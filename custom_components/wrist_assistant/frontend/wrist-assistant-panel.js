...
`)}function Vo(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,qd(r));return{values:t,nullKeys:i}}function qd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Ia(e){let n=oi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Yd(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}var Xd=10800;function Jd(e,n){let t=e.minutes==="always"||e.minutes==="auto"&&n<=Xd;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...t?{minute:"2-digit"}:{},...e.hourCycle==="h12"?{hourCycle:"h12"}:{},...e.hourCycle==="h24"?{hourCycle:"h23"}:{}})}function Zd(e,n){if(ht(e)===void 0)return[];let t=lo(e.timeLabelCount);if(t.length===0)return[];let i=Oe(e)*60,a=Jd(e,i);return t.map(r=>({position:r,text:a.format(new Date(n-i*1e3*(1-r)))}))}function It(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ze(e){let n=e.trim(),t=It(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:It(i)}function Qd(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ec(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function tc(e){let n=e.trim(),t=It(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?It(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=It(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function nc(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function ic(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function ac(e,n,t){if(Pe(n))return e;let i=n,a=e,r=It(e.trim()),o=i.duration?tc(e):void 0;if(o!==void 0)a=nc(o);else if(i.relativeTime&&r!==void 0)a=ec(r);else{let s=Ze(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Qd(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=ic(a);break}return a}function Jt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Mn(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function Bo(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function rc(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Rn(e,n=pt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:oc(i.slice(a+1))})}return t}function oc(e){try{return decodeURIComponent(e)}catch{return e}}function sc(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let u=t(o.state),c=i[i.length-1];c!==void 0&&c.colorHex===u?c.end=d:i.push({start:s,end:d,colorHex:u})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Go(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function lc(e,n,t){if(e===void 0)return 0;let i=Ze(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Qe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Bo(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Tt(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=Mn(i);return n.limit>0&&a.length>n.limit?n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit):a}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ze(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let u=t.get(s);if(!u)return{min:0,max:1};let c=u.scaleFrom,h=c!==void 0&&c!==s&&t.has(c)&&!l.has(c)?o(c,new Set([...l,c])):Bo(a.get(s)??[],u);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),u={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},c=this.chartEntity(l);c&&(u.entity=c),this.charts.set(s,u)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Pe(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Yd(a,t.kind.stat):void 0;i=a&&r!==void 0?no(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Ra(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return ac(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=It(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Jt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ze(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ze(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),u=d===void 0?void 0:Ze(d);if(a===void 0||l===void 0||u===void 0)return!1;let[c,h]=l<=u?[l,u]:[u,l];return a>=c&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ee[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,m={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return c!==void 0&&(m.countdownEnd=c),m}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...u,symbol:this.styleText(a,"icon")??c,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let c=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(c.value),m=this.styleNumber(a,"gaugeMin")??c.minValue,g=this.styleNumber(a,"gaugeMax")??c.maxValue,v=h===void 0?void 0:Ze(h),$=this.styleColor(a,"color")??c.colorSlot.baseColorHex;c.coloring==="bands"&&c.bands.length>0&&v!==void 0&&($=aa(v,wn(c),c.bandAboveColorHex));let S=g-m;if(c.total){let C=Ze(this.resolve(c.total)??"");C!==void 0&&(S=C)}let E=Go(S,1,Wn),w={kind:"gauge",...u,fraction:lc(h,m,g),style:c.style,lineWidth:c.lineWidth,colorHex:$,trackColorHex:c.trackColorHex,thresholdColorHex:c.thresholdColorHex,dotCount:E,filledCount:Go(v??0,0,E)};if(c.thresholdValue!==void 0&&g!==m){let C=(c.thresholdValue-m)/(g-m);C>=0&&C<=1&&(w.thresholdFraction=C)}return w}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),m=h.values,g={min:h.domainMin,max:h.domainMax},v=this.styleColor(a,"color")??c.colorSlot.baseColorHex,$=wn(c),S=to(c)?m.map(N=>aa(N,$,c.bandAboveColorHex)):[],E={kind:"chart",...u,values:m,style:c.style,domainMin:g.min,domainMax:g.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:v,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:S,fillBands:c.fillBands,thresholdColorHex:c.thresholdColorHex,nowColorHex:c.nowColorHex};if(m.length>0){let N=c.highlight==="highest"||c.highlight==="both",B=c.highlight==="lowest"||c.highlight==="both",X=N?m.indexOf(Math.max(...m)):-1,de=B?m.indexOf(Math.min(...m)):-1;X>=0&&(E.highIndex=X),de>=0&&de!==X&&(E.lowIndex=de)}let w=rc(c,g.min,g.max);w!==void 0&&(E.thresholdY=w);let C=this.chartNowIndex(c,m.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let c=n.payload,h=ht(c),m=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=Rn(m,pt),v=sc(g,Oe(c)*60,S=>uo(S,c.bands,c.otherColorHex));return{kind:"timeline",...u,runs:v,gap:c.gap,cornerRadius:c.cornerRadius,labels:Zd(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove}}case"shape":{let c={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};We(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=Eo(n,t).map(v=>this.resolveElement(v,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=l??u??this.resolve(a?.bezelText);c!==void 0&&(s.bezelText=c),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let v=a.bezelGauge,$=this.resolve(v.value),S=$===void 0?void 0:Ze($);if(S!==void 0){let E=Math.min(v.minValue,v.maxValue),w=Math.max(v.minValue,v.maxValue),C={value:Math.min(w,Math.max(E,S)),minValue:E,maxValue:w===E?E+1:w,colorHexes:v.colorHexes},N=this.resolve(v.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(v.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function dc(e,n,t){let i=new Qe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function si(e,n,t){let i=new Qe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=dc(e.inline,n,e)),a}var be=he,In=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:be,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Zt=In.find(e=>e.measured);function Zo(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return In.find(a=>a.screen.width===t&&a.screen.height===i)}function di(e,n){let t=be[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var cc={regular:400,medium:500,semibold:600,bold:700};function Ve(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function we(e,n,t="#FFFFFF"){let i=Ve(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Qo(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function uc(e,n){let t=we(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Jt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=e.text;if(n.w>0&&s.length*i(o)>n.w){let l=n.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var mc=5;function fc(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:mc,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,u=Math.max(n.h-r-o*2,1),c=d+u,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?u*.12:0,v=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-v*(i-1))/i,.5),S=w=>Math.min(1,Math.max(0,(w-e.domainMin)/h)),E=w=>c-S(w)*u;return{count:t.length,barWidth:$,plotTop:d,plotBottom:c,plotLeft:s,plotRight:s+l,baselineY:m?c:E(0),yAtFraction(w){return c-Math.min(Math.max(w,0),1)*u},barRect(w){let C=s+w*($+v),N=t[w],B,X;if(m){let de=g+S(N)*(u-g);B=c-de,X=c}else B=E(N),X=m?c:E(0),B>X&&([B,X]=[X,B]);return{x:C,y:B,w:$,h:Math.max(X-B,.5)}},point(w){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*w/(t.length-1):s+l/2,y:E(t[w])}},markerCenter(w,C){let N=C?this.barRect(w):void 0;return{x:N?N.x+N.w/2:this.point(w).x,y:n.y+r/2}}}}function gc(e,n){if(e.values.length===0)return f;let t=fc(e,n),i=we(e.colorHex,"fill"),a=we(e.highColorHex,"fill",e.colorHex),r=we(e.lowColorHex,"fill",e.colorHex),o=(u,c)=>b`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${c.fill} fill-opacity=${c["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?we(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let c=t.barRect(u),h=u===e.highIndex?a:u===e.lowIndex?r:d(u),m=Math.min(1.2,c.w/2,c.h/2);s.push(b`<rect x=${c.x} y=${c.y} width=${c.w} height=${c.h} rx=${m}
      ...
      fill=${d.fill} fill-opacity=${d["fill-opacity"]}>${c.text}</text>`});return b`${s}${u}`}function bc(e,n){let t=we(e.fillColorHex,"fill"),i=e.borderColorHex?Ve(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return b`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function vc(e,n,t){let i=t.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=we(e.colorHex,"stroke"),r=e.size;return b`
    ...
    ${e.maxLabel!==void 0?$(`${t}-gmax`,d+v,d+v+Math.max(s,3),e.maxLabel):f}`}function hi(e,n){let t=e.family in be?e.family:"rectangular",i=n.slot??be[t],a=be[t],r=di(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ve(e.backgroundColorHex),l=Ve(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,v=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=pi(g,v),w=Da(g,v),C=w/(a.width*g),N=E.tile.cx-w/2,B=E.tile.cy-w/2,X=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,de=f;if(e.bezelGauge)de=Rc(e.bezelGauge,g,o);else if(e.bezelText){let F=Ec(g,`${o}-bezel`),D=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Jt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;de=b`<defs><path id=${F.id} d=${F.d} /></defs>
        <text font-size=${Uo*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${F.id}" startOffset="50%" text-anchor="middle">${Wo(D,F.length,Uo*g)}</textPath></text>`}let k=f;if(S){let F=Ve(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},D=ts(g,`${o}-curved`,Tc*g,Fc);k=b`<defs><path id=${D.id} d=${D.d} /></defs>
        <text font-size=${jo*g} font-weight="600" fill=${F.color} fill-opacity=${F.opacity}
          ...
          <textPath href="#${D.id}" startOffset="50%" text-anchor="middle">${Wo($,D.length,jo*g*.88)}</textPath></text>`}else{let F=e.borderWidth*r.scale*C,D=l?b`<circle cx=${w/2} cy=${w/2} r=${w/2-F/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${F} />`:f;k=b`<g transform="translate(${N} ${B})">
        <g clip-path=${`url(#${o})`}>
    ...
    ${c}
      ...
      <path d=${a[0]} fill=${r.color} fill-opacity=${r.opacity} /></svg>`}load(){if(this.state!=="idle")return;this.state="loading";let n=new URL(`symbol-icons.json.gz?v=${cs}`,import.meta.url);fetch(n).then(t=>{if(!t.ok||!t.body)throw new Error(`symbol file: ${t.status}`);return new Response(t.body.pipeThrough(new DecompressionStream("gzip"))).json()}).then(t=>{if(t&&typeof t=="object")for(let[i,a]of Object.entries(t))Array.isArray(a)&&typeof a[0]=="string"&&typeof a[1]=="string"&&this.icons.set(i,[a[0],a[1]])}).catch(()=>{}).finally(()=>{this.state="loaded",this.onReady()})}};function us(e){return fi.available()?new fi(e):new Ua(e)}function ps(e){let n=new Map,t=new Set;return{size(i){let a=n.get(i);if(a)return a;if(t.has(i))return;t.add(i);let r=new Image;r.onload=()=>{r.naturalWidth<=0||r.naturalHeight<=0||(n.set(i,{width:r.naturalWidth,height:r.naturalHeight}),e())},r.src=i}}}var yi=[{name:"Home",symbols:["house","house.fill","house.circle.fill","bed.double.fill","sofa.fill","chair.lounge.fill","lamp.desk.fill","washer.fill","dryer.fill","refrigerator.fill","oven.fill","dishwasher.fill","microwave.fill","shower.fill","bathtub.fill","toilet.fill","stairs","door.left.hand.open","door.left.hand.closed","window.casement","curtains.closed","spigot.fill","humidifier.fill","air.purifier.fill","fan.fill","fan.ceiling.fill"]},{name:"Climate",symbols:["thermometer.variable","thermometer.medium","thermometer.low","thermometer.high","thermometer.sun.fill","thermometer.snowflake","humidity.fill","drop.fill","drop.degreesign","flame.fill","snowflake","wind","air.conditioner.horizontal.fill","heater.vertical.fill","gauge.with.needle"]},{name:"Weather",symbols:["sun.max.fill","sun.min.fill","sunrise.fill","sunset.fill","moon.fill","moon.stars.fill","cloud.fill","cloud.sun.fill","cloud.rain.fill","cloud.heavyrain.fill","cloud.drizzle.fill","cloud.snow.fill","cloud.bolt.fill","cloud.bolt.rain.fill","cloud.fog.fill","tornado","hurricane","umbrella.fill","rainbow","aqi.medium"]},{name:"Lighting",symbols:["lightbulb","lightbulb.fill","lightbulb.slash.fill","lightbulb.led.fill","light.recessed","light.panel.fill","light.strip.2","lamp.ceiling.fill","lamp.floor.fill","lamp.table.fill","sparkles","rays"]},{name:"Security",symbols:["lock.fill","lock.open.fill","lock.shield.fill","shield.fill","shield.slash.fill","key.fill","exclamationmark.shield.fill","video.fill","video.slash.fill","web.camera.fill","sensor.fill","sensor.tag.radiowaves.forward.fill","bell.fill","bell.slash.fill","bell.badge.fill","alarm.fill","eye.fill","eye.slash.fill"]},{name:"Media",symbols:["play.fill","pause.fill","stop.fill","forward.fill","backward.fill","forward.end.fill","backward.end.fill","speaker.wave.2.fill","speaker.wave.3.fill","speaker.slash.fill","music.note","music.note.list","tv","tv.fill","appletv.fill","homepod.fill","homepod.2.fill","airplay.audio","airplay.video","hifispeaker.fill","headphones","radio.fill","film.fill","photo.fill"]},{name:"Power",symbols:["bolt.fill","bolt.slash.fill","bolt.circle.fill","battery.100percent","battery.75percent","battery.50percent","battery.25percent","battery.0percent","battery.100percent.bolt","powerplug.fill","power","poweroutlet.type.b.fill","minus.plus.batteryblock.fill","leaf.fill"]},{name:"Devices",symbols:["iphone","ipad","applewatch","macbook","desktopcomputer","laptopcomputer","homekit","wifi","wifi.slash","antenna.radiowaves.left.and.right","network","externaldrive.fill","server.rack","printer.fill","cpu","memorychip","sdcard.fill","cable.connector","dot.radiowaves.left.and.right"]},{name:"Status",symbols:["checkmark","checkmark.circle.fill","xmark","xmark.circle.fill","exclamationmark.triangle.fill","exclamationmark.circle.fill","questionmark.circle.fill","info.circle.fill","circle.fill","circle","circle.circle.fill","minus.circle.fill","plus.circle.fill","hand.thumbsup.fill","hand.thumbsdown.fill","star.fill","heart.fill","flag.fill","pin.fill","wrench.and.screwdriver.fill","gearshape.fill","hourglass","ellipsis"]},{name:"Time",symbols:["clock","clock.fill","alarm","timer","stopwatch.fill","calendar","calendar.badge.clock","hourglass.bottomhalf.filled","deskclock.fill","sunrise","sunset","moon.zzz.fill","zzz"]},{name:"Arrows",symbols:["arrow.up","arrow.down","arrow.left","arrow.right","arrow.up.right","arrow.down.right","arrow.up.circle.fill","arrow.down.circle.fill","arrow.clockwise","arrow.counterclockwise","arrow.up.arrow.down","arrow.up.and.down","arrow.left.and.right","arrowshape.turn.up.left.fill","chevron.up","chevron.down","chevron.left","chevron.right"]},{name:"Shapes",symbols:["square.fill","square","circle.dashed","triangle.fill","diamond.fill","hexagon.fill","octagon.fill","capsule.fill","rectangle.fill","app.fill","seal.fill","shield","oval.fill","pentagon.fill","rhombus.fill","drop","cloud","bolt"]},{name:"Text and numbers",symbols:["0.circle.fill","1.circle.fill","2.circle.fill","3.circle.fill","textformat","textformat.size","percent","number","plus","minus","multiply","divide","equal","function","sum","character","character.textbox","degreesign.celsius","degreesign.fahrenheit"]},{name:"Nature",symbols:["tree.fill","carrot.fill","drop.triangle.fill","pawprint.fill","hare.fill","tortoise.fill","ant.fill","ladybug.fill","bird.fill","fish.fill","camera.macro","mountain.2.fill","water.waves","globe.americas.fill"]},{name:"People",symbols:["person.fill","person.2.fill","person.3.fill","person.crop.circle.fill","person.fill.checkmark","person.fill.xmark","figure.walk","figure.run","figure.stand","hand.raised.fill","ear.fill","brain.head.profile","eye","accessibility"]},{name:"Transport",symbols:["car.fill","car.2.fill","bus.fill","tram.fill","airplane","bicycle","figure.walk.motion","ev.charger.fill","fuelpump.fill","parkingsign.circle.fill","road.lanes","location.fill","location.slash.fill","map.fill","mappin.and.ellipse"]}],bi=[...new Set(yi.flatMap(e=>e.symbols))],Oc={"aqi.medium":["air quality"],"arrow.clockwise":["refresh","reload","update"],"battery.100percent":["charge","level"],"bolt.fill":["power","energy","watt","electric"],"checkmark.circle.fill":["ok","done","good"],"clock.fill":["time"],"curtains.closed":["blind","shade","cover"],"door.left.hand.open":["entry"],"drop.fill":["humidity","water","moisture"],"dryer.fill":["laundry"],"exclamationmark.triangle.fill":["alert","alarm","problem","error"],"fan.fill":["ventilation"],"figure.walk":["motion","presence"],"flame.fill":["heat","heating","boiler","fire"],"gauge.with.needle":["pressure"],"gearshape.fill":["settings","config"],"house.fill":["home"],"leaf.fill":["eco","plant","garden"],"lock.fill":["security","locked","secure"],"moon.fill":["night","sleep"],"person.fill":["presence","occupancy"],"poweroutlet.type.b.fill":["socket","outlet"],"powerplug.fill":["outlet","socket","plug","switch"],"sensor.tag.radiowaves.forward.fill":["motion"],snowflake:["cool","cooling","ac","freeze"],"speaker.wave.2.fill":["volume","sound","audio"],"sun.max.fill":["day","bright","brightness"],"thermometer.medium":["temperature","temp"],"video.fill":["camera"],"washer.fill":["laundry"],"water.waves":["pool","flood"],wifi:["network","internet","signal"],"window.casement":["blind","shade"]};function Pc(e){return`${e.replace(/\./g," ")} ${(Oc[e]??[]).join(" ")}`}function hs(e,n){let t=n.toLowerCase().split(/[\s.]+/).filter(Boolean);if(t.length===0)return[...e];let i=[];for(let a of e){let r=Pc(a);if(!t.every(s=>r.includes(s)))continue;let o=t.join(".");i.push({name:a,score:a===o?0:a.startsWith(o)?1:2})}return i.sort((a,r)=>a.score-r.score).map(a=>a.name)}var gi=class e{constructor(n){this.onChange=n;this.collapsed=new Set;this.browsing=new Map;this.recent=[];this.recent=e.loadRecent()}static{this.STORAGE_KEY="wrist-assistant.recent-symbols"}static{this.RECENT_LIMIT=12}isOpen(n){return!this.collapsed.has(n)}toggle(n){this.collapsed.has(n)?this.collapsed.delete(n):this.collapsed.add(n),this.onChange()}query(n){return this.browsing.get(n)?.query??""}category(n){return this.browsing.get(n)?.category??""}setQuery(n,t){this.browsing.set(n,{category:this.category(n),query:t}),this.onChange()}setCategory(n,t){this.browsing.set(n,{query:this.query(n),category:t}),this.onChange()}noteUsed(n){let t=n.trim();t&&(this.recent=[t,...this.recent.filter(i=>i!==t)].slice(0,e.RECENT_LIMIT),e.saveRecent(this.recent),this.onChange())}static loadRecent(){try{let n=localStorage.getItem(e.STORAGE_KEY),t=n?JSON.parse(n):[];return Array.isArray(t)?t.filter(i=>typeof i=="string").slice(0,e.RECENT_LIMIT):[]}catch{return[]}}static saveRecent(n){try{localStorage.setItem(e.STORAGE_KEY,JSON.stringify(n))}catch{}}};var Dc=100;function ms(e){return e.error!==void 0&&e.error!==""?{tone:"err",text:`Not saved: ${e.error}`}:e.templateError!==void 0&&e.templateError!==""?{tone:"err",text:`Template error: ${e.templateError}`}:e.dirty?{tone:"warn",text:"Unsaved changes"}:e.revision===null?{tone:"warn",text:"Not saved yet"}:{tone:"ok",text:`Saved, revision ${e.revision}`}}var Ht=class e{constructor(n,t){this.config=n;this.past=[];this.future=[];this.coalesceUntil=0;this.baseRevision=t,Xt(n),mt(n),this.baseline=JSON.stringify(Qn(n))}static fromDocument(n,t){return new e(Zn(n),t)}get dirty(){return JSON.stringify(Qn(this.config))!==this.baseline}get canUndo(){return this.past.length>0}get canRedo(){return this.future.length>0}update(n,t,i){let a=Date.now();t!==void 0&&t===this.coalesceKey&&a<this.coalesceUntil||(this.past.push(structuredClone(this.config)),this.past.length>Dc&&this.past.shift(),this.future=[]),this.coalesceKey=t,this.coalesceUntil=t===void 0?0:a+800;let o=structuredClone(this.config);n(o),Xt(o,i),mt(o),this.config=o}endGesture(){this.coalesceKey=void 0,this.coalesceUntil=0}undo(){let n=this.past.pop();n&&(this.future.push(this.config),this.config=n,this.endGesture())}redo(){let n=this.future.pop();n&&(this.past.push(this.config),this.config=n,this.endGesture())}encoded(){let n=structuredClone(this.config);return n.dataSources=Ia(n),Qn(n)}commit(){let n=structuredClone(this.config);return n.dataSources=Ia(n),new e(n,null)}};var vi=class{constructor(){this.watched=new Map;this.onScroll=n=>this.mark(n.currentTarget);this.observer=new ResizeObserver(()=>{for(let n of this.watched.keys())this.mark(n)})}refresh(n){let t=new Set(n.filter(i=>i!=null));for(let[i,a]of[...this.watched])t.has(i)||this.drop(i,a);for(let i of t){let a=this.watched.get(i);a||(a=new Set,this.watched.set(i,a),i.addEventListener("scroll",this.onScroll,{passive:!0}),this.observer.observe(i));for(let r of a)r.parentElement!==i&&(this.observer.unobserve(r),a.delete(r));for(let r of i.children)a.has(r)||(a.add(r),this.observer.observe(r));this.mark(i)}}disconnect(){for(let[n,t]of[...this.watched])this.drop(n,t);this.observer.disconnect()}drop(n,t){n.removeEventListener("scroll",this.onScroll),this.observer.unobserve(n);for(let i of t)this.observer.unobserve(i);this.watched.delete(n)}mark(n){let t=n.scrollHeight-n.clientHeight,i=t>1;n.toggleAttribute("data-more-above",i&&n.scrollTop>1),n.toggleAttribute("data-more-below",i&&n.scrollTop<t-1)}};var tn={isOn:"is on",isOff:"is off",equals:"equals",notEquals:"does not equal",isUnavailable:"is unavailable or unknown",isStale:"data is stale",isEmpty:"is empty",greaterThan:"is greater than",greaterOrEqual:"is at least",lessThan:"is less than",lessOrEqual:"is at most",between:"is between",contains:"contains",startsWith:"starts with",endsWith:"ends with",matchesRegex:"matches regex",isOneOf:"is one of"},et={icon:"Icon",text:"Text",color:"Colour",visibility:"Visible",opacity:"Opacity",fontSize:"Size",fontWeight:"Weight",rotation:"Rotation",gaugeValue:"Gauge value",gaugeMin:"Gauge min",gaugeMax:"Gauge max",backgroundColor:"Background",borderColor:"Border colour",borderWidth:"Border width"},gs=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"],ys={color:"setColor",opacity:"setOpacity",text:"setText",icon:"setIcon",fontSize:"setFontSize",fontWeight:"setFontWeight",rotation:"setRotation",visibility:"hide",gaugeValue:"setGaugeValue",gaugeMin:"setGaugeMin",gaugeMax:"setGaugeMax",borderColor:"setBorderColor",borderWidth:"setBorderWidth",backgroundColor:"setBackgroundColor"},Ka=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","lessThan","lessOrEqual","between","greaterOrEqual","greaterThan","contains","startsWith","endsWith"],Vc=["lessThan","lessOrEqual","between","greaterOrEqual","greaterThan"];function Wa(e){return Vc.includes(e)}function Bc(e){return Ka.includes(e)}function Gc(e,n){return JSON.stringify(re(e))===JSON.stringify(re(n))}function ja(e){if(e.length>1)return{ok:!1,reason:`There are ${e.length} rules here. A table shows one.`};let n=e[0];if(!n)return{ok:!0,table:{ruleId:"",rows:[],columns:[],numberMode:!1}};let t,i=[];for(let[r,o]of n.cases.entries()){let s=o.when.tests;if(s.length!==1)return{ok:!1,reason:s.length===0?`State ${r+1} checks nothing, so it always matches.`:`State ${r+1} checks ${s.length} things at once. A table row checks one.`};let l=s[0];if(!Bc(l.comparison.kind))return{ok:!1,reason:`State ${r+1} uses "${tn[l.comparison.kind]}", which a table row cannot show.`};if(t===void 0)t=l.value;else if(!Gc(t,l.value))return{ok:!1,reason:"The states test different values. A table tests one value in every row."};let d=fs(o.then);if(d)return{ok:!1,reason:`State ${r+1} sets ${et[d]} twice. A table has one cell per column.`};i.push({caseId:o.id,testId:l.id,join:o.when.join,comparison:l.comparison,changes:o.then})}if(n.otherwise){let r=fs(n.otherwise);if(r)return{ok:!1,reason:`Otherwise sets ${et[r]} twice. A table has one cell per column.`}}let a={ruleId:n.id,rows:i,columns:Uc(i,n.otherwise),numberMode:i.length>0&&i.every(r=>Wa(r.comparison.kind))};return t!==void 0&&(a.value=t),n.otherwise&&(a.otherwise=n.otherwise),{ok:!0,table:a}}function fs(e){let n=new Set;for(let t of e){let i=Ee[t.kind];if(n.has(i))return i;n.add(i)}}function Uc(e,n){let t=new Set;for(let i of e)for(let a of i.changes)t.add(Ee[a.kind]);for(let i of n??[])t.add(Ee[i.kind]);return gs.filter(i=>t.has(i))}function bs(e,n,t){let i=new Set(e);for(let a of n)i.add(a);return gs.filter(a=>i.has(a)&&t.includes(a))}function wi(e,n){return e.find(t=>Ee[t.kind]===n)}function vs(e,n,t,i){let a=n.map(o=>({id:o.caseId??Z(),when:{join:o.join??"all",tests:[{id:o.testId??Z(),value:structuredClone(e),comparison:o.comparison}]},then:o.changes})),r={id:i??Z(),cases:a};return t&&(r.otherwise=t),r}function An(e){if(e.length===0)return"No states yet.";let n=ja(e);if(!n.ok)return"Advanced rules.";let t=n.table.rows.length+(n.table.otherwise?1:0);return t===1?"1 state.":`${t} states.`}function ws(e){let n=e[0];return n||(n={id:Z(),cases:[]},e.push(n)),n}function xs(e){let n=e[0];n&&n.cases.length===0&&n.otherwise===void 0&&(e.length=0)}function ks(e,n,t){let i=ws(e),a=i.cases[i.cases.length-1]?.when.tests[0]?.comparison;i.cases.push({id:Z(),when:{join:"all",tests:[{id:Z(),value:structuredClone(n),comparison:Wc(a,t)}]},then:[]})}function $s(e,n){let t=e[0];t&&(t.cases=t.cases.filter(i=>i.id!==n),xs(e))}function qa(e,n,t){let i=e[0]?.cases;if(!i||t<0||t>=i.length)return;let[a]=i.splice(n,1);a&&i.splice(t,0,a)}function Ya(e,n){if(n){ws(e).otherwise=[];return}let t=e[0];t&&(delete t.otherwise,xs(e))}function Cs(e,n){for(let t of e[0]?.cases??[]){let i=t.when.tests[0];i&&(i.value=structuredClone(n))}}function Ss(e,n){let t=e[0];if(!t)return;let i=a=>a.filter(r=>Ee[r.kind]!==n);for(let a of t.cases)a.then=i(a.then);t.otherwise&&(t.otherwise=i(t.otherwise))}function Kc(e){return e?e.kind.kind==="literal"?e.kind.value===""?"?":e.kind.value:"a value":"?"}function Es(e,n=Kc){let t=()=>n(e.value??R(""));switch(e.kind){case"lessThan":return`below ${t()}`;case"lessOrEqual":return`${t()} or below`;case"greaterThan":return`above ${t()}`;case"greaterOrEqual":return`${t()} or above`;case"between":return`${t()} to ${n(e.upper??R(""))}`;case"matchesRegex":return`matches ${e.pattern||"?"}`;case"isOneOf":return`is one of ${(e.options??[]).join(", ")||"?"}`;default:return Mt(e.kind)==="value"?`${tn[e.kind]} ${t()}`:tn[e.kind]}}function Wc(e,n){if(!e)return n?{kind:"lessThan",value:R("20")}:{kind:"isOn"};switch(e.kind){case"isOn":return{kind:"isOff"};case"isOff":return{kind:"isOn"};case"lessThan":case"lessOrEqual":return{kind:"greaterOrEqual",value:e.value??R("0")};case"between":return{kind:"greaterOrEqual",value:e.upper??R("0")};case"greaterThan":case"greaterOrEqual":return{kind:"greaterOrEqual",value:e.value??R("0")};default:return{kind:e.kind,...Mt(e.kind)==="value"?{value:R("")}:{}}}}var Ts={text:"text",icon:"icon",gauge:"color",chart:"color",timeline:"visibility",shape:"color",image:"visibility",tap:"visibility",layout:"backgroundColor"};function Fs(e){if(!e)return!1;let n=e.kind;if(n.kind!=="entityState")return!1;let t=n.domain||n.entityId.split(".")[0]||"";return["light","switch","fan","input_boolean","binary_sensor","automation","siren","humidifier","group"].includes(t)}function jc(e){switch(e){case"text":return b`<path d="M5 6H19M12 6V19M9 19H15" />`;case"icon":return b`<path d="M12 3.5L14.6 9L20.5 9.7L16.1 13.8L17.3 19.7L12 16.8L6.7 19.7L7.9 13.8L3.5 9.7L9.4 9Z" />`;case"gauge":return b`<path d="M5 17A8 8 0 1 1 19 17" /><path d="M12 13L15.5 9.5" /><circle cx="12" cy="13" r="1.4" />`;case"chart":return b`<path d="M5 19V13" /><path d="M9.7 19V9" /><path d="M14.3 19V15" /><path d="M19 19V5" />`;case"timeline":return b`<rect x="3" y="9" width="6" height="6" rx="1.5" /><rect x="10.5" y="9" width="3.5" height="6" rx="1.5" /><rect x="15.5" y="9" width="5.5" height="6" rx="1.5" />`;case"shape":return b`<rect x="4" y="5" width="16" height="14" rx="3" />`;case"image":return b`<rect x="3.5" y="5" width="17" height="14" rx="2.5" /><circle cx="9" cy="10" r="1.6" /><path d="M20.5 15.5L15.5 11L7 19" />`;case"tap":return b`<path d="M10 12V5.5a1.8 1.8 0 0 1 3.6 0V12" /><path d="M13.6 10.5a1.8 1.8 0 0 1 3.6 0V13" /><path d="M10 11.5a1.8 1.8 0 0 0-3.6 0v3.5a6.6 6.6 0 0 0 13.2 0v-1.5" />`;case"content":return b`<rect x="3.5" y="5" width="17" height="14" rx="2.5" /><path d="M7 9.5H17M7 13H13" />`;case"look":return b`<circle cx="12" cy="12" r="8.5" /><circle cx="8.5" cy="10.5" r="1.1" /><circle cx="12" cy="8" r="1.1" /><circle cx="15.5" cy="10.5" r="1.1" /><path d="M12 20.5a2.5 2.5 0 0 0 0-5h-1a1.8 1.8 0 0 1 0-3.6" />`;case"clock":return b`<circle cx="12" cy="12" r="8.5" /><path d="M12 7.5V12L15 14" />`;case"states":return b`<path d="M6 4V9.5A2.5 2.5 0 0 0 8.5 12H15.5A2.5 2.5 0 0 1 18 14.5V20" /><circle cx="6" cy="4" r="1.4" /><circle cx="18" cy="20" r="1.4" /><path d="M6 20V14" />`;case"place":return b`<path d="M12 3V6.5M12 17.5V21M3 12H6.5M17.5 12H21" /><circle cx="12" cy="12" r="4.5" />`;case"layers":return b`<path d="M12 4L20 8.5L12 13L4 8.5Z" /><path d="M4 12.5L12 17L20 12.5" /><path d="M4 16.5L12 21L20 16.5" />`;case"grip":return b`<circle cx="9" cy="6" r="1.3" /><circle cx="15" cy="6" r="1.3" /><circle cx="9" cy="12" r="1.3" /><circle cx="15" cy="12" r="1.3" /><circle cx="9" cy="18" r="1.3" /><circle cx="15" cy="18" r="1.3" />`;case"chevron":return b`<path d="M6 9L12 15L18 9" />`;case"plus":return b`<path d="M12 5V19M5 12H19" />`;case"watch":return b`<rect x="6" y="6.5" width="12" height="11" rx="3" /><path d="M9 6.5L9.6 3H14.4L15 6.5M9 17.5L9.6 21H14.4L15 17.5" />`;case"compact":return b`<path d="M4 6.5H20M4 12H20M4 17.5H20" />`;case"expanded":return b`<rect x="3.5" y="4" width="17" height="7" rx="1.8" /><rect x="3.5" y="13" width="17" height="7" rx="1.8" /><path d="M6.5 8H13M6.5 17H13" />`;case"lock":return b`<rect x="5" y="11" width="14" height="10" rx="2" /><path d="M8 11V7.5a4 4 0 0 1 8 0V11" />`;case"unlock":return b`<rect x="5" y="11" width="14" height="10" rx="2" /><path d="M8 11V7.5a4 4 0 0 1 7.6-1.7" />`;case"folder":return b`<path d="M3.5 7.5A2 2 0 0 1 5.5 5.5H9.5L11.5 7.5H18.5A2 2 0 0 1 20.5 9.5V17A2 2 0 0 1 18.5 19H5.5A2 2 0 0 1 3.5 17Z" />`;case"ungroup":return b`<path d="M3.5 7.5A2 2 0 0 1 5.5 5.5H9.5L11.5 7.5H18.5A2 2 0 0 1 20.5 9.5V17A2 2 0 0 1 18.5 19H5.5A2 2 0 0 1 3.5 17Z" /><path d="M9 13.5H15" />`;case"up":return b`<path d="M6 14L12 8L18 14" />`;case"down":return b`<path d="M6 10L12 16L18 10" />`;case"show":return b`<path d="M2.5 12C5.5 7 8.7 5.5 12 5.5C15.3 5.5 18.5 7 21.5 12C18.5 17 15.3 18.5 12 18.5C8.7 18.5 5.5 17 2.5 12Z" />
        ...
        <path d="M4 3.5V7H7.5" />`;case"search":return b`<circle cx="10.8" cy="10.8" r="6.3" /><path d="M15.4 15.4L20 20" />`;case"undo":return b`<path d="M9 14L4 9L9 4" /><path d="M4 9H15A5 5 0 0 1 15 19H12" />`;case"redo":return b`<path d="M15 14L20 9L15 4" /><path d="M20 9H9A5 5 0 0 0 9 19H12" />`;case"expand":return b`<path d="M15 3H21V9M9 21H3V15M21 3L14 10M3 21L10 14" />`}}function L(e){return p`<svg class="ui-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${jc(e)}</svg>`}var Be="color-mix(in srgb, var(--k) 45%, #6b7280)",xi='system-ui, -apple-system, "Segoe UI", sans-serif';function Ms(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=u=>{let c=u*Math.PI/180;return{x:(e-t*Math.cos(c)).toFixed(2),y:(n-t*Math.sin(c)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Xa(e,n,t,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${Ms(e,n,t,1)} stroke=${Be} stroke-width="2.6" opacity=".5" />
    <path d=${Ms(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function qc(e){switch(e){case"text":return b`<g font-family=${xi} text-anchor="middle">
    ...
    <div class="ent-box ${s?"open":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:p`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let C=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),_t.set(a,{query:"",index:0}),Ae(C),C?.focus()}}>${L("close")}</button>`}
    </div>
    ...
    ${m}`}var cu=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],uu=[["bars","Bars"],["line","Line"],["area","Area"]],pu=[["auto","Auto"],["fixed","Fixed range"]],hu=[["lowest","Lowest value"],["zero","Zero"]],ll=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],mu=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],Ps=[["uniform","One colour"],["bands","By value"]];function Ds(e){let n=[ia,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Z(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Z(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function fu(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function gu(e,n){let t=wn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Z(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Vs(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    ${e.bands.map((o,s)=>p`
      <div class="row-inline">
        ...
        <button class="icon" title="Remove this state" aria-label="Remove this state"
          @click=${()=>n(l=>{l.bands=l.bands.filter((d,u)=>u!==s)})}>${L("close")}</button>
      </div>`)}
    ...
    ${o.kind==="filter"?p`<div class="grid2">
          ...
          ${pe("Floor ids",a(o.floorIds),s=>t({...n,scope:{...o,floorIds:r(s)}}))}
            ...
            <button class="icon" title="Remove" @click=${()=>t({...n,scope:{...o,entities:o.entities.filter((d,u)=>u!==l)}})}>${L("close")}</button>
          </div>`)}
    ...
    <div class="gen-row">
      ...
      ${Fe("Tap action",t.type,pl,s=>e.update(l=>{l.tapAction=hl(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
  ...
  ${a?f:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function yl(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return p`
    ...
    ${t?p`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:f}`}function Ri(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>Ri(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>Ri(e[a],n[a]))}function js(e,n,t){return t.some(i=>!Ri(e[i],n[i]))}function qs(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Ce(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=()=>e.toggleSection(n),l=p`<span class="swatch">${L(a.icon??"content")}</span>
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function ju(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function qu(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),u=i[i.length-1];u!==void 0&&u.state.trim().toLowerCase()===s.state.trim().toLowerCase()?u.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Uu(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Ii(e){let n=jn.find(o=>o.minutes===e);if(n)return n.label;let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return t>0&&r.push(`${t}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var Mi=new Set;function ir(e,n){return Mi.has(e)||!jn.some(t=>t.minutes===n)}function Ys(e,n,t,i){let a=ir(e,n);return p`<label class="field">${nt("Span",{atDefault:n===t&&!a,title:`Back to ${Ii(t)}`,reset:()=>{Mi.delete(e),i(t)}})}
      ...
      </select></label>`}function Xs(e,n){let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=(o,s,l)=>n(Math.min(ra,Math.max(1,Math.round(o)*1440+Math.round(s)*60+Math.round(l))));return p`<div class="grid3 span-parts">
    ...
    <div class="hint">On the ${Q(t)} shape only. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:te.place,icon:"place",summary:`${Math.round(s.width*100)}% wide \xB7 ${Q(t)}`,...i.inline?{alwaysOpen:!0,cardClass:"place-bar",bodyClass:"place-row"}:{},...d?{resetTitle:`Put this layer back to the middle of the ${Q(t)} face at half size, unrotated and shown`,reset:()=>e.update(u=>xe(u,t,a,{frame:{...Ke},isHidden:!1}))}:{}})}function cr(e,n,t={}){if(n.kind==="tap")return f;let i=n.payload.id,a=Te(e.config,i)[0];return Ce(e,"tappable","Tap",np(e,n,`el-${i}`),{color:te.tap,icon:"tap",summary:a?je(a.payload.action):"Not tappable",...t.inline?{alwaysOpen:!0,cardClass:"tap-bar",bodyClass:"tap-row"}:{},...a?{reset:()=>e.update(r=>ni(r,i))}:{}})}function xl(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,x)=>e.update(P=>y(P.elements[r]),x?`${o}-${x}`:void 0),l=Se(e.config,t,n),d=l.frame,u=(y,x)=>e.update(P=>xe(P,t,a,{frame:Ja(d,y)}),`${o}-${x}-${t}`),c=Ne(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",m=y=>c[y],g,v;switch(n.kind){case"text":{let y=ya(e.config,n.payload.value);g=p`
        ...
        <div class="grid2">
          ${ae("Style",y.style,vu,G=>x(V=>{G==="dots"&&V.total===void 0&&(V.total=Bs(V)),G!=="dots"&&delete V.total,V.style=G}),{titles:wu,def:c.style})}
        ...
        ${P?f:p`
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,x=(M,A)=>s(Di=>M(Di.payload),A),P=Tt(y),G=c.historyMinutes,V=c.historyPoints,O=y.historyMinutes>0,U=y.value.kind.kind==="entityState",W=P===void 0?void 0:e.historySeries(P),Ie=O&&U?W??"":e.resolve(y.value)??"",ke=y.historyPoints<1,at=ir(a,y.historyMinutes),q=Mn(Ie),ee=y.limit>0&&q.length>y.limit?y.takeFromEnd?q.slice(q.length-y.limit):q.slice(0,y.limit):q,Ni=!O&&U&&q.length===1,Oi=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),ql=ge(e),Pi=y.scaleFrom!==void 0&&Oi.some(M=>M.payload.id===y.scaleFrom);g=p`
        ${se(e,y.value,M=>x(A=>{A.value=M},"value"),{label:"Readings",key:`${o}-value`})}
        ${ae("Draw",O?"history":"value",[["history","Recorded history"],["value","The value itself"]],M=>x(A=>{A.historyMinutes=M==="history"?A.historyMinutes||qn:0}),{titles:{history:"Read the entity's past from the recorder and plot it",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${O?p`
            ...
            <div class="grid2">
              ${Ys(a,y.historyMinutes,G,M=>x(A=>{A.historyMinutes=M}))}
              <div class="field readings-field">${nt("Readings",{atDefault:y.historyPoints===V,title:`Back to ${V<1?"every one":`${V} averaged`}`,reset:()=>x(M=>{M.historyPoints=V})})}
                <div class="readings-row">
                  ...
                  ${ke?f:p`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    step="1" min=${oa} max=${Yn}
                    @input=${ve(M=>{let A=Number(M);M.trim()!==""&&Number.isFinite(A)&&A>=1&&x(Di=>{Di.historyPoints=Math.round(A)},"hpoints")})} />`}
                </div>
              </div>
            </div>
            ${at?Xs(y.historyMinutes,M=>x(A=>{A.historyMinutes=M},"span")):f}
        ...
        ${q.length>0?p`<div class="hint">Reads <span class="nums">${Gu(ee)}</span>${q.length===ee.length?p` · ${ee.length} ${ee.length===1?"value":"values"}`:p` · ${ee.length} of ${q.length}`}</div>`:f}
        ...
        <div class="grid2">
          ${ie("Use",y.limit,M=>x(A=>{A.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:c.limit})}
          ${ae("From",y.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],M=>x(A=>{A.takeFromEnd=M==="end"}),{def:c.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        <div class="grid2">
          ${ae("Style",y.style,uu,M=>x(A=>{A.style=M}),{def:c.style})}
          ${y.style==="bars"?ie("Bar gap (pt)",y.barGap,M=>x(A=>{A.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:c.barGap}):Si(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${ae("Scale",y.scale,pu,M=>x(A=>{A.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ae("Baseline",y.baseline,hu,M=>x(A=>{A.baseline=M}),{def:c.baseline})}
        </div>
        ${Oi.length===0?f:Fe("Same scale as",Pi?y.scaleFrom:"",[["","Its own"],...Oi.map(M=>[M.payload.id,Re(M,ql)])],M=>x(A=>{M?A.scaleFrom=M:delete A.scaleFrom}),{def:""})}
        ...
        ${!Pi&&y.scale==="fixed"?p`<div class="grid2">
              ${ie("Min",y.minValue,M=>x(A=>{A.minValue=M??0},"cmin"),{def:c.minValue})}
              ${ie("Max",y.maxValue,M=>x(A=>{A.maxValue=M??100},"cmax"),{def:c.maxValue})}
            </div>`:f}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          ...
          ${L("plus")}<span>Second series</span></button>
        ${ae("Colour",y.coloring,Ps,M=>x(A=>{A.coloring=M,M==="bands"&&A.bands.length===0&&(A.bands=Ds(ee))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${y.style==="area"?p`${Me("Fill follows the bands",y.fillBands,M=>x(A=>{A.fillBands=M}),c.fillBands)}
        ...
        <div class="grid2">
          ${ae("Highlight",y.highlight,ll,M=>x(A=>{A.highlight=M}),{def:c.highlight})}
          ${y.highlight==="none"?f:ae("Marker",y.marker,mu,M=>x(A=>{A.marker=M}),{def:c.marker})}
        </div>
        ${y.highlight==="none"?f:p`
          <div class="grid2">
            ${y.highlight==="lowest"?f:oe("Highest colour",y.highColorHex,M=>x(A=>{A.highColorHex=M??bn},"hicol"),!1,bn)}
            ${y.highlight==="highest"?f:oe("Lowest colour",y.lowColorHex,M=>x(A=>{A.lowColorHex=M??vn},"locol"),!1,vn)}
          </div>
        ...
        ${Me("Threshold line",y.thresholdValue!==void 0,M=>x(A=>{M?A.thresholdValue=fu(ee):delete A.thresholdValue}))}
        ${y.thresholdValue===void 0?f:p`
          <div class="grid2">
            ${ie("At",y.thresholdValue,M=>x(A=>{A.thresholdValue=M??0},"thval"))}
            ${oe("Line colour",y.thresholdColorHex,M=>x(A=>{A.thresholdColorHex=M??Ut},"thcol"),!1,Ut)}
          </div>
        ...
        ${Me("\u201CNow\u201D marker",y.nowIndex!==void 0,M=>x(A=>{M?A.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete A.nowIndex}))}
        ${y.nowIndex===void 0?f:p`
          ${se(e,y.nowIndex,M=>x(A=>{A.nowIndex=M},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${oe("Marker colour",y.nowColorHex,M=>x(A=>{A.nowColorHex=M??Kt},"nowcol"),!1,Kt)}
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=n.payload,x=(q,ee)=>s(Ni=>q(Ni.payload),ee),P=c.historyMinutes,G=y.value.kind.kind==="entityState",V=ht(y),O=V===void 0?void 0:e.historySeries(V),U=Oe(y)*60,W=Rn(O??"",pt),Ie=ir(a,y.historyMinutes),ke=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,at=yu(W,U,ke===void 0?void 0:e.hass.states[ke]?.state,ke?.split(".")[0]);g=p`
        ...
        ${Ys(a,y.historyMinutes,P,q=>x(ee=>{ee.historyMinutes=q}))}
        ${Ie?Xs(y.historyMinutes,q=>x(ee=>{ee.historyMinutes=q},"span")):f}
        ...
        ${W.length>0?p`<div class="hint">Reads <span class="nums">${qu(W,U)}</span></div>`:f}
        ...
        ${bu(y,x,at,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${n.payload.kind==="line"?Wu(t,d,u):f}`,v=n.payload.kind==="line"?ie("Thickness (pt)",n.payload.thickness,y=>s(x=>{x.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        ${kl(e,n.payload,(y,x)=>s(P=>y(P.payload),x),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let $=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:oe(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>s(x=>{x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,h),S=$a(e.config,n),E=S?{kind:{kind:"entityState",...S}}:void 0,w=me[n.kind],C=n.kind==="image"?n.payload.timestamp===!0:!1,N=Xu[n.kind],B=Ju[n.kind],X=js(n.payload,c,N),de=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,k=e.config.perFamily[t]?.placements[a]?.size!==void 0,F=js(n.payload,c,B)||de!==void 0&&l.size!==void 0&&l.size!==c[de],D=Ft(e.config,a),z=(y,x)=>()=>s(P=>qs(P.payload,c,y),x);return p`
    ${Ce(e,"content","Content",p`${n.kind==="tap"?f:Nu(e,n,o)}${g}`,{color:w,icon:"content",summary:lr(e,n),...X?{reset:z(N,"reset-content")}:{}})}
    ${v===void 0&&$===void 0?f:Ce(e,"look",n.kind==="image"?"Picture":"Look",p`${v??f}${$??f}`,{color:w,icon:n.kind==="image"?"image":"look",...Ai(n)?{summary:Ai(n)}:{},...F?{reset:()=>e.update(y=>{qs(y.elements[r].payload,c,B),k&&xe(y,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Ce(e,"numbers","Numbers",tp(e,n),{color:me.text,icon:"text",summary:ep(e,n),...D.length>0?{reset:()=>e.update(y=>{for(let x of Ft(y,a))Je(y,x.payload.id)})}:{}}):f}
    ${n.kind==="image"?Ce(e,"timestamp","Timestamp",Bu(n.payload,(y,x)=>s(P=>y(P.payload),x)),{color:w,icon:"clock",summary:C?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...C?{reset:z(Yu,"reset-stamp")}:{}}):f}
    ${i.tap===!1?f:cr(e,n)}
    ${Ce(e,"states","States",Ml(e,n.payload.rules,n.kind,y=>y.elements.find(x=>x.payload.id===a)?.payload.rules,`rules-${a}`,E),{color:te.states,icon:"states",summary:An(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(y=>{y.payload.rules=[]})}:{}})}
    ...
    ${Fe("Tap action",a.type,Mu,r=>t(o=>{o.action=hl(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?gl(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var Zu=24;function Qu(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Mo(e.config,n,r);o&&(t.push(`${Q(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<Zu;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function ep(e,n){let t=Ft(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Bt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function tp(e,n){let t=ge(e),i=Ft(e.config,n.payload.id),a=o=>e.update(s=>{ko(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
          ...
          ${i.map(o=>p`
            <div class="num-row">
              ...
              <button class="icon danger" title="Delete this number" aria-label="Delete this number"
                @click=${()=>e.update(s=>Je(s,o.payload.id))}>${L("close")}</button>
            </div>`)}
        </div>
    ...
    <div class="adders">
      ${Bt.map(([o,s])=>p`
        <button class="small" title=${r.has(o)?`Add another ${s.toLowerCase()}`:`Add the ${s.toLowerCase()}`}
          @click=${()=>a(o)}>${L("plus")}<span>${s}</span></button>`)}
    </div>
    ...
    ${a?p`<div class="value-editor">
          ...
          <div class="chips">
            ...
            ${Jn(a.payload.outset)?f:p`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                  @click=${()=>r(s=>{s.outset={...fa}})}>${L("reset")}</button>`}
          </div>
        </div>
        ${Qu(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${je(o)}</b>.</div>`}`}function Js(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Re(e,n){switch(e.kind){case"text":return Js(fe(e.payload.value,n));case"icon":return Js(fe(e.payload.symbol,n));case"gauge":return fe(e.payload.value,n);case"chart":return fe(e.payload.value,n);case"timeline":return fe(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function $l(e,n){let t=Ye(e.config,n.id),i=ge(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Ce(e,"content","Group",p`
    ...
    </div>`,{color:te.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Cl(e,n){if(n==="inline")return ip(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${Q(n)} yet.</div>
    ...
    ${n==="corner"?Ce(e,"corner","Corner content",ap(e,t,i),{color:te.place,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${Ce(e,"states","Shape states",Ml(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:te.states,icon:"states",summary:An(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${Ce(e,"symbol","Symbol",p`
      ...
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:me.icon,icon:"icon",summary:n.symbol||"None"})}`}function ap(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Ym=ne.map(e=>[e,Q(e)]),ur={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},op=Object.keys(ur);function sp(e){let n=ai[e];return op.filter(t=>n.includes(Ee[t]))}var lp={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Ei(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function gt(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function dp(e){if(!e||Pe(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function fe(e,n){return`${Sl(e,n)}${dp(e.format)}`}function Sl(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${gt(t.value,40)}"`:"(empty)";case"entityState":return Ei(t,n);case"entityAttribute":return t.attribute?`${Ei(t,n)} \xB7 ${t.attribute}`:Ei(t,n);case"entityAge":return`age of ${Ei(t,n)}`;case"aggregate":return cp(t.aggregate);case"time":return lp[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${gt(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Bt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Sl(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function cp(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Hi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function up(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ...
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>Hi(c,t,t-1))}>${L("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(c=>Hi(c,t,t+1))}>${L("down")}</button>
      <button class="icon danger" title="Delete rule" @click=${()=>r(c=>{let h=c.findIndex(m=>m.id===n.id);h>=0&&c.splice(h,1)})}>${L("delete")}</button>
    </div>
    <div class="branches">
    ...
    <div class="rule-head">
      ...
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(d=>Hi(d.cases,t,t-1))}>${L("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(d=>Hi(d.cases,t,t+1))}>${L("down")}</button>
      <button class="icon danger" title="Delete case" @click=${()=>r(d=>{let u=d.cases.findIndex(c=>c.id===n.id);u>=0&&d.cases.splice(u,1)})}>${L("delete")}</button>
    </div>
    <div class="row-inline">
    ...
    ${El(e,n.then,a,d=>s(u=>d(u.then)),`${o}-then`)}
        ...
        ${s.pattern&&!fp(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"options":u=pe("Options (comma separated)",(s.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    </select>`}var Tl=["setColor","setBorderColor","setBackgroundColor"];function gp(e,n,t,i,a,r,o){let s=!ai[i].includes(Ee[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${Fl(e,n,a,o)}
  </div>`}function Fl(e,n,t,i){let a=ri(n.kind),r=f;if(a==="value"){let o=n.value??R("");if(Tl.includes(n.kind)){let s=o.kind.kind==="literal";r=p`${s?oe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=R(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${up(e,n,t,i,a)}`:yp(e,o.table,n[0],t,i,a,r)}function yp(e,n,t,i,a,r,o){let s=(k,F)=>e.update(D=>{let z=a(D);z&&k(z)},F?`${r}-${F}`:void 0),l=n.value??Zs.get(r)??o,d=n.rows.length===0,u=n.numberMode||d&&l!==void 0&&!Fs(l)&&bp(e.resolve(l)),c=ai[i],h=Ti.get(r)??new Set,m=n.columns.length===0&&h.size===0?[Ts[i]]:[],g=bs(n.columns,[...h,...m.filter(k=>k!==void 0)],c),v=t?e.liveBranch(t):"none",$=t?e.forced.get(t.id)??"live":"live",S=k=>$!=="live"&&($==="otherwise"?k==="otherwise":$.caseId===k),E=k=>{t&&e.setForced(t.id,S(k)?"live":k==="otherwise"?"otherwise":{caseId:k})},w=k=>{Zs.set(r,k),n.rows.length!==0&&s(F=>Cs(F,k),"lhs")},C=()=>s(k=>ks(k,l??R(""),u)),N=n.rows.map((k,F)=>el(e,{key:`${r}-${k.caseId}`,label:Es(k.comparison,D=>fe(D,ge(e))),columns:g,changes:k.changes,live:v===k.caseId,forced:S(k.caseId),onForce:()=>E(k.caseId),when:$p(e,k.comparison,`${r}-${k.caseId}`,(D,z)=>s(y=>{let x=y[0]?.cases.find(P=>P.id===k.caseId)?.when.tests[0];x&&D(x.comparison)},z&&`${k.caseId}-${z}`)),updChanges:(D,z)=>s(y=>{let x=y[0]?.cases.find(P=>P.id===k.caseId);x&&D(x.then)},z&&`${k.caseId}-${z}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${F===0} @click=${()=>s(D=>qa(D,F,F-1))}>${L("up")}</button>
      <button class="icon" title="Move down" ?disabled=${F===n.rows.length-1} @click=${()=>s(D=>qa(D,F,F+1))}>${L("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>s(D=>$s(D,k.caseId))}>${L("delete")}</button>`})),B=n.otherwise===void 0?f:el(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:v==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(k,F)=>s(D=>{let z=D[0]?.otherwise;z&&k(z)},F),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(k=>Ya(k,!1))}>${L("close")}</button>`}),X=Fi.get(r),de=vp.filter(k=>c.includes(k)&&!g.includes(k));return p`
    <div class="states">
          ...
          <tr>
            ...
            ${g.map(k=>p`<th>
              ...
              <button class="icon" title=${`Remove the ${et[k]} column`}
                @click=${F=>{Fi.set(r,k),Ae(F.target)}}>${L("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${X===void 0?f:p`<div class="hint warn confirm-row">
        Remove the ${et[X]} column? Its ${Qs(n,X)} value${Qs(n,X)===1?"":"s"} are deleted from every state.
  ...
  </tr>`}function xp(e,n,t,i,a){let r=wi(t,n),o=or(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${et[n]} for this state`}
      @click=${d=>{i(u=>{u.push(Rt(ys[n]))}),Su(d.target,o)}}>unchanged</button>`;let s=(d,u)=>i(c=>{let h=c.find(m=>Ee[m.kind]===n);h&&d(h)},u&&`${n}-${u}`),l=et[n];return p`
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${cl}>
      ...
      ${_n.has(o)?p`${n==="visibility"?ae("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(u=>{u.kind=d})):Fl(e,r,s,a)}
    ...
    <select class="when-op" title="How this state is decided" @change=${ve(s=>i(l=>{let d=Fa(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Ka.map(s=>p`<option value=${s} ?selected=${s===n.kind}>${Cp(s)}</option>`)}
    </select>
    ...
    ${dl(e,s,o,n,t,l)}
  </span>`}var zn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:ka,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Hl(e){return zn.find(n=>n.kind===e)??zn[0]}var Rl="#FF9F0A",_i="#8E8E93",Ep=["#FF453A","#FFD60A","#34C759"],Ll=["#0A84FF","#34C759","#FF9F0A"];function Tp(e){return e?.attributes?.device_class==="battery"?Ep:Ll}var Fp={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Mp(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Fp[pr(e)]??{off:"circle",on:"circle.fill"}}function Rp(e){switch(pr(e)){case"lock":return{kind:"equals",value:R("locked")};case"cover":case"valve":return{kind:"equals",value:R("open")};case"media_player":return{kind:"equals",value:R("playing")};default:return{kind:"isOn"}}}function pr(e){return e.domain||e.entityId.split(".")[0]||""}function vt(e){return{...e,domain:pr(e)}}function Ip(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function rn(e){return Math.round(e*1e4)/1e4}function Nt(e,n,t){return Math.min(t,Math.max(n,e))}function hr(e,n,t){let i=be[e],a=Nt(rn(n/i.width),0,1),r=Nt(rn(t/i.height),0,1);return{x:rn((1-a)/2),y:rn((1-r)/2),width:a,height:r,rotationDegrees:0}}function Ap(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:hr(e,t*1.3,t*1.3),size:t}}function Hp(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:hr(e,n.width*.88,t*1.7),size:t}}function Lp(e){let n=be[e],t=Math.min(n.width,n.height)*.9;return{frame:hr(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function _l(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function _p(e){let n=be[e],t=Nt(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:rn(t/n.height),rotationDegrees:0}}}function zp(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:rn(Nt(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Np(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Op(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function yt(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Op(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Xe());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function bt(e){return Ne(e)}function mr(e,n){let t={kind:{kind:"entityState",...vt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Il(e){let n=Rt("setIcon");return n.value=R(e),n}function zt(e){let n=Rt("setColor");return n.value=R(e),n}function Pp(e,n){let t=Fn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...vt(e)}},a.comparison=Rp(e);let r=n.on!==n.off;return i.then=r?[Il(n.on),zt(Rl)]:[zt(Rl)],t.otherwise=r?[Il(n.off),zt(_i)]:[zt(_i)],t}function Dp(e){let n=Fn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...vt(e)}},i.comparison={kind:"isUnavailable"};let a=Rt("setOpacity");return a.number=.35,t.then=[a],n}function Al(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Vp(e,n,t=Ll){let i=n.max-n.min,a=Al(n.min+i/3),r=Al(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:R(a)},changes:[zt(t[0])]},{comparison:{kind:"between",value:R(a),upper:R(r)},changes:[zt(t[1])]},{comparison:{kind:"greaterThan",value:R(r)},changes:[zt(t[2])]}];return vs(mr(e),o)}function Bp(e,n,t){let i=bt("icon"),a=Mp(n);return i.payload.symbol=R(a.off),i.payload.colorSlot.baseColorHex=_i,i.payload.rules=[Pp(n,a)],yt(e,i,t.family,Ap),e.elements.push(i),ti(e,i.payload.id,{type:"toggleEntity",...vt(n)}),i.payload.id}function Gp(e,n,t){let i=bt("text");return i.payload.value=mr(n,t.state),i.payload.rules=[Dp(n)],yt(e,i,t.family,Hp),e.elements.push(i),i.payload.id}function Up(e,n,t){let i=bt("gauge");i.payload.value=mr(n);let a=Ip(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Vp(n,a,Tp(t.state))],yt(e,i,t.family,Lp),e.elements.push(i),i.payload.id}function Kp(e,n,t){let i=bt("chart");return i.payload.value={kind:{kind:"entityState",...vt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",yt(e,i,t.family,_l),e.elements.push(i),i.payload.id}function Wp(e,n,t){let i=bt("chart");return i.payload.value={kind:{kind:"entityState",...vt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",yt(e,i,t.family,_l),e.elements.push(i),i.payload.id}function jp(e,n,t){let i=vt(n),a=bt("text");a.payload.value=R(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=_i,yt(e,a,t.family,zp),e.elements.push(a);let r=t.state?.attributes?.device_class,o=bt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=ha(i.domain,typeof r=="string"?r:void 0),yt(e,o,t.family,_p),e.elements.push(o),o.payload.id}function qp(e,n,t){let i=bt("image");return i.payload.entity=vt(n),yt(e,i,t.family,Np),e.elements.push(i),i.payload.id}function zl(e,n,t,i){switch(n){case"toggle":return Bp(e,t,i);case"status":return Gp(e,t,i);case"gauge":return Up(e,t,i);case"chart":return Kp(e,t,i);case"history":return Wp(e,t,i);case"doorHistory":return jp(e,t,i);case"camera":return qp(e,t,i)}}var Xp=3e4,Jp=500,Nl="preset-entity",Zp={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function fr(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Qp(e){return e.kind==="family"?"look":"content"}function gr(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}var Ol=300,Pl=360,Dl=44,Vl=22,eh=[1,1.7,2.6],th=["S","M","L"],Bl=["Small","Medium","Large"],Gl="wrist-assistant-panel.layers.v1",it=34,Ot=200,nh=720,zi=320,ih=80,ah=56,Ul="wrist-assistant-panel.columns.v2",yr=e=>Math.max(Ot,Math.min(nh,Math.round(e))),Kl=e=>e.metaKey||e.ctrlKey||e.shiftKey,rh=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Nn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",wt=Nn==="Cmd"?"\u2318":"Ctrl+",br=Nn==="Cmd"?"\u21E7":"Shift+";function Wl(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-ih;if(i>=Ot*2+zi){let r=i-zi,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Ot,Math.floor(o*l)),s=Math.max(Ot,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Ot,o-d):s=Math.max(Ot,s-d))}return{columns:3,left:o,right:s}}let a=e-ah;return a>=Ot+zi?{columns:2,left:Math.min(n,a-zi),right:t}:{columns:1,left:n,right:t}}var I=class I extends ot{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Ol;this.colRight=Pl;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.pickerFilter="all";this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.recordPreviews=new Map;this.previewCase=Zt.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=us(()=>this.requestUpdate());this.imageSizes=ps(()=>this.requestUpdate());this.symbols=new gi(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new vi;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newChooserOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("newc"))||this.toggleNewChooser(!1)};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||ol(Nl)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Bi`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let t=window.localStorage.getItem(Ul);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=yr(i.left)),typeof i.right=="number"&&(this.colRight=yr(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Ul,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Gl);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Gl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>vl(s,o,i))}>Copy the ${Q(o)} layout</button>`)}
          </div>
      ...
      @click=${()=>{this.zoomed=!0}}>${L("expand")}</button>`}renderZoomDialog(t,i,a){let r=this.draft?.config;if(!r)return f;let o=a.slots[t],s=t==="corner"?104/124:o.width/o.height;return p`<dialog class="zoom-dialog" @close=${()=>{this.zoomed=!1}}>
      <div class="zoom-bar">
      ...
      <header>
        ...
        <div class="toolbar hbox hist">
          <button class="icon" @click=${()=>this.undo()} ?disabled=${!t?.canUndo} title="Undo (⌘Z)" aria-label="Undo">${L("undo")}</button>
          <span class="hdiv"></span>
          <button class="icon" @click=${()=>this.redo()} ?disabled=${!t?.canRedo} title="Redo (⇧⌘Z)" aria-label="Redo">${L("redo")}</button>
        </div>
        <span class="hsep"></span>
        <span class="spacer"></span>
      ...
      <button class="new-btn" ?disabled=${i} aria-haspopup="dialog" aria-expanded=${this.newShapeChooser?"true":"false"}
        ...
        @click=${()=>this.toggleNewChooser()}>${L("plus")}<span>New</span></button>
      ...
      ${this.newShapeChooser&&!i?p`<div class="new-shape" role="dialog" aria-label="New complication">
        ...
        <div class="adders">
          ${At.map(a=>p`<button class="small ${a==="rectangular"?"primary":""}" @click=${()=>{this.toggleNewChooser(!1),this.createNew(a)}}>${Q(a)}</button>`)}
        </div>
      </div>`:f}
              ...
              <span class="seg" role="group" aria-label="Button detail">
                ${[["compact","Names"],["expanded","Samples"]].map(([s,l])=>p`
                  <button class=${this.addDetail===s?"on":""} title=${l} aria-label=${l} aria-pressed=${this.addDetail===s?"true":"false"}
                    @click=${()=>{this.addDetail=s,this.saveListView()}}>${L(s)}</button>`)}
              </span>
            </span>`:f}
        <span class="chev">${L("chevron")}</span>
      </h2>
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Ba.map(s=>p`<button class="add" style=${`--k:${me[s]}`} ?disabled=${i} title=${`Add a blank ${en[s].toLowerCase()} layer`}
              ...
              >${r?p`<span class="well">${Rs(s)}</span>`:f}<span class="add-name">${r?L(s):p`<span class="k"></span>`}<span>${en[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(k,d)}</b>
          <small><span class="kind">${en[k.kind]}</span> · ${dh(k,u,this.historySeries,x.size)}</small>
          ${C?p`<span class="facts">${sh(this.host(),a,k,x).map(W=>p`<span class="fact"><b>${W.label}</b> ${W.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?p`<span class="acts">
            <button class="icon" title=${`Bring forward (${wt}])`} aria-label="Bring forward" @click=${W=>{W.stopPropagation(),r(z,1)}}>${L("up")}</button>
            <button class="icon" title=${`Send back (${wt}[)`} aria-label="Send back" @click=${W=>{W.stopPropagation(),r(z,-1)}}>${L("down")}</button>
            <button class="icon" title=${`${x.isHidden?"Show":"Hide"} (${br}${wt}H)`} aria-label=${x.isHidden?"Show this layer":"Hide this layer"} @click=${W=>{W.stopPropagation(),this.mutate(Ie=>xe(Ie,a,z,{isHidden:!x.isHidden}))}}>${L(x.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${wt}D)`} aria-label="Duplicate" @click=${W=>{W.stopPropagation(),o(z)}}>${L("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${W=>{W.stopPropagation(),s(z)}}>${L("delete")}</button>
          </span>`:f}
        </span>
      </div>`},B=(k,F)=>{let D=this.inspect.kind==="group"&&this.inspect.id===k.id,z=!this.collapsed.has(k.id),y=this.rowDrag(k.id,i),x=F[0],P=F[F.length-1],G=O=>{let U=O.currentTarget,W=U.getBoundingClientRect(),Ie=W.top+(U.classList.contains("drop-before")?it:0),ke=W.bottom-(U.classList.contains("drop-after")?it:0),at=(O.clientY-Ie)/Math.max(1,ke-Ie);return at<.25?"drop-before":!z&&at>.75?"drop-after":"drop-into"},V=F.map(O=>O.payload.id);return p`<div class="layer group ${D?"hl":""} ${C?"rich":""}" style=${`--k:${te.group}`} tabindex="0" draggable=${y.draggable}
        ...
        <span class="grip" title="Drag to reorder the whole group.">${L("grip")}</span>
        <span class="bar"></span>
        <span class="folder">${L("folder")}</span>
        <span class="name">
          <b>${k.name}</b>
        ...
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${br}${wt}G)`} aria-label="Ungroup" @click=${O=>{O.stopPropagation(),this.mutate(U=>En(U,k.id)),D&&(this.inspect={kind:"general"})}}>${L("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${k.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${O=>{O.stopPropagation(),this.mutate(U=>{let W=U.groups?.find(Ie=>Ie.id===k.id);W&&(W.locked=!W.locked)})}}>${L(k.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${z?"true":"false"} title=${z?"Fold the group":"Unfold the group"}
            @click=${O=>{O.stopPropagation();let U=new Set(this.collapsed);z?U.add(k.id):U.delete(k.id),this.collapsed=U}}>${L("chevron")}</button>
        </span>
      </div>`},X=[],de=new Set;for(let k=0;k<l.length;k++){let F=l[k],D=F.payload.groupId,z=D===void 0?void 0:t.groups?.find(P=>P.id===D);if(!z){X.push(N(F,!1));continue}if(de.has(z.id))continue;de.add(z.id);let y=l.filter(P=>P.payload.groupId===z.id);X.push(B(z,y));let x=this.inspect.kind==="group"&&this.inspect.id===z.id;this.collapsed.has(z.id)||X.push(p`<div class="group-kids">${y.map(P=>N(P,!0,x))}</div>`)}return p`<div class="card layers-card" style=${`--thumb-w:${S}px;--thumb-h:${E}px`}>
      <h2 class="panel-title tools" style=${`--c:${te.place}`}><span class="swatch">${L("layers")}</span>Layers
          ...
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([k,F])=>p`
              <button class=${this.layerDetail===k?"on":""} title=${F} aria-label=${F} aria-pressed=${this.layerDetail===k?"true":"false"}
                @click=${()=>{this.layerDetail=k,this.saveListView()}}>${L(k)}</button>`)}
          </span>
      ...
      <h2 class="panel-title"><span class="swatch">${L("content")}</span>Shared values
      ...
      ${i.map(o=>{let s=a.resolve({kind:{kind:"named",id:o.id}}),l=this.inspect.kind==="data"&&this.inspect.id===o.id;return p`<div class="datum vrow ${l?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:o.id}}}>
          ...
          ${this.canEdit?p`<button class="icon danger" title="Delete value" aria-label="Delete value" @click=${d=>{d.stopPropagation(),this.mutate(u=>{u.values=u.values.filter(c=>c.id!==o.id)}),l&&(this.inspect={kind:"general"})}}>${L("delete")}</button>`:f}
        </div>`})}
      </div>`}
        ...
        ${this.canEdit?p`<button class="icon danger tab-x" ?disabled=${!d}
          ...
          @click=${u=>{u.stopPropagation(),this.removeShape(r)}}>${L("delete")}</button>`:f}
      ...
      <h2 class="panel-title"><span class="swatch">${L("states")}</span>Values on the watch
      ...
      ${l===f?f:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=f,s=!0;if(r.kind==="layer"){let d=t.elements.find(u=>u.payload.id===r.id);if(!d)return this.inspect={kind:"general"},f;o=xl(a,d,this.canvasFamily,{placement:!1,tap:!1})}else if(r.kind==="group"){let d=t.groups?.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=$l(a,d)}else if(r.kind==="data"){let d=t.values.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${te.complication}`}>
      ...
      </div>`}else r.kind==="family"?o=Cl(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${L("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([Qp(r)]):new Set(rr)}}>${l?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <span>${t}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:f}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=ge(this.host()),o=new Qe(this.buildContext(),this.draft?.config),s=wl(t,a,i),l=i.length,d=[...i].reverse(),u=h=>this.mutate(m=>{for(let g of i)xe(m,a,g.payload.id,{isHidden:h})}),c=h=>this.mutate(m=>{for(let g of i){let v=m.elements.find($=>$.payload.id===g.payload.id);v&&v.kind!=="image"&&v.kind!=="tap"&&v.kind!=="timeline"&&(v.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
    ...
    </details>`}};H([Vt({attribute:!1})],I.prototype,"hass",2),H([Vt({type:Boolean})],I.prototype,"narrow",2),H([Vt({attribute:!1})],I.prototype,"panel",2),H([_()],I.prototype,"colLeft",2),H([_()],I.prototype,"colRight",2),H([_()],I.prototype,"panelWidth",2),H([_()],I.prototype,"owners",2),H([_()],I.prototype,"ownerId",2),H([_()],I.prototype,"records",2),H([_()],I.prototype,"selectedId",2),H([_()],I.prototype,"draft",2),H([_()],I.prototype,"readOnlyReason",2),H([_()],I.prototype,"parseError",2),H([_()],I.prototype,"maxSchemaVersion",2),H([_()],I.prototype,"presets",2),H([_()],I.prototype,"occupied",2),H([_()],I.prototype,"serverToken",2),H([_()],I.prototype,"appliedToken",2),H([_()],I.prototype,"polling",2),H([_()],I.prototype,"sendPending",2),H([_()],I.prototype,"pages",2),H([_()],I.prototype,"templateResults",2),H([_()],I.prototype,"historySeries",2),H([_()],I.prototype,"templateError",2),H([_()],I.prototype,"templateFetchedAt",2),H([_()],I.prototype,"forced",2),H([_()],I.prototype,"showRaw",2),H([_()],I.prototype,"inspect",2),H([_()],I.prototype,"openSections",2),H([_()],I.prototype,"pickerOpen",2),H([_()],I.prototype,"pickerFilter",2),H([_()],I.prototype,"testValues",2),H([_()],I.prototype,"editingValue",2),H([_()],I.prototype,"thumbStep",2),H([_()],I.prototype,"layerDetail",2),H([_()],I.prototype,"addOpen",2),H([_()],I.prototype,"addDetail",2),H([_()],I.prototype,"multi",2),H([_()],I.prototype,"collapsed",2),H([_()],I.prototype,"activeFamily",2),H([_()],I.prototype,"picking",2),H([_()],I.prototype,"pickHoverId",2),H([_()],I.prototype,"listHoverIds",2),H([_()],I.prototype,"zoomed",2),H([_()],I.prototype,"helpOpen",2),H([_()],I.prototype,"showTaps",2),H([_()],I.prototype,"timestampActiveId",2),H([_()],I.prototype,"savedName",2),H([_()],I.prototype,"presetKind",2),H([_()],I.prototype,"presetEntity",2),H([_()],I.prototype,"newShapeChooser",2),H([_()],I.prototype,"previewCase",2),H([_()],I.prototype,"loadError",2),H([_()],I.prototype,"saveError",2),H([_()],I.prototype,"saving",2),H([_()],I.prototype,"conflict",2),H([_()],I.prototype,"remoteRevision",2),H([_()],I.prototype,"confirmDelete",2),H([_()],I.prototype,"moveTarget",2),H([_()],I.prototype,"moving",2),H([_()],I.prototype,"moveError",2),H([_()],I.prototype,"version",2);var vr=I;function xt(e){return String(e?.message??e)}function oh(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function jl(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function sh(e,n,t,i){let a=[{label:"Shows",value:lr(e,t)}],r=Ai(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function lh(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function dh(e,n,t,i){let a=r=>p`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return p`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${$e(e.payload.colorSlot.baseColorHex)}`;case"gauge":return p`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=Tt(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Mn(o).length} values`}case"timeline":{let r=ht(e.payload),o=r===void 0?[]:Rn(t.get(r)??""),s=Math.max(0,o.length-1);return`${lh(Oe(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${$e(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return je(e.payload.action)}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",vr);export{vr as WristAssistantPanel,Wl as columnFit,sh as layerFacts};
