...
`)}function Sl(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,mp(r));return{values:t,nullKeys:i}}function mp(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Br(e){let n=Yi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function fp(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(cr(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var gp=10800;function yp(e,n,t){let i=n==="always"||n==="auto"&&t<=gp;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Fl(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=yp(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function bp(e,n){return Et(e)===void 0?[]:Fl(qe(e)*60,xr(e.timeLabelCount),e.hourCycle,e.minutes,n)}function xp(e,n){return zi(e)?Fl(Math.round(e.historyMinutes)*60,xr(ni(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Xt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Je(e){let n=e.trim(),t=Xt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Xt(i)}function vp(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function wp(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function kp(e){let n=e.trim(),t=Xt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Xt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Xt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function $p(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Cp(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Sp(e,n,t){if(Fe(n))return e;let i=n,a=e,r=Xt(e.trim()),o=i.duration?kp(e):void 0;if(o!==void 0)a=$p(o);else if(i.relativeTime&&r!==void 0)a=wp(r);else{let s=Je(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):vp(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Cp(a);break}return a}function kn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Xe(e,n=240){return Rl(e,n).map(t=>t.value)}function Rl(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Tl(e,n,t){let i=Rl(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Ct({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ie,c=t.highColorHex??He,u=t.lowColorHex??Le,p=[],m=(y,v)=>{if(y==="")return;let C=p.at(-1);C&&C.colorHex===v?C.text+=y:p.push({text:y,colorHex:v})},g=0;return i.forEach((y,v)=>{m(e.slice(g,y.start),n);let C=v===o?c:v===s?u:l.length>0?_i(y.value,l,d):n,S=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,S),C),g=S}),m(e.slice(g),n),p}function El(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Tp(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function di(e,n=Tt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Ep(i.slice(a+1))})}return t}function Ep(e){try{return decodeURIComponent(e)}catch{return e}}function Mp(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Ml(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Fp(e,n,t){if(e===void 0)return 0;let i=Je(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var pt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=El(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Gt(n),i=Kt(n),a;t!==void 0?a=this.ctx.historySeries?.get(t)??"":i!==void 0?a=this.ctx.historySeries?.get(i)??"":a=this.resolve(n.value)??"";let r=Xe(a);return n.limit>0&&r.length>n.limit?n.takeFromEnd?r.slice(r.length-n.limit):r.slice(0,n.limit):r}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Je(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):El(a.get(s)??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Fe(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?fp(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Us(r):cr(r,a.domainMax-a.domainMin));break}default:{let a=Vr(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Sp(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Xt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?kn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Je(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Je(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Je(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=qt(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:qt(d),p=c===void 0?void 0:qt(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Me[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Tl(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=je(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(v=>v.text).join(""),y):(zs(n.payload)&&(y.spans=Tl(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,v=m??p;y===void 0&&v.startsWith("mdi:")&&(v="questionmark.circle");let C={kind:"icon",...u,symbol:v,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(C.path=y),C}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(z,U,te)=>z??(U?Je(this.resolve(U)??""):void 0)??te,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),v=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),C=m===void 0?void 0:Je(m),S=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&C!==void 0&&(S=_i(C,Ct(p),p.bandAboveColorHex));let k=v-y;if(p.total){let z=Je(this.resolve(p.total)??"");z!==void 0&&(k=z)}let $=Ml(k,1,Li),O={kind:"gauge",...u,fraction:Fp(m,y,v),style:p.style,lineWidth:p.lineWidth,colorHex:S,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:$,filledCount:Ml(C??0,0,$)};if(p.thresholdValue!==void 0&&v!==y){let z=(p.thresholdValue-y)/(v-y);z>=0&&z<=1&&(O.thresholdFraction=z)}return O}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y={min:m.domainMin,max:m.domainMax},v=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Ct(p),S=Bs(p)?g.map(T=>_i(T,C,p.bandAboveColorHex)):[],k=p.highlight==="highest"||p.highlight==="both",$=p.highlight==="lowest"||p.highlight==="both",O=wt(p),z={kind:"chart",...u,values:g,style:p.style,domainMin:y.min,domainMax:y.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:v,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:k?O.high:"none",lowMarker:$?O.low:"none",pointColorHexes:S,fillBands:p.fillBands,thresholdColorHex:p.thresholdColorHex,nowColorHex:p.nowColorHex,labels:xp(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove};if(g.length>0){let T=k?g.indexOf(Math.max(...g)):-1,V=$?g.indexOf(Math.min(...g)):-1;T>=0&&(z.highIndex=T),V>=0&&V!==T&&(z.lowIndex=V)}let U=Tp(p,y.min,y.max);U!==void 0&&(z.thresholdY=U);let te=this.chartNowIndex(p,g.length);return te!==void 0&&(z.nowIndex=te),z}case"timeline":{let p=n.payload,m=Et(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=di(g,Tt),v=Mp(y,qe(p)*60,S=>Ys(S,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:v,gap:p.gap,cornerRadius:p.cornerRadius,labels:bp(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};ot(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=ll(n,t).map(y=>this.resolveElement(y,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,v=this.resolve(y.value),C=v===void 0?void 0:Je(v);if(C!==void 0){let S=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),$={value:Math.min(k,Math.max(S,C)),minValue:S,maxValue:k===S?S+1:k,colorHexes:y.colorHexes},O=this.resolve(y.minLabel);O!==void 0&&($.minLabel=O);let z=this.resolve(y.maxLabel);z!==void 0&&($.maxLabel=z),s.bezelGauge=$}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Rp(e,n,t){let i=new pt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Ji(e,n,t){let i=new pt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Rp(e.inline,n,e)),a}var Se=be,ui=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Se,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=ui.find(e=>e.measured);function Ol(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return ui.find(a=>a.screen.width===t&&a.screen.height===i)}function Zi(e,n){let t=Se[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Kr={regular:400,medium:500,semibold:600,bold:700},Ip=1.15;function Ze(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function me(e,n,t="#FFFFFF"){let i=Ze(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Dl(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var ht=e=>e*.55;function Vl(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Ap(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Hp(e,n,t){if(t<=0||e.length*ht(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/ht(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Lp(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Bl(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Ul(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function _p(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Gl(e,n){return e.reduce((t,i)=>t+i.text.length*ht(i.look.fontSize*n),0)}function Pp(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:ht(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=ht(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Np(e,n,t){if(t<=0||Gl(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*ht(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*ht(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function zp(e,n,t){let i=_p(n),a=e.lineLimit===2&&t.w>0?Pp(e.text,i,t.w):[e.text],r=Bl(e.text,a),o=a.map((S,k)=>Ul(S,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(S=>Gl(S,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(S=>Np(S,l,t.w)),{anchor:c,x:u}=Vl(e.alignment,t),p=Math.max(0,...d.flat().map(S=>S.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=S=>S.map(k=>{let $=me(k.look.colorHex,"fill");return w`<tspan font-size=${k.look.fontSize*l} font-weight=${Kr[k.look.fontWeight]??400} fill=${$.fill} fill-opacity=${$["fill-opacity"]}>${k.text}</tspan>`}),v=me(e.colorHex,"fill"),C=d.length>1?w`${d.map((S,k)=>w`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*g}>${y(S)}</tspan>`)}`:y(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${v.fill} fill-opacity=${v["fill-opacity"]}>${C}</text>`}function Op(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:zp(e,e.parts,n);let t=me(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:kn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Ap(e.text,n.w/ht(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*ht(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Hp(y,o,n.w)),{anchor:l,x:d}=Vl(e.alignment,n),c=Lp(e.text,e.spans),u=c?Bl(e.text,i):[],p=(y,v)=>c?Ul(y,u[v]??0,e.text,c,e.colorHex).map(C=>{let S=me(C.look,"fill");return w`<tspan fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${C.text}</tspan>`}):y,m=o*1.15,g=s.length>1?w`${s.map((y,v)=>w`<tspan x=${d} y=${n.cy+(v-(s.length-1)/2)*m}>${p(y,v)}</tspan>`)}`:p(s[0],0);return w`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Kr[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var Ur=2;function Dp(e,n){let t=me(e.colorHex,"stroke"),i=me(e.trackColorHex,"stroke","#FFFFFF"),a=me(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,g=Math.max(1,e.dotCount),y=m?n.w:n.h,v=m?n.h:n.w,C=Math.max(1,Math.min(v,y/g-Ur)),S=g*C+(g-1)*Ur,k=(m?n.cx:n.cy)-S/2+C/2;return w`${Array.from({length:g},($,O)=>{let z=k+O*(C+Ur),U=O<e.filledCount?t:i;return w`<circle cx=${m?z:n.cx} cy=${m?n.cy:z} r=${C/2}
    ...
    </g>`}function Vp(e,n,t,i,a){let r=me(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return w`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var Bp=5;function Up(e,n){let t=e.values,i=Math.max(t.length,1),r=e.highIndex!==void 0&&e.highMarker!=="none"||e.lowIndex!==void 0&&e.lowMarker!=="none"?Bp:0,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,c=Math.max(n.h-r-o*2,1),u=d+c,p=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?c*.12:0,y=Math.min(Math.max(e.barGap,0),l/(i*2)),v=Math.max((l-y*(i-1))/i,.5),C=k=>Math.min(1,Math.max(0,(k-e.domainMin)/p)),S=k=>u-C(k)*c;return{count:t.length,barWidth:v,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:m?u:S(0),yAtFraction(k){return u-Math.min(Math.max(k,0),1)*c},barRect(k){let $=s+k*(v+y),O=t[k],z,U;if(m){let te=g+C(O)*(c-g);z=u-te,U=u}else z=S(O),U=m?u:S(0),z>U&&([z,U]=[U,z]);return{x:$,y:z,w:v,h:Math.max(U-z,.5)}},point(k){let $=Math.max(l-o*2,0);return{x:t.length>1?s+o+$*k/(t.length-1):s+l/2,y:S(t[k])}},markerCenter(k,$){let O=$?this.barRect(k):void 0;return{x:O?O.x+O.w/2:this.point(k).x,y:n.y+r/2}}}}function Gp(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Kl(e,n),o=r?Wl(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:w`${o}`;let s=Kp(e,a);return o===void 0?s:w`${s}${o}`}function Kp(e,n){let t=Up(e,n),i=me(e.colorHex,"fill"),a=me(e.highColorHex,"fill",e.colorHex),r=me(e.lowColorHex,"fill",e.colorHex),o=(u,p)=>w`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${p.fill} fill-opacity=${p["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?me(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let p=t.barRect(u),m=u===e.highIndex?a:u===e.lowIndex?r:d(u),g=Math.min(1.2,p.w/2,p.h/2);s.push(w`<rect x=${p.x} y=${p.y} width=${p.w} height=${p.h} rx=${g}
        fill=${m.fill} fill-opacity=${m["fill-opacity"]} />`)}else{let u=Array.from({length:t.count},(m,g)=>t.point(g)),p=u.map((m,g)=>`${g===0?"M":"L"}${m.x} ${m.y}`).join(" ");if(e.style==="area")if(e.fillBands&&l&&t.count>1)for(let m=0;m<t.count-1;m++){let g=u[m],y=u[m+1],v=d(m+1),C=`M${g.x} ${g.y} L${y.x} ${y.y} L${y.x} ${t.baselineY} L${g.x} ${t.baselineY} Z`;s.push(w`<path d=${C} fill=${v.fill}
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?w`${s}${Wl(e,n,t,i)}`:w`${s}`}function jp(e,n){let t=me(e.fillColorHex,"fill"),i=e.borderColorHex?Ze(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return w`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function qp(e,n,t){if(e.path!==void 0&&e.path!==""){let o=me(e.colorHex,"fill"),s=e.size*Ip;return w`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Jr=.25,Yp=8;function Jp(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Jr),Yp),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),v=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+v)+0,width:m,height:g}}function Qi(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Xi=4;function ea(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Xi:n.x+n.w-Xi-a,d=e.timestampCorner.startsWith("top")?n.y+Xi:n.y+n.h-Xi-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Xp(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Zp(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ea(e,n,Qi(new Date)):void 0,s=o?w`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,g])=>w`<rect data-ts-corner=${p} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=Jp(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=w`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
    ...
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Qp(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?eh(a,n):void 0;return w`
    ...
    ${o!==void 0?w`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Wr} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?w`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var Wr=5;function eh(e,n){let t=Wr*.55,i=n.w-2;if(n.h<Wr*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function jr(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=Dl(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=Op(e,l);break;case"icon":c=qp(e,l,t.icons);break;case"gauge":c=Dp(e,l);break;case"chart":c=Gp(e,l);break;case"timeline":c=Wp(e,l);break;case"shape":c=jp(e,l);break;case"image":c=Zp(e,l,t);break;case"tap":c=Qp(e,l,t.icons,a,d?st(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,p=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,y=t.handles===!0&&(!s||o),v=g?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,C=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,S=w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,k=3,$=m&&y?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([O,z,U])=>w`<rect data-handle=${O} x=${z-k/2} y=${U-k/2} width=${k} height=${k}
    ...
    ${e.maxLabel!==void 0?v(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function na(e,n){let t=e.family in Se?e.family:"rectangular",i=n.slot??Se[t],a=Se[t],r=Zi(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ze(e.backgroundColorHex),l=Ze(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,y=!!e.bezelText||!!e.bezelGauge,v=e.curvedText??"",C=v!=="",S=ta(g,y),k=Xr(g,y),$=k/(a.width*g),O=S.tile.cx-k/2,z=S.tile.cy-k/2,U=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,te=f;if(e.bezelGauge)te=rh(e.bezelGauge,g,o);else if(e.bezelText){let V=th(g,`${o}-bezel`),X=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?kn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;te=w`<defs><path id=${V.id} d=${V.d} /></defs>
        <text font-size=${Il*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${V.id}" startOffset="50%" text-anchor="middle">${Hl(X,V.length,Il*g)}</textPath></text>`}let T=f;if(C){let V=Ze(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},X=ql(g,`${o}-curved`,nh*g,ih);T=w`<defs><path id=${X.id} d=${X.d} /></defs>
        <text font-size=${Ll*g} font-weight="600" fill=${V.color} fill-opacity=${V.opacity}
          ...
          <textPath href="#${X.id}" startOffset="50%" text-anchor="middle">${Hl(v,X.length,Ll*g*.88)}</textPath></text>`}else{let V=e.borderWidth*r.scale*$,X=l?w`<circle cx=${k/2} cy=${k/2} r=${k/2-V/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${V} />`:f;T=w`<g transform="translate(${O} ${z})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${kh(e)}</svg>`}var et="color-mix(in srgb, var(--k) 45%, #6b7280)",pa='system-ui, -apple-system, "Segoe UI", sans-serif';function wd(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function lo(e,n,t,i){return w`<g fill="none" stroke-linecap="round">
    <path d=${wd(e,n,t,1)} stroke=${et} stroke-width="2.6" opacity=".5" />
    <path d=${wd(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function $h(e){switch(e){case"text":return w`<g font-family=${pa} text-anchor="middle">
        ...
        <text x="6" y="39" font-family=${pa} font-size="7" fill=${et}>1h ago</text>
        <text x="114" y="39" font-family=${pa} font-size="7" text-anchor="end" fill=${et}>now</text>
    ...
    <textarea rows=${i} .value=${n} class="mono" @input=${pe(t)}></textarea></label>`}function oe(e,n,t,i={}){return h`<label class="field num">${Ae(e,Rt(n,i.def,t),Aa(n,t,i))}${Ha(n,t,i)}</label>`}function Ha(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e),a=h`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??f} max=${t.max??f}
      aria-label=${t.ariaLabel??f} placeholder=${t.placeholder??f}
      @input=${pe(r=>{if(r.trim()===""){t.optional&&n(void 0);return}let o=Number(r);Number.isNaN(o)||n(o)})} />`;return t.unit===void 0&&t.lead===void 0?a:h`<span class=${t.lead===void 0?"num-box":"num-box lead"} style=${`--wa-unit:${t.unit?.length??0}`}>${t.lead===void 0?f:h`<span class="lead" aria-hidden="true">${t.lead}</span>`}${a}${t.unit===void 0?f:h`<span class="unit" aria-hidden="true">${t.unit}</span>`}</span>`}function Pe(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<label class="field">${Ae(e,Rt(n,a.def,i,r))}
    <select @change=${pe(o=>i(o))}>
      ${t.map(([o,s])=>h`<option value=${o} ?selected=${o===n}>${s}</option>`)}
    </select></label>`}function J(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<div class="field seg-field">${Ae(e,Rt(n,a.def,o=>i(o,null),r))}
    ...
    </div>`}function _h(e,n){let t=i=>Rt(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${Ae(e.label,t(e))}
    <div class="pair-row">
      ${Ca(e.label,e.value,e.options,e.set,e)}
      ${Ae(n.label,t(n))}
      ${Ca(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function xi(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Ae(e,Rt(n,i.def,t,a),Aa(n,t,i))}
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${k=>{let $=k.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),tn.set(a,{query:"",index:0}),$e($),$?.focus()}}>${D("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${rc(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,$)=>h`<button type="button" role="option" aria-selected=${$===d?"true":"false"} class="ent ${$===d?"hl":""}"
  ...
  </div>`}function Vh(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Nd=120;function Bh(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(la.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(da),fromPack:!1}}function zd(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Uh(e){return[{value:"",label:`Starter set (${zd(da,e)})`},...la.map(n=>({value:n.name,label:`${n.name} (${zd(n.symbols,e)})`}))]}function Gh(e){return e.length>0?e.length:da.length}function Od(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function fa(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function oc(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Re),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=Kh(u,c),v=k=>{t(k),a?.(k.startsWith(Re)?e.icons.mdiPath?.(k):void 0),r.noteUsed(k)},C=k=>{if(t(k),!m)return;let $=k.trim();a?.($.startsWith(Re)?e.icons.mdiPath?.($):void 0)},S=f;if(o&&g==="mdi"){let k=e.icons.mdiNames?.(),$=Wh(k??[],s),O=$.slice(0,Nd),z=r.recent.filter(U=>U.startsWith(Re));S=h`<div class="sym-browse">
      ${Dd(r,i,g)}
      ...
      ${z.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${z.map(U=>fa(e,U,U===u,v))}</div>`}
      <div class="sym-grid">${O.map(U=>fa(e,U,U===u,v))}</div>
      ${k===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:$.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Od(O.length,$.length,!0,k.length)}</div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${pe(C)} @change=${pe(k=>{let $=k.trim();$.startsWith(Re)?e.icons.mdiPath?.($)!==void 0&&r.noteUsed(k):(c.size===0||c.has($))&&r.noteUsed(k)})} /></label>
    ...
    ${S}`}function Kh(e,n){let t=e.trim();return t!==""&&!t.startsWith(Re)&&n.size>0&&!n.has(t)}function Wh(e,n){let t=n.trim(),i=t.startsWith(Re)?t.slice(Re.length):t,a=e.map(r=>r.startsWith(Re)?r.slice(Re.length):r);return no(a,i).map(r=>Re+r)}function Dd(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
    ...
    ${vi.has(n)?cc(e,i,a,r):f}
  </div>`}function he(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function _a(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function sm(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var vi=new Set,gi=new WeakMap;function lm(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function lc(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function dc(e){let n=e.currentTarget,t=e.newState==="open",i=gi.get(n);if(i&&(i(),gi.delete(n)),!t){vi.delete(n.id)&&$e(n);return}let a=lm(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){gi.get(n)?.(),gi.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}bo(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),gi.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),bo(n,a.getBoundingClientRect()),vi.has(n.id)||(vi.add(n.id),$e(n),requestAnimationFrame(()=>{n.isConnected&&bo(n,a.getBoundingClientRect())}))}function bo(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=dm({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var en=8,ga=6,Ud=140;function dm(e,n,t){let i=t.height-e.bottom-ga-en,a=e.top-ga-en,r=n.height>i&&a>i&&i<Ud,o=Math.max(Ud,r?a:i),s=Math.min(n.height,o),l=Math.max(en,Math.min(e.left,t.width-n.width-en)),d=r?Math.max(en,e.top-ga-s):Math.max(en,Math.min(e.bottom+ga,t.height-s-en));return{left:l,top:d,maxHeight:o,above:r}}function cc(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=jh.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?oc(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):fe("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=nt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${nt(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${fe("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=um(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Pe("Field",a.timeField,rm,c=>r({...a,timeField:c}));break;case"dataAge":l=h`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=h`${nc("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":l=e.config.values.length===0?h`<div class="hint warn">There are no named values yet. Add one in the Data card first.</div>`:Pe("Value",a.id,[["","(choose)"],...e.config.values.map(c=>[c.id,c.name||c.id.slice(0,8)])],c=>r({...a,id:c}));break;case"chartStat":{let c=he(e),u=e.config.elements.filter(p=>p.kind==="chart");l=u.length===0?h`<div class="hint warn">There is no chart layer yet. Add one first, then this can print one of its numbers.</div>`:h`
          ${Pe("Chart",a.layer,[["","(choose)"],...u.map(p=>[p.payload.id,ze(p,c)])],p=>r({...a,layer:p}))}
    ...
    ${Pe("Source",a.kind,s,c=>r(om(a,c)))}
    ${l}
    ${i.noFormat?f:cm(n.format,c=>t(Fe(c)?{kind:n.kind}:{...n,format:c}))}
    ${i.showResolved?h`<div class="hint keep">Now:${d===void 0?h`<span class="warn">unresolved</span>`:h`<code>${d}</code>`}</div>`:f}`}function cm(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return h`<details class="sub" ?open=${!Fe(e)}>
    ...
    ${Ne("Append the entity's unit",!!t.useEntityUnit,a=>i({useEntityUnit:a}))}
    ...
    ${n.function==="count"?f:fe("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var uc=Sr,pm=uc.filter(([e])=>e!=="none");function hm(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function pc(e,n){let t=hm(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return Xs(e)?{type:e,...t}:{type:e}}var mm=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function hc(e,n,t,i){let a=n.serviceDataJSON??"",r=Zs(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    ${"entityId"in t?nt(e,"Target",t,s=>e.update(l=>{l.tapAction={type:t.type,...s}},"tap-entity"),"general-tap"):f}
    ${t.type==="callService"?hc(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?ym(e):f}`}var gm="#808080",Gd=[0,15,30,60,120];function Kd(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function ym(e){let n=e.config;return fc(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function fc(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Pe("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Lm(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Ee(e.config,t,n),o=r.frame,s=(d,c)=>e.update(u=>Te(u,t,i,{frame:co(o,d)}),`${a}-${c}-${t}`),l=!Ea(o,Zn)||r.isHidden;return ge(e,"placement","Position",h`
    <div class="xy">
    ...
    <div class="hint">X, Y, W and H are a percent of the face, on the ${Q(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:ee.place,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${Q(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${Q(t)} face at half size, unrotated and shown`,reset:()=>e.update(d=>Te(d,t,i,{frame:{...Zn},isHidden:!1}))}:{}})}function _m(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=_e(e.config,t)[0];return ge(e,"tappable","Tap",sf(e,n,`el-${t}`),{color:ee.tap,icon:"tap",summary:i?st(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Gi(a,t))}:{}})}function Yd(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${J("Clock",e.hourCycle,Ws,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${J("Minutes",e.minutes,js,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var Pm=[["number","Number"],["entity","Entity"]];function Nm(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function zm(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Om(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=Nm(n,o),c=s?n.minValue:n.maxValue,u=y=>a(v=>{s?v.minValue=y??0:v.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Ae(l,d==="number"?Rt(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Pm.map(([y,v])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          ...
          @click=${()=>{y!==d&&a(C=>zm(C,o,y))}}>${v}</button>`)}
      </span>
    ...
    ${i==="bands"?h`
      ...
      ${Ta({bands:n.bands??[],bandAboveColorHex:n.bandAboveColorHex??ie},n.colorSlot.baseColorHex,r,l.length===1?l[0]:void 0)}`:f}
    ${J("Highlight",a,Lo,d=>t(c=>{d==="none"?delete c.highlight:c.highlight=d}),{def:"none"})}
    ${a==="none"?f:h`
      <div class="grid2">
        ${a==="lowest"?f:le("Highest colour",n.highColorHex??He,d=>o("highColorHex",He,d),!1,He)}
        ${a==="highest"?f:le("Lowest colour",n.lowColorHex??Le,d=>o("lowColorHex",Le,d),!1,Le)}
      </div>
      ${i==="bands"?f:h`<div class="hint">${s}, and other text keeps the layer colour.</div>`}`}`}var bi=new Map,yi=new Map,tt=new Map,xa=new Map,ko=4,$o=40,Vm=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Bm=[["plain","Plain"],["rich","Rich"],["countdown","Countdown"]],Um={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size",countdown:"Ticks down to a time"};function Gm(e){return e.countdown===!0?"countdown":je(e)?"rich":"plain"}function Km(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Wm(e,n){let t=un(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ue(e.kind.value,40)||"template"}:{kind:"value",label:za(e,n)}}function vc(e,n,t){let i=un(e.value),a=i===void 0?Ue(za(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ue(i,24)}"`;return`Part ${n+1}: ${a}`}function jm(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,vc(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function Mo(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function qm(e,n){if(Mo(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Ct({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??ie],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function Jd(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${Na(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Ym={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Jm(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${Na(e.moved.map(n=>Ym[n]))} moved into Look.`}function Xm(e,n,t,i,a){let r=n.payload,o=r.id,s=Gm(r),l=(r.parts?.length??0)>0,d=Tr(e.config,r.value),c=tt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?yi.get(o):void 0,m=(v,C)=>{let S=!(r.parts??[]).every($=>$.value.kind.kind==="literal"),k=ma(structuredClone(r),e.config.values);if(yi.delete(o),!k.ok){tt.set(o,{text:Jd(k.blocked),rich:!0,warn:!0}),$e(C);return}tt.set(o,{text:Jm(k.joined?{joined:!0,template:S}:k),rich:!1}),i($=>{ma($,e.config.values),v==="countdown"&&($.countdown=!0)})},g=(v,C)=>{if(yi.delete(o),s==="rich"){let S=v==="countdown"?"countdown":"plain",k=r.parts??[];if(k.length<2){m(S,C);return}let $=fo(k,e.config.values);$.ok?(tt.delete(o),yi.set(o,S)):tt.set(o,{text:Jd($.blocked),rich:!0,warn:!0}),$e(C);return}if(v==="rich"){let S=r.parts?.[0]?.id??Y();bi.set(o,S),l?tt.delete(o):tt.set(o,{text:"Your text is now Part 1. Add more with the buttons after the chips.",rich:!0}),i(k=>{delete k.countdown,Ld(k,S)});return}tt.delete(o),i(S=>{if(v==="countdown"){S.countdown=!0;return}(S.parts?.length??0)>0&&ma(S,e.config.values),delete S.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${J("Type",s,Bm,g,{titles:Um})}
    ...
    ${s==="rich"?Zm(e,n,t,i,a):h`
        ${se(e,r.value,v=>i(C=>{C.value=v},"value"),{showResolved:!0,label:s==="countdown"?"Until":"Text",key:`${a}-value`})}
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${ze(d,he(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Zm(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=he(e),d=Math.max(0,o.findIndex(F=>F.id===bi.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Ee(e.config,t,n).size??r.fontSize,g=(F,b)=>{tt.delete(s),i(x=>{F(x),Os(x)},b)},y=(F,b)=>g(x=>{let A=x.parts?.find(E=>E.id===c.id);A&&F(A)},b?`part-${c.id}-${b}`:void 0),v=(F,b)=>{bi.set(s,F),tt.delete(s),$e(b)},C=(F,b)=>{let x=Y();bi.set(s,x),g(A=>{(A.parts??=[]).push({id:x,value:F})}),lc(b,_a(`${a}-part-${x}`),!0)},S=F=>g(b=>{b.parts&&wi(b.parts,d,F)}),k=()=>{let F=o[d+1]??o[d-1];F&&bi.set(s,F.id),g(b=>{b.parts=(b.parts??[]).filter(x=>x.id!==c.id)})},$=o.map((F,b)=>{let x=Wm(F.value,l),A=F.id===c.id,E=Mo(F),P=x.kind==="value"?e.resolve(F.value):void 0,B=F.fontWeight===void 0?void 0:Mn.find(([K])=>K===F.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${A?"true":"false"} class="part-chip ${x.kind} ${A?"on":""}"
      aria-label=${vc(F,b,l)} @click=${K=>v(F.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${qm(F,p)}`}
    ...
    </button>`}),O=r.rules.some(F=>F.partId===c.id),z=c.value.kind.kind==="literal",U=Mo(c),te=c.fontSize!==void 0,T=Mn.find(([F])=>F===r.fontWeight)?.[1]??r.fontWeight,V=F=>{F>=ko&&F<=$o&&y(b=>{b.fontSize=F},"size")},X=U==="bands"?Xe(e.resolve(c.value)??""):[],W={layer:"Use the layer colour",...z&&U!=="bands"?{bands:"By value needs a live value"}:{}},ye=(F,b)=>y(x=>{let A={bands:x.bands??[],bandAboveColorHex:x.bandAboveColorHex??ie};F(A),A.bands.length>0?x.bands=A.bands:delete x.bands,A.bandAboveColorHex!==ie?x.bandAboveColorHex=A.bandAboveColorHex:delete x.bandAboveColorHex},b);return h`<div class="rich-parts">
    <div class="part-row">
      <div class="part-chips" role="listbox" aria-label="Parts">${$}</div>
      <span class="part-add">
        <button type="button" class="icon" title="Add text" aria-label="Add text"
          @click=${F=>C(H(""),F.currentTarget)}>${D("text")}</button>
        <button type="button" class="icon" title="Add a value" aria-label="Add a value"
          @click=${F=>C({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},F.currentTarget)}>${D("braces")}</button>
      </span>
    </div>
    <div class="part-editor">
      ...
      ${J("Colour",U,Vm,F=>y(b=>{if(F==="layer"){delete b.colorHex,delete b.coloring;return}if(F==="pick"){delete b.coloring,b.colorHex=Ao(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Sa(Xe(e.resolve(b.value)??"")))}),{def:"layer",titles:W,...z&&U!=="bands"?{disabled:{bands:!0}}:{}})}
      ${U==="pick"?h`<div class="sub-field">${le("Part colour",c.colorHex,F=>y(b=>{b.colorHex=F??p},"color"))}</div>`:f}
      ${U==="bands"?h`
        ${Ta({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??ie},c.colorHex??p,ye,X.length===1?X[0]:void 0)}
        <div class="hint">These bands belong to this part. Another value in the same layer keeps its own.</div>`:f}
      <div class="field seg-field">${Ae("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>y(F=>{delete F.fontWeight})})}
        ${Ca("Weight",c.fontWeight,Mn,F=>y(b=>{b.fontWeight=F}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Ae("Font size",te?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(F=>{delete F.fontSize})}:void 0,Aa(c.fontSize??m,V,{step:1,min:ko,max:$o}))}
        ${Ha(c.fontSize,F=>{F===void 0?y(b=>{delete b.fontSize},"size"):V(F)},{step:1,min:ko,max:$o,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:te?"Part font size":`Part font size, ${m} pt from the layer`,...te?{}:{lead:D("link")}})}
      </label>
    </div>
  </div>`}function wc(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,x)=>e.update(A=>b(A.elements[r]),x?`${o}-${x}`:void 0),l=Ee(e.config,t,n),d=l.frame,c=(b,x)=>e.update(A=>Te(A,t,a,{frame:co(d,b)}),`${o}-${x}-${t}`),u=We(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],g,y;switch(n.kind){case"text":{let b=(x,A)=>s(E=>x(E.payload),A);g=Xm(e,n,t,b,o),y=h`
        ${ya(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${J("Weight",n.payload.fontWeight,Mn,x=>s(A=>{A.payload.fontWeight=x}),{def:u.fontWeight})}
        ${_h({label:"Align",value:n.payload.alignment??"center",options:vm,def:"center",set:x=>s(A=>{let E=A.payload;x==="center"?delete E.alignment:E.alignment=x})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:wm,def:"1",set:x=>s(A=>{let E=A.payload;x==="2"?E.lineLimit=2:delete E.lineLimit})})}
        ${Ne("Monospaced digits",n.payload.monospacedDigits===!0,x=>s(A=>{let E=A.payload;x?E.monospacedDigits=!0:delete E.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${n.payload.countdown||je(n.payload)?f:Dm(e,n.payload,b)}`;break}case"icon":g=h`
        ${se(e,n.payload.symbol,b=>s(x=>{x.payload.symbol=b},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${o}-symbol`,setSymbolPath:b=>s(x=>{let A=x.payload;b?A.path=b:delete A.path},"symbol")})}
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,y=ya(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let b=n.payload,x=(E,P)=>s(B=>E(B.payload),P),A=b.style==="dots";g=h`
        ...
        ${A?h`
            ...
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Li} dots are drawn.</div>`:Om(e,b,{min:u.minValue,max:u.maxValue},o,x)}`,y=h`
        <div class="grid2">
          ${J("Style",b.style,im,E=>x(P=>{E==="dots"&&P.total===void 0&&(P.total=Bd(P)),E!=="dots"&&delete P.total,P.style=E}),{titles:am,def:u.style})}
          ${A?f:ya(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${le(A?"Empty dot colour":"Track colour",b.trackColorHex,E=>x(P=>{P.trackColorHex=E??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${J("Colour",b.coloring,To,E=>x(P=>{P.coloring=E,E==="bands"&&P.bands.length===0&&(P.bands=Sa([P.minValue,P.maxValue]))}),{def:u.coloring})}
        ${b.coloring==="bands"?h`
          ...
          ${Ta(b,b.colorSlot.baseColorHex,x,Xe(e.resolve(b.value)??"")[0])}`:f}
        ${A?f:h`
          <div class="grid2">
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,x=(M,_)=>s(on=>M(on.payload),_),A=wt(b),E=sr(u.marker),P=u.historyMinutes,B=u.historyPoints,K=b.historyMinutes>0,ve=K&&b.source==="statistics",_t=K&&!ve,In=K?ve?"statistics":"history":"value",An=ve?ei:Ut,we=Gt(b)??Kt(b),ce=b.value.kind.kind==="entityState",it=we===void 0?void 0:e.historySeries(we),su=K&&ce?it??"":e.resolve(b.value)??"",at=b.historyPoints<1,jo=Eo(a,b.historyMinutes,An),Ge=Xe(su),Pt=b.limit>0&&Ge.length>b.limit?b.takeFromEnd?Ge.slice(Ge.length-b.limit):Ge.slice(0,b.limit):Ge,lu=!K&&ce&&Ge.length===1,Va=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),du=he(e),Ba=b.scaleFrom!==void 0&&Va.some(M=>M.payload.id===b.scaleFrom);g=h`
        ${se(e,b.value,M=>x(_=>{_.value=M},"value"),{label:"Readings",key:`${o}-value`})}
        ${J("Draw",In,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],M=>x(_=>{if(M==="value"){_.historyMinutes=0;return}_.source=M==="statistics"?"statistics":"history";let on=_.historyMinutes||Pi;_.historyMinutes=M==="statistics"?Math.min(on,ur):Math.min(on,Ni)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${ve?h`
            ...
            <div class="grid2">
              ${vo(a,b.historyMinutes,P,M=>x(_=>{_.historyMinutes=M}),ei)}
              ${J("Per",b.statPeriod,Hi,M=>x(_=>{_.statPeriod=M}),{def:Jn})}
            </div>
            ${jo?wo(b.historyMinutes,M=>x(_=>{_.historyMinutes=M},"span"),!0):f}
            ${J("Read",b.statType,rr,M=>x(_=>{_.statType=M}),{def:Xn})}
            ...
            ${ce&&it===void 0?h`<div class="hint keep">Reading the statistics…</div>`:f}
            ${ce&&it===""?h`<div class="hint warn">No long-term statistics for this entity in that span.
        ...
        ${_t?h`
            ${ce?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${vo(a,b.historyMinutes,P,M=>x(_=>{_.historyMinutes=M}))}
              <div class="field readings-field">${Ae("Readings",{atDefault:b.historyPoints===B,title:`Back to ${B<1?"every one":`${B} averaged`}`,reset:()=>x(M=>{M.historyPoints=B})})}
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Readings">
                    <button type="button" role="radio" aria-checked=${at?"false":"true"} class=${at?"":"on"}
                      title="Average the recorded states into this many equal time slots"
                      @click=${()=>{at&&x(M=>{M.historyPoints=24})}}>Average</button>
                    <button type="button" role="radio" aria-checked=${at?"true":"false"} class=${at?"on":""}
                      title="Plot every recorded state change, no averaging"
                      @click=${()=>{at||x(M=>{M.historyPoints=hr})}}>Every one</button>
                  </div>
                  ${at?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${pe(M=>{let _=Number(M);M.trim()!==""&&Number.isFinite(_)&&_>=1&&x(on=>{on.historyPoints=Math.round(_)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${jo?wo(b.historyMinutes,M=>x(_=>{_.historyMinutes=M},"span")):f}
            <div class="hint">${at?h`Every state the recorder holds in that span, oldest first, one reading per change,
            ...
            ${ce&&it===void 0?h`<div class="hint keep">Reading the history…</div>`:f}
            ${ce&&it===""?h`<div class="hint warn">Nothing recorded for this entity in that span.
        ...
        ${Ge.length===0&&!(K&&(!ce||it===void 0||it===""))?h`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${Ge.length>0?h`<div class="hint keep">Reads <span class="nums">${Em(Pt)}</span>${Ge.length===Pt.length?h` · ${Pt.length} ${Pt.length===1?"value":"values"}`:h` · ${Pt.length} of ${Ge.length}`}</div>`:f}
        ...
        <div class="grid2">
          ${oe("Use",b.limit,M=>x(_=>{_.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:u.limit})}
          ${J("From",b.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],M=>x(_=>{_.takeFromEnd=M==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        <div class="hint">${K?"Trims the series after it arrives, so 0 draws every reading fetched above.":"A forecast sensor often carries 24 or 48 entries. 0 draws all of them."}</div>`,y=h`
        <div class="grid2">
          ${J("Style",b.style,qh,M=>x(_=>{_.style=M}),{def:u.style})}
          ${b.style==="bars"?oe("Bar gap",b.barGap,M=>x(_=>{_.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):ya(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${J("Scale",b.scale,Yh,M=>x(_=>{_.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${J("Baseline",b.baseline,Jh,M=>x(_=>{_.baseline=M}),{def:u.baseline})}
        </div>
        ${Va.length===0?f:Pe("Same scale as",Ba?b.scaleFrom:"",[["","Its own"],...Va.map(M=>[M.payload.id,ze(M,du)])],M=>x(_=>{M?_.scaleFrom=M:delete _.scaleFrom}),{def:""})}
        ...
        ${!Ba&&b.scale==="fixed"?h`<div class="grid2">
              ${oe("Min",b.minValue,M=>x(_=>{_.minValue=M??0},"cmin"),{def:u.minValue})}
              ${oe("Max",b.maxValue,M=>x(_=>{_.maxValue=M??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let M;e.update(_=>{M=hl(_,a)}),M&&e.selectLayer(M)}}>
          ${D("plus")}<span>Second series</span></button>
        ${J("Colour",b.coloring,To,M=>x(_=>{_.coloring=M,M==="bands"&&_.bands.length===0&&(_.bands=Sa(Pt))}),{def:u.coloring})}
        ${b.coloring==="bands"?h`
          ...
          ${b.style==="area"?h`${Ne("Fill follows the bands",b.fillBands,M=>x(_=>{_.fillBands=M}),u.fillBands)}
        ...
        ${J("Highlight",b.highlight,Lo,M=>x(_=>{_.highlight=M}),{def:u.highlight})}
        ${b.highlight==="none"?f:h`
          <div class="grid2">
            ${b.highlight==="lowest"?f:J("Highest marker",A.high,Vd,M=>x(_=>{lr(_,{...wt(_),high:M})}),{def:E.high})}
            ${b.highlight==="highest"?f:J("Lowest marker",A.low,Vd,M=>x(_=>{lr(_,{...wt(_),low:M})}),{def:E.low})}
          </div>
          <div class="grid2">
            ${b.highlight==="lowest"?f:le("Highest colour",b.highColorHex,M=>x(_=>{_.highColorHex=M??He},"hicol"),!1,He)}
            ${b.highlight==="highest"?f:le("Lowest colour",b.lowColorHex,M=>x(_=>{_.lowColorHex=M??Le},"locol"),!1,Le)}
          </div>
        ...
        ${Ne("Threshold line",b.thresholdValue!==void 0,M=>x(_=>{M?_.thresholdValue=Xh(Pt):delete _.thresholdValue}))}
        ${b.thresholdValue===void 0?f:h`
          <div class="grid2">
            ${oe("At",b.thresholdValue,M=>x(_=>{_.thresholdValue=M??0},"thval"))}
            ${le("Line colour",b.thresholdColorHex,M=>x(_=>{_.thresholdColorHex=M??hn},"thcol"),!1,hn)}
          </div>
        ...
        ${Ne("\u201CNow\u201D marker",b.nowIndex!==void 0,M=>x(_=>{M?_.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete _.nowIndex}))}
        ${b.nowIndex===void 0?f:h`
          ${se(e,b.nowIndex,M=>x(_=>{_.nowIndex=M},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${le("Marker colour",b.nowColorHex,M=>x(_=>{_.nowColorHex=M??mn},"nowcol"),!1,mn)}
        ...
        ${zi(b)?Yd(b,x,u,"cl",h`
            <div class="hint">Clock times from the start of the span to now, evenly spaced, in a row of
              ...
              the recorder had nothing for shifts the earlier times a little.</div>`):at&&_t?h`<div class="hint keep">Clock times needevenly spaced readings, so they are offered when
              ...
              Recorded history.</div>`}`;break}case"timeline":{let b=n.payload,x=(we,ce)=>s(it=>we(it.payload),ce),A=u.historyMinutes,E=b.value.kind.kind==="entityState",P=Et(b),B=P===void 0?void 0:e.historySeries(P),K=qe(b)*60,ve=di(B??"",Tt),_t=Eo(a,b.historyMinutes),In=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,An=tm(ve,K,In===void 0?void 0:e.hass.states[In]?.state,In?.split(".")[0]);g=h`
        ...
        ${vo(a,b.historyMinutes,A,we=>x(ce=>{ce.historyMinutes=we}))}
        ...
        ${ve.length>0?h`<div class="hint keep">Reads <span class="nums">${Am(ve,K)}</span></div>`:f}
        ${Im(ve)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
            ...
            number's past, use a Chart layer instead.</div>`:f}`,y=h`
        ...
        ${nm(b,x,An,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${n.payload.kind==="line"?Rm(t,d,c):f}`,y=n.payload.kind==="line"?oe("Thickness",n.payload.thickness,b=>s(x=>{x.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${n.payload.borderColorHex!==void 0?oe("Border width",n.payload.borderWidth,b=>s(x=>{x.payload.borderWidth=b??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let b=n.payload,x=(B,K)=>s(ve=>B(ve.payload),K),A=b.entity.entityId?e.hass.states[b.entity.entityId]?.attributes?.entity_picture:void 0,E=typeof A=="string"?A:void 0,P=E!==void 0&&!E.startsWith("/");g=h`
        ...
        ${b.source==="camera"?h`
            ...
            <div class="hint">The watch fetches the entity's own picture on refresh and shows the cached copy in between. This preview shows it live.</div>`}`,y=h`
        ...
        ${oe("Corner radius",b.cornerRadius,B=>x(K=>{K.cornerRadius=Math.max(0,B??fn)},"imgradius"),{step:1,min:0,def:fn,unit:"pt"})}`;break}case"tap":{g=h`
        ${kc(e,n.payload,(b,x)=>s(A=>b(A.payload),x),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let v=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:le(n.kind==="shape"?"Fill colour":n.kind==="text"&&je(n.payload)?"Colour (parts set to Layer)":"Colour",n.payload.colorSlot.baseColorHex,b=>s(x=>{x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=b??"#FFFFFF")},"color"),!1,p),C=Ir(e.config,n),S=C?{kind:{kind:"entityState",...C}}:void 0,k=xe[n.kind],$=n.kind==="image"?n.payload.timestamp===!0:!1,O=n.kind==="text"&&je(n.payload),z=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,U=ef[n.kind],te=tf[n.kind],T=qd(n.payload,u,U),V=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,X=e.config.perFamily[t]?.placements[a]?.size!==void 0,W=qd(n.payload,u,te)||V!==void 0&&l.size!==void 0&&l.size!==u[V],ye=Wt(e.config,a),F=(b,x)=>()=>s(A=>xo(A.payload,u,b),x);return h`
    ${ge(e,"content","Content",h`${n.kind==="tap"||O?f:km(e,n,o)}${g}`,{color:k,icon:"content",summary:_o(e,n),...T?{reset:()=>s(b=>{xo(b.payload,u,U),b.kind==="text"&&fi(b.payload.rules)},"reset-content")}:{}})}
    ${y===void 0&&v===void 0?f:ge(e,"look",n.kind==="image"?"Picture":"Look",h`${y??f}${v??f}`,{color:k,icon:n.kind==="image"?"image":"look",...Ma(n)?{summary:Ma(n)}:{},...W?{reset:()=>e.update(b=>{xo(b.elements[r].payload,u,te),X&&Te(b,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?ge(e,"numbers","Numbers",of(e,n),{color:xe.text,icon:"text",summary:rf(e,n),...ye.length>0?{reset:()=>e.update(b=>{for(let x of Wt(b,a))ut(b,x.payload.id)})}:{}}):f}
    ${n.kind==="image"?ge(e,"timestamp","Timestamp",Tm(n.payload,(b,x)=>s(A=>b(A.payload),x)),{color:k,icon:"clock",summary:$?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...$?{reset:F(Qm,"reset-stamp")}:{}}):f}
    ${ge(e,"states","States",Fc(e,n.payload.rules,n.kind,b=>b.elements.find(x=>x.payload.id===a)?.payload.rules,`rules-${a}`,S,z),{color:ee.states,icon:"states",summary:pi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Lm(e,n,t)}
    ${i.tap===!1?f:_m(e,n)}`}var Qm=["timestamp","timestampCorner","timestampSize"],ef={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},tf={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function kc(e,n,t,i){let a=n.action;return h`
    ${Pe("Tap action",a.type,pm,r=>t(o=>{o.action=pc(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?nt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?hc(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?fc(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var nf=24;function af(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=ul(e.config,n,r);o&&(t.push(`${Q(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<nf;return h`<div class=${a?"hint warn":"hint keep"}>${t.join(" \xB7 ")}${a?h`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function rf(e,n){let t=Wt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(cn.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function of(e,n){let t=he(e),i=Wt(e.config,n.payload.id),a=o=>e.update(s=>{rl(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return h`
    ...
    ${Ne("Tappable",a!==void 0,s=>e.update(l=>{s?Ui(l,i):Gi(l,i)}))}
    ...
    </div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Cc(e,n){if(n==="inline")return lf(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${Q(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Q(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=Pa(e.config,n),r=t.backgroundColorHex?Ie(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ie(t.borderColorHex)} border`:"no border";return h`
    ...
    ${n==="corner"?ge(e,"corner","Corner content",df(e,t,i),{color:ee.place,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${ge(e,"states","Shape states",Fc(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:ee.states,icon:"states",summary:pi(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${ge(e,"content","Inline text",h`
      ...
      ${Ne("Live countdown",n.countdown===!0,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}
      ${n.countdown?h`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:f}`,{color:xe.text,icon:"text",summary:Ue(`${n.label?`${n.label}: `:""}${Ce(n.value,i)}`,48)})}
    ${ge(e,"symbol","Symbol",h`
      ...
      <div class="hint keep">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:xe.icon,icon:"icon",summary:n.symbol||"None"})}`}function df(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="text"&&n.bezelText?h`
      ...
      ${Ne("Live countdown",n.bezelCountdown===!0,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:f}
    ...
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function yf(e,n,t,i,a,r,o,s){let l=e.liveBranch(n),d=e.forced.get(n.id)??"live",c=m=>d==="live"?m==="live":d==="otherwise"?m==="otherwise":d.caseId===m,u=(m,g)=>r(y=>{let v=y.find(C=>C.id===n.id);v&&m(v)},g),p=s!==void 0&&n.partId!==void 0;return h`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${Ne("Otherwise (when no case matches)",n.otherwise!==void 0,m=>u(g=>{m?g.otherwise=g.otherwise??[]:delete g.otherwise}))}
    ...
    </div></div>`}function Tc(e,n,t,i,a,r=!1){let o=pf(t,r);return h`
    ...
    </select>`}var Ec=["setColor","setBorderColor","setBackgroundColor"];function $f(e,n,t,i,a,r,o,s=!1){let l=!ji[i].includes(Me[n.kind]),d=s&&!l&&!Fa.includes(Me[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${Mc(e,n,a,o)}
  </div>`}function Mc(e,n,t,i){let a=qi(n.kind),r=f;if(a==="value"){let o=n.value??H("");if(Ec.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?le("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=H(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{Fo.delete(a),$e(d.target)}}>Show as table</button>
        ${s.ok?f:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${gf(e,n,t,i,a,o)}`:Cf(e,s.table,n[0],t,i,a,r,o)}function Cf(e,n,t,i,a,r,o,s){let l=(x,A)=>e.update(E=>{let P=a(E);P&&x(P)},A?`${r}-${A}`:void 0),d=n.value??Qd.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!vd(d)&&Sf(e.resolve(d)),p=ji[i],m=wa.get(r)??new Set,g=n.columns.length===0&&m.size===0?[xd[i]]:[],y=cd(n.columns,[...m,...g.filter(x=>x!==void 0)],p),v=xa.get(r),C=t?t.partId:s?.some(x=>x.id===v)?v:void 0,S=s!==void 0&&C!==void 0,k=S?p.filter(x=>Fa.includes(x)):p,$=S?y.filter(x=>!Fa.includes(x)):[],O=(x,A)=>{if(!t){x?xa.set(r,x):xa.delete(r),$e(A);return}l(E=>{let P=E[0];P&&(x?P.partId=x:delete P.partId)})},z=t?e.liveBranch(t):"none",U=t?e.forced.get(t.id)??"live":"live",te=x=>U!=="live"&&(U==="otherwise"?x==="otherwise":U.caseId===x),T=x=>{t&&e.setForced(t.id,te(x)?"live":x==="otherwise"?"otherwise":{caseId:x})},V=x=>{Qd.set(r,x),n.rows.length!==0&&l(A=>gd(A,x),"lhs")},X=()=>{xa.delete(r),l(x=>{md(x,d??H(""),u),C!==void 0&&x[0]&&x[0].partId===void 0&&(x[0].partId=C)})},W=n.rows.map((x,A)=>tc(e,{key:`${r}-${x.caseId}`,label:bd(x.comparison,E=>Ce(E,he(e))),columns:y,changes:x.changes,live:z===x.caseId,forced:te(x.caseId),onForce:()=>T(x.caseId),when:Rf(e,x.comparison,`${r}-${x.caseId}`,(E,P)=>l(B=>{let K=B[0]?.cases.find(ve=>ve.id===x.caseId)?.when.tests[0];K&&E(K.comparison)},P&&`${x.caseId}-${P}`)),updChanges:(E,P)=>l(B=>{let K=B[0]?.cases.find(ve=>ve.id===x.caseId);K&&E(K.then)},P&&`${x.caseId}-${P}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${A===0} @click=${()=>l(E=>oo(E,A,A-1))}>${D("up")}</button>
      <button class="icon" title="Move down" ?disabled=${A===n.rows.length-1} @click=${()=>l(E=>oo(E,A,A+1))}>${D("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>fd(E,x.caseId))}>${D("delete")}</button>`})),ye=n.otherwise===void 0?f:tc(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:z==="otherwise",forced:te("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(x,A)=>l(E=>{let P=E[0]?.otherwise;P&&x(P)},A),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(x=>so(x,!1))}>${D("close")}</button>`}),F=ka.get(r),b=Tf.filter(x=>k.includes(x)&&!y.includes(x));return h`
    <div class="states">
      ${se(e,d??H(""),V,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:Sc(s,C,he(e),O)}
      <table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(x=>h`<th>
              <span>${Qe[x]}</span>
              <button class="icon" title=${`Remove the ${Qe[x]} column`}
                @click=${A=>{ka.set(r,x),$e(A.target)}}>${D("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${$.length===0?f:h`<div class="hint warn">A part ignores ${Na($.map(x=>Qe[x]))}. Pick Whole text to use ${$.length===1?"it":"them"}.</div>`}
      ${F===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${Qe[F]} column? Its ${ec(n,F)} value${ec(n,F)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${x=>{ka.delete(r),wa.get(r)?.delete(F),$e(x.target),l(A=>yd(A,F))}}>Remove</button>
        <button class="small" @click=${x=>{ka.delete(r),$e(x.target)}}>Cancel</button>
      </div>`}
      <div class="states-foot">
        <button class="small" @click=${X}>+ state</button>
        ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(x=>so(x,!0))}>+ otherwise</button>`:f}
        <span class="spacer"></span>
        ${U==="live"?f:h`<button class="small" @click=${()=>t&&e.setForced(t.id,"live")}>Back to live</button>`}
        ${b.length===0?f:h`<select class="chip-add" title="Add a column" @change=${x=>{let A=x.target,E=A.value;if(A.value="",!E)return;let P=wa.get(r)??new Set;P.add(E),wa.set(r,P),$e(A)}}>
          <option value="" selected>+ column…</option>
          ${b.map(x=>h`<option value=${x}>${Qe[x]}</option>`)}
        </select>`}
      </div>
      ...
      <div class="states-switch">
        <button class="link" @click=${x=>{Fo.add(r),$e(x.target)}}>Advanced</button>
  ...
  </tr>`}function Mf(e,n,t,i,a){let r=ua(t,n),o=_a(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${Qe[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Jt(dd[n]))}),lc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Me[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=Qe[n];return h`
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${dc}>
      ...
      ${vi.has(o)?h`${n==="visibility"?J("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Mc(e,r,s,a)}
    ...
    </div>`}function Ff(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=qi(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${Mn.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??H(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Ec.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ie(a):Ce(i,he(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Ce(i,he(e))}</span>`}function Ie(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Rf(e,n,t,i){let a=Yt(n.kind),r=ao(n.kind),o=(s,l,d,c)=>Af(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
...
`)}
${a}}`};return t(e,"")}function Bc(e,n,t=[]){let i=n==="share"?ag(e,t):e,a=bn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${rg(a)}
`}function Uc(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var og="There is nothing to read here. Paste a complication first.",sg="This is not valid JSON. Check for a missing brace or a stray comma.",lg="This is valid JSON but not a complication. A complication starts with { and ends with }.",dg="This does not look like a complication.",zc="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",cg="00000000-0000-4000-8000-000000000000";function ug(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function Gc(e,n){let t=e.trim();if(t==="")return{ok:!1,error:og};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:sg}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:lg};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${zc}`};let o={...a,id:cg,slotIndex:0},s;try{s=yn(o)}catch(d){let c=d instanceof Oe||d instanceof Error?d.message:String(d);return{ok:!1,error:`${dg}

${ug(c)}`}}let l=Vi(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${zc}`}}return{ok:!0,config:s,raw:i}}function Do(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=Nr(e,(o,s)=>Nc(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Nc(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Oc(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Kc(e,n){let t=structuredClone(e);_r(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Pr(t,a=>Lr(a,i)),t}function Wc(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function pg(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function jc(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=ia(e);return i.length===0?t:`${t}, ${pg(i)}`}function Vo(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var mg=3e4,fg=500,gg=3e4,qc="preset-entity";function Yc(e){return`import-entity-${e}`}var yg={entityId:"",displayName:"",domain:""},bg={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Bo(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function xg(e){return e.kind==="family"?"look":"content"}function Uo(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Jc(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    :host {
      ...
      --wa-text: ${ke(xe.text)};
      --wa-icon: ${ke(xe.icon)};
      --wa-gauge: ${ke(xe.gauge)};
      --wa-shape: ${ke(xe.shape)};
      --wa-image: ${ke(xe.image)};
      --wa-tap: ${ke(xe.tap)};
      --wa-states: ${ke(ee.states)};
      --wa-place: ${ke(ee.place)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.held { background: color-mix(in srgb, ${ke(ee.group)} 12%, var(--wa-panel)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${ke(ee.locked)}; }
    ...
    .card.tint-values {
      ...
      background: color-mix(in srgb, ${ke(ee.complication)} 8%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${ke(ee.complication)} 25%, var(--wa-card));
    }
    .card.tint-states {
      padding: 10px 14px 12px;
      background: color-mix(in srgb, ${ke(ee.states)} 12%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${ke(ee.states)} 35%, var(--wa-card));
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.addEventListener(Ra,this.scrubStart),this.addEventListener(Ia,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},gg)}loadColumnWidths(){try{let t=window.localStorage.getItem(iu);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Go(i.left)),typeof i.right=="number"&&(this.colRight=Go(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(iu,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(nu);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(nu,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>bc(s,o,i))}>Copy the ${Q(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Hr(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let C=this.focusTapId();if(C!==void 0&&o===C&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,C,r??void 0);return}let S=this.hitLayerId(i);S?this.inspect={kind:"layer",id:S}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=au(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=Hr(this.draft.config,o),p=this.draft.config.elements.find(C=>C.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=lt(this.draft.config,u),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let y=Ee(this.draft.config,t,p).frame,v=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let C=p.payload,S=be[t],k=y.width*S.width,$=y.height*S.height,O={x:0,y:0,w:k,h:$,cx:k/2,cy:$/2},z=ea(C,O,Qi(new Date));if(this.cancelGesture?.(),l){let V=v.width/S.width,X=C.timestampSize;this.cancelGesture=Td(s,i,l,{w:z.w*V,h:z.h*V},(W,ye)=>{let F=Math.min(40,Math.max(4,Math.round(X*W)));this.mutate(b=>{let x=b.elements.find(A=>A.payload.id===u);x?.kind==="image"&&(x.payload.timestampSize=F)},`ts-size-${u}`),ye&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let U={x:0,y:0,w:y.width*v.width,h:y.height*v.height},te=ot(C)?{x:C.timestampX,y:C.timestampY}:{x:(z.x+z.w/2)/O.w,y:(z.y+z.h/2)/O.h},T=!1;this.cancelGesture=Sd(s,U,i,te,(V,X,W)=>{W||(T=!0),T&&this.mutate(ye=>{let F=ye.elements.find(b=>b.payload.id===u);F?.kind==="image"&&(F.payload.timestampX=V,F.payload.timestampY=X)},`ts-${u}`),W&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=ha(s,v,i,{elementId:u,frame:y,handle:r??void 0},{onFrame:(C,S,k)=>{this.mutate($=>Te($,t,C,{frame:S}),`drag-${C}-${t}`),k&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=dt(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(v=>[v.payload.id,Ee(o,t,v).frame])),d=[...l.values()],c=Math.min(...d.map(v=>v.x)),u=Math.min(...d.map(v=>v.y)),p=Math.max(...d.map(v=>v.x+v.width)),m=Math.max(...d.map(v=>v.y+v.height)),g={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},y=v=>Math.round(v*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=ha(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:(v,C,S)=>{let k=C.x-g.x,$=C.y-g.y;this.mutate(O=>{for(let[z,U]of l)Te(O,t,z,{frame:{...U,x:y(U.x+k),y:y(U.y+$)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?$d:1,s=t*o,l=i*o,d=this.canvasFamily,c=be[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let v=this.inspect.id;return this.nudgeMany(dt(r,v).map(C=>C.payload.id),d,c,`nudge-group-${v}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(v=>v.payload.id===u);if(!p)return!1;let m=lt(r,u);if(m?.locked)return this.nudgeMany(dt(r,m.id).map(v=>v.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=Ee(r,d,p).frame,y=po(g,s,l,c);return(y.x!==g.x||y.y!==g.y)&&this.mutate(v=>Te(v,d,u,{frame:y}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=$=>Math.round($*1e3)/1e3,c=new Map;for(let $ of t){let O=l.elements.find(z=>z.payload.id===$);O&&c.set($,Ee(l,i,O).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map($=>$.x)),m=Math.min(...u.map($=>$.y)),g=Math.max(...u.map($=>$.x+$.width)),y=Math.max(...u.map($=>$.y+$.height)),v={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},C=po(v,o,s,a),S=C.x-v.x,k=C.y-v.y;return(S!==0||k!==0)&&this.mutate($=>{for(let[O,z]of c)Te($,i,O,{frame:{...z,x:d(z.x+S),y:d(z.y+k)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(v=>v.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=be[i],c=Ee(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=ea(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},Qi(new Date)),g=ot(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},y=Cd(g,a,r,{w:u,h:p});return(y.x!==g.x||y.y!==g.y)&&this.mutate(v=>{let C=v.elements.find(S=>S.payload.id===t);C?.kind==="image"&&(C.payload.timestampX=y.x,C.payload.timestampY=y.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=Zi(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Xr(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:_e(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ue(s,l),c=Ee(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=ha(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?cl(g,u,t,p):Te(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:ru(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=Uc(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Do(i,this.hass.states):[],r=Vo({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${nt({hass:this.hass},t.label,i??yg,a=>this.setImportEntity(t.entityId,a),Yc(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Qr.map(s=>h`<button class="add" style=${`--k:${xe[s]}`} ?disabled=${i} title=${`Add a blank ${Sn[s].toLowerCase()} layer`}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${ze(T,d)}</b>
          <small><span class="kind">${Sn[T.kind]}</span> · ${Rg(T,c,this.historySeries,F.size)}</small>
          ${$?h`<span class="facts">${Mg(this.host(),a,T,F).map(B=>h`<span class="fact"><b>${B.label}</b> ${B.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${x?h`<span class="badge tap" title=${`Tappable \xB7 ${ze(x,d)}`}>tap</span>`:f}
            ${T.payload.rules.length===0?f:h`<span class="badge states" title=${A}>${A.replace(/\.$/,"").toLowerCase()}</span>`}
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${F.isHidden?"Show":"Hide"} (${Ko}${Lt}H)`} aria-label=${F.isHidden?"Show this layer":"Hide this layer"} @click=${B=>{B.stopPropagation(),this.mutate(K=>Te(K,a,W,{isHidden:!F.isHidden}))}}>${D(F.isHidden?"hide":"show")}</button>
      ...
      </div>`},z=(T,V)=>{let X=this.inspect.kind==="group"&&this.inspect.id===T.id,W=!this.collapsed.has(T.id),ye=this.rowDrag(T.id,i),F=V[0],b=V[V.length-1],x=E=>{let P=E.currentTarget,B=P.getBoundingClientRect(),K=B.top+(P.classList.contains("drop-before")?mt:0),ve=B.bottom-(P.classList.contains("drop-after")?mt:0),_t=(E.clientY-K)/Math.max(1,ve-K);return _t<.25?"drop-before":!W&&_t>.75?"drop-after":"drop-into"},A=V.map(E=>E.payload.id);return h`<div class="layer group ${X?"hl":""} ${$?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${ye.draggable}
        ...
        @drop=${E=>{E.preventDefault();let P=x(E);this.clearDragMarks();let B=this.dragId;if(this.dragId=void 0,!(!B||!F||!b)){if(P==="drop-before"){this.reorderLayer(B,F.payload.id,!0,!0);return}if(P==="drop-after"){this.reorderLayer(B,b.payload.id,!1,!0);return}this.isGroupId(B)||(this.reorderLayer(B,F.payload.id,!0),this.mutate(K=>Mr(K,B,T.id)))}}}>
        ...
        <span class="name">
          ...
          ${$?h`<span class="facts"><span class="fact"><b>Holds</b> ${V.map(E=>ze(E,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Ko}${Lt}G)`} aria-label="Ungroup" @click=${E=>{E.stopPropagation(),this.mutate(P=>oi(P,T.id)),X&&(this.inspect={kind:"general"})}}>${D("ungroup")}</button>
          </span>`:f}
      ...
      </div>`},U=[],te=new Set;for(let T=0;T<l.length;T++){let V=l[T],X=V.payload.groupId,W=X===void 0?void 0:t.groups?.find(b=>b.id===X);if(!W){U.push(O(V,!1));continue}if(te.has(W.id))continue;te.add(W.id);let ye=l.filter(b=>b.payload.groupId===W.id);U.push(z(W,ye));let F=this.inspect.kind==="group"&&this.inspect.id===W.id;this.collapsed.has(W.id)||U.push(h`<div class="group-kids">${ye.map(b=>O(b,!0,F))}</div>`)}return h`<div class="card layers-card" style=${`--thumb-w:${C}px;--thumb-h:${S}px`}>
      ...
      ${t===void 0?f:h`
        ...
        ${nt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},qc,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Pc(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=Ji(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${ge(a,"complication","Complication",mc(a),{color:ee.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=wc(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=$c(a,c)}else if(r.kind==="data"){let c=t.values.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=ge(a,"shared-value","Shared value",gc(a,c),{color:ee.complication,icon:"content",summary:'Read by layers whose Source is "Named value"',alwaysOpen:!0})}else s=Cc(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
      ...
      <span>${t}${i==="mixed"?h` <span class="mixed">(mixed)</span>`:f}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=he(r),s=new pt(this.buildContext(),this.draft?.config),l=xc(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)Te(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let v=g.elements.find(C=>C.payload.id===y.payload.id);v&&v.kind!=="image"&&v.kind!=="tap"&&v.kind!=="timeline"&&(v.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ...
      ${ge(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:ee.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=od({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
    ...
    </details>`}};L([dn({attribute:!1})],I.prototype,"hass",2),L([dn({type:Boolean})],I.prototype,"narrow",2),L([dn({attribute:!1})],I.prototype,"panel",2),L([N()],I.prototype,"colLeft",2),L([N()],I.prototype,"colRight",2),L([N()],I.prototype,"panelWidth",2),L([N()],I.prototype,"owners",2),L([N()],I.prototype,"ownerId",2),L([N()],I.prototype,"records",2),L([N()],I.prototype,"selectedId",2),L([N()],I.prototype,"draft",2),L([N()],I.prototype,"readOnlyReason",2),L([N()],I.prototype,"parseError",2),L([N()],I.prototype,"maxSchemaVersion",2),L([N()],I.prototype,"presets",2),L([N()],I.prototype,"occupied",2),L([N()],I.prototype,"serverToken",2),L([N()],I.prototype,"appliedToken",2),L([N()],I.prototype,"sendStatusKnown",2),L([N()],I.prototype,"polling",2),L([N()],I.prototype,"lastPollSeconds",2),L([N()],I.prototype,"sendPending",2),L([N()],I.prototype,"pages",2),L([N()],I.prototype,"templateResults",2),L([N()],I.prototype,"historySeries",2),L([N()],I.prototype,"templateError",2),L([N()],I.prototype,"templateFetchedAt",2),L([N()],I.prototype,"forced",2),L([N()],I.prototype,"showRaw",2),L([N()],I.prototype,"inspect",2),L([N()],I.prototype,"openSections",2),L([N()],I.prototype,"helpSections",2),L([N()],I.prototype,"pickerOpen",2),L([N()],I.prototype,"pickerFilter",2),L([N()],I.prototype,"pickerNote",2),L([N()],I.prototype,"testValues",2),L([N()],I.prototype,"editingValue",2),L([N()],I.prototype,"thumbStep",2),L([N()],I.prototype,"layerDetail",2),L([N()],I.prototype,"addOpen",2),L([N()],I.prototype,"addDetail",2),L([N()],I.prototype,"multi",2),L([N()],I.prototype,"collapsed",2),L([N()],I.prototype,"activeFamily",2),L([N()],I.prototype,"picking",2),L([N()],I.prototype,"pickHoverId",2),L([N()],I.prototype,"listHoverIds",2),L([N()],I.prototype,"zoomed",2),L([N()],I.prototype,"helpOpen",2),L([N()],I.prototype,"showTaps",2),L([N()],I.prototype,"timestampActiveId",2),L([N()],I.prototype,"savedName",2),L([N()],I.prototype,"presetKind",2),L([N()],I.prototype,"presetEntity",2),L([N()],I.prototype,"newOpen",2),L([N()],I.prototype,"newName",2),L([N()],I.prototype,"newFamily",2),L([N()],I.prototype,"shareOpen",2),L([N()],I.prototype,"shareMode",2),L([N()],I.prototype,"shareLabels",2),L([N()],I.prototype,"shareNote",2),L([N()],I.prototype,"importOpen",2),L([N()],I.prototype,"importText",2),L([N()],I.prototype,"importParse",2),L([N()],I.prototype,"importName",2),L([N()],I.prototype,"importMap",2),L([N()],I.prototype,"previewCase",2),L([N()],I.prototype,"loadError",2),L([N()],I.prototype,"saveError",2),L([N()],I.prototype,"saving",2),L([N()],I.prototype,"conflict",2),L([N()],I.prototype,"remoteRevision",2),L([N()],I.prototype,"confirmDelete",2),L([N()],I.prototype,"moveTarget",2),L([N()],I.prototype,"moving",2),L([N()],I.prototype,"moveError",2),L([N()],I.prototype,"version",2);var Wo=I;function ft(e){return String(e?.message??e)}function Eg(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function ou(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function Mg(e,n,t,i){let a=[{label:"Shows",value:_o(e,t)}],r=Ma(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function Fg(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function Rg(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ie(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=Gt(e.payload)??Kt(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Xe(o).length} values`}case"timeline":{let r=Et(e.payload),o=r===void 0?[]:di(t.get(r)??""),s=Math.max(0,o.length-1);return`${Fg(qe(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ie(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return st(e.payload.action)}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Wo);export{Wo as WristAssistantPanel,ru as columnFit,Mg as layerFacts};
