...
`)}function qs(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Mu(r));return{values:t,nullKeys:i}}function Mu(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function yr(e){let n=Hi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Fu(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(Pa(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var Iu=10800;function Ru(e,n,t){let i=n==="always"||n==="auto"&&t<=Iu;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Xs(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Ru(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Au(e,n){return kt(e)===void 0?[]:Xs(Ge(e)*60,ja(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Hu(e,n){return ki(e)?Xs(Math.round(e.historyMinutes)*60,ja(qn(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Wt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function We(e){let n=e.trim(),t=Wt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Wt(i)}function Lu(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function _u(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Nu(e){let n=e.trim(),t=Wt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Wt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Wt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function zu(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Pu(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Ou(e,n,t){if(Ue(n))return e;let i=n,a=e,r=Wt(e.trim()),o=i.duration?Nu(e):void 0;if(o!==void 0)a=zu(o);else if(i.relativeTime&&r!==void 0)a=_u(r);else{let s=We(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Lu(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Pu(a);break}return a}function bn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function vn(e,n=240){return Zs(e,n).map(t=>t.value)}function Zs(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Du(e,n,t){let i=Zs(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?cn({bands:t.bands??[]}):[],d=t.bandAboveColorHex??we,u=t.highColorHex??Fe,c=t.lowColorHex??Ie,h=[],m=(y,x)=>{if(y==="")return;let S=h.at(-1);S&&S.colorHex===x?S.text+=y:h.push({text:y,colorHex:x})},g=0;return i.forEach((y,x)=>{m(e.slice(g,y.start),n);let S=x===o?u:x===s?c:l.length>0?vi(y.value,l,d):n,T=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,T),S),g=T}),m(e.slice(g),n),h}function Ys(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Vu(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function ei(e,n=xt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Bu(i.slice(a+1))})}return t}function Bu(e){try{return decodeURIComponent(e)}catch{return e}}function Gu(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let u=t(o.state),c=i[i.length-1];c!==void 0&&c.colorHex===u?c.end=d:i.push({start:s,end:d,colorHex:u})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Js(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Uu(e,n,t){if(e===void 0)return 0;let i=We(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var st=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Ys(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Ot(n),i=Dt(n),a;t!==void 0?a=this.ctx.historySeries?.get(t)??"":i!==void 0?a=this.ctx.historySeries?.get(i)??"":a=this.resolve(n.value)??"";let r=vn(a);return n.limit>0&&r.length>n.limit?n.takeFromEnd?r.slice(r.length-n.limit):r.slice(0,n.limit):r}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=We(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let u=t.get(s);if(!u)return{min:0,max:1};let c=u.scaleFrom,h=c!==void 0&&c!==s&&t.has(c)&&!l.has(c)?o(c,new Set([...l,c])):Ys(a.get(s)??[],u);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),u={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},c=this.chartEntity(l);c&&(u.entity=c),this.charts.set(s,u)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ue(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Fu(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?ps(r):Pa(r,a.domainMax-a.domainMin));break}default:{let a=gr(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Ou(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Wt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?bn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=We(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:We(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),u=d===void 0?void 0:We(d);if(a===void 0||l===void 0||u===void 0)return!1;let[c,h]=l<=u?[l,u]:[u,l];return a>=c&&a<=h}case"timeBetween":{let l=Gt(i),d=r(),u=this.resolve(t.upper),c=d===void 0?void 0:Gt(d),h=u===void 0?void 0:Gt(u);return l===void 0||c===void 0||h===void 0||c===h?!1:c<h?l>=c&&l<h:l>=c||l<h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Re[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,m={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return c!==void 0&&(m.countdownEnd=c),ls(n.payload)&&(m.spans=Du(m.text,m.colorHex,n.payload)),m}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",h=this.styleText(a,"icon"),m=n.payload.symbol.kind.kind==="literal",g=h===void 0&&m&&n.payload.path!==""?n.payload.path:void 0,y=h??c;g===void 0&&y.startsWith("mdi:")&&(y="questionmark.circle");let x={kind:"icon",...u,symbol:y,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(x.path=g),x}case"gauge":{let c=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(c.value),m=(L,O,V)=>L??(O?We(this.resolve(O)??""):void 0)??V,g=m(this.styleNumber(a,"gaugeMin"),c.minSource,c.minValue),y=m(this.styleNumber(a,"gaugeMax"),c.maxSource,c.maxValue),x=h===void 0?void 0:We(h),S=this.styleColor(a,"color")??c.colorSlot.baseColorHex;c.coloring==="bands"&&c.bands.length>0&&x!==void 0&&(S=vi(x,cn(c),c.bandAboveColorHex));let T=y-g;if(c.total){let L=We(this.resolve(c.total)??"");L!==void 0&&(T=L)}let $=Js(T,1,bi),C={kind:"gauge",...u,fraction:Uu(h,g,y),style:c.style,lineWidth:c.lineWidth,colorHex:S,trackColorHex:c.trackColorHex,thresholdColorHex:c.thresholdColorHex,dotCount:$,filledCount:Js(x??0,0,$)};if(c.thresholdValue!==void 0&&y!==g){let L=(c.thresholdValue-g)/(y-g);L>=0&&L<=1&&(C.thresholdFraction=L)}return C}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),m=h.values,g={min:h.domainMin,max:h.domainMax},y=this.styleColor(a,"color")??c.colorSlot.baseColorHex,x=cn(c),S=us(c)?m.map(ie=>vi(ie,x,c.bandAboveColorHex)):[],T=c.highlight==="highest"||c.highlight==="both",$=c.highlight==="lowest"||c.highlight==="both",C=yt(c),L={kind:"chart",...u,values:m,style:c.style,domainMin:g.min,domainMax:g.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:y,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,highMarker:T?C.high:"none",lowMarker:$?C.low:"none",pointColorHexes:S,fillBands:c.fillBands,thresholdColorHex:c.thresholdColorHex,nowColorHex:c.nowColorHex,labels:Hu(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove};if(m.length>0){let ie=T?m.indexOf(Math.max(...m)):-1,w=$?m.indexOf(Math.min(...m)):-1;ie>=0&&(L.highIndex=ie),w>=0&&w!==ie&&(L.lowIndex=w)}let O=Vu(c,g.min,g.max);O!==void 0&&(L.thresholdY=O);let V=this.chartNowIndex(c,m.length);return V!==void 0&&(L.nowIndex=V),L}case"timeline":{let c=n.payload,h=kt(c),m=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=ei(m,xt),y=Gu(g,Ge(c)*60,S=>bs(S,c.bands,c.otherColorHex));return{kind:"timeline",...u,runs:y,gap:c.gap,cornerRadius:c.cornerRadius,labels:Au(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove}}case"shape":{let c={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};tt(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=Rs(n,t).map(y=>this.resolveElement(y,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=l??u??this.resolve(a?.bezelText);c!==void 0&&(s.bezelText=c),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,x=this.resolve(y.value),S=x===void 0?void 0:We(x);if(S!==void 0){let T=Math.min(y.minValue,y.maxValue),$=Math.max(y.minValue,y.maxValue),C={value:Math.min($,Math.max(T,S)),minValue:T,maxValue:$===T?T+1:$,colorHexes:y.colorHexes},L=this.resolve(y.minLabel);L!==void 0&&(C.minLabel=L);let O=this.resolve(y.maxLabel);O!==void 0&&(C.maxLabel=O),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Ku(e,n,t){let i=new st(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Li(e,n,t){let i=new st(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Ku(e.inline,n,e)),a}var xe=he,ni=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:xe,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],wn=ni.find(e=>e.measured);function sl(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return ni.find(a=>a.screen.width===t&&a.screen.height===i)}function zi(e,n){let t=xe[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Wu={regular:400,medium:500,semibold:600,bold:700},ju=1.15;function je(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ye(e,n,t="#FFFFFF"){let i=je(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function ll(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Ni=e=>e*.55;function qu(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Yu(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Ju(e,n,t){if(t<=0||e.length*Ni(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/Ni(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Xu(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Zu(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Qu(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let u=s;if(/\s/.test(d))for(l(o)&&(u=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(u=i[o],o+=d.length)}s=u;let c=r.at(-1);c&&c.colorHex===u?c.text+=d:r.push({text:d,colorHex:u})}return r}function ep(e,n){let t=ye(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:bn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Yu(e.text,n.w/Ni(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*Ni(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Ju(y,o,n.w)),{anchor:l,x:d}=qu(e.alignment,n),u=Xu(e.text,e.spans),c=u?Zu(e.text,i):[],h=(y,x)=>u?Qu(y,c[x]??0,e.text,u,e.colorHex).map(S=>{let T=ye(S.colorHex,"fill");return v`<tspan fill=${T.fill} fill-opacity=${T["fill-opacity"]}>${S.text}</tspan>`}):y,m=o*1.15,g=s.length>1?v`${s.map((y,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${h(y,x)}</tspan>`)}`:h(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    ...
    <g transform="rotate(${u} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:np(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function np(e,n,t,i,a){let r=ye(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var ip=5;function ap(e,n){let t=e.values,i=Math.max(t.length,1),r=e.highIndex!==void 0&&e.highMarker!=="none"||e.lowIndex!==void 0&&e.lowMarker!=="none"?ip:0,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,u=Math.max(n.h-r-o*2,1),c=d+u,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?u*.12:0,y=Math.min(Math.max(e.barGap,0),l/(i*2)),x=Math.max((l-y*(i-1))/i,.5),S=$=>Math.min(1,Math.max(0,($-e.domainMin)/h)),T=$=>c-S($)*u;return{count:t.length,barWidth:x,plotTop:d,plotBottom:c,plotLeft:s,plotRight:s+l,baselineY:m?c:T(0),yAtFraction($){return c-Math.min(Math.max($,0),1)*u},barRect($){let C=s+$*(x+y),L=t[$],O,V;if(m){let ie=g+S(L)*(u-g);O=c-ie,V=c}else O=T(L),V=m?c:T(0),O>V&&([O,V]=[V,O]);return{x:C,y:O,w:x,h:Math.max(V-O,.5)}},point($){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*$/(t.length-1):s+l/2,y:T(t[$])}},markerCenter($,C){let L=C?this.barRect($):void 0;return{x:L?L.x+L.w/2:this.point($).x,y:n.y+r/2}}}}function rp(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=dl(e,n),o=r?cl(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=op(e,a);return o===void 0?s:v`${s}${o}`}function op(e,n){let t=ap(e,n),i=ye(e.colorHex,"fill"),a=ye(e.highColorHex,"fill",e.colorHex),r=ye(e.lowColorHex,"fill",e.colorHex),o=(c,h)=>v`<circle cx=${c.x} cy=${c.y} r="1.7" fill=${h.fill} fill-opacity=${h["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=c=>l?ye(e.pointColorHexes[c],"fill",e.colorHex):i;if(e.style==="bars")for(let c=0;c<t.count;c++){let h=t.barRect(c),m=c===e.highIndex?a:c===e.lowIndex?r:d(c),g=Math.min(1.2,h.w/2,h.h/2);s.push(v`<rect x=${h.x} y=${h.y} width=${h.w} height=${h.h} rx=${g}
        fill=${m.fill} fill-opacity=${m["fill-opacity"]} />`)}else{let c=Array.from({length:t.count},(m,g)=>t.point(g)),h=c.map((m,g)=>`${g===0?"M":"L"}${m.x} ${m.y}`).join(" ");if(e.style==="area")if(e.fillBands&&l&&t.count>1)for(let m=0;m<t.count-1;m++){let g=c[m],y=c[m+1],x=d(m+1),S=`M${g.x} ${g.y} L${y.x} ${y.y} L${y.x} ${t.baselineY} L${g.x} ${t.baselineY} Z`;s.push(v`<path d=${S} fill=${x.fill}
            fill-opacity=${x["fill-opacity"]*.28} stroke="none" />`)}else{let m=`${h} L${c[c.length-1].x} ${t.baselineY} L${c[0].x} ${t.baselineY} Z`;s.push(v`<path d=${m} fill=${i.fill}
          fill-opacity=${i["fill-opacity"]*.28} stroke="none" />`)}if(l&&t.count>1)for(let m=0;m<t.count-1;m++){let g=c[m],y=c[m+1],x=d(m+1);s.push(v`<path d=${`M${g.x} ${g.y} L${y.x} ${y.y}`} fill="none"
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?v`${s}${cl(e,n,t,i)}`:v`${s}`}function lp(e,n){let t=ye(e.fillColorHex,"fill"),i=e.borderColorHex?je(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return v`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function dp(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ye(e.colorHex,"fill"),s=e.size*ju;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Cr=.25,cp=8;function up(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Cr),cp),u=Math.max(e/t,n/i),c=Math.min(e/t,n/i),h=(a==="fit"?c:u)*d,m=t*h,g=i*h,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+x)+0,width:m,height:g}}function Pi(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var _i=4;function Oi(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+_i:n.x+n.w-_i-a,d=e.timestampCorner.startsWith("top")?n.y+_i:n.y+n.h-_i-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,u,c)=>c>=u?d+(u-c)/2:Math.min(d+u-c,Math.max(d,l-c/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function pp(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function hp(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Oi(e,n,Pi(new Date)):void 0,s=o?v`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([h,m,g])=>v`<rect data-ts-corner=${h} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${h}-resize" />`)}`:f,u=e.url?t.imageSizes?.size(e.url):void 0,c;if(e.url&&u){let h=up(n.w,n.h,u.width,u.height,e.contentMode,e.zoom,e.panX,e.panY);c=v`<image href=${e.url} x=${n.x+h.x} y=${n.y+h.y} width=${h.width} height=${h.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(pp(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${c}${s}</g>${d}`}function mp(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?fp(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${wr} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var wr=5;function fp(e,n){let t=wr*.55,i=n.w-2;if(n.h<wr*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function xr(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=ll(e,n),d=i&&(!s||o),u;switch(e.kind){case"text":u=ep(e,l);break;case"icon":u=dp(e,l,t.icons);break;case"gauge":u=tp(e,l);break;case"chart":u=rp(e,l);break;case"timeline":u=sp(e,l);break;case"shape":u=lp(e,l);break;case"image":u=hp(e,l,t);break;case"tap":u=mp(e,l,t.icons,a,d?nt(e.action):void 0);break}let c=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*c,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,y=t.handles===!0&&(!s||o),x=g?v`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,T=v`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,$=3,C=m&&y?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([L,O,V])=>v`<rect data-handle=${L} x=${O-$/2} y=${V-$/2} width=${$} height=${$}
          fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${L}-resize" />`):f;return v`<g data-element-id=${e.id} opacity=${h} style=${y?"cursor:move":f}
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${T}${u}${S}${x}${C}</g>`}function Di(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Sr(e,n){return(n?23.5:34)*e}var Qs=10.5;function ul(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function el(e,n){let t=0;for(let i of e)t+=ul(i,n);return t}function tl(e,n,t){let i=e.toUpperCase(),a=d=>ul(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function kr(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function $r(e,n,t,i){let a=kr(e,n,t),r=kr(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function pl(e,n,t,i){let{dial:a}=Di(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:$r(a,t,i.start,i.end),length:t*r}}function gp(e,n){let t=Di(e,!0);return pl(e,n,t.dial.r,t.labelArc)}var nl=18.5,yp=113,bp={start:-71,end:-36},il=104,vp=6.2,al={start:-77,end:-30.5};function rl(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function ol(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=rl(e[i]),o=rl(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var vr=11;function wp(e,n,t){let{dial:i}=Di(n,!0),a=il*n,r=180/(Math.PI*il),o=e.minLabel!==void 0?el(e.minLabel,vr)*r:0,s=e.maxLabel!==void 0?el(e.maxLabel,vr)*r:0,l=al.start+(o>0?Math.max(0,o-1.8):0),d=al.end-(s>0?Math.max(0,s-1.8):0),u=d-l,c=24,h=[];for(let S=0;S<c;S++){let T=l+u*S/c,$=Math.min(d,l+u*(S+1)/c+.4);h.push(v`<path d=${$r(i,a,T,$)} fill="none"
      stroke=${ol(e.colorHexes,(S+.5)/c)} stroke-width=${vp*n}
      stroke-linecap=${S===0||S===c-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=kr(i,a,l+u*m),y=1.5,x=(S,T,$,C)=>v`
    <defs><path id=${S} d=${$r(i,a,T,$)} /></defs>
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function Vi(e,n){let t=e.family in xe?e.family:"rectangular",i=n.slot??xe[t],a=xe[t],r=zi(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=je(e.backgroundColorHex),l=je(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,y=!!e.bezelText||!!e.bezelGauge,x=e.curvedText??"",S=x!=="",T=Di(g,y),$=Sr(g,y),C=$/(a.width*g),L=T.tile.cx-$/2,O=T.tile.cy-$/2,V=`M 0 0 H ${T.quad.width-T.cornerRadius} A ${T.cornerRadius} ${T.cornerRadius} 0 0 1 ${T.quad.width} ${T.cornerRadius} V ${T.quad.height} H 0 Z`,ie=f;if(e.bezelGauge)ie=wp(e.bezelGauge,g,o);else if(e.bezelText){let H=gp(g,`${o}-bezel`),U=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?bn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;ie=v`<defs><path id=${H.id} d=${H.d} /></defs>
        <text font-size=${Qs*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${H.id}" startOffset="50%" text-anchor="middle">${tl(U,H.length,Qs*g)}</textPath></text>`}let w=f;if(S){let H=je(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},U=pl(g,`${o}-curved`,yp*g,bp);w=v`<defs><path id=${U.id} d=${U.d} /></defs>
        <text font-size=${nl*g} font-weight="600" fill=${H.color} fill-opacity=${H.opacity}
          ...
          <textPath href="#${U.id}" startOffset="50%" text-anchor="middle">${tl(x,U.length,nl*g*.88)}</textPath></text>`}else{let H=e.borderWidth*r.scale*C,U=l?v`<circle cx=${$/2} cy=${$/2} r=${$/2-H/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${H} />`:f;w=v`<g transform="translate(${L} ${O})">
        <g clip-path=${`url(#${o})`}>
          ${s?v`<rect width=${$} height=${$} fill=${s.color} fill-opacity=${s.opacity} />`:f}
          <g data-design-box transform="scale(${r.scale*C})">
            ${e.elements.map(P=>xr(P,a,n))}
          </g>
        </g>
    ...
    ${u.map(m=>xr(m,a,d))}
    ${c}
  </svg>`}function Z(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var jt=["rectangular","circular","corner","inline"];function xn(e){return te.includes(e)}function Bi(e){return jt.filter(n=>e.supportedFamilies.includes(n))}function Er(e){return te.find(n=>e.supportedFamilies.includes(n))}function Gi(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function Cp(){return{value:I("")}}function ml(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=jt.filter(t=>t===n||e.supportedFamilies.includes(t))),xn(n)?e.perFamily[n]||(e.perFamily[n]=rt()):e.inline||(e.inline=Cp()),e.schemaVersion=zt(e)}function fl(e,n){if(Gi(e,n)){if(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),xn(n)){for(let t of Ke(e,n))ot(e,t.payload.id);delete e.perFamily[n],Pe(e)}else delete e.inline;e.schemaVersion=zt(e)}}function gl(e,n){let t=[];if(!xn(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=Ke(e,n).filter(r=>!ce(e,r)).length;return a>0&&t.push(`${a} layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var me={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},kn={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area"},Tr=["text","icon","gauge","chart","timeline","shape","image","tap"],ee={states:"#f9a825",tap:me.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var yl="2.8.0";function Mr(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function Sp(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function bl(e,n=yl){let t=Mr(e),i=Mr(n);return!t||!i?!1:Sp(t,i)>=0}function vl(e,n=yl){return`${Mr(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The editor needs ${n}, coming soon to the App Store.`}var wl="52a9d81d0fd7";var xl="11fa18406cea";var $e="mdi:";function Ep(e){return e.trim().replace(/\./g,"-")}function Tp(e){return e.trim().replace(/-/g,".")}var Ui=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>Tp(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=Ep(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=je(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return v`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
      ...
      <path d=${a[0]} fill=${r.color} fill-opacity=${r.opacity} /></svg>`}load(){if(this.state!=="idle")return;this.state="loading";let n=new URL(`${this.file}?v=${this.digest}`,import.meta.url);fetch(n).then(t=>{if(!t.ok||!t.body)throw new Error(`${this.file}: ${t.status}`);return new Response(t.body.pipeThrough(new DecompressionStream("gzip"))).json()}).then(t=>{if(t&&typeof t=="object")for(let[i,a]of Object.entries(t))Array.isArray(a)&&typeof a[0]=="string"&&typeof a[1]=="string"&&this.icons.set(i,[a[0],a[1]])}).catch(()=>{}).finally(()=>{this.state="loaded",this.onReady()})}},Fr=class{constructor(n,t){this.sf=n;this.mdi=new Ki(t,"mdi-icons.json.gz",xl)}render(n,t,i){return(n.trim().startsWith($e)?this.mdi:this.sf).render(n,t,i)}available(){return this.sf.available()}names(){return this.sf.names()}mdiNames(){return this.mdi.names()}mdiPath(n){return this.mdi.path(n)}};function kl(e){let n=Ui.available()?new Ui(e):new Ki(e);return new Fr(n,e)}function $l(e){let n=new Map,t=new Set;return{size(i){let a=n.get(i);if(a)return a;if(t.has(i))return;t.add(i);let r=new Image;r.onload=()=>{r.naturalWidth<=0||r.naturalHeight<=0||(n.set(i,{width:r.naturalWidth,height:r.naturalHeight}),e())},r.src=i}}}var ji=[{name:"Home",symbols:["house","house.fill","house.circle.fill","bed.double.fill","sofa.fill","chair.lounge.fill","lamp.desk.fill","washer.fill","dryer.fill","refrigerator.fill","oven.fill","dishwasher.fill","microwave.fill","shower.fill","bathtub.fill","toilet.fill","stairs","door.left.hand.open","door.left.hand.closed","window.casement","curtains.closed","spigot.fill","humidifier.fill","air.purifier.fill","fan.fill","fan.ceiling.fill"]},{name:"Climate",symbols:["thermometer.variable","thermometer.medium","thermometer.low","thermometer.high","thermometer.sun.fill","thermometer.snowflake","humidity.fill","drop.fill","drop.degreesign","flame.fill","snowflake","wind","air.conditioner.horizontal.fill","heater.vertical.fill","gauge.with.needle"]},{name:"Weather",symbols:["sun.max.fill","sun.min.fill","sunrise.fill","sunset.fill","moon.fill","moon.stars.fill","cloud.fill","cloud.sun.fill","cloud.rain.fill","cloud.heavyrain.fill","cloud.drizzle.fill","cloud.snow.fill","cloud.bolt.fill","cloud.bolt.rain.fill","cloud.fog.fill","tornado","hurricane","umbrella.fill","rainbow","aqi.medium"]},{name:"Lighting",symbols:["lightbulb","lightbulb.fill","lightbulb.slash.fill","lightbulb.led.fill","light.recessed","light.panel.fill","light.strip.2","lamp.ceiling.fill","lamp.floor.fill","lamp.table.fill","sparkles","rays"]},{name:"Security",symbols:["lock.fill","lock.open.fill","lock.shield.fill","shield.fill","shield.slash.fill","key.fill","exclamationmark.shield.fill","video.fill","video.slash.fill","web.camera.fill","sensor.fill","sensor.tag.radiowaves.forward.fill","bell.fill","bell.slash.fill","bell.badge.fill","alarm.fill","eye.fill","eye.slash.fill"]},{name:"Media",symbols:["play.fill","pause.fill","stop.fill","forward.fill","backward.fill","forward.end.fill","backward.end.fill","speaker.wave.2.fill","speaker.wave.3.fill","speaker.slash.fill","music.note","music.note.list","tv","tv.fill","appletv.fill","homepod.fill","homepod.2.fill","airplay.audio","airplay.video","hifispeaker.fill","headphones","radio.fill","film.fill","photo.fill"]},{name:"Power",symbols:["bolt.fill","bolt.slash.fill","bolt.circle.fill","battery.100percent","battery.75percent","battery.50percent","battery.25percent","battery.0percent","battery.100percent.bolt","powerplug.fill","power","poweroutlet.type.b.fill","minus.plus.batteryblock.fill","leaf.fill"]},{name:"Devices",symbols:["iphone","ipad","applewatch","macbook","desktopcomputer","laptopcomputer","homekit","wifi","wifi.slash","antenna.radiowaves.left.and.right","network","externaldrive.fill","server.rack","printer.fill","cpu","memorychip","sdcard.fill","cable.connector","dot.radiowaves.left.and.right"]},{name:"Status",symbols:["checkmark","checkmark.circle.fill","xmark","xmark.circle.fill","exclamationmark.triangle.fill","exclamationmark.circle.fill","questionmark.circle.fill","info.circle.fill","circle.fill","circle","circle.circle.fill","minus.circle.fill","plus.circle.fill","hand.thumbsup.fill","hand.thumbsdown.fill","star.fill","heart.fill","flag.fill","pin.fill","wrench.and.screwdriver.fill","gearshape.fill","hourglass","ellipsis"]},{name:"Time",symbols:["clock","clock.fill","alarm","timer","stopwatch.fill","calendar","calendar.badge.clock","hourglass.bottomhalf.filled","deskclock.fill","sunrise","sunset","moon.zzz.fill","zzz"]},{name:"Arrows",symbols:["arrow.up","arrow.down","arrow.left","arrow.right","arrow.up.right","arrow.down.right","arrow.up.circle.fill","arrow.down.circle.fill","arrow.clockwise","arrow.counterclockwise","arrow.up.arrow.down","arrow.up.and.down","arrow.left.and.right","arrowshape.turn.up.left.fill","chevron.up","chevron.down","chevron.left","chevron.right"]},{name:"Shapes",symbols:["square.fill","square","circle.dashed","triangle.fill","diamond.fill","hexagon.fill","octagon.fill","capsule.fill","rectangle.fill","app.fill","seal.fill","shield","oval.fill","pentagon.fill","rhombus.fill","drop","cloud","bolt"]},{name:"Text and numbers",symbols:["0.circle.fill","1.circle.fill","2.circle.fill","3.circle.fill","textformat","textformat.size","percent","number","plus","minus","multiply","divide","equal","function","sum","character","character.textbox","degreesign.celsius","degreesign.fahrenheit"]},{name:"Nature",symbols:["tree.fill","carrot.fill","drop.triangle.fill","pawprint.fill","hare.fill","tortoise.fill","ant.fill","ladybug.fill","bird.fill","fish.fill","camera.macro","mountain.2.fill","water.waves","globe.americas.fill"]},{name:"People",symbols:["person.fill","person.2.fill","person.3.fill","person.crop.circle.fill","person.fill.checkmark","person.fill.xmark","figure.walk","figure.run","figure.stand","hand.raised.fill","ear.fill","brain.head.profile","eye","accessibility"]},{name:"Transport",symbols:["car.fill","car.2.fill","bus.fill","tram.fill","airplane","bicycle","figure.walk.motion","ev.charger.fill","fuelpump.fill","parkingsign.circle.fill","road.lanes","location.fill","location.slash.fill","map.fill","mappin.and.ellipse"]}],qi=[...new Set(ji.flatMap(e=>e.symbols))],Mp={"aqi.medium":["air quality"],"arrow.clockwise":["refresh","reload","update"],"battery.100percent":["charge","level"],"bolt.fill":["power","energy","watt","electric"],"checkmark.circle.fill":["ok","done","good"],"clock.fill":["time"],"curtains.closed":["blind","shade","cover"],"door.left.hand.open":["entry"],"drop.fill":["humidity","water","moisture"],"dryer.fill":["laundry"],"exclamationmark.triangle.fill":["alert","alarm","problem","error"],"fan.fill":["ventilation"],"figure.walk":["motion","presence"],"flame.fill":["heat","heating","boiler","fire"],"gauge.with.needle":["pressure"],"gearshape.fill":["settings","config"],"house.fill":["home"],"leaf.fill":["eco","plant","garden"],"lock.fill":["security","locked","secure"],"moon.fill":["night","sleep"],"person.fill":["presence","occupancy"],"poweroutlet.type.b.fill":["socket","outlet"],"powerplug.fill":["outlet","socket","plug","switch"],"sensor.tag.radiowaves.forward.fill":["motion"],snowflake:["cool","cooling","ac","freeze"],"speaker.wave.2.fill":["volume","sound","audio"],"sun.max.fill":["day","bright","brightness"],"thermometer.medium":["temperature","temp"],"video.fill":["camera"],"washer.fill":["laundry"],"water.waves":["pool","flood"],wifi:["network","internet","signal"],"window.casement":["blind","shade"]};function Fp(e){return`${e.replace(/\./g," ")} ${(Mp[e]??[]).join(" ")}`}function Ir(e,n){let t=n.toLowerCase().split(/[\s.]+/).filter(Boolean);if(t.length===0)return[...e];let i=[];for(let a of e){let r=Fp(a);if(!t.every(s=>r.includes(s)))continue;let o=t.join(".");i.push({name:a,score:a===o?0:a.startsWith(o)?1:2})}return i.sort((a,r)=>a.score-r.score).map(a=>a.name)}var Wi=class e{constructor(n){this.onChange=n;this.collapsed=new Set;this.browsing=new Map;this.recent=[];this.recent=e.loadRecent()}static{this.STORAGE_KEY="wrist-assistant.recent-symbols"}static{this.RECENT_LIMIT=12}isOpen(n){return!this.collapsed.has(n)}toggle(n){this.collapsed.has(n)?this.collapsed.delete(n):this.collapsed.add(n),this.onChange()}query(n){return this.browsing.get(n)?.query??""}category(n){return this.browsing.get(n)?.category??""}pack(n){return this.browsing.get(n)?.pack}setQuery(n,t){this.browsing.set(n,{category:this.category(n),query:t,pack:this.pack(n)}),this.onChange()}setCategory(n,t){this.browsing.set(n,{query:this.query(n),category:t,pack:this.pack(n)}),this.onChange()}setPack(n,t){this.browsing.set(n,{query:"",category:this.category(n),pack:t}),this.onChange()}noteUsed(n){let t=n.trim();t&&(this.recent=[t,...this.recent.filter(i=>i!==t)].slice(0,e.RECENT_LIMIT),e.saveRecent(this.recent),this.onChange())}static loadRecent(){try{let n=localStorage.getItem(e.STORAGE_KEY),t=n?JSON.parse(n):[];return Array.isArray(t)?t.filter(i=>typeof i=="string").slice(0,e.RECENT_LIMIT):[]}catch{return[]}}static saveRecent(n){try{localStorage.setItem(e.STORAGE_KEY,JSON.stringify(n))}catch{}}};var Ip=100;function Cl(e){return e.error!==void 0&&e.error!==""?{tone:"err",text:`Not saved: ${e.error}`}:e.templateError!==void 0&&e.templateError!==""?{tone:"err",text:`Template error: ${e.templateError}`}:e.dirty?{tone:"warn",text:"Unsaved changes"}:e.revision===null?{tone:"warn",text:"Not saved yet"}:{tone:"ok",text:`Saved, revision ${e.revision}`}}var qt=class e{constructor(n,t){this.config=n;this.past=[];this.future=[];this.coalesceUntil=0;this.baseRevision=t,yn(n),$t(n),this.baseline=JSON.stringify(mn(n))}static fromDocument(n,t){return new e(hn(n),t)}get dirty(){return JSON.stringify(mn(this.config))!==this.baseline}get canUndo(){return this.past.length>0}get canRedo(){return this.future.length>0}update(n,t,i){let a=Date.now();t!==void 0&&t===this.coalesceKey&&a<this.coalesceUntil||(this.past.push(structuredClone(this.config)),this.past.length>Ip&&this.past.shift(),this.future=[]),this.coalesceKey=t,this.coalesceUntil=t===void 0?0:a+800;let o=structuredClone(this.config);n(o),yn(o,i),$t(o),this.config=o}markDirty(){this.baseline=""}endGesture(){this.coalesceKey=void 0,this.coalesceUntil=0}undo(){let n=this.past.pop();n&&(this.future.push(this.config),this.config=n,this.endGesture())}redo(){let n=this.future.pop();n&&(this.past.push(this.config),this.config=n,this.endGesture())}encoded(){let n=structuredClone(this.config);return n.dataSources=yr(n),mn(n)}commit(){let n=structuredClone(this.config);return n.dataSources=yr(n),new e(n,null)}};var Yi=class{constructor(){this.watched=new Map;this.onScroll=n=>this.mark(n.currentTarget);this.observer=new ResizeObserver(()=>{for(let n of this.watched.keys())this.mark(n)})}refresh(n){let t=new Set(n.filter(i=>i!=null));for(let[i,a]of[...this.watched])t.has(i)||this.drop(i,a);for(let i of t){let a=this.watched.get(i);a||(a=new Set,this.watched.set(i,a),i.addEventListener("scroll",this.onScroll,{passive:!0}),this.observer.observe(i));for(let r of a)r.parentElement!==i&&(this.observer.unobserve(r),a.delete(r));for(let r of i.children)a.has(r)||(a.add(r),this.observer.observe(r));this.mark(i)}}disconnect(){for(let[n,t]of[...this.watched])this.drop(n,t);this.observer.disconnect()}drop(n,t){n.removeEventListener("scroll",this.onScroll),this.observer.unobserve(n);for(let i of t)this.observer.unobserve(i);this.watched.delete(n)}mark(n){let t=n.scrollHeight-n.clientHeight,i=t>1;n.toggleAttribute("data-more-above",i&&n.scrollTop>1),n.toggleAttribute("data-more-below",i&&n.scrollTop<t-1)}};var $n={isOn:"is on",isOff:"is off",equals:"equals",notEquals:"does not equal",isUnavailable:"is unavailable or unknown",isStale:"data is stale",isEmpty:"is empty",greaterThan:"is greater than",greaterOrEqual:"is at least",lessThan:"is less than",lessOrEqual:"is at most",between:"is between",timeBetween:"is between times",contains:"contains",startsWith:"starts with",endsWith:"ends with",matchesRegex:"matches regex",isOneOf:"is one of"},lt={icon:"Icon",text:"Text",color:"Colour",visibility:"Visible",opacity:"Opacity",fontSize:"Size",fontWeight:"Weight",rotation:"Rotation",gaugeValue:"Gauge value",gaugeMin:"Gauge min",gaugeMax:"Gauge max",backgroundColor:"Background",borderColor:"Border colour",borderWidth:"Border width"},El=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"],Tl={color:"setColor",opacity:"setOpacity",text:"setText",icon:"setIcon",fontSize:"setFontSize",fontWeight:"setFontWeight",rotation:"setRotation",visibility:"hide",gaugeValue:"setGaugeValue",gaugeMin:"setGaugeMin",gaugeMax:"setGaugeMax",borderColor:"setBorderColor",borderWidth:"setBorderWidth",backgroundColor:"setBackgroundColor"},Rr=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","lessThan","lessOrEqual","between","greaterOrEqual","greaterThan","contains","startsWith","endsWith"],Rp=["lessThan","lessOrEqual","between","greaterOrEqual","greaterThan"];function Ar(e){return Rp.includes(e)}function Ap(e){return Rr.includes(e)}function Hp(e,n){return JSON.stringify(ae(e))===JSON.stringify(ae(n))}function Hr(e){if(e.length>1)return{ok:!1,reason:`There are ${e.length} rules here. A table shows one.`};let n=e[0];if(!n)return{ok:!0,table:{ruleId:"",rows:[],columns:[],numberMode:!1}};let t,i=[];for(let[r,o]of n.cases.entries()){let s=o.when.tests;if(s.length!==1)return{ok:!1,reason:s.length===0?`State ${r+1} checks nothing, so it always matches.`:`State ${r+1} checks ${s.length} things at once. A table row checks one.`};let l=s[0];if(!Ap(l.comparison.kind))return{ok:!1,reason:`State ${r+1} uses "${$n[l.comparison.kind]}", which a table row cannot show.`};if(t===void 0)t=l.value;else if(!Hp(t,l.value))return{ok:!1,reason:"The states test different values. A table tests one value in every row."};let d=Sl(o.then);if(d)return{ok:!1,reason:`State ${r+1} sets ${lt[d]} twice. A table has one cell per column.`};i.push({caseId:o.id,testId:l.id,join:o.when.join,comparison:l.comparison,changes:o.then})}if(n.otherwise){let r=Sl(n.otherwise);if(r)return{ok:!1,reason:`Otherwise sets ${lt[r]} twice. A table has one cell per column.`}}let a={ruleId:n.id,rows:i,columns:Lp(i,n.otherwise),numberMode:i.length>0&&i.every(r=>Ar(r.comparison.kind))};return t!==void 0&&(a.value=t),n.otherwise&&(a.otherwise=n.otherwise),{ok:!0,table:a}}function Sl(e){let n=new Set;for(let t of e){let i=Re[t.kind];if(n.has(i))return i;n.add(i)}}function Lp(e,n){let t=new Set;for(let i of e)for(let a of i.changes)t.add(Re[a.kind]);for(let i of n??[])t.add(Re[i.kind]);return El.filter(i=>t.has(i))}function Ml(e,n,t){let i=new Set(e);for(let a of n)i.add(a);return El.filter(a=>i.has(a)&&t.includes(a))}function Ji(e,n){return e.find(t=>Re[t.kind]===n)}function Fl(e,n,t,i){let a=n.map(o=>({id:o.caseId??J(),when:{join:o.join??"all",tests:[{id:o.testId??J(),value:structuredClone(e),comparison:o.comparison}]},then:o.changes})),r={id:i??J(),cases:a};return t&&(r.otherwise=t),r}function ii(e){if(e.length===0)return"No states yet.";let n=Hr(e);if(!n.ok)return"Advanced rules.";let t=n.table.rows.length+(n.table.otherwise?1:0);return t===1?"1 state.":`${t} states.`}function Il(e){let n=e[0];return n||(n={id:J(),cases:[]},e.push(n)),n}function Rl(e){let n=e[0];n&&n.cases.length===0&&n.otherwise===void 0&&(e.length=0)}function Al(e,n,t){let i=Il(e),a=i.cases[i.cases.length-1]?.when.tests[0]?.comparison;i.cases.push({id:J(),when:{join:"all",tests:[{id:J(),value:structuredClone(n),comparison:Np(a,t)}]},then:[]})}function Hl(e,n){let t=e[0];t&&(t.cases=t.cases.filter(i=>i.id!==n),Rl(e))}function Lr(e,n,t){let i=e[0]?.cases;if(!i||t<0||t>=i.length)return;let[a]=i.splice(n,1);a&&i.splice(t,0,a)}function _r(e,n){if(n){Il(e).otherwise=[];return}let t=e[0];t&&(delete t.otherwise,Rl(e))}function Ll(e,n){for(let t of e[0]?.cases??[]){let i=t.when.tests[0];i&&(i.value=structuredClone(n))}}function _l(e,n){let t=e[0];if(!t)return;let i=a=>a.filter(r=>Re[r.kind]!==n);for(let a of t.cases)a.then=i(a.then);t.otherwise&&(t.otherwise=i(t.otherwise))}function _p(e){return e?e.kind.kind==="literal"?e.kind.value===""?"?":e.kind.value:"a value":"?"}function Nl(e,n=_p){let t=()=>n(e.value??I(""));switch(e.kind){case"lessThan":return`below ${t()}`;case"lessOrEqual":return`${t()} or below`;case"greaterThan":return`above ${t()}`;case"greaterOrEqual":return`${t()} or above`;case"between":return`${t()} to ${n(e.upper??I(""))}`;case"timeBetween":return`${t()} to ${n(e.upper??I(""))}`;case"matchesRegex":return`matches ${e.pattern||"?"}`;case"isOneOf":return`is one of ${(e.options??[]).join(", ")||"?"}`;default:return Ut(e.kind)==="value"?`${$n[e.kind]} ${t()}`:$n[e.kind]}}function Np(e,n){if(!e)return n?{kind:"lessThan",value:I("20")}:{kind:"isOn"};switch(e.kind){case"isOn":return{kind:"isOff"};case"isOff":return{kind:"isOn"};case"lessThan":case"lessOrEqual":return{kind:"greaterOrEqual",value:e.value??I("0")};case"between":return{kind:"greaterOrEqual",value:e.upper??I("0")};case"greaterThan":case"greaterOrEqual":return{kind:"greaterOrEqual",value:e.value??I("0")};default:return{kind:e.kind,...Ut(e.kind)==="value"?{value:I("")}:{}}}}var zl={text:"text",icon:"icon",gauge:"color",chart:"color",timeline:"visibility",shape:"color",image:"visibility",tap:"visibility",layout:"backgroundColor"};function Pl(e){if(!e)return!1;let n=e.kind;if(n.kind!=="entityState")return!1;let t=n.domain||n.entityId.split(".")[0]||"";return["light","switch","fan","input_boolean","binary_sensor","automation","siren","humidifier","group"].includes(t)}function zp(e){switch(e){case"text":return v`<path d="M5 6H19M12 6V19M9 19H15" />`;case"icon":return v`<path d="M12 3.5L14.6 9L20.5 9.7L16.1 13.8L17.3 19.7L12 16.8L6.7 19.7L7.9 13.8L3.5 9.7L9.4 9Z" />`;case"gauge":return v`<path d="M5 17A8 8 0 1 1 19 17" /><path d="M12 13L15.5 9.5" /><circle cx="12" cy="13" r="1.4" />`;case"chart":return v`<path d="M5 19V13" /><path d="M9.7 19V9" /><path d="M14.3 19V15" /><path d="M19 19V5" />`;case"timeline":return v`<rect x="3" y="9" width="6" height="6" rx="1.5" /><rect x="10.5" y="9" width="3.5" height="6" rx="1.5" /><rect x="15.5" y="9" width="5.5" height="6" rx="1.5" />`;case"shape":return v`<rect x="4" y="5" width="16" height="14" rx="3" />`;case"image":return v`<rect x="3.5" y="5" width="17" height="14" rx="2.5" /><circle cx="9" cy="10" r="1.6" /><path d="M20.5 15.5L15.5 11L7 19" />`;case"tap":return v`<path d="M10 12V5.5a1.8 1.8 0 0 1 3.6 0V12" /><path d="M13.6 10.5a1.8 1.8 0 0 1 3.6 0V13" /><path d="M10 11.5a1.8 1.8 0 0 0-3.6 0v3.5a6.6 6.6 0 0 0 13.2 0v-1.5" />`;case"content":return v`<rect x="3.5" y="5" width="17" height="14" rx="2.5" /><path d="M7 9.5H17M7 13H13" />`;case"look":return v`<circle cx="12" cy="12" r="8.5" /><circle cx="8.5" cy="10.5" r="1.1" /><circle cx="12" cy="8" r="1.1" /><circle cx="15.5" cy="10.5" r="1.1" /><path d="M12 20.5a2.5 2.5 0 0 0 0-5h-1a1.8 1.8 0 0 1 0-3.6" />`;case"clock":return v`<circle cx="12" cy="12" r="8.5" /><path d="M12 7.5V12L15 14" />`;case"states":return v`<path d="M6 4V9.5A2.5 2.5 0 0 0 8.5 12H15.5A2.5 2.5 0 0 1 18 14.5V20" /><circle cx="6" cy="4" r="1.4" /><circle cx="18" cy="20" r="1.4" /><path d="M6 20V14" />`;case"place":return v`<path d="M12 3V6.5M12 17.5V21M3 12H6.5M17.5 12H21" /><circle cx="12" cy="12" r="4.5" />`;case"layers":return v`<path d="M12 4L20 8.5L12 13L4 8.5Z" /><path d="M4 12.5L12 17L20 12.5" /><path d="M4 16.5L12 21L20 16.5" />`;case"grip":return v`<circle cx="9" cy="6" r="1.3" /><circle cx="15" cy="6" r="1.3" /><circle cx="9" cy="12" r="1.3" /><circle cx="15" cy="12" r="1.3" /><circle cx="9" cy="18" r="1.3" /><circle cx="15" cy="18" r="1.3" />`;case"chevron":return v`<path d="M6 9L12 15L18 9" />`;case"plus":return v`<path d="M12 5V19M5 12H19" />`;case"watch":return v`<rect x="6" y="6.5" width="12" height="11" rx="3" /><path d="M9 6.5L9.6 3H14.4L15 6.5M9 17.5L9.6 21H14.4L15 17.5" />`;case"compact":return v`<path d="M4 6.5H20M4 12H20M4 17.5H20" />`;case"expanded":return v`<rect x="3.5" y="4" width="17" height="7" rx="1.8" /><rect x="3.5" y="13" width="17" height="7" rx="1.8" /><path d="M6.5 8H13M6.5 17H13" />`;case"lock":return v`<rect x="5" y="11" width="14" height="10" rx="2" /><path d="M8 11V7.5a4 4 0 0 1 8 0V11" />`;case"unlock":return v`<rect x="5" y="11" width="14" height="10" rx="2" /><path d="M8 11V7.5a4 4 0 0 1 7.6-1.7" />`;case"folder":return v`<path d="M3.5 7.5A2 2 0 0 1 5.5 5.5H9.5L11.5 7.5H18.5A2 2 0 0 1 20.5 9.5V17A2 2 0 0 1 18.5 19H5.5A2 2 0 0 1 3.5 17Z" />`;case"ungroup":return v`<path d="M3.5 7.5A2 2 0 0 1 5.5 5.5H9.5L11.5 7.5H18.5A2 2 0 0 1 20.5 9.5V17A2 2 0 0 1 18.5 19H5.5A2 2 0 0 1 3.5 17Z" /><path d="M9 13.5H15" />`;case"up":return v`<path d="M6 14L12 8L18 14" />`;case"down":return v`<path d="M6 10L12 16L18 10" />`;case"show":return v`<path d="M2.5 12C5.5 7 8.7 5.5 12 5.5C15.3 5.5 18.5 7 21.5 12C18.5 17 15.3 18.5 12 18.5C8.7 18.5 5.5 17 2.5 12Z" />
        ...
        <path d="M4 3.5V7H7.5" />`;case"search":return v`<circle cx="10.8" cy="10.8" r="6.3" /><path d="M15.4 15.4L20 20" />`;case"undo":return v`<path d="M9 14L4 9L9 4" /><path d="M4 9H15A5 5 0 0 1 15 19H12" />`;case"redo":return v`<path d="M15 14L20 9L15 4" /><path d="M20 9H9A5 5 0 0 0 9 19H12" />`;case"expand":return v`<path d="M15 3H21V9M9 21H3V15M21 3L14 10M3 21L10 14" />`}}function N(e){return p`<svg class="ui-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${zp(e)}</svg>`}var qe="color-mix(in srgb, var(--k) 45%, #6b7280)",Xi='system-ui, -apple-system, "Segoe UI", sans-serif';function Ol(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=u=>{let c=u*Math.PI/180;return{x:(e-t*Math.cos(c)).toFixed(2),y:(n-t*Math.sin(c)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Nr(e,n,t,i){return v`<g fill="none" stroke-linecap="round">
    <path d=${Ol(e,n,t,1)} stroke=${qe} stroke-width="2.6" opacity=".5" />
    <path d=${Ol(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function Pp(e){switch(e){case"text":return v`<g font-family=${Xi} text-anchor="middle">
    ...
    <textarea rows=${i} .value=${n} class="mono" @input=${fe(t)}></textarea></label>`}function ne(e,n,t,i={}){return p`<label class="field">${Je(e,Xt(n,i.def,t))}${xd(n,t,i)}</label>`}function xd(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e);return p`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??f} max=${t.max??f}
      aria-label=${t.ariaLabel??f}
      @input=${fe(a=>{if(a.trim()===""){t.optional&&n(void 0);return}let r=Number(a);Number.isNaN(r)||n(r)})} />`}function He(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return p`<label class="field">${Je(e,Xt(n,a.def,i,r))}
    <select @change=${fe(o=>i(o))}>
      ${t.map(([o,s])=>p`<option value=${o} ?selected=${o===n}>${s}</option>`)}
    </select></label>`}function X(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return p`<div class="field seg-field">${Je(e,Xt(n,a.def,i,r))}
    ...
    </div></div>`}function ri(e,n,t,i){let a=i.format??(r=>String(Math.round(r*100)/100));return p`<div class="field slider">${Je(e,Xt(n,i.def,t,a))}
    ...
    </div></div>`}function Qi(e,n,t,i,a,r){let o=s=>Math.round(s*1e3)/10;return ne(e,o(n),s=>t((s??0)/100),{min:a,max:r,step:.5,def:o(i)})}function Se(e,n,t,i){return p`<label class="field check"><input type="checkbox" .checked=${n} @change=${a=>t(a.target.checked)} />${Je(e,Xt(n,i,t,a=>a?"on":"off"))}</label>`}function re(e,n,t,i=!1,a){let r=(n??"").replace(/^#/,""),o=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(r),s=o?`#${r.slice(0,6)}`:"#ffffff",l=o&&r.length===8?Math.round(parseInt(r.slice(6,8),16)/255*100):100,d=(c,h)=>{let m=c.replace(/^#/,"").toUpperCase();return h>=100?`#${m}`:`#${m}${Math.round(h/100*255).toString(16).padStart(2,"0").toUpperCase()}`},u=a===void 0?void 0:{atDefault:qp(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)};return p`<div class="field color">${Je(e,u)}
    <div class="color-row">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      <input type="text" class="mono" role="combobox" aria-autocomplete="list" aria-expanded=${s?"true":"false"} autocomplete="off" spellcheck="false"
        ...
        @focus=${$=>{let C=$.target;c(C,t.entityId),C.select()}}
        @input=${$=>{let C=$.target;c(C,C.value)}}
        @keydown=${x}
        @blur=${$=>{let C=$.target;s&&m(C.value),h(C)}} />
      ${(s?s.query:t.entityId)===""?f:p`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        @mousedown=${$=>$.preventDefault()}
        @click=${$=>{let C=$.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Jt.set(a,{query:"",index:0}),Ne(C),C?.focus()}}>${N("close")}</button>`}
    </div>
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${$d(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map(($,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                @mousedown=${L=>L.preventDefault()} @click=${L=>g($,L.target)}>
                <span class="ent-ico ${Br($.state)?"on":""}">${Vr($.domain)}</span>
                <span class="ent-main">
                  <span class="ent-name">${$.name}</span>
                  <span class="ent-sub">
                    ${$.area?p`<span class="ent-area">${$.area}</span>`:f}
                    <span class="ent-id mono">${$.entityId}</span>
                  </span>
                </span>
                <span class="ent-right">
                  <span class="ent-type">${Zl($.domain)}</span>
                  <span class="ent-state">${$.state}</span>
                </span>
              </button>`)}
        </div>`:T}
  </div>`}function eh(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var ed=120;function th(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(ji.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(qi),fromPack:!1}}function td(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function nh(e){return[{value:"",label:`Starter set (${td(qi,e)})`},...ji.map(n=>({value:n.name,label:`${n.name} (${td(n.symbols,e)})`}))]}function ih(e){return e.length>0?e.length:qi.length}function nd(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function ea(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return p`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Cd(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],u=new Set(d),c=n.trim(),h=c.startsWith($e),m=a!==void 0,g=m?r.pack(i)??(h?"mdi":"sf"):"sf",y=ah(c,u),x=$=>{t($),a?.($.startsWith($e)?e.icons.mdiPath?.($):void 0),r.noteUsed($)},S=$=>{if(t($),!m)return;let C=$.trim();a?.(C.startsWith($e)?e.icons.mdiPath?.(C):void 0)},T=f;if(o&&g==="mdi"){let $=e.icons.mdiNames?.(),C=rh($??[],s),L=C.slice(0,ed),O=r.recent.filter(V=>V.startsWith($e));T=p`<div class="sym-browse">
      ${id(r,i,g)}
      ...
      ${O.length===0?f:p`<div class="hint">Recent</div>
        <div class="sym-grid one-row">${O.map(V=>ea(e,V,V===c,x))}</div>`}
      <div class="sym-grid">${L.map(V=>ea(e,V,V===c,x))}</div>
      ${$===void 0?p`<div class="hint">Loading the Material Design catalogue.</div>`:C.length===0?p`<div class="hint">Nothing matches that search. Any <code>mdi:</code> name can still be typed above.</div>`:p`<div class="hint">${nd(L.length,C.length,!0,$.length)}</div>`}
      ${$!==void 0&&h&&!$.includes(c)?p`<div class="hint warn">There is no <code>${c}</code> in this build's Material Design set, so the watch draws a question mark.</div>`:f}
    </div>`}else if(o){let $=r.category(i),C=th($,s,d,u),L=Ir(C.names,s),O=C.fromPack?L.slice(0,ed):L,V=r.recent.filter(w=>!w.startsWith($e)),ie=u.size===0?V:V.filter(w=>u.has(w));T=p`<div class="sym-browse">
      ${m?id(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${fe(w=>r.setQuery(i,w))} />
        <select @change=${fe(w=>r.setCategory(i,w))}>
          ${nh(u).map(w=>p`<option value=${w.value} ?selected=${w.value===$}>${w.label}</option>`)}
        </select>
      </div>
      ${ie.length===0?f:p`<div class="hint">Recent</div>
        <div class="sym-grid one-row">${ie.map(w=>ea(e,w,w===c,x))}</div>`}
      <div class="sym-grid">${O.map(w=>ea(e,w,w===c,x))}</div>
      ${L.length===0?p`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:p`<div class="hint">
            ${nd(O.length,L.length,s.trim()!=="",ih(d))}
          </div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${fe(S)} @change=${fe($=>{let C=$.trim();C.startsWith($e)?e.icons.mdiPath?.(C)!==void 0&&r.noteUsed($):(u.size===0||u.has(C))&&r.noteUsed($)})} /></label>
    ${y?p`<div class="hint warn">The installed icon pack has no <code>${c}</code>, so the preview shows a placeholder. The watch still draws it if the name is a real SF Symbol.</div>`:f}
    <button type="button" class="link" @click=${()=>r.toggle(i)}>${o?"Hide symbols":"Browse symbols"}</button>
    ${T}`}function ah(e,n){let t=e.trim();return t!==""&&!t.startsWith($e)&&n.size>0&&!n.has(t)}function rh(e,n){let t=n.trim(),i=t.startsWith($e)?t.slice($e.length):t,a=e.map(r=>r.startsWith($e)?r.slice($e.length):r);return Ir(a,i).map(r=>$e+r)}function id(e,n,t){return p`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var oh=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],sh=[["bars","Bars"],["line","Line"],["area","Area"]],lh=[["auto","Auto"],["fixed","Fixed range"]],dh=[["lowest","Lowest value"],["zero","Zero"]],Qr=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],ad=[["none","None"],["dot","Dot"],["triangle","Triangle"]],Wr=[["uniform","One colour"],["bands","By value"]];function jr(e){let n=[za,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function ch(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function uh(e,n){let t=cn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function qr(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    ${re("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??wt},"tother"),!1,wt)}`}var mh=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],fh={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function rd(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return I(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var gh=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function yh(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function oe(e,n,t,i){if(i.inline||!bh())return p`<div class="value-editor">${Td(e,n,t,i)}</div>`;let a=eo(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=be(n,ve(e)),l="entityId"in n.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${Sd(e,a,r,n,t,i)}
  </div>`}function Sd(e,n,t,i,a,r){return p`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Ed}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${oi.has(n)?Td(e,i,a,r):f}
  </div>`}function ve(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function eo(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function bh(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var oi=new Set,ai=new WeakMap;function vh(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function wh(e,n){let t=e instanceof Node?e:null;if(!t)return;let i=t.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(n)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function Ed(e){let n=e.currentTarget,t=e.newState==="open",i=ai.get(n);if(i&&(i(),ai.delete(n)),!t){oi.delete(n.id)&&Ne(n);return}let a=vh(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ai.get(n)?.(),ai.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}Gr(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ai.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Gr(n,a.getBoundingClientRect()),oi.has(n.id)||(oi.add(n.id),Ne(n),requestAnimationFrame(()=>{n.isConnected&&Gr(n,a.getBoundingClientRect())}))}function Gr(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=xh({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Yt=8,ta=6,od=140;function xh(e,n,t){let i=t.height-e.bottom-ta-Yt,a=e.top-ta-Yt,r=n.height>i&&a>i&&i<od,o=Math.max(od,r?a:i),s=Math.min(n.height,o),l=Math.max(Yt,Math.min(e.left,t.width-n.width-Yt)),d=r?Math.max(Yt,e.top-ta-s):Math.max(Yt,Math.min(e.bottom+ta,t.height-s-Yt));return{left:l,top:d,maxHeight:o,above:r}}function Td(e,n,t,i){let a=n.kind,r=u=>t({...n,kind:u}),o=i.key,s=oh.filter(([u])=>i.allowNamed!==!1||u!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Cd(e,a.value,u=>r({...a,value:u}),o,i.setSymbolPath):pe("Text",a.value,u=>r({...a,value:u}));break;case"entityState":case"entityAge":l=Ye(e,"Entity",a,u=>r({...a,...u}),`${o}-entity`);break;case"entityAttribute":{let u=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),c=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=p`${Ye(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${pe("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:c,mono:!0})}
        <datalist id=${c}>${u.map(h=>p`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=$h(e,a.aggregate,u=>r({...a,aggregate:u}),o);break;case"time":l=He("Field",a.timeField,gh,u=>r({...a,timeField:u}));break;case"dataAge":l=p`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=p`${wd("Template",a.value,u=>r({...a,value:u}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":l=e.config.values.length===0?p`<div class="hint warn">There are no named values yet. Add one in the Data card first.</div>`:He("Value",a.id,[["","(choose)"],...e.config.values.map(u=>[u.id,u.name||u.id.slice(0,8)])],u=>r({...a,id:u}));break;case"chartStat":{let u=ve(e),c=e.config.elements.filter(h=>h.kind==="chart");l=c.length===0?p`<div class="hint warn">There is no chart layer yet. Add one first, then this can print one of its numbers.</div>`:p`
          ...
          ${He("Number",a.stat,[...on],h=>r({...a,stat:h}))}
    ...
    ${He("Source",a.kind,s,u=>r(yh(a,u)))}
    ${l}
    ${i.noFormat?f:kh(n.format,u=>t(Ue(u)?{kind:n.kind}:{...n,format:u}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:f}`}function kh(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return p`<details class="sub" ?open=${!Ue(e)}>
  ...
  </details>`}function $h(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return p`
    ...
    ${n.function==="count"?f:pe("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Md=Qa,Ch=Md.filter(([e])=>e!=="none");function Sh(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Fd(e,n){let t=Sh(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return ws(e)?{type:e,...t}:{type:e}}var Eh=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Id(e,n,t,i){let a=n.serviceDataJSON??"",r=xs(a),o=n.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Mh).slice(0,7)}
    ...
    ${t.type==="callService"?Id(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?Fh(e):f}`}var Mh="#808080",sd=[0,15,30,60,120];function ld(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Fh(e){let n=e.config;return Ad(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Ad(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${He("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function Hd(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return p`
    ...
    ${t?p`
      ...
      ${ne("Text size (pt)",e.timestampSize,r=>n(o=>{o.timestampSize=Math.min(40,Math.max(4,r??pn))},"tssize"),{step:1,min:4,max:40,def:pn})}
  ...
  </section>`}function Dh(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Vh(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Bh(e,n){let t=he[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Gh(e,n,t){let i=Bh(e,n),a=he[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return p`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <div class="hint">${t?p`${Sn(e,r)}, up to 366 days. Statistics rows are never
          purged, so the limit is about what fits on a complication rather than about what
          the recorder still holds.`:p`${Sn(e,r)}, up to 7 days: the recorder keeps
          ten by default, and a longer span would quietly come back short.`}</div>`}function Wh(e){if(e.historyMinutes<=0)return"";if(e.source!=="statistics")return` \xB7 ${Sn(e.historyMinutes)}`;let n=yi.find(([t])=>t===e.statPeriod)?.[1]??e.statPeriod;return` \xB7 ${Sn(e.historyMinutes,Wn)} \xB7 per ${n.toLowerCase()}`}function no(e,n){let t=ve(e);switch(n.kind){case"text":return St(be(n.payload.value,t),48);case"icon":return St(be(n.payload.symbol,t),48);case"gauge":return St(be(n.payload.value,t),48);case"chart":return St(`${be(n.payload.value,t)}${Wh(n.payload)}`,48);case"timeline":return St(`${be(n.payload.value,t)} \xB7 ${Sn(Ge(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return nt(n.payload.action)}}function la(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Ce(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Ce(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${Qr.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Ce(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Ce(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Ce(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function io(e,n,t,i={}){let a=n.payload.id,r=`el-${a}`,o=Te(e.config,t,n),s=o.frame,l=(u,c)=>e.update(h=>ke(h,t,a,{frame:zr(s,u)}),`${r}-${c}-${t}`),d=!sa(s,et)||o.isHidden;return Ee(e,"placement","Position",p`
    <div class="grid4">
      ${Qi("Left",s.x,u=>l({x:u},"x"),et.x,-100,100)}
      ${Qi("Top",s.y,u=>l({y:u},"y"),et.y,-100,100)}
      ${Qi("Width",s.width,u=>l({width:u},"w"),et.width,4,200)}
      ${Qi("Height",s.height,u=>l({height:u},"h"),et.height,4,200)}
    </div>
    ${ri("Rotation",s.rotationDegrees,u=>l({rotationDegrees:u},"rot"),{min:-180,max:180,step:1,def:0,format:u=>`${Math.round(u)}\xB0`})}
    ${Se("Hidden",o.isHidden,u=>e.update(c=>ke(c,t,a,{isHidden:u})),!1)}
    <div class="hint">On the ${Z(t)} shape only. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:ee.place,icon:"place",summary:`${Math.round(s.width*100)}% wide \xB7 ${Z(t)}`,...i.inline?{alwaysOpen:!0,cardClass:"place-bar",bodyClass:"place-row"}:{},...d?{resetTitle:`Put this layer back to the middle of the ${Z(t)} face at half size, unrotated and shown`,reset:()=>e.update(u=>ke(u,t,a,{frame:{...et},isHidden:!1}))}:{}})}function ao(e,n,t={}){let i=t.placeholder;if(i===void 0&&(n===void 0||n.kind==="tap"))return f;let a=n!==void 0&&n.kind!=="tap"?n:void 0,r=a?Ae(e.config,a.payload.id)[0]:void 0,o=r===void 0,s=i===void 0&&a!==void 0?rm(e,a,`el-${a.payload.id}`):p`
      <label class="field check"><input type="checkbox" disabled .checked=${!1} /><span>Tappable</span></label>
      <div class="hint">${i}</div>`;return Ee(e,"tappable","Tap",s,{color:ee.tap,icon:"tap",summary:r?nt(r.payload.action):"Not tappable",...t.inline?{alwaysOpen:!0,cardClass:`tap-bar${o?" muted-bar":""}`,bodyClass:"tap-row"}:{},...r&&a?{reset:()=>e.update(l=>Mi(l,a.payload.id))}:{}})}function hd(e,n,t,i,a){return p`
    ...
    ${e.timeLabelCount<=0?f:p`
      <div class="grid2">
        ...
        ${re("Time colour",e.labelColorHex,r=>n(o=>{o.labelColorHex=r??vt},`${i}colour`),!1,t.labelColorHex)}
      </div>
      ...
      ${a}`}`}var jh=[["number","Number"],["entity","Entity"]];function qh(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Yh(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Jh(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=qh(n,o),u=s?n.minValue:n.maxValue,c=y=>a(x=>{s?x.minValue=y??0:x.maxValue=y??100},o),h={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=p`<div class="gauge-end-head">
      ${Je(l,d==="number"?Xt(u,t[o],c):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${jh.map(([y,x])=>p`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${h[y]}
          @click=${()=>{y!==d&&a(S=>Yh(S,o,y))}}>${x}</button>`)}
      </span>
    </div>`,g=s?n.minSource:n.maxSource;return d==="number"||g===void 0?p`<div class="field gauge-end">${m}${xd(u,c,{ariaLabel:l})}</div>`:p`<div class="field gauge-end">${m}${oe(e,g,y=>a(x=>{s?x.minSource=y:x.maxSource=y},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
      <div class="hint">If the entity has no number, the gauge uses ${String(u)}.</div>`};return n.minSource===void 0&&n.maxSource===void 0?p`<div class="grid2 gauge-ends">${r("min")}${r("max")}</div>`:p`${r("min")}${r("max")}`}function Xh(e,n,t){let i=n.coloring??"uniform",a=n.highlight??"none",r=(l,d)=>t(u=>{let c={bands:u.bands??[],bandAboveColorHex:u.bandAboveColorHex??we};l(c),c.bands.length>0?u.bands=c.bands:delete u.bands,c.bandAboveColorHex!==we?u.bandAboveColorHex=c.bandAboveColorHex:delete u.bandAboveColorHex},d),o=(l,d,u)=>t(c=>{u===void 0||u===d?delete c[l]:c[l]=u},l),s=a==="highest"?"The highest number takes its own colour":a==="lowest"?"The lowest number takes its own colour":"The highest and lowest numbers take their own colours";return p`
    ${X("Colour",i,Wr,l=>t(d=>{if(l==="uniform"){delete d.coloring;return}d.coloring=l,(d.bands?.length??0)===0&&(d.bands=jr(vn(e.resolve(d.value)??"")))}),{def:"uniform"})}
    ${i==="bands"?p`
    ...
    ${a==="none"?f:p`
      <div class="grid2">
        ${a==="lowest"?f:re("Highest colour",n.highColorHex??Fe,l=>o("highColorHex",Fe,l),!1,Fe)}
        ${a==="highest"?f:re("Lowest colour",n.lowColorHex??Ie,l=>o("lowColorHex",Ie,l),!1,Ie)}
      </div>
      ${i==="bands"?f:p`<div class="hint">${s}, and other text keeps the layer colour.</div>`}`}`}function zd(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,k)=>e.update(z=>b(z.elements[r]),k?`${o}-${k}`:void 0),l=Te(e.config,t,n),d=l.frame,u=(b,k)=>e.update(z=>ke(z,t,a,{frame:zr(d,b)}),`${o}-${k}-${t}`),c=Be(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",m=b=>c[b],g,y;switch(n.kind){case"text":{let b=er(e.config,n.payload.value);g=p`
        ${oe(e,n.payload.value,k=>s(z=>{z.payload.value=k},"value"),{showResolved:!0,label:"Text",key:`${o}-value`})}
        ${b?p`<div class="hint">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(b.payload.id)}>${Le(b,ve(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}
        ${Se("Live countdown",n.payload.countdown===!0,k=>s(z=>{let D=z.payload;k?D.countdown=!0:delete D.countdown}),c.countdown===!0)}
        ${n.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:f}`,y=p`<div class="grid2">
          ${na(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
          ${X("Weight",n.payload.fontWeight,to,k=>s(z=>{z.payload.fontWeight=k}),{def:c.fontWeight})}
          ${X("Align",n.payload.alignment??"center",Ah,k=>s(z=>{let D=z.payload;k==="center"?delete D.alignment:D.alignment=k}),{def:"center"})}
          ${X("Lines",n.payload.lineLimit===2?"2":"1",Hh,k=>s(z=>{let D=z.payload;k==="2"?D.lineLimit=2:delete D.lineLimit}),{def:"1"})}
        </div>
        ${Se("Monospaced digits",n.payload.monospacedDigits===!0,k=>s(z=>{let D=z.payload;k?D.monospacedDigits=!0:delete D.monospacedDigits}),c.monospacedDigits===!0)}
        ...
        ${n.payload.countdown?f:Xh(e,n.payload,(k,z)=>s(D=>k(D.payload),z))}`;break}case"icon":g=p`
        ${oe(e,n.payload.symbol,b=>s(k=>{k.payload.symbol=b},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${o}-symbol`,setSymbolPath:b=>s(k=>{let z=k.payload;b?z.path=b:delete z.path},"symbol")})}
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,y=na(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let b=n.payload,k=(D,Y)=>s(B=>D(B.payload),Y),z=b.style==="dots";g=p`
        ${oe(e,b.value,D=>k(Y=>{Y.value=D},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${z?p`
            ${oe(e,b.total??rd(b),D=>k(Y=>{Y.total=D},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${bi} dots are drawn.</div>`:Jh(e,b,{min:c.minValue,max:c.maxValue},o,k)}`,y=p`
        <div class="grid2">
          ${X("Style",b.style,mh,D=>k(Y=>{D==="dots"&&Y.total===void 0&&(Y.total=rd(Y)),D!=="dots"&&delete Y.total,Y.style=D}),{titles:fh,def:c.style})}
          ${z?f:na(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${re(z?"Empty dot colour":"Track colour",b.trackColorHex,D=>k(Y=>{Y.trackColorHex=D??"#FFFFFF40"},"track"),!1,c.trackColorHex)}
        ${X("Colour",b.coloring,Wr,D=>k(Y=>{Y.coloring=D,D==="bands"&&Y.bands.length===0&&(Y.bands=jr([Y.minValue,Y.maxValue]))}),{def:c.coloring})}
        ${b.coloring==="bands"?p`
          ...
          ${qr(b,b.colorSlot.baseColorHex,k)}`:f}
        ${z?f:p`
          <div class="grid2">
            ${ne("Threshold",b.thresholdValue,D=>k(Y=>{D===void 0?delete Y.thresholdValue:Y.thresholdValue=D},"thr"),{optional:!0})}
            ${b.thresholdValue===void 0?f:re("Threshold colour",b.thresholdColorHex,D=>k(Y=>{Y.thresholdColorHex=D??sn},"thrcol"),!1,sn)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,k=(E,R)=>s(tn=>E(tn.payload),R),z=yt(b),D=_a(c.marker),Y=c.historyMinutes,B=c.historyPoints,K=b.historyMinutes>0,j=K&&b.source==="statistics",Me=K&&!j,It=K?j?"statistics":"history":"value",ut=j?Wn:Pt,ge=Ot(b)??Dt(b),le=b.value.kind.kind==="entityState",Xe=ge===void 0?void 0:e.historySeries(ge),$c=K&&le?Xe??"":e.resolve(b.value)??"",Ze=b.historyPoints<1,yo=Yr(a,b.historyMinutes,ut),De=vn($c),Rt=b.limit>0&&De.length>b.limit?b.takeFromEnd?De.slice(De.length-b.limit):De.slice(0,b.limit):De,Cc=!K&&le&&De.length===1,ma=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),Sc=ve(e),fa=b.scaleFrom!==void 0&&ma.some(E=>E.payload.id===b.scaleFrom);g=p`
        ${oe(e,b.value,E=>k(R=>{R.value=E},"value"),{label:"Readings",key:`${o}-value`})}
        ${X("Draw",It,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>k(R=>{if(E==="value"){R.historyMinutes=0;return}R.source=E==="statistics"?"statistics":"history";let tn=R.historyMinutes||wi;R.historyMinutes=E==="statistics"?Math.min(tn,Oa):Math.min(tn,xi)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${j?p`
            ...
            <div class="grid2">
              ${Ur(a,b.historyMinutes,Y,E=>k(R=>{R.historyMinutes=E}),Wn)}
              ${X("Per",b.statPeriod,yi,E=>k(R=>{R.statPeriod=E}),{def:Un})}
            </div>
            ${yo?Kr(b.historyMinutes,E=>k(R=>{R.historyMinutes=E},"span"),!0):f}
            ${X("Read",b.statType,Ha,E=>k(R=>{R.statType=E}),{def:Kn})}
            <div class="hint">One bar per period, oldest first, newest ${jn} kept.
              Change suits energy (kWh per hour), Mean suits temperature.</div>
            ${b.statPeriod==="5minute"?p`<div class="hint warn">Five-minute rows are compacted into hourly ones after
                about ten days, so a longer span here comes back with only its recent tail.</div>`:f}
            ${le&&Xe===void 0?p`<div class="hint">Reading the statistics…</div>`:f}
            ${le&&Xe===""?p`<div class="hint warn">No long-term statistics for this entity in that span.
        ...
        ${Me?p`
            ${le?f:p`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Ur(a,b.historyMinutes,Y,E=>k(R=>{R.historyMinutes=E}))}
              <div class="field readings-field">${Je("Readings",{atDefault:b.historyPoints===B,title:`Back to ${B<1?"every one":`${B} averaged`}`,reset:()=>k(E=>{E.historyPoints=B})})}
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Readings">
                    <button type="button" role="radio" aria-checked=${Ze?"false":"true"} class=${Ze?"":"on"}
                      title="Average the recorded states into this many equal time slots"
                      @click=${()=>{Ze&&k(E=>{E.historyPoints=24})}}>Average</button>
                    <button type="button" role="radio" aria-checked=${Ze?"true":"false"} class=${Ze?"on":""}
                      title="Plot every recorded state change, no averaging"
                      @click=${()=>{Ze||k(E=>{E.historyPoints=Va})}}>Every one</button>
                  </div>
                  ${Ze?f:p`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${fe(E=>{let R=Number(E);E.trim()!==""&&Number.isFinite(R)&&R>=1&&k(tn=>{tn.historyPoints=Math.round(R)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${yo?Kr(b.historyMinutes,E=>k(R=>{R.historyMinutes=E},"span")):f}
            <div class="hint">${Ze?p`Every state the recorder holds in that span, oldest first, one reading per change,
            ...
            ${le&&Xe===void 0?p`<div class="hint">Reading the history…</div>`:f}
            ${le&&Xe===""?p`<div class="hint warn">Nothing recorded for this entity in that span.
        ...
        ${De.length===0&&!(K&&(!le||Xe===void 0||Xe===""))?p`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${De.length>0?p`<div class="hint">Reads <span class="nums">${Dh(Rt)}</span>${De.length===Rt.length?p` · ${Rt.length} ${Rt.length===1?"value":"values"}`:p` · ${Rt.length} of ${De.length}`}</div>`:f}
        ${Cc?p`<div class="hint warn">This entity holds one number, so the chart draws one bar.
              Switch Draw to <b>Recorded history</b> to plot how it has moved.</div>`:f}
        <div class="grid2">
          ${ne("Use",b.limit,E=>k(R=>{R.limit=Math.max(0,Math.round(E??0))},"limit"),{step:1,min:0,def:c.limit})}
          ${X("From",b.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],E=>k(R=>{R.takeFromEnd=E==="end"}),{def:c.takeFromEnd===!0?"end":"start"})}
        </div>
        <div class="hint">${K?"Trims the series after it arrives, so 0 draws every reading fetched above.":"A forecast sensor often carries 24 or 48 entries. 0 draws all of them."}</div>`,y=p`
        <div class="grid2">
          ${X("Style",b.style,sh,E=>k(R=>{R.style=E}),{def:c.style})}
          ${b.style==="bars"?ne("Bar gap (pt)",b.barGap,E=>k(R=>{R.barGap=Math.max(0,E??0)},"gap"),{step:.5,min:0,def:c.barGap}):na(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${X("Scale",b.scale,lh,E=>k(R=>{R.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${X("Baseline",b.baseline,dh,E=>k(R=>{R.baseline=E}),{def:c.baseline})}
        </div>
        ${ma.length===0?f:He("Same scale as",fa?b.scaleFrom:"",[["","Its own"],...ma.map(E=>[E.payload.id,Le(E,Sc)])],E=>k(R=>{E?R.scaleFrom=E:delete R.scaleFrom}),{def:""})}
        ...
        ${!fa&&b.scale==="fixed"?p`<div class="grid2">
              ${ne("Min",b.minValue,E=>k(R=>{R.minValue=E??0},"cmin"),{def:c.minValue})}
              ${ne("Max",b.maxValue,E=>k(R=>{R.maxValue=E??100},"cmax"),{def:c.maxValue})}
            </div>`:f}
        ...
        ${X("Colour",b.coloring,Wr,E=>k(R=>{R.coloring=E,E==="bands"&&R.bands.length===0&&(R.bands=jr(Rt))}),{def:c.coloring})}
        ${b.coloring==="bands"?p`
          ...
          ${qr(b,b.colorSlot.baseColorHex,k)}
          ${b.style==="area"?p`${Se("Fill follows the bands",b.fillBands,E=>k(R=>{R.fillBands=E}),c.fillBands)}
        ...
        ${X("Highlight",b.highlight,Qr,E=>k(R=>{R.highlight=E}),{def:c.highlight})}
        ${b.highlight==="none"?f:p`
          <div class="grid2">
            ${b.highlight==="lowest"?f:X("Highest marker",z.high,ad,E=>k(R=>{Na(R,{...yt(R),high:E})}),{def:D.high})}
            ${b.highlight==="highest"?f:X("Lowest marker",z.low,ad,E=>k(R=>{Na(R,{...yt(R),low:E})}),{def:D.low})}
          </div>
          <div class="grid2">
            ${b.highlight==="lowest"?f:re("Highest colour",b.highColorHex,E=>k(R=>{R.highColorHex=E??Fe},"hicol"),!1,Fe)}
            ${b.highlight==="highest"?f:re("Lowest colour",b.lowColorHex,E=>k(R=>{R.lowColorHex=E??Ie},"locol"),!1,Ie)}
          </div>
        ...
        ${Se("Threshold line",b.thresholdValue!==void 0,E=>k(R=>{E?R.thresholdValue=ch(Rt):delete R.thresholdValue}))}
        ${b.thresholdValue===void 0?f:p`
          <div class="grid2">
            ${ne("At",b.thresholdValue,E=>k(R=>{R.thresholdValue=E??0},"thval"))}
            ${re("Line colour",b.thresholdColorHex,E=>k(R=>{R.thresholdColorHex=E??ln},"thcol"),!1,ln)}
          </div>
        ...
        ${Se("\u201CNow\u201D marker",b.nowIndex!==void 0,E=>k(R=>{E?R.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete R.nowIndex}))}
        ${b.nowIndex===void 0?f:p`
          ${oe(e,b.nowIndex,E=>k(R=>{R.nowIndex=E},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${re("Marker colour",b.nowColorHex,E=>k(R=>{R.nowColorHex=E??dn},"nowcol"),!1,dn)}
        ...
        ${ki(b)?hd(b,k,c,"cl",p`
            <div class="hint">Clock times from the start of the span to now, evenly spaced, in a row of
              ...
              the recorder had nothing for shifts the earlier times a little.</div>`):Ze&&Me?p`<div class="hint">Clock times need evenly spaced readings, so they are offered when
              ...
              Recorded history.</div>`}`;break}case"timeline":{let b=n.payload,k=(ge,le)=>s(Xe=>ge(Xe.payload),le),z=c.historyMinutes,D=b.value.kind.kind==="entityState",Y=kt(b),B=Y===void 0?void 0:e.historySeries(Y),K=Ge(b)*60,j=ei(B??"",xt),Me=Yr(a,b.historyMinutes),It=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,ut=ph(j,K,It===void 0?void 0:e.hass.states[It]?.state,It?.split(".")[0]);g=p`
        ${oe(e,b.value,ge=>k(le=>{le.value=ge},"value"),{label:"States",key:`${o}-value`})}
        ${D?f:p`<div class="hint warn">A timeline draws an entity's recorded
        ...
        ${Ur(a,b.historyMinutes,z,ge=>k(le=>{le.historyMinutes=ge}))}
        ${Me?Kr(b.historyMinutes,ge=>k(le=>{le.historyMinutes=ge},"span")):f}
        ...
        ${D&&B===void 0?p`<div class="hint">Reading the history…</div>`:f}
        ${D&&B===""?p`<div class="hint warn">Nothing recorded for this entity in that span. Either it is
            excluded from the recorder, or it has not been seen in that long.</div>`:f}
        ${j.length>0?p`<div class="hint">Reads <span class="nums">${Kh(j,K)}</span></div>`:f}
        ${Uh(j)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${hh(b,k,ut,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ne("Gap (pt)",b.gap,ge=>k(le=>{le.gap=Math.min($i,Math.max(0,ge??0))},"tgap"),{step:.5,min:0,max:$i,def:c.gap})}
          ${ne("Corner radius (pt)",b.cornerRadius,ge=>k(le=>{le.cornerRadius=Math.max(0,ge??0)},"tradius"),{step:.5,min:0,def:c.cornerRadius})}
        </div>
        ...
        ${hd(b,k,c,"tl",p`
          ...
          ${X("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],b=>s(k=>{k.payload.kind=b}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:c.kind})}
          ${n.payload.kind==="roundedRectangle"?ne("Corner radius (pt)",n.payload.cornerRadius,b=>s(k=>{k.payload.cornerRadius=b??6},"radius"),{step:.5,min:0,def:c.cornerRadius}):f}
        </div>
        ${n.payload.kind==="line"?Gh(t,d,u):f}`,y=n.payload.kind==="line"?ne("Thickness (pt)",n.payload.thickness,b=>s(k=>{k.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ${re("Border colour",n.payload.borderColorHex,b=>s(k=>{b===void 0?delete k.payload.borderColorHex:k.payload.borderColorHex=b},"border"),!0,null)}
        ${n.payload.borderColorHex!==void 0?ne("Border width (pt)",n.payload.borderWidth,b=>s(k=>{k.payload.borderWidth=b??1},"bw"),{step:.5,min:0,def:c.borderWidth}):f}`;break;case"image":{let b=n.payload,k=(B,K)=>s(j=>B(j.payload),K),z=b.entity.entityId?e.hass.states[b.entity.entityId]?.attributes?.entity_picture:void 0,D=typeof z=="string"?z:void 0,Y=D!==void 0&&!D.startsWith("/");g=p`
        ${X("Source",b.source,[["camera","Camera"],["entityPicture","Entity picture"]],B=>k(K=>{K.source=B}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:c.source})}
        ${b.source==="camera"?p`
            ${b.entity.entityId&&!b.entity.entityId.startsWith("camera.")?p`<div class="hint warn">Only camera entities have snapshots, so this layer stays blank until the entity is a camera. Switch the source to Entity picture to use this entity's own photo.</div>`:f}
            ...
            ${b.entity.entityId&&D===void 0?p`<div class="hint warn">This entity has no picture right now, so the layer stays blank. Anything with an <code>entity_picture</code> works: a person, a media player playing something with cover art, a weather entity.</div>`:f}
            ${Y?p`<div class="hint warn">This picture is hosted outside Home Assistant, so the watch cannot fetch it.</div>`:f}
        ...
        ${X("Picture",b.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],B=>k(K=>{K.contentMode=B}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:c.contentMode})}
        ${ri("Zoom",b.zoom,B=>k(K=>{K.zoom=B},"zoom"),{min:Cr,max:4,step:.05,def:1,format:B=>`${B.toFixed(2)}x`})}
        ${ri("Pan left/right",b.panX,B=>k(K=>{K.panX=B},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${ri("Pan up/down",b.panY,B=>k(K=>{K.panY=B},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class="hint">${Ph(b)}</div>
        ${ne("Corner radius (pt)",b.cornerRadius,B=>k(K=>{K.cornerRadius=Math.max(0,B??un)},"imgradius"),{step:1,min:0,def:un})}`;break}case"tap":{g=p`
        ${Pd(e,n.payload,(b,k)=>s(z=>b(z.payload),k),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let x=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:re(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,b=>s(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=b??"#FFFFFF")},"color"),!1,h),S=rr(e.config,n),T=S?{kind:{kind:"entityState",...S}}:void 0,$=me[n.kind],C=n.kind==="image"?n.payload.timestamp===!0:!1,L=Qh[n.kind],O=em[n.kind],V=ud(n.payload,c,L),ie=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[t]?.placements[a]?.size!==void 0,H=ud(n.payload,c,O)||ie!==void 0&&l.size!==void 0&&l.size!==c[ie],U=Vt(e.config,a),P=(b,k)=>()=>s(z=>pd(z.payload,c,b),k);return p`
    ${Ee(e,"content","Content",p`${n.kind==="tap"?f:Lh(e,n,o)}${g}`,{color:$,icon:"content",summary:no(e,n),...V?{reset:P(L,"reset-content")}:{}})}
    ${y===void 0&&x===void 0?f:Ee(e,"look",n.kind==="image"?"Picture":"Look",p`${y??f}${x??f}`,{color:$,icon:n.kind==="image"?"image":"look",...la(n)?{summary:la(n)}:{},...H?{reset:()=>e.update(b=>{pd(b.elements[r].payload,c,O),w&&ke(b,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Ee(e,"numbers","Numbers",am(e,n),{color:me.text,icon:"text",summary:im(e,n),...U.length>0?{reset:()=>e.update(b=>{for(let k of Vt(b,a))ot(b,k.payload.id)})}:{}}):f}
    ${n.kind==="image"?Ee(e,"timestamp","Timestamp",Oh(n.payload,(b,k)=>s(z=>b(z.payload),k)),{color:$,icon:"clock",summary:C?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...C?{reset:P(Zh,"reset-stamp")}:{}}):f}
    ${i.tap===!1?f:ao(e,n)}
    ${Ee(e,"states","States",Kd(e,n.payload.rules,n.kind,b=>b.elements.find(k=>k.payload.id===a)?.payload.rules,`rules-${a}`,T),{color:ee.states,icon:"states",summary:ii(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:io(e,n,t)}`}var Zh=["timestamp","timestampCorner","timestampSize"],Qh={text:["value","countdown"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},em={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function Pd(e,n,t,i){let a=n.action;return p`
    ${He("Tap action",a.type,Ch,r=>t(o=>{o.action=Fd(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?Ye(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?Id(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?Ad(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var tm=24;function nm(e,n){let t=[],i=1/0;for(let r of te){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Ls(e.config,n,r);o&&(t.push(`${Z(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<tm;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function im(e,n){let t=Vt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(on.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function am(e,n){let t=ve(e),i=Vt(e.config,n.payload.id),a=o=>e.update(s=>{Ms(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
          ...
          ${i.map(o=>p`
            <div class="num-row">
              ...
              <button class="icon danger" title="Delete this number" aria-label="Delete this number"
                @click=${()=>e.update(s=>ot(s,o.payload.id))}>${N("close")}</button>
            </div>`)}
        </div>
    ...
    ${a?p`<div class="value-editor">
          ...
          <div class="chips">
            ...
            ${Ci(a.payload.outset)?f:p`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                  @click=${()=>r(s=>{s.outset={...Za}})}>${N("reset")}</button>`}
          </div>
        </div>
        ${nm(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${nt(o)}</b>.</div>`}`}function md(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Le(e,n){switch(e.kind){case"text":return md(be(e.payload.value,n));case"icon":return md(be(e.payload.symbol,n));case"gauge":return be(e.payload.value,n);case"chart":return be(e.payload.value,n);case"timeline":return be(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function Od(e,n){let t=at(e.config,n.id),i=ve(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Ee(e,"content","Group",p`
    ...
    </div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Dd(e,n){if(n==="inline")return om(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${Z(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Z(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=ua(e.config,n),r=t.backgroundColorHex?Ce(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ce(t.borderColorHex)} border`:"no border";return p`
    ...
    ${Ee(e,"symbol","Symbol",p`
      ${Cd(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:me.icon,icon:"icon",summary:n.symbol||"None"})}`}function sm(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ...
    ${a==="text"&&n.bezelText?p`
      ...
      ${Se("Live countdown",n.bezelCountdown===!0,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:f}
    ${a==="gauge"&&n.bezelGauge?lm(e,n.bezelGauge,t):f}`}function lm(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${Se("End number labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=I(String(s.minValue)),s.maxLabel=I(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?oe(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):f}
    ${n.maxLabel?oe(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var xy=te.map(e=>[e,Z(e)]),ro={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},dm=Object.keys(ro);function cm(e){let n=Ri[e];return dm.filter(t=>n.includes(Re[t]))}var um={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function ia(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function St(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function pm(e){if(!e||Ue(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function be(e,n){return`${Vd(e,n)}${pm(e.format)}`}function Vd(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${St(t.value,40)}"`:"(empty)";case"entityState":return ia(t,n);case"entityAttribute":return t.attribute?`${ia(t,n)} \xB7 ${t.attribute}`:ia(t,n);case"entityAge":return`age of ${ia(t,n)}`;case"aggregate":return hm(t.aggregate);case"time":return um[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${St(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(on.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Vd(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function hm(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function da(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function mm(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${n.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${t==="layout"?"family":"layer"} looks.</div>`:f}
    ${n.map((o,s)=>fm(e,o,s,n.length,t,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Qn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function fm(e,n,t,i,a,r,o){let s=e.liveBranch(n),l=e.forced.get(n.id)??"live",d=c=>l==="live"?c==="live":l==="otherwise"?c==="otherwise":l.caseId===c,u=(c,h)=>r(m=>{let g=m.find(y=>y.id===n.id);g&&c(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>da(c,t,t-1))}>${N("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(c=>da(c,t,t+1))}>${N("down")}</button>
    ...
    ${n.cases.map((c,h)=>gm(e,c,h,n,a,u,`${o}-${c.id}`))}
    ...
    ${n.otherwise?p`<div class="case-box otherwise">
          ...
          ${Bd(e,n.otherwise,a,c=>u(h=>{h.otherwise&&c(h.otherwise)}),`${o}-otherwise`)}
        </div>`:f}
  </div>`}function gm(e,n,t,i,a,r,o){let s=(d,u)=>r(c=>{let h=c.cases.find(m=>m.id===n.id);h&&d(h)},u),l=e.liveBranch(i)===n.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${l?p` <span class="ok">· active now</span>`:f}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(d=>da(d.cases,t,t-1))}>${N("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(d=>da(d.cases,t,t+1))}>${N("down")}</button>
    ...
    ${n.when.tests.map((d,u)=>ym(e,d,u,c=>s(h=>{let m=h.when.tests.find(g=>g.id===d.id);m&&c(m)}),()=>s(c=>{c.when.tests=c.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    <div class="adders">
    ...
    ${Bd(e,n.then,a,d=>s(u=>d(u.then)),`${o}-then`)}
  </div>`}function ym(e,n,t,i,a,r){let o=(c,h)=>i(c,h?`${r}-${h}`:void 0),s=n.comparison,l=Ut(s.kind),d=e.evaluateTest(n),u=f;switch(l){case"value":u=oe(e,s.value??I(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":u=p`${oe(e,s.value??I(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${oe(e,s.upper??I(""),c=>o(h=>{h.comparison.upper=c},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":u=p`${pe("Pattern",s.pattern??"",c=>o(h=>{h.comparison.pattern=c},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!bm(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":u=p`<div class="row-inline">
        ...
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":u=vm(n.value)?wm(s.options??[],c=>o(h=>{h.comparison.options=Dr(c)},"options")):pe("Options (comma separated)",(s.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${He("Comparison",s.kind,Bs.map(c=>[c,$n[c]]),c=>o(h=>{h.comparison=mr(h.comparison,c)}))}
    ${u}
  </div>`}function bm(e){try{return new RegExp(e),!0}catch{return!1}}function fd(e,n,t,i,a){if(t.kind.kind!=="literal")return oe(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Gt(r)??"";return p`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${fe(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?p`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function vm(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function wm(e,n){let t=ql(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return p`<div class="field seg-field"><span>Days</span>
    ...
    </div></div>`}function Bd(e,n,t,i,a){let r=cm(t);return p`
    ${n.length===0?p`<div class="hint">No changes.</div>`:f}
    ${n.map((o,s)=>xm(e,o,s,t,(l,d)=>i(u=>{u[s]&&l(u[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Kt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${ro[o]}</option>`)}
    </select>`}var Gd=["setColor","setBorderColor","setBackgroundColor"];function xm(e,n,t,i,a,r,o){let s=!Ri[i].includes(Re[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${Ud(e,n,a,o)}
  </div>`}function Ud(e,n,t,i){let a=Ai(n.kind),r=f;if(a==="value"){let o=n.value??I("");if(Gd.includes(n.kind)){let s=o.kind.kind==="literal";r=p`${s?re("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=I(l??"#FFFFFF")},"color")):oe(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${mm(e,n,t,i,a)}`:km(e,o.table,n[0],t,i,a,r)}function km(e,n,t,i,a,r,o){let s=(w,H)=>e.update(U=>{let P=a(U);P&&w(P)},H?`${r}-${H}`:void 0),l=n.value??gd.get(r)??o,d=n.rows.length===0,u=n.numberMode||d&&l!==void 0&&!Pl(l)&&$m(e.resolve(l)),c=Ri[i],h=aa.get(r)??new Set,m=n.columns.length===0&&h.size===0?[zl[i]]:[],g=Ml(n.columns,[...h,...m.filter(w=>w!==void 0)],c),y=t?e.liveBranch(t):"none",x=t?e.forced.get(t.id)??"live":"live",S=w=>x!=="live"&&(x==="otherwise"?w==="otherwise":x.caseId===w),T=w=>{t&&e.setForced(t.id,S(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},$=w=>{gd.set(r,w),n.rows.length!==0&&s(H=>Ll(H,w),"lhs")},C=()=>s(w=>Al(w,l??I(""),u)),L=n.rows.map((w,H)=>bd(e,{key:`${r}-${w.caseId}`,label:Nl(w.comparison,U=>be(U,ve(e))),columns:g,changes:w.changes,live:y===w.caseId,forced:S(w.caseId),onForce:()=>T(w.caseId),when:Mm(e,w.comparison,`${r}-${w.caseId}`,(U,P)=>s(b=>{let k=b[0]?.cases.find(z=>z.id===w.caseId)?.when.tests[0];k&&U(k.comparison)},P&&`${w.caseId}-${P}`)),updChanges:(U,P)=>s(b=>{let k=b[0]?.cases.find(z=>z.id===w.caseId);k&&U(k.then)},P&&`${w.caseId}-${P}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${H===0} @click=${()=>s(U=>Lr(U,H,H-1))}>${N("up")}</button>
      <button class="icon" title="Move down" ?disabled=${H===n.rows.length-1} @click=${()=>s(U=>Lr(U,H,H+1))}>${N("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>s(U=>Hl(U,w.caseId))}>${N("delete")}</button>`})),O=n.otherwise===void 0?f:bd(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:y==="otherwise",forced:S("otherwise"),onForce:()=>T("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,H)=>s(U=>{let P=U[0]?.otherwise;P&&w(P)},H),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>_r(w,!1))}>${N("close")}</button>`}),V=ra.get(r),ie=Cm.filter(w=>c.includes(w)&&!g.includes(w));return p`
    <div class="states">
      ${oe(e,l??I(""),$,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ...
      <table class="states-table">
        <thead>
          <tr>
            ...
            ${g.map(w=>p`<th>
              <span>${lt[w]}</span>
              <button class="icon" title=${`Remove the ${lt[w]} column`}
                @click=${H=>{ra.set(r,w),Ne(H.target)}}>${N("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${V===void 0?f:p`<div class="hint warn confirm-row">
        Remove the ${lt[V]} column? Its ${yd(n,V)} value${yd(n,V)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${w=>{ra.delete(r),aa.get(r)?.delete(V),Ne(w.target),s(H=>_l(H,V))}}>Remove</button>
      ...
      <div class="states-foot">
        ...
        <span class="spacer"></span>
        ${x==="live"?f:p`<button class="small" @click=${()=>t&&e.setForced(t.id,"live")}>Back to live</button>`}
        ${ie.length===0?f:p`<select class="chip-add" title="Add a column" @change=${w=>{let H=w.target,U=H.value;if(H.value="",!U)return;let P=aa.get(r)??new Set;P.add(U),aa.set(r,P),Ne(H)}}>
          <option value="" selected>+ column…</option>
          ${ie.map(w=>p`<option value=${w}>${lt[w]}</option>`)}
        </select>`}
      </div>
    ...
    ${n.columns.map(t=>p`<td>${Em(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Em(e,n,t,i,a){let r=Ji(t,n),o=eo(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${lt[n]} for this state`}
      @click=${d=>{i(u=>{u.push(Kt(Tl[n]))}),wh(d.target,o)}}>unchanged</button>`;let s=(d,u)=>i(c=>{let h=c.find(m=>Re[m.kind]===n);h&&d(h)},u&&`${n}-${u}`),l=lt[n];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Tm(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Ed}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
    ...
    </div>`}function Tm(e,n){if(n.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return p`<span class="cell-word">Shown</span>`;let t=Ai(n.kind);if(t==="number")return p`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return p`<span class="cell-word">${to.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??I(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Gd.includes(n.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ce(a):be(i,ve(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??f}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${be(i,ve(e))}</span>`}function Ce(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Mm(e,n,t,i){let a=Ut(n.kind),r=Ar(n.kind),o=(s,l,d,u)=>Im(e,s,l,`${t}-${d}`,r,u,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${fe(s=>i(l=>{let d=mr(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Rr.map(s=>p`<option value=${s} ?selected=${s===n.kind}>${Fm(s)}</option>`)}
    </select>
    ...
    ${Sd(e,s,o,n,t,l)}
  </span>`}var si=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:ar,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Yd(e){return si.find(n=>n.kind===e)??si[0]}var Wd="#FF9F0A",pa="#8E8E93",Rm=["#FF453A","#FFD60A","#34C759"],Jd=["#0A84FF","#34C759","#FF9F0A"];function Am(e){return e?.attributes?.device_class==="battery"?Rm:Jd}var Hm={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Lm(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Hm[oo(e)]??{off:"circle",on:"circle.fill"}}function _m(e){switch(oo(e)){case"lock":return{kind:"equals",value:I("locked")};case"cover":case"valve":return{kind:"equals",value:I("open")};case"media_player":return{kind:"equals",value:I("playing")};default:return{kind:"isOn"}}}function oo(e){return e.domain||e.entityId.split(".")[0]||""}function Mt(e){return{...e,domain:oo(e)}}function Nm(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function En(e){return Math.round(e*1e4)/1e4}function Qt(e,n,t){return Math.min(t,Math.max(n,e))}function so(e,n,t){let i=xe[e],a=Qt(En(n/i.width),0,1),r=Qt(En(t/i.height),0,1);return{x:En((1-a)/2),y:En((1-r)/2),width:a,height:r,rotationDegrees:0}}function zm(e){let n=xe[e],t=Qt(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:so(e,t*1.3,t*1.3),size:t}}function Pm(e){let n=xe[e],t=Qt(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:so(e,n.width*.88,t*1.7),size:t}}function Om(e){let n=xe[e],t=Math.min(n.width,n.height)*.9;return{frame:so(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Xd(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Dm(e){let n=xe[e],t=Qt(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:En(t/n.height),rotationDegrees:0}}}function Vm(e){let n=xe[e],t=Qt(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:En(Qt(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Bm(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Gm(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function Et(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Gm(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=rt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function Tt(e){return Be(e)}function lo(e,n){let t={kind:{kind:"entityState",...Mt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function jd(e){let n=Kt("setIcon");return n.value=I(e),n}function Zt(e){let n=Kt("setColor");return n.value=I(e),n}function Um(e,n){let t=Qn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...Mt(e)}},a.comparison=_m(e);let r=n.on!==n.off;return i.then=r?[jd(n.on),Zt(Wd)]:[Zt(Wd)],t.otherwise=r?[jd(n.off),Zt(pa)]:[Zt(pa)],t}function Km(e){let n=Qn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...Mt(e)}},i.comparison={kind:"isUnavailable"};let a=Kt("setOpacity");return a.number=.35,t.then=[a],n}function qd(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Wm(e,n,t=Jd){let i=n.max-n.min,a=qd(n.min+i/3),r=qd(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:I(a)},changes:[Zt(t[0])]},{comparison:{kind:"between",value:I(a),upper:I(r)},changes:[Zt(t[1])]},{comparison:{kind:"greaterThan",value:I(r)},changes:[Zt(t[2])]}];return Fl(lo(e),o)}function jm(e,n,t){let i=Tt("icon"),a=Lm(n);return i.payload.symbol=I(a.off),i.payload.colorSlot.baseColorHex=pa,i.payload.rules=[Um(n,a)],Et(e,i,t.family,zm),e.elements.push(i),Ti(e,i.payload.id,{type:"toggleEntity",...Mt(n)}),i.payload.id}function qm(e,n,t){let i=Tt("text");return i.payload.value=lo(n,t.state),i.payload.rules=[Km(n)],Et(e,i,t.family,Pm),e.elements.push(i),i.payload.id}function Ym(e,n,t){let i=Tt("gauge");i.payload.value=lo(n);let a=Nm(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Wm(n,a,Am(t.state))],Et(e,i,t.family,Om),e.elements.push(i),i.payload.id}function Jm(e,n,t){let i=Tt("chart");return i.payload.value={kind:{kind:"entityState",...Mt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",Et(e,i,t.family,Xd),e.elements.push(i),i.payload.id}function Xm(e,n,t){let i=Tt("chart");return i.payload.value={kind:{kind:"entityState",...Mt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",Et(e,i,t.family,Xd),e.elements.push(i),i.payload.id}function Zm(e,n,t){let i=Mt(n),a=Tt("text");a.payload.value=I(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=pa,Et(e,a,t.family,Vm),e.elements.push(a);let r=t.state?.attributes?.device_class,o=Tt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Ja(i.domain,typeof r=="string"?r:void 0),Et(e,o,t.family,Dm),e.elements.push(o),o.payload.id}function Qm(e,n,t){let i=Tt("image");return i.payload.entity=Mt(n),Et(e,i,t.family,Bm),e.elements.push(i),i.payload.id}function Zd(e,n,t,i){switch(n){case"toggle":return jm(e,t,i);case"status":return qm(e,t,i);case"gauge":return Ym(e,t,i);case"chart":return Jm(e,t,i);case"history":return Xm(e,t,i);case"doorHistory":return Zm(e,t,i);case"camera":return Qm(e,t,i)}}var ef=/^[a-z0-9_]+\.shared_(\d+)$/;function Qd(e){return ef.test(e)}function tf(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function tc(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function nc(e,n){let t=new Map;for(let i of ur(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=tc(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${tf(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function nf(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);dr(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),cr(t,r=>lr(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function ic(e){let n=!1;return Vs(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function af(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function ac(e,n,t=[]){let i=n==="share"?nf(e,t):e,a=mn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${af(a)}
`}function rc(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var rf="There is nothing to read here. Paste a complication first.",of="This is not valid JSON. Check for a missing brace or a stray comma.",sf="This is valid JSON but not a complication. A complication starts with { and ends with }.",lf="This does not look like a complication.",ec="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",df="00000000-0000-4000-8000-000000000000";function cf(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function oc(e,n){let t=e.trim();if(t==="")return{ok:!1,error:rf};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:of}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:sf};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${ec}`};let o={...a,id:df,slotIndex:0},s;try{s=hn(o)}catch(d){let u=d instanceof _e||d instanceof Error?d.message:String(d);return{ok:!1,error:`${lf}

${cf(u)}`}}let l=Si(a);if(l.length>0){let d=l.slice(0,3).join(", "),u=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${u}. ${ec}`}}return{ok:!0,config:s,raw:i}}function co(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=ur(e,(o,s)=>Qd(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Qd(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:tc(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function sc(e,n){let t=structuredClone(e);dr(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return cr(t,a=>lr(a,i)),t}function lc(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function uf(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function dc(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=Bi(e);return i.length===0?t:`${t}, ${uf(i)}`}function uo(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var hf=3e4,mf=500,ff=3e4,cc="preset-entity";function uc(e){return`import-entity-${e}`}var gf={entityId:"",displayName:"",domain:""},yf={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function po(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function bf(e){return e.kind==="family"?"look":"content"}function ho(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function pc(){return p`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function vf(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return p`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var hc=300,mc=360,fc=44,gc=22,wf=[1,1.7,2.6],xf=["S","M","L"],yc=["Small","Medium","Large"],bc="wrist-assistant-panel.layers.v1",dt=34,en=200,kf=720,ha=320,$f=80,Cf=56,vc="wrist-assistant-panel.columns.v2",mo=e=>Math.max(en,Math.min(kf,Math.round(e))),wc=e=>e.metaKey||e.ctrlKey||e.shiftKey,Sf=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,li=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Ft=li==="Cmd"?"\u2318":"Ctrl+",fo=li==="Cmd"?"\u21E7":"Shift+";function xc(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-$f;if(i>=en*2+ha){let r=i-ha,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(en,Math.floor(o*l)),s=Math.max(en,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(en,o-d):s=Math.max(en,s-d))}return{columns:3,left:o,right:s}}let a=e-Cf;return a>=en+ha?{columns:2,left:Math.min(n,a-ha),right:t}:{columns:1,left:n,right:t}}var M=class M extends ht{constructor(){super(...arguments);this.narrow=!1;this.colLeft=hc;this.colRight=mc;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.pickerFilter="all";this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=wn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=kl(()=>this.requestUpdate());this.imageSizes=$l(()=>this.requestUpdate());this.symbols=new Wi(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Yi;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=co(a,this.hass.states);r.some(s=>Zr(uc(s.entityId)))||uo({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Zr(cc)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=ya`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},ff)}loadColumnWidths(){try{let t=window.localStorage.getItem(vc);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=mo(i.left)),typeof i.right=="number"&&(this.colRight=mo(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(vc,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(bc);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(bc,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>_d(s,o,i))}>Copy the ${Z(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?sr(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let S=this.focusTapId();if(S!==void 0&&o===S&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,S,r??void 0);return}let T=this.hitLayerId(i);T?this.inspect={kind:"layer",id:T}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let u=wc(i);if(!u&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let c=sr(this.draft.config,o),h=this.draft.config.elements.find(S=>S.payload.id===c);if(!c||!h)return;if(u){i.preventDefault(),this.togglePick(c);return}let m=it(this.draft.config,c),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==c)&&(this.inspect={kind:"layer",id:c},r))return;i.preventDefault();let y=Te(this.draft.config,t,h).frame,x=this.gestureCanvas(t);if(d&&h.kind==="image"&&h.payload.timestamp===!0){this.timestampActiveId=c;let S=h.payload,T=he[t],$=y.width*T.width,C=y.height*T.height,L={x:0,y:0,w:$,h:C,cx:$/2,cy:C/2},O=Oi(S,L,Pi(new Date));if(this.cancelGesture?.(),l){let H=x.width/T.width,U=S.timestampSize;this.cancelGesture=Ul(s,i,l,{w:O.w*H,h:O.h*H},(P,b)=>{let k=Math.min(40,Math.max(4,Math.round(U*P)));this.mutate(z=>{let D=z.elements.find(Y=>Y.payload.id===c);D?.kind==="image"&&(D.payload.timestampSize=k)},`ts-size-${c}`),b&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let V={x:0,y:0,w:y.width*x.width,h:y.height*x.height},ie=tt(S)?{x:S.timestampX,y:S.timestampY}:{x:(O.x+O.w/2)/L.w,y:(O.y+O.h/2)/L.h},w=!1;this.cancelGesture=Gl(s,V,i,ie,(H,U,P)=>{P||(w=!0),w&&this.mutate(b=>{let k=b.elements.find(z=>z.payload.id===c);k?.kind==="image"&&(k.payload.timestampX=H,k.payload.timestampY=U)},`ts-${c}`),P&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=Zi(s,x,i,{elementId:c,frame:y,handle:r??void 0},{onFrame:(S,T,$)=>{this.mutate(C=>ke(C,t,S,{frame:T}),`drag-${S}-${t}`),$&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=at(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,Te(o,t,x).frame])),d=[...l.values()],u=Math.min(...d.map(x=>x.x)),c=Math.min(...d.map(x=>x.y)),h=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),g={x:u,y:c,width:h-u,height:m-c,rotationDegrees:0},y=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=Zi(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:(x,S,T)=>{let $=S.x-g.x,C=S.y-g.y;this.mutate(L=>{for(let[O,V]of l)ke(L,t,O,{frame:{...V,x:y(V.x+$),y:y(V.y+C)}})},`drag-group-${r.id}-${t}`),T&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?Vl:1,s=t*o,l=i*o,d=this.canvasFamily,u=he[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,u,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(at(r,x).map(S=>S.payload.id),d,u,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let c=this.inspect.id,h=r.elements.find(x=>x.payload.id===c);if(!h)return!1;let m=it(r,c);if(m?.locked)return this.nudgeMany(at(r,m.id).map(x=>x.payload.id),d,u,`nudge-group-${m.id}-${d}`,s,l);let g=Te(r,d,h).frame,y=Or(g,s,l,u);return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>ke(x,d,c,{frame:y}),`nudge-${c}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,u=new Map;for(let C of t){let L=l.elements.find(O=>O.payload.id===C);L&&u.set(C,Te(l,i,L).frame)}if(u.size===0)return!1;let c=[...u.values()],h=Math.min(...c.map(C=>C.x)),m=Math.min(...c.map(C=>C.y)),g=Math.max(...c.map(C=>C.x+C.width)),y=Math.max(...c.map(C=>C.y+C.height)),x={x:h,y:m,width:g-h,height:y-m,rotationDegrees:0},S=Or(x,o,s,a),T=S.x-x.x,$=S.y-x.y;return(T!==0||$!==0)&&this.mutate(C=>{for(let[L,O]of u)ke(C,i,L,{frame:{...O,x:d(O.x+T),y:d(O.y+$)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=he[i],u=Te(o,i,s).frame,c=u.width*d.width,h=u.height*d.height,m=Oi(l,{x:0,y:0,w:c,h,cx:c/2,cy:h/2},Pi(new Date)),g=tt(l)?{x:l.timestampX,y:l.timestampY}:{x:c>0?(m.x+m.w/2)/c:.5,y:h>0?(m.y+m.h/2)/h:.5},y=Bl(g,a,r,{w:c,h});return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>{let S=x.elements.find(T=>T.payload.id===t);S?.kind==="image"&&(S.payload.timestampX=y.x,S.payload.timestampY=y.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=zi(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Sr(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ae(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(c=>c.payload.id===r);if(!s||!l)return;let d=ce(s,l),u=Te(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Zi(a,this.gestureCanvas(t),i,{elementId:r,frame:u,handle:o},{onFrame:(c,h,m)=>{this.mutate(g=>{d?Hs(g,c,t,h):ke(g,t,c,{frame:h})},`tap-box-${c}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:xc(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return p`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>p`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${kc(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${pc()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?p`<span class="hor" aria-hidden="true">or</span>${pc()}`:f}
      ...
      <div class="new-head">
        ...
        <span class="spacer"></span>
        <button class="icon" title="Close" aria-label="Close" @click=${()=>this.closeShareDialog()}>${N("close")}</button>
      </div>
      <div class="xfer-body">
        <div class="field">
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=rc(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?co(i,this.hass.states):[],r=uo({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return p`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
        <h2>Import a complication</h2>
        <span class="spacer"></span>
        <button class="icon" title="Cancel" aria-label="Cancel" @click=${()=>this.closeImportDialog()}>${N("close")}</button>
      </div>
      <div class="xfer-body">
        <div class="field">
      ...
      ${r?p`<div class="hint err">A complication on this watch already has that name.</div>`:p`<div class="hint">${dc(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${ic(t)?p`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return p`<div class="xfer-ent">
      ${Ye({hass:this.hass},t.label,i??gf,a=>this.setImportEntity(t.entityId,a),uc(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,ca(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:oc(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=lc(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${ct(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=sc(t.config,this.importMap);i.id=J(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=zt(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(p`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(p`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(p`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${kc(a)}</option>`)}
              </select>
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Tr.map(s=>p`<button class="add" style=${`--k:${me[s]}`} ?disabled=${i} title=${`Add a blank ${kn[s].toLowerCase()} layer`}
              @click=${()=>{let l=Be(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?p`<span class="well">${Dl(s)}</span>`:f}<span class="add-name">${r?N(s):p`<span class="k"></span>`}<span>${kn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
    </div>`}isGroupId(t){return this.draft?.config.groups?.some(i=>i.id===t)===!0}reorderLayer(t,i,a,r=!1){t!==i&&this.mutate(o=>{let s=o.elements.filter(g=>!ce(o,g)),l=o.elements.filter(g=>ce(o,g)),d=[...s].reverse(),u=d.find(g=>g.payload.id===i);if(!u)return;let c=o.groups?.find(g=>g.id===t),h=c?d.filter(g=>g.payload.groupId===c.id):d.filter(g=>g.payload.id===t);if(h.length===0||h.includes(u))return;d=d.filter(g=>!h.includes(g));let m;if((c||r)&&u.payload.groupId!==void 0){let g=d.filter(y=>y.payload.groupId===u.payload.groupId);m=a?d.indexOf(g[0]):d.indexOf(g[g.length-1])+1}else m=d.indexOf(u)+(a?0:1);if(d.splice(m,0,...h),!c){let g=h[0],y=r?void 0:u.payload.groupId;y===void 0?delete g.payload.groupId:g.payload.groupId=y}o.elements=[...d.reverse(),...l],Pe(o),fn(o)})}markDrop(t,i){return t.classList.contains(i)?!1:(this.clearDropMarks(),t.classList.add(i),!0)}clearDropMarks(){for(let t of this.renderRoot.querySelectorAll(".layer"))t.classList.remove("drop-before","drop-after","drop-into")}clearDragMarks(){this.clearDropMarks();for(let t of this.renderRoot.querySelectorAll(".layer, .group-kids"))t.classList.remove("dragging")}rowDrag(t,i){return{draggable:i?"true":"false",onStart:a=>{this.dragId=t,a.dataTransfer?.setData("text/plain",t),a.dataTransfer&&(a.dataTransfer.effectAllowed="move");let r=a.currentTarget,o=r.classList.contains("group")?r.nextElementSibling:null;window.setTimeout(()=>{this.dragId===t&&(r.classList.add("dragging"),o?.classList.contains("group-kids")&&o.classList.add("dragging"))},0)},onEnd:()=>{this.dragId=void 0,this.clearDragMarks()},onOver:a=>{if(!this.dragId||this.dragId===t)return;a.preventDefault();let r=a.currentTarget,o=r.getBoundingClientRect(),s=o.top+(r.classList.contains("drop-before")?dt:0),l=o.bottom-(r.classList.contains("drop-after")?dt:0);this.markDrop(r,a.clientY<(s+l)/2?"drop-before":"drop-after")},onDrop:a=>{a.preventDefault();let o=a.currentTarget.classList.contains("drop-before");this.clearDragMarks(),this.dragId&&this.reorderLayer(this.dragId,t,o),this.dragId=void 0}}}clickRow(t,i){if(i.shiftKey&&!i.metaKey&&!i.ctrlKey){this.pickRange(t);return}if(wc(i)){this.togglePick(t),this.pickAnchor=t;return}this.multi=new Set,this.inspect={kind:"layer",id:t},this.pickAnchor=t}pickRange(t){let i=this.draft?.config,a=this.pickAnchor??(this.inspect.kind==="layer"?this.inspect.id:void 0);if(!i||a===void 0||a===t){this.togglePick(t);return}let r=[...i.elements].filter(l=>!ce(i,l)).reverse().map(l=>l.payload.id),o=r.indexOf(a),s=r.indexOf(t);if(o<0||s<0){this.togglePick(t);return}this.multi=new Set(r.slice(Math.min(o,s),Math.max(o,s)+1))}togglePick(t){let i=new Set(this.multi);i.size===0&&this.inspect.kind==="layer"&&this.inspect.id!==t&&i.add(this.inspect.id),i.has(t)?i.delete(t):i.add(t),this.multi=i}groupPicked(){let t=[...this.multi];if(!this.canEdit||t.length<2)return;let i;this.mutate(a=>{i=tr(a,t)}),this.multi=new Set,i&&(this.inspect={kind:"group",id:i})}renderLayers(){let t=this.draft?.config;if(!t)return f;if(this.activeFamily==="inline")return this.renderInlineHasNoLayers();let i=this.canEdit,a=this.canvasFamily,r=(w,H)=>this.moveLayer(w,H),o=w=>{let H;this.mutate(U=>{H=_s(U,w)}),H&&(this.inspect={kind:"layer",id:H})},s=w=>{this.mutate(H=>ot(H,w)),this.inspect.kind==="layer"&&this.inspect.id===w&&(this.inspect={kind:"general"})},l=Ke(t,a).filter(w=>!ce(t,w)).reverse(),d=ve(this.host()),u=new st(this.buildContext(),this.draft?.config),c=t.perFamily[this.activeFamily],h=this.inspect.kind==="family",m=`${c?.backgroundColorHex?Ce(c.backgroundColorHex):"transparent"} \xB7 ${c?.borderColorHex?`${c.borderWidth} pt border`:"no border"}`,g=[...this.multi].filter(w=>t.elements.some(H=>H.payload.id===w)).length,y=Li(t,this.buildContext(),this.forced)[a],x=wf[this.thumbStep],S=Math.round(fc*x),T=Math.round(gc*x),$=w=>y?p`<span class="thumb">${hl(y,w,{icons:this.icons,imageSizes:this.imageSizes,width:S,height:T})}</span>`:p`<span class="thumb"></span>`,C=this.layerDetail==="expanded",L=(w,H,U=!1)=>{let P=w.payload.id,b=this.inspect.kind==="layer"&&this.inspect.id===P,k=Te(t,a,w),z=k.isHidden,D=Ae(t,P)[0],Y=ii(w.payload.rules),B=this.picking&&this.pickHoverId===P,K=this.rowDrag(P,i);return p`<div class="layer ${b?"hl":""} ${U?"held":""} ${B?"pick":""} ${z?"dim":""} ${this.multi.has(P)?"multi":""} ${H?"kid":""} ${C?"rich":""}"
        style=${`--k:${me[w.kind]}`} tabindex="0" draggable=${K.draggable}
        @pointerenter=${()=>{this.listHoverIds=[P]}}
        @pointerleave=${()=>this.leaveRow([P])}
        @click=${j=>this.clickRow(P,j)}
        @keydown=${j=>{j.key==="Enter"&&(this.inspect={kind:"layer",id:P})}}
        ...
        <span class="name">
          <b>${Le(w,d)}</b>
          <small><span class="kind">${kn[w.kind]}</span> · ${Ff(w,u,this.historySeries,k.size)}</small>
          ${C?p`<span class="facts">${Tf(this.host(),a,w,k).map(j=>p`<span class="fact"><b>${j.label}</b> ${j.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${D?p`<span class="badge tap" title=${`Tappable \xB7 ${Le(D,d)}`}>tap</span>`:f}
            ${w.payload.rules.length===0?f:p`<span class="badge states" title=${Y}>${Y.replace(/\.$/,"").toLowerCase()}</span>`}
            ${z?p`<span class="badge">hidden</span>`:f}
          </span>
          ${i?p`<span class="acts">
            <button class="icon" title=${`Bring forward (${Ft}])`} aria-label="Bring forward" @click=${j=>{j.stopPropagation(),r(P,1)}}>${N("up")}</button>
            <button class="icon" title=${`Send back (${Ft}[)`} aria-label="Send back" @click=${j=>{j.stopPropagation(),r(P,-1)}}>${N("down")}</button>
            <button class="icon" title=${`${k.isHidden?"Show":"Hide"} (${fo}${Ft}H)`} aria-label=${k.isHidden?"Show this layer":"Hide this layer"} @click=${j=>{j.stopPropagation(),this.mutate(Me=>ke(Me,a,P,{isHidden:!k.isHidden}))}}>${N(k.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${Ft}D)`} aria-label="Duplicate" @click=${j=>{j.stopPropagation(),o(P)}}>${N("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${j=>{j.stopPropagation(),s(P)}}>${N("delete")}</button>
          </span>`:f}
        </span>
      </div>`},O=(w,H)=>{let U=this.inspect.kind==="group"&&this.inspect.id===w.id,P=!this.collapsed.has(w.id),b=this.rowDrag(w.id,i),k=H[0],z=H[H.length-1],D=B=>{let K=B.currentTarget,j=K.getBoundingClientRect(),Me=j.top+(K.classList.contains("drop-before")?dt:0),It=j.bottom-(K.classList.contains("drop-after")?dt:0),ut=(B.clientY-Me)/Math.max(1,It-Me);return ut<.25?"drop-before":!P&&ut>.75?"drop-after":"drop-into"},Y=H.map(B=>B.payload.id);return p`<div class="layer group ${U?"hl":""} ${C?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${b.draggable}
        @pointerenter=${()=>{this.listHoverIds=Y}}
        @pointerleave=${()=>this.leaveRow(Y)}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:w.id}}}
        @keydown=${B=>{B.key==="Enter"&&(this.inspect={kind:"group",id:w.id})}}
        @dragstart=${b.onStart} @dragend=${b.onEnd}
        @dragover=${B=>{!this.dragId||this.dragId===w.id||(B.preventDefault(),this.markDrop(B.currentTarget,D(B)))}}
        @drop=${B=>{B.preventDefault();let K=D(B);this.clearDragMarks();let j=this.dragId;if(this.dragId=void 0,!(!j||!k||!z)){if(K==="drop-before"){this.reorderLayer(j,k.payload.id,!0,!0);return}if(K==="drop-after"){this.reorderLayer(j,z.payload.id,!1,!0);return}this.isGroupId(j)||(this.reorderLayer(j,k.payload.id,!0),this.mutate(Me=>nr(Me,j,w.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${H.map(B=>Le(B,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${fo}${Ft}G)`} aria-label="Ungroup" @click=${B=>{B.stopPropagation(),this.mutate(K=>Zn(K,w.id)),U&&(this.inspect={kind:"general"})}}>${N("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${w.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${B=>{B.stopPropagation(),this.mutate(K=>{let j=K.groups?.find(Me=>Me.id===w.id);j&&(j.locked=!j.locked)})}}>${N(w.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${P?"true":"false"} title=${P?"Fold the group":"Unfold the group"}
            @click=${B=>{B.stopPropagation();let K=new Set(this.collapsed);P?K.add(w.id):K.delete(w.id),this.collapsed=K}}>${N("chevron")}</button>
        </span>
      </div>`},V=[],ie=new Set;for(let w=0;w<l.length;w++){let H=l[w],U=H.payload.groupId,P=U===void 0?void 0:t.groups?.find(z=>z.id===U);if(!P){V.push(L(H,!1));continue}if(ie.has(P.id))continue;ie.add(P.id);let b=l.filter(z=>z.payload.groupId===P.id);V.push(O(P,b));let k=this.inspect.kind==="group"&&this.inspect.id===P.id;this.collapsed.has(P.id)||V.push(p`<div class="group-kids">${b.map(z=>L(z,!0,k))}</div>`)}return p`<div class="card layers-card" style=${`--thumb-w:${S}px;--thumb-h:${T}px`}>
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${N("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${xf.map((w,H)=>p`
              <button class=${this.thumbStep===H?"on":""} title=${`${yc[H]} row pictures`}
                aria-label=${`${yc[H]} row pictures`} aria-pressed=${this.thumbStep===H?"true":"false"}
      ...
      <div class="layer pinned ${h?"hl":""}" style=${`--k:${ee.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${w=>{w.preventDefault(),this.clearDragMarks();let H=this.dragId,U=[...l].reverse().find(P=>P.payload.id!==H&&P.payload.groupId!==H);H&&U&&this.reorderLayer(H,U.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?Yd(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:p`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${Ye(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},cc,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Zd(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=Li(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`
      ${this.renderComplicationBar()}
      <div class="card canvas-card">
        <div class="canvas-bar">
          ${this.renderShapeTabs(t,i)}
          <span class="spacer"></span>
          <span class="inbox" title=${`Layouts are made in the ${wn.label} box. Smaller cases scale it down.`}>
      ...
      ${Vi(r,m)}
    </div>`}renderUnder(t,i){let a=ve(this.host()),r=this.inspect,o=r.kind==="layer"?t.elements.find(c=>c.payload.id===r.id):void 0,s;if(this.showTaps)s=p`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${nt(t.tapAction)}</b>.`;else if(this.picking)s="Point at a layer and click it. Escape stops.";else if(i==="inline")s="One line of text. Edit it on the right.";else if(r.kind==="group"){let c=t.groups?.find(m=>m.id===r.id),h=c?at(t,c.id).length:0;s=c?p`editing group <b>${c.name}</b>. Drag to move all ${h} layers.${c.locked?"":" Click one layer to move it alone."}`:""}else if(o){let c=it(t,o.payload.id);s=c?.locked?p`editing <b>${Le(o,a)}</b> in <b>${c.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:p`editing <b>${Le(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else s="click a layer to edit it";if(i==="inline")return p`<div class="under"><b>Inline</b><span class="dot">·</span><span class="tail">${s}</span></div>`;let l=this.currentCase().slots[i],d=zi(l,i),u=Math.round(d.scale*100);return p`<div class="under">
      <b>${Z(i)}</b>
      <span class="size">${l.width} × ${l.height} pt${u!==100?` \xB7 ${u}%`:""}</span>
      <span class="dot">·</span>
      <span class="tail">${s}</span>
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=p`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?bn((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=p`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:p`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderComplicationBar(){let t=this.host();return p`<div class="card comp-bar" style=${`--c:${ee.complication}`} @change=${()=>this.draft?.endGesture()}>
      <div class="settings inline" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${Rd(t)}</div>
      <span class="spacer"></span>
      <span class="acts">
    ...
    </div>`}renderSharedValues(t){let i=t.values,a=new st(this.buildContext(),this.draft?.config),r=ve(this.host());return p`<div class="card tint-values values-list" style=${`--c:${ee.complication}`}>
      <h2 class="panel-title"><span class="swatch">${N("content")}</span>Shared values
        ...
        <span class="spacer"></span>
        ${this.canEdit?p`<button class="small" @click=${()=>{let o=Ld();this.mutate(s=>{s.values.push(o)}),this.inspect={kind:"data",id:o.id}}}>Add</button>`:f}
      </h2>
      ...
      ${i.map(o=>{let s=a.resolve({kind:{kind:"named",id:o.id}}),l=this.inspect.kind==="data"&&this.inspect.id===o.id;return p`<div class="datum vrow ${l?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:o.id}}}>
          ...
          ${N("plus")}${Z(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let u=i[r];s=u?Vi(u,{icons:this.icons,imageSizes:this.imageSizes,slot:wn.slots[r]}):f}let l=r!=="inline"&&ua(t,r)===0&&t.elements.length>0,d=this.canEdit&&Gi(t,r);return p`<span class="tab-wrap">
      ...
      ${i.length===0?p`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:p`<div class="chips values">
        ${i.map(r=>{let o=this.hass.states[r],s=typeof o?.attributes.friendly_name=="string"?o.attributes.friendly_name:r,l=typeof o?.attributes.unit_of_measurement=="string"?` ${o.attributes.unit_of_measurement}`:"",d=o?`${o.state}${l}`:"not in Home Assistant",u=this.testValues.get(r),h=t.elements.find(g=>Fi(t,g.payload.id).some(y=>y.ref.entityId===r))?.kind??"text",m=this.editingValue===r;return p`<button class="vchip vrow ${u!==void 0?"testing":""}" style=${`--k:${me[h]}`}
      ...
      ${l===f?f:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=f,s=!0;if(r.kind==="layer"){let d=t.elements.find(u=>u.payload.id===r.id);if(!d)return this.inspect={kind:"general"},f;o=zd(a,d,this.canvasFamily,{placement:!1,tap:!1})}else if(r.kind==="group"){let d=t.groups?.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=Od(a,d)}else if(r.kind==="data"){let d=t.values.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${ee.complication}`}>
        ...
        <div class="sec-b">${Hd(a,d)}</div>
      </div>`}else r.kind==="family"?o=Dd(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${N("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([bf(r)]):new Set(Xr)}}>${l?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <span>${t}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:f}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=ve(this.host()),o=new st(this.buildContext(),this.draft?.config),s=Nd(t,a,i),l=i.length,d=[...i].reverse(),u=h=>this.mutate(m=>{for(let g of i)ke(m,a,g.payload.id,{isHidden:h})}),c=h=>this.mutate(m=>{for(let g of i){let y=m.elements.find(x=>x.payload.id===g.payload.id);y&&y.kind!=="image"&&y.kind!=="tap"&&y.kind!=="timeline"&&(y.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
          ...
          <div class="picked">
            ${d.map(h=>p`<div class="row" style=${`--k:${me[h.kind]}`}>
              ...
              <span class="name">
                ...
                <b>${Le(h,r)}</b><span class="kind">${kn[h.kind]}</span>
              </span>
            </div>`)}
          </div>
