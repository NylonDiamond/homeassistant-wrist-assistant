...
function shape(name: UiIconName) {
  switch (name) {
    ...
    // A bar cut into three stretches: the one glyph that says "the same thing,
    // in different states, over time" without drawing a clock.
    case "timeline":
      return svg`<rect x="3" y="9" width="6" height="6" rx="1.5" /><rect x="10.5" y="9" width="3.5" height="6" rx="1.5" /><rect x="15.5" y="9" width="5.5" height="6" rx="1.5" />`;
    case "shape":
    ...
    // A list: three rows, each a bullet and a line, which is what a row
    // template draws once per item.
    case "list":
      return svg`<circle cx="5.5" cy="7" r="1.6" /><circle cx="5.5" cy="12" r="1.6" /><circle cx="5.5" cy="17" r="1.6" /><path d="M10 7H19M10 12H19M10 17H19" />`;
    ...
    case "left":
      return svg`<path d="M14 6L8 12L14 18" />`;
    case "right":
      return svg`<path d="M10 6L16 12L10 18" />`;
    case "show":
