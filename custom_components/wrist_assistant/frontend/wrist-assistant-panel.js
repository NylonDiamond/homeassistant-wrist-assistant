...
`)}function Bo(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Zd(r));return{values:t,nullKeys:i}}function Zd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Ia(e){let n=oi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Qd(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}var ec=10800;function tc(e,n){let t=e.minutes==="always"||e.minutes==="auto"&&n<=ec;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...t?{minute:"2-digit"}:{},...e.hourCycle==="h12"?{hourCycle:"h12"}:{},...e.hourCycle==="h24"?{hourCycle:"h23"}:{}})}function nc(e,n){if(ht(e)===void 0)return[];let t=co(e.timeLabelCount);if(t.length===0)return[];let i=Oe(e)*60,a=tc(e,i);return t.map(r=>({position:r,text:a.format(new Date(n-i*1e3*(1-r)))}))}function It(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ze(e){let n=e.trim(),t=It(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:It(i)}function ic(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ac(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function rc(e){let n=e.trim(),t=It(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?It(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=It(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function oc(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function sc(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function lc(e,n,t){if(De(n))return e;let i=n,a=e,r=It(e.trim()),o=i.duration?rc(e):void 0;if(o!==void 0)a=oc(o);else if(i.relativeTime&&r!==void 0)a=ac(r);else{let s=Ze(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):ic(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=sc(a);break}return a}function Jt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Mn(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function Go(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function dc(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Rn(e,n=pt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:cc(i.slice(a+1))})}return t}function cc(e){try{return decodeURIComponent(e)}catch{return e}}function uc(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let u=t(o.state),c=i[i.length-1];c!==void 0&&c.colorHex===u?c.end=d:i.push({start:s,end:d,colorHex:u})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Uo(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function pc(e,n,t){if(e===void 0)return 0;let i=Ze(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Qe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Go(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Tt(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=Mn(i);return n.limit>0&&a.length>n.limit?n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit):a}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ze(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let u=t.get(s);if(!u)return{min:0,max:1};let c=u.scaleFrom,h=c!==void 0&&c!==s&&t.has(c)&&!l.has(c)?o(c,new Set([...l,c])):Go(a.get(s)??[],u);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),u={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},c=this.chartEntity(l);c&&(u.entity=c),this.charts.set(s,u)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!De(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Qd(a,t.kind.stat):void 0;i=a&&r!==void 0?io(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Ra(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return lc(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=It(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Jt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ze(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ze(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),u=d===void 0?void 0:Ze(d);if(a===void 0||l===void 0||u===void 0)return!1;let[c,h]=l<=u?[l,u]:[u,l];return a>=c&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ee[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,m={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return c!==void 0&&(m.countdownEnd=c),m}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...u,symbol:this.styleText(a,"icon")??c,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let c=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(c.value),m=this.styleNumber(a,"gaugeMin")??c.minValue,g=this.styleNumber(a,"gaugeMax")??c.maxValue,v=h===void 0?void 0:Ze(h),$=this.styleColor(a,"color")??c.colorSlot.baseColorHex;c.coloring==="bands"&&c.bands.length>0&&v!==void 0&&($=aa(v,wn(c),c.bandAboveColorHex));let S=g-m;if(c.total){let C=Ze(this.resolve(c.total)??"");C!==void 0&&(S=C)}let E=Uo(S,1,Wn),w={kind:"gauge",...u,fraction:pc(h,m,g),style:c.style,lineWidth:c.lineWidth,colorHex:$,trackColorHex:c.trackColorHex,thresholdColorHex:c.thresholdColorHex,dotCount:E,filledCount:Uo(v??0,0,E)};if(c.thresholdValue!==void 0&&g!==m){let C=(c.thresholdValue-m)/(g-m);C>=0&&C<=1&&(w.thresholdFraction=C)}return w}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),m=h.values,g={min:h.domainMin,max:h.domainMax},v=this.styleColor(a,"color")??c.colorSlot.baseColorHex,$=wn(c),S=no(c)?m.map(N=>aa(N,$,c.bandAboveColorHex)):[],E={kind:"chart",...u,values:m,style:c.style,domainMin:g.min,domainMax:g.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:v,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:S,fillBands:c.fillBands,thresholdColorHex:c.thresholdColorHex,nowColorHex:c.nowColorHex};if(m.length>0){let N=c.highlight==="highest"||c.highlight==="both",B=c.highlight==="lowest"||c.highlight==="both",X=N?m.indexOf(Math.max(...m)):-1,de=B?m.indexOf(Math.min(...m)):-1;X>=0&&(E.highIndex=X),de>=0&&de!==X&&(E.lowIndex=de)}let w=dc(c,g.min,g.max);w!==void 0&&(E.thresholdY=w);let C=this.chartNowIndex(c,m.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let c=n.payload,h=ht(c),m=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=Rn(m,pt),v=uc(g,Oe(c)*60,S=>po(S,c.bands,c.otherColorHex));return{kind:"timeline",...u,runs:v,gap:c.gap,cornerRadius:c.cornerRadius,labels:nc(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove}}case"shape":{let c={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};We(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=To(n,t).map(v=>this.resolveElement(v,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=l??u??this.resolve(a?.bezelText);c!==void 0&&(s.bezelText=c),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let v=a.bezelGauge,$=this.resolve(v.value),S=$===void 0?void 0:Ze($);if(S!==void 0){let E=Math.min(v.minValue,v.maxValue),w=Math.max(v.minValue,v.maxValue),C={value:Math.min(w,Math.max(E,S)),minValue:E,maxValue:w===E?E+1:w,colorHexes:v.colorHexes},N=this.resolve(v.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(v.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function hc(e,n,t){let i=new Qe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function si(e,n,t){let i=new Qe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=hc(e.inline,n,e)),a}var be=he,In=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:be,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Zt=In.find(e=>e.measured);function Qo(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return In.find(a=>a.screen.width===t&&a.screen.height===i)}function di(e,n){let t=be[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var mc={regular:400,medium:500,semibold:600,bold:700};function Be(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function we(e,n,t="#FFFFFF"){let i=Be(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function es(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function fc(e,n){let t=we(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Jt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=e.text;if(n.w>0&&s.length*i(o)>n.w){let l=n.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    <g transform="rotate(${u} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:yc(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function yc(e,n,t,i,a){let r=we(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return b`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var bc=5;function vc(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:bc,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,u=Math.max(n.h-r-o*2,1),c=d+u,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?u*.12:0,v=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-v*(i-1))/i,.5),S=w=>Math.min(1,Math.max(0,(w-e.domainMin)/h)),E=w=>c-S(w)*u;return{count:t.length,barWidth:$,plotTop:d,plotBottom:c,plotLeft:s,plotRight:s+l,baselineY:m?c:E(0),yAtFraction(w){return c-Math.min(Math.max(w,0),1)*u},barRect(w){let C=s+w*($+v),N=t[w],B,X;if(m){let de=g+S(N)*(u-g);B=c-de,X=c}else B=E(N),X=m?c:E(0),B>X&&([B,X]=[X,B]);return{x:C,y:B,w:$,h:Math.max(X-B,.5)}},point(w){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*w/(t.length-1):s+l/2,y:E(t[w])}},markerCenter(w,C){let N=C?this.barRect(w):void 0;return{x:N?N.x+N.w/2:this.point(w).x,y:n.y+r/2}}}}function wc(e,n){if(e.values.length===0)return f;let t=vc(e,n),i=we(e.colorHex,"fill"),a=we(e.highColorHex,"fill",e.colorHex),r=we(e.lowColorHex,"fill",e.colorHex),o=(u,c)=>b`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${c.fill} fill-opacity=${c["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?we(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let c=t.barRect(u),h=u===e.highIndex?a:u===e.lowIndex?r:d(u),m=Math.min(1.2,c.w/2,c.h/2);s.push(b`<rect x=${c.x} y=${c.y} width=${c.w} height=${c.h} rx=${m}
      ...
      fill=${d.fill} fill-opacity=${d["fill-opacity"]}>${c.text}</text>`});return b`${s}${u}`}function kc(e,n){let t=we(e.fillColorHex,"fill"),i=e.borderColorHex?Be(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return b`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function $c(e,n,t){let i=t.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=we(e.colorHex,"stroke"),r=e.size;return b`
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Oa=.25,Cc=8;function Sc(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Oa),Cc),u=Math.max(e/t,n/i),c=Math.min(e/t,n/i),h=(a==="fit"?c:u)*d,m=t*h,g=i*h,v=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),$=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+v)+0,y:-(g-n)/2*(1+$)+0,width:m,height:g}}function ci(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var li=4;function ui(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+li:n.x+n.w-li-a,d=e.timestampCorner.startsWith("top")?n.y+li:n.y+n.h-li-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,u,c)=>c>=u?d+(u-c)/2:Math.min(d+u-c,Math.max(d,l-c/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Ec(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Tc(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ui(e,n,ci(new Date)):void 0,s=o?b`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([h,m,g])=>b`<rect data-ts-corner=${h} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${h}-resize" />`)}`:f,u=e.url?t.imageSizes?.size(e.url):void 0,c;if(e.url&&u){let h=Sc(n.w,n.h,u.width,u.height,e.contentMode,e.zoom,e.panX,e.panY);c=b`<image href=${e.url} x=${n.x+h.x} y=${n.y+h.y} width=${h.width} height=${h.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Ec(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return b`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${c}${s}</g>${d}`}function Fc(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Mc(a,n):void 0;return b`
    ...
    ${o!==void 0?b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${_a} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var _a=5;function Mc(e,n){let t=_a*.55,i=n.w-2;if(n.h<_a*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function za(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=es(e,n),d=i&&(!s||o),u;switch(e.kind){case"text":u=fc(e,l);break;case"icon":u=$c(e,l,t.icons);break;case"gauge":u=gc(e,l);break;case"chart":u=wc(e,l);break;case"timeline":u=xc(e,l);break;case"shape":u=kc(e,l);break;case"image":u=Tc(e,l,t);break;case"tap":u=Fc(e,l,t.icons,a,d?je(e.action):void 0);break}let c=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*c,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,v=t.handles===!0&&(!s||o),$=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,E=b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,w=3,C=m&&v?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([N,B,X])=>b`<rect data-handle=${N} x=${B-w/2} y=${X-w/2} width=${w} height=${w}
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${u}${S}${$}${C}</g>`}function pi(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Da(e,n){return(n?23.5:34)*e}var Ko=10.5;function ts(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Wo(e,n){let t=0;for(let i of e)t+=ts(i,n);return t}function jo(e,n,t){let i=e.toUpperCase(),a=d=>ts(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Na(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Pa(e,n,t,i){let a=Na(e,n,t),r=Na(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function ns(e,n,t,i){let{dial:a}=pi(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Pa(a,t,i.start,i.end),length:t*r}}function Rc(e,n){let t=pi(e,!0);return ns(e,n,t.dial.r,t.labelArc)}var qo=18.5,Ic=113,Ac={start:-71,end:-36},Yo=104,Hc=6.2,Xo={start:-77,end:-30.5};function Jo(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Zo(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Jo(e[i]),o=Jo(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var La=11;function Lc(e,n,t){let{dial:i}=pi(n,!0),a=Yo*n,r=180/(Math.PI*Yo),o=e.minLabel!==void 0?Wo(e.minLabel,La)*r:0,s=e.maxLabel!==void 0?Wo(e.maxLabel,La)*r:0,l=Xo.start+(o>0?Math.max(0,o-1.8):0),d=Xo.end-(s>0?Math.max(0,s-1.8):0),u=d-l,c=24,h=[];for(let S=0;S<c;S++){let E=l+u*S/c,w=Math.min(d,l+u*(S+1)/c+.4);h.push(b`<path d=${Pa(i,a,E,w)} fill="none"
      stroke=${Zo(e.colorHexes,(S+.5)/c)} stroke-width=${Hc*n}
      stroke-linecap=${S===0||S===c-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=Na(i,a,l+u*m),v=1.5,$=(S,E,w,C)=>b`
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${Zo(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?$(`${t}-gmin`,l-v-Math.max(o,3),l-v,e.minLabel):f}
    ${e.maxLabel!==void 0?$(`${t}-gmax`,d+v,d+v+Math.max(s,3),e.maxLabel):f}`}function hi(e,n){let t=e.family in be?e.family:"rectangular",i=n.slot??be[t],a=be[t],r=di(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Be(e.backgroundColorHex),l=Be(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,v=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=pi(g,v),w=Da(g,v),C=w/(a.width*g),N=E.tile.cx-w/2,B=E.tile.cy-w/2,X=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,de=f;if(e.bezelGauge)de=Lc(e.bezelGauge,g,o);else if(e.bezelText){let F=Rc(g,`${o}-bezel`),D=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Jt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;de=b`<defs><path id=${F.id} d=${F.d} /></defs>
        <text font-size=${Ko*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${F.id}" startOffset="50%" text-anchor="middle">${jo(D,F.length,Ko*g)}</textPath></text>`}let k=f;if(S){let F=Be(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},D=ns(g,`${o}-curved`,Ic*g,Ac);k=b`<defs><path id=${D.id} d=${D.d} /></defs>
        <text font-size=${qo*g} font-weight="600" fill=${F.color} fill-opacity=${F.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${D.id}" startOffset="50%" text-anchor="middle">${jo($,D.length,qo*g*.88)}</textPath></text>`}else{let F=e.borderWidth*r.scale*C,D=l?b`<circle cx=${w/2} cy=${w/2} r=${w/2-F/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${F} />`:f;k=b`<g transform="translate(${N} ${B})">
        <g clip-path=${`url(#${o})`}>
          ${s?b`<rect width=${w} height=${w} fill=${s.color} fill-opacity=${s.opacity} />`:f}
          <g data-design-box transform="scale(${r.scale*C})">
            ${e.elements.map(z=>za(z,a,n))}
          </g>
        </g>
    ...
    ${u.map(m=>za(m,a,d))}
    ${c}
  </svg>`}function Z(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var At=["rectangular","circular","corner","inline"];function Qt(e){return ne.includes(e)}function as(e){return At.filter(n=>e.supportedFamilies.includes(n))}function Va(e){return ne.find(n=>e.supportedFamilies.includes(n))}function mi(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function Pc(){return{value:I("")}}function rs(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=At.filter(t=>t===n||e.supportedFamilies.includes(t))),Qt(n)?e.perFamily[n]||(e.perFamily[n]=Xe()):e.inline||(e.inline=Pc()),e.schemaVersion=yn(e)}function os(e,n){if(mi(e,n)){if(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),Qt(n)){for(let t of Ve(e,n))Je(e,t.payload.id);delete e.perFamily[n],He(e)}else delete e.inline;e.schemaVersion=yn(e)}}function ss(e,n){let t=[];if(!Qt(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=Ve(e,n).filter(r=>!le(e,r)).length;return a>0&&t.push(`${a} layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var me={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},en={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area"},Ba=["text","icon","gauge","chart","timeline","shape","image","tap"],te={states:"#f9a825",tap:me.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var ls="2.8.0";function Ga(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function Oc(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function ds(e,n=ls){let t=Ga(e),i=Ga(n);return!t||!i?!1:Oc(t,i)>=0}function cs(e,n=ls){return`${Ga(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The complication editor needs ${n} or newer. Update Wrist Assistant on the watch, open it once so it reports its version, then reload this page.`}var us="52a9d81d0fd7";function Dc(e){return e.trim().replace(/\./g,"-")}function Vc(e){return e.trim().replace(/-/g,".")}var fi=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>Vc(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=Dc(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Be(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return b`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Jc(e)}</svg>`}var Ge="color-mix(in srgb, var(--k) 45%, #6b7280)",xi='system-ui, -apple-system, "Segoe UI", sans-serif';function Rs(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=u=>{let c=u*Math.PI/180;return{x:(e-t*Math.cos(c)).toFixed(2),y:(n-t*Math.sin(c)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Xa(e,n,t,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${Rs(e,n,t,1)} stroke=${Ge} stroke-width="2.6" opacity=".5" />
    <path d=${Rs(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function Zc(e){switch(e){case"text":return b`<g font-family=${xi} text-anchor="middle">
        <text x="36" y="27" font-size="19" font-weight="600" fill="var(--k)">72°</text>
        <text x="36" y="38" font-size="8" fill=${Ge}>Kitchen</text>
        <text x="90" y="20" font-size="11" font-weight="500" fill=${Ge}>48%</text>
        <text x="90" y="34" font-size="11" font-weight="500" fill=${Ge}>1.2 kW</text>
        ...
        <rect x="6" y="17" width="30" height="12" rx="2.5" fill=${Ge} opacity=".55" />
        <rect x="37" y="17" width="18" height="12" rx="2.5" fill="var(--k)" />
        <rect x="56" y="17" width="8" height="12" rx="2.5" fill=${Ge} opacity=".55" />
        <rect x="65" y="17" width="24" height="12" rx="2.5" fill="var(--k)" />
        <rect x="90" y="17" width="24" height="12" rx="2.5" fill=${Ge} opacity=".55" />
        <text x="6" y="39" font-family=${xi} font-size="7" fill=${Ge}>1h ago</text>
        <text x="114" y="39" font-family=${xi} font-size="7" text-anchor="end" fill=${Ge}>now</text>
    ...
    </div></div>`}function nu(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function rl(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function iu(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Ns(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var ol=50;function au(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function ru(e,n,t=ol,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),u=l.name.toLowerCase(),c=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:u.startsWith(a)?h=2:d.includes(a)?h=3:u.includes(a)?h=4:o.length>1&&o.every(m=>d.includes(m)||u.includes(m))?h=5:c!==""&&(c.includes(a)||o.length>1&&o.every(m=>d.includes(m)||u.includes(m)||c.includes(m)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var ou=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function sl(e){return ou.test(e.trim())}function su(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return rl(t,i);if(sl(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var _t=new Map;function Ae(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function ll(e){return _t.has(e)}function tt(e,n,t,i,a,r={}){let o=e.hass.states,s=_t.get(a),l=s?ru(iu(o,r.domain,Ns(e.hass)),s.query,ol,r.preferNumeric?au:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,u=t.entityId?o[t.entityId]:void 0,c=(w,C,N=0)=>{_t.set(a,{query:C,index:N}),Ae(w)},h=w=>{_t.delete(a),Ae(w)},m=w=>{let C=su(w,t,o);C&&i(C)},g=(w,C)=>{i(rl(o,w.entityId)),h(C)},v=()=>Math.max(0,Math.min(_t.get(a)?.index??0,l.length-1)),$=w=>{let C=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let N=_t.get(a);if(!N){c(C,C.value);return}let B=w.key==="ArrowDown"?v()+1:v()-1;c(C,N.query,Math.max(0,Math.min(l.length-1,B))),lu(C);return}if(w.key==="Enter"){w.preventDefault();let N=l[v()];s&&N?g(N,C):(m(C.value),h(C));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),h(C)}},S=t.entityId?Ns(e.hass)?.(t.entityId):void 0,E=t.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:u?p`<div class="entity-current">
    ...
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${sl(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${zs(w.domain)}</span>
                  <span class="ent-state">${w.state}</span>
                </span>
              </button>`)}
        </div>`:E}
  </div>`}function lu(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var du=120;function cu(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(yi.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(bi),fromPack:!1}}function Ps(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function uu(e){return[{value:"",label:`Starter set (${Ps(bi,e)})`},...yi.map(n=>({value:n.name,label:`${n.name} (${Ps(n.symbols,e)})`}))]}function pu(e){return e.length>0?e.length:bi.length}function hu(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Os(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return p`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function dl(e,n,t,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),u=n.trim(),c=u!==""&&d.size>0&&!d.has(u),h=g=>{t(g),a.noteUsed(g)},m=f;if(r){let g=a.category(i),v=cu(g,o,l,d),$=ms(v.names,o),S=v.fromPack?$.slice(0,du):$,E=d.size===0?a.recent:a.recent.filter(w=>d.has(w));m=p`<div class="sym-browse">
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${o} @input=${ve(w=>a.setQuery(i,w))} />
        <select @change=${ve(w=>a.setCategory(i,w))}>
          ${uu(d).map(w=>p`<option value=${w.value} ?selected=${w.value===g}>${w.label}</option>`)}
        </select>
      </div>
      ...
      ${$.length===0?p`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:p`<div class="hint">
            ${hu(S.length,$.length,o.trim()!=="",pu(l))}
          </div>`}
    ...
    ${m}`}var mu=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],fu=[["bars","Bars"],["line","Line"],["area","Area"]],gu=[["auto","Auto"],["fixed","Fixed range"]],yu=[["lowest","Lowest value"],["zero","Zero"]],cl=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],bu=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],Ds=[["uniform","One colour"],["bands","By value"]];function Vs(e){let n=[ia,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function vu(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function wu(e,n){let t=wn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Bs(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    <button class="small" @click=${()=>n(o=>{o.bands=[...o.bands,{id:J(),match:r,colorHex:Un(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${oe("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??ut},"tother"),!1,ut)}`}var $u=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],Cu={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Gs(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return I(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Su=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function Eu(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function se(e,n,t,i){if(i.inline||!Tu())return p`<div class="value-editor">${hl(e,n,t,i)}</div>`;let a=or(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=fe(n,ge(e)),l="entityId"in n.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${ul(e,a,r,n,t,i)}
  </div>`}function ul(e,n,t,i,a,r){return p`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${pl}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${_n.has(n)?hl(e,i,a,r):f}
  </div>`}function ge(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function or(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function Tu(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var _n=new Set,Hn=new WeakMap;function Fu(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Mu(e,n){let t=e instanceof Node?e:null;if(!t)return;let i=t.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(n)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function pl(e){let n=e.currentTarget,t=e.newState==="open",i=Hn.get(n);if(i&&(i(),Hn.delete(n)),!t){_n.delete(n.id)&&Ae(n);return}let a=Fu(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){Hn.get(n)?.(),Hn.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}nr(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Hn.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),nr(n,a.getBoundingClientRect()),_n.has(n.id)||(_n.add(n.id),Ae(n),requestAnimationFrame(()=>{n.isConnected&&nr(n,a.getBoundingClientRect())}))}function nr(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=Ru({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Lt=8,Ci=6,Us=140;function Ru(e,n,t){let i=t.height-e.bottom-Ci-Lt,a=e.top-Ci-Lt,r=n.height>i&&a>i&&i<Us,o=Math.max(Us,r?a:i),s=Math.min(n.height,o),l=Math.max(Lt,Math.min(e.left,t.width-n.width-Lt)),d=r?Math.max(Lt,e.top-Ci-s):Math.max(Lt,Math.min(e.bottom+Ci,t.height-s-Lt));return{left:l,top:d,maxHeight:o,above:r}}function hl(e,n,t,i){let a=n.kind,r=u=>t({...n,kind:u}),o=i.key,s=mu.filter(([u])=>i.allowNamed!==!1||u!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?dl(e,a.value,u=>r({...a,value:u}),o):pe("Text",a.value,u=>r({...a,value:u}));break;case"entityState":case"entityAge":l=tt(e,"Entity",a,u=>r({...a,...u}),`${o}-entity`);break;case"entityAttribute":{let u=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),c=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=p`${tt(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${pe("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:c,mono:!0})}
        <datalist id=${c}>${u.map(h=>p`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=Au(e,a.aggregate,u=>r({...a,aggregate:u}),o);break;case"time":l=Fe("Field",a.timeField,Su,u=>r({...a,timeField:u}));break;case"dataAge":l=p`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=p`${al("Template",a.value,u=>r({...a,value:u}),4)}
    ...
    ${Fe("Source",a.kind,s,u=>r(Eu(a,u)))}
    ${l}
    ${i.noFormat?f:Iu(n.format,u=>t(De(u)?{kind:n.kind}:{...n,format:u}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:f}`}function Iu(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return p`<details class="sub" ?open=${!De(e)}>
    <summary>Format${De(e)?"":" (on)"}</summary>
    <div class="grid2">
  ...
  </details>`}function Au(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return p`
    ...
    ${n.function==="count"?f:pe("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var ml=ga,Hu=ml.filter(([e])=>e!=="none");function Lu(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function fl(e,n){let t=Lu(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return mo(e)?{type:e,...t}:{type:e}}var _u=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function gl(e,n,t,i){let a=n.serviceDataJSON??"",r=fo(a),o=n.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
    ...
    ${al("Data (JSON)",a,s=>{let l={...n};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,t(l,"svc-data")},3)}
    ${r?p`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:p`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function zu(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function yl(e){let n=e.config,t=n.tapAction,i=zu(e.savedName,n.name),a=n.refreshMinutes??0,r=Ks.map(s=>[String(s),Ws(s)]);Ks.includes(a)||r.push([String(a),Ws(a)]);let o=n.showSuccessFlash??!0;return p`
    <div class="gen-row">
      ${pe("Name",n.name,s=>e.update(l=>{l.name=s},"name"))}
      ${Fe("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Fe("Tap action",t.type,ml,s=>e.update(l=>{l.tapAction=fl(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Nu).slice(0,7)}
    ...
    ${t.type==="callService"?gl(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?Pu(e):f}`}var Nu="#808080",Ks=[0,15,30,60,120];function Ws(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Pu(e){let n=e.config;return bl(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function bl(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Fe("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function vl(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return p`
    ...
    <div class="hint">Used by ${js(e.config,n.id)} layer${js(e.config,n.id)===1?"":"s"}.</div>`}function js(e,n){return JSON.stringify(e.elements).split(`"${n}"`).length-1+JSON.stringify(e.perFamily).split(`"${n}"`).length-1}function wl(){return{id:J(),name:"Value",value:I("")}}function Se(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function xe(e,n,t,i,a=!1){let r=e.elements.find(u=>u.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=Se(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function Si(e,n,t,i,a){let r=n.payload.id,o=ei(n)??a.min,s=Se(e.config,t,n).size??o;return ie(`${i} (pt)`,s,l=>e.update(d=>xe(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,...a.def===void 0?{}:{def:a.def}})}function xl(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=Xe()),a=Ve(e,n).filter(l=>!le(e,l));if(a.length===0)return;let r=Yt(e,a.map(l=>l.payload.id),n),o=Et(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let u=s?.placements[l],c=u?.size??ei(d),h={frame:{...u?.frame??d.payload.frame},isHidden:u?.isHidden??!1,...c!==void 0?{size:c}:{}};for(let m of ne)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=wa(h,n,t,d.kind)}Xt(e,t)}function Li(e,n){return Lo(e,n)}function Ou(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function Du(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"?void 0:e.payload.colorSlot.baseColorHex}function kl(e,n,t){let i=Ou(t.map(l=>Se(e,n,l).isHidden)),a=t.map(Du),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var sr=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]];function Vu(e,n,t){let i=n.payload.id,a=ii(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s={...o?{domain:"camera"}:{},needed:qs(n)},l=d=>{let u=e.hass.states[d]?.attributes?.device_class;return typeof u=="string"?u:void 0};return p`
    ${tt(e,o?"Camera":"Entity",r,d=>e.update(u=>_o(u,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint ${qs(n)?"warn":""}">${Uu(n,a)}</div>`}function qs(e){return e.kind==="timeline"?e.payload.value.kind.kind!=="entityState":e.kind==="chart"?e.payload.historyMinutes>0&&e.payload.value.kind.kind!=="entityState":e.kind==="image"?e.payload.entity.entityId==="":!1}function Bu(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function Gu(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Uu(e,n){let t=Bu(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a named value, so change that value in the Data card to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${Gu(o)}.${r}`}function Ku(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function Wu(e,n){let t=e.timestamp===!0,i=We(e),a=r=>n(o=>{r?(o.timestampX=o.timestampCorner.endsWith("Leading")?.16:.84,o.timestampY=o.timestampCorner.startsWith("top")?.16:.84):(We(o)&&(o.timestampCorner=ma(o.timestampX,o.timestampY)),delete o.timestampX,delete o.timestampY)});return p`
    ...
    ${t?p`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:f}`}function Ri(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>Ri(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>Ri(e[a],n[a]))}function Ys(e,n,t){return t.some(i=>!Ri(e[i],n[i]))}function Xs(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Ce(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=()=>e.toggleSection(n),l=p`<span class="swatch">${_(a.icon??"content")}</span>
      <span class="tt"><h4>${t}${il(a.reset===void 0?void 0:{atDefault:!1,title:a.resetTitle??`Put ${t} back to its defaults`,reset:a.reset})}</h4>${a.summary?p`<span class="sum">${a.summary}</span>`:f}</span>`;return p`<section class="sec ${a.cardClass??""}" data-open=${o?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
  ...
  </section>`}function ju(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function qu(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Yu(e,n){let t=he[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Xu(e,n,t){let i=Yu(e,n),a=he[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return p`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Ju(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Zu(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),u=i[i.length-1];u!==void 0&&u.state.trim().toLowerCase()===s.state.trim().toLowerCase()?u.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${qu(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Ii(e){let n=jn.find(o=>o.minutes===e);if(n)return n.label;let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return t>0&&r.push(`${t}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var Mi=new Set;function ir(e,n){return Mi.has(e)||!jn.some(t=>t.minutes===n)}function Js(e,n,t,i){let a=ir(e,n);return p`<label class="field">${nt("Span",{atDefault:n===t&&!a,title:`Back to ${Ii(t)}`,reset:()=>{Mi.delete(e),i(t)}})}
      ...
      </select></label>`}function Zs(e,n){let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=(o,s,l)=>n(Math.min(ra,Math.max(1,Math.round(o)*1440+Math.round(s)*60+Math.round(l))));return p`<div class="grid3 span-parts">
    ...
    <div class="hint">On the ${Z(t)} shape only. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:te.place,icon:"place",summary:`${Math.round(s.width*100)}% wide \xB7 ${Z(t)}`,...i.inline?{alwaysOpen:!0,cardClass:"place-bar",bodyClass:"place-row"}:{},...d?{resetTitle:`Put this layer back to the middle of the ${Z(t)} face at half size, unrotated and shown`,reset:()=>e.update(u=>xe(u,t,a,{frame:{...Ke},isHidden:!1}))}:{}})}function cr(e,n,t={}){let i=t.placeholder;if(i===void 0&&(n===void 0||n.kind==="tap"))return f;let a=n!==void 0&&n.kind!=="tap"?n:void 0,r=a?Te(e.config,a.payload.id)[0]:void 0,o=r===void 0,s=i===void 0&&a!==void 0?op(e,a,`el-${a.payload.id}`):p`
      <label class="field check"><input type="checkbox" disabled .checked=${!1} /><span>Tappable</span></label>
      <div class="hint">${i}</div>`;return Ce(e,"tappable","Tap",s,{color:te.tap,icon:"tap",summary:r?je(r.payload.action):"Not tappable",...t.inline?{alwaysOpen:!0,cardClass:`tap-bar${o?" muted-bar":""}`,bodyClass:"tap-row"}:{},...r&&a?{reset:()=>e.update(l=>ni(l,a.payload.id))}:{}})}function $l(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,x)=>e.update(O=>y(O.elements[r]),x?`${o}-${x}`:void 0),l=Se(e.config,t,n),d=l.frame,u=(y,x)=>e.update(O=>xe(O,t,a,{frame:Ja(d,y)}),`${o}-${x}-${t}`),c=Pe(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",m=y=>c[y],g,v;switch(n.kind){case"text":{let y=ya(e.config,n.payload.value);g=p`
        ${se(e,n.payload.value,x=>s(O=>{O.payload.value=x},"value"),{showResolved:!0,label:"Text",key:`${o}-value`})}
        ...
        ${Me("Live countdown",n.payload.countdown===!0,x=>s(O=>{let G=O.payload;x?G.countdown=!0:delete G.countdown}),c.countdown===!0)}
        ${n.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:f}`,v=p`<div class="grid2">
          ...
          ${ae("Weight",n.payload.fontWeight,sr,x=>s(O=>{O.payload.fontWeight=x}),{def:c.fontWeight})}
        ...
        <div class="hint">An entity source draws that entity's own icon instead.</div>`,v=Si(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let y=n.payload,x=(G,V)=>s(P=>G(P.payload),V),O=y.style==="dots";g=p`
        ${se(e,y.value,G=>x(V=>{V.value=G},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${O?p`
            ${se(e,y.total??Gs(y),G=>x(V=>{V.total=G},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
        ...
        <div class="grid2">
          ${ae("Style",y.style,$u,G=>x(V=>{G==="dots"&&V.total===void 0&&(V.total=Gs(V)),G!=="dots"&&delete V.total,V.style=G}),{titles:Cu,def:c.style})}
          ${O?f:Si(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${oe(O?"Empty dot colour":"Track colour",y.trackColorHex,G=>x(V=>{V.trackColorHex=G??"#FFFFFF40"},"track"),!1,c.trackColorHex)}
        ${ae("Colour",y.coloring,Ds,G=>x(V=>{V.coloring=G,G==="bands"&&V.bands.length===0&&(V.bands=Vs([V.minValue,V.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Bs(y,y.colorSlot.baseColorHex,x)}`:f}
        ${O?f:p`
          <div class="grid2">
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,x=(M,L)=>s(Di=>M(Di.payload),L),O=Tt(y),G=c.historyMinutes,V=c.historyPoints,P=y.historyMinutes>0,U=y.value.kind.kind==="entityState",W=O===void 0?void 0:e.historySeries(O),Ie=P&&U?W??"":e.resolve(y.value)??"",ke=y.historyPoints<1,at=ir(a,y.historyMinutes),q=Mn(Ie),Q=y.limit>0&&q.length>y.limit?y.takeFromEnd?q.slice(q.length-y.limit):q.slice(0,y.limit):q,Ni=!P&&U&&q.length===1,Pi=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),Jl=ge(e),Oi=y.scaleFrom!==void 0&&Pi.some(M=>M.payload.id===y.scaleFrom);g=p`
        ${se(e,y.value,M=>x(L=>{L.value=M},"value"),{label:"Readings",key:`${o}-value`})}
        ${ae("Draw",P?"history":"value",[["history","Recorded history"],["value","The value itself"]],M=>x(L=>{L.historyMinutes=M==="history"?L.historyMinutes||qn:0}),{titles:{history:"Read the entity's past from the recorder and plot it",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${P?p`
            ...
            <div class="grid2">
              ${Js(a,y.historyMinutes,G,M=>x(L=>{L.historyMinutes=M}))}
                ...
                <div class="readings-row">
                  ...
                  ${ke?f:p`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(y.historyPoints)}
                      ...
                      @input=${ve(M=>{let L=Number(M);M.trim()!==""&&Number.isFinite(L)&&L>=1&&x(Di=>{Di.historyPoints=Math.round(L)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${at?Zs(y.historyMinutes,M=>x(L=>{L.historyMinutes=M},"span")):f}
        ...
        ${q.length===0&&!(P&&(!U||W===void 0||W===""))?p`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${q.length>0?p`<div class="hint">Reads <span class="nums">${ju(Q)}</span>${q.length===Q.length?p` · ${Q.length} ${Q.length===1?"value":"values"}`:p` · ${Q.length} of ${q.length}`}</div>`:f}
        ...
        <div class="grid2">
          ${ie("Use",y.limit,M=>x(L=>{L.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:c.limit})}
          ${ae("From",y.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],M=>x(L=>{L.takeFromEnd=M==="end"}),{def:c.takeFromEnd===!0?"end":"start"})}
        </div>
        <div class="hint">${P?"Trims the series after it arrives, so 0 draws every reading fetched above.":"A forecast sensor often carries 24 or 48 entries. 0 draws all of them."}</div>`,v=p`
        <div class="grid2">
          ${ae("Style",y.style,fu,M=>x(L=>{L.style=M}),{def:c.style})}
          ${y.style==="bars"?ie("Bar gap (pt)",y.barGap,M=>x(L=>{L.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:c.barGap}):Si(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${ae("Scale",y.scale,gu,M=>x(L=>{L.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ae("Baseline",y.baseline,yu,M=>x(L=>{L.baseline=M}),{def:c.baseline})}
        </div>
        ${Pi.length===0?f:Fe("Same scale as",Oi?y.scaleFrom:"",[["","Its own"],...Pi.map(M=>[M.payload.id,Re(M,Jl)])],M=>x(L=>{M?L.scaleFrom=M:delete L.scaleFrom}),{def:""})}
        ...
        ${!Oi&&y.scale==="fixed"?p`<div class="grid2">
              ${ie("Min",y.minValue,M=>x(L=>{L.minValue=M??0},"cmin"),{def:c.minValue})}
              ${ie("Max",y.maxValue,M=>x(L=>{L.maxValue=M??100},"cmax"),{def:c.maxValue})}
            </div>`:f}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let M;e.update(L=>{M=Ao(L,a)}),M&&e.selectLayer(M)}}>
          ${_("plus")}<span>Second series</span></button>
        ${ae("Colour",y.coloring,Ds,M=>x(L=>{L.coloring=M,M==="bands"&&L.bands.length===0&&(L.bands=Vs(Q))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Bs(y,y.colorSlot.baseColorHex,x)}
          ${y.style==="area"?p`${Me("Fill follows the bands",y.fillBands,M=>x(L=>{L.fillBands=M}),c.fillBands)}
        ...
        <div class="grid2">
          ${ae("Highlight",y.highlight,cl,M=>x(L=>{L.highlight=M}),{def:c.highlight})}
          ${y.highlight==="none"?f:ae("Marker",y.marker,bu,M=>x(L=>{L.marker=M}),{def:c.marker})}
        </div>
        ${y.highlight==="none"?f:p`
          <div class="grid2">
            ${y.highlight==="lowest"?f:oe("Highest colour",y.highColorHex,M=>x(L=>{L.highColorHex=M??bn},"hicol"),!1,bn)}
            ${y.highlight==="highest"?f:oe("Lowest colour",y.lowColorHex,M=>x(L=>{L.lowColorHex=M??vn},"locol"),!1,vn)}
          </div>
        ...
        ${Me("Threshold line",y.thresholdValue!==void 0,M=>x(L=>{M?L.thresholdValue=vu(Q):delete L.thresholdValue}))}
        ${y.thresholdValue===void 0?f:p`
          <div class="grid2">
            ${ie("At",y.thresholdValue,M=>x(L=>{L.thresholdValue=M??0},"thval"))}
            ${oe("Line colour",y.thresholdColorHex,M=>x(L=>{L.thresholdColorHex=M??Ut},"thcol"),!1,Ut)}
          </div>
        ...
        ${Me("\u201CNow\u201D marker",y.nowIndex!==void 0,M=>x(L=>{M?L.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete L.nowIndex}))}
        ${y.nowIndex===void 0?f:p`
          ${se(e,y.nowIndex,M=>x(L=>{L.nowIndex=M},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${oe("Marker colour",y.nowColorHex,M=>x(L=>{L.nowColorHex=M??Kt},"nowcol"),!1,Kt)}
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=n.payload,x=(q,Q)=>s(Ni=>q(Ni.payload),Q),O=c.historyMinutes,G=y.value.kind.kind==="entityState",V=ht(y),P=V===void 0?void 0:e.historySeries(V),U=Oe(y)*60,W=Rn(P??"",pt),Ie=ir(a,y.historyMinutes),ke=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,at=xu(W,U,ke===void 0?void 0:e.hass.states[ke]?.state,ke?.split(".")[0]);g=p`
        ${se(e,y.value,q=>x(Q=>{Q.value=q},"value"),{label:"States",key:`${o}-value`})}
        ...
        ${Js(a,y.historyMinutes,O,q=>x(Q=>{Q.historyMinutes=q}))}
        ${Ie?Zs(y.historyMinutes,q=>x(Q=>{Q.historyMinutes=q},"span")):f}
        ...
        ${G&&P===void 0?p`<div class="hint">Reading the history…</div>`:f}
        ${G&&P===""?p`<div class="hint warn">Nothing recorded for this entity in that span. Either it is
            excluded from the recorder, or it has not been seen in that long.</div>`:f}
        ${W.length>0?p`<div class="hint">Reads <span class="nums">${Zu(W,U)}</span></div>`:f}
        ${Ju(W)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${ku(y,x,at,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ie("Gap (pt)",y.gap,q=>x(Q=>{Q.gap=Math.min(Xn,Math.max(0,q??0))},"tgap"),{step:.5,min:0,max:Xn,def:c.gap})}
          ${ie("Corner radius (pt)",y.cornerRadius,q=>x(Q=>{Q.cornerRadius=Math.max(0,q??0)},"tradius"),{step:.5,min:0,def:c.cornerRadius})}
        </div>
        ...
        ${Ln("Times",y.timeLabelCount,q=>x(Q=>{Q.timeLabelCount=Math.max(0,Math.min($n,Math.round(q)))},"tlcount"),{min:0,max:$n,step:1,def:c.timeLabelCount,format:q=>q<=0?"None":String(Math.round(q))})}
        ${y.timeLabelCount<=0?f:p`
          <div class="grid2">
            ${ie("Time size (pt)",y.labelSize,q=>x(Q=>{Q.labelSize=Math.min(Sn,Math.max(Cn,q??xn))},"tlsize"),{step:.5,min:Cn,max:Sn,def:c.labelSize})}
            ${oe("Time colour",y.labelColorHex,q=>x(Q=>{Q.labelColorHex=q??kn},"tlcolour"),!1,c.labelColorHex)}
          </div>
          ${ae("Row",y.labelsAbove?"above":"below",[["below","Below"],["above","Above"]],q=>x(Q=>{Q.labelsAbove=q==="above"}),{def:c.labelsAbove===!0?"above":"below"})}
          ${ae("Clock",y.hourCycle,so,q=>x(Q=>{Q.hourCycle=q}),{titles:{auto:"Whatever clock the watch is set to"},def:c.hourCycle})}
          ${ae("Minutes",y.minutes,lo,q=>x(Q=>{Q.minutes=q}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:c.minutes})}
        ...
        ${n.payload.kind==="line"?Xu(t,d,u):f}`,v=n.payload.kind==="line"?ie("Thickness (pt)",n.payload.thickness,y=>s(x=>{x.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        ${n.payload.borderColorHex!==void 0?ie("Border width (pt)",n.payload.borderWidth,y=>s(x=>{x.payload.borderWidth=y??1},"bw"),{step:.5,min:0,def:c.borderWidth}):f}`;break;case"image":{let y=n.payload,x=(P,U)=>s(W=>P(W.payload),U),O=y.entity.entityId?e.hass.states[y.entity.entityId]?.attributes?.entity_picture:void 0,G=typeof O=="string"?O:void 0,V=G!==void 0&&!G.startsWith("/");g=p`
        ${ae("Source",y.source,[["camera","Camera"],["entityPicture","Entity picture"]],P=>x(U=>{U.source=P}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:c.source})}
        ${y.source==="camera"?p`
        ...
        ${ae("Picture",y.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],P=>x(U=>{U.contentMode=P}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:c.contentMode})}
        ${Ln("Zoom",y.zoom,P=>x(U=>{U.zoom=P},"zoom"),{min:Oa,max:4,step:.05,def:1,format:P=>`${P.toFixed(2)}x`})}
        ${Ln("Pan left/right",y.panX,P=>x(U=>{U.panX=P},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${Ln("Pan up/down",y.panY,P=>x(U=>{U.panY=P},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class="hint">${Ku(y)}</div>
        ${ie("Corner radius (pt)",y.cornerRadius,P=>x(U=>{U.cornerRadius=Math.max(0,P??Wt)},"imgradius"),{step:1,min:0,def:Wt})}`;break}case"tap":{g=p`
        ${Cl(e,n.payload,(y,x)=>s(O=>y(O.payload),x),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let $=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:oe(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>s(x=>{x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,h),S=$a(e.config,n),E=S?{kind:{kind:"entityState",...S}}:void 0,w=me[n.kind],C=n.kind==="image"?n.payload.timestamp===!0:!1,N=ep[n.kind],B=tp[n.kind],X=Ys(n.payload,c,N),de=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,k=e.config.perFamily[t]?.placements[a]?.size!==void 0,F=Ys(n.payload,c,B)||de!==void 0&&l.size!==void 0&&l.size!==c[de],D=Ft(e.config,a),z=(y,x)=>()=>s(O=>Xs(O.payload,c,y),x);return p`
    ${Ce(e,"content","Content",p`${n.kind==="tap"?f:Vu(e,n,o)}${g}`,{color:w,icon:"content",summary:lr(e,n),...X?{reset:z(N,"reset-content")}:{}})}
    ${v===void 0&&$===void 0?f:Ce(e,"look",n.kind==="image"?"Picture":"Look",p`${v??f}${$??f}`,{color:w,icon:n.kind==="image"?"image":"look",...Ai(n)?{summary:Ai(n)}:{},...F?{reset:()=>e.update(y=>{Xs(y.elements[r].payload,c,B),k&&xe(y,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Ce(e,"numbers","Numbers",rp(e,n),{color:me.text,icon:"text",summary:ap(e,n),...D.length>0?{reset:()=>e.update(y=>{for(let x of Ft(y,a))Je(y,x.payload.id)})}:{}}):f}
    ${n.kind==="image"?Ce(e,"timestamp","Timestamp",Wu(n.payload,(y,x)=>s(O=>y(O.payload),x)),{color:w,icon:"clock",summary:C?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...C?{reset:z(Qu,"reset-stamp")}:{}}):f}
    ${i.tap===!1?f:cr(e,n)}
    ${Ce(e,"states","States",Il(e,n.payload.rules,n.kind,y=>y.elements.find(x=>x.payload.id===a)?.payload.rules,`rules-${a}`,E),{color:te.states,icon:"states",summary:An(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(y=>{y.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:dr(e,n,t)}`}var Qu=["timestamp","timestampCorner","timestampSize"],ep={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},tp={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function Cl(e,n,t,i){let a=n.action;return p`
    ${Fe("Tap action",a.type,Hu,r=>t(o=>{o.action=fl(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?tt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?gl(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?bl(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var np=24;function ip(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Ro(e.config,n,r);o&&(t.push(`${Z(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<np;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function ap(e,n){let t=Ft(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Bt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function rp(e,n){let t=ge(e),i=Ft(e.config,n.payload.id),a=o=>e.update(s=>{$o(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    ${a?p`<div class="value-editor">
        ...
        ${ip(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${je(o)}</b>.</div>`}`}function Qs(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Re(e,n){switch(e.kind){case"text":return Qs(fe(e.payload.value,n));case"icon":return Qs(fe(e.payload.symbol,n));case"gauge":return fe(e.payload.value,n);case"chart":return fe(e.payload.value,n);case"timeline":return fe(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function Sl(e,n){let t=Ye(e.config,n.id),i=ge(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Ce(e,"content","Group",p`
    ...
    </div>`,{color:te.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function El(e,n){if(n==="inline")return sp(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${Z(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Z(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=Li(e.config,n),r=t.backgroundColorHex?$e(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${$e(t.borderColorHex)} border`:"no border";return p`
    ${Ce(e,"look",`${Z(n)} shape`,p`
    ...
    ${Ce(e,"symbol","Symbol",p`
      ...
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:me.icon,icon:"icon",summary:n.symbol||"None"})}`}function lp(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ${ae("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=I("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ae("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=I("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:I("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    ${a==="gauge"&&n.bezelGauge?dp(e,n.bezelGauge,t):f}`}function dp(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${Me("End number labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=I(String(s.minValue)),s.maxLabel=I(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?se(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):f}
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var tf=ne.map(e=>[e,Z(e)]),ur={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},cp=Object.keys(ur);function up(e){let n=ai[e];return cp.filter(t=>n.includes(Ee[t]))}var pp={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Ei(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function gt(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function hp(e){if(!e||De(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function fe(e,n){return`${Tl(e,n)}${hp(e.format)}`}function Tl(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${gt(t.value,40)}"`:"(empty)";case"entityState":return Ei(t,n);case"entityAttribute":return t.attribute?`${Ei(t,n)} \xB7 ${t.attribute}`:Ei(t,n);case"entityAge":return`age of ${Ei(t,n)}`;case"aggregate":return mp(t.aggregate);case"time":return pp[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${gt(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Bt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Tl(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function mp(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Hi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function fp(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${n.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${t==="layout"?"family":"layer"} looks.</div>`:f}
    ${n.map((o,s)=>gp(e,o,s,n.length,t,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Fn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function gp(e,n,t,i,a,r,o){let s=e.liveBranch(n),l=e.forced.get(n.id)??"live",d=c=>l==="live"?c==="live":l==="otherwise"?c==="otherwise":l.caseId===c,u=(c,h)=>r(m=>{let g=m.find(v=>v.id===n.id);g&&c(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${n.cases.map((c,h)=>yp(e,c,h,n,a,u,`${o}-${c.id}`))}
    ...
    ${n.otherwise?p`<div class="case-box otherwise">
          ...
          ${Fl(e,n.otherwise,a,c=>u(h=>{h.otherwise&&c(h.otherwise)}),`${o}-otherwise`)}
        </div>`:f}
  </div>`}function yp(e,n,t,i,a,r,o){let s=(d,u)=>r(c=>{let h=c.cases.find(m=>m.id===n.id);h&&d(h)},u),l=e.liveBranch(i)===n.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((d,u)=>bp(e,d,u,c=>s(h=>{let m=h.when.tests.find(g=>g.id===d.id);m&&c(m)}),()=>s(c=>{c.when.tests=c.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    ...
    ${Fl(e,n.then,a,d=>s(u=>d(u.then)),`${o}-then`)}
  </div>`}function bp(e,n,t,i,a,r){let o=(c,h)=>i(c,h?`${r}-${h}`:void 0),s=n.comparison,l=Mt(s.kind),d=e.evaluateTest(n),u=f;switch(l){case"value":u=se(e,s.value??I(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":u=p`${se(e,s.value??I(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${se(e,s.upper??I(""),c=>o(h=>{h.comparison.upper=c},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":u=p`${pe("Pattern",s.pattern??"",c=>o(h=>{h.comparison.pattern=c},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!vp(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"options":u=pe("Options (comma separated)",(s.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${Fe("Comparison",s.kind,zo.map(c=>[c,tn[c]]),c=>o(h=>{h.comparison=Fa(h.comparison,c)}))}
    ${u}
  </div>`}function vp(e){try{return new RegExp(e),!0}catch{return!1}}function Fl(e,n,t,i,a){let r=up(t);return p`
    ${n.length===0?p`<div class="hint">No changes.</div>`:f}
    ${n.map((o,s)=>wp(e,o,s,t,(l,d)=>i(u=>{u[s]&&l(u[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Rt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${ur[o]}</option>`)}
    </select>`}var Ml=["setColor","setBorderColor","setBackgroundColor"];function wp(e,n,t,i,a,r,o){let s=!ai[i].includes(Ee[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${Rl(e,n,a,o)}
  </div>`}function Rl(e,n,t,i){let a=ri(n.kind),r=f;if(a==="value"){let o=n.value??I("");if(Ml.includes(n.kind)){let s=o.kind.kind==="literal";r=p`${s?oe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=I(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${fp(e,n,t,i,a)}`:xp(e,o.table,n[0],t,i,a,r)}function xp(e,n,t,i,a,r,o){let s=(k,F)=>e.update(D=>{let z=a(D);z&&k(z)},F?`${r}-${F}`:void 0),l=n.value??el.get(r)??o,d=n.rows.length===0,u=n.numberMode||d&&l!==void 0&&!Ms(l)&&kp(e.resolve(l)),c=ai[i],h=Ti.get(r)??new Set,m=n.columns.length===0&&h.size===0?[Fs[i]]:[],g=vs(n.columns,[...h,...m.filter(k=>k!==void 0)],c),v=t?e.liveBranch(t):"none",$=t?e.forced.get(t.id)??"live":"live",S=k=>$!=="live"&&($==="otherwise"?k==="otherwise":$.caseId===k),E=k=>{t&&e.setForced(t.id,S(k)?"live":k==="otherwise"?"otherwise":{caseId:k})},w=k=>{el.set(r,k),n.rows.length!==0&&s(F=>Ss(F,k),"lhs")},C=()=>s(k=>$s(k,l??I(""),u)),N=n.rows.map((k,F)=>nl(e,{key:`${r}-${k.caseId}`,label:Ts(k.comparison,D=>fe(D,ge(e))),columns:g,changes:k.changes,live:v===k.caseId,forced:S(k.caseId),onForce:()=>E(k.caseId),when:Tp(e,k.comparison,`${r}-${k.caseId}`,(D,z)=>s(y=>{let x=y[0]?.cases.find(O=>O.id===k.caseId)?.when.tests[0];x&&D(x.comparison)},z&&`${k.caseId}-${z}`)),updChanges:(D,z)=>s(y=>{let x=y[0]?.cases.find(O=>O.id===k.caseId);x&&D(x.then)},z&&`${k.caseId}-${z}`),acts:p`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>s(D=>Cs(D,k.caseId))}>${_("delete")}</button>`})),B=n.otherwise===void 0?f:nl(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:v==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(k,F)=>s(D=>{let z=D[0]?.otherwise;z&&k(z)},F),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(k=>Ya(k,!1))}>${_("close")}</button>`}),X=Fi.get(r),de=$p.filter(k=>c.includes(k)&&!g.includes(k));return p`
    <div class="states">
      ${se(e,l??I(""),w,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ...
      ${X===void 0?f:p`<div class="hint warn confirm-row">
        Remove the ${et[X]} column? Its ${tl(n,X)} value${tl(n,X)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${k=>{Fi.delete(r),Ti.get(r)?.delete(X),Ae(k.target),s(F=>Es(F,X))}}>Remove</button>
      ...
      <div class="states-foot">
        ...
        ${de.length===0?f:p`<select class="chip-add" title="Add a column" @change=${k=>{let F=k.target,D=F.value;if(F.value="",!D)return;let z=Ti.get(r)??new Set;z.add(D),Ti.set(r,z),Ae(F)}}>
    ...
    </div>`}function kp(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var $p=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function tl(e,n){let t=0;for(let i of e.rows)wi(i.changes,n)&&(t+=1);return e.otherwise&&wi(e.otherwise,n)&&(t+=1),t}function Cp(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function nl(e,n){return p`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{Cp(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>p`<td>${Sp(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Sp(e,n,t,i,a){let r=wi(t,n),o=or(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${et[n]} for this state`}
      @click=${d=>{i(u=>{u.push(Rt(bs[n]))}),Mu(d.target,o)}}>unchanged</button>`;let s=(d,u)=>i(c=>{let h=c.find(m=>Ee[m.kind]===n);h&&d(h)},u&&`${n}-${u}`),l=et[n];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Ep(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${pl}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${_n.has(o)?p`${n==="visibility"?ae("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(u=>{u.kind=d})):Rl(e,r,s,a)}
    ...
    </div>`}function Ep(e,n){if(n.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return p`<span class="cell-word">Shown</span>`;let t=ri(n.kind);if(t==="number")return p`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return p`<span class="cell-word">${sr.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??I(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Ml.includes(n.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?$e(a):fe(i,ge(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??f}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${fe(i,ge(e))}</span>`}function $e(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Tp(e,n,t,i){let a=Mt(n.kind),r=Wa(n.kind),o=(s,l,d,u)=>Mp(e,s,l,`${t}-${d}`,r,u,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ve(s=>i(l=>{let d=Fa(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Ka.map(s=>p`<option value=${s} ?selected=${s===n.kind}>${Fp(s)}</option>`)}
    </select>
  ...
  </span>`}function Fp(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return tn[e]}}function Mp(e,n,t,i,a,r,o){let s=or(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return p`<span class="rhs">
    ...
    ${ul(e,s,o,n,t,l)}
  </span>`}var zn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:ka,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function _l(e){return zn.find(n=>n.kind===e)??zn[0]}var Al="#FF9F0A",_i="#8E8E93",Rp=["#FF453A","#FFD60A","#34C759"],zl=["#0A84FF","#34C759","#FF9F0A"];function Ip(e){return e?.attributes?.device_class==="battery"?Rp:zl}var Ap={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Hp(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Ap[pr(e)]??{off:"circle",on:"circle.fill"}}function Lp(e){switch(pr(e)){case"lock":return{kind:"equals",value:I("locked")};case"cover":case"valve":return{kind:"equals",value:I("open")};case"media_player":return{kind:"equals",value:I("playing")};default:return{kind:"isOn"}}}function pr(e){return e.domain||e.entityId.split(".")[0]||""}function vt(e){return{...e,domain:pr(e)}}function _p(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function rn(e){return Math.round(e*1e4)/1e4}function Nt(e,n,t){return Math.min(t,Math.max(n,e))}function hr(e,n,t){let i=be[e],a=Nt(rn(n/i.width),0,1),r=Nt(rn(t/i.height),0,1);return{x:rn((1-a)/2),y:rn((1-r)/2),width:a,height:r,rotationDegrees:0}}function zp(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:hr(e,t*1.3,t*1.3),size:t}}function Np(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:hr(e,n.width*.88,t*1.7),size:t}}function Pp(e){let n=be[e],t=Math.min(n.width,n.height)*.9;return{frame:hr(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Nl(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Op(e){let n=be[e],t=Nt(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:rn(t/n.height),rotationDegrees:0}}}function Dp(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:rn(Nt(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Vp(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Bp(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function yt(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Bp(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Xe());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function bt(e){return Pe(e)}function mr(e,n){let t={kind:{kind:"entityState",...vt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Hl(e){let n=Rt("setIcon");return n.value=I(e),n}function zt(e){let n=Rt("setColor");return n.value=I(e),n}function Gp(e,n){let t=Fn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...vt(e)}},a.comparison=Lp(e);let r=n.on!==n.off;return i.then=r?[Hl(n.on),zt(Al)]:[zt(Al)],t.otherwise=r?[Hl(n.off),zt(_i)]:[zt(_i)],t}function Up(e){let n=Fn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...vt(e)}},i.comparison={kind:"isUnavailable"};let a=Rt("setOpacity");return a.number=.35,t.then=[a],n}function Ll(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Kp(e,n,t=zl){let i=n.max-n.min,a=Ll(n.min+i/3),r=Ll(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:I(a)},changes:[zt(t[0])]},{comparison:{kind:"between",value:I(a),upper:I(r)},changes:[zt(t[1])]},{comparison:{kind:"greaterThan",value:I(r)},changes:[zt(t[2])]}];return ws(mr(e),o)}function Wp(e,n,t){let i=bt("icon"),a=Hp(n);return i.payload.symbol=I(a.off),i.payload.colorSlot.baseColorHex=_i,i.payload.rules=[Gp(n,a)],yt(e,i,t.family,zp),e.elements.push(i),ti(e,i.payload.id,{type:"toggleEntity",...vt(n)}),i.payload.id}function jp(e,n,t){let i=bt("text");return i.payload.value=mr(n,t.state),i.payload.rules=[Up(n)],yt(e,i,t.family,Np),e.elements.push(i),i.payload.id}function qp(e,n,t){let i=bt("gauge");i.payload.value=mr(n);let a=_p(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Kp(n,a,Ip(t.state))],yt(e,i,t.family,Pp),e.elements.push(i),i.payload.id}function Yp(e,n,t){let i=bt("chart");return i.payload.value={kind:{kind:"entityState",...vt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",yt(e,i,t.family,Nl),e.elements.push(i),i.payload.id}function Xp(e,n,t){let i=bt("chart");return i.payload.value={kind:{kind:"entityState",...vt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",yt(e,i,t.family,Nl),e.elements.push(i),i.payload.id}function Jp(e,n,t){let i=vt(n),a=bt("text");a.payload.value=I(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=_i,yt(e,a,t.family,Dp),e.elements.push(a);let r=t.state?.attributes?.device_class,o=bt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=ha(i.domain,typeof r=="string"?r:void 0),yt(e,o,t.family,Op),e.elements.push(o),o.payload.id}function Zp(e,n,t){let i=bt("image");return i.payload.entity=vt(n),yt(e,i,t.family,Vp),e.elements.push(i),i.payload.id}function Pl(e,n,t,i){switch(n){case"toggle":return Wp(e,t,i);case"status":return jp(e,t,i);case"gauge":return qp(e,t,i);case"chart":return Yp(e,t,i);case"history":return Xp(e,t,i);case"doorHistory":return Jp(e,t,i);case"camera":return Zp(e,t,i)}}var eh=3e4,th=500,nh=3e4,Ol="preset-entity",ih={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function fr(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function ah(e){return e.kind==="family"?"look":"content"}function gr(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Dl(){return p`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function rh(e){let n=b`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?b`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?b`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?b`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:b`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return p`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Vl=300,Bl=360,Gl=44,Ul=22,oh=[1,1.7,2.6],sh=["S","M","L"],Kl=["Small","Medium","Large"],Wl="wrist-assistant-panel.layers.v1",it=34,Pt=200,lh=720,zi=320,dh=80,ch=56,jl="wrist-assistant-panel.columns.v2",yr=e=>Math.max(Pt,Math.min(lh,Math.round(e))),ql=e=>e.metaKey||e.ctrlKey||e.shiftKey,uh=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Nn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",wt=Nn==="Cmd"?"\u2318":"Ctrl+",br=Nn==="Cmd"?"\u21E7":"Shift+";function Yl(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-dh;if(i>=Pt*2+zi){let r=i-zi,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Pt,Math.floor(o*l)),s=Math.max(Pt,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Pt,o-d):s=Math.max(Pt,s-d))}return{columns:3,left:o,right:s}}let a=e-ch;return a>=Pt+zi?{columns:2,left:Math.min(n,a-zi),right:t}:{columns:1,left:n,right:t}}var R=class R extends ot{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Vl;this.colRight=Bl;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.pickerFilter="all";this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.recordPreviews=new Map;this.previewCase=Zt.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=ps(()=>this.requestUpdate());this.imageSizes=hs(()=>this.requestUpdate());this.symbols=new gi(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new vi;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||ll(Ol)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Bi`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},nh)}loadColumnWidths(){try{let t=window.localStorage.getItem(jl);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=yr(i.left)),typeof i.right=="number"&&(this.colRight=yr(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(jl,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Wl);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Wl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>xl(s,o,i))}>Copy the ${Z(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(t){this.mutate(i=>rs(i,t)),this.activeFamily=t,this.inspect={kind:"family"}}removeShape(t){let i=this.draft?.config;if(!i||!mi(i,t))return;let a=ss(i,t);a.length>0&&!window.confirm(`Remove the ${Z(t)} shape? This deletes ${a.join(", ")}. They are on this shape only, so nothing else in the complication loses anything.`)||(this.mutate(r=>os(r,t)),this.ensureActiveFamily())}createNew(){let t=this.newFamily,i=this.newName.trim();!t||i===""||this.newNameProblem()!==void 0||(this.closeNewDialog(),this.startNew(Eo(i,this.freeSlot(),[t])))}setForced(t,i){let a=new Map(this.forced);i==="live"?a.delete(t):a.set(t,i),this.forced=a}async save(t=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!t&&!this.draft.dirty)){if(!t&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(t){let o=this.freeSlot();if(o<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let s=structuredClone(i.config);s.id=J(),s.slotIndex=o,i=new Ht(s,null)}let a=i.encoded(),r=await Dr(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id,this.draft=Ht.fromDocument(r.record.document,r.record.revision),this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=xt(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let t=await Vr(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!t.ok){t.error==="conflict"?this.conflict={current:t.current??null,message:t.message??"This complication changed on the server."}:this.saveError=t.message??t.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(t){this.saveError=xt(t)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let t=structuredClone(this.draft.config);t.id=J(),t.name=`${t.name} copy`,t.slotIndex=this.freeSlot(),this.startNew(t)}reloadFromServer(){let t=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,t&&!t.deleted?this.openRecord(t):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(t=>t.owner_watch_id===this.ownerId)}async moveAll(){let t=this.ownerId,i=this.moveTarget;if(!(!t||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await Br(this.hass,t,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=xt(a)}finally{this.moving=!1}}}scheduleTemplates(t){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},t),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},eh)}async refreshHistorySeries(){let t=this.draft?.config,i=t?la(t):[];if(i.length===0){this.historySeries.size>0&&(this.historySeries=new Map);return}let a={};for(let r of i)a[r.key]={entity_id:r.entityId,minutes:r.minutes,points:r.points,...r.mode==="states"?{mode:"states"}:{}};try{let r=await Kr(this.hass,a),o=new Map;for(let[s,l]of Object.entries(r))l.ok&&o.set(s,l.series);this.historySeries=o}catch{}}async refreshTemplates(){this.refreshHistorySeries();let t=this.compiled?.document;if(!t){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await Ur(this.hass,{doc:t})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=Bo(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=xt(i)}}entityStateFor(t,i,a){let r=this.hass.states[t];if(!r)return;let o=r.attributes,s=t.split(".")[0]??"",l={entityId:t,state:(a?this.testValues.get(t):void 0)??r.state,unitOfMeasurement:typeof o.unit_of_measurement=="string"?o.unit_of_measurement:void 0,iconName:i,domain:s};if(s==="timer"){l.timerState=r.state,typeof o.finishes_at=="string"&&(l.finishesAt=o.finishes_at);let d=ph(o.remaining);d!==void 0&&(l.remaining=d)}return typeof o.entity_picture=="string"&&(l.entityPicture=o.entity_picture),l}buildContext(){let t=new Map;for(let[i,a]of this.compiled?.entities??[]){let r=this.entityStateFor(i,a.iconName??"",!0);r&&t.set(i,r)}return{entityStates:t,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:this.draft?.config.values??[],dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3}}renderPickButton(){let t=this.picking,i=!this.draft||this.parseError!==void 0;return p`<button class="pick ${t?"on":""}" ?disabled=${i}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Sa(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let S=this.focusTapId();if(S!==void 0&&o===S&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,S,r??void 0);return}let E=this.hitLayerId(i);E?this.inspect={kind:"layer",id:E}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let u=ql(i);if(!u&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let c=Sa(this.draft.config,o),h=this.draft.config.elements.find(S=>S.payload.id===c);if(!c||!h)return;if(u){i.preventDefault(),this.togglePick(c);return}let m=qe(this.draft.config,c),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==c)&&(this.inspect={kind:"layer",id:c},r))return;i.preventDefault();let v=Se(this.draft.config,t,h).frame,$=this.gestureCanvas(t);if(d&&h.kind==="image"&&h.payload.timestamp===!0){this.timestampActiveId=c;let S=h.payload,E=he[t],w=v.width*E.width,C=v.height*E.height,N={x:0,y:0,w,h:C,cx:w/2,cy:C/2},B=ui(S,N,ci(new Date));if(this.cancelGesture?.(),l){let F=$.width/E.width,D=S.timestampSize;this.cancelGesture=_s(s,i,l,{w:B.w*F,h:B.h*F},(z,y)=>{let x=Math.min(40,Math.max(4,Math.round(D*z)));this.mutate(O=>{let G=O.elements.find(V=>V.payload.id===c);G?.kind==="image"&&(G.payload.timestampSize=x)},`ts-size-${c}`),y&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let X={x:0,y:0,w:v.width*$.width,h:v.height*$.height},de=We(S)?{x:S.timestampX,y:S.timestampY}:{x:(B.x+B.w/2)/N.w,y:(B.y+B.h/2)/N.h},k=!1;this.cancelGesture=Ls(s,X,i,de,(F,D,z)=>{z||(k=!0),k&&this.mutate(y=>{let x=y.elements.find(O=>O.payload.id===c);x?.kind==="image"&&(x.payload.timestampX=F,x.payload.timestampY=D)},`ts-${c}`),z&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=ki(s,$,i,{elementId:c,frame:v,handle:r??void 0},{onFrame:(S,E,w)=>{this.mutate(C=>xe(C,t,S,{frame:E}),`drag-${S}-${t}`),w&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=Ye(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map($=>[$.payload.id,Se(o,t,$).frame])),d=[...l.values()],u=Math.min(...d.map($=>$.x)),c=Math.min(...d.map($=>$.y)),h=Math.max(...d.map($=>$.x+$.width)),m=Math.max(...d.map($=>$.y+$.height)),g={x:u,y:c,width:h-u,height:m-c,rotationDegrees:0},v=$=>Math.round($*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=ki(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:($,S,E)=>{let w=S.x-g.x,C=S.y-g.y;this.mutate(N=>{for(let[B,X]of l)xe(N,t,B,{frame:{...X,x:v(X.x+w),y:v(X.y+C)}})},`drag-group-${r.id}-${t}`),E&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?As:1,s=t*o,l=i*o,d=this.canvasFamily,u=he[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,u,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let $=this.inspect.id;return this.nudgeMany(Ye(r,$).map(S=>S.payload.id),d,u,`nudge-group-${$}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let c=this.inspect.id,h=r.elements.find($=>$.payload.id===c);if(!h)return!1;let m=qe(r,c);if(m?.locked)return this.nudgeMany(Ye(r,m.id).map($=>$.payload.id),d,u,`nudge-group-${m.id}-${d}`,s,l);let g=Se(r,d,h).frame,v=Qa(g,s,l,u);return(v.x!==g.x||v.y!==g.y)&&this.mutate($=>xe($,d,c,{frame:v}),`nudge-${c}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,u=new Map;for(let C of t){let N=l.elements.find(B=>B.payload.id===C);N&&u.set(C,Se(l,i,N).frame)}if(u.size===0)return!1;let c=[...u.values()],h=Math.min(...c.map(C=>C.x)),m=Math.min(...c.map(C=>C.y)),g=Math.max(...c.map(C=>C.x+C.width)),v=Math.max(...c.map(C=>C.y+C.height)),$={x:h,y:m,width:g-h,height:v-m,rotationDegrees:0},S=Qa($,o,s,a),E=S.x-$.x,w=S.y-$.y;return(E!==0||w!==0)&&this.mutate(C=>{for(let[N,B]of u)xe(C,i,N,{frame:{...B,x:d(B.x+E),y:d(B.y+w)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find($=>$.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=he[i],u=Se(o,i,s).frame,c=u.width*d.width,h=u.height*d.height,m=ui(l,{x:0,y:0,w:c,h,cx:c/2,cy:h/2},ci(new Date)),g=We(l)?{x:l.timestampX,y:l.timestampY}:{x:c>0?(m.x+m.w/2)/c:.5,y:h>0?(m.y+m.h/2)/h:.5},v=Hs(g,a,r,{w:c,h});return(v.x!==g.x||v.y!==g.y)&&this.mutate($=>{let S=$.elements.find(E=>E.payload.id===t);S?.kind==="image"&&(S.payload.timestampX=v.x,S.payload.timestampY=v.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=di(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Da(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Te(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(c=>c.payload.id===r);if(!s||!l)return;let d=le(s,l),u=Se(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=ki(a,this.gestureCanvas(t),i,{elementId:r,frame:u,handle:o},{onFrame:(c,h,m)=>{this.mutate(g=>{d?Mo(g,c,t,h):xe(g,t,c,{frame:h})},`tap-box-${c}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Yl(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return p`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>p`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${Xl(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Dl()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?p`<span class="hor" aria-hidden="true">or</span>${Dl()}`:f}
      ...
      ${this.watchSupported?p`<div class="layout cols-${a.columns}"
          ...
          ${this.renderFooter()}`:p`<div class="card">
            <div class="banner warn"><b>Update the watch app first.</b> ${cs(this.selectedOwner?.app_version)}</div>
      ...
      ${a("all","All",t.length)}
      ${At.map(r=>a(r,Z(r),t.filter(o=>i(o).includes(r)).length))}
      ...
      ${this.pickerOpen?p`<div class="menu" role="listbox">
        ${o.length>=R.FILTER_FROM_ROWS?this.renderPickerFilter(o):f}
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Xl(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:p`<span class="mini">${Ba.length} kinds · ${zn.length} presets</span>`}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(k,d)}</b>
          <small><span class="kind">${en[k.kind]}</span> · ${fh(k,u,this.historySeries,x.size)}</small>
          ${C?p`<span class="facts">${hh(this.host(),a,k,x).map(W=>p`<span class="fact"><b>${W.label}</b> ${W.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ...
            ${O?p`<span class="badge">hidden</span>`:f}
          </span>
          ${i?p`<span class="acts">
            <button class="icon" title=${`Bring forward (${wt}])`} aria-label="Bring forward" @click=${W=>{W.stopPropagation(),r(z,1)}}>${_("up")}</button>
            <button class="icon" title=${`Send back (${wt}[)`} aria-label="Send back" @click=${W=>{W.stopPropagation(),r(z,-1)}}>${_("down")}</button>
            <button class="icon" title=${`${x.isHidden?"Show":"Hide"} (${br}${wt}H)`} aria-label=${x.isHidden?"Show this layer":"Hide this layer"} @click=${W=>{W.stopPropagation(),this.mutate(Ie=>xe(Ie,a,z,{isHidden:!x.isHidden}))}}>${_(x.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${wt}D)`} aria-label="Duplicate" @click=${W=>{W.stopPropagation(),o(z)}}>${_("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${W=>{W.stopPropagation(),s(z)}}>${_("delete")}</button>
          </span>`:f}
        </span>
      </div>`},B=(k,F)=>{let D=this.inspect.kind==="group"&&this.inspect.id===k.id,z=!this.collapsed.has(k.id),y=this.rowDrag(k.id,i),x=F[0],O=F[F.length-1],G=P=>{let U=P.currentTarget,W=U.getBoundingClientRect(),Ie=W.top+(U.classList.contains("drop-before")?it:0),ke=W.bottom-(U.classList.contains("drop-after")?it:0),at=(P.clientY-Ie)/Math.max(1,ke-Ie);return at<.25?"drop-before":!z&&at>.75?"drop-after":"drop-into"},V=F.map(P=>P.payload.id);return p`<div class="layer group ${D?"hl":""} ${C?"rich":""}" style=${`--k:${te.group}`} tabindex="0" draggable=${y.draggable}
        @pointerenter=${()=>{this.listHoverIds=V}}
        @pointerleave=${()=>this.leaveRow(V)}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:k.id}}}
        @keydown=${P=>{P.key==="Enter"&&(this.inspect={kind:"group",id:k.id})}}
        @dragstart=${y.onStart} @dragend=${y.onEnd}
        @dragover=${P=>{!this.dragId||this.dragId===k.id||(P.preventDefault(),this.markDrop(P.currentTarget,G(P)))}}
        @drop=${P=>{P.preventDefault();let U=G(P);this.clearDragMarks();let W=this.dragId;if(this.dragId=void 0,!(!W||!x||!O)){if(U==="drop-before"){this.reorderLayer(W,x.payload.id,!0,!0);return}if(U==="drop-after"){this.reorderLayer(W,O.payload.id,!1,!0);return}this.isGroupId(W)||(this.reorderLayer(W,x.payload.id,!0),this.mutate(Ie=>va(Ie,W,k.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${F.map(P=>Re(P,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${br}${wt}G)`} aria-label="Ungroup" @click=${P=>{P.stopPropagation(),this.mutate(U=>En(U,k.id)),D&&(this.inspect={kind:"general"})}}>${_("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${k.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${P=>{P.stopPropagation(),this.mutate(U=>{let W=U.groups?.find(Ie=>Ie.id===k.id);W&&(W.locked=!W.locked)})}}>${_(k.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${z?"true":"false"} title=${z?"Fold the group":"Unfold the group"}
            @click=${P=>{P.stopPropagation();let U=new Set(this.collapsed);z?U.add(k.id):U.delete(k.id),this.collapsed=U}}>${_("chevron")}</button>
        </span>
      </div>`},X=[],de=new Set;for(let k=0;k<l.length;k++){let F=l[k],D=F.payload.groupId,z=D===void 0?void 0:t.groups?.find(O=>O.id===D);if(!z){X.push(N(F,!1));continue}if(de.has(z.id))continue;de.add(z.id);let y=l.filter(O=>O.payload.groupId===z.id);X.push(B(z,y));let x=this.inspect.kind==="group"&&this.inspect.id===z.id;this.collapsed.has(z.id)||X.push(p`<div class="group-kids">${y.map(O=>N(O,!0,x))}</div>`)}return p`<div class="card layers-card" style=${`--thumb-w:${S}px;--thumb-h:${E}px`}>
      <h2 class="panel-title tools" style=${`--c:${te.place}`}><span class="swatch">${_("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${sh.map((k,F)=>p`
              <button class=${this.thumbStep===F?"on":""} title=${`${Kl[F]} row pictures`}
                aria-label=${`${Kl[F]} row pictures`} aria-pressed=${this.thumbStep===F?"true":"false"}
      ...
      ${g>=2&&i?p`<div class="group-cta"><span>${g} layers picked</span><span class="spacer"></span>
            ...
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?p`<div class="hint">${Nn}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:f}
      ...
      <div class="layer pinned ${h?"hl":""}" style=${`--k:${te.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${k=>{k.preventDefault(),this.clearDragMarks();let F=this.dragId,D=[...l].reverse().find(z=>z.payload.id!==F&&z.payload.groupId!==F);F&&D&&this.reorderLayer(F,D.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?_l(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Pl(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=si(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`
      ...
      <div class="settings inline" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${yl(t)}</div>
      <span class="spacer"></span>
      <span class="acts">
      ...
      <h2 class="panel-title"><span class="swatch">${_("content")}</span>Shared values
        ...
        <span class="spacer"></span>
        ${this.canEdit?p`<button class="small" @click=${()=>{let o=wl();this.mutate(s=>{s.values.push(o)}),this.inspect={kind:"data",id:o.id}}}>Add</button>`:f}
      </h2>
      ...
      ${l===f?f:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=f,s=!0;if(r.kind==="layer"){let d=t.elements.find(u=>u.payload.id===r.id);if(!d)return this.inspect={kind:"general"},f;o=$l(a,d,this.canvasFamily,{placement:!1,tap:!1})}else if(r.kind==="group"){let d=t.groups?.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=Sl(a,d)}else if(r.kind==="data"){let d=t.values.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${te.complication}`}>
        ...
        <div class="sec-b">${vl(a,d)}</div>
      </div>`}else r.kind==="family"?o=El(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${_("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([ah(r)]):new Set(rr)}}>${l?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <span>${t}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:f}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=ge(this.host()),o=new Qe(this.buildContext(),this.draft?.config),s=kl(t,a,i),l=i.length,d=[...i].reverse(),u=h=>this.mutate(m=>{for(let g of i)xe(m,a,g.payload.id,{isHidden:h})}),c=h=>this.mutate(m=>{for(let g of i){let v=m.elements.find($=>$.payload.id===g.payload.id);v&&v.kind!=="image"&&v.kind!=="tap"&&v.kind!=="timeline"&&(v.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
      <div class="sec" data-open="true" style="--c:var(--wa-accent)">
        ...
        <div class="sec-b">
          ...
          <div class="hint">${Nn}-click a layer to add it or take it out. Click one on its own to edit it alone.</div>
          <div class="adders">
            <button class="small primary" title=${`Group (${wt}G)`} @click=${()=>this.groupPicked()}>Group them</button>
      ...
      </div>`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=fs({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return p`<details class="foot">
      <summary>
    ...
    </details>`}};A([Vt({attribute:!1})],R.prototype,"hass",2),A([Vt({type:Boolean})],R.prototype,"narrow",2),A([Vt({attribute:!1})],R.prototype,"panel",2),A([H()],R.prototype,"colLeft",2),A([H()],R.prototype,"colRight",2),A([H()],R.prototype,"panelWidth",2),A([H()],R.prototype,"owners",2),A([H()],R.prototype,"ownerId",2),A([H()],R.prototype,"records",2),A([H()],R.prototype,"selectedId",2),A([H()],R.prototype,"draft",2),A([H()],R.prototype,"readOnlyReason",2),A([H()],R.prototype,"parseError",2),A([H()],R.prototype,"maxSchemaVersion",2),A([H()],R.prototype,"presets",2),A([H()],R.prototype,"occupied",2),A([H()],R.prototype,"serverToken",2),A([H()],R.prototype,"appliedToken",2),A([H()],R.prototype,"sendStatusKnown",2),A([H()],R.prototype,"polling",2),A([H()],R.prototype,"lastPollSeconds",2),A([H()],R.prototype,"sendPending",2),A([H()],R.prototype,"pages",2),A([H()],R.prototype,"templateResults",2),A([H()],R.prototype,"historySeries",2),A([H()],R.prototype,"templateError",2),A([H()],R.prototype,"templateFetchedAt",2),A([H()],R.prototype,"forced",2),A([H()],R.prototype,"showRaw",2),A([H()],R.prototype,"inspect",2),A([H()],R.prototype,"openSections",2),A([H()],R.prototype,"pickerOpen",2),A([H()],R.prototype,"pickerFilter",2),A([H()],R.prototype,"testValues",2),A([H()],R.prototype,"editingValue",2),A([H()],R.prototype,"thumbStep",2),A([H()],R.prototype,"layerDetail",2),A([H()],R.prototype,"addOpen",2),A([H()],R.prototype,"addDetail",2),A([H()],R.prototype,"multi",2),A([H()],R.prototype,"collapsed",2),A([H()],R.prototype,"activeFamily",2),A([H()],R.prototype,"picking",2),A([H()],R.prototype,"pickHoverId",2),A([H()],R.prototype,"listHoverIds",2),A([H()],R.prototype,"zoomed",2),A([H()],R.prototype,"helpOpen",2),A([H()],R.prototype,"showTaps",2),A([H()],R.prototype,"timestampActiveId",2),A([H()],R.prototype,"savedName",2),A([H()],R.prototype,"presetKind",2),A([H()],R.prototype,"presetEntity",2),A([H()],R.prototype,"newOpen",2),A([H()],R.prototype,"newName",2),A([H()],R.prototype,"newFamily",2),A([H()],R.prototype,"previewCase",2),A([H()],R.prototype,"loadError",2),A([H()],R.prototype,"saveError",2),A([H()],R.prototype,"saving",2),A([H()],R.prototype,"conflict",2),A([H()],R.prototype,"remoteRevision",2),A([H()],R.prototype,"confirmDelete",2),A([H()],R.prototype,"moveTarget",2),A([H()],R.prototype,"moving",2),A([H()],R.prototype,"moveError",2),A([H()],R.prototype,"version",2);var vr=R;function xt(e){return String(e?.message??e)}function ph(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Xl(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function hh(e,n,t,i){let a=[{label:"Shows",value:lr(e,t)}],r=Ai(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function mh(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function fh(e,n,t,i){let a=r=>p`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return p`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${$e(e.payload.colorSlot.baseColorHex)}`;case"gauge":return p`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=Tt(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Mn(o).length} values`}case"timeline":{let r=ht(e.payload),o=r===void 0?[]:Rn(t.get(r)??""),s=Math.max(0,o.length-1);return`${mh(Oe(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${$e(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return je(e.payload.action)}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",vr);export{vr as WristAssistantPanel,Yl as columnFit,hh as layerFacts};
