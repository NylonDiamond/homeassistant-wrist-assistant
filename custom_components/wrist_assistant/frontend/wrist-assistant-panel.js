...
`)}function Tl(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,gp(r));return{values:t,nullKeys:i}}function gp(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Br(e){let n=Yi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function yp(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(cr(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var bp=10800;function xp(e,n,t){let i=n==="always"||n==="auto"&&t<=bp;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Rl(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=xp(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function vp(e,n){return Et(e)===void 0?[]:Rl(je(e)*60,xr(e.timeLabelCount),e.hourCycle,e.minutes,n)}function wp(e,n){return Ni(e)?Rl(Math.round(e.historyMinutes)*60,xr(ni(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Xt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ye(e){let n=e.trim(),t=Xt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Xt(i)}function kp(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function $p(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Cp(e){let n=e.trim(),t=Xt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Xt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Xt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Sp(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Tp(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Ep(e,n,t){if(Me(n))return e;let i=n,a=e,r=Xt(e.trim()),o=i.duration?Cp(e):void 0;if(o!==void 0)a=Sp(o);else if(i.relativeTime&&r!==void 0)a=$p(r);else{let s=Ye(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):kp(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Tp(a);break}return a}function kn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Je(e,n=240){return Il(e,n).map(t=>t.value)}function Il(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function El(e,n,t){let i=Il(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Ct({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ie,c=t.highColorHex??Ae,u=t.lowColorHex??He,p=[],m=(y,v)=>{if(y==="")return;let $=p.at(-1);$&&$.colorHex===v?$.text+=y:p.push({text:y,colorHex:v})},g=0;return i.forEach((y,v)=>{m(e.slice(g,y.start),n);let $=v===o?c:v===s?u:l.length>0?_i(y.value,l,d):n,S=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,S),$),g=S}),m(e.slice(g),n),p}function Ml(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Mp(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function di(e,n=Tt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Fp(i.slice(a+1))})}return t}function Fp(e){try{return decodeURIComponent(e)}catch{return e}}function Rp(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Fl(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Ip(e,n,t){if(e===void 0)return 0;let i=Ye(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var ut=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Ml(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Gt(n),i=Kt(n),a;t!==void 0?a=this.ctx.historySeries?.get(t)??"":i!==void 0?a=this.ctx.historySeries?.get(i)??"":a=this.resolve(n.value)??"";let r=Je(a);return n.limit>0&&r.length>n.limit?n.takeFromEnd?r.slice(r.length-n.limit):r.slice(0,n.limit):r}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ye(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Ml(a.get(s)??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Me(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?yp(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Gs(r):cr(r,a.domainMax-a.domainMin));break}default:{let a=Vr(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Ep(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Xt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?kn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ye(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ye(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ye(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=qt(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:qt(d),p=c===void 0?void 0:qt(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ee[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=El(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=at(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(v=>v.text).join(""),y):(Os(n.payload)&&(y.spans=El(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,v=m??p;y===void 0&&v.startsWith("mdi:")&&(v="questionmark.circle");let $={kind:"icon",...u,symbol:v,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&($.path=y),$}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(N,U,te)=>N??(U?Ye(this.resolve(U)??""):void 0)??te,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),v=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),$=m===void 0?void 0:Ye(m),S=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&$!==void 0&&(S=_i($,Ct(p),p.bandAboveColorHex));let k=v-y;if(p.total){let N=Ye(this.resolve(p.total)??"");N!==void 0&&(k=N)}let C=Fl(k,1,Li),O={kind:"gauge",...u,fraction:Ip(m,y,v),style:p.style,lineWidth:p.lineWidth,colorHex:S,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:C,filledCount:Fl($??0,0,C)};if(p.thresholdValue!==void 0&&v!==y){let N=(p.thresholdValue-y)/(v-y);N>=0&&N<=1&&(O.thresholdFraction=N)}return O}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y={min:m.domainMin,max:m.domainMax},v=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Ct(p),S=Us(p)?g.map(T=>_i(T,$,p.bandAboveColorHex)):[],k=p.highlight==="highest"||p.highlight==="both",C=p.highlight==="lowest"||p.highlight==="both",O=wt(p),N={kind:"chart",...u,values:g,style:p.style,domainMin:y.min,domainMax:y.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:v,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:k?O.high:"none",lowMarker:C?O.low:"none",pointColorHexes:S,fillBands:p.fillBands,thresholdColorHex:p.thresholdColorHex,nowColorHex:p.nowColorHex,labels:wp(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove};if(g.length>0){let T=k?g.indexOf(Math.max(...g)):-1,V=C?g.indexOf(Math.min(...g)):-1;T>=0&&(N.highIndex=T),V>=0&&V!==T&&(N.lowIndex=V)}let U=Mp(p,y.min,y.max);U!==void 0&&(N.thresholdY=U);let te=this.chartNowIndex(p,g.length);return te!==void 0&&(N.nowIndex=te),N}case"timeline":{let p=n.payload,m=Et(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=di(g,Tt),v=Rp(y,je(p)*60,S=>Js(S,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:v,gap:p.gap,cornerRadius:p.cornerRadius,labels:vp(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};rt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=dl(n,t).map(y=>this.resolveElement(y,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,v=this.resolve(y.value),$=v===void 0?void 0:Ye(v);if($!==void 0){let S=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),C={value:Math.min(k,Math.max(S,$)),minValue:S,maxValue:k===S?S+1:k,colorHexes:y.colorHexes},O=this.resolve(y.minLabel);O!==void 0&&(C.minLabel=O);let N=this.resolve(y.maxLabel);N!==void 0&&(C.maxLabel=N),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Ap(e,n,t){let i=new ut(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Ji(e,n,t){let i=new ut(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Ap(e.inline,n,e)),a}var Ce=be,ui=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ce,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=ui.find(e=>e.measured);function Dl(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return ui.find(a=>a.screen.width===t&&a.screen.height===i)}function Zi(e,n){let t=Ce[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Kr={regular:400,medium:500,semibold:600,bold:700},Hp=1.15;function Xe(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function me(e,n,t="#FFFFFF"){let i=Xe(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Vl(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var pt=e=>e*.55;function Bl(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Lp(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function _p(e,n,t){if(t<=0||e.length*pt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/pt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Pp(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Ul(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Gl(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function zp(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Kl(e,n){return e.reduce((t,i)=>t+i.text.length*pt(i.look.fontSize*n),0)}function Np(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:pt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=pt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Op(e,n,t){if(t<=0||Kl(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*pt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*pt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Dp(e,n,t){let i=zp(n),a=e.lineLimit===2&&t.w>0?Np(e.text,i,t.w):[e.text],r=Ul(e.text,a),o=a.map((S,k)=>Gl(S,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(S=>Kl(S,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(S=>Op(S,l,t.w)),{anchor:c,x:u}=Bl(e.alignment,t),p=Math.max(0,...d.flat().map(S=>S.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=S=>S.map(k=>{let C=me(k.look.colorHex,"fill");return w`<tspan font-size=${k.look.fontSize*l} font-weight=${Kr[k.look.fontWeight]??400} fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}),v=me(e.colorHex,"fill"),$=d.length>1?w`${d.map((S,k)=>w`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*g}>${y(S)}</tspan>`)}`:y(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${v.fill} fill-opacity=${v["fill-opacity"]}>${$}</text>`}function Vp(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:Dp(e,e.parts,n);let t=me(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:kn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Lp(e.text,n.w/pt(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*pt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>_p(y,o,n.w)),{anchor:l,x:d}=Bl(e.alignment,n),c=Pp(e.text,e.spans),u=c?Ul(e.text,i):[],p=(y,v)=>c?Gl(y,u[v]??0,e.text,c,e.colorHex).map($=>{let S=me($.look,"fill");return w`<tspan fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}):y,m=o*1.15,g=s.length>1?w`${s.map((y,v)=>w`<tspan x=${d} y=${n.cy+(v-(s.length-1)/2)*m}>${p(y,v)}</tspan>`)}`:p(s[0],0);return w`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Kr[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var Ur=2;function Bp(e,n){let t=me(e.colorHex,"stroke"),i=me(e.trackColorHex,"stroke","#FFFFFF"),a=me(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,g=Math.max(1,e.dotCount),y=m?n.w:n.h,v=m?n.h:n.w,$=Math.max(1,Math.min(v,y/g-Ur)),S=g*$+(g-1)*Ur,k=(m?n.cx:n.cy)-S/2+$/2;return w`${Array.from({length:g},(C,O)=>{let N=k+O*($+Ur),U=O<e.filledCount?t:i;return w`<circle cx=${m?N:n.cx} cy=${m?n.cy:N} r=${$/2}
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var Gp=5;function Kp(e,n){let t=e.values,i=Math.max(t.length,1),r=e.highIndex!==void 0&&e.highMarker!=="none"||e.lowIndex!==void 0&&e.lowMarker!=="none"?Gp:0,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,c=Math.max(n.h-r-o*2,1),u=d+c,p=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?c*.12:0,y=Math.min(Math.max(e.barGap,0),l/(i*2)),v=Math.max((l-y*(i-1))/i,.5),$=k=>Math.min(1,Math.max(0,(k-e.domainMin)/p)),S=k=>u-$(k)*c;return{count:t.length,barWidth:v,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:m?u:S(0),yAtFraction(k){return u-Math.min(Math.max(k,0),1)*c},barRect(k){let C=s+k*(v+y),O=t[k],N,U;if(m){let te=g+$(O)*(c-g);N=u-te,U=u}else N=S(O),U=m?u:S(0),N>U&&([N,U]=[U,N]);return{x:C,y:N,w:v,h:Math.max(U-N,.5)}},point(k){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*k/(t.length-1):s+l/2,y:S(t[k])}},markerCenter(k,C){let O=C?this.barRect(k):void 0;return{x:O?O.x+O.w/2:this.point(k).x,y:n.y+r/2}}}}function Wp(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Wl(e,n),o=r?jl(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:w`${o}`;let s=jp(e,a);return o===void 0?s:w`${s}${o}`}function jp(e,n){let t=Kp(e,n),i=me(e.colorHex,"fill"),a=me(e.highColorHex,"fill",e.colorHex),r=me(e.lowColorHex,"fill",e.colorHex),o=(u,p)=>w`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${p.fill} fill-opacity=${p["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?me(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let p=t.barRect(u),m=u===e.highIndex?a:u===e.lowIndex?r:d(u),g=Math.min(1.2,p.w/2,p.h/2);s.push(w`<rect x=${p.x} y=${p.y} width=${p.w} height=${p.h} rx=${g}
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?w`${s}${jl(e,n,t,i)}`:w`${s}`}function Yp(e,n){let t=me(e.fillColorHex,"fill"),i=e.borderColorHex?Xe(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return w`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Jp(e,n,t){if(e.path!==void 0&&e.path!==""){let o=me(e.colorHex,"fill"),s=e.size*Hp;return w`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Jr=.25,Xp=8;function Zp(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Jr),Xp),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),v=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+v)+0,width:m,height:g}}function Qi(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Xi=4;function ea(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Xi:n.x+n.w-Xi-a,d=e.timestampCorner.startsWith("top")?n.y+Xi:n.y+n.h-Xi-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Qp(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function eh(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ea(e,n,Qi(new Date)):void 0,s=o?w`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,g])=>w`<rect data-ts-corner=${p} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=Zp(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=w`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Qp(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return w`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function th(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?nh(a,n):void 0;return w`
    ...
    ${o!==void 0?w`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Wr} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?w`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var Wr=5;function nh(e,n){let t=Wr*.55,i=n.w-2;if(n.h<Wr*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function jr(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=Vl(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=Vp(e,l);break;case"icon":c=Jp(e,l,t.icons);break;case"gauge":c=Bp(e,l);break;case"chart":c=Wp(e,l);break;case"timeline":c=qp(e,l);break;case"shape":c=Yp(e,l);break;case"image":c=eh(e,l,t);break;case"tap":c=th(e,l,t.icons,a,d?ot(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,p=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,y=t.handles===!0&&(!s||o),v=g?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,$=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    ${e.maxLabel!==void 0?v(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function na(e,n){let t=e.family in Ce?e.family:"rectangular",i=n.slot??Ce[t],a=Ce[t],r=Zi(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Xe(e.backgroundColorHex),l=Xe(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,y=!!e.bezelText||!!e.bezelGauge,v=e.curvedText??"",$=v!=="",S=ta(g,y),k=Xr(g,y),C=k/(a.width*g),O=S.tile.cx-k/2,N=S.tile.cy-k/2,U=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,te=f;if(e.bezelGauge)te=sh(e.bezelGauge,g,o);else if(e.bezelText){let V=ih(g,`${o}-bezel`),Z=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?kn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;te=w`<defs><path id=${V.id} d=${V.d} /></defs>
        <text font-size=${Al*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${V.id}" startOffset="50%" text-anchor="middle">${Ll(Z,V.length,Al*g)}</textPath></text>`}let T=f;if($){let V=Xe(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},Z=Yl(g,`${o}-curved`,ah*g,rh);T=w`<defs><path id=${Z.id} d=${Z.d} /></defs>
        <text font-size=${_l*g} font-weight="600" fill=${V.color} fill-opacity=${V.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${Z.id}" startOffset="50%" text-anchor="middle">${Ll(v,Z.length,_l*g*.88)}</textPath></text>`}else{let V=e.borderWidth*r.scale*C,Z=l?w`<circle cx=${k/2} cy=${k/2} r=${k/2-V/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${V} />`:f;T=w`<g transform="translate(${O} ${N})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Ch(e)}</svg>`}var Qe="color-mix(in srgb, var(--k) 45%, #6b7280)",pa='system-ui, -apple-system, "Segoe UI", sans-serif';function kd(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function lo(e,n,t,i){return w`<g fill="none" stroke-linecap="round">
    <path d=${kd(e,n,t,1)} stroke=${Qe} stroke-width="2.6" opacity=".5" />
    <path d=${kd(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function Sh(e){switch(e){case"text":return w`<g font-family=${pa} text-anchor="middle">
    ...
    <input type="text" .value=${n} placeholder=${i.placeholder??""} list=${i.list??f}
      class=${i.mono?"mono":""} @input=${pe(t)} /></label>`}function ic(e,n,t,i=3){return h`<label class="field"><span>${e}</span>
    ...
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${oc(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,C)=>h`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
    ...
    <span class="sym-name">${n}</span>
      ...
      ${k===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:C.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Dd(O.length,C.length,!0,k.length)}</div>`}
    ...
    </div>`}else if(o){let k=r.category(i),C=Gh(k,s,d,c),O=no(C.names,s),N=C.fromPack?O.slice(0,Nd):O,U=r.recent.filter(T=>!T.startsWith(Fe)),te=c.size===0?U:U.filter(T=>c.has(T));S=h`<div class="sym-browse">
      ${m?Vd(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${pe(T=>r.setQuery(i,T))} />
        <select @change=${pe(T=>r.setCategory(i,T))}>
          ${Kh(c).map(T=>h`<option value=${T.value} ?selected=${T.value===k}>${T.label}</option>`)}
        </select>
      </div>
      ...
      ${O.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${Dd(N.length,O.length,s.trim()!=="",Wh(d))}
          </div>`}
    ...
    ${S}`}function jh(e,n){let t=e.trim();return t!==""&&!t.startsWith(Fe)&&n.size>0&&!n.has(t)}function qh(e,n){let t=n.trim(),i=t.startsWith(Fe)?t.slice(Fe.length):t,a=e.map(r=>r.startsWith(Fe)?r.slice(Fe.length):r);return no(a,i).map(r=>Fe+r)}function Vd(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
    ...
    ${Pe("Source",a.kind,s,c=>r(lm(a,c)))}
    ${l}
    ${i.noFormat?f:pm(n.format,c=>t(Me(c)?{kind:n.kind}:{...n,format:c}))}
    ${i.showResolved?h`<div class="hint keep">Now:${d===void 0?h`<span class="warn">unresolved</span>`:h`<code>${d}</code>`}</div>`:f}`}function pm(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return h`<details class="sub" ?open=${!Me(e)}>
    ...
    <div class="gen-row">
      ...
      ${Pe("Tap action",t.type,pc,s=>e.update(l=>{l.tapAction=hc(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function _m(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Te(e.config,t,n),o=r.frame,s=(d,c)=>e.update(u=>Se(u,t,i,{frame:co(o,d)}),`${a}-${c}-${t}`),l=!Ea(o,Zn)||r.isHidden;return ge(e,"placement","Position",h`
    ...
    <div class="hint">X, Y, W and H are a percent of the face, on the ${ee(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:J.position,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${ee(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${ee(t)} face at half size, unrotated and shown`,reset:()=>e.update(d=>Se(d,t,i,{frame:{...Zn},isHidden:!1}))}:{}})}function Pm(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Le(e.config,t)[0];return ge(e,"tappable","Tap",lf(e,n,`el-${t}`),{color:J.tap,icon:"tap",summary:i?ot(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Gi(a,t))}:{}})}function Jd(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${X("Clock",e.hourCycle,js,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${X("Minutes",e.minutes,qs,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ...
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${zm.map(([y,v])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a($=>Om($,o,y))}}>${v}</button>`)}
      </span>
    ...
    ${r==="none"?f:h`
      ...
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var bi=new Map,yi=new Map,ht=new Map,xa=new Map,ko=4,$o=40,Bm=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Um=[["plain","Plain"],["rich","Rich"]],Gm={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function Po(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Oe("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function Km(e){return e.countdown===!0?"countdown":at(e)?"rich":"plain"}function Wm(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function jm(e,n){let t=un(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ue(e.kind.value,40)||"template"}:{kind:"value",label:Na(e,n)}}function kc(e,n,t){let i=un(e.value),a=i===void 0?Ue(Na(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ue(i,24)}"`;return`Part ${n+1}: ${a}`}function qm(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,kc(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function Mo(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Ym(e,n){if(Mo(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Ct({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??ie],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function Xd(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${za(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Jm={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Xm(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${za(e.moved.map(n=>Jm[n]))} moved into Look.`}function Zm(e,n,t,i,a){let r=n.payload,o=r.id,s=Km(r),l=(r.parts?.length??0)>0,d=Tr(e.config,r.value),c=ht.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?yi.get(o):void 0,m=(v,$)=>{let S=!(r.parts??[]).every(C=>C.value.kind.kind==="literal"),k=ma(structuredClone(r),e.config.values);if(yi.delete(o),!k.ok){ht.set(o,{text:Xd(k.blocked),rich:!0,warn:!0}),ke($);return}ht.set(o,{text:Xm(k.joined?{joined:!0,template:S}:k),rich:!1}),i(C=>{ma(C,e.config.values),v==="countdown"&&(C.countdown=!0)})},g=(v,$)=>{if(yi.delete(o),s==="rich"){let S=v==="countdown"?"countdown":"plain",k=r.parts??[];if(k.length<2){m(S,$);return}let C=fo(k,e.config.values);C.ok?(ht.delete(o),yi.set(o,S)):ht.set(o,{text:Xd(C.blocked),rich:!0,warn:!0}),ke($);return}if(v==="rich"){let S=r.parts?.[0]?.id??Y();bi.set(o,S),ht.delete(o),i(k=>{delete k.countdown,_d(k,S)});return}ht.delete(o),i(S=>{if(v==="countdown"){S.countdown=!0;return}(S.parts?.length??0)>0&&ma(S,e.config.values),delete S.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${X("Type",s==="rich"?"rich":"plain",Um,g,{titles:Gm})}
    ...
    ${s==="rich"?Qm(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${ze(d,he(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Qm(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=he(e),d=Math.max(0,o.findIndex(R=>R.id===bi.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Te(e.config,t,n).size??r.fontSize,g=(R,b)=>{ht.delete(s),i(x=>{R(x),Ds(x)},b)},y=(R,b)=>g(x=>{let M=x.parts?.find(E=>E.id===c.id);M&&R(M)},b?`part-${c.id}-${b}`:void 0),v=(R,b)=>{bi.set(s,R),ht.delete(s),ke(b)},$=(R,b)=>{let x=Y();bi.set(s,x),g(M=>{(M.parts??=[]).push({id:x,value:R})}),dc(b,_a(`${a}-part-${x}`),!0)},S=R=>g(b=>{b.parts&&wi(b.parts,d,R)}),k=()=>{let R=o[d+1]??o[d-1];R&&bi.set(s,R.id),g(b=>{b.parts=(b.parts??[]).filter(x=>x.id!==c.id)})},C=o.map((R,b)=>{let x=jm(R.value,l),M=R.id===c.id,E=Mo(R),P=x.kind==="value"?e.resolve(R.value):void 0,B=R.fontWeight===void 0?void 0:Mn.find(([K])=>K===R.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${M?"true":"false"} class="part-chip ${x.kind} ${M?"on":""}"
      aria-label=${kc(R,b,l)} @click=${K=>v(R.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${Ym(R,p)}`}
        title=${E==="bands"?"By value, with its own bands":E==="pick"?"Its own colour":"The layer colour"}></span>
      ${x.kind==="text"?h`<span class="part-txt">${x.label===""?h`<span class="part-empty">empty</span>`:Wm(x.label).map(K=>K.space?h`<span class="part-sp">${"\xB7".repeat(K.text.length)}</span>`:K.text)}</span>`:h`<span class="part-txt">${x.label}</span>`}
    ...
    <div class="part-editor">
      ...
      ${X("Colour",U,Bm,R=>y(b=>{if(R==="layer"){delete b.colorHex,delete b.coloring;return}if(R==="pick"){delete b.coloring,b.colorHex=Ao(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Sa(Je(e.resolve(b.value)??"")))}),{def:"layer",titles:W,...N&&U!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <label class="field num part-size">${Ie("Font size",te?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(R=>{delete R.fontSize})}:void 0,Aa(c.fontSize??m,V,{step:1,min:ko,max:$o}))}
  ...
  </div>`}function $c(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,x)=>e.update(M=>b(M.elements[r]),x?`${o}-${x}`:void 0),l=Te(e.config,t,n),d=l.frame,c=(b,x)=>e.update(M=>Se(M,t,a,{frame:co(d,b)}),`${o}-${x}-${t}`),u=We(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],g=!1,y=b=>n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?f:le(b,n.payload.colorSlot.baseColorHex,x=>s(M=>{M.kind!=="image"&&M.kind!=="tap"&&M.kind!=="timeline"&&(M.payload.colorSlot.baseColorHex=x??"#FFFFFF")},"color"),!1,p),v,$;switch(n.kind){case"text":{let b=(x,M)=>s(E=>x(E.payload),M);v=Zm(e,n,t,b,o),g=!n.payload.countdown&&!at(n.payload),$=h`
        ...
        ${zh({label:"Align",value:n.payload.alignment??"center",options:km,def:"center",set:x=>s(M=>{let E=M.payload;x==="center"?delete E.alignment:E.alignment=x})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:$m,def:"1",set:x=>s(M=>{let E=M.payload;x==="2"?E.lineLimit=2:delete E.lineLimit})})}
        ...
        ${g?Vm(e,n.payload,b,y("Main colour")):f}`;break}case"icon":v=h`
        ...
        ${M?h`
            ${se(e,b.total??Ud(b),E=>x(P=>{P.total=E},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Li} dots are drawn.</div>`:Dm(e,b,{min:u.minValue,max:u.maxValue},o,x)}`,g=!0,$=h`
        <div class="grid2">
          ${X("Style",b.style,rm,E=>x(P=>{E==="dots"&&P.total===void 0&&(P.total=Ud(P)),E!=="dots"&&delete P.total,P.style=E}),{titles:om,def:u.style})}
        ...
        ${xe?h`
            ...
            ${qo?wo(b.historyMinutes,F=>x(_=>{_.historyMinutes=F},"span"),!0):f}
        ...
        ${_t?h`
            ...
            ${qo?wo(b.historyMinutes,F=>x(_=>{_.historyMinutes=F},"span")):f}
        ...
        ${Ge.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${Mm(Pt)}</span>${Ge.length===Pt.length?h` · ${Pt.length} ${Pt.length===1?"value":"values"}`:h` · ${Pt.length} of ${Ge.length}`}</span></div>`:f}
        ...
        <div class="grid2">
          ${X("Style",b.style,Jh,F=>x(_=>{_.style=F}),{def:u.style})}
        ...
        <div class="grid2">
          ${X("Scale",b.scale,Xh,F=>x(_=>{_.scale=F}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${X("Baseline",b.baseline,Zh,F=>x(_=>{_.baseline=F}),{def:u.baseline})}
        </div>
        ${Va.length===0?f:Pe("Same scale as",Ba?b.scaleFrom:"",[["","Its own"],...Va.map(F=>[F.payload.id,ze(F,uu)])],F=>x(_=>{F?_.scaleFrom=F:delete _.scaleFrom}),{def:""})}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let F;e.update(_=>{F=ml(_,a)}),F&&e.selectLayer(F)}}>${D("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ...
        ${b.highlight==="none"?f:h`
          <div class="grid2">
            ${b.highlight==="lowest"?f:X("Highest marker",M.high,Bd,F=>x(_=>{lr(_,{...wt(_),high:F})}),{def:E.high})}
            ${b.highlight==="highest"?f:X("Lowest marker",M.low,Bd,F=>x(_=>{lr(_,{...wt(_),low:F})}),{def:E.low})}
          </div>
          <div class="grid2">
        ...
        ${Oe("Threshold",b.thresholdValue!==void 0,F=>x(_=>{F?_.thresholdValue=Qh(Pt):delete _.thresholdValue}))}
        ...
        ${xe.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Hm(xe,K)}</span></span></div>`:f}
        ${Am(xe)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${am(b,x,An,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${n.payload.kind==="line"?Im(t,d,c):f}`,$=n.payload.kind==="line"?oe("Thickness",n.payload.thickness,b=>s(x=>{x.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        <div class=${b.contentMode==="fit"&&b.zoom===1?"hint keep":"hint"}>${Tm(b)}</div>
        ...
        ${Cc(e,n.payload,(b,x)=>s(M=>b(M.payload),x),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let S=g||n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&at(n.payload)?"Layer colour":"Colour"),k=Ir(e.config,n),C=k?{kind:{kind:"entityState",...k}}:void 0,O=n.kind==="image"?n.payload.timestamp===!0:!1,N=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,U=tf[n.kind],te=nf[n.kind],T=Yd(n.payload,u,U),V=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,Z=e.config.perFamily[t]?.placements[a]?.size!==void 0,W=Yd(n.payload,u,te)||V!==void 0&&l.size!==void 0&&l.size!==u[V],ye=Wt(e.config,a),R=(b,x)=>()=>s(M=>xo(M.payload,u,b),x);return h`
    ${ge(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"?f:wc(e,n,o)}${v}`,{color:J.content,icon:"content",summary:_o(e,n),...T?{reset:()=>s(b=>{xo(b.payload,u,U),b.kind==="text"&&fi(b.payload.rules)},"reset-content")}:{}})}
    ...
    ${n.kind==="chart"?ge(e,"numbers","Numbers",sf(e,n),{color:J.numbers,icon:"text",summary:of(e,n),...ye.length>0?{reset:()=>e.update(b=>{for(let x of Wt(b,a))ct(b,x.payload.id)})}:{}}):f}
    ${n.kind==="image"?ge(e,"timestamp","Timestamp",Em(n.payload,(b,x)=>s(M=>b(M.payload),x)),{color:J.numbers,icon:"clock",summary:O?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...O?{reset:R(ef,"reset-stamp")}:{}}):f}
    ${ge(e,"states","States",Ic(e,n.payload.rules,n.kind,b=>b.elements.find(x=>x.payload.id===a)?.payload.rules,`rules-${a}`,C,N),{color:J.states,icon:"states",summary:pi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ...
    ${Pe("Tap action",a.type,mm,r=>t(o=>{o.action=hc(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?gc(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var af=24;function rf(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=pl(e.config,n,r);o&&(t.push(`${ee(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<af;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function of(e,n){let t=Wt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(cn.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function sf(e,n){let t=he(e),i=Wt(e.config,n.payload.id),a=o=>e.update(s=>{ol(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return h`
    ...
    ${a?h`<div class="value-editor">
        ...
        ${rf(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${ot(o)}</b>.</div>`}`}function Zd(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function ze(e,n){switch(e.kind){case"text":return Zd($e(e.payload.value,n));case"icon":return Zd($e(e.payload.symbol,n));case"gauge":return $e(e.payload.value,n);case"chart":return $e(e.payload.value,n);case"timeline":return $e(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function Sc(e,n){let t=lt(e.config,n.id),i=he(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return ge(e,"content","Group",h`
    ...
    <div class="field list-field"><span>Layers</span>
      <span class="readout-v">${t.map(r=>ze(r,i)).join(", ")}</span>
      <div class="row-acts">
        <button class="small" title="Keep the layers where they are and drop the folder" @click=${()=>e.update(r=>oi(r,n.id))}>Ungroup</button>
      </div>
    </div>
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:J.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Tc(e,n){if(n==="inline")return df(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ee(n)} yet.</div>
    ...
    ${n==="corner"?ge(e,"corner","Corner content",cf(e,t,i),{color:J.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${ge(e,"states","Shape states",Ic(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:J.states,icon:"states",summary:pi(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${ge(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:J.look,icon:"icon",summary:n.symbol||"None"})}`}function cf(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Eb=ne.map(e=>[e,ee(e)]),zo={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},pf=Object.keys(zo),Fa=["color","text","fontSize","fontWeight","visibility"];function hf(e,n=!1){let t=ji[e].filter(i=>!n||Fa.includes(i));return pf.filter(i=>t.includes(Ee[i]))}function Ec(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${qm(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var mf={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function va(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Ue(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function ff(e){if(!e||Me(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function $e(e,n){return`${Na(e,n)}${ff(e.format)}`}function Na(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Ue(t.value,40)}"`:"(empty)";case"entityState":return va(t,n);case"entityAttribute":return t.attribute?`${va(t,n)} \xB7 ${t.attribute}`:va(t,n);case"entityAge":return`age of ${va(t,n)}`;case"aggregate":return gf(t.aggregate);case"time":return mf[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Ue(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(cn.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Na(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function gf(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function wi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function yf(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${s===void 0?f:Ec(s,n.partId,he(e),m=>u(g=>{m?g.partId=m:delete g.partId}))}
    ...
    ${n.cases.map((m,g)=>xf(e,m,g,n,a,u,`${o}-${m.id}`,p))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${Mc(e,n.otherwise,a,m=>u(g=>{g.otherwise&&m(g.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function xf(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(g=>g.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>vf(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(Nr())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=Ld(p,Fd(e.hass?.states));l(g=>{g.when.tests.push(...m)})}}>
    ...
    ${Mc(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=kf(n.value)?$f(s.options??[],u=>o(p=>{p.comparison.options=ho(u)},"options")):fe("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Pe("Comparison",s.kind,vl.map(u=>[u,Tn[u]]),u=>o(p=>{p.comparison=Dr(p.comparison,u)}))}
    ${c}
  </div>`}function wf(e){try{return new RegExp(e),!0}catch{return!1}}function Qd(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=qt(r)??"";return h`<label class="field"><span>${n}</span>
    ...
    </select>`}var Fc=["setColor","setBorderColor","setBackgroundColor"];function Cf(e,n,t,i,a,r,o,s=!1){let l=!ji[i].includes(Ee[n.kind]),d=s&&!l&&!Fa.includes(Ee[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${Rc(e,n,a,o)}
  </div>`}function Rc(e,n,t,i){let a=qi(n.kind),r=f;if(a==="value"){let o=n.value??H("");if(Fc.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?le("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=H(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${yf(e,n,t,i,a,o)}`:Sf(e,s.table,n[0],t,i,a,r,o)}function Sf(e,n,t,i,a,r,o,s){let l=(x,M)=>e.update(E=>{let P=a(E);P&&x(P)},M?`${r}-${M}`:void 0),d=n.value??ec.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!wd(d)&&Tf(e.resolve(d)),p=ji[i],m=wa.get(r)??new Set,g=n.columns.length===0&&m.size===0?[vd[i]]:[],y=ud(n.columns,[...m,...g.filter(x=>x!==void 0)],p),v=xa.get(r),$=t?t.partId:s?.some(x=>x.id===v)?v:void 0,S=s!==void 0&&$!==void 0,k=S?p.filter(x=>Fa.includes(x)):p,C=S?y.filter(x=>!Fa.includes(x)):[],O=(x,M)=>{if(!t){x?xa.set(r,x):xa.delete(r),ke(M);return}l(E=>{let P=E[0];P&&(x?P.partId=x:delete P.partId)})},N=t?e.liveBranch(t):"none",U=t?e.forced.get(t.id)??"live":"live",te=x=>U!=="live"&&(U==="otherwise"?x==="otherwise":U.caseId===x),T=x=>{t&&e.setForced(t.id,te(x)?"live":x==="otherwise"?"otherwise":{caseId:x})},V=x=>{ec.set(r,x),n.rows.length!==0&&l(M=>yd(M,x),"lhs")},Z=()=>{xa.delete(r),l(x=>{fd(x,d??H(""),u),$!==void 0&&x[0]&&x[0].partId===void 0&&(x[0].partId=$)})},W=n.rows.map((x,M)=>nc(e,{key:`${r}-${x.caseId}`,label:xd(x.comparison,E=>$e(E,he(e))),columns:y,changes:x.changes,live:N===x.caseId,forced:te(x.caseId),onForce:()=>T(x.caseId),when:If(e,x.comparison,`${r}-${x.caseId}`,(E,P)=>l(B=>{let K=B[0]?.cases.find(xe=>xe.id===x.caseId)?.when.tests[0];K&&E(K.comparison)},P&&`${x.caseId}-${P}`)),updChanges:(E,P)=>l(B=>{let K=B[0]?.cases.find(xe=>xe.id===x.caseId);K&&E(K.then)},P&&`${x.caseId}-${P}`),acts:h`
    ...
    <div class="states">
      ...
      ${R===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${Ze[R]} column? Its ${tc(n,R)} value${tc(n,R)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${x=>{ka.delete(r),wa.get(r)?.delete(R),ke(x.target),l(M=>bd(M,R))}}>Remove</button>
  ...
  </tr>`}function Ff(e,n,t,i,a){let r=ua(t,n),o=_a(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${Ze[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Jt(cd[n]))}),dc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Ee[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=Ze[n];return h`
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${cc}>
      ...
      ${vi.has(o)?h`${n==="visibility"?X("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Rc(e,r,s,a)}
    ...
    </div>`}function Rf(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=qi(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${Mn.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??H(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Fc.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Re(a):$e(i,he(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${$e(i,he(e))}</span>`}function Re(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function If(e,n,t,i){let a=Yt(n.kind),r=ao(n.kind),o=(s,l,d,c)=>Hf(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${pe(s=>i(l=>{let d=Dr(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${io.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Af(s)}</option>`)}
    </select>
...
${pg(c)}`}}let l=Vi(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${Dc}`}}return{ok:!0,config:s,raw:i}}function Vo(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=zr(e,(o,s)=>Oc(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Oc(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Vc(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function jc(e,n){let t=structuredClone(e);_r(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Pr(t,a=>Lr(a,i)),t}function qc(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function hg(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Yc(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=ia(e);return i.length===0?t:`${t}, ${hg(i)}`}function Bo(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var fg=3e4,gg=500,yg=3e4,Jc="preset-entity";function Xc(e){return`import-entity-${e}`}var bg={entityId:"",displayName:"",domain:""},xg={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Uo(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function vg(e){return e.kind==="family"?"look":"content"}function Go(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Zc(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.addEventListener(Ra,this.scrubStart),this.addEventListener(Ia,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},yg)}loadColumnWidths(){try{let t=window.localStorage.getItem(ru);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Ko(i.left)),typeof i.right=="number"&&(this.colRight=Ko(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(ru,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(au);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(au,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${et({hass:this.hass},t.label,i??bg,a=>this.setImportEntity(t.entityId,a),Xc(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${ze(T,d)}</b>
          <small><span class="kind">${Sn[T.kind]}</span> · ${Ig(T,c,this.historySeries,R.size)}</small>
          ${C?h`<span class="facts">${Fg(this.host(),a,T,R).map(B=>h`<span class="fact"><b>${B.label}</b> ${B.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
        ...
        <span class="name">
          ...
          ${C?h`<span class="facts"><span class="fact"><b>Holds</b> ${V.map(E=>ze(E,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
      ...
      ${t===void 0?f:h`
        ...
        ${et(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Jc,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Nc(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=Ji(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${ge(a,"complication","Complication",fc(a),{color:J.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=$c(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=Sc(a,c)}else if(r.kind==="data"){let c=t.values.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=ge(a,"shared-value","Shared value",yc(a,c),{color:J.complication,icon:"content",summary:'Read by layers whose Source is "Named value"',alwaysOpen:!0})}else s=Tc(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([vg(r)]):new Set(Ro)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=he(r),s=new ut(this.buildContext(),this.draft?.config),l=vc(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)Se(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let v=g.elements.find($=>$.payload.id===y.payload.id);v&&v.kind!=="image"&&v.kind!=="tap"&&v.kind!=="timeline"&&(v.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ...
      ${ge(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:J.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=sd({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
