...
`)}function Vo(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Yd(r));return{values:t,nullKeys:i}}function Yd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Ia(e){let n=oi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Xd(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}var Jd=10800;function Zd(e,n){let t=e.minutes==="always"||e.minutes==="auto"&&n<=Jd;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...t?{minute:"2-digit"}:{},...e.hourCycle==="h12"?{hourCycle:"h12"}:{},...e.hourCycle==="h24"?{hourCycle:"h23"}:{}})}function Qd(e,n){if(ht(e)===void 0)return[];let t=lo(e.timeLabelCount);if(t.length===0)return[];let i=Oe(e)*60,a=Zd(e,i);return t.map(r=>({position:r,text:a.format(new Date(n-i*1e3*(1-r)))}))}function It(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ze(e){let n=e.trim(),t=It(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:It(i)}function ec(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function tc(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function nc(e){let n=e.trim(),t=It(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?It(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=It(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function ic(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function ac(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function rc(e,n,t){if(Pe(n))return e;let i=n,a=e,r=It(e.trim()),o=i.duration?nc(e):void 0;if(o!==void 0)a=ic(o);else if(i.relativeTime&&r!==void 0)a=tc(r);else{let s=Ze(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):ec(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=ac(a);break}return a}function Jt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Mn(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function Bo(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function oc(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Rn(e,n=pt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:sc(i.slice(a+1))})}return t}function sc(e){try{return decodeURIComponent(e)}catch{return e}}function lc(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let u=t(o.state),c=i[i.length-1];c!==void 0&&c.colorHex===u?c.end=d:i.push({start:s,end:d,colorHex:u})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Go(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function dc(e,n,t){if(e===void 0)return 0;let i=Ze(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Qe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Bo(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Tt(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=Mn(i);return n.limit>0&&a.length>n.limit?n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit):a}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ze(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let u=t.get(s);if(!u)return{min:0,max:1};let c=u.scaleFrom,h=c!==void 0&&c!==s&&t.has(c)&&!l.has(c)?o(c,new Set([...l,c])):Bo(a.get(s)??[],u);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),u={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},c=this.chartEntity(l);c&&(u.entity=c),this.charts.set(s,u)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Pe(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Xd(a,t.kind.stat):void 0;i=a&&r!==void 0?no(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Ra(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return rc(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=It(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Jt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ze(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ze(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),u=d===void 0?void 0:Ze(d);if(a===void 0||l===void 0||u===void 0)return!1;let[c,h]=l<=u?[l,u]:[u,l];return a>=c&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ee[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,m={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return c!==void 0&&(m.countdownEnd=c),m}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...u,symbol:this.styleText(a,"icon")??c,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let c=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(c.value),m=this.styleNumber(a,"gaugeMin")??c.minValue,g=this.styleNumber(a,"gaugeMax")??c.maxValue,v=h===void 0?void 0:Ze(h),$=this.styleColor(a,"color")??c.colorSlot.baseColorHex;c.coloring==="bands"&&c.bands.length>0&&v!==void 0&&($=aa(v,wn(c),c.bandAboveColorHex));let S=g-m;if(c.total){let C=Ze(this.resolve(c.total)??"");C!==void 0&&(S=C)}let E=Go(S,1,Wn),w={kind:"gauge",...u,fraction:dc(h,m,g),style:c.style,lineWidth:c.lineWidth,colorHex:$,trackColorHex:c.trackColorHex,thresholdColorHex:c.thresholdColorHex,dotCount:E,filledCount:Go(v??0,0,E)};if(c.thresholdValue!==void 0&&g!==m){let C=(c.thresholdValue-m)/(g-m);C>=0&&C<=1&&(w.thresholdFraction=C)}return w}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),m=h.values,g={min:h.domainMin,max:h.domainMax},v=this.styleColor(a,"color")??c.colorSlot.baseColorHex,$=wn(c),S=to(c)?m.map(N=>aa(N,$,c.bandAboveColorHex)):[],E={kind:"chart",...u,values:m,style:c.style,domainMin:g.min,domainMax:g.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:v,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:S,fillBands:c.fillBands,thresholdColorHex:c.thresholdColorHex,nowColorHex:c.nowColorHex};if(m.length>0){let N=c.highlight==="highest"||c.highlight==="both",B=c.highlight==="lowest"||c.highlight==="both",X=N?m.indexOf(Math.max(...m)):-1,de=B?m.indexOf(Math.min(...m)):-1;X>=0&&(E.highIndex=X),de>=0&&de!==X&&(E.lowIndex=de)}let w=oc(c,g.min,g.max);w!==void 0&&(E.thresholdY=w);let C=this.chartNowIndex(c,m.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let c=n.payload,h=ht(c),m=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=Rn(m,pt),v=lc(g,Oe(c)*60,S=>uo(S,c.bands,c.otherColorHex));return{kind:"timeline",...u,runs:v,gap:c.gap,cornerRadius:c.cornerRadius,labels:Qd(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove}}case"shape":{let c={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};We(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=Eo(n,t).map(v=>this.resolveElement(v,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=l??u??this.resolve(a?.bezelText);c!==void 0&&(s.bezelText=c),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let v=a.bezelGauge,$=this.resolve(v.value),S=$===void 0?void 0:Ze($);if(S!==void 0){let E=Math.min(v.minValue,v.maxValue),w=Math.max(v.minValue,v.maxValue),C={value:Math.min(w,Math.max(E,S)),minValue:E,maxValue:w===E?E+1:w,colorHexes:v.colorHexes},N=this.resolve(v.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(v.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function cc(e,n,t){let i=new Qe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function si(e,n,t){let i=new Qe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=cc(e.inline,n,e)),a}var be=he,In=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:be,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Zt=In.find(e=>e.measured);function Zo(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return In.find(a=>a.screen.width===t&&a.screen.height===i)}function di(e,n){let t=be[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var uc={regular:400,medium:500,semibold:600,bold:700};function Ve(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function we(e,n,t="#FFFFFF"){let i=Ve(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Qo(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function pc(e,n){let t=we(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Jt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=e.text;if(n.w>0&&s.length*i(o)>n.w){let l=n.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var fc=5;function gc(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:fc,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,u=Math.max(n.h-r-o*2,1),c=d+u,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?u*.12:0,v=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-v*(i-1))/i,.5),S=w=>Math.min(1,Math.max(0,(w-e.domainMin)/h)),E=w=>c-S(w)*u;return{count:t.length,barWidth:$,plotTop:d,plotBottom:c,plotLeft:s,plotRight:s+l,baselineY:m?c:E(0),yAtFraction(w){return c-Math.min(Math.max(w,0),1)*u},barRect(w){let C=s+w*($+v),N=t[w],B,X;if(m){let de=g+S(N)*(u-g);B=c-de,X=c}else B=E(N),X=m?c:E(0),B>X&&([B,X]=[X,B]);return{x:C,y:B,w:$,h:Math.max(X-B,.5)}},point(w){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*w/(t.length-1):s+l/2,y:E(t[w])}},markerCenter(w,C){let N=C?this.barRect(w):void 0;return{x:N?N.x+N.w/2:this.point(w).x,y:n.y+r/2}}}}function yc(e,n){if(e.values.length===0)return f;let t=gc(e,n),i=we(e.colorHex,"fill"),a=we(e.highColorHex,"fill",e.colorHex),r=we(e.lowColorHex,"fill",e.colorHex),o=(u,c)=>b`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${c.fill} fill-opacity=${c["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?we(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let c=t.barRect(u),h=u===e.highIndex?a:u===e.lowIndex?r:d(u),m=Math.min(1.2,c.w/2,c.h/2);s.push(b`<rect x=${c.x} y=${c.y} width=${c.w} height=${c.h} rx=${m}
      ...
      fill=${d.fill} fill-opacity=${d["fill-opacity"]}>${c.text}</text>`});return b`${s}${u}`}function vc(e,n){let t=we(e.fillColorHex,"fill"),i=e.borderColorHex?Ve(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return b`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function wc(e,n,t){let i=t.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=we(e.colorHex,"stroke"),r=e.size;return b`
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Pa=.25,xc=8;function kc(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Pa),xc),u=Math.max(e/t,n/i),c=Math.min(e/t,n/i),h=(a==="fit"?c:u)*d,m=t*h,g=i*h,v=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),$=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+v)+0,y:-(g-n)/2*(1+$)+0,width:m,height:g}}function ci(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var li=4;function ui(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+li:n.x+n.w-li-a,d=e.timestampCorner.startsWith("top")?n.y+li:n.y+n.h-li-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,u,c)=>c>=u?d+(u-c)/2:Math.min(d+u-c,Math.max(d,l-c/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function $c(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Cc(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ui(e,n,ci(new Date)):void 0,s=o?b`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([h,m,g])=>b`<rect data-ts-corner=${h} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${h}-resize" />`)}`:f,u=e.url?t.imageSizes?.size(e.url):void 0,c;if(e.url&&u){let h=kc(n.w,n.h,u.width,u.height,e.contentMode,e.zoom,e.panX,e.panY);c=b`<image href=${e.url} x=${n.x+h.x} y=${n.y+h.y} width=${h.width} height=${h.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render($c(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return b`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${c}${s}</g>${d}`}function Sc(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Ec(a,n):void 0;return b`
    ...
    ${o!==void 0?b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${_a} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var _a=5;function Ec(e,n){let t=_a*.55,i=n.w-2;if(n.h<_a*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function za(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=Qo(e,n),d=i&&(!s||o),u;switch(e.kind){case"text":u=pc(e,l);break;case"icon":u=wc(e,l,t.icons);break;case"gauge":u=hc(e,l);break;case"chart":u=yc(e,l);break;case"timeline":u=bc(e,l);break;case"shape":u=vc(e,l);break;case"image":u=Cc(e,l,t);break;case"tap":u=Sc(e,l,t.icons,a,d?je(e.action):void 0);break}let c=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*c,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,v=t.handles===!0&&(!s||o),$=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    ${e.maxLabel!==void 0?$(`${t}-gmax`,d+v,d+v+Math.max(s,3),e.maxLabel):f}`}function hi(e,n){let t=e.family in be?e.family:"rectangular",i=n.slot??be[t],a=be[t],r=di(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ve(e.backgroundColorHex),l=Ve(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,v=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=pi(g,v),w=Da(g,v),C=w/(a.width*g),N=E.tile.cx-w/2,B=E.tile.cy-w/2,X=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,de=f;if(e.bezelGauge)de=Ic(e.bezelGauge,g,o);else if(e.bezelText){let F=Tc(g,`${o}-bezel`),D=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Jt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;de=b`<defs><path id=${F.id} d=${F.d} /></defs>
        <text font-size=${Uo*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${F.id}" startOffset="50%" text-anchor="middle">${Wo(D,F.length,Uo*g)}</textPath></text>`}let k=f;if(S){let F=Ve(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},D=ts(g,`${o}-curved`,Fc*g,Mc);k=b`<defs><path id=${D.id} d=${D.d} /></defs>
  ...
  </div>`}function ru(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var ou=120;function su(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(yi.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(bi),fromPack:!1}}function Ns(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function lu(e){return[{value:"",label:`Starter set (${Ns(bi,e)})`},...yi.map(n=>({value:n.name,label:`${n.name} (${Ns(n.symbols,e)})`}))]}function du(e){return e.length>0?e.length:bi.length}function cu(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Os(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return p`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function ll(e,n,t,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),u=n.trim(),c=u!==""&&d.size>0&&!d.has(u),h=g=>{t(g),a.noteUsed(g)},m=f;if(r){let g=a.category(i),v=su(g,o,l,d),$=hs(v.names,o),S=v.fromPack?$.slice(0,ou):$,E=d.size===0?a.recent:a.recent.filter(w=>d.has(w));m=p`<div class="sym-browse">
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${o} @input=${ve(w=>a.setQuery(i,w))} />
        <select @change=${ve(w=>a.setCategory(i,w))}>
          ${lu(d).map(w=>p`<option value=${w.value} ?selected=${w.value===g}>${w.label}</option>`)}
        </select>
      </div>
      ...
      ${$.length===0?p`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:p`<div class="hint">
            ${cu(S.length,$.length,o.trim()!=="",du(l))}
          </div>`}
    ...
    ${m}`}var uu=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],pu=[["bars","Bars"],["line","Line"],["area","Area"]],hu=[["auto","Auto"],["fixed","Fixed range"]],mu=[["lowest","Lowest value"],["zero","Zero"]],dl=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],fu=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],Ps=[["uniform","One colour"],["bands","By value"]];function Ds(e){let n=[ia,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Z(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Z(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function gu(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function yu(e,n){let t=wn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Z(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Vs(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    ${oe("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??ut},"tother"),!1,ut)}`}var wu=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],xu={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Bs(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return R(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var ku=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function $u(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function se(e,n,t,i){if(i.inline||!Cu())return p`<div class="value-editor">${pl(e,n,t,i)}</div>`;let a=or(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=fe(n,ge(e)),l="entityId"in n.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${Fe("Source",a.kind,s,u=>r($u(a,u)))}
    ${l}
    ${i.noFormat?f:Fu(n.format,u=>t(Pe(u)?{kind:n.kind}:{...n,format:u}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:f}`}function Fu(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return p`<details class="sub" ?open=${!Pe(e)}>
  ...
  </details>`}function Mu(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return p`
    ...
    ${n.function==="count"?f:pe("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var hl=ga,Ru=hl.filter(([e])=>e!=="none");function Iu(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function ml(e,n){let t=Iu(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return ho(e)?{type:e,...t}:{type:e}}var Au=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function fl(e,n,t,i){let a=n.serviceDataJSON??"",r=mo(a),o=n.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Lu).slice(0,7)}
    ...
    ${t.type==="openPage"?_u(e):f}`}var Lu="#808080",Us=[0,15,30,60,120];function Ks(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function _u(e){let n=e.config;return yl(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function yl(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Fe("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ...
  </section>`}function Uu(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Ku(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Wu(e,n){let t=he[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function ju(e,n,t){let i=Wu(e,n),a=he[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return p`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <div class="hint">On the ${Q(t)} shape only. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:te.place,icon:"place",summary:`${Math.round(s.width*100)}% wide \xB7 ${Q(t)}`,...i.inline?{alwaysOpen:!0,cardClass:"place-bar",bodyClass:"place-row"}:{},...d?{resetTitle:`Put this layer back to the middle of the ${Q(t)} face at half size, unrotated and shown`,reset:()=>e.update(u=>xe(u,t,a,{frame:{...Ke},isHidden:!1}))}:{}})}function cr(e,n,t={}){let i=t.placeholder;if(i===void 0&&(n===void 0||n.kind==="tap"))return f;let a=n!==void 0&&n.kind!=="tap"?n:void 0,r=a?Te(e.config,a.payload.id)[0]:void 0,o=r===void 0,s=i===void 0&&a!==void 0?ip(e,a,`el-${a.payload.id}`):p`
      ...
      <div class="hint">${i}</div>`;return Ce(e,"tappable","Tap",s,{color:te.tap,icon:"tap",summary:r?je(r.payload.action):"Not tappable",...t.inline?{alwaysOpen:!0,cardClass:`tap-bar${o?" muted-bar":""}`,bodyClass:"tap-row"}:{},...r&&a?{reset:()=>e.update(l=>ni(l,a.payload.id))}:{}})}function kl(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,x)=>e.update(P=>y(P.elements[r]),x?`${o}-${x}`:void 0),l=Se(e.config,t,n),d=l.frame,u=(y,x)=>e.update(P=>xe(P,t,a,{frame:Ja(d,y)}),`${o}-${x}-${t}`),c=Ne(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",m=y=>c[y],g,v;switch(n.kind){case"text":{let y=ya(e.config,n.payload.value);g=p`
        ...
        <div class="grid2">
          ${ae("Style",y.style,wu,G=>x(V=>{G==="dots"&&V.total===void 0&&(V.total=Bs(V)),G!=="dots"&&delete V.total,V.style=G}),{titles:xu,def:c.style})}
        ...
        ${O?p`
            ...
            <div class="grid2">
              ${Xs(a,y.historyMinutes,G,M=>x(A=>{A.historyMinutes=M}))}
            ...
            ${at?Js(y.historyMinutes,M=>x(A=>{A.historyMinutes=M},"span")):f}
        ...
        ${q.length>0?p`<div class="hint">Reads <span class="nums">${Uu(ee)}</span>${q.length===ee.length?p` · ${ee.length} ${ee.length===1?"value":"values"}`:p` · ${ee.length} of ${q.length}`}</div>`:f}
        ...
        <div class="grid2">
          ${ae("Style",y.style,pu,M=>x(A=>{A.style=M}),{def:c.style})}
        ...
        <div class="grid2">
          ${ae("Scale",y.scale,hu,M=>x(A=>{A.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ae("Baseline",y.baseline,mu,M=>x(A=>{A.baseline=M}),{def:c.baseline})}
        </div>
        ${Oi.length===0?f:Fe("Same scale as",Pi?y.scaleFrom:"",[["","Its own"],...Oi.map(M=>[M.payload.id,Re(M,Yl)])],M=>x(A=>{M?A.scaleFrom=M:delete A.scaleFrom}),{def:""})}
        ...
        <div class="grid2">
          ${ae("Highlight",y.highlight,dl,M=>x(A=>{A.highlight=M}),{def:c.highlight})}
          ${y.highlight==="none"?f:ae("Marker",y.marker,fu,M=>x(A=>{A.marker=M}),{def:c.marker})}
        </div>
        ...
        ${Me("Threshold line",y.thresholdValue!==void 0,M=>x(A=>{M?A.thresholdValue=gu(ee):delete A.thresholdValue}))}
        ...
        ${W.length>0?p`<div class="hint">Reads <span class="nums">${Yu(W,U)}</span></div>`:f}
        ${qu(W)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${vu(y,x,at,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${n.payload.kind==="line"?ju(t,d,u):f}`,v=n.payload.kind==="line"?ie("Thickness (pt)",n.payload.thickness,y=>s(x=>{x.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let $=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:oe(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>s(x=>{x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,h),S=$a(e.config,n),E=S?{kind:{kind:"entityState",...S}}:void 0,w=me[n.kind],C=n.kind==="image"?n.payload.timestamp===!0:!1,N=Ju[n.kind],B=Zu[n.kind],X=qs(n.payload,c,N),de=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,k=e.config.perFamily[t]?.placements[a]?.size!==void 0,F=qs(n.payload,c,B)||de!==void 0&&l.size!==void 0&&l.size!==c[de],D=Ft(e.config,a),z=(y,x)=>()=>s(P=>Ys(P.payload,c,y),x);return p`
    ${Ce(e,"content","Content",p`${n.kind==="tap"?f:Ou(e,n,o)}${g}`,{color:w,icon:"content",summary:lr(e,n),...X?{reset:z(N,"reset-content")}:{}})}
    ...
    ${n.kind==="chart"?Ce(e,"numbers","Numbers",np(e,n),{color:me.text,icon:"text",summary:tp(e,n),...D.length>0?{reset:()=>e.update(y=>{for(let x of Ft(y,a))Je(y,x.payload.id)})}:{}}):f}
    ${n.kind==="image"?Ce(e,"timestamp","Timestamp",Gu(n.payload,(y,x)=>s(P=>y(P.payload),x)),{color:w,icon:"clock",summary:C?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...C?{reset:z(Xu,"reset-stamp")}:{}}):f}
    ${i.tap===!1?f:cr(e,n)}
    ...
    ${i.placement===!1?f:dr(e,n,t)}`}var Xu=["timestamp","timestampCorner","timestampSize"],Ju={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Zu={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function $l(e,n,t,i){let a=n.action;return p`
    ${Fe("Tap action",a.type,Ru,r=>t(o=>{o.action=ml(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?yl(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var Qu=24;function ep(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Mo(e.config,n,r);o&&(t.push(`${Q(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<Qu;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function tp(e,n){let t=Ft(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Bt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function np(e,n){let t=ge(e),i=Ft(e.config,n.payload.id),a=o=>e.update(s=>{ko(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    </div>`,{color:te.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Sl(e,n){if(n==="inline")return ap(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${Q(n)} yet.</div>
    ...
    ${n==="corner"?Ce(e,"corner","Corner content",rp(e,t,i),{color:te.place,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ...
    ${Ce(e,"symbol","Symbol",p`
      ...
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:me.icon,icon:"icon",summary:n.symbol||"None"})}`}function rp(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ...
    ${a==="gauge"&&n.bezelGauge?op(e,n.bezelGauge,t):f}`}function op(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Xm=ne.map(e=>[e,Q(e)]),ur={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},sp=Object.keys(ur);function lp(e){let n=ai[e];return sp.filter(t=>n.includes(Ee[t]))}var dp={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Ei(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function gt(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function cp(e){if(!e||Pe(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function fe(e,n){return`${El(e,n)}${cp(e.format)}`}function El(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${gt(t.value,40)}"`:"(empty)";case"entityState":return Ei(t,n);case"entityAttribute":return t.attribute?`${Ei(t,n)} \xB7 ${t.attribute}`:Ei(t,n);case"entityAge":return`age of ${Ei(t,n)}`;case"aggregate":return up(t.aggregate);case"time":return dp[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${gt(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Bt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?El(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function up(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Hi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function pp(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${n.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${t==="layout"?"family":"layer"} looks.</div>`:f}
    ${n.map((o,s)=>hp(e,o,s,n.length,t,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Fn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function hp(e,n,t,i,a,r,o){let s=e.liveBranch(n),l=e.forced.get(n.id)??"live",d=c=>l==="live"?c==="live":l==="otherwise"?c==="otherwise":l.caseId===c,u=(c,h)=>r(m=>{let g=m.find(v=>v.id===n.id);g&&c(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${n.cases.map((c,h)=>mp(e,c,h,n,a,u,`${o}-${c.id}`))}
  ...
  </div>`}function mp(e,n,t,i,a,r,o){let s=(d,u)=>r(c=>{let h=c.cases.find(m=>m.id===n.id);h&&d(h)},u),l=e.liveBranch(i)===n.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((d,u)=>fp(e,d,u,c=>s(h=>{let m=h.when.tests.find(g=>g.id===d.id);m&&c(m)}),()=>s(c=>{c.when.tests=c.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    ...
    ${Tl(e,n.then,a,d=>s(u=>d(u.then)),`${o}-then`)}
        ...
        ${s.pattern&&!gp(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"options":u=pe("Options (comma separated)",(s.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${u}
  </div>`}function gp(e){try{return new RegExp(e),!0}catch{return!1}}function Tl(e,n,t,i,a){let r=lp(t);return p`
    ${n.length===0?p`<div class="hint">No changes.</div>`:f}
    ${n.map((o,s)=>yp(e,o,s,t,(l,d)=>i(u=>{u[s]&&l(u[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Rt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${ur[o]}</option>`)}
    </select>`}var Fl=["setColor","setBorderColor","setBackgroundColor"];function yp(e,n,t,i,a,r,o){let s=!ai[i].includes(Ee[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${Ml(e,n,a,o)}
      ...
      ${pp(e,n,t,i,a)}`:bp(e,o.table,n[0],t,i,a,r)}function bp(e,n,t,i,a,r,o){let s=(k,F)=>e.update(D=>{let z=a(D);z&&k(z)},F?`${r}-${F}`:void 0),l=n.value??Qs.get(r)??o,d=n.rows.length===0,u=n.numberMode||d&&l!==void 0&&!Fs(l)&&vp(e.resolve(l)),c=ai[i],h=Ti.get(r)??new Set,m=n.columns.length===0&&h.size===0?[Ts[i]]:[],g=bs(n.columns,[...h,...m.filter(k=>k!==void 0)],c),v=t?e.liveBranch(t):"none",$=t?e.forced.get(t.id)??"live":"live",S=k=>$!=="live"&&($==="otherwise"?k==="otherwise":$.caseId===k),E=k=>{t&&e.setForced(t.id,S(k)?"live":k==="otherwise"?"otherwise":{caseId:k})},w=k=>{Qs.set(r,k),n.rows.length!==0&&s(F=>Cs(F,k),"lhs")},C=()=>s(k=>ks(k,l??R(""),u)),N=n.rows.map((k,F)=>tl(e,{key:`${r}-${k.caseId}`,label:Es(k.comparison,D=>fe(D,ge(e))),columns:g,changes:k.changes,live:v===k.caseId,forced:S(k.caseId),onForce:()=>E(k.caseId),when:Cp(e,k.comparison,`${r}-${k.caseId}`,(D,z)=>s(y=>{let x=y[0]?.cases.find(P=>P.id===k.caseId)?.when.tests[0];x&&D(x.comparison)},z&&`${k.caseId}-${z}`)),updChanges:(D,z)=>s(y=>{let x=y[0]?.cases.find(P=>P.id===k.caseId);x&&D(x.then)},z&&`${k.caseId}-${z}`),acts:p`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>s(D=>$s(D,k.caseId))}>${L("delete")}</button>`})),B=n.otherwise===void 0?f:tl(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:v==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(k,F)=>s(D=>{let z=D[0]?.otherwise;z&&k(z)},F),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(k=>Ya(k,!1))}>${L("close")}</button>`}),X=Fi.get(r),de=wp.filter(k=>c.includes(k)&&!g.includes(k));return p`
    <div class="states">
    ...
    ${n.columns.map(t=>p`<td>${kp(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function kp(e,n,t,i,a){let r=wi(t,n),o=or(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${et[n]} for this state`}
      @click=${d=>{i(u=>{u.push(Rt(ys[n]))}),Eu(d.target,o)}}>unchanged</button>`;let s=(d,u)=>i(c=>{let h=c.find(m=>Ee[m.kind]===n);h&&d(h)},u&&`${n}-${u}`),l=et[n];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${$p(e,r)}</button>
    ...
    </div>`}function $p(e,n){if(n.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return p`<span class="cell-word">Shown</span>`;let t=ri(n.kind);if(t==="number")return p`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return p`<span class="cell-word">${sr.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??R(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Fl.includes(n.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?$e(a):fe(i,ge(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??f}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${fe(i,ge(e))}</span>`}function $e(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Cp(e,n,t,i){let a=Mt(n.kind),r=Wa(n.kind),o=(s,l,d,u)=>Ep(e,s,l,`${t}-${d}`,r,u,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ve(s=>i(l=>{let d=Fa(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Ka.map(s=>p`<option value=${s} ?selected=${s===n.kind}>${Sp(s)}</option>`)}
    </select>
  ...
  </span>`}function Sp(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return tn[e]}}function Ep(e,n,t,i,a,r,o){let s=or(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return p`<span class="rhs">
    ...
    ${cl(e,s,o,n,t,l)}
  </span>`}var zn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:ka,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Ll(e){return zn.find(n=>n.kind===e)??zn[0]}var Il="#FF9F0A",_i="#8E8E93",Tp=["#FF453A","#FFD60A","#34C759"],_l=["#0A84FF","#34C759","#FF9F0A"];function Fp(e){return e?.attributes?.device_class==="battery"?Tp:_l}var Mp={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Rp(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Mp[pr(e)]??{off:"circle",on:"circle.fill"}}function Ip(e){switch(pr(e)){case"lock":return{kind:"equals",value:R("locked")};case"cover":case"valve":return{kind:"equals",value:R("open")};case"media_player":return{kind:"equals",value:R("playing")};default:return{kind:"isOn"}}}function pr(e){return e.domain||e.entityId.split(".")[0]||""}function vt(e){return{...e,domain:pr(e)}}function Ap(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function rn(e){return Math.round(e*1e4)/1e4}function Nt(e,n,t){return Math.min(t,Math.max(n,e))}function hr(e,n,t){let i=be[e],a=Nt(rn(n/i.width),0,1),r=Nt(rn(t/i.height),0,1);return{x:rn((1-a)/2),y:rn((1-r)/2),width:a,height:r,rotationDegrees:0}}function Hp(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:hr(e,t*1.3,t*1.3),size:t}}function Lp(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:hr(e,n.width*.88,t*1.7),size:t}}function _p(e){let n=be[e],t=Math.min(n.width,n.height)*.9;return{frame:hr(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function zl(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function zp(e){let n=be[e],t=Nt(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:rn(t/n.height),rotationDegrees:0}}}function Np(e){let n=be[e],t=Nt(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:rn(Nt(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Op(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Pp(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function yt(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Pp(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Xe());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function bt(e){return Ne(e)}function mr(e,n){let t={kind:{kind:"entityState",...vt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Al(e){let n=Rt("setIcon");return n.value=R(e),n}function zt(e){let n=Rt("setColor");return n.value=R(e),n}function Dp(e,n){let t=Fn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...vt(e)}},a.comparison=Ip(e);let r=n.on!==n.off;return i.then=r?[Al(n.on),zt(Il)]:[zt(Il)],t.otherwise=r?[Al(n.off),zt(_i)]:[zt(_i)],t}function Vp(e){let n=Fn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...vt(e)}},i.comparison={kind:"isUnavailable"};let a=Rt("setOpacity");return a.number=.35,t.then=[a],n}function Hl(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Bp(e,n,t=_l){let i=n.max-n.min,a=Hl(n.min+i/3),r=Hl(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:R(a)},changes:[zt(t[0])]},{comparison:{kind:"between",value:R(a),upper:R(r)},changes:[zt(t[1])]},{comparison:{kind:"greaterThan",value:R(r)},changes:[zt(t[2])]}];return vs(mr(e),o)}function Gp(e,n,t){let i=bt("icon"),a=Rp(n);return i.payload.symbol=R(a.off),i.payload.colorSlot.baseColorHex=_i,i.payload.rules=[Dp(n,a)],yt(e,i,t.family,Hp),e.elements.push(i),ti(e,i.payload.id,{type:"toggleEntity",...vt(n)}),i.payload.id}function Up(e,n,t){let i=bt("text");return i.payload.value=mr(n,t.state),i.payload.rules=[Vp(n)],yt(e,i,t.family,Lp),e.elements.push(i),i.payload.id}function Kp(e,n,t){let i=bt("gauge");i.payload.value=mr(n);let a=Ap(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Bp(n,a,Fp(t.state))],yt(e,i,t.family,_p),e.elements.push(i),i.payload.id}function Wp(e,n,t){let i=bt("chart");return i.payload.value={kind:{kind:"entityState",...vt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",yt(e,i,t.family,zl),e.elements.push(i),i.payload.id}function jp(e,n,t){let i=bt("chart");return i.payload.value={kind:{kind:"entityState",...vt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",yt(e,i,t.family,zl),e.elements.push(i),i.payload.id}function qp(e,n,t){let i=vt(n),a=bt("text");a.payload.value=R(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=_i,yt(e,a,t.family,Np),e.elements.push(a);let r=t.state?.attributes?.device_class,o=bt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=ha(i.domain,typeof r=="string"?r:void 0),yt(e,o,t.family,zp),e.elements.push(o),o.payload.id}function Yp(e,n,t){let i=bt("image");return i.payload.entity=vt(n),yt(e,i,t.family,Op),e.elements.push(i),i.payload.id}function Nl(e,n,t,i){switch(n){case"toggle":return Gp(e,t,i);case"status":return Up(e,t,i);case"gauge":return Kp(e,t,i);case"chart":return Wp(e,t,i);case"history":return jp(e,t,i);case"doorHistory":return qp(e,t,i);case"camera":return Yp(e,t,i)}}var Jp=3e4,Zp=500,Ol="preset-entity",Qp={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function fr(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function eh(e){return e.kind==="family"?"look":"content"}function gr(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}var Pl=300,Dl=360,Vl=44,Bl=22,th=[1,1.7,2.6],nh=["S","M","L"],Gl=["Small","Medium","Large"],Ul="wrist-assistant-panel.layers.v1",it=34,Ot=200,ih=720,zi=320,ah=80,rh=56,Kl="wrist-assistant-panel.columns.v2",yr=e=>Math.max(Ot,Math.min(ih,Math.round(e))),Wl=e=>e.metaKey||e.ctrlKey||e.shiftKey,oh=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Nn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",wt=Nn==="Cmd"?"\u2318":"Ctrl+",br=Nn==="Cmd"?"\u21E7":"Shift+";function jl(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-ah;if(i>=Ot*2+zi){let r=i-zi,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Ot,Math.floor(o*l)),s=Math.max(Ot,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Ot,o-d):s=Math.max(Ot,s-d))}return{columns:3,left:o,right:s}}let a=e-rh;return a>=Ot+zi?{columns:2,left:Math.min(n,a-zi),right:t}:{columns:1,left:n,right:t}}var I=class I extends ot{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Pl;this.colRight=Dl;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.pickerFilter="all";this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.recordPreviews=new Map;this.previewCase=Zt.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=us(()=>this.requestUpdate());this.imageSizes=ps(()=>this.requestUpdate());this.symbols=new gi(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new vi;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newChooserOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("newc"))||this.toggleNewChooser(!1)};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||sl(Ol)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Bi`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let t=window.localStorage.getItem(Kl);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=yr(i.left)),typeof i.right=="number"&&(this.colRight=yr(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Kl,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Ul);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Ul,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
        ...
        <label>Watch
          <select @change=${s=>{this.selectOwner(s.target.value)}}>
            ${this.owners.map(s=>p`<option value=${s.owner_watch_id} ?selected=${s.owner_watch_id===this.ownerId}>
              ${ql(s)} (${s.complication_count})</option>`)}
          </select>
        </label>
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${ql(a)}</option>`)}
              </select>
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(k,d)}</b>
          <small><span class="kind">${en[k.kind]}</span> · ${ch(k,u,this.historySeries,x.size)}</small>
          ${C?p`<span class="facts">${lh(this.host(),a,k,x).map(W=>p`<span class="fact"><b>${W.label}</b> ${W.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
      ...
      <h2 class="panel-title tools" style=${`--c:${te.place}`}><span class="swatch">${L("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${nh.map((k,F)=>p`
              <button class=${this.thumbStep===F?"on":""} title=${`${Gl[F]} row pictures`}
                aria-label=${`${Gl[F]} row pictures`} aria-pressed=${this.thumbStep===F?"true":"false"}
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Nl(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=si(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`
      ...
      </div>`}else r.kind==="family"?o=Sl(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${L("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([eh(r)]):new Set(rr)}}>${l?"One at a time":"Open all"}</button>`:f}
      </div>
