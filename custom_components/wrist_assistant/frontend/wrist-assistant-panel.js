...
`)}function td(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,rh(r));return{values:t,nullKeys:i}}function rh(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function so(e){let n=da(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function oh(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(Cr(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var sh=10800;function lh(e,n,t){let i=n==="always"||n==="auto"&&t<=sh;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function rd(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=lh(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function dh(e,n){return Rt(e)===void 0?[]:rd(Ye(e)*60,Hr(e.timeLabelCount),e.hourCycle,e.minutes,n)}function ch(e,n){return Yi(e)?rd(Math.round(e.historyMinutes)*60,Hr(ri(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function en(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ne(e){let n=e.trim(),t=en(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:en(i)}function uh(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ph(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function hh(e){let n=e.trim(),t=en(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?en(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=en(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function mh(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function fh(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function gh(e,n,t){if(Ce(n))return e;let i=n,a=e,r=en(e.trim()),o=i.duration?hh(e):void 0;if(o!==void 0)a=mh(o);else if(i.relativeTime&&r!==void 0)a=ph(r);else{let s=Ne(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):uh(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=fh(a);break}return a}function Sn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Qe(e,n=240){return od(e,n).map(t=>t.value)}function od(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function nd(e,n,t){let i=od(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Tt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ie,c=t.highColorHex??Re,u=t.lowColorHex??Fe,p=[],m=(y,x)=>{if(y==="")return;let $=p.at(-1);$&&$.colorHex===x?$.text+=y:p.push({text:y,colorHex:x})},g=0;return i.forEach((y,x)=>{m(e.slice(g,y.start),n);let $=x===o?c:x===s?u:l.length>0?Wi(y.value,l,d):n,S=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,S),$),g=S}),m(e.slice(g),n),p}function id(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function yh(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function gi(e,n=Mt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:bh(i.slice(a+1))})}return t}function bh(e){try{return decodeURIComponent(e)}catch{return e}}function vh(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function ad(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function xh(e,n,t){if(e===void 0)return 0;let i=Ne(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Ze=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=id(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Wt(n),i=jt(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let o=Qe(a),s=r===void 0?void 0:this.testedReading(n);return s!==void 0&&(o=[...o.slice(0,-1),s]),n.limit>0&&o.length>n.limit?n.takeFromEnd?o.slice(o.length-n.limit):o.slice(0,n.limit):o}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ne(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ne(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):id(a.get(s)??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ce(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?oh(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?pl(r):Cr(r,a.domainMax-a.domainMin));break}default:{let a=oo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return gh(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=en(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Sn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ne(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ne(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ne(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Jt(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Jt(d),p=c===void 0?void 0:Jt(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ae[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=nd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=dt(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(x=>x.text).join(""),y):(sl(n.payload)&&(y.spans=nd(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,x=m??p;y===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let $={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&($.path=y),$}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(B,N,J)=>B??(N?Ne(this.resolve(N)??""):void 0)??J,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),$=m===void 0?void 0:Ne(m),S=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&$!==void 0&&(S=Wi($,Tt(p),p.bandAboveColorHex));let k=x-y;if(p.total){let B=Ne(this.resolve(p.total)??"");B!==void 0&&(k=B)}let C=ad(k,1,Ki),D={kind:"gauge",...u,fraction:xh(m,y,x),style:p.style,lineWidth:p.lineWidth,colorHex:S,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:C,filledCount:ad($??0,0,C)};if(p.thresholdValue!==void 0&&x!==y){let B=(p.thresholdValue-y)/(x-y);B>=0&&B<=1&&(D.thresholdFraction=B)}return D}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y={min:m.domainMin,max:m.domainMax},x=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Tt(p),S=ul(p)?g.map(T=>Wi(T,$,p.bandAboveColorHex)):[],k=p.highlight==="highest"||p.highlight==="both",C=p.highlight==="lowest"||p.highlight==="both",D=qe(p),B={kind:"chart",...u,values:g,style:p.style,domainMin:y.min,domainMax:y.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:x,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:k?D.high:"none",lowMarker:C?D.low:"none",pointColorHexes:S,fillBands:p.fillBands,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:ch(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove};if(g.length>0){let T=k?g.indexOf(Math.max(...g)):-1,U=C?g.indexOf(Math.min(...g)):-1;T>=0&&(B.highIndex=T),U>=0&&U!==T&&(B.lowIndex=U)}let N=yh(p,y.min,y.max);N!==void 0&&(B.thresholdY=N);let J=this.chartNowIndex(p,g.length);return J!==void 0&&(B.nowIndex=J),B}case"timeline":{let p=n.payload,m=Rt(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=gi(g,Mt),x=vh(y,Ye(p)*60,S=>bl(S,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:dh(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};ct(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=[...$h(Ll(n,t).map(y=>this.resolveElement(y,i)),le[t==="inline"?"rectangular":t])],o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,x=this.resolve(y.value),$=x===void 0?void 0:Ne(x);if($!==void 0){let S=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),C={value:Math.min(k,Math.max(S,$)),minValue:S,maxValue:k===S?S+1:k,colorHexes:y.colorHexes},D=this.resolve(y.minLabel);D!==void 0&&(C.minLabel=D);let B=this.resolve(y.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function wh(e,n,t){let i=new Ze(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function ca(e,n,t){let i=new Ze(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=wh(e.inline,n,e)),a}function ua(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var kh=5;function lo(e,n){let t=e.values,i=Math.max(t.length,1),r=e.highIndex!==void 0&&e.highMarker!=="none"||e.lowIndex!==void 0&&e.lowMarker!=="none"?kh:0,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,c=Math.max(n.h-r-o*2,1),u=d+c,p=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?c*.12:0,y=Math.min(Math.max(e.barGap,0),l/(i*2)),x=Math.max((l-y*(i-1))/i,.5),$=k=>Math.min(1,Math.max(0,(k-e.domainMin)/p)),S=k=>u-$(k)*c;return{count:t.length,barWidth:x,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:m?u:S(0),yAtFraction(k){return u-Math.min(Math.max(k,0),1)*c},barRect(k){let C=s+k*(x+y),D=t[k],B,N;if(m){let J=g+$(D)*(c-g);B=u-J,N=u}else B=S(D),N=m?u:S(0),B>N&&([B,N]=[N,B]);return{x:C,y:B,w:x,h:Math.max(N-B,.5)}},point(k){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*k/(t.length-1):s+l/2,y:S(t[k])}},markerCenter(k,C){let D=C?this.barRect(k):void 0;return{x:D?D.x+D.w/2:this.point(k).x,y:n.y+r/2}}}}var fi=1;function pa(e,n){let t=Math.max(si,Math.min(li,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-fi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+fi:n.y,h:n.h-i-fi,cy:(e.labelsAbove?n.y+i+fi:n.y)+(n.h-i-fi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function $h(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;let o=Sh(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Ch(e,n){let t=n.values;if(t.length!==0)switch(e){case"highest":return t.indexOf(Math.max(...t));case"lowest":return t.indexOf(Math.min(...t));case"first":return 0;case"latest":return t.length-1;case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return}}function Sh(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=ua(t,i);if(a.w<=0||a.h<=0)return;let r=pa(t,a).body;if(r.w<=0||r.h<=0)return;let o=lo(t,r),s,l;if(lt(n.at)){let x=Ch(n.at,t);if(x===void 0)return;if(t.style==="bars"){let $=o.barRect(x);s=$.x+$.w/2,l=$.y}else{let $=o.point(x);s=$.x,l=$.y}}else{if(t.thresholdY===void 0)return;l=o.yAtFraction(t.thresholdY)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(x,$,S)=>$>S?($+S)/2:Math.min(Math.max(x,$),S),m={...e};if(s!==void 0){let x=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(x-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let x=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(x-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g+(n.dy??0),r.y+c/2,r.y+r.h-c/2);return m.y=(y-c/2)/i.height,m}var Se=le,yi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Se,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Tn=yi.find(e=>e.measured);function fd(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return yi.find(a=>a.screen.width===t&&a.screen.height===i)}function ma(e,n){let t=Se[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var po={regular:400,medium:500,semibold:600,bold:700},Th=1.15;function et(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ye(e,n,t="#FFFFFF"){let i=et(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var ft=e=>e*.55;function gd(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Eh(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Mh(e,n,t){if(t<=0||e.length*ft(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/ft(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Rh(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function yd(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function bd(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Fh(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function vd(e,n){return e.reduce((t,i)=>t+i.text.length*ft(i.look.fontSize*n),0)}function Ah(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:ft(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=ft(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Ih(e,n,t){if(t<=0||vd(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*ft(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*ft(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Hh(e,n,t){let i=Fh(n),a=e.lineLimit===2&&t.w>0?Ah(e.text,i,t.w):[e.text],r=yd(e.text,a),o=a.map((S,k)=>bd(S,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(S=>vd(S,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(S=>Ih(S,l,t.w)),{anchor:c,x:u}=gd(e.alignment,t),p=Math.max(0,...d.flat().map(S=>S.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=S=>S.map(k=>{let C=ye(k.look.colorHex,"fill");return w`<tspan font-size=${k.look.fontSize*l} font-weight=${po[k.look.fontWeight]??400} fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}),x=ye(e.colorHex,"fill"),$=d.length>1?w`${d.map((S,k)=>w`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*g}>${y(S)}</tspan>`)}`:y(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:Ph(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function Ph(e,n,t,i,a){let r=ye(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return w`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function Nh(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=pa(e,n),o=r?xd(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:w`${o}`;let s=zh(e,a);return o===void 0?s:w`${s}${o}`}function zh(e,n){let t=lo(e,n),i=ye(e.colorHex,"fill"),a=ye(e.highColorHex,"fill",e.colorHex),r=ye(e.lowColorHex,"fill",e.colorHex),o=(u,p)=>w`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${p.fill} fill-opacity=${p["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?ye(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let p=t.barRect(u),m=u===e.highIndex?a:u===e.lowIndex?r:d(u),g=Math.min(1.2,p.w/2,p.h/2);s.push(w`<rect x=${p.x} y=${p.y} width=${p.w} height=${p.h} rx=${g}
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?w`${s}${xd(e,n,t,i)}`:w`${s}`}function Dh(e,n){let t=ye(e.fillColorHex,"fill"),i=e.borderColorHex?et(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return w`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Vh(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ye(e.colorHex,"fill"),s=e.size*Th;return w`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var yo=.25,Bh=8;function Uh(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,yo),Bh),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+x)+0,width:m,height:g}}function fa(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var ha=4;function ga(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+ha:n.x+n.w-ha-a,d=e.timestampCorner.startsWith("top")?n.y+ha:n.y+n.h-ha-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Gh(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Kh(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ga(e,n,fa(new Date)):void 0,s=o?w`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,g])=>w`<rect data-ts-corner=${p} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=Uh(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=w`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
    ...
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Wh(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?jh(a,n):void 0;return w`
    ...
    ${o!==void 0?w`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${ho} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?w`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var ho=5;function jh(e,n){let t=ho*.55,i=n.w-2;if(n.h<ho*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function mo(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=ua(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=Lh(e,l);break;case"icon":c=Vh(e,l,t.icons);break;case"gauge":c=_h(e,l);break;case"chart":c=Nh(e,l);break;case"timeline":c=Oh(e,l);break;case"shape":c=Dh(e,l);break;case"image":c=Kh(e,l,t);break;case"tap":c=Wh(e,l,t.icons,a,d?ut(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,p=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,y=t.handles===!0&&(!s||o),x=g?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,$=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${S}${c}${$}${x}${C}</g>`}function ya(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function bo(e,n){return(n?23.5:34)*e}var sd=10.5;function wd(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function ld(e,n){let t=0;for(let i of e)t+=wd(i,n);return t}function dd(e,n,t){let i=e.toUpperCase(),a=d=>wd(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function fo(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function go(e,n,t,i){let a=fo(e,n,t),r=fo(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function kd(e,n,t,i){let{dial:a}=ya(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:go(a,t,i.start,i.end),length:t*r}}function qh(e,n){let t=ya(e,!0);return kd(e,n,t.dial.r,t.labelArc)}var cd=18.5,Yh=113,Xh={start:-71,end:-36},ud=104,Jh=6.2,pd={start:-77,end:-30.5};function hd(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function md(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=hd(e[i]),o=hd(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var uo=11;function Zh(e,n,t){let{dial:i}=ya(n,!0),a=ud*n,r=180/(Math.PI*ud),o=e.minLabel!==void 0?ld(e.minLabel,uo)*r:0,s=e.maxLabel!==void 0?ld(e.maxLabel,uo)*r:0,l=pd.start+(o>0?Math.max(0,o-1.8):0),d=pd.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let $=0;$<u;$++){let S=l+c*$/u,k=Math.min(d,l+c*($+1)/u+.4);p.push(w`<path d=${go(i,a,S,k)} fill="none"
      stroke=${md(e.colorHexes,($+.5)/u)} stroke-width=${Jh*n}
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${md(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?x(`${t}-gmin`,l-y-Math.max(o,3),l-y,e.minLabel):f}
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function ba(e,n){let t=e.family in Se?e.family:"rectangular",i=n.slot??Se[t],a=Se[t],r=ma(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=et(e.backgroundColorHex),l=et(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements;if(t==="corner"){let y=r.scale,x=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",k=ya(y,x),C=bo(y,x),D=C/(a.width*y),B=k.tile.cx-C/2,N=k.tile.cy-C/2,J=`M 0 0 H ${k.quad.width-k.cornerRadius} A ${k.cornerRadius} ${k.cornerRadius} 0 0 1 ${k.quad.width} ${k.cornerRadius} V ${k.quad.height} H 0 Z`,T=f;if(e.bezelGauge)T=Zh(e.bezelGauge,y,o);else if(e.bezelText){let X=qh(y,`${o}-bezel`),G=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Sn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;T=w`<defs><path id=${X.id} d=${X.d} /></defs>
        <text font-size=${sd*y} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${X.id}" startOffset="50%" text-anchor="middle">${dd(G,X.length,sd*y)}</textPath></text>`}let U=f;if(S){let X=et(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},G=kd(y,`${o}-curved`,Yh*y,Xh);U=w`<defs><path id=${G.id} d=${G.d} /></defs>
        <text font-size=${cd*y} font-weight="600" fill=${X.color} fill-opacity=${X.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${G.id}" startOffset="50%" text-anchor="middle">${dd($,G.length,cd*y*.88)}</textPath></text>`}else{let X=e.borderWidth*r.scale*D,G=l?w`<circle cx=${C/2} cy=${C/2} r=${C/2-X/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${X} />`:f;U=w`<g transform="translate(${B} ${N})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${fm(e)}</svg>`}var nt="color-mix(in srgb, var(--k) 45%, #6b7280)",Ma='system-ui, -apple-system, "Segoe UI", sans-serif';function Yd(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Ro(e,n,t,i){return w`<g fill="none" stroke-linecap="round">
    <path d=${Yd(e,n,t,1)} stroke=${nt} stroke-width="2.6" opacity=".5" />
    <path d=${Yd(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function gm(e){switch(e){case"text":return w`<g font-family=${Ma} text-anchor="middle">
    ...
    <input type="text" .value=${n} placeholder=${i.placeholder??""} list=${i.list??f}
      class=${i.mono?"mono":""} @input=${ge(t)} /></label>`}function Fc(e,n,t,i=3){return h`<label class="field"><span>${e}</span>
    ...
    </div>`}function Mm(e,n){let t=i=>It(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${_e(e.label,t(e))}
    <div class="pair-row">
    ...
    </span>`}function Zo(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function Ya(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Rm(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function cc(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var Ic=50;function Fm(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Am(e,n,t=Ic,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Im=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Hc(e){return Im.test(e.trim())}function Hm(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return Ya(t,i);if(Hc(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var rn=new Map;function ke(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Qo(e){return rn.has(e)}function it(e,n,t,i,a,r={}){let o=e.hass.states,s=rn.get(a),l=s?Am(Rm(o,r.domain,cc(e.hass)),s.query,Ic,r.preferNumeric?Fm:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(k,C,D=0)=>{rn.set(a,{query:C,index:D}),ke(k)},p=k=>{rn.delete(a),ke(k)},m=k=>{let C=Hm(k,t,o);C&&i(C)},g=(k,C)=>{i(Ya(o,k.entityId)),p(C)},y=()=>Math.max(0,Math.min(rn.get(a)?.index??0,l.length-1)),x=k=>{let C=k.target;if(k.key==="ArrowDown"||k.key==="ArrowUp"){k.preventDefault();let D=rn.get(a);if(!D){u(C,C.value);return}let B=k.key==="ArrowDown"?y()+1:y()-1;u(C,D.query,Math.max(0,Math.min(l.length-1,B))),Lm(C);return}if(k.key==="Enter"){k.preventDefault();let D=l[y()];s&&D?g(D,C):(m(C.value),p(C));return}if(k.key==="Escape"){if(!s)return;k.preventDefault(),k.stopPropagation(),p(C)}},$=t.entityId?cc(e.hass)?.(t.entityId):void 0,S=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${k=>{let C=k.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),rn.set(a,{query:"",index:0}),ke(C),C?.focus()}}>${O("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Hc(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,C)=>h`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${dc(k.domain)}</span>
                  <span class="ent-state">${k.state}</span>
                </span>
              </button>`)}
        </div>`:S}
  </div>`}function Lm(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var uc=120;function _m(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Ca.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Sa),fromPack:!1}}function pc(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Pm(e){return[{value:"",label:`Starter set (${pc(Sa,e)})`},...Ca.map(n=>({value:n.name,label:`${n.name} (${pc(n.symbols,e)})`}))]}function Nm(e){return e.length>0?e.length:Sa.length}function hc(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Aa(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Lc(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Ie),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=zm(u,c),x=k=>{t(k),a?.(k.startsWith(Ie)?e.icons.mdiPath?.(k):void 0),r.noteUsed(k)},$=k=>{if(t(k),!m)return;let C=k.trim();a?.(C.startsWith(Ie)?e.icons.mdiPath?.(C):void 0)},S=f;if(o&&g==="mdi"){let k=e.icons.mdiNames?.(),C=Om(k??[],s),D=C.slice(0,uc),B=r.recent.filter(N=>N.startsWith(Ie));S=h`<div class="sym-browse">
      ${mc(r,i,g)}
      ...
      ${k===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:C.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${hc(D.length,C.length,!0,k.length)}</div>`}
    ...
    </div>`}else if(o){let k=r.category(i),C=_m(k,s,d,c),D=$o(C.names,s),B=C.fromPack?D.slice(0,uc):D,N=r.recent.filter(T=>!T.startsWith(Ie)),J=c.size===0?N:N.filter(T=>c.has(T));S=h`<div class="sym-browse">
      ${m?mc(r,i,g):f}
      <div class="sym-controls">
      ...
      ${D.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${hc(B.length,D.length,s.trim()!=="",Nm(d))}
          </div>`}
    ...
    ${S}`}function zm(e,n){let t=e.trim();return t!==""&&!t.startsWith(Ie)&&n.size>0&&!n.has(t)}function Om(e,n){let t=n.trim(),i=t.startsWith(Ie)?t.slice(Ie.length):t,a=e.map(r=>r.startsWith(Ie)?r.slice(Ie.length):r);return $o(a,i).map(r=>Ie+r)}function mc(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Dm=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Vm={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Bm=[["bars","Bars"],["line","Line"],["area","Area"]],Um=[["auto","Auto"],["fixed","Fixed range"]],Gm=[["lowest","Lowest value"],["zero","Zero"]],es=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],fc=[["none","None"],["dot","Dot"],["triangle","Triangle"]],Wo=[["uniform","One colour"],["bands","By value"]];function Da(e){let n=[$r,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Y(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Y(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function Km(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Wm(e,n){let t=Tt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Y(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function jm(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function qm(e,n,t){let{lo:i,hi:a}=jm(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
    ...
    <button type="button" class="link add-band" @click=${()=>t(c=>{c.bands=[...c.bands,Wm(c.bands,n)]})}>+ Band</button>
    ...
    ${de("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??Et},"tother"),!1,Et)}`}var Jm=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],Zm={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function gc(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return A(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Qm=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function ef(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function se(e,n,t,i){if(i.inline||!tf())return h`<div class="value-editor">${zc(e,n,t,i)}</div>`;let a=Xa(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=$e(n,ce(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${_c(e,a,r,n,t,i)}
  </div>`}function _c(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Nc}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${Ei.has(n)?zc(e,i,a,r):f}
  </div>`}function ce(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Xa(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function tf(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Ei=new Set,ki=new WeakMap;function nf(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Pc(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Nc(e){let n=e.currentTarget,t=e.newState==="open",i=ki.get(n);if(i&&(i(),ki.delete(n)),!t){Ei.delete(n.id)&&ke(n);return}let a=nf(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ki.get(n)?.(),ki.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}zo(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ki.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),zo(n,a.getBoundingClientRect()),Ei.has(n.id)||(Ei.add(n.id),ke(n),requestAnimationFrame(()=>{n.isConnected&&zo(n,a.getBoundingClientRect())}))}function zo(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=af({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var an=8,Ia=6,yc=140;function af(e,n,t){let i=t.height-e.bottom-Ia-an,a=e.top-Ia-an,r=n.height>i&&a>i&&i<yc,o=Math.max(yc,r?a:i),s=Math.min(n.height,o),l=Math.max(an,Math.min(e.left,t.width-n.width-an)),d=r?Math.max(an,e.top-Ia-s):Math.max(an,Math.min(e.bottom+Ia,t.height-s-an));return{left:l,top:d,maxHeight:o,above:r}}function zc(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Dm.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Lc(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):be("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=it(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${it(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${be("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=pf(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Le("Field",a.timeField,Qm,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${Fc("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?ui(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>cf(e,n,t)}>Start an empty one</button>,
          ...
          ${Le("Number",a.stat,[...hn],p=>r({...a,stat:p}))}
          <div class="hint">${a.stat==="top"||a.stat==="bottom"?"One end of the plot's range: what the tallest or shortest mark means. On a Fixed scale that is the Min or Max the chart was given.":"Read from the readings the chart draws, after any trim. Decimals follow the chart's spread; set Decimals below to override, and Add unit to print the entity's unit after it."}</div>`;break}}let d=Vm[a.kind];return h`
    ${Le("Source",a.kind,s,c=>r(ef(a,c)))}
    ${d?h`<div class="hint">${d}</div>`:f}
    ${l}
    ${lf(n,i)?h`<div class="hint keep">
      <button type="button" class="link" title="Move this into a shared value that other layers can read too" @click=${()=>df(e,n,t)}>Make shared</button>
      so other layers can read this too.</div>`:f}
    ${i.noFormat?f:uf(n.format,c=>t(Ce(c)?{kind:n.kind}:{...n,format:c}),of(rf(e,n)))}
    ${i.showResolved?sf(e,n,e.resolve(i.resolveAs??n)):f}`}function rf(e,n){let t=n.kind;for(let i=0;t.kind==="named"&&i<8;i++){let a=t.id.toUpperCase(),r=e.config.values.find(o=>o.id.toUpperCase()===a);if(!r)return;t=r.value.kind}return t.kind==="named"?void 0:t}function of(e){if(!e)return{numbers:!0,textCase:!0,unit:!0,seconds:!0};switch(e.kind){case"literal":{let n=Ne(e.value)!==void 0;return{numbers:n,textCase:!n,unit:!1,seconds:n}}case"entityState":case"entityAttribute":case"jinja":case"named":return{numbers:!0,textCase:!0,unit:e.kind!=="jinja"&&e.kind!=="named",seconds:!0};case"entityAge":case"dataAge":return{numbers:!0,textCase:!1,unit:!1,seconds:!0};case"aggregate":return{numbers:!0,textCase:!1,unit:!1,seconds:!1};case"chartStat":{let n=e.stat==="trend";return{numbers:!n,textCase:!1,unit:!n,seconds:!1}}case"time":return{numbers:e.timeField!=="now",textCase:!1,unit:!1,seconds:!1}}}function sf(e,n,t){let i=t===void 0?h`<span class="readout-v now-v none">${Oc(e,n)}</span>`:t.trim()===""?h`<span class="readout-v now-v none">Empty</span>`:h`<span class="readout-v now-v"><span class="now-tok">${t}</span></span>`;return h`<div class="field readout now-field"><span>Now</span>${i}</div>`}function Oc(e,n){let t=n.kind;switch(t.kind){case"entityState":case"entityAttribute":case"entityAge":return t.entityId===""?"Pick an entity":e.hass.states[t.entityId]?t.kind==="entityAttribute"&&t.attribute.trim()===""?"Pick an attribute":t.kind==="entityState"?"No reading":"Waiting for Home Assistant":"No such entity";case"chartStat":return t.layer===""?"Pick a chart":"The chart has no readings yet";case"named":{if(t.id==="")return"Pick a shared value";let i=t.id.toUpperCase(),a=e.config.values.find(r=>r.id.toUpperCase()===i);return a?Oc(e,a.value):"That shared value is gone"}case"jinja":return t.value.trim()===""?"Type a template":"Waiting for Home Assistant";default:return"Waiting for Home Assistant"}}function lf(e,n){if(n.allowNamed===!1||n.noShare)return!1;let t=e.kind;return t.kind==="named"?!1:t.kind==="literal"||t.kind==="jinja"?t.value.trim()!=="":"entityId"in t?t.entityId!=="":t.kind==="chartStat"?t.layer!=="":!0}function df(e,n,t){let i=Ri(n,ce(e)).replace(/^"(.*)"$/,"$1"),{named:a,ref:r}=Xr(e.config,n,Ve(i,24));e.beginGesture(),e.update(o=>{o.values.push(a)}),t(r),e.endGesture()}function cf(e,n,t){let{named:i,ref:a}=Xr(e.config,{...n,kind:{kind:"literal",value:""}},"");i.name="",e.beginGesture(),e.update(r=>{r.values.push(i)}),t(a),e.endGesture(),e.selectValue(i.id)}function uf(e,n,t){let i=e??{},a=s=>{let l={...i,...s};for(let d of Object.keys(l))(l[d]===void 0||l[d]===!1||l[d]==="")&&delete l[d];n(l)},r=Ce(e),o={decimals:t.numbers||i.decimals!==void 0,multiply:t.numbers||i.multiply!==void 0,offset:t.numbers||i.offset!==void 0,textCase:t.textCase||i.textCase!==void 0,unit:t.unit||!!i.useEntityUnit,seconds:t.seconds||!!i.relativeTime||!!i.duration};return h`<details class="sub format" ?open=${!r}>
  ...
  </details>`}function pf(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${n.function==="count"?f:be("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Dc=zr,hf=Dc.filter(([e])=>e!=="none");function mf(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Vc(e,n){let t=mf(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return xl(e)?{type:e,...t}:{type:e}}var ff=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Bc(e,n,t,i){let a=n.serviceDataJSON??"",r=wl(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    ${Fc("Data (JSON)",a,s=>{let l={...n};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,t(l,"svc-data")},3)}
    ${r?h`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:h`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function gf(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function Uc(e){let n=e.config,t=n.tapAction,i=gf(e.savedName,n.name),a=n.refreshMinutes??0,r=bc.map(s=>[String(s),vc(s)]);bc.includes(a)||r.push([String(a),vc(a)]);let o=n.showSuccessFlash??!0;return h`
    <div class="gen-row">
      ${be("Name",n.name,s=>e.update(l=>{l.name=s},"name"))}
      ${Le("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Le("Tap action",t.type,Dc,s=>e.update(l=>{l.tapAction=Vc(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??yf).slice(0,7)}
    ...
    ${t.type==="callService"?Bc(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?bf(e):f}`}var yf="#808080",bc=[0,15,30,60,120];function vc(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function bf(e){let n=e.config;return Gc(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Gc(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Le("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Kc(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=ui(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
  ...
  </section>`}function Ef(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Mf(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Rf(e,n){let t=le[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Ff(e,n,t){let i=Rf(e,n),a=le[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Af(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function If(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Mf(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function In(e,n=Kt){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}var za=new Set;function jo(e,n,t=Kt){return za.has(e)||!t.some(i=>i.minutes===n)}function Do(e,n,t,i,a=Kt){let r=jo(e,n,a);return h`<label class="field">${_e("Span",{atDefault:n===t&&!r,title:`Back to ${In(t,a)}`,reset:()=>{za.delete(e),i(t)}})}
      ...
      </select></label>`}function Vo(e,n,t=!1){let i=t?Sr:qi,a=Math.floor(i/1440),r=t?ii:Kt,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Lf(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Ee(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Te(p,t,i,{frame:Fo(o,c)}),`${a}-${u}-${t}`),l=!Ba(o,ti)||r.isHidden,d=n.payload.chartAnchor;return xe(e,"placement","Position",h`
    ${_f(e,n,t)}
    ${d===void 0?h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
          ...
          bar is pushed down rather than off the top, and the bars never give up height to make room.</div>`}`}function Pf(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Pe(e.config,t)[0];return xe(e,"tappable","Tap",lg(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?ut(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>na(a,t))}:{}})}function kc(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${a}`}`}var Nf=[["number","Number"],["entity","Entity"]];function zf(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Of(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Df(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=zf(n,o),c=s?n.minValue:n.maxValue,u=y=>a(x=>{s?x.minValue=y??0:x.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${_e(l,d==="number"?It(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Nf.map(([y,x])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a($=>Of($,o,y))}}>${x}</button>`)}
      </span>
    ...
    ${r==="none"?f:h`
      ...
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var Si=new Map,Ci=new Map,gt=new Map,La=new Map,Bo=4,Uo=40,Bf=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Uf=[["plain","Plain"],["rich","Rich"]],Gf={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function ns(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Be("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function Kf(e){return e.countdown===!0?"countdown":dt(e)?"rich":"plain"}function Wf(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function jf(e,n){let t=mn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ve(e.kind.value,40)||"template"}:{kind:"value",label:Ri(e,n)}}function Xc(e,n,t){let i=mn(e.value),a=i===void 0?Ve(Ri(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ve(i,24)}"`;return`Part ${n+1}: ${a}`}function qf(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Xc(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function qo(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Yf(e,n){if(qo(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Tt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??ie],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function $c(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${Za(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Xf={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Jf(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${Za(e.moved.map(n=>Xf[n]))} moved into Look.`}function Zf(e,n,t,i,a){let r=n.payload,o=r.id,s=Kf(r),l=(r.parts?.length??0)>0,d=Or(e.config,r.value),c=gt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?Ci.get(o):void 0,m=(x,$)=>{let S=!(r.parts??[]).every(C=>C.value.kind.kind==="literal"),k=Fa(structuredClone(r),e.config.values);if(Ci.delete(o),!k.ok){gt.set(o,{text:$c(k.blocked),rich:!0,warn:!0}),ke($);return}gt.set(o,{text:Jf(k.joined?{joined:!0,template:S}:k),rich:!1}),i(C=>{Fa(C,e.config.values),x==="countdown"&&(C.countdown=!0)})},g=(x,$)=>{if(Ci.delete(o),s==="rich"){let S=x==="countdown"?"countdown":"plain",k=r.parts??[];if(k.length<2){m(S,$);return}let C=_o(k,e.config.values);C.ok?(gt.delete(o),Ci.set(o,S)):gt.set(o,{text:$c(C.blocked),rich:!0,warn:!0}),ke($);return}if(x==="rich"){let S=r.parts?.[0]?.id??Y();Si.set(o,S),gt.delete(o),i(k=>{delete k.countdown,lc(k,S)});return}gt.delete(o),i(S=>{if(x==="countdown"){S.countdown=!0;return}(S.parts?.length??0)>0&&Fa(S,e.config.values),delete S.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${Z("Type",s==="rich"?"rich":"plain",Uf,g,{titles:Gf})}
    ...
    ${s==="rich"?Qf(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Me(d,ce(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Qf(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ce(e),d=Math.max(0,o.findIndex(R=>R.id===Si.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Ee(e.config,t,n).size??r.fontSize,g=(R,b)=>{gt.delete(s),i(v=>{R(v),ll(v)},b)},y=(R,b)=>g(v=>{let M=v.parts?.find(E=>E.id===c.id);M&&R(M)},b?`part-${c.id}-${b}`:void 0),x=(R,b)=>{Si.set(s,R),gt.delete(s),ke(b)},$=(R,b)=>{let v=Y();Si.set(s,v),g(M=>{(M.parts??=[]).push({id:v,value:R})}),Pc(b,Xa(`${a}-part-${v}`),!0)},S=R=>g(b=>{b.parts&&Mi(b.parts,d,R)}),k=()=>{let R=o[d+1]??o[d-1];R&&Si.set(s,R.id),g(b=>{b.parts=(b.parts??[]).filter(v=>v.id!==c.id)})},C=o.map((R,b)=>{let v=jf(R.value,l),M=R.id===c.id,E=qo(R),L=v.kind==="value"?e.resolve(R.value):void 0,V=R.fontWeight===void 0?void 0:An.find(([K])=>K===R.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${M?"true":"false"} class="part-chip ${v.kind} ${M?"on":""}"
      aria-label=${Xc(R,b,l)} @click=${K=>x(R.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${Yf(R,p)}`}
    ...
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${R=>$(A(""),R.currentTarget)}>${O("text")}<span>Add text</span></button>
        <button type="button" class="small" title="Add a part that shows a live value"
          @click=${R=>$({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},R.currentTarget)}>${O("braces")}<span>Add value</span></button>
      </div>
    </div>
    <div class="part-editor">
      ...
      ${Z("Colour",N,Bf,R=>y(b=>{if(R==="layer"){delete b.colorHex,delete b.coloring;return}if(R==="pick"){delete b.coloring,b.colorHex=Zo(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Da(Qe(e.resolve(b.value)??"")))}),{def:"layer",titles:G,...B&&N!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <label class="field num part-size">${_e("Font size",J?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(R=>{delete R.fontSize})}:void 0,ja(c.fontSize??m,U,{step:1,min:Bo,max:Uo}))}
        ${qa(c.fontSize,R=>{R===void 0?y(b=>{delete b.fontSize},"size"):U(R)},{step:1,min:Bo,max:Uo,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:J?"Part font size":`Part font size, ${m} pt from the layer`,...J?{}:{lead:O("link")}})}
      </label>
    </div>
  </div>`}function Jc(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,v)=>e.update(M=>b(M.elements[r]),v?`${o}-${v}`:void 0),l=Ee(e.config,t,n),d=l.frame,c=(b,v)=>e.update(M=>Te(M,t,a,{frame:Fo(d,b)}),`${o}-${v}-${t}`),u=De(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],g=!1,y=b=>n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?f:de(b,n.payload.colorSlot.baseColorHex,v=>s(M=>{M.kind!=="image"&&M.kind!=="tap"&&M.kind!=="timeline"&&(M.payload.colorSlot.baseColorHex=v??"#FFFFFF")},"color"),!1,p),x,$;switch(n.kind){case"text":{let b=(v,M)=>s(E=>v(E.payload),M);x=Zf(e,n,t,b,o),g=!n.payload.countdown&&!dt(n.payload),$=h`
        ...
        ${Mm({label:"Align",value:n.payload.alignment??"center",options:wf,def:"center",set:v=>s(M=>{let E=M.payload;v==="center"?delete E.alignment:E.alignment=v})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:kf,def:"1",set:v=>s(M=>{let E=M.payload;v==="2"?E.lineLimit=2:delete E.lineLimit})})}
        ...
        ${g?Vf(e,n.payload,b,y("Main colour")):f}`;break}case"icon":x=h`
        ...
        ${M?h`
            ${se(e,b.total??gc(b),E=>v(L=>{L.total=E},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Ki} dots are drawn.</div>`:Df(e,b,{min:u.minValue,max:u.maxValue},o,v)}`,g=!0,$=h`
        <div class="grid2">
          ${Z("Style",b.style,Jm,E=>v(L=>{E==="dots"&&L.total===void 0&&(L.total=gc(L)),E!=="dots"&&delete L.total,L.style=E}),{titles:Zm,def:u.style})}
        ...
        ${M?f:h`
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,v=(H,z)=>s(dn=>H(dn.payload),z),M=qe(b),E=kr(u.marker),L=u.historyMinutes,V=u.historyPoints,K=b.historyMinutes>0,fe=K&&b.source==="statistics",at=K&&!fe,Ln=K?fe?"statistics":"history":"value",_n=fe?ii:Kt,we=Wt(b)??jt(b),he=b.value.kind.kind==="entityState",rt=we===void 0?void 0:e.historySeries(we),Nu=K&&he?rt??"":e.resolve(b.value)??"",ot=b.historyPoints<1,gs=jo(a,b.historyMinutes,_n),We=Qe(Nu),Nt=b.limit>0&&We.length>b.limit?b.takeFromEnd?We.slice(We.length-b.limit):We.slice(0,b.limit):We,zu=!K&&he&&We.length===1,tr=e.config.elements.filter(H=>H.kind==="chart"&&H.payload.id!==a),Ou=ce(e),nr=b.scaleFrom!==void 0&&tr.some(H=>H.payload.id===b.scaleFrom);x=h`
        ${se(e,b.value,H=>v(z=>{z.value=H},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${Z("Draw",Ln,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],H=>v(z=>{if(H==="value"){z.historyMinutes=0;return}z.source=H==="statistics"?"statistics":"history";let dn=z.historyMinutes||ji;z.historyMinutes=H==="statistics"?Math.min(dn,Sr):Math.min(dn,qi)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${fe?h`
            ...
            <div class="grid2">
              ...
              ${Z("Per",b.statPeriod,Ui,H=>v(z=>{z.statPeriod=H}),{def:Qn})}
            </div>
                ...
                <div class="readings-row">
                  ...
                  ${ot?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${ge(H=>{let z=Number(H);H.trim()!==""&&Number.isFinite(z)&&z>=1&&v(dn=>{dn.historyPoints=Math.round(z)},"hpoints")})} />
        ...
        ${We.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${Ef(Nt)}</span>${We.length===Nt.length?h` · ${Nt.length} ${Nt.length===1?"value":"values"}`:h` · ${Nt.length} of ${We.length}`}</span></div>`:f}
        ${zu?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        <div class="grid2">
          ${Z("Style",b.style,Bm,H=>v(z=>{z.style=H}),{def:u.style})}
        ...
        <div class="grid2">
          ${Z("Scale",b.scale,Um,H=>v(z=>{z.scale=H}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${Z("Baseline",b.baseline,Gm,H=>v(z=>{z.baseline=H}),{def:u.baseline})}
        </div>
        ${tr.length===0?f:Le("Same scale as",nr?b.scaleFrom:"",[["","Its own"],...tr.map(H=>[H.payload.id,Me(H,Ou)])],H=>v(z=>{H?z.scaleFrom=H:delete z.scaleFrom}),{def:""})}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let H;e.update(z=>{H=Ol(z,a)}),H&&e.selectLayer(H)}}>${O("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ...
        ${b.highlight==="none"?f:h`
          <div class="grid2">
            ${b.highlight==="lowest"?f:de("Highest colour",b.highColorHex,H=>v(z=>{z.highColorHex=H??Re},"hicol"),!1,Re)}
            ${b.highlight==="highest"?f:de("Lowest colour",b.lowColorHex,H=>v(z=>{z.lowColorHex=H??Fe},"locol"),!1,Fe)}
          </div>
        ...
        ${rg(e,n,M,E,v)}
        ${Be("Threshold",b.thresholdValue!==void 0,H=>v(z=>{H?z.thresholdValue=Km(Nt):delete z.thresholdValue}))}
        ...
        ${Yi(b)?kc(b,v,u,"cl",h`
            <div class="hint">Clock times from the start of the span to now, evenly spaced, in a row of
              ...
              Recorded history.</div>`}`;break}case"timeline":{let b=n.payload,v=(we,he)=>s(rt=>we(rt.payload),he),M=u.historyMinutes,E=b.value.kind.kind==="entityState",L=Rt(b),V=L===void 0?void 0:e.historySeries(L),K=Ye(b)*60,fe=gi(V??"",Mt),at=jo(a,b.historyMinutes),Ln=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,_n=Ym(fe,K,Ln===void 0?void 0:e.hass.states[Ln]?.state,Ln?.split(".")[0]);x=h`
        ...
        ${fe.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${If(fe,K)}</span></span></div>`:f}
        ${Af(fe)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${Xm(b,v,_n,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${n.payload.kind==="line"?Ff(t,d,c):f}`,$=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,b=>s(v=>{v.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        <div class=${b.contentMode==="fit"&&b.zoom===1?"hint keep":"hint"}>${Sf(b)}</div>
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let S=g||n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&dt(n.payload)?"Layer colour":"Colour"),k=Wr(e.config,n),C=k?{kind:{kind:"entityState",...k}}:void 0,D=n.kind==="image"?n.payload.timestamp===!0:!1,B=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,N=tg[n.kind],J=ng[n.kind],T=wc(n.payload,u,N),U=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,X=e.config.perFamily[t]?.placements[a]?.size!==void 0,G=wc(n.payload,u,J)||U!==void 0&&l.size!==void 0&&l.size!==u[U],pe=qt(e.config,a),R=(b,v)=>()=>s(M=>Oo(M.payload,u,b),v);return h`
    ${xe(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"?f:Yc(e,n,o)}${x}`,{color:Q.content,icon:"content",summary:ts(e,n),...T?{reset:()=>s(b=>{Oo(b.payload,u,N),b.kind==="text"&&wi(b.payload.rules)},"reset-content")}:{}})}
    ...
    ${n.kind==="chart"?xe(e,"numbers","Extras",sg(e,n),{color:Q.numbers,icon:"text",summary:og(e,n),...pe.length>0||Yt(e.config,a).length>0?{reset:()=>e.update(b=>{for(let v of qt(b,a))Xe(b,v.payload.id);for(let v of Yt(b,a))Xe(b,v.payload.id)})}:{}}):f}
    ${n.kind==="image"?xe(e,"timestamp","Timestamp",Tf(n.payload,(b,v)=>s(M=>b(M.payload),v)),{color:Q.numbers,icon:"clock",summary:D?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...D?{reset:R(eg,"reset-stamp")}:{}}):f}
    ${xe(e,"states","States",ou(e,n.payload.rules,n.kind,b=>b.elements.find(v=>v.payload.id===a)?.payload.rules,`rules-${a}`,C,B),{color:Q.states,icon:"states",summary:bi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Lf(e,n,t)}
    ${i.tap===!1?f:Pf(e,n)}`}var eg=["timestamp","timestampCorner","timestampSize"],tg={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},ng={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function Zc(e,n,t,i){let a=n.action;return h`
    ${Le("Tap action",a.type,hf,r=>t(o=>{o.action=Vc(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?it(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?Bc(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?Gc(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var ig=24;function ag(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Nl(e.config,n,r);o&&(t.push(`${te(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<ig;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function rg(e,n,t,i,a){if(!Rl(n))return f;let r=n.payload;return h`
    <div class="grid2">
      ${r.highlight==="lowest"?f:Z("Highest marker",t.high,fc,o=>a(s=>{Gi(s,{...qe(s),high:o})}),{def:i.high})}
      ${r.highlight==="highest"?f:Z("Lowest marker",t.low,fc,o=>a(s=>{Gi(s,{...qe(s),low:o})}),{def:i.low})}
    </div>
    <div class="field list-field"><span>Markers</span>
      <div class="chips">
        <button class="small" title="Turn these two marks into layers you can restyle"
          @click=${()=>e.update(o=>{Fl(o,r.id)})}>${O("plus")}<span>Move to layers</span></button>
      </div>
    </div>
    <div class="hint">These marks are drawn by the chart itself, which is why they are one of three
      ...
      emoji, any size, any colour, sitting over its own bar instead of in a band along the top.</div>`}function Cc(e,n,t){let i=n.payload,a=t==="now"?i.drawsNowLine!==!1:i.drawsThreshold!==!1,r=t==="now"?"now line":"threshold line";if(a)return h`
      ...
      </div>`;let o=Yt(e.config,i.id).some(s=>s.payload.chartAnchor?.at===t);return h`
    ${o?f:h`
      <div class="field list-field"><span>Line</span>
        <div class="chips">
    ...
    <div class="hint">${o?`The ${r} is a layer in Extras, so its colour, thickness and style are set there. The number here still decides where it sits.`:`The ${r} was moved to a layer that has since been deleted, so nothing draws it.`}</div>`}function og(e,n){let t=qt(e.config,n.payload.id),i=Yt(e.config,n.payload.id);if(t.length===0&&i.length===0)return"None yet";let a=t.map(r=>{let o=r.payload.value.kind;return o.kind==="chartStat"?(hn.find(([s])=>s===o.stat)?.[1]??"number").toLowerCase():"number"});for(let r of i){let{at:o,place:s}=r.payload.chartAnchor,l=(Gt.find(([d])=>d===o)?.[1]??"reading").toLowerCase();a.push(s==="through"?`${l} line`:`${l} marker`)}return a.join(" \xB7 ")}function sg(e,n){let t=ce(e),i=qt(e.config,n.payload.id),a=Yt(e.config,n.payload.id),r=c=>e.update(u=>{El(u,n.payload.id,c)}),o=c=>e.update(u=>{Dr(u,n.payload.id,c)}),s=new Set(i.map(c=>c.payload.value.kind.kind==="chartStat"?c.payload.value.kind.stat:"")),l=new Set(a.map(c=>c.payload.chartAnchor.at)),d=(c,u,p,m)=>h`
    <div class="num-row">
    ...
    ${i.length===0&&a.length===0?h`<div class="hint keep">A chart on its own shows that a reading moved, not what it moved to and not
        ...
        <div class="field list-field"><span>Shown</span>
          <div class="chart-numbers">
            ...
            ${a.map(c=>{let{at:u,place:p}=c.payload.chartAnchor,m=(Gt.find(([y])=>y===u)?.[1]??"reading").toLowerCase();if(p==="through")return d(c.payload.id,u==="threshold"?"\u2500":"\u2502",`line through the ${m}`,"line");let g=c.kind==="text"?e.resolve(c.payload.value)??"\u25CF":"\u25C6";return d(c.payload.id,g,`over the ${m}`,"marker")})}
          </div>
        </div>
    ...
    <div class="field list-field"><span>Line</span>
      <div class="adders">
        ${Al.map(([c,u])=>{let p=c==="threshold"&&n.payload.thresholdValue===void 0;return h`
    ...
    <div class="hint">A marker starts as a character over the reading it names, so type any glyph or emoji into it:
      ...
      sits on.</div>`}function lg(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Pe(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=jr(e.config,n);return h`
    ...
    ${a?h`<div class="value-editor">
        ...
        ${ag(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${ut(o)}</b>.</div>`}`}function Sc(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Me(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=Gt.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return Sc($e(e.payload.value,n));case"icon":return Sc($e(e.payload.symbol,n));case"gauge":return $e(e.payload.value,n);case"chart":return $e(e.payload.value,n);case"timeline":return $e(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}}}function Qc(e,n){let t=ht(e.config,n.id),i=ce(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return xe(e,"content","Group",h`
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:Q.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function eu(e,n){if(n==="inline")return dg(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${te(n)} yet.</div>
    ...
    ${xe(e,"symbol","Symbol",h`
      ${Lc(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:Q.look,icon:"icon",summary:n.symbol||"None"})}`}function cg(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="gauge"&&n.bezelGauge?ug(e,n.bezelGauge,t):f}`}function ug(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Av=ne.map(e=>[e,te(e)]),is={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},pg=Object.keys(is),Ga=["color","text","fontSize","fontWeight","visibility"];function hg(e,n=!1){let t=oa[e].filter(i=>!n||Ga.includes(i));return pg.filter(i=>t.includes(Ae[i]))}function tu(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${qf(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var mg={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function _a(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Ve(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function nu(e){if(!e||Ce(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function $e(e,n){return`${Ri(e,n)}${nu(e.format)}`}function Ri(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Ve(t.value,40)}"`:"(empty)";case"entityState":return _a(t,n);case"entityAttribute":return t.attribute?`${_a(t,n)} \xB7 ${t.attribute}`:_a(t,n);case"entityAge":return`age of ${_a(t,n)}`;case"aggregate":return fg(t.aggregate);case"time":return mg[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Ve(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(hn.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Ri(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function fg(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Mi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function gg(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.cases.map((m,g)=>bg(e,m,g,n,a,u,`${o}-${m.id}`,p))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${iu(e,n.otherwise,a,m=>u(g=>{g.otherwise&&m(g.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function bg(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(g=>g.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${d?h` <span class="ok">· active now</span>`:f}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>Mi(c.cases,t,t-1))}>${O("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>Mi(c.cases,t,t+1))}>${O("down")}</button>
    ...
    ${n.when.tests.map((c,u)=>vg(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(no())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=sc(p,nc(e.hass?.states));l(g=>{g.when.tests.push(...m)})}}>
        <option value="">+ preset…</option>
        ${rc.map(c=>h`<option value=${c.kind} title=${c.hint}>${c.label}</option>`)}
      </select>
    </div>
    <div class="hint keep" style="margin-top:8px">Then:</div>
    ${iu(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function vg(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=Zt(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=se(e,s.value??A(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${se(e,s.value??A(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ...
        ${s.pattern&&!xg(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Tc(e,"From",s.value??A("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Tc(e,"To",s.upper??A("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=wg(n.value)?kg(s.options??[],u=>o(p=>{p.comparison.options=Ho(u)},"options")):be("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Le("Comparison",s.kind,Kl.map(u=>[u,Rn[u]]),u=>o(p=>{p.comparison=ao(p.comparison,u)}))}
    ${c}
  </div>`}function xg(e){try{return new RegExp(e),!0}catch{return!1}}function Tc(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Jt(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${ge(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function wg(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function kg(e,n){let t=ac(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${ic.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function iu(e,n,t,i,a,r=!1){let o=hg(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>$g(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Qt(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${is[s]}</option>`)}
    </select>`}var au=["setColor","setBorderColor","setBackgroundColor"];function $g(e,n,t,i,a,r,o,s=!1){let l=!oa[i].includes(Ae[n.kind]),d=s&&!l&&!Ga.includes(Ae[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${ru(e,n,a,o)}
  </div>`}function ru(e,n,t,i){let a=sa(n.kind),r=f;if(a==="value"){let o=n.value??A("");if(au.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?de("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=A(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${gg(e,n,t,i,a,o)}`:Cg(e,s.table,n[0],t,i,a,r,o)}function Cg(e,n,t,i,a,r,o,s){let l=(v,M)=>e.update(E=>{let L=a(E);L&&v(L)},M?`${r}-${M}`:void 0),d=n.value??Ec.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!qd(d)&&Sg(e.resolve(d)),p=oa[i],m=Pa.get(r)??new Set,g=n.columns.length===0&&m.size===0?[jd[i]]:[],y=zd(n.columns,[...m,...g.filter(v=>v!==void 0)],p),x=La.get(r),$=t?t.partId:s?.some(v=>v.id===x)?x:void 0,S=s!==void 0&&$!==void 0,k=S?p.filter(v=>Ga.includes(v)):p,C=S?y.filter(v=>!Ga.includes(v)):[],D=(v,M)=>{if(!t){v?La.set(r,v):La.delete(r),ke(M);return}l(E=>{let L=E[0];L&&(v?L.partId=v:delete L.partId)})},B=t?e.liveBranch(t):"none",N=t?e.forced.get(t.id)??"live":"live",J=v=>N!=="live"&&(N==="otherwise"?v==="otherwise":N.caseId===v),T=v=>{t&&e.setForced(t.id,J(v)?"live":v==="otherwise"?"otherwise":{caseId:v})},U=v=>{Ec.set(r,v),n.rows.length!==0&&l(M=>Gd(M,v),"lhs")},X=()=>{La.delete(r),l(v=>{Bd(v,d??A(""),u),$!==void 0&&v[0]&&v[0].partId===void 0&&(v[0].partId=$)})},G=n.rows.map((v,M)=>Rc(e,{key:`${r}-${v.caseId}`,label:Wd(v.comparison,E=>$e(E,ce(e))),columns:y,changes:v.changes,live:B===v.caseId,forced:J(v.caseId),onForce:()=>T(v.caseId),when:Fg(e,v.comparison,`${r}-${v.caseId}`,(E,L)=>l(V=>{let K=V[0]?.cases.find(fe=>fe.id===v.caseId)?.when.tests[0];K&&E(K.comparison)},L&&`${v.caseId}-${L}`)),updChanges:(E,L)=>l(V=>{let K=V[0]?.cases.find(fe=>fe.id===v.caseId);K&&E(K.then)},L&&`${v.caseId}-${L}`),acts:h`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>Ud(E,v.caseId))}>${O("delete")}</button>`})),pe=n.otherwise===void 0?f:Rc(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:B==="otherwise",forced:J("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(v,M)=>l(E=>{let L=E[0]?.otherwise;L&&v(L)},M),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(v=>Mo(v,!1))}>${O("close")}</button>`}),R=Na.get(r),b=Tg.filter(v=>k.includes(v)&&!y.includes(v));return h`
    <div class="states">
      ${se(e,d??A(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:tu(s,$,ce(e),D)}
      ...
      ${R===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${tt[R]} column? Its ${Mc(n,R)} value${Mc(n,R)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${v=>{Na.delete(r),Pa.get(r)?.delete(R),ke(v.target),l(M=>Kd(M,R))}}>Remove</button>
    ...
    </div>`}function Sg(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var Tg=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Mc(e,n){let t=0;for(let i of e.rows)Ea(i.changes,n)&&(t+=1);return e.otherwise&&Ea(e.otherwise,n)&&(t+=1),t}function Eg(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Rc(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{Eg(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${Mg(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Mg(e,n,t,i,a){let r=Ea(t,n),o=Xa(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${tt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Qt(Nd[n]))}),Pc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Ae[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=tt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Rg(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Nc}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${Ei.has(o)?h`${n==="visibility"?Z("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):ru(e,r,s,a)}
    ...
    <select class="when-op" title="How this state is decided" @change=${ge(s=>i(l=>{let d=ao(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Co.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Ag(s)}</option>`)}
    </select>
  ...
  </span>`}function Ag(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return Rn[e]}}function Ig(e,n,t,i,a,r,o){let s=Xa(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${_c(e,s,o,n,t,l)}
  </span>`}var Fi=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Kr,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function cu(e){return Fi.find(n=>n.kind===e)??Fi[0]}var su="#FF9F0A",Qa="#8E8E93",Hg=["#FF453A","#FFD60A","#34C759"],uu=["#0A84FF","#34C759","#FF9F0A"];function Lg(e){return e?.attributes?.device_class==="battery"?Hg:uu}var _g={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Pg(e){let n=e.iconName?.trim();return n?{off:n,on:n}:_g[as(e)]??{off:"circle",on:"circle.fill"}}function Ng(e){switch(as(e)){case"lock":return{kind:"equals",value:A("locked")};case"cover":case"valve":return{kind:"equals",value:A("open")};case"media_player":return{kind:"equals",value:A("playing")};default:return{kind:"isOn"}}}function as(e){return e.domain||e.entityId.split(".")[0]||""}function _t(e){return{...e,domain:as(e)}}function zg(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Hn(e){return Math.round(e*1e4)/1e4}function sn(e,n,t){return Math.min(t,Math.max(n,e))}function rs(e,n,t){let i=Se[e],a=sn(Hn(n/i.width),0,1),r=sn(Hn(t/i.height),0,1);return{x:Hn((1-a)/2),y:Hn((1-r)/2),width:a,height:r,rotationDegrees:0}}function Og(e){let n=Se[e],t=sn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:rs(e,t*1.3,t*1.3),size:t}}function Dg(e){let n=Se[e],t=sn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:rs(e,n.width*.88,t*1.7),size:t}}function Vg(e){let n=Se[e],t=Math.min(n.width,n.height)*.9;return{frame:rs(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function pu(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Bg(e){let n=Se[e],t=sn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Hn(t/n.height),rotationDegrees:0}}}function Ug(e){let n=Se[e],t=sn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Hn(sn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Gg(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Kg(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function Ht(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Kg(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=mt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function Lt(e){return De(e)}function os(e,n){let t={kind:{kind:"entityState",..._t(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function lu(e){let n=Qt("setIcon");return n.value=A(e),n}function on(e){let n=Qt("setColor");return n.value=A(e),n}function Wg(e,n){let t=pi(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",..._t(e)}},a.comparison=Ng(e);let r=n.on!==n.off;return i.then=r?[lu(n.on),on(su)]:[on(su)],t.otherwise=r?[lu(n.off),on(Qa)]:[on(Qa)],t}function jg(e){let n=pi(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",..._t(e)}},i.comparison={kind:"isUnavailable"};let a=Qt("setOpacity");return a.number=.35,t.then=[a],n}function du(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function qg(e,n,t=uu){let i=n.max-n.min,a=du(n.min+i/3),r=du(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:A(a)},changes:[on(t[0])]},{comparison:{kind:"between",value:A(a),upper:A(r)},changes:[on(t[1])]},{comparison:{kind:"greaterThan",value:A(r)},changes:[on(t[2])]}];return Od(os(e),o)}function Yg(e,n,t){let i=Lt("icon"),a=Pg(n);return i.payload.symbol=A(a.off),i.payload.colorSlot.baseColorHex=Qa,i.payload.rules=[Wg(n,a)],Ht(e,i,t.family,Og),e.elements.push(i),ta(e,i.payload.id,{type:"toggleEntity",..._t(n)}),i.payload.id}function Xg(e,n,t){let i=Lt("text");return i.payload.value=os(n,t.state),i.payload.rules=[jg(n)],Ht(e,i,t.family,Dg),e.elements.push(i),i.payload.id}function Jg(e,n,t){let i=Lt("gauge");i.payload.value=os(n);let a=zg(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[qg(n,a,Lg(t.state))],Ht(e,i,t.family,Vg),e.elements.push(i),i.payload.id}function Zg(e,n,t){let i=Lt("chart");return i.payload.value={kind:{kind:"entityState",..._t(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",Ht(e,i,t.family,pu),e.elements.push(i),i.payload.id}function Qg(e,n,t){let i=Lt("chart");return i.payload.value={kind:{kind:"entityState",..._t(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",Ht(e,i,t.family,pu),e.elements.push(i),i.payload.id}function ey(e,n,t){let i=_t(n),a=Lt("text");a.payload.value=A(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=Qa,Ht(e,a,t.family,Ug),e.elements.push(a);let r=t.state?.attributes?.device_class,o=Lt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=_r(i.domain,typeof r=="string"?r:void 0),Ht(e,o,t.family,Bg),e.elements.push(o),o.payload.id}function ty(e,n,t){let i=Lt("image");return i.payload.entity=_t(n),Ht(e,i,t.family,Gg),e.elements.push(i),i.payload.id}function hu(e,n,t,i){switch(n){case"toggle":return Yg(e,t,i);case"status":return Xg(e,t,i);case"gauge":return Jg(e,t,i);case"chart":return Zg(e,t,i);case"history":return Qg(e,t,i);case"doorHistory":return ey(e,t,i);case"camera":return ty(e,t,i)}}var ny=/^[a-z0-9_]+\.shared_(\d+)$/;function mu(e){return ny.test(e)}function iy(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function gu(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function yu(e,n){let t=new Map;for(let i of to(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=gu(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${iy(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function ay(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);Qr(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),eo(t,r=>Yr(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function bu(e){let n=!1;return ra(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function ry(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function vu(e,n,t=[]){let i=n==="share"?ay(e,t):e,a=wn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${ry(a)}
`}function xu(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var oy="There is nothing to read here. Paste a complication first.",sy="This is not valid JSON. Check for a missing brace or a stray comma.",ly="This is valid JSON but not a complication. A complication starts with { and ends with }.",dy="This does not look like a complication.",fu="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",cy="00000000-0000-4000-8000-000000000000";function uy(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function wu(e,n){let t=e.trim();if(t==="")return{ok:!1,error:oy};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:sy}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:ly};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${fu}`};let o={...a,id:cy,slotIndex:0},s;try{s=xn(o)}catch(d){let c=d instanceof Oe||d instanceof Error?d.message:String(d);return{ok:!1,error:`${dy}

${uy(c)}`}}let l=Qi(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${fu}`}}return{ok:!0,config:s,raw:i}}function ss(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=to(e,(o,s)=>mu(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=mu(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:gu(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function ku(e,n){let t=structuredClone(e);Qr(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return eo(t,a=>Yr(a,i)),t}function $u(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function py(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Cu(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=va(e);return i.length===0?t:`${t}, ${py(i)}`}function ls(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var my=3e4,fy=500,gy=3e4,Su="preset-entity";function Tu(e){return`import-entity-${e}`}var yy={entityId:"",displayName:"",domain:""},by=new Map,vy={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function ds(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function xy(e){return e.kind==="family"?"look":"content"}function cs(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Eu(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function wy(e){let n=w`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?w`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?w`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?w`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:w`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Mu=300,Ru=360,hs=44,ms=22,Pu=[1,1.7,2.6],ky=["S","M","L"],Fu=["Small","Medium","Large"];function $y(){return Pu.map((e,n)=>{let t=Math.round(hs*e),i=Math.round(ms*e),a=`.layers-card.s${n}`;return`
...
`)}var Au="wrist-assistant-panel.layers.v1",yt=34,ln=200,Cy=720,er=320,Sy=80,Ty=56,Iu="wrist-assistant-panel.columns.v3",us=e=>Math.max(ln,Math.min(Cy,Math.round(e))),Hu=e=>e.metaKey||e.ctrlKey||e.shiftKey,Ey=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Ai=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Pt=Ai==="Cmd"?"\u2318":"Ctrl+",ps=Ai==="Cmd"?"\u21E7":"Shift+";function Lu(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Sy;if(i>=ln*2+er){let r=i-er,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(ln,Math.floor(o*l)),s=Math.max(ln,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(ln,o-d):s=Math.max(ln,s-d))}return{columns:3,left:o,right:s}}let a=e-Ty;return a>=ln+er?{columns:2,left:Math.min(n,a-er),right:t}:{columns:1,left:n,right:t}}var I=class I extends xt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Mu;this.colRight=Ru;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=Tn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Id(()=>this.requestUpdate());this.imageSizes=Hd(()=>this.requestUpdate());this.symbols=new $a(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Ta;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=ss(a,this.hass.states);r.some(s=>Qo(Tu(s.entityId)))||ls({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Qo(Su)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??by}static{this.styles=ar`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Ka,this.scrubStart),this.addEventListener(Wa,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},gy)}loadColumnWidths(){try{let t=window.localStorage.getItem(Iu);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=us(i.left)),typeof i.right=="number"&&(this.colRight=us(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Iu,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Au);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Au,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>jc(s,o,i))}>Copy the ${te(o)} layout</button>`)}
          </div>
        ...
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${_u(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Eu()}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${Rd(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
      ...
      ${a("all","All",t.length)}
      ${tn.map(r=>a(r,te(r),t.filter(o=>i(o).includes(r)).length))}
      ...
      <div class="new-body">
        ...
        <div class="field new-shapes">
          ...
          <div class="shape-cards" role="radiogroup" aria-label="Shape">
            ${tn.map(r=>h`<button type="button" role="radio" class="shape-card ${this.newFamily===r?"on":""}"
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=xu(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?ss(i,this.hass.states):[],r=ls({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${bu(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${it({hass:this.hass},t.label,i??yy,a=>this.setImportEntity(t.entityId,a),Tu(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,Ya(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:wu(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=$u(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${bt(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=ku(t.config,this.importMap);i.id=Y(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=Ut(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${_u(a)}</option>`)}
              </select>
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${xo.map(s=>h`<button class="add" style=${`--k:${ze[s]}`} ?disabled=${i} title=${`Add a blank ${Mn[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${Xd(s)}</span>`:f}<span class="add-name">${r?O(s):h`<span class="k"></span>`}<span>${Mn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Me(T,d)}</b>
          <small><span class="kind">${Mn[T.kind]}</span> · ${Ay(T,c,this.historySeries,R.size)}</small>
          ${C?h`<span class="facts">${Ry(this.host(),a,T,R).map(V=>h`<span class="fact"><b>${V.label}</b> ${V.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${R.isHidden?"Show":"Hide"} (${ps}${Pt}H)`} aria-label=${R.isHidden?"Show this layer":"Hide this layer"} @click=${V=>{V.stopPropagation(),this.mutate(K=>Te(K,a,G,{isHidden:!R.isHidden}))}}>${O(R.isHidden?"hide":"show")}</button>
      ...
      </div>`},B=(T,U)=>{let X=this.inspect.kind==="group"&&this.inspect.id===T.id,G=!this.collapsed.has(T.id),pe=this.rowDrag(T.id,i),R=U[0],b=U[U.length-1],v=E=>{let L=E.currentTarget,V=L.getBoundingClientRect(),K=V.top+(L.classList.contains("drop-before")?yt:0),fe=V.bottom-(L.classList.contains("drop-after")?yt:0),at=(E.clientY-K)/Math.max(1,fe-K);return at<.25?"drop-before":!G&&at>.75?"drop-after":"drop-into"},M=U.map(E=>E.payload.id);return h`<div class="layer group ${X?"hl":""} ${C?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${pe.draggable}
      ...
      </div>`},N=[],J=new Set;for(let T=0;T<l.length;T++){let U=l[T],X=U.payload.groupId,G=X===void 0?void 0:t.groups?.find(b=>b.id===X);if(!G){N.push(D(U,!1));continue}if(J.has(G.id))continue;J.add(G.id);let pe=l.filter(b=>b.payload.groupId===G.id);N.push(B(G,pe));let R=this.inspect.kind==="group"&&this.inspect.id===G.id;this.collapsed.has(G.id)||N.push(h`<div class="group-kids">${pe.map(b=>D(b,!0,R))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${$}px;--thumb-h:${S}px`}>
      <h2 class="panel-title tools" style=${`--c:${Q.place}`}><span class="swatch">${O("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${ky.map((T,U)=>h`
              <button class=${this.thumbStep===U?"on":""} title=${`${Fu[U]} row pictures`}
                aria-label=${`${Fu[U]} row pictures`} aria-pressed=${this.thumbStep===U?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?cu(this.presetKind):void 0,i=this.presetEntity;return h`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:h`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${it(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Su,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=hu(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=ca(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
      ...
      ${ba(r,m)}
    </div>`}renderUnder(t,i){let a=ce(this.host()),r=this.inspect,o=r.kind==="layer"?t.elements.find(u=>u.payload.id===r.id):void 0,s;if(this.showTaps)s=h`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${ut(t.tapAction)}</b>.`;else if(this.picking)s="Point at a layer and click it. Escape stops.";else if(i==="inline")s="One line of text. Edit it on the right.";else if(r.kind==="group"){let u=t.groups?.find(m=>m.id===r.id),p=u?ht(t,u.id).length:0;s=u?h`editing group <b>${u.name}</b>. Drag to move all ${p} layers.${u.locked?"":" Click one layer to move it alone."}`:""}else if(o){let u=pt(t,o.payload.id);s=u?.locked?h`editing <b>${Me(o,a)}</b> in <b>${u.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:h`editing <b>${Me(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else s="click a layer to edit it";if(i==="inline")return h`<div class="under"><b>Inline</b><span class="dot">·</span><span class="tail">${s}</span></div>`;let l=this.currentCase().slots[i],d=ma(l,i),c=Math.round(d.scale*100);return h`<div class="under">
      <b>${te(i)}</b>
      <span class="size">${l.width} × ${l.height} pt${c!==100?` \xB7 ${c}%`:""}</span>
      <span class="dot">·</span>
      <span class="tail">${s}</span>
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?Sn((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Wc();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${O("content")}</span>Shared values
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=jl(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${Q.states}`}>
    ...
    </div>`}renderTestControl(t,i,a,r,o,s){let l=r??a?.state??"",d=Yl(t,a,r);if(d.kind==="choice")return h`<span class="test-ctl"><select aria-label=${`Test value for ${i}`} @change=${m=>this.setTestValue(t,m.target.value)}>
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${xe(a,"complication","Complication",Uc(a),{color:Q.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=Jc(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=Qc(a,c)}else s=eu(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([xy(r)]):new Set(Xo)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ce(r),s=new Ze(this.buildContext(),this.draft?.config),l=qc(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)Te(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let x=g.elements.find($=>$.payload.id===y.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
