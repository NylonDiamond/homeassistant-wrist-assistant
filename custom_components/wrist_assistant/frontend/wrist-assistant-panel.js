    ...
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${A=>k(P(""),A.currentTarget)}>${B("text")}<span>Add text</span></button>
...
`;break}case"shape":C=h`<div class="grid2">
    ...
    ${ie("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=P("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ie("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=P("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:P("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    <div class="states">
      ${se(e,d??P(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
...
`)}var rm="wrist-assistant-panel.layers.v1",om="wrist-assistant-panel.grid.v1",Dt=34,ei=200,Yv=720,lo=320,Xv=80,Jv=56,sm="wrist-assistant-panel.columns.v3",Il=e=>Math.max(ei,Math.min(Yv,Math.round(e))),lm=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Zv(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Qv=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,wa=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",yn=wa==="Cmd"?"\u2318":"Ctrl+",Ll=wa==="Cmd"?"\u21E7":"Shift+";function dm(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Xv;if(i>=ei*2+lo){let r=i-lo,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(ei,Math.floor(o*l)),s=Math.max(ei,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(ei,o-d):s=Math.max(ei,s-d))}return{columns:3,left:o,right:s}}let a=e-Jv;return a>=ei+lo?{columns:2,left:Math.min(n,a-lo),right:t}:{columns:1,left:n,right:t}}var L=class L extends Gt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=nm;this.colRight=im;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.snapGrid=!0;this.gridStep=.01;this.showGridLines=!1;this.altHeld=!1;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=yi.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Bu(()=>this.requestUpdate());this.imageSizes=Gu(()=>this.requestUpdate());this.symbols=new Sr(()=>this.requestUpdate());this.keyHandler=t=>{t.key==="Alt"&&(this.altHeld=!0),this.onKey(t)};this.blurHandler=()=>{this.altHeld=!1};this.heldArrows=new Set;this.keyUpHandler=t=>{t.key==="Alt"&&(this.altHeld=!1),this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Mr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Rl(a,this.hass.states);r.some(s=>xl(em(s.entityId)))||Fl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||xl(Qh)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Gv}static{this.styles=mo`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.loadGrid(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("blur",this.blurHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Zr,this.scrubStart),this.addEventListener(Qr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Vv)}loadColumnWidths(){try{let t=window.localStorage.getItem(sm);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Il(i.left)),typeof i.right=="number"&&(this.colRight=Il(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(sm,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadGrid(){try{let t=window.localStorage.getItem(om);if(!t)return;let i=JSON.parse(t);typeof i.on=="boolean"&&(this.snapGrid=i.on),$s.includes(i.step)&&(this.gridStep=i.step),typeof i.lines=="boolean"&&(this.showGridLines=i.lines)}catch{}}setGrid(t,i,a=this.showGridLines){this.snapGrid=t,this.gridStep=i,this.showGridLines=a;try{window.localStorage.setItem(om,JSON.stringify({on:t,step:i,lines:a}))}catch{}}snapTarget(t){return{snap:{step:fi(this.gridStep,pe[t]),on:this.snapGrid}}}loadListView(){try{let t=window.localStorage.getItem(rm);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(rm,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      @click=${()=>{this.zoomed=!0}}>${B("expand")}</button>`}renderGridButton(){let t=this.snapGrid,i=this.showGridLines,a=!this.draft||this.parseError!==void 0||this.activeFamily==="inline",r=i?v`<path d="M1.5 8s2.4-4.5 6.5-4.5S14.5 8 14.5 8 12.1 12.5 8 12.5 1.5 8 1.5 8z" /><circle cx="8" cy="8" r="1.9" />`:v`<path d="M1.5 8s2.4-4.5 6.5-4.5S14.5 8 14.5 8 12.1 12.5 8 12.5 1.5 8 1.5 8z" /><path d="M2.5 13.5l11-11" />`;return h`<span class="grid-tool ${t?"on":""}">
    ...
    </details>`}};z([ai({attribute:!1})],L.prototype,"hass",2),z([ai({type:Boolean})],L.prototype,"narrow",2),z([ai({attribute:!1})],L.prototype,"panel",2),z([V()],L.prototype,"colLeft",2),z([V()],L.prototype,"colRight",2),z([V()],L.prototype,"panelWidth",2),z([V()],L.prototype,"owners",2),z([V()],L.prototype,"ownerId",2),z([V()],L.prototype,"records",2),z([V()],L.prototype,"selectedId",2),z([V()],L.prototype,"draft",2),z([V()],L.prototype,"readOnlyReason",2),z([V()],L.prototype,"parseError",2),z([V()],L.prototype,"maxSchemaVersion",2),z([V()],L.prototype,"presets",2),z([V()],L.prototype,"occupied",2),z([V()],L.prototype,"serverToken",2),z([V()],L.prototype,"appliedToken",2),z([V()],L.prototype,"sendStatusKnown",2),z([V()],L.prototype,"polling",2),z([V()],L.prototype,"lastPollSeconds",2),z([V()],L.prototype,"sendPending",2),z([V()],L.prototype,"pages",2),z([V()],L.prototype,"templateResults",2),z([V()],L.prototype,"historySeries",2),z([V()],L.prototype,"historyReadings",2),z([V()],L.prototype,"templateError",2),z([V()],L.prototype,"templateFetchedAt",2),z([V()],L.prototype,"forced",2),z([V()],L.prototype,"showRaw",2),z([V()],L.prototype,"inspect",2),z([V()],L.prototype,"openSections",2),z([V()],L.prototype,"helpSections",2),z([V()],L.prototype,"pickerOpen",2),z([V()],L.prototype,"pickerFilter",2),z([V()],L.prototype,"pickerNote",2),z([V()],L.prototype,"openValue",2),z([V()],L.prototype,"sharedHelp",2),z([V()],L.prototype,"editingValue",2),z([V()],L.prototype,"thumbStep",2),z([V()],L.prototype,"layerDetail",2),z([V()],L.prototype,"addOpen",2),z([V()],L.prototype,"addDetail",2),z([V()],L.prototype,"multi",2),z([V()],L.prototype,"copiedPosition",2),z([V()],L.prototype,"snapGrid",2),z([V()],L.prototype,"gridStep",2),z([V()],L.prototype,"showGridLines",2),z([V()],L.prototype,"altHeld",2),z([V()],L.prototype,"collapsed",2),z([V()],L.prototype,"activeFamily",2),z([V()],L.prototype,"picking",2),z([V()],L.prototype,"pickHoverId",2),z([V()],L.prototype,"listHoverIds",2),z([V()],L.prototype,"rowHoverId",2),z([V()],L.prototype,"zoomed",2),z([V()],L.prototype,"helpOpen",2),z([V()],L.prototype,"showTaps",2),z([V()],L.prototype,"savedName",2),z([V()],L.prototype,"presetKind",2),z([V()],L.prototype,"presetEntity",2),z([V()],L.prototype,"newOpen",2),z([V()],L.prototype,"newName",2),z([V()],L.prototype,"newFamily",2),z([V()],L.prototype,"shareOpen",2),z([V()],L.prototype,"shareMode",2),z([V()],L.prototype,"shareLabels",2),z([V()],L.prototype,"shareNote",2),z([V()],L.prototype,"importOpen",2),z([V()],L.prototype,"importText",2),z([V()],L.prototype,"importParse",2),z([V()],L.prototype,"importName",2),z([V()],L.prototype,"importMap",2),z([V()],L.prototype,"previewCase",2),z([V()],L.prototype,"loadError",2),z([V()],L.prototype,"saveError",2),z([V()],L.prototype,"saving",2),z([V()],L.prototype,"conflict",2),z([V()],L.prototype,"remoteRevision",2),z([V()],L.prototype,"confirmDelete",2),z([V()],L.prototype,"moveTarget",2),z([V()],L.prototype,"moving",2),z([V()],L.prototype,"moveError",2),z([V()],L.prototype,"version",2);var Pl=L;function Ot(e){return String(e?.message??e)}function ew(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function cm(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function tw(e,n,t,i){let a=[{label:"Shows",value:wl(e,t)}],r=qr(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function nw(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function iw(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${He(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=In(e.payload)??Ln(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${je(o).length} values`}case"timeline":{let r=yt(e.payload),o=r===void 0?[]:Zi(t.get(r)??""),s=Math.max(0,o.length-1);return`${nw(st(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${He(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return e.payload.contentMode==="fill"?"fill":"fit";case"tap":return Ht(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`;case"imageTime":return}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Pl);export{Pl as WristAssistantPanel,dm as columnFit,tw as layerFacts};
