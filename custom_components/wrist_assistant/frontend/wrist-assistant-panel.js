...
`)}function Zd(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Fm(r));return{values:t,nullKeys:i}}function Fm(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Vo(e){let n=Ia(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Am(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(eo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Im=10800;function Hm(e,n,t){let i=n==="always"||n==="auto"&&t<=Im;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Go(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Hm(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Lm(e,n){return Bt(e)===void 0?[]:Go(st(e)*60,va(e.timeLabelCount),e.hourCycle,e.minutes,n)}function _m(e,n){return pn(e)?Go(Math.round(e.historyMinutes)*60,va(ft(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function zm(e,n,t){return n===void 0||!pn(n)?[]:Go(Math.round(n.historyMinutes)*60,va(ft(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function $n(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Be(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:$n(i)}function Nm(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Pm(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Dm(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?$n(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=$n(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Om(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Vm(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Bm(e,n,t){if(Ae(n))return e;let i=n,a=e,r=$n(e.trim()),o=i.duration?Dm(e):void 0;if(o!==void 0)a=Om(o);else if(i.relativeTime&&r!==void 0)a=Pm(r);else{let s=Be(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Nm(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Vm(a);break}return a}function Qn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Je(e,n=240){return ic(e,n).map(t=>t.value)}function Uo(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Je(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:nc(r)}}function nc(e){return e.some(n=>n)?e:[]}function ic(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Qd(e,n,t){let i=ic(e),a=i.map(g=>g.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Pt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??oe,c=t.highColorHex??qe,u=t.lowColorHex??Ye,p=[],m=(g,x)=>{if(g==="")return;let w=p.at(-1);w&&w.colorHex===x?w.text+=g:p.push({text:g,colorHex:x})},b=0;return i.forEach((g,x)=>{m(e.slice(b,g.start),n);let w=x===o?c:x===s?u:l.length>0?ya(g.value,l,d):n,C=e[g.end-1]==="."?g.end-1:g.end;m(e.slice(g.start,C),w),b=C}),m(e.slice(b),n),p}function ec(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Gm(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Li(e,n=Vt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Um(i.slice(a+1))})}return t}function Um(e){try{return decodeURIComponent(e)}catch{return e}}function Km(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function tc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Wm(e,n,t){if(e===void 0)return 0;let i=Be(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var dt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=ec(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=hn(n),i=mn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Uo(a):{values:Je(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=nc(s),{values:Ko(o,nt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Be(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Be(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):ec(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ae(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Am(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?rd(r):eo(r,a.domainMax-a.domainMin));break}default:{let a=Oo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Bm(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=$n(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Qn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Be(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Be(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Be(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:vn(d),p=c===void 0?void 0:vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(_e[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Qd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,b=yt(n.payload)&&!r.has("text"),g={kind:"text",...u,text:b?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(g.countdownEnd=p),b?(g.parts=this.resolveTextParts(n.payload.parts,i.rules,g,t),g.text=g.parts.map(x=>x.text).join(""),g):(ed(n.payload)&&(g.spans=Qd(g.text,g.colorHex,n.payload)),g)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),b=n.payload.symbol.kind.kind==="literal",g=m===void 0&&b&&n.payload.path!==""?n.payload.path:void 0,x=m??p;g===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let w={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(w.path=g),w}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),b=(N,H,Z)=>N??(H?Be(this.resolve(H)??""):void 0)??Z,g=b(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=b(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),w=m===void 0?void 0:Be(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&w!==void 0&&(C=ya(w,Pt(p),p.bandAboveColorHex));let $=x-g;if(p.total){let N=Be(this.resolve(p.total)??"");N!==void 0&&($=N)}let S=tc($,1,ga),I={kind:"gauge",...u,fraction:Wm(m,g,x),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:tc(w??0,0,S)};if(p.thresholdValue!==void 0&&x!==g){let N=(p.thresholdValue-g)/(x-g);N>=0&&N<=1&&(I.thresholdFraction=N)}return I}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),b=m.values,g=m.holes,x={min:m.domainMin,max:m.domainMax},w=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Pt(p),$=ad(p)?b.map(X=>ya(X,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",I=p.highlight==="lowest"||p.highlight==="both",N=bi(p),H={kind:"chart",...u,values:b,holes:g,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:w,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?N.high:"none",lowMarker:I?N.low:"none",pointColorHexes:$,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:nt(p.smoothing)??"off",fillStyle:_t(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:zt(p.barRadius),barCorners:Nt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:_m(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},Z=g.length===0?b:b.filter((X,U)=>!g[U]);if(Z.length>0){let X=A=>b.findIndex((K,y)=>K===A&&g[y]!==!0),U=S?X(Math.max(...Z)):-1,ee=I?X(Math.min(...Z)):-1;U>=0&&(H.highIndex=U),ee>=0&&ee!==U&&(H.lowIndex=ee)}let T=Gm(p,x.min,x.max);T!==void 0&&(H.thresholdY=T);let O=this.chartNowIndex(p,b.length);return O!==void 0&&(H.nowIndex=O),H}case"timeline":{let p=n.payload,m=Bt(p),b=m===void 0?"":this.ctx.historySeries?.get(m)??"",g=Li(b,Vt),x=Km(g,st(p)*60,C=>pd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:Lm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};bt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:zm(p,this.chartElements.get(p.chart),this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"chartDots":{let p=n.payload,m=mt(p.size),b={kind:"chartDots",...u,chart:p.chart,dots:ma(p.dots),diameter:0,indices:[]};return m!==void 0&&(b.size=m),p.colorHex!==void 0&&(b.colorHex=p.colorHex),b}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Dn(p.lines),colorHex:It(p.colorHex),thickness:On(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...Zm(Jm(Ad(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,w=this.resolve(x.value),C=w===void 0?void 0:Be(w);if(C!==void 0){let $=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),I={value:Math.min(S,Math.max($,C)),minValue:$,maxValue:S===$?$+1:S,colorHexes:x.colorHexes},N=this.resolve(x.minLabel);N!==void 0&&(I.minLabel=N);let H=this.resolve(x.maxLabel);H!==void 0&&(I.maxLabel=H),l.bezelGauge=I}}let b=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;b!==void 0&&(l.backgroundColorHex=b);let g=this.styleColor(s,"borderColor")??a?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function jm(e,n,t){let i=new dt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function _i(e,n,t){let i=new dt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=jm(e.inline,n,e)),a}function Ha(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Bo=5,qm=1.7,Ym=1.8;function Xm(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Jm(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Ym,l=Math.max(o.frame.width*n.width,0),d=Xm(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function ac(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function rc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function La(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=H=>H==="triangle"?Bo+d:H==="dot"?Math.max(d,qm):d,u=c(a),p=c(r),m=n.y+u,b=Math.max(n.h-u-p,1),g=m+b,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),w=e.baseline==="lowest",C=w?b*.12:0,$=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-$*(i-1))/i,.5),I=H=>Math.min(1,Math.max(0,(H-e.domainMin)/x)),N=H=>g-I(H)*b;return{count:t.length,barWidth:S,plotTop:m,plotBottom:g,plotLeft:o,plotRight:o+s,baselineY:w?g:N(0),inset:d,yAtFraction(H){return g-Math.min(Math.max(H,0),1)*b},barRect(H){let Z=o+H*(S+$),T=t[H],O,X;if(w){let U=C+I(T)*(b-C);O=g-U,X=g}else O=N(T),X=w?g:N(0),O>X&&([O,X]=[X,O]);return{x:Z,y:O,w:S,h:Math.max(X-O,.5)}},point(H){let Z=Math.max(s-d*2,0);return{x:t.length>1?o+d+Z*H/(t.length-1):o+s/2,y:N(t[H])}},markerCenter(H,Z,T="high"){let O=Z?this.barRect(H):void 0,X=O?O.x+O.w/2:this.point(H).x,U=T==="high"?a:r,ee=T==="high"?U==="triangle"?n.y+Bo/2:m:U==="triangle"?n.y+n.h-Bo/2:g;return{x:X,y:ee}}}}function oc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Ko(e,n,t=[]){let i=e.length,a=Ql(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,b=0;for(let g=Math.max(0,p-r);g<=Math.min(i-1,p+r);g++){if(s(g))continue;let x=g-p,w=Math.exp(-(x*x)/(2*o*o));m+=e[g]*w,b+=w}return m/b}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function sc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Hi=1;function ei(e,n){let t=Math.max(Un,Math.min(Kn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Hi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Hi:n.y,h:n.h-i-Hi,cy:(e.labelsAbove?n.y+i+Hi:n.y)+(n.h-i-Hi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Zm(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&ac(r)===void 0)return{...i,isHidden:!0};let o=ef(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Qm(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function ef(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Ha(t,i);if(a.w<=0||a.h<=0)return;let r=ei(t,a).body;if(r.w<=0||r.h<=0)return;let o=La(t,r),s,l;if(gt(n.at)){let w=Qm(n.at,t);if(w===void 0)return;if(t.style==="bars"){let C=o.barRect(w);s=C.x+C.w/2,l=C.y}else{let C=o.point(w);s=C.x,l=C.y}}else{let w=n.at==="zero"?ac(t):t.thresholdY;if(w===void 0)return;l=o.yAtFraction(w)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(w,C,$)=>C>$?(C+$)/2:Math.min(Math.max(w,C),$),m={...e};if(s!==void 0){let w=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(w-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let w=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(w-c/2)/i.height}return m}let b=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,g=p(b,r.y+c/2,r.y+r.h-c/2),x=p(g+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Ie=pe,zi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ie,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],ti=zi.find(e=>e.measured);function yc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return zi.find(a=>a.screen.width===t&&a.screen.height===i)}function za(e,n){let t=Ie[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Yo={regular:400,medium:500,semibold:600,bold:700},tf=1.15;function Ge(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ge(e,n,t="#FFFFFF"){let i=Ge(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var $t=e=>e*.55;function bc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function nf(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function af(e,n,t){if(t<=0||e.length*$t(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/$t(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function rf(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function xc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function vc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function of(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function wc(e,n){return e.reduce((t,i)=>t+i.text.length*$t(i.look.fontSize*n),0)}function sf(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:$t(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=$t(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function lf(e,n,t){if(t<=0||wc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*$t(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*$t(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function df(e,n,t){let i=of(n),a=e.lineLimit===2&&t.w>0?sf(e.text,i,t.w):[e.text],r=xc(e.text,a),o=a.map((C,$)=>vc(C,r[$]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>wc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>lf(C,l,t.w)),{anchor:c,x:u}=bc(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,b=p*1.15,g=C=>C.map($=>{let S=ge($.look.colorHex,"fill");return v`<tspan font-size=${$.look.fontSize*l} font-weight=${Yo[$.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}),x=ge(e.colorHex,"fill"),w=d.length>1?v`${d.map((C,$)=>v`<tspan x=${u} y=${t.cy+m+($-(d.length-1)/2)*b}>${g(C)}</tspan>`)}`:g(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${w}</text>`}function cf(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(g=>g.text).join("")===e.text)return e.text===""?f:df(e,e.parts,n);let t=ge(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Qn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?nf(e.text,n.w/$t(e.fontSize)):[e.text],a=Math.max(...i.map(g=>g.length))*$t(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(g=>af(g,o,n.w)),{anchor:l,x:d}=bc(e.alignment,n),c=rf(e.text,e.spans),u=c?xc(e.text,i):[],p=(g,x)=>c?vc(g,u[x]??0,e.text,c,e.colorHex).map(w=>{let C=ge(w.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${w.text}</tspan>`}):g,m=o*1.15,b=s.length>1?v`${s.map((g,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(g,x)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Yo[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${b}</text>`}var Wo=2;function uf(e,n){let t=ge(e.colorHex,"stroke"),i=ge(e.trackColorHex,"stroke","#FFFFFF"),a=ge(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,b=Math.max(1,e.dotCount),g=m?n.w:n.h,x=m?n.h:n.w,w=Math.max(1,Math.min(x,g/b-Wo)),C=b*w+(b-1)*Wo,$=(m?n.cx:n.cy)-C/2+w/2;return v`${Array.from({length:b},(S,I)=>{let N=$+I*(w+Wo),H=I<e.filledCount?t:i;return v`<circle cx=${m?N:n.cx} cy=${m?n.cy:N} r=${w/2}
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:pf(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function pf(e,n,t,i,a){let r=ge(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function hf(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ei(e,n),o=r?es(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=ff(e,a);return o===void 0?s:v`${s}${o}`}function jo(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var lc=0;function kc(){return lc+=1,lc.toString(36)}function mf(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function ff(e,n){let t=La(e,n),i=kc(),a=ge(e.colorHex,"fill"),r=ge(e.highColorHex,"fill",e.colorHex),o=ge(e.lowColorHex,"fill",e.colorHex),s=(b,g)=>v`<circle cx=${b.x} cy=${b.y} r="1.7" fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=b=>c?ge(e.pointColorHexes[b],"fill",e.colorHex):a,p=b=>{let g=Ge(b)??Ge(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:g.color,opacity:g.opacity*.28};let x=gf(i,e.id,b),w=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,v`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${w} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${g.color} stop-opacity=${g.opacity*.28} />
        <stop offset="1" stop-color=${g.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let b=0;b<t.count;b++){if(e.holes[b]===!0)continue;let g=t.barRect(b),x=b===e.highIndex?r:b===e.lowIndex?o:u(b),w=Math.min(Math.max(e.barRadius,0),g.w/2,g.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[b]<0;l.push(v`<path d=${mf(g,w,C)}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else l.push(v`<rect x=${g.x} y=${g.y} width=${g.w} height=${g.h} rx=${w}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let b=Array.from({length:t.count},(C,$)=>t.point($)),g=e.holes.length>0,w=sc(t.count,e.holes).filter(C=>!g||C.length>1).map(C=>{let $=C.map(N=>b[N]),S=oc($,e.curve),I=`M${$[0].x} ${$[0].y}${S.map(N=>` ${jo(N)}`).join("")}`;return{run:C,pts:$,legs:S,line:I}});if(e.style==="area")for(let{run:C,pts:$,legs:S,line:I}of w)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let N=0;N<S.length;N++){let H=$[N],Z=$[N+1],T=p(e.pointColorHexes[C[N+1]]),O=`M${H.x} ${H.y} ${jo(S[N])} L${Z.x} ${t.baselineY} L${H.x} ${t.baselineY} Z`;l.push(v`<path d=${O} fill=${T.fill} fill-opacity=${T.opacity} stroke="none" />`)}else{let N=p(e.fillColorHex??e.colorHex),H=`${I} L${$[$.length-1].x} ${t.baselineY} L${$[0].x} ${t.baselineY} Z`;l.push(v`<path d=${H} fill=${N.fill} fill-opacity=${N.opacity} stroke="none" />`)}for(let{run:C,pts:$,legs:S,line:I}of w)if(c&&C.length>1)for(let N=0;N<S.length;N++){let H=$[N],Z=u(C[N+1]);l.push(v`<path d=${`M${H.x} ${H.y} ${jo(S[N])}`} fill="none"
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function kf(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ge(e.colorHex,"fill"),s=e.size*tf;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var ts=.25,$f=8;function Cf(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,ts),$f),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,b=i*p,g=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+g)+0,y:-(b-n)/2*(1+x)+0,width:m,height:b}}function Na(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var _a=4;function Pa(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+_a:n.x+n.w-_a-a,d=e.timestampCorner.startsWith("top")?n.y+_a:n.y+n.h-_a-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Sf(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Tf(e,n,t){let i=t.icons,a=`imgclip-${kc()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Pa(e,n,Na(new Date)):void 0,s=o?v`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,b])=>v`<rect data-ts-corner=${p} x=${m-l/2} y=${b-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=Cf(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=v`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Sf(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Ef(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Mf(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Xo} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var Xo=5;function Mf(e,n){let t=Xo*.55,i=n.w-2;if(n.h<Xo*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Cc(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function Jo(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return f;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return f;let d=Ha(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=cf(e,d);break;case"icon":u=kf(e,d,t.icons);break;case"gauge":u=uf(e,d);break;case"chart":u=hf(e,d);break;case"timeline":u=yf(e,d);break;case"chartTimes":u=bf(e,d);break;case"chartDots":u=xf(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=vf(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=wf(e,d);break;case"image":u=Tf(e,d,t);break;case"tap":u=Ef(e,d,t.icons,r,c?xt(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,b=t.highlightId===e.id,g=b||t.highlightIds?.includes(e.id)===!0,x=e.kind==="chartDots"||e.kind==="chartGrid",w=t.handles===!0&&(!l||s)&&!x,C=g&&!x?v`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,$=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,S=x?f:v`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="transparent" stroke="none" />`,I=3,N=b&&w?[["nw",d.x,d.y],["ne",d.x+d.w,d.y],["sw",d.x,d.y+d.h],["se",d.x+d.w,d.y+d.h]].map(([H,Z,T])=>v`<rect data-handle=${H} x=${Z-I/2} y=${T-I/2} width=${I} height=${I}
          fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${H}-resize" />`):f;return v`<g data-element-id=${e.id} opacity=${m} style=${w?"cursor:move":e.kind==="chartDots"?"cursor:pointer":f}
    pointer-events=${e.kind==="chartGrid"?"none":f}
    transform="rotate(${e.frame.rotationDegrees} ${d.cx} ${d.cy})">${S}${u}${$}${C}${N}</g>`}function Da(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function ns(e,n){return(n?23.5:34)*e}var dc=10.5;function Sc(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function cc(e,n){let t=0;for(let i of e)t+=Sc(i,n);return t}function uc(e,n,t){let i=e.toUpperCase(),a=d=>Sc(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Zo(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Qo(e,n,t,i){let a=Zo(e,n,t),r=Zo(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Tc(e,n,t,i){let{dial:a}=Da(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Qo(a,t,i.start,i.end),length:t*r}}function Rf(e,n){let t=Da(e,!0);return Tc(e,n,t.dial.r,t.labelArc)}var pc=18.5,Ff=113,Af={start:-71,end:-36},hc=104,If=6.2,mc={start:-77,end:-30.5};function fc(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function gc(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=fc(e[i]),o=fc(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var qo=11;function Hf(e,n,t){let{dial:i}=Da(n,!0),a=hc*n,r=180/(Math.PI*hc),o=e.minLabel!==void 0?cc(e.minLabel,qo)*r:0,s=e.maxLabel!==void 0?cc(e.maxLabel,qo)*r:0,l=mc.start+(o>0?Math.max(0,o-1.8):0),d=mc.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let w=0;w<u;w++){let C=l+c*w/u,$=Math.min(d,l+c*(w+1)/u+.4);p.push(v`<path d=${Qo(i,a,C,$)} fill="none"
      stroke=${gc(e.colorHexes,(w+.5)/u)} stroke-width=${If*n}
      stroke-linecap=${w===0||w===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),b=Zo(i,a,l+c*m),g=1.5,x=(w,C,$,S)=>v`
    <defs><path id=${w} d=${Qo(i,a,C,$)} /></defs>
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+g,d+g+Math.max(s,3),e.maxLabel):f}`}function Oa(e,n){let t=e.family in Ie?e.family:"rectangular",i=n.slot??Ie[t],a=Ie[t],r=za(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ge(e.backgroundColorHex),l=Ge(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Cc(c);if(t==="corner"){let x=r.scale,w=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",$=C!=="",S=Da(x,w),I=ns(x,w),N=I/(a.width*x),H=S.tile.cx-I/2,Z=S.tile.cy-I/2,T=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,O=f;if(e.bezelGauge)O=Hf(e.bezelGauge,x,o);else if(e.bezelText){let U=Rf(x,`${o}-bezel`),ee=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Qn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;O=v`<defs><path id=${U.id} d=${U.d} /></defs>
        <text font-size=${dc*x} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${U.id}" startOffset="50%" text-anchor="middle">${uc(ee,U.length,dc*x)}</textPath></text>`}let X=f;if($){let U=Ge(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ee=Tc(x,`${o}-curved`,Ff*x,Af);X=v`<defs><path id=${ee.id} d=${ee.d} /></defs>
        <text font-size=${pc*x} font-weight="600" fill=${U.color} fill-opacity=${U.opacity}
          ...
          <textPath href="#${ee.id}" startOffset="50%" text-anchor="middle">${uc(C,ee.length,pc*x*.88)}</textPath></text>`}else{let U=e.borderWidth*r.scale*N,ee=l?v`<circle cx=${I/2} cy=${I/2} r=${I/2-U/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${U} />`:f;X=v`<g transform="translate(${H} ${Z})">
        <g clip-path=${`url(#${o})`}>
          ${s?v`<rect width=${I} height=${I} fill=${s.color} fill-opacity=${s.opacity} />`:f}
          <g data-design-box transform="scale(${r.scale*N})">
            ${c.map(A=>Jo(A,a,n,u))}
          </g>
        </g>
    ...
    </div>`}function lg(e,n){let t=i=>jt(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${ze(e.label,t(e))}
    <div class="pair-row">
    ...
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Pu(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map(($,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${I=>I.preventDefault()} @click=${I=>b($,I.target)}>
  ...
  </div>`}function mg(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var yu=120;function fg(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Wa.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(ja),fromPack:!1}}function bu(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function gg(e){return[{value:"",label:`Starter set (${bu(ja,e)})`},...Wa.map(n=>({value:n.name,label:`${n.name} (${bu(n.symbols,e)})`}))]}function yg(e){return e.length>0?e.length:ja.length}function xu(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Za(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Du(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(De),m=a!==void 0,b=m?r.pack(i)??(p?"mdi":"sf"):"sf",g=bg(u,c),x=$=>{t($),a?.($.startsWith(De)?e.icons.mdiPath?.($):void 0),r.noteUsed($)},w=$=>{if(t($),!m)return;let S=$.trim();a?.(S.startsWith(De)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&b==="mdi"){let $=e.icons.mdiNames?.(),S=xg($??[],s),I=S.slice(0,yu),N=r.recent.filter(H=>H.startsWith(De));C=h`<div class="sym-browse">
      ${vu(r,i,b)}
      ...
      ${N.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${N.map(H=>Za(e,H,H===u,x))}</div>`}
      <div class="sym-grid">${I.map(H=>Za(e,H,H===u,x))}</div>
      ${$===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${xu(I.length,S.length,!0,$.length)}</div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${ye(w)} @change=${ye($=>{let S=$.trim();S.startsWith(De)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed($):(c.size===0||c.has(S))&&r.noteUsed($)})} /></label>
    ...
    ${C}`}function bg(e,n){let t=e.trim();return t!==""&&!t.startsWith(De)&&n.size>0&&!n.has(t)}function xg(e,n){let t=n.trim(),i=t.startsWith(De)?t.slice(De.length):t,a=e.map(r=>r.startsWith(De)?r.slice(De.length):r);return ss(a,i).map(r=>De+r)}function vu(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
    ...
    ${n.function==="count"?f:ve("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Wu=mo,Xg=Wu.filter(([e])=>e!=="none");function Jg(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function ju(e,n){let t=Jg(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return md(e)?{type:e,...t}:{type:e}}var Zg=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function qu(e,n,t,i){let a=n.serviceDataJSON??"",r=fd(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    ${t.type==="callService"?qu(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?ty(e):f}`}var ey="#808080",$u=[0,15,30,60,120];function Cu(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function ty(e){let n=e.config;return Xu(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Xu(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Ee("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Ju(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Mi(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    ${Ee("Reading",i.at,dn,c=>e.update(u=>{let p=u.elements.find(b=>b.payload.id===a);if(!p?.payload.chartAnchor)return;p.payload.chartAnchor.at=c;let m=u.elements.find(b=>b.payload.id===i.layer);m?.kind==="chart"&&(c==="threshold"&&m.payload.thresholdValue===void 0&&(m.payload.thresholdValue=Ou(Je(e.resolve(m.payload.value)??"")),m.payload.drawsThreshold=!1),c==="now"&&m.payload.nowIndex===void 0&&(m.payload.nowIndex={kind:{kind:"time",timeField:"hour"}},m.payload.drawsNowLine=!1))}),{def:"highest"})}
    ${xy(e,i,r)}
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function vy(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ve(e.config,t)[0];return we(e,"tappable","Tap",Ky(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?xt(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Ta(a,t))}:{}})}function Tu(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${ae("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(Kn,Math.max(Un,r??et))},`${i}size`),{step:.5,min:Un,max:Kn,def:t.labelSize,unit:"pt"})}
        ${be("Time colour",e.labelColorHex,r=>n(o=>{o.labelColorHex=r??tt},`${i}colour`),!1,t.labelColorHex)}
      </div>
    ...
    ${te("Colour",a,Fs,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=dr(Je(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    ${te("Highlight",r,Rg,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
    ...
    ${s==="rich"?Ny(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Re(d,ue(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Ny(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ue(e),d=Math.max(0,o.findIndex(A=>A.id===ji.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=He(e.config,t,n).size??r.fontSize,b=(A,K)=>{Ct.delete(s),i(y=>{A(y),td(y)},K)},g=(A,K)=>b(y=>{let k=y.parts?.find(E=>E.id===c.id);k&&A(k)},K?`part-${c.id}-${K}`:void 0),x=(A,K)=>{ji.set(s,A),Ct.delete(s),Te(K)},w=(A,K)=>{let y=J();ji.set(s,y),b(k=>{(k.parts??=[]).push({id:y,value:A})}),Bu(K,xr(`${a}-part-${y}`),!0)},C=A=>b(K=>{K.parts&&Xi(K.parts,d,A)}),$=()=>{let A=o[d+1]??o[d-1];A&&ji.set(s,A.id),b(K=>{K.parts=(K.parts??[]).filter(y=>y.id!==c.id)})},S=o.map((A,K)=>{let y=Ay(A.value,l),k=A.id===c.id,E=Is(A),R=y.kind==="value"?e.resolve(A.value):void 0,F=A.fontWeight===void 0?void 0:ri.find(([G])=>G===A.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${k?"true":"false"} class="part-chip ${y.kind} ${k?"on":""}"
      aria-label=${np(A,K,l)} @click=${G=>x(A.id,G.currentTarget)}>
    ...
    </button>`}),I=r.rules.some(A=>A.partId===c.id),N=c.value.kind.kind==="literal",H=Is(c),Z=c.fontSize!==void 0,T=ri.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,O=A=>{A>=Es&&A<=Ms&&g(K=>{K.fontSize=A},"size")},X=H==="bands"?Je(e.resolve(c.value)??""):[],U={layer:"Use the layer colour",...N&&H!=="bands"?{bands:"By value needs a live value"}:{}},ee=(A,K)=>g(y=>{let k={bands:y.bands??[],bandAboveColorHex:y.bandAboveColorHex??oe};A(k),k.bands.length>0?y.bands=k.bands:delete y.bands,k.bandAboveColorHex!==oe?y.bandAboveColorHex=k.bandAboveColorHex:delete y.bandAboveColorHex},K);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      ...
      ${ce(e,c.value,A=>g(K=>{K.value=A},"value"),{showResolved:!0,label:N?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ...
      ${te("Colour",H,Ty,A=>g(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=zs(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=dr(Je(e.resolve(K.value)??"")))}),{def:"layer",titles:U,...N&&H!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <label class="field num part-size">${ze("Font size",Z?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>g(A=>{delete A.fontSize})}:void 0,gr(c.fontSize??m,O,{step:1,min:Es,max:Ms}))}
  ...
  </div>`}function ip(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,k)=>e.update(E=>y(E.elements[r]),k?`${o}-${k}`:void 0),l=He(e.config,t,n),d=l.frame,c=(y,k)=>e.update(E=>Me(E,t,a,{frame:fs(d,y)}),`${o}-${k}-${t}`),u=Ce(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=y=>u[y],b=!1,g=y=>Wi(n)===void 0?f:be(y,Wi(n),k=>s(E=>{Wi(E)!==void 0&&(E.payload.colorSlot.baseColorHex=k??"#FFFFFF")},"color"),!1,p),x,w,C;switch(n.kind){case"text":{let y=(k,E)=>s(R=>k(R.payload),E);w=zy(e,n,t,y,o),b=!n.payload.countdown&&!yt(n.payload),C=h`
        ...
        ${lg({label:"Align",value:n.payload.alignment??"center",options:iy,def:"center",set:k=>s(E=>{let R=E.payload;k==="center"?delete R.alignment:R.alignment=k})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:ay,def:"1",set:k=>s(E=>{let R=E.payload;k==="2"?R.lineLimit=2:delete R.lineLimit})})}
        ${Ke("Mono digits",n.payload.monospacedDigits===!0,k=>s(E=>{let R=E.payload;k?R.monospacedDigits=!0:delete R.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,C=er(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let y=n.payload,k=(R,F)=>s(G=>R(G.payload),F),E=y.style==="dots";w=h`
        ${ce(e,y.value,R=>k(F=>{F.value=R},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${E?h`
            ${ce(e,y.total??wu(y),R=>k(F=>{F.total=R},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
        ...
        <div class="grid2">
          ${te("Style",y.style,_g,R=>k(F=>{R==="dots"&&F.total===void 0&&(F.total=wu(F)),R!=="dots"&&delete F.total,F.style=R}),{titles:zg,def:u.style})}
          ${E?f:er(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${be(E?"Empty dot colour":"Track colour",y.trackColorHex,R=>k(F=>{F.trackColorHex=R??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${te("Colour",y.coloring,Fs,R=>k(F=>{F.coloring=R,R==="bands"&&F.bands.length===0&&(F.bands=dr([F.minValue,F.maxValue]))}),{def:u.coloring})}
        ${g("Main colour")}
        ${y.coloring==="bands"?h`
          ...
          ${cr(y,y.colorSlot.baseColorHex,k,Je(e.resolve(y.value)??"")[0])}`:f}
        ${E?f:h`
          <div class="grid2">
            ${ae("Threshold",y.thresholdValue,R=>k(F=>{R===void 0?delete F.thresholdValue:F.thresholdValue=R},"thr"),{optional:!0})}
            ${y.thresholdValue===void 0?f:be("Threshold colour",y.thresholdColorHex,R=>k(F=>{F.thresholdColorHex=R??Gn},"thrcol"),!1,Gn)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,k=(M,P)=>s(Fe=>M(Fe.payload),P),E=u.historyMinutes,R=u.historyPoints,F=y.historyMinutes>0,G=F&&y.source==="statistics",q=F&&!G,le=F?G?"statistics":"history":"value",We=G?Ci:un,rt=hn(y)??mn(y),Le=y.value.kind.kind==="entityState",he=rt===void 0?void 0:e.historySeries(rt),Ne=F&&Le?he??"":e.resolve(y.value)??"",je=y.historyPoints<1,Gp=q&&Le&&rt!==void 0?e.historyReadings?.(rt):void 0,Qs=fy(je,Gp,Mn(y.historyMinutes)),el=As(a,y.historyMinutes,We),Cr=F&&Le?Uo(Ne):{values:Je(Ne),holes:[]},In=Cr.values,tl=M=>y.limit>0&&M.length>y.limit?y.takeFromEnd?M.slice(M.length-y.limit):M.slice(0,y.limit):M,Up=tl(In),Et=Ko(Up,nt(y.smoothing),Cr.holes.length>0?tl(Cr.holes):[]),Kp=!F&&Le&&In.length===1,Sr=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),Wp=ue(e),ea=y.scaleFrom!==void 0&&Sr.some(M=>M.payload.id===y.scaleFrom);w=h`
        ${ce(e,y.value,M=>k(P=>{P.value=M},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${te("Draw",le,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],M=>k(P=>{if(M==="value"){P.historyMinutes=0;return}P.source=M==="statistics"?"statistics":"history";let Fe=P.historyMinutes||ba;P.historyMinutes=M==="statistics"?Math.min(Fe,to):Math.min(Fe,xa)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${G?h`
            ...
            <div class="grid2">
              ${Ss(a,y.historyMinutes,E,M=>k(P=>{P.historyMinutes=M}),Ci)}
              ${te("Per",y.statPeriod,fa,M=>k(P=>{P.statPeriod=M}),{def:vi})}
            </div>
            ${el?Ts(y.historyMinutes,M=>k(P=>{P.historyMinutes=M},"span"),!0):f}
            ${te("Read",y.statType,qr,M=>k(P=>{P.statType=M}),{def:wi})}
        ...
        ${q?h`
            ${Le?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Ss(a,y.historyMinutes,E,M=>k(P=>{P.historyMinutes=M}))}
              <div class="field readings-field">${ze("Points",{atDefault:y.historyPoints===R,title:`Back to ${R<1?"every one":`${R} averaged`}`,reset:()=>k(M=>{M.historyPoints=R})})}
                <div class="readings-row">
                  ...
                  ${je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(y.historyPoints)}
                      ...
                      @input=${ye(M=>{let P=Number(M);M.trim()!==""&&Number.isFinite(P)&&P>=1&&k(Fe=>{Fe.historyPoints=Math.round(P)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${el?Ts(y.historyMinutes,M=>k(P=>{P.historyMinutes=M},"span")):f}
        ...
        ${F?h`
            ${Ke("Show gaps when unavailable",y.gaps===!0,M=>k(P=>{M?P.gaps=!0:delete P.gaps}),u.gaps===!0)}
            ${Wt(e)}
        ...
        ${F&&y.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",y.limit,M=>k(P=>{P.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${y.limit<=0?f:te("Keep",y.takeFromEnd?"end":"start",F?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],M=>k(P=>{P.takeFromEnd=M==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${Ee("Smooth data",nt(y.smoothing)??"off",Sg,M=>k(P=>{let Fe=nt(M);Fe===void 0?delete P.smoothing:P.smoothing=Fe}),{def:nt(u.smoothing)??"off"})}
        ${Wt(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,b=!0;let jp=(()=>{if(ea)return!0;if(y.scale==="fixed")return y.minValue<0&&y.maxValue>0;let M=Et.filter(ta=>Number.isFinite(ta));if(M.length===0)return!0;let P=Math.min(...M,y.thresholdValue??1/0),Fe=Math.max(...M,y.thresholdValue??-1/0);return P<0&&Fe>0})();C=h`
        <div class="grid2">
          ${te("Style",y.style,Tg,M=>k(P=>{P.style=M}),{def:u.style})}
          ${y.style==="bars"?ae("Bar gap",y.barGap,M=>k(P=>{P.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):er(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${y.style==="bars"?h`
          <div class="grid2">
            ${ae("Corner radius",zt(y.barRadius),M=>k(P=>{let Fe=Math.max(0,M??Vn);Fe===Vn?delete P.barRadius:P.barRadius=Fe},"barradius"),{step:.5,min:0,def:zt(u.barRadius),unit:"pt"})}
          </div>
          ${Ke("Round top only",Nt(y.barCorners)==="top",M=>k(P=>{M?P.barCorners="top":delete P.barCorners}),Nt(u.barCorners)==="top")}
          ${Wt(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${te("Curve",y.curve??"straight",kg,M=>k(P=>{M==="straight"?delete P.curve:P.curve=M}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Wt(e)}
          ${y.style==="area"?h`
            ${te("Fill",_t(y.fillStyle),$g,M=>k(P=>{M==="flat"?delete P.fillStyle:P.fillStyle=M}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:_t(u.fillStyle)})}
            ${fu("Fill colour",y.fillColorHex,"Line colour",M=>k(P=>{M===void 0?delete P.fillColorHex:P.fillColorHex=M},"fillcol"))}
            ${Wt(e)}`:f}`}
        <div class="grid2">
          ${te("Scale",y.scale,Eg,M=>k(P=>{P.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${te("Baseline",y.baseline,Mg,M=>k(P=>{P.baseline=M}),{def:u.baseline})}
        </div>
        ${Sr.length===0?f:Ee("Same scale as",ea?y.scaleFrom:"",[["","Its own"],...Sr.map(M=>[M.payload.id,Re(M,Wp)])],M=>k(P=>{M?P.scaleFrom=M:delete P.scaleFrom}),{def:""})}
        ...
        ${!ea&&y.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",y.minValue,M=>k(P=>{P.minValue=M??0},"cmin"),{def:u.minValue})}
              ${ae("Max",y.maxValue,M=>k(P=>{P.maxValue=M??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let M;e.update(P=>{M=zd(P,a)}),M&&e.selectLayer(M)}}>${B("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${te("Colour",y.coloring,Fs,M=>k(P=>{P.coloring=M,M==="bands"&&P.bands.length===0&&(P.bands=dr(Et))}),{def:u.coloring})}
        ${g("Main colour")}
        ${y.coloring==="bands"?h`
          ...
          ${cr(y,y.colorSlot.baseColorHex,k)}
          ${y.style==="area"?h`${Ke("Band fill",y.fillBands,M=>k(P=>{P.fillBands=M}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let nl=M=>Pe(e.config,a).some(P=>P.payload.chartAnchor?.at===M),qp=gn(e.config,a).length>0,Yp=yn(e.config,a).length>0,Xp=bn(e.config,a).length>0,il=Sd(e.config,a).length>0,Jp=pn(y)?void 0:je&&q?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Zp=y.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0,Hn=(M,P,Fe,ta)=>h`
        <button class="small ${P?"on":""}" ?disabled=${P||ta!==void 0} aria-pressed=${P?"true":"false"}
          title=${P?`${M} is on this chart. Remove it in the list at the bottom.`:ta??`Add ${M.toLowerCase()} to this chart`}
          @click=${()=>e.update(Qp=>{Fe(Qp)})}>${P?h`<span aria-hidden="true">✓</span>`:B("plus")}<span>${M}</span></button>`;x=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders">
            ${Hn("Threshold line",nl("threshold"),M=>Td(M,a,y.thresholdValue??Ou(Et)))}
            ${Hn("Now line",nl("now"),M=>Ed(M,a,!0))}
            ${Hn("Zero line",il,M=>{wo(M,a)})}
            ${Hn("Clock times",qp,M=>{bo(M,a)},Jp)}
            ${Hn("Dots",Yp,M=>{xo(M,a)},Zp)}
            ${Hn("Grid lines",Xp,M=>{vo(M,a)})}
          </div>
        </div>
        ${il&&!jp?h`<div class="hint warn">These readings never go below zero, or never above it, so the zero
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${Wt(e)}`;break}case"timeline":{let y=n.payload,k=(he,Ne)=>s(je=>he(je.payload),Ne),E=u.historyMinutes,R=y.value.kind.kind==="entityState",F=Bt(y),G=F===void 0?void 0:e.historySeries(F),q=st(y)*60,le=Li(G??"",Vt),We=As(a,y.historyMinutes),rt=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,Le=Hg(le,q,rt===void 0?void 0:e.hass.states[rt]?.state,rt?.split(".")[0]);w=h`
        ${ce(e,y.value,he=>k(Ne=>{Ne.value=he},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        ${Ss(a,y.historyMinutes,E,he=>k(Ne=>{Ne.historyMinutes=he}))}
        ${We?Ts(y.historyMinutes,he=>k(Ne=>{Ne.historyMinutes=he},"span")):f}
        ...
        ${Lg(y,k,Le,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ae("Gap",y.gap,he=>k(Ne=>{Ne.gap=Math.min(wa,Math.max(0,he??0))},"tgap"),{step:.5,min:0,max:wa,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",y.cornerRadius,he=>k(Ne=>{Ne.cornerRadius=Math.max(0,he??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
        ...
        ${n.payload.kind==="line"?py(t,d,c):f}`,C=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,y=>s(k=>{k.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${qi("Zoom",y.zoom,G=>k(q=>{q.zoom=G},"zoom"),{min:ts,max:4,step:.05,def:1,format:G=>`${G.toFixed(2)}x`,unit:"x"})}
        ...
        ${ap(e,n.payload,(y,k)=>s(E=>y(E.payload),k),o)}
        ...
        <div class="hint">The clock times of that chart's span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,C=Tu(y,k,u,"ct",h`
        <div class="hint">Evenly spaced from the start of the chart's span to now. Auto follows the watch's
          own clock and drops the minutes past a three hour span.</div>`);break}case"chartDots":{let y=n.payload,k=(q,le)=>s(We=>q(We.payload),le),E=e.config.elements.find(q=>q.payload.id===y.chart),R=E?.kind==="chart"?E:void 0,F=R===void 0?void 0:He(e.config,t,R).size??R.payload.lineWidth,G=F===void 0?void 0:Math.round(F*18)/10;w=h`
        ${Mu(e,R)}
        ...
        ${Wt(e)}`,C=h`
        ${te("Dots",y.dots,Cg,q=>k(le=>{le.dots=q}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",y.size??G,q=>k(le=>{let We=mt(q);We===void 0||We===G?delete le.size:le.size=We},"dotsize"),{step:.5,min:1,max:12,...G===void 0?{}:{def:G},unit:"pt"})}
          ${fu("Dot colour",y.colorHex,"Series colour",q=>k(le=>{q===void 0?delete le.colorHex:le.colorHex=q},"dotcol"))}
        </div>
        ...
        <div class="grid2">
          ...
          ${ae("Thickness",y.thickness,F=>k(G=>{G.thickness=On(F??Nn)},"thick"),{step:.25,min:Wr,max:jr,def:Nn,unit:"pt"})}
        </div>
        ${be("Colour",y.colorHex,F=>k(G=>{G.colorHex=F??ln},"gridcol"),!1,ln)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let $=b||Wi(n)===void 0?void 0:g(n.kind==="shape"?"Fill colour":n.kind==="text"&&yt(n.payload)?"Layer colour":"Colour"),S=To(e.config,n),I=S?{kind:{kind:"entityState",...S}}:void 0,N=n.kind==="image"?n.payload.timestamp===!0:!1,H=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,Z=Dy[n.kind],T=Oy[n.kind],O=Cs(n.payload,u,Z),X=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,U=e.config.perFamily[t]?.placements[a]?.size!==void 0,ee=Cs(n.payload,u,T)||X!==void 0&&l.size!==void 0&&l.size!==u[X],A=fn(e.config,a),K=(y,k)=>()=>s(E=>tr(E.payload,u,y),k);return h`
    ${we(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"?f:tp(e,n,o)}${w}`,{color:Q.content,icon:"content",summary:Ps(e,n),...O?{reset:()=>s(y=>{tr(y.payload,u,Z),y.kind==="text"&&Bi(y.payload.rules)},"reset-content")}:{}})}
    ...
    ${b===0?f:h`
      ...
      <div class="hint">Click a row to edit that layer. The × deletes it, and Undo brings it back. Dots and grid
        ...
        dot to pick the dots.</div>`}`}function Ky(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ve(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=Eo(e.config,n);return h`
    ${Ke("Tappable",a!==void 0,s=>e.update(l=>{s?Sa(l,i):Ta(l,i)}))}
    ${a?h`<div class="value-editor">
          ${ap(e,a.payload,r,`${t}-attached`)}
        ...
        ${By(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${xt(o)}</b>.</div>`}`}function Fu(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Wy(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Re(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=dn.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return Fu(xe(e.payload.value,n));case"icon":return Fu(xe(e.payload.symbol,n));case"gauge":return xe(e.payload.value,n);case"chart":return xe(e.payload.value,n);case"timeline":return xe(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines"}}function rp(e,n){let t=wt(e.config,n.id),i=ue(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return we(e,"content","Group",h`
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:Q.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function op(e,n){if(n==="inline")return jy(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ne(n)} yet.</div>
    ...
    ${n==="corner"?we(e,"corner","Corner content",qy(e,t,i),{color:Q.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${we(e,"states","Shape states",pp(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:Q.states,icon:"states",summary:Pi(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${we(e,"content","Inline text",h`
      ...
      ${Ds(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:Q.content,icon:"text",summary:Oe(`${n.label?`${n.label}: `:""}${xe(n.value,i)}`,48)})}
    ${we(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:Q.look,icon:"icon",summary:n.symbol||"None"})}`}function qy(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${s===void 0?f:sp(s,n.partId,ue(e),m=>u(b=>{m?b.partId=m:delete b.partId}))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${dp(e,n.otherwise,a,m=>u(b=>{b.otherwise&&m(b.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
    ...
    ${dp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function ib(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=wn(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=ce(e,s.value??L(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${ce(e,s.value??L(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${ce(e,s.upper??L(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${ve("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!ab(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Au(e,"From",s.value??L("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Au(e,"To",s.upper??L("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=rb(n.value)?ob(s.options??[],u=>o(p=>{p.comparison.options=bs(u)},"options")):ve("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${c}
  </div>`}function ab(e){try{return new RegExp(e),!0}catch{return!1}}function Au(e,n,t,i,a){if(t.kind.kind!=="literal")return ce(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=vn(r)??"";return h`<label class="field"><span>${n}</span>
    ...
    </div></div>`}function dp(e,n,t,i,a,r=!1){let o=Jy(t,r);return h`
    ...
    </select>`}var cp=["setColor","setBorderColor","setBackgroundColor"];function sb(e,n,t,i,a,r,o,s=!1){let l=!Ri[i].includes(_e[n.kind]),d=s&&!l&&!hr.includes(_e[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${up(e,n,a,o)}
  </div>`}function up(e,n,t,i){let a=Fa(n.kind),r=f;if(a==="value"){let o=n.value??L("");if(cp.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?be("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=L(l??"#FFFFFF")},"color")):ce(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${eb(e,n,t,i,a,o)}`:lb(e,s.table,n[0],t,i,a,r,o)}function lb(e,n,t,i,a,r,o,s){let l=(y,k)=>e.update(E=>{let R=a(E);R&&y(R)},k?`${r}-${k}`:void 0),d=n.value??Iu.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Qc(d)&&db(e.resolve(d)),p=Ri[i],m=ar.get(r)??new Set,b=n.columns.length===0&&m.size===0?[Zc[i]]:[],g=Gc(n.columns,[...m,...b.filter(y=>y!==void 0)],p),x=nr.get(r),w=t?t.partId:s?.some(y=>y.id===x)?x:void 0,C=s!==void 0&&w!==void 0,$=C?p.filter(y=>hr.includes(y)):p,S=C?g.filter(y=>!hr.includes(y)):[],I=(y,k)=>{if(!t){y?nr.set(r,y):nr.delete(r),Te(k);return}l(E=>{let R=E[0];R&&(y?R.partId=y:delete R.partId)})},N=t?e.liveBranch(t):"none",H=t?e.forced.get(t.id)??"live":"live",Z=y=>H!=="live"&&(H==="otherwise"?y==="otherwise":H.caseId===y),T=y=>{t&&e.setForced(t.id,Z(y)?"live":y==="otherwise"?"otherwise":{caseId:y})},O=y=>{Iu.set(r,y),n.rows.length!==0&&l(k=>Yc(k,y),"lhs")},X=()=>{nr.delete(r),l(y=>{jc(y,d??L(""),u),w!==void 0&&y[0]&&y[0].partId===void 0&&(y[0].partId=w)})},U=n.rows.map((y,k)=>Lu(e,{key:`${r}-${y.caseId}`,label:Jc(y.comparison,E=>xe(E,ue(e))),columns:g,changes:y.changes,live:N===y.caseId,forced:Z(y.caseId),onForce:()=>T(y.caseId),when:mb(e,y.comparison,`${r}-${y.caseId}`,(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===y.caseId)?.when.tests[0];G&&E(G.comparison)},R&&`${y.caseId}-${R}`)),updChanges:(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===y.caseId);G&&E(G.then)},R&&`${y.caseId}-${R}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${k===0} @click=${()=>l(E=>us(E,k,k-1))}>${B("up")}</button>
      <button class="icon" title="Move down" ?disabled=${k===n.rows.length-1} @click=${()=>l(E=>us(E,k,k+1))}>${B("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>qc(E,y.caseId))}>${B("delete")}</button>`})),ee=n.otherwise===void 0?f:Lu(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:N==="otherwise",forced:Z("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(y,k)=>l(E=>{let R=E[0]?.otherwise;R&&y(R)},k),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(y=>ps(y,!1))}>${B("close")}</button>`}),A=rr.get(r),K=cb.filter(y=>$.includes(y)&&!g.includes(y));return h`
    <div class="states">
      ${ce(e,d??L(""),O,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:sp(s,w,ue(e),I)}
          ...
          <tr>
            ...
            ${g.map(y=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${ct[y]} column`}
                @click=${k=>{rr.set(r,y),Te(k.target)}}>${B("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${A===void 0?f:h`<div class="hint warn confirm-row">
        ...
        <button class="danger small" @click=${y=>{rr.delete(r),ar.get(r)?.delete(A),Te(y.target),l(k=>Xc(k,A))}}>Remove</button>
      ...
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${K.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${y=>{let k=y.target,E=k.value;if(k.value="",!E)return;let R=ar.get(r)??new Set;R.add(E),ar.set(r,R),Te(k)}}>
  ...
  </tr>`}function pb(e,n,t,i,a){let r=Ya(t,n),o=xr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${ct[n]} for this state`}
      @click=${d=>{i(c=>{c.push(kn(Bc[n]))}),Bu(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>_e[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=ct[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${hb(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Gu}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${Yi.has(o)?h`${n==="visibility"?te("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):up(e,r,s,a)}
    ...
    </div>`}function hb(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Fa(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${ri.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??L(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(cp.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Se(a):xe(i,ue(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${xe(i,ue(e))}</span>`}function Se(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function mb(e,n,t,i){let a=wn(n.kind),r=ds(n.kind),o=(s,l,d,c)=>gb(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ye(s=>i(l=>{let d=Po(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${ls.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${fb(s)}</option>`)}
    </select>
...
`)}
${a}}`};return t(e,"")}function Sp(e,n,t=[]){let i=n==="share"?Bb(e,t):e,a=Yn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${Gb(a)}
`}function Tp(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var Ub="There is nothing to read here. Paste a complication first.",Kb="This is not valid JSON. Check for a missing brace or a stray comma.",Wb="This is valid JSON but not a complication. A complication starts with { and ends with }.",jb="This does not look like a complication.",wp="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",qb="00000000-0000-4000-8000-000000000000";function Yb(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function Ep(e,n){let t=e.trim();if(t==="")return{ok:!1,error:Ub};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:Kb}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:Wb};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${wp}`};let o={...a,id:qb,slotIndex:0},s;try{s=qn(o)}catch(d){let c=d instanceof Xe||d instanceof Error?d.message:String(d);return{ok:!1,error:`${jb}

${Yb(c)}`}}let l=$a(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${wp}`}}return{ok:!0,config:s,raw:i}}function Us(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=_o(e,(o,s)=>vp(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=vp(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:kp(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Mp(e,n){let t=structuredClone(e);Ho(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Lo(t,a=>Ro(a,i)),t}function Rp(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function Xb(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Fp(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=Va(e);return i.length===0?t:`${t}, ${Xb(i)}`}function Ks(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var Zb=3e4,Qb=500,ex=3e4,Ap="preset-entity";function Ip(e){return`import-entity-${e}`}var tx={entityId:"",displayName:"",domain:""},nx=new Map,ix={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Ws(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function ax(e){return e.kind==="family"?"look":"content"}function js(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Hp(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function rx(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Lp=300,_p=360,Xs=44,Js=22,Bp=[1,1.7,2.6],ox=["S","M","L"],zp=["Small","Medium","Large"];function sx(){return Bp.map((e,n)=>{let t=Math.round(Xs*e),i=Math.round(Js*e),a=`.layers-card.s${n}`;return`
...
`)}var Np="wrist-assistant-panel.layers.v1",St=34,An=200,lx=720,$r=320,dx=80,cx=56,Pp="wrist-assistant-panel.columns.v3",qs=e=>Math.max(An,Math.min(lx,Math.round(e))),Dp=e=>e.metaKey||e.ctrlKey||e.shiftKey,ux=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Qi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Jt=Qi==="Cmd"?"\u2318":"Ctrl+",Ys=Qi==="Cmd"?"\u21E7":"Shift+";function Op(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-dx;if(i>=An*2+$r){let r=i-$r,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(An,Math.floor(o*l)),s=Math.max(An,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(An,o-d):s=Math.max(An,s-d))}return{columns:3,left:o,right:s}}let a=e-cx;return a>=An+$r?{columns:2,left:Math.min(n,a-$r),right:t}:{columns:1,left:n,right:t}}var _=class _ extends Rt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Lp;this.colRight=_p;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=ti.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Nc(()=>this.requestUpdate());this.imageSizes=Pc(()=>this.requestUpdate());this.symbols=new Ka(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new qa;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Us(a,this.hass.states);r.some(s=>Ns(Ip(s.entityId)))||Ks({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Ns(Ap)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??nx}static{this.styles=Er`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(mr,this.scrubStart),this.addEventListener(fr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},ex)}loadColumnWidths(){try{let t=window.localStorage.getItem(Pp);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=qs(i.left)),typeof i.right=="number"&&(this.colRight=qs(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Pp,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Np);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Np,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Qu(s,o,i))}>Copy the ${ne(o)} layout</button>`)}
          </div>
        ...
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${Vp(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Hp()}
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=Tp(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Us(i,this.hass.states):[],r=Ks({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?h`<div class="hint err">A complication on this watch already has that name.</div>`:h`<div class="hint">${Fp(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${Cp(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${pt({hass:this.hass},t.label,i??tx,a=>this.setImportEntity(t.entityId,a),Ip(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Vp(a)}</option>`)}
              </select>
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(T,d)}</b>
          <small><span class="kind">${ii[T.kind]}</span> · ${fx(T,c,this.historySeries,A.size)}</small>
          ${S?h`<span class="facts">${hx(this.host(),a,T,A).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
      ...
      </div>`},H=[],Z=new Set;for(let T=0;T<l.length;T++){let O=l[T],X=O.payload.groupId,U=X===void 0?void 0:t.groups?.find(K=>K.id===X);if(!U){H.push(I(O,!1));continue}if(Z.has(U.id))continue;Z.add(U.id);let ee=l.filter(K=>K.payload.groupId===U.id);H.push(N(U,ee));let A=this.inspect.kind==="group"&&this.inspect.id===U.id;this.collapsed.has(U.id)||H.push(h`<div class="group-kids">${ee.map(K=>I(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${w}px;--thumb-h:${C}px`}>
      <h2 class="panel-title tools" style=${`--c:${Q.place}`}><span class="swatch">${B("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${ox.map((T,O)=>h`
              <button class=${this.thumbStep===O?"on":""} title=${`${zp[O]} row pictures`}
                aria-label=${`${zp[O]} row pictures`} aria-pressed=${this.thumbStep===O?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?gp(this.presetKind):void 0,i=this.presetEntity;return h`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:h`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${pt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Ap,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=xp(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=_i(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?Qn((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Zu();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${B("content")}</span>Shared values
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
        ...
        ${p?h`<div class="value-open">${Ju(s,c)}</div>`:f}</div>`})}
      </div>
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${we(a,"complication","Complication",Yu(a),{color:Q.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=ip(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=rp(a,c)}else s=op(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ue(r),s=new dt(this.buildContext(),this.draft?.config),l=ep(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(b=>{for(let g of i)Me(b,a,g.payload.id,{isHidden:m})}),p=m=>this.mutate(b=>{for(let g of i){let x=b.elements.find(w=>w.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&x.kind!=="chartTimes"&&x.kind!=="chartDots"&&x.kind!=="chartGrid"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
