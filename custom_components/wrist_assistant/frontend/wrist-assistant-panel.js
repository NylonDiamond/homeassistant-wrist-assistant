...
`)}function qc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,rg(r));return{values:t,nullKeys:i}}function rg(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Ts(e){let n=gr(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function og(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Vo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var sg=10800;function lg(e,n,t){let i=n==="always"||n==="auto"&&t<=sg;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function yr(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=lg(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function dg(e,n){return yt(e)===void 0?[]:yr(lt(e)*60,Vi(e.timeLabelCount),e.hourCycle,e.minutes,n)}function cg(e,n){return An(e)?yr(Math.round(e.historyMinutes)*60,Vi(mt(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function ug(e,n,t,i){return n===void 0&&i!==void 0?yt(i)===void 0?[]:yr(lt(i)*60,Vi(mt(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!An(n)?[]:yr(Math.round(n.historyMinutes)*60,Vi(mt(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Un(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function je(e){let n=e.trim(),t=Un(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Un(i)}function pg(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function hg(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function mg(e){let n=e.trim(),t=Un(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Un(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Un(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function fg(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function gg(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function yg(e,n,t){if(_e(n))return e;let i=n,a=e,r=Un(e.trim()),o=i.duration?mg(e):void 0;if(o!==void 0)a=fg(o);else if(i.relativeTime&&r!==void 0)a=hg(r);else{let s=je(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):pg(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=gg(a);break}return a}function mi(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function qe(e,n=240){return Qc(e,n).map(t=>t.value)}function Ms(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of qe(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:Zc(r)}}function Zc(e){return e.some(n=>n)?e:[]}function Qc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Yc(e,n,t){let i=Qc(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Qt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ue,c=t.highColorHex??Qe,u=t.lowColorHex??et,p=[],m=(y,b)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===b?k.text+=y:p.push({text:y,colorHex:b})},f=0;return i.forEach((y,b)=>{m(e.slice(f,y.start),n);let k=b===o?c:b===s?u:l.length>0?Za(y.value,l,d):n,$=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,$),k),f=$}),m(e.slice(f),n),p}function Xc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function bg(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Zi(e,n=an){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:xg(i.slice(a+1))})}return t}function xg(e){try{return decodeURIComponent(e)}catch{return e}}function vg(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Jc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function wg(e,n,t){if(e===void 0)return 0;let i=je(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var xt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=Xc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=In(n),i=Ln(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Ms(a):{values:qe(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=Zc(s),{values:Rs(o,ot(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:je(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=je(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Xc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!_e(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?og(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?tc(r):Vo(r,a.domainMax-a.domainMin));break}default:{let a=Ss(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return yg(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Un(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?mi(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=je(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:je(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:je(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Bn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Bn(d),p=c===void 0?void 0:Bn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ne[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Yc(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,f=st(n.payload)&&!r.has("text"),y={kind:"text",...u,text:f?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),f?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(Xd(n.payload)&&(y.spans=Yc(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),f=n.payload.symbol.kind.kind==="literal",y=m===void 0&&f&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let k={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),f=(_,A,W)=>_??(A?je(this.resolve(A)??""):void 0)??W,y=f(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=f(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:je(m),$=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&($=Za(k,Qt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let _=je(this.resolve(p.total)??"");_!==void 0&&(w=_)}let S=Jc(w,1,Xa),L={kind:"gauge",...u,fraction:wg(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:$,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:Jc(k??0,0,S)};if(p.thresholdValue!==void 0&&b!==y){let _=(p.thresholdValue-y)/(b-y);_>=0&&_<=1&&(L.thresholdFraction=_)}return L}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),f=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Qt(p),w=Bo(p)?f.map(q=>Za(q,$,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",L=p.highlight==="lowest"||p.highlight==="both",_=_i(p),A={kind:"chart",...u,values:f,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?_.high:"none",lowMarker:L?_.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:ot(p.smoothing)??"off",fillStyle:qt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:Yt(p.barRadius),barCorners:Xt(p.barCorners),barBorderWidth:Po(p),barFillColorHexes:[],barBorderColorHexes:[],barBorderOpenBase:Po(p)>0&&p.barBorderOpenBase===!0,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:cg(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},W=y.length===0?f:f.filter((q,U)=>!y[U]);if(W.length>0){let q=R=>f.findIndex((K,H)=>K===R&&y[H]!==!0),U=S?q(Math.max(...W)):-1,ee=L?q(Math.min(...W)):-1;U>=0&&(A.highIndex=U),ee>=0&&ee!==U&&(A.lowIndex=ee)}if(p.style==="bars"){let q=f.map((U,ee)=>ec(p,U,$,k,ee===A.highIndex?p.highColorHex:ee===A.lowIndex?p.lowColorHex:void 0));A.barFillColorHexes=q.map(U=>U.fill),A.barBorderWidth>0&&(A.barBorderColorHexes=q.map(U=>U.border))}let E=bg(p,b.min,b.max);E!==void 0&&(A.thresholdY=E);let G=this.chartNowIndex(p,f.length);return G!==void 0&&(A.nowIndex=G),A}case"timeline":{let p=n.payload,m=yt(p),f=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=Zi(f,an),b=vg(y,lt(p)*60,$=>lc($,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:dg(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};ar(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:ug(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),f={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(f.url=y),f}case"chartDots":{let p=n.payload,m=ht(p.size),f={kind:"chartDots",...u,chart:p.chart,dots:Ka(p.dots),diameter:0,indices:[]};return m!==void 0&&(f.size=m),p.colorHex!==void 0&&(f.colorHex=p.colorHex),f}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Mn(p.lines),colorHex:Kt(p.colorHex),thickness:Rn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...Eg(Tg(Ec(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,k=this.resolve(b.value),$=k===void 0?void 0:je(k);if($!==void 0){let w=Math.min(b.minValue,b.maxValue),S=Math.max(b.minValue,b.maxValue),L={value:Math.min(S,Math.max(w,$)),minValue:w,maxValue:S===w?w+1:S,colorHexes:b.colorHexes},_=this.resolve(b.minLabel);_!==void 0&&(L.minLabel=_);let A=this.resolve(b.maxLabel);A!==void 0&&(L.maxLabel=A),l.bezelGauge=L}}let f=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(l.backgroundColorHex=f);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function kg(e,n,t){let i=new xt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function fi(e,n,t){let i=new xt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=kg(e.inline,n,e)),a}function Qi(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Es=5,$g=1.7,Cg=1.8;function Sg(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Tg(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Cg,l=Math.max(o.frame.width*n.width,0),d=Sg(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function eu(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function tu(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function br(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=A=>A==="triangle"?Es+d:A==="dot"?Math.max(d,$g):d,u=c(a),p=c(r),m=n.y+u,f=Math.max(n.h-u-p,1),y=m+f,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",$=k?f*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-w*(i-1))/i,.5),L=A=>Math.min(1,Math.max(0,(A-e.domainMin)/b)),_=A=>y-L(A)*f;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:_(0),inset:d,yAtFraction(A){return y-Math.min(Math.max(A,0),1)*f},barRect(A){let W=o+A*(S+w),E=t[A],G,q;if(k){let U=$+L(E)*(f-$);G=y-U,q=y}else G=_(E),q=k?y:_(0),G>q&&([G,q]=[q,G]);return{x:W,y:G,w:S,h:Math.max(q-G,.5)}},point(A){let W=Math.max(s-d*2,0);return{x:t.length>1?o+d+W*A/(t.length-1):o+s/2,y:_(t[A])}},markerCenter(A,W,E="high"){let G=W?this.barRect(A):void 0,q=G?G.x+G.w/2:this.point(A).x,U=E==="high"?a:r,ee=E==="high"?U==="triangle"?n.y+Es/2:m:U==="triangle"?n.y+n.h-Es/2:y;return{x:q,y:ee}}}}function nu(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Rs(e,n,t=[]){let i=e.length,a=Yd(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,f=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,k=Math.exp(-(b*b)/(2*o*o));m+=e[y]*k,f+=k}return m/f}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function iu(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Ji=1;function Kn(e,n){let t=Math.max(tn,Math.min(nn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Ji>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Ji:n.y,h:n.h-i-Ji,cy:(e.labelsAbove?n.y+i+Ji:n.y)+(n.h-i-Ji)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Eg(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&eu(r)===void 0)return{...i,isHidden:!0};let o=Rg(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Mg(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Rg(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Qi(t,i);if(a.w<=0||a.h<=0)return;let r=Kn(t,a).body;if(r.w<=0||r.h<=0)return;let o=br(t,r),s,l;if(gt(n.at)){let k=Mg(n.at,t);if(k===void 0)return;if(t.style==="bars"){let $=o.barRect(k);s=$.x+$.w/2,l=$.y}else{let $=o.point(k);s=$.x,l=$.y}}else{let k=n.at==="zero"?eu(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,$,w)=>$>w?($+w)/2:Math.min(Math.max(k,$),w),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let f=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(f,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var Hs=[.01,.025,.05,.1];function gi(e,n){return!(n.width>0&&n.height>0)||n.width===n.height?{x:e,y:e}:n.width>n.height?{x:e*n.height/n.width,y:e}:{x:e,y:e*n.width/n.height}}function Fs(e){return typeof e=="number"?{x:e,y:e}:e}function As(e){return e.x>0&&e.y>0}var au=1e-6;function ea(e,n){return Math.round((e-.5)/n)*n+.5-e}function ru(e,n,t){let a=[e,e+n/2,e+n].map(r=>ea(r,t)).reduce((r,o)=>Math.abs(o)<Math.abs(r)?o:r);return le(e+a)}function Hg(e,n){let t=Fs(n);return As(t)?yi({...e,x:ru(e.x,e.width,t.x),y:ru(e.y,e.height,t.y)}):e}function ou(e,n,t,i={x:!0,y:!0}){let a=Fs(t);if(!As(a))return e;let{x:r,y:o,width:s,height:l}=e,d=r+s,c=o+l;if(i.x&&n.includes("e")&&(s=Math.max(Ue,le(d+ea(d,a.x)-r))),i.x&&n.includes("w")){let u=Math.min(le(r+ea(r,a.x)),d-Ue);s=le(d-u),r=le(u)}if(i.y&&n.includes("s")&&(l=Math.max(Ue,le(c+ea(c,a.y)-o))),i.y&&n.includes("n")){let u=Math.min(le(o+ea(o,a.y)),c-Ue);l=le(c-u),o=le(u)}return{...e,x:r,y:o,width:s,height:l}}function Is(e,n,t,i){let a=Fs(i);if(!As(a))return e;let r=(o,s,l)=>{if(s===0)return o;let d=(o-.5)/l,c=s>0?Math.floor(d+au)+1:Math.ceil(d-au)-1,u=le(c*l+.5);for(let p=0;p<1e3&&(s>0?u<=o:u>=o);p++)c+=s,u=le(c*l+.5);return u};return yi({...e,x:r(e.x,Math.sign(n),a.x),y:r(e.y,Math.sign(t),a.y)})}var Ue=.04,xr=.04;function su(e,n){let t=()=>{let a=e.getScreenCTM();return a&&a.a!==0&&a.d!==0?{x:a.a,y:a.d}:void 0},i=t()??{x:1,y:1};return a=>(i=t()??i,{x:(a.clientX-n.clientX)/i.x,y:(a.clientY-n.clientY)/i.y})}function vr(e,n){let t={...e,...n};return yi({...t,x:le(t.x),y:le(t.y),width:Math.max(Ue,le(t.width)),height:Math.max(Ue,le(t.height))})}function Ls(e,n){let t=n==="down"?e.x:le((1-e.width)/2),i=n==="across"?e.y:le((1-e.height)/2);return yi({...e,x:t,y:i})}function lu(e,n){let t=Ls(e,n);return t.x===e.x&&t.y===e.y}function yi(e){let n=Math.min(1-xr,Math.max(-e.width+xr,e.x)),t=Math.min(1-xr,Math.max(-e.height+xr,e.y));return{...e,x:n,y:t}}var le=e=>Math.round(e*1e3)/1e3,du=10;function wr(e,n,t,i){let a=i.width>0?e.x+n/i.width:e.x,r=i.height>0?e.y+t/i.height:e.y;return yi({...e,x:le(a),y:le(r)})}function Fg(e,n,t,i){let a=n.width,r=n.height,o=e.width*a,s=e.height*r,l=Math.min(o,s),d=e.x*a+(o-l)/2,c=e.y*r+(s-l)/2,u=t.includes("e")?1:-1,p=t.includes("s")?1:-1,m=Ue*Math.max(a,r),f=Math.max(m,l+(u*i.x+p*i.y)/2),y=u>0?d:d+l-f,b=p>0?c:c+l-f;return{...e,x:le(y/a),y:le(b/r),width:le(f/a),height:le(f/r)}}function Ag(e,n,t,i,a=!1){let r=n.width,o=n.height;if(a||e.width*r>=e.height*o){let p=a?Ue:Math.max(Ue,e.height*o/r),m=e.x+e.width,f=t.includes("e")?Math.max(p,e.width+i.x/r):Math.max(p,e.width-i.x/r),y=t.includes("e")?e.x:m-f;return{...e,x:le(y),width:le(f)}}let l=Math.max(Ue,e.width*r/o),d=e.y+e.height,c=t.includes("s")?Math.max(l,e.height+i.y/o):Math.max(l,e.height-i.y/o),u=t.includes("s")?e.y:d-c;return{...e,y:le(u),height:le(c)}}function kr(e,n,t,i,a){let r=su(e,t),o={...i.handle&&i.outline?i.outline:i.frame},s={...i.frame};e.setPointerCapture(t.pointerId);let l=p=>Math.round(p*1e3)/1e3,d=p=>{if(p.pointerId!==t.pointerId)return;let m=r(p),f=m.x/n.width,y=m.y/n.height,b,k=i.snap!==void 0&&i.snap.on!==p.altKey?i.snap.step:void 0;if(!i.handle)b=yi({...o,x:l(o.x+f),y:l(o.y+y)}),k!==void 0&&(b=Hg(b,k));else if(i.square)b=Fg(o,n,i.handle,m);else if(i.line||i.bar){if(b=Ag(o,n,i.handle,m,i.bar===!0),k!==void 0){let $=i.bar===!0||b.width*n.width>=b.height*n.height;b=ou(b,i.handle,k,{x:$,y:!$})}}else{let{x:$,y:w,width:S,height:L}=o,_=o.x+o.width,A=o.y+o.height;i.handle.includes("e")&&(S=Math.max(Ue,o.width+f)),i.handle.includes("s")&&(L=Math.max(Ue,o.height+y)),i.handle.includes("w")&&(S=Math.max(Ue,o.width-f),$=_-S),i.handle.includes("n")&&(L=Math.max(Ue,o.height-y),w=A-L),b={...o,x:l($),y:l(w),width:l(S),height:l(L)},k!==void 0&&(b=ou(b,i.handle,k))}s=b,a.onFrame(i.elementId,b,!1)},c=p=>{p.pointerId===t.pointerId&&(u(),a.onFrame(i.elementId,s,!0))},u=()=>{e.removeEventListener("pointermove",d),e.removeEventListener("pointerup",c),e.removeEventListener("pointercancel",c);try{e.releasePointerCapture(t.pointerId)}catch{}};return e.addEventListener("pointermove",d),e.addEventListener("pointerup",c),e.addEventListener("pointercancel",c),u}function cu(e,n,t,i,a){let r=su(e,n),o=1;e.setPointerCapture(n.pointerId);let s=c=>{if(c.pointerId!==n.pointerId)return;let u=r(c),p=u.x*(t.includes("e")?1:-1),m=u.y*(t.includes("s")?1:-1),f=i.w>0?(i.w+p)/i.w:1,y=i.h>0?(i.h+m)/i.h:1,b=Math.abs(f-1)>=Math.abs(y-1)?f:y;o=Math.max(.05,b),a(o,!1)},l=c=>{c.pointerId===n.pointerId&&(d(),a(o,!0))},d=()=>{e.removeEventListener("pointermove",s),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l);try{e.releasePointerCapture(n.pointerId)}catch{}};return e.addEventListener("pointermove",s),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),d}var ze=pe,na=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ze,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],bi=na.find(e=>e.measured);function $u(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return na.find(a=>a.screen.width===t&&a.screen.height===i)}function Sr(e,n){let t=ze[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}function uu(e,n){if(n===void 0||!(n>0))return g;let t=gi(n,e),i=[],a=n<.025,r=l=>l===0?"rgba(10,132,255,0.6)":a&&l%10!==0?"rgba(255,255,255,0.06)":"rgba(255,255,255,0.14)",o=Math.floor(.5/t.x+1e-6);for(let l=-o;l<=o;l++){let d=(.5+l*t.x)*e.width;d<=0||d>=e.width||i.push(v`<line x1=${d} y1="0" x2=${d} y2=${e.height} stroke=${r(l)} stroke-width="0.5" vector-effect="non-scaling-stroke" />`)}let s=Math.floor(.5/t.y+1e-6);for(let l=-s;l<=s;l++){let d=(.5+l*t.y)*e.height;d<=0||d>=e.height||i.push(v`<line x1="0" y1=${d} x2=${e.width} y2=${d} stroke=${r(l)} stroke-width="0.5" vector-effect="non-scaling-stroke" />`)}return v`<g class="snap-grid" pointer-events="none">${i}</g>`}var Ps={regular:400,medium:500,semibold:600,bold:700},Cu=1.15;function Ye(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function me(e,n,t="#FFFFFF"){let i=Ye(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var zt=e=>e*.55;function Su(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Ig(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Lg(e,n,t){if(t<=0||e.length*zt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/zt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function _g(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Tu(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Eu(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function zg(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Mu(e,n){return e.reduce((t,i)=>t+i.text.length*zt(i.look.fontSize*n),0)}function Pg(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:zt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=zt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Ng(e,n,t){if(t<=0||Mu(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*zt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*zt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Dg(e,n,t){let i=zg(n),a=e.lineLimit===2&&t.w>0?Pg(e.text,i,t.w):[e.text],r=Tu(e.text,a),o=a.map(($,w)=>Eu($,r[w]??0,e.text,i,i[0])),s=Math.max(...o.map($=>Mu($,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map($=>Ng($,l,t.w)),{anchor:c,x:u}=Su(e.alignment,t),p=Math.max(0,...d.flat().map($=>$.look.fontSize))*l||e.fontSize*l,m=.35*p,f=p*1.15,y=$=>$.map(w=>{let S=me(w.look.colorHex,"fill");return v`<tspan font-size=${w.look.fontSize*l} font-weight=${Ps[w.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${w.text}</tspan>`}),b=me(e.colorHex,"fill"),k=d.length>1?v`${d.map(($,w)=>v`<tspan x=${u} y=${t.cy+m+(w-(d.length-1)/2)*f}>${y($)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${b.fill} fill-opacity=${b["fill-opacity"]}>${k}</text>`}function Og(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?g:Dg(e,e.parts,n);let t=me(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:mi((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Ig(e.text,n.w/zt(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*zt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Lg(y,o,n.w)),{anchor:l,x:d}=Su(e.alignment,n),c=_g(e.text,e.spans),u=c?Tu(e.text,i):[],p=(y,b)=>c?Eu(y,u[b]??0,e.text,c,e.colorHex).map(k=>{let $=me(k.look,"fill");return v`<tspan fill=${$.fill} fill-opacity=${$["fill-opacity"]}>${k.text}</tspan>`}):y,m=o*1.15,f=s.length>1?v`${s.map((y,b)=>v`<tspan x=${d} y=${n.cy+(b-(s.length-1)/2)*m}>${p(y,b)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Ps[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":g}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${f}</text>`}var Ns=2;function Ru(e,n){let t=n.w>=n.h,i=Math.max(1,e.dotCount),a=t?n.w:n.h,r=t?n.h:n.w,o=Math.max(1,Math.min(r,a/i-Ns)),s=i*o+(i-1)*Ns;return{horizontal:t,count:i,d:o,span:s}}function Bg(e,n){let t=me(e.colorHex,"stroke"),i=me(e.trackColorHex,"stroke","#FFFFFF"),a=me(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let{horizontal:m,count:f,d:y,span:b}=Ru(e,n),k=(m?n.cx:n.cy)-b/2+y/2;return v`${Array.from({length:f},($,w)=>{let S=k+w*(y+Ns),L=w<e.filledCount?t:i;return v`<circle cx=${m?S:n.cx} cy=${m?n.cy:S} r=${y/2}
        fill=${L.stroke} fill-opacity=${L["stroke-opacity"]} />`})}`}if(e.style==="bar"){let m=n.w,f=Math.max(r,m*e.fraction),y=1;return v`
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Qg(e,n,t){if(e.path!==void 0&&e.path!==""){let o=me(e.colorHex,"fill"),s=e.size*Cu;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Ks=.25,ey=8;function ty(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Ks),ey),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,f=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),b=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(f-n)/2*(1+b)+0,width:m,height:f}}function Ws(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Cr=4;function ny(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Cr:n.x+n.w-Cr-a,d=e.timestampCorner.startsWith("top")?n.y+Cr:n.y+n.h-Cr-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function iy(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function ay(e,n,t){let i=t.icons,a=`imgclip-${Hu()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ny(e,n,Ws(new Date)):void 0,s=o?Lu(o):g,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=ty(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=v`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(iy(e.source,e.entityId),14,"#FFFFFF99")??g}</g>`;return v`
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function ry(e,n){if(!e.linked)return g;let t=Ws(new Date),i=as(n.w,n.h);if(i<=0)return g;let a=t.length*i*.578+i*.89,r=i*1.25;return Lu({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function oy(e,n,t,i,a){if(!i)return g;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?sy(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Ds} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??g}</g>`:g}`}var Ds=5;function sy(e,n){let t=Ds*.55,i=n.w-2;if(n.h<Ds*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function _u(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function Os(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return g;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return g;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return g;let d=Qi(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=Og(e,d);break;case"icon":u=Qg(e,d,t.icons);break;case"gauge":u=Bg(e,d);break;case"chart":u=Gg(e,d);break;case"timeline":u=jg(e,d);break;case"chartTimes":u=qg(e,d);break;case"imageTime":u=ry(e,d);break;case"chartDots":u=Yg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=Xg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=Zg(e,d);break;case"image":u=ay(e,d,t);break;case"tap":u=oy(e,d,t.icons,r,c?At(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,f=t.highlightId===e.id,y=f||t.highlightIds?.includes(e.id)===!0,b=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",$=t.handles===!0&&(!l||s)&&!b&&!k,w=Au(e,d),S=y&&!b?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:g,L=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:g,_=b?g:v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="transparent" stroke="none" />`,A=3,W=w,E=f&&$?[["nw",W.x,W.y],["ne",W.x+W.w,W.y],["sw",W.x,W.y+W.h],["se",W.x+W.w,W.y+W.h]].map(([G,q,U])=>v`<rect data-handle=${G} x=${q-A/2} y=${U-A/2} width=${A} height=${A}
    ...
    transform="rotate(${e.frame.rotationDegrees} ${d.cx} ${d.cy})">${_}${u}${L}${S}${E}</g>`}function Tr(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function js(e,n){return(n?23.5:34)*e}var fu=10.5;function zu(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function gu(e,n){let t=0;for(let i of e)t+=zu(i,n);return t}function yu(e,n,t){let i=e.toUpperCase(),a=d=>zu(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Bs(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Vs(e,n,t,i){let a=Bs(e,n,t),r=Bs(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Pu(e,n,t,i){let{dial:a}=Tr(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Vs(a,t,i.start,i.end),length:t*r}}function ly(e,n){let t=Tr(e,!0);return Pu(e,n,t.dial.r,t.labelArc)}var bu=18.5,dy=113,cy={start:-71,end:-36},xu=104,uy=6.2,vu={start:-77,end:-30.5};function wu(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function ku(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=wu(e[i]),o=wu(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var zs=11;function py(e,n,t){let{dial:i}=Tr(n,!0),a=xu*n,r=180/(Math.PI*xu),o=e.minLabel!==void 0?gu(e.minLabel,zs)*r:0,s=e.maxLabel!==void 0?gu(e.maxLabel,zs)*r:0,l=vu.start+(o>0?Math.max(0,o-1.8):0),d=vu.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let k=0;k<u;k++){let $=l+c*k/u,w=Math.min(d,l+c*(k+1)/u+.4);p.push(v`<path d=${Vs(i,a,$,w)} fill="none"
      stroke=${ku(e.colorHexes,(k+.5)/u)} stroke-width=${uy*n}
      stroke-linecap=${k===0||k===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),f=Bs(i,a,l+c*m),y=1.5,b=(k,$,w,S)=>v`
    <defs><path id=${k} d=${Vs(i,a,$,w)} /></defs>
    <text font-size=${zs*n} font-weight="600" fill="#FFFFFF"
    ...
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):g}`}function Er(e,n){let t=e.family in ze?e.family:"rectangular",i=n.slot??ze[t],a=ze[t],r=Sr(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ye(e.backgroundColorHex),l=Ye(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=_u(c);if(t==="corner"){let b=r.scale,k=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",w=$!=="",S=Tr(b,k),L=js(b,k),_=L/(a.width*b),A=S.tile.cx-L/2,W=S.tile.cy-L/2,E=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,G=g;if(e.bezelGauge)G=py(e.bezelGauge,b,o);else if(e.bezelText){let U=ly(b,`${o}-bezel`),ee=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?mi((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;G=v`<defs><path id=${U.id} d=${U.d} /></defs>
        <text font-size=${fu*b} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${U.id}" startOffset="50%" text-anchor="middle">${yu(ee,U.length,fu*b)}</textPath></text>`}let q=g;if(w){let U=Ye(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ee=Pu(b,`${o}-curved`,dy*b,cy);q=v`<defs><path id=${ee.id} d=${ee.d} /></defs>
        <text font-size=${bu*b} font-weight="600" fill=${U.color} fill-opacity=${U.opacity}
          ...
          <textPath href="#${ee.id}" startOffset="50%" text-anchor="middle">${yu($,ee.length,bu*b*.88)}</textPath></text>`}else{let U=e.borderWidth*r.scale*_,ee=l?v`<circle cx=${L/2} cy=${L/2} r=${L/2-U/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${U} />`:g;q=v`<g transform="translate(${A} ${W})">
        <g clip-path=${`url(#${o})`}>
          ${s?v`<rect width=${L} height=${L} fill=${s.color} fill-opacity=${s.opacity} />`:g}
    ...
    ${p}
    ${c.map(m=>Os(m,a,d,_u(e.elements)))}
    ${u}
  </svg>`}function ne(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var sn=["rectangular","circular","corner","inline"];function xi(e){return oe.includes(e)}function Mr(e){return sn.filter(n=>e.supportedFamilies.includes(n))}function qs(e){return oe.find(n=>e.supportedFamilies.includes(n))}function Rr(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function gy(){return{value:D("")}}function Du(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=sn.filter(t=>t===n||e.supportedFamilies.includes(t))),xi(n)?e.perFamily[n]||(e.perFamily[n]=_t()):e.inline||(e.inline=gy()),e.schemaVersion=En(e)}function Ou(e,n){if(Rr(e,n)){if(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),xi(n)){for(let t of bt(e,n))xe(e,t.payload.id);delete e.perFamily[n],ct(e)}else delete e.inline;e.schemaVersion=En(e)}}function Bu(e,n){let t=[];if(!xi(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=bt(e,n).filter(r=>!ve(e,r)).length;return a>0&&t.push(`${a} layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var Xe={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a",chartTimes:"#5e35b1",chartDots:"#5e35b1",chartGrid:"#5e35b1",imageTime:"#00838f"},ln={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area",chartTimes:"Clock times",chartDots:"Chart dots",chartGrid:"Chart grid",imageTime:"Timestamp"},Ys=["text","icon","gauge","chart","timeline","shape","image","tap"],Q={content:"#4a7fe8",look:"#a15fe0",numbers:"#26a69a",position:"#66bb6a",states:"#f9a825",tap:Xe.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Vu="2.8.0";function ia(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function Gu(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function Uu(e,n=Vu){let t=ia(e),i=ia(n);return!t||!i?!1:Gu(t,i)>=0}function Xs(e,n=null){if(n===null)return;let t=ia(e),i=ia(n);return!t||!i||Gu(t,i)>=0?void 0:`Needs Wrist Assistant ${i[2]===0?`${i[0]}.${i[1]}`:i.join(".")} or later on your watch.`}function Ku(e,n=Vu){return`${ia(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The editor needs ${n}, coming soon to the App Store.`}var Wu="52a9d81d0fd7";var ju="11fa18406cea";var Ke="mdi:";function yy(e){return e.trim().replace(/\./g,"-")}function by(e){return e.trim().replace(/-/g,".")}var Hr=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>by(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=yy(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Ye(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return v`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
    ...
    <path d=${up(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
      ...
      </g>`}}function pp(e){return h`<svg class="shot" viewBox="0 0 120 46" aria-hidden="true">${Ry(e)}</svg>`}var hp={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},mp=e=>(...n)=>({_$litDirective$:e,values:n}),Pr=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,t,i){this._$Ct=n,this._$AM=t,this._$Ci=i}_$AS(n,t){return this.update(n,t)}update(n,t){return this.render(...t)}};var{I:Hy}=md,fp=e=>e;var gp=()=>document.createComment(""),ki=(e,n,t)=>{let i=e._$AA.parentNode,a=n===void 0?e._$AB:n._$AA;if(t===void 0){let r=i.insertBefore(gp(),a),o=i.insertBefore(gp(),a);t=new Hy(r,o,e,e.options)}else{let r=t._$AB.nextSibling,o=t._$AM,s=o!==e;if(s){let l;t._$AQ?.(e),t._$AM=e,t._$AP!==void 0&&(l=e._$AU)!==o._$AU&&t._$AP(l)}if(r!==a||s){let l=t._$AA;for(;l!==r;){let d=fp(l).nextSibling;fp(i).insertBefore(l,a),l=d}}}return t},dn=(e,n,t=e)=>(e._$AI(n,t),e),Fy={},yp=(e,n=Fy)=>e._$AH=n,bp=e=>e._$AH,Nr=e=>{e._$AR(),e._$AA.remove()};var xp=(e,n,t)=>{let i=new Map;for(let a=n;a<=t;a++)i.set(e[a],a);return i},vp=mp(class extends Pr{constructor(e){if(super(e),e.type!==hp.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,n,t){let i;t===void 0?t=n:n!==void 0&&(i=n);let a=[],r=[],o=0;for(let s of e)a[o]=i?i(s,o):o,r[o]=t(s,o),o++;return{values:r,keys:a}}render(e,n,t){return this.dt(e,n,t).values}update(e,[n,t,i]){let a=bp(e),{values:r,keys:o}=this.dt(n,t,i);if(!Array.isArray(a))return this.ut=o,r;let s=this.ut??=[],l=[],d,c,u=0,p=a.length-1,m=0,f=r.length-1;for(;u<=p&&m<=f;)if(a[u]===null)u++;else if(a[p]===null)p--;else if(s[u]===o[m])l[m]=dn(a[u],r[m]),u++,m++;else if(s[p]===o[f])l[f]=dn(a[p],r[f]),p--,f--;else if(s[u]===o[f])l[f]=dn(a[u],r[f]),ki(e,l[f+1],a[u]),u++,f--;else if(s[p]===o[m])l[m]=dn(a[p],r[m]),ki(e,a[u],a[p]),p--,m++;else if(d===void 0&&(d=xp(o,m,f),c=xp(s,u,p)),d.has(s[u]))if(d.has(s[p])){let y=c.get(o[m]),b=y!==void 0?a[y]:null;if(b===null){let k=ki(e,a[u]);dn(k,r[m]),l[m]=k}else l[m]=dn(b,r[m]),ki(e,a[u],b),a[y]=null;m++}else Nr(a[p]),p--;else Nr(a[u]),u++;for(;m<=f;){let y=ki(e,l[f+1]);dn(y,r[m]),l[m++]=y}for(;u<=p;){let y=a[u++];y!==null&&Nr(y)}return this.ut=o,yp(e,l),Tt}});var wp="sun.sun";function kp(e){let n=e?.[wp],t=typeof n?.attributes?.friendly_name=="string"?n.attributes.friendly_name.trim():"";return{entityId:wp,displayName:t||"Sun",domain:"sun"}}var $p=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Ay=[0,1,2,3,4];function Cp(e){let n=[];for(let t of e??[]){let i=t.trim();if(i==="")continue;let a=Number(i);Number.isInteger(a)&&a>=0&&a<=6&&!n.includes(a)&&n.push(a)}return n.sort((t,i)=>t-i)}function rl(e){return[...new Set(e)].filter(n=>n>=0&&n<=6).sort((n,t)=>n-t).map(String)}var Sp=[{kind:"afterSunset",label:"After sunset",hint:"True from sunset to sunrise, from the sun entity's own state."},{kind:"daytime",label:"Daytime",hint:"True while the sun is up."},{kind:"sunElevation",label:"Sun below an angle",hint:"The sun's elevation in degrees, below a number you set. 0 is the horizon."},{kind:"weekday",label:"Weekday is one of",hint:"A row of days, starting on Monday to Friday."},{kind:"timeBetween",label:"Time between",hint:"A clock window that may wrap midnight, starting at 22:00 to 06:00."}];function Iy(e){return[Tp(e,"below_horizon")]}function Ly(e){return[Tp(e,"above_horizon")]}function Tp(e,n){return{id:Z(),value:{kind:{kind:"entityState",...e}},comparison:{kind:"equals",value:D(n)}}}function _y(e,n=0){return[{id:Z(),value:{kind:{kind:"entityAttribute",...e,attribute:"elevation"}},comparison:{kind:"lessThan",value:D(String(n))}}]}function zy(e=Ay){return[{id:Z(),value:{kind:{kind:"time",timeField:"weekday"}},comparison:{kind:"isOneOf",options:rl(e)}}]}function Py(e="22:00",n="06:00"){return[{id:Z(),value:{kind:{kind:"time",timeField:"now"}},comparison:{kind:"timeBetween",value:D(e),upper:D(n)}}]}function Ep(e,n){switch(e){case"afterSunset":return Iy(n);case"daytime":return Ly(n);case"sunElevation":return _y(n);case"weekday":return zy();case"timeBetween":return Py()}}function ol(e){delete e.coloring,delete e.bands,delete e.bandAboveColorHex,delete e.highlight,delete e.highColorHex,delete e.lowColorHex}function sa(e){for(let n of e)delete n.partId}function Mp(e,n=Z()){if(e.parts!==void 0&&e.parts.length>0)return e.parts[0].id;let t={id:n,value:structuredClone(e.value)};return e.coloring==="bands"&&(e.bands?.length??0)>0&&(t.coloring="bands",t.bands=e.bands,e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==ue&&(t.bandAboveColorHex=e.bandAboveColorHex)),ol(e),e.parts=[t],e.value=Oi(e.parts),n}function Dr(e,n=[]){let t=e.parts??[];if(e.countdown===!0||t.length===0)return delete e.parts,sa(e.rules),{ok:!0,joined:!1,moved:[]};if(t.length===1){let a=t[0],r=[];return e.value=a.value,a.fontSize!==void 0&&(e.fontSize=a.fontSize,r.push("fontSize")),a.fontWeight!==void 0&&(e.fontWeight=a.fontWeight,r.push("fontWeight")),a.colorHex!==void 0&&(e.colorSlot.baseColorHex=a.colorHex,r.push("color")),ol(e),a.coloring!==void 0&&a.coloring!=="uniform"&&(e.coloring=a.coloring),a.bands!==void 0&&a.bands.length>0&&(e.bands=a.bands),a.bandAboveColorHex!==void 0&&(e.bandAboveColorHex=a.bandAboveColorHex),a.coloring==="bands"&&(a.bands?.length??0)>0&&r.push("bands"),delete e.parts,sa(e.rules),{ok:!0,joined:!1,moved:r}}let i=sl(t,n);return i.ok?(e.value=i.value,ol(e),delete e.parts,sa(e.rules),{ok:!0,joined:!0}):i}function ra(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function oa(e){return e.includes("{")?`{% raw %}${e}{% endraw %}`:e}function Ny(e,n){let t=e,i=e.format;for(let r=0;t.kind.kind==="named";r++){if(r>8)return;let o=t.kind.id.toUpperCase(),s=n.find(l=>l.id.toUpperCase()===o)?.value;if(!s)return;i=_e(i)?s.format:i,t=s}let a={kind:t.kind};return _e(i)||(a.format=i),a}function Dy(e,n){let t=Ny(e,n);if(!t)return{blocked:"kind"};let i=Hn(t);if(i!==void 0)return oa(i);let a=t.kind,r=t.format??{};if(r.relativeTime||r.duration)return{blocked:"format"};let o="",s;switch(a.kind){case"entityState":s=`states(${ra(a.entityId)})`;break;case"jinja":{if(a.value.trim()==="")return"";let c=a.value.includes("{{")||a.value.includes("{%"),u=r.decimals===void 0&&r.multiply===void 0&&r.offset===void 0&&!r.textCase;if(c&&u)return oa(r.prefix??"")+a.value+oa(r.suffix??"");c?(o=`{% set wa_text %}${a.value}{% endset %}`,s="wa_text"):s=`(${a.value})`;break}case"entityAttribute":case"entityAge":case"aggregate":case"time":{let c=Xi(a);if(c===void 0)return{blocked:"kind"};s=c;break}default:return{blocked:"kind"}}if(r.decimals!==void 0||r.multiply!==void 0||r.offset!==void 0){let c=`(${s} | float(0))`;r.multiply!==void 0&&(c=`(${c} * ${r.multiply})`),r.offset!==void 0&&(c=`(${c} + ${r.offset})`),s=r.decimals!==void 0?`${ra(`%.${Math.max(0,Math.trunc(r.decimals))}f`)} | format(${c})`:c}let l=r.useEntityUnit&&"entityId"in a?a.entityId:void 0;l!==void 0&&(o+=`{% set wa_unit = state_attr(${ra(l)}, 'unit_of_measurement') %}`);let d="('' if not wa_unit else (wa_unit if wa_unit[:1] in ['\xB0', '%'] else ' ' ~ wa_unit))";if(r.textCase){let c=r.textCase==="upper"?"upper":r.textCase==="lower"?"lower":"title",u=[...r.prefix?[ra(r.prefix)]:[],`(${s})`,...l!==void 0?[d]:[],...r.suffix?[ra(r.suffix)]:[]].join(" ~ ");return`${o}{{ (${u}) | ${c} }}`}return o+oa(r.prefix??"")+`{{ ${s} }}`+(l!==void 0?`{{ ${d} }}`:"")+oa(r.suffix??"")}function sl(e,n=[]){if(e.every(a=>a.value.kind.kind==="literal"))return{ok:!0,value:Oi(e)};let t=[],i=[];return e.forEach((a,r)=>{let o=Dy(a.value,n);typeof o=="string"?t.push(o):i.push({index:r,partId:a.id,reason:o.blocked})}),i.length>0?{ok:!1,blocked:i}:{ok:!0,value:{kind:{kind:"jinja",value:t.join("")}}}}var jn="color-mix(in srgb, var(--k) 30%, #6b7280)",da='system-ui, -apple-system, "Segoe UI", sans-serif',Ae=[24,29,35,30,19,23,11,15],at=Ae.map((e,n)=>10+n*100/(Ae.length-1)),Rp=32,Oy=20,By=Ae.reduce((e,n)=>e+n,0)/Ae.length,ca=40,Vy=6,Or={highest:Ae.indexOf(Math.min(...Ae)),lowest:Ae.indexOf(Math.max(...Ae)),first:0,latest:Ae.length-1,now:5},Hp=at.map((e,n)=>`${n===0?"M":"L"}${e.toFixed(1)} ${Ae[n]}`).join("");function Gy(){return v`
    <path d=${`${Hp}L${at[at.length-1]} ${ca}L${at[0]} ${ca}Z`} fill=${jn} opacity=".18" />
    <path d=${Hp} fill="none" stroke=${jn} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />`}function Uy(){return v`${at.map((e,n)=>v`<rect x=${e-5} y=${Ae[n]} width="10" height=${ca-Ae[n]} rx="2" fill=${jn} opacity=".45" />`)}`}function Ky(){return v`${[[4,30,.35],[35,18,.7],[54,10,.35],[65,26,.7],[92,24,.35]].map(([n,t,i])=>v`<rect x=${n} y="10" width=${t} height="16" rx="3" fill=${jn} opacity=${i} />`)}`}function Wy(){return v`
    <rect x="3" y="3" width="114" height="40" rx="5" fill=${jn} opacity=".22" />
    <circle cx="30" cy="16" r="6" fill=${jn} opacity=".6" />
    <path d="M3 43L3 36L34 20L56 32L80 16L117 38L117 43Z" fill=${jn} opacity=".5" />`}function cn(e,n=2.6){return v`<circle cx=${at[e]} cy=${Ae[e]} r=${n} fill="var(--k)" />`}function Pt(e){return v`<text x="5" y="13" font-family=${da} font-size="10" font-weight="700" fill="var(--k)">${e}</text>`}function la(e,n=!1){return v`<path d=${`M4 ${e}H116`} stroke="var(--k)" stroke-width="1.4" stroke-dasharray=${n?"4 3":"none"} />`}function Fp(e){return v`<g font-family=${da} font-size="6.5" fill="var(--k)">
    <text x="4" y=${e}>9 AM</text><text x="60" y=${e} text-anchor="middle">1 PM</text><text x="116" y=${e} text-anchor="end">5 PM</text>
  </g>`}function jy(e){if(e==="timeline:times")return Fp(38);if(e==="image:time")return v`<rect x="70" y="30" width="42" height="10" rx="5" fill="#000" fill-opacity=".55" stroke="var(--k)" stroke-width=".8" />
      <text x="91" y="37.5" text-anchor="middle" font-family=${da} font-size="7" fill="var(--k)">3:41:07</text>`;let[n,t]=e.split(":");if(n==="draw")switch(t){case"threshold":return la(Oy,!0);case"now":return v`<path d=${`M${at[Or.now]} 4V${ca+2}`} stroke="var(--k)" stroke-width="1.4" />`;case"zero":return v`${la(Rp)}<text x="115" y=${Rp-3} text-anchor="end" font-family=${da} font-size="6.5" fill="var(--k)">0</text>`;case"times":return Fp(45);case"dots":return v`${at.map((o,s)=>cn(s,2.2))}`;case"grid":return v`<path d="M4 10H116M4 20H116M4 30H116M4 40H116" stroke="var(--k)" stroke-width=".8" opacity=".7" />`}if(n==="number"){let o=Ae.length-1;switch(t){case"latest":return v`${Pt("24.6")}${cn(o)}`;case"first":return v`${Pt("18.2")}${cn(0)}`;case"highest":return v`${Pt("28.9")}${cn(Or.highest)}`;case"lowest":return v`${Pt("9.8")}${cn(Or.lowest)}`;case"average":return v`${Pt("19.4")}${la(By,!0)}`;case"delta":return v`${Pt("+6.4")}${cn(0)}${cn(o)}
        <path d=${`M${at[0]} ${Ae[0]}L${at[o]} ${Ae[o]}`} stroke="var(--k)" stroke-width="1" stroke-dasharray="2 2" />`;case"sum":return v`${Pt("155")}${at.map((s,l)=>cn(l,1.6))}`;case"trend":return Pt("\u2191");case"top":return v`${Pt("30")}${la(Vy)}`;case"bottom":return v`<text x="5" y="37" font-family=${da} font-size="10" font-weight="700" fill="var(--k)">0</text>${la(ca)}`}}let i=Or[t]??0,a=at[i],r=Ae[i]-7;return t==="highest"?v`<path d=${`M${a} ${r-4}L${a+4} ${r+3}L${a-4} ${r+3}Z`} fill="var(--k)" />`:v`<circle cx=${a} cy=${r} r="3" fill="var(--k)" />`}function ll(e){return e==="timeline:times"?"timeline":e==="image:time"?"image":"chart"}function Ap(e,n,t=!1){let i=e==="timeline"?Ky():e==="image"?Wy():t?Uy():Gy(),a=n!==void 0&&ll(n)===e?jy(n):"";return h`<svg class="shot" viewBox="0 0 120 46" aria-hidden="true">${i}${a}</svg>`}var qy={threshold:"Threshold line",now:"Now line",zero:"Zero line",times:"Clock times",dots:"Dots",grid:"Grid lines"};function Ip(e){if(e==="timeline:times")return"Clock times";if(e==="image:time")return"Timestamp";let[n,t]=e.split(":");return n==="draw"?qy[t]:n==="number"?Ht.find(([i])=>i===t)?.[1]??t:`${ft.find(([i])=>i===t)?.[1]??"Reading"} marker`}var Yy={"draw:threshold":"A flat line at a value you pick, so a reading over it stands out.","draw:now":"An upright line through the reading that counts as now.","draw:zero":"A flat line where zero falls. It is drawn only when the readings cross zero.","draw:times":"The clock times of the chart's span, spread under the plot.","draw:dots":"A dot on every reading. Line and area charts only.","draw:grid":"Faint rules across the plot, to read heights against.","number:latest":"The newest reading, with the entity's unit after it.","number:first":"The oldest reading in the span.","number:highest":"The highest reading in the span.","number:lowest":"The lowest reading in the span.","number:average":"The average of every reading in the span.","number:delta":"The newest reading minus the first, with the unit after it.","number:sum":"Every reading in the span added up, with the unit after it.","number:trend":"The change as an arrow: up, down, or flat when it is too small to print.","number:top":"The value at the top of the plot. On a Fixed scale, this is Max.","number:bottom":"The value at the bottom of the plot. On a Fixed scale, this is Min.","marker:highest":"An icon over the highest reading. It starts as a triangle.","marker:lowest":"An icon over the lowest reading. It starts as a dot.","marker:now":"An icon over the reading that counts as now.","marker:first":"An icon over the oldest reading.","marker:latest":"An icon over the newest reading.","marker:threshold":"An icon at the threshold's height.","marker:zero":"An icon at zero's height.","timeline:times":"The clock times of the timeline's span, spread under the strip.","image:time":"The time the picture was fetched, so a picture that stops updating reads as stale."};function dl(e){return Yy[e]}function Xy(e){switch(e){case"light":return v`<path d="M9.2 15.5A5.5 5.5 0 1 1 14.8 15.5C13.8 16.6 13.6 17.4 13.5 19H10.5C10.4 17.4 10.2 16.6 9.2 15.5Z" /><path d="M10.5 21.5H13.5" />`;case"switch":case"input_boolean":return v`<rect x="3" y="7.5" width="18" height="9" rx="4.5" /><circle cx="16.5" cy="12" r="2.6" />`;case"sensor":return v`<path d="M12 14.5V4.5" /><circle cx="12" cy="17.5" r="3.2" /><path d="M14.5 6.5H12M14.5 9.5H12" />`;case"binary_sensor":return v`<circle cx="12" cy="12" r="8.5" /><circle cx="12" cy="12" r="3.2" />`;case"climate":case"water_heater":return v`<path d="M10 13.8V5.5a2 2 0 0 1 4 0V13.8" /><circle cx="12" cy="17" r="3.6" /><path d="M16.5 7H19M16.5 10.5H19" />`;case"humidifier":return v`<path d="M12 3.5S6.5 10.5 6.5 14.5A5.5 5.5 0 0 0 17.5 14.5C17.5 10.5 12 3.5 12 3.5Z" />`;case"media_player":return v`<rect x="2.8" y="4.5" width="18.4" height="12" rx="2.5" /><path d="M8 20H16" /><path d="M10.6 9.2L14.4 10.6L10.6 12Z" />`;case"camera":return v`<path d="M3.5 8.5A2 2 0 0 1 5.5 6.5H9L10.5 4.5H13.5L15 6.5H18.5A2 2 0 0 1 20.5 8.5V17A2 2 0 0 1 18.5 19H5.5A2 2 0 0 1 3.5 17Z" /><circle cx="12" cy="12.5" r="3.5" />`;case"cover":return v`<rect x="3.5" y="3.5" width="17" height="17" rx="2" /><path d="M3.5 8.5H20.5M3.5 13H20.5M3.5 17.5H20.5" />`;case"lock":return v`<rect x="5" y="10.5" width="14" height="10" rx="2.5" /><path d="M8.2 10.5V7.8a3.8 3.8 0 0 1 7.6 0V10.5" />`;case"fan":return v`<circle cx="12" cy="12" r="2" /><path d="M12 10C12 6 9 3.5 7 5.5S8.5 10 12 10Z" /><path d="M14 12C18 12 20.5 9 18.5 7S14 8.5 14 12Z" /><path d="M12 14C12 18 15 20.5 17 18.5S15.5 14 12 14Z" /><path d="M10 12C6 12 3.5 15 5.5 17S10 15.5 10 12Z" />`;case"script":case"automation":return v`<path d="M5 5.5H19M5 10H19M5 14.5H14M5 19H11" />`;case"scene":return v`<path d="M12 3.5L14.2 8.6L19.7 9.2L15.6 12.9L16.8 18.3L12 15.5L7.2 18.3L8.4 12.9L4.3 9.2L9.8 8.6Z" />`;case"person":case"device_tracker":return v`<circle cx="12" cy="8" r="3.6" /><path d="M5 20.5a7 7 0 0 1 14 0" />`;case"vacuum":case"lawn_mower":return v`<circle cx="12" cy="12" r="8.5" /><circle cx="12" cy="12" r="3" /><path d="M12 3.5V8.5" />`;case"weather":return v`<circle cx="9" cy="9" r="3.2" /><path d="M8.5 19.5a4 4 0 0 1 .4-8 5.2 5.2 0 0 1 10 1.2 3.4 3.4 0 0 1-.4 6.8Z" />`;case"sun":return v`<circle cx="12" cy="12" r="4.2" /><path d="M12 3V5.5M12 18.5V21M3 12H5.5M18.5 12H21M5.6 5.6L7.4 7.4M16.6 16.6L18.4 18.4M18.4 5.6L16.6 7.4M7.4 16.6L5.6 18.4" />`;case"input_number":case"number":return v`<path d="M8 4.5L6 19.5M18 4.5L16 19.5M4.5 9H19.5M4 15H19" />`;case"input_select":case"select":return v`<rect x="3.5" y="6" width="17" height="12" rx="2.5" /><path d="M14 10.5L16.2 13L18.4 10.5" />`;case"input_text":case"text":return v`<path d="M5 6H19M12 6V19M9 19H15" />`;case"button":case"input_button":return v`<circle cx="12" cy="12" r="8.5" /><path d="M12 8.5V15.5M8.5 12H15.5" />`;case"alarm_control_panel":return v`<path d="M12 3.5L19.5 6.5V12C19.5 16.5 16.3 19.6 12 20.8C7.7 19.6 4.5 16.5 4.5 12V6.5Z" /><path d="M9.5 12L11.3 14L14.8 10.2" />`;case"update":return v`<path d="M12 4.5V14.5" /><path d="M8.2 10.8L12 14.6L15.8 10.8" /><path d="M5 18.5H19" />`;case"todo":return v`<rect x="4" y="4" width="16" height="16" rx="2.5" /><path d="M8 12L10.6 14.5L16 9" />`;case"calendar":return v`<rect x="3.5" y="5.5" width="17" height="15" rx="2.5" /><path d="M3.5 10H20.5M8 3.5V7.5M16 3.5V7.5" />`;case"timer":case"counter":return v`<circle cx="12" cy="13.5" r="7.5" /><path d="M12 9.5V13.5L14.6 15.4" /><path d="M9.5 2.8H14.5" />`;case"zone":return v`<path d="M12 21S5 15.4 5 10.2A7 7 0 0 1 19 10.2C19 15.4 12 21 12 21Z" /><circle cx="12" cy="10" r="2.6" />`;case"remote":return v`<rect x="7" y="2.8" width="10" height="18.4" rx="3" /><circle cx="12" cy="8" r="1.5" /><path d="M9.6 12.5H14.4M9.6 16H14.4" />`;case"siren":return v`<path d="M5 18.5a7 7 0 0 1 14 0Z" /><path d="M3.5 18.5H20.5M12 4V7M5.5 6.5L7.4 8.4M18.5 6.5L16.6 8.4" />`;case"valve":return v`<path d="M4 8L12 12L4 16Z" /><path d="M20 8L12 12L20 16Z" /><path d="M12 12V4M9 4H15" />`;case"image":case"image_processing":return v`<rect x="3.5" y="5" width="17" height="14" rx="2.5" /><circle cx="9" cy="10" r="1.6" /><path d="M20.5 15.5L15.5 11L7 19" />`;case"event":return v`<circle cx="12" cy="12" r="2.4" /><path d="M8.2 8.2a5.4 5.4 0 0 0 0 7.6M15.8 8.2a5.4 5.4 0 0 1 0 7.6" /><path d="M5.5 5.5a9.2 9.2 0 0 0 0 13M18.5 5.5a9.2 9.2 0 0 1 0 13" />`;case"group":return v`<rect x="3.5" y="3.5" width="7.5" height="7.5" rx="2" /><rect x="13" y="3.5" width="7.5" height="7.5" rx="2" /><rect x="3.5" y="13" width="7.5" height="7.5" rx="2" /><rect x="13" y="13" width="7.5" height="7.5" rx="2" />`;default:return v`<circle cx="12" cy="12" r="7.5" /><circle cx="12" cy="12" r="2.2" />`}}function cl(e){return h`<svg class="dom-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Xy(e)}</svg>`}var Jy={binary_sensor:"Binary sensor",input_boolean:"Toggle helper",input_number:"Number helper",input_select:"Dropdown helper",input_text:"Text helper",input_button:"Button helper",input_datetime:"Date helper",alarm_control_panel:"Alarm panel",device_tracker:"Device tracker",media_player:"Media player",water_heater:"Water heater",lawn_mower:"Lawn mower",image_processing:"Image processing",persistent_notification:"Notification",remote:"Remote",sun:"Sun",todo:"To-do list"};function Lp(e){let n=Jy[e];if(n!==void 0)return n;if(e==="")return"";let t=e.replace(/_/g," ");return t.charAt(0).toUpperCase()+t.slice(1)}var Zy=new Set(["on","open","opening","closing","home","playing","heat","cool","heat_cool","auto","dry","fan_only","cleaning","returning","active","running","recording","streaming","triggered","armed_home","armed_away","armed_night","armed_vacation","unlocked"]);function ul(e){return Zy.has(e.trim().toLowerCase())}function Qy(e,n,t){let i=lr({frame:{...e.frame},isHidden:!1},e.family,n,t).frame;return vr(i,{})}var $l=["content","look","numbers","timestamp","tappable","states","placement","corner","placements","shape","symbol"];function we(e){return n=>e(n.target.value)}function Nt(e,n){let t=n===void 0?Xs(e.watchAppVersion):Xs(e.watchAppVersion,n);return t===void 0?g:h`<div class="hint keep">${t}</div>`}function va(e){if(e===void 0||e.atDefault)return g;let n=`Changed. Click to reset. ${e.title.replace(/\.$/,"")}.`;return h`<button type="button" class="reset-dot" title=${n} aria-label=${n}
    @pointerdown=${t=>t.stopPropagation()}
    @click=${t=>{t.preventDefault(),t.stopPropagation(),e.reset()}}></button>`}function Be(e,n,t){let i=va(n),a=[i===g?"":"changed",t?"scrub":""].filter(r=>r!=="").join(" ");return h`<span class=${a===""?g:a} title=${t?"Drag left or right to change":g}
    @pointerdown=${t??g}>${e}${i}</span>`}var no="wa-scrub-start",io="wa-scrub-end",eb=3,tb=3;function nb(e,n){return e!==void 0&&Number.isFinite(e)?e:Math.max(0,n.min??0)}function ib(e,n,t={}){let i=n!==void 0&&n>0?n:10**-Math.min(2,bl(e));return t.coarse?i*10:t.fine?i/10:i}function ab(e,n,t,i){let a=e+Math.round((n-e)/t)*t;return i.min!==void 0&&(a=Math.max(i.min,a)),i.max!==void 0&&(a=Math.min(i.max,a)),Number(a.toFixed(Math.min(10,Math.max(bl(t),bl(e)))))}function bl(e){if(!Number.isFinite(e)||Number.isInteger(e))return 0;let n=String(e),t=/e-(\d+)$/.exec(n);return t?Number(t[1])+(n.split("e")[0].split(".")[1]??"").length:(n.split(".")[1]??"").length}function rh(e,n,t,i,a,r){let o=nb(t,a),s=n.clientX,l=s,d=o,c=o,u=!1,p=f=>{if(!u){if(Math.abs(f.clientX-s)<eb)return;u=!0,l=f.clientX,e.classList.add("scrubbing"),e.dispatchEvent(new CustomEvent(no,{bubbles:!0,composed:!0}))}let y=ib(o,a.step,{coarse:f.shiftKey,fine:f.altKey});d+=(f.clientX-l)/tb*y,l=f.clientX,a.min!==void 0&&(d=Math.max(a.min,d)),a.max!==void 0&&(d=Math.min(a.max,d));let b=ab(o,d,y,a);b!==c&&(c=b,i(b))},m=f=>{if(e.removeEventListener("pointermove",p),e.removeEventListener("pointerup",m),e.removeEventListener("pointercancel",m),u){e.classList.remove("scrubbing"),e.dispatchEvent(new CustomEvent(io,{bubbles:!0,composed:!0}));let y=b=>{b.preventDefault(),b.stopPropagation()};e.addEventListener("click",y,{capture:!0,once:!0}),setTimeout(()=>e.removeEventListener("click",y,{capture:!0}),0)}r(u,f)};e.setPointerCapture(n.pointerId),e.addEventListener("pointermove",p),e.addEventListener("pointerup",m),e.addEventListener("pointercancel",m)}function ao(e,n,t){return i=>{if(i.button!==0||!i.isPrimary)return;let a=i.currentTarget;a.closest(".field")?.querySelector("input[type=number]")?.disabled||(i.preventDefault(),rh(a,i,e,n,t,()=>{}))}}function wa(e,n,t){return i=>{let a=i.currentTarget;i.button!==0||!i.isPrimary||a.disabled||a.matches(":focus")||(i.preventDefault(),rh(a,i,e,n,t,(r,o)=>{r||o.type!=="pointerup"||(a.focus(),a.select())}))}}function hn(e,n,t,i=a=>String(a)){if(n===void 0)return;let a=n;return{atDefault:e===a,title:`Back to ${i(a)}`,reset:()=>t(a)}}function Re(e,n,t,i={}){return h`<label class="field">${Be(e,hn(n,i.def,t,a=>a===""?"empty":a))}
    ...
    </div>`}function rb(e,n){let t=i=>hn(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${Be(e.label,t(e))}
    <div class="pair-row">
      ${Xr(e.label,e.value,e.options,e.set,e)}
      ${Be(n.label,t(n))}
      ${Xr(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function Jn(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Be(e,hn(n,i.def,t,a),ao(n,t,i))}
    <div class="slider-row">
      ...
      ${ro(n,r,{step:i.step,min:i.min,max:i.max,ariaLabel:e,...i.unit===void 0?{}:{unit:i.unit}})}
    </div></div>`}function Oe(e,n,t,i,a={}){return h`<label class="field check">${Be(e,hn(n,i,t,r=>r?"on":"off"))}<input type="checkbox" .checked=${n} ?disabled=${a.disabled===!0} @change=${r=>t(r.target.checked)} /></label>`}function fe(e,n,t,i=!1,a){let{rgb:r,alpha:o}=sh(n),s=a===void 0?void 0:{atDefault:Cl(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)},l=i&&n===void 0;return h`<div class="field color">${Be(e,s)}
    <div class="color-row">
      ${i?h`<input type="checkbox" title="Enabled" aria-label=${`${e} on`} .checked=${n!==void 0} @change=${d=>t(d.target.checked?qr(r,o):void 0)} />`:g}
      ${oo(e,n,t,l)}
    </div></div>`}function sh(e){let n=(e??"").replace(/^#/,""),t=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n);return{valid:t,swatch:t?`#${n}`:"transparent",rgb:t?`#${n.slice(0,6)}`:"#ffffff",alpha:t&&n.length===8?Math.round(parseInt(n.slice(6,8),16)/255*100):100}}function qr(e,n){let t=e.replace(/^#/,"").toUpperCase();return n>=100?`#${t}`:`#${t}${Math.round(n/100*255).toString(16).padStart(2,"0").toUpperCase()}`}function oo(e,n,t,i=!1,a="#RRGGBB"){let{valid:r,swatch:o,rgb:s,alpha:l}=sh(n);return h`<span class="color-box">
      <span class="color-swatch" style=${`--sw:${i||!r?"transparent":o}`} title="Pick a colour">
        <input type="color" .value=${s} ?disabled=${i} aria-label=${`${e}: pick a colour`} @input=${we(d=>t(qr(d,l)))} />
      </span>
      ...
      <span class="num-box alpha" style="--wa-unit:1">
        <input type="number" min="0" max="100" step="1" .value=${String(l)} title="Opacity" aria-label=${`${e}: opacity`} ?disabled=${i}
          data-scrub @pointerdown=${wa(l,d=>t(qr(s,d)),{step:1,min:0,max:100})}
          @input=${we(d=>{let c=Number(d);d.trim()!==""&&c>=0&&c<=100&&t(qr(s,Math.round(c)))})} />
        <span class="unit" aria-hidden="true">%</span>
      </span>
    </span>`}function ma(e,n,t,i){let a={atDefault:n===void 0,title:`Back to ${t.toLowerCase()}`,reset:()=>i(void 0)};return h`<div class="field color">${Be(e,a)}
    <div class="color-row">${oo(e,n,i,!1,t)}</div></div>`}function Cl(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function so(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function ob(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function _p(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var lh=50;function sb(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function lb(e,n,t=lh,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var db=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function dh(e){return db.test(e.trim())}function cb(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return so(t,i);if(dh(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Yn=new Map;function He(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Sl(e){return Yn.has(e)}function kt(e,n,t,i,a,r={}){let o=e.hass.states,s=Yn.get(a),l=s?lb(ob(o,r.domain,_p(e.hass)),s.query,lh,r.preferNumeric?sb:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(w,S,L=0)=>{Yn.set(a,{query:S,index:L}),He(w)},p=w=>{Yn.delete(a),He(w)},m=w=>{let S=cb(w,t,o);S&&i(S)},f=(w,S)=>{i(so(o,w.entityId)),p(S)},y=()=>Math.max(0,Math.min(Yn.get(a)?.index??0,l.length-1)),b=w=>{let S=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let L=Yn.get(a);if(!L){u(S,S.value);return}let _=w.key==="ArrowDown"?y()+1:y()-1;u(S,L.query,Math.max(0,Math.min(l.length-1,_))),ub(S);return}if(w.key==="Enter"){w.preventDefault();let L=l[y()];s&&L?f(L,S):(m(S.value),p(S));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),p(S)}},k=t.entityId?_p(e.hass)?.(t.entityId):void 0,$=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
          <span class="ent-ico ${ul(c.state)?"on":""}">${cl(t.domain||t.entityId.split(".")[0]||"")}</span>
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?g:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let S=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Yn.set(a,{query:"",index:0}),He(S),S?.focus()}}>${V("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${dh(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${L=>L.preventDefault()} @click=${L=>f(w,L.target)}>
                <span class="ent-ico ${ul(w.state)?"on":""}">${cl(w.domain)}</span>
                <span class="ent-main">
  ...
  </div>`}function ub(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var zp=120;function pb(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Ir.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Lr),fromPack:!1}}function Pp(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function hb(e){return[{value:"",label:`Starter set (${Pp(Lr,e)})`},...Ir.map(n=>({value:n.name,label:`${n.name} (${Pp(n.symbols,e)})`}))]}function mb(e){return e.length>0?e.length:Lr.length}function Np(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Br(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function ch(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Ke),m=a!==void 0,f=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=fb(u,c),b=w=>{t(w),a?.(w.startsWith(Ke)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},k=w=>{if(t(w),!m)return;let S=w.trim();a?.(S.startsWith(Ke)?e.icons.mdiPath?.(S):void 0)},$=g;if(o&&f==="mdi"){let w=e.icons.mdiNames?.(),S=gb(w??[],s),L=S.slice(0,zp),_=r.recent.filter(A=>A.startsWith(Ke));$=h`<div class="sym-browse">
      ${Dp(r,i,f)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${we(A=>r.setQuery(i,A))} />
      </div>
      ${_.length===0?g:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${_.map(A=>Br(e,A,A===u,b))}</div>`}
      <div class="sym-grid">${L.map(A=>Br(e,A,A===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Np(L.length,S.length,!0,w.length)}</div>`}
    ...
    </div>`}else if(o){let w=r.category(i),S=pb(w,s,d,c),L=Zs(S.names,s),_=S.fromPack?L.slice(0,zp):L,A=r.recent.filter(E=>!E.startsWith(Ke)),W=c.size===0?A:A.filter(E=>c.has(E));$=h`<div class="sym-browse">
      ${m?Dp(r,i,f):g}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${we(E=>r.setQuery(i,E))} />
        <select @change=${we(E=>r.setCategory(i,E))}>
          ${hb(c).map(E=>h`<option value=${E.value} ?selected=${E.value===w}>${E.label}</option>`)}
        </select>
      </div>
      ${W.length===0?g:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${W.map(E=>Br(e,E,E===u,b))}</div>`}
      <div class="sym-grid">${_.map(E=>Br(e,E,E===u,b))}</div>
      ${L.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${Np(_.length,L.length,s.trim()!=="",mb(d))}
          </div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${we(k)} @change=${we(w=>{let S=w.trim();S.startsWith(Ke)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed(w):(c.size===0||c.has(S))&&r.noteUsed(w)})} /></label>
    ...
    ${$}`}function fb(e,n){let t=e.trim();return t!==""&&!t.startsWith(Ke)&&n.size>0&&!n.has(t)}function gb(e,n){let t=n.trim(),i=t.startsWith(Ke)?t.slice(Ke.length):t,a=e.map(r=>r.startsWith(Ke)?r.slice(Ke.length):r);return Zs(a,i).map(r=>Ke+r)}function Dp(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var yb=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],bb={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},xb=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],vb=[["flat","Flat"],["fade","Fade"]],uh=[["auto","Auto"],["all","All"]],wb=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],ph=[["bars","Bars"],["line","Line"],["area","Area"]],kb=[["auto","Auto"],["fixed","Fixed range"]],$b=[["lowest","Lowest value"],["zero","Zero"]],Cb=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],xl=[["uniform","One colour"],["bands","By value"]];function Jr(e){let n=[No,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Z(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Z(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function Tl(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Sb(e,n){let t=Qt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Z(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Op(e,n,t,i){return h`<span class="band-cell">${oo(e,n,t)}${va(i)}</span>`}function Tb(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function Eb(e,n,t){let{lo:i,hi:a}=Tb(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
  ...
  </div>`}function Zr(e,n,t,i,a){let r=Qt({bands:e.bands}),o=i!==void 0&&Number.isFinite(i)?i:void 0,s=o===void 0?void 0:r.find(f=>o<=f.upTo)?.id??"above",l=(f,y)=>b=>{let k=b.bands.find($=>$.id===f);k&&y(k)},d=e.bandAboveColorHex,c={atDefault:Cl(d,ue),title:`Back to ${ue}`,reset:()=>t(f=>{f.bandAboveColorHex=ue})},u=a?.border===!0,p=(f,y,b,k,$)=>{if(!u)return oo(f,y.colorHex,A=>b(A??"#FFFFFF"));let w=a?.fillHex,S=a?.borderHex,L=y.fillColorHex===void 0?void 0:{atDefault:!1,title:"Back to the chart fill colour",reset:()=>k(void 0)},_=y.borderColorHex===void 0?void 0:{atDefault:!1,title:`Back to ${S===void 0?"white":"the chart border colour"}`,reset:()=>$(void 0)};return h`
      ${Op(`${f} fill`,y.fillColorHex??w??y.colorHex,A=>{A!==void 0&&(b(A),k(w===void 0?void 0:A))},L)}
      ${Op(`${f} border`,y.borderColorHex??S??Oa,A=>$(A),_)}`},m=(f,y)=>{let b=r[f];return h`<input type="number" class="band-up" step="any" .value=${String(b.upTo)} aria-label=${y}
    ...
    <button class="small" @click=${()=>n(o=>{o.bands=[...o.bands,{id:Z(),match:r,colorHex:Ba(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${fe("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??en},"tother"),!1,en)}`}var Hb=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],Fb={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Bp(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return D(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Ab=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function Ib(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function se(e,n,t,i){if(i.inline||!Lb())return h`<div class="value-editor">${gh(e,n,t,i)}</div>`;let a=lo(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=Me(n,de(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${ga.has(n)?gh(e,i,a,r):g}
  </div>`}function de(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function lo(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function Lb(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var ga=new Set,ua=new WeakMap;function _b(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function mh(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function fh(e){let n=e.currentTarget,t=e.newState==="open",i=ua.get(n);if(i&&(i(),ua.delete(n)),!t){ga.delete(n.id)&&He(n);return}let a=_b(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ua.get(n)?.(),ua.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}pl(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ua.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),pl(n,a.getBoundingClientRect()),ga.has(n.id)||(ga.add(n.id),He(n),requestAnimationFrame(()=>{n.isConnected&&pl(n,a.getBoundingClientRect())}))}function pl(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=zb({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var qn=8,Vr=6,Vp=140;function zb(e,n,t){let i=t.height-e.bottom-Vr-qn,a=e.top-Vr-qn,r=n.height>i&&a>i&&i<Vp,o=Math.max(Vp,r?a:i),s=Math.min(n.height,o),l=Math.max(qn,Math.min(e.left,t.width-n.width-qn)),d=r?Math.max(qn,e.top-Vr-s):Math.max(qn,Math.min(e.bottom+Vr,t.height-s-qn));return{left:l,top:d,maxHeight:o,above:r}}function gh(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=yb.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=g;switch(a.kind){case"literal":l=i.symbol?ch(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):Re("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=kt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${kt(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${Re("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=Ub(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Ce("Field",a.timeField,Ab,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${oh("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Wi(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
          ...
          ${c?h`<div class="hint keep">Read by ${u} ${u===1?"layer":"layers"}.
            ...
            <button type="button" class="link" @click=${()=>{let p=gs(e.config,n);p&&t(p)}}>stop sharing</button>
    ...
    ${o.unit?Oe("Add unit",!!i.useEntityUnit,s=>a({useEntityUnit:s})):g}
  ...
  </details>`}function Ub(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${n.function==="count"?g:Re("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var bh=Qo,Kb=bh.filter(([e])=>e!=="none");function Wb(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function xh(e,n){let t=Wb(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return cc(e)?{type:e,...t}:{type:e}}var jb=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function vh(e,n,t,i){let a=n.serviceDataJSON??"",r=uc(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Yb).slice(0,7)}
    ...
    ${t.type==="openPage"?Xb(e):g}`}var Yb="#808080",Gp=[0,15,30,60,120];function Up(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Xb(e){let n=e.config;return kh(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function kh(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Ce("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?g:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function $h(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Wi(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
    ...
    <div class="field readout"><span>Used by</span><span class="readout-v">${a===0?"No layers yet":`${a} ${a===1?"layer":"layers"}`}</span></div>`}function Ch(){return{id:Z(),name:"",value:D("")}}function Le(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function ke(e,n,t,i,a=!1){let r=e.elements.find(c=>c.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=Le(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function un(e,n,t,i,a){let r=n.payload.id,o=sr(n)??a.min,s=Le(e.config,t,n).size??o;return ae(i,s,l=>e.update(d=>ke(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,unit:"pt",...a.def===void 0?{}:{def:a.def}})}function Sh(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=_t()),a=bt(e,n).filter(l=>!ve(e,l));if(a.length===0)return;let r=pi(e,a.map(l=>l.payload.id),n),o=Tn(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let c=s?.placements[l],u=c?.size??sr(d),p={frame:{...c?.frame??d.payload.frame},isHidden:c?.isHidden??!1,...u!==void 0?{size:u}:{}};for(let m of oe)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=lr(p,n,t,d.kind)}hi(e,t)}function co(e,n){return Lc(e,n)}function Jb(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function Xn(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"||e.kind==="chartTimes"||e.kind==="chartDots"||e.kind==="chartGrid"||e.kind==="imageTime"?void 0:e.payload.colorSlot.baseColorHex}function Th(e,n,t){let i=Jb(t.map(l=>Le(e,n,l).isHidden)),a=t.map(Xn),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var $i=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]],Zb=[["leading","Left"],["center","Center"],["trailing","Right"]],Qb=[["1","1"],["2","2"]];function Eh(e,n,t){let i=n.payload.id,a=ur(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s={...o?{domain:"camera"}:{},needed:Kp(n)},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return h`
    ${kt(e,o?"Camera":"Entity",r,d=>e.update(c=>_c(c,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint ${Kp(n)?"warn":""}">${tx(n,a)}</div>`}function Kp(e){return e.kind==="timeline"?e.payload.value.kind.kind!=="entityState":e.kind==="chart"?e.payload.historyMinutes>0&&e.payload.value.kind.kind!=="entityState":e.kind==="image"?e.payload.entity.entityId==="":!1}function ex(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function uo(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function tx(e,n){let t=ex(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a shared value, so change that shared value to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${uo(o)}.${r}`}function nx(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function ba(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>ba(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>ba(e[a],n[a]))}function hl(e,n,t){return t.some(i=>!ba(e[i],n[i]))}function Gr(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Se(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=e.helpSections.has(n),l=()=>e.toggleSection(n),d=()=>{!s&&!o&&e.toggleSection(n),e.toggleHelp(n)},c=s?`Hide the help in ${t}`:`Show help for ${t}`,u=h`<span class="swatch">${V(a.icon??"content")}</span>
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function sx(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function lx(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${ax(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Zn(e,n=Fn){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function dx(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Ft}, so they are averaged into ${Ft} even slots to cover ${a}.`}var Yr=new Set;function vl(e,n,t=Fn){return Yr.has(e)||!t.some(i=>i.minutes===n)}function ml(e,n,t,i,a=Fn){let r=vl(e,n,a);return h`<label class="field">${Be("Span",{atDefault:n===t&&!r,title:`Back to ${Zn(t,a)}`,reset:()=>{Yr.delete(e),i(t)}})}
      <select @change=${o=>{let s=o.target.value;s==="custom"?(Yr.add(e),He(o.target)):(Yr.delete(e),i(Number(s)||Qa))}}>
        ${a.map(({minutes:o,label:s})=>h`<option value=${String(o)} ?selected=${!r&&o===n}>${s}</option>`)}
        <option value="custom" ?selected=${r}>Custom…</option>
      </select></label>`}function fl(e,n,t=!1){let i=t?Go:er,a=Math.floor(i/1440),r=t?Bi:Fn,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function ux(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Le(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>ke(p,t,i,{frame:vr(o,c)}),`${a}-${u}-${t}`),l=!ba(o,Di)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return Se(e,"placement","Position",h`
      ...
      ${Oe("Hidden",r.isHidden,u=>e.update(p=>ke(p,t,i,{isHidden:u})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`})}return d?.place==="through"?Se(e,"placement","Position",h`
      ...
      ${qp(e,n,t)}
      ${o.rotationDegrees!==0?Jn("Rotation",o.rotationDegrees,c=>s({rotationDegrees:c},"rot"),{min:-180,max:180,step:1,def:0,format:c=>`${Math.round(c)}\xB0`,unit:"\xB0",range:!1}):g}
  ...
  ${l?g:h`<div class="field list-field"><span>Copy</span>
    ...
    ${e.timeLabelCount<=0?g:h`
      ...
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${mx.map(([y,b])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          ...
          @click=${()=>{y!==d&&a(k=>gx(k,o,y))}}>${b}</button>`)}
      </span>
    ...
    ${p===void 0?g:h`<div class="rich-confirm" role="alertdialog" aria-label=${y}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${b=>{ha.delete(o),He(b.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ${u?h`<div class=${u.warn?"hint warn":"rich-note"}>${u.text}</div>`:g}
    ${s==="rich"?Hx(e,n,t,i,a):h`
        ${Eh(e,n,a)}
        ${se(e,r.value,b=>i(k=>{k.value=b},"value"),{showResolved:!0,label:s==="countdown"?"Until":"Text",key:`${a}-value`})}
        ${Ml(e,s==="countdown",r.value,b=>f(b?"countdown":"plain",null))}
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Te(d,de(e))}</button>. It stays in the chart's group and moves with it.</div>`:g}`}`}function Hx(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=de(e),d=Math.max(0,o.findIndex(R=>R.id===fa.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Le(e.config,t,n).size??r.fontSize,f=(R,K)=>{Dt.delete(s),i(H=>{R(H),Jd(H)},K)},y=(R,K)=>f(H=>{let x=H.parts?.find(C=>C.id===c.id);x&&R(x)},K?`part-${c.id}-${K}`:void 0),b=(R,K)=>{fa.set(s,R),Dt.delete(s),He(K)},k=(R,K)=>{let H=Z();fa.set(s,H),f(x=>{(x.parts??=[]).push({id:H,value:R})}),mh(K,lo(`${a}-part-${H}`),!0)},$=R=>f(K=>{K.parts&&xa(K.parts,d,R)}),w=()=>{let R=o[d+1]??o[d-1];R&&fa.set(s,R.id),f(K=>{K.parts=(K.parts??[]).filter(H=>H.id!==c.id)})},S=o.map((R,K)=>{let H=Cx(R.value,l),x=R.id===c.id,C=wl(R),M=H.kind==="value"?e.resolve(R.value):void 0,F=R.fontWeight===void 0?void 0:$i.find(([N])=>N===R.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${x?"true":"false"} class="part-chip ${H.kind} ${x?"on":""}"
      aria-label=${Rh(R,K,l)} @click=${N=>b(R.id,N.currentTarget)}>
      <span class="part-dot" style=${`background:${Tx(R,p)}`}
        title=${C==="bands"?"By value, with its own bands":C==="pick"?"Its own colour":"The layer colour"}></span>
      ${H.kind==="text"?h`<span class="part-txt">${H.label===""?h`<span class="part-empty">empty</span>`:$x(H.label).map(N=>N.space?h`<span class="part-sp">${"\xB7".repeat(N.text.length)}</span>`:N.text)}</span>`:h`<span class="part-txt">${H.label}</span>`}
      ${M===void 0?g:h`<span class="part-now">${M}</span>`}
      ${F===void 0?g:h`<span class="part-flag" title="Its own weight">${F}</span>`}
      ${R.fontSize===void 0?g:h`<span class="part-flag" title="Its own font size">${R.fontSize} pt</span>`}
    </button>`}),L=r.rules.some(R=>R.partId===c.id),_=c.value.kind.kind==="literal",A=wl(c),W=c.fontSize!==void 0,E=$i.find(([R])=>R===r.fontWeight)?.[1]??r.fontWeight,G=R=>{R>=gl&&R<=yl&&y(K=>{K.fontSize=R},"size")},q=A==="bands"?qe(e.resolve(c.value)??""):[],U={layer:"Use the layer colour",..._&&A!=="bands"?{bands:"By value needs a live value"}:{}},ee=(R,K)=>y(H=>{let x={bands:H.bands??[],bandAboveColorHex:H.bandAboveColorHex??ue};R(x),x.bands.length>0?H.bands=x.bands:delete H.bands,x.bandAboveColorHex!==ue?H.bandAboveColorHex=x.bandAboveColorHex:delete H.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${R=>k(D(""),R.currentTarget)}>${V("text")}<span>Add text</span></button>
        <button type="button" class="small" title="Add a part that shows a live value"
          @click=${R=>k({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},R.currentTarget)}>${V("braces")}<span>Add value</span></button>
      </div>
    </div>
    <div class="part-editor">
      ...
      ${L&&u>1?h`<div class="hint keep">A state changes this part. Change or delete that state first.</div>`:g}
      ${se(e,c.value,R=>y(K=>{K.value=R},"value"),{showResolved:!0,label:_?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ${_?h`<div class="hint">Spaces count, and show as dots in the parts list. Type one at the start or end when this part needs a gap.</div>`:g}
      ${ie("Colour",A,xx,R=>y(K=>{if(R==="layer"){delete K.colorHex,delete K.coloring;return}if(R==="pick"){delete K.coloring,K.colorHex=Cl(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=Jr(qe(e.resolve(K.value)??"")))}),{def:"layer",titles:U,..._&&A!=="bands"?{disabled:{bands:!0}}:{}})}
      ${A==="pick"?fe("Part colour",c.colorHex,R=>y(K=>{K.colorHex=R??p},"color")):g}
      ${A==="bands"?h`
        ${Zr({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??ue},c.colorHex??p,ee,q.length===1?q[0]:void 0)}
        <div class="hint">These bands belong to this part. Another value in the same layer keeps its own.</div>`:g}
      <div class="field seg-field">${Be("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${E})`,reset:()=>y(R=>{delete R.fontWeight})})}
        ${Xr("Weight",c.fontWeight,$i,R=>y(K=>{K.fontWeight=R}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Be("Font size",W?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(R=>{delete R.fontSize})}:void 0,ao(c.fontSize??m,G,{step:1,min:gl,max:yl}))}
        ${ro(c.fontSize,R=>{R===void 0?y(K=>{delete K.fontSize},"size"):G(R)},{step:1,min:gl,max:yl,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:W?"Part font size":`Part font size, ${m} pt from the layer`,...W?{}:{lead:V("link")}})}
      </label>
    </div>
        ...
        ${se(e,x.value,F=>C(N=>{N.value=F},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${M?h`
        ...
        ${Y?h`
            ...
            <div class="grid2">
              ${ml(a,x.historyMinutes,M,T=>C(I=>{I.historyMinutes=T}),Bi)}
              ${ie("Per",x.statPeriod,qa,T=>C(I=>{I.statPeriod=T}),{def:Pi})}
            </div>
            ${Kl?fl(x.historyMinutes,T=>C(I=>{I.historyMinutes=T},"span"),!0):g}
            ${ie("Read",x.statType,_o,T=>C(I=>{I.statType=T}),{def:Ni})}
            ...
            ${Pe&&ge===void 0?h`<div class="hint keep">Reading the statistics…</div>`:g}
            ${Pe&&ge===""?h`<div class="hint warn">No long-term statistics for this entity in that span.
        ...
        ${te?h`
            ${Pe?g:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${ml(a,x.historyMinutes,M,T=>C(I=>{I.historyMinutes=T}))}
              <div class="field readings-field">${Be("Points",{atDefault:x.historyPoints===F,title:`Back to ${F<1?"every one":`${F} averaged`}`,reset:()=>C(T=>{T.historyPoints=F})})}
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Points">
                    ...
                    <button type="button" role="radio" aria-checked=${Je?"true":"false"} class=${Je?"on":""}
                      ...
                      @click=${()=>{Je||C(T=>{T.historyPoints=Uo})}}>Every one</button>
                  </div>
                  ${Je?g:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      step="1" min=${tr} max=${Ft}
                      data-scrub @pointerdown=${wa(x.historyPoints,T=>C(I=>{I.historyPoints=Math.round(T)},"hpoints"),{step:1,min:tr,max:Ft})}
                      @input=${we(T=>{let I=Number(T);T.trim()!==""&&Number.isFinite(I)&&I>=1&&C(ye=>{ye.historyPoints=Math.round(I)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${Kl?fl(x.historyMinutes,T=>C(I=>{I.historyMinutes=T},"span")):g}
            ...
            ${Ul===void 0?g:h`<div class="hint keep">${Ul}</div>`}
            ${Pe&&ge===void 0?h`<div class="hint keep">Reading the history…</div>`:g}
            ${Pe&&ge===""?h`<div class="hint warn">Nothing recorded for this entity in that span.
                Either it is excluded from the recorder, or it has no numeric states.</div>`:g}`:g}
        ${N?h`
            ${Oe("Show gaps when unavailable",x.gaps===!0,T=>C(I=>{T?I.gaps=!0:delete I.gaps}),u.gaps===!0)}
            ${Nt(e)}
        ...
        <div class="grid2">
          ...
          ${x.limit<=0?g:ie("Keep",x.takeFromEnd?"end":"start",N?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],T=>C(I=>{I.takeFromEnd=T==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${Ce("Smooth data",ot(x.smoothing)??"off",wb,T=>C(I=>{let ye=ot(T);ye===void 0?delete I.smoothing:I.smoothing=ye}),{def:ot(u.smoothing)??"off"})}
        ${Nt(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,f=!0;let km=(()=>{if(Sa)return!0;if(x.scale==="fixed")return x.minValue<0&&x.maxValue>0;let T=Gt.filter(yo=>Number.isFinite(yo));if(T.length===0)return!0;let I=Math.min(...T,x.thresholdValue??1/0),ye=Math.max(...T,x.thresholdValue??-1/0);return I<0&&ye>0})();w=h`
        <div class="grid2">
          ${ie("Style",x.style,ph,T=>C(I=>{I.style=T}),{def:u.style})}
        ...
        ${x.style==="bars"?h`
          ...
          ${Oe("Round top only",Xt(x.barCorners)==="top",T=>C(I=>{T?I.barCorners="top":delete I.barCorners}),Xt(u.barCorners)==="top")}
          ${Nt(e)}
          ...
          ${x.barBorderWidth===void 0?g:h`
            ${ae("Border width",x.barBorderWidth,T=>C(I=>{I.barBorderWidth=Math.min(Math.max(T??1,0),Ja)},"barborderw"),{step:.5,min:0,max:Ja,def:1,unit:"pt"})}
            ${ma("Border colour",x.barBorderColorHex,"White",T=>C(I=>{T===void 0?delete I.barBorderColorHex:I.barBorderColorHex=T},"barbordercol"))}
        ...
        ${go.length===0?g:Ce("Same scale as",Sa?x.scaleFrom:"",[["","Its own"],...go.map(T=>[T.payload.id,Te(T,jl)])],T=>C(I=>{T?I.scaleFrom=T:delete I.scaleFrom}),{def:""})}
        ...
        ${x.coloring==="bands"?h`
          ...
          ${Zr(x,x.colorSlot.baseColorHex,C,void 0,x.style==="bars"?{...x.fillColorHex===void 0?{}:{fillHex:x.fillColorHex},...x.barBorderColorHex===void 0?{}:{borderHex:x.barBorderColorHex},border:x.barBorderWidth!==void 0}:void 0)}
        ...
        <div class="field list-field"><span>Draw</span>
          <div class="adders" @pointerover=${pn} @focusin=${pn}>
            ${ii("draw:threshold","Threshold line",ql("threshold"),T=>kc(T,a,x.thresholdValue??Tl(Gt)))}
            ${ii("draw:now","Now line",ql("now"),T=>$c(T,a,!0))}
            ${ii("draw:zero","Zero line",Yl,T=>{ls(T,a)})}
            ${ii("draw:times","Clock times",$m,T=>{Pn(T,a)},Xl)}
            ${ii("draw:dots","Dots",Cm,T=>{os(T,a)},Jl)}
            ${ii("draw:grid","Grid lines",Sm,T=>{ss(T,a)})}
          </div>
        </div>
        ${Yl&&!km?h`<div class="hint warn">These readings never go below zero, or never above it, so the zero
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${Nt(e)}`;break}case"timeline":{let x=n.payload,C=(ge,Ve)=>s(Je=>ge(Je.payload),Ve),M=u.historyMinutes,F=x.value.kind.kind==="entityState",N=yt(x),Y=N===void 0?void 0:e.historySeries(N),te=lt(x)*60,$e=Zi(Y??"",an),$t=vl(a,x.historyMinutes),Vt=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,Pe=Mb($e,te,Vt===void 0?void 0:e.hass.states[Vt]?.state,Vt?.split(".")[0]);$=h`
        ...
        ${Rb(x,C,Pe,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ${Pe.length>2?h`<div class="hint keep">Seen in this span: <span class="nums">${Pe.filter(ge=>ge!=="unavailable"&&ge!=="unknown").join(", ")}</span>. Click into a State box to pick one.</div>`:g}
        <div class="grid2">
          ${ae("Gap",x.gap,ge=>C(Ve=>{Ve.gap=Math.min(nr,Math.max(0,ge??0))},"tgap"),{step:.5,min:0,max:nr,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",x.cornerRadius,ge=>C(Ve=>{Ve.cornerRadius=Math.max(0,ge??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
...
`;break}case"shape":$=h`<div class="grid2">
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let x=n.payload,C=(Y,te)=>s($e=>Y($e.payload),te),M=e.config.elements.find(Y=>Y.payload.id===x.chart),F=M?.kind==="chart"||M?.kind==="timeline"?M:void 0,N=F?.kind==="timeline"?"timeline":"chart";$=h`
        <div class="field readout"><span>${F?.kind==="timeline"?"Timeline":"Chart"}</span><span class="readout-v">${F?h`<button class="small" title=${`Select that ${N}`} @click=${()=>e.selectLayer(F.payload.id)}>${Te(F,de(e))}</button>`:"None"}</span></div>
        ...
        <div class="hint">The clock times of that ${N}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,w=hx(x,C,u,"ct",h`
        ...
        <div class="hint">The time that picture was fetched, not the time now: a picture that stops updating
          ...
          has been fetched once. Move and size it like any other layer: the chip grows to fill the frame.</div>`;break}case"chartDots":{let x=n.payload,C=(te,$e)=>s($t=>te($t.payload),$e),M=e.config.elements.find(te=>te.payload.id===x.chart),F=M?.kind==="chart"?M:void 0,N=F===void 0?void 0:Le(e.config,t,F).size??F.payload.lineWidth,Y=N===void 0?void 0:Math.round(N*18)/10;$=h`
        ${Xp(e,F)}
        ...
        ${Nt(e)}`,w=h`
        ${ie("Dots",x.dots,uh,te=>C($e=>{$e.dots=te}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",x.size??Y,te=>C($e=>{let $t=ht(te);$t===void 0||$t===Y?delete $e.size:$e.size=$t},"dotsize"),{step:.5,min:1,max:12,...Y===void 0?{}:{def:Y},unit:"pt"})}
          ${ma("Dot colour",x.colorHex,"Series colour",te=>C($e=>{te===void 0?delete $e.colorHex:$e.colorHex=te},"dotcol"))}
        </div>
        <div class="hint">Auto leaves the dots off once the readings sit too close to tell apart. Left alone, a dot
          is a little wider than the chart's line and takes the colour the series has at its reading.</div>`;break}case"chartGrid":{let x=n.payload,C=(N,Y)=>s(te=>N(te.payload),Y),M=e.config.elements.find(N=>N.payload.id===x.chart),F=M?.kind==="chart"?M:void 0;$=h`
        ${Xp(e,F)}
        ...
        ${Nt(e)}`,w=h`
        <div class="grid2">
          ${ae("Lines",x.lines,N=>C(Y=>{Y.lines=Mn(N??Zt)},"lines"),{step:1,min:1,max:4,def:Zt})}
          ${ae("Thickness",x.thickness,N=>C(Y=>{Y.thickness=Rn(N??Jt)},"thick"),{step:.25,min:Wa,max:ja,def:Jt,unit:"pt"})}
        </div>
        ${fe("Colour",x.colorHex,N=>C(Y=>{Y.colorHex=N??Rt},"gridcol"),!1,Rt)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let S=f||Xn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&st(n.payload)?"Layer colour":"Colour"),L=us(e.config,n),_=L?{kind:{kind:"entityState",...L}}:void 0,A=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,W=Ax[n.kind],E=Ix[n.kind],G=hl(n.payload,u,W),q=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,U=e.config.perFamily[t]?.placements[a]?.size!==void 0,ee=hl(n.payload,u,E)||q!==void 0&&l.size!==void 0&&l.size!==u[q],R=zn(e.config,a),K=(x,C)=>()=>s(M=>Gr(M.payload,u,x),C),H=h`<section class="sec name-sec" data-open="true" style=${`--c:${Q.place}`}>
    <div class="sec-h pinned">
      ...
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${Ih(n,de(e))}
        @input=${we(x=>s(C=>{let M=Bx(x);M===void 0?delete C.payload.name:C.payload.name=M},"name"))} />
    </div>
  </section>`;return h`
    ${H}
    ${Se(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?g:Eh(e,n,o)}${$}`,{color:Q.content,icon:"content",summary:El(e,n),...G?{reset:()=>s(x=>{Gr(x.payload,u,W),x.kind==="text"&&sa(x.payload.rules)},"reset-content")}:{}})}
    ${w===void 0&&S===void 0?g:Se(e,"look",n.kind==="image"?"Picture":"Look",h`${w??g}${S??g}`,{color:Q.look,icon:n.kind==="image"?"image":"look",...Qr(n)?{summary:Qr(n)}:{},...ee?{reset:()=>e.update(x=>{Gr(x.elements[r].payload,u,E),U&&ke(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Extras",Px(e,n,b,k),{color:Q.numbers,icon:"text",summary:zx(e,n),...R.length>0||Ge(e.config,a).length>0||rn(e.config,a).length>0||Nn(e.config,a).length>0||Dn(e.config,a).length>0||hl(n.payload,u,Jp)?{reset:()=>e.update(x=>{for(let M of zn(x,a))xe(x,M.payload.id);for(let M of Ge(x,a))xe(x,M.payload.id);for(let M of rn(x,a))xe(x,M.payload.id);for(let M of Nn(x,a))xe(x,M.payload.id);for(let M of Dn(x,a))xe(x,M.payload.id);let C=x.elements.find(M=>M.payload.id===a);C&&Gr(C.payload,u,Jp)})}:{}}):g}
    ${n.kind==="timeline"||n.kind==="image"?Fx(e,n):g}
    ${Se(e,"states","States",Bh(e,n.payload.rules,n.kind,x=>x.elements.find(C=>C.payload.id===a)?.payload.rules,`rules-${a}`,_,A),{color:Q.states,icon:"states",summary:aa(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ${i.placement===!1?g:ux(e,n,t)}
    ${i.tap===!1?g:px(e,n)}`}function Fx(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?rn(e.config,t):is(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);if(!m)return;let f=m.payload.frame;m.payload.frame={...Le(p,o,m).frame},i?Pn(p,t):rs(p,t,pe[o==="inline"?"rectangular":o]),m.payload.frame=f}),l=a.length>0,d=a.map(p=>({el:p,lead:V("clock"),title:r,kind:i?"Times":"Timestamp"})),c=i?"timeline:times":"image:time",u=h`
    ${Ah(i?"timeline":"image")}
    <div class="field list-field"><span>Draw</span>
      <div class="adders" @pointerover=${pn} @focusin=${pn}>
        <button class="small ${l?"on":""}" ?disabled=${l} aria-pressed=${l?"true":"false"} data-extra=${c}
          title=${eo(c,l?`${r} is on this ${i?"timeline":"picture"}. Remove it in the list below.`:`Add ${r.toLowerCase()}`)}
    ...
    ${a.type==="openPage"?kh(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):g}`}var Lx=24;function _x(e,n){let t=[],i=1/0;for(let r of oe){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Hc(e.config,n,r);o&&(t.push(`${ne(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return g;let a=i<Lx;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:g}`}function zx(e,n){let t=n.payload,i=zn(e.config,t.id),a=Ge(e.config,t.id),r=rn(e.config,t.id),o=Nn(e.config,t.id),s=Dn(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(Ht.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(ft.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function Px(e,n,t,i={}){let a=de(e),r=zn(e.config,n.payload.id),o=rn(e.config,n.payload.id),s=Nn(e.config,n.payload.id),l=Dn(e.config,n.payload.id),d=Ge(e.config,n.payload.id),c=b=>e.update(k=>{yc(k,n.payload.id,b)}),u=b=>e.update(k=>{ns(k,n.payload.id,b)}),p=new Set(r.map(b=>b.payload.value.kind.kind==="chartStat"?b.payload.value.kind.stat:"")),m=new Set(d.map(b=>b.payload.chartAnchor.at)),f=[...r.map(b=>({el:b,lead:e.resolve(b.payload.value)??"--",title:Te(b,a),kind:"Number"})),...d.map(b=>{let{at:k,place:$}=b.payload.chartAnchor,w=ft.find(([L])=>L===k)?.[1]??"Reading";if($==="through")return{el:b,lead:k==="now"?"\u2502":"\u2500",title:k==="zero"?"Zero":w,kind:"Line"};let S=b.kind==="text"?e.resolve(b.payload.value)??"\u25CF":b.kind==="icon"?Ox(e.resolve(b.payload.symbol)):"\u25C6";return{el:b,lead:S,title:w,kind:"Marker"}}),...o.map(b=>({el:b,lead:V("clock"),title:"Clock times",kind:"Times"})),...s.map(b=>({el:b,lead:V("chartDots"),title:"Reading dots",kind:"Dots"})),...l.map(b=>({el:b,lead:V("chartGrid"),title:"Grid lines",kind:"Grid"}))],y=f.length;return h`
    ...
    ${Ah("chart",i,n.payload.style==="bars")}
    ${t??g}
      ...
      <div class="adders" @pointerover=${pn} @focusin=${pn}>
        ${Ht.map(([b,k])=>h`
          <button class="small ${p.has(b)?"on":""}" data-extra=${`number:${b}`}
            title=${eo(`number:${b}`,p.has(b)?`Add another ${k.toLowerCase()}`:`Add the ${k.toLowerCase()}`)}
      ...
      <div class="adders" @pointerover=${pn} @focusin=${pn}>
        ${ft.filter(([b])=>gt(b)).map(([b,k])=>h`
          <button class="small ${m.has(b)?"on":""}" data-extra=${`marker:${b}`}
            title=${eo(`marker:${b}`,m.has(b)?`Add another mark over the ${k.toLowerCase()}`:`Mark the ${k.toLowerCase()}`)}
    ...
    ${y===0?g:h`
      ...
      ${Hl(e,f,{icon:"close",danger:!0,label:b=>`Delete this ${b}`,run:b=>e.update(k=>xe(k,b))})}
      <div class="hint">Click a row to open its main settings here. More settings selects that layer for the
        ...
        dot to pick the dots.</div>`}`}var ya,Fh="wrist-assistant-extras-preview",po=(()=>{try{return window.localStorage.getItem(Fh)!=="off"}catch{return!0}})();function Zp(e,n){po=e;try{window.localStorage.setItem(Fh,e?"on":"off")}catch{}He(n)}function pn(e){if(!po)return;let n=e.target?.closest?.("[data-extra]")?.getAttribute("data-extra");!n||n===ya||(ya=n,He(e.currentTarget))}function eo(e,n){return po?n:`${dl(e)} ${n}.`}function Ah(e,n={},t=!1){if(!po)return h`<button class="link xprev-show" @click=${s=>Zp(!0,s.currentTarget)}>
      ${V("show")}<span>Show preview</span></button>`;let i=e==="timeline"?"timeline:times":e==="image"?"image:time":void 0,a=ya!==void 0&&ll(ya)===e?ya:i,r=a===void 0?void 0:n[a],o=e==="image"?"picture":e;return h`<div class="xprev">
    <span class="well">${Ap(e,a,t)}</span>
    <span class="xprev-t">
      <b>${a===void 0?"Preview":Ip(a)}</b>
      <span>${a===void 0?`Point at a button below to see what it adds to the ${o}.`:dl(a)}</span>
      ${r?h`<span class="xprev-why">${r}</span>`:g}
    </span>
    <button class="icon xprev-hide" title="Hide the preview" aria-label="Hide the preview"
      @click=${s=>Zp(!1,s.currentTarget)}>${V("hide")}</button>
  </div>`}function Hl(e,n,t){return h`<div class="chart-numbers">${vp(n,a=>a.el.payload.id,({el:a,lead:r,title:o,kind:s})=>{let l=a.payload.id,d=s.toLowerCase();return h`
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function Nx(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(f=>f.payload.id===t);m&&c(m)},`${i}-${u}`),o=Ee(n.kind).payload,s=Xn(n),l=s===void 0?g:fe("Colour",s,c=>r(u=>{Xn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ${c.kind==="chartStat"?Ce("Number",c.stat,[...Ht],u=>r(p=>{p.kind==="text"&&p.payload.value.kind.kind==="chartStat"&&(p.payload.value={...p.payload.value,kind:{...p.payload.value.kind,stat:u}})},"stat")):d||st(n.payload)?g:se(e,n.payload.value,u=>r(p=>{p.kind==="text"&&(p.payload.value=u)},"value"),{showResolved:!0,label:n.payload.countdown?"Until":"Text",key:`${i}-value`})}
        ...
        ${ie("Style",c.style,ph,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
        ...
        ${ie("Picture",c.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],u=>r(p=>{p.kind==="image"&&(p.payload.contentMode=u)},"mode"),{def:o.contentMode})}`}case"tap":return Rl(e,n.payload,(c,u)=>r(p=>{p.kind==="tap"&&c(p.payload)},u??"action"),i);case"chartTimes":{let c=n.payload;return h`
        ${Jn("Times",c.timeLabelCount,u=>r(p=>{p.kind==="chartTimes"&&(p.payload.timeLabelCount=Math.max(0,Math.min(_n,Math.round(u))))},"count"),{min:0,max:_n,step:1,def:o.timeLabelCount,format:u=>u<=0?"None":String(Math.round(u)),range:!1})}
        <div class="grid2">
        ...
        ${ie("Dots",c.dots,uh,f=>r(y=>{y.kind==="chartDots"&&(y.payload.dots=f)},"mode"),{def:"auto"})}
        <div class="grid2">
          ...
          ${ma("Dot colour",c.colorHex,"Series colour",f=>r(y=>{y.kind==="chartDots"&&(f===void 0?delete y.payload.colorHex:y.payload.colorHex=f)},"colour"))}
        </div>`}case"chartGrid":{let c=n.payload;return h`
        <div class="grid2">
          ${ae("Lines",c.lines,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.lines=Mn(u??Zt))},"lines"),{step:1,min:1,max:4,def:Zt})}
          ${ae("Thickness",c.thickness,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.thickness=Rn(u??Jt))},"thick"),{step:.25,min:Wa,max:ja,def:Jt,unit:"pt"})}
        </div>
    ...
    <div class="grid2">
      ...
      ${Ce("Sits",t.place,Ya.filter(([r])=>r!=="through"),r=>i(o=>{o.payload.chartAnchor&&(o.payload.chartAnchor.place=r)},"place"))}
    </div>`}function Dx(e,n,t){if(n.kind==="tap")return g;let i=n.payload.id,a=We(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=ps(e.config,n);return h`
    ${Oe("Tappable",a!==void 0,s=>e.update(l=>{s?dr(l,i):cr(l,i)}))}
    ${a?h`<div class="value-editor">
          ${Rl(e,a.payload,r,`${t}-attached`)}
    ...
    ${Hl(e,t.map(r=>({el:r,lead:V(r.kind),title:Te(r,i),kind:ln[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Ki(o,r,void 0))})}
    <div class="row-acts">
    ...
    ${Se(e,"content","Inline text",h`
      ...
      ${Ml(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:Q.content,icon:"text",summary:De(`${n.label?`${n.label}: `:""}${Me(n.value,i)}`,48)})}
    ...
    ${Oe("End labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=D(String(s.minValue)),s.maxLabel=D(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?se(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):g}
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):g}`}var L0=oe.map(e=>[e,ne(e)]),Fl={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Kx=Object.keys(Fl),to=["color","text","fontSize","fontWeight","visibility"];function Wx(e,n=!1){let t=ji[e].filter(i=>!n||to.includes(i));return Kx.filter(i=>t.includes(Ne[i]))}function zh(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Sx(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:g}`}var jx={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Kr(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function De(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Ph(e){if(!e||_e(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function Me(e,n){return`${ka(e,n)}${Ph(e.format)}`}function ka(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${De(t.value,40)}"`:"(empty)";case"entityState":return Kr(t,n);case"entityAttribute":return t.attribute?`${Kr(t,n)} \xB7 ${t.attribute}`:Kr(t,n);case"entityAge":return`age of ${Kr(t,n)}`;case"aggregate":return qx(t.aggregate);case"time":return jx[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${De(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Ht.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?ka(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function qx(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function xa(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function Yx(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.cases.map((m,f)=>Jx(e,m,f,n,a,u,`${o}-${m.id}`,p))}
    <div class="adders"><button class="small" @click=${()=>u(m=>{m.cases.push(ks())})}>+ case</button></div>
    ${Oe("Otherwise",n.otherwise!==void 0,m=>u(f=>{m?f.otherwise=f.otherwise??[]:delete f.otherwise}))}
  ...
  </div>`}function Jx(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(f=>f.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>Zx(e,c,u,p=>l(m=>{let f=m.when.tests.find(y=>y.id===c.id);f&&p(f)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
  ...
  </div>`}function Zx(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=Vn(s.kind),d=e.evaluateTest(n),c=g;switch(l){case"value":c=se(e,s.value??D(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${se(e,s.value??D(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${se(e,s.upper??D(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${Re("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!Qx(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:g}`;break;case"times":c=h`<div class="row-inline">
          ${th(e,"From",s.value??D("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${th(e,"To",s.upper??D("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=ev(n.value)?tv(s.options??[],u=>o(p=>{p.comparison.options=rl(u)},"options")):Re("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Ce("Comparison",s.kind,Nc.map(u=>[u,vi[u]]),u=>o(p=>{p.comparison=$s(p.comparison,u)}))}
    ${c}
  </div>`}function Qx(e){try{return new RegExp(e),!0}catch{return!1}}function th(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Bn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${we(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:g}</label>`}function ev(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function tv(e,n){let t=Cp(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    ...
    </div></div>`}function Nh(e,n,t,i,a,r=!1){let o=Wx(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:g}
    ${n.map((s,l)=>nv(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Gn(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${Fl[s]}</option>`)}
    </select>`}var Dh=["setColor","setBorderColor","setBackgroundColor"];function nv(e,n,t,i,a,r,o,s=!1){let l=!ji[i].includes(Ne[n.kind]),d=s&&!l&&!to.includes(Ne[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${Oh(e,n,a,o)}
  </div>`}function Oh(e,n,t,i){let a=mr(n.kind),r=g;if(a==="value"){let o=n.value??D("");if(Dh.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?fe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=D(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
        <button class="link" @click=${()=>t(l=>{l.value=s?{kind:{kind:"entityAttribute",entityId:"",displayName:"",domain:"",attribute:"rgb_color"}}:D("#FFFFFF")})}>${s?"Read the colour from a value instead":"Use a fixed colour instead"}</button>
        ${s?g:h`<div class="hint">The value must resolve to a hex colour such as <code>#FF9F0A</code>. Empty or invalid results leave the colour unchanged.</div>`}`}else r=se(e,o,s=>t(l=>{l.value=s},"value"),{noFormat:n.kind==="setIcon",symbol:n.kind==="setIcon",showResolved:!0,label:n.kind==="setIcon"?"Symbol":"To",key:`${i}-value`})}else if(a==="number"){let o=n.kind==="setOpacity"?{step:.05,min:0,max:1}:n.kind==="setRotation"?{step:1,unit:"\xB0"}:n.kind==="setFontSize"||n.kind==="setBorderWidth"?{step:.5,min:0,unit:"pt"}:{step:.5,min:0},s=n.kind==="setOpacity"?"Opacity (0 to 1)":n.kind==="setRotation"?"Angle":n.kind==="setFontSize"?"Size":n.kind==="setBorderWidth"?"Width":"Value";r=ae(s,n.number??0,l=>t(d=>{d.number=l??0},"number"),o)}else a==="weight"&&(r=ie("Weight",n.weight??"regular",$i,o=>t(s=>{s.weight=o})));return r}var kl=new Set,Wr=new Map,jr=new Map,nh=new Map;function Bh(e,n,t,i,a,r,o){let s=tl(n);return!s.ok||kl.has(a)?h`
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{kl.delete(a),He(d.target)}}>Show as table</button>
        ${s.ok?g:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${Yx(e,n,t,i,a,o)}`:iv(e,s.table,n[0],t,i,a,r,o)}function iv(e,n,t,i,a,r,o,s){let l=(H,x)=>e.update(C=>{let M=a(C);M&&H(M)},x?`${r}-${x}`:void 0),d=n.value??nh.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!cp(d)&&av(e.resolve(d)),p=ji[i],m=Wr.get(r)??new Set,f=n.columns.length===0&&m.size===0?[dp[i]]:[],y=ep(n.columns,[...m,...f.filter(H=>H!==void 0)],p),b=Ur.get(r),k=t?t.partId:s?.some(H=>H.id===b)?b:void 0,$=s!==void 0&&k!==void 0,w=$?p.filter(H=>to.includes(H)):p,S=$?y.filter(H=>!to.includes(H)):[],L=(H,x)=>{if(!t){H?Ur.set(r,H):Ur.delete(r),He(x);return}l(C=>{let M=C[0];M&&(H?M.partId=H:delete M.partId)})},_=t?e.liveBranch(t):"none",A=t?e.forced.get(t.id)??"live":"live",W=H=>A!=="live"&&(A==="otherwise"?H==="otherwise":A.caseId===H),E=H=>{t&&e.setForced(t.id,W(H)?"live":H==="otherwise"?"otherwise":{caseId:H})},G=H=>{nh.set(r,H),n.rows.length!==0&&l(x=>op(x,H),"lhs")},q=()=>{Ur.delete(r),l(H=>{ap(H,d??D(""),u),k!==void 0&&H[0]&&H[0].partId===void 0&&(H[0].partId=k)})},U=n.rows.map((H,x)=>ah(e,{key:`${r}-${H.caseId}`,label:lp(H.comparison,C=>Me(C,de(e))),columns:y,changes:H.changes,live:_===H.caseId,forced:W(H.caseId),onForce:()=>E(H.caseId),when:dv(e,H.comparison,`${r}-${H.caseId}`,(C,M)=>l(F=>{let N=F[0]?.cases.find(Y=>Y.id===H.caseId)?.when.tests[0];N&&C(N.comparison)},M&&`${H.caseId}-${M}`)),updChanges:(C,M)=>l(F=>{let N=F[0]?.cases.find(Y=>Y.id===H.caseId);N&&C(N.then)},M&&`${H.caseId}-${M}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${x===0} @click=${()=>l(C=>nl(C,x,x-1))}>${V("up")}</button>
      <button class="icon" title="Move down" ?disabled=${x===n.rows.length-1} @click=${()=>l(C=>nl(C,x,x+1))}>${V("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(C=>rp(C,H.caseId))}>${V("delete")}</button>`})),ee=n.otherwise===void 0?g:ah(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:_==="otherwise",forced:W("otherwise"),onForce:()=>E("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(H,x)=>l(C=>{let M=C[0]?.otherwise;M&&H(M)},x),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(H=>il(H,!1))}>${V("close")}</button>`}),R=jr.get(r),K=rv.filter(H=>w.includes(H)&&!y.includes(H));return h`
    <div class="states">
      ${se(e,d??D(""),G,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:g}
      ${s===void 0?g:zh(s,k,de(e),L)}
          ...
          <tr>
            ...
            ${y.map(H=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${vt[H]} column`}
                @click=${x=>{jr.set(r,H),He(x.target)}}>${V("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${S.length===0?g:h`<div class="hint warn">A part ignores ${uo(S.map(H=>vt[H]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${R===void 0?g:h`<div class="hint warn confirm-row">
        Remove the ${vt[R]} column? Its ${ih(n,R)} value${ih(n,R)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${H=>{jr.delete(r),Wr.get(r)?.delete(R),He(H.target),l(x=>sp(x,R))}}>Remove</button>
      ...
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          <button class="small" title="Add a row: a value to match and what the layer looks like then" @click=${q}>${V("plus")}<span>State</span></button>
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(H=>il(H,!0))}>${V("plus")}<span>Otherwise</span></button>`:g}
          ${K.length===0?g:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${H=>{let x=H.target,C=x.value;if(x.value="",!C)return;let M=Wr.get(r)??new Set;M.add(C),Wr.set(r,M),He(x)}}>
            <option value="" selected>+ Column…</option>
            ${K.map(H=>h`<option value=${H}>${vt[H]}</option>`)}
          </select>`}
        </div>
      </div>
      ...
      <div class="states-switch">
        <button class="link" @click=${H=>{kl.add(r),He(H.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function av(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var rv=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function ih(e,n){let t=0;for(let i of e.rows)zr(i.changes,n)&&(t+=1);return e.otherwise&&zr(e.otherwise,n)&&(t+=1),t}function ov(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function ah(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{ov(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${sv(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function sv(e,n,t,i,a){let r=zr(t,n),o=lo(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${vt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Gn(Qu[n]))}),mh(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Ne[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=vt[n];return h`
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${fh}>
      ...
      ${ga.has(o)?h`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Oh(e,r,s,a)}
          <button class="link" @click=${d=>{d.target.closest("[popover]")?.hidePopover(),i(c=>{let u=c.findIndex(p=>Ne[p.kind]===n);u>=0&&c.splice(u,1)})}}>Leave ${l.toLowerCase()} unchanged</button>`:g}
    </div>`}function lv(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=mr(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${$i.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??D(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Dh.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ie(a):Me(i,de(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??g}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Me(i,de(e))}</span>`}function Ie(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function dv(e,n,t,i){let a=Vn(n.kind),r=el(n.kind),o=(s,l,d,c)=>uv(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${we(s=>i(l=>{let d=$s(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Qs.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${cv(s)}</option>`)}
    </select>
    ${a==="value"||a==="between"?o(n.value??D(""),s=>i(l=>{l.value=s},"rhs"),"rhs",r?"0":"value"):g}
    ${a==="between"?h`<span class="when-and">to</span>${o(n.upper??D(""),s=>i(l=>{l.upper=s},"upper"),"upper","100")}`:g}
  </span>`}function cv(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return vi[e]}}function uv(e,n,t,i,a,r,o){let s=lo(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${hh(e,s,o,n,t,l)}
  </span>`}var $a=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:cs,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Kh(e){return $a.find(n=>n.kind===e)??$a[0]}var Vh="#FF9F0A",ho="#8E8E93",pv=["#FF453A","#FFD60A","#34C759"],Wh=["#0A84FF","#34C759","#FF9F0A"];function hv(e){return e?.attributes?.device_class==="battery"?pv:Wh}var mv={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function fv(e){let n=e.iconName?.trim();return n?{off:n,on:n}:mv[Al(e)]??{off:"circle",on:"circle.fill"}}function gv(e){switch(Al(e)){case"lock":return{kind:"equals",value:D("locked")};case"cover":case"valve":return{kind:"equals",value:D("open")};case"media_player":return{kind:"equals",value:D("playing")};default:return{kind:"isOn"}}}function Al(e){return e.domain||e.entityId.split(".")[0]||""}function gn(e){return{...e,domain:Al(e)}}function yv(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Ci(e){return Math.round(e*1e4)/1e4}function ei(e,n,t){return Math.min(t,Math.max(n,e))}function Il(e,n,t){let i=ze[e],a=ei(Ci(n/i.width),0,1),r=ei(Ci(t/i.height),0,1);return{x:Ci((1-a)/2),y:Ci((1-r)/2),width:a,height:r,rotationDegrees:0}}function bv(e){let n=ze[e],t=ei(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:Il(e,t*1.3,t*1.3),size:t}}function xv(e){let n=ze[e],t=ei(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:Il(e,n.width*.88,t*1.7),size:t}}function vv(e){let n=ze[e],t=Math.min(n.width,n.height)*.9;return{frame:Il(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function jh(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function wv(e){let n=ze[e],t=ei(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Ci(t/n.height),rotationDegrees:0}}}function kv(e){let n=ze[e],t=ei(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Ci(ei(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function $v(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Cv(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function mn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Cv(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=_t());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function fn(e){return Ee(e)}function Ll(e,n){let t={kind:{kind:"entityState",...gn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Gh(e){let n=Gn("setIcon");return n.value=D(e),n}function Qn(e){let n=Gn("setColor");return n.value=D(e),n}function Sv(e,n){let t=qi(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...gn(e)}},a.comparison=gv(e);let r=n.on!==n.off;return i.then=r?[Gh(n.on),Qn(Vh)]:[Qn(Vh)],t.otherwise=r?[Gh(n.off),Qn(ho)]:[Qn(ho)],t}function Tv(e){let n=qi(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...gn(e)}},i.comparison={kind:"isUnavailable"};let a=Gn("setOpacity");return a.number=.35,t.then=[a],n}function Uh(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Ev(e,n,t=Wh){let i=n.max-n.min,a=Uh(n.min+i/3),r=Uh(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:D(a)},changes:[Qn(t[0])]},{comparison:{kind:"between",value:D(a),upper:D(r)},changes:[Qn(t[1])]},{comparison:{kind:"greaterThan",value:D(r)},changes:[Qn(t[2])]}];return tp(Ll(e),o)}function Mv(e,n,t){let i=fn("icon"),a=fv(n);return i.payload.symbol=D(a.off),i.payload.colorSlot.baseColorHex=ho,i.payload.rules=[Sv(n,a)],mn(e,i,t.family,bv),e.elements.push(i),dr(e,i.payload.id,{type:"toggleEntity",...gn(n)}),i.payload.id}function Rv(e,n,t){let i=fn("text");return i.payload.value=Ll(n,t.state),i.payload.rules=[Tv(n)],mn(e,i,t.family,xv),e.elements.push(i),i.payload.id}function Hv(e,n,t){let i=fn("gauge");i.payload.value=Ll(n);let a=yv(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Ev(n,a,hv(t.state))],mn(e,i,t.family,vv),e.elements.push(i),i.payload.id}function Fv(e,n,t){let i=fn("chart");return i.payload.value={kind:{kind:"entityState",...gn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",mn(e,i,t.family,jh),e.elements.push(i),i.payload.id}function Av(e,n,t){let i=fn("chart");return i.payload.value={kind:{kind:"entityState",...gn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",mn(e,i,t.family,jh),e.elements.push(i),i.payload.id}function Iv(e,n,t){let i=gn(n),a=fn("text");a.payload.value=D(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=ho,mn(e,a,t.family,kv),e.elements.push(a);let r=t.state?.attributes?.device_class,o=fn("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Jo(i.domain,typeof r=="string"?r:void 0),mn(e,o,t.family,wv),e.elements.push(o),o.payload.id}function Lv(e,n,t){let i=fn("image");return i.payload.entity=gn(n),mn(e,i,t.family,$v),e.elements.push(i),i.payload.id}function qh(e,n,t,i){switch(n){case"toggle":return Mv(e,t,i);case"status":return Rv(e,t,i);case"gauge":return Hv(e,t,i);case"chart":return Fv(e,t,i);case"history":return Av(e,t,i);case"doorHistory":return Iv(e,t,i);case"camera":return Lv(e,t,i)}}var _v=/^[a-z0-9_]+\.shared_(\d+)$/;function Yh(e){return _v.test(e)}function zv(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Jh(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function Zh(e,n){let t=new Map;for(let i of vs(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=Jh(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${zv(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function Pv(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);bs(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),xs(t,r=>ms(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function Qh(e){let n=!1;return hr(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function Nv(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function em(e,n,t=[]){let i=n==="share"?Pv(e,t):e,a=ci(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${Nv(a)}
`}function tm(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var Dv="There is nothing to read here. Paste a complication first.",Ov="This is not valid JSON. Check for a missing brace or a stray comma.",Bv="This is valid JSON but not a complication. A complication starts with { and ends with }.",Vv="This does not look like a complication.",Xh="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",Gv="00000000-0000-4000-8000-000000000000";function Uv(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function nm(e,n){let t=e.trim();if(t==="")return{ok:!1,error:Dv};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:Ov}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:Bv};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${Xh}`};let o={...a,id:Gv,slotIndex:0},s;try{s=di(o)}catch(d){let c=d instanceof it||d instanceof Error?d.message:String(d);return{ok:!1,error:`${Vv}

${Uv(c)}`}}let l=or(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${Xh}`}}return{ok:!0,config:s,raw:i}}function _l(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=vs(e,(o,s)=>Yh(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Yh(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Jh(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function im(e,n){let t=structuredClone(e);bs(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return xs(t,a=>ms(a,i)),t}function am(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function Kv(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function rm(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=Mr(e);return i.length===0?t:`${t}, ${Kv(i)}`}function zl(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var jv=3e4,qv=500,Yv=3e4,om="preset-entity";function sm(e){return`import-entity-${e}`}var Xv={entityId:"",displayName:"",domain:""},Jv=new Map,Zv={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Pl(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Qv(e){return e.kind==="family"?"look":"content"}function Nl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function lm(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function ew(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var dm=300,cm=360,Bl=44,Vl=22,bm=[1,1.7,2.6],tw=["S","M","L"],um=["Small","Medium","Large"];function nw(){return bm.map((e,n)=>{let t=Math.round(Bl*e),i=Math.round(Vl*e),a=`.layers-card.s${n}`;return`
  ...
  `}firstUpdated(t){super.firstUpdated(t),this.renderRoot.addEventListener("change",i=>{let a=i.target;a?.tagName==="SELECT"&&a.blur()})}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.loadGrid(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("blur",this.blurHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(no,this.scrubStart),this.addEventListener(io,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Yv)}loadColumnWidths(){try{let t=window.localStorage.getItem(mm);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Dl(i.left)),typeof i.right=="number"&&(this.colRight=Dl(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(mm,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadGrid(){try{let t=window.localStorage.getItem(hm);if(!t)return;let i=JSON.parse(t);typeof i.on=="boolean"&&(this.snapGrid=i.on),Hs.includes(i.step)&&(this.gridStep=i.step),typeof i.lines=="boolean"&&(this.showGridLines=i.lines)}catch{}}setGrid(t,i,a=this.showGridLines){this.snapGrid=t,this.gridStep=i,this.showGridLines=a;try{window.localStorage.setItem(hm,JSON.stringify({on:t,step:i,lines:a}))}catch{}}snapTarget(t){return{snap:{step:gi(this.gridStep,pe[t]),on:this.snapGrid}}}loadListView(){try{let t=window.localStorage.getItem(pm);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(pm,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Sh(s,o,i))}>Copy the ${ne(o)} layout</button>`)}
          </div>
      ...
      ${this.openMenu==="grid"?h`<div class="pop-menu" role="listbox" aria-label="Grid size">
        ${Hs.map(o=>h`<button class="row" role="option" aria-selected=${o===this.gridStep?"true":"false"}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?hs(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){let a=this.renderRoot,r="activeElement"in a?a.activeElement:null;if(r&&typeof r.blur=="function"&&!i.currentTarget?.contains(r)&&r.blur(),this.picking){i.preventDefault(),this.pickAt(t,i);return}let o=i.target,s=o.closest("[data-handle]")?.getAttribute("data-handle"),l=o.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,d=o.closest("svg.complication");if(this.showTaps){let R=this.focusTapId();if(R!==void 0&&l===R&&d&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,d,R,s??void 0);return}let K=this.hitLayerId(i);K?this.inspect={kind:"layer",id:K}:l===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=fm(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!l||!d)return;let u=hs(this.draft.config,l),p=this.draft.config.elements.find(R=>R.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m,f=this.inspect.kind==="layer"?this.inspect.id:void 0;if(f!==void 0&&f!==u&&!s){let R=this.draft.config.elements.find(H=>H.payload.id===f);R!==void 0&&R.kind!=="chartDots"&&R.kind!=="chartGrid"&&R.payload.chartAnchor?.place!=="through"&&dt(this.draft.config,f)?.locked!==!0&&ow(d,f,i)&&(m=u,u=f,p=R)}let y=dt(this.draft.config,u),b=y!==void 0&&this.inspect.kind==="group"&&this.inspect.id===y.id;if(y&&(y.locked||b)&&!s){let R=b||this.inspect.kind==="layer"&&dt(this.draft.config,this.inspect.id)?.id===y.id;this.beginGroupGesture(t,i,d,y,R?u:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},s)||p.payload.chartAnchor?.place==="through")return;i.preventDefault();let k=Le(this.draft.config,t,p).frame,$=this.gestureCanvas(t),w=p.payload.chartAnchor,S=w!==void 0&&!gt(w.at)&&w.place!=="through",L=w!==void 0&&gt(w.at)&&w.place==="through",_=pe[t],A={dx:w?.dx??0,dy:w?.dy??0},W=w!==void 0&&!s?fi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(R=>R.id===u)?.frame:void 0,E=W??k,G=R=>Math.round(R*10)/10;this.cancelGesture?.();let q=!1,U=s!==null?fi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(R=>R.id===u):void 0;if(s!==null&&U?.kind==="icon"){let R=Us(U)/2,K=U.size;this.cancelGesture=cu(d,i,s,{w:R,h:R},(H,x)=>{this.mutate(C=>{ke(C,t,u,{size:Math.max(1,Math.round(K*H))})},`drag-${u}-${t}`),x&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let ee=U!==void 0?Iu(U,E,$):{};this.cancelGesture=kr(d,$,i,{elementId:u,frame:E,handle:s??void 0,...ee,...w===void 0?this.snapTarget(t):{}},{onFrame:(R,K,H)=>{if(H||(q=!0),H&&!q&&m!==void 0){this.inspect={kind:"layer",id:m},this.cancelGesture=void 0;return}this.mutate(x=>{if(w===void 0){ke(x,t,R,{frame:K});return}let C=W?{width:k.width,height:k.height}:{width:K.width,height:K.height};ke(x,t,R,{frame:{...K,...C,x:S?K.x:k.x,y:k.y}});let M=x.elements.find(Y=>Y.payload.id===R)?.payload.chartAnchor;if(M===void 0)return;let F=A.dx,N=L?A.dy:G(A.dy+(K.y-E.y)*_.height);F?M.dx=F:delete M.dx,N?M.dy=N:delete M.dy},`drag-${R}-${t}`),H&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=Lt(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map($=>[$.payload.id,Le(s,t,$).frame])),c=[...d.values()],u=Math.min(...c.map($=>$.x)),p=Math.min(...c.map($=>$.y)),m=Math.max(...c.map($=>$.x+$.width)),f=Math.max(...c.map($=>$.y+$.height)),y={x:u,y:p,width:m-u,height:f-p,rotationDegrees:0},b=$=>Math.round($*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=kr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y,...this.snapTarget(t)},{onFrame:($,w,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let L=w.x-y.x,_=w.y-y.y;this.mutate(A=>{for(let[W,E]of d)ke(A,t,W,{frame:{...E,x:b(E.x+L),y:b(E.y+_)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?du:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(Lt(r,k).map($=>$.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=dt(r,u);if(m?.locked)return this.nudgeMany(Lt(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let f=Le(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let k=!gt(y.at);return l===0&&!(k&&s!==0)||this.mutate($=>{k&&s!==0&&ke($,d,u,{frame:wr(f,s,0,c)});let w=$.elements.find(L=>L.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let S=Math.round(((w.dy??0)+l)*10)/10;S?w.dy=S:delete w.dy},`nudge-${u}-${d}`),!0}let b=this.snapGrid?Is(f,s,l,gi(this.gridStep,c)):wr(f,s,l,c);return(b.x!==f.x||b.y!==f.y)&&this.mutate(k=>ke(k,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let L=l.elements.find(_=>_.payload.id===S);L&&c.set(S,Le(l,i,L).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),f=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),b={x:p,y:m,width:f-p,height:y-m,rotationDegrees:0},k=this.snapGrid?Is(b,o,s,gi(this.gridStep,a)):wr(b,o,s,a),$=k.x-b.x,w=k.y-b.y;return($!==0||w!==0)&&this.mutate(S=>{for(let[L,_]of c)ke(S,i,L,{frame:{..._,x:d(_.x+$),y:d(_.y+w)}})},r),!0}gestureCanvas(t){let i=Sr(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=js(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:We(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ve(s,l),c=Le(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=kr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o,...this.snapTarget(t)},{onFrame:(u,p,m)=>{this.mutate(f=>{d?Rc(f,u,t,p):ke(f,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:gm(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
    ...
    </div>`}pickerRows(){let t=this.records.map(a=>({slot:Number(a.document?.slotIndex??0),kind:"record",record:a}));return[...t,...Wd(t.map(a=>a.slot),this.occupied).map(a=>a.kind==="custom"?{slot:a.slot,kind:"locked",name:a.name||"Unnamed complication",badge:a.home||"Other home",title:`A complication on ${a.home?`the ${a.home} home`:"another home"}${a.families?.length?` (${a.families.map(ne).join(", ")})`:""}. Edit it in that home's Wrist Assistant panel.`,families:a.families??[]}:{slot:a.slot,kind:"locked",name:a.name||"Unnamed preset",badge:"iPhone",title:"Still on the iPhone. Open the Wrist Assistant app on the iPhone to move it here.",families:[]})].sort((a,r)=>a.slot-r.slot)}shapeDots(t){return h`<span class="shape-dots">${sn.map(i=>h`<span class="shape-dot ${i} ${t.includes(i)?"on":""}" title=${ne(i)}></span>`)}</span>`}static{this.FILTER_FROM_ROWS=8}recordPreview(t){let i=this.recordPreviews.get(t.id);if(i&&i.revision===t.revision)return i;try{let a=di(t.document),r={revision:t.revision,config:a,entities:[...gr(a).entities.values()]};return this.recordPreviews.set(t.id,r),r}catch{this.recordPreviews.delete(t.id);return}}renderRowArt(t){let i=this.recordPreview(t);if(!i)return h`<span class="pk-art"></span>`;let a=i.config,o=(this.pickerFilter!=="all"&&a.supportedFamilies.includes(this.pickerFilter)?this.pickerFilter:void 0)??qs(a)??"inline",s=new Map;for(let c of i.entities){let u=this.entityStateFor(c.entityId,c.iconName??"",!1);u&&s.set(c.entityId,u)}let l=fi(a,{entityStates:s,templateResults:new Map,namedValues:a.values});if(o==="inline")return h`<span class="pk-art inline">${this.renderInlinePreview(l.inline,!0)}</span>`;let d=l[o];return d?h`<span class="pk-art ${o}">${Er(d,{icons:this.icons,imageSizes:this.imageSizes,slot:bi.slots[o]})}</span>`:h`<span class="pk-art"></span>`}renderPickerFilter(t){let i=r=>r.kind==="record"?Nl(r.record):r.families,a=(r,o,s)=>h`<button
      ...
      ${a("all","All",t.length)}
      ${sn.map(r=>a(r,ne(r),t.filter(o=>i(o).includes(r)).length))}
    </div>`}renderPicker(){let t=this.draft,i=this.records.find(d=>d.id===this.selectedId),a=t?t.config.name.trim()||"Untitled":"No complication",r=t?t.config.supportedFamilies:[],o=this.pickerRows(),s=this.pickerFilter,l=s==="all"?o:o.filter(d=>(d.kind==="record"?Nl(d.record):d.families).includes(s));return h`<div class="picker">
      ...
      ${this.pickerOpen?h`<div class="menu" role="listbox">
        ${o.length>=z.FILTER_FROM_ROWS?this.renderPickerFilter(o):g}
        ${o.length===0&&!(t&&t.baseRevision===null)?h`<div class="empty">No complications for this watch yet.</div>`:g}
        ${o.length>0&&l.length===0?h`<div class="empty">Nothing on this watch has a ${s==="all"?"":ne(s)} shape.</div>`:g}
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=tm(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?_l(i,this.hass.states):[],r=zl({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${kt({hass:this.hass},t.label,i??Xv,a=>this.setImportEntity(t.entityId,a),sm(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?g:h`<span class="mini">${Ys.length} kinds · ${$a.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Ys.map(s=>h`<button class="add" style=${`--k:${Xe[s]}`} ?disabled=${i} title=${`Add a blank ${ln[s].toLowerCase()} layer`}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Te(E,d)}</b>
          <small><span class="kind">${ln[E.kind]}</span> · ${uw(E,c,this.historySeries,R.size)}</small>
          ${S?h`<span class="facts">${dw(this.host(),a,E,R).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:g}
        </span>
        <span class="right">
          <span class="badges">
            ${H?h`<span class="badge tap" title=${`Tappable \xB7 ${Te(H,d)}`}>tap</span>`:g}
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${R.isHidden?"Show":"Hide"} (${Ol}${yn}H)`} aria-label=${R.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(N=>ke(N,a,U,{isHidden:!R.isHidden}))}}>${V(R.isHidden?"hide":"show")}</button>
      ...
      </div>`},_=(E,G)=>{let q=this.inspect.kind==="group"&&this.inspect.id===E.id,U=!this.collapsed.has(E.id),ee=this.rowDrag(E.id,i),R=G[0],K=G[G.length-1],H=C=>{let M=C.currentTarget,F=M.getBoundingClientRect(),N=F.top+(M.classList.contains("drop-before")?Ot:0),Y=F.bottom-(M.classList.contains("drop-after")?Ot:0),te=(C.clientY-N)/Math.max(1,Y-N);return te<.25?"drop-before":!U&&te>.75?"drop-after":"drop-into"},x=G.map(C=>C.payload.id);return h`<div class="layer group ${q?"hl":""} ${S?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${ee.draggable}
        ...
        @dragover=${C=>{!this.dragId||this.dragId===E.id||(C.preventDefault(),this.markDrop(C.currentTarget,H(C)))}}
        @drop=${C=>{C.preventDefault();let M=H(C);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!R||!K)){if(M==="drop-before"){this.reorderLayer(F,R.payload.id,!0,!0);return}if(M==="drop-after"){this.reorderLayer(F,K.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,R.payload.id,!0),this.mutate(N=>Ki(N,F,E.id)))}}}>
        ...
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Ol}${yn}G)`} aria-label="Ungroup" @click=${C=>{C.stopPropagation(),this.mutate(M=>Ui(M,E.id)),q&&(this.inspect={kind:"general"})}}>${V("ungroup")}</button>
          </span>`:g}
          <button class="icon lockbtn ${E.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${C=>{C.stopPropagation(),this.mutate(M=>{let F=M.groups?.find(N=>N.id===E.id);F&&(F.locked=!F.locked)})}}>${V(E.locked?"lock":"unlock")}</button>
      ...
      </div>`},A=[],W=new Set;for(let E=0;E<l.length;E++){let G=l[E],q=G.payload.groupId,U=q===void 0?void 0:t.groups?.find(K=>K.id===q);if(!U){A.push(L(G,!1));continue}if(W.has(U.id))continue;W.add(U.id);let ee=l.filter(K=>K.payload.groupId===U.id);A.push(_(U,ee));let R=this.inspect.kind==="group"&&this.inspect.id===U.id;this.collapsed.has(U.id)||A.push(h`<div class="group-kids">${ee.map(K=>L(K,!0,R))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${$}px`}>
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${Q.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${E=>{E.preventDefault(),this.clearDragMarks();let G=this.dragId,q=[...l].reverse().find(U=>U.payload.id!==G&&U.payload.groupId!==G);G&&q&&this.reorderLayer(G,q.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=qh(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=fi(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?mi((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??g}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return g;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Ch();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:g,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${V("content")}</span>Shared values
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ${i.map(o=>{let s=this.hass.states[o],l=typeof s?.attributes.friendly_name=="string"?s.attributes.friendly_name:o,d=typeof s?.attributes.unit_of_measurement=="string"?` ${s.attributes.unit_of_measurement}`:"",c=s?`${s.state}${d}`:"not in Home Assistant",u=this.testValues.get(o),m=t.elements.find(f=>ur(t,f.payload.id).some(y=>y.ref.entityId===o))?.kind??"text";return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${Xe[m]}`}
        ...
        ${a.map(o=>{let s=Cs(o.id),l=this.sharedRaw(o.id)??"",d=l===""?"empty":l,c=o.name||"(unnamed)",u=this.testValues.get(s),p={entity_id:s,state:l,attributes:{},last_changed:"",last_updated:""};return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${Q.complication}`}
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([Qv(r)]):new Set($l)}}>${d?"One at a time":"Open all"}</button>`:g}
      </div>
    ...
    </details>`}};P([ri({attribute:!1})],z.prototype,"hass",2),P([ri({type:Boolean})],z.prototype,"narrow",2),P([ri({attribute:!1})],z.prototype,"panel",2),P([O()],z.prototype,"colLeft",2),P([O()],z.prototype,"colRight",2),P([O()],z.prototype,"panelWidth",2),P([O()],z.prototype,"owners",2),P([O()],z.prototype,"ownerId",2),P([O()],z.prototype,"records",2),P([O()],z.prototype,"selectedId",2),P([O()],z.prototype,"draft",2),P([O()],z.prototype,"readOnlyReason",2),P([O()],z.prototype,"parseError",2),P([O()],z.prototype,"maxSchemaVersion",2),P([O()],z.prototype,"presets",2),P([O()],z.prototype,"occupied",2),P([O()],z.prototype,"serverToken",2),P([O()],z.prototype,"appliedToken",2),P([O()],z.prototype,"sendStatusKnown",2),P([O()],z.prototype,"polling",2),P([O()],z.prototype,"lastPollSeconds",2),P([O()],z.prototype,"sendPending",2),P([O()],z.prototype,"pages",2),P([O()],z.prototype,"templateResults",2),P([O()],z.prototype,"historySeries",2),P([O()],z.prototype,"historyReadings",2),P([O()],z.prototype,"templateError",2),P([O()],z.prototype,"templateFetchedAt",2),P([O()],z.prototype,"forced",2),P([O()],z.prototype,"showRaw",2),P([O()],z.prototype,"inspect",2),P([O()],z.prototype,"openSections",2),P([O()],z.prototype,"helpSections",2),P([O()],z.prototype,"pickerOpen",2),P([O()],z.prototype,"pickerFilter",2),P([O()],z.prototype,"pickerNote",2),P([O()],z.prototype,"openValue",2),P([O()],z.prototype,"sharedHelp",2),P([O()],z.prototype,"editingValue",2),P([O()],z.prototype,"thumbStep",2),P([O()],z.prototype,"layerDetail",2),P([O()],z.prototype,"addOpen",2),P([O()],z.prototype,"addDetail",2),P([O()],z.prototype,"multi",2),P([O()],z.prototype,"copiedPosition",2),P([O()],z.prototype,"snapGrid",2),P([O()],z.prototype,"gridStep",2),P([O()],z.prototype,"showGridLines",2),P([O()],z.prototype,"openMenu",2),P([O()],z.prototype,"altHeld",2),P([O()],z.prototype,"collapsed",2),P([O()],z.prototype,"activeFamily",2),P([O()],z.prototype,"picking",2),P([O()],z.prototype,"pickHoverId",2),P([O()],z.prototype,"listHoverIds",2),P([O()],z.prototype,"rowHoverId",2),P([O()],z.prototype,"zoomed",2),P([O()],z.prototype,"helpOpen",2),P([O()],z.prototype,"showTaps",2),P([O()],z.prototype,"savedName",2),P([O()],z.prototype,"presetKind",2),P([O()],z.prototype,"presetEntity",2),P([O()],z.prototype,"newOpen",2),P([O()],z.prototype,"newName",2),P([O()],z.prototype,"newFamily",2),P([O()],z.prototype,"shareOpen",2),P([O()],z.prototype,"shareMode",2),P([O()],z.prototype,"shareLabels",2),P([O()],z.prototype,"shareNote",2),P([O()],z.prototype,"importOpen",2),P([O()],z.prototype,"importText",2),P([O()],z.prototype,"importParse",2),P([O()],z.prototype,"importName",2),P([O()],z.prototype,"importMap",2),P([O()],z.prototype,"previewCase",2),P([O()],z.prototype,"loadError",2),P([O()],z.prototype,"saveError",2),P([O()],z.prototype,"saving",2),P([O()],z.prototype,"conflict",2),P([O()],z.prototype,"remoteRevision",2),P([O()],z.prototype,"confirmDelete",2),P([O()],z.prototype,"moveTarget",2),P([O()],z.prototype,"moving",2),P([O()],z.prototype,"moveError",2),P([O()],z.prototype,"version",2);var Gl=z;function Bt(e){return String(e?.message??e)}function lw(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function ym(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function dw(e,n,t,i){let a=[{label:"Shows",value:El(e,t)}],r=Qr(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function cw(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function uw(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ie(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=In(e.payload)??Ln(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${qe(o).length} values`}case"timeline":{let r=yt(e.payload),o=r===void 0?[]:Zi(t.get(r)??""),s=Math.max(0,o.length-1);return`${cw(lt(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ie(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return e.payload.contentMode==="fill"?"fill":"fit";case"tap":return At(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`;case"imageTime":return}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Gl);export{Gl as WristAssistantPanel,gm as columnFit,dw as layerFacts};
