var Qp=Object.defineProperty;var eh=Object.getOwnPropertyDescriptor;var D=(e,n,t,i)=>{for(var a=i>1?void 0:i?eh(n,t):n,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(n,t,a):o(a))||a);return i&&a&&Qp(n,t,a),a};var na=globalThis,ia=na.ShadowRoot&&(na.ShadyCSS===void 0||na.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Tr=Symbol(),al=new WeakMap,si=class{constructor(n,t,i){if(this._$cssResult$=!0,i!==Tr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=n,this.t=t}get styleSheet(){let n=this.o,t=this.t;if(ia&&n===void 0){let i=t!==void 0&&t.length===1;i&&(n=al.get(t)),n===void 0&&((this.o=n=new CSSStyleSheet).replaceSync(this.cssText),i&&al.set(t,n))}return n}toString(){return this.cssText}},ke=e=>new si(typeof e=="string"?e:e+"",void 0,Tr),Er=(e,...n)=>{let t=e.length===1?e[0]:n.reduce((i,a,r)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[r+1],e[0]);return new si(t,e,Tr)},rl=(e,n)=>{if(ia)e.adoptedStyleSheets=n.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of n){let i=document.createElement("style"),a=na.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,e.appendChild(i)}},Mr=ia?e=>e:e=>e instanceof CSSStyleSheet?(n=>{let t="";for(let i of n.cssRules)t+=i.cssText;return ke(t)})(e):e;var{is:th,defineProperty:nh,getOwnPropertyDescriptor:ih,getOwnPropertyNames:ah,getOwnPropertySymbols:rh,getPrototypeOf:oh}=Object,aa=globalThis,ol=aa.trustedTypes,sh=ol?ol.emptyScript:"",lh=aa.reactiveElementPolyfillSupport,li=(e,n)=>e,di={toAttribute(e,n){switch(n){case Boolean:e=e?sh:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,n){let t=e;switch(n){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch{t=null}}return t}},ra=(e,n)=>!th(e,n),sl={attribute:!0,type:String,converter:di,reflect:!1,useDefault:!1,hasChanged:ra};Symbol.metadata??=Symbol("metadata"),aa.litPropertyMetadata??=new WeakMap;var ht=class extends HTMLElement{static addInitializer(n){this._$Ei(),(this.l??=[]).push(n)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(n,t=sl){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(n)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(n,t),!t.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(n,i,t);a!==void 0&&nh(this.prototype,n,a)}}static getPropertyDescriptor(n,t,i){let{get:a,set:r}=ih(this.prototype,n)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(n,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(n){return this.elementProperties.get(n)??sl}static _$Ei(){if(this.hasOwnProperty(li("elementProperties")))return;let n=oh(this);n.finalize(),n.l!==void 0&&(this.l=[...n.l]),this.elementProperties=new Map(n.elementProperties)}static finalize(){if(this.hasOwnProperty(li("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(li("properties"))){let t=this.properties,i=[...ah(t),...rh(t)];for(let a of i)this.createProperty(a,t[a])}let n=this[Symbol.metadata];if(n!==null){let t=litPropertyMetadata.get(n);if(t!==void 0)for(let[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(n){let t=[];if(Array.isArray(n)){let i=new Set(n.flat(1/0).reverse());for(let a of i)t.unshift(Mr(a))}else n!==void 0&&t.push(Mr(n));return t}static _$Eu(n,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof n=="string"?n.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(n=>n(this))}addController(n){(this._$EO??=new Set).add(n),this.renderRoot!==void 0&&this.isConnected&&n.hostConnected?.()}removeController(n){this._$EO?.delete(n)}_$E_(){let n=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(n.set(i,this[i]),delete this[i]);n.size>0&&(this._$Ep=n)}createRenderRoot(){let n=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return rl(n,this.constructor.elementStyles),n}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(n=>n.hostConnected?.())}enableUpdating(n){}disconnectedCallback(){this._$EO?.forEach(n=>n.hostDisconnected?.())}attributeChangedCallback(n,t,i){this._$AK(n,i)}_$ET(n,t){let i=this.constructor.elementProperties.get(n),a=this.constructor._$Eu(n,i);if(a!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:di).toAttribute(t,i.type);this._$Em=n,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(n,t){let i=this.constructor,a=i._$Eh.get(n);if(a!==void 0&&this._$Em!==a){let r=i.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:di;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(n,t,i,a=!1,r){if(n!==void 0){let o=this.constructor;if(a===!1&&(r=this[n]),i??=o.getPropertyOptions(n),!((i.hasChanged??ra)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(n)&&!this.hasAttribute(o._$Eu(n,i))))return;this.C(n,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(n,t,{useDefault:i,reflect:a,wrapped:r},o){i&&!(this._$Ej??=new Map).has(n)&&(this._$Ej.set(n,o??t??this[n]),r!==!0||o!==void 0)||(this._$AL.has(n)||(this.hasUpdated||i||(t=void 0),this._$AL.set(n,t)),a===!0&&this._$Em!==n&&(this._$Eq??=new Set).add(n))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let n=this.scheduleUpdate();return n!=null&&await n,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,r]of i){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let n=!1,t=this._$AL;try{n=this.shouldUpdate(t),n?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw n=!1,this._$EM(),i}n&&this._$AE(t)}willUpdate(n){}_$AE(n){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(n)),this.updated(n)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(n){return!0}update(n){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(n){}firstUpdated(n){}};ht.elementStyles=[],ht.shadowRootOptions={mode:"open"},ht[li("elementProperties")]=new Map,ht[li("finalized")]=new Map,lh?.({ReactiveElement:ht}),(aa.reactiveElementVersions??=[]).push("2.1.2");var _r=globalThis,ll=e=>e,oa=_r.trustedTypes,dl=oa?oa.createPolicy("lit-html",{createHTML:e=>e}):void 0,fl="$lit$",Mt=`lit$${Math.random().toFixed(9).slice(2)}$`,gl="?"+Mt,dh=`<${gl}>`,en=document,ui=()=>en.createComment(""),pi=e=>e===null||typeof e!="object"&&typeof e!="function",zr=Array.isArray,ch=e=>zr(e)||typeof e?.[Symbol.iterator]=="function",Rr=`[ 	
\f\r]`,ci=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,cl=/-->/g,ul=/>/g,Zt=RegExp(`>|${Rr}(?:([^\\s"'>=/]+)(${Rr}*=${Rr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),pl=/'/g,hl=/"/g,yl=/^(?:script|style|textarea|title)$/i,Nr=e=>(n,...t)=>({_$litType$:e,strings:n,values:t}),h=Nr(1),v=Nr(2),vx=Nr(3),tn=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),ml=new WeakMap,Qt=en.createTreeWalker(en,129);function bl(e,n){if(!zr(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return dl!==void 0?dl.createHTML(n):n}var uh=(e,n)=>{let t=e.length-1,i=[],a,r=n===2?"<svg>":n===3?"<math>":"",o=ci;for(let s=0;s<t;s++){let l=e[s],d,c,u=-1,p=0;for(;p<l.length&&(o.lastIndex=p,c=o.exec(l),c!==null);)p=o.lastIndex,o===ci?c[1]==="!--"?o=cl:c[1]!==void 0?o=ul:c[2]!==void 0?(yl.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=Zt):c[3]!==void 0&&(o=Zt):o===Zt?c[0]===">"?(o=a??ci,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?Zt:c[3]==='"'?hl:pl):o===hl||o===pl?o=Zt:o===cl||o===ul?o=ci:(o=Zt,a=void 0);let m=o===Zt&&e[s+1].startsWith("/>")?" ":"";r+=o===ci?l+dh:u>=0?(i.push(d),l.slice(0,u)+fl+l.slice(u)+Mt+m):l+Mt+(u===-2?s:m)}return[bl(e,r+(e[t]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),i]},hi=class e{constructor({strings:n,_$litType$:t},i){let a;this.parts=[];let r=0,o=0,s=n.length-1,l=this.parts,[d,c]=uh(n,t);if(this.el=e.createElement(d,i),Qt.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=Qt.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(fl)){let p=c[o++],m=a.getAttribute(u).split(Mt),b=/([.?@])?(.*)/.exec(p);l.push({type:1,index:r,name:b[2],strings:m,ctor:b[1]==="."?Ar:b[1]==="?"?Ir:b[1]==="@"?Hr:_n}),a.removeAttribute(u)}else u.startsWith(Mt)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(yl.test(a.tagName)){let u=a.textContent.split(Mt),p=u.length-1;if(p>0){a.textContent=oa?oa.emptyScript:"";for(let m=0;m<p;m++)a.append(u[m],ui()),Qt.nextNode(),l.push({type:2,index:++r});a.append(u[p],ui())}}}else if(a.nodeType===8)if(a.data===gl)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(Mt,u+1))!==-1;)l.push({type:7,index:r}),u+=Mt.length-1}r++}}static createElement(n,t){let i=en.createElement("template");return i.innerHTML=n,i}};function Ln(e,n,t=e,i){if(n===tn)return n;let a=i!==void 0?t._$Co?.[i]:t._$Cl,r=pi(n)?void 0:n._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(e),a._$AT(e,t,i)),i!==void 0?(t._$Co??=[])[i]=a:t._$Cl=a),a!==void 0&&(n=Ln(e,a._$AS(e,n.values),a,i)),n}var Fr=class{constructor(n,t){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:t},parts:i}=this._$AD,a=(n?.creationScope??en).importNode(t,!0);Qt.currentNode=a;let r=Qt.nextNode(),o=0,s=0,l=i[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new mi(r,r.nextSibling,this,n):l.type===1?d=new l.ctor(r,l.name,l.strings,this,n):l.type===6&&(d=new Lr(r,this,n)),this._$AV.push(d),l=i[++s]}o!==l?.index&&(r=Qt.nextNode(),o++)}return Qt.currentNode=en,a}p(n){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(n,i,t),t+=i.strings.length-2):i._$AI(n[t])),t++}},mi=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,t,i,a){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=n,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,t=this._$AM;return t!==void 0&&n?.nodeType===11&&(n=t.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,t=this){n=Ln(this,n,t),pi(n)?n===f||n==null||n===""?(this._$AH!==f&&this._$AR(),this._$AH=f):n!==this._$AH&&n!==tn&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):ch(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==f&&pi(this._$AH)?this._$AA.nextSibling.data=n:this.T(en.createTextNode(n)),this._$AH=n}$(n){let{values:t,_$litType$:i}=n,a=typeof i=="number"?this._$AC(n):(i.el===void 0&&(i.el=hi.createElement(bl(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Fr(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(n){let t=ml.get(n.strings);return t===void 0&&ml.set(n.strings,t=new hi(n)),t}k(n){zr(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,a=0;for(let r of n)a===t.length?t.push(i=new e(this.O(ui()),this.O(ui()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(n=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);n!==this._$AB;){let i=ll(n).nextSibling;ll(n).remove(),n=i}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},_n=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,t,i,a,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=n,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}_$AI(n,t=this,i,a){let r=this.strings,o=!1;if(r===void 0)n=Ln(this,n,t,0),o=!pi(n)||n!==this._$AH&&n!==tn,o&&(this._$AH=n);else{let s=n,l,d;for(n=r[0],l=0;l<r.length-1;l++)d=Ln(this,s[i+l],t,l),d===tn&&(d=this._$AH[l]),o||=!pi(d)||d!==this._$AH[l],d===f?n=f:n!==f&&(n+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(n)}j(n){n===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},Ar=class extends _n{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===f?void 0:n}},Ir=class extends _n{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==f)}},Hr=class extends _n{constructor(n,t,i,a,r){super(n,t,i,a,r),this.type=5}_$AI(n,t=this){if((n=Ln(this,n,t,0)??f)===tn)return;let i=this._$AH,a=n===f&&i!==f||n.capture!==i.capture||n.once!==i.once||n.passive!==i.passive,r=n!==f&&(i===f||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},Lr=class{constructor(n,t,i){this.element=n,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(n){Ln(this,n)}};var ph=_r.litHtmlPolyfillSupport;ph?.(hi,mi),(_r.litHtmlVersions??=[]).push("3.3.3");var xl=(e,n,t)=>{let i=t?.renderBefore??n,a=i._$litPart$;if(a===void 0){let r=t?.renderBefore??null;i._$litPart$=a=new mi(n.insertBefore(ui(),r),r,void 0,t??{})}return a._$AI(e),a};var Pr=globalThis,Rt=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=xl(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return tn}};Rt._$litElement$=!0,Rt.finalized=!0,Pr.litElementHydrateSupport?.({LitElement:Rt});var hh=Pr.litElementPolyfillSupport;hh?.({LitElement:Rt});(Pr.litElementVersions??=[]).push("4.2.2");var mh={attribute:!0,type:String,converter:di,reflect:!1,hasChanged:ra},fh=(e=mh,n,t)=>{let{kind:i,metadata:a}=t,r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(t.name,e),i==="accessor"){let{name:o}=t;return{set(s){let l=n.get.call(this);n.set.call(this,s),this.requestUpdate(o,l,e,!0,s)},init(s){return s!==void 0&&this.C(o,void 0,e,s),s}}}if(i==="setter"){let{name:o}=t;return function(s){let l=this[o];n.call(this,s),this.requestUpdate(o,l,e,!0,s)}}throw Error("Unsupported decorator location: "+i)};function zn(e){return(n,t)=>typeof t=="object"?fh(e,n,t):((i,a,r)=>{let o=a.hasOwnProperty(r);return a.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(a,r):void 0})(e,n,t)}function V(e){return zn({...e,state:!0,attribute:!1})}var Je="wrist_assistant/complications";async function vl(e){return e.connection.sendMessagePromise({type:`${Je}/owners`})}async function wl(e,n){return e.connection.sendMessagePromise({type:`${Je}/list`,owner_watch_id:n})}async function kl(e,n){return e.connection.sendMessagePromise({type:`${Je}/nudge`,owner_watch_id:n})}async function $l(e,n){return e.connection.sendMessagePromise({type:`${Je}/watch_status`,owner_watch_id:n})}async function Cl(e,n,t,i){return e.connection.sendMessagePromise({type:`${Je}/save`,owner_watch_id:n,document:t,base_revision:i})}async function Sl(e,n,t,i){return e.connection.sendMessagePromise({type:`${Je}/delete`,owner_watch_id:n,complication_id:t,base_revision:i})}async function Tl(e,n,t){return e.connection.sendMessagePromise({type:`${Je}/move_owner`,source_owner_watch_id:n,target_owner_watch_id:t})}function El(e,n,t){let i={type:`${Je}/subscribe`};return n&&(i.owner_watch_id=n),e.connection.subscribeMessage(t,i)}async function Ml(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${Je}/render_values`,templates:n})).results}async function Rl(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${Je}/history_series`,requests:n})).results}function Fl(e){return{entity_id:e.entityId,minutes:e.minutes,points:e.points,...e.mode==="states"?{mode:"states"}:{},...e.gaps?{gaps:!0}:{}}}function Al(e){return{entity_id:e.entityId,minutes:e.minutes,period:e.period,type:e.type,...e.gaps?{gaps:!0}:{}}}function Il(e){let n=new Map,t=new Map;for(let[i,a]of Object.entries(e))a.ok&&(n.set(i,a.series),typeof a.readings=="number"&&t.set(i,{readings:a.readings,averaged:a.averaged===!0}));return{series:n,readings:t}}async function Hl(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${Je}/statistics_series`,requests:n})).results}var re=["rectangular","circular","corner"],pe={rectangular:{width:181,height:65.5},circular:{width:51,height:51},corner:{width:34,height:34}},gi=["rectangular","circular","corner","inline"];var Kr=64;function Yl(e,n){let t=new Set(e);for(let i of n)t.add(i.slot);for(let i=0;i<Kr;i++)if(!t.has(i))return i;return-1}function Xl(e,n){let t=new Set(e);return n.filter(i=>i.kind!=="preset"||!t.has(i.slot))}function sn(e){return re.some(t=>!e.supportedFamilies.includes(t))||e.supportedFamilies.includes("inline")||e.inline!==void 0?6:e.slotIndex>7?5:4}var gh=["none","dot","triangle"],yh=["straight","smooth","step"],bh=["light","medium","strong"],xh={light:.05,medium:.1,strong:.2};function Ll(e){return typeof e=="string"&&yh.includes(e)?e:"straight"}var vh=["flat","fade"],wh=["none","all","auto"],Jl=4,ln="#FFFFFF33";function _t(e){return typeof e=="string"&&vh.includes(e)?e:"flat"}function Gr(e){return typeof e=="string"&&wh.includes(e)?e:"none"}function Ur(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(Jl,Math.round(e)))}function Zl(e,n){return e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function It(e){return typeof e=="string"&&e!==""?e:ln}var kh=1,$h=12;function mt(e){if(!(typeof e!="number"||!Number.isFinite(e)))return Math.max(kh,Math.min($h,e))}function ma(e){return e==="all"?"all":"auto"}var Nn=1,Pn=3,Wr=.25,jr=4;function Dn(e){return typeof e!="number"||!Number.isFinite(e)?Pn:Math.max(1,Math.min(Jl,Math.round(e)))}function On(e){return typeof e!="number"||!Number.isFinite(e)?Nn:Math.max(Wr,Math.min(jr,e))}var Ch=["all","top"],Vn=1.2;function zt(e){return typeof e!="number"||!Number.isFinite(e)?Vn:Math.max(0,e)}function Nt(e){return typeof e=="string"&&Ch.includes(e)?e:"all"}function tt(e){if(typeof e=="string")return bh.includes(e)?e:void 0;if(e===3||e===5)return"light";if(e===7)return"medium";if(e===9)return"strong"}function Ql(e,n){if(n===void 0||e<2)return 0;let t=Math.max(3,Math.floor(e*xh[n]+.5));return t%2===0?t+1:t}var Sh=[["history","Recorded history"],["statistics","Long-term statistics"]],fa=[["5minute","5 min"],["hour","Hour"],["day","Day"],["week","Week"],["month","Month"]],qr=[["mean","Mean"],["min","Min"],["max","Max"],["change","Change"],["sum","Total"]],Yr="history",vi="hour",wi="mean",Bn=[["latest","Newest reading"],["first","First reading"],["highest","Highest reading"],["lowest","Lowest reading"],["average","Average reading"],["delta","Change"],["sum","Total"],["trend","Trend arrow"],["top","Top of the scale"],["bottom","Bottom of the scale"]],ki={x:.25,y:.25,width:.5,height:.5,rotationDegrees:0},dn=[["highest","Highest reading"],["lowest","Lowest reading"],["now","Now"],["first","First reading"],["latest","Newest reading"],["threshold","Threshold"],["zero","Zero"]];function gt(e){return e!=="threshold"&&e!=="zero"}var Xr=[["above","Above"],["on","On"],["below","Inside"],["bottom","At the bottom"],["through","Through"]];function Th(e){return dn.some(([n])=>n===e)}function Eh(e){return Xr.some(([n])=>n===e)}function Mh(e){if(!N(e)||typeof e.layer!="string"||e.layer==="")return;let n={layer:e.layer.toUpperCase(),at:Th(e.at)?e.at:"highest",place:Eh(e.place)?e.place:"above"},t=Y(e.dx,0),i=Y(e.dy,0);return t!==0&&(n.dx=t),i!==0&&(n.dy=i),n}function la(e,n){let t=Mh(e.chartAnchor);t!==void 0&&(n.chartAnchor=t)}function da(e,n){e.chartAnchor!==void 0&&(n.chartAnchor=Rh(e.chartAnchor))}function Rh(e){let n={layer:e.layer,at:e.at,place:e.place};return e.dx!==void 0&&e.dx!==0&&(n.dx=j(e.dx)),e.dy!==void 0&&e.dy!==0&&(n.dy=j(e.dy)),n}var _e={setColor:"color",setOpacity:"opacity",setText:"text",setIcon:"icon",setFontSize:"fontSize",setFontWeight:"fontWeight",setRotation:"rotation",hide:"visibility",show:"visibility",setGaugeValue:"gaugeValue",setGaugeMin:"gaugeMin",setGaugeMax:"gaugeMax",setBorderColor:"borderColor",setBorderWidth:"borderWidth",setBackgroundColor:"backgroundColor"};function ed(e){return e.countdown===!0?!1:e.coloring==="bands"&&(e.bands?.length??0)>0||e.highlight!==void 0&&e.highlight!=="none"}function yt(e){return e.countdown!==!0&&(e.parts?.length??0)>0}function cn(e){if(e.kind.kind==="literal")return(e.format?.prefix??"")+e.kind.value+(e.format?.suffix??"")}function $i(e){let n=c=>c.value.kind.kind!=="literal",t=(c,u)=>e.slice(c,u).map(p=>cn(p.value)??"").join(""),i=e.findIndex(n);if(i<0)return _(t(0,e.length));let a=e.findIndex((c,u)=>u>i&&n(c)),r=e[i].value,o={...r.format},s=t(0,i)+(o.prefix??""),l=(o.suffix??"")+t(i+1,a<0?e.length:a);delete o.prefix,delete o.suffix,s!==""&&(o.prefix=s),l!==""&&(o.suffix=l);let d={kind:structuredClone(r.kind)};return Ae(o)||(d.format=o),d}function td(e){yt(e)&&(e.value=$i(e.parts))}var Gn="#FFFFFF";function _l(e){return typeof e=="string"&&gh.includes(e)}function Fh(e){return e==="none"?{high:"none",low:"none"}:e==="pointer"?{high:"triangle",low:"dot"}:{high:"dot",low:"dot"}}function bi(e){let n=Fh(e.marker);return{high:e.highMarker??n.high,low:e.lowMarker??n.low}}function nd(e){return e.high==="triangle"?"pointer":e.high!=="none"||e.low!=="none"?"dot":"none"}function id(e){return e.high==="none"&&e.low==="none"||e.high==="dot"&&e.low==="dot"||e.high==="triangle"&&e.low==="dot"}function Ah(e,n){e.marker=nd(n),id(n)?(delete e.highMarker,delete e.lowMarker):(e.highMarker=n.high,e.lowMarker=n.low)}var ga=24,qe="#FF6B35",Ye="#32D74B",Jr="#32D74B",oe="#FF453A",Zr="#FF453A",Qr="#FFFFFF99";function Pt(e){return[...e.bands].sort((n,t)=>n.upTo-t.upTo)}function ad(e){return e.coloring==="bands"&&e.bands.length>0}function ya(e,n,t){for(let i of n)if(e<=i.upTo)return i.colorHex;return t}function eo(e,n){let t=Math.abs(n),i=t>=10?0:t>=1?1:2;return e.toFixed(i)}function rd(e){return e>0?"\u2191":e<0?"\u2193":"\u2192"}var un=[{minutes:60,label:"Last hour"},{minutes:180,label:"Last 3 hours"},{minutes:360,label:"Last 6 hours"},{minutes:720,label:"Last 12 hours"},{minutes:1440,label:"Last 24 hours"},{minutes:4320,label:"Last 3 days"},{minutes:10080,label:"Last 7 days"}],ba=360,xa=10080,Ci=[...un,{minutes:43200,label:"Last 30 days"},{minutes:129600,label:"Last 90 days"},{minutes:527040,label:"Last year"}],to=366*24*60,no=2,Dt=120,io=0;function ao(e){let n=Math.round(e.historyPoints);return Number.isFinite(n)?n<1?io:Math.max(no,Math.min(Dt,n)):24}function pn(e){return oo(e)!==void 0?!0:ro(e)!==void 0&&ao(e)>0}function ro(e){if(e.source==="history")return od(e)}function oo(e){if(e.source==="statistics")return od(e)}function od(e){if(!(e.historyMinutes<=0))return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function hn(e){let n=ro(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${ao(e)}${e.gaps===!0?"|gaps":""}`}function mn(e){let n=oo(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${e.statPeriod}|${e.statType}${e.gaps===!0?"|gaps":""}`}function sd(e){return[...so(e).map(t=>t.key),...lo(e).map(t=>t.key)].sort().join(";")}function so(e){let n=new Map,t=i=>{n.has(i.key)||n.set(i.key,i)};for(let i of e.elements)if(i.kind==="chart"){let a=hn(i.payload),r=ro(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:Math.round(i.payload.historyMinutes),points:ao(i.payload),mode:"numeric",gaps:i.payload.gaps===!0})}else if(i.kind==="timeline"){let a=Bt(i.payload),r=hd(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:st(i.payload),points:Vt,mode:"states",gaps:!1})}return[...n.values()]}function lo(e){let n=new Map;for(let t of e.elements){if(t.kind!=="chart")continue;let i=mn(t.payload),a=oo(t.payload);i===void 0||a===void 0||n.has(i)||n.set(i,{key:i,entityId:a,minutes:Math.round(t.payload.historyMinutes),period:t.payload.statPeriod,type:t.payload.statType,gaps:t.payload.gaps===!0})}return[...n.values()]}var ld=[["auto","Auto"],["h12","12 hour"],["h24","24 hour"]],dd=[["auto","Auto"],["always","Always"],["never","Never"]];function Dr(e){return e==="h12"||e==="h24"?e:an}function Or(e){return e==="always"||e==="never"?e:rn}function Ih(e){return e.timeLabelCount!==void 0?ft(e.timeLabelCount):e.timeLabels==="ends"?2:e.timeLabels==="four"?4:nn}function ft(e){let n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(Si,Math.round(n))):nn}function va(e){return e<=0?[]:e===1?[1]:Array.from({length:e},(n,t)=>t/(e-1))}var Ot="#8E8E93",cd=1,Hh="#000000",Lh=2,_h=1440,co=60,nn=0,Qe=9,et="#8E8E93",an="auto",rn="auto",ud=4,Si=12,Un=1,Kn=20,wa=4,Vt=120;function pd(e,n,t){let i=e.trim().toLowerCase();for(let a of n)if(a.match.trim().toLowerCase()===i)return a.colorHex;return t}function st(e){let n=Math.round(e.historyMinutes);return Number.isFinite(n)?Math.max(1,Math.min(xa,n)):co}function hd(e){return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function Bt(e){let n=hd(e);if(n!==void 0)return`${n}|${st(e)}|${Vt}|states`}var zh={on:"#FF9F0A",off:"#0A84FF",open:"#FF453A",closed:"#32D74B",opening:"#FFD60A",closing:"#FFD60A",home:"#32D74B",not_home:"#0A84FF",locked:"#32D74B",unlocked:"#FF453A",jammed:"#BF5AF2",playing:"#32D74B",paused:"#FF9F0A",idle:"#0A84FF",standby:"#5E5CE6",heat:"#FF9F0A",cool:"#64D2FF",heat_cool:"#BF5AF2",dry:"#FFD60A",fan_only:"#5E5CE6",auto:"#BF5AF2",cleaning:"#32D74B",docked:"#0A84FF",returning:"#64D2FF",error:"#FF453A",disarmed:"#32D74B",armed_home:"#0A84FF",armed_away:"#FF9F0A",armed_night:"#5E5CE6",arming:"#FFD60A",pending:"#FFD60A",triggered:"#FF453A",unavailable:"#48484A",unknown:"#48484A"},Ti={binary_sensor:["on","off"],switch:["on","off"],light:["on","off"],input_boolean:["on","off"],fan:["on","off"],humidifier:["on","off"],siren:["on","off"],cover:["open","closed","opening","closing"],lock:["locked","unlocked","jammed"],person:["home","not_home"],device_tracker:["home","not_home"],media_player:["playing","paused","idle","off"],climate:["heat","cool","heat_cool","dry","fan_only","auto","off"],vacuum:["cleaning","docked","returning","idle","error"],alarm_control_panel:["disarmed","armed_home","armed_away","armed_night","arming","pending","triggered"]};function ca(e){return zh[e.trim().toLowerCase()]??Ot}var Nh=["door","garage_door","window","opening"];function uo(e,n){let t=(n??"").trim().toLowerCase(),i=e==="binary_sensor"&&Nh.includes(t),a=o=>ca(i&&o==="on"?"open":o);return[...Ti[e]??[],"unavailable","unknown"].map(o=>({id:J(),match:o,colorHex:a(o)}))}var Wn=6,jn=9,Ph=["topLeading","topTrailing","bottomLeading","bottomTrailing"];function bt(e){return Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY)}function po(e,n){let t=n<=.5,i=e<=.5;return t?i?"topLeading":"topTrailing":i?"bottomLeading":"bottomTrailing"}var ho={top:0,left:0,bottom:0,right:0};function ka(e){return e===void 0||e.top===0&&e.left===0&&e.bottom===0&&e.right===0}var Dh=["toggleEntity","runScene","runScript","addTodo","runHTTPAction"];function md(e){return Dh.includes(e)}function fd(e){let n=(e??"").trim();if(n==="")return!0;try{let t=JSON.parse(n);return typeof t=="object"&&t!==null&&!Array.isArray(t)}catch{return!1}}var mo=[["refresh","Refresh"],["none","Nothing"],["openApp","Open the app"],["openPage","Open the page"],["openRoomPage","Open the room page"],["timerStartPause","Timer start / pause"],["timerCancel","Timer cancel"],["toggleEntity","Toggle an entity"],["runScene","Run a scene"],["runScript","Run a script"],["addTodo","Add a to-do"],["runHTTPAction","Run an HTTP action"],["callService","Call a service"]];function xt(e){let n=mo.find(([i])=>i===e.type)?.[1]??e.type;if(e.type==="callService"){let i=[e.serviceDomain,e.serviceName].filter(a=>a!=="").join(".");return i===""?n:`${n}: ${i}`}if(!("entityId"in e))return n;let t=e.displayName||e.entityId;return t?`${n}: ${t}`:n}function N(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function W(e,n=""){return typeof e=="string"?e:n}function Y(e,n){return typeof e=="number"?e:e==="+inf"?1/0:e==="-inf"?-1/0:e==="nan"?NaN:n}function ot(e){return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}function yi(e){return e==null?void 0:Y(e,0)}function de(e){return typeof e=="string"?e:void 0}function Vr(e,n,t){return n.some(([i])=>i===e)?e:t}var Xe=class extends Error{};function Ht(e){if(typeof e.entityId!="string")throw new Xe("entityId is required");let n={entityId:e.entityId,displayName:W(e.displayName),domain:W(e.domain)};return typeof e.iconName=="string"&&(n.iconName=e.iconName),n}function zl(e){if(!N(e))return;let n={};return e.decimals!==void 0&&e.decimals!==null&&(n.decimals=Y(e.decimals,0)),e.multiply!==void 0&&e.multiply!==null&&(n.multiply=Y(e.multiply,1)),e.offset!==void 0&&e.offset!==null&&(n.offset=Y(e.offset,0)),typeof e.prefix=="string"&&(n.prefix=e.prefix),typeof e.suffix=="string"&&(n.suffix=e.suffix),e.useEntityUnit===!0&&(n.useEntityUnit=!0),e.relativeTime===!0&&(n.relativeTime=!0),e.duration===!0&&(n.duration=!0),(e.textCase==="upper"||e.textCase==="lower"||e.textCase==="capitalized")&&(n.textCase=e.textCase),Ae(n)?void 0:n}function Ae(e){return e?e.decimals===void 0&&e.multiply===void 0&&e.offset===void 0&&!e.prefix&&!e.suffix&&!e.useEntityUnit&&!e.relativeTime&&!e.duration&&e.textCase===void 0:!0}function Oh(e){let n=W(e.function,"count"),t=N(e.scope)?e.scope:{},i;if(t.kind==="entities")i={kind:"entities",entities:(Array.isArray(t.entities)?t.entities:[]).filter(N).map(Ht)};else{let r=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[];i={kind:"filter",domains:r(t.domains),areaIds:r(t.areaIds),labelIds:r(t.labelIds),floorIds:r(t.floorIds)}}let a={function:n,scope:i};if(N(e.stateFilter)){let r=e.stateFilter.kind;r==="isOn"||r==="isOff"?a.stateFilter={kind:r}:(r==="equals"||r==="notEquals")&&(a.stateFilter={kind:r,value:W(e.stateFilter.value)})}return typeof e.attribute=="string"&&(a.attribute=e.attribute),a}function Nl(e){switch(e.kind){case"literal":return{kind:"literal",value:W(e.value)};case"entityState":return{kind:"entityState",...Ht(e)};case"entityAttribute":return{kind:"entityAttribute",...Ht(e),attribute:W(e.attribute)};case"entityAge":return{kind:"entityAge",...Ht(e)};case"aggregate":return{kind:"aggregate",aggregate:Oh(N(e.aggregate)?e.aggregate:{})};case"time":return{kind:"time",timeField:de(e.timeField)??"now"};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:W(e.value)};case"named":return{kind:"named",id:W(e.id).toUpperCase()};case"chartStat":return{kind:"chartStat",layer:W(e.layer).toUpperCase(),stat:Bn.some(([n])=>n===e.stat)?e.stat:"latest"};default:throw new Xe(`unknown value kind ${String(e.kind)}`)}}function me(e){if(!N(e))throw new Xe("value must be an object");if(N(e.kind)){let i={kind:Nl(e.kind)},a=zl(e.format);return a&&(i.format=a),i}let n={kind:Nl(e)},t=zl(e.format);return t&&(n.format=t),n}function gd(e){return N(e)?{x:Y(e.x,.25),y:Y(e.y,.25),width:Y(e.width,.5),height:Y(e.height,.5),rotationDegrees:Y(e.rotationDegrees,0)}:{...ki}}function Vh(e){if(!N(e))return{kind:"isOn"};let n=W(e.kind,"isOn"),t={kind:n};switch(n){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":t.value=N(e.value)?me(e.value):_("");break;case"between":case"timeBetween":t.value=N(e.value)?me(e.value):_(""),t.upper=N(e.upper)?me(e.upper):_("");break;case"matchesRegex":t.pattern=W(e.pattern);break;case"isOneOf":t.options=Array.isArray(e.options)?e.options.filter(i=>typeof i=="string"):[];break;default:break}return t}function Pl(e){if(!N(e))return{kind:"show"};let n=W(e.kind,"show"),t={kind:n};switch(n){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":t.value=N(e.value)?me(e.value):_("");break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":t.number=Y(e.number,0);break;case"setFontWeight":t.weight=de(e.weight)??"regular";break;default:break}return t}function yd(e){return Array.isArray(e)?e.filter(N).map(n=>{let t={id:W(n.id).toUpperCase(),cases:(Array.isArray(n.cases)?n.cases:[]).filter(N).map(i=>{let a=N(i.when)?i.when:{};return{id:W(i.id).toUpperCase(),when:{join:a.join==="any"?"any":"all",tests:(Array.isArray(a.tests)?a.tests:[]).filter(N).map(r=>({id:W(r.id).toUpperCase(),value:N(r.value)?me(r.value):_(""),comparison:Vh(r.comparison)}))},then:(Array.isArray(i.then)?i.then:[]).map(Pl)}})};return Array.isArray(n.otherwise)&&(t.otherwise=n.otherwise.map(Pl)),typeof n.partId=="string"&&n.partId!==""&&(t.partId=n.partId.toUpperCase()),t}):[]}function Bh(e,n){return{baseColorHex:N(e)?W(e.baseColorHex,n):n}}function ua(e){return Array.isArray(e)?e.filter(N).map(n=>({id:W(n.id,J()),upTo:Y(n.upTo,0),colorHex:W(n.colorHex,"#FFFFFF")})):[]}function Gh(e){return Array.isArray(e)?e.filter(N).map(n=>{let t={id:W(n.id,J()).toUpperCase(),value:N(n.value)?me(n.value):_("")};typeof n.colorHex=="string"&&(t.colorHex=n.colorHex);let i=de(n.fontWeight);(i==="regular"||i==="medium"||i==="semibold"||i==="bold")&&(t.fontWeight=i),typeof n.fontSize=="number"&&(t.fontSize=n.fontSize),de(n.coloring)==="bands"&&(t.coloring="bands");let a=ua(n.bands);a.length>0&&(t.bands=a);let r=W(n.bandAboveColorHex,oe);return r!==oe&&(t.bandAboveColorHex=r),t}):[]}function Uh(e){if(Array.isArray(e.bands))return ua(e.bands);if(typeof e.bandLowerBound!="number")return[];let n=N(e.colorSlot)?W(e.colorSlot.baseColorHex,"#FFFFFF"):"#FFFFFF";return[{id:J(),upTo:e.bandLowerBound,colorHex:W(e.bandLowColorHex,Jr)},{id:J(),upTo:Y(e.bandUpperBound,100),colorHex:n}]}function Kh(e){return Array.isArray(e)?e.filter(N).map(n=>({id:W(n.id,J()).toUpperCase(),match:W(n.match,""),colorHex:W(n.colorHex,Ot)})):[]}function Ze(e,n){if(typeof e.id!="string")throw new Xe("element id is required");return{id:e.id.toUpperCase(),colorSlot:Bh(e.colorSlot,n),rules:yd(e.rules),frame:gd(e.frame),isHidden:e.isHidden===!0}}function Wh(e){let n=jh(e),t=e.payload;return typeof t.groupId=="string"&&t.groupId!==""&&(n.payload.groupId=t.groupId.toUpperCase()),n}function jh(e){if(!N(e)||!N(e.payload))throw new Xe("element must have a payload");let n=e.payload;switch(e.kind){case"text":{let t={...Ze(n,"#FFFFFF"),value:N(n.value)?me(n.value):_(""),fontSize:Y(n.fontSize,14),fontWeight:de(n.fontWeight)??"regular"};n.countdown===!0&&(t.countdown=!0),n.monospacedDigits===!0&&(t.monospacedDigits=!0);let i=typeof n.lineLimit=="number"?Math.round(n.lineLimit):1;Math.min(2,Math.max(1,i))===2&&(t.lineLimit=2);let a=de(n.alignment);(a==="leading"||a==="trailing")&&(t.alignment=a),de(n.coloring)==="bands"&&(t.coloring="bands");let r=ua(n.bands);r.length>0&&(t.bands=r);let o=W(n.bandAboveColorHex,oe);o!==oe&&(t.bandAboveColorHex=o);let s=de(n.highlight);(s==="highest"||s==="lowest"||s==="both")&&(t.highlight=s);let l=W(n.highColorHex,qe);l!==qe&&(t.highColorHex=l);let d=W(n.lowColorHex,Ye);d!==Ye&&(t.lowColorHex=d);let c=Gh(n.parts);return c.length>0&&(t.parts=c),la(n,t),{kind:"text",payload:t}}case"icon":{let t={...Ze(n,"#FFFFFF"),symbol:N(n.symbol)?me(n.symbol):_("lightbulb"),size:Y(n.size,14)},i=de(n.path);return i!==void 0&&i!==""&&(t.path=i),la(n,t),{kind:"icon",payload:t}}case"gauge":{let t={...Ze(n,"#FFFFFF"),value:N(n.value)?me(n.value):_("50"),minValue:Y(n.minValue,0),maxValue:Y(n.maxValue,100),style:de(n.style)??"arc",lineWidth:Y(n.lineWidth,4),trackColorHex:W(n.trackColorHex,"#FFFFFF40"),coloring:de(n.coloring)??"uniform",bands:ua(n.bands),bandAboveColorHex:W(n.bandAboveColorHex,oe),thresholdColorHex:W(n.thresholdColorHex,Gn)},i=yi(n.thresholdValue);return i!==void 0&&(t.thresholdValue=i),N(n.total)&&(t.total=me(n.total)),N(n.minSource)&&(t.minSource=me(n.minSource)),N(n.maxSource)&&(t.maxSource=me(n.maxSource)),{kind:"gauge",payload:t}}case"chart":return{kind:"chart",payload:{...Ze(n,"#FFFFFF"),value:N(n.value)?me(n.value):_("13,14,16,17,19,22,24,28,30"),historyMinutes:Math.max(0,Math.round(Y(n.historyMinutes,0))),historyPoints:Math.round(Y(n.historyPoints,24)),source:Vr(de(n.source),Sh,Yr),statPeriod:Vr(de(n.statPeriod),fa,vi),statType:Vr(de(n.statType),qr,wi),style:de(n.style)??"bars",limit:Math.max(0,Math.round(Y(n.limit,0))),takeFromEnd:n.takeFromEnd===!0,scale:de(n.scale)??"auto",minValue:Y(n.minValue,0),maxValue:Y(n.maxValue,100),baseline:de(n.baseline)??"lowest",barGap:Y(n.barGap,1.5),lineWidth:Y(n.lineWidth,2),highlight:de(n.highlight)??"none",highColorHex:W(n.highColorHex,qe),lowColorHex:W(n.lowColorHex,Ye),marker:de(n.marker)??"pointer",..._l(n.highMarker)?{highMarker:n.highMarker}:{},..._l(n.lowMarker)?{lowMarker:n.lowMarker}:{},coloring:de(n.coloring)??"uniform",bands:Uh(n),bandAboveColorHex:W(n.bandHighColorHex,W(n.bandAboveColorHex,oe)),fillBands:n.fillBands===!0,...Ll(n.curve)!=="straight"?{curve:Ll(n.curve)}:{},..._t(n.fillStyle)!=="flat"?{fillStyle:_t(n.fillStyle)}:{},...typeof n.fillColorHex=="string"?{fillColorHex:n.fillColorHex}:{},...zt(n.barRadius)!==Vn?{barRadius:zt(n.barRadius)}:{},...Nt(n.barCorners)!=="all"?{barCorners:Nt(n.barCorners)}:{},...Gr(n.pointDots)!=="none"?{pointDots:Gr(n.pointDots)}:{},...mt(n.pointDotSize)!==void 0?{pointDotSize:mt(n.pointDotSize)}:{},...typeof n.pointDotColorHex=="string"?{pointDotColorHex:n.pointDotColorHex}:{},...Ur(n.gridLines)!==0?{gridLines:Ur(n.gridLines)}:{},...Zl(It(n.gridColorHex),ln)?{}:{gridColorHex:It(n.gridColorHex)},...n.zeroLine===!0?{zeroLine:!0}:{},...tt(n.smoothing)!==void 0?{smoothing:tt(n.smoothing)}:{},...n.gaps===!0?{gaps:!0}:{},...typeof n.thresholdValue=="number"&&Number.isFinite(n.thresholdValue)?{thresholdValue:n.thresholdValue}:{},thresholdColorHex:W(n.thresholdColorHex,Zr),...N(n.nowIndex)?{nowIndex:me(n.nowIndex)}:{},nowColorHex:W(n.nowColorHex,Qr),...n.drawsThreshold===!1?{drawsThreshold:!1}:{},...n.drawsNowLine===!1?{drawsNowLine:!1}:{},...n.drawsTimeLabels===!1?{drawsTimeLabels:!1}:{},...de(n.scaleFrom)!==void 0?{scaleFrom:de(n.scaleFrom)}:{},timeLabelCount:ft(n.timeLabelCount),labelSize:Y(n.labelSize,Qe),labelColorHex:W(n.labelColorHex,et),labelsAbove:n.labelsAbove===!0,hourCycle:Dr(n.hourCycle),minutes:Or(n.minutes)}};case"timeline":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"timeline",payload:{...i,value:N(n.value)?me(n.value):_(""),historyMinutes:Math.max(1,Math.round(Y(n.historyMinutes,co))),bands:Kh(n.bands),otherColorHex:W(n.otherColorHex,Ot),gap:Math.min(wa,Math.max(0,Y(n.gap,0))),cornerRadius:Math.max(0,Y(n.cornerRadius,cd)),timeLabelCount:Ih(n),labelSize:Y(n.labelSize,Qe),labelColorHex:W(n.labelColorHex,et),labelsAbove:n.labelsAbove===!0,hourCycle:Dr(n.hourCycle),minutes:Or(n.minutes)}}}case"shape":{let t={...Ze(n,"#FFFFFF33"),kind:de(n.kind)??"roundedRectangle",cornerRadius:Y(n.cornerRadius,6),thickness:Y(n.thickness,1),borderWidth:Y(n.borderWidth,1)};return typeof n.borderColorHex=="string"&&(t.borderColorHex=n.borderColorHex),la(n,t),{kind:"shape",payload:t}}case"image":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF"),a={...i,entity:Ht(N(n.entity)?n.entity:{}),source:n.source==="entityPicture"?"entityPicture":"camera",contentMode:n.contentMode==="fit"?"fit":"fill",zoom:Y(n.zoom,1),panX:Y(n.panX,0),panY:Y(n.panY,0),cornerRadius:Y(n.cornerRadius,Wn),timestampCorner:Ph.includes(n.timestampCorner)?n.timestampCorner:"topLeading",timestampSize:Y(n.timestampSize,jn)};n.timestamp===!0&&(a.timestamp=!0);let r=yi(n.timestampX),o=yi(n.timestampY);return r!==void 0&&o!==void 0&&Number.isFinite(r)&&Number.isFinite(o)&&(a.timestampX=ot(r),a.timestampY=ot(o)),la(n,a),{kind:"image",payload:a}}case"tap":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF"),a={...i,action:N(n.action)?bd(n.action):{type:"refresh"}};return typeof n.openPageId=="string"&&(a.openPageId=n.openPageId),typeof n.openPageName=="string"&&(a.openPageName=n.openPageName),typeof n.attachedTo=="string"&&(a.attachedTo=n.attachedTo.toUpperCase()),{kind:"tap",payload:a}}case"chartTimes":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"chartTimes",payload:{...i,chart:W(n.chart).toUpperCase(),timeLabelCount:ft(n.timeLabelCount),labelSize:Y(n.labelSize,Qe),labelColorHex:W(n.labelColorHex,et),hourCycle:Dr(n.hourCycle),minutes:Or(n.minutes)}}}case"chartDots":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF"),a=mt(n.size);return{kind:"chartDots",payload:{...i,chart:W(n.chart).toUpperCase(),dots:ma(n.dots),...a!==void 0?{size:a}:{},...typeof n.colorHex=="string"?{colorHex:n.colorHex}:{}}}}case"chartGrid":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"chartGrid",payload:{...i,chart:W(n.chart).toUpperCase(),lines:Dn(n.lines),colorHex:It(n.colorHex),thickness:On(n.thickness)}}}default:throw new Xe(`unknown element kind ${String(e.kind)}`)}}function Dl(e){let n=N(e)?e:{},t={};if(N(n.placements))for(let[a,r]of Object.entries(n.placements)){if(!N(r))continue;let o={frame:gd(r.frame),isHidden:r.isHidden===!0},s=yi(r.size);s!==void 0&&(o.size=s),t[a.toUpperCase()]=o}let i={placements:t,cornerBodyShape:n.cornerBodyShape==="circle"?"circle":"wedge",borderWidth:Y(n.borderWidth,2),rules:yd(n.rules)};if(N(n.bezelText)&&(i.bezelText=me(n.bezelText)),n.bezelCountdown===!0&&(i.bezelCountdown=!0),N(n.curvedText)&&(i.curvedText=me(n.curvedText)),typeof n.curvedColorHex=="string"&&(i.curvedColorHex=n.curvedColorHex),N(n.bezelGauge)){let a=n.bezelGauge,r={value:N(a.value)?me(a.value):_("50"),minValue:Y(a.minValue,0),maxValue:Y(a.maxValue,100),colorHexes:Array.isArray(a.colorHexes)&&a.colorHexes.length>0?a.colorHexes.filter(o=>typeof o=="string"):["#34C759","#FFCC00","#FF3B30"]};N(a.minLabel)&&(r.minLabel=me(a.minLabel)),N(a.maxLabel)&&(r.maxLabel=me(a.maxLabel)),i.bezelGauge=r}return typeof n.backgroundColorHex=="string"&&(i.backgroundColorHex=n.backgroundColorHex),typeof n.borderColorHex=="string"&&(i.borderColorHex=n.borderColorHex),i}function qh(e){let n={};if(Array.isArray(e))for(let t=0;t+1<e.length;t+=2){let i=e[t];typeof i=="string"&&(n[i]=Dl(e[t+1]))}else if(N(e))for(let[t,i]of Object.entries(e))n[t]=Dl(i);return n}function Yh(e){let n={value:N(e.value)?me(e.value):_("")};return typeof e.label=="string"&&(n.label=e.label),typeof e.symbol=="string"&&(n.symbol=e.symbol),e.countdown===!0&&(n.countdown=!0),n}function bd(e){if(!N(e)||typeof e.type!="string")return{type:"none"};switch(e.type){case"none":case"refresh":case"openApp":case"openPage":case"openRoomPage":case"timerStartPause":case"timerCancel":return{type:e.type};case"toggleEntity":case"runScene":case"runScript":case"addTodo":case"runHTTPAction":return{type:e.type,...Ht(e)};case"callService":{let n={type:"callService",serviceDomain:typeof e.serviceDomain=="string"?e.serviceDomain:"",serviceName:typeof e.serviceName=="string"?e.serviceName:""};return typeof e.serviceDataJSON=="string"&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),typeof e.entityId=="string"&&e.entityId!==""&&(n.target=Ht(e)),n}default:return{type:"none"}}}function qn(e){if(!N(e))throw new Xe("config must be an object");for(let r of["id","name","slotIndex","supportedFamilies","perFamily","tapAction"])if(!(r in e))throw new Xe(`${r} is required`);let n=(Array.isArray(e.values)?e.values:[]).filter(N).map(r=>({id:W(r.id).toUpperCase(),name:W(r.name),value:N(r.value)?me(r.value):_("")})),t=(Array.isArray(e.dataSources)?e.dataSources:[]).filter(N).map(r=>r.kind==="template"?{kind:"template",value:W(r.value)}:r.kind==="entity"?{kind:"entity",...Ht(r)}:null).filter(r=>r!==null),i={schemaVersion:Y(e.schemaVersion,1),id:W(e.id).toUpperCase(),name:W(e.name,"Custom"),values:n,slotIndex:Y(e.slotIndex,0),elements:(Array.isArray(e.elements)?e.elements:[]).map(Wh),supportedFamilies:(Array.isArray(e.supportedFamilies)?e.supportedFamilies:[]).filter(r=>typeof r=="string"),perFamily:qh(e.perFamily),dataSources:t,tapAction:bd(e.tapAction)};N(e.inline)&&(i.inline=Yh(e.inline));let a=yi(e.refreshMinutes);if(a!==void 0&&(i.refreshMinutes=a),typeof e.openPageId=="string"&&(i.openPageId=e.openPageId),typeof e.openPageName=="string"&&(i.openPageName=e.openPageName),typeof e.showSuccessFlash=="boolean"&&(i.showSuccessFlash=e.showSuccessFlash),typeof e.successFlashColorHex=="string"&&(i.successFlashColorHex=e.successFlashColorHex),Array.isArray(e.groups)){let r=e.groups.filter(N).filter(o=>typeof o.id=="string").map(o=>({id:W(o.id).toUpperCase(),name:W(o.name,"Group"),locked:o.locked!==!1}));r.length>0&&(i.groups=r)}return im(i,Array.isArray(e.elements)?e.elements:[]),nt(i),i}function fo(e,n){let t=n?.kind;if(!t||t.kind!=="chartStat")return;let i=e.elements.find(a=>a.payload.id===t.layer);return i?.kind==="chart"?i:void 0}function fn(e,n){return e.elements.filter(t=>t.kind==="text"&&t.payload.value.kind.kind==="chartStat"&&t.payload.value.kind.layer===n)}function Xh(e,n){let t=ha(e,xn(n))?.ref;return t?.displayName||t?.entityId||"Chart"}function Gt(e,n,t){let i=vt(e,n.payload.id);if(i){$o(e,t,i.id);return}let a=ko(e,[n.payload.id,t],Xh(e,n)),r=e.groups?.find(o=>o.id===a);r&&(r.locked=!1)}var xd={top:{x:0,y:0},highest:{x:.35,y:0},average:{x:.65,y:0},latest:{x:1,y:0},bottom:{x:0,y:1},lowest:{x:.35,y:1},trend:{x:.85,y:0},delta:{x:.5,y:0},sum:{x:.2,y:0},first:{x:.65,y:1}};function vd(e,n,t,i){let a=pe.rectangular,r=Math.min(1,(i*t*.62+4)/a.width),o=Math.min(1,t*1.3/a.height),s=e.x+n.x*e.width-n.x*r,l=e.y+n.y*e.height-n.y*o;return{x:Math.max(0,Math.min(1-r,s)),y:Math.max(0,Math.min(1-o,l)),width:r,height:o,rotationDegrees:0}}function wd(e,n,t){let i=e.elements.find(d=>d.payload.id===n);if(!i||i.kind!=="chart")return;let a=Ce("text"),r=t==="latest"?10:8,o={kind:{kind:"chartStat",layer:n,stat:t}};(t==="latest"||t==="delta"||t==="sum")&&(o.format={useEntityUnit:!0}),a.payload.value=o,a.payload.fontSize=r,a.payload.fontWeight="medium",a.payload.colorSlot={baseColorHex:t==="latest"?"#FFFFFF":"#FFFFFF99"};let s=t==="trend"?2:o.format?.useEntityUnit?7:4;a.payload.frame=vd(i.payload.frame,xd[t],r,s);let l=e.elements.findIndex(d=>d.payload.id===n);return e.elements.splice(l+1,0,a),Gt(e,i,a.payload.id),a.payload.id}var kd={highest:"arrowtriangle.up.fill",lowest:"circle.fill",now:"arrowtriangle.down.fill",first:"circle.fill",latest:"circle.fill",threshold:"circle.fill",zero:"circle.fill"},Ol=6,Jh={"\u25B2":"arrowtriangle.up.fill","\u25BC":"arrowtriangle.down.fill","\u25CF":"circle.fill","\u25C6":"diamond.fill"};function Zh(e,n){let t=(i,a)=>i!==void 0&&i!==a?i:void 0;return n==="highest"?t(e.payload.highColorHex,qe)??"#FFD60A":n==="lowest"?t(e.payload.lowColorHex,Ye)??"#FF453A":"#FFFFFF"}function go(e){e.nowIndex===void 0&&(e.nowIndex={kind:{kind:"time",timeField:"hour"}},e.drawsNowLine=!1)}function Oe(e,n){return e.elements.filter(t=>t.payload.chartAnchor?.layer===n)}function yo(e,n,t,i="above"){let a=e.elements.find(s=>s.payload.id===n);if(!a||a.kind!=="chart")return;t==="now"&&go(a.payload);let r=Ce("icon");r.payload.symbol=_(kd[t]),r.payload.size=Ol,r.payload.colorSlot={baseColorHex:Zh(a,t)},r.payload.frame=Qh(Ol),r.payload.chartAnchor={layer:n,at:t,place:i};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),Gt(e,a,r.payload.id),r.payload.id}function $d(e,n){let t=e.elements.findIndex(u=>u.payload.id===n),i=e.elements[t];if(!i||i.kind!=="text"||i.payload.chartAnchor===void 0)return;let a=i.payload,r=a.chartAnchor,o=u=>{let p=cn(u);return p===void 0?void 0:Jh[p.trim()]},s=new Set(Ri.icon),l=u=>u.flatMap(p=>{if(p.kind==="setText"){let m=p.value===void 0?void 0:o(p.value);return m===void 0?[]:[{kind:"setIcon",value:_(m)}]}return s.has(_e[p.kind])?[p]:[]}),d=a.rules.filter(u=>u.partId===void 0).map(u=>({...u,cases:u.cases.map(p=>({...p,then:l(p.then)})),...u.otherwise!==void 0?{otherwise:l(u.otherwise)}:{}})),c=Ce("icon");c.payload={...c.payload,id:a.id,colorSlot:a.colorSlot,rules:d,frame:a.frame,isHidden:a.isHidden,...a.groupId!==void 0?{groupId:a.groupId}:{},chartAnchor:r,symbol:_(o(a.value)??kd[r.at]),size:a.fontSize},e.elements[t]=c}function Qh(e){let n=pe.rectangular;return{x:0,y:0,width:Math.min(1,e*1.2/n.width),height:Math.min(1,e*1.3/n.height),rotationDegrees:0}}function pa(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;t==="now"&&go(a);let r=Ce("shape");r.payload.kind="line",r.payload.thickness=1,r.payload.borderWidth=0,r.payload.colorSlot={baseColorHex:t==="now"?a.nowColorHex:a.thresholdColorHex},r.payload.frame=Cd(a.frame,t),r.payload.chartAnchor={layer:n,at:t,place:"through"};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),Gt(e,i,r.payload.id),t==="now"?a.drawsNowLine=!1:a.drawsThreshold=!1,r.payload.id}function Cd(e,n){let t=pe.rectangular,i=3;return n==="now"?{...e,width:Math.min(e.width,i/t.width),rotationDegrees:0}:{...e,height:Math.min(e.height,i/t.height),rotationDegrees:0}}function gn(e,n){return e.elements.filter(t=>t.kind==="chartTimes"&&t.payload.chart===n)}function bo(e,n){let t=e.elements.find(o=>o.payload.id===n);if(!t||t.kind!=="chart")return;let i=t.payload,a=Ce("chartTimes");a.payload.chart=n,a.payload.timeLabelCount=i.timeLabelCount>0?ft(i.timeLabelCount):ud,a.payload.labelSize=i.labelSize,a.payload.labelColorHex=i.labelColorHex,a.payload.hourCycle=i.hourCycle,a.payload.minutes=i.minutes,a.payload.frame=nm(i.frame,i.labelSize,i.labelsAbove);let r=e.elements.findIndex(o=>o.payload.id===n);return e.elements.splice(r+1,0,a),Gt(e,t,a.payload.id),i.drawsTimeLabels=!1,a.payload.id}function yn(e,n){return e.elements.filter(t=>t.kind==="chartDots"&&t.payload.chart===n)}function bn(e,n){return e.elements.filter(t=>t.kind==="chartGrid"&&t.payload.chart===n)}function Sd(e,n){return Oe(e,n).filter(t=>t.payload.chartAnchor?.at==="zero")}function xo(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Ce("chartDots");i.payload.chart=n,i.payload.dots=t.payload.pointDots==="all"?"all":"auto",i.payload.frame={...t.payload.frame};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a+1,0,i),Gt(e,t,i.payload.id),i.payload.id}function vo(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Ce("chartGrid");i.payload.chart=n,i.payload.frame={...t.payload.frame};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a,0,i),Gt(e,t,i.payload.id),i.payload.id}var em="#FFFFFF66";function wo(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Ce("shape");i.payload.kind="line",i.payload.thickness=1,i.payload.borderWidth=0,i.payload.colorSlot={baseColorHex:em},i.payload.frame=Cd(t.payload.frame,"threshold"),i.payload.chartAnchor={layer:n,at:"zero",place:"through"};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a+1,0,i),Gt(e,t,i.payload.id),i.payload.id}function Td(e,n,t){let i=e.elements.find(r=>r.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;if(t===void 0){delete a.thresholdValue,delete a.drawsThreshold;for(let r of Oe(e,n))r.payload.chartAnchor?.at==="threshold"&&$e(e,r.payload.id);return}a.thresholdValue=t,a.drawsThreshold=!1,Oe(e,n).some(r=>r.payload.chartAnchor?.at==="threshold")||pa(e,n,"threshold")}function Ed(e,n,t){let i=e.elements.find(r=>r.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;if(!t){delete a.nowIndex,delete a.drawsNowLine;for(let r of Oe(e,n))r.payload.chartAnchor?.at==="now"&&$e(e,r.payload.id);return}go(a),a.drawsNowLine=!1,Oe(e,n).some(r=>r.payload.chartAnchor?.at==="now")||pa(e,n,"now")}function Md(e){let n=e.elements.filter(t=>t.kind==="chart");for(let t of n){let i=t.payload,a=new Set(e.elements.map(l=>l.payload.id)),r=re.find(l=>e.perFamily[l]?.placements[i.id]!==void 0),o=i.frame,s=r===void 0?void 0:e.perFamily[r].placements[i.id];if(s&&(i.frame={...s.frame}),tm(e,i),i.frame=o,!(r===void 0||s===void 0))for(let l of e.elements)a.has(l.payload.id)||(e.perFamily[r].placements[l.payload.id]={frame:{...l.payload.frame},isHidden:s.isHidden},l.payload.isHidden=!0)}}function tm(e,n){{if(n.highlight!==void 0&&n.highlight!=="none"){let a=bi(n),r=[];(n.highlight==="highest"||n.highlight==="both")&&r.push(["highest",a.high]),(n.highlight==="lowest"||n.highlight==="both")&&r.push(["lowest",a.low]);for(let[o,s]of r){let l=yo(e,n.id,o),d=e.elements.find(c=>c.payload.id===l);d?.kind==="icon"&&s!=="none"&&(d.payload.symbol=_(s==="triangle"?"arrowtriangle.up.fill":"circle.fill"))}Ah(n,{high:"none",low:"none"}),n.highlight="none"}n.thresholdValue!==void 0&&n.drawsThreshold!==!1&&pa(e,n.id,"threshold"),n.nowIndex!==void 0&&n.drawsNowLine!==!1&&pa(e,n.id,"now"),n.drawsTimeLabels!==!1&&pn(n)&&n.timeLabelCount>0&&bo(e,n.id);let t=Gr(n.pointDots);if(t!=="none"){let a=xo(e,n.id),r=e.elements.find(o=>o.payload.id===a);if(r?.kind==="chartDots"){r.payload.dots=t;let o=mt(n.pointDotSize);o!==void 0&&(r.payload.size=o),typeof n.pointDotColorHex=="string"&&(r.payload.colorHex=n.pointDotColorHex)}}let i=Ur(n.gridLines);if(i>0){let a=vo(e,n.id),r=e.elements.find(o=>o.payload.id===a);r?.kind==="chartGrid"&&(r.payload.lines=i,r.payload.colorHex=It(n.gridColorHex))}if(n.zeroLine===!0){let a=wo(e,n.id),r=e.elements.find(o=>o.payload.id===a);r?.kind==="shape"&&(r.payload.colorSlot={baseColorHex:It(n.gridColorHex)})}delete n.pointDots,delete n.pointDotSize,delete n.pointDotColorHex,delete n.gridLines,delete n.gridColorHex,delete n.zeroLine}}function nm(e,n,t){let i=pe.rectangular,a=Math.max(Un,Math.min(Kn,n)),r=Math.min(1,a*1.2/i.height),o=Math.min(1,Math.max(0,e.width)),s=t?e.y-r:e.y+e.height;return{x:Math.max(0,Math.min(1-o,e.x)),y:Math.max(0,Math.min(1-r,s)),width:o,height:r,rotationDegrees:0}}function im(e,n){for(let t of n){if(!N(t)||t.kind!=="chart"||!N(t.payload))continue;let i=t.payload,a=W(i.id).toUpperCase(),r=e.elements.find(p=>p.payload.id===a);if(!r||r.kind!=="chart")continue;let o=W(i.scaleLabelColorHex,"#FFFFFF99"),s=p=>{let m=N(p)?p:{};return{fontSize:Y(m.fontSize,8),colorHex:W(m.colorHex,o),pillColorHex:typeof m.pillColorHex=="string"?m.pillColorHex:void 0}},l=[],d=de(i.scaleLabels);(d==="top"||d==="range")&&l.push(["top",s(i.topLabelStyle)]),d==="range"&&l.push(["bottom",s(i.bottomLabelStyle)]);let c=de(i.latestLabel);if((c==="corner"||c==="end")&&l.push(["latest",s(i.latestLabelStyle)]),l.length===0)continue;let u=e.elements.findIndex(p=>p.payload.id===a)+1;for(let[p,m]of l){let b=vd(r.payload.frame,xd[p],m.fontSize,p==="latest"?5:4),g=[];if(m.pillColorHex!==void 0){let k=Ce("shape");k.payload.kind="capsule",k.payload.colorSlot={baseColorHex:m.pillColorHex},k.payload.frame={...b},g.push(k)}let x=Ce("text");x.payload.value={kind:{kind:"chartStat",layer:a,stat:p}},x.payload.fontSize=m.fontSize,x.payload.fontWeight="medium",x.payload.colorSlot={baseColorHex:m.colorHex},x.payload.frame=b,g.push(x),e.elements.splice(u,0,...g),u+=g.length;for(let k of g)Gt(e,r,k.payload.id)}}}function j(e){return Number.isNaN(e)?"nan":e===1/0?"+inf":e===-1/0?"-inf":e}function Lt(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function am(e){let n={};return e.decimals!==void 0&&(n.decimals=j(e.decimals)),e.multiply!==void 0&&(n.multiply=j(e.multiply)),e.offset!==void 0&&(n.offset=j(e.offset)),e.prefix&&(n.prefix=e.prefix),e.suffix&&(n.suffix=e.suffix),e.useEntityUnit&&(n.useEntityUnit=!0),e.relativeTime&&(n.relativeTime=!0),e.duration&&(n.duration=!0),e.textCase!==void 0&&(n.textCase=e.textCase),n}function rm(e){let n=e.scope.kind==="entities"?{kind:"entities",entities:e.scope.entities.map(Lt)}:{kind:"filter",domains:e.scope.domains,areaIds:e.scope.areaIds,labelIds:e.scope.labelIds,floorIds:e.scope.floorIds},t={function:e.function,scope:n};return e.stateFilter&&(t.stateFilter=e.stateFilter.kind==="equals"||e.stateFilter.kind==="notEquals"?{kind:e.stateFilter.kind,value:e.stateFilter.value}:{kind:e.stateFilter.kind}),e.attribute!==void 0&&(t.attribute=e.attribute),t}function om(e){switch(e.kind){case"literal":return{kind:"literal",value:e.value};case"entityState":return{kind:"entityState",...Lt(e)};case"entityAttribute":return{kind:"entityAttribute",...Lt(e),attribute:e.attribute};case"entityAge":return{kind:"entityAge",...Lt(e)};case"aggregate":return{kind:"aggregate",aggregate:rm(e.aggregate)};case"time":return{kind:"time",timeField:e.timeField};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:e.value};case"named":return{kind:"named",id:e.id};case"chartStat":return{kind:"chartStat",layer:e.layer,stat:e.stat}}}function se(e){let n={kind:om(e.kind)};return Ae(e.format)||(n.format=am(e.format)),n}function Ft(e){return{x:j(e.x),y:j(e.y),width:j(e.width),height:j(e.height),rotationDegrees:j(e.rotationDegrees)}}function sm(e){let n={kind:e.kind};switch(e.kind){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":n.value=se(e.value??_(""));break;case"between":case"timeBetween":n.value=se(e.value??_("")),n.upper=se(e.upper??_(""));break;case"matchesRegex":n.pattern=e.pattern??"";break;case"isOneOf":n.options=e.options??[];break;default:break}return n}function Vl(e){let n={kind:e.kind};switch(e.kind){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":n.value=se(e.value??_(""));break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":n.number=j(e.number??0);break;case"setFontWeight":n.weight=e.weight??"regular";break;default:break}return n}function At(e){return e.map(n=>{let t={id:n.id,cases:n.cases.map(i=>({id:i.id,when:{join:i.when.join,tests:i.when.tests.map(a=>({id:a.id,value:se(a.value),comparison:sm(a.comparison)}))},then:i.then.map(Vl)}))};return n.otherwise&&(t.otherwise=n.otherwise.map(Vl)),n.partId!==void 0&&(t.partId=n.partId),t})}function lm(e){let n={id:e.id,value:se(e.value)};return e.colorHex!==void 0&&(n.colorHex=e.colorHex),e.fontWeight!==void 0&&(n.fontWeight=e.fontWeight),e.fontSize!==void 0&&(n.fontSize=j(e.fontSize)),e.coloring!==void 0&&e.coloring!=="uniform"&&(n.coloring=e.coloring),e.bands!==void 0&&e.bands.length>0&&(n.bands=e.bands.map(t=>({id:t.id,upTo:j(t.upTo),colorHex:t.colorHex}))),e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==oe&&(n.bandAboveColorHex=e.bandAboveColorHex),n}function dm(e){let n=cm(e);return e.payload.groupId!==void 0&&(n.payload.groupId=e.payload.groupId),n}function cm(e){let n=t=>({id:t.id,colorSlot:{baseColorHex:t.colorSlot.baseColorHex},rules:At(t.rules),frame:Ft(t.frame),isHidden:t.isHidden});switch(e.kind){case"text":{let t={...n(e.payload),value:se(e.payload.value),fontSize:j(e.payload.fontSize),fontWeight:e.payload.fontWeight};e.payload.countdown===!0&&(t.countdown=!0),e.payload.monospacedDigits===!0&&(t.monospacedDigits=!0),e.payload.lineLimit===2&&(t.lineLimit=2),e.payload.alignment!==void 0&&e.payload.alignment!=="center"&&(t.alignment=e.payload.alignment);let i=e.payload;return i.coloring!==void 0&&i.coloring!=="uniform"&&(t.coloring=i.coloring),i.bands!==void 0&&i.bands.length>0&&(t.bands=i.bands.map(a=>({id:a.id,upTo:j(a.upTo),colorHex:a.colorHex}))),i.bandAboveColorHex!==void 0&&i.bandAboveColorHex!==oe&&(t.bandAboveColorHex=i.bandAboveColorHex),i.highlight!==void 0&&i.highlight!=="none"&&(t.highlight=i.highlight),i.highColorHex!==void 0&&i.highColorHex!==qe&&(t.highColorHex=i.highColorHex),i.lowColorHex!==void 0&&i.lowColorHex!==Ye&&(t.lowColorHex=i.lowColorHex),i.parts!==void 0&&i.parts.length>0&&(t.parts=i.parts.map(lm),yt(i)&&(t.value=se($i(i.parts)))),da(i,t),{kind:"text",payload:t}}case"icon":{let t={...n(e.payload),symbol:se(e.payload.symbol)};return e.payload.path!==void 0&&e.payload.path!==""&&(t.path=e.payload.path),t.size=j(e.payload.size),da(e.payload,t),{kind:"icon",payload:t}}case"gauge":{let t=e.payload,i={...n(t),value:se(t.value),minValue:j(t.minValue),maxValue:j(t.maxValue),style:t.style,lineWidth:j(t.lineWidth),trackColorHex:t.trackColorHex};return t.coloring!=="uniform"&&(i.coloring=t.coloring),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,upTo:j(a.upTo),colorHex:a.colorHex}))),t.bandAboveColorHex!==oe&&(i.bandAboveColorHex=t.bandAboveColorHex),t.thresholdValue!==void 0&&(i.thresholdValue=j(t.thresholdValue)),t.thresholdColorHex!==Gn&&(i.thresholdColorHex=t.thresholdColorHex),t.total!==void 0&&(i.total=se(t.total)),t.minSource!==void 0&&(i.minSource=se(t.minSource)),t.maxSource!==void 0&&(i.maxSource=se(t.maxSource)),{kind:"gauge",payload:i}}case"chart":{let t=e.payload,i={...n(t),value:se(t.value),historyMinutes:Math.max(0,Math.round(t.historyMinutes)),historyPoints:Math.round(t.historyPoints),style:t.style,limit:Math.max(0,Math.round(t.limit)),takeFromEnd:t.takeFromEnd,scale:t.scale,minValue:j(t.minValue),maxValue:j(t.maxValue),baseline:t.baseline,barGap:j(t.barGap),lineWidth:j(t.lineWidth),highlight:t.highlight,highColorHex:t.highColorHex,lowColorHex:t.lowColorHex,marker:nd(bi(t)),coloring:t.coloring,bands:t.bands.map(c=>({id:c.id,upTo:j(c.upTo),colorHex:c.colorHex})),bandAboveColorHex:t.bandAboveColorHex,fillBands:t.fillBands};t.source!==Yr&&(i.source=t.source),t.statPeriod!==vi&&(i.statPeriod=t.statPeriod),t.statType!==wi&&(i.statType=t.statType),t.thresholdValue!==void 0&&(i.thresholdValue=j(t.thresholdValue)),t.thresholdColorHex!==Zr&&(i.thresholdColorHex=t.thresholdColorHex),t.nowIndex!==void 0&&(i.nowIndex=se(t.nowIndex)),t.nowColorHex!==Qr&&(i.nowColorHex=t.nowColorHex),t.drawsThreshold===!1&&(i.drawsThreshold=!1),t.drawsNowLine===!1&&(i.drawsNowLine=!1),t.drawsTimeLabels===!1&&(i.drawsTimeLabels=!1),t.scaleFrom!==void 0&&(i.scaleFrom=t.scaleFrom),t.labelSize!==Qe&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==et&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==nn&&(i.timeLabelCount=ft(t.timeLabelCount)),t.hourCycle!==an&&(i.hourCycle=t.hourCycle),t.minutes!==rn&&(i.minutes=t.minutes);let a=bi(t);id(a)||(i.highMarker=a.high,i.lowMarker=a.low);let r=t.curve??"straight";r!=="straight"&&(i.curve=r);let o=_t(t.fillStyle);o!=="flat"&&(i.fillStyle=o),t.fillColorHex!==void 0&&(i.fillColorHex=t.fillColorHex);let s=zt(t.barRadius);s!==Vn&&(i.barRadius=j(s));let l=Nt(t.barCorners);l!=="all"&&(i.barCorners=l);let d=tt(t.smoothing);return d!==void 0&&(i.smoothing=d),t.gaps===!0&&(i.gaps=!0),{kind:"chart",payload:i}}case"timeline":{let t=e.payload,i={id:t.id,rules:At(t.rules),frame:Ft(t.frame),isHidden:t.isHidden,value:se(t.value)};return t.historyMinutes!==co&&(i.historyMinutes=Math.max(1,Math.round(t.historyMinutes))),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,match:a.match,colorHex:a.colorHex}))),t.otherColorHex!==Ot&&(i.otherColorHex=t.otherColorHex),t.gap!==0&&(i.gap=j(t.gap)),t.cornerRadius!==cd&&(i.cornerRadius=j(t.cornerRadius)),t.labelSize!==Qe&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==et&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==nn&&(i.timeLabelCount=Math.max(0,Math.min(Si,Math.round(t.timeLabelCount)))),t.hourCycle!==an&&(i.hourCycle=t.hourCycle),t.minutes!==rn&&(i.minutes=t.minutes),{kind:"timeline",payload:i}}case"shape":{let t={...n(e.payload),kind:e.payload.kind,cornerRadius:j(e.payload.cornerRadius),borderWidth:j(e.payload.borderWidth)};return e.payload.borderColorHex!==void 0&&(t.borderColorHex=e.payload.borderColorHex),e.payload.thickness!==1&&(t.thickness=j(e.payload.thickness)),da(e.payload,t),{kind:"shape",payload:t}}case"image":{let t=e.payload,i={id:t.id,entity:Lt(t.entity),rules:At(t.rules),frame:Ft(t.frame),isHidden:t.isHidden};t.source!=="camera"&&(i.source=t.source),t.timestamp===!0&&(i.timestamp=!0),t.contentMode!=="fill"&&(i.contentMode=t.contentMode),t.zoom!==1&&(i.zoom=j(t.zoom)),t.panX!==0&&(i.panX=j(t.panX)),t.panY!==0&&(i.panY=j(t.panY)),t.cornerRadius!==Wn&&(i.cornerRadius=j(t.cornerRadius));let a=bt(t),r=a?po(t.timestampX,t.timestampY):t.timestampCorner;return r!=="topLeading"&&(i.timestampCorner=r),t.timestampSize!==jn&&(i.timestampSize=j(t.timestampSize)),a&&(i.timestampX=j(t.timestampX),i.timestampY=j(t.timestampY)),da(t,i),{kind:"image",payload:i}}case"tap":{let t=e.payload,i={id:t.id,action:Rd(t.action)};return t.openPageId!==void 0&&(i.openPageId=t.openPageId),t.openPageName!==void 0&&(i.openPageName=t.openPageName),t.attachedTo!==void 0&&(i.attachedTo=t.attachedTo),i.rules=At(t.rules),i.frame=Ft(t.frame),i.isHidden=t.isHidden,{kind:"tap",payload:i}}case"chartTimes":{let t=e.payload,i={id:t.id,rules:At(t.rules),frame:Ft(t.frame),isHidden:t.isHidden,chart:t.chart};return t.labelSize!==Qe&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==et&&(i.labelColorHex=t.labelColorHex),t.timeLabelCount!==nn&&(i.timeLabelCount=ft(t.timeLabelCount)),t.hourCycle!==an&&(i.hourCycle=t.hourCycle),t.minutes!==rn&&(i.minutes=t.minutes),{kind:"chartTimes",payload:i}}case"chartDots":{let t=e.payload,i={id:t.id,rules:At(t.rules),frame:Ft(t.frame),isHidden:t.isHidden,chart:t.chart};ma(t.dots)!=="auto"&&(i.dots="all");let a=mt(t.size);return a!==void 0&&(i.size=j(a)),t.colorHex!==void 0&&(i.colorHex=t.colorHex),{kind:"chartDots",payload:i}}case"chartGrid":{let t=e.payload,i={id:t.id,rules:At(t.rules),frame:Ft(t.frame),isHidden:t.isHidden,chart:t.chart},a=Dn(t.lines);a!==Pn&&(i.lines=a);let r=It(t.colorHex);Zl(r,ln)||(i.colorHex=r);let o=On(t.thickness);return o!==Nn&&(i.thickness=j(o)),{kind:"chartGrid",payload:i}}}}function um(e){let n={},t=Object.keys(e.placements);if(t.length>0){let i={};for(let a of t){let r=e.placements[a],o={frame:Ft(r.frame)};r.isHidden&&(o.isHidden=!0),r.size!==void 0&&(o.size=j(r.size)),i[a]=o}n.placements=i}if(e.bezelText&&(n.bezelText=se(e.bezelText)),e.bezelCountdown===!0&&(n.bezelCountdown=!0),e.curvedText&&(n.curvedText=se(e.curvedText)),e.curvedColorHex!==void 0&&(n.curvedColorHex=e.curvedColorHex),e.bezelGauge){let i=e.bezelGauge,a={value:se(i.value),minValue:j(i.minValue),maxValue:j(i.maxValue),colorHexes:i.colorHexes};i.minLabel&&(a.minLabel=se(i.minLabel)),i.maxLabel&&(a.maxLabel=se(i.maxLabel)),n.bezelGauge=a}return e.backgroundColorHex!==void 0&&(n.backgroundColorHex=e.backgroundColorHex),n.cornerBodyShape=e.cornerBodyShape,e.borderColorHex!==void 0&&(n.borderColorHex=e.borderColorHex),n.borderWidth=j(e.borderWidth),e.rules.length>0&&(n.rules=At(e.rules)),n}function Rd(e){if(e.type==="callService"){let n={type:e.type,serviceDomain:e.serviceDomain,serviceName:e.serviceName};return e.serviceDataJSON!==void 0&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),e.target!==void 0&&e.target.entityId!==""&&Object.assign(n,Lt(e.target)),n}return"entityId"in e?{type:e.type,...Lt(e)}:{type:e.type}}function pm(e){let n={};return e.label!==void 0&&(n.label=e.label),n.value=se(e.value),e.symbol!==void 0&&(n.symbol=e.symbol),e.countdown&&(n.countdown=!0),n}function Yn(e){let n=[];for(let i of re){let a=e.perFamily[i];a&&n.push(i,um(a))}let t={schemaVersion:sn(e),id:e.id,name:e.name,values:e.values.map(i=>({id:i.id,name:i.name,value:se(i.value)})),slotIndex:e.slotIndex,elements:e.elements.map(dm),supportedFamilies:e.supportedFamilies,perFamily:n,dataSources:e.dataSources.map(i=>i.kind==="template"?{kind:"template",value:i.value}:{kind:"entity",...Lt(i)}),tapAction:Rd(e.tapAction)};return e.inline!==void 0&&(t.inline=pm(e.inline)),e.refreshMinutes!==void 0&&(t.refreshMinutes=e.refreshMinutes),e.openPageId!==void 0&&(t.openPageId=e.openPageId),e.openPageName!==void 0&&(t.openPageName=e.openPageName),e.showSuccessFlash!==void 0&&(t.showSuccessFlash=e.showSuccessFlash),e.successFlashColorHex!==void 0&&(t.successFlashColorHex=e.successFlashColorHex),e.groups!==void 0&&e.groups.length>0&&(t.groups=e.groups.map(i=>({id:i.id,name:i.name,locked:i.locked}))),t}function vt(e,n){let i=e.elements.find(a=>a.payload.id===n)?.payload.groupId;return i===void 0?void 0:e.groups?.find(a=>a.id===i)}function wt(e,n){return e.elements.filter(t=>t.payload.groupId===n&&!fe(e,t))}function nt(e){let n=new Set((e.groups??[]).map(a=>a.id));for(let a of e.elements)a.payload.groupId!==void 0&&!n.has(a.payload.groupId)&&delete a.payload.groupId;let t=new Set(e.elements.map(a=>a.payload.groupId).filter(a=>a!==void 0)),i=(e.groups??[]).filter(a=>t.has(a.id));i.length===0?delete e.groups:e.groups=i}function Xn(e){if(!e.groups?.length)return;let n=e.elements.filter(r=>!fe(e,r)),t=e.elements.filter(r=>fe(e,r)),i=[],a=new Set;for(let r=n.length-1;r>=0;r--){let o=n[r];if(a.has(o.payload.id))continue;let s=o.payload.groupId;if(s===void 0){i.unshift(o),a.add(o.payload.id);continue}let l=n.filter(d=>d.payload.groupId===s);for(let d=l.length-1;d>=0;d--)i.unshift(l[d]),a.add(l[d].payload.id)}e.elements=[...i,...t],Ut(e)}function ko(e,n,t="Group"){let i=e.elements.filter(r=>n.includes(r.payload.id)&&!fe(e,r));if(i.length<2)return;let a={id:J(),name:t,locked:!0};e.groups=[...e.groups??[],a];for(let r of i)r.payload.groupId=a.id;return nt(e),Xn(e),a.id}function Ei(e,n){for(let t of e.elements)t.payload.groupId===n&&delete t.payload.groupId;nt(e)}function $o(e,n,t){let i=e.elements.find(a=>a.payload.id===n);!i||fe(e,i)||(t===void 0?delete i.payload.groupId:i.payload.groupId=t,nt(e),Xn(e))}var ie={config:["schemaVersion","id","name","values","slotIndex","elements","supportedFamilies","perFamily","inline","dataSources","refreshMinutes","tapAction","openPageId","openPageName","showSuccessFlash","successFlashColorHex","groups"],group:["id","name","locked"],inline:["label","value","symbol","countdown"],named:["id","name","value"],value:["kind","format"],format:["decimals","multiply","offset","prefix","suffix","useEntityUnit","relativeTime","duration","textCase"],entityRef:["entityId","displayName","domain","iconName"],aggregate:["function","scope","stateFilter","attribute"],scope:["kind","entities","domains","areaIds","labelIds","floorIds"],stateFilter:["kind","value"],frame:["x","y","width","height","rotationDegrees"],chartAnchor:["layer","at","place","dx","dy"],elementEnvelope:["kind","payload"],elementBase:["id","colorSlot","rules","frame","isHidden","groupId"],text:["value","fontSize","fontWeight","countdown","monospacedDigits","lineLimit","alignment","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex","parts","chartAnchor"],textPart:["id","value","colorHex","fontWeight","fontSize","coloring","bands","bandAboveColorHex"],icon:["symbol","path","size","chartAnchor"],gauge:["value","minValue","maxValue","style","lineWidth","trackColorHex","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","style","limit","takeFromEnd","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes","highMarker","lowMarker","curve","fillStyle","fillColorHex","barRadius","barCorners","smoothing","gaps","pointDots","pointDotSize","pointDotColorHex","gridLines","gridColorHex","zeroLine","bandLowColorHex","bandHighColorHex","bandLowerBound","bandUpperBound","scaleLabels","scaleLabelPlacement","latestLabel","topLabelStyle","bottomLabelStyle","latestLabelStyle","latestLabelFollowsBand","scaleLabelColorHex"],timeline:["value","historyMinutes","bands","otherColorHex","gap","cornerRadius","timeLabels","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["kind","cornerRadius","thickness","borderColorHex","borderWidth","chartAnchor"],image:["entity","source","timestamp","contentMode","zoom","panX","panY","cornerRadius","timestampCorner","timestampSize","timestampStyle","timestampX","timestampY","chartAnchor"],tap:["action","openPageId","openPageName","attachedTo","grow"],chartTimes:["chart","timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["chart","dots","size","colorHex"],chartGrid:["chart","lines","colorHex","thickness"],colorSlot:["baseColorHex"],rule:["id","cases","otherwise","partId"],case:["id","when","then"],condition:["join","tests"],test:["id","value","comparison"],comparison:["kind","value","upper","pattern","options"],styleChange:["kind","value","number","weight"],layout:["placements","bezelText","bezelCountdown","curvedText","curvedColorHex","bezelGauge","backgroundColorHex","cornerBodyShape","borderColorHex","borderWidth","rules"],bezelGauge:["value","minValue","maxValue","colorHexes","minLabel","maxLabel"],placement:["frame","isHidden","size"],tapAction:["type","entityId","displayName","domain","iconName","serviceDomain","serviceName","serviceDataJSON"]},Bl={literal:["kind","value"],entityState:["kind",...ie.entityRef],entityAttribute:["kind",...ie.entityRef,"attribute"],entityAge:["kind",...ie.entityRef],aggregate:["kind","aggregate"],time:["kind","timeField"],dataAge:["kind"],jinja:["kind","value"],named:["kind","id"],chartStat:["kind","layer","stat"]};function $a(e){let n=[],t=(l,d,c)=>{if(N(l))for(let u of Object.keys(l))d.includes(u)||n.push(`${c}.${u}`)},i=(l,d)=>{if(!N(l))return;let c=typeof l.kind=="string"?l.kind:"";t(l,Bl[c]??["kind"],d),c==="aggregate"&&N(l.aggregate)&&(t(l.aggregate,ie.aggregate,`${d}.aggregate`),t(l.aggregate.scope,ie.scope,`${d}.aggregate.scope`),N(l.aggregate.scope)&&Array.isArray(l.aggregate.scope.entities)&&l.aggregate.scope.entities.forEach((u,p)=>t(u,ie.entityRef,`${d}.aggregate.scope.entities[${p}]`)),t(l.aggregate.stateFilter,ie.stateFilter,`${d}.aggregate.stateFilter`))},a=(l,d)=>{if(N(l)){if(N(l.kind))t(l,ie.value,d),i(l.kind,`${d}.kind`);else{let c=typeof l.kind=="string"?l.kind:"";t(l,[...Bl[c]??["kind"],"format"],d),c==="aggregate"&&i(l,d)}t(l.format,ie.format,`${d}.format`)}},r=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{t(c,ie.styleChange,`${d}[${u}]`),N(c)&&a(c.value,`${d}[${u}].value`)})},o=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{let p=`${d}[${u}]`;t(c,ie.rule,p),N(c)&&(Array.isArray(c.cases)&&c.cases.forEach((m,b)=>{let g=`${p}.cases[${b}]`;t(m,ie.case,g),N(m)&&(t(m.when,ie.condition,`${g}.when`),N(m.when)&&Array.isArray(m.when.tests)&&m.when.tests.forEach((x,k)=>{let C=`${g}.when.tests[${k}]`;t(x,ie.test,C),N(x)&&(a(x.value,`${C}.value`),t(x.comparison,ie.comparison,`${C}.comparison`),N(x.comparison)&&(a(x.comparison.value,`${C}.comparison.value`),a(x.comparison.upper,`${C}.comparison.upper`)))}),r(m.then,`${g}.then`))}),r(c.otherwise,`${p}.otherwise`))})};if(!N(e))return n;t(e,ie.config,"$"),Array.isArray(e.groups)&&e.groups.forEach((l,d)=>t(l,ie.group,`$.groups[${d}]`)),Array.isArray(e.values)&&e.values.forEach((l,d)=>{t(l,ie.named,`$.values[${d}]`),N(l)&&a(l.value,`$.values[${d}].value`)}),Array.isArray(e.elements)&&e.elements.forEach((l,d)=>{let c=`$.elements[${d}]`;if(t(l,ie.elementEnvelope,c),!N(l)||!N(l.payload))return;let u=typeof l.kind=="string"?l.kind:"",p=ie[u]??[];t(l.payload,[...ie.elementBase,...p],`${c}.payload`),t(l.payload.colorSlot,ie.colorSlot,`${c}.payload.colorSlot`),t(l.payload.frame,ie.frame,`${c}.payload.frame`),"chartAnchor"in l.payload&&t(l.payload.chartAnchor,ie.chartAnchor,`${c}.payload.chartAnchor`),o(l.payload.rules,`${c}.payload.rules`);for(let m of["value","symbol","nowIndex","total","minSource","maxSource"])m in l.payload&&a(l.payload[m],`${c}.payload.${m}`);u==="text"&&Array.isArray(l.payload.parts)&&l.payload.parts.forEach((m,b)=>{t(m,ie.textPart,`${c}.payload.parts[${b}]`),N(m)&&a(m.value,`${c}.payload.parts[${b}].value`)}),u==="image"&&t(l.payload.entity,ie.entityRef,`${c}.payload.entity`),u==="tap"&&t(l.payload.action,ie.tapAction,`${c}.payload.action`)});let s=[];if(Array.isArray(e.perFamily))for(let l=0;l+1<e.perFamily.length;l+=2)s.push([String(e.perFamily[l]),e.perFamily[l+1]]);else N(e.perFamily)&&s.push(...Object.entries(e.perFamily));for(let[l,d]of s){let c=`$.perFamily.${l}`;if(t(d,ie.layout,c),!!N(d)){if(N(d.placements))for(let[u,p]of Object.entries(d.placements))t(p,ie.placement,`${c}.placements.${u}`),N(p)&&t(p.frame,ie.frame,`${c}.placements.${u}.frame`);if(a(d.bezelText,`${c}.bezelText`),a(d.curvedText,`${c}.curvedText`),N(d.bezelGauge)){let u=`${c}.bezelGauge`;t(d.bezelGauge,ie.bezelGauge,u),a(d.bezelGauge.value,`${u}.value`),a(d.bezelGauge.minLabel,`${u}.minLabel`),a(d.bezelGauge.maxLabel,`${u}.maxLabel`)}o(d.rules,`${c}.rules`)}}return N(e.inline)&&(t(e.inline,ie.inline,"$.inline"),a(e.inline.value,"$.inline.value")),t(e.tapAction,ie.tapAction,"$.tapAction"),n}function J(){let e=globalThis.crypto;if(e&&"randomUUID"in e)return e.randomUUID().toUpperCase();let n=()=>Math.floor(Math.random()*65536).toString(16).padStart(4,"0"),t=(8+Math.floor(Math.random()*4)).toString(16)+n().slice(1);return`${n()}${n()}-${n()}-4${n().slice(1)}-${t}-${n()}${n()}${n()}`.toUpperCase()}function kt(){return{placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}}function Fd(e,n,t=[...re]){let i={};for(let r of re)t.includes(r)&&(i[r]=kt());let a={schemaVersion:4,id:J(),name:e,values:[],slotIndex:n,elements:[],supportedFamilies:gi.filter(r=>t.includes(r)),perFamily:i,dataSources:[],refreshMinutes:0,tapAction:{type:"refresh"}};return t.includes("inline")&&(a.inline={value:_("Text")}),a.schemaVersion=sn(a),a}function Ce(e){let n=t=>({id:J(),colorSlot:{baseColorHex:t},rules:[],frame:{...ki},isHidden:!1});switch(e){case"text":return{kind:e,payload:{...n("#FFFFFF"),value:_("Text"),fontSize:14,fontWeight:"regular"}};case"icon":return{kind:e,payload:{...n("#FFFFFF"),symbol:_("lightbulb"),size:14}};case"gauge":return{kind:e,payload:{...n("#FFFFFF"),value:_("50"),minValue:0,maxValue:100,style:"arc",lineWidth:4,trackColorHex:"#FFFFFF40",coloring:"uniform",bands:[],bandAboveColorHex:oe,thresholdColorHex:Gn}};case"chart":return{kind:e,payload:{...n("#FFFFFF"),value:_("13,14,16,17,19,22,24,28,30"),historyMinutes:ba,historyPoints:24,source:Yr,statPeriod:vi,statType:wi,style:"bars",curve:"smooth",fillStyle:"fade",limit:0,takeFromEnd:!1,scale:"auto",minValue:0,maxValue:100,baseline:"lowest",barGap:1.5,lineWidth:2,highlight:"none",highColorHex:qe,lowColorHex:Ye,marker:"none",coloring:"uniform",bands:[],bandAboveColorHex:oe,fillBands:!1,thresholdColorHex:Zr,nowColorHex:Qr,timeLabelCount:nn,labelSize:Qe,labelColorHex:et,labelsAbove:!1,hourCycle:an,minutes:rn}};case"timeline":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,value:_(""),historyMinutes:_h,bands:[],otherColorHex:Hh,gap:0,cornerRadius:Lh,timeLabelCount:ud,labelSize:Qe,labelColorHex:et,labelsAbove:!1,hourCycle:an,minutes:rn}}}case"shape":return{kind:e,payload:{...n("#FFFFFF33"),kind:"roundedRectangle",cornerRadius:6,thickness:1,borderWidth:1}};case"image":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,entity:{entityId:"",displayName:"",domain:"camera"},source:"camera",contentMode:"fill",zoom:1,panX:0,panY:0,cornerRadius:Wn,timestampCorner:"topLeading",timestampSize:jn}}}case"tap":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,action:{type:"refresh"}}}}case"chartTimes":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",timeLabelCount:nn,labelSize:Qe,labelColorHex:et,hourCycle:an,minutes:rn}}}case"chartDots":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",dots:"auto"}}}case"chartGrid":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",lines:Pn,colorHex:ln,thickness:Nn}}}}}function _(e){return{kind:{kind:"literal",value:e}}}function Ca(e){switch(e.kind){case"text":return e.payload.fontSize;case"icon":return e.payload.size;case"gauge":return e.payload.lineWidth;case"chart":return e.payload.lineWidth;case"timeline":return;case"shape":return;case"image":return;case"tap":return;case"chartTimes":return;case"chartDots":return;case"chartGrid":return}}var Gl=["circular","corner"],Ul=Math.SQRT1_2;function hm(e){return e==="text"||e==="icon"?4:.5}function Co(e,n,t,i){let a=structuredClone(e),r=pe[n],o=pe[t];if(n===t||!r||!o)return a;let s=Gl.includes(n),l=Gl.includes(t),d=s===l?1:l?Ul:1/Ul,c=Math.min(o.width/r.width,o.height/r.height)*d;if(d!==1){let u=a.frame,p=u.x+u.width/2,m=u.y+u.height/2;a.frame={...u,width:u.width*d,height:u.height*d,x:.5+(p-.5)*d-u.width*d/2,y:.5+(m-.5)*d-u.height*d/2}}return a.size!==void 0&&(a.size=Math.max(hm(i),Math.round(a.size*c*10)/10)),a}function Ad(e,n){let t=e.perFamily[n];return!t||Object.keys(t.placements).length===0?e.elements:e.elements.map(i=>{let a=t.placements[i.payload.id];if(!a)return i;let r={...i.payload,frame:a.frame,isHidden:a.isHidden};return a.size!==void 0&&(i.kind==="text"?r.fontSize=a.size:i.kind==="icon"?r.size=a.size:(i.kind==="gauge"||i.kind==="chart")&&(r.lineWidth=a.size)),{kind:i.kind,payload:r}})}function xn(e){switch(e.kind){case"text":return e.payload.value;case"icon":return e.payload.symbol;case"gauge":return e.payload.value;case"chart":return e.payload.value;case"timeline":return e.payload.value;case"shape":return;case"image":return{kind:{kind:"entityState",...e.payload.entity}};case"tap":return;case"chartTimes":return;case"chartDots":return;case"chartGrid":return}}function xi(e){let n=[],t=i=>{for(let a of i)a.value&&n.push(a.value)};for(let i of e){for(let a of i.cases){for(let r of a.when.tests)n.push(r.value),r.comparison.value&&n.push(r.comparison.value),r.comparison.upper&&n.push(r.comparison.upper);t(a.then)}i.otherwise&&t(i.otherwise)}return n}var So=["light","switch","fan","input_boolean","cover","lock","media_player","siren","humidifier","valve","automation","group"];function ha(e,n){let t,i=n;for(let a=0;i!==void 0&&a<4;a++){let r=i.kind;if(r.kind==="chartStat"){i=fo(e,i)?.payload.value;continue}if("entityId"in r){if(r.entityId==="")return;let o={entityId:r.entityId,displayName:r.displayName,domain:r.domain};return t===void 0?{ref:o}:{ref:o,namedId:t}}if(r.kind!=="named")return;t=r.id.toUpperCase(),i=e.values.find(o=>o.id.toUpperCase()===t)?.value}}function To(e,n){return ha(e,xn(n))?.ref}function Eo(e,n){let t=To(e,n),i=t&&(t.domain||t.entityId.split(".")[0])||"";return t&&So.includes(i)?{type:"toggleEntity",...t,domain:i}:{type:"refresh"}}function Kl(e,n,t){if(ka(n)||t.width<=0||t.height<=0)return{...e};let i=n,a=e.x-i.left/t.width,r=e.x+e.width+i.right/t.width,o=e.y-i.top/t.height,s=e.y+e.height+i.bottom/t.height;return r<a&&(a=r=(a+r)/2),s<o&&(o=s=(o+s)/2),a=ot(a),r=ot(r),o=ot(o),s=ot(s),{...e,x:a,y:o,width:Math.max(0,r-a),height:Math.max(0,s-o)}}function Id(e,n,t){let i=a=>Math.round(a*100)/100||0;return{left:i((e.x-n.x)*t.width),right:i((n.x+n.width-e.x-e.width)*t.width),top:i((e.y-n.y)*t.height),bottom:i((n.y+n.height-e.y-e.height)*t.height)}}function Hd(e,n,t,i){let a=e.elements.find(p=>p.payload.id===n);if(!a||a.kind!=="tap"||a.payload.attachedTo===void 0)return;let r=e.elements.find(p=>p.payload.id===a.payload.attachedTo);if(!r)return;let o=e.perFamily[t]?.placements[r.payload.id]?.frame??r.payload.frame,s=ot(i.x),l=ot(i.y),d=ot(i.x+i.width),c=ot(i.y+i.height),u={...i,x:s,y:l,width:Math.max(0,d-s),height:Math.max(0,c-l)};a.payload.outset=Id(o,u,pe[t])}function Ld(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i)return;let a=e.perFamily[t];if(!a)return;let r=a.placements[n]?.frame??i.payload.frame,o=pe[t];return{width:r.width*o.width,height:r.height*o.height}}function Ve(e,n){return e.elements.filter(t=>t.kind==="tap"&&t.payload.attachedTo===n)}function fe(e,n){return n.kind!=="tap"||n.payload.attachedTo===void 0?!1:e.elements.some(t=>t.payload.id===n.payload.attachedTo&&t.kind!=="tap")}function Mo(e,n){let t=e.elements.find(i=>i.payload.id===n);if(t){if(t.kind==="tap"&&t.payload.attachedTo!==void 0){let i=e.elements.find(a=>a.payload.id===t.payload.attachedTo);if(i)return i.payload.id}return t.payload.id}}function Ut(e){let n=new Map(e.elements.map(a=>[a.payload.id,a])),t=new Map;for(let a of e.elements){if(a.kind!=="tap")continue;let r=a.payload.attachedTo;if(r===void 0)continue;let o=n.get(r);if(!o||o.kind==="tap"||r===a.payload.id){delete a.payload.attachedTo;continue}let s=t.get(r);s?s.push(a):t.set(r,[a])}if(t.size===0)return;for(let[a,r]of t){let o=n.get(a);for(let s of r){let l=s.payload;l.outset===void 0&&(l.outset=Id(o.payload.frame,l.frame,pe.rectangular));let d=l.outset,c=!ka(d);s.payload.frame=Kl(o.payload.frame,d,pe.rectangular),s.payload.isHidden=o.payload.isHidden;let u=fm(e,a);for(let p of re){let m=e.perFamily[p];if(!m)continue;let b=pe[p],g=m.placements[a];p!==u||!g?delete m.placements[s.payload.id]:c?m.placements[s.payload.id]={frame:Kl(g.frame,d,b),isHidden:g.isHidden}:m.placements[s.payload.id]={frame:{...g.frame},isHidden:g.isHidden}}}}let i=[];for(let a of e.elements){if(a.kind==="tap"&&a.payload.attachedTo!==void 0)continue;i.push(a);let r=t.get(a.payload.id);r&&i.push(...r)}e.elements=i}function Sa(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind==="tap")return;let a=Ve(e,n)[0];if(a)return a.payload;let r=Ce("tap"),o=r.payload;return o.attachedTo=n,o.outset={...ho},o.action=t??Eo(e,i),e.elements.push(r),Ut(e),o}function Ta(e,n){let t=Ve(e,n).map(i=>i.payload.id);if(t.length!==0){e.elements=e.elements.filter(i=>!t.includes(i.payload.id));for(let i of re)for(let a of t)delete e.perFamily[i]?.placements[a]}}function $e(e,n){for(let a of fn(e,n))$e(e,a.payload.id);for(let a of gn(e,n))$e(e,a.payload.id);for(let a of yn(e,n))$e(e,a.payload.id);for(let a of bn(e,n))$e(e,a.payload.id);for(let a of Oe(e,n))delete a.payload.chartAnchor;let t=e.elements.find(a=>a.payload.id===n);Ta(e,n),e.elements=e.elements.filter(a=>a.payload.id!==n);let i=t?.payload.chartAnchor;if(i&&(i.at==="threshold"||i.at==="now")&&!Oe(e,i.layer).some(a=>a.payload.chartAnchor?.at===i.at)){let a=e.elements.find(r=>r.payload.id===i.layer);a?.kind==="chart"&&(i.at==="threshold"?(delete a.payload.thresholdValue,delete a.payload.drawsThreshold):(delete a.payload.nowIndex,delete a.payload.drawsNowLine))}for(let a of e.elements)a.kind==="chart"&&a.payload.scaleFrom===n&&delete a.payload.scaleFrom;for(let a of re)delete e.perFamily[a]?.placements[n];Ut(e),nt(e)}function _d(e,n){let t=e.elements.findIndex(l=>l.payload.id===n),i=e.elements[t];if(!i)return;let a=J(),r=structuredClone(i);r.payload.id=a,r.payload.frame={...r.payload.frame,x:Math.min(.9,r.payload.frame.x+.05),y:Math.min(.9,r.payload.frame.y+.05)};let o=[r],s=[[n,a]];for(let l of Ve(e,n)){let d=structuredClone(l);d.payload.id=J(),d.payload.attachedTo=a,o.push(d),s.push([l.payload.id,d.payload.id])}e.elements.splice(t+1,0,...o);for(let l of re){let d=e.perFamily[l];if(d)for(let[c,u]of s){let p=d.placements[c];p&&(d.placements[u]=structuredClone(p))}}return Ut(e),a}function zd(e,n){let t=e.elements.findIndex(o=>o.payload.id===n),i=e.elements[t];if(!i||i.kind!=="chart")return;let a=J(),r=structuredClone(i);r.payload.id=a,r.payload.scaleFrom=n,e.elements.splice(t+1,0,r);for(let o of re){let s=e.perFamily[o],l=s?.placements[n];s&&l&&(s.placements[a]=structuredClone(l))}return a}function Jn(e,n,t){let i=new Set,a=d=>{i.add(d);for(let c of Ve(e,d))i.add(c.payload.id)};for(let d of n){a(d);for(let c of fn(e,d))a(c.payload.id)}let r=e.elements.filter(d=>i.has(d.payload.id)).map(d=>structuredClone(d)),o={};for(let d of re){let c=e.perFamily[d];if(!c)continue;let u={};for(let p of r){let m=c.placements[p.payload.id];m&&(u[p.payload.id]=structuredClone(m))}Object.keys(u).length>0&&(o[d]=u)}let s=new Set(r.map(d=>d.payload.groupId).filter(d=>d!==void 0)),l=(e.groups??[]).filter(d=>s.has(d.id)).map(d=>structuredClone(d));return{elements:r,placements:o,groups:l,...t!==void 0?{family:t}:{}}}function Nd(e,n,t){let i=n.family,a=i!==void 0&&i!==t&&re.includes(i);if(!re.includes(t))return on(e,n);let r=on(e,n,a?{nudge:!1}:{}),o=e.perFamily[t]??(e.perFamily[t]=kt());for(let s of r){let l=e.elements.find(p=>p.payload.id===s);if(!l)continue;let d=(i!==void 0?e.perFamily[i]?.placements[s]:void 0)??re.map(p=>e.perFamily[p]?.placements[s]).find(p=>p!==void 0),c=d?.size??Ca(l),u={frame:{...d?.frame??l.payload.frame},isHidden:!1,...c!==void 0?{size:c}:{}};for(let p of re)p!==t&&delete e.perFamily[p]?.placements[s];o.placements[s]=a?Co(u,i,t,l.kind):u}return Zn(e,t),r}function on(e,n,t={}){let i=new Map;for(let d of n.elements)i.set(d.payload.id,J());let a=new Set(e.elements.map(d=>d.payload.id)),r=t.nudge!==!1&&n.elements.some(d=>a.has(d.payload.id)),o=d=>r?{...d,x:Math.min(.9,d.x+.05),y:Math.min(.9,d.y+.05)}:d,s=[];for(let d of n.elements){let c=structuredClone(d);if(c.payload.id=i.get(d.payload.id),c.kind==="tap"&&c.payload.attachedTo!==void 0){let u=i.get(c.payload.attachedTo);u?c.payload.attachedTo=u:delete c.payload.attachedTo}if(c.kind==="chart"&&c.payload.scaleFrom!==void 0){let u=i.get(c.payload.scaleFrom);u?c.payload.scaleFrom=u:a.has(c.payload.scaleFrom)||delete c.payload.scaleFrom}if(c.kind==="text")for(let u of c.payload.parts??[]){let p=u.value.kind,m=p.kind==="chartStat"?i.get(p.layer):void 0;p.kind==="chartStat"&&m&&(p.layer=m)}if(c.kind==="text"&&c.payload.value.kind.kind==="chartStat"){let u=i.get(c.payload.value.kind.layer);if(u)c.payload.value.kind.layer=u;else if(!a.has(c.payload.value.kind.layer))continue}if(c.kind==="chartTimes"||c.kind==="chartDots"||c.kind==="chartGrid"){let u=i.get(c.payload.chart);if(u)c.payload.chart=u;else if(!a.has(c.payload.chart))continue}if(c.payload.chartAnchor!==void 0){let u=i.get(c.payload.chartAnchor.layer);u?c.payload.chartAnchor.layer=u:a.has(c.payload.chartAnchor.layer)||delete c.payload.chartAnchor}c.payload.frame=o(c.payload.frame),s.push(c)}let l=new Map;for(let d of n.groups){if(s.filter(p=>p.payload.groupId===d.id&&!(p.kind==="tap"&&p.payload.attachedTo!==void 0)).length<2)continue;let u=J();l.set(d.id,u),(e.groups??=[]).push({...structuredClone(d),id:u})}for(let d of s){if(d.payload.groupId===void 0)continue;let c=l.get(d.payload.groupId);c?d.payload.groupId=c:delete d.payload.groupId}e.elements.push(...s);for(let d of re){let c=n.placements[d],u=e.perFamily[d];if(!(!c||!u))for(let[p,m]of Object.entries(c)){let b=i.get(p);b&&s.some(g=>g.payload.id===b)&&(u.placements[b]={...structuredClone(m),frame:o(m.frame)})}}return Ut(e),nt(e),Xn(e),s.filter(d=>!fe(e,d)).map(d=>d.payload.id)}function mm(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?!a.isHidden:!t.payload.isHidden}function fm(e,n){let t=e.elements.find(r=>r.payload.id===n),a=(t&&t.kind==="tap"?t.payload.attachedTo:void 0)??n;return re.find(r=>e.supportedFamilies.includes(r)&&e.perFamily[r]?.placements[a]!==void 0)}function lt(e,n){let t=e.perFamily[n];return t?e.elements.filter(i=>{let a=i.kind==="tap"?i.payload.attachedTo:void 0;return t.placements[a??i.payload.id]!==void 0}):[]}function Pd(e,n){let t=e.perFamily[n];return t?lt(e,n).filter(i=>!fe(e,i)&&!t.placements[i.payload.id]?.isHidden).length:0}function Zn(e,n){let t=re.filter(s=>e.supportedFamilies.includes(s));if(t.length===0)return;let i=n!==void 0&&t.includes(n)?n:t[0];for(let s of t)e.perFamily[s]||(e.perFamily[s]=kt());let a=()=>e.elements.filter(s=>!fe(e,s)),r=new Map,o=new Set;if(n===void 0){let s=new Map(a().map(p=>[p.payload.id,t.filter(m=>mm(e,m,p))]));for(let[p,m]of s)m[0]&&r.set(p,m[0]);let l=new Map([...a().entries()].map(([p,m])=>[m.payload.id,p]));for(let p of t){let m=a().filter(x=>(s.get(x.payload.id)??[]).includes(p)&&r.get(x.payload.id)!==p).map(x=>x.payload.id);if(m.length===0)continue;let b=Jn(e,m,p),g=on(e,b,{nudge:!1});g.forEach((x,k)=>{r.set(x,p);let C=g.length===m.length?m[k]:void 0;l.set(x,C!==void 0?l.get(C)??0:l.size)})}for(let p of a())r.has(p.payload.id)||o.add(p.payload.id);let d=p=>t.indexOf(r.get(p)??i),c=a().sort((p,m)=>d(p.payload.id)-d(m.payload.id)||(l.get(p.payload.id)??0)-(l.get(m.payload.id)??0)),u=[];for(let p of c)u.push(p),u.push(...Ve(e,p.payload.id));e.elements=u}for(let s of a()){let l=s.payload.id,d=t.filter(m=>e.perFamily[m].placements[l]!==void 0),c=r.get(l)??d.find(m=>!e.perFamily[m].placements[l].isHidden)??d[0]??i,u=e.perFamily[c]?.placements[l],p={frame:{...u?.frame??s.payload.frame},isHidden:o.has(l)||u?.isHidden===!0,...u?.size!==void 0?{size:u.size}:{}};s.payload.isHidden=!0;for(let m of re){let b=e.perFamily[m];b&&(m===c?b.placements[l]=p:delete b.placements[l])}}}function Ea(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t)return[];let i=[],a=ha(e,xn(t));if(a){let r=t.kind==="icon"?"symbol":t.kind==="image"?"camera":"value";i.push(a.namedId===void 0?{where:r,ref:a.ref}:{where:r,ref:a.ref,namedId:a.namedId})}for(let r of Ve(e,n)){let o=r.payload.action;!("entityId"in o)||o.entityId===""||i.push({where:"tap",ref:{entityId:o.entityId,displayName:o.displayName,domain:o.domain},tapId:r.payload.id})}for(let r of t.payload.rules)for(let o of r.cases)for(let s of o.when.tests){let l=ha(e,s.value);if(!l)continue;let d={where:"test",ref:l.ref,ruleId:r.id,caseId:o.id,testId:s.id};l.namedId!==void 0&&(d.namedId=l.namedId),i.push(d)}return i}function Br(e,n,t){if(!e)return;let i=e.kind;switch(i.kind){case"entityState":return{...e,kind:{kind:"entityState",...n}};case"entityAge":return{...e,kind:{kind:"entityAge",...n}};case"entityAttribute":return{...e,kind:{kind:"entityAttribute",...n,attribute:i.attribute}};case"literal":return t==="text"||t==="gauge"||t==="chart"||t==="timeline"?{...e,kind:{kind:"entityState",...n}}:void 0;default:return}}function Dd(e,n,t,i){let a=e.elements.find(o=>o.payload.id===n);if(!a||t.entityId==="")return;let r={...t,domain:t.domain||t.entityId.split(".")[0]||""};if(a.kind==="timeline"){let o=a.payload.value.kind.kind==="entityState"?a.payload.value.kind.entityId:void 0,s=Br(a.payload.value,r,a.kind);s&&(a.payload.value=s),(a.payload.bands.length===0||o!==r.entityId)&&(a.payload.bands=uo(r.domain,i))}else if(a.kind==="image")a.payload.entity=r;else if(a.kind==="text"||a.kind==="gauge"||a.kind==="chart"){let o=Br(a.payload.value,r,a.kind);o&&(a.payload.value=o)}else if(a.kind==="icon"){let o=Br(a.payload.symbol,r,a.kind);o&&(a.payload.symbol=o)}for(let o of Ve(e,n)){let s=o.payload;"entityId"in s.action&&(s.action={type:s.action.type,...r})}}var gm={text:"text",icon:"icon",gauge:"gauge",chart:"chart",timeline:"timeline",shape:"shape",image:"picture",tap:"tap area",chartTimes:"chart times",chartDots:"chart dots",chartGrid:"chart grid"};function Wl(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function jl(e){if(e.part==="template")return"Template text";if(e.part==="serviceData")return"Service data";let n=e.layerKind===void 0?"":gm[e.layerKind],t=e.layerName?`${n} "${e.layerName}"`:n;switch(e.kind){case"named":return e.valueName?`Shared value "${e.valueName}"`:"Shared value";case"layer":case"image":return e.part==="total"?`Total on ${t}`:e.part==="gaugeMin"?`Min on ${t}`:e.part==="gaugeMax"?`Max on ${t}`:e.part==="nowIndex"?`Now marker on ${t}`:e.part==="textPart"?`Part of ${t}`:`${Wl(n)} layer${e.layerName?` "${e.layerName}"`:""}`;case"tap":return"Tap area";case"documentTap":return"Tap action";case"rule":return t===""?`Rule on the ${e.family??"shared"} shape`:`Rule on ${t}`;case"layout":{let i=Wl(e.family??"");switch(e.part){case"curvedText":return`${i} curved text`;case"bezelGauge":return`${i} bezel gauge`;case"bezelGaugeMin":return`${i} bezel gauge low label`;case"bezelGaugeMax":return`${i} bezel gauge high label`;default:return`${i} bezel`}}case"inline":return"Inline"}}var Od=/(['"])([a-z0-9_]+\.[a-z0-9_]+)\1/g;function ym(e){let n=[];for(let t of e.matchAll(Od))t[2]!==void 0&&n.push(t[2]);return n}function Ro(e,n){return n.size===0?e:e.replace(Od,(t,i,a)=>{let r=n.get(a);return r===void 0?t:`${i}${r}${i}`})}function fi(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function bm(e,n){if(n.kind==="shape")return n.payload.kind==="roundedRectangle"?"rounded rectangle":n.payload.kind;if(n.kind==="tap")return"";if(n.kind==="image")return n.payload.entity.displayName||n.payload.entity.entityId;let t=xn(n)?.kind;if(t===void 0)return"";if(t.kind==="literal")return t.value;if("entityId"in t)return t.displayName||t.entityId;if(t.kind==="named"){let i=t.id.toUpperCase();return e.values.find(a=>a.id.toUpperCase()===i)?.name??""}return""}function Ma(e,n){let t=(r,o)=>{n.value?.(r,o);let s=r.kind;if(s.kind==="jinja"){if(n.text){let d=n.text(s.value,{...o,part:"template"});d!==s.value&&(s.value=d)}return}if(s.kind==="aggregate"){let d=s.aggregate.scope;if(n.ref&&d.kind==="entities")for(let c=0;c<d.entities.length;c++){let u=n.ref(fi(d.entities[c]),o);u&&(d.entities[c]=u)}return}if(!n.ref||!("entityId"in s))return;let l=n.ref(fi(s),o);l&&(s.kind==="entityAttribute"?r.kind={kind:"entityAttribute",...l,attribute:s.attribute}:s.kind==="entityState"?r.kind={kind:"entityState",...l}:r.kind={kind:"entityAge",...l})},i=(r,o,s)=>{if(r.type==="callService"){if(n.ref&&r.target!==void 0&&r.target.entityId!==""){let d=n.ref(fi(r.target),o);d&&(r.target=d)}if(n.text&&r.serviceDataJSON!==void 0){let d=n.text(r.serviceDataJSON,{...o,part:"serviceData"});d!==r.serviceDataJSON&&(r.serviceDataJSON=d)}return}if(!n.ref||!("entityId"in r)||r.entityId==="")return;let l=n.ref(fi(r),o);l&&s({type:r.type,...l})};for(let r of e.values)t(r.value,{kind:"named",valueId:r.id,valueName:r.name});for(let r of e.elements){let o={kind:"layer",layerId:r.payload.id,layerKind:r.kind,layerName:bm(e,r)};if(r.kind==="image"){if(n.ref){let l=n.ref(fi(r.payload.entity),{...o,kind:"image"});l&&(r.payload.entity=l)}}else if(r.kind==="tap"){let l=r.payload;i(l.action,{...o,kind:"tap"},d=>{l.action=d})}else{let l=xn(r);if(l&&t(l,o),r.kind==="text")for(let d of r.payload.parts??[])t(d.value,{...o,part:"textPart"});r.kind==="gauge"&&r.payload.total&&t(r.payload.total,{...o,part:"total"}),r.kind==="gauge"&&r.payload.minSource&&t(r.payload.minSource,{...o,part:"gaugeMin"}),r.kind==="gauge"&&r.payload.maxSource&&t(r.payload.maxSource,{...o,part:"gaugeMax"}),r.kind==="chart"&&r.payload.nowIndex&&t(r.payload.nowIndex,{...o,part:"nowIndex"})}let s={...o,kind:"rule"};for(let l of xi(r.payload.rules))t(l,s)}let a=Object.keys(e.perFamily).sort((r,o)=>{let s=gi.indexOf(r),l=gi.indexOf(o);return(s<0?gi.length:s)-(l<0?gi.length:l)});for(let r of a){let o=e.perFamily[r];if(!o)continue;let s={kind:"layout",family:r};o.bezelText&&t(o.bezelText,{...s,part:"bezelText"}),o.curvedText&&t(o.curvedText,{...s,part:"curvedText"});let l=o.bezelGauge;l&&(t(l.value,{...s,part:"bezelGauge"}),l.minLabel&&t(l.minLabel,{...s,part:"bezelGaugeMin"}),l.maxLabel&&t(l.maxLabel,{...s,part:"bezelGaugeMax"}));let d={kind:"rule",family:r};for(let c of xi(o.rules))t(c,d)}e.inline&&t(e.inline.value,{kind:"inline"}),i(e.tapAction,{kind:"documentTap"},r=>{e.tapAction=r})}function Ra(e,n){Ma(e,{value:n})}function Vd(e,n){return e.kind.kind==="named"&&e.kind.id.toUpperCase()===n.toUpperCase()}function Mi(e,n){let t=new Set;return Ra(e,(i,a)=>{Vd(i,n)&&t.add(a.layerId??`${a.kind}:${a.valueId??""}:${a.family??""}:${a.part??""}`)}),t.size}function xm(e,n){let t=new Set(e.values.map(a=>a.name.trim().toLowerCase())),i=n.trim()||"Value";if(!t.has(i.toLowerCase()))return i;for(let a=2;;a++){let r=`${i} ${a}`;if(!t.has(r.toLowerCase()))return r}}function Fo(e,n,t){let i={id:J(),name:xm(e,t),value:{kind:structuredClone(n.kind)}},a={kind:{kind:"named",id:i.id}};return n.format&&!Ae(n.format)&&(a.format=structuredClone(n.format)),{named:i,ref:a}}function Ao(e,n){if(n.kind.kind!=="named")return;let t=n.kind.id,i=e.values.find(o=>o.id.toUpperCase()===t.toUpperCase());if(!i)return;let a=n.format&&!Ae(n.format)?n.format:i.value.format,r={kind:structuredClone(i.value.kind)};return a&&!Ae(a)&&(r.format=structuredClone(a)),r}function Io(e,n){Ra(e,t=>{if(!Vd(t,n))return;let i=Ao(e,t);i&&(t.kind=i.kind,i.format?t.format=i.format:delete t.format)}),e.values=e.values.filter(t=>t.id.toUpperCase()!==n.toUpperCase())}function Ho(e,n){Ma(e,{ref:n})}function Lo(e,n){Ma(e,{text:n})}function _o(e,n){let t=[],i={ref:(a,r)=>{a.entityId!==""&&t.push({entityId:a.entityId,ref:a,where:jl(r)})}};return n&&(i.text=(a,r)=>{for(let o of ym(a)){let s=o.split(".")[0]??"";n(o,s)&&t.push({entityId:o,ref:{entityId:o,displayName:"",domain:s},where:jl(r)})}return a}),Ma(e,i),t}var Ri={text:["color","opacity","text","fontSize","fontWeight","rotation","visibility"],icon:["color","opacity","icon","fontSize","rotation","visibility"],gauge:["color","opacity","gaugeValue","gaugeMin","gaugeMax","rotation","visibility"],chart:["color","opacity","rotation","visibility"],timeline:["opacity","rotation","visibility"],shape:["color","opacity","borderColor","borderWidth","rotation","visibility"],image:["opacity","rotation","visibility"],tap:["visibility"],chartTimes:["opacity","rotation","visibility"],chartDots:["opacity","visibility"],chartGrid:["opacity","visibility"],layout:["backgroundColor","borderColor","borderWidth","text"]},Bd=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","greaterThan","greaterOrEqual","lessThan","lessOrEqual","between","timeBetween","contains","startsWith","endsWith","matchesRegex","isOneOf"];function vn(e){let n=e.trim();return/^([01][0-9]|2[0-3]):[0-5][0-9]$/.test(n)?n:void 0}function wn(e){switch(e){case"isOn":case"isOff":case"isUnavailable":case"isStale":case"isEmpty":return"none";case"between":return"between";case"timeBetween":return"times";case"matchesRegex":return"pattern";case"isOneOf":return"options";default:return"value"}}function Fa(e){switch(e){case"hide":case"show":return"none";case"setFontWeight":return"weight";case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":return"number";default:return"value"}}function zo(){return{id:J(),value:_(""),comparison:{kind:"isOn"}}}function No(){return{id:J(),when:{join:"all",tests:[zo()]},then:[]}}function Fi(){return{id:J(),cases:[No()]}}function ql(e,n){return e&&(e.kind.kind!=="literal"||vn(e.kind.value)!==void 0)?e:_(n)}function Po(e,n){let t={kind:n};switch(wn(n)){case"value":t.value=e.value??_("");break;case"between":t.value=e.value??_(""),t.upper=e.upper??_("");break;case"times":t.value=ql(e.value,"22:00"),t.upper=ql(e.upper,"06:00");break;case"pattern":t.pattern=e.pattern??"";break;case"options":t.options=e.options??[];break;case"none":break}return t}function kn(e){let n={kind:e};switch(Fa(e)){case"value":n.value=_(e==="setColor"||e==="setBorderColor"||e==="setBackgroundColor"?"#FF453A":e==="setIcon"?"exclamationmark.triangle":e==="setGaugeValue"?"50":"Text");break;case"number":n.number=e==="setOpacity"?.5:e==="setFontSize"?14:e==="setBorderWidth"?2:e==="setGaugeMax"?100:0;break;case"weight":n.weight="bold";break;case"none":break}return n}var Aa="shared:";function Do(e){return Aa+e.toUpperCase()}function Ud(e){return e.values.filter(n=>n.value.kind.kind!=="entityState"&&Mi(e,n.id)>0)}function Kd(e,n){return n.size===0?e:e.map(t=>{let i=n.get(Do(t.id));if(i===void 0)return t;let a={kind:{kind:"literal",value:i}};return t.value.format&&(a.format=t.value.format),{...t,value:a}})}var vm=["unavailable","unknown"],wm={automation:["on","off"],script:["on","off"],remote:["on","off"],update:["on","off"],timer:["idle","active","paused"],sun:["above_horizon","below_horizon"],valve:["open","closed","opening","closing"],lawn_mower:["mowing","docked","paused","returning","error"],weather:["sunny","clear-night","partlycloudy","cloudy","rainy","pouring","snowy","snowy-rainy","fog","windy","windy-variant","lightning","lightning-rainy","hail","exceptional"]},km=new Set(["\xB0C","\xB0F"]);function Gd(e){return Array.isArray(e)&&e.length>0&&e.every(n=>typeof n=="string")?e:void 0}function Ai(e){let n=typeof e=="number"?e:typeof e=="string"&&e.trim()!==""?Number(e):NaN;return Number.isFinite(n)?n:void 0}function $m(e){let n=e?.trim().match(/\.(\d+)$/)?.[1]?.length??0;return n===0?1:10**-Math.min(n,4)}function Cm(e){let n=10**Math.floor(Math.log10(e));return([1,2,2.5,5,10].find(i=>i*n>=e)??10)*n}function Sm(e){let n=new Set,t=[];for(let i of e)i===void 0||i===""||n.has(i)||(n.add(i),t.push(i));return t}function Wd(e,n,t){let i=e.split(".")[0]??"",a=n?.attributes??{},o=Gd(a.options)??(i==="climate"?Gd(a.hvac_modes):void 0)??Ti[i]??wm[i];if(o)return{kind:"choice",options:Sm([...o,n?.state,t,...vm])};let s=Ai(n?.state),l=typeof a.unit_of_measurement=="string"?a.unit_of_measurement:void 0;if(s===void 0&&l===void 0&&i!=="input_number"&&i!=="number")return{kind:"text"};let d=Ai(t),c=Ai(a.min),u=Ai(a.max),p=Ai(a.step),m,b;if(c!==void 0&&u!==void 0&&u>c)m=c,b=u;else if(l==="%")m=0,b=100;else{let x=Cm(Math.max(Math.abs(s??0)*2,10));m=(s??0)<0||l!==void 0&&km.has(l)?-x:0,b=x}d!==void 0&&(m=Math.min(m,d),b=Math.max(b,d));let g=p!==void 0&&p>0?p:$m(n?.state);return{kind:"number",min:m,max:b,step:g}}function jd(e){if(e.appliedToken===void 0)return{kind:"unsupported"};if(e.token===e.appliedToken){let n=!e.polling&&typeof e.lastPollSeconds=="number"?e.lastPollSeconds:void 0;return n===void 0?{kind:"sent"}:{kind:"sent",awaySeconds:n}}return e.pending&&e.polling?{kind:"sending"}:e.polling?{kind:"waiting"}:{kind:"offline"}}function Tm(e){if(e<60)return"just now";let n=Math.floor(e/60);if(n<60)return`${n} min ago`;let t=Math.floor(n/60);if(t<24)return`${t} h ago`;let i=Math.floor(t/24);return`${i} ${i===1?"day":"days"} ago`}function qd(e){switch(e.kind){case"unsupported":return{label:"Update the watch app",note:"to receive this",title:"This watch has never reported which changes it applied, so nothing saved here can reach it. Its Wrist Assistant app is older than custom complications, or it has not been opened on this home yet.",resend:!1};case"sent":return e.awaySeconds===void 0?{label:"On watch",title:"The watch has applied every change here.",resend:!1}:{label:"On watch",note:`last seen ${Tm(e.awaySeconds)}`,title:"The watch has applied every change here, but it is not listening now. A save made after this will not reach it until the watch app is open on this home again.",resend:!1};case"sending":return{label:"Sending\u2026",title:"Waiting for the watch to pull and confirm.",resend:!1};case"waiting":return{label:"Not on watch yet",title:"The watch is connected but has not confirmed the latest change. Resend wakes it again.",resend:!0};case"offline":return{label:"Open the watch app to sync",title:"Saves reach the watch by themselves while Wrist Assistant is open on this home. Open the app, or switch the watch to this home, and it pulls at once.",resend:!0}}}function Xd(e){let n=new TextEncoder().encode(e),t=0xcbf29ce484222325n,i=0x100000001b3n,a=0xffffffffffffffffn;for(let r of n)t^=BigInt(r),t=t*i&a;return t.toString(16)}function Jd(e){return new Map(e.map(n=>[n.id.toUpperCase(),n.value]))}function Yd(e){return e.kind==="entityAttribute"||e.kind==="entityAge"||e.kind==="aggregate"||e.kind==="time"||e.kind==="jinja"}function Oo(e,n,t=0){let i=n instanceof Map?n:Jd(n),a=e.kind;if(a.kind==="named"){if(t>8)return;let o=i.get(a.id.toUpperCase());return o?o.kind.kind==="named"?Oo(o,i,t+1):Yd(o.kind)?"n_"+a.id.toLowerCase().replace(/-/g,""):void 0:void 0}if(!Yd(a))return;let r=Ii(a);if(r!==void 0)return"e_"+Xd(r)}function it(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function Em(e){let n;if(e.scope.kind==="entities")n=`expand([${e.scope.entities.map(o=>it(o.entityId)).join(", ")}])`;else{let{domains:o,areaIds:s,labelIds:l,floorIds:d}=e.scope;if(!(s.length+l.length+d.length>0))n=o.length===0?"[]":"("+o.map(u=>`(states.${u} | list)`).join(" + ")+")";else{let u=[];for(let p of s)u.push(`area_entities(${it(p)})`);for(let p of l)u.push(`label_entities(${it(p)})`);d.length>0&&u.push(`((${d.map(p=>`floor_areas(${it(p)})`).join(" + ")}) | map('area_entities') | sum(start=[]))`),n=`(expand(${u.join(" + ")})`,o.length>0&&(n+=` | selectattr('domain', 'in', [${o.map(it).join(", ")}])`),n+=")"}}let t=n,i=e.stateFilter;if(i&&(i.kind==="isOn"?t+=" | selectattr('state', 'eq', 'on')":i.kind==="isOff"?t+=" | selectattr('state', 'eq', 'off')":i.kind==="equals"?t+=` | selectattr('state', 'eq', ${it(i.value)})`:t+=` | rejectattr('state', 'eq', ${it(i.value)})`),e.function==="count")return`(${t} | list | count)`;let a=e.attribute?`attributes.${e.attribute}`:"state",r=`${t} | map(attribute=${it(a)}) | map('float', 0) | list`;switch(e.function){case"sum":return`(${r} | sum)`;case"average":return`(${r} | average(0))`;case"min":return`(${r} | min(default=0))`;case"max":return`(${r} | max(default=0))`}}function Ii(e){switch(e.kind){case"entityAttribute":return`state_attr(${it(e.entityId)}, ${it(e.attribute)})`;case"entityAge":{let n=it(e.entityId);return`(((now() - states[${n}].last_changed).total_seconds() if states[${n}] is not none else 0) | round(0))`}case"time":switch(e.timeField){case"now":return"now().strftime('%H:%M')";case"hour":return"now().hour";case"minute":return"now().minute";case"day":return"now().day";case"month":return"now().month";case"weekday":return"now().weekday()";case"timestamp":return"(as_timestamp(now()) | round(0))"}return;case"jinja":return e.value.trim().length===0?void 0:e.value;case"aggregate":return Em(e.aggregate);default:return}}function Ia(e){let n=new Map,t=new Map,i=Jd(e.values),a=(o,s=0)=>{let l=o.kind;switch(l.kind){case"literal":case"dataAge":case"chartStat":return;case"entityState":n.set(l.entityId,l);return;case"named":{if(s>8)return;let d=i.get(l.id.toUpperCase());if(!d)return;if(d.kind.kind==="named"){a(d,s+1);return}if(d.kind.kind==="entityState"){n.set(d.kind.entityId,d.kind);return}let c=Ii(d.kind);if(c===void 0)return;t.set("n_"+l.id.toLowerCase().replace(/-/g,""),c);return}default:{let d=Ii(l);if(d===void 0)return;t.set("e_"+Xd(d),d)}}};for(let o of e.values)a({kind:{kind:"named",id:o.id}});for(let o of e.elements){let s=xn(o);if(s&&a(s),o.kind==="text")for(let l of o.payload.parts??[])a(l.value);o.kind==="gauge"&&o.payload.total&&a(o.payload.total),o.kind==="gauge"&&o.payload.minSource&&a(o.payload.minSource),o.kind==="gauge"&&o.payload.maxSource&&a(o.payload.maxSource),o.kind==="chart"&&o.payload.nowIndex&&a(o.payload.nowIndex);for(let l of xi(o.payload.rules))a(l)}for(let o of re){if(!e.supportedFamilies.includes(o))continue;let s=e.perFamily[o];if(s){s.bezelText&&a(s.bezelText),s.curvedText&&a(s.curvedText),s.bezelGauge&&(a(s.bezelGauge.value),s.bezelGauge.minLabel&&a(s.bezelGauge.minLabel),s.bezelGauge.maxLabel&&a(s.bezelGauge.maxLabel));for(let l of xi(s.rules))a(l)}}e.supportedFamilies.includes("inline")&&e.inline&&a(e.inline.value);let r={entities:n,expressions:t};return t.size>0&&(r.document=Mm(t)),r}function Mm(e){let n=[...e.keys()].sort(),t=[];for(let a of n){let r=e.get(a);r.includes("{{")||r.includes("{%")?t.push(`{% set v_${a} %}${r}{% endset %}`):t.push(`{% set v_${a} = ${r} %}`)}let i=n.map(a=>`"${a}": v_${a}`).join(", ");return t.push(`{{ { ${i} } | to_json }}`),t.join(`
`)}function Zd(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Rm(r));return{values:t,nullKeys:i}}function Rm(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Vo(e){let n=Ia(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Fm(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(eo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Am=10800;function Im(e,n,t){let i=n==="always"||n==="auto"&&t<=Am;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Go(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Im(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Hm(e,n){return Bt(e)===void 0?[]:Go(st(e)*60,va(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Lm(e,n){return pn(e)?Go(Math.round(e.historyMinutes)*60,va(ft(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function _m(e,n,t){return n===void 0||!pn(n)?[]:Go(Math.round(n.historyMinutes)*60,va(ft(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function $n(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Be(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:$n(i)}function zm(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Nm(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Pm(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?$n(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=$n(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Dm(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Om(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Vm(e,n,t){if(Ae(n))return e;let i=n,a=e,r=$n(e.trim()),o=i.duration?Pm(e):void 0;if(o!==void 0)a=Dm(o);else if(i.relativeTime&&r!==void 0)a=Nm(r);else{let s=Be(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):zm(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Om(a);break}return a}function Qn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function at(e,n=240){return ic(e,n).map(t=>t.value)}function Uo(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of at(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:nc(r)}}function nc(e){return e.some(n=>n)?e:[]}function ic(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Qd(e,n,t){let i=ic(e),a=i.map(g=>g.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Pt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??oe,c=t.highColorHex??qe,u=t.lowColorHex??Ye,p=[],m=(g,x)=>{if(g==="")return;let k=p.at(-1);k&&k.colorHex===x?k.text+=g:p.push({text:g,colorHex:x})},b=0;return i.forEach((g,x)=>{m(e.slice(b,g.start),n);let k=x===o?c:x===s?u:l.length>0?ya(g.value,l,d):n,C=e[g.end-1]==="."?g.end-1:g.end;m(e.slice(g.start,C),k),b=C}),m(e.slice(b),n),p}function ec(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Bm(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Li(e,n=Vt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Gm(i.slice(a+1))})}return t}function Gm(e){try{return decodeURIComponent(e)}catch{return e}}function Um(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function tc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Km(e,n,t){if(e===void 0)return 0;let i=Be(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var dt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=ec(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=hn(n),i=mn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Uo(a):{values:at(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=nc(s),{values:Ko(o,tt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Be(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Be(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):ec(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ae(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Fm(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?rd(r):eo(r,a.domainMax-a.domainMin));break}default:{let a=Oo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Vm(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=$n(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Qn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Be(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Be(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Be(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:vn(d),p=c===void 0?void 0:vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(_e[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Qd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,b=yt(n.payload)&&!r.has("text"),g={kind:"text",...u,text:b?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(g.countdownEnd=p),b?(g.parts=this.resolveTextParts(n.payload.parts,i.rules,g,t),g.text=g.parts.map(x=>x.text).join(""),g):(ed(n.payload)&&(g.spans=Qd(g.text,g.colorHex,n.payload)),g)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),b=n.payload.symbol.kind.kind==="literal",g=m===void 0&&b&&n.payload.path!==""?n.payload.path:void 0,x=m??p;g===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let k={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(k.path=g),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),b=(P,L,Z)=>P??(L?Be(this.resolve(L)??""):void 0)??Z,g=b(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=b(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Be(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=ya(k,Pt(p),p.bandAboveColorHex));let $=x-g;if(p.total){let P=Be(this.resolve(p.total)??"");P!==void 0&&($=P)}let S=tc($,1,ga),H={kind:"gauge",...u,fraction:Km(m,g,x),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:tc(k??0,0,S)};if(p.thresholdValue!==void 0&&x!==g){let P=(p.thresholdValue-g)/(x-g);P>=0&&P<=1&&(H.thresholdFraction=P)}return H}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),b=m.values,g=m.holes,x={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Pt(p),$=ad(p)?b.map(X=>ya(X,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",H=p.highlight==="lowest"||p.highlight==="both",P=bi(p),L={kind:"chart",...u,values:b,holes:g,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?P.high:"none",lowMarker:H?P.low:"none",pointColorHexes:$,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:tt(p.smoothing)??"off",fillStyle:_t(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:zt(p.barRadius),barCorners:Nt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Lm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},Z=g.length===0?b:b.filter((X,U)=>!g[U]);if(Z.length>0){let X=A=>b.findIndex((K,y)=>K===A&&g[y]!==!0),U=S?X(Math.max(...Z)):-1,ee=H?X(Math.min(...Z)):-1;U>=0&&(L.highIndex=U),ee>=0&&ee!==U&&(L.lowIndex=ee)}let T=Bm(p,x.min,x.max);T!==void 0&&(L.thresholdY=T);let O=this.chartNowIndex(p,b.length);return O!==void 0&&(L.nowIndex=O),L}case"timeline":{let p=n.payload,m=Bt(p),b=m===void 0?"":this.ctx.historySeries?.get(m)??"",g=Li(b,Vt),x=Um(g,st(p)*60,C=>pd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:Hm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};bt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:_m(p,this.chartElements.get(p.chart),this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"chartDots":{let p=n.payload,m=mt(p.size),b={kind:"chartDots",...u,chart:p.chart,dots:ma(p.dots),diameter:0,indices:[]};return m!==void 0&&(b.size=m),p.colorHex!==void 0&&(b.colorHex=p.colorHex),b}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Dn(p.lines),colorHex:It(p.colorHex),thickness:On(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...Jm(Xm(Ad(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,k=this.resolve(x.value),C=k===void 0?void 0:Be(k);if(C!==void 0){let $=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),H={value:Math.min(S,Math.max($,C)),minValue:$,maxValue:S===$?$+1:S,colorHexes:x.colorHexes},P=this.resolve(x.minLabel);P!==void 0&&(H.minLabel=P);let L=this.resolve(x.maxLabel);L!==void 0&&(H.maxLabel=L),l.bezelGauge=H}}let b=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;b!==void 0&&(l.backgroundColorHex=b);let g=this.styleColor(s,"borderColor")??a?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function Wm(e,n,t){let i=new dt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function _i(e,n,t){let i=new dt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Wm(e.inline,n,e)),a}function Ha(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Bo=5,jm=1.7,qm=1.8;function Ym(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Xm(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*qm,l=Math.max(o.frame.width*n.width,0),d=Ym(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function ac(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function rc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function La(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=L=>L==="triangle"?Bo+d:L==="dot"?Math.max(d,jm):d,u=c(a),p=c(r),m=n.y+u,b=Math.max(n.h-u-p,1),g=m+b,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?b*.12:0,$=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-$*(i-1))/i,.5),H=L=>Math.min(1,Math.max(0,(L-e.domainMin)/x)),P=L=>g-H(L)*b;return{count:t.length,barWidth:S,plotTop:m,plotBottom:g,plotLeft:o,plotRight:o+s,baselineY:k?g:P(0),inset:d,yAtFraction(L){return g-Math.min(Math.max(L,0),1)*b},barRect(L){let Z=o+L*(S+$),T=t[L],O,X;if(k){let U=C+H(T)*(b-C);O=g-U,X=g}else O=P(T),X=k?g:P(0),O>X&&([O,X]=[X,O]);return{x:Z,y:O,w:S,h:Math.max(X-O,.5)}},point(L){let Z=Math.max(s-d*2,0);return{x:t.length>1?o+d+Z*L/(t.length-1):o+s/2,y:P(t[L])}},markerCenter(L,Z,T="high"){let O=Z?this.barRect(L):void 0,X=O?O.x+O.w/2:this.point(L).x,U=T==="high"?a:r,ee=T==="high"?U==="triangle"?n.y+Bo/2:m:U==="triangle"?n.y+n.h-Bo/2:g;return{x:X,y:ee}}}}function oc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Ko(e,n,t=[]){let i=e.length,a=Ql(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,b=0;for(let g=Math.max(0,p-r);g<=Math.min(i-1,p+r);g++){if(s(g))continue;let x=g-p,k=Math.exp(-(x*x)/(2*o*o));m+=e[g]*k,b+=k}return m/b}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function sc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Hi=1;function ei(e,n){let t=Math.max(Un,Math.min(Kn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Hi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Hi:n.y,h:n.h-i-Hi,cy:(e.labelsAbove?n.y+i+Hi:n.y)+(n.h-i-Hi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Jm(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&ac(r)===void 0)return{...i,isHidden:!0};let o=Qm(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Zm(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Qm(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Ha(t,i);if(a.w<=0||a.h<=0)return;let r=ei(t,a).body;if(r.w<=0||r.h<=0)return;let o=La(t,r),s,l;if(gt(n.at)){let k=Zm(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?ac(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,$)=>C>$?(C+$)/2:Math.min(Math.max(k,C),$),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let b=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,g=p(b,r.y+c/2,r.y+r.h-c/2),x=p(g+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Ie=pe,zi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ie,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],ti=zi.find(e=>e.measured);function yc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return zi.find(a=>a.screen.width===t&&a.screen.height===i)}function za(e,n){let t=Ie[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Yo={regular:400,medium:500,semibold:600,bold:700},ef=1.15;function Ge(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ge(e,n,t="#FFFFFF"){let i=Ge(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var $t=e=>e*.55;function bc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function tf(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function nf(e,n,t){if(t<=0||e.length*$t(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/$t(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function af(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function xc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function vc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function rf(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function wc(e,n){return e.reduce((t,i)=>t+i.text.length*$t(i.look.fontSize*n),0)}function of(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:$t(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=$t(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function sf(e,n,t){if(t<=0||wc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*$t(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*$t(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function lf(e,n,t){let i=rf(n),a=e.lineLimit===2&&t.w>0?of(e.text,i,t.w):[e.text],r=xc(e.text,a),o=a.map((C,$)=>vc(C,r[$]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>wc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>sf(C,l,t.w)),{anchor:c,x:u}=bc(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,b=p*1.15,g=C=>C.map($=>{let S=ge($.look.colorHex,"fill");return v`<tspan font-size=${$.look.fontSize*l} font-weight=${Yo[$.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}),x=ge(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,$)=>v`<tspan x=${u} y=${t.cy+m+($-(d.length-1)/2)*b}>${g(C)}</tspan>`)}`:g(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${e.fontSize*l} font-weight=${Yo[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${k}</text>`}function df(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(g=>g.text).join("")===e.text)return e.text===""?f:lf(e,e.parts,n);let t=ge(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Qn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?tf(e.text,n.w/$t(e.fontSize)):[e.text],a=Math.max(...i.map(g=>g.length))*$t(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(g=>nf(g,o,n.w)),{anchor:l,x:d}=bc(e.alignment,n),c=af(e.text,e.spans),u=c?xc(e.text,i):[],p=(g,x)=>c?vc(g,u[x]??0,e.text,c,e.colorHex).map(k=>{let C=ge(k.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}):g,m=o*1.15,b=s.length>1?v`${s.map((g,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(g,x)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Yo[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${b}</text>`}var Wo=2;function cf(e,n){let t=ge(e.colorHex,"stroke"),i=ge(e.trackColorHex,"stroke","#FFFFFF"),a=ge(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,b=Math.max(1,e.dotCount),g=m?n.w:n.h,x=m?n.h:n.w,k=Math.max(1,Math.min(x,g/b-Wo)),C=b*k+(b-1)*Wo,$=(m?n.cx:n.cy)-C/2+k/2;return v`${Array.from({length:b},(S,H)=>{let P=$+H*(k+Wo),L=H<e.filledCount?t:i;return v`<circle cx=${m?P:n.cx} cy=${m?n.cy:P} r=${k/2}
        fill=${L.stroke} fill-opacity=${L["stroke-opacity"]} />`})}`}if(e.style==="bar"){let m=n.w,b=Math.max(r,m*e.fraction),g=1;return v`
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:uf(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function uf(e,n,t,i,a){let r=ge(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function pf(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ei(e,n),o=r?es(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=mf(e,a);return o===void 0?s:v`${s}${o}`}function jo(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var lc=0;function kc(){return lc+=1,lc.toString(36)}function hf(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function mf(e,n){let t=La(e,n),i=kc(),a=ge(e.colorHex,"fill"),r=ge(e.highColorHex,"fill",e.colorHex),o=ge(e.lowColorHex,"fill",e.colorHex),s=(b,g)=>v`<circle cx=${b.x} cy=${b.y} r="1.7" fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=b=>c?ge(e.pointColorHexes[b],"fill",e.colorHex):a,p=b=>{let g=Ge(b)??Ge(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:g.color,opacity:g.opacity*.28};let x=ff(i,e.id,b),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,v`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${g.color} stop-opacity=${g.opacity*.28} />
        <stop offset="1" stop-color=${g.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let b=0;b<t.count;b++){if(e.holes[b]===!0)continue;let g=t.barRect(b),x=b===e.highIndex?r:b===e.lowIndex?o:u(b),k=Math.min(Math.max(e.barRadius,0),g.w/2,g.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[b]<0;l.push(v`<path d=${hf(g,k,C)}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else l.push(v`<rect x=${g.x} y=${g.y} width=${g.w} height=${g.h} rx=${k}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let b=Array.from({length:t.count},(C,$)=>t.point($)),g=e.holes.length>0,k=sc(t.count,e.holes).filter(C=>!g||C.length>1).map(C=>{let $=C.map(P=>b[P]),S=oc($,e.curve),H=`M${$[0].x} ${$[0].y}${S.map(P=>` ${jo(P)}`).join("")}`;return{run:C,pts:$,legs:S,line:H}});if(e.style==="area")for(let{run:C,pts:$,legs:S,line:H}of k)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let P=0;P<S.length;P++){let L=$[P],Z=$[P+1],T=p(e.pointColorHexes[C[P+1]]),O=`M${L.x} ${L.y} ${jo(S[P])} L${Z.x} ${t.baselineY} L${L.x} ${t.baselineY} Z`;l.push(v`<path d=${O} fill=${T.fill} fill-opacity=${T.opacity} stroke="none" />`)}else{let P=p(e.fillColorHex??e.colorHex),L=`${H} L${$[$.length-1].x} ${t.baselineY} L${$[0].x} ${t.baselineY} Z`;l.push(v`<path d=${L} fill=${P.fill} fill-opacity=${P.opacity} stroke="none" />`)}for(let{run:C,pts:$,legs:S,line:H}of k)if(c&&C.length>1)for(let P=0;P<S.length;P++){let L=$[P],Z=u(C[P+1]);l.push(v`<path d=${`M${L.x} ${L.y} ${jo(S[P])}`} fill="none"
          ...
          stroke-width=${e.lineWidth} stroke-linecap="round" stroke-linejoin="round" />`);e.highIndex!==void 0&&l.push(s(b[e.highIndex],r)),e.lowIndex!==void 0&&l.push(s(b[e.lowIndex],o))}let m=(b,g,x,k)=>{if(b===void 0||g==="none")return;let C=t.markerCenter(b,e.style==="bars",k);l.push(g==="triangle"?v`<path d=${`M${C.x} ${C.y-1.8} L${C.x+2.2} ${C.y+1.8} L${C.x-2.2} ${C.y+1.8} Z`}
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function wf(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ge(e.colorHex,"fill"),s=e.size*ef;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var ts=.25,kf=8;function $f(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,ts),kf),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,b=i*p,g=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+g)+0,y:-(b-n)/2*(1+x)+0,width:m,height:b}}function Na(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var _a=4;function Pa(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+_a:n.x+n.w-_a-a,d=e.timestampCorner.startsWith("top")?n.y+_a:n.y+n.h-_a-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Cf(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Sf(e,n,t){let i=t.icons,a=`imgclip-${kc()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Pa(e,n,Na(new Date)):void 0,s=o?v`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,b])=>v`<rect data-ts-corner=${p} x=${m-l/2} y=${b-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=$f(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=v`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Cf(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Tf(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Ef(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Xo} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var Xo=5;function Ef(e,n){let t=Xo*.55,i=n.w-2;if(n.h<Xo*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Cc(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function Jo(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return f;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return f;let d=Ha(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=df(e,d);break;case"icon":u=wf(e,d,t.icons);break;case"gauge":u=cf(e,d);break;case"chart":u=pf(e,d);break;case"timeline":u=gf(e,d);break;case"chartTimes":u=yf(e,d);break;case"chartDots":u=bf(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=xf(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=vf(e,d);break;case"image":u=Sf(e,d,t);break;case"tap":u=Tf(e,d,t.icons,r,c?xt(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,b=t.highlightId===e.id,g=b||t.highlightIds?.includes(e.id)===!0,x=e.kind==="chartDots"||e.kind==="chartGrid",k=t.handles===!0&&(!l||s)&&!x,C=g&&!x?v`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,$=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${d.cx} ${d.cy})">${S}${u}${$}${C}${P}</g>`}function Da(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function ns(e,n){return(n?23.5:34)*e}var dc=10.5;function Sc(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function cc(e,n){let t=0;for(let i of e)t+=Sc(i,n);return t}function uc(e,n,t){let i=e.toUpperCase(),a=d=>Sc(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Zo(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Qo(e,n,t,i){let a=Zo(e,n,t),r=Zo(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Tc(e,n,t,i){let{dial:a}=Da(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Qo(a,t,i.start,i.end),length:t*r}}function Mf(e,n){let t=Da(e,!0);return Tc(e,n,t.dial.r,t.labelArc)}var pc=18.5,Rf=113,Ff={start:-71,end:-36},hc=104,Af=6.2,mc={start:-77,end:-30.5};function fc(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function gc(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=fc(e[i]),o=fc(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var qo=11;function If(e,n,t){let{dial:i}=Da(n,!0),a=hc*n,r=180/(Math.PI*hc),o=e.minLabel!==void 0?cc(e.minLabel,qo)*r:0,s=e.maxLabel!==void 0?cc(e.maxLabel,qo)*r:0,l=mc.start+(o>0?Math.max(0,o-1.8):0),d=mc.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let k=0;k<u;k++){let C=l+c*k/u,$=Math.min(d,l+c*(k+1)/u+.4);p.push(v`<path d=${Qo(i,a,C,$)} fill="none"
      stroke=${gc(e.colorHexes,(k+.5)/u)} stroke-width=${Af*n}
      stroke-linecap=${k===0||k===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),b=Zo(i,a,l+c*m),g=1.5,x=(k,C,$,S)=>v`
    <defs><path id=${k} d=${Qo(i,a,C,$)} /></defs>
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+g,d+g+Math.max(s,3),e.maxLabel):f}`}function Oa(e,n){let t=e.family in Ie?e.family:"rectangular",i=n.slot??Ie[t],a=Ie[t],r=za(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ge(e.backgroundColorHex),l=Ge(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Cc(c);if(t==="corner"){let x=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",$=C!=="",S=Da(x,k),H=ns(x,k),P=H/(a.width*x),L=S.tile.cx-H/2,Z=S.tile.cy-H/2,T=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,O=f;if(e.bezelGauge)O=If(e.bezelGauge,x,o);else if(e.bezelText){let U=Mf(x,`${o}-bezel`),ee=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Qn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;O=v`<defs><path id=${U.id} d=${U.d} /></defs>
        <text font-size=${dc*x} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${U.id}" startOffset="50%" text-anchor="middle">${uc(ee,U.length,dc*x)}</textPath></text>`}let X=f;if($){let U=Ge(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ee=Tc(x,`${o}-curved`,Rf*x,Ff);X=v`<defs><path id=${ee.id} d=${ee.d} /></defs>
        <text font-size=${pc*x} font-weight="600" fill=${U.color} fill-opacity=${U.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${ee.id}" startOffset="50%" text-anchor="middle">${uc(C,ee.length,pc*x*.88)}</textPath></text>`}else{let U=e.borderWidth*r.scale*P,ee=l?v`<circle cx=${H/2} cy=${H/2} r=${H/2-U/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${U} />`:f;X=v`<g transform="translate(${L} ${Z})">
        <g clip-path=${`url(#${o})`}>
    ...
    ${p}
    ${c.map(m=>Jo(m,a,d,Cc(e.elements)))}
    ${u}
  </svg>`}function ne(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var Cn=["rectangular","circular","corner","inline"];function ni(e){return re.includes(e)}function Va(e){return Cn.filter(n=>e.supportedFamilies.includes(n))}function is(e){return re.find(n=>e.supportedFamilies.includes(n))}function Ba(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function zf(){return{value:_("")}}function Mc(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=Cn.filter(t=>t===n||e.supportedFamilies.includes(t))),ni(n)?e.perFamily[n]||(e.perFamily[n]=kt()):e.inline||(e.inline=zf()),e.schemaVersion=sn(e)}function Rc(e,n){if(Ba(e,n)){if(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),ni(n)){for(let t of lt(e,n))$e(e,t.payload.id);delete e.perFamily[n],nt(e)}else delete e.inline;e.schemaVersion=sn(e)}}function Fc(e,n){let t=[];if(!ni(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=lt(e,n).filter(r=>!fe(e,r)).length;return a>0&&t.push(`${a} layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var Ue={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a",chartTimes:"#5e35b1",chartDots:"#5e35b1",chartGrid:"#5e35b1"},ii={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area",chartTimes:"Chart times",chartDots:"Chart dots",chartGrid:"Chart grid"},as=["text","icon","gauge","chart","timeline","shape","image","tap"],Q={content:"#4a7fe8",look:"#a15fe0",numbers:"#26a69a",position:"#66bb6a",states:"#f9a825",tap:Ue.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Ac="2.8.0";function Ni(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function Ic(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function Hc(e,n=Ac){let t=Ni(e),i=Ni(n);return!t||!i?!1:Ic(t,i)>=0}function rs(e,n=null){if(n===null)return;let t=Ni(e),i=Ni(n);return!t||!i||Ic(t,i)>=0?void 0:`Needs Wrist Assistant ${i[2]===0?`${i[0]}.${i[1]}`:i.join(".")} or later on your watch.`}function Lc(e,n=Ac){return`${Ni(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The editor needs ${n}, coming soon to the App Store.`}var _c="52a9d81d0fd7";var zc="11fa18406cea";var Pe="mdi:";function Nf(e){return e.trim().replace(/\./g,"-")}function Pf(e){return e.trim().replace(/-/g,".")}var Ga=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>Pf(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=Nf(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Ge(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return v`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${qf(e)}</svg>`}var ut="color-mix(in srgb, var(--k) 45%, #6b7280)",Di='system-ui, -apple-system, "Segoe UI", sans-serif';function eu(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function hs(e,n,t,i){return v`<g fill="none" stroke-linecap="round">
    <path d=${eu(e,n,t,1)} stroke=${ut} stroke-width="2.6" opacity=".5" />
    <path d=${eu(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function Yf(e){switch(e){case"text":return v`<g font-family=${Di} text-anchor="middle">
    ...
    </div>`}function sg(e,n){let t=i=>jt(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${ze(e.label,t(e))}
    <div class="pair-row">
      ${sr(e.label,e.value,e.options,e.set,e)}
      ${ze(n.label,t(n))}
      ${sr(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function qi(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${ze(e,jt(n,i.def,t,a),gr(n,t,i))}
    <div class="slider-row">
      ...
      ${yr(n,r,{step:i.step,min:i.min,max:i.max,ariaLabel:e,...i.unit===void 0?{}:{unit:i.unit}})}
    </div></div>`}function Ke(e,n,t,i,a={}){return h`<label class="field check">${ze(e,jt(n,i,t,r=>r?"on":"off"))}<input type="checkbox" .checked=${n} ?disabled=${a.disabled===!0} @change=${r=>t(r.target.checked)} /></label>`}function be(e,n,t,i=!1,a){let{rgb:r,alpha:o}=zu(n),s=a===void 0?void 0:{atDefault:zs(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)},l=i&&n===void 0;return h`<div class="field color">${ze(e,s)}
    <div class="color-row">
    ...
    </span>`}function fu(e,n,t,i){let a={atDefault:n===void 0,title:`Back to ${t.toLowerCase()}`,reset:()=>i(void 0)};return h`<div class="field color">${ze(e,a)}
    <div class="color-row">${lr(e,n,i,!1,t)}</div></div>`}function zs(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function br(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function lg(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function gu(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var Nu=50;function dg(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function cg(e,n,t=Nu,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var ug=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Pu(e){return ug.test(e.trim())}function pg(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return br(t,i);if(Pu(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var En=new Map;function Te(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Ns(e){return En.has(e)}function pt(e,n,t,i,a,r={}){let o=e.hass.states,s=En.get(a),l=s?cg(lg(o,r.domain,gu(e.hass)),s.query,Nu,r.preferNumeric?dg:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=($,S,H=0)=>{En.set(a,{query:S,index:H}),Te($)},p=$=>{En.delete(a),Te($)},m=$=>{let S=pg($,t,o);S&&i(S)},b=($,S)=>{i(br(o,$.entityId)),p(S)},g=()=>Math.max(0,Math.min(En.get(a)?.index??0,l.length-1)),x=$=>{let S=$.target;if($.key==="ArrowDown"||$.key==="ArrowUp"){$.preventDefault();let H=En.get(a);if(!H){u(S,S.value);return}let P=$.key==="ArrowDown"?g()+1:g()-1;u(S,H.query,Math.max(0,Math.min(l.length-1,P))),hg(S);return}if($.key==="Enter"){$.preventDefault();let H=l[g()];s&&H?b(H,S):(m(S.value),p(S));return}if($.key==="Escape"){if(!s)return;$.preventDefault(),$.stopPropagation(),p(S)}},k=t.entityId?gu(e.hass)?.(t.entityId):void 0,C=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${$=>{let S=$.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),En.set(a,{query:"",index:0}),Te(S),S?.focus()}}>${B("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Pu(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map(($,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
  ...
  </div>`}function hg(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var yu=120;function mg(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Wa.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(ja),fromPack:!1}}function bu(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function fg(e){return[{value:"",label:`Starter set (${bu(ja,e)})`},...Wa.map(n=>({value:n.name,label:`${n.name} (${bu(n.symbols,e)})`}))]}function gg(e){return e.length>0?e.length:ja.length}function xu(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Za(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Du(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Pe),m=a!==void 0,b=m?r.pack(i)??(p?"mdi":"sf"):"sf",g=yg(u,c),x=$=>{t($),a?.($.startsWith(Pe)?e.icons.mdiPath?.($):void 0),r.noteUsed($)},k=$=>{if(t($),!m)return;let S=$.trim();a?.(S.startsWith(Pe)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&b==="mdi"){let $=e.icons.mdiNames?.(),S=bg($??[],s),H=S.slice(0,yu),P=r.recent.filter(L=>L.startsWith(Pe));C=h`<div class="sym-browse">
      ${vu(r,i,b)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${ye(L=>r.setQuery(i,L))} />
      </div>
      ${P.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${P.map(L=>Za(e,L,L===u,x))}</div>`}
      <div class="sym-grid">${H.map(L=>Za(e,L,L===u,x))}</div>
      ${$===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${xu(H.length,S.length,!0,$.length)}</div>`}
    ...
    </div>`}else if(o){let $=r.category(i),S=mg($,s,d,c),H=ss(S.names,s),P=S.fromPack?H.slice(0,yu):H,L=r.recent.filter(T=>!T.startsWith(Pe)),Z=c.size===0?L:L.filter(T=>c.has(T));C=h`<div class="sym-browse">
      ${m?vu(r,i,b):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${ye(T=>r.setQuery(i,T))} />
        <select @change=${ye(T=>r.setCategory(i,T))}>
          ${fg(c).map(T=>h`<option value=${T.value} ?selected=${T.value===$}>${T.label}</option>`)}
        </select>
      </div>
      ${Z.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${Z.map(T=>Za(e,T,T===u,x))}</div>`}
      <div class="sym-grid">${P.map(T=>Za(e,T,T===u,x))}</div>
      ${H.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${xu(P.length,H.length,s.trim()!=="",gg(d))}
          </div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${ye(k)} @change=${ye($=>{let S=$.trim();S.startsWith(Pe)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed($):(c.size===0||c.has(S))&&r.noteUsed($)})} /></label>
    ...
    ${C}`}function yg(e,n){let t=e.trim();return t!==""&&!t.startsWith(Pe)&&n.size>0&&!n.has(t)}function bg(e,n){let t=n.trim(),i=t.startsWith(Pe)?t.slice(Pe.length):t,a=e.map(r=>r.startsWith(Pe)?r.slice(Pe.length):r);return ss(a,i).map(r=>Pe+r)}function vu(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var xg=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],vg={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},wg=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],kg=[["flat","Flat"],["fade","Fade"]],$g=[["auto","Auto"],["all","All"]],Cg=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],Sg=[["bars","Bars"],["line","Line"],["area","Area"]],Tg=[["auto","Auto"],["fixed","Fixed range"]],Eg=[["lowest","Lowest value"],["zero","Zero"]],Mg=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],Fs=[["uniform","One colour"],["bands","By value"]];function dr(e){let n=[Jr,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function Rg(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Fg(e,n){let t=Pt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Ag(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function Ig(e,n,t){let{lo:i,hi:a}=Ag(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
  ...
  </div>`}function cr(e,n,t,i){let a=Pt({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(b=>b.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:zs(l,oe),title:`Back to ${oe}`,reset:()=>t(c=>{c.bandAboveColorHex=oe})};return h`<div class="bands">
    ${Ig(a,l,r)}
    ${a.map(c=>h`
      <div class="band-row ${o===c.id?"hit":""}">
        ...
        ${lr(`Up to ${c.upTo}`,c.colorHex,u=>t(s(c.id,p=>{p.colorHex=u??"#FFFFFF"}),`bcol${c.id}`))}
    ...
    ${be("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??Ot},"tother"),!1,Ot)}`}var _g=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],zg={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function wu(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return _(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Ng=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function Pg(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function ce(e,n,t,i){if(i.inline||!Dg())return h`<div class="value-editor">${Gu(e,n,t,i)}</div>`;let a=xr(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=xe(n,ue(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${Ou(e,a,r,n,t,i)}
  </div>`}function Ou(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Bu}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${Yi.has(n)?Gu(e,i,a,r):f}
  </div>`}function ue(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function xr(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function Dg(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Yi=new Set,Gi=new WeakMap;function Og(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Vu(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Bu(e){let n=e.currentTarget,t=e.newState==="open",i=Gi.get(n);if(i&&(i(),Gi.delete(n)),!t){Yi.delete(n.id)&&Te(n);return}let a=Og(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){Gi.get(n)?.(),Gi.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}$s(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Gi.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),$s(n,a.getBoundingClientRect()),Yi.has(n.id)||(Yi.add(n.id),Te(n),requestAnimationFrame(()=>{n.isConnected&&$s(n,a.getBoundingClientRect())}))}function $s(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=Vg({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Tn=8,Qa=6,ku=140;function Vg(e,n,t){let i=t.height-e.bottom-Qa-Tn,a=e.top-Qa-Tn,r=n.height>i&&a>i&&i<ku,o=Math.max(ku,r?a:i),s=Math.min(n.height,o),l=Math.max(Tn,Math.min(e.left,t.width-n.width-Tn)),d=r?Math.max(Tn,e.top-Qa-s):Math.max(Tn,Math.min(e.bottom+Qa,t.height-s-Tn));return{left:l,top:d,maxHeight:o,above:r}}function Gu(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=xg.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Du(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):ve("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=pt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${pt(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${ve("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=Yg(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Ee("Field",a.timeField,Ng,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${_u("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Mi(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>jg(e,n,t)}>Start an empty one</button>,
          ...
          ${c?h`<div class="hint keep">Read by ${u} ${u===1?"layer":"layers"}.
            ...
            <button type="button" class="link" @click=${()=>{let p=Ao(e.config,n);p&&t(p)}}>stop sharing</button>
    ...
    <div class="grid2">
      ...
      ${ve("Before",i.prefix??"",s=>a({prefix:s}),{placeholder:"text in front"})}
      ${ve("After",i.suffix??"",s=>a({suffix:s}),{placeholder:"text after"})}
    </div>
  ...
  </details>`}function Yg(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${o.kind==="filter"?h`<div class="grid2">
          ${ve("Domains",a(o.domains),s=>t({...n,scope:{...o,domains:r(s)}}),{placeholder:"light, switch"})}
          ${ve("Area ids",a(o.areaIds),s=>t({...n,scope:{...o,areaIds:r(s)}}))}
          ${ve("Label ids",a(o.labelIds),s=>t({...n,scope:{...o,labelIds:r(s)}}))}
          ${ve("Floor ids",a(o.floorIds),s=>t({...n,scope:{...o,floorIds:r(s)}}))}
    ...
    ${n.stateFilter&&"value"in n.stateFilter?ve("State",n.stateFilter.value,s=>t({...n,stateFilter:{kind:n.stateFilter.kind,value:s}})):f}
    ${n.function==="count"?f:ve("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Ku=mo,Xg=Ku.filter(([e])=>e!=="none");function Jg(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Wu(e,n){let t=Jg(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return md(e)?{type:e,...t}:{type:e}}var Zg=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function ju(e,n,t,i){let a=n.serviceDataJSON??"",r=fd(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
      ${ve("Domain",n.serviceDomain,s=>t({...n,serviceDomain:s.trim()},"svc-domain"),{placeholder:"light"})}
      ${ve("Service",n.serviceName,s=>t({...n,serviceName:s.trim()},"svc-name"),{placeholder:"turn_on"})}
    </div>
    <div class="chips">
      ${Zg.map(([s,l,d,c])=>h`
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??ey).slice(0,7)}
    ...
    ${t.type==="callService"?ju(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?ty(e):f}`}var ey="#808080",$u=[0,15,30,60,120];function Cu(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function ty(e){let n=e.config;return Yu(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Yu(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Ee("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Xu(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Mi(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
    ${ve("Name",n.name,o=>e.update(s=>{s.values[t].name=o},`${i}-name`),{placeholder:"Name it, like Outside temp"})}
    ${ce(e,n.value,o=>e.update(s=>{s.values[t].value=o},i),{allowNamed:!1,showResolved:!0,resolveAs:r,inline:!0,key:i})}
    <div class="field readout"><span>Used by</span><span class="readout-v">${a===0?"No layers yet":`${a} ${a===1?"layer":"layers"}`}</span></div>`}function Ju(){return{id:J(),name:"",value:_("")}}function He(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function Me(e,n,t,i,a=!1){let r=e.elements.find(c=>c.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=He(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function er(e,n,t,i,a){let r=n.payload.id,o=Ca(n)??a.min,s=He(e.config,t,n).size??o;return ae(i,s,l=>e.update(d=>Me(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,unit:"pt",...a.def===void 0?{}:{def:a.def}})}function Zu(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=kt()),a=lt(e,n).filter(l=>!fe(e,l));if(a.length===0)return;let r=Jn(e,a.map(l=>l.payload.id),n),o=on(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let c=s?.placements[l],u=c?.size??Ca(d),p={frame:{...c?.frame??d.payload.frame},isHidden:c?.isHidden??!1,...u!==void 0?{size:u}:{}};for(let m of re)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=Co(p,n,t,d.kind)}Zn(e,t)}function vr(e,n){return Pd(e,n)}function ny(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function Wi(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"||e.kind==="chartTimes"||e.kind==="chartDots"||e.kind==="chartGrid"?void 0:e.payload.colorSlot.baseColorHex}function Qu(e,n,t){let i=ny(t.map(l=>He(e,n,l).isHidden)),a=t.map(Wi),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var ri=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]],iy=[["leading","Left"],["center","Center"],["trailing","Right"]],ay=[["1","1"],["2","2"]];function ep(e,n,t){let i=n.payload.id,a=Ea(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s={...o?{domain:"camera"}:{},needed:Su(n)},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return h`
    ${pt(e,o?"Camera":"Entity",r,d=>e.update(c=>Dd(c,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint ${Su(n)?"warn":""}">${oy(n,a)}</div>`}function Su(e){return e.kind==="timeline"?e.payload.value.kind.kind!=="entityState":e.kind==="chart"?e.payload.historyMinutes>0&&e.payload.value.kind.kind!=="entityState":e.kind==="image"?e.payload.entity.entityId==="":!1}function ry(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function wr(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function oy(e,n){let t=ry(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a shared value, so change that shared value to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${wr(o)}.${r}`}function sy(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function ly(e,n){let t=e.timestamp===!0,i=bt(e),a=r=>n(o=>{r?(o.timestampX=o.timestampCorner.endsWith("Leading")?.16:.84,o.timestampY=o.timestampCorner.startsWith("top")?.16:.84):(bt(o)&&(o.timestampCorner=po(o.timestampX,o.timestampY)),delete o.timestampX,delete o.timestampY)});return h`
    ${Ke("Timestamp",t,r=>n(o=>{r?o.timestamp=!0:delete o.timestamp}),!1)}
    ${t?h`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:f}`}function ur(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>ur(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>ur(e[a],n[a]))}function Cs(e,n,t){return t.some(i=>!ur(e[i],n[i]))}function tr(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function we(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=e.helpSections.has(n),l=()=>e.toggleSection(n),d=()=>{!s&&!o&&e.toggleSection(n),e.toggleHelp(n)},c=s?`Hide the help in ${t}`:`Show help for ${t}`,u=h`<span class="swatch">${B(a.icon??"content")}</span>
  ...
  </section>`}function dy(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function cy(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function uy(e,n){let t=pe[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function py(e,n,t){let i=uy(e,n),a=pe[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <div class="hint">${t?h`${Mn(e,r)}, up to 366 days. Statistics rows are never
          ...
          ten by default, and a longer span would quietly come back short.`}</div>`}function gy(e){if(e.historyMinutes<=0)return"";if(e.source!=="statistics")return` \xB7 ${Mn(e.historyMinutes)}`;let n=fa.find(([t])=>t===e.statPeriod)?.[1]??e.statPeriod;return` \xB7 ${Mn(e.historyMinutes,Ci)} \xB7 per ${n.toLowerCase()}`}function Ps(e,n){let t=ue(e);switch(n.kind){case"text":{let i=n.payload.parts?.length??0;return yt(n.payload)?`Rich text, ${i} part${i===1?"":"s"}`:De(xe(n.payload.value,t),48)}case"icon":return De(xe(n.payload.symbol,t),48);case"gauge":return De(xe(n.payload.value,t),48);case"chart":return De(`${xe(n.payload.value,t)}${gy(n.payload)}`,48);case"timeline":return De(`${xe(n.payload.value,t)} \xB7 ${Mn(st(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return xt(n.payload.action);case"chartTimes":{let i=e.config.elements.find(a=>a.payload.id===n.payload.chart);return i?.kind==="chart"?De(`Times of ${xe(i.payload.value,t)}`,48):"No chart"}case"chartDots":case"chartGrid":{let i=e.config.elements.find(r=>r.payload.id===n.payload.chart),a=n.kind==="chartDots"?"Dots on":"Grid behind";return i?.kind==="chart"?De(`${a} ${xe(i.payload.value,t)}`,48):"No chart"}}}function pr(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Se(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Se(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Se(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Se(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Se(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return;case"chartTimes":return`${e.payload.timeLabelCount<=0?"no":e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt \xB7 ${Se(e.payload.labelColorHex)}`;case"chartDots":{let n=e.payload;return`${n.dots==="all"?"all":"auto"} \xB7 ${n.size===void 0?"automatic size":`${n.size} pt`} \xB7 ${n.colorHex===void 0?"series colour":Se(n.colorHex)}`}case"chartGrid":{let n=e.payload;return`${n.lines} ${n.lines===1?"line":"lines"} \xB7 ${n.thickness} pt \xB7 ${Se(n.colorHex)}`}}}function Ui(e,n,t,i,a,r){let o=Math.round(t*1e3)/10,s=l=>i(l/100);return h`<label class="pf">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function yy(e,n,t){let i=n.payload.id,a=`el-${i}`,r=He(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Me(p,t,i,{frame:fs(o,c)}),`${a}-${u}-${t}`),l=!ur(o,ki)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return we(e,"placement","Position",h`
      ...
      ${Ke("Hidden",r.isHidden,u=>e.update(p=>Me(p,t,i,{isHidden:u})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`})}return we(e,"placement","Position",h`
    ${by(e,n,t)}
    ${d===void 0?h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
          ...
          can still lift it past the top of the chart, as far as the edge of the face.</div>`}`}function xy(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ve(e.config,t)[0];return we(e,"tappable","Tap",Uy(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?xt(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Ta(a,t))}:{}})}function Tu(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ...
        ${be("Time colour",e.labelColorHex,r=>n(o=>{o.labelColorHex=r??et},`${i}colour`),!1,t.labelColorHex)}
      </div>
      ...
      ${a}`}`}var vy=[["number","Number"],["entity","Entity"]];function wy(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function ky(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function $y(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=wy(n,o),c=s?n.minValue:n.maxValue,u=g=>a(x=>{s?x.minValue=g??0:x.maxValue=g??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${ze(l,d==="number"?jt(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${vy.map(([g,x])=>h`<button type="button" role="radio" aria-checked=${g===d?"true":"false"}
          ...
          @click=${()=>{g!==d&&a(k=>ky(k,o,g))}}>${x}</button>`)}
      </span>
    </div>`,b=s?n.minSource:n.maxSource;return d==="number"||b===void 0?h`<div class="field gauge-end">${m}${yr(c,u,{ariaLabel:l})}</div>`:h`<div class="field gauge-end">${m}${ce(e,b,g=>a(x=>{s?x.minSource=g:x.maxSource=g},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
    ...
    ${te("Colour",a,Fs,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=dr(at(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
      ...
      ${cr({bands:n.bands??[],bandAboveColorHex:n.bandAboveColorHex??oe},n.colorSlot.baseColorHex,o,d.length===1?d[0]:void 0)}`:f}
    ${te("Highlight",r,Mg,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
        ${r==="lowest"?f:be("Highest colour",n.highColorHex??qe,c=>s("highColorHex",qe,c),!1,qe)}
        ${r==="highest"?f:be("Lowest colour",n.lowColorHex??Ye,c=>s("lowColorHex",Ye,c),!1,Ye)}
      </div>
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var ji=new Map,Ki=new Map,Ct=new Map,nr=new Map,Es=4,Ms=40,Sy=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Ty=[["plain","Plain"],["rich","Rich"]],Ey={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function Ds(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Ke("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function My(e){return e.countdown===!0?"countdown":yt(e)?"rich":"plain"}function Ry(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Fy(e,n){let t=cn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:De(e.kind.value,40)||"template"}:{kind:"value",label:Ji(e,n)}}function tp(e,n,t){let i=cn(e.value),a=i===void 0?De(Ji(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${De(i,24)}"`;return`Part ${n+1}: ${a}`}function Ay(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,tp(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function Is(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Iy(e,n){if(Is(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Pt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??oe],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function Eu(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${wr(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Hy={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Ly(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${wr(e.moved.map(n=>Hy[n]))} moved into Look.`}function _y(e,n,t,i,a){let r=n.payload,o=r.id,s=My(r),l=(r.parts?.length??0)>0,d=fo(e.config,r.value),c=Ct.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?Ki.get(o):void 0,m=(x,k)=>{let C=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),$=Ja(structuredClone(r),e.config.values);if(Ki.delete(o),!$.ok){Ct.set(o,{text:Eu($.blocked),rich:!0,warn:!0}),Te(k);return}Ct.set(o,{text:Ly($.joined?{joined:!0,template:C}:$),rich:!1}),i(S=>{Ja(S,e.config.values),x==="countdown"&&(S.countdown=!0)})},b=(x,k)=>{if(Ki.delete(o),s==="rich"){let C=x==="countdown"?"countdown":"plain",$=r.parts??[];if($.length<2){m(C,k);return}let S=vs($,e.config.values);S.ok?(Ct.delete(o),Ki.set(o,C)):Ct.set(o,{text:Eu(S.blocked),rich:!0,warn:!0}),Te(k);return}if(x==="rich"){let C=r.parts?.[0]?.id??J();ji.set(o,C),Ct.delete(o),i($=>{delete $.countdown,hu($,C)});return}Ct.delete(o),i(C=>{if(x==="countdown"){C.countdown=!0;return}(C.parts?.length??0)>0&&Ja(C,e.config.values),delete C.countdown})},g=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${te("Type",s==="rich"?"rich":"plain",Ty,b,{titles:Ey})}
    ...
    ${p===void 0?f:h`<div class="rich-confirm" role="alertdialog" aria-label=${g}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${x=>{Ki.delete(o),Te(x.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ${u?h`<div class=${u.warn?"hint warn":"rich-note"}>${u.text}</div>`:f}
    ${s==="rich"?zy(e,n,t,i,a):h`
        ${ep(e,n,a)}
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Re(d,ue(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function zy(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ue(e),d=Math.max(0,o.findIndex(A=>A.id===ji.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=He(e.config,t,n).size??r.fontSize,b=(A,K)=>{Ct.delete(s),i(y=>{A(y),td(y)},K)},g=(A,K)=>b(y=>{let w=y.parts?.find(E=>E.id===c.id);w&&A(w)},K?`part-${c.id}-${K}`:void 0),x=(A,K)=>{ji.set(s,A),Ct.delete(s),Te(K)},k=(A,K)=>{let y=J();ji.set(s,y),b(w=>{(w.parts??=[]).push({id:y,value:A})}),Vu(K,xr(`${a}-part-${y}`),!0)},C=A=>b(K=>{K.parts&&Xi(K.parts,d,A)}),$=()=>{let A=o[d+1]??o[d-1];A&&ji.set(s,A.id),b(K=>{K.parts=(K.parts??[]).filter(y=>y.id!==c.id)})},S=o.map((A,K)=>{let y=Fy(A.value,l),w=A.id===c.id,E=Is(A),R=y.kind==="value"?e.resolve(A.value):void 0,F=A.fontWeight===void 0?void 0:ri.find(([G])=>G===A.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${w?"true":"false"} class="part-chip ${y.kind} ${w?"on":""}"
      aria-label=${tp(A,K,l)} @click=${G=>x(A.id,G.currentTarget)}>
      <span class="part-dot" style=${`background:${Iy(A,p)}`}
        title=${E==="bands"?"By value, with its own bands":E==="pick"?"Its own colour":"The layer colour"}></span>
      ${y.kind==="text"?h`<span class="part-txt">${y.label===""?h`<span class="part-empty">empty</span>`:Ry(y.label).map(G=>G.space?h`<span class="part-sp">${"\xB7".repeat(G.text.length)}</span>`:G.text)}</span>`:h`<span class="part-txt">${y.label}</span>`}
    ...
    </button>`}),H=r.rules.some(A=>A.partId===c.id),P=c.value.kind.kind==="literal",L=Is(c),Z=c.fontSize!==void 0,T=ri.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,O=A=>{A>=Es&&A<=Ms&&g(K=>{K.fontSize=A},"size")},X=L==="bands"?at(e.resolve(c.value)??""):[],U={layer:"Use the layer colour",...P&&L!=="bands"?{bands:"By value needs a live value"}:{}},ee=(A,K)=>g(y=>{let w={bands:y.bands??[],bandAboveColorHex:y.bandAboveColorHex??oe};A(w),w.bands.length>0?y.bands=w.bands:delete y.bands,w.bandAboveColorHex!==oe?y.bandAboveColorHex=w.bandAboveColorHex:delete y.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${A=>k(_(""),A.currentTarget)}>${B("text")}<span>Add text</span></button>
    ...
    <div class="part-editor">
      ...
      ${ce(e,c.value,A=>g(K=>{K.value=A},"value"),{showResolved:!0,label:P?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ...
      ${te("Colour",L,Sy,A=>g(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=zs(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=dr(at(e.resolve(K.value)??"")))}),{def:"layer",titles:U,...P&&L!=="bands"?{disabled:{bands:!0}}:{}})}
      ${L==="pick"?be("Part colour",c.colorHex,A=>g(K=>{K.colorHex=A??p},"color")):f}
      ${L==="bands"?h`
        ${cr({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??oe},c.colorHex??p,ee,X.length===1?X[0]:void 0)}
        <div class="hint">These bands belong to this part. Another value in the same layer keeps its own.</div>`:f}
      <div class="field seg-field">${ze("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>g(A=>{delete A.fontWeight})})}
        ${sr("Weight",c.fontWeight,ri,A=>g(K=>{K.fontWeight=A}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${ze("Font size",Z?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>g(A=>{delete A.fontSize})}:void 0,gr(c.fontSize??m,O,{step:1,min:Es,max:Ms}))}
        ${yr(c.fontSize,A=>{A===void 0?g(K=>{delete K.fontSize},"size"):O(A)},{step:1,min:Es,max:Ms,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:Z?"Part font size":`Part font size, ${m} pt from the layer`,...Z?{}:{lead:B("link")}})}
      </label>
    </div>
  </div>`}function np(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,w)=>e.update(E=>y(E.elements[r]),w?`${o}-${w}`:void 0),l=He(e.config,t,n),d=l.frame,c=(y,w)=>e.update(E=>Me(E,t,a,{frame:fs(d,y)}),`${o}-${w}-${t}`),u=Ce(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=y=>u[y],b=!1,g=y=>Wi(n)===void 0?f:be(y,Wi(n),w=>s(E=>{Wi(E)!==void 0&&(E.payload.colorSlot.baseColorHex=w??"#FFFFFF")},"color"),!1,p),x,k,C;switch(n.kind){case"text":{let y=(w,E)=>s(R=>w(R.payload),E);k=_y(e,n,t,y,o),b=!n.payload.countdown&&!yt(n.payload),C=h`
        ${er(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${te("Weight",n.payload.fontWeight,ri,w=>s(E=>{E.payload.fontWeight=w}),{def:u.fontWeight})}
        ${sg({label:"Align",value:n.payload.alignment??"center",options:iy,def:"center",set:w=>s(E=>{let R=E.payload;w==="center"?delete R.alignment:R.alignment=w})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:ay,def:"1",set:w=>s(E=>{let R=E.payload;w==="2"?R.lineLimit=2:delete R.lineLimit})})}
        ${Ke("Mono digits",n.payload.monospacedDigits===!0,w=>s(E=>{let R=E.payload;w?R.monospacedDigits=!0:delete R.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${b?Cy(e,n.payload,y,g("Main colour")):f}`;break}case"icon":k=h`
        ${ce(e,n.payload.symbol,y=>s(w=>{w.payload.symbol=y},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${o}-symbol`,setSymbolPath:y=>s(w=>{let E=w.payload;y?E.path=y:delete E.path},"symbol")})}
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,C=er(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let y=n.payload,w=(R,F)=>s(G=>R(G.payload),F),E=y.style==="dots";k=h`
        ${ce(e,y.value,R=>w(F=>{F.value=R},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${E?h`
            ${ce(e,y.total??wu(y),R=>w(F=>{F.total=R},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${ga} dots are drawn.</div>`:$y(e,y,{min:u.minValue,max:u.maxValue},o,w)}`,b=!0,C=h`
        <div class="grid2">
          ${te("Style",y.style,_g,R=>w(F=>{R==="dots"&&F.total===void 0&&(F.total=wu(F)),R!=="dots"&&delete F.total,F.style=R}),{titles:zg,def:u.style})}
          ${E?f:er(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${be(E?"Empty dot colour":"Track colour",y.trackColorHex,R=>w(F=>{F.trackColorHex=R??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${te("Colour",y.coloring,Fs,R=>w(F=>{F.coloring=R,R==="bands"&&F.bands.length===0&&(F.bands=dr([F.minValue,F.maxValue]))}),{def:u.coloring})}
        ${g("Main colour")}
        ${y.coloring==="bands"?h`
          ...
          ${cr(y,y.colorSlot.baseColorHex,w,at(e.resolve(y.value)??"")[0])}`:f}
        ${E?f:h`
          <div class="grid2">
            ${ae("Threshold",y.thresholdValue,R=>w(F=>{R===void 0?delete F.thresholdValue:F.thresholdValue=R},"thr"),{optional:!0})}
            ${y.thresholdValue===void 0?f:be("Threshold colour",y.thresholdColorHex,R=>w(F=>{F.thresholdColorHex=R??Gn},"thrcol"),!1,Gn)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,w=(M,I)=>s(Fe=>M(Fe.payload),I),E=u.historyMinutes,R=u.historyPoints,F=y.historyMinutes>0,G=F&&y.source==="statistics",q=F&&!G,le=F?G?"statistics":"history":"value",We=G?Ci:un,rt=hn(y)??mn(y),Le=y.value.kind.kind==="entityState",he=rt===void 0?void 0:e.historySeries(rt),Ne=F&&Le?he??"":e.resolve(y.value)??"",je=y.historyPoints<1,Bp=q&&Le&&rt!==void 0?e.historyReadings?.(rt):void 0,Qs=fy(je,Bp,Mn(y.historyMinutes)),el=As(a,y.historyMinutes,We),Cr=F&&Le?Uo(Ne):{values:at(Ne),holes:[]},In=Cr.values,tl=M=>y.limit>0&&M.length>y.limit?y.takeFromEnd?M.slice(M.length-y.limit):M.slice(0,y.limit):M,Gp=tl(In),Et=Ko(Gp,tt(y.smoothing),Cr.holes.length>0?tl(Cr.holes):[]),Up=!F&&Le&&In.length===1,Sr=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),Kp=ue(e),ea=y.scaleFrom!==void 0&&Sr.some(M=>M.payload.id===y.scaleFrom);k=h`
        ${ce(e,y.value,M=>w(I=>{I.value=M},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${te("Draw",le,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],M=>w(I=>{if(M==="value"){I.historyMinutes=0;return}I.source=M==="statistics"?"statistics":"history";let Fe=I.historyMinutes||ba;I.historyMinutes=M==="statistics"?Math.min(Fe,to):Math.min(Fe,xa)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${G?h`
            ...
            <div class="grid2">
              ${Ss(a,y.historyMinutes,E,M=>w(I=>{I.historyMinutes=M}),Ci)}
              ${te("Per",y.statPeriod,fa,M=>w(I=>{I.statPeriod=M}),{def:vi})}
            </div>
            ${el?Ts(y.historyMinutes,M=>w(I=>{I.historyMinutes=M},"span"),!0):f}
            ${te("Read",y.statType,qr,M=>w(I=>{I.statType=M}),{def:wi})}
            ...
            ${Le&&he===void 0?h`<div class="hint keep">Reading the statistics…</div>`:f}
            ${Le&&he===""?h`<div class="hint warn">No long-term statistics for this entity in that span.
        ...
        ${q?h`
            ${Le?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Ss(a,y.historyMinutes,E,M=>w(I=>{I.historyMinutes=M}))}
              <div class="field readings-field">${ze("Points",{atDefault:y.historyPoints===R,title:`Back to ${R<1?"every one":`${R} averaged`}`,reset:()=>w(M=>{M.historyPoints=R})})}
                <div class="readings-row">
                  ...
                  ${je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(y.historyPoints)}
                      ...
                      step="1" min=${no} max=${Dt}
                      @input=${ye(M=>{let I=Number(M);M.trim()!==""&&Number.isFinite(I)&&I>=1&&w(Fe=>{Fe.historyPoints=Math.round(I)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${el?Ts(y.historyMinutes,M=>w(I=>{I.historyMinutes=M},"span")):f}
            ...
            ${Le&&he===void 0?h`<div class="hint keep">Reading the history…</div>`:f}
            ${Le&&he===""?h`<div class="hint warn">Nothing recorded for this entity in that span.
                Either it is excluded from the recorder, or it has no numeric states.</div>`:f}`:f}
        ${F?h`
            ${Ke("Show gaps when unavailable",y.gaps===!0,M=>w(I=>{M?I.gaps=!0:delete I.gaps}),u.gaps===!0)}
            ${Wt(e)}
        ...
        ${In.length===0&&!(F&&(!Le||he===void 0||he===""))?h`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${In.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${dy(Et)}</span>${In.length===Et.length?h` · ${Et.length} ${Et.length===1?"value":"values"}`:h` · ${Et.length} of ${In.length}`}</span></div>`:f}
        ${Up?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
              Switch Draw to <b>Recorded history</b> to plot how it has moved.</div>`:f}
        ${F&&y.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",y.limit,M=>w(I=>{I.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${y.limit<=0?f:te("Keep",y.takeFromEnd?"end":"start",F?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],M=>w(I=>{I.takeFromEnd=M==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${Ee("Smooth data",tt(y.smoothing)??"off",Cg,M=>w(I=>{let Fe=tt(M);Fe===void 0?delete I.smoothing:I.smoothing=Fe}),{def:tt(u.smoothing)??"off"})}
        ${Wt(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,b=!0;let Wp=(()=>{if(ea)return!0;if(y.scale==="fixed")return y.minValue<0&&y.maxValue>0;let M=Et.filter(ta=>Number.isFinite(ta));if(M.length===0)return!0;let I=Math.min(...M,y.thresholdValue??1/0),Fe=Math.max(...M,y.thresholdValue??-1/0);return I<0&&Fe>0})();C=h`
        <div class="grid2">
          ${te("Style",y.style,Sg,M=>w(I=>{I.style=M}),{def:u.style})}
          ${y.style==="bars"?ae("Bar gap",y.barGap,M=>w(I=>{I.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):er(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${y.style==="bars"?h`
          <div class="grid2">
            ${ae("Corner radius",zt(y.barRadius),M=>w(I=>{let Fe=Math.max(0,M??Vn);Fe===Vn?delete I.barRadius:I.barRadius=Fe},"barradius"),{step:.5,min:0,def:zt(u.barRadius),unit:"pt"})}
          </div>
          ${Ke("Round top only",Nt(y.barCorners)==="top",M=>w(I=>{M?I.barCorners="top":delete I.barCorners}),Nt(u.barCorners)==="top")}
          ${Wt(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${te("Curve",y.curve??"straight",wg,M=>w(I=>{M==="straight"?delete I.curve:I.curve=M}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Wt(e)}
          ${y.style==="area"?h`
            ${te("Fill",_t(y.fillStyle),kg,M=>w(I=>{M==="flat"?delete I.fillStyle:I.fillStyle=M}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:_t(u.fillStyle)})}
            ${fu("Fill colour",y.fillColorHex,"Line colour",M=>w(I=>{M===void 0?delete I.fillColorHex:I.fillColorHex=M},"fillcol"))}
            ${Wt(e)}`:f}`}
        <div class="grid2">
          ${te("Scale",y.scale,Tg,M=>w(I=>{I.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${te("Baseline",y.baseline,Eg,M=>w(I=>{I.baseline=M}),{def:u.baseline})}
        </div>
        ${Sr.length===0?f:Ee("Same scale as",ea?y.scaleFrom:"",[["","Its own"],...Sr.map(M=>[M.payload.id,Re(M,Kp)])],M=>w(I=>{M?I.scaleFrom=M:delete I.scaleFrom}),{def:""})}
        ...
        ${!ea&&y.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",y.minValue,M=>w(I=>{I.minValue=M??0},"cmin"),{def:u.minValue})}
              ${ae("Max",y.maxValue,M=>w(I=>{I.maxValue=M??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let M;e.update(I=>{M=zd(I,a)}),M&&e.selectLayer(M)}}>${B("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${te("Colour",y.coloring,Fs,M=>w(I=>{I.coloring=M,M==="bands"&&I.bands.length===0&&(I.bands=dr(Et))}),{def:u.coloring})}
        ${g("Main colour")}
        ${y.coloring==="bands"?h`
          ...
          ${cr(y,y.colorSlot.baseColorHex,w)}
          ${y.style==="area"?h`${Ke("Band fill",y.fillBands,M=>w(I=>{I.fillBands=M}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let nl=M=>Oe(e.config,a).some(I=>I.payload.chartAnchor?.at===M),jp=gn(e.config,a).length>0,qp=yn(e.config,a).length>0,Yp=bn(e.config,a).length>0,il=Sd(e.config,a).length>0,Xp=pn(y)?void 0:je&&q?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Jp=y.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0,Hn=(M,I,Fe,ta)=>h`
        <button class="small ${I?"on":""}" ?disabled=${I||ta!==void 0} aria-pressed=${I?"true":"false"}
          title=${I?`${M} is on this chart. Remove it in the list at the bottom.`:ta??`Add ${M.toLowerCase()} to this chart`}
          @click=${()=>e.update(Zp=>{Fe(Zp)})}>${I?h`<span aria-hidden="true">✓</span>`:B("plus")}<span>${M}</span></button>`;x=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders">
            ${Hn("Threshold line",nl("threshold"),M=>Td(M,a,y.thresholdValue??Rg(Et)))}
            ${Hn("Now line",nl("now"),M=>Ed(M,a,!0))}
            ${Hn("Zero line",il,M=>{wo(M,a)})}
            ${Hn("Clock times",jp,M=>{bo(M,a)},Xp)}
            ${Hn("Dots",qp,M=>{xo(M,a)},Jp)}
            ${Hn("Grid lines",Yp,M=>{vo(M,a)})}
          </div>
        </div>
        ${y.thresholdValue===void 0?f:h`
          <div class="grid2">
            ${ae("Threshold at",y.thresholdValue,M=>w(I=>{I.thresholdValue=M??0},"thval"))}
          </div>
          <div class="hint">${y.scale==="fixed"?"A threshold outside Min and Max draws nothing: the plot keeps the range you asked for.":"The plot stretches to include the threshold, so a series that never reaches it still shows how far off it is."}</div>`}
        ${y.nowIndex===void 0?f:h`
          ${ce(e,y.nowIndex,M=>w(I=>{I.nowIndex=M},"nowidx"),{showResolved:!0,label:"Now is reading",key:`${o}-nowindex`})}
        ...
        ${il&&!Wp?h`<div class="hint warn">These readings never go below zero, or never above it, so zero sits
        ...
        ${Wt(e)}`;break}case"timeline":{let y=n.payload,w=(he,Ne)=>s(je=>he(je.payload),Ne),E=u.historyMinutes,R=y.value.kind.kind==="entityState",F=Bt(y),G=F===void 0?void 0:e.historySeries(F),q=st(y)*60,le=Li(G??"",Vt),We=As(a,y.historyMinutes),rt=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,Le=Hg(le,q,rt===void 0?void 0:e.hass.states[rt]?.state,rt?.split(".")[0]);k=h`
        ${ce(e,y.value,he=>w(Ne=>{Ne.value=he},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        ${Ss(a,y.historyMinutes,E,he=>w(Ne=>{Ne.historyMinutes=he}))}
        ${We?Ts(y.historyMinutes,he=>w(Ne=>{Ne.historyMinutes=he},"span")):f}
        ...
        ${le.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${my(le,q)}</span></span></div>`:f}
        ...
        ${Lg(y,w,Le,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ${Le.length>2?h`<div class="hint keep">Seen in this span: <span class="nums">${Le.filter(he=>he!=="unavailable"&&he!=="unknown").join(", ")}</span>. Click into a State box to pick one.</div>`:f}
        <div class="grid2">
          ${ae("Gap",y.gap,he=>w(Ne=>{Ne.gap=Math.min(wa,Math.max(0,he??0))},"tgap"),{step:.5,min:0,max:wa,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",y.cornerRadius,he=>w(Ne=>{Ne.cornerRadius=Math.max(0,he??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
        ...
        ${Tu(y,w,u,"tl",h`
          ...
          ${te("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],y=>s(w=>{w.payload.kind=y}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:u.kind})}
          ${n.payload.kind==="roundedRectangle"?ae("Corner radius",n.payload.cornerRadius,y=>s(w=>{w.payload.cornerRadius=y??6},"radius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"}):f}
        </div>
        ${n.payload.kind==="line"?py(t,d,c):f}`,C=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,y=>s(w=>{w.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ${be("Border colour",n.payload.borderColorHex,y=>s(w=>{y===void 0?delete w.payload.borderColorHex:w.payload.borderColorHex=y},"border"),!0,null)}
        ${n.payload.borderColorHex!==void 0?ae("Border width",n.payload.borderWidth,y=>s(w=>{w.payload.borderWidth=y??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let y=n.payload,w=(G,q)=>s(le=>G(le.payload),q),E=y.entity.entityId?e.hass.states[y.entity.entityId]?.attributes?.entity_picture:void 0,R=typeof E=="string"?E:void 0,F=R!==void 0&&!R.startsWith("/");k=h`
        ${te("Source",y.source,[["camera","Camera"],["entityPicture","Entity picture"]],G=>w(q=>{q.source=G}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:u.source})}
        ${y.source==="camera"?h`
        ...
        ${te("Picture",y.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],G=>w(q=>{q.contentMode=G}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:u.contentMode})}
        ${qi("Zoom",y.zoom,G=>w(q=>{q.zoom=G},"zoom"),{min:ts,max:4,step:.05,def:1,format:G=>`${G.toFixed(2)}x`,unit:"x"})}
        ${qi("Pan left/right",y.panX,G=>w(q=>{q.panX=G},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${qi("Pan up/down",y.panY,G=>w(q=>{q.panY=G},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${y.contentMode==="fit"&&y.zoom===1?"hint keep":"hint"}>${sy(y)}</div>
        ${ae("Corner radius",y.cornerRadius,G=>w(q=>{q.cornerRadius=Math.max(0,G??Wn)},"imgradius"),{step:1,min:0,def:Wn,unit:"pt"})}`;break}case"tap":{k=h`
        ${ip(e,n.payload,(y,w)=>s(E=>y(E.payload),w),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let y=n.payload,w=(F,G)=>s(q=>F(q.payload),G),E=e.config.elements.find(F=>F.payload.id===y.chart),R=E?.kind==="chart"?E:void 0;k=h`
        <div class="field readout"><span>Chart</span><span class="readout-v">${R?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(R.payload.id)}>${Re(R,ue(e))}</button>`:"None"}</span></div>
        ${R===void 0?h`<div class="hint warn">The chart these times belonged to is gone, so this layer draws nothing.</div>`:pn(R.payload)?f:h`<div class="hint warn">That chart has no evenly spaced span to label, so this layer draws
        ...
        <div class="hint">The clock times of that chart's span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,C=Tu(y,w,u,"ct",h`
        <div class="hint">Evenly spaced from the start of the chart's span to now. Auto follows the watch's
          own clock and drops the minutes past a three hour span.</div>`);break}case"chartDots":{let y=n.payload,w=(q,le)=>s(We=>q(We.payload),le),E=e.config.elements.find(q=>q.payload.id===y.chart),R=E?.kind==="chart"?E:void 0,F=R===void 0?void 0:He(e.config,t,R).size??R.payload.lineWidth,G=F===void 0?void 0:Math.round(F*18)/10;k=h`
        ${Mu(e,R)}
        ...
        ${Wt(e)}`,C=h`
        ${te("Dots",y.dots,$g,q=>w(le=>{le.dots=q}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",y.size??G,q=>w(le=>{let We=mt(q);We===void 0||We===G?delete le.size:le.size=We},"dotsize"),{step:.5,min:1,max:12,...G===void 0?{}:{def:G},unit:"pt"})}
          ${fu("Dot colour",y.colorHex,"Series colour",q=>w(le=>{q===void 0?delete le.colorHex:le.colorHex=q},"dotcol"))}
        </div>
        <div class="hint">Auto leaves the dots off once the readings sit too close to tell apart. Left alone, a dot
          is a little wider than the chart's line and takes the colour the series has at its reading.</div>`;break}case"chartGrid":{let y=n.payload,w=(F,G)=>s(q=>F(q.payload),G),E=e.config.elements.find(F=>F.payload.id===y.chart),R=E?.kind==="chart"?E:void 0;k=h`
        ${Mu(e,R)}
        ...
        ${Wt(e)}`,C=h`
        <div class="grid2">
          ${ae("Lines",y.lines,F=>w(G=>{G.lines=Dn(F??Pn)},"lines"),{step:1,min:1,max:4,def:Pn})}
          ${ae("Thickness",y.thickness,F=>w(G=>{G.thickness=On(F??Nn)},"thick"),{step:.25,min:Wr,max:jr,def:Nn,unit:"pt"})}
        </div>
        ${be("Colour",y.colorHex,F=>w(G=>{G.colorHex=F??ln},"gridcol"),!1,ln)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let $=b||Wi(n)===void 0?void 0:g(n.kind==="shape"?"Fill colour":n.kind==="text"&&yt(n.payload)?"Layer colour":"Colour"),S=To(e.config,n),H=S?{kind:{kind:"entityState",...S}}:void 0,P=n.kind==="image"?n.payload.timestamp===!0:!1,L=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,Z=Py[n.kind],T=Dy[n.kind],O=Cs(n.payload,u,Z),X=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,U=e.config.perFamily[t]?.placements[a]?.size!==void 0,ee=Cs(n.payload,u,T)||X!==void 0&&l.size!==void 0&&l.size!==u[X],A=fn(e.config,a),K=(y,w)=>()=>s(E=>tr(E.payload,u,y),w);return h`
    ${we(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"?f:ep(e,n,o)}${k}`,{color:Q.content,icon:"content",summary:Ps(e,n),...O?{reset:()=>s(y=>{tr(y.payload,u,Z),y.kind==="text"&&Bi(y.payload.rules)},"reset-content")}:{}})}
    ${C===void 0&&$===void 0?f:we(e,"look",n.kind==="image"?"Picture":"Look",h`${C??f}${$??f}`,{color:Q.look,icon:n.kind==="image"?"image":"look",...pr(n)?{summary:pr(n)}:{},...ee?{reset:()=>e.update(y=>{tr(y.elements[r].payload,u,T),U&&Me(y,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?we(e,"numbers","Extras",Gy(e,n,x),{color:Q.numbers,icon:"text",summary:By(e,n),...A.length>0||Oe(e.config,a).length>0||gn(e.config,a).length>0||yn(e.config,a).length>0||bn(e.config,a).length>0||Cs(n.payload,u,Ru)?{reset:()=>e.update(y=>{for(let E of fn(y,a))$e(y,E.payload.id);for(let E of Oe(y,a))$e(y,E.payload.id);for(let E of gn(y,a))$e(y,E.payload.id);for(let E of yn(y,a))$e(y,E.payload.id);for(let E of bn(y,a))$e(y,E.payload.id);let w=y.elements.find(E=>E.payload.id===a);w&&tr(w.payload,u,Ru)})}:{}}):f}
    ${n.kind==="image"?we(e,"timestamp","Timestamp",ly(n.payload,(y,w)=>s(E=>y(E.payload),w)),{color:Q.numbers,icon:"clock",summary:P?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...P?{reset:K(Ny,"reset-stamp")}:{}}):f}
    ${we(e,"states","States",up(e,n.payload.rules,n.kind,y=>y.elements.find(w=>w.payload.id===a)?.payload.rules,`rules-${a}`,H,L),{color:Q.states,icon:"states",summary:Pi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(y=>{y.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:yy(e,n,t)}
    ${i.tap===!1?f:xy(e,n)}`}var Ny=["timestamp","timestampCorner","timestampSize"],Py={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[],chartDots:[],chartGrid:[]},Dy={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["dots","size","colorHex"],chartGrid:["lines","colorHex","thickness"]};function Mu(e,n){return h`<div class="field readout"><span>Chart</span><span class="readout-v">${n?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(n.payload.id)}>${Re(n,ue(e))}</button>`:"None"}</span></div>`}var Ru=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function ip(e,n,t,i){let a=n.action;return h`
    ${Ee("Tap action",a.type,Xg,r=>t(o=>{o.action=Wu(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?pt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?ju(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?Yu(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var Oy=24;function Vy(e,n){let t=[],i=1/0;for(let r of re){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Ld(e.config,n,r);o&&(t.push(`${ne(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<Oy;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function By(e,n){let t=n.payload,i=fn(e.config,t.id),a=Oe(e.config,t.id),r=gn(e.config,t.id),o=yn(e.config,t.id),s=bn(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(Bn.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(dn.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function Gy(e,n,t){let i=ue(e),a=fn(e.config,n.payload.id),r=gn(e.config,n.payload.id),o=yn(e.config,n.payload.id),s=bn(e.config,n.payload.id),l=Oe(e.config,n.payload.id),d=g=>e.update(x=>{wd(x,n.payload.id,g)}),c=g=>e.update(x=>{yo(x,n.payload.id,g)}),u=new Set(a.map(g=>g.payload.value.kind.kind==="chartStat"?g.payload.value.kind.stat:"")),p=new Set(l.map(g=>g.payload.chartAnchor.at)),m=(g,x,k,C)=>h`
    <div class="num-row">
      ...
      <button class="icon danger" title=${`Delete this ${C.toLowerCase()}`} aria-label=${`Delete this ${C.toLowerCase()}`}
        @click=${()=>e.update($=>$e($,g))}>${B("close")}</button>
    ...
    <div class="field list-field"><span>Numbers</span>
      <div class="adders">
        ${Bn.map(([g,x])=>h`
          <button class="small" title=${u.has(g)?`Add another ${x.toLowerCase()}`:`Add the ${x.toLowerCase()}`}
            @click=${()=>d(g)}>${B("plus")}<span>${x}</span></button>`)}
      </div>
    </div>
    ...
    <div class="field list-field"><span>Markers</span>
      <div class="adders">
        ${dn.filter(([g])=>gt(g)).map(([g,x])=>h`
          <button class="small" title=${p.has(g)?`Add another mark over the ${x.toLowerCase()}`:`Mark the ${x.toLowerCase()}`}
            @click=${()=>c(g)}>${B("plus")}<span>${x}</span></button>`)}
      </div>
    </div>
    ...
    ${b===0?f:h`
      ...
      <div class="chart-numbers">
        ${a.map(g=>m(g.payload.id,e.resolve(g.payload.value)??"--",Re(g,i),"Number"))}
        ${l.map(g=>{let{at:x,place:k}=g.payload.chartAnchor,C=dn.find(([S])=>S===x)?.[1]??"Reading";if(k==="through")return m(g.payload.id,x==="now"?"\u2502":"\u2500",x==="zero"?"Zero":C,"Line");let $=g.kind==="text"?e.resolve(g.payload.value)??"\u25CF":g.kind==="icon"?Ky(e.resolve(g.payload.symbol)):"\u25C6";return m(g.payload.id,$,C,"Marker")})}
      ...
      <div class="hint">Click a row to edit that layer. The × deletes it, and Undo brings it back. Dots and grid
        ...
        dot to pick the dots.</div>`}`}function Uy(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ve(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=Eo(e.config,n);return h`
    ${Ke("Tappable",a!==void 0,s=>e.update(l=>{s?Sa(l,i):Ta(l,i)}))}
          ...
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${ka(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...ho}})}>${B("reset")}</button>`}
            </div>
          </div>
        </div>
        ${Vy(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${xt(o)}</b>.</div>`}`}function Fu(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Ky(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Re(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=dn.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return Fu(xe(e.payload.value,n));case"icon":return Fu(xe(e.payload.symbol,n));case"gauge":return xe(e.payload.value,n);case"chart":return xe(e.payload.value,n);case"timeline":return xe(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines"}}function ap(e,n){let t=wt(e.config,n.id),i=ue(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return we(e,"content","Group",h`
    ${ve("Name",n.name,r=>a(o=>{o.name=r},"name"))}
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:Q.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function rp(e,n){if(n==="inline")return Wy(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ne(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ne(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=vr(e.config,n),r=t.backgroundColorHex?Se(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Se(t.borderColorHex)} border`:"no border";return h`
    ...
    ${we(e,"content","Inline text",h`
      ${ve("Label (blank = value only)",n.label??"",a=>t(r=>{a?r.label=a:delete r.label},"label"))}
      ${ce(e,n.value,a=>t(r=>{r.value=a},"value"),{showResolved:!0,label:"Text",key:"inline-value"})}
      ${Ds(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:Q.content,icon:"text",summary:De(`${n.label?`${n.label}: `:""}${xe(n.value,i)}`,48)})}
    ${we(e,"symbol","Symbol",h`
      ${Du(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:Q.look,icon:"icon",summary:n.symbol||"None"})}`}function jy(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="gauge"&&n.bezelGauge?qy(e,n.bezelGauge,t):f}`}function qy(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${Ke("End labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=_(String(s.minValue)),s.maxLabel=_(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?ce(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):f}
    ${n.maxLabel?ce(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var xw=re.map(e=>[e,ne(e)]),Os={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Yy=Object.keys(Os),hr=["color","text","fontSize","fontWeight","visibility"];function Xy(e,n=!1){let t=Ri[e].filter(i=>!n||hr.includes(i));return Yy.filter(i=>t.includes(_e[i]))}function op(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Ay(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var Jy={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function ir(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function De(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function sp(e){if(!e||Ae(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function xe(e,n){return`${Ji(e,n)}${sp(e.format)}`}function Ji(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${De(t.value,40)}"`:"(empty)";case"entityState":return ir(t,n);case"entityAttribute":return t.attribute?`${ir(t,n)} \xB7 ${t.attribute}`:ir(t,n);case"entityAge":return`age of ${ir(t,n)}`;case"aggregate":return Zy(t.aggregate);case"time":return Jy[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${De(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Bn.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Ji(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function Zy(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Xi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function Qy(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.map((s,l)=>eb(e,s,l,n.length,t,o,`${a}-${s.id}`,r))}
    <div class="adders"><button class="small" @click=${()=>o(s=>{s.push(Fi())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function eb(e,n,t,i,a,r,o,s){let l=e.liveBranch(n),d=e.forced.get(n.id)??"live",c=m=>d==="live"?m==="live":d==="otherwise"?m==="otherwise":d.caseId===m,u=(m,b)=>r(g=>{let x=g.find(k=>k.id===n.id);x&&m(x)},b),p=s!==void 0&&n.partId!==void 0;return h`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${s===void 0?f:op(s,n.partId,ue(e),m=>u(b=>{m?b.partId=m:delete b.partId}))}
    ...
    ${n.cases.map((m,b)=>tb(e,m,b,n,a,u,`${o}-${m.id}`,p))}
    <div class="adders"><button class="small" @click=${()=>u(m=>{m.cases.push(No())})}>+ case</button></div>
    ${Ke("Otherwise",n.otherwise!==void 0,m=>u(b=>{m?b.otherwise=b.otherwise??[]:delete b.otherwise}))}
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${lp(e,n.otherwise,a,m=>u(b=>{b.otherwise&&m(b.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function tb(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(b=>b.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>nb(e,c,u,p=>l(m=>{let b=m.when.tests.find(g=>g.id===c.id);b&&p(b)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(zo())})}>+ test</button>
    ...
    ${lp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${ce(e,s.upper??_(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${ve("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!ib(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Au(e,"From",s.value??_("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Au(e,"To",s.upper??_("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=ab(n.value)?rb(s.options??[],u=>o(p=>{p.comparison.options=bs(u)},"options")):ve("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Ee("Comparison",s.kind,Bd.map(u=>[u,ai[u]]),u=>o(p=>{p.comparison=Po(p.comparison,u)}))}
    ${c}
  </div>`}function ib(e){try{return new RegExp(e),!0}catch{return!1}}function Au(e,n,t,i,a){if(t.kind.kind!=="literal")return ce(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=vn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${ye(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function ab(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function rb(e,n){let t=du(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    ...
    </div></div>`}function lp(e,n,t,i,a,r=!1){let o=Xy(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>ob(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(kn(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${Os[s]}</option>`)}
    </select>`}var dp=["setColor","setBorderColor","setBackgroundColor"];function ob(e,n,t,i,a,r,o,s=!1){let l=!Ri[i].includes(_e[n.kind]),d=s&&!l&&!hr.includes(_e[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${cp(e,n,a,o)}
  </div>`}function cp(e,n,t,i){let a=Fa(n.kind),r=f;if(a==="value"){let o=n.value??_("");if(dp.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?be("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=_(l??"#FFFFFF")},"color")):ce(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{Hs.delete(a),Te(d.target)}}>Show as table</button>
        ${s.ok?f:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${Qy(e,n,t,i,a,o)}`:sb(e,s.table,n[0],t,i,a,r,o)}function sb(e,n,t,i,a,r,o,s){let l=(y,w)=>e.update(E=>{let R=a(E);R&&y(R)},w?`${r}-${w}`:void 0),d=n.value??Iu.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Qc(d)&&lb(e.resolve(d)),p=Ri[i],m=ar.get(r)??new Set,b=n.columns.length===0&&m.size===0?[Zc[i]]:[],g=Gc(n.columns,[...m,...b.filter(y=>y!==void 0)],p),x=nr.get(r),k=t?t.partId:s?.some(y=>y.id===x)?x:void 0,C=s!==void 0&&k!==void 0,$=C?p.filter(y=>hr.includes(y)):p,S=C?g.filter(y=>!hr.includes(y)):[],H=(y,w)=>{if(!t){y?nr.set(r,y):nr.delete(r),Te(w);return}l(E=>{let R=E[0];R&&(y?R.partId=y:delete R.partId)})},P=t?e.liveBranch(t):"none",L=t?e.forced.get(t.id)??"live":"live",Z=y=>L!=="live"&&(L==="otherwise"?y==="otherwise":L.caseId===y),T=y=>{t&&e.setForced(t.id,Z(y)?"live":y==="otherwise"?"otherwise":{caseId:y})},O=y=>{Iu.set(r,y),n.rows.length!==0&&l(w=>Yc(w,y),"lhs")},X=()=>{nr.delete(r),l(y=>{jc(y,d??_(""),u),k!==void 0&&y[0]&&y[0].partId===void 0&&(y[0].partId=k)})},U=n.rows.map((y,w)=>Lu(e,{key:`${r}-${y.caseId}`,label:Jc(y.comparison,E=>xe(E,ue(e))),columns:g,changes:y.changes,live:P===y.caseId,forced:Z(y.caseId),onForce:()=>T(y.caseId),when:hb(e,y.comparison,`${r}-${y.caseId}`,(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===y.caseId)?.when.tests[0];G&&E(G.comparison)},R&&`${y.caseId}-${R}`)),updChanges:(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===y.caseId);G&&E(G.then)},R&&`${y.caseId}-${R}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${w===0} @click=${()=>l(E=>us(E,w,w-1))}>${B("up")}</button>
      <button class="icon" title="Move down" ?disabled=${w===n.rows.length-1} @click=${()=>l(E=>us(E,w,w+1))}>${B("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>qc(E,y.caseId))}>${B("delete")}</button>`})),ee=n.otherwise===void 0?f:Lu(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:P==="otherwise",forced:Z("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(y,w)=>l(E=>{let R=E[0]?.otherwise;R&&y(R)},w),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(y=>ps(y,!1))}>${B("close")}</button>`}),A=rr.get(r),K=db.filter(y=>$.includes(y)&&!g.includes(y));return h`
    <div class="states">
      ${ce(e,d??_(""),O,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:op(s,k,ue(e),H)}
          ...
          <tr>
            ...
            ${g.map(y=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${ct[y]} column`}
                @click=${w=>{rr.set(r,y),Te(w.target)}}>${B("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${wr(S.map(y=>ct[y]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${A===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${ct[A]} column? Its ${Hu(n,A)} value${Hu(n,A)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${y=>{rr.delete(r),ar.get(r)?.delete(A),Te(y.target),l(w=>Xc(w,A))}}>Remove</button>
        <button class="small" @click=${y=>{rr.delete(r),Te(y.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(y=>ps(y,!0))}>${B("plus")}<span>Otherwise</span></button>`:f}
          ${K.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${y=>{let w=y.target,E=w.value;if(w.value="",!E)return;let R=ar.get(r)??new Set;R.add(E),ar.set(r,R),Te(w)}}>
      ...
      <div class="states-switch">
        <button class="link" @click=${y=>{Hs.add(r),Te(y.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function lb(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var db=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Hu(e,n){let t=0;for(let i of e.rows)Ya(i.changes,n)&&(t+=1);return e.otherwise&&Ya(e.otherwise,n)&&(t+=1),t}function cb(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Lu(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{cb(t)||n.onForce()}}>
    <td class="when">
  ...
  </tr>`}function ub(e,n,t,i,a){let r=Ya(t,n),o=xr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${ct[n]} for this state`}
      @click=${d=>{i(c=>{c.push(kn(Bc[n]))}),Vu(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>_e[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=ct[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${pb(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Bu}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${Yi.has(o)?h`${n==="visibility"?te("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):cp(e,r,s,a)}
    ...
    </div>`}function pb(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Fa(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${ri.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??_(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(dp.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Se(a):xe(i,ue(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${xe(i,ue(e))}</span>`}function Se(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function hb(e,n,t,i){let a=wn(n.kind),r=ds(n.kind),o=(s,l,d,c)=>fb(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ye(s=>i(l=>{let d=Po(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${ls.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${mb(s)}</option>`)}
    </select>
  ...
  </span>`}function mb(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return ai[e]}}function fb(e,n,t,i,a,r,o){let s=xr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${Ou(e,s,o,n,t,l)}
  </span>`}var Zi=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:So,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function fp(e){return Zi.find(n=>n.kind===e)??Zi[0]}var pp="#FF9F0A",kr="#8E8E93",gb=["#FF453A","#FFD60A","#34C759"],gp=["#0A84FF","#34C759","#FF9F0A"];function yb(e){return e?.attributes?.device_class==="battery"?gb:gp}var bb={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function xb(e){let n=e.iconName?.trim();return n?{off:n,on:n}:bb[Vs(e)]??{off:"circle",on:"circle.fill"}}function vb(e){switch(Vs(e)){case"lock":return{kind:"equals",value:_("locked")};case"cover":case"valve":return{kind:"equals",value:_("open")};case"media_player":return{kind:"equals",value:_("playing")};default:return{kind:"isOn"}}}function Vs(e){return e.domain||e.entityId.split(".")[0]||""}function Xt(e){return{...e,domain:Vs(e)}}function wb(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function oi(e){return Math.round(e*1e4)/1e4}function Fn(e,n,t){return Math.min(t,Math.max(n,e))}function Bs(e,n,t){let i=Ie[e],a=Fn(oi(n/i.width),0,1),r=Fn(oi(t/i.height),0,1);return{x:oi((1-a)/2),y:oi((1-r)/2),width:a,height:r,rotationDegrees:0}}function kb(e){let n=Ie[e],t=Fn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:Bs(e,t*1.3,t*1.3),size:t}}function $b(e){let n=Ie[e],t=Fn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:Bs(e,n.width*.88,t*1.7),size:t}}function Cb(e){let n=Ie[e],t=Math.min(n.width,n.height)*.9;return{frame:Bs(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function yp(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Sb(e){let n=Ie[e],t=Fn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:oi(t/n.height),rotationDegrees:0}}}function Tb(e){let n=Ie[e],t=Fn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:oi(Fn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Eb(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Mb(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function qt(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Mb(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=kt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function Yt(e){return Ce(e)}function Gs(e,n){let t={kind:{kind:"entityState",...Xt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function hp(e){let n=kn("setIcon");return n.value=_(e),n}function Rn(e){let n=kn("setColor");return n.value=_(e),n}function Rb(e,n){let t=Fi(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...Xt(e)}},a.comparison=vb(e);let r=n.on!==n.off;return i.then=r?[hp(n.on),Rn(pp)]:[Rn(pp)],t.otherwise=r?[hp(n.off),Rn(kr)]:[Rn(kr)],t}function Fb(e){let n=Fi(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...Xt(e)}},i.comparison={kind:"isUnavailable"};let a=kn("setOpacity");return a.number=.35,t.then=[a],n}function mp(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Ab(e,n,t=gp){let i=n.max-n.min,a=mp(n.min+i/3),r=mp(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:_(a)},changes:[Rn(t[0])]},{comparison:{kind:"between",value:_(a),upper:_(r)},changes:[Rn(t[1])]},{comparison:{kind:"greaterThan",value:_(r)},changes:[Rn(t[2])]}];return Uc(Gs(e),o)}function Ib(e,n,t){let i=Yt("icon"),a=xb(n);return i.payload.symbol=_(a.off),i.payload.colorSlot.baseColorHex=kr,i.payload.rules=[Rb(n,a)],qt(e,i,t.family,kb),e.elements.push(i),Sa(e,i.payload.id,{type:"toggleEntity",...Xt(n)}),i.payload.id}function Hb(e,n,t){let i=Yt("text");return i.payload.value=Gs(n,t.state),i.payload.rules=[Fb(n)],qt(e,i,t.family,$b),e.elements.push(i),i.payload.id}function Lb(e,n,t){let i=Yt("gauge");i.payload.value=Gs(n);let a=wb(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Ab(n,a,yb(t.state))],qt(e,i,t.family,Cb),e.elements.push(i),i.payload.id}function _b(e,n,t){let i=Yt("chart");return i.payload.value={kind:{kind:"entityState",...Xt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",qt(e,i,t.family,yp),e.elements.push(i),i.payload.id}function zb(e,n,t){let i=Yt("chart");return i.payload.value={kind:{kind:"entityState",...Xt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",qt(e,i,t.family,yp),e.elements.push(i),i.payload.id}function Nb(e,n,t){let i=Xt(n),a=Yt("text");a.payload.value=_(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=kr,qt(e,a,t.family,Tb),e.elements.push(a);let r=t.state?.attributes?.device_class,o=Yt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=uo(i.domain,typeof r=="string"?r:void 0),qt(e,o,t.family,Sb),e.elements.push(o),o.payload.id}function Pb(e,n,t){let i=Yt("image");return i.payload.entity=Xt(n),qt(e,i,t.family,Eb),e.elements.push(i),i.payload.id}function bp(e,n,t,i){switch(n){case"toggle":return Ib(e,t,i);case"status":return Hb(e,t,i);case"gauge":return Lb(e,t,i);case"chart":return _b(e,t,i);case"history":return zb(e,t,i);case"doorHistory":return Nb(e,t,i);case"camera":return Pb(e,t,i)}}var Db=/^[a-z0-9_]+\.shared_(\d+)$/;function xp(e){return Db.test(e)}function Ob(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function wp(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function kp(e,n){let t=new Map;for(let i of _o(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=wp(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${Ob(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function Vb(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);Ho(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),Lo(t,r=>Ro(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function $p(e){let n=!1;return Ra(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function Bb(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function Cp(e,n,t=[]){let i=n==="share"?Vb(e,t):e,a=Yn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${Bb(a)}
`}function Sp(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var Gb="There is nothing to read here. Paste a complication first.",Ub="This is not valid JSON. Check for a missing brace or a stray comma.",Kb="This is valid JSON but not a complication. A complication starts with { and ends with }.",Wb="This does not look like a complication.",vp="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",jb="00000000-0000-4000-8000-000000000000";function qb(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function Tp(e,n){let t=e.trim();if(t==="")return{ok:!1,error:Gb};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:Ub}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:Kb};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${vp}`};let o={...a,id:jb,slotIndex:0},s;try{s=qn(o)}catch(d){let c=d instanceof Xe||d instanceof Error?d.message:String(d);return{ok:!1,error:`${Wb}

${qb(c)}`}}let l=$a(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${vp}`}}return{ok:!0,config:s,raw:i}}function Us(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=_o(e,(o,s)=>xp(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=xp(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:wp(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Ep(e,n){let t=structuredClone(e);Ho(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Lo(t,a=>Ro(a,i)),t}function Mp(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function Yb(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Rp(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=Va(e);return i.length===0?t:`${t}, ${Yb(i)}`}function Ks(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var Jb=3e4,Zb=500,Qb=3e4,Fp="preset-entity";function Ap(e){return`import-entity-${e}`}var ex={entityId:"",displayName:"",domain:""},tx=new Map,nx={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Ws(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function ix(e){return e.kind==="family"?"look":"content"}function js(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Ip(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function ax(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Hp=300,Lp=360,Xs=44,Js=22,Vp=[1,1.7,2.6],rx=["S","M","L"],_p=["Small","Medium","Large"];function ox(){return Vp.map((e,n)=>{let t=Math.round(Xs*e),i=Math.round(Js*e),a=`.layers-card.s${n}`;return`
...
`)}var zp="wrist-assistant-panel.layers.v1",St=34,An=200,sx=720,$r=320,lx=80,dx=56,Np="wrist-assistant-panel.columns.v3",qs=e=>Math.max(An,Math.min(sx,Math.round(e))),Pp=e=>e.metaKey||e.ctrlKey||e.shiftKey,cx=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Qi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Jt=Qi==="Cmd"?"\u2318":"Ctrl+",Ys=Qi==="Cmd"?"\u21E7":"Shift+";function Dp(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-lx;if(i>=An*2+$r){let r=i-$r,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(An,Math.floor(o*l)),s=Math.max(An,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(An,o-d):s=Math.max(An,s-d))}return{columns:3,left:o,right:s}}let a=e-dx;return a>=An+$r?{columns:2,left:Math.min(n,a-$r),right:t}:{columns:1,left:n,right:t}}var z=class z extends Rt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Hp;this.colRight=Lp;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=ti.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Nc(()=>this.requestUpdate());this.imageSizes=Pc(()=>this.requestUpdate());this.symbols=new Ka(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new qa;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Us(a,this.hass.states);r.some(s=>Ns(Ap(s.entityId)))||Ks({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Ns(Fp)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??tx}static{this.styles=Er`
    :host {
      ...
      --wa-text: ${ke(Ue.text)};
      --wa-icon: ${ke(Ue.icon)};
      --wa-gauge: ${ke(Ue.gauge)};
      --wa-shape: ${ke(Ue.shape)};
      --wa-image: ${ke(Ue.image)};
      --wa-tap: ${ke(Ue.tap)};
      --wa-states: ${ke(Q.states)};
      --wa-place: ${ke(Q.place)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.held { background: color-mix(in srgb, ${ke(Q.group)} 12%, var(--wa-panel)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${ke(Q.locked)}; }
    ...
    .card.tint-values {
      ...
      background: color-mix(in srgb, ${ke(Q.complication)} 8%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${ke(Q.complication)} 25%, var(--wa-card));
    }
    .card.tint-states {
      padding: 10px 14px 12px;
      background: color-mix(in srgb, ${ke(Q.states)} 12%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${ke(Q.states)} 35%, var(--wa-card));
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(mr,this.scrubStart),this.addEventListener(fr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Qb)}loadColumnWidths(){try{let t=window.localStorage.getItem(Np);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=qs(i.left)),typeof i.right=="number"&&(this.colRight=qs(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Np,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(zp);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(zp,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Zu(s,o,i))}>Copy the ${ne(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Mo(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let T=this.focusTapId();if(T!==void 0&&o===T&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,T,r??void 0);return}let O=this.hitLayerId(i);O?this.inspect={kind:"layer",id:O}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=Pp(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=Mo(this.draft.config,o),p=this.draft.config.elements.find(T=>T.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=vt(this.draft.config,u),b=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||b)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let g=He(this.draft.config,t,p).frame,x=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let T=p.payload,O=pe[t],X=g.width*O.width,U=g.height*O.height,ee={x:0,y:0,w:X,h:U,cx:X/2,cy:U/2},A=Pa(T,ee,Na(new Date));if(this.cancelGesture?.(),l){let E=x.width/O.width,R=T.timestampSize;this.cancelGesture=ru(s,i,l,{w:A.w*E,h:A.h*E},(F,G)=>{let q=Math.min(40,Math.max(4,Math.round(R*F)));this.mutate(le=>{let We=le.elements.find(rt=>rt.payload.id===u);We?.kind==="image"&&(We.payload.timestampSize=q)},`ts-size-${u}`),G&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let K={x:0,y:0,w:g.width*x.width,h:g.height*x.height},y=bt(T)?{x:T.timestampX,y:T.timestampY}:{x:(A.x+A.w/2)/ee.w,y:(A.y+A.h/2)/ee.h},w=!1;this.cancelGesture=au(s,K,i,y,(E,R,F)=>{F||(w=!0),w&&this.mutate(G=>{let q=G.elements.find(le=>le.payload.id===u);q?.kind==="image"&&(q.payload.timestampX=E,q.payload.timestampY=R)},`ts-${u}`),F&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let k=p.payload.chartAnchor,C=k!==void 0&&!gt(k.at)&&k.place!=="through",$=k!==void 0&&gt(k.at)&&k.place==="through",S=pe[t],H={dx:k?.dx??0,dy:k?.dy??0},P=k!==void 0&&!r?_i(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(T=>T.id===u)?.frame:void 0,L=P??g,Z=T=>Math.round(T*10)/10;this.cancelGesture?.(),this.cancelGesture=Xa(s,x,i,{elementId:u,frame:L,handle:r??void 0},{onFrame:(T,O,X)=>{this.mutate(U=>{if(k===void 0){Me(U,t,T,{frame:O});return}let ee=P?{width:g.width,height:g.height}:{width:O.width,height:O.height};Me(U,t,T,{frame:{...O,...ee,x:C?O.x:g.x,y:g.y}});let A=U.elements.find(w=>w.payload.id===T)?.payload.chartAnchor;if(A===void 0)return;let K=H.dx,y=$?H.dy:Z(H.dy+(O.y-L.y)*S.height);K?A.dx=K:delete A.dx,y?A.dy=y:delete A.dy},`drag-${T}-${t}`),X&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=wt(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,He(o,t,x).frame])),d=[...l.values()],c=Math.min(...d.map(x=>x.x)),u=Math.min(...d.map(x=>x.y)),p=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),b={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},g=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=Xa(a,this.gestureCanvas(t),i,{elementId:r.id,frame:b},{onFrame:(x,k,C)=>{let $=k.x-b.x,S=k.y-b.y;this.mutate(H=>{for(let[P,L]of l)Me(H,t,P,{frame:{...L,x:g(L.x+$),y:g(L.y+S)}})},`drag-group-${r.id}-${t}`),C&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?nu:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(wt(r,x).map(k=>k.payload.id),d,c,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(x=>x.payload.id===u);if(!p)return!1;let m=vt(r,u);if(m?.locked)return this.nudgeMany(wt(r,m.id).map(x=>x.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let b=He(r,d,p).frame,g=ys(b,s,l,c);return(g.x!==b.x||g.y!==b.y)&&this.mutate(x=>Me(x,d,u,{frame:g}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let H=l.elements.find(P=>P.payload.id===S);H&&c.set(S,He(l,i,H).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),b=Math.max(...u.map(S=>S.x+S.width)),g=Math.max(...u.map(S=>S.y+S.height)),x={x:p,y:m,width:b-p,height:g-m,rotationDegrees:0},k=ys(x,o,s,a),C=k.x-x.x,$=k.y-x.y;return(C!==0||$!==0)&&this.mutate(S=>{for(let[H,P]of c)Me(S,i,H,{frame:{...P,x:d(P.x+C),y:d(P.y+$)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=pe[i],c=He(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=Pa(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},Na(new Date)),b=bt(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},g=iu(b,a,r,{w:u,h:p});return(g.x!==b.x||g.y!==b.y)&&this.mutate(x=>{let k=x.elements.find(C=>C.payload.id===t);k?.kind==="image"&&(k.payload.timestampX=g.x,k.payload.timestampY=g.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=za(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=ns(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ve(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=fe(s,l),c=He(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Xa(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(b=>{d?Hd(b,u,t,p):Me(b,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Dp(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${Op(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Ip()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?h`<span class="hor" aria-hidden="true">or</span>${Ip()}`:f}
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=Sp(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Us(i,this.hass.states):[],r=Ks({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?h`<div class="hint err">A complication on this watch already has that name.</div>`:h`<div class="hint">${Rp(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${$p(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${pt({hass:this.hass},t.label,i??ex,a=>this.setImportEntity(t.entityId,a),Ap(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,br(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:Tp(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=Mp(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${Tt(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=Ep(t.config,this.importMap);i.id=J(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=sn(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Op(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${as.length} kinds · ${Zi.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${as.map(s=>h`<button class="add" style=${`--k:${Ue[s]}`} ?disabled=${i} title=${`Add a blank ${ii[s].toLowerCase()} layer`}
              @click=${()=>{let l=Ce(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(T,d)}</b>
          <small><span class="kind">${ii[T.kind]}</span> · ${mx(T,c,this.historySeries,A.size)}</small>
          ${S?h`<span class="facts">${px(this.host(),a,T,A).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${y?h`<span class="badge tap" title=${`Tappable \xB7 ${Re(y,d)}`}>tap</span>`:f}
        ...
        @drop=${E=>{E.preventDefault();let R=y(E);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!A||!K)){if(R==="drop-before"){this.reorderLayer(F,A.payload.id,!0,!0);return}if(R==="drop-after"){this.reorderLayer(F,K.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,A.payload.id,!0),this.mutate(G=>$o(G,F,T.id)))}}}>
        ...
        <span class="name">
          ...
          ${S?h`<span class="facts"><span class="fact"><b>Holds</b> ${O.map(E=>Re(E,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Ys}${Jt}G)`} aria-label="Ungroup" @click=${E=>{E.stopPropagation(),this.mutate(R=>Ei(R,T.id)),X&&(this.inspect={kind:"general"})}}>${B("ungroup")}</button>
          </span>`:f}
      ...
      </div>`},L=[],Z=new Set;for(let T=0;T<l.length;T++){let O=l[T],X=O.payload.groupId,U=X===void 0?void 0:t.groups?.find(K=>K.id===X);if(!U){L.push(H(O,!1));continue}if(Z.has(U.id))continue;Z.add(U.id);let ee=l.filter(K=>K.payload.groupId===U.id);L.push(P(U,ee));let A=this.inspect.kind==="group"&&this.inspect.id===U.id;this.collapsed.has(U.id)||L.push(h`<div class="group-kids">${ee.map(K=>H(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
      <h2 class="panel-title tools" style=${`--c:${Q.place}`}><span class="swatch">${B("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${rx.map((T,O)=>h`
              <button class=${this.thumbStep===O?"on":""} title=${`${_p[O]} row pictures`}
                aria-label=${`${_p[O]} row pictures`} aria-pressed=${this.thumbStep===O?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?fp(this.presetKind):void 0,i=this.presetEntity;return h`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:h`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${pt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Fp,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?Qn((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Ju();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${B("content")}</span>Shared values
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          <span class="spacer"></span>
          <span class="meta ${u===void 0?"none":""}" title=${xe(c.value,d)}>${u??"unresolved"}</span>
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${b=>{b.stopPropagation(),this.mutate(g=>{Io(g,c.id)}),p&&(this.openValue=void 0)}}>${B("delete")}</button>`:f}
        </div>
        ${p?h`<div class="value-open">${Xu(s,c)}</div>`:f}</div>`})}
      </div>
    </div>`}setOpenValue(t){let i=this.openValue;if(this.openValue=t,i===void 0||i===t)return;let a=this.draft?.config.values.find(r=>r.id===i);a&&a.name.trim()===""&&this.mutate(r=>{Io(r,i)})}openSharedValue(t){this.renderRoot.querySelectorAll(":popover-open").forEach(a=>a.hidePopover()),this.setOpenValue(t);let i=this.draft?.config.values.find(a=>a.id===t)?.name.trim()==="";this.updateComplete.then(()=>{this.renderRoot.querySelector(".values-list .datum.hl")?.scrollIntoView({block:"start",behavior:"smooth"}),i&&this.renderRoot.querySelector(".values-list .value-open input[type=text]")?.focus({preventScroll:!0})})}openRaw(){this.showRaw=!0;let t=this.renderRoot.querySelector("details.foot");t&&(t.open=!0),this.updateComplete.then(()=>this.renderRoot.querySelector("pre")?.scrollIntoView({block:"nearest"}))}renderShapeTabs(t,i){let a=t.supportedFamilies;return Cn.map(r=>{if(!a.includes(r))return h`<button class="tab off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${ne(r)} shape`} @click=${()=>this.addShape(r)}>
          ${B("plus")}${ne(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?Oa(c,{icons:this.icons,imageSizes:this.imageSizes,slot:ti.slots[r]}):f}let l=r!=="inline"&&vr(t,r)===0&&t.elements.length>0,d=this.canEdit&&Ba(t,r);return h`<span class="tab-wrap">
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=Ud(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${Q.states}`}>
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ...
        ${a.map(o=>{let s=Do(o.id),l=this.sharedRaw(o.id)??"",d=l===""?"empty":l,c=o.name||"(unnamed)",u=this.testValues.get(s),p={entity_id:s,state:l,attributes:{},last_changed:"",last_updated:""};return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${Q.complication}`}
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${we(a,"complication","Complication",qu(a),{color:Q.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=np(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=ap(a,c)}else s=rp(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([ix(r)]):new Set(Ls)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ue(r),s=new dt(this.buildContext(),this.draft?.config),l=Qu(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(b=>{for(let g of i)Me(b,a,g.payload.id,{isHidden:m})}),p=m=>this.mutate(b=>{for(let g of i){let x=b.elements.find(k=>k.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&x.kind!=="chartTimes"&&x.kind!=="chartDots"&&x.kind!=="chartGrid"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
            ...
            <div class="picked">
              ${c.map(m=>h`<div class="row" style=${`--k:${Ue[m.kind]}`}>
                ...
                <span class="name">
                  ...
                  <b>${Re(m,o)}</b><span class="kind">${ii[m.kind]}</span>
                </span>
              </div>`)}
            </div>
            <div class="row-acts">
