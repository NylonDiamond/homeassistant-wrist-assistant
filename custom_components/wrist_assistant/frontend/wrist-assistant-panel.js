...
`)}function ad(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,lh(r));return{values:t,nullKeys:i}}function lh(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function so(e){let n=ca(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function dh(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(Cr(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var ch=10800;function uh(e,n,t){let i=n==="always"||n==="auto"&&t<=ch;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function ld(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=uh(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function ph(e,n){return Ft(e)===void 0?[]:ld(Xe(e)*60,Hr(e.timeLabelCount),e.hourCycle,e.minutes,n)}function hh(e,n){return Ji(e)?ld(Math.round(e.historyMinutes)*60,Hr(ri(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function an(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function ze(e){let n=e.trim(),t=an(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:an(i)}function mh(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function fh(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function gh(e){let n=e.trim(),t=an(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?an(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=an(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function yh(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function bh(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function vh(e,n,t){if(Ce(n))return e;let i=n,a=e,r=an(e.trim()),o=i.duration?gh(e):void 0;if(o!==void 0)a=yh(o);else if(i.relativeTime&&r!==void 0)a=fh(r);else{let s=ze(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):mh(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=bh(a);break}return a}function En(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function et(e,n=240){return dd(e,n).map(t=>t.value)}function dd(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function rd(e,n,t){let i=dd(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Et({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ie,c=t.highColorHex??Ae,u=t.lowColorHex??Ie,p=[],m=(y,x)=>{if(y==="")return;let $=p.at(-1);$&&$.colorHex===x?$.text+=y:p.push({text:y,colorHex:x})},g=0;return i.forEach((y,x)=>{m(e.slice(g,y.start),n);let $=x===o?c:x===s?u:l.length>0?qi(y.value,l,d):n,T=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,T),$),g=T}),m(e.slice(g),n),p}function od(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function xh(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function yi(e,n=Rt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:wh(i.slice(a+1))})}return t}function wh(e){try{return decodeURIComponent(e)}catch{return e}}function kh(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function sd(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function $h(e,n,t){if(e===void 0)return 0;let i=ze(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Qe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=od(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Yt(n),i=Xt(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let o=et(a),s=r===void 0?void 0:this.testedReading(n);return s!==void 0&&(o=[...o.slice(0,-1),s]),n.limit>0&&o.length>n.limit?n.takeFromEnd?o.slice(o.length-n.limit):o.slice(0,n.limit):o}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:ze(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=ze(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):od(a.get(s)??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ce(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?dh(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?hl(r):Cr(r,a.domainMax-a.domainMin));break}default:{let a=oo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return vh(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=an(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?En(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=ze(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:ze(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:ze(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=en(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:en(d),p=c===void 0?void 0:en(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Me[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=rd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=dt(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(x=>x.text).join(""),y):(ll(n.payload)&&(y.spans=rd(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,x=m??p;y===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let $={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&($.path=y),$}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(V,U,ne)=>V??(U?ze(this.resolve(U)??""):void 0)??ne,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),$=m===void 0?void 0:ze(m),T=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&$!==void 0&&(T=qi($,Et(p),p.bandAboveColorHex));let k=x-y;if(p.total){let V=ze(this.resolve(p.total)??"");V!==void 0&&(k=V)}let C=sd(k,1,ji),O={kind:"gauge",...u,fraction:$h(m,y,x),style:p.style,lineWidth:p.lineWidth,colorHex:T,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:C,filledCount:sd($??0,0,C)};if(p.thresholdValue!==void 0&&x!==y){let V=(p.thresholdValue-y)/(x-y);V>=0&&V<=1&&(O.thresholdFraction=V)}return O}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y={min:m.domainMin,max:m.domainMax},x=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Et(p),T=pl(p)?g.map(S=>qi(S,$,p.bandAboveColorHex)):[],k=p.highlight==="highest"||p.highlight==="both",C=p.highlight==="lowest"||p.highlight==="both",O=Ye(p),V={kind:"chart",...u,values:g,style:p.style,domainMin:y.min,domainMax:y.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:x,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:k?O.high:"none",lowMarker:C?O.low:"none",pointColorHexes:T,fillBands:p.fillBands,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:hh(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove};if(g.length>0){let S=k?g.indexOf(Math.max(...g)):-1,B=C?g.indexOf(Math.min(...g)):-1;S>=0&&(V.highIndex=S),B>=0&&B!==S&&(V.lowIndex=B)}let U=xh(p,y.min,y.max);U!==void 0&&(V.thresholdY=U);let ne=this.chartNowIndex(p,g.length);return ne!==void 0&&(V.nowIndex=ne),V}case"timeline":{let p=n.payload,m=Ft(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=yi(g,Rt),x=kh(y,Xe(p)*60,T=>vl(T,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:ph(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};ct(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=[...Th(Nl(n,t).map(y=>this.resolveElement(y,i)),de[t==="inline"?"rectangular":t])],o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,x=this.resolve(y.value),$=x===void 0?void 0:ze(x);if($!==void 0){let T=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),C={value:Math.min(k,Math.max(T,$)),minValue:T,maxValue:k===T?T+1:k,colorHexes:y.colorHexes},O=this.resolve(y.minLabel);O!==void 0&&(C.minLabel=O);let V=this.resolve(y.maxLabel);V!==void 0&&(C.maxLabel=V),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Ch(e,n,t){let i=new Qe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function bi(e,n,t){let i=new Qe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Ch(e.inline,n,e)),a}function ua(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Sh=5;function lo(e,n){let t=e.values,i=Math.max(t.length,1),r=e.highIndex!==void 0&&e.highMarker!=="none"||e.lowIndex!==void 0&&e.lowMarker!=="none"?Sh:0,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,c=Math.max(n.h-r-o*2,1),u=d+c,p=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?c*.12:0,y=Math.min(Math.max(e.barGap,0),l/(i*2)),x=Math.max((l-y*(i-1))/i,.5),$=k=>Math.min(1,Math.max(0,(k-e.domainMin)/p)),T=k=>u-$(k)*c;return{count:t.length,barWidth:x,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:m?u:T(0),yAtFraction(k){return u-Math.min(Math.max(k,0),1)*c},barRect(k){let C=s+k*(x+y),O=t[k],V,U;if(m){let ne=g+$(O)*(c-g);V=u-ne,U=u}else V=T(O),U=m?u:T(0),V>U&&([V,U]=[U,V]);return{x:C,y:V,w:x,h:Math.max(U-V,.5)}},point(k){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*k/(t.length-1):s+l/2,y:T(t[k])}},markerCenter(k,C){let O=C?this.barRect(k):void 0;return{x:O?O.x+O.w/2:this.point(k).x,y:n.y+r/2}}}}var gi=1;function pa(e,n){let t=Math.max(si,Math.min(li,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-gi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+gi:n.y,h:n.h-i-gi,cy:(e.labelsAbove?n.y+i+gi:n.y)+(n.h-i-gi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Th(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;let o=Mh(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Eh(e,n){let t=n.values;if(t.length!==0)switch(e){case"highest":return t.indexOf(Math.max(...t));case"lowest":return t.indexOf(Math.min(...t));case"first":return 0;case"latest":return t.length-1;case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return}}function Mh(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=ua(t,i);if(a.w<=0||a.h<=0)return;let r=pa(t,a).body;if(r.w<=0||r.h<=0)return;let o=lo(t,r),s,l;if(lt(n.at)){let $=Eh(n.at,t);if($===void 0)return;if(t.style==="bars"){let T=o.barRect($);s=T.x+T.w/2,l=T.y}else{let T=o.point($);s=T.x,l=T.y}}else{if(t.thresholdY===void 0)return;l=o.yAtFraction(t.thresholdY)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=($,T,k)=>T>k?(T+k)/2:Math.min(Math.max($,T),k),m={...e};if(s!==void 0){let $=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=($-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let $=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=($-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g,r.y+c/2,r.y+r.h-c/2),x=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Se=de,vi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Se,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Mn=vi.find(e=>e.measured);function bd(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return vi.find(a=>a.screen.width===t&&a.screen.height===i)}function ma(e,n){let t=Se[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var po={regular:400,medium:500,semibold:600,bold:700},Rh=1.15;function tt(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ye(e,n,t="#FFFFFF"){let i=tt(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var ft=e=>e*.55;function vd(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Fh(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Ah(e,n,t){if(t<=0||e.length*ft(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/ft(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Ih(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function xd(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function wd(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Hh(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function kd(e,n){return e.reduce((t,i)=>t+i.text.length*ft(i.look.fontSize*n),0)}function Lh(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:ft(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=ft(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function _h(e,n,t){if(t<=0||kd(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*ft(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*ft(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Ph(e,n,t){let i=Hh(n),a=e.lineLimit===2&&t.w>0?Lh(e.text,i,t.w):[e.text],r=xd(e.text,a),o=a.map((T,k)=>wd(T,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(T=>kd(T,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(T=>_h(T,l,t.w)),{anchor:c,x:u}=vd(e.alignment,t),p=Math.max(0,...d.flat().map(T=>T.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=T=>T.map(k=>{let C=ye(k.look.colorHex,"fill");return w`<tspan font-size=${k.look.fontSize*l} font-weight=${po[k.look.fontWeight]??400} fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}),x=ye(e.colorHex,"fill"),$=d.length>1?w`${d.map((T,k)=>w`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*g}>${y(T)}</tspan>`)}`:y(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${$}</text>`}function Nh(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:Ph(e,e.parts,n);let t=ye(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:En((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Fh(e.text,n.w/ft(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*ft(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Ah(y,o,n.w)),{anchor:l,x:d}=vd(e.alignment,n),c=Ih(e.text,e.spans),u=c?xd(e.text,i):[],p=(y,x)=>c?wd(y,u[x]??0,e.text,c,e.colorHex).map($=>{let T=ye($.look,"fill");return w`<tspan fill=${T.fill} fill-opacity=${T["fill-opacity"]}>${$.text}</tspan>`}):y,m=o*1.15,g=s.length>1?w`${s.map((y,x)=>w`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(y,x)}</tspan>`)}`:p(s[0],0);return w`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${po[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var co=2;function zh(e,n){let t=ye(e.colorHex,"stroke"),i=ye(e.trackColorHex,"stroke","#FFFFFF"),a=ye(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,g=Math.max(1,e.dotCount),y=m?n.w:n.h,x=m?n.h:n.w,$=Math.max(1,Math.min(x,y/g-co)),T=g*$+(g-1)*co,k=(m?n.cx:n.cy)-T/2+$/2;return w`${Array.from({length:g},(C,O)=>{let V=k+O*($+co),U=O<e.filledCount?t:i;return w`<circle cx=${m?V:n.cx} cy=${m?n.cy:V} r=${$/2}
    ...
    ${o!==void 0?w`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
        ...
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,T=w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,k=3,C=m&&y?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([O,V,U])=>w`<rect data-handle=${O} x=${V-k/2} y=${U-k/2} width=${k} height=${k}
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function ba(e,n){let t=e.family in Se?e.family:"rectangular",i=n.slot??Se[t],a=Se[t],r=ma(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=tt(e.backgroundColorHex),l=tt(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements;if(t==="corner"){let y=r.scale,x=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",T=$!=="",k=ya(y,x),C=bo(y,x),O=C/(a.width*y),V=k.tile.cx-C/2,U=k.tile.cy-C/2,ne=`M 0 0 H ${k.quad.width-k.cornerRadius} A ${k.cornerRadius} ${k.cornerRadius} 0 0 1 ${k.quad.width} ${k.cornerRadius} V ${k.quad.height} H 0 Z`,S=f;if(e.bezelGauge)S=tm(e.bezelGauge,y,o);else if(e.bezelText){let J=Jh(y,`${o}-bezel`),G=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?En((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;S=w`<defs><path id=${J.id} d=${J.d} /></defs>
        <text font-size=${cd*y} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${J.id}" startOffset="50%" text-anchor="middle">${pd(G,J.length,cd*y)}</textPath></text>`}let B=f;if(T){let J=tt(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},G=Sd(y,`${o}-curved`,Zh*y,Qh);B=w`<defs><path id=${G.id} d=${G.d} /></defs>
    ...
    <path d=${Zd(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
        ...
        <text x="6" y="39" font-family=${Ma} font-size="7" fill=${it}>1h ago</text>
        <text x="114" y="39" font-family=${Ma} font-size="7" text-anchor="end" fill=${it}>now</text>
    ...
    <textarea rows=${i} .value=${n} class="mono" @input=${ge(t)}></textarea></label>`}function ae(e,n,t,i={}){return h`<label class="field num">${_e(e,Ht(n,i.def,t),ja(n,t,i))}${qa(n,t,i)}</label>`}function qa(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e),a=h`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??f} max=${t.max??f}
      aria-label=${t.ariaLabel??f} placeholder=${t.placeholder??f}
      @input=${ge(r=>{if(r.trim()===""){t.optional&&n(void 0);return}let o=Number(r);Number.isNaN(o)||n(o)})} />`;return t.unit===void 0&&t.lead===void 0?a:h`<span class=${t.lead===void 0?"num-box":"num-box lead"} style=${`--wa-unit:${t.unit?.length??0}`}>${t.lead===void 0?f:h`<span class="lead" aria-hidden="true">${t.lead}</span>`}${a}${t.unit===void 0?f:h`<span class="unit" aria-hidden="true">${t.unit}</span>`}</span>`}function Te(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<label class="field">${_e(e,Ht(n,a.def,i,r))}
    ...
    </div></div>`}function Mi(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${_e(e,Ht(n,i.def,t,a),ja(n,t,i))}
    ...
    <span class="sym-name">${n}</span>
      ...
      ${V.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${V.map(U=>Aa(e,U,U===u,x))}</div>`}
      <div class="sym-grid">${O.map(U=>Aa(e,U,U===u,x))}</div>
    ...
    </div>`}else if(o){let k=r.category(i),C=zm(k,s,d,c),O=$o(C.names,s),V=C.fromPack?O.slice(0,mc):O,U=r.recent.filter(S=>!S.startsWith(He)),ne=c.size===0?U:U.filter(S=>c.has(S));T=h`<div class="sym-browse">
      ${m?yc(r,i,g):f}
      <div class="sym-controls">
      ...
      ${ne.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${ne.map(S=>Aa(e,S,S===u,x))}</div>`}
      <div class="sym-grid">${V.map(S=>Aa(e,S,S===u,x))}</div>
    ...
    ${T}`}function Vm(e,n){let t=e.trim();return t!==""&&!t.startsWith(He)&&n.size>0&&!n.has(t)}function Bm(e,n){let t=n.trim(),i=t.startsWith(He)?t.slice(He.length):t,a=e.map(r=>r.startsWith(He)?r.slice(He.length):r);return $o(a,i).map(r=>He+r)}function yc(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}function Va(e,n,t,i){let a=Et({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(g=>g.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:Zo(l,ie),title:`Back to ${ie}`,reset:()=>t(c=>{c.bandAboveColorHex=ie})};return h`<div class="bands">
    ${Jm(a,l,r)}
    ${a.map(c=>h`
    ...
    ${Ri.has(n)?Vc(e,i,a,r):f}
  </div>`}function ue(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Xa(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function rf(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Ri=new Set,Ci=new WeakMap;function of(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Oc(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Dc(e){let n=e.currentTarget,t=e.newState==="open",i=Ci.get(n);if(i&&(i(),Ci.delete(n)),!t){Ri.delete(n.id)&&ke(n);return}let a=of(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){Ci.get(n)?.(),Ci.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}zo(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Ci.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),zo(n,a.getBoundingClientRect()),Ri.has(n.id)||(Ri.add(n.id),ke(n),requestAnimationFrame(()=>{n.isConnected&&zo(n,a.getBoundingClientRect())}))}function zo(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=sf({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var sn=8,Ia=6,xc=140;function sf(e,n,t){let i=t.height-e.bottom-Ia-sn,a=e.top-Ia-sn,r=n.height>i&&a>i&&i<xc,o=Math.max(xc,r?a:i),s=Math.min(n.height,o),l=Math.max(sn,Math.min(e.left,t.width-n.width-sn)),d=r?Math.max(sn,e.top-Ia-s):Math.max(sn,Math.min(e.bottom+Ia,t.height-s-sn));return{left:l,top:d,maxHeight:o,above:r}}function Vc(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Um.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Nc(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):be("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=at(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${at(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${be("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=ff(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Te("Field",a.timeField,nf,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${Hc("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?ui(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            ...
            or choose another source and click Make shared.</div>`:h`${Te("Value",a.id,[["","(choose)"],...e.config.values.map(p=>[p.id,p.name||p.id.slice(0,8)])],p=>r({...a,id:p}))}
          ...
          ${Te("Chart",a.layer,[["","(choose)"],...u.map(p=>[p.payload.id,Fe(p,c)])],p=>r({...a,layer:p}))}
          ${Te("Number",a.stat,[...gn],p=>r({...a,stat:p}))}
    ...
    <div class="gen-row">
      ...
      ${Te("Tap action",t.type,Uc,s=>e.update(l=>{l.tapAction=Gc(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <div class="hint">${t?h`${Ln(e,r)}, up to 366 days. Statistics rows are never
          purged, so the limit is about what fits on a complication rather than about what
          the recorder still holds.`:h`${Ln(e,r)}, up to 7 days: the recorder keeps
          ten by default, and a longer span would quietly come back short.`}</div>`}function Pf(e){if(e.historyMinutes<=0)return"";if(e.source!=="statistics")return` \xB7 ${Ln(e.historyMinutes)}`;let n=Ki.find(([t])=>t===e.statPeriod)?.[1]??e.statPeriod;return` \xB7 ${Ln(e.historyMinutes,ii)} \xB7 per ${n.toLowerCase()}`}function ts(e,n){let t=ue(e);switch(n.kind){case"text":{let i=n.payload.parts?.length??0;return dt(n.payload)?`Rich text, ${i} part${i===1?"":"s"}`:Ve($e(n.payload.value,t),48)}case"icon":return Ve($e(n.payload.symbol,t),48);case"gauge":return Ve($e(n.payload.value,t),48);case"chart":return Ve(`${$e(n.payload.value,t)}${Pf(n.payload)}`,48);case"timeline":return Ve(`${$e(n.payload.value,t)} \xB7 ${Ln(Xe(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return ut(n.payload.action)}}function Ua(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Le(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Le(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Le(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Le(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${es.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Le(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Le(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Le(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function Si(e,n,t,i,a,r){let o=Math.round(t*1e3)/10,s=l=>i(l/100);return h`<label class="pf">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Nf(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Re(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Ee(p,t,i,{frame:Fo(o,c)}),`${a}-${u}-${t}`),l=!Ba(o,ti)||r.isHidden,d=n.payload.chartAnchor;return xe(e,"placement","Position",h`
    ${zf(e,n,t)}
    ${d===void 0?h`
    <div class="field xy-field"><span>Position</span>
      <div class="xy">
        ${Si("X","Left",o.x,c=>s({x:c},"x"),-100,100)}
        ${Si("Y","Top",o.y,c=>s({y:c},"y"),-100,100)}
      </div>
    ...
    <div class="field xy-field"><span>Size</span>
      <div class="xy">
        ${Si("W","Width",o.width,c=>s({width:c},"w"),4,200)}
        ${Si("H","Height",o.height,c=>s({height:c},"h"),4,200)}
      </div>
    </div>
    ${Mi("Rotation",o.rotationDegrees,c=>s({rotationDegrees:c},"rot"),{min:-180,max:180,step:1,def:0,format:c=>`${Math.round(c)}\xB0`,unit:"\xB0",range:!1})}
    ${Be("Hidden",r.isHidden,c=>e.update(u=>Ee(u,t,i,{isHidden:c})),!1)}
    <div class="hint">${d===void 0?"X, Y, W and H are":"W and H are"} a percent of the face, on the ${ee(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:X.position,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${ee(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${ee(t)} face at half size, unrotated and shown`,reset:()=>e.update(c=>Ee(c,t,i,{frame:{...ti},isHidden:!1}))}:{}})}function zf(e,n,t){let i=n.payload.chartAnchor;if(i===void 0)return f;let a=n.payload.id,r=`el-${a}-anchor`,o=e.config.elements.filter(c=>c.kind==="chart"),s=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===a);m?.payload.chartAnchor&&c(m.payload.chartAnchor)},u?`${r}-${u}`:void 0),l=ue(e),d=!o.some(c=>c.payload.id===i.layer);return h`
    ${o.length<2?f:Te("Follows",i.layer,o.map(c=>[c.payload.id,Fe(c,l)]),c=>s(u=>{u.layer=c}))}
    ${Te("Reading",i.at,Wt,c=>s(u=>{u.at=c}),{def:"highest"})}
    ${i.place==="through"?f:Te("Sits",i.place,wr.filter(([c])=>c!=="through"),c=>s(u=>{u.place=c}),{def:"above"})}
    <div class="grid2">
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
          ...
          can still lift it past the top of the chart, as far as the edge of the face.</div>`}`}function Of(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ne(e.config,t)[0];return xe(e,"tappable","Tap",ug(e,n,`el-${t}`),{color:X.tap,icon:"tap",summary:i?ut(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>aa(a,t))}:{}})}function Sc(e,n,t,i,a){return h`
    ${Mi("Times",e.timeLabelCount,r=>n(o=>{o.timeLabelCount=Math.max(0,Math.min(oi,Math.round(r)))},`${i}count`),{min:0,max:oi,step:1,def:t.timeLabelCount,format:r=>r<=0?"None":String(Math.round(r)),range:!1})}
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${ae("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(li,Math.max(si,r??St))},`${i}size`),{step:.5,min:si,max:li,def:t.labelSize,unit:"pt"})}
        ${ce("Time colour",e.labelColorHex,r=>n(o=>{o.labelColorHex=r??Tt},`${i}colour`),!1,t.labelColorHex)}
      </div>
    ...
    ${Z("Colour",a,Wo,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=Da(et(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    ${p===void 0?f:h`<div class="rich-confirm" role="alertdialog" aria-label=${y}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${x=>{Ti.delete(o),ke(x.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ...
    </button>`}),O=r.rules.some(M=>M.partId===c.id),V=c.value.kind.kind==="literal",U=qo(c),ne=c.fontSize!==void 0,S=Hn.find(([M])=>M===r.fontWeight)?.[1]??r.fontWeight,B=M=>{M>=Bo&&M<=Uo&&y(b=>{b.fontSize=M},"size")},J=U==="bands"?et(e.resolve(c.value)??""):[],G={layer:"Use the layer colour",...V&&U!=="bands"?{bands:"By value needs a live value"}:{}},pe=(M,b)=>y(v=>{let R={bands:v.bands??[],bandAboveColorHex:v.bandAboveColorHex??ie};M(R),R.bands.length>0?v.bands=R.bands:delete v.bands,R.bandAboveColorHex!==ie?v.bandAboveColorHex=R.bandAboveColorHex:delete v.bandAboveColorHex},b);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      <div class="part-head">
        ...
        <span class="spacer"></span>
        <button type="button" class="icon" title="Move left" aria-label="Move left" ?disabled=${d===0} @click=${()=>T(d-1)}>${z("left")}</button>
        <button type="button" class="icon" title="Move right" aria-label="Move right" ?disabled=${d===u-1} @click=${()=>T(d+1)}>${z("right")}</button>
      ...
      ${Z("Colour",U,Kf,M=>y(b=>{if(M==="layer"){delete b.colorHex,delete b.coloring;return}if(M==="pick"){delete b.coloring,b.colorHex=Zo(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Da(et(e.resolve(b.value)??"")))}),{def:"layer",titles:G,...V&&U!=="bands"?{disabled:{bands:!0}}:{}})}
      ${U==="pick"?ce("Part colour",c.colorHex,M=>y(b=>{b.colorHex=M??p},"color")):f}
      ${U==="bands"?h`
        ${Va({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??ie},c.colorHex??p,pe,J.length===1?J[0]:void 0)}
      ...
      <div class="field seg-field">${_e("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${S})`,reset:()=>y(M=>{delete M.fontWeight})})}
        ${Oa("Weight",c.fontWeight,Hn,M=>y(b=>{b.fontWeight=M}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${_e("Font size",ne?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(M=>{delete M.fontSize})}:void 0,ja(c.fontSize??m,B,{step:1,min:Bo,max:Uo}))}
        ${qa(c.fontSize,M=>{M===void 0?y(b=>{delete b.fontSize},"size"):B(M)},{step:1,min:Bo,max:Uo,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:ne?"Part font size":`Part font size, ${m} pt from the layer`,...ne?{}:{lead:z("link")}})}
      </label>
    </div>
  </div>`}function eu(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,v)=>e.update(R=>b(R.elements[r]),v?`${o}-${v}`:void 0),l=Re(e.config,t,n),d=l.frame,c=(b,v)=>e.update(R=>Ee(R,t,a,{frame:Fo(d,b)}),`${o}-${v}-${t}`),u=Pe(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],g=!1,y=b=>n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?f:ce(b,n.payload.colorSlot.baseColorHex,v=>s(R=>{R.kind!=="image"&&R.kind!=="tap"&&R.kind!=="timeline"&&(R.payload.colorSlot.baseColorHex=v??"#FFFFFF")},"color"),!1,p),x,$;switch(n.kind){case"text":{let b=(v,R)=>s(E=>v(E.payload),R);x=tg(e,n,t,b,o),g=!n.payload.countdown&&!dt(n.payload),$=h`
        ${Ha(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${Z("Weight",n.payload.fontWeight,Hn,v=>s(R=>{R.payload.fontWeight=v}),{def:u.fontWeight})}
        ${Am({label:"Align",value:n.payload.alignment??"center",options:Cf,def:"center",set:v=>s(R=>{let E=R.payload;v==="center"?delete E.alignment:E.alignment=v})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:Sf,def:"1",set:v=>s(R=>{let E=R.payload;v==="2"?E.lineLimit=2:delete E.lineLimit})})}
        ${Be("Mono digits",n.payload.monospacedDigits===!0,v=>s(R=>{let E=R.payload;v?E.monospacedDigits=!0:delete E.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,$=Ha(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let b=n.payload,v=(E,L)=>s(D=>E(D.payload),L),R=b.style==="dots";x=h`
        ...
        ${R?h`
            ...
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${ji} dots are drawn.</div>`:Uf(e,b,{min:u.minValue,max:u.maxValue},o,v)}`,g=!0,$=h`
        <div class="grid2">
          ${Z("Style",b.style,ef,E=>v(L=>{E==="dots"&&L.total===void 0&&(L.total=vc(L)),E!=="dots"&&delete L.total,L.style=E}),{titles:tf,def:u.style})}
          ${R?f:Ha(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${ce(R?"Empty dot colour":"Track colour",b.trackColorHex,E=>v(L=>{L.trackColorHex=E??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ...
        ${b.coloring==="bands"?h`
          ...
          ${Va(b,b.colorSlot.baseColorHex,v,et(e.resolve(b.value)??"")[0])}`:f}
        ${R?f:h`
          <div class="grid2">
            ${ae("Threshold",b.thresholdValue,E=>v(L=>{E===void 0?delete L.thresholdValue:L.thresholdValue=E},"thr"),{optional:!0})}
            ${b.thresholdValue===void 0?f:ce("Threshold colour",b.thresholdColorHex,E=>v(L=>{L.thresholdColorHex=E??yn},"thrcol"),!1,yn)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,v=(H,N)=>s(pn=>H(pn.payload),N),R=Ye(b),E=kr(u.marker),L=u.historyMinutes,D=u.historyPoints,K=b.historyMinutes>0,le=K&&b.source==="statistics",Ue=K&&!le,vt=K?le?"statistics":"history":"value",zt=le?ii:qt,we=Yt(b)??Xt(b),me=b.value.kind.kind==="entityState",rt=we===void 0?void 0:e.historySeries(we),Du=K&&me?rt??"":e.resolve(b.value)??"",ot=b.historyPoints<1,gs=jo(a,b.historyMinutes,zt),je=et(Du),Ot=b.limit>0&&je.length>b.limit?b.takeFromEnd?je.slice(je.length-b.limit):je.slice(0,b.limit):je,Vu=!K&&me&&je.length===1,tr=e.config.elements.filter(H=>H.kind==="chart"&&H.payload.id!==a),Bu=ue(e),nr=b.scaleFrom!==void 0&&tr.some(H=>H.payload.id===b.scaleFrom);x=h`
        ${se(e,b.value,H=>v(N=>{N.value=H},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${Z("Draw",vt,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],H=>v(N=>{if(H==="value"){N.historyMinutes=0;return}N.source=H==="statistics"?"statistics":"history";let pn=N.historyMinutes||Yi;N.historyMinutes=H==="statistics"?Math.min(pn,Sr):Math.min(pn,Xi)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${le?h`
            ...
            <div class="grid2">
              ${Do(a,b.historyMinutes,L,H=>v(N=>{N.historyMinutes=H}),ii)}
              ${Z("Per",b.statPeriod,Ki,H=>v(N=>{N.statPeriod=H}),{def:Qn})}
            </div>
            ${gs?Vo(b.historyMinutes,H=>v(N=>{N.historyMinutes=H},"span"),!0):f}
            ${Z("Read",b.statType,vr,H=>v(N=>{N.statType=H}),{def:ei})}
        ...
        <div class="grid2">
          ...
          ${b.style==="bars"?ae("Bar gap",b.barGap,H=>v(N=>{N.barGap=Math.max(0,H??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):Ha(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
        ...
        ${tr.length===0?f:Te("Same scale as",nr?b.scaleFrom:"",[["","Its own"],...tr.map(H=>[H.payload.id,Fe(H,Bu)])],H=>v(N=>{H?N.scaleFrom=H:delete N.scaleFrom}),{def:""})}
        ...
        ${Z("Colour",b.coloring,Wo,H=>v(N=>{N.coloring=H,H==="bands"&&N.bands.length===0&&(N.bands=Da(Ot))}),{def:u.coloring})}
        ${y("Main colour")}
        ${b.coloring==="bands"?h`
        ...
        ${Ji(b)?Sc(b,v,u,"cl",h`
            <div class="hint">Clock times from the start of the span to now, evenly spaced, in a row of
              ...
              Recorded history.</div>`}`;break}case"timeline":{let b=n.payload,v=(we,me)=>s(rt=>we(rt.payload),me),R=u.historyMinutes,E=b.value.kind.kind==="entityState",L=Ft(b),D=L===void 0?void 0:e.historySeries(L),K=Xe(b)*60,le=yi(D??"",Rt),Ue=jo(a,b.historyMinutes),vt=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,zt=Zm(le,K,vt===void 0?void 0:e.hass.states[vt]?.state,vt?.split(".")[0]);x=h`
        ...
        ${E&&D===void 0?h`<div class="hint keep">Reading the history…</div>`:f}
        ${E&&D===""?h`<div class="hint warn">Nothing recorded for this entity in that span. Either it is
        ...
        <div class="grid2">
          ${ae("Gap",b.gap,we=>v(me=>{me.gap=Math.min(Zi,Math.max(0,we??0))},"tgap"),{step:.5,min:0,max:Zi,def:u.gap,unit:"pt"})}
        ...
        ${Mi("Zoom",b.zoom,D=>v(K=>{K.zoom=D},"zoom"),{min:yo,max:4,step:.05,def:1,format:D=>`${D.toFixed(2)}x`,unit:"x"})}
        ${Mi("Pan left/right",b.panX,D=>v(K=>{K.panX=D},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${Mi("Pan up/down",b.panY,D=>v(K=>{K.panY=D},"pany"),{min:-1,max:1,step:.02,def:0})}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let T=g||n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&dt(n.payload)?"Layer colour":"Colour"),k=Wr(e.config,n),C=k?{kind:{kind:"entityState",...k}}:void 0,O=n.kind==="image"?n.payload.timestamp===!0:!1,V=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,U=ag[n.kind],ne=rg[n.kind],S=Cc(n.payload,u,U),B=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,J=e.config.perFamily[t]?.placements[a]?.size!==void 0,G=Cc(n.payload,u,ne)||B!==void 0&&l.size!==void 0&&l.size!==u[B],pe=Jt(e.config,a),M=(b,v)=>()=>s(R=>Oo(R.payload,u,b),v);return h`
    ${xe(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"?f:Zc(e,n,o)}${x}`,{color:X.content,icon:"content",summary:ts(e,n),...S?{reset:()=>s(b=>{Oo(b.payload,u,U),b.kind==="text"&&$i(b.payload.rules)},"reset-content")}:{}})}
    ${$===void 0&&T===void 0?f:xe(e,"look",n.kind==="image"?"Picture":"Look",h`${$??f}${T??f}`,{color:X.look,icon:n.kind==="image"?"image":"look",...Ua(n)?{summary:Ua(n)}:{},...G?{reset:()=>e.update(b=>{Oo(b.elements[r].payload,u,ne),J&&Ee(b,t,a,{},!0)})}:{}})}
    ...
    ${xe(e,"states","States",du(e,n.payload.rules,n.kind,b=>b.elements.find(v=>v.payload.id===a)?.payload.rules,`rules-${a}`,C,V),{color:X.states,icon:"states",summary:xi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ...
    ${Te("Tap action",a.type,gf,r=>t(o=>{o.action=Gc(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    <div class="grid2">
      ${r.highlight==="lowest"?f:Z("Highest marker",t.high,bc,o=>a(s=>{Wi(s,{...Ye(s),high:o})}),{def:i.high})}
      ${r.highlight==="highest"?f:Z("Lowest marker",t.low,bc,o=>a(s=>{Wi(s,{...Ye(s),low:o})}),{def:i.low})}
    </div>
      ...
      <div class="field list-field"><span>Line</span>
        <div class="chips">
          <button class="small" title=${`Turn the ${r} into a layer you can restyle`}
            @click=${()=>e.update(s=>{Vr(s,i.id,t)})}>${z("plus")}<span>Move to layers</span></button>
        </div>
      ...
      <div class="adders">
        ${Ll.map(([c,u])=>{let p=c==="threshold"&&n.payload.thresholdValue===void 0;return h`
            <button class="small" ?disabled=${p}
              ...
              @click=${()=>e.update(m=>{Vr(m,n.payload.id,c)})}>${z("plus")}<span>${u}</span></button>`})}
      </div>
    </div>
    ...
    ${Be("Tappable",a!==void 0,s=>e.update(l=>{s?ia(l,i):aa(l,i)}))}
    ${a?h`<div class="value-editor">
          ...
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${Qi(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...Nr}})}>${z("reset")}</button>`}
            </div>
          </div>
        </div>
        ${sg(e,a.payload.id)}
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:X.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function iu(e,n){if(n==="inline")return hg(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ee(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ee(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=Ja(e.config,n),r=t.backgroundColorHex?Le(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Le(t.borderColorHex)} border`:"no border";return h`
    ...
    ${xe(e,"states","Shape states",du(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:X.states,icon:"states",summary:xi(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(m=>Fi(m,t,t-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(m=>Fi(m,t,t+1))}>${z("down")}</button>
    ...
    <div class="rule-head">
      ...
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>Fi(c.cases,t,t-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>Fi(c.cases,t,t+1))}>${z("down")}</button>
    ...
    ${Te("Comparison",s.kind,ql.map(u=>[u,An[u]]),u=>o(p=>{p.comparison=ao(p.comparison,u)}))}
    ${c}
    ...
    </select>`}var su=["setColor","setBorderColor","setBackgroundColor"];function Eg(e,n,t,i,a,r,o,s=!1){let l=!pi[i].includes(Me[n.kind]),d=s&&!l&&!Ga.includes(Me[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${lu(e,n,a,o)}
  </div>`}function lu(e,n,t,i){let a=la(n.kind),r=f;if(a==="value"){let o=n.value??F("");if(su.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?ce("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=F(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${xg(e,n,t,i,a,o)}`:Mg(e,s.table,n[0],t,i,a,r,o)}function Mg(e,n,t,i,a,r,o,s){let l=(v,R)=>e.update(E=>{let L=a(E);L&&v(L)},R?`${r}-${R}`:void 0),d=n.value??Fc.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Jd(d)&&Rg(e.resolve(d)),p=pi[i],m=Pa.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Xd[i]]:[],y=Vd(n.columns,[...m,...g.filter(v=>v!==void 0)],p),x=La.get(r),$=t?t.partId:s?.some(v=>v.id===x)?x:void 0,T=s!==void 0&&$!==void 0,k=T?p.filter(v=>Ga.includes(v)):p,C=T?y.filter(v=>!Ga.includes(v)):[],O=(v,R)=>{if(!t){v?La.set(r,v):La.delete(r),ke(R);return}l(E=>{let L=E[0];L&&(v?L.partId=v:delete L.partId)})},V=t?e.liveBranch(t):"none",U=t?e.forced.get(t.id)??"live":"live",ne=v=>U!=="live"&&(U==="otherwise"?v==="otherwise":U.caseId===v),S=v=>{t&&e.setForced(t.id,ne(v)?"live":v==="otherwise"?"otherwise":{caseId:v})},B=v=>{Fc.set(r,v),n.rows.length!==0&&l(R=>jd(R,v),"lhs")},J=()=>{La.delete(r),l(v=>{Kd(v,d??F(""),u),$!==void 0&&v[0]&&v[0].partId===void 0&&(v[0].partId=$)})},G=n.rows.map((v,R)=>Ic(e,{key:`${r}-${v.caseId}`,label:Yd(v.comparison,E=>$e(E,ue(e))),columns:y,changes:v.changes,live:V===v.caseId,forced:ne(v.caseId),onForce:()=>S(v.caseId),when:Lg(e,v.comparison,`${r}-${v.caseId}`,(E,L)=>l(D=>{let K=D[0]?.cases.find(le=>le.id===v.caseId)?.when.tests[0];K&&E(K.comparison)},L&&`${v.caseId}-${L}`)),updChanges:(E,L)=>l(D=>{let K=D[0]?.cases.find(le=>le.id===v.caseId);K&&E(K.then)},L&&`${v.caseId}-${L}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${R===0} @click=${()=>l(E=>Eo(E,R,R-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${R===n.rows.length-1} @click=${()=>l(E=>Eo(E,R,R+1))}>${z("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>Wd(E,v.caseId))}>${z("delete")}</button>`})),pe=n.otherwise===void 0?f:Ic(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:V==="otherwise",forced:ne("otherwise"),onForce:()=>S("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(v,R)=>l(E=>{let L=E[0]?.otherwise;L&&v(L)},R),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(v=>Mo(v,!1))}>${z("close")}</button>`}),M=Na.get(r),b=Fg.filter(v=>k.includes(v)&&!y.includes(v));return h`
    <div class="states">
          ...
          <tr>
            ...
            ${y.map(v=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${nt[v]} column`}
                @click=${R=>{Na.set(r,v),ke(R.target)}}>${z("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${C.length===0?f:h`<div class="hint warn">A part ignores ${Za(C.map(v=>nt[v]))}. Pick Whole text to use ${C.length===1?"it":"them"}.</div>`}
      ${M===void 0?f:h`<div class="hint warn confirm-row">
        ...
        <button class="danger small" @click=${v=>{Na.delete(r),Pa.get(r)?.delete(M),ke(v.target),l(R=>qd(R,M))}}>Remove</button>
      ...
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(v=>Mo(v,!0))}>${z("plus")}<span>Otherwise</span></button>`:f}
          ${b.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${v=>{let R=v.target,E=R.value;if(R.value="",!E)return;let L=Pa.get(r)??new Set;L.add(E),Pa.set(r,L),ke(R)}}>
  ...
  </tr>`}function Ig(e,n,t,i,a){let r=Ea(t,n),o=Xa(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${nt[n]} for this state`}
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Dc}>
      ...
      ${Ri.has(o)?h`${n==="visibility"?Z("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):lu(e,r,s,a)}
    ...
    </div>`}function Hg(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=la(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${Hn.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??F(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(su.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Le(a):$e(i,ue(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${$e(i,ue(e))}</span>`}function Le(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Lg(e,n,t,i){let a=tn(n.kind),r=So(n.kind),o=(s,l,d,c)=>Pg(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
...
`)}var Lu="wrist-assistant-panel.layers.v1",yt=34,un=200,My=720,er=320,Ry=80,Fy=56,_u="wrist-assistant-panel.columns.v3",us=e=>Math.max(un,Math.min(My,Math.round(e))),Pu=e=>e.metaKey||e.ctrlKey||e.shiftKey,Ay=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Hi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Nt=Hi==="Cmd"?"\u2318":"Ctrl+",ps=Hi==="Cmd"?"\u21E7":"Shift+";function Nu(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Ry;if(i>=un*2+er){let r=i-er,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(un,Math.floor(o*l)),s=Math.max(un,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(un,o-d):s=Math.max(un,s-d))}return{columns:3,left:o,right:s}}let a=e-Fy;return a>=un+er?{columns:2,left:Math.min(n,a-er),right:t}:{columns:1,left:n,right:t}}var I=class I extends wt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Au;this.colRight=Iu;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=Mn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=_d(()=>this.requestUpdate());this.imageSizes=Pd(()=>this.requestUpdate());this.symbols=new $a(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Ta;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=ss(a,this.hass.states);r.some(s=>Qo(Ru(s.entityId)))||ls({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Qo(Mu)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??ky}static{this.styles=ar`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Ka,this.scrubStart),this.addEventListener(Wa,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},xy)}loadColumnWidths(){try{let t=window.localStorage.getItem(_u);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=us(i.left)),typeof i.right=="number"&&(this.colRight=us(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(_u,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Lu);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Lu,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?qr(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let S=this.focusTapId();if(S!==void 0&&o===S&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,S,r??void 0);return}let B=this.hitLayerId(i);B?this.inspect={kind:"layer",id:B}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=Pu(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=qr(this.draft.config,o),p=this.draft.config.elements.find(S=>S.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=pt(this.draft.config,u),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let y=Re(this.draft.config,t,p).frame,x=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let S=p.payload,B=de[t],J=y.width*B.width,G=y.height*B.height,pe={x:0,y:0,w:J,h:G,cx:J/2,cy:G/2},M=ga(S,pe,fa(new Date));if(this.cancelGesture?.(),l){let E=x.width/B.width,L=S.timestampSize;this.cancelGesture=ic(s,i,l,{w:M.w*E,h:M.h*E},(D,K)=>{let le=Math.min(40,Math.max(4,Math.round(L*D)));this.mutate(Ue=>{let vt=Ue.elements.find(zt=>zt.payload.id===u);vt?.kind==="image"&&(vt.payload.timestampSize=le)},`ts-size-${u}`),K&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let b={x:0,y:0,w:y.width*x.width,h:y.height*x.height},v=ct(S)?{x:S.timestampX,y:S.timestampY}:{x:(M.x+M.w/2)/pe.w,y:(M.y+M.h/2)/pe.h},R=!1;this.cancelGesture=nc(s,b,i,v,(E,L,D)=>{D||(R=!0),R&&this.mutate(K=>{let le=K.elements.find(Ue=>Ue.payload.id===u);le?.kind==="image"&&(le.payload.timestampX=E,le.payload.timestampY=L)},`ts-${u}`),D&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let $=p.payload.chartAnchor,T=$!==void 0&&!lt($.at)&&$.place!=="through",k=$!==void 0&&lt($.at)&&$.place==="through",C=de[t],O={dx:$?.dx??0,dy:$?.dy??0},V=$!==void 0&&!r?bi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(S=>S.id===u)?.frame:void 0,U=V??y,ne=S=>Math.round(S*10)/10;this.cancelGesture?.(),this.cancelGesture=Ra(s,x,i,{elementId:u,frame:U,handle:r??void 0},{onFrame:(S,B,J)=>{this.mutate(G=>{if($===void 0){Ee(G,t,S,{frame:B});return}let pe=V?{width:y.width,height:y.height}:{width:B.width,height:B.height};Ee(G,t,S,{frame:{...B,...pe,x:T?B.x:y.x,y:y.y}});let M=G.elements.find(R=>R.payload.id===S)?.payload.chartAnchor;if(M===void 0)return;let b=O.dx,v=k?O.dy:ne(O.dy+(B.y-U.y)*C.height);b?M.dx=b:delete M.dx,v?M.dy=v:delete M.dy},`drag-${S}-${t}`),J&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=ht(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,Re(o,t,x).frame])),d=[...l.values()],c=Math.min(...d.map(x=>x.x)),u=Math.min(...d.map(x=>x.y)),p=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),g={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},y=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=Ra(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:(x,$,T)=>{let k=$.x-g.x,C=$.y-g.y;this.mutate(O=>{for(let[V,U]of l)Ee(O,t,V,{frame:{...U,x:y(U.x+k),y:y(U.y+C)}})},`drag-group-${r.id}-${t}`),T&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?ec:1,s=t*o,l=i*o,d=this.canvasFamily,c=de[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(ht(r,x).map($=>$.payload.id),d,c,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(x=>x.payload.id===u);if(!p)return!1;let m=pt(r,u);if(m?.locked)return this.nudgeMany(ht(r,m.id).map(x=>x.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=Re(r,d,p).frame,y=Io(g,s,l,c);return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>Ee(x,d,u,{frame:y}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,c=new Map;for(let C of t){let O=l.elements.find(V=>V.payload.id===C);O&&c.set(C,Re(l,i,O).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(C=>C.x)),m=Math.min(...u.map(C=>C.y)),g=Math.max(...u.map(C=>C.x+C.width)),y=Math.max(...u.map(C=>C.y+C.height)),x={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},$=Io(x,o,s,a),T=$.x-x.x,k=$.y-x.y;return(T!==0||k!==0)&&this.mutate(C=>{for(let[O,V]of c)Ee(C,i,O,{frame:{...V,x:d(V.x+T),y:d(V.y+k)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=de[i],c=Re(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=ga(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},fa(new Date)),g=ct(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},y=tc(g,a,r,{w:u,h:p});return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>{let $=x.elements.find(T=>T.payload.id===t);$?.kind==="image"&&($.payload.timestampX=y.x,$.payload.timestampY=y.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=ma(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=bo(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ne(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=fe(s,l),c=Re(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Ra(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?Ol(g,u,t,p):Ee(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Nu(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${xo.length} kinds · ${Ii.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${xo.map(s=>h`<button class="add" style=${`--k:${Oe[s]}`} ?disabled=${i} title=${`Add a blank ${Fn[s].toLowerCase()} layer`}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="right">
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${M.isHidden?"Show":"Hide"} (${ps}${Nt}H)`} aria-label=${M.isHidden?"Show this layer":"Hide this layer"} @click=${D=>{D.stopPropagation(),this.mutate(K=>Ee(K,a,G,{isHidden:!M.isHidden}))}}>${z(M.isHidden?"hide":"show")}</button>
      ...
      </div>`},V=(S,B)=>{let J=this.inspect.kind==="group"&&this.inspect.id===S.id,G=!this.collapsed.has(S.id),pe=this.rowDrag(S.id,i),M=B[0],b=B[B.length-1],v=E=>{let L=E.currentTarget,D=L.getBoundingClientRect(),K=D.top+(L.classList.contains("drop-before")?yt:0),le=D.bottom-(L.classList.contains("drop-after")?yt:0),Ue=(E.clientY-K)/Math.max(1,le-K);return Ue<.25?"drop-before":!G&&Ue>.75?"drop-after":"drop-into"},R=B.map(E=>E.payload.id);return h`<div class="layer group ${J?"hl":""} ${C?"rich":""}" style=${`--k:${X.group}`} tabindex="0" draggable=${pe.draggable}
        @pointerenter=${()=>{this.listHoverIds=R}}
        @pointerleave=${()=>this.leaveRow(R)}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:S.id}}}
        @keydown=${E=>{E.key==="Enter"&&(this.inspect={kind:"group",id:S.id})}}
        @dragstart=${pe.onStart} @dragend=${pe.onEnd}
        @dragover=${E=>{!this.dragId||this.dragId===S.id||(E.preventDefault(),this.markDrop(E.currentTarget,v(E)))}}
        @drop=${E=>{E.preventDefault();let L=v(E);this.clearDragMarks();let D=this.dragId;if(this.dragId=void 0,!(!D||!M||!b)){if(L==="drop-before"){this.reorderLayer(D,M.payload.id,!0,!0);return}if(L==="drop-after"){this.reorderLayer(D,b.payload.id,!1,!0);return}this.isGroupId(D)||(this.reorderLayer(D,M.payload.id,!0),this.mutate(K=>Ur(K,D,S.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?h`<span class="facts"><span class="fact"><b>Holds</b> ${B.map(E=>Fe(E,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${ps}${Nt}G)`} aria-label="Ungroup" @click=${E=>{E.stopPropagation(),this.mutate(L=>ci(L,S.id)),J&&(this.inspect={kind:"general"})}}>${z("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${S.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${E=>{E.stopPropagation(),this.mutate(L=>{let D=L.groups?.find(K=>K.id===S.id);D&&(D.locked=!D.locked)})}}>${z(S.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${G?"true":"false"} title=${G?"Fold the group":"Unfold the group"}
            @click=${E=>{E.stopPropagation();let L=new Set(this.collapsed);G?L.add(S.id):L.delete(S.id),this.collapsed=L}}>${z("chevron")}</button>
        </span>
      ...
      ${g>=2&&i?h`<div class="group-cta"><span>${g} layers picked</span><span class="spacer"></span>
            ...
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?h`<div class="hint">${Hi}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:f}
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=gu(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=bi(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?En((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Yc();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${z("content")}</span>Shared values
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${g=>{g.stopPropagation(),this.mutate(y=>{Zr(y,c.id)}),p&&(this.openValue=void 0)}}>${z("delete")}</button>`:f}
        </div>
        ${p?h`<div class="value-open">${qc(s,c)}</div>`:f}</div>`})}
          ...
          ${z("plus")}${ee(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?ba(c,{icons:this.icons,imageSizes:this.imageSizes,slot:Mn.slots[r]}):f}let l=r!=="inline"&&Ja(t,r)===0&&t.elements.length>0,d=this.canEdit&&xa(t,r);return h`<span class="tab-wrap">
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ...
        ${a.map(o=>{let s=ro(o.id),l=this.sharedRaw(o.id)??"",d=l===""?"empty":l,c=o.name||"(unnamed)",u=this.testValues.get(s),p={entity_id:s,state:l,attributes:{},last_changed:"",last_updated:""};return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${X.complication}`}
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ue(r),s=new Qe(this.buildContext(),this.draft?.config),l=Jc(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)Ee(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let x=g.elements.find($=>$.payload.id===y.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ${xe(r,"picked",`${d} layers picked`,h`
          ...
          <div class="hint">${Hi}-click a layer to add it or take it out. Click one on its own to edit it alone.</div>`,{color:"var(--wa-accent)",icon:"layers",summary:`Edits here land on all ${d}`,alwaysOpen:!0})}
