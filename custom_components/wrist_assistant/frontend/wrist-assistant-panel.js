...
`)}function Po(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Wd(r));return{values:t,nullKeys:i}}function Wd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Ia(e){let n=si(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function jd(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}var qd=10800;function Yd(e,n){let t=e.minutes==="always"||e.minutes==="auto"&&n<=qd;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...t?{minute:"2-digit"}:{},...e.hourCycle==="h12"?{hourCycle:"h12"}:{},...e.hourCycle==="h24"?{hourCycle:"h23"}:{}})}function Xd(e,n){if(pt(e)===void 0)return[];let t=ro(e.timeLabelCount);if(t.length===0)return[];let i=Pe(e)*60,a=Yd(e,i);return t.map(r=>({position:r,text:a.format(new Date(n-i*1e3*(1-r)))}))}function Rt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ze(e){let n=e.trim(),t=Rt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Rt(i)}function Jd(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Zd(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Qd(e){let n=e.trim(),t=Rt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Rt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Rt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function ec(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function tc(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function nc(e,n,t){if(Oe(n))return e;let i=n,a=e,r=Rt(e.trim()),o=i.duration?Qd(e):void 0;if(o!==void 0)a=ec(o);else if(i.relativeTime&&r!==void 0)a=Zd(r);else{let s=Ze(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Jd(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=tc(a);break}return a}function Xt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Rn(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function Oo(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function ic(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function In(e,n=ut){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:ac(i.slice(a+1))})}return t}function ac(e){try{return decodeURIComponent(e)}catch{return e}}function rc(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Do(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function oc(e,n,t){if(e===void 0)return 0;let i=Ze(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Qe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Oo(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Et(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=Rn(i);return n.limit>0&&a.length>n.limit?n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit):a}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ze(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,h=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Oo(a.get(s)??[],c);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Oe(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?jd(a,t.kind.stat):void 0;i=a&&r!==void 0?Qr(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Ra(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return nc(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Rt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Xt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ze(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ze(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ze(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,h]=l<=c?[l,c]:[c,l];return a>=u&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Se[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,c={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let u=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,m={kind:"text",...c,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return u!==void 0&&(m.countdownEnd=u),m}case"icon":{let u=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(a,"icon")??u,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let u=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(u.value),m=this.styleNumber(a,"gaugeMin")??u.minValue,g=this.styleNumber(a,"gaugeMax")??u.maxValue,v=h===void 0?void 0:Ze(h),$=this.styleColor(a,"color")??u.colorSlot.baseColorHex;u.coloring==="bands"&&u.bands.length>0&&v!==void 0&&($=aa(v,xn(u),u.bandAboveColorHex));let S=g-m;if(u.total){let C=Ze(this.resolve(u.total)??"");C!==void 0&&(S=C)}let E=Do(S,1,jn),w={kind:"gauge",...c,fraction:oc(h,m,g),style:u.style,lineWidth:u.lineWidth,colorHex:$,trackColorHex:u.trackColorHex,thresholdColorHex:u.thresholdColorHex,dotCount:E,filledCount:Do(v??0,0,E)};if(u.thresholdValue!==void 0&&g!==m){let C=(u.thresholdValue-m)/(g-m);C>=0&&C<=1&&(w.thresholdFraction=C)}return w}case"chart":{let u=n.payload,h=this.charts.get(u.id)??this.chartReadings(u),m=h.values,g={min:h.domainMin,max:h.domainMax},v=this.styleColor(a,"color")??u.colorSlot.baseColorHex,$=xn(u),S=Zr(u)?m.map(N=>aa(N,$,u.bandAboveColorHex)):[],E={kind:"chart",...c,values:m,style:u.style,domainMin:g.min,domainMax:g.max,baseline:u.baseline,barGap:u.barGap,lineWidth:u.lineWidth,colorHex:v,highColorHex:u.highColorHex,lowColorHex:u.lowColorHex,marker:u.marker,pointColorHexes:S,fillBands:u.fillBands,thresholdColorHex:u.thresholdColorHex,nowColorHex:u.nowColorHex};if(m.length>0){let N=u.highlight==="highest"||u.highlight==="both",B=u.highlight==="lowest"||u.highlight==="both",q=N?m.indexOf(Math.max(...m)):-1,de=B?m.indexOf(Math.min(...m)):-1;q>=0&&(E.highIndex=q),de>=0&&de!==q&&(E.lowIndex=de)}let w=ic(u,g.min,g.max);w!==void 0&&(E.thresholdY=w);let C=this.chartNowIndex(u,m.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let u=n.payload,h=pt(u),m=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=In(m,ut),v=rc(g,Pe(u)*60,S=>so(S,u.bands,u.otherColorHex));return{kind:"timeline",...c,runs:v,gap:u.gap,cornerRadius:u.cornerRadius,labels:Xd(u,this.nowMs()),labelSize:u.labelSize,labelColorHex:u.labelColorHex,labelsAbove:u.labelsAbove}}case"shape":{let u={kind:"shape",...c,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(u.borderColorHex=h),u}case"image":{let u={kind:"image",...c,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};We(n.payload)&&(u.timestampX=n.payload.timestampX,u.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(u.url=h),u}case"tap":{let u={kind:"tap",...c,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(u.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(u.attachedTo=n.payload.attachedTo),u}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=$o(n,t).map(v=>this.resolveElement(v,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let v=a.bezelGauge,$=this.resolve(v.value),S=$===void 0?void 0:Ze($);if(S!==void 0){let E=Math.min(v.minValue,v.maxValue),w=Math.max(v.minValue,v.maxValue),C={value:Math.min(w,Math.max(E,S)),minValue:E,maxValue:w===E?E+1:w,colorHexes:v.colorHexes},N=this.resolve(v.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(v.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function sc(e,n,t){let i=new Qe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function li(e,n,t){let i=new Qe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=sc(e.inline,n,e)),a}var ve=me,An=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ve,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Jt=An.find(e=>e.measured);function Yo(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return An.find(a=>a.screen.width===t&&a.screen.height===i)}function ci(e,n){let t=ve[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var lc={regular:400,medium:500,semibold:600,bold:700};function Ve(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ke(e,n,t="#FFFFFF"){let i=Ve(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Xo(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function dc(e,n){let t=ke(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Xt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=e.text;if(n.w>0&&s.length*i(o)>n.w){let l=n.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var pc=5;function hc(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:pc,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,c=Math.max(n.h-r-o*2,1),u=d+c,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?c*.12:0,v=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-v*(i-1))/i,.5),S=w=>Math.min(1,Math.max(0,(w-e.domainMin)/h)),E=w=>u-S(w)*c;return{count:t.length,barWidth:$,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:m?u:E(0),yAtFraction(w){return u-Math.min(Math.max(w,0),1)*c},barRect(w){let C=s+w*($+v),N=t[w],B,q;if(m){let de=g+S(N)*(c-g);B=u-de,q=u}else B=E(N),q=m?u:E(0),B>q&&([B,q]=[q,B]);return{x:C,y:B,w:$,h:Math.max(q-B,.5)}},point(w){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*w/(t.length-1):s+l/2,y:E(t[w])}},markerCenter(w,C){let N=C?this.barRect(w):void 0;return{x:N?N.x+N.w/2:this.point(w).x,y:n.y+r/2}}}}function mc(e,n){if(e.values.length===0)return f;let t=hc(e,n),i=ke(e.colorHex,"fill"),a=ke(e.highColorHex,"fill",e.colorHex),r=ke(e.lowColorHex,"fill",e.colorHex),o=(c,u)=>b`<circle cx=${c.x} cy=${c.y} r="1.7" fill=${u.fill} fill-opacity=${u["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=c=>l?ke(e.pointColorHexes[c],"fill",e.colorHex):i;if(e.style==="bars")for(let c=0;c<t.count;c++){let u=t.barRect(c),h=c===e.highIndex?a:c===e.lowIndex?r:d(c),m=Math.min(1.2,u.w/2,u.h/2);s.push(b`<rect x=${u.x} y=${u.y} width=${u.w} height=${u.h} rx=${m}
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(wc(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return b`
    ...
    ${o!==void 0?b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${_a} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var _a=5;function $c(e,n){let t=_a*.55,i=n.w-2;if(n.h<_a*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function za(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=Xo(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=dc(e,l);break;case"icon":c=yc(e,l,t.icons);break;case"gauge":c=cc(e,l);break;case"chart":c=mc(e,l);break;case"timeline":c=fc(e,l);break;case"shape":c=gc(e,l);break;case"image":c=xc(e,l,t);break;case"tap":c=kc(e,l,t.icons,a,d?je(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,v=t.handles===!0&&(!s||o),$=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,E=b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,w=3,C=m&&v?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([N,B,q])=>b`<rect data-handle=${N} x=${B-w/2} y=${q-w/2} width=${w} height=${w}
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${c}${S}${$}${C}</g>`}function hi(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Da(e,n){return(n?23.5:34)*e}var Vo=10.5;function Jo(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Bo(e,n){let t=0;for(let i of e)t+=Jo(i,n);return t}function Go(e,n,t){let i=e.toUpperCase(),a=d=>Jo(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Na(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Pa(e,n,t,i){let a=Na(e,n,t),r=Na(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Zo(e,n,t,i){let{dial:a}=hi(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Pa(a,t,i.start,i.end),length:t*r}}function Cc(e,n){let t=hi(e,!0);return Zo(e,n,t.dial.r,t.labelArc)}var Uo=18.5,Sc=113,Ec={start:-71,end:-36},Ko=104,Tc=6.2,Wo={start:-77,end:-30.5};function jo(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function qo(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=jo(e[i]),o=jo(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var La=11;function Fc(e,n,t){let{dial:i}=hi(n,!0),a=Ko*n,r=180/(Math.PI*Ko),o=e.minLabel!==void 0?Bo(e.minLabel,La)*r:0,s=e.maxLabel!==void 0?Bo(e.maxLabel,La)*r:0,l=Wo.start+(o>0?Math.max(0,o-1.8):0),d=Wo.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,h=[];for(let S=0;S<u;S++){let E=l+c*S/u,w=Math.min(d,l+c*(S+1)/u+.4);h.push(b`<path d=${Pa(i,a,E,w)} fill="none"
      stroke=${qo(e.colorHexes,(S+.5)/u)} stroke-width=${Tc*n}
      stroke-linecap=${S===0||S===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=Na(i,a,l+c*m),v=1.5,$=(S,E,w,C)=>b`
    <defs><path id=${S} d=${Pa(i,a,E,w)} /></defs>
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${qo(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?$(`${t}-gmin`,l-v-Math.max(o,3),l-v,e.minLabel):f}
    ${e.maxLabel!==void 0?$(`${t}-gmax`,d+v,d+v+Math.max(s,3),e.maxLabel):f}`}function mi(e,n){let t=e.family in ve?e.family:"rectangular",i=n.slot??ve[t],a=ve[t],r=ci(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ve(e.backgroundColorHex),l=Ve(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,v=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=hi(g,v),w=Da(g,v),C=w/(a.width*g),N=E.tile.cx-w/2,B=E.tile.cy-w/2,q=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,de=f;if(e.bezelGauge)de=Fc(e.bezelGauge,g,o);else if(e.bezelText){let F=Cc(g,`${o}-bezel`),V=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Xt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;de=b`<defs><path id=${F.id} d=${F.d} /></defs>
        <text font-size=${Vo*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${F.id}" startOffset="50%" text-anchor="middle">${Go(V,F.length,Vo*g)}</textPath></text>`}let x=f;if(S){let F=Ve(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},V=Zo(g,`${o}-curved`,Sc*g,Ec);x=b`<defs><path id=${V.id} d=${V.d} /></defs>
        <text font-size=${Uo*g} font-weight="600" fill=${F.color} fill-opacity=${F.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${V.id}" startOffset="50%" text-anchor="middle">${Go($,V.length,Uo*g*.88)}</textPath></text>`}else{let F=e.borderWidth*r.scale*C,V=l?b`<circle cx=${w/2} cy=${w/2} r=${w/2-F/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${F} />`:f;x=b`<g transform="translate(${N} ${B})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Kc(e)}</svg>`}var Be="color-mix(in srgb, var(--k) 45%, #6b7280)",xi='system-ui, -apple-system, "Segoe UI", sans-serif';function Es(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Xa(e,n,t,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${Es(e,n,t,1)} stroke=${Be} stroke-width="2.6" opacity=".5" />
    <path d=${Es(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function Wc(e){switch(e){case"text":return b`<g font-family=${xi} text-anchor="middle">
    ...
    <div class="slider-row">
      <input type="range" min=${i.min} max=${i.max} step=${i.step} .value=${String(n)}
        @input=${we(r=>{let o=Number(r);Number.isNaN(o)||t(o)})} />
      <span class="slider-value mono">${a(n)}</span>
    </div></div>`}function $i(e,n,t,i,a,r){let o=s=>Math.round(s*1e3)/10;return ne(e,o(n),s=>t((s??0)/100),{min:a,max:r,step:.5,def:o(i)})}function Ae(e,n,t,i){return p`<label class="field check"><input type="checkbox" .checked=${n} @change=${a=>t(a.target.checked)} />${nt(e,nn(n,i,t,a=>a?"on":"off"))}</label>`}function re(e,n,t,i=!1,a){let r=(n??"").replace(/^#/,""),o=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(r),s=o?`#${r.slice(0,6)}`:"#ffffff",l=o&&r.length===8?Math.round(parseInt(r.slice(6,8),16)/255*100):100,d=(u,h)=>{let m=u.replace(/^#/,"").toUpperCase();return h>=100?`#${m}`:`#${m}${Math.round(h/100*255).toString(16).padStart(2,"0").toUpperCase()}`},c=a===void 0?void 0:{atDefault:Xc(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)};return p`<div class="field color">${nt(e,c)}
    <div class="color-row">
      ${i?p`<input type="checkbox" title="Enabled" .checked=${n!==void 0} @change=${u=>t(u.target.checked?d(s,l):void 0)} />`:f}
      <input type="color" .value=${s} ?disabled=${i&&n===void 0} @input=${we(u=>t(d(u,l)))} />
      <input type="range" min="0" max="100" .value=${String(l)} title="Opacity" ?disabled=${i&&n===void 0} @input=${we(u=>t(d(s,Number(u))))} />
      <input type="text" class="mono hex" .value=${n??""} placeholder="#RRGGBB" ?disabled=${i&&n===void 0}
        @input=${we(u=>{let h=u.trim();/^#?[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(h)&&t(h.startsWith("#")?h.toUpperCase():`#${h.toUpperCase()}`)})} />
    </div></div>`}function Xc(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function tl(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Jc(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Ls(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var nl=50;function Zc(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Qc(e,n,t=nl,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:c.startsWith(a)?h=2:d.includes(a)?h=3:c.includes(a)?h=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?h=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var eu=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function il(e){return eu.test(e.trim())}function tu(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return tl(t,i);if(il(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Lt=new Map;function Ie(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function al(e){return Lt.has(e)}function tt(e,n,t,i,a,r={}){let o=e.hass.states,s=Lt.get(a),l=s?Qc(Jc(o,r.domain,Ls(e.hass)),s.query,nl,r.preferNumeric?Zc:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(w,C,N=0)=>{Lt.set(a,{query:C,index:N}),Ie(w)},h=w=>{Lt.delete(a),Ie(w)},m=w=>{let C=tu(w,t,o);C&&i(C)},g=(w,C)=>{i(tl(o,w.entityId)),h(C)},v=()=>Math.max(0,Math.min(Lt.get(a)?.index??0,l.length-1)),$=w=>{let C=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let N=Lt.get(a);if(!N){u(C,C.value);return}let B=w.key==="ArrowDown"?v()+1:v()-1;u(C,N.query,Math.max(0,Math.min(l.length-1,B))),nu(C);return}if(w.key==="Enter"){w.preventDefault();let N=l[v()];s&&N?g(N,C):(m(C.value),h(C));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),h(C)}},S=t.entityId?Ls(e.hass)?.(t.entityId):void 0,E=t.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:c?p`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:p`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let C=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Lt.set(a,{query:"",index:0}),Ie(C),C?.focus()}}>${_("close")}</button>`}
    </div>
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${il(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                @mousedown=${N=>N.preventDefault()} @click=${N=>g(w,N.target)}>
                <span class="ent-ico ${er(w.state)?"on":""}">${Qa(w.domain)}</span>
                <span class="ent-main">
                ...
                <span class="ent-right">
                  <span class="ent-type">${Hs(w.domain)}</span>
                  <span class="ent-state">${w.state}</span>
                </span>
              </button>`)}
        </div>`:E}
  </div>`}function nu(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var iu=120;function au(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(bi.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(vi),fromPack:!1}}function _s(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function ru(e){return[{value:"",label:`Starter set (${_s(vi,e)})`},...bi.map(n=>({value:n.name,label:`${n.name} (${_s(n.symbols,e)})`}))]}function ou(e){return e.length>0?e.length:vi.length}function su(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function zs(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return p`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function rl(e,n,t,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),c=n.trim(),u=c!==""&&d.size>0&&!d.has(c),h=g=>{t(g),a.noteUsed(g)},m=f;if(r){let g=a.category(i),v=au(g,o,l,d),$=cs(v.names,o),S=v.fromPack?$.slice(0,iu):$,E=d.size===0?a.recent:a.recent.filter(w=>d.has(w));m=p`<div class="sym-browse">
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${o} @input=${we(w=>a.setQuery(i,w))} />
        <select @change=${we(w=>a.setCategory(i,w))}>
          ${ru(d).map(w=>p`<option value=${w.value} ?selected=${w.value===g}>${w.label}</option>`)}
        </select>
      </div>
      ${E.length===0?f:p`<div class="hint">Recent</div>
        <div class="sym-grid one-row">${E.map(w=>zs(e,w,w===c,h))}</div>`}
      <div class="sym-grid">${S.map(w=>zs(e,w,w===c,h))}</div>
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${we(t)} @change=${we(g=>{(d.size===0||d.has(g.trim()))&&a.noteUsed(g)})} /></label>
    ...
    ${m}`}var lu=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],du=[["bars","Bars"],["line","Line"],["area","Area"]],cu=[["auto","Auto"],["fixed","Fixed range"]],uu=[["lowest","Lowest value"],["zero","Zero"]],ol=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],pu=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],Ns=[["uniform","One colour"],["bands","By value"]];function Ps(e){let n=[ia,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function hu(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function mu(e,n){let t=xn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Os(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    ${e.bands.map((o,s)=>p`
      <div class="row-inline">
        ...
        <button class="icon" title="Remove this state" aria-label="Remove this state"
          @click=${()=>n(l=>{l.bands=l.bands.filter((d,c)=>c!==s)})}>${_("close")}</button>
      </div>`)}
    <datalist id=${i}>${t.map(o=>p`<option value=${o}></option>`)}</datalist>
    <button class="small" @click=${()=>n(o=>{o.bands=[...o.bands,{id:J(),match:r,colorHex:Kn(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${re("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??ct},"tother"),!1,ct)}`}var yu=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],bu={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Ds(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return R(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var vu=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function wu(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function oe(e,n,t,i){if(i.inline||!xu())return p`<div class="value-editor">${dl(e,n,t,i)}</div>`;let a=rr(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=ge(n,ye(e)),l="entityId"in n.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    <div class="grid2">
      ...
      ${ie("Case",t.textCase??"",[["","As is"],["upper","UPPER"],["lower","lower"],["capitalized","Capitalized"]],a=>i({textCase:a||void 0}))}
    ...
    ${ie("Seconds as",t.duration?"duration":t.relativeTime?"relativeTime":"",[["","None"],["relativeTime","Time ago"],["duration","Duration"]],a=>i({relativeTime:a==="relativeTime",duration:a==="duration"}),{titles:{relativeTime:"45s, 2m, 3h",duration:"1h 23m, 45s"}})}
    ...
    ${o.kind==="filter"?p`<div class="grid2">
          ...
          ${he("Floor ids",a(o.floorIds),s=>t({...n,scope:{...o,floorIds:r(s)}}))}
            ...
            <button class="icon" title="Remove" @click=${()=>t({...n,scope:{...o,entities:o.entities.filter((d,c)=>c!==l)}})}>${_("close")}</button>
          </div>`)}
    ...
    ${n.function==="count"?f:he("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var cl=ga,Tu=cl.filter(([e])=>e!=="none");function Fu(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function ul(e,n){let t=Fu(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return co(e)?{type:e,...t}:{type:e}}var Mu=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function pl(e,n,t,i){let a=n.serviceDataJSON??"",r=uo(a),o=n.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Iu).slice(0,7)}
                @input=${we(s=>e.update(l=>{l.successFlashColorHex=s.toUpperCase()},"flash"))} />`:p`<span class="muted">Off</span>`}
        </div>
      </div>
    </div>
    ...
    ${t.type==="callService"?pl(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?Au(e):f}`}var Iu="#808080",Bs=[0,15,30,60,120];function Gs(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Au(e){let n=e.config;return ml(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function ml(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Te("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function fl(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return p`
    ...
    ${t?p`
      ${ie("Placement",i?"free":"corner",[["corner","A corner"],["free","Anywhere"]],r=>a(r==="free"))}
      ${i?f:ie("Corner",e.timestampCorner,[["topLeading","Top left"],["topTrailing","Top right"],["bottomLeading","Bottom left"],["bottomTrailing","Bottom right"]],r=>n(o=>{o.timestampCorner=r}))}
      ${ne("Text size (pt)",e.timestampSize,r=>n(o=>{o.timestampSize=Math.min(40,Math.max(4,r??Wt))},"tssize"),{step:1,min:4,max:40,def:Wt})}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <div class="hint">${Ii(e)}, up to 7 days: the recorder keeps
      ten by default, and a longer span would quietly come back short.</div>`}function sr(e,n){let t=ye(e);switch(n.kind){case"text":return ft(ge(n.payload.value,t),48);case"icon":return ft(ge(n.payload.symbol,t),48);case"gauge":return ft(ge(n.payload.value,t),48);case"chart":return ft(`${ge(n.payload.value,t)}${n.payload.historyMinutes>0?` \xB7 ${Ii(n.payload.historyMinutes)}`:""}`,48);case"timeline":return ft(`${ge(n.payload.value,t)} \xB7 ${Ii(Pe(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return je(n.payload.action)}}function Ai(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Ce(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Ce(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${ol.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Ce(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Ce(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Ce(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function vl(e,n,t){let i=n.payload.id,a=e.config.elements.findIndex(y=>y.payload.id===i),r=`el-${i}`,o=(y,k)=>e.update(Y=>y(Y.elements[a]),k?`${r}-${k}`:void 0),s=Re(e.config,t,n),l=s.frame,d=(y,k)=>e.update(Y=>Fe(Y,t,i,{frame:Fs(l,y)}),`${r}-${k}-${t}`),c=Ne(n.kind).payload,u=c.colorSlot?.baseColorHex??"#FFFFFF",h=y=>c[y],m,g;switch(n.kind){case"text":{let y=ya(e.config,n.payload.value);m=p`
        ...
        ${n.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:f}`,g=p`<div class="grid2">
          ...
          ${ie("Weight",n.payload.fontWeight,or,k=>o(Y=>{Y.payload.fontWeight=k}),{def:c.fontWeight})}
        ...
        <div class="hint">An entity source draws that entity's own icon instead.</div>`,g=Si(e,n,t,"Icon size",{step:1,min:4,def:h("size")});break;case"gauge":{let y=n.payload,k=(G,L)=>o(D=>G(D.payload),L),Y=y.style==="dots";m=p`
        ${oe(e,y.value,G=>k(L=>{L.value=G},"value"),{showResolved:!0,label:"Reading",key:`${r}-value`})}
        ${Y?p`
            ${oe(e,y.total??Ds(y),G=>k(L=>{L.total=G},"total"),{showResolved:!0,label:"Total",key:`${r}-total`})}
            ...
            <div class="grid2">
              ${ne("Min",y.minValue,G=>k(L=>{L.minValue=G??0},"min"),{def:c.minValue})}
              ${ne("Max",y.maxValue,G=>k(L=>{L.maxValue=G??100},"max"),{def:c.maxValue})}
            </div>`}`,g=p`
        <div class="grid2">
          ${ie("Style",y.style,yu,G=>k(L=>{G==="dots"&&L.total===void 0&&(L.total=Ds(L)),G!=="dots"&&delete L.total,L.style=G}),{titles:bu,def:c.style})}
          ${Y?f:Si(e,n,t,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        ${re(Y?"Empty dot colour":"Track colour",y.trackColorHex,G=>k(L=>{L.trackColorHex=G??"#FFFFFF40"},"track"),!1,c.trackColorHex)}
        ${ie("Colour",y.coloring,Ns,G=>k(L=>{L.coloring=G,G==="bands"&&L.bands.length===0&&(L.bands=Ps([L.minValue,L.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Os(y,y.colorSlot.baseColorHex,k)}`:f}
        ${Y?f:p`
          <div class="grid2">
            ${ne("Threshold",y.thresholdValue,G=>k(L=>{G===void 0?delete L.thresholdValue:L.thresholdValue=G},"thr"),{optional:!0})}
            ${y.thresholdValue===void 0?f:re("Threshold colour",y.thresholdColorHex,G=>k(L=>{L.thresholdColorHex=G??Bt},"thrcol"),!1,Bt)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,k=(M,A)=>o(Di=>M(Di.payload),A),Y=Et(y),G=c.historyMinutes,L=c.historyPoints,D=y.historyMinutes>0,O=y.value.kind.kind==="entityState",se=Y===void 0?void 0:e.historySeries(Y),rn=D&&O?se??"":e.resolve(y.value)??"",xe=y.historyPoints<1,on=nr(i,y.historyMinutes),W=Rn(rn),Q=y.limit>0&&W.length>y.limit?y.takeFromEnd?W.slice(W.length-y.limit):W.slice(0,y.limit):W,Ni=!D&&O&&W.length===1,Pi=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==i),Wl=ye(e),Oi=y.scaleFrom!==void 0&&Pi.some(M=>M.payload.id===y.scaleFrom);m=p`
        ${oe(e,y.value,M=>k(A=>{A.value=M},"value"),{label:"Readings",key:`${r}-value`})}
        ${ie("Draw",D?"history":"value",[["history","Recorded history"],["value","The value itself"]],M=>k(A=>{A.historyMinutes=M==="history"?A.historyMinutes||Yn:0}),{titles:{history:"Read the entity's past from the recorder and plot it",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${D?p`
            ...
            <div class="grid2">
              ${js(i,y.historyMinutes,G,M=>k(A=>{A.historyMinutes=M}))}
              <div class="field readings-field">${nt("Readings",{atDefault:y.historyPoints===L,title:`Back to ${L<1?"every one":`${L} averaged`}`,reset:()=>k(M=>{M.historyPoints=L})})}
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Readings">
                    <button type="button" role="radio" aria-checked=${xe?"false":"true"} class=${xe?"":"on"}
                      ...
                      @click=${()=>{xe&&k(M=>{M.historyPoints=24})}}>Average</button>
                    <button type="button" role="radio" aria-checked=${xe?"true":"false"} class=${xe?"on":""}
                      title="Plot every recorded state change, no averaging"
                      @click=${()=>{xe||k(M=>{M.historyPoints=sa})}}>Every one</button>
                  </div>
                  ${xe?f:p`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    step="1" min=${oa} max=${Xn}
                    @input=${we(M=>{let A=Number(M);M.trim()!==""&&Number.isFinite(A)&&A>=1&&k(Di=>{Di.historyPoints=Math.round(A)},"hpoints")})} />`}
                </div>
              </div>
            </div>
            ${on?qs(y.historyMinutes,M=>k(A=>{A.historyMinutes=M},"span")):f}
        ...
        <div class="grid2">
          ${ne("Use",y.limit,M=>k(A=>{A.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:c.limit})}
          ${ie("From",y.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],M=>k(A=>{A.takeFromEnd=M==="end"}),{def:c.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        <div class="grid2">
          ${ie("Style",y.style,du,M=>k(A=>{A.style=M}),{def:c.style})}
          ${y.style==="bars"?ne("Bar gap (pt)",y.barGap,M=>k(A=>{A.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:c.barGap}):Si(e,n,t,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        <div class="grid2">
          ${ie("Scale",y.scale,cu,M=>k(A=>{A.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ie("Baseline",y.baseline,uu,M=>k(A=>{A.baseline=M}),{def:c.baseline})}
        </div>
        ${Pi.length===0?f:Te("Same scale as",Oi?y.scaleFrom:"",[["","Its own"],...Pi.map(M=>[M.payload.id,Me(M,Wl)])],M=>k(A=>{M?A.scaleFrom=M:delete A.scaleFrom}),{def:""})}
        ...
        ${!Oi&&y.scale==="fixed"?p`<div class="grid2">
              ${ne("Min",y.minValue,M=>k(A=>{A.minValue=M??0},"cmin"),{def:c.minValue})}
              ${ne("Max",y.maxValue,M=>k(A=>{A.maxValue=M??100},"cmax"),{def:c.maxValue})}
            </div>`:f}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let M;e.update(A=>{M=Fo(A,i)}),M&&e.selectLayer(M)}}>
          ${_("plus")}<span>Second series</span></button>
        ${ie("Colour",y.coloring,Ns,M=>k(A=>{A.coloring=M,M==="bands"&&A.bands.length===0&&(A.bands=Ps(Q))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Os(y,y.colorSlot.baseColorHex,k)}
          ${y.style==="area"?p`${Ae("Fill follows the bands",y.fillBands,M=>k(A=>{A.fillBands=M}),c.fillBands)}
        ...
        <div class="grid2">
          ${ie("Highlight",y.highlight,ol,M=>k(A=>{A.highlight=M}),{def:c.highlight})}
          ${y.highlight==="none"?f:ie("Marker",y.marker,pu,M=>k(A=>{A.marker=M}),{def:c.marker})}
        </div>
        ${y.highlight==="none"?f:p`
          <div class="grid2">
            ${y.highlight==="lowest"?f:re("Highest colour",y.highColorHex,M=>k(A=>{A.highColorHex=M??vn},"hicol"),!1,vn)}
            ${y.highlight==="highest"?f:re("Lowest colour",y.lowColorHex,M=>k(A=>{A.lowColorHex=M??wn},"locol"),!1,wn)}
          </div>
        ...
        ${Ae("Threshold line",y.thresholdValue!==void 0,M=>k(A=>{M?A.thresholdValue=hu(Q):delete A.thresholdValue}))}
        ${y.thresholdValue===void 0?f:p`
          <div class="grid2">
            ${ne("At",y.thresholdValue,M=>k(A=>{A.thresholdValue=M??0},"thval"))}
            ${re("Line colour",y.thresholdColorHex,M=>k(A=>{A.thresholdColorHex=M??Gt},"thcol"),!1,Gt)}
          </div>
        ...
        ${Ae("\u201CNow\u201D marker",y.nowIndex!==void 0,M=>k(A=>{M?A.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete A.nowIndex}))}
        ${y.nowIndex===void 0?f:p`
          ${oe(e,y.nowIndex,M=>k(A=>{A.nowIndex=M},"nowidx"),{showResolved:!0,label:"Reading number",key:`${r}-nowindex`})}
          ${re("Marker colour",y.nowColorHex,M=>k(A=>{A.nowColorHex=M??Ut},"nowcol"),!1,Ut)}
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=n.payload,k=(W,Q)=>o(Ni=>W(Ni.payload),Q),Y=c.historyMinutes,G=y.value.kind.kind==="entityState",L=pt(y),D=L===void 0?void 0:e.historySeries(L),O=Pe(y)*60,se=In(D??"",ut),rn=nr(i,y.historyMinutes),xe=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,on=fu(se,O,xe===void 0?void 0:e.hass.states[xe]?.state,xe?.split(".")[0]);m=p`
        ...
        ${js(i,y.historyMinutes,Y,W=>k(Q=>{Q.historyMinutes=W}))}
        ${rn?qs(y.historyMinutes,W=>k(Q=>{Q.historyMinutes=W},"span")):f}
        ...
        <div class="grid2">
          ${ne("Gap (pt)",y.gap,W=>k(Q=>{Q.gap=Math.min(Jn,Math.max(0,W??0))},"tgap"),{step:.5,min:0,max:Jn,def:c.gap})}
          ${ne("Corner radius (pt)",y.cornerRadius,W=>k(Q=>{Q.cornerRadius=Math.max(0,W??0)},"tradius"),{step:.5,min:0,def:c.cornerRadius})}
        </div>
        ...
        ${y.timeLabelCount<=0?f:p`
          <div class="grid2">
            ${ne("Time size (pt)",y.labelSize,W=>k(Q=>{Q.labelSize=Math.min(En,Math.max(Sn,W??kn))},"tlsize"),{step:.5,min:Sn,max:En,def:c.labelSize})}
            ${re("Time colour",y.labelColorHex,W=>k(Q=>{Q.labelColorHex=W??$n},"tlcolour"),!1,c.labelColorHex)}
          </div>
          ${ie("Row",y.labelsAbove?"above":"below",[["below","Below"],["above","Above"]],W=>k(Q=>{Q.labelsAbove=W==="above"}),{def:c.labelsAbove===!0?"above":"below"})}
          ${ie("Clock",y.hourCycle,io,W=>k(Q=>{Q.hourCycle=W}),{titles:{auto:"Whatever clock the watch is set to"},def:c.hourCycle})}
          ${ie("Minutes",y.minutes,ao,W=>k(Q=>{Q.minutes=W}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:c.minutes})}
          ...
          ${ie("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],y=>o(k=>{k.payload.kind=y}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:c.kind})}
          ${n.payload.kind==="roundedRectangle"?ne("Corner radius (pt)",n.payload.cornerRadius,y=>o(k=>{k.payload.cornerRadius=y??6},"radius"),{step:.5,min:0,def:c.cornerRadius}):f}
        </div>
        ${n.payload.kind==="line"?Uu(t,l,d):f}`,g=n.payload.kind==="line"?ne("Thickness (pt)",n.payload.thickness,y=>o(k=>{k.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        ${n.payload.borderColorHex!==void 0?ne("Border width (pt)",n.payload.borderWidth,y=>o(k=>{k.payload.borderWidth=y??1},"bw"),{step:.5,min:0,def:c.borderWidth}):f}`;break;case"image":{let y=n.payload,k=(D,O)=>o(se=>D(se.payload),O),Y=y.entity.entityId?e.hass.states[y.entity.entityId]?.attributes?.entity_picture:void 0,G=typeof Y=="string"?Y:void 0,L=G!==void 0&&!G.startsWith("/");m=p`
        ${ie("Source",y.source,[["camera","Camera"],["entityPicture","Entity picture"]],D=>k(O=>{O.source=D}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:c.source})}
        ${y.source==="camera"?p`
            ...
            ${L?p`<div class="hint warn">This picture is hosted outside Home Assistant, so the watch cannot fetch it.</div>`:f}
        ...
        ${ie("Picture",y.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],D=>k(O=>{O.contentMode=D}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:c.contentMode})}
        ...
        ${ne("Corner radius (pt)",y.cornerRadius,D=>k(O=>{O.cornerRadius=Math.max(0,D??Kt)},"imgradius"),{step:1,min:0,def:Kt})}`;break}case"tap":{m=p`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let v=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:re(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>o(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,u),$=$a(e.config,n),S=$?{kind:{kind:"entityState",...$}}:void 0,E=fe[n.kind],w=n.kind==="tap"?void 0:Ee(e.config,i)[0],C=n.kind==="image"?n.payload.timestamp===!0:!1,N=qu[n.kind],B=Yu[n.kind],q=Ks(n.payload,c,N),de=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,x=e.config.perFamily[t]?.placements[i]?.size!==void 0,F=Ks(n.payload,c,B)||de!==void 0&&s.size!==void 0&&s.size!==c[de],V=!Ri(l,Ke)||s.isHidden,P=Tt(e.config,i),ce=(y,k)=>()=>o(Y=>Ws(Y.payload,c,y),k);return p`
    ${$e(e,"content","Content",p`${n.kind==="tap"?f:_u(e,n,r)}${m}`,{color:E,icon:"content",summary:sr(e,n),...q?{reset:ce(N,"reset-content")}:{}})}
    ${g===void 0&&v===void 0?f:$e(e,"look",n.kind==="image"?"Picture":"Look",p`${g??f}${v??f}`,{color:E,icon:n.kind==="image"?"image":"look",...Ai(n)?{summary:Ai(n)}:{},...F?{reset:()=>e.update(y=>{Ws(y.elements[a].payload,c,B),x&&Fe(y,t,i,{},!0)})}:{}})}
    ${n.kind==="chart"?$e(e,"numbers","Numbers",Qu(e,n),{color:fe.text,icon:"text",summary:Zu(e,n),...P.length>0?{reset:()=>e.update(y=>{for(let k of Tt(y,i))Je(y,k.payload.id)})}:{}}):f}
    ...
    ${n.kind==="tap"?f:$e(e,"tappable","Tap",ep(e,n,r),{color:ee.tap,icon:"tap",summary:w?je(w.payload.action):"Not tappable",...w?{reset:()=>e.update(y=>ii(y,i))}:{}})}
    ${$e(e,"states","States",Tl(e,n.payload.rules,n.kind,y=>y.elements.find(k=>k.payload.id===i)?.payload.rules,`rules-${i}`,S),{color:ee.states,icon:"states",summary:Hn(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>o(y=>{y.payload.rules=[]})}:{}})}
    ${$e(e,"placement","Place",p`
      ...
      <div class="hint">On the ${Z(t)} shape only. Arrow keys nudge 1 pt, shift for 10,
        and the eye on the layer's row hides it.</div>`,{color:ee.place,icon:"place",summary:`${Math.round(l.width*100)}% wide \xB7 ${Z(t)}`,...V?{resetTitle:`Put this layer back to the middle of the ${Z(t)} face at half size, unrotated and shown`,reset:()=>e.update(y=>Fe(y,t,i,{frame:{...Ke},isHidden:!1}))}:{}})}`}var ju=["timestamp","timestampCorner","timestampSize"],qu={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Yu={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function wl(e,n,t,i){let a=n.action;return p`
    ${Te("Tap action",a.type,Tu,r=>t(o=>{o.action=ul(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?tt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?pl(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?ml(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var Xu=24;function Ju(e,n){let t=[],i=1/0;for(let r of te){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Eo(e.config,n,r);o&&(t.push(`${Z(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<Xu;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function Zu(e,n){let t=Tt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Vt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Qu(e,n){let t=ye(e),i=Tt(e.config,n.payload.id),a=o=>e.update(s=>{vo(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    ${a?p`<div class="value-editor">
        ...
        ${Ju(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${je(o)}</b>.</div>`}`}function Ys(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Me(e,n){switch(e.kind){case"text":return Ys(ge(e.payload.value,n));case"icon":return Ys(ge(e.payload.symbol,n));case"gauge":return ge(e.payload.value,n);case"chart":return ge(e.payload.value,n);case"timeline":return ge(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function xl(e,n){let t=Ye(e.config,n.id),i=ye(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return $e(e,"content","Group",p`
    ...
    </div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function kl(e,n){if(n==="inline")return tp(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${Z(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Z(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=Li(e.config,n),r=t.backgroundColorHex?Ce(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ce(t.borderColorHex)} border`:"no border";return p`
    ${$e(e,"look",`${Z(n)} shape`,p`
    ...
    ${n==="corner"?$e(e,"corner","Corner content",np(e,t,i),{color:ee.place,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${$e(e,"states","Shape states",Tl(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:ee.states,icon:"states",summary:Hn(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${$e(e,"content","Inline text",p`
      ...
      ${n.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:f}`,{color:fe.text,icon:"text",summary:ft(`${n.label?`${n.label}: `:""}${ge(n.value,i)}`,48)})}
    ${$e(e,"symbol","Symbol",p`
      ${rl(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:fe.icon,icon:"icon",summary:n.symbol||"None"})}`}function np(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ${ie("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=R("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ie("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=R("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:R("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(u=>Hi(u,t,t-1))}>${_("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(u=>Hi(u,t,t+1))}>${_("down")}</button>
      <button class="icon danger" title="Delete rule" @click=${()=>r(u=>{let h=u.findIndex(m=>m.id===n.id);h>=0&&u.splice(h,1)})}>${_("delete")}</button>
    </div>
    <div class="branches">
    ...
    ${n.otherwise?p`<div class="case-box otherwise">
          ...
          ${Cl(e,n.otherwise,a,u=>c(h=>{h.otherwise&&u(h.otherwise)}),`${o}-otherwise`)}
        </div>`:f}
    ...
    <div class="rule-head">
      ...
      <button class="icon danger" title="Delete case" @click=${()=>r(d=>{let c=d.cases.findIndex(u=>u.id===n.id);c>=0&&d.cases.splice(c,1)})}>${_("delete")}</button>
    </div>
    <div class="row-inline">
      ${ie("When",n.when.join,[["all","All of these are true"],["any","Any of these is true"]],d=>s(c=>{c.when.join=d}))}
    </div>
    ...
    ${Cl(e,n.then,a,d=>s(c=>d(c.then)),`${o}-then`)}
        ...
        ${oe(e,s.upper??R(""),u=>o(h=>{h.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=p`${he("Pattern",s.pattern??"",u=>o(h=>{h.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!hp(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"options":c=he("Options (comma separated)",(s.options??[]).join(", "),u=>o(h=>{h.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${Te("Comparison",s.kind,Ao.map(u=>[u,en[u]]),u=>o(h=>{h.comparison=Fa(h.comparison,u)}))}
    ${c}
  </div>`}function hp(e){try{return new RegExp(e),!0}catch{return!1}}function Cl(e,n,t,i,a){let r=rp(t);return p`
    ...
    </select>`}var Sl=["setColor","setBorderColor","setBackgroundColor"];function mp(e,n,t,i,a,r,o){let s=!ri[i].includes(Se[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${El(e,n,a,o)}
  </div>`}function El(e,n,t,i){let a=oi(n.kind),r=f;if(a==="value"){let o=n.value??R("");if(Sl.includes(n.kind)){let s=o.kind.kind==="literal";r=p`${s?re("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=R(l??"#FFFFFF")},"color")):oe(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
        ...
        ${s?f:p`<div class="hint">The value must resolve to a hex colour such as <code>#FF9F0A</code>. Empty or invalid results leave the colour unchanged.</div>`}`}else r=oe(e,o,s=>t(l=>{l.value=s},"value"),{noFormat:n.kind==="setIcon",symbol:n.kind==="setIcon",showResolved:!0,label:n.kind==="setIcon"?"Symbol":"To",key:`${i}-value`})}else if(a==="number"){let o=n.kind==="setOpacity"?{step:.05,min:0,max:1}:n.kind==="setRotation"?{step:1}:{step:.5,min:0};r=ne(n.kind==="setOpacity"?"Opacity (0 to 1)":n.kind==="setRotation"?"Degrees":n.kind==="setFontSize"?"Points":"Value",n.number??0,s=>t(l=>{l.number=s??0},"number"),o)}else a==="weight"&&(r=ie("Weight",n.weight??"regular",or,o=>t(s=>{s.weight=o})));return r}var ir=new Set,Ti=new Map,Fi=new Map,Xs=new Map;function Tl(e,n,t,i,a,r){let o=ja(n);return!o.ok||ir.has(a)?p`
      ...
      ${dp(e,n,t,i,a)}`:fp(e,o.table,n[0],t,i,a,r)}function fp(e,n,t,i,a,r,o){let s=(x,F)=>e.update(V=>{let P=a(V);P&&x(P)},F?`${r}-${F}`:void 0),l=n.value??Xs.get(r)??o,d=n.rows.length===0,c=n.numberMode||d&&l!==void 0&&!Ss(l)&&gp(e.resolve(l)),u=ri[i],h=Ti.get(r)??new Set,m=n.columns.length===0&&h.size===0?[Cs[i]]:[],g=fs(n.columns,[...h,...m.filter(x=>x!==void 0)],u),v=t?e.liveBranch(t):"none",$=t?e.forced.get(t.id)??"live":"live",S=x=>$!=="live"&&($==="otherwise"?x==="otherwise":$.caseId===x),E=x=>{t&&e.setForced(t.id,S(x)?"live":x==="otherwise"?"otherwise":{caseId:x})},w=x=>{Xs.set(r,x),n.rows.length!==0&&s(F=>xs(F,x),"lhs")},C=()=>s(x=>vs(x,l??R(""),c)),N=n.rows.map((x,F)=>Zs(e,{key:`${r}-${x.caseId}`,label:$s(x.comparison,V=>ge(V,ye(e))),columns:g,changes:x.changes,live:v===x.caseId,forced:S(x.caseId),onForce:()=>E(x.caseId),when:xp(e,x.comparison,`${r}-${x.caseId}`,(V,P)=>s(ce=>{let y=ce[0]?.cases.find(k=>k.id===x.caseId)?.when.tests[0];y&&V(y.comparison)},P&&`${x.caseId}-${P}`)),updChanges:(V,P)=>s(ce=>{let y=ce[0]?.cases.find(k=>k.id===x.caseId);y&&V(y.then)},P&&`${x.caseId}-${P}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${F===0} @click=${()=>s(V=>qa(V,F,F-1))}>${_("up")}</button>
      <button class="icon" title="Move down" ?disabled=${F===n.rows.length-1} @click=${()=>s(V=>qa(V,F,F+1))}>${_("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>s(V=>ws(V,x.caseId))}>${_("delete")}</button>`})),B=n.otherwise===void 0?f:Zs(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:v==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(x,F)=>s(V=>{let P=V[0]?.otherwise;P&&x(P)},F),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(x=>Ya(x,!1))}>${_("close")}</button>`}),q=Fi.get(r),de=yp.filter(x=>u.includes(x)&&!g.includes(x));return p`
    <div class="states">
      ${oe(e,l??R(""),w,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ...
      <table class="states-table">
        <thead>
          <tr>
            ...
            ${g.map(x=>p`<th>
              <span>${et[x]}</span>
              <button class="icon" title=${`Remove the ${et[x]} column`}
                @click=${F=>{Fi.set(r,x),Ie(F.target)}}>${_("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${q===void 0?f:p`<div class="hint warn confirm-row">
        Remove the ${et[q]} column? Its ${Js(n,q)} value${Js(n,q)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${x=>{Fi.delete(r),Ti.get(r)?.delete(q),Ie(x.target),s(F=>ks(F,q))}}>Remove</button>
        <button class="small" @click=${x=>{Fi.delete(r),Ie(x.target)}}>Cancel</button>
      </div>`}
      <div class="states-foot">
        <button class="small" @click=${C}>+ state</button>
        ${n.otherwise===void 0?p`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>s(x=>Ya(x,!0))}>+ otherwise</button>`:f}
        <span class="spacer"></span>
        ${$==="live"?f:p`<button class="small" @click=${()=>t&&e.setForced(t.id,"live")}>Back to live</button>`}
        ${de.length===0?f:p`<select class="chip-add" title="Add a column" @change=${x=>{let F=x.target,V=F.value;if(F.value="",!V)return;let P=Ti.get(r)??new Set;P.add(V),Ti.set(r,P),Ie(F)}}>
          <option value="" selected>+ column…</option>
          ${de.map(x=>p`<option value=${x}>${et[x]}</option>`)}
        </select>`}
      </div>
  ...
  </tr>`}function vp(e,n,t,i,a){let r=wi(t,n),o=rr(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${et[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Mt(ms[n]))}),$u(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let h=u.find(m=>Se[m.kind]===n);h&&d(h)},c&&`${n}-${c}`),l=et[n];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${wp(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${ll}>
      ...
      ${zn.has(o)?p`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):El(e,r,s,a)}
    ...
    </div>`}function wp(e,n){if(n.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return p`<span class="cell-word">Shown</span>`;let t=oi(n.kind);if(t==="number")return p`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return p`<span class="cell-word">${or.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??R(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Sl.includes(n.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ce(a):ge(i,ye(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??f}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${ge(i,ye(e))}</span>`}function Ce(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function xp(e,n,t,i){let a=Ft(n.kind),r=Wa(n.kind),o=(s,l,d,c)=>$p(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${we(s=>i(l=>{let d=Fa(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
    ...
    :host {
      ...
      --wa-text: ${ue(fe.text)};
      --wa-icon: ${ue(fe.icon)};
      --wa-gauge: ${ue(fe.gauge)};
      --wa-shape: ${ue(fe.shape)};
      --wa-image: ${ue(fe.image)};
      --wa-tap: ${ue(fe.tap)};
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let t=window.localStorage.getItem(Bl);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=mr(i.left)),typeof i.right=="number"&&(this.colRight=mr(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Bl,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Vl);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Vl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>yl(s,o,i))}>Copy the ${Z(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(t){this.mutate(i=>ts(i,t)),this.activeFamily=t,this.inspect={kind:"family"}}removeShape(t){let i=this.draft?.config;if(!i||!fi(i,t))return;let a=is(i,t);a.length>0&&!window.confirm(`Remove the ${Z(t)} shape? This deletes ${a.join(", ")}. They are on this shape only, so nothing else in the complication loses anything.`)||(this.mutate(r=>ns(r,t)),this.ensureActiveFamily())}createNew(t){this.newShapeChooser=!1,this.startNew(ko("New complication",this.freeSlot(),[t]))}setForced(t,i){let a=new Map(this.forced);i==="live"?a.delete(t):a.set(t,i),this.forced=a}async save(t=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!t&&!this.draft.dirty)){if(!t&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(t){let o=this.freeSlot();if(o<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let s=structuredClone(i.config);s.id=J(),s.slotIndex=o,i=new At(s,null)}let a=i.encoded(),r=await zr(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id,this.draft=At.fromDocument(r.record.document,r.record.revision),this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=wt(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let t=await Nr(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!t.ok){t.error==="conflict"?this.conflict={current:t.current??null,message:t.message??"This complication changed on the server."}:this.saveError=t.message??t.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(t){this.saveError=wt(t)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let t=structuredClone(this.draft.config);t.id=J(),t.name=`${t.name} copy`,t.slotIndex=this.freeSlot(),this.startNew(t)}reloadFromServer(){let t=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,t&&!t.deleted?this.openRecord(t):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(t=>t.owner_watch_id===this.ownerId)}async moveAll(){let t=this.ownerId,i=this.moveTarget;if(!(!t||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await Pr(this.hass,t,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=wt(a)}finally{this.moving=!1}}}scheduleTemplates(t){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},t),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},qp)}async refreshHistorySeries(){let t=this.draft?.config,i=t?la(t):[];if(i.length===0){this.historySeries.size>0&&(this.historySeries=new Map);return}let a={};for(let r of i)a[r.key]={entity_id:r.entityId,minutes:r.minutes,points:r.points,...r.mode==="states"?{mode:"states"}:{}};try{let r=await Vr(this.hass,a),o=new Map;for(let[s,l]of Object.entries(r))l.ok&&o.set(s,l.series);this.historySeries=o}catch{}}async refreshTemplates(){this.refreshHistorySeries();let t=this.compiled?.document;if(!t){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await Dr(this.hass,{doc:t})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=Po(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=wt(i)}}entityStateFor(t,i,a){let r=this.hass.states[t];if(!r)return;let o=r.attributes,s=t.split(".")[0]??"",l={entityId:t,state:(a?this.testValues.get(t):void 0)??r.state,unitOfMeasurement:typeof o.unit_of_measurement=="string"?o.unit_of_measurement:void 0,iconName:i,domain:s};if(s==="timer"){l.timerState=r.state,typeof o.finishes_at=="string"&&(l.finishesAt=o.finishes_at);let d=ah(o.remaining);d!==void 0&&(l.remaining=d)}return typeof o.entity_picture=="string"&&(l.entityPicture=o.entity_picture),l}buildContext(){let t=new Map;for(let[i,a]of this.compiled?.entities??[]){let r=this.entityStateFor(i,a.iconName??"",!0);r&&t.set(i,r)}return{entityStates:t,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:this.draft?.config.values??[],dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3}}renderPickButton(){let t=this.picking,i=!this.draft||this.parseError!==void 0;return p`<button class="pick ${t?"on":""}" ?disabled=${i}
      ...
      ${a("all","All",t.length)}
      ${It.map(r=>a(r,Z(r),t.filter(o=>i(o).includes(r)).length))}
      ...
      <button class="new-btn" ?disabled=${i} aria-haspopup="dialog" aria-expanded=${this.newShapeChooser?"true":"false"}
        ...
        @click=${()=>this.toggleNewChooser()}>${_("plus")}<span>New</span></button>
      ...
      ${this.newShapeChooser&&!i?p`<div class="new-shape" role="dialog" aria-label="New complication">
        ...
        <div class="adders">
          ${It.map(a=>p`<button class="small ${a==="rectangular"?"primary":""}" @click=${()=>{this.toggleNewChooser(!1),this.createNew(a)}}>${Z(a)}</button>`)}
        </div>
      </div>`:f}
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Kl(a)}</option>`)}
              </select>
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Ba.map(s=>p`<button class="add" style=${`--k:${fe[s]}`} ?disabled=${i} title=${`Add a blank ${Qt[s].toLowerCase()} layer`}
              @click=${()=>{let l=Ne(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?p`<span class="well">${Ts(s)}</span>`:f}<span class="add-name">${r?_(s):p`<span class="k"></span>`}<span>${Qt[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Me(x,d)}</b>
          <small><span class="kind">${Qt[x.kind]}</span> · ${sh(x,c,this.historySeries,y.size)}</small>
          ${C?p`<span class="facts">${rh(this.host(),a,x,y).map(O=>p`<span class="fact"><b>${O.label}</b> ${O.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${Y?p`<span class="badge tap" title=${`Tappable \xB7 ${Me(Y,d)}`}>tap</span>`:f}
            ${x.payload.rules.length===0?f:p`<span class="badge states" title=${G}>${G.replace(/\.$/,"").toLowerCase()}</span>`}
            ${k?p`<span class="badge">hidden</span>`:f}
          </span>
          ${i?p`<span class="acts">
            <button class="icon" title=${`Bring forward (${vt}])`} aria-label="Bring forward" @click=${O=>{O.stopPropagation(),r(P,1)}}>${_("up")}</button>
            <button class="icon" title=${`Send back (${vt}[)`} aria-label="Send back" @click=${O=>{O.stopPropagation(),r(P,-1)}}>${_("down")}</button>
            <button class="icon" title=${`${y.isHidden?"Show":"Hide"} (${fr}${vt}H)`} aria-label=${y.isHidden?"Show this layer":"Hide this layer"} @click=${O=>{O.stopPropagation(),this.mutate(se=>Fe(se,a,P,{isHidden:!y.isHidden}))}}>${_(y.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${vt}D)`} aria-label="Duplicate" @click=${O=>{O.stopPropagation(),o(P)}}>${_("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${O=>{O.stopPropagation(),s(P)}}>${_("delete")}</button>
          </span>`:f}
        </span>
      </div>`},B=(x,F)=>{let V=this.inspect.kind==="group"&&this.inspect.id===x.id,P=!this.collapsed.has(x.id),ce=this.rowDrag(x.id,i),y=F[0],k=F[F.length-1],Y=L=>{let D=L.currentTarget,O=D.getBoundingClientRect(),se=O.top+(D.classList.contains("drop-before")?it:0),rn=O.bottom-(D.classList.contains("drop-after")?it:0),xe=(L.clientY-se)/Math.max(1,rn-se);return xe<.25?"drop-before":!P&&xe>.75?"drop-after":"drop-into"},G=F.map(L=>L.payload.id);return p`<div class="layer group ${V?"hl":""} ${C?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${ce.draggable}
        @pointerenter=${()=>{this.listHoverIds=G}}
        @pointerleave=${()=>this.leaveRow(G)}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:x.id}}}
        @keydown=${L=>{L.key==="Enter"&&(this.inspect={kind:"group",id:x.id})}}
        @dragstart=${ce.onStart} @dragend=${ce.onEnd}
        @dragover=${L=>{!this.dragId||this.dragId===x.id||(L.preventDefault(),this.markDrop(L.currentTarget,Y(L)))}}
        @drop=${L=>{L.preventDefault();let D=Y(L);this.clearDragMarks();let O=this.dragId;if(this.dragId=void 0,!(!O||!y||!k)){if(D==="drop-before"){this.reorderLayer(O,y.payload.id,!0,!0);return}if(D==="drop-after"){this.reorderLayer(O,k.payload.id,!1,!0);return}this.isGroupId(O)||(this.reorderLayer(O,y.payload.id,!0),this.mutate(se=>va(se,O,x.id)))}}}>
        <span class="grip" title="Drag to reorder the whole group.">${_("grip")}</span>
        <span class="bar"></span>
        <span class="folder">${_("folder")}</span>
        <span class="name">
          <b>${x.name}</b>
          <small><span class="kind">Group</span> · ${F.length} layer${F.length===1?"":"s"} · ${x.locked?"locked":"unlocked"}</small>
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${F.map(L=>Me(L,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${fr}${vt}G)`} aria-label="Ungroup" @click=${L=>{L.stopPropagation(),this.mutate(D=>Tn(D,x.id)),V&&(this.inspect={kind:"general"})}}>${_("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${x.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${L=>{L.stopPropagation(),this.mutate(D=>{let O=D.groups?.find(se=>se.id===x.id);O&&(O.locked=!O.locked)})}}>${_(x.locked?"lock":"unlock")}</button>
      ...
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${_("layers")}</span>Layers
        ...
        <span class="tool-set">
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([x,F])=>p`
              <button class=${this.layerDetail===x?"on":""} title=${F} aria-label=${F} aria-pressed=${this.layerDetail===x?"true":"false"}
                @click=${()=>{this.layerDetail=x,this.saveListView()}}>${_(x)}</button>`)}
          </span>
          <span class="seg" role="group" aria-label="Preview size">
            ${Qp.map((x,F)=>p`
              <button class=${this.thumbStep===F?"on":""} title=${`${Dl[F]} row pictures`}
                aria-label=${`${Dl[F]} row pictures`} aria-pressed=${this.thumbStep===F?"true":"false"}
                @click=${()=>{this.thumbStep=F,this.saveListView()}}>${x}</button>`)}
          </span>
        </span>
      </h2>
      ...
      <div class="layer pinned ${h?"hl":""}" style=${`--k:${ee.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${x=>{x.preventDefault(),this.clearDragMarks();let F=this.dragId,V=[...l].reverse().find(P=>P.payload.id!==F&&P.payload.groupId!==F);F&&V&&this.reorderLayer(F,V.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?Il(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:p`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${tt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},_l,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Ll(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=li(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`
      ${this.renderComplicationBar()}
      <div class="card canvas-card">
        <div class="canvas-bar">
          ${this.renderShapeTabs(t,i)}
          <span class="spacer"></span>
          <span class="inbox" title=${`Layouts are made in the ${Jt.label} box. Smaller cases scale it down.`}>
    ...
    </div>`}renderSharedValues(t){let i=t.values,a=new Qe(this.buildContext(),this.draft?.config),r=ye(this.host());return p`<div class="card tint-values values-list" style=${`--c:${ee.complication}`}>
      <h2 class="panel-title"><span class="swatch">${_("content")}</span>Shared values
        ...
        <span class="spacer"></span>
        ${this.canEdit?p`<button class="small" @click=${()=>{let o=gl();this.mutate(s=>{s.values.push(o)}),this.inspect={kind:"data",id:o.id}}}>Add</button>`:f}
      </h2>
      ...
      ${i.map(o=>{let s=a.resolve({kind:{kind:"named",id:o.id}}),l=this.inspect.kind==="data"&&this.inspect.id===o.id;return p`<div class="datum vrow ${l?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:o.id}}}>
          ...
          ${this.canEdit?p`<button class="icon danger" title="Delete value" aria-label="Delete value" @click=${d=>{d.stopPropagation(),this.mutate(c=>{c.values=c.values.filter(u=>u.id!==o.id)}),l&&(this.inspect={kind:"general"})}}>${_("delete")}</button>`:f}
        </div>`})}
      </div>`}
    </div>`}openRaw(){this.showRaw=!0;let t=this.renderRoot.querySelector("details.foot");t&&(t.open=!0),this.updateComplete.then(()=>this.renderRoot.querySelector("pre")?.scrollIntoView({block:"nearest"}))}renderShapeTabs(t,i){let a=t.supportedFamilies;return It.map(r=>{if(!a.includes(r))return p`<button class="tab off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${Z(r)} shape`} @click=${()=>this.addShape(r)}>
          ${_("plus")}${Z(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?mi(c,{icons:this.icons,imageSizes:this.imageSizes,slot:Jt.slots[r]}):f}let l=r!=="inline"&&Li(t,r)===0&&t.elements.length>0,d=this.canEdit&&fi(t,r);return p`<span class="tab-wrap">
    ...
    </div>`}commitTestValue(t,i){this.editingValue=void 0;let a=i.trim(),r=new Map(this.testValues),o=this.hass.states[t]?.state;a===""||a===o?r.delete(t):r.set(t,a),this.testValues=r}currentCase(){return An.find(t=>t.label===this.previewCase)??Jt}previewSlot(t){return this.currentCase().slots[t]}crumbs(t,i){let a=this.inspect,r=t.name.trim()||"Complication",o=this.activeFamily==="inline"?"Inline":Z(this.activeFamily),s=a.kind==="family"&&i===void 0?p`<span class="here" style=${`--k:${ee.place}`}>${o} shape</span>`:p`<button @click=${()=>{this.inspect={kind:"family"}}} title="Edit the shape">${o}</button>`,l=f,d=f;if(i!==void 0)l=p`<span class="here" style="--k:var(--wa-accent)"><span class="kchip">Picked</span>${i} layers</span>`;else if(a.kind==="layer"){let c=t.elements.find(u=>u.payload.id===a.id);if(c){l=p`<span class="here" style=${`--k:${fe[c.kind]}`}><span class="kchip">${Qt[c.kind]}</span>${Me(c,ye(this.host()))}</span>`;let u=qe(t,c.payload.id);u&&(d=p`<span class="sep">›</span><button @click=${()=>{this.inspect={kind:"group",id:u.id}}} title="Edit the group">${u.name}</button>`)}}else if(a.kind==="group"){let c=t.groups?.find(u=>u.id===a.id);c&&(l=p`<span class="here" style=${`--k:${ee.group}`}><span class="kchip">Group</span>${c.name}</span>`)}else if(a.kind==="data"){let c=t.values.find(u=>u.id===a.id);c&&(l=p`<span class="here" style=${`--k:${ee.complication}`}><span class="kchip">Value</span>${c.name||"(unnamed)"}</span>`)}else a.kind==="general"&&(l=p`<span class="mini">nothing selected</span>`);return p`<div class="crumbs">
      ...
      ${l===f?f:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=f,s=!0;if(r.kind==="layer"){let d=t.elements.find(c=>c.payload.id===r.id);if(!d)return this.inspect={kind:"general"},f;o=vl(a,d,this.canvasFamily)}else if(r.kind==="group"){let d=t.groups?.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=xl(a,d)}else if(r.kind==="data"){let d=t.values.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${ee.complication}`}>
      ...
      </div>`}else r.kind==="family"?o=kl(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${_("layers")}<b>Nothing selected</b>
      ...
      <span>${t}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:f}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=ye(this.host()),o=new Qe(this.buildContext(),this.draft?.config),s=bl(t,a,i),l=i.length,d=[...i].reverse(),c=h=>this.mutate(m=>{for(let g of i)Fe(m,a,g.payload.id,{isHidden:h})}),u=h=>this.mutate(m=>{for(let g of i){let v=m.elements.find($=>$.payload.id===g.payload.id);v&&v.kind!=="image"&&v.kind!=="tap"&&v.kind!=="timeline"&&(v.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
      <div class="sec" data-open="true" style="--c:var(--wa-accent)">
        ...
        <div class="sec-b">
          <div class="picked">
            ${d.map(h=>p`<div class="row" style=${`--k:${fe[h.kind]}`}>
              <span class="bar"></span>
              <span class="name">
      ...
      </div>`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=us({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return p`<details class="foot">
      <summary>
    ...
    </details>`}};H([Dt({attribute:!1})],I.prototype,"hass",2),H([Dt({type:Boolean})],I.prototype,"narrow",2),H([Dt({attribute:!1})],I.prototype,"panel",2),H([z()],I.prototype,"colLeft",2),H([z()],I.prototype,"colRight",2),H([z()],I.prototype,"panelWidth",2),H([z()],I.prototype,"owners",2),H([z()],I.prototype,"ownerId",2),H([z()],I.prototype,"records",2),H([z()],I.prototype,"selectedId",2),H([z()],I.prototype,"draft",2),H([z()],I.prototype,"readOnlyReason",2),H([z()],I.prototype,"parseError",2),H([z()],I.prototype,"maxSchemaVersion",2),H([z()],I.prototype,"presets",2),H([z()],I.prototype,"occupied",2),H([z()],I.prototype,"serverToken",2),H([z()],I.prototype,"appliedToken",2),H([z()],I.prototype,"polling",2),H([z()],I.prototype,"sendPending",2),H([z()],I.prototype,"pages",2),H([z()],I.prototype,"templateResults",2),H([z()],I.prototype,"historySeries",2),H([z()],I.prototype,"templateError",2),H([z()],I.prototype,"templateFetchedAt",2),H([z()],I.prototype,"forced",2),H([z()],I.prototype,"showRaw",2),H([z()],I.prototype,"inspect",2),H([z()],I.prototype,"openSections",2),H([z()],I.prototype,"pickerOpen",2),H([z()],I.prototype,"pickerFilter",2),H([z()],I.prototype,"testValues",2),H([z()],I.prototype,"editingValue",2),H([z()],I.prototype,"thumbStep",2),H([z()],I.prototype,"layerDetail",2),H([z()],I.prototype,"addOpen",2),H([z()],I.prototype,"addDetail",2),H([z()],I.prototype,"multi",2),H([z()],I.prototype,"collapsed",2),H([z()],I.prototype,"activeFamily",2),H([z()],I.prototype,"picking",2),H([z()],I.prototype,"pickHoverId",2),H([z()],I.prototype,"listHoverIds",2),H([z()],I.prototype,"zoomed",2),H([z()],I.prototype,"helpOpen",2),H([z()],I.prototype,"showTaps",2),H([z()],I.prototype,"timestampActiveId",2),H([z()],I.prototype,"savedName",2),H([z()],I.prototype,"presetKind",2),H([z()],I.prototype,"presetEntity",2),H([z()],I.prototype,"newShapeChooser",2),H([z()],I.prototype,"previewCase",2),H([z()],I.prototype,"loadError",2),H([z()],I.prototype,"saveError",2),H([z()],I.prototype,"saving",2),H([z()],I.prototype,"conflict",2),H([z()],I.prototype,"remoteRevision",2),H([z()],I.prototype,"confirmDelete",2),H([z()],I.prototype,"moveTarget",2),H([z()],I.prototype,"moving",2),H([z()],I.prototype,"moveError",2),H([z()],I.prototype,"version",2);var gr=I;function wt(e){return String(e?.message??e)}function ah(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Kl(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function rh(e,n,t,i){let a=[{label:"Shows",value:sr(e,t)}],r=Ai(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function oh(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function sh(e,n,t,i){let a=r=>p`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return p`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"gauge":return p`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=Et(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Rn(o).length} values`}case"timeline":{let r=pt(e.payload),o=r===void 0?[]:In(t.get(r)??""),s=Math.max(0,o.length-1);return`${oh(Pe(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ce(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return je(e.payload.action)}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",gr);export{gr as WristAssistantPanel,Ul as columnFit,rh as layerFacts};
