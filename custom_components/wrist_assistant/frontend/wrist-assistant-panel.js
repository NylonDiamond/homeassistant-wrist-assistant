...
`)}function _r(e){let t;try{t=JSON.parse(e)}catch{return}if(typeof t!="object"||t===null||Array.isArray(t))return;let n=new Map,i=new Set;for(let[r,a]of Object.entries(t))a===null?i.add(r):n.set(r,os(a));return{values:n,nullKeys:i}}function os(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Qn(e){let t=Zn(e),n=[...t.entities.entries()].sort(([i],[r])=>i<r?-1:i>r?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return t.document&&n.push({kind:"template",value:t.document}),n}function Xt(e){let t=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(t))return Number(t);let n=t.toLowerCase();if(n==="inf"||n==="+inf"||n==="infinity"||n==="+infinity")return 1/0;if(n==="-inf"||n==="-infinity")return-1/0;if(n==="nan"||n==="+nan"||n==="-nan")return NaN}function nt(e){let t=e.trim(),n=Xt(t);if(n!==void 0)return n;let i="";for(let a of t)if(/\p{N}/u.test(a)||a==="."||a==="-"||a==="+")i+=a;else if(i.length>0)break;return i.length===0?void 0:Xt(i)}function ss(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ls(e){let t=Math.max(0,e);return t<60?`${Math.trunc(t)}s`:t<3600?`${Math.trunc(t/60)}m`:t<86400?`${Math.trunc(t/3600)}h`:`${Math.trunc(t/86400)}d`}function ds(e){return e.replace(/\S+/g,t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase())}function cs(e,t,n){if($e(t))return e;let i=t,r=e,a=Xt(e.trim());if(i.relativeTime&&a!==void 0)r=ls(a);else{let o=nt(e);if(o!==void 0){let l=o*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?r=l.toFixed(Math.max(0,i.decimals)):l!==o&&(r=Number.isInteger(l)?String(l):ss(l))}}switch(i.useEntityUnit&&n&&(r+=n.startsWith("\xB0")||n.startsWith("%")?n:` ${n}`),i.prefix&&(r=i.prefix+r),i.suffix&&(r=r+i.suffix),i.textCase){case"upper":r=r.toUpperCase();break;case"lower":r=r.toLowerCase();break;case"capitalized":r=ds(r);break}return r}function it(e){let t=Math.trunc(Math.max(0,e)),n=Math.trunc(t/3600),i=Math.trunc(t%3600/60),r=t%60,a=o=>String(o).padStart(2,"0");return n>0?`${n}:${a(i)}:${a(r)}`:`${i}:${a(r)}`}function ps(e,t,n){if(e===void 0)return 0;let i=nt(e);if(i===void 0||Number.isNaN(i))return 0;let r=n-t;return r===0?0:Math.min(1,Math.max(0,(i-t)/r))}var Fe=class{constructor(t){this.ctx=t;this.named=new Map(t.namedValues.map(n=>[n.id.toUpperCase(),n.value]))}dereference(t){let n=t,i=new Set,r=t.format;for(;n.kind.kind==="named";){let o=n.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let l=this.named.get(o);if(!l)return;r=r&&!$e(r)?r:l.format,n=l}let a={kind:n.kind};return r&&(a.format=r),a}directEntityUnit(t){let n=t.kind;if(n.kind==="entityState"||n.kind==="entityAttribute"||n.kind==="entityAge")return this.ctx.entityStates.get(n.entityId)?.unitOfMeasurement}resolve(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i;switch(n.kind.kind){case"literal":i=n.kind.value;break;case"entityState":i=this.ctx.entityStates.get(n.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;default:{let r=Xn(t,this.named);i=r===void 0?void 0:this.ctx.templateResults.get(r)}}if(i!==void 0)return cs(i,n.format,this.directEntityUnit(n))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i=n.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let l=Date.parse(o.finishesAt);return Number.isFinite(l)&&l>this.nowMs()?l:void 0}}let r=this.resolve(t)?.trim();if(!r)return;let a=Date.parse(r);if(!Number.isFinite(a)){let o=Xt(r);a=o===void 0?NaN:o*1e3}return Number.isFinite(a)&&a>this.nowMs()?a:void 0}countdownFallbackText(t){if(!t)return;let n=this.dereference(t);if(!n||n.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(n.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?it(i.remaining):"Paused":"Idle"}entityIcon(t){let n=this.dereference(t);return!n||n.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(n.kind.entityId)?.iconName??n.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(t){let n=t.comparison;if(n.kind==="isStale")return this.isStale();let i=this.resolve(t.value);if(i===void 0)return n.kind==="isUnavailable";let r=nt(i),a=()=>this.resolve(n.value),o=()=>{let s=a();return s===void 0?void 0:nt(s)},l=s=>{let d=o();return r===void 0||d===void 0?!1:s(r,d)};switch(n.kind){case"equals":{let s=a();return s!==void 0&&i===s}case"notEquals":{let s=a();return s!==void 0&&i!==s}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let s=i.toLowerCase();return s==="unavailable"||s==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return l((s,d)=>s>d);case"greaterOrEqual":return l((s,d)=>s>=d);case"lessThan":return l((s,d)=>s<d);case"lessOrEqual":return l((s,d)=>s<=d);case"between":{let s=o(),d=this.resolve(n.upper),c=d===void 0?void 0:nt(d);if(r===void 0||s===void 0||c===void 0)return!1;let[p,h]=s<=c?[s,c]:[c,s];return r>=p&&r<=h}case"contains":{let s=a();return!!s&&i.toLowerCase().includes(s.toLowerCase())}case"startsWith":{let s=a();return!!s&&i.toLowerCase().startsWith(s.toLowerCase())}case"endsWith":{let s=a();return!!s&&i.toLowerCase().endsWith(s.toLowerCase())}case"matchesRegex":{if(!n.pattern)return!1;try{return new RegExp(n.pattern).test(i)}catch{return!1}}case"isOneOf":return(n.options??[]).some(s=>s.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(t){return t.tests.length===0?!0:t.join==="any"?t.tests.some(n=>this.evaluateTest(n)):t.tests.every(n=>this.evaluateTest(n))}applyRules(t,n){let i=new Map;for(let r of t){let a=n?.get(r.id),o=[];if(a&&a!=="live")a==="otherwise"?o=r.otherwise??[]:o=r.cases.find(l=>l.id===a.caseId)?.then??[];else{let l=r.cases.find(s=>this.evaluateCondition(s.when));o=l?l.then:r.otherwise??[]}for(let l of o)i.set(le[l.kind],l)}return i}liveBranches(t){let n=new Map;for(let i of t){let r=i.cases.find(a=>this.evaluateCondition(a.when));n.set(i.id,r?r.id:i.otherwise?"otherwise":"none")}return n}styleColor(t,n){let i=t.get(n);if(!i)return;let r=this.resolve(i.value);return r||void 0}styleText(t,n){let i=t.get(n);return i?this.resolve(i.value):void 0}styleNumber(t,n){return t.get(n)?.number}resolveElement(t,n){let i=t.payload,r=this.applyRules(i.rules,n),a=r.get("visibility"),o=a?a.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),s=l===void 0?i.frame:{...i.frame,rotationDegrees:l},d=this.styleNumber(r,"opacity")??1,c={id:i.id,isHidden:o,frame:s,opacity:d};switch(t.kind){case"text":{let p=t.payload.countdown?this.countdownEnd(t.payload.value):void 0,h=t.payload.countdown?this.countdownFallbackText(t.payload.value):void 0,y={kind:"text",...c,text:this.styleText(r,"text")??h??this.resolve(t.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??t.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??t.payload.fontWeight,colorHex:this.styleColor(r,"color")??t.payload.colorSlot.baseColorHex};return p!==void 0&&(y.countdownEnd=p),y}case"icon":{let p=this.entityIcon(t.payload.symbol)??this.resolve(t.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(r,"icon")??p,size:this.styleNumber(r,"fontSize")??t.payload.size,colorHex:this.styleColor(r,"color")??t.payload.colorSlot.baseColorHex}}case"gauge":{let p=this.styleText(r,"gaugeValue")??this.resolve(t.payload.value),h=this.styleNumber(r,"gaugeMin")??t.payload.minValue,y=this.styleNumber(r,"gaugeMax")??t.payload.maxValue;return{kind:"gauge",...c,fraction:ps(p,h,y),style:t.payload.style,lineWidth:t.payload.lineWidth,colorHex:this.styleColor(r,"color")??t.payload.colorSlot.baseColorHex,trackColorHex:t.payload.trackColorHex}}case"shape":{let p={kind:"shape",...c,shapeKind:t.payload.kind,cornerRadius:t.payload.cornerRadius,fillColorHex:this.styleColor(r,"color")??t.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??t.payload.borderWidth},h=this.styleColor(r,"borderColor")??t.payload.borderColorHex;return h!==void 0&&(p.borderColorHex=h),p}case"image":{let p={kind:"image",...c,entityId:t.payload.entity.entityId,showTimestamp:t.payload.timestamp===!0,contentMode:t.payload.contentMode,zoom:t.payload.zoom,panX:t.payload.panX,panY:t.payload.panY,cornerRadius:t.payload.cornerRadius,timestampCorner:t.payload.timestampCorner,timestampSize:t.payload.timestampSize};Ee(t.payload)&&(p.timestampX=t.payload.timestampX,p.timestampY=t.payload.timestampY);let h=this.ctx.entityStates.get(t.payload.entity.entityId)?.entityPicture;return h!==void 0&&(p.url=h),p}case"tap":{let p={kind:"tap",...c,frame:t.payload.frame,opacity:1,action:t.payload.action};return t.payload.openPageId!==void 0&&(p.openPageId=t.payload.openPageId),t.payload.attachedTo!==void 0&&(p.attachedTo=t.payload.attachedTo),p}}}resolveLayout(t,n,i){let r=t.perFamily[n],a=$r(t,n).map(w=>this.resolveElement(w,i)),o=r?this.applyRules(r.rules,i):new Map,l={family:n,elements:a,cornerBodyShape:r?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??r?.borderWidth??2},s=this.styleText(o,"text"),d=r?.bezelCountdown&&s===void 0?this.countdownEnd(r.bezelText):void 0,c=r?.bezelCountdown?this.countdownFallbackText(r.bezelText):void 0,p=s??c??this.resolve(r?.bezelText);p!==void 0&&(l.bezelText=p),d!==void 0&&(l.bezelCountdownEnd=d);let h=this.resolve(r?.curvedText);if(h!==void 0&&(l.curvedText=h),r?.curvedColorHex!==void 0&&(l.curvedColorHex=r.curvedColorHex),r?.bezelGauge){let w=r.bezelGauge,x=this.resolve(w.value),T=x===void 0?void 0:nt(x);if(T!==void 0){let $=Math.min(w.minValue,w.maxValue),f=Math.max(w.minValue,w.maxValue),v={value:Math.min(f,Math.max($,T)),minValue:$,maxValue:f===$?$+1:f,colorHexes:w.colorHexes},b=this.resolve(w.minLabel);b!==void 0&&(v.minLabel=b);let F=this.resolve(w.maxLabel);F!==void 0&&(v.maxLabel=F),l.bezelGauge=v}}let y=this.styleColor(o,"backgroundColor")??r?.backgroundColorHex;y!==void 0&&(l.backgroundColorHex=y);let g=this.styleColor(o,"borderColor")??r?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function us(e,t){let n=new Fe(t),i=e.countdown?n.countdownEnd(e.value):void 0,a={text:(e.countdown?n.countdownFallbackText(e.value):void 0)??n.resolve(e.value)??"--"};return e.label&&(a.label=e.label),e.symbol&&(a.symbol=e.symbol),i!==void 0&&(a.countdownEnd=i),a}function ei(e,t,n){let i=new Fe(t),r={};for(let a of["rectangular","circular","corner"])e.supportedFamilies.includes(a)&&(r[a]=i.resolveLayout(e,a,n));return e.supportedFamilies.includes("inline")&&e.inline&&(r.inline=us(e.inline,t)),r}var re=ge,Tt=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:re,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Ft=Tt.find(e=>e.measured);function Ur(e){if(!e)return;let t=/^(\d+)x(\d+)$/.exec(e.trim());if(!t)return;let n=Number(t[1]),i=Number(t[2]);return Tt.find(r=>r.screen.width===n&&r.screen.height===i)}function Qt(e,t){let n=re[t];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/n.width,e.height/n.height),r=n.width*i,a=n.height*i;return{scale:i,x:(e.width-r)/2,y:(e.height-a)/2,width:r,height:a}}var hs={regular:400,medium:500,semibold:600,bold:700};function ke(e){if(!e)return;let t=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(t))return;let n=t.length===8?parseInt(t.slice(6,8),16)/255:1;return{color:`#${t.slice(0,6)}`,opacity:n}}function Et(e,t,n="#FFFFFF"){let i=ke(e)??{color:n,opacity:1};return{[t]:i.color,[`${t}-opacity`]:i.opacity}}function Kr(e,t){let n=Math.max(0,e.frame.width*t.width),i=Math.max(0,e.frame.height*t.height),r=(e.frame.x+e.frame.width/2)*t.width,a=(e.frame.y+e.frame.height/2)*t.height;return{x:r-n/2,y:a-i/2,w:n,h:i,cx:r,cy:a}}function ms(e,t){let n=Et(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:it((e.countdownEnd-Date.now())/1e3)});let i=s=>s*.55,r=e.text.length*i(e.fontSize),a=r>t.w&&t.w>0?Math.max(.5,t.w/r):1,o=e.fontSize*a,l=e.text;if(t.w>0&&l.length*i(o)>t.w){let s=t.w-.8*o,d=Math.max(1,Math.floor(s/i(o)));l=`${l.slice(0,d).replace(/\s+$/,"")}\u2026`}return C`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
    ...
    ${e.maxLabel!==void 0?x(`${n}-gmax`,d+w,d+w+Math.max(l,3),e.maxLabel):m}`}function li(e,t){let n=e.family in re?e.family:"rectangular",i=t.slot??re[n],r=re[n],a=Qt(i,n),o=`clip-${n}-${Math.random().toString(36).slice(2,8)}`,l=ke(e.backgroundColorHex),s=ke(e.borderColorHex),d=e.borderWidth*a.scale;if(n==="corner"){let g=a.scale,w=!!e.bezelText||!!e.bezelGauge,x=e.curvedText??"",T=x!=="",$=nn(g,w),f=si(g,w),v=f/(r.width*g),b=$.tile.cx-f/2,F=$.tile.cy-f/2,M=`M 0 0 H ${$.quad.width-$.cornerRadius} A ${$.cornerRadius} ${$.cornerRadius} 0 0 1 ${$.quad.width} ${$.cornerRadius} V ${$.quad.height} H 0 Z`,P=m;if(e.bezelGauge)P=Ts(e.bezelGauge,g,o);else if(e.bezelText){let I=ks(g,`${o}-bezel`),_=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?it((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;P=C`<defs><path id=${I.id} d=${I.d} /></defs>
        <text font-size=${Hr*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${I.id}" startOffset="50%" text-anchor="middle">${Nr(_,I.length,Hr*g)}</textPath></text>`}let k=m;if(T){let I=ke(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},_=jr(g,`${o}-curved`,Cs*g,Ss);k=C`<defs><path id=${_.id} d=${_.d} /></defs>
        <text font-size=${Or*g} font-weight="600" fill=${I.color} fill-opacity=${I.opacity}
          ...
          <textPath href="#${_.id}" startOffset="50%" text-anchor="middle">${Nr(x,_.length,Or*g*.88)}</textPath></text>`}else{let I=e.borderWidth*a.scale*v,_=s?C`<circle cx=${f/2} cy=${f/2} r=${f/2-I/2} fill="none" stroke=${s.color} stroke-opacity=${s.opacity} stroke-width=${I} />`:m;k=C`<g transform="translate(${b} ${F})">
        <g clip-path=${`url(#${o})`}>
    ...
    </div></div>`}function Va(e,t){let n=e[t],i=n&&typeof n.attributes.friendly_name=="string"?n.attributes.friendly_name:t;return{entityId:t,displayName:i,domain:t.split(".")[0]??""}}function Ws(e,t){let n=t===void 0?void 0:typeof t=="string"?[t]:t,i=[];for(let[r,a]of Object.entries(e)){let o=r.split(".")[0]??"";if(n!==void 0&&!n.includes(o))continue;let l=typeof a?.attributes?.friendly_name=="string"?a.attributes.friendly_name.trim():"";i.push({entityId:r,name:l||r,state:a?.state??"",domain:o})}return i.sort((r,a)=>r.name.localeCompare(a.name)||r.entityId.localeCompare(a.entityId)),i}var Da=50;function js(e){let t=e.state.trim().split(/\s+/)[0]??"";return t!==""&&Number.isFinite(Number(t))}function qs(e,t,n=Da,i){let r=t.trim().toLowerCase(),a=s=>i===void 0||i(s)?0:1;if(r==="")return(i===void 0?e.slice():[...e].sort((s,d)=>a(s)-a(d))).slice(0,n);let o=r.split(/\s+/),l=[];for(let s of e){let d=s.entityId.toLowerCase(),c=s.name.toLowerCase(),p=-1;d===r?p=0:d.startsWith(r)?p=1:c.startsWith(r)?p=2:d.includes(r)?p=3:c.includes(r)?p=4:o.length>1&&o.every(h=>d.includes(h)||c.includes(h))&&(p=5),p>=0&&l.push({c:s,rank:p})}return l.sort((s,d)=>s.rank-d.rank||a(s.c)-a(d.c)||s.c.name.localeCompare(d.c.name)||s.c.entityId.localeCompare(d.c.entityId)),l.slice(0,n).map(s=>s.c)}var Ys=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Ba(e){return Ys.test(e.trim())}function Js(e,t,n){let i=e.trim();if(i!==t.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in n)return Va(n,i);if(Ba(i))return{...t,entityId:i,domain:i.split(".")[0]??""}}}var dt=new Map;function Ce(e){let t=e instanceof Node?e:null;for(let n=0;t&&n<8;n+=1){let i=t.getRootNode();if(!(i instanceof ShadowRoot))return;let r=i.host;if(typeof r.requestUpdate=="function"){r.requestUpdate();return}t=r}}function Ga(e){return dt.has(e)}function _e(e,t,n,i,r,a={}){let o=e.hass.states,l=dt.get(r),s=l?qs(Ws(o,a.domain),l.query,Da,a.preferNumeric?js:void 0):[],d=l?Math.max(0,Math.min(l.index,s.length-1)):0,c=n.entityId?o[n.entityId]:void 0,p=($,f,v=0)=>{dt.set(r,{query:f,index:v}),Ce($)},h=$=>{dt.delete(r),Ce($)},y=$=>{let f=Js($,n,o);f&&i(f)},g=($,f)=>{i(Va(o,$.entityId)),h(f)},w=()=>Math.max(0,Math.min(dt.get(r)?.index??0,s.length-1)),x=$=>{let f=$.target;if($.key==="ArrowDown"||$.key==="ArrowUp"){$.preventDefault();let v=dt.get(r);if(!v){p(f,f.value);return}let b=$.key==="ArrowDown"?w()+1:w()-1;p(f,v.query,Math.max(0,Math.min(s.length-1,b))),Xs(f);return}if($.key==="Enter"){$.preventDefault();let v=s[w()];l&&v?g(v,f):(y(f.value),h(f));return}if($.key==="Escape"){if(!l)return;$.preventDefault(),$.stopPropagation(),h(f)}},T=n.entityId===""?u`<div class="hint">Type part of a name, such as "kitchen".</div>`:c?u`<div class="entity-current"><span class="ent-name">${typeof c.attributes.friendly_name=="string"?c.attributes.friendly_name:n.entityId}</span><span class="ent-state">${c.state}</span></div>`:u`<div class="hint warn">Not in Home Assistant right now.</div>`;return u`<div class="field entity-field">
    <span>${t}</span>
    ...
    <span class="sym-name">${t}</span>
      ...
      ${x.length===0?u`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:u`<div class="hint">
            ${nl(T.length,x.length,o.trim()!=="",tl(s))}
          </div>`}
    ...
    ${y}`}var il=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"]],rl=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function al(e,t){let n="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(t){case"literal":return{kind:t,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:t,...n};case"entityAttribute":return{kind:t,...n,attribute:""};case"entityAge":return{kind:t,...n};case"aggregate":return{kind:t,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:t,timeField:"now"};case"dataAge":return{kind:t};case"jinja":return{kind:t,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:t,id:""}}}function Z(e,t,n,i){if(i.inline||!ol())return u`<div class="value-editor">${ja(e,t,n,i)}</div>`;let r=$i(i.key),a=i.label??"Value",o=i.showResolved?e.resolve(t):void 0,l=de(t,ce(e));return u`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${W("Source",r.kind,l,c=>a(al(r,c)))}
    ${s}
    ${i.noFormat?m:cl(t.format,c=>n($e(c)?{kind:t.kind}:{...t,format:c}))}
    ${i.showResolved?u`<div class="hint">Now: ${d===void 0?u`<span class="warn">unresolved</span>`:u`<code>${d}</code>`}</div>`:m}`}function cl(e,t){let n=e??{},i=r=>{let a={...n,...r};for(let o of Object.keys(a))(a[o]===void 0||a[o]===!1||a[o]==="")&&delete a[o];t(a)};return u`<details class="sub" ?open=${!$e(e)}>
  ...
  </details>`}function pl(e,t,n,i){let r=l=>l.join(", "),a=l=>l.split(",").map(s=>s.trim()).filter(Boolean),o=t.scope;return u`
    ...
    ${t.function==="count"?m:ee("Attribute (blank = state)",t.attribute??"",l=>{let s={...t};l?s.attribute=l:delete s.attribute,n(s)})}`}var qa=On,ul=qa.filter(([e])=>e!=="none");function hl(e,t){return e!==void 0&&t.trim()!==""&&t.trim()!==e.trim()}function Ya(e){let t=e.config,n=t.tapAction,i=s=>["toggleEntity","runScene","runScript","addTodo","runHTTPAction"].includes(s),r=hl(e.savedName,t.name),a=t.refreshMinutes??0,o=Aa.map(s=>[String(s),Ma(s)]);Aa.includes(a)||o.push([String(a),Ma(a)]);let l=t.showSuccessFlash??!0;return u`
    <div class="gen-row">
  ...
  ${r?m:u`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function Xa(e,t){let n=e.config.values.findIndex(r=>r.id===t.id),i=`nv-${t.id}`;return u`
    ...
    ${ae(e,"content","Content",u`${t.kind==="tap"?m:vl(e,t,a)}${p}`,{color:x,icon:"content",summary:Cl(e,t)})}
    ${h===void 0&&y===void 0?m:ae(e,"look",t.kind==="image"?"Picture":"Look",u`${h??m}${y??m}`,{color:x,icon:t.kind==="image"?"image":"look",..._a(t)?{summary:_a(t)}:{}})}
    ${t.kind==="image"?ae(e,"timestamp","Timestamp",kl(t.payload,(f,v)=>o(b=>f(b.payload),v)),{color:x,icon:"clock",summary:$?`Shown \xB7 ${t.payload.timestampSize} pt`:"Hidden"}):m}
    ${t.kind==="tap"?m:ae(e,"tappable","Tap",Tl(e,t,a),{color:K.tap,icon:"tap",summary:T?Te(T.payload.action):"Not tappable"})}
    ...
    ${ae(e,"placement","Place",u`
      ...
      ${t.kind==="shape"||t.kind==="image"||t.kind==="tap"?m:j(`${c} in ${O(n)} (blank = shared ${gl(t)})`,l.size,f=>e.update(v=>f===void 0?pe(v,n,i,{},!0):pe(v,n,i,{size:f}),`${a}-psize-${n}`),{step:1,min:1,optional:!0})}
    ...
    ${W("Tap action",r.type,ul,o=>n(l=>{l.action=a(o)?{type:o,..."entityId"in l.action?{entityId:l.action.entityId,displayName:l.action.displayName,domain:l.action.domain}:{entityId:"",displayName:"",domain:""}}:{type:o},o!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
    ${"entityId"in r?_e(e,"Target",r,o=>n(l=>{l.action={type:r.type,...o}},"tap-entity"),`${i}-tap`):m}
    ${r.type==="openPage"?Ja(e,t.openPageId,t.openPageName,(o,l)=>n(s=>{if(o===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=o,l?s.openPageName=l:delete s.openPageName},"tap-page")):m}`}var Sl=24;function El(e,t){let n=[],i=1/0;for(let a of X){if(a==="inline"||!e.config.supportedFamilies.includes(a))continue;let o=Sr(e.config,t,a);o&&(n.push(`${O(a)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(n.length===0)return m;let r=i<Sl;return u`<div class=${r?"hint warn":"hint"}>${n.join(" \xB7 ")}${r?u`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Tl(e,t,n){if(t.kind==="tap")return m;let i=t.payload.id,r=ye(e.config,i)[0],a=(l,s)=>e.update(d=>{let c=d.elements.find(p=>p.kind==="tap"&&p.payload.attachedTo===i);c&&l(c.payload)},s?`${n}-${s}`:void 0),o=Un(e.config,t);return u`
    ...
    </div>`,{color:K.group,icon:"folder",summary:`${n.length} layers \xB7 ${t.locked?"moves as one":"unlocked"}`})}function io(e,t){if(t==="inline")return u`${Fl(e)}${bi(e,t)}`;let n=e.config.perFamily[t];if(!n)return u`<div class="hint">No settings stored for ${O(t)} yet.</div>
    ...
    ${t==="corner"?ae(e,"corner","Corner content",Rl(e,n,i),{color:K.place,icon:"content",summary:n.curvedText?"Big curved text":"Layer canvas"}):m}
    ...
    ${n?u`<div class="hint">This is the only shape. Add another before removing it.</div>`:u`<div class="hint">The watch stops listing this complication for ${O(t)} slots.</div>`}`,{color:K.place,icon:"delete",summary:n?"The only shape":"Drops its layout"})}function Fl(e){let t=e.config.inline;if(!t)return u`<div class="hint">This complication lists Inline but has no Inline text yet (it was saved by an older integration). The watch shows "No inline layout" until one is added.</div>
    ...
    ${ae(e,"symbol","Symbol",u`
      ...
      <div class="hint">On the face: ${t.symbol?`${t.symbol} `:""}${t.label?`${t.label}: `:""}${e.resolve(t.value)??"--"}</div>`,{color:Q.icon,icon:"icon",summary:t.symbol||"None"})}`}function Rl(e,t,n){let i=t.curvedText?"curved":"canvas",r=t.bezelGauge?"gauge":t.bezelText?"text":"none";return u`
    ...
    ${r==="gauge"&&t.bezelGauge?Il(e,t.bezelGauge,n):m}`}function Il(e,t,n){let i=[t.colorHexes[0]??"#34C759",t.colorHexes[1]??t.colorHexes[t.colorHexes.length-1]??"#FFCC00",t.colorHexes[t.colorHexes.length-1]??"#FF3B30"],r=a=>o=>n(l=>{let s=[...i];s[a]=o??s[a],l.bezelGauge.colorHexes=s},`gstop${a}`);return u`
    ...
    ${t.cases.map((p,h)=>Ol(e,p,h,t,r,c,`${o}-${p.id}`))}
  ...
  </div>`}function Ol(e,t,n,i,r,a,o){let l=(d,c)=>a(p=>{let h=p.cases.find(y=>y.id===t.id);h&&d(h)},c),s=e.liveBranch(i)===t.id;return u`<div class="case-box ${s?"match":""}">
    <div class="rule-head">
    ...
    ${c}
  </div>`}function Dl(e){try{return new RegExp(e),!0}catch{return!1}}function ro(e,t,n,i,r){let a=Ml(n);return u`
    ${t.length===0?u`<div class="hint">No changes.</div>`:m}
    ${t.map((o,l)=>Bl(e,o,l,n,(s,d)=>i(c=>{c[l]&&s(c[l])},d?`${r}-${l}-${d}`:void 0),()=>i(s=>{s.splice(l,1)}),`${r}-${l}`))}
    <select class="adder" @change=${o=>{let l=o.target,s=l.value;l.value="",s&&i(d=>{d.push(je(s))})}}>
      <option value="">+ change…</option>
      ${a.map(o=>u`<option value=${o}>${Ci[o]}</option>`)}
    </select>`}var ao=["setColor","setBorderColor","setBackgroundColor"];function Bl(e,t,n,i,r,a,o){let l=!Yt[i].includes(le[t.kind]);return u`<div class="change-box">
    <div class="rule-head">
    ...
    ${oo(e,t,r,o)}
      ...
      ${Pl(e,t,n,i,r)}`:Gl(e,o.table,t[0],n,i,r,a)}function Gl(e,t,n,i,r,a,o){let l=(k,I)=>e.update(_=>{let D=r(_);D&&k(D)},I?`${a}-${I}`:void 0),s=t.value??Pa.get(a)??o,d=t.rows.length===0,c=t.numberMode||d&&s!==void 0&&!$a(s)&&Ul(e.resolve(s)),p=Yt[i],h=hn.get(a)??new Set,y=t.columns.length===0&&h.size===0?[wa[i]]:[],g=ua(t.columns,[...h,...y.filter(k=>k!==void 0)],p),w=n?e.liveBranch(n):"none",x=n?e.forced.get(n.id)??"live":"live",T=k=>x!=="live"&&(x==="otherwise"?k==="otherwise":x.caseId===k),$=k=>{n&&e.setForced(n.id,T(k)?"live":k==="otherwise"?"otherwise":{caseId:k})},f=k=>{Pa.set(a,k),t.rows.length!==0&&l(I=>va(I,k),"lhs")},v=()=>l(k=>ga(k,s??E(""),c)),b=t.rows.map((k,I)=>Oa(e,{key:`${a}-${k.caseId}`,label:xa(k.comparison,_=>de(_,ce(e))),columns:g,changes:k.changes,live:w===k.caseId,forced:T(k.caseId),onForce:()=>$(k.caseId),when:Yl(e,k.comparison,`${a}-${k.caseId}`,(_,D)=>l(Y=>{let z=Y[0]?.cases.find(N=>N.id===k.caseId)?.when.tests[0];z&&_(z.comparison)},D&&`${k.caseId}-${D}`)),updChanges:(_,D)=>l(Y=>{let z=Y[0]?.cases.find(N=>N.id===k.caseId);z&&_(z.then)},D&&`${k.caseId}-${D}`),acts:u`
      <button class="icon" title="Move up" ?disabled=${I===0} @click=${()=>l(_=>mi(_,I,I-1))}>${H("up")}</button>
      <button class="icon" title="Move down" ?disabled=${I===t.rows.length-1} @click=${()=>l(_=>mi(_,I,I+1))}>${H("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(_=>ya(_,k.caseId))}>${H("delete")}</button>`})),F=t.otherwise===void 0?m:Oa(e,{key:`${a}-otherwise`,label:"Otherwise",columns:g,changes:t.otherwise,live:w==="otherwise",forced:T("otherwise"),onForce:()=>$("otherwise"),when:u`<span class="when-otherwise">Otherwise</span>`,updChanges:(k,I)=>l(_=>{let D=_[0]?.otherwise;D&&k(D)},I),acts:u`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(k=>fi(k,!1))}>${H("close")}</button>`}),M=mn.get(a),P=Kl.filter(k=>p.includes(k)&&!g.includes(k));return u`
    <div class="states">
      ...
      <div class="states-foot">
        ...
        ${P.length===0?m:u`<select class="chip-add" title="Add a column" @change=${k=>{let I=k.target,_=I.value;if(I.value="",!_)return;let D=hn.get(a)??new Set;D.add(_),hn.set(a,D),Ce(I)}}>
  ...
  </tr>`}function jl(e,t,n,i,r){let a=ln(n,t),o=$i(r);if(!a)return u`<button type="button" class="cell empty" title=${`Set ${Re[t]} for this state`}
      @click=${d=>{i(c=>{c.push(je(pa[t]))}),ll(d.target,o)}}>unchanged</button>`;let l=(d,c)=>i(p=>{let h=p.find(y=>le[y.kind]===t);h&&d(h)},c&&`${t}-${c}`),s=Re[t];return u`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${s}. Click to change it.`}>${ql(e,a)}</button>
    ...
    </div>`}function ql(e,t){if(t.kind==="hide")return u`<span class="cell-word">Hidden</span>`;if(t.kind==="show")return u`<span class="cell-word">Shown</span>`;let n=Jt(t.kind);if(n==="number")return u`<span class="cell-word mono">${t.number??0}</span>`;if(n==="weight")return u`<span class="cell-word">${ki.find(([a])=>a===(t.weight??"regular"))?.[1]}</span>`;let i=t.value??E(""),r=i.kind.kind==="literal"?i.kind.value:void 0;if(ao.includes(t.kind))return u`<span class="swatch" style=${`background:${r&&/^#[0-9a-fA-F]{6,8}$/.test(r)?r:"transparent"}`}></span>
      <span class="cell-word">${r?be(r):de(i,ce(e))}</span>`;if(t.kind==="setIcon"&&r){let a=e.icons.render(r,16,"#FFFFFF");return u`${a??m}<span class="cell-word">${r}</span>`}return u`<span class="cell-word">${de(i,ce(e))}</span>`}function be(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Yl(e,t,n,i){let r=We(t.kind),a=ui(t.kind),o=(l,s,d,c)=>Xl(e,l,s,`${n}-${d}`,a,c,d==="rhs"?"Compare with":"Upper bound");return u`<span class="when-cell">
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let n=window.localStorage.getItem(bo);if(!n)return;let i=JSON.parse(n);typeof i.left=="number"&&(this.colLeft=Ai(i.left)),typeof i.right=="number"&&(this.colRight=Ai(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(bo,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}renderGutter(n){return u`<div class="gutter ${n}" role="separator" aria-orientation="vertical"
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="right">
          <span class="badges">
            ${_?u`<span class="badge tap" title=${`Tappable \xB7 ${He(_,d)}`}>tap</span>`:m}
      ...
      </div>`},$=(b,F)=>{let M=this.inspect.kind==="group"&&this.inspect.id===b.id,P=!this.collapsed.has(b.id),k=this.rowDrag(b.id,i),I=F[0],_=F[F.length-1],D=["drop-before","drop-into","drop-after"],Y=z=>{let N=z.currentTarget.getBoundingClientRect(),te=(z.clientY-N.top)/N.height;return te<.25?"drop-before":!P&&te>.75?"drop-after":"drop-into"};return u`<div class="layer group ${M?"hl":""}" style=${`--k:${K.group}`} tabindex="0" draggable=${k.draggable}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:b.id}}}
        @keydown=${z=>{z.key==="Enter"&&(this.inspect={kind:"group",id:b.id})}}
        @dragstart=${k.onStart} @dragend=${k.onEnd}
        @dragover=${z=>{if(!this.dragId||this.dragId===b.id)return;z.preventDefault();let N=z.currentTarget,te=Y(z);for(let fe of D)N.classList.toggle(fe,fe===te)}}
        @dragleave=${z=>{z.currentTarget.classList.remove(...D)}}
        @drop=${z=>{z.preventDefault();let N=z.currentTarget,te=Y(z);N.classList.remove(...D);let fe=this.dragId;if(this.dragId=void 0,!(!fe||!I||!_)){if(te==="drop-before"){this.reorderLayer(fe,I.payload.id,!0,!0);return}if(te==="drop-after"){this.reorderLayer(fe,_.payload.id,!1,!0);return}this.isGroupId(fe)||(this.reorderLayer(fe,I.payload.id,!0),this.mutate(ko=>br(ko,fe,b.id)))}}}>
        <button class="chev" aria-expanded=${P?"true":"false"} title=${P?"Fold the group":"Unfold the group"}
          @click=${z=>{z.stopPropagation();let N=new Set(this.collapsed);P?N.add(b.id):N.delete(b.id),this.collapsed=N}}>${H("chevron")}</button>
        <span class="bar"></span>
        ...
        <span class="right">
          ${i?u`<span class="acts">
            <button class="icon" title="Ungroup: keep the layers, drop the folder" aria-label="Ungroup" @click=${z=>{z.stopPropagation(),this.mutate(N=>Kt(N,b.id)),M&&(this.inspect={kind:"general"})}}>${H("ungroup")}</button>
          </span>`:m}
          <button class="icon lockbtn ${b.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${z=>{z.stopPropagation(),this.mutate(N=>{let te=N.groups?.find(fe=>fe.id===b.id);te&&(te.locked=!te.locked)})}}>${H(b.locked?"lock":"unlock")}</button>
        </span>
      ...
      ${n===void 0?m:u`
        ...
        ${_e(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},r=>{this.presetEntity=r.entityId===""?void 0:r},fo,{compact:!0,...n.domains?{domain:n.domains}:{},...n.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
      ...
      <div class="insp-head">
        ${this.crumbs(n)}
        ${l?u`<button class="expand" @click=${()=>{this.openSections=s?new Set([xd(a)]):new Set(wi)}}>${s?"One at a time":"Open all"}</button>`:m}
      </div>
