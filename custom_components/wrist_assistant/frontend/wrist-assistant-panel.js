...
`)}function lu(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Eg(r));return{values:t,nullKeys:i}}function Eg(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Is(e){let n=aa(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Mg(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(qi(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Rg=10800;function Ag(e,n,t){let i=n==="always"||n==="auto"&&t<=Rg;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function kr(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Ag(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Hg(e,n){return bt(e)===void 0?[]:kr(lt(e)*60,Xi(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Fg(e,n){return Ln(e)?kr(Math.round(e.historyMinutes)*60,Xi(ft(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Ig(e,n,t,i){return n===void 0&&i!==void 0?bt(i)===void 0?[]:kr(lt(i)*60,Xi(ft(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!Ln(n)?[]:kr(Math.round(n.historyMinutes)*60,Xi(ft(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Wn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function qe(e){let n=e.trim(),t=Wn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Wn(i)}function Lg(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function _g(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function zg(e){let n=e.trim(),t=Wn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Wn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Wn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Pg(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Ng(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Dg(e,n,t){if(_e(n))return e;let i=n,a=e,r=Wn(e.trim()),o=i.duration?zg(e):void 0;if(o!==void 0)a=Pg(o);else if(i.relativeTime&&r!==void 0)a=_g(r);else{let s=qe(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Lg(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Ng(a);break}return a}function bi(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Ye(e,n=240){return hu(e,n).map(t=>t.value)}function _s(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Ye(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:pu(r)}}function pu(e){return e.some(n=>n)?e:[]}function hu(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function du(e,n,t){let i=hu(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Qt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??pe,c=t.highColorHex??Qe,u=t.lowColorHex??et,p=[],m=(y,b)=>{if(y==="")return;let C=p.at(-1);C&&C.colorHex===b?C.text+=y:p.push({text:y,colorHex:b})},g=0;return i.forEach((y,b)=>{m(e.slice(g,y.start),n);let C=b===o?c:b===s?u:l.length>0?ir(y.value,l,d):n,k=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,k),C),g=k}),m(e.slice(g),n),p}function cu(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Og(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function oa(e,n=an){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Bg(i.slice(a+1))})}return t}function Bg(e){try{return decodeURIComponent(e)}catch{return e}}function Vg(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function uu(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Gg(e,n,t){if(e===void 0)return 0;let i=qe(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var vt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=cu(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=_n(n),i=zn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?_s(a):{values:Ye(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=pu(s),{values:zs(o,ot(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:qe(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=qe(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):cu(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!_e(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Mg(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?pc(r):qi(r,a.domainMax-a.domainMin));break}default:{let a=Fs(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Dg(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Wn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?bi(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=qe(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:qe(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:qe(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Vn(d),p=c===void 0?void 0:Vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(De[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=du(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=st(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(sc(n.payload)&&(y.spans=du(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let C={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(C.path=y),C}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(M,A,H)=>M??(A?qe(this.resolve(A)??""):void 0)??H,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),C=m===void 0?void 0:qe(m),k=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&C!==void 0&&(k=ir(C,Qt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let M=qe(this.resolve(p.total)??"");M!==void 0&&(w=M)}let $=uu(w,1,tr),D={kind:"gauge",...u,fraction:Gg(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:k,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:$,filledCount:uu(C??0,0,$)};if(p.thresholdValue!==void 0&&b!==y){let M=(p.thresholdValue-y)/(b-y);M>=0&&M<=1&&(D.thresholdFraction=M)}return D}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},C=this.styleColor(r,"color")??p.colorSlot.baseColorHex,k=Qt(p),w=ji(p)?g.map(j=>ir(j,k,p.bandAboveColorHex)):[],$=p.highlight==="highest"||p.highlight==="both",D=p.highlight==="lowest"||p.highlight==="both",M=Oi(p),A={kind:"chart",...u,values:g,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:C,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:$?M.high:"none",lowMarker:D?M.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:ot(p.smoothing)??"off",fillStyle:qt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:Yt(p.barRadius),barCorners:Xt(p.barCorners),barBorderWidth:jo(p),barFillColorHexes:[],barBorderColorHexes:[],barBorderOpenBase:jo(p)>0&&p.barBorderOpenBase===!0,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Fg(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},H=y.length===0?g:g.filter((j,G)=>!y[G]);if(H.length>0){let j=_=>g.findIndex((I,R)=>I===_&&y[R]!==!0),G=$?j(Math.max(...H)):-1,X=D?j(Math.min(...H)):-1;G>=0&&(A.highIndex=G),X>=0&&X!==G&&(A.lowIndex=X)}if(p.style==="bars"){let j=g.map((G,X)=>uc(p,G,k,C,X===A.highIndex?p.highColorHex:X===A.lowIndex?p.lowColorHex:void 0));A.barFillColorHexes=j.map(G=>G.fill),A.barBorderWidth>0&&(A.barBorderColorHexes=j.map(G=>G.border))}let T=Og(p,b.min,b.max);T!==void 0&&(A.thresholdY=T);let P=this.chartNowIndex(p,g.length);return P!==void 0&&(A.nowIndex=P),A}case"timeline":{let p=n.payload,m=bt(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=oa(g,an),b=Vg(y,lt(p)*60,k=>xc(k,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:Hg(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};dr(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Ig(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),g={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(g.url=y),g}case"chartDots":{let p=n.payload,m=mt(p.size),g={kind:"chartDots",...u,chart:p.chart,dots:Xa(p.dots),diameter:0,indices:[]};return m!==void 0&&(g.size=m),p.colorHex!==void 0&&(g.colorHex=p.colorHex),g}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:An(p.lines),colorHex:Wt(p.colorHex),thickness:Hn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=he[t==="inline"?"rectangular":t],o=[...Yg(qg(Bc(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,C=this.resolve(b.value),k=C===void 0?void 0:qe(C);if(k!==void 0){let w=Math.min(b.minValue,b.maxValue),$=Math.max(b.minValue,b.maxValue),D={value:Math.min($,Math.max(w,k)),minValue:w,maxValue:$===w?w+1:$,colorHexes:b.colorHexes},M=this.resolve(b.minLabel);M!==void 0&&(D.minLabel=M);let A=this.resolve(b.maxLabel);A!==void 0&&(D.maxLabel=A),l.bezelGauge=D}}let g=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;g!==void 0&&(l.backgroundColorHex=g);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function Ug(e,n,t){let i=new vt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function xi(e,n,t){let i=new vt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Ug(e.inline,n,e)),a}function sa(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Ls=5,Wg=1.7,Kg=1.8;function jg(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function qg(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Kg,l=Math.max(o.frame.width*n.width,0),d=jg(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function mu(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function fu(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function $r(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=A=>A==="triangle"?Ls+d:A==="dot"?Math.max(d,Wg):d,u=c(a),p=c(r),m=n.y+u,g=Math.max(n.h-u-p,1),y=m+g,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),C=e.baseline==="lowest",k=C?g*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),$=Math.max((s-w*(i-1))/i,.5),D=A=>Math.min(1,Math.max(0,(A-e.domainMin)/b)),M=A=>y-D(A)*g;return{count:t.length,barWidth:$,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:C?y:M(0),inset:d,yAtFraction(A){return y-Math.min(Math.max(A,0),1)*g},barRect(A){let H=o+A*($+w),T=t[A],P,j;if(C){let G=k+D(T)*(g-k);P=y-G,j=y}else P=M(T),j=C?y:M(0),P>j&&([P,j]=[j,P]);return{x:H,y:P,w:$,h:Math.max(j-P,.5)}},point(A){let H=Math.max(s-d*2,0);return{x:t.length>1?o+d+H*A/(t.length-1):o+s/2,y:M(t[A])}},markerCenter(A,H,T="high"){let P=H?this.barRect(A):void 0,j=P?P.x+P.w/2:this.point(A).x,G=T==="high"?a:r,X=T==="high"?G==="triangle"?n.y+Ls/2:m:G==="triangle"?n.y+n.h-Ls/2:y;return{x:j,y:X}}}}function gu(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function zs(e,n,t=[]){let i=e.length,a=oc(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,g=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,C=Math.exp(-(b*b)/(2*o*o));m+=e[y]*C,g+=C}return m/g}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function yu(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var ra=1;function Kn(e,n){let t=Math.max(tn,Math.min(nn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-ra>=2,r=a?{...n,y:e.labelsAbove?n.y+i+ra:n.y,h:n.h-i-ra,cy:(e.labelsAbove?n.y+i+ra:n.y)+(n.h-i-ra)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Yg(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&mu(r)===void 0)return{...i,isHidden:!0};let o=Jg(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Xg(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Jg(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=sa(t,i);if(a.w<=0||a.h<=0)return;let r=Kn(t,a).body;if(r.w<=0||r.h<=0)return;let o=$r(t,r),s,l;if(It(n.at)){let C=Xg(n.at,t);if(C===void 0)return;if(t.style==="bars"){let k=o.barRect(C);s=k.x+k.w/2,l=k.y}else{let k=o.point(C);s=k.x,l=k.y}}else{let C=n.at==="zero"?mu(t):t.thresholdY;if(C===void 0)return;l=o.yAtFraction(C)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(C,k,w)=>k>w?(k+w)/2:Math.min(Math.max(C,k),w),m={...e};if(s!==void 0){let C=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(C-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let C=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(C-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var Ps=[.01,.025,.05,.1];function vi(e,n){return!(n.width>0&&n.height>0)||n.width===n.height?{x:e,y:e}:n.width>n.height?{x:e*n.height/n.width,y:e}:{x:e,y:e*n.width/n.height}}function Ns(e){return typeof e=="number"?{x:e,y:e}:e}function Ds(e){return e.x>0&&e.y>0}var bu=1e-6;function la(e,n){return Math.round((e-.5)/n)*n+.5-e}function xu(e,n,t){let a=[e,e+n/2,e+n].map(r=>la(r,t)).reduce((r,o)=>Math.abs(o)<Math.abs(r)?o:r);return ce(e+a)}function Zg(e,n){let t=Ns(n);return Ds(t)?wi({...e,x:xu(e.x,e.width,t.x),y:xu(e.y,e.height,t.y)}):e}function vu(e,n,t,i={x:!0,y:!0}){let a=Ns(t);if(!Ds(a))return e;let{x:r,y:o,width:s,height:l}=e,d=r+s,c=o+l;if(i.x&&n.includes("e")&&(s=Math.max(Ue,ce(d+la(d,a.x)-r))),i.x&&n.includes("w")){let u=Math.min(ce(r+la(r,a.x)),d-Ue);s=ce(d-u),r=ce(u)}if(i.y&&n.includes("s")&&(l=Math.max(Ue,ce(c+la(c,a.y)-o))),i.y&&n.includes("n")){let u=Math.min(ce(o+la(o,a.y)),c-Ue);l=ce(c-u),o=ce(u)}return{...e,x:r,y:o,width:s,height:l}}function Os(e,n,t,i){let a=Ns(i);if(!Ds(a))return e;let r=(o,s,l)=>{if(s===0)return o;let d=(o-.5)/l,c=s>0?Math.floor(d+bu)+1:Math.ceil(d-bu)-1,u=ce(c*l+.5);for(let p=0;p<1e3&&(s>0?u<=o:u>=o);p++)c+=s,u=ce(c*l+.5);return u};return wi({...e,x:r(e.x,Math.sign(n),a.x),y:r(e.y,Math.sign(t),a.y)})}var Ue=.04,Cr=.04;function wu(e,n){let t=()=>{let a=e.getScreenCTM();return a&&a.a!==0&&a.d!==0?{x:a.a,y:a.d}:void 0},i=t()??{x:1,y:1};return a=>(i=t()??i,{x:(a.clientX-n.clientX)/i.x,y:(a.clientY-n.clientY)/i.y})}function Sr(e,n){let t={...e,...n};return wi({...t,x:ce(t.x),y:ce(t.y),width:Math.max(Ue,ce(t.width)),height:Math.max(Ue,ce(t.height))})}function Bs(e,n){let t=n==="down"?e.x:ce((1-e.width)/2),i=n==="across"?e.y:ce((1-e.height)/2);return wi({...e,x:t,y:i})}function ku(e,n){let t=Bs(e,n);return t.x===e.x&&t.y===e.y}function wi(e){let n=Math.min(1-Cr,Math.max(-e.width+Cr,e.x)),t=Math.min(1-Cr,Math.max(-e.height+Cr,e.y));return{...e,x:n,y:t}}var ce=e=>Math.round(e*1e3)/1e3,$u=10;function Tr(e,n,t,i){let a=i.width>0?e.x+n/i.width:e.x,r=i.height>0?e.y+t/i.height:e.y;return wi({...e,x:ce(a),y:ce(r)})}function Qg(e,n,t,i){let a=n.width,r=n.height,o=e.width*a,s=e.height*r,l=Math.min(o,s),d=e.x*a+(o-l)/2,c=e.y*r+(s-l)/2,u=t.includes("e")?1:-1,p=t.includes("s")?1:-1,m=Ue*Math.max(a,r),g=Math.max(m,l+(u*i.x+p*i.y)/2),y=u>0?d:d+l-g,b=p>0?c:c+l-g;return{...e,x:ce(y/a),y:ce(b/r),width:ce(g/a),height:ce(g/r)}}function ey(e,n,t,i,a=!1){let r=n.width,o=n.height;if(a||e.width*r>=e.height*o){let p=a?Ue:Math.max(Ue,e.height*o/r),m=e.x+e.width,g=t.includes("e")?Math.max(p,e.width+i.x/r):Math.max(p,e.width-i.x/r),y=t.includes("e")?e.x:m-g;return{...e,x:ce(y),width:ce(g)}}let l=Math.max(Ue,e.width*r/o),d=e.y+e.height,c=t.includes("s")?Math.max(l,e.height+i.y/o):Math.max(l,e.height-i.y/o),u=t.includes("s")?e.y:d-c;return{...e,y:ce(u),height:ce(c)}}function Er(e,n,t,i,a){let r=wu(e,t),o={...i.handle&&i.outline?i.outline:i.frame},s={...i.frame};e.setPointerCapture(t.pointerId);let l=p=>Math.round(p*1e3)/1e3,d=p=>{if(p.pointerId!==t.pointerId)return;let m=r(p),g=m.x/n.width,y=m.y/n.height,b,C=i.snap!==void 0&&i.snap.on!==p.altKey?i.snap.step:void 0;if(!i.handle)b=wi({...o,x:l(o.x+g),y:l(o.y+y)}),C!==void 0&&(b=Zg(b,C));else if(i.square)b=Qg(o,n,i.handle,m);else if(i.line||i.bar){if(b=ey(o,n,i.handle,m,i.bar===!0),C!==void 0){let k=i.bar===!0||b.width*n.width>=b.height*n.height;b=vu(b,i.handle,C,{x:k,y:!k})}}else{let{x:k,y:w,width:$,height:D}=o,M=o.x+o.width,A=o.y+o.height;i.handle.includes("e")&&($=Math.max(Ue,o.width+g)),i.handle.includes("s")&&(D=Math.max(Ue,o.height+y)),i.handle.includes("w")&&($=Math.max(Ue,o.width-g),k=M-$),i.handle.includes("n")&&(D=Math.max(Ue,o.height-y),w=A-D),b={...o,x:l(k),y:l(w),width:l($),height:l(D)},C!==void 0&&(b=vu(b,i.handle,C))}s=b,a.onFrame(i.elementId,b,!1)},c=p=>{p.pointerId===t.pointerId&&(u(),a.onFrame(i.elementId,s,!0))},u=()=>{e.removeEventListener("pointermove",d),e.removeEventListener("pointerup",c),e.removeEventListener("pointercancel",c);try{e.releasePointerCapture(t.pointerId)}catch{}};return e.addEventListener("pointermove",d),e.addEventListener("pointerup",c),e.addEventListener("pointercancel",c),u}function Cu(e,n,t,i,a){let r=wu(e,n),o=1;e.setPointerCapture(n.pointerId);let s=c=>{if(c.pointerId!==n.pointerId)return;let u=r(c),p=u.x*(t.includes("e")?1:-1),m=u.y*(t.includes("s")?1:-1),g=i.w>0?(i.w+p)/i.w:1,y=i.h>0?(i.h+m)/i.h:1,b=Math.abs(g-1)>=Math.abs(y-1)?g:y;o=Math.max(.05,b),a(o,!1)},l=c=>{c.pointerId===n.pointerId&&(d(),a(o,!0))},d=()=>{e.removeEventListener("pointermove",s),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l);try{e.releasePointerCapture(n.pointerId)}catch{}};return e.addEventListener("pointermove",s),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),d}var ze=he,ca=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ze,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],ki=ca.find(e=>e.measured);function Pu(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return ca.find(a=>a.screen.width===t&&a.screen.height===i)}function Ar(e,n){let t=ze[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Xs=[{label:"Orange",hex:"#FF9F0A"},{label:"Red",hex:"#FF453A"},{label:"Green",hex:"#30D158"},{label:"Blue",hex:"#0A84FF"},{label:"Purple",hex:"#BF5AF2"},{label:"White",hex:"#FFFFFF"}];function ty(e){switch(e){case"text":case"imageTime":case"tap":return"plain";case"image":return"picture";default:return"accent"}}function ny(e,n){let t=We(n)??{color:"#FFFFFF",opacity:1},i=l=>(parseInt(t.color.slice(1+l*2,3+l*2),16)/255).toFixed(4),[a,r,o]=e==="plain"?["1","1","1"]:[i(0),i(1),i(2)];return`0 0 0 0 ${a} 0 0 0 0 ${r} 0 0 0 0 ${o} ${e==="picture"?"0.2126 0.7152 0.0722 0 0":"0 0 0 1 0"}`}function iy(e,n){return v`${["accent","plain","picture"].map(i=>v`<filter id=${`${e}-${i}`} filterUnits="userSpaceOnUse" x="-10000" y="-10000" width="20000" height="20000"
    ...
    fill=${b.fill} fill-opacity=${b["fill-opacity"]}>${C}</text>`}function uy(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:cy(e,e.parts,n);let t=ge(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:bi((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?ay(e.text,n.w/Nt(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*Nt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>ry(y,o,n.w)),{anchor:l,x:d}=Du(e.alignment,n),c=oy(e.text,e.spans),u=c?Ou(e.text,i):[],p=(y,b)=>c?Bu(y,u[b]??0,e.text,c,e.colorHex).map(C=>{let k=ge(C.look,"fill");return v`<tspan fill=${k.fill} fill-opacity=${k["fill-opacity"]}>${C.text}</tspan>`}):y,m=o*1.15,g=s.length>1?v`${s.map((y,b)=>v`<tspan x=${d} y=${n.cy+(b-(s.length-1)/2)*m}>${p(y,b)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Us[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var Ws=2;function Gu(e,n){let t=n.w>=n.h,i=Math.max(1,e.dotCount),a=t?n.w:n.h,r=t?n.h:n.w,o=Math.max(1,Math.min(r,a/i-Ws)),s=i*o+(i-1)*Ws;return{horizontal:t,count:i,d:o,span:s}}function py(e,n){let t=ge(e.colorHex,"stroke"),i=ge(e.trackColorHex,"stroke","#FFFFFF"),a=ge(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let{horizontal:m,count:g,d:y,span:b}=Gu(e,n),C=(m?n.cx:n.cy)-b/2+y/2;return v`${Array.from({length:g},(k,w)=>{let $=C+w*(y+Ws),D=w<e.filledCount?t:i;return v`<circle cx=${m?$:n.cx} cy=${m?n.cy:$} r=${y/2}
        fill=${D.stroke} fill-opacity=${D["stroke-opacity"]} />`})}`}if(e.style==="bar"){let m=n.w,g=Math.max(r,m*e.fraction),y=1;return v`
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:hy(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function hy(e,n,t,i,a){let r=ge(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function my(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Kn(e,n),o=r?Js(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=gy(e,a);return o===void 0?s:v`${s}${o}`}function Vs(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var Tu=0;function Uu(){return Tu+=1,Tu.toString(36)}function Mr(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);if(s===0)return`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`;if(s>o){let l=Math.sqrt(o*(2*s-o)),d=i+s-l,c=i+r-s+l;return t?`M${d} ${a} L${c} ${a} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${d} ${a} Z`:`M${d} ${a+o} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${c} ${a+o} Z`}return t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function fy(e,n,t,i){let a=n.x,r=n.x+n.w;if(i){let l=e.y,d=n.y+n.h;return t===0?`M${a} ${l} L${a} ${d} L${r} ${d} L${r} ${l}`:`M${a} ${l} L${a} ${d-t} A${t} ${t} 0 0 0 ${a+t} ${d} L${r-t} ${d} A${t} ${t} 0 0 0 ${r} ${d-t} L${r} ${l}`}let o=e.y+e.h,s=n.y;return t===0?`M${a} ${o} L${a} ${s} L${r} ${s} L${r} ${o}`:`M${a} ${o} L${a} ${s+t} A${t} ${t} 0 0 1 ${a+t} ${s} L${r-t} ${s} A${t} ${t} 0 0 1 ${r} ${s+t} L${r} ${o}`}function gy(e,n){let t=$r(e,n),i=Uu(),a=ge(e.colorHex,"fill"),r=ge(e.highColorHex,"fill",e.colorHex),o=ge(e.lowColorHex,"fill",e.colorHex),s=(g,y)=>v`<circle cx=${g.x} cy=${g.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=g=>c?ge(e.pointColorHexes[g],"fill",e.colorHex):a,p=g=>{let y=We(g)??We(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:y.color,opacity:y.opacity*.28};let b=yy(i,e.id,g),C=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(b)||d.set(b,v`<linearGradient id=${b} gradientUnits="userSpaceOnUse" x1="0" y1=${C} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${y.color} stop-opacity=${y.opacity*.28} />
        <stop offset="1" stop-color=${y.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${b})`,opacity:1}};if(e.style==="bars")for(let g=0;g<t.count;g++){if(e.holes[g]===!0)continue;let y=t.barRect(g),b=e.barFillColorHexes.length===t.count?e.barFillColorHexes[g]:void 0,C=b!==void 0?ge(b,"fill",e.colorHex):g===e.highIndex?r:g===e.lowIndex?o:u(g),k=e.barCorners==="top"?Math.min(Math.max(e.barRadius,0),y.w/2):Math.min(Math.max(e.barRadius,0),y.w/2,y.h/2),w=e.baseline==="zero"&&e.values[g]<0,$=e.barCorners==="top"&&w,D=e.barBorderWidth>0&&e.barBorderColorHexes.length===t.count?e.barBorderColorHexes[g]:void 0,M=e.barBorderWidth,A=D!==void 0&&(y.w<=2*M||y.h<=2*M),H=A?ge(D,"fill",e.colorHex):C;if(e.barCorners==="top"?l.push(v`<path d=${Mr(y,k,$)}
          fill=${H.fill} fill-opacity=${H["fill-opacity"]} />`):l.push(v`<rect x=${y.x} y=${y.y} width=${y.w} height=${y.h} rx=${k}
          fill=${H.fill} fill-opacity=${H["fill-opacity"]} />`),D!==void 0&&!A){let T=ge(D,"fill",e.colorHex),P={x:y.x+M/2,y:y.y+M/2,w:y.w-M,h:y.h-M},j=e.barCorners==="top"?Math.min(Math.max(k-M/2,0),P.w/2):Math.min(Math.max(k-M/2,0),P.w/2,P.h/2);if(e.barBorderOpenBase){let X=`${i}bb${g}`,_=e.barCorners==="top"?v`<path d=${Mr(y,k,$)} />`:v`<rect x=${y.x} y=${y.y} width=${y.w} height=${y.h} rx=${k} />`;d.set(X,v`<clipPath id=${X}>${_}</clipPath>`),l.push(v`<path d=${fy(y,P,j,w)} fill="none" stroke=${T.fill} stroke-opacity=${T["fill-opacity"]} stroke-width=${M} clip-path=${`url(#${X})`} />`);continue}let G=e.barCorners==="top"?Mr(P,j,$):Mr(P,0,!1);e.barCorners==="top"||j===0?l.push(v`<path d=${G} fill="none" stroke=${T.fill} stroke-opacity=${T["fill-opacity"]} stroke-width=${M} />`):l.push(v`<rect x=${P.x} y=${P.y} width=${P.w} height=${P.h} rx=${j}
            fill="none" stroke=${T.fill} stroke-opacity=${T["fill-opacity"]} stroke-width=${M} />`)}}else{let g=Array.from({length:t.count},(k,w)=>t.point(w)),y=e.holes.length>0,C=yu(t.count,e.holes).filter(k=>!y||k.length>1).map(k=>{let w=k.map(M=>g[M]),$=gu(w,e.curve),D=`M${w[0].x} ${w[0].y}${$.map(M=>` ${Vs(M)}`).join("")}`;return{run:k,pts:w,legs:$,line:D}});if(e.style==="area")for(let{run:k,pts:w,legs:$,line:D}of C)if(e.fillBands&&c&&k.length>1&&e.fillColorHex===void 0)for(let M=0;M<$.length;M++){let A=w[M],H=w[M+1],T=p(e.pointColorHexes[k[M+1]]),P=`M${A.x} ${A.y} ${Vs($[M])} L${H.x} ${t.baselineY} L${A.x} ${t.baselineY} Z`;l.push(v`<path d=${P} fill=${T.fill} fill-opacity=${T.opacity} stroke="none" />`)}else{let M=p(e.fillColorHex??e.colorHex),A=`${D} L${w[w.length-1].x} ${t.baselineY} L${w[0].x} ${t.baselineY} Z`;l.push(v`<path d=${A} fill=${M.fill} fill-opacity=${M.opacity} stroke="none" />`)}for(let{run:k,pts:w,legs:$,line:D}of C)if(c&&k.length>1)for(let M=0;M<$.length;M++){let A=w[M],H=u(k[M+1]);l.push(v`<path d=${`M${A.x} ${A.y} ${Vs($[M])}`} fill="none"
          ...
          stroke-width=${e.lineWidth} stroke-linecap="round" stroke-linejoin="round" />`);e.highIndex!==void 0&&l.push(s(g[e.highIndex],r)),e.lowIndex!==void 0&&l.push(s(g[e.lowIndex],o))}let m=(g,y,b,C)=>{if(g===void 0||y==="none")return;let k=t.markerCenter(g,e.style==="bars",C);l.push(y==="triangle"?v`<path d=${`M${k.x} ${k.y-1.8} L${k.x+2.2} ${k.y+1.8} L${k.x-2.2} ${k.y+1.8} Z`}
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        stroke-width="1" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" pointer-events="none" />`):f}`}function Eu(e){let n=Math.min(e.w,e.h);return{x:e.cx-n/2,y:e.cy-n/2,w:n,h:n,cx:e.cx,cy:e.cy}}var da=4;function ky(e,n){let t=e.w>=e.h,i=t?e.h:e.w,a=Math.min(i,Math.max(da,Math.max(0,n)));return t?{x:e.x,y:e.cy-a/2,w:e.w,h:a,cx:e.cx,cy:e.cy}:{x:e.cx-a/2,y:e.y,w:a,h:e.h,cx:e.cx,cy:e.cy}}function Ku(e,n){if(e.kind==="shape")return e.shapeKind==="circle"?Eu(n):e.shapeKind==="line"?ky(n,e.thickness):n;if(e.kind==="icon"){let t=Math.max(da,Zs(e));return{x:n.cx-t/2,y:n.cy-t/2,w:t,h:t,cx:n.cx,cy:n.cy}}if(e.kind==="chartTimes"){if(e.labels.length===0||n.w<=0||n.h<=0)return n;let{rowHeight:t}=Kn({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),i=Math.max(da,t);return{x:n.x,y:n.cy-i/2,w:n.w,h:i,cx:n.cx,cy:n.cy}}if(e.kind==="imageTime"){let t=ps(n.w,n.h);if(!e.linked||t<=0)return n;let i=el(new Date).length*t*.578+t*.89,a=t*1.25;return{x:n.cx-i/2,y:n.cy-a/2,w:i,h:a,cx:n.cx,cy:n.cy}}if(e.kind!=="gauge")return n;switch(e.style){case"ring":case"arc":return Eu(n);case"bar":{let t=Math.max(da,e.lineWidth);return{x:n.x,y:n.cy-t/2,w:n.w,h:t,cx:n.cx,cy:n.cy}}case"dots":{let{horizontal:t,d:i,span:a}=Gu(e,n),r=Math.max(da,i);return t?{x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,cx:n.cx,cy:n.cy}:{x:n.cx-r/2,y:n.cy-a/2,w:r,h:a,cx:n.cx,cy:n.cy}}default:return n}}function ju(e,n,t){return e.kind==="shape"?e.shapeKind==="circle"?{square:!0}:e.shapeKind==="line"?{line:!0}:{}:e.kind==="chartTimes"?{bar:!0}:e.kind==="imageTime"?Mu(e,n,t):e.kind!=="gauge"?{}:e.style==="ring"||e.style==="arc"?{square:!0}:e.style==="bar"?{bar:!0}:e.style!=="dots"?{}:Mu(e,n,t)}function Mu(e,n,t){if(t.width<=0||t.height<=0)return{};let i=Ku({...e,frame:n},sa({...e,frame:n},t));return{outline:{...n,x:i.x/t.width,y:i.y/t.height,width:i.w/t.width,height:i.h/t.height}}}function Zs(e){return e.path!==void 0&&e.path!==""?e.size*Nu:e.size}function $y(e,n){let t=ge(e.fillColorHex,"fill"),i=e.borderColorHex?We(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return v`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Cy(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ge(e.colorHex,"fill"),s=e.size*Nu;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Qs=.25,Sy=8;function Ty(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Qs),Sy),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),b=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+b)+0,width:m,height:g}}function el(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Rr=4;function Ey(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Rr:n.x+n.w-Rr-a,d=e.timestampCorner.startsWith("top")?n.y+Rr:n.y+n.h-Rr-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function My(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Ry(e,n,t){let i=t.icons,a=`imgclip-${Uu()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Ey(e,n,el(new Date)):void 0,s=o?qu(o):f,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=Ty(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=v`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(My(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${d}${s}</g>`}function qu(e,n=1){return v`<g opacity=${n}>
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function Ay(e,n){if(!e.linked)return f;let t=el(new Date),i=ps(n.w,n.h);if(i<=0)return f;let a=t.length*i*.578+i*.89,r=i*1.25;return qu({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function Hy(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Fy(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Ks} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var Ks=5;function Fy(e,n){let t=Ks*.55,i=n.w-2;if(n.h<Ks*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Yu(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function js(e,n,t,i=new Map,a){if(e.isHidden&&!t.showHidden)return f;let r=t.tapReview===!0,o=t.tapAreas===!0||r,s=r?t.tapFocusId:void 0,l=s!==void 0&&e.id===s,d=s!==void 0;if(e.kind==="tap"&&!o)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!r||d&&!l))return f;let c=sa(e,n),u=r&&(!d||l),p;switch(e.kind){case"text":p=uy(e,c);break;case"icon":p=Cy(e,c,t.icons);break;case"gauge":p=py(e,c);break;case"chart":p=my(e,c);break;case"timeline":p=by(e,c);break;case"chartTimes":p=xy(e,c);break;case"imageTime":p=Ay(e,c);break;case"chartDots":p=vy(e,c,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":p=wy(e,c,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":p=$y(e,c);break;case"image":p=Ry(e,c,t);break;case"tap":p=Hy(e,c,t.icons,o,u?_t(e.action):void 0);break}e.kind!=="tap"&&(p=jn(p,ty(e.kind),a));let m=r&&(e.kind!=="tap"||d&&!l)?.35:1,g=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*m,y=t.highlightId===e.id,b=y||t.highlightIds?.includes(e.id)===!0,C=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",w=t.handles===!0&&(!d||l)&&!C&&!k,$=Ku(e,c),D=b&&!C?v`<rect x=${$.x} y=${$.y} width=${$.w} height=${$.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,M=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${$.x} y=${$.y} width=${$.w} height=${$.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,A=C?f:v`<rect x=${$.x} y=${$.y} width=${$.w} height=${$.h} fill="transparent" stroke="none" />`,H=3,T=$,P=y&&w?[["nw",T.x,T.y],["ne",T.x+T.w,T.y],["sw",T.x,T.y+T.h],["se",T.x+T.w,T.y+T.h]].map(([j,G,X])=>v`<rect data-handle=${j} x=${G-H/2} y=${X-H/2} width=${H} height=${H}
          fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${j}-resize" />`):f;return v`<g data-element-id=${e.id} opacity=${g} style=${w?"cursor:move":e.kind==="chartDots"?"cursor:pointer":f}
    pointer-events=${e.kind==="chartGrid"?"none":f}
    transform="rotate(${e.frame.rotationDegrees} ${c.cx} ${c.cy})">${A}${p}${M}${D}${P}</g>`}function Hr(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function tl(e,n){return(n?23.5:34)*e}var Ru=10.5;function Xu(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Au(e,n){let t=0;for(let i of e)t+=Xu(i,n);return t}function Hu(e,n,t){let i=e.toUpperCase(),a=d=>Xu(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function qs(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Ys(e,n,t,i){let a=qs(e,n,t),r=qs(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Ju(e,n,t,i){let{dial:a}=Hr(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Ys(a,t,i.start,i.end),length:t*r}}function Iy(e,n){let t=Hr(e,!0);return Ju(e,n,t.dial.r,t.labelArc)}var Fu=18.5,Ly=113,_y={start:-71,end:-36},Iu=104,zy=6.2,Lu={start:-77,end:-30.5};function _u(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function zu(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=_u(e[i]),o=_u(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var Gs=11;function Py(e,n,t){let{dial:i}=Hr(n,!0),a=Iu*n,r=180/(Math.PI*Iu),o=e.minLabel!==void 0?Au(e.minLabel,Gs)*r:0,s=e.maxLabel!==void 0?Au(e.maxLabel,Gs)*r:0,l=Lu.start+(o>0?Math.max(0,o-1.8):0),d=Lu.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let C=0;C<u;C++){let k=l+c*C/u,w=Math.min(d,l+c*(C+1)/u+.4);p.push(v`<path d=${Ys(i,a,k,w)} fill="none"
      stroke=${zu(e.colorHexes,(C+.5)/u)} stroke-width=${zy*n}
      stroke-linecap=${C===0||C===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=qs(i,a,l+c*m),y=1.5,b=(C,k,w,$)=>v`
    <defs><path id=${C} d=${Ys(i,a,k,w)} /></defs>
    <text font-size=${Gs*n} font-weight="600" fill="#FFFFFF"
      font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
      <textPath href="#${C}" startOffset="50%" text-anchor="middle">${$}</textPath></text>`;return v`${p}
    ...
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function Fr(e,n){let t=e.family in ze?e.family:"rectangular",i=n.slot??ze[t],a=ze[t],r=Ar(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=We(e.backgroundColorHex),l=We(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Yu(c),p=n.tint===void 0?void 0:`${o}-tint`,m=p===void 0?f:iy(p,n.tint);if(t==="corner"){let k=r.scale,w=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",D=$!=="",M=Hr(k,w),A=tl(k,w),H=A/(a.width*k),T=M.tile.cx-A/2,P=M.tile.cy-A/2,j=`M 0 0 H ${M.quad.width-M.cornerRadius} A ${M.cornerRadius} ${M.cornerRadius} 0 0 1 ${M.quad.width} ${M.cornerRadius} V ${M.quad.height} H 0 Z`,G=f;if(e.bezelGauge)G=Py(e.bezelGauge,k,o);else if(e.bezelText){let _=Iy(k,`${o}-bezel`),I=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?bi((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;G=v`<defs><path id=${_.id} d=${_.d} /></defs>
        <text font-size=${Ru*k} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${_.id}" startOffset="50%" text-anchor="middle">${Hu(I,_.length,Ru*k)}</textPath></text>`}let X=f;if(D){let _=We(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},I=Ju(k,`${o}-curved`,Ly*k,_y);X=v`<defs><path id=${I.id} d=${I.d} /></defs>
        <text font-size=${Fu*k} font-weight="600" fill=${_.color} fill-opacity=${_.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${I.id}" startOffset="50%" text-anchor="middle">${Hu($,I.length,Fu*k*.88)}</textPath></text>`}else{let _=e.borderWidth*r.scale*H,I=l?v`<circle cx=${A/2} cy=${A/2} r=${A/2-_/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${_} />`:f;X=v`<g transform="translate(${T} ${P})">
        <g clip-path=${`url(#${o})`}>
          ${s?jn(v`<rect width=${A} height=${A} fill=${s.color} fill-opacity=${s.opacity} />`,"plain",p):f}
          <g data-design-box transform="scale(${r.scale*H})">
            ${c.map(R=>js(R,a,n,u,p))}
            ${Su(a,n.grid)}
          </g>
        </g>
      ...
      ${jn(G,"accent",p)}
      ${D?jn(X,"accent",p):X}
    </svg>`}let g=v`<rect width=${i.width} height=${i.height} />`,y=l?v`<rect x=${d/2} y=${d/2} width=${i.width-d} height=${i.height-d} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${d} />`:f,b=v`<rect width=${i.width} height=${i.height} fill="#000000" />`,C=`0 0 ${i.width} ${i.height}`;return v`<svg viewBox=${C} xmlns="http://www.w3.org/2000/svg" class="complication ${t}"
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Qy(e)}</svg>`}var kt="color-mix(in srgb, var(--k) 45%, #6b7280)",Si='system-ui, -apple-system, "Segoe UI", sans-serif';function Tp(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function pl(e,n,t,i){return v`<g fill="none" stroke-linecap="round">
    <path d=${Tp(e,n,t,1)} stroke=${kt} stroke-width="2.6" opacity=".5" />
    <path d=${Tp(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function eb(e){switch(e){case"text":return v`<g font-family=${Si} text-anchor="middle">
      ...
      </g>`}}function Ep(e){return h`<svg class="shot" viewBox="0 0 120 46" aria-hidden="true">${eb(e)}</svg>`}var Mp={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Rp=e=>(...n)=>({_$litDirective$:e,values:n}),Vr=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,t,i){this._$Ct=n,this._$AM=t,this._$Ci=i}_$AS(n,t){return this.update(n,t)}update(n,t){return this.render(...t)}};var{I:tb}=Td,Ap=e=>e;var Hp=()=>document.createComment(""),Ti=(e,n,t)=>{let i=e._$AA.parentNode,a=n===void 0?e._$AB:n._$AA;if(t===void 0){let r=i.insertBefore(Hp(),a),o=i.insertBefore(Hp(),a);t=new tb(r,o,e,e.options)}else{let r=t._$AB.nextSibling,o=t._$AM,s=o!==e;if(s){let l;t._$AQ?.(e),t._$AM=e,t._$AP!==void 0&&(l=e._$AU)!==o._$AU&&t._$AP(l)}if(r!==a||s){let l=t._$AA;for(;l!==r;){let d=Ap(l).nextSibling;Ap(i).insertBefore(l,a),l=d}}}return t},cn=(e,n,t=e)=>(e._$AI(n,t),e),nb={},Fp=(e,n=nb)=>e._$AH=n,Ip=e=>e._$AH,Gr=e=>{e._$AR(),e._$AA.remove()};var Lp=(e,n,t)=>{let i=new Map;for(let a=n;a<=t;a++)i.set(e[a],a);return i},_p=Rp(class extends Vr{constructor(e){if(super(e),e.type!==Mp.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,n,t){let i;t===void 0?t=n:n!==void 0&&(i=n);let a=[],r=[],o=0;for(let s of e)a[o]=i?i(s,o):o,r[o]=t(s,o),o++;return{values:r,keys:a}}render(e,n,t){return this.dt(e,n,t).values}update(e,[n,t,i]){let a=Ip(e),{values:r,keys:o}=this.dt(n,t,i);if(!Array.isArray(a))return this.ut=o,r;let s=this.ut??=[],l=[],d,c,u=0,p=a.length-1,m=0,g=r.length-1;for(;u<=p&&m<=g;)if(a[u]===null)u++;else if(a[p]===null)p--;else if(s[u]===o[m])l[m]=cn(a[u],r[m]),u++,m++;else if(s[p]===o[g])l[g]=cn(a[p],r[g]),p--,g--;else if(s[u]===o[g])l[g]=cn(a[u],r[g]),Ti(e,l[g+1],a[u]),u++,g--;else if(s[p]===o[m])l[m]=cn(a[p],r[m]),Ti(e,a[u],a[p]),p--,m++;else if(d===void 0&&(d=Lp(o,m,g),c=Lp(s,u,p)),d.has(s[u]))if(d.has(s[p])){let y=c.get(o[m]),b=y!==void 0?a[y]:null;if(b===null){let C=Ti(e,a[u]);cn(C,r[m]),l[m]=C}else l[m]=cn(b,r[m]),Ti(e,a[u],b),a[y]=null;m++}else Gr(a[p]),p--;else Gr(a[u]),u++;for(;m<=g;){let y=Ti(e,l[g+1]);cn(y,r[m]),l[m++]=y}for(;u<=p;){let y=a[u++];y!==null&&Gr(y)}return this.ut=o,Fp(e,l),Rt}});var zp="sun.sun";function Pp(e){let n=e?.[zp],t=typeof n?.attributes?.friendly_name=="string"?n.attributes.friendly_name.trim():"";return{entityId:zp,displayName:t||"Sun",domain:"sun"}}var Np=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ib=[0,1,2,3,4];function Dp(e){let n=[];for(let t of e??[]){let i=t.trim();if(i==="")continue;let a=Number(i);Number.isInteger(a)&&a>=0&&a<=6&&!n.includes(a)&&n.push(a)}return n.sort((t,i)=>t-i)}function hl(e){return[...new Set(e)].filter(n=>n>=0&&n<=6).sort((n,t)=>n-t).map(String)}var Op=[{kind:"afterSunset",label:"After sunset",hint:"True from sunset to sunrise, from the sun entity's own state."},{kind:"daytime",label:"Daytime",hint:"True while the sun is up."},{kind:"sunElevation",label:"Sun below an angle",hint:"The sun's elevation in degrees, below a number you set. 0 is the horizon."},{kind:"weekday",label:"Weekday is one of",hint:"A row of days, starting on Monday to Friday."},{kind:"timeBetween",label:"Time between",hint:"A clock window that may wrap midnight, starting at 22:00 to 06:00."}];function ab(e){return[Bp(e,"below_horizon")]}function rb(e){return[Bp(e,"above_horizon")]}function Bp(e,n){return{id:ee(),value:{kind:{kind:"entityState",...e}},comparison:{kind:"equals",value:V(n)}}}function ob(e,n=0){return[{id:ee(),value:{kind:{kind:"entityAttribute",...e,attribute:"elevation"}},comparison:{kind:"lessThan",value:V(String(n))}}]}function sb(e=ib){return[{id:ee(),value:{kind:{kind:"time",timeField:"weekday"}},comparison:{kind:"isOneOf",options:hl(e)}}]}function lb(e="22:00",n="06:00"){return[{id:ee(),value:{kind:{kind:"time",timeField:"now"}},comparison:{kind:"timeBetween",value:V(e),upper:V(n)}}]}function Vp(e,n){switch(e){case"afterSunset":return ab(n);case"daytime":return rb(n);case"sunElevation":return ob(n);case"weekday":return sb();case"timeBetween":return lb()}}function ml(e){delete e.coloring,delete e.bands,delete e.bandAboveColorHex,delete e.highlight,delete e.highColorHex,delete e.lowColorHex}function ga(e){for(let n of e)delete n.partId}function Gp(e,n=ee()){if(e.parts!==void 0&&e.parts.length>0)return e.parts[0].id;let t={id:n,value:structuredClone(e.value)};return e.coloring==="bands"&&(e.bands?.length??0)>0&&(t.coloring="bands",t.bands=e.bands,e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==pe&&(t.bandAboveColorHex=e.bandAboveColorHex)),ml(e),e.parts=[t],e.value=Ki(e.parts),n}function Ur(e,n=[]){let t=e.parts??[];if(e.countdown===!0||t.length===0)return delete e.parts,ga(e.rules),{ok:!0,joined:!1,moved:[]};if(t.length===1){let a=t[0],r=[];return e.value=a.value,a.fontSize!==void 0&&(e.fontSize=a.fontSize,r.push("fontSize")),a.fontWeight!==void 0&&(e.fontWeight=a.fontWeight,r.push("fontWeight")),a.colorHex!==void 0&&(e.colorSlot.baseColorHex=a.colorHex,r.push("color")),ml(e),a.coloring!==void 0&&a.coloring!=="uniform"&&(e.coloring=a.coloring),a.bands!==void 0&&a.bands.length>0&&(e.bands=a.bands),a.bandAboveColorHex!==void 0&&(e.bandAboveColorHex=a.bandAboveColorHex),a.coloring==="bands"&&(a.bands?.length??0)>0&&r.push("bands"),delete e.parts,ga(e.rules),{ok:!0,joined:!1,moved:r}}let i=fl(t,n);return i.ok?(e.value=i.value,ml(e),delete e.parts,ga(e.rules),{ok:!0,joined:!0}):i}function ma(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function fa(e){return e.includes("{")?`{% raw %}${e}{% endraw %}`:e}function db(e,n){let t=e,i=e.format;for(let r=0;t.kind.kind==="named";r++){if(r>8)return;let o=t.kind.id.toUpperCase(),s=n.find(l=>l.id.toUpperCase()===o)?.value;if(!s)return;i=_e(i)?s.format:i,t=s}let a={kind:t.kind};return _e(i)||(a.format=i),a}function cb(e,n){let t=db(e,n);if(!t)return{blocked:"kind"};let i=Fn(t);if(i!==void 0)return fa(i);let a=t.kind,r=t.format??{};if(r.relativeTime||r.duration)return{blocked:"format"};let o="",s;switch(a.kind){case"entityState":s=`states(${ma(a.entityId)})`;break;case"jinja":{if(a.value.trim()==="")return"";let c=a.value.includes("{{")||a.value.includes("{%"),u=r.decimals===void 0&&r.multiply===void 0&&r.offset===void 0&&!r.textCase;if(c&&u)return fa(r.prefix??"")+a.value+fa(r.suffix??"");c?(o=`{% set wa_text %}${a.value}{% endset %}`,s="wa_text"):s=`(${a.value})`;break}case"entityAttribute":case"entityAge":case"aggregate":case"time":{let c=ia(a);if(c===void 0)return{blocked:"kind"};s=c;break}default:return{blocked:"kind"}}if(r.decimals!==void 0||r.multiply!==void 0||r.offset!==void 0){let c=`(${s} | float(0))`;r.multiply!==void 0&&(c=`(${c} * ${r.multiply})`),r.offset!==void 0&&(c=`(${c} + ${r.offset})`),s=r.decimals!==void 0?`${ma(`%.${Math.max(0,Math.trunc(r.decimals))}f`)} | format(${c})`:c}let l=r.useEntityUnit&&"entityId"in a?a.entityId:void 0;l!==void 0&&(o+=`{% set wa_unit = state_attr(${ma(l)}, 'unit_of_measurement') %}`);let d="('' if not wa_unit else (wa_unit if wa_unit[:1] in ['\xB0', '%'] else ' ' ~ wa_unit))";if(r.textCase){let c=r.textCase==="upper"?"upper":r.textCase==="lower"?"lower":"title",u=[...r.prefix?[ma(r.prefix)]:[],`(${s})`,...l!==void 0?[d]:[],...r.suffix?[ma(r.suffix)]:[]].join(" ~ ");return`${o}{{ (${u}) | ${c} }}`}return o+fa(r.prefix??"")+`{{ ${s} }}`+(l!==void 0?`{{ ${d} }}`:"")+fa(r.suffix??"")}function fl(e,n=[]){if(e.every(a=>a.value.kind.kind==="literal"))return{ok:!0,value:Ki(e)};let t=[],i=[];return e.forEach((a,r)=>{let o=cb(a.value,n);typeof o=="string"?t.push(o):i.push({index:r,partId:a.id,reason:o.blocked})}),i.length>0?{ok:!1,blocked:i}:{ok:!0,value:{kind:{kind:"jinja",value:t.join("")}}}}var jr=[["threshold","Threshold line"],["now","Now line"],["zero","Zero line"],["grid","Grid lines"],["dots","Dots"],["times","Clock times"]],Wp=[{label:"Newest",stat:"latest",marker:"latest"},{label:"First",stat:"first",marker:"first"},{label:"Highest",stat:"highest",marker:"highest"},{label:"Lowest",stat:"lowest",marker:"lowest"},{label:"Average",stat:"average"},{label:"Change",stat:"delta"},{label:"Total",stat:"sum"},{label:"Trend",stat:"trend"},{label:"Top of scale",stat:"top"},{label:"Bottom of scale",stat:"bottom"},{label:"Now",marker:"now"}],Yn="color-mix(in srgb, var(--k) 30%, #6b7280)",Kr='system-ui, -apple-system, "Segoe UI", sans-serif',pn=40,Wr=6,ub=[22,17,11,16,27,23,35,31];function pb(e={}){let n=(e.values??[]).filter(p=>Number.isFinite(p)),t=n.length>=2,i=t?n:ub,a=Math.min(...i),r=Math.max(...i);t&&e.threshold!==void 0&&Number.isFinite(e.threshold)&&(a=Math.min(a,e.threshold),r=Math.max(r,e.threshold)),r===a&&(r+=1,a-=1);let o=p=>Wr+(r-p)/(r-a)*(pn-Wr),s=i.length,l=i.map((p,m)=>10+m*100/(s-1)),d=i.map(o),c=p=>Math.min(pn,Math.max(Wr,p)),u=t&&e.now!==void 0&&Number.isFinite(e.now)?Math.min(s-1,Math.max(0,Math.round(e.now))):Math.round((s-1)*.6);return{xs:l,ys:d,y:o,real:t,zeroY:c(o(0)),thresholdY:c(o(t&&e.threshold!==void 0?e.threshold:(a+r)/2)),averageY:o(i.reduce((p,m)=>p+m,0)/s),column:{highest:i.indexOf(Math.max(...i)),lowest:i.indexOf(Math.min(...i)),first:0,latest:s-1,now:u}}}function hb(e){let n=e.xs.map((t,i)=>`${i===0?"M":"L"}${t.toFixed(1)} ${e.ys[i].toFixed(1)}`).join("");return v`
    <path d=${`${n}L${e.xs[e.xs.length-1]} ${pn}L${e.xs[0]} ${pn}Z`} fill=${Yn} opacity=".18" />
    <path d=${n} fill="none" stroke=${Yn} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />`}function mb(e){let n=Math.min(10,Math.max(1,100/e.xs.length*.7));return v`${e.xs.map((t,i)=>{let a=Math.min(e.ys[i],pn-1);return v`<rect x=${t-n/2} y=${a} width=${n} height=${pn-a} rx=${Math.min(2,n/2)} fill=${Yn} opacity=".45" />`})}`}function fb(){return v`${[[4,30,.35],[35,18,.7],[54,10,.35],[65,26,.7],[92,24,.35]].map(([n,t,i])=>v`<rect x=${n} y="10" width=${t} height="16" rx="3" fill=${Yn} opacity=${i} />`)}`}function gb(){return v`
    ...
    @pointerdown=${t??f}>${e}${i}</span>`}var co="wa-scrub-start",uo="wa-scrub-end",$b=3,Cb=3;function Sb(e,n){return e!==void 0&&Number.isFinite(e)?e:Math.max(0,n.min??0)}function Tb(e,n,t={}){let i=n!==void 0&&n>0?n:10**-Math.min(2,El(e));return t.coarse?i*10:t.fine?i/10:i}function Eb(e,n,t,i){let a=e+Math.round((n-e)/t)*t;return i.min!==void 0&&(a=Math.max(i.min,a)),i.max!==void 0&&(a=Math.min(i.max,a)),Number(a.toFixed(Math.min(10,Math.max(El(t),El(e)))))}function El(e){if(!Number.isFinite(e)||Number.isInteger(e))return 0;let n=String(e),t=/e-(\d+)$/.exec(n);return t?Number(t[1])+(n.split("e")[0].split(".")[1]??"").length:(n.split(".")[1]??"").length}function vh(e,n,t,i,a,r){let o=Sb(t,a),s=n.clientX,l=s,d=o,c=o,u=!1,p=g=>{if(!u){if(Math.abs(g.clientX-s)<$b)return;u=!0,l=g.clientX,e.classList.add("scrubbing"),e.dispatchEvent(new CustomEvent(co,{bubbles:!0,composed:!0}))}let y=Tb(o,a.step,{coarse:g.shiftKey,fine:g.altKey});d+=(g.clientX-l)/Cb*y,l=g.clientX,a.min!==void 0&&(d=Math.max(a.min,d)),a.max!==void 0&&(d=Math.min(a.max,d));let b=Eb(o,d,y,a);b!==c&&(c=b,i(b))},m=g=>{if(e.removeEventListener("pointermove",p),e.removeEventListener("pointerup",m),e.removeEventListener("pointercancel",m),u){e.classList.remove("scrubbing"),e.dispatchEvent(new CustomEvent(uo,{bubbles:!0,composed:!0}));let y=b=>{b.preventDefault(),b.stopPropagation()};e.addEventListener("click",y,{capture:!0,once:!0}),setTimeout(()=>e.removeEventListener("click",y,{capture:!0}),0)}r(u,g)};e.setPointerCapture(n.pointerId),e.addEventListener("pointermove",p),e.addEventListener("pointerup",m),e.addEventListener("pointercancel",m)}function po(e,n,t){return i=>{if(i.button!==0||!i.isPrimary)return;let a=i.currentTarget;a.closest(".field")?.querySelector("input[type=number]")?.disabled||(i.preventDefault(),vh(a,i,e,n,t,()=>{}))}}function Ea(e,n,t){return i=>{let a=i.currentTarget;i.button!==0||!i.isPrimary||a.disabled||a.matches(":focus")||(i.preventDefault(),vh(a,i,e,n,t,(r,o)=>{r||o.type!=="pointerup"||(a.focus(),a.select())}))}}function mn(e,n,t,i=a=>String(a)){if(n===void 0)return;let a=n;return{atDefault:e===a,title:`Back to ${i(a)}`,reset:()=>t(a)}}function Re(e,n,t,i={}){return h`<label class="field">${Ve(e,mn(n,i.def,t,a=>a===""?"empty":a))}
    <input type="text" .value=${n} placeholder=${i.placeholder??""} list=${i.list??f}
      class=${i.mono?"mono":""} @input=${we(t)} /></label>`}function wh(e,n,t,i=3){return h`<label class="field"><span>${e}</span>
    <textarea rows=${i} .value=${n} class="mono" @input=${we(t)}></textarea></label>`}function ae(e,n,t,i={}){let a=i.def===null?{atDefault:n===void 0,title:"Back to none",reset:()=>t(void 0)}:mn(n,i.def,t);return h`<label class="field num">${Ve(e,a,po(n,t,i))}${ho(n,t,i)}</label>`}function ho(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e),a=h`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??f} max=${t.max??f}
    ...
    ${ao(e,n,t,i,a)}</div>`}function ao(e,n,t,i,a={}){return h`<div class="seg wide" role="radiogroup" aria-label=${e}>
    ...
    </div>`}function Mb(e,n){let t=i=>mn(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${Ve(e.label,t(e))}
    <div class="pair-row">
      ${ao(e.label,e.value,e.options,e.set,e)}
      ${Ve(n.label,t(n))}
      ${ao(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function Qn(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Ve(e,mn(n,i.def,t,a),po(n,t,i))}
    <div class="slider-row">
      ...
      ${ho(n,r,{step:i.step,min:i.min,max:i.max,ariaLabel:e,...i.unit===void 0?{}:{unit:i.unit}})}
    </div></div>`}function Be(e,n,t,i,a={}){return h`<label class="field check">${Ve(e,mn(n,i,t,r=>r?"on":"off"))}<input type="checkbox" .checked=${n} ?disabled=${a.disabled===!0} @change=${r=>t(r.target.checked)} /></label>`}function ye(e,n,t,i=!1,a){let{rgb:r,alpha:o}=kh(n),s=a===void 0?void 0:{atDefault:Ll(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)},l=i&&n===void 0;return h`<div class="field color">${Ve(e,s)}
    <div class="color-row">
      ${i?h`<input type="checkbox" title="Enabled" aria-label=${`${e} on`} .checked=${n!==void 0} @change=${d=>t(d.target.checked?no(r,o):void 0)} />`:f}
      ${mo(e,n,t,l)}
    </div></div>`}function kh(e){let n=(e??"").replace(/^#/,""),t=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n);return{valid:t,swatch:t?`#${n}`:"transparent",rgb:t?`#${n.slice(0,6)}`:"#ffffff",alpha:t&&n.length===8?Math.round(parseInt(n.slice(6,8),16)/255*100):100}}function no(e,n){let t=e.replace(/^#/,"").toUpperCase();return n>=100?`#${t}`:`#${t}${Math.round(n/100*255).toString(16).padStart(2,"0").toUpperCase()}`}function mo(e,n,t,i=!1,a="#RRGGBB"){let{valid:r,swatch:o,rgb:s,alpha:l}=kh(n);return h`<span class="color-box">
      <span class="color-swatch" style=${`--sw:${i||!r?"transparent":o}`} title="Pick a colour">
        <input type="color" .value=${s} ?disabled=${i} aria-label=${`${e}: pick a colour`} @input=${we(d=>t(no(d,l)))} />
      </span>
      ...
      <span class="num-box alpha" style="--wa-unit:1">
        <input type="number" min="0" max="100" step="1" .value=${String(l)} title="Opacity" aria-label=${`${e}: opacity`} ?disabled=${i}
          data-scrub @pointerdown=${Ea(l,d=>t(no(s,d)),{step:1,min:0,max:100})}
          @input=${we(d=>{let c=Number(d);d.trim()!==""&&c>=0&&c<=100&&t(no(s,Math.round(c)))})} />
        <span class="unit" aria-hidden="true">%</span>
      </span>
    </span>`}function Il(e,n,t,i){let a={atDefault:n===void 0,title:`Back to ${t.toLowerCase()}`,reset:()=>i(void 0)};return h`<div class="field color">${Ve(e,a)}
    <div class="color-row">${mo(e,n,i,!1,t)}</div></div>`}function vl(e,n,t){return h`${Il(e.label,n,e.empty,t)}${e.note===void 0?f:h`<div class=${e.warn?"hint warn":"hint"}>${e.note}</div>`}`}function Ll(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function fo(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Rb(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Xp(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var $h=50;function Ab(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Hb(e,n,t=$h,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Fb=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Ch(e){return Fb.test(e.trim())}function Ib(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return fo(t,i);if(Ch(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Jn=new Map;function Ae(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function _l(e){return Jn.has(e)}function Ct(e,n,t,i,a,r={}){let o=e.hass.states,s=Jn.get(a),l=s?Hb(Rb(o,r.domain,Xp(e.hass)),s.query,$h,r.preferNumeric?Ab:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(w,$,D=0)=>{Jn.set(a,{query:$,index:D}),Ae(w)},p=w=>{Jn.delete(a),Ae(w)},m=w=>{let $=Ib(w,t,o);$&&i($)},g=(w,$)=>{i(fo(o,w.entityId)),p($)},y=()=>Math.max(0,Math.min(Jn.get(a)?.index??0,l.length-1)),b=w=>{let $=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let D=Jn.get(a);if(!D){u($,$.value);return}let M=w.key==="ArrowDown"?y()+1:y()-1;u($,D.query,Math.max(0,Math.min(l.length-1,M))),Lb($);return}if(w.key==="Enter"){w.preventDefault();let D=l[y()];s&&D?g(D,$):(m($.value),p($));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),p($)}},C=t.entityId?Xp(e.hass)?.(t.entityId):void 0,k=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
          <span class="ent-ico ${xl(c.state)?"on":""}">${bl(t.domain||t.entityId.split(".")[0]||"")}</span>
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let $=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Jn.set(a,{query:"",index:0}),Ae($),$?.focus()}}>${W("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Ch(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,$)=>h`<button type="button" role="option" aria-selected=${$===d?"true":"false"} class="ent ${$===d?"hl":""}"
                @mousedown=${D=>D.preventDefault()} @click=${D=>g(w,D.target)}>
                <span class="ent-ico ${xl(w.state)?"on":""}">${bl(w.domain)}</span>
                <span class="ent-main">
                ...
                <span class="ent-right">
                  <span class="ent-type">${Yp(w.domain)}</span>
                  <span class="ent-state">${w.state}</span>
                </span>
              </button>`)}
        </div>`:k}
  </div>`}function Lb(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Jp=120;function _b(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Pr.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Nr),fromPack:!1}}function Zp(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function zb(e){return[{value:"",label:`Starter set (${Zp(Nr,e)})`},...Pr.map(n=>({value:n.name,label:`${n.name} (${Zp(n.symbols,e)})`}))]}function Pb(e){return e.length>0?e.length:Nr.length}function Qp(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function qr(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Sh(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Ke),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=Nb(u,c),b=w=>{t(w),a?.(w.startsWith(Ke)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},C=w=>{if(t(w),!m)return;let $=w.trim();a?.($.startsWith(Ke)?e.icons.mdiPath?.($):void 0)},k=f;if(o&&g==="mdi"){let w=e.icons.mdiNames?.(),$=Db(w??[],s),D=$.slice(0,Jp),M=r.recent.filter(A=>A.startsWith(Ke));k=h`<div class="sym-browse">
      ${eh(r,i,g)}
      ...
      ${M.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${M.map(A=>qr(e,A,A===u,b))}</div>`}
      <div class="sym-grid">${D.map(A=>qr(e,A,A===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:$.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Qp(D.length,$.length,!0,w.length)}</div>`}
    ...
    </div>`}else if(o){let w=r.category(i),$=_b(w,s,d,c),D=ol($.names,s),M=$.fromPack?D.slice(0,Jp):D,A=r.recent.filter(T=>!T.startsWith(Ke)),H=c.size===0?A:A.filter(T=>c.has(T));k=h`<div class="sym-browse">
      ${m?eh(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${we(T=>r.setQuery(i,T))} />
        <select @change=${we(T=>r.setCategory(i,T))}>
          ${zb(c).map(T=>h`<option value=${T.value} ?selected=${T.value===w}>${T.label}</option>`)}
        </select>
      </div>
      ${H.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${H.map(T=>qr(e,T,T===u,b))}</div>`}
      <div class="sym-grid">${M.map(T=>qr(e,T,T===u,b))}</div>
      ${D.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${Qp(M.length,D.length,s.trim()!=="",Pb(d))}
          </div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${we(C)} @change=${we(w=>{let $=w.trim();$.startsWith(Ke)?e.icons.mdiPath?.($)!==void 0&&r.noteUsed(w):(c.size===0||c.has($))&&r.noteUsed(w)})} /></label>
    ...
    ${k}`}function Nb(e,n){let t=e.trim();return t!==""&&!t.startsWith(Ke)&&n.size>0&&!n.has(t)}function Db(e,n){let t=n.trim(),i=t.startsWith(Ke)?t.slice(Ke.length):t,a=e.map(r=>r.startsWith(Ke)?r.slice(Ke.length):r);return ol(a,i).map(r=>Ke+r)}function eh(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Ob=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Bb={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Vb=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],Gb=[["flat","Flat"],["fade","Fade"]],Th=[["auto","Auto"],["all","All"]],Ub=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],Eh=[["bars","Bars"],["line","Line"],["area","Area"]],Wb=[["auto","Auto"],["fixed","Fixed range"]],Kb=[["lowest","Lowest value"],["zero","Zero"]],jb=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],Ml=[["uniform","One colour"],["bands","By value"]];function ro(e){let n=[qo,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:ee(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:ee(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function zl(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function qb(e,n){let t=Qt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:ee(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function th(e,n,t,i){return h`<span class="band-cell">${mo(e,n,t)}${Ta(i)}</span>`}function Yb(e,n){let t=(typeof n=="number"?[n]:n??[]).filter(s=>Number.isFinite(s)),i=[...e,...t];if(i.length===0)return{lo:-1,hi:1};let a=Math.min(...i),r=Math.max(...i),o=r>a?(r-a)*.12:Math.abs(a)/2||1;return{lo:a-o,hi:r+o}}var Xb=.1;function Jb(e,n,t,i=Xb){let a=[...e].sort((k,w)=>k-w),r=k=>Math.max(n,Math.min(t,k)),o=[n,...a.map(r),t],s=t-n||1,l=o.slice(1).map((k,w)=>Math.max(0,k-o[w])/s),d=Math.min(i,1/l.length),c=l.map(k=>k<d),u=c.filter(Boolean).length,p=l.reduce((k,w,$)=>k+(c[$]?0:w),0),m=1-u*d,g=l.length-u,y=l.map((k,w)=>c[w]?d:p>0?k/p*m:m/g),b=y.map((k,w)=>y.slice(0,w).reduce(($,D)=>$+D,0));return{shares:y,at:k=>{let w=r(k),$=o.length-2;for(let A=0;A<o.length-1;A++)if(w<=o[A+1]){$=A;break}let D=o[$+1]-o[$],M=D>0?(w-o[$])/D:0;return Math.max(0,Math.min(100,(b[$]+M*y[$])*100))}}}function Yr(e){return Math.abs(e)>=1e3||Number.isInteger(e)?String(Math.round(e*100)/100):String(Number(e.toPrecision(4)))}function Zb(e,n){let t=e.flatMap(m=>m.upTo===void 0?[]:[m.upTo]),{lo:i,hi:a}=Yb(t,n),{shares:r,at:o}=Jb(t,i,a),s=typeof n=="number"&&Number.isFinite(n)?n:void 0,l=typeof n=="object"?n.filter(m=>Number.isFinite(m)):[],d=l.length>0?Math.min(...l):void 0,c=l.length>0?Math.max(...l):void 0,u=-1/0,p=[...t].sort((m,g)=>m-g).flatMap(m=>{let g=o(m);return g-u<12?[]:(u=g,[h`<span style=${`left:${g}%`}>${Yr(m)}</span>`])});return h`<div class="band-bar">
    ...
    ${d===void 0||c===void 0?f:h`<span class="span" style=${`left:${o(d)}%;width:${o(c)-o(d)}%`}
      title=${d===c?`Reads ${Yr(d)}`:`Reads ${Yr(d)} to ${Yr(c)}`}></span>`}
    ${s===void 0?f:h`<span class="now" style=${`left:${o(s)}%`} title=${`Now ${s}`}></span>`}
    ${p.length===0?f:h`<div class="ticks" aria-hidden="true">${p}</div>`}
  </div>`}function oo(e,n,t,i,a){let r=Qt({bands:e.bands}),o=typeof i=="number"&&Number.isFinite(i)?i:void 0,s=o===void 0?void 0:r.find(b=>o<=b.upTo)?.id??"above",l=(b,C)=>k=>{let w=k.bands.find($=>$.id===b);w&&C(w)},d=e.bandAboveColorHex,c={atDefault:Ll(d,pe),title:`Back to ${pe}`,reset:()=>t(b=>{b.bandAboveColorHex=pe})},u=a?.border===!0,p=(b,C,k,w,$)=>{if(!u)return mo(b,C.colorHex,T=>k(T??"#FFFFFF"));let D=a?.fillHex,M=a?.borderHex,A=C.fillColorHex===void 0?void 0:{atDefault:!1,title:"Back to the chart fill colour",reset:()=>w(void 0)},H=C.borderColorHex===void 0?void 0:{atDefault:!1,title:`Back to ${M===void 0?"white":"the chart border colour"}`,reset:()=>$(void 0)};return h`
      ${th(`${b} fill`,C.fillColorHex??D??C.colorHex,T=>{T!==void 0&&(k(T),w(D===void 0?void 0:T))},A)}
      ${th(`${b} border`,C.borderColorHex??M??Bi,T=>$(T),H)}`},m=(b,C)=>{let k=r[b];return h`<input type="number" class="band-up" step="any" .value=${String(k.upTo)} aria-label=${C}
      title=${`Band ${b+1} runs up to and including this number`}
      data-scrub @pointerdown=${Ea(k.upTo,w=>t(l(k.id,$=>{$.upTo=w})),{...b>0?{min:r[b-1].upTo}:{},...b<r.length-1?{max:r[b+1].upTo}:{}})}
      @change=${we(w=>{let $=Number(w);w.trim()!==""&&Number.isFinite($)&&t(l(k.id,D=>{D.upTo=$}))})} />`},g=(b,C)=>({...b===void 0?{}:{upTo:b},fill:u?C.fillColorHex??a?.fillHex??C.colorHex:C.colorHex,...u?{border:C.borderColorHex??a?.borderHex??Bi}:{}}),y=[...r.map(b=>g(b.upTo,b)),g(void 0,{colorHex:d,...e.bandAboveFillColorHex===void 0?{}:{fillColorHex:e.bandAboveFillColorHex},...e.bandAboveBorderColorHex===void 0?{}:{borderColorHex:e.bandAboveBorderColorHex}})];return h`<div class=${u?"bands split":"bands"}>
    ${Zb(y,o??(typeof i=="object"?i:void 0))}
    ...
    ${r.map((b,C)=>h`
      <div class="band-row ${s===b.id?"hit":""}">
        <span class="range">${C===0?h`<span class="le">Less than</span>${m(C,"Less than")}`:h`${m(C-1,"From")}<span class="to">to</span>${m(C,"Up to")}`}</span>
        ...
        <button type="button" class="icon" title="Remove this band" aria-label="Remove this band"
          @click=${()=>t(k=>{k.bands=k.bands.filter(w=>w.id!==b.id)})}>${W("close")}</button>
      </div>`)}
    <div class="band-row ${s==="above"?"hit":""}">${Ta(c)}
      ...
      ${p("Above the last band",{colorHex:d,...e.bandAboveFillColorHex===void 0?{}:{fillColorHex:e.bandAboveFillColorHex},...e.bandAboveBorderColorHex===void 0?{}:{borderColorHex:e.bandAboveBorderColorHex}},b=>t(C=>{C.bandAboveColorHex=b},"babove"),b=>t(C=>{b===void 0?delete C.bandAboveFillColorHex:C.bandAboveFillColorHex=b},"bafill"),b=>t(C=>{b===void 0?delete C.bandAboveBorderColorHex:C.bandAboveBorderColorHex=b},"baborder"))}
      <span></span>
    </div>
    <button type="button" class="link add-band" @click=${()=>t(b=>{b.bands=[...b.bands,qb(b.bands,n)]})}>+ Band</button>
  </div>`}function Qb(e,n,t,i){let a=new Map,r=new Map,o=(d,c)=>{let u=d.trim();if(u==="")return;let p=u.toLowerCase();r.has(p)||r.set(p,u),a.set(p,(a.get(p)??0)+c)};e.forEach((d,c)=>{let u=e[c+1],p=u===void 0?n:u.offsetSeconds;o(d.state,Math.max(0,p-d.offsetSeconds))}),t!==void 0&&o(t,0),(Ji[i??""]??[]).forEach(d=>o(d,0));let s=["unavailable","unknown"];return[...[...a.entries()].filter(([d])=>!s.includes(d)).sort((d,c)=>c[1]-d[1]).map(([d])=>r.get(d)??d),...s]}function ex(e,n,t=[],i="wa-timeline-states"){let a=new Set(e.bands.map(o=>o.match.trim().toLowerCase())),r=t.find(o=>!a.has(o.toLowerCase()))??"";return h`
    ${e.bands.map((o,s)=>h`
    ...
    ${Mh(e,a,r,n,t,i)}
  </div>`}function Mh(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Ah}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${ka.has(n)?Hh(e,i,a,r):f}
  </div>`}function me(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function go(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function rx(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var ka=new Set,ba=new WeakMap;function ox(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Rh(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Ah(e){let n=e.currentTarget,t=e.newState==="open",i=ba.get(n);if(i&&(i(),ba.delete(n)),!t){ka.delete(n.id)&&Ae(n);return}let a=ox(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ba.get(n)?.(),ba.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}wl(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ba.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),wl(n,a.getBoundingClientRect()),ka.has(n.id)||(ka.add(n.id),Ae(n),requestAnimationFrame(()=>{n.isConnected&&wl(n,a.getBoundingClientRect())}))}function wl(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=sx({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Xn=8,Xr=6,ih=140;function sx(e,n,t){let i=t.height-e.bottom-Xr-Xn,a=e.top-Xr-Xn,r=n.height>i&&a>i&&i<ih,o=Math.max(ih,r?a:i),s=Math.min(n.height,o),l=Math.max(Xn,Math.min(e.left,t.width-n.width-Xn)),d=r?Math.max(Xn,e.top-Xr-s):Math.max(Xn,Math.min(e.bottom+Xr,t.height-s-Xn));return{left:l,top:d,maxHeight:o,above:r}}function Hh(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Ob.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Sh(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):Re("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=Ct(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${Ct(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${Re("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=fx(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Ce("Field",a.timeField,ix,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${wh("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Qi(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>hx(e,n,t)}>Start an empty one</button>,
          ...
          ${c?h`<div class="hint keep">Read by ${u} ${u===1?"layer":"layers"}.
            ...
            <button type="button" class="link" @click=${()=>{let p=$s(e.config,n);p&&t(p)}}>stop sharing</button>
    ...
    ${Ce("Source",a.kind,s,c=>r(ax(a,c)))}
    ${d?h`<div class="hint">${d}</div>`:f}
    ${l}
    ${ux(n,i)?h`<div class="hint keep">
      <button type="button" class="link" title="Move this into a shared value that other layers can read too" @click=${()=>px(e,n,t)}>Make shared</button>
      so other layers can read this too.</div>`:f}
    ${i.noFormat?f:mx(n.format,c=>t(_e(c)?{kind:n.kind}:{...n,format:c}),dx(lx(e,n)))}
    ${i.showResolved?cx(e,n,e.resolve(i.resolveAs??n)):f}`}function lx(e,n){let t=n.kind;for(let i=0;t.kind==="named"&&i<8;i++){let a=t.id.toUpperCase(),r=e.config.values.find(o=>o.id.toUpperCase()===a);if(!r)return;t=r.value.kind}return t.kind==="named"?void 0:t}function dx(e){if(!e)return{numbers:!0,textCase:!0,unit:!0,seconds:!0};switch(e.kind){case"literal":{let n=qe(e.value)!==void 0;return{numbers:n,textCase:!n,unit:!1,seconds:n}}case"entityState":case"entityAttribute":case"jinja":case"named":return{numbers:!0,textCase:!0,unit:e.kind!=="jinja"&&e.kind!=="named",seconds:!0};case"entityAge":case"dataAge":return{numbers:!0,textCase:!1,unit:!1,seconds:!0};case"aggregate":return{numbers:!0,textCase:!1,unit:!1,seconds:!1};case"chartStat":{let n=e.stat==="trend";return{numbers:!n,textCase:!1,unit:!n,seconds:!1}}case"time":return{numbers:e.timeField!=="now",textCase:!1,unit:!1,seconds:!1}}}function cx(e,n,t){let i=t===void 0?h`<span class="readout-v now-v none">${Fh(e,n)}</span>`:t.trim()===""?h`<span class="readout-v now-v none">Empty</span>`:h`<span class="readout-v now-v"><span class="now-tok">${t}</span></span>`;return h`<div class="field readout now-field"><span>Now</span>${i}</div>`}function Fh(e,n){let t=n.kind;switch(t.kind){case"entityState":case"entityAttribute":case"entityAge":return t.entityId===""?"Pick an entity":e.hass.states[t.entityId]?t.kind==="entityAttribute"&&t.attribute.trim()===""?"Pick an attribute":t.kind==="entityState"?"No reading":"Waiting for Home Assistant":"No such entity";case"chartStat":return t.layer===""?"Pick a chart":"The chart has no readings yet";case"named":{if(t.id==="")return"Pick a shared value";let i=t.id.toUpperCase(),a=e.config.values.find(r=>r.id.toUpperCase()===i);return a?Fh(e,a.value):"That shared value is gone"}case"jinja":return t.value.trim()===""?"Type a template":"Waiting for Home Assistant";default:return"Waiting for Home Assistant"}}function ux(e,n){if(n.allowNamed===!1||n.noShare)return!1;let t=e.kind;return t.kind==="named"?!1:t.kind==="literal"||t.kind==="jinja"?t.value.trim()!=="":"entityId"in t?t.entityId!=="":t.kind==="chartStat"?t.layer!=="":!0}function px(e,n,t){let i=Ma(n,me(e)).replace(/^"(.*)"$/,"$1"),{named:a,ref:r}=ks(e.config,n,Oe(i,24));e.beginGesture(),e.update(o=>{o.values.push(a)}),t(r),e.endGesture()}function hx(e,n,t){let{named:i,ref:a}=ks(e.config,{...n,kind:{kind:"literal",value:""}},"");i.name="",e.beginGesture(),e.update(r=>{r.values.push(i)}),t(a),e.endGesture(),e.selectValue(i.id)}function mx(e,n,t){let i=e??{},a=s=>{let l={...i,...s};for(let d of Object.keys(l))(l[d]===void 0||l[d]===!1||l[d]==="")&&delete l[d];n(l)},r=_e(e),o={decimals:t.numbers||i.decimals!==void 0,multiply:t.numbers||i.multiply!==void 0,offset:t.numbers||i.offset!==void 0,textCase:t.textCase||i.textCase!==void 0,unit:t.unit||!!i.useEntityUnit,seconds:t.seconds||!!i.relativeTime||!!i.duration};return h`<details class="sub format" ?open=${!r}>
  ...
  </details>`}function fx(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${n.function==="count"?f:Re("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Ih=ss,gx=Ih.filter(([e])=>e!=="none");function yx(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Lh(e,n){let t=yx(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return wc(e)?{type:e,...t}:{type:e}}var bx=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function _h(e,n,t,i){let a=n.serviceDataJSON??"",r=kc(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    ${wh("Data (JSON)",a,s=>{let l={...n};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,t(l,"svc-data")},3)}
    ${r?h`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:h`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function xx(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function zh(e){let n=e.config,t=n.tapAction,i=xx(e.savedName,n.name),a=n.refreshMinutes??0,r=ah.map(s=>[String(s),rh(s)]);ah.includes(a)||r.push([String(a),rh(a)]);let o=n.showSuccessFlash??!0;return h`
    <div class="gen-row">
      ${Re("Name",n.name,s=>e.update(l=>{l.name=s},"name"))}
      ${Ce("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Ce("Tap action",t.type,Ih,s=>e.update(l=>{l.tapAction=Lh(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??vx).slice(0,7)}
    ...
    ${t.type==="callService"?_h(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?wx(e):f}`}var vx="#808080",ah=[0,15,30,60,120];function rh(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function wx(e){let n=e.config;return Ph(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Ph(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Ce("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Nh(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Qi(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
  ...
  </section>`}function Mx(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Rx(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Ax(e,n){let t=he[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Hx(e,n,t){let i=Ax(e,n),a=he[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Fx(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Ix(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Rx(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function ei(e,n=In){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function Lx(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Lt}, so they are averaged into ${Lt} even slots to cover ${a}.`}var io=new Set;function Rl(e,n,t=In){return io.has(e)||!t.some(i=>i.minutes===n)}function $l(e,n,t,i,a=In){let r=Rl(e,n,a);return h`<label class="field">${Ve("Span",{atDefault:n===t&&!r,title:`Back to ${ei(t,a)}`,reset:()=>{io.delete(e),i(t)}})}
      <select @change=${o=>{let s=o.target.value;s==="custom"?(io.add(e),Ae(o.target)):(io.delete(e),i(Number(s)||ar))}}>
        ${a.map(({minutes:o,label:s})=>h`<option value=${String(o)} ?selected=${!r&&o===n}>${s}</option>`)}
        <option value="custom" ?selected=${r}>Custom…</option>
      </select></label>`}function Cl(e,n,t=!1){let i=t?Jo:rr,a=Math.floor(i/1440),r=t?Yi:In,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function zx(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Le(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>ke(p,t,i,{frame:Sr(o,c)}),`${a}-${u}-${t}`),l=!Ca(o,Wi)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return Se(e,"placement","Position",h`
  ...
  ${l?f:h`<div class="field list-field"><span>Copy</span>
    ...
    ${Ce("Reading",i.at,yt,c=>e.update(u=>{let p=u.elements.find(g=>g.payload.id===a);if(!p?.payload.chartAnchor)return;p.payload.chartAnchor.at=c;let m=u.elements.find(g=>g.payload.id===i.layer);m?.kind==="chart"&&(c==="threshold"&&m.payload.thresholdValue===void 0&&(m.payload.thresholdValue=zl(Ye(e.resolve(m.payload.value)??"")),m.payload.drawsThreshold=!1),c==="now"&&m.payload.nowIndex===void 0&&(m.payload.nowIndex={kind:{kind:"time",timeField:"hour"}},m.payload.drawsNowLine=!1))}),{def:"highest"})}
    ${Gh(e,i,r)}
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function Px(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=je(e.config,t)[0];return Se(e,"tappable","Tap",cv(e,n,`el-${t}`),{color:te.tap,icon:"tap",summary:i?_t(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>gr(a,t))}:{}})}function Nx(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${a}
      </div>`}`}var Dx=[["number","Number"],["entity","Entity"]];function Ox(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Bx(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Vx(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=Ox(n,o),c=s?n.minValue:n.maxValue,u=y=>a(b=>{s?b.minValue=y??0:b.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Ve(l,d==="number"?mn(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Dx.map(([y,b])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a(C=>Bx(C,o,y))}}>${b}</button>`)}
      </span>
    </div>`,g=s?n.minSource:n.maxSource;return d==="number"||g===void 0?h`<div class="field gauge-end">${m}${ho(c,u,{ariaLabel:l})}</div>`:h`<div class="field gauge-end">${m}${le(e,g,y=>a(b=>{s?b.minSource=y:b.maxSource=y},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
    ...
    <div class="fgroup">
    ${ie("Colour",a,Ml,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=ro(Ye(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
      ...
      ${oo({bands:n.bands??[],bandAboveColorHex:n.bandAboveColorHex??pe},n.colorSlot.baseColorHex,o,d.length===1?d[0]:void 0)}`:f}
    </div>
    <div class="fgroup">
    ${ie("Highlight",r,jb,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
    ...
    </div>`}var wa=new Map,va=new Map,Ot=new Map,Zr=new Map,Sl=4,Tl=40,Ux=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Wx=[["plain","Plain"],["rich","Rich"]],Kx={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function Nl(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Be("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function jx(e){return e.countdown===!0?"countdown":st(e)?"rich":"plain"}function qx(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Yx(e,n){let t=Fn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Oe(e.kind.value,40)||"template"}:{kind:"value",label:Ma(e,n)}}function Uh(e,n,t){let i=Fn(e.value),a=i===void 0?Oe(Ma(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Oe(i,24)}"`;return`Part ${n+1}: ${a}`}function Xx(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Uh(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function Al(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Jx(e,n){if(Al(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Qt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??pe],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function ch(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${bo(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Zx={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Qx(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${bo(e.moved.map(n=>Zx[n]))} moved into Look.`}function ev(e,n,t,i,a){let r=n.payload,o=r.id,s=jx(r),l=(r.parts?.length??0)>0,d=ls(e.config,r.value),c=Ot.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?va.get(o):void 0,m=(b,C)=>{let k=!(r.parts??[]).every($=>$.value.kind.kind==="literal"),w=Ur(structuredClone(r),e.config.values);if(va.delete(o),!w.ok){Ot.set(o,{text:ch(w.blocked),rich:!0,warn:!0}),Ae(C);return}Ot.set(o,{text:Qx(w.joined?{joined:!0,template:k}:w),rich:!1}),i($=>{Ur($,e.config.values),b==="countdown"&&($.countdown=!0)})},g=(b,C)=>{if(va.delete(o),s==="rich"){let k=b==="countdown"?"countdown":"plain",w=r.parts??[];if(w.length<2){m(k,C);return}let $=fl(w,e.config.values);$.ok?(Ot.delete(o),va.set(o,k)):Ot.set(o,{text:ch($.blocked),rich:!0,warn:!0}),Ae(C);return}if(b==="rich"){let k=r.parts?.[0]?.id??ee();wa.set(o,k),Ot.delete(o),i(w=>{delete w.countdown,Gp(w,k)});return}Ot.delete(o),i(k=>{if(b==="countdown"){k.countdown=!0;return}(k.parts?.length??0)>0&&Ur(k,e.config.values),delete k.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${ie("Type",s==="rich"?"rich":"plain",Wx,g,{titles:Kx})}
    ...
    ${s==="rich"?tv(e,n,t,i,a):h`
        ${Vh(e,n,a)}
        ${le(e,r.value,b=>i(C=>{C.value=b},"value"),{showResolved:!0,label:s==="countdown"?"Until":"Text",key:`${a}-value`})}
        ${Nl(e,s==="countdown",r.value,b=>g(b?"countdown":"plain",null))}
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${He(d,me(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function tv(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=me(e),d=Math.max(0,o.findIndex(_=>_.id===wa.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Le(e.config,t,n).size??r.fontSize,g=(_,I)=>{Ot.delete(s),i(R=>{_(R),lc(R)},I)},y=(_,I)=>g(R=>{let Y=R.parts?.find(x=>x.id===c.id);Y&&_(Y)},I?`part-${c.id}-${I}`:void 0),b=(_,I)=>{wa.set(s,_),Ot.delete(s),Ae(I)},C=(_,I)=>{let R=ee();wa.set(s,R),g(Y=>{(Y.parts??=[]).push({id:R,value:_})}),Rh(I,go(`${a}-part-${R}`),!0)},k=_=>g(I=>{I.parts&&Sa(I.parts,d,_)}),w=()=>{let _=o[d+1]??o[d-1];_&&wa.set(s,_.id),g(I=>{I.parts=(I.parts??[]).filter(R=>R.id!==c.id)})},$=o.map((_,I)=>{let R=Yx(_.value,l),Y=_.id===c.id,x=Al(_),S=R.kind==="value"?e.resolve(_.value):void 0,F=_.fontWeight===void 0?void 0:Ei.find(([O])=>O===_.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${Y?"true":"false"} class="part-chip ${R.kind} ${Y?"on":""}"
      aria-label=${Uh(_,I,l)} @click=${O=>b(_.id,O.currentTarget)}>
      <span class="part-dot" style=${`background:${Jx(_,p)}`}
        title=${x==="bands"?"By value, with its own bands":x==="pick"?"Its own colour":"The layer colour"}></span>
      ${R.kind==="text"?h`<span class="part-txt">${R.label===""?h`<span class="part-empty">empty</span>`:qx(R.label).map(O=>O.space?h`<span class="part-sp">${"\xB7".repeat(O.text.length)}</span>`:O.text)}</span>`:h`<span class="part-txt">${R.label}</span>`}
    ...
    </button>`}),D=r.rules.some(_=>_.partId===c.id),M=c.value.kind.kind==="literal",A=Al(c),H=c.fontSize!==void 0,T=Ei.find(([_])=>_===r.fontWeight)?.[1]??r.fontWeight,P=_=>{_>=Sl&&_<=Tl&&y(I=>{I.fontSize=_},"size")},j=A==="bands"?Ye(e.resolve(c.value)??""):[],G={layer:"Use the layer colour",...M&&A!=="bands"?{bands:"By value needs a live value"}:{}},X=(_,I)=>y(R=>{let Y={bands:R.bands??[],bandAboveColorHex:R.bandAboveColorHex??pe};_(Y),Y.bands.length>0?R.bands=Y.bands:delete R.bands,Y.bandAboveColorHex!==pe?R.bandAboveColorHex=Y.bandAboveColorHex:delete R.bandAboveColorHex},I);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${_=>C(V(""),_.currentTarget)}>${W("text")}<span>Add text</span></button>
        <button type="button" class="small" title="Add a part that shows a live value"
          @click=${_=>C({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},_.currentTarget)}>${W("braces")}<span>Add value</span></button>
      </div>
    </div>
    <div class="part-editor">
      <div class="part-head">
        ...
        <span class="spacer"></span>
        <button type="button" class="icon" title="Move left" aria-label="Move left" ?disabled=${d===0} @click=${()=>k(d-1)}>${W("left")}</button>
        <button type="button" class="icon" title="Move right" aria-label="Move right" ?disabled=${d===u-1} @click=${()=>k(d+1)}>${W("right")}</button>
      ...
      ${le(e,c.value,_=>y(I=>{I.value=_},"value"),{showResolved:!0,label:M?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ...
      ${ie("Colour",A,Ux,_=>y(I=>{if(_==="layer"){delete I.colorHex,delete I.coloring;return}if(_==="pick"){delete I.coloring,I.colorHex=Ll(p,"#FFFFFF")?"#64D2FF":p;return}delete I.colorHex,I.coloring="bands",(I.bands?.length??0)===0&&(I.bands=ro(Ye(e.resolve(I.value)??"")))}),{def:"layer",titles:G,...M&&A!=="bands"?{disabled:{bands:!0}}:{}})}
      ${A==="pick"?ye("Part colour",c.colorHex,_=>y(I=>{I.colorHex=_??p},"color")):f}
      ${A==="bands"?h`
        ${oo({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??pe},c.colorHex??p,X,j.length===1?j[0]:void 0)}
        <div class="hint">These bands belong to this part. Another value in the same layer keeps its own.</div>`:f}
      <div class="field seg-field">${Ve("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>y(_=>{delete _.fontWeight})})}
        ${ao("Weight",c.fontWeight,Ei,_=>y(I=>{I.fontWeight=_}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Ve("Font size",H?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(_=>{delete _.fontSize})}:void 0,po(c.fontSize??m,P,{step:1,min:Sl,max:Tl}))}
        ${ho(c.fontSize,_=>{_===void 0?y(I=>{delete I.fontSize},"size"):P(_)},{step:1,min:Sl,max:Tl,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:H?"Part font size":`Part font size, ${m} pt from the layer`,...H?{}:{lead:W("link")}})}
      </label>
    </div>
  </div>`}function Wh(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(x=>x.payload.id===a),o=`el-${a}`,s=(x,S)=>e.update(F=>x(F.elements[r]),S?`${o}-${S}`:void 0),l=Le(e.config,t,n),d=l.frame,c=(x,S)=>e.update(F=>ke(F,t,a,{frame:Sr(d,x)}),`${o}-${S}-${t}`),u=Ee(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=x=>u[x],g=!1,y=x=>Zn(n)===void 0?f:ye(x,Zn(n),S=>s(F=>{Zn(F)!==void 0&&(F.payload.colorSlot.baseColorHex=S??"#FFFFFF")},"color"),!1,p),b,C={},k=[],w,$;switch(n.kind){case"text":{let x=(S,F)=>s(O=>S(O.payload),F);w=ev(e,n,t,x,o),g=!n.payload.countdown&&!st(n.payload),$=h`
        <div class="fgroup">
        ...
        ${Mb({label:"Align",value:n.payload.alignment??"center",options:$x,def:"center",set:S=>s(F=>{let O=F.payload;S==="center"?delete O.alignment:O.alignment=S})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:Cx,def:"1",set:S=>s(F=>{let O=F.payload;S==="2"?O.lineLimit=2:delete O.lineLimit})})}
        ...
        ${g?Gx(e,n.payload,x,y("Main colour")):f}`;break}case"icon":w=h`
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,$=hn(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let x=n.payload,S=(O,K)=>s(J=>O(J.payload),K),F=x.style==="dots";w=h`
        ${le(e,x.value,O=>S(K=>{K.value=O},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${F?h`
            ${le(e,x.total??nh(x),O=>S(K=>{K.total=O},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${tr} dots are drawn.</div>`:h`<div class="fgroup">${Vx(e,x,{min:u.minValue,max:u.maxValue},o,S)}</div>`}`,g=!0,$=h`
        <div class="grid2">
          ${ie("Style",x.style,tx,O=>S(K=>{O==="dots"&&K.total===void 0&&(K.total=nh(K)),O!=="dots"&&delete K.total,K.style=O}),{titles:nx,def:u.style})}
        ...
        ${ie("Colour",x.coloring,Ml,O=>S(K=>{K.coloring=O,O==="bands"&&K.bands.length===0&&(K.bands=ro([K.minValue,K.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${oo(x,x.colorSlot.baseColorHex,S,Ye(e.resolve(x.value)??"")[0])}`:f}
        </div>
        ${F?f:h`
          <div class="fgroup">
          <div class="grid2">
          ...
          </div>`}`;break}case"chart":{let x=n.payload,S=(E,L)=>s(de=>E(de.payload),L),F=u.historyMinutes,O=u.historyPoints,K=x.historyMinutes>0,J=K&&x.source==="statistics",re=K&&!J,$e=K?J?"statistics":"history":"value",Tt=J?Yi:In,Vt=_n(x)??zn(x),Pe=x.value.kind.kind==="entityState",be=Vt===void 0?void 0:e.historySeries(Vt),Ge=K&&Pe?be??"":e.resolve(x.value)??"",Je=x.historyPoints<1,Om=re&&Pe&&Vt!==void 0?e.historyReadings?.(Vt):void 0,ad=Lx(Je,Om,ei(x.historyMinutes)),rd=Rl(a,x.historyMinutes,Tt),ko=K&&Pe?_s(Ge):{values:Ye(Ge),holes:[]},ai=ko.values,od=E=>x.limit>0&&E.length>x.limit?x.takeFromEnd?E.slice(E.length-x.limit):E.slice(0,x.limit):E,Bm=od(ai),pt=zs(Bm,ot(x.smoothing),ko.holes.length>0?od(ko.holes):[]),Vm=!K&&Pe&&ai.length===1,$o=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),sd=me(e),Ha=x.scaleFrom!==void 0&&$o.some(E=>E.payload.id===x.scaleFrom);w=h`
        ${le(e,x.value,E=>S(L=>{L.value=E},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        <div class="fgroup">
        ${ie("Draw",$e,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>S(L=>{if(E==="value"){L.historyMinutes=0;return}L.source=E==="statistics"?"statistics":"history";let de=L.historyMinutes||ar;L.historyMinutes=E==="statistics"?Math.min(de,Jo):Math.min(de,rr)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${J?h`
            ...
            <div class="grid2">
              ${$l(a,x.historyMinutes,F,E=>S(L=>{L.historyMinutes=E}),Yi)}
              ${ie("Per",x.statPeriod,Qa,E=>S(L=>{L.statPeriod=E}),{def:Gi})}
            </div>
            ${rd?Cl(x.historyMinutes,E=>S(L=>{L.historyMinutes=E},"span"),!0):f}
            ${ie("Read",x.statType,Wo,E=>S(L=>{L.statType=E}),{def:Ui})}
        ...
        ${re?h`
            ${Pe?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${$l(a,x.historyMinutes,F,E=>S(L=>{L.historyMinutes=E}))}
              <div class="field readings-field">${Ve("Points",{atDefault:x.historyPoints===O,title:`Back to ${O<1?"every one":`${O} averaged`}`,reset:()=>S(E=>{E.historyPoints=O})})}
                <div class="readings-row">
                  ...
                  ${Je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      data-scrub @pointerdown=${Ea(x.historyPoints,E=>S(L=>{L.historyPoints=Math.round(E)},"hpoints"),{step:1,min:or,max:Lt})}
                      @input=${we(E=>{let L=Number(E);E.trim()!==""&&Number.isFinite(L)&&L>=1&&S(de=>{de.historyPoints=Math.round(L)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${rd?Cl(x.historyMinutes,E=>S(L=>{L.historyMinutes=E},"span")):f}
            ...
            ${ad===void 0?f:h`<div class="hint keep">${ad}</div>`}
        ...
        ${K?h`
            ${Be("Show gaps",x.gaps===!0,E=>S(L=>{E?L.gaps=!0:delete L.gaps}),u.gaps===!0)}
            ${Dt(e)}
        ...
        ${ai.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${Mx(pt)}</span>${ai.length===pt.length?h` · ${pt.length} ${pt.length===1?"value":"values"}`:h` · ${pt.length} of ${ai.length}`}</span></div>`:f}
        ...
        ${K&&x.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",x.limit,E=>S(L=>{L.limit=Math.max(0,Math.round(E??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${x.limit<=0?f:ie("Keep",x.takeFromEnd?"end":"start",K?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],E=>S(L=>{L.takeFromEnd=E==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${Ce("Smooth data",ot(x.smoothing)??"off",Ub,E=>S(L=>{let de=ot(E);de===void 0?delete L.smoothing:L.smoothing=de}),{def:ot(u.smoothing)??"off"})}
        ${Dt(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,g=!0;let Gm=(()=>{if(Ha)return!0;if(x.scale==="fixed")return x.minValue<0&&x.maxValue>0;let E=pt.filter(Fa=>Number.isFinite(Fa));if(E.length===0)return!0;let L=Math.min(...E,x.thresholdValue??1/0),de=Math.max(...E,x.thresholdValue??-1/0);return L<0&&de>0})(),Gt=qp(x);k=pt,$=h`
        <div class="grid2">
          ${ie("Style",x.style,Eh,E=>S(L=>{L.style=E}),{def:u.style})}
          ${x.style==="bars"?ae("Bar gap",x.barGap,E=>S(L=>{L.barGap=Math.max(0,E??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):hn(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${x.style==="bars"?h`
          <div class="fgroup">
          <div class="grid2">
            ${ae("Corner radius",Yt(x.barRadius),E=>S(L=>{let de=Math.max(0,E??di);de===di?delete L.barRadius:L.barRadius=de},"barradius"),{step:.5,min:0,def:Yt(u.barRadius),unit:"pt"})}
          </div>
          ${Be("Round top only",Xt(x.barCorners)==="top",E=>S(L=>{E?L.barCorners="top":delete L.barCorners}),Xt(u.barCorners)==="top")}
          ${Dt(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>
          </div>
          <div class="fgroup">
          ${Gt.fill===void 0?f:vl(Gt.fill,x.fillColorHex,E=>S(L=>{E===void 0?delete L.fillColorHex:L.fillColorHex=E},"fillcol"))}
          ${Be("Border",x.barBorderWidth!==void 0,E=>S(L=>{E?L.barBorderWidth=1:delete L.barBorderWidth}),!1)}
          ${x.barBorderWidth===void 0?f:h`
            ${ae("Border width",x.barBorderWidth,E=>S(L=>{L.barBorderWidth=Math.min(Math.max(E??1,0),nr)},"barborderw"),{step:.5,min:0,max:nr,def:1,unit:"pt"})}
            ${Gt.border===void 0?f:vl(Gt.border,x.barBorderColorHex,E=>S(L=>{E===void 0?delete L.barBorderColorHex:L.barBorderColorHex=E},"barbordercol"))}
            ${Be("Open at base",x.barBorderOpenBase===!0,E=>S(L=>{E?L.barBorderOpenBase=!0:delete L.barBorderOpenBase}),!1)}`}
          ${Dt(e)}
          ...
          <div class="fgroup">
          ${ie("Curve",x.curve??"straight",Vb,E=>S(L=>{E==="straight"?delete L.curve:L.curve=E}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Dt(e)}
          </div>
          ${x.style==="area"?h`
            <div class="fgroup">
            ${ie("Fill",qt(x.fillStyle),Gb,E=>S(L=>{E==="flat"?delete L.fillStyle:L.fillStyle=E}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:qt(u.fillStyle)})}
            ${Gt.fill===void 0?f:vl(Gt.fill,x.fillColorHex,E=>S(L=>{E===void 0?delete L.fillColorHex:L.fillColorHex=E},"fillcol"))}
            ${Dt(e)}
            </div>`:f}`}
        <div class="fgroup">
        <div class="grid2">
          ${ie("Scale",x.scale,Wb,E=>S(L=>{L.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${ie("Baseline",x.baseline,Kb,E=>S(L=>{L.baseline=E}),{def:u.baseline})}
        </div>
        ${$o.length===0?f:Ce("Same scale as",Ha?x.scaleFrom:"",[["","Its own"],...$o.map(E=>[E.payload.id,He(E,sd)])],E=>S(L=>{E?L.scaleFrom=E:delete L.scaleFrom}),{def:""})}
        ...
        ${!Ha&&x.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",x.minValue,E=>S(L=>{L.minValue=E??0},"cmin"),{def:u.minValue})}
              ${ae("Max",x.maxValue,E=>S(L=>{L.maxValue=E??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(L=>{E=Kc(L,a,de=>He(de,sd))}),E&&e.selectLayer(E)}}>${W("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        <div class="fgroup">
        ${ie("Colour",x.coloring,Ml,E=>S(L=>{L.coloring=E,E==="bands"&&L.bands.length===0&&(L.bands=ro(pt))}),{def:u.coloring})}
        ...
        ${x.coloring==="bands"?h`
          ...
          ${oo(x,x.colorSlot.baseColorHex,S,pt,x.style==="bars"?{...x.fillColorHex===void 0?{}:{fillHex:x.fillColorHex},...x.barBorderColorHex===void 0?{}:{borderHex:x.barBorderColorHex},border:x.barBorderWidth!==void 0}:void 0)}
          ${x.style==="area"?h`${Be("Band fill",x.fillBands,E=>S(L=>{L.fillBands=E}),u.fillBands)}
        ...
        </div>`;let Co=(E,L)=>Ne(E,a).filter(de=>de.payload.chartAnchor?.at===L&&de.payload.chartAnchor.place==="through"),ld=(E,L)=>Ne(E,a).some(de=>de.payload.chartAnchor?.at===L),dd={threshold:E=>Co(E,"threshold"),now:E=>Co(E,"now"),zero:E=>Co(E,"zero"),times:E=>on(E,a),dots:E=>Dn(E,a),grid:E=>On(E,a)},Um={threshold:E=>{ld(E,"threshold")?En(E,a,"threshold"):Fc(E,a,x.thresholdValue??zl(pt))},now:E=>{ld(E,"now")?En(E,a,"now"):Ic(E,a,!0)},zero:E=>{gs(E,a)},times:E=>{Nn(E,a)},dots:E=>{ms(E,a)},grid:E=>{fs(E,a)}},ri={};Ln(x)||(ri.times=Je&&re?"Clock times need evenly spaced readings. Set Points to Average.":"Clock times need a recorded span. Set Draw to Recorded history."),x.style==="bars"&&(ri.dots="Dots need a line or area chart. Set Style to Line or Area.");let So=E=>dd[E](e.config).length>0;C={};for(let[E,L]of Object.entries(ri))C[`draw:${E}`]=L;let Wm=([E,L])=>{let de=So(E),Fa=de?void 0:ri[E],cd=`draw:${E}`;return h`<div class="xr-row" role="row">
          <span role="cell"><span class="xr-name">${L}</span></span>
          <span role="cell"></span>
          <span role="cell"><button type="button" class="xtog ${de?"on":""}" role="switch" aria-checked=${de?"true":"false"}
            aria-label=${L} ?disabled=${Fa!==void 0} data-extra=${cd}
            title=${Ol(cd,Fa??(de?`Remove the ${L.toLowerCase()} from this chart`:`Add ${L.toLowerCase()} to this chart`))}
            @click=${()=>e.update(To=>{if(de)for(let Km of dd[E](To))fe(To,Km.payload.id);else Um[E](To)})}>${de?h`<span aria-hidden="true">✓</span>`:W("plus")}</button></span>
          <span role="cell"></span>
        </div>`};b=h`
        ...
        ${jr.filter(([E])=>ri[E]!==void 0&&!So(E)).map(([E])=>h`<div class="hint keep">${ri[E]}</div>`)}
        ${So("zero")&&!Gm?h`<div class="hint warn">These readings never cross zero, so the zero line is not drawn.</div>`:f}
        ${Dt(e)}`;break}case"timeline":{let x=n.payload,S=(be,Ge)=>s(Je=>be(Je.payload),Ge),F=u.historyMinutes,O=x.value.kind.kind==="entityState",K=bt(x),J=K===void 0?void 0:e.historySeries(K),re=lt(x)*60,$e=oa(J??"",an),Tt=Rl(a,x.historyMinutes),Vt=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,Pe=Qb($e,re,Vt===void 0?void 0:e.hass.states[Vt]?.state,Vt?.split(".")[0]);w=h`
        ...
        <div class="fgroup">
        ${$l(a,x.historyMinutes,F,be=>S(Ge=>{Ge.historyMinutes=be}))}
        ${Tt?Cl(x.historyMinutes,be=>S(Ge=>{Ge.historyMinutes=be},"span")):f}
        ...
        ${$e.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Ix($e,re)}</span></span></div>`:f}
        ${Fx($e)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${ex(x,S,Pe,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
...
`;break}case"shape":w=h`<div class="grid2">
        ...
        ${n.payload.kind==="line"?Hx(t,d,c):f}`,$=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,x=>s(S=>{S.payload.thickness=x??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        <div class="fgroup">
        ...
        ${Qn("Zoom",x.zoom,J=>S(re=>{re.zoom=J},"zoom"),{min:Qs,max:4,step:.05,def:1,format:J=>`${J.toFixed(2)}x`,unit:"x"})}
        ...
        ${Dl(e,n.payload,(x,S)=>s(F=>x(F.payload),S),o)}
        ...
        <div class="hint">The clock times of that ${K}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,$=Nx(x,S,u,"ct",h`
        ...
        ${Dt(e)}`,$=h`
        ${ie("Dots",x.dots,Th,re=>S($e=>{$e.dots=re}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ...
          ${Il("Dot colour",x.colorHex,"Series colour",re=>S($e=>{re===void 0?delete $e.colorHex:$e.colorHex=re},"dotcol"))}
        </div>
        ...
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let D=g||Zn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&st(n.payload)?"Layer colour":"Colour"),M=xs(e.config,n),A=M?{kind:{kind:"entityState",...M}}:void 0,H=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,T=iv[n.kind],P=av[n.kind],j=kl(n.payload,u,T),G=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,X=e.config.perFamily[t]?.placements[a]?.size!==void 0,_=kl(n.payload,u,P)||G!==void 0&&l.size!==void 0&&l.size!==u[G],I=rn(e.config,a),R=(x,S)=>()=>s(F=>Jr(F.payload,u,x),S),Y=h`<section class="sec name-sec" data-open="true" style=${`--c:${te.place}`}>
    <div class="sec-h pinned">
      ...
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${qh(n,me(e))}
        @input=${we(x=>s(S=>{let F=pv(x);F===void 0?delete S.payload.name:S.payload.name=F},"name"))} />
    </div>
  </section>`;return h`
    ${Y}
    ${Se(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:Vh(e,n,o)}${w}`,{color:te.content,icon:"content",summary:Pl(e,n),...j?{reset:()=>s(x=>{Jr(x.payload,u,T),x.kind==="text"&&ga(x.payload.rules)},"reset-content")}:{}})}
    ${$===void 0&&D===void 0?f:Se(e,"look",n.kind==="image"?"Picture":"Look",h`${$??f}${D??f}`,{color:te.look,icon:n.kind==="image"?"image":"look",...so(n)?{summary:so(n)}:{},..._?{reset:()=>e.update(x=>{Jr(x.elements[r].payload,u,P),X&&ke(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Extras",lv(e,n,b,C,k),{color:te.numbers,icon:"text",summary:sv(e,n),...I.length>0||Ne(e.config,a).length>0||on(e.config,a).length>0||Dn(e.config,a).length>0||On(e.config,a).length>0||kl(n.payload,u,ph)?{reset:()=>e.update(x=>{for(let F of rn(x,a))fe(x,F.payload.id);for(let F of Ne(x,a))fe(x,F.payload.id);for(let F of on(x,a))fe(x,F.payload.id);for(let F of Dn(x,a))fe(x,F.payload.id);for(let F of On(x,a))fe(x,F.payload.id);let S=x.elements.find(F=>F.payload.id===a);S&&Jr(S.payload,u,ph)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?nv(e,n):f}
    ${Se(e,"states","States",nm(e,n.payload.rules,n.kind,x=>x.elements.find(S=>S.payload.id===a)?.payload.rules,`rules-${a}`,A,H),{color:te.states,icon:"states",summary:ha(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:zx(e,n,t)}
    ${i.tap===!1?f:Px(e,n)}`}function nv(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?on(e.config,t):us(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);if(!m)return;let g=m.payload.frame;m.payload.frame={...Le(p,o,m).frame},i?Nn(p,t):hs(p,t,he[o==="inline"?"rectangular":o]),m.payload.frame=g}),l=a.length>0,d=a.map(p=>({el:p,lead:W("clock"),title:r,kind:i?"Times":"Timestamp"})),c=i?"timeline:times":"image:time",u=h`
    ${jh(i?"timeline":"image")}
    <div class="field list-field"><span>Draw</span>
      <div class="adders" @pointerover=${Mi} @focusin=${Mi}>
        <button class="small ${l?"on":""}" ?disabled=${l} aria-pressed=${l?"true":"false"} data-extra=${c}
          title=${Ol(c,l?`${r} is on this ${i?"timeline":"picture"}. Remove it in the list below.`:`Add ${r.toLowerCase()}`)}
    ...
    ${l?h`
      ${Bl(e,d,{icon:"close",danger:!0,label:p=>`Delete this ${p}`,run:p=>e.update(m=>fe(m,p))})}
      <div class="hint">Click the row to open its main settings here. More settings selects that layer. The ×
        deletes it, and Undo brings it back.</div>`:f}`;return Se(e,"numbers","Extras",u,{color:te.numbers,icon:"clock",summary:l?`${r} layer`:"None yet",...l?{reset:()=>e.update(p=>{for(let m of a)fe(p,m.payload.id)})}:{}})}var iv={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[],chartDots:[],chartGrid:[],imageTime:[]},av={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","barBorderWidth","barBorderColorHex","bandAboveFillColorHex","bandAboveBorderColorHex","barBorderOpenBase","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["dots","size","colorHex"],chartGrid:["lines","colorHex","thickness"],imageTime:[]};function uh(e,n){return h`<div class="field readout"><span>Chart</span><span class="readout-v">${n?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(n.payload.id)}>${He(n,me(e))}</button>`:"None"}</span></div>`}var ph=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function Dl(e,n,t,i){let a=n.action;return h`
    ${Ce("Tap action",a.type,gx,r=>t(o=>{o.action=Lh(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?Ct(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?_h(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?Ph(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var rv=24;function ov(e,n){let t=[],i=1/0;for(let r of se){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Uc(e.config,n,r);o&&(t.push(`${ne(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<rv;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function sv(e,n){let t=n.payload,i=rn(e.config,t.id),a=Ne(e.config,t.id),r=on(e.config,t.id),o=Dn(e.config,t.id),s=On(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(gt.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(yt.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function lv(e,n,t,i={},a=[]){let r=n.payload.id,o=me(e),s=rn(e.config,r),l=on(e.config,r),d=Dn(e.config,r),c=On(e.config,r),u=Ne(e.config,r),p={};for(let[H]of gt){let T=e.resolve({kind:{kind:"chartStat",layer:r,stat:H}});T!==void 0&&T.trim()!==""&&(p[H]=T)}let m=a.filter(H=>Number.isFinite(H)),g=n.payload.nowIndex===void 0?NaN:Number(e.resolve(n.payload.nowIndex)),y=Number.isFinite(g)&&a.length>0?Math.min(a.length-1,Math.max(0,Math.round(g))):void 0,b=y===void 0||!Number.isFinite(a[y])||m.length===0?void 0:qi(a[y],Math.max(...m)-Math.min(...m)),C={values:a,texts:p,...y===void 0?{}:{now:y},...n.payload.thresholdValue===void 0?{}:{threshold:n.payload.thresholdValue}},k=(H,T)=>rn(H,r).filter(P=>P.payload.value.kind.kind==="chartStat"&&P.payload.value.kind.stat===T),w=(H,T)=>Ne(H,r).filter(P=>P.payload.chartAnchor?.at===T&&P.payload.chartAnchor.place!=="through"),$=(H,T,P,j,G,X,_)=>h`
    <button type="button" class="xtog ${T>0?"on":""}" role="switch" aria-checked=${T>0?"true":"false"}
      aria-label=${G} data-extra=${H}
      title=${Ol(H,T===0?P:T===1?j:`${j}: all ${T} of them`)}
      @click=${()=>e.update(I=>{if(T>0)for(let R of _(I))fe(I,R.payload.id);else X(I)})}>${T>0?h`<span aria-hidden="true">✓</span>`:W("plus")}</button>`,D=h`<div class="xreadings" role="table" aria-label="Readings" @pointerover=${Mi} @focusin=${Mi}>
    <div class="xr-row xr-head" role="row">
    ...
    ${Wp.map(H=>{let T=H.stat!==void 0?p[H.stat]:b,P=H.stat===void 0?"":(gt.find(([G])=>G===H.stat)?.[1]??H.label).toLowerCase(),j=H.marker==="now"?"the reading at now":`the ${(yt.find(([G])=>G===H.marker)?.[1]??H.label).toLowerCase()}`;return h`<div class="xr-row" role="row">
        <span role="cell"><span class="xr-name">${H.label}</span></span>
        <span role="cell"><span class="xr-v nums">${T??""}</span></span>
        <span role="cell">${H.stat===void 0?f:$(`number:${H.stat}`,k(e.config,H.stat).length,`Print the ${P} as a number`,`Remove the ${P} number`,`${H.label} number`,G=>{Mc(G,r,H.stat)},G=>k(G,H.stat))}</span>
        <span role="cell">${H.marker===void 0?f:$(`marker:${H.marker}`,w(e.config,H.marker).length,`Put a marker over ${j}`,`Remove the marker over ${j}`,`${H.label} marker`,G=>{cs(G,r,H.marker)},G=>w(G,H.marker))}</span>
      </div>`})}
  </div>`,M=[...s.map(H=>({el:H,lead:e.resolve(H.payload.value)??"--",title:He(H,o),kind:"Number"})),...u.map(H=>{let{at:T,place:P}=H.payload.chartAnchor,j=yt.find(([X])=>X===T)?.[1]??"Reading";if(P==="through")return{el:H,lead:T==="now"?"\u2502":"\u2500",title:T==="zero"?"Zero":j,kind:"Line"};let G=H.kind==="text"?e.resolve(H.payload.value)??"\u25CF":H.kind==="icon"?uv(e.resolve(H.payload.symbol)):"\u25C6";return{el:H,lead:G,title:j,kind:"Marker"}}),...l.map(H=>({el:H,lead:W("clock"),title:"Clock times",kind:"Times"})),...d.map(H=>({el:H,lead:W("chartDots"),title:"Reading dots",kind:"Dots"})),...c.map(H=>({el:H,lead:W("chartGrid"),title:"Grid lines",kind:"Grid"}))],A=M.length;return h`
    <div class="hint keep">Each one you switch on is a layer in this chart's group.</div>
    ${jh("chart",i,n.payload.style==="bars",C)}
    ${t??f}
    ...
    ${A===0?f:h`
      ...
      ${Bl(e,M,{icon:"close",danger:!0,label:H=>`Delete this ${H}`,run:H=>e.update(T=>fe(T,H))})}
      <div class="hint">Click a row to set its value, colour and size here. More settings selects that layer.
        On the preview, click right on a dot to pick the dots.</div>`}`}var $a,Kh="wrist-assistant-extras-preview",xo=(()=>{try{return window.localStorage.getItem(Kh)!=="off"}catch{return!0}})();function hh(e,n){xo=e;try{window.localStorage.setItem(Kh,e?"on":"off")}catch{}Ae(n)}function Mi(e){if(!xo)return;let n=e.target?.closest?.("[data-extra]")?.getAttribute("data-extra");!n||n===$a||($a=n,Ae(e.currentTarget))}function Ol(e,n){return xo?n:`${yl(e)} ${n}.`}function jh(e,n={},t=!1,i={}){if(!xo)return h`<button class="link xprev-show" @click=${l=>hh(!0,l.currentTarget)}>
      ${W("show")}<span>Show preview</span></button>`;let a=e==="timeline"?"timeline:times":e==="image"?"image:time":void 0,r=$a!==void 0&&gl($a)===e?$a:a,o=r===void 0?void 0:n[r],s=e==="image"?"picture":e;return h`<div class="xprev">
    <span class="well">${Kp(e,r,t,i)}</span>
    <span class="xprev-t">
      <b>${r===void 0?"Preview":jp(r)}</b>
    ...
    <button class="icon xprev-hide" title="Hide the preview" aria-label="Hide the preview"
      @click=${l=>hh(!1,l.currentTarget)}>${W("hide")}</button>
  </div>`}function Bl(e,n,t){return h`<div class="chart-numbers">${_p(n,a=>a.el.payload.id,({el:a,lead:r,title:o,kind:s})=>{let l=a.payload.id,d=s.toLowerCase();return h`
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function dv(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===t);m&&c(m)},`${i}-${u}`),o=Ee(n.kind).payload,s=Zn(n),l=s===void 0?f:ye("Colour",s,c=>r(u=>{Zn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ...
        ${d&&d.place!=="through"?mh(e,t,d,r):f}
        <div class="grid2">
          ${hn(e,n,a,"Font size",{step:1,min:4,def:o.fontSize})}
          ${n.payload.countdown||st(n.payload)?f:l}
        </div>`}case"icon":return h`
        ${d?mh(e,t,d,r):le(e,n.payload.symbol,c=>r(u=>{u.kind==="icon"&&(u.payload.symbol=c)},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${i}-symbol`,setSymbolPath:c=>r(u=>{u.kind==="icon"&&(c?u.payload.path=c:delete u.payload.path)},"symbol")})}
        <div class="grid2">
        ...
        ${ie("Style",c.style,Eh,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
        ...
        ${ie("Picture",c.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],u=>r(p=>{p.kind==="image"&&(p.payload.contentMode=u)},"mode"),{def:o.contentMode})}`}case"tap":return Dl(e,n.payload,(c,u)=>r(p=>{p.kind==="tap"&&c(p.payload)},u??"action"),i);case"chartTimes":{let c=n.payload;return h`
        ...
        ${ye("Colour",c.colorHex,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.colorHex=u??Ft)},"colour"),!1,Ft)}`}default:return h`${l}`}}function mh(e,n,t,i){let a=yt.filter(([r])=>It(r)||r===t.at);return h`
    <div class="grid2">
    ...
    </div>`}function cv(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=je(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=vs(e.config,n);return h`
    ${Be("Tappable",a!==void 0,s=>e.update(l=>{s?fr(l,i):gr(l,i)}))}
    ${a?h`<div class="value-editor">
          ${Dl(e,a.payload,r,`${t}-attached`)}
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${cr(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...os}})}>${W("reset")}</button>`}
            </div>
          </div>
        </div>
        ${ov(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${_t(o)}</b>.</div>`}`}function fh(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function uv(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function He(e,n){return e.payload.name?e.payload.name:qh(e,n)}function pv(e){let n=e.trim();return n===""?void 0:n}function qh(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=yt.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return fh(Me(e.payload.value,n));case"icon":return fh(Me(e.payload.symbol,n));case"gauge":return Me(e.payload.value,n);case"chart":return Me(e.payload.value,n);case"timeline":return Me(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines";case"imageTime":return"Timestamp"}}function Yh(e,n){let t=dt(e.config,n.id),i=me(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Se(e,"content","Group",h`
    ...
    ${Bl(e,t.map(r=>({el:r,lead:W(r.kind),title:He(r,i),kind:dn[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Zi(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:te.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Xh(e,n){if(n==="inline")return hv(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ne(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ne(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=yo(e.config,n),r=t.backgroundColorHex?Ie(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ie(t.borderColorHex)} border`:"no border";return h`
    ...
    ${Se(e,"content","Inline text",h`
      ...
      ${Nl(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:te.content,icon:"text",summary:Oe(`${n.label?`${n.label}: `:""}${Me(n.value,i)}`,48)})}
    ${Se(e,"symbol","Symbol",h`
      ${Sh(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:te.look,icon:"icon",summary:n.symbol||"None"})}`}function mv(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    <div class="fgroup">
    ...
    ${a==="text"&&n.bezelText?h`
      ...
      ${Nl(e,n.bezelCountdown===!0,n.bezelText,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:f}
    ${a==="gauge"&&n.bezelGauge?fv(e,n.bezelGauge,t):f}
    </div>`}function fv(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?le(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var c$=se.map(e=>[e,ne(e)]),Vl={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},gv=Object.keys(Vl),lo=["color","text","fontSize","fontWeight","visibility"];function yv(e,n=!1){let t=ea[e].filter(i=>!n||lo.includes(i));return gv.filter(i=>t.includes(De[i]))}function Jh(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Xx(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var bv={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Qr(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Oe(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Zh(e){if(!e||_e(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function Me(e,n){return`${Ma(e,n)}${Zh(e.format)}`}function Ma(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Oe(t.value,40)}"`:"(empty)";case"entityState":return Qr(t,n);case"entityAttribute":return t.attribute?`${Qr(t,n)} \xB7 ${t.attribute}`:Qr(t,n);case"entityAge":return`age of ${Qr(t,n)}`;case"aggregate":return xv(t.aggregate);case"time":return bv[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Oe(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(gt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Ma(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function xv(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Sa(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function vv(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.map((s,l)=>wv(e,s,l,n.length,t,o,`${a}-${s.id}`,r))}
    <div class="adders"><button class="small" @click=${()=>o(s=>{s.push(ta())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function wv(e,n,t,i,a,r,o,s){let l=e.liveBranch(n),d=e.forced.get(n.id)??"live",c=m=>d==="live"?m==="live":d==="otherwise"?m==="otherwise":d.caseId===m,u=(m,g)=>r(y=>{let b=y.find(C=>C.id===n.id);b&&m(b)},g),p=s!==void 0&&n.partId!==void 0;return h`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(m=>Sa(m,t,t-1))}>${W("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(m=>Sa(m,t,t+1))}>${W("down")}</button>
      <button class="icon danger" title="Delete rule" @click=${()=>r(m=>{let g=m.findIndex(y=>y.id===n.id);g>=0&&m.splice(g,1)})}>${W("delete")}</button>
    </div>
    ${s===void 0?f:Jh(s,n.partId,me(e),m=>u(g=>{m?g.partId=m:delete g.partId}))}
    ...
    <div class="adders"><button class="small" @click=${()=>u(m=>{m.cases.push(Rs())})}>+ case</button></div>
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${Qh(e,n.otherwise,a,m=>u(g=>{g.otherwise&&m(g.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
    ...
    <div class="rule-head">
      ...
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>Sa(c.cases,t,t-1))}>${W("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>Sa(c.cases,t,t+1))}>${W("down")}</button>
    ...
    ${n.when.tests.map((c,u)=>$v(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(Ms())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=Vp(p,Pp(e.hass?.states));l(g=>{g.when.tests.push(...m)})}}>
        <option value="">+ preset…</option>
        ${Op.map(c=>h`<option value=${c.kind} title=${c.hint}>${c.label}</option>`)}
      </select>
    </div>
    ...
    ${Qh(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${s.pattern&&!Cv(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${gh(e,"From",s.value??V("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${gh(e,"To",s.upper??V("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=Sv(n.value)?Tv(s.options??[],u=>o(p=>{p.comparison.options=hl(u)},"options")):Re("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Ce("Comparison",s.kind,Zc.map(u=>[u,Ci[u]]),u=>o(p=>{p.comparison=As(p.comparison,u)}))}
    ${c}
  </div>`}function Cv(e){try{return new RegExp(e),!0}catch{return!1}}function gh(e,n,t,i,a){if(t.kind.kind!=="literal")return le(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Vn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${we(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function Sv(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function Tv(e,n){let t=Dp(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${Np.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function Qh(e,n,t,i,a,r=!1){let o=yv(t,r);return h`
    ...
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Un(d))})}}>
      ...
      ${o.map(s=>h`<option value=${s}>${Vl[s]}</option>`)}
    </select>`}var em=["setColor","setBorderColor","setBackgroundColor"];function Ev(e,n,t,i,a,r,o,s=!1){let l=!ea[i].includes(De[n.kind]),d=s&&!l&&!lo.includes(De[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
      <span>${Vl[n.kind]}${l?h` <span class="no">(ignored by ${i==="layout"?"layouts":`${i} layers`})</span>`:d?h` <span class="no">(ignored by a part)</span>`:f}</span>
      <span class="spacer"></span>
    ...
    ${tm(e,n,a,o)}
  </div>`}function tm(e,n,t,i){let a=vr(n.kind),r=f;if(a==="value"){let o=n.value??V("");if(em.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?ye("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=V(l??"#FFFFFF")},"color")):le(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{Hl.delete(a),Ae(d.target)}}>Show as table</button>
        ${s.ok?f:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${vv(e,n,t,i,a,o)}`:Mv(e,s.table,n[0],t,i,a,r,o)}function Mv(e,n,t,i,a,r,o,s){let l=(R,Y)=>e.update(x=>{let S=a(x);S&&R(S)},Y?`${r}-${Y}`:void 0),d=n.value??yh.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Sp(d)&&Rv(e.resolve(d)),p=ea[i],m=eo.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Cp[i]]:[],y=mp(n.columns,[...m,...g.filter(R=>R!==void 0)],p),b=Zr.get(r),C=t?t.partId:s?.some(R=>R.id===b)?b:void 0,k=s!==void 0&&C!==void 0,w=k?p.filter(R=>lo.includes(R)):p,$=k?y.filter(R=>!lo.includes(R)):[],D=(R,Y)=>{if(!t){R?Zr.set(r,R):Zr.delete(r),Ae(Y);return}l(x=>{let S=x[0];S&&(R?S.partId=R:delete S.partId)})},M=t?e.liveBranch(t):"none",A=t?e.forced.get(t.id)??"live":"live",H=R=>A!=="live"&&(A==="otherwise"?R==="otherwise":A.caseId===R),T=R=>{t&&e.setForced(t.id,H(R)?"live":R==="otherwise"?"otherwise":{caseId:R})},P=R=>{yh.set(r,R),n.rows.length!==0&&l(Y=>wp(Y,R),"lhs")},j=()=>{Zr.delete(r),l(R=>{xp(R,d??V(""),u),C!==void 0&&R[0]&&R[0].partId===void 0&&(R[0].partId=C)})},G=n.rows.map((R,Y)=>xh(e,{key:`${r}-${R.caseId}`,label:$p(R.comparison,x=>Me(x,me(e))),columns:y,changes:R.changes,live:M===R.caseId,forced:H(R.caseId),onForce:()=>T(R.caseId),when:Lv(e,R.comparison,`${r}-${R.caseId}`,(x,S)=>l(F=>{let O=F[0]?.cases.find(K=>K.id===R.caseId)?.when.tests[0];O&&x(O.comparison)},S&&`${R.caseId}-${S}`)),updChanges:(x,S)=>l(F=>{let O=F[0]?.cases.find(K=>K.id===R.caseId);O&&x(O.then)},S&&`${R.caseId}-${S}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${Y===0} @click=${()=>l(x=>cl(x,Y,Y-1))}>${W("up")}</button>
      <button class="icon" title="Move down" ?disabled=${Y===n.rows.length-1} @click=${()=>l(x=>cl(x,Y,Y+1))}>${W("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(x=>vp(x,R.caseId))}>${W("delete")}</button>`})),X=n.otherwise===void 0?f:xh(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:M==="otherwise",forced:H("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(R,Y)=>l(x=>{let S=x[0]?.otherwise;S&&R(S)},Y),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(R=>ul(R,!1))}>${W("close")}</button>`}),_=to.get(r),I=Av.filter(R=>w.includes(R)&&!y.includes(R));return h`
    <div class="states">
      ${le(e,d??V(""),P,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:Jh(s,C,me(e),D)}
      <div class="states-scroll"><table class="states-table">
          ...
          <tr>
            ...
            ${y.map(R=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${wt[R]} column`}
                @click=${Y=>{to.set(r,R),Ae(Y.target)}}>${W("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
        <tbody>
          ${G}
          ${X}
          ${n.rows.length===0&&n.otherwise===void 0?h`<tr><td class="empty-row" colspan=${y.length+2}>${gp(i)}</td></tr>`:f}
        </tbody>
      </table></div>
      ${$.length===0?f:h`<div class="hint warn">A part ignores ${bo($.map(R=>wt[R]))}. Pick Whole text to use ${$.length===1?"it":"them"}.</div>`}
      ${_===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${wt[_]} column? Its ${bh(n,_)} value${bh(n,_)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${R=>{to.delete(r),eo.get(r)?.delete(_),Ae(R.target),l(Y=>kp(Y,_))}}>Remove</button>
        <button class="small" @click=${R=>{to.delete(r),Ae(R.target)}}>Cancel</button>
      </div>`}
      <div class="states-add">
        ...
        ${n.otherwise===void 0?h`<button class="small" title="Add an Otherwise row at the bottom of the table" @click=${()=>l(R=>ul(R,!0))}>${W("plus")}<span>Add otherwise</span></button>
            <span class="states-add-note">${Br(i).otherwise}</span>`:f}
        ${I.length===0?f:h`<select class="chip-add" title="Add a column to the table" aria-label="Change another setting" @change=${R=>{let Y=R.target,x=Y.value;if(Y.value="",!x)return;let S=eo.get(r)??new Set;S.add(x),eo.set(r,S),Ae(Y)}}>
          <option value="" selected>Change another setting…</option>
          ${I.map(R=>h`<option value=${R}>${wt[R]}</option>`)}
        </select>
      ...
      <div class="states-switch">
        <button class="link" @click=${R=>{Hl.add(r),Ae(R.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function Rv(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var Av=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function bh(e,n){let t=0;for(let i of e.rows)Or(i.changes,n)&&(t+=1);return e.otherwise&&Or(e.otherwise,n)&&(t+=1),t}function Hv(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function xh(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{Hv(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${Fv(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Fv(e,n,t,i,a){let r=Or(t,n),o=go(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${wt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Un(hp[n]))}),Rh(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>De[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=wt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Iv(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Ah}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${ka.has(o)?h`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):tm(e,r,s,a)}
    ...
    </div>`}function Iv(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=vr(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${Ei.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??V(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(em.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ie(a):Me(i,me(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Me(i,me(e))}</span>`}function Ie(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Lv(e,n,t,i){let a=Gn(n.kind),r=ll(n.kind),o=(s,l,d,c)=>zv(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${we(s=>i(l=>{let d=As(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${sl.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${_v(s)}</option>`)}
    </select>
  ...
  </span>`}function _v(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return Ci[e]}}function zv(e,n,t,i,a,r,o){let s=go(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${Mh(e,s,o,n,t,l)}
  </span>`}var Ra=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:bs,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function om(e){return Ra.find(n=>n.kind===e)??Ra[0]}var im="#FF9F0A",vo="#8E8E93",Pv=["#FF453A","#FFD60A","#34C759"],sm=["#0A84FF","#34C759","#FF9F0A"];function Nv(e){return e?.attributes?.device_class==="battery"?Pv:sm}var Dv={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Ov(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Dv[Gl(e)]??{off:"circle",on:"circle.fill"}}function Bv(e){switch(Gl(e)){case"lock":return{kind:"equals",value:V("locked")};case"cover":case"valve":return{kind:"equals",value:V("open")};case"media_player":return{kind:"equals",value:V("playing")};default:return{kind:"isOn"}}}function Gl(e){return e.domain||e.entityId.split(".")[0]||""}function yn(e){return{...e,domain:Gl(e)}}function Vv(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Ri(e){return Math.round(e*1e4)/1e4}function ni(e,n,t){return Math.min(t,Math.max(n,e))}function Ul(e,n,t){let i=ze[e],a=ni(Ri(n/i.width),0,1),r=ni(Ri(t/i.height),0,1);return{x:Ri((1-a)/2),y:Ri((1-r)/2),width:a,height:r,rotationDegrees:0}}function Gv(e){let n=ze[e],t=ni(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:Ul(e,t*1.3,t*1.3),size:t}}function Uv(e){let n=ze[e],t=ni(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:Ul(e,n.width*.88,t*1.7),size:t}}function Wv(e){let n=ze[e],t=Math.min(n.width,n.height)*.9;return{frame:Ul(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function lm(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Kv(e){let n=ze[e],t=ni(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Ri(t/n.height),rotationDegrees:0}}}function jv(e){let n=ze[e],t=ni(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Ri(ni(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function qv(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Yv(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function fn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Yv(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Pt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function gn(e){return Ee(e)}function Wl(e,n){let t={kind:{kind:"entityState",...yn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function am(e){let n=Un("setIcon");return n.value=V(e),n}function ti(e){let n=Un("setColor");return n.value=V(e),n}function Xv(e,n){let t=ta(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...yn(e)}},a.comparison=Bv(e);let r=n.on!==n.off;return i.then=r?[am(n.on),ti(im)]:[ti(im)],t.otherwise=r?[am(n.off),ti(vo)]:[ti(vo)],t}function Jv(e){let n=ta(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...yn(e)}},i.comparison={kind:"isUnavailable"};let a=Un("setOpacity");return a.number=.35,t.then=[a],n}function rm(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Zv(e,n,t=sm){let i=n.max-n.min,a=rm(n.min+i/3),r=rm(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:V(a)},changes:[ti(t[0])]},{comparison:{kind:"between",value:V(a),upper:V(r)},changes:[ti(t[1])]},{comparison:{kind:"greaterThan",value:V(r)},changes:[ti(t[2])]}];return fp(Wl(e),o)}function Qv(e,n,t){let i=gn("icon"),a=Ov(n);return i.payload.symbol=V(a.off),i.payload.colorSlot.baseColorHex=vo,i.payload.rules=[Xv(n,a)],fn(e,i,t.family,Gv),e.elements.push(i),fr(e,i.payload.id,{type:"toggleEntity",...yn(n)}),i.payload.id}function ew(e,n,t){let i=gn("text");return i.payload.value=Wl(n,t.state),i.payload.rules=[Jv(n)],fn(e,i,t.family,Uv),e.elements.push(i),i.payload.id}function tw(e,n,t){let i=gn("gauge");i.payload.value=Wl(n);let a=Vv(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Zv(n,a,Nv(t.state))],fn(e,i,t.family,Wv),e.elements.push(i),i.payload.id}function nw(e,n,t){let i=gn("chart");return i.payload.value={kind:{kind:"entityState",...yn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",fn(e,i,t.family,lm),e.elements.push(i),i.payload.id}function iw(e,n,t){let i=gn("chart");return i.payload.value={kind:{kind:"entityState",...yn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",fn(e,i,t.family,lm),e.elements.push(i),i.payload.id}function aw(e,n,t){let i=yn(n),a=gn("text");a.payload.value=V(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=vo,fn(e,a,t.family,jv),e.elements.push(a);let r=t.state?.attributes?.device_class,o=gn("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=rs(i.domain,typeof r=="string"?r:void 0),fn(e,o,t.family,Kv),e.elements.push(o),o.payload.id}function rw(e,n,t){let i=gn("image");return i.payload.entity=yn(n),fn(e,i,t.family,qv),e.elements.push(i),i.payload.id}function dm(e,n,t,i){switch(n){case"toggle":return Qv(e,t,i);case"status":return ew(e,t,i);case"gauge":return tw(e,t,i);case"chart":return nw(e,t,i);case"history":return iw(e,t,i);case"doorHistory":return aw(e,t,i);case"camera":return rw(e,t,i)}}var ow=/^[a-z0-9_]+\.shared_(\d+)$/;function cm(e){return ow.test(e)}function sw(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function hm(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function mm(e,n){let t=new Map;for(let i of Es(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=hm(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${sw(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function lw(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);Ss(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),Ts(t,r=>ws(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function fm(e){let n=!1;return xr(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function dw(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function gm(e,n,t=[]){let i=n==="share"?lw(e,t):e,a=hi(i);return delete a.id,delete a.slotIndex,n==="share"&&delete a.hidden,a.dataSources=[],`${dw(a)}
`}function ym(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var cw="There is nothing to read here. Paste a complication first.",uw="This is not valid JSON. Check for a missing brace or a stray comma.",pw="This is valid JSON but not a complication. A complication starts with { and ends with }.",hw="This does not look like a complication.",um="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",mw="00000000-0000-4000-8000-000000000000";function fw(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function bm(e,n){let t=e.trim();if(t==="")return{ok:!1,error:cw};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:uw}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:pw};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${um}`};let o={...a,id:mw,slotIndex:0},s;try{s=pi(o)}catch(d){let c=d instanceof it||d instanceof Error?d.message:String(d);return{ok:!1,error:`${hw}

${fw(c)}`}}delete s.hidden;let l=ur(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${um}`}}return{ok:!0,config:s,raw:i}}function Kl(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=Es(e,(o,s)=>cm(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=cm(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:hm(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function xm(e,n){let t=structuredClone(e);Ss(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Ts(t,a=>ws(a,i)),t}function vm(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}var gw={rectangular:"Rectangular",circular:"Circular",corner:"Corner",inline:"Inline"};function wm(e,n){return{layers:e.elements.length,families:ua(e).map(t=>gw[t]??t),slots:n.filter(t=>t.required).length,missing:n.filter(t=>!t.required).length}}var km="import";function pm(e){let n="";for(let t=0;t<e.length;t+=32768)n+=String.fromCharCode(...e.subarray(t,t+32768));return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function yw(e){if(!/^[A-Za-z0-9_-]*$/.test(e)||e.length%4===1)return;let n=e.replace(/-/g,"+").replace(/_/g,"/")+"===".slice((e.length+3)%4);try{let t=atob(n),i=new Uint8Array(t.length);for(let a=0;a<t.length;a+=1)i[a]=t.charCodeAt(a);return i}catch{return}}async function $m(e,n){let t=new Blob([e]).stream().pipeThrough(n);return new Uint8Array(await new Response(t).arrayBuffer())}async function Cm(e,n={}){let t=new TextEncoder().encode(e);if(n.compress!==!1&&typeof CompressionStream=="function")try{return`z${pm(await $m(t,new CompressionStream("gzip")))}`}catch{}return`t${pm(t)}`}async function jl(e){let n=yw(e.slice(1));if(!n)return;let t=new TextDecoder("utf-8",{fatal:!0});try{if(e.startsWith("t"))return t.decode(n);if(e.startsWith("z")&&typeof DecompressionStream=="function")return t.decode(await $m(n,new DecompressionStream("gzip")))}catch{}}function Sm(e,n){return`${e.split("#")[0]??e}#${km}=${n}`}function ql(e){let n=e.startsWith("#")?e.slice(1):e,t=`${km}=`;if(!n.startsWith(t))return;let i=n.slice(t.length);return i.length>1?i:void 0}function Tm(e){let n=e.trim();if(n===""||/\s/.test(n)||n.startsWith("{"))return;let t=n.indexOf("#");return t<0?void 0:ql(n.slice(t))}var Yl="This share link is damaged or cut short. Ask for it again, or paste the text instead.";function Xl(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var xw="wrist-assistant-panel.picker-hidden.v1:",vw=3e4,ww=500,kw=3e4,Em="preset-entity";function Mm(e){return`import-entity-${e}`}var $w={entityId:"",displayName:"",domain:""},Cw=new Map,Sw={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Jl(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Tw(e){return e.kind==="family"?"look":"content"}function Zl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Rm(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function Ew(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Am=300,Hm=360,td=44,nd=22,Dm=[1,1.7,2.6],Mw=["S","M","L"],Fm=["Small","Medium","Large"];function Rw(){return Dm.map((e,n)=>{let t=Math.round(td*e),i=Math.round(nd*e),a=`.layers-card.s${n}`;return`
...
`)}var Im="wrist-assistant-panel.layers.v1",Lm="wrist-assistant-panel.grid.v1",Bt=34,ii=200,Aw=720,wo=320,Hw=80,Fw=56,_m="wrist-assistant-panel.columns.v3",Ql=e=>Math.max(ii,Math.min(Aw,Math.round(e))),zm=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Iw(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Lw=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,_w=3,Aa=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",bn=Aa==="Cmd"?"\u2318":"Ctrl+",ed=Aa==="Cmd"?"\u21E7":"Shift+";function Pm(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Hw;if(i>=ii*2+wo){let r=i-wo,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(ii,Math.floor(o*l)),s=Math.max(ii,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(ii,o-d):s=Math.max(ii,s-d))}return{columns:3,left:o,right:s}}let a=e-Fw;return a>=ii+wo?{columns:2,left:Math.min(n,a-wo),right:t}:{columns:1,left:n,right:t}}var z=class z extends Ut{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Am;this.colRight=Hm;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.pickerHiddenOpen=!1;this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.snapGrid=!0;this.gridStep=.01;this.showGridLines=!1;this.altHeld=!1;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.importDrop=!1;this.importDragDepth=0;this.importEntities=[];this.helpTab="basics";this.linkReady=!1;this.recordPreviews=new Map;this.previewCase=ki.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=lp(()=>this.requestUpdate());this.imageSizes=dp(()=>this.requestUpdate());this.symbols=new zr(()=>this.requestUpdate());this.keyHandler=t=>{t.key==="Alt"&&(this.altHeld=!0),this.onKey(t)};this.blurHandler=()=>{this.altHeld=!1};this.heldArrows=new Set;this.keyUpHandler=t=>{t.key==="Alt"&&(this.altHeld=!1),this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Dr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.menuOutside=t=>{let i=this.openMenu;if(i===void 0)return;t.composedPath().some(r=>r instanceof HTMLElement&&r.dataset.menu===i)||this.toggleMenu(i,!1)};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importDragEnter=t=>{this.dragReadable(t)&&(t.preventDefault(),this.importDragDepth+=1,this.importDrop=!0)};this.importDragOver=t=>{this.dragReadable(t)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect="copy"))};this.importDragLeave=()=>{this.importDragDepth!==0&&(this.importDragDepth-=1,this.importDragDepth===0&&(this.importDrop=!1))};this.importDropped=t=>{this.importDragDepth=0,this.importDrop=!1;let i=t.dataTransfer?.files?.[0];if(i){t.preventDefault(),this.readImportBlob(i);return}let a=t.dataTransfer?.getData("text/plain")??"";a!==""&&(t.preventDefault(),this.setImportText(a))};this.takeShareLink=()=>{let t=ql(window.location.hash);t!==void 0&&(history.replaceState(history.state,"",`${window.location.pathname}${window.location.search}`),this.pendingLink=t,this.linkReady&&this.openPendingLink())};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Kl(a,this.hass.states);r.some(s=>_l(Mm(s.entityId)))||Xl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||_l(Em)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Cw}static{this.styles=Mo`
    :host {
  ...
  `}firstUpdated(t){super.firstUpdated(t),this.renderRoot.addEventListener("change",i=>{let a=i.target;a?.tagName==="SELECT"&&a.blur()})}connectedCallback(){super.connectedCallback(),this.clearLegacyPickerHidden(),this.loadColumnWidths(),this.loadListView(),this.loadGrid(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("blur",this.blurHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(co,this.scrubStart),this.addEventListener(uo,this.scrubEnd),window.addEventListener("hashchange",this.takeShareLink),this.takeShareLink(),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},kw)}loadColumnWidths(){try{let t=window.localStorage.getItem(_m);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Ql(i.left)),typeof i.right=="number"&&(this.colRight=Ql(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(_m,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadGrid(){try{let t=window.localStorage.getItem(Lm);if(!t)return;let i=JSON.parse(t);typeof i.on=="boolean"&&(this.snapGrid=i.on),Ps.includes(i.step)&&(this.gridStep=i.step),typeof i.lines=="boolean"&&(this.showGridLines=i.lines)}catch{}}setGrid(t,i,a=this.showGridLines){this.snapGrid=t,this.gridStep=i,this.showGridLines=a;try{window.localStorage.setItem(Lm,JSON.stringify({on:t,step:i,lines:a}))}catch{}}snapTarget(t){return{snap:{step:vi(this.gridStep,he[t]),on:this.snapGrid}}}loadListView(){try{let t=window.localStorage.getItem(Im);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Im,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      @click=${()=>this.setShowTaps(!this.showTaps)}><span class="glyph">☞</span>Show taps</button>`}renderTintTool(){let t=this.previewTint,i=Xs.find(o=>o.hex===t),a=!this.draft||this.parseError!==void 0,r=o=>{this.toggleMenu("tint",!1),this.previewTint=o};return h`<span class="inbox tint-box ${t!==void 0?"on":""}"
      ...
      <span class="case-tool" data-menu="tint">
        <button class="case-pick" ?disabled=${a} aria-haspopup="listbox" aria-expanded=${this.openMenu==="tint"?"true":"false"}
          ...
          ${i?h`<i class="tint-dot" style=${`--sw:${i.hex}`}></i>${i.label} tint`:"Full colour"}${W("chevron")}
        </button>
        ${this.openMenu==="tint"?h`<div class="pop-menu" role="listbox" aria-label="Preview colour">
          ...
          ${Xs.map(o=>h`<button class="row" role="option" aria-selected=${o.hex===t?"true":"false"}
      ...
      ${this.openMenu==="grid"?h`<div class="pop-menu" role="listbox" aria-label="Grid size">
        ${Ps.map(o=>h`<button class="row" role="option" aria-selected=${o===this.gridStep?"true":"false"}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?mr(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){let a=this.renderRoot,r="activeElement"in a?a.activeElement:null;if(r&&typeof r.blur=="function"&&!i.currentTarget?.contains(r)&&r.blur(),this.picking){i.preventDefault(),this.pickAt(t,i);return}let o=i.target,s=o.closest("[data-handle]")?.getAttribute("data-handle")??null,l=o.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,d=o.closest("svg.complication");if(this.showTaps){let I=this.focusTapId();if(I!==void 0&&l===I&&d&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,d,I,s??void 0);return}let R=this.hitLayerId(i);R?this.inspect={kind:"layer",id:R}:l===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=zm(i),u=l!==void 0?mr(this.draft.config,l):void 0;if(!c&&!s&&d&&this.multi.size>=2&&u!==void 0&&this.multi.has(u)){let I=Dc(this.draft.config,this.multi);if(i.preventDefault(),I.length===0)return;this.beginMoveGesture(t,i,d,I,`drag-pick-${t}`,()=>{this.multi=new Set,this.inspect={kind:"layer",id:u}});return}if(!c&&this.multi.size>0&&(this.multi=new Set),!l||!d)return;let p=mr(this.draft.config,l),m=this.draft.config.elements.find(I=>I.payload.id===p);if(!p||!m)return;if(c){i.preventDefault(),this.togglePick(p);return}let g,y=this.inspect.kind==="layer"?this.inspect.id:void 0;if(y!==void 0&&y!==p&&!s){let I=this.draft.config.elements.find(Y=>Y.payload.id===y);I!==void 0&&I.kind!=="chartDots"&&I.kind!=="chartGrid"&&I.payload.chartAnchor?.place!=="through"&&at(this.draft.config,y)?.locked!==!0&&Iw(d,y,i)&&(g=p,p=y,m=I)}let b=at(this.draft.config,p),C=b!==void 0&&this.inspect.kind==="group"&&this.inspect.id===b.id;if(b&&(b.locked||C)&&!s){let I=C||this.inspect.kind==="layer"&&at(this.draft.config,this.inspect.id)?.id===b.id;this.beginGroupGesture(t,i,d,b,I?p:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==p)&&(this.inspect={kind:"layer",id:p},s)||m.payload.chartAnchor?.place==="through")return;i.preventDefault();let k=Le(this.draft.config,t,m).frame,w=this.gestureCanvas(t),$=m.payload.chartAnchor,D=$!==void 0&&!It($.at)&&$.place!=="through",M=$!==void 0&&It($.at)&&$.place==="through",A=he[t],H={dx:$?.dx??0,dy:$?.dy??0},T=$!==void 0&&!s?xi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(I=>I.id===p)?.frame:void 0,P=T??k,j=I=>Math.round(I*10)/10;this.cancelGesture?.();let G=!1,X=s!==null?xi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(I=>I.id===p):void 0;if(s!==null&&X?.kind==="icon"){let I=Zs(X)/2,R=X.size;this.cancelGesture=Cu(d,i,s,{w:I,h:I},(Y,x)=>{this.mutate(S=>{ke(S,t,p,{size:Math.max(1,Math.round(R*Y))})},`drag-${p}-${t}`),x&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let _=X!==void 0?ju(X,P,w):{};this.cancelGesture=Er(d,w,i,{elementId:p,frame:P,handle:s??void 0,..._,...$===void 0?this.snapTarget(t):{}},{onFrame:(I,R,Y)=>{if(Y||(G=!0),Y&&!G&&g!==void 0){this.inspect={kind:"layer",id:g},this.cancelGesture=void 0;return}this.mutate(x=>{if($===void 0){ke(x,t,I,{frame:R});return}let S=T?{width:k.width,height:k.height}:{width:R.width,height:R.height};ke(x,t,I,{frame:{...R,...S,x:D?R.x:k.x,y:k.y}});let F=x.elements.find(J=>J.payload.id===I)?.payload.chartAnchor;if(F===void 0)return;let O=H.dx,K=M?H.dy:j(H.dy+(R.y-P.y)*A.height);O?F.dx=O:delete F.dx,K?F.dy=K:delete F.dy},`drag-${I}-${t}`),Y&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=dt(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=o===void 0?void 0:()=>{this.inspect={kind:"layer",id:o}};this.beginMoveGesture(t,i,a,l.map(c=>c.payload.id),`drag-group-${r.id}-${t}`,d)}beginMoveGesture(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return;let d=l.elements.filter(M=>r.includes(M.payload.id));if(d.length===0)return;let c=new Map(d.map(M=>[M.payload.id,Le(l,t,M).frame])),u=[...c.values()],p=Math.min(...u.map(M=>M.x)),m=Math.min(...u.map(M=>M.y)),g=Math.max(...u.map(M=>M.x+M.width)),y=Math.max(...u.map(M=>M.y+M.height)),b={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},C=M=>Math.round(M*1e3)/1e3;this.cancelGesture?.();let k=!1,w=M=>{M.pointerId===i.pointerId&&Math.hypot(M.clientX-i.clientX,M.clientY-i.clientY)>_w&&(k=!0)};a.addEventListener("pointermove",w);let $=()=>a.removeEventListener("pointermove",w),D=Er(a,this.gestureCanvas(t),i,{elementId:o,frame:b,...this.snapTarget(t)},{onFrame:(M,A,H)=>{if(H&&$(),!H&&!k)return;if(H&&!k&&s!==void 0){s(),this.cancelGesture=void 0;return}let T=A.x-b.x,P=A.y-b.y;this.mutate(j=>{for(let[G,X]of c)ke(j,t,G,{frame:{...X,x:C(X.x+T),y:C(X.y+P)}})},o),H&&(this.draft?.endGesture(),this.cancelGesture=void 0)}});this.cancelGesture=()=>{$(),D()}}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?$u:1,s=t*o,l=i*o,d=this.canvasFamily,c=he[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let C=this.inspect.id;return this.nudgeMany(dt(r,C).map(k=>k.payload.id),d,c,`nudge-group-${C}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(C=>C.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=at(r,u);if(m?.locked)return this.nudgeMany(dt(r,m.id).map(C=>C.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=Le(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let C=!It(y.at);return l===0&&!(C&&s!==0)||this.mutate(k=>{C&&s!==0&&ke(k,d,u,{frame:Tr(g,s,0,c)});let w=k.elements.find(D=>D.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let $=Math.round(((w.dy??0)+l)*10)/10;$?w.dy=$:delete w.dy},`nudge-${u}-${d}`),!0}let b=this.snapGrid?Os(g,s,l,vi(this.gridStep,c)):Tr(g,s,l,c);return(b.x!==g.x||b.y!==g.y)&&this.mutate(C=>ke(C,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=$=>Math.round($*1e3)/1e3,c=new Map;for(let $ of t){let D=l.elements.find(M=>M.payload.id===$);D&&c.set($,Le(l,i,D).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map($=>$.x)),m=Math.min(...u.map($=>$.y)),g=Math.max(...u.map($=>$.x+$.width)),y=Math.max(...u.map($=>$.y+$.height)),b={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},C=this.snapGrid?Os(b,o,s,vi(this.gridStep,a)):Tr(b,o,s,a),k=C.x-b.x,w=C.y-b.y;return(k!==0||w!==0)&&this.mutate($=>{for(let[D,M]of c)ke($,i,D,{frame:{...M,x:d(M.x+k),y:d(M.y+w)}})},r),!0}gestureCanvas(t){let i=Ar(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=tl(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:je(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ve(s,l),c=Le(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Er(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o,...this.snapTarget(t)},{onFrame:(u,p,m)=>{this.mutate(g=>{d?Gc(g,u,t,p):ke(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Pm(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${Nm(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Rm()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?h`<span class="hor" aria-hidden="true">or</span>${Rm()}`:f}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${rp(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
    ...
    </div>`}renderPicker(){let t=this.draft,i=t?t.config.name.trim()||"Untitled":"No complication",a=t?t.config.supportedFamilies:[],r=this.pickerRows(),o=this.pickerFilter,s=o==="all"?r:r.filter(d=>(d.kind==="record"?Zl(d.record):d.families).includes(o)),l=Nc(s,d=>d.kind==="record"?{id:d.record.id,hidden:this.rowHidden(d.record)}:void 0,this.selectedId);return h`<div class="picker">
      ...
      ${this.pickerOpen?h`<div class="menu" role="listbox">
        ${r.length>=z.FILTER_FROM_ROWS?this.renderPickerFilter(r):f}
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.shareLink=void 0,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t,i="dialog.share-dialog textarea",a="Copied."){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote=a;return}}catch{}let r=this.renderRoot.querySelector(i);r?.focus(),r?.select();let o=!1;try{o=document.execCommand("copy")}catch{o=!1}this.shareNote=o?a:"Press Cmd+C or Ctrl+C to copy."}async copyShareLink(t){let i=await Cm(t),a=Sm(`${window.location.origin}${window.location.pathname}`,i);this.shareLink={text:t,url:a},await this.updateComplete,await this.copyShareText(a,"dialog.share-dialog input.xfer-link","Link copied.")}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=ym(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Kl(i,this.hass.states):[],r=Xl({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog ${this.importDrop?"dropping":""}" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}
    ...
    </dialog>`}renderImportPreview(t,i){let a=wm(t,i),r=a.layers===1?"1 layer":`${a.layers} layers`,o=a.slots===0?"no entities to choose":a.slots===1?"1 entity to choose":`${a.slots} entities to choose`,s=a.missing===0?"":` \xB7 ${a.missing} not in your Home Assistant`;return h`<div class="xfer-preview">
      ...
      ${fm(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${Ct({hass:this.hass},t.label,i??$w,a=>this.setImportEntity(t.entityId,a),Mm(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,fo(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=Tm(t);if(i!==void 0){this.importParse=void 0,this.importMap=new Map,this.importName="",jl(i).then(o=>{this.importText===t&&(o===void 0?this.importParse={ok:!1,error:Yl}:this.setImportText(o))});return}let a=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,r=t.trim()===""?void 0:bm(t,this.maxSchemaVersion);if(this.importParse=r,!r?.ok){this.importMap=new Map,this.importName="";return}try{this.importEntities=[...aa(r.config).entities.values()]}catch{this.importEntities=[]}JSON.stringify(r.config)!==a&&(this.importMap=new Map,this.importName=vm(r.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];a&&(await this.readImportBlob(a),i.value="")}async readImportBlob(t){try{this.setImportText(await t.text())}catch(i){this.importParse={ok:!1,error:`That file could not be read: ${St(i)}`}}}async openPendingLink(){let t=this.pendingLink;if(t===void 0)return;if(this.pendingLink=void 0,!this.hass.user?.is_admin){this.linkNote="This link holds a shared complication. Only a Home Assistant administrator can import it.";return}let i=await jl(t);if(i===void 0){this.linkNote=Yl;return}if(!this.ownerId){this.linkNote="This link holds a shared complication, but no watch has connected to this Home Assistant yet.";return}if(this.freeSlot()<0){this.linkNote="This link holds a shared complication, but this watch has no free slot. Delete a complication, then open the link again.";return}this.linkNote=void 0,this.openImportDialog(),this.setImportText(i)}doImport(){let t=this.importParse;if(!t?.ok)return;let i=xm(t.config,this.importMap);i.id=ee(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=Rn(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.importEntities=[],this.importDrop=!1,this.importDragDepth=0,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Nm(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${il.length} kinds · ${Ra.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${il.map(s=>h`<button class="add" style=${`--k:${Xe[s]}`} ?disabled=${i} title=${`Add a blank ${dn[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${Ep(s)}</span>`:f}<span class="add-name">${r?W(s):h`<span class="k"></span>`}<span>${dn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${He(T,d)}</b>
          <small><span class="kind">${dn[T.kind]}</span> · ${Dw(T,c,this.historySeries,_.size)}</small>
          ${$?h`<span class="facts">${Pw(this.host(),a,T,_).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ...
            ${I?h`<span class="badge">hidden</span>`:f}
          </span>
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${bn}])`} aria-label="Bring forward" @click=${F=>{F.stopPropagation(),r(G,1)}}>${W("up")}</button>
            <button class="icon" title=${`Send back (${bn}[)`} aria-label="Send back" @click=${F=>{F.stopPropagation(),r(G,-1)}}>${W("down")}</button>
            <button class="icon" title=${`${_.isHidden?"Show":"Hide"} (${ed}${bn}H)`} aria-label=${_.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(O=>ke(O,a,G,{isHidden:!_.isHidden}))}}>${W(_.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${bn}D)`} aria-label="Duplicate" @click=${F=>{F.stopPropagation(),o(G)}}>${W("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${F=>{F.stopPropagation(),s(G)}}>${W("delete")}</button>
          </span>`:f}
        </span>
      </div>`},M=(T,P)=>{let j=this.inspect.kind==="group"&&this.inspect.id===T.id,G=!this.collapsed.has(T.id),X=this.rowDrag(T.id,i),_=P[0],I=P[P.length-1],R=x=>{let S=x.currentTarget,F=S.getBoundingClientRect(),O=F.top+(S.classList.contains("drop-before")?Bt:0),K=F.bottom-(S.classList.contains("drop-after")?Bt:0),J=(x.clientY-O)/Math.max(1,K-O);return J<.25?"drop-before":!G&&J>.75?"drop-after":"drop-into"},Y=P.map(x=>x.payload.id);return h`<div class="layer group ${j?"hl":""} ${$?"rich":""}" style=${`--k:${te.group}`} tabindex="0" draggable=${X.draggable}
        ...
        @dragover=${x=>{!this.dragId||this.dragId===T.id||(x.preventDefault(),this.markDrop(x.currentTarget,R(x)))}}
        @drop=${x=>{x.preventDefault();let S=R(x);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!_||!I)){if(S==="drop-before"){this.reorderLayer(F,_.payload.id,!0,!0);return}if(S==="drop-after"){this.reorderLayer(F,I.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,_.payload.id,!0),this.mutate(O=>Zi(O,F,T.id)))}}}>
        <span class="grip" title="Drag to reorder the whole group.">${W("grip")}</span>
        <span class="bar"></span>
        <span class="folder">${W("folder")}</span>
        <span class="name">
          <b>${T.name}</b>
          <small><span class="kind">Group</span> · ${P.length} layer${P.length===1?"":"s"} · ${T.locked?"locked":"unlocked"}</small>
          ${$?h`<span class="facts"><span class="fact"><b>Holds</b> ${P.map(x=>He(x,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${ed}${bn}G)`} aria-label="Ungroup" @click=${x=>{x.stopPropagation(),this.mutate(S=>fi(S,T.id)),j&&(this.inspect={kind:"general"})}}>${W("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${T.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${x=>{x.stopPropagation(),this.mutate(S=>{let F=S.groups?.find(O=>O.id===T.id);F&&(F.locked=!F.locked)})}}>${W(T.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${G?"true":"false"} title=${G?"Fold the group":"Unfold the group"}
            @click=${x=>{x.stopPropagation();let S=new Set(this.collapsed);G?S.add(T.id):S.delete(T.id),this.collapsed=S}}>${W("chevron")}</button>
        </span>
      </div>`},A=[],H=new Set;for(let T=0;T<l.length;T++){let P=l[T],j=P.payload.groupId,G=j===void 0?void 0:t.groups?.find(I=>I.id===j);if(!G){A.push(D(P,!1));continue}if(H.has(G.id))continue;H.add(G.id);let X=l.filter(I=>I.payload.groupId===G.id);A.push(M(G,X));let _=this.inspect.kind==="group"&&this.inspect.id===G.id;this.collapsed.has(G.id)||A.push(h`<div class="group-kids">${X.map(I=>D(I,!0,_))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${C}px;--thumb-h:${k}px`}>
      <h2 class="panel-title tools" style=${`--c:${te.place}`}><span class="swatch">${W("layers")}</span>Layers
        ...
        <span class="tool-set">
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([T,P])=>h`
              <button class=${this.layerDetail===T?"on":""} title=${P} aria-label=${P} aria-pressed=${this.layerDetail===T?"true":"false"}
                @click=${()=>{this.layerDetail=T,this.saveListView()}}>${W(T)}</button>`)}
          </span>
          <span class="seg" role="group" aria-label="Preview size">
            ${Mw.map((T,P)=>h`
              <button class=${this.thumbStep===P?"on":""} title=${`${Fm[P]} row pictures`}
                aria-label=${`${Fm[P]} row pictures`} aria-pressed=${this.thumbStep===P?"true":"false"}
                @click=${()=>{this.thumbStep=P,this.saveListView()}}>${T}</button>`)}
          </span>
        </span>
      </h2>
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${te.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${T=>{T.preventDefault(),this.clearDragMarks();let P=this.dragId,j=[...l].reverse().find(G=>G.payload.id!==P&&G.payload.groupId!==P);P&&j&&this.reorderLayer(P,j.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?om(this.presetKind):void 0,i=this.presetEntity;return h`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:h`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${Ct(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Em,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=dm(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=xi(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?bi((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Dh();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${W("content")}</span>Shared values
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${g=>{g.stopPropagation(),this.mutate(y=>{Cs(y,c.id)}),p&&(this.openValue=void 0)}}>${W("delete")}</button>`:f}
        </div>
        ${p?h`<div class="value-open">${Nh(s,c)}</div>`:f}</div>`})}
      </div>
      ...
      ${r.length>0?h`<span class="shape-adds">${r.map(o=>h`<button class="tab off ${o}" ?disabled=${!this.canEdit}
        title=${`Add the ${ne(o)} shape`} @click=${()=>this.addShape(o)}>${W("plus")}${ne(o)}</button>`)}</span>`:f}`}renderHaveTabs(t,i){let a=t.supportedFamilies;return ln.filter(r=>a.includes(r)).map(r=>{let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?Fr(c,{icons:this.icons,imageSizes:this.imageSizes,slot:ki.slots[r]}):f}let l=r!=="inline"&&yo(t,r)===0&&t.elements.length>0,d=this.canEdit&&Ir(t,r);return h`<span class="tab-wrap">
        ...
        ${this.canEdit?h`<button class="icon danger tab-x" ?disabled=${!d}
          ...
          @click=${c=>{c.stopPropagation(),this.removeShape(r)}}>${W("delete")}</button>`:f}
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ...
        ${a.map(o=>{let s=Hs(o.id),l=this.sharedRaw(o.id)??"",d=l===""?"empty":l,c=o.name||"(unnamed)",u=this.testValues.get(s),p={entity_id:s,state:l,attributes:{},last_changed:"",last_updated:""};return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${te.complication}`}
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${Se(a,"complication","Complication",zh(a),{color:te.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=Wh(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=Yh(a,c)}else s=Xh(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([Tw(r)]):new Set(Fl)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=me(r),s=new vt(this.buildContext(),this.draft?.config),l=Bh(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)ke(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let b=g.elements.find(C=>C.payload.id===y.payload.id);b&&b.kind!=="image"&&b.kind!=="tap"&&b.kind!=="timeline"&&b.kind!=="chartTimes"&&b.kind!=="chartDots"&&b.kind!=="chartGrid"&&b.kind!=="imageTime"&&(b.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ...
      ${Se(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:te.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=cp({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
    ...
    </details>`}};N([si({attribute:!1})],z.prototype,"hass",2),N([si({type:Boolean})],z.prototype,"narrow",2),N([si({attribute:!1})],z.prototype,"panel",2),N([B()],z.prototype,"colLeft",2),N([B()],z.prototype,"colRight",2),N([B()],z.prototype,"panelWidth",2),N([B()],z.prototype,"owners",2),N([B()],z.prototype,"ownerId",2),N([B()],z.prototype,"records",2),N([B()],z.prototype,"selectedId",2),N([B()],z.prototype,"draft",2),N([B()],z.prototype,"readOnlyReason",2),N([B()],z.prototype,"parseError",2),N([B()],z.prototype,"maxSchemaVersion",2),N([B()],z.prototype,"presets",2),N([B()],z.prototype,"occupied",2),N([B()],z.prototype,"serverToken",2),N([B()],z.prototype,"appliedToken",2),N([B()],z.prototype,"sendStatusKnown",2),N([B()],z.prototype,"polling",2),N([B()],z.prototype,"lastPollSeconds",2),N([B()],z.prototype,"sendPending",2),N([B()],z.prototype,"pages",2),N([B()],z.prototype,"templateResults",2),N([B()],z.prototype,"historySeries",2),N([B()],z.prototype,"historyReadings",2),N([B()],z.prototype,"templateError",2),N([B()],z.prototype,"templateFetchedAt",2),N([B()],z.prototype,"forced",2),N([B()],z.prototype,"showRaw",2),N([B()],z.prototype,"inspect",2),N([B()],z.prototype,"openSections",2),N([B()],z.prototype,"helpSections",2),N([B()],z.prototype,"pickerOpen",2),N([B()],z.prototype,"pickerFilter",2),N([B()],z.prototype,"pickerNote",2),N([B()],z.prototype,"pickerHiddenOpen",2),N([B()],z.prototype,"pickerConfirmDelete",2),N([B()],z.prototype,"openValue",2),N([B()],z.prototype,"sharedHelp",2),N([B()],z.prototype,"editingValue",2),N([B()],z.prototype,"thumbStep",2),N([B()],z.prototype,"layerDetail",2),N([B()],z.prototype,"addOpen",2),N([B()],z.prototype,"addDetail",2),N([B()],z.prototype,"multi",2),N([B()],z.prototype,"copiedPosition",2),N([B()],z.prototype,"snapGrid",2),N([B()],z.prototype,"gridStep",2),N([B()],z.prototype,"showGridLines",2),N([B()],z.prototype,"openMenu",2),N([B()],z.prototype,"altHeld",2),N([B()],z.prototype,"collapsed",2),N([B()],z.prototype,"activeFamily",2),N([B()],z.prototype,"picking",2),N([B()],z.prototype,"pickHoverId",2),N([B()],z.prototype,"listHoverIds",2),N([B()],z.prototype,"rowHoverId",2),N([B()],z.prototype,"zoomed",2),N([B()],z.prototype,"helpOpen",2),N([B()],z.prototype,"showTaps",2),N([B()],z.prototype,"savedName",2),N([B()],z.prototype,"presetKind",2),N([B()],z.prototype,"presetEntity",2),N([B()],z.prototype,"newOpen",2),N([B()],z.prototype,"newName",2),N([B()],z.prototype,"newFamily",2),N([B()],z.prototype,"shareOpen",2),N([B()],z.prototype,"shareMode",2),N([B()],z.prototype,"shareLabels",2),N([B()],z.prototype,"shareNote",2),N([B()],z.prototype,"importOpen",2),N([B()],z.prototype,"importText",2),N([B()],z.prototype,"importParse",2),N([B()],z.prototype,"importName",2),N([B()],z.prototype,"importMap",2),N([B()],z.prototype,"importDrop",2),N([B()],z.prototype,"shareLink",2),N([B()],z.prototype,"helpTab",2),N([B()],z.prototype,"linkNote",2),N([B()],z.prototype,"previewCase",2),N([B()],z.prototype,"previewTint",2),N([B()],z.prototype,"loadError",2),N([B()],z.prototype,"saveError",2),N([B()],z.prototype,"saving",2),N([B()],z.prototype,"conflict",2),N([B()],z.prototype,"remoteRevision",2),N([B()],z.prototype,"confirmDelete",2),N([B()],z.prototype,"moveTarget",2),N([B()],z.prototype,"moving",2),N([B()],z.prototype,"moveError",2),N([B()],z.prototype,"version",2);var id=z;function St(e){return String(e?.message??e)}function zw(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Nm(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function Pw(e,n,t,i){let a=[{label:"Shows",value:Pl(e,t)}],r=so(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function Nw(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function Dw(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ie(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=_n(e.payload)??zn(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Ye(o).length} values`}case"timeline":{let r=bt(e.payload),o=r===void 0?[]:oa(t.get(r)??""),s=Math.max(0,o.length-1);return`${Nw(lt(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ie(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return e.payload.contentMode==="fill"?"fill":"fit";case"tap":return _t(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`;case"imageTime":return}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",id);export{id as WristAssistantPanel,Pm as columnFit,Pw as layerFacts};
