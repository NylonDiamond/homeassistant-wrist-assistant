var Gm=Object.defineProperty;var Um=Object.getOwnPropertyDescriptor;var D=(e,n,t,i)=>{for(var a=i>1?void 0:i?Um(n,t):n,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(n,t,a):o(a))||a);return i&&a&&Gm(n,t,a),a};var Ha=globalThis,Fa=Ha.ShadowRoot&&(Ha.ShadyCSS===void 0||Ha.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Co=Symbol(),ld=new WeakMap,Ri=class{constructor(n,t,i){if(this._$cssResult$=!0,i!==Co)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=n,this.t=t}get styleSheet(){let n=this.o,t=this.t;if(Fa&&n===void 0){let i=t!==void 0&&t.length===1;i&&(n=ld.get(t)),n===void 0&&((this.o=n=new CSSStyleSheet).replaceSync(this.cssText),i&&ld.set(t,n))}return n}toString(){return this.cssText}},Fe=e=>new Ri(typeof e=="string"?e:e+"",void 0,Co),So=(e,...n)=>{let t=e.length===1?e[0]:n.reduce((i,a,r)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[r+1],e[0]);return new Ri(t,e,Co)},dd=(e,n)=>{if(Fa)e.adoptedStyleSheets=n.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of n){let i=document.createElement("style"),a=Ha.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,e.appendChild(i)}},To=Fa?e=>e:e=>e instanceof CSSStyleSheet?(n=>{let t="";for(let i of n.cssRules)t+=i.cssText;return Fe(t)})(e):e;var{is:Wm,defineProperty:Km,getOwnPropertyDescriptor:jm,getOwnPropertyNames:qm,getOwnPropertySymbols:Ym,getPrototypeOf:Xm}=Object,Ia=globalThis,cd=Ia.trustedTypes,Jm=cd?cd.emptyScript:"",Zm=Ia.reactiveElementPolyfillSupport,Ai=(e,n)=>e,Hi={toAttribute(e,n){switch(n){case Boolean:e=e?Jm:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,n){let t=e;switch(n){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch{t=null}}return t}},La=(e,n)=>!Wm(e,n),ud={attribute:!0,type:String,converter:Hi,reflect:!1,useDefault:!1,hasChanged:La};Symbol.metadata??=Symbol("metadata"),Ia.litPropertyMetadata??=new WeakMap;var Et=class extends HTMLElement{static addInitializer(n){this._$Ei(),(this.l??=[]).push(n)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(n,t=ud){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(n)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(n,t),!t.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(n,i,t);a!==void 0&&Km(this.prototype,n,a)}}static getPropertyDescriptor(n,t,i){let{get:a,set:r}=jm(this.prototype,n)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(n,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(n){return this.elementProperties.get(n)??ud}static _$Ei(){if(this.hasOwnProperty(Ai("elementProperties")))return;let n=Xm(this);n.finalize(),n.l!==void 0&&(this.l=[...n.l]),this.elementProperties=new Map(n.elementProperties)}static finalize(){if(this.hasOwnProperty(Ai("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ai("properties"))){let t=this.properties,i=[...qm(t),...Ym(t)];for(let a of i)this.createProperty(a,t[a])}let n=this[Symbol.metadata];if(n!==null){let t=litPropertyMetadata.get(n);if(t!==void 0)for(let[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(n){let t=[];if(Array.isArray(n)){let i=new Set(n.flat(1/0).reverse());for(let a of i)t.unshift(To(a))}else n!==void 0&&t.push(To(n));return t}static _$Eu(n,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof n=="string"?n.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(n=>n(this))}addController(n){(this._$EO??=new Set).add(n),this.renderRoot!==void 0&&this.isConnected&&n.hostConnected?.()}removeController(n){this._$EO?.delete(n)}_$E_(){let n=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(n.set(i,this[i]),delete this[i]);n.size>0&&(this._$Ep=n)}createRenderRoot(){let n=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return dd(n,this.constructor.elementStyles),n}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(n=>n.hostConnected?.())}enableUpdating(n){}disconnectedCallback(){this._$EO?.forEach(n=>n.hostDisconnected?.())}attributeChangedCallback(n,t,i){this._$AK(n,i)}_$ET(n,t){let i=this.constructor.elementProperties.get(n),a=this.constructor._$Eu(n,i);if(a!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:Hi).toAttribute(t,i.type);this._$Em=n,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(n,t){let i=this.constructor,a=i._$Eh.get(n);if(a!==void 0&&this._$Em!==a){let r=i.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Hi;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(n,t,i,a=!1,r){if(n!==void 0){let o=this.constructor;if(a===!1&&(r=this[n]),i??=o.getPropertyOptions(n),!((i.hasChanged??La)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(n)&&!this.hasAttribute(o._$Eu(n,i))))return;this.C(n,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(n,t,{useDefault:i,reflect:a,wrapped:r},o){i&&!(this._$Ej??=new Map).has(n)&&(this._$Ej.set(n,o??t??this[n]),r!==!0||o!==void 0)||(this._$AL.has(n)||(this.hasUpdated||i||(t=void 0),this._$AL.set(n,t)),a===!0&&this._$Em!==n&&(this._$Eq??=new Set).add(n))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let n=this.scheduleUpdate();return n!=null&&await n,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,r]of i){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let n=!1,t=this._$AL;try{n=this.shouldUpdate(t),n?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw n=!1,this._$EM(),i}n&&this._$AE(t)}willUpdate(n){}_$AE(n){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(n)),this.updated(n)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(n){return!0}update(n){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(n){}firstUpdated(n){}};Et.elementStyles=[],Et.shadowRootOptions={mode:"open"},Et[Ai("elementProperties")]=new Map,Et[Ai("finalized")]=new Map,Zm?.({ReactiveElement:Et}),(Ia.reactiveElementVersions??=[]).push("2.1.2");var Mo=globalThis,pd=e=>e,_a=Mo.trustedTypes,hd=_a?_a.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ro="$lit$",Mt=`lit$${Math.random().toFixed(9).slice(2)}$`,Ao="?"+Mt,Qm=`<${Ao}>`,wn=document,Ii=()=>wn.createComment(""),Li=e=>e===null||typeof e!="object"&&typeof e!="function",Ho=Array.isArray,xd=e=>Ho(e)||typeof e?.[Symbol.iterator]=="function",Eo=`[ 	
\f\r]`,Fi=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,md=/-->/g,fd=/>/g,xn=RegExp(`>|${Eo}(?:([^\\s"'>=/]+)(${Eo}*=${Eo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),gd=/'/g,yd=/"/g,vd=/^(?:script|style|textarea|title)$/i,Fo=e=>(n,...t)=>({_$litType$:e,strings:n,values:t}),h=Fo(1),v=Fo(2),_w=Fo(3),Rt=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),bd=new WeakMap,vn=wn.createTreeWalker(wn,129);function wd(e,n){if(!Ho(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return hd!==void 0?hd.createHTML(n):n}var kd=(e,n)=>{let t=e.length-1,i=[],a,r=n===2?"<svg>":n===3?"<math>":"",o=Fi;for(let s=0;s<t;s++){let l=e[s],d,c,u=-1,p=0;for(;p<l.length&&(o.lastIndex=p,c=o.exec(l),c!==null);)p=o.lastIndex,o===Fi?c[1]==="!--"?o=md:c[1]!==void 0?o=fd:c[2]!==void 0?(vd.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=xn):c[3]!==void 0&&(o=xn):o===xn?c[0]===">"?(o=a??Fi,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?xn:c[3]==='"'?yd:gd):o===yd||o===gd?o=xn:o===md||o===fd?o=Fi:(o=xn,a=void 0);let m=o===xn&&e[s+1].startsWith("/>")?" ":"";r+=o===Fi?l+Qm:u>=0?(i.push(d),l.slice(0,u)+Ro+l.slice(u)+Mt+m):l+Mt+(u===-2?s:m)}return[wd(e,r+(e[t]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),i]},_i=class e{constructor({strings:n,_$litType$:t},i){let a;this.parts=[];let r=0,o=0,s=n.length-1,l=this.parts,[d,c]=kd(n,t);if(this.el=e.createElement(d,i),vn.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=vn.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(Ro)){let p=c[o++],m=a.getAttribute(u).split(Mt),f=/([.?@])?(.*)/.exec(p);l.push({type:1,index:r,name:f[2],strings:m,ctor:f[1]==="."?Pa:f[1]==="?"?Na:f[1]==="@"?Da:$n}),a.removeAttribute(u)}else u.startsWith(Mt)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(vd.test(a.tagName)){let u=a.textContent.split(Mt),p=u.length-1;if(p>0){a.textContent=_a?_a.emptyScript:"";for(let m=0;m<p;m++)a.append(u[m],Ii()),vn.nextNode(),l.push({type:2,index:++r});a.append(u[p],Ii())}}}else if(a.nodeType===8)if(a.data===Ao)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(Mt,u+1))!==-1;)l.push({type:7,index:r}),u+=Mt.length-1}r++}}static createElement(n,t){let i=wn.createElement("template");return i.innerHTML=n,i}};function kn(e,n,t=e,i){if(n===Rt)return n;let a=i!==void 0?t._$Co?.[i]:t._$Cl,r=Li(n)?void 0:n._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(e),a._$AT(e,t,i)),i!==void 0?(t._$Co??=[])[i]=a:t._$Cl=a),a!==void 0&&(n=kn(e,a._$AS(e,n.values),a,i)),n}var za=class{constructor(n,t){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:t},parts:i}=this._$AD,a=(n?.creationScope??wn).importNode(t,!0);vn.currentNode=a;let r=vn.nextNode(),o=0,s=0,l=i[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new ri(r,r.nextSibling,this,n):l.type===1?d=new l.ctor(r,l.name,l.strings,this,n):l.type===6&&(d=new Oa(r,this,n)),this._$AV.push(d),l=i[++s]}o!==l?.index&&(r=vn.nextNode(),o++)}return vn.currentNode=wn,a}p(n){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(n,i,t),t+=i.strings.length-2):i._$AI(n[t])),t++}},ri=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,t,i,a){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=n,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,t=this._$AM;return t!==void 0&&n?.nodeType===11&&(n=t.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,t=this){n=kn(this,n,t),Li(n)?n===g||n==null||n===""?(this._$AH!==g&&this._$AR(),this._$AH=g):n!==this._$AH&&n!==Rt&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):xd(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==g&&Li(this._$AH)?this._$AA.nextSibling.data=n:this.T(wn.createTextNode(n)),this._$AH=n}$(n){let{values:t,_$litType$:i}=n,a=typeof i=="number"?this._$AC(n):(i.el===void 0&&(i.el=_i.createElement(wd(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new za(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(n){let t=bd.get(n.strings);return t===void 0&&bd.set(n.strings,t=new _i(n)),t}k(n){Ho(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,a=0;for(let r of n)a===t.length?t.push(i=new e(this.O(Ii()),this.O(Ii()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(n=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);n!==this._$AB;){let i=pd(n).nextSibling;pd(n).remove(),n=i}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},$n=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,t,i,a,r){this.type=1,this._$AH=g,this._$AN=void 0,this.element=n,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=g}_$AI(n,t=this,i,a){let r=this.strings,o=!1;if(r===void 0)n=kn(this,n,t,0),o=!Li(n)||n!==this._$AH&&n!==Rt,o&&(this._$AH=n);else{let s=n,l,d;for(n=r[0],l=0;l<r.length-1;l++)d=kn(this,s[i+l],t,l),d===Rt&&(d=this._$AH[l]),o||=!Li(d)||d!==this._$AH[l],d===g?n=g:n!==g&&(n+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(n)}j(n){n===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},Pa=class extends $n{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===g?void 0:n}},Na=class extends $n{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==g)}},Da=class extends $n{constructor(n,t,i,a,r){super(n,t,i,a,r),this.type=5}_$AI(n,t=this){if((n=kn(this,n,t,0)??g)===Rt)return;let i=this._$AH,a=n===g&&i!==g||n.capture!==i.capture||n.once!==i.once||n.passive!==i.passive,r=n!==g&&(i===g||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},Oa=class{constructor(n,t,i){this.element=n,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(n){kn(this,n)}},$d={M:Ro,P:Mt,A:Ao,C:1,L:kd,R:za,D:xd,V:kn,I:ri,H:$n,N:Na,U:Da,B:Pa,F:Oa},ef=Mo.litHtmlPolyfillSupport;ef?.(_i,ri),(Mo.litHtmlVersions??=[]).push("3.3.3");var Cd=(e,n,t)=>{let i=t?.renderBefore??n,a=i._$litPart$;if(a===void 0){let r=t?.renderBefore??null;i._$litPart$=a=new ri(n.insertBefore(Ii(),r),r,void 0,t??{})}return a._$AI(e),a};var Io=globalThis,Ut=class extends Et{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=Cd(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Rt}};Ut._$litElement$=!0,Ut.finalized=!0,Io.litElementHydrateSupport?.({LitElement:Ut});var tf=Io.litElementPolyfillSupport;tf?.({LitElement:Ut});(Io.litElementVersions??=[]).push("4.2.2");var nf={attribute:!0,type:String,converter:Hi,reflect:!1,hasChanged:La},af=(e=nf,n,t)=>{let{kind:i,metadata:a}=t,r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(t.name,e),i==="accessor"){let{name:o}=t;return{set(s){let l=n.get.call(this);n.set.call(this,s),this.requestUpdate(o,l,e,!0,s)},init(s){return s!==void 0&&this.C(o,void 0,e,s),s}}}if(i==="setter"){let{name:o}=t;return function(s){let l=this[o];n.call(this,s),this.requestUpdate(o,l,e,!0,s)}}throw Error("Unsupported decorator location: "+i)};function oi(e){return(n,t)=>typeof t=="object"?af(e,n,t):((i,a,r)=>{let o=a.hasOwnProperty(r);return a.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(a,r):void 0})(e,n,t)}function B(e){return oi({...e,state:!0,attribute:!1})}var at="wrist_assistant/complications";async function Sd(e){return e.connection.sendMessagePromise({type:`${at}/owners`})}async function Td(e,n){return e.connection.sendMessagePromise({type:`${at}/list`,owner_watch_id:n})}async function Ed(e,n){return e.connection.sendMessagePromise({type:`${at}/nudge`,owner_watch_id:n})}async function Md(e,n){return e.connection.sendMessagePromise({type:`${at}/watch_status`,owner_watch_id:n})}async function Lo(e,n,t,i){return e.connection.sendMessagePromise({type:`${at}/save`,owner_watch_id:n,document:t,base_revision:i})}async function Rd(e,n,t,i){return e.connection.sendMessagePromise({type:`${at}/delete`,owner_watch_id:n,complication_id:t,base_revision:i})}async function Ad(e,n,t){return e.connection.sendMessagePromise({type:`${at}/move_owner`,source_owner_watch_id:n,target_owner_watch_id:t})}function Hd(e,n,t){let i={type:`${at}/subscribe`};return n&&(i.owner_watch_id=n),e.connection.subscribeMessage(t,i)}async function Fd(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${at}/render_values`,templates:n})).results}async function Id(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${at}/history_series`,requests:n})).results}function Ld(e){return{entity_id:e.entityId,minutes:e.minutes,points:e.points,...e.mode==="states"?{mode:"states"}:{},...e.gaps?{gaps:!0}:{}}}function _d(e){return{entity_id:e.entityId,minutes:e.minutes,period:e.period,type:e.type,...e.gaps?{gaps:!0}:{}}}function zd(e){let n=new Map,t=new Map;for(let[i,a]of Object.entries(e))a.ok&&(n.set(i,a.series),typeof a.readings=="number"&&t.set(i,{readings:a.readings,averaged:a.averaged===!0}));return{series:n,readings:t}}async function Pd(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${at}/statistics_series`,requests:n})).results}var se=["rectangular","circular","corner"],he={rectangular:{width:181,height:65.5},circular:{width:51,height:51},corner:{width:34,height:34}},Pi=["rectangular","circular","corner","inline"];var Bo=64;function Qd(e,n){let t=new Set(e);for(let i of n)t.add(i.slot);for(let i=0;i<Bo;i++)if(!t.has(i))return i;return-1}function ec(e,n){let t=new Set(e);return n.filter(i=>i.kind!=="preset"||!t.has(i.slot))}function Rn(e){return se.some(t=>!e.supportedFamilies.includes(t))||e.supportedFamilies.includes("inline")||e.inline!==void 0?6:e.slotIndex>7?5:4}var rf=["none","dot","triangle"],of=["straight","smooth","step"],sf=["light","medium","strong"],lf={light:.05,medium:.1,strong:.2};function Nd(e){return typeof e=="string"&&of.includes(e)?e:"straight"}var df=["flat","fade"],cf=["none","all","auto"],tc=4,Ft="#FFFFFF33";function qt(e){return typeof e=="string"&&df.includes(e)?e:"flat"}function Do(e){return typeof e=="string"&&cf.includes(e)?e:"none"}function Oo(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(tc,Math.round(e)))}function nc(e,n){return e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function Wt(e){return typeof e=="string"&&e!==""?e:Ft}var uf=1,pf=12;function pt(e){if(!(typeof e!="number"||!Number.isFinite(e)))return Math.max(uf,Math.min(pf,e))}function Ya(e){return e==="all"?"all":"auto"}var Jt=1,Zt=3,Xa=.25,Ja=4;function An(e){return typeof e!="number"||!Number.isFinite(e)?Zt:Math.max(1,Math.min(tc,Math.round(e)))}function Hn(e){return typeof e!="number"||!Number.isFinite(e)?Jt:Math.max(Xa,Math.min(Ja,e))}var hf=["all","top"],li=1.2;function Yt(e){return typeof e!="number"||!Number.isFinite(e)?li:Math.max(0,e)}function Xt(e){return typeof e=="string"&&hf.includes(e)?e:"all"}function rt(e){if(typeof e=="string")return sf.includes(e)?e:void 0;if(e===3||e===5)return"light";if(e===7)return"medium";if(e===9)return"strong"}function ic(e,n){if(n===void 0||e<2)return 0;let t=Math.max(3,Math.floor(e*lf[n]+.5));return t%2===0?t+1:t}var mf=[["history","Recorded history"],["statistics","Long-term statistics"]],Za=[["5minute","5 min"],["hour","Hour"],["day","Day"],["week","Week"],["month","Month"]],Vo=[["mean","Mean"],["min","Min"],["max","Max"],["change","Change"],["sum","Total"]],Go="history",Bi="hour",Vi="mean",mt=[["latest","Newest reading"],["first","First reading"],["highest","Highest reading"],["lowest","Lowest reading"],["average","Average reading"],["delta","Change"],["sum","Total"],["trend","Trend arrow"],["top","Top of the scale"],["bottom","Bottom of the scale"]],Gi={x:.25,y:.25,width:.5,height:.5,rotationDegrees:0},ft=[["highest","Highest reading"],["lowest","Lowest reading"],["now","Now"],["first","First reading"],["latest","Newest reading"],["threshold","Threshold"],["zero","Zero"]];function It(e){return e!=="threshold"&&e!=="zero"}var Qa=[["above","Above"],["on","On"],["below","Inside"],["bottom","At the bottom"],["through","Through"]];function ff(e){return ft.some(([n])=>n===e)}function gf(e){return Qa.some(([n])=>n===e)}function yf(e){if(!G(e)||typeof e.layer!="string"||e.layer==="")return;let n={layer:e.layer.toUpperCase(),at:ff(e.at)?e.at:"highest",place:gf(e.place)?e.place:"above"},t=Z(e.dx,0),i=Z(e.dy,0);return t!==0&&(n.dx=t),i!==0&&(n.dy=i),n}function Va(e,n){let t=yf(e.chartAnchor);t!==void 0&&(n.chartAnchor=t)}function Ga(e,n){e.chartAnchor!==void 0&&(n.chartAnchor=bf(e.chartAnchor))}function bf(e){let n={layer:e.layer,at:e.at,place:e.place};return e.dx!==void 0&&e.dx!==0&&(n.dx=X(e.dx)),e.dy!==void 0&&e.dy!==0&&(n.dy=X(e.dy)),n}var De={setColor:"color",setOpacity:"opacity",setText:"text",setIcon:"icon",setFontSize:"fontSize",setFontWeight:"fontWeight",setRotation:"rotation",hide:"visibility",show:"visibility",setGaugeValue:"gaugeValue",setGaugeMin:"gaugeMin",setGaugeMax:"gaugeMax",setBorderColor:"borderColor",setBorderWidth:"borderWidth",setBackgroundColor:"backgroundColor"};function ac(e){return e.countdown===!0?!1:e.coloring==="bands"&&(e.bands?.length??0)>0||e.highlight!==void 0&&e.highlight!=="none"}function ot(e){return e.countdown!==!0&&(e.parts?.length??0)>0}function Fn(e){if(e.kind.kind==="literal")return(e.format?.prefix??"")+e.kind.value+(e.format?.suffix??"")}function Ui(e){let n=c=>c.value.kind.kind!=="literal",t=(c,u)=>e.slice(c,u).map(p=>Fn(p.value)??"").join(""),i=e.findIndex(n);if(i<0)return V(t(0,e.length));let a=e.findIndex((c,u)=>u>i&&n(c)),r=e[i].value,o={...r.format},s=t(0,i)+(o.prefix??""),l=(o.suffix??"")+t(i+1,a<0?e.length:a);delete o.prefix,delete o.suffix,s!==""&&(o.prefix=s),l!==""&&(o.suffix=l);let d={kind:structuredClone(r.kind)};return _e(o)||(d.format=o),d}function rc(e){ot(e)&&(e.value=Ui(e.parts))}var di="#FFFFFF";function Dd(e){return typeof e=="string"&&rf.includes(e)}function xf(e){return e==="none"?{high:"none",low:"none"}:e==="pointer"?{high:"triangle",low:"dot"}:{high:"dot",low:"dot"}}function Di(e){let n=xf(e.marker);return{high:e.highMarker??n.high,low:e.lowMarker??n.low}}function oc(e){return e.high==="triangle"?"pointer":e.high!=="none"||e.low!=="none"?"dot":"none"}function sc(e){return e.high==="none"&&e.low==="none"||e.high==="dot"&&e.low==="dot"||e.high==="triangle"&&e.low==="dot"}function vf(e,n){e.marker=oc(n),sc(n)?(delete e.highMarker,delete e.lowMarker):(e.highMarker=n.high,e.lowMarker=n.low)}var er=24,tr=6,Wa="#FFFFFF";function Uo(e){if(e.style!=="bars")return 0;let n=e.barBorderWidth;return typeof n!="number"||!Number.isFinite(n)?0:Math.min(Math.max(n,0),tr)}function lc(e,n,t,i,a){if(a!==void 0)return{fill:a,border:a};if(!Wi(e))return{fill:e.fillColorHex??i,border:e.barBorderColorHex??Wa};let r=t.find(s=>n<=s.upTo),o=r?{color:r.colorHex,fill:r.fillColorHex,border:r.borderColorHex}:{color:e.bandAboveColorHex,fill:e.bandAboveFillColorHex,border:e.bandAboveBorderColorHex};return{fill:o.fill??e.fillColorHex??o.color,border:o.border??e.barBorderColorHex??Wa}}var Qe="#FF6B35",et="#32D74B",Wo="#32D74B",pe="#FF453A",Ko="#FF453A",jo="#FFFFFF99";function Qt(e){return[...e.bands].sort((n,t)=>n.upTo-t.upTo)}function Wi(e){return e.coloring==="bands"&&e.bands.length>0}function nr(e,n,t){for(let i of n)if(e<=i.upTo)return i.colorHex;return t}function Ki(e,n){let t=Math.abs(n),i=t>=10?0:t>=1?1:2;return e.toFixed(i)}function dc(e){return e>0?"\u2191":e<0?"\u2193":"\u2192"}var In=[{minutes:60,label:"Last hour"},{minutes:180,label:"Last 3 hours"},{minutes:360,label:"Last 6 hours"},{minutes:720,label:"Last 12 hours"},{minutes:1440,label:"Last 24 hours"},{minutes:4320,label:"Last 3 days"},{minutes:10080,label:"Last 7 days"}],ir=360,ar=10080,ji=[...In,{minutes:43200,label:"Last 30 days"},{minutes:129600,label:"Last 90 days"},{minutes:527040,label:"Last year"}],qo=366*24*60,rr=2,Lt=120,Yo=0;function Xo(e){let n=Math.round(e.historyPoints);return Number.isFinite(n)?n<1?Yo:Math.max(rr,Math.min(Lt,n)):24}function Ln(e){return Zo(e)!==void 0?!0:Jo(e)!==void 0&&Xo(e)>0}function Jo(e){if(e.source==="history")return cc(e)}function Zo(e){if(e.source==="statistics")return cc(e)}function cc(e){if(!(e.historyMinutes<=0))return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function _n(e){let n=Jo(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${Xo(e)}${e.gaps===!0?"|gaps":""}`}function zn(e){let n=Zo(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${e.statPeriod}|${e.statType}${e.gaps===!0?"|gaps":""}`}function uc(e){return[...Qo(e).map(t=>t.key),...es(e).map(t=>t.key)].sort().join(";")}function Qo(e){let n=new Map,t=i=>{n.has(i.key)||n.set(i.key,i)};for(let i of e.elements)if(i.kind==="chart"){let a=_n(i.payload),r=Jo(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:Math.round(i.payload.historyMinutes),points:Xo(i.payload),mode:"numeric",gaps:i.payload.gaps===!0})}else if(i.kind==="timeline"){let a=gt(i.payload),r=yc(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:st(i.payload),points:an,mode:"states",gaps:!1})}return[...n.values()]}function es(e){let n=new Map;for(let t of e.elements){if(t.kind!=="chart")continue;let i=zn(t.payload),a=Zo(t.payload);i===void 0||a===void 0||n.has(i)||n.set(i,{key:i,entityId:a,minutes:Math.round(t.payload.historyMinutes),period:t.payload.statPeriod,type:t.payload.statType,gaps:t.payload.gaps===!0})}return[...n.values()]}var pc=[["auto","Auto"],["h12","12 hour"],["h24","24 hour"]],hc=[["auto","Auto"],["always","Always"],["never","Never"]];function _o(e){return e==="h12"||e==="h24"?e:Sn}function zo(e){return e==="always"||e==="never"?e:Tn}function wf(e){return e.timeLabelCount!==void 0?ht(e.timeLabelCount):e.timeLabels==="ends"?2:e.timeLabels==="four"?4:Cn}function ht(e){let n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(Pn,Math.round(n))):Cn}function qi(e){return e<=0?[]:e===1?[1]:Array.from({length:e},(n,t)=>t/(e-1))}var en="#8E8E93",mc=1,kf="#000000",$f=2,Cf=1440,ts=60,Cn=0,tt=9,nt="#8E8E93",Sn="auto",Tn="auto",fc=4,Pn=12,tn=1,nn=20,or=4,an=120;function gc(e,n,t){let i=e.trim().toLowerCase();for(let a of n)if(a.match.trim().toLowerCase()===i)return a.colorHex;return t}function st(e){let n=Math.round(e.historyMinutes);return Number.isFinite(n)?Math.max(1,Math.min(ar,n)):ts}function yc(e){return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function gt(e){let n=yc(e);if(n!==void 0)return`${n}|${st(e)}|${an}|states`}var Sf={on:"#FF9F0A",off:"#0A84FF",open:"#FF453A",closed:"#32D74B",opening:"#FFD60A",closing:"#FFD60A",home:"#32D74B",not_home:"#0A84FF",locked:"#32D74B",unlocked:"#FF453A",jammed:"#BF5AF2",playing:"#32D74B",paused:"#FF9F0A",idle:"#0A84FF",standby:"#5E5CE6",heat:"#FF9F0A",cool:"#64D2FF",heat_cool:"#BF5AF2",dry:"#FFD60A",fan_only:"#5E5CE6",auto:"#BF5AF2",cleaning:"#32D74B",docked:"#0A84FF",returning:"#64D2FF",error:"#FF453A",disarmed:"#32D74B",armed_home:"#0A84FF",armed_away:"#FF9F0A",armed_night:"#5E5CE6",arming:"#FFD60A",pending:"#FFD60A",triggered:"#FF453A",unavailable:"#48484A",unknown:"#48484A"},Yi={binary_sensor:["on","off"],switch:["on","off"],light:["on","off"],input_boolean:["on","off"],fan:["on","off"],humidifier:["on","off"],siren:["on","off"],cover:["open","closed","opening","closing"],lock:["locked","unlocked","jammed"],person:["home","not_home"],device_tracker:["home","not_home"],media_player:["playing","paused","idle","off"],climate:["heat","cool","heat_cool","dry","fan_only","auto","off"],vacuum:["cleaning","docked","returning","idle","error"],alarm_control_panel:["disarmed","armed_home","armed_away","armed_night","arming","pending","triggered"]};function Ka(e){return Sf[e.trim().toLowerCase()]??en}var Tf=["door","garage_door","window","opening"];function ns(e,n){let t=(n??"").trim().toLowerCase(),i=e==="binary_sensor"&&Tf.includes(t),a=o=>Ka(i&&o==="on"?"open":o);return[...Yi[e]??[],"unavailable","unknown"].map(o=>({id:Q(),match:o,colorHex:a(o)}))}var ci=6,sr=9,Ef=["topLeading","topTrailing","bottomLeading","bottomTrailing"];function lr(e){return Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY)}function Mf(e,n){let t=n<=.5,i=e<=.5;return t?i?"topLeading":"topTrailing":i?"bottomLeading":"bottomTrailing"}var is={top:0,left:0,bottom:0,right:0};function dr(e){return e===void 0||e.top===0&&e.left===0&&e.bottom===0&&e.right===0}var Rf=["toggleEntity","runScene","runScript","addTodo","runHTTPAction"];function bc(e){return Rf.includes(e)}function xc(e){let n=(e??"").trim();if(n==="")return!0;try{let t=JSON.parse(n);return typeof t=="object"&&t!==null&&!Array.isArray(t)}catch{return!1}}var as=[["refresh","Refresh"],["none","Nothing"],["openApp","Open the app"],["openPage","Open the page"],["openRoomPage","Open the room page"],["timerStartPause","Timer start / pause"],["timerCancel","Timer cancel"],["toggleEntity","Toggle an entity"],["runScene","Run a scene"],["runScript","Run a script"],["addTodo","Add a to-do"],["runHTTPAction","Run an HTTP action"],["callService","Call a service"]];function _t(e){let n=as.find(([i])=>i===e.type)?.[1]??e.type;if(e.type==="callService"){let i=[e.serviceDomain,e.serviceName].filter(a=>a!=="").join(".");return i===""?n:`${n}: ${i}`}if(!("entityId"in e))return n;let t=e.displayName||e.entityId;return t?`${n}: ${t}`:n}function G(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function q(e,n=""){return typeof e=="string"?e:n}function Z(e,n){return typeof e=="number"?e:e==="+inf"?1/0:e==="-inf"?-1/0:e==="nan"?NaN:n}function ut(e){return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}function Ni(e){return e==null?void 0:Z(e,0)}function Te(e){return typeof e=="string"?e:void 0}function si(e,n,t){return typeof e=="string"&&n.includes(e)?e:t}function Po(e,n,t){return n.some(([i])=>i===e)?e:t}var it=class extends Error{};function Kt(e){if(typeof e.entityId!="string")throw new it("entityId is required");let n={entityId:e.entityId,displayName:q(e.displayName),domain:q(e.domain)};return typeof e.iconName=="string"&&(n.iconName=e.iconName),n}function Od(e){if(!G(e))return;let n={};return e.decimals!==void 0&&e.decimals!==null&&(n.decimals=Z(e.decimals,0)),e.multiply!==void 0&&e.multiply!==null&&(n.multiply=Z(e.multiply,1)),e.offset!==void 0&&e.offset!==null&&(n.offset=Z(e.offset,0)),typeof e.prefix=="string"&&(n.prefix=e.prefix),typeof e.suffix=="string"&&(n.suffix=e.suffix),e.useEntityUnit===!0&&(n.useEntityUnit=!0),e.relativeTime===!0&&(n.relativeTime=!0),e.duration===!0&&(n.duration=!0),(e.textCase==="upper"||e.textCase==="lower"||e.textCase==="capitalized")&&(n.textCase=e.textCase),_e(n)?void 0:n}function _e(e){return e?e.decimals===void 0&&e.multiply===void 0&&e.offset===void 0&&!e.prefix&&!e.suffix&&!e.useEntityUnit&&!e.relativeTime&&!e.duration&&e.textCase===void 0:!0}function Af(e){let n=q(e.function,"count"),t=G(e.scope)?e.scope:{},i;if(t.kind==="entities")i={kind:"entities",entities:(Array.isArray(t.entities)?t.entities:[]).filter(G).map(Kt)};else{let r=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[];i={kind:"filter",domains:r(t.domains),areaIds:r(t.areaIds),labelIds:r(t.labelIds),floorIds:r(t.floorIds)}}let a={function:n,scope:i};if(G(e.stateFilter)){let r=e.stateFilter.kind;r==="isOn"||r==="isOff"?a.stateFilter={kind:r}:(r==="equals"||r==="notEquals")&&(a.stateFilter={kind:r,value:q(e.stateFilter.value)})}return typeof e.attribute=="string"&&(a.attribute=e.attribute),a}function Bd(e){switch(e.kind){case"literal":return{kind:"literal",value:q(e.value)};case"entityState":return{kind:"entityState",...Kt(e)};case"entityAttribute":return{kind:"entityAttribute",...Kt(e),attribute:q(e.attribute)};case"entityAge":return{kind:"entityAge",...Kt(e)};case"aggregate":return{kind:"aggregate",aggregate:Af(G(e.aggregate)?e.aggregate:{})};case"time":return{kind:"time",timeField:Te(e.timeField)??"now"};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:q(e.value)};case"named":return{kind:"named",id:q(e.id).toUpperCase()};case"chartStat":return{kind:"chartStat",layer:q(e.layer).toUpperCase(),stat:mt.some(([n])=>n===e.stat)?e.stat:"latest"};default:throw new it(`unknown value kind ${String(e.kind)}`)}}function xe(e){if(!G(e))throw new it("value must be an object");if(G(e.kind)){let i={kind:Bd(e.kind)},a=Od(e.format);return a&&(i.format=a),i}let n={kind:Bd(e)},t=Od(e.format);return t&&(n.format=t),n}function vc(e){return G(e)?{x:Z(e.x,.25),y:Z(e.y,.25),width:Z(e.width,.5),height:Z(e.height,.5),rotationDegrees:Z(e.rotationDegrees,0)}:{...Gi}}function Hf(e){if(!G(e))return{kind:"isOn"};let n=q(e.kind,"isOn"),t={kind:n};switch(n){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":t.value=G(e.value)?xe(e.value):V("");break;case"between":case"timeBetween":t.value=G(e.value)?xe(e.value):V(""),t.upper=G(e.upper)?xe(e.upper):V("");break;case"matchesRegex":t.pattern=q(e.pattern);break;case"isOneOf":t.options=Array.isArray(e.options)?e.options.filter(i=>typeof i=="string"):[];break;default:break}return t}function Vd(e){if(!G(e))return{kind:"show"};let n=q(e.kind,"show"),t={kind:n};switch(n){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":t.value=G(e.value)?xe(e.value):V("");break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":t.number=Z(e.number,0);break;case"setFontWeight":t.weight=Te(e.weight)??"regular";break;default:break}return t}function wc(e){return Array.isArray(e)?e.filter(G).map(n=>{let t={id:q(n.id).toUpperCase(),cases:(Array.isArray(n.cases)?n.cases:[]).filter(G).map(i=>{let a=G(i.when)?i.when:{};return{id:q(i.id).toUpperCase(),when:{join:a.join==="any"?"any":"all",tests:(Array.isArray(a.tests)?a.tests:[]).filter(G).map(r=>({id:q(r.id).toUpperCase(),value:G(r.value)?xe(r.value):V(""),comparison:Hf(r.comparison)}))},then:(Array.isArray(i.then)?i.then:[]).map(Vd)}})};return Array.isArray(n.otherwise)&&(t.otherwise=n.otherwise.map(Vd)),typeof n.partId=="string"&&n.partId!==""&&(t.partId=n.partId.toUpperCase()),t}):[]}function Ff(e,n){return{baseColorHex:G(e)?q(e.baseColorHex,n):n}}function ja(e){return Array.isArray(e)?e.filter(G).map(n=>{let t={id:q(n.id,Q()),upTo:Z(n.upTo,0),colorHex:q(n.colorHex,"#FFFFFF")};return typeof n.fillColorHex=="string"&&(t.fillColorHex=n.fillColorHex),typeof n.borderColorHex=="string"&&(t.borderColorHex=n.borderColorHex),t}):[]}function Ua(e){let n={id:e.id,upTo:X(e.upTo),colorHex:e.colorHex};return e.fillColorHex!==void 0&&(n.fillColorHex=e.fillColorHex),e.borderColorHex!==void 0&&(n.borderColorHex=e.borderColorHex),n}function If(e){return Array.isArray(e)?e.filter(G).map(n=>{let t={id:q(n.id,Q()).toUpperCase(),value:G(n.value)?xe(n.value):V("")};typeof n.colorHex=="string"&&(t.colorHex=n.colorHex);let i=Te(n.fontWeight);(i==="regular"||i==="medium"||i==="semibold"||i==="bold")&&(t.fontWeight=i),typeof n.fontSize=="number"&&(t.fontSize=n.fontSize),Te(n.coloring)==="bands"&&(t.coloring="bands");let a=ja(n.bands);a.length>0&&(t.bands=a);let r=q(n.bandAboveColorHex,pe);return r!==pe&&(t.bandAboveColorHex=r),t}):[]}function Lf(e){if(Array.isArray(e.bands))return ja(e.bands);if(typeof e.bandLowerBound!="number")return[];let n=G(e.colorSlot)?q(e.colorSlot.baseColorHex,"#FFFFFF"):"#FFFFFF";return[{id:Q(),upTo:e.bandLowerBound,colorHex:q(e.bandLowColorHex,Wo)},{id:Q(),upTo:Z(e.bandUpperBound,100),colorHex:n}]}function _f(e){return Array.isArray(e)?e.filter(G).map(n=>({id:q(n.id,Q()).toUpperCase(),match:q(n.match,""),colorHex:q(n.colorHex,en)})):[]}function Ze(e,n){if(typeof e.id!="string")throw new it("element id is required");return{id:e.id.toUpperCase(),colorSlot:Ff(e.colorSlot,n),rules:wc(e.rules),frame:vc(e.frame),isHidden:e.isHidden===!0}}function zf(e){let n=Pf(e),t=e.payload;return typeof t.groupId=="string"&&t.groupId!==""&&(n.payload.groupId=t.groupId.toUpperCase()),typeof t.name=="string"&&t.name!==""&&(n.payload.name=t.name),n}function Pf(e){if(!G(e)||!G(e.payload))throw new it("element must have a payload");let n=e.payload;switch(e.kind){case"text":{let t={...Ze(n,"#FFFFFF"),value:G(n.value)?xe(n.value):V(""),fontSize:Z(n.fontSize,14),fontWeight:Te(n.fontWeight)??"regular"};n.countdown===!0&&(t.countdown=!0),n.monospacedDigits===!0&&(t.monospacedDigits=!0);let i=typeof n.lineLimit=="number"?Math.round(n.lineLimit):1;Math.min(2,Math.max(1,i))===2&&(t.lineLimit=2);let a=Te(n.alignment);(a==="leading"||a==="trailing")&&(t.alignment=a),Te(n.coloring)==="bands"&&(t.coloring="bands");let r=ja(n.bands);r.length>0&&(t.bands=r);let o=q(n.bandAboveColorHex,pe);o!==pe&&(t.bandAboveColorHex=o);let s=Te(n.highlight);(s==="highest"||s==="lowest"||s==="both")&&(t.highlight=s);let l=q(n.highColorHex,Qe);l!==Qe&&(t.highColorHex=l);let d=q(n.lowColorHex,et);d!==et&&(t.lowColorHex=d);let c=If(n.parts);return c.length>0&&(t.parts=c),Va(n,t),{kind:"text",payload:t}}case"icon":{let t={...Ze(n,"#FFFFFF"),symbol:G(n.symbol)?xe(n.symbol):V("lightbulb"),size:Z(n.size,14)},i=Te(n.path);return i!==void 0&&i!==""&&(t.path=i),Va(n,t),{kind:"icon",payload:t}}case"gauge":{let t={...Ze(n,"#FFFFFF"),value:G(n.value)?xe(n.value):V("50"),minValue:Z(n.minValue,0),maxValue:Z(n.maxValue,100),style:Te(n.style)??"arc",lineWidth:Z(n.lineWidth,4),trackColorHex:q(n.trackColorHex,"#FFFFFF40"),coloring:Te(n.coloring)??"uniform",bands:ja(n.bands),bandAboveColorHex:q(n.bandAboveColorHex,pe),thresholdColorHex:q(n.thresholdColorHex,di)},i=Ni(n.thresholdValue);return i!==void 0&&(t.thresholdValue=i),G(n.total)&&(t.total=xe(n.total)),G(n.minSource)&&(t.minSource=xe(n.minSource)),G(n.maxSource)&&(t.maxSource=xe(n.maxSource)),{kind:"gauge",payload:t}}case"chart":return{kind:"chart",payload:{...Ze(n,"#FFFFFF"),value:G(n.value)?xe(n.value):V("13,14,16,17,19,22,24,28,30"),historyMinutes:Math.max(0,Math.round(Z(n.historyMinutes,0))),historyPoints:Math.round(Z(n.historyPoints,24)),source:Po(Te(n.source),mf,Go),statPeriod:Po(Te(n.statPeriod),Za,Bi),statType:Po(Te(n.statType),Vo,Vi),style:si(n.style,["bars","line","area"],"bars"),limit:Math.max(0,Math.round(Z(n.limit,0))),takeFromEnd:n.takeFromEnd===!0,scale:si(n.scale,["auto","fixed"],"auto"),minValue:Z(n.minValue,0),maxValue:Z(n.maxValue,100),baseline:si(n.baseline,["lowest","zero"],"lowest"),barGap:Z(n.barGap,1.5),lineWidth:Z(n.lineWidth,2),highlight:si(n.highlight,["none","highest","lowest","both"],"none"),highColorHex:q(n.highColorHex,Qe),lowColorHex:q(n.lowColorHex,et),marker:typeof n.marker=="string"?si(n.marker,["none","dot","pointer"],"dot"):"pointer",...Dd(n.highMarker)?{highMarker:n.highMarker}:{},...Dd(n.lowMarker)?{lowMarker:n.lowMarker}:{},coloring:si(n.coloring,["uniform","bands"],"uniform"),bands:Lf(n),bandAboveColorHex:q(n.bandHighColorHex,q(n.bandAboveColorHex,pe)),fillBands:n.fillBands===!0,...Nd(n.curve)!=="straight"?{curve:Nd(n.curve)}:{},...qt(n.fillStyle)!=="flat"?{fillStyle:qt(n.fillStyle)}:{},...typeof n.fillColorHex=="string"?{fillColorHex:n.fillColorHex}:{},...Yt(n.barRadius)!==li?{barRadius:Yt(n.barRadius)}:{},...Xt(n.barCorners)!=="all"?{barCorners:Xt(n.barCorners)}:{},...typeof n.barBorderWidth=="number"&&Number.isFinite(n.barBorderWidth)&&n.barBorderWidth!==0?{barBorderWidth:n.barBorderWidth}:{},...typeof n.barBorderColorHex=="string"?{barBorderColorHex:n.barBorderColorHex}:{},...n.barBorderOpenBase===!0?{barBorderOpenBase:!0}:{},...typeof n.bandAboveFillColorHex=="string"?{bandAboveFillColorHex:n.bandAboveFillColorHex}:{},...typeof n.bandAboveBorderColorHex=="string"?{bandAboveBorderColorHex:n.bandAboveBorderColorHex}:{},...Do(n.pointDots)!=="none"?{pointDots:Do(n.pointDots)}:{},...pt(n.pointDotSize)!==void 0?{pointDotSize:pt(n.pointDotSize)}:{},...typeof n.pointDotColorHex=="string"?{pointDotColorHex:n.pointDotColorHex}:{},...Oo(n.gridLines)!==0?{gridLines:Oo(n.gridLines)}:{},...nc(Wt(n.gridColorHex),Ft)?{}:{gridColorHex:Wt(n.gridColorHex)},...n.zeroLine===!0?{zeroLine:!0}:{},...rt(n.smoothing)!==void 0?{smoothing:rt(n.smoothing)}:{},...n.gaps===!0?{gaps:!0}:{},...typeof n.thresholdValue=="number"&&Number.isFinite(n.thresholdValue)?{thresholdValue:n.thresholdValue}:{},thresholdColorHex:q(n.thresholdColorHex,Ko),...G(n.nowIndex)?{nowIndex:xe(n.nowIndex)}:{},nowColorHex:q(n.nowColorHex,jo),...n.drawsThreshold===!1?{drawsThreshold:!1}:{},...n.drawsNowLine===!1?{drawsNowLine:!1}:{},...n.drawsTimeLabels===!1?{drawsTimeLabels:!1}:{},...Te(n.scaleFrom)!==void 0?{scaleFrom:Te(n.scaleFrom)}:{},timeLabelCount:ht(n.timeLabelCount),labelSize:Z(n.labelSize,tt),labelColorHex:q(n.labelColorHex,nt),labelsAbove:n.labelsAbove===!0,hourCycle:_o(n.hourCycle),minutes:zo(n.minutes)}};case"timeline":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"timeline",payload:{...i,value:G(n.value)?xe(n.value):V(""),historyMinutes:Math.max(1,Math.round(Z(n.historyMinutes,ts))),bands:_f(n.bands),otherColorHex:q(n.otherColorHex,en),gap:Math.min(or,Math.max(0,Z(n.gap,0))),cornerRadius:Math.max(0,Z(n.cornerRadius,mc)),timeLabelCount:wf(n),labelSize:Z(n.labelSize,tt),labelColorHex:q(n.labelColorHex,nt),labelsAbove:n.labelsAbove===!0,hourCycle:_o(n.hourCycle),minutes:zo(n.minutes),...n.drawsTimeLabels===!1?{drawsTimeLabels:!1}:{}}}}case"shape":{let t={...Ze(n,"#FFFFFF33"),kind:Te(n.kind)??"roundedRectangle",cornerRadius:Z(n.cornerRadius,6),thickness:Z(n.thickness,1),borderWidth:Z(n.borderWidth,1)};return typeof n.borderColorHex=="string"&&(t.borderColorHex=n.borderColorHex),Va(n,t),{kind:"shape",payload:t}}case"image":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF"),a={...i,entity:Kt(G(n.entity)?n.entity:{}),source:n.source==="entityPicture"?"entityPicture":"camera",contentMode:n.contentMode==="fit"?"fit":"fill",zoom:Z(n.zoom,1),panX:Z(n.panX,0),panY:Z(n.panY,0),cornerRadius:Z(n.cornerRadius,ci),timestampCorner:Ef.includes(n.timestampCorner)?n.timestampCorner:"topLeading",timestampSize:Z(n.timestampSize,sr)};n.timestamp===!0&&(a.timestamp=!0);let r=Ni(n.timestampX),o=Ni(n.timestampY);return r!==void 0&&o!==void 0&&Number.isFinite(r)&&Number.isFinite(o)&&(a.timestampX=ut(r),a.timestampY=ut(o)),Va(n,a),{kind:"image",payload:a}}case"tap":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF"),a={...i,action:G(n.action)?kc(n.action):{type:"refresh"}};return typeof n.openPageId=="string"&&(a.openPageId=n.openPageId),typeof n.openPageName=="string"&&(a.openPageName=n.openPageName),typeof n.attachedTo=="string"&&(a.attachedTo=n.attachedTo.toUpperCase()),{kind:"tap",payload:a}}case"chartTimes":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"chartTimes",payload:{...i,chart:q(n.chart).toUpperCase(),timeLabelCount:ht(n.timeLabelCount),labelSize:Z(n.labelSize,tt),labelColorHex:q(n.labelColorHex,nt),hourCycle:_o(n.hourCycle),minutes:zo(n.minutes)}}}case"imageTime":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"imageTime",payload:{...i,image:q(n.image).toUpperCase()}}}case"chartDots":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF"),a=pt(n.size);return{kind:"chartDots",payload:{...i,chart:q(n.chart).toUpperCase(),dots:Ya(n.dots),...a!==void 0?{size:a}:{},...typeof n.colorHex=="string"?{colorHex:n.colorHex}:{}}}}case"chartGrid":{let{colorSlot:t,...i}=Ze(n,"#FFFFFF");return{kind:"chartGrid",payload:{...i,chart:q(n.chart).toUpperCase(),lines:An(n.lines),colorHex:Wt(n.colorHex),thickness:Hn(n.thickness)}}}default:throw new it(`unknown element kind ${String(e.kind)}`)}}function Gd(e){let n=G(e)?e:{},t={};if(G(n.placements))for(let[a,r]of Object.entries(n.placements)){if(!G(r))continue;let o={frame:vc(r.frame),isHidden:r.isHidden===!0},s=Ni(r.size);s!==void 0&&(o.size=s),t[a.toUpperCase()]=o}let i={placements:t,cornerBodyShape:n.cornerBodyShape==="circle"?"circle":"wedge",borderWidth:Z(n.borderWidth,2),rules:wc(n.rules)};if(G(n.bezelText)&&(i.bezelText=xe(n.bezelText)),n.bezelCountdown===!0&&(i.bezelCountdown=!0),G(n.curvedText)&&(i.curvedText=xe(n.curvedText)),typeof n.curvedColorHex=="string"&&(i.curvedColorHex=n.curvedColorHex),G(n.bezelGauge)){let a=n.bezelGauge,r={value:G(a.value)?xe(a.value):V("50"),minValue:Z(a.minValue,0),maxValue:Z(a.maxValue,100),colorHexes:Array.isArray(a.colorHexes)&&a.colorHexes.length>0?a.colorHexes.filter(o=>typeof o=="string"):["#34C759","#FFCC00","#FF3B30"]};G(a.minLabel)&&(r.minLabel=xe(a.minLabel)),G(a.maxLabel)&&(r.maxLabel=xe(a.maxLabel)),i.bezelGauge=r}return typeof n.backgroundColorHex=="string"&&(i.backgroundColorHex=n.backgroundColorHex),typeof n.borderColorHex=="string"&&(i.borderColorHex=n.borderColorHex),i}function Nf(e){let n={};if(Array.isArray(e))for(let t=0;t+1<e.length;t+=2){let i=e[t];typeof i=="string"&&(n[i]=Gd(e[t+1]))}else if(G(e))for(let[t,i]of Object.entries(e))n[t]=Gd(i);return n}function Df(e){let n={value:G(e.value)?xe(e.value):V("")};return typeof e.label=="string"&&(n.label=e.label),typeof e.symbol=="string"&&(n.symbol=e.symbol),e.countdown===!0&&(n.countdown=!0),n}function kc(e){if(!G(e)||typeof e.type!="string")return{type:"none"};switch(e.type){case"none":case"refresh":case"openApp":case"openPage":case"openRoomPage":case"timerStartPause":case"timerCancel":return{type:e.type};case"toggleEntity":case"runScene":case"runScript":case"addTodo":case"runHTTPAction":return{type:e.type,...Kt(e)};case"callService":{let n={type:"callService",serviceDomain:typeof e.serviceDomain=="string"?e.serviceDomain:"",serviceName:typeof e.serviceName=="string"?e.serviceName:""};return typeof e.serviceDataJSON=="string"&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),typeof e.entityId=="string"&&e.entityId!==""&&(n.target=Kt(e)),n}default:return{type:"none"}}}function ui(e){if(!G(e))throw new it("config must be an object");for(let r of["id","name","slotIndex","supportedFamilies","perFamily","tapAction"])if(!(r in e))throw new it(`${r} is required`);let n=(Array.isArray(e.values)?e.values:[]).filter(G).map(r=>({id:q(r.id).toUpperCase(),name:q(r.name),value:G(r.value)?xe(r.value):V("")})),t=(Array.isArray(e.dataSources)?e.dataSources:[]).filter(G).map(r=>r.kind==="template"?{kind:"template",value:q(r.value)}:r.kind==="entity"?{kind:"entity",...Kt(r)}:null).filter(r=>r!==null),i={schemaVersion:Z(e.schemaVersion,1),id:q(e.id).toUpperCase(),name:q(e.name,"Custom"),values:n,slotIndex:Z(e.slotIndex,0),elements:(Array.isArray(e.elements)?e.elements:[]).map(zf),supportedFamilies:(Array.isArray(e.supportedFamilies)?e.supportedFamilies:[]).filter(r=>typeof r=="string"),perFamily:Nf(e.perFamily),dataSources:t,tapAction:kc(e.tapAction)};G(e.inline)&&(i.inline=Df(e.inline));let a=Ni(e.refreshMinutes);if(a!==void 0&&(i.refreshMinutes=a),typeof e.openPageId=="string"&&(i.openPageId=e.openPageId),typeof e.openPageName=="string"&&(i.openPageName=e.openPageName),typeof e.showSuccessFlash=="boolean"&&(i.showSuccessFlash=e.showSuccessFlash),typeof e.successFlashColorHex=="string"&&(i.successFlashColorHex=e.successFlashColorHex),e.hidden===!0&&(i.hidden=!0),Array.isArray(e.groups)){let r=e.groups.filter(G).filter(o=>typeof o.id=="string").map(o=>({id:q(o.id).toUpperCase(),name:q(o.name,"Group"),locked:o.locked!==!1}));r.length>0&&(i.groups=r)}return qf(i,Array.isArray(e.elements)?e.elements:[]),dt(i),i}function rs(e,n){let t=n?.kind;if(!t||t.kind!=="chartStat")return;let i=e.elements.find(a=>a.payload.id===t.layer);return i?.kind==="chart"?i:void 0}function rn(e,n){return e.elements.filter(t=>t.kind==="text"&&t.payload.value.kind.kind==="chartStat"&&t.payload.value.kind.layer===n)}function Of(e,n){let t=qa(e,Bn(n))?.ref;return t?.displayName||t?.entityId||(n.kind==="image"?"Picture":n.kind==="timeline"?"Timeline":"Chart")}function zt(e,n,t){let i=lt(e,n.payload.id);if(i){Xi(e,t,i.id);return}let a=ms(e,[n.payload.id,t],Of(e,n)),r=e.groups?.find(o=>o.id===a);r&&(r.locked=!1)}var $c={top:{x:0,y:0},highest:{x:.35,y:0},average:{x:.65,y:0},latest:{x:1,y:0},bottom:{x:0,y:1},lowest:{x:.35,y:1},trend:{x:.85,y:0},delta:{x:.5,y:0},sum:{x:.2,y:0},first:{x:.65,y:1}};function Cc(e,n,t,i){let a=he.rectangular,r=Math.min(1,(i*t*.62+4)/a.width),o=Math.min(1,t*1.3/a.height),s=e.x+n.x*e.width-n.x*r,l=e.y+n.y*e.height-n.y*o;return{x:Math.max(0,Math.min(1-r,s)),y:Math.max(0,Math.min(1-o,l)),width:r,height:o,rotationDegrees:0}}function Sc(e,n,t){let i=e.elements.find(d=>d.payload.id===n);if(!i||i.kind!=="chart")return;let a=Ee("text"),r=t==="latest"?10:8,o={kind:{kind:"chartStat",layer:n,stat:t}};(t==="latest"||t==="delta"||t==="sum")&&(o.format={useEntityUnit:!0}),a.payload.value=o,a.payload.fontSize=r,a.payload.fontWeight="medium",a.payload.colorSlot={baseColorHex:t==="latest"?"#FFFFFF":"#FFFFFF99"};let s=t==="trend"?2:o.format?.useEntityUnit?7:4;a.payload.frame=Cc(i.payload.frame,$c[t],r,s);let l=e.elements.findIndex(d=>d.payload.id===n);return e.elements.splice(l+1,0,a),zt(e,i,a.payload.id),a.payload.id}var Tc={highest:"arrowtriangle.up.fill",lowest:"circle.fill",now:"arrowtriangle.down.fill",first:"circle.fill",latest:"circle.fill",threshold:"circle.fill",zero:"circle.fill"},Ud=6,Bf={"\u25B2":"arrowtriangle.up.fill","\u25BC":"arrowtriangle.down.fill","\u25CF":"circle.fill","\u25C6":"diamond.fill"};function Vf(e,n){let t=(i,a)=>i!==void 0&&i!==a?i:void 0;return n==="highest"?t(e.payload.highColorHex,Qe)??"#FFD60A":n==="lowest"?t(e.payload.lowColorHex,et)??"#FF453A":"#FFFFFF"}function os(e){e.nowIndex===void 0&&(e.nowIndex={kind:{kind:"time",timeField:"hour"}},e.drawsNowLine=!1)}function Ne(e,n){return e.elements.filter(t=>t.payload.chartAnchor?.layer===n)}function ss(e,n,t,i="above"){let a=e.elements.find(s=>s.payload.id===n);if(!a||a.kind!=="chart")return;t==="now"&&os(a.payload);let r=Ee("icon");r.payload.symbol=V(Tc[t]),r.payload.size=Ud,r.payload.colorSlot={baseColorHex:Vf(a,t)},r.payload.frame=Gf(Ud),r.payload.chartAnchor={layer:n,at:t,place:i};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),zt(e,a,r.payload.id),r.payload.id}function Ec(e,n){let t=e.elements.findIndex(u=>u.payload.id===n),i=e.elements[t];if(!i||i.kind!=="text"||i.payload.chartAnchor===void 0)return;let a=i.payload,r=a.chartAnchor,o=u=>{let p=Fn(u);return p===void 0?void 0:Bf[p.trim()]},s=new Set(Zi.icon),l=u=>u.flatMap(p=>{if(p.kind==="setText"){let m=p.value===void 0?void 0:o(p.value);return m===void 0?[]:[{kind:"setIcon",value:V(m)}]}return s.has(De[p.kind])?[p]:[]}),d=a.rules.filter(u=>u.partId===void 0).map(u=>({...u,cases:u.cases.map(p=>({...p,then:l(p.then)})),...u.otherwise!==void 0?{otherwise:l(u.otherwise)}:{}})),c=Ee("icon");c.payload={...c.payload,id:a.id,colorSlot:a.colorSlot,rules:d,frame:a.frame,isHidden:a.isHidden,...a.groupId!==void 0?{groupId:a.groupId}:{},...a.name!==void 0?{name:a.name}:{},chartAnchor:r,symbol:V(o(a.value)??Tc[r.at]),size:a.fontSize},e.elements[t]=c}function Gf(e){let n=he.rectangular;return{x:0,y:0,width:Math.min(1,e*1.2/n.width),height:Math.min(1,e*1.3/n.height),rotationDegrees:0}}function En(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;t==="now"&&os(a);let r=Ee("shape");r.payload.kind="line",r.payload.thickness=1,r.payload.borderWidth=0,r.payload.colorSlot={baseColorHex:t==="now"?a.nowColorHex:a.thresholdColorHex},r.payload.frame=Mc(a.frame,t),r.payload.chartAnchor={layer:n,at:t,place:"through"};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),zt(e,i,r.payload.id),t==="now"?a.drawsNowLine=!1:a.drawsThreshold=!1,r.payload.id}function Mc(e,n){let t=he.rectangular,i=3;return n==="now"?{...e,width:Math.min(e.width,i/t.width),rotationDegrees:0}:{...e,height:Math.min(e.height,i/t.height),rotationDegrees:0}}function on(e,n){return e.elements.filter(t=>t.kind==="chartTimes"&&t.payload.chart===n)}function Nn(e,n){let t=e.elements.find(o=>o.payload.id===n);if(!t||t.kind!=="chart"&&t.kind!=="timeline")return;let i=t.payload,a=Ee("chartTimes");a.payload.chart=n,a.payload.timeLabelCount=i.timeLabelCount>0?ht(i.timeLabelCount):fc,a.payload.labelSize=i.labelSize,a.payload.labelColorHex=i.labelColorHex,a.payload.hourCycle=i.hourCycle,a.payload.minutes=i.minutes,a.payload.frame=jf(i.frame,i.labelSize,i.labelsAbove);let r=e.elements.findIndex(o=>o.payload.id===n);return e.elements.splice(r+1,0,a),zt(e,t,a.payload.id),i.drawsTimeLabels=!1,a.payload.id}function ls(e,n){return e.elements.filter(t=>t.kind==="imageTime"&&t.payload.image===n)}function Uf(e){let n=Math.min(40,Math.max(4,e));return{w:8*n*.578+n*.89,h:n*1.25}}function ds(e,n){return Math.max(0,Math.min(e/(8*.578+.89),n/1.25))}function cs(e,n,t=he.rectangular){let i=e.elements.find(y=>y.payload.id===n);if(!i||i.kind!=="image")return;let a=i.payload,r=Ee("imageTime");r.payload.image=n;let o=Uf(a.timestampSize),s=a.frame.x*t.width,l=a.frame.y*t.height,d=a.frame.width*t.width,c=a.frame.height*t.height,u,p;if(lr(a)){let y=(b,k,$,w)=>w>=$?k+($-w)/2:Math.min(k+$-w,Math.max(k,b-w/2));u=y(s+a.timestampX*d,s,d,o.w),p=y(l+a.timestampY*c,l,c,o.h)}else u=a.timestampCorner.endsWith("Leading")?s+4:s+d-4-o.w,p=a.timestampCorner.startsWith("top")?l+4:l+c-4-o.h;let m=y=>Math.round(y*1e3)/1e3;r.payload.frame={x:m(u/t.width),y:m(p/t.height),width:m(o.w/t.width),height:m(o.h/t.height),rotationDegrees:0};let f=e.elements.findIndex(y=>y.payload.id===n);return e.elements.splice(f+1,0,r),zt(e,i,r.payload.id),delete a.timestamp,delete a.timestampX,delete a.timestampY,a.timestampCorner="topLeading",a.timestampSize=sr,r.payload.id}function Dn(e,n){return e.elements.filter(t=>t.kind==="chartDots"&&t.payload.chart===n)}function On(e,n){return e.elements.filter(t=>t.kind==="chartGrid"&&t.payload.chart===n)}function us(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Ee("chartDots");i.payload.chart=n,i.payload.dots=t.payload.pointDots==="all"?"all":"auto",i.payload.frame={...t.payload.frame};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a+1,0,i),zt(e,t,i.payload.id),i.payload.id}function ps(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Ee("chartGrid");i.payload.chart=n,i.payload.frame={...t.payload.frame};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a,0,i),zt(e,t,i.payload.id),i.payload.id}var Wf="#FFFFFF66";function hs(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Ee("shape");i.payload.kind="line",i.payload.thickness=1,i.payload.borderWidth=0,i.payload.colorSlot={baseColorHex:Wf},i.payload.frame=Mc(t.payload.frame,"threshold"),i.payload.chartAnchor={layer:n,at:"zero",place:"through"};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a+1,0,i),zt(e,t,i.payload.id),i.payload.id}function Rc(e,n,t){let i=e.elements.find(r=>r.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;if(t===void 0){delete a.thresholdValue,delete a.drawsThreshold;for(let r of Ne(e,n))r.payload.chartAnchor?.at==="threshold"&&fe(e,r.payload.id);return}a.thresholdValue=t,a.drawsThreshold=!1,Ne(e,n).some(r=>r.payload.chartAnchor?.at==="threshold")||En(e,n,"threshold")}function Ac(e,n,t){let i=e.elements.find(r=>r.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;if(!t){delete a.nowIndex,delete a.drawsNowLine;for(let r of Ne(e,n))r.payload.chartAnchor?.at==="now"&&fe(e,r.payload.id);return}os(a),a.drawsNowLine=!1,Ne(e,n).some(r=>r.payload.chartAnchor?.at==="now")||En(e,n,"now")}function Hc(e){let n=e.elements.filter(t=>t.kind==="chart"||t.kind==="timeline"||t.kind==="image");for(let t of n){let i=t.payload,a=new Set(e.elements.map(l=>l.payload.id)),r=se.find(l=>e.perFamily[l]?.placements[i.id]!==void 0),o=i.frame,s=r===void 0?void 0:e.perFamily[r].placements[i.id];if(s&&(i.frame={...s.frame}),t.kind==="chart"&&Kf(e,t.payload),t.kind==="timeline"&&t.payload.drawsTimeLabels!==!1&&t.payload.timeLabelCount>0&&Nn(e,i.id),t.kind==="image"&&t.payload.timestamp===!0&&cs(e,i.id,he[r===void 0||r==="inline"?"rectangular":r]),i.frame=o,!(r===void 0||s===void 0))for(let l of e.elements)a.has(l.payload.id)||(e.perFamily[r].placements[l.payload.id]={frame:{...l.payload.frame},isHidden:s.isHidden},l.payload.isHidden=!0)}}function Kf(e,n){{if(n.highlight!==void 0&&n.highlight!=="none"){let a=Di(n),r=[];(n.highlight==="highest"||n.highlight==="both")&&r.push(["highest",a.high]),(n.highlight==="lowest"||n.highlight==="both")&&r.push(["lowest",a.low]);for(let[o,s]of r){let l=ss(e,n.id,o),d=e.elements.find(c=>c.payload.id===l);d?.kind==="icon"&&s!=="none"&&(d.payload.symbol=V(s==="triangle"?"arrowtriangle.up.fill":"circle.fill"))}vf(n,{high:"none",low:"none"}),n.highlight="none"}n.thresholdValue!==void 0&&n.drawsThreshold!==!1&&En(e,n.id,"threshold"),n.nowIndex!==void 0&&n.drawsNowLine!==!1&&En(e,n.id,"now"),n.drawsTimeLabels!==!1&&Ln(n)&&n.timeLabelCount>0&&Nn(e,n.id);let t=Do(n.pointDots);if(t!=="none"){let a=us(e,n.id),r=e.elements.find(o=>o.payload.id===a);if(r?.kind==="chartDots"){r.payload.dots=t;let o=pt(n.pointDotSize);o!==void 0&&(r.payload.size=o),typeof n.pointDotColorHex=="string"&&(r.payload.colorHex=n.pointDotColorHex)}}let i=Oo(n.gridLines);if(i>0){let a=ps(e,n.id),r=e.elements.find(o=>o.payload.id===a);r?.kind==="chartGrid"&&(r.payload.lines=i,r.payload.colorHex=Wt(n.gridColorHex))}if(n.zeroLine===!0){let a=hs(e,n.id),r=e.elements.find(o=>o.payload.id===a);r?.kind==="shape"&&(r.payload.colorSlot={baseColorHex:Wt(n.gridColorHex)})}delete n.pointDots,delete n.pointDotSize,delete n.pointDotColorHex,delete n.gridLines,delete n.gridColorHex,delete n.zeroLine}}function jf(e,n,t){let i=he.rectangular,a=Math.max(tn,Math.min(nn,n)),r=Math.min(1,a*1.2/i.height),o=Math.min(1,Math.max(0,e.width)),s=t?e.y-r:e.y+e.height;return{x:Math.max(0,Math.min(1-o,e.x)),y:Math.max(0,Math.min(1-r,s)),width:o,height:r,rotationDegrees:0}}function qf(e,n){for(let t of n){if(!G(t)||t.kind!=="chart"||!G(t.payload))continue;let i=t.payload,a=q(i.id).toUpperCase(),r=e.elements.find(p=>p.payload.id===a);if(!r||r.kind!=="chart")continue;let o=q(i.scaleLabelColorHex,"#FFFFFF99"),s=p=>{let m=G(p)?p:{};return{fontSize:Z(m.fontSize,8),colorHex:q(m.colorHex,o),pillColorHex:typeof m.pillColorHex=="string"?m.pillColorHex:void 0}},l=[],d=Te(i.scaleLabels);(d==="top"||d==="range")&&l.push(["top",s(i.topLabelStyle)]),d==="range"&&l.push(["bottom",s(i.bottomLabelStyle)]);let c=Te(i.latestLabel);if((c==="corner"||c==="end")&&l.push(["latest",s(i.latestLabelStyle)]),l.length===0)continue;let u=e.elements.findIndex(p=>p.payload.id===a)+1;for(let[p,m]of l){let f=Cc(r.payload.frame,$c[p],m.fontSize,p==="latest"?5:4),y=[];if(m.pillColorHex!==void 0){let k=Ee("shape");k.payload.kind="capsule",k.payload.colorSlot={baseColorHex:m.pillColorHex},k.payload.frame={...f},y.push(k)}let b=Ee("text");b.payload.value={kind:{kind:"chartStat",layer:a,stat:p}},b.payload.fontSize=m.fontSize,b.payload.fontWeight="medium",b.payload.colorSlot={baseColorHex:m.colorHex},b.payload.frame=f,y.push(b),e.elements.splice(u,0,...y),u+=y.length;for(let k of y)zt(e,r,k.payload.id)}}}function X(e){return Number.isNaN(e)?"nan":e===1/0?"+inf":e===-1/0?"-inf":e}function jt(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function Yf(e){let n={};return e.decimals!==void 0&&(n.decimals=X(e.decimals)),e.multiply!==void 0&&(n.multiply=X(e.multiply)),e.offset!==void 0&&(n.offset=X(e.offset)),e.prefix&&(n.prefix=e.prefix),e.suffix&&(n.suffix=e.suffix),e.useEntityUnit&&(n.useEntityUnit=!0),e.relativeTime&&(n.relativeTime=!0),e.duration&&(n.duration=!0),e.textCase!==void 0&&(n.textCase=e.textCase),n}function Xf(e){let n=e.scope.kind==="entities"?{kind:"entities",entities:e.scope.entities.map(jt)}:{kind:"filter",domains:e.scope.domains,areaIds:e.scope.areaIds,labelIds:e.scope.labelIds,floorIds:e.scope.floorIds},t={function:e.function,scope:n};return e.stateFilter&&(t.stateFilter=e.stateFilter.kind==="equals"||e.stateFilter.kind==="notEquals"?{kind:e.stateFilter.kind,value:e.stateFilter.value}:{kind:e.stateFilter.kind}),e.attribute!==void 0&&(t.attribute=e.attribute),t}function Jf(e){switch(e.kind){case"literal":return{kind:"literal",value:e.value};case"entityState":return{kind:"entityState",...jt(e)};case"entityAttribute":return{kind:"entityAttribute",...jt(e),attribute:e.attribute};case"entityAge":return{kind:"entityAge",...jt(e)};case"aggregate":return{kind:"aggregate",aggregate:Xf(e.aggregate)};case"time":return{kind:"time",timeField:e.timeField};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:e.value};case"named":return{kind:"named",id:e.id};case"chartStat":return{kind:"chartStat",layer:e.layer,stat:e.stat}}}function ue(e){let n={kind:Jf(e.kind)};return _e(e.format)||(n.format=Yf(e.format)),n}function At(e){return{x:X(e.x),y:X(e.y),width:X(e.width),height:X(e.height),rotationDegrees:X(e.rotationDegrees)}}function Zf(e){let n={kind:e.kind};switch(e.kind){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":n.value=ue(e.value??V(""));break;case"between":case"timeBetween":n.value=ue(e.value??V("")),n.upper=ue(e.upper??V(""));break;case"matchesRegex":n.pattern=e.pattern??"";break;case"isOneOf":n.options=e.options??[];break;default:break}return n}function Wd(e){let n={kind:e.kind};switch(e.kind){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":n.value=ue(e.value??V(""));break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":n.number=X(e.number??0);break;case"setFontWeight":n.weight=e.weight??"regular";break;default:break}return n}function Ht(e){return e.map(n=>{let t={id:n.id,cases:n.cases.map(i=>({id:i.id,when:{join:i.when.join,tests:i.when.tests.map(a=>({id:a.id,value:ue(a.value),comparison:Zf(a.comparison)}))},then:i.then.map(Wd)}))};return n.otherwise&&(t.otherwise=n.otherwise.map(Wd)),n.partId!==void 0&&(t.partId=n.partId),t})}function Qf(e){let n={id:e.id,value:ue(e.value)};return e.colorHex!==void 0&&(n.colorHex=e.colorHex),e.fontWeight!==void 0&&(n.fontWeight=e.fontWeight),e.fontSize!==void 0&&(n.fontSize=X(e.fontSize)),e.coloring!==void 0&&e.coloring!=="uniform"&&(n.coloring=e.coloring),e.bands!==void 0&&e.bands.length>0&&(n.bands=e.bands.map(Ua)),e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==pe&&(n.bandAboveColorHex=e.bandAboveColorHex),n}function eg(e){let n=tg(e);return e.payload.groupId!==void 0&&(n.payload.groupId=e.payload.groupId),e.payload.name!==void 0&&(n.payload.name=e.payload.name),n}function tg(e){let n=t=>({id:t.id,colorSlot:{baseColorHex:t.colorSlot.baseColorHex},rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden});switch(e.kind){case"text":{let t={...n(e.payload),value:ue(e.payload.value),fontSize:X(e.payload.fontSize),fontWeight:e.payload.fontWeight};e.payload.countdown===!0&&(t.countdown=!0),e.payload.monospacedDigits===!0&&(t.monospacedDigits=!0),e.payload.lineLimit===2&&(t.lineLimit=2),e.payload.alignment!==void 0&&e.payload.alignment!=="center"&&(t.alignment=e.payload.alignment);let i=e.payload;return i.coloring!==void 0&&i.coloring!=="uniform"&&(t.coloring=i.coloring),i.bands!==void 0&&i.bands.length>0&&(t.bands=i.bands.map(Ua)),i.bandAboveColorHex!==void 0&&i.bandAboveColorHex!==pe&&(t.bandAboveColorHex=i.bandAboveColorHex),i.highlight!==void 0&&i.highlight!=="none"&&(t.highlight=i.highlight),i.highColorHex!==void 0&&i.highColorHex!==Qe&&(t.highColorHex=i.highColorHex),i.lowColorHex!==void 0&&i.lowColorHex!==et&&(t.lowColorHex=i.lowColorHex),i.parts!==void 0&&i.parts.length>0&&(t.parts=i.parts.map(Qf),ot(i)&&(t.value=ue(Ui(i.parts)))),Ga(i,t),{kind:"text",payload:t}}case"icon":{let t={...n(e.payload),symbol:ue(e.payload.symbol)};return e.payload.path!==void 0&&e.payload.path!==""&&(t.path=e.payload.path),t.size=X(e.payload.size),Ga(e.payload,t),{kind:"icon",payload:t}}case"gauge":{let t=e.payload,i={...n(t),value:ue(t.value),minValue:X(t.minValue),maxValue:X(t.maxValue),style:t.style,lineWidth:X(t.lineWidth),trackColorHex:t.trackColorHex};return t.coloring!=="uniform"&&(i.coloring=t.coloring),t.bands.length>0&&(i.bands=t.bands.map(Ua)),t.bandAboveColorHex!==pe&&(i.bandAboveColorHex=t.bandAboveColorHex),t.thresholdValue!==void 0&&(i.thresholdValue=X(t.thresholdValue)),t.thresholdColorHex!==di&&(i.thresholdColorHex=t.thresholdColorHex),t.total!==void 0&&(i.total=ue(t.total)),t.minSource!==void 0&&(i.minSource=ue(t.minSource)),t.maxSource!==void 0&&(i.maxSource=ue(t.maxSource)),{kind:"gauge",payload:i}}case"chart":{let t=e.payload,i={...n(t),value:ue(t.value),historyMinutes:Math.max(0,Math.round(t.historyMinutes)),historyPoints:Math.round(t.historyPoints),style:t.style,limit:Math.max(0,Math.round(t.limit)),takeFromEnd:t.takeFromEnd,scale:t.scale,minValue:X(t.minValue),maxValue:X(t.maxValue),baseline:t.baseline,barGap:X(t.barGap),lineWidth:X(t.lineWidth),highlight:t.highlight,highColorHex:t.highColorHex,lowColorHex:t.lowColorHex,marker:oc(Di(t)),coloring:t.coloring,bands:t.bands.map(Ua),bandAboveColorHex:t.bandAboveColorHex,fillBands:t.fillBands};t.source!==Go&&(i.source=t.source),t.statPeriod!==Bi&&(i.statPeriod=t.statPeriod),t.statType!==Vi&&(i.statType=t.statType),t.thresholdValue!==void 0&&(i.thresholdValue=X(t.thresholdValue)),t.thresholdColorHex!==Ko&&(i.thresholdColorHex=t.thresholdColorHex),t.nowIndex!==void 0&&(i.nowIndex=ue(t.nowIndex)),t.nowColorHex!==jo&&(i.nowColorHex=t.nowColorHex),t.drawsThreshold===!1&&(i.drawsThreshold=!1),t.drawsNowLine===!1&&(i.drawsNowLine=!1),t.drawsTimeLabels===!1&&(i.drawsTimeLabels=!1),t.scaleFrom!==void 0&&(i.scaleFrom=t.scaleFrom),t.labelSize!==tt&&(i.labelSize=X(t.labelSize)),t.labelColorHex!==nt&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==Cn&&(i.timeLabelCount=ht(t.timeLabelCount)),t.hourCycle!==Sn&&(i.hourCycle=t.hourCycle),t.minutes!==Tn&&(i.minutes=t.minutes);let a=Di(t);sc(a)||(i.highMarker=a.high,i.lowMarker=a.low);let r=t.curve??"straight";r!=="straight"&&(i.curve=r);let o=qt(t.fillStyle);o!=="flat"&&(i.fillStyle=o),t.fillColorHex!==void 0&&(i.fillColorHex=t.fillColorHex);let s=Yt(t.barRadius);s!==li&&(i.barRadius=X(s));let l=Xt(t.barCorners);l!=="all"&&(i.barCorners=l);let d=rt(t.smoothing);return d!==void 0&&(i.smoothing=d),t.gaps===!0&&(i.gaps=!0),t.barBorderWidth!==void 0&&t.barBorderWidth!==0&&(i.barBorderWidth=X(t.barBorderWidth)),t.barBorderColorHex!==void 0&&(i.barBorderColorHex=t.barBorderColorHex),t.bandAboveFillColorHex!==void 0&&(i.bandAboveFillColorHex=t.bandAboveFillColorHex),t.bandAboveBorderColorHex!==void 0&&(i.bandAboveBorderColorHex=t.bandAboveBorderColorHex),t.barBorderOpenBase===!0&&(i.barBorderOpenBase=!0),{kind:"chart",payload:i}}case"timeline":{let t=e.payload,i={id:t.id,rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden,value:ue(t.value)};return t.historyMinutes!==ts&&(i.historyMinutes=Math.max(1,Math.round(t.historyMinutes))),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,match:a.match,colorHex:a.colorHex}))),t.otherColorHex!==en&&(i.otherColorHex=t.otherColorHex),t.gap!==0&&(i.gap=X(t.gap)),t.cornerRadius!==mc&&(i.cornerRadius=X(t.cornerRadius)),t.labelSize!==tt&&(i.labelSize=X(t.labelSize)),t.labelColorHex!==nt&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==Cn&&(i.timeLabelCount=Math.max(0,Math.min(Pn,Math.round(t.timeLabelCount)))),t.hourCycle!==Sn&&(i.hourCycle=t.hourCycle),t.minutes!==Tn&&(i.minutes=t.minutes),t.drawsTimeLabels===!1&&(i.drawsTimeLabels=!1),{kind:"timeline",payload:i}}case"shape":{let t={...n(e.payload),kind:e.payload.kind,cornerRadius:X(e.payload.cornerRadius),borderWidth:X(e.payload.borderWidth)};return e.payload.borderColorHex!==void 0&&(t.borderColorHex=e.payload.borderColorHex),e.payload.thickness!==1&&(t.thickness=X(e.payload.thickness)),Ga(e.payload,t),{kind:"shape",payload:t}}case"image":{let t=e.payload,i={id:t.id,entity:jt(t.entity),rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden};t.source!=="camera"&&(i.source=t.source),t.timestamp===!0&&(i.timestamp=!0),t.contentMode!=="fill"&&(i.contentMode=t.contentMode),t.zoom!==1&&(i.zoom=X(t.zoom)),t.panX!==0&&(i.panX=X(t.panX)),t.panY!==0&&(i.panY=X(t.panY)),t.cornerRadius!==ci&&(i.cornerRadius=X(t.cornerRadius));let a=lr(t),r=a?Mf(t.timestampX,t.timestampY):t.timestampCorner;return r!=="topLeading"&&(i.timestampCorner=r),t.timestampSize!==sr&&(i.timestampSize=X(t.timestampSize)),a&&(i.timestampX=X(t.timestampX),i.timestampY=X(t.timestampY)),Ga(t,i),{kind:"image",payload:i}}case"tap":{let t=e.payload,i={id:t.id,action:Fc(t.action)};return t.openPageId!==void 0&&(i.openPageId=t.openPageId),t.openPageName!==void 0&&(i.openPageName=t.openPageName),t.attachedTo!==void 0&&(i.attachedTo=t.attachedTo),i.rules=Ht(t.rules),i.frame=At(t.frame),i.isHidden=t.isHidden,{kind:"tap",payload:i}}case"chartTimes":{let t=e.payload,i={id:t.id,rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden,chart:t.chart};return t.labelSize!==tt&&(i.labelSize=X(t.labelSize)),t.labelColorHex!==nt&&(i.labelColorHex=t.labelColorHex),t.timeLabelCount!==Cn&&(i.timeLabelCount=ht(t.timeLabelCount)),t.hourCycle!==Sn&&(i.hourCycle=t.hourCycle),t.minutes!==Tn&&(i.minutes=t.minutes),{kind:"chartTimes",payload:i}}case"imageTime":{let t=e.payload,i={id:t.id,rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden};return t.image!==""&&(i.image=t.image),{kind:"imageTime",payload:i}}case"chartDots":{let t=e.payload,i={id:t.id,rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden,chart:t.chart};Ya(t.dots)!=="auto"&&(i.dots="all");let a=pt(t.size);return a!==void 0&&(i.size=X(a)),t.colorHex!==void 0&&(i.colorHex=t.colorHex),{kind:"chartDots",payload:i}}case"chartGrid":{let t=e.payload,i={id:t.id,rules:Ht(t.rules),frame:At(t.frame),isHidden:t.isHidden,chart:t.chart},a=An(t.lines);a!==Zt&&(i.lines=a);let r=Wt(t.colorHex);nc(r,Ft)||(i.colorHex=r);let o=Hn(t.thickness);return o!==Jt&&(i.thickness=X(o)),{kind:"chartGrid",payload:i}}}}function ng(e){let n={},t=Object.keys(e.placements);if(t.length>0){let i={};for(let a of t){let r=e.placements[a],o={frame:At(r.frame)};r.isHidden&&(o.isHidden=!0),r.size!==void 0&&(o.size=X(r.size)),i[a]=o}n.placements=i}if(e.bezelText&&(n.bezelText=ue(e.bezelText)),e.bezelCountdown===!0&&(n.bezelCountdown=!0),e.curvedText&&(n.curvedText=ue(e.curvedText)),e.curvedColorHex!==void 0&&(n.curvedColorHex=e.curvedColorHex),e.bezelGauge){let i=e.bezelGauge,a={value:ue(i.value),minValue:X(i.minValue),maxValue:X(i.maxValue),colorHexes:i.colorHexes};i.minLabel&&(a.minLabel=ue(i.minLabel)),i.maxLabel&&(a.maxLabel=ue(i.maxLabel)),n.bezelGauge=a}return e.backgroundColorHex!==void 0&&(n.backgroundColorHex=e.backgroundColorHex),n.cornerBodyShape=e.cornerBodyShape,e.borderColorHex!==void 0&&(n.borderColorHex=e.borderColorHex),n.borderWidth=X(e.borderWidth),e.rules.length>0&&(n.rules=Ht(e.rules)),n}function Fc(e){if(e.type==="callService"){let n={type:e.type,serviceDomain:e.serviceDomain,serviceName:e.serviceName};return e.serviceDataJSON!==void 0&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),e.target!==void 0&&e.target.entityId!==""&&Object.assign(n,jt(e.target)),n}return"entityId"in e?{type:e.type,...jt(e)}:{type:e.type}}function ig(e){let n={};return e.label!==void 0&&(n.label=e.label),n.value=ue(e.value),e.symbol!==void 0&&(n.symbol=e.symbol),e.countdown&&(n.countdown=!0),n}function pi(e){let n=[];for(let i of se){let a=e.perFamily[i];a&&n.push(i,ng(a))}let t={schemaVersion:Rn(e),id:e.id,name:e.name,values:e.values.map(i=>({id:i.id,name:i.name,value:ue(i.value)})),slotIndex:e.slotIndex,elements:e.elements.map(eg),supportedFamilies:e.supportedFamilies,perFamily:n,dataSources:e.dataSources.map(i=>i.kind==="template"?{kind:"template",value:i.value}:{kind:"entity",...jt(i)}),tapAction:Fc(e.tapAction)};return e.inline!==void 0&&(t.inline=ig(e.inline)),e.refreshMinutes!==void 0&&(t.refreshMinutes=e.refreshMinutes),e.openPageId!==void 0&&(t.openPageId=e.openPageId),e.openPageName!==void 0&&(t.openPageName=e.openPageName),e.showSuccessFlash!==void 0&&(t.showSuccessFlash=e.showSuccessFlash),e.successFlashColorHex!==void 0&&(t.successFlashColorHex=e.successFlashColorHex),e.groups!==void 0&&e.groups.length>0&&(t.groups=e.groups.map(i=>({id:i.id,name:i.name,locked:i.locked}))),e.hidden===!0&&(t.hidden=!0),t}function Ic(e){return G(e)&&e.hidden===!0}function Lc(e,n){let t={...e};return n?t.hidden=!0:delete t.hidden,t}function _c(e,n,t){let i=[],a=[];for(let r of e){let o=n(r);o!==void 0&&o.hidden&&o.id!==t?a.push(r):i.push(r)}return{shown:i,hidden:a}}function lt(e,n){let i=e.elements.find(a=>a.payload.id===n)?.payload.groupId;return i===void 0?void 0:e.groups?.find(a=>a.id===i)}function yt(e,n){return e.elements.filter(t=>t.payload.groupId===n&&!ve(e,t))}function dt(e){let n=new Set((e.groups??[]).map(a=>a.id));for(let a of e.elements)a.payload.groupId!==void 0&&!n.has(a.payload.groupId)&&delete a.payload.groupId;let t=new Set(e.elements.map(a=>a.payload.groupId).filter(a=>a!==void 0)),i=(e.groups??[]).filter(a=>t.has(a.id));i.length===0?delete e.groups:e.groups=i}function hi(e){if(!e.groups?.length)return;let n=e.elements.filter(r=>!ve(e,r)),t=e.elements.filter(r=>ve(e,r)),i=[],a=new Set;for(let r=n.length-1;r>=0;r--){let o=n[r];if(a.has(o.payload.id))continue;let s=o.payload.groupId;if(s===void 0){i.unshift(o),a.add(o.payload.id);continue}let l=n.filter(d=>d.payload.groupId===s);for(let d=l.length-1;d>=0;d--)i.unshift(l[d]),a.add(l[d].payload.id)}e.elements=[...i,...t],sn(e)}function ms(e,n,t="Group"){let i=e.elements.filter(r=>n.includes(r.payload.id)&&!ve(e,r));if(i.length<2)return;let a={id:Q(),name:t,locked:!0};e.groups=[...e.groups??[],a];for(let r of i)r.payload.groupId=a.id;return dt(e),hi(e),a.id}function mi(e,n){for(let t of e.elements)t.payload.groupId===n&&delete t.payload.groupId;dt(e)}function Xi(e,n,t){let i=e.elements.find(a=>a.payload.id===n);!i||ve(e,i)||(t===void 0?delete i.payload.groupId:i.payload.groupId=t,dt(e),hi(e))}var oe={config:["schemaVersion","id","name","values","slotIndex","elements","supportedFamilies","perFamily","inline","dataSources","refreshMinutes","tapAction","openPageId","openPageName","showSuccessFlash","successFlashColorHex","groups","hidden"],group:["id","name","locked"],inline:["label","value","symbol","countdown"],named:["id","name","value"],value:["kind","format"],format:["decimals","multiply","offset","prefix","suffix","useEntityUnit","relativeTime","duration","textCase"],entityRef:["entityId","displayName","domain","iconName"],aggregate:["function","scope","stateFilter","attribute"],scope:["kind","entities","domains","areaIds","labelIds","floorIds"],stateFilter:["kind","value"],frame:["x","y","width","height","rotationDegrees"],chartAnchor:["layer","at","place","dx","dy"],elementEnvelope:["kind","payload"],elementBase:["id","colorSlot","rules","frame","isHidden","groupId","name"],text:["value","fontSize","fontWeight","countdown","monospacedDigits","lineLimit","alignment","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex","parts","chartAnchor"],textPart:["id","value","colorHex","fontWeight","fontSize","coloring","bands","bandAboveColorHex"],icon:["symbol","path","size","chartAnchor"],gauge:["value","minValue","maxValue","style","lineWidth","trackColorHex","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","style","limit","takeFromEnd","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes","highMarker","lowMarker","curve","fillStyle","fillColorHex","barRadius","barCorners","smoothing","gaps","barBorderWidth","barBorderColorHex","bandAboveFillColorHex","bandAboveBorderColorHex","barBorderOpenBase","pointDots","pointDotSize","pointDotColorHex","gridLines","gridColorHex","zeroLine","bandLowColorHex","bandHighColorHex","bandLowerBound","bandUpperBound","scaleLabels","scaleLabelPlacement","latestLabel","topLabelStyle","bottomLabelStyle","latestLabelStyle","latestLabelFollowsBand","scaleLabelColorHex"],timeline:["value","historyMinutes","bands","otherColorHex","gap","cornerRadius","timeLabels","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes","drawsTimeLabels"],shape:["kind","cornerRadius","thickness","borderColorHex","borderWidth","chartAnchor"],image:["entity","source","timestamp","contentMode","zoom","panX","panY","cornerRadius","timestampCorner","timestampSize","timestampStyle","timestampX","timestampY","chartAnchor"],tap:["action","openPageId","openPageName","attachedTo","grow"],chartTimes:["chart","timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["chart","dots","size","colorHex"],chartGrid:["chart","lines","colorHex","thickness"],imageTime:["image","size"],colorSlot:["baseColorHex"],rule:["id","cases","otherwise","partId"],case:["id","when","then"],condition:["join","tests"],test:["id","value","comparison"],comparison:["kind","value","upper","pattern","options"],styleChange:["kind","value","number","weight"],layout:["placements","bezelText","bezelCountdown","curvedText","curvedColorHex","bezelGauge","backgroundColorHex","cornerBodyShape","borderColorHex","borderWidth","rules"],bezelGauge:["value","minValue","maxValue","colorHexes","minLabel","maxLabel"],placement:["frame","isHidden","size"],tapAction:["type","entityId","displayName","domain","iconName","serviceDomain","serviceName","serviceDataJSON"]},Kd={literal:["kind","value"],entityState:["kind",...oe.entityRef],entityAttribute:["kind",...oe.entityRef,"attribute"],entityAge:["kind",...oe.entityRef],aggregate:["kind","aggregate"],time:["kind","timeField"],dataAge:["kind"],jinja:["kind","value"],named:["kind","id"],chartStat:["kind","layer","stat"]};function cr(e){let n=[],t=(l,d,c)=>{if(G(l))for(let u of Object.keys(l))d.includes(u)||n.push(`${c}.${u}`)},i=(l,d)=>{if(!G(l))return;let c=typeof l.kind=="string"?l.kind:"";t(l,Kd[c]??["kind"],d),c==="aggregate"&&G(l.aggregate)&&(t(l.aggregate,oe.aggregate,`${d}.aggregate`),t(l.aggregate.scope,oe.scope,`${d}.aggregate.scope`),G(l.aggregate.scope)&&Array.isArray(l.aggregate.scope.entities)&&l.aggregate.scope.entities.forEach((u,p)=>t(u,oe.entityRef,`${d}.aggregate.scope.entities[${p}]`)),t(l.aggregate.stateFilter,oe.stateFilter,`${d}.aggregate.stateFilter`))},a=(l,d)=>{if(G(l)){if(G(l.kind))t(l,oe.value,d),i(l.kind,`${d}.kind`);else{let c=typeof l.kind=="string"?l.kind:"";t(l,[...Kd[c]??["kind"],"format"],d),c==="aggregate"&&i(l,d)}t(l.format,oe.format,`${d}.format`)}},r=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{t(c,oe.styleChange,`${d}[${u}]`),G(c)&&a(c.value,`${d}[${u}].value`)})},o=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{let p=`${d}[${u}]`;t(c,oe.rule,p),G(c)&&(Array.isArray(c.cases)&&c.cases.forEach((m,f)=>{let y=`${p}.cases[${f}]`;t(m,oe.case,y),G(m)&&(t(m.when,oe.condition,`${y}.when`),G(m.when)&&Array.isArray(m.when.tests)&&m.when.tests.forEach((b,k)=>{let $=`${y}.when.tests[${k}]`;t(b,oe.test,$),G(b)&&(a(b.value,`${$}.value`),t(b.comparison,oe.comparison,`${$}.comparison`),G(b.comparison)&&(a(b.comparison.value,`${$}.comparison.value`),a(b.comparison.upper,`${$}.comparison.upper`)))}),r(m.then,`${y}.then`))}),r(c.otherwise,`${p}.otherwise`))})};if(!G(e))return n;t(e,oe.config,"$"),Array.isArray(e.groups)&&e.groups.forEach((l,d)=>t(l,oe.group,`$.groups[${d}]`)),Array.isArray(e.values)&&e.values.forEach((l,d)=>{t(l,oe.named,`$.values[${d}]`),G(l)&&a(l.value,`$.values[${d}].value`)}),Array.isArray(e.elements)&&e.elements.forEach((l,d)=>{let c=`$.elements[${d}]`;if(t(l,oe.elementEnvelope,c),!G(l)||!G(l.payload))return;let u=typeof l.kind=="string"?l.kind:"",p=oe[u]??[];t(l.payload,[...oe.elementBase,...p],`${c}.payload`),t(l.payload.colorSlot,oe.colorSlot,`${c}.payload.colorSlot`),t(l.payload.frame,oe.frame,`${c}.payload.frame`),"chartAnchor"in l.payload&&t(l.payload.chartAnchor,oe.chartAnchor,`${c}.payload.chartAnchor`),o(l.payload.rules,`${c}.payload.rules`);for(let m of["value","symbol","nowIndex","total","minSource","maxSource"])m in l.payload&&a(l.payload[m],`${c}.payload.${m}`);u==="text"&&Array.isArray(l.payload.parts)&&l.payload.parts.forEach((m,f)=>{t(m,oe.textPart,`${c}.payload.parts[${f}]`),G(m)&&a(m.value,`${c}.payload.parts[${f}].value`)}),u==="image"&&t(l.payload.entity,oe.entityRef,`${c}.payload.entity`),u==="tap"&&t(l.payload.action,oe.tapAction,`${c}.payload.action`)});let s=[];if(Array.isArray(e.perFamily))for(let l=0;l+1<e.perFamily.length;l+=2)s.push([String(e.perFamily[l]),e.perFamily[l+1]]);else G(e.perFamily)&&s.push(...Object.entries(e.perFamily));for(let[l,d]of s){let c=`$.perFamily.${l}`;if(t(d,oe.layout,c),!!G(d)){if(G(d.placements))for(let[u,p]of Object.entries(d.placements))t(p,oe.placement,`${c}.placements.${u}`),G(p)&&t(p.frame,oe.frame,`${c}.placements.${u}.frame`);if(a(d.bezelText,`${c}.bezelText`),a(d.curvedText,`${c}.curvedText`),G(d.bezelGauge)){let u=`${c}.bezelGauge`;t(d.bezelGauge,oe.bezelGauge,u),a(d.bezelGauge.value,`${u}.value`),a(d.bezelGauge.minLabel,`${u}.minLabel`),a(d.bezelGauge.maxLabel,`${u}.maxLabel`)}o(d.rules,`${c}.rules`)}}return G(e.inline)&&(t(e.inline,oe.inline,"$.inline"),a(e.inline.value,"$.inline.value")),t(e.tapAction,oe.tapAction,"$.tapAction"),n}function Q(){let e=globalThis.crypto;if(e&&"randomUUID"in e)return e.randomUUID().toUpperCase();let n=()=>Math.floor(Math.random()*65536).toString(16).padStart(4,"0"),t=(8+Math.floor(Math.random()*4)).toString(16)+n().slice(1);return`${n()}${n()}-${n()}-4${n().slice(1)}-${t}-${n()}${n()}${n()}`.toUpperCase()}function Pt(){return{placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}}function zc(e,n,t=[...se]){let i={};for(let r of se)t.includes(r)&&(i[r]=Pt());let a={schemaVersion:4,id:Q(),name:e,values:[],slotIndex:n,elements:[],supportedFamilies:Pi.filter(r=>t.includes(r)),perFamily:i,dataSources:[],refreshMinutes:0,tapAction:{type:"refresh"}};return t.includes("inline")&&(a.inline={value:V("Text")}),a.schemaVersion=Rn(a),a}function Ee(e){let n=t=>({id:Q(),colorSlot:{baseColorHex:t},rules:[],frame:{...Gi},isHidden:!1});switch(e){case"text":return{kind:e,payload:{...n("#FFFFFF"),value:V("Text"),fontSize:14,fontWeight:"regular"}};case"icon":return{kind:e,payload:{...n("#FFFFFF"),symbol:V("lightbulb"),size:14}};case"gauge":return{kind:e,payload:{...n("#FFFFFF"),value:V("50"),minValue:0,maxValue:100,style:"arc",lineWidth:4,trackColorHex:"#FFFFFF40",coloring:"uniform",bands:[],bandAboveColorHex:pe,thresholdColorHex:di}};case"chart":return{kind:e,payload:{...n("#FFFFFF"),value:V("13,14,16,17,19,22,24,28,30"),historyMinutes:ir,historyPoints:24,source:Go,statPeriod:Bi,statType:Vi,style:"bars",curve:"smooth",fillStyle:"fade",limit:0,takeFromEnd:!1,scale:"auto",minValue:0,maxValue:100,baseline:"lowest",barGap:1.5,lineWidth:2,highlight:"none",highColorHex:Qe,lowColorHex:et,marker:"none",coloring:"uniform",bands:[],bandAboveColorHex:pe,fillBands:!1,thresholdColorHex:Ko,nowColorHex:jo,timeLabelCount:Cn,labelSize:tt,labelColorHex:nt,labelsAbove:!1,hourCycle:Sn,minutes:Tn}};case"timeline":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,value:V(""),historyMinutes:Cf,bands:[],otherColorHex:kf,gap:0,cornerRadius:$f,timeLabelCount:fc,labelSize:tt,labelColorHex:nt,labelsAbove:!1,hourCycle:Sn,minutes:Tn}}}case"shape":return{kind:e,payload:{...n("#FFFFFF33"),kind:"roundedRectangle",cornerRadius:6,thickness:1,borderWidth:1}};case"image":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,entity:{entityId:"",displayName:"",domain:"camera"},source:"camera",contentMode:"fill",zoom:1,panX:0,panY:0,cornerRadius:ci,timestampCorner:"topLeading",timestampSize:sr}}}case"tap":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,action:{type:"refresh"}}}}case"chartTimes":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",timeLabelCount:Cn,labelSize:tt,labelColorHex:nt,hourCycle:Sn,minutes:Tn}}}case"imageTime":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,image:""}}}case"chartDots":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",dots:"auto"}}}case"chartGrid":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",lines:Zt,colorHex:Ft,thickness:Jt}}}}}function V(e){return{kind:{kind:"literal",value:e}}}function ur(e){switch(e.kind){case"text":return e.payload.fontSize;case"icon":return e.payload.size;case"gauge":return e.payload.lineWidth;case"chart":return e.payload.lineWidth;case"timeline":return;case"shape":return;case"image":return;case"tap":return;case"chartTimes":return;case"chartDots":return;case"chartGrid":return;case"imageTime":return}}var jd=["circular","corner"],qd=Math.SQRT1_2;function ag(e){return e==="text"||e==="icon"?4:.5}function pr(e,n,t,i){let a=structuredClone(e),r=he[n],o=he[t];if(n===t||!r||!o)return a;let s=jd.includes(n),l=jd.includes(t),d=s===l?1:l?qd:1/qd,c=Math.min(o.width/r.width,o.height/r.height)*d;if(d!==1){let u=a.frame,p=u.x+u.width/2,m=u.y+u.height/2;a.frame={...u,width:u.width*d,height:u.height*d,x:.5+(p-.5)*d-u.width*d/2,y:.5+(m-.5)*d-u.height*d/2}}return a.size!==void 0&&(a.size=Math.max(ag(i),Math.round(a.size*c*10)/10)),a}function Pc(e,n){let t=e.perFamily[n];return!t||Object.keys(t.placements).length===0?e.elements:e.elements.map(i=>{let a=t.placements[i.payload.id];if(!a)return i;let r={...i.payload,frame:a.frame,isHidden:a.isHidden};return a.size!==void 0&&(i.kind==="text"?r.fontSize=a.size:i.kind==="icon"?r.size=a.size:(i.kind==="gauge"||i.kind==="chart")&&(r.lineWidth=a.size)),{kind:i.kind,payload:r}})}function Bn(e){switch(e.kind){case"text":return e.payload.value;case"icon":return e.payload.symbol;case"gauge":return e.payload.value;case"chart":return e.payload.value;case"timeline":return e.payload.value;case"shape":return;case"image":return{kind:{kind:"entityState",...e.payload.entity}};case"tap":return;case"chartTimes":return;case"chartDots":return;case"chartGrid":return;case"imageTime":return}}function Oi(e){let n=[],t=i=>{for(let a of i)a.value&&n.push(a.value)};for(let i of e){for(let a of i.cases){for(let r of a.when.tests)n.push(r.value),r.comparison.value&&n.push(r.comparison.value),r.comparison.upper&&n.push(r.comparison.upper);t(a.then)}i.otherwise&&t(i.otherwise)}return n}var fs=["light","switch","fan","input_boolean","cover","lock","media_player","siren","humidifier","valve","automation","group"];function qa(e,n){let t,i=n;for(let a=0;i!==void 0&&a<4;a++){let r=i.kind;if(r.kind==="chartStat"){i=rs(e,i)?.payload.value;continue}if("entityId"in r){if(r.entityId==="")return;let o={entityId:r.entityId,displayName:r.displayName,domain:r.domain};return t===void 0?{ref:o}:{ref:o,namedId:t}}if(r.kind!=="named")return;t=r.id.toUpperCase(),i=e.values.find(o=>o.id.toUpperCase()===t)?.value}}function gs(e,n){return qa(e,Bn(n))?.ref}function ys(e,n){let t=gs(e,n),i=t&&(t.domain||t.entityId.split(".")[0])||"";return t&&fs.includes(i)?{type:"toggleEntity",...t,domain:i}:{type:"refresh"}}function Yd(e,n,t){if(dr(n)||t.width<=0||t.height<=0)return{...e};let i=n,a=e.x-i.left/t.width,r=e.x+e.width+i.right/t.width,o=e.y-i.top/t.height,s=e.y+e.height+i.bottom/t.height;return r<a&&(a=r=(a+r)/2),s<o&&(o=s=(o+s)/2),a=ut(a),r=ut(r),o=ut(o),s=ut(s),{...e,x:a,y:o,width:Math.max(0,r-a),height:Math.max(0,s-o)}}function Nc(e,n,t){let i=a=>Math.round(a*100)/100||0;return{left:i((e.x-n.x)*t.width),right:i((n.x+n.width-e.x-e.width)*t.width),top:i((e.y-n.y)*t.height),bottom:i((n.y+n.height-e.y-e.height)*t.height)}}function Dc(e,n,t,i){let a=e.elements.find(p=>p.payload.id===n);if(!a||a.kind!=="tap"||a.payload.attachedTo===void 0)return;let r=e.elements.find(p=>p.payload.id===a.payload.attachedTo);if(!r)return;let o=e.perFamily[t]?.placements[r.payload.id]?.frame??r.payload.frame,s=ut(i.x),l=ut(i.y),d=ut(i.x+i.width),c=ut(i.y+i.height),u={...i,x:s,y:l,width:Math.max(0,d-s),height:Math.max(0,c-l)};a.payload.outset=Nc(o,u,he[t])}function Oc(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i)return;let a=e.perFamily[t];if(!a)return;let r=a.placements[n]?.frame??i.payload.frame,o=he[t];return{width:r.width*o.width,height:r.height*o.height}}function Ke(e,n){return e.elements.filter(t=>t.kind==="tap"&&t.payload.attachedTo===n)}function ve(e,n){return n.kind!=="tap"||n.payload.attachedTo===void 0?!1:e.elements.some(t=>t.payload.id===n.payload.attachedTo&&t.kind!=="tap")}function bs(e,n){let t=e.elements.find(i=>i.payload.id===n);if(t){if(t.kind==="tap"&&t.payload.attachedTo!==void 0){let i=e.elements.find(a=>a.payload.id===t.payload.attachedTo);if(i)return i.payload.id}return t.payload.id}}function sn(e){let n=new Map(e.elements.map(a=>[a.payload.id,a])),t=new Map;for(let a of e.elements){if(a.kind!=="tap")continue;let r=a.payload.attachedTo;if(r===void 0)continue;let o=n.get(r);if(!o||o.kind==="tap"||r===a.payload.id){delete a.payload.attachedTo;continue}let s=t.get(r);s?s.push(a):t.set(r,[a])}if(t.size===0)return;for(let[a,r]of t){let o=n.get(a);for(let s of r){let l=s.payload;l.outset===void 0&&(l.outset=Nc(o.payload.frame,l.frame,he.rectangular));let d=l.outset,c=!dr(d);s.payload.frame=Yd(o.payload.frame,d,he.rectangular),s.payload.isHidden=o.payload.isHidden;let u=dg(e,a);for(let p of se){let m=e.perFamily[p];if(!m)continue;let f=he[p],y=m.placements[a];p!==u||!y?delete m.placements[s.payload.id]:c?m.placements[s.payload.id]={frame:Yd(y.frame,d,f),isHidden:y.isHidden}:m.placements[s.payload.id]={frame:{...y.frame},isHidden:y.isHidden}}}}let i=[];for(let a of e.elements){if(a.kind==="tap"&&a.payload.attachedTo!==void 0)continue;i.push(a);let r=t.get(a.payload.id);r&&i.push(...r)}e.elements=i}function hr(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind==="tap")return;let a=Ke(e,n)[0];if(a)return a.payload;let r=Ee("tap"),o=r.payload;return o.attachedTo=n,o.outset={...is},o.action=t??ys(e,i),e.elements.push(r),sn(e),o}function mr(e,n){let t=Ke(e,n).map(i=>i.payload.id);if(t.length!==0){e.elements=e.elements.filter(i=>!t.includes(i.payload.id));for(let i of se)for(let a of t)delete e.perFamily[i]?.placements[a]}}function fe(e,n){for(let a of rn(e,n))fe(e,a.payload.id);for(let a of on(e,n))fe(e,a.payload.id);for(let a of Dn(e,n))fe(e,a.payload.id);for(let a of On(e,n))fe(e,a.payload.id);for(let a of ls(e,n))fe(e,a.payload.id);for(let a of Ne(e,n))delete a.payload.chartAnchor;let t=e.elements.find(a=>a.payload.id===n);mr(e,n),e.elements=e.elements.filter(a=>a.payload.id!==n);let i=t?.payload.chartAnchor;if(i&&(i.at==="threshold"||i.at==="now")&&!Ne(e,i.layer).some(a=>a.payload.chartAnchor?.at===i.at)){let a=e.elements.find(r=>r.payload.id===i.layer);a?.kind==="chart"&&(i.at==="threshold"?(delete a.payload.thresholdValue,delete a.payload.drawsThreshold):(delete a.payload.nowIndex,delete a.payload.drawsNowLine))}for(let a of e.elements)a.kind==="chart"&&a.payload.scaleFrom===n&&delete a.payload.scaleFrom;for(let a of se)delete e.perFamily[a]?.placements[n];sn(e),dt(e),t&&og(e,t.payload.groupId,rg(t))}function rg(e){if(e.payload.chartAnchor)return e.payload.chartAnchor.layer;switch(e.kind){case"text":return e.payload.value.kind.kind==="chartStat"?e.payload.value.kind.layer:void 0;case"chartTimes":return e.payload.chart;case"chartDots":return e.payload.chart;case"chartGrid":return e.payload.chart;case"imageTime":return e.payload.image;default:return}}function og(e,n,t){if(n===void 0||t===void 0||!e.groups?.some(a=>a.id===n))return;let i=yt(e,n);i.length===1&&i[0].payload.id===t&&mi(e,n)}function Bc(e,n){let t=e.elements.findIndex(l=>l.payload.id===n),i=e.elements[t];if(!i)return;let a=Q(),r=structuredClone(i);r.payload.id=a,r.payload.frame={...r.payload.frame,x:Math.min(.9,r.payload.frame.x+.05),y:Math.min(.9,r.payload.frame.y+.05)};let o=[r],s=[[n,a]];for(let l of Ke(e,n)){let d=structuredClone(l);d.payload.id=Q(),d.payload.attachedTo=a,o.push(d),s.push([l.payload.id,d.payload.id])}e.elements.splice(t+1,0,...o);for(let l of se){let d=e.perFamily[l];if(d)for(let[c,u]of s){let p=d.placements[c];p&&(d.placements[u]=structuredClone(p))}}return sn(e),a}function sg(e,n){let t=/^(.*\S) \d+$/.exec(e)?.[1]??e,i=new Set(n),a=2;for(;i.has(`${t} ${a}`);)a++;return`${t} ${a}`}function Vc(e,n,t){let i=e.elements.findIndex(s=>s.payload.id===n),a=e.elements[i];if(!a||a.kind!=="chart")return;let r=Q(),o=structuredClone(a);o.payload.id=r,o.payload.scaleFrom=n,t&&(o.payload.name=sg(t(a),e.elements.map(t))),e.elements.splice(i+1,0,o);for(let s of se){let l=e.perFamily[s],d=l?.placements[n];l&&d&&(l.placements[r]=structuredClone(d))}return r}function fi(e,n,t){let i=new Set,a=d=>{i.add(d);for(let c of Ke(e,d))i.add(c.payload.id)};for(let d of n){a(d);for(let c of rn(e,d))a(c.payload.id)}let r=e.elements.filter(d=>i.has(d.payload.id)).map(d=>structuredClone(d)),o={};for(let d of se){let c=e.perFamily[d];if(!c)continue;let u={};for(let p of r){let m=c.placements[p.payload.id];m&&(u[p.payload.id]=structuredClone(m))}Object.keys(u).length>0&&(o[d]=u)}let s=new Set(r.map(d=>d.payload.groupId).filter(d=>d!==void 0)),l=(e.groups??[]).filter(d=>s.has(d.id)).map(d=>structuredClone(d));return{elements:r,placements:o,groups:l,...t!==void 0?{family:t}:{}}}function Gc(e,n,t){let i=n.family,a=i!==void 0&&i!==t&&se.includes(i);if(!se.includes(t))return Mn(e,n);let r=Mn(e,n,a?{nudge:!1}:{}),o=e.perFamily[t]??(e.perFamily[t]=Pt());for(let s of r){let l=e.elements.find(p=>p.payload.id===s);if(!l)continue;let d=(i!==void 0?e.perFamily[i]?.placements[s]:void 0)??se.map(p=>e.perFamily[p]?.placements[s]).find(p=>p!==void 0),c=d?.size??ur(l),u={frame:{...d?.frame??l.payload.frame},isHidden:!1,...c!==void 0?{size:c}:{}};for(let p of se)p!==t&&delete e.perFamily[p]?.placements[s];o.placements[s]=a?pr(u,i,t,l.kind):u}return gi(e,t),r}function Mn(e,n,t={}){let i=new Map;for(let d of n.elements)i.set(d.payload.id,Q());let a=new Set(e.elements.map(d=>d.payload.id)),r=t.nudge!==!1&&n.elements.some(d=>a.has(d.payload.id)),o=d=>r?{...d,x:Math.min(.9,d.x+.05),y:Math.min(.9,d.y+.05)}:d,s=[];for(let d of n.elements){let c=structuredClone(d);if(c.payload.id=i.get(d.payload.id),c.kind==="tap"&&c.payload.attachedTo!==void 0){let u=i.get(c.payload.attachedTo);u?c.payload.attachedTo=u:delete c.payload.attachedTo}if(c.kind==="chart"&&c.payload.scaleFrom!==void 0){let u=i.get(c.payload.scaleFrom);u?c.payload.scaleFrom=u:a.has(c.payload.scaleFrom)||delete c.payload.scaleFrom}if(c.kind==="text")for(let u of c.payload.parts??[]){let p=u.value.kind,m=p.kind==="chartStat"?i.get(p.layer):void 0;p.kind==="chartStat"&&m&&(p.layer=m)}if(c.kind==="text"&&c.payload.value.kind.kind==="chartStat"){let u=i.get(c.payload.value.kind.layer);if(u)c.payload.value.kind.layer=u;else if(!a.has(c.payload.value.kind.layer))continue}if(c.kind==="chartTimes"||c.kind==="chartDots"||c.kind==="chartGrid"){let u=i.get(c.payload.chart);if(u)c.payload.chart=u;else if(!a.has(c.payload.chart))continue}if(c.kind==="imageTime"){let u=i.get(c.payload.image);if(u)c.payload.image=u;else if(!a.has(c.payload.image))continue}if(c.payload.chartAnchor!==void 0){let u=i.get(c.payload.chartAnchor.layer);u?c.payload.chartAnchor.layer=u:a.has(c.payload.chartAnchor.layer)||delete c.payload.chartAnchor}c.payload.frame=o(c.payload.frame),s.push(c)}let l=new Map;for(let d of n.groups){if(s.filter(p=>p.payload.groupId===d.id&&!(p.kind==="tap"&&p.payload.attachedTo!==void 0)).length<2)continue;let u=Q();l.set(d.id,u),(e.groups??=[]).push({...structuredClone(d),id:u})}for(let d of s){if(d.payload.groupId===void 0)continue;let c=l.get(d.payload.groupId);c?d.payload.groupId=c:delete d.payload.groupId}e.elements.push(...s);for(let d of se){let c=n.placements[d],u=e.perFamily[d];if(!(!c||!u))for(let[p,m]of Object.entries(c)){let f=i.get(p);f&&s.some(y=>y.payload.id===f)&&(u.placements[f]={...structuredClone(m),frame:o(m.frame)})}}return sn(e),dt(e),hi(e),s.filter(d=>!ve(e,d)).map(d=>d.payload.id)}function lg(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?!a.isHidden:!t.payload.isHidden}function dg(e,n){let t=e.elements.find(r=>r.payload.id===n),a=(t&&t.kind==="tap"?t.payload.attachedTo:void 0)??n;return se.find(r=>e.supportedFamilies.includes(r)&&e.perFamily[r]?.placements[a]!==void 0)}function bt(e,n){let t=e.perFamily[n];return t?e.elements.filter(i=>{let a=i.kind==="tap"?i.payload.attachedTo:void 0;return t.placements[a??i.payload.id]!==void 0}):[]}function Uc(e,n){let t=e.perFamily[n];return t?bt(e,n).filter(i=>!ve(e,i)&&!t.placements[i.payload.id]?.isHidden).length:0}function gi(e,n){let t=se.filter(s=>e.supportedFamilies.includes(s));if(t.length===0)return;let i=n!==void 0&&t.includes(n)?n:t[0];for(let s of t)e.perFamily[s]||(e.perFamily[s]=Pt());let a=()=>e.elements.filter(s=>!ve(e,s)),r=new Map,o=new Set;if(n===void 0){let s=new Map(a().map(p=>[p.payload.id,t.filter(m=>lg(e,m,p))]));for(let[p,m]of s)m[0]&&r.set(p,m[0]);let l=new Map([...a().entries()].map(([p,m])=>[m.payload.id,p]));for(let p of t){let m=a().filter(b=>(s.get(b.payload.id)??[]).includes(p)&&r.get(b.payload.id)!==p).map(b=>b.payload.id);if(m.length===0)continue;let f=fi(e,m,p),y=Mn(e,f,{nudge:!1});y.forEach((b,k)=>{r.set(b,p);let $=y.length===m.length?m[k]:void 0;l.set(b,$!==void 0?l.get($)??0:l.size)})}for(let p of a())r.has(p.payload.id)||o.add(p.payload.id);let d=p=>t.indexOf(r.get(p)??i),c=a().sort((p,m)=>d(p.payload.id)-d(m.payload.id)||(l.get(p.payload.id)??0)-(l.get(m.payload.id)??0)),u=[];for(let p of c)u.push(p),u.push(...Ke(e,p.payload.id));e.elements=u}for(let s of a()){let l=s.payload.id,d=t.filter(m=>e.perFamily[m].placements[l]!==void 0),c=r.get(l)??d.find(m=>!e.perFamily[m].placements[l].isHidden)??d[0]??i,u=e.perFamily[c]?.placements[l],p={frame:{...u?.frame??s.payload.frame},isHidden:o.has(l)||u?.isHidden===!0,...u?.size!==void 0?{size:u.size}:{}};s.payload.isHidden=!0;for(let m of se){let f=e.perFamily[m];f&&(m===c?f.placements[l]=p:delete f.placements[l])}}}function fr(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t)return[];let i=[],a=qa(e,Bn(t));if(a){let r=t.kind==="icon"?"symbol":t.kind==="image"?"camera":"value";i.push(a.namedId===void 0?{where:r,ref:a.ref}:{where:r,ref:a.ref,namedId:a.namedId})}for(let r of Ke(e,n)){let o=r.payload.action;!("entityId"in o)||o.entityId===""||i.push({where:"tap",ref:{entityId:o.entityId,displayName:o.displayName,domain:o.domain},tapId:r.payload.id})}for(let r of t.payload.rules)for(let o of r.cases)for(let s of o.when.tests){let l=qa(e,s.value);if(!l)continue;let d={where:"test",ref:l.ref,ruleId:r.id,caseId:o.id,testId:s.id};l.namedId!==void 0&&(d.namedId=l.namedId),i.push(d)}return i}function No(e,n,t){if(!e)return;let i=e.kind;switch(i.kind){case"entityState":return{...e,kind:{kind:"entityState",...n}};case"entityAge":return{...e,kind:{kind:"entityAge",...n}};case"entityAttribute":return{...e,kind:{kind:"entityAttribute",...n,attribute:i.attribute}};case"literal":return t==="text"||t==="gauge"||t==="chart"||t==="timeline"?{...e,kind:{kind:"entityState",...n}}:void 0;default:return}}function Wc(e,n,t,i){let a=e.elements.find(o=>o.payload.id===n);if(!a||t.entityId==="")return;let r={...t,domain:t.domain||t.entityId.split(".")[0]||""};if(a.kind==="timeline"){let o=a.payload.value.kind.kind==="entityState"?a.payload.value.kind.entityId:void 0,s=No(a.payload.value,r,a.kind);s&&(a.payload.value=s),(a.payload.bands.length===0||o!==r.entityId)&&(a.payload.bands=ns(r.domain,i))}else if(a.kind==="image")a.payload.entity=r;else if(a.kind==="text"||a.kind==="gauge"||a.kind==="chart"){let o=No(a.payload.value,r,a.kind);o&&(a.payload.value=o)}else if(a.kind==="icon"){let o=No(a.payload.symbol,r,a.kind);o&&(a.payload.symbol=o)}for(let o of Ke(e,n)){let s=o.payload;"entityId"in s.action&&(s.action={type:s.action.type,...r})}}var cg={text:"text",icon:"icon",gauge:"gauge",chart:"chart",timeline:"timeline",shape:"shape",image:"picture",tap:"tap area",chartTimes:"clock times",chartDots:"chart dots",chartGrid:"chart grid",imageTime:"timestamp"};function Xd(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Jd(e){if(e.part==="template")return"Template text";if(e.part==="serviceData")return"Service data";let n=e.layerKind===void 0?"":cg[e.layerKind],t=e.layerName?`${n} "${e.layerName}"`:n;switch(e.kind){case"named":return e.valueName?`Shared value "${e.valueName}"`:"Shared value";case"layer":case"image":return e.part==="total"?`Total on ${t}`:e.part==="gaugeMin"?`Min on ${t}`:e.part==="gaugeMax"?`Max on ${t}`:e.part==="nowIndex"?`Now marker on ${t}`:e.part==="textPart"?`Part of ${t}`:`${Xd(n)} layer${e.layerName?` "${e.layerName}"`:""}`;case"tap":return"Tap area";case"documentTap":return"Tap action";case"rule":return t===""?`Rule on the ${e.family??"shared"} shape`:`Rule on ${t}`;case"layout":{let i=Xd(e.family??"");switch(e.part){case"curvedText":return`${i} curved text`;case"bezelGauge":return`${i} bezel gauge`;case"bezelGaugeMin":return`${i} bezel gauge low label`;case"bezelGaugeMax":return`${i} bezel gauge high label`;default:return`${i} bezel`}}case"inline":return"Inline"}}var Kc=/(['"])([a-z0-9_]+\.[a-z0-9_]+)\1/g;function ug(e){let n=[];for(let t of e.matchAll(Kc))t[2]!==void 0&&n.push(t[2]);return n}function xs(e,n){return n.size===0?e:e.replace(Kc,(t,i,a)=>{let r=n.get(a);return r===void 0?t:`${i}${r}${i}`})}function zi(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function pg(e,n){if(n.payload.name)return n.payload.name;if(n.kind==="shape")return n.payload.kind==="roundedRectangle"?"rounded rectangle":n.payload.kind;if(n.kind==="tap")return"";if(n.kind==="image")return n.payload.entity.displayName||n.payload.entity.entityId;let t=Bn(n)?.kind;if(t===void 0)return"";if(t.kind==="literal")return t.value;if("entityId"in t)return t.displayName||t.entityId;if(t.kind==="named"){let i=t.id.toUpperCase();return e.values.find(a=>a.id.toUpperCase()===i)?.name??""}return""}function gr(e,n){let t=(r,o)=>{n.value?.(r,o);let s=r.kind;if(s.kind==="jinja"){if(n.text){let d=n.text(s.value,{...o,part:"template"});d!==s.value&&(s.value=d)}return}if(s.kind==="aggregate"){let d=s.aggregate.scope;if(n.ref&&d.kind==="entities")for(let c=0;c<d.entities.length;c++){let u=n.ref(zi(d.entities[c]),o);u&&(d.entities[c]=u)}return}if(!n.ref||!("entityId"in s))return;let l=n.ref(zi(s),o);l&&(s.kind==="entityAttribute"?r.kind={kind:"entityAttribute",...l,attribute:s.attribute}:s.kind==="entityState"?r.kind={kind:"entityState",...l}:r.kind={kind:"entityAge",...l})},i=(r,o,s)=>{if(r.type==="callService"){if(n.ref&&r.target!==void 0&&r.target.entityId!==""){let d=n.ref(zi(r.target),o);d&&(r.target=d)}if(n.text&&r.serviceDataJSON!==void 0){let d=n.text(r.serviceDataJSON,{...o,part:"serviceData"});d!==r.serviceDataJSON&&(r.serviceDataJSON=d)}return}if(!n.ref||!("entityId"in r)||r.entityId==="")return;let l=n.ref(zi(r),o);l&&s({type:r.type,...l})};for(let r of e.values)t(r.value,{kind:"named",valueId:r.id,valueName:r.name});for(let r of e.elements){let o={kind:"layer",layerId:r.payload.id,layerKind:r.kind,layerName:pg(e,r)};if(r.kind==="image"){if(n.ref){let l=n.ref(zi(r.payload.entity),{...o,kind:"image"});l&&(r.payload.entity=l)}}else if(r.kind==="tap"){let l=r.payload;i(l.action,{...o,kind:"tap"},d=>{l.action=d})}else{let l=Bn(r);if(l&&t(l,o),r.kind==="text")for(let d of r.payload.parts??[])t(d.value,{...o,part:"textPart"});r.kind==="gauge"&&r.payload.total&&t(r.payload.total,{...o,part:"total"}),r.kind==="gauge"&&r.payload.minSource&&t(r.payload.minSource,{...o,part:"gaugeMin"}),r.kind==="gauge"&&r.payload.maxSource&&t(r.payload.maxSource,{...o,part:"gaugeMax"}),r.kind==="chart"&&r.payload.nowIndex&&t(r.payload.nowIndex,{...o,part:"nowIndex"})}let s={...o,kind:"rule"};for(let l of Oi(r.payload.rules))t(l,s)}let a=Object.keys(e.perFamily).sort((r,o)=>{let s=Pi.indexOf(r),l=Pi.indexOf(o);return(s<0?Pi.length:s)-(l<0?Pi.length:l)});for(let r of a){let o=e.perFamily[r];if(!o)continue;let s={kind:"layout",family:r};o.bezelText&&t(o.bezelText,{...s,part:"bezelText"}),o.curvedText&&t(o.curvedText,{...s,part:"curvedText"});let l=o.bezelGauge;l&&(t(l.value,{...s,part:"bezelGauge"}),l.minLabel&&t(l.minLabel,{...s,part:"bezelGaugeMin"}),l.maxLabel&&t(l.maxLabel,{...s,part:"bezelGaugeMax"}));let d={kind:"rule",family:r};for(let c of Oi(o.rules))t(c,d)}e.inline&&t(e.inline.value,{kind:"inline"}),i(e.tapAction,{kind:"documentTap"},r=>{e.tapAction=r})}function yr(e,n){gr(e,{value:n})}function jc(e,n){return e.kind.kind==="named"&&e.kind.id.toUpperCase()===n.toUpperCase()}function Ji(e,n){let t=new Set;return yr(e,(i,a)=>{jc(i,n)&&t.add(a.layerId??`${a.kind}:${a.valueId??""}:${a.family??""}:${a.part??""}`)}),t.size}function hg(e,n){let t=new Set(e.values.map(a=>a.name.trim().toLowerCase())),i=n.trim()||"Value";if(!t.has(i.toLowerCase()))return i;for(let a=2;;a++){let r=`${i} ${a}`;if(!t.has(r.toLowerCase()))return r}}function vs(e,n,t){let i={id:Q(),name:hg(e,t),value:{kind:structuredClone(n.kind)}},a={kind:{kind:"named",id:i.id}};return n.format&&!_e(n.format)&&(a.format=structuredClone(n.format)),{named:i,ref:a}}function ws(e,n){if(n.kind.kind!=="named")return;let t=n.kind.id,i=e.values.find(o=>o.id.toUpperCase()===t.toUpperCase());if(!i)return;let a=n.format&&!_e(n.format)?n.format:i.value.format,r={kind:structuredClone(i.value.kind)};return a&&!_e(a)&&(r.format=structuredClone(a)),r}function ks(e,n){yr(e,t=>{if(!jc(t,n))return;let i=ws(e,t);i&&(t.kind=i.kind,i.format?t.format=i.format:delete t.format)}),e.values=e.values.filter(t=>t.id.toUpperCase()!==n.toUpperCase())}function $s(e,n){gr(e,{ref:n})}function Cs(e,n){gr(e,{text:n})}function Ss(e,n){let t=[],i={ref:(a,r)=>{a.entityId!==""&&t.push({entityId:a.entityId,ref:a,where:Jd(r)})}};return n&&(i.text=(a,r)=>{for(let o of ug(a)){let s=o.split(".")[0]??"";n(o,s)&&t.push({entityId:o,ref:{entityId:o,displayName:"",domain:s},where:Jd(r)})}return a}),gr(e,i),t}var Zi={text:["color","opacity","text","fontSize","fontWeight","rotation","visibility"],icon:["color","opacity","icon","fontSize","rotation","visibility"],gauge:["color","opacity","gaugeValue","gaugeMin","gaugeMax","rotation","visibility"],chart:["color","opacity","rotation","visibility"],timeline:["opacity","rotation","visibility"],shape:["color","opacity","borderColor","borderWidth","rotation","visibility"],image:["opacity","rotation","visibility"],tap:["visibility"],chartTimes:["opacity","rotation","visibility"],chartDots:["opacity","visibility"],chartGrid:["opacity","visibility"],imageTime:["opacity","rotation","visibility"],layout:["backgroundColor","borderColor","borderWidth","text"]},qc=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","greaterThan","greaterOrEqual","lessThan","lessOrEqual","between","timeBetween","contains","startsWith","endsWith","matchesRegex","isOneOf"];function Vn(e){let n=e.trim();return/^([01][0-9]|2[0-3]):[0-5][0-9]$/.test(n)?n:void 0}function Gn(e){switch(e){case"isOn":case"isOff":case"isUnavailable":case"isStale":case"isEmpty":return"none";case"between":return"between";case"timeBetween":return"times";case"matchesRegex":return"pattern";case"isOneOf":return"options";default:return"value"}}function br(e){switch(e){case"hide":case"show":return"none";case"setFontWeight":return"weight";case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":return"number";default:return"value"}}function Ts(){return{id:Q(),value:V(""),comparison:{kind:"isOn"}}}function Es(){return{id:Q(),when:{join:"all",tests:[Ts()]},then:[]}}function Qi(){return{id:Q(),cases:[Es()]}}function Zd(e,n){return e&&(e.kind.kind!=="literal"||Vn(e.kind.value)!==void 0)?e:V(n)}function Ms(e,n){let t={kind:n};switch(Gn(n)){case"value":t.value=e.value??V("");break;case"between":t.value=e.value??V(""),t.upper=e.upper??V("");break;case"times":t.value=Zd(e.value,"22:00"),t.upper=Zd(e.upper,"06:00");break;case"pattern":t.pattern=e.pattern??"";break;case"options":t.options=e.options??[];break;case"none":break}return t}function Un(e){let n={kind:e};switch(br(e)){case"value":n.value=V(e==="setColor"||e==="setBorderColor"||e==="setBackgroundColor"?"#FF453A":e==="setIcon"?"exclamationmark.triangle":e==="setGaugeValue"?"50":"Text");break;case"number":n.number=e==="setOpacity"?.5:e==="setFontSize"?14:e==="setBorderWidth"?2:e==="setGaugeMax"?100:0;break;case"weight":n.weight="bold";break;case"none":break}return n}var xr="shared:";function Rs(e){return xr+e.toUpperCase()}function Xc(e){return e.values.filter(n=>n.value.kind.kind!=="entityState"&&Ji(e,n.id)>0)}function Jc(e,n){return n.size===0?e:e.map(t=>{let i=n.get(Rs(t.id));if(i===void 0)return t;let a={kind:{kind:"literal",value:i}};return t.value.format&&(a.format=t.value.format),{...t,value:a}})}var mg=["unavailable","unknown"],fg={automation:["on","off"],script:["on","off"],remote:["on","off"],update:["on","off"],timer:["idle","active","paused"],sun:["above_horizon","below_horizon"],valve:["open","closed","opening","closing"],lawn_mower:["mowing","docked","paused","returning","error"],weather:["sunny","clear-night","partlycloudy","cloudy","rainy","pouring","snowy","snowy-rainy","fog","windy","windy-variant","lightning","lightning-rainy","hail","exceptional"]},gg=new Set(["\xB0C","\xB0F"]);function Yc(e){return Array.isArray(e)&&e.length>0&&e.every(n=>typeof n=="string")?e:void 0}function ea(e){let n=typeof e=="number"?e:typeof e=="string"&&e.trim()!==""?Number(e):NaN;return Number.isFinite(n)?n:void 0}function yg(e){let n=e?.trim().match(/\.(\d+)$/)?.[1]?.length??0;return n===0?1:10**-Math.min(n,4)}function bg(e){let n=10**Math.floor(Math.log10(e));return([1,2,2.5,5,10].find(i=>i*n>=e)??10)*n}function xg(e){let n=new Set,t=[];for(let i of e)i===void 0||i===""||n.has(i)||(n.add(i),t.push(i));return t}function Zc(e,n,t){let i=e.split(".")[0]??"",a=n?.attributes??{},o=Yc(a.options)??(i==="climate"?Yc(a.hvac_modes):void 0)??Yi[i]??fg[i];if(o)return{kind:"choice",options:xg([...o,n?.state,t,...mg])};let s=ea(n?.state),l=typeof a.unit_of_measurement=="string"?a.unit_of_measurement:void 0;if(s===void 0&&l===void 0&&i!=="input_number"&&i!=="number")return{kind:"text"};let d=ea(t),c=ea(a.min),u=ea(a.max),p=ea(a.step),m,f;if(c!==void 0&&u!==void 0&&u>c)m=c,f=u;else if(l==="%")m=0,f=100;else{let b=bg(Math.max(Math.abs(s??0)*2,10));m=(s??0)<0||l!==void 0&&gg.has(l)?-b:0,f=b}d!==void 0&&(m=Math.min(m,d),f=Math.max(f,d));let y=p!==void 0&&p>0?p:yg(n?.state);return{kind:"number",min:m,max:f,step:y}}function Qc(e){if(e.appliedToken===void 0)return{kind:"unsupported"};if(e.token===e.appliedToken){let n=!e.polling&&typeof e.lastPollSeconds=="number"?e.lastPollSeconds:void 0;return n===void 0?{kind:"sent"}:{kind:"sent",awaySeconds:n}}return e.pending&&e.polling?{kind:"sending"}:e.polling?{kind:"waiting"}:{kind:"offline"}}function vg(e){if(e<60)return"just now";let n=Math.floor(e/60);if(n<60)return`${n} min ago`;let t=Math.floor(n/60);if(t<24)return`${t} h ago`;let i=Math.floor(t/24);return`${i} ${i===1?"day":"days"} ago`}function eu(e){switch(e.kind){case"unsupported":return{label:"Update the watch app",note:"to receive this",title:"This watch has never reported which changes it applied, so nothing saved here can reach it. Its Wrist Assistant app is older than custom complications, or it has not been opened on this home yet.",resend:!1};case"sent":return e.awaySeconds===void 0?{label:"On watch",title:"The watch has applied every change here.",resend:!1}:{label:"On watch",note:`last seen ${vg(e.awaySeconds)}`,title:"The watch has applied every change here, but it is not listening now. A save made after this will not reach it until the watch app is open on this home again.",resend:!1};case"sending":return{label:"Sending\u2026",title:"Waiting for the watch to pull and confirm.",resend:!1};case"waiting":return{label:"Not on watch yet",title:"The watch is connected but has not confirmed the latest change. Resend wakes it again.",resend:!0};case"offline":return{label:"Open the watch app to sync",title:"Saves reach the watch by themselves while Wrist Assistant is open on this home. Open the app, or switch the watch to this home, and it pulls at once.",resend:!0}}}function nu(e){let n=new TextEncoder().encode(e),t=0xcbf29ce484222325n,i=0x100000001b3n,a=0xffffffffffffffffn;for(let r of n)t^=BigInt(r),t=t*i&a;return t.toString(16)}function iu(e){return new Map(e.map(n=>[n.id.toUpperCase(),n.value]))}function tu(e){return e.kind==="entityAttribute"||e.kind==="entityAge"||e.kind==="aggregate"||e.kind==="time"||e.kind==="jinja"}function As(e,n,t=0){let i=n instanceof Map?n:iu(n),a=e.kind;if(a.kind==="named"){if(t>8)return;let o=i.get(a.id.toUpperCase());return o?o.kind.kind==="named"?As(o,i,t+1):tu(o.kind)?"n_"+a.id.toLowerCase().replace(/-/g,""):void 0:void 0}if(!tu(a))return;let r=ta(a);if(r!==void 0)return"e_"+nu(r)}function ct(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function wg(e){let n;if(e.scope.kind==="entities")n=`expand([${e.scope.entities.map(o=>ct(o.entityId)).join(", ")}])`;else{let{domains:o,areaIds:s,labelIds:l,floorIds:d}=e.scope;if(!(s.length+l.length+d.length>0))n=o.length===0?"[]":"("+o.map(u=>`(states.${u} | list)`).join(" + ")+")";else{let u=[];for(let p of s)u.push(`area_entities(${ct(p)})`);for(let p of l)u.push(`label_entities(${ct(p)})`);d.length>0&&u.push(`((${d.map(p=>`floor_areas(${ct(p)})`).join(" + ")}) | map('area_entities') | sum(start=[]))`),n=`(expand(${u.join(" + ")})`,o.length>0&&(n+=` | selectattr('domain', 'in', [${o.map(ct).join(", ")}])`),n+=")"}}let t=n,i=e.stateFilter;if(i&&(i.kind==="isOn"?t+=" | selectattr('state', 'eq', 'on')":i.kind==="isOff"?t+=" | selectattr('state', 'eq', 'off')":i.kind==="equals"?t+=` | selectattr('state', 'eq', ${ct(i.value)})`:t+=` | rejectattr('state', 'eq', ${ct(i.value)})`),e.function==="count")return`(${t} | list | count)`;let a=e.attribute?`attributes.${e.attribute}`:"state",r=`${t} | map(attribute=${ct(a)}) | map('float', 0) | list`;switch(e.function){case"sum":return`(${r} | sum)`;case"average":return`(${r} | average(0))`;case"min":return`(${r} | min(default=0))`;case"max":return`(${r} | max(default=0))`}}function ta(e){switch(e.kind){case"entityAttribute":return`state_attr(${ct(e.entityId)}, ${ct(e.attribute)})`;case"entityAge":{let n=ct(e.entityId);return`(((now() - states[${n}].last_changed).total_seconds() if states[${n}] is not none else 0) | round(0))`}case"time":switch(e.timeField){case"now":return"now().strftime('%H:%M')";case"hour":return"now().hour";case"minute":return"now().minute";case"day":return"now().day";case"month":return"now().month";case"weekday":return"now().weekday()";case"timestamp":return"(as_timestamp(now()) | round(0))"}return;case"jinja":return e.value.trim().length===0?void 0:e.value;case"aggregate":return wg(e.aggregate);default:return}}function na(e){let n=new Map,t=new Map,i=iu(e.values),a=(o,s=0)=>{let l=o.kind;switch(l.kind){case"literal":case"dataAge":case"chartStat":return;case"entityState":n.set(l.entityId,l);return;case"named":{if(s>8)return;let d=i.get(l.id.toUpperCase());if(!d)return;if(d.kind.kind==="named"){a(d,s+1);return}if(d.kind.kind==="entityState"){n.set(d.kind.entityId,d.kind);return}let c=ta(d.kind);if(c===void 0)return;t.set("n_"+l.id.toLowerCase().replace(/-/g,""),c);return}default:{let d=ta(l);if(d===void 0)return;t.set("e_"+nu(d),d)}}};for(let o of e.values)a({kind:{kind:"named",id:o.id}});for(let o of e.elements){let s=Bn(o);if(s&&a(s),o.kind==="text")for(let l of o.payload.parts??[])a(l.value);o.kind==="gauge"&&o.payload.total&&a(o.payload.total),o.kind==="gauge"&&o.payload.minSource&&a(o.payload.minSource),o.kind==="gauge"&&o.payload.maxSource&&a(o.payload.maxSource),o.kind==="chart"&&o.payload.nowIndex&&a(o.payload.nowIndex);for(let l of Oi(o.payload.rules))a(l)}for(let o of se){if(!e.supportedFamilies.includes(o))continue;let s=e.perFamily[o];if(s){s.bezelText&&a(s.bezelText),s.curvedText&&a(s.curvedText),s.bezelGauge&&(a(s.bezelGauge.value),s.bezelGauge.minLabel&&a(s.bezelGauge.minLabel),s.bezelGauge.maxLabel&&a(s.bezelGauge.maxLabel));for(let l of Oi(s.rules))a(l)}}e.supportedFamilies.includes("inline")&&e.inline&&a(e.inline.value);let r={entities:n,expressions:t};return t.size>0&&(r.document=kg(t)),r}function kg(e){let n=[...e.keys()].sort(),t=[];for(let a of n){let r=e.get(a);r.includes("{{")||r.includes("{%")?t.push(`{% set v_${a} %}${r}{% endset %}`):t.push(`{% set v_${a} = ${r} %}`)}let i=n.map(a=>`"${a}": v_${a}`).join(", ");return t.push(`{{ { ${i} } | to_json }}`),t.join(`
`)}function au(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,$g(r));return{values:t,nullKeys:i}}function $g(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Hs(e){let n=na(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Cg(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Ki(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Sg=10800;function Tg(e,n,t){let i=n==="always"||n==="auto"&&t<=Sg;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function vr(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Tg(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Eg(e,n){return gt(e)===void 0?[]:vr(st(e)*60,qi(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Mg(e,n){return Ln(e)?vr(Math.round(e.historyMinutes)*60,qi(ht(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Rg(e,n,t,i){return n===void 0&&i!==void 0?gt(i)===void 0?[]:vr(st(i)*60,qi(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!Ln(n)?[]:vr(Math.round(n.historyMinutes)*60,qi(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Wn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function je(e){let n=e.trim(),t=Wn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Wn(i)}function Ag(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Hg(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Fg(e){let n=e.trim(),t=Wn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Wn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Wn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Ig(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Lg(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function _g(e,n,t){if(_e(n))return e;let i=n,a=e,r=Wn(e.trim()),o=i.duration?Fg(e):void 0;if(o!==void 0)a=Ig(o);else if(i.relativeTime&&r!==void 0)a=Hg(r);else{let s=je(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Ag(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Lg(a);break}return a}function yi(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function qe(e,n=240){return du(e,n).map(t=>t.value)}function Is(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of qe(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:lu(r)}}function lu(e){return e.some(n=>n)?e:[]}function du(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function ru(e,n,t){let i=du(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Qt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??pe,c=t.highColorHex??Qe,u=t.lowColorHex??et,p=[],m=(y,b)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===b?k.text+=y:p.push({text:y,colorHex:b})},f=0;return i.forEach((y,b)=>{m(e.slice(f,y.start),n);let k=b===o?c:b===s?u:l.length>0?nr(y.value,l,d):n,$=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,$),k),f=$}),m(e.slice(f),n),p}function ou(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function zg(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function aa(e,n=an){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Pg(i.slice(a+1))})}return t}function Pg(e){try{return decodeURIComponent(e)}catch{return e}}function Ng(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function su(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Dg(e,n,t){if(e===void 0)return 0;let i=je(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var xt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=ou(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=_n(n),i=zn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Is(a):{values:qe(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=lu(s),{values:Ls(o,rt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:je(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=je(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):ou(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!_e(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Cg(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?dc(r):Ki(r,a.domainMax-a.domainMin));break}default:{let a=As(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return _g(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Wn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?yi(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=je(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:je(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:je(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Vn(d),p=c===void 0?void 0:Vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(De[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=ru(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,f=ot(n.payload)&&!r.has("text"),y={kind:"text",...u,text:f?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),f?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(ac(n.payload)&&(y.spans=ru(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),f=n.payload.symbol.kind.kind==="literal",y=m===void 0&&f&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let k={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),f=(z,F,R)=>z??(F?je(this.resolve(F)??""):void 0)??R,y=f(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=f(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:je(m),$=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&($=nr(k,Qt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let z=je(this.resolve(p.total)??"");z!==void 0&&(w=z)}let S=su(w,1,er),_={kind:"gauge",...u,fraction:Dg(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:$,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:su(k??0,0,S)};if(p.thresholdValue!==void 0&&b!==y){let z=(p.thresholdValue-y)/(b-y);z>=0&&z<=1&&(_.thresholdFraction=z)}return _}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),f=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Qt(p),w=Wi(p)?f.map(j=>nr(j,$,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",_=p.highlight==="lowest"||p.highlight==="both",z=Di(p),F={kind:"chart",...u,values:f,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?z.high:"none",lowMarker:_?z.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:rt(p.smoothing)??"off",fillStyle:qt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:Yt(p.barRadius),barCorners:Xt(p.barCorners),barBorderWidth:Uo(p),barFillColorHexes:[],barBorderColorHexes:[],barBorderOpenBase:Uo(p)>0&&p.barBorderOpenBase===!0,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Mg(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},R=y.length===0?f:f.filter((j,N)=>!y[N]);if(R.length>0){let j=M=>f.findIndex((W,A)=>W===M&&y[A]!==!0),N=S?j(Math.max(...R)):-1,ee=_?j(Math.min(...R)):-1;N>=0&&(F.highIndex=N),ee>=0&&ee!==N&&(F.lowIndex=ee)}if(p.style==="bars"){let j=f.map((N,ee)=>lc(p,N,$,k,ee===F.highIndex?p.highColorHex:ee===F.lowIndex?p.lowColorHex:void 0));F.barFillColorHexes=j.map(N=>N.fill),F.barBorderWidth>0&&(F.barBorderColorHexes=j.map(N=>N.border))}let E=zg(p,b.min,b.max);E!==void 0&&(F.thresholdY=E);let P=this.chartNowIndex(p,f.length);return P!==void 0&&(F.nowIndex=P),F}case"timeline":{let p=n.payload,m=gt(p),f=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=aa(f,an),b=Ng(y,st(p)*60,$=>gc($,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:Eg(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};lr(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Rg(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),f={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(f.url=y),f}case"chartDots":{let p=n.payload,m=pt(p.size),f={kind:"chartDots",...u,chart:p.chart,dots:Ya(p.dots),diameter:0,indices:[]};return m!==void 0&&(f.size=m),p.colorHex!==void 0&&(f.colorHex=p.colorHex),f}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:An(p.lines),colorHex:Wt(p.colorHex),thickness:Hn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=he[t==="inline"?"rectangular":t],o=[...Wg(Ug(Pc(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,k=this.resolve(b.value),$=k===void 0?void 0:je(k);if($!==void 0){let w=Math.min(b.minValue,b.maxValue),S=Math.max(b.minValue,b.maxValue),_={value:Math.min(S,Math.max(w,$)),minValue:w,maxValue:S===w?w+1:S,colorHexes:b.colorHexes},z=this.resolve(b.minLabel);z!==void 0&&(_.minLabel=z);let F=this.resolve(b.maxLabel);F!==void 0&&(_.maxLabel=F),l.bezelGauge=_}}let f=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(l.backgroundColorHex=f);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function Og(e,n,t){let i=new xt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function bi(e,n,t){let i=new xt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Og(e.inline,n,e)),a}function ra(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Fs=5,Bg=1.7,Vg=1.8;function Gg(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Ug(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Vg,l=Math.max(o.frame.width*n.width,0),d=Gg(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function cu(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function uu(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function wr(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=F=>F==="triangle"?Fs+d:F==="dot"?Math.max(d,Bg):d,u=c(a),p=c(r),m=n.y+u,f=Math.max(n.h-u-p,1),y=m+f,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",$=k?f*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-w*(i-1))/i,.5),_=F=>Math.min(1,Math.max(0,(F-e.domainMin)/b)),z=F=>y-_(F)*f;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:z(0),inset:d,yAtFraction(F){return y-Math.min(Math.max(F,0),1)*f},barRect(F){let R=o+F*(S+w),E=t[F],P,j;if(k){let N=$+_(E)*(f-$);P=y-N,j=y}else P=z(E),j=k?y:z(0),P>j&&([P,j]=[j,P]);return{x:R,y:P,w:S,h:Math.max(j-P,.5)}},point(F){let R=Math.max(s-d*2,0);return{x:t.length>1?o+d+R*F/(t.length-1):o+s/2,y:z(t[F])}},markerCenter(F,R,E="high"){let P=R?this.barRect(F):void 0,j=P?P.x+P.w/2:this.point(F).x,N=E==="high"?a:r,ee=E==="high"?N==="triangle"?n.y+Fs/2:m:N==="triangle"?n.y+n.h-Fs/2:y;return{x:j,y:ee}}}}function pu(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Ls(e,n,t=[]){let i=e.length,a=ic(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,f=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,k=Math.exp(-(b*b)/(2*o*o));m+=e[y]*k,f+=k}return m/f}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function hu(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var ia=1;function Kn(e,n){let t=Math.max(tn,Math.min(nn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-ia>=2,r=a?{...n,y:e.labelsAbove?n.y+i+ia:n.y,h:n.h-i-ia,cy:(e.labelsAbove?n.y+i+ia:n.y)+(n.h-i-ia)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Wg(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&cu(r)===void 0)return{...i,isHidden:!0};let o=jg(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function Kg(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function jg(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=ra(t,i);if(a.w<=0||a.h<=0)return;let r=Kn(t,a).body;if(r.w<=0||r.h<=0)return;let o=wr(t,r),s,l;if(It(n.at)){let k=Kg(n.at,t);if(k===void 0)return;if(t.style==="bars"){let $=o.barRect(k);s=$.x+$.w/2,l=$.y}else{let $=o.point(k);s=$.x,l=$.y}}else{let k=n.at==="zero"?cu(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,$,w)=>$>w?($+w)/2:Math.min(Math.max(k,$),w),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let f=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(f,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var _s=[.01,.025,.05,.1];function xi(e,n){return!(n.width>0&&n.height>0)||n.width===n.height?{x:e,y:e}:n.width>n.height?{x:e*n.height/n.width,y:e}:{x:e,y:e*n.width/n.height}}function zs(e){return typeof e=="number"?{x:e,y:e}:e}function Ps(e){return e.x>0&&e.y>0}var mu=1e-6;function oa(e,n){return Math.round((e-.5)/n)*n+.5-e}function fu(e,n,t){let a=[e,e+n/2,e+n].map(r=>oa(r,t)).reduce((r,o)=>Math.abs(o)<Math.abs(r)?o:r);return ce(e+a)}function qg(e,n){let t=zs(n);return Ps(t)?vi({...e,x:fu(e.x,e.width,t.x),y:fu(e.y,e.height,t.y)}):e}function gu(e,n,t,i={x:!0,y:!0}){let a=zs(t);if(!Ps(a))return e;let{x:r,y:o,width:s,height:l}=e,d=r+s,c=o+l;if(i.x&&n.includes("e")&&(s=Math.max(Ue,ce(d+oa(d,a.x)-r))),i.x&&n.includes("w")){let u=Math.min(ce(r+oa(r,a.x)),d-Ue);s=ce(d-u),r=ce(u)}if(i.y&&n.includes("s")&&(l=Math.max(Ue,ce(c+oa(c,a.y)-o))),i.y&&n.includes("n")){let u=Math.min(ce(o+oa(o,a.y)),c-Ue);l=ce(c-u),o=ce(u)}return{...e,x:r,y:o,width:s,height:l}}function Ns(e,n,t,i){let a=zs(i);if(!Ps(a))return e;let r=(o,s,l)=>{if(s===0)return o;let d=(o-.5)/l,c=s>0?Math.floor(d+mu)+1:Math.ceil(d-mu)-1,u=ce(c*l+.5);for(let p=0;p<1e3&&(s>0?u<=o:u>=o);p++)c+=s,u=ce(c*l+.5);return u};return vi({...e,x:r(e.x,Math.sign(n),a.x),y:r(e.y,Math.sign(t),a.y)})}var Ue=.04,kr=.04;function yu(e,n){let t=()=>{let a=e.getScreenCTM();return a&&a.a!==0&&a.d!==0?{x:a.a,y:a.d}:void 0},i=t()??{x:1,y:1};return a=>(i=t()??i,{x:(a.clientX-n.clientX)/i.x,y:(a.clientY-n.clientY)/i.y})}function $r(e,n){let t={...e,...n};return vi({...t,x:ce(t.x),y:ce(t.y),width:Math.max(Ue,ce(t.width)),height:Math.max(Ue,ce(t.height))})}function Ds(e,n){let t=n==="down"?e.x:ce((1-e.width)/2),i=n==="across"?e.y:ce((1-e.height)/2);return vi({...e,x:t,y:i})}function bu(e,n){let t=Ds(e,n);return t.x===e.x&&t.y===e.y}function vi(e){let n=Math.min(1-kr,Math.max(-e.width+kr,e.x)),t=Math.min(1-kr,Math.max(-e.height+kr,e.y));return{...e,x:n,y:t}}var ce=e=>Math.round(e*1e3)/1e3,xu=10;function Cr(e,n,t,i){let a=i.width>0?e.x+n/i.width:e.x,r=i.height>0?e.y+t/i.height:e.y;return vi({...e,x:ce(a),y:ce(r)})}function Yg(e,n,t,i){let a=n.width,r=n.height,o=e.width*a,s=e.height*r,l=Math.min(o,s),d=e.x*a+(o-l)/2,c=e.y*r+(s-l)/2,u=t.includes("e")?1:-1,p=t.includes("s")?1:-1,m=Ue*Math.max(a,r),f=Math.max(m,l+(u*i.x+p*i.y)/2),y=u>0?d:d+l-f,b=p>0?c:c+l-f;return{...e,x:ce(y/a),y:ce(b/r),width:ce(f/a),height:ce(f/r)}}function Xg(e,n,t,i,a=!1){let r=n.width,o=n.height;if(a||e.width*r>=e.height*o){let p=a?Ue:Math.max(Ue,e.height*o/r),m=e.x+e.width,f=t.includes("e")?Math.max(p,e.width+i.x/r):Math.max(p,e.width-i.x/r),y=t.includes("e")?e.x:m-f;return{...e,x:ce(y),width:ce(f)}}let l=Math.max(Ue,e.width*r/o),d=e.y+e.height,c=t.includes("s")?Math.max(l,e.height+i.y/o):Math.max(l,e.height-i.y/o),u=t.includes("s")?e.y:d-c;return{...e,y:ce(u),height:ce(c)}}function Sr(e,n,t,i,a){let r=yu(e,t),o={...i.handle&&i.outline?i.outline:i.frame},s={...i.frame};e.setPointerCapture(t.pointerId);let l=p=>Math.round(p*1e3)/1e3,d=p=>{if(p.pointerId!==t.pointerId)return;let m=r(p),f=m.x/n.width,y=m.y/n.height,b,k=i.snap!==void 0&&i.snap.on!==p.altKey?i.snap.step:void 0;if(!i.handle)b=vi({...o,x:l(o.x+f),y:l(o.y+y)}),k!==void 0&&(b=qg(b,k));else if(i.square)b=Yg(o,n,i.handle,m);else if(i.line||i.bar){if(b=Xg(o,n,i.handle,m,i.bar===!0),k!==void 0){let $=i.bar===!0||b.width*n.width>=b.height*n.height;b=gu(b,i.handle,k,{x:$,y:!$})}}else{let{x:$,y:w,width:S,height:_}=o,z=o.x+o.width,F=o.y+o.height;i.handle.includes("e")&&(S=Math.max(Ue,o.width+f)),i.handle.includes("s")&&(_=Math.max(Ue,o.height+y)),i.handle.includes("w")&&(S=Math.max(Ue,o.width-f),$=z-S),i.handle.includes("n")&&(_=Math.max(Ue,o.height-y),w=F-_),b={...o,x:l($),y:l(w),width:l(S),height:l(_)},k!==void 0&&(b=gu(b,i.handle,k))}s=b,a.onFrame(i.elementId,b,!1)},c=p=>{p.pointerId===t.pointerId&&(u(),a.onFrame(i.elementId,s,!0))},u=()=>{e.removeEventListener("pointermove",d),e.removeEventListener("pointerup",c),e.removeEventListener("pointercancel",c);try{e.releasePointerCapture(t.pointerId)}catch{}};return e.addEventListener("pointermove",d),e.addEventListener("pointerup",c),e.addEventListener("pointercancel",c),u}function vu(e,n,t,i,a){let r=yu(e,n),o=1;e.setPointerCapture(n.pointerId);let s=c=>{if(c.pointerId!==n.pointerId)return;let u=r(c),p=u.x*(t.includes("e")?1:-1),m=u.y*(t.includes("s")?1:-1),f=i.w>0?(i.w+p)/i.w:1,y=i.h>0?(i.h+m)/i.h:1,b=Math.abs(f-1)>=Math.abs(y-1)?f:y;o=Math.max(.05,b),a(o,!1)},l=c=>{c.pointerId===n.pointerId&&(d(),a(o,!0))},d=()=>{e.removeEventListener("pointermove",s),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l);try{e.releasePointerCapture(n.pointerId)}catch{}};return e.addEventListener("pointermove",s),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),d}var ze=he,la=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ze,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],wi=la.find(e=>e.measured);function Iu(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return la.find(a=>a.screen.width===t&&a.screen.height===i)}function Mr(e,n){let t=ze[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}function wu(e,n){if(n===void 0||!(n>0))return g;let t=xi(n,e),i=[],a=n<.025,r=l=>l===0?"rgba(10,132,255,0.6)":a&&l%10!==0?"rgba(255,255,255,0.06)":"rgba(255,255,255,0.14)",o=Math.floor(.5/t.x+1e-6);for(let l=-o;l<=o;l++){let d=(.5+l*t.x)*e.width;d<=0||d>=e.width||i.push(v`<line x1=${d} y1="0" x2=${d} y2=${e.height} stroke=${r(l)} stroke-width="0.5" vector-effect="non-scaling-stroke" />`)}let s=Math.floor(.5/t.y+1e-6);for(let l=-s;l<=s;l++){let d=(.5+l*t.y)*e.height;d<=0||d>=e.height||i.push(v`<line x1="0" y1=${d} x2=${e.width} y2=${d} stroke=${r(l)} stroke-width="0.5" vector-effect="non-scaling-stroke" />`)}return v`<g class="snap-grid" pointer-events="none">${i}</g>`}var Vs={regular:400,medium:500,semibold:600,bold:700},Lu=1.15;function Ye(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ge(e,n,t="#FFFFFF"){let i=Ye(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var Nt=e=>e*.55;function _u(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Jg(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Zg(e,n,t){if(t<=0||e.length*Nt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/Nt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Qg(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function zu(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Pu(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function ey(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Nu(e,n){return e.reduce((t,i)=>t+i.text.length*Nt(i.look.fontSize*n),0)}function ty(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:Nt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=Nt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function ny(e,n,t){if(t<=0||Nu(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*Nt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*Nt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function iy(e,n,t){let i=ey(n),a=e.lineLimit===2&&t.w>0?ty(e.text,i,t.w):[e.text],r=zu(e.text,a),o=a.map(($,w)=>Pu($,r[w]??0,e.text,i,i[0])),s=Math.max(...o.map($=>Nu($,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map($=>ny($,l,t.w)),{anchor:c,x:u}=_u(e.alignment,t),p=Math.max(0,...d.flat().map($=>$.look.fontSize))*l||e.fontSize*l,m=.35*p,f=p*1.15,y=$=>$.map(w=>{let S=ge(w.look.colorHex,"fill");return v`<tspan font-size=${w.look.fontSize*l} font-weight=${Vs[w.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${w.text}</tspan>`}),b=ge(e.colorHex,"fill"),k=d.length>1?v`${d.map(($,w)=>v`<tspan x=${u} y=${t.cy+m+(w-(d.length-1)/2)*f}>${y($)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${b.fill} fill-opacity=${b["fill-opacity"]}>${k}</text>`}function ay(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?g:iy(e,e.parts,n);let t=ge(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:yi((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Jg(e.text,n.w/Nt(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*Nt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Zg(y,o,n.w)),{anchor:l,x:d}=_u(e.alignment,n),c=Qg(e.text,e.spans),u=c?zu(e.text,i):[],p=(y,b)=>c?Pu(y,u[b]??0,e.text,c,e.colorHex).map(k=>{let $=ge(k.look,"fill");return v`<tspan fill=${$.fill} fill-opacity=${$["fill-opacity"]}>${k.text}</tspan>`}):y,m=o*1.15,f=s.length>1?v`${s.map((y,b)=>v`<tspan x=${d} y=${n.cy+(b-(s.length-1)/2)*m}>${p(y,b)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Vs[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":g}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${f}</text>`}var Gs=2;function Du(e,n){let t=n.w>=n.h,i=Math.max(1,e.dotCount),a=t?n.w:n.h,r=t?n.h:n.w,o=Math.max(1,Math.min(r,a/i-Gs)),s=i*o+(i-1)*Gs;return{horizontal:t,count:i,d:o,span:s}}function ry(e,n){let t=ge(e.colorHex,"stroke"),i=ge(e.trackColorHex,"stroke","#FFFFFF"),a=ge(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let{horizontal:m,count:f,d:y,span:b}=Du(e,n),k=(m?n.cx:n.cy)-b/2+y/2;return v`${Array.from({length:f},($,w)=>{let S=k+w*(y+Gs),_=w<e.filledCount?t:i;return v`<circle cx=${m?S:n.cx} cy=${m?n.cy:S} r=${y/2}
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?g:oy(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function oy(e,n,t,i,a){let r=ge(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function sy(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Kn(e,n),o=r?qs(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?g:v`${o}`;let s=dy(e,a);return o===void 0?s:v`${s}${o}`}function Os(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var ku=0;function Ou(){return ku+=1,ku.toString(36)}function Tr(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);if(s===0)return`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`;if(s>o){let l=Math.sqrt(o*(2*s-o)),d=i+s-l,c=i+r-s+l;return t?`M${d} ${a} L${c} ${a} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${d} ${a} Z`:`M${d} ${a+o} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${c} ${a+o} Z`}return t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function ly(e,n,t,i){let a=n.x,r=n.x+n.w;if(i){let l=e.y,d=n.y+n.h;return t===0?`M${a} ${l} L${a} ${d} L${r} ${d} L${r} ${l}`:`M${a} ${l} L${a} ${d-t} A${t} ${t} 0 0 0 ${a+t} ${d} L${r-t} ${d} A${t} ${t} 0 0 0 ${r} ${d-t} L${r} ${l}`}let o=e.y+e.h,s=n.y;return t===0?`M${a} ${o} L${a} ${s} L${r} ${s} L${r} ${o}`:`M${a} ${o} L${a} ${s+t} A${t} ${t} 0 0 1 ${a+t} ${s} L${r-t} ${s} A${t} ${t} 0 0 1 ${r} ${s+t} L${r} ${o}`}function dy(e,n){let t=wr(e,n),i=Ou(),a=ge(e.colorHex,"fill"),r=ge(e.highColorHex,"fill",e.colorHex),o=ge(e.lowColorHex,"fill",e.colorHex),s=(f,y)=>v`<circle cx=${f.x} cy=${f.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=f=>c?ge(e.pointColorHexes[f],"fill",e.colorHex):a,p=f=>{let y=Ye(f)??Ye(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:y.color,opacity:y.opacity*.28};let b=cy(i,e.id,f),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(b)||d.set(b,v`<linearGradient id=${b} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${y.color} stop-opacity=${y.opacity*.28} />
        <stop offset="1" stop-color=${y.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${b})`,opacity:1}};if(e.style==="bars")for(let f=0;f<t.count;f++){if(e.holes[f]===!0)continue;let y=t.barRect(f),b=e.barFillColorHexes.length===t.count?e.barFillColorHexes[f]:void 0,k=b!==void 0?ge(b,"fill",e.colorHex):f===e.highIndex?r:f===e.lowIndex?o:u(f),$=e.barCorners==="top"?Math.min(Math.max(e.barRadius,0),y.w/2):Math.min(Math.max(e.barRadius,0),y.w/2,y.h/2),w=e.baseline==="zero"&&e.values[f]<0,S=e.barCorners==="top"&&w,_=e.barBorderWidth>0&&e.barBorderColorHexes.length===t.count?e.barBorderColorHexes[f]:void 0,z=e.barBorderWidth,F=_!==void 0&&(y.w<=2*z||y.h<=2*z),R=F?ge(_,"fill",e.colorHex):k;if(e.barCorners==="top"?l.push(v`<path d=${Tr(y,$,S)}
          fill=${R.fill} fill-opacity=${R["fill-opacity"]} />`):l.push(v`<rect x=${y.x} y=${y.y} width=${y.w} height=${y.h} rx=${$}
          fill=${R.fill} fill-opacity=${R["fill-opacity"]} />`),_!==void 0&&!F){let E=ge(_,"fill",e.colorHex),P={x:y.x+z/2,y:y.y+z/2,w:y.w-z,h:y.h-z},j=e.barCorners==="top"?Math.min(Math.max($-z/2,0),P.w/2):Math.min(Math.max($-z/2,0),P.w/2,P.h/2);if(e.barBorderOpenBase){let ee=`${i}bb${f}`,M=e.barCorners==="top"?v`<path d=${Tr(y,$,S)} />`:v`<rect x=${y.x} y=${y.y} width=${y.w} height=${y.h} rx=${$} />`;d.set(ee,v`<clipPath id=${ee}>${M}</clipPath>`),l.push(v`<path d=${ly(y,P,j,w)} fill="none" stroke=${E.fill} stroke-opacity=${E["fill-opacity"]} stroke-width=${z} clip-path=${`url(#${ee})`} />`);continue}let N=e.barCorners==="top"?Tr(P,j,S):Tr(P,0,!1);e.barCorners==="top"||j===0?l.push(v`<path d=${N} fill="none" stroke=${E.fill} stroke-opacity=${E["fill-opacity"]} stroke-width=${z} />`):l.push(v`<rect x=${P.x} y=${P.y} width=${P.w} height=${P.h} rx=${j}
            fill="none" stroke=${E.fill} stroke-opacity=${E["fill-opacity"]} stroke-width=${z} />`)}}else{let f=Array.from({length:t.count},($,w)=>t.point(w)),y=e.holes.length>0,k=hu(t.count,e.holes).filter($=>!y||$.length>1).map($=>{let w=$.map(z=>f[z]),S=pu(w,e.curve),_=`M${w[0].x} ${w[0].y}${S.map(z=>` ${Os(z)}`).join("")}`;return{run:$,pts:w,legs:S,line:_}});if(e.style==="area")for(let{run:$,pts:w,legs:S,line:_}of k)if(e.fillBands&&c&&$.length>1&&e.fillColorHex===void 0)for(let z=0;z<S.length;z++){let F=w[z],R=w[z+1],E=p(e.pointColorHexes[$[z+1]]),P=`M${F.x} ${F.y} ${Os(S[z])} L${R.x} ${t.baselineY} L${F.x} ${t.baselineY} Z`;l.push(v`<path d=${P} fill=${E.fill} fill-opacity=${E.opacity} stroke="none" />`)}else{let z=p(e.fillColorHex??e.colorHex),F=`${_} L${w[w.length-1].x} ${t.baselineY} L${w[0].x} ${t.baselineY} Z`;l.push(v`<path d=${F} fill=${z.fill} fill-opacity=${z.opacity} stroke="none" />`)}for(let{run:$,pts:w,legs:S,line:_}of k)if(c&&$.length>1)for(let z=0;z<S.length;z++){let F=w[z],R=u($[z+1]);l.push(v`<path d=${`M${F.x} ${F.y} ${Os(S[z])}`} fill="none"
          ...
          fill=${b.fill} fill-opacity=${b["fill-opacity"]} />`:s($,b))};if(m(e.highIndex,e.highMarker,r,"high"),m(e.lowIndex,e.lowMarker,o,"low"),e.drawsThreshold&&e.thresholdY!==void 0){let f=t.yAtFraction(e.thresholdY),y=ge(e.thresholdColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${t.plotLeft} ${f} L${t.plotRight} ${f}`} fill="none"
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?v`${s}${qs(e,n,t,i)}`:v`${s}`}function py(e,n){if(e.labels.length===0||n.w<=0||n.h<=0)return g;let{labelSize:t,rowHeight:i}=Kn({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),a={...n,y:n.cy-i/2,h:i};return v`${qs({labels:e.labels,labelColorHex:e.labelColorHex,labelsAbove:!1},a,t,i)}`}function Bu(e,n){if(!(e===void 0||n.w<=0||n.h<=0))return{chart:e,g:wr(e,Kn(e,n).body)}}function hy(e,n,t,i=!1,a=0){let r=Bu(t,n);if(e.indices.length===0||r===void 0)return g;let o=r.chart,s=o.pointColorHexes.length===o.values.length,l=Math.max(e.diameter/2,a),d=new Map,c=l+1.2,u="";for(let m of e.indices){if(m>=o.values.length)continue;let f=r.g.point(m),y=e.colorHex??(s?o.pointColorHexes[m]:o.colorHex);d.set(y,`${d.get(y)??""}M${f.x-l} ${f.y} a${l} ${l} 0 1 0 ${2*l} 0 a${l} ${l} 0 1 0 ${-2*l} 0 Z`),i&&(u+=`M${f.x-c} ${f.y} a${c} ${c} 0 1 0 ${2*c} 0 a${c} ${c} 0 1 0 ${-2*c} 0 Z`)}let p=i&&u!==""?v`<path d=${u} fill="none" stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:g;return v`${p}${[...d].map(([m,f])=>{let y=ge(m,"fill",o.colorHex);return v`<path d=${f} fill=${y.fill} fill-opacity=${y["fill-opacity"]} stroke="transparent" stroke-width="3" />`})}`}function my(e,n,t,i=!1,a=0){let r=Bu(t,n);if(!e.draws||r===void 0)return g;let o=Ye(e.colorHex)??{color:"#FFFFFF",opacity:.2},s=uu(r.g,e.lines);return v`${s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none"
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        stroke-width="1" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" pointer-events="none" />`):g}`}function $u(e){let n=Math.min(e.w,e.h);return{x:e.cx-n/2,y:e.cy-n/2,w:n,h:n,cx:e.cx,cy:e.cy}}var sa=4;function fy(e,n){let t=e.w>=e.h,i=t?e.h:e.w,a=Math.min(i,Math.max(sa,Math.max(0,n)));return t?{x:e.x,y:e.cy-a/2,w:e.w,h:a,cx:e.cx,cy:e.cy}:{x:e.cx-a/2,y:e.y,w:a,h:e.h,cx:e.cx,cy:e.cy}}function Vu(e,n){if(e.kind==="shape")return e.shapeKind==="circle"?$u(n):e.shapeKind==="line"?fy(n,e.thickness):n;if(e.kind==="icon"){let t=Math.max(sa,Ys(e));return{x:n.cx-t/2,y:n.cy-t/2,w:t,h:t,cx:n.cx,cy:n.cy}}if(e.kind==="chartTimes"){if(e.labels.length===0||n.w<=0||n.h<=0)return n;let{rowHeight:t}=Kn({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),i=Math.max(sa,t);return{x:n.x,y:n.cy-i/2,w:n.w,h:i,cx:n.cx,cy:n.cy}}if(e.kind==="imageTime"){let t=ds(n.w,n.h);if(!e.linked||t<=0)return n;let i=Js(new Date).length*t*.578+t*.89,a=t*1.25;return{x:n.cx-i/2,y:n.cy-a/2,w:i,h:a,cx:n.cx,cy:n.cy}}if(e.kind!=="gauge")return n;switch(e.style){case"ring":case"arc":return $u(n);case"bar":{let t=Math.max(sa,e.lineWidth);return{x:n.x,y:n.cy-t/2,w:n.w,h:t,cx:n.cx,cy:n.cy}}case"dots":{let{horizontal:t,d:i,span:a}=Du(e,n),r=Math.max(sa,i);return t?{x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,cx:n.cx,cy:n.cy}:{x:n.cx-r/2,y:n.cy-a/2,w:r,h:a,cx:n.cx,cy:n.cy}}default:return n}}function Gu(e,n,t){return e.kind==="shape"?e.shapeKind==="circle"?{square:!0}:e.shapeKind==="line"?{line:!0}:{}:e.kind==="chartTimes"?{bar:!0}:e.kind==="imageTime"?Cu(e,n,t):e.kind!=="gauge"?{}:e.style==="ring"||e.style==="arc"?{square:!0}:e.style==="bar"?{bar:!0}:e.style!=="dots"?{}:Cu(e,n,t)}function Cu(e,n,t){if(t.width<=0||t.height<=0)return{};let i=Vu({...e,frame:n},ra({...e,frame:n},t));return{outline:{...n,x:i.x/t.width,y:i.y/t.height,width:i.w/t.width,height:i.h/t.height}}}function Ys(e){return e.path!==void 0&&e.path!==""?e.size*Lu:e.size}function gy(e,n){let t=ge(e.fillColorHex,"fill"),i=e.borderColorHex?Ye(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return v`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function yy(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ge(e.colorHex,"fill"),s=e.size*Lu;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Xs=.25,by=8;function xy(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Xs),by),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,f=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),b=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(f-n)/2*(1+b)+0,width:m,height:f}}function Js(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Er=4;function vy(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Er:n.x+n.w-Er-a,d=e.timestampCorner.startsWith("top")?n.y+Er:n.y+n.h-Er-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function wy(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function ky(e,n,t){let i=t.icons,a=`imgclip-${Ou()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?vy(e,n,Js(new Date)):void 0,s=o?Uu(o):g,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=xy(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=v`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(wy(e.source,e.entityId),14,"#FFFFFF99")??g}</g>`;return v`
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function $y(e,n){if(!e.linked)return g;let t=Js(new Date),i=ds(n.w,n.h);if(i<=0)return g;let a=t.length*i*.578+i*.89,r=i*1.25;return Uu({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function Cy(e,n,t,i,a){if(!i)return g;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Sy(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Us} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??g}</g>`:g}`}var Us=5;function Sy(e,n){let t=Us*.55,i=n.w-2;if(n.h<Us*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Wu(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function Ws(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return g;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return g;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return g;let d=ra(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=ay(e,d);break;case"icon":u=yy(e,d,t.icons);break;case"gauge":u=ry(e,d);break;case"chart":u=sy(e,d);break;case"timeline":u=uy(e,d);break;case"chartTimes":u=py(e,d);break;case"imageTime":u=$y(e,d);break;case"chartDots":u=hy(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=my(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=gy(e,d);break;case"image":u=ky(e,d,t);break;case"tap":u=Cy(e,d,t.icons,r,c?_t(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,f=t.highlightId===e.id,y=f||t.highlightIds?.includes(e.id)===!0,b=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",$=t.handles===!0&&(!l||s)&&!b&&!k,w=Vu(e,d),S=y&&!b?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:g,_=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${d.cx} ${d.cy})">${z}${u}${_}${S}${E}</g>`}function Rr(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Zs(e,n){return(n?23.5:34)*e}var Su=10.5;function Ku(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Tu(e,n){let t=0;for(let i of e)t+=Ku(i,n);return t}function Eu(e,n,t){let i=e.toUpperCase(),a=d=>Ku(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Ks(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function js(e,n,t,i){let a=Ks(e,n,t),r=Ks(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function ju(e,n,t,i){let{dial:a}=Rr(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:js(a,t,i.start,i.end),length:t*r}}function Ty(e,n){let t=Rr(e,!0);return ju(e,n,t.dial.r,t.labelArc)}var Mu=18.5,Ey=113,My={start:-71,end:-36},Ru=104,Ry=6.2,Au={start:-77,end:-30.5};function Hu(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Fu(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Hu(e[i]),o=Hu(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var Bs=11;function Ay(e,n,t){let{dial:i}=Rr(n,!0),a=Ru*n,r=180/(Math.PI*Ru),o=e.minLabel!==void 0?Tu(e.minLabel,Bs)*r:0,s=e.maxLabel!==void 0?Tu(e.maxLabel,Bs)*r:0,l=Au.start+(o>0?Math.max(0,o-1.8):0),d=Au.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let k=0;k<u;k++){let $=l+c*k/u,w=Math.min(d,l+c*(k+1)/u+.4);p.push(v`<path d=${js(i,a,$,w)} fill="none"
      stroke=${Fu(e.colorHexes,(k+.5)/u)} stroke-width=${Ry*n}
      stroke-linecap=${k===0||k===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),f=Ks(i,a,l+c*m),y=1.5,b=(k,$,w,S)=>v`
    <defs><path id=${k} d=${js(i,a,$,w)} /></defs>
    ...
    <circle cx=${f.x} cy=${f.y} r=${3.2*n} fill=${Fu(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?b(`${t}-gmin`,l-y-Math.max(o,3),l-y,e.minLabel):g}
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):g}`}function Ar(e,n){let t=e.family in ze?e.family:"rectangular",i=n.slot??ze[t],a=ze[t],r=Mr(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ye(e.backgroundColorHex),l=Ye(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Wu(c);if(t==="corner"){let b=r.scale,k=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",w=$!=="",S=Rr(b,k),_=Zs(b,k),z=_/(a.width*b),F=S.tile.cx-_/2,R=S.tile.cy-_/2,E=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,P=g;if(e.bezelGauge)P=Ay(e.bezelGauge,b,o);else if(e.bezelText){let N=Ty(b,`${o}-bezel`),ee=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?yi((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;P=v`<defs><path id=${N.id} d=${N.d} /></defs>
        <text font-size=${Su*b} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${N.id}" startOffset="50%" text-anchor="middle">${Eu(ee,N.length,Su*b)}</textPath></text>`}let j=g;if(w){let N=Ye(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ee=ju(b,`${o}-curved`,Ey*b,My);j=v`<defs><path id=${ee.id} d=${ee.d} /></defs>
        <text font-size=${Mu*b} font-weight="600" fill=${N.color} fill-opacity=${N.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${ee.id}" startOffset="50%" text-anchor="middle">${Eu($,ee.length,Mu*b*.88)}</textPath></text>`}else{let N=e.borderWidth*r.scale*z,ee=l?v`<circle cx=${_/2} cy=${_/2} r=${_/2-N/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${N} />`:g;j=v`<g transform="translate(${F} ${R})">
        <g clip-path=${`url(#${o})`}>
    ...
    ${p}
    ${c.map(m=>Ws(m,a,d,Wu(e.elements)))}
    ${u}
  </svg>`}function ne(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var ln=["rectangular","circular","corner","inline"];function ki(e){return se.includes(e)}function da(e){return ln.filter(n=>e.supportedFamilies.includes(n))}function Qs(e){return se.find(n=>e.supportedFamilies.includes(n))}function Hr(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function Ly(){return{value:V("")}}function Yu(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=ln.filter(t=>t===n||e.supportedFamilies.includes(t))),ki(n)?e.perFamily[n]||(e.perFamily[n]=Pt()):e.inline||(e.inline=Ly()),e.schemaVersion=Rn(e)}function Xu(e,n){if(Hr(e,n)){if(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),ki(n)){for(let t of bt(e,n))fe(e,t.payload.id);delete e.perFamily[n],dt(e)}else delete e.inline;e.schemaVersion=Rn(e)}}function Ju(e,n){let t=[];if(!ki(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=bt(e,n).filter(r=>!ve(e,r)).length;return a>0&&t.push(`${a} layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var Xe={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a",chartTimes:"#5e35b1",chartDots:"#5e35b1",chartGrid:"#5e35b1",imageTime:"#00838f"},dn={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area",chartTimes:"Clock times",chartDots:"Chart dots",chartGrid:"Chart grid",imageTime:"Timestamp"},el=["text","icon","gauge","chart","timeline","shape","image","tap"],te={content:"#4a7fe8",look:"#a15fe0",numbers:"#26a69a",position:"#66bb6a",states:"#f9a825",tap:Xe.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Zu="2.8.0";function ca(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function Qu(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function ep(e,n=Zu){let t=ca(e),i=ca(n);return!t||!i?!1:Qu(t,i)>=0}function tl(e,n=null){if(n===null)return;let t=ca(e),i=ca(n);return!t||!i||Qu(t,i)>=0?void 0:`Needs Wrist Assistant ${i[2]===0?`${i[0]}.${i[1]}`:i.join(".")} or later on your watch.`}function tp(e,n=Zu){return`${ca(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The editor needs ${n}, coming soon to the App Store.`}var np="52a9d81d0fd7";var ip="11fa18406cea";var We="mdi:";function _y(e){return e.trim().replace(/\./g,"-")}function zy(e){return e.trim().replace(/-/g,".")}var Fr=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>zy(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=_y(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Ye(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return v`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
    ...
    <path d=${kp(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
      ...
      </g>`}}function $p(e){return h`<svg class="shot" viewBox="0 0 120 46" aria-hidden="true">${jy(e)}</svg>`}var Cp={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Sp=e=>(...n)=>({_$litDirective$:e,values:n}),Or=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,t,i){this._$Ct=n,this._$AM=t,this._$Ci=i}_$AS(n,t){return this.update(n,t)}update(n,t){return this.render(...t)}};var{I:qy}=$d,Tp=e=>e;var Ep=()=>document.createComment(""),Si=(e,n,t)=>{let i=e._$AA.parentNode,a=n===void 0?e._$AB:n._$AA;if(t===void 0){let r=i.insertBefore(Ep(),a),o=i.insertBefore(Ep(),a);t=new qy(r,o,e,e.options)}else{let r=t._$AB.nextSibling,o=t._$AM,s=o!==e;if(s){let l;t._$AQ?.(e),t._$AM=e,t._$AP!==void 0&&(l=e._$AU)!==o._$AU&&t._$AP(l)}if(r!==a||s){let l=t._$AA;for(;l!==r;){let d=Tp(l).nextSibling;Tp(i).insertBefore(l,a),l=d}}}return t},cn=(e,n,t=e)=>(e._$AI(n,t),e),Yy={},Mp=(e,n=Yy)=>e._$AH=n,Rp=e=>e._$AH,Br=e=>{e._$AR(),e._$AA.remove()};var Ap=(e,n,t)=>{let i=new Map;for(let a=n;a<=t;a++)i.set(e[a],a);return i},Hp=Sp(class extends Or{constructor(e){if(super(e),e.type!==Cp.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,n,t){let i;t===void 0?t=n:n!==void 0&&(i=n);let a=[],r=[],o=0;for(let s of e)a[o]=i?i(s,o):o,r[o]=t(s,o),o++;return{values:r,keys:a}}render(e,n,t){return this.dt(e,n,t).values}update(e,[n,t,i]){let a=Rp(e),{values:r,keys:o}=this.dt(n,t,i);if(!Array.isArray(a))return this.ut=o,r;let s=this.ut??=[],l=[],d,c,u=0,p=a.length-1,m=0,f=r.length-1;for(;u<=p&&m<=f;)if(a[u]===null)u++;else if(a[p]===null)p--;else if(s[u]===o[m])l[m]=cn(a[u],r[m]),u++,m++;else if(s[p]===o[f])l[f]=cn(a[p],r[f]),p--,f--;else if(s[u]===o[f])l[f]=cn(a[u],r[f]),Si(e,l[f+1],a[u]),u++,f--;else if(s[p]===o[m])l[m]=cn(a[p],r[m]),Si(e,a[u],a[p]),p--,m++;else if(d===void 0&&(d=Ap(o,m,f),c=Ap(s,u,p)),d.has(s[u]))if(d.has(s[p])){let y=c.get(o[m]),b=y!==void 0?a[y]:null;if(b===null){let k=Si(e,a[u]);cn(k,r[m]),l[m]=k}else l[m]=cn(b,r[m]),Si(e,a[u],b),a[y]=null;m++}else Br(a[p]),p--;else Br(a[u]),u++;for(;m<=f;){let y=Si(e,l[f+1]);cn(y,r[m]),l[m++]=y}for(;u<=p;){let y=a[u++];y!==null&&Br(y)}return this.ut=o,Mp(e,l),Rt}});var Fp="sun.sun";function Ip(e){let n=e?.[Fp],t=typeof n?.attributes?.friendly_name=="string"?n.attributes.friendly_name.trim():"";return{entityId:Fp,displayName:t||"Sun",domain:"sun"}}var Lp=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Xy=[0,1,2,3,4];function _p(e){let n=[];for(let t of e??[]){let i=t.trim();if(i==="")continue;let a=Number(i);Number.isInteger(a)&&a>=0&&a<=6&&!n.includes(a)&&n.push(a)}return n.sort((t,i)=>t-i)}function cl(e){return[...new Set(e)].filter(n=>n>=0&&n<=6).sort((n,t)=>n-t).map(String)}var zp=[{kind:"afterSunset",label:"After sunset",hint:"True from sunset to sunrise, from the sun entity's own state."},{kind:"daytime",label:"Daytime",hint:"True while the sun is up."},{kind:"sunElevation",label:"Sun below an angle",hint:"The sun's elevation in degrees, below a number you set. 0 is the horizon."},{kind:"weekday",label:"Weekday is one of",hint:"A row of days, starting on Monday to Friday."},{kind:"timeBetween",label:"Time between",hint:"A clock window that may wrap midnight, starting at 22:00 to 06:00."}];function Jy(e){return[Pp(e,"below_horizon")]}function Zy(e){return[Pp(e,"above_horizon")]}function Pp(e,n){return{id:Q(),value:{kind:{kind:"entityState",...e}},comparison:{kind:"equals",value:V(n)}}}function Qy(e,n=0){return[{id:Q(),value:{kind:{kind:"entityAttribute",...e,attribute:"elevation"}},comparison:{kind:"lessThan",value:V(String(n))}}]}function eb(e=Xy){return[{id:Q(),value:{kind:{kind:"time",timeField:"weekday"}},comparison:{kind:"isOneOf",options:cl(e)}}]}function tb(e="22:00",n="06:00"){return[{id:Q(),value:{kind:{kind:"time",timeField:"now"}},comparison:{kind:"timeBetween",value:V(e),upper:V(n)}}]}function Np(e,n){switch(e){case"afterSunset":return Jy(n);case"daytime":return Zy(n);case"sunElevation":return Qy(n);case"weekday":return eb();case"timeBetween":return tb()}}function ul(e){delete e.coloring,delete e.bands,delete e.bandAboveColorHex,delete e.highlight,delete e.highColorHex,delete e.lowColorHex}function ma(e){for(let n of e)delete n.partId}function Dp(e,n=Q()){if(e.parts!==void 0&&e.parts.length>0)return e.parts[0].id;let t={id:n,value:structuredClone(e.value)};return e.coloring==="bands"&&(e.bands?.length??0)>0&&(t.coloring="bands",t.bands=e.bands,e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==pe&&(t.bandAboveColorHex=e.bandAboveColorHex)),ul(e),e.parts=[t],e.value=Ui(e.parts),n}function Vr(e,n=[]){let t=e.parts??[];if(e.countdown===!0||t.length===0)return delete e.parts,ma(e.rules),{ok:!0,joined:!1,moved:[]};if(t.length===1){let a=t[0],r=[];return e.value=a.value,a.fontSize!==void 0&&(e.fontSize=a.fontSize,r.push("fontSize")),a.fontWeight!==void 0&&(e.fontWeight=a.fontWeight,r.push("fontWeight")),a.colorHex!==void 0&&(e.colorSlot.baseColorHex=a.colorHex,r.push("color")),ul(e),a.coloring!==void 0&&a.coloring!=="uniform"&&(e.coloring=a.coloring),a.bands!==void 0&&a.bands.length>0&&(e.bands=a.bands),a.bandAboveColorHex!==void 0&&(e.bandAboveColorHex=a.bandAboveColorHex),a.coloring==="bands"&&(a.bands?.length??0)>0&&r.push("bands"),delete e.parts,ma(e.rules),{ok:!0,joined:!1,moved:r}}let i=pl(t,n);return i.ok?(e.value=i.value,ul(e),delete e.parts,ma(e.rules),{ok:!0,joined:!0}):i}function pa(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function ha(e){return e.includes("{")?`{% raw %}${e}{% endraw %}`:e}function nb(e,n){let t=e,i=e.format;for(let r=0;t.kind.kind==="named";r++){if(r>8)return;let o=t.kind.id.toUpperCase(),s=n.find(l=>l.id.toUpperCase()===o)?.value;if(!s)return;i=_e(i)?s.format:i,t=s}let a={kind:t.kind};return _e(i)||(a.format=i),a}function ib(e,n){let t=nb(e,n);if(!t)return{blocked:"kind"};let i=Fn(t);if(i!==void 0)return ha(i);let a=t.kind,r=t.format??{};if(r.relativeTime||r.duration)return{blocked:"format"};let o="",s;switch(a.kind){case"entityState":s=`states(${pa(a.entityId)})`;break;case"jinja":{if(a.value.trim()==="")return"";let c=a.value.includes("{{")||a.value.includes("{%"),u=r.decimals===void 0&&r.multiply===void 0&&r.offset===void 0&&!r.textCase;if(c&&u)return ha(r.prefix??"")+a.value+ha(r.suffix??"");c?(o=`{% set wa_text %}${a.value}{% endset %}`,s="wa_text"):s=`(${a.value})`;break}case"entityAttribute":case"entityAge":case"aggregate":case"time":{let c=ta(a);if(c===void 0)return{blocked:"kind"};s=c;break}default:return{blocked:"kind"}}if(r.decimals!==void 0||r.multiply!==void 0||r.offset!==void 0){let c=`(${s} | float(0))`;r.multiply!==void 0&&(c=`(${c} * ${r.multiply})`),r.offset!==void 0&&(c=`(${c} + ${r.offset})`),s=r.decimals!==void 0?`${pa(`%.${Math.max(0,Math.trunc(r.decimals))}f`)} | format(${c})`:c}let l=r.useEntityUnit&&"entityId"in a?a.entityId:void 0;l!==void 0&&(o+=`{% set wa_unit = state_attr(${pa(l)}, 'unit_of_measurement') %}`);let d="('' if not wa_unit else (wa_unit if wa_unit[:1] in ['\xB0', '%'] else ' ' ~ wa_unit))";if(r.textCase){let c=r.textCase==="upper"?"upper":r.textCase==="lower"?"lower":"title",u=[...r.prefix?[pa(r.prefix)]:[],`(${s})`,...l!==void 0?[d]:[],...r.suffix?[pa(r.suffix)]:[]].join(" ~ ");return`${o}{{ (${u}) | ${c} }}`}return o+ha(r.prefix??"")+`{{ ${s} }}`+(l!==void 0?`{{ ${d} }}`:"")+ha(r.suffix??"")}function pl(e,n=[]){if(e.every(a=>a.value.kind.kind==="literal"))return{ok:!0,value:Ui(e)};let t=[],i=[];return e.forEach((a,r)=>{let o=ib(a.value,n);typeof o=="string"?t.push(o):i.push({index:r,partId:a.id,reason:o.blocked})}),i.length>0?{ok:!1,blocked:i}:{ok:!0,value:{kind:{kind:"jinja",value:t.join("")}}}}var Wr=[["threshold","Threshold line"],["now","Now line"],["zero","Zero line"],["grid","Grid lines"],["dots","Dots"],["times","Clock times"]],Bp=[{label:"Newest",stat:"latest",marker:"latest"},{label:"First",stat:"first",marker:"first"},{label:"Highest",stat:"highest",marker:"highest"},{label:"Lowest",stat:"lowest",marker:"lowest"},{label:"Average",stat:"average"},{label:"Change",stat:"delta"},{label:"Total",stat:"sum"},{label:"Trend",stat:"trend"},{label:"Top of scale",stat:"top"},{label:"Bottom of scale",stat:"bottom"},{label:"Now",marker:"now"}],qn="color-mix(in srgb, var(--k) 30%, #6b7280)",Ur='system-ui, -apple-system, "Segoe UI", sans-serif',pn=40,Gr=6,ab=[22,17,11,16,27,23,35,31];function rb(e={}){let n=(e.values??[]).filter(p=>Number.isFinite(p)),t=n.length>=2,i=t?n:ab,a=Math.min(...i),r=Math.max(...i);t&&e.threshold!==void 0&&Number.isFinite(e.threshold)&&(a=Math.min(a,e.threshold),r=Math.max(r,e.threshold)),r===a&&(r+=1,a-=1);let o=p=>Gr+(r-p)/(r-a)*(pn-Gr),s=i.length,l=i.map((p,m)=>10+m*100/(s-1)),d=i.map(o),c=p=>Math.min(pn,Math.max(Gr,p)),u=t&&e.now!==void 0&&Number.isFinite(e.now)?Math.min(s-1,Math.max(0,Math.round(e.now))):Math.round((s-1)*.6);return{xs:l,ys:d,y:o,real:t,zeroY:c(o(0)),thresholdY:c(o(t&&e.threshold!==void 0?e.threshold:(a+r)/2)),averageY:o(i.reduce((p,m)=>p+m,0)/s),column:{highest:i.indexOf(Math.max(...i)),lowest:i.indexOf(Math.min(...i)),first:0,latest:s-1,now:u}}}function ob(e){let n=e.xs.map((t,i)=>`${i===0?"M":"L"}${t.toFixed(1)} ${e.ys[i].toFixed(1)}`).join("");return v`
    <path d=${`${n}L${e.xs[e.xs.length-1]} ${pn}L${e.xs[0]} ${pn}Z`} fill=${qn} opacity=".18" />
    <path d=${n} fill="none" stroke=${qn} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />`}function sb(e){let n=Math.min(10,Math.max(1,100/e.xs.length*.7));return v`${e.xs.map((t,i)=>{let a=Math.min(e.ys[i],pn-1);return v`<rect x=${t-n/2} y=${a} width=${n} height=${pn-a} rx=${Math.min(2,n/2)} fill=${qn} opacity=".45" />`})}`}function lb(){return v`${[[4,30,.35],[35,18,.7],[54,10,.35],[65,26,.7],[92,24,.35]].map(([n,t,i])=>v`<rect x=${n} y="10" width=${t} height="16" rx="3" fill=${qn} opacity=${i} />`)}`}function db(){return v`
    ...
    @pointerdown=${t??g}>${e}${i}</span>`}var oo="wa-scrub-start",so="wa-scrub-end",gb=3,yb=3;function bb(e,n){return e!==void 0&&Number.isFinite(e)?e:Math.max(0,n.min??0)}function xb(e,n,t={}){let i=n!==void 0&&n>0?n:10**-Math.min(2,Cl(e));return t.coarse?i*10:t.fine?i/10:i}function vb(e,n,t,i){let a=e+Math.round((n-e)/t)*t;return i.min!==void 0&&(a=Math.max(i.min,a)),i.max!==void 0&&(a=Math.min(i.max,a)),Number(a.toFixed(Math.min(10,Math.max(Cl(t),Cl(e)))))}function Cl(e){if(!Number.isFinite(e)||Number.isInteger(e))return 0;let n=String(e),t=/e-(\d+)$/.exec(n);return t?Number(t[1])+(n.split("e")[0].split(".")[1]??"").length:(n.split(".")[1]??"").length}function gh(e,n,t,i,a,r){let o=bb(t,a),s=n.clientX,l=s,d=o,c=o,u=!1,p=f=>{if(!u){if(Math.abs(f.clientX-s)<gb)return;u=!0,l=f.clientX,e.classList.add("scrubbing"),e.dispatchEvent(new CustomEvent(oo,{bubbles:!0,composed:!0}))}let y=xb(o,a.step,{coarse:f.shiftKey,fine:f.altKey});d+=(f.clientX-l)/yb*y,l=f.clientX,a.min!==void 0&&(d=Math.max(a.min,d)),a.max!==void 0&&(d=Math.min(a.max,d));let b=vb(o,d,y,a);b!==c&&(c=b,i(b))},m=f=>{if(e.removeEventListener("pointermove",p),e.removeEventListener("pointerup",m),e.removeEventListener("pointercancel",m),u){e.classList.remove("scrubbing"),e.dispatchEvent(new CustomEvent(so,{bubbles:!0,composed:!0}));let y=b=>{b.preventDefault(),b.stopPropagation()};e.addEventListener("click",y,{capture:!0,once:!0}),setTimeout(()=>e.removeEventListener("click",y,{capture:!0}),0)}r(u,f)};e.setPointerCapture(n.pointerId),e.addEventListener("pointermove",p),e.addEventListener("pointerup",m),e.addEventListener("pointercancel",m)}function lo(e,n,t){return i=>{if(i.button!==0||!i.isPrimary)return;let a=i.currentTarget;a.closest(".field")?.querySelector("input[type=number]")?.disabled||(i.preventDefault(),gh(a,i,e,n,t,()=>{}))}}function Sa(e,n,t){return i=>{let a=i.currentTarget;i.button!==0||!i.isPrimary||a.disabled||a.matches(":focus")||(i.preventDefault(),gh(a,i,e,n,t,(r,o)=>{r||o.type!=="pointerup"||(a.focus(),a.select())}))}}function mn(e,n,t,i=a=>String(a)){if(n===void 0)return;let a=n;return{atDefault:e===a,title:`Back to ${i(a)}`,reset:()=>t(a)}}function Re(e,n,t,i={}){return h`<label class="field">${Ve(e,mn(n,i.def,t,a=>a===""?"empty":a))}
    <input type="text" .value=${n} placeholder=${i.placeholder??""} list=${i.list??g}
      class=${i.mono?"mono":""} @input=${we(t)} /></label>`}function yh(e,n,t,i=3){return h`<label class="field"><span>${e}</span>
    <textarea rows=${i} .value=${n} class="mono" @input=${we(t)}></textarea></label>`}function ae(e,n,t,i={}){let a=i.def===null?{atDefault:n===void 0,title:"Back to none",reset:()=>t(void 0)}:mn(n,i.def,t);return h`<label class="field num">${Ve(e,a,lo(n,t,i))}${co(n,t,i)}</label>`}function co(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e),a=h`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??g} max=${t.max??g}
    ...
    ${to(e,n,t,i,a)}</div>`}function to(e,n,t,i,a={}){return h`<div class="seg wide" role="radiogroup" aria-label=${e}>
    ...
    </div>`}function wb(e,n){let t=i=>mn(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${Ve(e.label,t(e))}
    <div class="pair-row">
      ${to(e.label,e.value,e.options,e.set,e)}
      ${Ve(n.label,t(n))}
      ${to(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function Zn(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Ve(e,mn(n,i.def,t,a),lo(n,t,i))}
    ...
    </div></div>`}function Be(e,n,t,i,a={}){return h`<label class="field check">${Ve(e,mn(n,i,t,r=>r?"on":"off"))}<input type="checkbox" .checked=${n} ?disabled=${a.disabled===!0} @change=${r=>t(r.target.checked)} /></label>`}function ye(e,n,t,i=!1,a){let{rgb:r,alpha:o}=bh(n),s=a===void 0?void 0:{atDefault:Hl(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)},l=i&&n===void 0;return h`<div class="field color">${Ve(e,s)}
    <div class="color-row">
      ${i?h`<input type="checkbox" title="Enabled" aria-label=${`${e} on`} .checked=${n!==void 0} @change=${d=>t(d.target.checked?Qr(r,o):void 0)} />`:g}
      ${uo(e,n,t,l)}
    </div></div>`}function bh(e){let n=(e??"").replace(/^#/,""),t=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n);return{valid:t,swatch:t?`#${n}`:"transparent",rgb:t?`#${n.slice(0,6)}`:"#ffffff",alpha:t&&n.length===8?Math.round(parseInt(n.slice(6,8),16)/255*100):100}}function Qr(e,n){let t=e.replace(/^#/,"").toUpperCase();return n>=100?`#${t}`:`#${t}${Math.round(n/100*255).toString(16).padStart(2,"0").toUpperCase()}`}function uo(e,n,t,i=!1,a="#RRGGBB"){let{valid:r,swatch:o,rgb:s,alpha:l}=bh(n);return h`<span class="color-box">
      ...
      <span class="num-box alpha" style="--wa-unit:1">
        <input type="number" min="0" max="100" step="1" .value=${String(l)} title="Opacity" aria-label=${`${e}: opacity`} ?disabled=${i}
          data-scrub @pointerdown=${Sa(l,d=>t(Qr(s,d)),{step:1,min:0,max:100})}
    ...
    <div class="color-row">${uo(e,n,i,!1,t)}</div></div>`}function yl(e,n,t){return h`${Al(e.label,n,e.empty,t)}${e.note===void 0?g:h`<div class=${e.warn?"hint warn":"hint"}>${e.note}</div>`}`}function Hl(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function po(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function kb(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Kp(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var xh=50;function $b(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Cb(e,n,t=xh,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Sb=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function vh(e){return Sb.test(e.trim())}function Tb(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return po(t,i);if(vh(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Xn=new Map;function Ae(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Fl(e){return Xn.has(e)}function $t(e,n,t,i,a,r={}){let o=e.hass.states,s=Xn.get(a),l=s?Cb(kb(o,r.domain,Kp(e.hass)),s.query,xh,r.preferNumeric?$b:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(w,S,_=0)=>{Xn.set(a,{query:S,index:_}),Ae(w)},p=w=>{Xn.delete(a),Ae(w)},m=w=>{let S=Tb(w,t,o);S&&i(S)},f=(w,S)=>{i(po(o,w.entityId)),p(S)},y=()=>Math.max(0,Math.min(Xn.get(a)?.index??0,l.length-1)),b=w=>{let S=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let _=Xn.get(a);if(!_){u(S,S.value);return}let z=w.key==="ArrowDown"?y()+1:y()-1;u(S,_.query,Math.max(0,Math.min(l.length-1,z))),Eb(S);return}if(w.key==="Enter"){w.preventDefault();let _=l[y()];s&&_?f(_,S):(m(S.value),p(S));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),p(S)}},k=t.entityId?Kp(e.hass)?.(t.entityId):void 0,$=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${vh(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${Wp(w.domain)}</span>
                  <span class="ent-state">${w.state}</span>
                </span>
              </button>`)}
        </div>`:$}
  </div>`}function Eb(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var jp=120;function Mb(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(_r.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(zr),fromPack:!1}}function qp(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Rb(e){return[{value:"",label:`Starter set (${qp(zr,e)})`},..._r.map(n=>({value:n.name,label:`${n.name} (${qp(n.symbols,e)})`}))]}function Ab(e){return e.length>0?e.length:zr.length}function Yp(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Kr(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function wh(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(We),m=a!==void 0,f=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=Hb(u,c),b=w=>{t(w),a?.(w.startsWith(We)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},k=w=>{if(t(w),!m)return;let S=w.trim();a?.(S.startsWith(We)?e.icons.mdiPath?.(S):void 0)},$=g;if(o&&f==="mdi"){let w=e.icons.mdiNames?.(),S=Fb(w??[],s),_=S.slice(0,jp),z=r.recent.filter(F=>F.startsWith(We));$=h`<div class="sym-browse">
      ${Xp(r,i,f)}
      ...
      ${z.length===0?g:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${z.map(F=>Kr(e,F,F===u,b))}</div>`}
      <div class="sym-grid">${_.map(F=>Kr(e,F,F===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Yp(_.length,S.length,!0,w.length)}</div>`}
    ...
    </div>`}else if(o){let w=r.category(i),S=Mb(w,s,d,c),_=il(S.names,s),z=S.fromPack?_.slice(0,jp):_,F=r.recent.filter(E=>!E.startsWith(We)),R=c.size===0?F:F.filter(E=>c.has(E));$=h`<div class="sym-browse">
      ${m?Xp(r,i,f):g}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${we(E=>r.setQuery(i,E))} />
        <select @change=${we(E=>r.setCategory(i,E))}>
          ${Rb(c).map(E=>h`<option value=${E.value} ?selected=${E.value===w}>${E.label}</option>`)}
        </select>
      </div>
      ${R.length===0?g:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${R.map(E=>Kr(e,E,E===u,b))}</div>`}
      <div class="sym-grid">${z.map(E=>Kr(e,E,E===u,b))}</div>
      ${_.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${Yp(z.length,_.length,s.trim()!=="",Ab(d))}
          </div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${we(k)} @change=${we(w=>{let S=w.trim();S.startsWith(We)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed(w):(c.size===0||c.has(S))&&r.noteUsed(w)})} /></label>
    ...
    ${$}`}function Hb(e,n){let t=e.trim();return t!==""&&!t.startsWith(We)&&n.size>0&&!n.has(t)}function Fb(e,n){let t=n.trim(),i=t.startsWith(We)?t.slice(We.length):t,a=e.map(r=>r.startsWith(We)?r.slice(We.length):r);return il(a,i).map(r=>We+r)}function Xp(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Ib=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Lb={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},_b=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],zb=[["flat","Flat"],["fade","Fade"]],kh=[["auto","Auto"],["all","All"]],Pb=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],$h=[["bars","Bars"],["line","Line"],["area","Area"]],Nb=[["auto","Auto"],["fixed","Fixed range"]],Db=[["lowest","Lowest value"],["zero","Zero"]],Ob=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],Sl=[["uniform","One colour"],["bands","By value"]];function no(e){let n=[Wo,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Q(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Q(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function Il(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Bb(e,n){let t=Qt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Q(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Jp(e,n,t,i){return h`<span class="band-cell">${uo(e,n,t)}${Ca(i)}</span>`}function Vb(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function Gb(e,n,t){let{lo:i,hi:a}=Vb(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
  ...
  </div>`}function io(e,n,t,i,a){let r=Qt({bands:e.bands}),o=i!==void 0&&Number.isFinite(i)?i:void 0,s=o===void 0?void 0:r.find(f=>o<=f.upTo)?.id??"above",l=(f,y)=>b=>{let k=b.bands.find($=>$.id===f);k&&y(k)},d=e.bandAboveColorHex,c={atDefault:Hl(d,pe),title:`Back to ${pe}`,reset:()=>t(f=>{f.bandAboveColorHex=pe})},u=a?.border===!0,p=(f,y,b,k,$)=>{if(!u)return uo(f,y.colorHex,F=>b(F??"#FFFFFF"));let w=a?.fillHex,S=a?.borderHex,_=y.fillColorHex===void 0?void 0:{atDefault:!1,title:"Back to the chart fill colour",reset:()=>k(void 0)},z=y.borderColorHex===void 0?void 0:{atDefault:!1,title:`Back to ${S===void 0?"white":"the chart border colour"}`,reset:()=>$(void 0)};return h`
      ${Jp(`${f} fill`,y.fillColorHex??w??y.colorHex,F=>{F!==void 0&&(b(F),k(w===void 0?void 0:F))},_)}
      ${Jp(`${f} border`,y.borderColorHex??S??Wa,F=>$(F),z)}`},m=(f,y)=>{let b=r[f];return h`<input type="number" class="band-up" step="any" .value=${String(b.upTo)} aria-label=${y}
      title=${`Band ${f+1} runs up to and including this number`}
      data-scrub @pointerdown=${Sa(b.upTo,k=>t(l(b.id,$=>{$.upTo=k})),{...f>0?{min:r[f-1].upTo}:{},...f<r.length-1?{max:r[f+1].upTo}:{}})}
    ...
    <button class="small" @click=${()=>n(o=>{o.bands=[...o.bands,{id:Q(),match:r,colorHex:Ka(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${ye("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??en},"tother"),!1,en)}`}var Kb=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],jb={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Zp(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return V(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var qb=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function Yb(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function le(e,n,t,i){if(i.inline||!Xb())return h`<div class="value-editor">${Eh(e,n,t,i)}</div>`;let a=ho(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=Me(n,me(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${Ch(e,a,r,n,t,i)}
  </div>`}function Ch(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Th}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${va.has(n)?Eh(e,i,a,r):g}
  </div>`}function me(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function ho(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function Xb(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var va=new Set,ga=new WeakMap;function Jb(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Sh(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Th(e){let n=e.currentTarget,t=e.newState==="open",i=ga.get(n);if(i&&(i(),ga.delete(n)),!t){va.delete(n.id)&&Ae(n);return}let a=Jb(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ga.get(n)?.(),ga.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}bl(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ga.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),bl(n,a.getBoundingClientRect()),va.has(n.id)||(va.add(n.id),Ae(n),requestAnimationFrame(()=>{n.isConnected&&bl(n,a.getBoundingClientRect())}))}function bl(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=Zb({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Yn=8,jr=6,Qp=140;function Zb(e,n,t){let i=t.height-e.bottom-jr-Yn,a=e.top-jr-Yn,r=n.height>i&&a>i&&i<Qp,o=Math.max(Qp,r?a:i),s=Math.min(n.height,o),l=Math.max(Yn,Math.min(e.left,t.width-n.width-Yn)),d=r?Math.max(Yn,e.top-jr-s):Math.max(Yn,Math.min(e.bottom+jr,t.height-s-Yn));return{left:l,top:d,maxHeight:o,above:r}}function Eh(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Ib.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=g;switch(a.kind){case"literal":l=i.symbol?wh(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):Re("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=$t(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${$t(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${Re("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=ox(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Ce("Field",a.timeField,qb,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${yh("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Ji(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>ax(e,n,t)}>Start an empty one</button>,
  ...
  </details>`}function ox(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${n.function==="count"?g:Re("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Rh=as,sx=Rh.filter(([e])=>e!=="none");function lx(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Ah(e,n){let t=lx(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return bc(e)?{type:e,...t}:{type:e}}var dx=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Hh(e,n,t,i){let a=n.serviceDataJSON??"",r=xc(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??ux).slice(0,7)}
    ...
    ${t.type==="callService"?Hh(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):g}
    ${t.type==="openPage"?px(e):g}`}var ux="#808080",eh=[0,15,30,60,120];function th(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function px(e){let n=e.config;return Ih(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Ih(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Ce("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?g:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Lh(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Ji(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
  ...
  </section>`}function xx(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function vx(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function wx(e,n){let t=he[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function kx(e,n,t){let i=wx(e,n),a=he[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function $x(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Cx(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${vx(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Qn(e,n=In){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function Sx(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Lt}, so they are averaged into ${Lt} even slots to cover ${a}.`}var eo=new Set;function Tl(e,n,t=In){return eo.has(e)||!t.some(i=>i.minutes===n)}function vl(e,n,t,i,a=In){let r=Tl(e,n,a);return h`<label class="field">${Ve("Span",{atDefault:n===t&&!r,title:`Back to ${Qn(t,a)}`,reset:()=>{eo.delete(e),i(t)}})}
      <select @change=${o=>{let s=o.target.value;s==="custom"?(eo.add(e),Ae(o.target)):(eo.delete(e),i(Number(s)||ir))}}>
        ${a.map(({minutes:o,label:s})=>h`<option value=${String(o)} ?selected=${!r&&o===n}>${s}</option>`)}
        <option value="custom" ?selected=${r}>Custom…</option>
      </select></label>`}function wl(e,n,t=!1){let i=t?qo:ar,a=Math.floor(i/1440),r=t?ji:In,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Ex(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Le(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>ke(p,t,i,{frame:$r(o,c)}),`${a}-${u}-${t}`),l=!ka(o,Gi)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return Se(e,"placement","Position",h`
  ...
  ${l?g:h`<div class="field list-field"><span>Copy</span>
    <div class="chips">
      ...
      <button class="small" ?disabled=${s===void 0||d}
        ...
        @click=${()=>s&&o(fb(s,t,n.kind),"paste")}>Paste position</button>
    </div>
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:g}function Mx(e,n){if(n.kind==="tap")return g;let t=n.payload.id,i=Ke(e.config,t)[0];return Se(e,"tappable","Tap",tv(e,n,`el-${t}`),{color:te.tap,icon:"tap",summary:i?_t(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>mr(a,t))}:{}})}function Rx(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?g:h`
      ...
      ${a}
      </div>`}`}var Ax=[["number","Number"],["entity","Entity"]];function Hx(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Fx(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Ix(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=Hx(n,o),c=s?n.minValue:n.maxValue,u=y=>a(b=>{s?b.minValue=y??0:b.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Ve(l,d==="number"?mn(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Ax.map(([y,b])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a(k=>Fx(k,o,y))}}>${b}</button>`)}
      </span>
    </div>`,f=s?n.minSource:n.maxSource;return d==="number"||f===void 0?h`<div class="field gauge-end">${m}${co(c,u,{ariaLabel:l})}</div>`:h`<div class="field gauge-end">${m}${le(e,f,y=>a(b=>{s?b.minSource=y:b.maxSource=y},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
    ...
    <div class="fgroup">
    ${ie("Colour",a,Sl,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=no(qe(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
      ...
      ${io({bands:n.bands??[],bandAboveColorHex:n.bandAboveColorHex??pe},n.colorSlot.baseColorHex,o,d.length===1?d[0]:void 0)}`:g}
    </div>
    <div class="fgroup">
    ${ie("Highlight",r,Ob,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?g:h`
      <div class="grid2">
    ...
    </div>`}var xa=new Map,ba=new Map,Ot=new Map,Yr=new Map,kl=4,$l=40,_x=[["layer","Layer"],["pick","Pick"],["bands","By value"]],zx=[["plain","Plain"],["rich","Rich"]],Px={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function _l(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?g:h`${Be("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:g}`}function Nx(e){return e.countdown===!0?"countdown":ot(e)?"rich":"plain"}function Dx(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Ox(e,n){let t=Fn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Oe(e.kind.value,40)||"template"}:{kind:"value",label:Ta(e,n)}}function Oh(e,n,t){let i=Fn(e.value),a=i===void 0?Oe(Ta(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Oe(i,24)}"`;return`Part ${n+1}: ${a}`}function Bx(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Oh(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function El(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Vx(e,n){if(El(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Qt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??pe],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function oh(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${fo(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Gx={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Ux(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${fo(e.moved.map(n=>Gx[n]))} moved into Look.`}function Wx(e,n,t,i,a){let r=n.payload,o=r.id,s=Nx(r),l=(r.parts?.length??0)>0,d=rs(e.config,r.value),c=Ot.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?ba.get(o):void 0,m=(b,k)=>{let $=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),w=Vr(structuredClone(r),e.config.values);if(ba.delete(o),!w.ok){Ot.set(o,{text:oh(w.blocked),rich:!0,warn:!0}),Ae(k);return}Ot.set(o,{text:Ux(w.joined?{joined:!0,template:$}:w),rich:!1}),i(S=>{Vr(S,e.config.values),b==="countdown"&&(S.countdown=!0)})},f=(b,k)=>{if(ba.delete(o),s==="rich"){let $=b==="countdown"?"countdown":"plain",w=r.parts??[];if(w.length<2){m($,k);return}let S=pl(w,e.config.values);S.ok?(Ot.delete(o),ba.set(o,$)):Ot.set(o,{text:oh(S.blocked),rich:!0,warn:!0}),Ae(k);return}if(b==="rich"){let $=r.parts?.[0]?.id??Q();xa.set(o,$),Ot.delete(o),i(w=>{delete w.countdown,Dp(w,$)});return}Ot.delete(o),i($=>{if(b==="countdown"){$.countdown=!0;return}($.parts?.length??0)>0&&Vr($,e.config.values),delete $.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${ie("Type",s==="rich"?"rich":"plain",zx,f,{titles:Px})}
    ...
    ${s==="rich"?Kx(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${He(d,me(e))}</button>. It stays in the chart's group and moves with it.</div>`:g}`}`}function Kx(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=me(e),d=Math.max(0,o.findIndex(M=>M.id===xa.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Le(e.config,t,n).size??r.fontSize,f=(M,W)=>{Ot.delete(s),i(A=>{M(A),rc(A)},W)},y=(M,W)=>f(A=>{let Y=A.parts?.find(x=>x.id===c.id);Y&&M(Y)},W?`part-${c.id}-${W}`:void 0),b=(M,W)=>{xa.set(s,M),Ot.delete(s),Ae(W)},k=(M,W)=>{let A=Q();xa.set(s,A),f(Y=>{(Y.parts??=[]).push({id:A,value:M})}),Sh(W,ho(`${a}-part-${A}`),!0)},$=M=>f(W=>{W.parts&&$a(W.parts,d,M)}),w=()=>{let M=o[d+1]??o[d-1];M&&xa.set(s,M.id),f(W=>{W.parts=(W.parts??[]).filter(A=>A.id!==c.id)})},S=o.map((M,W)=>{let A=Ox(M.value,l),Y=M.id===c.id,x=El(M),C=A.kind==="value"?e.resolve(M.value):void 0,H=M.fontWeight===void 0?void 0:Ti.find(([O])=>O===M.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${Y?"true":"false"} class="part-chip ${A.kind} ${Y?"on":""}"
      aria-label=${Oh(M,W,l)} @click=${O=>b(M.id,O.currentTarget)}>
      <span class="part-dot" style=${`background:${Vx(M,p)}`}
        title=${x==="bands"?"By value, with its own bands":x==="pick"?"Its own colour":"The layer colour"}></span>
      ${A.kind==="text"?h`<span class="part-txt">${A.label===""?h`<span class="part-empty">empty</span>`:Dx(A.label).map(O=>O.space?h`<span class="part-sp">${"\xB7".repeat(O.text.length)}</span>`:O.text)}</span>`:h`<span class="part-txt">${A.label}</span>`}
    ...
    </button>`}),_=r.rules.some(M=>M.partId===c.id),z=c.value.kind.kind==="literal",F=El(c),R=c.fontSize!==void 0,E=Ti.find(([M])=>M===r.fontWeight)?.[1]??r.fontWeight,P=M=>{M>=kl&&M<=$l&&y(W=>{W.fontSize=M},"size")},j=F==="bands"?qe(e.resolve(c.value)??""):[],N={layer:"Use the layer colour",...z&&F!=="bands"?{bands:"By value needs a live value"}:{}},ee=(M,W)=>y(A=>{let Y={bands:A.bands??[],bandAboveColorHex:A.bandAboveColorHex??pe};M(Y),Y.bands.length>0?A.bands=Y.bands:delete A.bands,Y.bandAboveColorHex!==pe?A.bandAboveColorHex=Y.bandAboveColorHex:delete A.bandAboveColorHex},W);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      ...
      ${ie("Colour",F,_x,M=>y(W=>{if(M==="layer"){delete W.colorHex,delete W.coloring;return}if(M==="pick"){delete W.coloring,W.colorHex=Hl(p,"#FFFFFF")?"#64D2FF":p;return}delete W.colorHex,W.coloring="bands",(W.bands?.length??0)===0&&(W.bands=no(qe(e.resolve(W.value)??"")))}),{def:"layer",titles:N,...z&&F!=="bands"?{disabled:{bands:!0}}:{}})}
      ${F==="pick"?ye("Part colour",c.colorHex,M=>y(W=>{W.colorHex=M??p},"color")):g}
      ${F==="bands"?h`
        ${io({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??pe},c.colorHex??p,ee,j.length===1?j[0]:void 0)}
      ...
      <div class="field seg-field">${Ve("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${E})`,reset:()=>y(M=>{delete M.fontWeight})})}
        ${to("Weight",c.fontWeight,Ti,M=>y(W=>{W.fontWeight=M}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Ve("Font size",R?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(M=>{delete M.fontSize})}:void 0,lo(c.fontSize??m,P,{step:1,min:kl,max:$l}))}
        ${co(c.fontSize,M=>{M===void 0?y(W=>{delete W.fontSize},"size"):P(M)},{step:1,min:kl,max:$l,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:R?"Part font size":`Part font size, ${m} pt from the layer`,...R?{}:{lead:U("link")}})}
      </label>
    </div>
  </div>`}function Bh(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(x=>x.payload.id===a),o=`el-${a}`,s=(x,C)=>e.update(H=>x(H.elements[r]),C?`${o}-${C}`:void 0),l=Le(e.config,t,n),d=l.frame,c=(x,C)=>e.update(H=>ke(H,t,a,{frame:$r(d,x)}),`${o}-${C}-${t}`),u=Ee(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=x=>u[x],f=!1,y=x=>Jn(n)===void 0?g:ye(x,Jn(n),C=>s(H=>{Jn(H)!==void 0&&(H.payload.colorSlot.baseColorHex=C??"#FFFFFF")},"color"),!1,p),b,k={},$=[],w,S;switch(n.kind){case"text":{let x=(C,H)=>s(O=>C(O.payload),H);w=Wx(e,n,t,x,o),f=!n.payload.countdown&&!ot(n.payload),S=h`
        <div class="fgroup">
        ${hn(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${ie("Weight",n.payload.fontWeight,Ti,C=>s(H=>{H.payload.fontWeight=C}),{def:u.fontWeight})}
        ${wb({label:"Align",value:n.payload.alignment??"center",options:mx,def:"center",set:C=>s(H=>{let O=H.payload;C==="center"?delete O.alignment:O.alignment=C})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:fx,def:"1",set:C=>s(H=>{let O=H.payload;C==="2"?O.lineLimit=2:delete O.lineLimit})})}
        ...
        ${f?Lx(e,n.payload,x,y("Main colour")):g}`;break}case"icon":w=h`
        ...
        ${H?h`
            ${le(e,x.total??Zp(x),O=>C(K=>{K.total=O},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${er} dots are drawn.</div>`:h`<div class="fgroup">${Ix(e,x,{min:u.minValue,max:u.maxValue},o,C)}</div>`}`,f=!0,S=h`
        <div class="grid2">
          ${ie("Style",x.style,Kb,O=>C(K=>{O==="dots"&&K.total===void 0&&(K.total=Zp(K)),O!=="dots"&&delete K.total,K.style=O}),{titles:jb,def:u.style})}
          ${H?g:hn(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="fgroup">
        ${ye(H?"Empty dot colour":"Track colour",x.trackColorHex,O=>C(K=>{K.trackColorHex=O??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${ie("Colour",x.coloring,Sl,O=>C(K=>{K.coloring=O,O==="bands"&&K.bands.length===0&&(K.bands=no([K.minValue,K.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${io(x,x.colorSlot.baseColorHex,C,qe(e.resolve(x.value)??"")[0])}`:g}
        </div>
        ${H?g:h`
          <div class="fgroup">
          <div class="grid2">
            ${ae("Threshold",x.thresholdValue,O=>C(K=>{O===void 0?delete K.thresholdValue:K.thresholdValue=O},"thr"),{optional:!0,def:null})}
            ${x.thresholdValue===void 0?g:ye("Threshold colour",x.thresholdColorHex,O=>C(K=>{K.thresholdColorHex=O??di},"thrcol"),!1,di)}
          </div>
          ...
          </div>`}`;break}case"chart":{let x=n.payload,C=(T,I)=>s(de=>T(de.payload),I),H=u.historyMinutes,O=u.historyPoints,K=x.historyMinutes>0,J=K&&x.source==="statistics",re=K&&!J,$e=K?J?"statistics":"history":"value",St=J?ji:In,Vt=_n(x)??zn(x),Pe=x.value.kind.kind==="entityState",be=Vt===void 0?void 0:e.historySeries(Vt),Ge=K&&Pe?be??"":e.resolve(x.value)??"",Je=x.historyPoints<1,zm=re&&Pe&&Vt!==void 0?e.historyReadings?.(Vt):void 0,td=Sx(Je,zm,Qn(x.historyMinutes)),nd=Tl(a,x.historyMinutes,St),xo=K&&Pe?Is(Ge):{values:qe(Ge),holes:[]},ii=xo.values,id=T=>x.limit>0&&T.length>x.limit?x.takeFromEnd?T.slice(T.length-x.limit):T.slice(0,x.limit):T,Pm=id(ii),Tt=Ls(Pm,rt(x.smoothing),xo.holes.length>0?id(xo.holes):[]),Nm=!K&&Pe&&ii.length===1,vo=e.config.elements.filter(T=>T.kind==="chart"&&T.payload.id!==a),ad=me(e),Ra=x.scaleFrom!==void 0&&vo.some(T=>T.payload.id===x.scaleFrom);w=h`
        ${le(e,x.value,T=>C(I=>{I.value=T},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        <div class="fgroup">
        ${ie("Draw",$e,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],T=>C(I=>{if(T==="value"){I.historyMinutes=0;return}I.source=T==="statistics"?"statistics":"history";let de=I.historyMinutes||ir;I.historyMinutes=T==="statistics"?Math.min(de,qo):Math.min(de,ar)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${J?h`
            ...
            <div class="grid2">
              ${vl(a,x.historyMinutes,H,T=>C(I=>{I.historyMinutes=T}),ji)}
              ${ie("Per",x.statPeriod,Za,T=>C(I=>{I.statPeriod=T}),{def:Bi})}
            </div>
            ${nd?wl(x.historyMinutes,T=>C(I=>{I.historyMinutes=T},"span"),!0):g}
            ${ie("Read",x.statType,Vo,T=>C(I=>{I.statType=T}),{def:Vi})}
        ...
        ${re?h`
            ${Pe?g:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${vl(a,x.historyMinutes,H,T=>C(I=>{I.historyMinutes=T}))}
                ...
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Points">
                    ...
                    <button type="button" role="radio" aria-checked=${Je?"true":"false"} class=${Je?"on":""}
                      ...
                      @click=${()=>{Je||C(T=>{T.historyPoints=Yo})}}>Every one</button>
                  </div>
                  ${Je?g:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      data-scrub @pointerdown=${Sa(x.historyPoints,T=>C(I=>{I.historyPoints=Math.round(T)},"hpoints"),{step:1,min:rr,max:Lt})}
                      @input=${we(T=>{let I=Number(T);T.trim()!==""&&Number.isFinite(I)&&I>=1&&C(de=>{de.historyPoints=Math.round(I)},"hpoints")})} />
        ...
        ${ii.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${xx(Tt)}</span>${ii.length===Tt.length?h` · ${Tt.length} ${Tt.length===1?"value":"values"}`:h` · ${Tt.length} of ${ii.length}`}</span></div>`:g}
        ${Nm?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        ${Ce("Smooth data",rt(x.smoothing)??"off",Pb,T=>C(I=>{let de=rt(T);de===void 0?delete I.smoothing:I.smoothing=de}),{def:rt(u.smoothing)??"off"})}
        ${Dt(e)}
        ...
        ${x.style==="bars"?h`
          <div class="fgroup">
          <div class="grid2">
            ${ae("Corner radius",Yt(x.barRadius),T=>C(I=>{let de=Math.max(0,T??li);de===li?delete I.barRadius:I.barRadius=de},"barradius"),{step:.5,min:0,def:Yt(u.barRadius),unit:"pt"})}
          </div>
          ...
          ${x.barBorderWidth===void 0?g:h`
            ${ae("Border width",x.barBorderWidth,T=>C(I=>{I.barBorderWidth=Math.min(Math.max(T??1,0),tr)},"barborderw"),{step:.5,min:0,max:tr,def:1,unit:"pt"})}
          ...
          <div class="fgroup">
          ${ie("Curve",x.curve??"straight",_b,T=>C(I=>{T==="straight"?delete I.curve:I.curve=T}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Dt(e)}
          </div>
          ${x.style==="area"?h`
            <div class="fgroup">
            ${ie("Fill",qt(x.fillStyle),zb,T=>C(I=>{T==="flat"?delete I.fillStyle:I.fillStyle=T}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:qt(u.fillStyle)})}
            ${Gt.fill===void 0?g:yl(Gt.fill,x.fillColorHex,T=>C(I=>{T===void 0?delete I.fillColorHex:I.fillColorHex=T},"fillcol"))}
            ${Dt(e)}
            </div>`:g}`}
        <div class="fgroup">
        <div class="grid2">
          ${ie("Scale",x.scale,Nb,T=>C(I=>{I.scale=T}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${ie("Baseline",x.baseline,Db,T=>C(I=>{I.baseline=T}),{def:u.baseline})}
        </div>
        ${vo.length===0?g:Ce("Same scale as",Ra?x.scaleFrom:"",[["","Its own"],...vo.map(T=>[T.payload.id,He(T,ad)])],T=>C(I=>{T?I.scaleFrom=T:delete I.scaleFrom}),{def:""})}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let T;e.update(I=>{T=Vc(I,a,de=>He(de,ad))}),T&&e.selectLayer(T)}}>${U("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        <div class="fgroup">
        ${ie("Colour",x.coloring,Sl,T=>C(I=>{I.coloring=T,T==="bands"&&I.bands.length===0&&(I.bands=no(Tt))}),{def:u.coloring})}
        ...
        ${x.coloring==="bands"?h`
          ...
          ${io(x,x.colorSlot.baseColorHex,C,void 0,x.style==="bars"?{...x.fillColorHex===void 0?{}:{fillHex:x.fillColorHex},...x.barBorderColorHex===void 0?{}:{borderHex:x.barBorderColorHex},border:x.barBorderWidth!==void 0}:void 0)}
        ...
        </div>`;let wo=(T,I)=>Ne(T,a).filter(de=>de.payload.chartAnchor?.at===I&&de.payload.chartAnchor.place==="through"),rd=(T,I)=>Ne(T,a).some(de=>de.payload.chartAnchor?.at===I),od={threshold:T=>wo(T,"threshold"),now:T=>wo(T,"now"),zero:T=>wo(T,"zero"),times:T=>on(T,a),dots:T=>Dn(T,a),grid:T=>On(T,a)},Om={threshold:T=>{rd(T,"threshold")?En(T,a,"threshold"):Rc(T,a,x.thresholdValue??Il(Tt))},now:T=>{rd(T,"now")?En(T,a,"now"):Ac(T,a,!0)},zero:T=>{hs(T,a)},times:T=>{Nn(T,a)},dots:T=>{us(T,a)},grid:T=>{ps(T,a)}},ai={};Ln(x)||(ai.times=Je&&re?"Clock times need evenly spaced readings. Set Points to Average.":"Clock times need a recorded span. Set Draw to Recorded history."),x.style==="bars"&&(ai.dots="Dots need a line or area chart. Set Style to Line or Area.");let ko=T=>od[T](e.config).length>0;k={};for(let[T,I]of Object.entries(ai))k[`draw:${T}`]=I;let Bm=([T,I])=>{let de=ko(T),Aa=de?void 0:ai[T],sd=`draw:${T}`;return h`<div class="xr-row" role="row">
          ...
          <span role="cell"><button type="button" class="xtog ${de?"on":""}" role="switch" aria-checked=${de?"true":"false"}
            ...
            @click=${()=>e.update($o=>{if(de)for(let Vm of od[T]($o))fe($o,Vm.payload.id);else Om[T]($o)})}>${de?h`<span aria-hidden="true">✓</span>`:U("plus")}</button></span>
          <span role="cell"></span>
        </div>`};b=h`
        ...
        ${Wr.filter(([T])=>ai[T]!==void 0&&!ko(T)).map(([T])=>h`<div class="hint keep">${ai[T]}</div>`)}
        ${ko("zero")&&!Dm?h`<div class="hint warn">These readings never cross zero, so the zero line is not drawn.</div>`:g}
        ${Dt(e)}`;break}case"timeline":{let x=n.payload,C=(be,Ge)=>s(Je=>be(Je.payload),Ge),H=u.historyMinutes,O=x.value.kind.kind==="entityState",K=gt(x),J=K===void 0?void 0:e.historySeries(K),re=st(x)*60,$e=aa(J??"",an),St=Tl(a,x.historyMinutes),Vt=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,Pe=Ub($e,re,Vt===void 0?void 0:e.hass.states[Vt]?.state,Vt?.split(".")[0]);w=h`
        ${le(e,x.value,be=>C(Ge=>{Ge.value=be},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        <div class="fgroup">
        ${vl(a,x.historyMinutes,H,be=>C(Ge=>{Ge.historyMinutes=be}))}
        ${St?wl(x.historyMinutes,be=>C(Ge=>{Ge.historyMinutes=be},"span")):g}
        ...
        ${$e.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Cx($e,re)}</span></span></div>`:g}
        ${$x($e)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${Wb(x,C,Pe,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ae("Gap",x.gap,be=>C(Ge=>{Ge.gap=Math.min(or,Math.max(0,be??0))},"tgap"),{step:.5,min:0,max:or,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",x.cornerRadius,be=>C(Ge=>{Ge.cornerRadius=Math.max(0,be??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
...
`;break}case"shape":w=h`<div class="grid2">
        ...
        ${n.payload.kind==="line"?kx(t,d,c):g}`,S=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,x=>s(C=>{C.payload.thickness=x??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        <div class="fgroup">
        ${ye("Border colour",n.payload.borderColorHex,x=>s(C=>{x===void 0?delete C.payload.borderColorHex:C.payload.borderColorHex=x},"border"),!0,null)}
        ...
        </div>`;break;case"image":{let x=n.payload,C=(J,re)=>s($e=>J($e.payload),re),H=x.entity.entityId?e.hass.states[x.entity.entityId]?.attributes?.entity_picture:void 0,O=typeof H=="string"?H:void 0,K=O!==void 0&&!O.startsWith("/");w=h`
        ...
        ${Zn("Zoom",x.zoom,J=>C(re=>{re.zoom=J},"zoom"),{min:Xs,max:4,step:.05,def:1,format:J=>`${J.toFixed(2)}x`,unit:"x"})}
        ...
        <div class=${x.contentMode==="fit"&&x.zoom===1?"hint keep":"hint"}>${bx(x)}</div>
        </div>
        ${ae("Corner radius",x.cornerRadius,J=>C(re=>{re.cornerRadius=Math.max(0,J??ci)},"imgradius"),{step:1,min:0,def:ci,unit:"pt"})}`;break}case"tap":{w=h`
        ${zl(e,n.payload,(x,C)=>s(H=>x(H.payload),C),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let x=n.payload,C=(J,re)=>s($e=>J($e.payload),re),H=e.config.elements.find(J=>J.payload.id===x.chart),O=H?.kind==="chart"||H?.kind==="timeline"?H:void 0,K=O?.kind==="timeline"?"timeline":"chart";w=h`
        ...
        <div class="hint">The clock times of that ${K}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,S=Rx(x,C,u,"ct",h`
        ...
        <div class="hint">The time that picture was fetched, not the time now: a picture that stops updating
          ...
          has been fetched once. Move and size it like any other layer: the chip grows to fill the frame.</div>`;break}case"chartDots":{let x=n.payload,C=(re,$e)=>s(St=>re(St.payload),$e),H=e.config.elements.find(re=>re.payload.id===x.chart),O=H?.kind==="chart"?H:void 0,K=O===void 0?void 0:Le(e.config,t,O).size??O.payload.lineWidth,J=K===void 0?void 0:Math.round(K*18)/10;w=h`
        ${sh(e,O)}
        ...
        ${Dt(e)}`,S=h`
        ${ie("Dots",x.dots,kh,re=>C($e=>{$e.dots=re}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",x.size??J,re=>C($e=>{let St=pt(re);St===void 0||St===J?delete $e.size:$e.size=St},"dotsize"),{step:.5,min:1,max:12,...J===void 0?{}:{def:J},unit:"pt"})}
          ${Al("Dot colour",x.colorHex,"Series colour",re=>C($e=>{re===void 0?delete $e.colorHex:$e.colorHex=re},"dotcol"))}
        </div>
        ...
        <div class="grid2">
          ...
          ${ae("Thickness",x.thickness,K=>C(J=>{J.thickness=Hn(K??Jt)},"thick"),{step:.25,min:Xa,max:Ja,def:Jt,unit:"pt"})}
        </div>
        ${ye("Colour",x.colorHex,K=>C(J=>{J.colorHex=K??Ft},"gridcol"),!1,Ft)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let _=f||Jn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&ot(n.payload)?"Layer colour":"Colour"),z=gs(e.config,n),F=z?{kind:{kind:"entityState",...z}}:void 0,R=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,E=qx[n.kind],P=Yx[n.kind],j=xl(n.payload,u,E),N=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,ee=e.config.perFamily[t]?.placements[a]?.size!==void 0,M=xl(n.payload,u,P)||N!==void 0&&l.size!==void 0&&l.size!==u[N],W=rn(e.config,a),A=(x,C)=>()=>s(H=>qr(H.payload,u,x),C),Y=h`<section class="sec name-sec" data-open="true" style=${`--c:${te.place}`}>
    <div class="sec-h pinned">
      ...
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${Uh(n,me(e))}
        @input=${we(x=>s(C=>{let H=iv(x);H===void 0?delete C.payload.name:C.payload.name=H},"name"))} />
    </div>
  </section>`;return h`
    ${Y}
    ${Se(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?g:Nh(e,n,o)}${w}`,{color:te.content,icon:"content",summary:Ll(e,n),...j?{reset:()=>s(x=>{qr(x.payload,u,E),x.kind==="text"&&ma(x.payload.rules)},"reset-content")}:{}})}
    ${S===void 0&&_===void 0?g:Se(e,"look",n.kind==="image"?"Picture":"Look",h`${S??g}${_??g}`,{color:te.look,icon:n.kind==="image"?"image":"look",...ao(n)?{summary:ao(n)}:{},...M?{reset:()=>e.update(x=>{qr(x.elements[r].payload,u,P),ee&&ke(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Extras",Qx(e,n,b,k,$),{color:te.numbers,icon:"text",summary:Zx(e,n),...W.length>0||Ne(e.config,a).length>0||on(e.config,a).length>0||Dn(e.config,a).length>0||On(e.config,a).length>0||xl(n.payload,u,lh)?{reset:()=>e.update(x=>{for(let H of rn(x,a))fe(x,H.payload.id);for(let H of Ne(x,a))fe(x,H.payload.id);for(let H of on(x,a))fe(x,H.payload.id);for(let H of Dn(x,a))fe(x,H.payload.id);for(let H of On(x,a))fe(x,H.payload.id);let C=x.elements.find(H=>H.payload.id===a);C&&qr(C.payload,u,lh)})}:{}}):g}
    ${n.kind==="timeline"||n.kind==="image"?jx(e,n):g}
    ${Se(e,"states","States",Zh(e,n.payload.rules,n.kind,x=>x.elements.find(C=>C.payload.id===a)?.payload.rules,`rules-${a}`,F,R),{color:te.states,icon:"states",summary:ua(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ${i.placement===!1?g:Ex(e,n,t)}
    ${i.tap===!1?g:Mx(e,n)}`}function jx(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?on(e.config,t):ls(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);if(!m)return;let f=m.payload.frame;m.payload.frame={...Le(p,o,m).frame},i?Nn(p,t):cs(p,t,he[o==="inline"?"rectangular":o]),m.payload.frame=f}),l=a.length>0,d=a.map(p=>({el:p,lead:U("clock"),title:r,kind:i?"Times":"Timestamp"})),c=i?"timeline:times":"image:time",u=h`
    ${Gh(i?"timeline":"image")}
    ...
    ${l?h`
      ...
      <div class="hint">Click the row to open its main settings here. More settings selects that layer. The ×
        deletes it, and Undo brings it back.</div>`:g}`;return Se(e,"numbers","Extras",u,{color:te.numbers,icon:"clock",summary:l?`${r} layer`:"None yet",...l?{reset:()=>e.update(p=>{for(let m of a)fe(p,m.payload.id)})}:{}})}var qx={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[],chartDots:[],chartGrid:[],imageTime:[]},Yx={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","barBorderWidth","barBorderColorHex","bandAboveFillColorHex","bandAboveBorderColorHex","barBorderOpenBase","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["dots","size","colorHex"],chartGrid:["lines","colorHex","thickness"],imageTime:[]};function sh(e,n){return h`<div class="field readout"><span>Chart</span><span class="readout-v">${n?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(n.payload.id)}>${He(n,me(e))}</button>`:"None"}</span></div>`}var lh=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function zl(e,n,t,i){let a=n.action;return h`
    ${Ce("Tap action",a.type,sx,r=>t(o=>{o.action=Ah(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?$t(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):g}
    ${a.type==="callService"?Hh(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):g}
    ${a.type==="openPage"?Ih(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):g}`}var Xx=24;function Jx(e,n){let t=[],i=1/0;for(let r of se){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Oc(e.config,n,r);o&&(t.push(`${ne(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return g;let a=i<Xx;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:g}`}function Zx(e,n){let t=n.payload,i=rn(e.config,t.id),a=Ne(e.config,t.id),r=on(e.config,t.id),o=Dn(e.config,t.id),s=On(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(mt.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(ft.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function Qx(e,n,t,i={},a=[]){let r=n.payload.id,o=me(e),s=rn(e.config,r),l=on(e.config,r),d=Dn(e.config,r),c=On(e.config,r),u=Ne(e.config,r),p={};for(let[R]of mt){let E=e.resolve({kind:{kind:"chartStat",layer:r,stat:R}});E!==void 0&&E.trim()!==""&&(p[R]=E)}let m=a.filter(R=>Number.isFinite(R)),f=n.payload.nowIndex===void 0?NaN:Number(e.resolve(n.payload.nowIndex)),y=Number.isFinite(f)&&a.length>0?Math.min(a.length-1,Math.max(0,Math.round(f))):void 0,b=y===void 0||!Number.isFinite(a[y])||m.length===0?void 0:Ki(a[y],Math.max(...m)-Math.min(...m)),k={values:a,texts:p,...y===void 0?{}:{now:y},...n.payload.thresholdValue===void 0?{}:{threshold:n.payload.thresholdValue}},$=(R,E)=>rn(R,r).filter(P=>P.payload.value.kind.kind==="chartStat"&&P.payload.value.kind.stat===E),w=(R,E)=>Ne(R,r).filter(P=>P.payload.chartAnchor?.at===E&&P.payload.chartAnchor.place!=="through"),S=(R,E,P,j,N,ee,M)=>h`
    <button type="button" class="xtog ${E>0?"on":""}" role="switch" aria-checked=${E>0?"true":"false"}
      ...
      @click=${()=>e.update(W=>{if(E>0)for(let A of M(W))fe(W,A.payload.id);else ee(W)})}>${E>0?h`<span aria-hidden="true">✓</span>`:U("plus")}</button>`,_=h`<div class="xreadings" role="table" aria-label="Readings" @pointerover=${Ei} @focusin=${Ei}>
    <div class="xr-row xr-head" role="row">
    ...
    ${Bp.map(R=>{let E=R.stat!==void 0?p[R.stat]:b,P=R.stat===void 0?"":(mt.find(([N])=>N===R.stat)?.[1]??R.label).toLowerCase(),j=R.marker==="now"?"the reading at now":`the ${(ft.find(([N])=>N===R.marker)?.[1]??R.label).toLowerCase()}`;return h`<div class="xr-row" role="row">
        <span role="cell"><span class="xr-name">${R.label}</span></span>
        <span role="cell"><span class="xr-v nums">${E??""}</span></span>
        <span role="cell">${R.stat===void 0?g:S(`number:${R.stat}`,$(e.config,R.stat).length,`Print the ${P} as a number`,`Remove the ${P} number`,`${R.label} number`,N=>{Sc(N,r,R.stat)},N=>$(N,R.stat))}</span>
        <span role="cell">${R.marker===void 0?g:S(`marker:${R.marker}`,w(e.config,R.marker).length,`Put a marker over ${j}`,`Remove the marker over ${j}`,`${R.label} marker`,N=>{ss(N,r,R.marker)},N=>w(N,R.marker))}</span>
      </div>`})}
  </div>`,z=[...s.map(R=>({el:R,lead:e.resolve(R.payload.value)??"--",title:He(R,o),kind:"Number"})),...u.map(R=>{let{at:E,place:P}=R.payload.chartAnchor,j=ft.find(([ee])=>ee===E)?.[1]??"Reading";if(P==="through")return{el:R,lead:E==="now"?"\u2502":"\u2500",title:E==="zero"?"Zero":j,kind:"Line"};let N=R.kind==="text"?e.resolve(R.payload.value)??"\u25CF":R.kind==="icon"?nv(e.resolve(R.payload.symbol)):"\u25C6";return{el:R,lead:N,title:j,kind:"Marker"}}),...l.map(R=>({el:R,lead:U("clock"),title:"Clock times",kind:"Times"})),...d.map(R=>({el:R,lead:U("chartDots"),title:"Reading dots",kind:"Dots"})),...c.map(R=>({el:R,lead:U("chartGrid"),title:"Grid lines",kind:"Grid"}))],F=z.length;return h`
    <div class="hint keep">Each one you switch on is a layer in this chart's group.</div>
    ${Gh("chart",i,n.payload.style==="bars",k)}
    ${t??g}
    ...
    ${F===0?g:h`
      ...
      ${Nl(e,z,{icon:"close",danger:!0,label:R=>`Delete this ${R}`,run:R=>e.update(E=>fe(E,R))})}
      <div class="hint">Click a row to set its value, colour and size here. More settings selects that layer.
        On the preview, click right on a dot to pick the dots.</div>`}`}var wa,Vh="wrist-assistant-extras-preview",go=(()=>{try{return window.localStorage.getItem(Vh)!=="off"}catch{return!0}})();function dh(e,n){go=e;try{window.localStorage.setItem(Vh,e?"on":"off")}catch{}Ae(n)}function Ei(e){if(!go)return;let n=e.target?.closest?.("[data-extra]")?.getAttribute("data-extra");!n||n===wa||(wa=n,Ae(e.currentTarget))}function Pl(e,n){return go?n:`${ml(e)} ${n}.`}function Gh(e,n={},t=!1,i={}){if(!go)return h`<button class="link xprev-show" @click=${l=>dh(!0,l.currentTarget)}>
      ${U("show")}<span>Show preview</span></button>`;let a=e==="timeline"?"timeline:times":e==="image"?"image:time":void 0,r=wa!==void 0&&hl(wa)===e?wa:a,o=r===void 0?void 0:n[r],s=e==="image"?"picture":e;return h`<div class="xprev">
    <span class="well">${Vp(e,r,t,i)}</span>
    <span class="xprev-t">
      <b>${r===void 0?"Preview":Gp(r)}</b>
    ...
    <button class="icon xprev-hide" title="Hide the preview" aria-label="Hide the preview"
      @click=${l=>dh(!1,l.currentTarget)}>${U("hide")}</button>
  </div>`}function Nl(e,n,t){return h`<div class="chart-numbers">${Hp(n,a=>a.el.payload.id,({el:a,lead:r,title:o,kind:s})=>{let l=a.payload.id,d=s.toLowerCase();return h`
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function ev(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(f=>f.payload.id===t);m&&c(m)},`${i}-${u}`),o=Ee(n.kind).payload,s=Jn(n),l=s===void 0?g:ye("Colour",s,c=>r(u=>{Jn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ${c.kind==="chartStat"?Ce("Number",c.stat,[...mt],u=>r(p=>{p.kind==="text"&&p.payload.value.kind.kind==="chartStat"&&(p.payload.value={...p.payload.value,kind:{...p.payload.value.kind,stat:u}})},"stat")):d||ot(n.payload)?g:le(e,n.payload.value,u=>r(p=>{p.kind==="text"&&(p.payload.value=u)},"value"),{showResolved:!0,label:n.payload.countdown?"Until":"Text",key:`${i}-value`})}
        ${d&&d.place!=="through"?ch(e,t,d,r):g}
        <div class="grid2">
          ${hn(e,n,a,"Font size",{step:1,min:4,def:o.fontSize})}
          ${n.payload.countdown||ot(n.payload)?g:l}
        </div>`}case"icon":return h`
        ${d?ch(e,t,d,r):le(e,n.payload.symbol,c=>r(u=>{u.kind==="icon"&&(u.payload.symbol=c)},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${i}-symbol`,setSymbolPath:c=>r(u=>{u.kind==="icon"&&(c?u.payload.path=c:delete u.payload.path)},"symbol")})}
        <div class="grid2">
        ...
        ${ie("Style",c.style,$h,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
        ...
        ${ie("Dots",c.dots,kh,f=>r(y=>{y.kind==="chartDots"&&(y.payload.dots=f)},"mode"),{def:"auto"})}
        <div class="grid2">
        ...
        ${ye("Colour",c.colorHex,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.colorHex=u??Ft)},"colour"),!1,Ft)}`}default:return h`${l}`}}function ch(e,n,t,i){let a=ft.filter(([r])=>It(r)||r===t.at);return h`
    <div class="grid2">
    ...
    </div>`}function tv(e,n,t){if(n.kind==="tap")return g;let i=n.payload.id,a=Ke(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=ys(e.config,n);return h`
    ${Be("Tappable",a!==void 0,s=>e.update(l=>{s?hr(l,i):mr(l,i)}))}
          ...
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${dr(a.payload.outset)?g:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...is}})}>${U("reset")}</button>`}
            </div>
          </div>
        </div>
        ${Jx(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${_t(o)}</b>.</div>`}`}function uh(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function nv(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function He(e,n){return e.payload.name?e.payload.name:Uh(e,n)}function iv(e){let n=e.trim();return n===""?void 0:n}function Uh(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=ft.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return uh(Me(e.payload.value,n));case"icon":return uh(Me(e.payload.symbol,n));case"gauge":return Me(e.payload.value,n);case"chart":return Me(e.payload.value,n);case"timeline":return Me(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines";case"imageTime":return"Timestamp"}}function Wh(e,n){let t=yt(e.config,n.id),i=me(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Se(e,"content","Group",h`
    ...
    ${Nl(e,t.map(r=>({el:r,lead:U(r.kind),title:He(r,i),kind:dn[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Xi(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:te.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Kh(e,n){if(n==="inline")return av(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ne(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ne(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=mo(e.config,n),r=t.backgroundColorHex?Ie(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ie(t.borderColorHex)} border`:"no border";return h`
    ...
    ${Se(e,"symbol","Symbol",h`
      ${wh(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:te.look,icon:"icon",summary:n.symbol||"None"})}`}function rv(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    <div class="fgroup">
    ...
    ${a==="gauge"&&n.bezelGauge?ov(e,n.bezelGauge,t):g}
    </div>`}function ov(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?le(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):g}`}var e$=se.map(e=>[e,ne(e)]),Dl={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},sv=Object.keys(Dl),ro=["color","text","fontSize","fontWeight","visibility"];function lv(e,n=!1){let t=Zi[e].filter(i=>!n||ro.includes(i));return sv.filter(i=>t.includes(De[i]))}function jh(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Bx(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:g}`}var dv={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Xr(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Oe(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function qh(e){if(!e||_e(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function Me(e,n){return`${Ta(e,n)}${qh(e.format)}`}function Ta(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Oe(t.value,40)}"`:"(empty)";case"entityState":return Xr(t,n);case"entityAttribute":return t.attribute?`${Xr(t,n)} \xB7 ${t.attribute}`:Xr(t,n);case"entityAge":return`age of ${Xr(t,n)}`;case"aggregate":return cv(t.aggregate);case"time":return dv[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Oe(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(mt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Ta(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function cv(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function $a(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function uv(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.cases.map((m,f)=>hv(e,m,f,n,a,u,`${o}-${m.id}`,p))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${Yh(e,n.otherwise,a,m=>u(f=>{f.otherwise&&m(f.otherwise)}),`${o}-otherwise`,p)}
        </div>`:g}
  </div>`}function hv(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(f=>f.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${d?h` <span class="ok">· active now</span>`:g}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>$a(c.cases,t,t-1))}>${U("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>$a(c.cases,t,t+1))}>${U("down")}</button>
    ...
    ${Yh(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${s.pattern&&!fv(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:g}`;break;case"times":c=h`<div class="row-inline">
          ${ph(e,"From",s.value??V("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${ph(e,"To",s.upper??V("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=gv(n.value)?yv(s.options??[],u=>o(p=>{p.comparison.options=cl(u)},"options")):Re("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Ce("Comparison",s.kind,qc.map(u=>[u,$i[u]]),u=>o(p=>{p.comparison=Ms(p.comparison,u)}))}
    ${c}
  </div>`}function fv(e){try{return new RegExp(e),!0}catch{return!1}}function ph(e,n,t,i,a){if(t.kind.kind!=="literal")return le(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Vn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${we(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:g}</label>`}function gv(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function yv(e,n){let t=_p(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${Lp.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function Yh(e,n,t,i,a,r=!1){let o=lv(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:g}
    ${n.map((s,l)=>bv(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Un(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${Dl[s]}</option>`)}
    </select>`}var Xh=["setColor","setBorderColor","setBackgroundColor"];function bv(e,n,t,i,a,r,o,s=!1){let l=!Zi[i].includes(De[n.kind]),d=s&&!l&&!ro.includes(De[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${Jh(e,n,a,o)}
  </div>`}function Jh(e,n,t,i){let a=br(n.kind),r=g;if(a==="value"){let o=n.value??V("");if(Xh.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?ye("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=V(l??"#FFFFFF")},"color")):le(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${uv(e,n,t,i,a,o)}`:xv(e,s.table,n[0],t,i,a,r,o)}function xv(e,n,t,i,a,r,o,s){let l=(A,Y)=>e.update(x=>{let C=a(x);C&&A(C)},Y?`${r}-${Y}`:void 0),d=n.value??hh.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!wp(d)&&vv(e.resolve(d)),p=Zi[i],m=Jr.get(r)??new Set,f=n.columns.length===0&&m.size===0?[vp[i]]:[],y=cp(n.columns,[...m,...f.filter(A=>A!==void 0)],p),b=Yr.get(r),k=t?t.partId:s?.some(A=>A.id===b)?b:void 0,$=s!==void 0&&k!==void 0,w=$?p.filter(A=>ro.includes(A)):p,S=$?y.filter(A=>!ro.includes(A)):[],_=(A,Y)=>{if(!t){A?Yr.set(r,A):Yr.delete(r),Ae(Y);return}l(x=>{let C=x[0];C&&(A?C.partId=A:delete C.partId)})},z=t?e.liveBranch(t):"none",F=t?e.forced.get(t.id)??"live":"live",R=A=>F!=="live"&&(F==="otherwise"?A==="otherwise":F.caseId===A),E=A=>{t&&e.setForced(t.id,R(A)?"live":A==="otherwise"?"otherwise":{caseId:A})},P=A=>{hh.set(r,A),n.rows.length!==0&&l(Y=>yp(Y,A),"lhs")},j=()=>{Yr.delete(r),l(A=>{fp(A,d??V(""),u),k!==void 0&&A[0]&&A[0].partId===void 0&&(A[0].partId=k)})},N=n.rows.map((A,Y)=>fh(e,{key:`${r}-${A.caseId}`,label:xp(A.comparison,x=>Me(x,me(e))),columns:y,changes:A.changes,live:z===A.caseId,forced:R(A.caseId),onForce:()=>E(A.caseId),when:Sv(e,A.comparison,`${r}-${A.caseId}`,(x,C)=>l(H=>{let O=H[0]?.cases.find(K=>K.id===A.caseId)?.when.tests[0];O&&x(O.comparison)},C&&`${A.caseId}-${C}`)),updChanges:(x,C)=>l(H=>{let O=H[0]?.cases.find(K=>K.id===A.caseId);O&&x(O.then)},C&&`${A.caseId}-${C}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${Y===0} @click=${()=>l(x=>sl(x,Y,Y-1))}>${U("up")}</button>
      <button class="icon" title="Move down" ?disabled=${Y===n.rows.length-1} @click=${()=>l(x=>sl(x,Y,Y+1))}>${U("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(x=>gp(x,A.caseId))}>${U("delete")}</button>`})),ee=n.otherwise===void 0?g:fh(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:z==="otherwise",forced:R("otherwise"),onForce:()=>E("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(A,Y)=>l(x=>{let C=x[0]?.otherwise;C&&A(C)},Y),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(A=>ll(A,!1))}>${U("close")}</button>`}),M=Zr.get(r),W=wv.filter(A=>w.includes(A)&&!y.includes(A));return h`
    <div class="states">
      ${le(e,d??V(""),P,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:g}
      ${s===void 0?g:jh(s,k,me(e),_)}
      <div class="states-scroll"><table class="states-table">
          ...
          <tr>
            ...
            ${y.map(A=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${vt[A]} column`}
                @click=${Y=>{Zr.set(r,A),Ae(Y.target)}}>${U("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
        <tbody>
          ${N}
          ${ee}
          ${n.rows.length===0&&n.otherwise===void 0?h`<tr><td class="empty-row" colspan=${y.length+2}>${pp(i)}</td></tr>`:g}
        </tbody>
      </table></div>
      ${S.length===0?g:h`<div class="hint warn">A part ignores ${fo(S.map(A=>vt[A]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${M===void 0?g:h`<div class="hint warn confirm-row">
        Remove the ${vt[M]} column? Its ${mh(n,M)} value${mh(n,M)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${A=>{Zr.delete(r),Jr.get(r)?.delete(M),Ae(A.target),l(Y=>bp(Y,M))}}>Remove</button>
        <button class="small" @click=${A=>{Zr.delete(r),Ae(A.target)}}>Cancel</button>
      </div>`}
      <div class="states-add">
        ...
        <span class="states-add-note">${Dr(i).state}</span>
        ${n.otherwise===void 0?h`<button class="small" title="Add an Otherwise row at the bottom of the table" @click=${()=>l(A=>ll(A,!0))}>${U("plus")}<span>Add otherwise</span></button>
            <span class="states-add-note">${Dr(i).otherwise}</span>`:g}
        ${W.length===0?g:h`<select class="chip-add" title="Add a column to the table" aria-label="Change another setting" @change=${A=>{let Y=A.target,x=Y.value;if(Y.value="",!x)return;let C=Jr.get(r)??new Set;C.add(x),Jr.set(r,C),Ae(Y)}}>
          <option value="" selected>Change another setting…</option>
          ${W.map(A=>h`<option value=${A}>${vt[A]}</option>`)}
        </select>
        <span class="states-add-note">${Dr(i).column}</span>`}
      </div>
      ...
      <div class="states-switch">
        <button class="link" @click=${A=>{Ml.add(r),Ae(A.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function vv(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var wv=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function mh(e,n){let t=0;for(let i of e.rows)Nr(i.changes,n)&&(t+=1);return e.otherwise&&Nr(e.otherwise,n)&&(t+=1),t}function kv(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function fh(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{kv(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${$v(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function $v(e,n,t,i,a){let r=Nr(t,n),o=ho(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${vt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Un(dp[n]))}),Sh(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>De[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=vt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Cv(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Th}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${va.has(o)?h`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Jh(e,r,s,a)}
    ...
    </div>`}function Cv(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=br(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${Ti.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??V(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Xh.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ie(a):Me(i,me(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??g}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Me(i,me(e))}</span>`}function Ie(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Sv(e,n,t,i){let a=Gn(n.kind),r=rl(n.kind),o=(s,l,d,c)=>Ev(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${we(s=>i(l=>{let d=Ms(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${al.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Tv(s)}</option>`)}
    </select>
  ...
  </span>`}function Tv(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return $i[e]}}function Ev(e,n,t,i,a,r,o){let s=ho(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${Ch(e,s,o,n,t,l)}
  </span>`}var Ea=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:fs,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function nm(e){return Ea.find(n=>n.kind===e)??Ea[0]}var Qh="#FF9F0A",yo="#8E8E93",Mv=["#FF453A","#FFD60A","#34C759"],im=["#0A84FF","#34C759","#FF9F0A"];function Rv(e){return e?.attributes?.device_class==="battery"?Mv:im}var Av={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Hv(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Av[Ol(e)]??{off:"circle",on:"circle.fill"}}function Fv(e){switch(Ol(e)){case"lock":return{kind:"equals",value:V("locked")};case"cover":case"valve":return{kind:"equals",value:V("open")};case"media_player":return{kind:"equals",value:V("playing")};default:return{kind:"isOn"}}}function Ol(e){return e.domain||e.entityId.split(".")[0]||""}function yn(e){return{...e,domain:Ol(e)}}function Iv(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Mi(e){return Math.round(e*1e4)/1e4}function ti(e,n,t){return Math.min(t,Math.max(n,e))}function Bl(e,n,t){let i=ze[e],a=ti(Mi(n/i.width),0,1),r=ti(Mi(t/i.height),0,1);return{x:Mi((1-a)/2),y:Mi((1-r)/2),width:a,height:r,rotationDegrees:0}}function Lv(e){let n=ze[e],t=ti(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:Bl(e,t*1.3,t*1.3),size:t}}function _v(e){let n=ze[e],t=ti(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:Bl(e,n.width*.88,t*1.7),size:t}}function zv(e){let n=ze[e],t=Math.min(n.width,n.height)*.9;return{frame:Bl(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function am(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Pv(e){let n=ze[e],t=ti(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Mi(t/n.height),rotationDegrees:0}}}function Nv(e){let n=ze[e],t=ti(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Mi(ti(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Dv(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Ov(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function fn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Ov(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Pt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function gn(e){return Ee(e)}function Vl(e,n){let t={kind:{kind:"entityState",...yn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function em(e){let n=Un("setIcon");return n.value=V(e),n}function ei(e){let n=Un("setColor");return n.value=V(e),n}function Bv(e,n){let t=Qi(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...yn(e)}},a.comparison=Fv(e);let r=n.on!==n.off;return i.then=r?[em(n.on),ei(Qh)]:[ei(Qh)],t.otherwise=r?[em(n.off),ei(yo)]:[ei(yo)],t}function Vv(e){let n=Qi(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...yn(e)}},i.comparison={kind:"isUnavailable"};let a=Un("setOpacity");return a.number=.35,t.then=[a],n}function tm(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Gv(e,n,t=im){let i=n.max-n.min,a=tm(n.min+i/3),r=tm(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:V(a)},changes:[ei(t[0])]},{comparison:{kind:"between",value:V(a),upper:V(r)},changes:[ei(t[1])]},{comparison:{kind:"greaterThan",value:V(r)},changes:[ei(t[2])]}];return up(Vl(e),o)}function Uv(e,n,t){let i=gn("icon"),a=Hv(n);return i.payload.symbol=V(a.off),i.payload.colorSlot.baseColorHex=yo,i.payload.rules=[Bv(n,a)],fn(e,i,t.family,Lv),e.elements.push(i),hr(e,i.payload.id,{type:"toggleEntity",...yn(n)}),i.payload.id}function Wv(e,n,t){let i=gn("text");return i.payload.value=Vl(n,t.state),i.payload.rules=[Vv(n)],fn(e,i,t.family,_v),e.elements.push(i),i.payload.id}function Kv(e,n,t){let i=gn("gauge");i.payload.value=Vl(n);let a=Iv(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Gv(n,a,Rv(t.state))],fn(e,i,t.family,zv),e.elements.push(i),i.payload.id}function jv(e,n,t){let i=gn("chart");return i.payload.value={kind:{kind:"entityState",...yn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",fn(e,i,t.family,am),e.elements.push(i),i.payload.id}function qv(e,n,t){let i=gn("chart");return i.payload.value={kind:{kind:"entityState",...yn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",fn(e,i,t.family,am),e.elements.push(i),i.payload.id}function Yv(e,n,t){let i=yn(n),a=gn("text");a.payload.value=V(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=yo,fn(e,a,t.family,Nv),e.elements.push(a);let r=t.state?.attributes?.device_class,o=gn("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=ns(i.domain,typeof r=="string"?r:void 0),fn(e,o,t.family,Pv),e.elements.push(o),o.payload.id}function Xv(e,n,t){let i=gn("image");return i.payload.entity=yn(n),fn(e,i,t.family,Dv),e.elements.push(i),i.payload.id}function rm(e,n,t,i){switch(n){case"toggle":return Uv(e,t,i);case"status":return Wv(e,t,i);case"gauge":return Kv(e,t,i);case"chart":return jv(e,t,i);case"history":return qv(e,t,i);case"doorHistory":return Yv(e,t,i);case"camera":return Xv(e,t,i)}}var Jv=/^[a-z0-9_]+\.shared_(\d+)$/;function om(e){return Jv.test(e)}function Zv(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function dm(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function cm(e,n){let t=new Map;for(let i of Ss(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=dm(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${Zv(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function Qv(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);$s(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),Cs(t,r=>xs(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function um(e){let n=!1;return yr(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function ew(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function pm(e,n,t=[]){let i=n==="share"?Qv(e,t):e,a=pi(i);return delete a.id,delete a.slotIndex,n==="share"&&delete a.hidden,a.dataSources=[],`${ew(a)}
`}function hm(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var tw="There is nothing to read here. Paste a complication first.",nw="This is not valid JSON. Check for a missing brace or a stray comma.",iw="This is valid JSON but not a complication. A complication starts with { and ends with }.",aw="This does not look like a complication.",sm="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",rw="00000000-0000-4000-8000-000000000000";function ow(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function mm(e,n){let t=e.trim();if(t==="")return{ok:!1,error:tw};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:nw}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:iw};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${sm}`};let o={...a,id:rw,slotIndex:0},s;try{s=ui(o)}catch(d){let c=d instanceof it||d instanceof Error?d.message:String(d);return{ok:!1,error:`${aw}

${ow(c)}`}}delete s.hidden;let l=cr(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${sm}`}}return{ok:!0,config:s,raw:i}}function Gl(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=Ss(e,(o,s)=>om(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=om(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:dm(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function fm(e,n){let t=structuredClone(e);$s(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Cs(t,a=>xs(a,i)),t}function gm(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}var sw={rectangular:"Rectangular",circular:"Circular",corner:"Corner",inline:"Inline"};function ym(e,n){return{layers:e.elements.length,families:da(e).map(t=>sw[t]??t),slots:n.filter(t=>t.required).length,missing:n.filter(t=>!t.required).length}}var bm="import";function lm(e){let n="";for(let t=0;t<e.length;t+=32768)n+=String.fromCharCode(...e.subarray(t,t+32768));return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function lw(e){if(!/^[A-Za-z0-9_-]*$/.test(e)||e.length%4===1)return;let n=e.replace(/-/g,"+").replace(/_/g,"/")+"===".slice((e.length+3)%4);try{let t=atob(n),i=new Uint8Array(t.length);for(let a=0;a<t.length;a+=1)i[a]=t.charCodeAt(a);return i}catch{return}}async function xm(e,n){let t=new Blob([e]).stream().pipeThrough(n);return new Uint8Array(await new Response(t).arrayBuffer())}async function vm(e,n={}){let t=new TextEncoder().encode(e);if(n.compress!==!1&&typeof CompressionStream=="function")try{return`z${lm(await xm(t,new CompressionStream("gzip")))}`}catch{}return`t${lm(t)}`}async function Ul(e){let n=lw(e.slice(1));if(!n)return;let t=new TextDecoder("utf-8",{fatal:!0});try{if(e.startsWith("t"))return t.decode(n);if(e.startsWith("z")&&typeof DecompressionStream=="function")return t.decode(await xm(n,new DecompressionStream("gzip")))}catch{}}function wm(e,n){return`${e.split("#")[0]??e}#${bm}=${n}`}function Wl(e){let n=e.startsWith("#")?e.slice(1):e,t=`${bm}=`;if(!n.startsWith(t))return;let i=n.slice(t.length);return i.length>1?i:void 0}function km(e){let n=e.trim();if(n===""||/\s/.test(n)||n.startsWith("{"))return;let t=n.indexOf("#");return t<0?void 0:Wl(n.slice(t))}var Kl="This share link is damaged or cut short. Ask for it again, or paste the text instead.";function jl(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var cw="wrist-assistant-panel.picker-hidden.v1:",uw=3e4,pw=500,hw=3e4,$m="preset-entity";function Cm(e){return`import-entity-${e}`}var mw={entityId:"",displayName:"",domain:""},fw=new Map,gw={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function ql(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function yw(e){return e.kind==="family"?"look":"content"}function Yl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Sm(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function bw(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Tm=300,Em=360,Zl=44,Ql=22,_m=[1,1.7,2.6],xw=["S","M","L"],Mm=["Small","Medium","Large"];function vw(){return _m.map((e,n)=>{let t=Math.round(Zl*e),i=Math.round(Ql*e),a=`.layers-card.s${n}`;return`
...
`)}var Rm="wrist-assistant-panel.layers.v1",Am="wrist-assistant-panel.grid.v1",Bt=34,ni=200,ww=720,bo=320,kw=80,$w=56,Hm="wrist-assistant-panel.columns.v3",Xl=e=>Math.max(ni,Math.min(ww,Math.round(e))),Fm=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Cw(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Sw=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Ma=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",bn=Ma==="Cmd"?"\u2318":"Ctrl+",Jl=Ma==="Cmd"?"\u21E7":"Shift+";function Im(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-kw;if(i>=ni*2+bo){let r=i-bo,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(ni,Math.floor(o*l)),s=Math.max(ni,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(ni,o-d):s=Math.max(ni,s-d))}return{columns:3,left:o,right:s}}let a=e-$w;return a>=ni+bo?{columns:2,left:Math.min(n,a-bo),right:t}:{columns:1,left:n,right:t}}var L=class L extends Ut{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Tm;this.colRight=Em;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.pickerHiddenOpen=!1;this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.snapGrid=!0;this.gridStep=.01;this.showGridLines=!1;this.altHeld=!1;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.importDrop=!1;this.importDragDepth=0;this.importEntities=[];this.helpTab="basics";this.linkReady=!1;this.recordPreviews=new Map;this.previewCase=wi.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=ap(()=>this.requestUpdate());this.imageSizes=rp(()=>this.requestUpdate());this.symbols=new Lr(()=>this.requestUpdate());this.keyHandler=t=>{t.key==="Alt"&&(this.altHeld=!0),this.onKey(t)};this.blurHandler=()=>{this.altHeld=!1};this.heldArrows=new Set;this.keyUpHandler=t=>{t.key==="Alt"&&(this.altHeld=!1),this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Pr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.menuOutside=t=>{let i=this.openMenu;if(i===void 0)return;t.composedPath().some(r=>r instanceof HTMLElement&&r.dataset.menu===i)||this.toggleMenu(i,!1)};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importDragEnter=t=>{this.dragReadable(t)&&(t.preventDefault(),this.importDragDepth+=1,this.importDrop=!0)};this.importDragOver=t=>{this.dragReadable(t)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect="copy"))};this.importDragLeave=()=>{this.importDragDepth!==0&&(this.importDragDepth-=1,this.importDragDepth===0&&(this.importDrop=!1))};this.importDropped=t=>{this.importDragDepth=0,this.importDrop=!1;let i=t.dataTransfer?.files?.[0];if(i){t.preventDefault(),this.readImportBlob(i);return}let a=t.dataTransfer?.getData("text/plain")??"";a!==""&&(t.preventDefault(),this.setImportText(a))};this.takeShareLink=()=>{let t=Wl(window.location.hash);t!==void 0&&(history.replaceState(history.state,"",`${window.location.pathname}${window.location.search}`),this.pendingLink=t,this.linkReady&&this.openPendingLink())};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Gl(a,this.hass.states);r.some(s=>Fl(Cm(s.entityId)))||jl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Fl($m)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??fw}static{this.styles=So`
    :host {
  ...
  `}firstUpdated(t){super.firstUpdated(t),this.renderRoot.addEventListener("change",i=>{let a=i.target;a?.tagName==="SELECT"&&a.blur()})}connectedCallback(){super.connectedCallback(),this.clearLegacyPickerHidden(),this.loadColumnWidths(),this.loadListView(),this.loadGrid(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("blur",this.blurHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(oo,this.scrubStart),this.addEventListener(so,this.scrubEnd),window.addEventListener("hashchange",this.takeShareLink),this.takeShareLink(),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},hw)}loadColumnWidths(){try{let t=window.localStorage.getItem(Hm);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Xl(i.left)),typeof i.right=="number"&&(this.colRight=Xl(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Hm,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadGrid(){try{let t=window.localStorage.getItem(Am);if(!t)return;let i=JSON.parse(t);typeof i.on=="boolean"&&(this.snapGrid=i.on),_s.includes(i.step)&&(this.gridStep=i.step),typeof i.lines=="boolean"&&(this.showGridLines=i.lines)}catch{}}setGrid(t,i,a=this.showGridLines){this.snapGrid=t,this.gridStep=i,this.showGridLines=a;try{window.localStorage.setItem(Am,JSON.stringify({on:t,step:i,lines:a}))}catch{}}snapTarget(t){return{snap:{step:xi(this.gridStep,he[t]),on:this.snapGrid}}}loadListView(){try{let t=window.localStorage.getItem(Rm);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Rm,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>zh(s,o,i))}>Copy the ${ne(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?bs(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){let a=this.renderRoot,r="activeElement"in a?a.activeElement:null;if(r&&typeof r.blur=="function"&&!i.currentTarget?.contains(r)&&r.blur(),this.picking){i.preventDefault(),this.pickAt(t,i);return}let o=i.target,s=o.closest("[data-handle]")?.getAttribute("data-handle")??null,l=o.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,d=o.closest("svg.complication");if(this.showTaps){let M=this.focusTapId();if(M!==void 0&&l===M&&d&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,d,M,s??void 0);return}let W=this.hitLayerId(i);W?this.inspect={kind:"layer",id:W}:l===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=Fm(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!l||!d)return;let u=bs(this.draft.config,l),p=this.draft.config.elements.find(M=>M.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m,f=this.inspect.kind==="layer"?this.inspect.id:void 0;if(f!==void 0&&f!==u&&!s){let M=this.draft.config.elements.find(A=>A.payload.id===f);M!==void 0&&M.kind!=="chartDots"&&M.kind!=="chartGrid"&&M.payload.chartAnchor?.place!=="through"&&lt(this.draft.config,f)?.locked!==!0&&Cw(d,f,i)&&(m=u,u=f,p=M)}let y=lt(this.draft.config,u),b=y!==void 0&&this.inspect.kind==="group"&&this.inspect.id===y.id;if(y&&(y.locked||b)&&!s){let M=b||this.inspect.kind==="layer"&&lt(this.draft.config,this.inspect.id)?.id===y.id;this.beginGroupGesture(t,i,d,y,M?u:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},s)||p.payload.chartAnchor?.place==="through")return;i.preventDefault();let k=Le(this.draft.config,t,p).frame,$=this.gestureCanvas(t),w=p.payload.chartAnchor,S=w!==void 0&&!It(w.at)&&w.place!=="through",_=w!==void 0&&It(w.at)&&w.place==="through",z=he[t],F={dx:w?.dx??0,dy:w?.dy??0},R=w!==void 0&&!s?bi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(M=>M.id===u)?.frame:void 0,E=R??k,P=M=>Math.round(M*10)/10;this.cancelGesture?.();let j=!1,N=s!==null?bi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(M=>M.id===u):void 0;if(s!==null&&N?.kind==="icon"){let M=Ys(N)/2,W=N.size;this.cancelGesture=vu(d,i,s,{w:M,h:M},(A,Y)=>{this.mutate(x=>{ke(x,t,u,{size:Math.max(1,Math.round(W*A))})},`drag-${u}-${t}`),Y&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let ee=N!==void 0?Gu(N,E,$):{};this.cancelGesture=Sr(d,$,i,{elementId:u,frame:E,handle:s??void 0,...ee,...w===void 0?this.snapTarget(t):{}},{onFrame:(M,W,A)=>{if(A||(j=!0),A&&!j&&m!==void 0){this.inspect={kind:"layer",id:m},this.cancelGesture=void 0;return}this.mutate(Y=>{if(w===void 0){ke(Y,t,M,{frame:W});return}let x=R?{width:k.width,height:k.height}:{width:W.width,height:W.height};ke(Y,t,M,{frame:{...W,...x,x:S?W.x:k.x,y:k.y}});let C=Y.elements.find(K=>K.payload.id===M)?.payload.chartAnchor;if(C===void 0)return;let H=F.dx,O=_?F.dy:P(F.dy+(W.y-E.y)*z.height);H?C.dx=H:delete C.dx,O?C.dy=O:delete C.dy},`drag-${M}-${t}`),A&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=yt(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map($=>[$.payload.id,Le(s,t,$).frame])),c=[...d.values()],u=Math.min(...c.map($=>$.x)),p=Math.min(...c.map($=>$.y)),m=Math.max(...c.map($=>$.x+$.width)),f=Math.max(...c.map($=>$.y+$.height)),y={x:u,y:p,width:m-u,height:f-p,rotationDegrees:0},b=$=>Math.round($*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=Sr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y,...this.snapTarget(t)},{onFrame:($,w,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let _=w.x-y.x,z=w.y-y.y;this.mutate(F=>{for(let[R,E]of d)ke(F,t,R,{frame:{...E,x:b(E.x+_),y:b(E.y+z)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?xu:1,s=t*o,l=i*o,d=this.canvasFamily,c=he[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(yt(r,k).map($=>$.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=lt(r,u);if(m?.locked)return this.nudgeMany(yt(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let f=Le(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let k=!It(y.at);return l===0&&!(k&&s!==0)||this.mutate($=>{k&&s!==0&&ke($,d,u,{frame:Cr(f,s,0,c)});let w=$.elements.find(_=>_.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let S=Math.round(((w.dy??0)+l)*10)/10;S?w.dy=S:delete w.dy},`nudge-${u}-${d}`),!0}let b=this.snapGrid?Ns(f,s,l,xi(this.gridStep,c)):Cr(f,s,l,c);return(b.x!==f.x||b.y!==f.y)&&this.mutate(k=>ke(k,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let _=l.elements.find(z=>z.payload.id===S);_&&c.set(S,Le(l,i,_).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),f=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),b={x:p,y:m,width:f-p,height:y-m,rotationDegrees:0},k=this.snapGrid?Ns(b,o,s,xi(this.gridStep,a)):Cr(b,o,s,a),$=k.x-b.x,w=k.y-b.y;return($!==0||w!==0)&&this.mutate(S=>{for(let[_,z]of c)ke(S,i,_,{frame:{...z,x:d(z.x+$),y:d(z.y+w)}})},r),!0}gestureCanvas(t){let i=Mr(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Zs(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ke(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ve(s,l),c=Le(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Sr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o,...this.snapTarget(t)},{onFrame:(u,p,m)=>{this.mutate(f=>{d?Dc(f,u,t,p):ke(f,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Im(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${Lm(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Sm()}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${tp(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.shareLink=void 0,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t,i="dialog.share-dialog textarea",a="Copied."){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote=a;return}}catch{}let r=this.renderRoot.querySelector(i);r?.focus(),r?.select();let o=!1;try{o=document.execCommand("copy")}catch{o=!1}this.shareNote=o?a:"Press Cmd+C or Ctrl+C to copy."}async copyShareLink(t){let i=await vm(t),a=wm(`${window.location.origin}${window.location.pathname}`,i);this.shareLink={text:t,url:a},await this.updateComplete,await this.copyShareText(a,"dialog.share-dialog input.xfer-link","Link copied.")}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=hm(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Gl(i,this.hass.states):[],r=jl({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog ${this.importDrop?"dropping":""}" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}
    ...
    </dialog>`}renderImportPreview(t,i){let a=ym(t,i),r=a.layers===1?"1 layer":`${a.layers} layers`,o=a.slots===0?"no entities to choose":a.slots===1?"1 entity to choose":`${a.slots} entities to choose`,s=a.missing===0?"":` \xB7 ${a.missing} not in your Home Assistant`;return h`<div class="xfer-preview">
      ...
      ${um(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:g}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${$t({hass:this.hass},t.label,i??mw,a=>this.setImportEntity(t.entityId,a),Cm(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,po(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=km(t);if(i!==void 0){this.importParse=void 0,this.importMap=new Map,this.importName="",Ul(i).then(o=>{this.importText===t&&(o===void 0?this.importParse={ok:!1,error:Kl}:this.setImportText(o))});return}let a=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,r=t.trim()===""?void 0:mm(t,this.maxSchemaVersion);if(this.importParse=r,!r?.ok){this.importMap=new Map,this.importName="";return}try{this.importEntities=[...na(r.config).entities.values()]}catch{this.importEntities=[]}JSON.stringify(r.config)!==a&&(this.importMap=new Map,this.importName=gm(r.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];a&&(await this.readImportBlob(a),i.value="")}async readImportBlob(t){try{this.setImportText(await t.text())}catch(i){this.importParse={ok:!1,error:`That file could not be read: ${Ct(i)}`}}}async openPendingLink(){let t=this.pendingLink;if(t===void 0)return;if(this.pendingLink=void 0,!this.hass.user?.is_admin){this.linkNote="This link holds a shared complication. Only a Home Assistant administrator can import it.";return}let i=await Ul(t);if(i===void 0){this.linkNote=Kl;return}if(!this.ownerId){this.linkNote="This link holds a shared complication, but no watch has connected to this Home Assistant yet.";return}if(this.freeSlot()<0){this.linkNote="This link holds a shared complication, but this watch has no free slot. Delete a complication, then open the link again.";return}this.linkNote=void 0,this.openImportDialog(),this.setImportText(i)}doImport(){let t=this.importParse;if(!t?.ok)return;let i=fm(t.config,this.importMap);i.id=Q(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=Rn(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.importEntities=[],this.importDrop=!1,this.importDragDepth=0,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Lm(a)}</option>`)}
              </select>
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${el.map(s=>h`<button class="add" style=${`--k:${Xe[s]}`} ?disabled=${i} title=${`Add a blank ${dn[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${$p(s)}</span>`:g}<span class="add-name">${r?U(s):h`<span class="k"></span>`}<span>${dn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${He(E,d)}</b>
          <small><span class="kind">${dn[E.kind]}</span> · ${Rw(E,c,this.historySeries,M.size)}</small>
          ${S?h`<span class="facts">${Ew(this.host(),a,E,M).map(H=>h`<span class="fact"><b>${H.label}</b> ${H.value}</span>`)}</span>`:g}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${M.isHidden?"Show":"Hide"} (${Jl}${bn}H)`} aria-label=${M.isHidden?"Show this layer":"Hide this layer"} @click=${H=>{H.stopPropagation(),this.mutate(O=>ke(O,a,N,{isHidden:!M.isHidden}))}}>${U(M.isHidden?"hide":"show")}</button>
        ...
        @drop=${x=>{x.preventDefault();let C=A(x);this.clearDragMarks();let H=this.dragId;if(this.dragId=void 0,!(!H||!M||!W)){if(C==="drop-before"){this.reorderLayer(H,M.payload.id,!0,!0);return}if(C==="drop-after"){this.reorderLayer(H,W.payload.id,!1,!0);return}this.isGroupId(H)||(this.reorderLayer(H,M.payload.id,!0),this.mutate(O=>Xi(O,H,E.id)))}}}>
        ...
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Jl}${bn}G)`} aria-label="Ungroup" @click=${x=>{x.stopPropagation(),this.mutate(C=>mi(C,E.id)),j&&(this.inspect={kind:"general"})}}>${U("ungroup")}</button>
          </span>`:g}
      ...
      <h2 class="panel-title tools" style=${`--c:${te.place}`}><span class="swatch">${U("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${xw.map((E,P)=>h`
              <button class=${this.thumbStep===P?"on":""} title=${`${Mm[P]} row pictures`}
                aria-label=${`${Mm[P]} row pictures`} aria-pressed=${this.thumbStep===P?"true":"false"}
      ...
      ${t===void 0?g:h`
        ...
        ${$t(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},$m,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=rm(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=bi(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${f=>{f.stopPropagation(),this.mutate(y=>{ks(y,c.id)}),p&&(this.openValue=void 0)}}>${U("delete")}</button>`:g}
        </div>
        ${p?h`<div class="value-open">${Lh(s,c)}</div>`:g}</div>`})}
      </div>
      ...
      ${r.length>0?h`<span class="shape-adds">${r.map(o=>h`<button class="tab off ${o}" ?disabled=${!this.canEdit}
        title=${`Add the ${ne(o)} shape`} @click=${()=>this.addShape(o)}>${U("plus")}${ne(o)}</button>`)}</span>`:g}`}renderHaveTabs(t,i){let a=t.supportedFamilies;return ln.filter(r=>a.includes(r)).map(r=>{let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?Ar(c,{icons:this.icons,imageSizes:this.imageSizes,slot:wi.slots[r]}):g}let l=r!=="inline"&&mo(t,r)===0&&t.elements.length>0,d=this.canEdit&&Hr(t,r);return h`<span class="tab-wrap">
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return g;let i=[...this.compiled?.entities.keys()??[]],a=Xc(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${te.states}`}>
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ${i.map(o=>{let s=this.hass.states[o],l=typeof s?.attributes.friendly_name=="string"?s.attributes.friendly_name:o,d=typeof s?.attributes.unit_of_measurement=="string"?` ${s.attributes.unit_of_measurement}`:"",c=s?`${s.state}${d}`:"not in Home Assistant",u=this.testValues.get(o),m=t.elements.find(f=>fr(t,f.payload.id).some(y=>y.ref.entityId===o))?.kind??"text";return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${Xe[m]}`}
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${Se(a,"complication","Complication",Fh(a),{color:te.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=g,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},g;s=Bh(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},g;l=!1,s=Wh(a,c)}else s=Kh(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([yw(r)]):new Set(Rl)}}>${d?"One at a time":"Open all"}</button>`:g}
      </div>
      ...
      ${Se(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:te.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return g;let i=this.records.find(r=>r.id===this.selectedId),a=op({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
