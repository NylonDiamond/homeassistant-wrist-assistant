...
`)}function uc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Qm(r));return{values:t,nullKeys:i}}function Qm(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Jo(e){let n=ja(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function ef(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(ho(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var tf=10800;function nf(e,n,t){let i=n==="always"||n==="auto"&&t<=tf;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function qa(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=nf(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function af(e,n){return ut(e)===void 0?[]:qa(it(e)*60,Ai(e.timeLabelCount),e.hourCycle,e.minutes,n)}function rf(e,n){return $n(e)?qa(Math.round(e.historyMinutes)*60,Ai(dt(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function of(e,n,t,i){return n===void 0&&i!==void 0?ut(i)===void 0?[]:qa(it(i)*60,Ai(dt(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!$n(n)?[]:qa(Math.round(n.historyMinutes)*60,Ai(dt(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function _n(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Be(e){let n=e.trim(),t=_n(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:_n(i)}function sf(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function lf(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function df(e){let n=e.trim(),t=_n(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?_n(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=_n(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function cf(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function uf(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function pf(e,n,t){if(He(n))return e;let i=n,a=e,r=_n(e.trim()),o=i.duration?df(e):void 0;if(o!==void 0)a=cf(o);else if(i.relativeTime&&r!==void 0)a=lf(r);else{let s=Be(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):sf(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=uf(a);break}return a}function ai(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Ge(e,n=240){return gc(e,n).map(t=>t.value)}function Qo(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Ge(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:fc(r)}}function fc(e){return e.some(n=>n)?e:[]}function gc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function pc(e,n,t){let i=gc(e),a=i.map(g=>g.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Kt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??se,c=t.highColorHex??Ye,u=t.lowColorHex??Xe,p=[],m=(g,x)=>{if(g==="")return;let w=p.at(-1);w&&w.colorHex===x?w.text+=g:p.push({text:g,colorHex:x})},y=0;return i.forEach((g,x)=>{m(e.slice(y,g.start),n);let w=x===o?c:x===s?u:l.length>0?Fa(g.value,l,d):n,k=e[g.end-1]==="."?g.end-1:g.end;m(e.slice(g.start,k),w),y=k}),m(e.slice(y),n),p}function hc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function hf(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Vi(e,n=Yt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:mf(i.slice(a+1))})}return t}function mf(e){try{return decodeURIComponent(e)}catch{return e}}function ff(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function mc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function gf(e,n,t){if(e===void 0)return 0;let i=Be(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var ht=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=hc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=Cn(n),i=Sn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Qo(a):{values:Ge(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=fc(s),{values:es(o,tt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Be(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Be(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):hc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!He(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?ef(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?yd(r):ho(r,a.domainMax-a.domainMin));break}default:{let a=Xo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return pf(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=_n(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?ai(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Be(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Be(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Be(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Hn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Hn(d),p=c===void 0?void 0:Hn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(_e[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=pc(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,y=nt(n.payload)&&!r.has("text"),g={kind:"text",...u,text:y?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(g.countdownEnd=p),y?(g.parts=this.resolveTextParts(n.payload.parts,i.rules,g,t),g.text=g.parts.map(x=>x.text).join(""),g):(pd(n.payload)&&(g.spans=pc(g.text,g.colorHex,n.payload)),g)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),y=n.payload.symbol.kind.kind==="literal",g=m===void 0&&y&&n.payload.path!==""?n.payload.path:void 0,x=m??p;g===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let w={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(w.path=g),w}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),y=(L,P,J)=>L??(P?Be(this.resolve(P)??""):void 0)??J,g=y(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=y(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),w=m===void 0?void 0:Be(m),k=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&w!==void 0&&(k=Fa(w,Kt(p),p.bandAboveColorHex));let C=x-g;if(p.total){let L=Be(this.resolve(p.total)??"");L!==void 0&&(C=L)}let S=mc(C,1,Ra),I={kind:"gauge",...u,fraction:gf(m,g,x),style:p.style,lineWidth:p.lineWidth,colorHex:k,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:mc(w??0,0,S)};if(p.thresholdValue!==void 0&&x!==g){let L=(p.thresholdValue-g)/(x-g);L>=0&&L<=1&&(I.thresholdFraction=L)}return I}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),y=m.values,g=m.holes,x={min:m.domainMin,max:m.domainMax},w=this.styleColor(r,"color")??p.colorSlot.baseColorHex,k=Kt(p),C=gd(p)?y.map(j=>Fa(j,k,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",I=p.highlight==="lowest"||p.highlight==="both",L=Ci(p),P={kind:"chart",...u,values:y,holes:g,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:w,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?L.high:"none",lowMarker:I?L.low:"none",pointColorHexes:C,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:tt(p.smoothing)??"off",fillStyle:Dt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:Ot(p.barRadius),barCorners:Vt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:rf(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},J=g.length===0?y:y.filter((j,U)=>!g[U]);if(J.length>0){let j=_=>y.findIndex((K,b)=>K===_&&g[b]!==!0),U=S?j(Math.max(...J)):-1,ie=I?j(Math.min(...J)):-1;U>=0&&(P.highIndex=U),ie>=0&&ie!==U&&(P.lowIndex=ie)}let R=hf(p,x.min,x.max);R!==void 0&&(P.thresholdY=R);let A=this.chartNowIndex(p,y.length);return A!==void 0&&(P.nowIndex=A),P}case"timeline":{let p=n.payload,m=ut(p),y=m===void 0?"":this.ctx.historySeries?.get(m)??"",g=Vi(y,Yt),x=ff(g,it(p)*60,k=>Cd(k,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:af(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};za(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:of(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),y={kind:"imageTime",...u,image:p.image,linked:m!==void 0},g=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return g!==void 0&&(y.url=g),y}case"chartDots":{let p=n.payload,m=lt(p.size),y={kind:"chartDots",...u,chart:p.chart,dots:Ca(p.dots),diameter:0,indices:[]};return m!==void 0&&(y.size=m),p.colorHex!==void 0&&(y.colorHex=p.colorHex),y}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:bn(p.lines),colorHex:zt(p.colorHex),thickness:xn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=ue[t==="inline"?"rectangular":t],o=[...kf(wf(Ud(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,w=this.resolve(x.value),k=w===void 0?void 0:Be(w);if(k!==void 0){let C=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),I={value:Math.min(S,Math.max(C,k)),minValue:C,maxValue:S===C?C+1:S,colorHexes:x.colorHexes},L=this.resolve(x.minLabel);L!==void 0&&(I.minLabel=L);let P=this.resolve(x.maxLabel);P!==void 0&&(I.maxLabel=P),l.bezelGauge=I}}let y=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;y!==void 0&&(l.backgroundColorHex=y);let g=this.styleColor(s,"borderColor")??a?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function yf(e,n,t){let i=new ht(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Bi(e,n,t){let i=new ht(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=yf(e.inline,n,e)),a}function Ya(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Zo=5,bf=1.7,xf=1.8;function vf(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function wf(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*xf,l=Math.max(o.frame.width*n.width,0),d=vf(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function yc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function bc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function Xa(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=P=>P==="triangle"?Zo+d:P==="dot"?Math.max(d,bf):d,u=c(a),p=c(r),m=n.y+u,y=Math.max(n.h-u-p,1),g=m+y,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),w=e.baseline==="lowest",k=w?y*.12:0,C=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-C*(i-1))/i,.5),I=P=>Math.min(1,Math.max(0,(P-e.domainMin)/x)),L=P=>g-I(P)*y;return{count:t.length,barWidth:S,plotTop:m,plotBottom:g,plotLeft:o,plotRight:o+s,baselineY:w?g:L(0),inset:d,yAtFraction(P){return g-Math.min(Math.max(P,0),1)*y},barRect(P){let J=o+P*(S+C),R=t[P],A,j;if(w){let U=k+I(R)*(y-k);A=g-U,j=g}else A=L(R),j=w?g:L(0),A>j&&([A,j]=[j,A]);return{x:J,y:A,w:S,h:Math.max(j-A,.5)}},point(P){let J=Math.max(s-d*2,0);return{x:t.length>1?o+d+J*P/(t.length-1):o+s/2,y:L(t[P])}},markerCenter(P,J,R="high"){let A=J?this.barRect(P):void 0,j=A?A.x+A.w/2:this.point(P).x,U=R==="high"?a:r,ie=R==="high"?U==="triangle"?n.y+Zo/2:m:U==="triangle"?n.y+n.h-Zo/2:g;return{x:j,y:ie}}}}function xc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function es(e,n,t=[]){let i=e.length,a=ud(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,y=0;for(let g=Math.max(0,p-r);g<=Math.min(i-1,p+r);g++){if(s(g))continue;let x=g-p,w=Math.exp(-(x*x)/(2*o*o));m+=e[g]*w,y+=w}return m/y}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function vc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Oi=1;function ri(e,n){let t=Math.max(jt,Math.min(qt,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Oi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Oi:n.y,h:n.h-i-Oi,cy:(e.labelsAbove?n.y+i+Oi:n.y)+(n.h-i-Oi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function kf(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&yc(r)===void 0)return{...i,isHidden:!0};let o=Cf(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function $f(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Cf(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Ya(t,i);if(a.w<=0||a.h<=0)return;let r=ri(t,a).body;if(r.w<=0||r.h<=0)return;let o=Xa(t,r),s,l;if(ct(n.at)){let w=$f(n.at,t);if(w===void 0)return;if(t.style==="bars"){let k=o.barRect(w);s=k.x+k.w/2,l=k.y}else{let k=o.point(w);s=k.x,l=k.y}}else{let w=n.at==="zero"?yc(t):t.thresholdY;if(w===void 0)return;l=o.yAtFraction(w)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(w,k,C)=>k>C?(k+C)/2:Math.min(Math.max(w,k),C),m={...e};if(s!==void 0){let w=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(w-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let w=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(w-c/2)/i.height}return m}let y=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,g=p(y,r.y+c/2,r.y+r.h-c/2),x=p(g+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Ie=ue,Gi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ie,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],oi=Gi.find(e=>e.measured);function Fc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Gi.find(a=>a.screen.width===t&&a.screen.height===i)}function Za(e,n){let t=Ie[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var as={regular:400,medium:500,semibold:600,bold:700},Sf=1.15;function Ue(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function xe(e,n,t="#FFFFFF"){let i=Ue(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var Rt=e=>e*.55;function Ac(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Tf(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Ef(e,n,t){if(t<=0||e.length*Rt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/Rt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Mf(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Hc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Ic(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Rf(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Lc(e,n){return e.reduce((t,i)=>t+i.text.length*Rt(i.look.fontSize*n),0)}function Ff(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:Rt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=Rt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Af(e,n,t){if(t<=0||Lc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*Rt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*Rt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Hf(e,n,t){let i=Rf(n),a=e.lineLimit===2&&t.w>0?Ff(e.text,i,t.w):[e.text],r=Hc(e.text,a),o=a.map((k,C)=>Ic(k,r[C]??0,e.text,i,i[0])),s=Math.max(...o.map(k=>Lc(k,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(k=>Af(k,l,t.w)),{anchor:c,x:u}=Ac(e.alignment,t),p=Math.max(0,...d.flat().map(k=>k.look.fontSize))*l||e.fontSize*l,m=.35*p,y=p*1.15,g=k=>k.map(C=>{let S=xe(C.look.colorHex,"fill");return v`<tspan font-size=${C.look.fontSize*l} font-weight=${as[C.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${C.text}</tspan>`}),x=xe(e.colorHex,"fill"),w=d.length>1?v`${d.map((k,C)=>v`<tspan x=${u} y=${t.cy+m+(C-(d.length-1)/2)*y}>${g(k)}</tspan>`)}`:g(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${w}</text>`}function If(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(g=>g.text).join("")===e.text)return e.text===""?f:Hf(e,e.parts,n);let t=xe(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:ai((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Tf(e.text,n.w/Rt(e.fontSize)):[e.text],a=Math.max(...i.map(g=>g.length))*Rt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(g=>Ef(g,o,n.w)),{anchor:l,x:d}=Ac(e.alignment,n),c=Mf(e.text,e.spans),u=c?Hc(e.text,i):[],p=(g,x)=>c?Ic(g,u[x]??0,e.text,c,e.colorHex).map(w=>{let k=xe(w.look,"fill");return v`<tspan fill=${k.fill} fill-opacity=${k["fill-opacity"]}>${w.text}</tspan>`}):g,m=o*1.15,y=s.length>1?v`${s.map((g,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(g,x)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${as[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${y}</text>`}var ts=2;function Lf(e,n){let t=xe(e.colorHex,"stroke"),i=xe(e.trackColorHex,"stroke","#FFFFFF"),a=xe(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,y=Math.max(1,e.dotCount),g=m?n.w:n.h,x=m?n.h:n.w,w=Math.max(1,Math.min(x,g/y-ts)),k=y*w+(y-1)*ts,C=(m?n.cx:n.cy)-k/2+w/2;return v`${Array.from({length:y},(S,I)=>{let L=C+I*(w+ts),P=I<e.filledCount?t:i;return v`<circle cx=${m?L:n.cx} cy=${m?n.cy:L} r=${w/2}
    ...
    </g>`}function _f(e,n,t,i,a){let r=xe(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function zf(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ri(e,n),o=r?ds(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=Pf(e,a);return o===void 0?s:v`${s}${o}`}function ns(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var wc=0;function _c(){return wc+=1,wc.toString(36)}function Nf(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function Pf(e,n){let t=Xa(e,n),i=_c(),a=xe(e.colorHex,"fill"),r=xe(e.highColorHex,"fill",e.colorHex),o=xe(e.lowColorHex,"fill",e.colorHex),s=(y,g)=>v`<circle cx=${y.x} cy=${y.y} r="1.7" fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=y=>c?xe(e.pointColorHexes[y],"fill",e.colorHex):a,p=y=>{let g=Ue(y)??Ue(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:g.color,opacity:g.opacity*.28};let x=Df(i,e.id,y),w=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,v`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${w} x2="0" y2=${t.baselineY}>
        ...
        <stop offset="1" stop-color=${g.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let y=0;y<t.count;y++){if(e.holes[y]===!0)continue;let g=t.barRect(y),x=y===e.highIndex?r:y===e.lowIndex?o:u(y),w=Math.min(Math.max(e.barRadius,0),g.w/2,g.h/2);if(e.barCorners==="top"){let k=e.baseline==="zero"&&e.values[y]<0;l.push(v`<path d=${Nf(g,w,k)}
          ...
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let y=Array.from({length:t.count},(k,C)=>t.point(C)),g=e.holes.length>0,w=vc(t.count,e.holes).filter(k=>!g||k.length>1).map(k=>{let C=k.map(L=>y[L]),S=xc(C,e.curve),I=`M${C[0].x} ${C[0].y}${S.map(L=>` ${ns(L)}`).join("")}`;return{run:k,pts:C,legs:S,line:I}});if(e.style==="area")for(let{run:k,pts:C,legs:S,line:I}of w)if(e.fillBands&&c&&k.length>1&&e.fillColorHex===void 0)for(let L=0;L<S.length;L++){let P=C[L],J=C[L+1],R=p(e.pointColorHexes[k[L+1]]),A=`M${P.x} ${P.y} ${ns(S[L])} L${J.x} ${t.baselineY} L${P.x} ${t.baselineY} Z`;l.push(v`<path d=${A} fill=${R.fill} fill-opacity=${R.opacity} stroke="none" />`)}else{let L=p(e.fillColorHex??e.colorHex),P=`${I} L${C[C.length-1].x} ${t.baselineY} L${C[0].x} ${t.baselineY} Z`;l.push(v`<path d=${P} fill=${L.fill} fill-opacity=${L.opacity} stroke="none" />`)}for(let{run:k,pts:C,legs:S,line:I}of w)if(c&&k.length>1)for(let L=0;L<S.length;L++){let P=C[L],J=u(k[L+1]);l.push(v`<path d=${`M${P.x} ${P.y} ${ns(S[L])}`} fill="none"
          ...
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`:s(k,x))};if(m(e.highIndex,e.highMarker,r,"high"),m(e.lowIndex,e.lowMarker,o,"low"),e.drawsThreshold&&e.thresholdY!==void 0){let y=t.yAtFraction(e.thresholdY),g=xe(e.thresholdColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${t.plotLeft} ${y} L${t.plotRight} ${y}`} fill="none"
      stroke=${g.fill} stroke-opacity=${g["fill-opacity"]}
      stroke-width="1" stroke-dasharray="2 2" />`)}if(e.drawsNowLine&&e.nowIndex!==void 0&&e.nowIndex<t.count){let y=t.markerCenter(e.nowIndex,e.style==="bars").x,g=xe(e.nowColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${y} ${t.plotTop} L${y} ${t.plotBottom}`} fill="none"
      stroke=${g.fill} stroke-opacity=${g["fill-opacity"]} stroke-width="1" />`)}return d.size===0?v`${l}`:v`<defs>${[...d.values()]}</defs>${l}`}function Df(e,n,t){return`chartfade-${e}-${n}-${t}`.replace(/[^0-9A-Za-z_-]/g,"")}function ds(e,n,t,i){let a=(e.labelsAbove?n.y:n.y+n.h-i)+i/2,r=xe(e.labelColorHex,"fill");return e.labels.map((o,s)=>{let d=s===e.labels.length-1?"end":s===0?"start":"middle",c=n.x+o.position*n.w;return v`<text x=${c} y=${a} text-anchor=${d} dominant-baseline="central"
      font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
      font-size=${t} font-weight="400"
      fill=${r.fill} fill-opacity=${r["fill-opacity"]}>${o.text}</text>`})}function Of(e,n){if(e.runs.length===0&&e.labels.length===0||n.w<=0||n.h<=0)return f;let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ri(e,n),o=Math.max(0,Math.min(e.gap,n.w/Math.max(1,e.runs.length))),s=e.runs.map((l,d)=>{let c=n.x+l.start*n.w,u=(l.end-l.start)*n.w,p=d===e.runs.length-1,m=Math.max(p?u:Math.min(u,.5),u-(p?0:o)),y=Math.max(0,Math.min(e.cornerRadius,m/2,a.h/2)),g=xe(l.colorHex,"fill");return v`<rect x=${c} y=${a.y} width=${m} height=${a.h} rx=${y}
      fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`});return r?v`${s}${ds(e,n,t,i)}`:v`${s}`}function Vf(e,n){if(e.labels.length===0||n.w<=0||n.h<=0)return f;let{labelSize:t,rowHeight:i}=ri({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),a={...n,y:n.cy-i/2,h:i};return v`${ds({labels:e.labels,labelColorHex:e.labelColorHex,labelsAbove:!1},a,t,i)}`}function zc(e,n){if(!(e===void 0||n.w<=0||n.h<=0))return{chart:e,g:Xa(e,ri(e,n).body)}}function Bf(e,n,t,i=!1,a=0){let r=zc(t,n);if(e.indices.length===0||r===void 0)return f;let o=r.chart,s=o.pointColorHexes.length===o.values.length,l=Math.max(e.diameter/2,a),d=new Map,c=l+1.2,u="";for(let m of e.indices){if(m>=o.values.length)continue;let y=r.g.point(m),g=e.colorHex??(s?o.pointColorHexes[m]:o.colorHex);d.set(g,`${d.get(g)??""}M${y.x-l} ${y.y} a${l} ${l} 0 1 0 ${2*l} 0 a${l} ${l} 0 1 0 ${-2*l} 0 Z`),i&&(u+=`M${y.x-c} ${y.y} a${c} ${c} 0 1 0 ${2*c} 0 a${c} ${c} 0 1 0 ${-2*c} 0 Z`)}let p=i&&u!==""?v`<path d=${u} fill="none" stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f;return v`${p}${[...d].map(([m,y])=>{let g=xe(m,"fill",o.colorHex);return v`<path d=${y} fill=${g.fill} fill-opacity=${g["fill-opacity"]} stroke="transparent" stroke-width="3" />`})}`}function Gf(e,n,t,i=!1,a=0){let r=zc(t,n);if(!e.draws||r===void 0)return f;let o=Ue(e.colorHex)??{color:"#FFFFFF",opacity:.2},s=bc(r.g,e.lines);return v`${s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none"
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Kf(e,n,t){if(e.path!==void 0&&e.path!==""){let o=xe(e.colorHex,"fill"),s=e.size*Sf;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
      <path d=${e.path} fill=${o.fill} fill-opacity=${o["fill-opacity"]} /></g>`}let i=t.render(e.symbol,e.size,e.colorHex);if(i)return v`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=xe(e.colorHex,"stroke"),r=e.size;return v`
    ...
    </div></div>`}function Vn(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Ne(e,nn(n,i.def,t,a),Lr(n,t,i))}
    ...
    <div class="color-row">
      ...
      <span class="color-swatch" style=${`--sw:${i||!r?"transparent":o}`} title="Pick a colour">
        <input type="color" .value=${s} ?disabled=${i} aria-label=${`${e}: pick a colour`} @input=${be(d=>t(kr(d,l)))} />
      </span>
    ...
    <span class="sym-name">${n}</span>
      ...
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${be(P=>r.setQuery(i,P))} />
      </div>
    ...
    </div>`}else if(o){let C=r.category(i),S=qg(C,s,d,c),I=gs(S.names,s),L=S.fromPack?I.slice(0,zu):I,P=r.recent.filter(R=>!R.startsWith(Oe)),J=c.size===0?P:P.filter(R=>c.has(R));k=h`<div class="sym-browse">
      ${m?Du(r,i,y):f}
      <div class="sym-controls">
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${be(w)} @change=${be(C=>{let S=C.trim();S.startsWith(Oe)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed(C):(c.size===0||c.has(S))&&r.noteUsed(C)})} /></label>
    ...
    ${k}`}function Jg(e,n){let t=e.trim();return t!==""&&!t.startsWith(Oe)&&n.size>0&&!n.has(t)}function Zg(e,n){let t=n.trim(),i=t.startsWith(Oe)?t.slice(Oe.length):t,a=e.map(r=>r.startsWith(Oe)?r.slice(Oe.length):r);return gs(a,i).map(r=>Oe+r)}function Du(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
    ...
    ${a.map((c,u)=>h`
      <div class="band-row ${o===c.id?"hit":""}">
        ...
        <input type="number" class="band-up" step="any" .value=${String(c.upTo)} aria-label="Up to"
          ...
          @change=${be(p=>{let m=Number(p);p.trim()!==""&&Number.isFinite(m)&&t(s(c.id,y=>{y.upTo=m}))})} />
    ...
    <div class="band-row ${o==="above"?"hit":""}">${Ar(d)}
      <span class="le" aria-hidden="true">&gt;</span>
    ...
    ${e.bands.map((o,s)=>h`
      <div class="row-inline">
        ${Se("State",o.match,l=>n(d=>{let c=d.bands[s];c&&(c.match=l)},`tmatch${o.id}`),{placeholder:"on",list:i})}
    ...
    ${Qi.has(n)?pp(e,i,a,r):f}
        ...
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?_i(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            ...
            or choose another source and click Make shared.</div>`:h`${ve("Value",a.id,[["","(choose)"],...e.config.values.map(p=>[p.id,p.name||p.id.slice(0,8)])],p=>r({...a,id:p}))}
          ...
          ${ve("Chart",a.layer,[["","(choose)"],...u.map(p=>[p.payload.id,ke(p,c)])],p=>r({...a,layer:p}))}
          ${ve("Number",a.stat,[...vn],p=>r({...a,stat:p}))}
    ...
    <div class="grid2">
      ...
      ${Se("Before",i.prefix??"",s=>a({prefix:s}),{placeholder:"text in front"})}
      ${Se("After",i.suffix??"",s=>a({suffix:s}),{placeholder:"text after"})}
    </div>
    ...
    ${ve("Function",n.function,[["count","Count"],["sum","Sum"],["average","Average"],["min","Min"],["max","Max"]],s=>t({...n,function:s}))}
    ...
    ${o.kind==="filter"?h`<div class="grid2">
          ${Se("Domains",a(o.domains),s=>t({...n,scope:{...o,domains:r(s)}}),{placeholder:"light, switch"})}
          ${Se("Area ids",a(o.areaIds),s=>t({...n,scope:{...o,areaIds:r(s)}}))}
          ${Se("Label ids",a(o.labelIds),s=>t({...n,scope:{...o,labelIds:r(s)}}))}
          ${Se("Floor ids",a(o.floorIds),s=>t({...n,scope:{...o,floorIds:r(s)}}))}
    ...
    <div class="gen-row">
      ${Se("Name",n.name,s=>e.update(l=>{l.name=s},"name"))}
      ${ve("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${ve("Tap action",t.type,mp,s=>e.update(l=>{l.tapAction=fp(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Gy(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Uy(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Oy(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Bn(e,n=kn){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function Ky(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Ct}, so they are averaged into ${Ct} even slots to cover ${a}.`}var $r=new Set;function Ds(e,n,t=kn){return $r.has(e)||!t.some(i=>i.minutes===n)}function Hs(e,n,t,i,a=kn){let r=Ds(e,n,a);return h`<label class="field">${Ne("Span",{atDefault:n===t&&!r,title:`Back to ${Bn(t,a)}`,reset:()=>{$r.delete(e),i(t)}})}
      ...
      </select></label>`}function Is(e,n,t=!1){let i=t?mo:Ha,a=Math.floor(i/1440),r=t?Fi:kn,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function jy(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Ae(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Te(p,t,i,{frame:$s(o,c)}),`${a}-${u}-${t}`),l=!Mr(o,Mi)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return we(e,"placement","Position",h`
      ...
      ${We("Hidden",r.isHidden,u=>e.update(p=>Te(p,t,i,{isHidden:u})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`})}return d?.place==="through"?we(e,"placement","Position",h`
      ...
      ${We("Hidden",r.isHidden,c=>e.update(u=>Te(u,t,i,{isHidden:c})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`}):we(e,"placement","Position",h`
    ${Ku(e,n,t)}
    ${d===void 0?h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function qy(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ve(e.config,t)[0];return we(e,"tappable","Tap",wb(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?St(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Va(a,t))}:{}})}function Yy(e,n,t,i,a){return h`
    ...
    </div>`,y=s?n.minSource:n.maxSource;return d==="number"||y===void 0?h`<div class="field gauge-end">${m}${_r(c,u,{ariaLabel:l})}</div>`:h`<div class="field gauge-end">${m}${oe(e,y,g=>a(x=>{s?x.minSource=g:x.maxSource=g},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
    ...
    ${ee("Colour",a,Ps,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=Tr(Ge(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    </button>`}),I=r.rules.some(_=>_.partId===c.id),L=c.value.kind.kind==="literal",P=Os(c),J=c.fontSize!==void 0,R=pi.find(([_])=>_===r.fontWeight)?.[1]??r.fontWeight,A=_=>{_>=Ls&&_<=_s&&g(K=>{K.fontSize=_},"size")},j=P==="bands"?Ge(e.resolve(c.value)??""):[],U={layer:"Use the layer colour",...L&&P!=="bands"?{bands:"By value needs a live value"}:{}},ie=(_,K)=>g(b=>{let $={bands:b.bands??[],bandAboveColorHex:b.bandAboveColorHex??se};_($),$.bands.length>0?b.bands=$.bands:delete b.bands,$.bandAboveColorHex!==se?b.bandAboveColorHex=$.bandAboveColorHex:delete b.bandAboveColorHex},K);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      ...
      <label class="field num part-size">${Ne("Font size",J?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>g(_=>{delete _.fontSize})}:void 0,Lr(c.fontSize??m,A,{step:1,min:Ls,max:_s}))}
        ${_r(c.fontSize,_=>{_===void 0?g(K=>{delete K.fontSize},"size"):A(_)},{step:1,min:Ls,max:_s,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:J?"Part font size":`Part font size, ${m} pt from the layer`,...J?{}:{lead:B("link")}})}
      </label>
    </div>
  </div>`}function Tp(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,$)=>e.update(T=>b(T.elements[r]),$?`${o}-${$}`:void 0),l=Ae(e.config,t,n),d=l.frame,c=(b,$)=>e.update(T=>Te(T,t,a,{frame:$s(d,b)}),`${o}-${$}-${t}`),u=$e(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],y=!1,g=b=>On(n)===void 0?f:he(b,On(n),$=>s(T=>{On(T)!==void 0&&(T.payload.colorSlot.baseColorHex=$??"#FFFFFF")},"color"),!1,p),x,w,k;switch(n.kind){case"text":{let b=($,T)=>s(M=>$(M.payload),T);w=ub(e,n,t,b,o),y=!n.payload.countdown&&!nt(n.payload),k=h`
        ...
        ${ee("Colour",b.coloring,Ps,M=>$(F=>{F.coloring=M,M==="bands"&&F.bands.length===0&&(F.bands=Tr([F.minValue,F.maxValue]))}),{def:u.coloring})}
        ${g("Main colour")}
        ${b.coloring==="bands"?h`
        ...
        ${T?f:h`
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,$=(E,z)=>s(Ee=>E(Ee.payload),z),T=u.historyMinutes,M=u.historyPoints,F=b.historyMinutes>0,G=F&&b.source==="statistics",Z=F&&!G,pe=F?G?"statistics":"history":"value",yt=G?Fi:kn,It=Cn(b)??Sn(b),Le=b.value.kind.kind==="entityState",me=It===void 0?void 0:e.historySeries(It),Pe=F&&Le?me??"":e.resolve(b.value)??"",je=b.historyPoints<1,ph=Z&&Le&&It!==void 0?e.historyReadings?.(It):void 0,dl=Ky(je,ph,Bn(b.historyMinutes)),cl=Ds(a,b.historyMinutes,yt),Br=F&&Le?Qo(Pe):{values:Ge(Pe),holes:[]},Wn=Br.values,ul=E=>b.limit>0&&E.length>b.limit?b.takeFromEnd?E.slice(E.length-b.limit):E.slice(0,b.limit):E,hh=ul(Wn),Lt=es(hh,tt(b.smoothing),Br.holes.length>0?ul(Br.holes):[]),mh=!F&&Le&&Wn.length===1,Gr=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),pl=le(e),ra=b.scaleFrom!==void 0&&Gr.some(E=>E.payload.id===b.scaleFrom);w=h`
        ...
        ${G?h`
            ...
            <div class="grid2">
              ${Hs(a,b.historyMinutes,T,E=>$(z=>{z.historyMinutes=E}),Fi)}
              ${ee("Per",b.statPeriod,Ea,E=>$(z=>{z.statPeriod=E}),{def:Ti})}
            </div>
            ${cl?Is(b.historyMinutes,E=>$(z=>{z.historyMinutes=E},"span"),!0):f}
            ${ee("Read",b.statType,so,E=>$(z=>{z.statType=E}),{def:Ei})}
        ...
        ${Z?h`
            ${Le?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Hs(a,b.historyMinutes,T,E=>$(z=>{z.historyMinutes=E}))}
                ...
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Points">
                    ...
                    <button type="button" role="radio" aria-checked=${je?"true":"false"} class=${je?"on":""}
                      ...
                      @click=${()=>{je||$(E=>{E.historyPoints=fo})}}>Every one</button>
                  </div>
                  ${je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${be(E=>{let z=Number(E);E.trim()!==""&&Number.isFinite(z)&&z>=1&&$(Ee=>{Ee.historyPoints=Math.round(z)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${cl?Is(b.historyMinutes,E=>$(z=>{z.historyMinutes=E},"span")):f}
        ...
        ${ve("Smooth data",tt(b.smoothing)??"off",iy,E=>$(z=>{let Ee=tt(E);Ee===void 0?delete z.smoothing:z.smoothing=Ee}),{def:tt(u.smoothing)??"off"})}
        ${en(e)}
        ...
        ${b.style==="bars"?h`
          ...
          ${b.style==="area"?h`
            ...
            ${Ns("Fill colour",b.fillColorHex,"Line colour",E=>$(z=>{E===void 0?delete z.fillColorHex:z.fillColorHex=E},"fillcol"))}
            ${en(e)}`:f}`}
        <div class="grid2">
        ...
        ${Gr.length===0?f:ve("Same scale as",ra?b.scaleFrom:"",[["","Its own"],...Gr.map(E=>[E.payload.id,ke(E,pl)])],E=>$(z=>{E?z.scaleFrom=E:delete z.scaleFrom}),{def:""})}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(z=>{E=Yd(z,a,Ee=>ke(Ee,pl))}),E&&e.selectLayer(E)}}>${B("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${ee("Colour",b.coloring,Ps,E=>$(z=>{z.coloring=E,E==="bands"&&z.bands.length===0&&(z.bands=Tr(Lt))}),{def:u.coloring})}
        ${g("Main colour")}
        ${b.coloring==="bands"?h`
        ...
        <div class="field list-field"><span>Draw</span>
          <div class="adders">
            ...
            ${jn("Zero line",ml,E=>{Ho(E,a)})}
            ${jn("Clock times",gh,E=>{Mn(E,a)},xh)}
            ${jn("Dots",yh,E=>{Fo(E,a)},vh)}
            ${jn("Grid lines",bh,E=>{Ao(E,a)})}
          </div>
        </div>
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${en(e)}`;break}case"timeline":{let b=n.payload,$=(me,Pe)=>s(je=>me(je.payload),Pe),T=u.historyMinutes,M=b.value.kind.kind==="entityState",F=ut(b),G=F===void 0?void 0:e.historySeries(F),Z=it(b)*60,pe=Vi(G??"",Yt),yt=Ds(a,b.historyMinutes),It=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,Le=cy(pe,Z,It===void 0?void 0:e.hass.states[It]?.state,It?.split(".")[0]);w=h`
        ...
        ${Hs(a,b.historyMinutes,T,me=>$(Pe=>{Pe.historyMinutes=me}))}
        ${yt?Is(b.historyMinutes,me=>$(Pe=>{Pe.historyMinutes=me},"span")):f}
...
`;break}case"shape":w=h`<div class="grid2">
        ...
        ${Vn("Zoom",b.zoom,G=>$(Z=>{Z.zoom=G},"zoom"),{min:cs,max:4,step:.05,def:1,format:G=>`${G.toFixed(2)}x`,unit:"x"})}
        ...
        <div class="field readout"><span>${M?.kind==="timeline"?"Timeline":"Chart"}</span><span class="readout-v">${M?h`<button class="small" title=${`Select that ${F}`} @click=${()=>e.selectLayer(M.payload.id)}>${ke(M,le(e))}</button>`:"None"}</span></div>
        ...
        <div class="field readout"><span>Picture</span><span class="readout-v">${T?h`<button class="small" title="Select that picture" @click=${()=>e.selectLayer(T.payload.id)}>${ke(T,le(e))}</button>`:"None"}</span></div>
        ...
        <div class="grid2">
          ...
          ${Ns("Dot colour",b.colorHex,"Series colour",Z=>$(pe=>{Z===void 0?delete pe.colorHex:pe.colorHex=Z},"dotcol"))}
        </div>
        ...
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let C=y||On(n)===void 0?void 0:g(n.kind==="shape"?"Fill colour":n.kind==="text"&&nt(n.payload)?"Layer colour":"Colour"),S=zo(e.config,n),I=S?{kind:{kind:"entityState",...S}}:void 0,L=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,P=mb[n.kind],J=fb[n.kind],R=As(n.payload,u,P),A=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,j=e.config.perFamily[t]?.placements[a]?.size!==void 0,U=As(n.payload,u,J)||A!==void 0&&l.size!==void 0&&l.size!==u[A],ie=En(e.config,a),_=(b,$)=>()=>s(T=>yr(T.payload,u,b),$),K=h`<section class="sec name-sec" data-open="true" style=${`--c:${Q.place}`}>
    <div class="sec-h pinned">
      <span class="swatch">${B("text")}</span>
      <h4>Name${Ar(n.payload.name===void 0?void 0:{atDefault:!1,title:"Go back to the automatic title",reset:()=>s(b=>{delete b.payload.name},"reset-name")})}</h4>
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${Ep(n,le(e))}
        @input=${be(b=>s($=>{let T=$b(b);T===void 0?delete $.payload.name:$.payload.name=T},"name"))} />
    </div>
  </section>`;return h`
    ${K}
    ${we(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:$p(e,n,o)}${w}`,{color:Q.content,icon:"content",summary:Ws(e,n),...R?{reset:()=>s(b=>{yr(b.payload,u,P),b.kind==="text"&&qi(b.payload.rules)},"reset-content")}:{}})}
    ${k===void 0&&C===void 0?f:we(e,"look",n.kind==="image"?"Picture":"Look",h`${k??f}${C??f}`,{color:Q.look,icon:n.kind==="image"?"image":"look",...Rr(n)?{summary:Rr(n)}:{},...U?{reset:()=>e.update(b=>{yr(b.elements[r].payload,u,J),j&&Te(b,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?we(e,"numbers","Extras",xb(e,n,x),{color:Q.numbers,icon:"text",summary:bb(e,n),...ie.length>0||De(e.config,a).length>0||Xt(e.config,a).length>0||Rn(e.config,a).length>0||Fn(e.config,a).length>0||As(n.payload,u,qu)?{reset:()=>e.update(b=>{for(let T of En(b,a))ge(b,T.payload.id);for(let T of De(b,a))ge(b,T.payload.id);for(let T of Xt(b,a))ge(b,T.payload.id);for(let T of Rn(b,a))ge(b,T.payload.id);for(let T of Fn(b,a))ge(b,T.payload.id);let $=b.elements.find(T=>T.payload.id===a);$&&yr($.payload,u,qu)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?hb(e,n):f}
    ${we(e,"states","States",_p(e,n.payload.rules,n.kind,b=>b.elements.find($=>$.payload.id===a)?.payload.rules,`rules-${a}`,I,L),{color:Q.states,icon:"states",summary:Ki(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:jy(e,n,t)}
    ${i.tap===!1?f:qy(e,n)}`}function hb(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?Xt(e.config,t):Mo(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(u=>{let p=u.elements.find(y=>y.payload.id===t);if(!p)return;let m=p.payload.frame;p.payload.frame={...Ae(u,o,p).frame},i?Mn(u,t):Ro(u,t,ue[o==="inline"?"rectangular":o]),p.payload.frame=m}),l=a.length>0,d=a.map(u=>({el:u,lead:B("clock"),title:r,kind:i?"Times":"Timestamp"})),c=h`
    <div class="field list-field"><span>Draw</span>
      <div class="adders">
    ...
    </div>`})}</div>`}function vb(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);m&&c(m)},`${i}-${u}`),o=$e(n.kind).payload,s=On(n),l=s===void 0?f:he("Colour",s,c=>r(u=>{On(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ${c.kind==="chartStat"?ve("Number",c.stat,[...vn],u=>r(p=>{p.kind==="text"&&p.payload.value.kind.kind==="chartStat"&&(p.payload.value={...p.payload.value,kind:{...p.payload.value.kind,stat:u}})},"stat")):d||nt(n.payload)?f:oe(e,n.payload.value,u=>r(p=>{p.kind==="text"&&(p.payload.value=u)},"value"),{showResolved:!0,label:n.payload.countdown?"Until":"Text",key:`${i}-value`})}
    ...
    <div class="grid2">
      ${ve("Reading",t.at,a,r=>i(o=>{o.payload.chartAnchor&&(o.payload.chartAnchor.at=r)},"at"))}
      ${ve("Sits",t.place,Ma.filter(([r])=>r!=="through"),r=>i(o=>{o.payload.chartAnchor&&(o.payload.chartAnchor.place=r)},"place"))}
    </div>`}function wb(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ve(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=No(e.config,n);return h`
          ...
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${Na(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...$o}})}>${B("reset")}</button>`}
            </div>
          </div>
        </div>
        ${yb(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${St(o)}</b>.</div>`}`}function Xu(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function kb(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function ke(e,n){return e.payload.name?e.payload.name:Ep(e,n)}function $b(e){let n=e.trim();return n===""?void 0:n}function Ep(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=Ut.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return Xu(Ce(e.payload.value,n));case"icon":return Xu(Ce(e.payload.symbol,n));case"gauge":return Ce(e.payload.value,n);case"chart":return Ce(e.payload.value,n);case"timeline":return Ce(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines";case"imageTime":return"Timestamp"}}function Mp(e,n){let t=Et(e.config,n.id),i=le(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return we(e,"content","Group",h`
    ${Se("Name",n.name,r=>a(o=>{o.name=r},"name"))}
    ...
    ${Ys(e,t.map(r=>({el:r,lead:B(r.kind),title:ke(r,i),kind:Zt[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Li(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      ...
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ne(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=Pr(e.config,n),r=t.backgroundColorHex?Re(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Re(t.borderColorHex)} border`:"no border";return h`
    ${we(e,"look",`${ne(n)} shape`,h`
    ...
    ${n==="corner"?we(e,"corner","Corner content",Sb(e,t,i),{color:Q.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${we(e,"states","Shape states",_p(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:Q.states,icon:"states",summary:Ki(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ${we(e,"placements","Layers",h`
    ...
    ${we(e,"content","Inline text",h`
      ${Se("Label (blank = value only)",n.label??"",a=>t(r=>{a?r.label=a:delete r.label},"label"))}
      ${oe(e,n.value,a=>t(r=>{r.value=a},"value"),{showResolved:!0,label:"Text",key:"inline-value"})}
      ${js(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:Q.content,icon:"text",summary:ze(`${n.label?`${n.label}: `:""}${Ce(n.value,i)}`,48)})}
    ${we(e,"symbol","Symbol",h`
    ...
    ${Hp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${oe(e,s.upper??H(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${Se("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ...
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=zb(n.value)?Nb(s.options??[],u=>o(p=>{p.comparison.options=Ss(u)},"options")):Se("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${ve("Comparison",s.kind,tc.map(u=>[u,li[u]]),u=>o(p=>{p.comparison=qo(p.comparison,u)}))}
    ${c}
    ...
    <div class="states">
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${Dr(S.map(b=>mt[b]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ...
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(b=>ws(b,!0))}>${B("plus")}<span>Otherwise</span></button>`:f}
      ...
      <div class="states-switch">
        <button class="link" @click=${b=>{Vs.add(r),Fe(b.target)}}>Advanced</button>
  ...
  </tr>`}function Gb(e,n,t,i,a){let r=dr(t,n),o=Nr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${mt[n]} for this state`}
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${up}>
      ...
      <span class="cell-word">${a?Re(a):Ce(i,le(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Ce(i,le(e))}</span>`}function Re(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Kb(e,n,t,i){let a=In(n.kind),r=bs(n.kind),o=(s,l,d,c)=>jb(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${be(s=>i(l=>{let d=qo(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${ys.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Wb(s)}</option>`)}
    </select>
...
`)}var oh="wrist-assistant-panel.layers.v1",At=34,Kn=200,Dx=720,Vr=320,Ox=80,Vx=56,sh="wrist-assistant-panel.columns.v3",al=e=>Math.max(Kn,Math.min(Dx,Math.round(e))),lh=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Bx(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Gx=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,aa=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",sn=aa==="Cmd"?"\u2318":"Ctrl+",rl=aa==="Cmd"?"\u21E7":"Shift+";function dh(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Ox;if(i>=Kn*2+Vr){let r=i-Vr,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Kn,Math.floor(o*l)),s=Math.max(Kn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Kn,o-d):s=Math.max(Kn,s-d))}return{columns:3,left:o,right:s}}let a=e-Vx;return a>=Kn+Vr?{columns:2,left:Math.min(n,a-Vr),right:t}:{columns:1,left:n,right:t}}var N=class N extends _t{constructor(){super(...arguments);this.narrow=!1;this.colLeft=ih;this.colRight=ah;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=oi.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Zc(()=>this.requestUpdate());this.imageSizes=Qc(()=>this.requestUpdate());this.symbols=new rr(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new lr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=el(a,this.hass.states);r.some(s=>Us(th(s.entityId)))||tl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Us(eh)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Ix}static{this.styles=Kr`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Hr,this.scrubStart),this.addEventListener(Ir,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Ax)}loadColumnWidths(){try{let t=window.localStorage.getItem(sh);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=al(i.left)),typeof i.right=="number"&&(this.colRight=al(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(sh,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(oh);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(oh,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${hs.length} kinds · ${ia.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${hs.map(s=>h`<button class="add" style=${`--k:${Ke[s]}`} ?disabled=${i} title=${`Add a blank ${Zt[s].toLowerCase()} layer`}
              @click=${()=>{let l=$e(s);this.addHere(d=>{d.elements.push(l),l.kind==="timeline"&&Mn(d,l.payload.id)}),this.inspect={kind:"layer",id:l.payload.id}}}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="right">
          <span class="badges">
            ${b?h`<span class="badge tap" title=${`Tappable \xB7 ${ke(b,d)}`}>tap</span>`:f}
        ...
        <span class="name">
          ...
          ${S?h`<span class="facts"><span class="fact"><b>Holds</b> ${A.map(T=>ke(T,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${y=>{y.stopPropagation(),this.mutate(g=>{Bo(g,c.id)}),p&&(this.openValue=void 0)}}>${B("delete")}</button>`:f}
        </div>
        ${p?h`<div class="value-open">${xp(s,c)}</div>`:f}</div>`})}
          ...
          ${B("plus")}${ne(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?er(c,{icons:this.icons,imageSizes:this.imageSizes,slot:oi.slots[r]}):f}let l=r!=="inline"&&Pr(t,r)===0&&t.elements.length>0,d=this.canEdit&&nr(t,r);return h`<span class="tab-wrap">
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${we(a,"complication","Complication",yp(a),{color:Q.complication,icon:"watch",alwaysOpen:!0})}
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([_x(r)]):new Set(Bs)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
            ...
            <div class="picked">
              ${c.map(m=>h`<div class="row" style=${`--k:${Ke[m.kind]}`}>
                ...
                <span class="name">
                  ...
                  <b>${ke(m,o)}</b><span class="kind">${Zt[m.kind]}</span>
                </span>
              </div>`)}
            </div>
            <div class="row-acts">
      ...
      ${we(r,"picked-common",`All ${d} at once`,h`
