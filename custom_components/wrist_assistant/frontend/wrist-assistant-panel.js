...
`)}function Fc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Sf(r));return{values:t,nullKeys:i}}function Sf(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function us(e){let n=nr(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Tf(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Eo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Ef=10800;function Mf(e,n,t){let i=n==="always"||n==="auto"&&t<=Ef;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function ir(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Mf(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Rf(e,n){return gt(e)===void 0?[]:ir(ot(e)*60,Ni(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Ff(e,n){return Fn(e)?ir(Math.round(e.historyMinutes)*60,Ni(ht(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Af(e,n,t,i){return n===void 0&&i!==void 0?gt(i)===void 0?[]:ir(ot(i)*60,Ni(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!Fn(n)?[]:ir(Math.round(n.historyMinutes)*60,Ni(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Bn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ke(e){let n=e.trim(),t=Bn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Bn(i)}function Hf(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function If(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Lf(e){let n=e.trim(),t=Bn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Bn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Bn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function _f(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function zf(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Pf(e,n,t){if(Ie(n))return e;let i=n,a=e,r=Bn(e.trim()),o=i.duration?Lf(e):void 0;if(o!==void 0)a=_f(o);else if(i.relativeTime&&r!==void 0)a=If(r);else{let s=Ke(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Hf(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=zf(a);break}return a}function ui(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function We(e,n=240){return _c(e,n).map(t=>t.value)}function hs(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of We(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:Lc(r)}}function Lc(e){return e.some(n=>n)?e:[]}function _c(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Ac(e,n,t){let i=_c(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Jt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??le,c=t.highColorHex??Ze,u=t.lowColorHex??Qe,p=[],m=(y,b)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===b?k.text+=y:p.push({text:y,colorHex:b})},g=0;return i.forEach((y,b)=>{m(e.slice(g,y.start),n);let k=b===o?c:b===s?u:l.length>0?Da(y.value,l,d):n,C=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,C),k),g=C}),m(e.slice(g),n),p}function Hc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Nf(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function qi(e,n=tn){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Df(i.slice(a+1))})}return t}function Df(e){try{return decodeURIComponent(e)}catch{return e}}function Of(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Ic(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Vf(e,n,t){if(e===void 0)return 0;let i=Ke(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var bt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=Hc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=An(n),i=Hn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?hs(a):{values:We(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=Lc(s),{values:ms(o,at(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ke(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ke(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Hc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ie(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Tf(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?zd(r):Eo(r,a.domainMax-a.domainMin));break}default:{let a=cs(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Pf(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Bn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?ui(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ke(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ke(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ke(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Dn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Dn(d),p=c===void 0?void 0:Dn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(ze[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Ac(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=rt(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(Ad(n.payload)&&(y.spans=Ac(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let k={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(O,I,j)=>O??(I?Ke(this.resolve(I)??""):void 0)??j,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Ke(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=Da(k,Jt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let O=Ke(this.resolve(p.total)??"");O!==void 0&&(w=O)}let S=Ic(w,1,Na),H={kind:"gauge",...u,fraction:Vf(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:Ic(k??0,0,S)};if(p.thresholdValue!==void 0&&b!==y){let O=(p.thresholdValue-y)/(b-y);O>=0&&O<=1&&(H.thresholdFraction=O)}return H}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Jt(p),w=_d(p)?g.map(Z=>Da(Z,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",H=p.highlight==="lowest"||p.highlight==="both",O=Ai(p),I={kind:"chart",...u,values:g,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?O.high:"none",lowMarker:H?O.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:at(p.smoothing)??"off",fillStyle:Wt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:jt(p.barRadius),barCorners:qt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Ff(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},j=y.length===0?g:g.filter((Z,_)=>!y[_]);if(j.length>0){let Z=A=>g.findIndex((K,R)=>K===A&&y[R]!==!0),_=S?Z(Math.max(...j)):-1,Q=H?Z(Math.min(...j)):-1;_>=0&&(I.highIndex=_),Q>=0&&Q!==_&&(I.lowIndex=Q)}let M=Nf(p,b.min,b.max);M!==void 0&&(I.thresholdY=M);let U=this.chartNowIndex(p,g.length);return U!==void 0&&(I.nowIndex=U),I}case"timeline":{let p=n.payload,m=gt(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=qi(g,tn),b=Of(y,ot(p)*60,C=>Gd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:Rf(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};Ka(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Af(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),g={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(g.url=y),g}case"chartDots":{let p=n.payload,m=pt(p.size),g={kind:"chartDots",...u,chart:p.chart,dots:Ia(p.dots),diameter:0,indices:[]};return m!==void 0&&(g.size=m),p.colorHex!==void 0&&(g.colorHex=p.colorHex),g}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Tn(p.lines),colorHex:Gt(p.colorHex),thickness:En(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...jf(Wf(dc(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,k=this.resolve(b.value),C=k===void 0?void 0:Ke(k);if(C!==void 0){let w=Math.min(b.minValue,b.maxValue),S=Math.max(b.minValue,b.maxValue),H={value:Math.min(S,Math.max(w,C)),minValue:w,maxValue:S===w?w+1:S,colorHexes:b.colorHexes},O=this.resolve(b.minLabel);O!==void 0&&(H.minLabel=O);let I=this.resolve(b.maxLabel);I!==void 0&&(H.maxLabel=I),l.bezelGauge=H}}let g=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;g!==void 0&&(l.backgroundColorHex=g);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function Bf(e,n,t){let i=new bt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Yi(e,n,t){let i=new bt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Bf(e.inline,n,e)),a}function ar(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var ps=5,Gf=1.7,Uf=1.8;function Kf(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Wf(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Uf,l=Math.max(o.frame.width*n.width,0),d=Kf(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function zc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function Pc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function rr(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=I=>I==="triangle"?ps+d:I==="dot"?Math.max(d,Gf):d,u=c(a),p=c(r),m=n.y+u,g=Math.max(n.h-u-p,1),y=m+g,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?g*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-w*(i-1))/i,.5),H=I=>Math.min(1,Math.max(0,(I-e.domainMin)/b)),O=I=>y-H(I)*g;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:O(0),inset:d,yAtFraction(I){return y-Math.min(Math.max(I,0),1)*g},barRect(I){let j=o+I*(S+w),M=t[I],U,Z;if(k){let _=C+H(M)*(g-C);U=y-_,Z=y}else U=O(M),Z=k?y:O(0),U>Z&&([U,Z]=[Z,U]);return{x:j,y:U,w:S,h:Math.max(Z-U,.5)}},point(I){let j=Math.max(s-d*2,0);return{x:t.length>1?o+d+j*I/(t.length-1):o+s/2,y:O(t[I])}},markerCenter(I,j,M="high"){let U=j?this.barRect(I):void 0,Z=U?U.x+U.w/2:this.point(I).x,_=M==="high"?a:r,Q=M==="high"?_==="triangle"?n.y+ps/2:m:_==="triangle"?n.y+n.h-ps/2:y;return{x:Z,y:Q}}}}function Nc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function ms(e,n,t=[]){let i=e.length,a=Fd(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,g=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,k=Math.exp(-(b*b)/(2*o*o));m+=e[y]*k,g+=k}return m/g}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function Dc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var ji=1;function pi(e,n){let t=Math.max(Qt,Math.min(en,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-ji>=2,r=a?{...n,y:e.labelsAbove?n.y+i+ji:n.y,h:n.h-i-ji,cy:(e.labelsAbove?n.y+i+ji:n.y)+(n.h-i-ji)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function jf(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&zc(r)===void 0)return{...i,isHidden:!0};let o=Yf(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function qf(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Yf(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=ar(t,i);if(a.w<=0||a.h<=0)return;let r=pi(t,a).body;if(r.w<=0||r.h<=0)return;let o=rr(t,r),s,l;if(ft(n.at)){let k=qf(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?zc(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,w)=>C>w?(C+w)/2:Math.min(Math.max(k,C),w),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var Le=pe,Xi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Le,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],hi=Xi.find(e=>e.measured);function Yc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Xi.find(a=>a.screen.width===t&&a.screen.height===i)}function sr(e,n){let t=Le[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var bs={regular:400,medium:500,semibold:600,bold:700},Xf=1.15;function je(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function we(e,n,t="#FFFFFF"){let i=je(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var _t=e=>e*.55;function Xc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Jf(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Zf(e,n,t){if(t<=0||e.length*_t(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/_t(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Qf(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Jc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Zc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function eg(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Qc(e,n){return e.reduce((t,i)=>t+i.text.length*_t(i.look.fontSize*n),0)}function tg(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:_t(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=_t(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function ng(e,n,t){if(t<=0||Qc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*_t(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*_t(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function ig(e,n,t){let i=eg(n),a=e.lineLimit===2&&t.w>0?tg(e.text,i,t.w):[e.text],r=Jc(e.text,a),o=a.map((C,w)=>Zc(C,r[w]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>Qc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>ng(C,l,t.w)),{anchor:c,x:u}=Xc(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=C=>C.map(w=>{let S=we(w.look.colorHex,"fill");return v`<tspan font-size=${w.look.fontSize*l} font-weight=${bs[w.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${w.text}</tspan>`}),b=we(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,w)=>v`<tspan x=${u} y=${t.cy+m+(w-(d.length-1)/2)*g}>${y(C)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${b.fill} fill-opacity=${b["fill-opacity"]}>${k}</text>`}function ag(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:ig(e,e.parts,n);let t=we(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:ui((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Jf(e.text,n.w/_t(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*_t(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Zf(y,o,n.w)),{anchor:l,x:d}=Xc(e.alignment,n),c=Qf(e.text,e.spans),u=c?Jc(e.text,i):[],p=(y,b)=>c?Zc(y,u[b]??0,e.text,c,e.colorHex).map(k=>{let C=we(k.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}):y,m=o*1.15,g=s.length>1?v`${s.map((y,b)=>v`<tspan x=${d} y=${n.cy+(b-(s.length-1)/2)*m}>${p(y,b)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${bs[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var fs=2;function rg(e,n){let t=we(e.colorHex,"stroke"),i=we(e.trackColorHex,"stroke","#FFFFFF"),a=we(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,g=Math.max(1,e.dotCount),y=m?n.w:n.h,b=m?n.h:n.w,k=Math.max(1,Math.min(b,y/g-fs)),C=g*k+(g-1)*fs,w=(m?n.cx:n.cy)-C/2+k/2;return v`${Array.from({length:g},(S,H)=>{let O=w+H*(k+fs),I=H<e.filledCount?t:i;return v`<circle cx=${m?O:n.cx} cy=${m?n.cy:O} r=${k/2}
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        stroke-width="1" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" pointer-events="none" />`):f}`}function fg(e){let n=Math.min(e.w,e.h);return{x:e.cx-n/2,y:e.cy-n/2,w:n,h:n,cx:e.cx,cy:e.cy}}var gg=4;function yg(e,n){let t=e.w>=e.h,i=t?e.h:e.w,a=Math.min(i,Math.max(gg,Math.max(0,n)));return t?{x:e.x,y:e.cy-a/2,w:e.w,h:a,cx:e.cx,cy:e.cy}:{x:e.cx-a/2,y:e.y,w:a,h:e.h,cx:e.cx,cy:e.cy}}function bg(e,n){let t=we(e.fillColorHex,"fill"),i=e.borderColorHex?je(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return v`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function xg(e,n,t){if(e.path!==void 0&&e.path!==""){let o=we(e.colorHex,"fill"),s=e.size*Xf;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Cs=.25,vg=8;function wg(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Cs),vg),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),b=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+b)+0,width:m,height:g}}function nu(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var or=4;function kg(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+or:n.x+n.w-or-a,d=e.timestampCorner.startsWith("top")?n.y+or:n.y+n.h-or-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function $g(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Cg(e,n,t){let i=t.icons,a=`imgclip-${eu()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?kg(e,n,nu(new Date)):void 0,s=o?iu(o):f,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=wg(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=v`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render($g(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function Sg(e,n){if(!e.linked)return f;let t=nu(new Date),i=nc(n.w,n.h);if(i<=0)return f;let a=t.length*i*.578+i*.89,r=i*1.25;return iu({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function Tg(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Eg(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${xs} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var xs=5;function Eg(e,n){let t=xs*.55,i=n.w-2;if(n.h<xs*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function au(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function vs(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return f;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return f;let d=ar(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=ag(e,d);break;case"icon":u=xg(e,d,t.icons);break;case"gauge":u=rg(e,d);break;case"chart":u=sg(e,d);break;case"timeline":u=ug(e,d);break;case"chartTimes":u=pg(e,d);break;case"imageTime":u=Sg(e,d);break;case"chartDots":u=hg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=mg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=bg(e,d);break;case"image":u=Cg(e,d,t);break;case"tap":u=Tg(e,d,t.icons,r,c?At(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,g=t.highlightId===e.id,y=g||t.highlightIds?.includes(e.id)===!0,b=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",C=t.handles===!0&&(!l||s)&&!b&&!k,w=e.kind!=="shape"?d:e.shapeKind==="circle"?fg(d):e.shapeKind==="line"?yg(d,e.thickness):d,S=y&&!b?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,H=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,O=b?f:v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="transparent" stroke="none" />`,I=3,j=w,M=g&&C?[["nw",j.x,j.y],["ne",j.x+j.w,j.y],["sw",j.x,j.y+j.h],["se",j.x+j.w,j.y+j.h]].map(([U,Z,_])=>v`<rect data-handle=${U} x=${Z-I/2} y=${_-I/2} width=${I} height=${I}
    ...
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function dr(e,n){let t=e.family in Le?e.family:"rectangular",i=n.slot??Le[t],a=Le[t],r=sr(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=je(e.backgroundColorHex),l=je(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=au(c);if(t==="corner"){let b=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",w=C!=="",S=lr(b,k),H=Ss(b,k),O=H/(a.width*b),I=S.tile.cx-H/2,j=S.tile.cy-H/2,M=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,U=f;if(e.bezelGauge)U=Hg(e.bezelGauge,b,o);else if(e.bezelText){let _=Mg(b,`${o}-bezel`),Q=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?ui((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;U=v`<defs><path id=${_.id} d=${_.d} /></defs>
        <text font-size=${Vc*b} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${_.id}" startOffset="50%" text-anchor="middle">${Gc(Q,_.length,Vc*b)}</textPath></text>`}let Z=f;if(w){let _=je(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},Q=ou(b,`${o}-curved`,Rg*b,Fg);Z=v`<defs><path id=${Q.id} d=${Q.d} /></defs>
        <text font-size=${Uc*b} font-weight="600" fill=${_.color} fill-opacity=${_.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${Q.id}" startOffset="50%" text-anchor="middle">${Gc(C,Q.length,Uc*b*.88)}</textPath></text>`}else{let _=e.borderWidth*r.scale*O,Q=l?v`<circle cx=${H/2} cy=${H/2} r=${H/2-_/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${_} />`:f;Z=v`<g transform="translate(${I} ${j})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${qg(e)}</svg>`}var vt="color-mix(in srgb, var(--k) 45%, #6b7280)",gi='system-ui, -apple-system, "Segoe UI", sans-serif';function Lu(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function zs(e,n,t,i){return v`<g fill="none" stroke-linecap="round">
    <path d=${Lu(e,n,t,1)} stroke=${vt} stroke-width="2.6" opacity=".5" />
    <path d=${Lu(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function Yg(e){switch(e){case"text":return v`<g font-family=${gi} text-anchor="middle">
        ...
        <text x="6" y="39" font-family=${gi} font-size="7" fill=${vt}>1h ago</text>
        <text x="114" y="39" font-family=${gi} font-size="7" text-anchor="end" fill=${vt}>now</text>
    ...
    </div>`}function Ty(e,n){let t=i=>un(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${De(e.label,t(e))}
    <div class="pair-row">
    ...
    <div class="color-row">${zr(e,n,i,!1,t)}</div></div>`}function rl(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function qr(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Ey(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function rp(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var Rp=50;function My(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Ry(e,n,t=Rp,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Fy=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Fp(e){return Fy.test(e.trim())}function Ay(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return qr(t,i);if(Fp(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Wn=new Map;function Me(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function ol(e){return Wn.has(e)}function wt(e,n,t,i,a,r={}){let o=e.hass.states,s=Wn.get(a),l=s?Ry(Ey(o,r.domain,rp(e.hass)),s.query,Rp,r.preferNumeric?My:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(w,S,H=0)=>{Wn.set(a,{query:S,index:H}),Me(w)},p=w=>{Wn.delete(a),Me(w)},m=w=>{let S=Ay(w,t,o);S&&i(S)},g=(w,S)=>{i(qr(o,w.entityId)),p(S)},y=()=>Math.max(0,Math.min(Wn.get(a)?.index??0,l.length-1)),b=w=>{let S=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let H=Wn.get(a);if(!H){u(S,S.value);return}let O=w.key==="ArrowDown"?y()+1:y()-1;u(S,H.query,Math.max(0,Math.min(l.length-1,O))),Hy(S);return}if(w.key==="Enter"){w.preventDefault();let H=l[y()];s&&H?g(H,S):(m(S.value),p(S));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),p(S)}},k=t.entityId?rp(e.hass)?.(t.entityId):void 0,C=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let S=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Wn.set(a,{query:"",index:0}),Me(S),S?.focus()}}>${B("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Fp(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${H=>H.preventDefault()} @click=${H=>g(w,H.target)}>
                <span class="ent-ico ${Ks(w.state)?"on":""}">${Us(w.domain)}</span>
                <span class="ent-main">
                ...
                <span class="ent-right">
                  <span class="ent-type">${ap(w.domain)}</span>
                  <span class="ent-state">${w.state}</span>
                </span>
              </button>`)}
        </div>`:C}
  </div>`}function Hy(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var op=120;function Iy(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(fr.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(gr),fromPack:!1}}function sp(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Ly(e){return[{value:"",label:`Starter set (${sp(gr,e)})`},...fr.map(n=>({value:n.name,label:`${n.name} (${sp(n.symbols,e)})`}))]}function _y(e){return e.length>0?e.length:gr.length}function lp(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Tr(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Ap(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Be),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=zy(u,c),b=w=>{t(w),a?.(w.startsWith(Be)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},k=w=>{if(t(w),!m)return;let S=w.trim();a?.(S.startsWith(Be)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&g==="mdi"){let w=e.icons.mdiNames?.(),S=Py(w??[],s),H=S.slice(0,op),O=r.recent.filter(I=>I.startsWith(Be));C=h`<div class="sym-browse">
      ${dp(r,i,g)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${xe(I=>r.setQuery(i,I))} />
      </div>
      ${O.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${O.map(I=>Tr(e,I,I===u,b))}</div>`}
      <div class="sym-grid">${H.map(I=>Tr(e,I,I===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${lp(H.length,S.length,!0,w.length)}</div>`}
    ...
    ${C}`}function zy(e,n){let t=e.trim();return t!==""&&!t.startsWith(Be)&&n.size>0&&!n.has(t)}function Py(e,n){let t=n.trim(),i=t.startsWith(Be)?t.slice(Be.length):t,a=e.map(r=>r.startsWith(Be)?r.slice(Be.length):r);return Fs(a,i).map(r=>Be+r)}function dp(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Ny=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Dy={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Oy=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],Vy=[["flat","Flat"],["fade","Fade"]],Hp=[["auto","Auto"],["all","All"]],By=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],Ip=[["bars","Bars"],["line","Line"],["area","Area"]],Gy=[["auto","Auto"],["fixed","Fixed range"]],Uy=[["lowest","Lowest value"],["zero","Zero"]],Ky=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],el=[["uniform","One colour"],["bands","By value"]];function Pr(e){let n=[Co,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function sl(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Wy(e,n){let t=Jt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function jy(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function qy(e,n,t){let{lo:i,hi:a}=jy(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
  ...
  </div>`}function Nr(e,n,t,i){let a=Jt({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(g=>g.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:rl(l,le),title:`Back to ${le}`,reset:()=>t(c=>{c.bandAboveColorHex=le})};return h`<div class="bands">
    ${qy(a,l,r)}
    ${a.map((c,u)=>h`
    ...
    ${n.function==="count"?f:Ee("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Dp=No,pb=Dp.filter(([e])=>e!=="none");function hb(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Op(e,n){let t=hb(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return Kd(e)?{type:e,...t}:{type:e}}var mb=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Vp(e,n,t,i){let a=n.serviceDataJSON??"",r=Wd(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??gb).slice(0,7)}
  ...
  </section>`}function Cb(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Sb(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Tb(e,n){let t=pe[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Eb(e,n,t){let i=Tb(e,n),a=pe[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Mb(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Rb(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Sb(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Yn(e,n=Rn){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function Fb(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Ft}, so they are averaged into ${Ft} even slots to cover ${a}.`}var Lr=new Set;function tl(e,n,t=Rn){return Lr.has(e)||!t.some(i=>i.minutes===n)}function qs(e,n,t,i,a=Rn){let r=tl(e,n,a);return h`<label class="field">${De("Span",{atDefault:n===t&&!r,title:`Back to ${Yn(t,a)}`,reset:()=>{Lr.delete(e),i(t)}})}
      ...
      </select></label>`}function Ys(e,n,t=!1){let i=t?Mo:Va,a=Math.floor(i/1440),r=t?Pi:Rn,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Hb(e,n,t){let i=n.payload.id,a=`el-${i}`,r=He(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Re(p,t,i,{frame:Ps(o,c)}),`${a}-${u}-${t}`),l=!Dr(o,_i)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return $e(e,"placement","Position",h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function Ib(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ue(e.config,t)[0];return $e(e,"tappable","Tap",ox(e,n,`el-${t}`),{color:ee.tap,icon:"tap",summary:i?At(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Xa(a,t))}:{}})}function Lb(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${ne("Clock",e.hourCycle,Dd,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${ne("Minutes",e.minutes,Od,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var _b=[["number","Number"],["entity","Entity"]];function zb(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Pb(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Nb(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=zb(n,o),c=s?n.minValue:n.maxValue,u=y=>a(b=>{s?b.minValue=y??0:b.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${De(l,d==="number"?un(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${_b.map(([y,b])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a(k=>Pb(k,o,y))}}>${b}</button>`)}
      </span>
    ...
    ${ne("Colour",a,el,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=Pr(We(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    ${ne("Highlight",r,Ky,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
      ...
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var sa=new Map,oa=new Map,Pt=new Map,Rr=new Map,Xs=4,Js=40,Ob=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Vb=[["plain","Plain"],["rich","Rich"]],Bb={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function dl(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Ye("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function Gb(e){return e.countdown===!0?"countdown":rt(e)?"rich":"plain"}function Ub(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Kb(e,n){let t=Mn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ne(e.kind.value,40)||"template"}:{kind:"value",label:pa(e,n)}}function Xp(e,n,t){let i=Mn(e.value),a=i===void 0?Ne(pa(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ne(i,24)}"`;return`Part ${n+1}: ${a}`}function Wb(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Xp(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function nl(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function jb(e,n){if(nl(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Jt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??le],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function gp(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${Jr(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var qb={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Yb(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${Jr(e.moved.map(n=>qb[n]))} moved into Look.`}function Xb(e,n,t,i,a){let r=n.payload,o=r.id,s=Gb(r),l=(r.parts?.length??0)>0,d=Do(e.config,r.value),c=Pt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?oa.get(o):void 0,m=(b,k)=>{let C=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),w=$r(structuredClone(r),e.config.values);if(oa.delete(o),!w.ok){Pt.set(o,{text:gp(w.blocked),rich:!0,warn:!0}),Me(k);return}Pt.set(o,{text:Yb(w.joined?{joined:!0,template:C}:w),rich:!1}),i(S=>{$r(S,e.config.values),b==="countdown"&&(S.countdown=!0)})},g=(b,k)=>{if(oa.delete(o),s==="rich"){let C=b==="countdown"?"countdown":"plain",w=r.parts??[];if(w.length<2){m(C,k);return}let S=Vs(w,e.config.values);S.ok?(Pt.delete(o),oa.set(o,C)):Pt.set(o,{text:gp(S.blocked),rich:!0,warn:!0}),Me(k);return}if(b==="rich"){let C=r.parts?.[0]?.id??J();sa.set(o,C),Pt.delete(o),i(w=>{delete w.countdown,Zu(w,C)});return}Pt.delete(o),i(C=>{if(b==="countdown"){C.countdown=!0;return}(C.parts?.length??0)>0&&$r(C,e.config.values),delete C.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${ne("Type",s==="rich"?"rich":"plain",Vb,g,{titles:Bb})}
    ...
    ${s==="rich"?Jb(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Ce(d,de(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Jb(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=de(e),d=Math.max(0,o.findIndex(A=>A.id===sa.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=He(e.config,t,n).size??r.fontSize,g=(A,K)=>{Pt.delete(s),i(R=>{A(R),Hd(R)},K)},y=(A,K)=>g(R=>{let x=R.parts?.find($=>$.id===c.id);x&&A(x)},K?`part-${c.id}-${K}`:void 0),b=(A,K)=>{sa.set(s,A),Pt.delete(s),Me(K)},k=(A,K)=>{let R=J();sa.set(s,R),g(x=>{(x.parts??=[]).push({id:R,value:A})}),_p(K,Yr(`${a}-part-${R}`),!0)},C=A=>g(K=>{K.parts&&ca(K.parts,d,A)}),w=()=>{let A=o[d+1]??o[d-1];A&&sa.set(s,A.id),g(K=>{K.parts=(K.parts??[]).filter(R=>R.id!==c.id)})},S=o.map((A,K)=>{let R=Kb(A.value,l),x=A.id===c.id,$=nl(A),T=R.kind==="value"?e.resolve(A.value):void 0,F=A.fontWeight===void 0?void 0:xi.find(([N])=>N===A.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${x?"true":"false"} class="part-chip ${R.kind} ${x?"on":""}"
      aria-label=${Xp(A,K,l)} @click=${N=>b(A.id,N.currentTarget)}>
      <span class="part-dot" style=${`background:${jb(A,p)}`}
        title=${$==="bands"?"By value, with its own bands":$==="pick"?"Its own colour":"The layer colour"}></span>
      ${R.kind==="text"?h`<span class="part-txt">${R.label===""?h`<span class="part-empty">empty</span>`:Ub(R.label).map(N=>N.space?h`<span class="part-sp">${"\xB7".repeat(N.text.length)}</span>`:N.text)}</span>`:h`<span class="part-txt">${R.label}</span>`}
    ...
    </button>`}),H=r.rules.some(A=>A.partId===c.id),O=c.value.kind.kind==="literal",I=nl(c),j=c.fontSize!==void 0,M=xi.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,U=A=>{A>=Xs&&A<=Js&&y(K=>{K.fontSize=A},"size")},Z=I==="bands"?We(e.resolve(c.value)??""):[],_={layer:"Use the layer colour",...O&&I!=="bands"?{bands:"By value needs a live value"}:{}},Q=(A,K)=>y(R=>{let x={bands:R.bands??[],bandAboveColorHex:R.bandAboveColorHex??le};A(x),x.bands.length>0?R.bands=x.bands:delete R.bands,x.bandAboveColorHex!==le?R.bandAboveColorHex=x.bandAboveColorHex:delete R.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${A=>k(L(""),A.currentTarget)}>${B("text")}<span>Add text</span></button>
    ...
    <div class="part-editor">
      <div class="part-head">
        <span class="part-title"><b>Part ${d+1}</b> of ${u} · ${O?"Text":"Value"}</span>
        <span class="spacer"></span>
      ...
      ${se(e,c.value,A=>y(K=>{K.value=A},"value"),{showResolved:!0,label:O?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ${O?h`<div class="hint">Spaces count, and show as dots in the parts list. Type one at the start or end when this part needs a gap.</div>`:f}
      ${ne("Colour",I,Ob,A=>y(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=rl(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=Pr(We(e.resolve(K.value)??"")))}),{def:"layer",titles:_,...O&&I!=="bands"?{disabled:{bands:!0}}:{}})}
      ${I==="pick"?he("Part colour",c.colorHex,A=>y(K=>{K.colorHex=A??p},"color")):f}
      ${I==="bands"?h`
        ${Nr({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??le},c.colorHex??p,Q,Z.length===1?Z[0]:void 0)}
      ...
      <div class="field seg-field">${De("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${M})`,reset:()=>y(A=>{delete A.fontWeight})})}
        ${_r("Weight",c.fontWeight,xi,A=>y(K=>{K.fontWeight=A}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${De("Font size",j?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(A=>{delete A.fontSize})}:void 0,Wr(c.fontSize??m,U,{step:1,min:Xs,max:Js}))}
        ${jr(c.fontSize,A=>{A===void 0?y(K=>{delete K.fontSize},"size"):U(A)},{step:1,min:Xs,max:Js,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:j?"Part font size":`Part font size, ${m} pt from the layer`,...j?{}:{lead:B("link")}})}
      </label>
    </div>
  </div>`}function Jp(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(x=>x.payload.id===a),o=`el-${a}`,s=(x,$)=>e.update(T=>x(T.elements[r]),$?`${o}-${$}`:void 0),l=He(e.config,t,n),d=l.frame,c=(x,$)=>e.update(T=>Re(T,t,a,{frame:Ps(d,x)}),`${o}-${$}-${t}`),u=Se(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=x=>u[x],g=!1,y=x=>jn(n)===void 0?f:he(x,jn(n),$=>s(T=>{jn(T)!==void 0&&(T.payload.colorSlot.baseColorHex=$??"#FFFFFF")},"color"),!1,p),b,k={},C,w;switch(n.kind){case"text":{let x=($,T)=>s(F=>$(F.payload),T);C=Xb(e,n,t,x,o),g=!n.payload.countdown&&!rt(n.payload),w=h`
        ${dn(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${ne("Weight",n.payload.fontWeight,xi,$=>s(T=>{T.payload.fontWeight=$}),{def:u.fontWeight})}
        ${Ty({label:"Align",value:n.payload.alignment??"center",options:xb,def:"center",set:$=>s(T=>{let F=T.payload;$==="center"?delete F.alignment:F.alignment=$})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:vb,def:"1",set:$=>s(T=>{let F=T.payload;$==="2"?F.lineLimit=2:delete F.lineLimit})})}
        ...
        ${g?Db(e,n.payload,x,y("Main colour")):f}`;break}case"icon":C=h`
        ...
        ${T?h`
            ${se(e,x.total??cp(x),F=>$(N=>{N.total=F},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Na} dots are drawn.</div>`:Nb(e,x,{min:u.minValue,max:u.maxValue},o,$)}`,g=!0,w=h`
        <div class="grid2">
          ${ne("Style",x.style,Jy,F=>$(N=>{F==="dots"&&N.total===void 0&&(N.total=cp(N)),F!=="dots"&&delete N.total,N.style=F}),{titles:Zy,def:u.style})}
        ...
        ${ne("Colour",x.coloring,el,F=>$(N=>{N.coloring=F,F==="bands"&&N.bands.length===0&&(N.bands=Pr([N.minValue,N.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${Nr(x,x.colorSlot.baseColorHex,$,We(e.resolve(x.value)??"")[0])}`:f}
        ${T?f:h`
          <div class="grid2">
            ${ie("Threshold",x.thresholdValue,F=>$(N=>{F===void 0?delete N.thresholdValue:N.thresholdValue=F},"thr"),{optional:!0,def:null})}
            ${x.thresholdValue===void 0?f:he("Threshold colour",x.thresholdColorHex,F=>$(N=>{N.thresholdColorHex=F??ai},"thrcol"),!1,ai)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let x=n.payload,$=(E,D)=>s(fe=>E(fe.payload),D),T=u.historyMinutes,F=u.historyPoints,N=x.historyMinutes>0,q=N&&x.source==="statistics",te=N&&!q,ve=N?q?"statistics":"history":"value",kt=q?Pi:Rn,Ot=An(x)??Hn(x),_e=x.value.kind.kind==="entityState",me=Ot===void 0?void 0:e.historySeries(Ot),Oe=N&&_e?me??"":e.resolve(x.value)??"",Xe=x.historyPoints<1,Dh=te&&_e&&Ot!==void 0?e.historyReadings?.(Ot):void 0,Sl=Fb(Xe,Dh,Yn(x.historyMinutes)),Tl=tl(a,x.historyMinutes,kt),to=N&&_e?hs(Oe):{values:We(Oe),holes:[]},Qn=to.values,El=E=>x.limit>0&&E.length>x.limit?x.takeFromEnd?E.slice(E.length-x.limit):E.slice(0,x.limit):E,Oh=El(Qn),Vt=ms(Oh,at(x.smoothing),to.holes.length>0?El(to.holes):[]),Vh=!N&&_e&&Qn.length===1,no=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),Ml=de(e),fa=x.scaleFrom!==void 0&&no.some(E=>E.payload.id===x.scaleFrom);C=h`
        ${se(e,x.value,E=>$(D=>{D.value=E},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${ne("Draw",ve,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>$(D=>{if(E==="value"){D.historyMinutes=0;return}D.source=E==="statistics"?"statistics":"history";let fe=D.historyMinutes||Oa;D.historyMinutes=E==="statistics"?Math.min(fe,Mo):Math.min(fe,Va)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${q?h`
            ...
            <div class="grid2">
              ${qs(a,x.historyMinutes,T,E=>$(D=>{D.historyMinutes=E}),Pi)}
              ${ne("Per",x.statPeriod,za,E=>$(D=>{D.statPeriod=E}),{def:Ii})}
            </div>
            ${Tl?Ys(x.historyMinutes,E=>$(D=>{D.historyMinutes=E},"span"),!0):f}
            ${ne("Read",x.statType,ko,E=>$(D=>{D.statType=E}),{def:Li})}
        ...
        ${te?h`
                ...
                <div class="readings-row">
                  ...
                  ${Xe?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      step="1" min=${Ba} max=${Ft}
                      data-scrub @pointerdown=${ua(x.historyPoints,E=>$(D=>{D.historyPoints=Math.round(E)},"hpoints"),{step:1,min:Ba,max:Ft})}
            ...
            ${Tl?Ys(x.historyMinutes,E=>$(D=>{D.historyMinutes=E},"span")):f}
        ...
        ${Qn.length===0&&!(N&&(!_e||me===void 0||me===""))?h`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${Qn.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${Cb(Vt)}</span>${Qn.length===Vt.length?h` · ${Vt.length} ${Vt.length===1?"value":"values"}`:h` · ${Vt.length} of ${Qn.length}`}</span></div>`:f}
        ...
        <div class="grid2">
          ...
          ${x.limit<=0?f:ne("Keep",x.takeFromEnd?"end":"start",N?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],E=>$(D=>{D.takeFromEnd=E==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${ke("Smooth data",at(x.smoothing)??"off",By,E=>$(D=>{let fe=at(E);fe===void 0?delete D.smoothing:D.smoothing=fe}),{def:at(u.smoothing)??"off"})}
        ${ln(e)}
        ...
        <div class="grid2">
          ${ne("Style",x.style,Ip,E=>$(D=>{D.style=E}),{def:u.style})}
        ...
        ${x.style==="bars"?h`
          ...
          ${ne("Curve",x.curve??"straight",Oy,E=>$(D=>{E==="straight"?delete D.curve:D.curve=E}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${ln(e)}
          ${x.style==="area"?h`
            ${ne("Fill",Wt(x.fillStyle),Vy,E=>$(D=>{E==="flat"?delete D.fillStyle:D.fillStyle=E}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:Wt(u.fillStyle)})}
            ${Qs("Fill colour",x.fillColorHex,"Line colour",E=>$(D=>{E===void 0?delete D.fillColorHex:D.fillColorHex=E},"fillcol"))}
            ${ln(e)}`:f}`}
        <div class="grid2">
          ${ne("Scale",x.scale,Gy,E=>$(D=>{D.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${ne("Baseline",x.baseline,Uy,E=>$(D=>{D.baseline=E}),{def:u.baseline})}
        </div>
        ${no.length===0?f:ke("Same scale as",fa?x.scaleFrom:"",[["","Its own"],...no.map(E=>[E.payload.id,Ce(E,Ml)])],E=>$(D=>{E?D.scaleFrom=E:delete D.scaleFrom}),{def:""})}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(D=>{E=mc(D,a,fe=>Ce(fe,Ml))}),E&&e.selectLayer(E)}}>${B("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${ne("Colour",x.coloring,el,E=>$(D=>{D.coloring=E,E==="bands"&&D.bands.length===0&&(D.bands=Pr(Vt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${x.style==="area"?h`${Ye("Band fill",x.fillBands,E=>$(D=>{D.fillBands=E}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let Rl=E=>Ve(e.config,a).some(D=>D.payload.chartAnchor?.at===E),Gh=nn(e.config,a).length>0,Uh=zn(e.config,a).length>0,Kh=Pn(e.config,a).length>0,Fl=ic(e.config,a).length>0,Al=Fn(x)?void 0:Xe&&te?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Hl=x.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0;k={"draw:times":Al,"draw:dots":Hl};let ei=(E,D,fe,io,Il)=>h`
        <button class="small ${fe?"on":""}" ?disabled=${fe||Il!==void 0} aria-pressed=${fe?"true":"false"}
          data-extra=${E} title=${Vr(E,fe?`${D} is on this chart. Remove it in the list at the bottom.`:Il??`Add ${D.toLowerCase()} to this chart`)}
          @click=${()=>e.update(Wh=>{io(Wh)})}>${fe?h`<span aria-hidden="true">✓</span>`:B("plus")}<span>${D}</span></button>`;b=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders" @pointerover=${cn} @focusin=${cn}>
            ${ei("draw:threshold","Threshold line",Rl("threshold"),E=>ac(E,a,x.thresholdValue??sl(Vt)))}
            ${ei("draw:now","Now line",Rl("now"),E=>rc(E,a,!0))}
            ${ei("draw:zero","Zero line",Fl,E=>{Wo(E,a)})}
            ${ei("draw:times","Clock times",Gh,E=>{_n(E,a)},Al)}
            ${ei("draw:dots","Dots",Uh,E=>{Uo(E,a)},Hl)}
            ${ei("draw:grid","Grid lines",Kh,E=>{Ko(E,a)})}
          </div>
        </div>
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${ln(e)}`;break}case"timeline":{let x=n.payload,$=(me,Oe)=>s(Xe=>me(Xe.payload),Oe),T=u.historyMinutes,F=x.value.kind.kind==="entityState",N=gt(x),q=N===void 0?void 0:e.historySeries(N),te=ot(x)*60,ve=qi(q??"",tn),kt=tl(a,x.historyMinutes),Ot=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,_e=Yy(ve,te,Ot===void 0?void 0:e.hass.states[Ot]?.state,Ot?.split(".")[0]);C=h`
        ...
        ${qs(a,x.historyMinutes,T,me=>$(Oe=>{Oe.historyMinutes=me}))}
        ${kt?Ys(x.historyMinutes,me=>$(Oe=>{Oe.historyMinutes=me},"span")):f}
        ...
        ${ve.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Rb(ve,te)}</span></span></div>`:f}
        ${Mb(ve)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${Xy(x,$,_e,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ie("Gap",x.gap,me=>$(Oe=>{Oe.gap=Math.min(Ga,Math.max(0,me??0))},"tgap"),{step:.5,min:0,max:Ga,def:u.gap,unit:"pt"})}
...
`;break}case"shape":C=h`<div class="grid2">
        ...
        ${n.payload.kind==="line"?Eb(t,d,c):f}`,w=n.payload.kind==="line"?ie("Thickness",n.payload.thickness,x=>s($=>{$.payload.thickness=x??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${qn("Zoom",x.zoom,q=>$(te=>{te.zoom=q},"zoom"),{min:Cs,max:4,step:.05,def:1,format:q=>`${q.toFixed(2)}x`,unit:"x"})}
        ...
        <div class=${x.contentMode==="fit"&&x.zoom===1?"hint keep":"hint"}>${$b(x)}</div>
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let x=n.payload,$=(q,te)=>s(ve=>q(ve.payload),te),T=e.config.elements.find(q=>q.payload.id===x.chart),F=T?.kind==="chart"||T?.kind==="timeline"?T:void 0,N=F?.kind==="timeline"?"timeline":"chart";C=h`
        <div class="field readout"><span>${F?.kind==="timeline"?"Timeline":"Chart"}</span><span class="readout-v">${F?h`<button class="small" title=${`Select that ${N}`} @click=${()=>e.selectLayer(F.payload.id)}>${Ce(F,de(e))}</button>`:"None"}</span></div>
        ...
        <div class="hint">The clock times of that ${N}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,w=Lb(x,$,u,"ct",h`
        ...
        <div class="hint">The time that picture was fetched, not the time now: a picture that stops updating
          ...
          has been fetched once. Move and size it like any other layer: the chip grows to fill the frame.</div>`;break}case"chartDots":{let x=n.payload,$=(te,ve)=>s(kt=>te(kt.payload),ve),T=e.config.elements.find(te=>te.payload.id===x.chart),F=T?.kind==="chart"?T:void 0,N=F===void 0?void 0:He(e.config,t,F).size??F.payload.lineWidth,q=N===void 0?void 0:Math.round(N*18)/10;C=h`
        ${yp(e,F)}
        ...
        ${ln(e)}`,w=h`
        ${ne("Dots",x.dots,Hp,te=>$(ve=>{ve.dots=te}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ...
          ${Qs("Dot colour",x.colorHex,"Series colour",te=>$(ve=>{te===void 0?delete ve.colorHex:ve.colorHex=te},"dotcol"))}
        </div>
        ...
        ${ln(e)}`,w=h`
        <div class="grid2">
          ${ie("Lines",x.lines,N=>$(q=>{q.lines=Tn(N??Xt)},"lines"),{step:1,min:1,max:4,def:Xt})}
          ${ie("Thickness",x.thickness,N=>$(q=>{q.thickness=En(N??Yt)},"thick"),{step:.25,min:La,max:_a,def:Yt,unit:"pt"})}
        </div>
        ${he("Colour",x.colorHex,N=>$(q=>{q.colorHex=N??Mt},"gridcol"),!1,Mt)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let S=g||jn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&rt(n.payload)?"Layer colour":"Colour"),H=Xo(e.config,n),O=H?{kind:{kind:"entityState",...H}}:void 0,I=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,j=Qb[n.kind],M=ex[n.kind],U=js(n.payload,u,j),Z=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,_=e.config.perFamily[t]?.placements[a]?.size!==void 0,Q=js(n.payload,u,M)||Z!==void 0&&l.size!==void 0&&l.size!==u[Z],A=Ln(e.config,a),K=(x,$)=>()=>s(T=>Mr(T.payload,u,x),$),R=h`<section class="sec name-sec" data-open="true" style=${`--c:${ee.place}`}>
    <div class="sec-h pinned">
      ...
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${eh(n,de(e))}
        @input=${xe(x=>s($=>{let T=lx(x);T===void 0?delete $.payload.name:$.payload.name=T},"name"))} />
    </div>
  </section>`;return h`
    ${R}
    ${$e(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:qp(e,n,o)}${C}`,{color:ee.content,icon:"content",summary:ll(e,n),...U?{reset:()=>s(x=>{Mr(x.payload,u,j),x.kind==="text"&&ta(x.payload.rules)},"reset-content")}:{}})}
    ${w===void 0&&S===void 0?f:$e(e,"look",n.kind==="image"?"Picture":"Look",h`${w??f}${S??f}`,{color:ee.look,icon:n.kind==="image"?"image":"look",...Or(n)?{summary:Or(n)}:{},...Q?{reset:()=>e.update(x=>{Mr(x.elements[r].payload,u,M),_&&Re(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?$e(e,"numbers","Extras",ax(e,n,b,k),{color:ee.numbers,icon:"text",summary:ix(e,n),...A.length>0||Ve(e.config,a).length>0||nn(e.config,a).length>0||zn(e.config,a).length>0||Pn(e.config,a).length>0||js(n.payload,u,bp)?{reset:()=>e.update(x=>{for(let T of Ln(x,a))ye(x,T.payload.id);for(let T of Ve(x,a))ye(x,T.payload.id);for(let T of nn(x,a))ye(x,T.payload.id);for(let T of zn(x,a))ye(x,T.payload.id);for(let T of Pn(x,a))ye(x,T.payload.id);let $=x.elements.find(T=>T.payload.id===a);$&&Mr($.payload,u,bp)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?Zb(e,n):f}
    ${$e(e,"states","States",lh(e,n.payload.rules,n.kind,x=>x.elements.find($=>$.payload.id===a)?.payload.rules,`rules-${a}`,O,I),{color:ee.states,icon:"states",summary:Zi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Hb(e,n,t)}
    ${i.tap===!1?f:Ib(e,n)}`}function Zb(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?nn(e.config,t):Bo(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);if(!m)return;let g=m.payload.frame;m.payload.frame={...He(p,o,m).frame},i?_n(p,t):Go(p,t,pe[o==="inline"?"rectangular":o]),m.payload.frame=g}),l=a.length>0,d=a.map(p=>({el:p,lead:B("clock"),title:r,kind:i?"Times":"Timestamp"})),c=i?"timeline:times":"image:time",u=h`
    ${Qp(i?"timeline":"image")}
    <div class="field list-field"><span>Draw</span>
      <div class="adders" @pointerover=${cn} @focusin=${cn}>
    ...
    ${a.type==="openPage"?Gp(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var tx=24;function nx(e,n){let t=[],i=1/0;for(let r of oe){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=pc(e.config,n,r);o&&(t.push(`${ae(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<tx;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function ix(e,n){let t=n.payload,i=Ln(e.config,t.id),a=Ve(e.config,t.id),r=nn(e.config,t.id),o=zn(e.config,t.id),s=Pn(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(Rt.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(mt.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function ax(e,n,t,i={}){let a=de(e),r=Ln(e.config,n.payload.id),o=nn(e.config,n.payload.id),s=zn(e.config,n.payload.id),l=Pn(e.config,n.payload.id),d=Ve(e.config,n.payload.id),c=b=>e.update(k=>{Zd(k,n.payload.id,b)}),u=b=>e.update(k=>{Vo(k,n.payload.id,b)}),p=new Set(r.map(b=>b.payload.value.kind.kind==="chartStat"?b.payload.value.kind.stat:"")),m=new Set(d.map(b=>b.payload.chartAnchor.at)),g=[...r.map(b=>({el:b,lead:e.resolve(b.payload.value)??"--",title:Ce(b,a),kind:"Number"})),...d.map(b=>{let{at:k,place:C}=b.payload.chartAnchor,w=mt.find(([H])=>H===k)?.[1]??"Reading";if(C==="through")return{el:b,lead:k==="now"?"\u2502":"\u2500",title:k==="zero"?"Zero":w,kind:"Line"};let S=b.kind==="text"?e.resolve(b.payload.value)??"\u25CF":b.kind==="icon"?sx(e.resolve(b.payload.symbol)):"\u25C6";return{el:b,lead:S,title:w,kind:"Marker"}}),...o.map(b=>({el:b,lead:B("clock"),title:"Clock times",kind:"Times"})),...s.map(b=>({el:b,lead:B("chartDots"),title:"Reading dots",kind:"Dots"})),...l.map(b=>({el:b,lead:B("chartGrid"),title:"Grid lines",kind:"Grid"}))],y=g.length;return h`
    ...
    ${y===0?f:h`
      ...
      ${ul(e,g,{icon:"close",danger:!0,label:b=>`Delete this ${b}`,run:b=>e.update(k=>ye(k,b))})}
    ...
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function rx(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===t);m&&c(m)},`${i}-${u}`),o=Se(n.kind).payload,s=jn(n),l=s===void 0?f:he("Colour",s,c=>r(u=>{jn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ...
        ${ne("Style",c.style,Ip,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
        ...
        ${ne("Dots",c.dots,Hp,g=>r(y=>{y.kind==="chartDots"&&(y.payload.dots=g)},"mode"),{def:"auto"})}
        <div class="grid2">
        ...
        <div class="grid2">
          ...
          ${ie("Thickness",c.thickness,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.thickness=En(u??Yt))},"thick"),{step:.25,min:La,max:_a,def:Yt,unit:"pt"})}
        </div>
        ${he("Colour",c.colorHex,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.colorHex=u??Mt)},"colour"),!1,Mt)}`}default:return h`${l}`}}function vp(e,n,t,i){let a=mt.filter(([r])=>ft(r)||r===t.at);return h`
    <div class="grid2">
    ...
    </div>`}function ox(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ue(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=Jo(e.config,n);return h`
    ${Ye("Tappable",a!==void 0,s=>e.update(l=>{s?Ya(l,i):Xa(l,i)}))}
    ${a?h`<div class="value-editor">
        ...
        ${nx(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${At(o)}</b>.</div>`}`}function wp(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function sx(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Ce(e,n){return e.payload.name?e.payload.name:eh(e,n)}function lx(e){let n=e.trim();return n===""?void 0:n}function eh(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=mt.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return wp(Te(e.payload.value,n));case"icon":return wp(Te(e.payload.symbol,n));case"gauge":return Te(e.payload.value,n);case"chart":return Te(e.payload.value,n);case"timeline":return Te(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines";case"imageTime":return"Timestamp"}}function th(e,n){let t=It(e.config,n.id),i=de(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return $e(e,"content","Group",h`
    ...
    ${ul(e,t.map(r=>({el:r,lead:B(r.kind),title:Ce(r,i),kind:rn[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Vi(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function nh(e,n){if(n==="inline")return dx(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ae(n)} yet.</div>
    ...
    ${n==="corner"?$e(e,"corner","Corner content",cx(e,t,i),{color:ee.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${$e(e,"states","Shape states",lh(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:ee.states,icon:"states",summary:Zi(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${$e(e,"content","Inline text",h`
      ...
      ${dl(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:ee.content,icon:"text",summary:Ne(`${n.label?`${n.label}: `:""}${Te(n.value,i)}`,48)})}
    ${$e(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:ee.look,icon:"icon",summary:n.symbol||"None"})}`}function cx(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="gauge"&&n.bezelGauge?ux(e,n.bezelGauge,t):f}`}function ux(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var e0=oe.map(e=>[e,ae(e)]),pl={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},px=Object.keys(pl),Br=["color","text","fontSize","fontWeight","visibility"];function hx(e,n=!1){let t=Gi[e].filter(i=>!n||Br.includes(i));return px.filter(i=>t.includes(ze[i]))}function ih(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Wb(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var mx={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Fr(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Ne(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function ah(e){if(!e||Ie(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function Te(e,n){return`${pa(e,n)}${ah(e.format)}`}function pa(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Ne(t.value,40)}"`:"(empty)";case"entityState":return Fr(t,n);case"entityAttribute":return t.attribute?`${Fr(t,n)} \xB7 ${t.attribute}`:Fr(t,n);case"entityAge":return`age of ${Fr(t,n)}`;case"aggregate":return fx(t.aggregate);case"time":return mx[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Ne(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Rt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?pa(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function fx(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function ca(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function gx(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.cases.map((m,g)=>bx(e,m,g,n,a,u,`${o}-${m.id}`,p))}
  ...
  </div>`}function bx(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(g=>g.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>xx(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
    ...
    ${rh(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${s.pattern&&!vx(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
        ...
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=wx(n.value)?kx(s.options??[],u=>o(p=>{p.comparison.options=Ds(u)},"options")):Ee("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${ke("Comparison",s.kind,vc.map(u=>[u,fi[u]]),u=>o(p=>{p.comparison=ls(p.comparison,u)}))}
    ${c}
  </div>`}function vx(e){try{return new RegExp(e),!0}catch{return!1}}function kp(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Dn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${xe(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function wx(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function kx(e,n){let t=qu(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    ...
    </div></div>`}function rh(e,n,t,i,a,r=!1){let o=hx(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>$x(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Vn(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${pl[s]}</option>`)}
    </select>`}var oh=["setColor","setBorderColor","setBackgroundColor"];function $x(e,n,t,i,a,r,o,s=!1){let l=!Gi[i].includes(ze[n.kind]),d=s&&!l&&!Br.includes(ze[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${sh(e,n,a,o)}
      ...
      ${gx(e,n,t,i,a,o)}`:Cx(e,s.table,n[0],t,i,a,r,o)}function Cx(e,n,t,i,a,r,o,s){let l=(R,x)=>e.update($=>{let T=a($);T&&R(T)},x?`${r}-${x}`:void 0),d=n.value??$p.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Iu(d)&&Sx(e.resolve(d)),p=Gi[i],m=Ar.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Hu[i]]:[],y=$u(n.columns,[...m,...g.filter(R=>R!==void 0)],p),b=Rr.get(r),k=t?t.partId:s?.some(R=>R.id===b)?b:void 0,C=s!==void 0&&k!==void 0,w=C?p.filter(R=>Br.includes(R)):p,S=C?y.filter(R=>!Br.includes(R)):[],H=(R,x)=>{if(!t){R?Rr.set(r,R):Rr.delete(r),Me(x);return}l($=>{let T=$[0];T&&(R?T.partId=R:delete T.partId)})},O=t?e.liveBranch(t):"none",I=t?e.forced.get(t.id)??"live":"live",j=R=>I!=="live"&&(I==="otherwise"?R==="otherwise":I.caseId===R),M=R=>{t&&e.setForced(t.id,j(R)?"live":R==="otherwise"?"otherwise":{caseId:R})},U=R=>{$p.set(r,R),n.rows.length!==0&&l(x=>Ru(x,R),"lhs")},Z=()=>{Rr.delete(r),l(R=>{Eu(R,d??L(""),u),k!==void 0&&R[0]&&R[0].partId===void 0&&(R[0].partId=k)})},_=n.rows.map((R,x)=>Sp(e,{key:`${r}-${R.caseId}`,label:Au(R.comparison,$=>Te($,de(e))),columns:y,changes:R.changes,live:O===R.caseId,forced:j(R.caseId),onForce:()=>M(R.caseId),when:Fx(e,R.comparison,`${r}-${R.caseId}`,($,T)=>l(F=>{let N=F[0]?.cases.find(q=>q.id===R.caseId)?.when.tests[0];N&&$(N.comparison)},T&&`${R.caseId}-${T}`)),updChanges:($,T)=>l(F=>{let N=F[0]?.cases.find(q=>q.id===R.caseId);N&&$(N.then)},T&&`${R.caseId}-${T}`),acts:h`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>l($=>Mu($,R.caseId))}>${B("delete")}</button>`})),Q=n.otherwise===void 0?f:Sp(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:O==="otherwise",forced:j("otherwise"),onForce:()=>M("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(R,x)=>l($=>{let T=$[0]?.otherwise;T&&R(T)},x),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(R=>_s(R,!1))}>${B("close")}</button>`}),A=Hr.get(r),K=Tx.filter(R=>w.includes(R)&&!y.includes(R));return h`
    <div class="states">
      ${se(e,d??L(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:ih(s,k,de(e),H)}
      ...
      ${A===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${xt[A]} column? Its ${Cp(n,A)} value${Cp(n,A)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${R=>{Hr.delete(r),Ar.get(r)?.delete(A),Me(R.target),l(x=>Fu(x,A))}}>Remove</button>
    ...
    ${n.columns.map(t=>h`<td>${Mx(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Mx(e,n,t,i,a){let r=br(t,n),o=Yr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${xt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Vn(ku[n]))}),_p(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>ze[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=xt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Rx(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${zp}>
      ...
      ${la.has(o)?h`${n==="visibility"?ne("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):sh(e,r,s,a)}
    ...
    </div>`}function Rx(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=er(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${xi.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??L(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(oh.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ae(a):Te(i,de(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Te(i,de(e))}</span>`}function Ae(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Fx(e,n,t,i){let a=On(n.kind),r=Hs(n.kind),o=(s,l,d,c)=>Hx(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${xe(s=>i(l=>{let d=ls(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${As.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Ax(s)}</option>`)}
    </select>
  ...
  </span>`}function Ax(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return fi[e]}}function Hx(e,n,t,i,a,r,o){let s=Yr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${Lp(e,s,o,n,t,l)}
  </span>`}var ha=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Yo,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function ph(e){return ha.find(n=>n.kind===e)??ha[0]}var dh="#FF9F0A",Qr="#8E8E93",Ix=["#FF453A","#FFD60A","#34C759"],hh=["#0A84FF","#34C759","#FF9F0A"];function Lx(e){return e?.attributes?.device_class==="battery"?Ix:hh}var _x={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function zx(e){let n=e.iconName?.trim();return n?{off:n,on:n}:_x[hl(e)]??{off:"circle",on:"circle.fill"}}function Px(e){switch(hl(e)){case"lock":return{kind:"equals",value:L("locked")};case"cover":case"valve":return{kind:"equals",value:L("open")};case"media_player":return{kind:"equals",value:L("playing")};default:return{kind:"isOn"}}}function hl(e){return e.domain||e.entityId.split(".")[0]||""}function mn(e){return{...e,domain:hl(e)}}function Nx(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function vi(e){return Math.round(e*1e4)/1e4}function Jn(e,n,t){return Math.min(t,Math.max(n,e))}function ml(e,n,t){let i=Le[e],a=Jn(vi(n/i.width),0,1),r=Jn(vi(t/i.height),0,1);return{x:vi((1-a)/2),y:vi((1-r)/2),width:a,height:r,rotationDegrees:0}}function Dx(e){let n=Le[e],t=Jn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:ml(e,t*1.3,t*1.3),size:t}}function Ox(e){let n=Le[e],t=Jn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:ml(e,n.width*.88,t*1.7),size:t}}function Vx(e){let n=Le[e],t=Math.min(n.width,n.height)*.9;return{frame:ml(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function mh(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Bx(e){let n=Le[e],t=Jn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:vi(t/n.height),rotationDegrees:0}}}function Gx(e){let n=Le[e],t=Jn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:vi(Jn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Ux(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Kx(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function pn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Kx(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Lt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function hn(e){return Se(e)}function fl(e,n){let t={kind:{kind:"entityState",...mn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function ch(e){let n=Vn("setIcon");return n.value=L(e),n}function Xn(e){let n=Vn("setColor");return n.value=L(e),n}function Wx(e,n){let t=Ui(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...mn(e)}},a.comparison=Px(e);let r=n.on!==n.off;return i.then=r?[ch(n.on),Xn(dh)]:[Xn(dh)],t.otherwise=r?[ch(n.off),Xn(Qr)]:[Xn(Qr)],t}function jx(e){let n=Ui(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...mn(e)}},i.comparison={kind:"isUnavailable"};let a=Vn("setOpacity");return a.number=.35,t.then=[a],n}function uh(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function qx(e,n,t=hh){let i=n.max-n.min,a=uh(n.min+i/3),r=uh(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:L(a)},changes:[Xn(t[0])]},{comparison:{kind:"between",value:L(a),upper:L(r)},changes:[Xn(t[1])]},{comparison:{kind:"greaterThan",value:L(r)},changes:[Xn(t[2])]}];return Cu(fl(e),o)}function Yx(e,n,t){let i=hn("icon"),a=zx(n);return i.payload.symbol=L(a.off),i.payload.colorSlot.baseColorHex=Qr,i.payload.rules=[Wx(n,a)],pn(e,i,t.family,Dx),e.elements.push(i),Ya(e,i.payload.id,{type:"toggleEntity",...mn(n)}),i.payload.id}function Xx(e,n,t){let i=hn("text");return i.payload.value=fl(n,t.state),i.payload.rules=[jx(n)],pn(e,i,t.family,Ox),e.elements.push(i),i.payload.id}function Jx(e,n,t){let i=hn("gauge");i.payload.value=fl(n);let a=Nx(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[qx(n,a,Lx(t.state))],pn(e,i,t.family,Vx),e.elements.push(i),i.payload.id}function Zx(e,n,t){let i=hn("chart");return i.payload.value={kind:{kind:"entityState",...mn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",pn(e,i,t.family,mh),e.elements.push(i),i.payload.id}function Qx(e,n,t){let i=hn("chart");return i.payload.value={kind:{kind:"entityState",...mn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",pn(e,i,t.family,mh),e.elements.push(i),i.payload.id}function ev(e,n,t){let i=mn(n),a=hn("text");a.payload.value=L(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=Qr,pn(e,a,t.family,Gx),e.elements.push(a);let r=t.state?.attributes?.device_class,o=hn("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=zo(i.domain,typeof r=="string"?r:void 0),pn(e,o,t.family,Bx),e.elements.push(o),o.payload.id}function tv(e,n,t){let i=hn("image");return i.payload.entity=mn(n),pn(e,i,t.family,Ux),e.elements.push(i),i.payload.id}function fh(e,n,t,i){switch(n){case"toggle":return Yx(e,t,i);case"status":return Xx(e,t,i);case"gauge":return Jx(e,t,i);case"chart":return Zx(e,t,i);case"history":return Qx(e,t,i);case"doorHistory":return ev(e,t,i);case"camera":return tv(e,t,i)}}var nv=/^[a-z0-9_]+\.shared_(\d+)$/;function gh(e){return nv.test(e)}function iv(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function bh(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function xh(e,n){let t=new Map;for(let i of rs(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=bh(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${iv(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function av(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);is(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),as(t,r=>Qo(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function vh(e){let n=!1;return Qa(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function rv(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function wh(e,n,t=[]){let i=n==="share"?av(e,t):e,a=si(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${rv(a)}
`}function kh(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var ov="There is nothing to read here. Paste a complication first.",sv="This is not valid JSON. Check for a missing brace or a stray comma.",lv="This is valid JSON but not a complication. A complication starts with { and ends with }.",dv="This does not look like a complication.",yh="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",cv="00000000-0000-4000-8000-000000000000";function uv(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function $h(e,n){let t=e.trim();if(t==="")return{ok:!1,error:ov};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:sv}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:lv};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${yh}`};let o={...a,id:cv,slotIndex:0},s;try{s=oi(o)}catch(d){let c=d instanceof nt||d instanceof Error?d.message:String(d);return{ok:!1,error:`${dv}

${uv(c)}`}}let l=ja(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${yh}`}}return{ok:!0,config:s,raw:i}}function gl(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=rs(e,(o,s)=>gh(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=gh(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:bh(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Ch(e,n){let t=structuredClone(e);is(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return as(t,a=>Qo(a,i)),t}function Sh(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function pv(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Th(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=cr(e);return i.length===0?t:`${t}, ${pv(i)}`}function yl(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var mv=3e4,fv=500,gv=3e4,Eh="preset-entity";function Mh(e){return`import-entity-${e}`}var yv={entityId:"",displayName:"",domain:""},bv=new Map,xv={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function bl(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function vv(e){return e.kind==="family"?"look":"content"}function xl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Rh(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Ur,this.scrubStart),this.addEventListener(Kr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},gv)}loadColumnWidths(){try{let t=window.localStorage.getItem(Lh);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=vl(i.left)),typeof i.right=="number"&&(this.colRight=vl(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Lh,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Ih);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Ih,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Wp(s,o,i))}>Copy the ${ae(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Zo(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication");if(this.showTaps){let _=this.focusTapId();if(_!==void 0&&o===_&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,_,r??void 0);return}let Q=this.hitLayerId(i);Q?this.inspect={kind:"layer",id:Q}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let l=_h(i);if(!l&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let d=Zo(this.draft.config,o),c=this.draft.config.elements.find(_=>_.payload.id===d);if(!d||!c)return;if(l){i.preventDefault(),this.togglePick(d);return}let u,p=this.inspect.kind==="layer"?this.inspect.id:void 0;if(p!==void 0&&p!==d&&!r){let _=this.draft.config.elements.find(A=>A.payload.id===p);_!==void 0&&_.kind!=="chartDots"&&_.kind!=="chartGrid"&&_.payload.chartAnchor?.place!=="through"&&st(this.draft.config,p)?.locked!==!0&&Ev(s,p,i)&&(u=d,d=p,c=_)}let m=st(this.draft.config,d),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r){let _=g||this.inspect.kind==="layer"&&st(this.draft.config,this.inspect.id)?.id===m.id;this.beginGroupGesture(t,i,s,m,_?d:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==d)&&(this.inspect={kind:"layer",id:d},r)||c.payload.chartAnchor?.place==="through")return;i.preventDefault();let y=He(this.draft.config,t,c).frame,b=this.gestureCanvas(t),k=c.payload.chartAnchor,C=k!==void 0&&!ft(k.at)&&k.place!=="through",w=k!==void 0&&ft(k.at)&&k.place==="through",S=pe[t],H={dx:k?.dx??0,dy:k?.dy??0},O=k!==void 0&&!r?Yi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(_=>_.id===d)?.frame:void 0,I=O??y,j=_=>Math.round(_*10)/10;this.cancelGesture?.();let M=!1,U=r!==null&&c.kind==="shape"&&c.payload.kind==="circle",Z=r!==null&&c.kind==="shape"&&c.payload.kind==="line";this.cancelGesture=vr(s,b,i,{elementId:d,frame:I,handle:r??void 0,square:U,line:Z},{onFrame:(_,Q,A)=>{if(A||(M=!0),A&&!M&&u!==void 0){this.inspect={kind:"layer",id:u},this.cancelGesture=void 0;return}this.mutate(K=>{if(k===void 0){Re(K,t,_,{frame:Q});return}let R=O?{width:y.width,height:y.height}:{width:Q.width,height:Q.height};Re(K,t,_,{frame:{...Q,...R,x:C?Q.x:y.x,y:y.y}});let x=K.elements.find(F=>F.payload.id===_)?.payload.chartAnchor;if(x===void 0)return;let $=H.dx,T=w?H.dy:j(H.dy+(Q.y-I.y)*S.height);$?x.dx=$:delete x.dx,T?x.dy=T:delete x.dy},`drag-${_}-${t}`),A&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=It(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map(C=>[C.payload.id,He(s,t,C).frame])),c=[...d.values()],u=Math.min(...c.map(C=>C.x)),p=Math.min(...c.map(C=>C.y)),m=Math.max(...c.map(C=>C.x+C.width)),g=Math.max(...c.map(C=>C.y+C.height)),y={x:u,y:p,width:m-u,height:g-p,rotationDegrees:0},b=C=>Math.round(C*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=vr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y},{onFrame:(C,w,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let H=w.x-y.x,O=w.y-y.y;this.mutate(I=>{for(let[j,M]of d)Re(I,t,j,{frame:{...M,x:b(M.x+H),y:b(M.y+O)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?zu:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(It(r,k).map(C=>C.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=st(r,u);if(m?.locked)return this.nudgeMany(It(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=He(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let k=!ft(y.at);return l===0&&!(k&&s!==0)||this.mutate(C=>{k&&s!==0&&Re(C,d,u,{frame:xr(g,s,0,c)});let w=C.elements.find(H=>H.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let S=Math.round(((w.dy??0)+l)*10)/10;S?w.dy=S:delete w.dy},`nudge-${u}-${d}`),!0}let b=xr(g,s,l,c);return(b.x!==g.x||b.y!==g.y)&&this.mutate(k=>Re(k,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let H=l.elements.find(O=>O.payload.id===S);H&&c.set(S,He(l,i,H).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),g=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),b={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},k=xr(b,o,s,a),C=k.x-b.x,w=k.y-b.y;return(C!==0||w!==0)&&this.mutate(S=>{for(let[H,O]of c)Re(S,i,H,{frame:{...O,x:d(O.x+C),y:d(O.y+w)}})},r),!0}gestureCanvas(t){let i=sr(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Ss(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ue(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=be(s,l),c=He(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=vr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?uc(g,u,t,p):Re(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:zh(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
    ...
    </div>`}pickerRows(){let t=this.records.map(a=>({slot:Number(a.document?.slotIndex??0),kind:"record",record:a}));return[...t,...Ed(t.map(a=>a.slot),this.occupied).map(a=>a.kind==="custom"?{slot:a.slot,kind:"locked",name:a.name||"Unnamed complication",badge:a.home||"Other home",title:`A complication on ${a.home?`the ${a.home} home`:"another home"}${a.families?.length?` (${a.families.map(ae).join(", ")})`:""}. Edit it in that home's Wrist Assistant panel.`,families:a.families??[]}:{slot:a.slot,kind:"locked",name:a.name||"Unnamed preset",badge:"iPhone",title:"Still on the iPhone. Open the Wrist Assistant app on the iPhone to move it here.",families:[]})].sort((a,r)=>a.slot-r.slot)}shapeDots(t){return h`<span class="shape-dots">${Gn.map(i=>h`<span class="shape-dot ${i} ${t.includes(i)?"on":""}" title=${ae(i)}></span>`)}</span>`}static{this.FILTER_FROM_ROWS=8}recordPreview(t){let i=this.recordPreviews.get(t.id);if(i&&i.revision===t.revision)return i;try{let a=oi(t.document),r={revision:t.revision,config:a,entities:[...nr(a).entities.values()]};return this.recordPreviews.set(t.id,r),r}catch{this.recordPreviews.delete(t.id);return}}renderRowArt(t){let i=this.recordPreview(t);if(!i)return h`<span class="pk-art"></span>`;let a=i.config,o=(this.pickerFilter!=="all"&&a.supportedFamilies.includes(this.pickerFilter)?this.pickerFilter:void 0)??Ts(a)??"inline",s=new Map;for(let c of i.entities){let u=this.entityStateFor(c.entityId,c.iconName??"",!1);u&&s.set(c.entityId,u)}let l=Yi(a,{entityStates:s,templateResults:new Map,namedValues:a.values});if(o==="inline")return h`<span class="pk-art inline">${this.renderInlinePreview(l.inline,!0)}</span>`;let d=l[o];return d?h`<span class="pk-art ${o}">${dr(d,{icons:this.icons,imageSizes:this.imageSizes,slot:hi.slots[o]})}</span>`:h`<span class="pk-art"></span>`}renderPickerFilter(t){let i=r=>r.kind==="record"?xl(r.record):r.families,a=(r,o,s)=>h`<button
      ...
      ${wt({hass:this.hass},t.label,i??yv,a=>this.setImportEntity(t.entityId,a),Mh(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Es.map(s=>h`<button class="add" style=${`--k:${qe[s]}`} ?disabled=${i} title=${`Add a blank ${rn[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${_u(s)}</span>`:f}<span class="add-name">${r?B(s):h`<span class="k"></span>`}<span>${rn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Ce(M,d)}</b>
          <small><span class="kind">${rn[M.kind]}</span> · ${Hv(M,c,this.historySeries,A.size)}</small>
          ${S?h`<span class="facts">${Fv(this.host(),a,M,A).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${fn}])`} aria-label="Bring forward" @click=${F=>{F.stopPropagation(),r(_,1)}}>${B("up")}</button>
            <button class="icon" title=${`Send back (${fn}[)`} aria-label="Send back" @click=${F=>{F.stopPropagation(),r(_,-1)}}>${B("down")}</button>
            <button class="icon" title=${`${A.isHidden?"Show":"Hide"} (${wl}${fn}H)`} aria-label=${A.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(N=>Re(N,a,_,{isHidden:!A.isHidden}))}}>${B(A.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${fn}D)`} aria-label="Duplicate" @click=${F=>{F.stopPropagation(),o(_)}}>${B("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${F=>{F.stopPropagation(),s(_)}}>${B("delete")}</button>
          </span>`:f}
        </span>
      </div>`},O=(M,U)=>{let Z=this.inspect.kind==="group"&&this.inspect.id===M.id,_=!this.collapsed.has(M.id),Q=this.rowDrag(M.id,i),A=U[0],K=U[U.length-1],R=$=>{let T=$.currentTarget,F=T.getBoundingClientRect(),N=F.top+(T.classList.contains("drop-before")?Nt:0),q=F.bottom-(T.classList.contains("drop-after")?Nt:0),te=($.clientY-N)/Math.max(1,q-N);return te<.25?"drop-before":!_&&te>.75?"drop-after":"drop-into"},x=U.map($=>$.payload.id);return h`<div class="layer group ${Z?"hl":""} ${S?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${Q.draggable}
        ...
        @drop=${$=>{$.preventDefault();let T=R($);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!A||!K)){if(T==="drop-before"){this.reorderLayer(F,A.payload.id,!0,!0);return}if(T==="drop-after"){this.reorderLayer(F,K.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,A.payload.id,!0),this.mutate(N=>Vi(N,F,M.id)))}}}>
        ...
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${wl}${fn}G)`} aria-label="Ungroup" @click=${$=>{$.stopPropagation(),this.mutate(T=>Oi(T,M.id)),Z&&(this.inspect={kind:"general"})}}>${B("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${M.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${$=>{$.stopPropagation(),this.mutate(T=>{let F=T.groups?.find(N=>N.id===M.id);F&&(F.locked=!F.locked)})}}>${B(M.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${_?"true":"false"} title=${_?"Fold the group":"Unfold the group"}
            @click=${$=>{$.stopPropagation();let T=new Set(this.collapsed);_?T.add(M.id):T.delete(M.id),this.collapsed=T}}>${B("chevron")}</button>
        </span>
      </div>`},I=[],j=new Set;for(let M=0;M<l.length;M++){let U=l[M],Z=U.payload.groupId,_=Z===void 0?void 0:t.groups?.find(K=>K.id===Z);if(!_){I.push(H(U,!1));continue}if(j.has(_.id))continue;j.add(_.id);let Q=l.filter(K=>K.payload.groupId===_.id);I.push(O(_,Q));let A=this.inspect.kind==="group"&&this.inspect.id===_.id;this.collapsed.has(_.id)||I.push(h`<div class="group-kids">${Q.map(K=>H(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${B("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${kv.map((M,U)=>h`
              <button class=${this.thumbStep===U?"on":""} title=${`${Hh[U]} row pictures`}
                aria-label=${`${Hh[U]} row pictures`} aria-pressed=${this.thumbStep===U?"true":"false"}
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${ee.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${M=>{M.preventDefault(),this.clearDragMarks();let U=this.dragId,Z=[...l].reverse().find(_=>_.payload.id!==U&&_.payload.groupId!==U);U&&Z&&this.reorderLayer(U,Z.payload.id,!1,!0),this.dragId=void 0}}>
      ...
      ${t===void 0?f:h`
        ...
        ${wt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Eh,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
      ...
      <div class="card canvas-card">
        <div class="canvas-bar">
          ...
          <span class="spacer"></span>
          <span class="inbox" title=${`Layouts are made in the ${hi.label} box. Smaller cases scale it down.`}>
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?ui((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Kp();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${B("content")}</span>Shared values
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
        ...
        ${p?h`<div class="value-open">${Up(s,c)}</div>`:f}</div>`})}
          ...
          ${B("plus")}${ae(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?dr(c,{icons:this.icons,imageSizes:this.imageSizes,slot:hi.slots[r]}):f}let l=r!=="inline"&&Xr(t,r)===0&&t.elements.length>0,d=this.canEdit&&ur(t,r);return h`<span class="tab-wrap">
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=kc(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${ee.states}`}>
      ...
      ${c}
    </span>`}commitTestValue(t,i){this.editingValue=void 0,this.setTestValue(t,i)}setTestValue(t,i,a){let r=i?.trim()??"",o=new Map(this.testValues),s=t.startsWith(tr)?this.sharedRaw(t.slice(tr.length)):this.hass.states[t]?.state;r===""||r===s?o.delete(t):o.set(t,r),this.applyTestValues(o,a)}sharedRaw(t){let i=this.draft?.config;if(!i)return;let a=this.buildContext(!1),r=a.namedValues.map(o=>({...o,value:{kind:o.value.kind}}));return new bt({...a,namedValues:r},i).resolve({kind:{kind:"named",id:t}})}applyTestValues(t,i){let a=this.draft;!a||t.size===a.testValues.size&&[...t].every(([o,s])=>a.testValues.get(o)===s)||(a.setTestValues(t,i),this.version++)}currentCase(){return Xi.find(t=>t.label===this.previewCase)??hi}previewSlot(t){return this.currentCase().slots[t]}crumbs(t,i){let a=this.inspect,r=t.name.trim()||"Complication",o=this.activeFamily==="inline"?"Inline":ae(this.activeFamily),s=a.kind==="family"&&i===void 0?h`<span class="here" style=${`--k:${ee.place}`}>${o} shape</span>`:h`<button @click=${()=>{this.inspect={kind:"family"}}} title="Edit the shape">${o}</button>`,l=f,d=f;if(i!==void 0)l=h`<span class="here" style="--k:var(--wa-accent)"><span class="kchip">Picked</span><span class="nm">${i} layers</span></span>`;else if(a.kind==="layer"){let c=t.elements.find(u=>u.payload.id===a.id);if(c){l=h`<span class="here" style=${`--k:${qe[c.kind]}`}><span class="kchip">${rn[c.kind]}</span><span class="nm" title=${Ce(c,de(this.host()))}>${Ce(c,de(this.host()))}</span></span>`;let u=st(t,c.payload.id);u&&(d=h`<span class="sep">›</span><button @click=${()=>{this.inspect={kind:"group",id:u.id}}} title="Edit the group">${u.name}</button>`)}}else if(a.kind==="group"){let c=t.groups?.find(u=>u.id===a.id);c&&(l=h`<span class="here" style=${`--k:${ee.group}`}><span class="kchip">Group</span><span class="nm" title=${c.name}>${c.name}</span></span>`)}return h`<div class="crumbs">
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${$e(a,"complication","Complication",Bp(a),{color:ee.complication,icon:"watch",alwaysOpen:!0})}
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([vv(r)]):new Set(al)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=de(r),s=new bt(this.buildContext(),this.draft?.config),l=jp(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)Re(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let b=g.elements.find(k=>k.payload.id===y.payload.id);b&&b.kind!=="image"&&b.kind!=="tap"&&b.kind!=="timeline"&&b.kind!=="chartTimes"&&b.kind!=="chartDots"&&b.kind!=="chartGrid"&&b.kind!=="imageTime"&&(b.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ...
      ${$e(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:ee.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=xu({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
