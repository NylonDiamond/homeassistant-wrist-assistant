...
/** A template every house can render: how many lights are on. With no lights
 * at all it prints 0 rather than failing. */
export const STARTER_TEMPLATE = "{{ states.light | selectattr('state', 'eq', 'on') | list | count }}";
