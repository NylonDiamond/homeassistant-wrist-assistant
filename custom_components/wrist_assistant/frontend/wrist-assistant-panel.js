...
`)}function dc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Xm(r));return{values:t,nullKeys:i}}function Xm(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Yo(e){let n=Wa(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Jm(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(uo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Zm=10800;function Qm(e,n,t){let i=n==="always"||n==="auto"&&t<=Zm;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function ja(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Qm(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function ef(e,n){return ut(e)===void 0?[]:ja(it(e)*60,Fi(e.timeLabelCount),e.hourCycle,e.minutes,n)}function tf(e,n){return kn(e)?ja(Math.round(e.historyMinutes)*60,Fi(dt(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function nf(e,n,t,i){return n===void 0&&i!==void 0?ut(i)===void 0?[]:ja(it(i)*60,Fi(dt(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!kn(n)?[]:ja(Math.round(n.historyMinutes)*60,Fi(dt(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Ln(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ve(e){let n=e.trim(),t=Ln(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Ln(i)}function af(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function rf(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function of(e){let n=e.trim(),t=Ln(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Ln(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Ln(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function sf(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function lf(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function df(e,n,t){if(Ae(n))return e;let i=n,a=e,r=Ln(e.trim()),o=i.duration?of(e):void 0;if(o!==void 0)a=sf(o);else if(i.relativeTime&&r!==void 0)a=rf(r);else{let s=Ve(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):af(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=lf(a);break}return a}function ii(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Be(e,n=240){return mc(e,n).map(t=>t.value)}function Jo(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Be(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:hc(r)}}function hc(e){return e.some(n=>n)?e:[]}function mc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function cc(e,n,t){let i=mc(e),a=i.map(g=>g.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Ut({bands:t.bands??[]}):[],d=t.bandAboveColorHex??oe,c=t.highColorHex??Ye,u=t.lowColorHex??Xe,p=[],m=(g,x)=>{if(g==="")return;let k=p.at(-1);k&&k.colorHex===x?k.text+=g:p.push({text:g,colorHex:x})},y=0;return i.forEach((g,x)=>{m(e.slice(y,g.start),n);let k=x===o?c:x===s?u:l.length>0?Ra(g.value,l,d):n,$=e[g.end-1]==="."?g.end-1:g.end;m(e.slice(g.start,$),k),y=$}),m(e.slice(y),n),p}function uc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function cf(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Oi(e,n=qt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:uf(i.slice(a+1))})}return t}function uf(e){try{return decodeURIComponent(e)}catch{return e}}function pf(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function pc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function hf(e,n,t){if(e===void 0)return 0;let i=Ve(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var ht=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=uc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=$n(n),i=Cn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Jo(a):{values:Be(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=hc(s),{values:Zo(o,tt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ve(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ve(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):uc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ae(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Jm(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?fd(r):uo(r,a.domainMax-a.domainMin));break}default:{let a=qo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return df(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Ln(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?ii(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ve(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ve(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ve(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=An(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:An(d),p=c===void 0?void 0:An(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Le[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=cc(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,y=nt(n.payload)&&!r.has("text"),g={kind:"text",...u,text:y?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(g.countdownEnd=p),y?(g.parts=this.resolveTextParts(n.payload.parts,i.rules,g,t),g.text=g.parts.map(x=>x.text).join(""),g):(cd(n.payload)&&(g.spans=cc(g.text,g.colorHex,n.payload)),g)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),y=n.payload.symbol.kind.kind==="literal",g=m===void 0&&y&&n.payload.path!==""?n.payload.path:void 0,x=m??p;g===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let k={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(k.path=g),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),y=(L,N,J)=>L??(N?Ve(this.resolve(N)??""):void 0)??J,g=y(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=y(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Ve(m),$=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&($=Ra(k,Ut(p),p.bandAboveColorHex));let C=x-g;if(p.total){let L=Ve(this.resolve(p.total)??"");L!==void 0&&(C=L)}let S=pc(C,1,Ma),I={kind:"gauge",...u,fraction:hf(m,g,x),style:p.style,lineWidth:p.lineWidth,colorHex:$,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:pc(k??0,0,S)};if(p.thresholdValue!==void 0&&x!==g){let L=(p.thresholdValue-g)/(x-g);L>=0&&L<=1&&(I.thresholdFraction=L)}return I}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),y=m.values,g=m.holes,x={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Ut(p),C=md(p)?y.map(j=>Ra(j,$,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",I=p.highlight==="lowest"||p.highlight==="both",L=$i(p),N={kind:"chart",...u,values:y,holes:g,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?L.high:"none",lowMarker:I?L.low:"none",pointColorHexes:C,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:tt(p.smoothing)??"off",fillStyle:Nt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:Dt(p.barRadius),barCorners:Ot(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:tf(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},J=g.length===0?y:y.filter((j,U)=>!g[U]);if(J.length>0){let j=_=>y.findIndex((b,v)=>b===_&&g[v]!==!0),U=S?j(Math.max(...J)):-1,ne=I?j(Math.min(...J)):-1;U>=0&&(N.highIndex=U),ne>=0&&ne!==U&&(N.lowIndex=ne)}let R=cf(p,x.min,x.max);R!==void 0&&(N.thresholdY=R);let A=this.chartNowIndex(p,y.length);return A!==void 0&&(N.nowIndex=A),N}case"timeline":{let p=n.payload,m=ut(p),y=m===void 0?"":this.ctx.historySeries?.get(m)??"",g=Oi(y,qt),x=pf(g,it(p)*60,$=>kd($,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:ef(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};_a(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:nf(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),y={kind:"imageTime",...u,image:p.image,linked:m!==void 0},g=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return g!==void 0&&(y.url=g),y}case"chartDots":{let p=n.payload,m=lt(p.size),y={kind:"chartDots",...u,chart:p.chart,dots:$a(p.dots),diameter:0,indices:[]};return m!==void 0&&(y.size=m),p.colorHex!==void 0&&(y.colorHex=p.colorHex),y}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:yn(p.lines),colorHex:_t(p.colorHex),thickness:bn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=ue[t==="inline"?"rectangular":t],o=[...xf(bf(Bd(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,k=this.resolve(x.value),$=k===void 0?void 0:Ve(k);if($!==void 0){let C=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),I={value:Math.min(S,Math.max(C,$)),minValue:C,maxValue:S===C?C+1:S,colorHexes:x.colorHexes},L=this.resolve(x.minLabel);L!==void 0&&(I.minLabel=L);let N=this.resolve(x.maxLabel);N!==void 0&&(I.maxLabel=N),l.bezelGauge=I}}let y=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;y!==void 0&&(l.backgroundColorHex=y);let g=this.styleColor(s,"borderColor")??a?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function mf(e,n,t){let i=new ht(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Vi(e,n,t){let i=new ht(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=mf(e.inline,n,e)),a}function qa(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Xo=5,ff=1.7,gf=1.8;function yf(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function bf(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*gf,l=Math.max(o.frame.width*n.width,0),d=yf(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function fc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function gc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function Ya(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=N=>N==="triangle"?Xo+d:N==="dot"?Math.max(d,ff):d,u=c(a),p=c(r),m=n.y+u,y=Math.max(n.h-u-p,1),g=m+y,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",$=k?y*.12:0,C=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-C*(i-1))/i,.5),I=N=>Math.min(1,Math.max(0,(N-e.domainMin)/x)),L=N=>g-I(N)*y;return{count:t.length,barWidth:S,plotTop:m,plotBottom:g,plotLeft:o,plotRight:o+s,baselineY:k?g:L(0),inset:d,yAtFraction(N){return g-Math.min(Math.max(N,0),1)*y},barRect(N){let J=o+N*(S+C),R=t[N],A,j;if(k){let U=$+I(R)*(y-$);A=g-U,j=g}else A=L(R),j=k?g:L(0),A>j&&([A,j]=[j,A]);return{x:J,y:A,w:S,h:Math.max(j-A,.5)}},point(N){let J=Math.max(s-d*2,0);return{x:t.length>1?o+d+J*N/(t.length-1):o+s/2,y:L(t[N])}},markerCenter(N,J,R="high"){let A=J?this.barRect(N):void 0,j=A?A.x+A.w/2:this.point(N).x,U=R==="high"?a:r,ne=R==="high"?U==="triangle"?n.y+Xo/2:m:U==="triangle"?n.y+n.h-Xo/2:g;return{x:j,y:ne}}}}function yc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Zo(e,n,t=[]){let i=e.length,a=dd(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,y=0;for(let g=Math.max(0,p-r);g<=Math.min(i-1,p+r);g++){if(s(g))continue;let x=g-p,k=Math.exp(-(x*x)/(2*o*o));m+=e[g]*k,y+=k}return m/y}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function bc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Di=1;function ai(e,n){let t=Math.max(Wt,Math.min(jt,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Di>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Di:n.y,h:n.h-i-Di,cy:(e.labelsAbove?n.y+i+Di:n.y)+(n.h-i-Di)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function xf(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&fc(r)===void 0)return{...i,isHidden:!0};let o=wf(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function vf(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function wf(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=qa(t,i);if(a.w<=0||a.h<=0)return;let r=ai(t,a).body;if(r.w<=0||r.h<=0)return;let o=Ya(t,r),s,l;if(ct(n.at)){let k=vf(n.at,t);if(k===void 0)return;if(t.style==="bars"){let $=o.barRect(k);s=$.x+$.w/2,l=$.y}else{let $=o.point(k);s=$.x,l=$.y}}else{let k=n.at==="zero"?fc(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,$,C)=>$>C?($+C)/2:Math.min(Math.max(k,$),C),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let y=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,g=p(y,r.y+c/2,r.y+r.h-c/2),x=p(g+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var He=ue,Bi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:He,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],ri=Bi.find(e=>e.measured);function Mc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Bi.find(a=>a.screen.width===t&&a.screen.height===i)}function Ja(e,n){let t=He[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var ns={regular:400,medium:500,semibold:600,bold:700},kf=1.15;function Ge(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ye(e,n,t="#FFFFFF"){let i=Ge(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var Mt=e=>e*.55;function Rc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function $f(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Cf(e,n,t){if(t<=0||e.length*Mt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/Mt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Sf(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Fc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Ac(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Tf(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Hc(e,n){return e.reduce((t,i)=>t+i.text.length*Mt(i.look.fontSize*n),0)}function Ef(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:Mt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=Mt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Mf(e,n,t){if(t<=0||Hc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*Mt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*Mt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Rf(e,n,t){let i=Tf(n),a=e.lineLimit===2&&t.w>0?Ef(e.text,i,t.w):[e.text],r=Fc(e.text,a),o=a.map(($,C)=>Ac($,r[C]??0,e.text,i,i[0])),s=Math.max(...o.map($=>Hc($,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map($=>Mf($,l,t.w)),{anchor:c,x:u}=Rc(e.alignment,t),p=Math.max(0,...d.flat().map($=>$.look.fontSize))*l||e.fontSize*l,m=.35*p,y=p*1.15,g=$=>$.map(C=>{let S=ye(C.look.colorHex,"fill");return w`<tspan font-size=${C.look.fontSize*l} font-weight=${ns[C.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${C.text}</tspan>`}),x=ye(e.colorHex,"fill"),k=d.length>1?w`${d.map(($,C)=>w`<tspan x=${u} y=${t.cy+m+(C-(d.length-1)/2)*y}>${g($)}</tspan>`)}`:g(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${k}</text>`}function Ff(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(g=>g.text).join("")===e.text)return e.text===""?f:Rf(e,e.parts,n);let t=ye(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:ii((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?$f(e.text,n.w/Mt(e.fontSize)):[e.text],a=Math.max(...i.map(g=>g.length))*Mt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(g=>Cf(g,o,n.w)),{anchor:l,x:d}=Rc(e.alignment,n),c=Sf(e.text,e.spans),u=c?Fc(e.text,i):[],p=(g,x)=>c?Ac(g,u[x]??0,e.text,c,e.colorHex).map(k=>{let $=ye(k.look,"fill");return w`<tspan fill=${$.fill} fill-opacity=${$["fill-opacity"]}>${k.text}</tspan>`}):g,m=o*1.15,y=s.length>1?w`${s.map((g,x)=>w`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(g,x)}</tspan>`)}`:p(s[0],0);return w`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${ns[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${y}</text>`}var Qo=2;function Af(e,n){let t=ye(e.colorHex,"stroke"),i=ye(e.trackColorHex,"stroke","#FFFFFF"),a=ye(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,y=Math.max(1,e.dotCount),g=m?n.w:n.h,x=m?n.h:n.w,k=Math.max(1,Math.min(x,g/y-Qo)),$=y*k+(y-1)*Qo,C=(m?n.cx:n.cy)-$/2+k/2;return w`${Array.from({length:y},(S,I)=>{let L=C+I*(k+Qo),N=I<e.filledCount?t:i;return w`<circle cx=${m?L:n.cx} cy=${m?n.cy:L} r=${k/2}
    ...
    </g>`}function Hf(e,n,t,i,a){let r=ye(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return w`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function If(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ai(e,n),o=r?ss(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:w`${o}`;let s=_f(e,a);return o===void 0?s:w`${s}${o}`}function es(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var xc=0;function Ic(){return xc+=1,xc.toString(36)}function Lf(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function _f(e,n){let t=Ya(e,n),i=Ic(),a=ye(e.colorHex,"fill"),r=ye(e.highColorHex,"fill",e.colorHex),o=ye(e.lowColorHex,"fill",e.colorHex),s=(y,g)=>w`<circle cx=${y.x} cy=${y.y} r="1.7" fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=y=>c?ye(e.pointColorHexes[y],"fill",e.colorHex):a,p=y=>{let g=Ge(y)??Ge(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:g.color,opacity:g.opacity*.28};let x=zf(i,e.id,y),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,w`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${g.color} stop-opacity=${g.opacity*.28} />
        <stop offset="1" stop-color=${g.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let y=0;y<t.count;y++){if(e.holes[y]===!0)continue;let g=t.barRect(y),x=y===e.highIndex?r:y===e.lowIndex?o:u(y),k=Math.min(Math.max(e.barRadius,0),g.w/2,g.h/2);if(e.barCorners==="top"){let $=e.baseline==="zero"&&e.values[y]<0;l.push(w`<path d=${Lf(g,k,$)}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else l.push(w`<rect x=${g.x} y=${g.y} width=${g.w} height=${g.h} rx=${k}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let y=Array.from({length:t.count},($,C)=>t.point(C)),g=e.holes.length>0,k=bc(t.count,e.holes).filter($=>!g||$.length>1).map($=>{let C=$.map(L=>y[L]),S=yc(C,e.curve),I=`M${C[0].x} ${C[0].y}${S.map(L=>` ${es(L)}`).join("")}`;return{run:$,pts:C,legs:S,line:I}});if(e.style==="area")for(let{run:$,pts:C,legs:S,line:I}of k)if(e.fillBands&&c&&$.length>1&&e.fillColorHex===void 0)for(let L=0;L<S.length;L++){let N=C[L],J=C[L+1],R=p(e.pointColorHexes[$[L+1]]),A=`M${N.x} ${N.y} ${es(S[L])} L${J.x} ${t.baselineY} L${N.x} ${t.baselineY} Z`;l.push(w`<path d=${A} fill=${R.fill} fill-opacity=${R.opacity} stroke="none" />`)}else{let L=p(e.fillColorHex??e.colorHex),N=`${I} L${C[C.length-1].x} ${t.baselineY} L${C[0].x} ${t.baselineY} Z`;l.push(w`<path d=${N} fill=${L.fill} fill-opacity=${L.opacity} stroke="none" />`)}for(let{run:$,pts:C,legs:S,line:I}of k)if(c&&$.length>1)for(let L=0;L<S.length;L++){let N=C[L],J=u($[L+1]);l.push(w`<path d=${`M${N.x} ${N.y} ${es(S[L])}`} fill="none"
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>w`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Bf(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ye(e.colorHex,"fill"),s=e.size*kf;return w`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var ls=.25,Gf=8;function Uf(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,ls),Gf),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,y=i*p,g=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+g)+0,y:-(y-n)/2*(1+x)+0,width:m,height:y}}function _c(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Xa=4;function Kf(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Xa:n.x+n.w-Xa-a,d=e.timestampCorner.startsWith("top")?n.y+Xa:n.y+n.h-Xa-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Wf(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function jf(e,n,t){let i=t.icons,a=`imgclip-${Ic()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Kf(e,n,_c(new Date)):void 0,s=o?zc(o):f,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=Uf(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=w`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Wf(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return w`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${d}${s}</g>`}function zc(e,n=1){return w`<g opacity=${n}>
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function qf(e,n){if(!e.linked)return f;let t=_c(new Date),i=_d(n.w,n.h);if(i<=0)return f;let a=t.length*i*.578+i*.89,r=i*1.25;return zc({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function Yf(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Xf(a,n):void 0;return w`
    ...
    ${o!==void 0?w`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${is} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?w`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var is=5;function Xf(e,n){let t=is*.55,i=n.w-2;if(n.h<is*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Pc(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function as(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return f;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return f;let d=qa(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=Ff(e,d);break;case"icon":u=Bf(e,d,t.icons);break;case"gauge":u=Af(e,d);break;case"chart":u=If(e,d);break;case"timeline":u=Pf(e,d);break;case"chartTimes":u=Nf(e,d);break;case"imageTime":u=qf(e,d);break;case"chartDots":u=Df(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=Of(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=Vf(e,d);break;case"image":u=jf(e,d,t);break;case"tap":u=Yf(e,d,t.icons,r,c?Ct(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,y=t.highlightId===e.id,g=y||t.highlightIds?.includes(e.id)===!0,x=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",$=t.handles===!0&&(!l||s)&&!x&&!k,C=g&&!x?w`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?w`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${d.cx} ${d.cy})">${I}${u}${S}${C}${N}</g>`}function Za(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function ds(e,n){return(n?23.5:34)*e}var vc=10.5;function Nc(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function wc(e,n){let t=0;for(let i of e)t+=Nc(i,n);return t}function kc(e,n,t){let i=e.toUpperCase(),a=d=>Nc(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function rs(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function os(e,n,t,i){let a=rs(e,n,t),r=rs(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Dc(e,n,t,i){let{dial:a}=Za(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:os(a,t,i.start,i.end),length:t*r}}function Jf(e,n){let t=Za(e,!0);return Dc(e,n,t.dial.r,t.labelArc)}var $c=18.5,Zf=113,Qf={start:-71,end:-36},Cc=104,eg=6.2,Sc={start:-77,end:-30.5};function Tc(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Ec(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Tc(e[i]),o=Tc(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var ts=11;function tg(e,n,t){let{dial:i}=Za(n,!0),a=Cc*n,r=180/(Math.PI*Cc),o=e.minLabel!==void 0?wc(e.minLabel,ts)*r:0,s=e.maxLabel!==void 0?wc(e.maxLabel,ts)*r:0,l=Sc.start+(o>0?Math.max(0,o-1.8):0),d=Sc.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let k=0;k<u;k++){let $=l+c*k/u,C=Math.min(d,l+c*(k+1)/u+.4);p.push(w`<path d=${os(i,a,$,C)} fill="none"
      stroke=${Ec(e.colorHexes,(k+.5)/u)} stroke-width=${eg*n}
    ...
    <circle cx=${y.x} cy=${y.y} r=${3.2*n} fill=${Ec(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?x(`${t}-gmin`,l-g-Math.max(o,3),l-g,e.minLabel):f}
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+g,d+g+Math.max(s,3),e.maxLabel):f}`}function Qa(e,n){let t=e.family in He?e.family:"rectangular",i=n.slot??He[t],a=He[t],r=Ja(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ge(e.backgroundColorHex),l=Ge(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Pc(c);if(t==="corner"){let x=r.scale,k=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",C=$!=="",S=Za(x,k),I=ds(x,k),L=I/(a.width*x),N=S.tile.cx-I/2,J=S.tile.cy-I/2,R=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,A=f;if(e.bezelGauge)A=tg(e.bezelGauge,x,o);else if(e.bezelText){let U=Jf(x,`${o}-bezel`),ne=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?ii((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;A=w`<defs><path id=${U.id} d=${U.d} /></defs>
        <text font-size=${vc*x} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${U.id}" startOffset="50%" text-anchor="middle">${kc(ne,U.length,vc*x)}</textPath></text>`}let j=f;if(C){let U=Ge(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ne=Dc(x,`${o}-curved`,Zf*x,Qf);j=w`<defs><path id=${ne.id} d=${ne.d} /></defs>
        <text font-size=${$c*x} font-weight="600" fill=${U.color} fill-opacity=${U.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${ne.id}" startOffset="50%" text-anchor="middle">${kc($,ne.length,$c*x*.88)}</textPath></text>`}else{let U=e.borderWidth*r.scale*L,ne=l?w`<circle cx=${I/2} cy=${I/2} r=${I/2-U/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${U} />`:f;j=w`<g transform="translate(${N} ${J})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${yg(e)}</svg>`}var ft="color-mix(in srgb, var(--k) 45%, #6b7280)",li='system-ui, -apple-system, "Segoe UI", sans-serif';function hu(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function vs(e,n,t,i){return w`<g fill="none" stroke-linecap="round">
    <path d=${hu(e,n,t,1)} stroke=${ft} stroke-width="2.6" opacity=".5" />
    <path d=${hu(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function bg(e){switch(e){case"text":return w`<g font-family=${li} text-anchor="middle">
    ...
    </div>`}function Ng(e,n){let t=i=>tn(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${ze(e.label,t(e))}
    <div class="pair-row">
    ...
    <div class="color-row">${Cr(e,n,i,!1,t)}</div></div>`}function Bs(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function Lr(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Dg(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Iu(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var np=50;function Og(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Vg(e,n,t=np,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Bg=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function ip(e){return Bg.test(e.trim())}function Gg(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return Lr(t,i);if(ip(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Nn=new Map;function Me(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Gs(e){return Nn.has(e)}function gt(e,n,t,i,a,r={}){let o=e.hass.states,s=Nn.get(a),l=s?Vg(Dg(o,r.domain,Iu(e.hass)),s.query,np,r.preferNumeric?Og:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(C,S,I=0)=>{Nn.set(a,{query:S,index:I}),Me(C)},p=C=>{Nn.delete(a),Me(C)},m=C=>{let S=Gg(C,t,o);S&&i(S)},y=(C,S)=>{i(Lr(o,C.entityId)),p(S)},g=()=>Math.max(0,Math.min(Nn.get(a)?.index??0,l.length-1)),x=C=>{let S=C.target;if(C.key==="ArrowDown"||C.key==="ArrowUp"){C.preventDefault();let I=Nn.get(a);if(!I){u(S,S.value);return}let L=C.key==="ArrowDown"?g()+1:g()-1;u(S,I.query,Math.max(0,Math.min(l.length-1,L))),Ug(S);return}if(C.key==="Enter"){C.preventDefault();let I=l[g()];s&&I?y(I,S):(m(S.value),p(S));return}if(C.key==="Escape"){if(!s)return;C.preventDefault(),C.stopPropagation(),p(S)}},k=t.entityId?Iu(e.hass)?.(t.entityId):void 0,$=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${C=>{let S=C.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Nn.set(a,{query:"",index:0}),Me(S),S?.focus()}}>${G("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${ip(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((C,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
    ...
    <span class="sym-name">${n}</span>
      ...
      ${C===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${zu(I.length,S.length,!0,C.length)}</div>`}
    ...
    </div>`}else if(o){let C=r.category(i),S=Kg(C,s,d,c),I=ms(S.names,s),L=S.fromPack?I.slice(0,Lu):I,N=r.recent.filter(R=>!R.startsWith(De)),J=c.size===0?N:N.filter(R=>c.has(R));$=h`<div class="sym-browse">
      ${m?Pu(r,i,y):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${be(R=>r.setQuery(i,R))} />
        <select @change=${be(R=>r.setCategory(i,R))}>
          ${Wg(c).map(R=>h`<option value=${R.value} ?selected=${R.value===C}>${R.label}</option>`)}
        </select>
      </div>
      ...
      ${I.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${zu(L.length,I.length,s.trim()!=="",jg(d))}
          </div>`}
    ...
    ${$}`}function qg(e,n){let t=e.trim();return t!==""&&!t.startsWith(De)&&n.size>0&&!n.has(t)}function Yg(e,n){let t=n.trim(),i=t.startsWith(De)?t.slice(De.length):t,a=e.map(r=>r.startsWith(De)?r.slice(De.length):r);return ms(a,i).map(r=>De+r)}function Pu(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Xg=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Jg={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Zg=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],Qg=[["flat","Flat"],["fade","Fade"]],rp=[["auto","Auto"],["all","All"]],ey=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],op=[["bars","Bars"],["line","Line"],["area","Area"]],ty=[["auto","Auto"],["fixed","Fixed range"]],ny=[["lowest","Lowest value"],["zero","Zero"]],iy=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],zs=[["uniform","One colour"],["bands","By value"]];function Sr(e){let n=[so,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:X(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:X(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function Us(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function ay(e,n){let t=Ut({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:X(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function ry(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function oy(e,n,t){let{lo:i,hi:a}=ry(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
    ...
    ${pe("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??Kt},"tother"),!1,Kt)}`}var dy=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],cy={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Nu(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return H(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var uy=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function py(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function re(e,n,t,i){if(i.inline||!hy())return h`<div class="value-editor">${cp(e,n,t,i)}</div>`;let a=_r(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=ke(n,de(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${Zi.has(n)?cp(e,i,a,r):f}
  </div>`}function de(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function _r(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function hy(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Zi=new Set,qi=new WeakMap;function my(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function lp(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function dp(e){let n=e.currentTarget,t=e.newState==="open",i=qi.get(n);if(i&&(i(),qi.delete(n)),!t){Zi.delete(n.id)&&Me(n);return}let a=my(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){qi.get(n)?.(),qi.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}Ms(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),qi.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Ms(n,a.getBoundingClientRect()),Zi.has(n.id)||(Zi.add(n.id),Me(n),requestAnimationFrame(()=>{n.isConnected&&Ms(n,a.getBoundingClientRect())}))}function Ms(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=fy({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Pn=8,fr=6,Du=140;function fy(e,n,t){let i=t.height-e.bottom-fr-Pn,a=e.top-fr-Pn,r=n.height>i&&a>i&&i<Du,o=Math.max(Du,r?a:i),s=Math.min(n.height,o),l=Math.max(Pn,Math.min(e.left,t.width-n.width-Pn)),d=r?Math.max(Pn,e.top-fr-s):Math.max(Pn,Math.min(e.bottom+fr,t.height-s-Pn));return{left:l,top:d,maxHeight:o,above:r}}function cp(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Xg.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?ap(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):$e("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=gt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${gt(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${$e("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=$y(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=xe("Field",a.timeField,uy,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${ep("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Li(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>wy(e,n,t)}>Start an empty one</button>,
    ...
    ${n.function==="count"?f:$e("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var pp=ko,Cy=pp.filter(([e])=>e!=="none");function Sy(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function hp(e,n){let t=Sy(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return Cd(e)?{type:e,...t}:{type:e}}var Ty=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function mp(e,n,t,i){let a=n.serviceDataJSON??"",r=Sd(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??My).slice(0,7)}
    ...
    ${t.type==="openPage"?Ry(e):f}`}var My="#808080",Ou=[0,15,30,60,120];function Vu(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Ry(e){let n=e.config;return gp(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function gp(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${xe("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ...
  </section>`}function zy(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Py(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Ny(e,n){let t=ue[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Dy(e,n,t){let i=Ny(e,n),a=ue[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Uy(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Re(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Ce(p,t,i,{frame:ws(o,c)}),`${a}-${u}-${t}`),l=!Er(o,Ei)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return ve(e,"placement","Position",h`
      ...
      ${Ke("Hidden",r.isHidden,u=>e.update(p=>Ce(p,t,i,{isHidden:u})),!1)}`,{color:Z.position,icon:"place",summary:`On the chart \xB7 ${te(t)}`})}return d?.place==="through"?ve(e,"placement","Position",h`
      ...
      ${Ke("Hidden",r.isHidden,c=>e.update(u=>Ce(u,t,i,{isHidden:c})),!1)}`,{color:Z.position,icon:"place",summary:`On the chart \xB7 ${te(t)}`}):ve(e,"placement","Position",h`
    ${Gu(e,n,t)}
    ${d===void 0?h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function Ky(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Oe(e.config,t)[0];return ve(e,"tappable","Tap",bb(e,n,`el-${t}`),{color:Z.tap,icon:"tap",summary:i?Ct(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Oa(a,t))}:{}})}function Wy(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${Q("Clock",e.hourCycle,bd,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${Q("Minutes",e.minutes,xd,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var jy=[["number","Number"],["entity","Entity"]];function qy(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Yy(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Xy(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=qy(n,o),c=s?n.minValue:n.maxValue,u=g=>a(x=>{s?x.minValue=g??0:x.maxValue=g??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ...
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${jy.map(([g,x])=>h`<button type="button" role="radio" aria-checked=${g===d?"true":"false"}
          ...
          @click=${()=>{g!==d&&a(k=>Yy(k,o,g))}}>${x}</button>`)}
      </span>
    ...
    ${Q("Highlight",r,iy,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
      ...
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var Ji=new Map,Xi=new Map,Rt=new Map,yr=new Map,Hs=4,Is=40,Zy=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Qy=[["plain","Plain"],["rich","Rich"]],eb={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function Ws(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Ke("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function tb(e){return e.countdown===!0?"countdown":nt(e)?"rich":"plain"}function nb(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function ib(e,n){let t=vn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:_e(e.kind.value,40)||"template"}:{kind:"value",label:ta(e,n)}}function $p(e,n,t){let i=vn(e.value),a=i===void 0?_e(ta(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${_e(i,24)}"`;return`Part ${n+1}: ${a}`}function ab(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,$p(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function Ns(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function rb(e,n){if(Ns(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Ut({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??oe],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function Uu(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${Pr(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var ob={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function sb(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${Pr(e.moved.map(n=>ob[n]))} moved into Look.`}function lb(e,n,t,i,a){let r=n.payload,o=r.id,s=tb(r),l=(r.parts?.length??0)>0,d=$o(e.config,r.value),c=Rt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?Xi.get(o):void 0,m=(x,k)=>{let $=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),C=hr(structuredClone(r),e.config.values);if(Xi.delete(o),!C.ok){Rt.set(o,{text:Uu(C.blocked),rich:!0,warn:!0}),Me(k);return}Rt.set(o,{text:sb(C.joined?{joined:!0,template:$}:C),rich:!1}),i(S=>{hr(S,e.config.values),x==="countdown"&&(S.countdown=!0)})},y=(x,k)=>{if(Xi.delete(o),s==="rich"){let $=x==="countdown"?"countdown":"plain",C=r.parts??[];if(C.length<2){m($,k);return}let S=Ss(C,e.config.values);S.ok?(Rt.delete(o),Xi.set(o,$)):Rt.set(o,{text:Uu(S.blocked),rich:!0,warn:!0}),Me(k);return}if(x==="rich"){let $=r.parts?.[0]?.id??X();Ji.set(o,$),Rt.delete(o),i(C=>{delete C.countdown,Au(C,$)});return}Rt.delete(o),i($=>{if(x==="countdown"){$.countdown=!0;return}($.parts?.length??0)>0&&hr($,e.config.values),delete $.countdown})},g=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${Q("Type",s==="rich"?"rich":"plain",Qy,y,{titles:eb})}
    ...
    ${s==="rich"?db(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Se(d,de(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function db(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=de(e),d=Math.max(0,o.findIndex(_=>_.id===Ji.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Re(e.config,t,n).size??r.fontSize,y=(_,b)=>{Rt.delete(s),i(v=>{_(v),ud(v)},b)},g=(_,b)=>y(v=>{let M=v.parts?.find(T=>T.id===c.id);M&&_(M)},b?`part-${c.id}-${b}`:void 0),x=(_,b)=>{Ji.set(s,_),Rt.delete(s),Me(b)},k=(_,b)=>{let v=X();Ji.set(s,v),y(M=>{(M.parts??=[]).push({id:v,value:_})}),lp(b,_r(`${a}-part-${v}`),!0)},$=_=>y(b=>{b.parts&&Qi(b.parts,d,_)}),C=()=>{let _=o[d+1]??o[d-1];_&&Ji.set(s,_.id),y(b=>{b.parts=(b.parts??[]).filter(v=>v.id!==c.id)})},S=o.map((_,b)=>{let v=ib(_.value,l),M=_.id===c.id,T=Ns(_),F=v.kind==="value"?e.resolve(_.value):void 0,O=_.fontWeight===void 0?void 0:ui.find(([K])=>K===_.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${M?"true":"false"} class="part-chip ${v.kind} ${M?"on":""}"
      aria-label=${$p(_,b,l)} @click=${K=>x(_.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${rb(_,p)}`}
        title=${T==="bands"?"By value, with its own bands":T==="pick"?"Its own colour":"The layer colour"}></span>
      ${v.kind==="text"?h`<span class="part-txt">${v.label===""?h`<span class="part-empty">empty</span>`:nb(v.label).map(K=>K.space?h`<span class="part-sp">${"\xB7".repeat(K.text.length)}</span>`:K.text)}</span>`:h`<span class="part-txt">${v.label}</span>`}
    ...
    <div class="part-editor">
      ...
      ${Q("Colour",N,Zy,_=>g(b=>{if(_==="layer"){delete b.colorHex,delete b.coloring;return}if(_==="pick"){delete b.coloring,b.colorHex=Bs(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Sr(Be(e.resolve(b.value)??"")))}),{def:"layer",titles:U,...L&&N!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <label class="field num part-size">${ze("Font size",J?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>g(_=>{delete _.fontSize})}:void 0,Hr(c.fontSize??m,A,{step:1,min:Hs,max:Is}))}
  ...
  </div>`}function Cp(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,v)=>e.update(M=>b(M.elements[r]),v?`${o}-${v}`:void 0),l=Re(e.config,t,n),d=l.frame,c=(b,v)=>e.update(M=>Ce(M,t,a,{frame:ws(d,b)}),`${o}-${v}-${t}`),u=we(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],y=!1,g=b=>Dn(n)===void 0?f:pe(b,Dn(n),v=>s(M=>{Dn(M)!==void 0&&(M.payload.colorSlot.baseColorHex=v??"#FFFFFF")},"color"),!1,p),x,k,$;switch(n.kind){case"text":{let b=(v,M)=>s(T=>v(T.payload),M);k=lb(e,n,t,b,o),y=!n.payload.countdown&&!nt(n.payload),$=h`
        ...
        ${Ng({label:"Align",value:n.payload.alignment??"center",options:Ay,def:"center",set:v=>s(M=>{let T=M.payload;v==="center"?delete T.alignment:T.alignment=v})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:Hy,def:"1",set:v=>s(M=>{let T=M.payload;v==="2"?T.lineLimit=2:delete T.lineLimit})})}
        ...
        ${y?Jy(e,n.payload,b,g("Main colour")):f}`;break}case"icon":k=h`
        ...
        ${M?h`
            ${re(e,b.total??Nu(b),T=>v(F=>{F.total=T},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Ma} dots are drawn.</div>`:Xy(e,b,{min:u.minValue,max:u.maxValue},o,v)}`,y=!0,$=h`
        <div class="grid2">
          ${Q("Style",b.style,dy,T=>v(F=>{T==="dots"&&F.total===void 0&&(F.total=Nu(F)),T!=="dots"&&delete F.total,F.style=T}),{titles:cy,def:u.style})}
        ...
        ${M?f:h`
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,v=(E,z)=>s(Fe=>E(Fe.payload),z),M=u.historyMinutes,T=u.historyPoints,F=b.historyMinutes>0,O=F&&b.source==="statistics",K=F&&!O,se=F?O?"statistics":"history":"value",We=O?Ri:wn,Ht=$n(b)??Cn(b),Ie=b.value.kind.kind==="entityState",he=Ht===void 0?void 0:e.historySeries(Ht),Pe=F&&Ie?he??"":e.resolve(b.value)??"",je=b.historyPoints<1,dh=K&&Ie&&Ht!==void 0?e.historyReadings?.(Ht):void 0,ll=By(je,dh,Vn(b.historyMinutes)),dl=Ps(a,b.historyMinutes,We),Or=F&&Ie?Jo(Pe):{values:Be(Pe),holes:[]},Kn=Or.values,cl=E=>b.limit>0&&E.length>b.limit?b.takeFromEnd?E.slice(E.length-b.limit):E.slice(0,b.limit):E,ch=cl(Kn),It=Zo(ch,tt(b.smoothing),Or.holes.length>0?cl(Or.holes):[]),uh=!F&&Ie&&Kn.length===1,Vr=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),ph=de(e),aa=b.scaleFrom!==void 0&&Vr.some(E=>E.payload.id===b.scaleFrom);k=h`
        ${re(e,b.value,E=>v(z=>{z.value=E},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${Q("Draw",se,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>v(z=>{if(E==="value"){z.historyMinutes=0;return}z.source=E==="statistics"?"statistics":"history";let Fe=z.historyMinutes||Fa;z.historyMinutes=E==="statistics"?Math.min(Fe,po):Math.min(Fe,Aa)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${O?h`
                ...
                <div class="readings-row">
                  ...
                  ${je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${be(E=>{let z=Number(E);E.trim()!==""&&Number.isFinite(z)&&z>=1&&v(Fe=>{Fe.historyPoints=Math.round(z)},"hpoints")})} />
        ...
        ${Kn.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${zy(It)}</span>${Kn.length===It.length?h` · ${It.length} ${It.length===1?"value":"values"}`:h` · ${It.length} of ${Kn.length}`}</span></div>`:f}
        ${uh?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        ${xe("Smooth data",tt(b.smoothing)??"off",ey,E=>v(z=>{let Fe=tt(E);Fe===void 0?delete z.smoothing:z.smoothing=Fe}),{def:tt(u.smoothing)??"off"})}
        ${Qt(e)}
        ...
        ${b.style==="bars"?h`
          <div class="grid2">
            ${ee("Corner radius",Dt(b.barRadius),E=>v(z=>{let Fe=Math.max(0,E??Yn);Fe===Yn?delete z.barRadius:z.barRadius=Fe},"barradius"),{step:.5,min:0,def:Dt(u.barRadius),unit:"pt"})}
          </div>
          ...
          ${Q("Curve",b.curve??"straight",Zg,E=>v(z=>{E==="straight"?delete z.curve:z.curve=E}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Qt(e)}
          ${b.style==="area"?h`
            ${Q("Fill",Nt(b.fillStyle),Qg,E=>v(z=>{E==="flat"?delete z.fillStyle:z.fillStyle=E}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:Nt(u.fillStyle)})}
            ${_s("Fill colour",b.fillColorHex,"Line colour",E=>v(z=>{E===void 0?delete z.fillColorHex:z.fillColorHex=E},"fillcol"))}
            ${Qt(e)}`:f}`}
        <div class="grid2">
          ${Q("Scale",b.scale,ty,E=>v(z=>{z.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${Q("Baseline",b.baseline,ny,E=>v(z=>{z.baseline=E}),{def:u.baseline})}
        </div>
        ${Vr.length===0?f:xe("Same scale as",aa?b.scaleFrom:"",[["","Its own"],...Vr.map(E=>[E.payload.id,Se(E,ph)])],E=>v(z=>{E?z.scaleFrom=E:delete z.scaleFrom}),{def:""})}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(z=>{E=jd(z,a)}),E&&e.selectLayer(E)}}>${G("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ...
        ${b.coloring==="bands"?h`
          ...
          ${b.style==="area"?h`${Ke("Band fill",b.fillBands,E=>v(z=>{z.fillBands=E}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let ul=E=>Ne(e.config,a).some(z=>z.payload.chartAnchor?.at===E),mh=Yt(e.config,a).length>0,fh=Mn(e.config,a).length>0,gh=Rn(e.config,a).length>0,pl=zd(e.config,a).length>0,yh=kn(b)?void 0:je&&K?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",bh=b.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0,Wn=(E,z,Fe,ra)=>h`
        <button class="small ${z?"on":""}" ?disabled=${z||ra!==void 0} aria-pressed=${z?"true":"false"}
          ...
          @click=${()=>e.update(xh=>{Fe(xh)})}>${z?h`<span aria-hidden="true">✓</span>`:G("plus")}<span>${E}</span></button>`;x=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders">
            ${Wn("Threshold line",ul("threshold"),E=>Pd(E,a,b.thresholdValue??Us(It)))}
            ${Wn("Now line",ul("now"),E=>Nd(E,a,!0))}
            ${Wn("Zero line",pl,E=>{Fo(E,a)})}
            ${Wn("Clock times",mh,E=>{En(E,a)},yh)}
            ${Wn("Dots",fh,E=>{Mo(E,a)},bh)}
            ${Wn("Grid lines",gh,E=>{Ro(E,a)})}
          </div>
        </div>
        ${pl&&!hh?h`<div class="hint warn">These readings never go below zero, or never above it, so the zero
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${Qt(e)}`;break}case"timeline":{let b=n.payload,v=(he,Pe)=>s(je=>he(je.payload),Pe),M=u.historyMinutes,T=b.value.kind.kind==="entityState",F=ut(b),O=F===void 0?void 0:e.historySeries(F),K=it(b)*60,se=Oi(O??"",qt),We=Ps(a,b.historyMinutes),Ht=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,Ie=sy(se,K,Ht===void 0?void 0:e.hass.states[Ht]?.state,Ht?.split(".")[0]);k=h`
        ...
        ${se.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Vy(se,K)}</span></span></div>`:f}
        ${Oy(se)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${ly(b,v,Ie,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
...
`;break}case"shape":k=h`<div class="grid2">
        ...
        ${n.payload.kind==="line"?Dy(t,d,c):f}`,$=n.payload.kind==="line"?ee("Thickness",n.payload.thickness,b=>s(v=>{v.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        <div class=${b.contentMode==="fit"&&b.zoom===1?"hint keep":"hint"}>${_y(b)}</div>
        ...
        <div class="hint">The clock times of that ${F}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,$=Wy(b,v,u,"ct",h`
        ...
        <div class="field readout"><span>Picture</span><span class="readout-v">${M?h`<button class="small" title="Select that picture" @click=${()=>e.selectLayer(M.payload.id)}>${Se(M,de(e))}</button>`:"None"}</span></div>
        ...
        ${Qt(e)}`,$=h`
        ${Q("Dots",b.dots,rp,K=>v(se=>{se.dots=K}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
        ...
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let C=y||Dn(n)===void 0?void 0:g(n.kind==="shape"?"Fill colour":n.kind==="text"&&nt(n.payload)?"Layer colour":"Colour"),S=Lo(e.config,n),I=S?{kind:{kind:"entityState",...S}}:void 0,L=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,N=ub[n.kind],J=pb[n.kind],R=Rs(n.payload,u,N),A=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,j=e.config.perFamily[t]?.placements[a]?.size!==void 0,U=Rs(n.payload,u,J)||A!==void 0&&l.size!==void 0&&l.size!==u[A],ne=Tn(e.config,a),_=(b,v)=>()=>s(M=>gr(M.payload,u,b),v);return h`
    ${ve(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:wp(e,n,o)}${k}`,{color:Z.content,icon:"content",summary:Ks(e,n),...R?{reset:()=>s(b=>{gr(b.payload,u,N),b.kind==="text"&&ji(b.payload.rules)},"reset-content")}:{}})}
    ${$===void 0&&C===void 0?f:ve(e,"look",n.kind==="image"?"Picture":"Look",h`${$??f}${C??f}`,{color:Z.look,icon:n.kind==="image"?"image":"look",...Mr(n)?{summary:Mr(n)}:{},...U?{reset:()=>e.update(b=>{gr(b.elements[r].payload,u,J),j&&Ce(b,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?ve(e,"numbers","Extras",gb(e,n,x),{color:Z.numbers,icon:"text",summary:fb(e,n),...ne.length>0||Ne(e.config,a).length>0||Yt(e.config,a).length>0||Mn(e.config,a).length>0||Rn(e.config,a).length>0||Rs(n.payload,u,Wu)?{reset:()=>e.update(b=>{for(let M of Tn(b,a))fe(b,M.payload.id);for(let M of Ne(b,a))fe(b,M.payload.id);for(let M of Yt(b,a))fe(b,M.payload.id);for(let M of Mn(b,a))fe(b,M.payload.id);for(let M of Rn(b,a))fe(b,M.payload.id);let v=b.elements.find(M=>M.payload.id===a);v&&gr(v.payload,u,Wu)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?cb(e,n):f}
    ${ve(e,"states","States",Hp(e,n.payload.rules,n.kind,b=>b.elements.find(v=>v.payload.id===a)?.payload.rules,`rules-${a}`,I,L),{color:Z.states,icon:"states",summary:Ui(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Uy(e,n,t)}
    ${i.tap===!1?f:Ky(e,n)}`}function cb(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?Yt(e.config,t):To(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(u=>{let p=u.elements.find(y=>y.payload.id===t);if(!p)return;let m=p.payload.frame;p.payload.frame={...Re(u,o,p).frame},i?En(u,t):Eo(u,t,ue[o==="inline"?"rectangular":o]),p.payload.frame=m}),l=a.length>0,d=a.map(u=>({el:u,lead:G("clock"),title:r,kind:i?"Times":"Timestamp"})),c=h`
    <div class="field list-field"><span>Draw</span>
      <div class="adders">
    ...
    ${l?h`
      ...
      <div class="hint">Click the row to open its main settings here. More settings selects that layer. The ×
        deletes it, and Undo brings it back.</div>`:f}`;return ve(e,"numbers","Extras",c,{color:Z.numbers,icon:"clock",summary:l?`${r} layer`:"None yet",...l?{reset:()=>e.update(u=>{for(let p of a)fe(u,p.payload.id)})}:{}})}var ub={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[],chartDots:[],chartGrid:[],imageTime:[]},pb={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["dots","size","colorHex"],chartGrid:["lines","colorHex","thickness"],imageTime:[]};function Ku(e,n){return h`<div class="field readout"><span>Chart</span><span class="readout-v">${n?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(n.payload.id)}>${Se(n,de(e))}</button>`:"None"}</span></div>`}var Wu=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function js(e,n,t,i){let a=n.action;return h`
    ${xe("Tap action",a.type,Cy,r=>t(o=>{o.action=hp(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?gp(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var hb=24;function mb(e,n){let t=[],i=1/0;for(let r of ae){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Kd(e.config,n,r);o&&(t.push(`${te(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<hb;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function fb(e,n){let t=n.payload,i=Tn(e.config,t.id),a=Ne(e.config,t.id),r=Yt(e.config,t.id),o=Mn(e.config,t.id),s=Rn(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(xn.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(Gt.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function gb(e,n,t){let i=de(e),a=Tn(e.config,n.payload.id),r=Yt(e.config,n.payload.id),o=Mn(e.config,n.payload.id),s=Rn(e.config,n.payload.id),l=Ne(e.config,n.payload.id),d=g=>e.update(x=>{Ad(x,n.payload.id,g)}),c=g=>e.update(x=>{So(x,n.payload.id,g)}),u=new Set(a.map(g=>g.payload.value.kind.kind==="chartStat"?g.payload.value.kind.stat:"")),p=new Set(l.map(g=>g.payload.chartAnchor.at)),m=[...a.map(g=>({el:g,lead:e.resolve(g.payload.value)??"--",title:Se(g,i),kind:"Number"})),...l.map(g=>{let{at:x,place:k}=g.payload.chartAnchor,$=Gt.find(([S])=>S===x)?.[1]??"Reading";if(k==="through")return{el:g,lead:x==="now"?"\u2502":"\u2500",title:x==="zero"?"Zero":$,kind:"Line"};let C=g.kind==="text"?e.resolve(g.payload.value)??"\u25CF":g.kind==="icon"?xb(e.resolve(g.payload.symbol)):"\u25C6";return{el:g,lead:C,title:$,kind:"Marker"}}),...r.map(g=>({el:g,lead:G("clock"),title:"Clock times",kind:"Times"})),...o.map(g=>({el:g,lead:G("chartDots"),title:"Reading dots",kind:"Dots"})),...s.map(g=>({el:g,lead:G("chartGrid"),title:"Grid lines",kind:"Grid"}))],y=m.length;return h`
    ...
    ${y===0?f:h`
      ...
      <div class="hint">Click a row to open its main settings here. More settings selects that layer for the
        ...
        dot to pick the dots.</div>`}`}function qs(e,n,t){return h`<div class="chart-numbers">${$u(n,a=>a.el.payload.id,({el:a,lead:r,title:o,kind:s})=>{let l=a.payload.id,d=s.toLowerCase();return h`
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function yb(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);m&&c(m)},`${i}-${u}`),o=we(n.kind).payload,s=Dn(n),l=s===void 0?f:pe("Colour",s,c=>r(u=>{Dn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ...
        ${d?ju(e,t,d,r):re(e,n.payload.symbol,c=>r(u=>{u.kind==="icon"&&(u.payload.symbol=c)},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${i}-symbol`,setSymbolPath:c=>r(u=>{u.kind==="icon"&&(c?u.payload.path=c:delete u.payload.path)},"symbol")})}
        <div class="grid2">
        ...
        ${Q("Style",c.style,op,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
        ...
        ${Q("Dots",c.dots,rp,y=>r(g=>{g.kind==="chartDots"&&(g.payload.dots=y)},"mode"),{def:"auto"})}
        <div class="grid2">
        ...
        ${pe("Colour",c.colorHex,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.colorHex=u??kt)},"colour"),!1,kt)}`}default:return h`${l}`}}function ju(e,n,t,i){let a=Gt.filter(([r])=>ct(r)||r===t.at);return h`
    <div class="grid2">
    ...
    </div>`}function bb(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Oe(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=_o(e.config,n);return h`
    ...
    ${a?h`<div class="value-editor">
        ...
        ${mb(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${Ct(o)}</b>.</div>`}`}function qu(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function xb(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Se(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=Gt.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return qu(ke(e.payload.value,n));case"icon":return qu(ke(e.payload.symbol,n));case"gauge":return ke(e.payload.value,n);case"chart":return ke(e.payload.value,n);case"timeline":return ke(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines";case"imageTime":return"Timestamp"}}function Sp(e,n){let t=Tt(e.config,n.id),i=de(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return ve(e,"content","Group",h`
    ...
    ${qs(e,t.map(r=>({el:r,lead:G(r.kind),title:Se(r,i),kind:Jt[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Ii(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:Z.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Tp(e,n){if(n==="inline")return vb(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${te(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${te(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=zr(e.config,n),r=t.backgroundColorHex?Ee(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ee(t.borderColorHex)} border`:"no border";return h`
    ...
    ${ve(e,"content","Inline text",h`
      ...
      ${Ws(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:Z.content,icon:"text",summary:_e(`${n.label?`${n.label}: `:""}${ke(n.value,i)}`,48)})}
    ${ve(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:Z.look,icon:"icon",summary:n.symbol||"None"})}`}function wb(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="gauge"&&n.bezelGauge?kb(e,n.bezelGauge,t):f}`}function kb(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?re(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var sk=ae.map(e=>[e,te(e)]),Ys={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},$b=Object.keys(Ys),Rr=["color","text","fontSize","fontWeight","visibility"];function Cb(e,n=!1){let t=_i[e].filter(i=>!n||Rr.includes(i));return $b.filter(i=>t.includes(Le[i]))}function Ep(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${ab(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var Sb={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function br(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function _e(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Mp(e){if(!e||Ae(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function ke(e,n){return`${ta(e,n)}${Mp(e.format)}`}function ta(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${_e(t.value,40)}"`:"(empty)";case"entityState":return br(t,n);case"entityAttribute":return t.attribute?`${br(t,n)} \xB7 ${t.attribute}`:br(t,n);case"entityAge":return`age of ${br(t,n)}`;case"aggregate":return Tb(t.aggregate);case"time":return Sb[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${_e(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(xn.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?ta(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function Tb(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Qi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function Eb(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${s===void 0?f:Ep(s,n.partId,de(e),m=>u(y=>{m?y.partId=m:delete y.partId}))}
    ...
    ${n.cases.map((m,y)=>Rb(e,m,y,n,a,u,`${o}-${m.id}`,p))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${Rp(e,n.otherwise,a,m=>u(y=>{y.otherwise&&m(y.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function Rb(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(y=>y.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>Fb(e,c,u,p=>l(m=>{let y=m.when.tests.find(g=>g.id===c.id);y&&p(y)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(Uo())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=Fu(p,Su(e.hass?.states));l(y=>{y.when.tests.push(...m)})}}>
        <option value="">+ preset…</option>
        ${Mu.map(c=>h`<option value=${c.kind} title=${c.hint}>${c.label}</option>`)}
      </select>
    </div>
    <div class="hint keep" style="margin-top:8px">Then:</div>
    ${Rp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${s.pattern&&!Ab(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Yu(e,"From",s.value??H("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Yu(e,"To",s.upper??H("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=Hb(n.value)?Ib(s.options??[],u=>o(p=>{p.comparison.options=$s(u)},"options")):$e("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${xe("Comparison",s.kind,Qd.map(u=>[u,si[u]]),u=>o(p=>{p.comparison=Wo(p.comparison,u)}))}
    ${c}
  </div>`}function Ab(e){try{return new RegExp(e),!0}catch{return!1}}function Yu(e,n,t,i,a){if(t.kind.kind!=="literal")return re(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=An(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${be(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function Hb(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function Ib(e,n){let t=Eu(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${Tu.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function Rp(e,n,t,i,a,r=!1){let o=Cb(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>Lb(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(In(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${Ys[s]}</option>`)}
    </select>`}var Fp=["setColor","setBorderColor","setBackgroundColor"];function Lb(e,n,t,i,a,r,o,s=!1){let l=!_i[i].includes(Le[n.kind]),d=s&&!l&&!Rr.includes(Le[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${Ap(e,n,a,o)}
  </div>`}function Ap(e,n,t,i){let a=Ua(n.kind),r=f;if(a==="value"){let o=n.value??H("");if(Fp.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?pe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=H(l??"#FFFFFF")},"color")):re(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${Eb(e,n,t,i,a,o)}`:_b(e,s.table,n[0],t,i,a,r,o)}function _b(e,n,t,i,a,r,o,s){let l=(v,M)=>e.update(T=>{let F=a(T);F&&v(F)},M?`${r}-${M}`:void 0),d=n.value??Xu.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!pu(d)&&zb(e.resolve(d)),p=_i[i],m=xr.get(r)??new Set,y=n.columns.length===0&&m.size===0?[uu[i]]:[],g=nu(n.columns,[...m,...y.filter(v=>v!==void 0)],p),x=yr.get(r),k=t?t.partId:s?.some(v=>v.id===x)?x:void 0,$=s!==void 0&&k!==void 0,C=$?p.filter(v=>Rr.includes(v)):p,S=$?g.filter(v=>!Rr.includes(v)):[],I=(v,M)=>{if(!t){v?yr.set(r,v):yr.delete(r),Me(M);return}l(T=>{let F=T[0];F&&(v?F.partId=v:delete F.partId)})},L=t?e.liveBranch(t):"none",N=t?e.forced.get(t.id)??"live":"live",J=v=>N!=="live"&&(N==="otherwise"?v==="otherwise":N.caseId===v),R=v=>{t&&e.setForced(t.id,J(v)?"live":v==="otherwise"?"otherwise":{caseId:v})},A=v=>{Xu.set(r,v),n.rows.length!==0&&l(M=>lu(M,v),"lhs")},j=()=>{yr.delete(r),l(v=>{ou(v,d??H(""),u),k!==void 0&&v[0]&&v[0].partId===void 0&&(v[0].partId=k)})},U=n.rows.map((v,M)=>Zu(e,{key:`${r}-${v.caseId}`,label:cu(v.comparison,T=>ke(T,de(e))),columns:g,changes:v.changes,live:L===v.caseId,forced:J(v.caseId),onForce:()=>R(v.caseId),when:Vb(e,v.comparison,`${r}-${v.caseId}`,(T,F)=>l(O=>{let K=O[0]?.cases.find(se=>se.id===v.caseId)?.when.tests[0];K&&T(K.comparison)},F&&`${v.caseId}-${F}`)),updChanges:(T,F)=>l(O=>{let K=O[0]?.cases.find(se=>se.id===v.caseId);K&&T(K.then)},F&&`${v.caseId}-${F}`),acts:h`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>l(T=>su(T,v.caseId))}>${G("delete")}</button>`})),ne=n.otherwise===void 0?f:Zu(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:L==="otherwise",forced:J("otherwise"),onForce:()=>R("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(v,M)=>l(T=>{let F=T[0]?.otherwise;F&&v(F)},M),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(v=>xs(v,!1))}>${G("close")}</button>`}),_=vr.get(r),b=Pb.filter(v=>C.includes(v)&&!g.includes(v));return h`
    <div class="states">
      ${re(e,d??H(""),A,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:Ep(s,k,de(e),I)}
          ...
          <tr>
            ...
            ${g.map(v=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${mt[v]} column`}
                @click=${M=>{vr.set(r,v),Me(M.target)}}>${G("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${_===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${mt[_]} column? Its ${Ju(n,_)} value${Ju(n,_)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${v=>{vr.delete(r),xr.get(r)?.delete(_),Me(v.target),l(M=>du(M,_))}}>Remove</button>
      ...
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${b.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${v=>{let M=v.target,T=M.value;if(M.value="",!T)return;let F=xr.get(r)??new Set;F.add(T),xr.set(r,F),Me(M)}}>
    ...
    </div>`}function zb(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var Pb=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Ju(e,n){let t=0;for(let i of e.rows)lr(i.changes,n)&&(t+=1);return e.otherwise&&lr(e.otherwise,n)&&(t+=1),t}function Nb(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Zu(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{Nb(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${Db(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Db(e,n,t,i,a){let r=lr(t,n),o=_r(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${mt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(In(tu[n]))}),lp(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Le[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=mt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Ob(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${dp}>
      ...
      ${Zi.has(o)?h`${n==="visibility"?Q("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Ap(e,r,s,a)}
    ...
    </div>`}function Ob(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Ua(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${ui.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??H(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Fp.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ee(a):ke(i,de(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${ke(i,de(e))}</span>`}function Ee(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Vb(e,n,t,i){let a=Hn(n.kind),r=gs(n.kind),o=(s,l,d,c)=>Gb(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${be(s=>i(l=>{let d=Wo(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${fs.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Bb(s)}</option>`)}
    </select>
  ...
  </span>`}function Bb(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return si[e]}}function Gb(e,n,t,i,a,r,o){let s=_r(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${sp(e,s,o,n,t,l)}
  </span>`}var na=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Io,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function zp(e){return na.find(n=>n.kind===e)??na[0]}var Ip="#FF9F0A",Nr="#8E8E93",Ub=["#FF453A","#FFD60A","#34C759"],Pp=["#0A84FF","#34C759","#FF9F0A"];function Kb(e){return e?.attributes?.device_class==="battery"?Ub:Pp}var Wb={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function jb(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Wb[Xs(e)]??{off:"circle",on:"circle.fill"}}function qb(e){switch(Xs(e)){case"lock":return{kind:"equals",value:H("locked")};case"cover":case"valve":return{kind:"equals",value:H("open")};case"media_player":return{kind:"equals",value:H("playing")};default:return{kind:"isOn"}}}function Xs(e){return e.domain||e.entityId.split(".")[0]||""}function rn(e){return{...e,domain:Xs(e)}}function Yb(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function pi(e){return Math.round(e*1e4)/1e4}function Gn(e,n,t){return Math.min(t,Math.max(n,e))}function Js(e,n,t){let i=He[e],a=Gn(pi(n/i.width),0,1),r=Gn(pi(t/i.height),0,1);return{x:pi((1-a)/2),y:pi((1-r)/2),width:a,height:r,rotationDegrees:0}}function Xb(e){let n=He[e],t=Gn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:Js(e,t*1.3,t*1.3),size:t}}function Jb(e){let n=He[e],t=Gn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:Js(e,n.width*.88,t*1.7),size:t}}function Zb(e){let n=He[e],t=Math.min(n.width,n.height)*.9;return{frame:Js(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Np(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Qb(e){let n=He[e],t=Gn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:pi(t/n.height),rotationDegrees:0}}}function ex(e){let n=He[e],t=Gn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:pi(Gn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function tx(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function nx(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function nn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,nx(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Et());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function an(e){return we(e)}function Zs(e,n){let t={kind:{kind:"entityState",...rn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Lp(e){let n=In("setIcon");return n.value=H(e),n}function Bn(e){let n=In("setColor");return n.value=H(e),n}function ix(e,n){let t=zi(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...rn(e)}},a.comparison=qb(e);let r=n.on!==n.off;return i.then=r?[Lp(n.on),Bn(Ip)]:[Bn(Ip)],t.otherwise=r?[Lp(n.off),Bn(Nr)]:[Bn(Nr)],t}function ax(e){let n=zi(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...rn(e)}},i.comparison={kind:"isUnavailable"};let a=In("setOpacity");return a.number=.35,t.then=[a],n}function _p(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function rx(e,n,t=Pp){let i=n.max-n.min,a=_p(n.min+i/3),r=_p(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:H(a)},changes:[Bn(t[0])]},{comparison:{kind:"between",value:H(a),upper:H(r)},changes:[Bn(t[1])]},{comparison:{kind:"greaterThan",value:H(r)},changes:[Bn(t[2])]}];return iu(Zs(e),o)}function ox(e,n,t){let i=an("icon"),a=jb(n);return i.payload.symbol=H(a.off),i.payload.colorSlot.baseColorHex=Nr,i.payload.rules=[ix(n,a)],nn(e,i,t.family,Xb),e.elements.push(i),Da(e,i.payload.id,{type:"toggleEntity",...rn(n)}),i.payload.id}function sx(e,n,t){let i=an("text");return i.payload.value=Zs(n,t.state),i.payload.rules=[ax(n)],nn(e,i,t.family,Jb),e.elements.push(i),i.payload.id}function lx(e,n,t){let i=an("gauge");i.payload.value=Zs(n);let a=Yb(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[rx(n,a,Kb(t.state))],nn(e,i,t.family,Zb),e.elements.push(i),i.payload.id}function dx(e,n,t){let i=an("chart");return i.payload.value={kind:{kind:"entityState",...rn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",nn(e,i,t.family,Np),e.elements.push(i),i.payload.id}function cx(e,n,t){let i=an("chart");return i.payload.value={kind:{kind:"entityState",...rn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",nn(e,i,t.family,Np),e.elements.push(i),i.payload.id}function ux(e,n,t){let i=rn(n),a=an("text");a.payload.value=H(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=Nr,nn(e,a,t.family,ex),e.elements.push(a);let r=t.state?.attributes?.device_class,o=an("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=vo(i.domain,typeof r=="string"?r:void 0),nn(e,o,t.family,Qb),e.elements.push(o),o.payload.id}function px(e,n,t){let i=an("image");return i.payload.entity=rn(n),nn(e,i,t.family,tx),e.elements.push(i),i.payload.id}function Dp(e,n,t,i){switch(n){case"toggle":return ox(e,t,i);case"status":return sx(e,t,i);case"gauge":return lx(e,t,i);case"chart":return dx(e,t,i);case"history":return cx(e,t,i);case"doorHistory":return ux(e,t,i);case"camera":return px(e,t,i)}}var hx=/^[a-z0-9_]+\.shared_(\d+)$/;function Op(e){return hx.test(e)}function mx(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Bp(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function Gp(e,n){let t=new Map;for(let i of Go(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=Bp(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${mx(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function fx(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);Vo(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),Bo(t,r=>Po(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function Up(e){let n=!1;return Ga(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function gx(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function Kp(e,n,t=[]){let i=n==="share"?fx(e,t):e,a=Qn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${gx(a)}
`}function Wp(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var yx="There is nothing to read here. Paste a complication first.",bx="This is not valid JSON. Check for a missing brace or a stray comma.",xx="This is valid JSON but not a complication. A complication starts with { and ends with }.",vx="This does not look like a complication.",Vp="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",wx="00000000-0000-4000-8000-000000000000";function kx(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function jp(e,n){let t=e.trim();if(t==="")return{ok:!1,error:yx};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:bx}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:xx};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${Vp}`};let o={...a,id:wx,slotIndex:0},s;try{s=Zn(o)}catch(d){let c=d instanceof Qe||d instanceof Error?d.message:String(d);return{ok:!1,error:`${vx}

${kx(c)}`}}let l=Pa(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${Vp}`}}return{ok:!0,config:s,raw:i}}function Qs(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=Go(e,(o,s)=>Op(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Op(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Bp(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function qp(e,n){let t=structuredClone(e);Vo(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Bo(t,a=>Po(a,i)),t}function Yp(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function $x(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Xp(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=er(e);return i.length===0?t:`${t}, ${$x(i)}`}function el(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var Sx=3e4,Tx=500,Ex=3e4,Jp="preset-entity";function Zp(e){return`import-entity-${e}`}var Mx={entityId:"",displayName:"",domain:""},Rx=new Map,Fx={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function tl(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Ax(e){return e.kind==="family"?"look":"content"}function nl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Qp(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function Hx(e){let n=w`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?w`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?w`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?w`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:w`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var eh=300,th=360,rl=44,ol=22,lh=[1,1.7,2.6],Ix=["S","M","L"],nh=["Small","Medium","Large"];function Lx(){return lh.map((e,n)=>{let t=Math.round(rl*e),i=Math.round(ol*e),a=`.layers-card.s${n}`;return`
...
`)}var ih="wrist-assistant-panel.layers.v1",Ft=34,Un=200,_x=720,Dr=320,zx=80,Px=56,ah="wrist-assistant-panel.columns.v3",il=e=>Math.max(Un,Math.min(_x,Math.round(e))),rh=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Nx(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Dx=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,ia=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",on=ia==="Cmd"?"\u2318":"Ctrl+",al=ia==="Cmd"?"\u21E7":"Shift+";function oh(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-zx;if(i>=Un*2+Dr){let r=i-Dr,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Un,Math.floor(o*l)),s=Math.max(Un,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Un,o-d):s=Math.max(Un,s-d))}return{columns:3,left:o,right:s}}let a=e-Px;return a>=Un+Dr?{columns:2,left:Math.min(n,a-Dr),right:t}:{columns:1,left:n,right:t}}var P=class P extends Lt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=eh;this.colRight=th;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=ri.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Xc(()=>this.requestUpdate());this.imageSizes=Jc(()=>this.requestUpdate());this.symbols=new ar(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new sr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Qs(a,this.hass.states);r.some(s=>Gs(Zp(s.entityId)))||el({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Gs(Jp)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Rx}static{this.styles=Gr`
    :host {
      ...
      --wa-text: ${Te(Ue.text)};
      --wa-icon: ${Te(Ue.icon)};
      --wa-gauge: ${Te(Ue.gauge)};
      --wa-shape: ${Te(Ue.shape)};
      --wa-image: ${Te(Ue.image)};
      --wa-tap: ${Te(Ue.tap)};
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Fr,this.scrubStart),this.addEventListener(Ar,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Ex)}loadColumnWidths(){try{let t=window.localStorage.getItem(ah);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=il(i.left)),typeof i.right=="number"&&(this.colRight=il(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(ah,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(ih);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(ih,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>xp(s,o,i))}>Copy the ${te(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?zo(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication");if(this.showTaps){let A=this.focusTapId();if(A!==void 0&&o===A&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,A,r??void 0);return}let j=this.hitLayerId(i);j?this.inspect={kind:"layer",id:j}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let l=rh(i);if(!l&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let d=zo(this.draft.config,o),c=this.draft.config.elements.find(A=>A.payload.id===d);if(!d||!c)return;if(l){i.preventDefault(),this.togglePick(d);return}let u,p=this.inspect.kind==="layer"?this.inspect.id:void 0;if(p!==void 0&&p!==d&&!r){let A=this.draft.config.elements.find(U=>U.payload.id===p);A!==void 0&&A.kind!=="chartDots"&&A.kind!=="chartGrid"&&A.payload.chartAnchor?.place!=="through"&&at(this.draft.config,p)?.locked!==!0&&Nx(s,p,i)&&(u=d,d=p,c=A)}let m=at(this.draft.config,d),y=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||y)&&!r){let A=y||this.inspect.kind==="layer"&&at(this.draft.config,this.inspect.id)?.id===m.id;this.beginGroupGesture(t,i,s,m,A?d:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==d)&&(this.inspect={kind:"layer",id:d},r)||c.payload.chartAnchor?.place==="through")return;i.preventDefault();let g=Re(this.draft.config,t,c).frame,x=this.gestureCanvas(t),k=c.payload.chartAnchor,$=k!==void 0&&!ct(k.at)&&k.place!=="through",C=k!==void 0&&ct(k.at)&&k.place==="through",S=ue[t],I={dx:k?.dx??0,dy:k?.dy??0},L=k!==void 0&&!r?Vi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(A=>A.id===d)?.frame:void 0,N=L??g,J=A=>Math.round(A*10)/10;this.cancelGesture?.();let R=!1;this.cancelGesture=cr(s,x,i,{elementId:d,frame:N,handle:r??void 0},{onFrame:(A,j,U)=>{if(U||(R=!0),U&&!R&&u!==void 0){this.inspect={kind:"layer",id:u},this.cancelGesture=void 0;return}this.mutate(ne=>{if(k===void 0){Ce(ne,t,A,{frame:j});return}let _=L?{width:g.width,height:g.height}:{width:j.width,height:j.height};Ce(ne,t,A,{frame:{...j,..._,x:$?j.x:g.x,y:g.y}});let b=ne.elements.find(T=>T.payload.id===A)?.payload.chartAnchor;if(b===void 0)return;let v=I.dx,M=C?I.dy:J(I.dy+(j.y-N.y)*S.height);v?b.dx=v:delete b.dx,M?b.dy=M:delete b.dy},`drag-${A}-${t}`),U&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=Tt(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map($=>[$.payload.id,Re(s,t,$).frame])),c=[...d.values()],u=Math.min(...c.map($=>$.x)),p=Math.min(...c.map($=>$.y)),m=Math.max(...c.map($=>$.x+$.width)),y=Math.max(...c.map($=>$.y+$.height)),g={x:u,y:p,width:m-u,height:y-p,rotationDegrees:0},x=$=>Math.round($*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=cr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:($,C,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let I=C.x-g.x,L=C.y-g.y;this.mutate(N=>{for(let[J,R]of d)Ce(N,t,J,{frame:{...R,x:x(R.x+I),y:x(R.y+L)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?fu:1,s=t*o,l=i*o,d=this.canvasFamily,c=ue[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(Tt(r,k).map($=>$.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=at(r,u);if(m?.locked)return this.nudgeMany(Tt(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let y=Re(r,d,p).frame,g=p.payload.chartAnchor;if(g!==void 0){let k=!ct(g.at);return l===0&&!(k&&s!==0)||this.mutate($=>{k&&s!==0&&Ce($,d,u,{frame:dr(y,s,0,c)});let C=$.elements.find(I=>I.payload.id===u)?.payload.chartAnchor;if(C===void 0||l===0)return;let S=Math.round(((C.dy??0)+l)*10)/10;S?C.dy=S:delete C.dy},`nudge-${u}-${d}`),!0}let x=dr(y,s,l,c);return(x.x!==y.x||x.y!==y.y)&&this.mutate(k=>Ce(k,d,u,{frame:x}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let I=l.elements.find(L=>L.payload.id===S);I&&c.set(S,Re(l,i,I).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),y=Math.max(...u.map(S=>S.x+S.width)),g=Math.max(...u.map(S=>S.y+S.height)),x={x:p,y:m,width:y-p,height:g-m,rotationDegrees:0},k=dr(x,o,s,a),$=k.x-x.x,C=k.y-x.y;return($!==0||C!==0)&&this.mutate(S=>{for(let[I,L]of c)Ce(S,i,I,{frame:{...L,x:d(L.x+$),y:d(L.y+C)}})},r),!0}gestureCanvas(t){let i=Ja(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=ds(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Oe(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ge(s,l),c=Re(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=cr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(y=>{d?Ud(y,u,t,p):Ce(y,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:oh(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${sh(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Qp()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?h`<span class="hor" aria-hidden="true">or</span>${Qp()}`:f}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${jc(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=Wp(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Qs(i,this.hass.states):[],r=el({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?h`<div class="hint err">A complication on this watch already has that name.</div>`:h`<div class="hint">${Xp(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${Up(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${gt({hass:this.hass},t.label,i??Mx,a=>this.setImportEntity(t.entityId,a),Zp(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,Lr(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:jp(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=Yp(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${At(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=qp(t.config,this.importMap);i.id=X(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=gn(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${sh(a)}</option>`)}
              </select>
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${us.map(s=>h`<button class="add" style=${`--k:${Ue[s]}`} ?disabled=${i} title=${`Add a blank ${Jt[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${mu(s)}</span>`:f}<span class="add-name">${r?G(s):h`<span class="k"></span>`}<span>${Jt[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Se(R,d)}</b>
          <small><span class="kind">${Jt[R.kind]}</span> · ${Gx(R,c,this.historySeries,_.size)}</small>
          ${S?h`<span class="facts">${Vx(this.host(),a,R,_).map(O=>h`<span class="fact"><b>${O.label}</b> ${O.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${_.isHidden?"Show":"Hide"} (${al}${on}H)`} aria-label=${_.isHidden?"Show this layer":"Hide this layer"} @click=${O=>{O.stopPropagation(),this.mutate(K=>Ce(K,a,U,{isHidden:!_.isHidden}))}}>${G(_.isHidden?"hide":"show")}</button>
      ...
      <h2 class="panel-title tools" style=${`--c:${Z.place}`}><span class="swatch">${G("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${Ix.map((R,A)=>h`
              <button class=${this.thumbStep===A?"on":""} title=${`${nh[A]} row pictures`}
                aria-label=${`${nh[A]} row pictures`} aria-pressed=${this.thumbStep===A?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?zp(this.presetKind):void 0,i=this.presetEntity;return h`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:h`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${gt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Jp,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Dp(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=Vi(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
      ...
      ${Qa(r,g)}
    </div>`}renderUnder(t,i){let a=de(this.host()),r=this.inspect,o=r.kind==="layer"?t.elements.find(u=>u.payload.id===r.id):void 0,s;if(this.showTaps)s=h`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${Ct(t.tapAction)}</b>.`;else if(this.picking)s="Point at a layer and click it. Escape stops.";else if(i==="inline")s="One line of text. Edit it on the right.";else if(r.kind==="group"){let u=t.groups?.find(m=>m.id===r.id),p=u?Tt(t,u.id).length:0;s=u?h`editing group <b>${u.name}</b>. Drag to move all ${p} layers.${u.locked?"":" Click one layer to move it alone."}`:""}else if(o){let u=at(t,o.payload.id);s=u?.locked?h`editing <b>${Se(o,a)}</b> in <b>${u.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:h`editing <b>${Se(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else s="click a layer to edit it";if(i==="inline")return h`<div class="under"><b>Inline</b><span class="dot">·</span><span class="tail">${s}</span></div>`;let l=this.currentCase().slots[i],d=Ja(l,i),c=Math.round(d.scale*100);return h`<div class="under">
      <b>${te(i)}</b>
      <span class="size">${l.width} × ${l.height} pt${c!==100?` \xB7 ${c}%`:""}</span>
      <span class="dot">·</span>
      <span class="tail">${s}</span>
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?ii((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=bp();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${G("content")}</span>Shared values
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=tc(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${Z.states}`}>
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${ve(a,"complication","Complication",fp(a),{color:Z.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=Cp(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=Sp(a,c)}else s=Tp(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([Ax(r)]):new Set(Os)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=de(r),s=new ht(this.buildContext(),this.draft?.config),l=vp(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(y=>{for(let g of i)Ce(y,a,g.payload.id,{isHidden:m})}),p=m=>this.mutate(y=>{for(let g of i){let x=y.elements.find(k=>k.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&x.kind!=="chartTimes"&&x.kind!=="chartDots"&&x.kind!=="chartGrid"&&x.kind!=="imageTime"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ...
      ${ve(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:Z.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=Zc({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
