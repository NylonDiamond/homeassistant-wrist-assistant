var Al=Object.defineProperty;var Ll=Object.getOwnPropertyDescriptor;var L=(e,t,n,i)=>{for(var a=i>1?void 0:i?Ll(t,n):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(t,n,a):o(a))||a);return i&&a&&Al(t,n,a),a};var Rn=globalThis,Mn=Rn.ShadowRoot&&(Rn.ShadyCSS===void 0||Rn.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ti=Symbol(),ir=new WeakMap,tn=class{constructor(t,n,i){if(this._$cssResult$=!0,i!==Ti)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=n}get styleSheet(){let t=this.o,n=this.t;if(Mn&&t===void 0){let i=n!==void 0&&n.length===1;i&&(t=ir.get(n)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&ir.set(n,t))}return t}toString(){return this.cssText}},me=e=>new tn(typeof e=="string"?e:e+"",void 0,Ti),Fi=(e,...t)=>{let n=e.length===1?e[0]:t.reduce((i,a,r)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[r+1],e[0]);return new tn(n,e,Ti)},ar=(e,t)=>{if(Mn)e.adoptedStyleSheets=t.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet);else for(let n of t){let i=document.createElement("style"),a=Rn.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=n.cssText,e.appendChild(i)}},Ri=Mn?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let n="";for(let i of t.cssRules)n+=i.cssText;return me(n)})(e):e;var{is:_l,defineProperty:zl,getOwnPropertyDescriptor:Nl,getOwnPropertyNames:Pl,getOwnPropertySymbols:Ol,getPrototypeOf:Dl}=Object,In=globalThis,rr=In.trustedTypes,Vl=rr?rr.emptyScript:"",Bl=In.reactiveElementPolyfillSupport,nn=(e,t)=>e,an={toAttribute(e,t){switch(t){case Boolean:e=e?Vl:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},Hn=(e,t)=>!_l(e,t),or={attribute:!0,type:String,converter:an,reflect:!1,useDefault:!1,hasChanged:Hn};Symbol.metadata??=Symbol("metadata"),In.litPropertyMetadata??=new WeakMap;var Ve=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,n=or){if(n.state&&(n.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((n=Object.create(n)).wrapped=!0),this.elementProperties.set(t,n),!n.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(t,i,n);a!==void 0&&zl(this.prototype,t,a)}}static getPropertyDescriptor(t,n,i){let{get:a,set:r}=Nl(this.prototype,t)??{get(){return this[n]},set(o){this[n]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(t,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??or}static _$Ei(){if(this.hasOwnProperty(nn("elementProperties")))return;let t=Dl(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(nn("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(nn("properties"))){let n=this.properties,i=[...Pl(n),...Ol(n)];for(let a of i)this.createProperty(a,n[a])}let t=this[Symbol.metadata];if(t!==null){let n=litPropertyMetadata.get(t);if(n!==void 0)for(let[i,a]of n)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[n,i]of this.elementProperties){let a=this._$Eu(n,i);a!==void 0&&this._$Eh.set(a,n)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let n=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let a of i)n.unshift(Ri(a))}else t!==void 0&&n.push(Ri(t));return n}static _$Eu(t,n){let i=n.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,n=this.constructor.elementProperties;for(let i of n.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ar(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,n,i){this._$AK(t,i)}_$ET(t,n){let i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:an).toAttribute(n,i.type);this._$Em=t,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(t,n){let i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){let r=i.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:an;this._$Em=a;let s=o.fromAttribute(n,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(t,n,i,a=!1,r){if(t!==void 0){let o=this.constructor;if(a===!1&&(r=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??Hn)(r,n)||i.useDefault&&i.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,n,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,n,{useDefault:i,reflect:a,wrapped:r},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??n??this[t]),r!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(n=void 0),this._$AL.set(t,n)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(n){Promise.reject(n)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,r]of i){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let t=!1,n=this._$AL;try{t=this.shouldUpdate(n),t?(this.willUpdate(n),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(n)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(n)}willUpdate(t){}_$AE(t){this._$EO?.forEach(n=>n.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(n=>this._$ET(n,this[n])),this._$EM()}updated(t){}firstUpdated(t){}};Ve.elementStyles=[],Ve.shadowRootOptions={mode:"open"},Ve[nn("elementProperties")]=new Map,Ve[nn("finalized")]=new Map,Bl?.({ReactiveElement:Ve}),(In.reactiveElementVersions??=[]).push("2.1.2");var zi=globalThis,sr=e=>e,An=zi.trustedTypes,lr=An?An.createPolicy("lit-html",{createHTML:e=>e}):void 0,mr="$lit$",it=`lit$${Math.random().toFixed(9).slice(2)}$`,fr="?"+it,Gl=`<${fr}>`,xt=document,on=()=>xt.createComment(""),sn=e=>e===null||typeof e!="object"&&typeof e!="function",Ni=Array.isArray,Ul=e=>Ni(e)||typeof e?.[Symbol.iterator]=="function",Mi=`[ 	
\f\r]`,rn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,dr=/-->/g,cr=/>/g,bt=RegExp(`>|${Mi}(?:([^\\s"'>=/]+)(${Mi}*=${Mi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ur=/'/g,pr=/"/g,gr=/^(?:script|style|textarea|title)$/i,Pi=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),p=Pi(1),b=Pi(2),Dp=Pi(3),wt=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),hr=new WeakMap,vt=xt.createTreeWalker(xt,129);function yr(e,t){if(!Ni(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return lr!==void 0?lr.createHTML(t):t}var Kl=(e,t)=>{let n=e.length-1,i=[],a,r=t===2?"<svg>":t===3?"<math>":"",o=rn;for(let s=0;s<n;s++){let l=e[s],d,c,u=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===rn?c[1]==="!--"?o=dr:c[1]!==void 0?o=cr:c[2]!==void 0?(gr.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=bt):c[3]!==void 0&&(o=bt):o===bt?c[0]===">"?(o=a??rn,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?bt:c[3]==='"'?pr:ur):o===pr||o===ur?o=bt:o===dr||o===cr?o=rn:(o=bt,a=void 0);let f=o===bt&&e[s+1].startsWith("/>")?" ":"";r+=o===rn?l+Gl:u>=0?(i.push(d),l.slice(0,u)+mr+l.slice(u)+it+f):l+it+(u===-2?s:f)}return[yr(e,r+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},ln=class e{constructor({strings:t,_$litType$:n},i){let a;this.parts=[];let r=0,o=0,s=t.length-1,l=this.parts,[d,c]=Kl(t,n);if(this.el=e.createElement(d,i),vt.currentNode=this.el.content,n===2||n===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=vt.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(mr)){let h=c[o++],f=a.getAttribute(u).split(it),g=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:g[2],strings:f,ctor:g[1]==="."?Hi:g[1]==="?"?Ai:g[1]==="@"?Li:Nt}),a.removeAttribute(u)}else u.startsWith(it)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(gr.test(a.tagName)){let u=a.textContent.split(it),h=u.length-1;if(h>0){a.textContent=An?An.emptyScript:"";for(let f=0;f<h;f++)a.append(u[f],on()),vt.nextNode(),l.push({type:2,index:++r});a.append(u[h],on())}}}else if(a.nodeType===8)if(a.data===fr)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(it,u+1))!==-1;)l.push({type:7,index:r}),u+=it.length-1}r++}}static createElement(t,n){let i=xt.createElement("template");return i.innerHTML=t,i}};function zt(e,t,n=e,i){if(t===wt)return t;let a=i!==void 0?n._$Co?.[i]:n._$Cl,r=sn(t)?void 0:t._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(e),a._$AT(e,n,i)),i!==void 0?(n._$Co??=[])[i]=a:n._$Cl=a),a!==void 0&&(t=zt(e,a._$AS(e,t.values),a,i)),t}var Ii=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:i}=this._$AD,a=(t?.creationScope??xt).importNode(n,!0);vt.currentNode=a;let r=vt.nextNode(),o=0,s=0,l=i[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new dn(r,r.nextSibling,this,t):l.type===1?d=new l.ctor(r,l.name,l.strings,this,t):l.type===6&&(d=new _i(r,this,t)),this._$AV.push(d),l=i[++s]}o!==l?.index&&(r=vt.nextNode(),o++)}return vt.currentNode=xt,a}p(t){let n=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,n),n+=i.strings.length-2):i._$AI(t[n])),n++}},dn=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,i,a){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=zt(this,t,n),sn(t)?t===m||t==null||t===""?(this._$AH!==m&&this._$AR(),this._$AH=m):t!==this._$AH&&t!==wt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ul(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==m&&sn(this._$AH)?this._$AA.nextSibling.data=t:this.T(xt.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=ln.createElement(yr(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(n);else{let r=new Ii(a,this),o=r.u(this.options);r.p(n),this.T(o),this._$AH=r}}_$AC(t){let n=hr.get(t.strings);return n===void 0&&hr.set(t.strings,n=new ln(t)),n}k(t){Ni(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,i,a=0;for(let r of t)a===n.length?n.push(i=new e(this.O(on()),this.O(on()),this,this.options)):i=n[a],i._$AI(r),a++;a<n.length&&(this._$AR(i&&i._$AB.nextSibling,a),n.length=a)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let i=sr(t).nextSibling;sr(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},Nt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,i,a,r){this.type=1,this._$AH=m,this._$AN=void 0,this.element=t,this.name=n,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=m}_$AI(t,n=this,i,a){let r=this.strings,o=!1;if(r===void 0)t=zt(this,t,n,0),o=!sn(t)||t!==this._$AH&&t!==wt,o&&(this._$AH=t);else{let s=t,l,d;for(t=r[0],l=0;l<r.length-1;l++)d=zt(this,s[i+l],n,l),d===wt&&(d=this._$AH[l]),o||=!sn(d)||d!==this._$AH[l],d===m?t=m:t!==m&&(t+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(t)}j(t){t===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Hi=class extends Nt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===m?void 0:t}},Ai=class extends Nt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==m)}},Li=class extends Nt{constructor(t,n,i,a,r){super(t,n,i,a,r),this.type=5}_$AI(t,n=this){if((t=zt(this,t,n,0)??m)===wt)return;let i=this._$AH,a=t===m&&i!==m||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==m&&(i===m||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},_i=class{constructor(t,n,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){zt(this,t)}};var Wl=zi.litHtmlPolyfillSupport;Wl?.(ln,dn),(zi.litHtmlVersions??=[]).push("3.3.3");var br=(e,t,n)=>{let i=n?.renderBefore??t,a=i._$litPart$;if(a===void 0){let r=n?.renderBefore??null;i._$litPart$=a=new dn(t.insertBefore(on(),r),r,void 0,n??{})}return a._$AI(e),a};var Oi=globalThis,at=class extends Ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let n=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=br(n,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return wt}};at._$litElement$=!0,at.finalized=!0,Oi.litElementHydrateSupport?.({LitElement:at});var jl=Oi.litElementPolyfillSupport;jl?.({LitElement:at});(Oi.litElementVersions??=[]).push("4.2.2");var ql={attribute:!0,type:String,converter:an,reflect:!1,hasChanged:Hn},Yl=(e=ql,t,n)=>{let{kind:i,metadata:a}=n,r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(n.name,e),i==="accessor"){let{name:o}=n;return{set(s){let l=t.get.call(this);t.set.call(this,s),this.requestUpdate(o,l,e,!0,s)},init(s){return s!==void 0&&this.C(o,void 0,e,s),s}}}if(i==="setter"){let{name:o}=n;return function(s){let l=this[o];t.call(this,s),this.requestUpdate(o,l,e,!0,s)}}throw Error("Unsupported decorator location: "+i)};function Pt(e){return(t,n)=>typeof n=="object"?Yl(e,t,n):((i,a,r)=>{let o=a.hasOwnProperty(r);return a.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(a,r):void 0})(e,t,n)}function _(e){return Pt({...e,state:!0,attribute:!1})}var Be="wrist_assistant/complications";async function vr(e){return e.connection.sendMessagePromise({type:`${Be}/owners`})}async function xr(e,t){return e.connection.sendMessagePromise({type:`${Be}/list`,owner_watch_id:t})}async function wr(e,t){return e.connection.sendMessagePromise({type:`${Be}/nudge`,owner_watch_id:t})}async function kr(e,t,n,i){return e.connection.sendMessagePromise({type:`${Be}/save`,owner_watch_id:t,document:n,base_revision:i})}async function $r(e,t,n,i){return e.connection.sendMessagePromise({type:`${Be}/delete`,owner_watch_id:t,complication_id:n,base_revision:i})}async function Cr(e,t,n){return e.connection.sendMessagePromise({type:`${Be}/move_owner`,source_owner_watch_id:t,target_owner_watch_id:n})}function Sr(e,t,n){let i={type:`${Be}/subscribe`};return t&&(i.owner_watch_id=t),e.connection.subscribeMessage(n,i)}async function Er(e,t){return Object.keys(t).length===0?{}:(await e.connection.sendMessagePromise({type:`${Be}/render_values`,templates:t})).results}async function Tr(e,t){return Object.keys(t).length===0?{}:(await e.connection.sendMessagePromise({type:`${Be}/history_series`,requests:t})).results}var ee=["rectangular","circular","corner"],ge={rectangular:{width:181,height:65.5},circular:{width:51,height:51},corner:{width:34,height:34}},Jl=["rectangular","circular","corner","inline"];var Bi=64;function Pr(e,t){let n=new Set(e);for(let i of t)n.add(i.slot);for(let i=0;i<Bi;i++)if(!n.has(i))return i;return-1}function hn(e){return ee.some(n=>!e.supportedFamilies.includes(n))||e.supportedFamilies.includes("inline")||e.inline!==void 0?6:e.slotIndex>7?5:4}var Ot=[["latest","Newest reading"],["highest","Highest reading"],["lowest","Lowest reading"],["average","Average reading"],["top","Top of the scale"],["bottom","Bottom of the scale"]],Ge={x:.25,y:.25,width:.5,height:.5,rotationDegrees:0},Ee={setColor:"color",setOpacity:"opacity",setText:"text",setIcon:"icon",setFontSize:"fontSize",setFontWeight:"fontWeight",setRotation:"rotation",hide:"visibility",show:"visibility",setGaugeValue:"gaugeValue",setGaugeMin:"gaugeMin",setGaugeMax:"gaugeMax",setBorderColor:"borderColor",setBorderWidth:"borderWidth",setBackgroundColor:"backgroundColor"},Dt="#FFFFFF",zn=24,mn="#FF6B35",fn="#32D74B",Gi="#32D74B",lt="#FF453A",Vt="#FF453A",Bt="#FFFFFF99";function gn(e){return[...e.bands].sort((t,n)=>t.upTo-n.upTo)}function Or(e){return e.coloring==="bands"&&e.bands.length>0}function Ui(e,t,n){for(let i of t)if(e<=i.upTo)return i.colorHex;return n}function Dr(e,t){let n=Math.abs(t),i=n>=10?0:n>=1?1:2;return e.toFixed(i)}var Nn=[{minutes:60,label:"Last hour"},{minutes:180,label:"Last 3 hours"},{minutes:360,label:"Last 6 hours"},{minutes:720,label:"Last 12 hours"},{minutes:1440,label:"Last 24 hours"},{minutes:4320,label:"Last 3 days"},{minutes:10080,label:"Last 7 days"}],Pn=360,Ki=10080,Wi=2,On=120,ji=0;function Vr(e){let t=Math.round(e.historyPoints);return Number.isFinite(t)?t<1?ji:Math.max(Wi,Math.min(On,t)):24}function Br(e){if(!(e.historyMinutes<=0))return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function kt(e){let t=Br(e);if(t!==void 0)return`${t}|${Math.round(e.historyMinutes)}|${Vr(e)}`}function Gr(e){return qi(e).map(t=>t.key).sort().join(";")}function qi(e){let t=new Map,n=i=>{t.has(i.key)||t.set(i.key,i)};for(let i of e.elements)if(i.kind==="chart"){let a=kt(i.payload),r=Br(i.payload);if(a===void 0||r===void 0)continue;n({key:a,entityId:r,minutes:Math.round(i.payload.historyMinutes),points:Vr(i.payload),mode:"numeric"})}else if(i.kind==="timeline"){let a=$t(i.payload),r=Kr(i.payload);if(a===void 0||r===void 0)continue;n({key:a,entityId:r,minutes:Ke(i.payload),points:dt,mode:"states"})}return[...t.values()]}var Ue="#8E8E93",Yi=1,Dn=60,Vn=4,dt=120;function Ur(e,t,n){let i=e.trim().toLowerCase();for(let a of t)if(a.match.trim().toLowerCase()===i)return a.colorHex;return n}function Ke(e){let t=Math.round(e.historyMinutes);return Number.isFinite(t)?Math.max(1,Math.min(Ki,t)):Dn}function Kr(e){return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function $t(e){let t=Kr(e);if(t!==void 0)return`${t}|${Ke(e)}|${dt}|states`}var Xl="#FF9F0A",Di="#3A3A3C",Fr="#FF453A",Zl="#32D74B",Ql="#48484A",ed=["door","garage_door","window","opening"];function Ji(e,t){let n=(t??"").trim().toLowerCase(),i={id:Y(),match:"unavailable",colorHex:Ql},a=(o,s,l,d)=>[{id:Y(),match:o,colorHex:s},{id:Y(),match:l,colorHex:d},i];if(e==="cover")return a("open",Fr,"closed",Di);let r=e==="binary_sensor"&&ed.includes(n);switch(e){case"binary_sensor":case"switch":case"light":case"input_boolean":return a("on",r?Fr:Xl,"off",Di);case"person":case"device_tracker":return a("home",Zl,"not_home",Di);default:return[i]}}var Gt=6,Ut=9,td=["topLeading","topTrailing","bottomLeading","bottomTrailing"];function We(e){return Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY)}function Xi(e,t){let n=t<=.5,i=e<=.5;return n?i?"topLeading":"topTrailing":i?"bottomLeading":"bottomTrailing"}var Zi={top:0,left:0,bottom:0,right:0};function Bn(e){return e===void 0||e.top===0&&e.left===0&&e.bottom===0&&e.right===0}var nd=["toggleEntity","runScene","runScript","addTodo","runHTTPAction"];function Wr(e){return nd.includes(e)}function jr(e){let t=(e??"").trim();if(t==="")return!0;try{let n=JSON.parse(t);return typeof n=="object"&&n!==null&&!Array.isArray(n)}catch{return!1}}var Qi=[["refresh","Refresh"],["none","Nothing"],["openApp","Open the app"],["openPage","Open the page"],["openRoomPage","Open the room page"],["timerStartPause","Timer start / pause"],["timerCancel","Timer cancel"],["toggleEntity","Toggle an entity"],["runScene","Run a scene"],["runScript","Run a script"],["addTodo","Add a to-do"],["runHTTPAction","Run an HTTP action"],["callService","Call a service"]];function je(e){let t=Qi.find(([i])=>i===e.type)?.[1]??e.type;if(e.type==="callService"){let i=[e.serviceDomain,e.serviceName].filter(a=>a!=="").join(".");return i===""?t:`${t}: ${i}`}if(!("entityId"in e))return t;let n=e.displayName||e.entityId;return n?`${t}: ${n}`:t}function F(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function U(e,t=""){return typeof e=="string"?e:t}function K(e,t){return typeof e=="number"?e:e==="+inf"?1/0:e==="-inf"?-1/0:e==="nan"?NaN:t}function Le(e){return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}function pn(e){return e==null?void 0:K(e,0)}function fe(e){return typeof e=="string"?e:void 0}var _e=class extends Error{};function ot(e){if(typeof e.entityId!="string")throw new _e("entityId is required");let t={entityId:e.entityId,displayName:U(e.displayName),domain:U(e.domain)};return typeof e.iconName=="string"&&(t.iconName=e.iconName),t}function Rr(e){if(!F(e))return;let t={};return e.decimals!==void 0&&e.decimals!==null&&(t.decimals=K(e.decimals,0)),e.multiply!==void 0&&e.multiply!==null&&(t.multiply=K(e.multiply,1)),e.offset!==void 0&&e.offset!==null&&(t.offset=K(e.offset,0)),typeof e.prefix=="string"&&(t.prefix=e.prefix),typeof e.suffix=="string"&&(t.suffix=e.suffix),e.useEntityUnit===!0&&(t.useEntityUnit=!0),e.relativeTime===!0&&(t.relativeTime=!0),e.duration===!0&&(t.duration=!0),(e.textCase==="upper"||e.textCase==="lower"||e.textCase==="capitalized")&&(t.textCase=e.textCase),Ne(t)?void 0:t}function Ne(e){return e?e.decimals===void 0&&e.multiply===void 0&&e.offset===void 0&&!e.prefix&&!e.suffix&&!e.useEntityUnit&&!e.relativeTime&&!e.duration&&e.textCase===void 0:!0}function id(e){let t=U(e.function,"count"),n=F(e.scope)?e.scope:{},i;if(n.kind==="entities")i={kind:"entities",entities:(Array.isArray(n.entities)?n.entities:[]).filter(F).map(ot)};else{let r=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[];i={kind:"filter",domains:r(n.domains),areaIds:r(n.areaIds),labelIds:r(n.labelIds),floorIds:r(n.floorIds)}}let a={function:t,scope:i};if(F(e.stateFilter)){let r=e.stateFilter.kind;r==="isOn"||r==="isOff"?a.stateFilter={kind:r}:(r==="equals"||r==="notEquals")&&(a.stateFilter={kind:r,value:U(e.stateFilter.value)})}return typeof e.attribute=="string"&&(a.attribute=e.attribute),a}function Mr(e){switch(e.kind){case"literal":return{kind:"literal",value:U(e.value)};case"entityState":return{kind:"entityState",...ot(e)};case"entityAttribute":return{kind:"entityAttribute",...ot(e),attribute:U(e.attribute)};case"entityAge":return{kind:"entityAge",...ot(e)};case"aggregate":return{kind:"aggregate",aggregate:id(F(e.aggregate)?e.aggregate:{})};case"time":return{kind:"time",timeField:fe(e.timeField)??"now"};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:U(e.value)};case"named":return{kind:"named",id:U(e.id).toUpperCase()};case"chartStat":return{kind:"chartStat",layer:U(e.layer).toUpperCase(),stat:Ot.some(([t])=>t===e.stat)?e.stat:"latest"};default:throw new _e(`unknown value kind ${String(e.kind)}`)}}function de(e){if(!F(e))throw new _e("value must be an object");if(F(e.kind)){let i={kind:Mr(e.kind)},a=Rr(e.format);return a&&(i.format=a),i}let t={kind:Mr(e)},n=Rr(e.format);return n&&(t.format=n),t}function qr(e){return F(e)?{x:K(e.x,.25),y:K(e.y,.25),width:K(e.width,.5),height:K(e.height,.5),rotationDegrees:K(e.rotationDegrees,0)}:{...Ge}}function ad(e){if(!F(e))return{kind:"isOn"};let t=U(e.kind,"isOn"),n={kind:t};switch(t){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":n.value=F(e.value)?de(e.value):M("");break;case"between":n.value=F(e.value)?de(e.value):M(""),n.upper=F(e.upper)?de(e.upper):M("");break;case"matchesRegex":n.pattern=U(e.pattern);break;case"isOneOf":n.options=Array.isArray(e.options)?e.options.filter(i=>typeof i=="string"):[];break;default:break}return n}function Ir(e){if(!F(e))return{kind:"show"};let t=U(e.kind,"show"),n={kind:t};switch(t){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":n.value=F(e.value)?de(e.value):M("");break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":n.number=K(e.number,0);break;case"setFontWeight":n.weight=fe(e.weight)??"regular";break;default:break}return n}function Yr(e){return Array.isArray(e)?e.filter(F).map(t=>{let n={id:U(t.id).toUpperCase(),cases:(Array.isArray(t.cases)?t.cases:[]).filter(F).map(i=>{let a=F(i.when)?i.when:{};return{id:U(i.id).toUpperCase(),when:{join:a.join==="any"?"any":"all",tests:(Array.isArray(a.tests)?a.tests:[]).filter(F).map(r=>({id:U(r.id).toUpperCase(),value:F(r.value)?de(r.value):M(""),comparison:ad(r.comparison)}))},then:(Array.isArray(i.then)?i.then:[]).map(Ir)}})};return Array.isArray(t.otherwise)&&(n.otherwise=t.otherwise.map(Ir)),n}):[]}function rd(e,t){return{baseColorHex:F(e)?U(e.baseColorHex,t):t}}function Jr(e){return Array.isArray(e)?e.filter(F).map(t=>({id:U(t.id,Y()),upTo:K(t.upTo,0),colorHex:U(t.colorHex,"#FFFFFF")})):[]}function od(e){if(Array.isArray(e.bands))return Jr(e.bands);if(typeof e.bandLowerBound!="number")return[];let t=F(e.colorSlot)?U(e.colorSlot.baseColorHex,"#FFFFFF"):"#FFFFFF";return[{id:Y(),upTo:e.bandLowerBound,colorHex:U(e.bandLowColorHex,Gi)},{id:Y(),upTo:K(e.bandUpperBound,100),colorHex:t}]}function sd(e){return Array.isArray(e)?e.filter(F).map(t=>({id:U(t.id,Y()).toUpperCase(),match:U(t.match,""),colorHex:U(t.colorHex,Ue)})):[]}function rt(e,t){if(typeof e.id!="string")throw new _e("element id is required");return{id:e.id.toUpperCase(),colorSlot:rd(e.colorSlot,t),rules:Yr(e.rules),frame:qr(e.frame),isHidden:e.isHidden===!0}}function ld(e){let t=dd(e),n=e.payload;return typeof n.groupId=="string"&&n.groupId!==""&&(t.payload.groupId=n.groupId.toUpperCase()),t}function dd(e){if(!F(e)||!F(e.payload))throw new _e("element must have a payload");let t=e.payload;switch(e.kind){case"text":{let n={...rt(t,"#FFFFFF"),value:F(t.value)?de(t.value):M(""),fontSize:K(t.fontSize,14),fontWeight:fe(t.fontWeight)??"regular"};return t.countdown===!0&&(n.countdown=!0),{kind:"text",payload:n}}case"icon":return{kind:"icon",payload:{...rt(t,"#FFFFFF"),symbol:F(t.symbol)?de(t.symbol):M("lightbulb"),size:K(t.size,14)}};case"gauge":{let n={...rt(t,"#FFFFFF"),value:F(t.value)?de(t.value):M("50"),minValue:K(t.minValue,0),maxValue:K(t.maxValue,100),style:fe(t.style)??"arc",lineWidth:K(t.lineWidth,4),trackColorHex:U(t.trackColorHex,"#FFFFFF40"),coloring:fe(t.coloring)??"uniform",bands:Jr(t.bands),bandAboveColorHex:U(t.bandAboveColorHex,lt),thresholdColorHex:U(t.thresholdColorHex,Dt)},i=pn(t.thresholdValue);return i!==void 0&&(n.thresholdValue=i),F(t.total)&&(n.total=de(t.total)),{kind:"gauge",payload:n}}case"chart":return{kind:"chart",payload:{...rt(t,"#FFFFFF"),value:F(t.value)?de(t.value):M("13,14,16,17,19,22,24,28,30"),historyMinutes:Math.max(0,Math.round(K(t.historyMinutes,0))),historyPoints:Math.round(K(t.historyPoints,24)),style:fe(t.style)??"bars",limit:Math.max(0,Math.round(K(t.limit,0))),takeFromEnd:t.takeFromEnd===!0,scale:fe(t.scale)??"auto",minValue:K(t.minValue,0),maxValue:K(t.maxValue,100),baseline:fe(t.baseline)??"lowest",barGap:K(t.barGap,1.5),lineWidth:K(t.lineWidth,2),highlight:fe(t.highlight)??"none",highColorHex:U(t.highColorHex,mn),lowColorHex:U(t.lowColorHex,fn),marker:fe(t.marker)??"pointer",coloring:fe(t.coloring)??"uniform",bands:od(t),bandAboveColorHex:U(t.bandHighColorHex,U(t.bandAboveColorHex,lt)),fillBands:t.fillBands===!0,...typeof t.thresholdValue=="number"&&Number.isFinite(t.thresholdValue)?{thresholdValue:t.thresholdValue}:{},thresholdColorHex:U(t.thresholdColorHex,Vt),...F(t.nowIndex)?{nowIndex:de(t.nowIndex)}:{},nowColorHex:U(t.nowColorHex,Bt),...fe(t.scaleFrom)!==void 0?{scaleFrom:fe(t.scaleFrom)}:{}}};case"timeline":{let{colorSlot:n,...i}=rt(t,"#FFFFFF");return{kind:"timeline",payload:{...i,value:F(t.value)?de(t.value):M(""),historyMinutes:Math.max(1,Math.round(K(t.historyMinutes,Dn))),bands:sd(t.bands),otherColorHex:U(t.otherColorHex,Ue),gap:Math.min(Vn,Math.max(0,K(t.gap,0))),cornerRadius:Math.max(0,K(t.cornerRadius,Yi))}}}case"shape":{let n={...rt(t,"#FFFFFF33"),kind:fe(t.kind)??"roundedRectangle",cornerRadius:K(t.cornerRadius,6),thickness:K(t.thickness,1),borderWidth:K(t.borderWidth,1)};return typeof t.borderColorHex=="string"&&(n.borderColorHex=t.borderColorHex),{kind:"shape",payload:n}}case"image":{let{colorSlot:n,...i}=rt(t,"#FFFFFF"),a={...i,entity:ot(F(t.entity)?t.entity:{}),source:t.source==="entityPicture"?"entityPicture":"camera",contentMode:t.contentMode==="fit"?"fit":"fill",zoom:K(t.zoom,1),panX:K(t.panX,0),panY:K(t.panY,0),cornerRadius:K(t.cornerRadius,Gt),timestampCorner:td.includes(t.timestampCorner)?t.timestampCorner:"topLeading",timestampSize:K(t.timestampSize,Ut)};t.timestamp===!0&&(a.timestamp=!0);let r=pn(t.timestampX),o=pn(t.timestampY);return r!==void 0&&o!==void 0&&Number.isFinite(r)&&Number.isFinite(o)&&(a.timestampX=Le(r),a.timestampY=Le(o)),{kind:"image",payload:a}}case"tap":{let{colorSlot:n,...i}=rt(t,"#FFFFFF"),a={...i,action:F(t.action)?Xr(t.action):{type:"refresh"}};return typeof t.openPageId=="string"&&(a.openPageId=t.openPageId),typeof t.openPageName=="string"&&(a.openPageName=t.openPageName),typeof t.attachedTo=="string"&&(a.attachedTo=t.attachedTo.toUpperCase()),{kind:"tap",payload:a}}default:throw new _e(`unknown element kind ${String(e.kind)}`)}}function Hr(e){let t=F(e)?e:{},n={};if(F(t.placements))for(let[a,r]of Object.entries(t.placements)){if(!F(r))continue;let o={frame:qr(r.frame),isHidden:r.isHidden===!0},s=pn(r.size);s!==void 0&&(o.size=s),n[a.toUpperCase()]=o}let i={placements:n,cornerBodyShape:t.cornerBodyShape==="circle"?"circle":"wedge",borderWidth:K(t.borderWidth,2),rules:Yr(t.rules)};if(F(t.bezelText)&&(i.bezelText=de(t.bezelText)),t.bezelCountdown===!0&&(i.bezelCountdown=!0),F(t.curvedText)&&(i.curvedText=de(t.curvedText)),typeof t.curvedColorHex=="string"&&(i.curvedColorHex=t.curvedColorHex),F(t.bezelGauge)){let a=t.bezelGauge,r={value:F(a.value)?de(a.value):M("50"),minValue:K(a.minValue,0),maxValue:K(a.maxValue,100),colorHexes:Array.isArray(a.colorHexes)&&a.colorHexes.length>0?a.colorHexes.filter(o=>typeof o=="string"):["#34C759","#FFCC00","#FF3B30"]};F(a.minLabel)&&(r.minLabel=de(a.minLabel)),F(a.maxLabel)&&(r.maxLabel=de(a.maxLabel)),i.bezelGauge=r}return typeof t.backgroundColorHex=="string"&&(i.backgroundColorHex=t.backgroundColorHex),typeof t.borderColorHex=="string"&&(i.borderColorHex=t.borderColorHex),i}function cd(e){let t={};if(Array.isArray(e))for(let n=0;n+1<e.length;n+=2){let i=e[n];typeof i=="string"&&(t[i]=Hr(e[n+1]))}else if(F(e))for(let[n,i]of Object.entries(e))t[n]=Hr(i);return t}function ud(e){let t={value:F(e.value)?de(e.value):M("")};return typeof e.label=="string"&&(t.label=e.label),typeof e.symbol=="string"&&(t.symbol=e.symbol),e.countdown===!0&&(t.countdown=!0),t}function Xr(e){if(!F(e)||typeof e.type!="string")return{type:"none"};switch(e.type){case"none":case"refresh":case"openApp":case"openPage":case"openRoomPage":case"timerStartPause":case"timerCancel":return{type:e.type};case"toggleEntity":case"runScene":case"runScript":case"addTodo":case"runHTTPAction":return{type:e.type,...ot(e)};case"callService":{let t={type:"callService",serviceDomain:typeof e.serviceDomain=="string"?e.serviceDomain:"",serviceName:typeof e.serviceName=="string"?e.serviceName:""};return typeof e.serviceDataJSON=="string"&&e.serviceDataJSON.trim()!==""&&(t.serviceDataJSON=e.serviceDataJSON),typeof e.entityId=="string"&&e.entityId!==""&&(t.target=ot(e)),t}default:return{type:"none"}}}function Zr(e){if(!F(e))throw new _e("config must be an object");for(let r of["id","name","slotIndex","supportedFamilies","perFamily","tapAction"])if(!(r in e))throw new _e(`${r} is required`);let t=(Array.isArray(e.values)?e.values:[]).filter(F).map(r=>({id:U(r.id).toUpperCase(),name:U(r.name),value:F(r.value)?de(r.value):M("")})),n=(Array.isArray(e.dataSources)?e.dataSources:[]).filter(F).map(r=>r.kind==="template"?{kind:"template",value:U(r.value)}:r.kind==="entity"?{kind:"entity",...ot(r)}:null).filter(r=>r!==null),i={schemaVersion:K(e.schemaVersion,1),id:U(e.id).toUpperCase(),name:U(e.name,"Custom"),values:t,slotIndex:K(e.slotIndex,0),elements:(Array.isArray(e.elements)?e.elements:[]).map(ld),supportedFamilies:(Array.isArray(e.supportedFamilies)?e.supportedFamilies:[]).filter(r=>typeof r=="string"),perFamily:cd(e.perFamily),dataSources:n,tapAction:Xr(e.tapAction)};F(e.inline)&&(i.inline=ud(e.inline));let a=pn(e.refreshMinutes);if(a!==void 0&&(i.refreshMinutes=a),typeof e.openPageId=="string"&&(i.openPageId=e.openPageId),typeof e.openPageName=="string"&&(i.openPageName=e.openPageName),typeof e.showSuccessFlash=="boolean"&&(i.showSuccessFlash=e.showSuccessFlash),typeof e.successFlashColorHex=="string"&&(i.successFlashColorHex=e.successFlashColorHex),Array.isArray(e.groups)){let r=e.groups.filter(F).filter(o=>typeof o.id=="string").map(o=>({id:U(o.id).toUpperCase(),name:U(o.name,"Group"),locked:o.locked!==!1}));r.length>0&&(i.groups=r)}return hd(i,Array.isArray(e.elements)?e.elements:[]),Je(i),i}function ea(e,t){let n=t?.kind;if(!n||n.kind!=="chartStat")return;let i=e.elements.find(a=>a.payload.id===n.layer);return i?.kind==="chart"?i:void 0}function Ct(e,t){return e.elements.filter(n=>n.kind==="text"&&n.payload.value.kind.kind==="chartStat"&&n.payload.value.kind.layer===t)}function pd(e,t){let n=_n(e,bn(t))?.ref;return n?.displayName||n?.entityId||"Chart"}function Qr(e,t,n){let i=qe(e,t.payload.id);if(i){na(e,n,i.id);return}let a=ta(e,[t.payload.id,n],pd(e,t)),r=e.groups?.find(o=>o.id===a);r&&(r.locked=!1)}var eo={top:{x:0,y:0},highest:{x:.35,y:0},average:{x:.65,y:0},latest:{x:1,y:0},bottom:{x:0,y:1},lowest:{x:.35,y:1}};function to(e,t,n,i){let a=ge.rectangular,r=Math.min(1,(i*n*.62+4)/a.width),o=Math.min(1,n*1.3/a.height),s=e.x+t.x*e.width-t.x*r,l=e.y+t.y*e.height-t.y*o;return{x:Math.max(0,Math.min(1-r,s)),y:Math.max(0,Math.min(1-o,l)),width:r,height:o,rotationDegrees:0}}function no(e,t,n){let i=e.elements.find(l=>l.payload.id===t);if(!i||i.kind!=="chart")return;let a=ze("text"),r=n==="latest"?10:8,o={kind:{kind:"chartStat",layer:t,stat:n}};n==="latest"&&(o.format={useEntityUnit:!0}),a.payload.value=o,a.payload.fontSize=r,a.payload.fontWeight="medium",a.payload.colorSlot={baseColorHex:n==="latest"?"#FFFFFF":"#FFFFFF99"},a.payload.frame=to(i.payload.frame,eo[n],r,n==="latest"?7:4);let s=e.elements.findIndex(l=>l.payload.id===t);return e.elements.splice(s+1,0,a),Qr(e,i,a.payload.id),a.payload.id}function hd(e,t){for(let n of t){if(!F(n)||n.kind!=="chart"||!F(n.payload))continue;let i=n.payload,a=U(i.id).toUpperCase(),r=e.elements.find(h=>h.payload.id===a);if(!r||r.kind!=="chart")continue;let o=U(i.scaleLabelColorHex,"#FFFFFF99"),s=h=>{let f=F(h)?h:{};return{fontSize:K(f.fontSize,8),colorHex:U(f.colorHex,o),pillColorHex:typeof f.pillColorHex=="string"?f.pillColorHex:void 0}},l=[],d=fe(i.scaleLabels);(d==="top"||d==="range")&&l.push(["top",s(i.topLabelStyle)]),d==="range"&&l.push(["bottom",s(i.bottomLabelStyle)]);let c=fe(i.latestLabel);if((c==="corner"||c==="end")&&l.push(["latest",s(i.latestLabelStyle)]),l.length===0)continue;let u=e.elements.findIndex(h=>h.payload.id===a)+1;for(let[h,f]of l){let g=to(r.payload.frame,eo[h],f.fontSize,h==="latest"?5:4),x=[];if(f.pillColorHex!==void 0){let S=ze("shape");S.payload.kind="capsule",S.payload.colorSlot={baseColorHex:f.pillColorHex},S.payload.frame={...g},x.push(S)}let $=ze("text");$.payload.value={kind:{kind:"chartStat",layer:a,stat:h}},$.payload.fontSize=f.fontSize,$.payload.fontWeight="medium",$.payload.colorSlot={baseColorHex:f.colorHex},$.payload.frame=g,x.push($),e.elements.splice(u,0,...x),u+=x.length;for(let S of x)Qr(e,r,S.payload.id)}}}function W(e){return Number.isNaN(e)?"nan":e===1/0?"+inf":e===-1/0?"-inf":e}function st(e){let t={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(t.iconName=e.iconName),t}function md(e){let t={};return e.decimals!==void 0&&(t.decimals=W(e.decimals)),e.multiply!==void 0&&(t.multiply=W(e.multiply)),e.offset!==void 0&&(t.offset=W(e.offset)),e.prefix&&(t.prefix=e.prefix),e.suffix&&(t.suffix=e.suffix),e.useEntityUnit&&(t.useEntityUnit=!0),e.relativeTime&&(t.relativeTime=!0),e.duration&&(t.duration=!0),e.textCase!==void 0&&(t.textCase=e.textCase),t}function fd(e){let t=e.scope.kind==="entities"?{kind:"entities",entities:e.scope.entities.map(st)}:{kind:"filter",domains:e.scope.domains,areaIds:e.scope.areaIds,labelIds:e.scope.labelIds,floorIds:e.scope.floorIds},n={function:e.function,scope:t};return e.stateFilter&&(n.stateFilter=e.stateFilter.kind==="equals"||e.stateFilter.kind==="notEquals"?{kind:e.stateFilter.kind,value:e.stateFilter.value}:{kind:e.stateFilter.kind}),e.attribute!==void 0&&(n.attribute=e.attribute),n}function gd(e){switch(e.kind){case"literal":return{kind:"literal",value:e.value};case"entityState":return{kind:"entityState",...st(e)};case"entityAttribute":return{kind:"entityAttribute",...st(e),attribute:e.attribute};case"entityAge":return{kind:"entityAge",...st(e)};case"aggregate":return{kind:"aggregate",aggregate:fd(e.aggregate)};case"time":return{kind:"time",timeField:e.timeField};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:e.value};case"named":return{kind:"named",id:e.id};case"chartStat":return{kind:"chartStat",layer:e.layer,stat:e.stat}}}function ie(e){let t={kind:gd(e.kind)};return Ne(e.format)||(t.format=md(e.format)),t}function cn(e){return{x:W(e.x),y:W(e.y),width:W(e.width),height:W(e.height),rotationDegrees:W(e.rotationDegrees)}}function yd(e){let t={kind:e.kind};switch(e.kind){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":t.value=ie(e.value??M(""));break;case"between":t.value=ie(e.value??M("")),t.upper=ie(e.upper??M(""));break;case"matchesRegex":t.pattern=e.pattern??"";break;case"isOneOf":t.options=e.options??[];break;default:break}return t}function Ar(e){let t={kind:e.kind};switch(e.kind){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":t.value=ie(e.value??M(""));break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":t.number=W(e.number??0);break;case"setFontWeight":t.weight=e.weight??"regular";break;default:break}return t}function un(e){return e.map(t=>{let n={id:t.id,cases:t.cases.map(i=>({id:i.id,when:{join:i.when.join,tests:i.when.tests.map(a=>({id:a.id,value:ie(a.value),comparison:yd(a.comparison)}))},then:i.then.map(Ar)}))};return t.otherwise&&(n.otherwise=t.otherwise.map(Ar)),n})}function bd(e){let t=vd(e);return e.payload.groupId!==void 0&&(t.payload.groupId=e.payload.groupId),t}function vd(e){let t=n=>({id:n.id,colorSlot:{baseColorHex:n.colorSlot.baseColorHex},rules:un(n.rules),frame:cn(n.frame),isHidden:n.isHidden});switch(e.kind){case"text":{let n={...t(e.payload),value:ie(e.payload.value),fontSize:W(e.payload.fontSize),fontWeight:e.payload.fontWeight};return e.payload.countdown===!0&&(n.countdown=!0),{kind:"text",payload:n}}case"icon":return{kind:"icon",payload:{...t(e.payload),symbol:ie(e.payload.symbol),size:W(e.payload.size)}};case"gauge":{let n=e.payload,i={...t(n),value:ie(n.value),minValue:W(n.minValue),maxValue:W(n.maxValue),style:n.style,lineWidth:W(n.lineWidth),trackColorHex:n.trackColorHex};return n.coloring!=="uniform"&&(i.coloring=n.coloring),n.bands.length>0&&(i.bands=n.bands.map(a=>({id:a.id,upTo:W(a.upTo),colorHex:a.colorHex}))),n.bandAboveColorHex!==lt&&(i.bandAboveColorHex=n.bandAboveColorHex),n.thresholdValue!==void 0&&(i.thresholdValue=W(n.thresholdValue)),n.thresholdColorHex!==Dt&&(i.thresholdColorHex=n.thresholdColorHex),n.total!==void 0&&(i.total=ie(n.total)),{kind:"gauge",payload:i}}case"chart":{let n=e.payload,i={...t(n),value:ie(n.value),historyMinutes:Math.max(0,Math.round(n.historyMinutes)),historyPoints:Math.round(n.historyPoints),style:n.style,limit:Math.max(0,Math.round(n.limit)),takeFromEnd:n.takeFromEnd,scale:n.scale,minValue:W(n.minValue),maxValue:W(n.maxValue),baseline:n.baseline,barGap:W(n.barGap),lineWidth:W(n.lineWidth),highlight:n.highlight,highColorHex:n.highColorHex,lowColorHex:n.lowColorHex,marker:n.marker,coloring:n.coloring,bands:n.bands.map(a=>({id:a.id,upTo:W(a.upTo),colorHex:a.colorHex})),bandAboveColorHex:n.bandAboveColorHex,fillBands:n.fillBands};return n.thresholdValue!==void 0&&(i.thresholdValue=W(n.thresholdValue)),n.thresholdColorHex!==Vt&&(i.thresholdColorHex=n.thresholdColorHex),n.nowIndex!==void 0&&(i.nowIndex=ie(n.nowIndex)),n.nowColorHex!==Bt&&(i.nowColorHex=n.nowColorHex),n.scaleFrom!==void 0&&(i.scaleFrom=n.scaleFrom),{kind:"chart",payload:i}}case"timeline":{let n=e.payload,i={id:n.id,rules:un(n.rules),frame:cn(n.frame),isHidden:n.isHidden,value:ie(n.value)};return n.historyMinutes!==Dn&&(i.historyMinutes=Math.max(1,Math.round(n.historyMinutes))),n.bands.length>0&&(i.bands=n.bands.map(a=>({id:a.id,match:a.match,colorHex:a.colorHex}))),n.otherColorHex!==Ue&&(i.otherColorHex=n.otherColorHex),n.gap!==0&&(i.gap=W(n.gap)),n.cornerRadius!==Yi&&(i.cornerRadius=W(n.cornerRadius)),{kind:"timeline",payload:i}}case"shape":{let n={...t(e.payload),kind:e.payload.kind,cornerRadius:W(e.payload.cornerRadius),borderWidth:W(e.payload.borderWidth)};return e.payload.borderColorHex!==void 0&&(n.borderColorHex=e.payload.borderColorHex),e.payload.thickness!==1&&(n.thickness=W(e.payload.thickness)),{kind:"shape",payload:n}}case"image":{let n=e.payload,i={id:n.id,entity:st(n.entity),rules:un(n.rules),frame:cn(n.frame),isHidden:n.isHidden};n.source!=="camera"&&(i.source=n.source),n.timestamp===!0&&(i.timestamp=!0),n.contentMode!=="fill"&&(i.contentMode=n.contentMode),n.zoom!==1&&(i.zoom=W(n.zoom)),n.panX!==0&&(i.panX=W(n.panX)),n.panY!==0&&(i.panY=W(n.panY)),n.cornerRadius!==Gt&&(i.cornerRadius=W(n.cornerRadius));let a=We(n),r=a?Xi(n.timestampX,n.timestampY):n.timestampCorner;return r!=="topLeading"&&(i.timestampCorner=r),n.timestampSize!==Ut&&(i.timestampSize=W(n.timestampSize)),a&&(i.timestampX=W(n.timestampX),i.timestampY=W(n.timestampY)),{kind:"image",payload:i}}case"tap":{let n=e.payload,i={id:n.id,action:io(n.action)};return n.openPageId!==void 0&&(i.openPageId=n.openPageId),n.openPageName!==void 0&&(i.openPageName=n.openPageName),n.attachedTo!==void 0&&(i.attachedTo=n.attachedTo),i.rules=un(n.rules),i.frame=cn(n.frame),i.isHidden=n.isHidden,{kind:"tap",payload:i}}}}function xd(e){let t={},n=Object.keys(e.placements);if(n.length>0){let i={};for(let a of n){let r=e.placements[a],o={frame:cn(r.frame)};r.isHidden&&(o.isHidden=!0),r.size!==void 0&&(o.size=W(r.size)),i[a]=o}t.placements=i}if(e.bezelText&&(t.bezelText=ie(e.bezelText)),e.bezelCountdown===!0&&(t.bezelCountdown=!0),e.curvedText&&(t.curvedText=ie(e.curvedText)),e.curvedColorHex!==void 0&&(t.curvedColorHex=e.curvedColorHex),e.bezelGauge){let i=e.bezelGauge,a={value:ie(i.value),minValue:W(i.minValue),maxValue:W(i.maxValue),colorHexes:i.colorHexes};i.minLabel&&(a.minLabel=ie(i.minLabel)),i.maxLabel&&(a.maxLabel=ie(i.maxLabel)),t.bezelGauge=a}return e.backgroundColorHex!==void 0&&(t.backgroundColorHex=e.backgroundColorHex),t.cornerBodyShape=e.cornerBodyShape,e.borderColorHex!==void 0&&(t.borderColorHex=e.borderColorHex),t.borderWidth=W(e.borderWidth),e.rules.length>0&&(t.rules=un(e.rules)),t}function io(e){if(e.type==="callService"){let t={type:e.type,serviceDomain:e.serviceDomain,serviceName:e.serviceName};return e.serviceDataJSON!==void 0&&e.serviceDataJSON.trim()!==""&&(t.serviceDataJSON=e.serviceDataJSON),e.target!==void 0&&e.target.entityId!==""&&Object.assign(t,st(e.target)),t}return"entityId"in e?{type:e.type,...st(e)}:{type:e.type}}function wd(e){let t={};return e.label!==void 0&&(t.label=e.label),t.value=ie(e.value),e.symbol!==void 0&&(t.symbol=e.symbol),e.countdown&&(t.countdown=!0),t}function Gn(e){let t=[];for(let i of ee){let a=e.perFamily[i];a&&t.push(i,xd(a))}let n={schemaVersion:hn(e),id:e.id,name:e.name,values:e.values.map(i=>({id:i.id,name:i.name,value:ie(i.value)})),slotIndex:e.slotIndex,elements:e.elements.map(bd),supportedFamilies:e.supportedFamilies,perFamily:t,dataSources:e.dataSources.map(i=>i.kind==="template"?{kind:"template",value:i.value}:{kind:"entity",...st(i)}),tapAction:io(e.tapAction)};return e.inline!==void 0&&(n.inline=wd(e.inline)),e.refreshMinutes!==void 0&&(n.refreshMinutes=e.refreshMinutes),e.openPageId!==void 0&&(n.openPageId=e.openPageId),e.openPageName!==void 0&&(n.openPageName=e.openPageName),e.showSuccessFlash!==void 0&&(n.showSuccessFlash=e.showSuccessFlash),e.successFlashColorHex!==void 0&&(n.successFlashColorHex=e.successFlashColorHex),e.groups!==void 0&&e.groups.length>0&&(n.groups=e.groups.map(i=>({id:i.id,name:i.name,locked:i.locked}))),n}function qe(e,t){let i=e.elements.find(a=>a.payload.id===t)?.payload.groupId;return i===void 0?void 0:e.groups?.find(a=>a.id===i)}function Ye(e,t){return e.elements.filter(n=>n.payload.groupId===t&&!ye(e,n))}function Je(e){let t=new Set((e.groups??[]).map(a=>a.id));for(let a of e.elements)a.payload.groupId!==void 0&&!t.has(a.payload.groupId)&&delete a.payload.groupId;let n=new Set(e.elements.map(a=>a.payload.groupId).filter(a=>a!==void 0)),i=(e.groups??[]).filter(a=>n.has(a.id));i.length===0?delete e.groups:e.groups=i}function Kt(e){if(!e.groups?.length)return;let t=e.elements.filter(r=>!ye(e,r)),n=e.elements.filter(r=>ye(e,r)),i=[],a=new Set;for(let r=t.length-1;r>=0;r--){let o=t[r];if(a.has(o.payload.id))continue;let s=o.payload.groupId;if(s===void 0){i.unshift(o),a.add(o.payload.id);continue}let l=t.filter(d=>d.payload.groupId===s);for(let d=l.length-1;d>=0;d--)i.unshift(l[d]),a.add(l[d].payload.id)}e.elements=[...i,...n],ct(e)}function ta(e,t,n="Group"){let i=e.elements.filter(r=>t.includes(r.payload.id)&&!ye(e,r));if(i.length<2)return;let a={id:Y(),name:n,locked:!0};e.groups=[...e.groups??[],a];for(let r of i)r.payload.groupId=a.id;return Je(e),Kt(e),a.id}function yn(e,t){for(let n of e.elements)n.payload.groupId===t&&delete n.payload.groupId;Je(e)}function na(e,t,n){let i=e.elements.find(a=>a.payload.id===t);!i||ye(e,i)||(n===void 0?delete i.payload.groupId:i.payload.groupId=n,Je(e),Kt(e))}var X={config:["schemaVersion","id","name","values","slotIndex","elements","supportedFamilies","perFamily","inline","dataSources","refreshMinutes","tapAction","openPageId","openPageName","showSuccessFlash","successFlashColorHex","groups"],group:["id","name","locked"],inline:["label","value","symbol","countdown"],named:["id","name","value"],value:["kind","format"],format:["decimals","multiply","offset","prefix","suffix","useEntityUnit","relativeTime","duration","textCase"],entityRef:["entityId","displayName","domain","iconName"],aggregate:["function","scope","stateFilter","attribute"],scope:["kind","entities","domains","areaIds","labelIds","floorIds"],stateFilter:["kind","value"],frame:["x","y","width","height","rotationDegrees"],elementEnvelope:["kind","payload"],elementBase:["id","colorSlot","rules","frame","isHidden","groupId"],text:["value","fontSize","fontWeight","countdown"],icon:["symbol","size"],gauge:["value","minValue","maxValue","style","lineWidth","trackColorHex","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex","total"],chart:["value","historyMinutes","historyPoints","style","limit","takeFromEnd","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","bandLowColorHex","bandHighColorHex","bandLowerBound","bandUpperBound","scaleLabels","scaleLabelPlacement","latestLabel","topLabelStyle","bottomLabelStyle","latestLabelStyle","latestLabelFollowsBand","scaleLabelColorHex"],timeline:["value","historyMinutes","bands","otherColorHex","gap","cornerRadius"],shape:["kind","cornerRadius","thickness","borderColorHex","borderWidth"],image:["entity","source","timestamp","contentMode","zoom","panX","panY","cornerRadius","timestampCorner","timestampSize","timestampStyle","timestampX","timestampY"],tap:["action","openPageId","openPageName","attachedTo","grow"],colorSlot:["baseColorHex"],rule:["id","cases","otherwise"],case:["id","when","then"],condition:["join","tests"],test:["id","value","comparison"],comparison:["kind","value","upper","pattern","options"],styleChange:["kind","value","number","weight"],layout:["placements","bezelText","bezelCountdown","curvedText","curvedColorHex","bezelGauge","backgroundColorHex","cornerBodyShape","borderColorHex","borderWidth","rules"],bezelGauge:["value","minValue","maxValue","colorHexes","minLabel","maxLabel"],placement:["frame","isHidden","size"],tapAction:["type","entityId","displayName","domain","iconName","serviceDomain","serviceName","serviceDataJSON"],dataSource:["kind","entityId","displayName","domain","iconName","value"]},Lr={literal:["kind","value"],entityState:["kind",...X.entityRef],entityAttribute:["kind",...X.entityRef,"attribute"],entityAge:["kind",...X.entityRef],aggregate:["kind","aggregate"],time:["kind","timeField"],dataAge:["kind"],jinja:["kind","value"],named:["kind","id"],chartStat:["kind","layer","stat"]};function ao(e){let t=[],n=(l,d,c)=>{if(F(l))for(let u of Object.keys(l))d.includes(u)||t.push(`${c}.${u}`)},i=(l,d)=>{if(!F(l))return;let c=typeof l.kind=="string"?l.kind:"";n(l,Lr[c]??["kind"],d),c==="aggregate"&&F(l.aggregate)&&(n(l.aggregate,X.aggregate,`${d}.aggregate`),n(l.aggregate.scope,X.scope,`${d}.aggregate.scope`),F(l.aggregate.scope)&&Array.isArray(l.aggregate.scope.entities)&&l.aggregate.scope.entities.forEach((u,h)=>n(u,X.entityRef,`${d}.aggregate.scope.entities[${h}]`)),n(l.aggregate.stateFilter,X.stateFilter,`${d}.aggregate.stateFilter`))},a=(l,d)=>{if(F(l)){if(F(l.kind))n(l,X.value,d),i(l.kind,`${d}.kind`);else{let c=typeof l.kind=="string"?l.kind:"";n(l,[...Lr[c]??["kind"],"format"],d),c==="aggregate"&&i(l,d)}n(l.format,X.format,`${d}.format`)}},r=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{n(c,X.styleChange,`${d}[${u}]`),F(c)&&a(c.value,`${d}[${u}].value`)})},o=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{let h=`${d}[${u}]`;n(c,X.rule,h),F(c)&&(Array.isArray(c.cases)&&c.cases.forEach((f,g)=>{let x=`${h}.cases[${g}]`;n(f,X.case,x),F(f)&&(n(f.when,X.condition,`${x}.when`),F(f.when)&&Array.isArray(f.when.tests)&&f.when.tests.forEach(($,S)=>{let E=`${x}.when.tests[${S}]`;n($,X.test,E),F($)&&(a($.value,`${E}.value`),n($.comparison,X.comparison,`${E}.comparison`),F($.comparison)&&(a($.comparison.value,`${E}.comparison.value`),a($.comparison.upper,`${E}.comparison.upper`)))}),r(f.then,`${x}.then`))}),r(c.otherwise,`${h}.otherwise`))})};if(!F(e))return t;n(e,X.config,"$"),Array.isArray(e.groups)&&e.groups.forEach((l,d)=>n(l,X.group,`$.groups[${d}]`)),Array.isArray(e.values)&&e.values.forEach((l,d)=>{n(l,X.named,`$.values[${d}]`),F(l)&&a(l.value,`$.values[${d}].value`)}),Array.isArray(e.elements)&&e.elements.forEach((l,d)=>{let c=`$.elements[${d}]`;if(n(l,X.elementEnvelope,c),!F(l)||!F(l.payload))return;let u=typeof l.kind=="string"?l.kind:"",h=X[u]??[];n(l.payload,[...X.elementBase,...h],`${c}.payload`),n(l.payload.colorSlot,X.colorSlot,`${c}.payload.colorSlot`),n(l.payload.frame,X.frame,`${c}.payload.frame`),o(l.payload.rules,`${c}.payload.rules`);for(let f of["value","symbol","nowIndex","total"])f in l.payload&&a(l.payload[f],`${c}.payload.${f}`);u==="image"&&n(l.payload.entity,X.entityRef,`${c}.payload.entity`),u==="tap"&&n(l.payload.action,X.tapAction,`${c}.payload.action`)});let s=[];if(Array.isArray(e.perFamily))for(let l=0;l+1<e.perFamily.length;l+=2)s.push([String(e.perFamily[l]),e.perFamily[l+1]]);else F(e.perFamily)&&s.push(...Object.entries(e.perFamily));for(let[l,d]of s){let c=`$.perFamily.${l}`;if(n(d,X.layout,c),!!F(d)){if(F(d.placements))for(let[u,h]of Object.entries(d.placements))n(h,X.placement,`${c}.placements.${u}`),F(h)&&n(h.frame,X.frame,`${c}.placements.${u}.frame`);if(a(d.bezelText,`${c}.bezelText`),a(d.curvedText,`${c}.curvedText`),F(d.bezelGauge)){let u=`${c}.bezelGauge`;n(d.bezelGauge,X.bezelGauge,u),a(d.bezelGauge.value,`${u}.value`),a(d.bezelGauge.minLabel,`${u}.minLabel`),a(d.bezelGauge.maxLabel,`${u}.maxLabel`)}o(d.rules,`${c}.rules`)}}return F(e.inline)&&(n(e.inline,X.inline,"$.inline"),a(e.inline.value,"$.inline.value")),Array.isArray(e.dataSources)&&e.dataSources.forEach((l,d)=>n(l,X.dataSource,`$.dataSources[${d}]`)),n(e.tapAction,X.tapAction,"$.tapAction"),t}function Y(){let e=globalThis.crypto;if(e&&"randomUUID"in e)return e.randomUUID().toUpperCase();let t=()=>Math.floor(Math.random()*65536).toString(16).padStart(4,"0"),n=(8+Math.floor(Math.random()*4)).toString(16)+t().slice(1);return`${t()}${t()}-${t()}-4${t().slice(1)}-${n}-${t()}${t()}${t()}`.toUpperCase()}function Wt(){return{placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}}function ro(e,t,n=[...ee]){let i={};for(let r of ee)n.includes(r)&&(i[r]=Wt());let a={schemaVersion:4,id:Y(),name:e,values:[],slotIndex:t,elements:[],supportedFamilies:Jl.filter(r=>n.includes(r)),perFamily:i,dataSources:[],refreshMinutes:0,tapAction:{type:"refresh"}};return n.includes("inline")&&(a.inline={value:M("Text")}),a.schemaVersion=hn(a),a}function ze(e){let t=n=>({id:Y(),colorSlot:{baseColorHex:n},rules:[],frame:{...Ge},isHidden:!1});switch(e){case"text":return{kind:e,payload:{...t("#FFFFFF"),value:M("Text"),fontSize:14,fontWeight:"regular"}};case"icon":return{kind:e,payload:{...t("#FFFFFF"),symbol:M("lightbulb"),size:14}};case"gauge":return{kind:e,payload:{...t("#FFFFFF"),value:M("50"),minValue:0,maxValue:100,style:"arc",lineWidth:4,trackColorHex:"#FFFFFF40",coloring:"uniform",bands:[],bandAboveColorHex:lt,thresholdColorHex:Dt}};case"chart":return{kind:e,payload:{...t("#FFFFFF"),value:M("13,14,16,17,19,22,24,28,30"),historyMinutes:Pn,historyPoints:24,style:"bars",limit:0,takeFromEnd:!1,scale:"auto",minValue:0,maxValue:100,baseline:"lowest",barGap:1.5,lineWidth:2,highlight:"none",highColorHex:mn,lowColorHex:fn,marker:"pointer",coloring:"uniform",bands:[],bandAboveColorHex:lt,fillBands:!1,thresholdColorHex:Vt,nowColorHex:Bt}};case"timeline":{let{colorSlot:n,...i}=t("#FFFFFF");return{kind:e,payload:{...i,value:M(""),historyMinutes:Dn,bands:[],otherColorHex:Ue,gap:0,cornerRadius:Yi}}}case"shape":return{kind:e,payload:{...t("#FFFFFF33"),kind:"roundedRectangle",cornerRadius:6,thickness:1,borderWidth:1}};case"image":{let{colorSlot:n,...i}=t("#FFFFFF");return{kind:e,payload:{...i,entity:{entityId:"",displayName:"",domain:"camera"},source:"camera",contentMode:"fill",zoom:1,panX:0,panY:0,cornerRadius:Gt,timestampCorner:"topLeading",timestampSize:Ut}}}case"tap":{let{colorSlot:n,...i}=t("#FFFFFF");return{kind:e,payload:{...i,action:{type:"refresh"}}}}}}function M(e){return{kind:{kind:"literal",value:e}}}function Un(e){switch(e.kind){case"text":return e.payload.fontSize;case"icon":return e.payload.size;case"gauge":return e.payload.lineWidth;case"chart":return e.payload.lineWidth;case"timeline":return;case"shape":return;case"image":return;case"tap":return}}var _r=["circular","corner"],zr=Math.SQRT1_2;function kd(e){return e==="text"||e==="icon"?4:.5}function ia(e,t,n,i){let a=structuredClone(e),r=ge[t],o=ge[n];if(t===n||!r||!o)return a;let s=_r.includes(t),l=_r.includes(n),d=s===l?1:l?zr:1/zr,c=Math.min(o.width/r.width,o.height/r.height)*d;if(d!==1){let u=a.frame,h=u.x+u.width/2,f=u.y+u.height/2;a.frame={...u,width:u.width*d,height:u.height*d,x:.5+(h-.5)*d-u.width*d/2,y:.5+(f-.5)*d-u.height*d/2}}return a.size!==void 0&&(a.size=Math.max(kd(i),Math.round(a.size*c*10)/10)),a}function oo(e,t){let n=e.perFamily[t];return!n||Object.keys(n.placements).length===0?e.elements:e.elements.map(i=>{let a=n.placements[i.payload.id];if(!a)return i;let r={...i.payload,frame:a.frame,isHidden:a.isHidden};return a.size!==void 0&&(i.kind==="text"?r.fontSize=a.size:i.kind==="icon"?r.size=a.size:(i.kind==="gauge"||i.kind==="chart")&&(r.lineWidth=a.size)),{kind:i.kind,payload:r}})}function bn(e){switch(e.kind){case"text":return e.payload.value;case"icon":return e.payload.symbol;case"gauge":return e.payload.value;case"chart":return e.payload.value;case"timeline":return e.payload.value;case"shape":return;case"image":return{kind:{kind:"entityState",...e.payload.entity}};case"tap":return}}function aa(e){let t=[],n=i=>{for(let a of i)a.value&&t.push(a.value)};for(let i of e){for(let a of i.cases){for(let r of a.when.tests)t.push(r.value),r.comparison.value&&t.push(r.comparison.value),r.comparison.upper&&t.push(r.comparison.upper);n(a.then)}i.otherwise&&n(i.otherwise)}return t}var ra=["light","switch","fan","input_boolean","cover","lock","media_player","siren","humidifier","valve","automation","group"];function _n(e,t){let n,i=t;for(let a=0;i!==void 0&&a<4;a++){let r=i.kind;if(r.kind==="chartStat"){i=ea(e,i)?.payload.value;continue}if("entityId"in r){if(r.entityId==="")return;let o={entityId:r.entityId,displayName:r.displayName,domain:r.domain};return n===void 0?{ref:o}:{ref:o,namedId:n}}if(r.kind!=="named")return;n=r.id.toUpperCase(),i=e.values.find(o=>o.id.toUpperCase()===n)?.value}}function oa(e,t){return _n(e,bn(t))?.ref}function sa(e,t){let n=oa(e,t),i=n&&(n.domain||n.entityId.split(".")[0])||"";return n&&ra.includes(i)?{type:"toggleEntity",...n,domain:i}:{type:"refresh"}}function Nr(e,t,n){if(Bn(t)||n.width<=0||n.height<=0)return{...e};let i=t,a=e.x-i.left/n.width,r=e.x+e.width+i.right/n.width,o=e.y-i.top/n.height,s=e.y+e.height+i.bottom/n.height;return r<a&&(a=r=(a+r)/2),s<o&&(o=s=(o+s)/2),a=Le(a),r=Le(r),o=Le(o),s=Le(s),{...e,x:a,y:o,width:Math.max(0,r-a),height:Math.max(0,s-o)}}function so(e,t,n){let i=a=>Math.round(a*100)/100||0;return{left:i((e.x-t.x)*n.width),right:i((t.x+t.width-e.x-e.width)*n.width),top:i((e.y-t.y)*n.height),bottom:i((t.y+t.height-e.y-e.height)*n.height)}}function lo(e,t,n,i){let a=e.elements.find(h=>h.payload.id===t);if(!a||a.kind!=="tap"||a.payload.attachedTo===void 0)return;let r=e.elements.find(h=>h.payload.id===a.payload.attachedTo);if(!r)return;let o=e.perFamily[n]?.placements[r.payload.id]?.frame??r.payload.frame,s=Le(i.x),l=Le(i.y),d=Le(i.x+i.width),c=Le(i.y+i.height),u={...i,x:s,y:l,width:Math.max(0,d-s),height:Math.max(0,c-l)};a.payload.outset=so(o,u,ge[n])}function co(e,t,n){let i=e.elements.find(s=>s.payload.id===t);if(!i)return;let a=e.perFamily[n];if(!a)return;let r=a.placements[t]?.frame??i.payload.frame,o=ge[n];return{width:r.width*o.width,height:r.height*o.height}}function Me(e,t){return e.elements.filter(n=>n.kind==="tap"&&n.payload.attachedTo===t)}function ye(e,t){return t.kind!=="tap"||t.payload.attachedTo===void 0?!1:e.elements.some(n=>n.payload.id===t.payload.attachedTo&&n.kind!=="tap")}function la(e,t){let n=e.elements.find(i=>i.payload.id===t);if(n){if(n.kind==="tap"&&n.payload.attachedTo!==void 0){let i=e.elements.find(a=>a.payload.id===n.payload.attachedTo);if(i)return i.payload.id}return n.payload.id}}function ct(e){let t=new Map(e.elements.map(a=>[a.payload.id,a])),n=new Map;for(let a of e.elements){if(a.kind!=="tap")continue;let r=a.payload.attachedTo;if(r===void 0)continue;let o=t.get(r);if(!o||o.kind==="tap"||r===a.payload.id){delete a.payload.attachedTo;continue}let s=n.get(r);s?s.push(a):n.set(r,[a])}if(n.size===0)return;for(let[a,r]of n){let o=t.get(a);for(let s of r){let l=s.payload;l.outset===void 0&&(l.outset=so(o.payload.frame,l.frame,ge.rectangular));let d=l.outset,c=!Bn(d);s.payload.frame=Nr(o.payload.frame,d,ge.rectangular),s.payload.isHidden=o.payload.isHidden;for(let u of ee){let h=e.perFamily[u];if(!h)continue;let f=ge[u],g=h.placements[a];if(c){let x=g?.frame??o.payload.frame,$=g?.isHidden??o.payload.isHidden;h.placements[s.payload.id]={frame:Nr(x,d,f),isHidden:$}}else g?h.placements[s.payload.id]={frame:{...g.frame},isHidden:g.isHidden}:delete h.placements[s.payload.id]}}}let i=[];for(let a of e.elements){if(a.kind==="tap"&&a.payload.attachedTo!==void 0)continue;i.push(a);let r=n.get(a.payload.id);r&&i.push(...r)}e.elements=i}function Kn(e,t,n){let i=e.elements.find(s=>s.payload.id===t);if(!i||i.kind==="tap")return;let a=Me(e,t)[0];if(a)return a.payload;let r=ze("tap"),o=r.payload;return o.attachedTo=t,o.outset={...Zi},o.action=n??sa(e,i),e.elements.push(r),ct(e),o}function Wn(e,t){let n=Me(e,t).map(i=>i.payload.id);if(n.length!==0){e.elements=e.elements.filter(i=>!n.includes(i.payload.id));for(let i of ee)for(let a of n)delete e.perFamily[i]?.placements[a]}}function St(e,t){for(let n of Ct(e,t))St(e,n.payload.id);Wn(e,t),e.elements=e.elements.filter(n=>n.payload.id!==t);for(let n of e.elements)n.kind==="chart"&&n.payload.scaleFrom===t&&delete n.payload.scaleFrom;for(let n of ee)delete e.perFamily[n]?.placements[t];ct(e),Je(e)}function uo(e,t){let n=e.elements.findIndex(l=>l.payload.id===t),i=e.elements[n];if(!i)return;let a=Y(),r=structuredClone(i);r.payload.id=a,r.payload.frame={...r.payload.frame,x:Math.min(.9,r.payload.frame.x+.05),y:Math.min(.9,r.payload.frame.y+.05)};let o=[r],s=[[t,a]];for(let l of Me(e,t)){let d=structuredClone(l);d.payload.id=Y(),d.payload.attachedTo=a,o.push(d),s.push([l.payload.id,d.payload.id])}e.elements.splice(n+1,0,...o);for(let l of ee){let d=e.perFamily[l];if(d)for(let[c,u]of s){let h=d.placements[c];h&&(d.placements[u]=structuredClone(h))}}return ct(e),a}function po(e,t){let n=e.elements.findIndex(o=>o.payload.id===t),i=e.elements[n];if(!i||i.kind!=="chart")return;let a=Y(),r=structuredClone(i);r.payload.id=a,r.payload.scaleFrom=t,e.elements.splice(n+1,0,r);for(let o of ee){let s=e.perFamily[o],l=s?.placements[t];s&&l&&(s.placements[a]=structuredClone(l))}return a}function da(e,t,n){let i=new Set,a=d=>{i.add(d);for(let c of Me(e,d))i.add(c.payload.id)};for(let d of t){a(d);for(let c of Ct(e,d))a(c.payload.id)}let r=e.elements.filter(d=>i.has(d.payload.id)).map(d=>structuredClone(d)),o={};for(let d of ee){let c=e.perFamily[d];if(!c)continue;let u={};for(let h of r){let f=c.placements[h.payload.id];f&&(u[h.payload.id]=structuredClone(f))}Object.keys(u).length>0&&(o[d]=u)}let s=new Set(r.map(d=>d.payload.groupId).filter(d=>d!==void 0)),l=(e.groups??[]).filter(d=>s.has(d.id)).map(d=>structuredClone(d));return{elements:r,placements:o,groups:l,...n!==void 0?{family:n}:{}}}function ho(e,t,n){if(!ee.includes(n))return[];let i=e.perFamily[n];if(i||(i=Wt(),e.perFamily[n]=i),Object.keys(i.placements).length===0)for(let s of e.elements)i.placements[s.payload.id]={frame:{...s.payload.frame},isHidden:s.payload.isHidden};let a=new Set(e.elements.map(s=>s.payload.id)),r=t.family===void 0?void 0:t.placements[t.family],o=[];for(let s of t.elements){let l=s.payload.id;if(!a.has(l))continue;let d=r?.[l],c=d?.size??Un(s),u={frame:{...d?.frame??s.payload.frame},isHidden:!1,...c!==void 0?{size:c}:{}};i.placements[l]=t.family===void 0?u:ia(u,t.family,n,s.kind),o.push(l)}return o.filter(s=>{let l=e.elements.find(d=>d.payload.id===s);return l!==void 0&&!ye(e,l)})}function ca(e,t){let n=new Map;for(let l of t.elements)n.set(l.payload.id,Y());let i=new Set(e.elements.map(l=>l.payload.id)),a=t.elements.some(l=>i.has(l.payload.id)),r=l=>a?{...l,x:Math.min(.9,l.x+.05),y:Math.min(.9,l.y+.05)}:l,o=[];for(let l of t.elements){let d=structuredClone(l);if(d.payload.id=n.get(l.payload.id),d.kind==="tap"&&d.payload.attachedTo!==void 0){let c=n.get(d.payload.attachedTo);c?d.payload.attachedTo=c:delete d.payload.attachedTo}if(d.kind==="chart"&&d.payload.scaleFrom!==void 0){let c=n.get(d.payload.scaleFrom);c?d.payload.scaleFrom=c:i.has(d.payload.scaleFrom)||delete d.payload.scaleFrom}if(d.kind==="text"&&d.payload.value.kind.kind==="chartStat"){let c=n.get(d.payload.value.kind.layer);if(c)d.payload.value.kind.layer=c;else if(!i.has(d.payload.value.kind.layer))continue}d.payload.frame=r(d.payload.frame),o.push(d)}let s=new Map;for(let l of t.groups){if(o.filter(u=>u.payload.groupId===l.id&&!(u.kind==="tap"&&u.payload.attachedTo!==void 0)).length<2)continue;let c=Y();s.set(l.id,c),(e.groups??=[]).push({...structuredClone(l),id:c})}for(let l of o){if(l.payload.groupId===void 0)continue;let d=s.get(l.payload.groupId);d?l.payload.groupId=d:delete l.payload.groupId}e.elements.push(...o);for(let l of ee){let d=t.placements[l],c=e.perFamily[l];if(!(!d||!c))for(let[u,h]of Object.entries(d)){let f=n.get(u);f&&o.some(g=>g.payload.id===f)&&(c.placements[f]={...structuredClone(h),frame:r(h.frame)})}}return ct(e),Je(e),Kt(e),o.filter(l=>!ye(e,l)).map(l=>l.payload.id)}function jn(e,t){let n=e.elements.find(r=>r.payload.id===t);if(!n)return[];let i=[],a=_n(e,bn(n));if(a){let r=n.kind==="icon"?"symbol":n.kind==="image"?"camera":"value";i.push(a.namedId===void 0?{where:r,ref:a.ref}:{where:r,ref:a.ref,namedId:a.namedId})}for(let r of Me(e,t)){let o=r.payload.action;!("entityId"in o)||o.entityId===""||i.push({where:"tap",ref:{entityId:o.entityId,displayName:o.displayName,domain:o.domain},tapId:r.payload.id})}for(let r of n.payload.rules)for(let o of r.cases)for(let s of o.when.tests){let l=_n(e,s.value);if(!l)continue;let d={where:"test",ref:l.ref,ruleId:r.id,caseId:o.id,testId:s.id};l.namedId!==void 0&&(d.namedId=l.namedId),i.push(d)}return i}function Vi(e,t,n){if(!e)return;let i=e.kind;switch(i.kind){case"entityState":return{...e,kind:{kind:"entityState",...t}};case"entityAge":return{...e,kind:{kind:"entityAge",...t}};case"entityAttribute":return{...e,kind:{kind:"entityAttribute",...t,attribute:i.attribute}};case"literal":return n==="text"||n==="gauge"||n==="chart"||n==="timeline"?{...e,kind:{kind:"entityState",...t}}:void 0;default:return}}function mo(e,t,n,i){let a=e.elements.find(o=>o.payload.id===t);if(!a||n.entityId==="")return;let r={...n,domain:n.domain||n.entityId.split(".")[0]||""};if(a.kind==="timeline"){let o=Vi(a.payload.value,r,a.kind);o&&(a.payload.value=o),a.payload.bands.length===0&&(a.payload.bands=Ji(r.domain,i))}else if(a.kind==="image")a.payload.entity=r;else if(a.kind==="text"||a.kind==="gauge"||a.kind==="chart"){let o=Vi(a.payload.value,r,a.kind);o&&(a.payload.value=o)}else if(a.kind==="icon"){let o=Vi(a.payload.symbol,r,a.kind);o&&(a.payload.symbol=o)}for(let o of Me(e,t)){let s=o.payload;"entityId"in s.action&&(s.action={type:s.action.type,...r})}}var qn={text:["color","opacity","text","fontSize","fontWeight","rotation","visibility"],icon:["color","opacity","icon","fontSize","rotation","visibility"],gauge:["color","opacity","gaugeValue","gaugeMin","gaugeMax","rotation","visibility"],chart:["color","opacity","rotation","visibility"],timeline:["opacity","rotation","visibility"],shape:["color","opacity","borderColor","borderWidth","rotation","visibility"],image:["opacity","rotation","visibility"],tap:["visibility"],layout:["backgroundColor","borderColor","borderWidth","text"]},fo=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","greaterThan","greaterOrEqual","lessThan","lessOrEqual","between","contains","startsWith","endsWith","matchesRegex","isOneOf"];function Et(e){switch(e){case"isOn":case"isOff":case"isUnavailable":case"isStale":case"isEmpty":return"none";case"between":return"between";case"matchesRegex":return"pattern";case"isOneOf":return"options";default:return"value"}}function Yn(e){switch(e){case"hide":case"show":return"none";case"setFontWeight":return"weight";case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":return"number";default:return"value"}}function ua(){return{id:Y(),value:M(""),comparison:{kind:"isOn"}}}function pa(){return{id:Y(),when:{join:"all",tests:[ua()]},then:[]}}function vn(){return{id:Y(),cases:[pa()]}}function ha(e,t){let n={kind:t};switch(Et(t)){case"value":n.value=e.value??M("");break;case"between":n.value=e.value??M(""),n.upper=e.upper??M("");break;case"pattern":n.pattern=e.pattern??"";break;case"options":n.options=e.options??[];break;case"none":break}return n}function Tt(e){let t={kind:e};switch(Yn(e)){case"value":t.value=M(e==="setColor"||e==="setBorderColor"||e==="setBackgroundColor"?"#FF453A":e==="setIcon"?"exclamationmark.triangle":e==="setGaugeValue"?"50":"Text");break;case"number":t.number=e==="setOpacity"?.5:e==="setFontSize"?14:e==="setBorderWidth"?2:e==="setGaugeMax"?100:0;break;case"weight":t.weight="bold";break;case"none":break}return t}function go(e){return e.appliedToken===void 0?{kind:"unsupported"}:e.token===e.appliedToken?{kind:"sent"}:e.pending&&e.polling?{kind:"sending"}:e.polling?{kind:"waiting"}:{kind:"offline"}}function yo(e){switch(e.kind){case"unsupported":return{label:"",title:"",resend:!1};case"sent":return{label:"On watch",title:"The watch has applied every change here.",resend:!1};case"sending":return{label:"Sending\u2026",title:"Waiting for the watch to pull and confirm.",resend:!1};case"waiting":return{label:"Not on watch yet",title:"The watch is connected but has not confirmed the latest change. Resend wakes it again.",resend:!0};case"offline":return{label:"Open the watch app to sync",title:"Saves reach the watch by themselves while Wrist Assistant is open on this home. Open the app, or switch the watch to this home, and it pulls at once.",resend:!0}}}function vo(e){let t=new TextEncoder().encode(e),n=0xcbf29ce484222325n,i=0x100000001b3n,a=0xffffffffffffffffn;for(let r of t)n^=BigInt(r),n=n*i&a;return n.toString(16)}function xo(e){return new Map(e.map(t=>[t.id.toUpperCase(),t.value]))}function bo(e){return e.kind==="entityAttribute"||e.kind==="entityAge"||e.kind==="aggregate"||e.kind==="time"||e.kind==="jinja"}function fa(e,t,n=0){let i=t instanceof Map?t:xo(t),a=e.kind;if(a.kind==="named"){if(n>8)return;let o=i.get(a.id.toUpperCase());return o?o.kind.kind==="named"?fa(o,i,n+1):bo(o.kind)?"n_"+a.id.toLowerCase().replace(/-/g,""):void 0:void 0}if(!bo(a))return;let r=ma(a);if(r!==void 0)return"e_"+vo(r)}function Ae(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function $d(e){let t;if(e.scope.kind==="entities")t=`expand([${e.scope.entities.map(o=>Ae(o.entityId)).join(", ")}])`;else{let{domains:o,areaIds:s,labelIds:l,floorIds:d}=e.scope;if(!(s.length+l.length+d.length>0))t=o.length===0?"[]":"("+o.map(u=>`(states.${u} | list)`).join(" + ")+")";else{let u=[];for(let h of s)u.push(`area_entities(${Ae(h)})`);for(let h of l)u.push(`label_entities(${Ae(h)})`);d.length>0&&u.push(`((${d.map(h=>`floor_areas(${Ae(h)})`).join(" + ")}) | map('area_entities') | sum(start=[]))`),t=`(expand(${u.join(" + ")})`,o.length>0&&(t+=` | selectattr('domain', 'in', [${o.map(Ae).join(", ")}])`),t+=")"}}let n=t,i=e.stateFilter;if(i&&(i.kind==="isOn"?n+=" | selectattr('state', 'eq', 'on')":i.kind==="isOff"?n+=" | selectattr('state', 'eq', 'off')":i.kind==="equals"?n+=` | selectattr('state', 'eq', ${Ae(i.value)})`:n+=` | rejectattr('state', 'eq', ${Ae(i.value)})`),e.function==="count")return`(${n} | list | count)`;let a=e.attribute?`attributes.${e.attribute}`:"state",r=`${n} | map(attribute=${Ae(a)}) | map('float', 0) | list`;switch(e.function){case"sum":return`(${r} | sum)`;case"average":return`(${r} | average(0))`;case"min":return`(${r} | min(default=0))`;case"max":return`(${r} | max(default=0))`}}function ma(e){switch(e.kind){case"entityAttribute":return`state_attr(${Ae(e.entityId)}, ${Ae(e.attribute)})`;case"entityAge":{let t=Ae(e.entityId);return`(((now() - states[${t}].last_changed).total_seconds() if states[${t}] is not none else 0) | round(0))`}case"time":switch(e.timeField){case"now":return"now().strftime('%H:%M')";case"hour":return"now().hour";case"minute":return"now().minute";case"day":return"now().day";case"month":return"now().month";case"weekday":return"now().weekday()";case"timestamp":return"(as_timestamp(now()) | round(0))"}return;case"jinja":return e.value.trim().length===0?void 0:e.value;case"aggregate":return $d(e.aggregate);default:return}}function ga(e){let t=new Map,n=new Map,i=xo(e.values),a=(o,s=0)=>{let l=o.kind;switch(l.kind){case"literal":case"dataAge":case"chartStat":return;case"entityState":t.set(l.entityId,l);return;case"named":{if(s>8)return;let d=i.get(l.id.toUpperCase());if(!d)return;if(d.kind.kind==="named"){a(d,s+1);return}if(d.kind.kind==="entityState"){t.set(d.kind.entityId,d.kind);return}let c=ma(d.kind);if(c===void 0)return;n.set("n_"+l.id.toLowerCase().replace(/-/g,""),c);return}default:{let d=ma(l);if(d===void 0)return;n.set("e_"+vo(d),d)}}};for(let o of e.values)a({kind:{kind:"named",id:o.id}});for(let o of e.elements){let s=bn(o);s&&a(s),o.kind==="gauge"&&o.payload.total&&a(o.payload.total),o.kind==="chart"&&o.payload.nowIndex&&a(o.payload.nowIndex);for(let l of aa(o.payload.rules))a(l)}for(let o of ee){if(!e.supportedFamilies.includes(o))continue;let s=e.perFamily[o];if(s){s.bezelText&&a(s.bezelText),s.curvedText&&a(s.curvedText),s.bezelGauge&&(a(s.bezelGauge.value),s.bezelGauge.minLabel&&a(s.bezelGauge.minLabel),s.bezelGauge.maxLabel&&a(s.bezelGauge.maxLabel));for(let l of aa(s.rules))a(l)}}e.supportedFamilies.includes("inline")&&e.inline&&a(e.inline.value);let r={entities:t,expressions:n};return n.size>0&&(r.document=Cd(n)),r}function Cd(e){let t=[...e.keys()].sort(),n=[];for(let a of t){let r=e.get(a);r.includes("{{")||r.includes("{%")?n.push(`{% set v_${a} %}${r}{% endset %}`):n.push(`{% set v_${a} = ${r} %}`)}let i=t.map(a=>`"${a}": v_${a}`).join(", ");return n.push(`{{ { ${i} } | to_json }}`),n.join(`
`)}function wo(e){let t;try{t=JSON.parse(e)}catch{return}if(typeof t!="object"||t===null||Array.isArray(t))return;let n=new Map,i=new Set;for(let[a,r]of Object.entries(t))r===null?i.add(a):n.set(a,Sd(r));return{values:n,nullKeys:i}}function Sd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function ya(e){let t=ga(e),n=[...t.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return t.document&&n.push({kind:"template",value:t.document}),n}function Ed(e,t){if(e.values.length!==0)switch(t){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((n,i)=>n+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}function Ft(e){let t=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(t))return Number(t);let n=t.toLowerCase();if(n==="inf"||n==="+inf"||n==="infinity"||n==="+infinity")return 1/0;if(n==="-inf"||n==="-infinity")return-1/0;if(n==="nan"||n==="+nan"||n==="-nan")return NaN}function Xe(e){let t=e.trim(),n=Ft(t);if(n!==void 0)return n;let i="";for(let r of t)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Ft(i)}function Td(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Fd(e){let t=Math.max(0,e);return t<60?`${Math.trunc(t)}s`:t<3600?`${Math.trunc(t/60)}m`:t<86400?`${Math.trunc(t/3600)}h`:`${Math.trunc(t/86400)}d`}function Rd(e){let t=e.trim(),n=Ft(t);if(n!==void 0)return n;let i=0,a=t.indexOf(",");if(a>=0){let s=t.slice(0,a).trim().split(" "),l=s.length===2?Ft(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,t=t.slice(a+1).trim()}let r=t.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Ft(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Md(e){let t=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(t/86400),"d"],[Math.trunc(t%86400/3600),"h"],[Math.trunc(t%3600/60),"m"],[t%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Id(e){return e.replace(/\S+/g,t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase())}function Hd(e,t,n){if(Ne(t))return e;let i=t,a=e,r=Ft(e.trim()),o=i.duration?Rd(e):void 0;if(o!==void 0)a=Md(o);else if(i.relativeTime&&r!==void 0)a=Fd(r);else{let s=Xe(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Td(l))}}switch(i.useEntityUnit&&n&&(a+=n.startsWith("\xB0")||n.startsWith("%")?n:` ${n}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Id(a);break}return a}function jt(e){let t=Math.trunc(Math.max(0,e)),n=Math.trunc(t/3600),i=Math.trunc(t%3600/60),a=t%60,r=o=>String(o).padStart(2,"0");return n>0?`${n}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function xn(e,t=240){let n=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&n.push(o)}i=""};for(let o of e){if(n.length>=t)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return n.length<t&&r(),n}function ko(e,t){let n,i;return t.scale==="fixed"?(n=Math.min(t.minValue,t.maxValue),i=Math.max(t.minValue,t.maxValue)):(n=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,t.thresholdValue!==void 0&&Number.isFinite(t.thresholdValue)&&(n=Math.min(n,t.thresholdValue),i=Math.max(i,t.thresholdValue))),t.baseline==="zero"&&(n=Math.min(n,0),i=Math.max(i,0)),i>n||(i=n+1),{min:n,max:i}}function Ad(e,t,n){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(n>t)||i<t||i>n))return(i-t)/(n-t)}function wn(e,t=dt){let n=[];for(let i of e.split(" ")){if(n.length>=t)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||n.push({offsetSeconds:Math.round(r),state:Ld(i.slice(a+1))})}return n}function Ld(e){try{return decodeURIComponent(e)}catch{return e}}function _d(e,t,n){if(e.length===0||!(t>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/t)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/t));if(!(d>s))continue;let c=n(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function $o(e,t,n){if(Number.isNaN(e))return n;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(n,Math.max(t,i))}function zd(e,t,n){if(e===void 0)return 0;let i=Xe(e);if(i===void 0||Number.isNaN(i))return 0;let a=n-t;return a===0?0:Math.min(1,Math.max(0,(i-t)/a))}var Ze=class{constructor(t,n){this.ctx=t;this.charts=new Map;this.named=new Map(t.namedValues.map(i=>[i.id.toUpperCase(),i.value])),n&&this.settleCharts(n)}chartReadings(t){let n=this.chartSeries(t),i=ko(n,t),a={values:n,domainMin:i.min,domainMax:i.max},r=this.chartEntity(t);return r&&(a.entity=r),a}chartSeries(t){let n=kt(t),i=n!==void 0?this.ctx.historySeries?.get(n)??"":this.resolve(t.value)??"",a=xn(i);return t.limit>0&&a.length>t.limit?t.takeFromEnd?a.slice(a.length-t.limit):a.slice(0,t.limit):a}chartEntity(t){let n=this.dereference(t.value);if(!(!n||!("entityId"in n.kind)))return{entityId:n.kind.entityId,displayName:n.kind.displayName,domain:n.kind.domain}}chartNowIndex(t,n){if(t.nowIndex===void 0||n===0)return;let i=this.resolve(t.nowIndex);if(i===void 0)return;let a=Xe(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),n-1)}settleCharts(t){let n=new Map,i=[];for(let s of t.elements)s.kind!=="chart"||n.has(s.payload.id)||(n.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(n.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=n.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,h=u!==void 0&&u!==s&&n.has(u)&&!l.has(u)?o(u,new Set([...l,u])):ko(a.get(s)??[],c);return r.set(s,h),h};for(let s of i){let l=n.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(t){let n=t,i=new Set,a=t.format;for(;n.kind.kind==="named";){let o=n.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ne(a)?a:s.format,n=s}let r={kind:n.kind};return a&&(r.format=a),r}directEntityUnit(t){let n=t.kind;if(n.kind==="entityState"||n.kind==="entityAttribute"||n.kind==="entityAge")return this.ctx.entityStates.get(n.entityId)?.unitOfMeasurement;if(n.kind==="chartStat"){let i=this.charts.get(n.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i;switch(n.kind.kind){case"literal":i=n.kind.value;break;case"entityState":i=this.ctx.entityStates.get(n.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(n.kind.layer.toUpperCase()),r=a?Ed(a,n.kind.stat):void 0;i=a&&r!==void 0?Dr(r,a.domainMax-a.domainMin):void 0;break}default:{let a=fa(t,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Hd(i,n.format,this.directEntityUnit(n))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i=n.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(t)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Ft(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(t){if(!t)return;let n=this.dereference(t);if(!n||n.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(n.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?jt(i.remaining):"Paused":"Idle"}entityIcon(t){let n=this.dereference(t);return!n||n.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(n.kind.entityId)?.iconName??n.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(t){let n=t.comparison;if(n.kind==="isStale")return this.isStale();let i=this.resolve(t.value);if(i===void 0)return n.kind==="isUnavailable";let a=Xe(i),r=()=>this.resolve(n.value),o=()=>{let l=r();return l===void 0?void 0:Xe(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(n.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(n.upper),c=d===void 0?void 0:Xe(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,h]=l<=c?[l,c]:[c,l];return a>=u&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!n.pattern)return!1;try{return new RegExp(n.pattern).test(i)}catch{return!1}}case"isOneOf":return(n.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(t){return t.tests.length===0?!0:t.join==="any"?t.tests.some(n=>this.evaluateTest(n)):t.tests.every(n=>this.evaluateTest(n))}applyRules(t,n){let i=new Map;for(let a of t){let r=n?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ee[s.kind],s)}return i}liveBranches(t){let n=new Map;for(let i of t){let a=i.cases.find(r=>this.evaluateCondition(r.when));n.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return n}styleColor(t,n){let i=t.get(n);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(t,n){let i=t.get(n);return i?this.resolve(i.value):void 0}styleNumber(t,n){return t.get(n)?.number}resolveElement(t,n){let i=t.payload,a=this.applyRules(i.rules,n),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,c={id:i.id,isHidden:o,frame:l,opacity:d};switch(t.kind){case"text":{let u=t.payload.countdown?this.countdownEnd(t.payload.value):void 0,h=t.payload.countdown?this.countdownFallbackText(t.payload.value):void 0,f={kind:"text",...c,text:this.styleText(a,"text")??h??this.resolve(t.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??t.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??t.payload.fontWeight,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex};return u!==void 0&&(f.countdownEnd=u),f}case"icon":{let u=this.entityIcon(t.payload.symbol)??this.resolve(t.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(a,"icon")??u,size:this.styleNumber(a,"fontSize")??t.payload.size,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex}}case"gauge":{let u=t.payload,h=this.styleText(a,"gaugeValue")??this.resolve(u.value),f=this.styleNumber(a,"gaugeMin")??u.minValue,g=this.styleNumber(a,"gaugeMax")??u.maxValue,x=h===void 0?void 0:Xe(h),$=this.styleColor(a,"color")??u.colorSlot.baseColorHex;u.coloring==="bands"&&u.bands.length>0&&x!==void 0&&($=Ui(x,gn(u),u.bandAboveColorHex));let S=g-f;if(u.total){let C=Xe(this.resolve(u.total)??"");C!==void 0&&(S=C)}let E=$o(S,1,zn),v={kind:"gauge",...c,fraction:zd(h,f,g),style:u.style,lineWidth:u.lineWidth,colorHex:$,trackColorHex:u.trackColorHex,thresholdColorHex:u.thresholdColorHex,dotCount:E,filledCount:$o(x??0,0,E)};if(u.thresholdValue!==void 0&&g!==f){let C=(u.thresholdValue-f)/(g-f);C>=0&&C<=1&&(v.thresholdFraction=C)}return v}case"chart":{let u=t.payload,h=this.charts.get(u.id)??this.chartReadings(u),f=h.values,g={min:h.domainMin,max:h.domainMax},x=this.styleColor(a,"color")??u.colorSlot.baseColorHex,$=gn(u),S=Or(u)?f.map(N=>Ui(N,$,u.bandAboveColorHex)):[],E={kind:"chart",...c,values:f,style:u.style,domainMin:g.min,domainMax:g.max,baseline:u.baseline,barGap:u.barGap,lineWidth:u.lineWidth,colorHex:x,highColorHex:u.highColorHex,lowColorHex:u.lowColorHex,marker:u.marker,pointColorHexes:S,fillBands:u.fillBands,thresholdColorHex:u.thresholdColorHex,nowColorHex:u.nowColorHex};if(f.length>0){let N=u.highlight==="highest"||u.highlight==="both",B=u.highlight==="lowest"||u.highlight==="both",j=N?f.indexOf(Math.max(...f)):-1,oe=B?f.indexOf(Math.min(...f)):-1;j>=0&&(E.highIndex=j),oe>=0&&oe!==j&&(E.lowIndex=oe)}let v=Ad(u,g.min,g.max);v!==void 0&&(E.thresholdY=v);let C=this.chartNowIndex(u,f.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let u=t.payload,h=$t(u),f=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=wn(f,dt),x=_d(g,Ke(u)*60,S=>Ur(S,u.bands,u.otherColorHex));return{kind:"timeline",...c,runs:x,gap:u.gap,cornerRadius:u.cornerRadius}}case"shape":{let u={kind:"shape",...c,shapeKind:t.payload.kind,cornerRadius:t.payload.cornerRadius,thickness:t.payload.thickness,fillColorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??t.payload.borderWidth},h=this.styleColor(a,"borderColor")??t.payload.borderColorHex;return h!==void 0&&(u.borderColorHex=h),u}case"image":{let u={kind:"image",...c,entityId:t.payload.entity.entityId,source:t.payload.source,showTimestamp:t.payload.timestamp===!0,contentMode:t.payload.contentMode,zoom:t.payload.zoom,panX:t.payload.panX,panY:t.payload.panY,cornerRadius:t.payload.cornerRadius,timestampCorner:t.payload.timestampCorner,timestampSize:t.payload.timestampSize};We(t.payload)&&(u.timestampX=t.payload.timestampX,u.timestampY=t.payload.timestampY);let h=this.ctx.entityStates.get(t.payload.entity.entityId)?.entityPicture;return h!==void 0&&(u.url=h),u}case"tap":{let u={kind:"tap",...c,frame:t.payload.frame,opacity:1,action:t.payload.action};return t.payload.openPageId!==void 0&&(u.openPageId=t.payload.openPageId),t.payload.attachedTo!==void 0&&(u.attachedTo=t.payload.attachedTo),u}}}resolveLayout(t,n,i){let a=t.perFamily[n];this.settleCharts(t);let r=oo(t,n).map(x=>this.resolveElement(x,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:n,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,$=this.resolve(x.value),S=$===void 0?void 0:Xe($);if(S!==void 0){let E=Math.min(x.minValue,x.maxValue),v=Math.max(x.minValue,x.maxValue),C={value:Math.min(v,Math.max(E,S)),minValue:E,maxValue:v===E?E+1:v,colorHexes:x.colorHexes},N=this.resolve(x.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(x.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(s.backgroundColorHex=f);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Nd(e,t,n){let i=new Ze(t,n),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function ba(e,t,n){let i=new Ze(t),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,n));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Nd(e.inline,t,e)),a}var be=ge,kn=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:be,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=kn.find(e=>e.measured);function Ho(e){if(!e)return;let t=/^(\d+)x(\d+)$/.exec(e.trim());if(!t)return;let n=Number(t[1]),i=Number(t[2]);return kn.find(a=>a.screen.width===n&&a.screen.height===i)}function Xn(e,t){let n=be[t];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/n.width,e.height/n.height),a=n.width*i,r=n.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Pd={regular:400,medium:500,semibold:600,bold:700};function Pe(e){if(!e)return;let t=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(t))return;let n=t.length===8?parseInt(t.slice(6,8),16)/255:1;return{color:`#${t.slice(0,6)}`,opacity:n}}function we(e,t,n="#FFFFFF"){let i=Pe(e)??{color:n,opacity:1};return{[t]:i.color,[`${t}-opacity`]:i.opacity}}function Ao(e,t){let n=Math.max(0,e.frame.width*t.width),i=Math.max(0,e.frame.height*t.height),a=(e.frame.x+e.frame.width/2)*t.width,r=(e.frame.y+e.frame.height/2)*t.height;return{x:a-n/2,y:r-i/2,w:n,h:i,cx:a,cy:r}}function Od(e,t){let n=we(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:jt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>t.w&&t.w>0?Math.max(.5,t.w/a):1,o=e.fontSize*r,s=e.text;if(t.w>0&&s.length*i(o)>t.w){let l=t.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Pd[e.fontWeight]??400}
    fill=${n.fill} fill-opacity=${n["fill-opacity"]}>${s}</text>`}var va=2;function Dd(e,t){let n=we(e.colorHex,"stroke"),i=we(e.trackColorHex,"stroke","#FFFFFF"),a=we(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let f=t.w>=t.h,g=Math.max(1,e.dotCount),x=f?t.w:t.h,$=f?t.h:t.w,S=Math.max(1,Math.min($,x/g-va)),E=g*S+(g-1)*va,v=(f?t.cx:t.cy)-E/2+S/2;return b`${Array.from({length:g},(C,N)=>{let B=v+N*(S+va),j=N<e.filledCount?n:i;return b`<circle cx=${f?B:t.cx} cy=${f?t.cy:B} r=${S/2}
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var Bd=5;function Gd(e,t){let n=e.values,i=Math.max(n.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:Bd,o=e.style==="bars"?0:e.lineWidth/2,s=t.x,l=Math.max(t.w,0),d=t.y+r+o,c=Math.max(t.h-r-o*2,1),u=d+c,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),f=e.baseline==="lowest",g=f?c*.12:0,x=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-x*(i-1))/i,.5),S=v=>Math.min(1,Math.max(0,(v-e.domainMin)/h)),E=v=>u-S(v)*c;return{count:n.length,barWidth:$,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:f?u:E(0),yAtFraction(v){return u-Math.min(Math.max(v,0),1)*c},barRect(v){let C=s+v*($+x),N=n[v],B,j;if(f){let oe=g+S(N)*(c-g);B=u-oe,j=u}else B=E(N),j=f?u:E(0),B>j&&([B,j]=[j,B]);return{x:C,y:B,w:$,h:Math.max(j-B,.5)}},point(v){let C=Math.max(l-o*2,0);return{x:n.length>1?s+o+C*v/(n.length-1):s+l/2,y:E(n[v])}},markerCenter(v,C){let N=C?this.barRect(v):void 0;return{x:N?N.x+N.w/2:this.point(v).x,y:t.y+r/2}}}}function Ud(e,t){if(e.values.length===0)return m;let n=Gd(e,t),i=we(e.colorHex,"fill"),a=we(e.highColorHex,"fill",e.colorHex),r=we(e.lowColorHex,"fill",e.colorHex),o=(c,u)=>b`<circle cx=${c.x} cy=${c.y} r="1.7" fill=${u.fill} fill-opacity=${u["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===n.count,d=c=>l?we(e.pointColorHexes[c],"fill",e.colorHex):i;if(e.style==="bars")for(let c=0;c<n.count;c++){let u=n.barRect(c),h=c===e.highIndex?a:c===e.lowIndex?r:d(c),f=Math.min(1.2,u.w/2,u.h/2);s.push(b`<rect x=${u.x} y=${u.y} width=${u.w} height=${u.h} rx=${f}
        ...
        stroke-width=${e.lineWidth} stroke-linecap="round" stroke-linejoin="round" />`);e.highIndex!==void 0&&s.push(o(c[e.highIndex],a)),e.lowIndex!==void 0&&s.push(o(c[e.lowIndex],r))}if(e.marker!=="none"){let c=e.style==="bars";if(e.highIndex!==void 0){let u=n.markerCenter(e.highIndex,c);s.push(e.marker==="pointer"?b`<path d=${`M${u.x} ${u.y-1.8} L${u.x+2.2} ${u.y+1.8} L${u.x-2.2} ${u.y+1.8} Z`}
            fill=${a.fill} fill-opacity=${a["fill-opacity"]} />`:o(u,a))}e.lowIndex!==void 0&&s.push(o(n.markerCenter(e.lowIndex,c),r))}if(e.thresholdY!==void 0){let c=n.yAtFraction(e.thresholdY),u=we(e.thresholdColorHex,"fill",e.colorHex);s.push(b`<path d=${`M${n.plotLeft} ${c} L${n.plotRight} ${c}`} fill="none"
      stroke=${u.fill} stroke-opacity=${u["fill-opacity"]}
      stroke-width="1" stroke-dasharray="2 2" />`)}if(e.nowIndex!==void 0&&e.nowIndex<n.count){let c=n.markerCenter(e.nowIndex,e.style==="bars").x,u=we(e.nowColorHex,"fill",e.colorHex);s.push(b`<path d=${`M${c} ${n.plotTop} L${c} ${n.plotBottom}`} fill="none"
      stroke=${u.fill} stroke-opacity=${u["fill-opacity"]} stroke-width="1" />`)}return b`${s}`}function Kd(e,t){if(e.runs.length===0||t.w<=0||t.h<=0)return m;let n=Math.max(0,Math.min(e.gap,t.w/Math.max(1,e.runs.length))),i=e.runs.map((a,r)=>{let o=t.x+a.start*t.w,s=(a.end-a.start)*t.w,l=r===e.runs.length-1,d=Math.max(l?s:Math.min(s,.5),s-(l?0:n)),c=Math.max(0,Math.min(e.cornerRadius,d/2,t.h/2)),u=we(a.colorHex,"fill");return b`<rect x=${o} y=${t.y} width=${d} height=${t.h} rx=${c}
      fill=${u.fill} fill-opacity=${u["fill-opacity"]} />`});return b`${i}`}function Wd(e,t){let n=we(e.fillColorHex,"fill"),i=e.borderColorHex?Pe(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(t.w,t.h)/2-r;return b`<circle cx=${t.cx} cy=${t.cy} r=${Math.max(0,l)}
        ...
        fill=${n.fill} fill-opacity=${n["fill-opacity"]} stroke="none" />`}}}function jd(e,t,n){let i=n.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${t.cx-e.size/2} ${t.cy-e.size/2})">${i}</g>`;let a=we(e.colorHex,"stroke"),r=e.size;return b`
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${c}${S}${$}${C}</g>`}function ei(e,t){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:t?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Ea(e,t){return(t?23.5:34)*e}var Co=10.5;function Lo(e,t){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*t}function So(e,t){let n=0;for(let i of e)n+=Lo(i,t);return n}function Eo(e,t,n){let i=e.toUpperCase(),a=d=>Lo(d,n),r=.9*n,o=0;for(let d of i)o+=a(d);if(o<=t)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>t)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function $a(e,t,n){let i=n*Math.PI/180;return{x:e.cx+t*Math.cos(i),y:e.cy+t*Math.sin(i)}}function Ca(e,t,n,i){let a=$a(e,t,n),r=$a(e,t,i);return`M ${a.x} ${a.y} A ${t} ${t} 0 0 1 ${r.x} ${r.y}`}function _o(e,t,n,i){let{dial:a}=ei(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:t,d:Ca(a,n,i.start,i.end),length:n*r}}function ec(e,t){let n=ei(e,!0);return _o(e,t,n.dial.r,n.labelArc)}var To=18.5,tc=113,nc={start:-71,end:-36},Fo=104,ic=6.2,Ro={start:-77,end:-30.5};function Mo(e){let t=e.replace("#",""),n=i=>parseInt(t.slice(i,i+2),16)||0;return[n(0),n(2),n(4)]}function Io(e,t){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let n=Math.min(1,Math.max(0,t))*(e.length-1),i=Math.min(e.length-2,Math.floor(n)),a=n-i,r=Mo(e[i]),o=Mo(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var xa=11;function ac(e,t,n){let{dial:i}=ei(t,!0),a=Fo*t,r=180/(Math.PI*Fo),o=e.minLabel!==void 0?So(e.minLabel,xa)*r:0,s=e.maxLabel!==void 0?So(e.maxLabel,xa)*r:0,l=Ro.start+(o>0?Math.max(0,o-1.8):0),d=Ro.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,h=[];for(let S=0;S<u;S++){let E=l+c*S/u,v=Math.min(d,l+c*(S+1)/u+.4);h.push(b`<path d=${Ca(i,a,E,v)} fill="none"
      stroke=${Io(e.colorHexes,(S+.5)/u)} stroke-width=${ic*t}
      stroke-linecap=${S===0||S===u-1?"round":"butt"} />`)}let f=(e.value-e.minValue)/(e.maxValue-e.minValue),g=$a(i,a,l+c*f),x=1.5,$=(S,E,v,C)=>b`
    <defs><path id=${S} d=${Ca(i,a,E,v)} /></defs>
    <text font-size=${xa*t} font-weight="600" fill="#FFFFFF"
      font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
      <textPath href="#${S}" startOffset="50%" text-anchor="middle">${C}</textPath></text>`;return b`${h}
    <circle cx=${g.x} cy=${g.y} r=${3.2*t} fill=${Io(e.colorHexes,f)}
      stroke="#000000" stroke-width=${1.2*t} />
    ${e.minLabel!==void 0?$(`${n}-gmin`,l-x-Math.max(o,3),l-x,e.minLabel):m}
    ${e.maxLabel!==void 0?$(`${n}-gmax`,d+x,d+x+Math.max(s,3),e.maxLabel):m}`}function Ta(e,t){let n=e.family in be?e.family:"rectangular",i=t.slot??be[n],a=be[n],r=Xn(i,n),o=`clip-${n}-${Math.random().toString(36).slice(2,8)}`,s=Pe(e.backgroundColorHex),l=Pe(e.borderColorHex),d=e.borderWidth*r.scale;if(n==="corner"){let g=r.scale,x=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=ei(g,x),v=Ea(g,x),C=v/(a.width*g),N=E.tile.cx-v/2,B=E.tile.cy-v/2,j=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,oe=m;if(e.bezelGauge)oe=ac(e.bezelGauge,g,o);else if(e.bezelText){let T=ec(g,`${o}-bezel`),V=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?jt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;oe=b`<defs><path id=${T.id} d=${T.d} /></defs>
        <text font-size=${Co*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${T.id}" startOffset="50%" text-anchor="middle">${Eo(V,T.length,Co*g)}</textPath></text>`}let w=m;if(S){let T=Pe(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},V=_o(g,`${o}-curved`,tc*g,nc);w=b`<defs><path id=${V.id} d=${V.d} /></defs>
        <text font-size=${To*g} font-weight="600" fill=${T.color} fill-opacity=${T.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${V.id}" startOffset="50%" text-anchor="middle">${Eo($,V.length,To*g*.88)}</textPath></text>`}else{let T=e.borderWidth*r.scale*C,V=l?b`<circle cx=${v/2} cy=${v/2} r=${v/2-T/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${T} />`:m;w=b`<g transform="translate(${N} ${B})">
        <g clip-path=${`url(#${o})`}>
          ${s?b`<rect width=${v} height=${v} fill=${s.color} fill-opacity=${s.opacity} />`:m}
          <g data-design-box transform="scale(${r.scale*C})">
            ${e.elements.map(P=>ka(P,a,t))}
          </g>
        </g>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${kc(e)}</svg>`}var Oe="color-mix(in srgb, var(--k) 45%, #6b7280)",si='system-ui, -apple-system, "Segoe UI", sans-serif';function cs(e,t,n,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-n*Math.cos(u)).toFixed(2),y:(t-n*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${n} ${n} 0 ${d} 1 ${l.x} ${l.y}`}function za(e,t,n,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${cs(e,t,n,1)} stroke=${Oe} stroke-width="2.6" opacity=".5" />
    <path d=${cs(e,t,n,i)} stroke="var(--k)" stroke-width="2.6" />
    ...
    </div></div>`}function di(e,t,n,i){let a=i.format??(r=>String(Math.round(r*100)/100));return p`<div class="field slider">${tt(e,Zt(t,i.def,n,a))}
    <div class="slider-row">
      <input type="range" min=${i.min} max=${i.max} step=${i.step} .value=${String(t)}
        @input=${ve(r=>{let o=Number(r);Number.isNaN(o)||n(o)})} />
      <span class="slider-value mono">${a(t)}</span>
    </div></div>`}function ci(e,t,n,i,a,r){let o=s=>Math.round(s*1e3)/10;return Z(e,o(t),s=>n((s??0)/100),{min:a,max:r,step:.5,def:o(i)})}function He(e,t,n,i){return p`<label class="field check"><input type="checkbox" .checked=${t} @change=${a=>n(a.target.checked)} />${tt(e,Zt(t,i,n,a=>a?"on":"off"))}</label>`}function re(e,t,n,i=!1,a){let r=(t??"").replace(/^#/,""),o=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(r),s=o?`#${r.slice(0,6)}`:"#ffffff",l=o&&r.length===8?Math.round(parseInt(r.slice(6,8),16)/255*100):100,d=(u,h)=>{let f=u.replace(/^#/,"").toUpperCase();return h>=100?`#${f}`:`#${f}${Math.round(h/100*255).toString(16).padStart(2,"0").toUpperCase()}`},c=a===void 0?void 0:{atDefault:Tc(t,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>n(a??void 0)};return p`<div class="field color">${tt(e,c)}
    <div class="color-row">
      ${i?p`<input type="checkbox" title="Enabled" .checked=${t!==void 0} @change=${u=>n(u.target.checked?d(s,l):void 0)} />`:m}
      <input type="color" .value=${s} ?disabled=${i&&t===void 0} @input=${ve(u=>n(d(u,l)))} />
      <input type="range" min="0" max="100" .value=${String(l)} title="Opacity" ?disabled=${i&&t===void 0} @input=${ve(u=>n(d(s,Number(u))))} />
      <input type="text" class="mono hex" .value=${t??""} placeholder="#RRGGBB" ?disabled=${i&&t===void 0}
        @input=${ve(u=>{let h=u.trim();/^#?[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(h)&&n(h.startsWith("#")?h.toUpperCase():`#${h.toUpperCase()}`)})} />
    </div></div>`}function Tc(e,t){return e===void 0||t===void 0?e===t:e.replace(/^#/,"").toUpperCase()===t.replace(/^#/,"").toUpperCase()}function Ds(e,t){let n=e[t],i=n&&typeof n.attributes.friendly_name=="string"?n.attributes.friendly_name:t;return{entityId:t,displayName:i,domain:t.split(".")[0]??""}}function Fc(e,t,n){let i=t===void 0?void 0:typeof t=="string"?[t]:t,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=n?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function bs(e){let{entities:t,devices:n,areas:i}=e;if(!t||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=t[r];if(o)return a(o.area_id)??a(o.device_id?n?.[o.device_id]?.area_id:void 0)}}var Vs=50;function Rc(e){let t=e.state.trim().split(/\s+/)[0]??"";return t!==""&&Number.isFinite(Number(t))}function Mc(e,t,n=Vs,i){let a=t.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,n);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:c.startsWith(a)?h=2:d.includes(a)?h=3:c.includes(a)?h=4:o.length>1&&o.every(f=>d.includes(f)||c.includes(f))?h=5:u!==""&&(u.includes(a)||o.length>1&&o.every(f=>d.includes(f)||c.includes(f)||u.includes(f)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,n).map(l=>l.c)}var Ic=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Bs(e){return Ic.test(e.trim())}function Hc(e,t,n){let i=e.trim();if(i!==t.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in n)return Ds(n,i);if(Bs(i))return{...t,entityId:i,domain:i.split(".")[0]??""}}}var Ht=new Map;function Ie(e){let t=e instanceof Node?e:null;for(let n=0;t&&n<8;n+=1){let i=t.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}t=a}}function Gs(e){return Ht.has(e)}function et(e,t,n,i,a,r={}){let o=e.hass.states,s=Ht.get(a),l=s?Mc(Fc(o,r.domain,bs(e.hass)),s.query,Vs,r.preferNumeric?Rc:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=n.entityId?o[n.entityId]:void 0,u=(v,C,N=0)=>{Ht.set(a,{query:C,index:N}),Ie(v)},h=v=>{Ht.delete(a),Ie(v)},f=v=>{let C=Hc(v,n,o);C&&i(C)},g=(v,C)=>{i(Ds(o,v.entityId)),h(C)},x=()=>Math.max(0,Math.min(Ht.get(a)?.index??0,l.length-1)),$=v=>{let C=v.target;if(v.key==="ArrowDown"||v.key==="ArrowUp"){v.preventDefault();let N=Ht.get(a);if(!N){u(C,C.value);return}let B=v.key==="ArrowDown"?x()+1:x()-1;u(C,N.query,Math.max(0,Math.min(l.length-1,B))),Ac(C);return}if(v.key==="Enter"){v.preventDefault();let N=l[x()];s&&N?g(N,C):(f(C.value),h(C));return}if(v.key==="Escape"){if(!s)return;v.preventDefault(),v.stopPropagation(),h(C)}},S=n.entityId?bs(e.hass)?.(n.entityId):void 0,E=n.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:c?p`<div class="entity-current">
          <span class="ent-ico ${Da(c.state)?"on":""}">${Oa(n.domain||n.entityId.split(".")[0]||"")}</span>
    ...
    <div class="ent-box ${s?"open":""}">
      ...
      ${(s?s.query:n.entityId)===""?m:p`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${v=>{let C=v.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Ht.set(a,{query:"",index:0}),Ie(C),C?.focus()}}>${z("close")}</button>`}
    </div>
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${Bs(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((v,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                @mousedown=${N=>N.preventDefault()} @click=${N=>g(v,N.target)}>
                <span class="ent-ico ${Da(v.state)?"on":""}">${Oa(v.domain)}</span>
                <span class="ent-main">
                ...
                <span class="ent-right">
                  <span class="ent-type">${ys(v.domain)}</span>
                  <span class="ent-state">${v.state}</span>
                </span>
              </button>`)}
        </div>`:E}
  </div>`}function Ac(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Lc=120;function _c(e,t,n,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(ai.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:t.trim()!==""&&n.length>0?{names:[...n],fromPack:!0}:{names:a(ri),fromPack:!1}}function vs(e,t){return t.size===0?e.length:e.filter(n=>t.has(n)).length}function zc(e){return[{value:"",label:`Starter set (${vs(ri,e)})`},...ai.map(t=>({value:t.name,label:`${t.name} (${vs(t.symbols,e)})`}))]}function Nc(e){return e.length>0?e.length:ri.length}function Pc(e,t,n,i){return n?t>e?`Showing ${e} of ${t}. Type more to narrow it down.`:t===1?"1 symbol matches.":`${t} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function xs(e,t,n,i){let a=e.icons.render(t,22,"#FFFFFF");return p`<button type="button" class="sym ${n?"on":""}" title=${t} @click=${()=>i(t)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${t}</span>
  </button>`}function Us(e,t,n,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),c=t.trim(),u=c!==""&&d.size>0&&!d.has(c),h=g=>{n(g),a.noteUsed(g)},f=m;if(r){let g=a.category(i),x=_c(g,o,l,d),$=qo(x.names,o),S=x.fromPack?$.slice(0,Lc):$,E=d.size===0?a.recent:a.recent.filter(v=>d.has(v));f=p`<div class="sym-browse">
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${o} @input=${ve(v=>a.setQuery(i,v))} />
        <select @change=${ve(v=>a.setCategory(i,v))}>
          ${zc(d).map(v=>p`<option value=${v.value} ?selected=${v.value===g}>${v.label}</option>`)}
        </select>
      </div>
      ${E.length===0?m:p`<div class="hint">Recent</div>
        <div class="sym-grid one-row">${E.map(v=>xs(e,v,v===c,h))}</div>`}
      <div class="sym-grid">${S.map(v=>xs(e,v,v===c,h))}</div>
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${t} placeholder="lightbulb.fill"
        @input=${ve(n)} @change=${ve(g=>{(d.size===0||d.has(g.trim()))&&a.noteUsed(g)})} /></label>
    ...
    ${re("And the rest",e.bandAboveColorHex,i=>n(a=>{a.bandAboveColorHex=i??lt},"babove"),!1,lt)}`}function Wc(e,t){return p`
    ${e.bands.map((n,i)=>p`
      <div class="row-inline">
        ${ce("State",n.match,a=>t(r=>{let o=r.bands[i];o&&(o.match=a)},`tmatch${n.id}`),{placeholder:"on"})}
        ${re("Colour",n.colorHex,a=>t(r=>{let o=r.bands[i];o&&(o.colorHex=a??Ue)},`tcol${n.id}`))}
        <button class="icon" title="Remove this state" aria-label="Remove this state"
          @click=${()=>t(a=>{a.bands=a.bands.filter((r,o)=>o!==i)})}>${z("close")}</button>
      </div>`)}
    <button class="small" @click=${()=>t(n=>{n.bands=[...n.bands,{id:Y(),match:"",colorHex:Ue}]})}>Add state</button>
    ${re("Otherwise",e.otherColorHex,n=>t(i=>{i.otherColorHex=n??Ue},"tother"),!1,Ue)}`}var jc=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],qc={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Cs(e){let t=e.value.kind;if(t.kind==="aggregate"){let{stateFilter:n,...i}=t.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return M(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Yc=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function Jc(e,t){let n="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(t){case"literal":return{kind:t,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:t,...n};case"entityAttribute":return{kind:t,...n,attribute:""};case"entityAge":return{kind:t,...n};case"aggregate":return{kind:t,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:t,timeField:"now"};case"dataAge":return{kind:t};case"jinja":return{kind:t,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:t,id:""};case"chartStat":return{kind:t,layer:"",stat:"latest"}}}function ae(e,t,n,i){if(i.inline||!Xc())return p`<div class="value-editor">${qs(e,t,n,i)}</div>`;let a=Ka(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(t):void 0,s=pe(t,he(e)),l="entityId"in t.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${Ws(e,a,r,t,n,i)}
  </div>`}function Ws(e,t,n,i,a,r){return p`<div class="value-pop" id=${t} popover role="dialog" aria-label=${n} @toggle=${js}>
    <div class="pop-head">
      <b>${n}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${t} popovertargetaction="hide">Done</button>
    </div>
    ${En.has(t)?qs(e,i,a,r):m}
  </div>`}function he(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Ka(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function Xc(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var En=new Set,Sn=new WeakMap;function Zc(e){let t=e.getRootNode();return(t instanceof ShadowRoot||t instanceof Document?t:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Qc(e,t){let n=e instanceof Node?e:null;if(!n)return;let i=n.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(t)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function js(e){let t=e.currentTarget,n=e.newState==="open",i=Sn.get(t);if(i&&(i(),Sn.delete(t)),!n){En.delete(t.id)&&Ie(t);return}let a=Zc(t);if(!a)return;let r=()=>{if(!t.isConnected||!t.matches(":popover-open")){Sn.get(t)?.(),Sn.delete(t);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){t.hidePopover();return}Va(t,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Sn.set(t,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Va(t,a.getBoundingClientRect()),En.has(t.id)||(En.add(t.id),Ie(t),requestAnimationFrame(()=>{t.isConnected&&Va(t,a.getBoundingClientRect())}))}function Va(e,t){e.style.maxHeight="";let n=e.getBoundingClientRect(),i=eu({left:t.left,top:t.top,bottom:t.bottom,width:t.width},{width:n.width,height:n.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var It=8,ui=6,Ss=140;function eu(e,t,n){let i=n.height-e.bottom-ui-It,a=e.top-ui-It,r=t.height>i&&a>i&&i<Ss,o=Math.max(Ss,r?a:i),s=Math.min(t.height,o),l=Math.max(It,Math.min(e.left,n.width-t.width-It)),d=r?Math.max(It,e.top-ui-s):Math.max(It,Math.min(e.bottom+ui,n.height-s-It));return{left:l,top:d,maxHeight:o,above:r}}function qs(e,t,n,i){let a=t.kind,r=c=>n({...t,kind:c}),o=i.key,s=Oc.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=m;switch(a.kind){case"literal":l=i.symbol?Us(e,a.value,c=>r({...a,value:c}),o):ce("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=et(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=p`${et(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${ce("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(h=>p`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=nu(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Te("Field",a.timeField,Yc,c=>r({...a,timeField:c}));break;case"dataAge":l=p`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=p`${Os("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":l=e.config.values.length===0?p`<div class="hint warn">There are no named values yet. Add one in the Data card first.</div>`:Te("Value",a.id,[["","(choose)"],...e.config.values.map(c=>[c.id,c.name||c.id.slice(0,8)])],c=>r({...a,id:c}));break;case"chartStat":{let c=he(e),u=e.config.elements.filter(h=>h.kind==="chart");l=u.length===0?p`<div class="hint warn">There is no chart layer yet. Add one first, then this can print one of its numbers.</div>`:p`
          ${Te("Chart",a.layer,[["","(choose)"],...u.map(h=>[h.payload.id,Fe(h,c)])],h=>r({...a,layer:h}))}
          ${Te("Number",a.stat,[...Ot],h=>r({...a,stat:h}))}
    ...
    ${Te("Source",a.kind,s,c=>r(Jc(a,c)))}
    ${l}
    ${i.noFormat?m:tu(t.format,c=>n(Ne(c)?{kind:t.kind}:{...t,format:c}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:m}`}function tu(e,t){let n=e??{},i=a=>{let r={...n,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];t(r)};return p`<details class="sub" ?open=${!Ne(e)}>
    ...
    <div class="grid2">
      ...
      ${ce("Prefix",n.prefix??"",a=>i({prefix:a}))}
      ${ce("Suffix",n.suffix??"",a=>i({suffix:a}))}
    </div>
  ...
  </details>`}function nu(e,t,n,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=t.scope;return p`
    ...
    ${o.kind==="filter"?p`<div class="grid2">
          ${ce("Domains",a(o.domains),s=>n({...t,scope:{...o,domains:r(s)}}),{placeholder:"light, switch"})}
          ${ce("Area ids",a(o.areaIds),s=>n({...t,scope:{...o,areaIds:r(s)}}))}
          ${ce("Label ids",a(o.labelIds),s=>n({...t,scope:{...o,labelIds:r(s)}}))}
          ${ce("Floor ids",a(o.floorIds),s=>n({...t,scope:{...o,floorIds:r(s)}}))}
    ...
    ${t.stateFilter&&"value"in t.stateFilter?ce("State",t.stateFilter.value,s=>n({...t,stateFilter:{kind:t.stateFilter.kind,value:s}})):m}
    ${t.function==="count"?m:ce("Attribute (blank = state)",t.attribute??"",s=>{let l={...t};s?l.attribute=s:delete l.attribute,n(l)})}`}var Ys=Qi,iu=Ys.filter(([e])=>e!=="none");function au(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Js(e,t){let n=au(t)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=t.type==="callService"?{...t}:{type:"callService",serviceDomain:"",serviceName:""};return n.entityId!==""&&(i.target=n),i}return Wr(e)?{type:e,...n}:{type:e}}var ru=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Xs(e,t,n,i){let a=t.serviceDataJSON??"",r=jr(a),o=t.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
      ${ce("Domain",t.serviceDomain,s=>n({...t,serviceDomain:s.trim()},"svc-domain"),{placeholder:"light"})}
      ${ce("Service",t.serviceName,s=>n({...t,serviceName:s.trim()},"svc-name"),{placeholder:"turn_on"})}
    </div>
    <div class="chips">
      ${ru.map(([s,l,d,c])=>p`
    ...
    ${Os("Data (JSON)",a,s=>{let l={...t};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,n(l,"svc-data")},3)}
    ${r?p`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:p`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function ou(e,t){return e!==void 0&&t.trim()!==""&&t.trim()!==e.trim()}function Zs(e){let t=e.config,n=t.tapAction,i=ou(e.savedName,t.name),a=t.refreshMinutes??0,r=Es.map(s=>[String(s),Ts(s)]);Es.includes(a)||r.push([String(a),Ts(a)]);let o=t.showSuccessFlash??!0;return p`
    <div class="gen-row">
      ${ce("Name",t.name,s=>e.update(l=>{l.name=s},"name"))}
      ${Te("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Te("Tap action",n.type,Ys,s=>e.update(l=>{l.tapAction=Js(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
      <div class="field flash-cell"><span>Flash when a tap works</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(t.successFlashColorHex??su).slice(0,7)}
    ...
    ${n.type==="callService"?Xs(e,n,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):m}
    ${n.type==="openPage"?lu(e):m}`}var su="#808080",Es=[0,15,30,60,120];function Ts(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function lu(e){let t=e.config;return Qs(e,t.openPageId,t.openPageName,(n,i)=>e.update(a=>{if(n===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=n,i?a.openPageName=i:delete a.openPageName}))}function Qs(e,t,n,i){let a=t??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${n||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Te("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?m:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function el(e,t){let n=e.config.values.findIndex(a=>a.id===t.id),i=`nv-${t.id}`;return p`
    ${ce("Name",t.name,a=>e.update(r=>{r.values[n].name=a},`${i}-name`))}
    ${ae(e,t.value,a=>e.update(r=>{r.values[n].value=a},i),{allowNamed:!1,showResolved:!0,inline:!0,key:i})}
    <div class="hint">Used by ${Fs(e.config,t.id)} layer${Fs(e.config,t.id)===1?"":"s"}.</div>`}function Fs(e,t){return JSON.stringify(e.elements).split(`"${t}"`).length-1+JSON.stringify(e.perFamily).split(`"${t}"`).length-1}function tl(){return{id:Y(),name:"Value",value:M("")}}function xe(e,t,n){let i=e.perFamily[t],a=i?.placements[n.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:n.payload.frame,isHidden:n.payload.isHidden,fromPlacement:!1}}function Ce(e,t,n,i,a=!1){let r=e.elements.find(c=>c.payload.id===n);if(!r)return;let o=e.perFamily[t];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[t]=o);let s=xe(e,t,r),d={...o.placements[n]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};if(a&&delete d.size,Object.keys(o.placements).length===0)for(let c of e.elements)c.payload.id!==n&&(o.placements[c.payload.id]={frame:{...c.payload.frame},isHidden:c.payload.isHidden});o.placements[n]=d}function pi(e,t,n,i,a){let r=t.payload.id,o=Un(t)??a.min,s=xe(e.config,n,t).size??o;return Z(`${i} (pt)`,s,l=>e.update(d=>Ce(d,n,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${n}`),{step:a.step,min:a.min,...a.def===void 0?{}:{def:a.def}})}function nl(e,t,n){for(let i of ee)i===n||!e.supportedFamilies.includes(i)||Ce(e,i,t,{isHidden:!0})}function il(e,t,n){let i=e.perFamily[n]??(e.perFamily[n]=Wt()),a={};for(let r of e.elements){let o=xe(e,t,r),s=o.size??Un(r),l={frame:{...o.frame},isHidden:o.isHidden,...s!==void 0?{size:s}:{}};a[r.payload.id]=ia(l,t,n,r.kind)}i.placements=a}function wi(e,t){return e.elements.filter(n=>!xe(e,t,n).isHidden).length}function Rs(e){return e.length===0?"none":e.every(t=>t)?"all":e.every(t=>!t)?"none":"mixed"}function du(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"?void 0:e.payload.colorSlot.baseColorHex}function al(e,t,n){let i=Rs(n.map(d=>xe(e,t,d).isHidden)),a=Rs(n.map(d=>d.payload.isHidden)),r=n.map(du),o=n.length>0&&r.every(d=>d!==void 0),s=r[0],l=o&&s!==void 0&&r.every(d=>d!==void 0&&d.toUpperCase()===s.toUpperCase());return{hiddenHere:i,hiddenEverywhere:a,colourable:o,colour:l?s:void 0}}var Wa=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]];function cu(e,t,n){let i=t.payload.id,a=jn(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=t.kind==="image"&&t.payload.source==="camera",s=o?{domain:"camera"}:{},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return p`
    ${et(e,o?"Camera":"Entity",r,d=>e.update(c=>mo(c,i,d,l(d.entityId)),`${n}-entity`),`${n}-layer-entity`,s)}
    <div class="hint">${hu(t,a)}</div>`}function uu(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function pu(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function hu(e,t){let n=uu(e),i=n?.kind.kind,r=n!==void 0&&!("entityId"in n.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a named value, so change that value in the Data card to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(t.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=t.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),t.some(d=>d.where==="tap")&&o.push("the tap");let l=t.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${pu(o)}.${r}`}function mu(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function fu(e,t){let n=e.timestamp===!0,i=We(e),a=r=>t(o=>{r?(o.timestampX=o.timestampCorner.endsWith("Leading")?.16:.84,o.timestampY=o.timestampCorner.startsWith("top")?.16:.84):(We(o)&&(o.timestampCorner=Xi(o.timestampX,o.timestampY)),delete o.timestampX,delete o.timestampY)});return p`
    ...
    ${n?p`
      ...
      ${Z("Text size (pt)",e.timestampSize,r=>t(o=>{o.timestampSize=Math.min(40,Math.max(4,r??Ut))},"tssize"),{step:1,min:4,max:40,def:Ut})}
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:m}`}function yi(e,t){if(e===t)return!0;if(typeof e!=typeof t||e===null||t===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(t))return!1;if(Array.isArray(e))return e.length===t.length&&e.every((a,r)=>yi(a,t[r]));let n=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(t).filter(a=>t[a]!==void 0);return n.length!==i.length?!1:n.every(a=>yi(e[a],t[a]))}function Ms(e,t,n){return n.some(i=>!yi(e[i],t[i]))}function Is(e,t,n){let i=e,a=t;for(let r of n)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function ke(e,t,n,i,a={}){let r=e.openSections.has(t),o=()=>e.toggleSection(t);return p`<section class="sec" data-open=${r?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
    <div class="sec-h" role="button" tabindex="0" aria-expanded=${r?"true":"false"} @click=${o}
      ...
      <span class="tt"><h4>${n}${Ps(a.reset===void 0?void 0:{atDefault:!1,title:a.resetTitle??`Put ${n} back to its defaults`,reset:a.reset})}</h4>${a.summary?p`<span class="sum">${a.summary}</span>`:m}</span>
      <span class="chev">${z("chevron")}</span>
    </div>
    ${r?p`<div class="sec-b">${i}</div>`:m}
  </section>`}function gu(e){if(e.length===0)return"nothing";let t=n=>Number.isInteger(n)?String(n):String(Math.round(n*100)/100);return e.length<=12?e.map(t).join(" "):`${e.slice(0,6).map(t).join(" ")} \u2026 ${e.slice(-3).map(t).join(" ")}`}function yu(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let t=Math.round(e/60);if(t<90)return`${t}m`;let n=Math.floor(t/60),i=t%60;return i===0?`${n}h`:`${n}h ${i}m`}function bu(e,t,n=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??t,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-n),r=a.map(o=>`${o.state||"(blank)"} ${yu(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function bi(e){let t=Nn.find(o=>o.minutes===e);if(t)return t.label;let n=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return n>0&&r.push(`${n}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var gi=new Set;function Ba(e,t){return gi.has(e)||!Nn.some(n=>n.minutes===t)}function Hs(e,t,n,i){let a=Ba(e,t);return p`<label class="field">${tt("Span",{atDefault:t===n&&!a,title:`Back to ${bi(n)}`,reset:()=>{gi.delete(e),i(n)}})}
      ...
      </select></label>`}function As(e,t){let n=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=(o,s,l)=>t(Math.min(Ki,Math.max(1,Math.round(o)*1440+Math.round(s)*60+Math.round(l))));return p`<div class="grid3 span-parts">
    ...
    <div class="hint">${bi(e)}, up to 7 days: the recorder keeps
      ten by default, and a longer span would quietly come back short.</div>`}function ja(e,t){let n=he(e);switch(t.kind){case"text":return pt(pe(t.payload.value,n),48);case"icon":return pt(pe(t.payload.symbol,n),48);case"gauge":return pt(pe(t.payload.value,n),48);case"chart":return pt(`${pe(t.payload.value,n)}${t.payload.historyMinutes>0?` \xB7 ${bi(t.payload.historyMinutes)}`:""}`,48);case"timeline":return pt(`${pe(t.payload.value,n)} \xB7 ${bi(Ke(t.payload))}`,48);case"shape":return t.payload.kind==="roundedRectangle"?"Rounded rectangle":t.payload.kind;case"image":return t.payload.entity.displayName||t.payload.entity.entityId||(t.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return je(t.payload.action)}}function vi(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${$e(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${$e(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let t=e.payload,n=t.style==="dots"?`${t.bands.length>0&&t.coloring==="bands"?"banded":$e(t.colorSlot.baseColorHex)} dots`:`${t.lineWidth} pt line \xB7 ${t.coloring==="bands"&&t.bands.length>0?`${t.bands.length+1} colour bands`:$e(t.colorSlot.baseColorHex)}`;return`${t.style} \xB7 ${n}${t.thresholdValue===void 0?"":` \xB7 threshold ${t.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${Ks.find(([t])=>t===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let t=e.payload;return`${t.bands.length===0?`one colour (${$e(t.otherColorHex)})`:`${t.bands.length} ${t.bands.length===1?"state":"states"} coloured`}${t.gap>0?` \xB7 ${t.gap} pt gap`:""} \xB7 corners ${t.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${$e(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${$e(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function rl(e,t,n){let i=t.payload.id,a=e.config.elements.findIndex(y=>y.payload.id===i),r=`el-${i}`,o=(y,k)=>e.update(q=>y(q.elements[a]),k?`${r}-${k}`:void 0),s=xe(e.config,n,t),l=s.frame,d=(y,k)=>e.update(q=>Ce(q,n,i,{frame:ps(l,y)}),`${r}-${k}-${n}`),c=ze(t.kind).payload,u=c.colorSlot?.baseColorHex??"#FFFFFF",h=y=>c[y],f,g;switch(t.kind){case"text":{let y=ea(e.config,t.payload.value);f=p`
        ${ae(e,t.payload.value,k=>o(q=>{q.payload.value=k},"value"),{showResolved:!0,label:"Text",key:`${r}-value`})}
        ${y?p`<div class="hint">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(y.payload.id)}>${Fe(y,he(e))}</button>. It stays in the chart's group and moves with it.</div>`:m}
        ...
        ${t.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,g=p`<div class="grid2">
          ...
          ${te("Weight",t.payload.fontWeight,Wa,k=>o(q=>{q.payload.fontWeight=k}),{def:c.fontWeight})}
        ...
        ${q?p`
            ${ae(e,y.total??Cs(y),G=>k(H=>{H.total=G},"total"),{showResolved:!0,label:"Total",key:`${r}-total`})}
        ...
        <div class="grid2">
          ${te("Style",y.style,jc,G=>k(H=>{G==="dots"&&H.total===void 0&&(H.total=Cs(H)),G!=="dots"&&delete H.total,H.style=G}),{titles:qc,def:c.style})}
          ${q?m:pi(e,t,n,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        ${re(q?"Empty dot colour":"Track colour",y.trackColorHex,G=>k(H=>{H.trackColorHex=G??"#FFFFFF40"},"track"),!1,c.trackColorHex)}
        ${te("Colour",y.coloring,ws,G=>k(H=>{H.coloring=G,G==="bands"&&H.bands.length===0&&(H.bands=ks([H.minValue,H.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${$s(y,y.colorSlot.baseColorHex,k)}`:m}
        ${q?m:p`
          <div class="grid2">
            ${Z("Threshold",y.thresholdValue,G=>k(H=>{G===void 0?delete H.thresholdValue:H.thresholdValue=G},"thr"),{optional:!0})}
            ${y.thresholdValue===void 0?m:re("Threshold colour",y.thresholdColorHex,G=>k(H=>{H.thresholdColorHex=G??Dt},"thrcol"),!1,Dt)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=t.payload,k=(R,A)=>o(Ei=>R(Ei.payload),A),q=kt(y),G=c.historyMinutes,H=c.historyPoints,D=y.historyMinutes>0,O=y.value.kind.kind==="entityState",le=q===void 0?void 0:e.historySeries(q),en=D&&O?le??"":e.resolve(y.value)??"",ne=y.historyPoints<1,Se=Ba(i,y.historyMinutes),Re=xn(en),yt=y.limit>0&&Re.length>y.limit?y.takeFromEnd?Re.slice(Re.length-y.limit):Re.slice(0,y.limit):Re,Il=!D&&O&&Re.length===1,Ci=e.config.elements.filter(R=>R.kind==="chart"&&R.payload.id!==i),Hl=he(e),Si=y.scaleFrom!==void 0&&Ci.some(R=>R.payload.id===y.scaleFrom);f=p`
        ${ae(e,y.value,R=>k(A=>{A.value=R},"value"),{label:"Readings",key:`${r}-value`})}
        ${te("Draw",D?"history":"value",[["history","Recorded history"],["value","The value itself"]],R=>k(A=>{A.historyMinutes=R==="history"?A.historyMinutes||Pn:0}),{titles:{history:"Read the entity's past from the recorder and plot it",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${D?p`
            ...
            <div class="grid2">
              ${Hs(i,y.historyMinutes,G,R=>k(A=>{A.historyMinutes=R}))}
                ...
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Readings">
                    <button type="button" role="radio" aria-checked=${ne?"false":"true"} class=${ne?"":"on"}
                      ...
                      @click=${()=>{ne&&k(R=>{R.historyPoints=24})}}>Average</button>
                    <button type="button" role="radio" aria-checked=${ne?"true":"false"} class=${ne?"on":""}
                      title="Plot every recorded state change, no averaging"
                      @click=${()=>{ne||k(R=>{R.historyPoints=ji})}}>Every one</button>
                  </div>
                  ${ne?m:p`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    step="1" min=${Wi} max=${On}
                    @input=${ve(R=>{let A=Number(R);R.trim()!==""&&Number.isFinite(A)&&A>=1&&k(Ei=>{Ei.historyPoints=Math.round(A)},"hpoints")})} />`}
                </div>
              </div>
            </div>
            ${Se?As(y.historyMinutes,R=>k(A=>{A.historyMinutes=R},"span")):m}
            ...
            ${O&&le===void 0?p`<div class="hint">Reading the history…</div>`:m}
            ${O&&le===""?p`<div class="hint warn">Nothing recorded for this entity in that span.
        ...
        ${Re.length===0&&!(D&&(!O||le===void 0||le===""))?p`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:m}
        ${Re.length>0?p`<div class="hint">Reads <span class="nums">${gu(yt)}</span>${Re.length===yt.length?p` · ${yt.length} ${yt.length===1?"value":"values"}`:p` · ${yt.length} of ${Re.length}`}</div>`:m}
        ${Il?p`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        <div class="grid2">
          ...
          ${te("From",y.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],R=>k(A=>{A.takeFromEnd=R==="end"}),{def:c.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        <div class="grid2">
          ${te("Style",y.style,Dc,R=>k(A=>{A.style=R}),{def:c.style})}
        ...
        <div class="grid2">
          ${te("Scale",y.scale,Vc,R=>k(A=>{A.scale=R}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${te("Baseline",y.baseline,Bc,R=>k(A=>{A.baseline=R}),{def:c.baseline})}
        </div>
        ${Ci.length===0?m:Te("Same scale as",Si?y.scaleFrom:"",[["","Its own"],...Ci.map(R=>[R.payload.id,Fe(R,Hl)])],R=>k(A=>{R?A.scaleFrom=R:delete A.scaleFrom}),{def:""})}
        ${Si?p`<div class="hint">This chart is drawn against that one's range, so the two read as one
        ...
        ${!Si&&y.scale==="fixed"?p`<div class="grid2">
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let R;e.update(A=>{R=po(A,i)}),R&&e.selectLayer(R)}}>
          ${z("plus")}<span>Second series</span></button>
        ${te("Colour",y.coloring,ws,R=>k(A=>{A.coloring=R,R==="bands"&&A.bands.length===0&&(A.bands=ks(yt))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${$s(y,y.colorSlot.baseColorHex,k)}
        ...
        <div class="grid2">
          ${te("Highlight",y.highlight,Ks,R=>k(A=>{A.highlight=R}),{def:c.highlight})}
          ${y.highlight==="none"?m:te("Marker",y.marker,Gc,R=>k(A=>{A.marker=R}),{def:c.marker})}
        </div>
        ${y.highlight==="none"?m:p`
          <div class="grid2">
            ${y.highlight==="lowest"?m:re("Highest colour",y.highColorHex,R=>k(A=>{A.highColorHex=R??mn},"hicol"),!1,mn)}
            ${y.highlight==="highest"?m:re("Lowest colour",y.lowColorHex,R=>k(A=>{A.lowColorHex=R??fn},"locol"),!1,fn)}
          </div>
        ...
        ${He("Threshold line",y.thresholdValue!==void 0,R=>k(A=>{R?A.thresholdValue=Uc(yt):delete A.thresholdValue}))}
        ${y.thresholdValue===void 0?m:p`
          <div class="grid2">
            ${Z("At",y.thresholdValue,R=>k(A=>{A.thresholdValue=R??0},"thval"))}
            ${re("Line colour",y.thresholdColorHex,R=>k(A=>{A.thresholdColorHex=R??Vt},"thcol"),!1,Vt)}
          </div>
        ...
        ${y.nowIndex===void 0?m:p`
          ...
          ${re("Marker colour",y.nowColorHex,R=>k(A=>{A.nowColorHex=R??Bt},"nowcol"),!1,Bt)}
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=t.payload,k=(ne,Se)=>o(Re=>ne(Re.payload),Se),q=c.historyMinutes,G=y.value.kind.kind==="entityState",H=$t(y),D=H===void 0?void 0:e.historySeries(H),O=Ke(y)*60,le=wn(D??"",dt),en=Ba(i,y.historyMinutes);f=p`
        ${ae(e,y.value,ne=>k(Se=>{Se.value=ne},"value"),{label:"States",key:`${r}-value`})}
        ...
        ${Hs(i,y.historyMinutes,q,ne=>k(Se=>{Se.historyMinutes=ne}))}
        ${en?As(y.historyMinutes,ne=>k(Se=>{Se.historyMinutes=ne},"span")):m}
        ...
        ${le.length>0?p`<div class="hint">Reads <span class="nums">${bu(le,O)}</span></div>`:m}`,g=p`
        ...
        ${Wc(y,k)}
        <div class="grid2">
          ${Z("Gap (pt)",y.gap,ne=>k(Se=>{Se.gap=Math.min(Vn,Math.max(0,ne??0))},"tgap"),{step:.5,min:0,max:Vn,def:c.gap})}
          ${Z("Corner radius (pt)",y.cornerRadius,ne=>k(Se=>{Se.cornerRadius=Math.max(0,ne??0)},"tradius"),{step:.5,min:0,def:c.cornerRadius})}
        </div>
        ...
        ${t.payload.kind==="line"?p`<div class="hint">A line runs along the frame's long side. Make the frame taller than it is wide, or rotate it in Place, for a divider standing up.</div>`:m}`,g=t.payload.kind==="line"?Z("Thickness (pt)",t.payload.thickness,y=>o(k=>{k.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        ${t.payload.borderColorHex!==void 0?Z("Border width (pt)",t.payload.borderWidth,y=>o(k=>{k.payload.borderWidth=y??1},"bw"),{step:.5,min:0,def:c.borderWidth}):m}`;break;case"image":{let y=t.payload,k=(D,O)=>o(le=>D(le.payload),O),q=y.entity.entityId?e.hass.states[y.entity.entityId]?.attributes?.entity_picture:void 0,G=typeof q=="string"?q:void 0,H=G!==void 0&&!G.startsWith("/");f=p`
        ...
        ${di("Zoom",y.zoom,D=>k(O=>{O.zoom=D},"zoom"),{min:Sa,max:4,step:.05,def:1,format:D=>`${D.toFixed(2)}x`})}
        ...
        <div class="hint">${mu(y)}</div>
        ${Z("Corner radius (pt)",y.cornerRadius,D=>k(O=>{O.cornerRadius=Math.max(0,D??Gt)},"imgradius"),{step:1,min:0,def:Gt})}`;break}case"tap":{f=p`
        ${ol(e,t.payload,(y,k)=>o(q=>y(q.payload),k),r)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let x=t.kind==="image"||t.kind==="tap"||t.kind==="timeline"?void 0:re(t.kind==="shape"?"Fill colour":"Colour",t.payload.colorSlot.baseColorHex,y=>o(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,u),$=oa(e.config,t),S=$?{kind:{kind:"entityState",...$}}:void 0,E=ue[t.kind],v=t.kind==="tap"?void 0:Me(e.config,i)[0],C=t.kind==="image"?t.payload.timestamp===!0:!1,N=xu[t.kind],B=wu[t.kind],j=Ms(t.payload,c,N),oe=t.kind==="text"?"fontSize":t.kind==="icon"?"size":t.kind==="gauge"||t.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[n]?.placements[i]?.size!==void 0,T=Ms(t.payload,c,B)||oe!==void 0&&s.size!==void 0&&s.size!==c[oe],V=!yi(l,Ge)||s.isHidden,P=Ct(e.config,i),se=(y,k)=>()=>o(q=>Is(q.payload,c,y),k);return p`
    ${ke(e,"content","Content",p`${t.kind==="tap"?m:cu(e,t,r)}${f}`,{color:E,icon:"content",summary:ja(e,t),...j?{reset:se(N,"reset-content")}:{}})}
    ${g===void 0&&x===void 0?m:ke(e,"look",t.kind==="image"?"Picture":"Look",p`${g??m}${x??m}`,{color:E,icon:t.kind==="image"?"image":"look",...vi(t)?{summary:vi(t)}:{},...T?{reset:()=>e.update(y=>{Is(y.elements[a].payload,c,B),w&&Ce(y,n,i,{},!0)})}:{}})}
    ${t.kind==="chart"?ke(e,"numbers","Numbers",Su(e,t),{color:ue.text,icon:"text",summary:Cu(e,t),...P.length>0?{reset:()=>e.update(y=>{for(let k of Ct(y,i))St(y,k.payload.id)})}:{}}):m}
    ${t.kind==="image"?ke(e,"timestamp","Timestamp",fu(t.payload,(y,k)=>o(q=>y(q.payload),k)),{color:E,icon:"clock",summary:C?`Shown \xB7 ${t.payload.timestampSize} pt`:"Hidden",...C?{reset:se(vu,"reset-stamp")}:{}}):m}
    ${t.kind==="tap"?m:ke(e,"tappable","Tap",Eu(e,t,r),{color:Q.tap,icon:"tap",summary:v?je(v.payload.action):"Not tappable",...v?{reset:()=>e.update(y=>Wn(y,i))}:{}})}
    ${ke(e,"states","States",hl(e,t.payload.rules,t.kind,y=>y.elements.find(k=>k.payload.id===i)?.payload.rules,`rules-${i}`,S),{color:Q.states,icon:"states",summary:Cn(t.payload.rules).replace(/\.$/,""),...t.payload.rules.length>0?{reset:()=>o(y=>{y.payload.rules=[]})}:{}})}
    ${ke(e,"placement","Place",p`
      <div class="grid4">
      ...
      <div class="hint">Everything about where this layer sits, how big it is drawn and whether it
        ...
        the same layer differently there.</div>`,{color:Q.place,icon:"place",summary:`${Math.round(l.width*100)}% wide \xB7 ${J(n)}${s.fromPlacement?"":" \xB7 shared frame"}`,...V?{resetTitle:`Put this layer back to the middle of the ${J(n)} face at half size, unrotated and shown`,reset:()=>e.update(y=>Ce(y,n,i,{frame:{...Ge},isHidden:!1}))}:{}})}`}var vu=["timestamp","timestampCorner","timestampSize"],xu={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},wu={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function ol(e,t,n,i){let a=t.action;return p`
    ${Te("Tap action",a.type,iu,r=>n(o=>{o.action=Js(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?et(e,"Target",a,r=>n(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):m}
    ${a.type==="callService"?Xs(e,a,(r,o)=>n(s=>{s.action=r},o),`${i}-tap`):m}
    ${a.type==="openPage"?Qs(e,t.openPageId,t.openPageName,(r,o)=>n(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):m}`}var ku=24;function $u(e,t){let n=[],i=1/0;for(let r of ee){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=co(e.config,t,r);o&&(n.push(`${J(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(n.length===0)return m;let a=i<ku;return p`<div class=${a?"hint warn":"hint"}>${n.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Cu(e,t){let n=Ct(e.config,t.payload.id);return n.length===0?"None yet":n.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Ot.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Su(e,t){let n=he(e),i=Ct(e.config,t.payload.id),a=o=>e.update(s=>{no(s,t.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
          ...
          ${i.map(o=>p`
            <div class="num-row">
              <button class="small" title="Edit this number" @click=${()=>e.selectLayer(o.payload.id)}>
                <b>${e.resolve(o.payload.value)??"--"}</b> · <span class="ent-tok">${Fe(o,n)}</span>
              </button>
              <button class="icon danger" title="Delete this number" aria-label="Delete this number"
                @click=${()=>e.update(s=>St(s,o.payload.id))}>${z("close")}</button>
            </div>`)}
        </div>
    ...
    <div class="hint">The newest reading starts with the entity's unit after it. The ends of the scale come from the plot's range, so on a Fixed scale they print the Min and Max above.</div>`}function Eu(e,t,n){if(t.kind==="tap")return m;let i=t.payload.id,a=Me(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${n}-${l}`:void 0),o=sa(e.config,t);return p`
    ${He("Tappable",a!==void 0,s=>e.update(l=>{s?Kn(l,i):Wn(l,i)}))}
    ${a?p`<div class="value-editor">
          ${ol(e,a.payload,r,`${n}-attached`)}
          <div class="chips">
            ...
            ${Bn(a.payload.outset)?m:p`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                  @click=${()=>r(s=>{s.outset={...Zi}})}>${z("reset")}</button>`}
          </div>
        </div>
        ${$u(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${je(o)}</b>.</div>`}`}function Ls(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Fe(e,t){switch(e.kind){case"text":return Ls(pe(e.payload.value,t));case"icon":return Ls(pe(e.payload.symbol,t));case"gauge":return pe(e.payload.value,t);case"chart":return pe(e.payload.value,t);case"timeline":return pe(e.payload.value,t);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let n=e.payload.entity;return n.displayName||n.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let n=e.payload.action,i="entityId"in n?n.displayName||n.entityId:n.type==="callService"?[n.serviceDomain,n.serviceName].filter(a=>a!=="").join("."):n.type==="openPage"&&e.payload.openPageName||"";return i?`${n.type} \xB7 ${i}`:n.type}}}function sl(e,t){let n=Ye(e.config,t.id),i=he(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===t.id);l&&r(l)},o?`group-${t.id}-${o}`:void 0);return ke(e,"content","Group",p`
    ${ce("Name",t.name,r=>a(o=>{o.name=r},"name"))}
    ...
    <div class="hint">${n.length} layer${n.length===1?"":"s"}: ${n.map(r=>Fe(r,i)).join(", ")}. Click one in the list to edit it.</div>
    <div class="adders">
      <button class="small" title="Keep the layers where they are and drop the folder" @click=${()=>e.update(r=>yn(r,t.id))}>Ungroup</button>
    </div>`,{color:Q.group,icon:"folder",summary:`${n.length} layers \xB7 ${t.locked?"moves as one":"unlocked"}`})}function ll(e,t){if(t==="inline")return Tu(e);let n=e.config.perFamily[t];if(!n)return p`<div class="hint">No settings stored for ${J(t)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[t]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${J(t)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[t]),l?`fam-${t}-${l}`:void 0),a=wi(e.config,t),r=n.backgroundColorHex?$e(n.backgroundColorHex):"transparent",o=n.borderColorHex?`${n.borderWidth} pt ${$e(n.borderColorHex)} border`:"no border";return p`
    ${ke(e,"look",`${J(t)} shape`,p`
    ...
    ${t==="corner"?ke(e,"corner","Corner content",Fu(e,n,i),{color:Q.place,icon:"content",summary:n.curvedText?"Big curved text":"Layer canvas",...n.curvedText!==void 0||n.bezelText!==void 0||n.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):m}
    ${ke(e,"states","Shape states",hl(e,n.rules,"layout",s=>s.perFamily[t]?.rules,`rules-${t}`),{color:Q.states,icon:"states",summary:Cn(n.rules).replace(/\.$/,""),...n.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ${ke(e,"placements","Placements",p`
      <div class="hint">${a===0?`Nothing is on the ${J(t)} shape. The Layers card offers to copy another shape's whole arrangement onto it.`:`${a} layer${a===1?" is":"s are"} on the ${J(t)} shape, each with its own frame and size here.`}</div>`,{color:Q.place,icon:"place",summary:a===0?"Nothing placed":`${a} layer${a===1?"":"s"} placed`})}`}function Tu(e){let t=e.config.inline;if(!t)return p`<div class="hint">This complication lists Inline but has no Inline text yet (it was saved by an older integration). The watch shows "No inline layout" until one is added.</div>
      <button class="small" @click=${()=>e.addFamily("inline")}>Add Inline text</button>`;let n=(a,r)=>e.update(o=>{o.inline&&a(o.inline)},r?`inline-${r}`:void 0),i=he(e);return p`
    ${ke(e,"content","Inline text",p`
      ${ce("Label (blank = value only)",t.label??"",a=>n(r=>{a?r.label=a:delete r.label},"label"))}
      ...
      ${t.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,{color:ue.text,icon:"text",summary:pt(`${t.label?`${t.label}: `:""}${pe(t.value,i)}`,48)})}
    ${ke(e,"symbol","Symbol",p`
      ${Us(e,t.symbol??"",a=>n(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${t.symbol?`${t.symbol} `:""}${t.label?`${t.label}: `:""}${e.resolve(t.value)??"--"}</div>`,{color:ue.icon,icon:"icon",summary:t.symbol||"None"})}`}function Fu(e,t,n){let i=t.curvedText?"curved":"canvas",a=t.bezelGauge?"gauge":t.bezelText?"text":"none";return p`
    ${te("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>n(o=>{r==="curved"?o.curvedText||(o.curvedText=M("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:m}
    ${te("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>n(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=M("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:M("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    ${a==="gauge"&&t.bezelGauge?Ru(e,t.bezelGauge,n):m}`}function Ru(e,t,n){let i=[t.colorHexes[0]??"#34C759",t.colorHexes[1]??t.colorHexes[t.colorHexes.length-1]??"#FFCC00",t.colorHexes[t.colorHexes.length-1]??"#FF3B30"],a=r=>o=>n(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${t.maxLabel?ae(e,t.maxLabel,r=>n(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):m}`}var bm=ee.map(e=>[e,J(e)]),qa={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Mu=Object.keys(qa);function Iu(e){let t=qn[e];return Mu.filter(n=>t.includes(Ee[n]))}var Hu={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function hi(e,t){if(e.entityId==="")return"(no entity)";let n=e.displayName.trim();if(n!==""&&n!==e.entityId)return n;let i=t?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function pt(e,t){let n=e.replace(/\s+/g," ").trim();return n.length>t?`${n.slice(0,t-1)}\u2026`:n}function Au(e){if(!e||Ne(e))return"";let t=[];return e.decimals!==void 0&&t.push(`${e.decimals} dp`),e.multiply!==void 0&&t.push(`\xD7${e.multiply}`),e.offset!==void 0&&t.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&t.push(`"${e.prefix}" first`),e.suffix&&t.push(`"${e.suffix}" after`),e.useEntityUnit&&t.push("with unit"),e.relativeTime&&t.push("as relative time"),e.duration&&t.push("as a duration"),e.textCase&&t.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),t.length===0?"":` (${t.join(", ")})`}function pe(e,t){return`${dl(e,t)}${Au(e.format)}`}function dl(e,t){let n=e.kind;switch(n.kind){case"literal":return n.value?`"${pt(n.value,40)}"`:"(empty)";case"entityState":return hi(n,t);case"entityAttribute":return n.attribute?`${hi(n,t)} \xB7 ${n.attribute}`:hi(n,t);case"entityAge":return`age of ${hi(n,t)}`;case"aggregate":return Lu(n.aggregate);case"time":return Hu[n.timeField];case"dataAge":return"data age";case"jinja":return n.value?`template ${pt(n.value,32)}`:"template (empty)";case"named":return n.id===""?"(no value chosen)":t?.values?.find(a=>a.id===n.id)?.name?.trim()||`named ${n.id.slice(0,8)}`;case"chartStat":{let i=(Ot.find(([o])=>o===n.stat)?.[1]??n.stat).toLowerCase();if(n.layer==="")return`${i} (no chart chosen)`;let a=t?.elements?.find(o=>o.kind==="chart"&&o.payload.id===n.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?dl(a.payload.value,t):"a missing chart";return`${i} of ${r}`}}}function Lu(e){let t=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${t}`}function xi(e,t,n){if(n<0||n>=e.length)return;let[i]=e.splice(t,1);e.splice(n,0,i)}function _u(e,t,n,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${t.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${n==="layout"?"family":"layer"} looks.</div>`:m}
    ${t.map((o,s)=>zu(e,o,s,t.length,n,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(vn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function zu(e,t,n,i,a,r,o){let s=e.liveBranch(t),l=e.forced.get(t.id)??"live",d=u=>l==="live"?u==="live":l==="otherwise"?u==="otherwise":l.caseId===u,c=(u,h)=>r(f=>{let g=f.find(x=>x.id===t.id);g&&u(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${n+1}</b>
      <span class="spacer"></span>
    ...
    ${t.cases.map((u,h)=>Nu(e,u,h,t,a,c,`${o}-${u.id}`))}
    <div class="adders"><button class="small" @click=${()=>c(u=>{u.cases.push(pa())})}>+ case</button></div>
    ...
    ${t.otherwise?p`<div class="case-box otherwise">
          ...
          ${cl(e,t.otherwise,a,u=>c(h=>{h.otherwise&&u(h.otherwise)}),`${o}-otherwise`)}
        </div>`:m}
  </div>`}function Nu(e,t,n,i,a,r,o){let s=(d,c)=>r(u=>{let h=u.cases.find(f=>f.id===t.id);h&&d(h)},c),l=e.liveBranch(i)===t.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
    ...
    ${t.when.tests.map((d,c)=>Pu(e,d,c,u=>s(h=>{let f=h.when.tests.find(g=>g.id===d.id);f&&u(f)}),()=>s(u=>{u.when.tests=u.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    <div class="adders"><button class="small" @click=${()=>s(d=>{d.when.tests.push(ua())})}>+ test</button></div>
    <div class="hint" style="margin-top:8px">Then:</div>
    ${cl(e,t.then,a,d=>s(c=>d(c.then)),`${o}-then`)}
  </div>`}function Pu(e,t,n,i,a,r){let o=(u,h)=>i(u,h?`${r}-${h}`:void 0),s=t.comparison,l=Et(s.kind),d=e.evaluateTest(t),c=m;switch(l){case"value":c=ae(e,s.value??M(""),u=>o(h=>{h.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=p`${ae(e,s.value??M(""),u=>o(h=>{h.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${ae(e,s.upper??M(""),u=>o(h=>{h.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=p`${ce("Pattern",s.pattern??"",u=>o(h=>{h.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!Ou(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:m}`;break;case"options":c=ce("Options (comma separated)",(s.options??[]).join(", "),u=>o(h=>{h.comparison.options=u.split(",").map(f=>f.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${Te("Comparison",s.kind,fo.map(u=>[u,Jt[u]]),u=>o(h=>{h.comparison=ha(h.comparison,u)}))}
    ${c}
  </div>`}function Ou(e){try{return new RegExp(e),!0}catch{return!1}}function cl(e,t,n,i,a){let r=Iu(n);return p`
    ${t.length===0?p`<div class="hint">No changes.</div>`:m}
    ${t.map((o,s)=>Du(e,o,s,n,(l,d)=>i(c=>{c[s]&&l(c[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Tt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${qa[o]}</option>`)}
    </select>`}var ul=["setColor","setBorderColor","setBackgroundColor"];function Du(e,t,n,i,a,r,o){let s=!qn[i].includes(Ee[t.kind]);return p`<div class="change-box">
    <div class="rule-head">
      <span>${qa[t.kind]}${s?p` <span class="no">(ignored by ${i==="layout"?"layouts":`${i} layers`})</span>`:m}</span>
      <span class="spacer"></span>
      <button class="icon danger" title="Delete change" @click=${r}>${z("delete")}</button>
    </div>
    ${pl(e,t,a,o)}
  </div>`}function pl(e,t,n,i){let a=Yn(t.kind),r=m;if(a==="value"){let o=t.value??M("");if(ul.includes(t.kind)){let s=o.kind.kind==="literal";r=p`${s?re("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>n(d=>{d.value=M(l??"#FFFFFF")},"color")):ae(e,o,l=>n(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!o.ok} title=${o.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${l=>{Ga.delete(a),Ie(l.target)}}>Show as table</button>
        ${o.ok?m:p`<span class="hint">${o.reason}</span>`}
      </div>
      ${_u(e,t,n,i,a)}`:Vu(e,o.table,t[0],n,i,a,r)}function Vu(e,t,n,i,a,r,o){let s=(w,T)=>e.update(V=>{let P=a(V);P&&w(P)},T?`${r}-${T}`:void 0),l=t.value??_s.get(r)??o,d=t.rows.length===0,c=t.numberMode||d&&l!==void 0&&!ds(l)&&Bu(e.resolve(l)),u=qn[i],h=mi.get(r)??new Set,f=t.columns.length===0&&h.size===0?[ls[i]]:[],g=Qo(t.columns,[...h,...f.filter(w=>w!==void 0)],u),x=n?e.liveBranch(n):"none",$=n?e.forced.get(n.id)??"live":"live",S=w=>$!=="live"&&($==="otherwise"?w==="otherwise":$.caseId===w),E=w=>{n&&e.setForced(n.id,S(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},v=w=>{_s.set(r,w),t.rows.length!==0&&s(T=>rs(T,w),"lhs")},C=()=>s(w=>is(w,l??M(""),c)),N=t.rows.map((w,T)=>Ns(e,{key:`${r}-${w.caseId}`,label:ss(w.comparison,V=>pe(V,he(e))),columns:g,changes:w.changes,live:x===w.caseId,forced:S(w.caseId),onForce:()=>E(w.caseId),when:ju(e,w.comparison,`${r}-${w.caseId}`,(V,P)=>s(se=>{let y=se[0]?.cases.find(k=>k.id===w.caseId)?.when.tests[0];y&&V(y.comparison)},P&&`${w.caseId}-${P}`)),updChanges:(V,P)=>s(se=>{let y=se[0]?.cases.find(k=>k.id===w.caseId);y&&V(y.then)},P&&`${w.caseId}-${P}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${T===0} @click=${()=>s(V=>La(V,T,T-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${T===t.rows.length-1} @click=${()=>s(V=>La(V,T,T+1))}>${z("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>s(V=>as(V,w.caseId))}>${z("delete")}</button>`})),B=t.otherwise===void 0?m:Ns(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:t.otherwise,live:x==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,T)=>s(V=>{let P=V[0]?.otherwise;P&&w(P)},T),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>_a(w,!1))}>${z("close")}</button>`}),j=fi.get(r),oe=Gu.filter(w=>u.includes(w)&&!g.includes(w));return p`
    <div class="states">
      ...
      ${j===void 0?m:p`<div class="hint warn confirm-row">
        Remove the ${Qe[j]} column? Its ${zs(t,j)} value${zs(t,j)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${w=>{fi.delete(r),mi.get(r)?.delete(j),Ie(w.target),s(T=>os(T,j))}}>Remove</button>
      ...
      <div class="states-foot">
        ...
        ${t.otherwise===void 0?p`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>s(w=>_a(w,!0))}>+ otherwise</button>`:m}
        <span class="spacer"></span>
        ${$==="live"?m:p`<button class="small" @click=${()=>n&&e.setForced(n.id,"live")}>Back to live</button>`}
        ${oe.length===0?m:p`<select class="chip-add" title="Add a column" @change=${w=>{let T=w.target,V=T.value;if(T.value="",!V)return;let P=mi.get(r)??new Set;P.add(V),mi.set(r,P),Ie(T)}}>
          <option value="" selected>+ column…</option>
          ${oe.map(w=>p`<option value=${w}>${Qe[w]}</option>`)}
        </select>`}
      </div>
      ...
      <div class="states-switch">
        <button class="link" @click=${w=>{Ga.add(r),Ie(w.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function Bu(e){let t=(e??"").trim();return t!==""&&Number.isFinite(Number(t))}var Gu=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function zs(e,t){let n=0;for(let i of e.rows)oi(i.changes,t)&&(n+=1);return e.otherwise&&oi(e.otherwise,t)&&(n+=1),n}function Uu(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Ns(e,t){return p`<tr class="state-row ${t.live?"live":""} ${t.forced?"forced":""}"
    title=${`${t.label}. Click to hold the previews on this state.`}
    @click=${n=>{Uu(n)||t.onForce()}}>
    <td class="when">
    ...
    ${t.columns.map(n=>p`<td>${Ku(e,n,t.changes,t.updChanges,`${t.key}-${n}`)}</td>`)}
    <td class="acts">${t.acts}</td>
  </tr>`}function Ku(e,t,n,i,a){let r=oi(n,t),o=Ka(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${Qe[t]} for this state`}
      @click=${d=>{i(c=>{c.push(Tt(Zo[t]))}),Qc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let h=u.find(f=>Ee[f.kind]===t);h&&d(h)},c&&`${t}-${c}`),l=Qe[t];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Wu(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${js}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${En.has(o)?p`${t==="visibility"?te("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):pl(e,r,s,a)}
          <button class="link" @click=${d=>{d.target.closest("[popover]")?.hidePopover(),i(c=>{let u=c.findIndex(h=>Ee[h.kind]===t);u>=0&&c.splice(u,1)})}}>Leave ${l.toLowerCase()} unchanged</button>`:m}
    </div>`}function Wu(e,t){if(t.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(t.kind==="show")return p`<span class="cell-word">Shown</span>`;let n=Yn(t.kind);if(n==="number")return p`<span class="cell-word mono">${t.number??0}</span>`;if(n==="weight")return p`<span class="cell-word">${Wa.find(([r])=>r===(t.weight??"regular"))?.[1]}</span>`;let i=t.value??M(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(ul.includes(t.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?$e(a):pe(i,he(e))}</span>`;if(t.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??m}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${pe(i,he(e))}</span>`}function $e(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function ju(e,t,n,i){let a=Et(t.kind),r=Ha(t.kind),o=(s,l,d,c)=>Yu(e,s,l,`${n}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ve(s=>i(l=>{let d=ha(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Ia.map(s=>p`<option value=${s} ?selected=${s===t.kind}>${qu(s)}</option>`)}
    </select>
  ...
  </span>`}function qu(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return Jt[e]}}function Yu(e,t,n,i,a,r,o){let s=Ka(i),l={showResolved:!0,label:o,key:i};if(t.kind.kind!=="literal")return p`<span class="rhs">
    ...
    <input class="cellin ${a?"num":""}" type=${a?"number":"text"} .value=${d} placeholder=${r}
      @input=${ve(c=>n({...t,kind:{kind:"literal",value:c}}))} />
    <button type="button" class="icon more" popovertarget=${s} title="Compare with an entity or a template instead">…</button>
    ${Ws(e,s,o,t,n,l)}
  </span>`}var Tn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:ra,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function yl(e){return Tn.find(t=>t.kind===e)??Tn[0]}var ml="#FF9F0A",ki="#8E8E93",Ju=["#FF453A","#FFD60A","#34C759"],bl=["#0A84FF","#34C759","#FF9F0A"];function Xu(e){return e?.attributes?.device_class==="battery"?Ju:bl}var Zu={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Qu(e){let t=e.iconName?.trim();return t?{off:t,on:t}:Zu[Ya(e)]??{off:"circle",on:"circle.fill"}}function ep(e){switch(Ya(e)){case"lock":return{kind:"equals",value:M("locked")};case"cover":case"valve":return{kind:"equals",value:M("open")};case"media_player":return{kind:"equals",value:M("playing")};default:return{kind:"isOn"}}}function Ya(e){return e.domain||e.entityId.split(".")[0]||""}function ft(e){return{...e,domain:Ya(e)}}function tp(e){let t=e?.attributes??{},n=t.min,i=t.max;if(typeof n=="number"&&typeof i=="number"&&i>n)return{min:n,max:i};let a=typeof t.device_class=="string"?t.device_class:"",r=typeof t.unit_of_measurement=="string"?t.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Qt(e){return Math.round(e*1e4)/1e4}function Lt(e,t,n){return Math.min(n,Math.max(t,e))}function Ja(e,t,n){let i=be[e],a=Lt(Qt(t/i.width),0,1),r=Lt(Qt(n/i.height),0,1);return{x:Qt((1-a)/2),y:Qt((1-r)/2),width:a,height:r,rotationDegrees:0}}function np(e){let t=be[e],n=Lt(Math.round(Math.min(t.width,t.height)*.55),12,30);return{frame:Ja(e,n*1.3,n*1.3),size:n}}function ip(e){let t=be[e],n=Lt(Math.round(Math.min(t.width,t.height)*.3),9,20);return{frame:Ja(e,t.width*.88,n*1.7),size:n}}function ap(e){let t=be[e],n=Math.min(t.width,t.height)*.9;return{frame:Ja(e,n,n),size:Math.max(2.5,Math.round(n*.2)/2)}}function vl(e){let t=e==="rectangular";return{frame:{x:.05,y:t?.34:.3,width:.9,height:t?.42:.4,rotationDegrees:0},size:2}}function rp(e){let t=be[e],n=Lt(Math.round(t.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Qt(n/t.height),rotationDegrees:0}}}function op(e){let t=be[e],n=Lt(Math.round(Math.min(t.width,t.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Qt(Lt(n*1.5/t.height,0,1)),rotationDegrees:0},size:n}}function sp(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function lp(e,t){t!==void 0&&(e.kind==="text"?e.payload.fontSize=t:e.kind==="icon"?e.payload.size=t:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=t))}function ht(e,t,n,i){let a=i(n);t.payload.frame=a.frame,lp(t,a.size);for(let r of ee){if(r===n||r==="inline")continue;let o=e.perFamily[r];if(!o)continue;let s=i(r);JSON.stringify(s)!==JSON.stringify(a)&&(o.placements[t.payload.id]={frame:s.frame,isHidden:!1,...s.size!==void 0?{size:s.size}:{}})}}function mt(e){return ze(e)}function Xa(e,t){let n={kind:{kind:"entityState",...ft(e)}},i=t?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(n.format={useEntityUnit:!0}),n}function fl(e){let t=Tt("setIcon");return t.value=M(e),t}function At(e){let t=Tt("setColor");return t.value=M(e),t}function dp(e,t){let n=vn(),i=n.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...ft(e)}},a.comparison=ep(e);let r=t.on!==t.off;return i.then=r?[fl(t.on),At(ml)]:[At(ml)],n.otherwise=r?[fl(t.off),At(ki)]:[At(ki)],n}function cp(e){let t=vn(),n=t.cases[0],i=n.when.tests[0];i.value={kind:{kind:"entityState",...ft(e)}},i.comparison={kind:"isUnavailable"};let a=Tt("setOpacity");return a.number=.35,n.then=[a],t}function gl(e){let t=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(t)}function up(e,t,n=bl){let i=t.max-t.min,a=gl(t.min+i/3),r=gl(t.min+i*2/3),o=[{comparison:{kind:"lessThan",value:M(a)},changes:[At(n[0])]},{comparison:{kind:"between",value:M(a),upper:M(r)},changes:[At(n[1])]},{comparison:{kind:"greaterThan",value:M(r)},changes:[At(n[2])]}];return es(Xa(e),o)}function pp(e,t,n){let i=mt("icon"),a=Qu(t);return i.payload.symbol=M(a.off),i.payload.colorSlot.baseColorHex=ki,i.payload.rules=[dp(t,a)],ht(e,i,n.family,np),e.elements.push(i),Kn(e,i.payload.id,{type:"toggleEntity",...ft(t)}),i.payload.id}function hp(e,t,n){let i=mt("text");return i.payload.value=Xa(t,n.state),i.payload.rules=[cp(t)],ht(e,i,n.family,ip),e.elements.push(i),i.payload.id}function mp(e,t,n){let i=mt("gauge");i.payload.value=Xa(t);let a=tp(n.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[up(t,a,Xu(n.state))],ht(e,i,n.family,ap),e.elements.push(i),i.payload.id}function fp(e,t,n){let i=mt("chart");return i.payload.value={kind:{kind:"entityState",...ft(t)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",ht(e,i,n.family,vl),e.elements.push(i),i.payload.id}function gp(e,t,n){let i=mt("chart");return i.payload.value={kind:{kind:"entityState",...ft(t)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",ht(e,i,n.family,vl),e.elements.push(i),i.payload.id}function yp(e,t,n){let i=ft(t),a=mt("text");a.payload.value=M(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=ki,ht(e,a,n.family,op),e.elements.push(a);let r=n.state?.attributes?.device_class,o=mt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Ji(i.domain,typeof r=="string"?r:void 0),ht(e,o,n.family,rp),e.elements.push(o),o.payload.id}function bp(e,t,n){let i=mt("image");return i.payload.entity=ft(t),ht(e,i,n.family,sp),e.elements.push(i),i.payload.id}function xl(e,t,n,i){switch(t){case"toggle":return pp(e,n,i);case"status":return hp(e,n,i);case"gauge":return mp(e,n,i);case"chart":return fp(e,n,i);case"history":return gp(e,n,i);case"doorHistory":return yp(e,n,i);case"camera":return bp(e,n,i)}}var xp=3e4,wp=500,wl="preset-entity",kp={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Za(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function $p(e){return e.kind==="family"?"look":"content"}function Cp(e){let t=e.document?.supportedFamilies;return Array.isArray(t)?t.filter(n=>typeof n=="string"):[]}var kl=300,$l=400,Cl=52,Sl=36,Sp=[1,1.7,2.6],Ep=["S","M","L"],El=["Small","Medium","Large"],Tl="wrist-assistant-panel.layers.v1",nt=34,_t=200,Tp=720,$i=320,Fp=80,Rp=56,Fl="wrist-assistant-panel.columns.v2",Qa=e=>Math.max(_t,Math.min(Tp,Math.round(e))),Rl=e=>e.metaKey||e.ctrlKey||e.shiftKey,Mp=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Fn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",De=Fn==="Cmd"?"\u2318":"Ctrl+",er=Fn==="Cmd"?"\u21E7":"Shift+";function Ml(e,t,n){if(e<=0)return{columns:3,left:t,right:n};let i=e-Fp;if(i>=_t*2+$i){let r=i-$i,o=t,s=n;if(o+s>r){let l=r/(o+s);o=Math.max(_t,Math.floor(o*l)),s=Math.max(_t,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(_t,o-d):s=Math.max(_t,s-d))}return{columns:3,left:o,right:s}}let a=e-Rp;return a>=_t+$i?{columns:2,left:Math.min(t,a-$i),right:n}:{columns:1,left:t,right:n}}var I=class I extends at{constructor(){super(...arguments);this.narrow=!1;this.colLeft=kl;this.colRight=$l;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.previewCase=$n.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Wo(()=>this.requestUpdate());this.imageSizes=jo(()=>this.requestUpdate());this.symbols=new ii(()=>this.requestUpdate());this.keyHandler=n=>this.onKey(n);this.heldArrows=new Set;this.keyUpHandler=n=>{this.heldArrows.delete(n.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.sizeObserver=new ResizeObserver(n=>{let i=n[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=n=>{this.draft?.dirty&&n.preventDefault()};this.pickerOutside=n=>{n.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.presetKeys={handleEvent:n=>{n.key==="Enter"&&(this.presetEntity===void 0||Gs(wl)||(n.preventDefault(),n.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Fi`
    :host {
      ...
      --wa-text: ${me(ue.text)};
      --wa-icon: ${me(ue.icon)};
      --wa-gauge: ${me(ue.gauge)};
      --wa-shape: ${me(ue.shape)};
      --wa-image: ${me(ue.image)};
      --wa-tap: ${me(ue.tap)};
    ...
    * { box-sizing: border-box; }
    ...
    .layers { display: flex; flex-direction: column; gap: 6px; --thumb-w: ${Cl}px; --thumb-h: ${Sl}px; }
    ...
    .layer.held {
      border-color: color-mix(in srgb, ${me(Q.group)} 70%, var(--wa-line));
      background: color-mix(in srgb, ${me(Q.group)} 10%, var(--wa-panel));
    }
    .layer.held .thumb { border-color: color-mix(in srgb, ${me(Q.group)} 60%, var(--wa-line)); }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let n=window.localStorage.getItem(Fl);if(!n)return;let i=JSON.parse(n);typeof i.left=="number"&&(this.colLeft=Qa(i.left)),typeof i.right=="number"&&(this.colRight=Qa(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Fl,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let n=window.localStorage.getItem(Tl);if(!n)return;let i=JSON.parse(n);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Tl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(n){return p`<div class="gutter ${n}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>il(s,o,i))}>Copy the ${J(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(n){this.mutate(i=>Oo(i,n)),this.activeFamily=n,this.inspect={kind:"family"}}removeShape(n){let i=this.draft?.config;if(!i||!ti(i,n))return;let a=Vo(i,n);a.length>0&&!window.confirm(`Remove the ${J(n)} layout? This drops ${a.join(", ")}.`)||(this.mutate(r=>Do(r,n)),this.ensureActiveFamily())}createNew(n){this.newShapeChooser=!1,this.startNew(ro("New complication",this.freeSlot(),[n]))}setForced(n,i){let a=new Map(this.forced);i==="live"?a.delete(n):a.set(n,i),this.forced=a}async save(n=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!n&&!this.draft.dirty)){if(!n&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(n){let o=this.freeSlot();if(o<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let s=structuredClone(i.config);s.id=Y(),s.slotIndex=o,i=new Mt(s,null)}let a=i.encoded(),r=await kr(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id,this.draft=Mt.fromDocument(r.record.document,r.record.revision),this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=gt(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let n=await $r(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!n.ok){n.error==="conflict"?this.conflict={current:n.current??null,message:n.message??"This complication changed on the server."}:this.saveError=n.message??n.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(n){this.saveError=gt(n)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let n=structuredClone(this.draft.config);n.id=Y(),n.name=`${n.name} copy`,n.slotIndex=this.freeSlot(),this.startNew(n)}reloadFromServer(){let n=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,n&&!n.deleted?this.openRecord(n):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(n=>n.owner_watch_id===this.ownerId)}async moveAll(){let n=this.ownerId,i=this.moveTarget;if(!(!n||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await Cr(this.hass,n,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=gt(a)}finally{this.moving=!1}}}scheduleTemplates(n){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},n),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},xp)}async refreshHistorySeries(){let n=this.draft?.config,i=n?qi(n):[];if(i.length===0){this.historySeries.size>0&&(this.historySeries=new Map);return}let a={};for(let r of i)a[r.key]={entity_id:r.entityId,minutes:r.minutes,points:r.points,...r.mode==="states"?{mode:"states"}:{}};try{let r=await Tr(this.hass,a),o=new Map;for(let[s,l]of Object.entries(r))l.ok&&o.set(s,l.series);this.historySeries=o}catch{}}async refreshTemplates(){this.refreshHistorySeries();let n=this.compiled?.document;if(!n){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await Er(this.hass,{doc:n})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=wo(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=gt(i)}}buildContext(){let n=new Map;for(let i of this.compiled?.entities.keys()??[]){let a=this.hass.states[i];if(!a)continue;let r=a.attributes,o=i.split(".")[0]??"",s={entityId:i,state:this.testValues.get(i)??a.state,unitOfMeasurement:typeof r.unit_of_measurement=="string"?r.unit_of_measurement:void 0,iconName:this.compiled?.entities.get(i)?.iconName??"",domain:o};if(o==="timer"){s.timerState=a.state,typeof r.finishes_at=="string"&&(s.finishesAt=r.finishes_at);let l=Ip(r.remaining);l!==void 0&&(s.remaining=l)}typeof r.entity_picture=="string"&&(s.entityPicture=r.entity_picture),n.set(i,s)}return{entityStates:n,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:this.draft?.config.values??[],dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3}}renderPickButton(){let n=this.picking,i=!this.draft||this.parseError!==void 0;return p`<button class="pick ${n?"on":""}" ?disabled=${i}
    ...
    </dialog>`}setShowTaps(n){this.showTaps=n,n&&this.togglePicking(!1)}togglePicking(n=!this.picking){this.picking=n,this.pickHoverId=void 0,n&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(n){let i=this.draft?.config;if(!i)return;let r=n.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?la(i,r):void 0}leaveRow(n){this.listHoverIds.length===n.length&&this.listHoverIds.every((a,r)=>n[r]===a)&&(this.listHoverIds=[])}onPickMove(n){this.picking&&(this.pickHoverId=this.hitLayerId(n))}pickAt(n,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(n!==this.activeFamily&&(this.activeFamily=n),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(n,i){if(this.picking){i.preventDefault(),this.pickAt(n,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let S=this.focusTapId();if(S!==void 0&&o===S&&s&&this.draft&&this.canEdit){if(n!==this.activeFamily){this.activeFamily=n;return}i.preventDefault(),this.beginTapBoxGesture(n,i,s,S,r??void 0);return}let E=this.hitLayerId(i);E?this.inspect={kind:"layer",id:E}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(n!==this.activeFamily){this.activeFamily=n;return}let c=Rl(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=la(this.draft.config,o),h=this.draft.config.elements.find(S=>S.payload.id===u);if(!u||!h)return;if(c){i.preventDefault(),this.togglePick(u);return}let f=qe(this.draft.config,u),g=f!==void 0&&this.inspect.kind==="group"&&this.inspect.id===f.id;if(f&&(f.locked||g)&&!r&&!d){this.beginGroupGesture(n,i,s,f);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let x=xe(this.draft.config,n,h).frame,$=this.gestureCanvas(n);if(d&&h.kind==="image"&&h.payload.timestamp===!0){this.timestampActiveId=u;let S=h.payload,E=ge[n],v=x.width*E.width,C=x.height*E.height,N={x:0,y:0,w:v,h:C,cx:v/2,cy:C/2},B=Qn(S,N,Zn(new Date));if(this.cancelGesture?.(),l){let T=$.width/E.width,V=S.timestampSize;this.cancelGesture=gs(s,i,l,{w:B.w*T,h:B.h*T},(P,se)=>{let y=Math.min(40,Math.max(4,Math.round(V*P)));this.mutate(k=>{let q=k.elements.find(G=>G.payload.id===u);q?.kind==="image"&&(q.payload.timestampSize=y)},`ts-size-${u}`),se&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let j={x:0,y:0,w:x.width*$.width,h:x.height*$.height},oe=We(S)?{x:S.timestampX,y:S.timestampY}:{x:(B.x+B.w/2)/N.w,y:(B.y+B.h/2)/N.h},w=!1;this.cancelGesture=fs(s,j,i,oe,(T,V,P)=>{P||(w=!0),w&&this.mutate(se=>{let y=se.elements.find(k=>k.payload.id===u);y?.kind==="image"&&(y.payload.timestampX=T,y.payload.timestampY=V)},`ts-${u}`),P&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=li(s,$,i,{elementId:u,frame:x,handle:r??void 0},{onFrame:(S,E,v)=>{this.mutate(C=>Ce(C,n,S,{frame:E}),`drag-${S}-${n}`),v&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(n,i,a,r){let o=this.draft?.config;if(!o)return;let s=Ye(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map($=>[$.payload.id,xe(o,n,$).frame])),d=[...l.values()],c=Math.min(...d.map($=>$.x)),u=Math.min(...d.map($=>$.y)),h=Math.max(...d.map($=>$.x+$.width)),f=Math.max(...d.map($=>$.y+$.height)),g={x:c,y:u,width:h-c,height:f-u,rotationDegrees:0},x=$=>Math.round($*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=li(a,this.gestureCanvas(n),i,{elementId:r.id,frame:g},{onFrame:($,S,E)=>{let v=S.x-g.x,C=S.y-g.y;this.mutate(N=>{for(let[B,j]of l)Ce(N,n,B,{frame:{...j,x:x(j.x+v),y:x(j.y+C)}})},`drag-group-${r.id}-${n}`),E&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(n,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?hs:1,s=n*o,l=i*o,d=this.canvasFamily,c=ge[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let $=this.inspect.id;return this.nudgeMany(Ye(r,$).map(S=>S.payload.id),d,c,`nudge-group-${$}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,h=r.elements.find($=>$.payload.id===u);if(!h)return!1;let f=qe(r,u);if(f?.locked)return this.nudgeMany(Ye(r,f.id).map($=>$.payload.id),d,c,`nudge-group-${f.id}-${d}`,s,l);let g=xe(r,d,h).frame,x=Pa(g,s,l,c);return(x.x!==g.x||x.y!==g.y)&&this.mutate($=>Ce($,d,u,{frame:x}),`nudge-${u}-${d}`),!0}nudgeMany(n,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,c=new Map;for(let C of n){let N=l.elements.find(B=>B.payload.id===C);N&&c.set(C,xe(l,i,N).frame)}if(c.size===0)return!1;let u=[...c.values()],h=Math.min(...u.map(C=>C.x)),f=Math.min(...u.map(C=>C.y)),g=Math.max(...u.map(C=>C.x+C.width)),x=Math.max(...u.map(C=>C.y+C.height)),$={x:h,y:f,width:g-h,height:x-f,rotationDegrees:0},S=Pa($,o,s,a),E=S.x-$.x,v=S.y-$.y;return(E!==0||v!==0)&&this.mutate(C=>{for(let[N,B]of c)Ce(C,i,N,{frame:{...B,x:d(B.x+E),y:d(B.y+v)}})},r),!0}nudgeTimestamp(n,i,a,r){let o=this.draft?.config,s=o?.elements.find($=>$.payload.id===n);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=ge[i],c=xe(o,i,s).frame,u=c.width*d.width,h=c.height*d.height,f=Qn(l,{x:0,y:0,w:u,h,cx:u/2,cy:h/2},Zn(new Date)),g=We(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(f.x+f.w/2)/u:.5,y:h>0?(f.y+f.h/2)/h:.5},x=ms(g,a,r,{w:u,h});return(x.x!==g.x||x.y!==g.y)&&this.mutate($=>{let S=$.elements.find(E=>E.payload.id===n);S?.kind==="image"&&(S.payload.timestampX=x.x,S.payload.timestampY=x.y)},`nudge-ts-${n}`),!0}gestureCanvas(n){let i=Xn(this.previewSlot(n),n);if(n!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Ea(i.scale,r);return{width:o,height:o}}focusTapId(){let n=this.draft?.config;if(!n||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=n.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Me(n,i)[0]?.payload.id}beginTapBoxGesture(n,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ye(s,l),c=xe(s,n,l).frame;this.cancelGesture?.(),this.cancelGesture=li(a,this.gestureCanvas(n),i,{elementId:r,frame:c,handle:o},{onFrame:(u,h,f)=>{this.mutate(g=>{d?lo(g,u,n,h):Ce(g,n,u,{frame:h})},`tap-box-${u}-${n}`),f&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let n=this.draft,i=!!n?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Ml(this.panelWidth,this.colLeft,this.colRight);return p`
      <header>
        ...
        <label>Watch
          <select @change=${r=>{this.selectOwner(r.target.value)}}>
            ${this.owners.map(r=>p`<option value=${r.owner_watch_id} ?selected=${r.owner_watch_id===this.ownerId}>
              ${tr(r)} (${r.complication_count})</option>`)}
          </select>
        </label>
      ...
      ${this.watchSupported?p`<div class="layout cols-${a.columns}"
          ...
          ${this.renderFooter()}`:p`<div class="card">
            <div class="banner warn"><b>Update the watch app first.</b> ${Uo(this.selectedOwner?.app_version)}</div>
      ...
      ${this.pickerOpen?p`<div class="menu" role="listbox">
        ...
        ${this.hass.user?.is_admin?p`
          ...
          ${this.newShapeChooser&&s>=0?p`<div class="new-shape">
            ...
            <div class="adders">
              ${qt.map(l=>p`<button class="small ${l==="rectangular"?"primary":""}" @click=${()=>{this.togglePicker(!1),this.createNew(l)}}>${J(l)}</button>`)}
            </div>
          </div>`:m}`:m}
      </div>`:m}
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${tr(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?m:p`<span class="mini">${Fa.length} kinds · ${Tn.length} presets</span>`}
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Fa.map(s=>p`<button class="add" style=${`--k:${ue[s]}`} ?disabled=${i} title=${`Add a blank ${Yt[s].toLowerCase()} layer`}
              @click=${()=>{let l=ze(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?p`<span class="well">${us(s)}</span>`:m}<span class="add-name">${z(s)}<span>${Yt[s]}</span></span></button>`)}
          </div>
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Fe(w,d)}</b>
          <small><span class="kind">${Yt[w.kind]}</span> · ${Lp(w,c,this.historySeries,y.size)}</small>
          ${C?p`<span class="facts">${Hp(this.host(),a,w,y).map(O=>p`<span class="fact"><b>${O.label}</b> ${O.value}</span>`)}</span>`:m}
        </span>
        <span class="right">
          <span class="badges">
            ${q?p`<span class="badge tap" title=${`Tappable \xB7 ${Fe(q,d)}`}>tap</span>`:m}
          ...
          ${i?p`<span class="acts">
            ...
            <button class="icon" title=${`${y.isHidden?"Show":"Hide"} (${er}${De}H)`} aria-label=${y.isHidden?"Show this layer":"Hide this layer"} @click=${O=>{O.stopPropagation(),this.mutate(le=>Ce(le,a,P,{isHidden:!y.isHidden}))}}>${z(y.isHidden?"hide":"show")}</button>
      ...
      </div>`},B=(w,T)=>{let V=this.inspect.kind==="group"&&this.inspect.id===w.id,P=!this.collapsed.has(w.id),se=this.rowDrag(w.id,i),y=T[0],k=T[T.length-1],q=H=>{let D=H.currentTarget,O=D.getBoundingClientRect(),le=O.top+(D.classList.contains("drop-before")?nt:0),en=O.bottom-(D.classList.contains("drop-after")?nt:0),ne=(H.clientY-le)/Math.max(1,en-le);return ne<.25?"drop-before":!P&&ne>.75?"drop-after":"drop-into"},G=T.map(H=>H.payload.id);return p`<div class="layer group ${V?"hl":""} ${C?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${se.draggable}
        ...
        @dragstart=${se.onStart} @dragend=${se.onEnd}
        @dragover=${H=>{!this.dragId||this.dragId===w.id||(H.preventDefault(),this.markDrop(H.currentTarget,q(H)))}}
        @drop=${H=>{H.preventDefault();let D=q(H);this.clearDragMarks();let O=this.dragId;if(this.dragId=void 0,!(!O||!y||!k)){if(D==="drop-before"){this.reorderLayer(O,y.payload.id,!0,!0);return}if(D==="drop-after"){this.reorderLayer(O,k.payload.id,!1,!0);return}this.isGroupId(O)||(this.reorderLayer(O,y.payload.id,!0),this.mutate(le=>na(le,O,w.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${T.map(H=>Fe(H,d)).join(", ")}</span></span>`:m}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${er}${De}G)`} aria-label="Ungroup" @click=${H=>{H.stopPropagation(),this.mutate(D=>yn(D,w.id)),V&&(this.inspect={kind:"general"})}}>${z("ungroup")}</button>
          </span>`:m}
          <button class="icon lockbtn ${w.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${H=>{H.stopPropagation(),this.mutate(D=>{let O=D.groups?.find(le=>le.id===w.id);O&&(O.locked=!O.locked)})}}>${z(w.locked?"lock":"unlock")}</button>
        </span>
      </div>`},j=[],oe=new Set;for(let w=0;w<l.length;w++){let T=l[w],V=T.payload.groupId,P=V===void 0?void 0:n.groups?.find(k=>k.id===V);if(!P){j.push(N(T,!1));continue}if(oe.has(P.id))continue;oe.add(P.id);let se=l.filter(k=>k.payload.groupId===P.id);j.push(B(P,se));let y=this.inspect.kind==="group"&&this.inspect.id===P.id;this.collapsed.has(P.id)||j.push(p`<div class="group-kids">${se.map(k=>N(k,!0,y))}</div>`)}return p`<div class="card">
      <h2 class="panel-title tools"><span class="swatch">${z("layers")}</span>Layers<span class="spacer"></span>
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${Ep.map((w,T)=>p`
              <button class=${this.thumbStep===T?"on":""} title=${`${El[T]} row pictures`}
                aria-label=${`${El[T]} row pictures`} aria-pressed=${this.thumbStep===T?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let n=this.presetKind?yl(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${n===void 0?m:p`
        <h2>${n.title}</h2>
        <div class="hint">${n.blurb}</div>
        ${et(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},wl,{compact:!0,...n.domains?{domain:n.domains}:{},...n.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(n){this.canEdit&&(this.presetKind=n,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let n=this.renderRoot.querySelector("dialog.preset-dialog");n?.open?n.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let n=this.presetKind,i=this.presetEntity;if(!n||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=xl(s,n,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let n=this.draft?.config;if(!n)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=ba(n,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`<div class="card canvas-card">
      ...
      ${Ta(r,f)}
    </div>`}renderUnder(n,i){let a=he(this.host()),r=this.inspect,o=r.kind==="layer"?n.elements.find(u=>u.payload.id===r.id):void 0,s;if(this.showTaps)s=p`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${je(n.tapAction)}</b>.`;else if(this.picking)s="Point at a layer and click it. Escape stops.";else if(i==="inline")s="One line of text. Edit it on the right.";else if(r.kind==="group"){let u=n.groups?.find(f=>f.id===r.id),h=u?Ye(n,u.id).length:0;s=u?p`editing group <b>${u.name}</b>. Drag to move all ${h} layers.${u.locked?"":" Click one layer to move it alone."}`:""}else if(o){let u=qe(n,o.payload.id);s=u?.locked?p`editing <b>${Fe(o,a)}</b> in <b>${u.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:p`editing <b>${Fe(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else s="click a layer to edit it";if(i==="inline")return p`<div class="under"><b>Inline</b> · ${s}</div>`;let l=this.currentCase().slots[i],d=Xn(l,i),c=Math.round(d.scale*100);return p`<div class="under"><b>${J(i)}</b> · ${l.width} × ${l.height} pt${c!==100?` \xB7 ${c}%`:""} · ${s}</div>`}renderInlinePreview(n,i){let a;if(!n)a=p`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=n.countdownEnd!==void 0&&n.countdownEnd>r?jt((n.countdownEnd-r)/1e3):n.text,s=n.symbol?this.icons.render(n.symbol,i?11:15,"#FFFFFF"):void 0;a=p`<div class="inline-line">${s??m}<span>${n.label?`${n.label}: `:""}${o}</span></div>`}return i?a:p`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSettingsRow(n){let i=this.host(),a=this.records.find(c=>c.id===this.selectedId),r=this.selectedOwner,o=[a?`Revision ${a.revision}`:"Not saved yet",r?tr(r):void 0].filter(Boolean).join(" \xB7 "),s=n.values,l=new Ze(this.buildContext(),this.draft?.config),d=he(i);return p`<div class="strip-row" style=${`--c:${Q.complication}`} @change=${()=>this.draft?.endGesture()}>
      ...
      <div class="settings" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${Zs(i)}</div>
      <div class="values-list">
        <div class="values-head"><span class="sub">Shared values</span>
          ${this.canEdit?p`<button class="small" @click=${()=>{let c=tl();this.mutate(u=>{u.values.push(c)}),this.inspect={kind:"data",id:c.id}}}>Add</button>`:m}
        ...
        ${s.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),h=this.inspect.kind==="data"&&this.inspect.id===c.id;return p`<div class="datum ${h?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:c.id}}}>
            ...
            <span class="meta ${u===void 0?"none":""}" title=${pe(c.value,d)}>${u??"unresolved"}</span>
      ...
      <div class="tiles">
        ${qt.map(r=>{if(!a.includes(r))return p`<button class="tile off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${J(r)} shape`} @click=${()=>this.addShape(r)}>
              <span class="art"><span class="ghost ${r}"></span></span>
              <span class="lbl">+ Add ${J(r)}</span>
            </button>`;let s=r===this.activeFamily,l;if(r==="inline")l=this.renderInlinePreview(i.inline,!0);else{let u=i[r];l=u?Ta(u,{icons:this.icons,imageSizes:this.imageSizes,slot:$n.slots[r]}):m}let d=r!=="inline"&&n.elements.every(u=>xe(n,r,u).isHidden||u.payload.isHidden)&&n.elements.length>0,c=this.canEdit&&ti(n,r);return p`<div class="tile-wrap">
      ...
      ${l===m?m:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(n,i)}</div>`;let a=this.host(),r=this.inspect,o=m,s=!0;if(r.kind==="layer"){let d=n.elements.find(c=>c.payload.id===r.id);if(!d)return this.inspect={kind:"general"},m;o=rl(a,d,this.canvasFamily)}else if(r.kind==="group"){let d=n.groups?.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=sl(a,d)}else if(r.kind==="data"){let d=n.values.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${Q.complication}`}>
        ...
        <div class="sec-b">${el(a,d)}</div>
      </div>`}else r.kind==="family"?o=ll(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${z("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(n)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([$p(r)]):new Set(Ua)}}>${l?"One at a time":"Open all"}</button>`:m}
      </div>
      ...
      <span>${n}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:m}</span></label>`}multiEditor(n,i){let a=this.canvasFamily,r=he(this.host()),o=new Ze(this.buildContext(),this.draft?.config),s=al(n,a,i),l=i.length,d=[...i].reverse(),c=h=>this.mutate(f=>{for(let g of i)Ce(f,a,g.payload.id,{isHidden:h})}),u=h=>this.mutate(f=>{for(let g of i){let x=f.elements.find($=>$.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
      <div class="sec" data-open="true" style="--c:var(--wa-accent)">
        ...
        <div class="sec-b">
          <div class="picked">
            ${d.map(h=>p`<div class="row" style=${`--k:${ue[h.kind]}`}>
              <span class="bar"></span>
              <span class="name">
                ...
                <b>${Fe(h,r)}</b><span class="kind">${Yt[h.kind]}</span>
              </span>
            </div>`)}
          </div>
      ...
      </div>`}renderFooter(){let n=this.draft;if(!n)return m;let i=this.records.find(r=>r.id===this.selectedId),a=Yo({revision:i?.revision??null,dirty:n.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return p`<details class="foot">
      <summary>
