...
`)}function ko(e){let t;try{t=JSON.parse(e)}catch{return}if(typeof t!="object"||t===null||Array.isArray(t))return;let n=new Map,i=new Set;for(let[a,r]of Object.entries(t))r===null?i.add(a):n.set(a,Sd(r));return{values:n,nullKeys:i}}function Sd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function ya(e){let t=ga(e),n=[...t.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return t.document&&n.push({kind:"template",value:t.document}),n}function Ed(e,t){if(e.values.length!==0)switch(t){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((n,i)=>n+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}function Ft(e){let t=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(t))return Number(t);let n=t.toLowerCase();if(n==="inf"||n==="+inf"||n==="infinity"||n==="+infinity")return 1/0;if(n==="-inf"||n==="-infinity")return-1/0;if(n==="nan"||n==="+nan"||n==="-nan")return NaN}function Xe(e){let t=e.trim(),n=Ft(t);if(n!==void 0)return n;let i="";for(let r of t)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Ft(i)}function Td(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Fd(e){let t=Math.max(0,e);return t<60?`${Math.trunc(t)}s`:t<3600?`${Math.trunc(t/60)}m`:t<86400?`${Math.trunc(t/3600)}h`:`${Math.trunc(t/86400)}d`}function Rd(e){let t=e.trim(),n=Ft(t);if(n!==void 0)return n;let i=0,a=t.indexOf(",");if(a>=0){let s=t.slice(0,a).trim().split(" "),l=s.length===2?Ft(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,t=t.slice(a+1).trim()}let r=t.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Ft(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Md(e){let t=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(t/86400),"d"],[Math.trunc(t%86400/3600),"h"],[Math.trunc(t%3600/60),"m"],[t%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Id(e){return e.replace(/\S+/g,t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase())}function Hd(e,t,n){if(Ne(t))return e;let i=t,a=e,r=Ft(e.trim()),o=i.duration?Rd(e):void 0;if(o!==void 0)a=Md(o);else if(i.relativeTime&&r!==void 0)a=Fd(r);else{let s=Xe(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Td(l))}}switch(i.useEntityUnit&&n&&(a+=n.startsWith("\xB0")||n.startsWith("%")?n:` ${n}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Id(a);break}return a}function jt(e){let t=Math.trunc(Math.max(0,e)),n=Math.trunc(t/3600),i=Math.trunc(t%3600/60),a=t%60,r=o=>String(o).padStart(2,"0");return n>0?`${n}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function xn(e,t=240){let n=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&n.push(o)}i=""};for(let o of e){if(n.length>=t)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return n.length<t&&r(),n}function $o(e,t){let n,i;return t.scale==="fixed"?(n=Math.min(t.minValue,t.maxValue),i=Math.max(t.minValue,t.maxValue)):(n=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,t.thresholdValue!==void 0&&Number.isFinite(t.thresholdValue)&&(n=Math.min(n,t.thresholdValue),i=Math.max(i,t.thresholdValue))),t.baseline==="zero"&&(n=Math.min(n,0),i=Math.max(i,0)),i>n||(i=n+1),{min:n,max:i}}function Ad(e,t,n){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(n>t)||i<t||i>n))return(i-t)/(n-t)}function wn(e,t=dt){let n=[];for(let i of e.split(" ")){if(n.length>=t)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||n.push({offsetSeconds:Math.round(r),state:Ld(i.slice(a+1))})}return n}function Ld(e){try{return decodeURIComponent(e)}catch{return e}}function _d(e,t,n){if(e.length===0||!(t>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/t)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/t));if(!(d>s))continue;let c=n(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Co(e,t,n){if(Number.isNaN(e))return n;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(n,Math.max(t,i))}function zd(e,t,n){if(e===void 0)return 0;let i=Xe(e);if(i===void 0||Number.isNaN(i))return 0;let a=n-t;return a===0?0:Math.min(1,Math.max(0,(i-t)/a))}var Ze=class{constructor(t,n){this.ctx=t;this.charts=new Map;this.named=new Map(t.namedValues.map(i=>[i.id.toUpperCase(),i.value])),n&&this.settleCharts(n)}chartReadings(t){let n=this.chartSeries(t),i=$o(n,t),a={values:n,domainMin:i.min,domainMax:i.max},r=this.chartEntity(t);return r&&(a.entity=r),a}chartSeries(t){let n=kt(t),i=n!==void 0?this.ctx.historySeries?.get(n)??"":this.resolve(t.value)??"",a=xn(i);return t.limit>0&&a.length>t.limit?t.takeFromEnd?a.slice(a.length-t.limit):a.slice(0,t.limit):a}chartEntity(t){let n=this.dereference(t.value);if(!(!n||!("entityId"in n.kind)))return{entityId:n.kind.entityId,displayName:n.kind.displayName,domain:n.kind.domain}}chartNowIndex(t,n){if(t.nowIndex===void 0||n===0)return;let i=this.resolve(t.nowIndex);if(i===void 0)return;let a=Xe(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),n-1)}settleCharts(t){let n=new Map,i=[];for(let s of t.elements)s.kind!=="chart"||n.has(s.payload.id)||(n.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(n.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=n.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,h=u!==void 0&&u!==s&&n.has(u)&&!l.has(u)?o(u,new Set([...l,u])):$o(a.get(s)??[],c);return r.set(s,h),h};for(let s of i){let l=n.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(t){let n=t,i=new Set,a=t.format;for(;n.kind.kind==="named";){let o=n.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ne(a)?a:s.format,n=s}let r={kind:n.kind};return a&&(r.format=a),r}directEntityUnit(t){let n=t.kind;if(n.kind==="entityState"||n.kind==="entityAttribute"||n.kind==="entityAge")return this.ctx.entityStates.get(n.entityId)?.unitOfMeasurement;if(n.kind==="chartStat"){let i=this.charts.get(n.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i;switch(n.kind.kind){case"literal":i=n.kind.value;break;case"entityState":i=this.ctx.entityStates.get(n.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(n.kind.layer.toUpperCase()),r=a?Ed(a,n.kind.stat):void 0;i=a&&r!==void 0?Vr(r,a.domainMax-a.domainMin):void 0;break}default:{let a=fa(t,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Hd(i,n.format,this.directEntityUnit(n))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i=n.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(t)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Ft(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(t){if(!t)return;let n=this.dereference(t);if(!n||n.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(n.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?jt(i.remaining):"Paused":"Idle"}entityIcon(t){let n=this.dereference(t);return!n||n.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(n.kind.entityId)?.iconName??n.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(t){let n=t.comparison;if(n.kind==="isStale")return this.isStale();let i=this.resolve(t.value);if(i===void 0)return n.kind==="isUnavailable";let a=Xe(i),r=()=>this.resolve(n.value),o=()=>{let l=r();return l===void 0?void 0:Xe(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(n.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(n.upper),c=d===void 0?void 0:Xe(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,h]=l<=c?[l,c]:[c,l];return a>=u&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!n.pattern)return!1;try{return new RegExp(n.pattern).test(i)}catch{return!1}}case"isOneOf":return(n.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(t){return t.tests.length===0?!0:t.join==="any"?t.tests.some(n=>this.evaluateTest(n)):t.tests.every(n=>this.evaluateTest(n))}applyRules(t,n){let i=new Map;for(let a of t){let r=n?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ee[s.kind],s)}return i}liveBranches(t){let n=new Map;for(let i of t){let a=i.cases.find(r=>this.evaluateCondition(r.when));n.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return n}styleColor(t,n){let i=t.get(n);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(t,n){let i=t.get(n);return i?this.resolve(i.value):void 0}styleNumber(t,n){return t.get(n)?.number}resolveElement(t,n){let i=t.payload,a=this.applyRules(i.rules,n),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,c={id:i.id,isHidden:o,frame:l,opacity:d};switch(t.kind){case"text":{let u=t.payload.countdown?this.countdownEnd(t.payload.value):void 0,h=t.payload.countdown?this.countdownFallbackText(t.payload.value):void 0,f={kind:"text",...c,text:this.styleText(a,"text")??h??this.resolve(t.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??t.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??t.payload.fontWeight,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex};return u!==void 0&&(f.countdownEnd=u),f}case"icon":{let u=this.entityIcon(t.payload.symbol)??this.resolve(t.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(a,"icon")??u,size:this.styleNumber(a,"fontSize")??t.payload.size,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex}}case"gauge":{let u=t.payload,h=this.styleText(a,"gaugeValue")??this.resolve(u.value),f=this.styleNumber(a,"gaugeMin")??u.minValue,g=this.styleNumber(a,"gaugeMax")??u.maxValue,x=h===void 0?void 0:Xe(h),$=this.styleColor(a,"color")??u.colorSlot.baseColorHex;u.coloring==="bands"&&u.bands.length>0&&x!==void 0&&($=Ui(x,gn(u),u.bandAboveColorHex));let S=g-f;if(u.total){let C=Xe(this.resolve(u.total)??"");C!==void 0&&(S=C)}let E=Co(S,1,zn),v={kind:"gauge",...c,fraction:zd(h,f,g),style:u.style,lineWidth:u.lineWidth,colorHex:$,trackColorHex:u.trackColorHex,thresholdColorHex:u.thresholdColorHex,dotCount:E,filledCount:Co(x??0,0,E)};if(u.thresholdValue!==void 0&&g!==f){let C=(u.thresholdValue-f)/(g-f);C>=0&&C<=1&&(v.thresholdFraction=C)}return v}case"chart":{let u=t.payload,h=this.charts.get(u.id)??this.chartReadings(u),f=h.values,g={min:h.domainMin,max:h.domainMax},x=this.styleColor(a,"color")??u.colorSlot.baseColorHex,$=gn(u),S=Dr(u)?f.map(N=>Ui(N,$,u.bandAboveColorHex)):[],E={kind:"chart",...c,values:f,style:u.style,domainMin:g.min,domainMax:g.max,baseline:u.baseline,barGap:u.barGap,lineWidth:u.lineWidth,colorHex:x,highColorHex:u.highColorHex,lowColorHex:u.lowColorHex,marker:u.marker,pointColorHexes:S,fillBands:u.fillBands,thresholdColorHex:u.thresholdColorHex,nowColorHex:u.nowColorHex};if(f.length>0){let N=u.highlight==="highest"||u.highlight==="both",B=u.highlight==="lowest"||u.highlight==="both",j=N?f.indexOf(Math.max(...f)):-1,oe=B?f.indexOf(Math.min(...f)):-1;j>=0&&(E.highIndex=j),oe>=0&&oe!==j&&(E.lowIndex=oe)}let v=Ad(u,g.min,g.max);v!==void 0&&(E.thresholdY=v);let C=this.chartNowIndex(u,f.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let u=t.payload,h=$t(u),f=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=wn(f,dt),x=_d(g,Ke(u)*60,S=>Kr(S,u.bands,u.otherColorHex));return{kind:"timeline",...c,runs:x,gap:u.gap,cornerRadius:u.cornerRadius}}case"shape":{let u={kind:"shape",...c,shapeKind:t.payload.kind,cornerRadius:t.payload.cornerRadius,thickness:t.payload.thickness,fillColorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??t.payload.borderWidth},h=this.styleColor(a,"borderColor")??t.payload.borderColorHex;return h!==void 0&&(u.borderColorHex=h),u}case"image":{let u={kind:"image",...c,entityId:t.payload.entity.entityId,source:t.payload.source,showTimestamp:t.payload.timestamp===!0,contentMode:t.payload.contentMode,zoom:t.payload.zoom,panX:t.payload.panX,panY:t.payload.panY,cornerRadius:t.payload.cornerRadius,timestampCorner:t.payload.timestampCorner,timestampSize:t.payload.timestampSize};We(t.payload)&&(u.timestampX=t.payload.timestampX,u.timestampY=t.payload.timestampY);let h=this.ctx.entityStates.get(t.payload.entity.entityId)?.entityPicture;return h!==void 0&&(u.url=h),u}case"tap":{let u={kind:"tap",...c,frame:t.payload.frame,opacity:1,action:t.payload.action};return t.payload.openPageId!==void 0&&(u.openPageId=t.payload.openPageId),t.payload.attachedTo!==void 0&&(u.attachedTo=t.payload.attachedTo),u}}}resolveLayout(t,n,i){let a=t.perFamily[n];this.settleCharts(t);let r=so(t,n).map(x=>this.resolveElement(x,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:n,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,$=this.resolve(x.value),S=$===void 0?void 0:Xe($);if(S!==void 0){let E=Math.min(x.minValue,x.maxValue),v=Math.max(x.minValue,x.maxValue),C={value:Math.min(v,Math.max(E,S)),minValue:E,maxValue:v===E?E+1:v,colorHexes:x.colorHexes},N=this.resolve(x.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(x.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(s.backgroundColorHex=f);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Nd(e,t,n){let i=new Ze(t,n),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function ba(e,t,n){let i=new Ze(t),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,n));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Nd(e.inline,t,e)),a}var be=ce,kn=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:be,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=kn.find(e=>e.measured);function Ao(e){if(!e)return;let t=/^(\d+)x(\d+)$/.exec(e.trim());if(!t)return;let n=Number(t[1]),i=Number(t[2]);return kn.find(a=>a.screen.width===n&&a.screen.height===i)}function Xn(e,t){let n=be[t];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/n.width,e.height/n.height),a=n.width*i,r=n.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Pd={regular:400,medium:500,semibold:600,bold:700};function Pe(e){if(!e)return;let t=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(t))return;let n=t.length===8?parseInt(t.slice(6,8),16)/255:1;return{color:`#${t.slice(0,6)}`,opacity:n}}function we(e,t,n="#FFFFFF"){let i=Pe(e)??{color:n,opacity:1};return{[t]:i.color,[`${t}-opacity`]:i.opacity}}function Lo(e,t){let n=Math.max(0,e.frame.width*t.width),i=Math.max(0,e.frame.height*t.height),a=(e.frame.x+e.frame.width/2)*t.width,r=(e.frame.y+e.frame.height/2)*t.height;return{x:a-n/2,y:r-i/2,w:n,h:i,cx:a,cy:r}}function Od(e,t){let n=we(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:jt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>t.w&&t.w>0?Math.max(.5,t.w/a):1,o=e.fontSize*r,s=e.text;if(t.w>0&&s.length*i(o)>t.w){let l=t.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${c}${S}${$}${C}</g>`}function ei(e,t){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:t?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Ea(e,t){return(t?23.5:34)*e}var So=10.5;function _o(e,t){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*t}function Eo(e,t){let n=0;for(let i of e)n+=_o(i,t);return n}function To(e,t,n){let i=e.toUpperCase(),a=d=>_o(d,n),r=.9*n,o=0;for(let d of i)o+=a(d);if(o<=t)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>t)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function $a(e,t,n){let i=n*Math.PI/180;return{x:e.cx+t*Math.cos(i),y:e.cy+t*Math.sin(i)}}function Ca(e,t,n,i){let a=$a(e,t,n),r=$a(e,t,i);return`M ${a.x} ${a.y} A ${t} ${t} 0 0 1 ${r.x} ${r.y}`}function zo(e,t,n,i){let{dial:a}=ei(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:t,d:Ca(a,n,i.start,i.end),length:n*r}}function ec(e,t){let n=ei(e,!0);return zo(e,t,n.dial.r,n.labelArc)}var Fo=18.5,tc=113,nc={start:-71,end:-36},Ro=104,ic=6.2,Mo={start:-77,end:-30.5};function Io(e){let t=e.replace("#",""),n=i=>parseInt(t.slice(i,i+2),16)||0;return[n(0),n(2),n(4)]}function Ho(e,t){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let n=Math.min(1,Math.max(0,t))*(e.length-1),i=Math.min(e.length-2,Math.floor(n)),a=n-i,r=Io(e[i]),o=Io(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var xa=11;function ac(e,t,n){let{dial:i}=ei(t,!0),a=Ro*t,r=180/(Math.PI*Ro),o=e.minLabel!==void 0?Eo(e.minLabel,xa)*r:0,s=e.maxLabel!==void 0?Eo(e.maxLabel,xa)*r:0,l=Mo.start+(o>0?Math.max(0,o-1.8):0),d=Mo.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,h=[];for(let S=0;S<u;S++){let E=l+c*S/u,v=Math.min(d,l+c*(S+1)/u+.4);h.push(b`<path d=${Ca(i,a,E,v)} fill="none"
      stroke=${Ho(e.colorHexes,(S+.5)/u)} stroke-width=${ic*t}
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*t} fill=${Ho(e.colorHexes,f)}
    ...
    ${e.maxLabel!==void 0?$(`${n}-gmax`,d+x,d+x+Math.max(s,3),e.maxLabel):m}`}function Ta(e,t){let n=e.family in be?e.family:"rectangular",i=t.slot??be[n],a=be[n],r=Xn(i,n),o=`clip-${n}-${Math.random().toString(36).slice(2,8)}`,s=Pe(e.backgroundColorHex),l=Pe(e.borderColorHex),d=e.borderWidth*r.scale;if(n==="corner"){let g=r.scale,x=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=ei(g,x),v=Ea(g,x),C=v/(a.width*g),N=E.tile.cx-v/2,B=E.tile.cy-v/2,j=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,oe=m;if(e.bezelGauge)oe=ac(e.bezelGauge,g,o);else if(e.bezelText){let T=ec(g,`${o}-bezel`),V=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?jt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;oe=b`<defs><path id=${T.id} d=${T.d} /></defs>
        <text font-size=${So*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${T.id}" startOffset="50%" text-anchor="middle">${To(V,T.length,So*g)}</textPath></text>`}let w=m;if(S){let T=Pe(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},V=zo(g,`${o}-curved`,tc*g,nc);w=b`<defs><path id=${V.id} d=${V.d} /></defs>
        <text font-size=${Fo*g} font-weight="600" fill=${T.color} fill-opacity=${T.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${V.id}" startOffset="50%" text-anchor="middle">${To($,V.length,Fo*g*.88)}</textPath></text>`}else{let T=e.borderWidth*r.scale*C,V=l?b`<circle cx=${v/2} cy=${v/2} r=${v/2-T/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${T} />`:m;w=b`<g transform="translate(${N} ${B})">
        <g clip-path=${`url(#${o})`}>
    ...
    ${c.map(f=>ka(f,a,d))}
    ${u}
  </svg>`}function J(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var qt=["rectangular","circular","corner","inline"];function Rt(e){return ee.includes(e)}function Po(e){return qt.filter(t=>e.supportedFamilies.includes(t))}function Oo(e){return ee.find(t=>e.supportedFamilies.includes(t))}function ti(e,t){return e.supportedFamilies.includes(t)&&e.supportedFamilies.length>1}function lc(){return{value:M("")}}function dc(e){let t=Wt();for(let n of e.elements)t.placements[n.payload.id]={frame:{...n.payload.frame},isHidden:!0};return t}function Do(e,t){e.supportedFamilies.includes(t)||(e.supportedFamilies=qt.filter(n=>n===t||e.supportedFamilies.includes(n))),Rt(t)?e.perFamily[t]||(e.perFamily[t]=dc(e)):e.inline||(e.inline=lc()),e.schemaVersion=hn(e)}function Vo(e,t){ti(e,t)&&(e.supportedFamilies=e.supportedFamilies.filter(n=>n!==t),Rt(t)?delete e.perFamily[t]:delete e.inline,e.schemaVersion=hn(e))}function Bo(e,t){let n=[];if(!Rt(t)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||n.push("the Inline text")),n}let i=e.perFamily[t];if(!i)return n;let a=Object.values(i.placements).filter(r=>!r.isHidden).length;return a>0&&n.push(`${a} placed layer${a===1?"":"s"}`),i.rules.length>0&&n.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&n.push("the bezel"),i.curvedText&&n.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&n.push("the background or border"),n}var pe={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},Yt={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area"},Fa=["text","icon","gauge","chart","timeline","shape","image","tap"],Q={states:"#f9a825",tap:pe.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Go="2.8.0";function Ra(e){if(typeof e!="string")return;let t=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(t)return[Number(t[1]),Number(t[2]),Number(t[3]??0)]}function cc(e,t){for(let n=0;n<3;n++)if(e[n]!==t[n])return e[n]<t[n]?-1:1;return 0}function Uo(e,t=Go){let n=Ra(e),i=Ra(t);return!n||!i?!1:cc(n,i)>=0}function Ko(e,t=Go){return`${Ra(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The complication editor needs ${t} or newer. Update Wrist Assistant on the watch, open it once so it reports its version, then reload this page.`}var Wo="52a9d81d0fd7";function uc(e){return e.trim().replace(/\./g,"-")}function pc(e){return e.trim().replace(/-/g,".")}var ni=class e{constructor(t){this.onReady=t;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let t=window.customIcons?.ios;if(!t||typeof t.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>t.getIconList()).then(n=>{this.nameList=(n??[]).map(i=>pc(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(t,n,i){let a=uc(t),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Pe(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return b`<svg x="0" y="0" width=${n} height=${n} viewBox=${s}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${kc(e)}</svg>`}var Oe="color-mix(in srgb, var(--k) 45%, #6b7280)",si='system-ui, -apple-system, "Segoe UI", sans-serif';function us(e,t,n,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-n*Math.cos(u)).toFixed(2),y:(t-n*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${n} ${n} 0 ${d} 1 ${l.x} ${l.y}`}function za(e,t,n,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${us(e,t,n,1)} stroke=${Oe} stroke-width="2.6" opacity=".5" />
    <path d=${us(e,t,n,i)} stroke="var(--k)" stroke-width="2.6" />
    ...
    </div></div>`}function Tc(e,t){return e===void 0||t===void 0?e===t:e.replace(/^#/,"").toUpperCase()===t.replace(/^#/,"").toUpperCase()}function Vs(e,t){let n=e[t],i=n&&typeof n.attributes.friendly_name=="string"?n.attributes.friendly_name:t;return{entityId:t,displayName:i,domain:t.split(".")[0]??""}}function Fc(e,t,n){let i=t===void 0?void 0:typeof t=="string"?[t]:t,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=n?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function vs(e){let{entities:t,devices:n,areas:i}=e;if(!t||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=t[r];if(o)return a(o.area_id)??a(o.device_id?n?.[o.device_id]?.area_id:void 0)}}var Bs=50;function Rc(e){let t=e.state.trim().split(/\s+/)[0]??"";return t!==""&&Number.isFinite(Number(t))}function Mc(e,t,n=Bs,i){let a=t.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,n);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:c.startsWith(a)?h=2:d.includes(a)?h=3:c.includes(a)?h=4:o.length>1&&o.every(f=>d.includes(f)||c.includes(f))?h=5:u!==""&&(u.includes(a)||o.length>1&&o.every(f=>d.includes(f)||c.includes(f)||u.includes(f)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,n).map(l=>l.c)}var Ic=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Gs(e){return Ic.test(e.trim())}function Hc(e,t,n){let i=e.trim();if(i!==t.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in n)return Vs(n,i);if(Gs(i))return{...t,entityId:i,domain:i.split(".")[0]??""}}}var Ht=new Map;function Ie(e){let t=e instanceof Node?e:null;for(let n=0;t&&n<8;n+=1){let i=t.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}t=a}}function Us(e){return Ht.has(e)}function et(e,t,n,i,a,r={}){let o=e.hass.states,s=Ht.get(a),l=s?Mc(Fc(o,r.domain,vs(e.hass)),s.query,Bs,r.preferNumeric?Rc:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=n.entityId?o[n.entityId]:void 0,u=(v,C,N=0)=>{Ht.set(a,{query:C,index:N}),Ie(v)},h=v=>{Ht.delete(a),Ie(v)},f=v=>{let C=Hc(v,n,o);C&&i(C)},g=(v,C)=>{i(Vs(o,v.entityId)),h(C)},x=()=>Math.max(0,Math.min(Ht.get(a)?.index??0,l.length-1)),$=v=>{let C=v.target;if(v.key==="ArrowDown"||v.key==="ArrowUp"){v.preventDefault();let N=Ht.get(a);if(!N){u(C,C.value);return}let B=v.key==="ArrowDown"?x()+1:x()-1;u(C,N.query,Math.max(0,Math.min(l.length-1,B))),Ac(C);return}if(v.key==="Enter"){v.preventDefault();let N=l[x()];s&&N?g(N,C):(f(C.value),h(C));return}if(v.key==="Escape"){if(!s)return;v.preventDefault(),v.stopPropagation(),h(C)}},S=n.entityId?vs(e.hass)?.(n.entityId):void 0,E=n.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:c?p`<div class="entity-current">
    ...
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${Gs(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((v,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${bs(v.domain)}</span>
                  <span class="ent-state">${v.state}</span>
                </span>
              </button>`)}
        </div>`:E}
  </div>`}function Ac(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Lc=120;function _c(e,t,n,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(ai.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:t.trim()!==""&&n.length>0?{names:[...n],fromPack:!0}:{names:a(ri),fromPack:!1}}function xs(e,t){return t.size===0?e.length:e.filter(n=>t.has(n)).length}function zc(e){return[{value:"",label:`Starter set (${xs(ri,e)})`},...ai.map(t=>({value:t.name,label:`${t.name} (${xs(t.symbols,e)})`}))]}function Nc(e){return e.length>0?e.length:ri.length}function Pc(e,t,n,i){return n?t>e?`Showing ${e} of ${t}. Type more to narrow it down.`:t===1?"1 symbol matches.":`${t} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function ws(e,t,n,i){let a=e.icons.render(t,22,"#FFFFFF");return p`<button type="button" class="sym ${n?"on":""}" title=${t} @click=${()=>i(t)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${t}</span>
  </button>`}function Ks(e,t,n,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),c=t.trim(),u=c!==""&&d.size>0&&!d.has(c),h=g=>{n(g),a.noteUsed(g)},f=m;if(r){let g=a.category(i),x=_c(g,o,l,d),$=Yo(x.names,o),S=x.fromPack?$.slice(0,Lc):$,E=d.size===0?a.recent:a.recent.filter(v=>d.has(v));f=p`<div class="sym-browse">
      ...
      ${E.length===0?m:p`<div class="hint">Recent</div>
        <div class="sym-grid one-row">${E.map(v=>ws(e,v,v===c,h))}</div>`}
      <div class="sym-grid">${S.map(v=>ws(e,v,v===c,h))}</div>
    ...
    ${e.bands.map((n,i)=>p`
      <div class="row-inline">
        ${ue("State",n.match,a=>t(r=>{let o=r.bands[i];o&&(o.match=a)},`tmatch${n.id}`),{placeholder:"on"})}
    ...
    <div class="grid2">
      ...
      ${ue("Prefix",n.prefix??"",a=>i({prefix:a}))}
      ${ue("Suffix",n.suffix??"",a=>i({suffix:a}))}
    </div>
    ...
    ${o.kind==="filter"?p`<div class="grid2">
          ${ue("Domains",a(o.domains),s=>n({...t,scope:{...o,domains:r(s)}}),{placeholder:"light, switch"})}
          ${ue("Area ids",a(o.areaIds),s=>n({...t,scope:{...o,areaIds:r(s)}}))}
          ${ue("Label ids",a(o.labelIds),s=>n({...t,scope:{...o,labelIds:r(s)}}))}
          ${ue("Floor ids",a(o.floorIds),s=>n({...t,scope:{...o,floorIds:r(s)}}))}
    ...
    ${t.stateFilter&&"value"in t.stateFilter?ue("State",t.stateFilter.value,s=>n({...t,stateFilter:{kind:t.stateFilter.kind,value:s}})):m}
    ${t.function==="count"?m:ue("Attribute (blank = state)",t.attribute??"",s=>{let l={...t};s?l.attribute=s:delete l.attribute,n(l)})}`}var Js=Qi,iu=Js.filter(([e])=>e!=="none");function au(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Xs(e,t){let n=au(t)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=t.type==="callService"?{...t}:{type:"callService",serviceDomain:"",serviceName:""};return n.entityId!==""&&(i.target=n),i}return jr(e)?{type:e,...n}:{type:e}}var ru=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Zs(e,t,n,i){let a=t.serviceDataJSON??"",r=qr(a),o=t.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
      ${ue("Domain",t.serviceDomain,s=>n({...t,serviceDomain:s.trim()},"svc-domain"),{placeholder:"light"})}
      ${ue("Service",t.serviceName,s=>n({...t,serviceName:s.trim()},"svc-name"),{placeholder:"turn_on"})}
    </div>
    <div class="chips">
      ${ru.map(([s,l,d,c])=>p`
    ...
    ${Ds("Data (JSON)",a,s=>{let l={...t};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,n(l,"svc-data")},3)}
    ${r?p`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:p`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function ou(e,t){return e!==void 0&&t.trim()!==""&&t.trim()!==e.trim()}function Qs(e){let t=e.config,n=t.tapAction,i=ou(e.savedName,t.name),a=t.refreshMinutes??0,r=Ts.map(s=>[String(s),Fs(s)]);Ts.includes(a)||r.push([String(a),Fs(a)]);let o=t.showSuccessFlash??!0;return p`
    <div class="gen-row">
      ${ue("Name",t.name,s=>e.update(l=>{l.name=s},"name"))}
      ${Te("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Te("Tap action",n.type,Js,s=>e.update(l=>{l.tapAction=Xs(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
    ...
    ${n.type==="callService"?Zs(e,n,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):m}
    ${n.type==="openPage"?lu(e):m}`}var su="#808080",Ts=[0,15,30,60,120];function Fs(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function lu(e){let t=e.config;return el(e,t.openPageId,t.openPageName,(n,i)=>e.update(a=>{if(n===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=n,i?a.openPageName=i:delete a.openPageName}))}function el(e,t,n,i){let a=t??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${n||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Te("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?m:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function tl(e,t){let n=e.config.values.findIndex(a=>a.id===t.id),i=`nv-${t.id}`;return p`
    ${ue("Name",t.name,a=>e.update(r=>{r.values[n].name=a},`${i}-name`))}
    ${ae(e,t.value,a=>e.update(r=>{r.values[n].value=a},i),{allowNamed:!1,showResolved:!0,inline:!0,key:i})}
    <div class="hint">Used by ${Rs(e.config,t.id)} layer${Rs(e.config,t.id)===1?"":"s"}.</div>`}function Rs(e,t){return JSON.stringify(e.elements).split(`"${t}"`).length-1+JSON.stringify(e.perFamily).split(`"${t}"`).length-1}function nl(){return{id:Y(),name:"Value",value:M("")}}function xe(e,t,n){let i=e.perFamily[t],a=i?.placements[n.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:n.payload.frame,isHidden:n.payload.isHidden,fromPlacement:!1}}function Ce(e,t,n,i,a=!1){let r=e.elements.find(c=>c.payload.id===n);if(!r)return;let o=e.perFamily[t];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[t]=o);let s=xe(e,t,r),d={...o.placements[n]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};if(a&&delete d.size,Object.keys(o.placements).length===0)for(let c of e.elements)c.payload.id!==n&&(o.placements[c.payload.id]={frame:{...c.payload.frame},isHidden:c.payload.isHidden});o.placements[n]=d}function pi(e,t,n,i,a){let r=t.payload.id,o=Un(t)??a.min,s=xe(e.config,n,t).size??o;return Z(`${i} (pt)`,s,l=>e.update(d=>Ce(d,n,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${n}`),{step:a.step,min:a.min,...a.def===void 0?{}:{def:a.def}})}function il(e,t,n){for(let i of ee)i===n||!e.supportedFamilies.includes(i)||Ce(e,i,t,{isHidden:!0})}function al(e,t,n){let i=e.perFamily[n]??(e.perFamily[n]=Wt()),a={};for(let r of e.elements){let o=xe(e,t,r),s=o.size??Un(r),l={frame:{...o.frame},isHidden:o.isHidden,...s!==void 0?{size:s}:{}};a[r.payload.id]=ia(l,t,n,r.kind)}i.placements=a}function wi(e,t){return e.elements.filter(n=>!xe(e,t,n).isHidden).length}function Ms(e){return e.length===0?"none":e.every(t=>t)?"all":e.every(t=>!t)?"none":"mixed"}function du(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"?void 0:e.payload.colorSlot.baseColorHex}function rl(e,t,n){let i=Ms(n.map(d=>xe(e,t,d).isHidden)),a=Ms(n.map(d=>d.payload.isHidden)),r=n.map(du),o=n.length>0&&r.every(d=>d!==void 0),s=r[0],l=o&&s!==void 0&&r.every(d=>d!==void 0&&d.toUpperCase()===s.toUpperCase());return{hiddenHere:i,hiddenEverywhere:a,colourable:o,colour:l?s:void 0}}var Wa=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]];function cu(e,t,n){let i=t.payload.id,a=jn(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=t.kind==="image"&&t.payload.source==="camera",s=o?{domain:"camera"}:{},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return p`
    ${et(e,o?"Camera":"Entity",r,d=>e.update(c=>fo(c,i,d,l(d.entityId)),`${n}-entity`),`${n}-layer-entity`,s)}
    ...
    ${n?p`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:m}`}function yi(e,t){if(e===t)return!0;if(typeof e!=typeof t||e===null||t===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(t))return!1;if(Array.isArray(e))return e.length===t.length&&e.every((a,r)=>yi(a,t[r]));let n=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(t).filter(a=>t[a]!==void 0);return n.length!==i.length?!1:n.every(a=>yi(e[a],t[a]))}function Is(e,t,n){return n.some(i=>!yi(e[i],t[i]))}function Hs(e,t,n){let i=e,a=t;for(let r of n)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function ke(e,t,n,i,a={}){let r=e.openSections.has(t),o=()=>e.toggleSection(t);return p`<section class="sec" data-open=${r?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function xu(e){let t=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return t.length===0?!1:t.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>t.length}function wu(e,t,n=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??t,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-n),r=a.map(o=>`${o.state||"(blank)"} ${yu(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function bi(e){let t=Nn.find(o=>o.minutes===e);if(t)return t.label;let n=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return n>0&&r.push(`${n}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var gi=new Set;function Ba(e,t){return gi.has(e)||!Nn.some(n=>n.minutes===t)}function As(e,t,n,i){let a=Ba(e,t);return p`<label class="field">${tt("Span",{atDefault:t===n&&!a,title:`Back to ${bi(n)}`,reset:()=>{gi.delete(e),i(n)}})}
      ...
      </select></label>`}function Ls(e,t){let n=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=(o,s,l)=>t(Math.min(Ki,Math.max(1,Math.round(o)*1440+Math.round(s)*60+Math.round(l))));return p`<div class="grid3 span-parts">
    ...
    <div class="hint">${bi(e)}, up to 7 days: the recorder keeps
      ten by default, and a longer span would quietly come back short.</div>`}function ja(e,t){let n=me(e);switch(t.kind){case"text":return pt(he(t.payload.value,n),48);case"icon":return pt(he(t.payload.symbol,n),48);case"gauge":return pt(he(t.payload.value,n),48);case"chart":return pt(`${he(t.payload.value,n)}${t.payload.historyMinutes>0?` \xB7 ${bi(t.payload.historyMinutes)}`:""}`,48);case"timeline":return pt(`${he(t.payload.value,n)} \xB7 ${bi(Ke(t.payload))}`,48);case"shape":return t.payload.kind==="roundedRectangle"?"Rounded rectangle":t.payload.kind;case"image":return t.payload.entity.displayName||t.payload.entity.entityId||(t.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return je(t.payload.action)}}function vi(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${$e(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${$e(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let t=e.payload,n=t.style==="dots"?`${t.bands.length>0&&t.coloring==="bands"?"banded":$e(t.colorSlot.baseColorHex)} dots`:`${t.lineWidth} pt line \xB7 ${t.coloring==="bands"&&t.bands.length>0?`${t.bands.length+1} colour bands`:$e(t.colorSlot.baseColorHex)}`;return`${t.style} \xB7 ${n}${t.thresholdValue===void 0?"":` \xB7 threshold ${t.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${Ws.find(([t])=>t===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let t=e.payload;return`${t.bands.length===0?`one colour (${$e(t.otherColorHex)})`:`${t.bands.length} ${t.bands.length===1?"state":"states"} coloured`}${t.gap>0?` \xB7 ${t.gap} pt gap`:""} \xB7 corners ${t.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${$e(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${$e(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function ol(e,t,n){let i=t.payload.id,a=e.config.elements.findIndex(y=>y.payload.id===i),r=`el-${i}`,o=(y,k)=>e.update(q=>y(q.elements[a]),k?`${r}-${k}`:void 0),s=xe(e.config,n,t),l=s.frame,d=(y,k)=>e.update(q=>Ce(q,n,i,{frame:hs(l,y)}),`${r}-${k}-${n}`),c=ze(t.kind).payload,u=c.colorSlot?.baseColorHex??"#FFFFFF",h=y=>c[y],f,g;switch(t.kind){case"text":{let y=ea(e.config,t.payload.value);f=p`
        ...
        ${q?p`
            ${ae(e,y.total??Ss(y),G=>k(H=>{H.total=G},"total"),{showResolved:!0,label:"Total",key:`${r}-total`})}
        ...
        <div class="grid2">
          ${te("Style",y.style,jc,G=>k(H=>{G==="dots"&&H.total===void 0&&(H.total=Ss(H)),G!=="dots"&&delete H.total,H.style=G}),{titles:qc,def:c.style})}
        ...
        ${te("Colour",y.coloring,ks,G=>k(H=>{H.coloring=G,G==="bands"&&H.bands.length===0&&(H.bands=$s([H.minValue,H.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Cs(y,y.colorSlot.baseColorHex,k)}`:m}
        ${q?m:p`
          <div class="grid2">
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=t.payload,k=(R,A)=>o(Ei=>R(Ei.payload),A),q=kt(y),G=c.historyMinutes,H=c.historyPoints,D=y.historyMinutes>0,O=y.value.kind.kind==="entityState",se=q===void 0?void 0:e.historySeries(q),en=D&&O?se??"":e.resolve(y.value)??"",ne=y.historyPoints<1,Se=Ba(i,y.historyMinutes),Re=xn(en),yt=y.limit>0&&Re.length>y.limit?y.takeFromEnd?Re.slice(Re.length-y.limit):Re.slice(0,y.limit):Re,Hl=!D&&O&&Re.length===1,Ci=e.config.elements.filter(R=>R.kind==="chart"&&R.payload.id!==i),Al=me(e),Si=y.scaleFrom!==void 0&&Ci.some(R=>R.payload.id===y.scaleFrom);f=p`
        ...
        ${D?p`
            ...
            <div class="grid2">
              ${As(i,y.historyMinutes,G,R=>k(A=>{A.historyMinutes=R}))}
            ...
            ${Se?Ls(y.historyMinutes,R=>k(A=>{A.historyMinutes=R},"span")):m}
        ...
        ${Re.length===0&&!(D&&(!O||se===void 0||se===""))?p`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:m}
        ...
        ${Hl?p`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        ${Ci.length===0?m:Te("Same scale as",Si?y.scaleFrom:"",[["","Its own"],...Ci.map(R=>[R.payload.id,Fe(R,Al)])],R=>k(A=>{R?A.scaleFrom=R:delete A.scaleFrom}),{def:""})}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let R;e.update(A=>{R=ho(A,i)}),R&&e.selectLayer(R)}}>
          ${z("plus")}<span>Second series</span></button>
        ${te("Colour",y.coloring,ks,R=>k(A=>{A.coloring=R,R==="bands"&&A.bands.length===0&&(A.bands=$s(yt))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Cs(y,y.colorSlot.baseColorHex,k)}
        ...
        <div class="grid2">
          ${te("Highlight",y.highlight,Ws,R=>k(A=>{A.highlight=R}),{def:c.highlight})}
        ...
        ${y.nowIndex===void 0?m:p`
          ...
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=t.payload,k=(ne,Se)=>o(Re=>ne(Re.payload),Se),q=c.historyMinutes,G=y.value.kind.kind==="entityState",H=$t(y),D=H===void 0?void 0:e.historySeries(H),O=Ke(y)*60,se=wn(D??"",dt),en=Ba(i,y.historyMinutes);f=p`
        ...
        ${As(i,y.historyMinutes,q,ne=>k(Se=>{Se.historyMinutes=ne}))}
        ${en?Ls(y.historyMinutes,ne=>k(Se=>{Se.historyMinutes=ne},"span")):m}
        ...
        ${se.length>0?p`<div class="hint">Reads <span class="nums">${wu(se,O)}</span></div>`:m}
        ${xu(se)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${t.payload.kind==="line"?vu(n,l,d):m}`,g=t.payload.kind==="line"?Z("Thickness (pt)",t.payload.thickness,y=>o(k=>{k.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        ${t.payload.borderColorHex!==void 0?Z("Border width (pt)",t.payload.borderWidth,y=>o(k=>{k.payload.borderWidth=y??1},"bw"),{step:.5,min:0,def:c.borderWidth}):m}`;break;case"image":{let y=t.payload,k=(D,O)=>o(se=>D(se.payload),O),q=y.entity.entityId?e.hass.states[y.entity.entityId]?.attributes?.entity_picture:void 0,G=typeof q=="string"?q:void 0,H=G!==void 0&&!G.startsWith("/");f=p`
        ...
        ${sl(e,t.payload,(y,k)=>o(q=>y(q.payload),k),r)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let x=t.kind==="image"||t.kind==="tap"||t.kind==="timeline"?void 0:re(t.kind==="shape"?"Fill colour":"Colour",t.payload.colorSlot.baseColorHex,y=>o(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,u),$=oa(e.config,t),S=$?{kind:{kind:"entityState",...$}}:void 0,E=pe[t.kind],v=t.kind==="tap"?void 0:Me(e.config,i)[0],C=t.kind==="image"?t.payload.timestamp===!0:!1,N=$u[t.kind],B=Cu[t.kind],j=Is(t.payload,c,N),oe=t.kind==="text"?"fontSize":t.kind==="icon"?"size":t.kind==="gauge"||t.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[n]?.placements[i]?.size!==void 0,T=Is(t.payload,c,B)||oe!==void 0&&s.size!==void 0&&s.size!==c[oe],V=!yi(l,Ge)||s.isHidden,P=Ct(e.config,i),le=(y,k)=>()=>o(q=>Hs(q.payload,c,y),k);return p`
    ${ke(e,"content","Content",p`${t.kind==="tap"?m:cu(e,t,r)}${f}`,{color:E,icon:"content",summary:ja(e,t),...j?{reset:le(N,"reset-content")}:{}})}
    ${g===void 0&&x===void 0?m:ke(e,"look",t.kind==="image"?"Picture":"Look",p`${g??m}${x??m}`,{color:E,icon:t.kind==="image"?"image":"look",...vi(t)?{summary:vi(t)}:{},...T?{reset:()=>e.update(y=>{Hs(y.elements[a].payload,c,B),w&&Ce(y,n,i,{},!0)})}:{}})}
    ${t.kind==="chart"?ke(e,"numbers","Numbers",Fu(e,t),{color:pe.text,icon:"text",summary:Tu(e,t),...P.length>0?{reset:()=>e.update(y=>{for(let k of Ct(y,i))St(y,k.payload.id)})}:{}}):m}
    ${t.kind==="image"?ke(e,"timestamp","Timestamp",fu(t.payload,(y,k)=>o(q=>y(q.payload),k)),{color:E,icon:"clock",summary:C?`Shown \xB7 ${t.payload.timestampSize} pt`:"Hidden",...C?{reset:le(ku,"reset-stamp")}:{}}):m}
    ${t.kind==="tap"?m:ke(e,"tappable","Tap",Ru(e,t,r),{color:Q.tap,icon:"tap",summary:v?je(v.payload.action):"Not tappable",...v?{reset:()=>e.update(y=>Wn(y,i))}:{}})}
    ${ke(e,"states","States",ml(e,t.payload.rules,t.kind,y=>y.elements.find(k=>k.payload.id===i)?.payload.rules,`rules-${i}`,S),{color:Q.states,icon:"states",summary:Cn(t.payload.rules).replace(/\.$/,""),...t.payload.rules.length>0?{reset:()=>o(y=>{y.payload.rules=[]})}:{}})}
    ${ke(e,"placement","Place",p`
      ...
      <div class="hint">Everything about where this layer sits, how big it is drawn and whether it
        ...
        the same layer differently there.</div>`,{color:Q.place,icon:"place",summary:`${Math.round(l.width*100)}% wide \xB7 ${J(n)}${s.fromPlacement?"":" \xB7 shared frame"}`,...V?{resetTitle:`Put this layer back to the middle of the ${J(n)} face at half size, unrotated and shown`,reset:()=>e.update(y=>Ce(y,n,i,{frame:{...Ge},isHidden:!1}))}:{}})}`}var ku=["timestamp","timestampCorner","timestampSize"],$u={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Cu={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function sl(e,t,n,i){let a=t.action;return p`
    ${Te("Tap action",a.type,iu,r=>n(o=>{o.action=Xs(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?et(e,"Target",a,r=>n(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):m}
    ${a.type==="callService"?Zs(e,a,(r,o)=>n(s=>{s.action=r},o),`${i}-tap`):m}
    ${a.type==="openPage"?el(e,t.openPageId,t.openPageName,(r,o)=>n(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):m}`}var Su=24;function Eu(e,t){let n=[],i=1/0;for(let r of ee){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=uo(e.config,t,r);o&&(n.push(`${J(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(n.length===0)return m;let a=i<Su;return p`<div class=${a?"hint warn":"hint"}>${n.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Tu(e,t){let n=Ct(e.config,t.payload.id);return n.length===0?"None yet":n.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Ot.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Fu(e,t){let n=me(e),i=Ct(e.config,t.payload.id),a=o=>e.update(s=>{io(s,t.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    ${a?p`<div class="value-editor">
        ...
        ${Eu(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${je(o)}</b>.</div>`}`}function _s(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Fe(e,t){switch(e.kind){case"text":return _s(he(e.payload.value,t));case"icon":return _s(he(e.payload.symbol,t));case"gauge":return he(e.payload.value,t);case"chart":return he(e.payload.value,t);case"timeline":return he(e.payload.value,t);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let n=e.payload.entity;return n.displayName||n.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let n=e.payload.action,i="entityId"in n?n.displayName||n.entityId:n.type==="callService"?[n.serviceDomain,n.serviceName].filter(a=>a!=="").join("."):n.type==="openPage"&&e.payload.openPageName||"";return i?`${n.type} \xB7 ${i}`:n.type}}}function ll(e,t){let n=Ye(e.config,t.id),i=me(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===t.id);l&&r(l)},o?`group-${t.id}-${o}`:void 0);return ke(e,"content","Group",p`
    ${ue("Name",t.name,r=>a(o=>{o.name=r},"name"))}
    ...
    </div>`,{color:Q.group,icon:"folder",summary:`${n.length} layers \xB7 ${t.locked?"moves as one":"unlocked"}`})}function dl(e,t){if(t==="inline")return Mu(e);let n=e.config.perFamily[t];if(!n)return p`<div class="hint">No settings stored for ${J(t)} yet.</div>
    ...
    ${t==="corner"?ke(e,"corner","Corner content",Iu(e,n,i),{color:Q.place,icon:"content",summary:n.curvedText?"Big curved text":"Layer canvas",...n.curvedText!==void 0||n.bezelText!==void 0||n.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):m}
    ${ke(e,"states","Shape states",ml(e,n.rules,"layout",s=>s.perFamily[t]?.rules,`rules-${t}`),{color:Q.states,icon:"states",summary:Cn(n.rules).replace(/\.$/,""),...n.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ${ke(e,"placements","Placements",p`
      <div class="hint">${a===0?`Nothing is on the ${J(t)} shape. The Layers card offers to copy another shape's whole arrangement onto it.`:`${a} layer${a===1?" is":"s are"} on the ${J(t)} shape, each with its own frame and size here.`}</div>`,{color:Q.place,icon:"place",summary:a===0?"Nothing placed":`${a} layer${a===1?"":"s"} placed`})}`}function Mu(e){let t=e.config.inline;if(!t)return p`<div class="hint">This complication lists Inline but has no Inline text yet (it was saved by an older integration). The watch shows "No inline layout" until one is added.</div>
    ...
    ${ke(e,"content","Inline text",p`
      ${ue("Label (blank = value only)",t.label??"",a=>n(r=>{a?r.label=a:delete r.label},"label"))}
      ...
      ${t.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,{color:pe.text,icon:"text",summary:pt(`${t.label?`${t.label}: `:""}${he(t.value,i)}`,48)})}
    ${ke(e,"symbol","Symbol",p`
      ${Ks(e,t.symbol??"",a=>n(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${t.symbol?`${t.symbol} `:""}${t.label?`${t.label}: `:""}${e.resolve(t.value)??"--"}</div>`,{color:pe.icon,icon:"icon",summary:t.symbol||"None"})}`}function Iu(e,t,n){let i=t.curvedText?"curved":"canvas",a=t.bezelGauge?"gauge":t.bezelText?"text":"none";return p`
    ...
    ${a==="gauge"&&t.bezelGauge?Hu(e,t.bezelGauge,n):m}`}function Hu(e,t,n){let i=[t.colorHexes[0]??"#34C759",t.colorHexes[1]??t.colorHexes[t.colorHexes.length-1]??"#FFCC00",t.colorHexes[t.colorHexes.length-1]??"#FF3B30"],a=r=>o=>n(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${t.maxLabel?ae(e,t.maxLabel,r=>n(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):m}`}var km=ee.map(e=>[e,J(e)]),qa={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Au=Object.keys(qa);function Lu(e){let t=qn[e];return Au.filter(n=>t.includes(Ee[n]))}var _u={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function hi(e,t){if(e.entityId==="")return"(no entity)";let n=e.displayName.trim();if(n!==""&&n!==e.entityId)return n;let i=t?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function pt(e,t){let n=e.replace(/\s+/g," ").trim();return n.length>t?`${n.slice(0,t-1)}\u2026`:n}function zu(e){if(!e||Ne(e))return"";let t=[];return e.decimals!==void 0&&t.push(`${e.decimals} dp`),e.multiply!==void 0&&t.push(`\xD7${e.multiply}`),e.offset!==void 0&&t.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&t.push(`"${e.prefix}" first`),e.suffix&&t.push(`"${e.suffix}" after`),e.useEntityUnit&&t.push("with unit"),e.relativeTime&&t.push("as relative time"),e.duration&&t.push("as a duration"),e.textCase&&t.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),t.length===0?"":` (${t.join(", ")})`}function he(e,t){return`${cl(e,t)}${zu(e.format)}`}function cl(e,t){let n=e.kind;switch(n.kind){case"literal":return n.value?`"${pt(n.value,40)}"`:"(empty)";case"entityState":return hi(n,t);case"entityAttribute":return n.attribute?`${hi(n,t)} \xB7 ${n.attribute}`:hi(n,t);case"entityAge":return`age of ${hi(n,t)}`;case"aggregate":return Nu(n.aggregate);case"time":return _u[n.timeField];case"dataAge":return"data age";case"jinja":return n.value?`template ${pt(n.value,32)}`:"template (empty)";case"named":return n.id===""?"(no value chosen)":t?.values?.find(a=>a.id===n.id)?.name?.trim()||`named ${n.id.slice(0,8)}`;case"chartStat":{let i=(Ot.find(([o])=>o===n.stat)?.[1]??n.stat).toLowerCase();if(n.layer==="")return`${i} (no chart chosen)`;let a=t?.elements?.find(o=>o.kind==="chart"&&o.payload.id===n.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?cl(a.payload.value,t):"a missing chart";return`${i} of ${r}`}}}function Nu(e){let t=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${t}`}function xi(e,t,n){if(n<0||n>=e.length)return;let[i]=e.splice(t,1);e.splice(n,0,i)}function Pu(e,t,n,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${t.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${n==="layout"?"family":"layer"} looks.</div>`:m}
    ${t.map((o,s)=>Ou(e,o,s,t.length,n,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(vn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function Ou(e,t,n,i,a,r,o){let s=e.liveBranch(t),l=e.forced.get(t.id)??"live",d=u=>l==="live"?u==="live":l==="otherwise"?u==="otherwise":l.caseId===u,c=(u,h)=>r(f=>{let g=f.find(x=>x.id===t.id);g&&u(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${n+1}</b>
      <span class="spacer"></span>
    ...
    ${t.cases.map((u,h)=>Du(e,u,h,t,a,c,`${o}-${u.id}`))}
    ...
    ${t.otherwise?p`<div class="case-box otherwise">
          ...
          ${ul(e,t.otherwise,a,u=>c(h=>{h.otherwise&&u(h.otherwise)}),`${o}-otherwise`)}
        </div>`:m}
  </div>`}function Du(e,t,n,i,a,r,o){let s=(d,c)=>r(u=>{let h=u.cases.find(f=>f.id===t.id);h&&d(h)},c),l=e.liveBranch(i)===t.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
    ...
    ${t.when.tests.map((d,c)=>Vu(e,d,c,u=>s(h=>{let f=h.when.tests.find(g=>g.id===d.id);f&&u(f)}),()=>s(u=>{u.when.tests=u.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    ...
    ${ul(e,t.then,a,d=>s(c=>d(c.then)),`${o}-then`)}
  </div>`}function Vu(e,t,n,i,a,r){let o=(u,h)=>i(u,h?`${r}-${h}`:void 0),s=t.comparison,l=Et(s.kind),d=e.evaluateTest(t),c=m;switch(l){case"value":c=ae(e,s.value??M(""),u=>o(h=>{h.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=p`${ae(e,s.value??M(""),u=>o(h=>{h.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${ae(e,s.upper??M(""),u=>o(h=>{h.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=p`${ue("Pattern",s.pattern??"",u=>o(h=>{h.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!Bu(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:m}`;break;case"options":c=ue("Options (comma separated)",(s.options??[]).join(", "),u=>o(h=>{h.comparison.options=u.split(",").map(f=>f.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${Te("Comparison",s.kind,go.map(u=>[u,Jt[u]]),u=>o(h=>{h.comparison=ha(h.comparison,u)}))}
    ${c}
  </div>`}function Bu(e){try{return new RegExp(e),!0}catch{return!1}}function ul(e,t,n,i,a){let r=Lu(n);return p`
    ${t.length===0?p`<div class="hint">No changes.</div>`:m}
    ${t.map((o,s)=>Gu(e,o,s,n,(l,d)=>i(c=>{c[s]&&l(c[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Tt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${qa[o]}</option>`)}
    </select>`}var pl=["setColor","setBorderColor","setBackgroundColor"];function Gu(e,t,n,i,a,r,o){let s=!qn[i].includes(Ee[t.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${hl(e,t,a,o)}
  </div>`}function hl(e,t,n,i){let a=Yn(t.kind),r=m;if(a==="value"){let o=t.value??M("");if(pl.includes(t.kind)){let s=o.kind.kind==="literal";r=p`${s?re("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>n(d=>{d.value=M(l??"#FFFFFF")},"color")):ae(e,o,l=>n(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${Pu(e,t,n,i,a)}`:Uu(e,o.table,t[0],n,i,a,r)}function Uu(e,t,n,i,a,r,o){let s=(w,T)=>e.update(V=>{let P=a(V);P&&w(P)},T?`${r}-${T}`:void 0),l=t.value??zs.get(r)??o,d=t.rows.length===0,c=t.numberMode||d&&l!==void 0&&!cs(l)&&Ku(e.resolve(l)),u=qn[i],h=mi.get(r)??new Set,f=t.columns.length===0&&h.size===0?[ds[i]]:[],g=es(t.columns,[...h,...f.filter(w=>w!==void 0)],u),x=n?e.liveBranch(n):"none",$=n?e.forced.get(n.id)??"live":"live",S=w=>$!=="live"&&($==="otherwise"?w==="otherwise":$.caseId===w),E=w=>{n&&e.setForced(n.id,S(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},v=w=>{zs.set(r,w),t.rows.length!==0&&s(T=>os(T,w),"lhs")},C=()=>s(w=>as(w,l??M(""),c)),N=t.rows.map((w,T)=>Ps(e,{key:`${r}-${w.caseId}`,label:ls(w.comparison,V=>he(V,me(e))),columns:g,changes:w.changes,live:x===w.caseId,forced:S(w.caseId),onForce:()=>E(w.caseId),when:Ju(e,w.comparison,`${r}-${w.caseId}`,(V,P)=>s(le=>{let y=le[0]?.cases.find(k=>k.id===w.caseId)?.when.tests[0];y&&V(y.comparison)},P&&`${w.caseId}-${P}`)),updChanges:(V,P)=>s(le=>{let y=le[0]?.cases.find(k=>k.id===w.caseId);y&&V(y.then)},P&&`${w.caseId}-${P}`),acts:p`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>s(V=>rs(V,w.caseId))}>${z("delete")}</button>`})),B=t.otherwise===void 0?m:Ps(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:t.otherwise,live:x==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,T)=>s(V=>{let P=V[0]?.otherwise;P&&w(P)},T),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>_a(w,!1))}>${z("close")}</button>`}),j=fi.get(r),oe=Wu.filter(w=>u.includes(w)&&!g.includes(w));return p`
    <div class="states">
      ...
      ${j===void 0?m:p`<div class="hint warn confirm-row">
        Remove the ${Qe[j]} column? Its ${Ns(t,j)} value${Ns(t,j)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${w=>{fi.delete(r),mi.get(r)?.delete(j),Ie(w.target),s(T=>ss(T,j))}}>Remove</button>
    ...
    </div>`}function Ku(e){let t=(e??"").trim();return t!==""&&Number.isFinite(Number(t))}var Wu=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Ns(e,t){let n=0;for(let i of e.rows)oi(i.changes,t)&&(n+=1);return e.otherwise&&oi(e.otherwise,t)&&(n+=1),n}function ju(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Ps(e,t){return p`<tr class="state-row ${t.live?"live":""} ${t.forced?"forced":""}"
    title=${`${t.label}. Click to hold the previews on this state.`}
    @click=${n=>{ju(n)||t.onForce()}}>
    <td class="when">
    ...
    ${t.columns.map(n=>p`<td>${qu(e,n,t.changes,t.updChanges,`${t.key}-${n}`)}</td>`)}
    <td class="acts">${t.acts}</td>
  </tr>`}function qu(e,t,n,i,a){let r=oi(n,t),o=Ka(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${Qe[t]} for this state`}
      @click=${d=>{i(c=>{c.push(Tt(Qo[t]))}),Qc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let h=u.find(f=>Ee[f.kind]===t);h&&d(h)},c&&`${t}-${c}`),l=Qe[t];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Yu(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${qs}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${En.has(o)?p`${t==="visibility"?te("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):hl(e,r,s,a)}
    ...
    </div>`}function Yu(e,t){if(t.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(t.kind==="show")return p`<span class="cell-word">Shown</span>`;let n=Yn(t.kind);if(n==="number")return p`<span class="cell-word mono">${t.number??0}</span>`;if(n==="weight")return p`<span class="cell-word">${Wa.find(([r])=>r===(t.weight??"regular"))?.[1]}</span>`;let i=t.value??M(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(pl.includes(t.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?$e(a):he(i,me(e))}</span>`;if(t.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??m}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${he(i,me(e))}</span>`}function $e(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Ju(e,t,n,i){let a=Et(t.kind),r=Ha(t.kind),o=(s,l,d,c)=>Zu(e,s,l,`${n}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ve(s=>i(l=>{let d=ha(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Ia.map(s=>p`<option value=${s} ?selected=${s===t.kind}>${Xu(s)}</option>`)}
    </select>
  ...
  </span>`}function Xu(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return Jt[e]}}function Zu(e,t,n,i,a,r,o){let s=Ka(i),l={showResolved:!0,label:o,key:i};if(t.kind.kind!=="literal")return p`<span class="rhs">
    ...
    ${js(e,s,o,t,n,l)}
  </span>`}var Tn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:ra,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function bl(e){return Tn.find(t=>t.kind===e)??Tn[0]}var fl="#FF9F0A",ki="#8E8E93",Qu=["#FF453A","#FFD60A","#34C759"],vl=["#0A84FF","#34C759","#FF9F0A"];function ep(e){return e?.attributes?.device_class==="battery"?Qu:vl}var tp={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function np(e){let t=e.iconName?.trim();return t?{off:t,on:t}:tp[Ya(e)]??{off:"circle",on:"circle.fill"}}function ip(e){switch(Ya(e)){case"lock":return{kind:"equals",value:M("locked")};case"cover":case"valve":return{kind:"equals",value:M("open")};case"media_player":return{kind:"equals",value:M("playing")};default:return{kind:"isOn"}}}function Ya(e){return e.domain||e.entityId.split(".")[0]||""}function ft(e){return{...e,domain:Ya(e)}}function ap(e){let t=e?.attributes??{},n=t.min,i=t.max;if(typeof n=="number"&&typeof i=="number"&&i>n)return{min:n,max:i};let a=typeof t.device_class=="string"?t.device_class:"",r=typeof t.unit_of_measurement=="string"?t.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Qt(e){return Math.round(e*1e4)/1e4}function Lt(e,t,n){return Math.min(n,Math.max(t,e))}function Ja(e,t,n){let i=be[e],a=Lt(Qt(t/i.width),0,1),r=Lt(Qt(n/i.height),0,1);return{x:Qt((1-a)/2),y:Qt((1-r)/2),width:a,height:r,rotationDegrees:0}}function rp(e){let t=be[e],n=Lt(Math.round(Math.min(t.width,t.height)*.55),12,30);return{frame:Ja(e,n*1.3,n*1.3),size:n}}function op(e){let t=be[e],n=Lt(Math.round(Math.min(t.width,t.height)*.3),9,20);return{frame:Ja(e,t.width*.88,n*1.7),size:n}}function sp(e){let t=be[e],n=Math.min(t.width,t.height)*.9;return{frame:Ja(e,n,n),size:Math.max(2.5,Math.round(n*.2)/2)}}function xl(e){let t=e==="rectangular";return{frame:{x:.05,y:t?.34:.3,width:.9,height:t?.42:.4,rotationDegrees:0},size:2}}function lp(e){let t=be[e],n=Lt(Math.round(t.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Qt(n/t.height),rotationDegrees:0}}}function dp(e){let t=be[e],n=Lt(Math.round(Math.min(t.width,t.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Qt(Lt(n*1.5/t.height,0,1)),rotationDegrees:0},size:n}}function cp(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function up(e,t){t!==void 0&&(e.kind==="text"?e.payload.fontSize=t:e.kind==="icon"?e.payload.size=t:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=t))}function ht(e,t,n,i){let a=i(n);t.payload.frame=a.frame,up(t,a.size);for(let r of ee){if(r===n||r==="inline")continue;let o=e.perFamily[r];if(!o)continue;let s=i(r);JSON.stringify(s)!==JSON.stringify(a)&&(o.placements[t.payload.id]={frame:s.frame,isHidden:!1,...s.size!==void 0?{size:s.size}:{}})}}function mt(e){return ze(e)}function Xa(e,t){let n={kind:{kind:"entityState",...ft(e)}},i=t?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(n.format={useEntityUnit:!0}),n}function gl(e){let t=Tt("setIcon");return t.value=M(e),t}function At(e){let t=Tt("setColor");return t.value=M(e),t}function pp(e,t){let n=vn(),i=n.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...ft(e)}},a.comparison=ip(e);let r=t.on!==t.off;return i.then=r?[gl(t.on),At(fl)]:[At(fl)],n.otherwise=r?[gl(t.off),At(ki)]:[At(ki)],n}function hp(e){let t=vn(),n=t.cases[0],i=n.when.tests[0];i.value={kind:{kind:"entityState",...ft(e)}},i.comparison={kind:"isUnavailable"};let a=Tt("setOpacity");return a.number=.35,n.then=[a],t}function yl(e){let t=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(t)}function mp(e,t,n=vl){let i=t.max-t.min,a=yl(t.min+i/3),r=yl(t.min+i*2/3),o=[{comparison:{kind:"lessThan",value:M(a)},changes:[At(n[0])]},{comparison:{kind:"between",value:M(a),upper:M(r)},changes:[At(n[1])]},{comparison:{kind:"greaterThan",value:M(r)},changes:[At(n[2])]}];return ts(Xa(e),o)}function fp(e,t,n){let i=mt("icon"),a=np(t);return i.payload.symbol=M(a.off),i.payload.colorSlot.baseColorHex=ki,i.payload.rules=[pp(t,a)],ht(e,i,n.family,rp),e.elements.push(i),Kn(e,i.payload.id,{type:"toggleEntity",...ft(t)}),i.payload.id}function gp(e,t,n){let i=mt("text");return i.payload.value=Xa(t,n.state),i.payload.rules=[hp(t)],ht(e,i,n.family,op),e.elements.push(i),i.payload.id}function yp(e,t,n){let i=mt("gauge");i.payload.value=Xa(t);let a=ap(n.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[mp(t,a,ep(n.state))],ht(e,i,n.family,sp),e.elements.push(i),i.payload.id}function bp(e,t,n){let i=mt("chart");return i.payload.value={kind:{kind:"entityState",...ft(t)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",ht(e,i,n.family,xl),e.elements.push(i),i.payload.id}function vp(e,t,n){let i=mt("chart");return i.payload.value={kind:{kind:"entityState",...ft(t)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",ht(e,i,n.family,xl),e.elements.push(i),i.payload.id}function xp(e,t,n){let i=ft(t),a=mt("text");a.payload.value=M(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=ki,ht(e,a,n.family,dp),e.elements.push(a);let r=n.state?.attributes?.device_class,o=mt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Ji(i.domain,typeof r=="string"?r:void 0),ht(e,o,n.family,lp),e.elements.push(o),o.payload.id}function wp(e,t,n){let i=mt("image");return i.payload.entity=ft(t),ht(e,i,n.family,cp),e.elements.push(i),i.payload.id}function wl(e,t,n,i){switch(t){case"toggle":return fp(e,n,i);case"status":return gp(e,n,i);case"gauge":return yp(e,n,i);case"chart":return bp(e,n,i);case"history":return vp(e,n,i);case"doorHistory":return xp(e,n,i);case"camera":return wp(e,n,i)}}var $p=3e4,Cp=500,kl="preset-entity",Sp={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Za(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Ep(e){return e.kind==="family"?"look":"content"}function Tp(e){let t=e.document?.supportedFamilies;return Array.isArray(t)?t.filter(n=>typeof n=="string"):[]}var $l=300,Cl=400,Sl=52,El=36,Fp=[1,1.7,2.6],Rp=["S","M","L"],Tl=["Small","Medium","Large"],Fl="wrist-assistant-panel.layers.v1",nt=34,_t=200,Mp=720,$i=320,Ip=80,Hp=56,Rl="wrist-assistant-panel.columns.v2",Qa=e=>Math.max(_t,Math.min(Mp,Math.round(e))),Ml=e=>e.metaKey||e.ctrlKey||e.shiftKey,Ap=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Fn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",De=Fn==="Cmd"?"\u2318":"Ctrl+",er=Fn==="Cmd"?"\u21E7":"Shift+";function Il(e,t,n){if(e<=0)return{columns:3,left:t,right:n};let i=e-Ip;if(i>=_t*2+$i){let r=i-$i,o=t,s=n;if(o+s>r){let l=r/(o+s);o=Math.max(_t,Math.floor(o*l)),s=Math.max(_t,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(_t,o-d):s=Math.max(_t,s-d))}return{columns:3,left:o,right:s}}let a=e-Hp;return a>=_t+$i?{columns:2,left:Math.min(t,a-$i),right:n}:{columns:1,left:t,right:n}}var I=class I extends at{constructor(){super(...arguments);this.narrow=!1;this.colLeft=$l;this.colRight=Cl;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.previewCase=$n.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=jo(()=>this.requestUpdate());this.imageSizes=qo(()=>this.requestUpdate());this.symbols=new ii(()=>this.requestUpdate());this.keyHandler=n=>this.onKey(n);this.heldArrows=new Set;this.keyUpHandler=n=>{this.heldArrows.delete(n.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.sizeObserver=new ResizeObserver(n=>{let i=n[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=n=>{this.draft?.dirty&&n.preventDefault()};this.pickerOutside=n=>{n.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.presetKeys={handleEvent:n=>{n.key==="Enter"&&(this.presetEntity===void 0||Us(kl)||(n.preventDefault(),n.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Fi`
    :host {
      ...
      --wa-text: ${fe(pe.text)};
      --wa-icon: ${fe(pe.icon)};
      --wa-gauge: ${fe(pe.gauge)};
      --wa-shape: ${fe(pe.shape)};
      --wa-image: ${fe(pe.image)};
      --wa-tap: ${fe(pe.tap)};
    ...
    * { box-sizing: border-box; }
    ...
    .layers { display: flex; flex-direction: column; gap: 6px; --thumb-w: ${Sl}px; --thumb-h: ${El}px; }
    ...
    .layer.held {
      border-color: color-mix(in srgb, ${fe(Q.group)} 70%, var(--wa-line));
      background: color-mix(in srgb, ${fe(Q.group)} 10%, var(--wa-panel));
    }
    .layer.held .thumb { border-color: color-mix(in srgb, ${fe(Q.group)} 60%, var(--wa-line)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${fe(Q.locked)}; filter: drop-shadow(0 0 4px ${fe(Q.locked)}); }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let n=window.localStorage.getItem(Rl);if(!n)return;let i=JSON.parse(n);typeof i.left=="number"&&(this.colLeft=Qa(i.left)),typeof i.right=="number"&&(this.colRight=Qa(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Rl,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let n=window.localStorage.getItem(Fl);if(!n)return;let i=JSON.parse(n);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Fl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(n){return p`<div class="gutter ${n}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>al(s,o,i))}>Copy the ${J(o)} layout</button>`)}
          </div>
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Fa.map(s=>p`<button class="add" style=${`--k:${pe[s]}`} ?disabled=${i} title=${`Add a blank ${Yt[s].toLowerCase()} layer`}
              @click=${()=>{let l=ze(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?p`<span class="well">${ps(s)}</span>`:m}<span class="add-name">${z(s)}<span>${Yt[s]}</span></span></button>`)}
          </div>
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Fe(w,d)}</b>
          <small><span class="kind">${Yt[w.kind]}</span> · ${Np(w,c,this.historySeries,y.size)}</small>
          ${C?p`<span class="facts">${_p(this.host(),a,w,y).map(O=>p`<span class="fact"><b>${O.label}</b> ${O.value}</span>`)}</span>`:m}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?p`<span class="acts">
            ...
            <button class="icon" title=${`${y.isHidden?"Show":"Hide"} (${er}${De}H)`} aria-label=${y.isHidden?"Show this layer":"Hide this layer"} @click=${O=>{O.stopPropagation(),this.mutate(se=>Ce(se,a,P,{isHidden:!y.isHidden}))}}>${z(y.isHidden?"hide":"show")}</button>
      ...
      </div>`},B=(w,T)=>{let V=this.inspect.kind==="group"&&this.inspect.id===w.id,P=!this.collapsed.has(w.id),le=this.rowDrag(w.id,i),y=T[0],k=T[T.length-1],q=H=>{let D=H.currentTarget,O=D.getBoundingClientRect(),se=O.top+(D.classList.contains("drop-before")?nt:0),en=O.bottom-(D.classList.contains("drop-after")?nt:0),ne=(H.clientY-se)/Math.max(1,en-se);return ne<.25?"drop-before":!P&&ne>.75?"drop-after":"drop-into"},G=T.map(H=>H.payload.id);return p`<div class="layer group ${V?"hl":""} ${C?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${le.draggable}
        ...
        @drop=${H=>{H.preventDefault();let D=q(H);this.clearDragMarks();let O=this.dragId;if(this.dragId=void 0,!(!O||!y||!k)){if(D==="drop-before"){this.reorderLayer(O,y.payload.id,!0,!0);return}if(D==="drop-after"){this.reorderLayer(O,k.payload.id,!1,!0);return}this.isGroupId(O)||(this.reorderLayer(O,y.payload.id,!0),this.mutate(se=>na(se,O,w.id)))}}}>
        ...
        <span class="right">
          ...
          <button class="icon lockbtn ${w.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${H=>{H.stopPropagation(),this.mutate(D=>{let O=D.groups?.find(se=>se.id===w.id);O&&(O.locked=!O.locked)})}}>${z(w.locked?"lock":"unlock")}</button>
        </span>
      </div>`},j=[],oe=new Set;for(let w=0;w<l.length;w++){let T=l[w],V=T.payload.groupId,P=V===void 0?void 0:n.groups?.find(k=>k.id===V);if(!P){j.push(N(T,!1));continue}if(oe.has(P.id))continue;oe.add(P.id);let le=l.filter(k=>k.payload.groupId===P.id);j.push(B(P,le));let y=this.inspect.kind==="group"&&this.inspect.id===P.id;this.collapsed.has(P.id)||j.push(p`<div class="group-kids">${le.map(k=>N(k,!0,y))}</div>`)}return p`<div class="card">
      <h2 class="panel-title tools"><span class="swatch">${z("layers")}</span>Layers<span class="spacer"></span>
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${Rp.map((w,T)=>p`
              <button class=${this.thumbStep===T?"on":""} title=${`${Tl[T]} row pictures`}
                aria-label=${`${Tl[T]} row pictures`} aria-pressed=${this.thumbStep===T?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let n=this.presetKind?bl(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${n===void 0?m:p`
        <h2>${n.title}</h2>
        <div class="hint">${n.blurb}</div>
        ${et(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},kl,{compact:!0,...n.domains?{domain:n.domains}:{},...n.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
      ...
      <div class="settings" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${Qs(i)}</div>
      <div class="values-list">
        <div class="values-head"><span class="sub">Shared values</span>
          ${this.canEdit?p`<button class="small" @click=${()=>{let c=nl();this.mutate(u=>{u.values.push(c)}),this.inspect={kind:"data",id:c.id}}}>Add</button>`:m}
      ...
      ${l===m?m:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(n,i)}</div>`;let a=this.host(),r=this.inspect,o=m,s=!0;if(r.kind==="layer"){let d=n.elements.find(c=>c.payload.id===r.id);if(!d)return this.inspect={kind:"general"},m;o=ol(a,d,this.canvasFamily)}else if(r.kind==="group"){let d=n.groups?.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=ll(a,d)}else if(r.kind==="data"){let d=n.values.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${Q.complication}`}>
        ...
        <div class="sec-b">${tl(a,d)}</div>
      </div>`}else r.kind==="family"?o=dl(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${z("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(n)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([Ep(r)]):new Set(Ua)}}>${l?"One at a time":"Open all"}</button>`:m}
      </div>
      ...
      <span>${n}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:m}</span></label>`}multiEditor(n,i){let a=this.canvasFamily,r=me(this.host()),o=new Ze(this.buildContext(),this.draft?.config),s=rl(n,a,i),l=i.length,d=[...i].reverse(),c=h=>this.mutate(f=>{for(let g of i)Ce(f,a,g.payload.id,{isHidden:h})}),u=h=>this.mutate(f=>{for(let g of i){let x=f.elements.find($=>$.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
      <div class="sec" data-open="true" style="--c:var(--wa-accent)">
        ...
        <div class="sec-b">
          <div class="picked">
            ${d.map(h=>p`<div class="row" style=${`--k:${pe[h.kind]}`}>
              <span class="bar"></span>
              <span class="name">
      ...
      </div>`}renderFooter(){let n=this.draft;if(!n)return m;let i=this.records.find(r=>r.id===this.selectedId),a=Jo({revision:i?.revision??null,dirty:n.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return p`<details class="foot">
      <summary>
