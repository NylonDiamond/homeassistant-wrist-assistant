...
`)}function Zd(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Am(r));return{values:t,nullKeys:i}}function Am(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Vo(e){let n=Ia(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Im(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(eo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Hm=10800;function Lm(e,n,t){let i=n==="always"||n==="auto"&&t<=Hm;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Go(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Lm(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function _m(e,n){return Bt(e)===void 0?[]:Go(st(e)*60,va(e.timeLabelCount),e.hourCycle,e.minutes,n)}function zm(e,n){return pn(e)?Go(Math.round(e.historyMinutes)*60,va(ft(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Nm(e,n,t){return n===void 0||!pn(n)?[]:Go(Math.round(n.historyMinutes)*60,va(ft(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function $n(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ge(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:$n(i)}function Pm(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Dm(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Om(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?$n(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=$n(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Vm(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Bm(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Gm(e,n,t){if(Ae(n))return e;let i=n,a=e,r=$n(e.trim()),o=i.duration?Om(e):void 0;if(o!==void 0)a=Vm(o);else if(i.relativeTime&&r!==void 0)a=Dm(r);else{let s=Ge(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Pm(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Bm(a);break}return a}function Qn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Je(e,n=240){return ic(e,n).map(t=>t.value)}function Uo(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Je(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:nc(r)}}function nc(e){return e.some(n=>n)?e:[]}function ic(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Qd(e,n,t){let i=ic(e),a=i.map(g=>g.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Pt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??oe,c=t.highColorHex??qe,u=t.lowColorHex??Ye,p=[],m=(g,x)=>{if(g==="")return;let k=p.at(-1);k&&k.colorHex===x?k.text+=g:p.push({text:g,colorHex:x})},b=0;return i.forEach((g,x)=>{m(e.slice(b,g.start),n);let k=x===o?c:x===s?u:l.length>0?ya(g.value,l,d):n,C=e[g.end-1]==="."?g.end-1:g.end;m(e.slice(g.start,C),k),b=C}),m(e.slice(b),n),p}function ec(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Um(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function _i(e,n=Vt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Km(i.slice(a+1))})}return t}function Km(e){try{return decodeURIComponent(e)}catch{return e}}function Wm(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function tc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function jm(e,n,t){if(e===void 0)return 0;let i=Ge(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var dt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=ec(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=hn(n),i=mn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Uo(a):{values:Je(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=nc(s),{values:Ko(o,nt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ge(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ge(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):ec(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ae(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Im(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?rd(r):eo(r,a.domainMax-a.domainMin));break}default:{let a=Oo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Gm(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=$n(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Qn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ge(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ge(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ge(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:vn(d),p=c===void 0?void 0:vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(_e[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Qd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,b=gt(n.payload)&&!r.has("text"),g={kind:"text",...u,text:b?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(g.countdownEnd=p),b?(g.parts=this.resolveTextParts(n.payload.parts,i.rules,g,t),g.text=g.parts.map(x=>x.text).join(""),g):(ed(n.payload)&&(g.spans=Qd(g.text,g.colorHex,n.payload)),g)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),b=n.payload.symbol.kind.kind==="literal",g=m===void 0&&b&&n.payload.path!==""?n.payload.path:void 0,x=m??p;g===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let k={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(k.path=g),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),b=(I,L,Z)=>I??(L?Ge(this.resolve(L)??""):void 0)??Z,g=b(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=b(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Ge(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=ya(k,Pt(p),p.bandAboveColorHex));let $=x-g;if(p.total){let I=Ge(this.resolve(p.total)??"");I!==void 0&&($=I)}let S=tc($,1,ga),N={kind:"gauge",...u,fraction:jm(m,g,x),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:tc(k??0,0,S)};if(p.thresholdValue!==void 0&&x!==g){let I=(p.thresholdValue-g)/(x-g);I>=0&&I<=1&&(N.thresholdFraction=I)}return N}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),b=m.values,g=m.holes,x={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Pt(p),$=ad(p)?b.map(X=>ya(X,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",N=p.highlight==="lowest"||p.highlight==="both",I=xi(p),L={kind:"chart",...u,values:b,holes:g,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?I.high:"none",lowMarker:N?I.low:"none",pointColorHexes:$,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:nt(p.smoothing)??"off",fillStyle:Lt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:_t(p.barRadius),barCorners:zt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:zm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},Z=g.length===0?b:b.filter((X,U)=>!g[U]);if(Z.length>0){let X=A=>b.findIndex((K,y)=>K===A&&g[y]!==!0),U=S?X(Math.max(...Z)):-1,ee=N?X(Math.min(...Z)):-1;U>=0&&(L.highIndex=U),ee>=0&&ee!==U&&(L.lowIndex=ee)}let T=Um(p,x.min,x.max);T!==void 0&&(L.thresholdY=T);let D=this.chartNowIndex(p,b.length);return D!==void 0&&(L.nowIndex=D),L}case"timeline":{let p=n.payload,m=Bt(p),b=m===void 0?"":this.ctx.historySeries?.get(m)??"",g=_i(b,Vt),x=Wm(g,st(p)*60,C=>pd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:_m(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};yt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Nm(p,this.chartElements.get(p.chart),this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"chartDots":{let p=n.payload,m=mt(p.size),b={kind:"chartDots",...u,chart:p.chart,dots:ma(p.dots),diameter:0,indices:[]};return m!==void 0&&(b.size=m),p.colorHex!==void 0&&(b.colorHex=p.colorHex),b}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Dn(p.lines),colorHex:At(p.colorHex),thickness:On(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...Qm(Zm(Ad(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,k=this.resolve(x.value),C=k===void 0?void 0:Ge(k);if(C!==void 0){let $=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),N={value:Math.min(S,Math.max($,C)),minValue:$,maxValue:S===$?$+1:S,colorHexes:x.colorHexes},I=this.resolve(x.minLabel);I!==void 0&&(N.minLabel=I);let L=this.resolve(x.maxLabel);L!==void 0&&(N.maxLabel=L),l.bezelGauge=N}}let b=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;b!==void 0&&(l.backgroundColorHex=b);let g=this.styleColor(s,"borderColor")??a?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function qm(e,n,t){let i=new dt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function zi(e,n,t){let i=new dt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=qm(e.inline,n,e)),a}function Ha(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Bo=5,Ym=1.7,Xm=1.8;function Jm(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Zm(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Xm,l=Math.max(o.frame.width*n.width,0),d=Jm(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function ac(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function rc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function La(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=L=>L==="triangle"?Bo+d:L==="dot"?Math.max(d,Ym):d,u=c(a),p=c(r),m=n.y+u,b=Math.max(n.h-u-p,1),g=m+b,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?b*.12:0,$=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-$*(i-1))/i,.5),N=L=>Math.min(1,Math.max(0,(L-e.domainMin)/x)),I=L=>g-N(L)*b;return{count:t.length,barWidth:S,plotTop:m,plotBottom:g,plotLeft:o,plotRight:o+s,baselineY:k?g:I(0),inset:d,yAtFraction(L){return g-Math.min(Math.max(L,0),1)*b},barRect(L){let Z=o+L*(S+$),T=t[L],D,X;if(k){let U=C+N(T)*(b-C);D=g-U,X=g}else D=I(T),X=k?g:I(0),D>X&&([D,X]=[X,D]);return{x:Z,y:D,w:S,h:Math.max(X-D,.5)}},point(L){let Z=Math.max(s-d*2,0);return{x:t.length>1?o+d+Z*L/(t.length-1):o+s/2,y:I(t[L])}},markerCenter(L,Z,T="high"){let D=Z?this.barRect(L):void 0,X=D?D.x+D.w/2:this.point(L).x,U=T==="high"?a:r,ee=T==="high"?U==="triangle"?n.y+Bo/2:m:U==="triangle"?n.y+n.h-Bo/2:g;return{x:X,y:ee}}}}function oc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Ko(e,n,t=[]){let i=e.length,a=Ql(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,b=0;for(let g=Math.max(0,p-r);g<=Math.min(i-1,p+r);g++){if(s(g))continue;let x=g-p,k=Math.exp(-(x*x)/(2*o*o));m+=e[g]*k,b+=k}return m/b}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function sc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Li=1;function ei(e,n){let t=Math.max(Un,Math.min(Kn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Li>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Li:n.y,h:n.h-i-Li,cy:(e.labelsAbove?n.y+i+Li:n.y)+(n.h-i-Li)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function Qm(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&ac(r)===void 0)return{...i,isHidden:!0};let o=tf(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function ef(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function tf(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Ha(t,i);if(a.w<=0||a.h<=0)return;let r=ei(t,a).body;if(r.w<=0||r.h<=0)return;let o=La(t,r),s,l;if(Nt(n.at)){let k=ef(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?ac(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,$)=>C>$?(C+$)/2:Math.min(Math.max(k,C),$),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let b=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,g=p(b,r.y+c/2,r.y+r.h-c/2),x=p(g+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Ie=pe,Ni=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ie,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],ti=Ni.find(e=>e.measured);function yc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Ni.find(a=>a.screen.width===t&&a.screen.height===i)}function za(e,n){let t=Ie[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Yo={regular:400,medium:500,semibold:600,bold:700},nf=1.15;function Ue(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ge(e,n,t="#FFFFFF"){let i=Ue(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var kt=e=>e*.55;function bc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function af(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function rf(e,n,t){if(t<=0||e.length*kt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/kt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function of(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function xc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function vc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function sf(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function wc(e,n){return e.reduce((t,i)=>t+i.text.length*kt(i.look.fontSize*n),0)}function lf(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:kt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=kt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function df(e,n,t){if(t<=0||wc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*kt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*kt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function cf(e,n,t){let i=sf(n),a=e.lineLimit===2&&t.w>0?lf(e.text,i,t.w):[e.text],r=xc(e.text,a),o=a.map((C,$)=>vc(C,r[$]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>wc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>df(C,l,t.w)),{anchor:c,x:u}=bc(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,b=p*1.15,g=C=>C.map($=>{let S=ge($.look.colorHex,"fill");return v`<tspan font-size=${$.look.fontSize*l} font-weight=${Yo[$.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}),x=ge(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,$)=>v`<tspan x=${u} y=${t.cy+m+($-(d.length-1)/2)*b}>${g(C)}</tspan>`)}`:g(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${k}</text>`}function uf(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(g=>g.text).join("")===e.text)return e.text===""?f:cf(e,e.parts,n);let t=ge(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Qn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?af(e.text,n.w/kt(e.fontSize)):[e.text],a=Math.max(...i.map(g=>g.length))*kt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(g=>rf(g,o,n.w)),{anchor:l,x:d}=bc(e.alignment,n),c=of(e.text,e.spans),u=c?xc(e.text,i):[],p=(g,x)=>c?vc(g,u[x]??0,e.text,c,e.colorHex).map(k=>{let C=ge(k.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}):g,m=o*1.15,b=s.length>1?v`${s.map((g,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(g,x)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${Yo[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${b}</text>`}var Wo=2;function pf(e,n){let t=ge(e.colorHex,"stroke"),i=ge(e.trackColorHex,"stroke","#FFFFFF"),a=ge(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,b=Math.max(1,e.dotCount),g=m?n.w:n.h,x=m?n.h:n.w,k=Math.max(1,Math.min(x,g/b-Wo)),C=b*k+(b-1)*Wo,$=(m?n.cx:n.cy)-C/2+k/2;return v`${Array.from({length:b},(S,N)=>{let I=$+N*(k+Wo),L=N<e.filledCount?t:i;return v`<circle cx=${m?I:n.cx} cy=${m?n.cy:I} r=${k/2}
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function mf(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ei(e,n),o=r?es(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=gf(e,a);return o===void 0?s:v`${s}${o}`}function jo(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var lc=0;function kc(){return lc+=1,lc.toString(36)}function ff(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function gf(e,n){let t=La(e,n),i=kc(),a=ge(e.colorHex,"fill"),r=ge(e.highColorHex,"fill",e.colorHex),o=ge(e.lowColorHex,"fill",e.colorHex),s=(b,g)=>v`<circle cx=${b.x} cy=${b.y} r="1.7" fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=b=>c?ge(e.pointColorHexes[b],"fill",e.colorHex):a,p=b=>{let g=Ue(b)??Ue(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:g.color,opacity:g.opacity*.28};let x=yf(i,e.id,b),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,v`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${g.color} stop-opacity=${g.opacity*.28} />
        <stop offset="1" stop-color=${g.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let b=0;b<t.count;b++){if(e.holes[b]===!0)continue;let g=t.barRect(b),x=b===e.highIndex?r:b===e.lowIndex?o:u(b),k=Math.min(Math.max(e.barRadius,0),g.w/2,g.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[b]<0;l.push(v`<path d=${ff(g,k,C)}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else l.push(v`<rect x=${g.x} y=${g.y} width=${g.w} height=${g.h} rx=${k}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let b=Array.from({length:t.count},(C,$)=>t.point($)),g=e.holes.length>0,k=sc(t.count,e.holes).filter(C=>!g||C.length>1).map(C=>{let $=C.map(I=>b[I]),S=oc($,e.curve),N=`M${$[0].x} ${$[0].y}${S.map(I=>` ${jo(I)}`).join("")}`;return{run:C,pts:$,legs:S,line:N}});if(e.style==="area")for(let{run:C,pts:$,legs:S,line:N}of k)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let I=0;I<S.length;I++){let L=$[I],Z=$[I+1],T=p(e.pointColorHexes[C[I+1]]),D=`M${L.x} ${L.y} ${jo(S[I])} L${Z.x} ${t.baselineY} L${L.x} ${t.baselineY} Z`;l.push(v`<path d=${D} fill=${T.fill} fill-opacity=${T.opacity} stroke="none" />`)}else{let I=p(e.fillColorHex??e.colorHex),L=`${N} L${$[$.length-1].x} ${t.baselineY} L${$[0].x} ${t.baselineY} Z`;l.push(v`<path d=${L} fill=${I.fill} fill-opacity=${I.opacity} stroke="none" />`)}for(let{run:C,pts:$,legs:S,line:N}of k)if(c&&C.length>1)for(let I=0;I<S.length;I++){let L=$[I],Z=u(C[I+1]);l.push(v`<path d=${`M${L.x} ${L.y} ${jo(S[I])}`} fill="none"
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+g,d+g+Math.max(s,3),e.maxLabel):f}`}function Oa(e,n){let t=e.family in Ie?e.family:"rectangular",i=n.slot??Ie[t],a=Ie[t],r=za(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ue(e.backgroundColorHex),l=Ue(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Cc(c);if(t==="corner"){let x=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",$=C!=="",S=Da(x,k),N=ns(x,k),I=N/(a.width*x),L=S.tile.cx-N/2,Z=S.tile.cy-N/2,T=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,D=f;if(e.bezelGauge)D=Lf(e.bezelGauge,x,o);else if(e.bezelText){let U=Ff(x,`${o}-bezel`),ee=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Qn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;D=v`<defs><path id=${U.id} d=${U.d} /></defs>
        <text font-size=${dc*x} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${U.id}" startOffset="50%" text-anchor="middle">${uc(ee,U.length,dc*x)}</textPath></text>`}let X=f;if($){let U=Ue(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ee=Tc(x,`${o}-curved`,Af*x,If);X=v`<defs><path id=${ee.id} d=${ee.d} /></defs>
        <text font-size=${pc*x} font-weight="600" fill=${U.color} fill-opacity=${U.opacity}
          ...
          <textPath href="#${ee.id}" startOffset="50%" text-anchor="middle">${uc(C,ee.length,pc*x*.88)}</textPath></text>`}else{let U=e.borderWidth*r.scale*I,ee=l?v`<circle cx=${N/2} cy=${N/2} r=${N/2-U/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${U} />`:f;X=v`<g transform="translate(${L} ${Z})">
        <g clip-path=${`url(#${o})`}>
          ${s?v`<rect width=${N} height=${N} fill=${s.color} fill-opacity=${s.opacity} />`:f}
          <g data-design-box transform="scale(${r.scale*I})">
            ${c.map(A=>Jo(A,a,n,u))}
          </g>
        </g>
        <circle cx=${N/2} cy=${N/2} r=${N/2} fill="none"
      ...
      <defs><clipPath id=${o}><circle cx=${N/2} cy=${N/2} r=${N/2} /></clipPath></defs>
    ...
    <path d=${eu(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
        ...
        <text x="6" y="39" font-family=${Oi} font-size="7" fill=${ut}>1h ago</text>
        <text x="114" y="39" font-family=${Oi} font-size="7" text-anchor="end" fill=${ut}>now</text>
    ...
    <textarea rows=${i} .value=${n} class="mono" @input=${ye(t)}></textarea></label>`}function ae(e,n,t,i={}){return h`<label class="field num">${ze(e,jt(n,i.def,t),gr(n,t,i))}${yr(n,t,i)}</label>`}function yr(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e),a=h`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??f} max=${t.max??f}
      ...
      @input=${ye(r=>{if(r.trim()===""){t.optional&&n(void 0);return}let o=Number(r);Number.isNaN(o)||n(o)})} />`;return t.unit===void 0&&t.lead===void 0?a:h`<span class=${t.lead===void 0?"num-box":"num-box lead"} style=${`--wa-unit:${t.unit?.length??0}`}>${t.lead===void 0?f:h`<span class="lead" aria-hidden="true">${t.lead}</span>`}${a}${t.unit===void 0?f:h`<span class="unit" aria-hidden="true">${t.unit}</span>`}</span>`}function Me(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<label class="field">${ze(e,jt(n,a.def,i,r))}
    <select @change=${ye(o=>i(o))}>
      ${t.map(([o,s])=>h`<option value=${o} ?selected=${o===n}>${s}</option>`)}
    </select></label>`}function ne(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<div class="field seg-field">${ze(e,jt(n,a.def,o=>i(o,null),r))}
    ...
    </div>`}function dg(e,n){let t=i=>jt(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${ze(e.label,t(e))}
    <div class="pair-row">
      ${sr(e.label,e.value,e.options,e.set,e)}
      ${ze(n.label,t(n))}
      ${sr(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function ri(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${ze(e,jt(n,i.def,t,a),gr(n,t,i))}
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${$=>{let S=$.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),En.set(a,{query:"",index:0}),Ee(S),S?.focus()}}>${B("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Du(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map(($,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${N=>N.preventDefault()} @click=${N=>b($,N.target)}>
    ...
    <span class="sym-name">${n}</span>
  </button>`}function Ou(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(De),m=a!==void 0,b=m?r.pack(i)??(p?"mdi":"sf"):"sf",g=xg(u,c),x=$=>{t($),a?.($.startsWith(De)?e.icons.mdiPath?.($):void 0),r.noteUsed($)},k=$=>{if(t($),!m)return;let S=$.trim();a?.(S.startsWith(De)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&b==="mdi"){let $=e.icons.mdiNames?.(),S=vg($??[],s),N=S.slice(0,yu),I=r.recent.filter(L=>L.startsWith(De));C=h`<div class="sym-browse">
      ${vu(r,i,b)}
      ...
      ${I.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${I.map(L=>Za(e,L,L===u,x))}</div>`}
      <div class="sym-grid">${N.map(L=>Za(e,L,L===u,x))}</div>
      ${$===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${xu(N.length,S.length,!0,$.length)}</div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${ye(k)} @change=${ye($=>{let S=$.trim();S.startsWith(De)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed($):(c.size===0||c.has(S))&&r.noteUsed($)})} /></label>
    ...
    ${C}`}function xg(e,n){let t=e.trim();return t!==""&&!t.startsWith(De)&&n.size>0&&!n.has(t)}function vg(e,n){let t=n.trim(),i=t.startsWith(De)?t.slice(De.length):t,a=e.map(r=>r.startsWith(De)?r.slice(De.length):r);return ss(a,i).map(r=>De+r)}function vu(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
    ...
    ${Yi.has(n)?Ku(e,i,a,r):f}
        ...
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Ri(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            ...
            or choose another source and click Make shared.</div>`:h`${Me("Value",a.id,[["","(choose)"],...e.config.values.map(p=>[p.id,p.name||p.id.slice(0,8)])],p=>r({...a,id:p}))}
          ...
          ${Me("Chart",a.layer,[["","(choose)"],...u.map(p=>[p.payload.id,Re(p,c)])],p=>r({...a,layer:p}))}
          ${Me("Number",a.stat,[...Bn],p=>r({...a,stat:p}))}
    ...
    ${Me("Function",n.function,[["count","Count"],["sum","Sum"],["average","Average"],["min","Min"],["max","Max"]],s=>t({...n,function:s}))}
    ...
    <div class="gen-row">
      ...
      ${Me("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Me("Tap action",t.type,ju,s=>e.update(l=>{l.tapAction=qu(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function my(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function fy(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${uy(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Mn(e,n=un){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function gy(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Dt}, so they are averaged into ${Dt} even slots to cover ${a}.`}var or=new Set;function As(e,n,t=un){return or.has(e)||!t.some(i=>i.minutes===n)}function Ss(e,n,t,i,a=un){let r=As(e,n,a);return h`<label class="field">${ze("Span",{atDefault:n===t&&!r,title:`Back to ${Mn(t,a)}`,reset:()=>{or.delete(e),i(t)}})}
      <select @change=${o=>{let s=o.target.value;s==="custom"?(or.add(e),Ee(o.target)):(or.delete(e),i(Number(s)||ba))}}>
        ${a.map(({minutes:o,label:s})=>h`<option value=${String(o)} ?selected=${!r&&o===n}>${s}</option>`)}
        <option value="custom" ?selected=${r}>Custom…</option>
      </select></label>`}function Ts(e,n,t=!1){let i=t?to:xa,a=Math.floor(i/1440),r=t?Si:un,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <div class="hint">${t?h`${Mn(e,r)}, up to 366 days. Statistics rows are never
          ...
          ten by default, and a longer span would quietly come back short.`}</div>`}function yy(e){if(e.historyMinutes<=0)return"";if(e.source!=="statistics")return` \xB7 ${Mn(e.historyMinutes)}`;let n=fa.find(([t])=>t===e.statPeriod)?.[1]??e.statPeriod;return` \xB7 ${Mn(e.historyMinutes,Si)} \xB7 per ${n.toLowerCase()}`}function Ps(e,n){let t=ue(e);switch(n.kind){case"text":{let i=n.payload.parts?.length??0;return gt(n.payload)?`Rich text, ${i} part${i===1?"":"s"}`:Oe(ve(n.payload.value,t),48)}case"icon":return Oe(ve(n.payload.symbol,t),48);case"gauge":return Oe(ve(n.payload.value,t),48);case"chart":return Oe(`${ve(n.payload.value,t)}${yy(n.payload)}`,48);case"timeline":return Oe(`${ve(n.payload.value,t)} \xB7 ${Mn(st(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return bt(n.payload.action);case"chartTimes":{let i=e.config.elements.find(a=>a.payload.id===n.payload.chart);return i?.kind==="chart"?Oe(`Times of ${ve(i.payload.value,t)}`,48):"No chart"}case"chartDots":case"chartGrid":{let i=e.config.elements.find(r=>r.payload.id===n.payload.chart),a=n.kind==="chartDots"?"Dots on":"Grid behind";return i?.kind==="chart"?Oe(`${a} ${ve(i.payload.value,t)}`,48):"No chart"}}}function pr(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Te(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Te(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Te(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Te(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Te(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Te(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Te(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return;case"chartTimes":return`${e.payload.timeLabelCount<=0?"no":e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt \xB7 ${Te(e.payload.labelColorHex)}`;case"chartDots":{let n=e.payload;return`${n.dots==="all"?"all":"auto"} \xB7 ${n.size===void 0?"automatic size":`${n.size} pt`} \xB7 ${n.colorHex===void 0?"series colour":Te(n.colorHex)}`}case"chartGrid":{let n=e.payload;return`${n.lines} ${n.lines===1?"line":"lines"} \xB7 ${n.thickness} pt \xB7 ${Te(n.colorHex)}`}}}function Ki(e,n,t,i,a,r){let o=Math.round(t*1e3)/10,s=l=>i(l/100);return h`<label class="pf">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function by(e,n,t){let i=n.payload.id,a=`el-${i}`,r=He(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Ce(p,t,i,{frame:fs(o,c)}),`${a}-${u}-${t}`),l=!ur(o,$i)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return xe(e,"placement","Position",h`
      ...
      ${Ve("Hidden",r.isHidden,u=>e.update(p=>Ce(p,t,i,{isHidden:u})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${te(t)}`})}return d?.place==="through"?xe(e,"placement","Position",h`
      ...
      ${Ve("Hidden",r.isHidden,c=>e.update(u=>Ce(u,t,i,{isHidden:c})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${te(t)}`}):xe(e,"placement","Position",h`
    ${Tu(e,n,t)}
    ${d===void 0?h`
    ...
    <div class="hint">${d===void 0?"X, Y, W and H are":"W and H are"} a percent of the face, on the ${te(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:Q.position,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${te(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${te(t)} face at half size, unrotated and shown`,reset:()=>e.update(c=>Ce(c,t,i,{frame:{...$i},isHidden:!1}))}:{}})}function Tu(e,n,t){let i=n.payload.chartAnchor;if(i===void 0)return f;let a=n.payload.id,r=`el-${a}-anchor`,o=e.config.elements.filter(c=>c.kind==="chart"),s=(c,u)=>e.update(p=>{let m=p.elements.find(b=>b.payload.id===a);m?.payload.chartAnchor&&c(m.payload.chartAnchor)},u?`${r}-${u}`:void 0),l=ue(e),d=!o.some(c=>c.payload.id===i.layer);return h`
    ${o.length<2?f:Me("Follows",i.layer,o.map(c=>[c.payload.id,Re(c,l)]),c=>s(u=>{u.layer=c}))}
    ${Me("Reading",i.at,dn,c=>e.update(u=>{let p=u.elements.find(b=>b.payload.id===a);if(!p?.payload.chartAnchor)return;p.payload.chartAnchor.at=c;let m=u.elements.find(b=>b.payload.id===i.layer);m?.kind==="chart"&&(c==="threshold"&&m.payload.thresholdValue===void 0&&(m.payload.thresholdValue=Vu(Je(e.resolve(m.payload.value)??"")),m.payload.drawsThreshold=!1),c==="now"&&m.payload.nowIndex===void 0&&(m.payload.nowIndex={kind:{kind:"time",timeField:"hour"}},m.payload.drawsNowLine=!1))}),{def:"highest"})}
    ${xy(e,i,r)}
    ${i.place==="through"?f:Me("Sits",i.place,Xr.filter(([c])=>c!=="through"),c=>s(u=>{u.place=c}),{def:"above"})}
    <div class="grid2">
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function vy(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Be(e.config,t)[0];return xe(e,"tappable","Tap",Ky(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?bt(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Ta(a,t))}:{}})}function Eu(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${wy.map(([g,x])=>h`<button type="button" role="radio" aria-checked=${g===d?"true":"false"}
          ...
          @click=${()=>{g!==d&&a(k=>$y(k,o,g))}}>${x}</button>`)}
      </span>
    ...
    ${ne("Colour",a,Fs,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=dr(Je(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    ${p===void 0?f:h`<div class="rich-confirm" role="alertdialog" aria-label=${g}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${x=>{Wi.delete(o),Ee(x.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ...
    ${s==="rich"?Ny(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Re(d,ue(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Ny(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ue(e),d=Math.max(0,o.findIndex(A=>A.id===qi.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=He(e.config,t,n).size??r.fontSize,b=(A,K)=>{$t.delete(s),i(y=>{A(y),td(y)},K)},g=(A,K)=>b(y=>{let w=y.parts?.find(E=>E.id===c.id);w&&A(w)},K?`part-${c.id}-${K}`:void 0),x=(A,K)=>{qi.set(s,A),$t.delete(s),Ee(K)},k=(A,K)=>{let y=J();qi.set(s,y),b(w=>{(w.parts??=[]).push({id:y,value:A})}),Gu(K,xr(`${a}-part-${y}`),!0)},C=A=>b(K=>{K.parts&&Xi(K.parts,d,A)}),$=()=>{let A=o[d+1]??o[d-1];A&&qi.set(s,A.id),b(K=>{K.parts=(K.parts??[]).filter(y=>y.id!==c.id)})},S=o.map((A,K)=>{let y=Ay(A.value,l),w=A.id===c.id,E=Is(A),R=y.kind==="value"?e.resolve(A.value):void 0,F=A.fontWeight===void 0?void 0:oi.find(([G])=>G===A.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${w?"true":"false"} class="part-chip ${y.kind} ${w?"on":""}"
    ...
    </button>`}),N=r.rules.some(A=>A.partId===c.id),I=c.value.kind.kind==="literal",L=Is(c),Z=c.fontSize!==void 0,T=oi.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,D=A=>{A>=Es&&A<=Ms&&g(K=>{K.fontSize=A},"size")},X=L==="bands"?Je(e.resolve(c.value)??""):[],U={layer:"Use the layer colour",...I&&L!=="bands"?{bands:"By value needs a live value"}:{}},ee=(A,K)=>g(y=>{let w={bands:y.bands??[],bandAboveColorHex:y.bandAboveColorHex??oe};A(w),w.bands.length>0?y.bands=w.bands:delete y.bands,w.bandAboveColorHex!==oe?y.bandAboveColorHex=w.bandAboveColorHex:delete y.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${A=>k(H(""),A.currentTarget)}>${B("text")}<span>Add text</span></button>
    ...
    <div class="part-editor">
      ...
      ${ce(e,c.value,A=>g(K=>{K.value=A},"value"),{showResolved:!0,label:I?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ...
      ${ne("Colour",L,Ty,A=>g(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=zs(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=dr(Je(e.resolve(K.value)??"")))}),{def:"layer",titles:U,...I&&L!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <div class="field seg-field">${ze("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>g(A=>{delete A.fontWeight})})}
        ${sr("Weight",c.fontWeight,oi,A=>g(K=>{K.fontWeight=A}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${ze("Font size",Z?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>g(A=>{delete A.fontSize})}:void 0,gr(c.fontSize??m,D,{step:1,min:Es,max:Ms}))}
        ${yr(c.fontSize,A=>{A===void 0?g(K=>{delete K.fontSize},"size"):D(A)},{step:1,min:Es,max:Ms,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:Z?"Part font size":`Part font size, ${m} pt from the layer`,...Z?{}:{lead:B("link")}})}
      </label>
    </div>
  </div>`}function ap(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,w)=>e.update(E=>y(E.elements[r]),w?`${o}-${w}`:void 0),l=He(e.config,t,n),d=l.frame,c=(y,w)=>e.update(E=>Ce(E,t,a,{frame:fs(d,y)}),`${o}-${w}-${t}`),u=Se(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=y=>u[y],b=!1,g=y=>ji(n)===void 0?f:be(y,ji(n),w=>s(E=>{ji(E)!==void 0&&(E.payload.colorSlot.baseColorHex=w??"#FFFFFF")},"color"),!1,p),x,k,C;switch(n.kind){case"text":{let y=(w,E)=>s(R=>w(R.payload),E);k=zy(e,n,t,y,o),b=!n.payload.countdown&&!gt(n.payload),C=h`
        ${er(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${ne("Weight",n.payload.fontWeight,oi,w=>s(E=>{E.payload.fontWeight=w}),{def:u.fontWeight})}
        ${dg({label:"Align",value:n.payload.alignment??"center",options:ay,def:"center",set:w=>s(E=>{let R=E.payload;w==="center"?delete R.alignment:R.alignment=w})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:ry,def:"1",set:w=>s(E=>{let R=E.payload;w==="2"?R.lineLimit=2:delete R.lineLimit})})}
        ${Ve("Mono digits",n.payload.monospacedDigits===!0,w=>s(E=>{let R=E.payload;w?R.monospacedDigits=!0:delete R.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${b?Sy(e,n.payload,y,g("Main colour")):f}`;break}case"icon":k=h`
        ...
        ${E?h`
            ...
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${ga} dots are drawn.</div>`:Cy(e,y,{min:u.minValue,max:u.maxValue},o,w)}`,b=!0,C=h`
        <div class="grid2">
          ${ne("Style",y.style,zg,R=>w(F=>{R==="dots"&&F.total===void 0&&(F.total=wu(F)),R!=="dots"&&delete F.total,F.style=R}),{titles:Ng,def:u.style})}
        ...
        ${ne("Colour",y.coloring,Fs,R=>w(F=>{F.coloring=R,R==="bands"&&F.bands.length===0&&(F.bands=dr([F.minValue,F.maxValue]))}),{def:u.coloring})}
        ${g("Main colour")}
        ${y.coloring==="bands"?h`
          ...
          ${cr(y,y.colorSlot.baseColorHex,w,Je(e.resolve(y.value)??"")[0])}`:f}
        ${E?f:h`
          <div class="grid2">
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,w=(M,P)=>s(Fe=>M(Fe.payload),P),E=u.historyMinutes,R=u.historyPoints,F=y.historyMinutes>0,G=F&&y.source==="statistics",q=F&&!G,le=F?G?"statistics":"history":"value",We=G?Si:un,rt=hn(y)??mn(y),Le=y.value.kind.kind==="entityState",he=rt===void 0?void 0:e.historySeries(rt),Ne=F&&Le?he??"":e.resolve(y.value)??"",je=y.historyPoints<1,Up=q&&Le&&rt!==void 0?e.historyReadings?.(rt):void 0,Qs=gy(je,Up,Mn(y.historyMinutes)),el=As(a,y.historyMinutes,We),Cr=F&&Le?Uo(Ne):{values:Je(Ne),holes:[]},In=Cr.values,tl=M=>y.limit>0&&M.length>y.limit?y.takeFromEnd?M.slice(M.length-y.limit):M.slice(0,y.limit):M,Kp=tl(In),Tt=Ko(Kp,nt(y.smoothing),Cr.holes.length>0?tl(Cr.holes):[]),Wp=!F&&Le&&In.length===1,Sr=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),jp=ue(e),ea=y.scaleFrom!==void 0&&Sr.some(M=>M.payload.id===y.scaleFrom);k=h`
        ${ce(e,y.value,M=>w(P=>{P.value=M},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${ne("Draw",le,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],M=>w(P=>{if(M==="value"){P.historyMinutes=0;return}P.source=M==="statistics"?"statistics":"history";let Fe=P.historyMinutes||ba;P.historyMinutes=M==="statistics"?Math.min(Fe,to):Math.min(Fe,xa)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${G?h`
            ...
            <div class="grid2">
              ${Ss(a,y.historyMinutes,E,M=>w(P=>{P.historyMinutes=M}),Si)}
              ${ne("Per",y.statPeriod,fa,M=>w(P=>{P.statPeriod=M}),{def:wi})}
            </div>
            ${el?Ts(y.historyMinutes,M=>w(P=>{P.historyMinutes=M},"span"),!0):f}
            ${ne("Read",y.statType,qr,M=>w(P=>{P.statType=M}),{def:ki})}
        ...
        ${q?h`
            ${Le?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Ss(a,y.historyMinutes,E,M=>w(P=>{P.historyMinutes=M}))}
                ...
                <div class="readings-row">
                  ...
                  ${je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(y.historyPoints)}
                      ...
                      @input=${ye(M=>{let P=Number(M);M.trim()!==""&&Number.isFinite(P)&&P>=1&&w(Fe=>{Fe.historyPoints=Math.round(P)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${el?Ts(y.historyMinutes,M=>w(P=>{P.historyMinutes=M},"span")):f}
        ...
        ${F?h`
            ${Ve("Show gaps when unavailable",y.gaps===!0,M=>w(P=>{M?P.gaps=!0:delete P.gaps}),u.gaps===!0)}
            ${Wt(e)}
        ...
        ${In.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${cy(Tt)}</span>${In.length===Tt.length?h` · ${Tt.length} ${Tt.length===1?"value":"values"}`:h` · ${Tt.length} of ${In.length}`}</span></div>`:f}
        ...
        ${F&&y.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",y.limit,M=>w(P=>{P.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${y.limit<=0?f:ne("Keep",y.takeFromEnd?"end":"start",F?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],M=>w(P=>{P.takeFromEnd=M==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${Me("Smooth data",nt(y.smoothing)??"off",Tg,M=>w(P=>{let Fe=nt(M);Fe===void 0?delete P.smoothing:P.smoothing=Fe}),{def:nt(u.smoothing)??"off"})}
        ${Wt(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,b=!0;let qp=(()=>{if(ea)return!0;if(y.scale==="fixed")return y.minValue<0&&y.maxValue>0;let M=Tt.filter(ta=>Number.isFinite(ta));if(M.length===0)return!0;let P=Math.min(...M,y.thresholdValue??1/0),Fe=Math.max(...M,y.thresholdValue??-1/0);return P<0&&Fe>0})();C=h`
        <div class="grid2">
          ${ne("Style",y.style,Eg,M=>w(P=>{P.style=M}),{def:u.style})}
          ${y.style==="bars"?ae("Bar gap",y.barGap,M=>w(P=>{P.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):er(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${y.style==="bars"?h`
          <div class="grid2">
            ${ae("Corner radius",_t(y.barRadius),M=>w(P=>{let Fe=Math.max(0,M??Vn);Fe===Vn?delete P.barRadius:P.barRadius=Fe},"barradius"),{step:.5,min:0,def:_t(u.barRadius),unit:"pt"})}
          </div>
          ${Ve("Round top only",zt(y.barCorners)==="top",M=>w(P=>{M?P.barCorners="top":delete P.barCorners}),zt(u.barCorners)==="top")}
          ${Wt(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${ne("Curve",y.curve??"straight",$g,M=>w(P=>{M==="straight"?delete P.curve:P.curve=M}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Wt(e)}
          ${y.style==="area"?h`
            ${ne("Fill",Lt(y.fillStyle),Cg,M=>w(P=>{M==="flat"?delete P.fillStyle:P.fillStyle=M}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:Lt(u.fillStyle)})}
            ${fu("Fill colour",y.fillColorHex,"Line colour",M=>w(P=>{M===void 0?delete P.fillColorHex:P.fillColorHex=M},"fillcol"))}
            ${Wt(e)}`:f}`}
        <div class="grid2">
          ${ne("Scale",y.scale,Mg,M=>w(P=>{P.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${ne("Baseline",y.baseline,Rg,M=>w(P=>{P.baseline=M}),{def:u.baseline})}
        </div>
        ${Sr.length===0?f:Me("Same scale as",ea?y.scaleFrom:"",[["","Its own"],...Sr.map(M=>[M.payload.id,Re(M,jp)])],M=>w(P=>{M?P.scaleFrom=M:delete P.scaleFrom}),{def:""})}
        ...
        ${!ea&&y.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",y.minValue,M=>w(P=>{P.minValue=M??0},"cmin"),{def:u.minValue})}
              ${ae("Max",y.maxValue,M=>w(P=>{P.maxValue=M??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        ${ne("Colour",y.coloring,Fs,M=>w(P=>{P.coloring=M,M==="bands"&&P.bands.length===0&&(P.bands=dr(Tt))}),{def:u.coloring})}
        ${g("Main colour")}
        ${y.coloring==="bands"?h`
          ...
          ${y.style==="area"?h`${Ve("Band fill",y.fillBands,M=>w(P=>{P.fillBands=M}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let nl=M=>Pe(e.config,a).some(P=>P.payload.chartAnchor?.at===M),Yp=gn(e.config,a).length>0,Xp=yn(e.config,a).length>0,Jp=bn(e.config,a).length>0,il=Sd(e.config,a).length>0,Zp=pn(y)?void 0:je&&q?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Qp=y.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0,Hn=(M,P,Fe,ta)=>h`
        <button class="small ${P?"on":""}" ?disabled=${P||ta!==void 0} aria-pressed=${P?"true":"false"}
          ...
          @click=${()=>e.update(eh=>{Fe(eh)})}>${P?h`<span aria-hidden="true">✓</span>`:B("plus")}<span>${M}</span></button>`;x=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders">
            ${Hn("Threshold line",nl("threshold"),M=>Td(M,a,y.thresholdValue??Vu(Tt)))}
            ${Hn("Now line",nl("now"),M=>Ed(M,a,!0))}
            ${Hn("Zero line",il,M=>{wo(M,a)})}
            ${Hn("Clock times",Yp,M=>{bo(M,a)},Zp)}
            ${Hn("Dots",Xp,M=>{xo(M,a)},Qp)}
            ${Hn("Grid lines",Jp,M=>{vo(M,a)})}
          </div>
        </div>
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${Wt(e)}`;break}case"timeline":{let y=n.payload,w=(he,Ne)=>s(je=>he(je.payload),Ne),E=u.historyMinutes,R=y.value.kind.kind==="entityState",F=Bt(y),G=F===void 0?void 0:e.historySeries(F),q=st(y)*60,le=_i(G??"",Vt),We=As(a,y.historyMinutes),rt=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,Le=Lg(le,q,rt===void 0?void 0:e.hass.states[rt]?.state,rt?.split(".")[0]);k=h`
        ...
        ${le.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${fy(le,q)}</span></span></div>`:f}
        ${my(le)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${_g(y,w,Le,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${Eu(y,w,u,"tl",h`
          ...
          ${ne("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],y=>s(w=>{w.payload.kind=y}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:u.kind})}
        ...
        ${n.payload.kind==="line"?hy(t,d,c):f}`,C=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,y=>s(w=>{w.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${ne("Source",y.source,[["camera","Camera"],["entityPicture","Entity picture"]],G=>w(q=>{q.source=G}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:u.source})}
        ${y.source==="camera"?h`
        ...
        ${ne("Picture",y.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],G=>w(q=>{q.contentMode=G}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:u.contentMode})}
        ${ri("Zoom",y.zoom,G=>w(q=>{q.zoom=G},"zoom"),{min:ts,max:4,step:.05,def:1,format:G=>`${G.toFixed(2)}x`,unit:"x"})}
        ${ri("Pan left/right",y.panX,G=>w(q=>{q.panX=G},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${ri("Pan up/down",y.panY,G=>w(q=>{q.panY=G},"pany"),{min:-1,max:1,step:.02,def:0})}
        ...
        ${rp(e,n.payload,(y,w)=>s(E=>y(E.payload),w),o)}
        ...
        <div class="hint">The clock times of that chart's span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,C=Eu(y,w,u,"ct",h`
        ...
        ${Wt(e)}`,C=h`
        ${ne("Dots",y.dots,Sg,q=>w(le=>{le.dots=q}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
        ...
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let $=b||ji(n)===void 0?void 0:g(n.kind==="shape"?"Fill colour":n.kind==="text"&&gt(n.payload)?"Layer colour":"Colour"),S=To(e.config,n),N=S?{kind:{kind:"entityState",...S}}:void 0,I=n.kind==="image"?n.payload.timestamp===!0:!1,L=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,Z=Dy[n.kind],T=Oy[n.kind],D=Cs(n.payload,u,Z),X=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,U=e.config.perFamily[t]?.placements[a]?.size!==void 0,ee=Cs(n.payload,u,T)||X!==void 0&&l.size!==void 0&&l.size!==u[X],A=fn(e.config,a),K=(y,w)=>()=>s(E=>tr(E.payload,u,y),w);return h`
    ${xe(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"?f:np(e,n,o)}${k}`,{color:Q.content,icon:"content",summary:Ps(e,n),...D?{reset:()=>s(y=>{tr(y.payload,u,Z),y.kind==="text"&&Gi(y.payload.rules)},"reset-content")}:{}})}
    ${C===void 0&&$===void 0?f:xe(e,"look",n.kind==="image"?"Picture":"Look",h`${C??f}${$??f}`,{color:Q.look,icon:n.kind==="image"?"image":"look",...pr(n)?{summary:pr(n)}:{},...ee?{reset:()=>e.update(y=>{tr(y.elements[r].payload,u,T),U&&Ce(y,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?xe(e,"numbers","Extras",Uy(e,n,x),{color:Q.numbers,icon:"text",summary:Gy(e,n),...A.length>0||Pe(e.config,a).length>0||gn(e.config,a).length>0||yn(e.config,a).length>0||bn(e.config,a).length>0||Cs(n.payload,u,Fu)?{reset:()=>e.update(y=>{for(let E of fn(y,a))$e(y,E.payload.id);for(let E of Pe(y,a))$e(y,E.payload.id);for(let E of gn(y,a))$e(y,E.payload.id);for(let E of yn(y,a))$e(y,E.payload.id);for(let E of bn(y,a))$e(y,E.payload.id);let w=y.elements.find(E=>E.payload.id===a);w&&tr(w.payload,u,Fu)})}:{}}):f}
    ${n.kind==="image"?xe(e,"timestamp","Timestamp",dy(n.payload,(y,w)=>s(E=>y(E.payload),w)),{color:Q.numbers,icon:"clock",summary:I?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...I?{reset:K(Py,"reset-stamp")}:{}}):f}
    ${xe(e,"states","States",hp(e,n.payload.rules,n.kind,y=>y.elements.find(w=>w.payload.id===a)?.payload.rules,`rules-${a}`,N,L),{color:Q.states,icon:"states",summary:Di(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(y=>{y.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:by(e,n,t)}
    ${i.tap===!1?f:vy(e,n)}`}var Py=["timestamp","timestampCorner","timestampSize"],Dy={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[],chartDots:[],chartGrid:[]},Oy={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["dots","size","colorHex"],chartGrid:["lines","colorHex","thickness"]};function Ru(e,n){return h`<div class="field readout"><span>Chart</span><span class="readout-v">${n?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(n.payload.id)}>${Re(n,ue(e))}</button>`:"None"}</span></div>`}var Fu=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function rp(e,n,t,i){let a=n.action;return h`
    ${Me("Tap action",a.type,Jg,r=>t(o=>{o.action=qu(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${b===0?f:h`
      ...
      <div class="chart-numbers">
        ...
        ${l.map(g=>{let{at:x,place:k}=g.payload.chartAnchor,C=dn.find(([S])=>S===x)?.[1]??"Reading";if(k==="through")return m(g.payload.id,x==="now"?"\u2502":"\u2500",x==="zero"?"Zero":C,"Line");let $=g.kind==="text"?e.resolve(g.payload.value)??"\u25CF":g.kind==="icon"?Wy(e.resolve(g.payload.symbol)):"\u25C6";return m(g.payload.id,$,C,"Marker")})}
      ...
      <div class="hint">Click a row to edit that layer. The × deletes it, and Undo brings it back. Dots and grid
        ...
        dot to pick the dots.</div>`}`}function Ky(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Be(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=Eo(e.config,n);return h`
    ${Ve("Tappable",a!==void 0,s=>e.update(l=>{s?Sa(l,i):Ta(l,i)}))}
    ${a?h`<div class="value-editor">
        ...
        ${By(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${bt(o)}</b>.</div>`}`}function Au(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Wy(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Re(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=dn.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return Au(ve(e.payload.value,n));case"icon":return Au(ve(e.payload.symbol,n));case"gauge":return ve(e.payload.value,n);case"chart":return ve(e.payload.value,n);case"timeline":return ve(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines"}}function op(e,n){let t=vt(e.config,n.id),i=ue(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return xe(e,"content","Group",h`
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:Q.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function sp(e,n){if(n==="inline")return jy(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${te(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${te(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=vr(e.config,n),r=t.backgroundColorHex?Te(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Te(t.borderColorHex)} border`:"no border";return h`
    ...
    ${n==="corner"?xe(e,"corner","Corner content",qy(e,t,i),{color:Q.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${xe(e,"states","Shape states",hp(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:Q.states,icon:"states",summary:Di(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${xe(e,"content","Inline text",h`
      ...
      ${Ds(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:Q.content,icon:"text",summary:Oe(`${n.label?`${n.label}: `:""}${ve(n.value,i)}`,48)})}
    ...
    ${ne("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=H("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ne("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=H("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:H("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    ${s===void 0?f:lp(s,n.partId,ue(e),m=>u(b=>{m?b.partId=m:delete b.partId}))}
    ...
    ${Ve("Otherwise",n.otherwise!==void 0,m=>u(b=>{m?b.otherwise=b.otherwise??[]:delete b.otherwise}))}
    ...
    ${cp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${ce(e,s.upper??H(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${we("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!ab(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Iu(e,"From",s.value??H("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Iu(e,"To",s.upper??H("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=rb(n.value)?ob(s.options??[],u=>o(p=>{p.comparison.options=bs(u)},"options")):we("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Me("Comparison",s.kind,Bd.map(u=>[u,ai[u]]),u=>o(p=>{p.comparison=Po(p.comparison,u)}))}
    ${c}
  </div>`}function ab(e){try{return new RegExp(e),!0}catch{return!1}}function Iu(e,n,t,i,a){if(t.kind.kind!=="literal")return ce(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=vn(r)??"";return h`<label class="field"><span>${n}</span>
    ...
    </select>`}var up=["setColor","setBorderColor","setBackgroundColor"];function sb(e,n,t,i,a,r,o,s=!1){let l=!Fi[i].includes(_e[n.kind]),d=s&&!l&&!hr.includes(_e[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${pp(e,n,a,o)}
  </div>`}function pp(e,n,t,i){let a=Fa(n.kind),r=f;if(a==="value"){let o=n.value??H("");if(up.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?be("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=H(l??"#FFFFFF")},"color")):ce(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{Hs.delete(a),Ee(d.target)}}>Show as table</button>
        ${s.ok?f:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${eb(e,n,t,i,a,o)}`:lb(e,s.table,n[0],t,i,a,r,o)}function lb(e,n,t,i,a,r,o,s){let l=(y,w)=>e.update(E=>{let R=a(E);R&&y(R)},w?`${r}-${w}`:void 0),d=n.value??Hu.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Qc(d)&&db(e.resolve(d)),p=Fi[i],m=ar.get(r)??new Set,b=n.columns.length===0&&m.size===0?[Zc[i]]:[],g=Gc(n.columns,[...m,...b.filter(y=>y!==void 0)],p),x=nr.get(r),k=t?t.partId:s?.some(y=>y.id===x)?x:void 0,C=s!==void 0&&k!==void 0,$=C?p.filter(y=>hr.includes(y)):p,S=C?g.filter(y=>!hr.includes(y)):[],N=(y,w)=>{if(!t){y?nr.set(r,y):nr.delete(r),Ee(w);return}l(E=>{let R=E[0];R&&(y?R.partId=y:delete R.partId)})},I=t?e.liveBranch(t):"none",L=t?e.forced.get(t.id)??"live":"live",Z=y=>L!=="live"&&(L==="otherwise"?y==="otherwise":L.caseId===y),T=y=>{t&&e.setForced(t.id,Z(y)?"live":y==="otherwise"?"otherwise":{caseId:y})},D=y=>{Hu.set(r,y),n.rows.length!==0&&l(w=>Yc(w,y),"lhs")},X=()=>{nr.delete(r),l(y=>{jc(y,d??H(""),u),k!==void 0&&y[0]&&y[0].partId===void 0&&(y[0].partId=k)})},U=n.rows.map((y,w)=>_u(e,{key:`${r}-${y.caseId}`,label:Jc(y.comparison,E=>ve(E,ue(e))),columns:g,changes:y.changes,live:I===y.caseId,forced:Z(y.caseId),onForce:()=>T(y.caseId),when:mb(e,y.comparison,`${r}-${y.caseId}`,(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===y.caseId)?.when.tests[0];G&&E(G.comparison)},R&&`${y.caseId}-${R}`)),updChanges:(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===y.caseId);G&&E(G.then)},R&&`${y.caseId}-${R}`),acts:h`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>qc(E,y.caseId))}>${B("delete")}</button>`})),ee=n.otherwise===void 0?f:_u(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:I==="otherwise",forced:Z("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(y,w)=>l(E=>{let R=E[0]?.otherwise;R&&y(R)},w),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(y=>ps(y,!1))}>${B("close")}</button>`}),A=rr.get(r),K=cb.filter(y=>$.includes(y)&&!g.includes(y));return h`
    <div class="states">
      ${ce(e,d??H(""),D,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:lp(s,k,ue(e),N)}
          ...
          <tr>
            ...
            ${g.map(y=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${ct[y]} column`}
                @click=${w=>{rr.set(r,y),Ee(w.target)}}>${B("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${A===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${ct[A]} column? Its ${Lu(n,A)} value${Lu(n,A)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${y=>{rr.delete(r),ar.get(r)?.delete(A),Ee(y.target),l(w=>Xc(w,A))}}>Remove</button>
        <button class="small" @click=${y=>{rr.delete(r),Ee(y.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${K.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${y=>{let w=y.target,E=w.value;if(w.value="",!E)return;let R=ar.get(r)??new Set;R.add(E),ar.set(r,R),Ee(w)}}>
      ...
      <div class="states-switch">
        <button class="link" @click=${y=>{Hs.add(r),Ee(y.target)}}>Advanced</button>
    ...
    <td class="acts">${n.acts}</td>
      ...
      @click=${d=>{i(c=>{c.push(kn(Bc[n]))}),Gu(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>_e[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=ct[n];return h`
    ...
    </div>`}function hb(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Fa(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${oi.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??H(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(up.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Te(a):ve(i,ue(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${ve(i,ue(e))}</span>`}function Te(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function mb(e,n,t,i){let a=wn(n.kind),r=ds(n.kind),o=(s,l,d,c)=>gb(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
...
`)}var Pp="wrist-assistant-panel.layers.v1",Ct=34,An=200,lx=720,$r=320,dx=80,cx=56,Dp="wrist-assistant-panel.columns.v3",qs=e=>Math.max(An,Math.min(lx,Math.round(e))),Op=e=>e.metaKey||e.ctrlKey||e.shiftKey,ux=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Qi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Jt=Qi==="Cmd"?"\u2318":"Ctrl+",Ys=Qi==="Cmd"?"\u21E7":"Shift+";function Vp(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-dx;if(i>=An*2+$r){let r=i-$r,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(An,Math.floor(o*l)),s=Math.max(An,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(An,o-d):s=Math.max(An,s-d))}return{columns:3,left:o,right:s}}let a=e-cx;return a>=An+$r?{columns:2,left:Math.min(n,a-$r),right:t}:{columns:1,left:n,right:t}}var _=class _ extends Mt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=_p;this.colRight=zp;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=ti.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Nc(()=>this.requestUpdate());this.imageSizes=Pc(()=>this.requestUpdate());this.symbols=new Ka(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new qa;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Us(a,this.hass.states);r.some(s=>Ns(Hp(s.entityId)))||Ks({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Ns(Ip)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??nx}static{this.styles=Er`
    :host {
      ...
      --wa-text: ${ke(Ke.text)};
      --wa-icon: ${ke(Ke.icon)};
      --wa-gauge: ${ke(Ke.gauge)};
      --wa-shape: ${ke(Ke.shape)};
      --wa-image: ${ke(Ke.image)};
      --wa-tap: ${ke(Ke.tap)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.drop-before { border-top: ${Ct}px solid transparent; }
    .layer.drop-after { border-bottom: ${Ct}px solid transparent; }
    .layer.drop-before::after, .layer.drop-after::after {
      content: ""; position: absolute; left: 0; right: 0; height: ${Ct}px; box-sizing: border-box;
    ...
    .layer.drop-before::after { top: -${Ct}px; }
    .layer.drop-after::after { bottom: -${Ct}px; }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(mr,this.scrubStart),this.addEventListener(fr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},ex)}loadColumnWidths(){try{let t=window.localStorage.getItem(Dp);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=qs(i.left)),typeof i.right=="number"&&(this.colRight=qs(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Dp,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Pp);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Pp,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Mo(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let T=this.focusTapId();if(T!==void 0&&o===T&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,T,r??void 0);return}let D=this.hitLayerId(i);D?this.inspect={kind:"layer",id:D}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=Op(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=Mo(this.draft.config,o),p=this.draft.config.elements.find(T=>T.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=xt(this.draft.config,u),b=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||b)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r)||p.payload.chartAnchor?.place==="through")return;i.preventDefault();let g=He(this.draft.config,t,p).frame,x=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let T=p.payload,D=pe[t],X=g.width*D.width,U=g.height*D.height,ee={x:0,y:0,w:X,h:U,cx:X/2,cy:U/2},A=Pa(T,ee,Na(new Date));if(this.cancelGesture?.(),l){let E=x.width/D.width,R=T.timestampSize;this.cancelGesture=ru(s,i,l,{w:A.w*E,h:A.h*E},(F,G)=>{let q=Math.min(40,Math.max(4,Math.round(R*F)));this.mutate(le=>{let We=le.elements.find(rt=>rt.payload.id===u);We?.kind==="image"&&(We.payload.timestampSize=q)},`ts-size-${u}`),G&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let K={x:0,y:0,w:g.width*x.width,h:g.height*x.height},y=yt(T)?{x:T.timestampX,y:T.timestampY}:{x:(A.x+A.w/2)/ee.w,y:(A.y+A.h/2)/ee.h},w=!1;this.cancelGesture=au(s,K,i,y,(E,R,F)=>{F||(w=!0),w&&this.mutate(G=>{let q=G.elements.find(le=>le.payload.id===u);q?.kind==="image"&&(q.payload.timestampX=E,q.payload.timestampY=R)},`ts-${u}`),F&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let k=p.payload.chartAnchor,C=k!==void 0&&!Nt(k.at)&&k.place!=="through",$=k!==void 0&&Nt(k.at)&&k.place==="through",S=pe[t],N={dx:k?.dx??0,dy:k?.dy??0},I=k!==void 0&&!r?zi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(T=>T.id===u)?.frame:void 0,L=I??g,Z=T=>Math.round(T*10)/10;this.cancelGesture?.(),this.cancelGesture=Xa(s,x,i,{elementId:u,frame:L,handle:r??void 0},{onFrame:(T,D,X)=>{this.mutate(U=>{if(k===void 0){Ce(U,t,T,{frame:D});return}let ee=I?{width:g.width,height:g.height}:{width:D.width,height:D.height};Ce(U,t,T,{frame:{...D,...ee,x:C?D.x:g.x,y:g.y}});let A=U.elements.find(w=>w.payload.id===T)?.payload.chartAnchor;if(A===void 0)return;let K=N.dx,y=$?N.dy:Z(N.dy+(D.y-L.y)*S.height);K?A.dx=K:delete A.dx,y?A.dy=y:delete A.dy},`drag-${T}-${t}`),X&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=vt(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,He(o,t,x).frame])),d=[...l.values()],c=Math.min(...d.map(x=>x.x)),u=Math.min(...d.map(x=>x.y)),p=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),b={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},g=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=Xa(a,this.gestureCanvas(t),i,{elementId:r.id,frame:b},{onFrame:(x,k,C)=>{let $=k.x-b.x,S=k.y-b.y;this.mutate(N=>{for(let[I,L]of l)Ce(N,t,I,{frame:{...L,x:g(L.x+$),y:g(L.y+S)}})},`drag-group-${r.id}-${t}`),C&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?nu:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(vt(r,x).map(k=>k.payload.id),d,c,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(x=>x.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=xt(r,u);if(m?.locked)return this.nudgeMany(vt(r,m.id).map(x=>x.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let b=He(r,d,p).frame,g=ys(b,s,l,c);return(g.x!==b.x||g.y!==b.y)&&this.mutate(x=>Ce(x,d,u,{frame:g}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let N=l.elements.find(I=>I.payload.id===S);N&&c.set(S,He(l,i,N).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),b=Math.max(...u.map(S=>S.x+S.width)),g=Math.max(...u.map(S=>S.y+S.height)),x={x:p,y:m,width:b-p,height:g-m,rotationDegrees:0},k=ys(x,o,s,a),C=k.x-x.x,$=k.y-x.y;return(C!==0||$!==0)&&this.mutate(S=>{for(let[N,I]of c)Ce(S,i,N,{frame:{...I,x:d(I.x+C),y:d(I.y+$)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=pe[i],c=He(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=Pa(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},Na(new Date)),b=yt(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},g=iu(b,a,r,{w:u,h:p});return(g.x!==b.x||g.y!==b.y)&&this.mutate(x=>{let k=x.elements.find(C=>C.payload.id===t);k?.kind==="image"&&(k.payload.timestampX=g.x,k.payload.timestampY=g.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=za(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=ns(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Be(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=fe(s,l),c=He(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Xa(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(b=>{d?Hd(b,u,t,p):Ce(b,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Vp(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
      ...
      ${pt({hass:this.hass},t.label,i??tx,a=>this.setImportEntity(t.entityId,a),Hp(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${as.map(s=>h`<button class="add" style=${`--k:${Ke[s]}`} ?disabled=${i} title=${`Add a blank ${ii[s].toLowerCase()} layer`}
              @click=${()=>{let l=Se(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="right">
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${A.isHidden?"Show":"Hide"} (${Ys}${Jt}H)`} aria-label=${A.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(G=>Ce(G,a,U,{isHidden:!A.isHidden}))}}>${B(A.isHidden?"hide":"show")}</button>
      ...
      </div>`},I=(T,D)=>{let X=this.inspect.kind==="group"&&this.inspect.id===T.id,U=!this.collapsed.has(T.id),ee=this.rowDrag(T.id,i),A=D[0],K=D[D.length-1],y=E=>{let R=E.currentTarget,F=R.getBoundingClientRect(),G=F.top+(R.classList.contains("drop-before")?Ct:0),q=F.bottom-(R.classList.contains("drop-after")?Ct:0),le=(E.clientY-G)/Math.max(1,q-G);return le<.25?"drop-before":!U&&le>.75?"drop-after":"drop-into"},w=D.map(E=>E.payload.id);return h`<div class="layer group ${X?"hl":""} ${S?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${ee.draggable}
        ...
        <span class="name">
          <b>${T.name}</b>
          <small><span class="kind">Group</span> · ${D.length} layer${D.length===1?"":"s"} · ${T.locked?"locked":"unlocked"}</small>
          ${S?h`<span class="facts"><span class="fact"><b>Holds</b> ${D.map(E=>Re(E,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Ys}${Jt}G)`} aria-label="Ungroup" @click=${E=>{E.stopPropagation(),this.mutate(R=>Mi(R,T.id)),X&&(this.inspect={kind:"general"})}}>${B("ungroup")}</button>
          </span>`:f}
      ...
      </div>`},L=[],Z=new Set;for(let T=0;T<l.length;T++){let D=l[T],X=D.payload.groupId,U=X===void 0?void 0:t.groups?.find(K=>K.id===X);if(!U){L.push(N(D,!1));continue}if(Z.has(U.id))continue;Z.add(U.id);let ee=l.filter(K=>K.payload.groupId===U.id);L.push(I(U,ee));let A=this.inspect.kind==="group"&&this.inspect.id===U.id;this.collapsed.has(U.id)||L.push(h`<div class="group-kids">${ee.map(K=>N(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
      <h2 class="panel-title tools" style=${`--c:${Q.place}`}><span class="swatch">${B("layers")}</span>Layers
        ...
        <span class="tool-set">
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([T,D])=>h`
              <button class=${this.layerDetail===T?"on":""} title=${D} aria-label=${D} aria-pressed=${this.layerDetail===T?"true":"false"}
                @click=${()=>{this.layerDetail=T,this.saveListView()}}>${B(T)}</button>`)}
          </span>
          <span class="seg" role="group" aria-label="Preview size">
            ${ox.map((T,D)=>h`
              <button class=${this.thumbStep===D?"on":""} title=${`${Np[D]} row pictures`}
                aria-label=${`${Np[D]} row pictures`} aria-pressed=${this.thumbStep===D?"true":"false"}
                @click=${()=>{this.thumbStep=D,this.saveListView()}}>${T}</button>`)}
          </span>
        </span>
      </h2>
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${Q.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${T=>{T.preventDefault(),this.clearDragMarks();let D=this.dragId,X=[...l].reverse().find(U=>U.payload.id!==D&&U.payload.groupId!==D);D&&X&&this.reorderLayer(D,X.payload.id,!1,!0),this.dragId=void 0}}>
      ...
      ${t===void 0?f:h`
        ...
        ${pt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Ip,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          <span class="spacer"></span>
          <span class="meta ${u===void 0?"none":""}" title=${ve(c.value,d)}>${u??"unresolved"}</span>
      ...
      ${c}
    </span>`}commitTestValue(t,i){this.editingValue=void 0,this.setTestValue(t,i)}setTestValue(t,i,a){let r=i?.trim()??"",o=new Map(this.testValues),s=t.startsWith(Aa)?this.sharedRaw(t.slice(Aa.length)):this.hass.states[t]?.state;r===""||r===s?o.delete(t):o.set(t,r),this.applyTestValues(o,a)}sharedRaw(t){let i=this.draft?.config;if(!i)return;let a=this.buildContext(!1),r=a.namedValues.map(o=>({...o,value:{kind:o.value.kind}}));return new dt({...a,namedValues:r},i).resolve({kind:{kind:"named",id:t}})}applyTestValues(t,i){let a=this.draft;!a||t.size===a.testValues.size&&[...t].every(([o,s])=>a.testValues.get(o)===s)||(a.setTestValues(t,i),this.version++)}currentCase(){return Ni.find(t=>t.label===this.previewCase)??ti}previewSlot(t){return this.currentCase().slots[t]}crumbs(t,i){let a=this.inspect,r=t.name.trim()||"Complication",o=this.activeFamily==="inline"?"Inline":te(this.activeFamily),s=a.kind==="family"&&i===void 0?h`<span class="here" style=${`--k:${Q.place}`}>${o} shape</span>`:h`<button @click=${()=>{this.inspect={kind:"family"}}} title="Edit the shape">${o}</button>`,l=f,d=f;if(i!==void 0)l=h`<span class="here" style="--k:var(--wa-accent)"><span class="kchip">Picked</span><span class="nm">${i} layers</span></span>`;else if(a.kind==="layer"){let c=t.elements.find(u=>u.payload.id===a.id);if(c){l=h`<span class="here" style=${`--k:${Ke[c.kind]}`}><span class="kchip">${ii[c.kind]}</span><span class="nm" title=${Re(c,ue(this.host()))}>${Re(c,ue(this.host()))}</span></span>`;let u=xt(t,c.payload.id);u&&(d=h`<span class="sep">›</span><button @click=${()=>{this.inspect={kind:"group",id:u.id}}} title="Edit the group">${u.name}</button>`)}}else if(a.kind==="group"){let c=t.groups?.find(u=>u.id===a.id);c&&(l=h`<span class="here" style=${`--k:${Q.group}`}><span class="kchip">Group</span><span class="nm" title=${c.name}>${c.name}</span></span>`)}return h`<div class="crumbs">
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${xe(a,"complication","Complication",Xu(a),{color:Q.complication,icon:"watch",alwaysOpen:!0})}
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ue(r),s=new dt(this.buildContext(),this.draft?.config),l=tp(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(b=>{for(let g of i)Ce(b,a,g.payload.id,{isHidden:m})}),p=m=>this.mutate(b=>{for(let g of i){let x=b.elements.find(k=>k.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&x.kind!=="chartTimes"&&x.kind!=="chartDots"&&x.kind!=="chartGrid"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
    ...
    </details>`}};O([zn({attribute:!1})],_.prototype,"hass",2),O([zn({type:Boolean})],_.prototype,"narrow",2),O([zn({attribute:!1})],_.prototype,"panel",2),O([V()],_.prototype,"colLeft",2),O([V()],_.prototype,"colRight",2),O([V()],_.prototype,"panelWidth",2),O([V()],_.prototype,"owners",2),O([V()],_.prototype,"ownerId",2),O([V()],_.prototype,"records",2),O([V()],_.prototype,"selectedId",2),O([V()],_.prototype,"draft",2),O([V()],_.prototype,"readOnlyReason",2),O([V()],_.prototype,"parseError",2),O([V()],_.prototype,"maxSchemaVersion",2),O([V()],_.prototype,"presets",2),O([V()],_.prototype,"occupied",2),O([V()],_.prototype,"serverToken",2),O([V()],_.prototype,"appliedToken",2),O([V()],_.prototype,"sendStatusKnown",2),O([V()],_.prototype,"polling",2),O([V()],_.prototype,"lastPollSeconds",2),O([V()],_.prototype,"sendPending",2),O([V()],_.prototype,"pages",2),O([V()],_.prototype,"templateResults",2),O([V()],_.prototype,"historySeries",2),O([V()],_.prototype,"historyReadings",2),O([V()],_.prototype,"templateError",2),O([V()],_.prototype,"templateFetchedAt",2),O([V()],_.prototype,"forced",2),O([V()],_.prototype,"showRaw",2),O([V()],_.prototype,"inspect",2),O([V()],_.prototype,"openSections",2),O([V()],_.prototype,"helpSections",2),O([V()],_.prototype,"pickerOpen",2),O([V()],_.prototype,"pickerFilter",2),O([V()],_.prototype,"pickerNote",2),O([V()],_.prototype,"openValue",2),O([V()],_.prototype,"sharedHelp",2),O([V()],_.prototype,"editingValue",2),O([V()],_.prototype,"thumbStep",2),O([V()],_.prototype,"layerDetail",2),O([V()],_.prototype,"addOpen",2),O([V()],_.prototype,"addDetail",2),O([V()],_.prototype,"multi",2),O([V()],_.prototype,"collapsed",2),O([V()],_.prototype,"activeFamily",2),O([V()],_.prototype,"picking",2),O([V()],_.prototype,"pickHoverId",2),O([V()],_.prototype,"listHoverIds",2),O([V()],_.prototype,"zoomed",2),O([V()],_.prototype,"helpOpen",2),O([V()],_.prototype,"showTaps",2),O([V()],_.prototype,"timestampActiveId",2),O([V()],_.prototype,"savedName",2),O([V()],_.prototype,"presetKind",2),O([V()],_.prototype,"presetEntity",2),O([V()],_.prototype,"newOpen",2),O([V()],_.prototype,"newName",2),O([V()],_.prototype,"newFamily",2),O([V()],_.prototype,"shareOpen",2),O([V()],_.prototype,"shareMode",2),O([V()],_.prototype,"shareLabels",2),O([V()],_.prototype,"shareNote",2),O([V()],_.prototype,"importOpen",2),O([V()],_.prototype,"importText",2),O([V()],_.prototype,"importParse",2),O([V()],_.prototype,"importName",2),O([V()],_.prototype,"importMap",2),O([V()],_.prototype,"previewCase",2),O([V()],_.prototype,"loadError",2),O([V()],_.prototype,"saveError",2),O([V()],_.prototype,"saving",2),O([V()],_.prototype,"conflict",2),O([V()],_.prototype,"remoteRevision",2),O([V()],_.prototype,"confirmDelete",2),O([V()],_.prototype,"moveTarget",2),O([V()],_.prototype,"moving",2),O([V()],_.prototype,"moveError",2),O([V()],_.prototype,"version",2);var Zs=_;function St(e){return String(e?.message??e)}function px(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Bp(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function hx(e,n,t,i){let a=[{label:"Shows",value:Ps(e,t)}],r=pr(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function mx(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function fx(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Te(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=hn(e.payload)??mn(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Je(o).length} values`}case"timeline":{let r=Bt(e.payload),o=r===void 0?[]:_i(t.get(r)??""),s=Math.max(0,o.length-1);return`${mx(st(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Te(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return bt(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Zs);export{Zs as WristAssistantPanel,Vp as columnFit,hx as layerFacts};
