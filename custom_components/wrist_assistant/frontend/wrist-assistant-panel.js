...
`)}function Bc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Zf(r));return{values:t,nullKeys:i}}function Zf(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function xs(e){let n=cr(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Qf(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(_o(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var eg=10800;function tg(e,n,t){let i=n==="always"||n==="auto"&&t<=eg;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function ur(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=tg(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function ng(e,n){return yt(e)===void 0?[]:ur(st(e)*60,Bi(e.timeLabelCount),e.hourCycle,e.minutes,n)}function ig(e,n){return Hn(e)?ur(Math.round(e.historyMinutes)*60,Bi(mt(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function ag(e,n,t,i){return n===void 0&&i!==void 0?yt(i)===void 0?[]:ur(st(i)*60,Bi(mt(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!Hn(n)?[]:ur(Math.round(n.historyMinutes)*60,Bi(mt(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Un(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function We(e){let n=e.trim(),t=Un(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Un(i)}function rg(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function og(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function sg(e){let n=e.trim(),t=Un(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Un(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Un(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function lg(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function dg(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function cg(e,n,t){if(Le(n))return e;let i=n,a=e,r=Un(e.trim()),o=i.duration?sg(e):void 0;if(o!==void 0)a=lg(o);else if(i.relativeTime&&r!==void 0)a=og(r);else{let s=We(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):rg(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=dg(a);break}return a}function hi(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function je(e,n=240){return jc(e,n).map(t=>t.value)}function ws(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of je(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:Wc(r)}}function Wc(e){return e.some(n=>n)?e:[]}function jc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Gc(e,n,t){let i=jc(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Zt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??le,c=t.highColorHex??Qe,u=t.lowColorHex??et,p=[],m=(y,b)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===b?k.text+=y:p.push({text:y,colorHex:b})},g=0;return i.forEach((y,b)=>{m(e.slice(g,y.start),n);let k=b===o?c:b===s?u:l.length>0?Wa(y.value,l,d):n,C=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,C),k),g=C}),m(e.slice(g),n),p}function Uc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function ug(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Zi(e,n=nn){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:pg(i.slice(a+1))})}return t}function pg(e){try{return decodeURIComponent(e)}catch{return e}}function hg(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Kc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function mg(e,n,t){if(e===void 0)return 0;let i=We(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var xt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=Uc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=In(n),i=Ln(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?ws(a):{values:je(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=Wc(s),{values:ks(o,rt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:We(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=We(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Uc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Le(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Qf(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Yd(r):_o(r,a.domainMax-a.domainMin));break}default:{let a=bs(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return cg(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Un(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?hi(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=We(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:We(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:We(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Vn(d),p=c===void 0?void 0:Vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Pe[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Gc(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=ot(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(Ud(n.payload)&&(y.spans=Gc(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let k={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(G,_,j)=>G??(_?We(this.resolve(_)??""):void 0)??j,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:We(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=Wa(k,Zt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let G=We(this.resolve(p.total)??"");G!==void 0&&(w=G)}let S=Kc(w,1,Ka),H={kind:"gauge",...u,fraction:mg(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:Kc(k??0,0,S)};if(p.thresholdValue!==void 0&&b!==y){let G=(p.thresholdValue-y)/(b-y);G>=0&&G<=1&&(H.thresholdFraction=G)}return H}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Zt(p),w=qd(p)?g.map(Z=>Wa(Z,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",H=p.highlight==="lowest"||p.highlight==="both",G=_i(p),_={kind:"chart",...u,values:g,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?G.high:"none",lowMarker:H?G.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:rt(p.smoothing)??"off",fillStyle:jt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:qt(p.barRadius),barCorners:Yt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:ig(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},j=y.length===0?g:g.filter((Z,I)=>!y[I]);if(j.length>0){let Z=A=>g.findIndex((K,R)=>K===A&&y[R]!==!0),I=S?Z(Math.max(...j)):-1,Q=H?Z(Math.min(...j)):-1;I>=0&&(_.highIndex=I),Q>=0&&Q!==I&&(_.lowIndex=Q)}let M=ug(p,b.min,b.max);M!==void 0&&(_.thresholdY=M);let U=this.chartNowIndex(p,g.length);return U!==void 0&&(_.nowIndex=U),_}case"timeline":{let p=n.payload,m=yt(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=Zi(g,nn),b=hg(y,st(p)*60,C=>nc(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:ng(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};Za(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:ag(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),g={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(g.url=y),g}case"chartDots":{let p=n.payload,m=ht(p.size),g={kind:"chartDots",...u,chart:p.chart,dots:Oa(p.dots),diameter:0,indices:[]};return m!==void 0&&(g.size=m),p.colorHex!==void 0&&(g.colorHex=p.colorHex),g}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Mn(p.lines),colorHex:Ut(p.colorHex),thickness:Rn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...vg(xg(wc(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,k=this.resolve(b.value),C=k===void 0?void 0:We(k);if(C!==void 0){let w=Math.min(b.minValue,b.maxValue),S=Math.max(b.minValue,b.maxValue),H={value:Math.min(S,Math.max(w,C)),minValue:w,maxValue:S===w?w+1:S,colorHexes:b.colorHexes},G=this.resolve(b.minLabel);G!==void 0&&(H.minLabel=G);let _=this.resolve(b.maxLabel);_!==void 0&&(H.maxLabel=_),l.bezelGauge=H}}let g=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;g!==void 0&&(l.backgroundColorHex=g);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function fg(e,n,t){let i=new xt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function mi(e,n,t){let i=new xt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=fg(e.inline,n,e)),a}function Qi(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var vs=5,gg=1.7,yg=1.8;function bg(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function xg(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*yg,l=Math.max(o.frame.width*n.width,0),d=bg(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function qc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function Yc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function pr(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=_=>_==="triangle"?vs+d:_==="dot"?Math.max(d,gg):d,u=c(a),p=c(r),m=n.y+u,g=Math.max(n.h-u-p,1),y=m+g,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?g*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-w*(i-1))/i,.5),H=_=>Math.min(1,Math.max(0,(_-e.domainMin)/b)),G=_=>y-H(_)*g;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:G(0),inset:d,yAtFraction(_){return y-Math.min(Math.max(_,0),1)*g},barRect(_){let j=o+_*(S+w),M=t[_],U,Z;if(k){let I=C+H(M)*(g-C);U=y-I,Z=y}else U=G(M),Z=k?y:G(0),U>Z&&([U,Z]=[Z,U]);return{x:j,y:U,w:S,h:Math.max(Z-U,.5)}},point(_){let j=Math.max(s-d*2,0);return{x:t.length>1?o+d+j*_/(t.length-1):o+s/2,y:G(t[_])}},markerCenter(_,j,M="high"){let U=j?this.barRect(_):void 0,Z=U?U.x+U.w/2:this.point(_).x,I=M==="high"?a:r,Q=M==="high"?I==="triangle"?n.y+vs/2:m:I==="triangle"?n.y+n.h-vs/2:y;return{x:Z,y:Q}}}}function Xc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function ks(e,n,t=[]){let i=e.length,a=Gd(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,g=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,k=Math.exp(-(b*b)/(2*o*o));m+=e[y]*k,g+=k}return m/g}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function Jc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Ji=1;function Kn(e,n){let t=Math.max(en,Math.min(tn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Ji>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Ji:n.y,h:n.h-i-Ji,cy:(e.labelsAbove?n.y+i+Ji:n.y)+(n.h-i-Ji)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function vg(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&qc(r)===void 0)return{...i,isHidden:!0};let o=kg(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function wg(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function kg(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Qi(t,i);if(a.w<=0||a.h<=0)return;let r=Kn(t,a).body;if(r.w<=0||r.h<=0)return;let o=pr(t,r),s,l;if(gt(n.at)){let k=wg(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?qc(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,w)=>C>w?(C+w)/2:Math.min(Math.max(k,C),w),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var $s=[.01,.025,.05,.1];function fi(e,n){return!(n.width>0&&n.height>0)||n.width===n.height?{x:e,y:e}:n.width>n.height?{x:e*n.height/n.width,y:e}:{x:e,y:e*n.width/n.height}}function Cs(e){return typeof e=="number"?{x:e,y:e}:e}function Ss(e){return e.x>0&&e.y>0}var Zc=1e-6;function ea(e,n){return Math.round((e-.5)/n)*n+.5-e}function Qc(e,n,t){let a=[e,e+n/2,e+n].map(r=>ea(r,t)).reduce((r,o)=>Math.abs(o)<Math.abs(r)?o:r);return de(e+a)}function $g(e,n){let t=Cs(n);return Ss(t)?gi({...e,x:Qc(e.x,e.width,t.x),y:Qc(e.y,e.height,t.y)}):e}function eu(e,n,t,i={x:!0,y:!0}){let a=Cs(t);if(!Ss(a))return e;let{x:r,y:o,width:s,height:l}=e,d=r+s,c=o+l;if(i.x&&n.includes("e")&&(s=Math.max(Ge,de(d+ea(d,a.x)-r))),i.x&&n.includes("w")){let u=Math.min(de(r+ea(r,a.x)),d-Ge);s=de(d-u),r=de(u)}if(i.y&&n.includes("s")&&(l=Math.max(Ge,de(c+ea(c,a.y)-o))),i.y&&n.includes("n")){let u=Math.min(de(o+ea(o,a.y)),c-Ge);l=de(c-u),o=de(u)}return{...e,x:r,y:o,width:s,height:l}}function Ts(e,n,t,i){let a=Cs(i);if(!Ss(a))return e;let r=(o,s,l)=>{if(s===0)return o;let d=(o-.5)/l,c=s>0?Math.floor(d+Zc)+1:Math.ceil(d-Zc)-1,u=de(c*l+.5);for(let p=0;p<1e3&&(s>0?u<=o:u>=o);p++)c+=s,u=de(c*l+.5);return u};return gi({...e,x:r(e.x,Math.sign(n),a.x),y:r(e.y,Math.sign(t),a.y)})}var Ge=.04,hr=.04;function tu(e,n){let t=()=>{let a=e.getScreenCTM();return a&&a.a!==0&&a.d!==0?{x:a.a,y:a.d}:void 0},i=t()??{x:1,y:1};return a=>(i=t()??i,{x:(a.clientX-n.clientX)/i.x,y:(a.clientY-n.clientY)/i.y})}function mr(e,n){let t={...e,...n};return gi({...t,x:de(t.x),y:de(t.y),width:Math.max(Ge,de(t.width)),height:Math.max(Ge,de(t.height))})}function Es(e,n){let t=n==="down"?e.x:de((1-e.width)/2),i=n==="across"?e.y:de((1-e.height)/2);return gi({...e,x:t,y:i})}function nu(e,n){let t=Es(e,n);return t.x===e.x&&t.y===e.y}function gi(e){let n=Math.min(1-hr,Math.max(-e.width+hr,e.x)),t=Math.min(1-hr,Math.max(-e.height+hr,e.y));return{...e,x:n,y:t}}var de=e=>Math.round(e*1e3)/1e3,iu=10;function fr(e,n,t,i){let a=i.width>0?e.x+n/i.width:e.x,r=i.height>0?e.y+t/i.height:e.y;return gi({...e,x:de(a),y:de(r)})}function Cg(e,n,t,i){let a=n.width,r=n.height,o=e.width*a,s=e.height*r,l=Math.min(o,s),d=e.x*a+(o-l)/2,c=e.y*r+(s-l)/2,u=t.includes("e")?1:-1,p=t.includes("s")?1:-1,m=Ge*Math.max(a,r),g=Math.max(m,l+(u*i.x+p*i.y)/2),y=u>0?d:d+l-g,b=p>0?c:c+l-g;return{...e,x:de(y/a),y:de(b/r),width:de(g/a),height:de(g/r)}}function Sg(e,n,t,i,a=!1){let r=n.width,o=n.height;if(a||e.width*r>=e.height*o){let p=a?Ge:Math.max(Ge,e.height*o/r),m=e.x+e.width,g=t.includes("e")?Math.max(p,e.width+i.x/r):Math.max(p,e.width-i.x/r),y=t.includes("e")?e.x:m-g;return{...e,x:de(y),width:de(g)}}let l=Math.max(Ge,e.width*r/o),d=e.y+e.height,c=t.includes("s")?Math.max(l,e.height+i.y/o):Math.max(l,e.height-i.y/o),u=t.includes("s")?e.y:d-c;return{...e,y:de(u),height:de(c)}}function gr(e,n,t,i,a){let r=tu(e,t),o={...i.handle&&i.outline?i.outline:i.frame},s={...i.frame};e.setPointerCapture(t.pointerId);let l=p=>Math.round(p*1e3)/1e3,d=p=>{if(p.pointerId!==t.pointerId)return;let m=r(p),g=m.x/n.width,y=m.y/n.height,b,k=i.snap!==void 0&&i.snap.on!==p.altKey?i.snap.step:void 0;if(!i.handle)b=gi({...o,x:l(o.x+g),y:l(o.y+y)}),k!==void 0&&(b=$g(b,k));else if(i.square)b=Cg(o,n,i.handle,m);else if(i.line||i.bar){if(b=Sg(o,n,i.handle,m,i.bar===!0),k!==void 0){let C=i.bar===!0||b.width*n.width>=b.height*n.height;b=eu(b,i.handle,k,{x:C,y:!C})}}else{let{x:C,y:w,width:S,height:H}=o,G=o.x+o.width,_=o.y+o.height;i.handle.includes("e")&&(S=Math.max(Ge,o.width+g)),i.handle.includes("s")&&(H=Math.max(Ge,o.height+y)),i.handle.includes("w")&&(S=Math.max(Ge,o.width-g),C=G-S),i.handle.includes("n")&&(H=Math.max(Ge,o.height-y),w=_-H),b={...o,x:l(C),y:l(w),width:l(S),height:l(H)},k!==void 0&&(b=eu(b,i.handle,k))}s=b,a.onFrame(i.elementId,b,!1)},c=p=>{p.pointerId===t.pointerId&&(u(),a.onFrame(i.elementId,s,!0))},u=()=>{e.removeEventListener("pointermove",d),e.removeEventListener("pointerup",c),e.removeEventListener("pointercancel",c);try{e.releasePointerCapture(t.pointerId)}catch{}};return e.addEventListener("pointermove",d),e.addEventListener("pointerup",c),e.addEventListener("pointercancel",c),u}function au(e,n,t,i,a){let r=tu(e,n),o=1;e.setPointerCapture(n.pointerId);let s=c=>{if(c.pointerId!==n.pointerId)return;let u=r(c),p=u.x*(t.includes("e")?1:-1),m=u.y*(t.includes("s")?1:-1),g=i.w>0?(i.w+p)/i.w:1,y=i.h>0?(i.h+m)/i.h:1,b=Math.abs(g-1)>=Math.abs(y-1)?g:y;o=Math.max(.05,b),a(o,!1)},l=c=>{c.pointerId===n.pointerId&&(d(),a(o,!0))},d=()=>{e.removeEventListener("pointermove",s),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l);try{e.releasePointerCapture(n.pointerId)}catch{}};return e.addEventListener("pointermove",s),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),d}var _e=pe,na=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:_e,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],yi=na.find(e=>e.measured);function yu(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return na.find(a=>a.screen.width===t&&a.screen.height===i)}function br(e,n){let t=_e[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}function ru(e,n){if(n===void 0||!(n>0))return f;let t=fi(n,e),i=[],a=n<.025,r=l=>l===0?"rgba(10,132,255,0.6)":a&&l%10!==0?"rgba(255,255,255,0.06)":"rgba(255,255,255,0.14)",o=Math.floor(.5/t.x+1e-6);for(let l=-o;l<=o;l++){let d=(.5+l*t.x)*e.width;d<=0||d>=e.width||i.push(v`<line x1=${d} y1="0" x2=${d} y2=${e.height} stroke=${r(l)} stroke-width="0.5" vector-effect="non-scaling-stroke" />`)}let s=Math.floor(.5/t.y+1e-6);for(let l=-s;l<=s;l++){let d=(.5+l*t.y)*e.height;d<=0||d>=e.height||i.push(v`<line x1="0" y1=${d} x2=${e.width} y2=${d} stroke=${r(l)} stroke-width="0.5" vector-effect="non-scaling-stroke" />`)}return v`<g class="snap-grid" pointer-events="none">${i}</g>`}var Fs={regular:400,medium:500,semibold:600,bold:700},bu=1.15;function qe(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function $e(e,n,t="#FFFFFF"){let i=qe(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var zt=e=>e*.55;function xu(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Tg(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Eg(e,n,t){if(t<=0||e.length*zt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/zt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Mg(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function vu(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function wu(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Rg(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function ku(e,n){return e.reduce((t,i)=>t+i.text.length*zt(i.look.fontSize*n),0)}function Fg(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:zt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=zt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Ag(e,n,t){if(t<=0||ku(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*zt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*zt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Hg(e,n,t){let i=Rg(n),a=e.lineLimit===2&&t.w>0?Fg(e.text,i,t.w):[e.text],r=vu(e.text,a),o=a.map((C,w)=>wu(C,r[w]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>ku(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>Ag(C,l,t.w)),{anchor:c,x:u}=xu(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=C=>C.map(w=>{let S=$e(w.look.colorHex,"fill");return v`<tspan font-size=${w.look.fontSize*l} font-weight=${Fs[w.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${w.text}</tspan>`}),b=$e(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,w)=>v`<tspan x=${u} y=${t.cy+m+(w-(d.length-1)/2)*g}>${y(C)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var As=2;function $u(e,n){let t=n.w>=n.h,i=Math.max(1,e.dotCount),a=t?n.w:n.h,r=t?n.h:n.w,o=Math.max(1,Math.min(r,a/i-As)),s=i*o+(i-1)*As;return{horizontal:t,count:i,d:o,span:s}}function Lg(e,n){let t=$e(e.colorHex,"stroke"),i=$e(e.trackColorHex,"stroke","#FFFFFF"),a=$e(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let{horizontal:m,count:g,d:y,span:b}=$u(e,n),k=(m?n.cx:n.cy)-b/2+y/2;return v`${Array.from({length:g},(C,w)=>{let S=k+w*(y+As),H=w<e.filledCount?t:i;return v`<circle cx=${m?S:n.cx} cy=${m?n.cy:S} r=${y/2}
        fill=${H.stroke} fill-opacity=${H["stroke-opacity"]} />`})}`}if(e.style==="bar"){let m=n.w,g=Math.max(r,m*e.fraction),y=1;return v`
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function zg(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Kn(e,n),o=r?zs(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=Ng(e,a);return o===void 0?s:v`${s}${o}`}function Ms(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var ou=0;function Cu(){return ou+=1,ou.toString(36)}function Pg(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function Ng(e,n){let t=pr(e,n),i=Cu(),a=$e(e.colorHex,"fill"),r=$e(e.highColorHex,"fill",e.colorHex),o=$e(e.lowColorHex,"fill",e.colorHex),s=(g,y)=>v`<circle cx=${g.x} cy=${g.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=g=>c?$e(e.pointColorHexes[g],"fill",e.colorHex):a,p=g=>{let y=qe(g)??qe(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:y.color,opacity:y.opacity*.28};let b=Dg(i,e.id,g),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(b)||d.set(b,v`<linearGradient id=${b} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        ...
        <stop offset="1" stop-color=${y.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${b})`,opacity:1}};if(e.style==="bars")for(let g=0;g<t.count;g++){if(e.holes[g]===!0)continue;let y=t.barRect(g),b=g===e.highIndex?r:g===e.lowIndex?o:u(g),k=Math.min(Math.max(e.barRadius,0),y.w/2,y.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[g]<0;l.push(v`<path d=${Pg(y,k,C)}
          ...
          fill=${b.fill} fill-opacity=${b["fill-opacity"]} />`)}else{let g=Array.from({length:t.count},(C,w)=>t.point(w)),y=e.holes.length>0,k=Jc(t.count,e.holes).filter(C=>!y||C.length>1).map(C=>{let w=C.map(G=>g[G]),S=Xc(w,e.curve),H=`M${w[0].x} ${w[0].y}${S.map(G=>` ${Ms(G)}`).join("")}`;return{run:C,pts:w,legs:S,line:H}});if(e.style==="area")for(let{run:C,pts:w,legs:S,line:H}of k)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let G=0;G<S.length;G++){let _=w[G],j=w[G+1],M=p(e.pointColorHexes[C[G+1]]),U=`M${_.x} ${_.y} ${Ms(S[G])} L${j.x} ${t.baselineY} L${_.x} ${t.baselineY} Z`;l.push(v`<path d=${U} fill=${M.fill} fill-opacity=${M.opacity} stroke="none" />`)}else{let G=p(e.fillColorHex??e.colorHex),_=`${H} L${w[w.length-1].x} ${t.baselineY} L${w[0].x} ${t.baselineY} Z`;l.push(v`<path d=${_} fill=${G.fill} fill-opacity=${G.opacity} stroke="none" />`)}for(let{run:C,pts:w,legs:S,line:H}of k)if(c&&C.length>1)for(let G=0;G<S.length;G++){let _=w[G],j=u(C[G+1]);l.push(v`<path d=${`M${_.x} ${_.y} ${Ms(S[G])}`} fill="none"
    ...
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function vr(e,n){let t=e.family in _e?e.family:"rectangular",i=n.slot??_e[t],a=_e[t],r=br(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=qe(e.backgroundColorHex),l=qe(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Ru(c);if(t==="corner"){let b=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",w=C!=="",S=xr(b,k),H=Os(b,k),G=H/(a.width*b),_=S.tile.cx-H/2,j=S.tile.cy-H/2,M=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,U=f;if(e.bezelGauge)U=ry(e.bezelGauge,b,o);else if(e.bezelText){let I=ty(b,`${o}-bezel`),Q=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?hi((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;U=v`<defs><path id=${I.id} d=${I.d} /></defs>
        <text font-size=${du*b} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${I.id}" startOffset="50%" text-anchor="middle">${uu(Q,I.length,du*b)}</textPath></text>`}let Z=f;if(w){let I=qe(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},Q=Au(b,`${o}-curved`,ny*b,iy);Z=v`<defs><path id=${Q.id} d=${Q.d} /></defs>
        <text font-size=${pu*b} font-weight="600" fill=${I.color} fill-opacity=${I.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${Q.id}" startOffset="50%" text-anchor="middle">${uu(C,Q.length,pu*b*.88)}</textPath></text>`}else{let I=e.borderWidth*r.scale*G,Q=l?v`<circle cx=${H/2} cy=${H/2} r=${H/2-I/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${I} />`:f;Z=v`<g transform="translate(${_} ${j})">
        <g clip-path=${`url(#${o})`}>
          ${s?v`<rect width=${H} height=${H} fill=${s.color} fill-opacity=${s.opacity} />`:f}
          <g data-design-box transform="scale(${r.scale*G})">
            ${c.map(A=>Is(A,a,n,u))}
            ${ru(a,n.grid)}
          </g>
        </g>
    ...
    </select></label>`}function ie(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<div class="field seg-field">${Oe(e,hn(n,a.def,o=>i(o,null),r))}
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let S=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),qn.set(a,{query:"",index:0}),Fe(S),S?.focus()}}>${B("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${nh(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${H=>H.preventDefault()} @click=${H=>g(w,H.target)}>
  ...
  </button>`}function ih(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Ue),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=sb(u,c),b=w=>{t(w),a?.(w.startsWith(Ue)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},k=w=>{if(t(w),!m)return;let S=w.trim();a?.(S.startsWith(Ue)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&g==="mdi"){let w=e.icons.mdiNames?.(),S=lb(w??[],s),H=S.slice(0,Fp),G=r.recent.filter(_=>_.startsWith(Ue));C=h`<div class="sym-browse">
      ${Ip(r,i,g)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${ve(_=>r.setQuery(i,_))} />
      </div>
      ${G.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${G.map(_=>_r(e,_,_===u,b))}</div>`}
      <div class="sym-grid">${H.map(_=>_r(e,_,_===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Hp(H.length,S.length,!0,w.length)}</div>`}
    ...
    </div>`}else if(o){let w=r.category(i),S=ab(w,s,d,c),H=Ks(S.names,s),G=S.fromPack?H.slice(0,Fp):H,_=r.recent.filter(M=>!M.startsWith(Ue)),j=c.size===0?_:_.filter(M=>c.has(M));C=h`<div class="sym-browse">
      ${m?Ip(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${ve(M=>r.setQuery(i,M))} />
        <select @change=${ve(M=>r.setCategory(i,M))}>
          ${rb(c).map(M=>h`<option value=${M.value} ?selected=${M.value===w}>${M.label}</option>`)}
        </select>
      </div>
      ${j.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${j.map(M=>_r(e,M,M===u,b))}</div>`}
      <div class="sym-grid">${G.map(M=>_r(e,M,M===u,b))}</div>
      ${H.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${Hp(G.length,H.length,s.trim()!=="",ob(d))}
          </div>`}
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <span class="unit" aria-hidden="true">%</span>
      ...
      ${Xe("Hidden",r.isHidden,u=>e.update(p=>we(p,t,i,{isHidden:u})),!1)}`,{color:ee.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`})}return d?.place==="through"?Se(e,"placement","Position",h`
      ...
      ${Xe("Hidden",r.isHidden,c=>e.update(u=>we(u,t,i,{isHidden:c})),!1)}`,{color:ee.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`}):Se(e,"placement","Position",h`
    ${Vp(e,n,t)}
    ${d===void 0?h`
  ...
  ${l?f:h`<div class="field list-field"><span>Copy</span>
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function ax(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ke(e.config,t)[0];return Se(e,"tappable","Tap",Ax(e,n,`el-${t}`),{color:ee.tap,icon:"tap",summary:i?Ht(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>ar(a,t))}:{}})}function rx(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${ae("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(tn,Math.max(en,r??tt))},`${i}size`),{step:.5,min:en,max:tn,def:t.labelSize,unit:"pt"})}
      ...
      ${ie("Clock",e.hourCycle,Zd,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${ie("Minutes",e.minutes,Qd,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
    ...
    ${ie("Colour",a,hl,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=Wr(je(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    ${ie("Highlight",r,gb,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
    ...
    ${s==="rich"?kx(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Te(d,ce(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function kx(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ce(e),d=Math.max(0,o.findIndex(A=>A.id===ha.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Ie(e.config,t,n).size??r.fontSize,g=(A,K)=>{Nt.delete(s),i(R=>{A(R),Kd(R)},K)},y=(A,K)=>g(R=>{let x=R.parts?.find($=>$.id===c.id);x&&A(x)},K?`part-${c.id}-${K}`:void 0),b=(A,K)=>{ha.set(s,A),Nt.delete(s),Fe(K)},k=(A,K)=>{let R=J();ha.set(s,R),g(x=>{(x.parts??=[]).push({id:R,value:A})}),sh(K,io(`${a}-part-${R}`),!0)},C=A=>g(K=>{K.parts&&ya(K.parts,d,A)}),w=()=>{let A=o[d+1]??o[d-1];A&&ha.set(s,A.id),g(K=>{K.parts=(K.parts??[]).filter(R=>R.id!==c.id)})},S=o.map((A,K)=>{let R=gx(A.value,l),x=A.id===c.id,$=fl(A),T=R.kind==="value"?e.resolve(A.value):void 0,F=A.fontWeight===void 0?void 0:$i.find(([D])=>D===A.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${x?"true":"false"} class="part-chip ${R.kind} ${x?"on":""}"
      aria-label=${kh(A,K,l)} @click=${D=>b(A.id,D.currentTarget)}>
      <span class="part-dot" style=${`background:${bx(A,p)}`}
        title=${$==="bands"?"By value, with its own bands":$==="pick"?"Its own colour":"The layer colour"}></span>
      ${R.kind==="text"?h`<span class="part-txt">${R.label===""?h`<span class="part-empty">empty</span>`:fx(R.label).map(D=>D.space?h`<span class="part-sp">${"\xB7".repeat(D.text.length)}</span>`:D.text)}</span>`:h`<span class="part-txt">${R.label}</span>`}
    ...
    </button>`}),H=r.rules.some(A=>A.partId===c.id),G=c.value.kind.kind==="literal",_=fl(c),j=c.fontSize!==void 0,M=$i.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,U=A=>{A>=dl&&A<=cl&&y(K=>{K.fontSize=A},"size")},Z=_==="bands"?je(e.resolve(c.value)??""):[],I={layer:"Use the layer colour",...G&&_!=="bands"?{bands:"By value needs a live value"}:{}},Q=(A,K)=>y(R=>{let x={bands:R.bands??[],bandAboveColorHex:R.bandAboveColorHex??le};A(x),x.bands.length>0?R.bands=x.bands:delete R.bands,x.bandAboveColorHex!==le?R.bandAboveColorHex=x.bandAboveColorHex:delete R.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${A=>k(z(""),A.currentTarget)}>${B("text")}<span>Add text</span></button>
        <button type="button" class="small" title="Add a part that shows a live value"
          @click=${A=>k({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},A.currentTarget)}>${B("braces")}<span>Add value</span></button>
      </div>
    </div>
    <div class="part-editor">
      <div class="part-head">
        <span class="part-title"><b>Part ${d+1}</b> of ${u} · ${G?"Text":"Value"}</span>
        <span class="spacer"></span>
      ...
      ${se(e,c.value,A=>y(K=>{K.value=A},"value"),{showResolved:!0,label:G?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ${G?h`<div class="hint">Spaces count, and show as dots in the parts list. Type one at the start or end when this part needs a gap.</div>`:f}
      ${ie("Colour",_,ux,A=>y(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=bl(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=Wr(je(e.resolve(K.value)??"")))}),{def:"layer",titles:I,...G&&_!=="bands"?{disabled:{bands:!0}}:{}})}
      ${_==="pick"?me("Part colour",c.colorHex,A=>y(K=>{K.colorHex=A??p},"color")):f}
      ${_==="bands"?h`
        ${jr({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??le},c.colorHex??p,Q,Z.length===1?Z[0]:void 0)}
        <div class="hint">These bands belong to this part. Another value in the same layer keeps its own.</div>`:f}
      <div class="field seg-field">${Oe("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${M})`,reset:()=>y(A=>{delete A.fontWeight})})}
        ${Ur("Weight",c.fontWeight,$i,A=>y(K=>{K.fontWeight=A}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Oe("Font size",j?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(A=>{delete A.fontSize})}:void 0,eo(c.fontSize??m,U,{step:1,min:dl,max:cl}))}
        ${to(c.fontSize,A=>{A===void 0?y(K=>{delete K.fontSize},"size"):U(A)},{step:1,min:dl,max:cl,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:j?"Part font size":`Part font size, ${m} pt from the layer`,...j?{}:{lead:B("link")}})}
      </label>
    </div>
  </div>`}function $h(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(x=>x.payload.id===a),o=`el-${a}`,s=(x,$)=>e.update(T=>x(T.elements[r]),$?`${o}-${$}`:void 0),l=Ie(e.config,t,n),d=l.frame,c=(x,$)=>e.update(T=>we(T,t,a,{frame:mr(d,x)}),`${o}-${$}-${t}`),u=Ee(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=x=>u[x],g=!1,y=x=>Yn(n)===void 0?f:me(x,Yn(n),$=>s(T=>{Yn(T)!==void 0&&(T.payload.colorSlot.baseColorHex=$??"#FFFFFF")},"color"),!1,p),b,k={},C,w;switch(n.kind){case"text":{let x=($,T)=>s(F=>$(F.payload),T);C=wx(e,n,t,x,o),g=!n.payload.countdown&&!ot(n.payload),w=h`
        ${un(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${ie("Weight",n.payload.fontWeight,$i,$=>s(T=>{T.payload.fontWeight=$}),{def:u.fontWeight})}
        ${Jy({label:"Align",value:n.payload.alignment??"center",options:Ub,def:"center",set:$=>s(T=>{let F=T.payload;$==="center"?delete F.alignment:F.alignment=$})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:Kb,def:"1",set:$=>s(T=>{let F=T.payload;$==="2"?F.lineLimit=2:delete F.lineLimit})})}
        ${Xe("Mono digits",n.payload.monospacedDigits===!0,$=>s(T=>{let F=T.payload;$?F.monospacedDigits=!0:delete F.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,w=un(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let x=n.payload,$=(F,D)=>s(q=>F(q.payload),D),T=x.style==="dots";C=h`
        ${se(e,x.value,F=>$(D=>{D.value=F},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${T?h`
            ${se(e,x.total??Lp(x),F=>$(D=>{D.total=F},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
        ...
        <div class="grid2">
          ${ie("Style",x.style,kb,F=>$(D=>{F==="dots"&&D.total===void 0&&(D.total=Lp(D)),F!=="dots"&&delete D.total,D.style=F}),{titles:$b,def:u.style})}
          ${T?f:un(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${me(T?"Empty dot colour":"Track colour",x.trackColorHex,F=>$(D=>{D.trackColorHex=F??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${ie("Colour",x.coloring,hl,F=>$(D=>{D.coloring=F,F==="bands"&&D.bands.length===0&&(D.bands=Wr([D.minValue,D.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
        ...
        ${T?f:h`
          <div class="grid2">
            ${ae("Threshold",x.thresholdValue,F=>$(D=>{F===void 0?delete D.thresholdValue:D.thresholdValue=F},"thr"),{optional:!0,def:null})}
            ${x.thresholdValue===void 0?f:me("Threshold colour",x.thresholdColorHex,F=>$(D=>{D.thresholdColorHex=F??oi},"thrcol"),!1,oi)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let x=n.payload,$=(E,O)=>s(ge=>E(ge.payload),O),T=u.historyMinutes,F=u.historyPoints,D=x.historyMinutes>0,q=D&&x.source==="statistics",te=D&&!q,ke=D?q?"statistics":"history":"value",$t=q?Vi:An,Vt=In(x)??Ln(x),ze=x.value.kind.kind==="entityState",fe=Vt===void 0?void 0:e.historySeries(Vt),Ve=D&&ze?fe??"":e.resolve(x.value)??"",Je=x.historyPoints<1,pm=te&&ze&&Vt!==void 0?e.historyReadings?.(Vt):void 0,Nl=tx(Je,pm,Jn(x.historyMinutes)),Dl=ml(a,x.historyMinutes,$t),co=D&&ze?ws(Ve):{values:je(Ve),holes:[]},ti=co.values,Ol=E=>x.limit>0&&E.length>x.limit?x.takeFromEnd?E.slice(E.length-x.limit):E.slice(0,x.limit):E,hm=Ol(ti),Bt=ks(hm,rt(x.smoothing),co.holes.length>0?Ol(co.holes):[]),mm=!D&&ze&&ti.length===1,uo=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),Vl=ce(e),ka=x.scaleFrom!==void 0&&uo.some(E=>E.payload.id===x.scaleFrom);C=h`
        ${se(e,x.value,E=>$(O=>{O.value=E},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${ie("Draw",ke,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>$(O=>{if(E==="value"){O.historyMinutes=0;return}O.source=E==="statistics"?"statistics":"history";let ge=O.historyMinutes||ja;O.historyMinutes=E==="statistics"?Math.min(ge,zo):Math.min(ge,qa)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${q?h`
            ...
            <div class="grid2">
              ${sl(a,x.historyMinutes,T,E=>$(O=>{O.historyMinutes=E}),Vi)}
              ${ie("Per",x.statPeriod,Ga,E=>$(O=>{O.statPeriod=E}),{def:Pi})}
            </div>
            ${Dl?ll(x.historyMinutes,E=>$(O=>{O.historyMinutes=E},"span"),!0):f}
            ${ie("Read",x.statType,Fo,E=>$(O=>{O.statType=E}),{def:Ni})}
        ...
        ${te?h`
            ${ze?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${sl(a,x.historyMinutes,T,E=>$(O=>{O.historyMinutes=E}))}
              <div class="field readings-field">${Oe("Points",{atDefault:x.historyPoints===F,title:`Back to ${F<1?"every one":`${F} averaged`}`,reset:()=>$(E=>{E.historyPoints=F})})}
                <div class="readings-row">
                  ...
                  ${Je?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      data-scrub @pointerdown=${ba(x.historyPoints,E=>$(O=>{O.historyPoints=Math.round(E)},"hpoints"),{step:1,min:Ya,max:At})}
                      @input=${ve(E=>{let O=Number(E);E.trim()!==""&&Number.isFinite(O)&&O>=1&&$(ge=>{ge.historyPoints=Math.round(O)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${Dl?ll(x.historyMinutes,E=>$(O=>{O.historyMinutes=E},"span")):f}
        ...
        ${D?h`
            ${Xe("Show gaps when unavailable",x.gaps===!0,E=>$(O=>{E?O.gaps=!0:delete O.gaps}),u.gaps===!0)}
            ${cn(e)}
        ...
        ${ti.length===0&&!(D&&(!ze||fe===void 0||fe===""))?h`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ...
        ${D&&x.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",x.limit,E=>$(O=>{O.limit=Math.max(0,Math.round(E??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${x.limit<=0?f:ie("Keep",x.takeFromEnd?"end":"start",D?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],E=>$(O=>{O.takeFromEnd=E==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${Ce("Smooth data",rt(x.smoothing)??"off",hb,E=>$(O=>{let ge=rt(E);ge===void 0?delete O.smoothing:O.smoothing=ge}),{def:rt(u.smoothing)??"off"})}
        ${cn(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,g=!0;let fm=(()=>{if(ka)return!0;if(x.scale==="fixed")return x.minValue<0&&x.maxValue>0;let E=Bt.filter(po=>Number.isFinite(po));if(E.length===0)return!0;let O=Math.min(...E,x.thresholdValue??1/0),ge=Math.max(...E,x.thresholdValue??-1/0);return O<0&&ge>0})();w=h`
        <div class="grid2">
          ${ie("Style",x.style,rh,E=>$(O=>{O.style=E}),{def:u.style})}
          ${x.style==="bars"?ae("Bar gap",x.barGap,E=>$(O=>{O.barGap=Math.max(0,E??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):un(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${x.style==="bars"?h`
          <div class="grid2">
            ${ae("Corner radius",qt(x.barRadius),E=>$(O=>{let ge=Math.max(0,E??ri);ge===ri?delete O.barRadius:O.barRadius=ge},"barradius"),{step:.5,min:0,def:qt(u.barRadius),unit:"pt"})}
          </div>
          ${Xe("Round top only",Yt(x.barCorners)==="top",E=>$(O=>{E?O.barCorners="top":delete O.barCorners}),Yt(u.barCorners)==="top")}
          ${cn(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${ie("Curve",x.curve??"straight",ub,E=>$(O=>{E==="straight"?delete O.curve:O.curve=E}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${cn(e)}
          ${x.style==="area"?h`
            ${ie("Fill",jt(x.fillStyle),pb,E=>$(O=>{E==="flat"?delete O.fillStyle:O.fillStyle=E}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:jt(u.fillStyle)})}
            ${pl("Fill colour",x.fillColorHex,"Line colour",E=>$(O=>{E===void 0?delete O.fillColorHex:O.fillColorHex=E},"fillcol"))}
            ${cn(e)}`:f}`}
        <div class="grid2">
          ${ie("Scale",x.scale,mb,E=>$(O=>{O.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${ie("Baseline",x.baseline,fb,E=>$(O=>{O.baseline=E}),{def:u.baseline})}
        </div>
        ${uo.length===0?f:Ce("Same scale as",ka?x.scaleFrom:"",[["","Its own"],...uo.map(E=>[E.payload.id,Te(E,Vl)])],E=>$(O=>{E?O.scaleFrom=E:delete O.scaleFrom}),{def:""})}
        ...
        ${!ka&&x.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",x.minValue,E=>$(O=>{O.minValue=E??0},"cmin"),{def:u.minValue})}
              ${ae("Max",x.maxValue,E=>$(O=>{O.maxValue=E??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(O=>{E=Tc(O,a,ge=>Te(ge,Vl))}),E&&e.selectLayer(E)}}>${B("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${ie("Colour",x.coloring,hl,E=>$(O=>{O.coloring=E,E==="bands"&&O.bands.length===0&&(O.bands=Wr(Bt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${x.style==="area"?h`${Xe("Band fill",x.fillBands,E=>$(O=>{O.fillBands=E}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let Bl=E=>Be(e.config,a).some(O=>O.payload.chartAnchor?.at===E),gm=an(e.config,a).length>0,ym=Nn(e.config,a).length>0,bm=Dn(e.config,a).length>0,Gl=fc(e.config,a).length>0,Ul=Hn(x)?void 0:Je&&te?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Kl=x.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0;k={"draw:times":Ul,"draw:dots":Kl};let ni=(E,O,ge,po,Wl)=>h`
        <button class="small ${ge?"on":""}" ?disabled=${ge||Wl!==void 0} aria-pressed=${ge?"true":"false"}
          data-extra=${E} title=${Yr(E,ge?`${O} is on this chart. Remove it in the list at the bottom.`:Wl??`Add ${O.toLowerCase()} to this chart`)}
          @click=${()=>e.update(xm=>{po(xm)})}>${ge?h`<span aria-hidden="true">✓</span>`:B("plus")}<span>${O}</span></button>`;b=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders" @pointerover=${pn} @focusin=${pn}>
            ${ni("draw:threshold","Threshold line",Bl("threshold"),E=>gc(E,a,x.thresholdValue??vl(Bt)))}
            ${ni("draw:now","Now line",Bl("now"),E=>yc(E,a,!0))}
            ${ni("draw:zero","Zero line",Gl,E=>{ts(E,a)})}
            ${ni("draw:times","Clock times",gm,E=>{Pn(E,a)},Ul)}
            ${ni("draw:dots","Dots",ym,E=>{Qo(E,a)},Kl)}
            ${ni("draw:grid","Grid lines",bm,E=>{es(E,a)})}
          </div>
        </div>
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${cn(e)}`;break}case"timeline":{let x=n.payload,$=(fe,Ve)=>s(Je=>fe(Je.payload),Ve),T=u.historyMinutes,F=x.value.kind.kind==="entityState",D=yt(x),q=D===void 0?void 0:e.historySeries(D),te=st(x)*60,ke=Zi(q??"",nn),$t=ml(a,x.historyMinutes),Vt=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,ze=vb(ke,te,Vt===void 0?void 0:e.hass.states[Vt]?.state,Vt?.split(".")[0]);C=h`
        ...
        ${ke.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${ex(ke,te)}</span></span></div>`:f}
        ...
        <div class="grid2">
          ${ae("Gap",x.gap,fe=>$(Ve=>{Ve.gap=Math.min(Xa,Math.max(0,fe??0))},"tgap"),{step:.5,min:0,max:Xa,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",x.cornerRadius,fe=>$(Ve=>{Ve.cornerRadius=Math.max(0,fe??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
...
`;break}case"shape":C=h`<div class="grid2">
          ${ie("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],x=>s($=>{$.payload.kind=x}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:u.kind})}
          ${n.payload.kind==="roundedRectangle"?ae("Corner radius",n.payload.cornerRadius,x=>s($=>{$.payload.cornerRadius=x??6},"radius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"}):f}
        </div>
        ${n.payload.kind==="line"?Zb(t,d,c):f}`,w=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,x=>s($=>{$.payload.thickness=x??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${n.payload.borderColorHex!==void 0?ae("Border width",n.payload.borderWidth,x=>s($=>{$.payload.borderWidth=x??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let x=n.payload,$=(q,te)=>s(ke=>q(ke.payload),te),T=x.entity.entityId?e.hass.states[x.entity.entityId]?.attributes?.entity_picture:void 0,F=typeof T=="string"?T:void 0,D=F!==void 0&&!F.startsWith("/");C=h`
        ${ie("Source",x.source,[["camera","Camera"],["entityPicture","Entity picture"]],q=>$(te=>{te.source=q}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:u.source})}
        ${x.source==="camera"?h`
        ...
        ${ie("Picture",x.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],q=>$(te=>{te.contentMode=q}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:u.contentMode})}
        ${Xn("Zoom",x.zoom,q=>$(te=>{te.zoom=q},"zoom"),{min:Ns,max:4,step:.05,def:1,format:q=>`${q.toFixed(2)}x`,unit:"x"})}
        ${Xn("Pan left/right",x.panX,q=>$(te=>{te.panX=q},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${Xn("Pan up/down",x.panY,q=>$(te=>{te.panY=q},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${x.contentMode==="fit"&&x.zoom===1?"hint keep":"hint"}>${qb(x)}</div>
        ${ae("Corner radius",x.cornerRadius,q=>$(te=>{te.cornerRadius=Math.max(0,q??si)},"imgradius"),{step:1,min:0,def:si,unit:"pt"})}`;break}case"tap":{C=h`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let x=n.payload,$=(q,te)=>s(ke=>q(ke.payload),te),T=e.config.elements.find(q=>q.payload.id===x.chart),F=T?.kind==="chart"||T?.kind==="timeline"?T:void 0,D=F?.kind==="timeline"?"timeline":"chart";C=h`
        <div class="field readout"><span>${F?.kind==="timeline"?"Timeline":"Chart"}</span><span class="readout-v">${F?h`<button class="small" title=${`Select that ${D}`} @click=${()=>e.selectLayer(F.payload.id)}>${Te(F,ce(e))}</button>`:"None"}</span></div>
        ${F===void 0?h`<div class="hint warn">The chart or timeline these times belonged to is gone, so this layer draws nothing.</div>`:F.kind==="timeline"?yt(F.payload)===void 0?h`<div class="hint warn">That timeline names no entity yet, so it has no span to label and
                  this layer draws nothing.</div>`:f:Hn(F.payload)?f:h`<div class="hint warn">That chart has no evenly spaced span to label, so this layer draws
        ...
        <div class="hint">Evenly spaced from the start of the ${D}'s span to now. Auto follows the watch's
          own clock and drops the minutes past a three hour span.</div>`);break}case"imageTime":{let x=n.payload,$=e.config.elements.find(F=>F.payload.id===x.image),T=$?.kind==="image"?$:void 0;C=h`
        ...
        <div class="hint">The time that picture was fetched, not the time now: a picture that stops updating
          ...
          has been fetched once. Move and size it like any other layer: the chip grows to fill the frame.</div>`;break}case"chartDots":{let x=n.payload,$=(te,ke)=>s($t=>te($t.payload),ke),T=e.config.elements.find(te=>te.payload.id===x.chart),F=T?.kind==="chart"?T:void 0,D=F===void 0?void 0:Ie(e.config,t,F).size??F.payload.lineWidth,q=D===void 0?void 0:Math.round(D*18)/10;C=h`
        ${Gp(e,F)}
        ...
        ${cn(e)}`,w=h`
        ${ie("Dots",x.dots,ah,te=>$(ke=>{ke.dots=te}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",x.size??q,te=>$(ke=>{let $t=ht(te);$t===void 0||$t===q?delete ke.size:ke.size=$t},"dotsize"),{step:.5,min:1,max:12,...q===void 0?{}:{def:q},unit:"pt"})}
          ${pl("Dot colour",x.colorHex,"Series colour",te=>$(ke=>{te===void 0?delete ke.colorHex:ke.colorHex=te},"dotcol"))}
        </div>
        <div class="hint">Auto leaves the dots off once the readings sit too close to tell apart. Left alone, a dot
          is a little wider than the chart's line and takes the colour the series has at its reading.</div>`;break}case"chartGrid":{let x=n.payload,$=(D,q)=>s(te=>D(te.payload),q),T=e.config.elements.find(D=>D.payload.id===x.chart),F=T?.kind==="chart"?T:void 0;C=h`
        ${Gp(e,F)}
        ...
        ${cn(e)}`,w=h`
        <div class="grid2">
          ${ae("Lines",x.lines,D=>$(q=>{q.lines=Mn(D??Jt)},"lines"),{step:1,min:1,max:4,def:Jt})}
          ${ae("Thickness",x.thickness,D=>$(q=>{q.thickness=Rn(D??Xt)},"thick"),{step:.25,min:Va,max:Ba,def:Xt,unit:"pt"})}
        </div>
        ${me("Colour",x.colorHex,D=>$(q=>{q.colorHex=D??Rt},"gridcol"),!1,Rt)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let S=g||Yn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&ot(n.payload)?"Layer colour":"Colour"),H=as(e.config,n),G=H?{kind:{kind:"entityState",...H}}:void 0,_=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,j=Cx[n.kind],M=Sx[n.kind],U=ol(n.payload,u,j),Z=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,I=e.config.perFamily[t]?.placements[a]?.size!==void 0,Q=ol(n.payload,u,M)||Z!==void 0&&l.size!==void 0&&l.size!==u[Z],A=zn(e.config,a),K=(x,$)=>()=>s(T=>Pr(T.payload,u,x),$),R=h`<section class="sec name-sec" data-open="true" style=${`--c:${ee.place}`}>
    ...
    ${R}
    ${Se(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:vh(e,n,o)}${C}`,{color:ee.content,icon:"content",summary:wl(e,n),...U?{reset:()=>s(x=>{Pr(x.payload,u,j),x.kind==="text"&&sa(x.payload.rules)},"reset-content")}:{}})}
    ${w===void 0&&S===void 0?f:Se(e,"look",n.kind==="image"?"Picture":"Look",h`${w??f}${S??f}`,{color:ee.look,icon:n.kind==="image"?"image":"look",...qr(n)?{summary:qr(n)}:{},...Q?{reset:()=>e.update(x=>{Pr(x.elements[r].payload,u,M),I&&we(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Extras",Rx(e,n,b,k),{color:ee.numbers,icon:"text",summary:Mx(e,n),...A.length>0||Be(e.config,a).length>0||an(e.config,a).length>0||Nn(e.config,a).length>0||Dn(e.config,a).length>0||ol(n.payload,u,Up)?{reset:()=>e.update(x=>{for(let T of zn(x,a))be(x,T.payload.id);for(let T of Be(x,a))be(x,T.payload.id);for(let T of an(x,a))be(x,T.payload.id);for(let T of Nn(x,a))be(x,T.payload.id);for(let T of Dn(x,a))be(x,T.payload.id);let $=x.elements.find(T=>T.payload.id===a);$&&Pr($.payload,u,Up)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?$x(e,n):f}
    ${Se(e,"states","States",Lh(e,n.payload.rules,n.kind,x=>x.elements.find($=>$.payload.id===a)?.payload.rules,`rules-${a}`,G,_),{color:ee.states,icon:"states",summary:aa(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ...
    ${y===0?f:h`
      ...
      ${B("show")}<span>Show preview</span></button>`;let t=e==="timeline"?"timeline:times":e==="image"?"image:time":void 0,i=fa!==void 0&&tl(fa)===e?fa:t,a=i===void 0?void 0:n[i],r=e==="image"?"picture":e;return h`<div class="xprev">
    ...
    <button class="icon xprev-hide" title="Hide the preview" aria-label="Hide the preview"
      @click=${o=>Kp(!1,o.currentTarget)}>${B("hide")}</button>
    ...
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
        ...
        ${ie("Style",c.style,rh,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
        ...
        ${ie("Picture",c.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],u=>r(p=>{p.kind==="image"&&(p.payload.contentMode=u)},"mode"),{def:o.contentMode})}`}case"tap":return $l(e,n.payload,(c,u)=>r(p=>{p.kind==="tap"&&c(p.payload)},u??"action"),i);case"chartTimes":{let c=n.payload;return h`
        ...
        <div class="grid2">
          ${ae("Time size",c.labelSize,u=>r(p=>{p.kind==="chartTimes"&&(p.payload.labelSize=Math.min(tn,Math.max(en,u??tt)))},"size"),{step:.5,min:en,max:tn,def:o.labelSize,unit:"pt"})}
        ...
        ${ie("Dots",c.dots,ah,g=>r(y=>{y.kind==="chartDots"&&(y.payload.dots=g)},"mode"),{def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",c.size??m,g=>r(y=>{if(y.kind!=="chartDots")return;let b=ht(g);b===void 0||b===m?delete y.payload.size:y.payload.size=b},"size"),{step:.5,min:1,max:12,...m===void 0?{}:{def:m},unit:"pt"})}
        ...
        <div class="grid2">
          ${ae("Lines",c.lines,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.lines=Mn(u??Jt))},"lines"),{step:1,min:1,max:4,def:Jt})}
          ${ae("Thickness",c.thickness,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.thickness=Rn(u??Xt))},"thick"),{step:.25,min:Va,max:Ba,def:Xt,unit:"pt"})}
        </div>
          ...
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${Qa(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...Ko}})}>${B("reset")}</button>`}
            </div>
          </div>
        </div>
        ${Ex(e,a.payload.id)}
    ...
    ${Cl(e,t.map(r=>({el:r,lead:B(r.kind),title:Te(r,i),kind:sn[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Ki(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Mh(e,n){if(n==="inline")return Lx(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ne(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ne(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=ao(e.config,n),r=t.backgroundColorHex?He(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${He(t.borderColorHex)} border`:"no border";return h`
    ...
    ${n==="corner"?Se(e,"corner","Corner content",_x(e,t,i),{color:ee.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${Se(e,"states","Shape states",Lh(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:ee.states,icon:"states",summary:aa(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${Se(e,"content","Inline text",h`
      ...
      ${kl(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:ee.content,icon:"text",summary:De(`${n.label?`${n.label}: `:""}${Me(n.value,i)}`,48)})}
    ${Se(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:ee.look,icon:"icon",summary:n.symbol||"None"})}`}function _x(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ${ie("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=z("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ie("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=z("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:z("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(m=>ya(m,t,t-1))}>${B("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(m=>ya(m,t,t+1))}>${B("down")}</button>
    ...
    <div class="rule-head">
      ...
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>ya(c.cases,t,t-1))}>${B("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>ya(c.cases,t,t+1))}>${B("down")}</button>
    ...
    ${Ah(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function Ux(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=Bn(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=se(e,s.value??z(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${se(e,s.value??z(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${se(e,s.upper??z(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${Re("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!Kx(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${qp(e,"From",s.value??z("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${qp(e,"To",s.upper??z("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
    ...
    ${Ih(e,n,a,o)}
      ...
      ${Vx(e,n,t,i,a,o)}`:Yx(e,s.table,n[0],t,i,a,r,o)}function Yx(e,n,t,i,a,r,o,s){let l=(R,x)=>e.update($=>{let T=a($);T&&R(T)},x?`${r}-${x}`:void 0),d=n.value??Yp.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!ap(d)&&Xx(e.resolve(d)),p=ji[i],m=Or.get(r)??new Set,g=n.columns.length===0&&m.size===0?[ip[i]]:[],y=qu(n.columns,[...m,...g.filter(R=>R!==void 0)],p),b=Nr.get(r),k=t?t.partId:s?.some(R=>R.id===b)?b:void 0,C=s!==void 0&&k!==void 0,w=C?p.filter(R=>Xr.includes(R)):p,S=C?y.filter(R=>!Xr.includes(R)):[],H=(R,x)=>{if(!t){R?Nr.set(r,R):Nr.delete(r),Fe(x);return}l($=>{let T=$[0];T&&(R?T.partId=R:delete T.partId)})},G=t?e.liveBranch(t):"none",_=t?e.forced.get(t.id)??"live":"live",j=R=>_!=="live"&&(_==="otherwise"?R==="otherwise":_.caseId===R),M=R=>{t&&e.setForced(t.id,j(R)?"live":R==="otherwise"?"otherwise":{caseId:R})},U=R=>{Yp.set(r,R),n.rows.length!==0&&l(x=>ep(x,R),"lhs")},Z=()=>{Nr.delete(r),l(R=>{Zu(R,d??z(""),u),k!==void 0&&R[0]&&R[0].partId===void 0&&(R[0].partId=k)})},I=n.rows.map((R,x)=>Jp(e,{key:`${r}-${R.caseId}`,label:np(R.comparison,$=>Me($,ce(e))),columns:y,changes:R.changes,live:G===R.caseId,forced:j(R.caseId),onForce:()=>M(R.caseId),when:tv(e,R.comparison,`${r}-${R.caseId}`,($,T)=>l(F=>{let D=F[0]?.cases.find(q=>q.id===R.caseId)?.when.tests[0];D&&$(D.comparison)},T&&`${R.caseId}-${T}`)),updChanges:($,T)=>l(F=>{let D=F[0]?.cases.find(q=>q.id===R.caseId);D&&$(D.then)},T&&`${R.caseId}-${T}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${x===0} @click=${()=>l($=>Ys($,x,x-1))}>${B("up")}</button>
      <button class="icon" title="Move down" ?disabled=${x===n.rows.length-1} @click=${()=>l($=>Ys($,x,x+1))}>${B("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l($=>Qu($,R.caseId))}>${B("delete")}</button>`})),Q=n.otherwise===void 0?f:Jp(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:G==="otherwise",forced:j("otherwise"),onForce:()=>M("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(R,x)=>l($=>{let T=$[0]?.otherwise;T&&R(T)},x),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(R=>Xs(R,!1))}>${B("close")}</button>`}),A=Vr.get(r),K=Jx.filter(R=>w.includes(R)&&!y.includes(R));return h`
    <div class="states">
      ${se(e,d??z(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:Rh(s,k,ce(e),H)}
          ...
          <tr>
            ...
            ${y.map(R=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${vt[R]} column`}
                @click=${x=>{Vr.set(r,R),Fe(x.target)}}>${B("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${ro(S.map(R=>vt[R]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${A===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${vt[A]} column? Its ${Xp(n,A)} value${Xp(n,A)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${R=>{Vr.delete(r),Or.get(r)?.delete(A),Fe(R.target),l(x=>tp(x,A))}}>Remove</button>
        <button class="small" @click=${R=>{Vr.delete(r),Fe(R.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(R=>Xs(R,!0))}>${B("plus")}<span>Otherwise</span></button>`:f}
          ${K.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${R=>{let x=R.target,$=x.value;if(x.value="",!$)return;let T=Or.get(r)??new Set;T.add($),Or.set(r,T),Fe(x)}}>
      ...
      <div class="states-switch">
        <button class="link" @click=${R=>{gl.add(r),Fe(R.target)}}>Advanced</button>
    ...
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${lh}>
      ...
      ${ma.has(o)?h`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Ih(e,r,s,a)}
    ...
    </div>`}function ev(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=lr(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${$i.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??z(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Hh.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
    ...
    ${a==="value"||a==="between"?o(n.value??z(""),s=>i(l=>{l.value=s},"rhs"),"rhs",r?"0":"value"):f}
    ${a==="between"?h`<span class="when-and">to</span>${o(n.upper??z(""),s=>i(l=>{l.upper=s},"upper"),"upper","100")}`:f}
...
`)}var rm="wrist-assistant-panel.layers.v1",om="wrist-assistant-panel.grid.v1",Dt=34,ei=200,Yv=720,lo=320,Xv=80,Jv=56,sm="wrist-assistant-panel.columns.v3",Il=e=>Math.max(ei,Math.min(Yv,Math.round(e))),lm=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Zv(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Qv=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,wa=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",yn=wa==="Cmd"?"\u2318":"Ctrl+",Ll=wa==="Cmd"?"\u21E7":"Shift+";function dm(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Xv;if(i>=ei*2+lo){let r=i-lo,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(ei,Math.floor(o*l)),s=Math.max(ei,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(ei,o-d):s=Math.max(ei,s-d))}return{columns:3,left:o,right:s}}let a=e-Jv;return a>=ei+lo?{columns:2,left:Math.min(n,a-lo),right:t}:{columns:1,left:n,right:t}}var L=class L extends Gt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=nm;this.colRight=im;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.snapGrid=!1;this.gridStep=.05;this.altHeld=!1;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=yi.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Bu(()=>this.requestUpdate());this.imageSizes=Gu(()=>this.requestUpdate());this.symbols=new Sr(()=>this.requestUpdate());this.keyHandler=t=>{t.key==="Alt"&&(this.altHeld=!0),this.onKey(t)};this.blurHandler=()=>{this.altHeld=!1};this.heldArrows=new Set;this.keyUpHandler=t=>{t.key==="Alt"&&(this.altHeld=!1),this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Mr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Rl(a,this.hass.states);r.some(s=>xl(em(s.entityId)))||Fl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||xl(Qh)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Gv}static{this.styles=mo`
    :host {
      ...
      --wa-tap: ${Ae(Ye.tap)};
      --wa-states: ${Ae(ee.states)};
      --wa-place: ${Ae(ee.place)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.held { background: color-mix(in srgb, ${Ae(ee.group)} 12%, var(--wa-panel)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${Ae(ee.locked)}; }
    ...
    .card.tint-values {
      ...
      background: color-mix(in srgb, ${Ae(ee.complication)} 8%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${Ae(ee.complication)} 25%, var(--wa-card));
    }
    .card.tint-states {
      padding: 10px 14px 12px;
      background: color-mix(in srgb, ${Ae(ee.states)} 12%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${Ae(ee.states)} 35%, var(--wa-card));
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.loadGrid(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("blur",this.blurHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Zr,this.scrubStart),this.addEventListener(Qr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Vv)}loadColumnWidths(){try{let t=window.localStorage.getItem(sm);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Il(i.left)),typeof i.right=="number"&&(this.colRight=Il(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(sm,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadGrid(){try{let t=window.localStorage.getItem(om);if(!t)return;let i=JSON.parse(t);typeof i.on=="boolean"&&(this.snapGrid=i.on),$s.includes(i.step)&&(this.gridStep=i.step)}catch{}}setGrid(t,i){this.snapGrid=t,this.gridStep=i;try{window.localStorage.setItem(om,JSON.stringify({on:t,step:i}))}catch{}}snapTarget(t){return{snap:{step:fi(this.gridStep,pe[t]),on:this.snapGrid}}}loadListView(){try{let t=window.localStorage.getItem(rm);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(rm,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      @click=${()=>{this.zoomed=!0}}>${B("expand")}</button>`}renderGridButton(){let t=this.snapGrid,i=!this.draft||this.parseError!==void 0||this.activeFamily==="inline";return h`<span class="grid-tool ${t?"on":""}">
      <button class="pick ${t?"on":""}" ?disabled=${i} aria-pressed=${t?"true":"false"}
      ...
      ${t?h`<select class="grid-step" aria-label="Grid size" ?disabled=${i}
        @change=${a=>this.setGrid(!0,Number(a.target.value))}>
        ${$s.map(a=>h`<option value=${a} ?selected=${a===this.gridStep}>${a*100}%</option>`)}
      </select>`:f}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?os(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication");if(this.showTaps){let I=this.focusTapId();if(I!==void 0&&o===I&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,I,r??void 0);return}let Q=this.hitLayerId(i);Q?this.inspect={kind:"layer",id:Q}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let l=lm(i);if(!l&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let d=os(this.draft.config,o),c=this.draft.config.elements.find(I=>I.payload.id===d);if(!d||!c)return;if(l){i.preventDefault(),this.togglePick(d);return}let u,p=this.inspect.kind==="layer"?this.inspect.id:void 0;if(p!==void 0&&p!==d&&!r){let I=this.draft.config.elements.find(A=>A.payload.id===p);I!==void 0&&I.kind!=="chartDots"&&I.kind!=="chartGrid"&&I.payload.chartAnchor?.place!=="through"&&lt(this.draft.config,p)?.locked!==!0&&Zv(s,p,i)&&(u=d,d=p,c=I)}let m=lt(this.draft.config,d),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r){let I=g||this.inspect.kind==="layer"&&lt(this.draft.config,this.inspect.id)?.id===m.id;this.beginGroupGesture(t,i,s,m,I?d:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==d)&&(this.inspect={kind:"layer",id:d},r)||c.payload.chartAnchor?.place==="through")return;i.preventDefault();let y=Ie(this.draft.config,t,c).frame,b=this.gestureCanvas(t),k=c.payload.chartAnchor,C=k!==void 0&&!gt(k.at)&&k.place!=="through",w=k!==void 0&&gt(k.at)&&k.place==="through",S=pe[t],H={dx:k?.dx??0,dy:k?.dy??0},G=k!==void 0&&!r?mi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(I=>I.id===d)?.frame:void 0,_=G??y,j=I=>Math.round(I*10)/10;this.cancelGesture?.();let M=!1,U=r!==null?mi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(I=>I.id===d):void 0;if(r!==null&&U?.kind==="icon"){let I=Ps(U)/2,Q=U.size;this.cancelGesture=au(s,i,r,{w:I,h:I},(A,K)=>{this.mutate(R=>{we(R,t,d,{size:Math.max(1,Math.round(Q*A))})},`drag-${d}-${t}`),K&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let Z=U!==void 0?Eu(U,_,b):{};this.cancelGesture=gr(s,b,i,{elementId:d,frame:_,handle:r??void 0,...Z,...k===void 0?this.snapTarget(t):{}},{onFrame:(I,Q,A)=>{if(A||(M=!0),A&&!M&&u!==void 0){this.inspect={kind:"layer",id:u},this.cancelGesture=void 0;return}this.mutate(K=>{if(k===void 0){we(K,t,I,{frame:Q});return}let R=G?{width:y.width,height:y.height}:{width:Q.width,height:Q.height};we(K,t,I,{frame:{...Q,...R,x:C?Q.x:y.x,y:y.y}});let x=K.elements.find(F=>F.payload.id===I)?.payload.chartAnchor;if(x===void 0)return;let $=H.dx,T=w?H.dy:j(H.dy+(Q.y-_.y)*S.height);$?x.dx=$:delete x.dx,T?x.dy=T:delete x.dy},`drag-${I}-${t}`),A&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=Lt(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map(C=>[C.payload.id,Ie(s,t,C).frame])),c=[...d.values()],u=Math.min(...c.map(C=>C.x)),p=Math.min(...c.map(C=>C.y)),m=Math.max(...c.map(C=>C.x+C.width)),g=Math.max(...c.map(C=>C.y+C.height)),y={x:u,y:p,width:m-u,height:g-p,rotationDegrees:0},b=C=>Math.round(C*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=gr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y,...this.snapTarget(t)},{onFrame:(C,w,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let H=w.x-y.x,G=w.y-y.y;this.mutate(_=>{for(let[j,M]of d)we(_,t,j,{frame:{...M,x:b(M.x+H),y:b(M.y+G)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?iu:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(Lt(r,k).map(C=>C.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=lt(r,u);if(m?.locked)return this.nudgeMany(Lt(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=Ie(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let k=!gt(y.at);return l===0&&!(k&&s!==0)||this.mutate(C=>{k&&s!==0&&we(C,d,u,{frame:fr(g,s,0,c)});let w=C.elements.find(H=>H.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let S=Math.round(((w.dy??0)+l)*10)/10;S?w.dy=S:delete w.dy},`nudge-${u}-${d}`),!0}let b=this.snapGrid?Ts(g,s,l,fi(this.gridStep,c)):fr(g,s,l,c);return(b.x!==g.x||b.y!==g.y)&&this.mutate(k=>we(k,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let H=l.elements.find(G=>G.payload.id===S);H&&c.set(S,Ie(l,i,H).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),g=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),b={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},k=this.snapGrid?Ts(b,o,s,fi(this.gridStep,a)):fr(b,o,s,a),C=k.x-b.x,w=k.y-b.y;return(C!==0||w!==0)&&this.mutate(S=>{for(let[H,G]of c)we(S,i,H,{frame:{...G,x:d(G.x+C),y:d(G.y+w)}})},r),!0}gestureCanvas(t){let i=br(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Os(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ke(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=xe(s,l),c=Ie(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=gr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o,...this.snapTarget(t)},{onFrame:(u,p,m)=>{this.mutate(g=>{d?$c(g,u,t,p):we(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:dm(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
      ...
      ${a("all","All",t.length)}
      ${on.map(r=>a(r,ne(r),t.filter(o=>i(o).includes(r)).length))}
      ...
      ${this.pickerOpen?h`<div class="menu" role="listbox">
        ${o.length>=L.FILTER_FROM_ROWS?this.renderPickerFilter(o):f}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Bs.map(s=>h`<button class="add" style=${`--k:${Ye[s]}`} ?disabled=${i} title=${`Add a blank ${sn[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${op(s)}</span>`:f}<span class="add-name">${r?B(s):h`<span class="k"></span>`}<span>${sn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Te(M,d)}</b>
          <small><span class="kind">${sn[M.kind]}</span> · ${iw(M,c,this.historySeries,A.size)}</small>
          ${S?h`<span class="facts">${tw(this.host(),a,M,A).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${yn}])`} aria-label="Bring forward" @click=${F=>{F.stopPropagation(),r(I,1)}}>${B("up")}</button>
            <button class="icon" title=${`Send back (${yn}[)`} aria-label="Send back" @click=${F=>{F.stopPropagation(),r(I,-1)}}>${B("down")}</button>
            <button class="icon" title=${`${A.isHidden?"Show":"Hide"} (${Ll}${yn}H)`} aria-label=${A.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(D=>we(D,a,I,{isHidden:!A.isHidden}))}}>${B(A.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${yn}D)`} aria-label="Duplicate" @click=${F=>{F.stopPropagation(),o(I)}}>${B("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${F=>{F.stopPropagation(),s(I)}}>${B("delete")}</button>
          </span>`:f}
        </span>
      </div>`},G=(M,U)=>{let Z=this.inspect.kind==="group"&&this.inspect.id===M.id,I=!this.collapsed.has(M.id),Q=this.rowDrag(M.id,i),A=U[0],K=U[U.length-1],R=$=>{let T=$.currentTarget,F=T.getBoundingClientRect(),D=F.top+(T.classList.contains("drop-before")?Dt:0),q=F.bottom-(T.classList.contains("drop-after")?Dt:0),te=($.clientY-D)/Math.max(1,q-D);return te<.25?"drop-before":!I&&te>.75?"drop-after":"drop-into"},x=U.map($=>$.payload.id);return h`<div class="layer group ${Z?"hl":""} ${S?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${Q.draggable}
        ...
        @drop=${$=>{$.preventDefault();let T=R($);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!A||!K)){if(T==="drop-before"){this.reorderLayer(F,A.payload.id,!0,!0);return}if(T==="drop-after"){this.reorderLayer(F,K.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,A.payload.id,!0),this.mutate(D=>Ki(D,F,M.id)))}}}>
        <span class="grip" title="Drag to reorder the whole group.">${B("grip")}</span>
        <span class="bar"></span>
        <span class="folder">${B("folder")}</span>
        <span class="name">
          <b>${M.name}</b>
          <small><span class="kind">Group</span> · ${U.length} layer${U.length===1?"":"s"} · ${M.locked?"locked":"unlocked"}</small>
          ${S?h`<span class="facts"><span class="fact"><b>Holds</b> ${U.map($=>Te($,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Ll}${yn}G)`} aria-label="Ungroup" @click=${$=>{$.stopPropagation(),this.mutate(T=>Ui(T,M.id)),Z&&(this.inspect={kind:"general"})}}>${B("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${M.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${$=>{$.stopPropagation(),this.mutate(T=>{let F=T.groups?.find(D=>D.id===M.id);F&&(F.locked=!F.locked)})}}>${B(M.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${I?"true":"false"} title=${I?"Fold the group":"Unfold the group"}
            @click=${$=>{$.stopPropagation();let T=new Set(this.collapsed);I?T.add(M.id):T.delete(M.id),this.collapsed=T}}>${B("chevron")}</button>
        </span>
      </div>`},_=[],j=new Set;for(let M=0;M<l.length;M++){let U=l[M],Z=U.payload.groupId,I=Z===void 0?void 0:t.groups?.find(K=>K.id===Z);if(!I){_.push(H(U,!1));continue}if(j.has(I.id))continue;j.add(I.id);let Q=l.filter(K=>K.payload.groupId===I.id);_.push(G(I,Q));let A=this.inspect.kind==="group"&&this.inspect.id===I.id;this.collapsed.has(I.id)||_.push(h`<div class="group-kids">${Q.map(K=>H(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${B("layers")}</span>Layers
        ...
        <span class="tool-set">
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([M,U])=>h`
              <button class=${this.layerDetail===M?"on":""} title=${U} aria-label=${U} aria-pressed=${this.layerDetail===M?"true":"false"}
                @click=${()=>{this.layerDetail=M,this.saveListView()}}>${B(M)}</button>`)}
          </span>
          <span class="seg" role="group" aria-label="Preview size">
            ${jv.map((M,U)=>h`
              <button class=${this.thumbStep===U?"on":""} title=${`${am[U]} row pictures`}
                aria-label=${`${am[U]} row pictures`} aria-pressed=${this.thumbStep===U?"true":"false"}
                @click=${()=>{this.thumbStep=U,this.saveListView()}}>${M}</button>`)}
          </span>
        </span>
      </h2>
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${ee.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${M=>{M.preventDefault(),this.clearDragMarks();let U=this.dragId,Z=[...l].reverse().find(I=>I.payload.id!==U&&I.payload.groupId!==U);U&&Z&&this.reorderLayer(U,Z.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?hi((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=yh();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${B("content")}</span>Shared values
      ...
      ${this.sharedHelp?h`<div class="shared-help">
        ...
        ${o}
      </div>`;let s=this.host(),l=new xt(this.buildContext(),this.draft?.config),d=ce(s);return h`<div class="card tint-values values-list" style=${`--c:${ee.complication}`}>
      ${o}
      <div class="data">
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${g=>{g.stopPropagation(),this.mutate(y=>{cs(y,c.id)}),p&&(this.openValue=void 0)}}>${B("delete")}</button>`:f}
        </div>
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=Lc(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${ee.states}`}>
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ...
        ${a.map(o=>{let s=ys(o.id),l=this.sharedRaw(o.id)??"",d=l===""?"empty":l,c=o.name||"(unnamed)",u=this.testValues.get(s),p={entity_id:s,state:l,attributes:{},last_changed:"",last_updated:""};return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${ee.complication}`}
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${Se(a,"complication","Complication",mh(a),{color:ee.complication,icon:"watch",alwaysOpen:!0})}
      ...
      ${Se(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:ee.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=Uu({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
    ...
    </details>`}};P([ai({attribute:!1})],L.prototype,"hass",2),P([ai({type:Boolean})],L.prototype,"narrow",2),P([ai({attribute:!1})],L.prototype,"panel",2),P([V()],L.prototype,"colLeft",2),P([V()],L.prototype,"colRight",2),P([V()],L.prototype,"panelWidth",2),P([V()],L.prototype,"owners",2),P([V()],L.prototype,"ownerId",2),P([V()],L.prototype,"records",2),P([V()],L.prototype,"selectedId",2),P([V()],L.prototype,"draft",2),P([V()],L.prototype,"readOnlyReason",2),P([V()],L.prototype,"parseError",2),P([V()],L.prototype,"maxSchemaVersion",2),P([V()],L.prototype,"presets",2),P([V()],L.prototype,"occupied",2),P([V()],L.prototype,"serverToken",2),P([V()],L.prototype,"appliedToken",2),P([V()],L.prototype,"sendStatusKnown",2),P([V()],L.prototype,"polling",2),P([V()],L.prototype,"lastPollSeconds",2),P([V()],L.prototype,"sendPending",2),P([V()],L.prototype,"pages",2),P([V()],L.prototype,"templateResults",2),P([V()],L.prototype,"historySeries",2),P([V()],L.prototype,"historyReadings",2),P([V()],L.prototype,"templateError",2),P([V()],L.prototype,"templateFetchedAt",2),P([V()],L.prototype,"forced",2),P([V()],L.prototype,"showRaw",2),P([V()],L.prototype,"inspect",2),P([V()],L.prototype,"openSections",2),P([V()],L.prototype,"helpSections",2),P([V()],L.prototype,"pickerOpen",2),P([V()],L.prototype,"pickerFilter",2),P([V()],L.prototype,"pickerNote",2),P([V()],L.prototype,"openValue",2),P([V()],L.prototype,"sharedHelp",2),P([V()],L.prototype,"editingValue",2),P([V()],L.prototype,"thumbStep",2),P([V()],L.prototype,"layerDetail",2),P([V()],L.prototype,"addOpen",2),P([V()],L.prototype,"addDetail",2),P([V()],L.prototype,"multi",2),P([V()],L.prototype,"copiedPosition",2),P([V()],L.prototype,"snapGrid",2),P([V()],L.prototype,"gridStep",2),P([V()],L.prototype,"altHeld",2),P([V()],L.prototype,"collapsed",2),P([V()],L.prototype,"activeFamily",2),P([V()],L.prototype,"picking",2),P([V()],L.prototype,"pickHoverId",2),P([V()],L.prototype,"listHoverIds",2),P([V()],L.prototype,"rowHoverId",2),P([V()],L.prototype,"zoomed",2),P([V()],L.prototype,"helpOpen",2),P([V()],L.prototype,"showTaps",2),P([V()],L.prototype,"savedName",2),P([V()],L.prototype,"presetKind",2),P([V()],L.prototype,"presetEntity",2),P([V()],L.prototype,"newOpen",2),P([V()],L.prototype,"newName",2),P([V()],L.prototype,"newFamily",2),P([V()],L.prototype,"shareOpen",2),P([V()],L.prototype,"shareMode",2),P([V()],L.prototype,"shareLabels",2),P([V()],L.prototype,"shareNote",2),P([V()],L.prototype,"importOpen",2),P([V()],L.prototype,"importText",2),P([V()],L.prototype,"importParse",2),P([V()],L.prototype,"importName",2),P([V()],L.prototype,"importMap",2),P([V()],L.prototype,"previewCase",2),P([V()],L.prototype,"loadError",2),P([V()],L.prototype,"saveError",2),P([V()],L.prototype,"saving",2),P([V()],L.prototype,"conflict",2),P([V()],L.prototype,"remoteRevision",2),P([V()],L.prototype,"confirmDelete",2),P([V()],L.prototype,"moveTarget",2),P([V()],L.prototype,"moving",2),P([V()],L.prototype,"moveError",2),P([V()],L.prototype,"version",2);var Pl=L;function Ot(e){return String(e?.message??e)}function ew(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function cm(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function tw(e,n,t,i){let a=[{label:"Shows",value:wl(e,t)}],r=qr(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function nw(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function iw(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${He(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=In(e.payload)??Ln(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${je(o).length} values`}case"timeline":{let r=yt(e.payload),o=r===void 0?[]:Zi(t.get(r)??""),s=Math.max(0,o.length-1);return`${nw(st(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${He(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return e.payload.contentMode==="fill"?"fill":"fit";case"tap":return Ht(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`;case"imageTime":return}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Pl);export{Pl as WristAssistantPanel,dm as columnFit,tw as layerFacts};
