...
import { type Person, deviceShortName, peopleOf, personOf } from "./people.js";
...
export class WristAssistantPanel extends LitElement {
  ...
  static override styles = css`
    ...
    * { box-sizing: border-box; }
    ...
    /* One device, as a row: the Devices dialog's list. The New dialog has its
       own row in .dev-tick above, which is a checkbox rather than a button
       that acts. */
    .dev-card {
