...
`)}function ur(e){let t;try{t=JSON.parse(e)}catch{return}if(typeof t!="object"||t===null||Array.isArray(t))return;let n=new Map,i=new Set;for(let[a,r]of Object.entries(t))r===null?i.add(a):n.set(a,Ds(r));return{values:n,nullKeys:i}}function Ds(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function vi(e){let t=bi(e),n=[...t.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return t.document&&n.push({kind:"template",value:t.document}),n}function Ht(e){return za(e.text,e.fontSize,e.pillColorHex!==void 0)}function _t(e){return Pa(e.fontSize,e.pillColorHex!==void 0)}function un(e){let t=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(t))return Number(t);let n=t.toLowerCase();if(n==="inf"||n==="+inf"||n==="infinity"||n==="+infinity")return 1/0;if(n==="-inf"||n==="-infinity")return-1/0;if(n==="nan"||n==="+nan"||n==="-nan")return NaN}function ct(e){let t=e.trim(),n=un(t);if(n!==void 0)return n;let i="";for(let r of t)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:un(i)}function Bs(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Gs(e){let t=Math.max(0,e);return t<60?`${Math.trunc(t)}s`:t<3600?`${Math.trunc(t/60)}m`:t<86400?`${Math.trunc(t/3600)}h`:`${Math.trunc(t/86400)}d`}function Us(e){return e.replace(/\S+/g,t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase())}function Ks(e,t,n){if(Ce(t))return e;let i=t,a=e,r=un(e.trim());if(i.relativeTime&&r!==void 0)a=Gs(r);else{let o=ct(e);if(o!==void 0){let l=o*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==o&&(a=Number.isInteger(l)?String(l):Bs(l))}}switch(i.useEntityUnit&&n&&(a+=n.startsWith("\xB0")||n.startsWith("%")?n:` ${n}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Us(a);break}return a}function ut(e){let t=Math.trunc(Math.max(0,e)),n=Math.trunc(t/3600),i=Math.trunc(t%3600/60),a=t%60,r=o=>String(o).padStart(2,"0");return n>0?`${n}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function zt(e,t=240){let n=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&n.push(o)}i=""};for(let o of e){if(n.length>=t)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let l=!a;r(),l&&(i+=o),a=!1}else r(),a=!1}return n.length<t&&r(),n}function Ws(e,t){let n,i;return t.scale==="fixed"?(n=Math.min(t.minValue,t.maxValue),i=Math.max(t.minValue,t.maxValue)):(n=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1),t.baseline==="zero"&&(n=Math.min(n,0),i=Math.max(i,0)),i>n||(i=n+1),{min:n,max:i}}function js(e,t,n){if(e===void 0)return 0;let i=ct(e);if(i===void 0||Number.isNaN(i))return 0;let a=n-t;return a===0?0:Math.min(1,Math.max(0,(i-t)/a))}var Le=class{constructor(t){this.ctx=t;this.named=new Map(t.namedValues.map(n=>[n.id.toUpperCase(),n.value]))}dereference(t){let n=t,i=new Set,a=t.format;for(;n.kind.kind==="named";){let o=n.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let l=this.named.get(o);if(!l)return;a=a&&!Ce(a)?a:l.format,n=l}let r={kind:n.kind};return a&&(r.format=a),r}directEntityUnit(t){let n=t.kind;if(n.kind==="entityState"||n.kind==="entityAttribute"||n.kind==="entityAge")return this.ctx.entityStates.get(n.entityId)?.unitOfMeasurement}resolve(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i;switch(n.kind.kind){case"literal":i=n.kind.value;break;case"entityState":i=this.ctx.entityStates.get(n.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;default:{let a=yi(t,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Ks(i,n.format,this.directEntityUnit(n))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i=n.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let l=Date.parse(o.finishesAt);return Number.isFinite(l)&&l>this.nowMs()?l:void 0}}let a=this.resolve(t)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=un(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(t){if(!t)return;let n=this.dereference(t);if(!n||n.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(n.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?ut(i.remaining):"Paused":"Idle"}entityIcon(t){let n=this.dereference(t);return!n||n.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(n.kind.entityId)?.iconName??n.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(t){let n=t.comparison;if(n.kind==="isStale")return this.isStale();let i=this.resolve(t.value);if(i===void 0)return n.kind==="isUnavailable";let a=ct(i),r=()=>this.resolve(n.value),o=()=>{let s=r();return s===void 0?void 0:ct(s)},l=s=>{let d=o();return a===void 0||d===void 0?!1:s(a,d)};switch(n.kind){case"equals":{let s=r();return s!==void 0&&i===s}case"notEquals":{let s=r();return s!==void 0&&i!==s}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let s=i.toLowerCase();return s==="unavailable"||s==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return l((s,d)=>s>d);case"greaterOrEqual":return l((s,d)=>s>=d);case"lessThan":return l((s,d)=>s<d);case"lessOrEqual":return l((s,d)=>s<=d);case"between":{let s=o(),d=this.resolve(n.upper),u=d===void 0?void 0:ct(d);if(a===void 0||s===void 0||u===void 0)return!1;let[c,h]=s<=u?[s,u]:[u,s];return a>=c&&a<=h}case"contains":{let s=r();return!!s&&i.toLowerCase().includes(s.toLowerCase())}case"startsWith":{let s=r();return!!s&&i.toLowerCase().startsWith(s.toLowerCase())}case"endsWith":{let s=r();return!!s&&i.toLowerCase().endsWith(s.toLowerCase())}case"matchesRegex":{if(!n.pattern)return!1;try{return new RegExp(n.pattern).test(i)}catch{return!1}}case"isOneOf":return(n.options??[]).some(s=>s.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(t){return t.tests.length===0?!0:t.join==="any"?t.tests.some(n=>this.evaluateTest(n)):t.tests.every(n=>this.evaluateTest(n))}applyRules(t,n){let i=new Map;for(let a of t){let r=n?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(l=>l.id===r.caseId)?.then??[];else{let l=a.cases.find(s=>this.evaluateCondition(s.when));o=l?l.then:a.otherwise??[]}for(let l of o)i.set(he[l.kind],l)}return i}liveBranches(t){let n=new Map;for(let i of t){let a=i.cases.find(r=>this.evaluateCondition(r.when));n.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return n}styleColor(t,n){let i=t.get(n);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(t,n){let i=t.get(n);return i?this.resolve(i.value):void 0}styleNumber(t,n){return t.get(n)?.number}resolveElement(t,n){let i=t.payload,a=this.applyRules(i.rules,n),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,l=this.styleNumber(a,"rotation"),s=l===void 0?i.frame:{...i.frame,rotationDegrees:l},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:s,opacity:d};switch(t.kind){case"text":{let c=t.payload.countdown?this.countdownEnd(t.payload.value):void 0,h=t.payload.countdown?this.countdownFallbackText(t.payload.value):void 0,y={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(t.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??t.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??t.payload.fontWeight,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex};return c!==void 0&&(y.countdownEnd=c),y}case"icon":{let c=this.entityIcon(t.payload.symbol)??this.resolve(t.payload.symbol)??"questionmark.circle";return{kind:"icon",...u,symbol:this.styleText(a,"icon")??c,size:this.styleNumber(a,"fontSize")??t.payload.size,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex}}case"gauge":{let c=this.styleText(a,"gaugeValue")??this.resolve(t.payload.value),h=this.styleNumber(a,"gaugeMin")??t.payload.minValue,y=this.styleNumber(a,"gaugeMax")??t.payload.maxValue;return{kind:"gauge",...u,fraction:js(c,h,y),style:t.payload.style,lineWidth:t.payload.lineWidth,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex,trackColorHex:t.payload.trackColorHex}}case"chart":{let c=t.payload,h=qe(c),y=h!==void 0?this.ctx.historySeries?.get(h)??"":this.resolve(c.value)??"",f=zt(y);c.limit>0&&f.length>c.limit&&(f=c.takeFromEnd?f.slice(f.length-c.limit):f.slice(0,c.limit));let w=Ws(f,c),x=this.styleColor(a,"color")??c.colorSlot.baseColorHex,F=dt(c),k=Na(c)?f.map(T=>Oa(T,F,c.bandAboveColorHex)):[],m={kind:"chart",...u,values:f,style:c.style,domainMin:w.min,domainMax:w.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:x,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:k,fillBands:c.fillBands,scaleLabelPlacement:c.scaleLabelPlacement,latestLabelPlacement:c.latestLabel},b=w.max-w.min,v=(T,R,H)=>{let C={text:T,fontSize:_a(R),colorHex:H??R.colorHex};return R.pillColorHex!==void 0&&(C.pillColorHex=R.pillColorHex),C};if(c.scaleLabels!=="none"&&f.length>0&&(m.topLabel=v(tn(w.max,b),c.topLabelStyle),c.scaleLabels==="range"&&(m.bottomLabel=v(tn(w.min,b),c.bottomLabelStyle))),c.latestLabel!=="none"&&f.length>0){let T=c.latestLabelFollowsBand?k[k.length-1]:void 0;m.latestLabel=v(tn(f[f.length-1],b),c.latestLabelStyle,T)}if(f.length>0){let T=c.highlight==="highest"||c.highlight==="both",R=c.highlight==="lowest"||c.highlight==="both",H=T?f.indexOf(Math.max(...f)):-1,C=R?f.indexOf(Math.min(...f)):-1;H>=0&&(m.highIndex=H),C>=0&&C!==H&&(m.lowIndex=C)}return m}case"shape":{let c={kind:"shape",...u,shapeKind:t.payload.kind,cornerRadius:t.payload.cornerRadius,fillColorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??t.payload.borderWidth},h=this.styleColor(a,"borderColor")??t.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:t.payload.entity.entityId,showTimestamp:t.payload.timestamp===!0,contentMode:t.payload.contentMode,zoom:t.payload.zoom,panX:t.payload.panX,panY:t.payload.panY,cornerRadius:t.payload.cornerRadius,timestampCorner:t.payload.timestampCorner,timestampSize:t.payload.timestampSize};Re(t.payload)&&(c.timestampX=t.payload.timestampX,c.timestampY=t.payload.timestampY);let h=this.ctx.entityStates.get(t.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:t.payload.frame,opacity:1,action:t.payload.action};return t.payload.openPageId!==void 0&&(c.openPageId=t.payload.openPageId),t.payload.attachedTo!==void 0&&(c.attachedTo=t.payload.attachedTo),c}}}resolveLayout(t,n,i){let a=t.perFamily[n],r=Za(t,n).map(w=>this.resolveElement(w,i)),o=a?this.applyRules(a.rules,i):new Map,l={family:n,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},s=this.styleText(o,"text"),d=a?.bezelCountdown&&s===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=s??u??this.resolve(a?.bezelText);c!==void 0&&(l.bezelText=c),d!==void 0&&(l.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(l.curvedText=h),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let w=a.bezelGauge,x=this.resolve(w.value),F=x===void 0?void 0:ct(x);if(F!==void 0){let k=Math.min(w.minValue,w.maxValue),m=Math.max(w.minValue,w.maxValue),b={value:Math.min(m,Math.max(k,F)),minValue:k,maxValue:m===k?k+1:m,colorHexes:w.colorHexes},v=this.resolve(w.minLabel);v!==void 0&&(b.minLabel=v);let T=this.resolve(w.maxLabel);T!==void 0&&(b.maxLabel=T),l.bezelGauge=b}}let y=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;y!==void 0&&(l.backgroundColorHex=y);let f=this.styleColor(o,"borderColor")??a?.borderColorHex;return f!==void 0&&(l.borderColorHex=f),l}};function qs(e,t){let n=new Le(t),i=e.countdown?n.countdownEnd(e.value):void 0,r={text:(e.countdown?n.countdownFallbackText(e.value):void 0)??n.resolve(e.value)??"--"};return e.label&&(r.label=e.label),e.symbol&&(r.symbol=e.symbol),i!==void 0&&(r.countdownEnd=i),r}function xi(e,t,n){let i=new Le(t),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,n));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=qs(e.inline,t)),a}var le=ye,Pt=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:le,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Nt=Pt.find(e=>e.measured);function xr(e){if(!e)return;let t=/^(\d+)x(\d+)$/.exec(e.trim());if(!t)return;let n=Number(t[1]),i=Number(t[2]);return Pt.find(a=>a.screen.width===n&&a.screen.height===i)}function hn(e,t){let n=le[t];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/n.width,e.height/n.height),a=n.width*i,r=n.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Ys={regular:400,medium:500,semibold:600,bold:700};function Se(e){if(!e)return;let t=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(t))return;let n=t.length===8?parseInt(t.slice(6,8),16)/255:1;return{color:`#${t.slice(0,6)}`,opacity:n}}function xe(e,t,n="#FFFFFF"){let i=Se(e)??{color:n,opacity:1};return{[t]:i.color,[`${t}-opacity`]:i.opacity}}function wr(e,t){let n=Math.max(0,e.frame.width*t.width),i=Math.max(0,e.frame.height*t.height),a=(e.frame.x+e.frame.width/2)*t.width,r=(e.frame.y+e.frame.height/2)*t.height;return{x:a-n/2,y:r-i/2,w:n,h:i,cx:a,cy:r}}function Js(e,t){let n=xe(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:ut((e.countdownEnd-Date.now())/1e3)});let i=s=>s*.55,a=e.text.length*i(e.fontSize),r=a>t.w&&t.w>0?Math.max(.5,t.w/a):1,o=e.fontSize*r,l=e.text;if(t.w>0&&l.length*i(o)>t.w){let s=t.w-.8*o,d=Math.max(1,Math.floor(s/i(o)));l=`${l.slice(0,d).replace(/\s+$/,"")}\u2026`}return S`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
    ...
    ${e.maxLabel!==void 0?x(`${n}-gmax`,d+w,d+w+Math.max(l,3),e.maxLabel):g}`}function Fi(e,t){let n=e.family in le?e.family:"rectangular",i=t.slot??le[n],a=le[n],r=hn(i,n),o=`clip-${n}-${Math.random().toString(36).slice(2,8)}`,l=Se(e.backgroundColorHex),s=Se(e.borderColorHex),d=e.borderWidth*r.scale;if(n==="corner"){let f=r.scale,w=!!e.bezelText||!!e.bezelGauge,x=e.curvedText??"",F=x!=="",k=gn(f,w),m=Ti(f,w),b=m/(a.width*f),v=k.tile.cx-m/2,T=k.tile.cy-m/2,R=`M 0 0 H ${k.quad.width-k.cornerRadius} A ${k.cornerRadius} ${k.cornerRadius} 0 0 1 ${k.quad.width} ${k.cornerRadius} V ${k.quad.height} H 0 Z`,H=g;if(e.bezelGauge)H=pl(e.bezelGauge,f,o);else if(e.bezelText){let L=ll(f,`${o}-bezel`),P=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?ut((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;H=S`<defs><path id=${L.id} d=${L.d} /></defs>
        <text font-size=${pr*f} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${L.id}" startOffset="50%" text-anchor="middle">${mr(P,L.length,pr*f)}</textPath></text>`}let C=g;if(F){let L=Se(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},P=kr(f,`${o}-curved`,dl*f,cl);C=S`<defs><path id=${P.id} d=${P.d} /></defs>
        <text font-size=${fr*f} font-weight="600" fill=${L.color} fill-opacity=${L.opacity}
          ...
          <textPath href="#${P.id}" startOffset="50%" text-anchor="middle">${mr(x,P.length,fr*f*.88)}</textPath></text>`}else{let L=e.borderWidth*r.scale*b,P=s?S`<circle cx=${m/2} cy=${m/2} r=${m/2-L/2} fill="none" stroke=${s.color} stroke-opacity=${s.opacity} stroke-width=${L} />`:g;C=S`<g transform="translate(${v} ${T})">
        <g clip-path=${`url(#${o})`}>
    ...
    </select></label>`}function Pi(e,t,n,i){let a=i.format??(r=>String(Math.round(r*100)/100));return p`<div class="field slider"><span>${e}</span>
    ...
    ${y}`}var Bl=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"]],Gl=[["bars","Bars"],["line","Line"],["area","Area"]],Ul=[["auto","Auto (fit the readings)"],["fixed","Fixed range"]],Kl=[["lowest","Lowest value"],["zero","Zero"]],$o=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],Wl=[["none","None"],["pointer","Triangle and dot"],["dot","Dots"]],jl=[["uniform","One colour"],["bands","By value"]],ql=[["none","None"],["top","Top value"],["range","Top and bottom"]],Yl=[["gutter","Beside the chart"],["overlay","Over the chart"]],Jl=[["none","None"],["corner","Top right"],["end","Beside the newest reading"]];function Xl(e,t,n){t(e.latestLabelStyle),n==="colour"&&(e.latestLabelFollowsBand=!1)}function Ni(e,t,n,i){return p`
    <div class="hint"><b>${e}</b></div>
    <div class="grid2">
      ${j("Size (pt)",t.fontSize,a=>n(r=>{r.fontSize=a??_e},`${i}-size`,"size"),{step:.5,min:Xn,max:Zn})}
      ${te("Colour",t.colorHex,a=>n(r=>{r.colorHex=a??lt},`${i}-col`,"colour"))}
    </div>
    ${te("Pill behind it",t.pillColorHex,a=>n(r=>{a===void 0?delete r.pillColorHex:r.pillColorHex=a},`${i}-pill`,"pill"),!0)}`}function Zl(e){let t=[Jn,"#FFD60A"];if(e.length<2)return t.map((o,l)=>({id:q(),upTo:(l+1)*33,colorHex:o}));let n=Math.min(...e),a=Math.max(...e)-n,r=o=>Number(o.toFixed(a>=10?0:2));return t.map((o,l)=>({id:q(),upTo:r(n+a*(l+1)/3),colorHex:o}))}function Ql(e){let t=dt(e).at(-1),n=e.bands.length>1?Math.abs(dt(e)[1].upTo-dt(e)[0].upTo):10;return{id:q(),upTo:(t?.upTo??0)+(n||10),colorHex:e.colorSlot.baseColorHex}}var ed=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function td(e,t){let n="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(t){case"literal":return{kind:t,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:t,...n};case"entityAttribute":return{kind:t,...n,attribute:""};case"entityAge":return{kind:t,...n};case"aggregate":return{kind:t,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:t,timeField:"now"};case"dataAge":return{kind:t};case"jinja":return{kind:t,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:t,id:""}}}function Q(e,t,n,i){if(i.inline||!nd())return p`<div class="value-editor">${So(e,t,n,i)}</div>`;let a=Gi(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(t):void 0,l=oe(t,me(e));return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${D("Source",a.kind,l,u=>r(td(a,u)))}
    ${s}
    ${i.noFormat?g:od(t.format,u=>n(Ce(u)?{kind:t.kind}:{...t,format:u}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:g}`}function od(e,t){let n=e??{},i=a=>{let r={...n,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];t(r)};return p`<details class="sub" ?open=${!Ce(e)}>
  ...
  </details>`}function sd(e,t,n,i){let a=l=>l.join(", "),r=l=>l.split(",").map(s=>s.trim()).filter(Boolean),o=t.scope;return p`
    ...
    ${t.function==="count"?g:ie("Attribute (blank = state)",t.attribute??"",l=>{let s={...t};l?s.attribute=l:delete s.attribute,n(s)})}`}var Eo=ri,ld=Eo.filter(([e])=>e!=="none");function dd(e,t){return e!==void 0&&t.trim()!==""&&t.trim()!==e.trim()}function To(e){let t=e.config,n=t.tapAction,i=s=>["toggleEntity","runScene","runScript","addTodo","runHTTPAction"].includes(s),a=dd(e.savedName,t.name),r=t.refreshMinutes??0,o=so.map(s=>[String(s),lo(s)]);so.includes(r)||o.push([String(r),lo(r)]);let l=t.showSuccessFlash??!0;return p`
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span>Flash when a tap works</span>
        <div class="flash-row">
          ...
          ${l?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(t.successFlashColorHex??cd).slice(0,7)}
  ...
  ${a?g:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function Ro(e,t){let n=e.config.values.findIndex(a=>a.id===t.id),i=`nv-${t.id}`;return p`
    ...
    ${r?p`<div class="sec-b">${i}</div>`:g}
        ...
        ${L.length>0?p`<div class="hint">Reads ${xd(P)}${L.length===P.length?p` · ${P.length} ${P.length===1?"value":"values"}`:p` · ${P.length} of ${L.length}`}</div>`:g}
        ...
        ${m.latestLabel==="none"?g:p`<div class="hint">Printed at the right-hand edge, ${m.latestLabel==="corner"?"parked at the top wherever the data happens to be.":"at the height of the last mark, so the number and the end of the line read as one thing."}</div>
            ${m.coloring==="bands"?p`${ce("Match the reading's colour",m.latestLabelFollowsBand,E=>b($=>{$.latestLabelFollowsBand=E}))}
                <div class="hint">${m.latestLabelFollowsBand?"The number takes the band colour of the reading it names, so the two always agree. Picking a colour below turns this off.":"The number keeps the colour below, whatever band the reading is in."}</div>`:g}
            ${Ni("Newest number",m.latestLabelStyle,(E,$,N)=>b(J=>Xl(J,E,N),$),`${r}-latl`)}`}
        ${D("Colour",m.coloring,jl,E=>b($=>{$.coloring=E,E==="bands"&&$.bands.length===0&&($.bands=Zl(P))}))}
        ${m.coloring==="bands"?p`
          ...
          <button class="small" @click=${()=>b(E=>{E.bands=[...E.bands,Ql(E)]})}>Add band</button>
        ...
        ${Pi("Zoom",m.zoom,v=>b(T=>{T.zoom=v},"zoom"),{min:Ei,max:4,step:.05,def:1,format:v=>`${v.toFixed(2)}x`})}
        ${Pi("Pan left/right",m.panX,v=>b(T=>{T.panX=v},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${Pi("Pan up/down",m.panY,v=>b(T=>{T.panY=v},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class="hint">${bd(m)}</div>
    ...
    ${de(e,"content","Content",p`${t.kind==="tap"?g:md(e,t,r)}${c}`,{color:x,icon:"content",summary:$d(e,t)})}
    ${h===void 0&&y===void 0?g:de(e,"look",t.kind==="image"?"Picture":"Look",p`${h??g}${y??g}`,{color:x,icon:t.kind==="image"?"image":"look",...po(t)?{summary:po(t)}:{}})}
    ${t.kind==="image"?de(e,"timestamp","Timestamp",vd(t.payload,(m,b)=>o(v=>m(v.payload),b)),{color:x,icon:"clock",summary:k?`Shown \xB7 ${t.payload.timestampSize} pt`:"Hidden"}):g}
    ${t.kind==="tap"?g:de(e,"tappable","Tap",Sd(e,t,r),{color:Y.tap,icon:"tap",summary:F?Ie(F.payload.action):"Not tappable"})}
    ...
    ${de(e,"placement","Place",p`
      ...
      ${t.kind==="shape"||t.kind==="image"||t.kind==="tap"?g:j(`${u} in ${K(n)} (blank = shared ${pd(t)})`,l.size,m=>e.update(b=>m===void 0?fe(b,n,i,{},!0):fe(b,n,i,{size:m}),`${r}-psize-${n}`),{step:1,min:1,optional:!0})}
    ...
    ${D("Tap action",a.type,ld,o=>n(l=>{l.action=r(o)?{type:o,..."entityId"in l.action?{entityId:l.action.entityId,displayName:l.action.displayName,domain:l.action.domain}:{entityId:"",displayName:"",domain:""}}:{type:o},o!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
    ${"entityId"in a?Ne(e,"Target",a,o=>n(l=>{l.action={type:a.type,...o}},"tap-entity"),`${i}-tap`):g}
    ${a.type==="openPage"?Fo(e,t.openPageId,t.openPageName,(o,l)=>n(s=>{if(o===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=o,l?s.openPageName=l:delete s.openPageName},"tap-page")):g}`}var kd=24;function Cd(e,t){let n=[],i=1/0;for(let r of ee){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=tr(e.config,t,r);o&&(n.push(`${K(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(n.length===0)return g;let a=i<kd;return p`<div class=${a?"hint warn":"hint"}>${n.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:g}</div>`}function Sd(e,t,n){if(t.kind==="tap")return g;let i=t.payload.id,a=be(e.config,i)[0],r=(l,s)=>e.update(d=>{let u=d.elements.find(c=>c.kind==="tap"&&c.payload.attachedTo===i);u&&l(u.payload)},s?`${n}-${s}`:void 0),o=ci(e.config,t);return p`
    ...
    </div>`,{color:Y.group,icon:"folder",summary:`${n.length} layers \xB7 ${t.locked?"moves as one":"unlocked"}`})}function _o(e,t){if(t==="inline")return p`${Ed(e)}${Vi(e,t)}`;let n=e.config.perFamily[t];if(!n)return p`<div class="hint">No settings stored for ${K(t)} yet.</div>
    ...
    ${t==="corner"?de(e,"corner","Corner content",Td(e,n,i),{color:Y.place,icon:"content",summary:n.curvedText?"Big curved text":"Layer canvas"}):g}
    ...
    ${n?p`<div class="hint">This is the only shape. Add another before removing it.</div>`:p`<div class="hint">The watch stops listing this complication for ${K(t)} slots.</div>`}`,{color:Y.place,icon:"delete",summary:n?"The only shape":"Drops its layout"})}function Ed(e){let t=e.config.inline;if(!t)return p`<div class="hint">This complication lists Inline but has no Inline text yet (it was saved by an older integration). The watch shows "No inline layout" until one is added.</div>
    ...
    ${de(e,"symbol","Symbol",p`
      ...
      <div class="hint">On the face: ${t.symbol?`${t.symbol} `:""}${t.label?`${t.label}: `:""}${e.resolve(t.value)??"--"}</div>`,{color:ne.icon,icon:"icon",summary:t.symbol||"None"})}`}function Td(e,t,n){let i=t.curvedText?"curved":"canvas",a=t.bezelGauge?"gauge":t.bezelText?"text":"none";return p`
    ...
    ${a==="gauge"&&t.bezelGauge?Fd(e,t.bezelGauge,n):g}`}function Fd(e,t,n){let i=[t.colorHexes[0]??"#34C759",t.colorHexes[1]??t.colorHexes[t.colorHexes.length-1]??"#FFCC00",t.colorHexes[t.colorHexes.length-1]??"#FF3B30"],a=r=>o=>n(l=>{let s=[...i];s[r]=o??s[r],l.bezelGauge.colorHexes=s},`gstop${r}`);return p`
    ...
    ${t.maxLabel?Q(e,t.maxLabel,r=>n(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):g}`}var rp=ee.map(e=>[e,K(e)]),Ki={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Rd=Object.keys(Ki);function Id(e){let t=dn[e];return Rd.filter(n=>t.includes(he[n]))}var Ld={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Sn(e,t){if(e.entityId==="")return"(no entity)";let n=e.displayName.trim();if(n!==""&&n!==e.entityId)return n;let i=t?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function tt(e,t){let n=e.replace(/\s+/g," ").trim();return n.length>t?`${n.slice(0,t-1)}\u2026`:n}function Ad(e){if(!e||Ce(e))return"";let t=[];return e.decimals!==void 0&&t.push(`${e.decimals} dp`),e.multiply!==void 0&&t.push(`\xD7${e.multiply}`),e.offset!==void 0&&t.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&t.push(`"${e.prefix}" first`),e.suffix&&t.push(`"${e.suffix}" after`),e.useEntityUnit&&t.push("with unit"),e.relativeTime&&t.push("as relative time"),e.textCase&&t.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),t.length===0?"":` (${t.join(", ")})`}function oe(e,t){return`${Md(e,t)}${Ad(e.format)}`}function Md(e,t){let n=e.kind;switch(n.kind){case"literal":return n.value?`"${tt(n.value,40)}"`:"(empty)";case"entityState":return Sn(n,t);case"entityAttribute":return n.attribute?`${Sn(n,t)} \xB7 ${n.attribute}`:Sn(n,t);case"entityAge":return`age of ${Sn(n,t)}`;case"aggregate":return Hd(n.aggregate);case"time":return Ld[n.timeField];case"dataAge":return"data age";case"jinja":return n.value?`template ${tt(n.value,32)}`:"template (empty)";case"named":return n.id===""?"(no value chosen)":t?.values?.find(a=>a.id===n.id)?.name?.trim()||`named ${n.id.slice(0,8)}`}}function Hd(e){let t=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${t}`}function Fn(e,t,n){if(n<0||n>=e.length)return;let[i]=e.splice(t,1);e.splice(n,0,i)}function _d(e,t,n,i,a){let r=(o,l)=>e.update(s=>{let d=i(s);d&&o(d)},l?`${a}-${l}`:void 0);return p`
    ${t.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${n==="layout"?"family":"layer"} looks.</div>`:g}
    ${t.map((o,l)=>zd(e,o,l,t.length,n,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Mt())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function zd(e,t,n,i,a,r,o){let l=e.liveBranch(t),s=e.forced.get(t.id)??"live",d=c=>s==="live"?c==="live":s==="otherwise"?c==="otherwise":s.caseId===c,u=(c,h)=>r(y=>{let f=y.find(w=>w.id===t.id);f&&c(f)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${n+1}</b>
      <span class="spacer"></span>
    ...
    ${t.otherwise?p`<div class="case-box otherwise">
          ...
          ${zo(e,t.otherwise,a,c=>u(h=>{h.otherwise&&c(h.otherwise)}),`${o}-otherwise`)}
        </div>`:g}
    ...
    ${t.when.tests.map((d,u)=>Nd(e,d,u,c=>l(h=>{let y=h.when.tests.find(f=>f.id===d.id);y&&c(y)}),()=>l(c=>{c.when.tests=c.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    ...
    ${zo(e,t.then,a,d=>l(u=>d(u.then)),`${o}-then`)}
        ...
        ${l.pattern&&!Od(l.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:g}`;break;case"options":u=ie("Options (comma separated)",(l.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(y=>y.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${u}
  </div>`}function Od(e){try{return new RegExp(e),!0}catch{return!1}}function zo(e,t,n,i,a){let r=Id(n);return p`
    ${t.length===0?p`<div class="hint">No changes.</div>`:g}
    ${t.map((o,l)=>Vd(e,o,l,n,(s,d)=>i(u=>{u[l]&&s(u[l])},d?`${a}-${l}-${d}`:void 0),()=>i(s=>{s.splice(l,1)}),`${a}-${l}`))}
    <select class="adder" @change=${o=>{let l=o.target,s=l.value;l.value="",s&&i(d=>{d.push(Ze(s))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${Ki[o]}</option>`)}
    </select>`}var Po=["setColor","setBorderColor","setBackgroundColor"];function Vd(e,t,n,i,a,r,o){let l=!dn[i].includes(he[t.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${No(e,t,a,o)}
  </div>`}function No(e,t,n,i){let a=cn(t.kind),r=g;if(a==="value"){let o=t.value??A("");if(Po.includes(t.kind)){let l=o.kind.kind==="literal";r=p`${l?te("Colour",o.kind.kind==="literal"?o.kind.value:"",s=>n(d=>{d.value=A(s??"#FFFFFF")},"color")):Q(e,o,s=>n(d=>{d.value=s},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${_d(e,t,n,i,a)}`:Dd(e,o.table,t[0],n,i,a,r)}function Dd(e,t,n,i,a,r,o){let l=(C,L)=>e.update(P=>{let B=a(P);B&&C(B)},L?`${r}-${L}`:void 0),s=t.value??mo.get(r)??o,d=t.rows.length===0,u=t.numberMode||d&&s!==void 0&&!Zr(s)&&Bd(e.resolve(s)),c=dn[i],h=En.get(r)??new Set,y=t.columns.length===0&&h.size===0?[Xr[i]]:[],f=Br(t.columns,[...h,...y.filter(C=>C!==void 0)],c),w=n?e.liveBranch(n):"none",x=n?e.forced.get(n.id)??"live":"live",F=C=>x!=="live"&&(x==="otherwise"?C==="otherwise":x.caseId===C),k=C=>{n&&e.setForced(n.id,F(C)?"live":C==="otherwise"?"otherwise":{caseId:C})},m=C=>{mo.set(r,C),t.rows.length!==0&&l(L=>qr(L,C),"lhs")},b=()=>l(C=>Wr(C,s??A(""),u)),v=t.rows.map((C,L)=>go(e,{key:`${r}-${C.caseId}`,label:Jr(C.comparison,P=>oe(P,me(e))),columns:f,changes:C.changes,live:w===C.caseId,forced:F(C.caseId),onForce:()=>k(C.caseId),when:jd(e,C.comparison,`${r}-${C.caseId}`,(P,B)=>l(E=>{let $=E[0]?.cases.find(N=>N.id===C.caseId)?.when.tests[0];$&&P($.comparison)},B&&`${C.caseId}-${B}`)),updChanges:(P,B)=>l(E=>{let $=E[0]?.cases.find(N=>N.id===C.caseId);$&&P($.then)},B&&`${C.caseId}-${B}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${L===0} @click=${()=>l(P=>Hi(P,L,L-1))}>${O("up")}</button>
      <button class="icon" title="Move down" ?disabled=${L===t.rows.length-1} @click=${()=>l(P=>Hi(P,L,L+1))}>${O("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(P=>jr(P,C.caseId))}>${O("delete")}</button>`})),T=t.otherwise===void 0?g:go(e,{key:`${r}-otherwise`,label:"Otherwise",columns:f,changes:t.otherwise,live:w==="otherwise",forced:F("otherwise"),onForce:()=>k("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(C,L)=>l(P=>{let B=P[0]?.otherwise;B&&C(B)},L),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(C=>_i(C,!1))}>${O("close")}</button>`}),R=Tn.get(r),H=Gd.filter(C=>c.includes(C)&&!f.includes(C));return p`
    <div class="states">
      ...
      <div class="states-foot">
        ...
        ${H.length===0?g:p`<select class="chip-add" title="Add a column" @change=${C=>{let L=C.target,P=L.value;if(L.value="",!P)return;let B=En.get(r)??new Set;B.add(P),En.set(r,B),Ee(L)}}>
    ...
    </div>`}function Bd(e){let t=(e??"").trim();return t!==""&&Number.isFinite(Number(t))}var Gd=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function fo(e,t){let n=0;for(let i of e.rows)wn(i.changes,t)&&(n+=1);return e.otherwise&&wn(e.otherwise,t)&&(n+=1),n}function Ud(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function go(e,t){return p`<tr class="state-row ${t.live?"live":""} ${t.forced?"forced":""}"
    title=${`${t.label}. Click to hold the previews on this state.`}
    @click=${n=>{Ud(n)||t.onForce()}}>
    <td class="when">
    ...
    ${t.columns.map(n=>p`<td>${Kd(e,n,t.changes,t.updChanges,`${t.key}-${n}`)}</td>`)}
    <td class="acts">${t.acts}</td>
  </tr>`}function Kd(e,t,n,i,a){let r=wn(n,t),o=Gi(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${Ae[t]} for this state`}
      @click=${d=>{i(u=>{u.push(Ze(Dr[t]))}),ad(d.target,o)}}>unchanged</button>`;let l=(d,u)=>i(c=>{let h=c.find(y=>he[y.kind]===t);h&&d(h)},u&&`${t}-${u}`),s=Ae[t];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${s}. Click to change it.`}>${Wd(e,r)}</button>
    ...
    </div>`}function Wd(e,t){if(t.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(t.kind==="show")return p`<span class="cell-word">Shown</span>`;let n=cn(t.kind);if(n==="number")return p`<span class="cell-word mono">${t.number??0}</span>`;if(n==="weight")return p`<span class="cell-word">${Ui.find(([r])=>r===(t.weight??"regular"))?.[1]}</span>`;let i=t.value??A(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Po.includes(t.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?we(a):oe(i,me(e))}</span>`;if(t.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??g}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${oe(i,me(e))}</span>`}function we(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function jd(e,t,n,i){let a=Xe(t.kind),r=Ai(t.kind),o=(l,s,d,u)=>Yd(e,l,s,`${n}-${d}`,r,u,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${re(l=>i(s=>{let d=fi(s,l);s.kind=d.kind,d.value!==void 0?s.value=d.value:delete s.value,d.upper!==void 0?s.upper=d.upper:delete s.upper}))}>
      ${Li.map(l=>p`<option value=${l} ?selected=${l===t.kind}>${qd(l)}</option>`)}
    </select>
  ...
  </span>`}function qd(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return ft[e]}}function Yd(e,t,n,i,a,r,o){let l=Gi(i),s={showResolved:!0,label:o,key:i};if(t.kind.kind!=="literal")return p`<span class="rhs">
      ${Q(e,t,n,{...s,compact:!0})}
    ...
    ${ko(e,l,o,t,n,s)}
  </span>`}var In=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:li,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Go(e){return In.find(t=>t.kind===e)??In[0]}var Vo="#FF9F0A",Wi="#8E8E93",Jd=["#FF453A","#FFD60A","#34C759"],Uo=["#0A84FF","#34C759","#FF9F0A"];function Xd(e){return e?.attributes?.device_class==="battery"?Jd:Uo}var Zd={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Qd(e){let t=e.iconName?.trim();return t?{off:t,on:t}:Zd[ji(e)]??{off:"circle",on:"circle.fill"}}function ec(e){switch(ji(e)){case"lock":return{kind:"equals",value:A("locked")};case"cover":case"valve":return{kind:"equals",value:A("open")};case"media_player":return{kind:"equals",value:A("playing")};default:return{kind:"isOn"}}}function ji(e){return e.domain||e.entityId.split(".")[0]||""}function it(e){return{...e,domain:ji(e)}}function tc(e){let t=e?.attributes??{},n=t.min,i=t.max;if(typeof n=="number"&&typeof i=="number"&&i>n)return{min:n,max:i};let a=typeof t.device_class=="string"?t.device_class:"",r=typeof t.unit_of_measurement=="string"?t.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Rn(e){return Math.round(e*1e4)/1e4}function Ln(e,t,n){return Math.min(n,Math.max(t,e))}function qi(e,t,n){let i=le[e],a=Ln(Rn(t/i.width),0,1),r=Ln(Rn(n/i.height),0,1);return{x:Rn((1-a)/2),y:Rn((1-r)/2),width:a,height:r,rotationDegrees:0}}function nc(e){let t=le[e],n=Ln(Math.round(Math.min(t.width,t.height)*.55),12,30);return{frame:qi(e,n*1.3,n*1.3),size:n}}function ic(e){let t=le[e],n=Ln(Math.round(Math.min(t.width,t.height)*.3),9,20);return{frame:qi(e,t.width*.88,n*1.7),size:n}}function ac(e){let t=le[e],n=Math.min(t.width,t.height)*.9;return{frame:qi(e,n,n),size:Math.max(2.5,Math.round(n*.2)/2)}}function Ko(e){let t=e==="rectangular";return{frame:{x:.05,y:t?.34:.3,width:.9,height:t?.42:.4,rotationDegrees:0},size:2}}function rc(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function oc(e,t){t!==void 0&&(e.kind==="text"?e.payload.fontSize=t:e.kind==="icon"?e.payload.size=t:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=t))}function bt(e,t,n,i){let a=i(n);t.payload.frame=a.frame,oc(t,a.size);for(let r of ee){if(r===n||r==="inline")continue;let o=e.perFamily[r];if(!o)continue;let l=i(r);JSON.stringify(l)!==JSON.stringify(a)&&(o.placements[t.payload.id]={frame:l.frame,isHidden:!1,...l.size!==void 0?{size:l.size}:{}})}}function vt(e){return At(e)}function Yi(e,t){let n={kind:{kind:"entityState",...it(e)}},i=t?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(n.format={useEntityUnit:!0}),n}function Do(e){let t=Ze("setIcon");return t.value=A(e),t}function nt(e){let t=Ze("setColor");return t.value=A(e),t}function sc(e,t){let n=Mt(),i=n.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...it(e)}},a.comparison=ec(e);let r=t.on!==t.off;return i.then=r?[Do(t.on),nt(Vo)]:[nt(Vo)],n.otherwise=r?[Do(t.off),nt(Wi)]:[nt(Wi)],n}function lc(e){let t=Mt(),n=t.cases[0],i=n.when.tests[0];i.value={kind:{kind:"entityState",...it(e)}},i.comparison={kind:"isUnavailable"};let a=Ze("setOpacity");return a.number=.35,n.then=[a],t}function Bo(e){let t=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(t)}function dc(e,t,n=Uo){let i=t.max-t.min,a=Bo(t.min+i/3),r=Bo(t.min+i*2/3),o=[{comparison:{kind:"lessThan",value:A(a)},changes:[nt(n[0])]},{comparison:{kind:"between",value:A(a),upper:A(r)},changes:[nt(n[1])]},{comparison:{kind:"greaterThan",value:A(r)},changes:[nt(n[2])]}];return Gr(Yi(e),o)}function cc(e,t,n){let i=vt("icon"),a=Qd(t);return i.payload.symbol=A(a.off),i.payload.colorSlot.baseColorHex=Wi,i.payload.rules=[sc(t,a)],bt(e,i,n.family,nc),e.elements.push(i),sn(e,i.payload.id,{type:"toggleEntity",...it(t)}),i.payload.id}function uc(e,t,n){let i=vt("text");return i.payload.value=Yi(t,n.state),i.payload.rules=[lc(t)],bt(e,i,n.family,ic),e.elements.push(i),i.payload.id}function pc(e,t,n){let i=vt("gauge");i.payload.value=Yi(t);let a=tc(n.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[dc(t,a,Xd(n.state))],bt(e,i,n.family,ac),e.elements.push(i),i.payload.id}function hc(e,t,n){let i=vt("chart");return i.payload.value={kind:{kind:"entityState",...it(t)}},i.payload.highlight="both",i.payload.marker="pointer",bt(e,i,n.family,Ko),e.elements.push(i),i.payload.id}function mc(e,t,n){let i=vt("chart");return i.payload.value={kind:{kind:"entityState",...it(t)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",bt(e,i,n.family,Ko),e.elements.push(i),i.payload.id}function fc(e,t,n){let i=vt("image");return i.payload.entity=it(t),bt(e,i,n.family,rc),e.elements.push(i),i.payload.id}function Wo(e,t,n,i){switch(t){case"toggle":return cc(e,n,i);case"status":return uc(e,n,i);case"gauge":return pc(e,n,i);case"chart":return hc(e,n,i);case"history":return mc(e,n,i);case"camera":return fc(e,n,i)}}var yc=3e4,bc=500,jo="preset-entity",vc={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Ji(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function xc(e){return e.kind==="family"?"look":"content"}function wc(e){let t=e.document?.supportedFamilies;return Array.isArray(t)?t.filter(n=>typeof n=="string"):[]}var qo=300,Yo=400,Xi=52,Jo=36,at=200,$c=720,An=320,kc=80,Cc=56,Xo="wrist-assistant-panel.columns.v2",Zi=e=>Math.max(at,Math.min($c,Math.round(e))),Zo=e=>e.metaKey||e.ctrlKey||e.shiftKey,Qo=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl";function es(e,t,n){if(e<=0)return{columns:3,left:t,right:n};let i=e-kc;if(i>=at*2+An){let r=i-An,o=t,l=n;if(o+l>r){let s=r/(o+l);o=Math.max(at,Math.floor(o*s)),l=Math.max(at,Math.floor(l*s));let d=o+l-r;d>0&&(o>=l?o=Math.max(at,o-d):l=Math.max(at,l-d))}return{columns:3,left:o,right:l}}let a=e-Cc;return a>=at+An?{columns:2,left:Math.min(t,a-An),right:n}:{columns:1,left:t,right:n}}var M=class extends He{constructor(){super(...arguments);this.narrow=!1;this.colLeft=qo;this.colRight=Yo;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.testValues=new Map;this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.showTaps=!1;this.newShapeChooser=!1;this.previewCase=Nt.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=_r(()=>this.requestUpdate());this.imageSizes=zr(()=>this.requestUpdate());this.symbols=new bn(()=>this.requestUpdate());this.keyHandler=n=>this.onKey(n);this.heldArrows=new Set;this.keyUpHandler=n=>{this.heldArrows.delete(n.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.sizeObserver=new ResizeObserver(n=>{let i=n[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=n=>{this.draft?.dirty&&n.preventDefault()};this.pickerOutside=n=>{n.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.presetKeys={handleEvent:n=>{n.key==="Enter"&&(this.presetEntity===void 0||xo(jo)||(n.preventDefault(),n.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Hn`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let n=window.localStorage.getItem(Xo);if(!n)return;let i=JSON.parse(n);typeof i.left=="number"&&(this.colLeft=Zi(i.left)),typeof i.right=="number"&&(this.colRight=Zi(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Xo,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}renderGutter(n){return p`<div class="gutter ${n}" role="separator" aria-orientation="vertical"
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Oe(v,d)}</b>
          <small><span class="kind">${mt[v.kind]}</span> · ${Ec(v,u,this.historySeries)}</small>
        </span>
        <span class="right">
          <span class="badges">
            ${P?p`<span class="badge tap" title=${`Tappable \xB7 ${Oe(P,d)}`}>tap</span>`:g}
      ...
      </div>`},k=(v,T)=>{let R=this.inspect.kind==="group"&&this.inspect.id===v.id,H=!this.collapsed.has(v.id),C=this.rowDrag(v.id,i),L=T[0],P=T[T.length-1],B=["drop-before","drop-into","drop-after"],E=$=>{let N=$.currentTarget.getBoundingClientRect(),J=($.clientY-N.top)/N.height;return J<.25?"drop-before":!H&&J>.75?"drop-after":"drop-into"};return p`<div class="layer group ${R?"hl":""}" style=${`--k:${Y.group}`} tabindex="0" draggable=${C.draggable}
        ...
        @drop=${$=>{$.preventDefault();let N=$.currentTarget,J=E($);N.classList.remove(...B);let X=this.dragId;if(this.dragId=void 0,!(!X||!L||!P)){if(J==="drop-before"){this.reorderLayer(X,L.payload.id,!0,!0);return}if(J==="drop-after"){this.reorderLayer(X,P.payload.id,!1,!0);return}this.isGroupId(X)||(this.reorderLayer(X,L.payload.id,!0),this.mutate(ts=>Ya(ts,X,v.id)))}}}>
      ...
      <div class="canvas-bar">
        <label>Preview as
          <select @change=${o=>{this.previewCase=o.target.value}}>
            ${Pt.map(o=>p`<option value=${o.label} ?selected=${o.label===a.label}>${o.label}${o.measured?"":" (estimated)"}</option>`)}
          </select>
        </label>
      ...
      <div class="insp-head">
        ${this.crumbs(n)}
        ${l?p`<button class="expand" @click=${()=>{this.openSections=s?new Set([xc(r)]):new Set(Bi)}}>${s?"One at a time":"Open all"}</button>`:g}
      </div>
    ...
    </details>`}};_([st({attribute:!1})],M.prototype,"hass",2),_([st({type:Boolean})],M.prototype,"narrow",2),_([st({attribute:!1})],M.prototype,"panel",2),_([z()],M.prototype,"colLeft",2),_([z()],M.prototype,"colRight",2),_([z()],M.prototype,"panelWidth",2),_([z()],M.prototype,"owners",2),_([z()],M.prototype,"ownerId",2),_([z()],M.prototype,"records",2),_([z()],M.prototype,"selectedId",2),_([z()],M.prototype,"draft",2),_([z()],M.prototype,"readOnlyReason",2),_([z()],M.prototype,"parseError",2),_([z()],M.prototype,"maxSchemaVersion",2),_([z()],M.prototype,"presets",2),_([z()],M.prototype,"occupied",2),_([z()],M.prototype,"serverToken",2),_([z()],M.prototype,"appliedToken",2),_([z()],M.prototype,"polling",2),_([z()],M.prototype,"sendPending",2),_([z()],M.prototype,"pages",2),_([z()],M.prototype,"templateResults",2),_([z()],M.prototype,"historySeries",2),_([z()],M.prototype,"templateError",2),_([z()],M.prototype,"templateFetchedAt",2),_([z()],M.prototype,"forced",2),_([z()],M.prototype,"showRaw",2),_([z()],M.prototype,"inspect",2),_([z()],M.prototype,"openSections",2),_([z()],M.prototype,"pickerOpen",2),_([z()],M.prototype,"testValues",2),_([z()],M.prototype,"editingValue",2),_([z()],M.prototype,"multi",2),_([z()],M.prototype,"collapsed",2),_([z()],M.prototype,"activeFamily",2),_([z()],M.prototype,"picking",2),_([z()],M.prototype,"pickHoverId",2),_([z()],M.prototype,"showTaps",2),_([z()],M.prototype,"timestampActiveId",2),_([z()],M.prototype,"savedName",2),_([z()],M.prototype,"presetKind",2),_([z()],M.prototype,"presetEntity",2),_([z()],M.prototype,"newShapeChooser",2),_([z()],M.prototype,"previewCase",2),_([z()],M.prototype,"loadError",2),_([z()],M.prototype,"saveError",2),_([z()],M.prototype,"saving",2),_([z()],M.prototype,"conflict",2),_([z()],M.prototype,"remoteRevision",2),_([z()],M.prototype,"confirmDelete",2),_([z()],M.prototype,"moveTarget",2),_([z()],M.prototype,"moving",2),_([z()],M.prototype,"moveError",2),_([z()],M.prototype,"version",2);function Ve(e){return String(e?.message??e)}function Sc(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let t=e.split(":").map(n=>Number(n));if(!(t.length===0||t.length>3||t.some(n=>Number.isNaN(n))))return t.reduce((n,i)=>n*60+i,0)}function Qi(e){let t=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${t} (${e.paired_iphone_name})`:t}function Ec(e,t,n){switch(e.kind){case"text":return`${t.resolve(e.payload.value)??"--"} \xB7 ${e.payload.fontSize} pt`;case"icon":return`${e.payload.size} pt \xB7 ${we(e.payload.colorSlot.baseColorHex)}`;case"gauge":return`${t.resolve(e.payload.value)??"--"} \xB7 ${e.payload.style}`;case"chart":{let i=qe(e.payload),a=i!==void 0?n.get(i)??"":t.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${zt(a).length} values`}case"shape":return`${we(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return Ie(e.payload.action)}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",M);export{M as WristAssistantPanel,es as columnFit};
