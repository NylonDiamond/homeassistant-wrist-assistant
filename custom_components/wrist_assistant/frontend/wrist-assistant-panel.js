...
`)}function Pl(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Hp(r));return{values:t,nullKeys:i}}function Hp(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function qr(e){let n=Qi(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Lp(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(hr(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var _p=10800;function Pp(e,n,t){let i=n==="always"||n==="auto"&&t<=_p;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Dl(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Pp(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function zp(e,n){return Et(e)===void 0?[]:Dl(qe(e)*60,kr(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Np(e,n){return Vi(e)?Dl(Math.round(e.historyMinutes)*60,kr(ni(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Jt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Pe(e){let n=e.trim(),t=Jt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Jt(i)}function Op(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Dp(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Vp(e){let n=e.trim(),t=Jt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Jt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Jt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Bp(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Up(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Gp(e,n,t){if(Ce(n))return e;let i=n,a=e,r=Jt(e.trim()),o=i.duration?Vp(e):void 0;if(o!==void 0)a=Bp(o);else if(i.relativeTime&&r!==void 0)a=Dp(r);else{let s=Pe(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Op(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Up(a);break}return a}function kn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Xe(e,n=240){return Vl(e,n).map(t=>t.value)}function Vl(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function zl(e,n,t){let i=Vl(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Ct({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ie,c=t.highColorHex??He,u=t.lowColorHex??Le,p=[],m=(y,x)=>{if(y==="")return;let $=p.at(-1);$&&$.colorHex===x?$.text+=y:p.push({text:y,colorHex:x})},g=0;return i.forEach((y,x)=>{m(e.slice(g,y.start),n);let $=x===o?c:x===s?u:l.length>0?Ni(y.value,l,d):n,S=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,S),$),g=S}),m(e.slice(g),n),p}function Nl(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Kp(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function ui(e,n=Tt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Wp(i.slice(a+1))})}return t}function Wp(e){try{return decodeURIComponent(e)}catch{return e}}function jp(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Ol(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function qp(e,n,t){if(e===void 0)return 0;let i=Pe(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var ut=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Nl(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Gt(n),i=Kt(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let o=Xe(a),s=r===void 0?void 0:this.testedReading(n);return s!==void 0&&(o=[...o.slice(0,-1),s]),n.limit>0&&o.length>n.limit?n.takeFromEnd?o.slice(o.length-n.limit):o.slice(0,n.limit):o}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Pe(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Pe(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Nl(a.get(s)??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ce(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Lp(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Zs(r):hr(r,a.domainMax-a.domainMin));break}default:{let a=jr(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Gp(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Jt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?kn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Pe(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Pe(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Pe(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=qt(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:qt(d),p=c===void 0?void 0:qt(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Me[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=zl(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=at(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(x=>x.text).join(""),y):(js(n.payload)&&(y.spans=zl(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,x=m??p;y===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let $={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&($.path=y),$}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(N,U,te)=>N??(U?Pe(this.resolve(U)??""):void 0)??te,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),$=m===void 0?void 0:Pe(m),S=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&$!==void 0&&(S=Ni($,Ct(p),p.bandAboveColorHex));let k=x-y;if(p.total){let N=Pe(this.resolve(p.total)??"");N!==void 0&&(k=N)}let C=Ol(k,1,zi),O={kind:"gauge",...u,fraction:qp(m,y,x),style:p.style,lineWidth:p.lineWidth,colorHex:S,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:C,filledCount:Ol($??0,0,C)};if(p.thresholdValue!==void 0&&x!==y){let N=(p.thresholdValue-y)/(x-y);N>=0&&N<=1&&(O.thresholdFraction=N)}return O}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y={min:m.domainMin,max:m.domainMax},x=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Ct(p),S=Js(p)?g.map(T=>Ni(T,$,p.bandAboveColorHex)):[],k=p.highlight==="highest"||p.highlight==="both",C=p.highlight==="lowest"||p.highlight==="both",O=wt(p),N={kind:"chart",...u,values:g,style:p.style,domainMin:y.min,domainMax:y.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:x,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:k?O.high:"none",lowMarker:C?O.low:"none",pointColorHexes:S,fillBands:p.fillBands,thresholdColorHex:p.thresholdColorHex,nowColorHex:p.nowColorHex,labels:Np(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove};if(g.length>0){let T=k?g.indexOf(Math.max(...g)):-1,V=C?g.indexOf(Math.min(...g)):-1;T>=0&&(N.highIndex=T),V>=0&&V!==T&&(N.lowIndex=V)}let U=Kp(p,y.min,y.max);U!==void 0&&(N.thresholdY=U);let te=this.chartNowIndex(p,g.length);return te!==void 0&&(N.nowIndex=te),N}case"timeline":{let p=n.payload,m=Et(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=ui(g,Tt),x=jp(y,qe(p)*60,S=>al(S,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:zp(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};rt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=yl(n,t).map(y=>this.resolveElement(y,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,x=this.resolve(y.value),$=x===void 0?void 0:Pe(x);if($!==void 0){let S=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),C={value:Math.min(k,Math.max(S,$)),minValue:S,maxValue:k===S?S+1:k,colorHexes:y.colorHexes},O=this.resolve(y.minLabel);O!==void 0&&(C.minLabel=O);let N=this.resolve(y.maxLabel);N!==void 0&&(C.maxLabel=N),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Yp(e,n,t){let i=new ut(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function ea(e,n,t){let i=new ut(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Yp(e.inline,n,e)),a}var Se=be,hi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Se,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=hi.find(e=>e.measured);function Xl(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return hi.find(a=>a.screen.width===t&&a.screen.height===i)}function na(e,n){let t=Se[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Jr={regular:400,medium:500,semibold:600,bold:700},Xp=1.15;function Je(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function me(e,n,t="#FFFFFF"){let i=Je(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Jl(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var pt=e=>e*.55;function Zl(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Jp(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Zp(e,n,t){if(t<=0||e.length*pt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/pt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Qp(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Ql(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function ed(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function eh(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function td(e,n){return e.reduce((t,i)=>t+i.text.length*pt(i.look.fontSize*n),0)}function th(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:pt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=pt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function nh(e,n,t){if(t<=0||td(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*pt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*pt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function ih(e,n,t){let i=eh(n),a=e.lineLimit===2&&t.w>0?th(e.text,i,t.w):[e.text],r=Ql(e.text,a),o=a.map((S,k)=>ed(S,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(S=>td(S,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(S=>nh(S,l,t.w)),{anchor:c,x:u}=Zl(e.alignment,t),p=Math.max(0,...d.flat().map(S=>S.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=S=>S.map(k=>{let C=me(k.look.colorHex,"fill");return w`<tspan font-size=${k.look.fontSize*l} font-weight=${Jr[k.look.fontWeight]??400} fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}),x=me(e.colorHex,"fill"),$=d.length>1?w`${d.map((S,k)=>w`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*g}>${y(S)}</tspan>`)}`:y(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function bh(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?vh(a,n):void 0;return w`
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${S}${c}${$}${x}${C}</g>`}function ra(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function io(e,n){return(n?23.5:34)*e}var Bl=10.5;function ad(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Ul(e,n){let t=0;for(let i of e)t+=ad(i,n);return t}function Gl(e,n,t){let i=e.toUpperCase(),a=d=>ad(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function eo(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function to(e,n,t,i){let a=eo(e,n,t),r=eo(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function rd(e,n,t,i){let{dial:a}=ra(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:to(a,t,i.start,i.end),length:t*r}}function xh(e,n){let t=ra(e,!0);return rd(e,n,t.dial.r,t.labelArc)}var Kl=18.5,wh=113,kh={start:-71,end:-36},Wl=104,$h=6.2,jl={start:-77,end:-30.5};function ql(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Yl(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=ql(e[i]),o=ql(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var Xr=11;function Ch(e,n,t){let{dial:i}=ra(n,!0),a=Wl*n,r=180/(Math.PI*Wl),o=e.minLabel!==void 0?Ul(e.minLabel,Xr)*r:0,s=e.maxLabel!==void 0?Ul(e.maxLabel,Xr)*r:0,l=jl.start+(o>0?Math.max(0,o-1.8):0),d=jl.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let $=0;$<u;$++){let S=l+c*$/u,k=Math.min(d,l+c*($+1)/u+.4);p.push(w`<path d=${to(i,a,S,k)} fill="none"
      stroke=${Yl(e.colorHexes,($+.5)/u)} stroke-width=${$h*n}
      stroke-linecap=${$===0||$===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=eo(i,a,l+c*m),y=1.5,x=($,S,k,C)=>w`
    <defs><path id=${$} d=${to(i,a,S,k)} /></defs>
    <text font-size=${Xr*n} font-weight="600" fill="#FFFFFF"
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function oa(e,n){let t=e.family in Se?e.family:"rectangular",i=n.slot??Se[t],a=Se[t],r=na(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Je(e.backgroundColorHex),l=Je(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,y=!!e.bezelText||!!e.bezelGauge,x=e.curvedText??"",$=x!=="",S=ra(g,y),k=io(g,y),C=k/(a.width*g),O=S.tile.cx-k/2,N=S.tile.cy-k/2,U=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,te=f;if(e.bezelGauge)te=Ch(e.bezelGauge,g,o);else if(e.bezelText){let V=xh(g,`${o}-bezel`),Z=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?kn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;te=w`<defs><path id=${V.id} d=${V.d} /></defs>
        ...
        <text font-size=${Kl*g} font-weight="600" fill=${V.color} fill-opacity=${V.opacity}
          ...
          <textPath href="#${Z.id}" startOffset="50%" text-anchor="middle">${Gl(x,Z.length,Kl*g*.88)}</textPath></text>`}else{let V=e.borderWidth*r.scale*C,Z=l?w`<circle cx=${k/2} cy=${k/2} r=${k/2-V/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${V} />`:f;T=w`<g transform="translate(${O} ${N})">
        <g clip-path=${`url(#${o})`}>
    ...
    </div></div>`}function Ve(e,n,t,i,a={}){return h`<label class="field check">${Ie(e,Rt(n,i,t,r=>r?"on":"off"))}<input type="checkbox" .checked=${n} ?disabled=${a.disabled===!0} @change=${r=>t(r.target.checked)} /></label>`}function le(e,n,t,i=!1,a){let{rgb:r,alpha:o}=hc(n),s=a===void 0?void 0:{atDefault:No(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)},l=i&&n===void 0;return h`<div class="field color">${Ie(e,s)}
    <div class="color-row">
      ${i?h`<input type="checkbox" title="Enabled" aria-label=${`${e} on`} .checked=${n!==void 0} @change=${d=>t(d.target.checked?Ro(r,o):void 0)} />`:f}
      ${Io(e,n,t,l)}
    </div></div>`}function hc(e){let n=(e??"").replace(/^#/,""),t=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n);return{valid:t,swatch:t?`#${n}`:"transparent",rgb:t?`#${n.slice(0,6)}`:"#ffffff",alpha:t&&n.length===8?Math.round(parseInt(n.slice(6,8),16)/255*100):100}}function Ro(e,n){let t=e.replace(/^#/,"").toUpperCase();return n>=100?`#${t}`:`#${t}${Math.round(n/100*255).toString(16).padStart(2,"0").toUpperCase()}`}function Io(e,n,t,i=!1){let{valid:a,swatch:r,rgb:o,alpha:s}=hc(n);return h`<span class="color-box">
      <span class="color-swatch" style=${`--sw:${i||!a?"transparent":r}`} title="Pick a colour">
        <input type="color" .value=${o} ?disabled=${i} aria-label=${`${e}: pick a colour`} @input=${he(l=>t(Ro(l,s)))} />
      </span>
    ...
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${fc(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,C)=>h`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                ...
                <span class="ent-ico ${$o(k.state)?"on":""}">${ko(k.domain)}</span>
                <span class="ent-main">
    ...
    <span class="sym-name">${n}</span>
      ...
      ${N.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${N.map(U=>va(e,U,U===u,x))}</div>`}
      <div class="sym-grid">${O.map(U=>va(e,U,U===u,x))}</div>
    ...
    </div>`}else if(o){let k=r.category(i),C=sm(k,s,d,c),O=lo(C.names,s),N=C.fromPack?O.slice(0,qd):O,U=r.recent.filter(T=>!T.startsWith(Fe)),te=c.size===0?U:U.filter(T=>c.has(T));S=h`<div class="sym-browse">
      ${m?Jd(r,i,g):f}
      <div class="sym-controls">
      ...
      ${te.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${te.map(T=>va(e,T,T===u,x))}</div>`}
      <div class="sym-grid">${N.map(T=>va(e,T,T===u,x))}</div>
    ...
    ${S}`}function cm(e,n){let t=e.trim();return t!==""&&!t.startsWith(Fe)&&n.size>0&&!n.has(t)}function um(e,n){let t=n.trim(),i=t.startsWith(Fe)?t.slice(Fe.length):t,a=e.map(r=>r.startsWith(Fe)?r.slice(Fe.length):r);return lo(a,i).map(r=>Fe+r)}function Jd(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}function Ra(e,n,t,i){let a=Ct({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(g=>g.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:No(l,ie),title:`Back to ${ie}`,reset:()=>t(c=>{c.bandAboveColorHex=ie})};return h`<div class="bands">
    ${xm(a,l,r)}
    ${a.map(c=>h`
      <div class="band-row ${o===c.id?"hit":""}">
        ...
        ${Io(`Up to ${c.upTo}`,c.colorHex,u=>t(s(c.id,p=>{p.colorHex=u??"#FFFFFF"}),`bcol${c.id}`))}
    ...
    <div class="band-row ${o==="above"?"hit":""}">${zo(d)}
      <span class="le" aria-hidden="true">&gt;</span>
      <span class="else">Above</span>
      ${Io("Above the last band",l,c=>t(u=>{u.bandAboveColorHex=c??ie},"babove"))}
      <span></span>
    </div>
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function nf(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function af(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Qm(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Fn(e,n=Ut){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}var Ea=new Set;function Ho(e,n,t=Ut){return Ea.has(e)||!t.some(i=>i.minutes===n)}function To(e,n,t,i,a=Ut){let r=Ho(e,n,a);return h`<label class="field">${Ie("Span",{atDefault:n===t&&!r,title:`Back to ${Fn(t,a)}`,reset:()=>{Ea.delete(e),i(t)}})}
      ...
      </select></label>`}function Eo(e,n,t=!1){let i=t?mr:Di,a=Math.floor(i/1440),r=t?ei:Ut,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function of(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Ee(e.config,t,n),o=r.frame,s=(d,c)=>e.update(u=>Te(u,t,i,{frame:go(o,d)}),`${a}-${c}-${t}`),l=!Ia(o,Zn)||r.isHidden;return ve(e,"placement","Position",h`
    ...
    <div class="hint">X, Y, W and H are a percent of the face, on the ${ee(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:X.position,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${ee(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${ee(t)} face at half size, unrotated and shown`,reset:()=>e.update(d=>Te(d,t,i,{frame:{...Zn},isHidden:!1}))}:{}})}function sf(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=_e(e.config,t)[0];return ve(e,"tappable","Tap",Af(e,n,`el-${t}`),{color:X.tap,icon:"tap",summary:i?ot(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>ji(a,t))}:{}})}function rc(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${J("Clock",e.hourCycle,tl,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${J("Minutes",e.minutes,nl,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var lf=[["number","Number"],["entity","Entity"]];function df(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function cf(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function uf(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=df(n,o),c=s?n.minValue:n.maxValue,u=y=>a(x=>{s?x.minValue=y??0:x.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Ie(l,d==="number"?Rt(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${lf.map(([y,x])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a($=>cf($,o,y))}}>${x}</button>`)}
      </span>
    </div>`,g=s?n.minSource:n.maxSource;return d==="number"||g===void 0?h`<div class="field gauge-end">${m}${za(c,u,{ariaLabel:l})}</div>`:h`<div class="field gauge-end">${m}${se(e,g,y=>a(x=>{s?x.minSource=y:x.maxSource=y},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
    ...
    ${J("Colour",a,Ao,c=>t(u=>{if(c==="uniform"){delete u.coloring;return}u.coloring=c,(u.bands?.length??0)===0&&(u.bands=Fa(Xe(e.resolve(u.value)??"")))}),{def:"uniform"})}
    ${i}
    ${a==="bands"?h`
    ...
    ${J("Highlight",r,Do,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
    ...
    ${p===void 0?f:h`<div class="rich-confirm" role="alertdialog" aria-label=${y}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${x=>{vi.delete(o),ke(x.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ...
    ${s==="rich"?Cf(e,n,t,i,a):h`
        ...
        ${Bo(e,s==="countdown",r.value,x=>g(x?"countdown":"plain",null))}
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Ae(d,ce(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Cf(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ce(e),d=Math.max(0,o.findIndex(R=>R.id===xi.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Ee(e.config,t,n).size??r.fontSize,g=(R,b)=>{ht.delete(s),i(v=>{R(v),qs(v)},b)},y=(R,b)=>g(v=>{let M=v.parts?.find(E=>E.id===c.id);M&&R(M)},b?`part-${c.id}-${b}`:void 0),x=(R,b)=>{xi.set(s,R),ht.delete(s),ke(b)},$=(R,b)=>{let v=j();xi.set(s,v),g(M=>{(M.parts??=[]).push({id:v,value:R})}),bc(b,Oa(`${a}-part-${v}`),!0)},S=R=>g(b=>{b.parts&&$i(b.parts,d,R)}),k=()=>{let R=o[d+1]??o[d-1];R&&xi.set(s,R.id),g(b=>{b.parts=(b.parts??[]).filter(v=>v.id!==c.id)})},C=o.map((R,b)=>{let v=bf(R.value,l),M=R.id===c.id,E=Lo(R),z=v.kind==="value"?e.resolve(R.value):void 0,B=R.fontWeight===void 0?void 0:Mn.find(([K])=>K===R.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${M?"true":"false"} class="part-chip ${v.kind} ${M?"on":""}"
      aria-label=${Ac(R,b,l)} @click=${K=>x(R.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${xf(R,p)}`}
    ...
    </button>`}),O=r.rules.some(R=>R.partId===c.id),N=c.value.kind.kind==="literal",U=Lo(c),te=c.fontSize!==void 0,T=Mn.find(([R])=>R===r.fontWeight)?.[1]??r.fontWeight,V=R=>{R>=Mo&&R<=Fo&&y(b=>{b.fontSize=R},"size")},Z=U==="bands"?Xe(e.resolve(c.value)??""):[],W={layer:"Use the layer colour",...N&&U!=="bands"?{bands:"By value needs a live value"}:{}},ge=(R,b)=>y(v=>{let M={bands:v.bands??[],bandAboveColorHex:v.bandAboveColorHex??ie};R(M),M.bands.length>0?v.bands=M.bands:delete v.bands,M.bandAboveColorHex!==ie?v.bandAboveColorHex=M.bandAboveColorHex:delete v.bandAboveColorHex},b);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      ...
      ${J("Colour",U,hf,R=>y(b=>{if(R==="layer"){delete b.colorHex,delete b.coloring;return}if(R==="pick"){delete b.coloring,b.colorHex=No(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Fa(Xe(e.resolve(b.value)??"")))}),{def:"layer",titles:W,...N&&U!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <label class="field num part-size">${Ie("Font size",te?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(R=>{delete R.fontSize})}:void 0,Pa(c.fontSize??m,V,{step:1,min:Mo,max:Fo}))}
        ${za(c.fontSize,R=>{R===void 0?y(b=>{delete b.fontSize},"size"):V(R)},{step:1,min:Mo,max:Fo,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:te?"Part font size":`Part font size, ${m} pt from the layer`,...te?{}:{lead:D("link")}})}
      </label>
    </div>
  </div>`}function Hc(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,v)=>e.update(M=>b(M.elements[r]),v?`${o}-${v}`:void 0),l=Ee(e.config,t,n),d=l.frame,c=(b,v)=>e.update(M=>Te(M,t,a,{frame:go(d,b)}),`${o}-${v}-${t}`),u=je(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],g=!1,y=b=>n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?f:le(b,n.payload.colorSlot.baseColorHex,v=>s(M=>{M.kind!=="image"&&M.kind!=="tap"&&M.kind!=="timeline"&&(M.payload.colorSlot.baseColorHex=v??"#FFFFFF")},"color"),!1,p),x,$;switch(n.kind){case"text":{let b=(v,M)=>s(E=>v(E.payload),M);x=$f(e,n,t,b,o),g=!n.payload.countdown&&!at(n.payload),$=h`
        ${wa(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${J("Weight",n.payload.fontWeight,Mn,v=>s(M=>{M.payload.fontWeight=v}),{def:u.fontWeight})}
        ${em({label:"Align",value:n.payload.alignment??"center",options:Wm,def:"center",set:v=>s(M=>{let E=M.payload;v==="center"?delete E.alignment:E.alignment=v})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:jm,def:"1",set:v=>s(M=>{let E=M.payload;v==="2"?E.lineLimit=2:delete E.lineLimit})})}
        ${Ve("Mono digits",n.payload.monospacedDigits===!0,v=>s(M=>{let E=M.payload;v?E.monospacedDigits=!0:delete E.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${g?pf(e,n.payload,b,y("Main colour")):f}`;break}case"icon":x=h`
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,$=wa(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let b=n.payload,v=(E,z)=>s(B=>E(B.payload),z),M=b.style==="dots";x=h`
        ${se(e,b.value,E=>v(z=>{z.value=E},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${M?h`
            ${se(e,b.total??Qd(b),E=>v(z=>{z.total=E},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${zi} dots are drawn.</div>`:uf(e,b,{min:u.minValue,max:u.maxValue},o,v)}`,g=!0,$=h`
        <div class="grid2">
          ${J("Style",b.style,$m,E=>v(z=>{E==="dots"&&z.total===void 0&&(z.total=Qd(z)),E!=="dots"&&delete z.total,z.style=E}),{titles:Cm,def:u.style})}
          ${M?f:wa(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${le(M?"Empty dot colour":"Track colour",b.trackColorHex,E=>v(z=>{z.trackColorHex=E??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${J("Colour",b.coloring,Ao,E=>v(z=>{z.coloring=E,E==="bands"&&z.bands.length===0&&(z.bands=Fa([z.minValue,z.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${b.coloring==="bands"?h`
          ...
          ${Ra(b,b.colorSlot.baseColorHex,v,Xe(e.resolve(b.value)??"")[0])}`:f}
        ${M?f:h`
          <div class="grid2">
            ${oe("Threshold",b.thresholdValue,E=>v(z=>{E===void 0?delete z.thresholdValue:z.thresholdValue=E},"thr"),{optional:!0})}
            ${b.thresholdValue===void 0?f:le("Threshold colour",b.thresholdColorHex,E=>v(z=>{z.thresholdColorHex=E??pn},"thrcol"),!1,pn)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,v=(F,_)=>s(on=>F(on.payload),_),M=wt(b),E=cr(u.marker),z=u.historyMinutes,B=u.historyPoints,K=b.historyMinutes>0,xe=K&&b.source==="statistics",_t=K&&!xe,In=K?xe?"statistics":"history":"value",An=xe?ei:Ut,we=Gt(b)??Kt(b),ue=b.value.kind.kind==="entityState",tt=we===void 0?void 0:e.historySeries(we),vu=K&&ue?tt??"":e.resolve(b.value)??"",nt=b.historyPoints<1,ns=Ho(a,b.historyMinutes,An),Ke=Xe(vu),Pt=b.limit>0&&Ke.length>b.limit?b.takeFromEnd?Ke.slice(Ke.length-b.limit):Ke.slice(0,b.limit):Ke,xu=!K&&ue&&Ke.length===1,Ga=e.config.elements.filter(F=>F.kind==="chart"&&F.payload.id!==a),wu=ce(e),Ka=b.scaleFrom!==void 0&&Ga.some(F=>F.payload.id===b.scaleFrom);x=h`
        ${se(e,b.value,F=>v(_=>{_.value=F},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${J("Draw",In,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],F=>v(_=>{if(F==="value"){_.historyMinutes=0;return}_.source=F==="statistics"?"statistics":"history";let on=_.historyMinutes||Oi;_.historyMinutes=F==="statistics"?Math.min(on,mr):Math.min(on,Di)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${xe?h`
            ...
            <div class="grid2">
              ${To(a,b.historyMinutes,z,F=>v(_=>{_.historyMinutes=F}),ei)}
              ${J("Per",b.statPeriod,Pi,F=>v(_=>{_.statPeriod=F}),{def:Xn})}
            </div>
            ${ns?Eo(b.historyMinutes,F=>v(_=>{_.historyMinutes=F},"span"),!0):f}
            ${J("Read",b.statType,lr,F=>v(_=>{_.statType=F}),{def:Jn})}
        ...
        ${_t?h`
            ${ue?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${To(a,b.historyMinutes,z,F=>v(_=>{_.historyMinutes=F}))}
              <div class="field readings-field">${Ie("Points",{atDefault:b.historyPoints===B,title:`Back to ${B<1?"every one":`${B} averaged`}`,reset:()=>v(F=>{F.historyPoints=B})})}
                <div class="readings-row">
                  ...
                  ${nt?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${he(F=>{let _=Number(F);F.trim()!==""&&Number.isFinite(_)&&_>=1&&v(on=>{on.historyPoints=Math.round(_)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${ns?Eo(b.historyMinutes,F=>v(_=>{_.historyMinutes=F},"span")):f}
        ...
        ${xu?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
              Switch Draw to <b>Recorded history</b> to plot how it has moved.</div>`:f}
        <div class="grid2">
          ${oe("Use",b.limit,F=>v(_=>{_.limit=Math.max(0,Math.round(F??0))},"limit"),{step:1,min:0,def:u.limit})}
          ${J("From",b.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],F=>v(_=>{_.takeFromEnd=F==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        <div class="grid2">
          ${J("Style",b.style,mm,F=>v(_=>{_.style=F}),{def:u.style})}
          ${b.style==="bars"?oe("Bar gap",b.barGap,F=>v(_=>{_.barGap=Math.max(0,F??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):wa(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${J("Scale",b.scale,fm,F=>v(_=>{_.scale=F}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${J("Baseline",b.baseline,gm,F=>v(_=>{_.baseline=F}),{def:u.baseline})}
        </div>
        ${Ga.length===0?f:Ne("Same scale as",Ka?b.scaleFrom:"",[["","Its own"],...Ga.map(F=>[F.payload.id,Ae(F,wu)])],F=>v(_=>{F?_.scaleFrom=F:delete _.scaleFrom}),{def:""})}
        ...
        ${!Ka&&b.scale==="fixed"?h`<div class="grid2">
              ${oe("Min",b.minValue,F=>v(_=>{_.minValue=F??0},"cmin"),{def:u.minValue})}
              ${oe("Max",b.maxValue,F=>v(_=>{_.maxValue=F??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let F;e.update(_=>{F=kl(_,a)}),F&&e.selectLayer(F)}}>${D("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${J("Colour",b.coloring,Ao,F=>v(_=>{_.coloring=F,F==="bands"&&_.bands.length===0&&(_.bands=Fa(Pt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${b.coloring==="bands"?h`
          ...
          ${Ra(b,b.colorSlot.baseColorHex,v)}
          ${b.style==="area"?h`${Ve("Band fill",b.fillBands,F=>v(_=>{_.fillBands=F}),u.fillBands)}
        ...
        ${J("Highlight",b.highlight,Do,F=>v(_=>{_.highlight=F}),{def:u.highlight})}
        ${b.highlight==="none"?f:h`
          <div class="grid2">
            ${b.highlight==="lowest"?f:J("Highest marker",M.high,Zd,F=>v(_=>{ur(_,{...wt(_),high:F})}),{def:E.high})}
            ${b.highlight==="highest"?f:J("Lowest marker",M.low,Zd,F=>v(_=>{ur(_,{...wt(_),low:F})}),{def:E.low})}
          </div>
          <div class="grid2">
            ${b.highlight==="lowest"?f:le("Highest colour",b.highColorHex,F=>v(_=>{_.highColorHex=F??He},"hicol"),!1,He)}
            ${b.highlight==="highest"?f:le("Lowest colour",b.lowColorHex,F=>v(_=>{_.lowColorHex=F??Le},"locol"),!1,Le)}
          </div>
        ...
        ${Ve("Threshold",b.thresholdValue!==void 0,F=>v(_=>{F?_.thresholdValue=ym(Pt):delete _.thresholdValue}))}
        ${b.thresholdValue===void 0?f:h`
          <div class="grid2">
            ${oe("At",b.thresholdValue,F=>v(_=>{_.thresholdValue=F??0},"thval"))}
            ${le("Line colour",b.thresholdColorHex,F=>v(_=>{_.thresholdColorHex=F??hn},"thcol"),!1,hn)}
          </div>
        ...
        ${Ve("Now marker",b.nowIndex!==void 0,F=>v(_=>{F?_.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete _.nowIndex}))}
        ${b.nowIndex===void 0?f:h`
          ${se(e,b.nowIndex,F=>v(_=>{_.nowIndex=F},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${le("Marker colour",b.nowColorHex,F=>v(_=>{_.nowColorHex=F??mn},"nowcol"),!1,mn)}
        ...
        ${Vi(b)?rc(b,v,u,"cl",h`
            <div class="hint">Clock times from the start of the span to now, evenly spaced, in a row of
              ...
              Recorded history.</div>`}`;break}case"timeline":{let b=n.payload,v=(we,ue)=>s(tt=>we(tt.payload),ue),M=u.historyMinutes,E=b.value.kind.kind==="entityState",z=Et(b),B=z===void 0?void 0:e.historySeries(z),K=qe(b)*60,xe=ui(B??"",Tt),_t=Ho(a,b.historyMinutes),In=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,An=wm(xe,K,In===void 0?void 0:e.hass.states[In]?.state,In?.split(".")[0]);x=h`
        ${se(e,b.value,we=>v(ue=>{ue.value=we},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        ${To(a,b.historyMinutes,M,we=>v(ue=>{ue.historyMinutes=we}))}
        ${_t?Eo(b.historyMinutes,we=>v(ue=>{ue.historyMinutes=we},"span")):f}
        ...
        ${xe.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${af(xe,K)}</span></span></div>`:f}
        ${nf(xe)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${km(b,v,An,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${oe("Gap",b.gap,we=>v(ue=>{ue.gap=Math.min(Bi,Math.max(0,we??0))},"tgap"),{step:.5,min:0,max:Bi,def:u.gap,unit:"pt"})}
          ${oe("Corner radius",b.cornerRadius,we=>v(ue=>{ue.cornerRadius=Math.max(0,we??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
        ...
        ${rc(b,v,u,"tl",h`
          ...
          ${J("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],b=>s(v=>{v.payload.kind=b}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:u.kind})}
          ${n.payload.kind==="roundedRectangle"?oe("Corner radius",n.payload.cornerRadius,b=>s(v=>{v.payload.cornerRadius=b??6},"radius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"}):f}
        </div>
        ${n.payload.kind==="line"?tf(t,d,c):f}`,$=n.payload.kind==="line"?oe("Thickness",n.payload.thickness,b=>s(v=>{v.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${n.payload.borderColorHex!==void 0?oe("Border width",n.payload.borderWidth,b=>s(v=>{v.payload.borderWidth=b??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let b=n.payload,v=(B,K)=>s(xe=>B(xe.payload),K),M=b.entity.entityId?e.hass.states[b.entity.entityId]?.attributes?.entity_picture:void 0,E=typeof M=="string"?M:void 0,z=E!==void 0&&!E.startsWith("/");x=h`
        ${J("Source",b.source,[["camera","Camera"],["entityPicture","Entity picture"]],B=>v(K=>{K.source=B}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:u.source})}
        ${b.source==="camera"?h`
        ...
        ${J("Picture",b.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],B=>v(K=>{K.contentMode=B}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:u.contentMode})}
        ${wi("Zoom",b.zoom,B=>v(K=>{K.zoom=B},"zoom"),{min:no,max:4,step:.05,def:1,format:B=>`${B.toFixed(2)}x`,unit:"x"})}
        ${wi("Pan left/right",b.panX,B=>v(K=>{K.panX=B},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${wi("Pan up/down",b.panY,B=>v(K=>{K.panY=B},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${b.contentMode==="fit"&&b.zoom===1?"hint keep":"hint"}>${Xm(b)}</div>
        ${oe("Corner radius",b.cornerRadius,B=>v(K=>{K.cornerRadius=Math.max(0,B??fn)},"imgradius"),{step:1,min:0,def:fn,unit:"pt"})}`;break}case"tap":{x=h`
        ${Lc(e,n.payload,(b,v)=>s(M=>b(M.payload),v),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let S=g||n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&at(n.payload)?"Layer colour":"Colour"),k=Hr(e.config,n),C=k?{kind:{kind:"entityState",...k}}:void 0,O=n.kind==="image"?n.payload.timestamp===!0:!1,N=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,U=Tf[n.kind],te=Ef[n.kind],T=ac(n.payload,u,U),V=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,Z=e.config.perFamily[t]?.placements[a]?.size!==void 0,W=ac(n.payload,u,te)||V!==void 0&&l.size!==void 0&&l.size!==u[V],ge=Wt(e.config,a),R=(b,v)=>()=>s(M=>So(M.payload,u,b),v);return h`
    ${ve(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"?f:Ic(e,n,o)}${x}`,{color:X.content,icon:"content",summary:Vo(e,n),...T?{reset:()=>s(b=>{So(b.payload,u,U),b.kind==="text"&&yi(b.payload.rules)},"reset-content")}:{}})}
    ${$===void 0&&S===void 0?f:ve(e,"look",n.kind==="image"?"Picture":"Look",h`${$??f}${S??f}`,{color:X.look,icon:n.kind==="image"?"image":"look",...Aa(n)?{summary:Aa(n)}:{},...W?{reset:()=>e.update(b=>{So(b.elements[r].payload,u,te),Z&&Te(b,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?ve(e,"numbers","Numbers",If(e,n),{color:X.numbers,icon:"text",summary:Rf(e,n),...ge.length>0?{reset:()=>e.update(b=>{for(let v of Wt(b,a))ct(b,v.payload.id)})}:{}}):f}
    ${n.kind==="image"?ve(e,"timestamp","Timestamp",Jm(n.payload,(b,v)=>s(M=>b(M.payload),v)),{color:X.numbers,icon:"clock",summary:O?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...O?{reset:R(Sf,"reset-stamp")}:{}}):f}
    ${ve(e,"states","States",Bc(e,n.payload.rules,n.kind,b=>b.elements.find(v=>v.payload.id===a)?.payload.rules,`rules-${a}`,C,N),{color:X.states,icon:"states",summary:mi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ...
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function Rf(e,n){let t=Wt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(cn.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function If(e,n){let t=ce(e),i=Wt(e.config,n.payload.id),a=o=>e.update(s=>{ml(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return h`
    ...
    ${n==="corner"?ve(e,"corner","Corner content",Lf(e,t,i),{color:X.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${ve(e,"states","Shape states",Bc(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:X.states,icon:"states",summary:mi(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${ve(e,"content","Inline text",h`
      ...
      ${Bo(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:X.content,icon:"text",summary:De(`${n.label?`${n.label}: `:""}${$e(n.value,i)}`,48)})}
    ...
    ${a==="text"&&n.bezelText?h`
      ...
      ${Bo(e,n.bezelCountdown===!0,n.bezelText,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:f}
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Qb=ne.map(e=>[e,ee(e)]),Uo={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Pf=Object.keys(Uo),Ha=["color","text","fontSize","fontWeight","visibility"];function zf(e,n=!1){let t=Ji[e].filter(i=>!n||Ha.includes(i));return Pf.filter(i=>t.includes(Me[i]))}function zc(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${vf(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ...
    <div class="adders"><button class="small" @click=${()=>u(m=>{m.cases.push(Kr())})}>+ case</button></div>
    ...
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(Gr())})}>+ test</button>
    ...
    ${Oc(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=Kf(n.value)?Wf(s.options??[],u=>o(p=>{p.comparison.options=vo(u)},"options")):fe("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Ne("Comparison",s.kind,Ml.map(u=>[u,Tn[u]]),u=>o(p=>{p.comparison=Wr(p.comparison,u)}))}
    ${c}
    ...
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Xt(d))})}}>
      ...
      ${o.map(s=>h`<option value=${s}>${Uo[s]}</option>`)}
    ...
    <div class="rule-head">
      <span>${Uo[n.kind]}${l?h` <span class="no">(ignored by ${i==="layout"?"layouts":`${i} layers`})</span>`:d?h` <span class="no">(ignored by a part)</span>`:f}</span>
      <span class="spacer"></span>
    ...
    ${Vc(e,n,a,o)}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{_o.delete(a),ke(d.target)}}>Show as table</button>
        ${s.ok?f:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${Df(e,n,t,i,a,o)}`:qf(e,s.table,n[0],t,i,a,r,o)}function qf(e,n,t,i,a,r,o,s){let l=(v,M)=>e.update(E=>{let z=a(E);z&&v(z)},M?`${r}-${M}`:void 0),d=n.value??dc.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Id(d)&&Yf(e.resolve(d)),p=Ji[i],m=Sa.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Rd[i]]:[],y=wd(n.columns,[...m,...g.filter(v=>v!==void 0)],p),x=$a.get(r),$=t?t.partId:s?.some(v=>v.id===x)?x:void 0,S=s!==void 0&&$!==void 0,k=S?p.filter(v=>Ha.includes(v)):p,C=S?y.filter(v=>!Ha.includes(v)):[],O=(v,M)=>{if(!t){v?$a.set(r,v):$a.delete(r),ke(M);return}l(E=>{let z=E[0];z&&(v?z.partId=v:delete z.partId)})},N=t?e.liveBranch(t):"none",U=t?e.forced.get(t.id)??"live":"live",te=v=>U!=="live"&&(U==="otherwise"?v==="otherwise":U.caseId===v),T=v=>{t&&e.setForced(t.id,te(v)?"live":v==="otherwise"?"otherwise":{caseId:v})},V=v=>{dc.set(r,v),n.rows.length!==0&&l(M=>Ed(M,v),"lhs")},Z=()=>{$a.delete(r),l(v=>{Sd(v,d??H(""),u),$!==void 0&&v[0]&&v[0].partId===void 0&&(v[0].partId=$)})},W=n.rows.map((v,M)=>uc(e,{key:`${r}-${v.caseId}`,label:Fd(v.comparison,E=>$e(E,ce(e))),columns:y,changes:v.changes,live:N===v.caseId,forced:te(v.caseId),onForce:()=>T(v.caseId),when:eg(e,v.comparison,`${r}-${v.caseId}`,(E,z)=>l(B=>{let K=B[0]?.cases.find(xe=>xe.id===v.caseId)?.when.tests[0];K&&E(K.comparison)},z&&`${v.caseId}-${z}`)),updChanges:(E,z)=>l(B=>{let K=B[0]?.cases.find(xe=>xe.id===v.caseId);K&&E(K.then)},z&&`${v.caseId}-${z}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${M===0} @click=${()=>l(E=>ho(E,M,M-1))}>${D("up")}</button>
      <button class="icon" title="Move down" ?disabled=${M===n.rows.length-1} @click=${()=>l(E=>ho(E,M,M+1))}>${D("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>Td(E,v.caseId))}>${D("delete")}</button>`})),ge=n.otherwise===void 0?f:uc(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:N==="otherwise",forced:te("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(v,M)=>l(E=>{let z=E[0]?.otherwise;z&&v(z)},M),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(v=>mo(v,!1))}>${D("close")}</button>`}),R=Ta.get(r),b=Xf.filter(v=>k.includes(v)&&!y.includes(v));return h`
    <div class="states">
      ...
      <div class="states-scroll"><table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(v=>h`<th>
              <span>${Ze[v]}</span>
              <button class="icon" title=${`Remove the ${Ze[v]} column`}
                @click=${M=>{Ta.set(r,v),ke(M.target)}}>${D("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${C.length===0?f:h`<div class="hint warn">A part ignores ${Va(C.map(v=>Ze[v]))}. Pick Whole text to use ${C.length===1?"it":"them"}.</div>`}
      ${R===void 0?f:h`<div class="hint warn confirm-row">
        ...
        <button class="danger small" @click=${v=>{Ta.delete(r),Sa.get(r)?.delete(R),ke(v.target),l(M=>Md(M,R))}}>Remove</button>
        <button class="small" @click=${v=>{Ta.delete(r),ke(v.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(v=>mo(v,!0))}>${D("plus")}<span>Otherwise</span></button>`:f}
          ${b.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${v=>{let M=v.target,E=M.value;if(M.value="",!E)return;let z=Sa.get(r)??new Set;z.add(E),Sa.set(r,z),ke(M)}}>
            <option value="" selected>+ Column…</option>
            ${b.map(v=>h`<option value=${v}>${Ze[v]}</option>`)}
          </select>`}
        </div>
      </div>
      ...
      <div class="states-switch">
        <button class="link" @click=${v=>{_o.add(r),ke(v.target)}}>Advanced</button>
    ...
    <td class="acts">${n.acts}</td>
      ...
      @click=${d=>{i(c=>{c.push(Xt(xd[n]))}),bc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Me[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=Ze[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Qf(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${vc}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
...
${_g(c)}`}}let l=Gi(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${Jc}`}}return{ok:!0,config:s,raw:i}}function jo(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=Ur(e,(o,s)=>Xc(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Xc(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Zc(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function au(e,n){let t=structuredClone(e);Vr(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return Br(t,a=>Pr(a,i)),t}function ru(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function Pg(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function ou(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=sa(e);return i.length===0?t:`${t}, ${Pg(i)}`}function qo(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var Ng=3e4,Og=500,Dg=3e4,su="preset-entity";function lu(e){return`import-entity-${e}`}var Vg={entityId:"",displayName:"",domain:""},Bg=new Map,Ug={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Yo(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Gg(e){return e.kind==="family"?"look":"content"}function Xo(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function du(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function Kg(e){let n=w`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?w`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?w`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?w`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:w`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var cu=300,uu=360,Qo=44,es=22,bu=[1,1.7,2.6],Wg=["S","M","L"],pu=["Small","Medium","Large"];function jg(){return bu.map((e,n)=>{let t=Math.round(Qo*e),i=Math.round(es*e),a=`.layers-card.s${n}`;return`
...
`)}var hu="wrist-assistant-panel.layers.v1",mt=34,rn=200,qg=720,Ua=320,Yg=80,Xg=56,mu="wrist-assistant-panel.columns.v3",Jo=e=>Math.max(rn,Math.min(qg,Math.round(e))),fu=e=>e.metaKey||e.ctrlKey||e.shiftKey,Jg=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Ti=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Lt=Ti==="Cmd"?"\u2318":"Ctrl+",Zo=Ti==="Cmd"?"\u21E7":"Shift+";function gu(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Yg;if(i>=rn*2+Ua){let r=i-Ua,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(rn,Math.floor(o*l)),s=Math.max(rn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(rn,o-d):s=Math.max(rn,s-d))}return{columns:3,left:o,right:s}}let a=e-Xg;return a>=rn+Ua?{columns:2,left:Math.min(n,a-Ua),right:t}:{columns:1,left:n,right:t}}var I=class I extends yt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=cu;this.colRight=uu;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=$n.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=fd(()=>this.requestUpdate());this.imageSizes=gd(()=>this.requestUpdate());this.symbols=new ua(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new ma;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=jo(a,this.hass.states);r.some(s=>Oo(lu(s.entityId)))||qo({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Oo(su)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Bg}static{this.styles=ja`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(La,this.scrubStart),this.addEventListener(_a,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Dg)}loadColumnWidths(){try{let t=window.localStorage.getItem(mu);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Jo(i.left)),typeof i.right=="number"&&(this.colRight=Jo(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(mu,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(hu);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(hu,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?_r(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let $=this.focusTapId();if($!==void 0&&o===$&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,$,r??void 0);return}let S=this.hitLayerId(i);S?this.inspect={kind:"layer",id:S}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=fu(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=_r(this.draft.config,o),p=this.draft.config.elements.find($=>$.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=st(this.draft.config,u),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let y=Ee(this.draft.config,t,p).frame,x=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let $=p.payload,S=be[t],k=y.width*S.width,C=y.height*S.height,O={x:0,y:0,w:k,h:C,cx:k/2,cy:C/2},N=aa($,O,ia(new Date));if(this.cancelGesture?.(),l){let V=x.width/S.width,Z=$.timestampSize;this.cancelGesture=zd(s,i,l,{w:N.w*V,h:N.h*V},(W,ge)=>{let R=Math.min(40,Math.max(4,Math.round(Z*W)));this.mutate(b=>{let v=b.elements.find(M=>M.payload.id===u);v?.kind==="image"&&(v.payload.timestampSize=R)},`ts-size-${u}`),ge&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let U={x:0,y:0,w:y.width*x.width,h:y.height*x.height},te=rt($)?{x:$.timestampX,y:$.timestampY}:{x:(N.x+N.w/2)/O.w,y:(N.y+N.h/2)/O.h},T=!1;this.cancelGesture=Pd(s,U,i,te,(V,Z,W)=>{W||(T=!0),T&&this.mutate(ge=>{let R=ge.elements.find(b=>b.payload.id===u);R?.kind==="image"&&(R.payload.timestampX=V,R.payload.timestampY=Z)},`ts-${u}`),W&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=ya(s,x,i,{elementId:u,frame:y,handle:r??void 0},{onFrame:($,S,k)=>{this.mutate(C=>Te(C,t,$,{frame:S}),`drag-${$}-${t}`),k&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=lt(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,Ee(o,t,x).frame])),d=[...l.values()],c=Math.min(...d.map(x=>x.x)),u=Math.min(...d.map(x=>x.y)),p=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),g={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},y=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=ya(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:(x,$,S)=>{let k=$.x-g.x,C=$.y-g.y;this.mutate(O=>{for(let[N,U]of l)Te(O,t,N,{frame:{...U,x:y(U.x+k),y:y(U.y+C)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?Ld:1,s=t*o,l=i*o,d=this.canvasFamily,c=be[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(lt(r,x).map($=>$.payload.id),d,c,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(x=>x.payload.id===u);if(!p)return!1;let m=st(r,u);if(m?.locked)return this.nudgeMany(lt(r,m.id).map(x=>x.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=Ee(r,d,p).frame,y=bo(g,s,l,c);return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>Te(x,d,u,{frame:y}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,c=new Map;for(let C of t){let O=l.elements.find(N=>N.payload.id===C);O&&c.set(C,Ee(l,i,O).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(C=>C.x)),m=Math.min(...u.map(C=>C.y)),g=Math.max(...u.map(C=>C.x+C.width)),y=Math.max(...u.map(C=>C.y+C.height)),x={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},$=bo(x,o,s,a),S=$.x-x.x,k=$.y-x.y;return(S!==0||k!==0)&&this.mutate(C=>{for(let[O,N]of c)Te(C,i,O,{frame:{...N,x:d(N.x+S),y:d(N.y+k)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=be[i],c=Ee(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=aa(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},ia(new Date)),g=rt(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},y=_d(g,a,r,{w:u,h:p});return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>{let $=x.elements.find(S=>S.payload.id===t);$?.kind==="image"&&($.payload.timestampX=y.x,$.payload.timestampY=y.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=na(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=io(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:_e(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=pe(s,l),c=Ee(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=ya(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?vl(g,u,t,p):Te(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:gu(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
    ...
    </div>`}pickerRows(){let t=this.records.map(a=>({slot:Number(a.document?.slotIndex??0),kind:"record",record:a}));return[...t,...Ws(t.map(a=>a.slot),this.occupied).map(a=>a.kind==="custom"?{slot:a.slot,kind:"locked",name:a.name||"Unnamed complication",badge:a.home||"Other home",title:`A complication on ${a.home?`the ${a.home} home`:"another home"}${a.families?.length?` (${a.families.map(ee).join(", ")})`:""}. Edit it in that home's Wrist Assistant panel.`,families:a.families??[]}:{slot:a.slot,kind:"locked",name:a.name||"Unnamed preset",badge:"iPhone",title:"Still on the iPhone. Open the Wrist Assistant app on the iPhone to move it here.",families:[]})].sort((a,r)=>a.slot-r.slot)}shapeDots(t){return h`<span class="shape-dots">${Zt.map(i=>h`<span class="shape-dot ${i} ${t.includes(i)?"on":""}" title=${ee(i)}></span>`)}</span>`}static{this.FILTER_FROM_ROWS=8}recordPreview(t){let i=this.recordPreviews.get(t.id);if(i&&i.revision===t.revision)return i;try{let a=yn(t.document),r={revision:t.revision,config:a,entities:[...Qi(a).entities.values()]};return this.recordPreviews.set(t.id,r),r}catch{this.recordPreviews.delete(t.id);return}}renderRowArt(t){let i=this.recordPreview(t);if(!i)return h`<span class="pk-art"></span>`;let a=i.config,o=(this.pickerFilter!=="all"&&a.supportedFamilies.includes(this.pickerFilter)?this.pickerFilter:void 0)??ao(a)??"inline",s=new Map;for(let c of i.entities){let u=this.entityStateFor(c.entityId,c.iconName??"",!1);u&&s.set(c.entityId,u)}let l=ea(a,{entityStates:s,templateResults:new Map,namedValues:a.values});if(o==="inline")return h`<span class="pk-art inline">${this.renderInlinePreview(l.inline,!0)}</span>`;let d=l[o];return d?h`<span class="pk-art ${o}">${oa(d,{icons:this.icons,imageSizes:this.imageSizes,slot:$n.slots[o]})}</span>`:h`<span class="pk-art"></span>`}renderPickerFilter(t){let i=r=>r.kind==="record"?Xo(r.record):r.families,a=(r,o,s)=>h`<button
    ...
    </div>`}renderPicker(){let t=this.draft,i=this.records.find(d=>d.id===this.selectedId),a=t?t.config.name.trim()||"Untitled":"No complication",r=t?t.config.supportedFamilies:[],o=this.pickerRows(),s=this.pickerFilter,l=s==="all"?o:o.filter(d=>(d.kind==="record"?Xo(d.record):d.families).includes(s));return h`<div class="picker">
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=nu(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?jo(i,this.hass.states):[],r=qo({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${ro.length} kinds · ${Si.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${ro.map(s=>h`<button class="add" style=${`--k:${ze[s]}`} ?disabled=${i} title=${`Add a blank ${Sn[s].toLowerCase()} layer`}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="right">
          <span class="badges">
            ${v?h`<span class="badge tap" title=${`Tappable \xB7 ${Ae(v,d)}`}>tap</span>`:f}
          ...
          ${i?h`<span class="acts">
            ...
            <button class="icon" title=${`${R.isHidden?"Show":"Hide"} (${Zo}${Lt}H)`} aria-label=${R.isHidden?"Show this layer":"Hide this layer"} @click=${B=>{B.stopPropagation(),this.mutate(K=>Te(K,a,W,{isHidden:!R.isHidden}))}}>${D(R.isHidden?"hide":"show")}</button>
      ...
      </div>`},N=(T,V)=>{let Z=this.inspect.kind==="group"&&this.inspect.id===T.id,W=!this.collapsed.has(T.id),ge=this.rowDrag(T.id,i),R=V[0],b=V[V.length-1],v=E=>{let z=E.currentTarget,B=z.getBoundingClientRect(),K=B.top+(z.classList.contains("drop-before")?mt:0),xe=B.bottom-(z.classList.contains("drop-after")?mt:0),_t=(E.clientY-K)/Math.max(1,xe-K);return _t<.25?"drop-before":!W&&_t>.75?"drop-after":"drop-into"},M=V.map(E=>E.payload.id);return h`<div class="layer group ${Z?"hl":""} ${C?"rich":""}" style=${`--k:${X.group}`} tabindex="0" draggable=${ge.draggable}
        ...
        @drop=${E=>{E.preventDefault();let z=v(E);this.clearDragMarks();let B=this.dragId;if(this.dragId=void 0,!(!B||!R||!b)){if(z==="drop-before"){this.reorderLayer(B,R.payload.id,!0,!0);return}if(z==="drop-after"){this.reorderLayer(B,b.payload.id,!1,!0);return}this.isGroupId(B)||(this.reorderLayer(B,R.payload.id,!0),this.mutate(K=>Rr(K,B,T.id)))}}}>
        ...
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Zo}${Lt}G)`} aria-label="Ungroup" @click=${E=>{E.stopPropagation(),this.mutate(z=>si(z,T.id)),Z&&(this.inspect={kind:"general"})}}>${D("ungroup")}</button>
          </span>`:f}
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${ve(a,"complication","Complication",Sc(a),{color:X.complication,icon:"watch",alwaysOpen:!0})}
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([Gg(r)]):new Set(Po)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ce(r),s=new ut(this.buildContext(),this.draft?.config),l=Rc(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)Te(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let x=g.elements.find($=>$.payload.id===y.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
