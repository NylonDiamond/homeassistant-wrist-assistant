...
`)}function Ns(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,fu(r));return{values:t,nullKeys:i}}function fu(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function pr(e){let n=Ii(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function gu(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(La(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var yu=10800;function bu(e,n,t){let i=n==="always"||n==="auto"&&t<=yu;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Os(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=bu(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function vu(e,n){return vt(e)===void 0?[]:Os(Be(e)*60,Ba(e.timeLabelCount),e.hourCycle,e.minutes,n)}function wu(e,n){return vi(e)?Os(Math.round(e.historyMinutes)*60,Ba(Kn(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Bt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function nt(e){let n=e.trim(),t=Bt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Bt(i)}function xu(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ku(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function $u(e){let n=e.trim(),t=Bt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Bt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Bt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Cu(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Su(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Eu(e,n,t){if(Ue(n))return e;let i=n,a=e,r=Bt(e.trim()),o=i.duration?$u(e):void 0;if(o!==void 0)a=Cu(o);else if(i.relativeTime&&r!==void 0)a=ku(r);else{let s=nt(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):xu(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Su(a);break}return a}function pn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Xn(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function zs(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Tu(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Zn(e,n=bt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Fu(i.slice(a+1))})}return t}function Fu(e){try{return decodeURIComponent(e)}catch{return e}}function Mu(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let u=t(o.state),c=i[i.length-1];c!==void 0&&c.colorHex===u?c.end=d:i.push({start:s,end:d,colorHex:u})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Ps(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Iu(e,n,t){if(e===void 0)return 0;let i=nt(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var it=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=zs(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=_t(n),i=Nt(n),a;t!==void 0?a=this.ctx.historySeries?.get(t)??"":i!==void 0?a=this.ctx.historySeries?.get(i)??"":a=this.resolve(n.value)??"";let r=Xn(a);return n.limit>0&&r.length>n.limit?n.takeFromEnd?r.slice(r.length-n.limit):r.slice(0,n.limit):r}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=nt(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let u=t.get(s);if(!u)return{min:0,max:1};let c=u.scaleFrom,h=c!==void 0&&c!==s&&t.has(c)&&!l.has(c)?o(c,new Set([...l,c])):zs(a.get(s)??[],u);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),u={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},c=this.chartEntity(l);c&&(u.entity=c),this.charts.set(s,u)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ue(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?gu(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Qo(r):La(r,a.domainMax-a.domainMin));break}default:{let a=ur(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Eu(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Bt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?pn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=nt(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:nt(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),u=d===void 0?void 0:nt(d);if(a===void 0||l===void 0||u===void 0)return!1;let[c,h]=l<=u?[l,u]:[u,l];return a>=c&&a<=h}case"timeBetween":{let l=Ot(i),d=r(),u=this.resolve(t.upper),c=d===void 0?void 0:Ot(d),h=u===void 0?void 0:Ot(u);return l===void 0||c===void 0||h===void 0||c===h?!1:c<h?l>=c&&l<h:l>=c||l<h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Fe[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,f={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return c!==void 0&&(f.countdownEnd=c),f}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",h=this.styleText(a,"icon"),f=n.payload.symbol.kind.kind==="literal",g=h===void 0&&f&&n.payload.path!==""?n.payload.path:void 0,v=h??c;g===void 0&&v.startsWith("mdi:")&&(v="questionmark.circle");let $={kind:"icon",...u,symbol:v,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&($.path=g),$}case"gauge":{let c=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(c.value),f=this.styleNumber(a,"gaugeMin")??c.minValue,g=this.styleNumber(a,"gaugeMax")??c.maxValue,v=h===void 0?void 0:nt(h),$=this.styleColor(a,"color")??c.colorSlot.baseColorHex;c.coloring==="bands"&&c.bands.length>0&&v!==void 0&&($=Aa(v,Bn(c),c.bandAboveColorHex));let S=g-f;if(c.total){let C=nt(this.resolve(c.total)??"");C!==void 0&&(S=C)}let T=Ps(S,1,gi),k={kind:"gauge",...u,fraction:Iu(h,f,g),style:c.style,lineWidth:c.lineWidth,colorHex:$,trackColorHex:c.trackColorHex,thresholdColorHex:c.thresholdColorHex,dotCount:T,filledCount:Ps(v??0,0,T)};if(c.thresholdValue!==void 0&&g!==f){let C=(c.thresholdValue-f)/(g-f);C>=0&&C<=1&&(k.thresholdFraction=C)}return k}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),f=h.values,g={min:h.domainMin,max:h.domainMax},v=this.styleColor(a,"color")??c.colorSlot.baseColorHex,$=Bn(c),S=Zo(c)?f.map(N=>Aa(N,$,c.bandAboveColorHex)):[],T={kind:"chart",...u,values:f,style:c.style,domainMin:g.min,domainMax:g.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:v,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:S,fillBands:c.fillBands,thresholdColorHex:c.thresholdColorHex,nowColorHex:c.nowColorHex,labels:wu(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove};if(f.length>0){let N=c.highlight==="highest"||c.highlight==="both",D=c.highlight==="lowest"||c.highlight==="both",V=N?f.indexOf(Math.max(...f)):-1,ie=D?f.indexOf(Math.min(...f)):-1;V>=0&&(T.highIndex=V),ie>=0&&ie!==V&&(T.lowIndex=ie)}let k=Tu(c,g.min,g.max);k!==void 0&&(T.thresholdY=k);let C=this.chartNowIndex(c,f.length);return C!==void 0&&(T.nowIndex=C),T}case"timeline":{let c=n.payload,h=vt(c),f=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=Zn(f,bt),v=Mu(g,Be(c)*60,S=>rs(S,c.bands,c.otherColorHex));return{kind:"timeline",...u,runs:v,gap:c.gap,cornerRadius:c.cornerRadius,labels:vu(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove}}case"shape":{let c={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};Je(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=vs(n,t).map(v=>this.resolveElement(v,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=l??u??this.resolve(a?.bezelText);c!==void 0&&(s.bezelText=c),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let v=a.bezelGauge,$=this.resolve(v.value),S=$===void 0?void 0:nt($);if(S!==void 0){let T=Math.min(v.minValue,v.maxValue),k=Math.max(v.minValue,v.maxValue),C={value:Math.min(k,Math.max(T,S)),minValue:T,maxValue:k===T?T+1:k,colorHexes:v.colorHexes},N=this.resolve(v.minLabel);N!==void 0&&(C.minLabel=N);let D=this.resolve(v.maxLabel);D!==void 0&&(C.maxLabel=D),s.bezelGauge=C}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(s.backgroundColorHex=f);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Ru(e,n,t){let i=new it(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Ri(e,n,t){let i=new it(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Ru(e.inline,n,e)),a}var we=he,ei=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:we,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],hn=ei.find(e=>e.measured);function qs(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return ei.find(a=>a.screen.width===t&&a.screen.height===i)}function Hi(e,n){let t=we[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Au={regular:400,medium:500,semibold:600,bold:700},Lu=1.15;function Ke(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ve(e,n,t="#FFFFFF"){let i=Ke(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Ys(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Li=e=>e*.55;function Hu(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function _u(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Nu(e,n,t){if(t<=0||e.length*Li(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/Li(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function zu(e,n){let t=ve(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:pn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?_u(e.text,n.w/Li(e.fontSize)):[e.text],a=Math.max(...i.map(h=>h.length))*Li(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(h=>Nu(h,o,n.w)),{anchor:l,x:d}=Hu(e.alignment,n),u=o*1.15,c=s.length>1?b`${s.map((h,f)=>b`<tspan x=${d} y=${n.cy+(f-(s.length-1)/2)*u}>${h}</tspan>`)}`:s[0];return b`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    ...
    <g transform="rotate(${u} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?m:Ou(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function Ou(e,n,t,i,a){let r=ve(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return b`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var Du=5;function Vu(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:Du,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,u=Math.max(n.h-r-o*2,1),c=d+u,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),f=e.baseline==="lowest",g=f?u*.12:0,v=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-v*(i-1))/i,.5),S=k=>Math.min(1,Math.max(0,(k-e.domainMin)/h)),T=k=>c-S(k)*u;return{count:t.length,barWidth:$,plotTop:d,plotBottom:c,plotLeft:s,plotRight:s+l,baselineY:f?c:T(0),yAtFraction(k){return c-Math.min(Math.max(k,0),1)*u},barRect(k){let C=s+k*($+v),N=t[k],D,V;if(f){let ie=g+S(N)*(u-g);D=c-ie,V=c}else D=T(N),V=f?c:T(0),D>V&&([D,V]=[V,D]);return{x:C,y:D,w:$,h:Math.max(V-D,.5)}},point(k){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*k/(t.length-1):s+l/2,y:T(t[k])}},markerCenter(k,C){let N=C?this.barRect(k):void 0;return{x:N?N.x+N.w/2:this.point(k).x,y:n.y+r/2}}}}function Bu(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Js(e,n),o=r?Xs(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?m:b`${o}`;let s=Uu(e,a);return o===void 0?s:b`${s}${o}`}function Uu(e,n){let t=Vu(e,n),i=ve(e.colorHex,"fill"),a=ve(e.highColorHex,"fill",e.colorHex),r=ve(e.lowColorHex,"fill",e.colorHex),o=(u,c)=>b`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${c.fill} fill-opacity=${c["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?ve(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let c=t.barRect(u),h=u===e.highIndex?a:u===e.lowIndex?r:d(u),f=Math.min(1.2,c.w/2,c.h/2);s.push(b`<rect x=${c.x} y=${c.y} width=${c.w} height=${c.h} rx=${f}
      ...
      fill=${v.fill} fill-opacity=${v["fill-opacity"]} />`});return r?b`${s}${Xs(e,n,t,i)}`:b`${s}`}function Ku(e,n){let t=ve(e.fillColorHex,"fill"),i=e.borderColorHex?Ke(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return b`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Wu(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ve(e.colorHex,"fill"),s=e.size*Lu;return b`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var vr=.25,ju=8;function qu(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,vr),ju),u=Math.max(e/t,n/i),c=Math.min(e/t,n/i),h=(a==="fit"?c:u)*d,f=t*h,g=i*h,v=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),$=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(f-e)/2*(1+v)+0,y:-(g-n)/2*(1+$)+0,width:f,height:g}}function _i(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Ai=4;function Ni(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Ai:n.x+n.w-Ai-a,d=e.timestampCorner.startsWith("top")?n.y+Ai:n.y+n.h-Ai-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,u,c)=>c>=u?d+(u-c)/2:Math.min(d+u-c,Math.max(d,l-c/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Yu(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Ju(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Ni(e,n,_i(new Date)):void 0,s=o?b`
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Yu(e.source,e.entityId),14,"#FFFFFF99")??m}</g>`;return b`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${c}${s}</g>${d}`}function Xu(e,n,t,i,a){if(!i)return m;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Zu(a,n):void 0;return b`
    ...
    ${o!==void 0?b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${fr} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??m}</g>`:m}`}var fr=5;function Zu(e,n){let t=fr*.55,i=n.w-2;if(n.h<fr*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function gr(e,n,t){if(e.isHidden&&!t.showHidden)return m;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return m;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return m;let l=Ys(e,n),d=i&&(!s||o),u;switch(e.kind){case"text":u=zu(e,l);break;case"icon":u=Wu(e,l,t.icons);break;case"gauge":u=Pu(e,l);break;case"chart":u=Bu(e,l);break;case"timeline":u=Gu(e,l);break;case"shape":u=Ku(e,l);break;case"image":u=Ju(e,l,t);break;case"tap":u=Xu(e,l,t.icons,a,d?Xe(e.action):void 0);break}let c=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*c,f=t.highlightId===e.id,g=f||t.highlightIds?.includes(e.id)===!0,v=t.handles===!0&&(!s||o),$=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:m,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${T}${u}${S}${$}${C}</g>`}function zi(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function wr(e,n){return(n?23.5:34)*e}var Ds=10.5;function Zs(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Vs(e,n){let t=0;for(let i of e)t+=Zs(i,n);return t}function Bs(e,n,t){let i=e.toUpperCase(),a=d=>Zs(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function yr(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function br(e,n,t,i){let a=yr(e,n,t),r=yr(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Qs(e,n,t,i){let{dial:a}=zi(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:br(a,t,i.start,i.end),length:t*r}}function Qu(e,n){let t=zi(e,!0);return Qs(e,n,t.dial.r,t.labelArc)}var Us=18.5,ep=113,tp={start:-71,end:-36},Gs=104,np=6.2,Ks={start:-77,end:-30.5};function Ws(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function js(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Ws(e[i]),o=Ws(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var mr=11;function ip(e,n,t){let{dial:i}=zi(n,!0),a=Gs*n,r=180/(Math.PI*Gs),o=e.minLabel!==void 0?Vs(e.minLabel,mr)*r:0,s=e.maxLabel!==void 0?Vs(e.maxLabel,mr)*r:0,l=Ks.start+(o>0?Math.max(0,o-1.8):0),d=Ks.end-(s>0?Math.max(0,s-1.8):0),u=d-l,c=24,h=[];for(let S=0;S<c;S++){let T=l+u*S/c,k=Math.min(d,l+u*(S+1)/c+.4);h.push(b`<path d=${br(i,a,T,k)} fill="none"
      stroke=${js(e.colorHexes,(S+.5)/c)} stroke-width=${np*n}
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${js(e.colorHexes,f)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?$(`${t}-gmin`,l-v-Math.max(o,3),l-v,e.minLabel):m}
    ${e.maxLabel!==void 0?$(`${t}-gmax`,d+v,d+v+Math.max(s,3),e.maxLabel):m}`}function Pi(e,n){let t=e.family in we?e.family:"rectangular",i=n.slot??we[t],a=we[t],r=Hi(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ke(e.backgroundColorHex),l=Ke(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,v=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",T=zi(g,v),k=wr(g,v),C=k/(a.width*g),N=T.tile.cx-k/2,D=T.tile.cy-k/2,V=`M 0 0 H ${T.quad.width-T.cornerRadius} A ${T.cornerRadius} ${T.cornerRadius} 0 0 1 ${T.quad.width} ${T.cornerRadius} V ${T.quad.height} H 0 Z`,ie=m;if(e.bezelGauge)ie=ip(e.bezelGauge,g,o);else if(e.bezelText){let A=Qu(g,`${o}-bezel`),G=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?pn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;ie=b`<defs><path id=${A.id} d=${A.d} /></defs>
        <text font-size=${Ds*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${A.id}" startOffset="50%" text-anchor="middle">${Bs(G,A.length,Ds*g)}</textPath></text>`}let w=m;if(S){let A=Ke(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},G=Qs(g,`${o}-curved`,ep*g,tp);w=b`<defs><path id=${G.id} d=${G.d} /></defs>
        <text font-size=${Us*g} font-weight="600" fill=${A.color} fill-opacity=${A.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${G.id}" startOffset="50%" text-anchor="middle">${Bs($,G.length,Us*g*.88)}</textPath></text>`}else{let A=e.borderWidth*r.scale*C,G=l?b`<circle cx=${k/2} cy=${k/2} r=${k/2-A/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${A} />`:m;w=b`<g transform="translate(${N} ${D})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${wp(e)}</svg>`}var We="color-mix(in srgb, var(--k) 45%, #6b7280)",qi='system-ui, -apple-system, "Segoe UI", sans-serif';function El(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=u=>{let c=u*Math.PI/180;return{x:(e-t*Math.cos(c)).toFixed(2),y:(n-t*Math.sin(c)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Rr(e,n,t,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${El(e,n,t,1)} stroke=${We} stroke-width="2.6" opacity=".5" />
    <path d=${El(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function xp(e){switch(e){case"text":return b`<g font-family=${qi} text-anchor="middle">
    ...
    </div></div>`}function Rp(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function sa(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Ap(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Dl(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var cd=50;function Lp(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Hp(e,n,t=cd,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),u=l.name.toLowerCase(),c=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:u.startsWith(a)?h=2:d.includes(a)?h=3:u.includes(a)?h=4:o.length>1&&o.every(f=>d.includes(f)||u.includes(f))?h=5:c!==""&&(c.includes(a)||o.length>1&&o.every(f=>d.includes(f)||u.includes(f)||c.includes(f)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var _p=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function ud(e){return _p.test(e.trim())}function Np(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return sa(t,i);if(ud(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Wt=new Map;function He(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Gr(e){return Wt.has(e)}function je(e,n,t,i,a,r={}){let o=e.hass.states,s=Wt.get(a),l=s?Hp(Ap(o,r.domain,Dl(e.hass)),s.query,cd,r.preferNumeric?Lp:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,u=t.entityId?o[t.entityId]:void 0,c=(k,C,N=0)=>{Wt.set(a,{query:C,index:N}),He(k)},h=k=>{Wt.delete(a),He(k)},f=k=>{let C=Np(k,t,o);C&&i(C)},g=(k,C)=>{i(sa(o,k.entityId)),h(C)},v=()=>Math.max(0,Math.min(Wt.get(a)?.index??0,l.length-1)),$=k=>{let C=k.target;if(k.key==="ArrowDown"||k.key==="ArrowUp"){k.preventDefault();let N=Wt.get(a);if(!N){c(C,C.value);return}let D=k.key==="ArrowDown"?v()+1:v()-1;c(C,N.query,Math.max(0,Math.min(l.length-1,D))),zp(C);return}if(k.key==="Enter"){k.preventDefault();let N=l[v()];s&&N?g(N,C):(f(C.value),h(C));return}if(k.key==="Escape"){if(!s)return;k.preventDefault(),k.stopPropagation(),h(C)}},S=t.entityId?Dl(e.hass)?.(t.entityId):void 0,T=t.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:u?p`<div class="entity-current">
    ...
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${ud(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${Ol(k.domain)}</span>
                  <span class="ent-state">${k.state}</span>
                </span>
              </button>`)}
        </div>`:T}
  </div>`}function zp(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Vl=120;function Pp(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Gi.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Ki),fromPack:!1}}function Bl(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Op(e){return[{value:"",label:`Starter set (${Bl(Ki,e)})`},...Gi.map(n=>({value:n.name,label:`${n.name} (${Bl(n.symbols,e)})`}))]}function Dp(e){return e.length>0?e.length:Ki.length}function Ul(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Xi(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return p`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function pd(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],u=new Set(d),c=n.trim(),h=c.startsWith(ke),f=a!==void 0,g=f?r.pack(i)??(h?"mdi":"sf"):"sf",v=Vp(c,u),$=k=>{t(k),a?.(k.startsWith(ke)?e.icons.mdiPath?.(k):void 0),r.noteUsed(k)},S=k=>{if(t(k),!f)return;let C=k.trim();a?.(C.startsWith(ke)?e.icons.mdiPath?.(C):void 0)},T=m;if(o&&g==="mdi"){let k=e.icons.mdiNames?.(),C=Bp(k??[],s),N=C.slice(0,Vl),D=r.recent.filter(V=>V.startsWith(ke));T=p`<div class="sym-browse">
      ${Gl(r,i,g)}
      ...
      ${k===void 0?p`<div class="hint">Loading the Material Design catalogue.</div>`:C.length===0?p`<div class="hint">Nothing matches that search. Any <code>mdi:</code> name can still be typed above.</div>`:p`<div class="hint">${Ul(N.length,C.length,!0,k.length)}</div>`}
    ...
    </div>`}else if(o){let k=r.category(i),C=Pp(k,s,d,u),N=Sr(C.names,s),D=C.fromPack?N.slice(0,Vl):N,V=r.recent.filter(w=>!w.startsWith(ke)),ie=u.size===0?V:V.filter(w=>u.has(w));T=p`<div class="sym-browse">
      ${f?Gl(r,i,g):m}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${fe(w=>r.setQuery(i,w))} />
        <select @change=${fe(w=>r.setCategory(i,w))}>
          ${Op(u).map(w=>p`<option value=${w.value} ?selected=${w.value===k}>${w.label}</option>`)}
        </select>
      </div>
      ...
      ${N.length===0?p`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:p`<div class="hint">
            ${Ul(D.length,N.length,s.trim()!=="",Dp(d))}
          </div>`}
    ...
    ${T}`}function Vp(e,n){let t=e.trim();return t!==""&&!t.startsWith(ke)&&n.size>0&&!n.has(t)}function Bp(e,n){let t=n.trim(),i=t.startsWith(ke)?t.slice(ke.length):t,a=e.map(r=>r.startsWith(ke)?r.slice(ke.length):r);return Sr(a,i).map(r=>ke+r)}function Gl(e,n,t){return p`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Up=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],Gp=[["bars","Bars"],["line","Line"],["area","Area"]],Kp=[["auto","Auto"],["fixed","Fixed range"]],Wp=[["lowest","Lowest value"],["zero","Zero"]],hd=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],jp=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],Kl=[["uniform","One colour"],["bands","By value"]];function Wl(e){let n=[Ra,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function qp(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Yp(e,n){let t=Bn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function jl(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    ${md(e,a,r,n,t,i)}
  </div>`}function md(e,n,t,i,a,r){return p`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${fd}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${ai.has(n)?gd(e,i,a,r):m}
  </div>`}function ye(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Kr(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function nh(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var ai=new Set,ni=new WeakMap;function ih(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function ah(e,n){let t=e instanceof Node?e:null;if(!t)return;let i=t.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(n)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function fd(e){let n=e.currentTarget,t=e.newState==="open",i=ni.get(n);if(i&&(i(),ni.delete(n)),!t){ai.delete(n.id)&&He(n);return}let a=ih(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ni.get(n)?.(),ni.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}Pr(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ni.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Pr(n,a.getBoundingClientRect()),ai.has(n.id)||(ai.add(n.id),He(n),requestAnimationFrame(()=>{n.isConnected&&Pr(n,a.getBoundingClientRect())}))}function Pr(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=rh({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Kt=8,Zi=6,Yl=140;function rh(e,n,t){let i=t.height-e.bottom-Zi-Kt,a=e.top-Zi-Kt,r=n.height>i&&a>i&&i<Yl,o=Math.max(Yl,r?a:i),s=Math.min(n.height,o),l=Math.max(Kt,Math.min(e.left,t.width-n.width-Kt)),d=r?Math.max(Kt,e.top-Zi-s):Math.max(Kt,Math.min(e.bottom+Zi,t.height-s-Kt));return{left:l,top:d,maxHeight:o,above:r}}function gd(e,n,t,i){let a=n.kind,r=u=>t({...n,kind:u}),o=i.key,s=Up.filter(([u])=>i.allowNamed!==!1||u!=="named"),l=m;switch(a.kind){case"literal":l=i.symbol?pd(e,a.value,u=>r({...a,value:u}),o,i.setSymbolPath):pe("Text",a.value,u=>r({...a,value:u}));break;case"entityState":case"entityAge":l=je(e,"Entity",a,u=>r({...a,...u}),`${o}-entity`);break;case"entityAttribute":{let u=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),c=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=p`${je(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${pe("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:c,mono:!0})}
        <datalist id=${c}>${u.map(h=>p`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=sh(e,a.aggregate,u=>r({...a,aggregate:u}),o);break;case"time":l=Ie("Field",a.timeField,eh,u=>r({...a,timeField:u}));break;case"dataAge":l=p`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=p`${dd("Template",a.value,u=>r({...a,value:u}),4)}
    ...
    ${Ie("Source",a.kind,s,u=>r(th(a,u)))}
    ${l}
    ${i.noFormat?m:oh(n.format,u=>t(Ue(u)?{kind:n.kind}:{...n,format:u}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:m}`}function oh(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return p`<details class="sub" ?open=${!Ue(e)}>
  ...
  </details>`}function sh(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return p`
    ...
    ${n.function==="count"?m:pe("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var yd=qa,lh=yd.filter(([e])=>e!=="none");function dh(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function bd(e,n){let t=dh(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return ss(e)?{type:e,...t}:{type:e}}var ch=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function vd(e,n,t,i){let a=n.serviceDataJSON??"",r=ls(a),o=n.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
    ...
    ${dd("Data (JSON)",a,s=>{let l={...n};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,t(l,"svc-data")},3)}
    ${r?p`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:p`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function uh(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function wd(e){let n=e.config,t=n.tapAction,i=uh(e.savedName,n.name),a=n.refreshMinutes??0,r=Jl.map(s=>[String(s),Xl(s)]);Jl.includes(a)||r.push([String(a),Xl(a)]);let o=n.showSuccessFlash??!0;return p`
    <div class="gen-row">
      ${pe("Name",n.name,s=>e.update(l=>{l.name=s},"name"))}
      ${Ie("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${Ie("Tap action",t.type,yd,s=>e.update(l=>{l.tapAction=bd(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??ph).slice(0,7)}
    ...
    ${t.type==="callService"?vd(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):m}
    ${t.type==="openPage"?hh(e):m}`}var ph="#808080",Jl=[0,15,30,60,120];function Xl(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function hh(e){let n=e.config;return xd(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function xd(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Ie("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?m:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function kd(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return p`
    ...
    ${t?p`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:m}`}function aa(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>aa(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>aa(e[a],n[a]))}function ed(e,n,t){return t.some(i=>!aa(e[i],n[i]))}function td(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Se(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=()=>e.toggleSection(n),l=p`<span class="swatch">${_(a.icon??"content")}</span>
      <span class="tt"><h4>${t}${ld(a.reset===void 0?void 0:{atDefault:!1,title:a.resetTitle??`Put ${t} back to its defaults`,reset:a.reset})}</h4>${a.summary?p`<span class="sum">${a.summary}</span>`:m}</span>`;return p`<section class="sec ${a.cardClass??""}" data-open=${o?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
  ...
  </section>`}function Ch(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Sh(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Eh(e,n){let t=he[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Th(e,n,t){let i=Eh(e,n),a=he[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return p`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    ${e.timeLabelCount<=0?m:p`
      ...
      ${Z("Clock",e.hourCycle,ns,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${Z("Minutes",e.minutes,is,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}function Ed(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,x)=>e.update(z=>y(z.elements[r]),x?`${o}-${x}`:void 0),l=Ee(e.config,t,n),d=l.frame,u=(y,x)=>e.update(z=>xe(z,t,a,{frame:Ar(d,y)}),`${o}-${x}-${t}`),c=Ve(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",f=y=>c[y],g,v;switch(n.kind){case"text":{let y=Ya(e.config,n.payload.value);g=p`
        ...
        ${n.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,v=p`<div class="grid2">
          ...
          ${Z("Align",n.payload.alignment??"center",gh,x=>s(z=>{let P=z.payload;x==="center"?delete P.alignment:P.alignment=x}),{def:"center"})}
          ${Z("Lines",n.payload.lineLimit===2?"2":"1",yh,x=>s(z=>{let P=z.payload;x==="2"?P.lineLimit=2:delete P.lineLimit}),{def:"1"})}
        </div>
        ...
        <div class="grid2">
          ${Z("Style",y.style,Zp,P=>x(B=>{P==="dots"&&B.total===void 0&&(B.total=ql(B)),P!=="dots"&&delete B.total,B.style=P}),{titles:Qp,def:c.style})}
        ...
        ${Z("Colour",y.coloring,Kl,P=>x(B=>{B.coloring=P,P==="bands"&&B.bands.length===0&&(B.bands=Wl([B.minValue,B.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${jl(y,y.colorSlot.baseColorHex,x)}`:m}
        ${z?m:p`
          <div class="grid2">
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,x=(E,H)=>s(Jt=>E(Jt.payload),H),z=c.historyMinutes,P=c.historyPoints,B=y.historyMinutes>0,U=B&&y.source==="statistics",j=B&&!U,Y=B?U?"statistics":"history":"value",Ae=U?Un:Ht,lt=_t(y)??Nt(y),be=y.value.kind.kind==="entityState",re=lt===void 0?void 0:e.historySeries(lt),Te=B&&be?re??"":e.resolve(y.value)??"",_e=y.historyPoints<1,so=Vr(a,y.historyMinutes,Ae),Oe=Xn(Te),Tt=y.limit>0&&Oe.length>y.limit?y.takeFromEnd?Oe.slice(Oe.length-y.limit):Oe.slice(0,y.limit):Oe,pc=!B&&be&&Oe.length===1,ua=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),hc=ye(e),pa=y.scaleFrom!==void 0&&ua.some(E=>E.payload.id===y.scaleFrom);g=p`
        ${ae(e,y.value,E=>x(H=>{H.value=E},"value"),{label:"Readings",key:`${o}-value`})}
        ${Z("Draw",Y,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>x(H=>{if(E==="value"){H.historyMinutes=0;return}H.source=E==="statistics"?"statistics":"history";let Jt=H.historyMinutes||yi;H.historyMinutes=E==="statistics"?Math.min(Jt,Ha):Math.min(Jt,bi)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${U?p`
            ...
            <div class="grid2">
              ${Or(a,y.historyMinutes,z,E=>x(H=>{H.historyMinutes=E}),Un)}
              ${Z("Per",y.statPeriod,fi,E=>x(H=>{H.statPeriod=E}),{def:Pn})}
            </div>
            ${so?Dr(y.historyMinutes,E=>x(H=>{H.historyMinutes=E},"span"),!0):m}
            ${Z("Read",y.statType,Ma,E=>x(H=>{H.statType=E}),{def:On})}
        ...
        ${j?p`
            ${be?m:p`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Or(a,y.historyMinutes,z,E=>x(H=>{H.historyMinutes=E}))}
            ...
            ${so?Dr(y.historyMinutes,E=>x(H=>{H.historyMinutes=E},"span")):m}
        ...
        ${Oe.length>0?p`<div class="hint">Reads <span class="nums">${Ch(Tt)}</span>${Oe.length===Tt.length?p` · ${Tt.length} ${Tt.length===1?"value":"values"}`:p` · ${Tt.length} of ${Oe.length}`}</div>`:m}
        ${pc?p`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        <div class="grid2">
          ${Z("Style",y.style,Gp,E=>x(H=>{H.style=E}),{def:c.style})}
          ${y.style==="bars"?ne("Bar gap (pt)",y.barGap,E=>x(H=>{H.barGap=Math.max(0,E??0)},"gap"),{step:.5,min:0,def:c.barGap}):Qi(e,n,t,"Line width",{step:.5,min:.5,def:f("lineWidth")})}
        </div>
        <div class="grid2">
          ${Z("Scale",y.scale,Kp,E=>x(H=>{H.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${Z("Baseline",y.baseline,Wp,E=>x(H=>{H.baseline=E}),{def:c.baseline})}
        </div>
        ${ua.length===0?m:Ie("Same scale as",pa?y.scaleFrom:"",[["","Its own"],...ua.map(E=>[E.payload.id,Re(E,hc)])],E=>x(H=>{E?H.scaleFrom=E:delete H.scaleFrom}),{def:""})}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let E;e.update(H=>{E=Cs(H,a)}),E&&e.selectLayer(E)}}>
          ${_("plus")}<span>Second series</span></button>
        ${Z("Colour",y.coloring,Kl,E=>x(H=>{H.coloring=E,E==="bands"&&H.bands.length===0&&(H.bands=Wl(Tt))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${jl(y,y.colorSlot.baseColorHex,x)}
          ${y.style==="area"?p`${Ce("Fill follows the bands",y.fillBands,E=>x(H=>{H.fillBands=E}),c.fillBands)}
        ...
        <div class="grid2">
          ${Z("Highlight",y.highlight,hd,E=>x(H=>{H.highlight=E}),{def:c.highlight})}
          ${y.highlight==="none"?m:Z("Marker",y.marker,jp,E=>x(H=>{H.marker=E}),{def:c.marker})}
        </div>
        ...
        ${Ce("Threshold line",y.thresholdValue!==void 0,E=>x(H=>{E?H.thresholdValue=qp(Tt):delete H.thresholdValue}))}
        ...
        ${Ce("\u201CNow\u201D marker",y.nowIndex!==void 0,E=>x(H=>{E?H.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete H.nowIndex}))}
        ...
        ${Y.length>0?p`<div class="hint">Reads <span class="nums">${Mh(Y,j)}</span></div>`:m}
        ${Fh(Y)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${Xp(y,x,be,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${n.payload.kind==="line"?Th(t,d,u):m}`,v=n.payload.kind==="line"?ne("Thickness (pt)",n.payload.thickness,y=>s(x=>{x.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let $=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:se(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>s(x=>{x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&(x.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,h),S=er(e.config,n),T=S?{kind:{kind:"entityState",...S}}:void 0,k=me[n.kind],C=n.kind==="image"?n.payload.timestamp===!0:!1,N=Ah[n.kind],D=Lh[n.kind],V=ed(n.payload,c,N),ie=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[t]?.placements[a]?.size!==void 0,A=ed(n.payload,c,D)||ie!==void 0&&l.size!==void 0&&l.size!==c[ie],G=zt(e.config,a),O=(y,x)=>()=>s(z=>td(z.payload,c,y),x);return p`
    ${Se(e,"content","Content",p`${n.kind==="tap"?m:bh(e,n,o)}${g}`,{color:k,icon:"content",summary:jr(e,n),...V?{reset:O(N,"reset-content")}:{}})}
    ${v===void 0&&$===void 0?m:Se(e,"look",n.kind==="image"?"Picture":"Look",p`${v??m}${$??m}`,{color:k,icon:n.kind==="image"?"image":"look",...ra(n)?{summary:ra(n)}:{},...A?{reset:()=>e.update(y=>{td(y.elements[r].payload,c,D),w&&xe(y,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Numbers",zh(e,n),{color:me.text,icon:"text",summary:Nh(e,n),...G.length>0?{reset:()=>e.update(y=>{for(let x of zt(y,a))tt(y,x.payload.id)})}:{}}):m}
    ${n.kind==="image"?Se(e,"timestamp","Timestamp",$h(n.payload,(y,x)=>s(z=>y(z.payload),x)),{color:k,icon:"clock",summary:C?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...C?{reset:O(Rh,"reset-stamp")}:{}}):m}
    ${i.tap===!1?m:Yr(e,n)}
    ${Se(e,"states","States",Hd(e,n.payload.rules,n.kind,y=>y.elements.find(x=>x.payload.id===a)?.payload.rules,`rules-${a}`,T),{color:ee.states,icon:"states",summary:ti(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(y=>{y.payload.rules=[]})}:{}})}
    ${i.placement===!1?m:qr(e,n,t)}`}var Rh=["timestamp","timestampCorner","timestampSize"],Ah={text:["value","countdown"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Lh={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function Td(e,n,t,i){let a=n.action;return p`
    ${Ie("Tap action",a.type,lh,r=>t(o=>{o.action=bd(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?je(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):m}
    ${a.type==="callService"?vd(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):m}
    ${a.type==="openPage"?xd(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):m}`}var Hh=24;function _h(e,n){let t=[],i=1/0;for(let r of te){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=ks(e.config,n,r);o&&(t.push(`${X(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return m;let a=i<Hh;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Nh(e,n){let t=zt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(en.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function zh(e,n){let t=ye(e),i=zt(e.config,n.payload.id),a=o=>e.update(s=>{gs(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    ${a?p`<div class="value-editor">
        ...
        ${_h(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${Xe(o)}</b>.</div>`}`}function id(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Re(e,n){switch(e.kind){case"text":return id(ge(e.payload.value,n));case"icon":return id(ge(e.payload.symbol,n));case"gauge":return ge(e.payload.value,n);case"chart":return ge(e.payload.value,n);case"timeline":return ge(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function Fd(e,n){let t=Qe(e.config,n.id),i=ye(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Se(e,"content","Group",p`
    ...
    </div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Md(e,n){if(n==="inline")return Oh(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${X(n)} yet.</div>
    ...
    ${Se(e,"symbol","Symbol",p`
      ${pd(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:me.icon,icon:"icon",summary:n.symbol||"None"})}`}function Dh(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ...
    ${a==="gauge"&&n.bezelGauge?Vh(e,n.bezelGauge,t):m}`}function Vh(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${n.maxLabel?ae(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):m}`}var ey=te.map(e=>[e,X(e)]),Jr={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Bh=Object.keys(Jr);function Uh(e){let n=Fi[e];return Bh.filter(t=>n.includes(Fe[t]))}var Gh={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function ea(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function kt(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Kh(e){if(!e||Ue(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function ge(e,n){return`${Id(e,n)}${Kh(e.format)}`}function Id(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${kt(t.value,40)}"`:"(empty)";case"entityState":return ea(t,n);case"entityAttribute":return t.attribute?`${ea(t,n)} \xB7 ${t.attribute}`:ea(t,n);case"entityAge":return`age of ${ea(t,n)}`;case"aggregate":return Wh(t.aggregate);case"time":return Gh[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${kt(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(en.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Id(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function Wh(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function oa(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function jh(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${n.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${t==="layout"?"family":"layer"} looks.</div>`:m}
    ${n.map((o,s)=>qh(e,o,s,n.length,t,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Jn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function qh(e,n,t,i,a,r,o){let s=e.liveBranch(n),l=e.forced.get(n.id)??"live",d=c=>l==="live"?c==="live":l==="otherwise"?c==="otherwise":l.caseId===c,u=(c,h)=>r(f=>{let g=f.find(v=>v.id===n.id);g&&c(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${n.cases.map((c,h)=>Yh(e,c,h,n,a,u,`${o}-${c.id}`))}
    ...
    ${n.otherwise?p`<div class="case-box otherwise">
          ...
          ${Rd(e,n.otherwise,a,c=>u(h=>{h.otherwise&&c(h.otherwise)}),`${o}-otherwise`)}
        </div>`:m}
  </div>`}function Yh(e,n,t,i,a,r,o){let s=(d,u)=>r(c=>{let h=c.cases.find(f=>f.id===n.id);h&&d(h)},u),l=e.liveBranch(i)===n.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
    ...
    ${Rd(e,n.then,a,d=>s(u=>d(u.then)),`${o}-then`)}
        ...
        ${s.pattern&&!Xh(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:m}`;break;case"times":u=p`<div class="row-inline">
          ${ad(e,"From",s.value??M("22:00"),c=>o(h=>{h.comparison.value=c},"rhs"),`${r}-rhs`)}
          ${ad(e,"To",s.upper??M("06:00"),c=>o(h=>{h.comparison.upper=c},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":u=Zh(n.value)?Qh(s.options??[],c=>o(h=>{h.comparison.options=_r(c)},"options")):pe("Options (comma separated)",(s.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(f=>f.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${Ie("Comparison",s.kind,Is.map(c=>[c,gn[c]]),c=>o(h=>{h.comparison=dr(h.comparison,c)}))}
    ${u}
  </div>`}function Xh(e){try{return new RegExp(e),!0}catch{return!1}}function ad(e,n,t,i,a){if(t.kind.kind!=="literal")return ae(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Ot(r)??"";return p`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${fe(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?p`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:m}</label>`}function Zh(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function Qh(e,n){let t=_l(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return p`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${Hl.map((a,r)=>p`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function Rd(e,n,t,i,a){let r=Uh(t);return p`
    ${n.length===0?p`<div class="hint">No changes.</div>`:m}
    ${n.map((o,s)=>em(e,o,s,t,(l,d)=>i(u=>{u[s]&&l(u[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Vt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${Jr[o]}</option>`)}
    </select>`}var Ad=["setColor","setBorderColor","setBackgroundColor"];function em(e,n,t,i,a,r,o){let s=!Fi[i].includes(Fe[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${Ld(e,n,a,o)}
  </div>`}function Ld(e,n,t,i){let a=Mi(n.kind),r=m;if(a==="value"){let o=n.value??M("");if(Ad.includes(n.kind)){let s=o.kind.kind==="literal";r=p`${s?se("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=M(l??"#FFFFFF")},"color")):ae(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${jh(e,n,t,i,a)}`:tm(e,o.table,n[0],t,i,a,r)}function tm(e,n,t,i,a,r,o){let s=(w,A)=>e.update(G=>{let O=a(G);O&&w(O)},A?`${r}-${A}`:void 0),l=n.value??rd.get(r)??o,d=n.rows.length===0,u=n.numberMode||d&&l!==void 0&&!Sl(l)&&nm(e.resolve(l)),c=Fi[i],h=ta.get(r)??new Set,f=n.columns.length===0&&h.size===0?[Cl[i]]:[],g=fl(n.columns,[...h,...f.filter(w=>w!==void 0)],c),v=t?e.liveBranch(t):"none",$=t?e.forced.get(t.id)??"live":"live",S=w=>$!=="live"&&($==="otherwise"?w==="otherwise":$.caseId===w),T=w=>{t&&e.setForced(t.id,S(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},k=w=>{rd.set(r,w),n.rows.length!==0&&s(A=>xl(A,w),"lhs")},C=()=>s(w=>vl(w,l??M(""),u)),N=n.rows.map((w,A)=>sd(e,{key:`${r}-${w.caseId}`,label:$l(w.comparison,G=>ge(G,ye(e))),columns:g,changes:w.changes,live:v===w.caseId,forced:S(w.caseId),onForce:()=>T(w.caseId),when:sm(e,w.comparison,`${r}-${w.caseId}`,(G,O)=>s(y=>{let x=y[0]?.cases.find(z=>z.id===w.caseId)?.when.tests[0];x&&G(x.comparison)},O&&`${w.caseId}-${O}`)),updChanges:(G,O)=>s(y=>{let x=y[0]?.cases.find(z=>z.id===w.caseId);x&&G(x.then)},O&&`${w.caseId}-${O}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${A===0} @click=${()=>s(G=>Mr(G,A,A-1))}>${_("up")}</button>
      <button class="icon" title="Move down" ?disabled=${A===n.rows.length-1} @click=${()=>s(G=>Mr(G,A,A+1))}>${_("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>s(G=>wl(G,w.caseId))}>${_("delete")}</button>`})),D=n.otherwise===void 0?m:sd(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:v==="otherwise",forced:S("otherwise"),onForce:()=>T("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,A)=>s(G=>{let O=G[0]?.otherwise;O&&w(O)},A),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>Ir(w,!1))}>${_("close")}</button>`}),V=na.get(r),ie=im.filter(w=>c.includes(w)&&!g.includes(w));return p`
    <div class="states">
          ...
          <tr>
            ...
            ${g.map(w=>p`<th>
              ...
              <button class="icon" title=${`Remove the ${at[w]} column`}
                @click=${A=>{na.set(r,w),He(A.target)}}>${_("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${V===void 0?m:p`<div class="hint warn confirm-row">
        Remove the ${at[V]} column? Its ${od(n,V)} value${od(n,V)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${w=>{na.delete(r),ta.get(r)?.delete(V),He(w.target),s(A=>kl(A,V))}}>Remove</button>
      ...
      <div class="states-foot">
        ...
        ${ie.length===0?m:p`<select class="chip-add" title="Add a column" @change=${w=>{let A=w.target,G=A.value;if(A.value="",!G)return;let O=ta.get(r)??new Set;O.add(G),ta.set(r,O),He(A)}}>
    ...
    </div>`}function nm(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var im=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function od(e,n){let t=0;for(let i of e.rows)ji(i.changes,n)&&(t+=1);return e.otherwise&&ji(e.otherwise,n)&&(t+=1),t}function am(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function sd(e,n){return p`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{am(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>p`<td>${rm(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function rm(e,n,t,i,a){let r=ji(t,n),o=Kr(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${at[n]} for this state`}
      @click=${d=>{i(u=>{u.push(Vt(ml[n]))}),ah(d.target,o)}}>unchanged</button>`;let s=(d,u)=>i(c=>{let h=c.find(f=>Fe[f.kind]===n);h&&d(h)},u&&`${n}-${u}`),l=at[n];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${om(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${fd}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${ai.has(o)?p`${n==="visibility"?Z("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(u=>{u.kind=d})):Ld(e,r,s,a)}
    ...
    </div>`}function om(e,n){if(n.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return p`<span class="cell-word">Shown</span>`;let t=Mi(n.kind);if(t==="number")return p`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return p`<span class="cell-word">${Wr.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??M(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Ad.includes(n.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?$e(a):ge(i,ye(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??m}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${ge(i,ye(e))}</span>`}function $e(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function sm(e,n,t,i){let a=Dt(n.kind),r=Tr(n.kind),o=(s,l,d,u)=>dm(e,s,l,`${t}-${d}`,r,u,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${fe(s=>i(l=>{let d=dr(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Er.map(s=>p`<option value=${s} ?selected=${s===n.kind}>${lm(s)}</option>`)}
    </select>
  ...
  </span>`}function lm(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return gn[e]}}function dm(e,n,t,i,a,r,o){let s=Kr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return p`<span class="rhs">
    ...
    ${md(e,s,o,n,t,l)}
  </span>`}var ri=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Qa,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Pd(e){return ri.find(n=>n.kind===e)??ri[0]}var _d="#FF9F0A",da="#8E8E93",cm=["#FF453A","#FFD60A","#34C759"],Od=["#0A84FF","#34C759","#FF9F0A"];function um(e){return e?.attributes?.device_class==="battery"?cm:Od}var pm={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function hm(e){let n=e.iconName?.trim();return n?{off:n,on:n}:pm[Xr(e)]??{off:"circle",on:"circle.fill"}}function mm(e){switch(Xr(e)){case"lock":return{kind:"equals",value:M("locked")};case"cover":case"valve":return{kind:"equals",value:M("open")};case"media_player":return{kind:"equals",value:M("playing")};default:return{kind:"isOn"}}}function Xr(e){return e.domain||e.entityId.split(".")[0]||""}function St(e){return{...e,domain:Xr(e)}}function fm(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function wn(e){return Math.round(e*1e4)/1e4}function qt(e,n,t){return Math.min(t,Math.max(n,e))}function Zr(e,n,t){let i=we[e],a=qt(wn(n/i.width),0,1),r=qt(wn(t/i.height),0,1);return{x:wn((1-a)/2),y:wn((1-r)/2),width:a,height:r,rotationDegrees:0}}function gm(e){let n=we[e],t=qt(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:Zr(e,t*1.3,t*1.3),size:t}}function ym(e){let n=we[e],t=qt(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:Zr(e,n.width*.88,t*1.7),size:t}}function bm(e){let n=we[e],t=Math.min(n.width,n.height)*.9;return{frame:Zr(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Dd(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function vm(e){let n=we[e],t=qt(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:wn(t/n.height),rotationDegrees:0}}}function wm(e){let n=we[e],t=qt(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:wn(qt(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function xm(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function km(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function $t(e,n,t,i){let a=i(t);n.payload.frame=a.frame,km(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=et());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function Ct(e){return Ve(e)}function Qr(e,n){let t={kind:{kind:"entityState",...St(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Nd(e){let n=Vt("setIcon");return n.value=M(e),n}function jt(e){let n=Vt("setColor");return n.value=M(e),n}function $m(e,n){let t=Jn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...St(e)}},a.comparison=mm(e);let r=n.on!==n.off;return i.then=r?[Nd(n.on),jt(_d)]:[jt(_d)],t.otherwise=r?[Nd(n.off),jt(da)]:[jt(da)],t}function Cm(e){let n=Jn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...St(e)}},i.comparison={kind:"isUnavailable"};let a=Vt("setOpacity");return a.number=.35,t.then=[a],n}function zd(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Sm(e,n,t=Od){let i=n.max-n.min,a=zd(n.min+i/3),r=zd(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:M(a)},changes:[jt(t[0])]},{comparison:{kind:"between",value:M(a),upper:M(r)},changes:[jt(t[1])]},{comparison:{kind:"greaterThan",value:M(r)},changes:[jt(t[2])]}];return gl(Qr(e),o)}function Em(e,n,t){let i=Ct("icon"),a=hm(n);return i.payload.symbol=M(a.off),i.payload.colorSlot.baseColorHex=da,i.payload.rules=[$m(n,a)],$t(e,i,t.family,gm),e.elements.push(i),Ci(e,i.payload.id,{type:"toggleEntity",...St(n)}),i.payload.id}function Tm(e,n,t){let i=Ct("text");return i.payload.value=Qr(n,t.state),i.payload.rules=[Cm(n)],$t(e,i,t.family,ym),e.elements.push(i),i.payload.id}function Fm(e,n,t){let i=Ct("gauge");i.payload.value=Qr(n);let a=fm(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Sm(n,a,um(t.state))],$t(e,i,t.family,bm),e.elements.push(i),i.payload.id}function Mm(e,n,t){let i=Ct("chart");return i.payload.value={kind:{kind:"entityState",...St(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",$t(e,i,t.family,Dd),e.elements.push(i),i.payload.id}function Im(e,n,t){let i=Ct("chart");return i.payload.value={kind:{kind:"entityState",...St(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",$t(e,i,t.family,Dd),e.elements.push(i),i.payload.id}function Rm(e,n,t){let i=St(n),a=Ct("text");a.payload.value=M(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=da,$t(e,a,t.family,wm),e.elements.push(a);let r=t.state?.attributes?.device_class,o=Ct("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Ka(i.domain,typeof r=="string"?r:void 0),$t(e,o,t.family,vm),e.elements.push(o),o.payload.id}function Am(e,n,t){let i=Ct("image");return i.payload.entity=St(n),$t(e,i,t.family,xm),e.elements.push(i),i.payload.id}function Vd(e,n,t,i){switch(n){case"toggle":return Em(e,t,i);case"status":return Tm(e,t,i);case"gauge":return Fm(e,t,i);case"chart":return Mm(e,t,i);case"history":return Im(e,t,i);case"doorHistory":return Rm(e,t,i);case"camera":return Am(e,t,i)}}var Lm=/^[a-z0-9_]+\.shared_(\d+)$/;function Bd(e){return Lm.test(e)}function Hm(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Gd(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function Kd(e,n){let t=new Map;for(let i of or(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=Gd(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${Hm(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function _m(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);ar(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),rr(t,r=>ir(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function Wd(e){let n=!1;return Ms(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function Nm(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function jd(e,n,t=[]){let i=n==="share"?_m(e,t):e,a=ln(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${Nm(a)}
`}function qd(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var zm="There is nothing to read here. Paste a complication first.",Pm="This is not valid JSON. Check for a missing brace or a stray comma.",Om="This is valid JSON but not a complication. A complication starts with { and ends with }.",Dm="This does not look like a complication.",Ud="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",Vm="00000000-0000-4000-8000-000000000000";function Bm(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function Yd(e,n){let t=e.trim();if(t==="")return{ok:!1,error:zm};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:Pm}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:Om};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${Ud}`};let o={...a,id:Vm,slotIndex:0},s;try{s=sn(o)}catch(d){let u=d instanceof Le||d instanceof Error?d.message:String(d);return{ok:!1,error:`${Dm}

${Bm(u)}`}}let l=ki(a);if(l.length>0){let d=l.slice(0,3).join(", "),u=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${u}. ${Ud}`}}return{ok:!0,config:s,raw:i}}function eo(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=or(e,(o,s)=>Bd(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Bd(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Gd(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Jd(e,n){let t=structuredClone(e);ar(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return rr(t,a=>ir(a,i)),t}function Xd(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function Um(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Zd(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=Oi(e);return i.length===0?t:`${t}, ${Um(i)}`}function to(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var Km=3e4,Wm=500,jm=3e4,Qd="preset-entity";function ec(e){return`import-entity-${e}`}var qm={entityId:"",displayName:"",domain:""},Ym={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function no(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Jm(e){return e.kind==="family"?"look":"content"}function io(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function tc(){return p`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function Xm(e){let n=b`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?b`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?b`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?b`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:b`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return p`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var nc=300,ic=360,ac=44,rc=22,Zm=[1,1.7,2.6],Qm=["S","M","L"],oc=["Small","Medium","Large"],sc="wrist-assistant-panel.layers.v1",ot=34,Yt=200,ef=720,ca=320,tf=80,nf=56,lc="wrist-assistant-panel.columns.v2",ao=e=>Math.max(Yt,Math.min(ef,Math.round(e))),dc=e=>e.metaKey||e.ctrlKey||e.shiftKey,af=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,oi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Et=oi==="Cmd"?"\u2318":"Ctrl+",ro=oi==="Cmd"?"\u21E7":"Shift+";function cc(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-tf;if(i>=Yt*2+ca){let r=i-ca,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Yt,Math.floor(o*l)),s=Math.max(Yt,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Yt,o-d):s=Math.max(Yt,s-d))}return{columns:3,left:o,right:s}}let a=e-nf;return a>=Yt+ca?{columns:2,left:Math.min(n,a-ca),right:t}:{columns:1,left:n,right:t}}var F=class F extends ct{constructor(){super(...arguments);this.narrow=!1;this.colLeft=nc;this.colRight=ic;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.pickerFilter="all";this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=hn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=dl(()=>this.requestUpdate());this.imageSizes=cl(()=>this.requestUpdate());this.symbols=new Ui(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Wi;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=eo(a,this.hass.states);r.some(s=>Gr(ec(s.entityId)))||to({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Gr(Qd)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=ma`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},jm)}loadColumnWidths(){try{let t=window.localStorage.getItem(lc);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=ao(i.left)),typeof i.right=="number"&&(this.colRight=ao(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(lc,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(sc);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(sc,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Cd(s,o,i))}>Copy the ${X(o)} layout</button>`)}
          </div>
        ...
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>p`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${uc(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${tc()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?p`<span class="hor" aria-hidden="true">or</span>${tc()}`:m}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${ol(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
      ...
      ${this.pickerOpen?p`<div class="menu" role="listbox">
        ...
        ${l.map(d=>d.kind==="record"?p`<button class="row" role="option" aria-current=${d.record.id===this.selectedId?"true":"false"}
            ...
            ${this.pickerNote===d.slot?p`<div class="pk-note">${d.title}</div>`:m}`)}
    ...
    </div>`}togglePicker(t=!this.pickerOpen){this.pickerOpen=t,t||(this.pickerNote=void 0),t?window.addEventListener("pointerdown",this.pickerOutside,{capture:!0}):window.removeEventListener("pointerdown",this.pickerOutside,{capture:!0})}renderNewButton(){if(!this.hass.user?.is_admin)return m;let t=this.freeSlot()<0;return p`<div class="newc">
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=qd(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?eo(i,this.hass.states):[],r=to({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return p`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?p`<div class="hint err">A complication on this watch already has that name.</div>`:p`<div class="hint">${Zd(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${Wd(t)?p`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:m}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return p`<div class="xfer-ent">
      ${je({hass:this.hass},t.label,i??qm,a=>this.setImportEntity(t.entityId,a),ec(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,sa(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:Yd(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=Xd(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${st(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=Jd(t.config,this.importMap);i.id=J(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=Lt(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(p`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(p`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(p`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${uc(a)}</option>`)}
              </select>
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${kr.map(s=>p`<button class="add" style=${`--k:${me[s]}`} ?disabled=${i} title=${`Add a blank ${fn[s].toLowerCase()} layer`}
              ...
              >${r?p`<span class="well">${Tl(s)}</span>`:m}<span class="add-name">${r?_(s):p`<span class="k"></span>`}<span>${fn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(w,d)}</b>
          <small><span class="kind">${fn[w.kind]}</span> · ${lf(w,u,this.historySeries,x.size)}</small>
          ${C?p`<span class="facts">${of(this.host(),a,w,x).map(Y=>p`<span class="fact"><b>${Y.label}</b> ${Y.value}</span>`)}</span>`:m}
        </span>
        <span class="right">
          <span class="badges">
        ...
        <span class="name">
          ...
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${A.map(U=>Re(U,d)).join(", ")}</span></span>`:m}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
      ...
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${_("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${Qm.map((w,A)=>p`
              <button class=${this.thumbStep===A?"on":""} title=${`${oc[A]} row pictures`}
                aria-label=${`${oc[A]} row pictures`} aria-pressed=${this.thumbStep===A?"true":"false"}
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?Pd(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?m:p`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${je(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Qd,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Vd(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=Ri(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`
      ...
      <div class="settings inline" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${wd(t)}</div>
      <span class="spacer"></span>
      <span class="acts">
      ...
      <h2 class="panel-title"><span class="swatch">${_("content")}</span>Shared values
        ...
        <span class="spacer"></span>
        ${this.canEdit?p`<button class="small" @click=${()=>{let o=$d();this.mutate(s=>{s.values.push(o)}),this.inspect={kind:"data",id:o.id}}}>Add</button>`:m}
      </h2>
      ...
      ${l===m?m:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=m,s=!0;if(r.kind==="layer"){let d=t.elements.find(u=>u.payload.id===r.id);if(!d)return this.inspect={kind:"general"},m;o=Ed(a,d,this.canvasFamily,{placement:!1,tap:!1})}else if(r.kind==="group"){let d=t.groups?.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=Fd(a,d)}else if(r.kind==="data"){let d=t.values.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${ee.complication}`}>
        ...
        <div class="sec-b">${kd(a,d)}</div>
      </div>`}else r.kind==="family"?o=Md(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${_("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([Jm(r)]):new Set(Ur)}}>${l?"One at a time":"Open all"}</button>`:m}
      </div>
      ...
      </div>`}renderFooter(){let t=this.draft;if(!t)return m;let i=this.records.find(r=>r.id===this.selectedId),a=ul({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return p`<details class="foot">
      <summary>
