...
`)}function ko(e){let t;try{t=JSON.parse(e)}catch{return}if(typeof t!="object"||t===null||Array.isArray(t))return;let n=new Map,i=new Set;for(let[a,r]of Object.entries(t))r===null?i.add(a):n.set(a,Ed(r));return{values:n,nullKeys:i}}function Ed(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function ba(e){let t=ya(e),n=[...t.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return t.document&&n.push({kind:"template",value:t.document}),n}function Td(e,t){if(e.values.length!==0)switch(t){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((n,i)=>n+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}function Tt(e){let t=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(t))return Number(t);let n=t.toLowerCase();if(n==="inf"||n==="+inf"||n==="infinity"||n==="+infinity")return 1/0;if(n==="-inf"||n==="-infinity")return-1/0;if(n==="nan"||n==="+nan"||n==="-nan")return NaN}function Je(e){let t=e.trim(),n=Tt(t);if(n!==void 0)return n;let i="";for(let r of t)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Tt(i)}function Fd(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Rd(e){let t=Math.max(0,e);return t<60?`${Math.trunc(t)}s`:t<3600?`${Math.trunc(t/60)}m`:t<86400?`${Math.trunc(t/3600)}h`:`${Math.trunc(t/86400)}d`}function Md(e){let t=e.trim(),n=Tt(t);if(n!==void 0)return n;let i=0,a=t.indexOf(",");if(a>=0){let s=t.slice(0,a).trim().split(" "),l=s.length===2?Tt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,t=t.slice(a+1).trim()}let r=t.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Tt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Id(e){let t=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(t/86400),"d"],[Math.trunc(t%86400/3600),"h"],[Math.trunc(t%3600/60),"m"],[t%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Ad(e){return e.replace(/\S+/g,t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase())}function Hd(e,t,n){if(Ne(t))return e;let i=t,a=e,r=Tt(e.trim()),o=i.duration?Md(e):void 0;if(o!==void 0)a=Id(o);else if(i.relativeTime&&r!==void 0)a=Rd(r);else{let s=Je(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Fd(l))}}switch(i.useEntityUnit&&n&&(a+=n.startsWith("\xB0")||n.startsWith("%")?n:` ${n}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Ad(a);break}return a}function Wt(e){let t=Math.trunc(Math.max(0,e)),n=Math.trunc(t/3600),i=Math.trunc(t%3600/60),a=t%60,r=o=>String(o).padStart(2,"0");return n>0?`${n}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function xn(e,t=240){let n=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&n.push(o)}i=""};for(let o of e){if(n.length>=t)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return n.length<t&&r(),n}function $o(e,t){let n,i;return t.scale==="fixed"?(n=Math.min(t.minValue,t.maxValue),i=Math.max(t.minValue,t.maxValue)):(n=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,t.thresholdValue!==void 0&&Number.isFinite(t.thresholdValue)&&(n=Math.min(n,t.thresholdValue),i=Math.max(i,t.thresholdValue))),t.baseline==="zero"&&(n=Math.min(n,0),i=Math.max(i,0)),i>n||(i=n+1),{min:n,max:i}}function Ld(e,t,n){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(n>t)||i<t||i>n))return(i-t)/(n-t)}function wn(e,t=dt){let n=[];for(let i of e.split(" ")){if(n.length>=t)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||n.push({offsetSeconds:Math.round(r),state:_d(i.slice(a+1))})}return n}function _d(e){try{return decodeURIComponent(e)}catch{return e}}function zd(e,t,n){if(e.length===0||!(t>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/t)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/t));if(!(d>s))continue;let c=n(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Co(e,t,n){if(Number.isNaN(e))return n;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(n,Math.max(t,i))}function Nd(e,t,n){if(e===void 0)return 0;let i=Je(e);if(i===void 0||Number.isNaN(i))return 0;let a=n-t;return a===0?0:Math.min(1,Math.max(0,(i-t)/a))}var Xe=class{constructor(t,n){this.ctx=t;this.charts=new Map;this.named=new Map(t.namedValues.map(i=>[i.id.toUpperCase(),i.value])),n&&this.settleCharts(n)}chartReadings(t){let n=this.chartSeries(t),i=$o(n,t),a={values:n,domainMin:i.min,domainMax:i.max},r=this.chartEntity(t);return r&&(a.entity=r),a}chartSeries(t){let n=wt(t),i=n!==void 0?this.ctx.historySeries?.get(n)??"":this.resolve(t.value)??"",a=xn(i);return t.limit>0&&a.length>t.limit?t.takeFromEnd?a.slice(a.length-t.limit):a.slice(0,t.limit):a}chartEntity(t){let n=this.dereference(t.value);if(!(!n||!("entityId"in n.kind)))return{entityId:n.kind.entityId,displayName:n.kind.displayName,domain:n.kind.domain}}chartNowIndex(t,n){if(t.nowIndex===void 0||n===0)return;let i=this.resolve(t.nowIndex);if(i===void 0)return;let a=Je(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),n-1)}settleCharts(t){let n=new Map,i=[];for(let s of t.elements)s.kind!=="chart"||n.has(s.payload.id)||(n.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(n.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=n.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,h=u!==void 0&&u!==s&&n.has(u)&&!l.has(u)?o(u,new Set([...l,u])):$o(a.get(s)??[],c);return r.set(s,h),h};for(let s of i){let l=n.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(t){let n=t,i=new Set,a=t.format;for(;n.kind.kind==="named";){let o=n.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ne(a)?a:s.format,n=s}let r={kind:n.kind};return a&&(r.format=a),r}directEntityUnit(t){let n=t.kind;if(n.kind==="entityState"||n.kind==="entityAttribute"||n.kind==="entityAge")return this.ctx.entityStates.get(n.entityId)?.unitOfMeasurement;if(n.kind==="chartStat"){let i=this.charts.get(n.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i;switch(n.kind.kind){case"literal":i=n.kind.value;break;case"entityState":i=this.ctx.entityStates.get(n.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(n.kind.layer.toUpperCase()),r=a?Td(a,n.kind.stat):void 0;i=a&&r!==void 0?Dr(r,a.domainMax-a.domainMin):void 0;break}default:{let a=ga(t,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Hd(i,n.format,this.directEntityUnit(n))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i=n.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(t)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Tt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(t){if(!t)return;let n=this.dereference(t);if(!n||n.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(n.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Wt(i.remaining):"Paused":"Idle"}entityIcon(t){let n=this.dereference(t);return!n||n.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(n.kind.entityId)?.iconName??n.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(t){let n=t.comparison;if(n.kind==="isStale")return this.isStale();let i=this.resolve(t.value);if(i===void 0)return n.kind==="isUnavailable";let a=Je(i),r=()=>this.resolve(n.value),o=()=>{let l=r();return l===void 0?void 0:Je(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(n.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(n.upper),c=d===void 0?void 0:Je(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,h]=l<=c?[l,c]:[c,l];return a>=u&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!n.pattern)return!1;try{return new RegExp(n.pattern).test(i)}catch{return!1}}case"isOneOf":return(n.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(t){return t.tests.length===0?!0:t.join==="any"?t.tests.some(n=>this.evaluateTest(n)):t.tests.every(n=>this.evaluateTest(n))}applyRules(t,n){let i=new Map;for(let a of t){let r=n?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Te[s.kind],s)}return i}liveBranches(t){let n=new Map;for(let i of t){let a=i.cases.find(r=>this.evaluateCondition(r.when));n.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return n}styleColor(t,n){let i=t.get(n);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(t,n){let i=t.get(n);return i?this.resolve(i.value):void 0}styleNumber(t,n){return t.get(n)?.number}resolveElement(t,n){let i=t.payload,a=this.applyRules(i.rules,n),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,c={id:i.id,isHidden:o,frame:l,opacity:d};switch(t.kind){case"text":{let u=t.payload.countdown?this.countdownEnd(t.payload.value):void 0,h=t.payload.countdown?this.countdownFallbackText(t.payload.value):void 0,f={kind:"text",...c,text:this.styleText(a,"text")??h??this.resolve(t.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??t.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??t.payload.fontWeight,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex};return u!==void 0&&(f.countdownEnd=u),f}case"icon":{let u=this.entityIcon(t.payload.symbol)??this.resolve(t.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(a,"icon")??u,size:this.styleNumber(a,"fontSize")??t.payload.size,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex}}case"gauge":{let u=t.payload,h=this.styleText(a,"gaugeValue")??this.resolve(u.value),f=this.styleNumber(a,"gaugeMin")??u.minValue,g=this.styleNumber(a,"gaugeMax")??u.maxValue,x=h===void 0?void 0:Je(h),$=this.styleColor(a,"color")??u.colorSlot.baseColorHex;u.coloring==="bands"&&u.bands.length>0&&x!==void 0&&($=Ui(x,gn(u),u.bandAboveColorHex));let S=g-f;if(u.total){let C=Je(this.resolve(u.total)??"");C!==void 0&&(S=C)}let E=Co(S,1,Nn),v={kind:"gauge",...c,fraction:Nd(h,f,g),style:u.style,lineWidth:u.lineWidth,colorHex:$,trackColorHex:u.trackColorHex,thresholdColorHex:u.thresholdColorHex,dotCount:E,filledCount:Co(x??0,0,E)};if(u.thresholdValue!==void 0&&g!==f){let C=(u.thresholdValue-f)/(g-f);C>=0&&C<=1&&(v.thresholdFraction=C)}return v}case"chart":{let u=t.payload,h=this.charts.get(u.id)??this.chartReadings(u),f=h.values,g={min:h.domainMin,max:h.domainMax},x=this.styleColor(a,"color")??u.colorSlot.baseColorHex,$=gn(u),S=Or(u)?f.map(N=>Ui(N,$,u.bandAboveColorHex)):[],E={kind:"chart",...c,values:f,style:u.style,domainMin:g.min,domainMax:g.max,baseline:u.baseline,barGap:u.barGap,lineWidth:u.lineWidth,colorHex:x,highColorHex:u.highColorHex,lowColorHex:u.lowColorHex,marker:u.marker,pointColorHexes:S,fillBands:u.fillBands,thresholdColorHex:u.thresholdColorHex,nowColorHex:u.nowColorHex};if(f.length>0){let N=u.highlight==="highest"||u.highlight==="both",B=u.highlight==="lowest"||u.highlight==="both",j=N?f.indexOf(Math.max(...f)):-1,se=B?f.indexOf(Math.min(...f)):-1;j>=0&&(E.highIndex=j),se>=0&&se!==j&&(E.lowIndex=se)}let v=Ld(u,g.min,g.max);v!==void 0&&(E.thresholdY=v);let C=this.chartNowIndex(u,f.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let u=t.payload,h=kt(u),f=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=wn(f,dt),x=zd(g,Ue(u)*60,S=>Kr(S,u.bands,u.otherColorHex));return{kind:"timeline",...c,runs:x,gap:u.gap,cornerRadius:u.cornerRadius}}case"shape":{let u={kind:"shape",...c,shapeKind:t.payload.kind,cornerRadius:t.payload.cornerRadius,thickness:t.payload.thickness,fillColorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??t.payload.borderWidth},h=this.styleColor(a,"borderColor")??t.payload.borderColorHex;return h!==void 0&&(u.borderColorHex=h),u}case"image":{let u={kind:"image",...c,entityId:t.payload.entity.entityId,source:t.payload.source,showTimestamp:t.payload.timestamp===!0,contentMode:t.payload.contentMode,zoom:t.payload.zoom,panX:t.payload.panX,panY:t.payload.panY,cornerRadius:t.payload.cornerRadius,timestampCorner:t.payload.timestampCorner,timestampSize:t.payload.timestampSize};Ke(t.payload)&&(u.timestampX=t.payload.timestampX,u.timestampY=t.payload.timestampY);let h=this.ctx.entityStates.get(t.payload.entity.entityId)?.entityPicture;return h!==void 0&&(u.url=h),u}case"tap":{let u={kind:"tap",...c,frame:t.payload.frame,opacity:1,action:t.payload.action};return t.payload.openPageId!==void 0&&(u.openPageId=t.payload.openPageId),t.payload.attachedTo!==void 0&&(u.attachedTo=t.payload.attachedTo),u}}}resolveLayout(t,n,i){let a=t.perFamily[n];this.settleCharts(t);let r=so(t,n).map(x=>this.resolveElement(x,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:n,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,$=this.resolve(x.value),S=$===void 0?void 0:Je($);if(S!==void 0){let E=Math.min(x.minValue,x.maxValue),v=Math.max(x.minValue,x.maxValue),C={value:Math.min(v,Math.max(E,S)),minValue:E,maxValue:v===E?E+1:v,colorHexes:x.colorHexes},N=this.resolve(x.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(x.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(s.backgroundColorHex=f);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Pd(e,t,n){let i=new Xe(t,n),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function va(e,t,n){let i=new Xe(t),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,n));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Pd(e.inline,t,e)),a}var ve=ue,kn=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ve,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=kn.find(e=>e.measured);function Ho(e){if(!e)return;let t=/^(\d+)x(\d+)$/.exec(e.trim());if(!t)return;let n=Number(t[1]),i=Number(t[2]);return kn.find(a=>a.screen.width===n&&a.screen.height===i)}function Xn(e,t){let n=ve[t];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/n.width,e.height/n.height),a=n.width*i,r=n.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Od={regular:400,medium:500,semibold:600,bold:700};function Pe(e){if(!e)return;let t=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(t))return;let n=t.length===8?parseInt(t.slice(6,8),16)/255:1;return{color:`#${t.slice(0,6)}`,opacity:n}}function $e(e,t,n="#FFFFFF"){let i=Pe(e)??{color:n,opacity:1};return{[t]:i.color,[`${t}-opacity`]:i.opacity}}function Lo(e,t){let n=Math.max(0,e.frame.width*t.width),i=Math.max(0,e.frame.height*t.height),a=(e.frame.x+e.frame.width/2)*t.width,r=(e.frame.y+e.frame.height/2)*t.height;return{x:a-n/2,y:r-i/2,w:n,h:i,cx:a,cy:r}}function Dd(e,t){let n=$e(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Wt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>t.w&&t.w>0?Math.max(.5,t.w/a):1,o=e.fontSize*r,s=e.text;if(t.w>0&&s.length*i(o)>t.w){let l=t.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
    ...
    <g transform="rotate(${c} ${t.cx} ${t.cy})">
      ...
      ${e.thresholdFraction===void 0?m:Bd(t,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function Bd(e,t,n,i,a){let r=$e(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=n/2+1;return b`<line x1=${e.cx+s*(t-d)} y1=${e.cy+l*(t-d)}
    x2=${e.cx+s*(t+d)} y2=${e.cy+l*(t+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var Gd=5;function Ud(e,t){let n=e.values,i=Math.max(n.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:Gd,o=e.style==="bars"?0:e.lineWidth/2,s=t.x,l=Math.max(t.w,0),d=t.y+r+o,c=Math.max(t.h-r-o*2,1),u=d+c,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),f=e.baseline==="lowest",g=f?c*.12:0,x=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-x*(i-1))/i,.5),S=v=>Math.min(1,Math.max(0,(v-e.domainMin)/h)),E=v=>u-S(v)*c;return{count:n.length,barWidth:$,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:f?u:E(0),yAtFraction(v){return u-Math.min(Math.max(v,0),1)*c},barRect(v){let C=s+v*($+x),N=n[v],B,j;if(f){let se=g+S(N)*(c-g);B=u-se,j=u}else B=E(N),j=f?u:E(0),B>j&&([B,j]=[j,B]);return{x:C,y:B,w:$,h:Math.max(j-B,.5)}},point(v){let C=Math.max(l-o*2,0);return{x:n.length>1?s+o+C*v/(n.length-1):s+l/2,y:E(n[v])}},markerCenter(v,C){let N=C?this.barRect(v):void 0;return{x:N?N.x+N.w/2:this.point(v).x,y:t.y+r/2}}}}function Kd(e,t){if(e.values.length===0)return m;let n=Ud(e,t),i=$e(e.colorHex,"fill"),a=$e(e.highColorHex,"fill",e.colorHex),r=$e(e.lowColorHex,"fill",e.colorHex),o=(c,u)=>b`<circle cx=${c.x} cy=${c.y} r="1.7" fill=${u.fill} fill-opacity=${u["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===n.count,d=c=>l?$e(e.pointColorHexes[c],"fill",e.colorHex):i;if(e.style==="bars")for(let c=0;c<n.count;c++){let u=n.barRect(c),h=c===e.highIndex?a:c===e.lowIndex?r:d(c),f=Math.min(1.2,u.w/2,u.h/2);s.push(b`<rect x=${u.x} y=${u.y} width=${u.w} height=${u.h} rx=${f}
      ...
      fill=${u.fill} fill-opacity=${u["fill-opacity"]} />`});return b`${i}`}function jd(e,t){let n=$e(e.fillColorHex,"fill"),i=e.borderColorHex?Pe(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(t.w,t.h)/2-r;return b`<circle cx=${t.cx} cy=${t.cy} r=${Math.max(0,l)}
        ...
        fill=${n.fill} fill-opacity=${n["fill-opacity"]} stroke="none" />`}}}function qd(e,t,n){let i=n.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${t.cx-e.size/2} ${t.cy-e.size/2})">${i}</g>`;let a=$e(e.colorHex,"stroke"),r=e.size;return b`
    ...
    <text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Ea=.25,Yd=8;function Jd(e,t,n,i,a,r,o,s){let l={x:0,y:0,width:e,height:t};if(!(e>0)||!(t>0)||!(n>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Ea),Yd),c=Math.max(e/n,t/i),u=Math.min(e/n,t/i),h=(a==="fit"?u:c)*d,f=n*h,g=i*h,x=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),$=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(f-e)/2*(1+x)+0,y:-(g-t)/2*(1+$)+0,width:f,height:g}}function Zn(e){let t=e.getHours()%12||12,n=i=>String(i).padStart(2,"0");return`${t}:${n(e.getMinutes())}:${n(e.getSeconds())}`}var Jn=4;function Qn(e,t,n){let i=Math.min(Math.max(e.timestampSize,4),40),a=n.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?t.x+Jn:t.x+t.w-Jn-a,d=e.timestampCorner.startsWith("top")?t.y+Jn:t.y+t.h-Jn-r;return{x:l,y:d,w:a,h:r,size:i,label:n}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(t.x+e.timestampX*t.w,t.x,t.w,a),y:s(t.y+e.timestampY*t.h,t.y,t.h,r),w:a,h:r,size:i,label:n}}function Xd(e,t){if(e==="camera")return"camera.fill";switch(t.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Zd(e,t,n){let i=n.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Qn(e,t,Zn(new Date)):void 0,s=o?b`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([h,f,g])=>b`<rect data-ts-corner=${h} x=${f-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${h}-resize" />`)}`:m,c=e.url?n.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let h=Jd(t.w,t.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=b`<image href=${e.url} x=${t.x+h.x} y=${t.y+h.y} width=${h.width} height=${h.height}
      ...
      <g transform="translate(${t.cx-7} ${t.cy-7})">${i.render(Xd(e.source,e.entityId),14,"#FFFFFF99")??m}</g>`;return b`
    <defs><clipPath id=${a}><rect x=${t.x} y=${t.y} width=${t.w} height=${t.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Qd(e,t,n,i,a){if(!i)return m;let r=Math.min(10,t.w*.5,t.h*.5),o=a!==void 0?ec(a,t):void 0;return b`
    ...
    ${o!==void 0?b`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${ka} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${t.cx-r/2} ${t.cy-r/2})" opacity="0.8">${n.render("hand.tap.fill",r,"#FFD60A")??m}</g>`:m}`}var ka=5;function ec(e,t){let n=ka*.55,i=t.w-2;if(t.h<ka*1.6||i<n*4)return;if(e.length*n<=i)return e;let a=Math.max(1,Math.floor(i/n)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function $a(e,t,n){if(e.isHidden&&!n.showHidden)return m;let i=n.tapReview===!0,a=n.tapAreas===!0||i,r=i?n.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return m;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return m;let l=Lo(e,t),d=i&&(!s||o),c;switch(e.kind){case"text":c=Dd(e,l);break;case"icon":c=qd(e,l,n.icons);break;case"gauge":c=Vd(e,l);break;case"chart":c=Kd(e,l);break;case"timeline":c=Wd(e,l);break;case"shape":c=jd(e,l);break;case"image":c=Zd(e,l,n);break;case"tap":c=Qd(e,l,n.icons,a,d?We(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,f=n.highlightId===e.id,g=f||n.highlightIds?.includes(e.id)===!0,x=n.handles===!0&&(!s||o),$=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:m,S=n.hoverId===e.id||n.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${c}${S}${$}${C}</g>`}function ei(e,t){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:t?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Ta(e,t){return(t?23.5:34)*e}var So=10.5;function _o(e,t){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*t}function Eo(e,t){let n=0;for(let i of e)n+=_o(i,t);return n}function To(e,t,n){let i=e.toUpperCase(),a=d=>_o(d,n),r=.9*n,o=0;for(let d of i)o+=a(d);if(o<=t)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>t)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Ca(e,t,n){let i=n*Math.PI/180;return{x:e.cx+t*Math.cos(i),y:e.cy+t*Math.sin(i)}}function Sa(e,t,n,i){let a=Ca(e,t,n),r=Ca(e,t,i);return`M ${a.x} ${a.y} A ${t} ${t} 0 0 1 ${r.x} ${r.y}`}function zo(e,t,n,i){let{dial:a}=ei(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:t,d:Sa(a,n,i.start,i.end),length:n*r}}function tc(e,t){let n=ei(e,!0);return zo(e,t,n.dial.r,n.labelArc)}var Fo=18.5,nc=113,ic={start:-71,end:-36},Ro=104,ac=6.2,Mo={start:-77,end:-30.5};function Io(e){let t=e.replace("#",""),n=i=>parseInt(t.slice(i,i+2),16)||0;return[n(0),n(2),n(4)]}function Ao(e,t){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let n=Math.min(1,Math.max(0,t))*(e.length-1),i=Math.min(e.length-2,Math.floor(n)),a=n-i,r=Io(e[i]),o=Io(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var wa=11;function rc(e,t,n){let{dial:i}=ei(t,!0),a=Ro*t,r=180/(Math.PI*Ro),o=e.minLabel!==void 0?Eo(e.minLabel,wa)*r:0,s=e.maxLabel!==void 0?Eo(e.maxLabel,wa)*r:0,l=Mo.start+(o>0?Math.max(0,o-1.8):0),d=Mo.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,h=[];for(let S=0;S<u;S++){let E=l+c*S/u,v=Math.min(d,l+c*(S+1)/u+.4);h.push(b`<path d=${Sa(i,a,E,v)} fill="none"
      stroke=${Ao(e.colorHexes,(S+.5)/u)} stroke-width=${ac*t}
    ...
    ${c.map(f=>$a(f,a,d))}
    ${u}
  </svg>`}function Y(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var jt=["rectangular","circular","corner","inline"];function Ft(e){return te.includes(e)}function Po(e){return jt.filter(t=>e.supportedFamilies.includes(t))}function Oo(e){return te.find(t=>e.supportedFamilies.includes(t))}function ti(e,t){return e.supportedFamilies.includes(t)&&e.supportedFamilies.length>1}function dc(){return{value:M("")}}function cc(e){let t=Kt();for(let n of e.elements)t.placements[n.payload.id]={frame:{...n.payload.frame},isHidden:!0};return t}function Do(e,t){e.supportedFamilies.includes(t)||(e.supportedFamilies=jt.filter(n=>n===t||e.supportedFamilies.includes(n))),Ft(t)?e.perFamily[t]||(e.perFamily[t]=cc(e)):e.inline||(e.inline=dc()),e.schemaVersion=hn(e)}function Vo(e,t){ti(e,t)&&(e.supportedFamilies=e.supportedFamilies.filter(n=>n!==t),Ft(t)?delete e.perFamily[t]:delete e.inline,e.schemaVersion=hn(e))}function Bo(e,t){let n=[];if(!Ft(t)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||n.push("the Inline text")),n}let i=e.perFamily[t];if(!i)return n;let a=Object.values(i.placements).filter(r=>!r.isHidden).length;return a>0&&n.push(`${a} placed layer${a===1?"":"s"}`),i.rules.length>0&&n.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&n.push("the bezel"),i.curvedText&&n.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&n.push("the background or border"),n}var he={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},qt={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area"},Ra=["text","icon","gauge","chart","timeline","shape","image","tap"],Q={states:"#f9a825",tap:he.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Go="2.8.0";function Ma(e){if(typeof e!="string")return;let t=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(t)return[Number(t[1]),Number(t[2]),Number(t[3]??0)]}function uc(e,t){for(let n=0;n<3;n++)if(e[n]!==t[n])return e[n]<t[n]?-1:1;return 0}function Uo(e,t=Go){let n=Ma(e),i=Ma(t);return!n||!i?!1:uc(n,i)>=0}function Ko(e,t=Go){return`${Ma(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The complication editor needs ${t} or newer. Update Wrist Assistant on the watch, open it once so it reports its version, then reload this page.`}var Wo="52a9d81d0fd7";function pc(e){return e.trim().replace(/\./g,"-")}function hc(e){return e.trim().replace(/-/g,".")}var ni=class e{constructor(t){this.onReady=t;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let t=window.customIcons?.ios;if(!t||typeof t.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>t.getIconList()).then(n=>{this.nameList=(n??[]).map(i=>hc(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(t,n,i){let a=pc(t),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Pe(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return b`<svg x="0" y="0" width=${n} height=${n} viewBox=${s}>
    ...
    </div></div>`}function di(e,t,n,i){let a=i.format??(r=>String(Math.round(r*100)/100));return p`<div class="field slider">${et(e,Xt(t,i.def,n,a))}
    ...
    </div></div>`}function ci(e,t,n,i,a,r){let o=s=>Math.round(s*1e3)/10;return Z(e,o(t),s=>n((s??0)/100),{min:a,max:r,step:.5,def:o(i)})}function Ae(e,t,n,i){return p`<label class="field check"><input type="checkbox" .checked=${t} @change=${a=>n(a.target.checked)} />${et(e,Xt(t,i,n,a=>a?"on":"off"))}</label>`}function oe(e,t,n,i=!1,a){let r=(t??"").replace(/^#/,""),o=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(r),s=o?`#${r.slice(0,6)}`:"#ffffff",l=o&&r.length===8?Math.round(parseInt(r.slice(6,8),16)/255*100):100,d=(u,h)=>{let f=u.replace(/^#/,"").toUpperCase();return h>=100?`#${f}`:`#${f}${Math.round(h/100*255).toString(16).padStart(2,"0").toUpperCase()}`},c=a===void 0?void 0:{atDefault:Fc(t,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>n(a??void 0)};return p`<div class="field color">${et(e,c)}
    <div class="color-row">
    ...
    </div></div>`}function Fc(e,t){return e===void 0||t===void 0?e===t:e.replace(/^#/,"").toUpperCase()===t.replace(/^#/,"").toUpperCase()}function Vs(e,t){let n=e[t],i=n&&typeof n.attributes.friendly_name=="string"?n.attributes.friendly_name:t;return{entityId:t,displayName:i,domain:t.split(".")[0]??""}}function Rc(e,t,n){let i=t===void 0?void 0:typeof t=="string"?[t]:t,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=n?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function vs(e){let{entities:t,devices:n,areas:i}=e;if(!t||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=t[r];if(o)return a(o.area_id)??a(o.device_id?n?.[o.device_id]?.area_id:void 0)}}var Bs=50;function Mc(e){let t=e.state.trim().split(/\s+/)[0]??"";return t!==""&&Number.isFinite(Number(t))}function Ic(e,t,n=Bs,i){let a=t.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,n);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:c.startsWith(a)?h=2:d.includes(a)?h=3:c.includes(a)?h=4:o.length>1&&o.every(f=>d.includes(f)||c.includes(f))?h=5:u!==""&&(u.includes(a)||o.length>1&&o.every(f=>d.includes(f)||c.includes(f)||u.includes(f)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,n).map(l=>l.c)}var Ac=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Gs(e){return Ac.test(e.trim())}function Hc(e,t,n){let i=e.trim();if(i!==t.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in n)return Vs(n,i);if(Gs(i))return{...t,entityId:i,domain:i.split(".")[0]??""}}}var It=new Map;function Ie(e){let t=e instanceof Node?e:null;for(let n=0;t&&n<8;n+=1){let i=t.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}t=a}}function Us(e){return It.has(e)}function Qe(e,t,n,i,a,r={}){let o=e.hass.states,s=It.get(a),l=s?Ic(Rc(o,r.domain,vs(e.hass)),s.query,Bs,r.preferNumeric?Mc:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=n.entityId?o[n.entityId]:void 0,u=(v,C,N=0)=>{It.set(a,{query:C,index:N}),Ie(v)},h=v=>{It.delete(a),Ie(v)},f=v=>{let C=Hc(v,n,o);C&&i(C)},g=(v,C)=>{i(Vs(o,v.entityId)),h(C)},x=()=>Math.max(0,Math.min(It.get(a)?.index??0,l.length-1)),$=v=>{let C=v.target;if(v.key==="ArrowDown"||v.key==="ArrowUp"){v.preventDefault();let N=It.get(a);if(!N){u(C,C.value);return}let B=v.key==="ArrowDown"?x()+1:x()-1;u(C,N.query,Math.max(0,Math.min(l.length-1,B))),Lc(C);return}if(v.key==="Enter"){v.preventDefault();let N=l[x()];s&&N?g(N,C):(f(C.value),h(C));return}if(v.key==="Escape"){if(!s)return;v.preventDefault(),v.stopPropagation(),h(C)}},S=n.entityId?vs(e.hass)?.(n.entityId):void 0,E=n.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:c?p`<div class="entity-current">
  ...
  </div>`}function Lc(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var _c=120;function zc(e,t,n,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(ai.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:t.trim()!==""&&n.length>0?{names:[...n],fromPack:!0}:{names:a(ri),fromPack:!1}}function xs(e,t){return t.size===0?e.length:e.filter(n=>t.has(n)).length}function Nc(e){return[{value:"",label:`Starter set (${xs(ri,e)})`},...ai.map(t=>({value:t.name,label:`${t.name} (${xs(t.symbols,e)})`}))]}function Pc(e){return e.length>0?e.length:ri.length}function Oc(e,t,n,i){return n?t>e?`Showing ${e} of ${t}. Type more to narrow it down.`:t===1?"1 symbol matches.":`${t} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function ws(e,t,n,i){let a=e.icons.render(t,22,"#FFFFFF");return p`<button type="button" class="sym ${n?"on":""}" title=${t} @click=${()=>i(t)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${t}</span>
  </button>`}function Ks(e,t,n,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),c=t.trim(),u=c!==""&&d.size>0&&!d.has(c),h=g=>{n(g),a.noteUsed(g)},f=m;if(r){let g=a.category(i),x=zc(g,o,l,d),$=Yo(x.names,o),S=x.fromPack?$.slice(0,_c):$,E=d.size===0?a.recent:a.recent.filter(v=>d.has(v));f=p`<div class="sym-browse">
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${o} @input=${xe(v=>a.setQuery(i,v))} />
        <select @change=${xe(v=>a.setCategory(i,v))}>
          ${Nc(d).map(v=>p`<option value=${v.value} ?selected=${v.value===g}>${v.label}</option>`)}
        </select>
      </div>
      ...
      ${$.length===0?p`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:p`<div class="hint">
            ${Oc(S.length,$.length,o.trim()!=="",Pc(l))}
          </div>`}
    ...
    ${f}`}var Dc=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],Vc=[["bars","Bars"],["line","Line"],["area","Area"]],Bc=[["auto","Auto"],["fixed","Fixed range"]],Gc=[["lowest","Lowest value"],["zero","Zero"]],Ws=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],Uc=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],ks=[["uniform","One colour"],["bands","By value"]];function $s(e){let t=[Gi,"#FFD60A"];if(e.length<2)return t.map((o,s)=>({id:X(),upTo:(s+1)*33,colorHex:o}));let n=Math.min(...e),a=Math.max(...e)-n,r=o=>Number(o.toFixed(a>=10?0:2));return t.map((o,s)=>({id:X(),upTo:r(n+a*(s+1)/3),colorHex:o}))}function Kc(e){if(e.length===0)return 0;let t=Math.min(...e),n=Math.max(...e),i=n-t;return Number(((t+n)/2).toFixed(i>=10?0:2))}function Wc(e,t){let n=gn({bands:e}),i=n.at(-1),a=e.length>1?Math.abs(n[1].upTo-n[0].upTo):10;return{id:X(),upTo:(i?.upTo??0)+(a||10),colorHex:t}}function Cs(e,t,n){return p`
    ${e.bands.map((i,a)=>p`
    ...
    <button class="small" @click=${()=>n(i=>{i.bands=[...i.bands,Wc(i.bands,t)]})}>Add band</button>
    ${oe("And the rest",e.bandAboveColorHex,i=>n(a=>{a.bandAboveColorHex=i??st},"babove"),!1,st)}`}function jc(e,t,n,i){let a=new Map,r=new Map,o=(d,c)=>{let u=d.trim();if(u==="")return;let h=u.toLowerCase();r.has(h)||r.set(h,u),a.set(h,(a.get(h)??0)+c)};e.forEach((d,c)=>{let u=e[c+1],h=u===void 0?t:u.offsetSeconds;o(d.state,Math.max(0,h-d.offsetSeconds))}),n!==void 0&&o(n,0),(Ji[i??""]??[]).forEach(d=>o(d,0));let s=["unavailable","unknown"];return[...[...a.entries()].filter(([d])=>!s.includes(d)).sort((d,c)=>c[1]-d[1]).map(([d])=>r.get(d)??d),...s]}function qc(e,t,n=[],i="wa-timeline-states"){let a=new Set(e.bands.map(o=>o.match.trim().toLowerCase())),r=n.find(o=>!a.has(o.toLowerCase()))??"";return p`
    ${e.bands.map((o,s)=>p`
      <div class="row-inline">
        ${pe("State",o.match,l=>t(d=>{let c=d.bands[s];c&&(c.match=l)},`tmatch${o.id}`),{placeholder:"on",list:i})}
        ${oe("Colour",o.colorHex,l=>t(d=>{let c=d.bands[s];c&&(c.colorHex=l??lt)},`tcol${o.id}`))}
    ...
    <button class="small" @click=${()=>t(o=>{o.bands=[...o.bands,{id:X(),match:r,colorHex:_n(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${oe("Otherwise",e.otherColorHex,o=>t(s=>{s.otherColorHex=o??lt},"tother"),!1,lt)}`}var Yc=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],Jc={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Ss(e){let t=e.value.kind;if(t.kind==="aggregate"){let{stateFilter:n,...i}=t.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return M(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Xc=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function Zc(e,t){let n="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(t){case"literal":return{kind:t,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:t,...n};case"entityAttribute":return{kind:t,...n,attribute:""};case"entityAge":return{kind:t,...n};case"aggregate":return{kind:t,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:t,timeField:"now"};case"dataAge":return{kind:t};case"jinja":return{kind:t,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:t,id:""};case"chartStat":return{kind:t,layer:"",stat:"latest"}}}function ae(e,t,n,i){if(i.inline||!Qc())return p`<div class="value-editor">${Ys(e,t,n,i)}</div>`;let a=Wa(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(t):void 0,s=me(t,fe(e)),l="entityId"in t.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
  ...
  </div>`}function fe(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Wa(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function Qc(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var En=new Set,Sn=new WeakMap;function eu(e){let t=e.getRootNode();return(t instanceof ShadowRoot||t instanceof Document?t:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function tu(e,t){let n=e instanceof Node?e:null;if(!n)return;let i=n.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(t)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function qs(e){let t=e.currentTarget,n=e.newState==="open",i=Sn.get(t);if(i&&(i(),Sn.delete(t)),!n){En.delete(t.id)&&Ie(t);return}let a=eu(t);if(!a)return;let r=()=>{if(!t.isConnected||!t.matches(":popover-open")){Sn.get(t)?.(),Sn.delete(t);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){t.hidePopover();return}Ba(t,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Sn.set(t,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Ba(t,a.getBoundingClientRect()),En.has(t.id)||(En.add(t.id),Ie(t),requestAnimationFrame(()=>{t.isConnected&&Ba(t,a.getBoundingClientRect())}))}function Ba(e,t){e.style.maxHeight="";let n=e.getBoundingClientRect(),i=nu({left:t.left,top:t.top,bottom:t.bottom,width:t.width},{width:n.width,height:n.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Mt=8,ui=6,Es=140;function nu(e,t,n){let i=n.height-e.bottom-ui-Mt,a=e.top-ui-Mt,r=t.height>i&&a>i&&i<Es,o=Math.max(Es,r?a:i),s=Math.min(t.height,o),l=Math.max(Mt,Math.min(e.left,n.width-t.width-Mt)),d=r?Math.max(Mt,e.top-ui-s):Math.max(Mt,Math.min(e.bottom+ui,n.height-s-Mt));return{left:l,top:d,maxHeight:o,above:r}}function Ys(e,t,n,i){let a=t.kind,r=c=>n({...t,kind:c}),o=i.key,s=Dc.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=m;switch(a.kind){case"literal":l=i.symbol?Ks(e,a.value,c=>r({...a,value:c}),o):pe("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=Qe(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=p`${Qe(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${pe("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(h=>p`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=au(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Fe("Field",a.timeField,Xc,c=>r({...a,timeField:c}));break;case"dataAge":l=p`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=p`${Ds("Template",a.value,c=>r({...a,value:c}),4)}
    ...
    ${Fe("Source",a.kind,s,c=>r(Zc(a,c)))}
    ${l}
    ${i.noFormat?m:iu(t.format,c=>n(Ne(c)?{kind:t.kind}:{...t,format:c}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:m}`}function iu(e,t){let n=e??{},i=a=>{let r={...n,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];t(r)};return p`<details class="sub" ?open=${!Ne(e)}>
  ...
  </details>`}function au(e,t,n,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=t.scope;return p`
    ...
    ${t.function==="count"?m:pe("Attribute (blank = state)",t.attribute??"",s=>{let l={...t};s?l.attribute=s:delete l.attribute,n(l)})}`}var Js=ea,ru=Js.filter(([e])=>e!=="none");function ou(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Xs(e,t){let n=ou(t)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=t.type==="callService"?{...t}:{type:"callService",serviceDomain:"",serviceName:""};return n.entityId!==""&&(i.target=n),i}return jr(e)?{type:e,...n}:{type:e}}var su=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Zs(e,t,n,i){let a=t.serviceDataJSON??"",r=qr(a),o=t.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span>Flash when a tap works</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(t.successFlashColorHex??du).slice(0,7)}
  ...
  </section>`}function bu(e){if(e.length===0)return"nothing";let t=n=>Number.isInteger(n)?String(n):String(Math.round(n*100)/100);return e.length<=12?e.map(t).join(" "):`${e.slice(0,6).map(t).join(" ")} \u2026 ${e.slice(-3).map(t).join(" ")}`}function vu(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let t=Math.round(e/60);if(t<90)return`${t}m`;let n=Math.floor(t/60),i=t%60;return i===0?`${n}h`:`${n}h ${i}m`}function xu(e,t){let n=ue[e==="inline"?"rectangular":e],i=t.height*n.height>t.width*n.width,a=Math.round((t.rotationDegrees%180+180)%180)===90;return i!==a}function wu(e,t,n){let i=xu(e,t),a=ue[e==="inline"?"rectangular":e],r=t.height*a.height>t.width*a.width;return p`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function ku(e){let t=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return t.length===0?!1:t.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>t.length}function $u(e,t,n=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??t,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-n),r=a.map(o=>`${o.state||"(blank)"} ${vu(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function bi(e){let t=Pn.find(o=>o.minutes===e);if(t)return t.label;let n=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return n>0&&r.push(`${n}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var gi=new Set;function Ga(e,t){return gi.has(e)||!Pn.some(n=>n.minutes===t)}function Hs(e,t,n,i){let a=Ga(e,t);return p`<label class="field">${et("Span",{atDefault:t===n&&!a,title:`Back to ${bi(n)}`,reset:()=>{gi.delete(e),i(n)}})}
      <select @change=${r=>{let o=r.target.value;o==="custom"?(gi.add(e),Ie(r.target)):(gi.delete(e),i(Number(o)||On))}}>
        ${Pn.map(({minutes:r,label:o})=>p`<option value=${String(r)} ?selected=${!a&&r===t}>${o}</option>`)}
    ...
    <div class="hint">${bi(e)}, up to 7 days: the recorder keeps
      ten by default, and a longer span would quietly come back short.</div>`}function qa(e,t){let n=fe(e);switch(t.kind){case"text":return pt(me(t.payload.value,n),48);case"icon":return pt(me(t.payload.symbol,n),48);case"gauge":return pt(me(t.payload.value,n),48);case"chart":return pt(`${me(t.payload.value,n)}${t.payload.historyMinutes>0?` \xB7 ${bi(t.payload.historyMinutes)}`:""}`,48);case"timeline":return pt(`${me(t.payload.value,n)} \xB7 ${bi(Ue(t.payload))}`,48);case"shape":return t.payload.kind==="roundedRectangle"?"Rounded rectangle":t.payload.kind;case"image":return t.payload.entity.displayName||t.payload.entity.entityId||(t.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return We(t.payload.action)}}function vi(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let t=e.payload,n=t.style==="dots"?`${t.bands.length>0&&t.coloring==="bands"?"banded":Se(t.colorSlot.baseColorHex)} dots`:`${t.lineWidth} pt line \xB7 ${t.coloring==="bands"&&t.bands.length>0?`${t.bands.length+1} colour bands`:Se(t.colorSlot.baseColorHex)}`;return`${t.style} \xB7 ${n}${t.thresholdValue===void 0?"":` \xB7 threshold ${t.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${Ws.find(([t])=>t===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let t=e.payload;return`${t.bands.length===0?`one colour (${Se(t.otherColorHex)})`:`${t.bands.length} ${t.bands.length===1?"state":"states"} coloured`}${t.gap>0?` \xB7 ${t.gap} pt gap`:""} \xB7 corners ${t.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Se(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Se(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function ol(e,t,n){let i=t.payload.id,a=e.config.elements.findIndex(y=>y.payload.id===i),r=`el-${i}`,o=(y,k)=>e.update(q=>y(q.elements[a]),k?`${r}-${k}`:void 0),s=we(e.config,n,t),l=s.frame,d=(y,k)=>e.update(q=>Ee(q,n,i,{frame:hs(l,y)}),`${r}-${k}-${n}`),c=ze(t.kind).payload,u=c.colorSlot?.baseColorHex??"#FFFFFF",h=y=>c[y],f,g;switch(t.kind){case"text":{let y=ta(e.config,t.payload.value);f=p`
        ...
        <div class="hint">An entity source draws that entity's own icon instead.</div>`,g=pi(e,t,n,"Icon size",{step:1,min:4,def:h("size")});break;case"gauge":{let y=t.payload,k=(G,A)=>o(D=>G(D.payload),A),q=y.style==="dots";f=p`
        ${ae(e,y.value,G=>k(A=>{A.value=G},"value"),{showResolved:!0,label:"Reading",key:`${r}-value`})}
        ${q?p`
            ${ae(e,y.total??Ss(y),G=>k(A=>{A.total=G},"total"),{showResolved:!0,label:"Total",key:`${r}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Nn} dots are drawn.</div>`:p`
            <div class="grid2">
              ${Z("Min",y.minValue,G=>k(A=>{A.minValue=G??0},"min"),{def:c.minValue})}
              ${Z("Max",y.maxValue,G=>k(A=>{A.maxValue=G??100},"max"),{def:c.maxValue})}
            </div>`}`,g=p`
        <div class="grid2">
          ${ne("Style",y.style,Yc,G=>k(A=>{G==="dots"&&A.total===void 0&&(A.total=Ss(A)),G!=="dots"&&delete A.total,A.style=G}),{titles:Jc,def:c.style})}
          ${q?m:pi(e,t,n,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        ${oe(q?"Empty dot colour":"Track colour",y.trackColorHex,G=>k(A=>{A.trackColorHex=G??"#FFFFFF40"},"track"),!1,c.trackColorHex)}
        ${ne("Colour",y.coloring,ks,G=>k(A=>{A.coloring=G,G==="bands"&&A.bands.length===0&&(A.bands=$s([A.minValue,A.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
        ...
        ${q?m:p`
          <div class="grid2">
            ${Z("Threshold",y.thresholdValue,G=>k(A=>{G===void 0?delete A.thresholdValue:A.thresholdValue=G},"thr"),{optional:!0})}
            ${y.thresholdValue===void 0?m:oe("Threshold colour",y.thresholdColorHex,G=>k(A=>{A.thresholdColorHex=G??Ot},"thrcol"),!1,Ot)}
          </div>
        ...
        ${D?p`
            ...
            <div class="grid2">
              ${Hs(i,y.historyMinutes,G,R=>k(H=>{H.historyMinutes=R}))}
              <div class="field readings-field">${et("Readings",{atDefault:y.historyPoints===A,title:`Back to ${A<1?"every one":`${A} averaged`}`,reset:()=>k(R=>{R.historyPoints=A})})}
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Readings">
                    ...
                    <button type="button" role="radio" aria-checked=${ke?"true":"false"} class=${ke?"on":""}
                      ...
                      @click=${()=>{ke||k(R=>{R.historyPoints=ji})}}>Every one</button>
                  </div>
                  ${ke?m:p`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    step="1" min=${Wi} max=${Dn}
                    @input=${xe(R=>{let H=Number(R);R.trim()!==""&&Number.isFinite(H)&&H>=1&&k(Ti=>{Ti.historyPoints=Math.round(H)},"hpoints")})} />`}
                </div>
              </div>
            </div>
            ${en?Ls(y.historyMinutes,R=>k(H=>{H.historyMinutes=R},"span")):m}
            <div class="hint">${ke?p`Every state the recorder holds in that span, oldest first, one reading per change,
                  and a chatty sensor keeps its newest ${Dn}. The time axis follows
        ...
        ${ee.length>0?p`<div class="hint">Reads <span class="nums">${bu(de)}</span>${ee.length===de.length?p` · ${de.length} ${de.length===1?"value":"values"}`:p` · ${de.length} of ${ee.length}`}</div>`:m}
        ...
        <div class="grid2">
          ${Z("Use",y.limit,R=>k(H=>{H.limit=Math.max(0,Math.round(R??0))},"limit"),{step:1,min:0,def:c.limit})}
          ${ne("From",y.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],R=>k(H=>{H.takeFromEnd=R==="end"}),{def:c.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        <div class="grid2">
          ${ne("Style",y.style,Vc,R=>k(H=>{H.style=R}),{def:c.style})}
          ${y.style==="bars"?Z("Bar gap (pt)",y.barGap,R=>k(H=>{H.barGap=Math.max(0,R??0)},"gap"),{step:.5,min:0,def:c.barGap}):pi(e,t,n,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        <div class="grid2">
          ${ne("Scale",y.scale,Bc,R=>k(H=>{H.scale=R}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ne("Baseline",y.baseline,Gc,R=>k(H=>{H.baseline=R}),{def:c.baseline})}
        </div>
        ${Si.length===0?m:Fe("Same scale as",Ei?y.scaleFrom:"",[["","Its own"],...Si.map(R=>[R.payload.id,Re(R,Al)])],R=>k(H=>{R?H.scaleFrom=R:delete H.scaleFrom}),{def:""})}
        ...
        ${!Ei&&y.scale==="fixed"?p`<div class="grid2">
              ${Z("Min",y.minValue,R=>k(H=>{H.minValue=R??0},"cmin"),{def:c.minValue})}
              ${Z("Max",y.maxValue,R=>k(H=>{H.maxValue=R??100},"cmax"),{def:c.maxValue})}
            </div>`:m}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let R;e.update(H=>{R=ho(H,i)}),R&&e.selectLayer(R)}}>
          ${z("plus")}<span>Second series</span></button>
        ${ne("Colour",y.coloring,ks,R=>k(H=>{H.coloring=R,R==="bands"&&H.bands.length===0&&(H.bands=$s(de))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${y.style==="area"?p`${Ae("Fill follows the bands",y.fillBands,R=>k(H=>{H.fillBands=R}),c.fillBands)}
        ...
        <div class="grid2">
          ${ne("Highlight",y.highlight,Ws,R=>k(H=>{H.highlight=R}),{def:c.highlight})}
          ${y.highlight==="none"?m:ne("Marker",y.marker,Uc,R=>k(H=>{H.marker=R}),{def:c.marker})}
        </div>
        ${y.highlight==="none"?m:p`
          <div class="grid2">
            ${y.highlight==="lowest"?m:oe("Highest colour",y.highColorHex,R=>k(H=>{H.highColorHex=R??mn},"hicol"),!1,mn)}
            ${y.highlight==="highest"?m:oe("Lowest colour",y.lowColorHex,R=>k(H=>{H.lowColorHex=R??fn},"locol"),!1,fn)}
          </div>
        ...
        ${Ae("Threshold line",y.thresholdValue!==void 0,R=>k(H=>{R?H.thresholdValue=Kc(de):delete H.thresholdValue}))}
        ${y.thresholdValue===void 0?m:p`
          <div class="grid2">
            ${Z("At",y.thresholdValue,R=>k(H=>{H.thresholdValue=R??0},"thval"))}
            ${oe("Line colour",y.thresholdColorHex,R=>k(H=>{H.thresholdColorHex=R??Dt},"thcol"),!1,Dt)}
          </div>
        ...
        ${Ae("\u201CNow\u201D marker",y.nowIndex!==void 0,R=>k(H=>{R?H.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete H.nowIndex}))}
        ${y.nowIndex===void 0?m:p`
          ${ae(e,y.nowIndex,R=>k(H=>{H.nowIndex=R},"nowidx"),{showResolved:!0,label:"Reading number",key:`${r}-nowindex`})}
          ${oe("Marker colour",y.nowColorHex,R=>k(H=>{H.nowColorHex=R??Vt},"nowcol"),!1,Vt)}
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=t.payload,k=(ee,de)=>o(Ci=>ee(Ci.payload),de),q=c.historyMinutes,G=y.value.kind.kind==="entityState",A=kt(y),D=A===void 0?void 0:e.historySeries(A),O=Ue(y)*60,re=wn(D??"",dt),Qt=Ga(i,y.historyMinutes),ke=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,en=jc(re,O,ke===void 0?void 0:e.hass.states[ke]?.state,ke?.split(".")[0]);f=p`
        ...
        ${Hs(i,y.historyMinutes,q,ee=>k(de=>{de.historyMinutes=ee}))}
        ${Qt?Ls(y.historyMinutes,ee=>k(de=>{de.historyMinutes=ee},"span")):m}
        ...
        ${re.length>0?p`<div class="hint">Reads <span class="nums">${$u(re,O)}</span></div>`:m}
        ${ku(re)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${qc(y,k,en,`wa-tl-states-${r.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${t.payload.kind==="line"?wu(n,l,d):m}`,g=t.payload.kind==="line"?Z("Thickness (pt)",t.payload.thickness,y=>o(k=>{k.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let x=t.kind==="image"||t.kind==="tap"||t.kind==="timeline"?void 0:oe(t.kind==="shape"?"Fill colour":"Colour",t.payload.colorSlot.baseColorHex,y=>o(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,u),$=sa(e.config,t),S=$?{kind:{kind:"entityState",...$}}:void 0,E=he[t.kind],v=t.kind==="tap"?void 0:Me(e.config,i)[0],C=t.kind==="image"?t.payload.timestamp===!0:!1,N=Su[t.kind],B=Eu[t.kind],j=Is(t.payload,c,N),se=t.kind==="text"?"fontSize":t.kind==="icon"?"size":t.kind==="gauge"||t.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[n]?.placements[i]?.size!==void 0,T=Is(t.payload,c,B)||se!==void 0&&s.size!==void 0&&s.size!==c[se],V=!yi(l,Ge)||s.isHidden,P=$t(e.config,i),le=(y,k)=>()=>o(q=>As(q.payload,c,y),k);return p`
    ${Ce(e,"content","Content",p`${t.kind==="tap"?m:pu(e,t,r)}${f}`,{color:E,icon:"content",summary:qa(e,t),...j?{reset:le(N,"reset-content")}:{}})}
    ...
    ${t.kind==="chart"?Ce(e,"numbers","Numbers",Mu(e,t),{color:he.text,icon:"text",summary:Ru(e,t),...P.length>0?{reset:()=>e.update(y=>{for(let k of $t(y,i))Ct(y,k.payload.id)})}:{}}):m}
    ${t.kind==="image"?Ce(e,"timestamp","Timestamp",yu(t.payload,(y,k)=>o(q=>y(q.payload),k)),{color:E,icon:"clock",summary:C?`Shown \xB7 ${t.payload.timestampSize} pt`:"Hidden",...C?{reset:le(Cu,"reset-stamp")}:{}}):m}
    ${t.kind==="tap"?m:Ce(e,"tappable","Tap",Iu(e,t,r),{color:Q.tap,icon:"tap",summary:v?We(v.payload.action):"Not tappable",...v?{reset:()=>e.update(y=>Wn(y,i))}:{}})}
    ${Ce(e,"states","States",ml(e,t.payload.rules,t.kind,y=>y.elements.find(k=>k.payload.id===i)?.payload.rules,`rules-${i}`,S),{color:Q.states,icon:"states",summary:Cn(t.payload.rules).replace(/\.$/,""),...t.payload.rules.length>0?{reset:()=>o(y=>{y.payload.rules=[]})}:{}})}
    ${Ce(e,"placement","Place",p`
      ...
      <div class="hint">Drag the layer on the ${Y(n)} preview to move it, or pull a
      ...
      <div class="hint">Everything about where this layer sits, how big it is drawn and whether it
        shows belongs to the ${Y(n)} shape alone. Pick another shape above to place
        the same layer differently there.</div>`,{color:Q.place,icon:"place",summary:`${Math.round(l.width*100)}% wide \xB7 ${Y(n)}${s.fromPlacement?"":" \xB7 shared frame"}`,...V?{resetTitle:`Put this layer back to the middle of the ${Y(n)} face at half size, unrotated and shown`,reset:()=>e.update(y=>Ee(y,n,i,{frame:{...Ge},isHidden:!1}))}:{}})}`}var Cu=["timestamp","timestampCorner","timestampSize"],Su={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Eu={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function sl(e,t,n,i){let a=t.action;return p`
    ${Fe("Tap action",a.type,ru,r=>n(o=>{o.action=Xs(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?el(e,t.openPageId,t.openPageName,(r,o)=>n(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):m}`}var Tu=24;function Fu(e,t){let n=[],i=1/0;for(let r of te){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=uo(e.config,t,r);o&&(n.push(`${Y(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(n.length===0)return m;let a=i<Tu;return p`<div class=${a?"hint warn":"hint"}>${n.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Ru(e,t){let n=$t(e.config,t.payload.id);return n.length===0?"None yet":n.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Pt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Mu(e,t){let n=fe(e),i=$t(e.config,t.payload.id),a=o=>e.update(s=>{io(s,t.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    <div class="hint">The newest reading starts with the entity's unit after it. The ends of the scale come from the plot's range, so on a Fixed scale they print the Min and Max above.</div>`}function Iu(e,t,n){if(t.kind==="tap")return m;let i=t.payload.id,a=Me(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${n}-${l}`:void 0),o=la(e.config,t);return p`
    ${Ae("Tappable",a!==void 0,s=>e.update(l=>{s?Kn(l,i):Wn(l,i)}))}
    ${a?p`<div class="value-editor">
        ...
        ${Fu(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${We(o)}</b>.</div>`}`}function _s(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Re(e,t){switch(e.kind){case"text":return _s(me(e.payload.value,t));case"icon":return _s(me(e.payload.symbol,t));case"gauge":return me(e.payload.value,t);case"chart":return me(e.payload.value,t);case"timeline":return me(e.payload.value,t);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let n=e.payload.entity;return n.displayName||n.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let n=e.payload.action,i="entityId"in n?n.displayName||n.entityId:n.type==="callService"?[n.serviceDomain,n.serviceName].filter(a=>a!=="").join("."):n.type==="openPage"&&e.payload.openPageName||"";return i?`${n.type} \xB7 ${i}`:n.type}}}function ll(e,t){let n=qe(e.config,t.id),i=fe(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===t.id);l&&r(l)},o?`group-${t.id}-${o}`:void 0);return Ce(e,"content","Group",p`
    ...
    </div>`,{color:Q.group,icon:"folder",summary:`${n.length} layers \xB7 ${t.locked?"moves as one":"unlocked"}`})}function dl(e,t){if(t==="inline")return Au(e);let n=e.config.perFamily[t];if(!n)return p`<div class="hint">No settings stored for ${Y(t)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[t]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Y(t)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[t]),l?`fam-${t}-${l}`:void 0),a=wi(e.config,t),r=n.backgroundColorHex?Se(n.backgroundColorHex):"transparent",o=n.borderColorHex?`${n.borderWidth} pt ${Se(n.borderColorHex)} border`:"no border";return p`
    ${Ce(e,"look",`${Y(t)} shape`,p`
    ...
    ${Ce(e,"states","Shape states",ml(e,n.rules,"layout",s=>s.perFamily[t]?.rules,`rules-${t}`),{color:Q.states,icon:"states",summary:Cn(n.rules).replace(/\.$/,""),...n.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ${Ce(e,"placements","Placements",p`
      <div class="hint">${a===0?`Nothing is on the ${Y(t)} shape. The Layers card offers to copy another shape's whole arrangement onto it.`:`${a} layer${a===1?" is":"s are"} on the ${Y(t)} shape, each with its own frame and size here.`}</div>`,{color:Q.place,icon:"place",summary:a===0?"Nothing placed":`${a} layer${a===1?"":"s"} placed`})}`}function Au(e){let t=e.config.inline;if(!t)return p`<div class="hint">This complication lists Inline but has no Inline text yet (it was saved by an older integration). The watch shows "No inline layout" until one is added.</div>
    ...
    ${a==="gauge"&&t.bezelGauge?Lu(e,t.bezelGauge,n):m}`}function Lu(e,t,n){let i=[t.colorHexes[0]??"#34C759",t.colorHexes[1]??t.colorHexes[t.colorHexes.length-1]??"#FFCC00",t.colorHexes[t.colorHexes.length-1]??"#FF3B30"],a=r=>o=>n(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${Ae("End number labels",!!(t.minLabel||t.maxLabel),r=>n(o=>{let s=o.bezelGauge;r?(s.minLabel=M(String(s.minValue)),s.maxLabel=M(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${t.minLabel?ae(e,t.minLabel,r=>n(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):m}
    ${t.maxLabel?ae(e,t.maxLabel,r=>n(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):m}`}var Cm=te.map(e=>[e,Y(e)]),Ya={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},_u=Object.keys(Ya);function zu(e){let t=qn[e];return _u.filter(n=>t.includes(Te[n]))}var Nu={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function hi(e,t){if(e.entityId==="")return"(no entity)";let n=e.displayName.trim();if(n!==""&&n!==e.entityId)return n;let i=t?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function pt(e,t){let n=e.replace(/\s+/g," ").trim();return n.length>t?`${n.slice(0,t-1)}\u2026`:n}function Pu(e){if(!e||Ne(e))return"";let t=[];return e.decimals!==void 0&&t.push(`${e.decimals} dp`),e.multiply!==void 0&&t.push(`\xD7${e.multiply}`),e.offset!==void 0&&t.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&t.push(`"${e.prefix}" first`),e.suffix&&t.push(`"${e.suffix}" after`),e.useEntityUnit&&t.push("with unit"),e.relativeTime&&t.push("as relative time"),e.duration&&t.push("as a duration"),e.textCase&&t.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),t.length===0?"":` (${t.join(", ")})`}function me(e,t){return`${cl(e,t)}${Pu(e.format)}`}function cl(e,t){let n=e.kind;switch(n.kind){case"literal":return n.value?`"${pt(n.value,40)}"`:"(empty)";case"entityState":return hi(n,t);case"entityAttribute":return n.attribute?`${hi(n,t)} \xB7 ${n.attribute}`:hi(n,t);case"entityAge":return`age of ${hi(n,t)}`;case"aggregate":return Ou(n.aggregate);case"time":return Nu[n.timeField];case"dataAge":return"data age";case"jinja":return n.value?`template ${pt(n.value,32)}`:"template (empty)";case"named":return n.id===""?"(no value chosen)":t?.values?.find(a=>a.id===n.id)?.name?.trim()||`named ${n.id.slice(0,8)}`;case"chartStat":{let i=(Pt.find(([o])=>o===n.stat)?.[1]??n.stat).toLowerCase();if(n.layer==="")return`${i} (no chart chosen)`;let a=t?.elements?.find(o=>o.kind==="chart"&&o.payload.id===n.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?cl(a.payload.value,t):"a missing chart";return`${i} of ${r}`}}}function Ou(e){let t=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${t}`}function xi(e,t,n){if(n<0||n>=e.length)return;let[i]=e.splice(t,1);e.splice(n,0,i)}function Du(e,t,n,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${t.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${n==="layout"?"family":"layer"} looks.</div>`:m}
    ${t.map((o,s)=>Vu(e,o,s,t.length,n,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(vn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function Vu(e,t,n,i,a,r,o){let s=e.liveBranch(t),l=e.forced.get(t.id)??"live",d=u=>l==="live"?u==="live":l==="otherwise"?u==="otherwise":l.caseId===u,c=(u,h)=>r(f=>{let g=f.find(x=>x.id===t.id);g&&u(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${n+1}</b>
      <span class="spacer"></span>
    ...
    ${t.cases.map((u,h)=>Bu(e,u,h,t,a,c,`${o}-${u.id}`))}
  ...
  </div>`}function Bu(e,t,n,i,a,r,o){let s=(d,c)=>r(u=>{let h=u.cases.find(f=>f.id===t.id);h&&d(h)},c),l=e.liveBranch(i)===t.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
    ...
    ${t.when.tests.map((d,c)=>Gu(e,d,c,u=>s(h=>{let f=h.when.tests.find(g=>g.id===d.id);f&&u(f)}),()=>s(u=>{u.when.tests=u.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    ...
    ${ul(e,t.then,a,d=>s(c=>d(c.then)),`${o}-then`)}
  </div>`}function Gu(e,t,n,i,a,r){let o=(u,h)=>i(u,h?`${r}-${h}`:void 0),s=t.comparison,l=St(s.kind),d=e.evaluateTest(t),c=m;switch(l){case"value":c=ae(e,s.value??M(""),u=>o(h=>{h.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=p`${ae(e,s.value??M(""),u=>o(h=>{h.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ...
        ${s.pattern&&!Uu(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:m}`;break;case"options":c=pe("Options (comma separated)",(s.options??[]).join(", "),u=>o(h=>{h.comparison.options=u.split(",").map(f=>f.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${Fe("Comparison",s.kind,go.map(u=>[u,Yt[u]]),u=>o(h=>{h.comparison=ma(h.comparison,u)}))}
    ${c}
  </div>`}function Uu(e){try{return new RegExp(e),!0}catch{return!1}}function ul(e,t,n,i,a){let r=zu(n);return p`
    ${t.length===0?p`<div class="hint">No changes.</div>`:m}
    ${t.map((o,s)=>Ku(e,o,s,n,(l,d)=>i(c=>{c[s]&&l(c[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Et(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${Ya[o]}</option>`)}
    </select>`}var pl=["setColor","setBorderColor","setBackgroundColor"];function Ku(e,t,n,i,a,r,o){let s=!qn[i].includes(Te[t.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${hl(e,t,a,o)}
  </div>`}function hl(e,t,n,i){let a=Yn(t.kind),r=m;if(a==="value"){let o=t.value??M("");if(pl.includes(t.kind)){let s=o.kind.kind==="literal";r=p`${s?oe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>n(d=>{d.value=M(l??"#FFFFFF")},"color")):ae(e,o,l=>n(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${Du(e,t,n,i,a)}`:Wu(e,o.table,t[0],n,i,a,r)}function Wu(e,t,n,i,a,r,o){let s=(w,T)=>e.update(V=>{let P=a(V);P&&w(P)},T?`${r}-${T}`:void 0),l=t.value??zs.get(r)??o,d=t.rows.length===0,c=t.numberMode||d&&l!==void 0&&!cs(l)&&ju(e.resolve(l)),u=qn[i],h=mi.get(r)??new Set,f=t.columns.length===0&&h.size===0?[ds[i]]:[],g=es(t.columns,[...h,...f.filter(w=>w!==void 0)],u),x=n?e.liveBranch(n):"none",$=n?e.forced.get(n.id)??"live":"live",S=w=>$!=="live"&&($==="otherwise"?w==="otherwise":$.caseId===w),E=w=>{n&&e.setForced(n.id,S(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},v=w=>{zs.set(r,w),t.rows.length!==0&&s(T=>os(T,w),"lhs")},C=()=>s(w=>as(w,l??M(""),c)),N=t.rows.map((w,T)=>Ps(e,{key:`${r}-${w.caseId}`,label:ls(w.comparison,V=>me(V,fe(e))),columns:g,changes:w.changes,live:x===w.caseId,forced:S(w.caseId),onForce:()=>E(w.caseId),when:Zu(e,w.comparison,`${r}-${w.caseId}`,(V,P)=>s(le=>{let y=le[0]?.cases.find(k=>k.id===w.caseId)?.when.tests[0];y&&V(y.comparison)},P&&`${w.caseId}-${P}`)),updChanges:(V,P)=>s(le=>{let y=le[0]?.cases.find(k=>k.id===w.caseId);y&&V(y.then)},P&&`${w.caseId}-${P}`),acts:p`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>s(V=>rs(V,w.caseId))}>${z("delete")}</button>`})),B=t.otherwise===void 0?m:Ps(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:t.otherwise,live:x==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,T)=>s(V=>{let P=V[0]?.otherwise;P&&w(P)},T),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>za(w,!1))}>${z("close")}</button>`}),j=fi.get(r),se=qu.filter(w=>u.includes(w)&&!g.includes(w));return p`
    <div class="states">
      ...
      ${j===void 0?m:p`<div class="hint warn confirm-row">
        Remove the ${Ze[j]} column? Its ${Ns(t,j)} value${Ns(t,j)===1?"":"s"} are deleted from every state.
      ...
      <div class="states-foot">
        ...
        ${se.length===0?m:p`<select class="chip-add" title="Add a column" @change=${w=>{let T=w.target,V=T.value;if(T.value="",!V)return;let P=mi.get(r)??new Set;P.add(V),mi.set(r,P),Ie(T)}}>
          ...
          ${se.map(w=>p`<option value=${w}>${Ze[w]}</option>`)}
        </select>`}
      </div>
    ...
    </div>`}function ju(e){let t=(e??"").trim();return t!==""&&Number.isFinite(Number(t))}var qu=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Ns(e,t){let n=0;for(let i of e.rows)oi(i.changes,t)&&(n+=1);return e.otherwise&&oi(e.otherwise,t)&&(n+=1),n}function Yu(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Ps(e,t){return p`<tr class="state-row ${t.live?"live":""} ${t.forced?"forced":""}"
    title=${`${t.label}. Click to hold the previews on this state.`}
    @click=${n=>{Yu(n)||t.onForce()}}>
    <td class="when">
    ...
    ${t.columns.map(n=>p`<td>${Ju(e,n,t.changes,t.updChanges,`${t.key}-${n}`)}</td>`)}
    <td class="acts">${t.acts}</td>
  </tr>`}function Ju(e,t,n,i,a){let r=oi(n,t),o=Wa(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${Ze[t]} for this state`}
      @click=${d=>{i(c=>{c.push(Et(Qo[t]))}),tu(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let h=u.find(f=>Te[f.kind]===t);h&&d(h)},c&&`${t}-${c}`),l=Ze[t];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Xu(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${qs}>
      ...
      ${En.has(o)?p`${t==="visibility"?ne("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):hl(e,r,s,a)}
    ...
    <select class="when-op" title="How this state is decided" @change=${xe(s=>i(l=>{let d=ma(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Aa.map(s=>p`<option value=${s} ?selected=${s===t.kind}>${Qu(s)}</option>`)}
    </select>
    ...
    ${js(e,s,o,t,n,l)}
  </span>`}var Tn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:oa,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function bl(e){return Tn.find(t=>t.kind===e)??Tn[0]}var fl="#FF9F0A",ki="#8E8E93",tp=["#FF453A","#FFD60A","#34C759"],vl=["#0A84FF","#34C759","#FF9F0A"];function np(e){return e?.attributes?.device_class==="battery"?tp:vl}var ip={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function ap(e){let t=e.iconName?.trim();return t?{off:t,on:t}:ip[Ja(e)]??{off:"circle",on:"circle.fill"}}function rp(e){switch(Ja(e)){case"lock":return{kind:"equals",value:M("locked")};case"cover":case"valve":return{kind:"equals",value:M("open")};case"media_player":return{kind:"equals",value:M("playing")};default:return{kind:"isOn"}}}function Ja(e){return e.domain||e.entityId.split(".")[0]||""}function ft(e){return{...e,domain:Ja(e)}}function op(e){let t=e?.attributes??{},n=t.min,i=t.max;if(typeof n=="number"&&typeof i=="number"&&i>n)return{min:n,max:i};let a=typeof t.device_class=="string"?t.device_class:"",r=typeof t.unit_of_measurement=="string"?t.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Zt(e){return Math.round(e*1e4)/1e4}function Ht(e,t,n){return Math.min(n,Math.max(t,e))}function Xa(e,t,n){let i=ve[e],a=Ht(Zt(t/i.width),0,1),r=Ht(Zt(n/i.height),0,1);return{x:Zt((1-a)/2),y:Zt((1-r)/2),width:a,height:r,rotationDegrees:0}}function sp(e){let t=ve[e],n=Ht(Math.round(Math.min(t.width,t.height)*.55),12,30);return{frame:Xa(e,n*1.3,n*1.3),size:n}}function lp(e){let t=ve[e],n=Ht(Math.round(Math.min(t.width,t.height)*.3),9,20);return{frame:Xa(e,t.width*.88,n*1.7),size:n}}function dp(e){let t=ve[e],n=Math.min(t.width,t.height)*.9;return{frame:Xa(e,n,n),size:Math.max(2.5,Math.round(n*.2)/2)}}function xl(e){let t=e==="rectangular";return{frame:{x:.05,y:t?.34:.3,width:.9,height:t?.42:.4,rotationDegrees:0},size:2}}function cp(e){let t=ve[e],n=Ht(Math.round(t.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Zt(n/t.height),rotationDegrees:0}}}function up(e){let t=ve[e],n=Ht(Math.round(Math.min(t.width,t.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Zt(Ht(n*1.5/t.height,0,1)),rotationDegrees:0},size:n}}function pp(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function hp(e,t){t!==void 0&&(e.kind==="text"?e.payload.fontSize=t:e.kind==="icon"?e.payload.size=t:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=t))}function ht(e,t,n,i){let a=i(n);t.payload.frame=a.frame,hp(t,a.size);for(let r of te){if(r===n||r==="inline")continue;let o=e.perFamily[r];if(!o)continue;let s=i(r);JSON.stringify(s)!==JSON.stringify(a)&&(o.placements[t.payload.id]={frame:s.frame,isHidden:!1,...s.size!==void 0?{size:s.size}:{}})}}function mt(e){return ze(e)}function Za(e,t){let n={kind:{kind:"entityState",...ft(e)}},i=t?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(n.format={useEntityUnit:!0}),n}function gl(e){let t=Et("setIcon");return t.value=M(e),t}function At(e){let t=Et("setColor");return t.value=M(e),t}function mp(e,t){let n=vn(),i=n.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...ft(e)}},a.comparison=rp(e);let r=t.on!==t.off;return i.then=r?[gl(t.on),At(fl)]:[At(fl)],n.otherwise=r?[gl(t.off),At(ki)]:[At(ki)],n}function fp(e){let t=vn(),n=t.cases[0],i=n.when.tests[0];i.value={kind:{kind:"entityState",...ft(e)}},i.comparison={kind:"isUnavailable"};let a=Et("setOpacity");return a.number=.35,n.then=[a],t}function yl(e){let t=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(t)}function gp(e,t,n=vl){let i=t.max-t.min,a=yl(t.min+i/3),r=yl(t.min+i*2/3),o=[{comparison:{kind:"lessThan",value:M(a)},changes:[At(n[0])]},{comparison:{kind:"between",value:M(a),upper:M(r)},changes:[At(n[1])]},{comparison:{kind:"greaterThan",value:M(r)},changes:[At(n[2])]}];return ts(Za(e),o)}function yp(e,t,n){let i=mt("icon"),a=ap(t);return i.payload.symbol=M(a.off),i.payload.colorSlot.baseColorHex=ki,i.payload.rules=[mp(t,a)],ht(e,i,n.family,sp),e.elements.push(i),Kn(e,i.payload.id,{type:"toggleEntity",...ft(t)}),i.payload.id}function bp(e,t,n){let i=mt("text");return i.payload.value=Za(t,n.state),i.payload.rules=[fp(t)],ht(e,i,n.family,lp),e.elements.push(i),i.payload.id}function vp(e,t,n){let i=mt("gauge");i.payload.value=Za(t);let a=op(n.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[gp(t,a,np(n.state))],ht(e,i,n.family,dp),e.elements.push(i),i.payload.id}function xp(e,t,n){let i=mt("chart");return i.payload.value={kind:{kind:"entityState",...ft(t)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",ht(e,i,n.family,xl),e.elements.push(i),i.payload.id}function wp(e,t,n){let i=mt("chart");return i.payload.value={kind:{kind:"entityState",...ft(t)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",ht(e,i,n.family,xl),e.elements.push(i),i.payload.id}function kp(e,t,n){let i=ft(t),a=mt("text");a.payload.value=M(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=ki,ht(e,a,n.family,up),e.elements.push(a);let r=n.state?.attributes?.device_class,o=mt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Xi(i.domain,typeof r=="string"?r:void 0),ht(e,o,n.family,cp),e.elements.push(o),o.payload.id}function $p(e,t,n){let i=mt("image");return i.payload.entity=ft(t),ht(e,i,n.family,pp),e.elements.push(i),i.payload.id}function wl(e,t,n,i){switch(t){case"toggle":return yp(e,n,i);case"status":return bp(e,n,i);case"gauge":return vp(e,n,i);case"chart":return xp(e,n,i);case"history":return wp(e,n,i);case"doorHistory":return kp(e,n,i);case"camera":return $p(e,n,i)}}var Sp=3e4,Ep=500,kl="preset-entity",Tp={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Qa(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Fp(e){return e.kind==="family"?"look":"content"}function Rp(e){let t=e.document?.supportedFamilies;return Array.isArray(t)?t.filter(n=>typeof n=="string"):[]}var $l=300,Cl=400,Sl=52,El=36,Mp=[1,1.7,2.6],Ip=["S","M","L"],Tl=["Small","Medium","Large"],Fl="wrist-assistant-panel.layers.v1",tt=34,Lt=200,Ap=720,$i=320,Hp=80,Lp=56,Rl="wrist-assistant-panel.columns.v2",er=e=>Math.max(Lt,Math.min(Ap,Math.round(e))),Ml=e=>e.metaKey||e.ctrlKey||e.shiftKey,_p=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Fn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",De=Fn==="Cmd"?"\u2318":"Ctrl+",tr=Fn==="Cmd"?"\u21E7":"Shift+";function Il(e,t,n){if(e<=0)return{columns:3,left:t,right:n};let i=e-Hp;if(i>=Lt*2+$i){let r=i-$i,o=t,s=n;if(o+s>r){let l=r/(o+s);o=Math.max(Lt,Math.floor(o*l)),s=Math.max(Lt,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Lt,o-d):s=Math.max(Lt,s-d))}return{columns:3,left:o,right:s}}let a=e-Lp;return a>=Lt+$i?{columns:2,left:Math.min(t,a-$i),right:n}:{columns:1,left:t,right:n}}var I=class I extends it{constructor(){super(...arguments);this.narrow=!1;this.colLeft=$l;this.colRight=Cl;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.previewCase=$n.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=jo(()=>this.requestUpdate());this.imageSizes=qo(()=>this.requestUpdate());this.symbols=new ii(()=>this.requestUpdate());this.keyHandler=n=>this.onKey(n);this.heldArrows=new Set;this.keyUpHandler=n=>{this.heldArrows.delete(n.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.sizeObserver=new ResizeObserver(n=>{let i=n[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=n=>{this.draft?.dirty&&n.preventDefault()};this.pickerOutside=n=>{n.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.presetKeys={handleEvent:n=>{n.key==="Enter"&&(this.presetEntity===void 0||Us(kl)||(n.preventDefault(),n.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Ri`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let n=window.localStorage.getItem(Rl);if(!n)return;let i=JSON.parse(n);typeof i.left=="number"&&(this.colLeft=er(i.left)),typeof i.right=="number"&&(this.colRight=er(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Rl,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let n=window.localStorage.getItem(Fl);if(!n)return;let i=JSON.parse(n);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Fl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(n){return p`<div class="gutter ${n}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              title=${`Put every layer on the ${Y(i)} shape where it sits on the ${Y(o)} one, scaled to this canvas`}
              @click=${()=>this.mutate(s=>al(s,o,i))}>Copy the ${Y(o)} layout</button>`)}
          </div>
      ...
      ${this.pickerOpen?p`<div class="menu" role="listbox">
        ...
        ${this.hass.user?.is_admin?p`
          ...
          ${this.newShapeChooser&&s>=0?p`<div class="new-shape">
            ...
            <div class="adders">
              ${jt.map(l=>p`<button class="small ${l==="rectangular"?"primary":""}" @click=${()=>{this.togglePicker(!1),this.createNew(l)}}>${Y(l)}</button>`)}
            </div>
          </div>`:m}`:m}
      </div>`:m}
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Ra.map(s=>p`<button class="add" style=${`--k:${he[s]}`} ?disabled=${i} title=${`Add a blank ${qt[s].toLowerCase()} layer`}
              ...
              >${r?p`<span class="well">${ps(s)}</span>`:m}<span class="add-name">${z(s)}<span>${qt[s]}</span></span></button>`)}
          </div>
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(w,d)}</b>
          <small><span class="kind">${qt[w.kind]}</span> · ${Op(w,c,this.historySeries,y.size)}</small>
          ${C?p`<span class="facts">${Np(this.host(),a,w,y).map(O=>p`<span class="fact"><b>${O.label}</b> ${O.value}</span>`)}</span>`:m}
        </span>
        <span class="right">
          <span class="badges">
      ...
      </div>`},B=(w,T)=>{let V=this.inspect.kind==="group"&&this.inspect.id===w.id,P=!this.collapsed.has(w.id),le=this.rowDrag(w.id,i),y=T[0],k=T[T.length-1],q=A=>{let D=A.currentTarget,O=D.getBoundingClientRect(),re=O.top+(D.classList.contains("drop-before")?tt:0),Qt=O.bottom-(D.classList.contains("drop-after")?tt:0),ke=(A.clientY-re)/Math.max(1,Qt-re);return ke<.25?"drop-before":!P&&ke>.75?"drop-after":"drop-into"},G=T.map(A=>A.payload.id);return p`<div class="layer group ${V?"hl":""} ${C?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${le.draggable}
        ...
        @drop=${A=>{A.preventDefault();let D=q(A);this.clearDragMarks();let O=this.dragId;if(this.dragId=void 0,!(!O||!y||!k)){if(D==="drop-before"){this.reorderLayer(O,y.payload.id,!0,!0);return}if(D==="drop-after"){this.reorderLayer(O,k.payload.id,!1,!0);return}this.isGroupId(O)||(this.reorderLayer(O,y.payload.id,!0),this.mutate(re=>ia(re,O,w.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${T.map(A=>Re(A,d)).join(", ")}</span></span>`:m}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${tr}${De}G)`} aria-label="Ungroup" @click=${A=>{A.stopPropagation(),this.mutate(D=>yn(D,w.id)),V&&(this.inspect={kind:"general"})}}>${z("ungroup")}</button>
          </span>`:m}
          <button class="icon lockbtn ${w.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${A=>{A.stopPropagation(),this.mutate(D=>{let O=D.groups?.find(re=>re.id===w.id);O&&(O.locked=!O.locked)})}}>${z(w.locked?"lock":"unlock")}</button>
        </span>
      ...
      ${n===void 0?m:p`
        ...
        ${Qe(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},kl,{compact:!0,...n.domains?{domain:n.domains}:{},...n.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
      ...
      <div class="tiles">
        ${jt.map(r=>{if(!a.includes(r))return p`<button class="tile off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${Y(r)} shape`} @click=${()=>this.addShape(r)}>
              <span class="art"><span class="ghost ${r}"></span></span>
              <span class="lbl">+ Add ${Y(r)}</span>
            ...
            <button class="tile ${r}" aria-pressed=${s?"true":"false"} title=${`Edit the ${Y(r)} shape`}
              @click=${()=>{this.activeFamily=r,r==="inline"&&this.inspect.kind==="layer"&&(this.inspect={kind:"family"})}}>
              <span class="art">${l}</span>
              <span class="lbl">${Y(r)}${d?p`<small>· nothing shown</small>`:m}${s?p`<small>· editing</small>`:m}</span>
            </button>
            ${this.canEdit?p`<button class="icon danger tile-x" ?disabled=${!c}
              title=${c?`Remove the ${Y(r)} shape`:"The only shape. Add another before removing it."}
      ...
      <div class="insp-head">
        ${this.crumbs(n)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([Fp(r)]):new Set(Ka)}}>${l?"One at a time":"Open all"}</button>`:m}
      </div>
      ...
      <div class="sec" data-open="true" style=${`--c:${Q.place}`}>
        ...
        <div class="sec-b">
          ${this.triCheck(`Hidden in ${Y(a)}`,s.hiddenHere,c)}
          ...
          <div class="hint">Hiding, like size and place, belongs to the ${Y(a)} shape alone.</div>
