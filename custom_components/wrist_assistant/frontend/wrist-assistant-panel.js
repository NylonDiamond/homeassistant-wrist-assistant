var Cp=Object.defineProperty;var Sp=Object.getOwnPropertyDescriptor;var N=(e,n,t,i)=>{for(var a=i>1?void 0:i?Sp(n,t):n,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(n,t,a):o(a))||a);return i&&a&&Cp(n,t,a),a};var Xi=globalThis,Ji=Xi.ShadowRoot&&(Xi.ShadyCSS===void 0||Xi.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,wr=Symbol(),Ks=new WeakMap,ni=class{constructor(n,t,i){if(this._$cssResult$=!0,i!==wr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=n,this.t=t}get styleSheet(){let n=this.o,t=this.t;if(Ji&&n===void 0){let i=t!==void 0&&t.length===1;i&&(n=Ks.get(t)),n===void 0&&((this.o=n=new CSSStyleSheet).replaceSync(this.cssText),i&&Ks.set(t,n))}return n}toString(){return this.cssText}},ve=e=>new ni(typeof e=="string"?e:e+"",void 0,wr),kr=(e,...n)=>{let t=e.length===1?e[0]:n.reduce((i,a,r)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[r+1],e[0]);return new ni(t,e,wr)},Ws=(e,n)=>{if(Ji)e.adoptedStyleSheets=n.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of n){let i=document.createElement("style"),a=Xi.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,e.appendChild(i)}},$r=Ji?e=>e:e=>e instanceof CSSStyleSheet?(n=>{let t="";for(let i of n.cssRules)t+=i.cssText;return ve(t)})(e):e;var{is:Tp,defineProperty:Ep,getOwnPropertyDescriptor:Mp,getOwnPropertyNames:Rp,getOwnPropertySymbols:Fp,getPrototypeOf:Ap}=Object,Zi=globalThis,js=Zi.trustedTypes,Ip=js?js.emptyScript:"",Hp=Zi.reactiveElementPolyfillSupport,ii=(e,n)=>e,ai={toAttribute(e,n){switch(n){case Boolean:e=e?Ip:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,n){let t=e;switch(n){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch{t=null}}return t}},Qi=(e,n)=>!Tp(e,n),qs={attribute:!0,type:String,converter:ai,reflect:!1,useDefault:!1,hasChanged:Qi};Symbol.metadata??=Symbol("metadata"),Zi.litPropertyMetadata??=new WeakMap;var ut=class extends HTMLElement{static addInitializer(n){this._$Ei(),(this.l??=[]).push(n)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(n,t=qs){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(n)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(n,t),!t.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(n,i,t);a!==void 0&&Ep(this.prototype,n,a)}}static getPropertyDescriptor(n,t,i){let{get:a,set:r}=Mp(this.prototype,n)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(n,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(n){return this.elementProperties.get(n)??qs}static _$Ei(){if(this.hasOwnProperty(ii("elementProperties")))return;let n=Ap(this);n.finalize(),n.l!==void 0&&(this.l=[...n.l]),this.elementProperties=new Map(n.elementProperties)}static finalize(){if(this.hasOwnProperty(ii("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ii("properties"))){let t=this.properties,i=[...Rp(t),...Fp(t)];for(let a of i)this.createProperty(a,t[a])}let n=this[Symbol.metadata];if(n!==null){let t=litPropertyMetadata.get(n);if(t!==void 0)for(let[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(n){let t=[];if(Array.isArray(n)){let i=new Set(n.flat(1/0).reverse());for(let a of i)t.unshift($r(a))}else n!==void 0&&t.push($r(n));return t}static _$Eu(n,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof n=="string"?n.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(n=>n(this))}addController(n){(this._$EO??=new Set).add(n),this.renderRoot!==void 0&&this.isConnected&&n.hostConnected?.()}removeController(n){this._$EO?.delete(n)}_$E_(){let n=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(n.set(i,this[i]),delete this[i]);n.size>0&&(this._$Ep=n)}createRenderRoot(){let n=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ws(n,this.constructor.elementStyles),n}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(n=>n.hostConnected?.())}enableUpdating(n){}disconnectedCallback(){this._$EO?.forEach(n=>n.hostDisconnected?.())}attributeChangedCallback(n,t,i){this._$AK(n,i)}_$ET(n,t){let i=this.constructor.elementProperties.get(n),a=this.constructor._$Eu(n,i);if(a!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:ai).toAttribute(t,i.type);this._$Em=n,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(n,t){let i=this.constructor,a=i._$Eh.get(n);if(a!==void 0&&this._$Em!==a){let r=i.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:ai;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(n,t,i,a=!1,r){if(n!==void 0){let o=this.constructor;if(a===!1&&(r=this[n]),i??=o.getPropertyOptions(n),!((i.hasChanged??Qi)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(n)&&!this.hasAttribute(o._$Eu(n,i))))return;this.C(n,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(n,t,{useDefault:i,reflect:a,wrapped:r},o){i&&!(this._$Ej??=new Map).has(n)&&(this._$Ej.set(n,o??t??this[n]),r!==!0||o!==void 0)||(this._$AL.has(n)||(this.hasUpdated||i||(t=void 0),this._$AL.set(n,t)),a===!0&&this._$Em!==n&&(this._$Eq??=new Set).add(n))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let n=this.scheduleUpdate();return n!=null&&await n,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,r]of i){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let n=!1,t=this._$AL;try{n=this.shouldUpdate(t),n?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw n=!1,this._$EM(),i}n&&this._$AE(t)}willUpdate(n){}_$AE(n){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(n)),this.updated(n)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(n){return!0}update(n){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(n){}firstUpdated(n){}};ut.elementStyles=[],ut.shadowRootOptions={mode:"open"},ut[ii("elementProperties")]=new Map,ut[ii("finalized")]=new Map,Hp?.({ReactiveElement:ut}),(Zi.reactiveElementVersions??=[]).push("2.1.2");var Fr=globalThis,Ys=e=>e,ea=Fr.trustedTypes,Xs=ea?ea.createPolicy("lit-html",{createHTML:e=>e}):void 0,nl="$lit$",St=`lit$${Math.random().toFixed(9).slice(2)}$`,il="?"+St,Lp=`<${il}>`,Jt=document,oi=()=>Jt.createComment(""),si=e=>e===null||typeof e!="object"&&typeof e!="function",Ar=Array.isArray,_p=e=>Ar(e)||typeof e?.[Symbol.iterator]=="function",Cr=`[ 	
\f\r]`,ri=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Js=/-->/g,Zs=/>/g,Yt=RegExp(`>|${Cr}(?:([^\\s"'>=/]+)(${Cr}*=${Cr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Qs=/'/g,el=/"/g,al=/^(?:script|style|textarea|title)$/i,Ir=e=>(n,...t)=>({_$litType$:e,strings:n,values:t}),h=Ir(1),v=Ir(2),Db=Ir(3),Zt=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),tl=new WeakMap,Xt=Jt.createTreeWalker(Jt,129);function rl(e,n){if(!Ar(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xs!==void 0?Xs.createHTML(n):n}var Pp=(e,n)=>{let t=e.length-1,i=[],a,r=n===2?"<svg>":n===3?"<math>":"",o=ri;for(let s=0;s<t;s++){let l=e[s],d,c,u=-1,p=0;for(;p<l.length&&(o.lastIndex=p,c=o.exec(l),c!==null);)p=o.lastIndex,o===ri?c[1]==="!--"?o=Js:c[1]!==void 0?o=Zs:c[2]!==void 0?(al.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=Yt):c[3]!==void 0&&(o=Yt):o===Yt?c[0]===">"?(o=a??ri,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?Yt:c[3]==='"'?el:Qs):o===el||o===Qs?o=Yt:o===Js||o===Zs?o=ri:(o=Yt,a=void 0);let m=o===Yt&&e[s+1].startsWith("/>")?" ":"";r+=o===ri?l+Lp:u>=0?(i.push(d),l.slice(0,u)+nl+l.slice(u)+St+m):l+St+(u===-2?s:m)}return[rl(e,r+(e[t]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),i]},li=class e{constructor({strings:n,_$litType$:t},i){let a;this.parts=[];let r=0,o=0,s=n.length-1,l=this.parts,[d,c]=Pp(n,t);if(this.el=e.createElement(d,i),Xt.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=Xt.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(nl)){let p=c[o++],m=a.getAttribute(u).split(St),b=/([.?@])?(.*)/.exec(p);l.push({type:1,index:r,name:b[2],strings:m,ctor:b[1]==="."?Tr:b[1]==="?"?Er:b[1]==="@"?Mr:Rn}),a.removeAttribute(u)}else u.startsWith(St)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(al.test(a.tagName)){let u=a.textContent.split(St),p=u.length-1;if(p>0){a.textContent=ea?ea.emptyScript:"";for(let m=0;m<p;m++)a.append(u[m],oi()),Xt.nextNode(),l.push({type:2,index:++r});a.append(u[p],oi())}}}else if(a.nodeType===8)if(a.data===il)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(St,u+1))!==-1;)l.push({type:7,index:r}),u+=St.length-1}r++}}static createElement(n,t){let i=Jt.createElement("template");return i.innerHTML=n,i}};function Mn(e,n,t=e,i){if(n===Zt)return n;let a=i!==void 0?t._$Co?.[i]:t._$Cl,r=si(n)?void 0:n._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(e),a._$AT(e,t,i)),i!==void 0?(t._$Co??=[])[i]=a:t._$Cl=a),a!==void 0&&(n=Mn(e,a._$AS(e,n.values),a,i)),n}var Sr=class{constructor(n,t){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:t},parts:i}=this._$AD,a=(n?.creationScope??Jt).importNode(t,!0);Xt.currentNode=a;let r=Xt.nextNode(),o=0,s=0,l=i[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new di(r,r.nextSibling,this,n):l.type===1?d=new l.ctor(r,l.name,l.strings,this,n):l.type===6&&(d=new Rr(r,this,n)),this._$AV.push(d),l=i[++s]}o!==l?.index&&(r=Xt.nextNode(),o++)}return Xt.currentNode=Jt,a}p(n){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(n,i,t),t+=i.strings.length-2):i._$AI(n[t])),t++}},di=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,t,i,a){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=n,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,t=this._$AM;return t!==void 0&&n?.nodeType===11&&(n=t.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,t=this){n=Mn(this,n,t),si(n)?n===f||n==null||n===""?(this._$AH!==f&&this._$AR(),this._$AH=f):n!==this._$AH&&n!==Zt&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):_p(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==f&&si(this._$AH)?this._$AA.nextSibling.data=n:this.T(Jt.createTextNode(n)),this._$AH=n}$(n){let{values:t,_$litType$:i}=n,a=typeof i=="number"?this._$AC(n):(i.el===void 0&&(i.el=li.createElement(rl(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Sr(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(n){let t=tl.get(n.strings);return t===void 0&&tl.set(n.strings,t=new li(n)),t}k(n){Ar(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,a=0;for(let r of n)a===t.length?t.push(i=new e(this.O(oi()),this.O(oi()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(n=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);n!==this._$AB;){let i=Ys(n).nextSibling;Ys(n).remove(),n=i}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},Rn=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,t,i,a,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=n,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}_$AI(n,t=this,i,a){let r=this.strings,o=!1;if(r===void 0)n=Mn(this,n,t,0),o=!si(n)||n!==this._$AH&&n!==Zt,o&&(this._$AH=n);else{let s=n,l,d;for(n=r[0],l=0;l<r.length-1;l++)d=Mn(this,s[i+l],t,l),d===Zt&&(d=this._$AH[l]),o||=!si(d)||d!==this._$AH[l],d===f?n=f:n!==f&&(n+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(n)}j(n){n===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},Tr=class extends Rn{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===f?void 0:n}},Er=class extends Rn{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==f)}},Mr=class extends Rn{constructor(n,t,i,a,r){super(n,t,i,a,r),this.type=5}_$AI(n,t=this){if((n=Mn(this,n,t,0)??f)===Zt)return;let i=this._$AH,a=n===f&&i!==f||n.capture!==i.capture||n.once!==i.once||n.passive!==i.passive,r=n!==f&&(i===f||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},Rr=class{constructor(n,t,i){this.element=n,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(n){Mn(this,n)}};var zp=Fr.litHtmlPolyfillSupport;zp?.(li,di),(Fr.litHtmlVersions??=[]).push("3.3.3");var ol=(e,n,t)=>{let i=t?.renderBefore??n,a=i._$litPart$;if(a===void 0){let r=t?.renderBefore??null;i._$litPart$=a=new di(n.insertBefore(oi(),r),r,void 0,t??{})}return a._$AI(e),a};var Hr=globalThis,Tt=class extends ut{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=ol(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Zt}};Tt._$litElement$=!0,Tt.finalized=!0,Hr.litElementHydrateSupport?.({LitElement:Tt});var Np=Hr.litElementPolyfillSupport;Np?.({LitElement:Tt});(Hr.litElementVersions??=[]).push("4.2.2");var Op={attribute:!0,type:String,converter:ai,reflect:!1,hasChanged:Qi},Dp=(e=Op,n,t)=>{let{kind:i,metadata:a}=t,r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(t.name,e),i==="accessor"){let{name:o}=t;return{set(s){let l=n.get.call(this);n.set.call(this,s),this.requestUpdate(o,l,e,!0,s)},init(s){return s!==void 0&&this.C(o,void 0,e,s),s}}}if(i==="setter"){let{name:o}=t;return function(s){let l=this[o];n.call(this,s),this.requestUpdate(o,l,e,!0,s)}}throw Error("Unsupported decorator location: "+i)};function Fn(e){return(n,t)=>typeof t=="object"?Dp(e,n,t):((i,a,r)=>{let o=a.hasOwnProperty(r);return a.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(a,r):void 0})(e,n,t)}function D(e){return Fn({...e,state:!0,attribute:!1})}var je="wrist_assistant/complications";async function sl(e){return e.connection.sendMessagePromise({type:`${je}/owners`})}async function ll(e,n){return e.connection.sendMessagePromise({type:`${je}/list`,owner_watch_id:n})}async function dl(e,n){return e.connection.sendMessagePromise({type:`${je}/nudge`,owner_watch_id:n})}async function cl(e,n){return e.connection.sendMessagePromise({type:`${je}/watch_status`,owner_watch_id:n})}async function ul(e,n,t,i){return e.connection.sendMessagePromise({type:`${je}/save`,owner_watch_id:n,document:t,base_revision:i})}async function pl(e,n,t,i){return e.connection.sendMessagePromise({type:`${je}/delete`,owner_watch_id:n,complication_id:t,base_revision:i})}async function hl(e,n,t){return e.connection.sendMessagePromise({type:`${je}/move_owner`,source_owner_watch_id:n,target_owner_watch_id:t})}function ml(e,n,t){let i={type:`${je}/subscribe`};return n&&(i.owner_watch_id=n),e.connection.subscribeMessage(t,i)}async function fl(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${je}/render_values`,templates:n})).results}async function gl(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${je}/history_series`,requests:n})).results}function yl(e){return{entity_id:e.entityId,minutes:e.minutes,points:e.points,...e.mode==="states"?{mode:"states"}:{},...e.gaps?{gaps:!0}:{}}}function bl(e){return{entity_id:e.entityId,minutes:e.minutes,period:e.period,type:e.type,...e.gaps?{gaps:!0}:{}}}async function xl(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${je}/statistics_series`,requests:n})).results}var ae=["rectangular","circular","corner"],ce={rectangular:{width:181,height:65.5},circular:{width:51,height:51},corner:{width:34,height:34}},ui=["rectangular","circular","corner","inline"];var Nr=64;function _l(e,n){let t=new Set(e);for(let i of n)t.add(i.slot);for(let i=0;i<Nr;i++)if(!t.has(i))return i;return-1}function Pl(e,n){let t=new Set(e);return n.filter(i=>i.kind!=="preset"||!t.has(i.slot))}function rn(e){return ae.some(t=>!e.supportedFamilies.includes(t))||e.supportedFamilies.includes("inline")||e.inline!==void 0?6:e.slotIndex>7?5:4}var Vp=["none","dot","triangle"],Bp=["straight","smooth","step"],Up=["light","medium","strong"],Gp={light:.05,medium:.1,strong:.2};function vl(e){return typeof e=="string"&&Bp.includes(e)?e:"straight"}var Kp=["flat","fade"],Wp=["none","all","auto"],Or=4,Ht="#FFFFFF33";function Rt(e){return typeof e=="string"&&Kp.includes(e)?e:"flat"}function Ft(e){return typeof e=="string"&&Wp.includes(e)?e:"none"}function tt(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(Or,Math.round(e)))}function sa(e,n){return e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function nn(e){return typeof e=="string"&&e!==""?e:Ht}var jp=["all","top"],Hn=1.2;function At(e){return typeof e!="number"||!Number.isFinite(e)?Hn:Math.max(0,e)}function It(e){return typeof e=="string"&&jp.includes(e)?e:"all"}function Xe(e){if(typeof e=="string")return Up.includes(e)?e:void 0;if(e===3||e===5)return"light";if(e===7)return"medium";if(e===9)return"strong"}function zl(e,n){if(n===void 0||e<2)return 0;let t=Math.max(3,Math.floor(e*Gp[n]+.5));return t%2===0?t+1:t}var qp=[["history","Recorded history"],["statistics","Long-term statistics"]],la=[["5minute","5 min"],["hour","Hour"],["day","Day"],["week","Week"],["month","Month"]],Dr=[["mean","Mean"],["min","Min"],["max","Max"],["change","Change"],["sum","Total"]],Vr="history",mi="hour",fi="mean",Ln=[["latest","Newest reading"],["first","First reading"],["highest","Highest reading"],["lowest","Lowest reading"],["average","Average reading"],["delta","Change"],["sum","Total"],["trend","Trend arrow"],["top","Top of the scale"],["bottom","Bottom of the scale"]],gi={x:.25,y:.25,width:.5,height:.5,rotationDegrees:0},on=[["highest","Highest reading"],["lowest","Lowest reading"],["now","Now"],["first","First reading"],["latest","Newest reading"],["threshold","Threshold"]];function mt(e){return e!=="threshold"}var Br=[["above","Above"],["on","On"],["below","Inside"],["bottom","At the bottom"],["through","Through"]];function Yp(e){return on.some(([n])=>n===e)}function Xp(e){return Br.some(([n])=>n===e)}function Jp(e){if(!L(e)||typeof e.layer!="string"||e.layer==="")return;let n={layer:e.layer.toUpperCase(),at:Yp(e.at)?e.at:"highest",place:Xp(e.place)?e.place:"above"},t=q(e.dx,0),i=q(e.dy,0);return t!==0&&(n.dx=t),i!==0&&(n.dy=i),n}function na(e,n){let t=Jp(e.chartAnchor);t!==void 0&&(n.chartAnchor=t)}function ia(e,n){e.chartAnchor!==void 0&&(n.chartAnchor=Zp(e.chartAnchor))}function Zp(e){let n={layer:e.layer,at:e.at,place:e.place};return e.dx!==void 0&&e.dx!==0&&(n.dx=j(e.dx)),e.dy!==void 0&&e.dy!==0&&(n.dy=j(e.dy)),n}var Ae={setColor:"color",setOpacity:"opacity",setText:"text",setIcon:"icon",setFontSize:"fontSize",setFontWeight:"fontWeight",setRotation:"rotation",hide:"visibility",show:"visibility",setGaugeValue:"gaugeValue",setGaugeMin:"gaugeMin",setGaugeMax:"gaugeMax",setBorderColor:"borderColor",setBorderWidth:"borderWidth",setBackgroundColor:"backgroundColor"};function Nl(e){return e.countdown===!0?!1:e.coloring==="bands"&&(e.bands?.length??0)>0||e.highlight!==void 0&&e.highlight!=="none"}function ft(e){return e.countdown!==!0&&(e.parts?.length??0)>0}function sn(e){if(e.kind.kind==="literal")return(e.format?.prefix??"")+e.kind.value+(e.format?.suffix??"")}function yi(e){let n=c=>c.value.kind.kind!=="literal",t=(c,u)=>e.slice(c,u).map(p=>sn(p.value)??"").join(""),i=e.findIndex(n);if(i<0)return H(t(0,e.length));let a=e.findIndex((c,u)=>u>i&&n(c)),r=e[i].value,o={...r.format},s=t(0,i)+(o.prefix??""),l=(o.suffix??"")+t(i+1,a<0?e.length:a);delete o.prefix,delete o.suffix,s!==""&&(o.prefix=s),l!==""&&(o.suffix=l);let d={kind:structuredClone(r.kind)};return Te(o)||(d.format=o),d}function Ol(e){ft(e)&&(e.value=yi(e.parts))}var _n="#FFFFFF";function wl(e){return typeof e=="string"&&Vp.includes(e)}function Ur(e){return e==="none"?{high:"none",low:"none"}:e==="pointer"?{high:"triangle",low:"dot"}:{high:"dot",low:"dot"}}function nt(e){let n=Ur(e.marker);return{high:e.highMarker??n.high,low:e.lowMarker??n.low}}function Dl(e){return e.high==="triangle"?"pointer":e.high!=="none"||e.low!=="none"?"dot":"none"}function Vl(e){return e.high==="none"&&e.low==="none"||e.high==="dot"&&e.low==="dot"||e.high==="triangle"&&e.low==="dot"}function da(e,n){e.marker=Dl(n),Vl(n)?(delete e.highMarker,delete e.lowMarker):(e.highMarker=n.high,e.lowMarker=n.low)}var ca=24,Pe="#FF6B35",ze="#32D74B",Gr="#32D74B",oe="#FF453A",Pn="#FF453A",zn="#FFFFFF99";function Lt(e){return[...e.bands].sort((n,t)=>n.upTo-t.upTo)}function Bl(e){return e.coloring==="bands"&&e.bands.length>0}function ua(e,n,t){for(let i of n)if(e<=i.upTo)return i.colorHex;return t}function Kr(e,n){let t=Math.abs(n),i=t>=10?0:t>=1?1:2;return e.toFixed(i)}function Ul(e){return e>0?"\u2191":e<0?"\u2193":"\u2192"}var ln=[{minutes:60,label:"Last hour"},{minutes:180,label:"Last 3 hours"},{minutes:360,label:"Last 6 hours"},{minutes:720,label:"Last 12 hours"},{minutes:1440,label:"Last 24 hours"},{minutes:4320,label:"Last 3 days"},{minutes:10080,label:"Last 7 days"}],pa=360,ha=10080,bi=[...ln,{minutes:43200,label:"Last 30 days"},{minutes:129600,label:"Last 90 days"},{minutes:527040,label:"Last year"}],Wr=366*24*60,jr=2,xi=120,qr=0;function Yr(e){let n=Math.round(e.historyPoints);return Number.isFinite(n)?n<1?qr:Math.max(jr,Math.min(xi,n)):24}function dn(e){return Jr(e)!==void 0?!0:Xr(e)!==void 0&&Yr(e)>0}function Xr(e){if(e.source==="history")return Gl(e)}function Jr(e){if(e.source==="statistics")return Gl(e)}function Gl(e){if(!(e.historyMinutes<=0))return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function cn(e){let n=Xr(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${Yr(e)}${e.gaps===!0?"|gaps":""}`}function un(e){let n=Jr(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${e.statPeriod}|${e.statType}${e.gaps===!0?"|gaps":""}`}function Kl(e){return[...Zr(e).map(t=>t.key),...Qr(e).map(t=>t.key)].sort().join(";")}function Zr(e){let n=new Map,t=i=>{n.has(i.key)||n.set(i.key,i)};for(let i of e.elements)if(i.kind==="chart"){let a=cn(i.payload),r=Xr(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:Math.round(i.payload.historyMinutes),points:Yr(i.payload),mode:"numeric",gaps:i.payload.gaps===!0})}else if(i.kind==="timeline"){let a=zt(i.payload),r=Xl(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:it(i.payload),points:Pt,mode:"states",gaps:!1})}return[...n.values()]}function Qr(e){let n=new Map;for(let t of e.elements){if(t.kind!=="chart")continue;let i=un(t.payload),a=Jr(t.payload);i===void 0||a===void 0||n.has(i)||n.set(i,{key:i,entityId:a,minutes:Math.round(t.payload.historyMinutes),period:t.payload.statPeriod,type:t.payload.statType,gaps:t.payload.gaps===!0})}return[...n.values()]}var Wl=[["auto","Auto"],["h12","12 hour"],["h24","24 hour"]],jl=[["auto","Auto"],["always","Always"],["never","Never"]];function Lr(e){return e==="h12"||e==="h24"?e:en}function _r(e){return e==="always"||e==="never"?e:tn}function Qp(e){return e.timeLabelCount!==void 0?ht(e.timeLabelCount):e.timeLabels==="ends"?2:e.timeLabels==="four"?4:Qt}function ht(e){let n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(vi,Math.round(n))):Qt}function ma(e){return e<=0?[]:e===1?[1]:Array.from({length:e},(n,t)=>t/(e-1))}var _t="#8E8E93",ql=1,eh="#000000",th=2,nh=1440,eo=60,Qt=0,qe=9,Ye="#8E8E93",en="auto",tn="auto",ih=4,vi=12,Nn=1,On=20,fa=4,Pt=120;function Yl(e,n,t){let i=e.trim().toLowerCase();for(let a of n)if(a.match.trim().toLowerCase()===i)return a.colorHex;return t}function it(e){let n=Math.round(e.historyMinutes);return Number.isFinite(n)?Math.max(1,Math.min(ha,n)):eo}function Xl(e){return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function zt(e){let n=Xl(e);if(n!==void 0)return`${n}|${it(e)}|${Pt}|states`}var ah={on:"#FF9F0A",off:"#0A84FF",open:"#FF453A",closed:"#32D74B",opening:"#FFD60A",closing:"#FFD60A",home:"#32D74B",not_home:"#0A84FF",locked:"#32D74B",unlocked:"#FF453A",jammed:"#BF5AF2",playing:"#32D74B",paused:"#FF9F0A",idle:"#0A84FF",standby:"#5E5CE6",heat:"#FF9F0A",cool:"#64D2FF",heat_cool:"#BF5AF2",dry:"#FFD60A",fan_only:"#5E5CE6",auto:"#BF5AF2",cleaning:"#32D74B",docked:"#0A84FF",returning:"#64D2FF",error:"#FF453A",disarmed:"#32D74B",armed_home:"#0A84FF",armed_away:"#FF9F0A",armed_night:"#5E5CE6",arming:"#FFD60A",pending:"#FFD60A",triggered:"#FF453A",unavailable:"#48484A",unknown:"#48484A"},wi={binary_sensor:["on","off"],switch:["on","off"],light:["on","off"],input_boolean:["on","off"],fan:["on","off"],humidifier:["on","off"],siren:["on","off"],cover:["open","closed","opening","closing"],lock:["locked","unlocked","jammed"],person:["home","not_home"],device_tracker:["home","not_home"],media_player:["playing","paused","idle","off"],climate:["heat","cool","heat_cool","dry","fan_only","auto","off"],vacuum:["cleaning","docked","returning","idle","error"],alarm_control_panel:["disarmed","armed_home","armed_away","armed_night","arming","pending","triggered"]};function aa(e){return ah[e.trim().toLowerCase()]??_t}var rh=["door","garage_door","window","opening"];function to(e,n){let t=(n??"").trim().toLowerCase(),i=e==="binary_sensor"&&rh.includes(t),a=o=>aa(i&&o==="on"?"open":o);return[...wi[e]??[],"unavailable","unknown"].map(o=>({id:X(),match:o,colorHex:a(o)}))}var Dn=6,Vn=9,oh=["topLeading","topTrailing","bottomLeading","bottomTrailing"];function gt(e){return Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY)}function no(e,n){let t=n<=.5,i=e<=.5;return t?i?"topLeading":"topTrailing":i?"bottomLeading":"bottomTrailing"}var io={top:0,left:0,bottom:0,right:0};function ga(e){return e===void 0||e.top===0&&e.left===0&&e.bottom===0&&e.right===0}var sh=["toggleEntity","runScene","runScript","addTodo","runHTTPAction"];function Jl(e){return sh.includes(e)}function Zl(e){let n=(e??"").trim();if(n==="")return!0;try{let t=JSON.parse(n);return typeof t=="object"&&t!==null&&!Array.isArray(t)}catch{return!1}}var ao=[["refresh","Refresh"],["none","Nothing"],["openApp","Open the app"],["openPage","Open the page"],["openRoomPage","Open the room page"],["timerStartPause","Timer start / pause"],["timerCancel","Timer cancel"],["toggleEntity","Toggle an entity"],["runScene","Run a scene"],["runScript","Run a script"],["addTodo","Add a to-do"],["runHTTPAction","Run an HTTP action"],["callService","Call a service"]];function yt(e){let n=ao.find(([i])=>i===e.type)?.[1]??e.type;if(e.type==="callService"){let i=[e.serviceDomain,e.serviceName].filter(a=>a!=="").join(".");return i===""?n:`${n}: ${i}`}if(!("entityId"in e))return n;let t=e.displayName||e.entityId;return t?`${n}: ${t}`:n}function L(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function W(e,n=""){return typeof e=="string"?e:n}function q(e,n){return typeof e=="number"?e:e==="+inf"?1/0:e==="-inf"?-1/0:e==="nan"?NaN:n}function et(e){return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}function pi(e){return e==null?void 0:q(e,0)}function le(e){return typeof e=="string"?e:void 0}function Pr(e,n,t){return n.some(([i])=>i===e)?e:t}var Ke=class extends Error{};function Et(e){if(typeof e.entityId!="string")throw new Ke("entityId is required");let n={entityId:e.entityId,displayName:W(e.displayName),domain:W(e.domain)};return typeof e.iconName=="string"&&(n.iconName=e.iconName),n}function kl(e){if(!L(e))return;let n={};return e.decimals!==void 0&&e.decimals!==null&&(n.decimals=q(e.decimals,0)),e.multiply!==void 0&&e.multiply!==null&&(n.multiply=q(e.multiply,1)),e.offset!==void 0&&e.offset!==null&&(n.offset=q(e.offset,0)),typeof e.prefix=="string"&&(n.prefix=e.prefix),typeof e.suffix=="string"&&(n.suffix=e.suffix),e.useEntityUnit===!0&&(n.useEntityUnit=!0),e.relativeTime===!0&&(n.relativeTime=!0),e.duration===!0&&(n.duration=!0),(e.textCase==="upper"||e.textCase==="lower"||e.textCase==="capitalized")&&(n.textCase=e.textCase),Te(n)?void 0:n}function Te(e){return e?e.decimals===void 0&&e.multiply===void 0&&e.offset===void 0&&!e.prefix&&!e.suffix&&!e.useEntityUnit&&!e.relativeTime&&!e.duration&&e.textCase===void 0:!0}function lh(e){let n=W(e.function,"count"),t=L(e.scope)?e.scope:{},i;if(t.kind==="entities")i={kind:"entities",entities:(Array.isArray(t.entities)?t.entities:[]).filter(L).map(Et)};else{let r=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[];i={kind:"filter",domains:r(t.domains),areaIds:r(t.areaIds),labelIds:r(t.labelIds),floorIds:r(t.floorIds)}}let a={function:n,scope:i};if(L(e.stateFilter)){let r=e.stateFilter.kind;r==="isOn"||r==="isOff"?a.stateFilter={kind:r}:(r==="equals"||r==="notEquals")&&(a.stateFilter={kind:r,value:W(e.stateFilter.value)})}return typeof e.attribute=="string"&&(a.attribute=e.attribute),a}function $l(e){switch(e.kind){case"literal":return{kind:"literal",value:W(e.value)};case"entityState":return{kind:"entityState",...Et(e)};case"entityAttribute":return{kind:"entityAttribute",...Et(e),attribute:W(e.attribute)};case"entityAge":return{kind:"entityAge",...Et(e)};case"aggregate":return{kind:"aggregate",aggregate:lh(L(e.aggregate)?e.aggregate:{})};case"time":return{kind:"time",timeField:le(e.timeField)??"now"};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:W(e.value)};case"named":return{kind:"named",id:W(e.id).toUpperCase()};case"chartStat":return{kind:"chartStat",layer:W(e.layer).toUpperCase(),stat:Ln.some(([n])=>n===e.stat)?e.stat:"latest"};default:throw new Ke(`unknown value kind ${String(e.kind)}`)}}function me(e){if(!L(e))throw new Ke("value must be an object");if(L(e.kind)){let i={kind:$l(e.kind)},a=kl(e.format);return a&&(i.format=a),i}let n={kind:$l(e)},t=kl(e.format);return t&&(n.format=t),n}function Ql(e){return L(e)?{x:q(e.x,.25),y:q(e.y,.25),width:q(e.width,.5),height:q(e.height,.5),rotationDegrees:q(e.rotationDegrees,0)}:{...gi}}function dh(e){if(!L(e))return{kind:"isOn"};let n=W(e.kind,"isOn"),t={kind:n};switch(n){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":t.value=L(e.value)?me(e.value):H("");break;case"between":case"timeBetween":t.value=L(e.value)?me(e.value):H(""),t.upper=L(e.upper)?me(e.upper):H("");break;case"matchesRegex":t.pattern=W(e.pattern);break;case"isOneOf":t.options=Array.isArray(e.options)?e.options.filter(i=>typeof i=="string"):[];break;default:break}return t}function Cl(e){if(!L(e))return{kind:"show"};let n=W(e.kind,"show"),t={kind:n};switch(n){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":t.value=L(e.value)?me(e.value):H("");break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":t.number=q(e.number,0);break;case"setFontWeight":t.weight=le(e.weight)??"regular";break;default:break}return t}function ed(e){return Array.isArray(e)?e.filter(L).map(n=>{let t={id:W(n.id).toUpperCase(),cases:(Array.isArray(n.cases)?n.cases:[]).filter(L).map(i=>{let a=L(i.when)?i.when:{};return{id:W(i.id).toUpperCase(),when:{join:a.join==="any"?"any":"all",tests:(Array.isArray(a.tests)?a.tests:[]).filter(L).map(r=>({id:W(r.id).toUpperCase(),value:L(r.value)?me(r.value):H(""),comparison:dh(r.comparison)}))},then:(Array.isArray(i.then)?i.then:[]).map(Cl)}})};return Array.isArray(n.otherwise)&&(t.otherwise=n.otherwise.map(Cl)),typeof n.partId=="string"&&n.partId!==""&&(t.partId=n.partId.toUpperCase()),t}):[]}function ch(e,n){return{baseColorHex:L(e)?W(e.baseColorHex,n):n}}function ra(e){return Array.isArray(e)?e.filter(L).map(n=>({id:W(n.id,X()),upTo:q(n.upTo,0),colorHex:W(n.colorHex,"#FFFFFF")})):[]}function uh(e){return Array.isArray(e)?e.filter(L).map(n=>{let t={id:W(n.id,X()).toUpperCase(),value:L(n.value)?me(n.value):H("")};typeof n.colorHex=="string"&&(t.colorHex=n.colorHex);let i=le(n.fontWeight);(i==="regular"||i==="medium"||i==="semibold"||i==="bold")&&(t.fontWeight=i),typeof n.fontSize=="number"&&(t.fontSize=n.fontSize),le(n.coloring)==="bands"&&(t.coloring="bands");let a=ra(n.bands);a.length>0&&(t.bands=a);let r=W(n.bandAboveColorHex,oe);return r!==oe&&(t.bandAboveColorHex=r),t}):[]}function ph(e){if(Array.isArray(e.bands))return ra(e.bands);if(typeof e.bandLowerBound!="number")return[];let n=L(e.colorSlot)?W(e.colorSlot.baseColorHex,"#FFFFFF"):"#FFFFFF";return[{id:X(),upTo:e.bandLowerBound,colorHex:W(e.bandLowColorHex,Gr)},{id:X(),upTo:q(e.bandUpperBound,100),colorHex:n}]}function hh(e){return Array.isArray(e)?e.filter(L).map(n=>({id:W(n.id,X()).toUpperCase(),match:W(n.match,""),colorHex:W(n.colorHex,_t)})):[]}function pt(e,n){if(typeof e.id!="string")throw new Ke("element id is required");return{id:e.id.toUpperCase(),colorSlot:ch(e.colorSlot,n),rules:ed(e.rules),frame:Ql(e.frame),isHidden:e.isHidden===!0}}function mh(e){let n=fh(e),t=e.payload;return typeof t.groupId=="string"&&t.groupId!==""&&(n.payload.groupId=t.groupId.toUpperCase()),n}function fh(e){if(!L(e)||!L(e.payload))throw new Ke("element must have a payload");let n=e.payload;switch(e.kind){case"text":{let t={...pt(n,"#FFFFFF"),value:L(n.value)?me(n.value):H(""),fontSize:q(n.fontSize,14),fontWeight:le(n.fontWeight)??"regular"};n.countdown===!0&&(t.countdown=!0),n.monospacedDigits===!0&&(t.monospacedDigits=!0);let i=typeof n.lineLimit=="number"?Math.round(n.lineLimit):1;Math.min(2,Math.max(1,i))===2&&(t.lineLimit=2);let a=le(n.alignment);(a==="leading"||a==="trailing")&&(t.alignment=a),le(n.coloring)==="bands"&&(t.coloring="bands");let r=ra(n.bands);r.length>0&&(t.bands=r);let o=W(n.bandAboveColorHex,oe);o!==oe&&(t.bandAboveColorHex=o);let s=le(n.highlight);(s==="highest"||s==="lowest"||s==="both")&&(t.highlight=s);let l=W(n.highColorHex,Pe);l!==Pe&&(t.highColorHex=l);let d=W(n.lowColorHex,ze);d!==ze&&(t.lowColorHex=d);let c=uh(n.parts);return c.length>0&&(t.parts=c),na(n,t),{kind:"text",payload:t}}case"icon":{let t={...pt(n,"#FFFFFF"),symbol:L(n.symbol)?me(n.symbol):H("lightbulb"),size:q(n.size,14)},i=le(n.path);return i!==void 0&&i!==""&&(t.path=i),na(n,t),{kind:"icon",payload:t}}case"gauge":{let t={...pt(n,"#FFFFFF"),value:L(n.value)?me(n.value):H("50"),minValue:q(n.minValue,0),maxValue:q(n.maxValue,100),style:le(n.style)??"arc",lineWidth:q(n.lineWidth,4),trackColorHex:W(n.trackColorHex,"#FFFFFF40"),coloring:le(n.coloring)??"uniform",bands:ra(n.bands),bandAboveColorHex:W(n.bandAboveColorHex,oe),thresholdColorHex:W(n.thresholdColorHex,_n)},i=pi(n.thresholdValue);return i!==void 0&&(t.thresholdValue=i),L(n.total)&&(t.total=me(n.total)),L(n.minSource)&&(t.minSource=me(n.minSource)),L(n.maxSource)&&(t.maxSource=me(n.maxSource)),{kind:"gauge",payload:t}}case"chart":return{kind:"chart",payload:{...pt(n,"#FFFFFF"),value:L(n.value)?me(n.value):H("13,14,16,17,19,22,24,28,30"),historyMinutes:Math.max(0,Math.round(q(n.historyMinutes,0))),historyPoints:Math.round(q(n.historyPoints,24)),source:Pr(le(n.source),qp,Vr),statPeriod:Pr(le(n.statPeriod),la,mi),statType:Pr(le(n.statType),Dr,fi),style:le(n.style)??"bars",limit:Math.max(0,Math.round(q(n.limit,0))),takeFromEnd:n.takeFromEnd===!0,scale:le(n.scale)??"auto",minValue:q(n.minValue,0),maxValue:q(n.maxValue,100),baseline:le(n.baseline)??"lowest",barGap:q(n.barGap,1.5),lineWidth:q(n.lineWidth,2),highlight:le(n.highlight)??"none",highColorHex:W(n.highColorHex,Pe),lowColorHex:W(n.lowColorHex,ze),marker:le(n.marker)??"pointer",...wl(n.highMarker)?{highMarker:n.highMarker}:{},...wl(n.lowMarker)?{lowMarker:n.lowMarker}:{},coloring:le(n.coloring)??"uniform",bands:ph(n),bandAboveColorHex:W(n.bandHighColorHex,W(n.bandAboveColorHex,oe)),fillBands:n.fillBands===!0,...vl(n.curve)!=="straight"?{curve:vl(n.curve)}:{},...Rt(n.fillStyle)!=="flat"?{fillStyle:Rt(n.fillStyle)}:{},...typeof n.fillColorHex=="string"?{fillColorHex:n.fillColorHex}:{},...At(n.barRadius)!==Hn?{barRadius:At(n.barRadius)}:{},...It(n.barCorners)!=="all"?{barCorners:It(n.barCorners)}:{},...Ft(n.pointDots)!=="none"?{pointDots:Ft(n.pointDots)}:{},...tt(n.gridLines)!==0?{gridLines:tt(n.gridLines)}:{},...sa(nn(n.gridColorHex),Ht)?{}:{gridColorHex:nn(n.gridColorHex)},...n.zeroLine===!0?{zeroLine:!0}:{},...Xe(n.smoothing)!==void 0?{smoothing:Xe(n.smoothing)}:{},...n.gaps===!0?{gaps:!0}:{},...typeof n.thresholdValue=="number"&&Number.isFinite(n.thresholdValue)?{thresholdValue:n.thresholdValue}:{},thresholdColorHex:W(n.thresholdColorHex,Pn),...L(n.nowIndex)?{nowIndex:me(n.nowIndex)}:{},nowColorHex:W(n.nowColorHex,zn),...n.drawsThreshold===!1?{drawsThreshold:!1}:{},...n.drawsNowLine===!1?{drawsNowLine:!1}:{},...n.drawsTimeLabels===!1?{drawsTimeLabels:!1}:{},...le(n.scaleFrom)!==void 0?{scaleFrom:le(n.scaleFrom)}:{},timeLabelCount:ht(n.timeLabelCount),labelSize:q(n.labelSize,qe),labelColorHex:W(n.labelColorHex,Ye),labelsAbove:n.labelsAbove===!0,hourCycle:Lr(n.hourCycle),minutes:_r(n.minutes)}};case"timeline":{let{colorSlot:t,...i}=pt(n,"#FFFFFF");return{kind:"timeline",payload:{...i,value:L(n.value)?me(n.value):H(""),historyMinutes:Math.max(1,Math.round(q(n.historyMinutes,eo))),bands:hh(n.bands),otherColorHex:W(n.otherColorHex,_t),gap:Math.min(fa,Math.max(0,q(n.gap,0))),cornerRadius:Math.max(0,q(n.cornerRadius,ql)),timeLabelCount:Qp(n),labelSize:q(n.labelSize,qe),labelColorHex:W(n.labelColorHex,Ye),labelsAbove:n.labelsAbove===!0,hourCycle:Lr(n.hourCycle),minutes:_r(n.minutes)}}}case"shape":{let t={...pt(n,"#FFFFFF33"),kind:le(n.kind)??"roundedRectangle",cornerRadius:q(n.cornerRadius,6),thickness:q(n.thickness,1),borderWidth:q(n.borderWidth,1)};return typeof n.borderColorHex=="string"&&(t.borderColorHex=n.borderColorHex),na(n,t),{kind:"shape",payload:t}}case"image":{let{colorSlot:t,...i}=pt(n,"#FFFFFF"),a={...i,entity:Et(L(n.entity)?n.entity:{}),source:n.source==="entityPicture"?"entityPicture":"camera",contentMode:n.contentMode==="fit"?"fit":"fill",zoom:q(n.zoom,1),panX:q(n.panX,0),panY:q(n.panY,0),cornerRadius:q(n.cornerRadius,Dn),timestampCorner:oh.includes(n.timestampCorner)?n.timestampCorner:"topLeading",timestampSize:q(n.timestampSize,Vn)};n.timestamp===!0&&(a.timestamp=!0);let r=pi(n.timestampX),o=pi(n.timestampY);return r!==void 0&&o!==void 0&&Number.isFinite(r)&&Number.isFinite(o)&&(a.timestampX=et(r),a.timestampY=et(o)),na(n,a),{kind:"image",payload:a}}case"tap":{let{colorSlot:t,...i}=pt(n,"#FFFFFF"),a={...i,action:L(n.action)?td(n.action):{type:"refresh"}};return typeof n.openPageId=="string"&&(a.openPageId=n.openPageId),typeof n.openPageName=="string"&&(a.openPageName=n.openPageName),typeof n.attachedTo=="string"&&(a.attachedTo=n.attachedTo.toUpperCase()),{kind:"tap",payload:a}}case"chartTimes":{let{colorSlot:t,...i}=pt(n,"#FFFFFF");return{kind:"chartTimes",payload:{...i,chart:W(n.chart).toUpperCase(),timeLabelCount:ht(n.timeLabelCount),labelSize:q(n.labelSize,qe),labelColorHex:W(n.labelColorHex,Ye),hourCycle:Lr(n.hourCycle),minutes:_r(n.minutes)}}}default:throw new Ke(`unknown element kind ${String(e.kind)}`)}}function Sl(e){let n=L(e)?e:{},t={};if(L(n.placements))for(let[a,r]of Object.entries(n.placements)){if(!L(r))continue;let o={frame:Ql(r.frame),isHidden:r.isHidden===!0},s=pi(r.size);s!==void 0&&(o.size=s),t[a.toUpperCase()]=o}let i={placements:t,cornerBodyShape:n.cornerBodyShape==="circle"?"circle":"wedge",borderWidth:q(n.borderWidth,2),rules:ed(n.rules)};if(L(n.bezelText)&&(i.bezelText=me(n.bezelText)),n.bezelCountdown===!0&&(i.bezelCountdown=!0),L(n.curvedText)&&(i.curvedText=me(n.curvedText)),typeof n.curvedColorHex=="string"&&(i.curvedColorHex=n.curvedColorHex),L(n.bezelGauge)){let a=n.bezelGauge,r={value:L(a.value)?me(a.value):H("50"),minValue:q(a.minValue,0),maxValue:q(a.maxValue,100),colorHexes:Array.isArray(a.colorHexes)&&a.colorHexes.length>0?a.colorHexes.filter(o=>typeof o=="string"):["#34C759","#FFCC00","#FF3B30"]};L(a.minLabel)&&(r.minLabel=me(a.minLabel)),L(a.maxLabel)&&(r.maxLabel=me(a.maxLabel)),i.bezelGauge=r}return typeof n.backgroundColorHex=="string"&&(i.backgroundColorHex=n.backgroundColorHex),typeof n.borderColorHex=="string"&&(i.borderColorHex=n.borderColorHex),i}function gh(e){let n={};if(Array.isArray(e))for(let t=0;t+1<e.length;t+=2){let i=e[t];typeof i=="string"&&(n[i]=Sl(e[t+1]))}else if(L(e))for(let[t,i]of Object.entries(e))n[t]=Sl(i);return n}function yh(e){let n={value:L(e.value)?me(e.value):H("")};return typeof e.label=="string"&&(n.label=e.label),typeof e.symbol=="string"&&(n.symbol=e.symbol),e.countdown===!0&&(n.countdown=!0),n}function td(e){if(!L(e)||typeof e.type!="string")return{type:"none"};switch(e.type){case"none":case"refresh":case"openApp":case"openPage":case"openRoomPage":case"timerStartPause":case"timerCancel":return{type:e.type};case"toggleEntity":case"runScene":case"runScript":case"addTodo":case"runHTTPAction":return{type:e.type,...Et(e)};case"callService":{let n={type:"callService",serviceDomain:typeof e.serviceDomain=="string"?e.serviceDomain:"",serviceName:typeof e.serviceName=="string"?e.serviceName:""};return typeof e.serviceDataJSON=="string"&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),typeof e.entityId=="string"&&e.entityId!==""&&(n.target=Et(e)),n}default:return{type:"none"}}}function Bn(e){if(!L(e))throw new Ke("config must be an object");for(let r of["id","name","slotIndex","supportedFamilies","perFamily","tapAction"])if(!(r in e))throw new Ke(`${r} is required`);let n=(Array.isArray(e.values)?e.values:[]).filter(L).map(r=>({id:W(r.id).toUpperCase(),name:W(r.name),value:L(r.value)?me(r.value):H("")})),t=(Array.isArray(e.dataSources)?e.dataSources:[]).filter(L).map(r=>r.kind==="template"?{kind:"template",value:W(r.value)}:r.kind==="entity"?{kind:"entity",...Et(r)}:null).filter(r=>r!==null),i={schemaVersion:q(e.schemaVersion,1),id:W(e.id).toUpperCase(),name:W(e.name,"Custom"),values:n,slotIndex:q(e.slotIndex,0),elements:(Array.isArray(e.elements)?e.elements:[]).map(mh),supportedFamilies:(Array.isArray(e.supportedFamilies)?e.supportedFamilies:[]).filter(r=>typeof r=="string"),perFamily:gh(e.perFamily),dataSources:t,tapAction:td(e.tapAction)};L(e.inline)&&(i.inline=yh(e.inline));let a=pi(e.refreshMinutes);if(a!==void 0&&(i.refreshMinutes=a),typeof e.openPageId=="string"&&(i.openPageId=e.openPageId),typeof e.openPageName=="string"&&(i.openPageName=e.openPageName),typeof e.showSuccessFlash=="boolean"&&(i.showSuccessFlash=e.showSuccessFlash),typeof e.successFlashColorHex=="string"&&(i.successFlashColorHex=e.successFlashColorHex),Array.isArray(e.groups)){let r=e.groups.filter(L).filter(o=>typeof o.id=="string").map(o=>({id:W(o.id).toUpperCase(),name:W(o.name,"Group"),locked:o.locked!==!1}));r.length>0&&(i.groups=r)}return Ch(i,Array.isArray(e.elements)?e.elements:[]),Je(i),i}function ro(e,n){let t=n?.kind;if(!t||t.kind!=="chartStat")return;let i=e.elements.find(a=>a.payload.id===t.layer);return i?.kind==="chart"?i:void 0}function pn(e,n){return e.elements.filter(t=>t.kind==="text"&&t.payload.value.kind.kind==="chartStat"&&t.payload.value.kind.layer===n)}function bh(e,n){let t=oa(e,fn(n))?.ref;return t?.displayName||t?.entityId||"Chart"}function ki(e,n,t){let i=bt(e,n.payload.id);if(i){co(e,t,i.id);return}let a=lo(e,[n.payload.id,t],bh(e,n)),r=e.groups?.find(o=>o.id===a);r&&(r.locked=!1)}var nd={top:{x:0,y:0},highest:{x:.35,y:0},average:{x:.65,y:0},latest:{x:1,y:0},bottom:{x:0,y:1},lowest:{x:.35,y:1},trend:{x:.85,y:0},delta:{x:.5,y:0},sum:{x:.2,y:0},first:{x:.65,y:1}};function id(e,n,t,i){let a=ce.rectangular,r=Math.min(1,(i*t*.62+4)/a.width),o=Math.min(1,t*1.3/a.height),s=e.x+n.x*e.width-n.x*r,l=e.y+n.y*e.height-n.y*o;return{x:Math.max(0,Math.min(1-r,s)),y:Math.max(0,Math.min(1-o,l)),width:r,height:o,rotationDegrees:0}}function ad(e,n,t){let i=e.elements.find(d=>d.payload.id===n);if(!i||i.kind!=="chart")return;let a=Ne("text"),r=t==="latest"?10:8,o={kind:{kind:"chartStat",layer:n,stat:t}};(t==="latest"||t==="delta"||t==="sum")&&(o.format={useEntityUnit:!0}),a.payload.value=o,a.payload.fontSize=r,a.payload.fontWeight="medium",a.payload.colorSlot={baseColorHex:t==="latest"?"#FFFFFF":"#FFFFFF99"};let s=t==="trend"?2:o.format?.useEntityUnit?7:4;a.payload.frame=id(i.payload.frame,nd[t],r,s);let l=e.elements.findIndex(d=>d.payload.id===n);return e.elements.splice(l+1,0,a),ki(e,i,a.payload.id),a.payload.id}var rd={highest:"arrowtriangle.up.fill",lowest:"circle.fill",now:"arrowtriangle.down.fill",first:"circle.fill",latest:"circle.fill",threshold:"circle.fill"},Tl=6,xh={"\u25B2":"arrowtriangle.up.fill","\u25BC":"arrowtriangle.down.fill","\u25CF":"circle.fill","\u25C6":"diamond.fill"};function vh(e,n){let t=(i,a)=>i!==void 0&&i!==a?i:void 0;return n==="highest"?t(e.payload.highColorHex,Pe)??"#FFD60A":n==="lowest"?t(e.payload.lowColorHex,ze)??"#FF453A":"#FFFFFF"}function od(e){e.nowIndex===void 0&&(e.nowIndex={kind:{kind:"time",timeField:"hour"}})}function hn(e,n){return e.elements.filter(t=>t.payload.chartAnchor?.layer===n)}function oo(e,n,t,i="above"){let a=e.elements.find(s=>s.payload.id===n);if(!a||a.kind!=="chart")return;t==="now"&&od(a.payload);let r=Ne("icon");r.payload.symbol=H(rd[t]),r.payload.size=Tl,r.payload.colorSlot={baseColorHex:vh(a,t)},r.payload.frame=wh(Tl),r.payload.chartAnchor={layer:n,at:t,place:i};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),ki(e,a,r.payload.id),r.payload.id}function sd(e,n){let t=e.elements.findIndex(u=>u.payload.id===n),i=e.elements[t];if(!i||i.kind!=="text"||i.payload.chartAnchor===void 0)return;let a=i.payload,r=a.chartAnchor,o=u=>{let p=sn(u);return p===void 0?void 0:xh[p.trim()]},s=new Set(Si.icon),l=u=>u.flatMap(p=>{if(p.kind==="setText"){let m=p.value===void 0?void 0:o(p.value);return m===void 0?[]:[{kind:"setIcon",value:H(m)}]}return s.has(Ae[p.kind])?[p]:[]}),d=a.rules.filter(u=>u.partId===void 0).map(u=>({...u,cases:u.cases.map(p=>({...p,then:l(p.then)})),...u.otherwise!==void 0?{otherwise:l(u.otherwise)}:{}})),c=Ne("icon");c.payload={...c.payload,id:a.id,colorSlot:a.colorSlot,rules:d,frame:a.frame,isHidden:a.isHidden,...a.groupId!==void 0?{groupId:a.groupId}:{},chartAnchor:r,symbol:H(o(a.value)??rd[r.at]),size:a.fontSize},e.elements[t]=c}function wh(e){let n=ce.rectangular;return{x:0,y:0,width:Math.min(1,e*1.2/n.width),height:Math.min(1,e*1.3/n.height),rotationDegrees:0}}function ld(e){let n=e.payload;if(n.highlight==="none"||n.highlight===void 0)return!1;let t=nt(n),i=n.highlight==="highest"||n.highlight==="both",a=n.highlight==="lowest"||n.highlight==="both";return i&&t.high!=="none"||a&&t.low!=="none"}function dd(e,n){let t=e.elements.find(l=>l.payload.id===n);if(!t||t.kind!=="chart")return;let i=t.payload,a=nt(i),r=i.highlight==="highest"||i.highlight==="both",o=i.highlight==="lowest"||i.highlight==="both",s=[];r&&a.high!=="none"&&s.push(["highest",a.high]),o&&a.low!=="none"&&s.push(["lowest",a.low]);for(let[l,d]of s){let c=oo(e,n,l),u=e.elements.find(p=>p.payload.id===c);u?.kind==="icon"&&(u.payload.symbol=H(d==="triangle"?"arrowtriangle.up.fill":"circle.fill"))}da(i,{high:"none",low:"none"})}var cd=[["now","Now line"],["threshold","Threshold line"]];function so(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;t==="now"&&od(a);let r=Ne("shape");r.payload.kind="line",r.payload.thickness=1,r.payload.borderWidth=0,r.payload.colorSlot={baseColorHex:t==="now"?a.nowColorHex:a.thresholdColorHex},r.payload.frame=kh(a.frame,t),r.payload.chartAnchor={layer:n,at:t,place:"through"};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),ki(e,i,r.payload.id),t==="now"?a.drawsNowLine=!1:a.drawsThreshold=!1,r.payload.id}function kh(e,n){let t=ce.rectangular,i=3;return n==="now"?{...e,width:Math.min(e.width,i/t.width),rotationDegrees:0}:{...e,height:Math.min(e.height,i/t.height),rotationDegrees:0}}function mn(e,n){return e.elements.filter(t=>t.kind==="chartTimes"&&t.payload.chart===n)}function ud(e,n){let t=e.elements.find(o=>o.payload.id===n);if(!t||t.kind!=="chart")return;let i=t.payload,a=Ne("chartTimes");a.payload.chart=n,a.payload.timeLabelCount=ht(i.timeLabelCount),a.payload.labelSize=i.labelSize,a.payload.labelColorHex=i.labelColorHex,a.payload.hourCycle=i.hourCycle,a.payload.minutes=i.minutes,a.payload.frame=$h(i.frame,i.labelSize,i.labelsAbove);let r=e.elements.findIndex(o=>o.payload.id===n);return e.elements.splice(r+1,0,a),ki(e,t,a.payload.id),i.drawsTimeLabels=!1,a.payload.id}function $h(e,n,t){let i=ce.rectangular,a=Math.max(Nn,Math.min(On,n)),r=Math.min(1,a*1.2/i.height),o=Math.min(1,Math.max(0,e.width)),s=t?e.y-r:e.y+e.height;return{x:Math.max(0,Math.min(1-o,e.x)),y:Math.max(0,Math.min(1-r,s)),width:o,height:r,rotationDegrees:0}}function Ch(e,n){for(let t of n){if(!L(t)||t.kind!=="chart"||!L(t.payload))continue;let i=t.payload,a=W(i.id).toUpperCase(),r=e.elements.find(p=>p.payload.id===a);if(!r||r.kind!=="chart")continue;let o=W(i.scaleLabelColorHex,"#FFFFFF99"),s=p=>{let m=L(p)?p:{};return{fontSize:q(m.fontSize,8),colorHex:W(m.colorHex,o),pillColorHex:typeof m.pillColorHex=="string"?m.pillColorHex:void 0}},l=[],d=le(i.scaleLabels);(d==="top"||d==="range")&&l.push(["top",s(i.topLabelStyle)]),d==="range"&&l.push(["bottom",s(i.bottomLabelStyle)]);let c=le(i.latestLabel);if((c==="corner"||c==="end")&&l.push(["latest",s(i.latestLabelStyle)]),l.length===0)continue;let u=e.elements.findIndex(p=>p.payload.id===a)+1;for(let[p,m]of l){let b=id(r.payload.frame,nd[p],m.fontSize,p==="latest"?5:4),y=[];if(m.pillColorHex!==void 0){let $=Ne("shape");$.payload.kind="capsule",$.payload.colorSlot={baseColorHex:m.pillColorHex},$.payload.frame={...b},y.push($)}let x=Ne("text");x.payload.value={kind:{kind:"chartStat",layer:a,stat:p}},x.payload.fontSize=m.fontSize,x.payload.fontWeight="medium",x.payload.colorSlot={baseColorHex:m.colorHex},x.payload.frame=b,y.push(x),e.elements.splice(u,0,...y),u+=y.length;for(let $ of y)ki(e,r,$.payload.id)}}}function j(e){return Number.isNaN(e)?"nan":e===1/0?"+inf":e===-1/0?"-inf":e}function Mt(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function Sh(e){let n={};return e.decimals!==void 0&&(n.decimals=j(e.decimals)),e.multiply!==void 0&&(n.multiply=j(e.multiply)),e.offset!==void 0&&(n.offset=j(e.offset)),e.prefix&&(n.prefix=e.prefix),e.suffix&&(n.suffix=e.suffix),e.useEntityUnit&&(n.useEntityUnit=!0),e.relativeTime&&(n.relativeTime=!0),e.duration&&(n.duration=!0),e.textCase!==void 0&&(n.textCase=e.textCase),n}function Th(e){let n=e.scope.kind==="entities"?{kind:"entities",entities:e.scope.entities.map(Mt)}:{kind:"filter",domains:e.scope.domains,areaIds:e.scope.areaIds,labelIds:e.scope.labelIds,floorIds:e.scope.floorIds},t={function:e.function,scope:n};return e.stateFilter&&(t.stateFilter=e.stateFilter.kind==="equals"||e.stateFilter.kind==="notEquals"?{kind:e.stateFilter.kind,value:e.stateFilter.value}:{kind:e.stateFilter.kind}),e.attribute!==void 0&&(t.attribute=e.attribute),t}function Eh(e){switch(e.kind){case"literal":return{kind:"literal",value:e.value};case"entityState":return{kind:"entityState",...Mt(e)};case"entityAttribute":return{kind:"entityAttribute",...Mt(e),attribute:e.attribute};case"entityAge":return{kind:"entityAge",...Mt(e)};case"aggregate":return{kind:"aggregate",aggregate:Th(e.aggregate)};case"time":return{kind:"time",timeField:e.timeField};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:e.value};case"named":return{kind:"named",id:e.id};case"chartStat":return{kind:"chartStat",layer:e.layer,stat:e.stat}}}function se(e){let n={kind:Eh(e.kind)};return Te(e.format)||(n.format=Sh(e.format)),n}function An(e){return{x:j(e.x),y:j(e.y),width:j(e.width),height:j(e.height),rotationDegrees:j(e.rotationDegrees)}}function Mh(e){let n={kind:e.kind};switch(e.kind){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":n.value=se(e.value??H(""));break;case"between":case"timeBetween":n.value=se(e.value??H("")),n.upper=se(e.upper??H(""));break;case"matchesRegex":n.pattern=e.pattern??"";break;case"isOneOf":n.options=e.options??[];break;default:break}return n}function El(e){let n={kind:e.kind};switch(e.kind){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":n.value=se(e.value??H(""));break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":n.number=j(e.number??0);break;case"setFontWeight":n.weight=e.weight??"regular";break;default:break}return n}function In(e){return e.map(n=>{let t={id:n.id,cases:n.cases.map(i=>({id:i.id,when:{join:i.when.join,tests:i.when.tests.map(a=>({id:a.id,value:se(a.value),comparison:Mh(a.comparison)}))},then:i.then.map(El)}))};return n.otherwise&&(t.otherwise=n.otherwise.map(El)),n.partId!==void 0&&(t.partId=n.partId),t})}function Rh(e){let n={id:e.id,value:se(e.value)};return e.colorHex!==void 0&&(n.colorHex=e.colorHex),e.fontWeight!==void 0&&(n.fontWeight=e.fontWeight),e.fontSize!==void 0&&(n.fontSize=j(e.fontSize)),e.coloring!==void 0&&e.coloring!=="uniform"&&(n.coloring=e.coloring),e.bands!==void 0&&e.bands.length>0&&(n.bands=e.bands.map(t=>({id:t.id,upTo:j(t.upTo),colorHex:t.colorHex}))),e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==oe&&(n.bandAboveColorHex=e.bandAboveColorHex),n}function Fh(e){let n=Ah(e);return e.payload.groupId!==void 0&&(n.payload.groupId=e.payload.groupId),n}function Ah(e){let n=t=>({id:t.id,colorSlot:{baseColorHex:t.colorSlot.baseColorHex},rules:In(t.rules),frame:An(t.frame),isHidden:t.isHidden});switch(e.kind){case"text":{let t={...n(e.payload),value:se(e.payload.value),fontSize:j(e.payload.fontSize),fontWeight:e.payload.fontWeight};e.payload.countdown===!0&&(t.countdown=!0),e.payload.monospacedDigits===!0&&(t.monospacedDigits=!0),e.payload.lineLimit===2&&(t.lineLimit=2),e.payload.alignment!==void 0&&e.payload.alignment!=="center"&&(t.alignment=e.payload.alignment);let i=e.payload;return i.coloring!==void 0&&i.coloring!=="uniform"&&(t.coloring=i.coloring),i.bands!==void 0&&i.bands.length>0&&(t.bands=i.bands.map(a=>({id:a.id,upTo:j(a.upTo),colorHex:a.colorHex}))),i.bandAboveColorHex!==void 0&&i.bandAboveColorHex!==oe&&(t.bandAboveColorHex=i.bandAboveColorHex),i.highlight!==void 0&&i.highlight!=="none"&&(t.highlight=i.highlight),i.highColorHex!==void 0&&i.highColorHex!==Pe&&(t.highColorHex=i.highColorHex),i.lowColorHex!==void 0&&i.lowColorHex!==ze&&(t.lowColorHex=i.lowColorHex),i.parts!==void 0&&i.parts.length>0&&(t.parts=i.parts.map(Rh),ft(i)&&(t.value=se(yi(i.parts)))),ia(i,t),{kind:"text",payload:t}}case"icon":{let t={...n(e.payload),symbol:se(e.payload.symbol)};return e.payload.path!==void 0&&e.payload.path!==""&&(t.path=e.payload.path),t.size=j(e.payload.size),ia(e.payload,t),{kind:"icon",payload:t}}case"gauge":{let t=e.payload,i={...n(t),value:se(t.value),minValue:j(t.minValue),maxValue:j(t.maxValue),style:t.style,lineWidth:j(t.lineWidth),trackColorHex:t.trackColorHex};return t.coloring!=="uniform"&&(i.coloring=t.coloring),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,upTo:j(a.upTo),colorHex:a.colorHex}))),t.bandAboveColorHex!==oe&&(i.bandAboveColorHex=t.bandAboveColorHex),t.thresholdValue!==void 0&&(i.thresholdValue=j(t.thresholdValue)),t.thresholdColorHex!==_n&&(i.thresholdColorHex=t.thresholdColorHex),t.total!==void 0&&(i.total=se(t.total)),t.minSource!==void 0&&(i.minSource=se(t.minSource)),t.maxSource!==void 0&&(i.maxSource=se(t.maxSource)),{kind:"gauge",payload:i}}case"chart":{let t=e.payload,i={...n(t),value:se(t.value),historyMinutes:Math.max(0,Math.round(t.historyMinutes)),historyPoints:Math.round(t.historyPoints),style:t.style,limit:Math.max(0,Math.round(t.limit)),takeFromEnd:t.takeFromEnd,scale:t.scale,minValue:j(t.minValue),maxValue:j(t.maxValue),baseline:t.baseline,barGap:j(t.barGap),lineWidth:j(t.lineWidth),highlight:t.highlight,highColorHex:t.highColorHex,lowColorHex:t.lowColorHex,marker:Dl(nt(t)),coloring:t.coloring,bands:t.bands.map(m=>({id:m.id,upTo:j(m.upTo),colorHex:m.colorHex})),bandAboveColorHex:t.bandAboveColorHex,fillBands:t.fillBands};t.source!==Vr&&(i.source=t.source),t.statPeriod!==mi&&(i.statPeriod=t.statPeriod),t.statType!==fi&&(i.statType=t.statType),t.thresholdValue!==void 0&&(i.thresholdValue=j(t.thresholdValue)),t.thresholdColorHex!==Pn&&(i.thresholdColorHex=t.thresholdColorHex),t.nowIndex!==void 0&&(i.nowIndex=se(t.nowIndex)),t.nowColorHex!==zn&&(i.nowColorHex=t.nowColorHex),t.drawsThreshold===!1&&(i.drawsThreshold=!1),t.drawsNowLine===!1&&(i.drawsNowLine=!1),t.drawsTimeLabels===!1&&(i.drawsTimeLabels=!1),t.scaleFrom!==void 0&&(i.scaleFrom=t.scaleFrom),t.labelSize!==qe&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==Ye&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==Qt&&(i.timeLabelCount=ht(t.timeLabelCount)),t.hourCycle!==en&&(i.hourCycle=t.hourCycle),t.minutes!==tn&&(i.minutes=t.minutes);let a=nt(t);Vl(a)||(i.highMarker=a.high,i.lowMarker=a.low);let r=t.curve??"straight";r!=="straight"&&(i.curve=r);let o=Rt(t.fillStyle);o!=="flat"&&(i.fillStyle=o),t.fillColorHex!==void 0&&(i.fillColorHex=t.fillColorHex);let s=At(t.barRadius);s!==Hn&&(i.barRadius=j(s));let l=It(t.barCorners);l!=="all"&&(i.barCorners=l);let d=Ft(t.pointDots);d!=="none"&&(i.pointDots=d);let c=tt(t.gridLines);c!==0&&(i.gridLines=c);let u=nn(t.gridColorHex);sa(u,Ht)||(i.gridColorHex=u),t.zeroLine===!0&&(i.zeroLine=!0);let p=Xe(t.smoothing);return p!==void 0&&(i.smoothing=p),t.gaps===!0&&(i.gaps=!0),{kind:"chart",payload:i}}case"timeline":{let t=e.payload,i={id:t.id,rules:In(t.rules),frame:An(t.frame),isHidden:t.isHidden,value:se(t.value)};return t.historyMinutes!==eo&&(i.historyMinutes=Math.max(1,Math.round(t.historyMinutes))),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,match:a.match,colorHex:a.colorHex}))),t.otherColorHex!==_t&&(i.otherColorHex=t.otherColorHex),t.gap!==0&&(i.gap=j(t.gap)),t.cornerRadius!==ql&&(i.cornerRadius=j(t.cornerRadius)),t.labelSize!==qe&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==Ye&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==Qt&&(i.timeLabelCount=Math.max(0,Math.min(vi,Math.round(t.timeLabelCount)))),t.hourCycle!==en&&(i.hourCycle=t.hourCycle),t.minutes!==tn&&(i.minutes=t.minutes),{kind:"timeline",payload:i}}case"shape":{let t={...n(e.payload),kind:e.payload.kind,cornerRadius:j(e.payload.cornerRadius),borderWidth:j(e.payload.borderWidth)};return e.payload.borderColorHex!==void 0&&(t.borderColorHex=e.payload.borderColorHex),e.payload.thickness!==1&&(t.thickness=j(e.payload.thickness)),ia(e.payload,t),{kind:"shape",payload:t}}case"image":{let t=e.payload,i={id:t.id,entity:Mt(t.entity),rules:In(t.rules),frame:An(t.frame),isHidden:t.isHidden};t.source!=="camera"&&(i.source=t.source),t.timestamp===!0&&(i.timestamp=!0),t.contentMode!=="fill"&&(i.contentMode=t.contentMode),t.zoom!==1&&(i.zoom=j(t.zoom)),t.panX!==0&&(i.panX=j(t.panX)),t.panY!==0&&(i.panY=j(t.panY)),t.cornerRadius!==Dn&&(i.cornerRadius=j(t.cornerRadius));let a=gt(t),r=a?no(t.timestampX,t.timestampY):t.timestampCorner;return r!=="topLeading"&&(i.timestampCorner=r),t.timestampSize!==Vn&&(i.timestampSize=j(t.timestampSize)),a&&(i.timestampX=j(t.timestampX),i.timestampY=j(t.timestampY)),ia(t,i),{kind:"image",payload:i}}case"tap":{let t=e.payload,i={id:t.id,action:pd(t.action)};return t.openPageId!==void 0&&(i.openPageId=t.openPageId),t.openPageName!==void 0&&(i.openPageName=t.openPageName),t.attachedTo!==void 0&&(i.attachedTo=t.attachedTo),i.rules=In(t.rules),i.frame=An(t.frame),i.isHidden=t.isHidden,{kind:"tap",payload:i}}case"chartTimes":{let t=e.payload,i={id:t.id,rules:In(t.rules),frame:An(t.frame),isHidden:t.isHidden,chart:t.chart};return t.labelSize!==qe&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==Ye&&(i.labelColorHex=t.labelColorHex),t.timeLabelCount!==Qt&&(i.timeLabelCount=ht(t.timeLabelCount)),t.hourCycle!==en&&(i.hourCycle=t.hourCycle),t.minutes!==tn&&(i.minutes=t.minutes),{kind:"chartTimes",payload:i}}}}function Ih(e){let n={},t=Object.keys(e.placements);if(t.length>0){let i={};for(let a of t){let r=e.placements[a],o={frame:An(r.frame)};r.isHidden&&(o.isHidden=!0),r.size!==void 0&&(o.size=j(r.size)),i[a]=o}n.placements=i}if(e.bezelText&&(n.bezelText=se(e.bezelText)),e.bezelCountdown===!0&&(n.bezelCountdown=!0),e.curvedText&&(n.curvedText=se(e.curvedText)),e.curvedColorHex!==void 0&&(n.curvedColorHex=e.curvedColorHex),e.bezelGauge){let i=e.bezelGauge,a={value:se(i.value),minValue:j(i.minValue),maxValue:j(i.maxValue),colorHexes:i.colorHexes};i.minLabel&&(a.minLabel=se(i.minLabel)),i.maxLabel&&(a.maxLabel=se(i.maxLabel)),n.bezelGauge=a}return e.backgroundColorHex!==void 0&&(n.backgroundColorHex=e.backgroundColorHex),n.cornerBodyShape=e.cornerBodyShape,e.borderColorHex!==void 0&&(n.borderColorHex=e.borderColorHex),n.borderWidth=j(e.borderWidth),e.rules.length>0&&(n.rules=In(e.rules)),n}function pd(e){if(e.type==="callService"){let n={type:e.type,serviceDomain:e.serviceDomain,serviceName:e.serviceName};return e.serviceDataJSON!==void 0&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),e.target!==void 0&&e.target.entityId!==""&&Object.assign(n,Mt(e.target)),n}return"entityId"in e?{type:e.type,...Mt(e)}:{type:e.type}}function Hh(e){let n={};return e.label!==void 0&&(n.label=e.label),n.value=se(e.value),e.symbol!==void 0&&(n.symbol=e.symbol),e.countdown&&(n.countdown=!0),n}function Un(e){let n=[];for(let i of ae){let a=e.perFamily[i];a&&n.push(i,Ih(a))}let t={schemaVersion:rn(e),id:e.id,name:e.name,values:e.values.map(i=>({id:i.id,name:i.name,value:se(i.value)})),slotIndex:e.slotIndex,elements:e.elements.map(Fh),supportedFamilies:e.supportedFamilies,perFamily:n,dataSources:e.dataSources.map(i=>i.kind==="template"?{kind:"template",value:i.value}:{kind:"entity",...Mt(i)}),tapAction:pd(e.tapAction)};return e.inline!==void 0&&(t.inline=Hh(e.inline)),e.refreshMinutes!==void 0&&(t.refreshMinutes=e.refreshMinutes),e.openPageId!==void 0&&(t.openPageId=e.openPageId),e.openPageName!==void 0&&(t.openPageName=e.openPageName),e.showSuccessFlash!==void 0&&(t.showSuccessFlash=e.showSuccessFlash),e.successFlashColorHex!==void 0&&(t.successFlashColorHex=e.successFlashColorHex),e.groups!==void 0&&e.groups.length>0&&(t.groups=e.groups.map(i=>({id:i.id,name:i.name,locked:i.locked}))),t}function bt(e,n){let i=e.elements.find(a=>a.payload.id===n)?.payload.groupId;return i===void 0?void 0:e.groups?.find(a=>a.id===i)}function xt(e,n){return e.elements.filter(t=>t.payload.groupId===n&&!fe(e,t))}function Je(e){let n=new Set((e.groups??[]).map(a=>a.id));for(let a of e.elements)a.payload.groupId!==void 0&&!n.has(a.payload.groupId)&&delete a.payload.groupId;let t=new Set(e.elements.map(a=>a.payload.groupId).filter(a=>a!==void 0)),i=(e.groups??[]).filter(a=>t.has(a.id));i.length===0?delete e.groups:e.groups=i}function Gn(e){if(!e.groups?.length)return;let n=e.elements.filter(r=>!fe(e,r)),t=e.elements.filter(r=>fe(e,r)),i=[],a=new Set;for(let r=n.length-1;r>=0;r--){let o=n[r];if(a.has(o.payload.id))continue;let s=o.payload.groupId;if(s===void 0){i.unshift(o),a.add(o.payload.id);continue}let l=n.filter(d=>d.payload.groupId===s);for(let d=l.length-1;d>=0;d--)i.unshift(l[d]),a.add(l[d].payload.id)}e.elements=[...i,...t],Nt(e)}function lo(e,n,t="Group"){let i=e.elements.filter(r=>n.includes(r.payload.id)&&!fe(e,r));if(i.length<2)return;let a={id:X(),name:t,locked:!0};e.groups=[...e.groups??[],a];for(let r of i)r.payload.groupId=a.id;return Je(e),Gn(e),a.id}function $i(e,n){for(let t of e.elements)t.payload.groupId===n&&delete t.payload.groupId;Je(e)}function co(e,n,t){let i=e.elements.find(a=>a.payload.id===n);!i||fe(e,i)||(t===void 0?delete i.payload.groupId:i.payload.groupId=t,Je(e),Gn(e))}var ne={config:["schemaVersion","id","name","values","slotIndex","elements","supportedFamilies","perFamily","inline","dataSources","refreshMinutes","tapAction","openPageId","openPageName","showSuccessFlash","successFlashColorHex","groups"],group:["id","name","locked"],inline:["label","value","symbol","countdown"],named:["id","name","value"],value:["kind","format"],format:["decimals","multiply","offset","prefix","suffix","useEntityUnit","relativeTime","duration","textCase"],entityRef:["entityId","displayName","domain","iconName"],aggregate:["function","scope","stateFilter","attribute"],scope:["kind","entities","domains","areaIds","labelIds","floorIds"],stateFilter:["kind","value"],frame:["x","y","width","height","rotationDegrees"],chartAnchor:["layer","at","place","dx","dy"],elementEnvelope:["kind","payload"],elementBase:["id","colorSlot","rules","frame","isHidden","groupId"],text:["value","fontSize","fontWeight","countdown","monospacedDigits","lineLimit","alignment","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex","parts","chartAnchor"],textPart:["id","value","colorHex","fontWeight","fontSize","coloring","bands","bandAboveColorHex"],icon:["symbol","path","size","chartAnchor"],gauge:["value","minValue","maxValue","style","lineWidth","trackColorHex","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","style","limit","takeFromEnd","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes","highMarker","lowMarker","curve","fillStyle","fillColorHex","barRadius","barCorners","pointDots","gridLines","gridColorHex","zeroLine","smoothing","gaps","bandLowColorHex","bandHighColorHex","bandLowerBound","bandUpperBound","scaleLabels","scaleLabelPlacement","latestLabel","topLabelStyle","bottomLabelStyle","latestLabelStyle","latestLabelFollowsBand","scaleLabelColorHex"],timeline:["value","historyMinutes","bands","otherColorHex","gap","cornerRadius","timeLabels","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["kind","cornerRadius","thickness","borderColorHex","borderWidth","chartAnchor"],image:["entity","source","timestamp","contentMode","zoom","panX","panY","cornerRadius","timestampCorner","timestampSize","timestampStyle","timestampX","timestampY","chartAnchor"],tap:["action","openPageId","openPageName","attachedTo","grow"],chartTimes:["chart","timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],colorSlot:["baseColorHex"],rule:["id","cases","otherwise","partId"],case:["id","when","then"],condition:["join","tests"],test:["id","value","comparison"],comparison:["kind","value","upper","pattern","options"],styleChange:["kind","value","number","weight"],layout:["placements","bezelText","bezelCountdown","curvedText","curvedColorHex","bezelGauge","backgroundColorHex","cornerBodyShape","borderColorHex","borderWidth","rules"],bezelGauge:["value","minValue","maxValue","colorHexes","minLabel","maxLabel"],placement:["frame","isHidden","size"],tapAction:["type","entityId","displayName","domain","iconName","serviceDomain","serviceName","serviceDataJSON"]},Ml={literal:["kind","value"],entityState:["kind",...ne.entityRef],entityAttribute:["kind",...ne.entityRef,"attribute"],entityAge:["kind",...ne.entityRef],aggregate:["kind","aggregate"],time:["kind","timeField"],dataAge:["kind"],jinja:["kind","value"],named:["kind","id"],chartStat:["kind","layer","stat"]};function ya(e){let n=[],t=(l,d,c)=>{if(L(l))for(let u of Object.keys(l))d.includes(u)||n.push(`${c}.${u}`)},i=(l,d)=>{if(!L(l))return;let c=typeof l.kind=="string"?l.kind:"";t(l,Ml[c]??["kind"],d),c==="aggregate"&&L(l.aggregate)&&(t(l.aggregate,ne.aggregate,`${d}.aggregate`),t(l.aggregate.scope,ne.scope,`${d}.aggregate.scope`),L(l.aggregate.scope)&&Array.isArray(l.aggregate.scope.entities)&&l.aggregate.scope.entities.forEach((u,p)=>t(u,ne.entityRef,`${d}.aggregate.scope.entities[${p}]`)),t(l.aggregate.stateFilter,ne.stateFilter,`${d}.aggregate.stateFilter`))},a=(l,d)=>{if(L(l)){if(L(l.kind))t(l,ne.value,d),i(l.kind,`${d}.kind`);else{let c=typeof l.kind=="string"?l.kind:"";t(l,[...Ml[c]??["kind"],"format"],d),c==="aggregate"&&i(l,d)}t(l.format,ne.format,`${d}.format`)}},r=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{t(c,ne.styleChange,`${d}[${u}]`),L(c)&&a(c.value,`${d}[${u}].value`)})},o=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{let p=`${d}[${u}]`;t(c,ne.rule,p),L(c)&&(Array.isArray(c.cases)&&c.cases.forEach((m,b)=>{let y=`${p}.cases[${b}]`;t(m,ne.case,y),L(m)&&(t(m.when,ne.condition,`${y}.when`),L(m.when)&&Array.isArray(m.when.tests)&&m.when.tests.forEach((x,$)=>{let C=`${y}.when.tests[${$}]`;t(x,ne.test,C),L(x)&&(a(x.value,`${C}.value`),t(x.comparison,ne.comparison,`${C}.comparison`),L(x.comparison)&&(a(x.comparison.value,`${C}.comparison.value`),a(x.comparison.upper,`${C}.comparison.upper`)))}),r(m.then,`${y}.then`))}),r(c.otherwise,`${p}.otherwise`))})};if(!L(e))return n;t(e,ne.config,"$"),Array.isArray(e.groups)&&e.groups.forEach((l,d)=>t(l,ne.group,`$.groups[${d}]`)),Array.isArray(e.values)&&e.values.forEach((l,d)=>{t(l,ne.named,`$.values[${d}]`),L(l)&&a(l.value,`$.values[${d}].value`)}),Array.isArray(e.elements)&&e.elements.forEach((l,d)=>{let c=`$.elements[${d}]`;if(t(l,ne.elementEnvelope,c),!L(l)||!L(l.payload))return;let u=typeof l.kind=="string"?l.kind:"",p=ne[u]??[];t(l.payload,[...ne.elementBase,...p],`${c}.payload`),t(l.payload.colorSlot,ne.colorSlot,`${c}.payload.colorSlot`),t(l.payload.frame,ne.frame,`${c}.payload.frame`),"chartAnchor"in l.payload&&t(l.payload.chartAnchor,ne.chartAnchor,`${c}.payload.chartAnchor`),o(l.payload.rules,`${c}.payload.rules`);for(let m of["value","symbol","nowIndex","total","minSource","maxSource"])m in l.payload&&a(l.payload[m],`${c}.payload.${m}`);u==="text"&&Array.isArray(l.payload.parts)&&l.payload.parts.forEach((m,b)=>{t(m,ne.textPart,`${c}.payload.parts[${b}]`),L(m)&&a(m.value,`${c}.payload.parts[${b}].value`)}),u==="image"&&t(l.payload.entity,ne.entityRef,`${c}.payload.entity`),u==="tap"&&t(l.payload.action,ne.tapAction,`${c}.payload.action`)});let s=[];if(Array.isArray(e.perFamily))for(let l=0;l+1<e.perFamily.length;l+=2)s.push([String(e.perFamily[l]),e.perFamily[l+1]]);else L(e.perFamily)&&s.push(...Object.entries(e.perFamily));for(let[l,d]of s){let c=`$.perFamily.${l}`;if(t(d,ne.layout,c),!!L(d)){if(L(d.placements))for(let[u,p]of Object.entries(d.placements))t(p,ne.placement,`${c}.placements.${u}`),L(p)&&t(p.frame,ne.frame,`${c}.placements.${u}.frame`);if(a(d.bezelText,`${c}.bezelText`),a(d.curvedText,`${c}.curvedText`),L(d.bezelGauge)){let u=`${c}.bezelGauge`;t(d.bezelGauge,ne.bezelGauge,u),a(d.bezelGauge.value,`${u}.value`),a(d.bezelGauge.minLabel,`${u}.minLabel`),a(d.bezelGauge.maxLabel,`${u}.maxLabel`)}o(d.rules,`${c}.rules`)}}return L(e.inline)&&(t(e.inline,ne.inline,"$.inline"),a(e.inline.value,"$.inline.value")),t(e.tapAction,ne.tapAction,"$.tapAction"),n}function X(){let e=globalThis.crypto;if(e&&"randomUUID"in e)return e.randomUUID().toUpperCase();let n=()=>Math.floor(Math.random()*65536).toString(16).padStart(4,"0"),t=(8+Math.floor(Math.random()*4)).toString(16)+n().slice(1);return`${n()}${n()}-${n()}-4${n().slice(1)}-${t}-${n()}${n()}${n()}`.toUpperCase()}function vt(){return{placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}}function hd(e,n,t=[...ae]){let i={};for(let r of ae)t.includes(r)&&(i[r]=vt());let a={schemaVersion:4,id:X(),name:e,values:[],slotIndex:n,elements:[],supportedFamilies:ui.filter(r=>t.includes(r)),perFamily:i,dataSources:[],refreshMinutes:0,tapAction:{type:"refresh"}};return t.includes("inline")&&(a.inline={value:H("Text")}),a.schemaVersion=rn(a),a}function Ne(e){let n=t=>({id:X(),colorSlot:{baseColorHex:t},rules:[],frame:{...gi},isHidden:!1});switch(e){case"text":return{kind:e,payload:{...n("#FFFFFF"),value:H("Text"),fontSize:14,fontWeight:"regular"}};case"icon":return{kind:e,payload:{...n("#FFFFFF"),symbol:H("lightbulb"),size:14}};case"gauge":return{kind:e,payload:{...n("#FFFFFF"),value:H("50"),minValue:0,maxValue:100,style:"arc",lineWidth:4,trackColorHex:"#FFFFFF40",coloring:"uniform",bands:[],bandAboveColorHex:oe,thresholdColorHex:_n}};case"chart":return{kind:e,payload:{...n("#FFFFFF"),value:H("13,14,16,17,19,22,24,28,30"),historyMinutes:pa,historyPoints:24,source:Vr,statPeriod:mi,statType:fi,style:"bars",curve:"smooth",fillStyle:"fade",limit:0,takeFromEnd:!1,scale:"auto",minValue:0,maxValue:100,baseline:"lowest",barGap:1.5,lineWidth:2,highlight:"none",highColorHex:Pe,lowColorHex:ze,marker:"none",coloring:"uniform",bands:[],bandAboveColorHex:oe,fillBands:!1,thresholdColorHex:Pn,nowColorHex:zn,timeLabelCount:Qt,labelSize:qe,labelColorHex:Ye,labelsAbove:!1,hourCycle:en,minutes:tn}};case"timeline":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,value:H(""),historyMinutes:nh,bands:[],otherColorHex:eh,gap:0,cornerRadius:th,timeLabelCount:ih,labelSize:qe,labelColorHex:Ye,labelsAbove:!1,hourCycle:en,minutes:tn}}}case"shape":return{kind:e,payload:{...n("#FFFFFF33"),kind:"roundedRectangle",cornerRadius:6,thickness:1,borderWidth:1}};case"image":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,entity:{entityId:"",displayName:"",domain:"camera"},source:"camera",contentMode:"fill",zoom:1,panX:0,panY:0,cornerRadius:Dn,timestampCorner:"topLeading",timestampSize:Vn}}}case"tap":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,action:{type:"refresh"}}}}case"chartTimes":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",timeLabelCount:Qt,labelSize:qe,labelColorHex:Ye,hourCycle:en,minutes:tn}}}}}function H(e){return{kind:{kind:"literal",value:e}}}function ba(e){switch(e.kind){case"text":return e.payload.fontSize;case"icon":return e.payload.size;case"gauge":return e.payload.lineWidth;case"chart":return e.payload.lineWidth;case"timeline":return;case"shape":return;case"image":return;case"tap":return;case"chartTimes":return}}var Rl=["circular","corner"],Fl=Math.SQRT1_2;function Lh(e){return e==="text"||e==="icon"?4:.5}function uo(e,n,t,i){let a=structuredClone(e),r=ce[n],o=ce[t];if(n===t||!r||!o)return a;let s=Rl.includes(n),l=Rl.includes(t),d=s===l?1:l?Fl:1/Fl,c=Math.min(o.width/r.width,o.height/r.height)*d;if(d!==1){let u=a.frame,p=u.x+u.width/2,m=u.y+u.height/2;a.frame={...u,width:u.width*d,height:u.height*d,x:.5+(p-.5)*d-u.width*d/2,y:.5+(m-.5)*d-u.height*d/2}}return a.size!==void 0&&(a.size=Math.max(Lh(i),Math.round(a.size*c*10)/10)),a}function md(e,n){let t=e.perFamily[n];return!t||Object.keys(t.placements).length===0?e.elements:e.elements.map(i=>{let a=t.placements[i.payload.id];if(!a)return i;let r={...i.payload,frame:a.frame,isHidden:a.isHidden};return a.size!==void 0&&(i.kind==="text"?r.fontSize=a.size:i.kind==="icon"?r.size=a.size:(i.kind==="gauge"||i.kind==="chart")&&(r.lineWidth=a.size)),{kind:i.kind,payload:r}})}function fn(e){switch(e.kind){case"text":return e.payload.value;case"icon":return e.payload.symbol;case"gauge":return e.payload.value;case"chart":return e.payload.value;case"timeline":return e.payload.value;case"shape":return;case"image":return{kind:{kind:"entityState",...e.payload.entity}};case"tap":return;case"chartTimes":return}}function hi(e){let n=[],t=i=>{for(let a of i)a.value&&n.push(a.value)};for(let i of e){for(let a of i.cases){for(let r of a.when.tests)n.push(r.value),r.comparison.value&&n.push(r.comparison.value),r.comparison.upper&&n.push(r.comparison.upper);t(a.then)}i.otherwise&&t(i.otherwise)}return n}var po=["light","switch","fan","input_boolean","cover","lock","media_player","siren","humidifier","valve","automation","group"];function oa(e,n){let t,i=n;for(let a=0;i!==void 0&&a<4;a++){let r=i.kind;if(r.kind==="chartStat"){i=ro(e,i)?.payload.value;continue}if("entityId"in r){if(r.entityId==="")return;let o={entityId:r.entityId,displayName:r.displayName,domain:r.domain};return t===void 0?{ref:o}:{ref:o,namedId:t}}if(r.kind!=="named")return;t=r.id.toUpperCase(),i=e.values.find(o=>o.id.toUpperCase()===t)?.value}}function ho(e,n){return oa(e,fn(n))?.ref}function mo(e,n){let t=ho(e,n),i=t&&(t.domain||t.entityId.split(".")[0])||"";return t&&po.includes(i)?{type:"toggleEntity",...t,domain:i}:{type:"refresh"}}function Al(e,n,t){if(ga(n)||t.width<=0||t.height<=0)return{...e};let i=n,a=e.x-i.left/t.width,r=e.x+e.width+i.right/t.width,o=e.y-i.top/t.height,s=e.y+e.height+i.bottom/t.height;return r<a&&(a=r=(a+r)/2),s<o&&(o=s=(o+s)/2),a=et(a),r=et(r),o=et(o),s=et(s),{...e,x:a,y:o,width:Math.max(0,r-a),height:Math.max(0,s-o)}}function fd(e,n,t){let i=a=>Math.round(a*100)/100||0;return{left:i((e.x-n.x)*t.width),right:i((n.x+n.width-e.x-e.width)*t.width),top:i((e.y-n.y)*t.height),bottom:i((n.y+n.height-e.y-e.height)*t.height)}}function gd(e,n,t,i){let a=e.elements.find(p=>p.payload.id===n);if(!a||a.kind!=="tap"||a.payload.attachedTo===void 0)return;let r=e.elements.find(p=>p.payload.id===a.payload.attachedTo);if(!r)return;let o=e.perFamily[t]?.placements[r.payload.id]?.frame??r.payload.frame,s=et(i.x),l=et(i.y),d=et(i.x+i.width),c=et(i.y+i.height),u={...i,x:s,y:l,width:Math.max(0,d-s),height:Math.max(0,c-l)};a.payload.outset=fd(o,u,ce[t])}function yd(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i)return;let a=e.perFamily[t];if(!a)return;let r=a.placements[n]?.frame??i.payload.frame,o=ce[t];return{width:r.width*o.width,height:r.height*o.height}}function Ve(e,n){return e.elements.filter(t=>t.kind==="tap"&&t.payload.attachedTo===n)}function fe(e,n){return n.kind!=="tap"||n.payload.attachedTo===void 0?!1:e.elements.some(t=>t.payload.id===n.payload.attachedTo&&t.kind!=="tap")}function fo(e,n){let t=e.elements.find(i=>i.payload.id===n);if(t){if(t.kind==="tap"&&t.payload.attachedTo!==void 0){let i=e.elements.find(a=>a.payload.id===t.payload.attachedTo);if(i)return i.payload.id}return t.payload.id}}function Nt(e){let n=new Map(e.elements.map(a=>[a.payload.id,a])),t=new Map;for(let a of e.elements){if(a.kind!=="tap")continue;let r=a.payload.attachedTo;if(r===void 0)continue;let o=n.get(r);if(!o||o.kind==="tap"||r===a.payload.id){delete a.payload.attachedTo;continue}let s=t.get(r);s?s.push(a):t.set(r,[a])}if(t.size===0)return;for(let[a,r]of t){let o=n.get(a);for(let s of r){let l=s.payload;l.outset===void 0&&(l.outset=fd(o.payload.frame,l.frame,ce.rectangular));let d=l.outset,c=!ga(d);s.payload.frame=Al(o.payload.frame,d,ce.rectangular),s.payload.isHidden=o.payload.isHidden;let u=Ph(e,a);for(let p of ae){let m=e.perFamily[p];if(!m)continue;let b=ce[p],y=m.placements[a];p!==u||!y?delete m.placements[s.payload.id]:c?m.placements[s.payload.id]={frame:Al(y.frame,d,b),isHidden:y.isHidden}:m.placements[s.payload.id]={frame:{...y.frame},isHidden:y.isHidden}}}}let i=[];for(let a of e.elements){if(a.kind==="tap"&&a.payload.attachedTo!==void 0)continue;i.push(a);let r=t.get(a.payload.id);r&&i.push(...r)}e.elements=i}function xa(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind==="tap")return;let a=Ve(e,n)[0];if(a)return a.payload;let r=Ne("tap"),o=r.payload;return o.attachedTo=n,o.outset={...io},o.action=t??mo(e,i),e.elements.push(r),Nt(e),o}function va(e,n){let t=Ve(e,n).map(i=>i.payload.id);if(t.length!==0){e.elements=e.elements.filter(i=>!t.includes(i.payload.id));for(let i of ae)for(let a of t)delete e.perFamily[i]?.placements[a]}}function We(e,n){for(let t of pn(e,n))We(e,t.payload.id);for(let t of mn(e,n))We(e,t.payload.id);for(let t of hn(e,n))delete t.payload.chartAnchor;va(e,n),e.elements=e.elements.filter(t=>t.payload.id!==n);for(let t of e.elements)t.kind==="chart"&&t.payload.scaleFrom===n&&delete t.payload.scaleFrom;for(let t of ae)delete e.perFamily[t]?.placements[n];Nt(e),Je(e)}function bd(e,n){let t=e.elements.findIndex(l=>l.payload.id===n),i=e.elements[t];if(!i)return;let a=X(),r=structuredClone(i);r.payload.id=a,r.payload.frame={...r.payload.frame,x:Math.min(.9,r.payload.frame.x+.05),y:Math.min(.9,r.payload.frame.y+.05)};let o=[r],s=[[n,a]];for(let l of Ve(e,n)){let d=structuredClone(l);d.payload.id=X(),d.payload.attachedTo=a,o.push(d),s.push([l.payload.id,d.payload.id])}e.elements.splice(t+1,0,...o);for(let l of ae){let d=e.perFamily[l];if(d)for(let[c,u]of s){let p=d.placements[c];p&&(d.placements[u]=structuredClone(p))}}return Nt(e),a}function xd(e,n){let t=e.elements.findIndex(o=>o.payload.id===n),i=e.elements[t];if(!i||i.kind!=="chart")return;let a=X(),r=structuredClone(i);r.payload.id=a,r.payload.scaleFrom=n,e.elements.splice(t+1,0,r);for(let o of ae){let s=e.perFamily[o],l=s?.placements[n];s&&l&&(s.placements[a]=structuredClone(l))}return a}function Kn(e,n,t){let i=new Set,a=d=>{i.add(d);for(let c of Ve(e,d))i.add(c.payload.id)};for(let d of n){a(d);for(let c of pn(e,d))a(c.payload.id)}let r=e.elements.filter(d=>i.has(d.payload.id)).map(d=>structuredClone(d)),o={};for(let d of ae){let c=e.perFamily[d];if(!c)continue;let u={};for(let p of r){let m=c.placements[p.payload.id];m&&(u[p.payload.id]=structuredClone(m))}Object.keys(u).length>0&&(o[d]=u)}let s=new Set(r.map(d=>d.payload.groupId).filter(d=>d!==void 0)),l=(e.groups??[]).filter(d=>s.has(d.id)).map(d=>structuredClone(d));return{elements:r,placements:o,groups:l,...t!==void 0?{family:t}:{}}}function vd(e,n,t){let i=n.family,a=i!==void 0&&i!==t&&ae.includes(i);if(!ae.includes(t))return an(e,n);let r=an(e,n,a?{nudge:!1}:{}),o=e.perFamily[t]??(e.perFamily[t]=vt());for(let s of r){let l=e.elements.find(p=>p.payload.id===s);if(!l)continue;let d=(i!==void 0?e.perFamily[i]?.placements[s]:void 0)??ae.map(p=>e.perFamily[p]?.placements[s]).find(p=>p!==void 0),c=d?.size??ba(l),u={frame:{...d?.frame??l.payload.frame},isHidden:!1,...c!==void 0?{size:c}:{}};for(let p of ae)p!==t&&delete e.perFamily[p]?.placements[s];o.placements[s]=a?uo(u,i,t,l.kind):u}return Wn(e,t),r}function an(e,n,t={}){let i=new Map;for(let d of n.elements)i.set(d.payload.id,X());let a=new Set(e.elements.map(d=>d.payload.id)),r=t.nudge!==!1&&n.elements.some(d=>a.has(d.payload.id)),o=d=>r?{...d,x:Math.min(.9,d.x+.05),y:Math.min(.9,d.y+.05)}:d,s=[];for(let d of n.elements){let c=structuredClone(d);if(c.payload.id=i.get(d.payload.id),c.kind==="tap"&&c.payload.attachedTo!==void 0){let u=i.get(c.payload.attachedTo);u?c.payload.attachedTo=u:delete c.payload.attachedTo}if(c.kind==="chart"&&c.payload.scaleFrom!==void 0){let u=i.get(c.payload.scaleFrom);u?c.payload.scaleFrom=u:a.has(c.payload.scaleFrom)||delete c.payload.scaleFrom}if(c.kind==="text")for(let u of c.payload.parts??[]){let p=u.value.kind,m=p.kind==="chartStat"?i.get(p.layer):void 0;p.kind==="chartStat"&&m&&(p.layer=m)}if(c.kind==="text"&&c.payload.value.kind.kind==="chartStat"){let u=i.get(c.payload.value.kind.layer);if(u)c.payload.value.kind.layer=u;else if(!a.has(c.payload.value.kind.layer))continue}if(c.kind==="chartTimes"){let u=i.get(c.payload.chart);if(u)c.payload.chart=u;else if(!a.has(c.payload.chart))continue}if(c.payload.chartAnchor!==void 0){let u=i.get(c.payload.chartAnchor.layer);u?c.payload.chartAnchor.layer=u:a.has(c.payload.chartAnchor.layer)||delete c.payload.chartAnchor}c.payload.frame=o(c.payload.frame),s.push(c)}let l=new Map;for(let d of n.groups){if(s.filter(p=>p.payload.groupId===d.id&&!(p.kind==="tap"&&p.payload.attachedTo!==void 0)).length<2)continue;let u=X();l.set(d.id,u),(e.groups??=[]).push({...structuredClone(d),id:u})}for(let d of s){if(d.payload.groupId===void 0)continue;let c=l.get(d.payload.groupId);c?d.payload.groupId=c:delete d.payload.groupId}e.elements.push(...s);for(let d of ae){let c=n.placements[d],u=e.perFamily[d];if(!(!c||!u))for(let[p,m]of Object.entries(c)){let b=i.get(p);b&&s.some(y=>y.payload.id===b)&&(u.placements[b]={...structuredClone(m),frame:o(m.frame)})}}return Nt(e),Je(e),Gn(e),s.filter(d=>!fe(e,d)).map(d=>d.payload.id)}function _h(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?!a.isHidden:!t.payload.isHidden}function Ph(e,n){let t=e.elements.find(r=>r.payload.id===n),a=(t&&t.kind==="tap"?t.payload.attachedTo:void 0)??n;return ae.find(r=>e.supportedFamilies.includes(r)&&e.perFamily[r]?.placements[a]!==void 0)}function at(e,n){let t=e.perFamily[n];return t?e.elements.filter(i=>{let a=i.kind==="tap"?i.payload.attachedTo:void 0;return t.placements[a??i.payload.id]!==void 0}):[]}function wd(e,n){let t=e.perFamily[n];return t?at(e,n).filter(i=>!fe(e,i)&&!t.placements[i.payload.id]?.isHidden).length:0}function Wn(e,n){let t=ae.filter(s=>e.supportedFamilies.includes(s));if(t.length===0)return;let i=n!==void 0&&t.includes(n)?n:t[0];for(let s of t)e.perFamily[s]||(e.perFamily[s]=vt());let a=()=>e.elements.filter(s=>!fe(e,s)),r=new Map,o=new Set;if(n===void 0){let s=new Map(a().map(p=>[p.payload.id,t.filter(m=>_h(e,m,p))]));for(let[p,m]of s)m[0]&&r.set(p,m[0]);let l=new Map([...a().entries()].map(([p,m])=>[m.payload.id,p]));for(let p of t){let m=a().filter(x=>(s.get(x.payload.id)??[]).includes(p)&&r.get(x.payload.id)!==p).map(x=>x.payload.id);if(m.length===0)continue;let b=Kn(e,m,p),y=an(e,b,{nudge:!1});y.forEach((x,$)=>{r.set(x,p);let C=y.length===m.length?m[$]:void 0;l.set(x,C!==void 0?l.get(C)??0:l.size)})}for(let p of a())r.has(p.payload.id)||o.add(p.payload.id);let d=p=>t.indexOf(r.get(p)??i),c=a().sort((p,m)=>d(p.payload.id)-d(m.payload.id)||(l.get(p.payload.id)??0)-(l.get(m.payload.id)??0)),u=[];for(let p of c)u.push(p),u.push(...Ve(e,p.payload.id));e.elements=u}for(let s of a()){let l=s.payload.id,d=t.filter(m=>e.perFamily[m].placements[l]!==void 0),c=r.get(l)??d.find(m=>!e.perFamily[m].placements[l].isHidden)??d[0]??i,u=e.perFamily[c]?.placements[l],p={frame:{...u?.frame??s.payload.frame},isHidden:o.has(l)||u?.isHidden===!0,...u?.size!==void 0?{size:u.size}:{}};s.payload.isHidden=!0;for(let m of ae){let b=e.perFamily[m];b&&(m===c?b.placements[l]=p:delete b.placements[l])}}}function wa(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t)return[];let i=[],a=oa(e,fn(t));if(a){let r=t.kind==="icon"?"symbol":t.kind==="image"?"camera":"value";i.push(a.namedId===void 0?{where:r,ref:a.ref}:{where:r,ref:a.ref,namedId:a.namedId})}for(let r of Ve(e,n)){let o=r.payload.action;!("entityId"in o)||o.entityId===""||i.push({where:"tap",ref:{entityId:o.entityId,displayName:o.displayName,domain:o.domain},tapId:r.payload.id})}for(let r of t.payload.rules)for(let o of r.cases)for(let s of o.when.tests){let l=oa(e,s.value);if(!l)continue;let d={where:"test",ref:l.ref,ruleId:r.id,caseId:o.id,testId:s.id};l.namedId!==void 0&&(d.namedId=l.namedId),i.push(d)}return i}function zr(e,n,t){if(!e)return;let i=e.kind;switch(i.kind){case"entityState":return{...e,kind:{kind:"entityState",...n}};case"entityAge":return{...e,kind:{kind:"entityAge",...n}};case"entityAttribute":return{...e,kind:{kind:"entityAttribute",...n,attribute:i.attribute}};case"literal":return t==="text"||t==="gauge"||t==="chart"||t==="timeline"?{...e,kind:{kind:"entityState",...n}}:void 0;default:return}}function kd(e,n,t,i){let a=e.elements.find(o=>o.payload.id===n);if(!a||t.entityId==="")return;let r={...t,domain:t.domain||t.entityId.split(".")[0]||""};if(a.kind==="timeline"){let o=a.payload.value.kind.kind==="entityState"?a.payload.value.kind.entityId:void 0,s=zr(a.payload.value,r,a.kind);s&&(a.payload.value=s),(a.payload.bands.length===0||o!==r.entityId)&&(a.payload.bands=to(r.domain,i))}else if(a.kind==="image")a.payload.entity=r;else if(a.kind==="text"||a.kind==="gauge"||a.kind==="chart"){let o=zr(a.payload.value,r,a.kind);o&&(a.payload.value=o)}else if(a.kind==="icon"){let o=zr(a.payload.symbol,r,a.kind);o&&(a.payload.symbol=o)}for(let o of Ve(e,n)){let s=o.payload;"entityId"in s.action&&(s.action={type:s.action.type,...r})}}var zh={text:"text",icon:"icon",gauge:"gauge",chart:"chart",timeline:"timeline",shape:"shape",image:"picture",tap:"tap area",chartTimes:"chart times"};function Il(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Hl(e){if(e.part==="template")return"Template text";if(e.part==="serviceData")return"Service data";let n=e.layerKind===void 0?"":zh[e.layerKind],t=e.layerName?`${n} "${e.layerName}"`:n;switch(e.kind){case"named":return e.valueName?`Shared value "${e.valueName}"`:"Shared value";case"layer":case"image":return e.part==="total"?`Total on ${t}`:e.part==="gaugeMin"?`Min on ${t}`:e.part==="gaugeMax"?`Max on ${t}`:e.part==="nowIndex"?`Now marker on ${t}`:e.part==="textPart"?`Part of ${t}`:`${Il(n)} layer${e.layerName?` "${e.layerName}"`:""}`;case"tap":return"Tap area";case"documentTap":return"Tap action";case"rule":return t===""?`Rule on the ${e.family??"shared"} shape`:`Rule on ${t}`;case"layout":{let i=Il(e.family??"");switch(e.part){case"curvedText":return`${i} curved text`;case"bezelGauge":return`${i} bezel gauge`;case"bezelGaugeMin":return`${i} bezel gauge low label`;case"bezelGaugeMax":return`${i} bezel gauge high label`;default:return`${i} bezel`}}case"inline":return"Inline"}}var $d=/(['"])([a-z0-9_]+\.[a-z0-9_]+)\1/g;function Nh(e){let n=[];for(let t of e.matchAll($d))t[2]!==void 0&&n.push(t[2]);return n}function go(e,n){return n.size===0?e:e.replace($d,(t,i,a)=>{let r=n.get(a);return r===void 0?t:`${i}${r}${i}`})}function ci(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function Oh(e,n){if(n.kind==="shape")return n.payload.kind==="roundedRectangle"?"rounded rectangle":n.payload.kind;if(n.kind==="tap")return"";if(n.kind==="image")return n.payload.entity.displayName||n.payload.entity.entityId;let t=fn(n)?.kind;if(t===void 0)return"";if(t.kind==="literal")return t.value;if("entityId"in t)return t.displayName||t.entityId;if(t.kind==="named"){let i=t.id.toUpperCase();return e.values.find(a=>a.id.toUpperCase()===i)?.name??""}return""}function ka(e,n){let t=(r,o)=>{n.value?.(r,o);let s=r.kind;if(s.kind==="jinja"){if(n.text){let d=n.text(s.value,{...o,part:"template"});d!==s.value&&(s.value=d)}return}if(s.kind==="aggregate"){let d=s.aggregate.scope;if(n.ref&&d.kind==="entities")for(let c=0;c<d.entities.length;c++){let u=n.ref(ci(d.entities[c]),o);u&&(d.entities[c]=u)}return}if(!n.ref||!("entityId"in s))return;let l=n.ref(ci(s),o);l&&(s.kind==="entityAttribute"?r.kind={kind:"entityAttribute",...l,attribute:s.attribute}:s.kind==="entityState"?r.kind={kind:"entityState",...l}:r.kind={kind:"entityAge",...l})},i=(r,o,s)=>{if(r.type==="callService"){if(n.ref&&r.target!==void 0&&r.target.entityId!==""){let d=n.ref(ci(r.target),o);d&&(r.target=d)}if(n.text&&r.serviceDataJSON!==void 0){let d=n.text(r.serviceDataJSON,{...o,part:"serviceData"});d!==r.serviceDataJSON&&(r.serviceDataJSON=d)}return}if(!n.ref||!("entityId"in r)||r.entityId==="")return;let l=n.ref(ci(r),o);l&&s({type:r.type,...l})};for(let r of e.values)t(r.value,{kind:"named",valueId:r.id,valueName:r.name});for(let r of e.elements){let o={kind:"layer",layerId:r.payload.id,layerKind:r.kind,layerName:Oh(e,r)};if(r.kind==="image"){if(n.ref){let l=n.ref(ci(r.payload.entity),{...o,kind:"image"});l&&(r.payload.entity=l)}}else if(r.kind==="tap"){let l=r.payload;i(l.action,{...o,kind:"tap"},d=>{l.action=d})}else{let l=fn(r);if(l&&t(l,o),r.kind==="text")for(let d of r.payload.parts??[])t(d.value,{...o,part:"textPart"});r.kind==="gauge"&&r.payload.total&&t(r.payload.total,{...o,part:"total"}),r.kind==="gauge"&&r.payload.minSource&&t(r.payload.minSource,{...o,part:"gaugeMin"}),r.kind==="gauge"&&r.payload.maxSource&&t(r.payload.maxSource,{...o,part:"gaugeMax"}),r.kind==="chart"&&r.payload.nowIndex&&t(r.payload.nowIndex,{...o,part:"nowIndex"})}let s={...o,kind:"rule"};for(let l of hi(r.payload.rules))t(l,s)}let a=Object.keys(e.perFamily).sort((r,o)=>{let s=ui.indexOf(r),l=ui.indexOf(o);return(s<0?ui.length:s)-(l<0?ui.length:l)});for(let r of a){let o=e.perFamily[r];if(!o)continue;let s={kind:"layout",family:r};o.bezelText&&t(o.bezelText,{...s,part:"bezelText"}),o.curvedText&&t(o.curvedText,{...s,part:"curvedText"});let l=o.bezelGauge;l&&(t(l.value,{...s,part:"bezelGauge"}),l.minLabel&&t(l.minLabel,{...s,part:"bezelGaugeMin"}),l.maxLabel&&t(l.maxLabel,{...s,part:"bezelGaugeMax"}));let d={kind:"rule",family:r};for(let c of hi(o.rules))t(c,d)}e.inline&&t(e.inline.value,{kind:"inline"}),i(e.tapAction,{kind:"documentTap"},r=>{e.tapAction=r})}function $a(e,n){ka(e,{value:n})}function Cd(e,n){return e.kind.kind==="named"&&e.kind.id.toUpperCase()===n.toUpperCase()}function Ci(e,n){let t=new Set;return $a(e,(i,a)=>{Cd(i,n)&&t.add(a.layerId??`${a.kind}:${a.valueId??""}:${a.family??""}:${a.part??""}`)}),t.size}function Dh(e,n){let t=new Set(e.values.map(a=>a.name.trim().toLowerCase())),i=n.trim()||"Value";if(!t.has(i.toLowerCase()))return i;for(let a=2;;a++){let r=`${i} ${a}`;if(!t.has(r.toLowerCase()))return r}}function yo(e,n,t){let i={id:X(),name:Dh(e,t),value:{kind:structuredClone(n.kind)}},a={kind:{kind:"named",id:i.id}};return n.format&&!Te(n.format)&&(a.format=structuredClone(n.format)),{named:i,ref:a}}function bo(e,n){if(n.kind.kind!=="named")return;let t=n.kind.id,i=e.values.find(o=>o.id.toUpperCase()===t.toUpperCase());if(!i)return;let a=n.format&&!Te(n.format)?n.format:i.value.format,r={kind:structuredClone(i.value.kind)};return a&&!Te(a)&&(r.format=structuredClone(a)),r}function xo(e,n){$a(e,t=>{if(!Cd(t,n))return;let i=bo(e,t);i&&(t.kind=i.kind,i.format?t.format=i.format:delete t.format)}),e.values=e.values.filter(t=>t.id.toUpperCase()!==n.toUpperCase())}function vo(e,n){ka(e,{ref:n})}function wo(e,n){ka(e,{text:n})}function ko(e,n){let t=[],i={ref:(a,r)=>{a.entityId!==""&&t.push({entityId:a.entityId,ref:a,where:Hl(r)})}};return n&&(i.text=(a,r)=>{for(let o of Nh(a)){let s=o.split(".")[0]??"";n(o,s)&&t.push({entityId:o,ref:{entityId:o,displayName:"",domain:s},where:Hl(r)})}return a}),ka(e,i),t}var Si={text:["color","opacity","text","fontSize","fontWeight","rotation","visibility"],icon:["color","opacity","icon","fontSize","rotation","visibility"],gauge:["color","opacity","gaugeValue","gaugeMin","gaugeMax","rotation","visibility"],chart:["color","opacity","rotation","visibility"],timeline:["opacity","rotation","visibility"],shape:["color","opacity","borderColor","borderWidth","rotation","visibility"],image:["opacity","rotation","visibility"],tap:["visibility"],chartTimes:["opacity","rotation","visibility"],layout:["backgroundColor","borderColor","borderWidth","text"]},Sd=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","greaterThan","greaterOrEqual","lessThan","lessOrEqual","between","timeBetween","contains","startsWith","endsWith","matchesRegex","isOneOf"];function gn(e){let n=e.trim();return/^([01][0-9]|2[0-3]):[0-5][0-9]$/.test(n)?n:void 0}function yn(e){switch(e){case"isOn":case"isOff":case"isUnavailable":case"isStale":case"isEmpty":return"none";case"between":return"between";case"timeBetween":return"times";case"matchesRegex":return"pattern";case"isOneOf":return"options";default:return"value"}}function Ca(e){switch(e){case"hide":case"show":return"none";case"setFontWeight":return"weight";case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":return"number";default:return"value"}}function $o(){return{id:X(),value:H(""),comparison:{kind:"isOn"}}}function Co(){return{id:X(),when:{join:"all",tests:[$o()]},then:[]}}function Ti(){return{id:X(),cases:[Co()]}}function Ll(e,n){return e&&(e.kind.kind!=="literal"||gn(e.kind.value)!==void 0)?e:H(n)}function So(e,n){let t={kind:n};switch(yn(n)){case"value":t.value=e.value??H("");break;case"between":t.value=e.value??H(""),t.upper=e.upper??H("");break;case"times":t.value=Ll(e.value,"22:00"),t.upper=Ll(e.upper,"06:00");break;case"pattern":t.pattern=e.pattern??"";break;case"options":t.options=e.options??[];break;case"none":break}return t}function bn(e){let n={kind:e};switch(Ca(e)){case"value":n.value=H(e==="setColor"||e==="setBorderColor"||e==="setBackgroundColor"?"#FF453A":e==="setIcon"?"exclamationmark.triangle":e==="setGaugeValue"?"50":"Text");break;case"number":n.number=e==="setOpacity"?.5:e==="setFontSize"?14:e==="setBorderWidth"?2:e==="setGaugeMax"?100:0;break;case"weight":n.weight="bold";break;case"none":break}return n}var Sa="shared:";function To(e){return Sa+e.toUpperCase()}function Ed(e){return e.values.filter(n=>n.value.kind.kind!=="entityState"&&Ci(e,n.id)>0)}function Md(e,n){return n.size===0?e:e.map(t=>{let i=n.get(To(t.id));if(i===void 0)return t;let a={kind:{kind:"literal",value:i}};return t.value.format&&(a.format=t.value.format),{...t,value:a}})}var Vh=["unavailable","unknown"],Bh={automation:["on","off"],script:["on","off"],remote:["on","off"],update:["on","off"],timer:["idle","active","paused"],sun:["above_horizon","below_horizon"],valve:["open","closed","opening","closing"],lawn_mower:["mowing","docked","paused","returning","error"],weather:["sunny","clear-night","partlycloudy","cloudy","rainy","pouring","snowy","snowy-rainy","fog","windy","windy-variant","lightning","lightning-rainy","hail","exceptional"]},Uh=new Set(["\xB0C","\xB0F"]);function Td(e){return Array.isArray(e)&&e.length>0&&e.every(n=>typeof n=="string")?e:void 0}function Ei(e){let n=typeof e=="number"?e:typeof e=="string"&&e.trim()!==""?Number(e):NaN;return Number.isFinite(n)?n:void 0}function Gh(e){let n=e?.trim().match(/\.(\d+)$/)?.[1]?.length??0;return n===0?1:10**-Math.min(n,4)}function Kh(e){let n=10**Math.floor(Math.log10(e));return([1,2,2.5,5,10].find(i=>i*n>=e)??10)*n}function Wh(e){let n=new Set,t=[];for(let i of e)i===void 0||i===""||n.has(i)||(n.add(i),t.push(i));return t}function Rd(e,n,t){let i=e.split(".")[0]??"",a=n?.attributes??{},o=Td(a.options)??(i==="climate"?Td(a.hvac_modes):void 0)??wi[i]??Bh[i];if(o)return{kind:"choice",options:Wh([...o,n?.state,t,...Vh])};let s=Ei(n?.state),l=typeof a.unit_of_measurement=="string"?a.unit_of_measurement:void 0;if(s===void 0&&l===void 0&&i!=="input_number"&&i!=="number")return{kind:"text"};let d=Ei(t),c=Ei(a.min),u=Ei(a.max),p=Ei(a.step),m,b;if(c!==void 0&&u!==void 0&&u>c)m=c,b=u;else if(l==="%")m=0,b=100;else{let x=Kh(Math.max(Math.abs(s??0)*2,10));m=(s??0)<0||l!==void 0&&Uh.has(l)?-x:0,b=x}d!==void 0&&(m=Math.min(m,d),b=Math.max(b,d));let y=p!==void 0&&p>0?p:Gh(n?.state);return{kind:"number",min:m,max:b,step:y}}function Fd(e){if(e.appliedToken===void 0)return{kind:"unsupported"};if(e.token===e.appliedToken){let n=!e.polling&&typeof e.lastPollSeconds=="number"?e.lastPollSeconds:void 0;return n===void 0?{kind:"sent"}:{kind:"sent",awaySeconds:n}}return e.pending&&e.polling?{kind:"sending"}:e.polling?{kind:"waiting"}:{kind:"offline"}}function jh(e){if(e<60)return"just now";let n=Math.floor(e/60);if(n<60)return`${n} min ago`;let t=Math.floor(n/60);if(t<24)return`${t} h ago`;let i=Math.floor(t/24);return`${i} ${i===1?"day":"days"} ago`}function Ad(e){switch(e.kind){case"unsupported":return{label:"Update the watch app",note:"to receive this",title:"This watch has never reported which changes it applied, so nothing saved here can reach it. Its Wrist Assistant app is older than custom complications, or it has not been opened on this home yet.",resend:!1};case"sent":return e.awaySeconds===void 0?{label:"On watch",title:"The watch has applied every change here.",resend:!1}:{label:"On watch",note:`last seen ${jh(e.awaySeconds)}`,title:"The watch has applied every change here, but it is not listening now. A save made after this will not reach it until the watch app is open on this home again.",resend:!1};case"sending":return{label:"Sending\u2026",title:"Waiting for the watch to pull and confirm.",resend:!1};case"waiting":return{label:"Not on watch yet",title:"The watch is connected but has not confirmed the latest change. Resend wakes it again.",resend:!0};case"offline":return{label:"Open the watch app to sync",title:"Saves reach the watch by themselves while Wrist Assistant is open on this home. Open the app, or switch the watch to this home, and it pulls at once.",resend:!0}}}function Hd(e){let n=new TextEncoder().encode(e),t=0xcbf29ce484222325n,i=0x100000001b3n,a=0xffffffffffffffffn;for(let r of n)t^=BigInt(r),t=t*i&a;return t.toString(16)}function Ld(e){return new Map(e.map(n=>[n.id.toUpperCase(),n.value]))}function Id(e){return e.kind==="entityAttribute"||e.kind==="entityAge"||e.kind==="aggregate"||e.kind==="time"||e.kind==="jinja"}function Eo(e,n,t=0){let i=n instanceof Map?n:Ld(n),a=e.kind;if(a.kind==="named"){if(t>8)return;let o=i.get(a.id.toUpperCase());return o?o.kind.kind==="named"?Eo(o,i,t+1):Id(o.kind)?"n_"+a.id.toLowerCase().replace(/-/g,""):void 0:void 0}if(!Id(a))return;let r=Mi(a);if(r!==void 0)return"e_"+Hd(r)}function Ze(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function qh(e){let n;if(e.scope.kind==="entities")n=`expand([${e.scope.entities.map(o=>Ze(o.entityId)).join(", ")}])`;else{let{domains:o,areaIds:s,labelIds:l,floorIds:d}=e.scope;if(!(s.length+l.length+d.length>0))n=o.length===0?"[]":"("+o.map(u=>`(states.${u} | list)`).join(" + ")+")";else{let u=[];for(let p of s)u.push(`area_entities(${Ze(p)})`);for(let p of l)u.push(`label_entities(${Ze(p)})`);d.length>0&&u.push(`((${d.map(p=>`floor_areas(${Ze(p)})`).join(" + ")}) | map('area_entities') | sum(start=[]))`),n=`(expand(${u.join(" + ")})`,o.length>0&&(n+=` | selectattr('domain', 'in', [${o.map(Ze).join(", ")}])`),n+=")"}}let t=n,i=e.stateFilter;if(i&&(i.kind==="isOn"?t+=" | selectattr('state', 'eq', 'on')":i.kind==="isOff"?t+=" | selectattr('state', 'eq', 'off')":i.kind==="equals"?t+=` | selectattr('state', 'eq', ${Ze(i.value)})`:t+=` | rejectattr('state', 'eq', ${Ze(i.value)})`),e.function==="count")return`(${t} | list | count)`;let a=e.attribute?`attributes.${e.attribute}`:"state",r=`${t} | map(attribute=${Ze(a)}) | map('float', 0) | list`;switch(e.function){case"sum":return`(${r} | sum)`;case"average":return`(${r} | average(0))`;case"min":return`(${r} | min(default=0))`;case"max":return`(${r} | max(default=0))`}}function Mi(e){switch(e.kind){case"entityAttribute":return`state_attr(${Ze(e.entityId)}, ${Ze(e.attribute)})`;case"entityAge":{let n=Ze(e.entityId);return`(((now() - states[${n}].last_changed).total_seconds() if states[${n}] is not none else 0) | round(0))`}case"time":switch(e.timeField){case"now":return"now().strftime('%H:%M')";case"hour":return"now().hour";case"minute":return"now().minute";case"day":return"now().day";case"month":return"now().month";case"weekday":return"now().weekday()";case"timestamp":return"(as_timestamp(now()) | round(0))"}return;case"jinja":return e.value.trim().length===0?void 0:e.value;case"aggregate":return qh(e.aggregate);default:return}}function Ta(e){let n=new Map,t=new Map,i=Ld(e.values),a=(o,s=0)=>{let l=o.kind;switch(l.kind){case"literal":case"dataAge":case"chartStat":return;case"entityState":n.set(l.entityId,l);return;case"named":{if(s>8)return;let d=i.get(l.id.toUpperCase());if(!d)return;if(d.kind.kind==="named"){a(d,s+1);return}if(d.kind.kind==="entityState"){n.set(d.kind.entityId,d.kind);return}let c=Mi(d.kind);if(c===void 0)return;t.set("n_"+l.id.toLowerCase().replace(/-/g,""),c);return}default:{let d=Mi(l);if(d===void 0)return;t.set("e_"+Hd(d),d)}}};for(let o of e.values)a({kind:{kind:"named",id:o.id}});for(let o of e.elements){let s=fn(o);if(s&&a(s),o.kind==="text")for(let l of o.payload.parts??[])a(l.value);o.kind==="gauge"&&o.payload.total&&a(o.payload.total),o.kind==="gauge"&&o.payload.minSource&&a(o.payload.minSource),o.kind==="gauge"&&o.payload.maxSource&&a(o.payload.maxSource),o.kind==="chart"&&o.payload.nowIndex&&a(o.payload.nowIndex);for(let l of hi(o.payload.rules))a(l)}for(let o of ae){if(!e.supportedFamilies.includes(o))continue;let s=e.perFamily[o];if(s){s.bezelText&&a(s.bezelText),s.curvedText&&a(s.curvedText),s.bezelGauge&&(a(s.bezelGauge.value),s.bezelGauge.minLabel&&a(s.bezelGauge.minLabel),s.bezelGauge.maxLabel&&a(s.bezelGauge.maxLabel));for(let l of hi(s.rules))a(l)}}e.supportedFamilies.includes("inline")&&e.inline&&a(e.inline.value);let r={entities:n,expressions:t};return t.size>0&&(r.document=Yh(t)),r}function Yh(e){let n=[...e.keys()].sort(),t=[];for(let a of n){let r=e.get(a);r.includes("{{")||r.includes("{%")?t.push(`{% set v_${a} %}${r}{% endset %}`):t.push(`{% set v_${a} = ${r} %}`)}let i=n.map(a=>`"${a}": v_${a}`).join(", ");return t.push(`{{ { ${i} } | to_json }}`),t.join(`
`)}function _d(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Xh(r));return{values:t,nullKeys:i}}function Xh(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Mo(e){let n=Ta(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Jh(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Kr(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Zh=10800;function Qh(e,n,t){let i=n==="always"||n==="auto"&&t<=Zh;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Fo(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Qh(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function em(e,n){return zt(e)===void 0?[]:Fo(it(e)*60,ma(e.timeLabelCount),e.hourCycle,e.minutes,n)}function tm(e,n){return dn(e)?Fo(Math.round(e.historyMinutes)*60,ma(ht(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function nm(e,n,t){return n===void 0||!dn(n)?[]:Fo(Math.round(n.historyMinutes)*60,ma(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function xn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Be(e){let n=e.trim(),t=xn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:xn(i)}function im(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function am(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function rm(e){let n=e.trim(),t=xn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?xn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=xn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function om(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function sm(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function lm(e,n,t){if(Te(n))return e;let i=n,a=e,r=xn(e.trim()),o=i.duration?rm(e):void 0;if(o!==void 0)a=om(o);else if(i.relativeTime&&r!==void 0)a=am(r);else{let s=Be(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):im(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=sm(a);break}return a}function jn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Qe(e,n=240){return Dd(e,n).map(t=>t.value)}function Ao(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Qe(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:Od(r)}}function Od(e){return e.some(n=>n)?e:[]}function Dd(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Pd(e,n,t){let i=Dd(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Lt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??oe,c=t.highColorHex??Pe,u=t.lowColorHex??ze,p=[],m=(y,x)=>{if(y==="")return;let $=p.at(-1);$&&$.colorHex===x?$.text+=y:p.push({text:y,colorHex:x})},b=0;return i.forEach((y,x)=>{m(e.slice(b,y.start),n);let $=x===o?c:x===s?u:l.length>0?ua(y.value,l,d):n,C=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,C),$),b=C}),m(e.slice(b),n),p}function zd(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function dm(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Fi(e,n=Pt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:cm(i.slice(a+1))})}return t}function cm(e){try{return decodeURIComponent(e)}catch{return e}}function um(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Nd(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function pm(e,n,t){if(e===void 0)return 0;let i=Be(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var rt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=zd(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=cn(n),i=un(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Ao(a):{values:Qe(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=Od(s),{values:Ho(o,Xe(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Be(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Be(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):zd(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Te(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Jh(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Ul(r):Kr(r,a.domainMax-a.domainMin));break}default:{let a=Eo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return lm(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=xn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?jn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Be(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Be(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Be(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=gn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:gn(d),p=c===void 0?void 0:gn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ae[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Pd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,b=ft(n.payload)&&!r.has("text"),y={kind:"text",...u,text:b?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),b?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(x=>x.text).join(""),y):(Nl(n.payload)&&(y.spans=Pd(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),b=n.payload.symbol.kind.kind==="literal",y=m===void 0&&b&&n.payload.path!==""?n.payload.path:void 0,x=m??p;y===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let $={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&($.path=y),$}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),b=(I,G,Q)=>I??(G?Be(this.resolve(G)??""):void 0)??Q,y=b(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=b(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),$=m===void 0?void 0:Be(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&$!==void 0&&(C=ua($,Lt(p),p.bandAboveColorHex));let k=x-y;if(p.total){let I=Be(this.resolve(p.total)??"");I!==void 0&&(k=I)}let S=Nd(k,1,ca),O={kind:"gauge",...u,fraction:pm(m,y,x),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:Nd($??0,0,S)};if(p.thresholdValue!==void 0&&x!==y){let I=(p.thresholdValue-y)/(x-y);I>=0&&I<=1&&(O.thresholdFraction=I)}return O}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),b=m.values,y=m.holes,x={min:m.domainMin,max:m.domainMax},$=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Lt(p),k=Bl(p)?b.map(Y=>ua(Y,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",O=p.highlight==="lowest"||p.highlight==="both",I=nt(p),G={kind:"chart",...u,values:b,holes:y,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:$,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?I.high:"none",lowMarker:O?I.low:"none",pointColorHexes:k,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:Xe(p.smoothing)??"off",fillStyle:Rt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:At(p.barRadius),barCorners:It(p.barCorners),pointDots:Ft(p.pointDots),gridLines:tt(p.gridLines),gridColorHex:nn(p.gridColorHex),zeroLine:p.zeroLine===!0,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:tm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},Q=y.length===0?b:b.filter((Y,P)=>!y[P]);if(Q.length>0){let Y=F=>b.findIndex((V,g)=>V===F&&y[g]!==!0),P=S?Y(Math.max(...Q)):-1,te=O?Y(Math.min(...Q)):-1;P>=0&&(G.highIndex=P),te>=0&&te!==P&&(G.lowIndex=te)}let T=dm(p,x.min,x.max);T!==void 0&&(G.thresholdY=T);let U=this.chartNowIndex(p,b.length);return U!==void 0&&(G.nowIndex=U),G}case"timeline":{let p=n.payload,m=zt(p),b=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=Fi(b,Pt),x=um(y,it(p)*60,C=>Yl(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:em(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};gt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:nm(p,this.chartElements.get(p.chart),this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=[...ym(md(n,t).map(y=>this.resolveElement(y,i)),ce[t==="inline"?"rectangular":t])],o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,x=this.resolve(y.value),$=x===void 0?void 0:Be(x);if($!==void 0){let C=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),S={value:Math.min(k,Math.max(C,$)),minValue:C,maxValue:k===C?C+1:k,colorHexes:y.colorHexes},O=this.resolve(y.minLabel);O!==void 0&&(S.minLabel=O);let I=this.resolve(y.maxLabel);I!==void 0&&(S.maxLabel=I),s.bezelGauge=S}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let b=this.styleColor(o,"borderColor")??a?.borderColorHex;return b!==void 0&&(s.borderColorHex=b),s}};function hm(e,n,t){let i=new rt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Ai(e,n,t){let i=new rt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=hm(e.inline,n,e)),a}function Ea(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Ro=5,mm=1.7,fm=1.8;function gm(e,n,t,i,a,r){return e==="bars"||n==="none"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Io(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.lineWidth*fm,c=gm(e.style,e.pointDots,t.length,s,l,d),u=c?Math.max(l,d/2):l,p=P=>P==="triangle"?Ro+u:P==="dot"?Math.max(u,mm):u,m=p(a),b=p(r),y=n.y+m,x=Math.max(n.h-m-b,1),$=y+x,C=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",S=k?x*.12:0,O=Math.min(Math.max(e.barGap,0),s/(i*2)),I=Math.max((s-O*(i-1))/i,.5),G=P=>Math.min(1,Math.max(0,(P-e.domainMin)/C)),Q=P=>$-G(P)*x,T=Math.max(0,Math.min(4,Math.round(e.gridLines))),U=Array.from({length:T},(P,te)=>y+x*(te+1)/(T+1)),Y;if(e.zeroLine&&e.domainMin<=0&&e.domainMax>=0){let P=Q(0);P!==y&&P!==$&&(Y=P)}return{count:t.length,barWidth:I,plotTop:y,plotBottom:$,plotLeft:o,plotRight:o+s,baselineY:k?$:Q(0),drawsDots:c,dotDiameter:d,gridYs:U,zeroY:Y,yAtFraction(P){return $-Math.min(Math.max(P,0),1)*x},barRect(P){let te=o+P*(I+O),F=t[P],V,g;if(k){let w=S+G(F)*(x-S);V=$-w,g=$}else V=Q(F),g=k?$:Q(0),V>g&&([V,g]=[g,V]);return{x:te,y:V,w:I,h:Math.max(g-V,.5)}},point(P){let te=Math.max(s-u*2,0);return{x:t.length>1?o+u+te*P/(t.length-1):o+s/2,y:Q(t[P])}},markerCenter(P,te,F="high"){let V=te?this.barRect(P):void 0,g=V?V.x+V.w/2:this.point(P).x,w=F==="high"?a:r,M=F==="high"?w==="triangle"?n.y+Ro/2:y:w==="triangle"?n.y+n.h-Ro/2:$;return{x:g,y:M}}}}function Vd(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Ho(e,n,t=[]){let i=e.length,a=zl(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,b=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let x=y-p,$=Math.exp(-(x*x)/(2*o*o));m+=e[y]*$,b+=$}return m/b}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function Bd(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Ri=1;function Ii(e,n){let t=Math.max(Nn,Math.min(On,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Ri>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Ri:n.y,h:n.h-i-Ri,cy:(e.labelsAbove?n.y+i+Ri:n.y)+(n.h-i-Ri)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function ym(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;let o=xm(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function bm(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return}}function xm(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Ea(t,i);if(a.w<=0||a.h<=0)return;let r=Ii(t,a).body;if(r.w<=0||r.h<=0)return;let o=Io(t,r),s,l;if(mt(n.at)){let $=bm(n.at,t);if($===void 0)return;if(t.style==="bars"){let C=o.barRect($);s=C.x+C.w/2,l=C.y}else{let C=o.point($);s=C.x,l=C.y}}else{if(t.thresholdY===void 0)return;l=o.yAtFraction(t.thresholdY)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=($,C,k)=>C>k?(C+k)/2:Math.min(Math.max($,C),k),m={...e};if(s!==void 0){let $=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=($-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let $=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=($-c/2)/i.height}return m}let b=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(b,r.y+c/2,r.y+r.h-c/2),x=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Ee=ce,Hi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ee,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],qn=Hi.find(e=>e.measured);function Zd(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Hi.find(a=>a.screen.width===t&&a.screen.height===i)}function Ra(e,n){let t=Ee[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var zo={regular:400,medium:500,semibold:600,bold:700},vm=1.15;function Oe(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ge(e,n,t="#FFFFFF"){let i=Oe(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var wt=e=>e*.55;function Qd(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function wm(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function km(e,n,t){if(t<=0||e.length*wt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/wt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function $m(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function ec(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function tc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Cm(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function nc(e,n){return e.reduce((t,i)=>t+i.text.length*wt(i.look.fontSize*n),0)}function Sm(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:wt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=wt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Tm(e,n,t){if(t<=0||nc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*wt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*wt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Em(e,n,t){let i=Cm(n),a=e.lineLimit===2&&t.w>0?Sm(e.text,i,t.w):[e.text],r=ec(e.text,a),o=a.map((C,k)=>tc(C,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>nc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>Tm(C,l,t.w)),{anchor:c,x:u}=Qd(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,b=p*1.15,y=C=>C.map(k=>{let S=ge(k.look.colorHex,"fill");return v`<tspan font-size=${k.look.fontSize*l} font-weight=${zo[k.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${k.text}</tspan>`}),x=ge(e.colorHex,"fill"),$=d.length>1?v`${d.map((C,k)=>v`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*b}>${y(C)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${$}</text>`}function Mm(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:Em(e,e.parts,n);let t=ge(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:jn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?wm(e.text,n.w/wt(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*wt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>km(y,o,n.w)),{anchor:l,x:d}=Qd(e.alignment,n),c=$m(e.text,e.spans),u=c?ec(e.text,i):[],p=(y,x)=>c?tc(y,u[x]??0,e.text,c,e.colorHex).map($=>{let C=ge($.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${$.text}</tspan>`}):y,m=o*1.15,b=s.length>1?v`${s.map((y,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(y,x)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${zo[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${b}</text>`}var Lo=2;function Rm(e,n){let t=ge(e.colorHex,"stroke"),i=ge(e.trackColorHex,"stroke","#FFFFFF"),a=ge(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,b=Math.max(1,e.dotCount),y=m?n.w:n.h,x=m?n.h:n.w,$=Math.max(1,Math.min(x,y/b-Lo)),C=b*$+(b-1)*Lo,k=(m?n.cx:n.cy)-C/2+$/2;return v`${Array.from({length:b},(S,O)=>{let I=k+O*($+Lo),G=O<e.filledCount?t:i;return v`<circle cx=${m?I:n.cx} cy=${m?n.cy:I} r=${$/2}
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function Am(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Ii(e,n),o=r?Bo(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=Hm(e,a);return o===void 0?s:v`${s}${o}`}function _o(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var Ud=0;function ic(){return Ud+=1,Ud.toString(36)}function Im(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function Hm(e,n){let t=Io(e,n),i=ic(),a=ge(e.colorHex,"fill"),r=ge(e.highColorHex,"fill",e.colorHex),o=ge(e.lowColorHex,"fill",e.colorHex),s=(b,y)=>v`<circle cx=${b.x} cy=${b.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=b=>c?ge(e.pointColorHexes[b],"fill",e.colorHex):a;if(t.gridYs.length>0||t.zeroY!==void 0){let b=Oe(e.gridColorHex)??Oe(Ht),y=x=>v`<path d=${`M${t.plotLeft} ${x} L${t.plotRight} ${x}`} fill="none"
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?v`${s}${Bo(e,n,t,i)}`:v`${s}`}function Pm(e,n){if(e.labels.length===0||n.w<=0||n.h<=0)return f;let{labelSize:t,rowHeight:i}=Ii({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),a={...n,y:n.cy-i/2,h:i};return v`${Bo({labels:e.labels,labelColorHex:e.labelColorHex,labelsAbove:!1},a,t,i)}`}function zm(e,n){let t=ge(e.fillColorHex,"fill"),i=e.borderColorHex?Oe(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return v`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Nm(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ge(e.colorHex,"fill"),s=e.size*vm;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Uo=.25,Om=8;function Dm(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Uo),Om),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,b=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(b-n)/2*(1+x)+0,width:m,height:b}}function Fa(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var Ma=4;function Aa(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+Ma:n.x+n.w-Ma-a,d=e.timestampCorner.startsWith("top")?n.y+Ma:n.y+n.h-Ma-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Vm(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Bm(e,n,t){let i=t.icons,a=`imgclip-${ic()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Aa(e,n,Fa(new Date)):void 0,s=o?v`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,b])=>v`<rect data-ts-corner=${p} x=${m-l/2} y=${b-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=Dm(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=v`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Vm(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Um(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Gm(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${No} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var No=5;function Gm(e,n){let t=No*.55,i=n.w-2;if(n.h<No*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Oo(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=Ea(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=Mm(e,l);break;case"icon":c=Nm(e,l,t.icons);break;case"gauge":c=Rm(e,l);break;case"chart":c=Am(e,l);break;case"timeline":c=_m(e,l);break;case"chartTimes":c=Pm(e,l);break;case"shape":c=zm(e,l);break;case"image":c=Bm(e,l,t);break;case"tap":c=Um(e,l,t.icons,a,d?yt(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,p=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,m=t.highlightId===e.id,b=m||t.highlightIds?.includes(e.id)===!0,y=t.handles===!0&&(!s||o),x=b?v`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,$=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${C}${c}${$}${x}${S}</g>`}function Ia(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Go(e,n){return(n?23.5:34)*e}var Gd=10.5;function ac(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Kd(e,n){let t=0;for(let i of e)t+=ac(i,n);return t}function Wd(e,n,t){let i=e.toUpperCase(),a=d=>ac(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Do(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Vo(e,n,t,i){let a=Do(e,n,t),r=Do(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function rc(e,n,t,i){let{dial:a}=Ia(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Vo(a,t,i.start,i.end),length:t*r}}function Km(e,n){let t=Ia(e,!0);return rc(e,n,t.dial.r,t.labelArc)}var jd=18.5,Wm=113,jm={start:-71,end:-36},qd=104,qm=6.2,Yd={start:-77,end:-30.5};function Xd(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Jd(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Xd(e[i]),o=Xd(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var Po=11;function Ym(e,n,t){let{dial:i}=Ia(n,!0),a=qd*n,r=180/(Math.PI*qd),o=e.minLabel!==void 0?Kd(e.minLabel,Po)*r:0,s=e.maxLabel!==void 0?Kd(e.maxLabel,Po)*r:0,l=Yd.start+(o>0?Math.max(0,o-1.8):0),d=Yd.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let $=0;$<u;$++){let C=l+c*$/u,k=Math.min(d,l+c*($+1)/u+.4);p.push(v`<path d=${Vo(i,a,C,k)} fill="none"
      stroke=${Jd(e.colorHexes,($+.5)/u)} stroke-width=${qm*n}
    ...
    <circle cx=${b.x} cy=${b.y} r=${3.2*n} fill=${Jd(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?x(`${t}-gmin`,l-y-Math.max(o,3),l-y,e.minLabel):f}
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function Ha(e,n){let t=e.family in Ee?e.family:"rectangular",i=n.slot??Ee[t],a=Ee[t],r=Ra(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Oe(e.backgroundColorHex),l=Oe(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements;if(t==="corner"){let y=r.scale,x=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",C=$!=="",k=Ia(y,x),S=Go(y,x),O=S/(a.width*y),I=k.tile.cx-S/2,G=k.tile.cy-S/2,Q=`M 0 0 H ${k.quad.width-k.cornerRadius} A ${k.cornerRadius} ${k.cornerRadius} 0 0 1 ${k.quad.width} ${k.cornerRadius} V ${k.quad.height} H 0 Z`,T=f;if(e.bezelGauge)T=Ym(e.bezelGauge,y,o);else if(e.bezelText){let Y=Km(y,`${o}-bezel`),P=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?jn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;T=v`<defs><path id=${Y.id} d=${Y.d} /></defs>
        <text font-size=${Gd*y} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${Y.id}" startOffset="50%" text-anchor="middle">${Wd(P,Y.length,Gd*y)}</textPath></text>`}let U=f;if(C){let Y=Oe(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},P=rc(y,`${o}-curved`,Wm*y,jm);U=v`<defs><path id=${P.id} d=${P.d} /></defs>
        <text font-size=${jd*y} font-weight="600" fill=${Y.color} fill-opacity=${Y.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${P.id}" startOffset="50%" text-anchor="middle">${Wd($,P.length,jd*y*.88)}</textPath></text>`}else{let Y=e.borderWidth*r.scale*O,P=l?v`<circle cx=${S/2} cy=${S/2} r=${S/2-Y/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${Y} />`:f;U=v`<g transform="translate(${I} ${G})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${pf(e)}</svg>`}var st="color-mix(in srgb, var(--k) 45%, #6b7280)",Pi='system-ui, -apple-system, "Segoe UI", sans-serif';function Hc(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function es(e,n,t,i){return v`<g fill="none" stroke-linecap="round">
    <path d=${Hc(e,n,t,1)} stroke=${st} stroke-width="2.6" opacity=".5" />
    <path d=${Hc(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function hf(e){switch(e){case"text":return v`<g font-family=${Pi} text-anchor="middle">
        ...
        <text x="6" y="39" font-family=${Pi} font-size="7" fill=${st}>1h ago</text>
        <text x="114" y="39" font-family=${Pi} font-size="7" text-anchor="end" fill=${st}>now</text>
    ...
    </div>`}function Sf(e,n){let t=i=>Vt(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${Le(e.label,t(e))}
    <div class="pair-row">
      ${tr(e.label,e.value,e.options,e.set,e)}
      ${Le(n.label,t(n))}
      ${tr(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function Gi(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Le(e,Vt(n,i.def,t,a),cr(n,t,i))}
    ...
    </span>`}function Tf(e,n,t,i){let a={atDefault:n===void 0,title:`Back to ${t.toLowerCase()}`,reset:()=>i(void 0)};return h`<div class="field color">${Le(e,a)}
    <div class="color-row">${nr(e,n,i,!1,t)}</div></div>`}function Cs(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function pr(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Ef(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Yc(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var gu=50;function Mf(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Rf(e,n,t=gu,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Ff=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function yu(e){return Ff.test(e.trim())}function Af(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return pr(t,i);if(yu(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var $n=new Map;function Ce(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Ss(e){return $n.has(e)}function lt(e,n,t,i,a,r={}){let o=e.hass.states,s=$n.get(a),l=s?Rf(Ef(o,r.domain,Yc(e.hass)),s.query,gu,r.preferNumeric?Mf:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(k,S,O=0)=>{$n.set(a,{query:S,index:O}),Ce(k)},p=k=>{$n.delete(a),Ce(k)},m=k=>{let S=Af(k,t,o);S&&i(S)},b=(k,S)=>{i(pr(o,k.entityId)),p(S)},y=()=>Math.max(0,Math.min($n.get(a)?.index??0,l.length-1)),x=k=>{let S=k.target;if(k.key==="ArrowDown"||k.key==="ArrowUp"){k.preventDefault();let O=$n.get(a);if(!O){u(S,S.value);return}let I=k.key==="ArrowDown"?y()+1:y()-1;u(S,O.query,Math.max(0,Math.min(l.length-1,I))),If(S);return}if(k.key==="Enter"){k.preventDefault();let O=l[y()];s&&O?b(O,S):(m(S.value),p(S));return}if(k.key==="Escape"){if(!s)return;k.preventDefault(),k.stopPropagation(),p(S)}},$=t.entityId?Yc(e.hass)?.(t.entityId):void 0,C=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${k=>{let S=k.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),$n.set(a,{query:"",index:0}),Ce(S),S?.focus()}}>${B("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${yu(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${jc(k.domain)}</span>
                  <span class="ent-state">${k.state}</span>
                </span>
              </button>`)}
        </div>`:C}
  </div>`}function If(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Xc=120;function Hf(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Da.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Va),fromPack:!1}}function Jc(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Lf(e){return[{value:"",label:`Starter set (${Jc(Va,e)})`},...Da.map(n=>({value:n.name,label:`${n.name} (${Jc(n.symbols,e)})`}))]}function _f(e){return e.length>0?e.length:Va.length}function Zc(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Wa(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function bu(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(De),m=a!==void 0,b=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=Pf(u,c),x=k=>{t(k),a?.(k.startsWith(De)?e.icons.mdiPath?.(k):void 0),r.noteUsed(k)},$=k=>{if(t(k),!m)return;let S=k.trim();a?.(S.startsWith(De)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&b==="mdi"){let k=e.icons.mdiNames?.(),S=zf(k??[],s),O=S.slice(0,Xc),I=r.recent.filter(G=>G.startsWith(De));C=h`<div class="sym-browse">
      ${Qc(r,i,b)}
      ...
      ${k===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${Zc(O.length,S.length,!0,k.length)}</div>`}
    ...
    </div>`}else if(o){let k=r.category(i),S=Hf(k,s,d,c),O=qo(S.names,s),I=S.fromPack?O.slice(0,Xc):O,G=r.recent.filter(T=>!T.startsWith(De)),Q=c.size===0?G:G.filter(T=>c.has(T));C=h`<div class="sym-browse">
      ${m?Qc(r,i,b):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${ye(T=>r.setQuery(i,T))} />
        <select @change=${ye(T=>r.setCategory(i,T))}>
          ${Lf(c).map(T=>h`<option value=${T.value} ?selected=${T.value===k}>${T.label}</option>`)}
        </select>
      </div>
      ...
      ${O.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${Zc(I.length,O.length,s.trim()!=="",_f(d))}
          </div>`}
    ...
    ${C}`}function Pf(e,n){let t=e.trim();return t!==""&&!t.startsWith(De)&&n.size>0&&!n.has(t)}function zf(e,n){let t=n.trim(),i=t.startsWith(De)?t.slice(De.length):t,a=e.map(r=>r.startsWith(De)?r.slice(De.length):r);return qo(a,i).map(r=>De+r)}function Qc(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Nf=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Of={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Df=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],Vf=[["flat","Flat"],["fade","Fade"]],Bf=[["none","Off"],["all","All"],["auto","Auto"]],Uf=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],Gf=[["bars","Bars"],["line","Line"],["area","Area"]],Kf=[["auto","Auto"],["fixed","Fixed range"]],Wf=[["lowest","Lowest value"],["zero","Zero"]],Ts=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],eu=[["none","None"],["dot","Dot"],["triangle","Triangle"]],ys=[["uniform","One colour"],["bands","By value"]];function ir(e){let n=[Gr,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:X(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:X(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function jf(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function qf(e,n){let t=Lt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:X(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Yf(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function Xf(e,n,t){let{lo:i,hi:a}=Yf(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
  ...
  </div>`}function ar(e,n,t,i){let a=Lt({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(b=>b.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:Cs(l,oe),title:`Back to ${oe}`,reset:()=>t(c=>{c.bandAboveColorHex=oe})};return h`<div class="bands">
    ${Xf(a,l,r)}
    ${a.map(c=>h`
    ...
    ${ue("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??_t},"tother"),!1,_t)}`}var Qf=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],eg={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function tu(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return H(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var tg=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function ng(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function de(e,n,t,i){if(i.inline||!ig())return h`<div class="value-editor">${ku(e,n,t,i)}</div>`;let a=hr(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=we(n,pe(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${xu(e,a,r,n,t,i)}
  </div>`}function xu(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${wu}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${Ki.has(n)?ku(e,i,a,r):f}
  </div>`}function pe(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function hr(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function ig(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Ki=new Set,Di=new WeakMap;function ag(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function vu(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function wu(e){let n=e.currentTarget,t=e.newState==="open",i=Di.get(n);if(i&&(i(),Di.delete(n)),!t){Ki.delete(n.id)&&Ce(n);return}let a=ag(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){Di.get(n)?.(),Di.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}cs(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Di.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),cs(n,a.getBoundingClientRect()),Ki.has(n.id)||(Ki.add(n.id),Ce(n),requestAnimationFrame(()=>{n.isConnected&&cs(n,a.getBoundingClientRect())}))}function cs(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=rg({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var kn=8,ja=6,nu=140;function rg(e,n,t){let i=t.height-e.bottom-ja-kn,a=e.top-ja-kn,r=n.height>i&&a>i&&i<nu,o=Math.max(nu,r?a:i),s=Math.min(n.height,o),l=Math.max(kn,Math.min(e.left,t.width-n.width-kn)),d=r?Math.max(kn,e.top-ja-s):Math.max(kn,Math.min(e.bottom+ja,t.height-s-kn));return{left:l,top:d,maxHeight:o,above:r}}function ku(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Nf.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?bu(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):be("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=lt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${lt(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${be("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=hg(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Se("Field",a.timeField,tg,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${mu("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Ci(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>ug(e,n,t)}>Start an empty one</button>,
          ...
          ${Se("Number",a.stat,[...Ln],p=>r({...a,stat:p}))}
          <div class="hint">${a.stat==="top"||a.stat==="bottom"?"One end of the plot's range: what the tallest or shortest mark means. On a Fixed scale that is the Min or Max the chart was given.":"Read from the readings the chart draws, after any trim. Decimals follow the chart's spread; set Decimals below to override, and Add unit to print the entity's unit after it."}</div>`;break}}let d=Of[a.kind];return h`
    ${Se("Source",a.kind,s,c=>r(ng(a,c)))}
    ${d?h`<div class="hint">${d}</div>`:f}
    ${l}
    ${dg(n,i)?h`<div class="hint keep">
      <button type="button" class="link" title="Move this into a shared value that other layers can read too" @click=${()=>cg(e,n,t)}>Make shared</button>
      so other layers can read this too.</div>`:f}
    ${i.noFormat?f:pg(n.format,c=>t(Te(c)?{kind:n.kind}:{...n,format:c}),sg(og(e,n)))}
    ${i.showResolved?lg(e,n,e.resolve(i.resolveAs??n)):f}`}function og(e,n){let t=n.kind;for(let i=0;t.kind==="named"&&i<8;i++){let a=t.id.toUpperCase(),r=e.config.values.find(o=>o.id.toUpperCase()===a);if(!r)return;t=r.value.kind}return t.kind==="named"?void 0:t}function sg(e){if(!e)return{numbers:!0,textCase:!0,unit:!0,seconds:!0};switch(e.kind){case"literal":{let n=Be(e.value)!==void 0;return{numbers:n,textCase:!n,unit:!1,seconds:n}}case"entityState":case"entityAttribute":case"jinja":case"named":return{numbers:!0,textCase:!0,unit:e.kind!=="jinja"&&e.kind!=="named",seconds:!0};case"entityAge":case"dataAge":return{numbers:!0,textCase:!1,unit:!1,seconds:!0};case"aggregate":return{numbers:!0,textCase:!1,unit:!1,seconds:!1};case"chartStat":{let n=e.stat==="trend";return{numbers:!n,textCase:!1,unit:!n,seconds:!1}}case"time":return{numbers:e.timeField!=="now",textCase:!1,unit:!1,seconds:!1}}}function lg(e,n,t){let i=t===void 0?h`<span class="readout-v now-v none">${$u(e,n)}</span>`:t.trim()===""?h`<span class="readout-v now-v none">Empty</span>`:h`<span class="readout-v now-v"><span class="now-tok">${t}</span></span>`;return h`<div class="field readout now-field"><span>Now</span>${i}</div>`}function $u(e,n){let t=n.kind;switch(t.kind){case"entityState":case"entityAttribute":case"entityAge":return t.entityId===""?"Pick an entity":e.hass.states[t.entityId]?t.kind==="entityAttribute"&&t.attribute.trim()===""?"Pick an attribute":t.kind==="entityState"?"No reading":"Waiting for Home Assistant":"No such entity";case"chartStat":return t.layer===""?"Pick a chart":"The chart has no readings yet";case"named":{if(t.id==="")return"Pick a shared value";let i=t.id.toUpperCase(),a=e.config.values.find(r=>r.id.toUpperCase()===i);return a?$u(e,a.value):"That shared value is gone"}case"jinja":return t.value.trim()===""?"Type a template":"Waiting for Home Assistant";default:return"Waiting for Home Assistant"}}function dg(e,n){if(n.allowNamed===!1||n.noShare)return!1;let t=e.kind;return t.kind==="named"?!1:t.kind==="literal"||t.kind==="jinja"?t.value.trim()!=="":"entityId"in t?t.entityId!=="":t.kind==="chartStat"?t.layer!=="":!0}function cg(e,n,t){let i=ji(n,pe(e)).replace(/^"(.*)"$/,"$1"),{named:a,ref:r}=yo(e.config,n,Ge(i,24));e.beginGesture(),e.update(o=>{o.values.push(a)}),t(r),e.endGesture()}function ug(e,n,t){let{named:i,ref:a}=yo(e.config,{...n,kind:{kind:"literal",value:""}},"");i.name="",e.beginGesture(),e.update(r=>{r.values.push(i)}),t(a),e.endGesture(),e.selectValue(i.id)}function pg(e,n,t){let i=e??{},a=s=>{let l={...i,...s};for(let d of Object.keys(l))(l[d]===void 0||l[d]===!1||l[d]==="")&&delete l[d];n(l)},r=Te(e),o={decimals:t.numbers||i.decimals!==void 0,multiply:t.numbers||i.multiply!==void 0,offset:t.numbers||i.offset!==void 0,textCase:t.textCase||i.textCase!==void 0,unit:t.unit||!!i.useEntityUnit,seconds:t.seconds||!!i.relativeTime||!!i.duration};return h`<details class="sub format" ?open=${!r}>
    <summary>Format${r?h`<span class="sum-note">as it comes</span>`:h`<span class="sum-note">${Du(e).replace(/^ \((.*)\)$/,"$1")}</span>`}</summary>
    <div class="grid2">
  ...
  </details>`}function hg(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${o.kind==="filter"?h`<div class="grid2">
          ...
          ${be("Floor ids",a(o.floorIds),s=>t({...n,scope:{...o,floorIds:r(s)}}))}
            ...
            ${lt(e,`Entity ${l+1}`,s,d=>{let c=[...o.entities];c[l]=d,t({...n,scope:{...o,entities:c}})},`${i}-agg-${l}`,{compact:!0})}
    ...
    ${n.function==="count"?f:be("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Cu=ao,mg=Cu.filter(([e])=>e!=="none");function fg(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Su(e,n){let t=fg(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return Jl(e)?{type:e,...t}:{type:e}}var gg=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Tu(e,n,t,i){let a=n.serviceDataJSON??"",r=Zl(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??bg).slice(0,7)}
    ...
    ${"entityId"in t?lt(e,"Target",t,s=>e.update(l=>{l.tapAction={type:t.type,...s}},"tap-entity"),"general-tap"):f}
    ${t.type==="callService"?Tu(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?xg(e):f}`}var bg="#808080",iu=[0,15,30,60,120];function au(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function xg(e){let n=e.config;return Mu(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Mu(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Se("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Ru(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Ci(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
    ...
    <div class="field readout"><span>Used by</span><span class="readout-v">${a===0?"No layers yet":`${a} ${a===1?"layer":"layers"}`}</span></div>`}function Fu(){return{id:X(),name:"",value:H("")}}function _e(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function Me(e,n,t,i,a=!1){let r=e.elements.find(c=>c.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=_e(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function qa(e,n,t,i,a){let r=n.payload.id,o=ba(n)??a.min,s=_e(e.config,t,n).size??o;return re(i,s,l=>e.update(d=>Me(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,unit:"pt",...a.def===void 0?{}:{def:a.def}})}function Au(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=vt()),a=at(e,n).filter(l=>!fe(e,l));if(a.length===0)return;let r=Kn(e,a.map(l=>l.payload.id),n),o=an(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let c=s?.placements[l],u=c?.size??ba(d),p={frame:{...c?.frame??d.payload.frame},isHidden:c?.isHidden??!1,...u!==void 0?{size:u}:{}};for(let m of ae)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=uo(p,n,t,d.kind)}Wn(e,t)}function mr(e,n){return wd(e,n)}function vg(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function wg(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"||e.kind==="chartTimes"?void 0:e.payload.colorSlot.baseColorHex}function Iu(e,n,t){let i=vg(t.map(l=>_e(e,n,l).isHidden)),a=t.map(wg),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var Zn=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]],kg=[["leading","Left"],["center","Center"],["trailing","Right"]],$g=[["1","1"],["2","2"]];function Hu(e,n,t){let i=n.payload.id,a=wa(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s={...o?{domain:"camera"}:{},needed:ru(n)},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return h`
    ${lt(e,o?"Camera":"Entity",r,d=>e.update(c=>kd(c,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint ${ru(n)?"warn":""}">${Sg(n,a)}</div>`}function ru(e){return e.kind==="timeline"?e.payload.value.kind.kind!=="entityState":e.kind==="chart"?e.payload.historyMinutes>0&&e.payload.value.kind.kind!=="entityState":e.kind==="image"?e.payload.entity.entityId==="":!1}function Cg(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function fr(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Sg(e,n){let t=Cg(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a shared value, so change that shared value to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${fr(o)}.${r}`}function Tg(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function Eg(e,n){let t=e.timestamp===!0,i=gt(e),a=r=>n(o=>{r?(o.timestampX=o.timestampCorner.endsWith("Leading")?.16:.84,o.timestampY=o.timestampCorner.startsWith("top")?.16:.84):(gt(o)&&(o.timestampCorner=no(o.timestampX,o.timestampY)),delete o.timestampX,delete o.timestampY)});return h`
    ...
    ${t?h`
      ...
      ${re("Text size",e.timestampSize,r=>n(o=>{o.timestampSize=Math.min(40,Math.max(4,r??Vn))},"tssize"),{step:1,min:4,max:40,def:Vn,unit:"pt"})}
  ...
  </section>`}function Mg(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Rg(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Fg(e,n){let t=ce[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Ag(e,n,t){let i=Fg(e,n),a=ce[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Ig(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Hg(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Rg(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Qn(e,n=ln){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}var er=new Set;function bs(e,n,t=ln){return er.has(e)||!t.some(i=>i.minutes===n)}function ps(e,n,t,i,a=ln){let r=bs(e,n,a);return h`<label class="field">${Le("Span",{atDefault:n===t&&!r,title:`Back to ${Qn(t,a)}`,reset:()=>{er.delete(e),i(t)}})}
      ...
      </select></label>`}function hs(e,n,t=!1){let i=t?Wr:ha,a=Math.floor(i/1440),r=t?bi:ln,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function _g(e,n,t){let i=n.payload.id,a=`el-${i}`,r=_e(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Me(p,t,i,{frame:ns(o,c)}),`${a}-${u}-${t}`),l=!rr(o,gi)||r.isHidden,d=n.payload.chartAnchor;return ke(e,"placement","Position",h`
    ${Pg(e,n,t)}
    ${d===void 0?h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
          ...
          can still lift it past the top of the chart, as far as the edge of the face.</div>`}`}function zg(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ve(e.config,t)[0];return ke(e,"tappable","Tap",cy(e,n,`el-${t}`),{color:ee.tap,icon:"tap",summary:i?yt(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>va(a,t))}:{}})}function xs(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${re("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(On,Math.max(Nn,r??qe))},`${i}size`),{step:.5,min:Nn,max:On,def:t.labelSize,unit:"pt"})}
      ...
      ${Z("Clock",e.hourCycle,Wl,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${Z("Minutes",e.minutes,jl,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var Ng=[["number","Number"],["entity","Entity"]];function Og(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Dg(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Vg(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=Og(n,o),c=s?n.minValue:n.maxValue,u=y=>a(x=>{s?x.minValue=y??0:x.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Le(l,d==="number"?Vt(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Ng.map(([y,x])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a($=>Dg($,o,y))}}>${x}</button>`)}
      </span>
    ...
    ${r==="none"?f:h`
      ...
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var Ui=new Map,Bi=new Map,kt=new Map,Xa=new Map,ms=4,fs=40,Ug=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Gg=[["plain","Plain"],["rich","Rich"]],Kg={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function Ms(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${He("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function Wg(e){return e.countdown===!0?"countdown":ft(e)?"rich":"plain"}function jg(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function qg(e,n){let t=sn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ge(e.kind.value,40)||"template"}:{kind:"value",label:ji(e,n)}}function Lu(e,n,t){let i=sn(e.value),a=i===void 0?Ge(ji(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ge(i,24)}"`;return`Part ${n+1}: ${a}`}function Yg(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Lu(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function vs(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Xg(e,n){if(vs(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Lt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??oe],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function ou(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${fr(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Jg={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Zg(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${fr(e.moved.map(n=>Jg[n]))} moved into Look.`}function Qg(e,n,t,i,a){let r=n.payload,o=r.id,s=Wg(r),l=(r.parts?.length??0)>0,d=ro(e.config,r.value),c=kt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?Bi.get(o):void 0,m=(x,$)=>{let C=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),k=Ka(structuredClone(r),e.config.values);if(Bi.delete(o),!k.ok){kt.set(o,{text:ou(k.blocked),rich:!0,warn:!0}),Ce($);return}kt.set(o,{text:Zg(k.joined?{joined:!0,template:C}:k),rich:!1}),i(S=>{Ka(S,e.config.values),x==="countdown"&&(S.countdown=!0)})},b=(x,$)=>{if(Bi.delete(o),s==="rich"){let C=x==="countdown"?"countdown":"plain",k=r.parts??[];if(k.length<2){m(C,$);return}let S=ss(k,e.config.values);S.ok?(kt.delete(o),Bi.set(o,C)):kt.set(o,{text:ou(S.blocked),rich:!0,warn:!0}),Ce($);return}if(x==="rich"){let C=r.parts?.[0]?.id??X();Ui.set(o,C),kt.delete(o),i(k=>{delete k.countdown,Wc(k,C)});return}kt.delete(o),i(C=>{if(x==="countdown"){C.countdown=!0;return}(C.parts?.length??0)>0&&Ka(C,e.config.values),delete C.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${Z("Type",s==="rich"?"rich":"plain",Gg,b,{titles:Kg})}
    ...
    ${s==="rich"?ey(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Re(d,pe(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function ey(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=pe(e),d=Math.max(0,o.findIndex(F=>F.id===Ui.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=_e(e.config,t,n).size??r.fontSize,b=(F,V)=>{kt.delete(s),i(g=>{F(g),Ol(g)},V)},y=(F,V)=>b(g=>{let w=g.parts?.find(M=>M.id===c.id);w&&F(w)},V?`part-${c.id}-${V}`:void 0),x=(F,V)=>{Ui.set(s,F),kt.delete(s),Ce(V)},$=(F,V)=>{let g=X();Ui.set(s,g),b(w=>{(w.parts??=[]).push({id:g,value:F})}),vu(V,hr(`${a}-part-${g}`),!0)},C=F=>b(V=>{V.parts&&Wi(V.parts,d,F)}),k=()=>{let F=o[d+1]??o[d-1];F&&Ui.set(s,F.id),b(V=>{V.parts=(V.parts??[]).filter(g=>g.id!==c.id)})},S=o.map((F,V)=>{let g=qg(F.value,l),w=F.id===c.id,M=vs(F),A=g.kind==="value"?e.resolve(F.value):void 0,z=F.fontWeight===void 0?void 0:Zn.find(([K])=>K===F.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${w?"true":"false"} class="part-chip ${g.kind} ${w?"on":""}"
      aria-label=${Lu(F,V,l)} @click=${K=>x(F.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${Xg(F,p)}`}
    ...
    </button>`}),O=r.rules.some(F=>F.partId===c.id),I=c.value.kind.kind==="literal",G=vs(c),Q=c.fontSize!==void 0,T=Zn.find(([F])=>F===r.fontWeight)?.[1]??r.fontWeight,U=F=>{F>=ms&&F<=fs&&y(V=>{V.fontSize=F},"size")},Y=G==="bands"?Qe(e.resolve(c.value)??""):[],P={layer:"Use the layer colour",...I&&G!=="bands"?{bands:"By value needs a live value"}:{}},te=(F,V)=>y(g=>{let w={bands:g.bands??[],bandAboveColorHex:g.bandAboveColorHex??oe};F(w),w.bands.length>0?g.bands=w.bands:delete g.bands,w.bandAboveColorHex!==oe?g.bandAboveColorHex=w.bandAboveColorHex:delete g.bandAboveColorHex},V);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      ...
      ${Z("Colour",G,Ug,F=>y(V=>{if(F==="layer"){delete V.colorHex,delete V.coloring;return}if(F==="pick"){delete V.coloring,V.colorHex=Cs(p,"#FFFFFF")?"#64D2FF":p;return}delete V.colorHex,V.coloring="bands",(V.bands?.length??0)===0&&(V.bands=ir(Qe(e.resolve(V.value)??"")))}),{def:"layer",titles:P,...I&&G!=="bands"?{disabled:{bands:!0}}:{}})}
      ...
      <div class="field seg-field">${Le("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>y(F=>{delete F.fontWeight})})}
        ${tr("Weight",c.fontWeight,Zn,F=>y(V=>{V.fontWeight=F}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Le("Font size",Q?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(F=>{delete F.fontSize})}:void 0,cr(c.fontSize??m,U,{step:1,min:ms,max:fs}))}
  ...
  </div>`}function _u(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(g=>g.payload.id===a),o=`el-${a}`,s=(g,w)=>e.update(M=>g(M.elements[r]),w?`${o}-${w}`:void 0),l=_e(e.config,t,n),d=l.frame,c=(g,w)=>e.update(M=>Me(M,t,a,{frame:ns(d,g)}),`${o}-${w}-${t}`),u=Ne(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=g=>u[g],b=!1,y=g=>n.kind==="image"||n.kind==="tap"||n.kind==="timeline"||n.kind==="chartTimes"?f:ue(g,n.payload.colorSlot.baseColorHex,w=>s(M=>{M.kind!=="image"&&M.kind!=="tap"&&M.kind!=="timeline"&&M.kind!=="chartTimes"&&(M.payload.colorSlot.baseColorHex=w??"#FFFFFF")},"color"),!1,p),x,$,C;switch(n.kind){case"text":{let g=(w,M)=>s(A=>w(A.payload),M);$=Qg(e,n,t,g,o),b=!n.payload.countdown&&!ft(n.payload),C=h`
        ${qa(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${Z("Weight",n.payload.fontWeight,Zn,w=>s(M=>{M.payload.fontWeight=w}),{def:u.fontWeight})}
        ${Sf({label:"Align",value:n.payload.alignment??"center",options:kg,def:"center",set:w=>s(M=>{let A=M.payload;w==="center"?delete A.alignment:A.alignment=w})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:$g,def:"1",set:w=>s(M=>{let A=M.payload;w==="2"?A.lineLimit=2:delete A.lineLimit})})}
        ...
        ${b?Bg(e,n.payload,g,y("Main colour")):f}`;break}case"icon":$=h`
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,C=qa(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let g=n.payload,w=(A,z)=>s(K=>A(K.payload),z),M=g.style==="dots";$=h`
        ${de(e,g.value,A=>w(z=>{z.value=A},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${M?h`
            ${de(e,g.total??tu(g),A=>w(z=>{z.total=A},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${ca} dots are drawn.</div>`:Vg(e,g,{min:u.minValue,max:u.maxValue},o,w)}`,b=!0,C=h`
        <div class="grid2">
          ${Z("Style",g.style,Qf,A=>w(z=>{A==="dots"&&z.total===void 0&&(z.total=tu(z)),A!=="dots"&&delete z.total,z.style=A}),{titles:eg,def:u.style})}
          ${M?f:qa(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${ue(M?"Empty dot colour":"Track colour",g.trackColorHex,A=>w(z=>{z.trackColorHex=A??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${Z("Colour",g.coloring,ys,A=>w(z=>{z.coloring=A,A==="bands"&&z.bands.length===0&&(z.bands=ir([z.minValue,z.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${g.coloring==="bands"?h`
        ...
        ${M?f:h`
          <div class="grid2">
            ${re("Threshold",g.thresholdValue,A=>w(z=>{A===void 0?delete z.thresholdValue:z.thresholdValue=A},"thr"),{optional:!0})}
            ${g.thresholdValue===void 0?f:ue("Threshold colour",g.thresholdColorHex,A=>w(z=>{z.thresholdColorHex=A??_n},"thrcol"),!1,_n)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let g=n.payload,w=(E,R)=>s(Fe=>E(Fe.payload),R),M=nt(g),A=Ur(u.marker),z=u.historyMinutes,K=u.historyPoints,J=g.historyMinutes>0,xe=J&&g.source==="statistics",Wt=J&&!xe,jt=J?xe?"statistics":"history":"value",ti=xe?bi:ln,$e=cn(g)??un(g),he=g.value.kind.kind==="entityState",dt=$e===void 0?void 0:e.historySeries($e),Bs=J&&he?dt??"":e.resolve(g.value)??"",ct=g.historyPoints<1,Us=bs(a,g.historyMinutes,ti),br=J&&he?Ao(Bs):{values:Qe(Bs),holes:[]},En=br.values,Gs=E=>g.limit>0&&E.length>g.limit?g.takeFromEnd?E.slice(E.length-g.limit):E.slice(0,g.limit):E,wp=Gs(En),qt=Ho(wp,Xe(g.smoothing),br.holes.length>0?Gs(br.holes):[]),kp=!J&&he&&En.length===1,xr=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),$p=pe(e),vr=g.scaleFrom!==void 0&&xr.some(E=>E.payload.id===g.scaleFrom);$=h`
        ${de(e,g.value,E=>w(R=>{R.value=E},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${Z("Draw",jt,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>w(R=>{if(E==="value"){R.historyMinutes=0;return}R.source=E==="statistics"?"statistics":"history";let Fe=R.historyMinutes||pa;R.historyMinutes=E==="statistics"?Math.min(Fe,Wr):Math.min(Fe,ha)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${xe?h`
            ...
            <div class="grid2">
              ${ps(a,g.historyMinutes,z,E=>w(R=>{R.historyMinutes=E}),bi)}
              ${Z("Per",g.statPeriod,la,E=>w(R=>{R.statPeriod=E}),{def:mi})}
            </div>
            ${Us?hs(g.historyMinutes,E=>w(R=>{R.historyMinutes=E},"span"),!0):f}
            ${Z("Read",g.statType,Dr,E=>w(R=>{R.statType=E}),{def:fi})}
            <div class="hint">One bar per period, oldest first, newest ${xi} kept.
            ...
            ${he&&dt===void 0?h`<div class="hint keep">Reading the statistics…</div>`:f}
            ${he&&dt===""?h`<div class="hint warn">No long-term statistics for this entity in that span.
        ...
        ${Wt?h`
            ${he?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${ps(a,g.historyMinutes,z,E=>w(R=>{R.historyMinutes=E}))}
              <div class="field readings-field">${Le("Points",{atDefault:g.historyPoints===K,title:`Back to ${K<1?"every one":`${K} averaged`}`,reset:()=>w(E=>{E.historyPoints=K})})}
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Points">
                    <button type="button" role="radio" aria-checked=${ct?"false":"true"} class=${ct?"":"on"}
                      title="Average the recorded states into this many equal time slots"
                      @click=${()=>{ct&&w(E=>{E.historyPoints=24})}}>Average</button>
                    <button type="button" role="radio" aria-checked=${ct?"true":"false"} class=${ct?"on":""}
                      title="Plot every recorded state change, no averaging"
                      @click=${()=>{ct||w(E=>{E.historyPoints=qr})}}>Every one</button>
                  </div>
                  ${ct?f:h`<span class="readings-into">into</span>
            ...
            ${Us?hs(g.historyMinutes,E=>w(R=>{R.historyMinutes=E},"span")):f}
            <div class="hint">${ct?h`Every state the recorder holds in that span, oldest first, one reading per change,
                  and a chatty sensor keeps its newest ${xi}. The time axis follows
            ...
            ${he&&dt===void 0?h`<div class="hint keep">Reading the history…</div>`:f}
            ${he&&dt===""?h`<div class="hint warn">Nothing recorded for this entity in that span.
        ...
        ${En.length===0&&!(J&&(!he||dt===void 0||dt===""))?h`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${En.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${Mg(qt)}</span>${En.length===qt.length?h` · ${qt.length} ${qt.length===1?"value":"values"}`:h` · ${qt.length} of ${En.length}`}</span></div>`:f}
        ${kp?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        ${Se("Smooth data",Xe(g.smoothing)??"off",Uf,E=>w(R=>{let Fe=Xe(E);Fe===void 0?delete R.smoothing:R.smoothing=Fe}),{def:Xe(u.smoothing)??"off"})}
        ${Dt(e)}
        ...
        <div class="grid2">
          ${Z("Style",g.style,Gf,E=>w(R=>{R.style=E}),{def:u.style})}
        ...
        ${g.style==="bars"?h`
          <div class="grid2">
            ${re("Corner radius",At(g.barRadius),E=>w(R=>{let Fe=Math.max(0,E??Hn);Fe===Hn?delete R.barRadius:R.barRadius=Fe},"barradius"),{step:.5,min:0,def:At(u.barRadius),unit:"pt"})}
          </div>
          ${He("Round top only",It(g.barCorners)==="top",E=>w(R=>{E?R.barCorners="top":delete R.barCorners}),It(u.barCorners)==="top")}
          ${Dt(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${Z("Curve",g.curve??"straight",Df,E=>w(R=>{E==="straight"?delete R.curve:R.curve=E}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Dt(e)}
          ${g.style==="area"?h`
            ${Z("Fill",Rt(g.fillStyle),Vf,E=>w(R=>{E==="flat"?delete R.fillStyle:R.fillStyle=E}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:Rt(u.fillStyle)})}
            ${Tf("Fill colour",g.fillColorHex,"Line colour",E=>w(R=>{E===void 0?delete R.fillColorHex:R.fillColorHex=E},"fillcol"))}
            ${Dt(e)}`:f}
          ${Z("Dots",Ft(g.pointDots),Bf,E=>w(R=>{E==="none"?delete R.pointDots:R.pointDots=E}),{titles:{none:"No dots on the readings",all:"A dot on every reading",auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart"},def:Ft(u.pointDots)})}
          ${Dt(e)}`}
        <div class="grid2">
          ${Z("Scale",g.scale,Kf,E=>w(R=>{R.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${Z("Baseline",g.baseline,Wf,E=>w(R=>{R.baseline=E}),{def:u.baseline})}
        </div>
        ${xr.length===0?f:Se("Same scale as",vr?g.scaleFrom:"",[["","Its own"],...xr.map(E=>[E.payload.id,Re(E,$p)])],E=>w(R=>{E?R.scaleFrom=E:delete R.scaleFrom}),{def:""})}
        ...
        <div class="grid2">
          ${re("Grid",tt(g.gridLines),E=>w(R=>{let Fe=tt(E??0);Fe===0?delete R.gridLines:R.gridLines=Fe},"grid"),{step:1,min:0,max:Or,def:tt(u.gridLines)})}
          ${tt(g.gridLines)===0&&g.zeroLine!==!0?f:ue("Grid colour",nn(g.gridColorHex),E=>w(R=>{E===void 0||sa(E,Ht)?delete R.gridColorHex:R.gridColorHex=E},"gridcol"),!1,Ht)}
        </div>
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(R=>{E=xd(R,a)}),E&&e.selectLayer(E)}}>${B("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${Z("Colour",g.coloring,ys,E=>w(R=>{R.coloring=E,E==="bands"&&R.bands.length===0&&(R.bands=ir(qt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${g.coloring==="bands"?h`
        ...
        ${oy(e,n,M,A,w)}
        ${He("Threshold",g.thresholdValue!==void 0,E=>w(R=>{E?R.thresholdValue=jf(qt):delete R.thresholdValue}))}
        ${g.thresholdValue===void 0?f:h`
          <div class="grid2">
            ${re("At",g.thresholdValue,E=>w(R=>{R.thresholdValue=E??0},"thval"))}
            ${g.drawsThreshold===!1?f:ue("Line colour",g.thresholdColorHex,E=>w(R=>{R.thresholdColorHex=E??Pn},"thcol"),!1,Pn)}
          </div>
        ...
        ${g.nowIndex===void 0?f:h`
          ...
          ${g.drawsNowLine===!1?f:ue("Marker colour",g.nowColorHex,E=>w(R=>{R.nowColorHex=E??zn},"nowcol"),!1,zn)}
          ...
          ${lu(e,n,"now")}`}
        ${dn(g)?sy(e,n,w,u):ct&&Wt?h`<div class="hint keep">Clock times need evenly spaced readings, so they are offered when
              ...
              Recorded history.</div>`}`;break}case"timeline":{let g=n.payload,w=($e,he)=>s(dt=>$e(dt.payload),he),M=u.historyMinutes,A=g.value.kind.kind==="entityState",z=zt(g),K=z===void 0?void 0:e.historySeries(z),J=it(g)*60,xe=Fi(K??"",Pt),Wt=bs(a,g.historyMinutes),jt=g.value.kind.kind==="entityState"?g.value.kind.entityId:void 0,ti=Jf(xe,J,jt===void 0?void 0:e.hass.states[jt]?.state,jt?.split(".")[0]);$=h`
        ${de(e,g.value,$e=>w(he=>{he.value=$e},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        ${ps(a,g.historyMinutes,M,$e=>w(he=>{he.historyMinutes=$e}))}
        ${Wt?hs(g.historyMinutes,$e=>w(he=>{he.historyMinutes=$e},"span")):f}
        ...
        ${xe.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Hg(xe,J)}</span></span></div>`:f}
        ${Ig(xe)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${Zf(g,w,ti,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ${ti.length>2?h`<div class="hint keep">Seen in this span: <span class="nums">${ti.filter($e=>$e!=="unavailable"&&$e!=="unknown").join(", ")}</span>. Click into a State box to pick one.</div>`:f}
        <div class="grid2">
          ${re("Gap",g.gap,$e=>w(he=>{he.gap=Math.min(fa,Math.max(0,$e??0))},"tgap"),{step:.5,min:0,max:fa,def:u.gap,unit:"pt"})}
          ${re("Corner radius",g.cornerRadius,$e=>w(he=>{he.cornerRadius=Math.max(0,$e??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
        ...
        ${n.payload.kind==="line"?Ag(t,d,c):f}`,C=n.payload.kind==="line"?re("Thickness",n.payload.thickness,g=>s(w=>{w.payload.thickness=g??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${n.payload.borderColorHex!==void 0?re("Border width",n.payload.borderWidth,g=>s(w=>{w.payload.borderWidth=g??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let g=n.payload,w=(K,J)=>s(xe=>K(xe.payload),J),M=g.entity.entityId?e.hass.states[g.entity.entityId]?.attributes?.entity_picture:void 0,A=typeof M=="string"?M:void 0,z=A!==void 0&&!A.startsWith("/");$=h`
        ...
        <div class=${g.contentMode==="fit"&&g.zoom===1?"hint keep":"hint"}>${Tg(g)}</div>
        ${re("Corner radius",g.cornerRadius,K=>w(J=>{J.cornerRadius=Math.max(0,K??Dn)},"imgradius"),{step:1,min:0,def:Dn,unit:"pt"})}`;break}case"tap":{$=h`
        ${Pu(e,n.payload,(g,w)=>s(M=>g(M.payload),w),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let g=n.payload,w=(z,K)=>s(J=>z(J.payload),K),M=e.config.elements.find(z=>z.payload.id===g.chart),A=M?.kind==="chart"?M:void 0;$=h`
        ...
        <div class="hint">Evenly spaced from the start of the chart's span to now. Auto follows the watch's
          own clock and drops the minutes past a three hour span.</div>`);break}}let k=b||n.kind==="image"||n.kind==="tap"||n.kind==="timeline"||n.kind==="chartTimes"?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&ft(n.payload)?"Layer colour":"Colour"),S=ho(e.config,n),O=S?{kind:{kind:"entityState",...S}}:void 0,I=n.kind==="image"?n.payload.timestamp===!0:!1,G=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,Q=ny[n.kind],T=iy[n.kind],U=us(n.payload,u,Q),Y=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,P=e.config.perFamily[t]?.placements[a]?.size!==void 0,te=us(n.payload,u,T)||Y!==void 0&&l.size!==void 0&&l.size!==u[Y],F=pn(e.config,a),V=(g,w)=>()=>s(M=>Ya(M.payload,u,g),w);return h`
    ${ke(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"?f:Hu(e,n,o)}${$}`,{color:ee.content,icon:"content",summary:Es(e,n),...U?{reset:()=>s(g=>{Ya(g.payload,u,Q),g.kind==="text"&&Oi(g.payload.rules)},"reset-content")}:{}})}
    ${C===void 0&&k===void 0?f:ke(e,"look",n.kind==="image"?"Picture":"Look",h`${C??f}${k??f}`,{color:ee.look,icon:n.kind==="image"?"image":"look",...or(n)?{summary:or(n)}:{},...te?{reset:()=>e.update(g=>{Ya(g.elements[r].payload,u,T),P&&Me(g,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?ke(e,"numbers","Extras",dy(e,n,x),{color:ee.numbers,icon:"text",summary:ly(e,n),...F.length>0||hn(e.config,a).length>0||mn(e.config,a).length>0||us(n.payload,u,su)?{reset:()=>e.update(g=>{for(let M of pn(g,a))We(g,M.payload.id);for(let M of hn(g,a))We(g,M.payload.id);for(let M of mn(g,a))We(g,M.payload.id);let w=g.elements.find(M=>M.payload.id===a);w&&Ya(w.payload,u,su)})}:{}}):f}
    ${n.kind==="image"?ke(e,"timestamp","Timestamp",Eg(n.payload,(g,w)=>s(M=>g(M.payload),w)),{color:ee.numbers,icon:"clock",summary:I?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...I?{reset:V(ty,"reset-stamp")}:{}}):f}
    ${ke(e,"states","States",Gu(e,n.payload.rules,n.kind,g=>g.elements.find(w=>w.payload.id===a)?.payload.rules,`rules-${a}`,O,G),{color:ee.states,icon:"states",summary:_i(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(g=>{g.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:_g(e,n,t)}
    ${i.tap===!1?f:zg(e,n)}`}var ty=["timestamp","timestampCorner","timestampSize"],ny={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[]},iy={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","pointDots","gridLines","gridColorHex","zeroLine","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"]},su=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function Pu(e,n,t,i){let a=n.action;return h`
    ${Se("Tap action",a.type,mg,r=>t(o=>{o.action=Su(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?lt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?Tu(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?Mu(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var ay=24;function ry(e,n){let t=[],i=1/0;for(let r of ae){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=yd(e.config,n,r);o&&(t.push(`${ie(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<ay;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function oy(e,n,t,i,a){if(!ld(n))return f;let r=n.payload;return h`
    <div class="grid2">
      ${r.highlight==="lowest"?f:Z("Highest marker",t.high,eu,o=>a(s=>{da(s,{...nt(s),high:o})}),{def:i.high})}
      ${r.highlight==="highest"?f:Z("Lowest marker",t.low,eu,o=>a(s=>{da(s,{...nt(s),low:o})}),{def:i.low})}
    </div>
    <div class="field list-field"><span>Markers</span>
      <div class="chips">
        <button class="small" title="Turn these two marks into layers you can restyle"
          @click=${()=>e.update(o=>{dd(o,r.id)})}>${B("plus")}<span>Move to layers</span></button>
      </div>
    </div>
    <div class="hint">These marks are drawn by the chart itself, which is why they are one of three
      ...
      bar and taking no room from the plot.</div>`}function lu(e,n,t){let i=n.payload,a=t==="now"?i.drawsNowLine!==!1:i.drawsThreshold!==!1,r=t==="now"?"now line":"threshold line";if(a)return h`
      ...
      </div>`;let o=hn(e.config,i.id).some(s=>s.payload.chartAnchor?.at===t);return h`
    ${o?f:h`
      <div class="field list-field"><span>Line</span>
        <div class="chips">
    ...
    <div class="hint">${o?`The ${r} is a layer listed below, so its colour, thickness and style are set there. The number here still decides where it sits.`:`The ${r} was moved to a layer that has since been deleted, so nothing draws it.`}</div>`}function sy(e,n,t,i){let a=n.payload;if(a.drawsTimeLabels===!1){let o=mn(e.config,a.id).length>0;return h`
      ${o?f:h`
      ...
      <div class="field list-field"><span>Times</span>
        <div class="chips">
          <button class="small" ?disabled=${r}
            ...
            @click=${()=>e.update(o=>{ud(o,a.id)})}>${B("plus")}<span>Move to layer</span></button>
        </div>
      </div>
      ${Dt(e,null)}
      <div class="hint">As a layer the row can sit anywhere at any width, and the plot gets its height back.</div>`}`}function ly(e,n){let t=n.payload,i=pn(e.config,t.id),a=hn(e.config,t.id),r=mn(e.config,t.id),o=[];if(t.highlight!=="none"&&o.push(`${Ts.find(([l])=>l===t.highlight)?.[1].toLowerCase()??""} marked`),t.thresholdValue!==void 0&&o.push("threshold"),t.nowIndex!==void 0&&o.push("now"),t.drawsTimeLabels!==!1&&dn(t)&&t.timeLabelCount>0&&o.push(`${t.timeLabelCount} times`),o.length===0&&i.length===0&&a.length===0&&r.length===0)return"None yet";let s=[...o,...i.map(l=>{let d=l.payload.value.kind;return d.kind==="chartStat"?(Ln.find(([c])=>c===d.stat)?.[1]??"number").toLowerCase():"number"})];for(let l of a){let{at:d,place:c}=l.payload.chartAnchor,u=(on.find(([p])=>p===d)?.[1]??"reading").toLowerCase();s.push(c==="through"?`${u} line`:`${u} marker`)}for(let l of r)s.push("times layer");return s.join(" \xB7 ")}function dy(e,n,t){let i=pe(e),a=pn(e.config,n.payload.id),r=mn(e.config,n.payload.id),o=hn(e.config,n.payload.id),s=p=>e.update(m=>{ad(m,n.payload.id,p)}),l=p=>e.update(m=>{oo(m,n.payload.id,p)}),d=new Set(a.map(p=>p.payload.value.kind.kind==="chartStat"?p.payload.value.kind.stat:"")),c=new Set(o.map(p=>p.payload.chartAnchor.at)),u=(p,m,b,y)=>h`
    <div class="num-row">
    ...
    ${a.length===0&&o.length===0&&r.length===0?h`<div class="hint keep">A chart on its own shows that a reading moved, not what it moved to and not
        ...
        <div class="field list-field"><span>Shown</span>
          <div class="chart-numbers">
            ...
            ${o.map(p=>{let{at:m,place:b}=p.payload.chartAnchor,y=(on.find(([$])=>$===m)?.[1]??"reading").toLowerCase();if(b==="through")return u(p.payload.id,m==="threshold"?"\u2500":"\u2502",`line through the ${y}`,"line");let x=p.kind==="text"?e.resolve(p.payload.value)??"\u25CF":p.kind==="icon"?uy(e.resolve(p.payload.symbol)):"\u25C6";return u(p.payload.id,x,`over the ${y}`,"marker")})}
    ...
    <div class="field list-field"><span>Line</span>
      <div class="adders">
        ${cd.map(([p,m])=>{let b=p==="threshold"&&n.payload.thresholdValue===void 0;return h`
    ...
    <div class="hint">A marker starts as an icon over the reading it names: a triangle over the highest, a dot over
      ...
      sits on.</div>`}function cy(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ve(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=mo(e.config,n);return h`
    ${He("Tappable",a!==void 0,s=>e.update(l=>{s?xa(l,i):va(l,i)}))}
    ${a?h`<div class="value-editor">
          ${Pu(e,a.payload,r,`${t}-attached`)}
        ...
        ${ry(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${yt(o)}</b>.</div>`}`}function du(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function uy(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Re(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=on.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return du(we(e.payload.value,n));case"icon":return du(we(e.payload.symbol,n));case"gauge":return we(e.payload.value,n);case"chart":return we(e.payload.value,n);case"timeline":return we(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times"}}function zu(e,n){let t=xt(e.config,n.id),i=pe(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return ke(e,"content","Group",h`
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Nu(e,n){if(n==="inline")return py(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ie(n)} yet.</div>
    ...
    ${ke(e,"content","Inline text",h`
      ...
      ${Ms(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:ee.content,icon:"text",summary:Ge(`${n.label?`${n.label}: `:""}${we(n.value,i)}`,48)})}
    ${ke(e,"symbol","Symbol",h`
      ${bu(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:ee.look,icon:"icon",summary:n.symbol||"None"})}`}function hy(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="gauge"&&n.bezelGauge?my(e,n.bezelGauge,t):f}`}function my(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?de(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var zv=ae.map(e=>[e,ie(e)]),Rs={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},fy=Object.keys(Rs),sr=["color","text","fontSize","fontWeight","visibility"];function gy(e,n=!1){let t=Si[e].filter(i=>!n||sr.includes(i));return fy.filter(i=>t.includes(Ae[i]))}function Ou(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Yg(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var yy={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Ja(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Ge(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Du(e){if(!e||Te(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function we(e,n){return`${ji(e,n)}${Du(e.format)}`}function ji(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Ge(t.value,40)}"`:"(empty)";case"entityState":return Ja(t,n);case"entityAttribute":return t.attribute?`${Ja(t,n)} \xB7 ${t.attribute}`:Ja(t,n);case"entityAge":return`age of ${Ja(t,n)}`;case"aggregate":return by(t.aggregate);case"time":return yy[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Ge(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Ln.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?ji(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function by(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Wi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function xy(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${s===void 0?f:Ou(s,n.partId,pe(e),m=>u(b=>{m?b.partId=m:delete b.partId}))}
    ...
    ${n.cases.map((m,b)=>wy(e,m,b,n,a,u,`${o}-${m.id}`,p))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${Vu(e,n.otherwise,a,m=>u(b=>{b.otherwise&&m(b.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function wy(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(b=>b.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>ky(e,c,u,p=>l(m=>{let b=m.when.tests.find(y=>y.id===c.id);b&&p(b)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push($o())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=Kc(p,Dc(e.hass?.states));l(b=>{b.when.tests.push(...m)})}}>
        <option value="">+ preset…</option>
        ${Uc.map(c=>h`<option value=${c.kind} title=${c.hint}>${c.label}</option>`)}
      </select>
    </div>
    <div class="hint keep" style="margin-top:8px">Then:</div>
    ${Vu(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function ky(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=yn(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=de(e,s.value??H(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${de(e,s.value??H(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${de(e,s.upper??H(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${be("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!$y(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${cu(e,"From",s.value??H("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${cu(e,"To",s.upper??H("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=Cy(n.value)?Sy(s.options??[],u=>o(p=>{p.comparison.options=rs(u)},"options")):be("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Se("Comparison",s.kind,Sd.map(u=>[u,Jn[u]]),u=>o(p=>{p.comparison=So(p.comparison,u)}))}
    ${c}
  </div>`}function $y(e){try{return new RegExp(e),!0}catch{return!1}}function cu(e,n,t,i,a){if(t.kind.kind!=="literal")return de(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=gn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${ye(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function Cy(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function Sy(e,n){let t=Bc(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${Vc.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function Vu(e,n,t,i,a,r=!1){let o=gy(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>Ty(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(bn(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${Rs[s]}</option>`)}
    </select>`}var Bu=["setColor","setBorderColor","setBackgroundColor"];function Ty(e,n,t,i,a,r,o,s=!1){let l=!Si[i].includes(Ae[n.kind]),d=s&&!l&&!sr.includes(Ae[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${Uu(e,n,a,o)}
  </div>`}function Uu(e,n,t,i){let a=Ca(n.kind),r=f;if(a==="value"){let o=n.value??H("");if(Bu.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?ue("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=H(l??"#FFFFFF")},"color")):de(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${xy(e,n,t,i,a,o)}`:Ey(e,s.table,n[0],t,i,a,r,o)}function Ey(e,n,t,i,a,r,o,s){let l=(g,w)=>e.update(M=>{let A=a(M);A&&g(A)},w?`${r}-${w}`:void 0),d=n.value??uu.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Ic(d)&&My(e.resolve(d)),p=Si[i],m=Za.get(r)??new Set,b=n.columns.length===0&&m.size===0?[Ac[i]]:[],y=kc(n.columns,[...m,...b.filter(g=>g!==void 0)],p),x=Xa.get(r),$=t?t.partId:s?.some(g=>g.id===x)?x:void 0,C=s!==void 0&&$!==void 0,k=C?p.filter(g=>sr.includes(g)):p,S=C?y.filter(g=>!sr.includes(g)):[],O=(g,w)=>{if(!t){g?Xa.set(r,g):Xa.delete(r),Ce(w);return}l(M=>{let A=M[0];A&&(g?A.partId=g:delete A.partId)})},I=t?e.liveBranch(t):"none",G=t?e.forced.get(t.id)??"live":"live",Q=g=>G!=="live"&&(G==="otherwise"?g==="otherwise":G.caseId===g),T=g=>{t&&e.setForced(t.id,Q(g)?"live":g==="otherwise"?"otherwise":{caseId:g})},U=g=>{uu.set(r,g),n.rows.length!==0&&l(w=>Mc(w,g),"lhs")},Y=()=>{Xa.delete(r),l(g=>{Tc(g,d??H(""),u),$!==void 0&&g[0]&&g[0].partId===void 0&&(g[0].partId=$)})},P=n.rows.map((g,w)=>hu(e,{key:`${r}-${g.caseId}`,label:Fc(g.comparison,M=>we(M,pe(e))),columns:y,changes:g.changes,live:I===g.caseId,forced:Q(g.caseId),onForce:()=>T(g.caseId),when:Hy(e,g.comparison,`${r}-${g.caseId}`,(M,A)=>l(z=>{let K=z[0]?.cases.find(J=>J.id===g.caseId)?.when.tests[0];K&&M(K.comparison)},A&&`${g.caseId}-${A}`)),updChanges:(M,A)=>l(z=>{let K=z[0]?.cases.find(J=>J.id===g.caseId);K&&M(K.then)},A&&`${g.caseId}-${A}`),acts:h`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>l(M=>Ec(M,g.caseId))}>${B("delete")}</button>`})),te=n.otherwise===void 0?f:hu(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:I==="otherwise",forced:Q("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(g,w)=>l(M=>{let A=M[0]?.otherwise;A&&g(A)},w),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(g=>Qo(g,!1))}>${B("close")}</button>`}),F=Qa.get(r),V=Ry.filter(g=>k.includes(g)&&!y.includes(g));return h`
    <div class="states">
      ${de(e,d??H(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:Ou(s,$,pe(e),O)}
      <div class="states-scroll"><table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(g=>h`<th>
              <span>${ot[g]}</span>
              <button class="icon" title=${`Remove the ${ot[g]} column`}
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${fr(S.map(g=>ot[g]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${F===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${ot[F]} column? Its ${pu(n,F)} value${pu(n,F)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${g=>{Qa.delete(r),Za.get(r)?.delete(F),Ce(g.target),l(w=>Rc(w,F))}}>Remove</button>
      ...
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${V.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${g=>{let w=g.target,M=w.value;if(w.value="",!M)return;let A=Za.get(r)??new Set;A.add(M),Za.set(r,A),Ce(w)}}>
            ...
            ${V.map(g=>h`<option value=${g}>${ot[g]}</option>`)}
          </select>`}
        </div>
      </div>
    ...
    </div>`}function My(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var Ry=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function pu(e,n){let t=0;for(let i of e.rows)Ua(i.changes,n)&&(t+=1);return e.otherwise&&Ua(e.otherwise,n)&&(t+=1),t}function Fy(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function hu(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{Fy(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${Ay(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Ay(e,n,t,i,a){let r=Ua(t,n),o=hr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${ot[n]} for this state`}
      @click=${d=>{i(c=>{c.push(bn(wc[n]))}),vu(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Ae[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=ot[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Iy(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${wu}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${Ki.has(o)?h`${n==="visibility"?Z("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Uu(e,r,s,a)}
    ...
    </div>`}function Iy(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Ca(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${Zn.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??H(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Bu.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ie(a):we(i,pe(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${we(i,pe(e))}</span>`}function Ie(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Hy(e,n,t,i){let a=yn(n.kind),r=Xo(n.kind),o=(s,l,d,c)=>_y(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${ye(s=>i(l=>{let d=So(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Yo.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Ly(s)}</option>`)}
    </select>
  ...
  </span>`}function Ly(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return Jn[e]}}function _y(e,n,t,i,a,r,o){let s=hr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${xu(e,s,o,n,t,l)}
  </span>`}var qi=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:po,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function qu(e){return qi.find(n=>n.kind===e)??qi[0]}var Ku="#FF9F0A",gr="#8E8E93",Py=["#FF453A","#FFD60A","#34C759"],Yu=["#0A84FF","#34C759","#FF9F0A"];function zy(e){return e?.attributes?.device_class==="battery"?Py:Yu}var Ny={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Oy(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Ny[Fs(e)]??{off:"circle",on:"circle.fill"}}function Dy(e){switch(Fs(e)){case"lock":return{kind:"equals",value:H("locked")};case"cover":case"valve":return{kind:"equals",value:H("open")};case"media_player":return{kind:"equals",value:H("playing")};default:return{kind:"isOn"}}}function Fs(e){return e.domain||e.entityId.split(".")[0]||""}function Gt(e){return{...e,domain:Fs(e)}}function Vy(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function ei(e){return Math.round(e*1e4)/1e4}function Sn(e,n,t){return Math.min(t,Math.max(n,e))}function As(e,n,t){let i=Ee[e],a=Sn(ei(n/i.width),0,1),r=Sn(ei(t/i.height),0,1);return{x:ei((1-a)/2),y:ei((1-r)/2),width:a,height:r,rotationDegrees:0}}function By(e){let n=Ee[e],t=Sn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:As(e,t*1.3,t*1.3),size:t}}function Uy(e){let n=Ee[e],t=Sn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:As(e,n.width*.88,t*1.7),size:t}}function Gy(e){let n=Ee[e],t=Math.min(n.width,n.height)*.9;return{frame:As(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Xu(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Ky(e){let n=Ee[e],t=Sn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:ei(t/n.height),rotationDegrees:0}}}function Wy(e){let n=Ee[e],t=Sn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:ei(Sn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function jy(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function qy(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function Bt(e,n,t,i){let a=i(t);n.payload.frame=a.frame,qy(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=vt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function Ut(e){return Ne(e)}function Is(e,n){let t={kind:{kind:"entityState",...Gt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Wu(e){let n=bn("setIcon");return n.value=H(e),n}function Cn(e){let n=bn("setColor");return n.value=H(e),n}function Yy(e,n){let t=Ti(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...Gt(e)}},a.comparison=Dy(e);let r=n.on!==n.off;return i.then=r?[Wu(n.on),Cn(Ku)]:[Cn(Ku)],t.otherwise=r?[Wu(n.off),Cn(gr)]:[Cn(gr)],t}function Xy(e){let n=Ti(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...Gt(e)}},i.comparison={kind:"isUnavailable"};let a=bn("setOpacity");return a.number=.35,t.then=[a],n}function ju(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Jy(e,n,t=Yu){let i=n.max-n.min,a=ju(n.min+i/3),r=ju(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:H(a)},changes:[Cn(t[0])]},{comparison:{kind:"between",value:H(a),upper:H(r)},changes:[Cn(t[1])]},{comparison:{kind:"greaterThan",value:H(r)},changes:[Cn(t[2])]}];return $c(Is(e),o)}function Zy(e,n,t){let i=Ut("icon"),a=Oy(n);return i.payload.symbol=H(a.off),i.payload.colorSlot.baseColorHex=gr,i.payload.rules=[Yy(n,a)],Bt(e,i,t.family,By),e.elements.push(i),xa(e,i.payload.id,{type:"toggleEntity",...Gt(n)}),i.payload.id}function Qy(e,n,t){let i=Ut("text");return i.payload.value=Is(n,t.state),i.payload.rules=[Xy(n)],Bt(e,i,t.family,Uy),e.elements.push(i),i.payload.id}function eb(e,n,t){let i=Ut("gauge");i.payload.value=Is(n);let a=Vy(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Jy(n,a,zy(t.state))],Bt(e,i,t.family,Gy),e.elements.push(i),i.payload.id}function tb(e,n,t){let i=Ut("chart");return i.payload.value={kind:{kind:"entityState",...Gt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",Bt(e,i,t.family,Xu),e.elements.push(i),i.payload.id}function nb(e,n,t){let i=Ut("chart");return i.payload.value={kind:{kind:"entityState",...Gt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",Bt(e,i,t.family,Xu),e.elements.push(i),i.payload.id}function ib(e,n,t){let i=Gt(n),a=Ut("text");a.payload.value=H(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=gr,Bt(e,a,t.family,Wy),e.elements.push(a);let r=t.state?.attributes?.device_class,o=Ut("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=to(i.domain,typeof r=="string"?r:void 0),Bt(e,o,t.family,Ky),e.elements.push(o),o.payload.id}function ab(e,n,t){let i=Ut("image");return i.payload.entity=Gt(n),Bt(e,i,t.family,jy),e.elements.push(i),i.payload.id}function Ju(e,n,t,i){switch(n){case"toggle":return Zy(e,t,i);case"status":return Qy(e,t,i);case"gauge":return eb(e,t,i);case"chart":return tb(e,t,i);case"history":return nb(e,t,i);case"doorHistory":return ib(e,t,i);case"camera":return ab(e,t,i)}}var rb=/^[a-z0-9_]+\.shared_(\d+)$/;function Zu(e){return rb.test(e)}function ob(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function ep(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function tp(e,n){let t=new Map;for(let i of ko(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=ep(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${ob(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function sb(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);vo(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),wo(t,r=>go(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function np(e){let n=!1;return $a(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function lb(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function ip(e,n,t=[]){let i=n==="share"?sb(e,t):e,a=Un(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${lb(a)}
`}function ap(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var db="There is nothing to read here. Paste a complication first.",cb="This is not valid JSON. Check for a missing brace or a stray comma.",ub="This is valid JSON but not a complication. A complication starts with { and ends with }.",pb="This does not look like a complication.",Qu="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",hb="00000000-0000-4000-8000-000000000000";function mb(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function rp(e,n){let t=e.trim();if(t==="")return{ok:!1,error:db};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:cb}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:ub};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${Qu}`};let o={...a,id:hb,slotIndex:0},s;try{s=Bn(o)}catch(d){let c=d instanceof Ke||d instanceof Error?d.message:String(d);return{ok:!1,error:`${pb}

${mb(c)}`}}let l=ya(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${Qu}`}}return{ok:!0,config:s,raw:i}}function Hs(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=ko(e,(o,s)=>Zu(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Zu(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:ep(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function op(e,n){let t=structuredClone(e);vo(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return wo(t,a=>go(a,i)),t}function sp(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function fb(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function lp(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=La(e);return i.length===0?t:`${t}, ${fb(i)}`}function Ls(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var yb=3e4,bb=500,xb=3e4,dp="preset-entity";function cp(e){return`import-entity-${e}`}var vb={entityId:"",displayName:"",domain:""},wb=new Map,kb={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function _s(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function $b(e){return e.kind==="family"?"look":"content"}function Ps(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function up(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function Cb(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var pp=300,hp=360,Os=44,Ds=22,vp=[1,1.7,2.6],Sb=["S","M","L"],mp=["Small","Medium","Large"];function Tb(){return vp.map((e,n)=>{let t=Math.round(Os*e),i=Math.round(Ds*e),a=`.layers-card.s${n}`;return`
...
`)}var fp="wrist-assistant-panel.layers.v1",$t=34,Tn=200,Eb=720,yr=320,Mb=80,Rb=56,gp="wrist-assistant-panel.columns.v3",zs=e=>Math.max(Tn,Math.min(Eb,Math.round(e))),yp=e=>e.metaKey||e.ctrlKey||e.shiftKey,Fb=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Yi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Kt=Yi==="Cmd"?"\u2318":"Ctrl+",Ns=Yi==="Cmd"?"\u21E7":"Shift+";function bp(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Mb;if(i>=Tn*2+yr){let r=i-yr,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Tn,Math.floor(o*l)),s=Math.max(Tn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Tn,o-d):s=Math.max(Tn,s-d))}return{columns:3,left:o,right:s}}let a=e-Rb;return a>=Tn+yr?{columns:2,left:Math.min(n,a-yr),right:t}:{columns:1,left:n,right:t}}var _=class _ extends Tt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=pp;this.colRight=hp;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=qn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=gc(()=>this.requestUpdate());this.imageSizes=yc(()=>this.requestUpdate());this.symbols=new Oa(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Ba;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Hs(a,this.hass.states);r.some(s=>Ss(cp(s.entityId)))||Ls({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Ss(dp)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??wb}static{this.styles=kr`
    :host {
      ...
      --wa-tap: ${ve(Ue.tap)};
      --wa-states: ${ve(ee.states)};
      --wa-place: ${ve(ee.place)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.held { background: color-mix(in srgb, ${ve(ee.group)} 12%, var(--wa-panel)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${ve(ee.locked)}; }
    ...
    .card.tint-values {
      ...
      background: color-mix(in srgb, ${ve(ee.complication)} 8%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${ve(ee.complication)} 25%, var(--wa-card));
    }
    .card.tint-states {
      padding: 10px 14px 12px;
      background: color-mix(in srgb, ${ve(ee.states)} 12%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${ve(ee.states)} 35%, var(--wa-card));
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(lr,this.scrubStart),this.addEventListener(dr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},xb)}loadColumnWidths(){try{let t=window.localStorage.getItem(gp);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=zs(i.left)),typeof i.right=="number"&&(this.colRight=zs(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(gp,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(fp);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(fp,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Au(s,o,i))}>Copy the ${ie(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(t){this.mutate(i=>sc(i,t)),this.activeFamily=t,this.inspect={kind:"family"}}removeShape(t){let i=this.draft?.config;if(!i||!_a(i,t))return;let a=dc(i,t);a.length>0&&!window.confirm(`Remove the ${ie(t)} shape? This deletes ${a.join(", ")}. They are on this shape only, so nothing else in the complication loses anything.`)||(this.mutate(r=>lc(r,t)),this.ensureActiveFamily())}createNew(){let t=this.newFamily,i=this.newName.trim();!t||i===""||this.newNameProblem()!==void 0||(this.closeNewDialog(),this.startNew(hd(i,this.freeSlot(),[t])))}setForced(t,i){let a=new Map(this.forced);i==="live"?a.delete(t):a.set(t,i),this.forced=a}async save(t=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!t&&!this.draft.dirty)){if(!t&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(t){let s=this.freeSlot();if(s<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let l=structuredClone(i.config);l.id=X(),l.slotIndex=s,i=new wn(l,null)}let a=i.encoded(),r=await ul(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id;let o=this.draft.testValues;this.draft=wn.fromDocument(r.record.document,r.record.revision),this.draft.testValues=o,this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=Ct(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let t=await pl(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!t.ok){t.error==="conflict"?this.conflict={current:t.current??null,message:t.message??"This complication changed on the server."}:this.saveError=t.message??t.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(t){this.saveError=Ct(t)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let t=structuredClone(this.draft.config);t.id=X(),t.name=`${t.name} copy`,t.slotIndex=this.freeSlot(),this.startNew(t)}reloadFromServer(){let t=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,t&&!t.deleted?this.openRecord(t):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(t=>t.owner_watch_id===this.ownerId)}async moveAll(){let t=this.ownerId,i=this.moveTarget;if(!(!t||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await hl(this.hass,t,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=Ct(a)}finally{this.moving=!1}}}scheduleTemplates(t){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},t),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},yb)}async refreshHistorySeries(){let t=this.draft?.config,i=t?Zr(t):[],a=t?Qr(t):[];if(i.length===0&&a.length===0){this.historySeries.size>0&&(this.historySeries=new Map);return}let r={};for(let s of i)r[s.key]=yl(s);let o={};for(let s of a)o[s.key]=bl(s);try{let[s,l]=await Promise.all([gl(this.hass,r),xl(this.hass,o).catch(()=>({}))]),d=new Map;for(let[c,u]of Object.entries({...s,...l}))u.ok&&d.set(c,u.series);this.historySeries=d}catch{}}async refreshTemplates(){this.refreshHistorySeries();let t=this.compiled?.document;if(!t){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await fl(this.hass,{doc:t})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=_d(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=Ct(i)}}entityStateFor(t,i,a){let r=this.hass.states[t];if(!r)return;let o=r.attributes,s=t.split(".")[0]??"",l={entityId:t,state:(a?this.testValues.get(t):void 0)??r.state,unitOfMeasurement:typeof o.unit_of_measurement=="string"?o.unit_of_measurement:void 0,iconName:i,domain:s};if(s==="timer"){l.timerState=r.state,typeof o.finishes_at=="string"&&(l.finishesAt=o.finishes_at);let d=Ab(o.remaining);d!==void 0&&(l.remaining=d)}return typeof o.entity_picture=="string"&&(l.entityPicture=o.entity_picture),l}buildContext(t=!0){let i=new Map;for(let[r,o]of this.compiled?.entities??[]){let s=this.entityStateFor(r,o.iconName??"",t);s&&i.set(r,s)}let a=this.draft?.config.values??[];return{entityStates:i,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:t?Md(a,this.testValues):a,dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3,testedEntities:t?new Set(this.testValues.keys()):new Set}}renderPickButton(){let t=this.picking,i=!this.draft||this.parseError!==void 0;return h`<button class="pick ${t?"on":""}" ?disabled=${i}
        ...
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${xp(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${up()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?h`<span class="hor" aria-hidden="true">or</span>${up()}`:f}
    ...
    </div>`}pickerRows(){let t=this.records.map(a=>({slot:Number(a.document?.slotIndex??0),kind:"record",record:a}));return[...t,...Pl(t.map(a=>a.slot),this.occupied).map(a=>a.kind==="custom"?{slot:a.slot,kind:"locked",name:a.name||"Unnamed complication",badge:a.home||"Other home",title:`A complication on ${a.home?`the ${a.home} home`:"another home"}${a.families?.length?` (${a.families.map(ie).join(", ")})`:""}. Edit it in that home's Wrist Assistant panel.`,families:a.families??[]}:{slot:a.slot,kind:"locked",name:a.name||"Unnamed preset",badge:"iPhone",title:"Still on the iPhone. Open the Wrist Assistant app on the iPhone to move it here.",families:[]})].sort((a,r)=>a.slot-r.slot)}shapeDots(t){return h`<span class="shape-dots">${vn.map(i=>h`<span class="shape-dot ${i} ${t.includes(i)?"on":""}" title=${ie(i)}></span>`)}</span>`}static{this.FILTER_FROM_ROWS=8}recordPreview(t){let i=this.recordPreviews.get(t.id);if(i&&i.revision===t.revision)return i;try{let a=Bn(t.document),r={revision:t.revision,config:a,entities:[...Ta(a).entities.values()]};return this.recordPreviews.set(t.id,r),r}catch{this.recordPreviews.delete(t.id);return}}renderRowArt(t){let i=this.recordPreview(t);if(!i)return h`<span class="pk-art"></span>`;let a=i.config,o=(this.pickerFilter!=="all"&&a.supportedFamilies.includes(this.pickerFilter)?this.pickerFilter:void 0)??Ko(a)??"inline",s=new Map;for(let c of i.entities){let u=this.entityStateFor(c.entityId,c.iconName??"",!1);u&&s.set(c.entityId,u)}let l=Ai(a,{entityStates:s,templateResults:new Map,namedValues:a.values});if(o==="inline")return h`<span class="pk-art inline">${this.renderInlinePreview(l.inline,!0)}</span>`;let d=l[o];return d?h`<span class="pk-art ${o}">${Ha(d,{icons:this.icons,imageSizes:this.imageSizes,slot:qn.slots[o]})}</span>`:h`<span class="pk-art"></span>`}renderPickerFilter(t){let i=r=>r.kind==="record"?Ps(r.record):r.families,a=(r,o,s)=>h`<button
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=ap(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?Hs(i,this.hass.states):[],r=Ls({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?h`<div class="hint err">A complication on this watch already has that name.</div>`:h`<div class="hint">${lp(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${np(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${lt({hass:this.hass},t.label,i??vb,a=>this.setImportEntity(t.entityId,a),cp(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,pr(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:rp(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=sp(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${Ct(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=op(t.config,this.importMap);i.id=X(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=rn(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${xp(a)}</option>`)}
              </select>
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Wo.map(s=>h`<button class="add" style=${`--k:${Ue[s]}`} ?disabled=${i} title=${`Add a blank ${Xn[s].toLowerCase()} layer`}
              @click=${()=>{let l=Ne(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?h`<span class="well">${Lc(s)}</span>`:f}<span class="add-name">${r?B(s):h`<span class="k"></span>`}<span>${Xn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Re(T,d)}</b>
          <small><span class="kind">${Xn[T.kind]}</span> · ${Lb(T,c,this.historySeries,F.size)}</small>
          ${S?h`<span class="facts">${Ib(this.host(),a,T,F).map(z=>h`<span class="fact"><b>${z.label}</b> ${z.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${Kt}])`} aria-label="Bring forward" @click=${z=>{z.stopPropagation(),r(P,1)}}>${B("up")}</button>
            <button class="icon" title=${`Send back (${Kt}[)`} aria-label="Send back" @click=${z=>{z.stopPropagation(),r(P,-1)}}>${B("down")}</button>
            <button class="icon" title=${`${F.isHidden?"Show":"Hide"} (${Ns}${Kt}H)`} aria-label=${F.isHidden?"Show this layer":"Hide this layer"} @click=${z=>{z.stopPropagation(),this.mutate(K=>Me(K,a,P,{isHidden:!F.isHidden}))}}>${B(F.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${Kt}D)`} aria-label="Duplicate" @click=${z=>{z.stopPropagation(),o(P)}}>${B("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${z=>{z.stopPropagation(),s(P)}}>${B("delete")}</button>
          </span>`:f}
        </span>
      </div>`},I=(T,U)=>{let Y=this.inspect.kind==="group"&&this.inspect.id===T.id,P=!this.collapsed.has(T.id),te=this.rowDrag(T.id,i),F=U[0],V=U[U.length-1],g=M=>{let A=M.currentTarget,z=A.getBoundingClientRect(),K=z.top+(A.classList.contains("drop-before")?$t:0),J=z.bottom-(A.classList.contains("drop-after")?$t:0),xe=(M.clientY-K)/Math.max(1,J-K);return xe<.25?"drop-before":!P&&xe>.75?"drop-after":"drop-into"},w=U.map(M=>M.payload.id);return h`<div class="layer group ${Y?"hl":""} ${S?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${te.draggable}
        ...
        @drop=${M=>{M.preventDefault();let A=g(M);this.clearDragMarks();let z=this.dragId;if(this.dragId=void 0,!(!z||!F||!V)){if(A==="drop-before"){this.reorderLayer(z,F.payload.id,!0,!0);return}if(A==="drop-after"){this.reorderLayer(z,V.payload.id,!1,!0);return}this.isGroupId(z)||(this.reorderLayer(z,F.payload.id,!0),this.mutate(K=>co(K,z,T.id)))}}}>
        ...
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Ns}${Kt}G)`} aria-label="Ungroup" @click=${M=>{M.stopPropagation(),this.mutate(A=>$i(A,T.id)),Y&&(this.inspect={kind:"general"})}}>${B("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${T.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${M=>{M.stopPropagation(),this.mutate(A=>{let z=A.groups?.find(K=>K.id===T.id);z&&(z.locked=!z.locked)})}}>${B(T.locked?"lock":"unlock")}</button>
      ...
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${B("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${Sb.map((T,U)=>h`
              <button class=${this.thumbStep===U?"on":""} title=${`${mp[U]} row pictures`}
                aria-label=${`${mp[U]} row pictures`} aria-pressed=${this.thumbStep===U?"true":"false"}
      ...
      ${b>=2&&i?h`<div class="group-cta"><span>${b} layers picked</span><span class="spacer"></span>
            <button class="small primary" title=${`Group (${Kt}G)`} @click=${()=>this.groupPicked()}>Group them</button>
      ...
      ${t===void 0?f:h`
        ...
        ${lt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},dp,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Ju(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=Ai(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?jn((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Fu();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${B("content")}</span>Shared values
      ...
      ${this.sharedHelp?h`<div class="shared-help">
        ...
        ${o}
      </div>`;let s=this.host(),l=new rt(this.buildContext(),this.draft?.config),d=pe(s);return h`<div class="card tint-values values-list" style=${`--c:${ee.complication}`}>
      ${o}
      <div class="data">
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
        ...
        ${p?h`<div class="value-open">${Ru(s,c)}</div>`:f}</div>`})}
      </div>
          ...
          ${B("plus")}${ie(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?Ha(c,{icons:this.icons,imageSizes:this.imageSizes,slot:qn.slots[r]}):f}let l=r!=="inline"&&mr(t,r)===0&&t.elements.length>0,d=this.canEdit&&_a(t,r);return h`<span class="tab-wrap">
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=Ed(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${ee.states}`}>
    ...
    </div>`}renderTestControl(t,i,a,r,o,s){let l=r??a?.state??"",d=Rd(t,a,r);if(d.kind==="choice")return h`<span class="test-ctl"><select aria-label=${`Test value for ${i}`} @change=${m=>this.setTestValue(t,m.target.value)}>
      ...
      ${c}
    </span>`}commitTestValue(t,i){this.editingValue=void 0,this.setTestValue(t,i)}setTestValue(t,i,a){let r=i?.trim()??"",o=new Map(this.testValues),s=t.startsWith(Sa)?this.sharedRaw(t.slice(Sa.length)):this.hass.states[t]?.state;r===""||r===s?o.delete(t):o.set(t,r),this.applyTestValues(o,a)}sharedRaw(t){let i=this.draft?.config;if(!i)return;let a=this.buildContext(!1),r=a.namedValues.map(o=>({...o,value:{kind:o.value.kind}}));return new rt({...a,namedValues:r},i).resolve({kind:{kind:"named",id:t}})}applyTestValues(t,i){let a=this.draft;!a||t.size===a.testValues.size&&[...t].every(([o,s])=>a.testValues.get(o)===s)||(a.setTestValues(t,i),this.version++)}currentCase(){return Hi.find(t=>t.label===this.previewCase)??qn}previewSlot(t){return this.currentCase().slots[t]}crumbs(t,i){let a=this.inspect,r=t.name.trim()||"Complication",o=this.activeFamily==="inline"?"Inline":ie(this.activeFamily),s=a.kind==="family"&&i===void 0?h`<span class="here" style=${`--k:${ee.place}`}>${o} shape</span>`:h`<button @click=${()=>{this.inspect={kind:"family"}}} title="Edit the shape">${o}</button>`,l=f,d=f;if(i!==void 0)l=h`<span class="here" style="--k:var(--wa-accent)"><span class="kchip">Picked</span><span class="nm">${i} layers</span></span>`;else if(a.kind==="layer"){let c=t.elements.find(u=>u.payload.id===a.id);if(c){l=h`<span class="here" style=${`--k:${Ue[c.kind]}`}><span class="kchip">${Xn[c.kind]}</span><span class="nm" title=${Re(c,pe(this.host()))}>${Re(c,pe(this.host()))}</span></span>`;let u=bt(t,c.payload.id);u&&(d=h`<span class="sep">›</span><button @click=${()=>{this.inspect={kind:"group",id:u.id}}} title="Edit the group">${u.name}</button>`)}}else if(a.kind==="group"){let c=t.groups?.find(u=>u.id===a.id);c&&(l=h`<span class="here" style=${`--k:${ee.group}`}><span class="kchip">Group</span><span class="nm" title=${c.name}>${c.name}</span></span>`)}return h`<div class="crumbs">
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${ke(a,"complication","Complication",Eu(a),{color:ee.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=_u(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=zu(a,c)}else s=Nu(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([$b(r)]):new Set(ks)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=pe(r),s=new rt(this.buildContext(),this.draft?.config),l=Iu(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(b=>{for(let y of i)Me(b,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(b=>{for(let y of i){let x=b.elements.find($=>$.payload.id===y.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&x.kind!=="chartTimes"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
            ...
            <div class="picked">
              ${c.map(m=>h`<div class="row" style=${`--k:${Ue[m.kind]}`}>
                ...
                <span class="name">
                  ...
                  <b>${Re(m,o)}</b><span class="kind">${Xn[m.kind]}</span>
                </span>
              </div>`)}
            </div>
            <div class="row-acts">
      ...
      ${ke(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:ee.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=bc({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
    ...
    </details>`}};N([Fn({attribute:!1})],_.prototype,"hass",2),N([Fn({type:Boolean})],_.prototype,"narrow",2),N([Fn({attribute:!1})],_.prototype,"panel",2),N([D()],_.prototype,"colLeft",2),N([D()],_.prototype,"colRight",2),N([D()],_.prototype,"panelWidth",2),N([D()],_.prototype,"owners",2),N([D()],_.prototype,"ownerId",2),N([D()],_.prototype,"records",2),N([D()],_.prototype,"selectedId",2),N([D()],_.prototype,"draft",2),N([D()],_.prototype,"readOnlyReason",2),N([D()],_.prototype,"parseError",2),N([D()],_.prototype,"maxSchemaVersion",2),N([D()],_.prototype,"presets",2),N([D()],_.prototype,"occupied",2),N([D()],_.prototype,"serverToken",2),N([D()],_.prototype,"appliedToken",2),N([D()],_.prototype,"sendStatusKnown",2),N([D()],_.prototype,"polling",2),N([D()],_.prototype,"lastPollSeconds",2),N([D()],_.prototype,"sendPending",2),N([D()],_.prototype,"pages",2),N([D()],_.prototype,"templateResults",2),N([D()],_.prototype,"historySeries",2),N([D()],_.prototype,"templateError",2),N([D()],_.prototype,"templateFetchedAt",2),N([D()],_.prototype,"forced",2),N([D()],_.prototype,"showRaw",2),N([D()],_.prototype,"inspect",2),N([D()],_.prototype,"openSections",2),N([D()],_.prototype,"helpSections",2),N([D()],_.prototype,"pickerOpen",2),N([D()],_.prototype,"pickerFilter",2),N([D()],_.prototype,"pickerNote",2),N([D()],_.prototype,"openValue",2),N([D()],_.prototype,"sharedHelp",2),N([D()],_.prototype,"editingValue",2),N([D()],_.prototype,"thumbStep",2),N([D()],_.prototype,"layerDetail",2),N([D()],_.prototype,"addOpen",2),N([D()],_.prototype,"addDetail",2),N([D()],_.prototype,"multi",2),N([D()],_.prototype,"collapsed",2),N([D()],_.prototype,"activeFamily",2),N([D()],_.prototype,"picking",2),N([D()],_.prototype,"pickHoverId",2),N([D()],_.prototype,"listHoverIds",2),N([D()],_.prototype,"zoomed",2),N([D()],_.prototype,"helpOpen",2),N([D()],_.prototype,"showTaps",2),N([D()],_.prototype,"timestampActiveId",2),N([D()],_.prototype,"savedName",2),N([D()],_.prototype,"presetKind",2),N([D()],_.prototype,"presetEntity",2),N([D()],_.prototype,"newOpen",2),N([D()],_.prototype,"newName",2),N([D()],_.prototype,"newFamily",2),N([D()],_.prototype,"shareOpen",2),N([D()],_.prototype,"shareMode",2),N([D()],_.prototype,"shareLabels",2),N([D()],_.prototype,"shareNote",2),N([D()],_.prototype,"importOpen",2),N([D()],_.prototype,"importText",2),N([D()],_.prototype,"importParse",2),N([D()],_.prototype,"importName",2),N([D()],_.prototype,"importMap",2),N([D()],_.prototype,"previewCase",2),N([D()],_.prototype,"loadError",2),N([D()],_.prototype,"saveError",2),N([D()],_.prototype,"saving",2),N([D()],_.prototype,"conflict",2),N([D()],_.prototype,"remoteRevision",2),N([D()],_.prototype,"confirmDelete",2),N([D()],_.prototype,"moveTarget",2),N([D()],_.prototype,"moving",2),N([D()],_.prototype,"moveError",2),N([D()],_.prototype,"version",2);var Vs=_;function Ct(e){return String(e?.message??e)}function Ab(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function xp(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function Ib(e,n,t,i){let a=[{label:"Shows",value:Es(e,t)}],r=or(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function Hb(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function Lb(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ie(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=cn(e.payload)??un(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Qe(o).length} values`}case"timeline":{let r=zt(e.payload),o=r===void 0?[]:Fi(t.get(r)??""),s=Math.max(0,o.length-1);return`${Hb(it(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ie(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return yt(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Vs);export{Vs as WristAssistantPanel,bp as columnFit,Ib as layerFacts};
