...
`)}function sc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Ym(r));return{values:t,nullKeys:i}}function Ym(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function qo(e){let n=Ua(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Xm(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(lo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Jm=10800;function Zm(e,n,t){let i=n==="always"||n==="auto"&&t<=Jm;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Xo(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Zm(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Qm(e,n){return Yt(e)===void 0?[]:Xo(ct(e)*60,Ha(e.timeLabelCount),e.hourCycle,e.minutes,n)}function ef(e,n){return Cn(e)?Xo(Math.round(e.historyMinutes)*60,Ha(vt(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function tf(e,n,t){return n===void 0||!Cn(n)?[]:Xo(Math.round(n.historyMinutes)*60,Ha(vt(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function zn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ke(e){let n=e.trim(),t=zn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:zn(i)}function nf(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function af(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function rf(e){let n=e.trim(),t=zn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?zn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=zn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function of(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function sf(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function lf(e,n,t){if(Le(n))return e;let i=n,a=e,r=zn(e.trim()),o=i.duration?rf(e):void 0;if(o!==void 0)a=of(o);else if(i.relativeTime&&r!==void 0)a=af(r);else{let s=Ke(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):nf(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=sf(a);break}return a}function oi(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function et(e,n=240){return pc(e,n).map(t=>t.value)}function Jo(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of et(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:uc(r)}}function uc(e){return e.some(n=>n)?e:[]}function pc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function lc(e,n,t){let i=pc(e),a=i.map(g=>g.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Gt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??se,c=t.highColorHex??Ye,u=t.lowColorHex??Xe,p=[],m=(g,x)=>{if(g==="")return;let w=p.at(-1);w&&w.colorHex===x?w.text+=g:p.push({text:g,colorHex:x})},y=0;return i.forEach((g,x)=>{m(e.slice(y,g.start),n);let w=x===o?c:x===s?u:l.length>0?Ra(g.value,l,d):n,C=e[g.end-1]==="."?g.end-1:g.end;m(e.slice(g.start,C),w),y=C}),m(e.slice(y),n),p}function dc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function df(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Oi(e,n=qt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:cf(i.slice(a+1))})}return t}function cf(e){try{return decodeURIComponent(e)}catch{return e}}function uf(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function cc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function pf(e,n,t){if(e===void 0)return 0;let i=Ke(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var ht=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=dc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=Sn(n),i=Tn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Jo(a):{values:et(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=uc(s),{values:Zo(o,it(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ke(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ke(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):dc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Le(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Xm(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?md(r):lo(r,a.domainMax-a.domainMin));break}default:{let a=jo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return lf(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=zn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?oi(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ke(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ke(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ke(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=In(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:In(d),p=c===void 0?void 0:In(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(ze[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=lc(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,y=at(n.payload)&&!r.has("text"),g={kind:"text",...u,text:y?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(g.countdownEnd=p),y?(g.parts=this.resolveTextParts(n.payload.parts,i.rules,g,t),g.text=g.parts.map(x=>x.text).join(""),g):(dd(n.payload)&&(g.spans=lc(g.text,g.colorHex,n.payload)),g)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),y=n.payload.symbol.kind.kind==="literal",g=m===void 0&&y&&n.payload.path!==""?n.payload.path:void 0,x=m??p;g===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let w={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return g!==void 0&&(w.path=g),w}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),y=(z,I,Q)=>z??(I?Ke(this.resolve(I)??""):void 0)??Q,g=y(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=y(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),w=m===void 0?void 0:Ke(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&w!==void 0&&(C=Ra(w,Gt(p),p.bandAboveColorHex));let $=x-g;if(p.total){let z=Ke(this.resolve(p.total)??"");z!==void 0&&($=z)}let S=cc($,1,Ma),P={kind:"gauge",...u,fraction:pf(m,g,x),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:cc(w??0,0,S)};if(p.thresholdValue!==void 0&&x!==g){let z=(p.thresholdValue-g)/(x-g);z>=0&&z<=1&&(P.thresholdFraction=z)}return P}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),y=m.values,g=m.holes,x={min:m.domainMin,max:m.domainMax},w=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Gt(p),$=hd(p)?y.map(Z=>Ra(Z,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",P=p.highlight==="lowest"||p.highlight==="both",z=Ci(p),I={kind:"chart",...u,values:y,holes:g,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:w,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?z.high:"none",lowMarker:P?z.low:"none",pointColorHexes:$,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:it(p.smoothing)??"off",fillStyle:Nt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:Pt(p.barRadius),barCorners:Dt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:ef(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},Q=g.length===0?y:y.filter((Z,H)=>!g[H]);if(Q.length>0){let Z=A=>y.findIndex((K,b)=>K===A&&g[b]!==!0),H=S?Z(Math.max(...Q)):-1,X=P?Z(Math.min(...Q)):-1;H>=0&&(I.highIndex=H),X>=0&&X!==H&&(I.lowIndex=X)}let R=df(p,x.min,x.max);R!==void 0&&(I.thresholdY=R);let U=this.chartNowIndex(p,y.length);return U!==void 0&&(I.nowIndex=U),I}case"timeline":{let p=n.payload,m=Yt(p),y=m===void 0?"":this.ctx.historySeries?.get(m)??"",g=Oi(y,qt),x=uf(g,ct(p)*60,C=>wd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:Qm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};kt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:tf(p,this.chartElements.get(p.chart),this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"chartDots":{let p=n.payload,m=lt(p.size),y={kind:"chartDots",...u,chart:p.chart,dots:$a(p.dots),diameter:0,indices:[]};return m!==void 0&&(y.size=m),p.colorHex!==void 0&&(y.colorHex=p.colorHex),y}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:xn(p.lines),colorHex:Lt(p.colorHex),thickness:vn(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=he[t==="inline"?"rectangular":t],o=[...bf(yf(Od(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,w=this.resolve(x.value),C=w===void 0?void 0:Ke(w);if(C!==void 0){let $=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),P={value:Math.min(S,Math.max($,C)),minValue:$,maxValue:S===$?$+1:S,colorHexes:x.colorHexes},z=this.resolve(x.minLabel);z!==void 0&&(P.minLabel=z);let I=this.resolve(x.maxLabel);I!==void 0&&(P.maxLabel=I),l.bezelGauge=P}}let y=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;y!==void 0&&(l.backgroundColorHex=y);let g=this.styleColor(s,"borderColor")??a?.borderColorHex;return g!==void 0&&(l.borderColorHex=g),l}};function hf(e,n,t){let i=new ht(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Vi(e,n,t){let i=new ht(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=hf(e.inline,n,e)),a}function Ka(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Yo=5,mf=1.7,ff=1.8;function gf(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function yf(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*ff,l=Math.max(o.frame.width*n.width,0),d=gf(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function hc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function mc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function Wa(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=I=>I==="triangle"?Yo+d:I==="dot"?Math.max(d,mf):d,u=c(a),p=c(r),m=n.y+u,y=Math.max(n.h-u-p,1),g=m+y,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),w=e.baseline==="lowest",C=w?y*.12:0,$=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-$*(i-1))/i,.5),P=I=>Math.min(1,Math.max(0,(I-e.domainMin)/x)),z=I=>g-P(I)*y;return{count:t.length,barWidth:S,plotTop:m,plotBottom:g,plotLeft:o,plotRight:o+s,baselineY:w?g:z(0),inset:d,yAtFraction(I){return g-Math.min(Math.max(I,0),1)*y},barRect(I){let Q=o+I*(S+$),R=t[I],U,Z;if(w){let H=C+P(R)*(y-C);U=g-H,Z=g}else U=z(R),Z=w?g:z(0),U>Z&&([U,Z]=[Z,U]);return{x:Q,y:U,w:S,h:Math.max(Z-U,.5)}},point(I){let Q=Math.max(s-d*2,0);return{x:t.length>1?o+d+Q*I/(t.length-1):o+s/2,y:z(t[I])}},markerCenter(I,Q,R="high"){let U=Q?this.barRect(I):void 0,Z=U?U.x+U.w/2:this.point(I).x,H=R==="high"?a:r,X=R==="high"?H==="triangle"?n.y+Yo/2:m:H==="triangle"?n.y+n.h-Yo/2:g;return{x:Z,y:X}}}}function fc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Zo(e,n,t=[]){let i=e.length,a=ld(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,y=0;for(let g=Math.max(0,p-r);g<=Math.min(i-1,p+r);g++){if(s(g))continue;let x=g-p,w=Math.exp(-(x*x)/(2*o*o));m+=e[g]*w,y+=w}return m/y}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function gc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Di=1;function si(e,n){let t=Math.max(Wt,Math.min(jt,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Di>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Di:n.y,h:n.h-i-Di,cy:(e.labelsAbove?n.y+i+Di:n.y)+(n.h-i-Di)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function bf(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&hc(r)===void 0)return{...i,isHidden:!0};let o=vf(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function xf(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function vf(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Ka(t,i);if(a.w<=0||a.h<=0)return;let r=si(t,a).body;if(r.w<=0||r.h<=0)return;let o=Wa(t,r),s,l;if(dt(n.at)){let w=xf(n.at,t);if(w===void 0)return;if(t.style==="bars"){let C=o.barRect(w);s=C.x+C.w/2,l=C.y}else{let C=o.point(w);s=C.x,l=C.y}}else{let w=n.at==="zero"?hc(t):t.thresholdY;if(w===void 0)return;l=o.yAtFraction(w)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(w,C,$)=>C>$?(C+$)/2:Math.min(Math.max(w,C),$),m={...e};if(s!==void 0){let w=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(w-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let w=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(w-c/2)/i.height}return m}let y=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,g=p(y,r.y+c/2,r.y+r.h-c/2),x=p(g+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var _e=he,Bi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:_e,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],li=Bi.find(e=>e.measured);function Tc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Bi.find(a=>a.screen.width===t&&a.screen.height===i)}function qa(e,n){let t=_e[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var ns={regular:400,medium:500,semibold:600,bold:700},wf=1.15;function We(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ye(e,n,t="#FFFFFF"){let i=We(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var Tt=e=>e*.55;function Ec(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function kf(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function $f(e,n,t){if(t<=0||e.length*Tt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/Tt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Cf(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Mc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Rc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Sf(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Fc(e,n){return e.reduce((t,i)=>t+i.text.length*Tt(i.look.fontSize*n),0)}function Tf(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:Tt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=Tt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Ef(e,n,t){if(t<=0||Fc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*Tt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*Tt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Mf(e,n,t){let i=Sf(n),a=e.lineLimit===2&&t.w>0?Tf(e.text,i,t.w):[e.text],r=Mc(e.text,a),o=a.map((C,$)=>Rc(C,r[$]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>Fc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>Ef(C,l,t.w)),{anchor:c,x:u}=Ec(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,y=p*1.15,g=C=>C.map($=>{let S=ye($.look.colorHex,"fill");return v`<tspan font-size=${$.look.fontSize*l} font-weight=${ns[$.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}),x=ye(e.colorHex,"fill"),w=d.length>1?v`${d.map((C,$)=>v`<tspan x=${u} y=${t.cy+m+($-(d.length-1)/2)*y}>${g(C)}</tspan>`)}`:g(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${y}</text>`}var Qo=2;function Ff(e,n){let t=ye(e.colorHex,"stroke"),i=ye(e.trackColorHex,"stroke","#FFFFFF"),a=ye(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,y=Math.max(1,e.dotCount),g=m?n.w:n.h,x=m?n.h:n.w,w=Math.max(1,Math.min(x,g/y-Qo)),C=y*w+(y-1)*Qo,$=(m?n.cx:n.cy)-C/2+w/2;return v`${Array.from({length:y},(S,P)=>{let z=$+P*(w+Qo),I=P<e.filledCount?t:i;return v`<circle cx=${m?z:n.cx} cy=${m?n.cy:z} r=${w/2}
        fill=${I.stroke} fill-opacity=${I["stroke-opacity"]} />`})}`}if(e.style==="bar"){let m=n.w,y=Math.max(r,m*e.fraction),g=1;return v`
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function Hf(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=si(e,n),o=r?ss(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=Lf(e,a);return o===void 0?s:v`${s}${o}`}function es(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var yc=0;function Ac(){return yc+=1,yc.toString(36)}function If(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function Lf(e,n){let t=Wa(e,n),i=Ac(),a=ye(e.colorHex,"fill"),r=ye(e.highColorHex,"fill",e.colorHex),o=ye(e.lowColorHex,"fill",e.colorHex),s=(y,g)=>v`<circle cx=${y.x} cy=${y.y} r="1.7" fill=${g.fill} fill-opacity=${g["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=y=>c?ye(e.pointColorHexes[y],"fill",e.colorHex):a,p=y=>{let g=We(y)??We(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:g.color,opacity:g.opacity*.28};let x=_f(i,e.id,y),w=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,v`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${w} x2="0" y2=${t.baselineY}>
        ...
        <stop offset="1" stop-color=${g.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let y=0;y<t.count;y++){if(e.holes[y]===!0)continue;let g=t.barRect(y),x=y===e.highIndex?r:y===e.lowIndex?o:u(y),w=Math.min(Math.max(e.barRadius,0),g.w/2,g.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[y]<0;l.push(v`<path d=${If(g,w,C)}
          ...
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let y=Array.from({length:t.count},(C,$)=>t.point($)),g=e.holes.length>0,w=gc(t.count,e.holes).filter(C=>!g||C.length>1).map(C=>{let $=C.map(z=>y[z]),S=fc($,e.curve),P=`M${$[0].x} ${$[0].y}${S.map(z=>` ${es(z)}`).join("")}`;return{run:C,pts:$,legs:S,line:P}});if(e.style==="area")for(let{run:C,pts:$,legs:S,line:P}of w)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let z=0;z<S.length;z++){let I=$[z],Q=$[z+1],R=p(e.pointColorHexes[C[z+1]]),U=`M${I.x} ${I.y} ${es(S[z])} L${Q.x} ${t.baselineY} L${I.x} ${t.baselineY} Z`;l.push(v`<path d=${U} fill=${R.fill} fill-opacity=${R.opacity} stroke="none" />`)}else{let z=p(e.fillColorHex??e.colorHex),I=`${P} L${$[$.length-1].x} ${t.baselineY} L${$[0].x} ${t.baselineY} Z`;l.push(v`<path d=${I} fill=${z.fill} fill-opacity=${z.opacity} stroke="none" />`)}for(let{run:C,pts:$,legs:S,line:P}of w)if(c&&C.length>1)for(let z=0;z<S.length;z++){let I=$[z],Q=u(C[z+1]);l.push(v`<path d=${`M${I.x} ${I.y} ${es(S[z])}`} fill="none"
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
        ...
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,P=x?f:v`<rect x=${d.x} y=${d.y} width=${d.w} height=${d.h} fill="transparent" stroke="none" />`,z=3,I=y&&C?[["nw",d.x,d.y],["ne",d.x+d.w,d.y],["sw",d.x,d.y+d.h],["se",d.x+d.w,d.y+d.h]].map(([Q,R,U])=>v`<rect data-handle=${Q} x=${R-z/2} y=${U-z/2} width=${z} height=${z}
    ...
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+g,d+g+Math.max(s,3),e.maxLabel):f}`}function Za(e,n){let t=e.family in _e?e.family:"rectangular",i=n.slot??_e[t],a=_e[t],r=qa(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=We(e.backgroundColorHex),l=We(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=Ic(c);if(t==="corner"){let x=r.scale,w=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",$=C!=="",S=Ja(x,w),P=ds(x,w),z=P/(a.width*x),I=S.tile.cx-P/2,Q=S.tile.cy-P/2,R=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,U=f;if(e.bezelGauge)U=Zf(e.bezelGauge,x,o);else if(e.bezelText){let H=qf(x,`${o}-bezel`),X=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?oi((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;U=v`<defs><path id=${H.id} d=${H.d} /></defs>
        ...
        <text font-size=${wc*x} font-weight="600" fill=${H.color} fill-opacity=${H.opacity}
          ...
          <textPath href="#${X.id}" startOffset="50%" text-anchor="middle">${vc(C,X.length,wc*x*.88)}</textPath></text>`}else{let H=e.borderWidth*r.scale*z,X=l?v`<circle cx=${P/2} cy=${P/2} r=${P/2-H/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${H} />`:f;Z=v`<g transform="translate(${I} ${Q})">
        <g clip-path=${`url(#${o})`}>
  ...
  </button>`}function ip(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Oe),m=a!==void 0,y=m?r.pack(i)??(p?"mdi":"sf"):"sf",g=Dg(u,c),x=$=>{t($),a?.($.startsWith(Oe)?e.icons.mdiPath?.($):void 0),r.noteUsed($)},w=$=>{if(t($),!m)return;let S=$.trim();a?.(S.startsWith(Oe)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&y==="mdi"){let $=e.icons.mdiNames?.(),S=Og($??[],s),P=S.slice(0,Iu),z=r.recent.filter(I=>I.startsWith(Oe));C=h`<div class="sym-browse">
      ${zu(r,i,y)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${be(I=>r.setQuery(i,I))} />
      </div>
      ${z.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${z.map(I=>hr(e,I,I===u,x))}</div>`}
      <div class="sym-grid">${P.map(I=>hr(e,I,I===u,x))}</div>
    ...
    </div>`}else if(o){let $=r.category(i),S=zg($,s,d,c),P=ms(S.names,s),z=S.fromPack?P.slice(0,Iu):P,I=r.recent.filter(R=>!R.startsWith(Oe)),Q=c.size===0?I:I.filter(R=>c.has(R));C=h`<div class="sym-browse">
      ${m?zu(r,i,y):f}
      <div class="sym-controls">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    </button>`}),P=r.rules.some(A=>A.partId===c.id),z=c.value.kind.kind==="literal",I=Ds(c),Q=c.fontSize!==void 0,R=pi.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,U=A=>{A>=Is&&A<=Ls&&g(K=>{K.fontSize=A},"size")},Z=I==="bands"?et(e.resolve(c.value)??""):[],H={layer:"Use the layer colour",...z&&I!=="bands"?{bands:"By value needs a live value"}:{}},X=(A,K)=>g(b=>{let k={bands:b.bands??[],bandAboveColorHex:b.bandAboveColorHex??se};A(k),k.bands.length>0?b.bands=k.bands:delete b.bands,k.bandAboveColorHex!==se?b.bandAboveColorHex=k.bandAboveColorHex:delete b.bandAboveColorHex},K);return h`<div class="rich-parts">
    ...
    <div class="part-editor">
      ...
      ${ee("Colour",I,Gy,A=>g(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=Gs(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=$r(et(e.resolve(K.value)??"")))}),{def:"layer",titles:H,...z&&I!=="bands"?{disabled:{bands:!0}}:{}})}
      ${I==="pick"?me("Part colour",c.colorHex,A=>g(K=>{K.colorHex=A??p},"color")):f}
      ${I==="bands"?h`
      ...
      <label class="field num part-size">${Ne("Font size",Q?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>g(A=>{delete A.fontSize})}:void 0,Fr(c.fontSize??m,U,{step:1,min:Is,max:Ls}))}
        ...
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let $=y||Vn(n)===void 0?void 0:g(n.kind==="shape"?"Fill colour":n.kind==="text"&&at(n.payload)?"Layer colour":"Colour"),S=Io(e.config,n),P=S?{kind:{kind:"entityState",...S}}:void 0,z=n.kind==="image"?n.payload.timestamp===!0:!1,I=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,Q=nb[n.kind],R=ib[n.kind],U=Fs(n.payload,u,Q),Z=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,H=e.config.perFamily[t]?.placements[a]?.size!==void 0,X=Fs(n.payload,u,R)||Z!==void 0&&l.size!==void 0&&l.size!==u[Z],A=Mn(e.config,a),K=(b,k)=>()=>s(T=>fr(T.payload,u,b),k);return h`
    ...
    ${ve(e,"states","States",Ip(e,n.payload.rules,n.kind,b=>b.elements.find(k=>k.payload.id===a)?.payload.rules,`rules-${a}`,P,I),{color:te.states,icon:"states",summary:Ui(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ...
    ${ee("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=L("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ee("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=L("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:L("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    ${Fp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function wb(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=Ln(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=oe(e,s.value??L(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${oe(e,s.value??L(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${oe(e,s.upper??L(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${$e("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!kb(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Yu(e,"From",s.value??L("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Yu(e,"To",s.upper??L("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
    ...
    ${Hp(e,n,a,o)}
  </div>`}function Hp(e,n,t,i){let a=Ba(n.kind),r=f;if(a==="value"){let o=n.value??L("");if(Ap.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?me("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=L(l??"#FFFFFF")},"color")):oe(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${bb(e,n,t,i,a,o)}`:Tb(e,s.table,n[0],t,i,a,r,o)}function Tb(e,n,t,i,a,r,o,s){let l=(b,k)=>e.update(T=>{let M=a(T);M&&b(M)},k?`${r}-${k}`:void 0),d=n.value??Xu.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!lu(d)&&Eb(e.resolve(d)),p=_i[i],m=br.get(r)??new Set,y=n.columns.length===0&&m.size===0?[su[i]]:[],g=Zc(n.columns,[...m,...y.filter(b=>b!==void 0)],p),x=gr.get(r),w=t?t.partId:s?.some(b=>b.id===x)?x:void 0,C=s!==void 0&&w!==void 0,$=C?p.filter(b=>Er.includes(b)):p,S=C?g.filter(b=>!Er.includes(b)):[],P=(b,k)=>{if(!t){b?gr.set(r,b):gr.delete(r),Re(k);return}l(T=>{let M=T[0];M&&(b?M.partId=b:delete M.partId)})},z=t?e.liveBranch(t):"none",I=t?e.forced.get(t.id)??"live":"live",Q=b=>I!=="live"&&(I==="otherwise"?b==="otherwise":I.caseId===b),R=b=>{t&&e.setForced(t.id,Q(b)?"live":b==="otherwise"?"otherwise":{caseId:b})},U=b=>{Xu.set(r,b),n.rows.length!==0&&l(k=>au(k,b),"lhs")},Z=()=>{gr.delete(r),l(b=>{nu(b,d??L(""),u),w!==void 0&&b[0]&&b[0].partId===void 0&&(b[0].partId=w)})},H=n.rows.map((b,k)=>Zu(e,{key:`${r}-${b.caseId}`,label:ou(b.comparison,T=>ke(T,pe(e))),columns:g,changes:b.changes,live:z===b.caseId,forced:Q(b.caseId),onForce:()=>R(b.caseId),when:Hb(e,b.comparison,`${r}-${b.caseId}`,(T,M)=>l(F=>{let G=F[0]?.cases.find(Y=>Y.id===b.caseId)?.when.tests[0];G&&T(G.comparison)},M&&`${b.caseId}-${M}`)),updChanges:(T,M)=>l(F=>{let G=F[0]?.cases.find(Y=>Y.id===b.caseId);G&&T(G.then)},M&&`${b.caseId}-${M}`),acts:h`
    ...
    <div class="states">
      ${oe(e,d??L(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
    ...
    </div>`}function Ab(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Ba(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${pi.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??L(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Ap.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
...
`)}var ah="wrist-assistant-panel.layers.v1",Mt=34,Wn=200,Tx=720,Nr=320,Ex=80,Mx=56,rh="wrist-assistant-panel.columns.v3",nl=e=>Math.max(Wn,Math.min(Tx,Math.round(e))),oh=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Rx(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Fx=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,ia=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",ln=ia==="Cmd"?"\u2318":"Ctrl+",il=ia==="Cmd"?"\u21E7":"Shift+";function sh(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Ex;if(i>=Wn*2+Nr){let r=i-Nr,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Wn,Math.floor(o*l)),s=Math.max(Wn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Wn,o-d):s=Math.max(Wn,s-d))}return{columns:3,left:o,right:s}}let a=e-Mx;return a>=Wn+Nr?{columns:2,left:Math.min(n,a-Nr),right:t}:{columns:1,left:n,right:t}}var _=class _ extends At{constructor(){super(...arguments);this.narrow=!1;this.colLeft=th;this.colRight=nh;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=li.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Wc(()=>this.requestUpdate());this.imageSizes=jc(()=>this.requestUpdate());this.symbols=new ir(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new or;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Zs(a,this.hass.states);r.some(s=>Us(Qp(s.entityId)))||Qs({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Us(Zp)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??vx}static{this.styles=Vr`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Mr,this.scrubStart),this.addEventListener(Rr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},bx)}loadColumnWidths(){try{let t=window.localStorage.getItem(rh);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=nl(i.left)),typeof i.right=="number"&&(this.colRight=nl(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(rh,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(ah);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(ah,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      </div>`},I=[],Q=new Set;for(let R=0;R<l.length;R++){let U=l[R],Z=U.payload.groupId,H=Z===void 0?void 0:t.groups?.find(K=>K.id===Z);if(!H){I.push(P(U,!1));continue}if(Q.has(H.id))continue;Q.add(H.id);let X=l.filter(K=>K.payload.groupId===H.id);I.push(z(H,X));let A=this.inspect.kind==="group"&&this.inspect.id===H.id;this.collapsed.has(H.id)||I.push(h`<div class="group-kids">${X.map(K=>P(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${w}px;--thumb-h:${C}px`}>
    ...
    </details>`}};O([Xn({attribute:!1})],_.prototype,"hass",2),O([Xn({type:Boolean})],_.prototype,"narrow",2),O([Xn({attribute:!1})],_.prototype,"panel",2),O([V()],_.prototype,"colLeft",2),O([V()],_.prototype,"colRight",2),O([V()],_.prototype,"panelWidth",2),O([V()],_.prototype,"owners",2),O([V()],_.prototype,"ownerId",2),O([V()],_.prototype,"records",2),O([V()],_.prototype,"selectedId",2),O([V()],_.prototype,"draft",2),O([V()],_.prototype,"readOnlyReason",2),O([V()],_.prototype,"parseError",2),O([V()],_.prototype,"maxSchemaVersion",2),O([V()],_.prototype,"presets",2),O([V()],_.prototype,"occupied",2),O([V()],_.prototype,"serverToken",2),O([V()],_.prototype,"appliedToken",2),O([V()],_.prototype,"sendStatusKnown",2),O([V()],_.prototype,"polling",2),O([V()],_.prototype,"lastPollSeconds",2),O([V()],_.prototype,"sendPending",2),O([V()],_.prototype,"pages",2),O([V()],_.prototype,"templateResults",2),O([V()],_.prototype,"historySeries",2),O([V()],_.prototype,"historyReadings",2),O([V()],_.prototype,"templateError",2),O([V()],_.prototype,"templateFetchedAt",2),O([V()],_.prototype,"forced",2),O([V()],_.prototype,"showRaw",2),O([V()],_.prototype,"inspect",2),O([V()],_.prototype,"openSections",2),O([V()],_.prototype,"helpSections",2),O([V()],_.prototype,"pickerOpen",2),O([V()],_.prototype,"pickerFilter",2),O([V()],_.prototype,"pickerNote",2),O([V()],_.prototype,"openValue",2),O([V()],_.prototype,"sharedHelp",2),O([V()],_.prototype,"editingValue",2),O([V()],_.prototype,"thumbStep",2),O([V()],_.prototype,"layerDetail",2),O([V()],_.prototype,"addOpen",2),O([V()],_.prototype,"addDetail",2),O([V()],_.prototype,"multi",2),O([V()],_.prototype,"collapsed",2),O([V()],_.prototype,"activeFamily",2),O([V()],_.prototype,"picking",2),O([V()],_.prototype,"pickHoverId",2),O([V()],_.prototype,"listHoverIds",2),O([V()],_.prototype,"rowHoverId",2),O([V()],_.prototype,"zoomed",2),O([V()],_.prototype,"helpOpen",2),O([V()],_.prototype,"showTaps",2),O([V()],_.prototype,"timestampActiveId",2),O([V()],_.prototype,"savedName",2),O([V()],_.prototype,"presetKind",2),O([V()],_.prototype,"presetEntity",2),O([V()],_.prototype,"newOpen",2),O([V()],_.prototype,"newName",2),O([V()],_.prototype,"newFamily",2),O([V()],_.prototype,"shareOpen",2),O([V()],_.prototype,"shareMode",2),O([V()],_.prototype,"shareLabels",2),O([V()],_.prototype,"shareNote",2),O([V()],_.prototype,"importOpen",2),O([V()],_.prototype,"importText",2),O([V()],_.prototype,"importParse",2),O([V()],_.prototype,"importName",2),O([V()],_.prototype,"importMap",2),O([V()],_.prototype,"previewCase",2),O([V()],_.prototype,"loadError",2),O([V()],_.prototype,"saveError",2),O([V()],_.prototype,"saving",2),O([V()],_.prototype,"conflict",2),O([V()],_.prototype,"remoteRevision",2),O([V()],_.prototype,"confirmDelete",2),O([V()],_.prototype,"moveTarget",2),O([V()],_.prototype,"moving",2),O([V()],_.prototype,"moveError",2),O([V()],_.prototype,"version",2);var ol=_;function Rt(e){return String(e?.message??e)}function Ax(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function lh(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function Hx(e,n,t,i){let a=[{label:"Shows",value:Ks(e,t)}],r=Tr(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function Ix(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function Lx(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Me(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=Sn(e.payload)??Tn(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${et(o).length} values`}case"timeline":{let r=Yt(e.payload),o=r===void 0?[]:Oi(t.get(r)??""),s=Math.max(0,o.length-1);return`${Ix(ct(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Me(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return $t(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",ol);export{ol as WristAssistantPanel,sh as columnFit,Hx as layerFacts};
