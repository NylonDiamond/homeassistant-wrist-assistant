var sm=Object.defineProperty;var lm=Object.getOwnPropertyDescriptor;var O=(e,n,t,i)=>{for(var a=i>1?void 0:i?lm(n,t):n,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(n,t,a):o(a))||a);return i&&a&&sm(n,t,a),a};var xa=globalThis,va=xa.ShadowRoot&&(xa.ShadyCSS===void 0||xa.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,lo=Symbol(),Dl=new WeakMap,ki=class{constructor(n,t,i){if(this._$cssResult$=!0,i!==lo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=n,this.t=t}get styleSheet(){let n=this.o,t=this.t;if(va&&n===void 0){let i=t!==void 0&&t.length===1;i&&(n=Dl.get(t)),n===void 0&&((this.o=n=new CSSStyleSheet).replaceSync(this.cssText),i&&Dl.set(t,n))}return n}toString(){return this.cssText}},Fe=e=>new ki(typeof e=="string"?e:e+"",void 0,lo),co=(e,...n)=>{let t=e.length===1?e[0]:n.reduce((i,a,r)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[r+1],e[0]);return new ki(t,e,lo)},Ol=(e,n)=>{if(va)e.adoptedStyleSheets=n.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of n){let i=document.createElement("style"),a=xa.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,e.appendChild(i)}},uo=va?e=>e:e=>e instanceof CSSStyleSheet?(n=>{let t="";for(let i of n.cssRules)t+=i.cssText;return Fe(t)})(e):e;var{is:dm,defineProperty:cm,getOwnPropertyDescriptor:um,getOwnPropertyNames:pm,getOwnPropertySymbols:hm,getPrototypeOf:mm}=Object,wa=globalThis,Vl=wa.trustedTypes,fm=Vl?Vl.emptyScript:"",gm=wa.reactiveElementPolyfillSupport,$i=(e,n)=>e,Ci={toAttribute(e,n){switch(n){case Boolean:e=e?fm:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,n){let t=e;switch(n){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch{t=null}}return t}},ka=(e,n)=>!dm(e,n),Bl={attribute:!0,type:String,converter:Ci,reflect:!1,useDefault:!1,hasChanged:ka};Symbol.metadata??=Symbol("metadata"),wa.litPropertyMetadata??=new WeakMap;var $t=class extends HTMLElement{static addInitializer(n){this._$Ei(),(this.l??=[]).push(n)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(n,t=Bl){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(n)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(n,t),!t.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(n,i,t);a!==void 0&&cm(this.prototype,n,a)}}static getPropertyDescriptor(n,t,i){let{get:a,set:r}=um(this.prototype,n)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(n,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(n){return this.elementProperties.get(n)??Bl}static _$Ei(){if(this.hasOwnProperty($i("elementProperties")))return;let n=mm(this);n.finalize(),n.l!==void 0&&(this.l=[...n.l]),this.elementProperties=new Map(n.elementProperties)}static finalize(){if(this.hasOwnProperty($i("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty($i("properties"))){let t=this.properties,i=[...pm(t),...hm(t)];for(let a of i)this.createProperty(a,t[a])}let n=this[Symbol.metadata];if(n!==null){let t=litPropertyMetadata.get(n);if(t!==void 0)for(let[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(n){let t=[];if(Array.isArray(n)){let i=new Set(n.flat(1/0).reverse());for(let a of i)t.unshift(uo(a))}else n!==void 0&&t.push(uo(n));return t}static _$Eu(n,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof n=="string"?n.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(n=>n(this))}addController(n){(this._$EO??=new Set).add(n),this.renderRoot!==void 0&&this.isConnected&&n.hostConnected?.()}removeController(n){this._$EO?.delete(n)}_$E_(){let n=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(n.set(i,this[i]),delete this[i]);n.size>0&&(this._$Ep=n)}createRenderRoot(){let n=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ol(n,this.constructor.elementStyles),n}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(n=>n.hostConnected?.())}enableUpdating(n){}disconnectedCallback(){this._$EO?.forEach(n=>n.hostDisconnected?.())}attributeChangedCallback(n,t,i){this._$AK(n,i)}_$ET(n,t){let i=this.constructor.elementProperties.get(n),a=this.constructor._$Eu(n,i);if(a!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:Ci).toAttribute(t,i.type);this._$Em=n,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(n,t){let i=this.constructor,a=i._$Eh.get(n);if(a!==void 0&&this._$Em!==a){let r=i.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Ci;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(n,t,i,a=!1,r){if(n!==void 0){let o=this.constructor;if(a===!1&&(r=this[n]),i??=o.getPropertyOptions(n),!((i.hasChanged??ka)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(n)&&!this.hasAttribute(o._$Eu(n,i))))return;this.C(n,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(n,t,{useDefault:i,reflect:a,wrapped:r},o){i&&!(this._$Ej??=new Map).has(n)&&(this._$Ej.set(n,o??t??this[n]),r!==!0||o!==void 0)||(this._$AL.has(n)||(this.hasUpdated||i||(t=void 0),this._$AL.set(n,t)),a===!0&&this._$Em!==n&&(this._$Eq??=new Set).add(n))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let n=this.scheduleUpdate();return n!=null&&await n,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,r]of i){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let n=!1,t=this._$AL;try{n=this.shouldUpdate(t),n?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw n=!1,this._$EM(),i}n&&this._$AE(t)}willUpdate(n){}_$AE(n){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(n)),this.updated(n)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(n){return!0}update(n){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(n){}firstUpdated(n){}};$t.elementStyles=[],$t.shadowRootOptions={mode:"open"},$t[$i("elementProperties")]=new Map,$t[$i("finalized")]=new Map,gm?.({ReactiveElement:$t}),(wa.reactiveElementVersions??=[]).push("2.1.2");var ho=globalThis,Gl=e=>e,$a=ho.trustedTypes,Ul=$a?$a.createPolicy("lit-html",{createHTML:e=>e}):void 0,mo="$lit$",Ct=`lit$${Math.random().toFixed(9).slice(2)}$`,fo="?"+Ct,ym=`<${fo}>`,bn=document,Ti=()=>bn.createComment(""),Ei=e=>e===null||typeof e!="object"&&typeof e!="function",go=Array.isArray,Xl=e=>go(e)||typeof e?.[Symbol.iterator]=="function",po=`[ 	
\f\r]`,Si=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Kl=/-->/g,Wl=/>/g,gn=RegExp(`>|${po}(?:([^\\s"'>=/]+)(${po}*=${po}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),jl=/'/g,ql=/"/g,Jl=/^(?:script|style|textarea|title)$/i,yo=e=>(n,...t)=>({_$litType$:e,strings:n,values:t}),h=yo(1),v=yo(2),Yv=yo(3),St=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Yl=new WeakMap,yn=bn.createTreeWalker(bn,129);function Zl(e,n){if(!go(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ul!==void 0?Ul.createHTML(n):n}var Ql=(e,n)=>{let t=e.length-1,i=[],a,r=n===2?"<svg>":n===3?"<math>":"",o=Si;for(let s=0;s<t;s++){let l=e[s],d,c,u=-1,p=0;for(;p<l.length&&(o.lastIndex=p,c=o.exec(l),c!==null);)p=o.lastIndex,o===Si?c[1]==="!--"?o=Kl:c[1]!==void 0?o=Wl:c[2]!==void 0?(Jl.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=gn):c[3]!==void 0&&(o=gn):o===gn?c[0]===">"?(o=a??Si,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?gn:c[3]==='"'?ql:jl):o===ql||o===jl?o=gn:o===Kl||o===Wl?o=Si:(o=gn,a=void 0);let m=o===gn&&e[s+1].startsWith("/>")?" ":"";r+=o===Si?l+ym:u>=0?(i.push(d),l.slice(0,u)+mo+l.slice(u)+Ct+m):l+Ct+(u===-2?s:m)}return[Zl(e,r+(e[t]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),i]},Mi=class e{constructor({strings:n,_$litType$:t},i){let a;this.parts=[];let r=0,o=0,s=n.length-1,l=this.parts,[d,c]=Ql(n,t);if(this.el=e.createElement(d,i),yn.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=yn.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(mo)){let p=c[o++],m=a.getAttribute(u).split(Ct),g=/([.?@])?(.*)/.exec(p);l.push({type:1,index:r,name:g[2],strings:m,ctor:g[1]==="."?Sa:g[1]==="?"?Ta:g[1]==="@"?Ea:vn}),a.removeAttribute(u)}else u.startsWith(Ct)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(Jl.test(a.tagName)){let u=a.textContent.split(Ct),p=u.length-1;if(p>0){a.textContent=$a?$a.emptyScript:"";for(let m=0;m<p;m++)a.append(u[m],Ti()),yn.nextNode(),l.push({type:2,index:++r});a.append(u[p],Ti())}}}else if(a.nodeType===8)if(a.data===fo)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(Ct,u+1))!==-1;)l.push({type:7,index:r}),u+=Ct.length-1}r++}}static createElement(n,t){let i=bn.createElement("template");return i.innerHTML=n,i}};function xn(e,n,t=e,i){if(n===St)return n;let a=i!==void 0?t._$Co?.[i]:t._$Cl,r=Ei(n)?void 0:n._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(e),a._$AT(e,t,i)),i!==void 0?(t._$Co??=[])[i]=a:t._$Cl=a),a!==void 0&&(n=xn(e,a._$AS(e,n.values),a,i)),n}var Ca=class{constructor(n,t){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:t},parts:i}=this._$AD,a=(n?.creationScope??bn).importNode(t,!0);yn.currentNode=a;let r=yn.nextNode(),o=0,s=0,l=i[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new ni(r,r.nextSibling,this,n):l.type===1?d=new l.ctor(r,l.name,l.strings,this,n):l.type===6&&(d=new Ma(r,this,n)),this._$AV.push(d),l=i[++s]}o!==l?.index&&(r=yn.nextNode(),o++)}return yn.currentNode=bn,a}p(n){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(n,i,t),t+=i.strings.length-2):i._$AI(n[t])),t++}},ni=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,t,i,a){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=n,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,t=this._$AM;return t!==void 0&&n?.nodeType===11&&(n=t.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,t=this){n=xn(this,n,t),Ei(n)?n===f||n==null||n===""?(this._$AH!==f&&this._$AR(),this._$AH=f):n!==this._$AH&&n!==St&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):Xl(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==f&&Ei(this._$AH)?this._$AA.nextSibling.data=n:this.T(bn.createTextNode(n)),this._$AH=n}$(n){let{values:t,_$litType$:i}=n,a=typeof i=="number"?this._$AC(n):(i.el===void 0&&(i.el=Mi.createElement(Zl(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Ca(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(n){let t=Yl.get(n.strings);return t===void 0&&Yl.set(n.strings,t=new Mi(n)),t}k(n){go(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,a=0;for(let r of n)a===t.length?t.push(i=new e(this.O(Ti()),this.O(Ti()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(n=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);n!==this._$AB;){let i=Gl(n).nextSibling;Gl(n).remove(),n=i}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},vn=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,t,i,a,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=n,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}_$AI(n,t=this,i,a){let r=this.strings,o=!1;if(r===void 0)n=xn(this,n,t,0),o=!Ei(n)||n!==this._$AH&&n!==St,o&&(this._$AH=n);else{let s=n,l,d;for(n=r[0],l=0;l<r.length-1;l++)d=xn(this,s[i+l],t,l),d===St&&(d=this._$AH[l]),o||=!Ei(d)||d!==this._$AH[l],d===f?n=f:n!==f&&(n+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(n)}j(n){n===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},Sa=class extends vn{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===f?void 0:n}},Ta=class extends vn{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==f)}},Ea=class extends vn{constructor(n,t,i,a,r){super(n,t,i,a,r),this.type=5}_$AI(n,t=this){if((n=xn(this,n,t,0)??f)===St)return;let i=this._$AH,a=n===f&&i!==f||n.capture!==i.capture||n.once!==i.once||n.passive!==i.passive,r=n!==f&&(i===f||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},Ma=class{constructor(n,t,i){this.element=n,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(n){xn(this,n)}},ed={M:mo,P:Ct,A:fo,C:1,L:Ql,R:Ca,D:Xl,V:xn,I:ni,H:vn,N:Ta,U:Ea,B:Sa,F:Ma},bm=ho.litHtmlPolyfillSupport;bm?.(Mi,ni),(ho.litHtmlVersions??=[]).push("3.3.3");var td=(e,n,t)=>{let i=t?.renderBefore??n,a=i._$litPart$;if(a===void 0){let r=t?.renderBefore??null;i._$litPart$=a=new ni(n.insertBefore(Ti(),r),r,void 0,t??{})}return a._$AI(e),a};var bo=globalThis,Bt=class extends $t{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=td(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return St}};Bt._$litElement$=!0,Bt.finalized=!0,bo.litElementHydrateSupport?.({LitElement:Bt});var xm=bo.litElementPolyfillSupport;xm?.({LitElement:Bt});(bo.litElementVersions??=[]).push("4.2.2");var vm={attribute:!0,type:String,converter:Ci,reflect:!1,hasChanged:ka},wm=(e=vm,n,t)=>{let{kind:i,metadata:a}=t,r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(t.name,e),i==="accessor"){let{name:o}=t;return{set(s){let l=n.get.call(this);n.set.call(this,s),this.requestUpdate(o,l,e,!0,s)},init(s){return s!==void 0&&this.C(o,void 0,e,s),s}}}if(i==="setter"){let{name:o}=t;return function(s){let l=this[o];n.call(this,s),this.requestUpdate(o,l,e,!0,s)}}throw Error("Unsupported decorator location: "+i)};function ii(e){return(n,t)=>typeof t=="object"?wm(e,n,t):((i,a,r)=>{let o=a.hasOwnProperty(r);return a.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(a,r):void 0})(e,n,t)}function G(e){return ii({...e,state:!0,attribute:!1})}var it="wrist_assistant/complications";async function nd(e){return e.connection.sendMessagePromise({type:`${it}/owners`})}async function id(e,n){return e.connection.sendMessagePromise({type:`${it}/list`,owner_watch_id:n})}async function ad(e,n){return e.connection.sendMessagePromise({type:`${it}/nudge`,owner_watch_id:n})}async function rd(e,n){return e.connection.sendMessagePromise({type:`${it}/watch_status`,owner_watch_id:n})}async function od(e,n,t,i){return e.connection.sendMessagePromise({type:`${it}/save`,owner_watch_id:n,document:t,base_revision:i})}async function sd(e,n,t,i){return e.connection.sendMessagePromise({type:`${it}/delete`,owner_watch_id:n,complication_id:t,base_revision:i})}async function ld(e,n,t){return e.connection.sendMessagePromise({type:`${it}/move_owner`,source_owner_watch_id:n,target_owner_watch_id:t})}function dd(e,n,t){let i={type:`${it}/subscribe`};return n&&(i.owner_watch_id=n),e.connection.subscribeMessage(t,i)}async function cd(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${it}/render_values`,templates:n})).results}async function ud(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${it}/history_series`,requests:n})).results}function pd(e){return{entity_id:e.entityId,minutes:e.minutes,points:e.points,...e.mode==="states"?{mode:"states"}:{},...e.gaps?{gaps:!0}:{}}}function hd(e){return{entity_id:e.entityId,minutes:e.minutes,period:e.period,type:e.type,...e.gaps?{gaps:!0}:{}}}function md(e){let n=new Map,t=new Map;for(let[i,a]of Object.entries(e))a.ok&&(n.set(i,a.series),typeof a.readings=="number"&&t.set(i,{readings:a.readings,averaged:a.averaged===!0}));return{series:n,readings:t}}async function fd(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${it}/statistics_series`,requests:n})).results}var oe=["rectangular","circular","corner"],pe={rectangular:{width:181,height:65.5},circular:{width:51,height:51},corner:{width:34,height:34}},Fi=["rectangular","circular","corner","inline"];var So=64;function Ad(e,n){let t=new Set(e);for(let i of n)t.add(i.slot);for(let i=0;i<So;i++)if(!t.has(i))return i;return-1}function Hd(e,n){let t=new Set(e);return n.filter(i=>i.kind!=="preset"||!t.has(i.slot))}function Sn(e){return oe.some(t=>!e.supportedFamilies.includes(t))||e.supportedFamilies.includes("inline")||e.inline!==void 0?6:e.slotIndex>7?5:4}var km=["none","dot","triangle"],$m=["straight","smooth","step"],Cm=["light","medium","strong"],Sm={light:.05,medium:.1,strong:.2};function gd(e){return typeof e=="string"&&$m.includes(e)?e:"straight"}var Tm=["flat","fade"],Em=["none","all","auto"],Id=4,Mt="#FFFFFF33";function Wt(e){return typeof e=="string"&&Tm.includes(e)?e:"flat"}function $o(e){return typeof e=="string"&&Em.includes(e)?e:"none"}function Co(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(Id,Math.round(e)))}function Ld(e,n){return e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function Gt(e){return typeof e=="string"&&e!==""?e:Mt}var Mm=1,Rm=12;function pt(e){if(!(typeof e!="number"||!Number.isFinite(e)))return Math.max(Mm,Math.min(Rm,e))}function za(e){return e==="all"?"all":"auto"}var Yt=1,Xt=3,Pa=.25,Na=4;function Tn(e){return typeof e!="number"||!Number.isFinite(e)?Xt:Math.max(1,Math.min(Id,Math.round(e)))}function En(e){return typeof e!="number"||!Number.isFinite(e)?Yt:Math.max(Pa,Math.min(Na,e))}var Fm=["all","top"],ai=1.2;function jt(e){return typeof e!="number"||!Number.isFinite(e)?ai:Math.max(0,e)}function qt(e){return typeof e=="string"&&Fm.includes(e)?e:"all"}function at(e){if(typeof e=="string")return Cm.includes(e)?e:void 0;if(e===3||e===5)return"light";if(e===7)return"medium";if(e===9)return"strong"}function _d(e,n){if(n===void 0||e<2)return 0;let t=Math.max(3,Math.floor(e*Sm[n]+.5));return t%2===0?t+1:t}var Am=[["history","Recorded history"],["statistics","Long-term statistics"]],Da=[["5minute","5 min"],["hour","Hour"],["day","Day"],["week","Week"],["month","Month"]],To=[["mean","Mean"],["min","Min"],["max","Max"],["change","Change"],["sum","Total"]],Eo="history",Li="hour",_i="mean",Rt=[["latest","Newest reading"],["first","First reading"],["highest","Highest reading"],["lowest","Lowest reading"],["average","Average reading"],["delta","Change"],["sum","Total"],["trend","Trend arrow"],["top","Top of the scale"],["bottom","Bottom of the scale"]],zi={x:.25,y:.25,width:.5,height:.5,rotationDegrees:0},mt=[["highest","Highest reading"],["lowest","Lowest reading"],["now","Now"],["first","First reading"],["latest","Newest reading"],["threshold","Threshold"],["zero","Zero"]];function ft(e){return e!=="threshold"&&e!=="zero"}var Oa=[["above","Above"],["on","On"],["below","Inside"],["bottom","At the bottom"],["through","Through"]];function Hm(e){return mt.some(([n])=>n===e)}function Im(e){return Oa.some(([n])=>n===e)}function Lm(e){if(!P(e)||typeof e.layer!="string"||e.layer==="")return;let n={layer:e.layer.toUpperCase(),at:Hm(e.at)?e.at:"highest",place:Im(e.place)?e.place:"above"},t=X(e.dx,0),i=X(e.dy,0);return t!==0&&(n.dx=t),i!==0&&(n.dy=i),n}function Fa(e,n){let t=Lm(e.chartAnchor);t!==void 0&&(n.chartAnchor=t)}function Aa(e,n){e.chartAnchor!==void 0&&(n.chartAnchor=_m(e.chartAnchor))}function _m(e){let n={layer:e.layer,at:e.at,place:e.place};return e.dx!==void 0&&e.dx!==0&&(n.dx=Y(e.dx)),e.dy!==void 0&&e.dy!==0&&(n.dy=Y(e.dy)),n}var Pe={setColor:"color",setOpacity:"opacity",setText:"text",setIcon:"icon",setFontSize:"fontSize",setFontWeight:"fontWeight",setRotation:"rotation",hide:"visibility",show:"visibility",setGaugeValue:"gaugeValue",setGaugeMin:"gaugeMin",setGaugeMax:"gaugeMax",setBorderColor:"borderColor",setBorderWidth:"borderWidth",setBackgroundColor:"backgroundColor"};function zd(e){return e.countdown===!0?!1:e.coloring==="bands"&&(e.bands?.length??0)>0||e.highlight!==void 0&&e.highlight!=="none"}function rt(e){return e.countdown!==!0&&(e.parts?.length??0)>0}function Mn(e){if(e.kind.kind==="literal")return(e.format?.prefix??"")+e.kind.value+(e.format?.suffix??"")}function Pi(e){let n=c=>c.value.kind.kind!=="literal",t=(c,u)=>e.slice(c,u).map(p=>Mn(p.value)??"").join(""),i=e.findIndex(n);if(i<0)return L(t(0,e.length));let a=e.findIndex((c,u)=>u>i&&n(c)),r=e[i].value,o={...r.format},s=t(0,i)+(o.prefix??""),l=(o.suffix??"")+t(i+1,a<0?e.length:a);delete o.prefix,delete o.suffix,s!==""&&(o.prefix=s),l!==""&&(o.suffix=l);let d={kind:structuredClone(r.kind)};return Ie(o)||(d.format=o),d}function Pd(e){rt(e)&&(e.value=Pi(e.parts))}var ri="#FFFFFF";function yd(e){return typeof e=="string"&&km.includes(e)}function zm(e){return e==="none"?{high:"none",low:"none"}:e==="pointer"?{high:"triangle",low:"dot"}:{high:"dot",low:"dot"}}function Hi(e){let n=zm(e.marker);return{high:e.highMarker??n.high,low:e.lowMarker??n.low}}function Nd(e){return e.high==="triangle"?"pointer":e.high!=="none"||e.low!=="none"?"dot":"none"}function Dd(e){return e.high==="none"&&e.low==="none"||e.high==="dot"&&e.low==="dot"||e.high==="triangle"&&e.low==="dot"}function Pm(e,n){e.marker=Nd(n),Dd(n)?(delete e.highMarker,delete e.lowMarker):(e.highMarker=n.high,e.lowMarker=n.low)}var Va=24,Ze="#FF6B35",Qe="#32D74B",Mo="#32D74B",le="#FF453A",Ro="#FF453A",Fo="#FFFFFF99";function Jt(e){return[...e.bands].sort((n,t)=>n.upTo-t.upTo)}function Od(e){return e.coloring==="bands"&&e.bands.length>0}function Ba(e,n,t){for(let i of n)if(e<=i.upTo)return i.colorHex;return t}function Ao(e,n){let t=Math.abs(n),i=t>=10?0:t>=1?1:2;return e.toFixed(i)}function Vd(e){return e>0?"\u2191":e<0?"\u2193":"\u2192"}var Rn=[{minutes:60,label:"Last hour"},{minutes:180,label:"Last 3 hours"},{minutes:360,label:"Last 6 hours"},{minutes:720,label:"Last 12 hours"},{minutes:1440,label:"Last 24 hours"},{minutes:4320,label:"Last 3 days"},{minutes:10080,label:"Last 7 days"}],Ga=360,Ua=10080,Ni=[...Rn,{minutes:43200,label:"Last 30 days"},{minutes:129600,label:"Last 90 days"},{minutes:527040,label:"Last year"}],Ho=366*24*60,Ka=2,Ft=120,Io=0;function Lo(e){let n=Math.round(e.historyPoints);return Number.isFinite(n)?n<1?Io:Math.max(Ka,Math.min(Ft,n)):24}function Fn(e){return zo(e)!==void 0?!0:_o(e)!==void 0&&Lo(e)>0}function _o(e){if(e.source==="history")return Bd(e)}function zo(e){if(e.source==="statistics")return Bd(e)}function Bd(e){if(!(e.historyMinutes<=0))return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function An(e){let n=_o(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${Lo(e)}${e.gaps===!0?"|gaps":""}`}function Hn(e){let n=zo(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${e.statPeriod}|${e.statType}${e.gaps===!0?"|gaps":""}`}function Gd(e){return[...Po(e).map(t=>t.key),...No(e).map(t=>t.key)].sort().join(";")}function Po(e){let n=new Map,t=i=>{n.has(i.key)||n.set(i.key,i)};for(let i of e.elements)if(i.kind==="chart"){let a=An(i.payload),r=_o(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:Math.round(i.payload.historyMinutes),points:Lo(i.payload),mode:"numeric",gaps:i.payload.gaps===!0})}else if(i.kind==="timeline"){let a=gt(i.payload),r=Yd(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:ot(i.payload),points:tn,mode:"states",gaps:!1})}return[...n.values()]}function No(e){let n=new Map;for(let t of e.elements){if(t.kind!=="chart")continue;let i=Hn(t.payload),a=zo(t.payload);i===void 0||a===void 0||n.has(i)||n.set(i,{key:i,entityId:a,minutes:Math.round(t.payload.historyMinutes),period:t.payload.statPeriod,type:t.payload.statType,gaps:t.payload.gaps===!0})}return[...n.values()]}var Ud=[["auto","Auto"],["h12","12 hour"],["h24","24 hour"]],Kd=[["auto","Auto"],["always","Always"],["never","Never"]];function xo(e){return e==="h12"||e==="h24"?e:kn}function vo(e){return e==="always"||e==="never"?e:$n}function Nm(e){return e.timeLabelCount!==void 0?ht(e.timeLabelCount):e.timeLabels==="ends"?2:e.timeLabels==="four"?4:wn}function ht(e){let n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(In,Math.round(n))):wn}function Di(e){return e<=0?[]:e===1?[1]:Array.from({length:e},(n,t)=>t/(e-1))}var Zt="#8E8E93",Wd=1,Dm="#000000",Om=2,Vm=1440,Do=60,wn=0,et=9,tt="#8E8E93",kn="auto",$n="auto",jd=4,In=12,Qt=1,en=20,Wa=4,tn=120;function qd(e,n,t){let i=e.trim().toLowerCase();for(let a of n)if(a.match.trim().toLowerCase()===i)return a.colorHex;return t}function ot(e){let n=Math.round(e.historyMinutes);return Number.isFinite(n)?Math.max(1,Math.min(Ua,n)):Do}function Yd(e){return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function gt(e){let n=Yd(e);if(n!==void 0)return`${n}|${ot(e)}|${tn}|states`}var Bm={on:"#FF9F0A",off:"#0A84FF",open:"#FF453A",closed:"#32D74B",opening:"#FFD60A",closing:"#FFD60A",home:"#32D74B",not_home:"#0A84FF",locked:"#32D74B",unlocked:"#FF453A",jammed:"#BF5AF2",playing:"#32D74B",paused:"#FF9F0A",idle:"#0A84FF",standby:"#5E5CE6",heat:"#FF9F0A",cool:"#64D2FF",heat_cool:"#BF5AF2",dry:"#FFD60A",fan_only:"#5E5CE6",auto:"#BF5AF2",cleaning:"#32D74B",docked:"#0A84FF",returning:"#64D2FF",error:"#FF453A",disarmed:"#32D74B",armed_home:"#0A84FF",armed_away:"#FF9F0A",armed_night:"#5E5CE6",arming:"#FFD60A",pending:"#FFD60A",triggered:"#FF453A",unavailable:"#48484A",unknown:"#48484A"},Oi={binary_sensor:["on","off"],switch:["on","off"],light:["on","off"],input_boolean:["on","off"],fan:["on","off"],humidifier:["on","off"],siren:["on","off"],cover:["open","closed","opening","closing"],lock:["locked","unlocked","jammed"],person:["home","not_home"],device_tracker:["home","not_home"],media_player:["playing","paused","idle","off"],climate:["heat","cool","heat_cool","dry","fan_only","auto","off"],vacuum:["cleaning","docked","returning","idle","error"],alarm_control_panel:["disarmed","armed_home","armed_away","armed_night","arming","pending","triggered"]};function Ha(e){return Bm[e.trim().toLowerCase()]??Zt}var Gm=["door","garage_door","window","opening"];function Oo(e,n){let t=(n??"").trim().toLowerCase(),i=e==="binary_sensor"&&Gm.includes(t),a=o=>Ha(i&&o==="on"?"open":o);return[...Oi[e]??[],"unavailable","unknown"].map(o=>({id:J(),match:o,colorHex:a(o)}))}var oi=6,ja=9,Um=["topLeading","topTrailing","bottomLeading","bottomTrailing"];function qa(e){return Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY)}function Km(e,n){let t=n<=.5,i=e<=.5;return t?i?"topLeading":"topTrailing":i?"bottomLeading":"bottomTrailing"}var Vo={top:0,left:0,bottom:0,right:0};function Ya(e){return e===void 0||e.top===0&&e.left===0&&e.bottom===0&&e.right===0}var Wm=["toggleEntity","runScene","runScript","addTodo","runHTTPAction"];function Xd(e){return Wm.includes(e)}function Jd(e){let n=(e??"").trim();if(n==="")return!0;try{let t=JSON.parse(n);return typeof t=="object"&&t!==null&&!Array.isArray(t)}catch{return!1}}var Bo=[["refresh","Refresh"],["none","Nothing"],["openApp","Open the app"],["openPage","Open the page"],["openRoomPage","Open the room page"],["timerStartPause","Timer start / pause"],["timerCancel","Timer cancel"],["toggleEntity","Toggle an entity"],["runScene","Run a scene"],["runScript","Run a script"],["addTodo","Add a to-do"],["runHTTPAction","Run an HTTP action"],["callService","Call a service"]];function At(e){let n=Bo.find(([i])=>i===e.type)?.[1]??e.type;if(e.type==="callService"){let i=[e.serviceDomain,e.serviceName].filter(a=>a!=="").join(".");return i===""?n:`${n}: ${i}`}if(!("entityId"in e))return n;let t=e.displayName||e.entityId;return t?`${n}: ${t}`:n}function P(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function W(e,n=""){return typeof e=="string"?e:n}function X(e,n){return typeof e=="number"?e:e==="+inf"?1/0:e==="-inf"?-1/0:e==="nan"?NaN:n}function ut(e){return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}function Ai(e){return e==null?void 0:X(e,0)}function ue(e){return typeof e=="string"?e:void 0}function wo(e,n,t){return n.some(([i])=>i===e)?e:t}var nt=class extends Error{};function Ut(e){if(typeof e.entityId!="string")throw new nt("entityId is required");let n={entityId:e.entityId,displayName:W(e.displayName),domain:W(e.domain)};return typeof e.iconName=="string"&&(n.iconName=e.iconName),n}function bd(e){if(!P(e))return;let n={};return e.decimals!==void 0&&e.decimals!==null&&(n.decimals=X(e.decimals,0)),e.multiply!==void 0&&e.multiply!==null&&(n.multiply=X(e.multiply,1)),e.offset!==void 0&&e.offset!==null&&(n.offset=X(e.offset,0)),typeof e.prefix=="string"&&(n.prefix=e.prefix),typeof e.suffix=="string"&&(n.suffix=e.suffix),e.useEntityUnit===!0&&(n.useEntityUnit=!0),e.relativeTime===!0&&(n.relativeTime=!0),e.duration===!0&&(n.duration=!0),(e.textCase==="upper"||e.textCase==="lower"||e.textCase==="capitalized")&&(n.textCase=e.textCase),Ie(n)?void 0:n}function Ie(e){return e?e.decimals===void 0&&e.multiply===void 0&&e.offset===void 0&&!e.prefix&&!e.suffix&&!e.useEntityUnit&&!e.relativeTime&&!e.duration&&e.textCase===void 0:!0}function jm(e){let n=W(e.function,"count"),t=P(e.scope)?e.scope:{},i;if(t.kind==="entities")i={kind:"entities",entities:(Array.isArray(t.entities)?t.entities:[]).filter(P).map(Ut)};else{let r=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[];i={kind:"filter",domains:r(t.domains),areaIds:r(t.areaIds),labelIds:r(t.labelIds),floorIds:r(t.floorIds)}}let a={function:n,scope:i};if(P(e.stateFilter)){let r=e.stateFilter.kind;r==="isOn"||r==="isOff"?a.stateFilter={kind:r}:(r==="equals"||r==="notEquals")&&(a.stateFilter={kind:r,value:W(e.stateFilter.value)})}return typeof e.attribute=="string"&&(a.attribute=e.attribute),a}function xd(e){switch(e.kind){case"literal":return{kind:"literal",value:W(e.value)};case"entityState":return{kind:"entityState",...Ut(e)};case"entityAttribute":return{kind:"entityAttribute",...Ut(e),attribute:W(e.attribute)};case"entityAge":return{kind:"entityAge",...Ut(e)};case"aggregate":return{kind:"aggregate",aggregate:jm(P(e.aggregate)?e.aggregate:{})};case"time":return{kind:"time",timeField:ue(e.timeField)??"now"};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:W(e.value)};case"named":return{kind:"named",id:W(e.id).toUpperCase()};case"chartStat":return{kind:"chartStat",layer:W(e.layer).toUpperCase(),stat:Rt.some(([n])=>n===e.stat)?e.stat:"latest"};default:throw new nt(`unknown value kind ${String(e.kind)}`)}}function ge(e){if(!P(e))throw new nt("value must be an object");if(P(e.kind)){let i={kind:xd(e.kind)},a=bd(e.format);return a&&(i.format=a),i}let n={kind:xd(e)},t=bd(e.format);return t&&(n.format=t),n}function Zd(e){return P(e)?{x:X(e.x,.25),y:X(e.y,.25),width:X(e.width,.5),height:X(e.height,.5),rotationDegrees:X(e.rotationDegrees,0)}:{...zi}}function qm(e){if(!P(e))return{kind:"isOn"};let n=W(e.kind,"isOn"),t={kind:n};switch(n){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":t.value=P(e.value)?ge(e.value):L("");break;case"between":case"timeBetween":t.value=P(e.value)?ge(e.value):L(""),t.upper=P(e.upper)?ge(e.upper):L("");break;case"matchesRegex":t.pattern=W(e.pattern);break;case"isOneOf":t.options=Array.isArray(e.options)?e.options.filter(i=>typeof i=="string"):[];break;default:break}return t}function vd(e){if(!P(e))return{kind:"show"};let n=W(e.kind,"show"),t={kind:n};switch(n){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":t.value=P(e.value)?ge(e.value):L("");break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":t.number=X(e.number,0);break;case"setFontWeight":t.weight=ue(e.weight)??"regular";break;default:break}return t}function Qd(e){return Array.isArray(e)?e.filter(P).map(n=>{let t={id:W(n.id).toUpperCase(),cases:(Array.isArray(n.cases)?n.cases:[]).filter(P).map(i=>{let a=P(i.when)?i.when:{};return{id:W(i.id).toUpperCase(),when:{join:a.join==="any"?"any":"all",tests:(Array.isArray(a.tests)?a.tests:[]).filter(P).map(r=>({id:W(r.id).toUpperCase(),value:P(r.value)?ge(r.value):L(""),comparison:qm(r.comparison)}))},then:(Array.isArray(i.then)?i.then:[]).map(vd)}})};return Array.isArray(n.otherwise)&&(t.otherwise=n.otherwise.map(vd)),typeof n.partId=="string"&&n.partId!==""&&(t.partId=n.partId.toUpperCase()),t}):[]}function Ym(e,n){return{baseColorHex:P(e)?W(e.baseColorHex,n):n}}function Ia(e){return Array.isArray(e)?e.filter(P).map(n=>({id:W(n.id,J()),upTo:X(n.upTo,0),colorHex:W(n.colorHex,"#FFFFFF")})):[]}function Xm(e){return Array.isArray(e)?e.filter(P).map(n=>{let t={id:W(n.id,J()).toUpperCase(),value:P(n.value)?ge(n.value):L("")};typeof n.colorHex=="string"&&(t.colorHex=n.colorHex);let i=ue(n.fontWeight);(i==="regular"||i==="medium"||i==="semibold"||i==="bold")&&(t.fontWeight=i),typeof n.fontSize=="number"&&(t.fontSize=n.fontSize),ue(n.coloring)==="bands"&&(t.coloring="bands");let a=Ia(n.bands);a.length>0&&(t.bands=a);let r=W(n.bandAboveColorHex,le);return r!==le&&(t.bandAboveColorHex=r),t}):[]}function Jm(e){if(Array.isArray(e.bands))return Ia(e.bands);if(typeof e.bandLowerBound!="number")return[];let n=P(e.colorSlot)?W(e.colorSlot.baseColorHex,"#FFFFFF"):"#FFFFFF";return[{id:J(),upTo:e.bandLowerBound,colorHex:W(e.bandLowColorHex,Mo)},{id:J(),upTo:X(e.bandUpperBound,100),colorHex:n}]}function Zm(e){return Array.isArray(e)?e.filter(P).map(n=>({id:W(n.id,J()).toUpperCase(),match:W(n.match,""),colorHex:W(n.colorHex,Zt)})):[]}function Je(e,n){if(typeof e.id!="string")throw new nt("element id is required");return{id:e.id.toUpperCase(),colorSlot:Ym(e.colorSlot,n),rules:Qd(e.rules),frame:Zd(e.frame),isHidden:e.isHidden===!0}}function Qm(e){let n=ef(e),t=e.payload;return typeof t.groupId=="string"&&t.groupId!==""&&(n.payload.groupId=t.groupId.toUpperCase()),typeof t.name=="string"&&t.name!==""&&(n.payload.name=t.name),n}function ef(e){if(!P(e)||!P(e.payload))throw new nt("element must have a payload");let n=e.payload;switch(e.kind){case"text":{let t={...Je(n,"#FFFFFF"),value:P(n.value)?ge(n.value):L(""),fontSize:X(n.fontSize,14),fontWeight:ue(n.fontWeight)??"regular"};n.countdown===!0&&(t.countdown=!0),n.monospacedDigits===!0&&(t.monospacedDigits=!0);let i=typeof n.lineLimit=="number"?Math.round(n.lineLimit):1;Math.min(2,Math.max(1,i))===2&&(t.lineLimit=2);let a=ue(n.alignment);(a==="leading"||a==="trailing")&&(t.alignment=a),ue(n.coloring)==="bands"&&(t.coloring="bands");let r=Ia(n.bands);r.length>0&&(t.bands=r);let o=W(n.bandAboveColorHex,le);o!==le&&(t.bandAboveColorHex=o);let s=ue(n.highlight);(s==="highest"||s==="lowest"||s==="both")&&(t.highlight=s);let l=W(n.highColorHex,Ze);l!==Ze&&(t.highColorHex=l);let d=W(n.lowColorHex,Qe);d!==Qe&&(t.lowColorHex=d);let c=Xm(n.parts);return c.length>0&&(t.parts=c),Fa(n,t),{kind:"text",payload:t}}case"icon":{let t={...Je(n,"#FFFFFF"),symbol:P(n.symbol)?ge(n.symbol):L("lightbulb"),size:X(n.size,14)},i=ue(n.path);return i!==void 0&&i!==""&&(t.path=i),Fa(n,t),{kind:"icon",payload:t}}case"gauge":{let t={...Je(n,"#FFFFFF"),value:P(n.value)?ge(n.value):L("50"),minValue:X(n.minValue,0),maxValue:X(n.maxValue,100),style:ue(n.style)??"arc",lineWidth:X(n.lineWidth,4),trackColorHex:W(n.trackColorHex,"#FFFFFF40"),coloring:ue(n.coloring)??"uniform",bands:Ia(n.bands),bandAboveColorHex:W(n.bandAboveColorHex,le),thresholdColorHex:W(n.thresholdColorHex,ri)},i=Ai(n.thresholdValue);return i!==void 0&&(t.thresholdValue=i),P(n.total)&&(t.total=ge(n.total)),P(n.minSource)&&(t.minSource=ge(n.minSource)),P(n.maxSource)&&(t.maxSource=ge(n.maxSource)),{kind:"gauge",payload:t}}case"chart":return{kind:"chart",payload:{...Je(n,"#FFFFFF"),value:P(n.value)?ge(n.value):L("13,14,16,17,19,22,24,28,30"),historyMinutes:Math.max(0,Math.round(X(n.historyMinutes,0))),historyPoints:Math.round(X(n.historyPoints,24)),source:wo(ue(n.source),Am,Eo),statPeriod:wo(ue(n.statPeriod),Da,Li),statType:wo(ue(n.statType),To,_i),style:ue(n.style)??"bars",limit:Math.max(0,Math.round(X(n.limit,0))),takeFromEnd:n.takeFromEnd===!0,scale:ue(n.scale)??"auto",minValue:X(n.minValue,0),maxValue:X(n.maxValue,100),baseline:ue(n.baseline)??"lowest",barGap:X(n.barGap,1.5),lineWidth:X(n.lineWidth,2),highlight:ue(n.highlight)??"none",highColorHex:W(n.highColorHex,Ze),lowColorHex:W(n.lowColorHex,Qe),marker:ue(n.marker)??"pointer",...yd(n.highMarker)?{highMarker:n.highMarker}:{},...yd(n.lowMarker)?{lowMarker:n.lowMarker}:{},coloring:ue(n.coloring)??"uniform",bands:Jm(n),bandAboveColorHex:W(n.bandHighColorHex,W(n.bandAboveColorHex,le)),fillBands:n.fillBands===!0,...gd(n.curve)!=="straight"?{curve:gd(n.curve)}:{},...Wt(n.fillStyle)!=="flat"?{fillStyle:Wt(n.fillStyle)}:{},...typeof n.fillColorHex=="string"?{fillColorHex:n.fillColorHex}:{},...jt(n.barRadius)!==ai?{barRadius:jt(n.barRadius)}:{},...qt(n.barCorners)!=="all"?{barCorners:qt(n.barCorners)}:{},...$o(n.pointDots)!=="none"?{pointDots:$o(n.pointDots)}:{},...pt(n.pointDotSize)!==void 0?{pointDotSize:pt(n.pointDotSize)}:{},...typeof n.pointDotColorHex=="string"?{pointDotColorHex:n.pointDotColorHex}:{},...Co(n.gridLines)!==0?{gridLines:Co(n.gridLines)}:{},...Ld(Gt(n.gridColorHex),Mt)?{}:{gridColorHex:Gt(n.gridColorHex)},...n.zeroLine===!0?{zeroLine:!0}:{},...at(n.smoothing)!==void 0?{smoothing:at(n.smoothing)}:{},...n.gaps===!0?{gaps:!0}:{},...typeof n.thresholdValue=="number"&&Number.isFinite(n.thresholdValue)?{thresholdValue:n.thresholdValue}:{},thresholdColorHex:W(n.thresholdColorHex,Ro),...P(n.nowIndex)?{nowIndex:ge(n.nowIndex)}:{},nowColorHex:W(n.nowColorHex,Fo),...n.drawsThreshold===!1?{drawsThreshold:!1}:{},...n.drawsNowLine===!1?{drawsNowLine:!1}:{},...n.drawsTimeLabels===!1?{drawsTimeLabels:!1}:{},...ue(n.scaleFrom)!==void 0?{scaleFrom:ue(n.scaleFrom)}:{},timeLabelCount:ht(n.timeLabelCount),labelSize:X(n.labelSize,et),labelColorHex:W(n.labelColorHex,tt),labelsAbove:n.labelsAbove===!0,hourCycle:xo(n.hourCycle),minutes:vo(n.minutes)}};case"timeline":{let{colorSlot:t,...i}=Je(n,"#FFFFFF");return{kind:"timeline",payload:{...i,value:P(n.value)?ge(n.value):L(""),historyMinutes:Math.max(1,Math.round(X(n.historyMinutes,Do))),bands:Zm(n.bands),otherColorHex:W(n.otherColorHex,Zt),gap:Math.min(Wa,Math.max(0,X(n.gap,0))),cornerRadius:Math.max(0,X(n.cornerRadius,Wd)),timeLabelCount:Nm(n),labelSize:X(n.labelSize,et),labelColorHex:W(n.labelColorHex,tt),labelsAbove:n.labelsAbove===!0,hourCycle:xo(n.hourCycle),minutes:vo(n.minutes),...n.drawsTimeLabels===!1?{drawsTimeLabels:!1}:{}}}}case"shape":{let t={...Je(n,"#FFFFFF33"),kind:ue(n.kind)??"roundedRectangle",cornerRadius:X(n.cornerRadius,6),thickness:X(n.thickness,1),borderWidth:X(n.borderWidth,1)};return typeof n.borderColorHex=="string"&&(t.borderColorHex=n.borderColorHex),Fa(n,t),{kind:"shape",payload:t}}case"image":{let{colorSlot:t,...i}=Je(n,"#FFFFFF"),a={...i,entity:Ut(P(n.entity)?n.entity:{}),source:n.source==="entityPicture"?"entityPicture":"camera",contentMode:n.contentMode==="fit"?"fit":"fill",zoom:X(n.zoom,1),panX:X(n.panX,0),panY:X(n.panY,0),cornerRadius:X(n.cornerRadius,oi),timestampCorner:Um.includes(n.timestampCorner)?n.timestampCorner:"topLeading",timestampSize:X(n.timestampSize,ja)};n.timestamp===!0&&(a.timestamp=!0);let r=Ai(n.timestampX),o=Ai(n.timestampY);return r!==void 0&&o!==void 0&&Number.isFinite(r)&&Number.isFinite(o)&&(a.timestampX=ut(r),a.timestampY=ut(o)),Fa(n,a),{kind:"image",payload:a}}case"tap":{let{colorSlot:t,...i}=Je(n,"#FFFFFF"),a={...i,action:P(n.action)?ec(n.action):{type:"refresh"}};return typeof n.openPageId=="string"&&(a.openPageId=n.openPageId),typeof n.openPageName=="string"&&(a.openPageName=n.openPageName),typeof n.attachedTo=="string"&&(a.attachedTo=n.attachedTo.toUpperCase()),{kind:"tap",payload:a}}case"chartTimes":{let{colorSlot:t,...i}=Je(n,"#FFFFFF");return{kind:"chartTimes",payload:{...i,chart:W(n.chart).toUpperCase(),timeLabelCount:ht(n.timeLabelCount),labelSize:X(n.labelSize,et),labelColorHex:W(n.labelColorHex,tt),hourCycle:xo(n.hourCycle),minutes:vo(n.minutes)}}}case"imageTime":{let{colorSlot:t,...i}=Je(n,"#FFFFFF");return{kind:"imageTime",payload:{...i,image:W(n.image).toUpperCase()}}}case"chartDots":{let{colorSlot:t,...i}=Je(n,"#FFFFFF"),a=pt(n.size);return{kind:"chartDots",payload:{...i,chart:W(n.chart).toUpperCase(),dots:za(n.dots),...a!==void 0?{size:a}:{},...typeof n.colorHex=="string"?{colorHex:n.colorHex}:{}}}}case"chartGrid":{let{colorSlot:t,...i}=Je(n,"#FFFFFF");return{kind:"chartGrid",payload:{...i,chart:W(n.chart).toUpperCase(),lines:Tn(n.lines),colorHex:Gt(n.colorHex),thickness:En(n.thickness)}}}default:throw new nt(`unknown element kind ${String(e.kind)}`)}}function wd(e){let n=P(e)?e:{},t={};if(P(n.placements))for(let[a,r]of Object.entries(n.placements)){if(!P(r))continue;let o={frame:Zd(r.frame),isHidden:r.isHidden===!0},s=Ai(r.size);s!==void 0&&(o.size=s),t[a.toUpperCase()]=o}let i={placements:t,cornerBodyShape:n.cornerBodyShape==="circle"?"circle":"wedge",borderWidth:X(n.borderWidth,2),rules:Qd(n.rules)};if(P(n.bezelText)&&(i.bezelText=ge(n.bezelText)),n.bezelCountdown===!0&&(i.bezelCountdown=!0),P(n.curvedText)&&(i.curvedText=ge(n.curvedText)),typeof n.curvedColorHex=="string"&&(i.curvedColorHex=n.curvedColorHex),P(n.bezelGauge)){let a=n.bezelGauge,r={value:P(a.value)?ge(a.value):L("50"),minValue:X(a.minValue,0),maxValue:X(a.maxValue,100),colorHexes:Array.isArray(a.colorHexes)&&a.colorHexes.length>0?a.colorHexes.filter(o=>typeof o=="string"):["#34C759","#FFCC00","#FF3B30"]};P(a.minLabel)&&(r.minLabel=ge(a.minLabel)),P(a.maxLabel)&&(r.maxLabel=ge(a.maxLabel)),i.bezelGauge=r}return typeof n.backgroundColorHex=="string"&&(i.backgroundColorHex=n.backgroundColorHex),typeof n.borderColorHex=="string"&&(i.borderColorHex=n.borderColorHex),i}function tf(e){let n={};if(Array.isArray(e))for(let t=0;t+1<e.length;t+=2){let i=e[t];typeof i=="string"&&(n[i]=wd(e[t+1]))}else if(P(e))for(let[t,i]of Object.entries(e))n[t]=wd(i);return n}function nf(e){let n={value:P(e.value)?ge(e.value):L("")};return typeof e.label=="string"&&(n.label=e.label),typeof e.symbol=="string"&&(n.symbol=e.symbol),e.countdown===!0&&(n.countdown=!0),n}function ec(e){if(!P(e)||typeof e.type!="string")return{type:"none"};switch(e.type){case"none":case"refresh":case"openApp":case"openPage":case"openRoomPage":case"timerStartPause":case"timerCancel":return{type:e.type};case"toggleEntity":case"runScene":case"runScript":case"addTodo":case"runHTTPAction":return{type:e.type,...Ut(e)};case"callService":{let n={type:"callService",serviceDomain:typeof e.serviceDomain=="string"?e.serviceDomain:"",serviceName:typeof e.serviceName=="string"?e.serviceName:""};return typeof e.serviceDataJSON=="string"&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),typeof e.entityId=="string"&&e.entityId!==""&&(n.target=Ut(e)),n}default:return{type:"none"}}}function si(e){if(!P(e))throw new nt("config must be an object");for(let r of["id","name","slotIndex","supportedFamilies","perFamily","tapAction"])if(!(r in e))throw new nt(`${r} is required`);let n=(Array.isArray(e.values)?e.values:[]).filter(P).map(r=>({id:W(r.id).toUpperCase(),name:W(r.name),value:P(r.value)?ge(r.value):L("")})),t=(Array.isArray(e.dataSources)?e.dataSources:[]).filter(P).map(r=>r.kind==="template"?{kind:"template",value:W(r.value)}:r.kind==="entity"?{kind:"entity",...Ut(r)}:null).filter(r=>r!==null),i={schemaVersion:X(e.schemaVersion,1),id:W(e.id).toUpperCase(),name:W(e.name,"Custom"),values:n,slotIndex:X(e.slotIndex,0),elements:(Array.isArray(e.elements)?e.elements:[]).map(Qm),supportedFamilies:(Array.isArray(e.supportedFamilies)?e.supportedFamilies:[]).filter(r=>typeof r=="string"),perFamily:tf(e.perFamily),dataSources:t,tapAction:ec(e.tapAction)};P(e.inline)&&(i.inline=nf(e.inline));let a=Ai(e.refreshMinutes);if(a!==void 0&&(i.refreshMinutes=a),typeof e.openPageId=="string"&&(i.openPageId=e.openPageId),typeof e.openPageName=="string"&&(i.openPageName=e.openPageName),typeof e.showSuccessFlash=="boolean"&&(i.showSuccessFlash=e.showSuccessFlash),typeof e.successFlashColorHex=="string"&&(i.successFlashColorHex=e.successFlashColorHex),Array.isArray(e.groups)){let r=e.groups.filter(P).filter(o=>typeof o.id=="string").map(o=>({id:W(o.id).toUpperCase(),name:W(o.name,"Group"),locked:o.locked!==!1}));r.length>0&&(i.groups=r)}return pf(i,Array.isArray(e.elements)?e.elements:[]),lt(i),i}function Go(e,n){let t=n?.kind;if(!t||t.kind!=="chartStat")return;let i=e.elements.find(a=>a.payload.id===t.layer);return i?.kind==="chart"?i:void 0}function Ln(e,n){return e.elements.filter(t=>t.kind==="text"&&t.payload.value.kind.kind==="chartStat"&&t.payload.value.kind.layer===n)}function af(e,n){let t=_a(e,Nn(n))?.ref;return t?.displayName||t?.entityId||(n.kind==="image"?"Picture":n.kind==="timeline"?"Timeline":"Chart")}function Ht(e,n,t){let i=st(e,n.payload.id);if(i){Bi(e,t,i.id);return}let a=Zo(e,[n.payload.id,t],af(e,n)),r=e.groups?.find(o=>o.id===a);r&&(r.locked=!1)}var tc={top:{x:0,y:0},highest:{x:.35,y:0},average:{x:.65,y:0},latest:{x:1,y:0},bottom:{x:0,y:1},lowest:{x:.35,y:1},trend:{x:.85,y:0},delta:{x:.5,y:0},sum:{x:.2,y:0},first:{x:.65,y:1}};function nc(e,n,t,i){let a=pe.rectangular,r=Math.min(1,(i*t*.62+4)/a.width),o=Math.min(1,t*1.3/a.height),s=e.x+n.x*e.width-n.x*r,l=e.y+n.y*e.height-n.y*o;return{x:Math.max(0,Math.min(1-r,s)),y:Math.max(0,Math.min(1-o,l)),width:r,height:o,rotationDegrees:0}}function ic(e,n,t){let i=e.elements.find(d=>d.payload.id===n);if(!i||i.kind!=="chart")return;let a=Te("text"),r=t==="latest"?10:8,o={kind:{kind:"chartStat",layer:n,stat:t}};(t==="latest"||t==="delta"||t==="sum")&&(o.format={useEntityUnit:!0}),a.payload.value=o,a.payload.fontSize=r,a.payload.fontWeight="medium",a.payload.colorSlot={baseColorHex:t==="latest"?"#FFFFFF":"#FFFFFF99"};let s=t==="trend"?2:o.format?.useEntityUnit?7:4;a.payload.frame=nc(i.payload.frame,tc[t],r,s);let l=e.elements.findIndex(d=>d.payload.id===n);return e.elements.splice(l+1,0,a),Ht(e,i,a.payload.id),a.payload.id}var ac={highest:"arrowtriangle.up.fill",lowest:"circle.fill",now:"arrowtriangle.down.fill",first:"circle.fill",latest:"circle.fill",threshold:"circle.fill",zero:"circle.fill"},kd=6,rf={"\u25B2":"arrowtriangle.up.fill","\u25BC":"arrowtriangle.down.fill","\u25CF":"circle.fill","\u25C6":"diamond.fill"};function of(e,n){let t=(i,a)=>i!==void 0&&i!==a?i:void 0;return n==="highest"?t(e.payload.highColorHex,Ze)??"#FFD60A":n==="lowest"?t(e.payload.lowColorHex,Qe)??"#FF453A":"#FFFFFF"}function Uo(e){e.nowIndex===void 0&&(e.nowIndex={kind:{kind:"time",timeField:"hour"}},e.drawsNowLine=!1)}function Be(e,n){return e.elements.filter(t=>t.payload.chartAnchor?.layer===n)}function Ko(e,n,t,i="above"){let a=e.elements.find(s=>s.payload.id===n);if(!a||a.kind!=="chart")return;t==="now"&&Uo(a.payload);let r=Te("icon");r.payload.symbol=L(ac[t]),r.payload.size=kd,r.payload.colorSlot={baseColorHex:of(a,t)},r.payload.frame=sf(kd),r.payload.chartAnchor={layer:n,at:t,place:i};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),Ht(e,a,r.payload.id),r.payload.id}function rc(e,n){let t=e.elements.findIndex(u=>u.payload.id===n),i=e.elements[t];if(!i||i.kind!=="text"||i.payload.chartAnchor===void 0)return;let a=i.payload,r=a.chartAnchor,o=u=>{let p=Mn(u);return p===void 0?void 0:rf[p.trim()]},s=new Set(Ui.icon),l=u=>u.flatMap(p=>{if(p.kind==="setText"){let m=p.value===void 0?void 0:o(p.value);return m===void 0?[]:[{kind:"setIcon",value:L(m)}]}return s.has(Pe[p.kind])?[p]:[]}),d=a.rules.filter(u=>u.partId===void 0).map(u=>({...u,cases:u.cases.map(p=>({...p,then:l(p.then)})),...u.otherwise!==void 0?{otherwise:l(u.otherwise)}:{}})),c=Te("icon");c.payload={...c.payload,id:a.id,colorSlot:a.colorSlot,rules:d,frame:a.frame,isHidden:a.isHidden,...a.groupId!==void 0?{groupId:a.groupId}:{},...a.name!==void 0?{name:a.name}:{},chartAnchor:r,symbol:L(o(a.value)??ac[r.at]),size:a.fontSize},e.elements[t]=c}function sf(e){let n=pe.rectangular;return{x:0,y:0,width:Math.min(1,e*1.2/n.width),height:Math.min(1,e*1.3/n.height),rotationDegrees:0}}function La(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;t==="now"&&Uo(a);let r=Te("shape");r.payload.kind="line",r.payload.thickness=1,r.payload.borderWidth=0,r.payload.colorSlot={baseColorHex:t==="now"?a.nowColorHex:a.thresholdColorHex},r.payload.frame=oc(a.frame,t),r.payload.chartAnchor={layer:n,at:t,place:"through"};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),Ht(e,i,r.payload.id),t==="now"?a.drawsNowLine=!1:a.drawsThreshold=!1,r.payload.id}function oc(e,n){let t=pe.rectangular,i=3;return n==="now"?{...e,width:Math.min(e.width,i/t.width),rotationDegrees:0}:{...e,height:Math.min(e.height,i/t.height),rotationDegrees:0}}function nn(e,n){return e.elements.filter(t=>t.kind==="chartTimes"&&t.payload.chart===n)}function _n(e,n){let t=e.elements.find(o=>o.payload.id===n);if(!t||t.kind!=="chart"&&t.kind!=="timeline")return;let i=t.payload,a=Te("chartTimes");a.payload.chart=n,a.payload.timeLabelCount=i.timeLabelCount>0?ht(i.timeLabelCount):jd,a.payload.labelSize=i.labelSize,a.payload.labelColorHex=i.labelColorHex,a.payload.hourCycle=i.hourCycle,a.payload.minutes=i.minutes,a.payload.frame=uf(i.frame,i.labelSize,i.labelsAbove);let r=e.elements.findIndex(o=>o.payload.id===n);return e.elements.splice(r+1,0,a),Ht(e,t,a.payload.id),i.drawsTimeLabels=!1,a.payload.id}function Wo(e,n){return e.elements.filter(t=>t.kind==="imageTime"&&t.payload.image===n)}function lf(e){let n=Math.min(40,Math.max(4,e));return{w:8*n*.578+n*.89,h:n*1.25}}function jo(e,n){return Math.max(0,Math.min(e/(8*.578+.89),n/1.25))}function qo(e,n,t=pe.rectangular){let i=e.elements.find(y=>y.payload.id===n);if(!i||i.kind!=="image")return;let a=i.payload,r=Te("imageTime");r.payload.image=n;let o=lf(a.timestampSize),s=a.frame.x*t.width,l=a.frame.y*t.height,d=a.frame.width*t.width,c=a.frame.height*t.height,u,p;if(qa(a)){let y=(b,k,C,w)=>w>=C?k+(C-w)/2:Math.min(k+C-w,Math.max(k,b-w/2));u=y(s+a.timestampX*d,s,d,o.w),p=y(l+a.timestampY*c,l,c,o.h)}else u=a.timestampCorner.endsWith("Leading")?s+4:s+d-4-o.w,p=a.timestampCorner.startsWith("top")?l+4:l+c-4-o.h;let m=y=>Math.round(y*1e3)/1e3;r.payload.frame={x:m(u/t.width),y:m(p/t.height),width:m(o.w/t.width),height:m(o.h/t.height),rotationDegrees:0};let g=e.elements.findIndex(y=>y.payload.id===n);return e.elements.splice(g+1,0,r),Ht(e,i,r.payload.id),delete a.timestamp,delete a.timestampX,delete a.timestampY,a.timestampCorner="topLeading",a.timestampSize=ja,r.payload.id}function zn(e,n){return e.elements.filter(t=>t.kind==="chartDots"&&t.payload.chart===n)}function Pn(e,n){return e.elements.filter(t=>t.kind==="chartGrid"&&t.payload.chart===n)}function sc(e,n){return Be(e,n).filter(t=>t.payload.chartAnchor?.at==="zero")}function Yo(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Te("chartDots");i.payload.chart=n,i.payload.dots=t.payload.pointDots==="all"?"all":"auto",i.payload.frame={...t.payload.frame};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a+1,0,i),Ht(e,t,i.payload.id),i.payload.id}function Xo(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Te("chartGrid");i.payload.chart=n,i.payload.frame={...t.payload.frame};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a,0,i),Ht(e,t,i.payload.id),i.payload.id}var df="#FFFFFF66";function Jo(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t||t.kind!=="chart")return;let i=Te("shape");i.payload.kind="line",i.payload.thickness=1,i.payload.borderWidth=0,i.payload.colorSlot={baseColorHex:df},i.payload.frame=oc(t.payload.frame,"threshold"),i.payload.chartAnchor={layer:n,at:"zero",place:"through"};let a=e.elements.findIndex(r=>r.payload.id===n);return e.elements.splice(a+1,0,i),Ht(e,t,i.payload.id),i.payload.id}function lc(e,n,t){let i=e.elements.find(r=>r.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;if(t===void 0){delete a.thresholdValue,delete a.drawsThreshold;for(let r of Be(e,n))r.payload.chartAnchor?.at==="threshold"&&ye(e,r.payload.id);return}a.thresholdValue=t,a.drawsThreshold=!1,Be(e,n).some(r=>r.payload.chartAnchor?.at==="threshold")||La(e,n,"threshold")}function dc(e,n,t){let i=e.elements.find(r=>r.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload;if(!t){delete a.nowIndex,delete a.drawsNowLine;for(let r of Be(e,n))r.payload.chartAnchor?.at==="now"&&ye(e,r.payload.id);return}Uo(a),a.drawsNowLine=!1,Be(e,n).some(r=>r.payload.chartAnchor?.at==="now")||La(e,n,"now")}function cc(e){let n=e.elements.filter(t=>t.kind==="chart"||t.kind==="timeline"||t.kind==="image");for(let t of n){let i=t.payload,a=new Set(e.elements.map(l=>l.payload.id)),r=oe.find(l=>e.perFamily[l]?.placements[i.id]!==void 0),o=i.frame,s=r===void 0?void 0:e.perFamily[r].placements[i.id];if(s&&(i.frame={...s.frame}),t.kind==="chart"&&cf(e,t.payload),t.kind==="timeline"&&t.payload.drawsTimeLabels!==!1&&t.payload.timeLabelCount>0&&_n(e,i.id),t.kind==="image"&&t.payload.timestamp===!0&&qo(e,i.id,pe[r===void 0||r==="inline"?"rectangular":r]),i.frame=o,!(r===void 0||s===void 0))for(let l of e.elements)a.has(l.payload.id)||(e.perFamily[r].placements[l.payload.id]={frame:{...l.payload.frame},isHidden:s.isHidden},l.payload.isHidden=!0)}}function cf(e,n){{if(n.highlight!==void 0&&n.highlight!=="none"){let a=Hi(n),r=[];(n.highlight==="highest"||n.highlight==="both")&&r.push(["highest",a.high]),(n.highlight==="lowest"||n.highlight==="both")&&r.push(["lowest",a.low]);for(let[o,s]of r){let l=Ko(e,n.id,o),d=e.elements.find(c=>c.payload.id===l);d?.kind==="icon"&&s!=="none"&&(d.payload.symbol=L(s==="triangle"?"arrowtriangle.up.fill":"circle.fill"))}Pm(n,{high:"none",low:"none"}),n.highlight="none"}n.thresholdValue!==void 0&&n.drawsThreshold!==!1&&La(e,n.id,"threshold"),n.nowIndex!==void 0&&n.drawsNowLine!==!1&&La(e,n.id,"now"),n.drawsTimeLabels!==!1&&Fn(n)&&n.timeLabelCount>0&&_n(e,n.id);let t=$o(n.pointDots);if(t!=="none"){let a=Yo(e,n.id),r=e.elements.find(o=>o.payload.id===a);if(r?.kind==="chartDots"){r.payload.dots=t;let o=pt(n.pointDotSize);o!==void 0&&(r.payload.size=o),typeof n.pointDotColorHex=="string"&&(r.payload.colorHex=n.pointDotColorHex)}}let i=Co(n.gridLines);if(i>0){let a=Xo(e,n.id),r=e.elements.find(o=>o.payload.id===a);r?.kind==="chartGrid"&&(r.payload.lines=i,r.payload.colorHex=Gt(n.gridColorHex))}if(n.zeroLine===!0){let a=Jo(e,n.id),r=e.elements.find(o=>o.payload.id===a);r?.kind==="shape"&&(r.payload.colorSlot={baseColorHex:Gt(n.gridColorHex)})}delete n.pointDots,delete n.pointDotSize,delete n.pointDotColorHex,delete n.gridLines,delete n.gridColorHex,delete n.zeroLine}}function uf(e,n,t){let i=pe.rectangular,a=Math.max(Qt,Math.min(en,n)),r=Math.min(1,a*1.2/i.height),o=Math.min(1,Math.max(0,e.width)),s=t?e.y-r:e.y+e.height;return{x:Math.max(0,Math.min(1-o,e.x)),y:Math.max(0,Math.min(1-r,s)),width:o,height:r,rotationDegrees:0}}function pf(e,n){for(let t of n){if(!P(t)||t.kind!=="chart"||!P(t.payload))continue;let i=t.payload,a=W(i.id).toUpperCase(),r=e.elements.find(p=>p.payload.id===a);if(!r||r.kind!=="chart")continue;let o=W(i.scaleLabelColorHex,"#FFFFFF99"),s=p=>{let m=P(p)?p:{};return{fontSize:X(m.fontSize,8),colorHex:W(m.colorHex,o),pillColorHex:typeof m.pillColorHex=="string"?m.pillColorHex:void 0}},l=[],d=ue(i.scaleLabels);(d==="top"||d==="range")&&l.push(["top",s(i.topLabelStyle)]),d==="range"&&l.push(["bottom",s(i.bottomLabelStyle)]);let c=ue(i.latestLabel);if((c==="corner"||c==="end")&&l.push(["latest",s(i.latestLabelStyle)]),l.length===0)continue;let u=e.elements.findIndex(p=>p.payload.id===a)+1;for(let[p,m]of l){let g=nc(r.payload.frame,tc[p],m.fontSize,p==="latest"?5:4),y=[];if(m.pillColorHex!==void 0){let k=Te("shape");k.payload.kind="capsule",k.payload.colorSlot={baseColorHex:m.pillColorHex},k.payload.frame={...g},y.push(k)}let b=Te("text");b.payload.value={kind:{kind:"chartStat",layer:a,stat:p}},b.payload.fontSize=m.fontSize,b.payload.fontWeight="medium",b.payload.colorSlot={baseColorHex:m.colorHex},b.payload.frame=g,y.push(b),e.elements.splice(u,0,...y),u+=y.length;for(let k of y)Ht(e,r,k.payload.id)}}}function Y(e){return Number.isNaN(e)?"nan":e===1/0?"+inf":e===-1/0?"-inf":e}function Kt(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function hf(e){let n={};return e.decimals!==void 0&&(n.decimals=Y(e.decimals)),e.multiply!==void 0&&(n.multiply=Y(e.multiply)),e.offset!==void 0&&(n.offset=Y(e.offset)),e.prefix&&(n.prefix=e.prefix),e.suffix&&(n.suffix=e.suffix),e.useEntityUnit&&(n.useEntityUnit=!0),e.relativeTime&&(n.relativeTime=!0),e.duration&&(n.duration=!0),e.textCase!==void 0&&(n.textCase=e.textCase),n}function mf(e){let n=e.scope.kind==="entities"?{kind:"entities",entities:e.scope.entities.map(Kt)}:{kind:"filter",domains:e.scope.domains,areaIds:e.scope.areaIds,labelIds:e.scope.labelIds,floorIds:e.scope.floorIds},t={function:e.function,scope:n};return e.stateFilter&&(t.stateFilter=e.stateFilter.kind==="equals"||e.stateFilter.kind==="notEquals"?{kind:e.stateFilter.kind,value:e.stateFilter.value}:{kind:e.stateFilter.kind}),e.attribute!==void 0&&(t.attribute=e.attribute),t}function ff(e){switch(e.kind){case"literal":return{kind:"literal",value:e.value};case"entityState":return{kind:"entityState",...Kt(e)};case"entityAttribute":return{kind:"entityAttribute",...Kt(e),attribute:e.attribute};case"entityAge":return{kind:"entityAge",...Kt(e)};case"aggregate":return{kind:"aggregate",aggregate:mf(e.aggregate)};case"time":return{kind:"time",timeField:e.timeField};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:e.value};case"named":return{kind:"named",id:e.id};case"chartStat":return{kind:"chartStat",layer:e.layer,stat:e.stat}}}function ce(e){let n={kind:ff(e.kind)};return Ie(e.format)||(n.format=hf(e.format)),n}function Tt(e){return{x:Y(e.x),y:Y(e.y),width:Y(e.width),height:Y(e.height),rotationDegrees:Y(e.rotationDegrees)}}function gf(e){let n={kind:e.kind};switch(e.kind){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":n.value=ce(e.value??L(""));break;case"between":case"timeBetween":n.value=ce(e.value??L("")),n.upper=ce(e.upper??L(""));break;case"matchesRegex":n.pattern=e.pattern??"";break;case"isOneOf":n.options=e.options??[];break;default:break}return n}function $d(e){let n={kind:e.kind};switch(e.kind){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":n.value=ce(e.value??L(""));break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":n.number=Y(e.number??0);break;case"setFontWeight":n.weight=e.weight??"regular";break;default:break}return n}function Et(e){return e.map(n=>{let t={id:n.id,cases:n.cases.map(i=>({id:i.id,when:{join:i.when.join,tests:i.when.tests.map(a=>({id:a.id,value:ce(a.value),comparison:gf(a.comparison)}))},then:i.then.map($d)}))};return n.otherwise&&(t.otherwise=n.otherwise.map($d)),n.partId!==void 0&&(t.partId=n.partId),t})}function yf(e){let n={id:e.id,value:ce(e.value)};return e.colorHex!==void 0&&(n.colorHex=e.colorHex),e.fontWeight!==void 0&&(n.fontWeight=e.fontWeight),e.fontSize!==void 0&&(n.fontSize=Y(e.fontSize)),e.coloring!==void 0&&e.coloring!=="uniform"&&(n.coloring=e.coloring),e.bands!==void 0&&e.bands.length>0&&(n.bands=e.bands.map(t=>({id:t.id,upTo:Y(t.upTo),colorHex:t.colorHex}))),e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==le&&(n.bandAboveColorHex=e.bandAboveColorHex),n}function bf(e){let n=xf(e);return e.payload.groupId!==void 0&&(n.payload.groupId=e.payload.groupId),e.payload.name!==void 0&&(n.payload.name=e.payload.name),n}function xf(e){let n=t=>({id:t.id,colorSlot:{baseColorHex:t.colorSlot.baseColorHex},rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden});switch(e.kind){case"text":{let t={...n(e.payload),value:ce(e.payload.value),fontSize:Y(e.payload.fontSize),fontWeight:e.payload.fontWeight};e.payload.countdown===!0&&(t.countdown=!0),e.payload.monospacedDigits===!0&&(t.monospacedDigits=!0),e.payload.lineLimit===2&&(t.lineLimit=2),e.payload.alignment!==void 0&&e.payload.alignment!=="center"&&(t.alignment=e.payload.alignment);let i=e.payload;return i.coloring!==void 0&&i.coloring!=="uniform"&&(t.coloring=i.coloring),i.bands!==void 0&&i.bands.length>0&&(t.bands=i.bands.map(a=>({id:a.id,upTo:Y(a.upTo),colorHex:a.colorHex}))),i.bandAboveColorHex!==void 0&&i.bandAboveColorHex!==le&&(t.bandAboveColorHex=i.bandAboveColorHex),i.highlight!==void 0&&i.highlight!=="none"&&(t.highlight=i.highlight),i.highColorHex!==void 0&&i.highColorHex!==Ze&&(t.highColorHex=i.highColorHex),i.lowColorHex!==void 0&&i.lowColorHex!==Qe&&(t.lowColorHex=i.lowColorHex),i.parts!==void 0&&i.parts.length>0&&(t.parts=i.parts.map(yf),rt(i)&&(t.value=ce(Pi(i.parts)))),Aa(i,t),{kind:"text",payload:t}}case"icon":{let t={...n(e.payload),symbol:ce(e.payload.symbol)};return e.payload.path!==void 0&&e.payload.path!==""&&(t.path=e.payload.path),t.size=Y(e.payload.size),Aa(e.payload,t),{kind:"icon",payload:t}}case"gauge":{let t=e.payload,i={...n(t),value:ce(t.value),minValue:Y(t.minValue),maxValue:Y(t.maxValue),style:t.style,lineWidth:Y(t.lineWidth),trackColorHex:t.trackColorHex};return t.coloring!=="uniform"&&(i.coloring=t.coloring),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,upTo:Y(a.upTo),colorHex:a.colorHex}))),t.bandAboveColorHex!==le&&(i.bandAboveColorHex=t.bandAboveColorHex),t.thresholdValue!==void 0&&(i.thresholdValue=Y(t.thresholdValue)),t.thresholdColorHex!==ri&&(i.thresholdColorHex=t.thresholdColorHex),t.total!==void 0&&(i.total=ce(t.total)),t.minSource!==void 0&&(i.minSource=ce(t.minSource)),t.maxSource!==void 0&&(i.maxSource=ce(t.maxSource)),{kind:"gauge",payload:i}}case"chart":{let t=e.payload,i={...n(t),value:ce(t.value),historyMinutes:Math.max(0,Math.round(t.historyMinutes)),historyPoints:Math.round(t.historyPoints),style:t.style,limit:Math.max(0,Math.round(t.limit)),takeFromEnd:t.takeFromEnd,scale:t.scale,minValue:Y(t.minValue),maxValue:Y(t.maxValue),baseline:t.baseline,barGap:Y(t.barGap),lineWidth:Y(t.lineWidth),highlight:t.highlight,highColorHex:t.highColorHex,lowColorHex:t.lowColorHex,marker:Nd(Hi(t)),coloring:t.coloring,bands:t.bands.map(c=>({id:c.id,upTo:Y(c.upTo),colorHex:c.colorHex})),bandAboveColorHex:t.bandAboveColorHex,fillBands:t.fillBands};t.source!==Eo&&(i.source=t.source),t.statPeriod!==Li&&(i.statPeriod=t.statPeriod),t.statType!==_i&&(i.statType=t.statType),t.thresholdValue!==void 0&&(i.thresholdValue=Y(t.thresholdValue)),t.thresholdColorHex!==Ro&&(i.thresholdColorHex=t.thresholdColorHex),t.nowIndex!==void 0&&(i.nowIndex=ce(t.nowIndex)),t.nowColorHex!==Fo&&(i.nowColorHex=t.nowColorHex),t.drawsThreshold===!1&&(i.drawsThreshold=!1),t.drawsNowLine===!1&&(i.drawsNowLine=!1),t.drawsTimeLabels===!1&&(i.drawsTimeLabels=!1),t.scaleFrom!==void 0&&(i.scaleFrom=t.scaleFrom),t.labelSize!==et&&(i.labelSize=Y(t.labelSize)),t.labelColorHex!==tt&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==wn&&(i.timeLabelCount=ht(t.timeLabelCount)),t.hourCycle!==kn&&(i.hourCycle=t.hourCycle),t.minutes!==$n&&(i.minutes=t.minutes);let a=Hi(t);Dd(a)||(i.highMarker=a.high,i.lowMarker=a.low);let r=t.curve??"straight";r!=="straight"&&(i.curve=r);let o=Wt(t.fillStyle);o!=="flat"&&(i.fillStyle=o),t.fillColorHex!==void 0&&(i.fillColorHex=t.fillColorHex);let s=jt(t.barRadius);s!==ai&&(i.barRadius=Y(s));let l=qt(t.barCorners);l!=="all"&&(i.barCorners=l);let d=at(t.smoothing);return d!==void 0&&(i.smoothing=d),t.gaps===!0&&(i.gaps=!0),{kind:"chart",payload:i}}case"timeline":{let t=e.payload,i={id:t.id,rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden,value:ce(t.value)};return t.historyMinutes!==Do&&(i.historyMinutes=Math.max(1,Math.round(t.historyMinutes))),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,match:a.match,colorHex:a.colorHex}))),t.otherColorHex!==Zt&&(i.otherColorHex=t.otherColorHex),t.gap!==0&&(i.gap=Y(t.gap)),t.cornerRadius!==Wd&&(i.cornerRadius=Y(t.cornerRadius)),t.labelSize!==et&&(i.labelSize=Y(t.labelSize)),t.labelColorHex!==tt&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==wn&&(i.timeLabelCount=Math.max(0,Math.min(In,Math.round(t.timeLabelCount)))),t.hourCycle!==kn&&(i.hourCycle=t.hourCycle),t.minutes!==$n&&(i.minutes=t.minutes),t.drawsTimeLabels===!1&&(i.drawsTimeLabels=!1),{kind:"timeline",payload:i}}case"shape":{let t={...n(e.payload),kind:e.payload.kind,cornerRadius:Y(e.payload.cornerRadius),borderWidth:Y(e.payload.borderWidth)};return e.payload.borderColorHex!==void 0&&(t.borderColorHex=e.payload.borderColorHex),e.payload.thickness!==1&&(t.thickness=Y(e.payload.thickness)),Aa(e.payload,t),{kind:"shape",payload:t}}case"image":{let t=e.payload,i={id:t.id,entity:Kt(t.entity),rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden};t.source!=="camera"&&(i.source=t.source),t.timestamp===!0&&(i.timestamp=!0),t.contentMode!=="fill"&&(i.contentMode=t.contentMode),t.zoom!==1&&(i.zoom=Y(t.zoom)),t.panX!==0&&(i.panX=Y(t.panX)),t.panY!==0&&(i.panY=Y(t.panY)),t.cornerRadius!==oi&&(i.cornerRadius=Y(t.cornerRadius));let a=qa(t),r=a?Km(t.timestampX,t.timestampY):t.timestampCorner;return r!=="topLeading"&&(i.timestampCorner=r),t.timestampSize!==ja&&(i.timestampSize=Y(t.timestampSize)),a&&(i.timestampX=Y(t.timestampX),i.timestampY=Y(t.timestampY)),Aa(t,i),{kind:"image",payload:i}}case"tap":{let t=e.payload,i={id:t.id,action:uc(t.action)};return t.openPageId!==void 0&&(i.openPageId=t.openPageId),t.openPageName!==void 0&&(i.openPageName=t.openPageName),t.attachedTo!==void 0&&(i.attachedTo=t.attachedTo),i.rules=Et(t.rules),i.frame=Tt(t.frame),i.isHidden=t.isHidden,{kind:"tap",payload:i}}case"chartTimes":{let t=e.payload,i={id:t.id,rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden,chart:t.chart};return t.labelSize!==et&&(i.labelSize=Y(t.labelSize)),t.labelColorHex!==tt&&(i.labelColorHex=t.labelColorHex),t.timeLabelCount!==wn&&(i.timeLabelCount=ht(t.timeLabelCount)),t.hourCycle!==kn&&(i.hourCycle=t.hourCycle),t.minutes!==$n&&(i.minutes=t.minutes),{kind:"chartTimes",payload:i}}case"imageTime":{let t=e.payload,i={id:t.id,rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden};return t.image!==""&&(i.image=t.image),{kind:"imageTime",payload:i}}case"chartDots":{let t=e.payload,i={id:t.id,rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden,chart:t.chart};za(t.dots)!=="auto"&&(i.dots="all");let a=pt(t.size);return a!==void 0&&(i.size=Y(a)),t.colorHex!==void 0&&(i.colorHex=t.colorHex),{kind:"chartDots",payload:i}}case"chartGrid":{let t=e.payload,i={id:t.id,rules:Et(t.rules),frame:Tt(t.frame),isHidden:t.isHidden,chart:t.chart},a=Tn(t.lines);a!==Xt&&(i.lines=a);let r=Gt(t.colorHex);Ld(r,Mt)||(i.colorHex=r);let o=En(t.thickness);return o!==Yt&&(i.thickness=Y(o)),{kind:"chartGrid",payload:i}}}}function vf(e){let n={},t=Object.keys(e.placements);if(t.length>0){let i={};for(let a of t){let r=e.placements[a],o={frame:Tt(r.frame)};r.isHidden&&(o.isHidden=!0),r.size!==void 0&&(o.size=Y(r.size)),i[a]=o}n.placements=i}if(e.bezelText&&(n.bezelText=ce(e.bezelText)),e.bezelCountdown===!0&&(n.bezelCountdown=!0),e.curvedText&&(n.curvedText=ce(e.curvedText)),e.curvedColorHex!==void 0&&(n.curvedColorHex=e.curvedColorHex),e.bezelGauge){let i=e.bezelGauge,a={value:ce(i.value),minValue:Y(i.minValue),maxValue:Y(i.maxValue),colorHexes:i.colorHexes};i.minLabel&&(a.minLabel=ce(i.minLabel)),i.maxLabel&&(a.maxLabel=ce(i.maxLabel)),n.bezelGauge=a}return e.backgroundColorHex!==void 0&&(n.backgroundColorHex=e.backgroundColorHex),n.cornerBodyShape=e.cornerBodyShape,e.borderColorHex!==void 0&&(n.borderColorHex=e.borderColorHex),n.borderWidth=Y(e.borderWidth),e.rules.length>0&&(n.rules=Et(e.rules)),n}function uc(e){if(e.type==="callService"){let n={type:e.type,serviceDomain:e.serviceDomain,serviceName:e.serviceName};return e.serviceDataJSON!==void 0&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),e.target!==void 0&&e.target.entityId!==""&&Object.assign(n,Kt(e.target)),n}return"entityId"in e?{type:e.type,...Kt(e)}:{type:e.type}}function wf(e){let n={};return e.label!==void 0&&(n.label=e.label),n.value=ce(e.value),e.symbol!==void 0&&(n.symbol=e.symbol),e.countdown&&(n.countdown=!0),n}function li(e){let n=[];for(let i of oe){let a=e.perFamily[i];a&&n.push(i,vf(a))}let t={schemaVersion:Sn(e),id:e.id,name:e.name,values:e.values.map(i=>({id:i.id,name:i.name,value:ce(i.value)})),slotIndex:e.slotIndex,elements:e.elements.map(bf),supportedFamilies:e.supportedFamilies,perFamily:n,dataSources:e.dataSources.map(i=>i.kind==="template"?{kind:"template",value:i.value}:{kind:"entity",...Kt(i)}),tapAction:uc(e.tapAction)};return e.inline!==void 0&&(t.inline=wf(e.inline)),e.refreshMinutes!==void 0&&(t.refreshMinutes=e.refreshMinutes),e.openPageId!==void 0&&(t.openPageId=e.openPageId),e.openPageName!==void 0&&(t.openPageName=e.openPageName),e.showSuccessFlash!==void 0&&(t.showSuccessFlash=e.showSuccessFlash),e.successFlashColorHex!==void 0&&(t.successFlashColorHex=e.successFlashColorHex),e.groups!==void 0&&e.groups.length>0&&(t.groups=e.groups.map(i=>({id:i.id,name:i.name,locked:i.locked}))),t}function st(e,n){let i=e.elements.find(a=>a.payload.id===n)?.payload.groupId;return i===void 0?void 0:e.groups?.find(a=>a.id===i)}function It(e,n){return e.elements.filter(t=>t.payload.groupId===n&&!be(e,t))}function lt(e){let n=new Set((e.groups??[]).map(a=>a.id));for(let a of e.elements)a.payload.groupId!==void 0&&!n.has(a.payload.groupId)&&delete a.payload.groupId;let t=new Set(e.elements.map(a=>a.payload.groupId).filter(a=>a!==void 0)),i=(e.groups??[]).filter(a=>t.has(a.id));i.length===0?delete e.groups:e.groups=i}function di(e){if(!e.groups?.length)return;let n=e.elements.filter(r=>!be(e,r)),t=e.elements.filter(r=>be(e,r)),i=[],a=new Set;for(let r=n.length-1;r>=0;r--){let o=n[r];if(a.has(o.payload.id))continue;let s=o.payload.groupId;if(s===void 0){i.unshift(o),a.add(o.payload.id);continue}let l=n.filter(d=>d.payload.groupId===s);for(let d=l.length-1;d>=0;d--)i.unshift(l[d]),a.add(l[d].payload.id)}e.elements=[...i,...t],an(e)}function Zo(e,n,t="Group"){let i=e.elements.filter(r=>n.includes(r.payload.id)&&!be(e,r));if(i.length<2)return;let a={id:J(),name:t,locked:!0};e.groups=[...e.groups??[],a];for(let r of i)r.payload.groupId=a.id;return lt(e),di(e),a.id}function Vi(e,n){for(let t of e.elements)t.payload.groupId===n&&delete t.payload.groupId;lt(e)}function Bi(e,n,t){let i=e.elements.find(a=>a.payload.id===n);!i||be(e,i)||(t===void 0?delete i.payload.groupId:i.payload.groupId=t,lt(e),di(e))}var re={config:["schemaVersion","id","name","values","slotIndex","elements","supportedFamilies","perFamily","inline","dataSources","refreshMinutes","tapAction","openPageId","openPageName","showSuccessFlash","successFlashColorHex","groups"],group:["id","name","locked"],inline:["label","value","symbol","countdown"],named:["id","name","value"],value:["kind","format"],format:["decimals","multiply","offset","prefix","suffix","useEntityUnit","relativeTime","duration","textCase"],entityRef:["entityId","displayName","domain","iconName"],aggregate:["function","scope","stateFilter","attribute"],scope:["kind","entities","domains","areaIds","labelIds","floorIds"],stateFilter:["kind","value"],frame:["x","y","width","height","rotationDegrees"],chartAnchor:["layer","at","place","dx","dy"],elementEnvelope:["kind","payload"],elementBase:["id","colorSlot","rules","frame","isHidden","groupId","name"],text:["value","fontSize","fontWeight","countdown","monospacedDigits","lineLimit","alignment","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex","parts","chartAnchor"],textPart:["id","value","colorHex","fontWeight","fontSize","coloring","bands","bandAboveColorHex"],icon:["symbol","path","size","chartAnchor"],gauge:["value","minValue","maxValue","style","lineWidth","trackColorHex","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","style","limit","takeFromEnd","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes","highMarker","lowMarker","curve","fillStyle","fillColorHex","barRadius","barCorners","smoothing","gaps","pointDots","pointDotSize","pointDotColorHex","gridLines","gridColorHex","zeroLine","bandLowColorHex","bandHighColorHex","bandLowerBound","bandUpperBound","scaleLabels","scaleLabelPlacement","latestLabel","topLabelStyle","bottomLabelStyle","latestLabelStyle","latestLabelFollowsBand","scaleLabelColorHex"],timeline:["value","historyMinutes","bands","otherColorHex","gap","cornerRadius","timeLabels","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes","drawsTimeLabels"],shape:["kind","cornerRadius","thickness","borderColorHex","borderWidth","chartAnchor"],image:["entity","source","timestamp","contentMode","zoom","panX","panY","cornerRadius","timestampCorner","timestampSize","timestampStyle","timestampX","timestampY","chartAnchor"],tap:["action","openPageId","openPageName","attachedTo","grow"],chartTimes:["chart","timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["chart","dots","size","colorHex"],chartGrid:["chart","lines","colorHex","thickness"],imageTime:["image","size"],colorSlot:["baseColorHex"],rule:["id","cases","otherwise","partId"],case:["id","when","then"],condition:["join","tests"],test:["id","value","comparison"],comparison:["kind","value","upper","pattern","options"],styleChange:["kind","value","number","weight"],layout:["placements","bezelText","bezelCountdown","curvedText","curvedColorHex","bezelGauge","backgroundColorHex","cornerBodyShape","borderColorHex","borderWidth","rules"],bezelGauge:["value","minValue","maxValue","colorHexes","minLabel","maxLabel"],placement:["frame","isHidden","size"],tapAction:["type","entityId","displayName","domain","iconName","serviceDomain","serviceName","serviceDataJSON"]},Cd={literal:["kind","value"],entityState:["kind",...re.entityRef],entityAttribute:["kind",...re.entityRef,"attribute"],entityAge:["kind",...re.entityRef],aggregate:["kind","aggregate"],time:["kind","timeField"],dataAge:["kind"],jinja:["kind","value"],named:["kind","id"],chartStat:["kind","layer","stat"]};function Xa(e){let n=[],t=(l,d,c)=>{if(P(l))for(let u of Object.keys(l))d.includes(u)||n.push(`${c}.${u}`)},i=(l,d)=>{if(!P(l))return;let c=typeof l.kind=="string"?l.kind:"";t(l,Cd[c]??["kind"],d),c==="aggregate"&&P(l.aggregate)&&(t(l.aggregate,re.aggregate,`${d}.aggregate`),t(l.aggregate.scope,re.scope,`${d}.aggregate.scope`),P(l.aggregate.scope)&&Array.isArray(l.aggregate.scope.entities)&&l.aggregate.scope.entities.forEach((u,p)=>t(u,re.entityRef,`${d}.aggregate.scope.entities[${p}]`)),t(l.aggregate.stateFilter,re.stateFilter,`${d}.aggregate.stateFilter`))},a=(l,d)=>{if(P(l)){if(P(l.kind))t(l,re.value,d),i(l.kind,`${d}.kind`);else{let c=typeof l.kind=="string"?l.kind:"";t(l,[...Cd[c]??["kind"],"format"],d),c==="aggregate"&&i(l,d)}t(l.format,re.format,`${d}.format`)}},r=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{t(c,re.styleChange,`${d}[${u}]`),P(c)&&a(c.value,`${d}[${u}].value`)})},o=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{let p=`${d}[${u}]`;t(c,re.rule,p),P(c)&&(Array.isArray(c.cases)&&c.cases.forEach((m,g)=>{let y=`${p}.cases[${g}]`;t(m,re.case,y),P(m)&&(t(m.when,re.condition,`${y}.when`),P(m.when)&&Array.isArray(m.when.tests)&&m.when.tests.forEach((b,k)=>{let C=`${y}.when.tests[${k}]`;t(b,re.test,C),P(b)&&(a(b.value,`${C}.value`),t(b.comparison,re.comparison,`${C}.comparison`),P(b.comparison)&&(a(b.comparison.value,`${C}.comparison.value`),a(b.comparison.upper,`${C}.comparison.upper`)))}),r(m.then,`${y}.then`))}),r(c.otherwise,`${p}.otherwise`))})};if(!P(e))return n;t(e,re.config,"$"),Array.isArray(e.groups)&&e.groups.forEach((l,d)=>t(l,re.group,`$.groups[${d}]`)),Array.isArray(e.values)&&e.values.forEach((l,d)=>{t(l,re.named,`$.values[${d}]`),P(l)&&a(l.value,`$.values[${d}].value`)}),Array.isArray(e.elements)&&e.elements.forEach((l,d)=>{let c=`$.elements[${d}]`;if(t(l,re.elementEnvelope,c),!P(l)||!P(l.payload))return;let u=typeof l.kind=="string"?l.kind:"",p=re[u]??[];t(l.payload,[...re.elementBase,...p],`${c}.payload`),t(l.payload.colorSlot,re.colorSlot,`${c}.payload.colorSlot`),t(l.payload.frame,re.frame,`${c}.payload.frame`),"chartAnchor"in l.payload&&t(l.payload.chartAnchor,re.chartAnchor,`${c}.payload.chartAnchor`),o(l.payload.rules,`${c}.payload.rules`);for(let m of["value","symbol","nowIndex","total","minSource","maxSource"])m in l.payload&&a(l.payload[m],`${c}.payload.${m}`);u==="text"&&Array.isArray(l.payload.parts)&&l.payload.parts.forEach((m,g)=>{t(m,re.textPart,`${c}.payload.parts[${g}]`),P(m)&&a(m.value,`${c}.payload.parts[${g}].value`)}),u==="image"&&t(l.payload.entity,re.entityRef,`${c}.payload.entity`),u==="tap"&&t(l.payload.action,re.tapAction,`${c}.payload.action`)});let s=[];if(Array.isArray(e.perFamily))for(let l=0;l+1<e.perFamily.length;l+=2)s.push([String(e.perFamily[l]),e.perFamily[l+1]]);else P(e.perFamily)&&s.push(...Object.entries(e.perFamily));for(let[l,d]of s){let c=`$.perFamily.${l}`;if(t(d,re.layout,c),!!P(d)){if(P(d.placements))for(let[u,p]of Object.entries(d.placements))t(p,re.placement,`${c}.placements.${u}`),P(p)&&t(p.frame,re.frame,`${c}.placements.${u}.frame`);if(a(d.bezelText,`${c}.bezelText`),a(d.curvedText,`${c}.curvedText`),P(d.bezelGauge)){let u=`${c}.bezelGauge`;t(d.bezelGauge,re.bezelGauge,u),a(d.bezelGauge.value,`${u}.value`),a(d.bezelGauge.minLabel,`${u}.minLabel`),a(d.bezelGauge.maxLabel,`${u}.maxLabel`)}o(d.rules,`${c}.rules`)}}return P(e.inline)&&(t(e.inline,re.inline,"$.inline"),a(e.inline.value,"$.inline.value")),t(e.tapAction,re.tapAction,"$.tapAction"),n}function J(){let e=globalThis.crypto;if(e&&"randomUUID"in e)return e.randomUUID().toUpperCase();let n=()=>Math.floor(Math.random()*65536).toString(16).padStart(4,"0"),t=(8+Math.floor(Math.random()*4)).toString(16)+n().slice(1);return`${n()}${n()}-${n()}-4${n().slice(1)}-${t}-${n()}${n()}${n()}`.toUpperCase()}function Lt(){return{placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}}function pc(e,n,t=[...oe]){let i={};for(let r of oe)t.includes(r)&&(i[r]=Lt());let a={schemaVersion:4,id:J(),name:e,values:[],slotIndex:n,elements:[],supportedFamilies:Fi.filter(r=>t.includes(r)),perFamily:i,dataSources:[],refreshMinutes:0,tapAction:{type:"refresh"}};return t.includes("inline")&&(a.inline={value:L("Text")}),a.schemaVersion=Sn(a),a}function Te(e){let n=t=>({id:J(),colorSlot:{baseColorHex:t},rules:[],frame:{...zi},isHidden:!1});switch(e){case"text":return{kind:e,payload:{...n("#FFFFFF"),value:L("Text"),fontSize:14,fontWeight:"regular"}};case"icon":return{kind:e,payload:{...n("#FFFFFF"),symbol:L("lightbulb"),size:14}};case"gauge":return{kind:e,payload:{...n("#FFFFFF"),value:L("50"),minValue:0,maxValue:100,style:"arc",lineWidth:4,trackColorHex:"#FFFFFF40",coloring:"uniform",bands:[],bandAboveColorHex:le,thresholdColorHex:ri}};case"chart":return{kind:e,payload:{...n("#FFFFFF"),value:L("13,14,16,17,19,22,24,28,30"),historyMinutes:Ga,historyPoints:24,source:Eo,statPeriod:Li,statType:_i,style:"bars",curve:"smooth",fillStyle:"fade",limit:0,takeFromEnd:!1,scale:"auto",minValue:0,maxValue:100,baseline:"lowest",barGap:1.5,lineWidth:2,highlight:"none",highColorHex:Ze,lowColorHex:Qe,marker:"none",coloring:"uniform",bands:[],bandAboveColorHex:le,fillBands:!1,thresholdColorHex:Ro,nowColorHex:Fo,timeLabelCount:wn,labelSize:et,labelColorHex:tt,labelsAbove:!1,hourCycle:kn,minutes:$n}};case"timeline":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,value:L(""),historyMinutes:Vm,bands:[],otherColorHex:Dm,gap:0,cornerRadius:Om,timeLabelCount:jd,labelSize:et,labelColorHex:tt,labelsAbove:!1,hourCycle:kn,minutes:$n}}}case"shape":return{kind:e,payload:{...n("#FFFFFF33"),kind:"roundedRectangle",cornerRadius:6,thickness:1,borderWidth:1}};case"image":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,entity:{entityId:"",displayName:"",domain:"camera"},source:"camera",contentMode:"fill",zoom:1,panX:0,panY:0,cornerRadius:oi,timestampCorner:"topLeading",timestampSize:ja}}}case"tap":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,action:{type:"refresh"}}}}case"chartTimes":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",timeLabelCount:wn,labelSize:et,labelColorHex:tt,hourCycle:kn,minutes:$n}}}case"imageTime":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,image:""}}}case"chartDots":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",dots:"auto"}}}case"chartGrid":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,chart:"",lines:Xt,colorHex:Mt,thickness:Yt}}}}}function L(e){return{kind:{kind:"literal",value:e}}}function Ja(e){switch(e.kind){case"text":return e.payload.fontSize;case"icon":return e.payload.size;case"gauge":return e.payload.lineWidth;case"chart":return e.payload.lineWidth;case"timeline":return;case"shape":return;case"image":return;case"tap":return;case"chartTimes":return;case"chartDots":return;case"chartGrid":return;case"imageTime":return}}var Sd=["circular","corner"],Td=Math.SQRT1_2;function kf(e){return e==="text"||e==="icon"?4:.5}function Za(e,n,t,i){let a=structuredClone(e),r=pe[n],o=pe[t];if(n===t||!r||!o)return a;let s=Sd.includes(n),l=Sd.includes(t),d=s===l?1:l?Td:1/Td,c=Math.min(o.width/r.width,o.height/r.height)*d;if(d!==1){let u=a.frame,p=u.x+u.width/2,m=u.y+u.height/2;a.frame={...u,width:u.width*d,height:u.height*d,x:.5+(p-.5)*d-u.width*d/2,y:.5+(m-.5)*d-u.height*d/2}}return a.size!==void 0&&(a.size=Math.max(kf(i),Math.round(a.size*c*10)/10)),a}function hc(e,n){let t=e.perFamily[n];return!t||Object.keys(t.placements).length===0?e.elements:e.elements.map(i=>{let a=t.placements[i.payload.id];if(!a)return i;let r={...i.payload,frame:a.frame,isHidden:a.isHidden};return a.size!==void 0&&(i.kind==="text"?r.fontSize=a.size:i.kind==="icon"?r.size=a.size:(i.kind==="gauge"||i.kind==="chart")&&(r.lineWidth=a.size)),{kind:i.kind,payload:r}})}function Nn(e){switch(e.kind){case"text":return e.payload.value;case"icon":return e.payload.symbol;case"gauge":return e.payload.value;case"chart":return e.payload.value;case"timeline":return e.payload.value;case"shape":return;case"image":return{kind:{kind:"entityState",...e.payload.entity}};case"tap":return;case"chartTimes":return;case"chartDots":return;case"chartGrid":return;case"imageTime":return}}function Ii(e){let n=[],t=i=>{for(let a of i)a.value&&n.push(a.value)};for(let i of e){for(let a of i.cases){for(let r of a.when.tests)n.push(r.value),r.comparison.value&&n.push(r.comparison.value),r.comparison.upper&&n.push(r.comparison.upper);t(a.then)}i.otherwise&&t(i.otherwise)}return n}var Qo=["light","switch","fan","input_boolean","cover","lock","media_player","siren","humidifier","valve","automation","group"];function _a(e,n){let t,i=n;for(let a=0;i!==void 0&&a<4;a++){let r=i.kind;if(r.kind==="chartStat"){i=Go(e,i)?.payload.value;continue}if("entityId"in r){if(r.entityId==="")return;let o={entityId:r.entityId,displayName:r.displayName,domain:r.domain};return t===void 0?{ref:o}:{ref:o,namedId:t}}if(r.kind!=="named")return;t=r.id.toUpperCase(),i=e.values.find(o=>o.id.toUpperCase()===t)?.value}}function es(e,n){return _a(e,Nn(n))?.ref}function ts(e,n){let t=es(e,n),i=t&&(t.domain||t.entityId.split(".")[0])||"";return t&&Qo.includes(i)?{type:"toggleEntity",...t,domain:i}:{type:"refresh"}}function Ed(e,n,t){if(Ya(n)||t.width<=0||t.height<=0)return{...e};let i=n,a=e.x-i.left/t.width,r=e.x+e.width+i.right/t.width,o=e.y-i.top/t.height,s=e.y+e.height+i.bottom/t.height;return r<a&&(a=r=(a+r)/2),s<o&&(o=s=(o+s)/2),a=ut(a),r=ut(r),o=ut(o),s=ut(s),{...e,x:a,y:o,width:Math.max(0,r-a),height:Math.max(0,s-o)}}function mc(e,n,t){let i=a=>Math.round(a*100)/100||0;return{left:i((e.x-n.x)*t.width),right:i((n.x+n.width-e.x-e.width)*t.width),top:i((e.y-n.y)*t.height),bottom:i((n.y+n.height-e.y-e.height)*t.height)}}function fc(e,n,t,i){let a=e.elements.find(p=>p.payload.id===n);if(!a||a.kind!=="tap"||a.payload.attachedTo===void 0)return;let r=e.elements.find(p=>p.payload.id===a.payload.attachedTo);if(!r)return;let o=e.perFamily[t]?.placements[r.payload.id]?.frame??r.payload.frame,s=ut(i.x),l=ut(i.y),d=ut(i.x+i.width),c=ut(i.y+i.height),u={...i,x:s,y:l,width:Math.max(0,d-s),height:Math.max(0,c-l)};a.payload.outset=mc(o,u,pe[t])}function gc(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i)return;let a=e.perFamily[t];if(!a)return;let r=a.placements[n]?.frame??i.payload.frame,o=pe[t];return{width:r.width*o.width,height:r.height*o.height}}function Ue(e,n){return e.elements.filter(t=>t.kind==="tap"&&t.payload.attachedTo===n)}function be(e,n){return n.kind!=="tap"||n.payload.attachedTo===void 0?!1:e.elements.some(t=>t.payload.id===n.payload.attachedTo&&t.kind!=="tap")}function ns(e,n){let t=e.elements.find(i=>i.payload.id===n);if(t){if(t.kind==="tap"&&t.payload.attachedTo!==void 0){let i=e.elements.find(a=>a.payload.id===t.payload.attachedTo);if(i)return i.payload.id}return t.payload.id}}function an(e){let n=new Map(e.elements.map(a=>[a.payload.id,a])),t=new Map;for(let a of e.elements){if(a.kind!=="tap")continue;let r=a.payload.attachedTo;if(r===void 0)continue;let o=n.get(r);if(!o||o.kind==="tap"||r===a.payload.id){delete a.payload.attachedTo;continue}let s=t.get(r);s?s.push(a):t.set(r,[a])}if(t.size===0)return;for(let[a,r]of t){let o=n.get(a);for(let s of r){let l=s.payload;l.outset===void 0&&(l.outset=mc(o.payload.frame,l.frame,pe.rectangular));let d=l.outset,c=!Ya(d);s.payload.frame=Ed(o.payload.frame,d,pe.rectangular),s.payload.isHidden=o.payload.isHidden;let u=Sf(e,a);for(let p of oe){let m=e.perFamily[p];if(!m)continue;let g=pe[p],y=m.placements[a];p!==u||!y?delete m.placements[s.payload.id]:c?m.placements[s.payload.id]={frame:Ed(y.frame,d,g),isHidden:y.isHidden}:m.placements[s.payload.id]={frame:{...y.frame},isHidden:y.isHidden}}}}let i=[];for(let a of e.elements){if(a.kind==="tap"&&a.payload.attachedTo!==void 0)continue;i.push(a);let r=t.get(a.payload.id);r&&i.push(...r)}e.elements=i}function Qa(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind==="tap")return;let a=Ue(e,n)[0];if(a)return a.payload;let r=Te("tap"),o=r.payload;return o.attachedTo=n,o.outset={...Vo},o.action=t??ts(e,i),e.elements.push(r),an(e),o}function er(e,n){let t=Ue(e,n).map(i=>i.payload.id);if(t.length!==0){e.elements=e.elements.filter(i=>!t.includes(i.payload.id));for(let i of oe)for(let a of t)delete e.perFamily[i]?.placements[a]}}function ye(e,n){for(let a of Ln(e,n))ye(e,a.payload.id);for(let a of nn(e,n))ye(e,a.payload.id);for(let a of zn(e,n))ye(e,a.payload.id);for(let a of Pn(e,n))ye(e,a.payload.id);for(let a of Wo(e,n))ye(e,a.payload.id);for(let a of Be(e,n))delete a.payload.chartAnchor;let t=e.elements.find(a=>a.payload.id===n);er(e,n),e.elements=e.elements.filter(a=>a.payload.id!==n);let i=t?.payload.chartAnchor;if(i&&(i.at==="threshold"||i.at==="now")&&!Be(e,i.layer).some(a=>a.payload.chartAnchor?.at===i.at)){let a=e.elements.find(r=>r.payload.id===i.layer);a?.kind==="chart"&&(i.at==="threshold"?(delete a.payload.thresholdValue,delete a.payload.drawsThreshold):(delete a.payload.nowIndex,delete a.payload.drawsNowLine))}for(let a of e.elements)a.kind==="chart"&&a.payload.scaleFrom===n&&delete a.payload.scaleFrom;for(let a of oe)delete e.perFamily[a]?.placements[n];an(e),lt(e)}function yc(e,n){let t=e.elements.findIndex(l=>l.payload.id===n),i=e.elements[t];if(!i)return;let a=J(),r=structuredClone(i);r.payload.id=a,r.payload.frame={...r.payload.frame,x:Math.min(.9,r.payload.frame.x+.05),y:Math.min(.9,r.payload.frame.y+.05)};let o=[r],s=[[n,a]];for(let l of Ue(e,n)){let d=structuredClone(l);d.payload.id=J(),d.payload.attachedTo=a,o.push(d),s.push([l.payload.id,d.payload.id])}e.elements.splice(t+1,0,...o);for(let l of oe){let d=e.perFamily[l];if(d)for(let[c,u]of s){let p=d.placements[c];p&&(d.placements[u]=structuredClone(p))}}return an(e),a}function $f(e,n){let t=/^(.*\S) \d+$/.exec(e)?.[1]??e,i=new Set(n),a=2;for(;i.has(`${t} ${a}`);)a++;return`${t} ${a}`}function bc(e,n,t){let i=e.elements.findIndex(s=>s.payload.id===n),a=e.elements[i];if(!a||a.kind!=="chart")return;let r=J(),o=structuredClone(a);o.payload.id=r,o.payload.scaleFrom=n,t&&(o.payload.name=$f(t(a),e.elements.map(t))),e.elements.splice(i+1,0,o);for(let s of oe){let l=e.perFamily[s],d=l?.placements[n];l&&d&&(l.placements[r]=structuredClone(d))}return r}function ci(e,n,t){let i=new Set,a=d=>{i.add(d);for(let c of Ue(e,d))i.add(c.payload.id)};for(let d of n){a(d);for(let c of Ln(e,d))a(c.payload.id)}let r=e.elements.filter(d=>i.has(d.payload.id)).map(d=>structuredClone(d)),o={};for(let d of oe){let c=e.perFamily[d];if(!c)continue;let u={};for(let p of r){let m=c.placements[p.payload.id];m&&(u[p.payload.id]=structuredClone(m))}Object.keys(u).length>0&&(o[d]=u)}let s=new Set(r.map(d=>d.payload.groupId).filter(d=>d!==void 0)),l=(e.groups??[]).filter(d=>s.has(d.id)).map(d=>structuredClone(d));return{elements:r,placements:o,groups:l,...t!==void 0?{family:t}:{}}}function xc(e,n,t){let i=n.family,a=i!==void 0&&i!==t&&oe.includes(i);if(!oe.includes(t))return Cn(e,n);let r=Cn(e,n,a?{nudge:!1}:{}),o=e.perFamily[t]??(e.perFamily[t]=Lt());for(let s of r){let l=e.elements.find(p=>p.payload.id===s);if(!l)continue;let d=(i!==void 0?e.perFamily[i]?.placements[s]:void 0)??oe.map(p=>e.perFamily[p]?.placements[s]).find(p=>p!==void 0),c=d?.size??Ja(l),u={frame:{...d?.frame??l.payload.frame},isHidden:!1,...c!==void 0?{size:c}:{}};for(let p of oe)p!==t&&delete e.perFamily[p]?.placements[s];o.placements[s]=a?Za(u,i,t,l.kind):u}return ui(e,t),r}function Cn(e,n,t={}){let i=new Map;for(let d of n.elements)i.set(d.payload.id,J());let a=new Set(e.elements.map(d=>d.payload.id)),r=t.nudge!==!1&&n.elements.some(d=>a.has(d.payload.id)),o=d=>r?{...d,x:Math.min(.9,d.x+.05),y:Math.min(.9,d.y+.05)}:d,s=[];for(let d of n.elements){let c=structuredClone(d);if(c.payload.id=i.get(d.payload.id),c.kind==="tap"&&c.payload.attachedTo!==void 0){let u=i.get(c.payload.attachedTo);u?c.payload.attachedTo=u:delete c.payload.attachedTo}if(c.kind==="chart"&&c.payload.scaleFrom!==void 0){let u=i.get(c.payload.scaleFrom);u?c.payload.scaleFrom=u:a.has(c.payload.scaleFrom)||delete c.payload.scaleFrom}if(c.kind==="text")for(let u of c.payload.parts??[]){let p=u.value.kind,m=p.kind==="chartStat"?i.get(p.layer):void 0;p.kind==="chartStat"&&m&&(p.layer=m)}if(c.kind==="text"&&c.payload.value.kind.kind==="chartStat"){let u=i.get(c.payload.value.kind.layer);if(u)c.payload.value.kind.layer=u;else if(!a.has(c.payload.value.kind.layer))continue}if(c.kind==="chartTimes"||c.kind==="chartDots"||c.kind==="chartGrid"){let u=i.get(c.payload.chart);if(u)c.payload.chart=u;else if(!a.has(c.payload.chart))continue}if(c.kind==="imageTime"){let u=i.get(c.payload.image);if(u)c.payload.image=u;else if(!a.has(c.payload.image))continue}if(c.payload.chartAnchor!==void 0){let u=i.get(c.payload.chartAnchor.layer);u?c.payload.chartAnchor.layer=u:a.has(c.payload.chartAnchor.layer)||delete c.payload.chartAnchor}c.payload.frame=o(c.payload.frame),s.push(c)}let l=new Map;for(let d of n.groups){if(s.filter(p=>p.payload.groupId===d.id&&!(p.kind==="tap"&&p.payload.attachedTo!==void 0)).length<2)continue;let u=J();l.set(d.id,u),(e.groups??=[]).push({...structuredClone(d),id:u})}for(let d of s){if(d.payload.groupId===void 0)continue;let c=l.get(d.payload.groupId);c?d.payload.groupId=c:delete d.payload.groupId}e.elements.push(...s);for(let d of oe){let c=n.placements[d],u=e.perFamily[d];if(!(!c||!u))for(let[p,m]of Object.entries(c)){let g=i.get(p);g&&s.some(y=>y.payload.id===g)&&(u.placements[g]={...structuredClone(m),frame:o(m.frame)})}}return an(e),lt(e),di(e),s.filter(d=>!be(e,d)).map(d=>d.payload.id)}function Cf(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?!a.isHidden:!t.payload.isHidden}function Sf(e,n){let t=e.elements.find(r=>r.payload.id===n),a=(t&&t.kind==="tap"?t.payload.attachedTo:void 0)??n;return oe.find(r=>e.supportedFamilies.includes(r)&&e.perFamily[r]?.placements[a]!==void 0)}function yt(e,n){let t=e.perFamily[n];return t?e.elements.filter(i=>{let a=i.kind==="tap"?i.payload.attachedTo:void 0;return t.placements[a??i.payload.id]!==void 0}):[]}function vc(e,n){let t=e.perFamily[n];return t?yt(e,n).filter(i=>!be(e,i)&&!t.placements[i.payload.id]?.isHidden).length:0}function ui(e,n){let t=oe.filter(s=>e.supportedFamilies.includes(s));if(t.length===0)return;let i=n!==void 0&&t.includes(n)?n:t[0];for(let s of t)e.perFamily[s]||(e.perFamily[s]=Lt());let a=()=>e.elements.filter(s=>!be(e,s)),r=new Map,o=new Set;if(n===void 0){let s=new Map(a().map(p=>[p.payload.id,t.filter(m=>Cf(e,m,p))]));for(let[p,m]of s)m[0]&&r.set(p,m[0]);let l=new Map([...a().entries()].map(([p,m])=>[m.payload.id,p]));for(let p of t){let m=a().filter(b=>(s.get(b.payload.id)??[]).includes(p)&&r.get(b.payload.id)!==p).map(b=>b.payload.id);if(m.length===0)continue;let g=ci(e,m,p),y=Cn(e,g,{nudge:!1});y.forEach((b,k)=>{r.set(b,p);let C=y.length===m.length?m[k]:void 0;l.set(b,C!==void 0?l.get(C)??0:l.size)})}for(let p of a())r.has(p.payload.id)||o.add(p.payload.id);let d=p=>t.indexOf(r.get(p)??i),c=a().sort((p,m)=>d(p.payload.id)-d(m.payload.id)||(l.get(p.payload.id)??0)-(l.get(m.payload.id)??0)),u=[];for(let p of c)u.push(p),u.push(...Ue(e,p.payload.id));e.elements=u}for(let s of a()){let l=s.payload.id,d=t.filter(m=>e.perFamily[m].placements[l]!==void 0),c=r.get(l)??d.find(m=>!e.perFamily[m].placements[l].isHidden)??d[0]??i,u=e.perFamily[c]?.placements[l],p={frame:{...u?.frame??s.payload.frame},isHidden:o.has(l)||u?.isHidden===!0,...u?.size!==void 0?{size:u.size}:{}};s.payload.isHidden=!0;for(let m of oe){let g=e.perFamily[m];g&&(m===c?g.placements[l]=p:delete g.placements[l])}}}function tr(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t)return[];let i=[],a=_a(e,Nn(t));if(a){let r=t.kind==="icon"?"symbol":t.kind==="image"?"camera":"value";i.push(a.namedId===void 0?{where:r,ref:a.ref}:{where:r,ref:a.ref,namedId:a.namedId})}for(let r of Ue(e,n)){let o=r.payload.action;!("entityId"in o)||o.entityId===""||i.push({where:"tap",ref:{entityId:o.entityId,displayName:o.displayName,domain:o.domain},tapId:r.payload.id})}for(let r of t.payload.rules)for(let o of r.cases)for(let s of o.when.tests){let l=_a(e,s.value);if(!l)continue;let d={where:"test",ref:l.ref,ruleId:r.id,caseId:o.id,testId:s.id};l.namedId!==void 0&&(d.namedId=l.namedId),i.push(d)}return i}function ko(e,n,t){if(!e)return;let i=e.kind;switch(i.kind){case"entityState":return{...e,kind:{kind:"entityState",...n}};case"entityAge":return{...e,kind:{kind:"entityAge",...n}};case"entityAttribute":return{...e,kind:{kind:"entityAttribute",...n,attribute:i.attribute}};case"literal":return t==="text"||t==="gauge"||t==="chart"||t==="timeline"?{...e,kind:{kind:"entityState",...n}}:void 0;default:return}}function wc(e,n,t,i){let a=e.elements.find(o=>o.payload.id===n);if(!a||t.entityId==="")return;let r={...t,domain:t.domain||t.entityId.split(".")[0]||""};if(a.kind==="timeline"){let o=a.payload.value.kind.kind==="entityState"?a.payload.value.kind.entityId:void 0,s=ko(a.payload.value,r,a.kind);s&&(a.payload.value=s),(a.payload.bands.length===0||o!==r.entityId)&&(a.payload.bands=Oo(r.domain,i))}else if(a.kind==="image")a.payload.entity=r;else if(a.kind==="text"||a.kind==="gauge"||a.kind==="chart"){let o=ko(a.payload.value,r,a.kind);o&&(a.payload.value=o)}else if(a.kind==="icon"){let o=ko(a.payload.symbol,r,a.kind);o&&(a.payload.symbol=o)}for(let o of Ue(e,n)){let s=o.payload;"entityId"in s.action&&(s.action={type:s.action.type,...r})}}var Tf={text:"text",icon:"icon",gauge:"gauge",chart:"chart",timeline:"timeline",shape:"shape",image:"picture",tap:"tap area",chartTimes:"clock times",chartDots:"chart dots",chartGrid:"chart grid",imageTime:"timestamp"};function Md(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Rd(e){if(e.part==="template")return"Template text";if(e.part==="serviceData")return"Service data";let n=e.layerKind===void 0?"":Tf[e.layerKind],t=e.layerName?`${n} "${e.layerName}"`:n;switch(e.kind){case"named":return e.valueName?`Shared value "${e.valueName}"`:"Shared value";case"layer":case"image":return e.part==="total"?`Total on ${t}`:e.part==="gaugeMin"?`Min on ${t}`:e.part==="gaugeMax"?`Max on ${t}`:e.part==="nowIndex"?`Now marker on ${t}`:e.part==="textPart"?`Part of ${t}`:`${Md(n)} layer${e.layerName?` "${e.layerName}"`:""}`;case"tap":return"Tap area";case"documentTap":return"Tap action";case"rule":return t===""?`Rule on the ${e.family??"shared"} shape`:`Rule on ${t}`;case"layout":{let i=Md(e.family??"");switch(e.part){case"curvedText":return`${i} curved text`;case"bezelGauge":return`${i} bezel gauge`;case"bezelGaugeMin":return`${i} bezel gauge low label`;case"bezelGaugeMax":return`${i} bezel gauge high label`;default:return`${i} bezel`}}case"inline":return"Inline"}}var kc=/(['"])([a-z0-9_]+\.[a-z0-9_]+)\1/g;function Ef(e){let n=[];for(let t of e.matchAll(kc))t[2]!==void 0&&n.push(t[2]);return n}function is(e,n){return n.size===0?e:e.replace(kc,(t,i,a)=>{let r=n.get(a);return r===void 0?t:`${i}${r}${i}`})}function Ri(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function Mf(e,n){if(n.payload.name)return n.payload.name;if(n.kind==="shape")return n.payload.kind==="roundedRectangle"?"rounded rectangle":n.payload.kind;if(n.kind==="tap")return"";if(n.kind==="image")return n.payload.entity.displayName||n.payload.entity.entityId;let t=Nn(n)?.kind;if(t===void 0)return"";if(t.kind==="literal")return t.value;if("entityId"in t)return t.displayName||t.entityId;if(t.kind==="named"){let i=t.id.toUpperCase();return e.values.find(a=>a.id.toUpperCase()===i)?.name??""}return""}function nr(e,n){let t=(r,o)=>{n.value?.(r,o);let s=r.kind;if(s.kind==="jinja"){if(n.text){let d=n.text(s.value,{...o,part:"template"});d!==s.value&&(s.value=d)}return}if(s.kind==="aggregate"){let d=s.aggregate.scope;if(n.ref&&d.kind==="entities")for(let c=0;c<d.entities.length;c++){let u=n.ref(Ri(d.entities[c]),o);u&&(d.entities[c]=u)}return}if(!n.ref||!("entityId"in s))return;let l=n.ref(Ri(s),o);l&&(s.kind==="entityAttribute"?r.kind={kind:"entityAttribute",...l,attribute:s.attribute}:s.kind==="entityState"?r.kind={kind:"entityState",...l}:r.kind={kind:"entityAge",...l})},i=(r,o,s)=>{if(r.type==="callService"){if(n.ref&&r.target!==void 0&&r.target.entityId!==""){let d=n.ref(Ri(r.target),o);d&&(r.target=d)}if(n.text&&r.serviceDataJSON!==void 0){let d=n.text(r.serviceDataJSON,{...o,part:"serviceData"});d!==r.serviceDataJSON&&(r.serviceDataJSON=d)}return}if(!n.ref||!("entityId"in r)||r.entityId==="")return;let l=n.ref(Ri(r),o);l&&s({type:r.type,...l})};for(let r of e.values)t(r.value,{kind:"named",valueId:r.id,valueName:r.name});for(let r of e.elements){let o={kind:"layer",layerId:r.payload.id,layerKind:r.kind,layerName:Mf(e,r)};if(r.kind==="image"){if(n.ref){let l=n.ref(Ri(r.payload.entity),{...o,kind:"image"});l&&(r.payload.entity=l)}}else if(r.kind==="tap"){let l=r.payload;i(l.action,{...o,kind:"tap"},d=>{l.action=d})}else{let l=Nn(r);if(l&&t(l,o),r.kind==="text")for(let d of r.payload.parts??[])t(d.value,{...o,part:"textPart"});r.kind==="gauge"&&r.payload.total&&t(r.payload.total,{...o,part:"total"}),r.kind==="gauge"&&r.payload.minSource&&t(r.payload.minSource,{...o,part:"gaugeMin"}),r.kind==="gauge"&&r.payload.maxSource&&t(r.payload.maxSource,{...o,part:"gaugeMax"}),r.kind==="chart"&&r.payload.nowIndex&&t(r.payload.nowIndex,{...o,part:"nowIndex"})}let s={...o,kind:"rule"};for(let l of Ii(r.payload.rules))t(l,s)}let a=Object.keys(e.perFamily).sort((r,o)=>{let s=Fi.indexOf(r),l=Fi.indexOf(o);return(s<0?Fi.length:s)-(l<0?Fi.length:l)});for(let r of a){let o=e.perFamily[r];if(!o)continue;let s={kind:"layout",family:r};o.bezelText&&t(o.bezelText,{...s,part:"bezelText"}),o.curvedText&&t(o.curvedText,{...s,part:"curvedText"});let l=o.bezelGauge;l&&(t(l.value,{...s,part:"bezelGauge"}),l.minLabel&&t(l.minLabel,{...s,part:"bezelGaugeMin"}),l.maxLabel&&t(l.maxLabel,{...s,part:"bezelGaugeMax"}));let d={kind:"rule",family:r};for(let c of Ii(o.rules))t(c,d)}e.inline&&t(e.inline.value,{kind:"inline"}),i(e.tapAction,{kind:"documentTap"},r=>{e.tapAction=r})}function ir(e,n){nr(e,{value:n})}function $c(e,n){return e.kind.kind==="named"&&e.kind.id.toUpperCase()===n.toUpperCase()}function Gi(e,n){let t=new Set;return ir(e,(i,a)=>{$c(i,n)&&t.add(a.layerId??`${a.kind}:${a.valueId??""}:${a.family??""}:${a.part??""}`)}),t.size}function Rf(e,n){let t=new Set(e.values.map(a=>a.name.trim().toLowerCase())),i=n.trim()||"Value";if(!t.has(i.toLowerCase()))return i;for(let a=2;;a++){let r=`${i} ${a}`;if(!t.has(r.toLowerCase()))return r}}function as(e,n,t){let i={id:J(),name:Rf(e,t),value:{kind:structuredClone(n.kind)}},a={kind:{kind:"named",id:i.id}};return n.format&&!Ie(n.format)&&(a.format=structuredClone(n.format)),{named:i,ref:a}}function rs(e,n){if(n.kind.kind!=="named")return;let t=n.kind.id,i=e.values.find(o=>o.id.toUpperCase()===t.toUpperCase());if(!i)return;let a=n.format&&!Ie(n.format)?n.format:i.value.format,r={kind:structuredClone(i.value.kind)};return a&&!Ie(a)&&(r.format=structuredClone(a)),r}function os(e,n){ir(e,t=>{if(!$c(t,n))return;let i=rs(e,t);i&&(t.kind=i.kind,i.format?t.format=i.format:delete t.format)}),e.values=e.values.filter(t=>t.id.toUpperCase()!==n.toUpperCase())}function ss(e,n){nr(e,{ref:n})}function ls(e,n){nr(e,{text:n})}function ds(e,n){let t=[],i={ref:(a,r)=>{a.entityId!==""&&t.push({entityId:a.entityId,ref:a,where:Rd(r)})}};return n&&(i.text=(a,r)=>{for(let o of Ef(a)){let s=o.split(".")[0]??"";n(o,s)&&t.push({entityId:o,ref:{entityId:o,displayName:"",domain:s},where:Rd(r)})}return a}),nr(e,i),t}var Ui={text:["color","opacity","text","fontSize","fontWeight","rotation","visibility"],icon:["color","opacity","icon","fontSize","rotation","visibility"],gauge:["color","opacity","gaugeValue","gaugeMin","gaugeMax","rotation","visibility"],chart:["color","opacity","rotation","visibility"],timeline:["opacity","rotation","visibility"],shape:["color","opacity","borderColor","borderWidth","rotation","visibility"],image:["opacity","rotation","visibility"],tap:["visibility"],chartTimes:["opacity","rotation","visibility"],chartDots:["opacity","visibility"],chartGrid:["opacity","visibility"],imageTime:["opacity","rotation","visibility"],layout:["backgroundColor","borderColor","borderWidth","text"]},Cc=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","greaterThan","greaterOrEqual","lessThan","lessOrEqual","between","timeBetween","contains","startsWith","endsWith","matchesRegex","isOneOf"];function Dn(e){let n=e.trim();return/^([01][0-9]|2[0-3]):[0-5][0-9]$/.test(n)?n:void 0}function On(e){switch(e){case"isOn":case"isOff":case"isUnavailable":case"isStale":case"isEmpty":return"none";case"between":return"between";case"timeBetween":return"times";case"matchesRegex":return"pattern";case"isOneOf":return"options";default:return"value"}}function ar(e){switch(e){case"hide":case"show":return"none";case"setFontWeight":return"weight";case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":return"number";default:return"value"}}function cs(){return{id:J(),value:L(""),comparison:{kind:"isOn"}}}function us(){return{id:J(),when:{join:"all",tests:[cs()]},then:[]}}function Ki(){return{id:J(),cases:[us()]}}function Fd(e,n){return e&&(e.kind.kind!=="literal"||Dn(e.kind.value)!==void 0)?e:L(n)}function ps(e,n){let t={kind:n};switch(On(n)){case"value":t.value=e.value??L("");break;case"between":t.value=e.value??L(""),t.upper=e.upper??L("");break;case"times":t.value=Fd(e.value,"22:00"),t.upper=Fd(e.upper,"06:00");break;case"pattern":t.pattern=e.pattern??"";break;case"options":t.options=e.options??[];break;case"none":break}return t}function Vn(e){let n={kind:e};switch(ar(e)){case"value":n.value=L(e==="setColor"||e==="setBorderColor"||e==="setBackgroundColor"?"#FF453A":e==="setIcon"?"exclamationmark.triangle":e==="setGaugeValue"?"50":"Text");break;case"number":n.number=e==="setOpacity"?.5:e==="setFontSize"?14:e==="setBorderWidth"?2:e==="setGaugeMax"?100:0;break;case"weight":n.weight="bold";break;case"none":break}return n}var rr="shared:";function hs(e){return rr+e.toUpperCase()}function Tc(e){return e.values.filter(n=>n.value.kind.kind!=="entityState"&&Gi(e,n.id)>0)}function Ec(e,n){return n.size===0?e:e.map(t=>{let i=n.get(hs(t.id));if(i===void 0)return t;let a={kind:{kind:"literal",value:i}};return t.value.format&&(a.format=t.value.format),{...t,value:a}})}var Ff=["unavailable","unknown"],Af={automation:["on","off"],script:["on","off"],remote:["on","off"],update:["on","off"],timer:["idle","active","paused"],sun:["above_horizon","below_horizon"],valve:["open","closed","opening","closing"],lawn_mower:["mowing","docked","paused","returning","error"],weather:["sunny","clear-night","partlycloudy","cloudy","rainy","pouring","snowy","snowy-rainy","fog","windy","windy-variant","lightning","lightning-rainy","hail","exceptional"]},Hf=new Set(["\xB0C","\xB0F"]);function Sc(e){return Array.isArray(e)&&e.length>0&&e.every(n=>typeof n=="string")?e:void 0}function Wi(e){let n=typeof e=="number"?e:typeof e=="string"&&e.trim()!==""?Number(e):NaN;return Number.isFinite(n)?n:void 0}function If(e){let n=e?.trim().match(/\.(\d+)$/)?.[1]?.length??0;return n===0?1:10**-Math.min(n,4)}function Lf(e){let n=10**Math.floor(Math.log10(e));return([1,2,2.5,5,10].find(i=>i*n>=e)??10)*n}function _f(e){let n=new Set,t=[];for(let i of e)i===void 0||i===""||n.has(i)||(n.add(i),t.push(i));return t}function Mc(e,n,t){let i=e.split(".")[0]??"",a=n?.attributes??{},o=Sc(a.options)??(i==="climate"?Sc(a.hvac_modes):void 0)??Oi[i]??Af[i];if(o)return{kind:"choice",options:_f([...o,n?.state,t,...Ff])};let s=Wi(n?.state),l=typeof a.unit_of_measurement=="string"?a.unit_of_measurement:void 0;if(s===void 0&&l===void 0&&i!=="input_number"&&i!=="number")return{kind:"text"};let d=Wi(t),c=Wi(a.min),u=Wi(a.max),p=Wi(a.step),m,g;if(c!==void 0&&u!==void 0&&u>c)m=c,g=u;else if(l==="%")m=0,g=100;else{let b=Lf(Math.max(Math.abs(s??0)*2,10));m=(s??0)<0||l!==void 0&&Hf.has(l)?-b:0,g=b}d!==void 0&&(m=Math.min(m,d),g=Math.max(g,d));let y=p!==void 0&&p>0?p:If(n?.state);return{kind:"number",min:m,max:g,step:y}}function Rc(e){if(e.appliedToken===void 0)return{kind:"unsupported"};if(e.token===e.appliedToken){let n=!e.polling&&typeof e.lastPollSeconds=="number"?e.lastPollSeconds:void 0;return n===void 0?{kind:"sent"}:{kind:"sent",awaySeconds:n}}return e.pending&&e.polling?{kind:"sending"}:e.polling?{kind:"waiting"}:{kind:"offline"}}function zf(e){if(e<60)return"just now";let n=Math.floor(e/60);if(n<60)return`${n} min ago`;let t=Math.floor(n/60);if(t<24)return`${t} h ago`;let i=Math.floor(t/24);return`${i} ${i===1?"day":"days"} ago`}function Fc(e){switch(e.kind){case"unsupported":return{label:"Update the watch app",note:"to receive this",title:"This watch has never reported which changes it applied, so nothing saved here can reach it. Its Wrist Assistant app is older than custom complications, or it has not been opened on this home yet.",resend:!1};case"sent":return e.awaySeconds===void 0?{label:"On watch",title:"The watch has applied every change here.",resend:!1}:{label:"On watch",note:`last seen ${zf(e.awaySeconds)}`,title:"The watch has applied every change here, but it is not listening now. A save made after this will not reach it until the watch app is open on this home again.",resend:!1};case"sending":return{label:"Sending\u2026",title:"Waiting for the watch to pull and confirm.",resend:!1};case"waiting":return{label:"Not on watch yet",title:"The watch is connected but has not confirmed the latest change. Resend wakes it again.",resend:!0};case"offline":return{label:"Open the watch app to sync",title:"Saves reach the watch by themselves while Wrist Assistant is open on this home. Open the app, or switch the watch to this home, and it pulls at once.",resend:!0}}}function Hc(e){let n=new TextEncoder().encode(e),t=0xcbf29ce484222325n,i=0x100000001b3n,a=0xffffffffffffffffn;for(let r of n)t^=BigInt(r),t=t*i&a;return t.toString(16)}function Ic(e){return new Map(e.map(n=>[n.id.toUpperCase(),n.value]))}function Ac(e){return e.kind==="entityAttribute"||e.kind==="entityAge"||e.kind==="aggregate"||e.kind==="time"||e.kind==="jinja"}function ms(e,n,t=0){let i=n instanceof Map?n:Ic(n),a=e.kind;if(a.kind==="named"){if(t>8)return;let o=i.get(a.id.toUpperCase());return o?o.kind.kind==="named"?ms(o,i,t+1):Ac(o.kind)?"n_"+a.id.toLowerCase().replace(/-/g,""):void 0:void 0}if(!Ac(a))return;let r=ji(a);if(r!==void 0)return"e_"+Hc(r)}function dt(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function Pf(e){let n;if(e.scope.kind==="entities")n=`expand([${e.scope.entities.map(o=>dt(o.entityId)).join(", ")}])`;else{let{domains:o,areaIds:s,labelIds:l,floorIds:d}=e.scope;if(!(s.length+l.length+d.length>0))n=o.length===0?"[]":"("+o.map(u=>`(states.${u} | list)`).join(" + ")+")";else{let u=[];for(let p of s)u.push(`area_entities(${dt(p)})`);for(let p of l)u.push(`label_entities(${dt(p)})`);d.length>0&&u.push(`((${d.map(p=>`floor_areas(${dt(p)})`).join(" + ")}) | map('area_entities') | sum(start=[]))`),n=`(expand(${u.join(" + ")})`,o.length>0&&(n+=` | selectattr('domain', 'in', [${o.map(dt).join(", ")}])`),n+=")"}}let t=n,i=e.stateFilter;if(i&&(i.kind==="isOn"?t+=" | selectattr('state', 'eq', 'on')":i.kind==="isOff"?t+=" | selectattr('state', 'eq', 'off')":i.kind==="equals"?t+=` | selectattr('state', 'eq', ${dt(i.value)})`:t+=` | rejectattr('state', 'eq', ${dt(i.value)})`),e.function==="count")return`(${t} | list | count)`;let a=e.attribute?`attributes.${e.attribute}`:"state",r=`${t} | map(attribute=${dt(a)}) | map('float', 0) | list`;switch(e.function){case"sum":return`(${r} | sum)`;case"average":return`(${r} | average(0))`;case"min":return`(${r} | min(default=0))`;case"max":return`(${r} | max(default=0))`}}function ji(e){switch(e.kind){case"entityAttribute":return`state_attr(${dt(e.entityId)}, ${dt(e.attribute)})`;case"entityAge":{let n=dt(e.entityId);return`(((now() - states[${n}].last_changed).total_seconds() if states[${n}] is not none else 0) | round(0))`}case"time":switch(e.timeField){case"now":return"now().strftime('%H:%M')";case"hour":return"now().hour";case"minute":return"now().minute";case"day":return"now().day";case"month":return"now().month";case"weekday":return"now().weekday()";case"timestamp":return"(as_timestamp(now()) | round(0))"}return;case"jinja":return e.value.trim().length===0?void 0:e.value;case"aggregate":return Pf(e.aggregate);default:return}}function or(e){let n=new Map,t=new Map,i=Ic(e.values),a=(o,s=0)=>{let l=o.kind;switch(l.kind){case"literal":case"dataAge":case"chartStat":return;case"entityState":n.set(l.entityId,l);return;case"named":{if(s>8)return;let d=i.get(l.id.toUpperCase());if(!d)return;if(d.kind.kind==="named"){a(d,s+1);return}if(d.kind.kind==="entityState"){n.set(d.kind.entityId,d.kind);return}let c=ji(d.kind);if(c===void 0)return;t.set("n_"+l.id.toLowerCase().replace(/-/g,""),c);return}default:{let d=ji(l);if(d===void 0)return;t.set("e_"+Hc(d),d)}}};for(let o of e.values)a({kind:{kind:"named",id:o.id}});for(let o of e.elements){let s=Nn(o);if(s&&a(s),o.kind==="text")for(let l of o.payload.parts??[])a(l.value);o.kind==="gauge"&&o.payload.total&&a(o.payload.total),o.kind==="gauge"&&o.payload.minSource&&a(o.payload.minSource),o.kind==="gauge"&&o.payload.maxSource&&a(o.payload.maxSource),o.kind==="chart"&&o.payload.nowIndex&&a(o.payload.nowIndex);for(let l of Ii(o.payload.rules))a(l)}for(let o of oe){if(!e.supportedFamilies.includes(o))continue;let s=e.perFamily[o];if(s){s.bezelText&&a(s.bezelText),s.curvedText&&a(s.curvedText),s.bezelGauge&&(a(s.bezelGauge.value),s.bezelGauge.minLabel&&a(s.bezelGauge.minLabel),s.bezelGauge.maxLabel&&a(s.bezelGauge.maxLabel));for(let l of Ii(s.rules))a(l)}}e.supportedFamilies.includes("inline")&&e.inline&&a(e.inline.value);let r={entities:n,expressions:t};return t.size>0&&(r.document=Nf(t)),r}function Nf(e){let n=[...e.keys()].sort(),t=[];for(let a of n){let r=e.get(a);r.includes("{{")||r.includes("{%")?t.push(`{% set v_${a} %}${r}{% endset %}`):t.push(`{% set v_${a} = ${r} %}`)}let i=n.map(a=>`"${a}": v_${a}`).join(", ");return t.push(`{{ { ${i} } | to_json }}`),t.join(`
`)}function Lc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Df(r));return{values:t,nullKeys:i}}function Df(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function fs(e){let n=or(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Of(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Ao(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Vf=10800;function Bf(e,n,t){let i=n==="always"||n==="auto"&&t<=Vf;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function sr(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Bf(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Gf(e,n){return gt(e)===void 0?[]:sr(ot(e)*60,Di(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Uf(e,n){return Fn(e)?sr(Math.round(e.historyMinutes)*60,Di(ht(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Kf(e,n,t,i){return n===void 0&&i!==void 0?gt(i)===void 0?[]:sr(ot(i)*60,Di(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!Fn(n)?[]:sr(Math.round(n.historyMinutes)*60,Di(ht(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Bn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ke(e){let n=e.trim(),t=Bn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Bn(i)}function Wf(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function jf(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function qf(e){let n=e.trim(),t=Bn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Bn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Bn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Yf(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Xf(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Jf(e,n,t){if(Ie(n))return e;let i=n,a=e,r=Bn(e.trim()),o=i.duration?qf(e):void 0;if(o!==void 0)a=Yf(o);else if(i.relativeTime&&r!==void 0)a=jf(r);else{let s=Ke(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Wf(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Xf(a);break}return a}function pi(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function We(e,n=240){return Dc(e,n).map(t=>t.value)}function ys(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of We(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:Nc(r)}}function Nc(e){return e.some(n=>n)?e:[]}function Dc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function _c(e,n,t){let i=Dc(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Jt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??le,c=t.highColorHex??Ze,u=t.lowColorHex??Qe,p=[],m=(y,b)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===b?k.text+=y:p.push({text:y,colorHex:b})},g=0;return i.forEach((y,b)=>{m(e.slice(g,y.start),n);let k=b===o?c:b===s?u:l.length>0?Ba(y.value,l,d):n,C=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,C),k),g=C}),m(e.slice(g),n),p}function zc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Zf(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Yi(e,n=tn){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Qf(i.slice(a+1))})}return t}function Qf(e){try{return decodeURIComponent(e)}catch{return e}}function eg(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Pc(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function tg(e,n,t){if(e===void 0)return 0;let i=Ke(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var bt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=zc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=An(n),i=Hn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?ys(a):{values:We(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=Nc(s),{values:bs(o,at(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ke(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ke(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):zc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ie(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Of(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?Vd(r):Ao(r,a.domainMax-a.domainMin));break}default:{let a=ms(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Jf(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Bn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?pi(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ke(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ke(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ke(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Dn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Dn(d),p=c===void 0?void 0:Dn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Pe[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=_c(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=rt(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(zd(n.payload)&&(y.spans=_c(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let k={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(B,z,j)=>B??(z?Ke(this.resolve(z)??""):void 0)??j,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Ke(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=Ba(k,Jt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let B=Ke(this.resolve(p.total)??"");B!==void 0&&(w=B)}let S=Pc(w,1,Va),I={kind:"gauge",...u,fraction:tg(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:Pc(k??0,0,S)};if(p.thresholdValue!==void 0&&b!==y){let B=(p.thresholdValue-y)/(b-y);B>=0&&B<=1&&(I.thresholdFraction=B)}return I}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Jt(p),w=Od(p)?g.map(Z=>Ba(Z,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",I=p.highlight==="lowest"||p.highlight==="both",B=Hi(p),z={kind:"chart",...u,values:g,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?B.high:"none",lowMarker:I?B.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:at(p.smoothing)??"off",fillStyle:Wt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:jt(p.barRadius),barCorners:qt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Uf(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},j=y.length===0?g:g.filter((Z,H)=>!y[H]);if(j.length>0){let Z=A=>g.findIndex((K,R)=>K===A&&y[R]!==!0),H=S?Z(Math.max(...j)):-1,Q=I?Z(Math.min(...j)):-1;H>=0&&(z.highIndex=H),Q>=0&&Q!==H&&(z.lowIndex=Q)}let M=Zf(p,b.min,b.max);M!==void 0&&(z.thresholdY=M);let U=this.chartNowIndex(p,g.length);return U!==void 0&&(z.nowIndex=U),z}case"timeline":{let p=n.payload,m=gt(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=Yi(g,tn),b=eg(y,ot(p)*60,C=>qd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:Gf(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};qa(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Kf(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),g={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(g.url=y),g}case"chartDots":{let p=n.payload,m=pt(p.size),g={kind:"chartDots",...u,chart:p.chart,dots:za(p.dots),diameter:0,indices:[]};return m!==void 0&&(g.size=m),p.colorHex!==void 0&&(g.colorHex=p.colorHex),g}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Tn(p.lines),colorHex:Gt(p.colorHex),thickness:En(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...sg(og(hc(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,k=this.resolve(b.value),C=k===void 0?void 0:Ke(k);if(C!==void 0){let w=Math.min(b.minValue,b.maxValue),S=Math.max(b.minValue,b.maxValue),I={value:Math.min(S,Math.max(w,C)),minValue:w,maxValue:S===w?w+1:S,colorHexes:b.colorHexes},B=this.resolve(b.minLabel);B!==void 0&&(I.minLabel=B);let z=this.resolve(b.maxLabel);z!==void 0&&(I.maxLabel=z),l.bezelGauge=I}}let g=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;g!==void 0&&(l.backgroundColorHex=g);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function ng(e,n,t){let i=new bt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function hi(e,n,t){let i=new bt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=ng(e.inline,n,e)),a}function Xi(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var gs=5,ig=1.7,ag=1.8;function rg(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function og(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*ag,l=Math.max(o.frame.width*n.width,0),d=rg(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function Oc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function Vc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function lr(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=z=>z==="triangle"?gs+d:z==="dot"?Math.max(d,ig):d,u=c(a),p=c(r),m=n.y+u,g=Math.max(n.h-u-p,1),y=m+g,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?g*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-w*(i-1))/i,.5),I=z=>Math.min(1,Math.max(0,(z-e.domainMin)/b)),B=z=>y-I(z)*g;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:B(0),inset:d,yAtFraction(z){return y-Math.min(Math.max(z,0),1)*g},barRect(z){let j=o+z*(S+w),M=t[z],U,Z;if(k){let H=C+I(M)*(g-C);U=y-H,Z=y}else U=B(M),Z=k?y:B(0),U>Z&&([U,Z]=[Z,U]);return{x:j,y:U,w:S,h:Math.max(Z-U,.5)}},point(z){let j=Math.max(s-d*2,0);return{x:t.length>1?o+d+j*z/(t.length-1):o+s/2,y:B(t[z])}},markerCenter(z,j,M="high"){let U=j?this.barRect(z):void 0,Z=U?U.x+U.w/2:this.point(z).x,H=M==="high"?a:r,Q=M==="high"?H==="triangle"?n.y+gs/2:m:H==="triangle"?n.y+n.h-gs/2:y;return{x:Z,y:Q}}}}function Bc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function bs(e,n,t=[]){let i=e.length,a=_d(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,g=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,k=Math.exp(-(b*b)/(2*o*o));m+=e[y]*k,g+=k}return m/g}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function Gc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var qi=1;function Gn(e,n){let t=Math.max(Qt,Math.min(en,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-qi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+qi:n.y,h:n.h-i-qi,cy:(e.labelsAbove?n.y+i+qi:n.y)+(n.h-i-qi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function sg(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&Oc(r)===void 0)return{...i,isHidden:!0};let o=dg(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function lg(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function dg(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Xi(t,i);if(a.w<=0||a.h<=0)return;let r=Gn(t,a).body;if(r.w<=0||r.h<=0)return;let o=lr(t,r),s,l;if(ft(n.at)){let k=lg(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?Oc(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,w)=>C>w?(C+w)/2:Math.min(Math.max(k,C),w),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var Le=pe,Zi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Le,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],mi=Zi.find(e=>e.measured);function tu(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Zi.find(a=>a.screen.width===t&&a.screen.height===i)}function cr(e,n){let t=Le[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var ws={regular:400,medium:500,semibold:600,bold:700},nu=1.15;function je(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ke(e,n,t="#FFFFFF"){let i=je(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var _t=e=>e*.55;function iu(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function cg(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function ug(e,n,t){if(t<=0||e.length*_t(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/_t(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function pg(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function au(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function ru(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function hg(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function ou(e,n){return e.reduce((t,i)=>t+i.text.length*_t(i.look.fontSize*n),0)}function mg(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:_t(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=_t(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function fg(e,n,t){if(t<=0||ou(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*_t(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*_t(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function gg(e,n,t){let i=hg(n),a=e.lineLimit===2&&t.w>0?mg(e.text,i,t.w):[e.text],r=au(e.text,a),o=a.map((C,w)=>ru(C,r[w]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>ou(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>fg(C,l,t.w)),{anchor:c,x:u}=iu(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=C=>C.map(w=>{let S=ke(w.look.colorHex,"fill");return v`<tspan font-size=${w.look.fontSize*l} font-weight=${ws[w.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${w.text}</tspan>`}),b=ke(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,w)=>v`<tspan x=${u} y=${t.cy+m+(w-(d.length-1)/2)*g}>${y(C)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${b.fill} fill-opacity=${b["fill-opacity"]}>${k}</text>`}function yg(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:gg(e,e.parts,n);let t=ke(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:pi((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?cg(e.text,n.w/_t(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*_t(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>ug(y,o,n.w)),{anchor:l,x:d}=iu(e.alignment,n),c=pg(e.text,e.spans),u=c?au(e.text,i):[],p=(y,b)=>c?ru(y,u[b]??0,e.text,c,e.colorHex).map(k=>{let C=ke(k.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}):y,m=o*1.15,g=s.length>1?v`${s.map((y,b)=>v`<tspan x=${d} y=${n.cy+(b-(s.length-1)/2)*m}>${p(y,b)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${ws[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var ks=2;function su(e,n){let t=n.w>=n.h,i=Math.max(1,e.dotCount),a=t?n.w:n.h,r=t?n.h:n.w,o=Math.max(1,Math.min(r,a/i-ks)),s=i*o+(i-1)*ks;return{horizontal:t,count:i,d:o,span:s}}function bg(e,n){let t=ke(e.colorHex,"stroke"),i=ke(e.trackColorHex,"stroke","#FFFFFF"),a=ke(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let{horizontal:m,count:g,d:y,span:b}=su(e,n),k=(m?n.cx:n.cy)-b/2+y/2;return v`${Array.from({length:g},(C,w)=>{let S=k+w*(y+ks),I=w<e.filledCount?t:i;return v`<circle cx=${m?S:n.cx} cy=${m?n.cy:S} r=${y/2}
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:xg(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function xg(e,n,t,i,a){let r=ke(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return v`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function vg(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Gn(e,n),o=r?Es(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=kg(e,a);return o===void 0?s:v`${s}${o}`}function xs(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var Uc=0;function lu(){return Uc+=1,Uc.toString(36)}function wg(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function kg(e,n){let t=lr(e,n),i=lu(),a=ke(e.colorHex,"fill"),r=ke(e.highColorHex,"fill",e.colorHex),o=ke(e.lowColorHex,"fill",e.colorHex),s=(g,y)=>v`<circle cx=${g.x} cy=${g.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=g=>c?ke(e.pointColorHexes[g],"fill",e.colorHex):a,p=g=>{let y=je(g)??je(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:y.color,opacity:y.opacity*.28};let b=$g(i,e.id,g),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(b)||d.set(b,v`<linearGradient id=${b} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${y.color} stop-opacity=${y.opacity*.28} />
        <stop offset="1" stop-color=${y.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${b})`,opacity:1}};if(e.style==="bars")for(let g=0;g<t.count;g++){if(e.holes[g]===!0)continue;let y=t.barRect(g),b=g===e.highIndex?r:g===e.lowIndex?o:u(g),k=Math.min(Math.max(e.barRadius,0),y.w/2,y.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[g]<0;l.push(v`<path d=${wg(y,k,C)}
          fill=${b.fill} fill-opacity=${b["fill-opacity"]} />`)}else l.push(v`<rect x=${y.x} y=${y.y} width=${y.w} height=${y.h} rx=${k}
          fill=${b.fill} fill-opacity=${b["fill-opacity"]} />`)}else{let g=Array.from({length:t.count},(C,w)=>t.point(w)),y=e.holes.length>0,k=Gc(t.count,e.holes).filter(C=>!y||C.length>1).map(C=>{let w=C.map(B=>g[B]),S=Bc(w,e.curve),I=`M${w[0].x} ${w[0].y}${S.map(B=>` ${xs(B)}`).join("")}`;return{run:C,pts:w,legs:S,line:I}});if(e.style==="area")for(let{run:C,pts:w,legs:S,line:I}of k)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let B=0;B<S.length;B++){let z=w[B],j=w[B+1],M=p(e.pointColorHexes[C[B+1]]),U=`M${z.x} ${z.y} ${xs(S[B])} L${j.x} ${t.baselineY} L${z.x} ${t.baselineY} Z`;l.push(v`<path d=${U} fill=${M.fill} fill-opacity=${M.opacity} stroke="none" />`)}else{let B=p(e.fillColorHex??e.colorHex),z=`${I} L${w[w.length-1].x} ${t.baselineY} L${w[0].x} ${t.baselineY} Z`;l.push(v`<path d=${z} fill=${B.fill} fill-opacity=${B.opacity} stroke="none" />`)}for(let{run:C,pts:w,legs:S,line:I}of k)if(c&&C.length>1)for(let B=0;B<S.length;B++){let z=w[B],j=u(C[B+1]);l.push(v`<path d=${`M${z.x} ${z.y} ${xs(S[B])}`} fill="none"
          ...
          fill=${b.fill} fill-opacity=${b["fill-opacity"]} />`:s(C,b))};if(m(e.highIndex,e.highMarker,r,"high"),m(e.lowIndex,e.lowMarker,o,"low"),e.drawsThreshold&&e.thresholdY!==void 0){let g=t.yAtFraction(e.thresholdY),y=ke(e.thresholdColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${t.plotLeft} ${g} L${t.plotRight} ${g}`} fill="none"
      stroke=${y.fill} stroke-opacity=${y["fill-opacity"]}
      stroke-width="1" stroke-dasharray="2 2" />`)}if(e.drawsNowLine&&e.nowIndex!==void 0&&e.nowIndex<t.count){let g=t.markerCenter(e.nowIndex,e.style==="bars").x,y=ke(e.nowColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${g} ${t.plotTop} L${g} ${t.plotBottom}`} fill="none"
      stroke=${y.fill} stroke-opacity=${y["fill-opacity"]} stroke-width="1" />`)}return d.size===0?v`${l}`:v`<defs>${[...d.values()]}</defs>${l}`}function $g(e,n,t){return`chartfade-${e}-${n}-${t}`.replace(/[^0-9A-Za-z_-]/g,"")}function Es(e,n,t,i){let a=(e.labelsAbove?n.y:n.y+n.h-i)+i/2,r=ke(e.labelColorHex,"fill");return e.labels.map((o,s)=>{let d=s===e.labels.length-1?"end":s===0?"start":"middle",c=n.x+o.position*n.w;return v`<text x=${c} y=${a} text-anchor=${d} dominant-baseline="central"
      font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
      font-size=${t} font-weight="400"
      fill=${r.fill} fill-opacity=${r["fill-opacity"]}>${o.text}</text>`})}function Cg(e,n){if(e.runs.length===0&&e.labels.length===0||n.w<=0||n.h<=0)return f;let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=Gn(e,n),o=Math.max(0,Math.min(e.gap,n.w/Math.max(1,e.runs.length))),s=e.runs.map((l,d)=>{let c=n.x+l.start*n.w,u=(l.end-l.start)*n.w,p=d===e.runs.length-1,m=Math.max(p?u:Math.min(u,.5),u-(p?0:o)),g=Math.max(0,Math.min(e.cornerRadius,m/2,a.h/2)),y=ke(l.colorHex,"fill");return v`<rect x=${c} y=${a.y} width=${m} height=${a.h} rx=${g}
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?v`${s}${Es(e,n,t,i)}`:v`${s}`}function Sg(e,n){if(e.labels.length===0||n.w<=0||n.h<=0)return f;let{labelSize:t,rowHeight:i}=Gn({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),a={...n,y:n.cy-i/2,h:i};return v`${Es({labels:e.labels,labelColorHex:e.labelColorHex,labelsAbove:!1},a,t,i)}`}function du(e,n){if(!(e===void 0||n.w<=0||n.h<=0))return{chart:e,g:lr(e,Gn(e,n).body)}}function Tg(e,n,t,i=!1,a=0){let r=du(t,n);if(e.indices.length===0||r===void 0)return f;let o=r.chart,s=o.pointColorHexes.length===o.values.length,l=Math.max(e.diameter/2,a),d=new Map,c=l+1.2,u="";for(let m of e.indices){if(m>=o.values.length)continue;let g=r.g.point(m),y=e.colorHex??(s?o.pointColorHexes[m]:o.colorHex);d.set(y,`${d.get(y)??""}M${g.x-l} ${g.y} a${l} ${l} 0 1 0 ${2*l} 0 a${l} ${l} 0 1 0 ${-2*l} 0 Z`),i&&(u+=`M${g.x-c} ${g.y} a${c} ${c} 0 1 0 ${2*c} 0 a${c} ${c} 0 1 0 ${-2*c} 0 Z`)}let p=i&&u!==""?v`<path d=${u} fill="none" stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f;return v`${p}${[...d].map(([m,g])=>{let y=ke(m,"fill",o.colorHex);return v`<path d=${g} fill=${y.fill} fill-opacity=${y["fill-opacity"]} stroke="transparent" stroke-width="3" />`})}`}function Eg(e,n,t,i=!1,a=0){let r=du(t,n);if(!e.draws||r===void 0)return f;let o=je(e.colorHex)??{color:"#FFFFFF",opacity:.2},s=Vc(r.g,e.lines);return v`${s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none"
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        stroke-width="1" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" pointer-events="none" />`):f}`}function Kc(e){let n=Math.min(e.w,e.h);return{x:e.cx-n/2,y:e.cy-n/2,w:n,h:n,cx:e.cx,cy:e.cy}}var Ji=4;function Mg(e,n){let t=e.w>=e.h,i=t?e.h:e.w,a=Math.min(i,Math.max(Ji,Math.max(0,n)));return t?{x:e.x,y:e.cy-a/2,w:e.w,h:a,cx:e.cx,cy:e.cy}:{x:e.cx-a/2,y:e.y,w:a,h:e.h,cx:e.cx,cy:e.cy}}function cu(e,n){if(e.kind==="shape")return e.shapeKind==="circle"?Kc(n):e.shapeKind==="line"?Mg(n,e.thickness):n;if(e.kind==="icon"){let t=Math.max(Ji,Ms(e));return{x:n.cx-t/2,y:n.cy-t/2,w:t,h:t,cx:n.cx,cy:n.cy}}if(e.kind==="chartTimes"){if(e.labels.length===0||n.w<=0||n.h<=0)return n;let{rowHeight:t}=Gn({labels:e.labels,labelSize:e.labelSize,labelsAbove:!1},n),i=Math.max(Ji,t);return{x:n.x,y:n.cy-i/2,w:n.w,h:i,cx:n.cx,cy:n.cy}}if(e.kind==="imageTime"){let t=jo(n.w,n.h);if(!e.linked||t<=0)return n;let i=Fs(new Date).length*t*.578+t*.89,a=t*1.25;return{x:n.cx-i/2,y:n.cy-a/2,w:i,h:a,cx:n.cx,cy:n.cy}}if(e.kind!=="gauge")return n;switch(e.style){case"ring":case"arc":return Kc(n);case"bar":{let t=Math.max(Ji,e.lineWidth);return{x:n.x,y:n.cy-t/2,w:n.w,h:t,cx:n.cx,cy:n.cy}}case"dots":{let{horizontal:t,d:i,span:a}=su(e,n),r=Math.max(Ji,i);return t?{x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,cx:n.cx,cy:n.cy}:{x:n.cx-r/2,y:n.cy-a/2,w:r,h:a,cx:n.cx,cy:n.cy}}default:return n}}function uu(e,n,t){return e.kind==="shape"?e.shapeKind==="circle"?{square:!0}:e.shapeKind==="line"?{line:!0}:{}:e.kind==="chartTimes"?{bar:!0}:e.kind==="imageTime"?Wc(e,n,t):e.kind!=="gauge"?{}:e.style==="ring"||e.style==="arc"?{square:!0}:e.style==="bar"?{bar:!0}:e.style!=="dots"?{}:Wc(e,n,t)}function Wc(e,n,t){if(t.width<=0||t.height<=0)return{};let i=cu({...e,frame:n},Xi({...e,frame:n},t));return{outline:{...n,x:i.x/t.width,y:i.y/t.height,width:i.w/t.width,height:i.h/t.height}}}function Ms(e){return e.path!==void 0&&e.path!==""?e.size*nu:e.size}function Rg(e,n){let t=ke(e.fillColorHex,"fill"),i=e.borderColorHex?je(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return v`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Fg(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ke(e.colorHex,"fill"),s=e.size*nu;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
      <path d=${e.path} fill=${o.fill} fill-opacity=${o["fill-opacity"]} /></g>`}let i=t.render(e.symbol,e.size,e.colorHex);if(i)return v`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=ke(e.colorHex,"stroke"),r=e.size;return v`
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Rs=.25,Ag=8;function Hg(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Rs),Ag),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),b=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+b)+0,width:m,height:g}}function Fs(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var dr=4;function Ig(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+dr:n.x+n.w-dr-a,d=e.timestampCorner.startsWith("top")?n.y+dr:n.y+n.h-dr-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Lg(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function _g(e,n,t){let i=t.icons,a=`imgclip-${lu()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?Ig(e,n,Fs(new Date)):void 0,s=o?pu(o):f,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=Hg(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=v`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Lg(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${d}${s}</g>`}function pu(e,n=1){return v`<g opacity=${n}>
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function zg(e,n){if(!e.linked)return f;let t=Fs(new Date),i=jo(n.w,n.h);if(i<=0)return f;let a=t.length*i*.578+i*.89,r=i*1.25;return pu({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function Pg(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Ng(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${$s} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var $s=5;function Ng(e,n){let t=$s*.55,i=n.w-2;if(n.h<$s*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function hu(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function Cs(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return f;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return f;let d=Xi(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=yg(e,d);break;case"icon":u=Fg(e,d,t.icons);break;case"gauge":u=bg(e,d);break;case"chart":u=vg(e,d);break;case"timeline":u=Cg(e,d);break;case"chartTimes":u=Sg(e,d);break;case"imageTime":u=zg(e,d);break;case"chartDots":u=Tg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=Eg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=Rg(e,d);break;case"image":u=_g(e,d,t);break;case"tap":u=Pg(e,d,t.icons,r,c?At(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,g=t.highlightId===e.id,y=g||t.highlightIds?.includes(e.id)===!0,b=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",C=t.handles===!0&&(!l||s)&&!b&&!k,w=cu(e,d),S=y&&!b?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,I=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,B=b?f:v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="transparent" stroke="none" />`,z=3,j=w,M=g&&C?[["nw",j.x,j.y],["ne",j.x+j.w,j.y],["sw",j.x,j.y+j.h],["se",j.x+j.w,j.y+j.h]].map(([U,Z,H])=>v`<rect data-handle=${U} x=${Z-z/2} y=${H-z/2} width=${z} height=${z}
    ...
    transform="rotate(${e.frame.rotationDegrees} ${d.cx} ${d.cy})">${B}${u}${I}${S}${M}</g>`}function ur(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function As(e,n){return(n?23.5:34)*e}var jc=10.5;function mu(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function qc(e,n){let t=0;for(let i of e)t+=mu(i,n);return t}function Yc(e,n,t){let i=e.toUpperCase(),a=d=>mu(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Ss(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Ts(e,n,t,i){let a=Ss(e,n,t),r=Ss(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function fu(e,n,t,i){let{dial:a}=ur(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Ts(a,t,i.start,i.end),length:t*r}}function Dg(e,n){let t=ur(e,!0);return fu(e,n,t.dial.r,t.labelArc)}var Xc=18.5,Og=113,Vg={start:-71,end:-36},Jc=104,Bg=6.2,Zc={start:-77,end:-30.5};function Qc(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function eu(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Qc(e[i]),o=Qc(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var vs=11;function Gg(e,n,t){let{dial:i}=ur(n,!0),a=Jc*n,r=180/(Math.PI*Jc),o=e.minLabel!==void 0?qc(e.minLabel,vs)*r:0,s=e.maxLabel!==void 0?qc(e.maxLabel,vs)*r:0,l=Zc.start+(o>0?Math.max(0,o-1.8):0),d=Zc.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let k=0;k<u;k++){let C=l+c*k/u,w=Math.min(d,l+c*(k+1)/u+.4);p.push(v`<path d=${Ts(i,a,C,w)} fill="none"
      stroke=${eu(e.colorHexes,(k+.5)/u)} stroke-width=${Bg*n}
      stroke-linecap=${k===0||k===u-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=Ss(i,a,l+c*m),y=1.5,b=(k,C,w,S)=>v`
    <defs><path id=${k} d=${Ts(i,a,C,w)} /></defs>
    <text font-size=${vs*n} font-weight="600" fill="#FFFFFF"
      font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
      <textPath href="#${k}" startOffset="50%" text-anchor="middle">${S}</textPath></text>`;return v`${p}
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${eu(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?b(`${t}-gmin`,l-y-Math.max(o,3),l-y,e.minLabel):f}
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function pr(e,n){let t=e.family in Le?e.family:"rectangular",i=n.slot??Le[t],a=Le[t],r=cr(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=je(e.backgroundColorHex),l=je(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=hu(c);if(t==="corner"){let b=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",w=C!=="",S=ur(b,k),I=As(b,k),B=I/(a.width*b),z=S.tile.cx-I/2,j=S.tile.cy-I/2,M=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,U=f;if(e.bezelGauge)U=Gg(e.bezelGauge,b,o);else if(e.bezelText){let H=Dg(b,`${o}-bezel`),Q=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?pi((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;U=v`<defs><path id=${H.id} d=${H.d} /></defs>
        <text font-size=${jc*b} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${H.id}" startOffset="50%" text-anchor="middle">${Yc(Q,H.length,jc*b)}</textPath></text>`}let Z=f;if(w){let H=je(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},Q=fu(b,`${o}-curved`,Og*b,Vg);Z=v`<defs><path id=${Q.id} d=${Q.d} /></defs>
        <text font-size=${Xc*b} font-weight="600" fill=${H.color} fill-opacity=${H.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${Q.id}" startOffset="50%" text-anchor="middle">${Yc(C,Q.length,Xc*b*.88)}</textPath></text>`}else{let H=e.borderWidth*r.scale*B,Q=l?v`<circle cx=${I/2} cy=${I/2} r=${I/2-H/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${H} />`:f;Z=v`<g transform="translate(${z} ${j})">
        <g clip-path=${`url(#${o})`}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${ry(e)}</svg>`}var vt="color-mix(in srgb, var(--k) 45%, #6b7280)",yi='system-ui, -apple-system, "Segoe UI", sans-serif';function Gu(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Bs(e,n,t,i){return v`<g fill="none" stroke-linecap="round">
    <path d=${Gu(e,n,t,1)} stroke=${vt} stroke-width="2.6" opacity=".5" />
    <path d=${Gu(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function oy(e){switch(e){case"text":return v`<g font-family=${yi} text-anchor="middle">
        <text x="36" y="27" font-size="19" font-weight="600" fill="var(--k)">72°</text>
        <text x="36" y="38" font-size="8" fill=${vt}>Kitchen</text>
        <text x="90" y="20" font-size="11" font-weight="500" fill=${vt}>48%</text>
        <text x="90" y="34" font-size="11" font-weight="500" fill=${vt}>1.2 kW</text>
        ...
        ${Bs(60,24,12,.62)}
        ${Bs(98,24,12,.92)}
        <text x="60" y="27" font-family=${yi} font-size="8" font-weight="600" text-anchor="middle" fill="var(--k)">62</text>
        ...
        <rect x="6" y="17" width="30" height="12" rx="2.5" fill=${vt} opacity=".55" />
        <rect x="37" y="17" width="18" height="12" rx="2.5" fill="var(--k)" />
        <rect x="56" y="17" width="8" height="12" rx="2.5" fill=${vt} opacity=".55" />
        <rect x="65" y="17" width="24" height="12" rx="2.5" fill="var(--k)" />
        <rect x="90" y="17" width="24" height="12" rx="2.5" fill=${vt} opacity=".55" />
        <text x="6" y="39" font-family=${yi} font-size="7" fill=${vt}>1h ago</text>
        <text x="114" y="39" font-family=${yi} font-size="7" text-anchor="end" fill=${vt}>now</text>
      ...
      </g>`;case"chartTimes":return v`<g font-family=${yi} font-size="8" fill="var(--k)">
        ...
        <text x="60" y="27" text-anchor="middle" font-family=${yi} font-size="10" fill="var(--k)">3:41:07</text>
      </g>`}}function Uu(e){return h`<svg class="shot" viewBox="0 0 120 46" aria-hidden="true">${oy(e)}</svg>`}function Ku(e,n){let t=()=>{let a=e.getScreenCTM();return a&&a.a!==0&&a.d!==0?{x:a.a,y:a.d}:void 0},i=t()??{x:1,y:1};return a=>(i=t()??i,{x:(a.clientX-n.clientX)/i.x,y:(a.clientY-n.clientY)/i.y})}function kr(e,n){let t={...e,...n};return $r({...t,x:_e(t.x),y:_e(t.y),width:Math.max(.04,_e(t.width)),height:Math.max(.04,_e(t.height))})}function Gs(e,n){let t=n==="down"?e.x:_e((1-e.width)/2),i=n==="across"?e.y:_e((1-e.height)/2);return $r({...e,x:t,y:i})}function Wu(e,n){let t=Gs(e,n);return t.x===e.x&&t.y===e.y}function $r(e){let n=Math.min(.96,Math.max(-e.width+.04,e.x)),t=Math.min(1-.04,Math.max(-e.height+.04,e.y));return{...e,x:n,y:t}}var _e=e=>Math.round(e*1e3)/1e3,ju=10;function Cr(e,n,t,i){let a=i.width>0?e.x+n/i.width:e.x,r=i.height>0?e.y+t/i.height:e.y;return $r({...e,x:_e(a),y:_e(r)})}function sy(e,n,t,i){let a=n.width,r=n.height,o=e.width*a,s=e.height*r,l=Math.min(o,s),d=e.x*a+(o-l)/2,c=e.y*r+(s-l)/2,u=t.includes("e")?1:-1,p=t.includes("s")?1:-1,m=.04*Math.max(a,r),g=Math.max(m,l+(u*i.x+p*i.y)/2),y=u>0?d:d+l-g,b=p>0?c:c+l-g;return{...e,x:_e(y/a),y:_e(b/r),width:_e(g/a),height:_e(g/r)}}function ly(e,n,t,i,a=!1){let r=n.width,o=n.height;if(a||e.width*r>=e.height*o){let p=a?.04:Math.max(.04,e.height*o/r),m=e.x+e.width,g=t.includes("e")?Math.max(p,e.width+i.x/r):Math.max(p,e.width-i.x/r),y=t.includes("e")?e.x:m-g;return{...e,x:_e(y),width:_e(g)}}let l=Math.max(.04,e.width*r/o),d=e.y+e.height,c=t.includes("s")?Math.max(l,e.height+i.y/o):Math.max(l,e.height-i.y/o),u=t.includes("s")?e.y:d-c;return{...e,y:_e(u),height:_e(c)}}function Sr(e,n,t,i,a){let r=Ku(e,t),o={...i.handle&&i.outline?i.outline:i.frame},s={...i.frame};e.setPointerCapture(t.pointerId);let l=p=>Math.round(p*1e3)/1e3,d=p=>{if(p.pointerId!==t.pointerId)return;let m=r(p),g=m.x/n.width,y=m.y/n.height,b;if(!i.handle)b=$r({...o,x:l(o.x+g),y:l(o.y+y)});else if(i.square)b=sy(o,n,i.handle,m);else if(i.line||i.bar)b=ly(o,n,i.handle,m,i.bar===!0);else{let{x:k,y:C,width:w,height:S}=o,I=o.x+o.width,B=o.y+o.height;i.handle.includes("e")&&(w=Math.max(.04,o.width+g)),i.handle.includes("s")&&(S=Math.max(.04,o.height+y)),i.handle.includes("w")&&(w=Math.max(.04,o.width-g),k=I-w),i.handle.includes("n")&&(S=Math.max(.04,o.height-y),C=B-S),b={...o,x:l(k),y:l(C),width:l(w),height:l(S)}}s=b,a.onFrame(i.elementId,b,!1)},c=p=>{p.pointerId===t.pointerId&&(u(),a.onFrame(i.elementId,s,!0))},u=()=>{e.removeEventListener("pointermove",d),e.removeEventListener("pointerup",c),e.removeEventListener("pointercancel",c);try{e.releasePointerCapture(t.pointerId)}catch{}};return e.addEventListener("pointermove",d),e.addEventListener("pointerup",c),e.addEventListener("pointercancel",c),u}function qu(e,n,t,i,a){let r=Ku(e,n),o=1;e.setPointerCapture(n.pointerId);let s=c=>{if(c.pointerId!==n.pointerId)return;let u=r(c),p=u.x*(t.includes("e")?1:-1),m=u.y*(t.includes("s")?1:-1),g=i.w>0?(i.w+p)/i.w:1,y=i.h>0?(i.h+m)/i.h:1,b=Math.abs(g-1)>=Math.abs(y-1)?g:y;o=Math.max(.05,b),a(o,!1)},l=c=>{c.pointerId===n.pointerId&&(d(),a(o,!0))},d=()=>{e.removeEventListener("pointermove",s),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l);try{e.releasePointerCapture(n.pointerId)}catch{}};return e.addEventListener("pointermove",s),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),d}var Yu={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Xu=e=>(...n)=>({_$litDirective$:e,values:n}),Tr=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,t,i){this._$Ct=n,this._$AM=t,this._$Ci=i}_$AS(n,t){return this.update(n,t)}update(n,t){return this.render(...t)}};var{I:dy}=ed,Ju=e=>e;var Zu=()=>document.createComment(""),bi=(e,n,t)=>{let i=e._$AA.parentNode,a=n===void 0?e._$AB:n._$AA;if(t===void 0){let r=i.insertBefore(Zu(),a),o=i.insertBefore(Zu(),a);t=new dy(r,o,e,e.options)}else{let r=t._$AB.nextSibling,o=t._$AM,s=o!==e;if(s){let l;t._$AQ?.(e),t._$AM=e,t._$AP!==void 0&&(l=e._$AU)!==o._$AU&&t._$AP(l)}if(r!==a||s){let l=t._$AA;for(;l!==r;){let d=Ju(l).nextSibling;Ju(i).insertBefore(l,a),l=d}}}return t},on=(e,n,t=e)=>(e._$AI(n,t),e),cy={},Qu=(e,n=cy)=>e._$AH=n,ep=e=>e._$AH,Er=e=>{e._$AR(),e._$AA.remove()};var tp=(e,n,t)=>{let i=new Map;for(let a=n;a<=t;a++)i.set(e[a],a);return i},np=Xu(class extends Tr{constructor(e){if(super(e),e.type!==Yu.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,n,t){let i;t===void 0?t=n:n!==void 0&&(i=n);let a=[],r=[],o=0;for(let s of e)a[o]=i?i(s,o):o,r[o]=t(s,o),o++;return{values:r,keys:a}}render(e,n,t){return this.dt(e,n,t).values}update(e,[n,t,i]){let a=ep(e),{values:r,keys:o}=this.dt(n,t,i);if(!Array.isArray(a))return this.ut=o,r;let s=this.ut??=[],l=[],d,c,u=0,p=a.length-1,m=0,g=r.length-1;for(;u<=p&&m<=g;)if(a[u]===null)u++;else if(a[p]===null)p--;else if(s[u]===o[m])l[m]=on(a[u],r[m]),u++,m++;else if(s[p]===o[g])l[g]=on(a[p],r[g]),p--,g--;else if(s[u]===o[g])l[g]=on(a[u],r[g]),bi(e,l[g+1],a[u]),u++,g--;else if(s[p]===o[m])l[m]=on(a[p],r[m]),bi(e,a[u],a[p]),p--,m++;else if(d===void 0&&(d=tp(o,m,g),c=tp(s,u,p)),d.has(s[u]))if(d.has(s[p])){let y=c.get(o[m]),b=y!==void 0?a[y]:null;if(b===null){let k=bi(e,a[u]);on(k,r[m]),l[m]=k}else l[m]=on(b,r[m]),bi(e,a[u],b),a[y]=null;m++}else Er(a[p]),p--;else Er(a[u]),u++;for(;m<=g;){let y=bi(e,l[g+1]);on(y,r[m]),l[m++]=y}for(;u<=p;){let y=a[u++];y!==null&&Er(y)}return this.ut=o,Qu(e,l),St}});var ip="sun.sun";function ap(e){let n=e?.[ip],t=typeof n?.attributes?.friendly_name=="string"?n.attributes.friendly_name.trim():"";return{entityId:ip,displayName:t||"Sun",domain:"sun"}}var rp=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],uy=[0,1,2,3,4];function op(e){let n=[];for(let t of e??[]){let i=t.trim();if(i==="")continue;let a=Number(i);Number.isInteger(a)&&a>=0&&a<=6&&!n.includes(a)&&n.push(a)}return n.sort((t,i)=>t-i)}function Us(e){return[...new Set(e)].filter(n=>n>=0&&n<=6).sort((n,t)=>n-t).map(String)}var sp=[{kind:"afterSunset",label:"After sunset",hint:"True from sunset to sunrise, from the sun entity's own state."},{kind:"daytime",label:"Daytime",hint:"True while the sun is up."},{kind:"sunElevation",label:"Sun below an angle",hint:"The sun's elevation in degrees, below a number you set. 0 is the horizon."},{kind:"weekday",label:"Weekday is one of",hint:"A row of days, starting on Monday to Friday."},{kind:"timeBetween",label:"Time between",hint:"A clock window that may wrap midnight, starting at 22:00 to 06:00."}];function py(e){return[lp(e,"below_horizon")]}function hy(e){return[lp(e,"above_horizon")]}function lp(e,n){return{id:J(),value:{kind:{kind:"entityState",...e}},comparison:{kind:"equals",value:L(n)}}}function my(e,n=0){return[{id:J(),value:{kind:{kind:"entityAttribute",...e,attribute:"elevation"}},comparison:{kind:"lessThan",value:L(String(n))}}]}function fy(e=uy){return[{id:J(),value:{kind:{kind:"time",timeField:"weekday"}},comparison:{kind:"isOneOf",options:Us(e)}}]}function gy(e="22:00",n="06:00"){return[{id:J(),value:{kind:{kind:"time",timeField:"now"}},comparison:{kind:"timeBetween",value:L(e),upper:L(n)}}]}function dp(e,n){switch(e){case"afterSunset":return py(n);case"daytime":return hy(n);case"sunElevation":return my(n);case"weekday":return fy();case"timeBetween":return gy()}}function Ks(e){delete e.coloring,delete e.bands,delete e.bandAboveColorHex,delete e.highlight,delete e.highColorHex,delete e.lowColorHex}function ia(e){for(let n of e)delete n.partId}function cp(e,n=J()){if(e.parts!==void 0&&e.parts.length>0)return e.parts[0].id;let t={id:n,value:structuredClone(e.value)};return e.coloring==="bands"&&(e.bands?.length??0)>0&&(t.coloring="bands",t.bands=e.bands,e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==le&&(t.bandAboveColorHex=e.bandAboveColorHex)),Ks(e),e.parts=[t],e.value=Pi(e.parts),n}function Mr(e,n=[]){let t=e.parts??[];if(e.countdown===!0||t.length===0)return delete e.parts,ia(e.rules),{ok:!0,joined:!1,moved:[]};if(t.length===1){let a=t[0],r=[];return e.value=a.value,a.fontSize!==void 0&&(e.fontSize=a.fontSize,r.push("fontSize")),a.fontWeight!==void 0&&(e.fontWeight=a.fontWeight,r.push("fontWeight")),a.colorHex!==void 0&&(e.colorSlot.baseColorHex=a.colorHex,r.push("color")),Ks(e),a.coloring!==void 0&&a.coloring!=="uniform"&&(e.coloring=a.coloring),a.bands!==void 0&&a.bands.length>0&&(e.bands=a.bands),a.bandAboveColorHex!==void 0&&(e.bandAboveColorHex=a.bandAboveColorHex),a.coloring==="bands"&&(a.bands?.length??0)>0&&r.push("bands"),delete e.parts,ia(e.rules),{ok:!0,joined:!1,moved:r}}let i=Ws(t,n);return i.ok?(e.value=i.value,Ks(e),delete e.parts,ia(e.rules),{ok:!0,joined:!0}):i}function ta(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function na(e){return e.includes("{")?`{% raw %}${e}{% endraw %}`:e}function yy(e,n){let t=e,i=e.format;for(let r=0;t.kind.kind==="named";r++){if(r>8)return;let o=t.kind.id.toUpperCase(),s=n.find(l=>l.id.toUpperCase()===o)?.value;if(!s)return;i=Ie(i)?s.format:i,t=s}let a={kind:t.kind};return Ie(i)||(a.format=i),a}function by(e,n){let t=yy(e,n);if(!t)return{blocked:"kind"};let i=Mn(t);if(i!==void 0)return na(i);let a=t.kind,r=t.format??{};if(r.relativeTime||r.duration)return{blocked:"format"};let o="",s;switch(a.kind){case"entityState":s=`states(${ta(a.entityId)})`;break;case"jinja":{if(a.value.trim()==="")return"";let c=a.value.includes("{{")||a.value.includes("{%"),u=r.decimals===void 0&&r.multiply===void 0&&r.offset===void 0&&!r.textCase;if(c&&u)return na(r.prefix??"")+a.value+na(r.suffix??"");c?(o=`{% set wa_text %}${a.value}{% endset %}`,s="wa_text"):s=`(${a.value})`;break}case"entityAttribute":case"entityAge":case"aggregate":case"time":{let c=ji(a);if(c===void 0)return{blocked:"kind"};s=c;break}default:return{blocked:"kind"}}if(r.decimals!==void 0||r.multiply!==void 0||r.offset!==void 0){let c=`(${s} | float(0))`;r.multiply!==void 0&&(c=`(${c} * ${r.multiply})`),r.offset!==void 0&&(c=`(${c} + ${r.offset})`),s=r.decimals!==void 0?`${ta(`%.${Math.max(0,Math.trunc(r.decimals))}f`)} | format(${c})`:c}let l=r.useEntityUnit&&"entityId"in a?a.entityId:void 0;l!==void 0&&(o+=`{% set wa_unit = state_attr(${ta(l)}, 'unit_of_measurement') %}`);let d="('' if not wa_unit else (wa_unit if wa_unit[:1] in ['\xB0', '%'] else ' ' ~ wa_unit))";if(r.textCase){let c=r.textCase==="upper"?"upper":r.textCase==="lower"?"lower":"title",u=[...r.prefix?[ta(r.prefix)]:[],`(${s})`,...l!==void 0?[d]:[],...r.suffix?[ta(r.suffix)]:[]].join(" ~ ");return`${o}{{ (${u}) | ${c} }}`}return o+na(r.prefix??"")+`{{ ${s} }}`+(l!==void 0?`{{ ${d} }}`:"")+na(r.suffix??"")}function Ws(e,n=[]){if(e.every(a=>a.value.kind.kind==="literal"))return{ok:!0,value:Pi(e)};let t=[],i=[];return e.forEach((a,r)=>{let o=by(a.value,n);typeof o=="string"?t.push(o):i.push({index:r,partId:a.id,reason:o.blocked})}),i.length>0?{ok:!1,blocked:i}:{ok:!0,value:{kind:{kind:"jinja",value:t.join("")}}}}var xi="color-mix(in srgb, var(--k) 30%, #6b7280)",ra='system-ui, -apple-system, "Segoe UI", sans-serif',Ne=[24,29,35,30,19,23,11,15],ct=Ne.map((e,n)=>10+n*100/(Ne.length-1)),up=32,xy=20,vy=Ne.reduce((e,n)=>e+n,0)/Ne.length,Fr=40,wy=6,Rr={highest:Ne.indexOf(Math.min(...Ne)),lowest:Ne.indexOf(Math.max(...Ne)),first:0,latest:Ne.length-1,now:5},pp=ct.map((e,n)=>`${n===0?"M":"L"}${e.toFixed(1)} ${Ne[n]}`).join("");function ky(){return v`
    <path d=${`${pp}L${ct[ct.length-1]} ${Fr}L${ct[0]} ${Fr}Z`} fill=${xi} opacity=".18" />
    <path d=${pp} fill="none" stroke=${xi} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />`}function $y(){return v`${[[4,30,.35],[35,18,.7],[54,10,.35],[65,26,.7],[92,24,.35]].map(([n,t,i])=>v`<rect x=${n} y="10" width=${t} height="16" rx="3" fill=${xi} opacity=${i} />`)}`}function Cy(){return v`
    <rect x="3" y="3" width="114" height="40" rx="5" fill=${xi} opacity=".22" />
    <circle cx="30" cy="16" r="6" fill=${xi} opacity=".6" />
    <path d="M3 43L3 36L34 20L56 32L80 16L117 38L117 43Z" fill=${xi} opacity=".5" />`}function sn(e,n=2.6){return v`<circle cx=${ct[e]} cy=${Ne[e]} r=${n} fill="var(--k)" />`}function zt(e){return v`<text x="5" y="13" font-family=${ra} font-size="10" font-weight="700" fill="var(--k)">${e}</text>`}function aa(e,n=!1){return v`<path d=${`M4 ${e}H116`} stroke="var(--k)" stroke-width="1.4" stroke-dasharray=${n?"4 3":"none"} />`}function hp(e){return v`<g font-family=${ra} font-size="6.5" fill="var(--k)">
    <text x="4" y=${e}>9 AM</text><text x="60" y=${e} text-anchor="middle">1 PM</text><text x="116" y=${e} text-anchor="end">5 PM</text>
  </g>`}function Sy(e){if(e==="timeline:times")return hp(38);if(e==="image:time")return v`<rect x="70" y="30" width="42" height="10" rx="5" fill="#000" fill-opacity=".55" stroke="var(--k)" stroke-width=".8" />
      <text x="91" y="37.5" text-anchor="middle" font-family=${ra} font-size="7" fill="var(--k)">3:41:07</text>`;let[n,t]=e.split(":");if(n==="draw")switch(t){case"threshold":return aa(xy,!0);case"now":return v`<path d=${`M${ct[Rr.now]} 4V${Fr+2}`} stroke="var(--k)" stroke-width="1.4" />`;case"zero":return v`${aa(up)}<text x="115" y=${up-3} text-anchor="end" font-family=${ra} font-size="6.5" fill="var(--k)">0</text>`;case"times":return hp(45);case"dots":return v`${ct.map((o,s)=>sn(s,2.2))}`;case"grid":return v`<path d="M4 10H116M4 20H116M4 30H116M4 40H116" stroke="var(--k)" stroke-width=".8" opacity=".7" />`}if(n==="number"){let o=Ne.length-1;switch(t){case"latest":return v`${zt("24.6")}${sn(o)}`;case"first":return v`${zt("18.2")}${sn(0)}`;case"highest":return v`${zt("28.9")}${sn(Rr.highest)}`;case"lowest":return v`${zt("9.8")}${sn(Rr.lowest)}`;case"average":return v`${zt("19.4")}${aa(vy,!0)}`;case"delta":return v`${zt("+6.4")}${sn(0)}${sn(o)}
        <path d=${`M${ct[0]} ${Ne[0]}L${ct[o]} ${Ne[o]}`} stroke="var(--k)" stroke-width="1" stroke-dasharray="2 2" />`;case"sum":return v`${zt("155")}${ct.map((s,l)=>sn(l,1.6))}`;case"trend":return zt("\u2191");case"top":return v`${zt("30")}${aa(wy)}`;case"bottom":return v`<text x="5" y="37" font-family=${ra} font-size="10" font-weight="700" fill="var(--k)">0</text>${aa(Fr)}`}}let i=Rr[t]??0,a=ct[i],r=Ne[i]-7;return t==="highest"?v`<path d=${`M${a} ${r-4}L${a+4} ${r+3}L${a-4} ${r+3}Z`} fill="var(--k)" />`:v`<circle cx=${a} cy=${r} r="3" fill="var(--k)" />`}function js(e){return e==="timeline:times"?"timeline":e==="image:time"?"image":"chart"}function mp(e,n){let t=e==="timeline"?$y():e==="image"?Cy():ky(),i=n!==void 0&&js(n)===e?Sy(n):"";return h`<svg class="shot" viewBox="0 0 120 46" aria-hidden="true">${t}${i}</svg>`}var Ty={threshold:"Threshold line",now:"Now line",zero:"Zero line",times:"Clock times",dots:"Dots",grid:"Grid lines"};function fp(e){if(e==="timeline:times")return"Clock times";if(e==="image:time")return"Timestamp";let[n,t]=e.split(":");return n==="draw"?Ty[t]:n==="number"?Rt.find(([i])=>i===t)?.[1]??t:`${mt.find(([i])=>i===t)?.[1]??"Reading"} marker`}var Ey={"draw:threshold":"A flat line at a value you pick, so a reading over it stands out.","draw:now":"An upright line through the reading that counts as now.","draw:zero":"A flat line where zero falls. It is drawn only when the readings cross zero.","draw:times":"The clock times of the chart's span, spread under the plot.","draw:dots":"A dot on every reading. Line and area charts only.","draw:grid":"Faint rules across the plot, to read heights against.","number:latest":"The newest reading, with the entity's unit after it.","number:first":"The oldest reading in the span.","number:highest":"The highest reading in the span.","number:lowest":"The lowest reading in the span.","number:average":"The average of every reading in the span.","number:delta":"The newest reading minus the first, with the unit after it.","number:sum":"Every reading in the span added up, with the unit after it.","number:trend":"The change as an arrow: up, down, or flat when it is too small to print.","number:top":"The value at the top of the plot. On a Fixed scale, this is Max.","number:bottom":"The value at the bottom of the plot. On a Fixed scale, this is Min.","marker:highest":"An icon over the highest reading. It starts as a triangle.","marker:lowest":"An icon over the lowest reading. It starts as a dot.","marker:now":"An icon over the reading that counts as now.","marker:first":"An icon over the oldest reading.","marker:latest":"An icon over the newest reading.","marker:threshold":"An icon at the threshold's height.","marker:zero":"An icon at zero's height.","timeline:times":"The clock times of the timeline's span, spread under the strip.","image:time":"The time the picture was fetched, so a picture that stops updating reads as stale."};function qs(e){return Ey[e]}function My(e){switch(e){case"light":return v`<path d="M9.2 15.5A5.5 5.5 0 1 1 14.8 15.5C13.8 16.6 13.6 17.4 13.5 19H10.5C10.4 17.4 10.2 16.6 9.2 15.5Z" /><path d="M10.5 21.5H13.5" />`;case"switch":case"input_boolean":return v`<rect x="3" y="7.5" width="18" height="9" rx="4.5" /><circle cx="16.5" cy="12" r="2.6" />`;case"sensor":return v`<path d="M12 14.5V4.5" /><circle cx="12" cy="17.5" r="3.2" /><path d="M14.5 6.5H12M14.5 9.5H12" />`;case"binary_sensor":return v`<circle cx="12" cy="12" r="8.5" /><circle cx="12" cy="12" r="3.2" />`;case"climate":case"water_heater":return v`<path d="M10 13.8V5.5a2 2 0 0 1 4 0V13.8" /><circle cx="12" cy="17" r="3.6" /><path d="M16.5 7H19M16.5 10.5H19" />`;case"humidifier":return v`<path d="M12 3.5S6.5 10.5 6.5 14.5A5.5 5.5 0 0 0 17.5 14.5C17.5 10.5 12 3.5 12 3.5Z" />`;case"media_player":return v`<rect x="2.8" y="4.5" width="18.4" height="12" rx="2.5" /><path d="M8 20H16" /><path d="M10.6 9.2L14.4 10.6L10.6 12Z" />`;case"camera":return v`<path d="M3.5 8.5A2 2 0 0 1 5.5 6.5H9L10.5 4.5H13.5L15 6.5H18.5A2 2 0 0 1 20.5 8.5V17A2 2 0 0 1 18.5 19H5.5A2 2 0 0 1 3.5 17Z" /><circle cx="12" cy="12.5" r="3.5" />`;case"cover":return v`<rect x="3.5" y="3.5" width="17" height="17" rx="2" /><path d="M3.5 8.5H20.5M3.5 13H20.5M3.5 17.5H20.5" />`;case"lock":return v`<rect x="5" y="10.5" width="14" height="10" rx="2.5" /><path d="M8.2 10.5V7.8a3.8 3.8 0 0 1 7.6 0V10.5" />`;case"fan":return v`<circle cx="12" cy="12" r="2" /><path d="M12 10C12 6 9 3.5 7 5.5S8.5 10 12 10Z" /><path d="M14 12C18 12 20.5 9 18.5 7S14 8.5 14 12Z" /><path d="M12 14C12 18 15 20.5 17 18.5S15.5 14 12 14Z" /><path d="M10 12C6 12 3.5 15 5.5 17S10 15.5 10 12Z" />`;case"script":case"automation":return v`<path d="M5 5.5H19M5 10H19M5 14.5H14M5 19H11" />`;case"scene":return v`<path d="M12 3.5L14.2 8.6L19.7 9.2L15.6 12.9L16.8 18.3L12 15.5L7.2 18.3L8.4 12.9L4.3 9.2L9.8 8.6Z" />`;case"person":case"device_tracker":return v`<circle cx="12" cy="8" r="3.6" /><path d="M5 20.5a7 7 0 0 1 14 0" />`;case"vacuum":case"lawn_mower":return v`<circle cx="12" cy="12" r="8.5" /><circle cx="12" cy="12" r="3" /><path d="M12 3.5V8.5" />`;case"weather":return v`<circle cx="9" cy="9" r="3.2" /><path d="M8.5 19.5a4 4 0 0 1 .4-8 5.2 5.2 0 0 1 10 1.2 3.4 3.4 0 0 1-.4 6.8Z" />`;case"sun":return v`<circle cx="12" cy="12" r="4.2" /><path d="M12 3V5.5M12 18.5V21M3 12H5.5M18.5 12H21M5.6 5.6L7.4 7.4M16.6 16.6L18.4 18.4M18.4 5.6L16.6 7.4M7.4 16.6L5.6 18.4" />`;case"input_number":case"number":return v`<path d="M8 4.5L6 19.5M18 4.5L16 19.5M4.5 9H19.5M4 15H19" />`;case"input_select":case"select":return v`<rect x="3.5" y="6" width="17" height="12" rx="2.5" /><path d="M14 10.5L16.2 13L18.4 10.5" />`;case"input_text":case"text":return v`<path d="M5 6H19M12 6V19M9 19H15" />`;case"button":case"input_button":return v`<circle cx="12" cy="12" r="8.5" /><path d="M12 8.5V15.5M8.5 12H15.5" />`;case"alarm_control_panel":return v`<path d="M12 3.5L19.5 6.5V12C19.5 16.5 16.3 19.6 12 20.8C7.7 19.6 4.5 16.5 4.5 12V6.5Z" /><path d="M9.5 12L11.3 14L14.8 10.2" />`;case"update":return v`<path d="M12 4.5V14.5" /><path d="M8.2 10.8L12 14.6L15.8 10.8" /><path d="M5 18.5H19" />`;case"todo":return v`<rect x="4" y="4" width="16" height="16" rx="2.5" /><path d="M8 12L10.6 14.5L16 9" />`;case"calendar":return v`<rect x="3.5" y="5.5" width="17" height="15" rx="2.5" /><path d="M3.5 10H20.5M8 3.5V7.5M16 3.5V7.5" />`;case"timer":case"counter":return v`<circle cx="12" cy="13.5" r="7.5" /><path d="M12 9.5V13.5L14.6 15.4" /><path d="M9.5 2.8H14.5" />`;case"zone":return v`<path d="M12 21S5 15.4 5 10.2A7 7 0 0 1 19 10.2C19 15.4 12 21 12 21Z" /><circle cx="12" cy="10" r="2.6" />`;case"remote":return v`<rect x="7" y="2.8" width="10" height="18.4" rx="3" /><circle cx="12" cy="8" r="1.5" /><path d="M9.6 12.5H14.4M9.6 16H14.4" />`;case"siren":return v`<path d="M5 18.5a7 7 0 0 1 14 0Z" /><path d="M3.5 18.5H20.5M12 4V7M5.5 6.5L7.4 8.4M18.5 6.5L16.6 8.4" />`;case"valve":return v`<path d="M4 8L12 12L4 16Z" /><path d="M20 8L12 12L20 16Z" /><path d="M12 12V4M9 4H15" />`;case"image":case"image_processing":return v`<rect x="3.5" y="5" width="17" height="14" rx="2.5" /><circle cx="9" cy="10" r="1.6" /><path d="M20.5 15.5L15.5 11L7 19" />`;case"event":return v`<circle cx="12" cy="12" r="2.4" /><path d="M8.2 8.2a5.4 5.4 0 0 0 0 7.6M15.8 8.2a5.4 5.4 0 0 1 0 7.6" /><path d="M5.5 5.5a9.2 9.2 0 0 0 0 13M18.5 5.5a9.2 9.2 0 0 1 0 13" />`;case"group":return v`<rect x="3.5" y="3.5" width="7.5" height="7.5" rx="2" /><rect x="13" y="3.5" width="7.5" height="7.5" rx="2" /><rect x="3.5" y="13" width="7.5" height="7.5" rx="2" /><rect x="13" y="13" width="7.5" height="7.5" rx="2" />`;default:return v`<circle cx="12" cy="12" r="7.5" /><circle cx="12" cy="12" r="2.2" />`}}function Ys(e){return h`<svg class="dom-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${My(e)}</svg>`}var Ry={binary_sensor:"Binary sensor",input_boolean:"Toggle helper",input_number:"Number helper",input_select:"Dropdown helper",input_text:"Text helper",input_button:"Button helper",input_datetime:"Date helper",alarm_control_panel:"Alarm panel",device_tracker:"Device tracker",media_player:"Media player",water_heater:"Water heater",lawn_mower:"Lawn mower",image_processing:"Image processing",persistent_notification:"Notification",remote:"Remote",sun:"Sun",todo:"To-do list"};function gp(e){let n=Ry[e];if(n!==void 0)return n;if(e==="")return"";let t=e.replace(/_/g," ");return t.charAt(0).toUpperCase()+t.slice(1)}var Fy=new Set(["on","open","opening","closing","home","playing","heat","cool","heat_cool","auto","dry","fan_only","cleaning","returning","active","running","recording","streaming","triggered","armed_home","armed_away","armed_night","armed_vacation","unlocked"]);function Xs(e){return Fy.has(e.trim().toLowerCase())}function Ay(e,n,t){let i=Za({frame:{...e.frame},isHidden:!1},e.family,n,t).frame;return kr(i,{})}var dl=["content","look","numbers","timestamp","tappable","states","placement","corner","placements","shape","symbol"];function xe(e){return n=>e(n.target.value)}function ln(e,n){let t=n===void 0?Ls(e.watchAppVersion):Ls(e.watchAppVersion,n);return t===void 0?f:h`<div class="hint keep">${t}</div>`}function jr(e){if(e===void 0||e.atDefault)return f;let n=`Changed. Click to reset. ${e.title.replace(/\.$/,"")}.`;return h`<button type="button" class="reset-dot" title=${n} aria-label=${n}
    ...
    @pointerdown=${t??f}>${e}${i}</span>`}var qr="wa-scrub-start",Yr="wa-scrub-end",Hy=3,Iy=3;function Ly(e,n){return e!==void 0&&Number.isFinite(e)?e:Math.max(0,n.min??0)}function _y(e,n,t={}){let i=n!==void 0&&n>0?n:10**-Math.min(2,il(e));return t.coarse?i*10:t.fine?i/10:i}function zy(e,n,t,i){let a=e+Math.round((n-e)/t)*t;return i.min!==void 0&&(a=Math.max(i.min,a)),i.max!==void 0&&(a=Math.min(i.max,a)),Number(a.toFixed(Math.min(10,Math.max(il(t),il(e)))))}function il(e){if(!Number.isFinite(e)||Number.isInteger(e))return 0;let n=String(e),t=/e-(\d+)$/.exec(n);return t?Number(t[1])+(n.split("e")[0].split(".")[1]??"").length:(n.split(".")[1]??"").length}function Op(e,n,t,i,a,r){let o=Ly(t,a),s=n.clientX,l=s,d=o,c=o,u=!1,p=g=>{if(!u){if(Math.abs(g.clientX-s)<Hy)return;u=!0,l=g.clientX,e.classList.add("scrubbing"),e.dispatchEvent(new CustomEvent(qr,{bubbles:!0,composed:!0}))}let y=_y(o,a.step,{coarse:g.shiftKey,fine:g.altKey});d+=(g.clientX-l)/Iy*y,l=g.clientX,a.min!==void 0&&(d=Math.max(a.min,d)),a.max!==void 0&&(d=Math.min(a.max,d));let b=zy(o,d,y,a);b!==c&&(c=b,i(b))},m=g=>{if(e.removeEventListener("pointermove",p),e.removeEventListener("pointerup",m),e.removeEventListener("pointercancel",m),u){e.classList.remove("scrubbing"),e.dispatchEvent(new CustomEvent(Yr,{bubbles:!0,composed:!0}));let y=b=>{b.preventDefault(),b.stopPropagation()};e.addEventListener("click",y,{capture:!0,once:!0}),setTimeout(()=>e.removeEventListener("click",y,{capture:!0}),0)}r(u,g)};e.setPointerCapture(n.pointerId),e.addEventListener("pointermove",p),e.addEventListener("pointerup",m),e.addEventListener("pointercancel",m)}function Xr(e,n,t){return i=>{if(i.button!==0||!i.isPrimary)return;let a=i.currentTarget;a.closest(".field")?.querySelector("input[type=number]")?.disabled||(i.preventDefault(),Op(a,i,e,n,t,()=>{}))}}function ma(e,n,t){return i=>{let a=i.currentTarget;i.button!==0||!i.isPrimary||a.disabled||a.matches(":focus")||(i.preventDefault(),Op(a,i,e,n,t,(r,o)=>{r||o.type!=="pointerup"||(a.focus(),a.select())}))}}function un(e,n,t,i=a=>String(a)){if(n===void 0)return;let a=n;return{atDefault:e===a,title:`Back to ${i(a)}`,reset:()=>t(a)}}function Me(e,n,t,i={}){return h`<label class="field">${Oe(e,un(n,i.def,t,a=>a===""?"empty":a))}
    <input type="text" .value=${n} placeholder=${i.placeholder??""} list=${i.list??f}
      class=${i.mono?"mono":""} @input=${xe(t)} /></label>`}function Vp(e,n,t,i=3){return h`<label class="field"><span>${e}</span>
    <textarea rows=${i} .value=${n} class="mono" @input=${xe(t)}></textarea></label>`}function ae(e,n,t,i={}){let a=i.def===null?{atDefault:n===void 0,title:"Back to none",reset:()=>t(void 0)}:un(n,i.def,t);return h`<label class="field num">${Oe(e,a,Xr(n,t,i))}${Jr(n,t,i)}</label>`}function Jr(e,n,t){let i=e===void 0||Number.isNaN(e)?"":String(e),a=h`<input type="number" .value=${i} step=${t.step??"any"} min=${t.min??f} max=${t.max??f}
      aria-label=${t.ariaLabel??f} placeholder=${t.placeholder??f}
      data-scrub @pointerdown=${ma(e,n,t)}
      @input=${xe(r=>{if(r.trim()===""){t.optional&&n(void 0);return}let o=Number(r);Number.isNaN(o)||n(o)})} />`;return t.unit===void 0&&t.lead===void 0?a:h`<span class=${t.lead===void 0?"num-box":"num-box lead"} style=${`--wa-unit:${t.unit?.length??0}`}>${t.lead===void 0?f:h`<span class="lead" aria-hidden="true">${t.lead}</span>`}${a}${t.unit===void 0?f:h`<span class="unit" aria-hidden="true">${t.unit}</span>`}</span>`}function $e(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<label class="field">${Oe(e,un(n,a.def,i,r))}
    <select @change=${xe(o=>i(o))}>
      ${t.map(([o,s])=>h`<option value=${o} ?selected=${o===n}>${s}</option>`)}
    </select></label>`}function ie(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<div class="field seg-field">${Oe(e,un(n,a.def,o=>i(o,null),r))}
    ${Or(e,n,t,i,a)}</div>`}function Or(e,n,t,i,a={}){return h`<div class="seg wide" role="radiogroup" aria-label=${e}>
    ...
    </div>`}function Py(e,n){let t=i=>un(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${Oe(e.label,t(e))}
    <div class="pair-row">
      ${Or(e.label,e.value,e.options,e.set,e)}
      ${Oe(n.label,t(n))}
      ${Or(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function Yn(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${Oe(e,un(n,i.def,t,a),Xr(n,t,i))}
    ...
    </div></div>`}function Ye(e,n,t,i,a={}){return h`<label class="field check">${Oe(e,un(n,i,t,r=>r?"on":"off"))}<input type="checkbox" .checked=${n} ?disabled=${a.disabled===!0} @change=${r=>t(r.target.checked)} /></label>`}function he(e,n,t,i=!1,a){let{rgb:r,alpha:o}=Bp(n),s=a===void 0?void 0:{atDefault:cl(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)},l=i&&n===void 0;return h`<div class="field color">${Oe(e,s)}
    <div class="color-row">
      ${i?h`<input type="checkbox" title="Enabled" aria-label=${`${e} on`} .checked=${n!==void 0} @change=${d=>t(d.target.checked?Nr(r,o):void 0)} />`:f}
      ${Vr(e,n,t,l)}
    </div></div>`}function Bp(e){let n=(e??"").replace(/^#/,""),t=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n);return{valid:t,swatch:t?`#${n}`:"transparent",rgb:t?`#${n.slice(0,6)}`:"#ffffff",alpha:t&&n.length===8?Math.round(parseInt(n.slice(6,8),16)/255*100):100}}function Nr(e,n){let t=e.replace(/^#/,"").toUpperCase();return n>=100?`#${t}`:`#${t}${Math.round(n/100*255).toString(16).padStart(2,"0").toUpperCase()}`}function Vr(e,n,t,i=!1,a="#RRGGBB"){let{valid:r,swatch:o,rgb:s,alpha:l}=Bp(n);return h`<span class="color-box">
      <span class="color-swatch" style=${`--sw:${i||!r?"transparent":o}`} title="Pick a colour">
        <input type="color" .value=${s} ?disabled=${i} aria-label=${`${e}: pick a colour`} @input=${xe(d=>t(Nr(d,l)))} />
      </span>
      ...
      <span class="num-box alpha" style="--wa-unit:1">
        <input type="number" min="0" max="100" step="1" .value=${String(l)} title="Opacity" aria-label=${`${e}: opacity`} ?disabled=${i}
          data-scrub @pointerdown=${ma(l,d=>t(Nr(s,d)),{step:1,min:0,max:100})}
          @input=${xe(d=>{let c=Number(d);d.trim()!==""&&c>=0&&c<=100&&t(Nr(s,Math.round(c)))})} />
        <span class="unit" aria-hidden="true">%</span>
      </span>
    </span>`}function al(e,n,t,i){let a={atDefault:n===void 0,title:`Back to ${t.toLowerCase()}`,reset:()=>i(void 0)};return h`<div class="field color">${Oe(e,a)}
    <div class="color-row">${Vr(e,n,i,!1,t)}</div></div>`}function cl(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function Zr(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Ny(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function yp(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var Gp=50;function Dy(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Oy(e,n,t=Gp,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Vy=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Up(e){return Vy.test(e.trim())}function By(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return Zr(t,i);if(Up(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var jn=new Map;function Re(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function ul(e){return jn.has(e)}function wt(e,n,t,i,a,r={}){let o=e.hass.states,s=jn.get(a),l=s?Oy(Ny(o,r.domain,yp(e.hass)),s.query,Gp,r.preferNumeric?Dy:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(w,S,I=0)=>{jn.set(a,{query:S,index:I}),Re(w)},p=w=>{jn.delete(a),Re(w)},m=w=>{let S=By(w,t,o);S&&i(S)},g=(w,S)=>{i(Zr(o,w.entityId)),p(S)},y=()=>Math.max(0,Math.min(jn.get(a)?.index??0,l.length-1)),b=w=>{let S=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let I=jn.get(a);if(!I){u(S,S.value);return}let B=w.key==="ArrowDown"?y()+1:y()-1;u(S,I.query,Math.max(0,Math.min(l.length-1,B))),Gy(S);return}if(w.key==="Enter"){w.preventDefault();let I=l[y()];s&&I?g(I,S):(m(S.value),p(S));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),p(S)}},k=t.entityId?yp(e.hass)?.(t.entityId):void 0,C=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
          <span class="ent-ico ${Xs(c.state)?"on":""}">${Ys(t.domain||t.entityId.split(".")[0]||"")}</span>
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let S=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),jn.set(a,{query:"",index:0}),Re(S),S?.focus()}}>${V("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Up(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${I=>I.preventDefault()} @click=${I=>g(w,I.target)}>
                <span class="ent-ico ${Xs(w.state)?"on":""}">${Ys(w.domain)}</span>
                <span class="ent-main">
                ...
                <span class="ent-right">
                  <span class="ent-type">${gp(w.domain)}</span>
                  <span class="ent-state">${w.state}</span>
                </span>
              </button>`)}
        </div>`:C}
  </div>`}function Gy(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var bp=120;function Uy(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(br.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(xr),fromPack:!1}}function xp(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Ky(e){return[{value:"",label:`Starter set (${xp(xr,e)})`},...br.map(n=>({value:n.name,label:`${n.name} (${xp(n.symbols,e)})`}))]}function Wy(e){return e.length>0?e.length:xr.length}function vp(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Ar(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Kp(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Ge),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=jy(u,c),b=w=>{t(w),a?.(w.startsWith(Ge)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},k=w=>{if(t(w),!m)return;let S=w.trim();a?.(S.startsWith(Ge)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&g==="mdi"){let w=e.icons.mdiNames?.(),S=qy(w??[],s),I=S.slice(0,bp),B=r.recent.filter(z=>z.startsWith(Ge));C=h`<div class="sym-browse">
      ${wp(r,i,g)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${xe(z=>r.setQuery(i,z))} />
      </div>
      ${B.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${B.map(z=>Ar(e,z,z===u,b))}</div>`}
      <div class="sym-grid">${I.map(z=>Ar(e,z,z===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${vp(I.length,S.length,!0,w.length)}</div>`}
    ...
    </div>`}else if(o){let w=r.category(i),S=Uy(w,s,d,c),I=zs(S.names,s),B=S.fromPack?I.slice(0,bp):I,z=r.recent.filter(M=>!M.startsWith(Ge)),j=c.size===0?z:z.filter(M=>c.has(M));C=h`<div class="sym-browse">
      ${m?wp(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${xe(M=>r.setQuery(i,M))} />
        <select @change=${xe(M=>r.setCategory(i,M))}>
          ${Ky(c).map(M=>h`<option value=${M.value} ?selected=${M.value===w}>${M.label}</option>`)}
        </select>
      </div>
      ${j.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${j.map(M=>Ar(e,M,M===u,b))}</div>`}
      <div class="sym-grid">${B.map(M=>Ar(e,M,M===u,b))}</div>
      ${I.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${vp(B.length,I.length,s.trim()!=="",Wy(d))}
          </div>`}
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${xe(k)} @change=${xe(w=>{let S=w.trim();S.startsWith(Ge)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed(w):(c.size===0||c.has(S))&&r.noteUsed(w)})} /></label>
    ...
    ${C}`}function jy(e,n){let t=e.trim();return t!==""&&!t.startsWith(Ge)&&n.size>0&&!n.has(t)}function qy(e,n){let t=n.trim(),i=t.startsWith(Ge)?t.slice(Ge.length):t,a=e.map(r=>r.startsWith(Ge)?r.slice(Ge.length):r);return zs(a,i).map(r=>Ge+r)}function wp(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Yy=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Xy={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Jy=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],Zy=[["flat","Flat"],["fade","Fade"]],Wp=[["auto","Auto"],["all","All"]],Qy=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],jp=[["bars","Bars"],["line","Line"],["area","Area"]],eb=[["auto","Auto"],["fixed","Fixed range"]],tb=[["lowest","Lowest value"],["zero","Zero"]],nb=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],rl=[["uniform","One colour"],["bands","By value"]];function Br(e){let n=[Mo,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function pl(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function ib(e,n){let t=Jt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function ab(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function rb(e,n,t){let{lo:i,hi:a}=ab(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
  ...
  </div>`}function Gr(e,n,t,i){let a=Jt({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(g=>g.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:cl(l,le),title:`Back to ${le}`,reset:()=>t(c=>{c.bandAboveColorHex=le})};return h`<div class="bands">
    ${rb(a,l,r)}
    ${a.map((c,u)=>h`
      <div class="band-row ${o===c.id?"hit":""}">
        ...
        <input type="number" class="band-up" step="any" .value=${String(c.upTo)} aria-label="Up to"
          ...
          data-scrub @pointerdown=${ma(c.upTo,p=>t(s(c.id,m=>{m.upTo=p})),{...u>0?{min:a[u-1].upTo}:{},...u<a.length-1?{max:a[u+1].upTo}:{}})}
          @change=${xe(p=>{let m=Number(p);p.trim()!==""&&Number.isFinite(m)&&t(s(c.id,g=>{g.upTo=m}))})} />
        ${Vr(`Up to ${c.upTo}`,c.colorHex,p=>t(s(c.id,m=>{m.colorHex=p??"#FFFFFF"}),`bcol${c.id}`))}
    ...
    <div class="band-row ${o==="above"?"hit":""}">${jr(d)}
      ...
      ${Vr("Above the last band",l,c=>t(u=>{u.bandAboveColorHex=c??le},"babove"))}
      <span></span>
    </div>
    <button type="button" class="link add-band" @click=${()=>t(c=>{c.bands=[...c.bands,ib(c.bands,n)]})}>+ Band</button>
  </div>`}function ob(e,n,t,i){let a=new Map,r=new Map,o=(d,c)=>{let u=d.trim();if(u==="")return;let p=u.toLowerCase();r.has(p)||r.set(p,u),a.set(p,(a.get(p)??0)+c)};e.forEach((d,c)=>{let u=e[c+1],p=u===void 0?n:u.offsetSeconds;o(d.state,Math.max(0,p-d.offsetSeconds))}),t!==void 0&&o(t,0),(Oi[i??""]??[]).forEach(d=>o(d,0));let s=["unavailable","unknown"];return[...[...a.entries()].filter(([d])=>!s.includes(d)).sort((d,c)=>c[1]-d[1]).map(([d])=>r.get(d)??d),...s]}function sb(e,n,t=[],i="wa-timeline-states"){let a=new Set(e.bands.map(o=>o.match.trim().toLowerCase())),r=t.find(o=>!a.has(o.toLowerCase()))??"";return h`
    ${e.bands.map((o,s)=>h`
      <div class="row-inline">
        ${Me("State",o.match,l=>n(d=>{let c=d.bands[s];c&&(c.match=l)},`tmatch${o.id}`),{placeholder:"on",list:i})}
        ${he("Colour",o.colorHex,l=>n(d=>{let c=d.bands[s];c&&(c.colorHex=l??Zt)},`tcol${o.id}`))}
    ...
    <button class="small" @click=${()=>n(o=>{o.bands=[...o.bands,{id:J(),match:r,colorHex:Ha(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${he("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??Zt},"tother"),!1,Zt)}`}var lb=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],db={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function kp(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return L(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var cb=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function ub(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function se(e,n,t,i){if(i.inline||!pb())return h`<div class="value-editor">${Jp(e,n,t,i)}</div>`;let a=Qr(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=Ee(n,de(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${qp(e,a,r,n,t,i)}
  </div>`}function qp(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Xp}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${ca.has(n)?Jp(e,i,a,r):f}
  </div>`}function de(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Qr(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function pb(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var ca=new Set,oa=new WeakMap;function hb(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Yp(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Xp(e){let n=e.currentTarget,t=e.newState==="open",i=oa.get(n);if(i&&(i(),oa.delete(n)),!t){ca.delete(n.id)&&Re(n);return}let a=hb(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){oa.get(n)?.(),oa.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}Js(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),oa.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Js(n,a.getBoundingClientRect()),ca.has(n.id)||(ca.add(n.id),Re(n),requestAnimationFrame(()=>{n.isConnected&&Js(n,a.getBoundingClientRect())}))}function Js(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=mb({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Wn=8,Hr=6,$p=140;function mb(e,n,t){let i=t.height-e.bottom-Hr-Wn,a=e.top-Hr-Wn,r=n.height>i&&a>i&&i<$p,o=Math.max($p,r?a:i),s=Math.min(n.height,o),l=Math.max(Wn,Math.min(e.left,t.width-n.width-Wn)),d=r?Math.max(Wn,e.top-Hr-s):Math.max(Wn,Math.min(e.bottom+Hr,t.height-s-Wn));return{left:l,top:d,maxHeight:o,above:r}}function Jp(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Yy.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Kp(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):Me("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=wt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${wt(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${Me("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=kb(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=$e("Field",a.timeField,cb,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${Vp("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?Gi(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>vb(e,n,t)}>Start an empty one</button>,
          ...
          ${c?h`<div class="hint keep">Read by ${u} ${u===1?"layer":"layers"}.
            ...
            <button type="button" class="link" @click=${()=>{let p=rs(e.config,n);p&&t(p)}}>stop sharing</button>
          ...
          ${$e("Chart",a.layer,[["","(choose)"],...u.map(p=>[p.payload.id,Se(p,c)])],p=>r({...a,layer:p}))}
          ${$e("Number",a.stat,[...Rt],p=>r({...a,stat:p}))}
          <div class="hint">${a.stat==="top"||a.stat==="bottom"?"One end of the plot's range: what the tallest or shortest mark means. On a Fixed scale that is the Min or Max the chart was given.":"Read from the readings the chart draws, after any trim. Decimals follow the chart's spread; set Decimals below to override, and Add unit to print the entity's unit after it."}</div>`;break}}let d=Xy[a.kind];return h`
    ${$e("Source",a.kind,s,c=>r(ub(a,c)))}
    ${d?h`<div class="hint">${d}</div>`:f}
    ${l}
    ${bb(n,i)?h`<div class="hint keep">
      <button type="button" class="link" title="Move this into a shared value that other layers can read too" @click=${()=>xb(e,n,t)}>Make shared</button>
      so other layers can read this too.</div>`:f}
    ${i.noFormat?f:wb(n.format,c=>t(Ie(c)?{kind:n.kind}:{...n,format:c}),gb(fb(e,n)))}
    ${i.showResolved?yb(e,n,e.resolve(i.resolveAs??n)):f}`}function fb(e,n){let t=n.kind;for(let i=0;t.kind==="named"&&i<8;i++){let a=t.id.toUpperCase(),r=e.config.values.find(o=>o.id.toUpperCase()===a);if(!r)return;t=r.value.kind}return t.kind==="named"?void 0:t}function gb(e){if(!e)return{numbers:!0,textCase:!0,unit:!0,seconds:!0};switch(e.kind){case"literal":{let n=Ke(e.value)!==void 0;return{numbers:n,textCase:!n,unit:!1,seconds:n}}case"entityState":case"entityAttribute":case"jinja":case"named":return{numbers:!0,textCase:!0,unit:e.kind!=="jinja"&&e.kind!=="named",seconds:!0};case"entityAge":case"dataAge":return{numbers:!0,textCase:!1,unit:!1,seconds:!0};case"aggregate":return{numbers:!0,textCase:!1,unit:!1,seconds:!1};case"chartStat":{let n=e.stat==="trend";return{numbers:!n,textCase:!1,unit:!n,seconds:!1}}case"time":return{numbers:e.timeField!=="now",textCase:!1,unit:!1,seconds:!1}}}function yb(e,n,t){let i=t===void 0?h`<span class="readout-v now-v none">${Zp(e,n)}</span>`:t.trim()===""?h`<span class="readout-v now-v none">Empty</span>`:h`<span class="readout-v now-v"><span class="now-tok">${t}</span></span>`;return h`<div class="field readout now-field"><span>Now</span>${i}</div>`}function Zp(e,n){let t=n.kind;switch(t.kind){case"entityState":case"entityAttribute":case"entityAge":return t.entityId===""?"Pick an entity":e.hass.states[t.entityId]?t.kind==="entityAttribute"&&t.attribute.trim()===""?"Pick an attribute":t.kind==="entityState"?"No reading":"Waiting for Home Assistant":"No such entity";case"chartStat":return t.layer===""?"Pick a chart":"The chart has no readings yet";case"named":{if(t.id==="")return"Pick a shared value";let i=t.id.toUpperCase(),a=e.config.values.find(r=>r.id.toUpperCase()===i);return a?Zp(e,a.value):"That shared value is gone"}case"jinja":return t.value.trim()===""?"Type a template":"Waiting for Home Assistant";default:return"Waiting for Home Assistant"}}function bb(e,n){if(n.allowNamed===!1||n.noShare)return!1;let t=e.kind;return t.kind==="named"?!1:t.kind==="literal"||t.kind==="jinja"?t.value.trim()!=="":"entityId"in t?t.entityId!=="":t.kind==="chartStat"?t.layer!=="":!0}function xb(e,n,t){let i=fa(n,de(e)).replace(/^"(.*)"$/,"$1"),{named:a,ref:r}=as(e.config,n,De(i,24));e.beginGesture(),e.update(o=>{o.values.push(a)}),t(r),e.endGesture()}function vb(e,n,t){let{named:i,ref:a}=as(e.config,{...n,kind:{kind:"literal",value:""}},"");i.name="",e.beginGesture(),e.update(r=>{r.values.push(i)}),t(a),e.endGesture(),e.selectValue(i.id)}function wb(e,n,t){let i=e??{},a=s=>{let l={...i,...s};for(let d of Object.keys(l))(l[d]===void 0||l[d]===!1||l[d]==="")&&delete l[d];n(l)},r=Ie(e),o={decimals:t.numbers||i.decimals!==void 0,multiply:t.numbers||i.multiply!==void 0,offset:t.numbers||i.offset!==void 0,textCase:t.textCase||i.textCase!==void 0,unit:t.unit||!!i.useEntityUnit,seconds:t.seconds||!!i.relativeTime||!!i.duration};return h`<details class="sub format" ?open=${!r}>
    <summary>Format${r?h`<span class="sum-note">as it comes</span>`:h`<span class="sum-note">${bh(e).replace(/^ \((.*)\)$/,"$1")}</span>`}</summary>
    <div class="grid2">
      ...
      ${Me("Before",i.prefix??"",s=>a({prefix:s}),{placeholder:"text in front"})}
      ${Me("After",i.suffix??"",s=>a({suffix:s}),{placeholder:"text after"})}
    </div>
    ${o.unit?Ye("Add unit",!!i.useEntityUnit,s=>a({useEntityUnit:s})):f}
  ...
  </details>`}function kb(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${o.kind==="filter"?h`<div class="grid2">
          ${Me("Domains",a(o.domains),s=>t({...n,scope:{...o,domains:r(s)}}),{placeholder:"light, switch"})}
          ${Me("Area ids",a(o.areaIds),s=>t({...n,scope:{...o,areaIds:r(s)}}))}
          ${Me("Label ids",a(o.labelIds),s=>t({...n,scope:{...o,labelIds:r(s)}}))}
          ${Me("Floor ids",a(o.floorIds),s=>t({...n,scope:{...o,floorIds:r(s)}}))}
        </div>`:h`${o.entities.map((s,l)=>h`<div class="row-inline">
            ${wt(e,`Entity ${l+1}`,s,d=>{let c=[...o.entities];c[l]=d,t({...n,scope:{...o,entities:c}})},`${i}-agg-${l}`,{compact:!0})}
    ...
    ${n.stateFilter&&"value"in n.stateFilter?Me("State",n.stateFilter.value,s=>t({...n,stateFilter:{kind:n.stateFilter.kind,value:s}})):f}
    ${n.function==="count"?f:Me("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Qp=Bo,$b=Qp.filter(([e])=>e!=="none");function Cb(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function eh(e,n){let t=Cb(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return Xd(e)?{type:e,...t}:{type:e}}var Sb=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function th(e,n,t,i){let a=n.serviceDataJSON??"",r=Jd(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
      ${Me("Domain",n.serviceDomain,s=>t({...n,serviceDomain:s.trim()},"svc-domain"),{placeholder:"light"})}
      ${Me("Service",n.serviceName,s=>t({...n,serviceName:s.trim()},"svc-name"),{placeholder:"turn_on"})}
    </div>
    <div class="chips">
      ${Sb.map(([s,l,d,c])=>h`
    ...
    ${wt(e,"Target entity (optional)",o,s=>{let l={...n};s.entityId===""?delete l.target:l.target=s,t(l,"svc-entity")},`${i}-svc-entity`)}
    ${Vp("Data (JSON)",a,s=>{let l={...n};s.trim()===""?delete l.serviceDataJSON:l.serviceDataJSON=s,t(l,"svc-data")},3)}
    ${r?h`<div class="hint">Leave the data empty for a service that needs nothing else. Anything here must be a JSON object, like <code>{"brightness_pct": 50}</code>. Templates are not run.</div>`:h`<div class="hint warn">That is not a JSON object, so the watch will refuse the tap. It has to look like <code>{"brightness_pct": 50}</code>.</div>`}`}function Tb(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function nh(e){let n=e.config,t=n.tapAction,i=Tb(e.savedName,n.name),a=n.refreshMinutes??0,r=Cp.map(s=>[String(s),Sp(s)]);Cp.includes(a)||r.push([String(a),Sp(a)]);let o=n.showSuccessFlash??!0;return h`
    <div class="gen-row">
      ${Me("Name",n.name,s=>e.update(l=>{l.name=s},"name"))}
      ${$e("Refresh",String(a),r,s=>e.update(l=>{l.refreshMinutes=Number(s)||0},"refresh"))}
      ${$e("Tap action",t.type,Qp,s=>e.update(l=>{l.tapAction=eh(s,l.tapAction),s!=="openPage"&&(delete l.openPageId,delete l.openPageName)}))}
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Eb).slice(0,7)}
    ...
    ${"entityId"in t?wt(e,"Target",t,s=>e.update(l=>{l.tapAction={type:t.type,...s}},"tap-entity"),"general-tap"):f}
    ${t.type==="callService"?th(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?Mb(e):f}`}var Eb="#808080",Cp=[0,15,30,60,120];function Sp(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Mb(e){let n=e.config;return ih(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function ih(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${$e("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function ah(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=Gi(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
    ${Me("Name",n.name,o=>e.update(s=>{s.values[t].name=o},`${i}-name`),{placeholder:"Name it, like Outside temp"})}
    ${se(e,n.value,o=>e.update(s=>{s.values[t].value=o},i),{allowNamed:!1,showResolved:!0,resolveAs:r,inline:!0,key:i})}
    <div class="field readout"><span>Used by</span><span class="readout-v">${a===0?"No layers yet":`${a} ${a===1?"layer":"layers"}`}</span></div>`}function rh(){return{id:J(),name:"",value:L("")}}function He(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function ve(e,n,t,i,a=!1){let r=e.elements.find(c=>c.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=He(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function dn(e,n,t,i,a){let r=n.payload.id,o=Ja(n)??a.min,s=He(e.config,t,n).size??o;return ae(i,s,l=>e.update(d=>ve(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,unit:"pt",...a.def===void 0?{}:{def:a.def}})}function oh(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=Lt()),a=yt(e,n).filter(l=>!be(e,l));if(a.length===0)return;let r=ci(e,a.map(l=>l.payload.id),n),o=Cn(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let c=s?.placements[l],u=c?.size??Ja(d),p={frame:{...c?.frame??d.payload.frame},isHidden:c?.isHidden??!1,...u!==void 0?{size:u}:{}};for(let m of oe)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=Za(p,n,t,d.kind)}ui(e,t)}function eo(e,n){return vc(e,n)}function Rb(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function qn(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"||e.kind==="chartTimes"||e.kind==="chartDots"||e.kind==="chartGrid"||e.kind==="imageTime"?void 0:e.payload.colorSlot.baseColorHex}function sh(e,n,t){let i=Rb(t.map(l=>He(e,n,l).isHidden)),a=t.map(qn),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var vi=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]],Fb=[["leading","Left"],["center","Center"],["trailing","Right"]],Ab=[["1","1"],["2","2"]];function lh(e,n,t){let i=n.payload.id,a=tr(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s={...o?{domain:"camera"}:{},needed:Tp(n)},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return h`
    ${wt(e,o?"Camera":"Entity",r,d=>e.update(c=>wc(c,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint ${Tp(n)?"warn":""}">${Ib(n,a)}</div>`}function Tp(e){return e.kind==="timeline"?e.payload.value.kind.kind!=="entityState":e.kind==="chart"?e.payload.historyMinutes>0&&e.payload.value.kind.kind!=="entityState":e.kind==="image"?e.payload.entity.entityId==="":!1}function Hb(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function to(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Ib(e,n){let t=Hb(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a shared value, so change that shared value to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${to(o)}.${r}`}function Lb(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function pa(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>pa(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>pa(e[a],n[a]))}function Zs(e,n,t){return t.some(i=>!pa(e[i],n[i]))}function Ir(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Ce(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=e.helpSections.has(n),l=()=>e.toggleSection(n),d=()=>{!s&&!o&&e.toggleSection(n),e.toggleHelp(n)},c=s?`Hide the help in ${t}`:`Show help for ${t}`,u=h`<span class="swatch">${V(a.icon??"content")}</span>
  ...
  </section>`}function _b(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function zb(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Pb(e,n){let t=pe[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Nb(e,n,t){let i=Pb(e,n),a=pe[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Db(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Ob(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${zb(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Xn(e,n=Rn){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}function Vb(e,n,t){if(!e||n===void 0||!n.averaged)return;let i=t.replace(/^Last\s+/,""),a=/^\d/.test(i)?`all ${i}`:`the whole ${i}`;return`This span has ${n.readings} readings, more than ${Ft}, so they are averaged into ${Ft} even slots to cover ${a}.`}var Dr=new Set;function ol(e,n,t=Rn){return Dr.has(e)||!t.some(i=>i.minutes===n)}function Qs(e,n,t,i,a=Rn){let r=ol(e,n,a);return h`<label class="field">${Oe("Span",{atDefault:n===t&&!r,title:`Back to ${Xn(t,a)}`,reset:()=>{Dr.delete(e),i(t)}})}
      <select @change=${o=>{let s=o.target.value;s==="custom"?(Dr.add(e),Re(o.target)):(Dr.delete(e),i(Number(s)||Ga))}}>
        ${a.map(({minutes:o,label:s})=>h`<option value=${String(o)} ?selected=${!r&&o===n}>${s}</option>`)}
        <option value="custom" ?selected=${r}>Custom…</option>
      </select></label>`}function el(e,n,t=!1){let i=t?Ho:Ua,a=Math.floor(i/1440),r=t?Ni:Rn,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <div class="hint">${t?h`${Xn(e,r)}, up to 366 days. Statistics rows are never
          purged, so the limit is about what fits on a complication rather than about what
          the recorder still holds.`:h`${Xn(e,r)}, up to 7 days: the recorder keeps
          ten by default, and a longer span would quietly come back short.`}</div>`}function Bb(e){if(e.historyMinutes<=0)return"";if(e.source!=="statistics")return` \xB7 ${Xn(e.historyMinutes)}`;let n=Da.find(([t])=>t===e.statPeriod)?.[1]??e.statPeriod;return` \xB7 ${Xn(e.historyMinutes,Ni)} \xB7 per ${n.toLowerCase()}`}function hl(e,n){let t=de(e);switch(n.kind){case"text":{let i=n.payload.parts?.length??0;return rt(n.payload)?`Rich text, ${i} part${i===1?"":"s"}`:De(Ee(n.payload.value,t),48)}case"icon":return De(Ee(n.payload.symbol,t),48);case"gauge":return De(Ee(n.payload.value,t),48);case"chart":return De(`${Ee(n.payload.value,t)}${Bb(n.payload)}`,48);case"timeline":return De(`${Ee(n.payload.value,t)} \xB7 ${Xn(ot(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return At(n.payload.action);case"chartTimes":{let i=e.config.elements.find(a=>a.payload.id===n.payload.chart);return i?.kind==="chart"||i?.kind==="timeline"?De(`Times of ${Ee(i.payload.value,t)}`,48):"No chart or timeline"}case"imageTime":{let i=e.config.elements.find(a=>a.payload.id===n.payload.image);return i?.kind==="image"?De(`Time of ${Se(i,t)}`,48):"No picture"}case"chartDots":case"chartGrid":{let i=e.config.elements.find(r=>r.payload.id===n.payload.chart),a=n.kind==="chartDots"?"Dots on":"Grid behind";return i?.kind==="chart"?De(`${a} ${Ee(i.payload.value,t)}`,48):"No chart"}}}function Ur(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Ae(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Ae(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Ae(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Ae(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Ae(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Ae(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Ae(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return;case"chartTimes":return`${e.payload.timeLabelCount<=0?"no":e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt \xB7 ${Ae(e.payload.labelColorHex)}`;case"imageTime":return;case"chartDots":{let n=e.payload;return`${n.dots==="all"?"all":"auto"} \xB7 ${n.size===void 0?"automatic size":`${n.size} pt`} \xB7 ${n.colorHex===void 0?"series colour":Ae(n.colorHex)}`}case"chartGrid":{let n=e.payload;return`${n.lines} ${n.lines===1?"line":"lines"} \xB7 ${n.thickness} pt \xB7 ${Ae(n.colorHex)}`}}}function sa(e,n,t,i,a,r){let o=Math.round(t*1e3)/10,s=l=>i(l/100);return h`<label class="pf">
    <span class="pl" title=${`${n}. Drag left or right to change it.`}
      @pointerdown=${Xr(o,s,{step:.5,min:a,max:r})}>${e}</span>
    <input type="number" step="0.5" min=${a} max=${r} .value=${String(o)} aria-label=${`${n} in percent`}
      data-scrub @pointerdown=${ma(o,s,{step:.5,min:a,max:r})}
      @input=${xe(l=>{let d=Number(l);l.trim()!==""&&Number.isFinite(d)&&s(d)})} />
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Gb(e,n,t){let i=n.payload.id,a=`el-${i}`,r=He(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>ve(p,t,i,{frame:kr(o,c)}),`${a}-${u}-${t}`),l=!pa(o,zi)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return Ce(e,"placement","Position",h`
      ...
      ${Ye("Hidden",r.isHidden,u=>e.update(p=>ve(p,t,i,{isHidden:u})),!1)}`,{color:ee.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`})}return d?.place==="through"?Ce(e,"placement","Position",h`
      ...
      ${Rp(e,n,t)}
      ${o.rotationDegrees!==0?Yn("Rotation",o.rotationDegrees,c=>s({rotationDegrees:c},"rot"),{min:-180,max:180,step:1,def:0,format:c=>`${Math.round(c)}\xB0`,unit:"\xB0",range:!1}):f}
      ${Ye("Hidden",r.isHidden,c=>e.update(u=>ve(u,t,i,{isHidden:c})),!1)}`,{color:ee.position,icon:"place",summary:`On the chart \xB7 ${ne(t)}`}):Ce(e,"placement","Position",h`
    ${Rp(e,n,t)}
    ${d===void 0?h`
    <div class="field xy-field"><span>Position</span>
      <div class="xy">
        ${sa("X","Left",o.x,c=>s({x:c},"x"),-100,100)}
        ${sa("Y","Top",o.y,c=>s({y:c},"y"),-100,100)}
      </div>
    </div>
    ${Mp(e,n,t,o,["across","down","both"])}`:ft(d.at)?f:h`
    <div class="field xy-field"><span>Position</span>
      <div class="xy">
        ${sa("X","Left",o.x,c=>s({x:c},"x"),-100,100)}
      </div>
    ...
    <div class="field xy-field"><span>Size</span>
      <div class="xy">
        ${sa("W","Width",o.width,c=>s({width:c},"w"),4,200)}
        ${sa("H","Height",o.height,c=>s({height:c},"h"),4,200)}
      </div>
    </div>
    ${Yn("Rotation",o.rotationDegrees,c=>s({rotationDegrees:c},"rot"),{min:-180,max:180,step:1,def:0,format:c=>`${Math.round(c)}\xB0`,unit:"\xB0",range:!1})}
    ${Ye("Hidden",r.isHidden,c=>e.update(u=>ve(u,t,i,{isHidden:c})),!1)}
    <div class="hint">${d===void 0?"X, Y, W and H are":"W and H are"} a percent of the face, on the ${ne(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.${d===void 0?" Copy position and Paste position repeat a spot on another layer, on any shape.":""}</div>`,{color:ee.position,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${ne(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${ne(t)} face at half size, unrotated and shown`,reset:()=>e.update(c=>ve(c,t,i,{frame:{...zi},isHidden:!1}))}:{}})}var Ep={across:{label:"Center across",title:"Move this layer to the middle of the face, left to right"},down:{label:"Center up and down",title:"Move this layer to the middle of the face, top to bottom"},both:{label:"Center",title:"Move this layer to the middle of the face"}};function Mp(e,n,t,i,a){let r=n.payload.id,o=(c,u)=>e.update(p=>ve(p,t,r,{frame:c}),`el-${r}-${u}-${t}`),s=e.copiedPosition,l=n.payload.chartAnchor!==void 0,d=s!==void 0&&s.family===t&&pa(s.frame,i);return h`<div class="field list-field"><span>Line up</span>
    <div class="chips">
      ${a.map(c=>h`<button class="small" title=${Ep[c].title}
        ?disabled=${Wu(i,c)}
        @click=${()=>o(Gs(i,c),`center-${c}`)}>${Ep[c].label}</button>`)}
    </div>
  </div>
  ${l?f:h`<div class="field list-field"><span>Copy</span>
    <div class="chips">
      ...
      <button class="small" ?disabled=${s===void 0||d}
        ...
        @click=${()=>s&&o(Ay(s,t,n.kind),"paste")}>Paste position</button>
    </div>
  </div>`}`}function Rp(e,n,t){let i=n.payload.chartAnchor;if(i===void 0)return f;let a=n.payload.id,r=`el-${a}-anchor`,o=e.config.elements.filter(c=>c.kind==="chart"),s=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===a);m?.payload.chartAnchor&&c(m.payload.chartAnchor)},u?`${r}-${u}`:void 0),l=de(e),d=!o.some(c=>c.payload.id===i.layer);return h`
    ${o.length<2?f:$e("Follows",i.layer,o.map(c=>[c.payload.id,Se(c,l)]),c=>s(u=>{u.layer=c}))}
    ${$e("Reading",i.at,mt,c=>e.update(u=>{let p=u.elements.find(g=>g.payload.id===a);if(!p?.payload.chartAnchor)return;p.payload.chartAnchor.at=c;let m=u.elements.find(g=>g.payload.id===i.layer);m?.kind==="chart"&&(c==="threshold"&&m.payload.thresholdValue===void 0&&(m.payload.thresholdValue=pl(We(e.resolve(m.payload.value)??"")),m.payload.drawsThreshold=!1),c==="now"&&m.payload.nowIndex===void 0&&(m.payload.nowIndex={kind:{kind:"time",timeField:"hour"}},m.payload.drawsNowLine=!1))}),{def:"highest"})}
    ${dh(e,i,r)}
    ${i.place==="through"?f:$e("Sits",i.place,Oa.filter(([c])=>c!=="through"),c=>s(u=>{u.place=c}),{def:"above"})}
    <div class="grid2">
    ...
    <div class="field list-field"><span>Marker</span>
      <div class="chips">
        ...
        ${n.kind==="text"?h`<button class="small" title="Swap this text marker for an icon of the same shape, keeping where it sits"
              @click=${()=>e.update(c=>{rc(c,a)})}><span>Use an icon</span></button>`:f}
      </div>
    </div>`}
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function Ub(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ue(e.config,t)[0];return Ce(e,"tappable","Tap",yx(e,n,`el-${t}`),{color:ee.tap,icon:"tap",summary:i?At(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>er(a,t))}:{}})}function Kb(e,n,t,i,a){return h`
    ${Yn("Times",e.timeLabelCount,r=>n(o=>{o.timeLabelCount=Math.max(0,Math.min(In,Math.round(r)))},`${i}count`),{min:0,max:In,step:1,def:t.timeLabelCount,format:r=>r<=0?"None":String(Math.round(r)),range:!1})}
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${ae("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(en,Math.max(Qt,r??et))},`${i}size`),{step:.5,min:Qt,max:en,def:t.labelSize,unit:"pt"})}
        ${he("Time colour",e.labelColorHex,r=>n(o=>{o.labelColorHex=r??tt},`${i}colour`),!1,t.labelColorHex)}
      </div>
      ...
      ${ie("Clock",e.hourCycle,Ud,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${ie("Minutes",e.minutes,Kd,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var Wb=[["number","Number"],["entity","Entity"]];function jb(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function qb(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Yb(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=jb(n,o),c=s?n.minValue:n.maxValue,u=y=>a(b=>{s?b.minValue=y??0:b.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Oe(l,d==="number"?un(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Wb.map(([y,b])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a(k=>qb(k,o,y))}}>${b}</button>`)}
      </span>
    ...
    ${a==="bands"?h`
      ...
      ${Gr({bands:n.bands??[],bandAboveColorHex:n.bandAboveColorHex??le},n.colorSlot.baseColorHex,o,d.length===1?d[0]:void 0)}`:f}
    ${ie("Highlight",r,nb,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
        ${r==="lowest"?f:he("Highest colour",n.highColorHex??Ze,c=>s("highColorHex",Ze,c),!1,Ze)}
        ${r==="highest"?f:he("Lowest colour",n.lowColorHex??Qe,c=>s("lowColorHex",Qe,c),!1,Qe)}
      </div>
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var da=new Map,la=new Map,Pt=new Map,Lr=new Map,tl=4,nl=40,Jb=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Zb=[["plain","Plain"],["rich","Rich"]],Qb={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function ml(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Ye("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function ex(e){return e.countdown===!0?"countdown":rt(e)?"rich":"plain"}function tx(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function nx(e,n){let t=Mn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:De(e.kind.value,40)||"template"}:{kind:"value",label:fa(e,n)}}function ch(e,n,t){let i=Mn(e.value),a=i===void 0?De(fa(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${De(i,24)}"`;return`Part ${n+1}: ${a}`}function ix(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,ch(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function sl(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function ax(e,n){if(sl(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Jt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??le],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function Fp(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${to(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var rx={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function ox(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${to(e.moved.map(n=>rx[n]))} moved into Look.`}function sx(e,n,t,i,a){let r=n.payload,o=r.id,s=ex(r),l=(r.parts?.length??0)>0,d=Go(e.config,r.value),c=Pt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?la.get(o):void 0,m=(b,k)=>{let C=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),w=Mr(structuredClone(r),e.config.values);if(la.delete(o),!w.ok){Pt.set(o,{text:Fp(w.blocked),rich:!0,warn:!0}),Re(k);return}Pt.set(o,{text:ox(w.joined?{joined:!0,template:C}:w),rich:!1}),i(S=>{Mr(S,e.config.values),b==="countdown"&&(S.countdown=!0)})},g=(b,k)=>{if(la.delete(o),s==="rich"){let C=b==="countdown"?"countdown":"plain",w=r.parts??[];if(w.length<2){m(C,k);return}let S=Ws(w,e.config.values);S.ok?(Pt.delete(o),la.set(o,C)):Pt.set(o,{text:Fp(S.blocked),rich:!0,warn:!0}),Re(k);return}if(b==="rich"){let C=r.parts?.[0]?.id??J();da.set(o,C),Pt.delete(o),i(w=>{delete w.countdown,cp(w,C)});return}Pt.delete(o),i(C=>{if(b==="countdown"){C.countdown=!0;return}(C.parts?.length??0)>0&&Mr(C,e.config.values),delete C.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${ie("Type",s==="rich"?"rich":"plain",Zb,g,{titles:Qb})}
    ...
    ${p===void 0?f:h`<div class="rich-confirm" role="alertdialog" aria-label=${y}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${b=>{la.delete(o),Re(b.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ${u?h`<div class=${u.warn?"hint warn":"rich-note"}>${u.text}</div>`:f}
    ${s==="rich"?lx(e,n,t,i,a):h`
        ${lh(e,n,a)}
        ${se(e,r.value,b=>i(k=>{k.value=b},"value"),{showResolved:!0,label:s==="countdown"?"Until":"Text",key:`${a}-value`})}
        ${ml(e,s==="countdown",r.value,b=>g(b?"countdown":"plain",null))}
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Se(d,de(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function lx(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=de(e),d=Math.max(0,o.findIndex(A=>A.id===da.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=He(e.config,t,n).size??r.fontSize,g=(A,K)=>{Pt.delete(s),i(R=>{A(R),Pd(R)},K)},y=(A,K)=>g(R=>{let x=R.parts?.find($=>$.id===c.id);x&&A(x)},K?`part-${c.id}-${K}`:void 0),b=(A,K)=>{da.set(s,A),Pt.delete(s),Re(K)},k=(A,K)=>{let R=J();da.set(s,R),g(x=>{(x.parts??=[]).push({id:R,value:A})}),Yp(K,Qr(`${a}-part-${R}`),!0)},C=A=>g(K=>{K.parts&&ha(K.parts,d,A)}),w=()=>{let A=o[d+1]??o[d-1];A&&da.set(s,A.id),g(K=>{K.parts=(K.parts??[]).filter(R=>R.id!==c.id)})},S=o.map((A,K)=>{let R=nx(A.value,l),x=A.id===c.id,$=sl(A),T=R.kind==="value"?e.resolve(A.value):void 0,F=A.fontWeight===void 0?void 0:vi.find(([N])=>N===A.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${x?"true":"false"} class="part-chip ${R.kind} ${x?"on":""}"
      aria-label=${ch(A,K,l)} @click=${N=>b(A.id,N.currentTarget)}>
      <span class="part-dot" style=${`background:${ax(A,p)}`}
        title=${$==="bands"?"By value, with its own bands":$==="pick"?"Its own colour":"The layer colour"}></span>
      ${R.kind==="text"?h`<span class="part-txt">${R.label===""?h`<span class="part-empty">empty</span>`:tx(R.label).map(N=>N.space?h`<span class="part-sp">${"\xB7".repeat(N.text.length)}</span>`:N.text)}</span>`:h`<span class="part-txt">${R.label}</span>`}
    ...
    </button>`}),I=r.rules.some(A=>A.partId===c.id),B=c.value.kind.kind==="literal",z=sl(c),j=c.fontSize!==void 0,M=vi.find(([A])=>A===r.fontWeight)?.[1]??r.fontWeight,U=A=>{A>=tl&&A<=nl&&y(K=>{K.fontSize=A},"size")},Z=z==="bands"?We(e.resolve(c.value)??""):[],H={layer:"Use the layer colour",...B&&z!=="bands"?{bands:"By value needs a live value"}:{}},Q=(A,K)=>y(R=>{let x={bands:R.bands??[],bandAboveColorHex:R.bandAboveColorHex??le};A(x),x.bands.length>0?R.bands=x.bands:delete R.bands,x.bandAboveColorHex!==le?R.bandAboveColorHex=x.bandAboveColorHex:delete R.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${A=>k(L(""),A.currentTarget)}>${V("text")}<span>Add text</span></button>
        <button type="button" class="small" title="Add a part that shows a live value"
          @click=${A=>k({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},A.currentTarget)}>${V("braces")}<span>Add value</span></button>
      </div>
    </div>
    <div class="part-editor">
      ...
      ${se(e,c.value,A=>y(K=>{K.value=A},"value"),{showResolved:!0,label:B?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ...
      ${ie("Colour",z,Jb,A=>y(K=>{if(A==="layer"){delete K.colorHex,delete K.coloring;return}if(A==="pick"){delete K.coloring,K.colorHex=cl(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=Br(We(e.resolve(K.value)??"")))}),{def:"layer",titles:H,...B&&z!=="bands"?{disabled:{bands:!0}}:{}})}
      ${z==="pick"?he("Part colour",c.colorHex,A=>y(K=>{K.colorHex=A??p},"color")):f}
      ${z==="bands"?h`
        ${Gr({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??le},c.colorHex??p,Q,Z.length===1?Z[0]:void 0)}
      ...
      <div class="field seg-field">${Oe("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${M})`,reset:()=>y(A=>{delete A.fontWeight})})}
        ${Or("Weight",c.fontWeight,vi,A=>y(K=>{K.fontWeight=A}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Oe("Font size",j?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(A=>{delete A.fontSize})}:void 0,Xr(c.fontSize??m,U,{step:1,min:tl,max:nl}))}
        ${Jr(c.fontSize,A=>{A===void 0?y(K=>{delete K.fontSize},"size"):U(A)},{step:1,min:tl,max:nl,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:j?"Part font size":`Part font size, ${m} pt from the layer`,...j?{}:{lead:V("link")}})}
      </label>
    </div>
  </div>`}function uh(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(x=>x.payload.id===a),o=`el-${a}`,s=(x,$)=>e.update(T=>x(T.elements[r]),$?`${o}-${$}`:void 0),l=He(e.config,t,n),d=l.frame,c=(x,$)=>e.update(T=>ve(T,t,a,{frame:kr(d,x)}),`${o}-${$}-${t}`),u=Te(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=x=>u[x],g=!1,y=x=>qn(n)===void 0?f:he(x,qn(n),$=>s(T=>{qn(T)!==void 0&&(T.payload.colorSlot.baseColorHex=$??"#FFFFFF")},"color"),!1,p),b,k={},C,w;switch(n.kind){case"text":{let x=($,T)=>s(F=>$(F.payload),T);C=sx(e,n,t,x,o),g=!n.payload.countdown&&!rt(n.payload),w=h`
        ${dn(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${ie("Weight",n.payload.fontWeight,vi,$=>s(T=>{T.payload.fontWeight=$}),{def:u.fontWeight})}
        ${Py({label:"Align",value:n.payload.alignment??"center",options:Fb,def:"center",set:$=>s(T=>{let F=T.payload;$==="center"?delete F.alignment:F.alignment=$})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:Ab,def:"1",set:$=>s(T=>{let F=T.payload;$==="2"?F.lineLimit=2:delete F.lineLimit})})}
        ${Ye("Mono digits",n.payload.monospacedDigits===!0,$=>s(T=>{let F=T.payload;$?F.monospacedDigits=!0:delete F.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${g?Xb(e,n.payload,x,y("Main colour")):f}`;break}case"icon":C=h`
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,w=dn(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let x=n.payload,$=(F,N)=>s(q=>F(q.payload),N),T=x.style==="dots";C=h`
        ${se(e,x.value,F=>$(N=>{N.value=F},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${T?h`
            ${se(e,x.total??kp(x),F=>$(N=>{N.total=F},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Va} dots are drawn.</div>`:Yb(e,x,{min:u.minValue,max:u.maxValue},o,$)}`,g=!0,w=h`
        <div class="grid2">
          ${ie("Style",x.style,lb,F=>$(N=>{F==="dots"&&N.total===void 0&&(N.total=kp(N)),F!=="dots"&&delete N.total,N.style=F}),{titles:db,def:u.style})}
          ${T?f:dn(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${he(T?"Empty dot colour":"Track colour",x.trackColorHex,F=>$(N=>{N.trackColorHex=F??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${ie("Colour",x.coloring,rl,F=>$(N=>{N.coloring=F,F==="bands"&&N.bands.length===0&&(N.bands=Br([N.minValue,N.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${Gr(x,x.colorSlot.baseColorHex,$,We(e.resolve(x.value)??"")[0])}`:f}
        ${T?f:h`
          <div class="grid2">
            ${ae("Threshold",x.thresholdValue,F=>$(N=>{F===void 0?delete N.thresholdValue:N.thresholdValue=F},"thr"),{optional:!0,def:null})}
            ${x.thresholdValue===void 0?f:he("Threshold colour",x.thresholdColorHex,F=>$(N=>{N.thresholdColorHex=F??ri},"thrcol"),!1,ri)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let x=n.payload,$=(E,D)=>s(fe=>E(fe.payload),D),T=u.historyMinutes,F=u.historyPoints,N=x.historyMinutes>0,q=N&&x.source==="statistics",te=N&&!q,we=N?q?"statistics":"history":"value",kt=q?Ni:Rn,Ot=An(x)??Hn(x),ze=x.value.kind.kind==="entityState",me=Ot===void 0?void 0:e.historySeries(Ot),Ve=N&&ze?me??"":e.resolve(x.value)??"",Xe=x.historyPoints<1,Qh=te&&ze&&Ot!==void 0?e.historyReadings?.(Ot):void 0,Fl=Vb(Xe,Qh,Xn(x.historyMinutes)),Al=ol(a,x.historyMinutes,kt),ro=N&&ze?ys(Ve):{values:We(Ve),holes:[]},ei=ro.values,Hl=E=>x.limit>0&&E.length>x.limit?x.takeFromEnd?E.slice(E.length-x.limit):E.slice(0,x.limit):E,em=Hl(ei),Vt=bs(em,at(x.smoothing),ro.holes.length>0?Hl(ro.holes):[]),tm=!N&&ze&&ei.length===1,oo=e.config.elements.filter(E=>E.kind==="chart"&&E.payload.id!==a),Il=de(e),ba=x.scaleFrom!==void 0&&oo.some(E=>E.payload.id===x.scaleFrom);C=h`
        ${se(e,x.value,E=>$(D=>{D.value=E},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${ie("Draw",we,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],E=>$(D=>{if(E==="value"){D.historyMinutes=0;return}D.source=E==="statistics"?"statistics":"history";let fe=D.historyMinutes||Ga;D.historyMinutes=E==="statistics"?Math.min(fe,Ho):Math.min(fe,Ua)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${q?h`
            ...
            <div class="grid2">
              ${Qs(a,x.historyMinutes,T,E=>$(D=>{D.historyMinutes=E}),Ni)}
              ${ie("Per",x.statPeriod,Da,E=>$(D=>{D.statPeriod=E}),{def:Li})}
            </div>
            ${Al?el(x.historyMinutes,E=>$(D=>{D.historyMinutes=E},"span"),!0):f}
            ${ie("Read",x.statType,To,E=>$(D=>{D.statType=E}),{def:_i})}
            ...
            ${ze&&me===void 0?h`<div class="hint keep">Reading the statistics…</div>`:f}
            ${ze&&me===""?h`<div class="hint warn">No long-term statistics for this entity in that span.
        ...
        ${te?h`
            ${ze?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Qs(a,x.historyMinutes,T,E=>$(D=>{D.historyMinutes=E}))}
                ...
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Points">
                    <button type="button" role="radio" aria-checked=${Xe?"false":"true"} class=${Xe?"":"on"}
                      ...
                      @click=${()=>{Xe&&$(E=>{E.historyPoints=24})}}>Average</button>
                    <button type="button" role="radio" aria-checked=${Xe?"true":"false"} class=${Xe?"on":""}
                      title="Plot every recorded state change, no averaging"
                      @click=${()=>{Xe||$(E=>{E.historyPoints=Io})}}>Every one</button>
                  </div>
                  ${Xe?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      step="1" min=${Ka} max=${Ft}
                      data-scrub @pointerdown=${ma(x.historyPoints,E=>$(D=>{D.historyPoints=Math.round(E)},"hpoints"),{step:1,min:Ka,max:Ft})}
                      @input=${xe(E=>{let D=Number(E);E.trim()!==""&&Number.isFinite(D)&&D>=1&&$(fe=>{fe.historyPoints=Math.round(D)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${Al?el(x.historyMinutes,E=>$(D=>{D.historyMinutes=E},"span")):f}
            <div class="hint">${Xe?h`Every state the recorder holds in that span, oldest first, one reading per change.
            ...
            ${Fl===void 0?f:h`<div class="hint keep">${Fl}</div>`}
            ${ze&&me===void 0?h`<div class="hint keep">Reading the history…</div>`:f}
            ${ze&&me===""?h`<div class="hint warn">Nothing recorded for this entity in that span.
                Either it is excluded from the recorder, or it has no numeric states.</div>`:f}`:f}
        ${N?h`
            ${Ye("Show gaps when unavailable",x.gaps===!0,E=>$(D=>{E?D.gaps=!0:delete D.gaps}),u.gaps===!0)}
            ${ln(e)}
        ...
        ${ei.length===0&&!(N&&(!ze||me===void 0||me===""))?h`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${ei.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${_b(Vt)}</span>${ei.length===Vt.length?h` · ${Vt.length} ${Vt.length===1?"value":"values"}`:h` · ${Vt.length} of ${ei.length}`}</span></div>`:f}
        ${tm?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
              Switch Draw to <b>Recorded history</b> to plot how it has moved.</div>`:f}
        ${N&&x.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",x.limit,E=>$(D=>{D.limit=Math.max(0,Math.round(E??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${x.limit<=0?f:ie("Keep",x.takeFromEnd?"end":"start",N?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],E=>$(D=>{D.takeFromEnd=E==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ${N?h`<div class="hint warn">Span and slots already set how much is drawn, so set this to 0.
        ...
        ${$e("Smooth data",at(x.smoothing)??"off",Qy,E=>$(D=>{let fe=at(E);fe===void 0?delete D.smoothing:D.smoothing=fe}),{def:at(u.smoothing)??"off"})}
        ${ln(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,g=!0;let nm=(()=>{if(ba)return!0;if(x.scale==="fixed")return x.minValue<0&&x.maxValue>0;let E=Vt.filter(so=>Number.isFinite(so));if(E.length===0)return!0;let D=Math.min(...E,x.thresholdValue??1/0),fe=Math.max(...E,x.thresholdValue??-1/0);return D<0&&fe>0})();w=h`
        <div class="grid2">
          ${ie("Style",x.style,jp,E=>$(D=>{D.style=E}),{def:u.style})}
          ${x.style==="bars"?ae("Bar gap",x.barGap,E=>$(D=>{D.barGap=Math.max(0,E??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):dn(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${x.style==="bars"?h`
          <div class="grid2">
            ${ae("Corner radius",jt(x.barRadius),E=>$(D=>{let fe=Math.max(0,E??ai);fe===ai?delete D.barRadius:D.barRadius=fe},"barradius"),{step:.5,min:0,def:jt(u.barRadius),unit:"pt"})}
          </div>
          ${Ye("Round top only",qt(x.barCorners)==="top",E=>$(D=>{E?D.barCorners="top":delete D.barCorners}),qt(u.barCorners)==="top")}
          ${ln(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${ie("Curve",x.curve??"straight",Jy,E=>$(D=>{E==="straight"?delete D.curve:D.curve=E}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${ln(e)}
          ${x.style==="area"?h`
            ${ie("Fill",Wt(x.fillStyle),Zy,E=>$(D=>{E==="flat"?delete D.fillStyle:D.fillStyle=E}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:Wt(u.fillStyle)})}
            ${al("Fill colour",x.fillColorHex,"Line colour",E=>$(D=>{E===void 0?delete D.fillColorHex:D.fillColorHex=E},"fillcol"))}
            ${ln(e)}`:f}`}
        <div class="grid2">
          ${ie("Scale",x.scale,eb,E=>$(D=>{D.scale=E}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${ie("Baseline",x.baseline,tb,E=>$(D=>{D.baseline=E}),{def:u.baseline})}
        </div>
        ${oo.length===0?f:$e("Same scale as",ba?x.scaleFrom:"",[["","Its own"],...oo.map(E=>[E.payload.id,Se(E,Il)])],E=>$(D=>{E?D.scaleFrom=E:delete D.scaleFrom}),{def:""})}
        ...
        ${!ba&&x.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",x.minValue,E=>$(D=>{D.minValue=E??0},"cmin"),{def:u.minValue})}
              ${ae("Max",x.maxValue,E=>$(D=>{D.maxValue=E??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let E;e.update(D=>{E=bc(D,a,fe=>Se(fe,Il))}),E&&e.selectLayer(E)}}>${V("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${ie("Colour",x.coloring,rl,E=>$(D=>{D.coloring=E,E==="bands"&&D.bands.length===0&&(D.bands=Br(Vt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${Gr(x,x.colorSlot.baseColorHex,$)}
          ${x.style==="area"?h`${Ye("Band fill",x.fillBands,E=>$(D=>{D.fillBands=E}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let Ll=E=>Be(e.config,a).some(D=>D.payload.chartAnchor?.at===E),im=nn(e.config,a).length>0,am=zn(e.config,a).length>0,rm=Pn(e.config,a).length>0,_l=sc(e.config,a).length>0,zl=Fn(x)?void 0:Xe&&te?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Pl=x.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0;k={"draw:times":zl,"draw:dots":Pl};let ti=(E,D,fe,so,Nl)=>h`
        <button class="small ${fe?"on":""}" ?disabled=${fe||Nl!==void 0} aria-pressed=${fe?"true":"false"}
          data-extra=${E} title=${Kr(E,fe?`${D} is on this chart. Remove it in the list at the bottom.`:Nl??`Add ${D.toLowerCase()} to this chart`)}
          @click=${()=>e.update(om=>{so(om)})}>${fe?h`<span aria-hidden="true">✓</span>`:V("plus")}<span>${D}</span></button>`;b=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders" @pointerover=${cn} @focusin=${cn}>
            ${ti("draw:threshold","Threshold line",Ll("threshold"),E=>lc(E,a,x.thresholdValue??pl(Vt)))}
            ${ti("draw:now","Now line",Ll("now"),E=>dc(E,a,!0))}
            ${ti("draw:zero","Zero line",_l,E=>{Jo(E,a)})}
            ${ti("draw:times","Clock times",im,E=>{_n(E,a)},zl)}
            ${ti("draw:dots","Dots",am,E=>{Yo(E,a)},Pl)}
            ${ti("draw:grid","Grid lines",rm,E=>{Xo(E,a)})}
          </div>
        </div>
        ${_l&&!nm?h`<div class="hint warn">These readings never go below zero, or never above it, so the zero
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${ln(e)}`;break}case"timeline":{let x=n.payload,$=(me,Ve)=>s(Xe=>me(Xe.payload),Ve),T=u.historyMinutes,F=x.value.kind.kind==="entityState",N=gt(x),q=N===void 0?void 0:e.historySeries(N),te=ot(x)*60,we=Yi(q??"",tn),kt=ol(a,x.historyMinutes),Ot=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,ze=ob(we,te,Ot===void 0?void 0:e.hass.states[Ot]?.state,Ot?.split(".")[0]);C=h`
        ${se(e,x.value,me=>$(Ve=>{Ve.value=me},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        ${Qs(a,x.historyMinutes,T,me=>$(Ve=>{Ve.historyMinutes=me}))}
        ${kt?el(x.historyMinutes,me=>$(Ve=>{Ve.historyMinutes=me},"span")):f}
        <div class="hint">Every state the recorder holds in that span, oldest at the left, each run as
          wide as the time it lasted. At most ${tn} changes are drawn, and a
        ...
        ${we.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Ob(we,te)}</span></span></div>`:f}
        ${Db(we)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${sb(x,$,ze,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ${ze.length>2?h`<div class="hint keep">Seen in this span: <span class="nums">${ze.filter(me=>me!=="unavailable"&&me!=="unknown").join(", ")}</span>. Click into a State box to pick one.</div>`:f}
        <div class="grid2">
          ${ae("Gap",x.gap,me=>$(Ve=>{Ve.gap=Math.min(Wa,Math.max(0,me??0))},"tgap"),{step:.5,min:0,max:Wa,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",x.cornerRadius,me=>$(Ve=>{Ve.cornerRadius=Math.max(0,me??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
...
`;break}case"shape":C=h`<div class="grid2">
        ...
        ${n.payload.kind==="line"?Nb(t,d,c):f}`,w=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,x=>s($=>{$.payload.thickness=x??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${n.payload.borderColorHex!==void 0?ae("Border width",n.payload.borderWidth,x=>s($=>{$.payload.borderWidth=x??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let x=n.payload,$=(q,te)=>s(we=>q(we.payload),te),T=x.entity.entityId?e.hass.states[x.entity.entityId]?.attributes?.entity_picture:void 0,F=typeof T=="string"?T:void 0,N=F!==void 0&&!F.startsWith("/");C=h`
        ...
        ${Yn("Zoom",x.zoom,q=>$(te=>{te.zoom=q},"zoom"),{min:Rs,max:4,step:.05,def:1,format:q=>`${q.toFixed(2)}x`,unit:"x"})}
        ${Yn("Pan left/right",x.panX,q=>$(te=>{te.panX=q},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${Yn("Pan up/down",x.panY,q=>$(te=>{te.panY=q},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${x.contentMode==="fit"&&x.zoom===1?"hint keep":"hint"}>${Lb(x)}</div>
        ${ae("Corner radius",x.cornerRadius,q=>$(te=>{te.cornerRadius=Math.max(0,q??oi)},"imgradius"),{step:1,min:0,def:oi,unit:"pt"})}`;break}case"tap":{C=h`
        ${fl(e,n.payload,(x,$)=>s(T=>x(T.payload),$),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let x=n.payload,$=(q,te)=>s(we=>q(we.payload),te),T=e.config.elements.find(q=>q.payload.id===x.chart),F=T?.kind==="chart"||T?.kind==="timeline"?T:void 0,N=F?.kind==="timeline"?"timeline":"chart";C=h`
        <div class="field readout"><span>${F?.kind==="timeline"?"Timeline":"Chart"}</span><span class="readout-v">${F?h`<button class="small" title=${`Select that ${N}`} @click=${()=>e.selectLayer(F.payload.id)}>${Se(F,de(e))}</button>`:"None"}</span></div>
        ${F===void 0?h`<div class="hint warn">The chart or timeline these times belonged to is gone, so this layer draws nothing.</div>`:F.kind==="timeline"?gt(F.payload)===void 0?h`<div class="hint warn">That timeline names no entity yet, so it has no span to label and
                  this layer draws nothing.</div>`:f:Fn(F.payload)?f:h`<div class="hint warn">That chart has no evenly spaced span to label, so this layer draws
                  nothing. Clock times are drawn when its Draw is Recorded history with Points on Average,
                  or Long-term statistics.</div>`}
        <div class="hint">The clock times of that ${N}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,w=Kb(x,$,u,"ct",h`
        <div class="hint">Evenly spaced from the start of the ${N}'s span to now. Auto follows the watch's
        ...
        <div class="field readout"><span>Picture</span><span class="readout-v">${T?h`<button class="small" title="Select that picture" @click=${()=>e.selectLayer(T.payload.id)}>${Se(T,de(e))}</button>`:"None"}</span></div>
        ...
        <div class="hint">The time that picture was fetched, not the time now: a picture that stops updating
          ...
          has been fetched once. Move and size it like any other layer: the chip grows to fill the frame.</div>`;break}case"chartDots":{let x=n.payload,$=(te,we)=>s(kt=>te(kt.payload),we),T=e.config.elements.find(te=>te.payload.id===x.chart),F=T?.kind==="chart"?T:void 0,N=F===void 0?void 0:He(e.config,t,F).size??F.payload.lineWidth,q=N===void 0?void 0:Math.round(N*18)/10;C=h`
        ${Ap(e,F)}
        ...
        ${ln(e)}`,w=h`
        ${ie("Dots",x.dots,Wp,te=>$(we=>{we.dots=te}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",x.size??q,te=>$(we=>{let kt=pt(te);kt===void 0||kt===q?delete we.size:we.size=kt},"dotsize"),{step:.5,min:1,max:12,...q===void 0?{}:{def:q},unit:"pt"})}
          ${al("Dot colour",x.colorHex,"Series colour",te=>$(we=>{te===void 0?delete we.colorHex:we.colorHex=te},"dotcol"))}
        </div>
        <div class="hint">Auto leaves the dots off once the readings sit too close to tell apart. Left alone, a dot
          is a little wider than the chart's line and takes the colour the series has at its reading.</div>`;break}case"chartGrid":{let x=n.payload,$=(N,q)=>s(te=>N(te.payload),q),T=e.config.elements.find(N=>N.payload.id===x.chart),F=T?.kind==="chart"?T:void 0;C=h`
        ${Ap(e,F)}
        ...
        ${ln(e)}`,w=h`
        <div class="grid2">
          ${ae("Lines",x.lines,N=>$(q=>{q.lines=Tn(N??Xt)},"lines"),{step:1,min:1,max:4,def:Xt})}
          ${ae("Thickness",x.thickness,N=>$(q=>{q.thickness=En(N??Yt)},"thick"),{step:.25,min:Pa,max:Na,def:Yt,unit:"pt"})}
        </div>
        ${he("Colour",x.colorHex,N=>$(q=>{q.colorHex=N??Mt},"gridcol"),!1,Mt)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let S=g||qn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&rt(n.payload)?"Layer colour":"Colour"),I=es(e.config,n),B=I?{kind:{kind:"entityState",...I}}:void 0,z=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,j=cx[n.kind],M=ux[n.kind],U=Zs(n.payload,u,j),Z=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,H=e.config.perFamily[t]?.placements[a]?.size!==void 0,Q=Zs(n.payload,u,M)||Z!==void 0&&l.size!==void 0&&l.size!==u[Z],A=Ln(e.config,a),K=(x,$)=>()=>s(T=>Ir(T.payload,u,x),$),R=h`<section class="sec name-sec" data-open="true" style=${`--c:${ee.place}`}>
    <div class="sec-h pinned">
      ...
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${mh(n,de(e))}
        @input=${xe(x=>s($=>{let T=xx(x);T===void 0?delete $.payload.name:$.payload.name=T},"name"))} />
    </div>
  </section>`;return h`
    ${R}
    ${Ce(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:lh(e,n,o)}${C}`,{color:ee.content,icon:"content",summary:hl(e,n),...U?{reset:()=>s(x=>{Ir(x.payload,u,j),x.kind==="text"&&ia(x.payload.rules)},"reset-content")}:{}})}
    ${w===void 0&&S===void 0?f:Ce(e,"look",n.kind==="image"?"Picture":"Look",h`${w??f}${S??f}`,{color:ee.look,icon:n.kind==="image"?"image":"look",...Ur(n)?{summary:Ur(n)}:{},...Q?{reset:()=>e.update(x=>{Ir(x.elements[r].payload,u,M),H&&ve(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Ce(e,"numbers","Extras",fx(e,n,b,k),{color:ee.numbers,icon:"text",summary:mx(e,n),...A.length>0||Be(e.config,a).length>0||nn(e.config,a).length>0||zn(e.config,a).length>0||Pn(e.config,a).length>0||Zs(n.payload,u,Hp)?{reset:()=>e.update(x=>{for(let T of Ln(x,a))ye(x,T.payload.id);for(let T of Be(x,a))ye(x,T.payload.id);for(let T of nn(x,a))ye(x,T.payload.id);for(let T of zn(x,a))ye(x,T.payload.id);for(let T of Pn(x,a))ye(x,T.payload.id);let $=x.elements.find(T=>T.payload.id===a);$&&Ir($.payload,u,Hp)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?dx(e,n):f}
    ${Ce(e,"states","States",kh(e,n.payload.rules,n.kind,x=>x.elements.find($=>$.payload.id===a)?.payload.rules,`rules-${a}`,B,z),{color:ee.states,icon:"states",summary:ea(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Gb(e,n,t)}
    ${i.tap===!1?f:Ub(e,n)}`}function dx(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?nn(e.config,t):Wo(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);if(!m)return;let g=m.payload.frame;m.payload.frame={...He(p,o,m).frame},i?_n(p,t):qo(p,t,pe[o==="inline"?"rectangular":o]),m.payload.frame=g}),l=a.length>0,d=a.map(p=>({el:p,lead:V("clock"),title:r,kind:i?"Times":"Timestamp"})),c=i?"timeline:times":"image:time",u=h`
    ${hh(i?"timeline":"image")}
    <div class="field list-field"><span>Draw</span>
      <div class="adders" @pointerover=${cn} @focusin=${cn}>
        <button class="small ${l?"on":""}" ?disabled=${l} aria-pressed=${l?"true":"false"} data-extra=${c}
          title=${Kr(c,l?`${r} is on this ${i?"timeline":"picture"}. Remove it in the list below.`:`Add ${r.toLowerCase()}`)}
    ...
    ${l?h`
      ${gl(e,d,{icon:"close",danger:!0,label:p=>`Delete this ${p}`,run:p=>e.update(m=>ye(m,p))})}
      <div class="hint">Click the row to open its main settings here. More settings selects that layer. The ×
        deletes it, and Undo brings it back.</div>`:f}`;return Ce(e,"numbers","Extras",u,{color:ee.numbers,icon:"clock",summary:l?`${r} layer`:"None yet",...l?{reset:()=>e.update(p=>{for(let m of a)ye(p,m.payload.id)})}:{}})}var cx={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"],chartTimes:[],chartDots:[],chartGrid:[],imageTime:[]},ux={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","coloring","bands","bandAboveColorHex","fillBands","curve","fillStyle","fillColorHex","barRadius","barCorners","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[],chartTimes:["timeLabelCount","labelSize","labelColorHex","hourCycle","minutes"],chartDots:["dots","size","colorHex"],chartGrid:["lines","colorHex","thickness"],imageTime:[]};function Ap(e,n){return h`<div class="field readout"><span>Chart</span><span class="readout-v">${n?h`<button class="small" title="Select that chart" @click=${()=>e.selectLayer(n.payload.id)}>${Se(n,de(e))}</button>`:"None"}</span></div>`}var Hp=["highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","drawsThreshold","drawsNowLine","drawsTimeLabels","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"];function fl(e,n,t,i){let a=n.action;return h`
    ${$e("Tap action",a.type,$b,r=>t(o=>{o.action=eh(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?wt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?th(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?ih(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var px=24;function hx(e,n){let t=[],i=1/0;for(let r of oe){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=gc(e.config,n,r);o&&(t.push(`${ne(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<px;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function mx(e,n){let t=n.payload,i=Ln(e.config,t.id),a=Be(e.config,t.id),r=nn(e.config,t.id),o=zn(e.config,t.id),s=Pn(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(Rt.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(mt.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function fx(e,n,t,i={}){let a=de(e),r=Ln(e.config,n.payload.id),o=nn(e.config,n.payload.id),s=zn(e.config,n.payload.id),l=Pn(e.config,n.payload.id),d=Be(e.config,n.payload.id),c=b=>e.update(k=>{ic(k,n.payload.id,b)}),u=b=>e.update(k=>{Ko(k,n.payload.id,b)}),p=new Set(r.map(b=>b.payload.value.kind.kind==="chartStat"?b.payload.value.kind.stat:"")),m=new Set(d.map(b=>b.payload.chartAnchor.at)),g=[...r.map(b=>({el:b,lead:e.resolve(b.payload.value)??"--",title:Se(b,a),kind:"Number"})),...d.map(b=>{let{at:k,place:C}=b.payload.chartAnchor,w=mt.find(([I])=>I===k)?.[1]??"Reading";if(C==="through")return{el:b,lead:k==="now"?"\u2502":"\u2500",title:k==="zero"?"Zero":w,kind:"Line"};let S=b.kind==="text"?e.resolve(b.payload.value)??"\u25CF":b.kind==="icon"?bx(e.resolve(b.payload.symbol)):"\u25C6";return{el:b,lead:S,title:w,kind:"Marker"}}),...o.map(b=>({el:b,lead:V("clock"),title:"Clock times",kind:"Times"})),...s.map(b=>({el:b,lead:V("chartDots"),title:"Reading dots",kind:"Dots"})),...l.map(b=>({el:b,lead:V("chartGrid"),title:"Grid lines",kind:"Grid"}))],y=g.length;return h`
      ...
      <div class="adders" @pointerover=${cn} @focusin=${cn}>
        ${Rt.map(([b,k])=>h`
          <button class="small ${p.has(b)?"on":""}" data-extra=${`number:${b}`}
            title=${Kr(`number:${b}`,p.has(b)?`Add another ${k.toLowerCase()}`:`Add the ${k.toLowerCase()}`)}
    ...
    <div class="field list-field"><span>Markers</span>
      <div class="adders" @pointerover=${cn} @focusin=${cn}>
        ${mt.filter(([b])=>ft(b)).map(([b,k])=>h`
          <button class="small ${m.has(b)?"on":""}" data-extra=${`marker:${b}`}
            title=${Kr(`marker:${b}`,m.has(b)?`Add another mark over the ${k.toLowerCase()}`:`Mark the ${k.toLowerCase()}`)}
    ...
    ${y===0?f:h`
      ...
      ${gl(e,g,{icon:"close",danger:!0,label:b=>`Delete this ${b}`,run:b=>e.update(k=>ye(k,b))})}
      <div class="hint">Click a row to open its main settings here. More settings selects that layer for the
        ...
        dot to pick the dots.</div>`}`}var ua,ph="wrist-assistant-extras-preview",no=(()=>{try{return window.localStorage.getItem(ph)!=="off"}catch{return!0}})();function Ip(e,n){no=e;try{window.localStorage.setItem(ph,e?"on":"off")}catch{}Re(n)}function cn(e){if(!no)return;let n=e.target?.closest?.("[data-extra]")?.getAttribute("data-extra");!n||n===ua||(ua=n,Re(e.currentTarget))}function Kr(e,n){return no?n:`${qs(e)} ${n}.`}function hh(e,n={}){if(!no)return h`<button class="link xprev-show" @click=${o=>Ip(!0,o.currentTarget)}>
      ${V("show")}<span>Show preview</span></button>`;let t=e==="timeline"?"timeline:times":e==="image"?"image:time":void 0,i=ua!==void 0&&js(ua)===e?ua:t,a=i===void 0?void 0:n[i],r=e==="image"?"picture":e;return h`<div class="xprev">
    <span class="well">${mp(e,i)}</span>
    <span class="xprev-t">
      <b>${i===void 0?"Preview":fp(i)}</b>
    ...
    <button class="icon xprev-hide" title="Hide the preview" aria-label="Hide the preview"
      @click=${o=>Ip(!1,o.currentTarget)}>${V("hide")}</button>
  </div>`}function gl(e,n,t){return h`<div class="chart-numbers">${np(n,a=>a.el.payload.id,({el:a,lead:r,title:o,kind:s})=>{let l=a.payload.id,d=s.toLowerCase();return h`
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function gx(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===t);m&&c(m)},`${i}-${u}`),o=Te(n.kind).payload,s=qn(n),l=s===void 0?f:he("Colour",s,c=>r(u=>{qn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ${c.kind==="chartStat"?$e("Number",c.stat,[...Rt],u=>r(p=>{p.kind==="text"&&p.payload.value.kind.kind==="chartStat"&&(p.payload.value={...p.payload.value,kind:{...p.payload.value.kind,stat:u}})},"stat")):d||rt(n.payload)?f:se(e,n.payload.value,u=>r(p=>{p.kind==="text"&&(p.payload.value=u)},"value"),{showResolved:!0,label:n.payload.countdown?"Until":"Text",key:`${i}-value`})}
        ${d&&d.place!=="through"?Lp(e,t,d,r):f}
        <div class="grid2">
          ${dn(e,n,a,"Font size",{step:1,min:4,def:o.fontSize})}
          ${n.payload.countdown||rt(n.payload)?f:l}
        </div>`}case"icon":return h`
        ${d?Lp(e,t,d,r):se(e,n.payload.symbol,c=>r(u=>{u.kind==="icon"&&(u.payload.symbol=c)},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${i}-symbol`,setSymbolPath:c=>r(u=>{u.kind==="icon"&&(c?u.payload.path=c:delete u.payload.path)},"symbol")})}
        <div class="grid2">
          ${dn(e,n,a,"Icon size",{step:1,min:4,def:o.size})}
          ${l}
        ...
        <div class="grid2">
          ${c.style==="dots"?f:dn(e,n,a,"Line width",{step:.5,min:.5,def:o.lineWidth})}
          ${l}
        ...
        ${ie("Style",c.style,jp,u=>r(p=>{p.kind==="chart"&&(p.payload.style=u)},"style"),{def:o.style})}
        <div class="grid2">
          ${c.style==="bars"?f:dn(e,n,a,"Line width",{step:.5,min:.5,def:o.lineWidth})}
          ${l}
        ...
        ${ie("Picture",c.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],u=>r(p=>{p.kind==="image"&&(p.payload.contentMode=u)},"mode"),{def:o.contentMode})}`}case"tap":return fl(e,n.payload,(c,u)=>r(p=>{p.kind==="tap"&&c(p.payload)},u??"action"),i);case"chartTimes":{let c=n.payload;return h`
        ${Yn("Times",c.timeLabelCount,u=>r(p=>{p.kind==="chartTimes"&&(p.payload.timeLabelCount=Math.max(0,Math.min(In,Math.round(u))))},"count"),{min:0,max:In,step:1,def:o.timeLabelCount,format:u=>u<=0?"None":String(Math.round(u)),range:!1})}
        <div class="grid2">
          ${ae("Time size",c.labelSize,u=>r(p=>{p.kind==="chartTimes"&&(p.payload.labelSize=Math.min(en,Math.max(Qt,u??et)))},"size"),{step:.5,min:Qt,max:en,def:o.labelSize,unit:"pt"})}
          ${he("Time colour",c.labelColorHex,u=>r(p=>{p.kind==="chartTimes"&&(p.payload.labelColorHex=u??tt)},"colour"),!1,o.labelColorHex)}
        ...
        ${ie("Dots",c.dots,Wp,g=>r(y=>{y.kind==="chartDots"&&(y.payload.dots=g)},"mode"),{def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",c.size??m,g=>r(y=>{if(y.kind!=="chartDots")return;let b=pt(g);b===void 0||b===m?delete y.payload.size:y.payload.size=b},"size"),{step:.5,min:1,max:12,...m===void 0?{}:{def:m},unit:"pt"})}
          ${al("Dot colour",c.colorHex,"Series colour",g=>r(y=>{y.kind==="chartDots"&&(g===void 0?delete y.payload.colorHex:y.payload.colorHex=g)},"colour"))}
        </div>`}case"chartGrid":{let c=n.payload;return h`
        <div class="grid2">
          ${ae("Lines",c.lines,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.lines=Tn(u??Xt))},"lines"),{step:1,min:1,max:4,def:Xt})}
          ${ae("Thickness",c.thickness,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.thickness=En(u??Yt))},"thick"),{step:.25,min:Pa,max:Na,def:Yt,unit:"pt"})}
        </div>
        ${he("Colour",c.colorHex,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.colorHex=u??Mt)},"colour"),!1,Mt)}`}default:return h`${l}`}}function Lp(e,n,t,i){let a=mt.filter(([r])=>ft(r)||r===t.at);return h`
    <div class="grid2">
      ${$e("Reading",t.at,a,r=>i(o=>{o.payload.chartAnchor&&(o.payload.chartAnchor.at=r)},"at"))}
      ${$e("Sits",t.place,Oa.filter(([r])=>r!=="through"),r=>i(o=>{o.payload.chartAnchor&&(o.payload.chartAnchor.place=r)},"place"))}
    </div>`}function yx(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ue(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=ts(e.config,n);return h`
    ${Ye("Tappable",a!==void 0,s=>e.update(l=>{s?Qa(l,i):er(l,i)}))}
    ${a?h`<div class="value-editor">
          ${fl(e,a.payload,r,`${t}-attached`)}
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${Ya(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...Vo}})}>${V("reset")}</button>`}
            </div>
          </div>
        </div>
        ${hx(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${At(o)}</b>.</div>`}`}function _p(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function bx(e){return e===void 0?"\u25C6":e.includes("up")?"\u25B2":e.includes("down")?"\u25BC":e.startsWith("circle")?"\u25CF":"\u25C6"}function Se(e,n){return e.payload.name?e.payload.name:mh(e,n)}function xx(e){let n=e.trim();return n===""?void 0:n}function mh(e,n){let t=e.payload.chartAnchor;if(t!==void 0){let i=mt.find(([a])=>a===t.at)?.[1]??"Reading";return t.place==="through"?`${i} line`:`${i} marker`}switch(e.kind){case"text":return _p(Ee(e.payload.value,n));case"icon":return _p(Ee(e.payload.symbol,n));case"gauge":return Ee(e.payload.value,n);case"chart":return Ee(e.payload.value,n);case"timeline":return Ee(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let i=e.payload.entity;return i.displayName||i.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let i=e.payload.action,a="entityId"in i?i.displayName||i.entityId:i.type==="callService"?[i.serviceDomain,i.serviceName].filter(r=>r!=="").join("."):i.type==="openPage"&&e.payload.openPageName||"";return a?`${i.type} \xB7 ${a}`:i.type}case"chartTimes":return"Clock times";case"chartDots":return"Reading dots";case"chartGrid":return"Grid lines";case"imageTime":return"Timestamp"}}function fh(e,n){let t=It(e.config,n.id),i=de(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Ce(e,"content","Group",h`
    ${Me("Name",n.name,r=>a(o=>{o.name=r},"name"))}
    ${Ye("Move as one",n.locked,r=>a(o=>{o.locked=r}))}
    ...
    ${gl(e,t.map(r=>({el:r,lead:V(r.kind),title:Se(r,i),kind:rn[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Bi(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function gh(e,n){if(n==="inline")return vx(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ne(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${ne(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=eo(e.config,n),r=t.backgroundColorHex?Ae(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ae(t.borderColorHex)} border`:"no border";return h`
    ${Ce(e,"look",`${ne(n)} shape`,h`
    ...
    ${n==="corner"?Ce(e,"corner","Corner content",wx(e,t,i),{color:ee.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ${Ce(e,"states","Shape states",kh(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:ee.states,icon:"states",summary:ea(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ${Ce(e,"placements","Layers",h`
      <div class="hint keep">${a===0?`Nothing is on the ${ne(n)} shape. The Layers card offers a copy of another shape's whole arrangement, or you can add layers here one at a time.`:`${a} layer${a===1?" is":"s are"} on the ${ne(n)} shape. They belong to this shape alone: no other shape draws them, and editing one here cannot reach another shape.`}</div>`,{color:ee.position,icon:"place",summary:a===0?"Nothing on it":`${a} layer${a===1?"":"s"}`})}`}function vx(e){let n=e.config.inline;if(!n)return h`<div class="hint">This complication lists Inline but has no Inline text yet (it was saved by an older integration). The watch shows "No inline layout" until one is added.</div>
    ...
    ${Ce(e,"content","Inline text",h`
      ${Me("Label (blank = value only)",n.label??"",a=>t(r=>{a?r.label=a:delete r.label},"label"))}
      ${se(e,n.value,a=>t(r=>{r.value=a},"value"),{showResolved:!0,label:"Text",key:"inline-value"})}
      ${ml(e,n.countdown===!0,n.value,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}`,{color:ee.content,icon:"text",summary:De(`${n.label?`${n.label}: `:""}${Ee(n.value,i)}`,48)})}
    ${Ce(e,"symbol","Symbol",h`
      ${Kp(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:ee.look,icon:"icon",summary:n.symbol||"None"})}`}function wx(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ${ie("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=L("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${ie("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=L("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:L("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ${a==="text"&&n.bezelText?h`
      ${se(e,n.bezelText,r=>t(o=>{o.bezelText=r},"bezel"),{showResolved:!0,label:"Bezel label",key:"fam-corner-bezel"})}
      ${ml(e,n.bezelCountdown===!0,n.bezelText,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:f}
    ${a==="gauge"&&n.bezelGauge?kx(e,n.bezelGauge,t):f}`}function kx(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${Ye("End labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=L(String(s.minValue)),s.maxLabel=L(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?se(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):f}
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var u0=oe.map(e=>[e,ne(e)]),yl={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},$x=Object.keys(yl),Wr=["color","text","fontSize","fontWeight","visibility"];function Cx(e,n=!1){let t=Ui[e].filter(i=>!n||Wr.includes(i));return $x.filter(i=>t.includes(Pe[i]))}function yh(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${ix(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var Sx={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function _r(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function De(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function bh(e){if(!e||Ie(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function Ee(e,n){return`${fa(e,n)}${bh(e.format)}`}function fa(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${De(t.value,40)}"`:"(empty)";case"entityState":return _r(t,n);case"entityAttribute":return t.attribute?`${_r(t,n)} \xB7 ${t.attribute}`:_r(t,n);case"entityAge":return`age of ${_r(t,n)}`;case"aggregate":return Tx(t.aggregate);case"time":return Sx[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${De(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Rt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?fa(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function Tx(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function ha(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function Ex(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.cases.map((m,g)=>Rx(e,m,g,n,a,u,`${o}-${m.id}`,p))}
    <div class="adders"><button class="small" @click=${()=>u(m=>{m.cases.push(us())})}>+ case</button></div>
    ${Ye("Otherwise",n.otherwise!==void 0,m=>u(g=>{m?g.otherwise=g.otherwise??[]:delete g.otherwise}))}
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${xh(e,n.otherwise,a,m=>u(g=>{g.otherwise&&m(g.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function Rx(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(g=>g.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${d?h` <span class="ok">· active now</span>`:f}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>ha(c.cases,t,t-1))}>${V("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>ha(c.cases,t,t+1))}>${V("down")}</button>
    ...
    ${n.when.tests.map((c,u)=>Fx(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(cs())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=dp(p,ap(e.hass?.states));l(g=>{g.when.tests.push(...m)})}}>
  ...
  </div>`}function Fx(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=On(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=se(e,s.value??L(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${se(e,s.value??L(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${se(e,s.upper??L(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${Me("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!Ax(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${zp(e,"From",s.value??L("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${zp(e,"To",s.upper??L("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=Hx(n.value)?Ix(s.options??[],u=>o(p=>{p.comparison.options=Us(u)},"options")):Me("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${$e("Comparison",s.kind,Cc.map(u=>[u,gi[u]]),u=>o(p=>{p.comparison=ps(p.comparison,u)}))}
    ${c}
  </div>`}function Ax(e){try{return new RegExp(e),!0}catch{return!1}}function zp(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Dn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${xe(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function Hx(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function Ix(e,n){let t=op(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${rp.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function xh(e,n,t,i,a,r=!1){let o=Cx(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>Lx(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Vn(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${yl[s]}</option>`)}
    </select>`}var vh=["setColor","setBorderColor","setBackgroundColor"];function Lx(e,n,t,i,a,r,o,s=!1){let l=!Ui[i].includes(Pe[n.kind]),d=s&&!l&&!Wr.includes(Pe[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
      <span>${yl[n.kind]}${l?h` <span class="no">(ignored by ${i==="layout"?"layouts":`${i} layers`})</span>`:d?h` <span class="no">(ignored by a part)</span>`:f}</span>
      <span class="spacer"></span>
    ...
    ${wh(e,n,a,o)}
  </div>`}function wh(e,n,t,i){let a=ar(n.kind),r=f;if(a==="value"){let o=n.value??L("");if(vh.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?he("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=L(l??"#FFFFFF")},"color")):se(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!s.ok} title=${s.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${d=>{ll.delete(a),Re(d.target)}}>Show as table</button>
        ${s.ok?f:h`<span class="hint keep">${s.reason}</span>`}
      </div>
      ${Ex(e,n,t,i,a,o)}`:_x(e,s.table,n[0],t,i,a,r,o)}function _x(e,n,t,i,a,r,o,s){let l=(R,x)=>e.update($=>{let T=a($);T&&R(T)},x?`${r}-${x}`:void 0),d=n.value??Pp.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Bu(d)&&zx(e.resolve(d)),p=Ui[i],m=zr.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Vu[i]]:[],y=Hu(n.columns,[...m,...g.filter(R=>R!==void 0)],p),b=Lr.get(r),k=t?t.partId:s?.some(R=>R.id===b)?b:void 0,C=s!==void 0&&k!==void 0,w=C?p.filter(R=>Wr.includes(R)):p,S=C?y.filter(R=>!Wr.includes(R)):[],I=(R,x)=>{if(!t){R?Lr.set(r,R):Lr.delete(r),Re(x);return}l($=>{let T=$[0];T&&(R?T.partId=R:delete T.partId)})},B=t?e.liveBranch(t):"none",z=t?e.forced.get(t.id)??"live":"live",j=R=>z!=="live"&&(z==="otherwise"?R==="otherwise":z.caseId===R),M=R=>{t&&e.setForced(t.id,j(R)?"live":R==="otherwise"?"otherwise":{caseId:R})},U=R=>{Pp.set(r,R),n.rows.length!==0&&l(x=>Nu(x,R),"lhs")},Z=()=>{Lr.delete(r),l(R=>{zu(R,d??L(""),u),k!==void 0&&R[0]&&R[0].partId===void 0&&(R[0].partId=k)})},H=n.rows.map((R,x)=>Dp(e,{key:`${r}-${R.caseId}`,label:Ou(R.comparison,$=>Ee($,de(e))),columns:y,changes:R.changes,live:B===R.caseId,forced:j(R.caseId),onForce:()=>M(R.caseId),when:Vx(e,R.comparison,`${r}-${R.caseId}`,($,T)=>l(F=>{let N=F[0]?.cases.find(q=>q.id===R.caseId)?.when.tests[0];N&&$(N.comparison)},T&&`${R.caseId}-${T}`)),updChanges:($,T)=>l(F=>{let N=F[0]?.cases.find(q=>q.id===R.caseId);N&&$(N.then)},T&&`${R.caseId}-${T}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${x===0} @click=${()=>l($=>Os($,x,x-1))}>${V("up")}</button>
      <button class="icon" title="Move down" ?disabled=${x===n.rows.length-1} @click=${()=>l($=>Os($,x,x+1))}>${V("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l($=>Pu($,R.caseId))}>${V("delete")}</button>`})),Q=n.otherwise===void 0?f:Dp(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:B==="otherwise",forced:j("otherwise"),onForce:()=>M("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(R,x)=>l($=>{let T=$[0]?.otherwise;T&&R(T)},x),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(R=>Vs(R,!1))}>${V("close")}</button>`}),A=Pr.get(r),K=Px.filter(R=>w.includes(R)&&!y.includes(R));return h`
    <div class="states">
      ${se(e,d??L(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:yh(s,k,de(e),I)}
      <div class="states-scroll"><table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(R=>h`<th>
              <span>${xt[R]}</span>
              <button class="icon" title=${`Remove the ${xt[R]} column`}
                @click=${x=>{Pr.set(r,R),Re(x.target)}}>${V("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${to(S.map(R=>xt[R]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${A===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${xt[A]} column? Its ${Np(n,A)} value${Np(n,A)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${R=>{Pr.delete(r),zr.get(r)?.delete(A),Re(R.target),l(x=>Du(x,A))}}>Remove</button>
        <button class="small" @click=${R=>{Pr.delete(r),Re(R.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          <button class="small" title="Add a row: a value to match and what the layer looks like then" @click=${Z}>${V("plus")}<span>State</span></button>
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(R=>Vs(R,!0))}>${V("plus")}<span>Otherwise</span></button>`:f}
          ${K.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${R=>{let x=R.target,$=x.value;if(x.value="",!$)return;let T=zr.get(r)??new Set;T.add($),zr.set(r,T),Re(x)}}>
            <option value="" selected>+ Column…</option>
            ${K.map(R=>h`<option value=${R}>${xt[R]}</option>`)}
          </select>`}
        </div>
      </div>
      ${z==="live"?f:h`<div class="field"><span>Preview</span>
      ...
      <div class="states-switch">
        <button class="link" @click=${R=>{ll.add(r),Re(R.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function zx(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var Px=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Np(e,n){let t=0;for(let i of e.rows)wr(i.changes,n)&&(t+=1);return e.otherwise&&wr(e.otherwise,n)&&(t+=1),t}function Nx(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Dp(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{Nx(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>h`<td>${Dx(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Dx(e,n,t,i,a){let r=wr(t,n),o=Qr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${xt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Vn(Au[n]))}),Yp(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Pe[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=xt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Ox(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Xp}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${ca.has(o)?h`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):wh(e,r,s,a)}
    ...
    </div>`}function Ox(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=ar(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${vi.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??L(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(vh.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ae(a):Ee(i,de(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Ee(i,de(e))}</span>`}function Ae(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Vx(e,n,t,i){let a=On(n.kind),r=Ns(n.kind),o=(s,l,d,c)=>Gx(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${xe(s=>i(l=>{let d=ps(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Ps.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Bx(s)}</option>`)}
    </select>
  ...
  </span>`}function Bx(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return gi[e]}}function Gx(e,n,t,i,a,r,o){let s=Qr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${qp(e,s,o,n,t,l)}
  </span>`}var ga=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Qo,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Th(e){return ga.find(n=>n.kind===e)??ga[0]}var $h="#FF9F0A",io="#8E8E93",Ux=["#FF453A","#FFD60A","#34C759"],Eh=["#0A84FF","#34C759","#FF9F0A"];function Kx(e){return e?.attributes?.device_class==="battery"?Ux:Eh}var Wx={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function jx(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Wx[bl(e)]??{off:"circle",on:"circle.fill"}}function qx(e){switch(bl(e)){case"lock":return{kind:"equals",value:L("locked")};case"cover":case"valve":return{kind:"equals",value:L("open")};case"media_player":return{kind:"equals",value:L("playing")};default:return{kind:"isOn"}}}function bl(e){return e.domain||e.entityId.split(".")[0]||""}function mn(e){return{...e,domain:bl(e)}}function Yx(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function wi(e){return Math.round(e*1e4)/1e4}function Zn(e,n,t){return Math.min(t,Math.max(n,e))}function xl(e,n,t){let i=Le[e],a=Zn(wi(n/i.width),0,1),r=Zn(wi(t/i.height),0,1);return{x:wi((1-a)/2),y:wi((1-r)/2),width:a,height:r,rotationDegrees:0}}function Xx(e){let n=Le[e],t=Zn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:xl(e,t*1.3,t*1.3),size:t}}function Jx(e){let n=Le[e],t=Zn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:xl(e,n.width*.88,t*1.7),size:t}}function Zx(e){let n=Le[e],t=Math.min(n.width,n.height)*.9;return{frame:xl(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Mh(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Qx(e){let n=Le[e],t=Zn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:wi(t/n.height),rotationDegrees:0}}}function ev(e){let n=Le[e],t=Zn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:wi(Zn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function tv(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function nv(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function pn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,nv(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Lt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function hn(e){return Te(e)}function vl(e,n){let t={kind:{kind:"entityState",...mn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Ch(e){let n=Vn("setIcon");return n.value=L(e),n}function Jn(e){let n=Vn("setColor");return n.value=L(e),n}function iv(e,n){let t=Ki(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...mn(e)}},a.comparison=qx(e);let r=n.on!==n.off;return i.then=r?[Ch(n.on),Jn($h)]:[Jn($h)],t.otherwise=r?[Ch(n.off),Jn(io)]:[Jn(io)],t}function av(e){let n=Ki(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...mn(e)}},i.comparison={kind:"isUnavailable"};let a=Vn("setOpacity");return a.number=.35,t.then=[a],n}function Sh(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function rv(e,n,t=Eh){let i=n.max-n.min,a=Sh(n.min+i/3),r=Sh(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:L(a)},changes:[Jn(t[0])]},{comparison:{kind:"between",value:L(a),upper:L(r)},changes:[Jn(t[1])]},{comparison:{kind:"greaterThan",value:L(r)},changes:[Jn(t[2])]}];return Iu(vl(e),o)}function ov(e,n,t){let i=hn("icon"),a=jx(n);return i.payload.symbol=L(a.off),i.payload.colorSlot.baseColorHex=io,i.payload.rules=[iv(n,a)],pn(e,i,t.family,Xx),e.elements.push(i),Qa(e,i.payload.id,{type:"toggleEntity",...mn(n)}),i.payload.id}function sv(e,n,t){let i=hn("text");return i.payload.value=vl(n,t.state),i.payload.rules=[av(n)],pn(e,i,t.family,Jx),e.elements.push(i),i.payload.id}function lv(e,n,t){let i=hn("gauge");i.payload.value=vl(n);let a=Yx(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[rv(n,a,Kx(t.state))],pn(e,i,t.family,Zx),e.elements.push(i),i.payload.id}function dv(e,n,t){let i=hn("chart");return i.payload.value={kind:{kind:"entityState",...mn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",pn(e,i,t.family,Mh),e.elements.push(i),i.payload.id}function cv(e,n,t){let i=hn("chart");return i.payload.value={kind:{kind:"entityState",...mn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",pn(e,i,t.family,Mh),e.elements.push(i),i.payload.id}function uv(e,n,t){let i=mn(n),a=hn("text");a.payload.value=L(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=io,pn(e,a,t.family,ev),e.elements.push(a);let r=t.state?.attributes?.device_class,o=hn("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=Oo(i.domain,typeof r=="string"?r:void 0),pn(e,o,t.family,Qx),e.elements.push(o),o.payload.id}function pv(e,n,t){let i=hn("image");return i.payload.entity=mn(n),pn(e,i,t.family,tv),e.elements.push(i),i.payload.id}function Rh(e,n,t,i){switch(n){case"toggle":return ov(e,t,i);case"status":return sv(e,t,i);case"gauge":return lv(e,t,i);case"chart":return dv(e,t,i);case"history":return cv(e,t,i);case"doorHistory":return uv(e,t,i);case"camera":return pv(e,t,i)}}var hv=/^[a-z0-9_]+\.shared_(\d+)$/;function Fh(e){return hv.test(e)}function mv(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function Hh(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function Ih(e,n){let t=new Map;for(let i of ds(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=Hh(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${mv(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function fv(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);ss(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),ls(t,r=>is(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function Lh(e){let n=!1;return ir(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function gv(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function _h(e,n,t=[]){let i=n==="share"?fv(e,t):e,a=li(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${gv(a)}
`}function zh(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var yv="There is nothing to read here. Paste a complication first.",bv="This is not valid JSON. Check for a missing brace or a stray comma.",xv="This is valid JSON but not a complication. A complication starts with { and ends with }.",vv="This does not look like a complication.",Ah="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",wv="00000000-0000-4000-8000-000000000000";function kv(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function Ph(e,n){let t=e.trim();if(t==="")return{ok:!1,error:yv};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:bv}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:xv};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${Ah}`};let o={...a,id:wv,slotIndex:0},s;try{s=si(o)}catch(d){let c=d instanceof nt||d instanceof Error?d.message:String(d);return{ok:!1,error:`${vv}

${kv(c)}`}}let l=Xa(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${Ah}`}}return{ok:!0,config:s,raw:i}}function wl(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=ds(e,(o,s)=>Fh(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=Fh(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:Hh(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Nh(e,n){let t=structuredClone(e);ss(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return ls(t,a=>is(a,i)),t}function Dh(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function $v(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Oh(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=hr(e);return i.length===0?t:`${t}, ${$v(i)}`}function kl(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var Sv=3e4,Tv=500,Ev=3e4,Vh="preset-entity";function Bh(e){return`import-entity-${e}`}var Mv={entityId:"",displayName:"",domain:""},Rv=new Map,Fv={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function $l(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Av(e){return e.kind==="family"?"look":"content"}function Cl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Gh(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function Hv(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Uh=300,Kh=360,El=44,Ml=22,Zh=[1,1.7,2.6],Iv=["S","M","L"],Wh=["Small","Medium","Large"];function Lv(){return Zh.map((e,n)=>{let t=Math.round(El*e),i=Math.round(Ml*e),a=`.layers-card.s${n}`;return`
...
`)}var jh="wrist-assistant-panel.layers.v1",Nt=34,Qn=200,_v=720,ao=320,zv=80,Pv=56,qh="wrist-assistant-panel.columns.v3",Sl=e=>Math.max(Qn,Math.min(_v,Math.round(e))),Yh=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Nv(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Dv=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,ya=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",fn=ya==="Cmd"?"\u2318":"Ctrl+",Tl=ya==="Cmd"?"\u21E7":"Shift+";function Xh(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-zv;if(i>=Qn*2+ao){let r=i-ao,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Qn,Math.floor(o*l)),s=Math.max(Qn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Qn,o-d):s=Math.max(Qn,s-d))}return{columns:3,left:o,right:s}}let a=e-Pv;return a>=Qn+ao?{columns:2,left:Math.min(n,a-ao),right:t}:{columns:1,left:n,right:t}}var _=class _ extends Bt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Uh;this.colRight=Kh;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=mi.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Tu(()=>this.requestUpdate());this.imageSizes=Eu(()=>this.requestUpdate());this.symbols=new yr(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new vr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=wl(a,this.hass.states);r.some(s=>ul(Bh(s.entityId)))||kl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||ul(Vh)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Rv}static{this.styles=co`
    :host {
      ...
      --wa-text: ${Fe(qe.text)};
      --wa-icon: ${Fe(qe.icon)};
      --wa-gauge: ${Fe(qe.gauge)};
      --wa-shape: ${Fe(qe.shape)};
      --wa-image: ${Fe(qe.image)};
      --wa-tap: ${Fe(qe.tap)};
      --wa-states: ${Fe(ee.states)};
      --wa-place: ${Fe(ee.place)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.held { background: color-mix(in srgb, ${Fe(ee.group)} 12%, var(--wa-panel)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${Fe(ee.locked)}; }
    ...
    .card.tint-values {
      ...
      background: color-mix(in srgb, ${Fe(ee.complication)} 8%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${Fe(ee.complication)} 25%, var(--wa-card));
    }
    .card.tint-states {
      padding: 10px 14px 12px;
      background: color-mix(in srgb, ${Fe(ee.states)} 12%, var(--wa-card));
      box-shadow: 0 0 0 1px color-mix(in srgb, ${Fe(ee.states)} 35%, var(--wa-card));
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(qr,this.scrubStart),this.addEventListener(Yr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Ev)}loadColumnWidths(){try{let t=window.localStorage.getItem(qh);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Sl(i.left)),typeof i.right=="number"&&(this.colRight=Sl(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(qh,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(jh);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(jh,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>oh(s,o,i))}>Copy the ${ne(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(t){this.mutate(i=>yu(i,t)),this.activeFamily=t,this.inspect={kind:"family"}}removeShape(t){let i=this.draft?.config;if(!i||!mr(i,t))return;let a=xu(i,t);a.length>0&&!window.confirm(`Remove the ${ne(t)} shape? This deletes ${a.join(", ")}. They are on this shape only, so nothing else in the complication loses anything.`)||(this.mutate(r=>bu(r,t)),this.ensureActiveFamily())}createNew(){let t=this.newFamily,i=this.newName.trim();!t||i===""||this.newNameProblem()!==void 0||(this.closeNewDialog(),this.startNew(pc(i,this.freeSlot(),[t])))}setForced(t,i){let a=new Map(this.forced);i==="live"?a.delete(t):a.set(t,i),this.forced=a}async save(t=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!t&&!this.draft.dirty)){if(!t&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(t){let s=this.freeSlot();if(s<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let l=structuredClone(i.config);l.id=J(),l.slotIndex=s,i=new Kn(l,null)}let a=i.encoded(),r=await od(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id;let o=this.draft.testValues;this.draft=Kn.fromDocument(r.record.document,r.record.revision),this.draft.testValues=o,this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=Dt(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let t=await sd(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!t.ok){t.error==="conflict"?this.conflict={current:t.current??null,message:t.message??"This complication changed on the server."}:this.saveError=t.message??t.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(t){this.saveError=Dt(t)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let t=structuredClone(this.draft.config);t.id=J(),t.name=`${t.name} copy`,t.slotIndex=this.freeSlot(),this.startNew(t)}reloadFromServer(){let t=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,t&&!t.deleted?this.openRecord(t):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(t=>t.owner_watch_id===this.ownerId)}async moveAll(){let t=this.ownerId,i=this.moveTarget;if(!(!t||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await ld(this.hass,t,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=Dt(a)}finally{this.moving=!1}}}scheduleTemplates(t){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},t),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},Sv)}async refreshHistorySeries(){let t=this.draft?.config,i=t?Po(t):[],a=t?No(t):[];if(i.length===0&&a.length===0){this.historySeries.size>0&&(this.historySeries=new Map),this.historyReadings.size>0&&(this.historyReadings=new Map);return}let r={};for(let s of i)r[s.key]=pd(s);let o={};for(let s of a)o[s.key]=hd(s);try{let[s,l]=await Promise.all([ud(this.hass,r),fd(this.hass,o).catch(()=>({}))]),d=md({...s,...l});this.historySeries=d.series,this.historyReadings=d.readings}catch{}}async refreshTemplates(){this.refreshHistorySeries();let t=this.compiled?.document;if(!t){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await cd(this.hass,{doc:t})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=Lc(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=Dt(i)}}entityStateFor(t,i,a){let r=this.hass.states[t];if(!r)return;let o=r.attributes,s=t.split(".")[0]??"",l={entityId:t,state:(a?this.testValues.get(t):void 0)??r.state,unitOfMeasurement:typeof o.unit_of_measurement=="string"?o.unit_of_measurement:void 0,iconName:i,domain:s};if(s==="timer"){l.timerState=r.state,typeof o.finishes_at=="string"&&(l.finishesAt=o.finishes_at);let d=Ov(o.remaining);d!==void 0&&(l.remaining=d)}return typeof o.entity_picture=="string"&&(l.entityPicture=o.entity_picture),l}buildContext(t=!0){let i=new Map;for(let[r,o]of this.compiled?.entities??[]){let s=this.entityStateFor(r,o.iconName??"",t);s&&i.set(r,s)}let a=this.draft?.config.values??[];return{entityStates:i,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:t?Ec(a,this.testValues):a,dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3,testedEntities:t?new Set(this.testValues.keys()):new Set}}renderPickButton(){let t=this.picking,i=!this.draft||this.parseError!==void 0;return h`<button class="pick ${t?"on":""}" ?disabled=${i}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?ns(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication");if(this.showTaps){let H=this.focusTapId();if(H!==void 0&&o===H&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,H,r??void 0);return}let Q=this.hitLayerId(i);Q?this.inspect={kind:"layer",id:Q}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let l=Yh(i);if(!l&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let d=ns(this.draft.config,o),c=this.draft.config.elements.find(H=>H.payload.id===d);if(!d||!c)return;if(l){i.preventDefault(),this.togglePick(d);return}let u,p=this.inspect.kind==="layer"?this.inspect.id:void 0;if(p!==void 0&&p!==d&&!r){let H=this.draft.config.elements.find(A=>A.payload.id===p);H!==void 0&&H.kind!=="chartDots"&&H.kind!=="chartGrid"&&H.payload.chartAnchor?.place!=="through"&&st(this.draft.config,p)?.locked!==!0&&Nv(s,p,i)&&(u=d,d=p,c=H)}let m=st(this.draft.config,d),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r){let H=g||this.inspect.kind==="layer"&&st(this.draft.config,this.inspect.id)?.id===m.id;this.beginGroupGesture(t,i,s,m,H?d:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==d)&&(this.inspect={kind:"layer",id:d},r)||c.payload.chartAnchor?.place==="through")return;i.preventDefault();let y=He(this.draft.config,t,c).frame,b=this.gestureCanvas(t),k=c.payload.chartAnchor,C=k!==void 0&&!ft(k.at)&&k.place!=="through",w=k!==void 0&&ft(k.at)&&k.place==="through",S=pe[t],I={dx:k?.dx??0,dy:k?.dy??0},B=k!==void 0&&!r?hi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(H=>H.id===d)?.frame:void 0,z=B??y,j=H=>Math.round(H*10)/10;this.cancelGesture?.();let M=!1,U=r!==null?hi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(H=>H.id===d):void 0;if(r!==null&&U?.kind==="icon"){let H=Ms(U)/2,Q=U.size;this.cancelGesture=qu(s,i,r,{w:H,h:H},(A,K)=>{this.mutate(R=>{ve(R,t,d,{size:Math.max(1,Math.round(Q*A))})},`drag-${d}-${t}`),K&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let Z=U!==void 0?uu(U,z,b):{};this.cancelGesture=Sr(s,b,i,{elementId:d,frame:z,handle:r??void 0,...Z},{onFrame:(H,Q,A)=>{if(A||(M=!0),A&&!M&&u!==void 0){this.inspect={kind:"layer",id:u},this.cancelGesture=void 0;return}this.mutate(K=>{if(k===void 0){ve(K,t,H,{frame:Q});return}let R=B?{width:y.width,height:y.height}:{width:Q.width,height:Q.height};ve(K,t,H,{frame:{...Q,...R,x:C?Q.x:y.x,y:y.y}});let x=K.elements.find(F=>F.payload.id===H)?.payload.chartAnchor;if(x===void 0)return;let $=I.dx,T=w?I.dy:j(I.dy+(Q.y-z.y)*S.height);$?x.dx=$:delete x.dx,T?x.dy=T:delete x.dy},`drag-${H}-${t}`),A&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=It(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map(C=>[C.payload.id,He(s,t,C).frame])),c=[...d.values()],u=Math.min(...c.map(C=>C.x)),p=Math.min(...c.map(C=>C.y)),m=Math.max(...c.map(C=>C.x+C.width)),g=Math.max(...c.map(C=>C.y+C.height)),y={x:u,y:p,width:m-u,height:g-p,rotationDegrees:0},b=C=>Math.round(C*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=Sr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y},{onFrame:(C,w,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let I=w.x-y.x,B=w.y-y.y;this.mutate(z=>{for(let[j,M]of d)ve(z,t,j,{frame:{...M,x:b(M.x+I),y:b(M.y+B)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?ju:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(It(r,k).map(C=>C.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=st(r,u);if(m?.locked)return this.nudgeMany(It(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=He(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let k=!ft(y.at);return l===0&&!(k&&s!==0)||this.mutate(C=>{k&&s!==0&&ve(C,d,u,{frame:Cr(g,s,0,c)});let w=C.elements.find(I=>I.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let S=Math.round(((w.dy??0)+l)*10)/10;S?w.dy=S:delete w.dy},`nudge-${u}-${d}`),!0}let b=Cr(g,s,l,c);return(b.x!==g.x||b.y!==g.y)&&this.mutate(k=>ve(k,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let I=l.elements.find(B=>B.payload.id===S);I&&c.set(S,He(l,i,I).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),g=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),b={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},k=Cr(b,o,s,a),C=k.x-b.x,w=k.y-b.y;return(C!==0||w!==0)&&this.mutate(S=>{for(let[I,B]of c)ve(S,i,I,{frame:{...B,x:d(B.x+C),y:d(B.y+w)}})},r),!0}gestureCanvas(t){let i=cr(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=As(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ue(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=be(s,l),c=He(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Sr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?fc(g,u,t,p):ve(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Xh(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
          <select @change=${o=>{this.selectOwner(o.target.value)}}>
            ${this.owners.map(o=>h`<option value=${o.owner_watch_id} ?selected=${o.owner_watch_id===this.ownerId}>
              ${Jh(o)} (${o.complication_count})</option>`)}
          </select>
        </label>
        ${Gh()}
        <label class="pick-label" for="wa-picker">Choose complication</label>
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?h`<span class="hor" aria-hidden="true">or</span>${Gh()}`:f}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${$u(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
    ...
    </div>`}pickerRows(){let t=this.records.map(a=>({slot:Number(a.document?.slotIndex??0),kind:"record",record:a}));return[...t,...Hd(t.map(a=>a.slot),this.occupied).map(a=>a.kind==="custom"?{slot:a.slot,kind:"locked",name:a.name||"Unnamed complication",badge:a.home||"Other home",title:`A complication on ${a.home?`the ${a.home} home`:"another home"}${a.families?.length?` (${a.families.map(ne).join(", ")})`:""}. Edit it in that home's Wrist Assistant panel.`,families:a.families??[]}:{slot:a.slot,kind:"locked",name:a.name||"Unnamed preset",badge:"iPhone",title:"Still on the iPhone. Open the Wrist Assistant app on the iPhone to move it here.",families:[]})].sort((a,r)=>a.slot-r.slot)}shapeDots(t){return h`<span class="shape-dots">${Un.map(i=>h`<span class="shape-dot ${i} ${t.includes(i)?"on":""}" title=${ne(i)}></span>`)}</span>`}static{this.FILTER_FROM_ROWS=8}recordPreview(t){let i=this.recordPreviews.get(t.id);if(i&&i.revision===t.revision)return i;try{let a=si(t.document),r={revision:t.revision,config:a,entities:[...or(a).entities.values()]};return this.recordPreviews.set(t.id,r),r}catch{this.recordPreviews.delete(t.id);return}}renderRowArt(t){let i=this.recordPreview(t);if(!i)return h`<span class="pk-art"></span>`;let a=i.config,o=(this.pickerFilter!=="all"&&a.supportedFamilies.includes(this.pickerFilter)?this.pickerFilter:void 0)??Hs(a)??"inline",s=new Map;for(let c of i.entities){let u=this.entityStateFor(c.entityId,c.iconName??"",!1);u&&s.set(c.entityId,u)}let l=hi(a,{entityStates:s,templateResults:new Map,namedValues:a.values});if(o==="inline")return h`<span class="pk-art inline">${this.renderInlinePreview(l.inline,!0)}</span>`;let d=l[o];return d?h`<span class="pk-art ${o}">${pr(d,{icons:this.icons,imageSizes:this.imageSizes,slot:mi.slots[o]})}</span>`:h`<span class="pk-art"></span>`}renderPickerFilter(t){let i=r=>r.kind==="record"?Cl(r.record):r.families,a=(r,o,s)=>h`<button
      ...
      ${a("all","All",t.length)}
      ${Un.map(r=>a(r,ne(r),t.filter(o=>i(o).includes(r)).length))}
    </div>`}renderPicker(){let t=this.draft,i=this.records.find(d=>d.id===this.selectedId),a=t?t.config.name.trim()||"Untitled":"No complication",r=t?t.config.supportedFamilies:[],o=this.pickerRows(),s=this.pickerFilter,l=s==="all"?o:o.filter(d=>(d.kind==="record"?Cl(d.record):d.families).includes(s));return h`<div class="picker">
      ...
      <div class="new-body">
        ...
        <div class="field new-shapes">
          ...
          <div class="shape-cards" role="radiogroup" aria-label="Shape">
            ${Un.map(r=>h`<button type="button" role="radio" class="shape-card ${this.newFamily===r?"on":""}"
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=zh(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?wl(i,this.hass.states):[],r=kl({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?h`<div class="hint err">A complication on this watch already has that name.</div>`:h`<div class="hint">${Oh(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${Lh(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${wt({hass:this.hass},t.label,i??Mv,a=>this.setImportEntity(t.entityId,a),Bh(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,Zr(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:Ph(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=Dh(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${Dt(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=Nh(t.config,this.importMap);i.id=J(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=Sn(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      ${this.hass.user?.is_admin?i.length===0?h`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:h`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>h`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Jh(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${Is.length} kinds · ${ga.length} presets</span>`}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Is.map(s=>h`<button class="add" style=${`--k:${qe[s]}`} ?disabled=${i} title=${`Add a blank ${rn[s].toLowerCase()} layer`}
              @click=${()=>{let l=Te(s);this.addHere(d=>{d.elements.push(l),l.kind==="timeline"&&_n(d,l.payload.id)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?h`<span class="well">${Uu(s)}</span>`:f}<span class="add-name">${r?V(s):h`<span class="k"></span>`}<span>${rn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Se(M,d)}</b>
          <small><span class="kind">${rn[M.kind]}</span> · ${Gv(M,c,this.historySeries,A.size)}</small>
          ${S?h`<span class="facts">${Vv(this.host(),a,M,A).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${R?h`<span class="badge tap" title=${`Tappable \xB7 ${Se(R,d)}`}>tap</span>`:f}
          ...
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${fn}])`} aria-label="Bring forward" @click=${F=>{F.stopPropagation(),r(H,1)}}>${V("up")}</button>
            <button class="icon" title=${`Send back (${fn}[)`} aria-label="Send back" @click=${F=>{F.stopPropagation(),r(H,-1)}}>${V("down")}</button>
            <button class="icon" title=${`${A.isHidden?"Show":"Hide"} (${Tl}${fn}H)`} aria-label=${A.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(N=>ve(N,a,H,{isHidden:!A.isHidden}))}}>${V(A.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${fn}D)`} aria-label="Duplicate" @click=${F=>{F.stopPropagation(),o(H)}}>${V("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${F=>{F.stopPropagation(),s(H)}}>${V("delete")}</button>
          </span>`:f}
        </span>
      </div>`},B=(M,U)=>{let Z=this.inspect.kind==="group"&&this.inspect.id===M.id,H=!this.collapsed.has(M.id),Q=this.rowDrag(M.id,i),A=U[0],K=U[U.length-1],R=$=>{let T=$.currentTarget,F=T.getBoundingClientRect(),N=F.top+(T.classList.contains("drop-before")?Nt:0),q=F.bottom-(T.classList.contains("drop-after")?Nt:0),te=($.clientY-N)/Math.max(1,q-N);return te<.25?"drop-before":!H&&te>.75?"drop-after":"drop-into"},x=U.map($=>$.payload.id);return h`<div class="layer group ${Z?"hl":""} ${S?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${Q.draggable}
        ...
        @drop=${$=>{$.preventDefault();let T=R($);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!A||!K)){if(T==="drop-before"){this.reorderLayer(F,A.payload.id,!0,!0);return}if(T==="drop-after"){this.reorderLayer(F,K.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,A.payload.id,!0),this.mutate(N=>Bi(N,F,M.id)))}}}>
        ...
        <span class="name">
          ...
          ${S?h`<span class="facts"><span class="fact"><b>Holds</b> ${U.map($=>Se($,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Tl}${fn}G)`} aria-label="Ungroup" @click=${$=>{$.stopPropagation(),this.mutate(T=>Vi(T,M.id)),Z&&(this.inspect={kind:"general"})}}>${V("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${M.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${$=>{$.stopPropagation(),this.mutate(T=>{let F=T.groups?.find(N=>N.id===M.id);F&&(F.locked=!F.locked)})}}>${V(M.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${H?"true":"false"} title=${H?"Fold the group":"Unfold the group"}
            @click=${$=>{$.stopPropagation();let T=new Set(this.collapsed);H?T.add(M.id):T.delete(M.id),this.collapsed=T}}>${V("chevron")}</button>
        </span>
      </div>`},z=[],j=new Set;for(let M=0;M<l.length;M++){let U=l[M],Z=U.payload.groupId,H=Z===void 0?void 0:t.groups?.find(K=>K.id===Z);if(!H){z.push(I(U,!1));continue}if(j.has(H.id))continue;j.add(H.id);let Q=l.filter(K=>K.payload.groupId===H.id);z.push(B(H,Q));let A=this.inspect.kind==="group"&&this.inspect.id===H.id;this.collapsed.has(H.id)||z.push(h`<div class="group-kids">${Q.map(K=>I(K,!0,A))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${V("layers")}</span>Layers
          ...
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([M,U])=>h`
              <button class=${this.layerDetail===M?"on":""} title=${U} aria-label=${U} aria-pressed=${this.layerDetail===M?"true":"false"}
                @click=${()=>{this.layerDetail=M,this.saveListView()}}>${V(M)}</button>`)}
          </span>
          <span class="seg" role="group" aria-label="Preview size">
            ${Iv.map((M,U)=>h`
              <button class=${this.thumbStep===U?"on":""} title=${`${Wh[U]} row pictures`}
                aria-label=${`${Wh[U]} row pictures`} aria-pressed=${this.thumbStep===U?"true":"false"}
      ...
      ${g>=2&&i?h`<div class="group-cta"><span>${g} layers picked</span><span class="spacer"></span>
            <button class="small primary" title=${`Group (${fn}G)`} @click=${()=>this.groupPicked()}>Group them</button>
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?h`<div class="hint">${ya}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:f}
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${ee.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${M=>{M.preventDefault(),this.clearDragMarks();let U=this.dragId,Z=[...l].reverse().find(H=>H.payload.id!==U&&H.payload.groupId!==U);U&&Z&&this.reorderLayer(U,Z.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?Th(this.presetKind):void 0,i=this.presetEntity;return h`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:h`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${wt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Vh,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Rh(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=hi(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
        ...
        <div class="canvas-bar">
          ...
          <span class="inbox" title=${`Layouts are made in the ${mi.label} box. Smaller cases scale it down.`}>
            ...
            <select aria-label="Preview as" @change=${o=>{this.previewCase=o.target.value}}>
              ${Zi.map(o=>h`<option value=${o.label} ?selected=${o.label===a.label}>${o.label}${o.measured?"":" (estimated)"}</option>`)}
            </select>
          </span>
      ...
      ${pr(r,y)}
    </div>`}renderUnder(t,i){let a=de(this.host()),r=this.inspect,o=r.kind==="layer"?t.elements.find(u=>u.payload.id===r.id):void 0,s;if(this.showTaps)s=h`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${At(t.tapAction)}</b>.`;else if(this.picking)s="Point at a layer and click it. Escape stops.";else if(i==="inline")s="One line of text. Edit it on the right.";else if(r.kind==="group"){let u=t.groups?.find(m=>m.id===r.id),p=u?It(t,u.id).length:0;s=u?h`editing group <b>${u.name}</b>. Drag to move all ${p} layers.${u.locked?"":" Click one layer to move it alone."}`:""}else if(o){let u=st(t,o.payload.id);s=u?.locked?h`editing <b>${Se(o,a)}</b> in <b>${u.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:h`editing <b>${Se(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else s="click a layer to edit it";if(i==="inline")return h`<div class="under"><b>Inline</b><span class="dot">·</span><span class="tail">${s}</span></div>`;let l=this.currentCase().slots[i],d=cr(l,i),c=Math.round(d.scale*100);return h`<div class="under">
      <b>${ne(i)}</b>
      <span class="size">${l.width} × ${l.height} pt${c!==100?` \xB7 ${c}%`:""}</span>
      <span class="dot">·</span>
      <span class="tail">${s}</span>
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?pi((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=rh();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${V("content")}</span>Shared values
      ...
      ${this.sharedHelp?h`<div class="shared-help">
        ...
        ${o}
      </div>`;let s=this.host(),l=new bt(this.buildContext(),this.draft?.config),d=de(s);return h`<div class="card tint-values values-list" style=${`--c:${ee.complication}`}>
      ${o}
      <div class="data">
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          <span class="spacer"></span>
          <span class="meta ${u===void 0?"none":""}" title=${Ee(c.value,d)}>${u??"unresolved"}</span>
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${g=>{g.stopPropagation(),this.mutate(y=>{os(y,c.id)}),p&&(this.openValue=void 0)}}>${V("delete")}</button>`:f}
        </div>
        ${p?h`<div class="value-open">${ah(s,c)}</div>`:f}</div>`})}
      </div>
    </div>`}setOpenValue(t){let i=this.openValue;if(this.openValue=t,i===void 0||i===t)return;let a=this.draft?.config.values.find(r=>r.id===i);a&&a.name.trim()===""&&this.mutate(r=>{os(r,i)})}openSharedValue(t){this.renderRoot.querySelectorAll(":popover-open").forEach(a=>a.hidePopover()),this.setOpenValue(t);let i=this.draft?.config.values.find(a=>a.id===t)?.name.trim()==="";this.updateComplete.then(()=>{this.renderRoot.querySelector(".values-list .datum.hl")?.scrollIntoView({block:"start",behavior:"smooth"}),i&&this.renderRoot.querySelector(".values-list .value-open input[type=text]")?.focus({preventScroll:!0})})}openRaw(){this.showRaw=!0;let t=this.renderRoot.querySelector("details.foot");t&&(t.open=!0),this.updateComplete.then(()=>this.renderRoot.querySelector("pre")?.scrollIntoView({block:"nearest"}))}renderShapeTabs(t,i){let a=t.supportedFamilies;return Un.map(r=>{if(!a.includes(r))return h`<button class="tab off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${ne(r)} shape`} @click=${()=>this.addShape(r)}>
          ${V("plus")}${ne(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?pr(c,{icons:this.icons,imageSizes:this.imageSizes,slot:mi.slots[r]}):f}let l=r!=="inline"&&eo(t,r)===0&&t.elements.length>0,d=this.canEdit&&mr(t,r);return h`<span class="tab-wrap">
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=Tc(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${ee.states}`}>
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ...
        ${a.map(o=>{let s=hs(o.id),l=this.sharedRaw(o.id)??"",d=l===""?"empty":l,c=o.name||"(unnamed)",u=this.testValues.get(s),p={entity_id:s,state:l,attributes:{},last_changed:"",last_updated:""};return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${ee.complication}`}
    ...
    </div>`}renderTestControl(t,i,a,r,o,s){let l=r??a?.state??"",d=Mc(t,a,r);if(d.kind==="choice")return h`<span class="test-ctl"><select aria-label=${`Test value for ${i}`} @change=${m=>this.setTestValue(t,m.target.value)}>
      ...
      ${c}
    </span>`}commitTestValue(t,i){this.editingValue=void 0,this.setTestValue(t,i)}setTestValue(t,i,a){let r=i?.trim()??"",o=new Map(this.testValues),s=t.startsWith(rr)?this.sharedRaw(t.slice(rr.length)):this.hass.states[t]?.state;r===""||r===s?o.delete(t):o.set(t,r),this.applyTestValues(o,a)}sharedRaw(t){let i=this.draft?.config;if(!i)return;let a=this.buildContext(!1),r=a.namedValues.map(o=>({...o,value:{kind:o.value.kind}}));return new bt({...a,namedValues:r},i).resolve({kind:{kind:"named",id:t}})}applyTestValues(t,i){let a=this.draft;!a||t.size===a.testValues.size&&[...t].every(([o,s])=>a.testValues.get(o)===s)||(a.setTestValues(t,i),this.version++)}currentCase(){return Zi.find(t=>t.label===this.previewCase)??mi}previewSlot(t){return this.currentCase().slots[t]}crumbs(t,i){let a=this.inspect,r=t.name.trim()||"Complication",o=this.activeFamily==="inline"?"Inline":ne(this.activeFamily),s=a.kind==="family"&&i===void 0?h`<span class="here" style=${`--k:${ee.place}`}>${o} shape</span>`:h`<button @click=${()=>{this.inspect={kind:"family"}}} title="Edit the shape">${o}</button>`,l=f,d=f;if(i!==void 0)l=h`<span class="here" style="--k:var(--wa-accent)"><span class="kchip">Picked</span><span class="nm">${i} layers</span></span>`;else if(a.kind==="layer"){let c=t.elements.find(u=>u.payload.id===a.id);if(c){l=h`<span class="here" style=${`--k:${qe[c.kind]}`}><span class="kchip">${rn[c.kind]}</span><span class="nm" title=${Se(c,de(this.host()))}>${Se(c,de(this.host()))}</span></span>`;let u=st(t,c.payload.id);u&&(d=h`<span class="sep">›</span><button @click=${()=>{this.inspect={kind:"group",id:u.id}}} title="Edit the group">${u.name}</button>`)}}else if(a.kind==="group"){let c=t.groups?.find(u=>u.id===a.id);c&&(l=h`<span class="here" style=${`--k:${ee.group}`}><span class="kchip">Group</span><span class="nm" title=${c.name}>${c.name}</span></span>`)}return h`<div class="crumbs">
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${Ce(a,"complication","Complication",nh(a),{color:ee.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=uh(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=fh(a,c)}else s=gh(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([Av(r)]):new Set(dl)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=de(r),s=new bt(this.buildContext(),this.draft?.config),l=sh(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(g=>{for(let y of i)ve(g,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(g=>{for(let y of i){let b=g.elements.find(k=>k.payload.id===y.payload.id);b&&b.kind!=="image"&&b.kind!=="tap"&&b.kind!=="timeline"&&b.kind!=="chartTimes"&&b.kind!=="chartDots"&&b.kind!=="chartGrid"&&b.kind!=="imageTime"&&(b.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
      ${Ce(r,"picked",`${d} layers picked`,h`
            ...
            <div class="picked">
              ${c.map(m=>h`<div class="row" style=${`--k:${qe[m.kind]}`}>
                ...
                <span class="name">
                  ...
                  <b>${Se(m,o)}</b><span class="kind">${rn[m.kind]}</span>
                </span>
              </div>`)}
            </div>
            <div class="row-acts">
      ...
      ${Ce(r,"picked-common",`All ${d} at once`,h`
          ...
          <div class="hint">Size, content and states belong to one layer at a time. Click a layer on its own to reach them.</div>`,{color:ee.place,icon:"place",summary:"The settings every picked layer has",alwaysOpen:!0})}`}renderFooter(){let t=this.draft;if(!t)return f;let i=this.records.find(r=>r.id===this.selectedId),a=Mu({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return h`<details class="foot">
      <summary>
    ...
    </details>`}};O([ii({attribute:!1})],_.prototype,"hass",2),O([ii({type:Boolean})],_.prototype,"narrow",2),O([ii({attribute:!1})],_.prototype,"panel",2),O([G()],_.prototype,"colLeft",2),O([G()],_.prototype,"colRight",2),O([G()],_.prototype,"panelWidth",2),O([G()],_.prototype,"owners",2),O([G()],_.prototype,"ownerId",2),O([G()],_.prototype,"records",2),O([G()],_.prototype,"selectedId",2),O([G()],_.prototype,"draft",2),O([G()],_.prototype,"readOnlyReason",2),O([G()],_.prototype,"parseError",2),O([G()],_.prototype,"maxSchemaVersion",2),O([G()],_.prototype,"presets",2),O([G()],_.prototype,"occupied",2),O([G()],_.prototype,"serverToken",2),O([G()],_.prototype,"appliedToken",2),O([G()],_.prototype,"sendStatusKnown",2),O([G()],_.prototype,"polling",2),O([G()],_.prototype,"lastPollSeconds",2),O([G()],_.prototype,"sendPending",2),O([G()],_.prototype,"pages",2),O([G()],_.prototype,"templateResults",2),O([G()],_.prototype,"historySeries",2),O([G()],_.prototype,"historyReadings",2),O([G()],_.prototype,"templateError",2),O([G()],_.prototype,"templateFetchedAt",2),O([G()],_.prototype,"forced",2),O([G()],_.prototype,"showRaw",2),O([G()],_.prototype,"inspect",2),O([G()],_.prototype,"openSections",2),O([G()],_.prototype,"helpSections",2),O([G()],_.prototype,"pickerOpen",2),O([G()],_.prototype,"pickerFilter",2),O([G()],_.prototype,"pickerNote",2),O([G()],_.prototype,"openValue",2),O([G()],_.prototype,"sharedHelp",2),O([G()],_.prototype,"editingValue",2),O([G()],_.prototype,"thumbStep",2),O([G()],_.prototype,"layerDetail",2),O([G()],_.prototype,"addOpen",2),O([G()],_.prototype,"addDetail",2),O([G()],_.prototype,"multi",2),O([G()],_.prototype,"copiedPosition",2),O([G()],_.prototype,"collapsed",2),O([G()],_.prototype,"activeFamily",2),O([G()],_.prototype,"picking",2),O([G()],_.prototype,"pickHoverId",2),O([G()],_.prototype,"listHoverIds",2),O([G()],_.prototype,"rowHoverId",2),O([G()],_.prototype,"zoomed",2),O([G()],_.prototype,"helpOpen",2),O([G()],_.prototype,"showTaps",2),O([G()],_.prototype,"savedName",2),O([G()],_.prototype,"presetKind",2),O([G()],_.prototype,"presetEntity",2),O([G()],_.prototype,"newOpen",2),O([G()],_.prototype,"newName",2),O([G()],_.prototype,"newFamily",2),O([G()],_.prototype,"shareOpen",2),O([G()],_.prototype,"shareMode",2),O([G()],_.prototype,"shareLabels",2),O([G()],_.prototype,"shareNote",2),O([G()],_.prototype,"importOpen",2),O([G()],_.prototype,"importText",2),O([G()],_.prototype,"importParse",2),O([G()],_.prototype,"importName",2),O([G()],_.prototype,"importMap",2),O([G()],_.prototype,"previewCase",2),O([G()],_.prototype,"loadError",2),O([G()],_.prototype,"saveError",2),O([G()],_.prototype,"saving",2),O([G()],_.prototype,"conflict",2),O([G()],_.prototype,"remoteRevision",2),O([G()],_.prototype,"confirmDelete",2),O([G()],_.prototype,"moveTarget",2),O([G()],_.prototype,"moving",2),O([G()],_.prototype,"moveError",2),O([G()],_.prototype,"version",2);var Rl=_;function Dt(e){return String(e?.message??e)}function Ov(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Jh(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function Vv(e,n,t,i){let a=[{label:"Shows",value:hl(e,t)}],r=Ur(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function Bv(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function Gv(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ae(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=An(e.payload)??Hn(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${We(o).length} values`}case"timeline":{let r=gt(e.payload),o=r===void 0?[]:Yi(t.get(r)??""),s=Math.max(0,o.length-1);return`${Bv(ot(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ae(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return e.payload.contentMode==="fill"?"fill":"fit";case"tap":return At(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`;case"imageTime":return}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Rl);export{Rl as WristAssistantPanel,Xh as columnFit,Vv as layerFacts};
