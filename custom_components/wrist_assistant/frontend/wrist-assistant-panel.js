...
`)}function to(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Ul(r));return{values:t,nullKeys:i}}function Ul(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function ta(e){let n=ea(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Kl(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}function Nn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function _t(e){let n=e.trim(),t=Nn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Nn(i)}function Wl(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function jl(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function ql(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Yl(e,n,t){if(_e(n))return e;let i=n,a=e,r=Nn(e.trim());if(i.relativeTime&&r!==void 0)a=jl(r);else{let o=_t(e);if(o!==void 0){let s=o*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=s.toFixed(Math.max(0,i.decimals)):s!==o&&(a=Number.isInteger(s)?String(s):Wl(s))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=ql(a);break}return a}function Pt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function ln(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function Jl(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Xl(e,n,t){if(e===void 0)return 0;let i=_t(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var je=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=ut(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=ln(i);n.limit>0&&a.length>n.limit&&(a=n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit));let r=Jl(a,n),o={values:a,domainMin:r.min,domainMax:r.max},s=this.dereference(n.value);return s&&"entityId"in s.kind&&(o.entity={entityId:s.kind.entityId,displayName:s.kind.displayName,domain:s.kind.domain}),o}settleCharts(n){for(let t of n.elements)t.kind==="chart"&&this.charts.set(t.payload.id,this.chartReadings(t.payload))}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!_e(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Kl(a,t.kind.stat):void 0;i=a&&r!==void 0?Er(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Qi(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Yl(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Nn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Pt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=_t(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:_t(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:_t(d);if(a===void 0||l===void 0||c===void 0)return!1;let[p,h]=l<=c?[l,c]:[c,l];return a>=p&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set($e[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,c={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,f={kind:"text",...c,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return p!==void 0&&(f.countdownEnd=p),f}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(a,"icon")??p,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let p=this.styleText(a,"gaugeValue")??this.resolve(n.payload.value),h=this.styleNumber(a,"gaugeMin")??n.payload.minValue,f=this.styleNumber(a,"gaugeMax")??n.payload.maxValue;return{kind:"gauge",...c,fraction:Xl(p,h,f),style:n.payload.style,lineWidth:n.payload.lineWidth,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,trackColorHex:n.payload.trackColorHex}}case"chart":{let p=n.payload,h=this.charts.get(p.id)??this.chartReadings(p),f=h.values,g={min:h.domainMin,max:h.domainMax},x=this.styleColor(a,"color")??p.colorSlot.baseColorHex,k=It(p),E=Cr(p)?f.map(v=>Sr(v,k,p.bandAboveColorHex)):[],T={kind:"chart",...c,values:f,style:p.style,domainMin:g.min,domainMax:g.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:x,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,pointColorHexes:E,fillBands:p.fillBands};if(f.length>0){let v=p.highlight==="highest"||p.highlight==="both",C=p.highlight==="lowest"||p.highlight==="both",P=v?f.indexOf(Math.max(...f)):-1,N=C?f.indexOf(Math.min(...f)):-1;P>=0&&(T.highIndex=P),N>=0&&N!==P&&(T.lowIndex=N)}return T}case"shape":{let p={kind:"shape",...c,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(p.borderColorHex=h),p}case"image":{let p={kind:"image",...c,entityId:n.payload.entity.entityId,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};Be(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(p.url=h),p}case"tap":{let p={kind:"tap",...c,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=Br(n,t).map(x=>this.resolveElement(x,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=l??c??this.resolve(a?.bezelText);p!==void 0&&(s.bezelText=p),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,k=this.resolve(x.value),E=k===void 0?void 0:_t(k);if(E!==void 0){let T=Math.min(x.minValue,x.maxValue),v=Math.max(x.minValue,x.maxValue),C={value:Math.min(v,Math.max(T,E)),minValue:T,maxValue:v===T?T+1:v,colorHexes:x.colorHexes},P=this.resolve(x.minLabel);P!==void 0&&(C.minLabel=P);let N=this.resolve(x.maxLabel);N!==void 0&&(C.maxLabel=N),s.bezelGauge=C}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(s.backgroundColorHex=f);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Zl(e,n,t){let i=new je(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function na(e,n,t){let i=new je(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Zl(e.inline,n,e)),a}var we=de,dn=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:we,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],cn=dn.find(e=>e.measured);function po(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return dn.find(a=>a.screen.width===t&&a.screen.height===i)}function Vn(e,n){let t=we[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Ql={regular:400,medium:500,semibold:600,bold:700};function Pe(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function qe(e,n,t="#FFFFFF"){let i=Pe(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function uo(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function ed(e,n){let t=qe(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Pt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=e.text;if(n.w>0&&s.length*i(o)>n.w){let l=n.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    <g transform="rotate(${d} ${n.cx} ${n.cy})">
      ...
      ${e.fraction>0?b`<circle cx=${n.cx} cy=${n.cy} r=${o} fill="none" stroke-width=${a} stroke-linecap="round"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]}
        stroke=${o} stroke-opacity=${s} stroke-width=${a} />`}}function od(e,n,t){let i=t.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=qe(e.colorHex,"stroke"),r=e.size;return b`
    ...
    ${o!==void 0?b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${aa} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??m}</g>`:m}`}var aa=5;function pd(e,n){let t=aa*.55,i=n.w-2;if(n.h<aa*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function ra(e,n,t){if(e.isHidden&&!t.showHidden)return m;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return m;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return m;let l=uo(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=ed(e,l);break;case"icon":c=od(e,l,t.icons);break;case"gauge":c=td(e,l);break;case"chart":c=ad(e,l);break;case"shape":c=rd(e,l);break;case"image":c=dd(e,l,t);break;case"tap":c=cd(e,l,t.icons,a,d?Ge(e.action):void 0);break}let p=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,f=t.highlightId===e.id,g=f||t.highlightIds?.includes(e.id)===!0,x=t.handles===!0&&(!s||o),k=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:m,E=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:m,T=b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,v=3,C=f&&x?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([P,N,q])=>b`<rect data-handle=${P} x=${N-v/2} y=${q-v/2} width=${v} height=${v}
          fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${P}-resize" />`):m;return b`<g data-element-id=${e.id} opacity=${h} style=${x?"cursor:move":m}
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${T}${c}${E}${k}${C}</g>`}function Un(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function da(e,n){return(n?23.5:34)*e}var no=10.5;function ho(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function io(e,n){let t=0;for(let i of e)t+=ho(i,n);return t}function ao(e,n,t){let i=e.toUpperCase(),a=d=>ho(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function oa(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function sa(e,n,t,i){let a=oa(e,n,t),r=oa(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function mo(e,n,t,i){let{dial:a}=Un(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:sa(a,t,i.start,i.end),length:t*r}}function ud(e,n){let t=Un(e,!0);return mo(e,n,t.dial.r,t.labelArc)}var ro=18.5,hd=113,md={start:-71,end:-36},oo=104,fd=6.2,so={start:-77,end:-30.5};function lo(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function co(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=lo(e[i]),o=lo(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var ia=11;function gd(e,n,t){let{dial:i}=Un(n,!0),a=oo*n,r=180/(Math.PI*oo),o=e.minLabel!==void 0?io(e.minLabel,ia)*r:0,s=e.maxLabel!==void 0?io(e.maxLabel,ia)*r:0,l=so.start+(o>0?Math.max(0,o-1.8):0),d=so.end-(s>0?Math.max(0,s-1.8):0),c=d-l,p=24,h=[];for(let E=0;E<p;E++){let T=l+c*E/p,v=Math.min(d,l+c*(E+1)/p+.4);h.push(b`<path d=${sa(i,a,T,v)} fill="none"
      stroke=${co(e.colorHexes,(E+.5)/p)} stroke-width=${fd*n}
      stroke-linecap=${E===0||E===p-1?"round":"butt"} />`)}let f=(e.value-e.minValue)/(e.maxValue-e.minValue),g=oa(i,a,l+c*f),x=1.5,k=(E,T,v,C)=>b`
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${co(e.colorHexes,f)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?k(`${t}-gmin`,l-x-Math.max(o,3),l-x,e.minLabel):m}
    ${e.maxLabel!==void 0?k(`${t}-gmax`,d+x,d+x+Math.max(s,3),e.maxLabel):m}`}function ca(e,n){let t=e.family in we?e.family:"rectangular",i=n.slot??we[t],a=we[t],r=Vn(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Pe(e.backgroundColorHex),l=Pe(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,x=!!e.bezelText||!!e.bezelGauge,k=e.curvedText??"",E=k!=="",T=Un(g,x),v=da(g,x),C=v/(a.width*g),P=T.tile.cx-v/2,N=T.tile.cy-v/2,q=`M 0 0 H ${T.quad.width-T.cornerRadius} A ${T.cornerRadius} ${T.cornerRadius} 0 0 1 ${T.quad.width} ${T.cornerRadius} V ${T.quad.height} H 0 Z`,oe=m;if(e.bezelGauge)oe=gd(e.bezelGauge,g,o);else if(e.bezelText){let S=ud(g,`${o}-bezel`),O=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Pt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;oe=b`<defs><path id=${S.id} d=${S.d} /></defs>
        <text font-size=${no*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${S.id}" startOffset="50%" text-anchor="middle">${ao(O,S.length,no*g)}</textPath></text>`}let w=m;if(E){let S=Pe(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},O=mo(g,`${o}-curved`,hd*g,md);w=b`<defs><path id=${O.id} d=${O.d} /></defs>
        <text font-size=${ro*g} font-weight="600" fill=${S.color} fill-opacity=${S.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${O.id}" startOffset="50%" text-anchor="middle">${ao(k,O.length,ro*g*.88)}</textPath></text>`}else{let S=e.borderWidth*r.scale*C,O=l?b`<circle cx=${v/2} cy=${v/2} r=${v/2-S/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${S} />`:m;w=b`<g transform="translate(${P} ${N})">
        <g clip-path=${`url(#${o})`}>
    ...
    ${c.map(f=>ra(f,a,d))}
    ${p}
  </svg>`}function V(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var Ot=["rectangular","circular","corner","inline"];function yt(e){return Q.includes(e)}function go(e){return Ot.filter(n=>e.supportedFamilies.includes(n))}function yo(e){return Q.find(n=>e.supportedFamilies.includes(n))}function Nt(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function wd(){return{value:M("")}}function xd(e){let n=zt();for(let t of e.elements)n.placements[t.payload.id]={frame:{...t.payload.frame},isHidden:!0};return n}function bo(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=Ot.filter(t=>t===n||e.supportedFamilies.includes(t))),yt(n)?e.perFamily[n]||(e.perFamily[n]=xd(e)):e.inline||(e.inline=wd()),e.schemaVersion=en(e)}function vo(e,n){Nt(e,n)&&(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),yt(n)?delete e.perFamily[n]:delete e.inline,e.schemaVersion=en(e))}function wo(e,n){let t=[];if(!yt(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=Object.values(i.placements).filter(r=>!r.isHidden).length;return a>0&&t.push(`${a} placed layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var re={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},Dt={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",shape:"Shape",image:"Picture",tap:"Tap area"},pa=["text","icon","gauge","chart","shape","image","tap"],J={states:"#f9a825",tap:re.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var xo="2.8.0";function ua(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function kd(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function ko(e,n=xo){let t=ua(e),i=ua(n);return!t||!i?!1:kd(t,i)>=0}function $o(e,n=xo){return`${ua(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The complication editor needs ${n} or newer. Update Wrist Assistant on the watch, open it once so it reports its version, then reload this page.`}var Co="52a9d81d0fd7";function $d(e){return e.trim().replace(/\./g,"-")}function Cd(e){return e.trim().replace(/-/g,".")}var Kn=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>Cd(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=$d(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Pe(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return b`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Ld(e)}</svg>`}var un="color-mix(in srgb, var(--k) 45%, #6b7280)",Go='system-ui, -apple-system, "Segoe UI", sans-serif';function Uo(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let p=c*Math.PI/180;return{x:(e-t*Math.cos(p)).toFixed(2),y:(n-t*Math.sin(p)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function va(e,n,t,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${Uo(e,n,t,1)} stroke=${un} stroke-width="2.6" opacity=".5" />
    <path d=${Uo(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function zd(e){switch(e){case"text":return b`<g font-family=${Go} text-anchor="middle">
        <text x="36" y="27" font-size="19" font-weight="600" fill="var(--k)">72°</text>
        <text x="36" y="38" font-size="8" fill=${un}>Kitchen</text>
        <text x="90" y="20" font-size="11" font-weight="500" fill=${un}>48%</text>
        <text x="90" y="34" font-size="11" font-weight="500" fill=${un}>1.2 kW</text>
        ...
        ${va(60,24,12,.62)}
        ${va(98,24,12,.92)}
        <text x="60" y="27" font-family=${Go} font-size="8" font-weight="600" text-anchor="middle" fill="var(--k)">62</text>
    ...
    <textarea rows=${i} .value=${n} class="mono" @input=${he(t)}></textarea></label>`}function ee(e,n,t,i={}){let a=n===void 0||Number.isNaN(n)?"":String(n),r=u`<input type="number" .value=${a} step=${i.step??"any"} min=${i.min??m} max=${i.max??m}
      @input=${he(o=>{if(o.trim()===""){i.optional&&t(void 0);return}let s=Number(o);Number.isNaN(s)||t(s)})} />`;return u`<label class="field">${Je(e,Gt(n,i.def,t))}${r}</label>`}function Se(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return u`<label class="field">${Je(e,Gt(n,a.def,i,r))}
    <select @change=${he(o=>i(o))}>
      ${t.map(([o,s])=>u`<option value=${o} ?selected=${o===n}>${s}</option>`)}
    </select></label>`}function te(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return u`<div class="field seg-field">${Je(e,Gt(n,a.def,i,r))}
    ...
    </div></div>`}function Xn(e,n,t,i){let a=i.format??(r=>String(Math.round(r*100)/100));return u`<div class="field slider">${Je(e,Gt(n,i.def,t,a))}
    ...
    </div></div>`}function Dd(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function hs(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Vd(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function Zo(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var ms=50;function Bd(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Gd(e,n,t=ms,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),p=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:c.startsWith(a)?h=2:d.includes(a)?h=3:c.includes(a)?h=4:o.length>1&&o.every(f=>d.includes(f)||c.includes(f))?h=5:p!==""&&(p.includes(a)||o.length>1&&o.every(f=>d.includes(f)||c.includes(f)||p.includes(f)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Ud=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function fs(e){return Ud.test(e.trim())}function Kd(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return hs(t,i);if(fs(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var wt=new Map;function Ee(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function gs(e){return wt.has(e)}function nt(e,n,t,i,a,r={}){let o=e.hass.states,s=wt.get(a),l=s?Gd(Vd(o,r.domain,Zo(e.hass)),s.query,ms,r.preferNumeric?Bd:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,p=(v,C,P=0)=>{wt.set(a,{query:C,index:P}),Ee(v)},h=v=>{wt.delete(a),Ee(v)},f=v=>{let C=Kd(v,t,o);C&&i(C)},g=(v,C)=>{i(hs(o,v.entityId)),h(C)},x=()=>Math.max(0,Math.min(wt.get(a)?.index??0,l.length-1)),k=v=>{let C=v.target;if(v.key==="ArrowDown"||v.key==="ArrowUp"){v.preventDefault();let P=wt.get(a);if(!P){p(C,C.value);return}let N=v.key==="ArrowDown"?x()+1:x()-1;p(C,P.query,Math.max(0,Math.min(l.length-1,N))),Wd(C);return}if(v.key==="Enter"){v.preventDefault();let P=l[x()];s&&P?g(P,C):(f(C.value),h(C));return}if(v.key==="Escape"){if(!s)return;v.preventDefault(),v.stopPropagation(),h(C)}},E=t.entityId?Zo(e.hass)?.(t.entityId):void 0,T=t.entityId===""?u`<div class="hint">Type part of a name, a room, or an id.</div>`:c?u`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""}">
      ...
      ${(s?s.query:t.entityId)===""?m:u`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${v=>{let C=v.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),wt.set(a,{query:"",index:0}),Ee(C),C?.focus()}}>${z("close")}</button>`}
    </div>
    ${s?u`<div class="entity-results" role="listbox">
          ${l.length===0?u`<div class="hint" style="padding:6px 8px">${fs(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((v,C)=>u`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                ...
                <span class="ent-right">
                  <span class="ent-type">${Xo(v.domain)}</span>
                  <span class="ent-state">${v.state}</span>
                </span>
              </button>`)}
        </div>`:T}
  </div>`}function Wd(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var jd=120;function qd(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(jn.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(qn),fromPack:!1}}function Qo(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Yd(e){return[{value:"",label:`Starter set (${Qo(qn,e)})`},...jn.map(n=>({value:n.name,label:`${n.name} (${Qo(n.symbols,e)})`}))]}function Jd(e){return e.length>0?e.length:qn.length}function Xd(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function es(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return u`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??u`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function ys(e,n,t,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),c=n.trim(),p=c!==""&&d.size>0&&!d.has(c),h=g=>{t(g),a.noteUsed(g)},f=m;if(r){let g=a.category(i),x=qd(g,o,l,d),k=To(x.names,o),E=x.fromPack?k.slice(0,jd):k,T=d.size===0?a.recent:a.recent.filter(v=>d.has(v));f=u`<div class="sym-browse">
      ...
      ${T.length===0?m:u`<div class="hint">Recent</div>
        <div class="sym-grid one-row">${T.map(v=>es(e,v,v===c,h))}</div>`}
      <div class="sym-grid">${E.map(v=>es(e,v,v===c,h))}</div>
      ${k.length===0?u`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:u`<div class="hint">
            ${Xd(E.length,k.length,o.trim()!=="",Jd(l))}
          </div>`}
    ...
    ${vs(e,a,r,n,t,i)}
  </div>`}function vs(e,n,t,i,a,r){return u`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${ws}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${mn.has(n)?xs(e,i,a,r):m}
  </div>`}function me(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Ra(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function lc(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var mn=new Set,hn=new WeakMap;function dc(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function cc(e,n){let t=e instanceof Node?e:null;if(!t)return;let i=t.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(n)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function ws(e){let n=e.currentTarget,t=e.newState==="open",i=hn.get(n);if(i&&(i(),hn.delete(n)),!t){mn.delete(n.id)&&Ee(n);return}let a=dc(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){hn.get(n)?.(),hn.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}Ca(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),hn.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Ca(n,a.getBoundingClientRect()),mn.has(n.id)||(mn.add(n.id),Ee(n),requestAnimationFrame(()=>{n.isConnected&&Ca(n,a.getBoundingClientRect())}))}function Ca(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=pc({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var vt=8,Qn=6,ts=140;function pc(e,n,t){let i=t.height-e.bottom-Qn-vt,a=e.top-Qn-vt,r=n.height>i&&a>i&&i<ts,o=Math.max(ts,r?a:i),s=Math.min(n.height,o),l=Math.max(vt,Math.min(e.left,t.width-n.width-vt)),d=r?Math.max(vt,e.top-Qn-s):Math.max(vt,Math.min(e.bottom+Qn,t.height-s-vt));return{left:l,top:d,maxHeight:o,above:r}}function xs(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Zd.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=m;switch(a.kind){case"literal":l=i.symbol?ys(e,a.value,c=>r({...a,value:c}),o):ue("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=nt(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),p=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=u`${nt(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${ue("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:p,mono:!0})}
        <datalist id=${p}>${c.map(h=>u`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=hc(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Se("Field",a.timeField,oc,c=>r({...a,timeField:c}));break;case"dataAge":l=u`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=u`${Nd("Template",a.value,c=>r({...a,value:c}),4)}
    ...
    ${Se("Source",a.kind,s,c=>r(sc(a,c)))}
    ${l}
    ${i.noFormat?m:uc(n.format,c=>t(_e(c)?{kind:n.kind}:{...n,format:c}))}
    ${i.showResolved?u`<div class="hint">Now: ${d===void 0?u`<span class="warn">unresolved</span>`:u`<code>${d}</code>`}</div>`:m}`}function uc(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return u`<details class="sub" ?open=${!_e(e)}>
    ...
    ${n.function==="count"?m:ue("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var ks=Pi,mc=ks.filter(([e])=>e!=="none");function fc(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function $s(e){let n=e.config,t=n.tapAction,i=l=>["toggleEntity","runScene","runScript","addTodo","runHTTPAction"].includes(l),a=fc(e.savedName,n.name),r=n.refreshMinutes??0,o=ns.map(l=>[String(l),is(l)]);ns.includes(r)||o.push([String(r),is(r)]);let s=n.showSuccessFlash??!0;return u`
    <div class="gen-row">
      ${ue("Name",n.name,l=>e.update(d=>{d.name=l},"name"))}
      ${Se("Refresh",String(r),o,l=>e.update(d=>{d.refreshMinutes=Number(l)||0},"refresh"))}
      ${Se("Tap action",t.type,ks,l=>e.update(d=>{d.tapAction=i(l)?{type:l,..."entityId"in d.tapAction?{entityId:d.tapAction.entityId,displayName:d.tapAction.displayName,domain:d.tapAction.domain}:{entityId:"",displayName:"",domain:""}}:{type:l},l!=="openPage"&&(delete d.openPageId,delete d.openPageName)}))}
    ...
    ${t.type==="openPage"?yc(e):m}`}var gc="#808080",ns=[0,15,30,60,120];function is(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function yc(e){let n=e.config;return Cs(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Cs(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?u`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:u`${Se("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?m:u`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function Ss(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return u`
    ...
    <div class="sec-h" role="button" tabindex="0" aria-expanded=${r?"true":"false"} @click=${o}
      ...
      <span class="tt"><h4>${t}${us(a.reset===void 0?void 0:{atDefault:!1,title:a.resetTitle??`Put ${t} back to its defaults`,reset:a.reset})}</h4>${a.summary?u`<span class="sum">${a.summary}</span>`:m}</span>
      <span class="chev">${z("chevron")}</span>
    </div>
    ${r?u`<div class="sec-b">${i}</div>`:m}
  </section>`}function Sc(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Ea(e){let n=Fn.find(o=>o.minutes===e);if(n)return n.label;let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return t>0&&r.push(`${t}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var ti=new Set;function Ia(e,n){let t=me(e);switch(n.kind){case"text":return xt(ye(n.payload.value,t),48);case"icon":return xt(ye(n.payload.symbol,t),48);case"gauge":return xt(ye(n.payload.value,t),48);case"chart":return xt(`${ye(n.payload.value,t)}${n.payload.historyMinutes>0?` \xB7 ${Ea(n.payload.historyMinutes)}`:""}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||"No camera yet";case"tap":return Ge(n.payload.action)}}function oi(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Me(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Me(e.payload.colorSlot.baseColorHex)}`;case"gauge":return`${e.payload.style} \xB7 ${e.payload.lineWidth} pt line \xB7 ${Me(e.payload.colorSlot.baseColorHex)}`;case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${bs.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"shape":return`${Me(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function Ms(e,n,t){let i=n.payload.id,a=e.config.elements.findIndex(y=>y.payload.id===i),r=`el-${i}`,o=(y,$)=>e.update(D=>y(D.elements[a]),$?`${r}-${$}`:void 0),s=fe(e.config,t,n),l=s.frame,d=(y,$)=>e.update(D=>xe(D,t,i,{frame:Wo(l,y)}),`${r}-${$}-${t}`),c=ze(n.kind).payload,p=c.colorSlot?.baseColorHex??"#FFFFFF",h=y=>c[y],f,g;switch(n.kind){case"text":{let y=Oi(e.config,n.payload.value);f=u`
        ...
        ${n.payload.countdown?u`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,g=u`<div class="grid2">
          ...
          ${te("Weight",n.payload.fontWeight,Ma,$=>o(D=>{D.payload.fontWeight=$}),{def:c.fontWeight})}
        ...
        ${pe("Track colour",n.payload.trackColorHex,y=>o($=>{$.payload.trackColorHex=y??"#FFFFFF40"},"track"),!1,c.trackColorHex)}`;break;case"chart":{let y=n.payload,$=(R,_)=>o(ve=>R(ve.payload),_),D=ut(y),Z=c.historyMinutes,K=c.historyPoints,X=y.historyMinutes>0,B=y.value.kind.kind==="entityState",be=D===void 0?void 0:e.historySeries(D),ui=X&&B?be??"":e.resolve(y.value)??"",Fe=y.historyPoints<1,nl=Fn.some(R=>R.minutes===y.historyMinutes),yn=ti.has(i)||!nl,hi=Math.floor(y.historyMinutes/1440),mi=Math.floor(y.historyMinutes%1440/60),fi=y.historyMinutes%60,gi=(R,_,ve)=>$(Et=>{Et.historyMinutes=Math.min(Tr,Math.max(1,Math.round(R)*1440+Math.round(_)*60+Math.round(ve)))},"span"),Ae=ln(ui),St=y.limit>0&&Ae.length>y.limit?y.takeFromEnd?Ae.slice(Ae.length-y.limit):Ae.slice(0,y.limit):Ae,il=!X&&B&&Ae.length===1;f=u`
        ${ae(e,y.value,R=>$(_=>{_.value=R},"value"),{label:"Readings",key:`${r}-value`})}
        ${te("Draw",X?"history":"value",[["history","Recorded history"],["value","The value itself"]],R=>$(_=>{_.historyMinutes=R==="history"?_.historyMinutes||Rn:0}),{titles:{history:"Read the entity's past from the recorder and plot it",value:"Plot the numbers the value holds right now, such as a forecast list"},def:c.historyMinutes>0?"history":"value"})}
        ${X?u`
            ${B?m:u`<div class="hint warn">History needs an entity.
            ...
            <div class="grid2">
              <label class="field">${Je("Span",{atDefault:y.historyMinutes===Z&&!yn,title:`Back to ${Ea(Z)}`,reset:()=>{ti.delete(i),$(R=>{R.historyMinutes=Z})}})}
                <select @change=${R=>{let _=R.target.value;_==="custom"?(ti.add(i),Ee(R.target)):(ti.delete(i),$(ve=>{ve.historyMinutes=Number(_)||Rn}))}}>
                  ${Fn.map(({minutes:R,label:_})=>u`<option value=${String(R)} ?selected=${!yn&&R===y.historyMinutes}>${_}</option>`)}
                  <option value="custom" ?selected=${yn}>Custom…</option>
                </select></label>
              <div class="field readings-field">${Je("Readings",{atDefault:y.historyPoints===K,title:`Back to ${K<1?"every one":`${K} averaged`}`,reset:()=>$(R=>{R.historyPoints=K})})}
                <div class="readings-row">
                  ...
                  ${Fe?m:u`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    ...
                    @input=${he(R=>{let _=Number(R);R.trim()!==""&&Number.isFinite(_)&&_>=1&&$(ve=>{ve.historyPoints=Math.round(_)},"hpoints")})} />`}
                </div>
              </div>
            </div>
            ${yn?u`<div class="grid3 span-parts">
              ...
              <div class="hint">${Ea(y.historyMinutes)}, up to 7 days: the recorder keeps
            ...
            ${B&&be===void 0?u`<div class="hint">Reading the history…</div>`:m}
            ${B&&be===""?u`<div class="hint warn">Nothing recorded for this entity in that span.
        ...
        ${Ae.length===0&&!(X&&(!B||be===void 0||be===""))?u`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:m}
        ${Ae.length>0?u`<div class="hint">Reads <span class="nums">${Sc(St)}</span>${Ae.length===St.length?u` · ${St.length} ${St.length===1?"value":"values"}`:u` · ${St.length} of ${Ae.length}`}</div>`:m}
        ...
        <div class="hint">${X?"Trims the series after it arrives, so 0 draws every reading fetched above.":"A forecast sensor often carries 24 or 48 entries. 0 draws all of them."}</div>`,g=u`
        <div class="grid2">
          ${te("Style",y.style,Qd,R=>$(_=>{_.style=R}),{def:c.style})}
        ...
        <div class="grid2">
          ${te("Scale",y.scale,ec,R=>$(_=>{_.scale=R}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${te("Baseline",y.baseline,tc,R=>$(_=>{_.baseline=R}),{def:c.baseline})}
        </div>
        ...
        ${te("Colour",y.coloring,ic,R=>$(_=>{_.coloring=R,R==="bands"&&_.bands.length===0&&(_.bands=ac(St))}),{def:c.coloring})}
        ${y.coloring==="bands"?u`
          ...
          ${y.bands.map((R,_)=>u`
            <div class="row-inline">
              ${ee("Up to",R.upTo,ve=>$(Et=>{let at=Et.bands[_];at&&(at.upTo=ve??0)},`bup${R.id}`))}
              ${pe("Colour",R.colorHex,ve=>$(Et=>{let at=Et.bands[_];at&&(at.colorHex=ve??"#FFFFFF")},`bcol${R.id}`))}
              <button class="icon" title="Remove this band" aria-label="Remove this band"
                @click=${()=>$(ve=>{ve.bands=ve.bands.filter((Et,at)=>at!==_)})}>${z("close")}</button>
            </div>`)}
          <button class="small" @click=${()=>$(R=>{R.bands=[...R.bands,rc(R)]})}>Add band</button>
          ${pe("And the rest",y.bandAboveColorHex,R=>$(_=>{_.bandAboveColorHex=R??an},"babove"),!1,an)}
        ...
        <div class="grid2">
          ${te("Highlight",y.highlight,bs,R=>$(_=>{_.highlight=R}),{def:c.highlight})}
          ${y.highlight==="none"?m:te("Marker",y.marker,nc,R=>$(_=>{_.marker=R}),{def:c.marker})}
        </div>
        ${y.highlight==="none"?m:u`
          <div class="grid2">
            ${y.highlight==="lowest"?m:pe("Highest colour",y.highColorHex,R=>$(_=>{_.highColorHex=R??tn},"hicol"),!1,tn)}
            ${y.highlight==="highest"?m:pe("Lowest colour",y.lowColorHex,R=>$(_=>{_.lowColorHex=R??nn},"locol"),!1,nn)}
          </div>
        ...
        ${Is(e,n.payload,(y,$)=>o(D=>y(D.payload),$),r)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let x=n.kind==="image"||n.kind==="tap"?void 0:pe(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>o($=>{$.kind!=="image"&&$.kind!=="tap"&&($.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,p),k=Ui(e.config,n),E=k?{kind:{kind:"entityState",...k}}:void 0,T=re[n.kind],v=n.kind==="tap"?void 0:Ce(e.config,i)[0],C=n.kind==="image"?n.payload.timestamp===!0:!1,P=Tc[n.kind],N=Fc[n.kind],q=os(n.payload,c,P),oe=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[t]?.placements[i]?.size!==void 0,S=os(n.payload,c,N)||oe!==void 0&&s.size!==void 0&&s.size!==c[oe],O=!ri(l,Ve)||s.isHidden,L=ht(e.config,i),ne=(y,$)=>()=>o(D=>ss(D.payload,c,y),$);return u`
    ${ge(e,"content","Content",u`${n.kind==="tap"?m:vc(e,n,r)}${f}`,{color:T,icon:"content",summary:Ia(e,n),...q?{reset:ne(P,"reset-content")}:{}})}
    ${g===void 0&&x===void 0?m:ge(e,"look",n.kind==="image"?"Picture":"Look",u`${g??m}${x??m}`,{color:T,icon:n.kind==="image"?"image":"look",...oi(n)?{summary:oi(n)}:{},...S?{reset:()=>e.update(y=>{ss(y.elements[a].payload,c,N),w&&xe(y,t,i,{},!0)})}:{}})}
    ${n.kind==="chart"?ge(e,"numbers","Numbers",Ac(e,n),{color:re.text,icon:"text",summary:Ic(e,n),...L.length>0?{reset:()=>e.update(y=>{for(let $ of ht(y,i))mt(y,$.payload.id)})}:{}}):m}
    ${n.kind==="image"?ge(e,"timestamp","Timestamp",Cc(n.payload,(y,$)=>o(D=>y(D.payload),$)),{color:T,icon:"clock",summary:C?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...C?{reset:ne(Ec,"reset-stamp")}:{}}):m}
    ${n.kind==="tap"?m:ge(e,"tappable","Tap",Hc(e,n,r),{color:J.tap,icon:"tap",summary:v?Ge(v.payload.action):"Not tappable",...v?{reset:()=>e.update(y=>zn(y,i))}:{}})}
    ${ge(e,"states","States",Os(e,n.payload.rules,n.kind,y=>y.elements.find($=>$.payload.id===i)?.payload.rules,`rules-${i}`,E),{color:J.states,icon:"states",summary:pn(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>o(y=>{y.payload.rules=[]})}:{}})}
    ${ge(e,"placement","Place",u`
      ...
      <div class="hint">Everything about where this layer sits, how big it is drawn and whether it
        ...
        the same layer differently there.</div>`,{color:J.place,icon:"place",summary:`${Math.round(l.width*100)}% wide \xB7 ${V(t)}${s.fromPlacement?"":" \xB7 shared frame"}`,...O?{resetTitle:`Put this layer back to the middle of the ${V(t)} face at half size, unrotated and shown`,reset:()=>e.update(y=>xe(y,t,i,{frame:{...Ve},isHidden:!1}))}:{}})}`}var Ec=["timestamp","timestampCorner","timestampSize"],Tc={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],shape:["kind","cornerRadius"],image:["entity"],tap:["action","openPageName"]},Fc={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","colorSlot"],shape:["colorSlot","borderColorHex","borderWidth"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function Is(e,n,t,i){let a=n.action,r=o=>["toggleEntity","runScene","runScript","addTodo","runHTTPAction"].includes(o);return u`
    ${Se("Tap action",a.type,mc,o=>t(s=>{s.action=r(o)?{type:o,..."entityId"in s.action?{entityId:s.action.entityId,displayName:s.action.displayName,domain:s.action.domain}:{entityId:"",displayName:"",domain:""}}:{type:o},o!=="openPage"&&(delete s.openPageId,delete s.openPageName)}))}
    ${"entityId"in a?nt(e,"Target",a,o=>t(s=>{s.action={type:a.type,...o}},"tap-entity"),`${i}-tap`):m}
    ${a.type==="openPage"?Cs(e,n.openPageId,n.openPageName,(o,s)=>t(l=>{if(o===void 0){delete l.openPageId,delete l.openPageName;return}l.openPageId=o,s?l.openPageName=s:delete l.openPageName},"tap-page")):m}`}var Rc=24;function Mc(e,n){let t=[],i=1/0;for(let r of Q){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Kr(e.config,n,r);o&&(t.push(`${V(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return m;let a=i<Rc;return u`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?u`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Ic(e,n){let t=ht(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Mt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Ac(e,n){let t=me(e),i=ht(e.config,n.payload.id),a=o=>e.update(s=>{Or(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return u`
    ...
    ${Ie("Tappable",a!==void 0,s=>e.update(l=>{s?Ln(l,i):zn(l,i)}))}
    ${a?u`<div class="value-editor">
          ${Is(e,a.payload,r,`${t}-attached`)}
          <div class="chips">
        ...
        ${Mc(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:u`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${Ge(o)}</b>.</div>`}`}function ls(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Te(e,n){switch(e.kind){case"text":return ls(ye(e.payload.value,n));case"icon":return ls(ye(e.payload.symbol,n));case"gauge":return ye(e.payload.value,n);case"chart":return ye(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||"camera"}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function As(e,n){let t=Ke(e.config,n.id),i=me(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return ge(e,"content","Group",u`
    ...
    <div class="adders">
      <button class="small" title="Keep the layers where they are and drop the folder" @click=${()=>e.update(r=>rn(r,n.id))}>Ungroup</button>
    </div>`,{color:J.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Hs(e,n){if(n==="inline")return u`${Lc(e)}${Sa(e,n)}`;let t=e.config.perFamily[n];if(!t)return u`<div class="hint">No settings stored for ${V(n)} yet.</div>
      ...
      ${Sa(e,n)}`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=li(e.config,n),r=t.backgroundColorHex?Me(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Me(t.borderColorHex)} border`:"no border";return u`
    ${ge(e,"look",`${V(n)} shape`,u`
      ...
      ${ee("Border width (pt)",t.borderWidth,s=>i(l=>{l.borderWidth=s??2},"bw"),{step:.5,min:0,def:2})}`,{color:J.place,icon:"shape",summary:`${r} \xB7 ${o}`,...t.backgroundColorHex!==void 0||t.borderColorHex!==void 0||t.borderWidth!==2?{reset:()=>i(s=>{delete s.backgroundColorHex,delete s.borderColorHex,s.borderWidth=2},"reset-look")}:{}})}
    ${n==="corner"?ge(e,"corner","Corner content",zc(e,t,i),{color:J.place,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):m}
    ${ge(e,"states","Shape states",Os(e,t.rules,"layout",s=>s.perFamily[n]?.rules,`rules-${n}`),{color:J.states,icon:"states",summary:pn(t.rules).replace(/\.$/,""),...t.rules.length>0?{reset:()=>i(s=>{s.rules=[]},"reset-states")}:{}})}
    ...
    ${ge(e,"content","Inline text",u`
      ...
      ${n.countdown?u`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,{color:re.text,icon:"text",summary:xt(`${n.label?`${n.label}: `:""}${ye(n.value,i)}`,48)})}
    ${ge(e,"symbol","Symbol",u`
      ${ys(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:re.icon,icon:"icon",summary:n.symbol||"None"})}`}function zc(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return u`
    ...
    ${n.maxLabel?ae(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):m}`}var kh=Q.map(e=>[e,V(e)]),Aa={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Pc=Object.keys(Aa);function Oc(e){let n=Pn[e];return Pc.filter(t=>n.includes($e[t]))}var Nc={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function ni(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function xt(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Dc(e){if(!e||_e(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function ye(e,n){return`${Ls(e,n)}${Dc(e.format)}`}function Ls(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${xt(t.value,40)}"`:"(empty)";case"entityState":return ni(t,n);case"entityAttribute":return t.attribute?`${ni(t,n)} \xB7 ${t.attribute}`:ni(t,n);case"entityAge":return`age of ${ni(t,n)}`;case"aggregate":return Vc(t.aggregate);case"time":return Nc[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${xt(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Mt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Ls(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function Vc(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function si(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function Bc(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return u`
    ...
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(sn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function Gc(e,n,t,i,a,r,o){let s=e.liveBranch(n),l=e.forced.get(n.id)??"live",d=p=>l==="live"?p==="live":l==="otherwise"?p==="otherwise":l.caseId===p,c=(p,h)=>r(f=>{let g=f.find(x=>x.id===n.id);g&&p(g)},h);return u`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${n.otherwise?u`<div class="case-box otherwise">
          ...
          ${zs(e,n.otherwise,a,p=>c(h=>{h.otherwise&&p(h.otherwise)}),`${o}-otherwise`)}
        </div>`:m}
    ...
    ${zs(e,n.then,a,d=>s(c=>d(c.then)),`${o}-then`)}
        ...
        ${s.pattern&&!Wc(s.pattern)?u`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:m}`;break;case"options":c=ue("Options (comma separated)",(s.options??[]).join(", "),p=>o(h=>{h.comparison.options=p.split(",").map(f=>f.trim()).filter(Boolean)},"options"));break;case"none":break}return u`<div class="test-box">
    <div class="rule-head">
    ...
    ${Se("Comparison",s.kind,Yr.map(p=>[p,Vt[p]]),p=>o(h=>{h.comparison=Xi(h.comparison,p)}))}
    ${c}
  </div>`}function Wc(e){try{return new RegExp(e),!0}catch{return!1}}function zs(e,n,t,i,a){let r=Oc(t);return u`
    ...
    </select>`}var _s=["setColor","setBorderColor","setBackgroundColor"];function jc(e,n,t,i,a,r,o){let s=!Pn[i].includes($e[n.kind]);return u`<div class="change-box">
    <div class="rule-head">
      <span>${Aa[n.kind]}${s?u` <span class="no">(ignored by ${i==="layout"?"layouts":`${i} layers`})</span>`:m}</span>
      <span class="spacer"></span>
      <button class="icon danger" title="Delete change" @click=${r}>${z("delete")}</button>
    </div>
    ${Ps(e,n,a,o)}
  </div>`}function Ps(e,n,t,i){let a=On(n.kind),r=m;if(a==="value"){let o=n.value??M("");if(_s.includes(n.kind)){let s=o.kind.kind==="literal";r=u`${s?pe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=M(l??"#FFFFFF")},"color")):ae(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!o.ok} title=${o.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${l=>{Ta.delete(a),Ee(l.target)}}>Show as table</button>
        ${o.ok?m:u`<span class="hint">${o.reason}</span>`}
      </div>
      ${Bc(e,n,t,i,a)}`:qc(e,o.table,n[0],t,i,a,r)}function qc(e,n,t,i,a,r,o){let s=(w,S)=>e.update(O=>{let L=a(O);L&&w(L)},S?`${r}-${S}`:void 0),l=n.value??ds.get(r)??o,d=n.rows.length===0,c=n.numberMode||d&&l!==void 0&&!Bo(l)&&Yc(e.resolve(l)),p=Pn[i],h=ii.get(r)??new Set,f=n.columns.length===0&&h.size===0?[Vo[i]]:[],g=Ao(n.columns,[...h,...f.filter(w=>w!==void 0)],p),x=t?e.liveBranch(t):"none",k=t?e.forced.get(t.id)??"live":"live",E=w=>k!=="live"&&(k==="otherwise"?w==="otherwise":k.caseId===w),T=w=>{t&&e.setForced(t.id,E(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},v=w=>{ds.set(r,w),n.rows.length!==0&&s(S=>Oo(S,w),"lhs")},C=()=>s(w=>_o(w,l??M(""),c)),P=n.rows.map((w,S)=>ps(e,{key:`${r}-${w.caseId}`,label:Do(w.comparison,O=>ye(O,me(e))),columns:g,changes:w.changes,live:x===w.caseId,forced:E(w.caseId),onForce:()=>T(w.caseId),when:ep(e,w.comparison,`${r}-${w.caseId}`,(O,L)=>s(ne=>{let y=ne[0]?.cases.find($=>$.id===w.caseId)?.when.tests[0];y&&O(y.comparison)},L&&`${w.caseId}-${L}`)),updChanges:(O,L)=>s(ne=>{let y=ne[0]?.cases.find($=>$.id===w.caseId);y&&O(y.then)},L&&`${w.caseId}-${L}`),acts:u`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>s(O=>Po(O,w.caseId))}>${z("delete")}</button>`})),N=n.otherwise===void 0?m:ps(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:x==="otherwise",forced:E("otherwise"),onForce:()=>T("otherwise"),when:u`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,S)=>s(O=>{let L=O[0]?.otherwise;L&&w(L)},S),acts:u`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>ba(w,!1))}>${z("close")}</button>`}),q=ai.get(r),oe=Jc.filter(w=>p.includes(w)&&!g.includes(w));return u`
    <div class="states">
      ...
      <table class="states-table">
        <thead>
          <tr>
            ...
            ${g.map(w=>u`<th>
              <span>${Ye[w]}</span>
              <button class="icon" title=${`Remove the ${Ye[w]} column`}
                @click=${S=>{ai.set(r,w),Ee(S.target)}}>${z("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${q===void 0?m:u`<div class="hint warn confirm-row">
        Remove the ${Ye[q]} column? Its ${cs(n,q)} value${cs(n,q)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${w=>{ai.delete(r),ii.get(r)?.delete(q),Ee(w.target),s(S=>No(S,q))}}>Remove</button>
        <button class="small" @click=${w=>{ai.delete(r),Ee(w.target)}}>Cancel</button>
      </div>`}
      <div class="states-foot">
        <button class="small" @click=${C}>+ state</button>
        ${n.otherwise===void 0?u`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>s(w=>ba(w,!0))}>+ otherwise</button>`:m}
        <span class="spacer"></span>
        ${k==="live"?m:u`<button class="small" @click=${()=>t&&e.setForced(t.id,"live")}>Back to live</button>`}
        ${oe.length===0?m:u`<select class="chip-add" title="Add a column" @change=${w=>{let S=w.target,O=S.value;if(S.value="",!O)return;let L=ii.get(r)??new Set;L.add(O),ii.set(r,L),Ee(S)}}>
          <option value="" selected>+ column…</option>
          ${oe.map(w=>u`<option value=${w}>${Ye[w]}</option>`)}
        </select>`}
      </div>
  ...
  </tr>`}function Zc(e,n,t,i,a){let r=Yn(t,n),o=Ra(a);if(!r)return u`<button type="button" class="cell empty" title=${`Set ${Ye[n]} for this state`}
      @click=${d=>{i(c=>{c.push(gt(Io[n]))}),cc(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(p=>{let h=p.find(f=>$e[f.kind]===n);h&&d(h)},c&&`${n}-${c}`),l=Ye[n];return u`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Qc(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${ws}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${mn.has(o)?u`${n==="visibility"?te("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):Ps(e,r,s,a)}
    ...
    </div>`}function Qc(e,n){if(n.kind==="hide")return u`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return u`<span class="cell-word">Shown</span>`;let t=On(n.kind);if(t==="number")return u`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return u`<span class="cell-word">${Ma.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??M(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(_s.includes(n.kind))return u`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Me(a):ye(i,me(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return u`${r??m}<span class="cell-word">${a}</span>`}return u`<span class="cell-word">${ye(i,me(e))}</span>`}function Me(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function ep(e,n,t,i){let a=ft(n.kind),r=fa(n.kind),o=(s,l,d,c)=>np(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return u`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${he(s=>i(l=>{let d=Xi(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${ma.map(s=>u`<option value=${s} ?selected=${s===n.kind}>${tp(s)}</option>`)}
    </select>
    ...
    ${vs(e,s,o,n,t,l)}
  </span>`}var fn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Gi,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Bs(e){return fn.find(n=>n.kind===e)??fn[0]}var Ns="#FF9F0A",Ha="#8E8E93",ip=["#FF453A","#FFD60A","#34C759"],Gs=["#0A84FF","#34C759","#FF9F0A"];function ap(e){return e?.attributes?.device_class==="battery"?ip:Gs}var rp={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function op(e){let n=e.iconName?.trim();return n?{off:n,on:n}:rp[La(e)]??{off:"circle",on:"circle.fill"}}function sp(e){switch(La(e)){case"lock":return{kind:"equals",value:M("locked")};case"cover":case"valve":return{kind:"equals",value:M("open")};case"media_player":return{kind:"equals",value:M("playing")};default:return{kind:"isOn"}}}function La(e){return e.domain||e.entityId.split(".")[0]||""}function $t(e){return{...e,domain:La(e)}}function lp(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function di(e){return Math.round(e*1e4)/1e4}function ci(e,n,t){return Math.min(t,Math.max(n,e))}function za(e,n,t){let i=we[e],a=ci(di(n/i.width),0,1),r=ci(di(t/i.height),0,1);return{x:di((1-a)/2),y:di((1-r)/2),width:a,height:r,rotationDegrees:0}}function dp(e){let n=we[e],t=ci(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:za(e,t*1.3,t*1.3),size:t}}function cp(e){let n=we[e],t=ci(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:za(e,n.width*.88,t*1.7),size:t}}function pp(e){let n=we[e],t=Math.min(n.width,n.height)*.9;return{frame:za(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function Us(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function up(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function hp(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function Ut(e,n,t,i){let a=i(t);n.payload.frame=a.frame,hp(n,a.size);for(let r of Q){if(r===t||r==="inline")continue;let o=e.perFamily[r];if(!o)continue;let s=i(r);JSON.stringify(s)!==JSON.stringify(a)&&(o.placements[n.payload.id]={frame:s.frame,isHidden:!1,...s.size!==void 0?{size:s.size}:{}})}}function Kt(e){return ze(e)}function _a(e,n){let t={kind:{kind:"entityState",...$t(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Ds(e){let n=gt("setIcon");return n.value=M(e),n}function kt(e){let n=gt("setColor");return n.value=M(e),n}function mp(e,n){let t=sn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...$t(e)}},a.comparison=sp(e);let r=n.on!==n.off;return i.then=r?[Ds(n.on),kt(Ns)]:[kt(Ns)],t.otherwise=r?[Ds(n.off),kt(Ha)]:[kt(Ha)],t}function fp(e){let n=sn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...$t(e)}},i.comparison={kind:"isUnavailable"};let a=gt("setOpacity");return a.number=.35,t.then=[a],n}function Vs(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function gp(e,n,t=Gs){let i=n.max-n.min,a=Vs(n.min+i/3),r=Vs(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:M(a)},changes:[kt(t[0])]},{comparison:{kind:"between",value:M(a),upper:M(r)},changes:[kt(t[1])]},{comparison:{kind:"greaterThan",value:M(r)},changes:[kt(t[2])]}];return Ho(_a(e),o)}function yp(e,n,t){let i=Kt("icon"),a=op(n);return i.payload.symbol=M(a.off),i.payload.colorSlot.baseColorHex=Ha,i.payload.rules=[mp(n,a)],Ut(e,i,t.family,dp),e.elements.push(i),Ln(e,i.payload.id,{type:"toggleEntity",...$t(n)}),i.payload.id}function bp(e,n,t){let i=Kt("text");return i.payload.value=_a(n,t.state),i.payload.rules=[fp(n)],Ut(e,i,t.family,cp),e.elements.push(i),i.payload.id}function vp(e,n,t){let i=Kt("gauge");i.payload.value=_a(n);let a=lp(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[gp(n,a,ap(t.state))],Ut(e,i,t.family,pp),e.elements.push(i),i.payload.id}function wp(e,n,t){let i=Kt("chart");return i.payload.value={kind:{kind:"entityState",...$t(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",Ut(e,i,t.family,Us),e.elements.push(i),i.payload.id}function xp(e,n,t){let i=Kt("chart");return i.payload.value={kind:{kind:"entityState",...$t(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",Ut(e,i,t.family,Us),e.elements.push(i),i.payload.id}function kp(e,n,t){let i=Kt("image");return i.payload.entity=$t(n),Ut(e,i,t.family,up),e.elements.push(i),i.payload.id}function Ks(e,n,t,i){switch(n){case"toggle":return yp(e,t,i);case"status":return bp(e,t,i);case"gauge":return vp(e,t,i);case"chart":return wp(e,t,i);case"history":return xp(e,t,i);case"camera":return kp(e,t,i)}}var Cp=3e4,Sp=500,Ws="preset-entity",Ep={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function Pa(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Tp(e){return e.kind==="family"?"look":"content"}function Fp(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}var js=300,qs=400,Ys=52,Js=36,Rp=[1,1.7,2.6],Mp=["S","M","L"],Xs=["Small","Medium","Large"],Zs="wrist-assistant-panel.layers.v1",Xe=34,Ct=200,Ip=720,pi=320,Ap=80,Hp=56,Qs="wrist-assistant-panel.columns.v2",Oa=e=>Math.max(Ct,Math.min(Ip,Math.round(e))),el=e=>e.metaKey||e.ctrlKey||e.shiftKey,Lp=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,gn=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Oe=gn==="Cmd"?"\u2318":"Ctrl+",Na=gn==="Cmd"?"\u21E7":"Shift+";function tl(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Ap;if(i>=Ct*2+pi){let r=i-pi,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Ct,Math.floor(o*l)),s=Math.max(Ct,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Ct,o-d):s=Math.max(Ct,s-d))}return{columns:3,left:o,right:s}}let a=e-Hp;return a>=Ct+pi?{columns:2,left:Math.min(n,a-pi),right:t}:{columns:1,left:n,right:t}}var I=class I extends Qe{constructor(){super(...arguments);this.narrow=!1;this.colLeft=js;this.colRight=qs;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.previewCase=cn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=So(()=>this.requestUpdate());this.imageSizes=Eo(()=>this.requestUpdate());this.symbols=new Wn(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||gs(Ws)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=bi`
    :host {
    ...
    * { box-sizing: border-box; }
    ...
    .layers { display: flex; flex-direction: column; gap: 6px; --thumb-w: ${Ys}px; --thumb-h: ${Js}px; }
    ...
    .layer.held {
      border-color: color-mix(in srgb, ${se(J.group)} 70%, var(--wa-line));
      background: color-mix(in srgb, ${se(J.group)} 10%, var(--wa-panel));
    }
    .layer.held .thumb { border-color: color-mix(in srgb, ${se(J.group)} 60%, var(--wa-line)); }
    ...
    .layer .lockbtn.on { opacity: 1; color: ${se(J.locked)}; filter: drop-shadow(0 0 4px ${se(J.locked)}); }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let t=window.localStorage.getItem(Qs);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=Oa(i.left)),typeof i.right=="number"&&(this.colRight=Oa(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Qs,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Zs);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Zs,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return u`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?u`<div class="adders">
            ${r.map(o=>u`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Fs(s,o,i))}>Copy the ${V(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(t){this.mutate(i=>bo(i,t)),this.activeFamily=t,this.inspect={kind:"family"}}removeShape(t){let i=this.draft?.config;if(!i||!Nt(i,t))return;let a=wo(i,t);a.length>0&&!window.confirm(`Remove the ${V(t)} layout? This drops ${a.join(", ")}.`)||(this.mutate(r=>vo(r,t)),this.ensureActiveFamily())}createNew(t){this.newShapeChooser=!1,this.startNew(Vr("New complication",this.freeSlot(),[t]))}setForced(t,i){let a=new Map(this.forced);i==="live"?a.delete(t):a.set(t,i),this.forced=a}async save(t=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!t&&!this.draft.dirty)){if(!t&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(t){let o=this.freeSlot();if(o<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let s=structuredClone(i.config);s.id=Y(),s.slotIndex=o,i=new bt(s,null)}let a=i.encoded(),r=await sr(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id,this.draft=bt.fromDocument(r.record.document,r.record.revision),this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=it(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let t=await lr(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!t.ok){t.error==="conflict"?this.conflict={current:t.current??null,message:t.message??"This complication changed on the server."}:this.saveError=t.message??t.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(t){this.saveError=it(t)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let t=structuredClone(this.draft.config);t.id=Y(),t.name=`${t.name} copy`,t.slotIndex=this.freeSlot(),this.startNew(t)}reloadFromServer(){let t=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,t&&!t.deleted?this.openRecord(t):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(t=>t.owner_watch_id===this.ownerId)}async moveAll(){let t=this.ownerId,i=this.moveTarget;if(!(!t||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await dr(this.hass,t,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=it(a)}finally{this.moving=!1}}}scheduleTemplates(t){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},t),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},Cp)}async refreshHistorySeries(){let t=this.draft?.config,i=t?Li(t):[];if(i.length===0){this.historySeries.size>0&&(this.historySeries=new Map);return}let a={};for(let r of i)a[r.key]={entity_id:r.entityId,minutes:r.minutes,points:r.points};try{let r=await ur(this.hass,a),o=new Map;for(let[s,l]of Object.entries(r))l.ok&&o.set(s,l.series);this.historySeries=o}catch{}}async refreshTemplates(){this.refreshHistorySeries();let t=this.compiled?.document;if(!t){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await pr(this.hass,{doc:t})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=to(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=it(i)}}buildContext(){let t=new Map;for(let i of this.compiled?.entities.keys()??[]){let a=this.hass.states[i];if(!a)continue;let r=a.attributes,o=i.split(".")[0]??"",s={entityId:i,state:this.testValues.get(i)??a.state,unitOfMeasurement:typeof r.unit_of_measurement=="string"?r.unit_of_measurement:void 0,iconName:this.compiled?.entities.get(i)?.iconName??"",domain:o};if(o==="timer"){s.timerState=a.state,typeof r.finishes_at=="string"&&(s.finishesAt=r.finishes_at);let l=zp(r.remaining);l!==void 0&&(s.remaining=l)}o==="camera"&&typeof r.entity_picture=="string"&&(s.entityPicture=r.entity_picture),t.set(i,s)}return{entityStates:t,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:this.draft?.config.values??[],dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3}}renderPickButton(){let t=this.picking,i=!this.draft||this.parseError!==void 0;return u`<button class="pick ${t?"on":""}" ?disabled=${i}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Wi(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let E=this.focusTapId();if(E!==void 0&&o===E&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,E,r??void 0);return}let T=this.hitLayerId(i);T?this.inspect={kind:"layer",id:T}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=el(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let p=Wi(this.draft.config,o),h=this.draft.config.elements.find(E=>E.payload.id===p);if(!p||!h)return;if(c){i.preventDefault(),this.togglePick(p);return}let f=Ue(this.draft.config,p),g=f!==void 0&&this.inspect.kind==="group"&&this.inspect.id===f.id;if(f&&(f.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,f);return}if((this.inspect.kind!=="layer"||this.inspect.id!==p)&&(this.inspect={kind:"layer",id:p},r))return;i.preventDefault();let x=fe(this.draft.config,t,h).frame,k=this.gestureCanvas(t);if(d&&h.kind==="image"&&h.payload.timestamp===!0){this.timestampActiveId=p;let E=h.payload,T=de[t],v=x.width*T.width,C=x.height*T.height,P={x:0,y:0,w:v,h:C,cx:v/2,cy:C/2},N=Gn(E,P,Bn(new Date));if(this.cancelGesture?.(),l){let S=k.width/T.width,O=E.timestampSize;this.cancelGesture=Jo(s,i,l,{w:N.w*S,h:N.h*S},(L,ne)=>{let y=Math.min(40,Math.max(4,Math.round(O*L)));this.mutate($=>{let D=$.elements.find(Z=>Z.payload.id===p);D?.kind==="image"&&(D.payload.timestampSize=y)},`ts-size-${p}`),ne&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let q={x:0,y:0,w:x.width*k.width,h:x.height*k.height},oe=Be(E)?{x:E.timestampX,y:E.timestampY}:{x:(N.x+N.w/2)/P.w,y:(N.y+N.h/2)/P.h},w=!1;this.cancelGesture=Yo(s,q,i,oe,(S,O,L)=>{L||(w=!0),w&&this.mutate(ne=>{let y=ne.elements.find($=>$.payload.id===p);y?.kind==="image"&&(y.payload.timestampX=S,y.payload.timestampY=O)},`ts-${p}`),L&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=Jn(s,k,i,{elementId:p,frame:x,handle:r??void 0},{onFrame:(E,T,v)=>{this.mutate(C=>xe(C,t,E,{frame:T}),`drag-${E}-${t}`),v&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=Ke(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(k=>[k.payload.id,fe(o,t,k).frame])),d=[...l.values()],c=Math.min(...d.map(k=>k.x)),p=Math.min(...d.map(k=>k.y)),h=Math.max(...d.map(k=>k.x+k.width)),f=Math.max(...d.map(k=>k.y+k.height)),g={x:c,y:p,width:h-c,height:f-p,rotationDegrees:0},x=k=>Math.round(k*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=Jn(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:(k,E,T)=>{let v=E.x-g.x,C=E.y-g.y;this.mutate(P=>{for(let[N,q]of l)xe(P,t,N,{frame:{...q,x:x(q.x+v),y:x(q.y+C)}})},`drag-group-${r.id}-${t}`),T&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?jo:1,s=t*o,l=i*o,d=this.canvasFamily,c=de[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(Ke(r,k).map(E=>E.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let p=this.inspect.id,h=r.elements.find(k=>k.payload.id===p);if(!h)return!1;let f=Ue(r,p);if(f?.locked)return this.nudgeMany(Ke(r,f.id).map(k=>k.payload.id),d,c,`nudge-group-${f.id}-${d}`,s,l);let g=fe(r,d,h).frame,x=xa(g,s,l,c);return(x.x!==g.x||x.y!==g.y)&&this.mutate(k=>xe(k,d,p,{frame:x}),`nudge-${p}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,c=new Map;for(let C of t){let P=l.elements.find(N=>N.payload.id===C);P&&c.set(C,fe(l,i,P).frame)}if(c.size===0)return!1;let p=[...c.values()],h=Math.min(...p.map(C=>C.x)),f=Math.min(...p.map(C=>C.y)),g=Math.max(...p.map(C=>C.x+C.width)),x=Math.max(...p.map(C=>C.y+C.height)),k={x:h,y:f,width:g-h,height:x-f,rotationDegrees:0},E=xa(k,o,s,a),T=E.x-k.x,v=E.y-k.y;return(T!==0||v!==0)&&this.mutate(C=>{for(let[P,N]of c)xe(C,i,P,{frame:{...N,x:d(N.x+T),y:d(N.y+v)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(k=>k.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=de[i],c=fe(o,i,s).frame,p=c.width*d.width,h=c.height*d.height,f=Gn(l,{x:0,y:0,w:p,h,cx:p/2,cy:h/2},Bn(new Date)),g=Be(l)?{x:l.timestampX,y:l.timestampY}:{x:p>0?(f.x+f.w/2)/p:.5,y:h>0?(f.y+f.h/2)/h:.5},x=qo(g,a,r,{w:p,h});return(x.x!==g.x||x.y!==g.y)&&this.mutate(k=>{let E=k.elements.find(T=>T.payload.id===t);E?.kind==="image"&&(E.payload.timestampX=x.x,E.payload.timestampY=x.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=Vn(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=da(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ce(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(p=>p.payload.id===r);if(!s||!l)return;let d=ce(s,l),c=fe(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Jn(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(p,h,f)=>{this.mutate(g=>{d?Ur(g,p,t,h):xe(g,t,p,{frame:h})},`tap-box-${p}-${t}`),f&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:tl(this.panelWidth,this.colLeft,this.colRight);return u`
      <header>
        ...
        <label>Watch
          <select @change=${r=>{this.selectOwner(r.target.value)}}>
            ${this.owners.map(r=>u`<option value=${r.owner_watch_id} ?selected=${r.owner_watch_id===this.ownerId}>
              ${Da(r)} (${r.complication_count})</option>`)}
          </select>
        </label>
      ...
      ${this.watchSupported?u`<div class="layout cols-${a.columns}"
          ...
          ${this.renderFooter()}`:u`<div class="card">
            <div class="banner warn"><b>Update the watch app first.</b> ${$o(this.selectedOwner?.app_version)}</div>
          ...
          </div>`}`}pickerRows(){return[...this.records.map(i=>({slot:Number(i.document?.slotIndex??0),kind:"record",record:i})),...this.occupied.map(i=>i.kind==="custom"?{slot:i.slot,kind:"locked",name:i.name||"Unnamed complication",badge:i.home||"Other home",title:`A complication on ${i.home?`the ${i.home} home`:"another home"}${i.families?.length?` (${i.families.map(V).join(", ")})`:""}. Edit it in that home's Wrist Assistant panel.`,families:i.families??[]}:{slot:i.slot,kind:"locked",name:i.name||"Unnamed preset",badge:"iPhone",title:"An iPhone preset complication. Edit it in the Wrist Assistant app on the iPhone.",families:[]})].sort((i,a)=>i.slot-a.slot)}shapeDots(t){return u`<span class="shape-dots">${Ot.map(i=>u`<span class="shape-dot ${i} ${t.includes(i)?"on":""}" title=${V(i)}></span>`)}</span>`}renderPicker(){let t=this.draft,i=this.records.find(l=>l.id===this.selectedId),a=t?t.config.name.trim()||"Untitled":"No complication",r=t?t.config.supportedFamilies:[],o=this.pickerRows(),s=this.freeSlot();return u`<div class="picker">
      ...
      ${this.pickerOpen?u`<div class="menu" role="listbox">
        ...
        ${this.hass.user?.is_admin?u`
          ...
          ${this.newShapeChooser&&s>=0?u`<div class="new-shape">
            ...
            <div class="adders">
              ${Ot.map(l=>u`<button class="small ${l==="rectangular"?"primary":""}" @click=${()=>{this.togglePicker(!1),this.createNew(l)}}>${V(l)}</button>`)}
            </div>
          </div>`:m}`:m}
      </div>`:m}
      ...
      ${this.hass.user?.is_admin?i.length===0?u`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:u`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>u`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${Da(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?m:u`<span class="mini">${pa.length} kinds · ${fn.length} presets</span>`}
      ...
      ${a?u`
          <div class="add-grid ${r?"":"lean"}">
            ${pa.map(s=>u`<button class="add" style=${`--k:${re[s]}`} ?disabled=${i} title=${`Add a blank ${Dt[s].toLowerCase()} layer`}
              @click=${()=>{let l=ze(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?u`<span class="well">${Ko(s)}</span>`:m}<span class="add-name">${z(s)}<span>${Dt[s]}</span></span></button>`)}
          </div>
          <div class="presets-l">Or start from a preset</div>
          <div class="presets">
            ${fn.map(s=>u`<button class="preset" title=${s.blurb}
              ?disabled=${t.elements.length+s.layerCount>64}
              @click=${()=>this.openPreset(s.kind)}>${s.title}</button>`)}
          </div>`:m}
      ${this.renderPresetDialog()}
    </div>`}isGroupId(t){return this.draft?.config.groups?.some(i=>i.id===t)===!0}reorderLayer(t,i,a,r=!1){t!==i&&this.mutate(o=>{let s=o.elements.filter(g=>!ce(o,g)),l=o.elements.filter(g=>ce(o,g)),d=[...s].reverse(),c=d.find(g=>g.payload.id===i);if(!c)return;let p=o.groups?.find(g=>g.id===t),h=p?d.filter(g=>g.payload.groupId===p.id):d.filter(g=>g.payload.id===t);if(h.length===0||h.includes(c))return;d=d.filter(g=>!h.includes(g));let f;if((p||r)&&c.payload.groupId!==void 0){let g=d.filter(x=>x.payload.groupId===c.payload.groupId);f=a?d.indexOf(g[0]):d.indexOf(g[g.length-1])+1}else f=d.indexOf(c)+(a?0:1);if(d.splice(f,0,...h),!p){let g=h[0],x=r?void 0:c.payload.groupId;x===void 0?delete g.payload.groupId:g.payload.groupId=x}o.elements=[...d.reverse(),...l],We(o),Lt(o)})}markDrop(t,i){return t.classList.contains(i)?!1:(this.clearDropMarks(),t.classList.add(i),!0)}clearDropMarks(){for(let t of this.renderRoot.querySelectorAll(".layer"))t.classList.remove("drop-before","drop-after","drop-into")}clearDragMarks(){this.clearDropMarks();for(let t of this.renderRoot.querySelectorAll(".layer, .group-kids"))t.classList.remove("dragging")}rowDrag(t,i){return{draggable:i?"true":"false",onStart:a=>{this.dragId=t,a.dataTransfer?.setData("text/plain",t),a.dataTransfer&&(a.dataTransfer.effectAllowed="move");let r=a.currentTarget,o=r.classList.contains("group")?r.nextElementSibling:null;window.setTimeout(()=>{this.dragId===t&&(r.classList.add("dragging"),o?.classList.contains("group-kids")&&o.classList.add("dragging"))},0)},onEnd:()=>{this.dragId=void 0,this.clearDragMarks()},onOver:a=>{if(!this.dragId||this.dragId===t)return;a.preventDefault();let r=a.currentTarget,o=r.getBoundingClientRect(),s=o.top+(r.classList.contains("drop-before")?Xe:0),l=o.bottom-(r.classList.contains("drop-after")?Xe:0);this.markDrop(r,a.clientY<(s+l)/2?"drop-before":"drop-after")},onDrop:a=>{a.preventDefault();let o=a.currentTarget.classList.contains("drop-before");this.clearDragMarks(),this.dragId&&this.reorderLayer(this.dragId,t,o),this.dragId=void 0}}}clickRow(t,i){if(i.shiftKey&&!i.metaKey&&!i.ctrlKey){this.pickRange(t);return}if(el(i)){this.togglePick(t),this.pickAnchor=t;return}this.multi=new Set,this.inspect={kind:"layer",id:t},this.pickAnchor=t}pickRange(t){let i=this.draft?.config,a=this.pickAnchor??(this.inspect.kind==="layer"?this.inspect.id:void 0);if(!i||a===void 0||a===t){this.togglePick(t);return}let r=[...i.elements].filter(l=>!ce(i,l)).reverse().map(l=>l.payload.id),o=r.indexOf(a),s=r.indexOf(t);if(o<0||s<0){this.togglePick(t);return}this.multi=new Set(r.slice(Math.min(o,s),Math.max(o,s)+1))}togglePick(t){let i=new Set(this.multi);i.size===0&&this.inspect.kind==="layer"&&this.inspect.id!==t&&i.add(this.inspect.id),i.has(t)?i.delete(t):i.add(t),this.multi=i}groupPicked(){let t=[...this.multi];if(!this.canEdit||t.length<2)return;let i;this.mutate(a=>{i=Ni(a,t)}),this.multi=new Set,i&&(this.inspect={kind:"group",id:i})}renderLayers(){let t=this.draft?.config;if(!t)return m;if(this.activeFamily==="inline")return this.renderInlineHasNoLayers();let i=this.canEdit,a=this.canvasFamily,r=(w,S)=>this.moveLayer(w,S),o=w=>{let S;this.mutate(O=>{S=Wr(O,w)}),S&&(this.inspect={kind:"layer",id:S})},s=w=>{this.mutate(S=>mt(S,w)),this.inspect.kind==="layer"&&this.inspect.id===w&&(this.inspect={kind:"general"})},l=[...t.elements].filter(w=>!ce(t,w)).reverse(),d=me(this.host()),c=new je(this.buildContext(),this.draft?.config),p=t.perFamily[this.activeFamily],h=this.inspect.kind==="family",f=`${p?.backgroundColorHex?Me(p.backgroundColorHex):"transparent"} \xB7 ${p?.borderColorHex?`${p.borderWidth} pt border`:"no border"}`,g=[...this.multi].filter(w=>t.elements.some(S=>S.payload.id===w)).length,x=na(t,this.buildContext(),this.forced)[a],k=Rp[this.thumbStep],E=Math.round(Ys*k),T=Math.round(Js*k),v=w=>x?u`<span class="thumb">${fo(x,w,{icons:this.icons,imageSizes:this.imageSizes,width:E,height:T})}</span>`:u`<span class="thumb"></span>`,C=this.layerDetail==="expanded",P=(w,S,O=!1)=>{let L=w.payload.id,ne=this.inspect.kind==="layer"&&this.inspect.id===L,y=fe(t,a,w),$=y.isHidden,D=Ce(t,L)[0],Z=pn(w.payload.rules),K=this.picking&&this.pickHoverId===L,X=this.rowDrag(L,i);return u`<div class="layer ${ne?"hl":""} ${O?"held":""} ${K?"pick":""} ${$?"dim":""} ${this.multi.has(L)?"multi":""} ${S?"kid":""} ${C?"rich":""}"
        style=${`--k:${re[w.kind]}`} tabindex="0" draggable=${X.draggable}
        @pointerenter=${()=>{this.listHoverIds=[L]}}
        @pointerleave=${()=>this.leaveRow([L])}
        @click=${B=>this.clickRow(L,B)}
        @keydown=${B=>{B.key==="Enter"&&(this.inspect={kind:"layer",id:L})}}
        ...
        <span class="name">
          <b>${Te(w,d)}</b>
          <small><span class="kind">${Dt[w.kind]}</span> · ${Pp(w,c,this.historySeries,y.size)}</small>
          ${C?u`<span class="facts">${_p(this.host(),a,w,y).map(B=>u`<span class="fact"><b>${B.label}</b> ${B.value}</span>`)}</span>`:m}
        </span>
        <span class="right">
          <span class="badges">
            ${D?u`<span class="badge tap" title=${`Tappable \xB7 ${Te(D,d)}`}>tap</span>`:m}
            ${w.payload.rules.length===0?m:u`<span class="badge states" title=${Z}>${Z.replace(/\.$/,"").toLowerCase()}</span>`}
            ${$?u`<span class="badge">hidden</span>`:m}
          </span>
          ${i?u`<span class="acts">
            <button class="icon" title=${`Bring forward (${Oe}])`} aria-label="Bring forward" @click=${B=>{B.stopPropagation(),r(L,1)}}>${z("up")}</button>
            <button class="icon" title=${`Send back (${Oe}[)`} aria-label="Send back" @click=${B=>{B.stopPropagation(),r(L,-1)}}>${z("down")}</button>
            <button class="icon" title=${`${y.isHidden?"Show":"Hide"} (${Na}${Oe}H)`} aria-label=${y.isHidden?"Show this layer":"Hide this layer"} @click=${B=>{B.stopPropagation(),this.mutate(be=>xe(be,a,L,{isHidden:!y.isHidden}))}}>${z(y.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${Oe}D)`} aria-label="Duplicate" @click=${B=>{B.stopPropagation(),o(L)}}>${z("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${B=>{B.stopPropagation(),s(L)}}>${z("delete")}</button>
          </span>`:m}
        </span>
      </div>`},N=(w,S)=>{let O=this.inspect.kind==="group"&&this.inspect.id===w.id,L=!this.collapsed.has(w.id),ne=this.rowDrag(w.id,i),y=S[0],$=S[S.length-1],D=K=>{let X=K.currentTarget,B=X.getBoundingClientRect(),be=B.top+(X.classList.contains("drop-before")?Xe:0),ui=B.bottom-(X.classList.contains("drop-after")?Xe:0),Fe=(K.clientY-be)/Math.max(1,ui-be);return Fe<.25?"drop-before":!L&&Fe>.75?"drop-after":"drop-into"},Z=S.map(K=>K.payload.id);return u`<div class="layer group ${O?"hl":""} ${C?"rich":""}" style=${`--k:${J.group}`} tabindex="0" draggable=${ne.draggable}
        @pointerenter=${()=>{this.listHoverIds=Z}}
        @pointerleave=${()=>this.leaveRow(Z)}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:w.id}}}
        @keydown=${K=>{K.key==="Enter"&&(this.inspect={kind:"group",id:w.id})}}
        @dragstart=${ne.onStart} @dragend=${ne.onEnd}
        @dragover=${K=>{!this.dragId||this.dragId===w.id||(K.preventDefault(),this.markDrop(K.currentTarget,D(K)))}}
        @drop=${K=>{K.preventDefault();let X=D(K);this.clearDragMarks();let B=this.dragId;if(this.dragId=void 0,!(!B||!y||!$)){if(X==="drop-before"){this.reorderLayer(B,y.payload.id,!0,!0);return}if(X==="drop-after"){this.reorderLayer(B,$.payload.id,!1,!0);return}this.isGroupId(B)||(this.reorderLayer(B,y.payload.id,!0),this.mutate(be=>Di(be,B,w.id)))}}}>
        <button class="chev" aria-expanded=${L?"true":"false"} title=${L?"Fold the group":"Unfold the group"}
          @click=${K=>{K.stopPropagation();let X=new Set(this.collapsed);L?X.add(w.id):X.delete(w.id),this.collapsed=X}}>${z("chevron")}</button>
        <span class="bar"></span>
        ${v(S.map(K=>K.payload.id))}
        <span class="name">
          <b>${w.name}</b>
          <small><span class="kind">Group</span> · ${S.length} layer${S.length===1?"":"s"} · ${w.locked?"moves as one":"unlocked"}</small>
          ${C?u`<span class="facts"><span class="fact"><b>Holds</b> ${S.map(K=>Te(K,d)).join(", ")}</span></span>`:m}
        </span>
        <span class="right">
          ${i?u`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${Na}${Oe}G)`} aria-label="Ungroup" @click=${K=>{K.stopPropagation(),this.mutate(X=>rn(X,w.id)),O&&(this.inspect={kind:"general"})}}>${z("ungroup")}</button>
          </span>`:m}
          <button class="icon lockbtn ${w.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${K=>{K.stopPropagation(),this.mutate(X=>{let B=X.groups?.find(be=>be.id===w.id);B&&(B.locked=!B.locked)})}}>${z(w.locked?"lock":"unlock")}</button>
        </span>
      </div>`},q=[],oe=new Set;for(let w=0;w<l.length;w++){let S=l[w],O=S.payload.groupId,L=O===void 0?void 0:t.groups?.find($=>$.id===O);if(!L){q.push(P(S,!1));continue}if(oe.has(L.id))continue;oe.add(L.id);let ne=l.filter($=>$.payload.groupId===L.id);q.push(N(L,ne));let y=this.inspect.kind==="group"&&this.inspect.id===L.id;this.collapsed.has(L.id)||q.push(u`<div class="group-kids">${ne.map($=>P($,!0,y))}</div>`)}return u`<div class="card">
      <h2 class="panel-title tools"><span class="swatch">${z("layers")}</span>Layers<span class="spacer"></span>
        ...
        <span class="tool-set">
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([w,S])=>u`
              <button class=${this.layerDetail===w?"on":""} title=${S} aria-label=${S} aria-pressed=${this.layerDetail===w?"true":"false"}
                @click=${()=>{this.layerDetail=w,this.saveListView()}}>${z(w)}</button>`)}
          </span>
          <span class="seg" role="group" aria-label="Preview size">
            ${Mp.map((w,S)=>u`
              <button class=${this.thumbStep===S?"on":""} title=${`${Xs[S]} row pictures`}
                aria-label=${`${Xs[S]} row pictures`} aria-pressed=${this.thumbStep===S?"true":"false"}
                @click=${()=>{this.thumbStep=S,this.saveListView()}}>${w}</button>`)}
          </span>
        </span>
      </h2>
      ${g>=2&&i?u`<div class="group-cta"><span>${g} layers picked</span><span class="spacer"></span>
            ...
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?u`<div class="hint">${gn}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:m}
      ...
      <div class="layer pinned ${h?"hl":""}" style=${`--k:${J.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${w=>{w.preventDefault(),this.clearDragMarks();let S=this.dragId,O=[...l].reverse().find(L=>L.payload.id!==S&&L.payload.groupId!==S);S&&O&&this.reorderLayer(S,O.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?Bs(this.presetKind):void 0,i=this.presetEntity;return u`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?m:u`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${nt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Ws,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=Ks(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return u`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return u`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=na(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return u`<div class="card canvas-card">
      <div class="canvas-bar">
        <label>Preview as
          <select @change=${o=>{this.previewCase=o.target.value}}>
            ${dn.map(o=>u`<option value=${o.label} ?selected=${o.label===a.label}>${o.label}${o.measured?"":" (estimated)"}</option>`)}
          </select>
        </label>
        <span class="hint">Layouts are made in the ${cn.label} box. Smaller cases scale it down.</span>
        <span class="spacer"></span>
      ...
      <div class="settings" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${$s(i)}</div>
      <div class="values-list">
        <div class="values-head"><span class="sub">Shared values</span>
          ${this.canEdit?u`<button class="small" @click=${()=>{let c=Es();this.mutate(p=>{p.values.push(c)}),this.inspect={kind:"data",id:c.id}}}>Add</button>`:m}
        ...
        ${s.map(c=>{let p=l.resolve({kind:{kind:"named",id:c.id}}),h=this.inspect.kind==="data"&&this.inspect.id===c.id;return u`<div class="datum ${h?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:c.id}}}>
            ...
            ${this.canEdit?u`<button class="icon danger" title="Delete value" aria-label="Delete value" @click=${f=>{f.stopPropagation(),this.mutate(g=>{g.values=g.values.filter(x=>x.id!==c.id)}),h&&(this.inspect={kind:"general"})}}>${z("delete")}</button>`:m}
          </div>`})}
        </div>`}
      </div>
      ...
      <div class="tiles">
        ${Ot.map(r=>{if(!a.includes(r))return u`<button class="tile off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${V(r)} shape`} @click=${()=>this.addShape(r)}>
              <span class="art"><span class="ghost ${r}"></span></span>
              <span class="lbl">+ Add ${V(r)}</span>
            </button>`;let s=r===this.activeFamily,l;if(r==="inline")l=this.renderInlinePreview(i.inline,!0);else{let p=i[r];l=p?ca(p,{icons:this.icons,imageSizes:this.imageSizes,slot:cn.slots[r]}):m}let d=r!=="inline"&&t.elements.every(p=>fe(t,r,p).isHidden||p.payload.isHidden)&&t.elements.length>0,c=this.canEdit&&Nt(t,r);return u`<div class="tile-wrap">
      ...
      ${i.length===0?u`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:u`<div class="chips values">
        ${i.map(r=>{let o=this.hass.states[r],s=typeof o?.attributes.friendly_name=="string"?o.attributes.friendly_name:r,l=typeof o?.attributes.unit_of_measurement=="string"?` ${o.attributes.unit_of_measurement}`:"",d=o?`${o.state}${l}`:"not in Home Assistant",c=this.testValues.get(r),h=t.elements.find(g=>_n(t,g.payload.id).some(x=>x.ref.entityId===r))?.kind??"text",f=this.editingValue===r;return u`<button class="vchip ${c!==void 0?"testing":""}" style=${`--k:${re[h]}`}
    ...
    </div>`}commitTestValue(t,i){this.editingValue=void 0;let a=i.trim(),r=new Map(this.testValues),o=this.hass.states[t]?.state;a===""||a===o?r.delete(t):r.set(t,a),this.testValues=r}currentCase(){return dn.find(t=>t.label===this.previewCase)??cn}previewSlot(t){return this.currentCase().slots[t]}crumbs(t,i){let a=this.inspect,r=t.name.trim()||"Complication",o=this.activeFamily==="inline"?"Inline":V(this.activeFamily),s=a.kind==="family"&&i===void 0?u`<span class="here" style=${`--k:${J.place}`}>${o} shape</span>`:u`<button @click=${()=>{this.inspect={kind:"family"}}} title="Edit the shape">${o}</button>`,l=m,d=m;if(i!==void 0)l=u`<span class="here" style="--k:var(--wa-accent)"><span class="kchip">Picked</span>${i} layers</span>`;else if(a.kind==="layer"){let c=t.elements.find(p=>p.payload.id===a.id);if(c){l=u`<span class="here" style=${`--k:${re[c.kind]}`}><span class="kchip">${Dt[c.kind]}</span>${Te(c,me(this.host()))}</span>`;let p=Ue(t,c.payload.id);p&&(d=u`<span class="sep">›</span><button @click=${()=>{this.inspect={kind:"group",id:p.id}}} title="Edit the group">${p.name}</button>`)}}else if(a.kind==="group"){let c=t.groups?.find(p=>p.id===a.id);c&&(l=u`<span class="here" style=${`--k:${J.group}`}><span class="kchip">Group</span>${c.name}</span>`)}else if(a.kind==="data"){let c=t.values.find(p=>p.id===a.id);c&&(l=u`<span class="here" style=${`--k:${J.complication}`}><span class="kchip">Value</span>${c.name||"(unnamed)"}</span>`)}else a.kind==="general"&&(l=u`<span class="mini">nothing selected</span>`);return u`<div class="crumbs">
      ...
      ${l===m?m:u`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=m,s=!0;if(r.kind==="layer"){let d=t.elements.find(c=>c.payload.id===r.id);if(!d)return this.inspect={kind:"general"},m;o=Ms(a,d,this.canvasFamily)}else if(r.kind==="group"){let d=t.groups?.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=As(a,d)}else if(r.kind==="data"){let d=t.values.find(c=>c.id===r.id);if(!d)return this.inspect={kind:"general"},m;s=!1,o=u`<div class="sec" data-open="true" style=${`--c:${J.complication}`}>
        ...
        <div class="sec-b">${Ss(a,d)}</div>
      </div>`}else r.kind==="family"?o=Hs(a,this.activeFamily):(s=!1,o=u`<div class="empty-insp">${z("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?u`<button class="expand" @click=${()=>{this.openSections=l?new Set([Tp(r)]):new Set(Fa)}}>${l?"One at a time":"Open all"}</button>`:m}
      </div>
      ...
      <span>${t}${i==="mixed"?u` <span class="mixed">(mixed)</span>`:m}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=me(this.host()),o=new je(this.buildContext(),this.draft?.config),s=Rs(t,a,i),l=i.length,d=[...i].reverse(),c=h=>this.mutate(f=>{for(let g of i)xe(f,a,g.payload.id,{isHidden:h})}),p=h=>this.mutate(f=>{for(let g of i){let x=f.elements.find(k=>k.payload.id===g.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&(x.payload.colorSlot.baseColorHex=h)}},"multi-colour");return u`
          ...
          <div class="picked">
            ${d.map(h=>u`<div class="row" style=${`--k:${re[h.kind]}`}>
              ...
              <span class="name">
                ...
                <b>${Te(h,r)}</b><span class="kind">${Dt[h.kind]}</span>
              </span>
            </div>`)}
          </div>
          <div class="hint">${gn}-click a layer to add it or take it out. Click one on its own to edit it alone.</div>
          <div class="adders">
            <button class="small primary" title=${`Group (${Oe}G)`} @click=${()=>this.groupPicked()}>Group them</button>
      ...
      </div>`}renderFooter(){let t=this.draft;if(!t)return m;let i=this.records.find(r=>r.id===this.selectedId),a=Fo({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return u`<details class="foot">
      <summary>
