...
watch_id, so re-runs don't collide. The integration retains those entries; the
dev HA can be reset to drop them when they accumulate.
"""
...
def iphone_key(
    ...
    r = session.post(
        ...
        json={
            ...
            "label": "pytest watch_secret_status smoke",
            "algo": "hmac-sha256",
        },
        timeout=10,
    )
