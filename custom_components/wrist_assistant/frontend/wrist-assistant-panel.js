...
`)}function Vo(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,qd(r));return{values:t,nullKeys:i}}function qd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Aa(e){let n=si(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Yd(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}var Xd=10800;function Jd(e,n){let t=e.minutes==="always"||e.minutes==="auto"&&n<=Xd;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...t?{minute:"2-digit"}:{},...e.hourCycle==="h12"?{hourCycle:"h12"}:{},...e.hourCycle==="h24"?{hourCycle:"h23"}:{}})}function Zd(e,n){if(pt(e)===void 0)return[];let t=lo(e.timeLabelCount);if(t.length===0)return[];let i=Oe(e)*60,a=Jd(e,i);return t.map(r=>({position:r,text:a.format(new Date(n-i*1e3*(1-r)))}))}function Rt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ze(e){let n=e.trim(),t=Rt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Rt(i)}function Qd(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ec(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function tc(e){let n=e.trim(),t=Rt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Rt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Rt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function nc(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function ic(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function ac(e,n,t){if(Pe(n))return e;let i=n,a=e,r=Rt(e.trim()),o=i.duration?tc(e):void 0;if(o!==void 0)a=nc(o);else if(i.relativeTime&&r!==void 0)a=ec(r);else{let s=Ze(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Qd(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=ic(a);break}return a}function Xt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Rn(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function Bo(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function rc(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function In(e,n=ut){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:oc(i.slice(a+1))})}return t}function oc(e){try{return decodeURIComponent(e)}catch{return e}}function sc(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let u=t(o.state),c=i[i.length-1];c!==void 0&&c.colorHex===u?c.end=d:i.push({start:s,end:d,colorHex:u})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Go(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function lc(e,n,t){if(e===void 0)return 0;let i=Ze(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Qe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=Bo(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Et(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=Rn(i);return n.limit>0&&a.length>n.limit?n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit):a}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ze(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let u=t.get(s);if(!u)return{min:0,max:1};let c=u.scaleFrom,h=c!==void 0&&c!==s&&t.has(c)&&!l.has(c)?o(c,new Set([...l,c])):Bo(a.get(s)??[],u);return r.set(s,h),h};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),u={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},c=this.chartEntity(l);c&&(u.entity=c),this.charts.set(s,u)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Pe(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Yd(a,t.kind.stat):void 0;i=a&&r!==void 0?no(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Ia(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return ac(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Rt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Xt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ze(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ze(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),u=d===void 0?void 0:Ze(d);if(a===void 0||l===void 0||u===void 0)return!1;let[c,h]=l<=u?[l,u]:[u,l];return a>=c&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Te[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,u={id:i.id,isHidden:o,frame:l,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,m={kind:"text",...u,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return c!==void 0&&(m.countdownEnd=c),m}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...u,symbol:this.styleText(a,"icon")??c,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let c=n.payload,h=this.styleText(a,"gaugeValue")??this.resolve(c.value),m=this.styleNumber(a,"gaugeMin")??c.minValue,g=this.styleNumber(a,"gaugeMax")??c.maxValue,v=h===void 0?void 0:Ze(h),$=this.styleColor(a,"color")??c.colorSlot.baseColorHex;c.coloring==="bands"&&c.bands.length>0&&v!==void 0&&($=ra(v,xn(c),c.bandAboveColorHex));let S=g-m;if(c.total){let C=Ze(this.resolve(c.total)??"");C!==void 0&&(S=C)}let E=Go(S,1,jn),w={kind:"gauge",...u,fraction:lc(h,m,g),style:c.style,lineWidth:c.lineWidth,colorHex:$,trackColorHex:c.trackColorHex,thresholdColorHex:c.thresholdColorHex,dotCount:E,filledCount:Go(v??0,0,E)};if(c.thresholdValue!==void 0&&g!==m){let C=(c.thresholdValue-m)/(g-m);C>=0&&C<=1&&(w.thresholdFraction=C)}return w}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),m=h.values,g={min:h.domainMin,max:h.domainMax},v=this.styleColor(a,"color")??c.colorSlot.baseColorHex,$=xn(c),S=to(c)?m.map(N=>ra(N,$,c.bandAboveColorHex)):[],E={kind:"chart",...u,values:m,style:c.style,domainMin:g.min,domainMax:g.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:v,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:S,fillBands:c.fillBands,thresholdColorHex:c.thresholdColorHex,nowColorHex:c.nowColorHex};if(m.length>0){let N=c.highlight==="highest"||c.highlight==="both",B=c.highlight==="lowest"||c.highlight==="both",q=N?m.indexOf(Math.max(...m)):-1,de=B?m.indexOf(Math.min(...m)):-1;q>=0&&(E.highIndex=q),de>=0&&de!==q&&(E.lowIndex=de)}let w=rc(c,g.min,g.max);w!==void 0&&(E.thresholdY=w);let C=this.chartNowIndex(c,m.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let c=n.payload,h=pt(c),m=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=In(m,ut),v=sc(g,Oe(c)*60,S=>uo(S,c.bands,c.otherColorHex));return{kind:"timeline",...u,runs:v,gap:c.gap,cornerRadius:c.cornerRadius,labels:Zd(c,this.nowMs()),labelSize:c.labelSize,labelColorHex:c.labelColorHex,labelsAbove:c.labelsAbove}}case"shape":{let c={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};We(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=Eo(n,t).map(v=>this.resolveElement(v,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=l??u??this.resolve(a?.bezelText);c!==void 0&&(s.bezelText=c),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let v=a.bezelGauge,$=this.resolve(v.value),S=$===void 0?void 0:Ze($);if(S!==void 0){let E=Math.min(v.minValue,v.maxValue),w=Math.max(v.minValue,v.maxValue),C={value:Math.min(w,Math.max(E,S)),minValue:E,maxValue:w===E?E+1:w,colorHexes:v.colorHexes},N=this.resolve(v.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(v.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function dc(e,n,t){let i=new Qe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function li(e,n,t){let i=new Qe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=dc(e.inline,n,e)),a}var ve=me,An=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ve,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Jt=An.find(e=>e.measured);function Zo(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return An.find(a=>a.screen.width===t&&a.screen.height===i)}function ci(e,n){let t=ve[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var cc={regular:400,medium:500,semibold:600,bold:700};function Ve(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ke(e,n,t="#FFFFFF"){let i=Ve(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Qo(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function uc(e,n){let t=ke(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Xt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=e.text;if(n.w>0&&s.length*i(o)>n.w){let l=n.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    <g transform="rotate(${u} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:hc(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function hc(e,n,t,i,a){let r=ke(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return b`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}var mc=5;function fc(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:mc,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,u=Math.max(n.h-r-o*2,1),c=d+u,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?u*.12:0,v=Math.min(Math.max(e.barGap,0),l/(i*2)),$=Math.max((l-v*(i-1))/i,.5),S=w=>Math.min(1,Math.max(0,(w-e.domainMin)/h)),E=w=>c-S(w)*u;return{count:t.length,barWidth:$,plotTop:d,plotBottom:c,plotLeft:s,plotRight:s+l,baselineY:m?c:E(0),yAtFraction(w){return c-Math.min(Math.max(w,0),1)*u},barRect(w){let C=s+w*($+v),N=t[w],B,q;if(m){let de=g+S(N)*(u-g);B=c-de,q=c}else B=E(N),q=m?c:E(0),B>q&&([B,q]=[q,B]);return{x:C,y:B,w:$,h:Math.max(q-B,.5)}},point(w){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*w/(t.length-1):s+l/2,y:E(t[w])}},markerCenter(w,C){let N=C?this.barRect(w):void 0;return{x:N?N.x+N.w/2:this.point(w).x,y:n.y+r/2}}}}function gc(e,n){if(e.values.length===0)return f;let t=fc(e,n),i=ke(e.colorHex,"fill"),a=ke(e.highColorHex,"fill",e.colorHex),r=ke(e.lowColorHex,"fill",e.colorHex),o=(u,c)=>b`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${c.fill} fill-opacity=${c["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?ke(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let c=t.barRect(u),h=u===e.highIndex?a:u===e.lowIndex?r:d(u),m=Math.min(1.2,c.w/2,c.h/2);s.push(b`<rect x=${c.x} y=${c.y} width=${c.w} height=${c.h} rx=${m}
        ...
        stroke-width=${e.lineWidth} stroke-linecap="round" stroke-linejoin="round" />`);e.highIndex!==void 0&&s.push(o(u[e.highIndex],a)),e.lowIndex!==void 0&&s.push(o(u[e.lowIndex],r))}if(e.marker!=="none"){let u=e.style==="bars";if(e.highIndex!==void 0){let c=t.markerCenter(e.highIndex,u);s.push(e.marker==="pointer"?b`<path d=${`M${c.x} ${c.y-1.8} L${c.x+2.2} ${c.y+1.8} L${c.x-2.2} ${c.y+1.8} Z`}
            fill=${a.fill} fill-opacity=${a["fill-opacity"]} />`:o(c,a))}e.lowIndex!==void 0&&s.push(o(t.markerCenter(e.lowIndex,u),r))}if(e.thresholdY!==void 0){let u=t.yAtFraction(e.thresholdY),c=ke(e.thresholdColorHex,"fill",e.colorHex);s.push(b`<path d=${`M${t.plotLeft} ${u} L${t.plotRight} ${u}`} fill="none"
      stroke=${c.fill} stroke-opacity=${c["fill-opacity"]}
      stroke-width="1" stroke-dasharray="2 2" />`)}if(e.nowIndex!==void 0&&e.nowIndex<t.count){let u=t.markerCenter(e.nowIndex,e.style==="bars").x,c=ke(e.nowColorHex,"fill",e.colorHex);s.push(b`<path d=${`M${u} ${t.plotTop} L${u} ${t.plotBottom}`} fill="none"
      stroke=${c.fill} stroke-opacity=${c["fill-opacity"]} stroke-width="1" />`)}return b`${s}`}var La=1;function yc(e,n){if(e.runs.length===0&&e.labels.length===0||n.w<=0||n.h<=0)return f;let t=Math.max(Sn,Math.min(En,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-La>=2,r=a?{...n,y:e.labelsAbove?n.y+i+La:n.y,h:n.h-i-La}:n,o=Math.max(0,Math.min(e.gap,n.w/Math.max(1,e.runs.length))),s=e.runs.map((c,h)=>{let m=n.x+c.start*n.w,g=(c.end-c.start)*n.w,v=h===e.runs.length-1,$=Math.max(v?g:Math.min(g,.5),g-(v?0:o)),S=Math.max(0,Math.min(e.cornerRadius,$/2,r.h/2)),E=ke(c.colorHex,"fill");return b`<rect x=${m} y=${r.y} width=${$} height=${r.h} rx=${S}
      fill=${E.fill} fill-opacity=${E["fill-opacity"]} />`});if(!a)return b`${s}`;let l=(e.labelsAbove?n.y:n.y+n.h-i)+i/2,d=ke(e.labelColorHex,"fill"),u=e.labels.map((c,h)=>{let g=h===e.labels.length-1?"end":h===0?"start":"middle",v=n.x+c.position*n.w;return b`<text x=${v} y=${l} text-anchor=${g} dominant-baseline="central"
      font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
      font-size=${t} font-weight="400"
      fill=${d.fill} fill-opacity=${d["fill-opacity"]}>${c.text}</text>`});return b`${s}${u}`}function bc(e,n){let t=ke(e.fillColorHex,"fill"),i=e.borderColorHex?Ve(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return b`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function vc(e,n,t){let i=t.render(e.symbol,e.size,e.colorHex);if(i)return b`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=ke(e.colorHex,"stroke"),r=e.size;return b`
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Da=.25,wc=8;function xc(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Da),wc),u=Math.max(e/t,n/i),c=Math.min(e/t,n/i),h=(a==="fit"?c:u)*d,m=t*h,g=i*h,v=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),$=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+v)+0,y:-(g-n)/2*(1+$)+0,width:m,height:g}}function ui(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var di=4;function pi(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+di:n.x+n.w-di-a,d=e.timestampCorner.startsWith("top")?n.y+di:n.y+n.h-di-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,u,c)=>c>=u?d+(u-c)/2:Math.min(d+u-c,Math.max(d,l-c/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function kc(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function $c(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?pi(e,n,ui(new Date)):void 0,s=o?b`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([h,m,g])=>b`<rect data-ts-corner=${h} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${h}-resize" />`)}`:f,u=e.url?t.imageSizes?.size(e.url):void 0,c;if(e.url&&u){let h=xc(n.w,n.h,u.width,u.height,e.contentMode,e.zoom,e.panX,e.panY);c=b`<image href=${e.url} x=${n.x+h.x} y=${n.y+h.y} width=${h.width} height=${h.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(kc(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return b`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${c}${s}</g>${d}`}function Cc(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Sc(a,n):void 0;return b`
    ...
    ${o!==void 0?b`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${za} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?b`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var za=5;function Sc(e,n){let t=za*.55,i=n.w-2;if(n.h<za*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Na(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=Qo(e,n),d=i&&(!s||o),u;switch(e.kind){case"text":u=uc(e,l);break;case"icon":u=vc(e,l,t.icons);break;case"gauge":u=pc(e,l);break;case"chart":u=gc(e,l);break;case"timeline":u=yc(e,l);break;case"shape":u=bc(e,l);break;case"image":u=$c(e,l,t);break;case"tap":u=Cc(e,l,t.icons,a,d?je(e.action):void 0);break}let c=i&&(e.kind!=="tap"||s&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*c,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,v=t.handles===!0&&(!s||o),$=g?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,S=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?b`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${u}${S}${$}${C}</g>`}function hi(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Va(e,n){return(n?23.5:34)*e}var Uo=10.5;function es(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Ko(e,n){let t=0;for(let i of e)t+=es(i,n);return t}function Wo(e,n,t){let i=e.toUpperCase(),a=d=>es(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Oa(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Pa(e,n,t,i){let a=Oa(e,n,t),r=Oa(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function ts(e,n,t,i){let{dial:a}=hi(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Pa(a,t,i.start,i.end),length:t*r}}function Ec(e,n){let t=hi(e,!0);return ts(e,n,t.dial.r,t.labelArc)}var jo=18.5,Tc=113,Fc={start:-71,end:-36},qo=104,Mc=6.2,Yo={start:-77,end:-30.5};function Xo(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Jo(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Xo(e[i]),o=Xo(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var _a=11;function Rc(e,n,t){let{dial:i}=hi(n,!0),a=qo*n,r=180/(Math.PI*qo),o=e.minLabel!==void 0?Ko(e.minLabel,_a)*r:0,s=e.maxLabel!==void 0?Ko(e.maxLabel,_a)*r:0,l=Yo.start+(o>0?Math.max(0,o-1.8):0),d=Yo.end-(s>0?Math.max(0,s-1.8):0),u=d-l,c=24,h=[];for(let S=0;S<c;S++){let E=l+u*S/c,w=Math.min(d,l+u*(S+1)/c+.4);h.push(b`<path d=${Pa(i,a,E,w)} fill="none"
      stroke=${Jo(e.colorHexes,(S+.5)/c)} stroke-width=${Mc*n}
      stroke-linecap=${S===0||S===c-1?"round":"butt"} />`)}let m=(e.value-e.minValue)/(e.maxValue-e.minValue),g=Oa(i,a,l+u*m),v=1.5,$=(S,E,w,C)=>b`
    <defs><path id=${S} d=${Pa(i,a,E,w)} /></defs>
    <text font-size=${_a*n} font-weight="600" fill="#FFFFFF"
    ...
    ${e.maxLabel!==void 0?$(`${t}-gmax`,d+v,d+v+Math.max(s,3),e.maxLabel):f}`}function mi(e,n){let t=e.family in ve?e.family:"rectangular",i=n.slot??ve[t],a=ve[t],r=ci(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ve(e.backgroundColorHex),l=Ve(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let g=r.scale,v=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",E=hi(g,v),w=Va(g,v),C=w/(a.width*g),N=E.tile.cx-w/2,B=E.tile.cy-w/2,q=`M 0 0 H ${E.quad.width-E.cornerRadius} A ${E.cornerRadius} ${E.cornerRadius} 0 0 1 ${E.quad.width} ${E.cornerRadius} V ${E.quad.height} H 0 Z`,de=f;if(e.bezelGauge)de=Rc(e.bezelGauge,g,o);else if(e.bezelText){let F=Ec(g,`${o}-bezel`),V=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Xt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;de=b`<defs><path id=${F.id} d=${F.d} /></defs>
        <text font-size=${Uo*g} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${F.id}" startOffset="50%" text-anchor="middle">${Wo(V,F.length,Uo*g)}</textPath></text>`}let x=f;if(S){let F=Ve(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},V=ts(g,`${o}-curved`,Tc*g,Fc);x=b`<defs><path id=${V.id} d=${V.d} /></defs>
        <text font-size=${jo*g} font-weight="600" fill=${F.color} fill-opacity=${F.opacity}
          ...
          <textPath href="#${V.id}" startOffset="50%" text-anchor="middle">${Wo($,V.length,jo*g*.88)}</textPath></text>`}else{let F=e.borderWidth*r.scale*C,V=l?b`<circle cx=${w/2} cy=${w/2} r=${w/2-F/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${F} />`:f;x=b`<g transform="translate(${N} ${B})">
        <g clip-path=${`url(#${o})`}>
          ${s?b`<rect width=${w} height=${w} fill=${s.color} fill-opacity=${s.opacity} />`:f}
          <g data-design-box transform="scale(${r.scale*C})">
            ${e.elements.map(O=>Na(O,a,n))}
          </g>
        </g>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${jc(e)}</svg>`}var Be="color-mix(in srgb, var(--k) 45%, #6b7280)",ki='system-ui, -apple-system, "Segoe UI", sans-serif';function Ms(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=u=>{let c=u*Math.PI/180;return{x:(e-t*Math.cos(c)).toFixed(2),y:(n-t*Math.sin(c)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Ja(e,n,t,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${Ms(e,n,t,1)} stroke=${Be} stroke-width="2.6" opacity=".5" />
    <path d=${Ms(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function qc(e){switch(e){case"text":return b`<g font-family=${ki} text-anchor="middle">
        ...
        <text x="6" y="39" font-family=${ki} font-size="7" fill=${Be}>1h ago</text>
        <text x="114" y="39" font-family=${ki} font-size="7" text-anchor="end" fill=${Be}>now</text>
    ...
    <textarea rows=${i} .value=${n} class="mono" @input=${we(t)}></textarea></label>`}function ne(e,n,t,i={}){let a=n===void 0||Number.isNaN(n)?"":String(n),r=p`<input type="number" .value=${a} step=${i.step??"any"} min=${i.min??f} max=${i.max??f}
      @input=${we(o=>{if(o.trim()===""){i.optional&&t(void 0);return}let s=Number(o);Number.isNaN(s)||t(s)})} />`;return p`<label class="field">${nt(e,nn(n,i.def,t))}${r}</label>`}function Me(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return p`<label class="field">${nt(e,nn(n,a.def,i,r))}
    ...
    </div></div>`}function _n(e,n,t,i){let a=i.format??(r=>String(Math.round(r*100)/100));return p`<div class="field slider">${nt(e,nn(n,i.def,t,a))}
    ...
    </div></div>`}function Ci(e,n,t,i,a,r){let o=s=>Math.round(s*1e3)/10;return ne(e,o(n),s=>t((s??0)/100),{min:a,max:r,step:.5,def:o(i)})}function Re(e,n,t,i){return p`<label class="field check"><input type="checkbox" .checked=${n} @change=${a=>t(a.target.checked)} />${nt(e,nn(n,i,t,a=>a?"on":"off"))}</label>`}function re(e,n,t,i=!1,a){let r=(n??"").replace(/^#/,""),o=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(r),s=o?`#${r.slice(0,6)}`:"#ffffff",l=o&&r.length===8?Math.round(parseInt(r.slice(6,8),16)/255*100):100,d=(c,h)=>{let m=c.replace(/^#/,"").toUpperCase();return h>=100?`#${m}`:`#${m}${Math.round(h/100*255).toString(16).padStart(2,"0").toUpperCase()}`},u=a===void 0?void 0:{atDefault:Zc(n,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>t(a??void 0)};return p`<div class="field color">${nt(e,u)}
    <div class="color-row">
      ${i?p`<input type="checkbox" title="Enabled" .checked=${n!==void 0} @change=${c=>t(c.target.checked?d(s,l):void 0)} />`:f}
      <input type="color" .value=${s} ?disabled=${i&&n===void 0} @input=${we(c=>t(d(c,l)))} />
      <input type="range" min="0" max="100" .value=${String(l)} title="Opacity" ?disabled=${i&&n===void 0} @input=${we(c=>t(d(s,Number(c))))} />
      <input type="text" class="mono hex" .value=${n??""} placeholder="#RRGGBB" ?disabled=${i&&n===void 0}
        @input=${we(c=>{let h=c.trim();/^#?[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(h)&&t(h.startsWith("#")?h.toUpperCase():`#${h.toUpperCase()}`)})} />
    </div></div>`}function Zc(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function il(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Qc(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function zs(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var al=50;function eu(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function tu(e,n,t=al,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),u=l.name.toLowerCase(),c=(l.area??"").toLowerCase(),h=-1;d===a?h=0:d.startsWith(a)?h=1:u.startsWith(a)?h=2:d.includes(a)?h=3:u.includes(a)?h=4:o.length>1&&o.every(m=>d.includes(m)||u.includes(m))?h=5:c!==""&&(c.includes(a)||o.length>1&&o.every(m=>d.includes(m)||u.includes(m)||c.includes(m)))&&(h=6),h>=0&&s.push({c:l,rank:h})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var nu=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function rl(e){return nu.test(e.trim())}function iu(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return il(t,i);if(rl(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var Lt=new Map;function Ae(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function ol(e){return Lt.has(e)}function tt(e,n,t,i,a,r={}){let o=e.hass.states,s=Lt.get(a),l=s?tu(Qc(o,r.domain,zs(e.hass)),s.query,al,r.preferNumeric?eu:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,u=t.entityId?o[t.entityId]:void 0,c=(w,C,N=0)=>{Lt.set(a,{query:C,index:N}),Ae(w)},h=w=>{Lt.delete(a),Ae(w)},m=w=>{let C=iu(w,t,o);C&&i(C)},g=(w,C)=>{i(il(o,w.entityId)),h(C)},v=()=>Math.max(0,Math.min(Lt.get(a)?.index??0,l.length-1)),$=w=>{let C=w.target;if(w.key==="ArrowDown"||w.key==="ArrowUp"){w.preventDefault();let N=Lt.get(a);if(!N){c(C,C.value);return}let B=w.key==="ArrowDown"?v()+1:v()-1;c(C,N.query,Math.max(0,Math.min(l.length-1,B))),au(C);return}if(w.key==="Enter"){w.preventDefault();let N=l[v()];s&&N?g(N,C):(m(C.value),h(C));return}if(w.key==="Escape"){if(!s)return;w.preventDefault(),w.stopPropagation(),h(C)}},S=t.entityId?zs(e.hass)?.(t.entityId):void 0,E=t.entityId===""?p`<div class="hint">Type part of a name, a room, or an id.</div>`:u?p`<div class="entity-current">
          <span class="ent-ico ${nr(u.state)?"on":""}">${tr(t.domain||t.entityId.split(".")[0]||"")}</span>
    ...
    <div class="ent-box ${s?"open":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:p`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${w=>{let C=w.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),Lt.set(a,{query:"",index:0}),Ae(C),C?.focus()}}>${_("close")}</button>`}
    </div>
    ${s?p`<div class="entity-results" role="listbox">
          ${l.length===0?p`<div class="hint" style="padding:6px 8px">${rl(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((w,C)=>p`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                @mousedown=${N=>N.preventDefault()} @click=${N=>g(w,N.target)}>
                <span class="ent-ico ${nr(w.state)?"on":""}">${tr(w.domain)}</span>
                <span class="ent-main">
  ...
  </div>`}function au(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var ru=120;function ou(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(bi.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(vi),fromPack:!1}}function Ns(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function su(e){return[{value:"",label:`Starter set (${Ns(vi,e)})`},...bi.map(n=>({value:n.name,label:`${n.name} (${Ns(n.symbols,e)})`}))]}function lu(e){return e.length>0?e.length:vi.length}function du(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Os(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return p`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??p`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function sl(e,n,t,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),s=e.icons.names(),l=s??[],d=new Set(l),u=n.trim(),c=u!==""&&d.size>0&&!d.has(u),h=g=>{t(g),a.noteUsed(g)},m=f;if(r){let g=a.category(i),v=ou(g,o,l,d),$=hs(v.names,o),S=v.fromPack?$.slice(0,ru):$,E=d.size===0?a.recent:a.recent.filter(w=>d.has(w));m=p`<div class="sym-browse">
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${o} @input=${we(w=>a.setQuery(i,w))} />
        <select @change=${we(w=>a.setCategory(i,w))}>
          ${su(d).map(w=>p`<option value=${w.value} ?selected=${w.value===g}>${w.label}</option>`)}
        </select>
      </div>
      ...
      ${$.length===0?p`<div class="hint">Nothing matches that search. Any name can still be typed above.</div>`:p`<div class="hint">
            ${du(S.length,$.length,o.trim()!=="",lu(l))}
          </div>`}
    ...
    ${m}`}var cu=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Entity age (seconds)"],["aggregate","Aggregate"],["time","Time"],["dataAge","Data age (seconds)"],["jinja","Jinja template"],["named","Named value"],["chartStat","A chart's number"]],uu=[["bars","Bars"],["line","Line"],["area","Area"]],pu=[["auto","Auto"],["fixed","Fixed range"]],hu=[["lowest","Lowest value"],["zero","Zero"]],ll=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],mu=[["none","None"],["pointer","Triangle & dot"],["dot","Dots"]],Ps=[["uniform","One colour"],["bands","By value"]];function Ds(e){let n=[aa,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:J(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:J(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function fu(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function gu(e,n){let t=xn({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:J(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Vs(e,n,t){return p`
    ${e.bands.map((i,a)=>p`
    ...
    ${re("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??ct},"tother"),!1,ct)}`}var vu=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],wu={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function Bs(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return R(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var xu=[["now","Now (HH:mm)"],["hour","Hour"],["minute","Minute"],["weekday","Weekday"],["day","Day"],["month","Month"],["timestamp","Unix timestamp"]];function ku(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function oe(e,n,t,i){if(i.inline||!$u())return p`<div class="value-editor">${ul(e,n,t,i)}</div>`;let a=sr(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=ge(n,ye(e)),l="entityId"in n.kind;return p`<div class="field value-chip-field ${i.compact?"compact":""}">
    ...
    ${dl(e,a,r,n,t,i)}
  </div>`}function dl(e,n,t,i,a,r){return p`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${cl}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${zn.has(n)?ul(e,i,a,r):f}
  </div>`}function ye(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function sr(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function $u(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var zn=new Set,Ln=new WeakMap;function Cu(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function Su(e,n){let t=e instanceof Node?e:null;if(!t)return;let i=t.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(n)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function cl(e){let n=e.currentTarget,t=e.newState==="open",i=Ln.get(n);if(i&&(i(),Ln.delete(n)),!t){zn.delete(n.id)&&Ae(n);return}let a=Cu(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){Ln.get(n)?.(),Ln.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}ir(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),Ln.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),ir(n,a.getBoundingClientRect()),zn.has(n.id)||(zn.add(n.id),Ae(n),requestAnimationFrame(()=>{n.isConnected&&ir(n,a.getBoundingClientRect())}))}function ir(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=Eu({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var Ht=8,Si=6,Gs=140;function Eu(e,n,t){let i=t.height-e.bottom-Si-Ht,a=e.top-Si-Ht,r=n.height>i&&a>i&&i<Gs,o=Math.max(Gs,r?a:i),s=Math.min(n.height,o),l=Math.max(Ht,Math.min(e.left,t.width-n.width-Ht)),d=r?Math.max(Ht,e.top-Si-s):Math.max(Ht,Math.min(e.bottom+Si,t.height-s-Ht));return{left:l,top:d,maxHeight:o,above:r}}function ul(e,n,t,i){let a=n.kind,r=u=>t({...n,kind:u}),o=i.key,s=cu.filter(([u])=>i.allowNamed!==!1||u!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?sl(e,a.value,u=>r({...a,value:u}),o):he("Text",a.value,u=>r({...a,value:u}));break;case"entityState":case"entityAge":l=tt(e,"Entity",a,u=>r({...a,...u}),`${o}-entity`);break;case"entityAttribute":{let u=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),c=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=p`${tt(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
        ${he("Attribute",a.attribute,h=>r({...a,attribute:h}),{list:c,mono:!0})}
        <datalist id=${c}>${u.map(h=>p`<option value=${h}></option>`)}</datalist>`;break}case"aggregate":l=Fu(e,a.aggregate,u=>r({...a,aggregate:u}),o);break;case"time":l=Me("Field",a.timeField,xu,u=>r({...a,timeField:u}));break;case"dataAge":l=p`<div class="hint">Seconds since the watch last fetched values.</div>`;break;case"jinja":l=p`${nl("Template",a.value,u=>r({...a,value:u}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":l=e.config.values.length===0?p`<div class="hint warn">There are no named values yet. Add one in the Data card first.</div>`:Me("Value",a.id,[["","(choose)"],...e.config.values.map(u=>[u.id,u.name||u.id.slice(0,8)])],u=>r({...a,id:u}));break;case"chartStat":{let u=ye(e),c=e.config.elements.filter(h=>h.kind==="chart");l=c.length===0?p`<div class="hint warn">There is no chart layer yet. Add one first, then this can print one of its numbers.</div>`:p`
          ${Me("Chart",a.layer,[["","(choose)"],...c.map(h=>[h.payload.id,Ie(h,u)])],h=>r({...a,layer:h}))}
          ${Me("Number",a.stat,[...Vt],h=>r({...a,stat:h}))}
    ...
    ${Me("Source",a.kind,s,u=>r(ku(a,u)))}
    ${l}
    ${i.noFormat?f:Tu(n.format,u=>t(Pe(u)?{kind:n.kind}:{...n,format:u}))}
    ${i.showResolved?p`<div class="hint">Now: ${d===void 0?p`<span class="warn">unresolved</span>`:p`<code>${d}</code>`}</div>`:f}`}function Tu(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return p`<details class="sub" ?open=${!Pe(e)}>
    ...
    ${Re("Append the entity's unit",!!t.useEntityUnit,a=>i({useEntityUnit:a}))}
  ...
  </details>`}function Fu(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return p`
    ...
    ${n.function==="count"?f:he("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var pl=ya,Mu=pl.filter(([e])=>e!=="none");function Ru(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function hl(e,n){let t=Ru(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return ho(e)?{type:e,...t}:{type:e}}var Iu=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function ml(e,n,t,i){let a=n.serviceDataJSON??"",r=mo(a),o=n.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?p`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??Hu).slice(0,7)}
    ...
    ${t.type==="callService"?ml(e,t,(s,l)=>e.update(d=>{d.tapAction=s},l),"general-tap"):f}
    ${t.type==="openPage"?Lu(e):f}`}var Hu="#808080",Us=[0,15,30,60,120];function Ks(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function Lu(e){let n=e.config;return gl(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function gl(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?p`<div class="hint">No pages reported yet. Open the watch app once so it can send its page list.</div>`:p`${Me("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function yl(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return p`
    ...
    <div class="hint">Used by ${Ws(e.config,n.id)} layer${Ws(e.config,n.id)===1?"":"s"}.</div>`}function Ws(e,n){return JSON.stringify(e.elements).split(`"${n}"`).length-1+JSON.stringify(e.perFamily).split(`"${n}"`).length-1}function bl(){return{id:J(),name:"Value",value:R("")}}function Ee(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function $e(e,n,t,i,a=!1){let r=e.elements.find(u=>u.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=Ee(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function Ei(e,n,t,i,a){let r=n.payload.id,o=ti(n)??a.min,s=Ee(e.config,t,n).size??o;return ne(`${i} (pt)`,s,l=>e.update(d=>$e(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,...a.def===void 0?{}:{def:a.def}})}function vl(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=Xe()),a=De(e,n).filter(l=>!le(e,l));if(a.length===0)return;let r=qt(e,a.map(l=>l.payload.id),n),o=St(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let u=s?.placements[l],c=u?.size??ti(d),h={frame:{...u?.frame??d.payload.frame},isHidden:u?.isHidden??!1,...c!==void 0?{size:c}:{}};for(let m of te)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=xa(h,n,t,d.kind)}Yt(e,t)}function _i(e,n){return Ho(e,n)}function _u(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function zu(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"?void 0:e.payload.colorSlot.baseColorHex}function wl(e,n,t){let i=_u(t.map(l=>Ee(e,n,l).isHidden)),a=t.map(zu),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var lr=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]];function Nu(e,n,t){let i=n.payload.id,a=ai(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s=o?{domain:"camera"}:{},l=d=>{let u=e.hass.states[d]?.attributes?.device_class;return typeof u=="string"?u:void 0};return p`
    ${tt(e,o?"Camera":"Entity",r,d=>e.update(u=>Lo(u,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint">${Du(n,a)}</div>`}function Ou(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function Pu(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Du(e,n){let t=Ou(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a named value, so change that value in the Data card to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${Pu(o)}.${r}`}function Vu(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function Bu(e,n){let t=e.timestamp===!0,i=We(e),a=r=>n(o=>{r?(o.timestampX=o.timestampCorner.endsWith("Leading")?.16:.84,o.timestampY=o.timestampCorner.startsWith("top")?.16:.84):(We(o)&&(o.timestampCorner=fa(o.timestampX,o.timestampY)),delete o.timestampX,delete o.timestampY)});return p`
    ${Re("Show timestamp",t,r=>n(o=>{r?o.timestamp=!0:delete o.timestamp}),!1)}
    ${t?p`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:f}`}function Ii(e,n){if(e===n)return!0;if(typeof e!=typeof n||e===null||n===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(n))return!1;if(Array.isArray(e))return e.length===n.length&&e.every((a,r)=>Ii(a,n[r]));let t=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(n).filter(a=>n[a]!==void 0);return t.length!==i.length?!1:t.every(a=>Ii(e[a],n[a]))}function js(e,n,t){return t.some(i=>!Ii(e[i],n[i]))}function qs(e,n,t){let i=e,a=n;for(let r of t)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Se(e,n,t,i,a={}){let r=a.alwaysOpen===!0,o=r||e.openSections.has(n),s=()=>e.toggleSection(n),l=p`<span class="swatch">${_(a.icon??"content")}</span>
      <span class="tt"><h4>${t}${tl(a.reset===void 0?void 0:{atDefault:!1,title:a.resetTitle??`Put ${t} back to its defaults`,reset:a.reset})}</h4>${a.summary?p`<span class="sum">${a.summary}</span>`:f}</span>`;return p`<section class="sec ${a.cardClass??""}" data-open=${o?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
  ...
  </section>`}function Gu(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Uu(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Ku(e,n){let t=me[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Wu(e,n,t){let i=Ku(e,n),a=me[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return p`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function ju(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function qu(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),u=i[i.length-1];u!==void 0&&u.state.trim().toLowerCase()===s.state.trim().toLowerCase()?u.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Uu(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function Ai(e){let n=qn.find(o=>o.minutes===e);if(n)return n.label;let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=[];return t>0&&r.push(`${t}d`),i>0&&r.push(`${i}h`),(a>0||r.length===0)&&r.push(`${a}m`),`Last ${r.join(" ")}`}var Ri=new Set;function ar(e,n){return Ri.has(e)||!qn.some(t=>t.minutes===n)}function Ys(e,n,t,i){let a=ar(e,n);return p`<label class="field">${nt("Span",{atDefault:n===t&&!a,title:`Back to ${Ai(t)}`,reset:()=>{Ri.delete(e),i(t)}})}
      <select @change=${r=>{let o=r.target.value;o==="custom"?(Ri.add(e),Ae(r.target)):(Ri.delete(e),i(Number(o)||Yn))}}>
        ${qn.map(({minutes:r,label:o})=>p`<option value=${String(r)} ?selected=${!a&&r===n}>${o}</option>`)}
        <option value="custom" ?selected=${a}>Custom…</option>
      </select></label>`}function Xs(e,n){let t=Math.floor(e/1440),i=Math.floor(e%1440/60),a=e%60,r=(o,s,l)=>n(Math.min(oa,Math.max(1,Math.round(o)*1440+Math.round(s)*60+Math.round(l))));return p`<div class="grid3 span-parts">
    ...
    <div class="hint">${Ai(e)}, up to 7 days: the recorder keeps
      ten by default, and a longer span would quietly come back short.</div>`}function dr(e,n){let t=ye(e);switch(n.kind){case"text":return ft(ge(n.payload.value,t),48);case"icon":return ft(ge(n.payload.symbol,t),48);case"gauge":return ft(ge(n.payload.value,t),48);case"chart":return ft(`${ge(n.payload.value,t)}${n.payload.historyMinutes>0?` \xB7 ${Ai(n.payload.historyMinutes)}`:""}`,48);case"timeline":return ft(`${ge(n.payload.value,t)} \xB7 ${Ai(Oe(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return je(n.payload.action)}}function Hi(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Ce(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":Ce(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:Ce(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${ll.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${Ce(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Ce(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Ce(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function cr(e,n,t,i={}){let a=n.payload.id,r=`el-${a}`,o=Ee(e.config,t,n),s=o.frame,l=(u,c)=>e.update(h=>$e(h,t,a,{frame:Za(s,u)}),`${r}-${c}-${t}`),d=!Ii(s,Ke)||o.isHidden;return Se(e,"placement","Place",p`
    <div class="grid4">
      ${Ci("Left",s.x,u=>l({x:u},"x"),Ke.x,-100,100)}
      ${Ci("Top",s.y,u=>l({y:u},"y"),Ke.y,-100,100)}
      ${Ci("Width",s.width,u=>l({width:u},"w"),Ke.width,4,200)}
      ${Ci("Height",s.height,u=>l({height:u},"h"),Ke.height,4,200)}
    </div>
    ${_n("Rotation",s.rotationDegrees,u=>l({rotationDegrees:u},"rot"),{min:-180,max:180,step:1,def:0,format:u=>`${Math.round(u)}\xB0`})}
    ${Re("Hidden",o.isHidden,u=>e.update(c=>$e(c,t,a,{isHidden:u})),!1)}
    <div class="hint">On the ${Z(t)} shape only. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:ee.place,icon:"place",summary:`${Math.round(s.width*100)}% wide \xB7 ${Z(t)}`,...i.inline?{alwaysOpen:!0,cardClass:"place-bar",bodyClass:"place-row"}:{},...d?{resetTitle:`Put this layer back to the middle of the ${Z(t)} face at half size, unrotated and shown`,reset:()=>e.update(u=>$e(u,t,a,{frame:{...Ke},isHidden:!1}))}:{}})}function xl(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,k)=>e.update(Y=>y(Y.elements[r]),k?`${o}-${k}`:void 0),l=Ee(e.config,t,n),d=l.frame,u=(y,k)=>e.update(Y=>$e(Y,t,a,{frame:Za(d,y)}),`${o}-${k}-${t}`),c=Ne(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",m=y=>c[y],g,v;switch(n.kind){case"text":{let y=ba(e.config,n.payload.value);g=p`
        ${oe(e,n.payload.value,k=>s(Y=>{Y.payload.value=k},"value"),{showResolved:!0,label:"Text",key:`${o}-value`})}
        ...
        ${Re("Live countdown",n.payload.countdown===!0,k=>s(Y=>{let G=Y.payload;k?G.countdown=!0:delete G.countdown}),c.countdown===!0)}
        ${n.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:f}`,v=p`<div class="grid2">
          ${Ei(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
          ${ie("Weight",n.payload.fontWeight,lr,k=>s(Y=>{Y.payload.fontWeight=k}),{def:c.fontWeight})}
        </div>`;break}case"icon":g=p`
        ${oe(e,n.payload.symbol,y=>s(k=>{k.payload.symbol=y},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${o}-symbol`})}
        <div class="hint">An entity source draws that entity's own icon instead.</div>`,v=Ei(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let y=n.payload,k=(G,L)=>s(D=>G(D.payload),L),Y=y.style==="dots";g=p`
        ${oe(e,y.value,G=>k(L=>{L.value=G},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${Y?p`
            ${oe(e,y.total??Bs(y),G=>k(L=>{L.total=G},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
        ...
        <div class="grid2">
          ${ie("Style",y.style,vu,G=>k(L=>{G==="dots"&&L.total===void 0&&(L.total=Bs(L)),G!=="dots"&&delete L.total,L.style=G}),{titles:wu,def:c.style})}
          ${Y?f:Ei(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${re(Y?"Empty dot colour":"Track colour",y.trackColorHex,G=>k(L=>{L.trackColorHex=G??"#FFFFFF40"},"track"),!1,c.trackColorHex)}
        ${ie("Colour",y.coloring,Ps,G=>k(L=>{L.coloring=G,G==="bands"&&L.bands.length===0&&(L.bands=Ds([L.minValue,L.maxValue]))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Vs(y,y.colorSlot.baseColorHex,k)}`:f}
        ${Y?f:p`
          <div class="grid2">
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=n.payload,k=(M,A)=>s(Vi=>M(Vi.payload),A),Y=Et(y),G=c.historyMinutes,L=c.historyPoints,D=y.historyMinutes>0,P=y.value.kind.kind==="entityState",se=Y===void 0?void 0:e.historySeries(Y),rn=D&&P?se??"":e.resolve(y.value)??"",xe=y.historyPoints<1,on=ar(a,y.historyMinutes),W=Rn(rn),Q=y.limit>0&&W.length>y.limit?y.takeFromEnd?W.slice(W.length-y.limit):W.slice(0,y.limit):W,Oi=!D&&P&&W.length===1,Pi=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),ql=ye(e),Di=y.scaleFrom!==void 0&&Pi.some(M=>M.payload.id===y.scaleFrom);g=p`
        ${oe(e,y.value,M=>k(A=>{A.value=M},"value"),{label:"Readings",key:`${o}-value`})}
        ...
        ${D?p`
            ${P?f:p`<div class="hint warn">History needs an entity.
            ...
            <div class="grid2">
              ${Ys(a,y.historyMinutes,G,M=>k(A=>{A.historyMinutes=M}))}
                ...
                <div class="readings-row">
                  <div class="seg wide" role="radiogroup" aria-label="Readings">
                    ...
                    <button type="button" role="radio" aria-checked=${xe?"true":"false"} class=${xe?"on":""}
                      ...
                      @click=${()=>{xe||k(M=>{M.historyPoints=la})}}>Every one</button>
                  </div>
                  ${xe?f:p`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    step="1" min=${sa} max=${Xn}
                    @input=${we(M=>{let A=Number(M);M.trim()!==""&&Number.isFinite(A)&&A>=1&&k(Vi=>{Vi.historyPoints=Math.round(A)},"hpoints")})} />`}
                </div>
              </div>
            </div>
            ${on?Xs(y.historyMinutes,M=>k(A=>{A.historyMinutes=M},"span")):f}
            ...
            ${P&&se===void 0?p`<div class="hint">Reading the history…</div>`:f}
            ${P&&se===""?p`<div class="hint warn">Nothing recorded for this entity in that span.
        ...
        ${W.length===0&&!(D&&(!P||se===void 0||se===""))?p`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:f}
        ${W.length>0?p`<div class="hint">Reads <span class="nums">${Gu(Q)}</span>${W.length===Q.length?p` · ${Q.length} ${Q.length===1?"value":"values"}`:p` · ${Q.length} of ${W.length}`}</div>`:f}
        ${Oi?p`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        <div class="hint">${D?"Trims the series after it arrives, so 0 draws every reading fetched above.":"A forecast sensor often carries 24 or 48 entries. 0 draws all of them."}</div>`,v=p`
        <div class="grid2">
          ${ie("Style",y.style,uu,M=>k(A=>{A.style=M}),{def:c.style})}
          ${y.style==="bars"?ne("Bar gap (pt)",y.barGap,M=>k(A=>{A.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:c.barGap}):Ei(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${ie("Scale",y.scale,pu,M=>k(A=>{A.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ie("Baseline",y.baseline,hu,M=>k(A=>{A.baseline=M}),{def:c.baseline})}
        </div>
        ${Pi.length===0?f:Me("Same scale as",Di?y.scaleFrom:"",[["","Its own"],...Pi.map(M=>[M.payload.id,Ie(M,ql)])],M=>k(A=>{M?A.scaleFrom=M:delete A.scaleFrom}),{def:""})}
        ${Di?p`<div class="hint">This chart is drawn against that one's range, so the two read as one
        ...
        ${!Di&&y.scale==="fixed"?p`<div class="grid2">
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let M;e.update(A=>{M=Io(A,a)}),M&&e.selectLayer(M)}}>
          ${_("plus")}<span>Second series</span></button>
        ${ie("Colour",y.coloring,Ps,M=>k(A=>{A.coloring=M,M==="bands"&&A.bands.length===0&&(A.bands=Ds(Q))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
          ...
          ${Vs(y,y.colorSlot.baseColorHex,k)}
          ${y.style==="area"?p`${Re("Fill follows the bands",y.fillBands,M=>k(A=>{A.fillBands=M}),c.fillBands)}
        ...
        <div class="grid2">
          ${ie("Highlight",y.highlight,ll,M=>k(A=>{A.highlight=M}),{def:c.highlight})}
          ${y.highlight==="none"?f:ie("Marker",y.marker,mu,M=>k(A=>{A.marker=M}),{def:c.marker})}
        </div>
        ...
        ${Re("Threshold line",y.thresholdValue!==void 0,M=>k(A=>{M?A.thresholdValue=fu(Q):delete A.thresholdValue}))}
        ...
        ${Re("\u201CNow\u201D marker",y.nowIndex!==void 0,M=>k(A=>{M?A.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete A.nowIndex}))}
        ${y.nowIndex===void 0?f:p`
          ${oe(e,y.nowIndex,M=>k(A=>{A.nowIndex=M},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ...
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=n.payload,k=(W,Q)=>s(Oi=>W(Oi.payload),Q),Y=c.historyMinutes,G=y.value.kind.kind==="entityState",L=pt(y),D=L===void 0?void 0:e.historySeries(L),P=Oe(y)*60,se=In(D??"",ut),rn=ar(a,y.historyMinutes),xe=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,on=yu(se,P,xe===void 0?void 0:e.hass.states[xe]?.state,xe?.split(".")[0]);g=p`
        ${oe(e,y.value,W=>k(Q=>{Q.value=W},"value"),{label:"States",key:`${o}-value`})}
        ...
        ${Ys(a,y.historyMinutes,Y,W=>k(Q=>{Q.historyMinutes=W}))}
        ${rn?Xs(y.historyMinutes,W=>k(Q=>{Q.historyMinutes=W},"span")):f}
        ...
        ${se.length>0?p`<div class="hint">Reads <span class="nums">${qu(se,P)}</span></div>`:f}
        ${ju(se)?p`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${bu(y,k,on,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        ${_n("Times",y.timeLabelCount,W=>k(Q=>{Q.timeLabelCount=Math.max(0,Math.min(Cn,Math.round(W)))},"tlcount"),{min:0,max:Cn,step:1,def:c.timeLabelCount,format:W=>W<=0?"None":String(Math.round(W))})}
        ${y.timeLabelCount<=0?f:p`
          ...
          ${ie("Clock",y.hourCycle,oo,W=>k(Q=>{Q.hourCycle=W}),{titles:{auto:"Whatever clock the watch is set to"},def:c.hourCycle})}
          ${ie("Minutes",y.minutes,so,W=>k(Q=>{Q.minutes=W}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:c.minutes})}
          ...
          ${ie("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],y=>s(k=>{k.payload.kind=y}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:c.kind})}
          ${n.payload.kind==="roundedRectangle"?ne("Corner radius (pt)",n.payload.cornerRadius,y=>s(k=>{k.payload.cornerRadius=y??6},"radius"),{step:.5,min:0,def:c.cornerRadius}):f}
        </div>
        ${n.payload.kind==="line"?Wu(t,d,u):f}`,v=n.payload.kind==="line"?ne("Thickness (pt)",n.payload.thickness,y=>s(k=>{k.payload.thickness=y??1},"thick"),{step:.5,min:.5,def:c.thickness}):p`
        ${re("Border colour",n.payload.borderColorHex,y=>s(k=>{y===void 0?delete k.payload.borderColorHex:k.payload.borderColorHex=y},"border"),!0,null)}
        ${n.payload.borderColorHex!==void 0?ne("Border width (pt)",n.payload.borderWidth,y=>s(k=>{k.payload.borderWidth=y??1},"bw"),{step:.5,min:0,def:c.borderWidth}):f}`;break;case"image":{let y=n.payload,k=(D,P)=>s(se=>D(se.payload),P),Y=y.entity.entityId?e.hass.states[y.entity.entityId]?.attributes?.entity_picture:void 0,G=typeof Y=="string"?Y:void 0,L=G!==void 0&&!G.startsWith("/");g=p`
        ${ie("Source",y.source,[["camera","Camera"],["entityPicture","Entity picture"]],D=>k(P=>{P.source=D}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:c.source})}
        ${y.source==="camera"?p`
        ...
        ${ie("Picture",y.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],D=>k(P=>{P.contentMode=D}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:c.contentMode})}
        ${_n("Zoom",y.zoom,D=>k(P=>{P.zoom=D},"zoom"),{min:Da,max:4,step:.05,def:1,format:D=>`${D.toFixed(2)}x`})}
        ${_n("Pan left/right",y.panX,D=>k(P=>{P.panX=D},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${_n("Pan up/down",y.panY,D=>k(P=>{P.panY=D},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class="hint">${Vu(y)}</div>
        ${ne("Corner radius (pt)",y.cornerRadius,D=>k(P=>{P.cornerRadius=Math.max(0,D??Kt)},"imgradius"),{step:1,min:0,def:Kt})}`;break}case"tap":{g=p`
        ${kl(e,n.payload,(y,k)=>s(Y=>y(Y.payload),k),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let $=n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:re(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,y=>s(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,h),S=Ca(e.config,n),E=S?{kind:{kind:"entityState",...S}}:void 0,w=fe[n.kind],C=n.kind==="tap"?void 0:Fe(e.config,a)[0],N=n.kind==="image"?n.payload.timestamp===!0:!1,B=Xu[n.kind],q=Ju[n.kind],de=js(n.payload,c,B),x=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,F=e.config.perFamily[t]?.placements[a]?.size!==void 0,V=js(n.payload,c,q)||x!==void 0&&l.size!==void 0&&l.size!==c[x],O=Tt(e.config,a),ce=(y,k)=>()=>s(Y=>qs(Y.payload,c,y),k);return p`
    ${Se(e,"content","Content",p`${n.kind==="tap"?f:Nu(e,n,o)}${g}`,{color:w,icon:"content",summary:dr(e,n),...de?{reset:ce(B,"reset-content")}:{}})}
    ${v===void 0&&$===void 0?f:Se(e,"look",n.kind==="image"?"Picture":"Look",p`${v??f}${$??f}`,{color:w,icon:n.kind==="image"?"image":"look",...Hi(n)?{summary:Hi(n)}:{},...V?{reset:()=>e.update(y=>{qs(y.elements[r].payload,c,q),F&&$e(y,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Numbers",tp(e,n),{color:fe.text,icon:"text",summary:ep(e,n),...O.length>0?{reset:()=>e.update(y=>{for(let k of Tt(y,a))Je(y,k.payload.id)})}:{}}):f}
    ${n.kind==="image"?Se(e,"timestamp","Timestamp",Bu(n.payload,(y,k)=>s(Y=>y(Y.payload),k)),{color:w,icon:"clock",summary:N?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...N?{reset:ce(Yu,"reset-stamp")}:{}}):f}
    ${n.kind==="tap"?f:Se(e,"tappable","Tap",np(e,n,o),{color:ee.tap,icon:"tap",summary:C?je(C.payload.action):"Not tappable",...C?{reset:()=>e.update(y=>ii(y,a))}:{}})}
    ${Se(e,"states","States",Ml(e,n.payload.rules,n.kind,y=>y.elements.find(k=>k.payload.id===a)?.payload.rules,`rules-${a}`,E),{color:ee.states,icon:"states",summary:Hn(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(y=>{y.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:cr(e,n,t)}`}var Yu=["timestamp","timestampCorner","timestampSize"],Xu={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Ju={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function kl(e,n,t,i){let a=n.action;return p`
    ${Me("Tap action",a.type,Mu,r=>t(o=>{o.action=hl(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ${"entityId"in a?tt(e,"Target",a,r=>t(o=>{o.action={type:a.type,...r}},"tap-entity"),`${i}-tap`):f}
    ${a.type==="callService"?ml(e,a,(r,o)=>t(s=>{s.action=r},o),`${i}-tap`):f}
    ${a.type==="openPage"?gl(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var Zu=24;function Qu(e,n){let t=[],i=1/0;for(let r of te){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Mo(e.config,n,r);o&&(t.push(`${Z(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<Zu;return p`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:f}</div>`}function ep(e,n){let t=Tt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Vt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function tp(e,n){let t=ye(e),i=Tt(e.config,n.payload.id),a=o=>e.update(s=>{ko(s,n.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    <div class="hint">The newest reading starts with the entity's unit after it. The ends of the scale come from the plot's range, so on a Fixed scale they print the Min and Max above.</div>`}function np(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Fe(e.config,i)[0],r=(s,l)=>e.update(d=>{let u=d.elements.find(c=>c.kind==="tap"&&c.payload.attachedTo===i);u&&s(u.payload)},l?`${t}-${l}`:void 0),o=Sa(e.config,n);return p`
    ${Re("Tappable",a!==void 0,s=>e.update(l=>{s?ni(l,i):ii(l,i)}))}
    ${a?p`<div class="value-editor">
          ...
          <div class="chips">
            ...
            ${Zn(a.payload.outset)?f:p`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                  @click=${()=>r(s=>{s.outset={...ga}})}>${_("reset")}</button>`}
          </div>
        </div>
        ${Qu(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:p`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${je(o)}</b>.</div>`}`}function Js(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Ie(e,n){switch(e.kind){case"text":return Js(ge(e.payload.value,n));case"icon":return Js(ge(e.payload.symbol,n));case"gauge":return ge(e.payload.value,n);case"chart":return ge(e.payload.value,n);case"timeline":return ge(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function $l(e,n){let t=Ye(e.config,n.id),i=ye(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return Se(e,"content","Group",p`
    ${he("Name",n.name,r=>a(o=>{o.name=r},"name"))}
    ${Re("Move as one on the watch",n.locked,r=>a(o=>{o.locked=r}))}
    ...
    </div>`,{color:ee.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Cl(e,n){if(n==="inline")return ip(e);let t=e.config.perFamily[n];if(!t)return p`<div class="hint">No settings stored for ${Z(n)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[n]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Z(n)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[n]),l?`fam-${n}-${l}`:void 0),a=_i(e.config,n),r=t.backgroundColorHex?Ce(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Ce(t.borderColorHex)} border`:"no border";return p`
    ${Se(e,"look",`${Z(n)} shape`,p`
    ...
    ${Se(e,"content","Inline text",p`
      ...
      ${Re("Live countdown",n.countdown===!0,a=>t(r=>{a?r.countdown=!0:delete r.countdown}))}
    ...
    ${Se(e,"symbol","Symbol",p`
      ${sl(e,n.symbol??"",a=>t(r=>{a?r.symbol=a:delete r.symbol},"symbol"),"inline-symbol")}
      <div class="hint">Drawn before the text. Leave it blank for text only.</div>
      <div class="hint">On the face: ${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</div>`,{color:fe.icon,icon:"icon",summary:n.symbol||"None"})}`}function ap(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return p`
    ...
    ${a==="text"&&n.bezelText?p`
      ...
      ${Re("Live countdown",n.bezelCountdown===!0,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:f}
    ${a==="gauge"&&n.bezelGauge?rp(e,n.bezelGauge,t):f}`}function rp(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return p`
    ...
    ${Re("End number labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=R(String(s.minValue)),s.maxLabel=R(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?oe(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):f}
    ${n.maxLabel?oe(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Ym=te.map(e=>[e,Z(e)]),ur={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},op=Object.keys(ur);function sp(e){let n=ri[e];return op.filter(t=>n.includes(Te[t]))}var lp={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Ti(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function ft(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function dp(e){if(!e||Pe(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function ge(e,n){return`${Sl(e,n)}${dp(e.format)}`}function Sl(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${ft(t.value,40)}"`:"(empty)";case"entityState":return Ti(t,n);case"entityAttribute":return t.attribute?`${Ti(t,n)} \xB7 ${t.attribute}`:Ti(t,n);case"entityAge":return`age of ${Ti(t,n)}`;case"aggregate":return cp(t.aggregate);case"time":return lp[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${ft(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Vt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Sl(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function cp(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Li(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function up(e,n,t,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ${n.length===0?p`<div class="hint">No rules yet. A rule checks values and changes how this ${t==="layout"?"family":"layer"} looks.</div>`:f}
    ${n.map((o,s)=>pp(e,o,s,n.length,t,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Mn())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function pp(e,n,t,i,a,r,o){let s=e.liveBranch(n),l=e.forced.get(n.id)??"live",d=c=>l==="live"?c==="live":l==="otherwise"?c==="otherwise":l.caseId===c,u=(c,h)=>r(m=>{let g=m.find(v=>v.id===n.id);g&&c(g)},h);return p`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>Li(c,t,t-1))}>${_("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(c=>Li(c,t,t+1))}>${_("down")}</button>
    ...
    ${n.cases.map((c,h)=>hp(e,c,h,n,a,u,`${o}-${c.id}`))}
    <div class="adders"><button class="small" @click=${()=>u(c=>{c.cases.push(Fa())})}>+ case</button></div>
    ${Re("Otherwise (when no case matches)",n.otherwise!==void 0,c=>u(h=>{c?h.otherwise=h.otherwise??[]:delete h.otherwise}))}
    ${n.otherwise?p`<div class="case-box otherwise">
          <div class="hint">${s==="otherwise"?p`<b>Active now.</b> `:f}Changes when no case matches:</div>
          ${El(e,n.otherwise,a,c=>u(h=>{h.otherwise&&c(h.otherwise)}),`${o}-otherwise`)}
        </div>`:f}
  </div>`}function hp(e,n,t,i,a,r,o){let s=(d,u)=>r(c=>{let h=c.cases.find(m=>m.id===n.id);h&&d(h)},u),l=e.liveBranch(i)===n.id;return p`<div class="case-box ${l?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${l?p` <span class="ok">· active now</span>`:f}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(d=>Li(d.cases,t,t-1))}>${_("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(d=>Li(d.cases,t,t+1))}>${_("down")}</button>
    ...
    <div class="row-inline">
      ${ie("When",n.when.join,[["all","All of these are true"],["any","Any of these is true"]],d=>s(u=>{u.when.join=d}))}
    </div>
    ${n.when.tests.length===0?p`<div class="hint">No tests: this case always matches.</div>`:f}
    ${n.when.tests.map((d,u)=>mp(e,d,u,c=>s(h=>{let m=h.when.tests.find(g=>g.id===d.id);m&&c(m)}),()=>s(c=>{c.when.tests=c.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    <div class="adders"><button class="small" @click=${()=>s(d=>{d.when.tests.push(Ta())})}>+ test</button></div>
    <div class="hint" style="margin-top:8px">Then:</div>
    ${El(e,n.then,a,d=>s(u=>d(u.then)),`${o}-then`)}
  </div>`}function mp(e,n,t,i,a,r){let o=(c,h)=>i(c,h?`${r}-${h}`:void 0),s=n.comparison,l=Ft(s.kind),d=e.evaluateTest(n),u=f;switch(l){case"value":u=oe(e,s.value??R(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":u=p`${oe(e,s.value??R(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${oe(e,s.upper??R(""),c=>o(h=>{h.comparison.upper=c},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":u=p`${he("Pattern",s.pattern??"",c=>o(h=>{h.comparison.pattern=c},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!fp(s.pattern)?p`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"options":u=he("Options (comma separated)",(s.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return p`<div class="test-box">
    <div class="rule-head">
    ...
    ${s.kind==="isStale"?p`<div class="hint">True when the watch's cached values are older than the staleness limit. The value below is not read.</div>`:oe(e,n.value,c=>o(h=>{h.value=c},"lhs"),{showResolved:!0,label:"Value",key:`${r}-lhs`})}
    ${Me("Comparison",s.kind,_o.map(c=>[c,en[c]]),c=>o(h=>{h.comparison=Ma(h.comparison,c)}))}
    ${u}
  </div>`}function fp(e){try{return new RegExp(e),!0}catch{return!1}}function El(e,n,t,i,a){let r=sp(t);return p`
    ${n.length===0?p`<div class="hint">No changes.</div>`:f}
    ${n.map((o,s)=>gp(e,o,s,t,(l,d)=>i(u=>{u[s]&&l(u[s])},d?`${a}-${s}-${d}`:void 0),()=>i(l=>{l.splice(s,1)}),`${a}-${s}`))}
    <select class="adder" @change=${o=>{let s=o.target,l=s.value;s.value="",l&&i(d=>{d.push(Mt(l))})}}>
      <option value="">+ change…</option>
      ${r.map(o=>p`<option value=${o}>${ur[o]}</option>`)}
    </select>`}var Tl=["setColor","setBorderColor","setBackgroundColor"];function gp(e,n,t,i,a,r,o){let s=!ri[i].includes(Te[n.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${Fl(e,n,a,o)}
  </div>`}function Fl(e,n,t,i){let a=oi(n.kind),r=f;if(a==="value"){let o=n.value??R("");if(Tl.includes(n.kind)){let s=o.kind.kind==="literal";r=p`${s?re("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=R(l??"#FFFFFF")},"color")):oe(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!o.ok} title=${o.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${l=>{rr.delete(a),Ae(l.target)}}>Show as table</button>
        ${o.ok?f:p`<span class="hint">${o.reason}</span>`}
      </div>
      ${up(e,n,t,i,a)}`:yp(e,o.table,n[0],t,i,a,r)}function yp(e,n,t,i,a,r,o){let s=(x,F)=>e.update(V=>{let O=a(V);O&&x(O)},F?`${r}-${F}`:void 0),l=n.value??Zs.get(r)??o,d=n.rows.length===0,u=n.numberMode||d&&l!==void 0&&!Fs(l)&&bp(e.resolve(l)),c=ri[i],h=Fi.get(r)??new Set,m=n.columns.length===0&&h.size===0?[Ts[i]]:[],g=bs(n.columns,[...h,...m.filter(x=>x!==void 0)],c),v=t?e.liveBranch(t):"none",$=t?e.forced.get(t.id)??"live":"live",S=x=>$!=="live"&&($==="otherwise"?x==="otherwise":$.caseId===x),E=x=>{t&&e.setForced(t.id,S(x)?"live":x==="otherwise"?"otherwise":{caseId:x})},w=x=>{Zs.set(r,x),n.rows.length!==0&&s(F=>Cs(F,x),"lhs")},C=()=>s(x=>ks(x,l??R(""),u)),N=n.rows.map((x,F)=>el(e,{key:`${r}-${x.caseId}`,label:Es(x.comparison,V=>ge(V,ye(e))),columns:g,changes:x.changes,live:v===x.caseId,forced:S(x.caseId),onForce:()=>E(x.caseId),when:$p(e,x.comparison,`${r}-${x.caseId}`,(V,O)=>s(ce=>{let y=ce[0]?.cases.find(k=>k.id===x.caseId)?.when.tests[0];y&&V(y.comparison)},O&&`${x.caseId}-${O}`)),updChanges:(V,O)=>s(ce=>{let y=ce[0]?.cases.find(k=>k.id===x.caseId);y&&V(y.then)},O&&`${x.caseId}-${O}`),acts:p`
      <button class="icon" title="Move up" ?disabled=${F===0} @click=${()=>s(V=>Ya(V,F,F-1))}>${_("up")}</button>
      <button class="icon" title="Move down" ?disabled=${F===n.rows.length-1} @click=${()=>s(V=>Ya(V,F,F+1))}>${_("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>s(V=>$s(V,x.caseId))}>${_("delete")}</button>`})),B=n.otherwise===void 0?f:el(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:n.otherwise,live:v==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(x,F)=>s(V=>{let O=V[0]?.otherwise;O&&x(O)},F),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(x=>Xa(x,!1))}>${_("close")}</button>`}),q=Mi.get(r),de=vp.filter(x=>c.includes(x)&&!g.includes(x));return p`
    <div class="states">
          ...
          <tr>
            ...
            ${g.map(x=>p`<th>
              ...
              <button class="icon" title=${`Remove the ${et[x]} column`}
                @click=${F=>{Mi.set(r,x),Ae(F.target)}}>${_("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${q===void 0?f:p`<div class="hint warn confirm-row">
        Remove the ${et[q]} column? Its ${Qs(n,q)} value${Qs(n,q)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${x=>{Mi.delete(r),Fi.get(r)?.delete(q),Ae(x.target),s(F=>Ss(F,q))}}>Remove</button>
        <button class="small" @click=${x=>{Mi.delete(r),Ae(x.target)}}>Cancel</button>
      </div>`}
      <div class="states-foot">
        <button class="small" @click=${C}>+ state</button>
        ${n.otherwise===void 0?p`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>s(x=>Xa(x,!0))}>+ otherwise</button>`:f}
        <span class="spacer"></span>
        ${$==="live"?f:p`<button class="small" @click=${()=>t&&e.setForced(t.id,"live")}>Back to live</button>`}
        ${de.length===0?f:p`<select class="chip-add" title="Add a column" @change=${x=>{let F=x.target,V=F.value;if(F.value="",!V)return;let O=Fi.get(r)??new Set;O.add(V),Fi.set(r,O),Ae(F)}}>
      ...
      <div class="states-switch">
        <button class="link" @click=${x=>{rr.add(r),Ae(x.target)}}>Advanced</button>
        <span class="hint">Several rules, several tests per state, or a regular expression.</span>
      </div>
    </div>`}function bp(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var vp=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Qs(e,n){let t=0;for(let i of e.rows)xi(i.changes,n)&&(t+=1);return e.otherwise&&xi(e.otherwise,n)&&(t+=1),t}function wp(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function el(e,n){return p`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    title=${`${n.label}. Click to hold the previews on this state.`}
    @click=${t=>{wp(t)||n.onForce()}}>
    <td class="when">
    ...
    ${n.columns.map(t=>p`<td>${xp(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function xp(e,n,t,i,a){let r=xi(t,n),o=sr(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${et[n]} for this state`}
      @click=${d=>{i(u=>{u.push(Mt(ys[n]))}),Su(d.target,o)}}>unchanged</button>`;let s=(d,u)=>i(c=>{let h=c.find(m=>Te[m.kind]===n);h&&d(h)},u&&`${n}-${u}`),l=et[n];return p`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${kp(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${cl}>
      <div class="pop-head">
        <b>${l}</b>
        <span class="spacer"></span>
        <button type="button" class="small" popovertarget=${o} popovertargetaction="hide">Done</button>
      </div>
      ${zn.has(o)?p`${n==="visibility"?ie("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(u=>{u.kind=d})):Fl(e,r,s,a)}
          <button class="link" @click=${d=>{d.target.closest("[popover]")?.hidePopover(),i(u=>{let c=u.findIndex(h=>Te[h.kind]===n);c>=0&&u.splice(c,1)})}}>Leave ${l.toLowerCase()} unchanged</button>`:f}
    </div>`}function kp(e,n){if(n.kind==="hide")return p`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return p`<span class="cell-word">Shown</span>`;let t=oi(n.kind);if(t==="number")return p`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return p`<span class="cell-word">${lr.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??R(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Tl.includes(n.kind))return p`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ce(a):ge(i,ye(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return p`${r??f}<span class="cell-word">${a}</span>`}return p`<span class="cell-word">${ge(i,ye(e))}</span>`}function Ce(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function $p(e,n,t,i){let a=Ft(n.kind),r=ja(n.kind),o=(s,l,d,u)=>Sp(e,s,l,`${t}-${d}`,r,u,d==="rhs"?"Compare with":"Upper bound");return p`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${we(s=>i(l=>{let d=Ma(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Wa.map(s=>p`<option value=${s} ?selected=${s===n.kind}>${Cp(s)}</option>`)}
    </select>
  ...
  </span>`}function Cp(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return en[e]}}function Sp(e,n,t,i,a,r,o){let s=sr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return p`<span class="rhs">
    ...
    <input class="cellin ${a?"num":""}" type=${a?"number":"text"} .value=${d} placeholder=${r}
      @input=${we(u=>t({...n,kind:{kind:"literal",value:u}}))} />
    <button type="button" class="icon more" popovertarget=${s} title="Compare with an entity or a template instead">…</button>
    ${dl(e,s,o,n,t,l)}
  </span>`}var Nn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:$a,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function Hl(e){return Nn.find(n=>n.kind===e)??Nn[0]}var Rl="#FF9F0A",zi="#8E8E93",Ep=["#FF453A","#FFD60A","#34C759"],Ll=["#0A84FF","#34C759","#FF9F0A"];function Tp(e){return e?.attributes?.device_class==="battery"?Ep:Ll}var Fp={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Mp(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Fp[pr(e)]??{off:"circle",on:"circle.fill"}}function Rp(e){switch(pr(e)){case"lock":return{kind:"equals",value:R("locked")};case"cover":case"valve":return{kind:"equals",value:R("open")};case"media_player":return{kind:"equals",value:R("playing")};default:return{kind:"isOn"}}}function pr(e){return e.domain||e.entityId.split(".")[0]||""}function bt(e){return{...e,domain:pr(e)}}function Ip(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function an(e){return Math.round(e*1e4)/1e4}function zt(e,n,t){return Math.min(t,Math.max(n,e))}function hr(e,n,t){let i=ve[e],a=zt(an(n/i.width),0,1),r=zt(an(t/i.height),0,1);return{x:an((1-a)/2),y:an((1-r)/2),width:a,height:r,rotationDegrees:0}}function Ap(e){let n=ve[e],t=zt(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:hr(e,t*1.3,t*1.3),size:t}}function Hp(e){let n=ve[e],t=zt(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:hr(e,n.width*.88,t*1.7),size:t}}function Lp(e){let n=ve[e],t=Math.min(n.width,n.height)*.9;return{frame:hr(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function _l(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function _p(e){let n=ve[e],t=zt(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:an(t/n.height),rotationDegrees:0}}}function zp(e){let n=ve[e],t=zt(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:an(zt(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Np(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Op(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function gt(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Op(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Xe());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function yt(e){return Ne(e)}function mr(e,n){let t={kind:{kind:"entityState",...bt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function Il(e){let n=Mt("setIcon");return n.value=R(e),n}function _t(e){let n=Mt("setColor");return n.value=R(e),n}function Pp(e,n){let t=Mn(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...bt(e)}},a.comparison=Rp(e);let r=n.on!==n.off;return i.then=r?[Il(n.on),_t(Rl)]:[_t(Rl)],t.otherwise=r?[Il(n.off),_t(zi)]:[_t(zi)],t}function Dp(e){let n=Mn(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...bt(e)}},i.comparison={kind:"isUnavailable"};let a=Mt("setOpacity");return a.number=.35,t.then=[a],n}function Al(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Vp(e,n,t=Ll){let i=n.max-n.min,a=Al(n.min+i/3),r=Al(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:R(a)},changes:[_t(t[0])]},{comparison:{kind:"between",value:R(a),upper:R(r)},changes:[_t(t[1])]},{comparison:{kind:"greaterThan",value:R(r)},changes:[_t(t[2])]}];return vs(mr(e),o)}function Bp(e,n,t){let i=yt("icon"),a=Mp(n);return i.payload.symbol=R(a.off),i.payload.colorSlot.baseColorHex=zi,i.payload.rules=[Pp(n,a)],gt(e,i,t.family,Ap),e.elements.push(i),ni(e,i.payload.id,{type:"toggleEntity",...bt(n)}),i.payload.id}function Gp(e,n,t){let i=yt("text");return i.payload.value=mr(n,t.state),i.payload.rules=[Dp(n)],gt(e,i,t.family,Hp),e.elements.push(i),i.payload.id}function Up(e,n,t){let i=yt("gauge");i.payload.value=mr(n);let a=Ip(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Vp(n,a,Tp(t.state))],gt(e,i,t.family,Lp),e.elements.push(i),i.payload.id}function Kp(e,n,t){let i=yt("chart");return i.payload.value={kind:{kind:"entityState",...bt(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",gt(e,i,t.family,_l),e.elements.push(i),i.payload.id}function Wp(e,n,t){let i=yt("chart");return i.payload.value={kind:{kind:"entityState",...bt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",gt(e,i,t.family,_l),e.elements.push(i),i.payload.id}function jp(e,n,t){let i=bt(n),a=yt("text");a.payload.value=R(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=zi,gt(e,a,t.family,zp),e.elements.push(a);let r=t.state?.attributes?.device_class,o=yt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=ma(i.domain,typeof r=="string"?r:void 0),gt(e,o,t.family,_p),e.elements.push(o),o.payload.id}function qp(e,n,t){let i=yt("image");return i.payload.entity=bt(n),gt(e,i,t.family,Np),e.elements.push(i),i.payload.id}function zl(e,n,t,i){switch(n){case"toggle":return Bp(e,t,i);case"status":return Gp(e,t,i);case"gauge":return Up(e,t,i);case"chart":return Kp(e,t,i);case"history":return Wp(e,t,i);case"doorHistory":return jp(e,t,i);case"camera":return qp(e,t,i)}}var Xp=3e4,Jp=500,Nl="preset-entity",Zp={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function fr(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Qp(e){return e.kind==="family"?"look":"content"}function gr(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}var Ol=300,Pl=360,Dl=44,Vl=22,eh=[1,1.7,2.6],th=["S","M","L"],Bl=["Small","Medium","Large"],Gl="wrist-assistant-panel.layers.v1",it=34,Nt=200,nh=720,Ni=320,ih=80,ah=56,Ul="wrist-assistant-panel.columns.v2",yr=e=>Math.max(Nt,Math.min(nh,Math.round(e))),Kl=e=>e.metaKey||e.ctrlKey||e.shiftKey,rh=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,On=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",vt=On==="Cmd"?"\u2318":"Ctrl+",br=On==="Cmd"?"\u21E7":"Shift+";function Wl(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-ih;if(i>=Nt*2+Ni){let r=i-Ni,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Nt,Math.floor(o*l)),s=Math.max(Nt,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Nt,o-d):s=Math.max(Nt,s-d))}return{columns:3,left:o,right:s}}let a=e-ah;return a>=Nt+Ni?{columns:2,left:Math.min(n,a-Ni),right:t}:{columns:1,left:n,right:t}}var I=class I extends rt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Ol;this.colRight=Pl;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.pickerFilter="all";this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.recordPreviews=new Map;this.previewCase=Jt.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=us(()=>this.requestUpdate());this.imageSizes=ps(()=>this.requestUpdate());this.symbols=new yi(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new wi;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newChooserOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("newc"))||this.toggleNewChooser(!1)};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||ol(Nl)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Gi`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let t=window.localStorage.getItem(Ul);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=yr(i.left)),typeof i.right=="number"&&(this.colRight=yr(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Ul,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Gl);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Gl,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return p`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?p`<div class="adders">
            ${r.map(o=>p`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>vl(s,o,i))}>Copy the ${Z(o)} layout</button>`)}
          </div>
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Ea(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let S=this.focusTapId();if(S!==void 0&&o===S&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,S,r??void 0);return}let E=this.hitLayerId(i);E?this.inspect={kind:"layer",id:E}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let u=Kl(i);if(!u&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let c=Ea(this.draft.config,o),h=this.draft.config.elements.find(S=>S.payload.id===c);if(!c||!h)return;if(u){i.preventDefault(),this.togglePick(c);return}let m=qe(this.draft.config,c),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==c)&&(this.inspect={kind:"layer",id:c},r))return;i.preventDefault();let v=Ee(this.draft.config,t,h).frame,$=this.gestureCanvas(t);if(d&&h.kind==="image"&&h.payload.timestamp===!0){this.timestampActiveId=c;let S=h.payload,E=me[t],w=v.width*E.width,C=v.height*E.height,N={x:0,y:0,w,h:C,cx:w/2,cy:C/2},B=pi(S,N,ui(new Date));if(this.cancelGesture?.(),l){let F=$.width/E.width,V=S.timestampSize;this.cancelGesture=Ls(s,i,l,{w:B.w*F,h:B.h*F},(O,ce)=>{let y=Math.min(40,Math.max(4,Math.round(V*O)));this.mutate(k=>{let Y=k.elements.find(G=>G.payload.id===c);Y?.kind==="image"&&(Y.payload.timestampSize=y)},`ts-size-${c}`),ce&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let q={x:0,y:0,w:v.width*$.width,h:v.height*$.height},de=We(S)?{x:S.timestampX,y:S.timestampY}:{x:(B.x+B.w/2)/N.w,y:(B.y+B.h/2)/N.h},x=!1;this.cancelGesture=Hs(s,q,i,de,(F,V,O)=>{O||(x=!0),x&&this.mutate(ce=>{let y=ce.elements.find(k=>k.payload.id===c);y?.kind==="image"&&(y.payload.timestampX=F,y.payload.timestampY=V)},`ts-${c}`),O&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=$i(s,$,i,{elementId:c,frame:v,handle:r??void 0},{onFrame:(S,E,w)=>{this.mutate(C=>$e(C,t,S,{frame:E}),`drag-${S}-${t}`),w&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=Ye(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map($=>[$.payload.id,Ee(o,t,$).frame])),d=[...l.values()],u=Math.min(...d.map($=>$.x)),c=Math.min(...d.map($=>$.y)),h=Math.max(...d.map($=>$.x+$.width)),m=Math.max(...d.map($=>$.y+$.height)),g={x:u,y:c,width:h-u,height:m-c,rotationDegrees:0},v=$=>Math.round($*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=$i(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:($,S,E)=>{let w=S.x-g.x,C=S.y-g.y;this.mutate(N=>{for(let[B,q]of l)$e(N,t,B,{frame:{...q,x:v(q.x+w),y:v(q.y+C)}})},`drag-group-${r.id}-${t}`),E&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?Is:1,s=t*o,l=i*o,d=this.canvasFamily,u=me[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,u,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let $=this.inspect.id;return this.nudgeMany(Ye(r,$).map(S=>S.payload.id),d,u,`nudge-group-${$}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let c=this.inspect.id,h=r.elements.find($=>$.payload.id===c);if(!h)return!1;let m=qe(r,c);if(m?.locked)return this.nudgeMany(Ye(r,m.id).map($=>$.payload.id),d,u,`nudge-group-${m.id}-${d}`,s,l);let g=Ee(r,d,h).frame,v=er(g,s,l,u);return(v.x!==g.x||v.y!==g.y)&&this.mutate($=>$e($,d,c,{frame:v}),`nudge-${c}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,u=new Map;for(let C of t){let N=l.elements.find(B=>B.payload.id===C);N&&u.set(C,Ee(l,i,N).frame)}if(u.size===0)return!1;let c=[...u.values()],h=Math.min(...c.map(C=>C.x)),m=Math.min(...c.map(C=>C.y)),g=Math.max(...c.map(C=>C.x+C.width)),v=Math.max(...c.map(C=>C.y+C.height)),$={x:h,y:m,width:g-h,height:v-m,rotationDegrees:0},S=er($,o,s,a),E=S.x-$.x,w=S.y-$.y;return(E!==0||w!==0)&&this.mutate(C=>{for(let[N,B]of u)$e(C,i,N,{frame:{...B,x:d(B.x+E),y:d(B.y+w)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find($=>$.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=me[i],u=Ee(o,i,s).frame,c=u.width*d.width,h=u.height*d.height,m=pi(l,{x:0,y:0,w:c,h,cx:c/2,cy:h/2},ui(new Date)),g=We(l)?{x:l.timestampX,y:l.timestampY}:{x:c>0?(m.x+m.w/2)/c:.5,y:h>0?(m.y+m.h/2)/h:.5},v=As(g,a,r,{w:c,h});return(v.x!==g.x||v.y!==g.y)&&this.mutate($=>{let S=$.elements.find(E=>E.payload.id===t);S?.kind==="image"&&(S.payload.timestampX=v.x,S.payload.timestampY=v.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=ci(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Va(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Fe(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(c=>c.payload.id===r);if(!s||!l)return;let d=le(s,l),u=Ee(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=$i(a,this.gestureCanvas(t),i,{elementId:r,frame:u,handle:o},{onFrame:(c,h,m)=>{this.mutate(g=>{d?Fo(g,c,t,h):$e(g,t,c,{frame:h})},`tap-box-${c}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Wl(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(s=>s.id===this.selectedId),o=t===void 0?"No complication":r?`Revision ${r.revision} \xB7 ${i?"unsaved changes":"saved"}`:"Not saved yet";return p`
      <header>
        ...
        <label>Watch
          <select @change=${s=>{this.selectOwner(s.target.value)}}>
            ${this.owners.map(s=>p`<option value=${s.owner_watch_id} ?selected=${s.owner_watch_id===this.ownerId}>
              ${jl(s)} (${s.complication_count})</option>`)}
          </select>
        </label>
      ...
      ${this.hass.user?.is_admin?i.length===0?p`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:p`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>p`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${jl(a)}</option>`)}
              </select>
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:p`<span class="mini">${Ga.length} kinds · ${Nn.length} presets</span>`}
      ...
      ${a?p`
          <div class="add-grid ${r?"":"lean"}">
            ${Ga.map(s=>p`<button class="add" style=${`--k:${fe[s]}`} ?disabled=${i} title=${`Add a blank ${Qt[s].toLowerCase()} layer`}
              @click=${()=>{let l=Ne(s);this.addHere(d=>{d.elements.push(l)}),this.inspect={kind:"layer",id:l.payload.id}}}
              >${r?p`<span class="well">${Rs(s)}</span>`:f}<span class="add-name">${r?_(s):p`<span class="k"></span>`}<span>${Qt[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Ie(x,d)}</b>
          <small><span class="kind">${Qt[x.kind]}</span> · ${dh(x,u,this.historySeries,y.size)}</small>
          ${C?p`<span class="facts">${sh(this.host(),a,x,y).map(P=>p`<span class="fact"><b>${P.label}</b> ${P.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${Y?p`<span class="badge tap" title=${`Tappable \xB7 ${Ie(Y,d)}`}>tap</span>`:f}
          ...
          ${i?p`<span class="acts">
            <button class="icon" title=${`Bring forward (${vt}])`} aria-label="Bring forward" @click=${P=>{P.stopPropagation(),r(O,1)}}>${_("up")}</button>
            <button class="icon" title=${`Send back (${vt}[)`} aria-label="Send back" @click=${P=>{P.stopPropagation(),r(O,-1)}}>${_("down")}</button>
            <button class="icon" title=${`${y.isHidden?"Show":"Hide"} (${br}${vt}H)`} aria-label=${y.isHidden?"Show this layer":"Hide this layer"} @click=${P=>{P.stopPropagation(),this.mutate(se=>$e(se,a,O,{isHidden:!y.isHidden}))}}>${_(y.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${vt}D)`} aria-label="Duplicate" @click=${P=>{P.stopPropagation(),o(O)}}>${_("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${P=>{P.stopPropagation(),s(O)}}>${_("delete")}</button>
          </span>`:f}
        </span>
      </div>`},B=(x,F)=>{let V=this.inspect.kind==="group"&&this.inspect.id===x.id,O=!this.collapsed.has(x.id),ce=this.rowDrag(x.id,i),y=F[0],k=F[F.length-1],Y=L=>{let D=L.currentTarget,P=D.getBoundingClientRect(),se=P.top+(D.classList.contains("drop-before")?it:0),rn=P.bottom-(D.classList.contains("drop-after")?it:0),xe=(L.clientY-se)/Math.max(1,rn-se);return xe<.25?"drop-before":!O&&xe>.75?"drop-after":"drop-into"},G=F.map(L=>L.payload.id);return p`<div class="layer group ${V?"hl":""} ${C?"rich":""}" style=${`--k:${ee.group}`} tabindex="0" draggable=${ce.draggable}
        ...
        @drop=${L=>{L.preventDefault();let D=Y(L);this.clearDragMarks();let P=this.dragId;if(this.dragId=void 0,!(!P||!y||!k)){if(D==="drop-before"){this.reorderLayer(P,y.payload.id,!0,!0);return}if(D==="drop-after"){this.reorderLayer(P,k.payload.id,!1,!0);return}this.isGroupId(P)||(this.reorderLayer(P,y.payload.id,!0),this.mutate(se=>wa(se,P,x.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?p`<span class="facts"><span class="fact"><b>Holds</b> ${F.map(L=>Ie(L,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?p`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${br}${vt}G)`} aria-label="Ungroup" @click=${L=>{L.stopPropagation(),this.mutate(D=>Tn(D,x.id)),V&&(this.inspect={kind:"general"})}}>${_("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${x.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${L=>{L.stopPropagation(),this.mutate(D=>{let P=D.groups?.find(se=>se.id===x.id);P&&(P.locked=!P.locked)})}}>${_(x.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${O?"true":"false"} title=${O?"Fold the group":"Unfold the group"}
            @click=${L=>{L.stopPropagation();let D=new Set(this.collapsed);O?D.add(x.id):D.delete(x.id),this.collapsed=D}}>${_("chevron")}</button>
        </span>
      </div>`},q=[],de=new Set;for(let x=0;x<l.length;x++){let F=l[x],V=F.payload.groupId,O=V===void 0?void 0:t.groups?.find(k=>k.id===V);if(!O){q.push(N(F,!1));continue}if(de.has(O.id))continue;de.add(O.id);let ce=l.filter(k=>k.payload.groupId===O.id);q.push(B(O,ce));let y=this.inspect.kind==="group"&&this.inspect.id===O.id;this.collapsed.has(O.id)||q.push(p`<div class="group-kids">${ce.map(k=>N(k,!0,y))}</div>`)}return p`<div class="card layers-card" style=${`--thumb-w:${S}px;--thumb-h:${E}px`}>
      <h2 class="panel-title tools" style=${`--c:${ee.place}`}><span class="swatch">${_("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${th.map((x,F)=>p`
              <button class=${this.thumbStep===F?"on":""} title=${`${Bl[F]} row pictures`}
                aria-label=${`${Bl[F]} row pictures`} aria-pressed=${this.thumbStep===F?"true":"false"}
      ...
      ${g>=2&&i?p`<div class="group-cta"><span>${g} layers picked</span><span class="spacer"></span>
            ...
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?p`<div class="hint">${On}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:f}
      ...
      <div class="layer pinned ${h?"hl":""}" style=${`--k:${ee.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${x=>{x.preventDefault(),this.clearDragMarks();let F=this.dragId,V=[...l].reverse().find(O=>O.payload.id!==F&&O.payload.groupId!==F);F&&V&&this.reorderLayer(F,V.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderPresetDialog(){let t=this.presetKind?Hl(this.presetKind):void 0,i=this.presetEntity;return p`<dialog class="preset-dialog" @keydown=${this.presetKeys}
        @close=${()=>{this.presetKind=void 0,this.presetEntity=void 0}}>
      ${t===void 0?f:p`
        <h2>${t.title}</h2>
        <div class="hint">${t.blurb}</div>
        ${tt(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Nl,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=zl(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return p`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return p`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=li(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return p`
      ...
      <div class="settings inline" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}>${fl(t)}</div>
      <span class="spacer"></span>
      <span class="acts">
      ...
      <h2 class="panel-title"><span class="swatch">${_("content")}</span>Shared values
        ...
        <span class="spacer"></span>
        ${this.canEdit?p`<button class="small" @click=${()=>{let o=bl();this.mutate(s=>{s.values.push(o)}),this.inspect={kind:"data",id:o.id}}}>Add</button>`:f}
      </h2>
      ...
      ${i.map(o=>{let s=a.resolve({kind:{kind:"named",id:o.id}}),l=this.inspect.kind==="data"&&this.inspect.id===o.id;return p`<div class="datum vrow ${l?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:o.id}}}>
          ...
          ${_("plus")}${Z(r)}
        </button>`;let o=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let u=i[r];s=u?mi(u,{icons:this.icons,imageSizes:this.imageSizes,slot:Jt.slots[r]}):f}let l=r!=="inline"&&_i(t,r)===0&&t.elements.length>0,d=this.canEdit&&fi(t,r);return p`<span class="tab-wrap">
      ...
      ${i.length===0?p`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:p`<div class="chips values">
        ${i.map(r=>{let o=this.hass.states[r],s=typeof o?.attributes.friendly_name=="string"?o.attributes.friendly_name:r,l=typeof o?.attributes.unit_of_measurement=="string"?` ${o.attributes.unit_of_measurement}`:"",d=o?`${o.state}${l}`:"not in Home Assistant",u=this.testValues.get(r),h=t.elements.find(g=>ai(t,g.payload.id).some(v=>v.ref.entityId===r))?.kind??"text",m=this.editingValue===r;return p`<button class="vchip vrow ${u!==void 0?"testing":""}" style=${`--k:${fe[h]}`}
      ...
      ${l===f?f:p`<span class="sep">›</span>${l}`}
        ...
        <div class="insp-body" style=${this.canEdit?"":"pointer-events:none;opacity:.6"}
          @change=${()=>this.draft?.endGesture()}>${this.multiEditor(t,i)}</div>`;let a=this.host(),r=this.inspect,o=f,s=!0;if(r.kind==="layer"){let d=t.elements.find(u=>u.payload.id===r.id);if(!d)return this.inspect={kind:"general"},f;o=xl(a,d,this.canvasFamily,{placement:!1})}else if(r.kind==="group"){let d=t.groups?.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=$l(a,d)}else if(r.kind==="data"){let d=t.values.find(u=>u.id===r.id);if(!d)return this.inspect={kind:"general"},f;s=!1,o=p`<div class="sec" data-open="true" style=${`--c:${ee.complication}`}>
        ...
        <div class="sec-b">${yl(a,d)}</div>
      </div>`}else r.kind==="family"?o=Cl(a,this.activeFamily):(s=!1,o=p`<div class="empty-insp">${_("layers")}<b>Nothing selected</b>
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${s?p`<button class="expand" @click=${()=>{this.openSections=l?new Set([Qp(r)]):new Set(or)}}>${l?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      <span>${t}${i==="mixed"?p` <span class="mixed">(mixed)</span>`:f}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=ye(this.host()),o=new Qe(this.buildContext(),this.draft?.config),s=wl(t,a,i),l=i.length,d=[...i].reverse(),u=h=>this.mutate(m=>{for(let g of i)$e(m,a,g.payload.id,{isHidden:h})}),c=h=>this.mutate(m=>{for(let g of i){let v=m.elements.find($=>$.payload.id===g.payload.id);v&&v.kind!=="image"&&v.kind!=="tap"&&v.kind!=="timeline"&&(v.payload.colorSlot.baseColorHex=h)}},"multi-colour");return p`
          ...
          <div class="picked">
            ${d.map(h=>p`<div class="row" style=${`--k:${fe[h.kind]}`}>
              ...
              <span class="name">
                ...
                <b>${Ie(h,r)}</b><span class="kind">${Qt[h.kind]}</span>
              </span>
            </div>`)}
          </div>
      ...
      <div class="sec" data-open="true" style=${`--c:${ee.place}`}>
        ...
        <div class="sec-b">
          ...
          ${s.colourable?p`${re("Colour",s.colour,h=>{h!==void 0&&c(h)})}
