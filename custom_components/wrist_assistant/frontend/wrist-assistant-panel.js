...
`)}function Jd(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Sm(r));return{values:t,nullKeys:i}}function Sm(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Oo(e){let n=Fa(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Tm(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Zr(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Em=10800;function Mm(e,n,t){let i=n==="always"||n==="auto"&&t<=Em;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function Bo(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Mm(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Rm(e,n){return Bt(e)===void 0?[]:Bo(st(e)*60,ba(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Fm(e,n){return fn(e)?Bo(Math.round(e.historyMinutes)*60,ba(ft(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Am(e,n,t){return n===void 0||!fn(n)?[]:Bo(Math.round(n.historyMinutes)*60,ba(ft(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function $n(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Be(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:$n(i)}function Im(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Hm(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Lm(e){let n=e.trim(),t=$n(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?$n(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=$n(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function _m(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function zm(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Nm(e,n,t){if(Ae(n))return e;let i=n,a=e,r=$n(e.trim()),o=i.duration?Lm(e):void 0;if(o!==void 0)a=_m(o);else if(i.relativeTime&&r!==void 0)a=Hm(r);else{let s=Be(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Im(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=zm(a);break}return a}function Qn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function at(e,n=240){return nc(e,n).map(t=>t.value)}function Go(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of at(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:tc(r)}}function tc(e){return e.some(n=>n)?e:[]}function nc(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Zd(e,n,t){let i=nc(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Pt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??oe,c=t.highColorHex??je,u=t.lowColorHex??qe,p=[],m=(y,x)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===x?k.text+=y:p.push({text:y,colorHex:x})},b=0;return i.forEach((y,x)=>{m(e.slice(b,y.start),n);let k=x===o?c:x===s?u:l.length>0?fa(y.value,l,d):n,C=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,C),k),b=C}),m(e.slice(b),n),p}function Qd(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Pm(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function Li(e,n=Vt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Dm(i.slice(a+1))})}return t}function Dm(e){try{return decodeURIComponent(e)}catch{return e}}function Om(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function ec(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Vm(e,n,t){if(e===void 0)return 0;let i=Be(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var dt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=Qd(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=gn(n),i=yn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?Go(a):{values:at(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=tc(s),{values:Uo(o,tt(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Be(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Be(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Qd(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ae(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Tm(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?rd(r):Zr(r,a.domainMax-a.domainMin));break}default:{let a=Do(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Nm(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=$n(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Qn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Be(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Be(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Be(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=vn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:vn(d),p=c===void 0?void 0:vn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(ze[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Zd(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,b=yt(n.payload)&&!r.has("text"),y={kind:"text",...u,text:b?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),b?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(x=>x.text).join(""),y):(ed(n.payload)&&(y.spans=Zd(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),b=n.payload.symbol.kind.kind==="literal",y=m===void 0&&b&&n.payload.path!==""?n.payload.path:void 0,x=m??p;y===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let k={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),b=(P,L,Z)=>P??(L?Be(this.resolve(L)??""):void 0)??Z,y=b(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=b(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Be(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=fa(k,Pt(p),p.bandAboveColorHex));let $=x-y;if(p.total){let P=Be(this.resolve(p.total)??"");P!==void 0&&($=P)}let S=ec($,1,ma),H={kind:"gauge",...u,fraction:Vm(m,y,x),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:ec(k??0,0,S)};if(p.thresholdValue!==void 0&&x!==y){let P=(p.thresholdValue-y)/(x-y);P>=0&&P<=1&&(H.thresholdFraction=P)}return H}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),b=m.values,y=m.holes,x={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Pt(p),$=ad(p)?b.map(X=>fa(X,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",H=p.highlight==="lowest"||p.highlight==="both",P=bi(p),L={kind:"chart",...u,values:b,holes:y,style:p.style,domainMin:x.min,domainMax:x.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?P.high:"none",lowMarker:H?P.low:"none",pointColorHexes:$,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:tt(p.smoothing)??"off",fillStyle:_t(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:zt(p.barRadius),barCorners:Nt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Fm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},Z=y.length===0?b:b.filter((X,U)=>!y[U]);if(Z.length>0){let X=I=>b.findIndex((K,g)=>K===I&&y[g]!==!0),U=S?X(Math.max(...Z)):-1,ee=H?X(Math.min(...Z)):-1;U>=0&&(L.highIndex=U),ee>=0&&ee!==U&&(L.lowIndex=ee)}let T=Pm(p,x.min,x.max);T!==void 0&&(L.thresholdY=T);let O=this.chartNowIndex(p,b.length);return O!==void 0&&(L.nowIndex=O),L}case"timeline":{let p=n.payload,m=Bt(p),b=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=Li(b,Vt),x=Om(y,st(p)*60,C=>pd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:Rm(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};bt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Am(p,this.chartElements.get(p.chart),this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"chartDots":{let p=n.payload,m=mt(p.size),b={kind:"chartDots",...u,chart:p.chart,dots:pa(p.dots),diameter:0,indices:[]};return m!==void 0&&(b.size=m),p.colorHex!==void 0&&(b.colorHex=p.colorHex),b}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Dn(p.lines),colorHex:It(p.colorHex),thickness:On(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...jm(Wm(Fd(n,t).map(x=>this.resolveElement(x,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,k=this.resolve(x.value),C=k===void 0?void 0:Be(k);if(C!==void 0){let $=Math.min(x.minValue,x.maxValue),S=Math.max(x.minValue,x.maxValue),H={value:Math.min(S,Math.max($,C)),minValue:$,maxValue:S===$?$+1:S,colorHexes:x.colorHexes},P=this.resolve(x.minLabel);P!==void 0&&(H.minLabel=P);let L=this.resolve(x.maxLabel);L!==void 0&&(H.maxLabel=L),l.bezelGauge=H}}let b=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;b!==void 0&&(l.backgroundColorHex=b);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function Bm(e,n,t){let i=new dt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function _i(e,n,t){let i=new dt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Bm(e.inline,n,e)),a}function Aa(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var Vo=5,Gm=1.7,Um=1.8;function Km(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Wm(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Um,l=Math.max(o.frame.width*n.width,0),d=Km(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function ic(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function ac(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function Ia(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=L=>L==="triangle"?Vo+d:L==="dot"?Math.max(d,Gm):d,u=c(a),p=c(r),m=n.y+u,b=Math.max(n.h-u-p,1),y=m+b,x=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?b*.12:0,$=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-$*(i-1))/i,.5),H=L=>Math.min(1,Math.max(0,(L-e.domainMin)/x)),P=L=>y-H(L)*b;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:P(0),inset:d,yAtFraction(L){return y-Math.min(Math.max(L,0),1)*b},barRect(L){let Z=o+L*(S+$),T=t[L],O,X;if(k){let U=C+H(T)*(b-C);O=y-U,X=y}else O=P(T),X=k?y:P(0),O>X&&([O,X]=[X,O]);return{x:Z,y:O,w:S,h:Math.max(X-O,.5)}},point(L){let Z=Math.max(s-d*2,0);return{x:t.length>1?o+d+Z*L/(t.length-1):o+s/2,y:P(t[L])}},markerCenter(L,Z,T="high"){let O=Z?this.barRect(L):void 0,X=O?O.x+O.w/2:this.point(L).x,U=T==="high"?a:r,ee=T==="high"?U==="triangle"?n.y+Vo/2:m:U==="triangle"?n.y+n.h-Vo/2:y;return{x:X,y:ee}}}}function rc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function Uo(e,n,t=[]){let i=e.length,a=Ql(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,b=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let x=y-p,k=Math.exp(-(x*x)/(2*o*o));m+=e[y]*k,b+=k}return m/b}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function oc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var Hi=1;function ei(e,n){let t=Math.max(Un,Math.min(Kn,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-Hi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+Hi:n.y,h:n.h-i-Hi,cy:(e.labelsAbove?n.y+i+Hi:n.y)+(n.h-i-Hi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function jm(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&ic(r)===void 0)return{...i,isHidden:!0};let o=Ym(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function qm(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Ym(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=Aa(t,i);if(a.w<=0||a.h<=0)return;let r=ei(t,a).body;if(r.w<=0||r.h<=0)return;let o=Ia(t,r),s,l;if(gt(n.at)){let k=qm(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?ic(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,$)=>C>$?(C+$)/2:Math.min(Math.max(k,C),$),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let b=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(b,r.y+c/2,r.y+r.h-c/2),x=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(x-c/2)/i.height,m}var Ie=pe,zi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Ie,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],ti=zi.find(e=>e.measured);function gc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return zi.find(a=>a.screen.width===t&&a.screen.height===i)}function La(e,n){let t=Ie[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var qo={regular:400,medium:500,semibold:600,bold:700},Xm=1.15;function Ge(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function be(e,n,t="#FFFFFF"){let i=Ge(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var $t=e=>e*.55;function yc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Jm(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Zm(e,n,t){if(t<=0||e.length*$t(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/$t(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Qm(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function bc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function xc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function ef(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function vc(e,n){return e.reduce((t,i)=>t+i.text.length*$t(i.look.fontSize*n),0)}function tf(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:$t(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=$t(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function nf(e,n,t){if(t<=0||vc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*$t(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*$t(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function af(e,n,t){let i=ef(n),a=e.lineLimit===2&&t.w>0?tf(e.text,i,t.w):[e.text],r=bc(e.text,a),o=a.map((C,$)=>xc(C,r[$]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>vc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>nf(C,l,t.w)),{anchor:c,x:u}=yc(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,b=p*1.15,y=C=>C.map($=>{let S=be($.look.colorHex,"fill");return v`<tspan font-size=${$.look.fontSize*l} font-weight=${qo[$.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}),x=be(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,$)=>v`<tspan x=${u} y=${t.cy+m+($-(d.length-1)/2)*b}>${y(C)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${k}</text>`}function rf(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:af(e,e.parts,n);let t=be(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Qn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Jm(e.text,n.w/$t(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*$t(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Zm(y,o,n.w)),{anchor:l,x:d}=yc(e.alignment,n),c=Qm(e.text,e.spans),u=c?bc(e.text,i):[],p=(y,x)=>c?xc(y,u[x]??0,e.text,c,e.colorHex).map(k=>{let C=be(k.look,"fill");return v`<tspan fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}):y,m=o*1.15,b=s.length>1?v`${s.map((y,x)=>v`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(y,x)}</tspan>`)}`:p(s[0],0);return v`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${qo[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${b}</text>`}var Ko=2;function of(e,n){let t=be(e.colorHex,"stroke"),i=be(e.trackColorHex,"stroke","#FFFFFF"),a=be(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,b=Math.max(1,e.dotCount),y=m?n.w:n.h,x=m?n.h:n.w,k=Math.max(1,Math.min(x,y/b-Ko)),C=b*k+(b-1)*Ko,$=(m?n.cx:n.cy)-C/2+k/2;return v`${Array.from({length:b},(S,H)=>{let P=$+H*(k+Ko),L=H<e.filledCount?t:i;return v`<circle cx=${m?P:n.cx} cy=${m?n.cy:P} r=${k/2}
        fill=${L.stroke} fill-opacity=${L["stroke-opacity"]} />`})}`}if(e.style==="bar"){let m=n.w,b=Math.max(r,m*e.fraction),y=1;return v`
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function lf(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=ei(e,n),o=r?Qo(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=cf(e,a);return o===void 0?s:v`${s}${o}`}function Wo(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var sc=0;function wc(){return sc+=1,sc.toString(36)}function df(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function cf(e,n){let t=Ia(e,n),i=wc(),a=be(e.colorHex,"fill"),r=be(e.highColorHex,"fill",e.colorHex),o=be(e.lowColorHex,"fill",e.colorHex),s=(b,y)=>v`<circle cx=${b.x} cy=${b.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=b=>c?be(e.pointColorHexes[b],"fill",e.colorHex):a,p=b=>{let y=Ge(b)??Ge(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:y.color,opacity:y.opacity*.28};let x=uf(i,e.id,b),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(x)||d.set(x,v`<linearGradient id=${x} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        <stop offset="0" stop-color=${y.color} stop-opacity=${y.opacity*.28} />
        <stop offset="1" stop-color=${y.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${x})`,opacity:1}};if(e.style==="bars")for(let b=0;b<t.count;b++){if(e.holes[b]===!0)continue;let y=t.barRect(b),x=b===e.highIndex?r:b===e.lowIndex?o:u(b),k=Math.min(Math.max(e.barRadius,0),y.w/2,y.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[b]<0;l.push(v`<path d=${df(y,k,C)}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else l.push(v`<rect x=${y.x} y=${y.y} width=${y.w} height=${y.h} rx=${k}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`)}else{let b=Array.from({length:t.count},(C,$)=>t.point($)),y=e.holes.length>0,k=oc(t.count,e.holes).filter(C=>!y||C.length>1).map(C=>{let $=C.map(P=>b[P]),S=rc($,e.curve),H=`M${$[0].x} ${$[0].y}${S.map(P=>` ${Wo(P)}`).join("")}`;return{run:C,pts:$,legs:S,line:H}});if(e.style==="area")for(let{run:C,pts:$,legs:S,line:H}of k)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let P=0;P<S.length;P++){let L=$[P],Z=$[P+1],T=p(e.pointColorHexes[C[P+1]]),O=`M${L.x} ${L.y} ${Wo(S[P])} L${Z.x} ${t.baselineY} L${L.x} ${t.baselineY} Z`;l.push(v`<path d=${O} fill=${T.fill} fill-opacity=${T.opacity} stroke="none" />`)}else{let P=p(e.fillColorHex??e.colorHex),L=`${H} L${$[$.length-1].x} ${t.baselineY} L${$[0].x} ${t.baselineY} Z`;l.push(v`<path d=${L} fill=${P.fill} fill-opacity=${P.opacity} stroke="none" />`)}for(let{run:C,pts:$,legs:S,line:H}of k)if(c&&C.length>1)for(let P=0;P<S.length;P++){let L=$[P],Z=u(C[P+1]);l.push(v`<path d=${`M${L.x} ${L.y} ${Wo(S[P])}`} fill="none"
          ...
          stroke-width=${e.lineWidth} stroke-linecap="round" stroke-linejoin="round" />`);e.highIndex!==void 0&&l.push(s(b[e.highIndex],r)),e.lowIndex!==void 0&&l.push(s(b[e.lowIndex],o))}let m=(b,y,x,k)=>{if(b===void 0||y==="none")return;let C=t.markerCenter(b,e.style==="bars",k);l.push(y==="triangle"?v`<path d=${`M${C.x} ${C.y-1.8} L${C.x+2.2} ${C.y+1.8} L${C.x-2.2} ${C.y+1.8} Z`}
          fill=${x.fill} fill-opacity=${x["fill-opacity"]} />`:s(C,x))};if(m(e.highIndex,e.highMarker,r,"high"),m(e.lowIndex,e.lowMarker,o,"low"),e.drawsThreshold&&e.thresholdY!==void 0){let b=t.yAtFraction(e.thresholdY),y=be(e.thresholdColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${t.plotLeft} ${b} L${t.plotRight} ${b}`} fill="none"
      stroke=${y.fill} stroke-opacity=${y["fill-opacity"]}
      stroke-width="1" stroke-dasharray="2 2" />`)}if(e.drawsNowLine&&e.nowIndex!==void 0&&e.nowIndex<t.count){let b=t.markerCenter(e.nowIndex,e.style==="bars").x,y=be(e.nowColorHex,"fill",e.colorHex);l.push(v`<path d=${`M${b} ${t.plotTop} L${b} ${t.plotBottom}`} fill="none"
    ...
    <circle cx=${b.x} cy=${b.y} r=${3.2*n} fill=${fc(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?x(`${t}-gmin`,l-y-Math.max(o,3),l-y,e.minLabel):f}
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function Pa(e,n){let t=e.family in Ie?e.family:"rectangular",i=n.slot??Ie[t],a=Ie[t],r=La(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=Ge(e.backgroundColorHex),l=Ge(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=$c(c);if(t==="corner"){let x=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",$=C!=="",S=Na(x,k),H=ts(x,k),P=H/(a.width*x),L=S.tile.cx-H/2,Z=S.tile.cy-H/2,T=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,O=f;if(e.bezelGauge)O=Mf(e.bezelGauge,x,o);else if(e.bezelText){let U=Cf(x,`${o}-bezel`),ee=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Qn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;O=v`<defs><path id=${U.id} d=${U.d} /></defs>
        ...
        <text font-size=${uc*x} font-weight="600" fill=${U.color} fill-opacity=${U.opacity}
          ...
          <textPath href="#${ee.id}" startOffset="50%" text-anchor="middle">${cc(C,ee.length,uc*x*.88)}</textPath></text>`}else{let U=e.borderWidth*r.scale*P,ee=l?v`<circle cx=${H/2} cy=${H/2} r=${H/2-U/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${U} />`:f;X=v`<g transform="translate(${L} ${Z})">
        <g clip-path=${`url(#${o})`}>
      ...
      ${O}
      ${X}
    </svg>`}let p=v`<rect width=${i.width} height=${i.height} />`,m=l?v`<rect x=${d/2} y=${d/2} width=${i.width-d} height=${i.height-d} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${d} />`:f,b=v`<rect width=${i.width} height=${i.height} fill="#000000" />`,y=`0 0 ${i.width} ${i.height}`;return v`<svg viewBox=${y} xmlns="http://www.w3.org/2000/svg" class="complication ${t}"
    ...
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Nu(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map(($,S)=>h`<button type="button" role="option" aria-selected=${S===d?"true":"false"} class="ent ${S===d?"hl":""}"
                @mousedown=${H=>H.preventDefault()} @click=${H=>b($,H.target)}>
  ...
  </button>`}function Pu(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(De),m=a!==void 0,b=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=hg(u,c),x=$=>{t($),a?.($.startsWith(De)?e.icons.mdiPath?.($):void 0),r.noteUsed($)},k=$=>{if(t($),!m)return;let S=$.trim();a?.(S.startsWith(De)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&b==="mdi"){let $=e.icons.mdiNames?.(),S=mg($??[],s),H=S.slice(0,gu),P=r.recent.filter(L=>L.startsWith(De));C=h`<div class="sym-browse">
      ${xu(r,i,b)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${xe(L=>r.setQuery(i,L))} />
      </div>
      ${P.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${P.map(L=>Xa(e,L,L===u,x))}</div>`}
      <div class="sym-grid">${H.map(L=>Xa(e,L,L===u,x))}</div>
      ${$===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${bu(H.length,S.length,!0,$.length)}</div>`}
    ...
    </div>`}else if(o){let $=r.category(i),S=cg($,s,d,c),H=os(S.names,s),P=S.fromPack?H.slice(0,gu):H,L=r.recent.filter(T=>!T.startsWith(De)),Z=c.size===0?L:L.filter(T=>c.has(T));C=h`<div class="sym-browse">
      ${m?xu(r,i,b):f}
      <div class="sym-controls">
    ...
    <label class="field"><span>Symbol</span>
      <input type="text" class="mono" .value=${n} placeholder="lightbulb.fill"
        @input=${xe(k)} @change=${xe($=>{let S=$.trim();S.startsWith(De)?e.icons.mdiPath?.(S)!==void 0&&r.noteUsed($):(c.size===0||c.has(S))&&r.noteUsed($)})} /></label>
  ...
  </div>`}function lr(e,n,t,i){let a=Pt({bands:e.bands}),r=i!==void 0&&Number.isFinite(i)?i:void 0,o=r===void 0?void 0:a.find(c=>r<=c.upTo)?.id??"above",s=(c,u)=>p=>{let m=p.bands.find(b=>b.id===c);m&&u(m)},l=e.bandAboveColorHex,d={atDefault:_s(l,oe),title:`Back to ${oe}`,reset:()=>t(c=>{c.bandAboveColorHex=oe})};return h`<div class="bands">
    ${Mg(a,l,r)}
    ${a.map(c=>h`
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    ${e.timeLabelCount<=0?f:h`
      ...
      ${a}`}`}var gy=[["number","Number"],["entity","Entity"]];function yy(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function by(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function xy(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=yy(n,o),c=s?n.minValue:n.maxValue,u=y=>a(x=>{s?x.minValue=y??0:x.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${Ne(l,d==="number"?Xt(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${gy.map(([y,x])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a(k=>by(k,o,y))}}>${x}</button>`)}
      </span>
    </div>`,b=s?n.minSource:n.maxSource;return d==="number"||b===void 0?h`<div class="field gauge-end">${m}${fr(c,u,{ariaLabel:l})}</div>`:h`<div class="field gauge-end">${m}${ce(e,b,y=>a(x=>{s?x.minSource=y:x.maxSource=y},`${o}src`),{showResolved:!0,noLabel:!0,label:l,key:`${i}-${o}source`})}</div>
    ...
    ${s==="rich"?Iy(e,n,t,i,a):h`
        ${Qu(e,n,a)}
        ${ce(e,r.value,x=>i(k=>{k.value=x},"value"),{showResolved:!0,label:s==="countdown"?"Until":"Text",key:`${a}-value`})}
        ${Ps(e,s==="countdown",r.value,x=>b(x?"countdown":"plain",null))}
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Fe(d,ue(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Iy(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ue(e),d=Math.max(0,o.findIndex(I=>I.id===ji.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Le(e.config,t,n).size??r.fontSize,b=(I,K)=>{Ct.delete(s),i(g=>{I(g),td(g)},K)},y=(I,K)=>b(g=>{let w=g.parts?.find(E=>E.id===c.id);w&&I(w)},K?`part-${c.id}-${K}`:void 0),x=(I,K)=>{ji.set(s,I),Ct.delete(s),Me(K)},k=(I,K)=>{let g=J();ji.set(s,g),b(w=>{(w.parts??=[]).push({id:g,value:I})}),Ou(K,yr(`${a}-part-${g}`),!0)},C=I=>b(K=>{K.parts&&Xi(K.parts,d,I)}),$=()=>{let I=o[d+1]??o[d-1];I&&ji.set(s,I.id),b(K=>{K.parts=(K.parts??[]).filter(g=>g.id!==c.id)})},S=o.map((I,K)=>{let g=Ty(I.value,l),w=I.id===c.id,E=As(I),R=g.kind==="value"?e.resolve(I.value):void 0,F=I.fontWeight===void 0?void 0:ri.find(([G])=>G===I.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${w?"true":"false"} class="part-chip ${g.kind} ${w?"on":""}"
      ...
      ${g.kind==="text"?h`<span class="part-txt">${g.label===""?h`<span class="part-empty">empty</span>`:Sy(g.label).map(G=>G.space?h`<span class="part-sp">${"\xB7".repeat(G.text.length)}</span>`:G.text)}</span>`:h`<span class="part-txt">${g.label}</span>`}
    ...
    </button>`}),H=r.rules.some(I=>I.partId===c.id),P=c.value.kind.kind==="literal",L=As(c),Z=c.fontSize!==void 0,T=ri.find(([I])=>I===r.fontWeight)?.[1]??r.fontWeight,O=I=>{I>=Ts&&I<=Es&&y(K=>{K.fontSize=I},"size")},X=L==="bands"?at(e.resolve(c.value)??""):[],U={layer:"Use the layer colour",...P&&L!=="bands"?{bands:"By value needs a live value"}:{}},ee=(I,K)=>y(g=>{let w={bands:g.bands??[],bandAboveColorHex:g.bandAboveColorHex??oe};I(w),w.bands.length>0?g.bands=w.bands:delete g.bands,w.bandAboveColorHex!==oe?g.bandAboveColorHex=w.bandAboveColorHex:delete g.bandAboveColorHex},K);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${I=>k(_(""),I.currentTarget)}>${B("text")}<span>Add text</span></button>
        <button type="button" class="small" title="Add a part that shows a live value"
          @click=${I=>k({kind:{kind:"entityState",entityId:"",displayName:"",domain:""}},I.currentTarget)}>${B("braces")}<span>Add value</span></button>
      </div>
    </div>
    <div class="part-editor">
      ...
      ${ce(e,c.value,I=>y(K=>{K.value=I},"value"),{showResolved:!0,label:P?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ${P?h`<div class="hint">Spaces count, and show as dots in the parts list. Type one at the start or end when this part needs a gap.</div>`:f}
      ${te("Colour",L,wy,I=>y(K=>{if(I==="layer"){delete K.colorHex,delete K.coloring;return}if(I==="pick"){delete K.coloring,K.colorHex=_s(p,"#FFFFFF")?"#64D2FF":p;return}delete K.colorHex,K.coloring="bands",(K.bands?.length??0)===0&&(K.bands=sr(at(e.resolve(K.value)??"")))}),{def:"layer",titles:U,...P&&L!=="bands"?{disabled:{bands:!0}}:{}})}
      ${L==="pick"?ve("Part colour",c.colorHex,I=>y(K=>{K.colorHex=I??p},"color")):f}
      ${L==="bands"?h`
      ...
      <div class="field seg-field">${Ne("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>y(I=>{delete I.fontWeight})})}
        ${rr("Weight",c.fontWeight,ri,I=>y(K=>{K.fontWeight=I}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${Ne("Font size",Z?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(I=>{delete I.fontSize})}:void 0,mr(c.fontSize??m,O,{step:1,min:Ts,max:Es}))}
        ${fr(c.fontSize,I=>{I===void 0?y(K=>{delete K.fontSize},"size"):O(I)},{step:1,min:Ts,max:Es,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:Z?"Part font size":`Part font size, ${m} pt from the layer`,...Z?{}:{lead:B("link")}})}
      </label>
    </div>
  </div>`}function tp(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(g=>g.payload.id===a),o=`el-${a}`,s=(g,w)=>e.update(E=>g(E.elements[r]),w?`${o}-${w}`:void 0),l=Le(e.config,t,n),d=l.frame,c=(g,w)=>e.update(E=>He(E,t,a,{frame:ms(d,g)}),`${o}-${w}-${t}`),u=Te(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=g=>u[g],b=!1,y=g=>Wi(n)===void 0?f:ve(g,Wi(n),w=>s(E=>{Wi(E)!==void 0&&(E.payload.colorSlot.baseColorHex=w??"#FFFFFF")},"color"),!1,p),x,k,C;switch(n.kind){case"text":{let g=(w,E)=>s(R=>w(R.payload),E);k=Ay(e,n,t,g,o),b=!n.payload.countdown&&!yt(n.payload),C=h`
        ${Za(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${te("Weight",n.payload.fontWeight,ri,w=>s(E=>{E.payload.fontWeight=w}),{def:u.fontWeight})}
        ${ig({label:"Align",value:n.payload.alignment??"center",options:Qg,def:"center",set:w=>s(E=>{let R=E.payload;w==="center"?delete R.alignment:R.alignment=w})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:ey,def:"1",set:w=>s(E=>{let R=E.payload;w==="2"?R.lineLimit=2:delete R.lineLimit})})}
        ${Ce("Mono digits",n.payload.monospacedDigits===!0,w=>s(E=>{let R=E.payload;w?R.monospacedDigits=!0:delete R.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${b?vy(e,n.payload,g,y("Main colour")):f}`;break}case"icon":k=h`
        ${ce(e,n.payload.symbol,g=>s(w=>{w.payload.symbol=g},"symbol"),{noFormat:!0,showResolved:!0,symbol:!0,label:"Symbol",key:`${o}-symbol`,setSymbolPath:g=>s(w=>{let E=w.payload;g?E.path=g:delete E.path},"symbol")})}
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,C=Za(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let g=n.payload,w=(R,F)=>s(G=>R(G.payload),F),E=g.style==="dots";k=h`
        ${ce(e,g.value,R=>w(F=>{F.value=R},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${E?h`
            ${ce(e,g.total??vu(g),R=>w(F=>{F.total=R},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${ma} dots are drawn.</div>`:xy(e,g,{min:u.minValue,max:u.maxValue},o,w)}`,b=!0,C=h`
        <div class="grid2">
          ${te("Style",g.style,Ag,R=>w(F=>{R==="dots"&&F.total===void 0&&(F.total=vu(F)),R!=="dots"&&delete F.total,F.style=R}),{titles:Ig,def:u.style})}
          ${E?f:Za(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${ve(E?"Empty dot colour":"Track colour",g.trackColorHex,R=>w(F=>{F.trackColorHex=R??"#FFFFFF40"},"track"),!1,u.trackColorHex)}
        ${te("Colour",g.coloring,Rs,R=>w(F=>{F.coloring=R,R==="bands"&&F.bands.length===0&&(F.bands=sr([F.minValue,F.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${g.coloring==="bands"?h`
          ...
          ${lr(g,g.colorSlot.baseColorHex,w,at(e.resolve(g.value)??"")[0])}`:f}
        ${E?f:h`
          <div class="grid2">
            ${ae("Threshold",g.thresholdValue,R=>w(F=>{R===void 0?delete F.thresholdValue:F.thresholdValue=R},"thr"),{optional:!0})}
            ${g.thresholdValue===void 0?f:ve("Threshold colour",g.thresholdColorHex,R=>w(F=>{F.thresholdColorHex=R??Gn},"thrcol"),!1,Gn)}
          </div>
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let g=n.payload,w=(M,A)=>s(me=>M(me.payload),A),E=u.historyMinutes,R=u.historyPoints,F=g.historyMinutes>0,G=F&&g.source==="statistics",q=F&&!G,le=F?G?"statistics":"history":"value",Ke=G?Ci:mn,rt=gn(g)??yn(g),_e=g.value.kind.kind==="entityState",he=rt===void 0?void 0:e.historySeries(rt),Pe=F&&_e?he??"":e.resolve(g.value)??"",We=g.historyPoints<1,Vp=q&&_e&&rt!==void 0?e.historyReadings?.(rt):void 0,Zs=uy(We,Vp,Mn(g.historyMinutes)),Qs=Fs(a,g.historyMinutes,Ke),kr=F&&_e?Go(Pe):{values:at(Pe),holes:[]},In=kr.values,el=M=>g.limit>0&&M.length>g.limit?g.takeFromEnd?M.slice(M.length-g.limit):M.slice(0,g.limit):M,Bp=el(In),Et=Uo(Bp,tt(g.smoothing),kr.holes.length>0?el(kr.holes):[]),Gp=!F&&_e&&In.length===1,$r=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),Up=ue(e),ea=g.scaleFrom!==void 0&&$r.some(M=>M.payload.id===g.scaleFrom);k=h`
        ${ce(e,g.value,M=>w(A=>{A.value=M},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${te("Draw",le,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],M=>w(A=>{if(M==="value"){A.historyMinutes=0;return}A.source=M==="statistics"?"statistics":"history";let me=A.historyMinutes||ga;A.historyMinutes=M==="statistics"?Math.min(me,Qr):Math.min(me,ya)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${G?h`
            ...
            <div class="grid2">
              ${Cs(a,g.historyMinutes,E,M=>w(A=>{A.historyMinutes=M}),Ci)}
              ${te("Per",g.statPeriod,ha,M=>w(A=>{A.statPeriod=M}),{def:vi})}
            </div>
            ${Qs?Ss(g.historyMinutes,M=>w(A=>{A.historyMinutes=M},"span"),!0):f}
            ${te("Read",g.statType,Wr,M=>w(A=>{A.statType=M}),{def:wi})}
        ...
        ${q?h`
            ${_e?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Cs(a,g.historyMinutes,E,M=>w(A=>{A.historyMinutes=M}))}
              <div class="field readings-field">${Ne("Points",{atDefault:g.historyPoints===R,title:`Back to ${R<1?"every one":`${R} averaged`}`,reset:()=>w(M=>{M.historyPoints=R})})}
                <div class="readings-row">
                  ...
                  ${We?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(g.historyPoints)}
                      ...
                      @input=${xe(M=>{let A=Number(M);M.trim()!==""&&Number.isFinite(A)&&A>=1&&w(me=>{me.historyPoints=Math.round(A)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${Qs?Ss(g.historyMinutes,M=>w(A=>{A.historyMinutes=M},"span")):f}
        ...
        ${F?h`
            ${Ce("Show gaps when unavailable",g.gaps===!0,M=>w(A=>{M?A.gaps=!0:delete A.gaps}),u.gaps===!0)}
            ${Yt(e)}
        ...
        ${F&&g.limit<=0?f:h`
        <div class="grid2">
          ${ae("Only draw",g.limit,M=>w(A=>{A.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${g.limit<=0?f:te("Keep",g.takeFromEnd?"end":"start",F?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],M=>w(A=>{A.takeFromEnd=M==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ${F?h`<div class="hint warn">Span and slots already set how much is drawn, so set this to 0.
              Trimming here draws only ${g.limit} of the readings fetched above, while clock times still label the whole span.</div>`:h`<div class="hint">${g.limit<=0?"0 draws every reading. Type a number to draw only that many.":`Draws only ${g.limit} of the numbers: the first or the last ones. A forecast sensor often carries 24 or 48.`}</div>`}`}
        ${Re("Smooth data",tt(g.smoothing)??"off",vg,M=>w(A=>{let me=tt(M);me===void 0?delete A.smoothing:A.smoothing=me}),{def:tt(u.smoothing)??"off"})}
        ${Yt(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,b=!0;let Kp=(()=>{if(ea)return!0;if(g.scale==="fixed")return g.minValue<0&&g.maxValue>0;let M=Et.filter(qp=>Number.isFinite(qp));if(M.length===0)return!0;let A=Math.min(...M,g.thresholdValue??1/0),me=Math.max(...M,g.thresholdValue??-1/0);return A<0&&me>0})();C=h`
        <div class="grid2">
          ${te("Style",g.style,wg,M=>w(A=>{A.style=M}),{def:u.style})}
          ${g.style==="bars"?ae("Bar gap",g.barGap,M=>w(A=>{A.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):Za(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${g.style==="bars"?h`
          <div class="grid2">
            ${ae("Corner radius",zt(g.barRadius),M=>w(A=>{let me=Math.max(0,M??Vn);me===Vn?delete A.barRadius:A.barRadius=me},"barradius"),{step:.5,min:0,def:zt(u.barRadius),unit:"pt"})}
          </div>
          ${Ce("Round top only",Nt(g.barCorners)==="top",M=>w(A=>{M?A.barCorners="top":delete A.barCorners}),Nt(u.barCorners)==="top")}
          ${Yt(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${te("Curve",g.curve??"straight",yg,M=>w(A=>{M==="straight"?delete A.curve:A.curve=M}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${Yt(e)}
          ${g.style==="area"?h`
            ${te("Fill",_t(g.fillStyle),bg,M=>w(A=>{M==="flat"?delete A.fillStyle:A.fillStyle=M}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:_t(u.fillStyle)})}
            ${mu("Fill colour",g.fillColorHex,"Line colour",M=>w(A=>{M===void 0?delete A.fillColorHex:A.fillColorHex=M},"fillcol"))}
            ${Yt(e)}`:f}`}
        <div class="grid2">
          ${te("Scale",g.scale,kg,M=>w(A=>{A.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${te("Baseline",g.baseline,$g,M=>w(A=>{A.baseline=M}),{def:u.baseline})}
        </div>
        ${$r.length===0?f:Re("Same scale as",ea?g.scaleFrom:"",[["","Its own"],...$r.map(M=>[M.payload.id,Fe(M,Up)])],M=>w(A=>{M?A.scaleFrom=M:delete A.scaleFrom}),{def:""})}
        ...
        ${!ea&&g.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",g.minValue,M=>w(A=>{A.minValue=M??0},"cmin"),{def:u.minValue})}
              ${ae("Max",g.maxValue,M=>w(A=>{A.maxValue=M??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        ${te("Colour",g.coloring,Rs,M=>w(A=>{A.coloring=M,M==="bands"&&A.bands.length===0&&(A.bands=sr(Et))}),{def:u.coloring})}
        ${y("Main colour")}
        ${g.coloring==="bands"?h`
          ...
          ${lr(g,g.colorSlot.baseColorHex,w)}
          ${g.style==="area"?h`${Ce("Band fill",g.fillBands,M=>w(A=>{A.fillBands=M}),u.fillBands)}
        ...
        ${Ce("Threshold",g.thresholdValue!==void 0,M=>e.update(A=>{Sd(A,a,M?Sg(Et):void 0)}))}
        ${g.thresholdValue===void 0?f:h`
          <div class="grid2">
            ${ae("At",g.thresholdValue,M=>w(A=>{A.thresholdValue=M??0},"thval"))}
          </div>
          ${tl("threshold")}
        ...
        ${Ce("Now",g.nowIndex!==void 0,M=>e.update(A=>{Td(A,a,M)}))}
        ${g.nowIndex===void 0?f:h`
          ${ce(e,g.nowIndex,M=>w(A=>{A.nowIndex=M},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${tl("now")}
        ...
        ${g.style!=="bars"||nl.length>0?Ce("Dots",nl.length>0,M=>e.update(A=>{if(M)bo(A,a);else for(let me of Kt(A,a))ge(A,me.payload.id)})):f}
        ${g.style==="bars"?h`<div class="hint keep">Dots on the readings are drawn on a line or area chart, so they are offered
        ...
        ${Yt(e)}`;break}case"timeline":{let g=n.payload,w=(he,Pe)=>s(We=>he(We.payload),Pe),E=u.historyMinutes,R=g.value.kind.kind==="entityState",F=Bt(g),G=F===void 0?void 0:e.historySeries(F),q=st(g)*60,le=Li(G??"",Vt),Ke=Fs(a,g.historyMinutes),rt=g.value.kind.kind==="entityState"?g.value.kind.entityId:void 0,_e=Rg(le,q,rt===void 0?void 0:e.hass.states[rt]?.state,rt?.split(".")[0]);k=h`
        ${ce(e,g.value,he=>w(Pe=>{Pe.value=he},"value"),{label:"States",noShare:!0,key:`${o}-value`})}
        ...
        ${Cs(a,g.historyMinutes,E,he=>w(Pe=>{Pe.historyMinutes=he}))}
        ${Ke?Ss(g.historyMinutes,he=>w(Pe=>{Pe.historyMinutes=he},"span")):f}
        ...
        ${Fg(g,w,_e,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ae("Gap",g.gap,he=>w(Pe=>{Pe.gap=Math.min(xa,Math.max(0,he??0))},"tgap"),{step:.5,min:0,max:xa,def:u.gap,unit:"pt"})}
          ${ae("Corner radius",g.cornerRadius,he=>w(Pe=>{Pe.cornerRadius=Math.max(0,he??0)},"tradius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"})}
        </div>
        ...
        ${Su(g,w,u,"tl",h`
          <div class="hint">Clock times from the start of the span to now, evenly spaced. Four is what
            ...
            minutes past a three hour span.</div>`)}`;break}case"shape":k=h`<div class="grid2">
          ${te("Shape",n.payload.kind,[["roundedRectangle","Rounded"],["rectangle","Rectangle"],["capsule","Capsule"],["circle","Circle"],["line","Line"]],g=>s(w=>{w.payload.kind=g}),{titles:{roundedRectangle:"Rounded rectangle",line:"A rule along the frame's long side"},def:u.kind})}
          ${n.payload.kind==="roundedRectangle"?ae("Corner radius",n.payload.cornerRadius,g=>s(w=>{w.payload.cornerRadius=g??6},"radius"),{step:.5,min:0,def:u.cornerRadius,unit:"pt"}):f}
        </div>
        ${n.payload.kind==="line"?ly(t,d,c):f}`,C=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,g=>s(w=>{w.payload.thickness=g??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ${ve("Border colour",n.payload.borderColorHex,g=>s(w=>{g===void 0?delete w.payload.borderColorHex:w.payload.borderColorHex=g},"border"),!0,null)}
        ${n.payload.borderColorHex!==void 0?ae("Border width",n.payload.borderWidth,g=>s(w=>{w.payload.borderWidth=g??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let g=n.payload,w=(G,q)=>s(le=>G(le.payload),q),E=g.entity.entityId?e.hass.states[g.entity.entityId]?.attributes?.entity_picture:void 0,R=typeof E=="string"?E:void 0,F=R!==void 0&&!R.startsWith("/");k=h`
        ${te("Source",g.source,[["camera","Camera"],["entityPicture","Entity picture"]],G=>w(q=>{q.source=G}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:u.source})}
        ${g.source==="camera"?h`
        ...
        ${te("Picture",g.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],G=>w(q=>{q.contentMode=G}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:u.contentMode})}
        ${qi("Zoom",g.zoom,G=>w(q=>{q.zoom=G},"zoom"),{min:es,max:4,step:.05,def:1,format:G=>`${G.toFixed(2)}x`,unit:"x"})}
        ${qi("Pan left/right",g.panX,G=>w(q=>{q.panX=G},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${qi("Pan up/down",g.panY,G=>w(q=>{q.panY=G},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${g.contentMode==="fit"&&g.zoom===1?"hint keep":"hint"}>${iy(g)}</div>
        ${ae("Corner radius",g.cornerRadius,G=>w(q=>{q.cornerRadius=Math.max(0,G??Wn)},"imgradius"),{step:1,min:0,def:Wn,unit:"pt"})}`;break}case"tap":{k=h`
        ${np(e,n.payload,(g,w)=>s(E=>g(E.payload),w),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let g=n.payload,w=(F,G)=>s(q=>F(q.payload),G),E=e.config.elements.find(F=>F.payload.id===g.chart),R=E?.kind==="chart"?E:void 0;k=h`
        ...
        <div class="hint">The clock times of that chart's span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,C=Su(g,w,u,"ct",h`
        <div class="hint">Evenly spaced from the start of the chart's span to now. Auto follows the watch's
          own clock and drops the minutes past a three hour span.</div>`);break}case"chartDots":{let g=n.payload,w=(q,le)=>s(Ke=>q(Ke.payload),le),E=e.config.elements.find(q=>q.payload.id===g.chart),R=E?.kind==="chart"?E:void 0,F=R===void 0?void 0:Le(e.config,t,R).size??R.payload.lineWidth,G=F===void 0?void 0:Math.round(F*18)/10;k=h`
        ${Eu(e,R)}
        ...
        ${Yt(e)}`,C=h`
        ${te("Dots",g.dots,xg,q=>w(le=>{le.dots=q}),{titles:{auto:"A dot on every reading while they sit far enough apart to tell apart, none on a crowded chart",all:"A dot on every reading"},def:"auto"})}
        <div class="grid2">
          ${ae("Dot size",g.size??G,q=>w(le=>{let Ke=mt(q);Ke===void 0||Ke===G?delete le.size:le.size=Ke},"dotsize"),{step:.5,min:1,max:12,...G===void 0?{}:{def:G},unit:"pt"})}
          ${mu("Dot colour",g.colorHex,"Series colour",q=>w(le=>{q===void 0?delete le.colorHex:le.colorHex=q},"dotcol"))}
        </div>
        <div class="hint">Auto leaves the dots off once the readings sit too close to tell apart. Left alone, a dot
          is a little wider than the chart's line and takes the colour the series has at its reading.</div>`;break}case"chartGrid":{let g=n.payload,w=(F,G)=>s(q=>F(q.payload),G),E=e.config.elements.find(F=>F.payload.id===g.chart),R=E?.kind==="chart"?E:void 0;k=h`
        ${Eu(e,R)}
        ...
        ${Yt(e)}`,C=h`
        <div class="grid2">
          ${ae("Lines",g.lines,F=>w(G=>{G.lines=Dn(F??Pn)},"lines"),{step:1,min:1,max:4,def:Pn})}
          ${ae("Thickness",g.thickness,F=>w(G=>{G.thickness=On(F??Nn)},"thick"),{step:.25,min:Ur,max:Kr,def:Nn,unit:"pt"})}
        </div>
        ${ve("Colour",g.colorHex,F=>w(G=>{G.colorHex=F??un},"gridcol"),!1,un)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let $=b||Wi(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&yt(n.payload)?"Layer colour":"Colour"),S=So(e.config,n),H=S?{kind:{kind:"entityState",...S}}:void 0,P=n.kind==="image"?n.payload.timestamp===!0:!1,L=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,Z=Ly[n.kind],T=_y[n.kind],O=$s(n.payload,u,Z),X=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,U=e.config.perFamily[t]?.placements[a]?.size!==void 0,ee=$s(n.payload,u,T)||X!==void 0&&l.size!==void 0&&l.size!==u[X],I=bn(e.config,a),K=(g,w)=>()=>s(E=>Qa(E.payload,u,g),w);return h`
    ${Se(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"?f:Qu(e,n,o)}${k}`,{color:Q.content,icon:"content",summary:Ns(e,n),...O?{reset:()=>s(g=>{Qa(g.payload,u,Z),g.kind==="text"&&Bi(g.payload.rules)},"reset-content")}:{}})}
    ${C===void 0&&$===void 0?f:Se(e,"look",n.kind==="image"?"Picture":"Look",h`${C??f}${$??f}`,{color:Q.look,icon:n.kind==="image"?"image":"look",...cr(n)?{summary:cr(n)}:{},...ee?{reset:()=>e.update(g=>{Qa(g.elements[r].payload,u,T),U&&He(g,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?Se(e,"numbers","Extras",Dy(e,n,x),{color:Q.numbers,icon:"text",summary:Py(e,n),...I.length>0||Xe(e.config,a).length>0||Ut(e.config,a).length>0||Kt(e.config,a).length>0||Wt(e.config,a).length>0||$s(n.payload,u,Mu)?{reset:()=>e.update(g=>{for(let E of bn(g,a))ge(g,E.payload.id);for(let E of Xe(g,a))ge(g,E.payload.id);for(let E of Ut(g,a))ge(g,E.payload.id);for(let E of Kt(g,a))ge(g,E.payload.id);for(let E of Wt(g,a))ge(g,E.payload.id);let w=g.elements.find(E=>E.payload.id===a);w&&Qa(w.payload,u,Mu)})}:{}}):f}
    ${n.kind==="image"?Se(e,"timestamp","Timestamp",ay(n.payload,(g,w)=>s(E=>g(E.payload),w)),{color:Q.numbers,icon:"clock",summary:P?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...P?{reset:K(Hy,"reset-stamp")}:{}}):f}
    ${Se(e,"states","States",cp(e,n.payload.rules,n.kind,g=>g.elements.find(w=>w.payload.id===a)?.payload.rules,`rules-${a}`,H,L),{color:Q.states,icon:"states",summary:Pi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(g=>{g.payload.rules=[]})}:{}})}
    ...
    <div class="field list-field"><span>Add</span>
      <div class="adders">
        ${Bn.map(([y,x])=>h`
          <button class="small" title=${u.has(y)?`Add another ${x.toLowerCase()}`:`Add the ${x.toLowerCase()}`}
            @click=${()=>d(y)}>${B("plus")}<span>${x}</span></button>`)}
      </div>
    </div>
    ...
    <div class="field list-field"><span>Mark</span>
      <div class="adders">
        ${pn.filter(([y])=>gt(y)).map(([y,x])=>h`
          <button class="small" title=${p.has(y)?`Add another mark over the ${x.toLowerCase()}`:`Mark the ${x.toLowerCase()}`}
            @click=${()=>c(y)}>${B("plus")}<span>${x}</span></button>`)}
      </div>
    </div>
    ...
    ${b===0?f:h`
      ...
      <div class="chart-numbers">
        ${a.map(y=>m(y.payload.id,e.resolve(y.payload.value)??"--",Fe(y,i),"Number"))}
        ${l.map(y=>{let{at:x,place:k}=y.payload.chartAnchor,C=pn.find(([S])=>S===x)?.[1]??"Reading";if(k==="through")return m(y.payload.id,x==="now"?"\u2502":"\u2500",x==="zero"?"Zero":C,"Line");let $=y.kind==="text"?e.resolve(y.payload.value)??"\u25CF":y.kind==="icon"?Vy(e.resolve(y.payload.symbol)):"\u25C6";return m(y.payload.id,$,C,"Marker")})}
        ${r.map(y=>m(y.payload.id,B("clock"),"Clock times","Times"))}
        ${o.map(y=>m(y.payload.id,B("chartDots"),"Reading dots","Dots"))}
        ${s.map(y=>m(y.payload.id,B("chartGrid"),"Grid lines","Grid"))}
      </div>
      <div class="hint">Click a row to edit that layer. The × deletes it, and Undo brings it back. Dots and grid
        ...
        dot to pick the dots.</div>`}`}function Oy(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ve(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=To(e.config,n);return h`
    ...
    ${te("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=_("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${te("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=_("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:_("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    ${Ce("End labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=_(String(s.minValue)),s.maxLabel=_(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ...
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function Xy(e,n,t,i,a,r,o,s){let l=e.liveBranch(n),d=e.forced.get(n.id)??"live",c=m=>d==="live"?m==="live":d==="otherwise"?m==="otherwise":d.caseId===m,u=(m,b)=>r(y=>{let x=y.find(k=>k.id===n.id);x&&m(x)},b),p=s!==void 0&&n.partId!==void 0;return h`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
    ...
    ${s===void 0?f:rp(s,n.partId,ue(e),m=>u(b=>{m?b.partId=m:delete b.partId}))}
    ...
    ${n.cases.map((m,b)=>Jy(e,m,b,n,a,u,`${o}-${m.id}`,p))}
    <div class="adders"><button class="small" @click=${()=>u(m=>{m.cases.push(zo())})}>+ case</button></div>
    ${Ce("Otherwise",n.otherwise!==void 0,m=>u(b=>{m?b.otherwise=b.otherwise??[]:delete b.otherwise}))}
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${sp(e,n.otherwise,a,m=>u(b=>{b.otherwise&&m(b.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function Jy(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(b=>b.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
    ...
    ${n.when.tests.map((c,u)=>Zy(e,c,u,p=>l(m=>{let b=m.when.tests.find(y=>y.id===c.id);b&&p(b)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(_o())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=uu(p,ou(e.hass?.states));l(b=>{b.when.tests.push(...m)})}}>
    ...
    ${sp(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function Zy(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=wn(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=ce(e,s.value??_(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${ce(e,s.value??_(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${ce(e,s.upper??_(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${ke("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!Qy(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Fu(e,"From",s.value??_("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Fu(e,"To",s.upper??_("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
    ...
    ${dp(e,n,a,o)}
  </div>`}function dp(e,n,t,i){let a=Ma(n.kind),r=f;if(a==="value"){let o=n.value??_("");if(lp.includes(n.kind)){let s=o.kind.kind==="literal";r=h`${s?ve("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>t(d=>{d.value=_(l??"#FFFFFF")},"color")):ce(e,o,l=>t(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${Yy(e,n,t,i,a,o)}`:ib(e,s.table,n[0],t,i,a,r,o)}function ib(e,n,t,i,a,r,o,s){let l=(g,w)=>e.update(E=>{let R=a(E);R&&g(R)},w?`${r}-${w}`:void 0),d=n.value??Au.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Zc(d)&&ab(e.resolve(d)),p=Ri[i],m=nr.get(r)??new Set,b=n.columns.length===0&&m.size===0?[Jc[i]]:[],y=Bc(n.columns,[...m,...b.filter(g=>g!==void 0)],p),x=er.get(r),k=t?t.partId:s?.some(g=>g.id===x)?x:void 0,C=s!==void 0&&k!==void 0,$=C?p.filter(g=>ur.includes(g)):p,S=C?y.filter(g=>!ur.includes(g)):[],H=(g,w)=>{if(!t){g?er.set(r,g):er.delete(r),Me(w);return}l(E=>{let R=E[0];R&&(g?R.partId=g:delete R.partId)})},P=t?e.liveBranch(t):"none",L=t?e.forced.get(t.id)??"live":"live",Z=g=>L!=="live"&&(L==="otherwise"?g==="otherwise":L.caseId===g),T=g=>{t&&e.setForced(t.id,Z(g)?"live":g==="otherwise"?"otherwise":{caseId:g})},O=g=>{Au.set(r,g),n.rows.length!==0&&l(w=>qc(w,g),"lhs")},X=()=>{er.delete(r),l(g=>{Wc(g,d??_(""),u),k!==void 0&&g[0]&&g[0].partId===void 0&&(g[0].partId=k)})},U=n.rows.map((g,w)=>Hu(e,{key:`${r}-${g.caseId}`,label:Xc(g.comparison,E=>we(E,ue(e))),columns:y,changes:g.changes,live:P===g.caseId,forced:Z(g.caseId),onForce:()=>T(g.caseId),when:db(e,g.comparison,`${r}-${g.caseId}`,(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===g.caseId)?.when.tests[0];G&&E(G.comparison)},R&&`${g.caseId}-${R}`)),updChanges:(E,R)=>l(F=>{let G=F[0]?.cases.find(q=>q.id===g.caseId);G&&E(G.then)},R&&`${g.caseId}-${R}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${w===0} @click=${()=>l(E=>cs(E,w,w-1))}>${B("up")}</button>
      <button class="icon" title="Move down" ?disabled=${w===n.rows.length-1} @click=${()=>l(E=>cs(E,w,w+1))}>${B("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>jc(E,g.caseId))}>${B("delete")}</button>`})),ee=n.otherwise===void 0?f:Hu(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:P==="otherwise",forced:Z("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(g,w)=>l(E=>{let R=E[0]?.otherwise;R&&g(R)},w),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(g=>us(g,!1))}>${B("close")}</button>`}),I=ir.get(r),K=rb.filter(g=>$.includes(g)&&!y.includes(g));return h`
    <div class="states">
      ${ce(e,d??_(""),O,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:rp(s,k,ue(e),H)}
      <div class="states-scroll"><table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(g=>h`<th>
              <span>${ct[g]}</span>
              <button class="icon" title=${`Remove the ${ct[g]} column`}
                @click=${w=>{ir.set(r,g),Me(w.target)}}>${B("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${xr(S.map(g=>ct[g]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${I===void 0?f:h`<div class="hint warn confirm-row">
        ...
        <button class="danger small" @click=${g=>{ir.delete(r),nr.get(r)?.delete(I),Me(g.target),l(w=>Yc(w,I))}}>Remove</button>
        <button class="small" @click=${g=>{ir.delete(r),Me(g.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          ...
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(g=>us(g,!0))}>${B("plus")}<span>Otherwise</span></button>`:f}
          ${K.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${g=>{let w=g.target,E=w.value;if(w.value="",!E)return;let R=nr.get(r)??new Set;R.add(E),nr.set(r,R),Me(w)}}>
            <option value="" selected>+ Column…</option>
            ${K.map(g=>h`<option value=${g}>${ct[g]}</option>`)}
          </select>`}
        </div>
      </div>
      ...
      <div class="states-switch">
        <button class="link" @click=${g=>{Is.add(r),Me(g.target)}}>Advanced</button>
    ...
    </div>`}function lb(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=Ma(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${ri.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??_(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(lp.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
...
`)}var _p="wrist-assistant-panel.layers.v1",St=34,An=200,ix=720,wr=320,ax=80,rx=56,zp="wrist-assistant-panel.columns.v3",js=e=>Math.max(An,Math.min(ix,Math.round(e))),Np=e=>e.metaKey||e.ctrlKey||e.shiftKey,ox=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Qi=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",en=Qi==="Cmd"?"\u2318":"Ctrl+",qs=Qi==="Cmd"?"\u21E7":"Shift+";function Pp(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-ax;if(i>=An*2+wr){let r=i-wr,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(An,Math.floor(o*l)),s=Math.max(An,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(An,o-d):s=Math.max(An,s-d))}return{columns:3,left:o,right:s}}let a=e-rx;return a>=An+wr?{columns:2,left:Math.min(n,a-wr),right:t}:{columns:1,left:n,right:t}}var z=class z extends Rt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Ip;this.colRight=Hp;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=ti.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=zc(()=>this.requestUpdate());this.imageSizes=Nc(()=>this.requestUpdate());this.symbols=new Ga(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Wa;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=Gs(a,this.hass.states);r.some(s=>zs(Fp(s.entityId)))||Us({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||zs(Rp)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??Jb}static{this.styles=Sr`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(pr,this.scrubStart),this.addEventListener(hr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},Yb)}loadColumnWidths(){try{let t=window.localStorage.getItem(zp);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=js(i.left)),typeof i.right=="number"&&(this.colRight=js(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(zp,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(_p);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(_p,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Eo(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let T=this.focusTapId();if(T!==void 0&&o===T&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,T,r??void 0);return}let O=this.hitLayerId(i);O?this.inspect={kind:"layer",id:O}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=Np(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=Eo(this.draft.config,o),p=this.draft.config.elements.find(T=>T.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=vt(this.draft.config,u),b=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||b)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let y=Le(this.draft.config,t,p).frame,x=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let T=p.payload,O=pe[t],X=y.width*O.width,U=y.height*O.height,ee={x:0,y:0,w:X,h:U,cx:X/2,cy:U/2},I=za(T,ee,_a(new Date));if(this.cancelGesture?.(),l){let E=x.width/O.width,R=T.timestampSize;this.cancelGesture=au(s,i,l,{w:I.w*E,h:I.h*E},(F,G)=>{let q=Math.min(40,Math.max(4,Math.round(R*F)));this.mutate(le=>{let Ke=le.elements.find(rt=>rt.payload.id===u);Ke?.kind==="image"&&(Ke.payload.timestampSize=q)},`ts-size-${u}`),G&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let K={x:0,y:0,w:y.width*x.width,h:y.height*x.height},g=bt(T)?{x:T.timestampX,y:T.timestampY}:{x:(I.x+I.w/2)/ee.w,y:(I.y+I.h/2)/ee.h},w=!1;this.cancelGesture=iu(s,K,i,g,(E,R,F)=>{F||(w=!0),w&&this.mutate(G=>{let q=G.elements.find(le=>le.payload.id===u);q?.kind==="image"&&(q.payload.timestampX=E,q.payload.timestampY=R)},`ts-${u}`),F&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let k=p.payload.chartAnchor,C=k!==void 0&&!gt(k.at)&&k.place!=="through",$=k!==void 0&&gt(k.at)&&k.place==="through",S=pe[t],H={dx:k?.dx??0,dy:k?.dy??0},P=k!==void 0&&!r?_i(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(T=>T.id===u)?.frame:void 0,L=P??y,Z=T=>Math.round(T*10)/10;this.cancelGesture?.(),this.cancelGesture=qa(s,x,i,{elementId:u,frame:L,handle:r??void 0},{onFrame:(T,O,X)=>{this.mutate(U=>{if(k===void 0){He(U,t,T,{frame:O});return}let ee=P?{width:y.width,height:y.height}:{width:O.width,height:O.height};He(U,t,T,{frame:{...O,...ee,x:C?O.x:y.x,y:y.y}});let I=U.elements.find(w=>w.payload.id===T)?.payload.chartAnchor;if(I===void 0)return;let K=H.dx,g=$?H.dy:Z(H.dy+(O.y-L.y)*S.height);K?I.dx=K:delete I.dx,g?I.dy=g:delete I.dy},`drag-${T}-${t}`),X&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=wt(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,Le(o,t,x).frame])),d=[...l.values()],c=Math.min(...d.map(x=>x.x)),u=Math.min(...d.map(x=>x.y)),p=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),b={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},y=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=qa(a,this.gestureCanvas(t),i,{elementId:r.id,frame:b},{onFrame:(x,k,C)=>{let $=k.x-b.x,S=k.y-b.y;this.mutate(H=>{for(let[P,L]of l)He(H,t,P,{frame:{...L,x:y(L.x+$),y:y(L.y+S)}})},`drag-group-${r.id}-${t}`),C&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?tu:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(wt(r,x).map(k=>k.payload.id),d,c,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(x=>x.payload.id===u);if(!p)return!1;let m=vt(r,u);if(m?.locked)return this.nudgeMany(wt(r,m.id).map(x=>x.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let b=Le(r,d,p).frame,y=gs(b,s,l,c);return(y.x!==b.x||y.y!==b.y)&&this.mutate(x=>He(x,d,u,{frame:y}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let H=l.elements.find(P=>P.payload.id===S);H&&c.set(S,Le(l,i,H).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),b=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),x={x:p,y:m,width:b-p,height:y-m,rotationDegrees:0},k=gs(x,o,s,a),C=k.x-x.x,$=k.y-x.y;return(C!==0||$!==0)&&this.mutate(S=>{for(let[H,P]of c)He(S,i,H,{frame:{...P,x:d(P.x+C),y:d(P.y+$)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=pe[i],c=Le(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=za(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},_a(new Date)),b=bt(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},y=nu(b,a,r,{w:u,h:p});return(y.x!==b.x||y.y!==b.y)&&this.mutate(x=>{let k=x.elements.find(C=>C.payload.id===t);k?.kind==="image"&&(k.payload.timestampX=y.x,k.payload.timestampY=y.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=La(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=ts(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ve(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=ye(s,l),c=Le(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=qa(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(b=>{d?Id(b,u,t,p):He(b,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Pp(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="right">
          <span class="badges">
            ${g?h`<span class="badge tap" title=${`Tappable \xB7 ${Fe(g,d)}`}>tap</span>`:f}
      ...
      </div>`},P=(T,O)=>{let X=this.inspect.kind==="group"&&this.inspect.id===T.id,U=!this.collapsed.has(T.id),ee=this.rowDrag(T.id,i),I=O[0],K=O[O.length-1],g=E=>{let R=E.currentTarget,F=R.getBoundingClientRect(),G=F.top+(R.classList.contains("drop-before")?St:0),q=F.bottom-(R.classList.contains("drop-after")?St:0),le=(E.clientY-G)/Math.max(1,q-G);return le<.25?"drop-before":!U&&le>.75?"drop-after":"drop-into"},w=O.map(E=>E.payload.id);return h`<div class="layer group ${X?"hl":""} ${S?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${ee.draggable}
        ...
        @drop=${E=>{E.preventDefault();let R=g(E);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!I||!K)){if(R==="drop-before"){this.reorderLayer(F,I.payload.id,!0,!0);return}if(R==="drop-after"){this.reorderLayer(F,K.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,I.payload.id,!0),this.mutate(G=>ko(G,F,T.id)))}}}>
      ...
      </div>`},L=[],Z=new Set;for(let T=0;T<l.length;T++){let O=l[T],X=O.payload.groupId,U=X===void 0?void 0:t.groups?.find(K=>K.id===X);if(!U){L.push(H(O,!1));continue}if(Z.has(U.id))continue;Z.add(U.id);let ee=l.filter(K=>K.payload.groupId===U.id);L.push(P(U,ee));let I=this.inspect.kind==="group"&&this.inspect.id===U.id;this.collapsed.has(U.id)||L.push(h`<div class="group-kids">${ee.map(K=>H(K,!0,I))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
      ...
      ${i.map(c=>{let u=l.resolve({kind:{kind:"named",id:c.id}}),p=this.openValue===c.id,m=()=>{this.setOpenValue(p?void 0:c.id)};return h`<div class="vitem ${p?"open":""}"><div class="datum vrow ${p?"hl":""}" role="button" tabindex="0" aria-expanded=${p?"true":"false"}
          ...
          ${this.canEdit?h`<button class="icon danger" title="Delete. Layers that read it keep their own copy." aria-label="Delete value" @click=${b=>{b.stopPropagation(),this.mutate(y=>{Ao(y,c.id)}),p&&(this.openValue=void 0)}}>${B("delete")}</button>`:f}
        </div>
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ${i.map(o=>{let s=this.hass.states[o],l=typeof s?.attributes.friendly_name=="string"?s.attributes.friendly_name:o,d=typeof s?.attributes.unit_of_measurement=="string"?` ${s.attributes.unit_of_measurement}`:"",c=s?`${s.state}${d}`:"not in Home Assistant",u=this.testValues.get(o),m=t.elements.find(b=>Sa(t,b.payload.id).some(y=>y.ref.entityId===o))?.kind??"text";return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${Ue[m]}`}
      ...
      <input type="checkbox" .checked=${i==="all"} .indeterminate=${i==="mixed"}
        @change=${r=>a(r.target.checked)} /></label>`}multiEditor(t,i){let a=this.canvasFamily,r=this.host(),o=ue(r),s=new dt(this.buildContext(),this.draft?.config),l=Zu(t,a,i),d=i.length,c=[...i].reverse(),u=m=>this.mutate(b=>{for(let y of i)He(b,a,y.payload.id,{isHidden:m})}),p=m=>this.mutate(b=>{for(let y of i){let x=b.elements.find(k=>k.payload.id===y.payload.id);x&&x.kind!=="image"&&x.kind!=="tap"&&x.kind!=="timeline"&&x.kind!=="chartTimes"&&x.kind!=="chartDots"&&x.kind!=="chartGrid"&&(x.payload.colorSlot.baseColorHex=m)}},"multi-colour");return h`
    ...
    </details>`}};D([_n({attribute:!1})],z.prototype,"hass",2),D([_n({type:Boolean})],z.prototype,"narrow",2),D([_n({attribute:!1})],z.prototype,"panel",2),D([V()],z.prototype,"colLeft",2),D([V()],z.prototype,"colRight",2),D([V()],z.prototype,"panelWidth",2),D([V()],z.prototype,"owners",2),D([V()],z.prototype,"ownerId",2),D([V()],z.prototype,"records",2),D([V()],z.prototype,"selectedId",2),D([V()],z.prototype,"draft",2),D([V()],z.prototype,"readOnlyReason",2),D([V()],z.prototype,"parseError",2),D([V()],z.prototype,"maxSchemaVersion",2),D([V()],z.prototype,"presets",2),D([V()],z.prototype,"occupied",2),D([V()],z.prototype,"serverToken",2),D([V()],z.prototype,"appliedToken",2),D([V()],z.prototype,"sendStatusKnown",2),D([V()],z.prototype,"polling",2),D([V()],z.prototype,"lastPollSeconds",2),D([V()],z.prototype,"sendPending",2),D([V()],z.prototype,"pages",2),D([V()],z.prototype,"templateResults",2),D([V()],z.prototype,"historySeries",2),D([V()],z.prototype,"historyReadings",2),D([V()],z.prototype,"templateError",2),D([V()],z.prototype,"templateFetchedAt",2),D([V()],z.prototype,"forced",2),D([V()],z.prototype,"showRaw",2),D([V()],z.prototype,"inspect",2),D([V()],z.prototype,"openSections",2),D([V()],z.prototype,"helpSections",2),D([V()],z.prototype,"pickerOpen",2),D([V()],z.prototype,"pickerFilter",2),D([V()],z.prototype,"pickerNote",2),D([V()],z.prototype,"openValue",2),D([V()],z.prototype,"sharedHelp",2),D([V()],z.prototype,"editingValue",2),D([V()],z.prototype,"thumbStep",2),D([V()],z.prototype,"layerDetail",2),D([V()],z.prototype,"addOpen",2),D([V()],z.prototype,"addDetail",2),D([V()],z.prototype,"multi",2),D([V()],z.prototype,"collapsed",2),D([V()],z.prototype,"activeFamily",2),D([V()],z.prototype,"picking",2),D([V()],z.prototype,"pickHoverId",2),D([V()],z.prototype,"listHoverIds",2),D([V()],z.prototype,"zoomed",2),D([V()],z.prototype,"helpOpen",2),D([V()],z.prototype,"showTaps",2),D([V()],z.prototype,"timestampActiveId",2),D([V()],z.prototype,"savedName",2),D([V()],z.prototype,"presetKind",2),D([V()],z.prototype,"presetEntity",2),D([V()],z.prototype,"newOpen",2),D([V()],z.prototype,"newName",2),D([V()],z.prototype,"newFamily",2),D([V()],z.prototype,"shareOpen",2),D([V()],z.prototype,"shareMode",2),D([V()],z.prototype,"shareLabels",2),D([V()],z.prototype,"shareNote",2),D([V()],z.prototype,"importOpen",2),D([V()],z.prototype,"importText",2),D([V()],z.prototype,"importParse",2),D([V()],z.prototype,"importName",2),D([V()],z.prototype,"importMap",2),D([V()],z.prototype,"previewCase",2),D([V()],z.prototype,"loadError",2),D([V()],z.prototype,"saveError",2),D([V()],z.prototype,"saving",2),D([V()],z.prototype,"conflict",2),D([V()],z.prototype,"remoteRevision",2),D([V()],z.prototype,"confirmDelete",2),D([V()],z.prototype,"moveTarget",2),D([V()],z.prototype,"moving",2),D([V()],z.prototype,"moveError",2),D([V()],z.prototype,"version",2);var Js=z;function Tt(e){return String(e?.message??e)}function sx(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Dp(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function lx(e,n,t,i){let a=[{label:"Shows",value:Ns(e,t)}],r=cr(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function dx(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function cx(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ee(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=gn(e.payload)??yn(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${at(o).length} values`}case"timeline":{let r=Bt(e.payload),o=r===void 0?[]:Li(t.get(r)??""),s=Math.max(0,o.length-1);return`${dx(st(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ee(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return xt(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Js);export{Js as WristAssistantPanel,Pp as columnFit,lx as layerFacts};
