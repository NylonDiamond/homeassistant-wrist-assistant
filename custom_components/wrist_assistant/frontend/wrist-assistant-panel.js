...
`)}function ko(e){let t;try{t=JSON.parse(e)}catch{return}if(typeof t!="object"||t===null||Array.isArray(t))return;let n=new Map,i=new Set;for(let[a,r]of Object.entries(t))r===null?i.add(a):n.set(a,Sd(r));return{values:n,nullKeys:i}}function Sd(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function ba(e){let t=ya(e),n=[...t.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return t.document&&n.push({kind:"template",value:t.document}),n}function Ed(e,t){if(e.values.length!==0)switch(t){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((n,i)=>n+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}function Tt(e){let t=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(t))return Number(t);let n=t.toLowerCase();if(n==="inf"||n==="+inf"||n==="infinity"||n==="+infinity")return 1/0;if(n==="-inf"||n==="-infinity")return-1/0;if(n==="nan"||n==="+nan"||n==="-nan")return NaN}function Je(e){let t=e.trim(),n=Tt(t);if(n!==void 0)return n;let i="";for(let r of t)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Tt(i)}function Td(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function Fd(e){let t=Math.max(0,e);return t<60?`${Math.trunc(t)}s`:t<3600?`${Math.trunc(t/60)}m`:t<86400?`${Math.trunc(t/3600)}h`:`${Math.trunc(t/86400)}d`}function Rd(e){let t=e.trim(),n=Tt(t);if(n!==void 0)return n;let i=0,a=t.indexOf(",");if(a>=0){let s=t.slice(0,a).trim().split(" "),l=s.length===2?Tt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,t=t.slice(a+1).trim()}let r=t.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Tt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function Md(e){let t=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(t/86400),"d"],[Math.trunc(t%86400/3600),"h"],[Math.trunc(t%3600/60),"m"],[t%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function Id(e){return e.replace(/\S+/g,t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase())}function Ad(e,t,n){if(Ne(t))return e;let i=t,a=e,r=Tt(e.trim()),o=i.duration?Rd(e):void 0;if(o!==void 0)a=Md(o);else if(i.relativeTime&&r!==void 0)a=Fd(r);else{let s=Je(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Td(l))}}switch(i.useEntityUnit&&n&&(a+=n.startsWith("\xB0")||n.startsWith("%")?n:` ${n}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=Id(a);break}return a}function Wt(e){let t=Math.trunc(Math.max(0,e)),n=Math.trunc(t/3600),i=Math.trunc(t%3600/60),a=t%60,r=o=>String(o).padStart(2,"0");return n>0?`${n}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function xn(e,t=240){let n=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&n.push(o)}i=""};for(let o of e){if(n.length>=t)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let s=!a;r(),s&&(i+=o),a=!1}else r(),a=!1}return n.length<t&&r(),n}function $o(e,t){let n,i;return t.scale==="fixed"?(n=Math.min(t.minValue,t.maxValue),i=Math.max(t.minValue,t.maxValue)):(n=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,t.thresholdValue!==void 0&&Number.isFinite(t.thresholdValue)&&(n=Math.min(n,t.thresholdValue),i=Math.max(i,t.thresholdValue))),t.baseline==="zero"&&(n=Math.min(n,0),i=Math.max(i,0)),i>n||(i=n+1),{min:n,max:i}}function Hd(e,t,n){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(n>t)||i<t||i>n))return(i-t)/(n-t)}function wn(e,t=dt){let n=[];for(let i of e.split(" ")){if(n.length>=t)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||n.push({offsetSeconds:Math.round(r),state:Ld(i.slice(a+1))})}return n}function Ld(e){try{return decodeURIComponent(e)}catch{return e}}function _d(e,t,n){if(e.length===0||!(t>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/t)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/t));if(!(d>s))continue;let c=n(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Co(e,t,n){if(Number.isNaN(e))return n;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(n,Math.max(t,i))}function zd(e,t,n){if(e===void 0)return 0;let i=Je(e);if(i===void 0||Number.isNaN(i))return 0;let a=n-t;return a===0?0:Math.min(1,Math.max(0,(i-t)/a))}var Xe=class{constructor(t,n){this.ctx=t;this.charts=new Map;this.named=new Map(t.namedValues.map(i=>[i.id.toUpperCase(),i.value])),n&&this.settleCharts(n)}chartReadings(t){let n=this.chartSeries(t),i=$o(n,t),a={values:n,domainMin:i.min,domainMax:i.max},r=this.chartEntity(t);return r&&(a.entity=r),a}chartSeries(t){let n=wt(t),i=n!==void 0?this.ctx.historySeries?.get(n)??"":this.resolve(t.value)??"",a=xn(i);return t.limit>0&&a.length>t.limit?t.takeFromEnd?a.slice(a.length-t.limit):a.slice(0,t.limit):a}chartEntity(t){let n=this.dereference(t.value);if(!(!n||!("entityId"in n.kind)))return{entityId:n.kind.entityId,displayName:n.kind.displayName,domain:n.kind.domain}}chartNowIndex(t,n){if(t.nowIndex===void 0||n===0)return;let i=this.resolve(t.nowIndex);if(i===void 0)return;let a=Je(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),n-1)}settleCharts(t){let n=new Map,i=[];for(let s of t.elements)s.kind!=="chart"||n.has(s.payload.id)||(n.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(n.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=n.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,h=u!==void 0&&u!==s&&n.has(u)&&!l.has(u)?o(u,new Set([...l,u])):$o(a.get(s)??[],c);return r.set(s,h),h};for(let s of i){let l=n.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(t){let n=t,i=new Set,a=t.format;for(;n.kind.kind==="named";){let o=n.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ne(a)?a:s.format,n=s}let r={kind:n.kind};return a&&(r.format=a),r}directEntityUnit(t){let n=t.kind;if(n.kind==="entityState"||n.kind==="entityAttribute"||n.kind==="entityAge")return this.ctx.entityStates.get(n.entityId)?.unitOfMeasurement;if(n.kind==="chartStat"){let i=this.charts.get(n.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i;switch(n.kind.kind){case"literal":i=n.kind.value;break;case"entityState":i=this.ctx.entityStates.get(n.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(n.kind.layer.toUpperCase()),r=a?Ed(a,n.kind.stat):void 0;i=a&&r!==void 0?Dr(r,a.domainMax-a.domainMin):void 0;break}default:{let a=ga(t,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Ad(i,n.format,this.directEntityUnit(n))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(t){if(!t)return;let n=this.dereference(t);if(!n)return;let i=n.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(t)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Tt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(t){if(!t)return;let n=this.dereference(t);if(!n||n.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(n.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Wt(i.remaining):"Paused":"Idle"}entityIcon(t){let n=this.dereference(t);return!n||n.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(n.kind.entityId)?.iconName??n.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(t){let n=t.comparison;if(n.kind==="isStale")return this.isStale();let i=this.resolve(t.value);if(i===void 0)return n.kind==="isUnavailable";let a=Je(i),r=()=>this.resolve(n.value),o=()=>{let l=r();return l===void 0?void 0:Je(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(n.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(n.upper),c=d===void 0?void 0:Je(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,h]=l<=c?[l,c]:[c,l];return a>=u&&a<=h}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!n.pattern)return!1;try{return new RegExp(n.pattern).test(i)}catch{return!1}}case"isOneOf":return(n.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(t){return t.tests.length===0?!0:t.join==="any"?t.tests.some(n=>this.evaluateTest(n)):t.tests.every(n=>this.evaluateTest(n))}applyRules(t,n){let i=new Map;for(let a of t){let r=n?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Te[s.kind],s)}return i}liveBranches(t){let n=new Map;for(let i of t){let a=i.cases.find(r=>this.evaluateCondition(r.when));n.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return n}styleColor(t,n){let i=t.get(n);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(t,n){let i=t.get(n);return i?this.resolve(i.value):void 0}styleNumber(t,n){return t.get(n)?.number}resolveElement(t,n){let i=t.payload,a=this.applyRules(i.rules,n),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,s=this.styleNumber(a,"rotation"),l=s===void 0?i.frame:{...i.frame,rotationDegrees:s},d=this.styleNumber(a,"opacity")??1,c={id:i.id,isHidden:o,frame:l,opacity:d};switch(t.kind){case"text":{let u=t.payload.countdown?this.countdownEnd(t.payload.value):void 0,h=t.payload.countdown?this.countdownFallbackText(t.payload.value):void 0,f={kind:"text",...c,text:this.styleText(a,"text")??h??this.resolve(t.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??t.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??t.payload.fontWeight,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex};return u!==void 0&&(f.countdownEnd=u),f}case"icon":{let u=this.entityIcon(t.payload.symbol)??this.resolve(t.payload.symbol)??"questionmark.circle";return{kind:"icon",...c,symbol:this.styleText(a,"icon")??u,size:this.styleNumber(a,"fontSize")??t.payload.size,colorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex}}case"gauge":{let u=t.payload,h=this.styleText(a,"gaugeValue")??this.resolve(u.value),f=this.styleNumber(a,"gaugeMin")??u.minValue,g=this.styleNumber(a,"gaugeMax")??u.maxValue,x=h===void 0?void 0:Je(h),$=this.styleColor(a,"color")??u.colorSlot.baseColorHex;u.coloring==="bands"&&u.bands.length>0&&x!==void 0&&($=Ki(x,gn(u),u.bandAboveColorHex));let S=g-f;if(u.total){let C=Je(this.resolve(u.total)??"");C!==void 0&&(S=C)}let E=Co(S,1,Nn),v={kind:"gauge",...c,fraction:zd(h,f,g),style:u.style,lineWidth:u.lineWidth,colorHex:$,trackColorHex:u.trackColorHex,thresholdColorHex:u.thresholdColorHex,dotCount:E,filledCount:Co(x??0,0,E)};if(u.thresholdValue!==void 0&&g!==f){let C=(u.thresholdValue-f)/(g-f);C>=0&&C<=1&&(v.thresholdFraction=C)}return v}case"chart":{let u=t.payload,h=this.charts.get(u.id)??this.chartReadings(u),f=h.values,g={min:h.domainMin,max:h.domainMax},x=this.styleColor(a,"color")??u.colorSlot.baseColorHex,$=gn(u),S=Or(u)?f.map(N=>Ki(N,$,u.bandAboveColorHex)):[],E={kind:"chart",...c,values:f,style:u.style,domainMin:g.min,domainMax:g.max,baseline:u.baseline,barGap:u.barGap,lineWidth:u.lineWidth,colorHex:x,highColorHex:u.highColorHex,lowColorHex:u.lowColorHex,marker:u.marker,pointColorHexes:S,fillBands:u.fillBands,thresholdColorHex:u.thresholdColorHex,nowColorHex:u.nowColorHex};if(f.length>0){let N=u.highlight==="highest"||u.highlight==="both",B=u.highlight==="lowest"||u.highlight==="both",j=N?f.indexOf(Math.max(...f)):-1,se=B?f.indexOf(Math.min(...f)):-1;j>=0&&(E.highIndex=j),se>=0&&se!==j&&(E.lowIndex=se)}let v=Hd(u,g.min,g.max);v!==void 0&&(E.thresholdY=v);let C=this.chartNowIndex(u,f.length);return C!==void 0&&(E.nowIndex=C),E}case"timeline":{let u=t.payload,h=kt(u),f=h===void 0?"":this.ctx.historySeries?.get(h)??"",g=wn(f,dt),x=_d(g,Ue(u)*60,S=>Kr(S,u.bands,u.otherColorHex));return{kind:"timeline",...c,runs:x,gap:u.gap,cornerRadius:u.cornerRadius}}case"shape":{let u={kind:"shape",...c,shapeKind:t.payload.kind,cornerRadius:t.payload.cornerRadius,thickness:t.payload.thickness,fillColorHex:this.styleColor(a,"color")??t.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??t.payload.borderWidth},h=this.styleColor(a,"borderColor")??t.payload.borderColorHex;return h!==void 0&&(u.borderColorHex=h),u}case"image":{let u={kind:"image",...c,entityId:t.payload.entity.entityId,source:t.payload.source,showTimestamp:t.payload.timestamp===!0,contentMode:t.payload.contentMode,zoom:t.payload.zoom,panX:t.payload.panX,panY:t.payload.panY,cornerRadius:t.payload.cornerRadius,timestampCorner:t.payload.timestampCorner,timestampSize:t.payload.timestampSize};Ke(t.payload)&&(u.timestampX=t.payload.timestampX,u.timestampY=t.payload.timestampY);let h=this.ctx.entityStates.get(t.payload.entity.entityId)?.entityPicture;return h!==void 0&&(u.url=h),u}case"tap":{let u={kind:"tap",...c,frame:t.payload.frame,opacity:1,action:t.payload.action};return t.payload.openPageId!==void 0&&(u.openPageId=t.payload.openPageId),t.payload.attachedTo!==void 0&&(u.attachedTo=t.payload.attachedTo),u}}}resolveLayout(t,n,i){let a=t.perFamily[n];this.settleCharts(t);let r=so(t,n).map(x=>this.resolveElement(x,i)),o=a?this.applyRules(a.rules,i):new Map,s={family:n,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(s.curvedText=h),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let x=a.bezelGauge,$=this.resolve(x.value),S=$===void 0?void 0:Je($);if(S!==void 0){let E=Math.min(x.minValue,x.maxValue),v=Math.max(x.minValue,x.maxValue),C={value:Math.min(v,Math.max(E,S)),minValue:E,maxValue:v===E?E+1:v,colorHexes:x.colorHexes},N=this.resolve(x.minLabel);N!==void 0&&(C.minLabel=N);let B=this.resolve(x.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(s.backgroundColorHex=f);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function Nd(e,t,n){let i=new Xe(t,n),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function va(e,t,n){let i=new Xe(t),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,n));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Nd(e.inline,t,e)),a}var ve=ue,kn=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:ve,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],$n=kn.find(e=>e.measured);function Ho(e){if(!e)return;let t=/^(\d+)x(\d+)$/.exec(e.trim());if(!t)return;let n=Number(t[1]),i=Number(t[2]);return kn.find(a=>a.screen.width===n&&a.screen.height===i)}function Zn(e,t){let n=ve[t];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/n.width,e.height/n.height),a=n.width*i,r=n.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var Pd={regular:400,medium:500,semibold:600,bold:700};function Pe(e){if(!e)return;let t=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(t))return;let n=t.length===8?parseInt(t.slice(6,8),16)/255:1;return{color:`#${t.slice(0,6)}`,opacity:n}}function $e(e,t,n="#FFFFFF"){let i=Pe(e)??{color:n,opacity:1};return{[t]:i.color,[`${t}-opacity`]:i.opacity}}function Lo(e,t){let n=Math.max(0,e.frame.width*t.width),i=Math.max(0,e.frame.height*t.height),a=(e.frame.x+e.frame.width/2)*t.width,r=(e.frame.y+e.frame.height/2)*t.height;return{x:a-n/2,y:r-i/2,w:n,h:i,cx:a,cy:r}}function Od(e,t){let n=$e(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Wt((e.countdownEnd-Date.now())/1e3)});let i=l=>l*.55,a=e.text.length*i(e.fontSize),r=a>t.w&&t.w>0?Math.max(.5,t.w/a):1,o=e.fontSize*r,s=e.text;if(t.w>0&&s.length*i(o)>t.w){let l=t.w-.8*o,d=Math.max(1,Math.floor(l/i(o)));s=`${s.slice(0,d).replace(/\s+$/,"")}\u2026`}return b`<text x=${t.cx} y=${t.cy} text-anchor="middle" dominant-baseline="central"
    ...
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${E}${c}${S}${$}${C}</g>`}function ti(e,t){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:t?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function Ta(e,t){return(t?23.5:34)*e}var So=10.5;function _o(e,t){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*t}function Eo(e,t){let n=0;for(let i of e)n+=_o(i,t);return n}function To(e,t,n){let i=e.toUpperCase(),a=d=>_o(d,n),r=.9*n,o=0;for(let d of i)o+=a(d);if(o<=t)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>t)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function Ca(e,t,n){let i=n*Math.PI/180;return{x:e.cx+t*Math.cos(i),y:e.cy+t*Math.sin(i)}}function Sa(e,t,n,i){let a=Ca(e,t,n),r=Ca(e,t,i);return`M ${a.x} ${a.y} A ${t} ${t} 0 0 1 ${r.x} ${r.y}`}function zo(e,t,n,i){let{dial:a}=ti(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:t,d:Sa(a,n,i.start,i.end),length:n*r}}function ec(e,t){let n=ti(e,!0);return zo(e,t,n.dial.r,n.labelArc)}var Fo=18.5,tc=113,nc={start:-71,end:-36},Ro=104,ic=6.2,Mo={start:-77,end:-30.5};function Io(e){let t=e.replace("#",""),n=i=>parseInt(t.slice(i,i+2),16)||0;return[n(0),n(2),n(4)]}function Ao(e,t){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let n=Math.min(1,Math.max(0,t))*(e.length-1),i=Math.min(e.length-2,Math.floor(n)),a=n-i,r=Io(e[i]),o=Io(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var wa=11;function ac(e,t,n){let{dial:i}=ti(t,!0),a=Ro*t,r=180/(Math.PI*Ro),o=e.minLabel!==void 0?Eo(e.minLabel,wa)*r:0,s=e.maxLabel!==void 0?Eo(e.maxLabel,wa)*r:0,l=Mo.start+(o>0?Math.max(0,o-1.8):0),d=Mo.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,h=[];for(let S=0;S<u;S++){let E=l+c*S/u,v=Math.min(d,l+c*(S+1)/u+.4);h.push(b`<path d=${Sa(i,a,E,v)} fill="none"
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${kc(e)}</svg>`}var Oe="color-mix(in srgb, var(--k) 45%, #6b7280)",li='system-ui, -apple-system, "Segoe UI", sans-serif';function us(e,t,n,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-n*Math.cos(u)).toFixed(2),y:(t-n*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${n} ${n} 0 ${d} 1 ${l.x} ${l.y}`}function Na(e,t,n,i){return b`<g fill="none" stroke-linecap="round">
    <path d=${us(e,t,n,1)} stroke=${Oe} stroke-width="2.6" opacity=".5" />
    <path d=${us(e,t,n,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function $c(e){switch(e){case"text":return b`<g font-family=${li} text-anchor="middle">
        ...
        <text x="6" y="39" font-family=${li} font-size="7" fill=${Oe}>1h ago</text>
        <text x="114" y="39" font-family=${li} font-size="7" text-anchor="end" fill=${Oe}>now</text>
    ...
    </div></div>`}function ci(e,t,n,i){let a=i.format??(r=>String(Math.round(r*100)/100));return p`<div class="field slider">${et(e,Xt(t,i.def,n,a))}
    ...
    </div></div>`}function ui(e,t,n,i,a,r){let o=s=>Math.round(s*1e3)/10;return Z(e,o(t),s=>n((s??0)/100),{min:a,max:r,step:.5,def:o(i)})}function Ae(e,t,n,i){return p`<label class="field check"><input type="checkbox" .checked=${t} @change=${a=>n(a.target.checked)} />${et(e,Xt(t,i,n,a=>a?"on":"off"))}</label>`}function oe(e,t,n,i=!1,a){let r=(t??"").replace(/^#/,""),o=/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(r),s=o?`#${r.slice(0,6)}`:"#ffffff",l=o&&r.length===8?Math.round(parseInt(r.slice(6,8),16)/255*100):100,d=(u,h)=>{let f=u.replace(/^#/,"").toUpperCase();return h>=100?`#${f}`:`#${f}${Math.round(h/100*255).toString(16).padStart(2,"0").toUpperCase()}`},c=a===void 0?void 0:{atDefault:Tc(t,a??void 0),title:a===null?"Back to none":`Back to ${a}`,reset:()=>n(a??void 0)};return p`<div class="field color">${et(e,c)}
    <div class="color-row">
  ...
  </div>`}function Hc(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var Lc=120;function _c(e,t,n,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(ri.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:t.trim()!==""&&n.length>0?{names:[...n],fromPack:!0}:{names:a(oi),fromPack:!1}}function xs(e,t){return t.size===0?e.length:e.filter(n=>t.has(n)).length}function zc(e){return[{value:"",label:`Starter set (${xs(oi,e)})`},...ri.map(t=>({value:t.name,label:`${t.name} (${xs(t.symbols,e)})`}))]}function Nc(e){return e.length>0?e.length:oi.length}function Pc(e,t,n,i){return n?t>e?`Showing ${e} of ${t}. Type more to narrow it down.`:t===1?"1 symbol matches.":`${t} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function ws(e,t,n,i){let a=e.icons.render(t,22,"#FFFFFF");return p`<button type="button" class="sym ${n?"on":""}" title=${t} @click=${()=>i(t)}>
    ...
    ${t.function==="count"?m:pe("Attribute (blank = state)",t.attribute??"",s=>{let l={...t};s?l.attribute=s:delete l.attribute,n(l)})}`}var Js=ea,au=Js.filter(([e])=>e!=="none");function ru(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Xs(e,t){let n=ru(t)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=t.type==="callService"?{...t}:{type:"callService",serviceDomain:"",serviceName:""};return n.entityId!==""&&(i.target=n),i}return jr(e)?{type:e,...n}:{type:e}}var ou=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Zs(e,t,n,i){let a=t.serviceDataJSON??"",r=qr(a),o=t.target??{entityId:"",displayName:"",domain:""};return p`
    <div class="gen-row">
  ...
  ${a?m:p`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function tl(e,t){let n=e.config.values.findIndex(a=>a.id===t.id),i=`nv-${t.id}`;return p`
    ...
    ${n?p`
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:m}`}function bi(e,t){if(e===t)return!0;if(typeof e!=typeof t||e===null||t===null||typeof e!="object"||Array.isArray(e)!==Array.isArray(t))return!1;if(Array.isArray(e))return e.length===t.length&&e.every((a,r)=>bi(a,t[r]));let n=Object.keys(e).filter(a=>e[a]!==void 0),i=Object.keys(t).filter(a=>t[a]!==void 0);return n.length!==i.length?!1:n.every(a=>bi(e[a],t[a]))}function Is(e,t,n){return n.some(i=>!bi(e[i],t[i]))}function As(e,t,n){let i=e,a=t;for(let r of n)a[r]===void 0?delete i[r]:i[r]=structuredClone(a[r])}function Ce(e,t,n,i,a={}){let r=e.openSections.has(t),o=()=>e.toggleSection(t);return p`<section class="sec" data-open=${r?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <div class="hint">${vi(e)}, up to 7 days: the recorder keeps
      ten by default, and a longer span would quietly come back short.</div>`}function qa(e,t){let n=fe(e);switch(t.kind){case"text":return pt(me(t.payload.value,n),48);case"icon":return pt(me(t.payload.symbol,n),48);case"gauge":return pt(me(t.payload.value,n),48);case"chart":return pt(`${me(t.payload.value,n)}${t.payload.historyMinutes>0?` \xB7 ${vi(t.payload.historyMinutes)}`:""}`,48);case"timeline":return pt(`${me(t.payload.value,n)} \xB7 ${vi(Ue(t.payload))}`,48);case"shape":return t.payload.kind==="roundedRectangle"?"Rounded rectangle":t.payload.kind;case"image":return t.payload.entity.displayName||t.payload.entity.entityId||(t.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return We(t.payload.action)}}function xi(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let t=e.payload,n=t.style==="dots"?`${t.bands.length>0&&t.coloring==="bands"?"banded":Se(t.colorSlot.baseColorHex)} dots`:`${t.lineWidth} pt line \xB7 ${t.coloring==="bands"&&t.bands.length>0?`${t.bands.length+1} colour bands`:Se(t.colorSlot.baseColorHex)}`;return`${t.style} \xB7 ${n}${t.thresholdValue===void 0?"":` \xB7 threshold ${t.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${Ws.find(([t])=>t===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let t=e.payload;return`${t.bands.length===0?`one colour (${Se(t.otherColorHex)})`:`${t.bands.length} ${t.bands.length===1?"state":"states"} coloured`}${t.gap>0?` \xB7 ${t.gap} pt gap`:""} \xB7 corners ${t.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${Se(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${Se(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function ol(e,t,n){let i=t.payload.id,a=e.config.elements.findIndex(y=>y.payload.id===i),r=`el-${i}`,o=(y,k)=>e.update(q=>y(q.elements[a]),k?`${r}-${k}`:void 0),s=we(e.config,n,t),l=s.frame,d=(y,k)=>e.update(q=>Ee(q,n,i,{frame:hs(l,y)}),`${r}-${k}-${n}`),c=ze(t.kind).payload,u=c.colorSlot?.baseColorHex??"#FFFFFF",h=y=>c[y],f,g;switch(t.kind){case"text":{let y=ta(e.config,t.payload.value);f=p`
        ...
        ${t.payload.countdown?p`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:m}`,g=p`<div class="grid2">
          ${hi(e,t,n,"Font size",{step:1,min:4,def:h("fontSize")})}
        ...
        <div class="hint">An entity source draws that entity's own icon instead.</div>`,g=hi(e,t,n,"Icon size",{step:1,min:4,def:h("size")});break;case"gauge":{let y=t.payload,k=(G,A)=>o(D=>G(D.payload),A),q=y.style==="dots";f=p`
        ...
        <div class="grid2">
          ${ne("Style",y.style,qc,G=>k(A=>{G==="dots"&&A.total===void 0&&(A.total=Ss(A)),G!=="dots"&&delete A.total,A.style=G}),{titles:Yc,def:c.style})}
          ${q?m:hi(e,t,n,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        ...
        ${q?m:p`
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let y=t.payload,k=(R,H)=>o(Fi=>R(Fi.payload),H),q=wt(y),G=c.historyMinutes,A=c.historyPoints,D=y.historyMinutes>0,O=y.value.kind.kind==="entityState",re=q===void 0?void 0:e.historySeries(q),Qt=D&&O?re??"":e.resolve(y.value)??"",ke=y.historyPoints<1,en=Ga(i,y.historyMinutes),ee=xn(Qt),de=y.limit>0&&ee.length>y.limit?y.takeFromEnd?ee.slice(ee.length-y.limit):ee.slice(0,y.limit):ee,Si=!D&&O&&ee.length===1,Ei=e.config.elements.filter(R=>R.kind==="chart"&&R.payload.id!==i),Al=fe(e),Ti=y.scaleFrom!==void 0&&Ei.some(R=>R.payload.id===y.scaleFrom);f=p`
              ...
              <div class="field readings-field">${et("Readings",{atDefault:y.historyPoints===A,title:`Back to ${A<1?"every one":`${A} averaged`}`,reset:()=>k(R=>{R.historyPoints=A})})}
                <div class="readings-row">
                  ...
                  ${ke?m:p`<input type="number" class="short" aria-label="How many readings" .value=${String(y.historyPoints)}
                    step="1" min=${ji} max=${Dn}
                    @input=${xe(R=>{let H=Number(R);R.trim()!==""&&Number.isFinite(H)&&H>=1&&k(Fi=>{Fi.historyPoints=Math.round(H)},"hpoints")})} />`}
                </div>
              </div>
            </div>
        ...
        ${Si?p`<div class="hint warn">This entity holds one number, so the chart draws one bar.
        ...
        <div class="grid2">
          ${ne("Style",y.style,Dc,R=>k(H=>{H.style=R}),{def:c.style})}
          ${y.style==="bars"?Z("Bar gap (pt)",y.barGap,R=>k(H=>{H.barGap=Math.max(0,R??0)},"gap"),{step:.5,min:0,def:c.barGap}):hi(e,t,n,"Line width",{step:.5,min:.5,def:h("lineWidth")})}
        </div>
        <div class="grid2">
          ${ne("Scale",y.scale,Vc,R=>k(H=>{H.scale=R}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ne("Baseline",y.baseline,Bc,R=>k(H=>{H.baseline=R}),{def:c.baseline})}
        </div>
        ${Ei.length===0?m:Fe("Same scale as",Ti?y.scaleFrom:"",[["","Its own"],...Ei.map(R=>[R.payload.id,Re(R,Al)])],R=>k(H=>{R?H.scaleFrom=R:delete H.scaleFrom}),{def:""})}
        ${Ti?p`<div class="hint">This chart is drawn against that one's range, so the two read as one
        ...
        ${!Ti&&y.scale==="fixed"?p`<div class="grid2">
        ...
        <div class="grid2">
          ...
          ${y.highlight==="none"?m:ne("Marker",y.marker,Gc,R=>k(H=>{H.marker=R}),{def:c.marker})}
        </div>
        ...
        ${Ae("Threshold line",y.thresholdValue!==void 0,R=>k(H=>{R?H.thresholdValue=Uc(de):delete H.thresholdValue}))}
        ...
        ${y.nowIndex===void 0?m:p`
          ...
          <div class="hint">Counted from 0, so Hour puts the line on reading 14 at 2 pm, which is what a
            24-reading price or forecast chart wants. Rounded, and clamped to the readings drawn.</div>`}`;break}case"timeline":{let y=t.payload,k=(ee,de)=>o(Si=>ee(Si.payload),de),q=c.historyMinutes,G=y.value.kind.kind==="entityState",A=kt(y),D=A===void 0?void 0:e.historySeries(A),O=Ue(y)*60,re=wn(D??"",dt),Qt=Ga(i,y.historyMinutes),ke=y.value.kind.kind==="entityState"?y.value.kind.entityId:void 0,en=Wc(re,O,ke===void 0?void 0:e.hass.states[ke]?.state,ke?.split(".")[0]);f=p`
        ...
        <div class="grid2">
          ${Z("Gap (pt)",y.gap,ee=>k(de=>{de.gap=Math.min(Bn,Math.max(0,ee??0))},"tgap"),{step:.5,min:0,max:Bn,def:c.gap})}
        ...
        ${ci("Zoom",y.zoom,D=>k(O=>{O.zoom=D},"zoom"),{min:Ea,max:4,step:.05,def:1,format:D=>`${D.toFixed(2)}x`})}
        ${ci("Pan left/right",y.panX,D=>k(O=>{O.panX=D},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${ci("Pan up/down",y.panY,D=>k(O=>{O.panY=D},"pany"),{min:-1,max:1,step:.02,def:0})}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let x=t.kind==="image"||t.kind==="tap"||t.kind==="timeline"?void 0:oe(t.kind==="shape"?"Fill colour":"Colour",t.payload.colorSlot.baseColorHex,y=>o(k=>{k.kind!=="image"&&k.kind!=="tap"&&k.kind!=="timeline"&&(k.payload.colorSlot.baseColorHex=y??"#FFFFFF")},"color"),!1,u),$=sa(e.config,t),S=$?{kind:{kind:"entityState",...$}}:void 0,E=he[t.kind],v=t.kind==="tap"?void 0:Me(e.config,i)[0],C=t.kind==="image"?t.payload.timestamp===!0:!1,N=Cu[t.kind],B=Su[t.kind],j=Is(t.payload,c,N),se=t.kind==="text"?"fontSize":t.kind==="icon"?"size":t.kind==="gauge"||t.kind==="chart"?"lineWidth":void 0,w=e.config.perFamily[n]?.placements[i]?.size!==void 0,T=Is(t.payload,c,B)||se!==void 0&&s.size!==void 0&&s.size!==c[se],V=!bi(l,Ge)||s.isHidden,P=$t(e.config,i),le=(y,k)=>()=>o(q=>As(q.payload,c,y),k);return p`
    ${Ce(e,"content","Content",p`${t.kind==="tap"?m:uu(e,t,r)}${f}`,{color:E,icon:"content",summary:qa(e,t),...j?{reset:le(N,"reset-content")}:{}})}
    ${g===void 0&&x===void 0?m:Ce(e,"look",t.kind==="image"?"Picture":"Look",p`${g??m}${x??m}`,{color:E,icon:t.kind==="image"?"image":"look",...xi(t)?{summary:xi(t)}:{},...T?{reset:()=>e.update(y=>{As(y.elements[a].payload,c,B),w&&Ee(y,n,i,{},!0)})}:{}})}
    ...
    ${t.kind==="tap"?m:Ce(e,"tappable","Tap",Mu(e,t,r),{color:Q.tap,icon:"tap",summary:v?We(v.payload.action):"Not tappable",...v?{reset:()=>e.update(y=>jn(y,i))}:{}})}
    ...
    ${Ce(e,"placement","Place",p`
      <div class="grid4">
        ${ui("Left",l.x,y=>d({x:y},"x"),Ge.x,-100,100)}
        ${ui("Top",l.y,y=>d({y},"y"),Ge.y,-100,100)}
        ${ui("Width",l.width,y=>d({width:y},"w"),Ge.width,4,200)}
        ${ui("Height",l.height,y=>d({height:y},"h"),Ge.height,4,200)}
      </div>
      ${ci("Rotation",l.rotationDegrees,y=>d({rotationDegrees:y},"rot"),{min:-180,max:180,step:1,def:0,format:y=>`${Math.round(y)}\xB0`})}
      ...
      <div class="hint">Everything about where this layer sits, how big it is drawn and whether it
        ...
        the same layer differently there.</div>`,{color:Q.place,icon:"place",summary:`${Math.round(l.width*100)}% wide \xB7 ${Y(n)}${s.fromPlacement?"":" \xB7 shared frame"}`,...V?{resetTitle:`Put this layer back to the middle of the ${Y(n)} face at half size, unrotated and shown`,reset:()=>e.update(y=>Ee(y,n,i,{frame:{...Ge},isHidden:!1}))}:{}})}`}var $u=["timestamp","timestampCorner","timestampSize"],Cu={text:["value","countdown"],icon:["symbol"],gauge:["value","minValue","maxValue","total"],chart:["value","historyMinutes","historyPoints","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},Su={text:["fontSize","fontWeight","colorSlot"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot"],timeline:["bands","otherColorHex","gap","cornerRadius"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function sl(e,t,n,i){let a=t.action;return p`
    ${Fe("Tap action",a.type,au,r=>n(o=>{o.action=Xs(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?el(e,t.openPageId,t.openPageName,(r,o)=>n(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):m}`}var Eu=24;function Tu(e,t){let n=[],i=1/0;for(let r of te){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=uo(e.config,t,r);o&&(n.push(`${Y(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(n.length===0)return m;let a=i<Eu;return p`<div class=${a?"hint warn":"hint"}>${n.join(" \xB7 ")}${a?p`<br />That is small for a wrist. Show the tap area and drag its corners out.`:m}</div>`}function Fu(e,t){let n=$t(e.config,t.payload.id);return n.length===0?"None yet":n.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(Pt.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Ru(e,t){let n=fe(e),i=$t(e.config,t.payload.id),a=o=>e.update(s=>{io(s,t.payload.id,o)}),r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return p`
    ...
    ${Ae("Tappable",a!==void 0,s=>e.update(l=>{s?Wn(l,i):jn(l,i)}))}
    ${a?p`<div class="value-editor">
          ...
          <div class="chips">
            ...
            ${Gn(a.payload.outset)?m:p`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
    ...
    </div>`,{color:Q.group,icon:"folder",summary:`${n.length} layers \xB7 ${t.locked?"moves as one":"unlocked"}`})}function dl(e,t){if(t==="inline")return Iu(e);let n=e.config.perFamily[t];if(!n)return p`<div class="hint">No settings stored for ${Y(t)} yet.</div>
      <button class="small" @click=${()=>e.update(s=>{s.perFamily[t]={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}})}>Add ${Y(t)} settings</button>`;let i=(s,l)=>e.update(d=>s(d.perFamily[t]),l?`fam-${t}-${l}`:void 0),a=ki(e.config,t),r=n.backgroundColorHex?Se(n.backgroundColorHex):"transparent",o=n.borderColorHex?`${n.borderWidth} pt ${Se(n.borderColorHex)} border`:"no border";return p`
    ...
    ${t==="corner"?Ce(e,"corner","Corner content",Au(e,n,i),{color:Q.place,icon:"content",summary:n.curvedText?"Big curved text":"Layer canvas",...n.curvedText!==void 0||n.bezelText!==void 0||n.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):m}
    ...
    ${Ce(e,"symbol","Symbol",p`
      ...
      <div class="hint">On the face: ${t.symbol?`${t.symbol} `:""}${t.label?`${t.label}: `:""}${e.resolve(t.value)??"--"}</div>`,{color:he.icon,icon:"icon",summary:t.symbol||"None"})}`}function Au(e,t,n){let i=t.curvedText?"curved":"canvas",a=t.bezelGauge?"gauge":t.bezelText?"text":"none";return p`
    ...
    ${t.maxLabel?ae(e,t.maxLabel,r=>n(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):m}`}var $m=te.map(e=>[e,Y(e)]),Ya={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Lu=Object.keys(Ya);function _u(e){let t=Yn[e];return Lu.filter(n=>t.includes(Te[n]))}var zu={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function mi(e,t){if(e.entityId==="")return"(no entity)";let n=e.displayName.trim();if(n!==""&&n!==e.entityId)return n;let i=t?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function pt(e,t){let n=e.replace(/\s+/g," ").trim();return n.length>t?`${n.slice(0,t-1)}\u2026`:n}function Nu(e){if(!e||Ne(e))return"";let t=[];return e.decimals!==void 0&&t.push(`${e.decimals} dp`),e.multiply!==void 0&&t.push(`\xD7${e.multiply}`),e.offset!==void 0&&t.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&t.push(`"${e.prefix}" first`),e.suffix&&t.push(`"${e.suffix}" after`),e.useEntityUnit&&t.push("with unit"),e.relativeTime&&t.push("as relative time"),e.duration&&t.push("as a duration"),e.textCase&&t.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),t.length===0?"":` (${t.join(", ")})`}function me(e,t){return`${cl(e,t)}${Nu(e.format)}`}function cl(e,t){let n=e.kind;switch(n.kind){case"literal":return n.value?`"${pt(n.value,40)}"`:"(empty)";case"entityState":return mi(n,t);case"entityAttribute":return n.attribute?`${mi(n,t)} \xB7 ${n.attribute}`:mi(n,t);case"entityAge":return`age of ${mi(n,t)}`;case"aggregate":return Pu(n.aggregate);case"time":return zu[n.timeField];case"dataAge":return"data age";case"jinja":return n.value?`template ${pt(n.value,32)}`:"template (empty)";case"named":return n.id===""?"(no value chosen)":t?.values?.find(a=>a.id===n.id)?.name?.trim()||`named ${n.id.slice(0,8)}`;case"chartStat":{let i=(Pt.find(([o])=>o===n.stat)?.[1]??n.stat).toLowerCase();if(n.layer==="")return`${i} (no chart chosen)`;let a=t?.elements?.find(o=>o.kind==="chart"&&o.payload.id===n.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?cl(a.payload.value,t):"a missing chart";return`${i} of ${r}`}}}function Pu(e){let t=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${t}`}function wi(e,t,n){if(n<0||n>=e.length)return;let[i]=e.splice(t,1);e.splice(n,0,i)}function Ou(e,t,n,i,a){let r=(o,s)=>e.update(l=>{let d=i(l);d&&o(d)},s?`${a}-${s}`:void 0);return p`
    ...
    <div class="rule-head">
      <b>Rule ${n+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${n===0} @click=${()=>r(u=>wi(u,n,n-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${n===i-1} @click=${()=>r(u=>wi(u,n,n+1))}>${z("down")}</button>
    ...
    <div class="rule-head">
      ...
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${n===0} @click=${()=>r(d=>wi(d.cases,n,n-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${n===i.cases.length-1} @click=${()=>r(d=>wi(d.cases,n,n+1))}>${z("down")}</button>
    ...
    ${c}
  </div>`}function Gu(e){try{return new RegExp(e),!0}catch{return!1}}function ul(e,t,n,i,a){let r=_u(n);return p`
    ...
    </select>`}var pl=["setColor","setBorderColor","setBackgroundColor"];function Uu(e,t,n,i,a,r,o){let s=!Yn[i].includes(Te[t.kind]);return p`<div class="change-box">
    <div class="rule-head">
    ...
    ${hl(e,t,a,o)}
  </div>`}function hl(e,t,n,i){let a=Jn(t.kind),r=m;if(a==="value"){let o=t.value??M("");if(pl.includes(t.kind)){let s=o.kind.kind==="literal";r=p`${s?oe("Colour",o.kind.kind==="literal"?o.kind.value:"",l=>n(d=>{d.value=M(l??"#FFFFFF")},"color")):ae(e,o,l=>n(d=>{d.value=l},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      ${Ou(e,t,n,i,a)}`:Ku(e,o.table,t[0],n,i,a,r)}function Ku(e,t,n,i,a,r,o){let s=(w,T)=>e.update(V=>{let P=a(V);P&&w(P)},T?`${r}-${T}`:void 0),l=t.value??zs.get(r)??o,d=t.rows.length===0,c=t.numberMode||d&&l!==void 0&&!cs(l)&&Wu(e.resolve(l)),u=Yn[i],h=fi.get(r)??new Set,f=t.columns.length===0&&h.size===0?[ds[i]]:[],g=es(t.columns,[...h,...f.filter(w=>w!==void 0)],u),x=n?e.liveBranch(n):"none",$=n?e.forced.get(n.id)??"live":"live",S=w=>$!=="live"&&($==="otherwise"?w==="otherwise":$.caseId===w),E=w=>{n&&e.setForced(n.id,S(w)?"live":w==="otherwise"?"otherwise":{caseId:w})},v=w=>{zs.set(r,w),t.rows.length!==0&&s(T=>os(T,w),"lhs")},C=()=>s(w=>as(w,l??M(""),c)),N=t.rows.map((w,T)=>Ps(e,{key:`${r}-${w.caseId}`,label:ls(w.comparison,V=>me(V,fe(e))),columns:g,changes:w.changes,live:x===w.caseId,forced:S(w.caseId),onForce:()=>E(w.caseId),when:Xu(e,w.comparison,`${r}-${w.caseId}`,(V,P)=>s(le=>{let y=le[0]?.cases.find(k=>k.id===w.caseId)?.when.tests[0];y&&V(y.comparison)},P&&`${w.caseId}-${P}`)),updChanges:(V,P)=>s(le=>{let y=le[0]?.cases.find(k=>k.id===w.caseId);y&&V(y.then)},P&&`${w.caseId}-${P}`),acts:p`
      ...
      <button class="icon danger" title="Delete this state" @click=${()=>s(V=>rs(V,w.caseId))}>${z("delete")}</button>`})),B=t.otherwise===void 0?m:Ps(e,{key:`${r}-otherwise`,label:"Otherwise",columns:g,changes:t.otherwise,live:x==="otherwise",forced:S("otherwise"),onForce:()=>E("otherwise"),when:p`<span class="when-otherwise">Otherwise</span>`,updChanges:(w,T)=>s(V=>{let P=V[0]?.otherwise;P&&w(P)},T),acts:p`<button class="icon" title="Remove the Otherwise row" @click=${()=>s(w=>za(w,!1))}>${z("close")}</button>`}),j=gi.get(r),se=ju.filter(w=>u.includes(w)&&!g.includes(w));return p`
    <div class="states">
          ...
          <tr>
            ...
            ${g.map(w=>p`<th>
              ...
              <button class="icon" title=${`Remove the ${Ze[w]} column`}
                @click=${T=>{gi.set(r,w),Ie(T.target)}}>${z("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${j===void 0?m:p`<div class="hint warn confirm-row">
        ...
        <button class="danger small" @click=${w=>{gi.delete(r),fi.get(r)?.delete(j),Ie(w.target),s(T=>ss(T,j))}}>Remove</button>
        <button class="small" @click=${w=>{gi.delete(r),Ie(w.target)}}>Cancel</button>
      </div>`}
      <div class="states-foot">
        ...
        ${se.length===0?m:p`<select class="chip-add" title="Add a column" @change=${w=>{let T=w.target,V=T.value;if(T.value="",!V)return;let P=fi.get(r)??new Set;P.add(V),fi.set(r,P),Ie(T)}}>
  ...
  </tr>`}function Yu(e,t,n,i,a){let r=si(n,t),o=Wa(a);if(!r)return p`<button type="button" class="cell empty" title=${`Set ${Ze[t]} for this state`}
      @click=${d=>{i(c=>{c.push(Et(Qo[t]))}),eu(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let h=u.find(f=>Te[f.kind]===t);h&&d(h)},c&&`${t}-${c}`),l=Ze[t];return p`
    ...
    <select class="when-op" title="How this state is decided" @change=${xe(s=>i(l=>{let d=ma(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Aa.map(s=>p`<option value=${s} ?selected=${s===t.kind}>${Zu(s)}</option>`)}
    </select>
