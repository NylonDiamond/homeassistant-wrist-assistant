...
`)}function Fc(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,Sf(r));return{values:t,nullKeys:i}}function Sf(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function us(e){let n=nr(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function Tf(e,n){let t=e.holes.length===0?e.values:e.values.filter((i,a)=>!e.holes[a]);if(t.length!==0)switch(n){case"latest":return t[t.length-1];case"highest":return Math.max(...t);case"lowest":return Math.min(...t);case"average":return t.reduce((i,a)=>i+a,0)/t.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return t[0];case"delta":return t[t.length-1]-t[0];case"sum":return t.reduce((i,a)=>i+a,0);case"trend":{let i=t[t.length-1]-t[0],a=Number(Eo(i,e.domainMax-e.domainMin));return a>0?1:a<0?-1:0}}}var Ef=10800;function Mf(e,n,t){let i=n==="always"||n==="auto"&&t<=Ef;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function ir(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=Mf(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function Rf(e,n){return ft(e)===void 0?[]:ir(rt(e)*60,Ni(e.timeLabelCount),e.hourCycle,e.minutes,n)}function Ff(e,n){return Fn(e)?ir(Math.round(e.historyMinutes)*60,Ni(pt(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Af(e,n,t,i){return n===void 0&&i!==void 0?ft(i)===void 0?[]:ir(rt(i)*60,Ni(pt(e.timeLabelCount)),e.hourCycle,e.minutes,t):n===void 0||!Fn(n)?[]:ir(Math.round(n.historyMinutes)*60,Ni(pt(e.timeLabelCount)),e.hourCycle,e.minutes,t)}function Bn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ue(e){let n=e.trim(),t=Bn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Bn(i)}function Hf(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function If(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function Lf(e){let n=e.trim(),t=Bn(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Bn(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Bn(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function _f(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function zf(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function Pf(e,n,t){if(Ie(n))return e;let i=n,a=e,r=Bn(e.trim()),o=i.duration?Lf(e):void 0;if(o!==void 0)a=_f(o);else if(i.relativeTime&&r!==void 0)a=If(r);else{let s=Ue(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):Hf(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=zf(a);break}return a}function ui(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Ke(e,n=240){return _c(e,n).map(t=>t.value)}function hs(e,n=240){let t=[];for(let s of e.split(",")){if(t.length>=n)break;if(s.trim()===""){t.push(void 0);continue}for(let l of Ke(s,n-t.length))t.push(l)}let i=t.find(s=>s!==void 0);if(i===void 0)return{values:[],holes:[]};let a=[],r=[],o=i;for(let s of t)s===void 0?(a.push(o),r.push(!0)):(o=s,a.push(s),r.push(!1));return{values:a,holes:Lc(r)}}function Lc(e){return e.some(n=>n)?e:[]}function _c(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function Ac(e,n,t){let i=_c(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Jt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??le,c=t.highColorHex??Je,u=t.lowColorHex??Ze,p=[],m=(y,b)=>{if(y==="")return;let k=p.at(-1);k&&k.colorHex===b?k.text+=y:p.push({text:y,colorHex:b})},g=0;return i.forEach((y,b)=>{m(e.slice(g,y.start),n);let k=b===o?c:b===s?u:l.length>0?Da(y.value,l,d):n,C=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,C),k),g=C}),m(e.slice(g),n),p}function Hc(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function Nf(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function qi(e,n=tn){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:Df(i.slice(a+1))})}return t}function Df(e){try{return decodeURIComponent(e)}catch{return e}}function Of(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function Ic(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function Vf(e,n,t){if(e===void 0)return 0;let i=Ue(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var yt=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.chartElements=new Map;this.timelineElements=new Map;this.imageElements=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let{values:t,holes:i}=this.chartSeries(n),a=Hc(t,n),r={values:t,holes:i,domainMin:a.min,domainMax:a.max},o=this.chartEntity(n);return o&&(r.entity=o),r}chartSeries(n){let t=An(n),i=Hn(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let{values:o,holes:s}=r!==void 0?hs(a):{values:Ke(a),holes:[]},l=r===void 0?void 0:this.testedReading(n);if(l!==void 0&&(o=[...o.slice(0,-1),l],s.length>0&&(s=[...s.slice(0,-1),!1])),n.limit>0&&o.length>n.limit){let d=c=>n.takeFromEnd?c.slice(c.length-n.limit):c.slice(0,n.limit);o=d(o),s.length>0&&(s=d(s))}return s=Lc(s),{values:ms(o,it(n.smoothing),s),holes:s}}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ue(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ue(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind==="timeline"&&this.timelineElements.set(s.payload.id,s.payload),s.kind==="image"&&this.imageElements.set(s.payload.id,s.payload),!(s.kind!=="chart"||t.has(s.payload.id))&&(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):Hc(a.get(s)?.values??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)?.values??[],holes:a.get(s)?.holes??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c),this.chartElements.set(s,l)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ie(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?Tf(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?zd(r):Eo(r,a.domainMax-a.domainMin));break}default:{let a=cs(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return Pf(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Bn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?ui(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ue(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ue(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ue(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Dn(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Dn(d),p=c===void 0?void 0:Dn(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(ze[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=Ac(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=at(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(b=>b.text).join(""),y):(Ad(n.payload)&&(y.spans=Ac(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,b=m??p;y===void 0&&b.startsWith("mdi:")&&(b="questionmark.circle");let k={kind:"icon",...u,symbol:b,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&(k.path=y),k}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(D,I,q)=>D??(I?Ue(this.resolve(I)??""):void 0)??q,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),b=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),k=m===void 0?void 0:Ue(m),C=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&k!==void 0&&(C=Da(k,Jt(p),p.bandAboveColorHex));let w=b-y;if(p.total){let D=Ue(this.resolve(p.total)??"");D!==void 0&&(w=D)}let S=Ic(w,1,Na),A={kind:"gauge",...u,fraction:Vf(m,y,b),style:p.style,lineWidth:p.lineWidth,colorHex:C,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:S,filledCount:Ic(k??0,0,S)};if(p.thresholdValue!==void 0&&b!==y){let D=(p.thresholdValue-y)/(b-y);D>=0&&D<=1&&(A.thresholdFraction=D)}return A}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y=m.holes,b={min:m.domainMin,max:m.domainMax},k=this.styleColor(r,"color")??p.colorSlot.baseColorHex,C=Jt(p),w=_d(p)?g.map(K=>Da(K,C,p.bandAboveColorHex)):[],S=p.highlight==="highest"||p.highlight==="both",A=p.highlight==="lowest"||p.highlight==="both",D=Ai(p),I={kind:"chart",...u,values:g,holes:y,style:p.style,domainMin:b.min,domainMax:b.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:k,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:S?D.high:"none",lowMarker:A?D.low:"none",pointColorHexes:w,fillBands:p.fillBands,curve:p.curve??"straight",smoothing:it(p.smoothing)??"off",fillStyle:Wt(p.fillStyle),...p.fillColorHex!==void 0?{fillColorHex:p.fillColorHex}:{},barRadius:jt(p.barRadius),barCorners:qt(p.barCorners),thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:p.drawsTimeLabels===!1?[]:Ff(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove},q=y.length===0?g:g.filter((K,G)=>!y[G]);if(q.length>0){let K=H=>g.findIndex((W,E)=>W===H&&y[E]!==!0),G=S?K(Math.max(...q)):-1,ie=A?K(Math.min(...q)):-1;G>=0&&(I.highIndex=G),ie>=0&&ie!==G&&(I.lowIndex=ie)}let R=Nf(p,b.min,b.max);R!==void 0&&(I.thresholdY=R);let U=this.chartNowIndex(p,g.length);return U!==void 0&&(I.nowIndex=U),I}case"timeline":{let p=n.payload,m=ft(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=qi(g,tn),b=Of(y,rt(p)*60,C=>Gd(C,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:b,gap:p.gap,cornerRadius:p.cornerRadius,labels:p.drawsTimeLabels===!1?[]:Rf(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};Ka(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}case"chartTimes":{let p=n.payload;return{kind:"chartTimes",...u,labels:Af(p,this.chartElements.get(p.chart),this.nowMs(),this.timelineElements.get(p.chart)),labelSize:p.labelSize,labelColorHex:p.labelColorHex}}case"imageTime":{let p=n.payload,m=this.imageElements.get(p.image),g={kind:"imageTime",...u,image:p.image,linked:m!==void 0},y=m===void 0?void 0:this.ctx.entityStates.get(m.entity.entityId)?.entityPicture;return y!==void 0&&(g.url=y),g}case"chartDots":{let p=n.payload,m=ut(p.size),g={kind:"chartDots",...u,chart:p.chart,dots:Ia(p.dots),diameter:0,indices:[]};return m!==void 0&&(g.size=m),p.colorHex!==void 0&&(g.colorHex=p.colorHex),g}case"chartGrid":{let p=n.payload;return{kind:"chartGrid",...u,chart:p.chart,lines:Tn(p.lines),colorHex:Gt(p.colorHex),thickness:En(p.thickness),draws:!1}}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=pe[t==="inline"?"rectangular":t],o=[...jf(Wf(dc(n,t).map(b=>this.resolveElement(b,i)),r),r)],s=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:o,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(s,"borderWidth")??a?.borderWidth??2},d=this.styleText(s,"text"),c=a?.bezelCountdown&&d===void 0?this.countdownEnd(a.bezelText):void 0,u=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,p=d??u??this.resolve(a?.bezelText);p!==void 0&&(l.bezelText=p),c!==void 0&&(l.bezelCountdownEnd=c);let m=this.resolve(a?.curvedText);if(m!==void 0&&(l.curvedText=m),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let b=a.bezelGauge,k=this.resolve(b.value),C=k===void 0?void 0:Ue(k);if(C!==void 0){let w=Math.min(b.minValue,b.maxValue),S=Math.max(b.minValue,b.maxValue),A={value:Math.min(S,Math.max(w,C)),minValue:w,maxValue:S===w?w+1:S,colorHexes:b.colorHexes},D=this.resolve(b.minLabel);D!==void 0&&(A.minLabel=D);let I=this.resolve(b.maxLabel);I!==void 0&&(A.maxLabel=I),l.bezelGauge=A}}let g=this.styleColor(s,"backgroundColor")??a?.backgroundColorHex;g!==void 0&&(l.backgroundColorHex=g);let y=this.styleColor(s,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function Bf(e,n,t){let i=new yt(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Yi(e,n,t){let i=new yt(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=Bf(e.inline,n,e)),a}function ar(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var ps=5,Gf=1.7,Uf=1.8;function Kf(e,n,t,i,a,r){return e==="bars"||t===0?!1:n==="all"||t===1?!0:Math.max(i-a*2,0)/(t-1)>=3*r}function Wf(e,n){if(!e.some(r=>r.kind==="chartDots"||r.kind==="chartGrid"))return[...e];let t=new Map;for(let r of e)r.kind==="chart"&&t.set(r.id,r);let i=new Map,a=e.map(r=>{if(r.kind==="chartGrid"){let u=t.get(r.chart);return u===void 0?{...r,draws:!1}:{...r,frame:u.frame,draws:u.values.length>0}}if(r.kind!=="chartDots")return r;let o=t.get(r.chart);if(o===void 0)return{...r,diameter:0,indices:[]};let s=r.size??o.lineWidth*Uf,l=Math.max(o.frame.width*n.width,0),d=Kf(o.style,r.dots,o.values.length,l,o.lineWidth/2,s);d&&!r.isHidden&&i.set(o.id,Math.max(i.get(o.id)??0,s));let c=d?o.values.map((u,p)=>p).filter(u=>o.holes[u]!==!0&&u!==o.highIndex&&u!==o.lowIndex):[];return{...r,frame:o.frame,diameter:s,indices:c}});return i.size===0?a:a.map(r=>{if(r.kind!=="chart")return r;let o=i.get(r.id);return o===void 0?r:{...r,dotDiameter:o}})}function zc(e){if(e.domainMin<0&&e.domainMax>0)return(0-e.domainMin)/(e.domainMax-e.domainMin)}function Pc(e,n){let t=Math.max(0,Math.min(4,Math.round(n))),i=e.plotBottom-e.plotTop;return Array.from({length:t},(a,r)=>e.plotTop+i*(r+1)/(t+1))}function rr(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0?e.highMarker:"none",r=e.lowIndex!==void 0?e.lowMarker:"none",o=n.x,s=Math.max(n.w,0),l=e.style==="bars"?0:e.lineWidth/2,d=e.dotDiameter!==void 0&&e.style!=="bars"?Math.max(l,e.dotDiameter/2):l,c=I=>I==="triangle"?ps+d:I==="dot"?Math.max(d,Gf):d,u=c(a),p=c(r),m=n.y+u,g=Math.max(n.h-u-p,1),y=m+g,b=Math.max(e.domainMax-e.domainMin,Number.EPSILON),k=e.baseline==="lowest",C=k?g*.12:0,w=Math.min(Math.max(e.barGap,0),s/(i*2)),S=Math.max((s-w*(i-1))/i,.5),A=I=>Math.min(1,Math.max(0,(I-e.domainMin)/b)),D=I=>y-A(I)*g;return{count:t.length,barWidth:S,plotTop:m,plotBottom:y,plotLeft:o,plotRight:o+s,baselineY:k?y:D(0),inset:d,yAtFraction(I){return y-Math.min(Math.max(I,0),1)*g},barRect(I){let q=o+I*(S+w),R=t[I],U,K;if(k){let G=C+A(R)*(g-C);U=y-G,K=y}else U=D(R),K=k?y:D(0),U>K&&([U,K]=[K,U]);return{x:q,y:U,w:S,h:Math.max(K-U,.5)}},point(I){let q=Math.max(s-d*2,0);return{x:t.length>1?o+d+q*I/(t.length-1):o+s/2,y:D(t[I])}},markerCenter(I,q,R="high"){let U=q?this.barRect(I):void 0,K=U?U.x+U.w/2:this.point(I).x,G=R==="high"?a:r,ie=R==="high"?G==="triangle"?n.y+ps/2:m:G==="triangle"?n.y+n.h-ps/2:y;return{x:K,y:ie}}}}function Nc(e,n){let t=e.length;if(t<2)return[];let i=[];if(n==="step"){for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1];i.push({kind:"step",start:s,corner:{x:l.x,y:s.y},end:l})}return i}if(n!=="smooth"){for(let o=0;o<t-1;o++)i.push({kind:"straight",start:e[o],end:e[o+1]});return i}let a=[];for(let o=0;o<t-1;o++){let s=e[o+1].x-e[o].x;a.push(s===0?0:(e[o+1].y-e[o].y)/s)}let r=new Array(t).fill(0);r[0]=a[0],r[t-1]=a[t-2];for(let o=1;o<t-1;o++)r[o]=a[o-1]*a[o]<=0?0:(a[o-1]+a[o])/2;for(let o=0;o<t-1;o++){if(a[o]===0){r[o]=0,r[o+1]=0;continue}let s=r[o]/a[o],l=r[o+1]/a[o],d=s*s+l*l;if(d>9){let c=3/Math.sqrt(d);r[o]=c*s*a[o],r[o+1]=c*l*a[o]}}for(let o=0;o<t-1;o++){let s=e[o],l=e[o+1],d=l.x-s.x;i.push({kind:"smooth",start:s,c1:{x:s.x+d/3,y:s.y+r[o]*d/3},c2:{x:l.x-d/3,y:l.y-r[o+1]*d/3},end:l})}return i}function ms(e,n,t=[]){let i=e.length,a=Fd(i,n);if(a===0)return e;let r=Math.floor(a/2),o=r/2,s=u=>t[u]===!0,l=e.map((u,p)=>{if(s(p))return u;let m=0,g=0;for(let y=Math.max(0,p-r);y<=Math.min(i-1,p+r);y++){if(s(y))continue;let b=y-p,k=Math.exp(-(b*b)/(2*o*o));m+=e[y]*k,g+=k}return m/g}),d=l.find((u,p)=>!s(p));if(d===void 0)return l;let c=d;return l.map((u,p)=>s(p)?c:(c=u,u))}function Dc(e,n){let t=[],i=[];for(let a=0;a<e;a++)n[a]===!0?(i.length>0&&t.push(i),i=[]):i.push(a);return i.length>0&&t.push(i),t}var ji=1;function pi(e,n){let t=Math.max(Qt,Math.min(en,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-ji>=2,r=a?{...n,y:e.labelsAbove?n.y+i+ji:n.y,h:n.h-i-ji,cy:(e.labelsAbove?n.y+i+ji:n.y)+(n.h-i-ji)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function jf(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;if(a.at==="zero"&&zc(r)===void 0)return{...i,isHidden:!0};let o=Yf(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function qf(e,n){let t=n.values;if(t.length===0)return;let i=t.map((a,r)=>r).filter(a=>n.holes.length===0||!n.holes[a]);if(i.length!==0)switch(e){case"highest":return i.reduce((a,r)=>t[r]>t[a]?r:a);case"lowest":return i.reduce((a,r)=>t[r]<t[a]?r:a);case"first":return i[0];case"latest":return i[i.length-1];case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return;case"zero":return}}function Yf(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=ar(t,i);if(a.w<=0||a.h<=0)return;let r=pi(t,a).body;if(r.w<=0||r.h<=0)return;let o=rr(t,r),s,l;if(mt(n.at)){let k=qf(n.at,t);if(k===void 0)return;if(t.style==="bars"){let C=o.barRect(k);s=C.x+C.w/2,l=C.y}else{let C=o.point(k);s=C.x,l=C.y}}else{let k=n.at==="zero"?zc(t):t.thresholdY;if(k===void 0)return;l=o.yAtFraction(k)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(k,C,w)=>C>w?(C+w)/2:Math.min(Math.max(k,C),w),m={...e};if(s!==void 0){let k=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(k-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let k=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(k-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g,r.y+c/2,r.y+r.h-c/2),b=p(y+(n.dy??0),c/2,i.height-c/2);return m.y=(b-c/2)/i.height,m}var Le=pe,Xi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Le,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],hi=Xi.find(e=>e.measured);function Yc(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Xi.find(a=>a.screen.width===t&&a.screen.height===i)}function sr(e,n){let t=Le[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var bs={regular:400,medium:500,semibold:600,bold:700},Xf=1.15;function We(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function we(e,n,t="#FFFFFF"){let i=We(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var _t=e=>e*.55;function Xc(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Jf(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Zf(e,n,t){if(t<=0||e.length*_t(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/_t(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Qf(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function Jc(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function Zc(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function eg(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function Qc(e,n){return e.reduce((t,i)=>t+i.text.length*_t(i.look.fontSize*n),0)}function tg(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:_t(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=_t(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function ng(e,n,t){if(t<=0||Qc(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*_t(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*_t(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function ig(e,n,t){let i=eg(n),a=e.lineLimit===2&&t.w>0?tg(e.text,i,t.w):[e.text],r=Jc(e.text,a),o=a.map((C,w)=>Zc(C,r[w]??0,e.text,i,i[0])),s=Math.max(...o.map(C=>Qc(C,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(C=>ng(C,l,t.w)),{anchor:c,x:u}=Xc(e.alignment,t),p=Math.max(0,...d.flat().map(C=>C.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=C=>C.map(w=>{let S=we(w.look.colorHex,"fill");return v`<tspan font-size=${w.look.fontSize*l} font-weight=${bs[w.look.fontWeight]??400} fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${w.text}</tspan>`}),b=we(e.colorHex,"fill"),k=d.length>1?v`${d.map((C,w)=>v`<tspan x=${u} y=${t.cy+m+(w-(d.length-1)/2)*g}>${y(C)}</tspan>`)}`:y(d[0]);return v`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function sg(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=pi(e,n),o=r?$s(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:v`${o}`;let s=dg(e,a);return o===void 0?s:v`${s}${o}`}function gs(e){switch(e.kind){case"smooth":return`C${e.c1.x} ${e.c1.y} ${e.c2.x} ${e.c2.y} ${e.end.x} ${e.end.y}`;case"step":return`L${e.corner.x} ${e.corner.y} L${e.end.x} ${e.end.y}`;case"straight":return`L${e.end.x} ${e.end.y}`}}var Oc=0;function eu(){return Oc+=1,Oc.toString(36)}function lg(e,n,t){let{x:i,y:a,w:r,h:o}=e,s=Math.max(0,n);return s===0?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o} L${i} ${a+o} Z`:t?`M${i} ${a} L${i+r} ${a} L${i+r} ${a+o-s} A${s} ${s} 0 0 1 ${i+r-s} ${a+o} L${i+s} ${a+o} A${s} ${s} 0 0 1 ${i} ${a+o-s} Z`:`M${i} ${a+o} L${i} ${a+s} A${s} ${s} 0 0 1 ${i+s} ${a} L${i+r-s} ${a} A${s} ${s} 0 0 1 ${i+r} ${a+s} L${i+r} ${a+o} Z`}function dg(e,n){let t=rr(e,n),i=eu(),a=we(e.colorHex,"fill"),r=we(e.highColorHex,"fill",e.colorHex),o=we(e.lowColorHex,"fill",e.colorHex),s=(g,y)=>v`<circle cx=${g.x} cy=${g.y} r="1.7" fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`,l=[],d=new Map,c=e.pointColorHexes.length===t.count,u=g=>c?we(e.pointColorHexes[g],"fill",e.colorHex):a,p=g=>{let y=We(g)??We(e.colorHex)??{color:"#FFFFFF",opacity:1};if(e.fillStyle!=="fade")return{fill:y.color,opacity:y.opacity*.28};let b=cg(i,e.id,g),k=t.baselineY<=t.plotTop?t.plotBottom:t.plotTop;return d.has(b)||d.set(b,v`<linearGradient id=${b} gradientUnits="userSpaceOnUse" x1="0" y1=${k} x2="0" y2=${t.baselineY}>
        ...
        <stop offset="1" stop-color=${y.color} stop-opacity="0" /></linearGradient>`),{fill:`url(#${b})`,opacity:1}};if(e.style==="bars")for(let g=0;g<t.count;g++){if(e.holes[g]===!0)continue;let y=t.barRect(g),b=g===e.highIndex?r:g===e.lowIndex?o:u(g),k=Math.min(Math.max(e.barRadius,0),y.w/2,y.h/2);if(e.barCorners==="top"){let C=e.baseline==="zero"&&e.values[g]<0;l.push(v`<path d=${lg(y,k,C)}
          ...
          fill=${b.fill} fill-opacity=${b["fill-opacity"]} />`)}else{let g=Array.from({length:t.count},(C,w)=>t.point(w)),y=e.holes.length>0,k=Dc(t.count,e.holes).filter(C=>!y||C.length>1).map(C=>{let w=C.map(D=>g[D]),S=Nc(w,e.curve),A=`M${w[0].x} ${w[0].y}${S.map(D=>` ${gs(D)}`).join("")}`;return{run:C,pts:w,legs:S,line:A}});if(e.style==="area")for(let{run:C,pts:w,legs:S,line:A}of k)if(e.fillBands&&c&&C.length>1&&e.fillColorHex===void 0)for(let D=0;D<S.length;D++){let I=w[D],q=w[D+1],R=p(e.pointColorHexes[C[D+1]]),U=`M${I.x} ${I.y} ${gs(S[D])} L${q.x} ${t.baselineY} L${I.x} ${t.baselineY} Z`;l.push(v`<path d=${U} fill=${R.fill} fill-opacity=${R.opacity} stroke="none" />`)}else{let D=p(e.fillColorHex??e.colorHex),I=`${A} L${w[w.length-1].x} ${t.baselineY} L${w[0].x} ${t.baselineY} Z`;l.push(v`<path d=${I} fill=${D.fill} fill-opacity=${D.opacity} stroke="none" />`)}for(let{run:C,pts:w,legs:S,line:A}of k)if(c&&C.length>1)for(let D=0;D<S.length;D++){let I=w[D],q=u(C[D+1]);l.push(v`<path d=${`M${I.x} ${I.y} ${gs(S[D])}`} fill="none"
    ...
    stroke=${o.color} stroke-opacity=${Math.max(o.opacity,a>0?.6:0)} stroke-width=${Math.max(e.thickness,a)} />`)}${i?s.map(l=>v`<path d=${`M${r.g.plotLeft} ${l} L${r.g.plotRight} ${l}`} fill="none" stroke="#0A84FF"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function yg(e,n,t){if(e.path!==void 0&&e.path!==""){let o=we(e.colorHex,"fill"),s=e.size*Xf;return v`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Cs=.25,bg=8;function xg(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Cs),bg),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),b=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+b)+0,width:m,height:g}}function nu(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var or=4;function vg(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+or:n.x+n.w-or-a,d=e.timestampCorner.startsWith("top")?n.y+or:n.y+n.h-or-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function wg(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function kg(e,n,t){let i=t.icons,a=`imgclip-${eu()}-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?vg(e,n,nu(new Date)):void 0,s=o?iu(o):f,l=e.url?t.imageSizes?.size(e.url):void 0,d;if(e.url&&l){let c=xg(n.w,n.h,l.width,l.height,e.contentMode,e.zoom,e.panX,e.panY);d=v`<image href=${e.url} x=${n.x+c.x} y=${n.y+c.y} width=${c.width} height=${c.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(wg(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return v`
    ...
    <text x=${e.x+e.w/2} y=${e.y+e.h/2} text-anchor="middle" dominant-baseline="central"
      ...
      font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${e.label}</text></g>`}function $g(e,n){if(!e.linked)return f;let t=nu(new Date),i=nc(n.w,n.h);if(i<=0)return f;let a=t.length*i*.578+i*.89,r=i*1.25;return iu({x:n.cx-a/2,y:n.cy-r/2,w:a,h:r,size:i,label:t},e.url===void 0?.5:1)}function Cg(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Sg(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${xs} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var xs=5;function Sg(e,n){let t=xs*.55,i=n.w-2;if(n.h<xs*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function au(e){let n=new Map;for(let t of e)t.kind==="chart"&&n.set(t.id,t);return n}function vs(e,n,t,i=new Map){if(e.isHidden&&!t.showHidden)return f;let a=t.tapReview===!0,r=t.tapAreas===!0||a,o=a?t.tapFocusId:void 0,s=o!==void 0&&e.id===o,l=o!==void 0;if(e.kind==="tap"&&!r)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!a||l&&!s))return f;let d=ar(e,n),c=a&&(!l||s),u;switch(e.kind){case"text":u=ag(e,d);break;case"icon":u=yg(e,d,t.icons);break;case"gauge":u=rg(e,d);break;case"chart":u=sg(e,d);break;case"timeline":u=ug(e,d);break;case"chartTimes":u=pg(e,d);break;case"imageTime":u=$g(e,d);break;case"chartDots":u=hg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minDotRadius);break;case"chartGrid":u=mg(e,d,i.get(e.chart),t.highlightId===e.id||t.highlightIds?.includes(e.id)===!0,t.minGridStroke);break;case"shape":u=gg(e,d);break;case"image":u=kg(e,d,t);break;case"tap":u=Cg(e,d,t.icons,r,c?At(e.action):void 0);break}let p=a&&(e.kind!=="tap"||l&&!s)?.35:1,m=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*p,g=t.highlightId===e.id,y=g||t.highlightIds?.includes(e.id)===!0,b=e.kind==="chartDots"||e.kind==="chartGrid",k=e.chartAnchor?.place==="through",C=t.handles===!0&&(!l||s)&&!b&&!k,w=e.kind==="shape"&&e.shapeKind==="circle"?fg(d):d,S=y&&!b?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,A=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,D=b?f:v`<rect x=${w.x} y=${w.y} width=${w.w} height=${w.h} fill="transparent" stroke="none" />`,I=3,q=w,R=g&&C?[["nw",q.x,q.y],["ne",q.x+q.w,q.y],["sw",q.x,q.y+q.h],["se",q.x+q.w,q.y+q.h]].map(([U,K,G])=>v`<rect data-handle=${U} x=${K-I/2} y=${G-I/2} width=${I} height=${I}
    ...
    ${e.maxLabel!==void 0?b(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function dr(e,n){let t=e.family in Le?e.family:"rectangular",i=n.slot??Le[t],a=Le[t],r=sr(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=We(e.backgroundColorHex),l=We(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements,u=au(c);if(t==="corner"){let b=r.scale,k=!!e.bezelText||!!e.bezelGauge,C=e.curvedText??"",w=C!=="",S=lr(b,k),A=Ss(b,k),D=A/(a.width*b),I=S.tile.cx-A/2,q=S.tile.cy-A/2,R=`M 0 0 H ${S.quad.width-S.cornerRadius} A ${S.cornerRadius} ${S.cornerRadius} 0 0 1 ${S.quad.width} ${S.cornerRadius} V ${S.quad.height} H 0 Z`,U=f;if(e.bezelGauge)U=Fg(e.bezelGauge,b,o);else if(e.bezelText){let G=Tg(b,`${o}-bezel`),ie=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?ui((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;U=v`<defs><path id=${G.id} d=${G.d} /></defs>
        <text font-size=${Vc*b} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${G.id}" startOffset="50%" text-anchor="middle">${Gc(ie,G.length,Vc*b)}</textPath></text>`}let K=f;if(w){let G=We(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},ie=ou(b,`${o}-curved`,Eg*b,Mg);K=v`<defs><path id=${ie.id} d=${ie.d} /></defs>
        <text font-size=${Uc*b} font-weight="600" fill=${G.color} fill-opacity=${G.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${ie.id}" startOffset="50%" text-anchor="middle">${Gc(C,ie.length,Uc*b*.88)}</textPath></text>`}else{let G=e.borderWidth*r.scale*D,ie=l?v`<circle cx=${A/2} cy=${A/2} r=${A/2-G/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${G} />`:f;K=v`<g transform="translate(${I} ${q})">
        <g clip-path=${`url(#${o})`}>
    ...
    <path d=${Lu(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
        ...
        <text x="6" y="39" font-family=${gi} font-size="7" fill=${xt}>1h ago</text>
        <text x="114" y="39" font-family=${gi} font-size="7" text-anchor="end" fill=${xt}>now</text>
    ...
    </select></label>`}function te(e,n,t,i,a={}){let r=o=>t.find(([s])=>s===o)?.[1]??o;return h`<div class="field seg-field">${De(e,un(n,a.def,o=>i(o,null),r))}
    ...
    </div>`}function $y(e,n){let t=i=>un(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${De(e.label,t(e))}
    <div class="pair-row">
  ...
  </div>`}function Ry(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var op=120;function Fy(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(fr.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(gr),fromPack:!1}}function sp(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function Ay(e){return[{value:"",label:`Starter set (${sp(gr,e)})`},...fr.map(n=>({value:n.name,label:`${n.name} (${sp(n.symbols,e)})`}))]}function Hy(e){return e.length>0?e.length:gr.length}function lp(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Tr(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Ap(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Be),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=Iy(u,c),b=w=>{t(w),a?.(w.startsWith(Be)?e.icons.mdiPath?.(w):void 0),r.noteUsed(w)},k=w=>{if(t(w),!m)return;let S=w.trim();a?.(S.startsWith(Be)?e.icons.mdiPath?.(S):void 0)},C=f;if(o&&g==="mdi"){let w=e.icons.mdiNames?.(),S=Ly(w??[],s),A=S.slice(0,op),D=r.recent.filter(I=>I.startsWith(Be));C=h`<div class="sym-browse">
      ${dp(r,i,g)}
      <div class="sym-controls">
        <input type="search" placeholder="Search Material Design icons" .value=${s} @input=${xe(I=>r.setQuery(i,I))} />
      </div>
      ${D.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${D.map(I=>Tr(e,I,I===u,b))}</div>`}
      <div class="sym-grid">${A.map(I=>Tr(e,I,I===u,b))}</div>
      ${w===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:S.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${lp(A.length,S.length,!0,w.length)}</div>`}
    ...
    </div>`}else if(o){let w=r.category(i),S=Fy(w,s,d,c),A=Fs(S.names,s),D=S.fromPack?A.slice(0,op):A,I=r.recent.filter(R=>!R.startsWith(Be)),q=c.size===0?I:I.filter(R=>c.has(R));C=h`<div class="sym-browse">
      ${m?dp(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${xe(R=>r.setQuery(i,R))} />
        <select @change=${xe(R=>r.setCategory(i,R))}>
          ${Ay(c).map(R=>h`<option value=${R.value} ?selected=${R.value===w}>${R.label}</option>`)}
        </select>
      </div>
      ${q.length===0?f:h`<div class="hint keep">Recent</div>
        <div class="sym-grid one-row">${q.map(R=>Tr(e,R,R===u,b))}</div>`}
      <div class="sym-grid">${D.map(R=>Tr(e,R,R===u,b))}</div>
      ${A.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${lp(D.length,A.length,s.trim()!=="",Hy(d))}
          </div>`}
    ...
    ${C}`}function Iy(e,n){let t=e.trim();return t!==""&&!t.startsWith(Be)&&n.size>0&&!n.has(t)}function Ly(e,n){let t=n.trim(),i=t.startsWith(Be)?t.slice(Be.length):t,a=e.map(r=>r.startsWith(Be)?r.slice(Be.length):r);return Fs(a,i).map(r=>Be+r)}function dp(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var _y=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],zy={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Py=[["straight","Straight"],["smooth","Smooth"],["step","Step"]],Ny=[["flat","Flat"],["fade","Fade"]],Hp=[["auto","Auto"],["all","All"]],Dy=[["off","Off"],["light","Light"],["medium","Medium"],["strong","Strong"]],Ip=[["bars","Bars"],["line","Line"],["area","Area"]],Oy=[["auto","Auto"],["fixed","Fixed range"]],Vy=[["lowest","Lowest value"],["zero","Zero"]],By=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],el=[["uniform","One colour"],["bands","By value"]];function Pr(e){let n=[Co,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Z(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Z(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function sl(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Gy(e,n){let t=Jt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Z(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Uy(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function Ky(e,n,t){let{lo:i,hi:a}=Uy(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
    ...
    <button class="small" @click=${()=>n(o=>{o.bands=[...o.bands,{id:Z(),match:r,colorHex:Ra(r)}]})}>${r===""?"Add state":`Add ${r}`}</button>
    ${he("Otherwise",e.otherColorHex,o=>n(s=>{s.otherColorHex=o??Zt},"tother"),!1,Zt)}`}var qy=[["arc","Arc"],["ring","Ring"],["bar","Bar"],["dots","Dots"]],Yy={arc:"A 270\xB0 arc, open at the bottom",ring:"A full circle",bar:"A straight bar",dots:"One dot per unit, the first few filled"};function cp(e){let n=e.value.kind;if(n.kind==="aggregate"){let{stateFilter:t,...i}=n.aggregate;return{kind:{kind:"aggregate",aggregate:{...i,function:"count"}}}}return L(String(Math.max(1,Math.round(e.maxValue-e.minValue))))}var Xy=[["now","Time (14:05)"],["hour","Hour"],["minute","Minute"],["weekday","Day of the week (0 is Monday)"],["day","Day of the month"],["month","Month number"],["timestamp","Unix timestamp (seconds)"]];function Jy(e,n){let t="entityId"in e?{entityId:e.entityId,displayName:e.displayName,domain:e.domain}:{entityId:"",displayName:"",domain:""};switch(n){case"literal":return{kind:n,value:e.kind==="literal"?e.value:""};case"entityState":return{kind:n,...t};case"entityAttribute":return{kind:n,...t,attribute:""};case"entityAge":return{kind:n,...t};case"aggregate":return{kind:n,aggregate:{function:"count",scope:{kind:"filter",domains:[],areaIds:[],labelIds:[],floorIds:[]},stateFilter:{kind:"isOn"}}};case"time":return{kind:n,timeField:"now"};case"dataAge":return{kind:n};case"jinja":return{kind:n,value:e.kind==="jinja"?e.value:"{{ states('sensor.example') }}"};case"named":return{kind:n,id:""};case"chartStat":return{kind:n,layer:"",stat:"latest"}}}function se(e,n,t,i){if(i.inline||!Zy())return h`<div class="value-editor">${Pp(e,n,t,i)}</div>`;let a=Yr(i.key),r=i.label??"Value",o=i.showResolved?e.resolve(n):void 0,s=Te(n,de(e)),l="entityId"in n.kind;return h`<div class="field value-chip-field ${i.compact?"compact":""}">
  ...
  </details>`}function lb(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${n.function==="count"?f:Ee("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Dp=No,db=Dp.filter(([e])=>e!=="none");function cb(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Op(e,n){let t=cb(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return Kd(e)?{type:e,...t}:{type:e}}var ub=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Vp(e,n,t,i){let a=n.serviceDataJSON??"",r=Wd(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??hb).slice(0,7)}
  ...
  </section>`}function wb(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function kb(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function $b(e,n){let t=pe[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Cb(e,n,t){let i=$b(e,n),a=pe[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Rb(e,n,t){let i=n.payload.id,a=`el-${i}`,r=He(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Re(p,t,i,{frame:Ps(o,c)}),`${a}-${u}-${t}`),l=!Dr(o,_i)||r.isHidden,d=n.payload.chartAnchor;if(n.kind==="chartDots"||n.kind==="chartGrid"){let c=e.config.elements.find(u=>u.payload.id===n.payload.chart);return $e(e,"placement","Position",h`
      ...
      ${qe("Hidden",r.isHidden,u=>e.update(p=>Re(p,t,i,{isHidden:u})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${ae(t)}`})}return d?.place==="through"?$e(e,"placement","Position",h`
      ...
      ${qe("Hidden",r.isHidden,c=>e.update(u=>Re(u,t,i,{isHidden:c})),!1)}`,{color:Q.position,icon:"place",summary:`On the chart \xB7 ${ae(t)}`}):$e(e,"placement","Position",h`
    ${fp(e,n,t)}
    ${d===void 0?h`
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
      ...
      sits on the edge of the plot or outside it, and nothing draws.</div>`:f}function Fb(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Ge(e.config,t)[0];return $e(e,"tappable","Tap",ix(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?At(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>Xa(a,t))}:{}})}function Ab(e,n,t,i,a){return h`
    ...
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${ne("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(en,Math.max(Qt,r??Qe))},`${i}size`),{step:.5,min:Qt,max:en,def:t.labelSize,unit:"pt"})}
      ...
      ${a}`}`}var Hb=[["number","Number"],["entity","Entity"]];function Ib(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function Lb(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function _b(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=Ib(n,o),c=s?n.minValue:n.maxValue,u=y=>a(b=>{s?b.minValue=y??0:b.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
      ${De(l,d==="number"?un(c,t[o],u):void 0)}
      <span class="seg" role="radiogroup" aria-label=${`${l} comes from`}>
        ${Hb.map(([y,b])=>h`<button type="button" role="radio" aria-checked=${y===d?"true":"false"}
          class=${y===d?"on":""} title=${p[y]}
          @click=${()=>{y!==d&&a(k=>Lb(k,o,y))}}>${b}</button>`)}
      </span>
    ...
    ${te("Highlight",r,By,c=>t(u=>{c==="none"?delete u.highlight:u.highlight=c}),{def:"none"})}
    ${r==="none"?f:h`
      <div class="grid2">
      ...
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var sa=new Map,oa=new Map,Pt=new Map,Rr=new Map,Xs=4,Js=40,Pb=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Nb=[["plain","Plain"],["rich","Rich"]],Db={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function dl(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${qe("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function Ob(e){return e.countdown===!0?"countdown":at(e)?"rich":"plain"}function Vb(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Bb(e,n){let t=Mn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ne(e.kind.value,40)||"template"}:{kind:"value",label:pa(e,n)}}function Xp(e,n,t){let i=Mn(e.value),a=i===void 0?Ne(pa(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ne(i,24)}"`;return`Part ${n+1}: ${a}`}function Gb(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Xp(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function nl(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function Ub(e,n){if(nl(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Jt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??le],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function gp(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${Jr(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Kb={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Wb(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${Jr(e.moved.map(n=>Kb[n]))} moved into Look.`}function jb(e,n,t,i,a){let r=n.payload,o=r.id,s=Ob(r),l=(r.parts?.length??0)>0,d=Do(e.config,r.value),c=Pt.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?oa.get(o):void 0,m=(b,k)=>{let C=!(r.parts??[]).every(S=>S.value.kind.kind==="literal"),w=$r(structuredClone(r),e.config.values);if(oa.delete(o),!w.ok){Pt.set(o,{text:gp(w.blocked),rich:!0,warn:!0}),Me(k);return}Pt.set(o,{text:Wb(w.joined?{joined:!0,template:C}:w),rich:!1}),i(S=>{$r(S,e.config.values),b==="countdown"&&(S.countdown=!0)})},g=(b,k)=>{if(oa.delete(o),s==="rich"){let C=b==="countdown"?"countdown":"plain",w=r.parts??[];if(w.length<2){m(C,k);return}let S=Vs(w,e.config.values);S.ok?(Pt.delete(o),oa.set(o,C)):Pt.set(o,{text:gp(S.blocked),rich:!0,warn:!0}),Me(k);return}if(b==="rich"){let C=r.parts?.[0]?.id??Z();sa.set(o,C),Pt.delete(o),i(w=>{delete w.countdown,Zu(w,C)});return}Pt.delete(o),i(C=>{if(b==="countdown"){C.countdown=!0;return}(C.parts?.length??0)>0&&$r(C,e.config.values),delete C.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${te("Type",s==="rich"?"rich":"plain",Nb,g,{titles:Db})}
    ...
    ${s==="rich"?qb(e,n,t,i,a):h`
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Ce(d,de(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function qb(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=de(e),d=Math.max(0,o.findIndex(H=>H.id===sa.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=He(e.config,t,n).size??r.fontSize,g=(H,W)=>{Pt.delete(s),i(E=>{H(E),Hd(E)},W)},y=(H,W)=>g(E=>{let x=E.parts?.find($=>$.id===c.id);x&&H(x)},W?`part-${c.id}-${W}`:void 0),b=(H,W)=>{sa.set(s,H),Pt.delete(s),Me(W)},k=(H,W)=>{let E=Z();sa.set(s,E),g(x=>{(x.parts??=[]).push({id:E,value:H})}),_p(W,Yr(`${a}-part-${E}`),!0)},C=H=>g(W=>{W.parts&&ca(W.parts,d,H)}),w=()=>{let H=o[d+1]??o[d-1];H&&sa.set(s,H.id),g(W=>{W.parts=(W.parts??[]).filter(E=>E.id!==c.id)})},S=o.map((H,W)=>{let E=Bb(H.value,l),x=H.id===c.id,$=nl(H),T=E.kind==="value"?e.resolve(H.value):void 0,F=H.fontWeight===void 0?void 0:xi.find(([P])=>P===H.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${x?"true":"false"} class="part-chip ${E.kind} ${x?"on":""}"
      aria-label=${Xp(H,W,l)} @click=${P=>b(H.id,P.currentTarget)}>
      <span class="part-dot" style=${`background:${Ub(H,p)}`}
        title=${$==="bands"?"By value, with its own bands":$==="pick"?"Its own colour":"The layer colour"}></span>
      ${E.kind==="text"?h`<span class="part-txt">${E.label===""?h`<span class="part-empty">empty</span>`:Vb(E.label).map(P=>P.space?h`<span class="part-sp">${"\xB7".repeat(P.text.length)}</span>`:P.text)}</span>`:h`<span class="part-txt">${E.label}</span>`}
      ${T===void 0?f:h`<span class="part-now">${T}</span>`}
      ${F===void 0?f:h`<span class="part-flag" title="Its own weight">${F}</span>`}
      ${H.fontSize===void 0?f:h`<span class="part-flag" title="Its own font size">${H.fontSize} pt</span>`}
    </button>`}),A=r.rules.some(H=>H.partId===c.id),D=c.value.kind.kind==="literal",I=nl(c),q=c.fontSize!==void 0,R=xi.find(([H])=>H===r.fontWeight)?.[1]??r.fontWeight,U=H=>{H>=Xs&&H<=Js&&y(W=>{W.fontSize=H},"size")},K=I==="bands"?Ke(e.resolve(c.value)??""):[],G={layer:"Use the layer colour",...D&&I!=="bands"?{bands:"By value needs a live value"}:{}},ie=(H,W)=>y(E=>{let x={bands:E.bands??[],bandAboveColorHex:E.bandAboveColorHex??le};H(x),x.bands.length>0?E.bands=x.bands:delete E.bands,x.bandAboveColorHex!==le?E.bandAboveColorHex=x.bandAboveColorHex:delete E.bandAboveColorHex},W);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${H=>k(L(""),H.currentTarget)}>${V("text")}<span>Add text</span></button>
    ...
    <div class="part-editor">
      ...
      ${se(e,c.value,H=>y(W=>{W.value=H},"value"),{showResolved:!0,label:D?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ${D?h`<div class="hint">Spaces count, and show as dots in the parts list. Type one at the start or end when this part needs a gap.</div>`:f}
      ${te("Colour",I,Pb,H=>y(W=>{if(H==="layer"){delete W.colorHex,delete W.coloring;return}if(H==="pick"){delete W.coloring,W.colorHex=rl(p,"#FFFFFF")?"#64D2FF":p;return}delete W.colorHex,W.coloring="bands",(W.bands?.length??0)===0&&(W.bands=Pr(Ke(e.resolve(W.value)??"")))}),{def:"layer",titles:G,...D&&I!=="bands"?{disabled:{bands:!0}}:{}})}
      ${I==="pick"?he("Part colour",c.colorHex,H=>y(W=>{W.colorHex=H??p},"color")):f}
      ${I==="bands"?h`
        ${Nr({bands:c.bands??[],bandAboveColorHex:c.bandAboveColorHex??le},c.colorHex??p,ie,K.length===1?K[0]:void 0)}
        <div class="hint">These bands belong to this part. Another value in the same layer keeps its own.</div>`:f}
      <div class="field seg-field">${De("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${R})`,reset:()=>y(H=>{delete H.fontWeight})})}
        ${_r("Weight",c.fontWeight,xi,H=>y(W=>{W.fontWeight=H}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${De("Font size",q?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(H=>{delete H.fontSize})}:void 0,Wr(c.fontSize??m,U,{step:1,min:Xs,max:Js}))}
        ${jr(c.fontSize,H=>{H===void 0?y(W=>{delete W.fontSize},"size"):U(H)},{step:1,min:Xs,max:Js,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:q?"Part font size":`Part font size, ${m} pt from the layer`,...q?{}:{lead:V("link")}})}
      </label>
    </div>
  </div>`}function Jp(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(x=>x.payload.id===a),o=`el-${a}`,s=(x,$)=>e.update(T=>x(T.elements[r]),$?`${o}-${$}`:void 0),l=He(e.config,t,n),d=l.frame,c=(x,$)=>e.update(T=>Re(T,t,a,{frame:Ps(d,x)}),`${o}-${$}-${t}`),u=Se(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=x=>u[x],g=!1,y=x=>jn(n)===void 0?f:he(x,jn(n),$=>s(T=>{jn(T)!==void 0&&(T.payload.colorSlot.baseColorHex=$??"#FFFFFF")},"color"),!1,p),b,k={},C,w;switch(n.kind){case"text":{let x=($,T)=>s(F=>$(F.payload),T);C=jb(e,n,t,x,o),g=!n.payload.countdown&&!at(n.payload),w=h`
        ${dn(e,n,t,"Font size",{step:1,min:4,def:m("fontSize")})}
        ${te("Weight",n.payload.fontWeight,xi,$=>s(T=>{T.payload.fontWeight=$}),{def:u.fontWeight})}
        ${$y({label:"Align",value:n.payload.alignment??"center",options:gb,def:"center",set:$=>s(T=>{let F=T.payload;$==="center"?delete F.alignment:F.alignment=$})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:yb,def:"1",set:$=>s(T=>{let F=T.payload;$==="2"?F.lineLimit=2:delete F.lineLimit})})}
        ${qe("Mono digits",n.payload.monospacedDigits===!0,$=>s(T=>{let F=T.payload;$?F.monospacedDigits=!0:delete F.monospacedDigits}),u.monospacedDigits===!0)}
        ...
        ${g?zb(e,n.payload,x,y("Main colour")):f}`;break}case"icon":C=h`
        ...
        <div class="hint">An entity source draws that entity's own icon instead. A Material Design icon travels with the document, so a rule that swaps the icon goes back to SF Symbols.</div>`,w=dn(e,n,t,"Icon size",{step:1,min:4,def:m("size")});break;case"gauge":{let x=n.payload,$=(F,P)=>s(Y=>F(Y.payload),P),T=x.style==="dots";C=h`
        ${se(e,x.value,F=>$(P=>{P.value=F},"value"),{showResolved:!0,label:"Reading",key:`${o}-value`})}
        ${T?h`
            ${se(e,x.total??cp(x),F=>$(P=>{P.total=F},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Na} dots are drawn.</div>`:_b(e,x,{min:u.minValue,max:u.maxValue},o,$)}`,g=!0,w=h`
        <div class="grid2">
          ${te("Style",x.style,qy,F=>$(P=>{F==="dots"&&P.total===void 0&&(P.total=cp(P)),F!=="dots"&&delete P.total,P.style=F}),{titles:Yy,def:u.style})}
        ...
        ${te("Colour",x.coloring,el,F=>$(P=>{P.coloring=F,F==="bands"&&P.bands.length===0&&(P.bands=Pr([P.minValue,P.maxValue]))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
        ...
        ${T?f:h`
          <div class="grid2">
            ${ne("Threshold",x.thresholdValue,F=>$(P=>{F===void 0?delete P.thresholdValue:P.thresholdValue=F},"thr"),{optional:!0,def:null})}
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let x=n.payload,$=(M,N)=>s(fe=>M(fe.payload),N),T=u.historyMinutes,F=u.historyPoints,P=x.historyMinutes>0,Y=P&&x.source==="statistics",ee=P&&!Y,ve=P?Y?"statistics":"history":"value",kt=Y?Pi:Rn,Ot=An(x)??Hn(x),_e=x.value.kind.kind==="entityState",me=Ot===void 0?void 0:e.historySeries(Ot),Oe=P&&_e?me??"":e.resolve(x.value)??"",Ye=x.historyPoints<1,Dh=ee&&_e&&Ot!==void 0?e.historyReadings?.(Ot):void 0,Sl=Eb(Ye,Dh,Yn(x.historyMinutes)),Tl=tl(a,x.historyMinutes,kt),to=P&&_e?hs(Oe):{values:Ke(Oe),holes:[]},Qn=to.values,El=M=>x.limit>0&&M.length>x.limit?x.takeFromEnd?M.slice(M.length-x.limit):M.slice(0,x.limit):M,Oh=El(Qn),Vt=ms(Oh,it(x.smoothing),to.holes.length>0?El(to.holes):[]),Vh=!P&&_e&&Qn.length===1,no=e.config.elements.filter(M=>M.kind==="chart"&&M.payload.id!==a),Ml=de(e),fa=x.scaleFrom!==void 0&&no.some(M=>M.payload.id===x.scaleFrom);C=h`
        ${se(e,x.value,M=>$(N=>{N.value=M},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${te("Draw",ve,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],M=>$(N=>{if(M==="value"){N.historyMinutes=0;return}N.source=M==="statistics"?"statistics":"history";let fe=N.historyMinutes||Oa;N.historyMinutes=M==="statistics"?Math.min(fe,Mo):Math.min(fe,Va)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${Y?h`
            ...
            <div class="grid2">
              ${qs(a,x.historyMinutes,T,M=>$(N=>{N.historyMinutes=M}),Pi)}
              ${te("Per",x.statPeriod,za,M=>$(N=>{N.statPeriod=M}),{def:Ii})}
            </div>
            ${Tl?Ys(x.historyMinutes,M=>$(N=>{N.historyMinutes=M},"span"),!0):f}
            ${te("Read",x.statType,ko,M=>$(N=>{N.statType=M}),{def:Li})}
        ...
        ${ee?h`
            ${_e?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${qs(a,x.historyMinutes,T,M=>$(N=>{N.historyMinutes=M}))}
              <div class="field readings-field">${De("Points",{atDefault:x.historyPoints===F,title:`Back to ${F<1?"every one":`${F} averaged`}`,reset:()=>$(M=>{M.historyPoints=F})})}
                <div class="readings-row">
                  ...
                  ${Ye?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(x.historyPoints)}
                      ...
                      data-scrub @pointerdown=${ua(x.historyPoints,M=>$(N=>{N.historyPoints=Math.round(M)},"hpoints"),{step:1,min:Ba,max:Ft})}
                      @input=${xe(M=>{let N=Number(M);M.trim()!==""&&Number.isFinite(N)&&N>=1&&$(fe=>{fe.historyPoints=Math.round(N)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${Tl?Ys(x.historyMinutes,M=>$(N=>{N.historyMinutes=M},"span")):f}
        ...
        ${P?h`
            ${qe("Show gaps when unavailable",x.gaps===!0,M=>$(N=>{M?N.gaps=!0:delete N.gaps}),u.gaps===!0)}
            ${ln(e)}
        ...
        ${Qn.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${wb(Vt)}</span>${Qn.length===Vt.length?h` · ${Vt.length} ${Vt.length===1?"value":"values"}`:h` · ${Vt.length} of ${Qn.length}`}</span></div>`:f}
        ...
        ${P&&x.limit<=0?f:h`
        <div class="grid2">
          ${ne("Only draw",x.limit,M=>$(N=>{N.limit=Math.max(0,Math.round(M??0))},"limit"),{step:1,min:0,def:u.limit,unit:"readings"})}
          ${x.limit<=0?f:te("Keep",x.takeFromEnd?"end":"start",P?[["start","Oldest"],["end","Newest"]]:[["start","First"],["end","Last"]],M=>$(N=>{N.takeFromEnd=M==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        ${ke("Smooth data",it(x.smoothing)??"off",Dy,M=>$(N=>{let fe=it(M);fe===void 0?delete N.smoothing:N.smoothing=fe}),{def:it(u.smoothing)??"off"})}
        ${ln(e)}
        <div class="hint">Averages each reading with its neighbours, weighted towards the middle, so a
          ...
          read the smoothed series too: its stats, highlights and bands. A text layer pointed at the entity itself still shows the raw value.</div>`,g=!0;let Bh=(()=>{if(fa)return!0;if(x.scale==="fixed")return x.minValue<0&&x.maxValue>0;let M=Vt.filter(io=>Number.isFinite(io));if(M.length===0)return!0;let N=Math.min(...M,x.thresholdValue??1/0),fe=Math.max(...M,x.thresholdValue??-1/0);return N<0&&fe>0})();w=h`
        <div class="grid2">
          ${te("Style",x.style,Ip,M=>$(N=>{N.style=M}),{def:u.style})}
          ${x.style==="bars"?ne("Bar gap",x.barGap,M=>$(N=>{N.barGap=Math.max(0,M??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):dn(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        ${x.style==="bars"?h`
          <div class="grid2">
            ${ne("Corner radius",jt(x.barRadius),M=>$(N=>{let fe=Math.max(0,M??ii);fe===ii?delete N.barRadius:N.barRadius=fe},"barradius"),{step:.5,min:0,def:jt(u.barRadius),unit:"pt"})}
          </div>
          ${qe("Round top only",qt(x.barCorners)==="top",M=>$(N=>{M?N.barCorners="top":delete N.barCorners}),qt(u.barCorners)==="top")}
          ${ln(e)}
          <div class="hint">Round top only rounds the end away from the baseline, so a bar hanging
            below zero rounds its bottom.</div>`:h`
          ${te("Curve",x.curve??"straight",Py,M=>$(N=>{M==="straight"?delete N.curve:N.curve=M}),{titles:{straight:"A straight line from each reading to the next",smooth:"A smooth line that never rises past the highest reading or dips under the lowest",step:"Each reading holds flat until the next one, the way a state does"},def:u.curve??"straight"})}
          ${ln(e)}
          ${x.style==="area"?h`
            ${te("Fill",Wt(x.fillStyle),Ny,M=>$(N=>{M==="flat"?delete N.fillStyle:N.fillStyle=M}),{titles:{flat:"One even wash under the line",fade:"Strongest at the top of the plot, fading to clear at the baseline"},def:Wt(u.fillStyle)})}
            ${Qs("Fill colour",x.fillColorHex,"Line colour",M=>$(N=>{M===void 0?delete N.fillColorHex:N.fillColorHex=M},"fillcol"))}
            ${ln(e)}`:f}`}
        <div class="grid2">
          ${te("Scale",x.scale,Oy,M=>$(N=>{N.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${te("Baseline",x.baseline,Vy,M=>$(N=>{N.baseline=M}),{def:u.baseline})}
        </div>
        ${no.length===0?f:ke("Same scale as",fa?x.scaleFrom:"",[["","Its own"],...no.map(M=>[M.payload.id,Ce(M,Ml)])],M=>$(N=>{M?N.scaleFrom=M:delete N.scaleFrom}),{def:""})}
        ...
        ${!fa&&x.scale==="fixed"?h`<div class="grid2">
              ${ne("Min",x.minValue,M=>$(N=>{N.minValue=M??0},"cmin"),{def:u.minValue})}
              ${ne("Max",x.maxValue,M=>$(N=>{N.maxValue=M??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let M;e.update(N=>{M=mc(N,a,fe=>Ce(fe,Ml))}),M&&e.selectLayer(M)}}>${V("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${te("Colour",x.coloring,el,M=>$(N=>{N.coloring=M,M==="bands"&&N.bands.length===0&&(N.bands=Pr(Vt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${x.coloring==="bands"?h`
          ...
          ${x.style==="area"?h`${qe("Band fill",x.fillBands,M=>$(N=>{N.fillBands=M}),u.fillBands)}
              <div class="hint">Off, the wash under the line stays one colour. On, each stretch of
                ...
                than one band and as noise on one that flickers between them.</div>`:f}`:f}`;let Rl=M=>Ve(e.config,a).some(N=>N.payload.chartAnchor?.at===M),Gh=nn(e.config,a).length>0,Uh=zn(e.config,a).length>0,Kh=Pn(e.config,a).length>0,Fl=ic(e.config,a).length>0,Al=Fn(x)?void 0:Ye&&ee?"Clock times need evenly spaced readings: set Points to Average":"Clock times need a recorded span: set Draw to Recorded history",Hl=x.style==="bars"?"Dots sit on a line or area chart: set Style to Line or Area":void 0;k={"draw:times":Al,"draw:dots":Hl};let ei=(M,N,fe,io,Il)=>h`
        <button class="small ${fe?"on":""}" ?disabled=${fe||Il!==void 0} aria-pressed=${fe?"true":"false"}
          data-extra=${M} title=${Vr(M,fe?`${N} is on this chart. Remove it in the list at the bottom.`:Il??`Add ${N.toLowerCase()} to this chart`)}
          @click=${()=>e.update(Wh=>{io(Wh)})}>${fe?h`<span aria-hidden="true">✓</span>`:V("plus")}<span>${N}</span></button>`;b=h`
        <div class="field list-field"><span>Draw</span>
          <div class="adders" @pointerover=${cn} @focusin=${cn}>
            ${ei("draw:threshold","Threshold line",Rl("threshold"),M=>ac(M,a,x.thresholdValue??sl(Vt)))}
            ${ei("draw:now","Now line",Rl("now"),M=>rc(M,a,!0))}
            ${ei("draw:zero","Zero line",Fl,M=>{Wo(M,a)})}
            ${ei("draw:times","Clock times",Gh,M=>{_n(M,a)},Al)}
            ${ei("draw:dots","Dots",Uh,M=>{Uo(M,a)},Hl)}
            ${ei("draw:grid","Grid lines",Kh,M=>{Ko(M,a)})}
          </div>
        </div>
        ...
        <div class="hint">Each button adds a layer to this chart, listed at the bottom. Click it there to set its
          ...
          those lines.</div>
        ${ln(e)}`;break}case"timeline":{let x=n.payload,$=(me,Oe)=>s(Ye=>me(Ye.payload),Oe),T=u.historyMinutes,F=x.value.kind.kind==="entityState",P=ft(x),Y=P===void 0?void 0:e.historySeries(P),ee=rt(x)*60,ve=qi(Y??"",tn),kt=tl(a,x.historyMinutes),Ot=x.value.kind.kind==="entityState"?x.value.kind.entityId:void 0,_e=Wy(ve,ee,Ot===void 0?void 0:e.hass.states[Ot]?.state,Ot?.split(".")[0]);C=h`
        ...
        ${F&&Y===void 0?h`<div class="hint keep">Reading the history…</div>`:f}
        ...
        ${ve.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Tb(ve,ee)}</span></span></div>`:f}
        ${Sb(ve)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${jy(x,$,_e,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
...
`;break}case"shape":C=h`<div class="grid2">
        ...
        ${n.payload.kind==="line"?Cb(t,d,c):f}`,w=n.payload.kind==="line"?ne("Thickness",n.payload.thickness,x=>s($=>{$.payload.thickness=x??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${n.payload.borderColorHex!==void 0?ne("Border width",n.payload.borderWidth,x=>s($=>{$.payload.borderWidth=x??1},"bw"),{step:.5,min:0,def:u.borderWidth,unit:"pt"}):f}`;break;case"image":{let x=n.payload,$=(Y,ee)=>s(ve=>Y(ve.payload),ee),T=x.entity.entityId?e.hass.states[x.entity.entityId]?.attributes?.entity_picture:void 0,F=typeof T=="string"?T:void 0,P=F!==void 0&&!F.startsWith("/");C=h`
        ${te("Source",x.source,[["camera","Camera"],["entityPicture","Entity picture"]],Y=>$(ee=>{ee.source=Y}),{titles:{camera:"A snapshot from a camera entity",entityPicture:"The picture an entity already carries: a person's photo, cover art, a weather icon"},def:u.source})}
        ${x.source==="camera"?h`
        ...
        ${te("Picture",x.contentMode,[["fill","Fill the frame"],["fit","Fit inside"]],Y=>$(ee=>{ee.contentMode=Y}),{titles:{fill:"Cover the frame, cropping what does not fit",fit:"Show the whole picture, with space around it"},def:u.contentMode})}
        ${qn("Zoom",x.zoom,Y=>$(ee=>{ee.zoom=Y},"zoom"),{min:Cs,max:4,step:.05,def:1,format:Y=>`${Y.toFixed(2)}x`,unit:"x"})}
        ${qn("Pan left/right",x.panX,Y=>$(ee=>{ee.panX=Y},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${qn("Pan up/down",x.panY,Y=>$(ee=>{ee.panY=Y},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${x.contentMode==="fit"&&x.zoom===1?"hint keep":"hint"}>${vb(x)}</div>
        ${ne("Corner radius",x.cornerRadius,Y=>$(ee=>{ee.cornerRadius=Math.max(0,Y??ri)},"imgradius"),{step:1,min:0,def:ri,unit:"pt"})}`;break}case"tap":{C=h`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}case"chartTimes":{let x=n.payload,$=(Y,ee)=>s(ve=>Y(ve.payload),ee),T=e.config.elements.find(Y=>Y.payload.id===x.chart),F=T?.kind==="chart"||T?.kind==="timeline"?T:void 0,P=F?.kind==="timeline"?"timeline":"chart";C=h`
        ...
        <div class="hint">The clock times of that ${P}'s span, spread across this layer's width and centred
          in its height. Move and size it like any other layer.</div>`,w=Ab(x,$,u,"ct",h`
        ...
        <div class="hint">The time that picture was fetched, not the time now: a picture that stops updating
          ...
          has been fetched once. Move and size it like any other layer: the chip grows to fill the frame.</div>`;break}case"chartDots":{let x=n.payload,$=(ee,ve)=>s(kt=>ee(kt.payload),ve),T=e.config.elements.find(ee=>ee.payload.id===x.chart),F=T?.kind==="chart"?T:void 0,P=F===void 0?void 0:He(e.config,t,F).size??F.payload.lineWidth,Y=P===void 0?void 0:Math.round(P*18)/10;C=h`
        ${yp(e,F)}
        ...
        <div class="grid2">
          ${ne("Dot size",x.size??Y,ee=>$(ve=>{let kt=ut(ee);kt===void 0||kt===Y?delete ve.size:ve.size=kt},"dotsize"),{step:.5,min:1,max:12,...Y===void 0?{}:{def:Y},unit:"pt"})}
        ...
        <div class="hint">Auto leaves the dots off once the readings sit too close to tell apart. Left alone, a dot
          is a little wider than the chart's line and takes the colour the series has at its reading.</div>`;break}case"chartGrid":{let x=n.payload,$=(P,Y)=>s(ee=>P(ee.payload),Y),T=e.config.elements.find(P=>P.payload.id===x.chart),F=T?.kind==="chart"?T:void 0;C=h`
        ${yp(e,F)}
        ...
        ${ln(e)}`,w=h`
        <div class="grid2">
          ${ne("Lines",x.lines,P=>$(Y=>{Y.lines=Tn(P??Xt)},"lines"),{step:1,min:1,max:4,def:Xt})}
          ${ne("Thickness",x.thickness,P=>$(Y=>{Y.thickness=En(P??Yt)},"thick"),{step:.25,min:La,max:_a,def:Yt,unit:"pt"})}
        </div>
        ${he("Colour",x.colorHex,P=>$(Y=>{Y.colorHex=P??Mt},"gridcol"),!1,Mt)}
        <div class="hint">Equal rows across the plot, never on its top or bottom edge.</div>`;break}}let S=g||jn(n)===void 0?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&at(n.payload)?"Layer colour":"Colour"),A=Xo(e.config,n),D=A?{kind:{kind:"entityState",...A}}:void 0,I=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,q=Xb[n.kind],R=Jb[n.kind],U=js(n.payload,u,q),K=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,G=e.config.perFamily[t]?.placements[a]?.size!==void 0,ie=js(n.payload,u,R)||K!==void 0&&l.size!==void 0&&l.size!==u[K],H=Ln(e.config,a),W=(x,$)=>()=>s(T=>Mr(T.payload,u,x),$),E=h`<section class="sec name-sec" data-open="true" style=${`--c:${Q.place}`}>
    <div class="sec-h pinned">
      ...
      <input type="text" aria-label="Layer name" .value=${n.payload.name??""} placeholder=${eh(n,de(e))}
        @input=${xe(x=>s($=>{let T=rx(x);T===void 0?delete $.payload.name:$.payload.name=T},"name"))} />
    </div>
  </section>`;return h`
    ${E}
    ${$e(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"||n.kind==="chartTimes"||n.kind==="chartDots"||n.kind==="chartGrid"||n.kind==="imageTime"?f:qp(e,n,o)}${C}`,{color:Q.content,icon:"content",summary:ll(e,n),...U?{reset:()=>s(x=>{Mr(x.payload,u,q),x.kind==="text"&&ta(x.payload.rules)},"reset-content")}:{}})}
    ${w===void 0&&S===void 0?f:$e(e,"look",n.kind==="image"?"Picture":"Look",h`${w??f}${S??f}`,{color:Q.look,icon:n.kind==="image"?"image":"look",...Or(n)?{summary:Or(n)}:{},...ie?{reset:()=>e.update(x=>{Mr(x.elements[r].payload,u,R),G&&Re(x,t,a,{},!0)})}:{}})}
    ${n.kind==="chart"?$e(e,"numbers","Extras",tx(e,n,b,k),{color:Q.numbers,icon:"text",summary:ex(e,n),...H.length>0||Ve(e.config,a).length>0||nn(e.config,a).length>0||zn(e.config,a).length>0||Pn(e.config,a).length>0||js(n.payload,u,bp)?{reset:()=>e.update(x=>{for(let T of Ln(x,a))ye(x,T.payload.id);for(let T of Ve(x,a))ye(x,T.payload.id);for(let T of nn(x,a))ye(x,T.payload.id);for(let T of zn(x,a))ye(x,T.payload.id);for(let T of Pn(x,a))ye(x,T.payload.id);let $=x.elements.find(T=>T.payload.id===a);$&&Mr($.payload,u,bp)})}:{}}):f}
    ${n.kind==="timeline"||n.kind==="image"?Yb(e,n):f}
    ${$e(e,"states","States",lh(e,n.payload.rules,n.kind,x=>x.elements.find($=>$.payload.id===a)?.payload.rules,`rules-${a}`,D,I),{color:Q.states,icon:"states",summary:Zi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(x=>{x.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Rb(e,n,t)}
    ${i.tap===!1?f:Fb(e,n)}`}function Yb(e,n){let t=n.payload.id,i=n.kind==="timeline",a=i?nn(e.config,t):Bo(e.config,t),r=i?"Clock times":"Timestamp",o=e.activeFamily,s=()=>e.update(p=>{let m=p.elements.find(y=>y.payload.id===t);if(!m)return;let g=m.payload.frame;m.payload.frame={...He(p,o,m).frame},i?_n(p,t):Go(p,t,pe[o==="inline"?"rectangular":o]),m.payload.frame=g}),l=a.length>0,d=a.map(p=>({el:p,lead:V("clock"),title:r,kind:i?"Times":"Timestamp"})),c=i?"timeline:times":"image:time",u=h`
    ${Qp(i?"timeline":"image")}
    <div class="field list-field"><span>Draw</span>
      <div class="adders" @pointerover=${cn} @focusin=${cn}>
    ...
    ${a.type==="openPage"?Gp(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var Zb=24;function Qb(e,n){let t=[],i=1/0;for(let r of oe){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=pc(e.config,n,r);o&&(t.push(`${ae(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<Zb;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function ex(e,n){let t=n.payload,i=Ln(e.config,t.id),a=Ve(e.config,t.id),r=nn(e.config,t.id),o=zn(e.config,t.id),s=Pn(e.config,t.id);if(i.length===0&&a.length===0&&r.length===0&&o.length===0&&s.length===0)return"None yet";let l=[...i.map(d=>{let c=d.payload.value.kind;return c.kind==="chartStat"?(Rt.find(([u])=>u===c.stat)?.[1]??"number").toLowerCase():"number"})];for(let d of a){let{at:c,place:u}=d.payload.chartAnchor,p=(ht.find(([m])=>m===c)?.[1]??"reading").toLowerCase();l.push(u==="through"?`${p} line`:`${p} marker`)}for(let d of r)l.push("times layer");for(let d of o)l.push("dots layer");for(let d of s)l.push("grid layer");return l.join(" \xB7 ")}function tx(e,n,t,i={}){let a=de(e),r=Ln(e.config,n.payload.id),o=nn(e.config,n.payload.id),s=zn(e.config,n.payload.id),l=Pn(e.config,n.payload.id),d=Ve(e.config,n.payload.id),c=b=>e.update(k=>{Zd(k,n.payload.id,b)}),u=b=>e.update(k=>{Vo(k,n.payload.id,b)}),p=new Set(r.map(b=>b.payload.value.kind.kind==="chartStat"?b.payload.value.kind.stat:"")),m=new Set(d.map(b=>b.payload.chartAnchor.at)),g=[...r.map(b=>({el:b,lead:e.resolve(b.payload.value)??"--",title:Ce(b,a),kind:"Number"})),...d.map(b=>{let{at:k,place:C}=b.payload.chartAnchor,w=ht.find(([A])=>A===k)?.[1]??"Reading";if(C==="through")return{el:b,lead:k==="now"?"\u2502":"\u2500",title:k==="zero"?"Zero":w,kind:"Line"};let S=b.kind==="text"?e.resolve(b.payload.value)??"\u25CF":b.kind==="icon"?ax(e.resolve(b.payload.symbol)):"\u25C6";return{el:b,lead:S,title:w,kind:"Marker"}}),...o.map(b=>({el:b,lead:V("clock"),title:"Clock times",kind:"Times"})),...s.map(b=>({el:b,lead:V("chartDots"),title:"Reading dots",kind:"Dots"})),...l.map(b=>({el:b,lead:V("chartGrid"),title:"Grid lines",kind:"Grid"}))],y=g.length;return h`
    ...
    ${y===0?f:h`
      ...
      ${V("show")}<span>Show preview</span></button>`;let t=e==="timeline"?"timeline:times":e==="image"?"image:time":void 0,i=da!==void 0&&Bs(da)===e?da:t,a=i===void 0?void 0:n[i],r=e==="image"?"picture":e;return h`<div class="xprev">
    ...
    <button class="icon xprev-hide" title="Hide the preview" aria-label="Hide the preview"
      @click=${o=>xp(!1,o.currentTarget)}>${V("hide")}</button>
    ...
    <div class="num-row">
      ...
      <button class="icon ${t.danger?"danger":""}" title=${t.label(d)} aria-label=${t.label(d)}
    ...
    </div>`})}</div>`}function nx(e,n){let t=n.payload.id,i=`quick-${t}`,a=e.activeFamily,r=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===t);m&&c(m)},`${i}-${u}`),o=Se(n.kind).payload,s=jn(n),l=s===void 0?f:he("Colour",s,c=>r(u=>{jn(u)!==void 0&&(u.payload.colorSlot.baseColorHex=c??"#FFFFFF")},"colour"),!1,o.colorSlot?.baseColorHex??"#FFFFFF"),d=n.payload.chartAnchor;switch(n.kind){case"text":{let c=n.payload.value.kind;return h`
        ${c.kind==="chartStat"?ke("Number",c.stat,[...Rt],u=>r(p=>{p.kind==="text"&&p.payload.value.kind.kind==="chartStat"&&(p.payload.value={...p.payload.value,kind:{...p.payload.value.kind,stat:u}})},"stat")):d||at(n.payload)?f:se(e,n.payload.value,u=>r(p=>{p.kind==="text"&&(p.payload.value=u)},"value"),{showResolved:!0,label:n.payload.countdown?"Until":"Text",key:`${i}-value`})}
        ...
        <div class="grid2">
          ${ne("Time size",c.labelSize,u=>r(p=>{p.kind==="chartTimes"&&(p.payload.labelSize=Math.min(en,Math.max(Qt,u??Qe)))},"size"),{step:.5,min:Qt,max:en,def:o.labelSize,unit:"pt"})}
        ...
        <div class="grid2">
          ${ne("Lines",c.lines,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.lines=Tn(u??Xt))},"lines"),{step:1,min:1,max:4,def:Xt})}
          ${ne("Thickness",c.thickness,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.thickness=En(u??Yt))},"thick"),{step:.25,min:La,max:_a,def:Yt,unit:"pt"})}
        </div>
        ${he("Colour",c.colorHex,u=>r(p=>{p.kind==="chartGrid"&&(p.payload.colorHex=u??Mt)},"colour"),!1,Mt)}`}default:return h`${l}`}}function vp(e,n,t,i){let a=ht.filter(([r])=>mt(r)||r===t.at);return h`
    <div class="grid2">
    ...
    </div>`}function ix(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Ge(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=Jo(e.config,n);return h`
    ...
    ${ul(e,t.map(r=>({el:r,lead:V(r.kind),title:Ce(r,i),kind:rn[r.kind]})),{icon:"ungroup",label:r=>`Take this ${r} out of the group`,run:r=>e.update(o=>Vi(o,r,void 0))})}
    <div class="row-acts">
    ...
    <div class="hint">Click a row to open its main settings here. More settings selects that layer for the rest.
      The button beside a row takes that layer out of the group and keeps it on the face.</div>`,{color:Q.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function nh(e,n){if(n==="inline")return ox(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${ae(n)} yet.</div>
    ...
    ${n==="corner"?$e(e,"corner","Corner content",sx(e,t,i),{color:Q.content,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas",...t.curvedText!==void 0||t.bezelText!==void 0||t.bezelGauge!==void 0?{reset:()=>i(s=>{delete s.curvedText,delete s.bezelText,delete s.bezelGauge},"reset-corner")}:{}}):f}
    ...
    ${$e(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:Q.look,icon:"icon",summary:n.symbol||"None"})}`}function sx(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ...
    ${a==="gauge"&&n.bezelGauge?lx(e,n.bezelGauge,t):f}`}function lx(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Jk=oe.map(e=>[e,ae(e)]),pl={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},dx=Object.keys(pl),Br=["color","text","fontSize","fontWeight","visibility"];function cx(e,n=!1){let t=Gi[e].filter(i=>!n||Br.includes(i));return dx.filter(i=>t.includes(ze[i]))}function ih(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${Gb(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var ux={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function Fr(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Ne(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function ah(e){if(!e||Ie(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function Te(e,n){return`${pa(e,n)}${ah(e.format)}`}function pa(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Ne(t.value,40)}"`:"(empty)";case"entityState":return Fr(t,n);case"entityAttribute":return t.attribute?`${Fr(t,n)} \xB7 ${t.attribute}`:Fr(t,n);case"entityAge":return`age of ${Fr(t,n)}`;case"aggregate":return px(t.aggregate);case"time":return ux[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Ne(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(Rt.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?pa(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function px(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function ca(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function hx(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(m=>ca(m,t,t-1))}>${V("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(m=>ca(m,t,t+1))}>${V("down")}</button>
    ...
    ${n.cases.map((m,g)=>fx(e,m,g,n,a,u,`${o}-${m.id}`,p))}
  ...
  </div>`}function fx(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(g=>g.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${d?h` <span class="ok">· active now</span>`:f}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>ca(c.cases,t,t-1))}>${V("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>ca(c.cases,t,t+1))}>${V("down")}</button>
    ...
    ${n.when.tests.map((c,u)=>gx(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
    ...
    ${rh(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
        ...
        ${s.pattern&&!yx(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
        ...
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=bx(n.value)?xx(s.options??[],u=>o(p=>{p.comparison.options=Ds(u)},"options")):Ee("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${c}
  </div>`}function yx(e){try{return new RegExp(e),!0}catch{return!1}}function kp(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Dn(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${xe(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function bx(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function xx(e,n){let t=qu(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    ...
    </div></div>`}function rh(e,n,t,i,a,r=!1){let o=cx(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>vx(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Vn(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${pl[s]}</option>`)}
    </select>`}var oh=["setColor","setBorderColor","setBackgroundColor"];function vx(e,n,t,i,a,r,o,s=!1){let l=!Gi[i].includes(ze[n.kind]),d=s&&!l&&!Br.includes(ze[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${sh(e,n,a,o)}
      ...
      ${hx(e,n,t,i,a,o)}`:wx(e,s.table,n[0],t,i,a,r,o)}function wx(e,n,t,i,a,r,o,s){let l=(E,x)=>e.update($=>{let T=a($);T&&E(T)},x?`${r}-${x}`:void 0),d=n.value??$p.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!Iu(d)&&kx(e.resolve(d)),p=Gi[i],m=Ar.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Hu[i]]:[],y=$u(n.columns,[...m,...g.filter(E=>E!==void 0)],p),b=Rr.get(r),k=t?t.partId:s?.some(E=>E.id===b)?b:void 0,C=s!==void 0&&k!==void 0,w=C?p.filter(E=>Br.includes(E)):p,S=C?y.filter(E=>!Br.includes(E)):[],A=(E,x)=>{if(!t){E?Rr.set(r,E):Rr.delete(r),Me(x);return}l($=>{let T=$[0];T&&(E?T.partId=E:delete T.partId)})},D=t?e.liveBranch(t):"none",I=t?e.forced.get(t.id)??"live":"live",q=E=>I!=="live"&&(I==="otherwise"?E==="otherwise":I.caseId===E),R=E=>{t&&e.setForced(t.id,q(E)?"live":E==="otherwise"?"otherwise":{caseId:E})},U=E=>{$p.set(r,E),n.rows.length!==0&&l(x=>Ru(x,E),"lhs")},K=()=>{Rr.delete(r),l(E=>{Eu(E,d??L(""),u),k!==void 0&&E[0]&&E[0].partId===void 0&&(E[0].partId=k)})},G=n.rows.map((E,x)=>Sp(e,{key:`${r}-${E.caseId}`,label:Au(E.comparison,$=>Te($,de(e))),columns:y,changes:E.changes,live:D===E.caseId,forced:q(E.caseId),onForce:()=>R(E.caseId),when:Ex(e,E.comparison,`${r}-${E.caseId}`,($,T)=>l(F=>{let P=F[0]?.cases.find(Y=>Y.id===E.caseId)?.when.tests[0];P&&$(P.comparison)},T&&`${E.caseId}-${T}`)),updChanges:($,T)=>l(F=>{let P=F[0]?.cases.find(Y=>Y.id===E.caseId);P&&$(P.then)},T&&`${E.caseId}-${T}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${x===0} @click=${()=>l($=>Ls($,x,x-1))}>${V("up")}</button>
      <button class="icon" title="Move down" ?disabled=${x===n.rows.length-1} @click=${()=>l($=>Ls($,x,x+1))}>${V("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l($=>Mu($,E.caseId))}>${V("delete")}</button>`})),ie=n.otherwise===void 0?f:Sp(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:D==="otherwise",forced:q("otherwise"),onForce:()=>R("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(E,x)=>l($=>{let T=$[0]?.otherwise;T&&E(T)},x),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(E=>_s(E,!1))}>${V("close")}</button>`}),H=Hr.get(r),W=$x.filter(E=>w.includes(E)&&!y.includes(E));return h`
    <div class="states">
      ${se(e,d??L(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:ih(s,k,de(e),A)}
      <div class="states-scroll"><table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(E=>h`<th>
              <span>${bt[E]}</span>
              <button class="icon" title=${`Remove the ${bt[E]} column`}
                @click=${x=>{Hr.set(r,E),Me(x.target)}}>${V("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${S.length===0?f:h`<div class="hint warn">A part ignores ${Jr(S.map(E=>bt[E]))}. Pick Whole text to use ${S.length===1?"it":"them"}.</div>`}
      ${H===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${bt[H]} column? Its ${Cp(n,H)} value${Cp(n,H)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${E=>{Hr.delete(r),Ar.get(r)?.delete(H),Me(E.target),l(x=>Fu(x,H))}}>Remove</button>
        <button class="small" @click=${E=>{Hr.delete(r),Me(E.target)}}>Cancel</button>
      </div>`}
      <div class="field list-field"><span>Add</span>
        <div class="states-foot">
          <button class="small" title="Add a row: a value to match and what the layer looks like then" @click=${K}>${V("plus")}<span>State</span></button>
          ${n.otherwise===void 0?h`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(E=>_s(E,!0))}>${V("plus")}<span>Otherwise</span></button>`:f}
          ${W.length===0?f:h`<select class="chip-add" title="Add a column" aria-label="Add a column" @change=${E=>{let x=E.target,$=x.value;if(x.value="",!$)return;let T=Ar.get(r)??new Set;T.add($),Ar.set(r,T),Me(x)}}>
            <option value="" selected>+ Column…</option>
            ${W.map(E=>h`<option value=${E}>${bt[E]}</option>`)}
          </select>`}
        </div>
      </div>
    ...
    ${n.columns.map(t=>h`<td>${Sx(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Sx(e,n,t,i,a){let r=br(t,n),o=Yr(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${bt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Vn(ku[n]))}),_p(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>ze[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=bt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Tx(e,r)}</button>
    ...
    </div>`}function Tx(e,n){if(n.kind==="hide")return h`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return h`<span class="cell-word">Shown</span>`;let t=er(n.kind);if(t==="number")return h`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return h`<span class="cell-word">${xi.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??L(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(oh.includes(n.kind))return h`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Ae(a):Te(i,de(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return h`${r??f}<span class="cell-word">${a}</span>`}return h`<span class="cell-word">${Te(i,de(e))}</span>`}function Ae(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function Ex(e,n,t,i){let a=On(n.kind),r=Hs(n.kind),o=(s,l,d,c)=>Rx(e,s,l,`${t}-${d}`,r,c,d==="rhs"?"Compare with":"Upper bound");return h`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${xe(s=>i(l=>{let d=ls(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${As.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Mx(s)}</option>`)}
    </select>
  ...
  </span>`}function Mx(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return fi[e]}}function Rx(e,n,t,i,a,r,o){let s=Yr(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${Lp(e,s,o,n,t,l)}
  </span>`}var ha=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Yo,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function ph(e){return ha.find(n=>n.kind===e)??ha[0]}var dh="#FF9F0A",Qr="#8E8E93",Fx=["#FF453A","#FFD60A","#34C759"],hh=["#0A84FF","#34C759","#FF9F0A"];function Ax(e){return e?.attributes?.device_class==="battery"?Fx:hh}var Hx={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function Ix(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Hx[hl(e)]??{off:"circle",on:"circle.fill"}}function Lx(e){switch(hl(e)){case"lock":return{kind:"equals",value:L("locked")};case"cover":case"valve":return{kind:"equals",value:L("open")};case"media_player":return{kind:"equals",value:L("playing")};default:return{kind:"isOn"}}}function hl(e){return e.domain||e.entityId.split(".")[0]||""}function mn(e){return{...e,domain:hl(e)}}function _x(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function vi(e){return Math.round(e*1e4)/1e4}function Jn(e,n,t){return Math.min(t,Math.max(n,e))}function ml(e,n,t){let i=Le[e],a=Jn(vi(n/i.width),0,1),r=Jn(vi(t/i.height),0,1);return{x:vi((1-a)/2),y:vi((1-r)/2),width:a,height:r,rotationDegrees:0}}function zx(e){let n=Le[e],t=Jn(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:ml(e,t*1.3,t*1.3),size:t}}function Px(e){let n=Le[e],t=Jn(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:ml(e,n.width*.88,t*1.7),size:t}}function Nx(e){let n=Le[e],t=Math.min(n.width,n.height)*.9;return{frame:ml(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function mh(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Dx(e){let n=Le[e],t=Jn(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:vi(t/n.height),rotationDegrees:0}}}function Ox(e){let n=Le[e],t=Jn(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:vi(Jn(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Vx(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Bx(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function pn(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Bx(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=Lt());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function hn(e){return Se(e)}function fl(e,n){let t={kind:{kind:"entityState",...mn(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function ch(e){let n=Vn("setIcon");return n.value=L(e),n}function Xn(e){let n=Vn("setColor");return n.value=L(e),n}function Gx(e,n){let t=Ui(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...mn(e)}},a.comparison=Lx(e);let r=n.on!==n.off;return i.then=r?[ch(n.on),Xn(dh)]:[Xn(dh)],t.otherwise=r?[ch(n.off),Xn(Qr)]:[Xn(Qr)],t}function Ux(e){let n=Ui(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...mn(e)}},i.comparison={kind:"isUnavailable"};let a=Vn("setOpacity");return a.number=.35,t.then=[a],n}function uh(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Kx(e,n,t=hh){let i=n.max-n.min,a=uh(n.min+i/3),r=uh(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:L(a)},changes:[Xn(t[0])]},{comparison:{kind:"between",value:L(a),upper:L(r)},changes:[Xn(t[1])]},{comparison:{kind:"greaterThan",value:L(r)},changes:[Xn(t[2])]}];return Cu(fl(e),o)}function Wx(e,n,t){let i=hn("icon"),a=Ix(n);return i.payload.symbol=L(a.off),i.payload.colorSlot.baseColorHex=Qr,i.payload.rules=[Gx(n,a)],pn(e,i,t.family,zx),e.elements.push(i),Ya(e,i.payload.id,{type:"toggleEntity",...mn(n)}),i.payload.id}function jx(e,n,t){let i=hn("text");return i.payload.value=fl(n,t.state),i.payload.rules=[Ux(n)],pn(e,i,t.family,Px),e.elements.push(i),i.payload.id}function qx(e,n,t){let i=hn("gauge");i.payload.value=fl(n);let a=_x(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Kx(n,a,Ax(t.state))],pn(e,i,t.family,Nx),e.elements.push(i),i.payload.id}function Yx(e,n,t){let i=hn("chart");return i.payload.value={kind:{kind:"entityState",...mn(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",pn(e,i,t.family,mh),e.elements.push(i),i.payload.id}function Xx(e,n,t){let i=hn("chart");return i.payload.value={kind:{kind:"entityState",...mn(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",pn(e,i,t.family,mh),e.elements.push(i),i.payload.id}function Jx(e,n,t){let i=mn(n),a=hn("text");a.payload.value=L(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=Qr,pn(e,a,t.family,Ox),e.elements.push(a);let r=t.state?.attributes?.device_class,o=hn("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=zo(i.domain,typeof r=="string"?r:void 0),pn(e,o,t.family,Dx),e.elements.push(o),o.payload.id}function Zx(e,n,t){let i=hn("image");return i.payload.entity=mn(n),pn(e,i,t.family,Vx),e.elements.push(i),i.payload.id}function fh(e,n,t,i){switch(n){case"toggle":return Wx(e,t,i);case"status":return jx(e,t,i);case"gauge":return qx(e,t,i);case"chart":return Yx(e,t,i);case"history":return Xx(e,t,i);case"doorHistory":return Jx(e,t,i);case"camera":return Zx(e,t,i)}}var Qx=/^[a-z0-9_]+\.shared_(\d+)$/;function gh(e){return Qx.test(e)}function ev(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function bh(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function xh(e,n){let t=new Map;for(let i of rs(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=bh(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${ev(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function tv(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);is(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),as(t,r=>Qo(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function vh(e){let n=!1;return Qa(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function nv(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function wh(e,n,t=[]){let i=n==="share"?tv(e,t):e,a=si(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${nv(a)}
`}function kh(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var iv="There is nothing to read here. Paste a complication first.",av="This is not valid JSON. Check for a missing brace or a stray comma.",rv="This is valid JSON but not a complication. A complication starts with { and ends with }.",ov="This does not look like a complication.",yh="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",sv="00000000-0000-4000-8000-000000000000";function lv(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function $h(e,n){let t=e.trim();if(t==="")return{ok:!1,error:iv};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:av}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:rv};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${yh}`};let o={...a,id:sv,slotIndex:0},s;try{s=oi(o)}catch(d){let c=d instanceof tt||d instanceof Error?d.message:String(d);return{ok:!1,error:`${ov}

${lv(c)}`}}let l=ja(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${yh}`}}return{ok:!0,config:s,raw:i}}function gl(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=rs(e,(o,s)=>gh(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=gh(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:bh(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function Ch(e,n){let t=structuredClone(e);is(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return as(t,a=>Qo(a,i)),t}function Sh(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function dv(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function Th(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=cr(e);return i.length===0?t:`${t}, ${dv(i)}`}function yl(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var uv=3e4,pv=500,hv=3e4,Eh="preset-entity";function Mh(e){return`import-entity-${e}`}var mv={entityId:"",displayName:"",domain:""},fv=new Map,gv={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function bl(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function yv(e){return e.kind==="family"?"look":"content"}function xl(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Rh(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h13" /><path d="M12 6l6 6-6 6" /></svg></span>`}function bv(e){let n=v`<rect x="3" y="2" width="38" height="48" rx="11" fill="none" stroke="currentColor" stroke-opacity=".55" stroke-width="1.5" />`,t=e==="rectangular"?v`<rect x="8" y="21" width="28" height="10" rx="3" fill="currentColor" />`:e==="circular"?v`<circle cx="22" cy="26" r="8" fill="currentColor" />`:e==="corner"?v`<path d="M9 18a9 9 0 0 1 9-9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" />
              <circle cx="11.5" cy="11.5" r="3" fill="currentColor" />`:v`<rect x="10" y="7" width="24" height="5" rx="2.5" fill="currentColor" />`;return h`<svg class="shape-art" viewBox="0 0 44 52" aria-hidden="true">${n}${t}</svg>`}var Fh=300,Ah=360,kl=44,$l=22,Nh=[1,1.7,2.6],xv=["S","M","L"],Hh=["Small","Medium","Large"];function vv(){return Nh.map((e,n)=>{let t=Math.round(kl*e),i=Math.round($l*e),a=`.layers-card.s${n}`;return`
...
`)}var Ih="wrist-assistant-panel.layers.v1",Nt=34,Zn=200,wv=720,eo=320,kv=80,$v=56,Lh="wrist-assistant-panel.columns.v3",vl=e=>Math.max(Zn,Math.min(wv,Math.round(e))),_h=e=>e.metaKey||e.ctrlKey||e.shiftKey;function Cv(e,n,t){let a=e.querySelector(`g[data-element-id="${CSS.escape(n)}"]`)?.firstElementChild;if(!a||a.tagName.toLowerCase()!=="rect")return!1;let r=a.getBoundingClientRect();return t.clientX>=r.left&&t.clientX<=r.right&&t.clientY>=r.top&&t.clientY<=r.bottom}var Sv=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,ma=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",fn=ma==="Cmd"?"\u2318":"Ctrl+",wl=ma==="Cmd"?"\u21E7":"Shift+";function zh(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-kv;if(i>=Zn*2+eo){let r=i-eo,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(Zn,Math.floor(o*l)),s=Math.max(Zn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(Zn,o-d):s=Math.max(Zn,s-d))}return{columns:3,left:o,right:s}}let a=e-$v;return a>=Zn+eo?{columns:2,left:Math.min(n,a-eo),right:t}:{columns:1,left:n,right:t}}var _=class _ extends Bt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Fh;this.colRight=Ah;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.historyReadings=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=hi.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=yu(()=>this.requestUpdate());this.imageSizes=bu(()=>this.requestUpdate());this.symbols=new mr(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new yr;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=gl(a,this.hass.states);r.some(s=>ol(Mh(s.entityId)))||yl({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||ol(Eh)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??fv}static{this.styles=ro`
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Ur,this.scrubStart),this.addEventListener(Kr,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},hv)}loadColumnWidths(){try{let t=window.localStorage.getItem(Lh);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=vl(i.left)),typeof i.right=="number"&&(this.colRight=vl(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Lh,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Ih);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Ih,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?Zo(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg.complication");if(this.showTaps){let K=this.focusTapId();if(K!==void 0&&o===K&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,K,r??void 0);return}let G=this.hitLayerId(i);G?this.inspect={kind:"layer",id:G}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let l=_h(i);if(!l&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let d=Zo(this.draft.config,o),c=this.draft.config.elements.find(K=>K.payload.id===d);if(!d||!c)return;if(l){i.preventDefault(),this.togglePick(d);return}let u,p=this.inspect.kind==="layer"?this.inspect.id:void 0;if(p!==void 0&&p!==d&&!r){let K=this.draft.config.elements.find(ie=>ie.payload.id===p);K!==void 0&&K.kind!=="chartDots"&&K.kind!=="chartGrid"&&K.payload.chartAnchor?.place!=="through"&&ot(this.draft.config,p)?.locked!==!0&&Cv(s,p,i)&&(u=d,d=p,c=K)}let m=ot(this.draft.config,d),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r){let K=g||this.inspect.kind==="layer"&&ot(this.draft.config,this.inspect.id)?.id===m.id;this.beginGroupGesture(t,i,s,m,K?d:void 0);return}if((this.inspect.kind!=="layer"||this.inspect.id!==d)&&(this.inspect={kind:"layer",id:d},r)||c.payload.chartAnchor?.place==="through")return;i.preventDefault();let y=He(this.draft.config,t,c).frame,b=this.gestureCanvas(t),k=c.payload.chartAnchor,C=k!==void 0&&!mt(k.at)&&k.place!=="through",w=k!==void 0&&mt(k.at)&&k.place==="through",S=pe[t],A={dx:k?.dx??0,dy:k?.dy??0},D=k!==void 0&&!r?Yi(this.draft.config,this.buildContext(),this.forced)[t]?.elements.find(K=>K.id===d)?.frame:void 0,I=D??y,q=K=>Math.round(K*10)/10;this.cancelGesture?.();let R=!1,U=r!==null&&c.kind==="shape"&&c.payload.kind==="circle";this.cancelGesture=vr(s,b,i,{elementId:d,frame:I,handle:r??void 0,square:U},{onFrame:(K,G,ie)=>{if(ie||(R=!0),ie&&!R&&u!==void 0){this.inspect={kind:"layer",id:u},this.cancelGesture=void 0;return}this.mutate(H=>{if(k===void 0){Re(H,t,K,{frame:G});return}let W=D?{width:y.width,height:y.height}:{width:G.width,height:G.height};Re(H,t,K,{frame:{...G,...W,x:C?G.x:y.x,y:y.y}});let E=H.elements.find(T=>T.payload.id===K)?.payload.chartAnchor;if(E===void 0)return;let x=A.dx,$=w?A.dy:q(A.dy+(G.y-I.y)*S.height);x?E.dx=x:delete E.dx,$?E.dy=$:delete E.dy},`drag-${K}-${t}`),ie&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r,o){let s=this.draft?.config;if(!s)return;let l=It(s,r.id);if(l.length===0)return;o===void 0&&(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let d=new Map(l.map(C=>[C.payload.id,He(s,t,C).frame])),c=[...d.values()],u=Math.min(...c.map(C=>C.x)),p=Math.min(...c.map(C=>C.y)),m=Math.max(...c.map(C=>C.x+C.width)),g=Math.max(...c.map(C=>C.y+C.height)),y={x:u,y:p,width:m-u,height:g-p,rotationDegrees:0},b=C=>Math.round(C*1e3)/1e3;this.cancelGesture?.();let k=!1;this.cancelGesture=vr(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y},{onFrame:(C,w,S)=>{if(S||(k=!0),S&&!k&&o!==void 0){this.inspect={kind:"layer",id:o},this.cancelGesture=void 0;return}let A=w.x-y.x,D=w.y-y.y;this.mutate(I=>{for(let[q,R]of d)Re(I,t,q,{frame:{...R,x:b(R.x+A),y:b(R.y+D)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?zu:1,s=t*o,l=i*o,d=this.canvasFamily,c=pe[d];if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let k=this.inspect.id;return this.nudgeMany(It(r,k).map(C=>C.payload.id),d,c,`nudge-group-${k}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(k=>k.payload.id===u);if(!p||p.payload.chartAnchor?.place==="through")return!1;let m=ot(r,u);if(m?.locked)return this.nudgeMany(It(r,m.id).map(k=>k.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=He(r,d,p).frame,y=p.payload.chartAnchor;if(y!==void 0){let k=!mt(y.at);return l===0&&!(k&&s!==0)||this.mutate(C=>{k&&s!==0&&Re(C,d,u,{frame:xr(g,s,0,c)});let w=C.elements.find(A=>A.payload.id===u)?.payload.chartAnchor;if(w===void 0||l===0)return;let S=Math.round(((w.dy??0)+l)*10)/10;S?w.dy=S:delete w.dy},`nudge-${u}-${d}`),!0}let b=xr(g,s,l,c);return(b.x!==g.x||b.y!==g.y)&&this.mutate(k=>Re(k,d,u,{frame:b}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=S=>Math.round(S*1e3)/1e3,c=new Map;for(let S of t){let A=l.elements.find(D=>D.payload.id===S);A&&c.set(S,He(l,i,A).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(S=>S.x)),m=Math.min(...u.map(S=>S.y)),g=Math.max(...u.map(S=>S.x+S.width)),y=Math.max(...u.map(S=>S.y+S.height)),b={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},k=xr(b,o,s,a),C=k.x-b.x,w=k.y-b.y;return(C!==0||w!==0)&&this.mutate(S=>{for(let[A,D]of c)Re(S,i,A,{frame:{...D,x:d(D.x+C),y:d(D.y+w)}})},r),!0}gestureCanvas(t){let i=sr(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=Ss(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Ge(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=be(s,l),c=He(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=vr(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?uc(g,u,t,p):Re(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:zh(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
      ...
      ${wt({hass:this.hass},t.label,i??mv,a=>this.setImportEntity(t.entityId,a),Mh(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
      ...
      ${a?h`
          <div class="add-grid ${r?"":"lean"}">
            ${Es.map(s=>h`<button class="add" style=${`--k:${je[s]}`} ?disabled=${i} title=${`Add a blank ${rn[s].toLowerCase()} layer`}
              ...
              >${r?h`<span class="well">${_u(s)}</span>`:f}<span class="add-name">${r?V(s):h`<span class="k"></span>`}<span>${rn[s]}</span></span></button>`)}
          </div>
          <div class="presets">
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Ce(R,d)}</b>
          <small><span class="kind">${rn[R.kind]}</span> · ${Rv(R,c,this.historySeries,H.size)}</small>
          ${S?h`<span class="facts">${Ev(this.host(),a,R,H).map(F=>h`<span class="fact"><b>${F.label}</b> ${F.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
            ${E?h`<span class="badge tap" title=${`Tappable \xB7 ${Ce(E,d)}`}>tap</span>`:f}
          ...
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${fn}])`} aria-label="Bring forward" @click=${F=>{F.stopPropagation(),r(G,1)}}>${V("up")}</button>
            <button class="icon" title=${`Send back (${fn}[)`} aria-label="Send back" @click=${F=>{F.stopPropagation(),r(G,-1)}}>${V("down")}</button>
            <button class="icon" title=${`${H.isHidden?"Show":"Hide"} (${wl}${fn}H)`} aria-label=${H.isHidden?"Show this layer":"Hide this layer"} @click=${F=>{F.stopPropagation(),this.mutate(P=>Re(P,a,G,{isHidden:!H.isHidden}))}}>${V(H.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${fn}D)`} aria-label="Duplicate" @click=${F=>{F.stopPropagation(),o(G)}}>${V("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${F=>{F.stopPropagation(),s(G)}}>${V("delete")}</button>
          </span>`:f}
        </span>
      </div>`},D=(R,U)=>{let K=this.inspect.kind==="group"&&this.inspect.id===R.id,G=!this.collapsed.has(R.id),ie=this.rowDrag(R.id,i),H=U[0],W=U[U.length-1],E=$=>{let T=$.currentTarget,F=T.getBoundingClientRect(),P=F.top+(T.classList.contains("drop-before")?Nt:0),Y=F.bottom-(T.classList.contains("drop-after")?Nt:0),ee=($.clientY-P)/Math.max(1,Y-P);return ee<.25?"drop-before":!G&&ee>.75?"drop-after":"drop-into"},x=U.map($=>$.payload.id);return h`<div class="layer group ${K?"hl":""} ${S?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${ie.draggable}
        @pointerenter=${()=>{this.listHoverIds=x}}
        @pointerleave=${()=>this.leaveRow(x)}
        @click=${()=>{this.multi=new Set,this.inspect={kind:"group",id:R.id}}}
        @keydown=${$=>{$.key==="Enter"&&(this.inspect={kind:"group",id:R.id})}}
        @dragstart=${ie.onStart} @dragend=${ie.onEnd}
        @dragover=${$=>{!this.dragId||this.dragId===R.id||($.preventDefault(),this.markDrop($.currentTarget,E($)))}}
        @drop=${$=>{$.preventDefault();let T=E($);this.clearDragMarks();let F=this.dragId;if(this.dragId=void 0,!(!F||!H||!W)){if(T==="drop-before"){this.reorderLayer(F,H.payload.id,!0,!0);return}if(T==="drop-after"){this.reorderLayer(F,W.payload.id,!1,!0);return}this.isGroupId(F)||(this.reorderLayer(F,H.payload.id,!0),this.mutate(P=>Vi(P,F,R.id)))}}}>
        ...
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${wl}${fn}G)`} aria-label="Ungroup" @click=${$=>{$.stopPropagation(),this.mutate(T=>Oi(T,R.id)),K&&(this.inspect={kind:"general"})}}>${V("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${R.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${$=>{$.stopPropagation(),this.mutate(T=>{let F=T.groups?.find(P=>P.id===R.id);F&&(F.locked=!F.locked)})}}>${V(R.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${G?"true":"false"} title=${G?"Fold the group":"Unfold the group"}
            @click=${$=>{$.stopPropagation();let T=new Set(this.collapsed);G?T.add(R.id):T.delete(R.id),this.collapsed=T}}>${V("chevron")}</button>
        </span>
      </div>`},I=[],q=new Set;for(let R=0;R<l.length;R++){let U=l[R],K=U.payload.groupId,G=K===void 0?void 0:t.groups?.find(W=>W.id===K);if(!G){I.push(A(U,!1));continue}if(q.has(G.id))continue;q.add(G.id);let ie=l.filter(W=>W.payload.groupId===G.id);I.push(D(G,ie));let H=this.inspect.kind==="group"&&this.inspect.id===G.id;this.collapsed.has(G.id)||I.push(h`<div class="group-kids">${ie.map(W=>A(W,!0,H))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${k}px;--thumb-h:${C}px`}>
          ...
          <span class="seg" role="group" aria-label="Row detail">
            ${[["compact","Compact rows: the name and one line about the layer"],["expanded","Expanded rows: what the layer is made of and where it sits"]].map(([R,U])=>h`
              <button class=${this.layerDetail===R?"on":""} title=${U} aria-label=${U} aria-pressed=${this.layerDetail===R?"true":"false"}
                @click=${()=>{this.layerDetail=R,this.saveListView()}}>${V(R)}</button>`)}
          </span>
      ...
      <div class="layer pinned ${p?"hl":""}" style=${`--k:${Q.place}`} tabindex="0" title="The shape is always the bottom layer"
        ...
        @drop=${R=>{R.preventDefault(),this.clearDragMarks();let U=this.dragId,K=[...l].reverse().find(G=>G.payload.id!==U&&G.payload.groupId!==U);U&&K&&this.reorderLayer(U,K.payload.id,!1,!0),this.dragId=void 0}}>
    ...
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?ui((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Kp();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${V("content")}</span>Shared values
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([yv(r)]):new Set(al)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
    ...
    </details>`}};O([ni({attribute:!1})],_.prototype,"hass",2),O([ni({type:Boolean})],_.prototype,"narrow",2),O([ni({attribute:!1})],_.prototype,"panel",2),O([B()],_.prototype,"colLeft",2),O([B()],_.prototype,"colRight",2),O([B()],_.prototype,"panelWidth",2),O([B()],_.prototype,"owners",2),O([B()],_.prototype,"ownerId",2),O([B()],_.prototype,"records",2),O([B()],_.prototype,"selectedId",2),O([B()],_.prototype,"draft",2),O([B()],_.prototype,"readOnlyReason",2),O([B()],_.prototype,"parseError",2),O([B()],_.prototype,"maxSchemaVersion",2),O([B()],_.prototype,"presets",2),O([B()],_.prototype,"occupied",2),O([B()],_.prototype,"serverToken",2),O([B()],_.prototype,"appliedToken",2),O([B()],_.prototype,"sendStatusKnown",2),O([B()],_.prototype,"polling",2),O([B()],_.prototype,"lastPollSeconds",2),O([B()],_.prototype,"sendPending",2),O([B()],_.prototype,"pages",2),O([B()],_.prototype,"templateResults",2),O([B()],_.prototype,"historySeries",2),O([B()],_.prototype,"historyReadings",2),O([B()],_.prototype,"templateError",2),O([B()],_.prototype,"templateFetchedAt",2),O([B()],_.prototype,"forced",2),O([B()],_.prototype,"showRaw",2),O([B()],_.prototype,"inspect",2),O([B()],_.prototype,"openSections",2),O([B()],_.prototype,"helpSections",2),O([B()],_.prototype,"pickerOpen",2),O([B()],_.prototype,"pickerFilter",2),O([B()],_.prototype,"pickerNote",2),O([B()],_.prototype,"openValue",2),O([B()],_.prototype,"sharedHelp",2),O([B()],_.prototype,"editingValue",2),O([B()],_.prototype,"thumbStep",2),O([B()],_.prototype,"layerDetail",2),O([B()],_.prototype,"addOpen",2),O([B()],_.prototype,"addDetail",2),O([B()],_.prototype,"multi",2),O([B()],_.prototype,"collapsed",2),O([B()],_.prototype,"activeFamily",2),O([B()],_.prototype,"picking",2),O([B()],_.prototype,"pickHoverId",2),O([B()],_.prototype,"listHoverIds",2),O([B()],_.prototype,"rowHoverId",2),O([B()],_.prototype,"zoomed",2),O([B()],_.prototype,"helpOpen",2),O([B()],_.prototype,"showTaps",2),O([B()],_.prototype,"savedName",2),O([B()],_.prototype,"presetKind",2),O([B()],_.prototype,"presetEntity",2),O([B()],_.prototype,"newOpen",2),O([B()],_.prototype,"newName",2),O([B()],_.prototype,"newFamily",2),O([B()],_.prototype,"shareOpen",2),O([B()],_.prototype,"shareMode",2),O([B()],_.prototype,"shareLabels",2),O([B()],_.prototype,"shareNote",2),O([B()],_.prototype,"importOpen",2),O([B()],_.prototype,"importText",2),O([B()],_.prototype,"importParse",2),O([B()],_.prototype,"importName",2),O([B()],_.prototype,"importMap",2),O([B()],_.prototype,"previewCase",2),O([B()],_.prototype,"loadError",2),O([B()],_.prototype,"saveError",2),O([B()],_.prototype,"saving",2),O([B()],_.prototype,"conflict",2),O([B()],_.prototype,"remoteRevision",2),O([B()],_.prototype,"confirmDelete",2),O([B()],_.prototype,"moveTarget",2),O([B()],_.prototype,"moving",2),O([B()],_.prototype,"moveError",2),O([B()],_.prototype,"version",2);var Cl=_;function Dt(e){return String(e?.message??e)}function Tv(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function Ph(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function Ev(e,n,t,i){let a=[{label:"Shows",value:ll(e,t)}],r=Or(t);return r&&a.push({label:"Looks",value:r}),i.frame.rotationDegrees!==0&&a.push({label:"Turned",value:`${Math.round(i.frame.rotationDegrees)}\xB0`}),a}function Mv(e){return e<120?`${e} min`:e%1440===0?`${e/1440} d`:e%60===0?`${e/60} h`:`${e} min`}function Rv(e,n,t,i){let a=r=>h`<span class="val-tok">${r??"--"}</span>`;switch(e.kind){case"text":return h`${a(n.resolve(e.payload.value))} · ${i??e.payload.fontSize} pt`;case"icon":return`${i??e.payload.size} pt \xB7 ${Ae(e.payload.colorSlot.baseColorHex)}`;case"gauge":return h`${a(n.resolve(e.payload.value))} · ${e.payload.style}`;case"chart":{let r=An(e.payload)??Hn(e.payload),o=r!==void 0?t.get(r)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Ke(o).length} values`}case"timeline":{let r=ft(e.payload),o=r===void 0?[]:qi(t.get(r)??""),s=Math.max(0,o.length-1);return`${Mv(rt(e.payload))} \xB7 ${s} ${s===1?"change":"changes"}`}case"shape":return`${Ae(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return e.payload.contentMode==="fill"?"fill":"fit";case"tap":return At(e.payload.action);case"chartTimes":return`${e.payload.timeLabelCount} times \xB7 ${e.payload.labelSize} pt`;case"chartDots":return`${e.payload.dots==="all"?"every reading":"auto"}${e.payload.size===void 0?"":` \xB7 ${e.payload.size} pt`}`;case"chartGrid":return`${e.payload.lines} ${e.payload.lines===1?"line":"lines"} \xB7 ${e.payload.thickness} pt`;case"imageTime":return}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",Cl);export{Cl as WristAssistantPanel,zh as columnFit,Ev as layerFacts};
