var Ou=Object.defineProperty;var Du=Object.getOwnPropertyDescriptor;var _=(e,n,t,i)=>{for(var a=i>1?void 0:i?Du(n,t):n,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(n,t,a):o(a))||a);return i&&a&&Ou(n,t,a),a};var Ii=globalThis,Hi=Ii.ShadowRoot&&(Ii.ShadyCSS===void 0||Ii.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ir=Symbol(),ys=new WeakMap,Pn=class{constructor(n,t,i){if(this._$cssResult$=!0,i!==ir)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=n,this.t=t}get styleSheet(){let n=this.o,t=this.t;if(Hi&&n===void 0){let i=t!==void 0&&t.length===1;i&&(n=ys.get(t)),n===void 0&&((this.o=n=new CSSStyleSheet).replaceSync(this.cssText),i&&ys.set(t,n))}return n}toString(){return this.cssText}},ve=e=>new Pn(typeof e=="string"?e:e+"",void 0,ir),ar=(e,...n)=>{let t=e.length===1?e[0]:n.reduce((i,a,r)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[r+1],e[0]);return new Pn(t,e,ir)},bs=(e,n)=>{if(Hi)e.adoptedStyleSheets=n.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of n){let i=document.createElement("style"),a=Ii.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,e.appendChild(i)}},rr=Hi?e=>e:e=>e instanceof CSSStyleSheet?(n=>{let t="";for(let i of n.cssRules)t+=i.cssText;return ve(t)})(e):e;var{is:Vu,defineProperty:Bu,getOwnPropertyDescriptor:Uu,getOwnPropertyNames:Gu,getOwnPropertySymbols:Ku,getPrototypeOf:Wu}=Object,Li=globalThis,vs=Li.trustedTypes,ju=vs?vs.emptyScript:"",qu=Li.reactiveElementPolyfillSupport,Nn=(e,n)=>e,zn={toAttribute(e,n){switch(n){case Boolean:e=e?ju:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,n){let t=e;switch(n){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch{t=null}}return t}},_i=(e,n)=>!Vu(e,n),xs={attribute:!0,type:String,converter:zn,reflect:!1,useDefault:!1,hasChanged:_i};Symbol.metadata??=Symbol("metadata"),Li.litPropertyMetadata??=new WeakMap;var st=class extends HTMLElement{static addInitializer(n){this._$Ei(),(this.l??=[]).push(n)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(n,t=xs){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(n)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(n,t),!t.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(n,i,t);a!==void 0&&Bu(this.prototype,n,a)}}static getPropertyDescriptor(n,t,i){let{get:a,set:r}=Uu(this.prototype,n)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(n,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(n){return this.elementProperties.get(n)??xs}static _$Ei(){if(this.hasOwnProperty(Nn("elementProperties")))return;let n=Wu(this);n.finalize(),n.l!==void 0&&(this.l=[...n.l]),this.elementProperties=new Map(n.elementProperties)}static finalize(){if(this.hasOwnProperty(Nn("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Nn("properties"))){let t=this.properties,i=[...Gu(t),...Ku(t)];for(let a of i)this.createProperty(a,t[a])}let n=this[Symbol.metadata];if(n!==null){let t=litPropertyMetadata.get(n);if(t!==void 0)for(let[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(n){let t=[];if(Array.isArray(n)){let i=new Set(n.flat(1/0).reverse());for(let a of i)t.unshift(rr(a))}else n!==void 0&&t.push(rr(n));return t}static _$Eu(n,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof n=="string"?n.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(n=>n(this))}addController(n){(this._$EO??=new Set).add(n),this.renderRoot!==void 0&&this.isConnected&&n.hostConnected?.()}removeController(n){this._$EO?.delete(n)}_$E_(){let n=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(n.set(i,this[i]),delete this[i]);n.size>0&&(this._$Ep=n)}createRenderRoot(){let n=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return bs(n,this.constructor.elementStyles),n}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(n=>n.hostConnected?.())}enableUpdating(n){}disconnectedCallback(){this._$EO?.forEach(n=>n.hostDisconnected?.())}attributeChangedCallback(n,t,i){this._$AK(n,i)}_$ET(n,t){let i=this.constructor.elementProperties.get(n),a=this.constructor._$Eu(n,i);if(a!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:zn).toAttribute(t,i.type);this._$Em=n,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(n,t){let i=this.constructor,a=i._$Eh.get(n);if(a!==void 0&&this._$Em!==a){let r=i.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:zn;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(n,t,i,a=!1,r){if(n!==void 0){let o=this.constructor;if(a===!1&&(r=this[n]),i??=o.getPropertyOptions(n),!((i.hasChanged??_i)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(n)&&!this.hasAttribute(o._$Eu(n,i))))return;this.C(n,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(n,t,{useDefault:i,reflect:a,wrapped:r},o){i&&!(this._$Ej??=new Map).has(n)&&(this._$Ej.set(n,o??t??this[n]),r!==!0||o!==void 0)||(this._$AL.has(n)||(this.hasUpdated||i||(t=void 0),this._$AL.set(n,t)),a===!0&&this._$Em!==n&&(this._$Eq??=new Set).add(n))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let n=this.scheduleUpdate();return n!=null&&await n,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,r]of i){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let n=!1,t=this._$AL;try{n=this.shouldUpdate(t),n?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw n=!1,this._$EM(),i}n&&this._$AE(t)}willUpdate(n){}_$AE(n){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(n)),this.updated(n)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(n){return!0}update(n){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(n){}firstUpdated(n){}};st.elementStyles=[],st.shadowRootOptions={mode:"open"},st[Nn("elementProperties")]=new Map,st[Nn("finalized")]=new Map,qu?.({ReactiveElement:st}),(Li.reactiveElementVersions??=[]).push("2.1.2");var pr=globalThis,ws=e=>e,Pi=pr.trustedTypes,ks=Pi?Pi.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ms="$lit$",bt=`lit$${Math.random().toFixed(9).slice(2)}$`,Rs="?"+bt,Yu=`<${Rs}>`,Dt=document,Dn=()=>Dt.createComment(""),Vn=e=>e===null||typeof e!="object"&&typeof e!="function",hr=Array.isArray,Xu=e=>hr(e)||typeof e?.[Symbol.iterator]=="function",or=`[ 	
\f\r]`,On=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,$s=/-->/g,Cs=/>/g,zt=RegExp(`>|${or}(?:([^\\s"'>=/]+)(${or}*=${or}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ss=/'/g,Ts=/"/g,Fs=/^(?:script|style|textarea|title)$/i,mr=e=>(n,...t)=>({_$litType$:e,strings:n,values:t}),h=mr(1),w=mr(2),Py=mr(3),Vt=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Es=new WeakMap,Ot=Dt.createTreeWalker(Dt,129);function As(e,n){if(!hr(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return ks!==void 0?ks.createHTML(n):n}var Ju=(e,n)=>{let t=e.length-1,i=[],a,r=n===2?"<svg>":n===3?"<math>":"",o=On;for(let s=0;s<t;s++){let l=e[s],d,c,u=-1,p=0;for(;p<l.length&&(o.lastIndex=p,c=o.exec(l),c!==null);)p=o.lastIndex,o===On?c[1]==="!--"?o=$s:c[1]!==void 0?o=Cs:c[2]!==void 0?(Fs.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=zt):c[3]!==void 0&&(o=zt):o===zt?c[0]===">"?(o=a??On,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?zt:c[3]==='"'?Ts:Ss):o===Ts||o===Ss?o=zt:o===$s||o===Cs?o=On:(o=zt,a=void 0);let m=o===zt&&e[s+1].startsWith("/>")?" ":"";r+=o===On?l+Yu:u>=0?(i.push(d),l.slice(0,u)+Ms+l.slice(u)+bt+m):l+bt+(u===-2?s:m)}return[As(e,r+(e[t]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),i]},Bn=class e{constructor({strings:n,_$litType$:t},i){let a;this.parts=[];let r=0,o=0,s=n.length-1,l=this.parts,[d,c]=Ju(n,t);if(this.el=e.createElement(d,i),Ot.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=Ot.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(Ms)){let p=c[o++],m=a.getAttribute(u).split(bt),g=/([.?@])?(.*)/.exec(p);l.push({type:1,index:r,name:g[2],strings:m,ctor:g[1]==="."?lr:g[1]==="?"?dr:g[1]==="@"?cr:cn}),a.removeAttribute(u)}else u.startsWith(bt)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(Fs.test(a.tagName)){let u=a.textContent.split(bt),p=u.length-1;if(p>0){a.textContent=Pi?Pi.emptyScript:"";for(let m=0;m<p;m++)a.append(u[m],Dn()),Ot.nextNode(),l.push({type:2,index:++r});a.append(u[p],Dn())}}}else if(a.nodeType===8)if(a.data===Rs)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(bt,u+1))!==-1;)l.push({type:7,index:r}),u+=bt.length-1}r++}}static createElement(n,t){let i=Dt.createElement("template");return i.innerHTML=n,i}};function dn(e,n,t=e,i){if(n===Vt)return n;let a=i!==void 0?t._$Co?.[i]:t._$Cl,r=Vn(n)?void 0:n._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(e),a._$AT(e,t,i)),i!==void 0?(t._$Co??=[])[i]=a:t._$Cl=a),a!==void 0&&(n=dn(e,a._$AS(e,n.values),a,i)),n}var sr=class{constructor(n,t){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:t},parts:i}=this._$AD,a=(n?.creationScope??Dt).importNode(t,!0);Ot.currentNode=a;let r=Ot.nextNode(),o=0,s=0,l=i[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new Un(r,r.nextSibling,this,n):l.type===1?d=new l.ctor(r,l.name,l.strings,this,n):l.type===6&&(d=new ur(r,this,n)),this._$AV.push(d),l=i[++s]}o!==l?.index&&(r=Ot.nextNode(),o++)}return Ot.currentNode=Dt,a}p(n){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(n,i,t),t+=i.strings.length-2):i._$AI(n[t])),t++}},Un=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,t,i,a){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=n,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,t=this._$AM;return t!==void 0&&n?.nodeType===11&&(n=t.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,t=this){n=dn(this,n,t),Vn(n)?n===f||n==null||n===""?(this._$AH!==f&&this._$AR(),this._$AH=f):n!==this._$AH&&n!==Vt&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):Xu(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==f&&Vn(this._$AH)?this._$AA.nextSibling.data=n:this.T(Dt.createTextNode(n)),this._$AH=n}$(n){let{values:t,_$litType$:i}=n,a=typeof i=="number"?this._$AC(n):(i.el===void 0&&(i.el=Bn.createElement(As(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new sr(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(n){let t=Es.get(n.strings);return t===void 0&&Es.set(n.strings,t=new Bn(n)),t}k(n){hr(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,a=0;for(let r of n)a===t.length?t.push(i=new e(this.O(Dn()),this.O(Dn()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(n=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);n!==this._$AB;){let i=ws(n).nextSibling;ws(n).remove(),n=i}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},cn=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,t,i,a,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=n,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}_$AI(n,t=this,i,a){let r=this.strings,o=!1;if(r===void 0)n=dn(this,n,t,0),o=!Vn(n)||n!==this._$AH&&n!==Vt,o&&(this._$AH=n);else{let s=n,l,d;for(n=r[0],l=0;l<r.length-1;l++)d=dn(this,s[i+l],t,l),d===Vt&&(d=this._$AH[l]),o||=!Vn(d)||d!==this._$AH[l],d===f?n=f:n!==f&&(n+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(n)}j(n){n===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},lr=class extends cn{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===f?void 0:n}},dr=class extends cn{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==f)}},cr=class extends cn{constructor(n,t,i,a,r){super(n,t,i,a,r),this.type=5}_$AI(n,t=this){if((n=dn(this,n,t,0)??f)===Vt)return;let i=this._$AH,a=n===f&&i!==f||n.capture!==i.capture||n.once!==i.once||n.passive!==i.passive,r=n!==f&&(i===f||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},ur=class{constructor(n,t,i){this.element=n,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(n){dn(this,n)}};var Zu=pr.litHtmlPolyfillSupport;Zu?.(Bn,Un),(pr.litHtmlVersions??=[]).push("3.3.3");var Is=(e,n,t)=>{let i=t?.renderBefore??n,a=i._$litPart$;if(a===void 0){let r=t?.renderBefore??null;i._$litPart$=a=new Un(n.insertBefore(Dn(),r),r,void 0,t??{})}return a._$AI(e),a};var fr=globalThis,vt=class extends st{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=Is(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Vt}};vt._$litElement$=!0,vt.finalized=!0,fr.litElementHydrateSupport?.({LitElement:vt});var Qu=fr.litElementPolyfillSupport;Qu?.({LitElement:vt});(fr.litElementVersions??=[]).push("4.2.2");var ep={attribute:!0,type:String,converter:zn,reflect:!1,hasChanged:_i},tp=(e=ep,n,t)=>{let{kind:i,metadata:a}=t,r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(t.name,e),i==="accessor"){let{name:o}=t;return{set(s){let l=n.get.call(this);n.set.call(this,s),this.requestUpdate(o,l,e,!0,s)},init(s){return s!==void 0&&this.C(o,void 0,e,s),s}}}if(i==="setter"){let{name:o}=t;return function(s){let l=this[o];n.call(this,s),this.requestUpdate(o,l,e,!0,s)}}throw Error("Unsupported decorator location: "+i)};function un(e){return(n,t)=>typeof t=="object"?tp(e,n,t):((i,a,r)=>{let o=a.hasOwnProperty(r);return a.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(a,r):void 0})(e,n,t)}function P(e){return un({...e,state:!0,attribute:!1})}var Ue="wrist_assistant/complications";async function Hs(e){return e.connection.sendMessagePromise({type:`${Ue}/owners`})}async function Ls(e,n){return e.connection.sendMessagePromise({type:`${Ue}/list`,owner_watch_id:n})}async function _s(e,n){return e.connection.sendMessagePromise({type:`${Ue}/nudge`,owner_watch_id:n})}async function Ps(e,n){return e.connection.sendMessagePromise({type:`${Ue}/watch_status`,owner_watch_id:n})}async function Ns(e,n,t,i){return e.connection.sendMessagePromise({type:`${Ue}/save`,owner_watch_id:n,document:t,base_revision:i})}async function zs(e,n,t,i){return e.connection.sendMessagePromise({type:`${Ue}/delete`,owner_watch_id:n,complication_id:t,base_revision:i})}async function Os(e,n,t){return e.connection.sendMessagePromise({type:`${Ue}/move_owner`,source_owner_watch_id:n,target_owner_watch_id:t})}function Ds(e,n,t){let i={type:`${Ue}/subscribe`};return n&&(i.owner_watch_id=n),e.connection.subscribeMessage(t,i)}async function Vs(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${Ue}/render_values`,templates:n})).results}async function Bs(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${Ue}/history_series`,requests:n})).results}async function Us(e,n){return Object.keys(n).length===0?{}:(await e.connection.sendMessagePromise({type:`${Ue}/statistics_series`,requests:n})).results}var ne=["rectangular","circular","corner"],le={rectangular:{width:181,height:65.5},circular:{width:51,height:51},corner:{width:34,height:34}},Kn=["rectangular","circular","corner","inline"];var br=64;function rl(e,n){let t=new Set(e);for(let i of n)t.add(i.slot);for(let i=0;i<br;i++)if(!t.has(i))return i;return-1}function ol(e,n){let t=new Set(e);return n.filter(i=>i.kind!=="preset"||!t.has(i.slot))}function Ut(e){return ne.some(t=>!e.supportedFamilies.includes(t))||e.supportedFamilies.includes("inline")||e.inline!==void 0?6:e.slotIndex>7?5:4}var np=["none","dot","triangle"],ip=[["history","Recorded history"],["statistics","Long-term statistics"]],Ui=[["5minute","5 min"],["hour","Hour"],["day","Day"],["week","Week"],["month","Month"]],vr=[["mean","Mean"],["min","Min"],["max","Max"],["change","Change"],["sum","Total"]],xr="history",Qn="hour",ei="mean",pn=[["latest","Newest reading"],["first","First reading"],["highest","Highest reading"],["lowest","Lowest reading"],["average","Average reading"],["delta","Change"],["sum","Total"],["trend","Trend arrow"],["top","Top of the scale"],["bottom","Bottom of the scale"]],ti={x:.25,y:.25,width:.5,height:.5,rotationDegrees:0},hn=[["highest","Highest reading"],["lowest","Lowest reading"],["now","Now"],["first","First reading"],["latest","Newest reading"],["threshold","Threshold"]];function St(e){return e!=="threshold"}var wr=[["above","Above"],["on","On"],["below","Inside"],["bottom","At the bottom"],["through","Through"]];function ap(e){return hn.some(([n])=>n===e)}function rp(e){return wr.some(([n])=>n===e)}function op(e){if(!F(e)||typeof e.layer!="string"||e.layer==="")return;let n={layer:e.layer.toUpperCase(),at:ap(e.at)?e.at:"highest",place:rp(e.place)?e.place:"above"},t=q(e.dx,0),i=q(e.dy,0);return t!==0&&(n.dx=t),i!==0&&(n.dy=i),n}function zi(e,n){let t=op(e.chartAnchor);t!==void 0&&(n.chartAnchor=t)}function Oi(e,n){e.chartAnchor!==void 0&&(n.chartAnchor=sp(e.chartAnchor))}function sp(e){let n={layer:e.layer,at:e.at,place:e.place};return e.dx!==void 0&&e.dx!==0&&(n.dx=j(e.dx)),e.dy!==void 0&&e.dy!==0&&(n.dy=j(e.dy)),n}var Ae={setColor:"color",setOpacity:"opacity",setText:"text",setIcon:"icon",setFontSize:"fontSize",setFontWeight:"fontWeight",setRotation:"rotation",hide:"visibility",show:"visibility",setGaugeValue:"gaugeValue",setGaugeMin:"gaugeMin",setGaugeMax:"gaugeMax",setBorderColor:"borderColor",setBorderWidth:"borderWidth",setBackgroundColor:"backgroundColor"};function sl(e){return e.countdown===!0?!1:e.coloring==="bands"&&(e.bands?.length??0)>0||e.highlight!==void 0&&e.highlight!=="none"}function lt(e){return e.countdown!==!0&&(e.parts?.length??0)>0}function mn(e){if(e.kind.kind==="literal")return(e.format?.prefix??"")+e.kind.value+(e.format?.suffix??"")}function ni(e){let n=c=>c.value.kind.kind!=="literal",t=(c,u)=>e.slice(c,u).map(p=>mn(p.value)??"").join(""),i=e.findIndex(n);if(i<0)return A(t(0,e.length));let a=e.findIndex((c,u)=>u>i&&n(c)),r=e[i].value,o={...r.format},s=t(0,i)+(o.prefix??""),l=(o.suffix??"")+t(i+1,a<0?e.length:a);delete o.prefix,delete o.suffix,s!==""&&(o.prefix=s),l!==""&&(o.suffix=l);let d={kind:structuredClone(r.kind)};return Ce(o)||(d.format=o),d}function ll(e){lt(e)&&(e.value=ni(e.parts))}var fn="#FFFFFF";function Gs(e){return typeof e=="string"&&np.includes(e)}function kr(e){return e==="none"?{high:"none",low:"none"}:e==="pointer"?{high:"triangle",low:"dot"}:{high:"dot",low:"dot"}}function qe(e){let n=kr(e.marker);return{high:e.highMarker??n.high,low:e.lowMarker??n.low}}function dl(e){return e.high==="triangle"?"pointer":e.high!=="none"||e.low!=="none"?"dot":"none"}function cl(e){return e.high==="none"&&e.low==="none"||e.high==="dot"&&e.low==="dot"||e.high==="triangle"&&e.low==="dot"}function Gi(e,n){e.marker=dl(n),cl(n)?(delete e.highMarker,delete e.lowMarker):(e.highMarker=n.high,e.lowMarker=n.low)}var Ki=24,Re="#FF6B35",Fe="#32D74B",$r="#32D74B",ie="#FF453A",gn="#FF453A",yn="#FFFFFF99";function Tt(e){return[...e.bands].sort((n,t)=>n.upTo-t.upTo)}function ul(e){return e.coloring==="bands"&&e.bands.length>0}function Wi(e,n,t){for(let i of n)if(e<=i.upTo)return i.colorHex;return t}function Cr(e,n){let t=Math.abs(n),i=t>=10?0:t>=1?1:2;return e.toFixed(i)}function pl(e){return e>0?"\u2191":e<0?"\u2193":"\u2192"}var Gt=[{minutes:60,label:"Last hour"},{minutes:180,label:"Last 3 hours"},{minutes:360,label:"Last 6 hours"},{minutes:720,label:"Last 12 hours"},{minutes:1440,label:"Last 24 hours"},{minutes:4320,label:"Last 3 days"},{minutes:10080,label:"Last 7 days"}],ji=360,qi=10080,ii=[...Gt,{minutes:43200,label:"Last 30 days"},{minutes:129600,label:"Last 90 days"},{minutes:527040,label:"Last year"}],Sr=366*24*60,Tr=2,ai=120,Er=0;function Mr(e){let n=Math.round(e.historyPoints);return Number.isFinite(n)?n<1?Er:Math.max(Tr,Math.min(ai,n)):24}function Yi(e){return Fr(e)!==void 0?!0:Rr(e)!==void 0&&Mr(e)>0}function Rr(e){if(e.source==="history")return hl(e)}function Fr(e){if(e.source==="statistics")return hl(e)}function hl(e){if(!(e.historyMinutes<=0))return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function Kt(e){let n=Rr(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${Mr(e)}`}function Wt(e){let n=Fr(e);if(n!==void 0)return`${n}|${Math.round(e.historyMinutes)}|${e.statPeriod}|${e.statType}`}function ml(e){return[...Ar(e).map(t=>t.key),...Ir(e).map(t=>t.key)].sort().join(";")}function Ar(e){let n=new Map,t=i=>{n.has(i.key)||n.set(i.key,i)};for(let i of e.elements)if(i.kind==="chart"){let a=Kt(i.payload),r=Rr(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:Math.round(i.payload.historyMinutes),points:Mr(i.payload),mode:"numeric"})}else if(i.kind==="timeline"){let a=Rt(i.payload),r=vl(i.payload);if(a===void 0||r===void 0)continue;t({key:a,entityId:r,minutes:Ye(i.payload),points:Mt,mode:"states"})}return[...n.values()]}function Ir(e){let n=new Map;for(let t of e.elements){if(t.kind!=="chart")continue;let i=Wt(t.payload),a=Fr(t.payload);i===void 0||a===void 0||n.has(i)||n.set(i,{key:i,entityId:a,minutes:Math.round(t.payload.historyMinutes),period:t.payload.statPeriod,type:t.payload.statType})}return[...n.values()]}var fl=[["auto","Auto"],["h12","12 hour"],["h24","24 hour"]],gl=[["auto","Auto"],["always","Always"],["never","Never"]];function Ks(e){return e==="h12"||e==="h24"?e:Xn}function Ws(e){return e==="always"||e==="never"?e:Jn}function lp(e){return e.timeLabelCount!==void 0?ri(e.timeLabelCount):e.timeLabels==="ends"?2:e.timeLabels==="four"?4:Yn}function ri(e){let n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(oi,Math.round(n))):Yn}function Hr(e){return e<=0?[]:e===1?[1]:Array.from({length:e},(n,t)=>t/(e-1))}var Et="#8E8E93",yl=1,dp="#000000",cp=2,up=1440,Lr=60,Yn=0,$t=9,Ct="#8E8E93",Xn="auto",Jn="auto",pp=4,oi=12,si=1,li=20,Xi=4,Mt=120;function bl(e,n,t){let i=e.trim().toLowerCase();for(let a of n)if(a.match.trim().toLowerCase()===i)return a.colorHex;return t}function Ye(e){let n=Math.round(e.historyMinutes);return Number.isFinite(n)?Math.max(1,Math.min(qi,n)):Lr}function vl(e){return e.value.kind.kind==="entityState"?e.value.kind.entityId:void 0}function Rt(e){let n=vl(e);if(n!==void 0)return`${n}|${Ye(e)}|${Mt}|states`}var hp={on:"#FF9F0A",off:"#0A84FF",open:"#FF453A",closed:"#32D74B",opening:"#FFD60A",closing:"#FFD60A",home:"#32D74B",not_home:"#0A84FF",locked:"#32D74B",unlocked:"#FF453A",jammed:"#BF5AF2",playing:"#32D74B",paused:"#FF9F0A",idle:"#0A84FF",standby:"#5E5CE6",heat:"#FF9F0A",cool:"#64D2FF",heat_cool:"#BF5AF2",dry:"#FFD60A",fan_only:"#5E5CE6",auto:"#BF5AF2",cleaning:"#32D74B",docked:"#0A84FF",returning:"#64D2FF",error:"#FF453A",disarmed:"#32D74B",armed_home:"#0A84FF",armed_away:"#FF9F0A",armed_night:"#5E5CE6",arming:"#FFD60A",pending:"#FFD60A",triggered:"#FF453A",unavailable:"#48484A",unknown:"#48484A"},di={binary_sensor:["on","off"],switch:["on","off"],light:["on","off"],input_boolean:["on","off"],fan:["on","off"],humidifier:["on","off"],siren:["on","off"],cover:["open","closed","opening","closing"],lock:["locked","unlocked","jammed"],person:["home","not_home"],device_tracker:["home","not_home"],media_player:["playing","paused","idle","off"],climate:["heat","cool","heat_cool","dry","fan_only","auto","off"],vacuum:["cleaning","docked","returning","idle","error"],alarm_control_panel:["disarmed","armed_home","armed_away","armed_night","arming","pending","triggered"]};function Di(e){return hp[e.trim().toLowerCase()]??Et}var mp=["door","garage_door","window","opening"];function _r(e,n){let t=(n??"").trim().toLowerCase(),i=e==="binary_sensor"&&mp.includes(t),a=o=>Di(i&&o==="on"?"open":o);return[...di[e]??[],"unavailable","unknown"].map(o=>({id:Y(),match:o,colorHex:a(o)}))}var bn=6,vn=9,fp=["topLeading","topTrailing","bottomLeading","bottomTrailing"];function dt(e){return Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY)}function Pr(e,n){let t=n<=.5,i=e<=.5;return t?i?"topLeading":"topTrailing":i?"bottomLeading":"bottomTrailing"}var Nr={top:0,left:0,bottom:0,right:0};function Ji(e){return e===void 0||e.top===0&&e.left===0&&e.bottom===0&&e.right===0}var gp=["toggleEntity","runScene","runScript","addTodo","runHTTPAction"];function xl(e){return gp.includes(e)}function wl(e){let n=(e??"").trim();if(n==="")return!0;try{let t=JSON.parse(n);return typeof t=="object"&&t!==null&&!Array.isArray(t)}catch{return!1}}var zr=[["refresh","Refresh"],["none","Nothing"],["openApp","Open the app"],["openPage","Open the page"],["openRoomPage","Open the room page"],["timerStartPause","Timer start / pause"],["timerCancel","Timer cancel"],["toggleEntity","Toggle an entity"],["runScene","Run a scene"],["runScript","Run a script"],["addTodo","Add a to-do"],["runHTTPAction","Run an HTTP action"],["callService","Call a service"]];function ct(e){let n=zr.find(([i])=>i===e.type)?.[1]??e.type;if(e.type==="callService"){let i=[e.serviceDomain,e.serviceName].filter(a=>a!=="").join(".");return i===""?n:`${n}: ${i}`}if(!("entityId"in e))return n;let t=e.displayName||e.entityId;return t?`${n}: ${t}`:n}function F(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function W(e,n=""){return typeof e=="string"?e:n}function q(e,n){return typeof e=="number"?e:e==="+inf"?1/0:e==="-inf"?-1/0:e==="nan"?NaN:n}function je(e){return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}function qn(e){return e==null?void 0:q(e,0)}function oe(e){return typeof e=="string"?e:void 0}function gr(e,n,t){return n.some(([i])=>i===e)?e:t}var Oe=class extends Error{};function wt(e){if(typeof e.entityId!="string")throw new Oe("entityId is required");let n={entityId:e.entityId,displayName:W(e.displayName),domain:W(e.domain)};return typeof e.iconName=="string"&&(n.iconName=e.iconName),n}function js(e){if(!F(e))return;let n={};return e.decimals!==void 0&&e.decimals!==null&&(n.decimals=q(e.decimals,0)),e.multiply!==void 0&&e.multiply!==null&&(n.multiply=q(e.multiply,1)),e.offset!==void 0&&e.offset!==null&&(n.offset=q(e.offset,0)),typeof e.prefix=="string"&&(n.prefix=e.prefix),typeof e.suffix=="string"&&(n.suffix=e.suffix),e.useEntityUnit===!0&&(n.useEntityUnit=!0),e.relativeTime===!0&&(n.relativeTime=!0),e.duration===!0&&(n.duration=!0),(e.textCase==="upper"||e.textCase==="lower"||e.textCase==="capitalized")&&(n.textCase=e.textCase),Ce(n)?void 0:n}function Ce(e){return e?e.decimals===void 0&&e.multiply===void 0&&e.offset===void 0&&!e.prefix&&!e.suffix&&!e.useEntityUnit&&!e.relativeTime&&!e.duration&&e.textCase===void 0:!0}function yp(e){let n=W(e.function,"count"),t=F(e.scope)?e.scope:{},i;if(t.kind==="entities")i={kind:"entities",entities:(Array.isArray(t.entities)?t.entities:[]).filter(F).map(wt)};else{let r=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[];i={kind:"filter",domains:r(t.domains),areaIds:r(t.areaIds),labelIds:r(t.labelIds),floorIds:r(t.floorIds)}}let a={function:n,scope:i};if(F(e.stateFilter)){let r=e.stateFilter.kind;r==="isOn"||r==="isOff"?a.stateFilter={kind:r}:(r==="equals"||r==="notEquals")&&(a.stateFilter={kind:r,value:W(e.stateFilter.value)})}return typeof e.attribute=="string"&&(a.attribute=e.attribute),a}function qs(e){switch(e.kind){case"literal":return{kind:"literal",value:W(e.value)};case"entityState":return{kind:"entityState",...wt(e)};case"entityAttribute":return{kind:"entityAttribute",...wt(e),attribute:W(e.attribute)};case"entityAge":return{kind:"entityAge",...wt(e)};case"aggregate":return{kind:"aggregate",aggregate:yp(F(e.aggregate)?e.aggregate:{})};case"time":return{kind:"time",timeField:oe(e.timeField)??"now"};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:W(e.value)};case"named":return{kind:"named",id:W(e.id).toUpperCase()};case"chartStat":return{kind:"chartStat",layer:W(e.layer).toUpperCase(),stat:pn.some(([n])=>n===e.stat)?e.stat:"latest"};default:throw new Oe(`unknown value kind ${String(e.kind)}`)}}function ue(e){if(!F(e))throw new Oe("value must be an object");if(F(e.kind)){let i={kind:qs(e.kind)},a=js(e.format);return a&&(i.format=a),i}let n={kind:qs(e)},t=js(e.format);return t&&(n.format=t),n}function kl(e){return F(e)?{x:q(e.x,.25),y:q(e.y,.25),width:q(e.width,.5),height:q(e.height,.5),rotationDegrees:q(e.rotationDegrees,0)}:{...ti}}function bp(e){if(!F(e))return{kind:"isOn"};let n=W(e.kind,"isOn"),t={kind:n};switch(n){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":t.value=F(e.value)?ue(e.value):A("");break;case"between":case"timeBetween":t.value=F(e.value)?ue(e.value):A(""),t.upper=F(e.upper)?ue(e.upper):A("");break;case"matchesRegex":t.pattern=W(e.pattern);break;case"isOneOf":t.options=Array.isArray(e.options)?e.options.filter(i=>typeof i=="string"):[];break;default:break}return t}function Ys(e){if(!F(e))return{kind:"show"};let n=W(e.kind,"show"),t={kind:n};switch(n){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":t.value=F(e.value)?ue(e.value):A("");break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":t.number=q(e.number,0);break;case"setFontWeight":t.weight=oe(e.weight)??"regular";break;default:break}return t}function $l(e){return Array.isArray(e)?e.filter(F).map(n=>{let t={id:W(n.id).toUpperCase(),cases:(Array.isArray(n.cases)?n.cases:[]).filter(F).map(i=>{let a=F(i.when)?i.when:{};return{id:W(i.id).toUpperCase(),when:{join:a.join==="any"?"any":"all",tests:(Array.isArray(a.tests)?a.tests:[]).filter(F).map(r=>({id:W(r.id).toUpperCase(),value:F(r.value)?ue(r.value):A(""),comparison:bp(r.comparison)}))},then:(Array.isArray(i.then)?i.then:[]).map(Ys)}})};return Array.isArray(n.otherwise)&&(t.otherwise=n.otherwise.map(Ys)),typeof n.partId=="string"&&n.partId!==""&&(t.partId=n.partId.toUpperCase()),t}):[]}function vp(e,n){return{baseColorHex:F(e)?W(e.baseColorHex,n):n}}function Vi(e){return Array.isArray(e)?e.filter(F).map(n=>({id:W(n.id,Y()),upTo:q(n.upTo,0),colorHex:W(n.colorHex,"#FFFFFF")})):[]}function xp(e){return Array.isArray(e)?e.filter(F).map(n=>{let t={id:W(n.id,Y()).toUpperCase(),value:F(n.value)?ue(n.value):A("")};typeof n.colorHex=="string"&&(t.colorHex=n.colorHex);let i=oe(n.fontWeight);(i==="regular"||i==="medium"||i==="semibold"||i==="bold")&&(t.fontWeight=i),typeof n.fontSize=="number"&&(t.fontSize=n.fontSize),oe(n.coloring)==="bands"&&(t.coloring="bands");let a=Vi(n.bands);a.length>0&&(t.bands=a);let r=W(n.bandAboveColorHex,ie);return r!==ie&&(t.bandAboveColorHex=r),t}):[]}function wp(e){if(Array.isArray(e.bands))return Vi(e.bands);if(typeof e.bandLowerBound!="number")return[];let n=F(e.colorSlot)?W(e.colorSlot.baseColorHex,"#FFFFFF"):"#FFFFFF";return[{id:Y(),upTo:e.bandLowerBound,colorHex:W(e.bandLowColorHex,$r)},{id:Y(),upTo:q(e.bandUpperBound,100),colorHex:n}]}function kp(e){return Array.isArray(e)?e.filter(F).map(n=>({id:W(n.id,Y()).toUpperCase(),match:W(n.match,""),colorHex:W(n.colorHex,Et)})):[]}function xt(e,n){if(typeof e.id!="string")throw new Oe("element id is required");return{id:e.id.toUpperCase(),colorSlot:vp(e.colorSlot,n),rules:$l(e.rules),frame:kl(e.frame),isHidden:e.isHidden===!0}}function $p(e){let n=Cp(e),t=e.payload;return typeof t.groupId=="string"&&t.groupId!==""&&(n.payload.groupId=t.groupId.toUpperCase()),n}function Cp(e){if(!F(e)||!F(e.payload))throw new Oe("element must have a payload");let n=e.payload;switch(e.kind){case"text":{let t={...xt(n,"#FFFFFF"),value:F(n.value)?ue(n.value):A(""),fontSize:q(n.fontSize,14),fontWeight:oe(n.fontWeight)??"regular"};n.countdown===!0&&(t.countdown=!0),n.monospacedDigits===!0&&(t.monospacedDigits=!0);let i=typeof n.lineLimit=="number"?Math.round(n.lineLimit):1;Math.min(2,Math.max(1,i))===2&&(t.lineLimit=2);let a=oe(n.alignment);(a==="leading"||a==="trailing")&&(t.alignment=a),oe(n.coloring)==="bands"&&(t.coloring="bands");let r=Vi(n.bands);r.length>0&&(t.bands=r);let o=W(n.bandAboveColorHex,ie);o!==ie&&(t.bandAboveColorHex=o);let s=oe(n.highlight);(s==="highest"||s==="lowest"||s==="both")&&(t.highlight=s);let l=W(n.highColorHex,Re);l!==Re&&(t.highColorHex=l);let d=W(n.lowColorHex,Fe);d!==Fe&&(t.lowColorHex=d);let c=xp(n.parts);return c.length>0&&(t.parts=c),zi(n,t),{kind:"text",payload:t}}case"icon":{let t={...xt(n,"#FFFFFF"),symbol:F(n.symbol)?ue(n.symbol):A("lightbulb"),size:q(n.size,14)},i=oe(n.path);return i!==void 0&&i!==""&&(t.path=i),zi(n,t),{kind:"icon",payload:t}}case"gauge":{let t={...xt(n,"#FFFFFF"),value:F(n.value)?ue(n.value):A("50"),minValue:q(n.minValue,0),maxValue:q(n.maxValue,100),style:oe(n.style)??"arc",lineWidth:q(n.lineWidth,4),trackColorHex:W(n.trackColorHex,"#FFFFFF40"),coloring:oe(n.coloring)??"uniform",bands:Vi(n.bands),bandAboveColorHex:W(n.bandAboveColorHex,ie),thresholdColorHex:W(n.thresholdColorHex,fn)},i=qn(n.thresholdValue);return i!==void 0&&(t.thresholdValue=i),F(n.total)&&(t.total=ue(n.total)),F(n.minSource)&&(t.minSource=ue(n.minSource)),F(n.maxSource)&&(t.maxSource=ue(n.maxSource)),{kind:"gauge",payload:t}}case"chart":return{kind:"chart",payload:{...xt(n,"#FFFFFF"),value:F(n.value)?ue(n.value):A("13,14,16,17,19,22,24,28,30"),historyMinutes:Math.max(0,Math.round(q(n.historyMinutes,0))),historyPoints:Math.round(q(n.historyPoints,24)),source:gr(oe(n.source),ip,xr),statPeriod:gr(oe(n.statPeriod),Ui,Qn),statType:gr(oe(n.statType),vr,ei),style:oe(n.style)??"bars",limit:Math.max(0,Math.round(q(n.limit,0))),takeFromEnd:n.takeFromEnd===!0,scale:oe(n.scale)??"auto",minValue:q(n.minValue,0),maxValue:q(n.maxValue,100),baseline:oe(n.baseline)??"lowest",barGap:q(n.barGap,1.5),lineWidth:q(n.lineWidth,2),highlight:oe(n.highlight)??"none",highColorHex:W(n.highColorHex,Re),lowColorHex:W(n.lowColorHex,Fe),marker:oe(n.marker)??"pointer",...Gs(n.highMarker)?{highMarker:n.highMarker}:{},...Gs(n.lowMarker)?{lowMarker:n.lowMarker}:{},coloring:oe(n.coloring)??"uniform",bands:wp(n),bandAboveColorHex:W(n.bandHighColorHex,W(n.bandAboveColorHex,ie)),fillBands:n.fillBands===!0,...typeof n.thresholdValue=="number"&&Number.isFinite(n.thresholdValue)?{thresholdValue:n.thresholdValue}:{},thresholdColorHex:W(n.thresholdColorHex,gn),...F(n.nowIndex)?{nowIndex:ue(n.nowIndex)}:{},nowColorHex:W(n.nowColorHex,yn),...n.drawsThreshold===!1?{drawsThreshold:!1}:{},...n.drawsNowLine===!1?{drawsNowLine:!1}:{},...oe(n.scaleFrom)!==void 0?{scaleFrom:oe(n.scaleFrom)}:{},timeLabelCount:ri(n.timeLabelCount),labelSize:q(n.labelSize,$t),labelColorHex:W(n.labelColorHex,Ct),labelsAbove:n.labelsAbove===!0,hourCycle:Ks(n.hourCycle),minutes:Ws(n.minutes)}};case"timeline":{let{colorSlot:t,...i}=xt(n,"#FFFFFF");return{kind:"timeline",payload:{...i,value:F(n.value)?ue(n.value):A(""),historyMinutes:Math.max(1,Math.round(q(n.historyMinutes,Lr))),bands:kp(n.bands),otherColorHex:W(n.otherColorHex,Et),gap:Math.min(Xi,Math.max(0,q(n.gap,0))),cornerRadius:Math.max(0,q(n.cornerRadius,yl)),timeLabelCount:lp(n),labelSize:q(n.labelSize,$t),labelColorHex:W(n.labelColorHex,Ct),labelsAbove:n.labelsAbove===!0,hourCycle:Ks(n.hourCycle),minutes:Ws(n.minutes)}}}case"shape":{let t={...xt(n,"#FFFFFF33"),kind:oe(n.kind)??"roundedRectangle",cornerRadius:q(n.cornerRadius,6),thickness:q(n.thickness,1),borderWidth:q(n.borderWidth,1)};return typeof n.borderColorHex=="string"&&(t.borderColorHex=n.borderColorHex),zi(n,t),{kind:"shape",payload:t}}case"image":{let{colorSlot:t,...i}=xt(n,"#FFFFFF"),a={...i,entity:wt(F(n.entity)?n.entity:{}),source:n.source==="entityPicture"?"entityPicture":"camera",contentMode:n.contentMode==="fit"?"fit":"fill",zoom:q(n.zoom,1),panX:q(n.panX,0),panY:q(n.panY,0),cornerRadius:q(n.cornerRadius,bn),timestampCorner:fp.includes(n.timestampCorner)?n.timestampCorner:"topLeading",timestampSize:q(n.timestampSize,vn)};n.timestamp===!0&&(a.timestamp=!0);let r=qn(n.timestampX),o=qn(n.timestampY);return r!==void 0&&o!==void 0&&Number.isFinite(r)&&Number.isFinite(o)&&(a.timestampX=je(r),a.timestampY=je(o)),zi(n,a),{kind:"image",payload:a}}case"tap":{let{colorSlot:t,...i}=xt(n,"#FFFFFF"),a={...i,action:F(n.action)?Cl(n.action):{type:"refresh"}};return typeof n.openPageId=="string"&&(a.openPageId=n.openPageId),typeof n.openPageName=="string"&&(a.openPageName=n.openPageName),typeof n.attachedTo=="string"&&(a.attachedTo=n.attachedTo.toUpperCase()),{kind:"tap",payload:a}}default:throw new Oe(`unknown element kind ${String(e.kind)}`)}}function Xs(e){let n=F(e)?e:{},t={};if(F(n.placements))for(let[a,r]of Object.entries(n.placements)){if(!F(r))continue;let o={frame:kl(r.frame),isHidden:r.isHidden===!0},s=qn(r.size);s!==void 0&&(o.size=s),t[a.toUpperCase()]=o}let i={placements:t,cornerBodyShape:n.cornerBodyShape==="circle"?"circle":"wedge",borderWidth:q(n.borderWidth,2),rules:$l(n.rules)};if(F(n.bezelText)&&(i.bezelText=ue(n.bezelText)),n.bezelCountdown===!0&&(i.bezelCountdown=!0),F(n.curvedText)&&(i.curvedText=ue(n.curvedText)),typeof n.curvedColorHex=="string"&&(i.curvedColorHex=n.curvedColorHex),F(n.bezelGauge)){let a=n.bezelGauge,r={value:F(a.value)?ue(a.value):A("50"),minValue:q(a.minValue,0),maxValue:q(a.maxValue,100),colorHexes:Array.isArray(a.colorHexes)&&a.colorHexes.length>0?a.colorHexes.filter(o=>typeof o=="string"):["#34C759","#FFCC00","#FF3B30"]};F(a.minLabel)&&(r.minLabel=ue(a.minLabel)),F(a.maxLabel)&&(r.maxLabel=ue(a.maxLabel)),i.bezelGauge=r}return typeof n.backgroundColorHex=="string"&&(i.backgroundColorHex=n.backgroundColorHex),typeof n.borderColorHex=="string"&&(i.borderColorHex=n.borderColorHex),i}function Sp(e){let n={};if(Array.isArray(e))for(let t=0;t+1<e.length;t+=2){let i=e[t];typeof i=="string"&&(n[i]=Xs(e[t+1]))}else if(F(e))for(let[t,i]of Object.entries(e))n[t]=Xs(i);return n}function Tp(e){let n={value:F(e.value)?ue(e.value):A("")};return typeof e.label=="string"&&(n.label=e.label),typeof e.symbol=="string"&&(n.symbol=e.symbol),e.countdown===!0&&(n.countdown=!0),n}function Cl(e){if(!F(e)||typeof e.type!="string")return{type:"none"};switch(e.type){case"none":case"refresh":case"openApp":case"openPage":case"openRoomPage":case"timerStartPause":case"timerCancel":return{type:e.type};case"toggleEntity":case"runScene":case"runScript":case"addTodo":case"runHTTPAction":return{type:e.type,...wt(e)};case"callService":{let n={type:"callService",serviceDomain:typeof e.serviceDomain=="string"?e.serviceDomain:"",serviceName:typeof e.serviceName=="string"?e.serviceName:""};return typeof e.serviceDataJSON=="string"&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),typeof e.entityId=="string"&&e.entityId!==""&&(n.target=wt(e)),n}default:return{type:"none"}}}function xn(e){if(!F(e))throw new Oe("config must be an object");for(let r of["id","name","slotIndex","supportedFamilies","perFamily","tapAction"])if(!(r in e))throw new Oe(`${r} is required`);let n=(Array.isArray(e.values)?e.values:[]).filter(F).map(r=>({id:W(r.id).toUpperCase(),name:W(r.name),value:F(r.value)?ue(r.value):A("")})),t=(Array.isArray(e.dataSources)?e.dataSources:[]).filter(F).map(r=>r.kind==="template"?{kind:"template",value:W(r.value)}:r.kind==="entity"?{kind:"entity",...wt(r)}:null).filter(r=>r!==null),i={schemaVersion:q(e.schemaVersion,1),id:W(e.id).toUpperCase(),name:W(e.name,"Custom"),values:n,slotIndex:q(e.slotIndex,0),elements:(Array.isArray(e.elements)?e.elements:[]).map($p),supportedFamilies:(Array.isArray(e.supportedFamilies)?e.supportedFamilies:[]).filter(r=>typeof r=="string"),perFamily:Sp(e.perFamily),dataSources:t,tapAction:Cl(e.tapAction)};F(e.inline)&&(i.inline=Tp(e.inline));let a=qn(e.refreshMinutes);if(a!==void 0&&(i.refreshMinutes=a),typeof e.openPageId=="string"&&(i.openPageId=e.openPageId),typeof e.openPageName=="string"&&(i.openPageName=e.openPageName),typeof e.showSuccessFlash=="boolean"&&(i.showSuccessFlash=e.showSuccessFlash),typeof e.successFlashColorHex=="string"&&(i.successFlashColorHex=e.successFlashColorHex),Array.isArray(e.groups)){let r=e.groups.filter(F).filter(o=>typeof o.id=="string").map(o=>({id:W(o.id).toUpperCase(),name:W(o.name,"Group"),locked:o.locked!==!1}));r.length>0&&(i.groups=r)}return Ip(i,Array.isArray(e.elements)?e.elements:[]),Ge(i),i}function Or(e,n){let t=n?.kind;if(!t||t.kind!=="chartStat")return;let i=e.elements.find(a=>a.payload.id===t.layer);return i?.kind==="chart"?i:void 0}function jt(e,n){return e.elements.filter(t=>t.kind==="text"&&t.payload.value.kind.kind==="chartStat"&&t.payload.value.kind.layer===n)}function Ep(e,n){let t=Bi(e,Yt(n))?.ref;return t?.displayName||t?.entityId||"Chart"}function Zi(e,n,t){let i=ut(e,n.payload.id);if(i){Ur(e,t,i.id);return}let a=Br(e,[n.payload.id,t],Ep(e,n)),r=e.groups?.find(o=>o.id===a);r&&(r.locked=!1)}var Sl={top:{x:0,y:0},highest:{x:.35,y:0},average:{x:.65,y:0},latest:{x:1,y:0},bottom:{x:0,y:1},lowest:{x:.35,y:1},trend:{x:.85,y:0},delta:{x:.5,y:0},sum:{x:.2,y:0},first:{x:.65,y:1}};function Tl(e,n,t,i){let a=le.rectangular,r=Math.min(1,(i*t*.62+4)/a.width),o=Math.min(1,t*1.3/a.height),s=e.x+n.x*e.width-n.x*r,l=e.y+n.y*e.height-n.y*o;return{x:Math.max(0,Math.min(1-r,s)),y:Math.max(0,Math.min(1-o,l)),width:r,height:o,rotationDegrees:0}}function El(e,n,t){let i=e.elements.find(d=>d.payload.id===n);if(!i||i.kind!=="chart")return;let a=De("text"),r=t==="latest"?10:8,o={kind:{kind:"chartStat",layer:n,stat:t}};(t==="latest"||t==="delta"||t==="sum")&&(o.format={useEntityUnit:!0}),a.payload.value=o,a.payload.fontSize=r,a.payload.fontWeight="medium",a.payload.colorSlot={baseColorHex:t==="latest"?"#FFFFFF":"#FFFFFF99"};let s=t==="trend"?2:o.format?.useEntityUnit?7:4;a.payload.frame=Tl(i.payload.frame,Sl[t],r,s);let l=e.elements.findIndex(d=>d.payload.id===n);return e.elements.splice(l+1,0,a),Zi(e,i,a.payload.id),a.payload.id}var Mp={highest:"\u25B2",lowest:"\u25CF",now:"\u25BC",first:"\u25CF",latest:"\u25CF",threshold:"\u25CF"};function Rp(e,n){return n==="highest"?e.payload.highColorHex??Re:n==="lowest"?e.payload.lowColorHex??Fe:"#FFFFFF"}function qt(e,n){return e.elements.filter(t=>t.payload.chartAnchor?.layer===n)}function Dr(e,n,t,i="above"){let a=e.elements.find(l=>l.payload.id===n);if(!a||a.kind!=="chart")return;let r=De("text"),o=6;r.payload.value=A(Mp[t]),r.payload.fontSize=o,r.payload.fontWeight="medium",r.payload.colorSlot={baseColorHex:Rp(a,t)},r.payload.frame=Fp(o),r.payload.chartAnchor={layer:n,at:t,place:i};let s=e.elements.findIndex(l=>l.payload.id===n);return e.elements.splice(s+1,0,r),Zi(e,a,r.payload.id),r.payload.id}function Fp(e){let n=le.rectangular;return{x:0,y:0,width:Math.min(1,e*1.2/n.width),height:Math.min(1,e*1.3/n.height),rotationDegrees:0}}function Ml(e){let n=e.payload;if(n.highlight==="none"||n.highlight===void 0)return!1;let t=qe(n),i=n.highlight==="highest"||n.highlight==="both",a=n.highlight==="lowest"||n.highlight==="both";return i&&t.high!=="none"||a&&t.low!=="none"}function Rl(e,n){let t=e.elements.find(l=>l.payload.id===n);if(!t||t.kind!=="chart")return;let i=t.payload,a=qe(i),r=i.highlight==="highest"||i.highlight==="both",o=i.highlight==="lowest"||i.highlight==="both",s=[];r&&a.high!=="none"&&s.push(["highest",a.high]),o&&a.low!=="none"&&s.push(["lowest",a.low]);for(let[l,d]of s){let c=Dr(e,n,l),u=e.elements.find(p=>p.payload.id===c);u?.kind==="text"&&(u.payload.value=A(d==="triangle"?"\u25B2":"\u25CF"))}Gi(i,{high:"none",low:"none"})}var Fl=[["now","Now line"],["threshold","Threshold line"]];function Vr(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind!=="chart")return;let a=i.payload,r=De("shape");r.payload.kind="line",r.payload.thickness=1,r.payload.borderWidth=0,r.payload.colorSlot={baseColorHex:t==="now"?a.nowColorHex:a.thresholdColorHex},r.payload.frame=Ap(a.frame,t),r.payload.chartAnchor={layer:n,at:t,place:"through"};let o=e.elements.findIndex(s=>s.payload.id===n);return e.elements.splice(o+1,0,r),Zi(e,i,r.payload.id),t==="now"?a.drawsNowLine=!1:a.drawsThreshold=!1,r.payload.id}function Ap(e,n){let t=le.rectangular,i=3;return n==="now"?{...e,width:Math.min(e.width,i/t.width),rotationDegrees:0}:{...e,height:Math.min(e.height,i/t.height),rotationDegrees:0}}function Ip(e,n){for(let t of n){if(!F(t)||t.kind!=="chart"||!F(t.payload))continue;let i=t.payload,a=W(i.id).toUpperCase(),r=e.elements.find(p=>p.payload.id===a);if(!r||r.kind!=="chart")continue;let o=W(i.scaleLabelColorHex,"#FFFFFF99"),s=p=>{let m=F(p)?p:{};return{fontSize:q(m.fontSize,8),colorHex:W(m.colorHex,o),pillColorHex:typeof m.pillColorHex=="string"?m.pillColorHex:void 0}},l=[],d=oe(i.scaleLabels);(d==="top"||d==="range")&&l.push(["top",s(i.topLabelStyle)]),d==="range"&&l.push(["bottom",s(i.bottomLabelStyle)]);let c=oe(i.latestLabel);if((c==="corner"||c==="end")&&l.push(["latest",s(i.latestLabelStyle)]),l.length===0)continue;let u=e.elements.findIndex(p=>p.payload.id===a)+1;for(let[p,m]of l){let g=Tl(r.payload.frame,Sl[p],m.fontSize,p==="latest"?5:4),y=[];if(m.pillColorHex!==void 0){let $=De("shape");$.payload.kind="capsule",$.payload.colorSlot={baseColorHex:m.pillColorHex},$.payload.frame={...g},y.push($)}let x=De("text");x.payload.value={kind:{kind:"chartStat",layer:a,stat:p}},x.payload.fontSize=m.fontSize,x.payload.fontWeight="medium",x.payload.colorSlot={baseColorHex:m.colorHex},x.payload.frame=g,y.push(x),e.elements.splice(u,0,...y),u+=y.length;for(let $ of y)Zi(e,r,$.payload.id)}}}function j(e){return Number.isNaN(e)?"nan":e===1/0?"+inf":e===-1/0?"-inf":e}function kt(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function Hp(e){let n={};return e.decimals!==void 0&&(n.decimals=j(e.decimals)),e.multiply!==void 0&&(n.multiply=j(e.multiply)),e.offset!==void 0&&(n.offset=j(e.offset)),e.prefix&&(n.prefix=e.prefix),e.suffix&&(n.suffix=e.suffix),e.useEntityUnit&&(n.useEntityUnit=!0),e.relativeTime&&(n.relativeTime=!0),e.duration&&(n.duration=!0),e.textCase!==void 0&&(n.textCase=e.textCase),n}function Lp(e){let n=e.scope.kind==="entities"?{kind:"entities",entities:e.scope.entities.map(kt)}:{kind:"filter",domains:e.scope.domains,areaIds:e.scope.areaIds,labelIds:e.scope.labelIds,floorIds:e.scope.floorIds},t={function:e.function,scope:n};return e.stateFilter&&(t.stateFilter=e.stateFilter.kind==="equals"||e.stateFilter.kind==="notEquals"?{kind:e.stateFilter.kind,value:e.stateFilter.value}:{kind:e.stateFilter.kind}),e.attribute!==void 0&&(t.attribute=e.attribute),t}function _p(e){switch(e.kind){case"literal":return{kind:"literal",value:e.value};case"entityState":return{kind:"entityState",...kt(e)};case"entityAttribute":return{kind:"entityAttribute",...kt(e),attribute:e.attribute};case"entityAge":return{kind:"entityAge",...kt(e)};case"aggregate":return{kind:"aggregate",aggregate:Lp(e.aggregate)};case"time":return{kind:"time",timeField:e.timeField};case"dataAge":return{kind:"dataAge"};case"jinja":return{kind:"jinja",value:e.value};case"named":return{kind:"named",id:e.id};case"chartStat":return{kind:"chartStat",layer:e.layer,stat:e.stat}}}function re(e){let n={kind:_p(e.kind)};return Ce(e.format)||(n.format=Hp(e.format)),n}function Wn(e){return{x:j(e.x),y:j(e.y),width:j(e.width),height:j(e.height),rotationDegrees:j(e.rotationDegrees)}}function Pp(e){let n={kind:e.kind};switch(e.kind){case"equals":case"notEquals":case"greaterThan":case"greaterOrEqual":case"lessThan":case"lessOrEqual":case"contains":case"startsWith":case"endsWith":n.value=re(e.value??A(""));break;case"between":case"timeBetween":n.value=re(e.value??A("")),n.upper=re(e.upper??A(""));break;case"matchesRegex":n.pattern=e.pattern??"";break;case"isOneOf":n.options=e.options??[];break;default:break}return n}function Js(e){let n={kind:e.kind};switch(e.kind){case"setColor":case"setText":case"setIcon":case"setGaugeValue":case"setBorderColor":case"setBackgroundColor":n.value=re(e.value??A(""));break;case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":n.number=j(e.number??0);break;case"setFontWeight":n.weight=e.weight??"regular";break;default:break}return n}function jn(e){return e.map(n=>{let t={id:n.id,cases:n.cases.map(i=>({id:i.id,when:{join:i.when.join,tests:i.when.tests.map(a=>({id:a.id,value:re(a.value),comparison:Pp(a.comparison)}))},then:i.then.map(Js)}))};return n.otherwise&&(t.otherwise=n.otherwise.map(Js)),n.partId!==void 0&&(t.partId=n.partId),t})}function Np(e){let n={id:e.id,value:re(e.value)};return e.colorHex!==void 0&&(n.colorHex=e.colorHex),e.fontWeight!==void 0&&(n.fontWeight=e.fontWeight),e.fontSize!==void 0&&(n.fontSize=j(e.fontSize)),e.coloring!==void 0&&e.coloring!=="uniform"&&(n.coloring=e.coloring),e.bands!==void 0&&e.bands.length>0&&(n.bands=e.bands.map(t=>({id:t.id,upTo:j(t.upTo),colorHex:t.colorHex}))),e.bandAboveColorHex!==void 0&&e.bandAboveColorHex!==ie&&(n.bandAboveColorHex=e.bandAboveColorHex),n}function zp(e){let n=Op(e);return e.payload.groupId!==void 0&&(n.payload.groupId=e.payload.groupId),n}function Op(e){let n=t=>({id:t.id,colorSlot:{baseColorHex:t.colorSlot.baseColorHex},rules:jn(t.rules),frame:Wn(t.frame),isHidden:t.isHidden});switch(e.kind){case"text":{let t={...n(e.payload),value:re(e.payload.value),fontSize:j(e.payload.fontSize),fontWeight:e.payload.fontWeight};e.payload.countdown===!0&&(t.countdown=!0),e.payload.monospacedDigits===!0&&(t.monospacedDigits=!0),e.payload.lineLimit===2&&(t.lineLimit=2),e.payload.alignment!==void 0&&e.payload.alignment!=="center"&&(t.alignment=e.payload.alignment);let i=e.payload;return i.coloring!==void 0&&i.coloring!=="uniform"&&(t.coloring=i.coloring),i.bands!==void 0&&i.bands.length>0&&(t.bands=i.bands.map(a=>({id:a.id,upTo:j(a.upTo),colorHex:a.colorHex}))),i.bandAboveColorHex!==void 0&&i.bandAboveColorHex!==ie&&(t.bandAboveColorHex=i.bandAboveColorHex),i.highlight!==void 0&&i.highlight!=="none"&&(t.highlight=i.highlight),i.highColorHex!==void 0&&i.highColorHex!==Re&&(t.highColorHex=i.highColorHex),i.lowColorHex!==void 0&&i.lowColorHex!==Fe&&(t.lowColorHex=i.lowColorHex),i.parts!==void 0&&i.parts.length>0&&(t.parts=i.parts.map(Np),lt(i)&&(t.value=re(ni(i.parts)))),Oi(i,t),{kind:"text",payload:t}}case"icon":{let t={...n(e.payload),symbol:re(e.payload.symbol)};return e.payload.path!==void 0&&e.payload.path!==""&&(t.path=e.payload.path),t.size=j(e.payload.size),Oi(e.payload,t),{kind:"icon",payload:t}}case"gauge":{let t=e.payload,i={...n(t),value:re(t.value),minValue:j(t.minValue),maxValue:j(t.maxValue),style:t.style,lineWidth:j(t.lineWidth),trackColorHex:t.trackColorHex};return t.coloring!=="uniform"&&(i.coloring=t.coloring),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,upTo:j(a.upTo),colorHex:a.colorHex}))),t.bandAboveColorHex!==ie&&(i.bandAboveColorHex=t.bandAboveColorHex),t.thresholdValue!==void 0&&(i.thresholdValue=j(t.thresholdValue)),t.thresholdColorHex!==fn&&(i.thresholdColorHex=t.thresholdColorHex),t.total!==void 0&&(i.total=re(t.total)),t.minSource!==void 0&&(i.minSource=re(t.minSource)),t.maxSource!==void 0&&(i.maxSource=re(t.maxSource)),{kind:"gauge",payload:i}}case"chart":{let t=e.payload,i={...n(t),value:re(t.value),historyMinutes:Math.max(0,Math.round(t.historyMinutes)),historyPoints:Math.round(t.historyPoints),style:t.style,limit:Math.max(0,Math.round(t.limit)),takeFromEnd:t.takeFromEnd,scale:t.scale,minValue:j(t.minValue),maxValue:j(t.maxValue),baseline:t.baseline,barGap:j(t.barGap),lineWidth:j(t.lineWidth),highlight:t.highlight,highColorHex:t.highColorHex,lowColorHex:t.lowColorHex,marker:dl(qe(t)),coloring:t.coloring,bands:t.bands.map(r=>({id:r.id,upTo:j(r.upTo),colorHex:r.colorHex})),bandAboveColorHex:t.bandAboveColorHex,fillBands:t.fillBands};t.source!==xr&&(i.source=t.source),t.statPeriod!==Qn&&(i.statPeriod=t.statPeriod),t.statType!==ei&&(i.statType=t.statType),t.thresholdValue!==void 0&&(i.thresholdValue=j(t.thresholdValue)),t.thresholdColorHex!==gn&&(i.thresholdColorHex=t.thresholdColorHex),t.nowIndex!==void 0&&(i.nowIndex=re(t.nowIndex)),t.nowColorHex!==yn&&(i.nowColorHex=t.nowColorHex),t.drawsThreshold===!1&&(i.drawsThreshold=!1),t.drawsNowLine===!1&&(i.drawsNowLine=!1),t.scaleFrom!==void 0&&(i.scaleFrom=t.scaleFrom),t.labelSize!==$t&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==Ct&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==Yn&&(i.timeLabelCount=ri(t.timeLabelCount)),t.hourCycle!==Xn&&(i.hourCycle=t.hourCycle),t.minutes!==Jn&&(i.minutes=t.minutes);let a=qe(t);return cl(a)||(i.highMarker=a.high,i.lowMarker=a.low),{kind:"chart",payload:i}}case"timeline":{let t=e.payload,i={id:t.id,rules:jn(t.rules),frame:Wn(t.frame),isHidden:t.isHidden,value:re(t.value)};return t.historyMinutes!==Lr&&(i.historyMinutes=Math.max(1,Math.round(t.historyMinutes))),t.bands.length>0&&(i.bands=t.bands.map(a=>({id:a.id,match:a.match,colorHex:a.colorHex}))),t.otherColorHex!==Et&&(i.otherColorHex=t.otherColorHex),t.gap!==0&&(i.gap=j(t.gap)),t.cornerRadius!==yl&&(i.cornerRadius=j(t.cornerRadius)),t.labelSize!==$t&&(i.labelSize=j(t.labelSize)),t.labelColorHex!==Ct&&(i.labelColorHex=t.labelColorHex),t.labelsAbove&&(i.labelsAbove=!0),t.timeLabelCount!==Yn&&(i.timeLabelCount=Math.max(0,Math.min(oi,Math.round(t.timeLabelCount)))),t.hourCycle!==Xn&&(i.hourCycle=t.hourCycle),t.minutes!==Jn&&(i.minutes=t.minutes),{kind:"timeline",payload:i}}case"shape":{let t={...n(e.payload),kind:e.payload.kind,cornerRadius:j(e.payload.cornerRadius),borderWidth:j(e.payload.borderWidth)};return e.payload.borderColorHex!==void 0&&(t.borderColorHex=e.payload.borderColorHex),e.payload.thickness!==1&&(t.thickness=j(e.payload.thickness)),Oi(e.payload,t),{kind:"shape",payload:t}}case"image":{let t=e.payload,i={id:t.id,entity:kt(t.entity),rules:jn(t.rules),frame:Wn(t.frame),isHidden:t.isHidden};t.source!=="camera"&&(i.source=t.source),t.timestamp===!0&&(i.timestamp=!0),t.contentMode!=="fill"&&(i.contentMode=t.contentMode),t.zoom!==1&&(i.zoom=j(t.zoom)),t.panX!==0&&(i.panX=j(t.panX)),t.panY!==0&&(i.panY=j(t.panY)),t.cornerRadius!==bn&&(i.cornerRadius=j(t.cornerRadius));let a=dt(t),r=a?Pr(t.timestampX,t.timestampY):t.timestampCorner;return r!=="topLeading"&&(i.timestampCorner=r),t.timestampSize!==vn&&(i.timestampSize=j(t.timestampSize)),a&&(i.timestampX=j(t.timestampX),i.timestampY=j(t.timestampY)),Oi(t,i),{kind:"image",payload:i}}case"tap":{let t=e.payload,i={id:t.id,action:Al(t.action)};return t.openPageId!==void 0&&(i.openPageId=t.openPageId),t.openPageName!==void 0&&(i.openPageName=t.openPageName),t.attachedTo!==void 0&&(i.attachedTo=t.attachedTo),i.rules=jn(t.rules),i.frame=Wn(t.frame),i.isHidden=t.isHidden,{kind:"tap",payload:i}}}}function Dp(e){let n={},t=Object.keys(e.placements);if(t.length>0){let i={};for(let a of t){let r=e.placements[a],o={frame:Wn(r.frame)};r.isHidden&&(o.isHidden=!0),r.size!==void 0&&(o.size=j(r.size)),i[a]=o}n.placements=i}if(e.bezelText&&(n.bezelText=re(e.bezelText)),e.bezelCountdown===!0&&(n.bezelCountdown=!0),e.curvedText&&(n.curvedText=re(e.curvedText)),e.curvedColorHex!==void 0&&(n.curvedColorHex=e.curvedColorHex),e.bezelGauge){let i=e.bezelGauge,a={value:re(i.value),minValue:j(i.minValue),maxValue:j(i.maxValue),colorHexes:i.colorHexes};i.minLabel&&(a.minLabel=re(i.minLabel)),i.maxLabel&&(a.maxLabel=re(i.maxLabel)),n.bezelGauge=a}return e.backgroundColorHex!==void 0&&(n.backgroundColorHex=e.backgroundColorHex),n.cornerBodyShape=e.cornerBodyShape,e.borderColorHex!==void 0&&(n.borderColorHex=e.borderColorHex),n.borderWidth=j(e.borderWidth),e.rules.length>0&&(n.rules=jn(e.rules)),n}function Al(e){if(e.type==="callService"){let n={type:e.type,serviceDomain:e.serviceDomain,serviceName:e.serviceName};return e.serviceDataJSON!==void 0&&e.serviceDataJSON.trim()!==""&&(n.serviceDataJSON=e.serviceDataJSON),e.target!==void 0&&e.target.entityId!==""&&Object.assign(n,kt(e.target)),n}return"entityId"in e?{type:e.type,...kt(e)}:{type:e.type}}function Vp(e){let n={};return e.label!==void 0&&(n.label=e.label),n.value=re(e.value),e.symbol!==void 0&&(n.symbol=e.symbol),e.countdown&&(n.countdown=!0),n}function wn(e){let n=[];for(let i of ne){let a=e.perFamily[i];a&&n.push(i,Dp(a))}let t={schemaVersion:Ut(e),id:e.id,name:e.name,values:e.values.map(i=>({id:i.id,name:i.name,value:re(i.value)})),slotIndex:e.slotIndex,elements:e.elements.map(zp),supportedFamilies:e.supportedFamilies,perFamily:n,dataSources:e.dataSources.map(i=>i.kind==="template"?{kind:"template",value:i.value}:{kind:"entity",...kt(i)}),tapAction:Al(e.tapAction)};return e.inline!==void 0&&(t.inline=Vp(e.inline)),e.refreshMinutes!==void 0&&(t.refreshMinutes=e.refreshMinutes),e.openPageId!==void 0&&(t.openPageId=e.openPageId),e.openPageName!==void 0&&(t.openPageName=e.openPageName),e.showSuccessFlash!==void 0&&(t.showSuccessFlash=e.showSuccessFlash),e.successFlashColorHex!==void 0&&(t.successFlashColorHex=e.successFlashColorHex),e.groups!==void 0&&e.groups.length>0&&(t.groups=e.groups.map(i=>({id:i.id,name:i.name,locked:i.locked}))),t}function ut(e,n){let i=e.elements.find(a=>a.payload.id===n)?.payload.groupId;return i===void 0?void 0:e.groups?.find(a=>a.id===i)}function pt(e,n){return e.elements.filter(t=>t.payload.groupId===n&&!me(e,t))}function Ge(e){let n=new Set((e.groups??[]).map(a=>a.id));for(let a of e.elements)a.payload.groupId!==void 0&&!n.has(a.payload.groupId)&&delete a.payload.groupId;let t=new Set(e.elements.map(a=>a.payload.groupId).filter(a=>a!==void 0)),i=(e.groups??[]).filter(a=>t.has(a.id));i.length===0?delete e.groups:e.groups=i}function kn(e){if(!e.groups?.length)return;let n=e.elements.filter(r=>!me(e,r)),t=e.elements.filter(r=>me(e,r)),i=[],a=new Set;for(let r=n.length-1;r>=0;r--){let o=n[r];if(a.has(o.payload.id))continue;let s=o.payload.groupId;if(s===void 0){i.unshift(o),a.add(o.payload.id);continue}let l=n.filter(d=>d.payload.groupId===s);for(let d=l.length-1;d>=0;d--)i.unshift(l[d]),a.add(l[d].payload.id)}e.elements=[...i,...t],Ft(e)}function Br(e,n,t="Group"){let i=e.elements.filter(r=>n.includes(r.payload.id)&&!me(e,r));if(i.length<2)return;let a={id:Y(),name:t,locked:!0};e.groups=[...e.groups??[],a];for(let r of i)r.payload.groupId=a.id;return Ge(e),kn(e),a.id}function ci(e,n){for(let t of e.elements)t.payload.groupId===n&&delete t.payload.groupId;Ge(e)}function Ur(e,n,t){let i=e.elements.find(a=>a.payload.id===n);!i||me(e,i)||(t===void 0?delete i.payload.groupId:i.payload.groupId=t,Ge(e),kn(e))}var ee={config:["schemaVersion","id","name","values","slotIndex","elements","supportedFamilies","perFamily","inline","dataSources","refreshMinutes","tapAction","openPageId","openPageName","showSuccessFlash","successFlashColorHex","groups"],group:["id","name","locked"],inline:["label","value","symbol","countdown"],named:["id","name","value"],value:["kind","format"],format:["decimals","multiply","offset","prefix","suffix","useEntityUnit","relativeTime","duration","textCase"],entityRef:["entityId","displayName","domain","iconName"],aggregate:["function","scope","stateFilter","attribute"],scope:["kind","entities","domains","areaIds","labelIds","floorIds"],stateFilter:["kind","value"],frame:["x","y","width","height","rotationDegrees"],chartAnchor:["layer","at","place","dx","dy"],elementEnvelope:["kind","payload"],elementBase:["id","colorSlot","rules","frame","isHidden","groupId"],text:["value","fontSize","fontWeight","countdown","monospacedDigits","lineLimit","alignment","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex","parts","chartAnchor"],textPart:["id","value","colorHex","fontWeight","fontSize","coloring","bands","bandAboveColorHex"],icon:["symbol","path","size","chartAnchor"],gauge:["value","minValue","maxValue","style","lineWidth","trackColorHex","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","style","limit","takeFromEnd","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","drawsThreshold","drawsNowLine","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes","highMarker","lowMarker","bandLowColorHex","bandHighColorHex","bandLowerBound","bandUpperBound","scaleLabels","scaleLabelPlacement","latestLabel","topLabelStyle","bottomLabelStyle","latestLabelStyle","latestLabelFollowsBand","scaleLabelColorHex"],timeline:["value","historyMinutes","bands","otherColorHex","gap","cornerRadius","timeLabels","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["kind","cornerRadius","thickness","borderColorHex","borderWidth","chartAnchor"],image:["entity","source","timestamp","contentMode","zoom","panX","panY","cornerRadius","timestampCorner","timestampSize","timestampStyle","timestampX","timestampY","chartAnchor"],tap:["action","openPageId","openPageName","attachedTo","grow"],colorSlot:["baseColorHex"],rule:["id","cases","otherwise","partId"],case:["id","when","then"],condition:["join","tests"],test:["id","value","comparison"],comparison:["kind","value","upper","pattern","options"],styleChange:["kind","value","number","weight"],layout:["placements","bezelText","bezelCountdown","curvedText","curvedColorHex","bezelGauge","backgroundColorHex","cornerBodyShape","borderColorHex","borderWidth","rules"],bezelGauge:["value","minValue","maxValue","colorHexes","minLabel","maxLabel"],placement:["frame","isHidden","size"],tapAction:["type","entityId","displayName","domain","iconName","serviceDomain","serviceName","serviceDataJSON"]},Zs={literal:["kind","value"],entityState:["kind",...ee.entityRef],entityAttribute:["kind",...ee.entityRef,"attribute"],entityAge:["kind",...ee.entityRef],aggregate:["kind","aggregate"],time:["kind","timeField"],dataAge:["kind"],jinja:["kind","value"],named:["kind","id"],chartStat:["kind","layer","stat"]};function Qi(e){let n=[],t=(l,d,c)=>{if(F(l))for(let u of Object.keys(l))d.includes(u)||n.push(`${c}.${u}`)},i=(l,d)=>{if(!F(l))return;let c=typeof l.kind=="string"?l.kind:"";t(l,Zs[c]??["kind"],d),c==="aggregate"&&F(l.aggregate)&&(t(l.aggregate,ee.aggregate,`${d}.aggregate`),t(l.aggregate.scope,ee.scope,`${d}.aggregate.scope`),F(l.aggregate.scope)&&Array.isArray(l.aggregate.scope.entities)&&l.aggregate.scope.entities.forEach((u,p)=>t(u,ee.entityRef,`${d}.aggregate.scope.entities[${p}]`)),t(l.aggregate.stateFilter,ee.stateFilter,`${d}.aggregate.stateFilter`))},a=(l,d)=>{if(F(l)){if(F(l.kind))t(l,ee.value,d),i(l.kind,`${d}.kind`);else{let c=typeof l.kind=="string"?l.kind:"";t(l,[...Zs[c]??["kind"],"format"],d),c==="aggregate"&&i(l,d)}t(l.format,ee.format,`${d}.format`)}},r=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{t(c,ee.styleChange,`${d}[${u}]`),F(c)&&a(c.value,`${d}[${u}].value`)})},o=(l,d)=>{Array.isArray(l)&&l.forEach((c,u)=>{let p=`${d}[${u}]`;t(c,ee.rule,p),F(c)&&(Array.isArray(c.cases)&&c.cases.forEach((m,g)=>{let y=`${p}.cases[${g}]`;t(m,ee.case,y),F(m)&&(t(m.when,ee.condition,`${y}.when`),F(m.when)&&Array.isArray(m.when.tests)&&m.when.tests.forEach((x,$)=>{let S=`${y}.when.tests[${$}]`;t(x,ee.test,S),F(x)&&(a(x.value,`${S}.value`),t(x.comparison,ee.comparison,`${S}.comparison`),F(x.comparison)&&(a(x.comparison.value,`${S}.comparison.value`),a(x.comparison.upper,`${S}.comparison.upper`)))}),r(m.then,`${y}.then`))}),r(c.otherwise,`${p}.otherwise`))})};if(!F(e))return n;t(e,ee.config,"$"),Array.isArray(e.groups)&&e.groups.forEach((l,d)=>t(l,ee.group,`$.groups[${d}]`)),Array.isArray(e.values)&&e.values.forEach((l,d)=>{t(l,ee.named,`$.values[${d}]`),F(l)&&a(l.value,`$.values[${d}].value`)}),Array.isArray(e.elements)&&e.elements.forEach((l,d)=>{let c=`$.elements[${d}]`;if(t(l,ee.elementEnvelope,c),!F(l)||!F(l.payload))return;let u=typeof l.kind=="string"?l.kind:"",p=ee[u]??[];t(l.payload,[...ee.elementBase,...p],`${c}.payload`),t(l.payload.colorSlot,ee.colorSlot,`${c}.payload.colorSlot`),t(l.payload.frame,ee.frame,`${c}.payload.frame`),"chartAnchor"in l.payload&&t(l.payload.chartAnchor,ee.chartAnchor,`${c}.payload.chartAnchor`),o(l.payload.rules,`${c}.payload.rules`);for(let m of["value","symbol","nowIndex","total","minSource","maxSource"])m in l.payload&&a(l.payload[m],`${c}.payload.${m}`);u==="text"&&Array.isArray(l.payload.parts)&&l.payload.parts.forEach((m,g)=>{t(m,ee.textPart,`${c}.payload.parts[${g}]`),F(m)&&a(m.value,`${c}.payload.parts[${g}].value`)}),u==="image"&&t(l.payload.entity,ee.entityRef,`${c}.payload.entity`),u==="tap"&&t(l.payload.action,ee.tapAction,`${c}.payload.action`)});let s=[];if(Array.isArray(e.perFamily))for(let l=0;l+1<e.perFamily.length;l+=2)s.push([String(e.perFamily[l]),e.perFamily[l+1]]);else F(e.perFamily)&&s.push(...Object.entries(e.perFamily));for(let[l,d]of s){let c=`$.perFamily.${l}`;if(t(d,ee.layout,c),!!F(d)){if(F(d.placements))for(let[u,p]of Object.entries(d.placements))t(p,ee.placement,`${c}.placements.${u}`),F(p)&&t(p.frame,ee.frame,`${c}.placements.${u}.frame`);if(a(d.bezelText,`${c}.bezelText`),a(d.curvedText,`${c}.curvedText`),F(d.bezelGauge)){let u=`${c}.bezelGauge`;t(d.bezelGauge,ee.bezelGauge,u),a(d.bezelGauge.value,`${u}.value`),a(d.bezelGauge.minLabel,`${u}.minLabel`),a(d.bezelGauge.maxLabel,`${u}.maxLabel`)}o(d.rules,`${c}.rules`)}}return F(e.inline)&&(t(e.inline,ee.inline,"$.inline"),a(e.inline.value,"$.inline.value")),t(e.tapAction,ee.tapAction,"$.tapAction"),n}function Y(){let e=globalThis.crypto;if(e&&"randomUUID"in e)return e.randomUUID().toUpperCase();let n=()=>Math.floor(Math.random()*65536).toString(16).padStart(4,"0"),t=(8+Math.floor(Math.random()*4)).toString(16)+n().slice(1);return`${n()}${n()}-${n()}-4${n().slice(1)}-${t}-${n()}${n()}${n()}`.toUpperCase()}function ht(){return{placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]}}function Il(e,n,t=[...ne]){let i={};for(let r of ne)t.includes(r)&&(i[r]=ht());let a={schemaVersion:4,id:Y(),name:e,values:[],slotIndex:n,elements:[],supportedFamilies:Kn.filter(r=>t.includes(r)),perFamily:i,dataSources:[],refreshMinutes:0,tapAction:{type:"refresh"}};return t.includes("inline")&&(a.inline={value:A("Text")}),a.schemaVersion=Ut(a),a}function De(e){let n=t=>({id:Y(),colorSlot:{baseColorHex:t},rules:[],frame:{...ti},isHidden:!1});switch(e){case"text":return{kind:e,payload:{...n("#FFFFFF"),value:A("Text"),fontSize:14,fontWeight:"regular"}};case"icon":return{kind:e,payload:{...n("#FFFFFF"),symbol:A("lightbulb"),size:14}};case"gauge":return{kind:e,payload:{...n("#FFFFFF"),value:A("50"),minValue:0,maxValue:100,style:"arc",lineWidth:4,trackColorHex:"#FFFFFF40",coloring:"uniform",bands:[],bandAboveColorHex:ie,thresholdColorHex:fn}};case"chart":return{kind:e,payload:{...n("#FFFFFF"),value:A("13,14,16,17,19,22,24,28,30"),historyMinutes:ji,historyPoints:24,source:xr,statPeriod:Qn,statType:ei,style:"bars",limit:0,takeFromEnd:!1,scale:"auto",minValue:0,maxValue:100,baseline:"lowest",barGap:1.5,lineWidth:2,highlight:"none",highColorHex:Re,lowColorHex:Fe,marker:"none",coloring:"uniform",bands:[],bandAboveColorHex:ie,fillBands:!1,thresholdColorHex:gn,nowColorHex:yn,timeLabelCount:Yn,labelSize:$t,labelColorHex:Ct,labelsAbove:!1,hourCycle:Xn,minutes:Jn}};case"timeline":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,value:A(""),historyMinutes:up,bands:[],otherColorHex:dp,gap:0,cornerRadius:cp,timeLabelCount:pp,labelSize:$t,labelColorHex:Ct,labelsAbove:!1,hourCycle:Xn,minutes:Jn}}}case"shape":return{kind:e,payload:{...n("#FFFFFF33"),kind:"roundedRectangle",cornerRadius:6,thickness:1,borderWidth:1}};case"image":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,entity:{entityId:"",displayName:"",domain:"camera"},source:"camera",contentMode:"fill",zoom:1,panX:0,panY:0,cornerRadius:bn,timestampCorner:"topLeading",timestampSize:vn}}}case"tap":{let{colorSlot:t,...i}=n("#FFFFFF");return{kind:e,payload:{...i,action:{type:"refresh"}}}}}}function A(e){return{kind:{kind:"literal",value:e}}}function ea(e){switch(e.kind){case"text":return e.payload.fontSize;case"icon":return e.payload.size;case"gauge":return e.payload.lineWidth;case"chart":return e.payload.lineWidth;case"timeline":return;case"shape":return;case"image":return;case"tap":return}}var Qs=["circular","corner"],el=Math.SQRT1_2;function Bp(e){return e==="text"||e==="icon"?4:.5}function Gr(e,n,t,i){let a=structuredClone(e),r=le[n],o=le[t];if(n===t||!r||!o)return a;let s=Qs.includes(n),l=Qs.includes(t),d=s===l?1:l?el:1/el,c=Math.min(o.width/r.width,o.height/r.height)*d;if(d!==1){let u=a.frame,p=u.x+u.width/2,m=u.y+u.height/2;a.frame={...u,width:u.width*d,height:u.height*d,x:.5+(p-.5)*d-u.width*d/2,y:.5+(m-.5)*d-u.height*d/2}}return a.size!==void 0&&(a.size=Math.max(Bp(i),Math.round(a.size*c*10)/10)),a}function Hl(e,n){let t=e.perFamily[n];return!t||Object.keys(t.placements).length===0?e.elements:e.elements.map(i=>{let a=t.placements[i.payload.id];if(!a)return i;let r={...i.payload,frame:a.frame,isHidden:a.isHidden};return a.size!==void 0&&(i.kind==="text"?r.fontSize=a.size:i.kind==="icon"?r.size=a.size:(i.kind==="gauge"||i.kind==="chart")&&(r.lineWidth=a.size)),{kind:i.kind,payload:r}})}function Yt(e){switch(e.kind){case"text":return e.payload.value;case"icon":return e.payload.symbol;case"gauge":return e.payload.value;case"chart":return e.payload.value;case"timeline":return e.payload.value;case"shape":return;case"image":return{kind:{kind:"entityState",...e.payload.entity}};case"tap":return}}function Zn(e){let n=[],t=i=>{for(let a of i)a.value&&n.push(a.value)};for(let i of e){for(let a of i.cases){for(let r of a.when.tests)n.push(r.value),r.comparison.value&&n.push(r.comparison.value),r.comparison.upper&&n.push(r.comparison.upper);t(a.then)}i.otherwise&&t(i.otherwise)}return n}var Kr=["light","switch","fan","input_boolean","cover","lock","media_player","siren","humidifier","valve","automation","group"];function Bi(e,n){let t,i=n;for(let a=0;i!==void 0&&a<4;a++){let r=i.kind;if(r.kind==="chartStat"){i=Or(e,i)?.payload.value;continue}if("entityId"in r){if(r.entityId==="")return;let o={entityId:r.entityId,displayName:r.displayName,domain:r.domain};return t===void 0?{ref:o}:{ref:o,namedId:t}}if(r.kind!=="named")return;t=r.id.toUpperCase(),i=e.values.find(o=>o.id.toUpperCase()===t)?.value}}function Wr(e,n){return Bi(e,Yt(n))?.ref}function jr(e,n){let t=Wr(e,n),i=t&&(t.domain||t.entityId.split(".")[0])||"";return t&&Kr.includes(i)?{type:"toggleEntity",...t,domain:i}:{type:"refresh"}}function tl(e,n,t){if(Ji(n)||t.width<=0||t.height<=0)return{...e};let i=n,a=e.x-i.left/t.width,r=e.x+e.width+i.right/t.width,o=e.y-i.top/t.height,s=e.y+e.height+i.bottom/t.height;return r<a&&(a=r=(a+r)/2),s<o&&(o=s=(o+s)/2),a=je(a),r=je(r),o=je(o),s=je(s),{...e,x:a,y:o,width:Math.max(0,r-a),height:Math.max(0,s-o)}}function Ll(e,n,t){let i=a=>Math.round(a*100)/100||0;return{left:i((e.x-n.x)*t.width),right:i((n.x+n.width-e.x-e.width)*t.width),top:i((e.y-n.y)*t.height),bottom:i((n.y+n.height-e.y-e.height)*t.height)}}function _l(e,n,t,i){let a=e.elements.find(p=>p.payload.id===n);if(!a||a.kind!=="tap"||a.payload.attachedTo===void 0)return;let r=e.elements.find(p=>p.payload.id===a.payload.attachedTo);if(!r)return;let o=e.perFamily[t]?.placements[r.payload.id]?.frame??r.payload.frame,s=je(i.x),l=je(i.y),d=je(i.x+i.width),c=je(i.y+i.height),u={...i,x:s,y:l,width:Math.max(0,d-s),height:Math.max(0,c-l)};a.payload.outset=Ll(o,u,le[t])}function Pl(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i)return;let a=e.perFamily[t];if(!a)return;let r=a.placements[n]?.frame??i.payload.frame,o=le[t];return{width:r.width*o.width,height:r.height*o.height}}function Pe(e,n){return e.elements.filter(t=>t.kind==="tap"&&t.payload.attachedTo===n)}function me(e,n){return n.kind!=="tap"||n.payload.attachedTo===void 0?!1:e.elements.some(t=>t.payload.id===n.payload.attachedTo&&t.kind!=="tap")}function qr(e,n){let t=e.elements.find(i=>i.payload.id===n);if(t){if(t.kind==="tap"&&t.payload.attachedTo!==void 0){let i=e.elements.find(a=>a.payload.id===t.payload.attachedTo);if(i)return i.payload.id}return t.payload.id}}function Ft(e){let n=new Map(e.elements.map(a=>[a.payload.id,a])),t=new Map;for(let a of e.elements){if(a.kind!=="tap")continue;let r=a.payload.attachedTo;if(r===void 0)continue;let o=n.get(r);if(!o||o.kind==="tap"||r===a.payload.id){delete a.payload.attachedTo;continue}let s=t.get(r);s?s.push(a):t.set(r,[a])}if(t.size===0)return;for(let[a,r]of t){let o=n.get(a);for(let s of r){let l=s.payload;l.outset===void 0&&(l.outset=Ll(o.payload.frame,l.frame,le.rectangular));let d=l.outset,c=!Ji(d);s.payload.frame=tl(o.payload.frame,d,le.rectangular),s.payload.isHidden=o.payload.isHidden;let u=Gp(e,a);for(let p of ne){let m=e.perFamily[p];if(!m)continue;let g=le[p],y=m.placements[a];p!==u||!y?delete m.placements[s.payload.id]:c?m.placements[s.payload.id]={frame:tl(y.frame,d,g),isHidden:y.isHidden}:m.placements[s.payload.id]={frame:{...y.frame},isHidden:y.isHidden}}}}let i=[];for(let a of e.elements){if(a.kind==="tap"&&a.payload.attachedTo!==void 0)continue;i.push(a);let r=t.get(a.payload.id);r&&i.push(...r)}e.elements=i}function ta(e,n,t){let i=e.elements.find(s=>s.payload.id===n);if(!i||i.kind==="tap")return;let a=Pe(e,n)[0];if(a)return a.payload;let r=De("tap"),o=r.payload;return o.attachedTo=n,o.outset={...Nr},o.action=t??jr(e,i),e.elements.push(r),Ft(e),o}function na(e,n){let t=Pe(e,n).map(i=>i.payload.id);if(t.length!==0){e.elements=e.elements.filter(i=>!t.includes(i.payload.id));for(let i of ne)for(let a of t)delete e.perFamily[i]?.placements[a]}}function Xe(e,n){for(let t of jt(e,n))Xe(e,t.payload.id);for(let t of qt(e,n))delete t.payload.chartAnchor;na(e,n),e.elements=e.elements.filter(t=>t.payload.id!==n);for(let t of e.elements)t.kind==="chart"&&t.payload.scaleFrom===n&&delete t.payload.scaleFrom;for(let t of ne)delete e.perFamily[t]?.placements[n];Ft(e),Ge(e)}function Nl(e,n){let t=e.elements.findIndex(l=>l.payload.id===n),i=e.elements[t];if(!i)return;let a=Y(),r=structuredClone(i);r.payload.id=a,r.payload.frame={...r.payload.frame,x:Math.min(.9,r.payload.frame.x+.05),y:Math.min(.9,r.payload.frame.y+.05)};let o=[r],s=[[n,a]];for(let l of Pe(e,n)){let d=structuredClone(l);d.payload.id=Y(),d.payload.attachedTo=a,o.push(d),s.push([l.payload.id,d.payload.id])}e.elements.splice(t+1,0,...o);for(let l of ne){let d=e.perFamily[l];if(d)for(let[c,u]of s){let p=d.placements[c];p&&(d.placements[u]=structuredClone(p))}}return Ft(e),a}function zl(e,n){let t=e.elements.findIndex(o=>o.payload.id===n),i=e.elements[t];if(!i||i.kind!=="chart")return;let a=Y(),r=structuredClone(i);r.payload.id=a,r.payload.scaleFrom=n,e.elements.splice(t+1,0,r);for(let o of ne){let s=e.perFamily[o],l=s?.placements[n];s&&l&&(s.placements[a]=structuredClone(l))}return a}function $n(e,n,t){let i=new Set,a=d=>{i.add(d);for(let c of Pe(e,d))i.add(c.payload.id)};for(let d of n){a(d);for(let c of jt(e,d))a(c.payload.id)}let r=e.elements.filter(d=>i.has(d.payload.id)).map(d=>structuredClone(d)),o={};for(let d of ne){let c=e.perFamily[d];if(!c)continue;let u={};for(let p of r){let m=c.placements[p.payload.id];m&&(u[p.payload.id]=structuredClone(m))}Object.keys(u).length>0&&(o[d]=u)}let s=new Set(r.map(d=>d.payload.groupId).filter(d=>d!==void 0)),l=(e.groups??[]).filter(d=>s.has(d.id)).map(d=>structuredClone(d));return{elements:r,placements:o,groups:l,...t!==void 0?{family:t}:{}}}function Ol(e,n,t){let i=n.family,a=i!==void 0&&i!==t&&ne.includes(i);if(!ne.includes(t))return Bt(e,n);let r=Bt(e,n,a?{nudge:!1}:{}),o=e.perFamily[t]??(e.perFamily[t]=ht());for(let s of r){let l=e.elements.find(p=>p.payload.id===s);if(!l)continue;let d=(i!==void 0?e.perFamily[i]?.placements[s]:void 0)??ne.map(p=>e.perFamily[p]?.placements[s]).find(p=>p!==void 0),c=d?.size??ea(l),u={frame:{...d?.frame??l.payload.frame},isHidden:!1,...c!==void 0?{size:c}:{}};for(let p of ne)p!==t&&delete e.perFamily[p]?.placements[s];o.placements[s]=a?Gr(u,i,t,l.kind):u}return Cn(e,t),r}function Bt(e,n,t={}){let i=new Map;for(let d of n.elements)i.set(d.payload.id,Y());let a=new Set(e.elements.map(d=>d.payload.id)),r=t.nudge!==!1&&n.elements.some(d=>a.has(d.payload.id)),o=d=>r?{...d,x:Math.min(.9,d.x+.05),y:Math.min(.9,d.y+.05)}:d,s=[];for(let d of n.elements){let c=structuredClone(d);if(c.payload.id=i.get(d.payload.id),c.kind==="tap"&&c.payload.attachedTo!==void 0){let u=i.get(c.payload.attachedTo);u?c.payload.attachedTo=u:delete c.payload.attachedTo}if(c.kind==="chart"&&c.payload.scaleFrom!==void 0){let u=i.get(c.payload.scaleFrom);u?c.payload.scaleFrom=u:a.has(c.payload.scaleFrom)||delete c.payload.scaleFrom}if(c.kind==="text")for(let u of c.payload.parts??[]){let p=u.value.kind,m=p.kind==="chartStat"?i.get(p.layer):void 0;p.kind==="chartStat"&&m&&(p.layer=m)}if(c.kind==="text"&&c.payload.value.kind.kind==="chartStat"){let u=i.get(c.payload.value.kind.layer);if(u)c.payload.value.kind.layer=u;else if(!a.has(c.payload.value.kind.layer))continue}if(c.payload.chartAnchor!==void 0){let u=i.get(c.payload.chartAnchor.layer);u?c.payload.chartAnchor.layer=u:a.has(c.payload.chartAnchor.layer)||delete c.payload.chartAnchor}c.payload.frame=o(c.payload.frame),s.push(c)}let l=new Map;for(let d of n.groups){if(s.filter(p=>p.payload.groupId===d.id&&!(p.kind==="tap"&&p.payload.attachedTo!==void 0)).length<2)continue;let u=Y();l.set(d.id,u),(e.groups??=[]).push({...structuredClone(d),id:u})}for(let d of s){if(d.payload.groupId===void 0)continue;let c=l.get(d.payload.groupId);c?d.payload.groupId=c:delete d.payload.groupId}e.elements.push(...s);for(let d of ne){let c=n.placements[d],u=e.perFamily[d];if(!(!c||!u))for(let[p,m]of Object.entries(c)){let g=i.get(p);g&&s.some(y=>y.payload.id===g)&&(u.placements[g]={...structuredClone(m),frame:o(m.frame)})}}return Ft(e),Ge(e),kn(e),s.filter(d=>!me(e,d)).map(d=>d.payload.id)}function Up(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?!a.isHidden:!t.payload.isHidden}function Gp(e,n){let t=e.elements.find(r=>r.payload.id===n),a=(t&&t.kind==="tap"?t.payload.attachedTo:void 0)??n;return ne.find(r=>e.supportedFamilies.includes(r)&&e.perFamily[r]?.placements[a]!==void 0)}function Je(e,n){let t=e.perFamily[n];return t?e.elements.filter(i=>{let a=i.kind==="tap"?i.payload.attachedTo:void 0;return t.placements[a??i.payload.id]!==void 0}):[]}function Dl(e,n){let t=e.perFamily[n];return t?Je(e,n).filter(i=>!me(e,i)&&!t.placements[i.payload.id]?.isHidden).length:0}function Cn(e,n){let t=ne.filter(s=>e.supportedFamilies.includes(s));if(t.length===0)return;let i=n!==void 0&&t.includes(n)?n:t[0];for(let s of t)e.perFamily[s]||(e.perFamily[s]=ht());let a=()=>e.elements.filter(s=>!me(e,s)),r=new Map,o=new Set;if(n===void 0){let s=new Map(a().map(p=>[p.payload.id,t.filter(m=>Up(e,m,p))]));for(let[p,m]of s)m[0]&&r.set(p,m[0]);let l=new Map([...a().entries()].map(([p,m])=>[m.payload.id,p]));for(let p of t){let m=a().filter(x=>(s.get(x.payload.id)??[]).includes(p)&&r.get(x.payload.id)!==p).map(x=>x.payload.id);if(m.length===0)continue;let g=$n(e,m,p),y=Bt(e,g,{nudge:!1});y.forEach((x,$)=>{r.set(x,p);let S=y.length===m.length?m[$]:void 0;l.set(x,S!==void 0?l.get(S)??0:l.size)})}for(let p of a())r.has(p.payload.id)||o.add(p.payload.id);let d=p=>t.indexOf(r.get(p)??i),c=a().sort((p,m)=>d(p.payload.id)-d(m.payload.id)||(l.get(p.payload.id)??0)-(l.get(m.payload.id)??0)),u=[];for(let p of c)u.push(p),u.push(...Pe(e,p.payload.id));e.elements=u}for(let s of a()){let l=s.payload.id,d=t.filter(m=>e.perFamily[m].placements[l]!==void 0),c=r.get(l)??d.find(m=>!e.perFamily[m].placements[l].isHidden)??d[0]??i,u=e.perFamily[c]?.placements[l],p={frame:{...u?.frame??s.payload.frame},isHidden:o.has(l)||u?.isHidden===!0,...u?.size!==void 0?{size:u.size}:{}};s.payload.isHidden=!0;for(let m of ne){let g=e.perFamily[m];g&&(m===c?g.placements[l]=p:delete g.placements[l])}}}function ia(e,n){let t=e.elements.find(r=>r.payload.id===n);if(!t)return[];let i=[],a=Bi(e,Yt(t));if(a){let r=t.kind==="icon"?"symbol":t.kind==="image"?"camera":"value";i.push(a.namedId===void 0?{where:r,ref:a.ref}:{where:r,ref:a.ref,namedId:a.namedId})}for(let r of Pe(e,n)){let o=r.payload.action;!("entityId"in o)||o.entityId===""||i.push({where:"tap",ref:{entityId:o.entityId,displayName:o.displayName,domain:o.domain},tapId:r.payload.id})}for(let r of t.payload.rules)for(let o of r.cases)for(let s of o.when.tests){let l=Bi(e,s.value);if(!l)continue;let d={where:"test",ref:l.ref,ruleId:r.id,caseId:o.id,testId:s.id};l.namedId!==void 0&&(d.namedId=l.namedId),i.push(d)}return i}function yr(e,n,t){if(!e)return;let i=e.kind;switch(i.kind){case"entityState":return{...e,kind:{kind:"entityState",...n}};case"entityAge":return{...e,kind:{kind:"entityAge",...n}};case"entityAttribute":return{...e,kind:{kind:"entityAttribute",...n,attribute:i.attribute}};case"literal":return t==="text"||t==="gauge"||t==="chart"||t==="timeline"?{...e,kind:{kind:"entityState",...n}}:void 0;default:return}}function Vl(e,n,t,i){let a=e.elements.find(o=>o.payload.id===n);if(!a||t.entityId==="")return;let r={...t,domain:t.domain||t.entityId.split(".")[0]||""};if(a.kind==="timeline"){let o=a.payload.value.kind.kind==="entityState"?a.payload.value.kind.entityId:void 0,s=yr(a.payload.value,r,a.kind);s&&(a.payload.value=s),(a.payload.bands.length===0||o!==r.entityId)&&(a.payload.bands=_r(r.domain,i))}else if(a.kind==="image")a.payload.entity=r;else if(a.kind==="text"||a.kind==="gauge"||a.kind==="chart"){let o=yr(a.payload.value,r,a.kind);o&&(a.payload.value=o)}else if(a.kind==="icon"){let o=yr(a.payload.symbol,r,a.kind);o&&(a.payload.symbol=o)}for(let o of Pe(e,n)){let s=o.payload;"entityId"in s.action&&(s.action={type:s.action.type,...r})}}var Kp={text:"text",icon:"icon",gauge:"gauge",chart:"chart",timeline:"timeline",shape:"shape",image:"picture",tap:"tap area"};function nl(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function il(e){if(e.part==="template")return"Template text";if(e.part==="serviceData")return"Service data";let n=e.layerKind===void 0?"":Kp[e.layerKind],t=e.layerName?`${n} "${e.layerName}"`:n;switch(e.kind){case"named":return e.valueName?`Shared value "${e.valueName}"`:"Shared value";case"layer":case"image":return e.part==="total"?`Total on ${t}`:e.part==="gaugeMin"?`Min on ${t}`:e.part==="gaugeMax"?`Max on ${t}`:e.part==="nowIndex"?`Now marker on ${t}`:e.part==="textPart"?`Part of ${t}`:`${nl(n)} layer${e.layerName?` "${e.layerName}"`:""}`;case"tap":return"Tap area";case"documentTap":return"Tap action";case"rule":return t===""?`Rule on the ${e.family??"shared"} shape`:`Rule on ${t}`;case"layout":{let i=nl(e.family??"");switch(e.part){case"curvedText":return`${i} curved text`;case"bezelGauge":return`${i} bezel gauge`;case"bezelGaugeMin":return`${i} bezel gauge low label`;case"bezelGaugeMax":return`${i} bezel gauge high label`;default:return`${i} bezel`}}case"inline":return"Inline"}}var Bl=/(['"])([a-z0-9_]+\.[a-z0-9_]+)\1/g;function Wp(e){let n=[];for(let t of e.matchAll(Bl))t[2]!==void 0&&n.push(t[2]);return n}function Yr(e,n){return n.size===0?e:e.replace(Bl,(t,i,a)=>{let r=n.get(a);return r===void 0?t:`${i}${r}${i}`})}function Gn(e){let n={entityId:e.entityId,displayName:e.displayName,domain:e.domain};return e.iconName!==void 0&&(n.iconName=e.iconName),n}function jp(e,n){if(n.kind==="shape")return n.payload.kind==="roundedRectangle"?"rounded rectangle":n.payload.kind;if(n.kind==="tap")return"";if(n.kind==="image")return n.payload.entity.displayName||n.payload.entity.entityId;let t=Yt(n)?.kind;if(t===void 0)return"";if(t.kind==="literal")return t.value;if("entityId"in t)return t.displayName||t.entityId;if(t.kind==="named"){let i=t.id.toUpperCase();return e.values.find(a=>a.id.toUpperCase()===i)?.name??""}return""}function aa(e,n){let t=(r,o)=>{n.value?.(r,o);let s=r.kind;if(s.kind==="jinja"){if(n.text){let d=n.text(s.value,{...o,part:"template"});d!==s.value&&(s.value=d)}return}if(s.kind==="aggregate"){let d=s.aggregate.scope;if(n.ref&&d.kind==="entities")for(let c=0;c<d.entities.length;c++){let u=n.ref(Gn(d.entities[c]),o);u&&(d.entities[c]=u)}return}if(!n.ref||!("entityId"in s))return;let l=n.ref(Gn(s),o);l&&(s.kind==="entityAttribute"?r.kind={kind:"entityAttribute",...l,attribute:s.attribute}:s.kind==="entityState"?r.kind={kind:"entityState",...l}:r.kind={kind:"entityAge",...l})},i=(r,o,s)=>{if(r.type==="callService"){if(n.ref&&r.target!==void 0&&r.target.entityId!==""){let d=n.ref(Gn(r.target),o);d&&(r.target=d)}if(n.text&&r.serviceDataJSON!==void 0){let d=n.text(r.serviceDataJSON,{...o,part:"serviceData"});d!==r.serviceDataJSON&&(r.serviceDataJSON=d)}return}if(!n.ref||!("entityId"in r)||r.entityId==="")return;let l=n.ref(Gn(r),o);l&&s({type:r.type,...l})};for(let r of e.values)t(r.value,{kind:"named",valueId:r.id,valueName:r.name});for(let r of e.elements){let o={kind:"layer",layerId:r.payload.id,layerKind:r.kind,layerName:jp(e,r)};if(r.kind==="image"){if(n.ref){let l=n.ref(Gn(r.payload.entity),{...o,kind:"image"});l&&(r.payload.entity=l)}}else if(r.kind==="tap"){let l=r.payload;i(l.action,{...o,kind:"tap"},d=>{l.action=d})}else{let l=Yt(r);if(l&&t(l,o),r.kind==="text")for(let d of r.payload.parts??[])t(d.value,{...o,part:"textPart"});r.kind==="gauge"&&r.payload.total&&t(r.payload.total,{...o,part:"total"}),r.kind==="gauge"&&r.payload.minSource&&t(r.payload.minSource,{...o,part:"gaugeMin"}),r.kind==="gauge"&&r.payload.maxSource&&t(r.payload.maxSource,{...o,part:"gaugeMax"}),r.kind==="chart"&&r.payload.nowIndex&&t(r.payload.nowIndex,{...o,part:"nowIndex"})}let s={...o,kind:"rule"};for(let l of Zn(r.payload.rules))t(l,s)}let a=Object.keys(e.perFamily).sort((r,o)=>{let s=Kn.indexOf(r),l=Kn.indexOf(o);return(s<0?Kn.length:s)-(l<0?Kn.length:l)});for(let r of a){let o=e.perFamily[r];if(!o)continue;let s={kind:"layout",family:r};o.bezelText&&t(o.bezelText,{...s,part:"bezelText"}),o.curvedText&&t(o.curvedText,{...s,part:"curvedText"});let l=o.bezelGauge;l&&(t(l.value,{...s,part:"bezelGauge"}),l.minLabel&&t(l.minLabel,{...s,part:"bezelGaugeMin"}),l.maxLabel&&t(l.maxLabel,{...s,part:"bezelGaugeMax"}));let d={kind:"rule",family:r};for(let c of Zn(o.rules))t(c,d)}e.inline&&t(e.inline.value,{kind:"inline"}),i(e.tapAction,{kind:"documentTap"},r=>{e.tapAction=r})}function ra(e,n){aa(e,{value:n})}function Ul(e,n){return e.kind.kind==="named"&&e.kind.id.toUpperCase()===n.toUpperCase()}function ui(e,n){let t=new Set;return ra(e,(i,a)=>{Ul(i,n)&&t.add(a.layerId??`${a.kind}:${a.valueId??""}:${a.family??""}:${a.part??""}`)}),t.size}function qp(e,n){let t=new Set(e.values.map(a=>a.name.trim().toLowerCase())),i=n.trim()||"Value";if(!t.has(i.toLowerCase()))return i;for(let a=2;;a++){let r=`${i} ${a}`;if(!t.has(r.toLowerCase()))return r}}function Xr(e,n,t){let i={id:Y(),name:qp(e,t),value:{kind:structuredClone(n.kind)}},a={kind:{kind:"named",id:i.id}};return n.format&&!Ce(n.format)&&(a.format=structuredClone(n.format)),{named:i,ref:a}}function Jr(e,n){if(n.kind.kind!=="named")return;let t=n.kind.id,i=e.values.find(o=>o.id.toUpperCase()===t.toUpperCase());if(!i)return;let a=n.format&&!Ce(n.format)?n.format:i.value.format,r={kind:structuredClone(i.value.kind)};return a&&!Ce(a)&&(r.format=structuredClone(a)),r}function Zr(e,n){ra(e,t=>{if(!Ul(t,n))return;let i=Jr(e,t);i&&(t.kind=i.kind,i.format?t.format=i.format:delete t.format)}),e.values=e.values.filter(t=>t.id.toUpperCase()!==n.toUpperCase())}function Qr(e,n){aa(e,{ref:n})}function eo(e,n){aa(e,{text:n})}function to(e,n){let t=[],i={ref:(a,r)=>{a.entityId!==""&&t.push({entityId:a.entityId,ref:a,where:il(r)})}};return n&&(i.text=(a,r)=>{for(let o of Wp(a)){let s=o.split(".")[0]??"";n(o,s)&&t.push({entityId:o,ref:{entityId:o,displayName:"",domain:s},where:il(r)})}return a}),aa(e,i),t}var oa={text:["color","opacity","text","fontSize","fontWeight","rotation","visibility"],icon:["color","opacity","icon","fontSize","rotation","visibility"],gauge:["color","opacity","gaugeValue","gaugeMin","gaugeMax","rotation","visibility"],chart:["color","opacity","rotation","visibility"],timeline:["opacity","rotation","visibility"],shape:["color","opacity","borderColor","borderWidth","rotation","visibility"],image:["opacity","rotation","visibility"],tap:["visibility"],layout:["backgroundColor","borderColor","borderWidth","text"]},Gl=["isOn","isOff","equals","notEquals","isUnavailable","isStale","isEmpty","greaterThan","greaterOrEqual","lessThan","lessOrEqual","between","timeBetween","contains","startsWith","endsWith","matchesRegex","isOneOf"];function Xt(e){let n=e.trim();return/^([01][0-9]|2[0-3]):[0-5][0-9]$/.test(n)?n:void 0}function Jt(e){switch(e){case"isOn":case"isOff":case"isUnavailable":case"isStale":case"isEmpty":return"none";case"between":return"between";case"timeBetween":return"times";case"matchesRegex":return"pattern";case"isOneOf":return"options";default:return"value"}}function sa(e){switch(e){case"hide":case"show":return"none";case"setFontWeight":return"weight";case"setOpacity":case"setFontSize":case"setRotation":case"setGaugeMin":case"setGaugeMax":case"setBorderWidth":return"number";default:return"value"}}function no(){return{id:Y(),value:A(""),comparison:{kind:"isOn"}}}function io(){return{id:Y(),when:{join:"all",tests:[no()]},then:[]}}function pi(){return{id:Y(),cases:[io()]}}function al(e,n){return e&&(e.kind.kind!=="literal"||Xt(e.kind.value)!==void 0)?e:A(n)}function ao(e,n){let t={kind:n};switch(Jt(n)){case"value":t.value=e.value??A("");break;case"between":t.value=e.value??A(""),t.upper=e.upper??A("");break;case"times":t.value=al(e.value,"22:00"),t.upper=al(e.upper,"06:00");break;case"pattern":t.pattern=e.pattern??"";break;case"options":t.options=e.options??[];break;case"none":break}return t}function Zt(e){let n={kind:e};switch(sa(e)){case"value":n.value=A(e==="setColor"||e==="setBorderColor"||e==="setBackgroundColor"?"#FF453A":e==="setIcon"?"exclamationmark.triangle":e==="setGaugeValue"?"50":"Text");break;case"number":n.number=e==="setOpacity"?.5:e==="setFontSize"?14:e==="setBorderWidth"?2:e==="setGaugeMax"?100:0;break;case"weight":n.weight="bold";break;case"none":break}return n}var la="shared:";function ro(e){return la+e.toUpperCase()}function Wl(e){return e.values.filter(n=>n.value.kind.kind!=="entityState"&&ui(e,n.id)>0)}function jl(e,n){return n.size===0?e:e.map(t=>{let i=n.get(ro(t.id));if(i===void 0)return t;let a={kind:{kind:"literal",value:i}};return t.value.format&&(a.format=t.value.format),{...t,value:a}})}var Yp=["unavailable","unknown"],Xp={automation:["on","off"],script:["on","off"],remote:["on","off"],update:["on","off"],timer:["idle","active","paused"],sun:["above_horizon","below_horizon"],valve:["open","closed","opening","closing"],lawn_mower:["mowing","docked","paused","returning","error"],weather:["sunny","clear-night","partlycloudy","cloudy","rainy","pouring","snowy","snowy-rainy","fog","windy","windy-variant","lightning","lightning-rainy","hail","exceptional"]},Jp=new Set(["\xB0C","\xB0F"]);function Kl(e){return Array.isArray(e)&&e.length>0&&e.every(n=>typeof n=="string")?e:void 0}function hi(e){let n=typeof e=="number"?e:typeof e=="string"&&e.trim()!==""?Number(e):NaN;return Number.isFinite(n)?n:void 0}function Zp(e){let n=e?.trim().match(/\.(\d+)$/)?.[1]?.length??0;return n===0?1:10**-Math.min(n,4)}function Qp(e){let n=10**Math.floor(Math.log10(e));return([1,2,2.5,5,10].find(i=>i*n>=e)??10)*n}function eh(e){let n=new Set,t=[];for(let i of e)i===void 0||i===""||n.has(i)||(n.add(i),t.push(i));return t}function ql(e,n,t){let i=e.split(".")[0]??"",a=n?.attributes??{},o=Kl(a.options)??(i==="climate"?Kl(a.hvac_modes):void 0)??di[i]??Xp[i];if(o)return{kind:"choice",options:eh([...o,n?.state,t,...Yp])};let s=hi(n?.state),l=typeof a.unit_of_measurement=="string"?a.unit_of_measurement:void 0;if(s===void 0&&l===void 0&&i!=="input_number"&&i!=="number")return{kind:"text"};let d=hi(t),c=hi(a.min),u=hi(a.max),p=hi(a.step),m,g;if(c!==void 0&&u!==void 0&&u>c)m=c,g=u;else if(l==="%")m=0,g=100;else{let x=Qp(Math.max(Math.abs(s??0)*2,10));m=(s??0)<0||l!==void 0&&Jp.has(l)?-x:0,g=x}d!==void 0&&(m=Math.min(m,d),g=Math.max(g,d));let y=p!==void 0&&p>0?p:Zp(n?.state);return{kind:"number",min:m,max:g,step:y}}function Yl(e){if(e.appliedToken===void 0)return{kind:"unsupported"};if(e.token===e.appliedToken){let n=!e.polling&&typeof e.lastPollSeconds=="number"?e.lastPollSeconds:void 0;return n===void 0?{kind:"sent"}:{kind:"sent",awaySeconds:n}}return e.pending&&e.polling?{kind:"sending"}:e.polling?{kind:"waiting"}:{kind:"offline"}}function th(e){if(e<60)return"just now";let n=Math.floor(e/60);if(n<60)return`${n} min ago`;let t=Math.floor(n/60);if(t<24)return`${t} h ago`;let i=Math.floor(t/24);return`${i} ${i===1?"day":"days"} ago`}function Xl(e){switch(e.kind){case"unsupported":return{label:"Update the watch app",note:"to receive this",title:"This watch has never reported which changes it applied, so nothing saved here can reach it. Its Wrist Assistant app is older than custom complications, or it has not been opened on this home yet.",resend:!1};case"sent":return e.awaySeconds===void 0?{label:"On watch",title:"The watch has applied every change here.",resend:!1}:{label:"On watch",note:`last seen ${th(e.awaySeconds)}`,title:"The watch has applied every change here, but it is not listening now. A save made after this will not reach it until the watch app is open on this home again.",resend:!1};case"sending":return{label:"Sending\u2026",title:"Waiting for the watch to pull and confirm.",resend:!1};case"waiting":return{label:"Not on watch yet",title:"The watch is connected but has not confirmed the latest change. Resend wakes it again.",resend:!0};case"offline":return{label:"Open the watch app to sync",title:"Saves reach the watch by themselves while Wrist Assistant is open on this home. Open the app, or switch the watch to this home, and it pulls at once.",resend:!0}}}function Zl(e){let n=new TextEncoder().encode(e),t=0xcbf29ce484222325n,i=0x100000001b3n,a=0xffffffffffffffffn;for(let r of n)t^=BigInt(r),t=t*i&a;return t.toString(16)}function Ql(e){return new Map(e.map(n=>[n.id.toUpperCase(),n.value]))}function Jl(e){return e.kind==="entityAttribute"||e.kind==="entityAge"||e.kind==="aggregate"||e.kind==="time"||e.kind==="jinja"}function oo(e,n,t=0){let i=n instanceof Map?n:Ql(n),a=e.kind;if(a.kind==="named"){if(t>8)return;let o=i.get(a.id.toUpperCase());return o?o.kind.kind==="named"?oo(o,i,t+1):Jl(o.kind)?"n_"+a.id.toLowerCase().replace(/-/g,""):void 0:void 0}if(!Jl(a))return;let r=mi(a);if(r!==void 0)return"e_"+Zl(r)}function Ke(e){return"'"+e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"}function nh(e){let n;if(e.scope.kind==="entities")n=`expand([${e.scope.entities.map(o=>Ke(o.entityId)).join(", ")}])`;else{let{domains:o,areaIds:s,labelIds:l,floorIds:d}=e.scope;if(!(s.length+l.length+d.length>0))n=o.length===0?"[]":"("+o.map(u=>`(states.${u} | list)`).join(" + ")+")";else{let u=[];for(let p of s)u.push(`area_entities(${Ke(p)})`);for(let p of l)u.push(`label_entities(${Ke(p)})`);d.length>0&&u.push(`((${d.map(p=>`floor_areas(${Ke(p)})`).join(" + ")}) | map('area_entities') | sum(start=[]))`),n=`(expand(${u.join(" + ")})`,o.length>0&&(n+=` | selectattr('domain', 'in', [${o.map(Ke).join(", ")}])`),n+=")"}}let t=n,i=e.stateFilter;if(i&&(i.kind==="isOn"?t+=" | selectattr('state', 'eq', 'on')":i.kind==="isOff"?t+=" | selectattr('state', 'eq', 'off')":i.kind==="equals"?t+=` | selectattr('state', 'eq', ${Ke(i.value)})`:t+=` | rejectattr('state', 'eq', ${Ke(i.value)})`),e.function==="count")return`(${t} | list | count)`;let a=e.attribute?`attributes.${e.attribute}`:"state",r=`${t} | map(attribute=${Ke(a)}) | map('float', 0) | list`;switch(e.function){case"sum":return`(${r} | sum)`;case"average":return`(${r} | average(0))`;case"min":return`(${r} | min(default=0))`;case"max":return`(${r} | max(default=0))`}}function mi(e){switch(e.kind){case"entityAttribute":return`state_attr(${Ke(e.entityId)}, ${Ke(e.attribute)})`;case"entityAge":{let n=Ke(e.entityId);return`(((now() - states[${n}].last_changed).total_seconds() if states[${n}] is not none else 0) | round(0))`}case"time":switch(e.timeField){case"now":return"now().strftime('%H:%M')";case"hour":return"now().hour";case"minute":return"now().minute";case"day":return"now().day";case"month":return"now().month";case"weekday":return"now().weekday()";case"timestamp":return"(as_timestamp(now()) | round(0))"}return;case"jinja":return e.value.trim().length===0?void 0:e.value;case"aggregate":return nh(e.aggregate);default:return}}function da(e){let n=new Map,t=new Map,i=Ql(e.values),a=(o,s=0)=>{let l=o.kind;switch(l.kind){case"literal":case"dataAge":case"chartStat":return;case"entityState":n.set(l.entityId,l);return;case"named":{if(s>8)return;let d=i.get(l.id.toUpperCase());if(!d)return;if(d.kind.kind==="named"){a(d,s+1);return}if(d.kind.kind==="entityState"){n.set(d.kind.entityId,d.kind);return}let c=mi(d.kind);if(c===void 0)return;t.set("n_"+l.id.toLowerCase().replace(/-/g,""),c);return}default:{let d=mi(l);if(d===void 0)return;t.set("e_"+Zl(d),d)}}};for(let o of e.values)a({kind:{kind:"named",id:o.id}});for(let o of e.elements){let s=Yt(o);if(s&&a(s),o.kind==="text")for(let l of o.payload.parts??[])a(l.value);o.kind==="gauge"&&o.payload.total&&a(o.payload.total),o.kind==="gauge"&&o.payload.minSource&&a(o.payload.minSource),o.kind==="gauge"&&o.payload.maxSource&&a(o.payload.maxSource),o.kind==="chart"&&o.payload.nowIndex&&a(o.payload.nowIndex);for(let l of Zn(o.payload.rules))a(l)}for(let o of ne){if(!e.supportedFamilies.includes(o))continue;let s=e.perFamily[o];if(s){s.bezelText&&a(s.bezelText),s.curvedText&&a(s.curvedText),s.bezelGauge&&(a(s.bezelGauge.value),s.bezelGauge.minLabel&&a(s.bezelGauge.minLabel),s.bezelGauge.maxLabel&&a(s.bezelGauge.maxLabel));for(let l of Zn(s.rules))a(l)}}e.supportedFamilies.includes("inline")&&e.inline&&a(e.inline.value);let r={entities:n,expressions:t};return t.size>0&&(r.document=ih(t)),r}function ih(e){let n=[...e.keys()].sort(),t=[];for(let a of n){let r=e.get(a);r.includes("{{")||r.includes("{%")?t.push(`{% set v_${a} %}${r}{% endset %}`):t.push(`{% set v_${a} = ${r} %}`)}let i=n.map(a=>`"${a}": v_${a}`).join(", ");return t.push(`{{ { ${i} } | to_json }}`),t.join(`
`)}function ed(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,ah(r));return{values:t,nullKeys:i}}function ah(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function so(e){let n=da(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function rh(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin;case"first":return e.values[0];case"delta":return e.values[e.values.length-1]-e.values[0];case"sum":return e.values.reduce((t,i)=>t+i,0);case"trend":{let t=e.values[e.values.length-1]-e.values[0],i=Number(Cr(t,e.domainMax-e.domainMin));return i>0?1:i<0?-1:0}}}var oh=10800;function sh(e,n,t){let i=n==="always"||n==="auto"&&t<=oh;return new Intl.DateTimeFormat(void 0,{hour:"numeric",...i?{minute:"2-digit"}:{},...e==="h12"?{hourCycle:"h12"}:{},...e==="h24"?{hourCycle:"h23"}:{}})}function ad(e,n,t,i,a){if(e<=0||n.length===0)return[];let r=sh(t,i,e);return n.map(o=>({position:o,text:r.format(new Date(a-e*1e3*(1-o)))}))}function lh(e,n){return Rt(e)===void 0?[]:ad(Ye(e)*60,Hr(e.timeLabelCount),e.hourCycle,e.minutes,n)}function dh(e,n){return Yi(e)?ad(Math.round(e.historyMinutes)*60,Hr(ri(e.timeLabelCount)),e.hourCycle,e.minutes,n):[]}function Qt(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function Ne(e){let n=e.trim(),t=Qt(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:Qt(i)}function ch(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function uh(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function ph(e){let n=e.trim(),t=Qt(n);if(t!==void 0)return t;let i=0,a=n.indexOf(",");if(a>=0){let s=n.slice(0,a).trim().split(" "),l=s.length===2?Qt(s[0]):void 0;if(l===void 0||s[1]!=="day"&&s[1]!=="days")return;i=l,n=n.slice(a+1).trim()}let r=n.split(":");if(r.length!==2&&r.length!==3)return;let o=0;for(let s=0;s<r.length;s++){let l=Qt(r[s]);if(l===void 0)return;o+=l*Math.pow(60,r.length-1-s)}return i*86400+o}function hh(e){let n=Math.trunc(Math.min(Math.max(0,e)||0,863913600)),i=[[Math.trunc(n/86400),"d"],[Math.trunc(n%86400/3600),"h"],[Math.trunc(n%3600/60),"m"],[n%60,"s"]].filter(([a])=>a>0).slice(0,2).map(([a,r])=>`${a}${r}`);return i.length===0?"0s":i.join(" ")}function mh(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function fh(e,n,t){if(Ce(n))return e;let i=n,a=e,r=Qt(e.trim()),o=i.duration?ph(e):void 0;if(o!==void 0)a=hh(o);else if(i.relativeTime&&r!==void 0)a=uh(r);else{let s=Ne(e);if(s!==void 0){let l=s*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==s&&(a=Number.isInteger(l)?String(l):ch(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=mh(a);break}return a}function Sn(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Qe(e,n=240){return rd(e,n).map(t=>t.value)}function rd(e,n=240){let t=[],i="",a=0,r=!1,o=0,s=()=>{if(i!==""){let l=Number(i);Number.isFinite(l)&&t.push({value:l,start:a,end:a+i.length})}i=""};for(let l of e){if(t.length>=n)break;if(l>="0"&&l<="9")i===""&&(a=o),i+=l,r=!0;else if(l===".")i.includes(".")&&s(),i===""&&(a=o),i+=".",r=!0;else if(l==="-"||l==="+"){let d=!r;s(),d&&(a=o,i=l),r=!1}else s(),r=!1;o+=l.length}return t.length<n&&s(),t}function td(e,n,t){let i=rd(e),a=i.map(y=>y.value),r=t.highlight??"none",o=-1,s=-1;a.length>0&&((r==="highest"||r==="both")&&(o=a.indexOf(Math.max(...a))),(r==="lowest"||r==="both")&&(s=a.indexOf(Math.min(...a))),s===o&&(s=-1));let l=t.coloring==="bands"?Tt({bands:t.bands??[]}):[],d=t.bandAboveColorHex??ie,c=t.highColorHex??Re,u=t.lowColorHex??Fe,p=[],m=(y,x)=>{if(y==="")return;let $=p.at(-1);$&&$.colorHex===x?$.text+=y:p.push({text:y,colorHex:x})},g=0;return i.forEach((y,x)=>{m(e.slice(g,y.start),n);let $=x===o?c:x===s?u:l.length>0?Wi(y.value,l,d):n,S=e[y.end-1]==="."?y.end-1:y.end;m(e.slice(y.start,S),$),g=S}),m(e.slice(g),n),p}function nd(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1,n.thresholdValue!==void 0&&Number.isFinite(n.thresholdValue)&&(t=Math.min(t,n.thresholdValue),i=Math.max(i,n.thresholdValue))),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function gh(e,n,t){let i=e.thresholdValue;if(!(i===void 0||!Number.isFinite(i)||!(t>n)||i<n||i>t))return(i-n)/(t-n)}function gi(e,n=Mt){let t=[];for(let i of e.split(" ")){if(t.length>=n)break;if(i==="")continue;let a=i.indexOf(":");if(a<=0)continue;let r=Number(i.slice(0,a));!Number.isFinite(r)||r<0||t.push({offsetSeconds:Math.round(r),state:yh(i.slice(a+1))})}return t}function yh(e){try{return decodeURIComponent(e)}catch{return e}}function bh(e,n,t){if(e.length===0||!(n>0))return[];let i=[];for(let r=0;r<e.length;r++){let o=e[r],s=Math.min(1,Math.max(0,o.offsetSeconds/n)),l=e[r+1],d=l===void 0?1:Math.min(1,Math.max(s,l.offsetSeconds/n));if(!(d>s))continue;let c=t(o.state),u=i[i.length-1];u!==void 0&&u.colorHex===c?u.end=d:i.push({start:s,end:d,colorHex:c})}let a=i[i.length-1];return a!==void 0&&(a.end=1),i}function id(e,n,t){if(Number.isNaN(e))return t;let i=e<0?-Math.round(-e):Math.round(e);return Math.min(t,Math.max(n,i))}function vh(e,n,t){if(e===void 0)return 0;let i=Ne(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Ze=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=this.chartSeries(n),i=nd(t,n),a={values:t,domainMin:i.min,domainMax:i.max},r=this.chartEntity(n);return r&&(a.entity=r),a}chartSeries(n){let t=Kt(n),i=Wt(n),a,r=t??i;r!==void 0?a=this.ctx.historySeries?.get(r)??"":a=this.resolve(n.value)??"";let o=Qe(a),s=r===void 0?void 0:this.testedReading(n);return s!==void 0&&(o=[...o.slice(0,-1),s]),n.limit>0&&o.length>n.limit?n.takeFromEnd?o.slice(o.length-n.limit):o.slice(0,n.limit):o}testedReading(n){let t=this.chartEntity(n);if(!t||!this.ctx.testedEntities?.has(t.entityId))return;let i=this.ctx.entityStates.get(t.entityId)?.state;return i===void 0?void 0:Ne(i)}chartEntity(n){let t=this.dereference(n.value);if(!(!t||!("entityId"in t.kind)))return{entityId:t.kind.entityId,displayName:t.kind.displayName,domain:t.kind.domain}}chartNowIndex(n,t){if(n.nowIndex===void 0||t===0)return;let i=this.resolve(n.nowIndex);if(i===void 0)return;let a=Ne(i);if(!(a===void 0||!Number.isFinite(a)))return Math.min(Math.max(Math.round(a),0),t-1)}settleCharts(n){let t=new Map,i=[];for(let s of n.elements)s.kind!=="chart"||t.has(s.payload.id)||(t.set(s.payload.id,s.payload),i.push(s.payload.id));let a=new Map;for(let s of i)a.set(s,this.chartSeries(t.get(s)));let r=new Map,o=(s,l)=>{let d=r.get(s);if(d)return d;let c=t.get(s);if(!c)return{min:0,max:1};let u=c.scaleFrom,p=u!==void 0&&u!==s&&t.has(u)&&!l.has(u)?o(u,new Set([...l,u])):nd(a.get(s)??[],c);return r.set(s,p),p};for(let s of i){let l=t.get(s),d=o(s,new Set([s])),c={values:a.get(s)??[],domainMin:d.min,domainMax:d.max},u=this.chartEntity(l);u&&(c.entity=u),this.charts.set(s,c)}}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let s=this.named.get(o);if(!s)return;a=a&&!Ce(a)?a:s.format,t=s}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){if(t.stat==="trend")return;let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?rh(a,t.kind.stat):void 0;a&&r!==void 0&&(i=t.kind.stat==="trend"?pl(r):Cr(r,a.domainMax-a.domainMin));break}default:{let a=oo(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return fh(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let s=Date.parse(o.finishesAt);return Number.isFinite(s)&&s>this.nowMs()?s:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=Qt(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}canCountDown(n){if(!n)return!1;let t=this.dereference(n);if(t?.kind.kind==="entityState"){let i=t.kind.entityId;if(i.startsWith("timer.")||this.ctx.entityStates.get(i)?.timerState!==void 0)return!0}return this.countdownEnd(n)!==void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?Sn(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=Ne(i),r=()=>this.resolve(t.value),o=()=>{let l=r();return l===void 0?void 0:Ne(l)},s=l=>{let d=o();return a===void 0||d===void 0?!1:l(a,d)};switch(t.kind){case"equals":{let l=r();return l!==void 0&&i===l}case"notEquals":{let l=r();return l!==void 0&&i!==l}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let l=i.toLowerCase();return l==="unavailable"||l==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return s((l,d)=>l>d);case"greaterOrEqual":return s((l,d)=>l>=d);case"lessThan":return s((l,d)=>l<d);case"lessOrEqual":return s((l,d)=>l<=d);case"between":{let l=o(),d=this.resolve(t.upper),c=d===void 0?void 0:Ne(d);if(a===void 0||l===void 0||c===void 0)return!1;let[u,p]=l<=c?[l,c]:[c,l];return a>=u&&a<=p}case"timeBetween":{let l=Xt(i),d=r(),c=this.resolve(t.upper),u=d===void 0?void 0:Xt(d),p=c===void 0?void 0:Xt(c);return l===void 0||u===void 0||p===void 0||u===p?!1:u<p?l>=u&&l<p:l>=u||l<p}case"contains":{let l=r();return!!l&&i.toLowerCase().includes(l.toLowerCase())}case"startsWith":{let l=r();return!!l&&i.toLowerCase().startsWith(l.toLowerCase())}case"endsWith":{let l=r();return!!l&&i.toLowerCase().endsWith(l.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(l=>l.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(s=>s.id===r.caseId)?.then??[];else{let s=a.cases.find(l=>this.evaluateCondition(l.when));o=s?s.then:a.otherwise??[]}for(let s of o)i.set(Ae[s.kind],s)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveTextParts(n,t,i,a){let r=[];for(let o of n){let s=this.applyRules(t.filter(d=>d.partId===o.id),a);if(s.get("visibility")?.kind==="hide")continue;let l={text:this.styleText(s,"text")??this.resolve(o.value)??"--",fontSize:this.styleNumber(s,"fontSize")??o.fontSize??i.fontSize,fontWeight:s.get("fontWeight")?.weight??o.fontWeight??i.fontWeight,colorHex:this.styleColor(s,"color")??o.colorHex??i.colorHex};o.coloring==="bands"&&(o.bands?.length??0)>0&&(l.spans=td(l.text,l.colorHex,o)),r.push(l)}return r}resolveElement(n,t){let i=n.payload,a=n.kind==="text"?i.rules.filter(p=>p.partId===void 0):i.rules,r=this.applyRules(a,t),o=r.get("visibility"),s=o?o.kind==="hide":i.isHidden,l=this.styleNumber(r,"rotation"),d=l===void 0?i.frame:{...i.frame,rotationDegrees:l},c=this.styleNumber(r,"opacity")??1,u={id:i.id,isHidden:s,frame:d,opacity:c};switch(i.chartAnchor!==void 0&&(u.chartAnchor=i.chartAnchor),n.kind){case"text":{let p=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,m=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,g=lt(n.payload)&&!r.has("text"),y={kind:"text",...u,text:g?"":this.styleText(r,"text")??m??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(r,"fontSize")??n.payload.fontSize,fontWeight:r.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,monospacedDigits:n.payload.monospacedDigits===!0,lineLimit:n.payload.lineLimit===2?2:1,alignment:n.payload.alignment??"center"};return p!==void 0&&(y.countdownEnd=p),g?(y.parts=this.resolveTextParts(n.payload.parts,i.rules,y,t),y.text=y.parts.map(x=>x.text).join(""),y):(sl(n.payload)&&(y.spans=td(y.text,y.colorHex,n.payload)),y)}case"icon":{let p=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle",m=this.styleText(r,"icon"),g=n.payload.symbol.kind.kind==="literal",y=m===void 0&&g&&n.payload.path!==""?n.payload.path:void 0,x=m??p;y===void 0&&x.startsWith("mdi:")&&(x="questionmark.circle");let $={kind:"icon",...u,symbol:x,size:this.styleNumber(r,"fontSize")??n.payload.size,colorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex};return y!==void 0&&($.path=y),$}case"gauge":{let p=n.payload,m=this.styleText(r,"gaugeValue")??this.resolve(p.value),g=(B,N,J)=>B??(N?Ne(this.resolve(N)??""):void 0)??J,y=g(this.styleNumber(r,"gaugeMin"),p.minSource,p.minValue),x=g(this.styleNumber(r,"gaugeMax"),p.maxSource,p.maxValue),$=m===void 0?void 0:Ne(m),S=this.styleColor(r,"color")??p.colorSlot.baseColorHex;p.coloring==="bands"&&p.bands.length>0&&$!==void 0&&(S=Wi($,Tt(p),p.bandAboveColorHex));let k=x-y;if(p.total){let B=Ne(this.resolve(p.total)??"");B!==void 0&&(k=B)}let C=id(k,1,Ki),z={kind:"gauge",...u,fraction:vh(m,y,x),style:p.style,lineWidth:p.lineWidth,colorHex:S,trackColorHex:p.trackColorHex,thresholdColorHex:p.thresholdColorHex,dotCount:C,filledCount:id($??0,0,C)};if(p.thresholdValue!==void 0&&x!==y){let B=(p.thresholdValue-y)/(x-y);B>=0&&B<=1&&(z.thresholdFraction=B)}return z}case"chart":{let p=n.payload,m=this.charts.get(p.id)??this.chartReadings(p),g=m.values,y={min:m.domainMin,max:m.domainMax},x=this.styleColor(r,"color")??p.colorSlot.baseColorHex,$=Tt(p),S=ul(p)?g.map(T=>Wi(T,$,p.bandAboveColorHex)):[],k=p.highlight==="highest"||p.highlight==="both",C=p.highlight==="lowest"||p.highlight==="both",z=qe(p),B={kind:"chart",...u,values:g,style:p.style,domainMin:y.min,domainMax:y.max,baseline:p.baseline,barGap:p.barGap,lineWidth:p.lineWidth,colorHex:x,highColorHex:p.highColorHex,lowColorHex:p.lowColorHex,marker:p.marker,highMarker:k?z.high:"none",lowMarker:C?z.low:"none",pointColorHexes:S,fillBands:p.fillBands,thresholdColorHex:p.thresholdColorHex,drawsThreshold:p.drawsThreshold!==!1,nowColorHex:p.nowColorHex,drawsNowLine:p.drawsNowLine!==!1,labels:dh(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove};if(g.length>0){let T=k?g.indexOf(Math.max(...g)):-1,U=C?g.indexOf(Math.min(...g)):-1;T>=0&&(B.highIndex=T),U>=0&&U!==T&&(B.lowIndex=U)}let N=gh(p,y.min,y.max);N!==void 0&&(B.thresholdY=N);let J=this.chartNowIndex(p,g.length);return J!==void 0&&(B.nowIndex=J),B}case"timeline":{let p=n.payload,m=Rt(p),g=m===void 0?"":this.ctx.historySeries?.get(m)??"",y=gi(g,Mt),x=bh(y,Ye(p)*60,S=>bl(S,p.bands,p.otherColorHex));return{kind:"timeline",...u,runs:x,gap:p.gap,cornerRadius:p.cornerRadius,labels:lh(p,this.nowMs()),labelSize:p.labelSize,labelColorHex:p.labelColorHex,labelsAbove:p.labelsAbove}}case"shape":{let p={kind:"shape",...u,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,thickness:n.payload.thickness,fillColorHex:this.styleColor(r,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(r,"borderWidth")??n.payload.borderWidth},m=this.styleColor(r,"borderColor")??n.payload.borderColorHex;return m!==void 0&&(p.borderColorHex=m),p}case"image":{let p={kind:"image",...u,entityId:n.payload.entity.entityId,source:n.payload.source,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};dt(n.payload)&&(p.timestampX=n.payload.timestampX,p.timestampY=n.payload.timestampY);let m=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return m!==void 0&&(p.url=m),p}case"tap":{let p={kind:"tap",...u,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(p.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(p.attachedTo=n.payload.attachedTo),p}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=[...kh(Hl(n,t).map(y=>this.resolveElement(y,i)),le[t==="inline"?"rectangular":t])],o=a?this.applyRules(a.rules,i):new Map,s={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},l=this.styleText(o,"text"),d=a?.bezelCountdown&&l===void 0?this.countdownEnd(a.bezelText):void 0,c=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,u=l??c??this.resolve(a?.bezelText);u!==void 0&&(s.bezelText=u),d!==void 0&&(s.bezelCountdownEnd=d);let p=this.resolve(a?.curvedText);if(p!==void 0&&(s.curvedText=p),a?.curvedColorHex!==void 0&&(s.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let y=a.bezelGauge,x=this.resolve(y.value),$=x===void 0?void 0:Ne(x);if($!==void 0){let S=Math.min(y.minValue,y.maxValue),k=Math.max(y.minValue,y.maxValue),C={value:Math.min(k,Math.max(S,$)),minValue:S,maxValue:k===S?S+1:k,colorHexes:y.colorHexes},z=this.resolve(y.minLabel);z!==void 0&&(C.minLabel=z);let B=this.resolve(y.maxLabel);B!==void 0&&(C.maxLabel=B),s.bezelGauge=C}}let m=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;m!==void 0&&(s.backgroundColorHex=m);let g=this.styleColor(o,"borderColor")??a?.borderColorHex;return g!==void 0&&(s.borderColorHex=g),s}};function xh(e,n,t){let i=new Ze(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function ca(e,n,t){let i=new Ze(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=xh(e.inline,n,e)),a}function ua(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}var wh=5;function lo(e,n){let t=e.values,i=Math.max(t.length,1),r=e.highIndex!==void 0&&e.highMarker!=="none"||e.lowIndex!==void 0&&e.lowMarker!=="none"?wh:0,o=e.style==="bars"?0:e.lineWidth/2,s=n.x,l=Math.max(n.w,0),d=n.y+r+o,c=Math.max(n.h-r-o*2,1),u=d+c,p=Math.max(e.domainMax-e.domainMin,Number.EPSILON),m=e.baseline==="lowest",g=m?c*.12:0,y=Math.min(Math.max(e.barGap,0),l/(i*2)),x=Math.max((l-y*(i-1))/i,.5),$=k=>Math.min(1,Math.max(0,(k-e.domainMin)/p)),S=k=>u-$(k)*c;return{count:t.length,barWidth:x,plotTop:d,plotBottom:u,plotLeft:s,plotRight:s+l,baselineY:m?u:S(0),yAtFraction(k){return u-Math.min(Math.max(k,0),1)*c},barRect(k){let C=s+k*(x+y),z=t[k],B,N;if(m){let J=g+$(z)*(c-g);B=u-J,N=u}else B=S(z),N=m?u:S(0),B>N&&([B,N]=[N,B]);return{x:C,y:B,w:x,h:Math.max(N-B,.5)}},point(k){let C=Math.max(l-o*2,0);return{x:t.length>1?s+o+C*k/(t.length-1):s+l/2,y:S(t[k])}},markerCenter(k,C){let z=C?this.barRect(k):void 0;return{x:z?z.x+z.w/2:this.point(k).x,y:n.y+r/2}}}}var fi=1;function pa(e,n){let t=Math.max(si,Math.min(li,e.labelSize)),i=t*1.2,a=e.labels.length>0&&n.h-i-fi>=2,r=a?{...n,y:e.labelsAbove?n.y+i+fi:n.y,h:n.h-i-fi,cy:(e.labelsAbove?n.y+i+fi:n.y)+(n.h-i-fi)/2}:n;return{labelSize:t,rowHeight:i,body:r,showsLabels:a}}function kh(e,n){if(!e.some(i=>i.chartAnchor!==void 0))return e;let t=new Map;for(let i of e)i.kind==="chart"&&t.set(i.id,i);return t.size===0?e:e.map(i=>{let a=i.chartAnchor;if(a===void 0)return i;let r=t.get(a.layer);if(r===void 0)return i;let o=Ch(i.frame,a,r,n);return o===void 0?i:{...i,frame:o}})}function $h(e,n){let t=n.values;if(t.length!==0)switch(e){case"highest":return t.indexOf(Math.max(...t));case"lowest":return t.indexOf(Math.min(...t));case"first":return 0;case"latest":return t.length-1;case"now":return n.nowIndex===void 0?void 0:Math.min(Math.max(n.nowIndex,0),t.length-1);case"threshold":return}}function Ch(e,n,t,i){if(i.width<=0||i.height<=0)return;let a=ua(t,i);if(a.w<=0||a.h<=0)return;let r=pa(t,a).body;if(r.w<=0||r.h<=0)return;let o=lo(t,r),s,l;if(St(n.at)){let x=$h(n.at,t);if(x===void 0)return;if(t.style==="bars"){let $=o.barRect(x);s=$.x+$.w/2,l=$.y}else{let $=o.point(x);s=$.x,l=$.y}}else{if(t.thresholdY===void 0)return;l=o.yAtFraction(t.thresholdY)}let d=Math.max(e.width,0)*i.width,c=Math.max(e.height,0)*i.height,u=.75,p=(x,$,S)=>$>S?($+S)/2:Math.min(Math.max(x,$),S),m={...e};if(s!==void 0){let x=p(s+(n.dx??0),r.x+d/2,r.x+r.w-d/2);m.x=(x-d/2)/i.width}if(n.place==="through"){if(s!==void 0)m.y=o.plotTop/i.height,m.height=(o.plotBottom-o.plotTop)/i.height;else{m.x=o.plotLeft/i.width,m.width=(o.plotRight-o.plotLeft)/i.width;let x=p(l+(n.dy??0),r.y+c/2,r.y+r.h-c/2);m.y=(x-c/2)/i.height}return m}let g=n.place==="on"?l:n.place==="below"?l+u+c/2:n.place==="bottom"?o.plotBottom-u-c/2:l-u-c/2,y=p(g+(n.dy??0),r.y+c/2,r.y+r.h-c/2);return m.y=(y-c/2)/i.height,m}var Se=le,yi=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:Se,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Tn=yi.find(e=>e.measured);function md(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return yi.find(a=>a.screen.width===t&&a.screen.height===i)}function ma(e,n){let t=Se[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var po={regular:400,medium:500,semibold:600,bold:700},Sh=1.15;function et(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function ye(e,n,t="#FFFFFF"){let i=et(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}var mt=e=>e*.55;function fd(e,n){switch(e){case"leading":return{anchor:"start",x:n.x};case"trailing":return{anchor:"end",x:n.x+n.w};default:return{anchor:"middle",x:n.cx}}}function Th(e,n){let t=e.split(/\s+/).filter(r=>r!=="");if(t.length<2)return[e];let i="",a=0;for(let r=0;r<t.length-1;r++){let o=i===""?t[r]:`${i} ${t[r]}`;if(i!==""&&o.length>n)break;i=o,a=r+1}return a===0&&(i=t[0],a=1),[i,t.slice(a).join(" ")]}function Eh(e,n,t){if(t<=0||e.length*mt(n)<=t)return e;let i=t-.8*n,a=Math.max(1,Math.floor(i/mt(n)));return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Mh(e,n){if(!n||n.map(i=>i.text).join("")!==e)return;let t=[];for(let i of n)for(let a=0;a<i.text.length;a++)t.push(i.colorHex);return t}function gd(e,n){if(n.length<2)return[0];let t=[...e.matchAll(/\S+/g)].map(i=>i.index);return[t[0]??0,t[n[0].split(" ").length]??e.length]}function yd(e,n,t,i,a){let r=[],o=n,s=a,l=d=>d<t.length&&/\s/.test(t[d]);for(let d of e){let c=s;if(/\s/.test(d))for(l(o)&&(c=i[o]);l(o);)o++;else{for(;l(o);)o++;t.startsWith(d,o)&&(c=i[o],o+=d.length)}s=c;let u=r.at(-1);u&&u.look===c?u.text+=d:r.push({text:d,look:c})}return r}function Rh(e){let n=[];for(let t of e){let i=t.spans!==void 0&&t.spans.map(a=>a.text).join("")===t.text?t.spans:[{text:t.text,colorHex:t.colorHex}];for(let a of i){let r={fontSize:t.fontSize,fontWeight:t.fontWeight,colorHex:a.colorHex};for(let o=0;o<a.text.length;o++)n.push(r)}}return n}function bd(e,n){return e.reduce((t,i)=>t+i.text.length*mt(i.look.fontSize*n),0)}function Fh(e,n,t){let i=[...e.matchAll(/\S+/g)];if(i.length<2)return[e];let a=l=>n[l]?.fontSize??0,r=0,o=0;for(let l=0;l<i.length-1;l++){let d=i[l].index??0,c=o===0?0:mt(a(d-1));for(let u=d;u<d+i[l][0].length;u++)c+=mt(a(u));if(o>0&&r+c>t)break;r+=c,o=l+1}let s=l=>l.map(d=>d[0]).join(" ");return[s(i.slice(0,o)),s(i.slice(o))]}function Ah(e,n,t){if(t<=0||bd(e,n)<=t)return[...e];let i=[],a=0,r=0;e:for(let s of e){let l=s.look.fontSize*n,d=t-.8*l,c="";for(let u of s.text){if(r>0&&a+u.length*mt(l)>d){c!==""&&i.push({text:c,look:s.look});break e}c+=u,a+=u.length*mt(l),r+=1}i.push({text:c,look:s.look})}for(;i.length>0;){let s=i.at(-1);if(s.text=s.text.replace(/\s+$/,""),s.text!=="")break;i.pop()}let o=i.at(-1);return o?o.text+="\u2026":e[0]&&i.push({text:"\u2026",look:e[0].look}),i}function Ih(e,n,t){let i=Rh(n),a=e.lineLimit===2&&t.w>0?Fh(e.text,i,t.w):[e.text],r=gd(e.text,a),o=a.map((S,k)=>yd(S,r[k]??0,e.text,i,i[0])),s=Math.max(...o.map(S=>bd(S,1))),l=s>t.w&&t.w>0?Math.max(.5,t.w/s):1,d=o.map(S=>Ah(S,l,t.w)),{anchor:c,x:u}=fd(e.alignment,t),p=Math.max(0,...d.flat().map(S=>S.look.fontSize))*l||e.fontSize*l,m=.35*p,g=p*1.15,y=S=>S.map(k=>{let C=ye(k.look.colorHex,"fill");return w`<tspan font-size=${k.look.fontSize*l} font-weight=${po[k.look.fontWeight]??400} fill=${C.fill} fill-opacity=${C["fill-opacity"]}>${k.text}</tspan>`}),x=ye(e.colorHex,"fill"),$=d.length>1?w`${d.map((S,k)=>w`<tspan x=${u} y=${t.cy+m+(k-(d.length-1)/2)*g}>${y(S)}</tspan>`)}`:y(d[0]);return w`<text x=${u} y=${t.cy+m} text-anchor=${c}
    ...
    fill=${x.fill} fill-opacity=${x["fill-opacity"]}>${$}</text>`}function Hh(e,n){if(e.parts!==void 0&&e.countdownEnd===void 0&&e.parts.map(y=>y.text).join("")===e.text)return e.text===""?f:Ih(e,e.parts,n);let t=ye(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:Sn((e.countdownEnd-Date.now())/1e3)});let i=e.lineLimit===2&&n.w>0?Th(e.text,n.w/mt(e.fontSize)):[e.text],a=Math.max(...i.map(y=>y.length))*mt(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,s=i.map(y=>Eh(y,o,n.w)),{anchor:l,x:d}=fd(e.alignment,n),c=Mh(e.text,e.spans),u=c?gd(e.text,i):[],p=(y,x)=>c?yd(y,u[x]??0,e.text,c,e.colorHex).map($=>{let S=ye($.look,"fill");return w`<tspan fill=${S.fill} fill-opacity=${S["fill-opacity"]}>${$.text}</tspan>`}):y,m=o*1.15,g=s.length>1?w`${s.map((y,x)=>w`<tspan x=${d} y=${n.cy+(x-(s.length-1)/2)*m}>${p(y,x)}</tspan>`)}`:p(s[0],0);return w`<text x=${d} y=${n.cy} text-anchor=${l} dominant-baseline="central"
    font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
    font-size=${o} font-weight=${po[e.fontWeight]??400}
    style=${e.monospacedDigits?"font-variant-numeric: tabular-nums":f}
    fill=${t.fill} fill-opacity=${t["fill-opacity"]}>${g}</text>`}var co=2;function Lh(e,n){let t=ye(e.colorHex,"stroke"),i=ye(e.trackColorHex,"stroke","#FFFFFF"),a=ye(e.thresholdColorHex,"stroke","#FFFFFF"),r=e.lineWidth;if(e.style==="dots"){let m=n.w>=n.h,g=Math.max(1,e.dotCount),y=m?n.w:n.h,x=m?n.h:n.w,$=Math.max(1,Math.min(x,y/g-co)),S=g*$+(g-1)*co,k=(m?n.cx:n.cy)-S/2+$/2;return w`${Array.from({length:g},(C,z)=>{let B=k+z*($+co),N=z<e.filledCount?t:i;return w`<circle cx=${m?B:n.cx} cy=${m?n.cy:B} r=${$/2}
    ...
    <g transform="rotate(${c} ${n.cx} ${n.cy})">
      ...
      ${e.thresholdFraction===void 0?f:_h(n,s,r,d*360*e.thresholdFraction,e.thresholdColorHex)}
    </g>`}function _h(e,n,t,i,a){let r=ye(a,"stroke","#FFFFFF"),o=i*Math.PI/180,s=Math.cos(o),l=Math.sin(o),d=t/2+1;return w`<line x1=${e.cx+s*(n-d)} y1=${e.cy+l*(n-d)}
    x2=${e.cx+s*(n+d)} y2=${e.cy+l*(n+d)}
    stroke-width="1" stroke=${r.stroke} stroke-opacity=${r["stroke-opacity"]} />`}function Ph(e,n){let{labelSize:t,rowHeight:i,body:a,showsLabels:r}=pa(e,n),o=r?vd(e,n,t,i):void 0;if(e.values.length===0)return o===void 0?f:w`${o}`;let s=Nh(e,a);return o===void 0?s:w`${s}${o}`}function Nh(e,n){let t=lo(e,n),i=ye(e.colorHex,"fill"),a=ye(e.highColorHex,"fill",e.colorHex),r=ye(e.lowColorHex,"fill",e.colorHex),o=(u,p)=>w`<circle cx=${u.x} cy=${u.y} r="1.7" fill=${p.fill} fill-opacity=${p["fill-opacity"]} />`,s=[],l=e.pointColorHexes.length===t.count,d=u=>l?ye(e.pointColorHexes[u],"fill",e.colorHex):i;if(e.style==="bars")for(let u=0;u<t.count;u++){let p=t.barRect(u),m=u===e.highIndex?a:u===e.lowIndex?r:d(u),g=Math.min(1.2,p.w/2,p.h/2);s.push(w`<rect x=${p.x} y=${p.y} width=${p.w} height=${p.h} rx=${g}
      ...
      fill=${y.fill} fill-opacity=${y["fill-opacity"]} />`});return r?w`${s}${vd(e,n,t,i)}`:w`${s}`}function Oh(e,n){let t=ye(e.fillColorHex,"fill"),i=e.borderColorHex?et(e.borderColorHex):void 0,a=i?e.borderWidth:0,r=a/2,o=i?i.color:"none",s=i?i.opacity:0;switch(e.shapeKind){case"circle":{let l=Math.min(n.w,n.h)/2-r;return w`<circle cx=${n.cx} cy=${n.cy} r=${Math.max(0,l)}
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]} stroke="none" />`}}}function Dh(e,n,t){if(e.path!==void 0&&e.path!==""){let o=ye(e.colorHex,"fill"),s=e.size*Sh;return w`<g transform="translate(${n.cx-s/2} ${n.cy-s/2}) scale(${s/24})">
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var yo=.25,Vh=8;function Bh(e,n,t,i,a,r,o,s){let l={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return l;let d=Math.min(Math.max(Number.isFinite(r)?r:1,yo),Vh),c=Math.max(e/t,n/i),u=Math.min(e/t,n/i),p=(a==="fit"?u:c)*d,m=t*p,g=i*p,y=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),x=Math.min(Math.max(Number.isFinite(s)?s:0,-1),1);return{x:-(m-e)/2*(1+y)+0,y:-(g-n)/2*(1+x)+0,width:m,height:g}}function fa(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var ha=4;function ga(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let l=e.timestampCorner.endsWith("Leading")?n.x+ha:n.x+n.w-ha-a,d=e.timestampCorner.startsWith("top")?n.y+ha:n.y+n.h-ha-r;return{x:l,y:d,w:a,h:r,size:i,label:t}}let s=(l,d,c,u)=>u>=c?d+(c-u)/2:Math.min(d+c-u,Math.max(d,l-u/2));return{x:s(n.x+e.timestampX*n.w,n.x,n.w,a),y:s(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Uh(e,n){if(e==="camera")return"camera.fill";switch(n.split(".")[0]){case"camera":return"camera.fill";case"person":return"person.crop.circle";case"media_player":return"music.note";default:return"photo"}}function Gh(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?ga(e,n,fa(new Date)):void 0,s=o?w`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([p,m,g])=>w`<rect data-ts-corner=${p} x=${m-l/2} y=${g-l/2} width=${l} height=${l}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${p}-resize" />`)}`:f,c=e.url?t.imageSizes?.size(e.url):void 0,u;if(e.url&&c){let p=Bh(n.w,n.h,c.width,c.height,e.contentMode,e.zoom,e.panX,e.panY);u=w`<image href=${e.url} x=${n.x+p.x} y=${n.y+p.y} width=${p.width} height=${p.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render(Uh(e.source,e.entityId),14,"#FFFFFF99")??f}</g>`;return w`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${u}${s}</g>${d}`}function Kh(e,n,t,i,a){if(!i)return f;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?Wh(a,n):void 0;return w`
    ...
    ${o!==void 0?w`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${ho} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?w`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??f}</g>`:f}`}var ho=5;function Wh(e,n){let t=ho*.55,i=n.w-2;if(n.h<ho*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function mo(e,n,t){if(e.isHidden&&!t.showHidden)return f;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,s=r!==void 0;if(e.kind==="tap"&&!a)return f;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||s&&!o))return f;let l=ua(e,n),d=i&&(!s||o),c;switch(e.kind){case"text":c=Hh(e,l);break;case"icon":c=Dh(e,l,t.icons);break;case"gauge":c=Lh(e,l);break;case"chart":c=Ph(e,l);break;case"timeline":c=zh(e,l);break;case"shape":c=Oh(e,l);break;case"image":c=Gh(e,l,t);break;case"tap":c=Kh(e,l,t.icons,a,d?ct(e.action):void 0);break}let u=i&&(e.kind!=="tap"||s&&!o)?.35:1,p=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*u,m=t.highlightId===e.id,g=m||t.highlightIds?.includes(e.id)===!0,y=t.handles===!0&&(!s||o),x=g?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:f,$=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:f,S=w`<rect x=${l.x} y=${l.y} width=${l.w} height=${l.h} fill="transparent" stroke="none" />`,k=3,C=m&&y?[["nw",l.x,l.y],["ne",l.x+l.w,l.y],["sw",l.x,l.y+l.h],["se",l.x+l.w,l.y+l.h]].map(([z,B,N])=>w`<rect data-handle=${z} x=${B-k/2} y=${N-k/2} width=${k} height=${k}
          fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${z}-resize" />`):f;return w`<g data-element-id=${e.id} opacity=${p} style=${y?"cursor:move":f}
    transform="rotate(${e.frame.rotationDegrees} ${l.cx} ${l.cy})">${S}${c}${$}${x}${C}</g>`}function ya(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function bo(e,n){return(n?23.5:34)*e}var od=10.5;function xd(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function sd(e,n){let t=0;for(let i of e)t+=xd(i,n);return t}function ld(e,n,t){let i=e.toUpperCase(),a=d=>xd(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let s=0,l="";for(let d of i){if(s+a(d)+r>n)break;l+=d,s+=a(d)}return`${l.replace(/\s+$/,"")}\u2026`}function fo(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function go(e,n,t,i){let a=fo(e,n,t),r=fo(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function wd(e,n,t,i){let{dial:a}=ya(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:go(a,t,i.start,i.end),length:t*r}}function jh(e,n){let t=ya(e,!0);return wd(e,n,t.dial.r,t.labelArc)}var dd=18.5,qh=113,Yh={start:-71,end:-36},cd=104,Xh=6.2,ud={start:-77,end:-30.5};function pd(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function hd(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=pd(e[i]),o=pd(e[i+1]),s=(l,d)=>Math.round(l+(d-l)*a);return`rgb(${s(r[0],o[0])}, ${s(r[1],o[1])}, ${s(r[2],o[2])})`}var uo=11;function Jh(e,n,t){let{dial:i}=ya(n,!0),a=cd*n,r=180/(Math.PI*cd),o=e.minLabel!==void 0?sd(e.minLabel,uo)*r:0,s=e.maxLabel!==void 0?sd(e.maxLabel,uo)*r:0,l=ud.start+(o>0?Math.max(0,o-1.8):0),d=ud.end-(s>0?Math.max(0,s-1.8):0),c=d-l,u=24,p=[];for(let $=0;$<u;$++){let S=l+c*$/u,k=Math.min(d,l+c*($+1)/u+.4);p.push(w`<path d=${go(i,a,S,k)} fill="none"
      stroke=${hd(e.colorHexes,($+.5)/u)} stroke-width=${Xh*n}
    ...
    <circle cx=${g.x} cy=${g.y} r=${3.2*n} fill=${hd(e.colorHexes,m)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?x(`${t}-gmin`,l-y-Math.max(o,3),l-y,e.minLabel):f}
    ${e.maxLabel!==void 0?x(`${t}-gmax`,d+y,d+y+Math.max(s,3),e.maxLabel):f}`}function ba(e,n){let t=e.family in Se?e.family:"rectangular",i=n.slot??Se[t],a=Se[t],r=ma(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,s=et(e.backgroundColorHex),l=et(e.borderColorHex),d=e.borderWidth*r.scale,c=e.elements;if(t==="corner"){let y=r.scale,x=!!e.bezelText||!!e.bezelGauge,$=e.curvedText??"",S=$!=="",k=ya(y,x),C=bo(y,x),z=C/(a.width*y),B=k.tile.cx-C/2,N=k.tile.cy-C/2,J=`M 0 0 H ${k.quad.width-k.cornerRadius} A ${k.cornerRadius} ${k.cornerRadius} 0 0 1 ${k.quad.width} ${k.cornerRadius} V ${k.quad.height} H 0 Z`,T=f;if(e.bezelGauge)T=Jh(e.bezelGauge,y,o);else if(e.bezelText){let X=jh(y,`${o}-bezel`),G=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?Sn((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;T=w`<defs><path id=${X.id} d=${X.d} /></defs>
        <text font-size=${od*y} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${X.id}" startOffset="50%" text-anchor="middle">${ld(G,X.length,od*y)}</textPath></text>`}let U=f;if(S){let X=et(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},G=wd(y,`${o}-curved`,qh*y,Yh);U=w`<defs><path id=${G.id} d=${G.d} /></defs>
        <text font-size=${dd*y} font-weight="600" fill=${X.color} fill-opacity=${X.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${G.id}" startOffset="50%" text-anchor="middle">${ld($,G.length,dd*y*.88)}</textPath></text>`}else{let X=e.borderWidth*r.scale*z,G=l?w`<circle cx=${C/2} cy=${C/2} r=${C/2-X/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${X} />`:f;U=w`<g transform="translate(${B} ${N})">
        <g clip-path=${`url(#${o})`}>
    ...
    ${c.map(m=>mo(m,a,d))}
    ${u}
  </svg>`}function te(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var en=["rectangular","circular","corner","inline"];function En(e){return ne.includes(e)}function va(e){return en.filter(n=>e.supportedFamilies.includes(n))}function vo(e){return ne.find(n=>e.supportedFamilies.includes(n))}function xa(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function tm(){return{value:A("")}}function $d(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=en.filter(t=>t===n||e.supportedFamilies.includes(t))),En(n)?e.perFamily[n]||(e.perFamily[n]=ht()):e.inline||(e.inline=tm()),e.schemaVersion=Ut(e)}function Cd(e,n){if(xa(e,n)){if(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),En(n)){for(let t of Je(e,n))Xe(e,t.payload.id);delete e.perFamily[n],Ge(e)}else delete e.inline;e.schemaVersion=Ut(e)}}function Sd(e,n){let t=[];if(!En(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=Je(e,n).filter(r=>!me(e,r)).length;return a>0&&t.push(`${a} layer${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var ze={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",timeline:"#00897b",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},Mn={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",timeline:"Timeline",shape:"Shape",image:"Picture",tap:"Tap area"},xo=["text","icon","gauge","chart","timeline","shape","image","tap"],Q={content:"#4a7fe8",look:"#a15fe0",numbers:"#26a69a",position:"#66bb6a",states:"#f9a825",tap:ze.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Td="2.8.0";function wo(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function nm(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function Ed(e,n=Td){let t=wo(e),i=wo(n);return!t||!i?!1:nm(t,i)>=0}function Md(e,n=Td){return`${wo(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The editor needs ${n}, coming soon to the App Store.`}var Rd="52a9d81d0fd7";var Fd="11fa18406cea";var Ie="mdi:";function im(e){return e.trim().replace(/\./g,"-")}function am(e){return e.trim().replace(/-/g,".")}var wa=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>am(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=im(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=et(i)??{color:"#FFFFFF",opacity:1},s=r.viewBox??"0 0 24 24";return w`<svg x="0" y="0" width=${t} height=${t} viewBox=${s}>
    ...
    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${mm(e)}</svg>`}var nt="color-mix(in srgb, var(--k) 45%, #6b7280)",Ma='system-ui, -apple-system, "Segoe UI", sans-serif';function qd(e,n,t,i){let r=135+270*Math.max(0,Math.min(1,i)),o=c=>{let u=c*Math.PI/180;return{x:(e-t*Math.cos(u)).toFixed(2),y:(n-t*Math.sin(u)).toFixed(2)}},s=o(135),l=o(r),d=r-135>180?1:0;return`M${s.x} ${s.y}A${t} ${t} 0 ${d} 1 ${l.x} ${l.y}`}function Ro(e,n,t,i){return w`<g fill="none" stroke-linecap="round">
    <path d=${qd(e,n,t,1)} stroke=${nt} stroke-width="2.6" opacity=".5" />
    <path d=${qd(e,n,t,i)} stroke="var(--k)" stroke-width="2.6" />
  </g>`}function fm(e){switch(e){case"text":return w`<g font-family=${Ma} text-anchor="middle">
    ...
    <input type="text" .value=${n} placeholder=${i.placeholder??""} list=${i.list??f}
      class=${i.mono?"mono":""} @input=${ge(t)} /></label>`}function Rc(e,n,t,i=3){return h`<label class="field"><span>${e}</span>
    ...
    </div>`}function Em(e,n){let t=i=>It(i.value,i.def,i.set,a=>i.options.find(([r])=>r===a)?.[1]??a);return h`<div class="field seg-field pair">${_e(e.label,t(e))}
    <div class="pair-row">
      ${Oa(e.label,e.value,e.options,e.set,e)}
      ${_e(n.label,t(n))}
      ${Oa(n.label,n.value,n.options,n.set,n)}
    </div></div>`}function Ti(e,n,t,i){let a=i.format??(o=>String(Math.round(o*100)/100)),r=o=>{o!==void 0&&o>=i.min&&o<=i.max&&t(o)};return h`<div class="field slider num">${_e(e,It(n,i.def,t,a),ja(n,t,i))}
    ...
    </span>`}function Zo(e,n){return e===void 0||n===void 0?e===n:e.replace(/^#/,"").toUpperCase()===n.replace(/^#/,"").toUpperCase()}function Ya(e,n){let t=e[n],i=t&&typeof t.attributes.friendly_name=="string"?t.attributes.friendly_name:n;return{entityId:n,displayName:i,domain:n.split(".")[0]??""}}function Mm(e,n,t){let i=n===void 0?void 0:typeof n=="string"?[n]:n,a=[];for(let[r,o]of Object.entries(e)){let s=r.split(".")[0]??"";if(i!==void 0&&!i.includes(s))continue;let l=typeof o?.attributes?.friendly_name=="string"?o.attributes.friendly_name.trim():"",d=t?.(r);a.push({entityId:r,name:l||r,state:o?.state??"",domain:s,...d?{area:d}:{}})}return a.sort((r,o)=>r.name.localeCompare(o.name)||r.entityId.localeCompare(o.entityId)),a}function dc(e){let{entities:n,devices:t,areas:i}=e;if(!n||!i)return;let a=r=>{if(!r)return;let o=i[r]?.name;return typeof o=="string"&&o.trim()!==""?o.trim():void 0};return r=>{let o=n[r];if(o)return a(o.area_id)??a(o.device_id?t?.[o.device_id]?.area_id:void 0)}}var Ac=50;function Rm(e){let n=e.state.trim().split(/\s+/)[0]??"";return n!==""&&Number.isFinite(Number(n))}function Fm(e,n,t=Ac,i){let a=n.trim().toLowerCase(),r=l=>i===void 0||i(l)?0:1;if(a==="")return(i===void 0?e.slice():[...e].sort((l,d)=>r(l)-r(d))).slice(0,t);let o=a.split(/\s+/),s=[];for(let l of e){let d=l.entityId.toLowerCase(),c=l.name.toLowerCase(),u=(l.area??"").toLowerCase(),p=-1;d===a?p=0:d.startsWith(a)?p=1:c.startsWith(a)?p=2:d.includes(a)?p=3:c.includes(a)?p=4:o.length>1&&o.every(m=>d.includes(m)||c.includes(m))?p=5:u!==""&&(u.includes(a)||o.length>1&&o.every(m=>d.includes(m)||c.includes(m)||u.includes(m)))&&(p=6),p>=0&&s.push({c:l,rank:p})}return s.sort((l,d)=>l.rank-d.rank||r(l.c)-r(d.c)||l.c.name.localeCompare(d.c.name)||l.c.entityId.localeCompare(d.c.entityId)),s.slice(0,t).map(l=>l.c)}var Am=/^[a-z0-9_]+\.[a-z0-9_]+$/i;function Ic(e){return Am.test(e.trim())}function Im(e,n,t){let i=e.trim();if(i!==n.entityId){if(i==="")return{entityId:"",displayName:"",domain:""};if(i in t)return Ya(t,i);if(Ic(i))return{...n,entityId:i,domain:i.split(".")[0]??""}}}var an=new Map;function ke(e){let n=e instanceof Node?e:null;for(let t=0;n&&t<8;t+=1){let i=n.getRootNode();if(!(i instanceof ShadowRoot))return;let a=i.host;if(typeof a.requestUpdate=="function"){a.requestUpdate();return}n=a}}function Qo(e){return an.has(e)}function it(e,n,t,i,a,r={}){let o=e.hass.states,s=an.get(a),l=s?Fm(Mm(o,r.domain,dc(e.hass)),s.query,Ac,r.preferNumeric?Rm:void 0):[],d=s?Math.max(0,Math.min(s.index,l.length-1)):0,c=t.entityId?o[t.entityId]:void 0,u=(k,C,z=0)=>{an.set(a,{query:C,index:z}),ke(k)},p=k=>{an.delete(a),ke(k)},m=k=>{let C=Im(k,t,o);C&&i(C)},g=(k,C)=>{i(Ya(o,k.entityId)),p(C)},y=()=>Math.max(0,Math.min(an.get(a)?.index??0,l.length-1)),x=k=>{let C=k.target;if(k.key==="ArrowDown"||k.key==="ArrowUp"){k.preventDefault();let z=an.get(a);if(!z){u(C,C.value);return}let B=k.key==="ArrowDown"?y()+1:y()-1;u(C,z.query,Math.max(0,Math.min(l.length-1,B))),Hm(C);return}if(k.key==="Enter"){k.preventDefault();let z=l[y()];s&&z?g(z,C):(m(C.value),p(C));return}if(k.key==="Escape"){if(!s)return;k.preventDefault(),k.stopPropagation(),p(C)}},$=t.entityId?dc(e.hass)?.(t.entityId):void 0,S=t.entityId===""?h`<div class="hint">Type part of a name, a room, or an id.</div>`:c?h`<div class="entity-current">
    ...
    <div class="ent-box ${s?"open":""} ${r.needed&&t.entityId===""?"needs":""}">
      ...
      ${(s?s.query:t.entityId)===""?f:h`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
        ...
        @click=${k=>{let C=k.currentTarget.closest(".ent-box")?.querySelector("input")??null;i({entityId:"",displayName:"",domain:""}),an.set(a,{query:"",index:0}),ke(C),C?.focus()}}>${D("close")}</button>`}
    </div>
    ${s?h`<div class="entity-results" role="listbox">
          ${l.length===0?h`<div class="hint keep" style="padding:6px 8px">${Ic(s.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:l.map((k,C)=>h`<button type="button" role="option" aria-selected=${C===d?"true":"false"} class="ent ${C===d?"hl":""}"
                @mousedown=${z=>z.preventDefault()} @click=${z=>g(k,z.target)}>
                ...
                <span class="ent-right">
                  <span class="ent-type">${lc(k.domain)}</span>
                  <span class="ent-state">${k.state}</span>
                </span>
              </button>`)}
        </div>`:S}
  </div>`}function Hm(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var cc=120;function Lm(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(Ca.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Sa),fromPack:!1}}function uc(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function _m(e){return[{value:"",label:`Starter set (${uc(Sa,e)})`},...Ca.map(n=>({value:n.name,label:`${n.name} (${uc(n.symbols,e)})`}))]}function Pm(e){return e.length>0?e.length:Sa.length}function pc(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function Aa(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return h`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??h`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function Hc(e,n,t,i,a){let r=e.symbols,o=r.isOpen(i),s=r.query(i),l=e.icons.names(),d=l??[],c=new Set(d),u=n.trim(),p=u.startsWith(Ie),m=a!==void 0,g=m?r.pack(i)??(p?"mdi":"sf"):"sf",y=Nm(u,c),x=k=>{t(k),a?.(k.startsWith(Ie)?e.icons.mdiPath?.(k):void 0),r.noteUsed(k)},$=k=>{if(t(k),!m)return;let C=k.trim();a?.(C.startsWith(Ie)?e.icons.mdiPath?.(C):void 0)},S=f;if(o&&g==="mdi"){let k=e.icons.mdiNames?.(),C=zm(k??[],s),z=C.slice(0,cc),B=r.recent.filter(N=>N.startsWith(Ie));S=h`<div class="sym-browse">
      ${hc(r,i,g)}
      ...
      <div class="sym-grid">${z.map(N=>Aa(e,N,N===u,x))}</div>
      ${k===void 0?h`<div class="hint keep">Loading the Material Design catalogue.</div>`:C.length===0?h`<div class="hint keep">Nothing matches that search. Any<code>mdi:</code> name can still be typed above.</div>`:h`<div class="hint keep">${pc(z.length,C.length,!0,k.length)}</div>`}
    ...
    </div>`}else if(o){let k=r.category(i),C=Lm(k,s,d,c),z=$o(C.names,s),B=C.fromPack?z.slice(0,cc):z,N=r.recent.filter(T=>!T.startsWith(Ie)),J=c.size===0?N:N.filter(T=>c.has(T));S=h`<div class="sym-browse">
      ${m?hc(r,i,g):f}
      <div class="sym-controls">
        <input type="search" placeholder="Search symbols" .value=${s} @input=${ge(T=>r.setQuery(i,T))} />
        <select @change=${ge(T=>r.setCategory(i,T))}>
          ${_m(c).map(T=>h`<option value=${T.value} ?selected=${T.value===k}>${T.label}</option>`)}
        </select>
      </div>
      ...
      ${z.length===0?h`<div class="hint keep">Nothing matches that search. Anyname can still be typed above.</div>`:h`<div class="hint keep">
            ${pc(B.length,z.length,s.trim()!=="",Pm(d))}
          </div>`}
    ...
    ${S}`}function Nm(e,n){let t=e.trim();return t!==""&&!t.startsWith(Ie)&&n.size>0&&!n.has(t)}function zm(e,n){let t=n.trim(),i=t.startsWith(Ie)?t.slice(Ie.length):t,a=e.map(r=>r.startsWith(Ie)?r.slice(Ie.length):r);return $o(a,i).map(r=>Ie+r)}function hc(e,n,t){return h`<div class="seg wide" role="radiogroup" aria-label="Icon set">
  ...
  </div>`}var Om=[["literal","Fixed text"],["entityState","Entity state"],["entityAttribute","Entity attribute"],["entityAge","Time since entity changed"],["aggregate","Several entities combined"],["chartStat","Number from a chart"],["time","Clock and date"],["dataAge","Time since last refresh"],["jinja","Template (Jinja)"],["named","Shared value"]],Dm={literal:"Words or a number you type. It never changes.",entityState:"What Home Assistant shows for the entity, like 21.5 or on.",entityAttribute:"One detail the entity carries besides its state, like a light's brightness.",entityAge:"Seconds since the entity's state last changed. Set Seconds as, under Format, to read 5m instead of 300.",aggregate:"Count several entities, or take the sum, average, lowest or highest of their states.",time:"The time or date, read each time the complication refreshes.",dataAge:"Seconds since the watch last fetched values."},Vm=[["bars","Bars"],["line","Line"],["area","Area"]],Bm=[["auto","Auto"],["fixed","Fixed range"]],Um=[["lowest","Lowest value"],["zero","Zero"]],es=[["none","None"],["highest","Highest"],["lowest","Lowest"],["both","Both"]],mc=[["none","None"],["dot","Dot"],["triangle","Triangle"]],Wo=[["uniform","One colour"],["bands","By value"]];function Da(e){let n=[$r,"#FFD60A"];if(e.length<2)return n.map((o,s)=>({id:Y(),upTo:(s+1)*33,colorHex:o}));let t=Math.min(...e),a=Math.max(...e)-t,r=o=>Number(o.toFixed(a>=10?0:2));return n.map((o,s)=>({id:Y(),upTo:r(t+a*(s+1)/3),colorHex:o}))}function Gm(e){if(e.length===0)return 0;let n=Math.min(...e),t=Math.max(...e),i=t-n;return Number(((n+t)/2).toFixed(i>=10?0:2))}function Km(e,n){let t=Tt({bands:e}),i=t.at(-1),a=e.length>1?Math.abs(t[1].upTo-t[0].upTo):10;return{id:Y(),upTo:(i?.upTo??0)+(a||10),colorHex:n}}function Wm(e,n){let t=[...e].sort((l,d)=>l-d),i=t[0],a=t.at(-1),r=n!==void 0&&Number.isFinite(n)?n:void 0,o=(r??0)-1,s=(r??0)+1;if(i!==void 0&&a!==void 0){let l=(t.length>1?(a-i)/(t.length-1):Math.abs(i)/2)||1;o=i-l,s=a+l}return r!==void 0&&(o=Math.min(o,r),s=Math.max(s,r)),{lo:o,hi:s}}function jm(e,n,t){let{lo:i,hi:a}=Wm(e.map(l=>l.upTo),t),r=l=>Math.max(0,Math.min(100,(l-i)/(a-i)*100)),o=i,s=e.map(l=>{let d=Math.max(0,r(l.upTo)-r(o));return o=Math.max(o,l.upTo),h`<i style=${`width:${d}%;background:${l.colorHex}`}></i>`});return h`<div class="band-bar">
    ...
    ${Lc(e,a,r,n,t,i)}
  </div>`}function Lc(e,n,t,i,a,r){return h`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Pc}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${Ei.has(n)?Nc(e,i,a,r):f}
  </div>`}function ce(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Xa(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function ef(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Ei=new Set,ki=new WeakMap;function tf(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function _c(e,n,t=!1){let i=e instanceof Node?e:null;if(!i)return;let a=i.getRootNode();!(a instanceof ShadowRoot)&&!(a instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let r=a.querySelector(`#${CSS.escape(n)}`);r&&typeof r.showPopover=="function"&&!r.matches(":popover-open")&&r.showPopover(),r&&t&&requestAnimationFrame(()=>requestAnimationFrame(()=>{r.querySelector("textarea, input[type=text], input[type=search], input:not([type])")?.focus()}))}))}function Pc(e){let n=e.currentTarget,t=e.newState==="open",i=ki.get(n);if(i&&(i(),ki.delete(n)),!t){Ei.delete(n.id)&&ke(n);return}let a=tf(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){ki.get(n)?.(),ki.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}zo(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),ki.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),zo(n,a.getBoundingClientRect()),Ei.has(n.id)||(Ei.add(n.id),ke(n),requestAnimationFrame(()=>{n.isConnected&&zo(n,a.getBoundingClientRect())}))}function zo(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=nf({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var nn=8,Ia=6,gc=140;function nf(e,n,t){let i=t.height-e.bottom-Ia-nn,a=e.top-Ia-nn,r=n.height>i&&a>i&&i<gc,o=Math.max(gc,r?a:i),s=Math.min(n.height,o),l=Math.max(nn,Math.min(e.left,t.width-n.width-nn)),d=r?Math.max(nn,e.top-Ia-s):Math.max(nn,Math.min(e.bottom+Ia,t.height-s-nn));return{left:l,top:d,maxHeight:o,above:r}}function Nc(e,n,t,i){let a=n.kind,r=c=>t({...n,kind:c}),o=i.key,s=Om.filter(([c])=>i.allowNamed!==!1||c!=="named"),l=f;switch(a.kind){case"literal":l=i.symbol?Hc(e,a.value,c=>r({...a,value:c}),o,i.setSymbolPath):be("Text",a.value,c=>r({...a,value:c}));break;case"entityState":case"entityAge":l=it(e,"Entity",a,c=>r({...a,...c}),`${o}-entity`);break;case"entityAttribute":{let c=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),u=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;l=h`${it(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`)}
        ${be("Attribute",a.attribute,p=>r({...a,attribute:p}),{list:u,mono:!0})}
        <datalist id=${u}>${c.map(p=>h`<option value=${p}></option>`)}</datalist>`;break}case"aggregate":l=uf(e,a.aggregate,c=>r({...a,aggregate:c}),o);break;case"time":l=Le("Field",a.timeField,Zm,c=>r({...a,timeField:c}));break;case"dataAge":break;case"jinja":l=h`${Rc("Template",a.value,c=>r({...a,value:c}),4)}
        <div class="hint">Rendered by Home Assistant. The result should be one value, not a whole document.</div>`;break;case"named":{let c=e.config.values.find(p=>p.id===a.id),u=c?ui(e.config,c.id):0;l=e.config.values.length===0?h`<div class="hint keep">No shared values yet.
            <button type="button" class="link" @click=${()=>df(e,n,t)}>Start an empty one</button>,
          ...
          ${Le("Number",a.stat,[...pn],p=>r({...a,stat:p}))}
          <div class="hint">${a.stat==="top"||a.stat==="bottom"?"One end of the plot's range: what the tallest or shortest mark means. On a Fixed scale that is the Min or Max the chart was given.":"Read from the readings the chart draws, after any trim. Decimals follow the chart's spread; set Decimals below to override, and Add unit to print the entity's unit after it."}</div>`;break}}let d=Dm[a.kind];return h`
    ${Le("Source",a.kind,s,c=>r(Qm(a,c)))}
    ${d?h`<div class="hint">${d}</div>`:f}
    ${l}
    ${sf(n,i)?h`<div class="hint keep">
      <button type="button" class="link" title="Move this into a shared value that other layers can read too" @click=${()=>lf(e,n,t)}>Make shared</button>
      so other layers can read this too.</div>`:f}
    ${i.noFormat?f:cf(n.format,c=>t(Ce(c)?{kind:n.kind}:{...n,format:c}),rf(af(e,n)))}
    ${i.showResolved?of(e,n,e.resolve(i.resolveAs??n)):f}`}function af(e,n){let t=n.kind;for(let i=0;t.kind==="named"&&i<8;i++){let a=t.id.toUpperCase(),r=e.config.values.find(o=>o.id.toUpperCase()===a);if(!r)return;t=r.value.kind}return t.kind==="named"?void 0:t}function rf(e){if(!e)return{numbers:!0,textCase:!0,unit:!0,seconds:!0};switch(e.kind){case"literal":{let n=Ne(e.value)!==void 0;return{numbers:n,textCase:!n,unit:!1,seconds:n}}case"entityState":case"entityAttribute":case"jinja":case"named":return{numbers:!0,textCase:!0,unit:e.kind!=="jinja"&&e.kind!=="named",seconds:!0};case"entityAge":case"dataAge":return{numbers:!0,textCase:!1,unit:!1,seconds:!0};case"aggregate":return{numbers:!0,textCase:!1,unit:!1,seconds:!1};case"chartStat":{let n=e.stat==="trend";return{numbers:!n,textCase:!1,unit:!n,seconds:!1}}case"time":return{numbers:e.timeField!=="now",textCase:!1,unit:!1,seconds:!1}}}function of(e,n,t){let i=t===void 0?h`<span class="readout-v now-v none">${zc(e,n)}</span>`:t.trim()===""?h`<span class="readout-v now-v none">Empty</span>`:h`<span class="readout-v now-v"><span class="now-tok">${t}</span></span>`;return h`<div class="field readout now-field"><span>Now</span>${i}</div>`}function zc(e,n){let t=n.kind;switch(t.kind){case"entityState":case"entityAttribute":case"entityAge":return t.entityId===""?"Pick an entity":e.hass.states[t.entityId]?t.kind==="entityAttribute"&&t.attribute.trim()===""?"Pick an attribute":t.kind==="entityState"?"No reading":"Waiting for Home Assistant":"No such entity";case"chartStat":return t.layer===""?"Pick a chart":"The chart has no readings yet";case"named":{if(t.id==="")return"Pick a shared value";let i=t.id.toUpperCase(),a=e.config.values.find(r=>r.id.toUpperCase()===i);return a?zc(e,a.value):"That shared value is gone"}case"jinja":return t.value.trim()===""?"Type a template":"Waiting for Home Assistant";default:return"Waiting for Home Assistant"}}function sf(e,n){if(n.allowNamed===!1||n.noShare)return!1;let t=e.kind;return t.kind==="named"?!1:t.kind==="literal"||t.kind==="jinja"?t.value.trim()!=="":"entityId"in t?t.entityId!=="":t.kind==="chartStat"?t.layer!=="":!0}function lf(e,n,t){let i=Ri(n,ce(e)).replace(/^"(.*)"$/,"$1"),{named:a,ref:r}=Xr(e.config,n,Ve(i,24));e.beginGesture(),e.update(o=>{o.values.push(a)}),t(r),e.endGesture()}function df(e,n,t){let{named:i,ref:a}=Xr(e.config,{...n,kind:{kind:"literal",value:""}},"");i.name="",e.beginGesture(),e.update(r=>{r.values.push(i)}),t(a),e.endGesture(),e.selectValue(i.id)}function cf(e,n,t){let i=e??{},a=s=>{let l={...i,...s};for(let d of Object.keys(l))(l[d]===void 0||l[d]===!1||l[d]==="")&&delete l[d];n(l)},r=Ce(e),o={decimals:t.numbers||i.decimals!==void 0,multiply:t.numbers||i.multiply!==void 0,offset:t.numbers||i.offset!==void 0,textCase:t.textCase||i.textCase!==void 0,unit:t.unit||!!i.useEntityUnit,seconds:t.seconds||!!i.relativeTime||!!i.duration};return h`<details class="sub format" ?open=${!r}>
    <summary>Format${r?h`<span class="sum-note">as it comes</span>`:h`<span class="sum-note">${tu(e).replace(/^ \((.*)\)$/,"$1")}</span>`}</summary>
    <div class="grid2">
  ...
  </details>`}function uf(e,n,t,i){let a=s=>s.join(", "),r=s=>s.split(",").map(l=>l.trim()).filter(Boolean),o=n.scope;return h`
    ...
    ${n.function==="count"?f:be("Attribute (blank = state)",n.attribute??"",s=>{let l={...n};s?l.attribute=s:delete l.attribute,t(l)})}`}var Oc=zr,pf=Oc.filter(([e])=>e!=="none");function hf(e){if("entityId"in e)return{entityId:e.entityId,displayName:e.displayName,domain:e.domain};if(e.type==="callService")return e.target}function Dc(e,n){let t=hf(n)??{entityId:"",displayName:"",domain:""};if(e==="callService"){let i=n.type==="callService"?{...n}:{type:"callService",serviceDomain:"",serviceName:""};return t.entityId!==""&&(i.target=t),i}return xl(e)?{type:e,...t}:{type:e}}var mf=[["Open a cover","cover","open_cover",""],["Close a cover","cover","close_cover",""],["Stop a cover","cover","stop_cover",""],["Lock","lock","lock",""],["Unlock","lock","unlock",""],["Light brightness","light","turn_on",'{"brightness_pct": 50}'],["Climate target","climate","set_temperature",'{"temperature": 21}'],["Play / pause","media_player","media_play_pause",""],["Start a vacuum","vacuum","start",""],["Send a vacuum home","vacuum","return_to_base",""]];function Vc(e,n,t,i){let a=n.serviceDataJSON??"",r=wl(a),o=n.target??{entityId:"",displayName:"",domain:""};return h`
    <div class="gen-row">
    ...
    <div class="gen-row">
      ...
      <div class="field flash-cell"><span title="Flash when a tap works">Flash</span>
        <div class="flash-row">
          ...
          ${o?h`<input type="color" class="flash-color" title="Flash colour. Click to change it." .value=${(n.successFlashColorHex??gf).slice(0,7)}
    ...
    ${t.type==="openPage"?yf(e):f}`}var gf="#808080",yc=[0,15,30,60,120];function bc(e){return e===0?"None":e%60===0?e===60?"Every hour":`Every ${e/60} hours`:e===1?"Every minute":`Every ${e} minutes`}function yf(e){let n=e.config;return Uc(e,n.openPageId,n.openPageName,(t,i)=>e.update(a=>{if(t===void 0){delete a.openPageId,delete a.openPageName;return}a.openPageId=t,i?a.openPageName=i:delete a.openPageName}))}function Uc(e,n,t,i){let a=n??"",r=e.pages.map(o=>[o.id,o.name||"Unnamed page"]);return a&&!e.pages.some(o=>o.id.toUpperCase()===a.toUpperCase())&&r.unshift([a,`${t||"Unknown page"} (not on the watch)`]),a||r.unshift(["","Choose a page\u2026"]),r.length<=1&&!a?h`<div class="hint keep">No pages reported yet. Open the watch app once so it can send its page list.</div>`:h`${Le("Page",a,r,o=>{if(!o){i(void 0,void 0);return}i(o,e.pages.find(s=>s.id===o)?.name)})}
  ${a?f:h`<div class="hint keep">Without a page the tap falls back to the complication list.</div>`}`}function Gc(e,n){let t=e.config.values.findIndex(o=>o.id===n.id),i=`nv-${n.id}`,a=ui(e.config,n.id),r={kind:{kind:"named",id:n.id}};return h`
    ...
    <div class="field readout"><span>Used by</span><span class="readout-v">${a===0?"No layers yet":`${a} ${a===1?"layer":"layers"}`}</span></div>`}function Kc(){return{id:Y(),name:"",value:A("")}}function Ee(e,n,t){let i=e.perFamily[n],a=i?.placements[t.payload.id];return i&&Object.keys(i.placements).length>0&&a?{frame:a.frame,isHidden:a.isHidden,size:a.size,fromPlacement:!0}:{frame:t.payload.frame,isHidden:t.payload.isHidden,fromPlacement:!1}}function Te(e,n,t,i,a=!1){let r=e.elements.find(c=>c.payload.id===t);if(!r)return;let o=e.perFamily[n];o||(o={placements:{},cornerBodyShape:"circle",borderWidth:2,rules:[]},e.perFamily[n]=o);let s=Ee(e,n,r),d={...o.placements[t]??{frame:{...s.frame},isHidden:s.isHidden,...s.size!==void 0?{size:s.size}:{}},...i};a&&delete d.size,o.placements[t]=d}function Ha(e,n,t,i,a){let r=n.payload.id,o=ea(n)??a.min,s=Ee(e.config,t,n).size??o;return ae(i,s,l=>e.update(d=>Te(d,t,r,{size:Math.max(a.min,l??o)}),`el-${r}-size-${t}`),{step:a.step,min:a.min,unit:"pt",...a.def===void 0?{}:{def:a.def}})}function Wc(e,n,t){let i=e.perFamily[t]??(e.perFamily[t]=ht()),a=Je(e,n).filter(l=>!me(e,l));if(a.length===0)return;let r=$n(e,a.map(l=>l.payload.id),n),o=Bt(e,r,{nudge:!1}),s=e.perFamily[n];for(let l of o){let d=e.elements.find(m=>m.payload.id===l);if(!d)continue;let c=s?.placements[l],u=c?.size??ea(d),p={frame:{...c?.frame??d.payload.frame},isHidden:c?.isHidden??!1,...u!==void 0?{size:u}:{}};for(let m of ne)m!==t&&delete e.perFamily[m]?.placements[l];i.placements[l]=Gr(p,n,t,d.kind)}Cn(e,t)}function Ja(e,n){return Dl(e,n)}function bf(e){return e.length===0?"none":e.every(n=>n)?"all":e.every(n=>!n)?"none":"mixed"}function vf(e){return e.kind==="image"||e.kind==="tap"||e.kind==="timeline"?void 0:e.payload.colorSlot.baseColorHex}function jc(e,n,t){let i=bf(t.map(l=>Ee(e,n,l).isHidden)),a=t.map(vf),r=t.length>0&&a.every(l=>l!==void 0),o=a[0],s=r&&o!==void 0&&a.every(l=>l!==void 0&&l.toUpperCase()===o.toUpperCase());return{hiddenHere:i,colourable:r,colour:s?o:void 0}}var An=[["regular","Regular"],["medium","Medium"],["semibold","Semibold"],["bold","Bold"]],xf=[["leading","Left"],["center","Center"],["trailing","Right"]],wf=[["1","1"],["2","2"]];function qc(e,n,t){let i=n.payload.id,a=ia(e.config,i),r=a[0]?.ref??{entityId:"",displayName:"",domain:""},o=n.kind==="image"&&n.payload.source==="camera",s={...o?{domain:"camera"}:{},needed:vc(n)},l=d=>{let c=e.hass.states[d]?.attributes?.device_class;return typeof c=="string"?c:void 0};return h`
    ${it(e,o?"Camera":"Entity",r,d=>e.update(c=>Vl(c,i,d,l(d.entityId)),`${t}-entity`),`${t}-layer-entity`,s)}
    <div class="hint ${vc(n)?"warn":""}">${$f(n,a)}</div>`}function vc(e){return e.kind==="timeline"?e.payload.value.kind.kind!=="entityState":e.kind==="chart"?e.payload.historyMinutes>0&&e.payload.value.kind.kind!=="entityState":e.kind==="image"?e.payload.entity.entityId==="":!1}function kf(e){if(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline")return e.payload.value;if(e.kind==="icon")return e.payload.symbol}function Za(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function $f(e,n){let t=kf(e),i=t?.kind.kind,r=t!==void 0&&!("entityId"in t.kind)&&!(i==="literal"&&(e.kind==="text"||e.kind==="gauge"||e.kind==="chart"||e.kind==="timeline"))?i==="named"?" Its content comes through a shared value, so change that shared value to point it somewhere else.":i==="chartStat"?" Its number comes from a chart, so point the chart somewhere else to change it.":e.kind==="icon"&&i==="literal"?" The symbol above is a fixed name and stays as it is.":" The value above was written by hand and stays as it is.":"";if(n.length===0)return e.kind==="shape"?"A shape draws no value, so an entity reaches it only through a tap. Tick Tappable below, then choose the entity here.":`Nothing on this layer reads an entity yet. Choosing one points the layer, and its tap, at it.${r}`;let o=[],s=n.find(d=>d.where==="value"||d.where==="symbol"||d.where==="camera");s&&o.push(s.where==="symbol"?"the symbol":s.where==="camera"?"the picture":e.kind==="gauge"?"the reading":e.kind==="chart"?"the readings":e.kind==="timeline"?"the states":"the text"),n.some(d=>d.where==="tap")&&o.push("the tap");let l=n.filter(d=>d.where==="test").length;return l>0&&o.push(l===1?"1 state test":`${l} state tests`),`Used by ${Za(o)}.${r}`}function Cf(e){return e.zoom<1?"Below 1x the picture pulls away from the frame and the spare edges are left empty. Pan still moves whatever does overflow.":e.contentMode==="fit"&&e.zoom===1?"The whole picture is inside the frame, so there is nothing to pan. Zoom in, or switch to Fill, to crop it first.":"Pan moves the frame over the picture: -1 is hard left (or top), 1 is hard right (or bottom). An edge the picture does not overflow cannot move."}function Sf(e,n){let t=e.timestamp===!0,i=dt(e),a=r=>n(o=>{r?(o.timestampX=o.timestampCorner.endsWith("Leading")?.16:.84,o.timestampY=o.timestampCorner.startsWith("top")?.16:.84):(dt(o)&&(o.timestampCorner=Pr(o.timestampX,o.timestampY)),delete o.timestampX,delete o.timestampY)});return h`
  ...
  </section>`}function Tf(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Ef(e){if(e<60)return`${Math.max(0,Math.round(e))}s`;let n=Math.round(e/60);if(n<90)return`${n}m`;let t=Math.floor(n/60),i=n%60;return i===0?`${t}h`:`${t}h ${i}m`}function Mf(e,n){let t=le[e==="inline"?"rectangular":e],i=n.height*t.height>n.width*t.width,a=Math.round((n.rotationDegrees%180+180)%180)===90;return i!==a}function Rf(e,n,t){let i=Mf(e,n),a=le[e==="inline"?"rectangular":e],r=n.height*a.height>n.width*a.width;return h`<div class="grid2">
  ...
  <div class="hint">Direction sets the frame's rotation. A line runs along the frame's long side, so
    for a thin divider make the frame long in one direction and Direction will follow it.</div>`}function Ff(e){let n=e.filter(i=>i.state!=="unavailable"&&i.state!=="unknown");return n.length===0?!1:n.filter(i=>i.state.trim()!==""&&Number.isFinite(Number(i.state))).length*2>n.length}function Af(e,n,t=4){if(e.length===0)return"nothing";let i=[];for(let o=0;o<e.length;o++){let s=e[o],l=e[o+1]?.offsetSeconds??n,d=Math.max(0,l-s.offsetSeconds),c=i[i.length-1];c!==void 0&&c.state.trim().toLowerCase()===s.state.trim().toLowerCase()?c.seconds+=d:i.push({state:s.state,seconds:d})}let a=i.slice(-t),r=a.map(o=>`${o.state||"(blank)"} ${Ef(o.seconds)}`).join(", ");return i.length>a.length?`\u2026 ${r}`:r}function In(e,n=Gt){let t=n.find(s=>s.minutes===e);if(t)return t.label;let i=Math.floor(e/1440),a=Math.floor(e%1440/60),r=e%60,o=[];return i>0&&o.push(`${i}d`),a>0&&o.push(`${a}h`),(r>0||o.length===0)&&o.push(`${r}m`),`Last ${o.join(" ")}`}var za=new Set;function jo(e,n,t=Gt){return za.has(e)||!t.some(i=>i.minutes===n)}function Do(e,n,t,i,a=Gt){let r=jo(e,n,a);return h`<label class="field">${_e("Span",{atDefault:n===t&&!r,title:`Back to ${In(t,a)}`,reset:()=>{za.delete(e),i(t)}})}
      <select @change=${o=>{let s=o.target.value;s==="custom"?(za.add(e),ke(o.target)):(za.delete(e),i(Number(s)||ji))}}>
        ${a.map(({minutes:o,label:s})=>h`<option value=${String(o)} ?selected=${!r&&o===n}>${s}</option>`)}
        <option value="custom" ?selected=${r}>Custom…</option>
      </select></label>`}function Vo(e,n,t=!1){let i=t?Sr:qi,a=Math.floor(i/1440),r=t?ii:Gt,o=Math.floor(e/1440),s=Math.floor(e%1440/60),l=e%60,d=(c,u,p)=>n(Math.min(i,Math.max(1,Math.round(c)*1440+Math.round(u)*60+Math.round(p))));return h`<div class="grid3 span-parts">
    ...
    <div class="hint">${t?h`${In(e,r)}, up to 366 days. Statistics rows are never
          ...
          ten by default, and a longer span would quietly come back short.`}</div>`}function If(e){if(e.historyMinutes<=0)return"";if(e.source!=="statistics")return` \xB7 ${In(e.historyMinutes)}`;let n=Ui.find(([t])=>t===e.statPeriod)?.[1]??e.statPeriod;return` \xB7 ${In(e.historyMinutes,ii)} \xB7 per ${n.toLowerCase()}`}function ts(e,n){let t=ce(e);switch(n.kind){case"text":{let i=n.payload.parts?.length??0;return lt(n.payload)?`Rich text, ${i} part${i===1?"":"s"}`:Ve($e(n.payload.value,t),48)}case"icon":return Ve($e(n.payload.symbol,t),48);case"gauge":return Ve($e(n.payload.value,t),48);case"chart":return Ve(`${$e(n.payload.value,t)}${If(n.payload)}`,48);case"timeline":return Ve(`${$e(n.payload.value,t)} \xB7 ${In(Ye(n.payload))}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||(n.payload.source==="camera"?"No camera yet":"No entity yet");case"tap":return ct(n.payload.action)}}function Ua(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${He(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${He(e.payload.colorSlot.baseColorHex)}`;case"gauge":{let n=e.payload,t=n.style==="dots"?`${n.bands.length>0&&n.coloring==="bands"?"banded":He(n.colorSlot.baseColorHex)} dots`:`${n.lineWidth} pt line \xB7 ${n.coloring==="bands"&&n.bands.length>0?`${n.bands.length+1} colour bands`:He(n.colorSlot.baseColorHex)}`;return`${n.style} \xB7 ${t}${n.thresholdValue===void 0?"":` \xB7 threshold ${n.thresholdValue}`}`}case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${es.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"timeline":{let n=e.payload;return`${n.bands.length===0?`one colour (${He(n.otherColorHex)})`:`${n.bands.length} ${n.bands.length===1?"state":"states"} coloured`}${n.gap>0?` \xB7 ${n.gap} pt gap`:""} \xB7 corners ${n.cornerRadius} pt`}case"shape":return e.payload.kind==="line"?`${He(e.payload.colorSlot.baseColorHex)} \xB7 ${e.payload.thickness} pt thick`:`${He(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function $i(e,n,t,i,a,r){let o=Math.round(t*1e3)/10,s=l=>i(l/100);return h`<label class="pf">
    ...
    <span class="unit" aria-hidden="true">%</span>
  </label>`}function Hf(e,n,t){let i=n.payload.id,a=`el-${i}`,r=Ee(e.config,t,n),o=r.frame,s=(c,u)=>e.update(p=>Te(p,t,i,{frame:Fo(o,c)}),`${a}-${u}-${t}`),l=!Ba(o,ti)||r.isHidden,d=n.payload.chartAnchor;return xe(e,"placement","Position",h`
    ${Lf(e,n,t)}
    ${d===void 0?h`
    <div class="field xy-field"><span>Position</span>
      <div class="xy">
        ${$i("X","Left",o.x,c=>s({x:c},"x"),-100,100)}
        ${$i("Y","Top",o.y,c=>s({y:c},"y"),-100,100)}
      </div>
    </div>`:!St(d.at)&&d.place!=="through"?h`
    <div class="field xy-field"><span>Position</span>
      <div class="xy">
        ${$i("X","Left",o.x,c=>s({x:c},"x"),-100,100)}
      </div>
    ...
    <div class="field xy-field"><span>Size</span>
      <div class="xy">
        ${$i("W","Width",o.width,c=>s({width:c},"w"),4,200)}
        ${$i("H","Height",o.height,c=>s({height:c},"h"),4,200)}
      </div>
    </div>
    ${Ti("Rotation",o.rotationDegrees,c=>s({rotationDegrees:c},"rot"),{min:-180,max:180,step:1,def:0,format:c=>`${Math.round(c)}\xB0`,unit:"\xB0",range:!1})}
    ${Be("Hidden",r.isHidden,c=>e.update(u=>Te(u,t,i,{isHidden:c})),!1)}
    <div class="hint">${d===void 0?"X, Y, W and H are":"W and H are"} a percent of the face, on the ${te(t)} shape only. Drag a letter left or right to change its number. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:Q.position,icon:"place",summary:`${Math.round(o.width*100)}% wide \xB7 ${te(t)}`,...l?{resetTitle:`Put this layer back to the middle of the ${te(t)} face at half size, unrotated and shown`,reset:()=>e.update(c=>Te(c,t,i,{frame:{...ti},isHidden:!1}))}:{}})}function Lf(e,n,t){let i=n.payload.chartAnchor;if(i===void 0)return f;let a=n.payload.id,r=`el-${a}-anchor`,o=e.config.elements.filter(c=>c.kind==="chart"),s=(c,u)=>e.update(p=>{let m=p.elements.find(g=>g.payload.id===a);m?.payload.chartAnchor&&c(m.payload.chartAnchor)},u?`${r}-${u}`:void 0),l=ce(e),d=!o.some(c=>c.payload.id===i.layer);return h`
    ${o.length<2?f:Le("Follows",i.layer,o.map(c=>[c.payload.id,Me(c,l)]),c=>s(u=>{u.layer=c}))}
    ${Z("Reading",i.at,hn,c=>s(u=>{u.at=c}),{def:"highest"})}
    ...
    ${d?h`<div class="hint keep">The chart this followed is not in this document any more, so the layer
          ...
          bar is pushed down rather than off the top, and the bars never give up height to make room.</div>`}`}function _f(e,n){if(n.kind==="tap")return f;let t=n.payload.id,i=Pe(e.config,t)[0];return xe(e,"tappable","Tap",sg(e,n,`el-${t}`),{color:Q.tap,icon:"tap",summary:i?ct(i.payload.action):"Not tappable",...i?{reset:()=>e.update(a=>na(a,t))}:{}})}function wc(e,n,t,i,a){return h`
    ${Ti("Times",e.timeLabelCount,r=>n(o=>{o.timeLabelCount=Math.max(0,Math.min(oi,Math.round(r)))},`${i}count`),{min:0,max:oi,step:1,def:t.timeLabelCount,format:r=>r<=0?"None":String(Math.round(r)),range:!1})}
    ${e.timeLabelCount<=0?f:h`
      <div class="grid2">
        ${ae("Time size",e.labelSize,r=>n(o=>{o.labelSize=Math.min(li,Math.max(si,r??$t))},`${i}size`),{step:.5,min:si,max:li,def:t.labelSize,unit:"pt"})}
      ...
      ${Z("Clock",e.hourCycle,fl,r=>n(o=>{o.hourCycle=r}),{titles:{auto:"Whatever clock the watch is set to"},def:t.hourCycle})}
      ${Z("Minutes",e.minutes,gl,r=>n(o=>{o.minutes=r}),{titles:{auto:"Kept up to a three hour span, dropped past it"},def:t.minutes})}
      ${a}`}`}var Pf=[["number","Number"],["entity","Entity"]];function Nf(e,n){return(n==="min"?e.minSource:e.maxSource)===void 0?"number":"entity"}function zf(e,n,t){let i=n==="min"?"minSource":"maxSource";t==="number"?delete e[i]:e[i]===void 0&&(e[i]={kind:{kind:"entityState",entityId:"",displayName:"",domain:""}})}function Of(e,n,t,i,a){let r=o=>{let s=o==="min",l=s?"Min":"Max",d=Nf(n,o),c=s?n.minValue:n.maxValue,u=y=>a(x=>{s?x.minValue=y??0:x.maxValue=y??100},o),p={number:`${l} is a fixed number`,entity:`${l} reads a number from an entity`},m=h`<div class="gauge-end-head">
    ...
    ${r==="none"?f:h`
      <div class="grid2">
        ${r==="lowest"?f:de("Highest colour",n.highColorHex??Re,c=>s("highColorHex",Re,c),!1,Re)}
        ${r==="highest"?f:de("Lowest colour",n.lowColorHex??Fe,c=>s("lowColorHex",Fe,c),!1,Fe)}
      </div>
      ${a==="bands"?f:h`<div class="hint">${l}, and other text keeps the layer colour.</div>`}`}`}var Si=new Map,Ci=new Map,ft=new Map,La=new Map,Bo=4,Uo=40,Vf=[["layer","Layer"],["pick","Pick"],["bands","By value"]],Bf=[["plain","Plain"],["rich","Rich"]],Uf={plain:"One line: typed words, a live value or a template",rich:"Parts, each with its own colour, weight and size"};function ns(e,n,t,i){let a=t!==void 0&&e.canCountDown(t);return!n&&!a?f:h`${Be("Count down",n,i)}
    ...
    ${n&&!a?h`<div class="hint warn">This value is not a timer or a future time, so nothing counts down. The watch shows it as plain text.</div>`:f}`}function Gf(e){return e.countdown===!0?"countdown":lt(e)?"rich":"plain"}function Kf(e){return(e.match(/ +|[^ ]+/g)??[]).map(n=>({text:n,space:n.startsWith(" ")}))}function Wf(e,n){let t=mn(e);return t!==void 0?{kind:"text",label:t}:e.kind.kind==="jinja"?{kind:"template",label:Ve(e.kind.value,40)||"template"}:{kind:"value",label:Ri(e,n)}}function Yc(e,n,t){let i=mn(e.value),a=i===void 0?Ve(Ri(e.value,t),28):i.trim()===""?i===""?"empty":"spaces":`"${Ve(i,24)}"`;return`Part ${n+1}: ${a}`}function jf(e,n,t){let i=[["","Whole text"],...e.map((a,r)=>[a.id,Yc(a,r,t)])];return n!==void 0&&!e.some(a=>a.id===n)&&i.push([n,"A part that is gone"]),i}function qo(e){return e.coloring==="bands"?"bands":e.colorHex===void 0?"layer":"pick"}function qf(e,n){if(qo(e)==="bands"&&(e.bands?.length??0)>0){let t=[...Tt({bands:e.bands}).map(r=>r.colorHex),e.bandAboveColorHex??ie],i=100/t.length,a=r=>`${Math.round(r*10)/10}%`;return`conic-gradient(${t.map((r,o)=>`${r} ${a(o*i)} ${a((o+1)*i)}`).join(", ")})`}return e.colorHex??n}function kc(e){let n=r=>r.length===1?`Part ${r[0].index+1}`:`Parts ${Za(r.map(o=>String(o.index+1)))}`,t=e.filter(r=>r.reason==="kind"),i=e.filter(r=>r.reason==="format"),a=[];return t.length>0&&a.push(`${n(t)} ${t.length===1?"shows":"show"} a value a template cannot read, such as data age or a chart's number.`),i.length>0&&a.push(`${n(i)} ${i.length===1?"uses":"use"} a relative time or duration format, which a template cannot print.`),`Rich text stays on, because the parts cannot join into one line. ${a.join(" ")} Change or remove ${e.length===1?"that part":"those parts"} first.`}var Yf={fontSize:"font size",fontWeight:"weight",color:"colour",bands:"colour bands"};function Xf(e){return e.joined?e.template?"Rich text is off. The parts joined into one template, so the live values still update.":"Rich text is off. The parts joined into one line of text.":e.moved.length===0?"Rich text is off.":`Rich text is off. The part's ${Za(e.moved.map(n=>Yf[n]))} moved into Look.`}function Jf(e,n,t,i,a){let r=n.payload,o=r.id,s=Gf(r),l=(r.parts?.length??0)>0,d=Or(e.config,r.value),c=ft.get(o),u=c&&c.rich===l?c:void 0,p=s==="rich"&&(r.parts?.length??0)>=2?Ci.get(o):void 0,m=(x,$)=>{let S=!(r.parts??[]).every(C=>C.value.kind.kind==="literal"),k=Fa(structuredClone(r),e.config.values);if(Ci.delete(o),!k.ok){ft.set(o,{text:kc(k.blocked),rich:!0,warn:!0}),ke($);return}ft.set(o,{text:Xf(k.joined?{joined:!0,template:S}:k),rich:!1}),i(C=>{Fa(C,e.config.values),x==="countdown"&&(C.countdown=!0)})},g=(x,$)=>{if(Ci.delete(o),s==="rich"){let S=x==="countdown"?"countdown":"plain",k=r.parts??[];if(k.length<2){m(S,$);return}let C=_o(k,e.config.values);C.ok?(ft.delete(o),Ci.set(o,S)):ft.set(o,{text:kc(C.blocked),rich:!0,warn:!0}),ke($);return}if(x==="rich"){let S=r.parts?.[0]?.id??Y();Si.set(o,S),ft.delete(o),i(k=>{delete k.countdown,sc(k,S)});return}ft.delete(o),i(S=>{if(x==="countdown"){S.countdown=!0;return}(S.parts?.length??0)>0&&Fa(S,e.config.values),delete S.countdown})},y=p==="countdown"?"Switch to Countdown?":"Switch to Plain?";return h`
    ${Z("Type",s==="rich"?"rich":"plain",Bf,g,{titles:Uf})}
    ...
    ${p===void 0?f:h`<div class="rich-confirm" role="alertdialog" aria-label=${y}>
        ...
        <div class="acts">
          ...
          <button class="small" @click=${x=>{Ci.delete(o),ke(x.currentTarget)}}>Keep Rich</button>
        </div>
      </div>`}
    ${u?h`<div class=${u.warn?"hint warn":"rich-note"}>${u.text}</div>`:f}
    ${s==="rich"?Zf(e,n,t,i,a):h`
        ${qc(e,n,a)}
        ...
        ${d?h`<div class="hint keep">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(d.payload.id)}>${Me(d,ce(e))}</button>. It stays in the chart's group and moves with it.</div>`:f}`}`}function Zf(e,n,t,i,a){let r=n.payload,o=r.parts??[],s=r.id,l=ce(e),d=Math.max(0,o.findIndex(R=>R.id===Si.get(s))),c=o[d],u=o.length,p=r.colorSlot.baseColorHex,m=Ee(e.config,t,n).size??r.fontSize,g=(R,b)=>{ft.delete(s),i(v=>{R(v),ll(v)},b)},y=(R,b)=>g(v=>{let M=v.parts?.find(E=>E.id===c.id);M&&R(M)},b?`part-${c.id}-${b}`:void 0),x=(R,b)=>{Si.set(s,R),ft.delete(s),ke(b)},$=(R,b)=>{let v=Y();Si.set(s,v),g(M=>{(M.parts??=[]).push({id:v,value:R})}),_c(b,Xa(`${a}-part-${v}`),!0)},S=R=>g(b=>{b.parts&&Mi(b.parts,d,R)}),k=()=>{let R=o[d+1]??o[d-1];R&&Si.set(s,R.id),g(b=>{b.parts=(b.parts??[]).filter(v=>v.id!==c.id)})},C=o.map((R,b)=>{let v=Wf(R.value,l),M=R.id===c.id,E=qo(R),L=v.kind==="value"?e.resolve(R.value):void 0,V=R.fontWeight===void 0?void 0:An.find(([K])=>K===R.fontWeight)?.[1];return h`<button type="button" role="option" aria-selected=${M?"true":"false"} class="part-chip ${v.kind} ${M?"on":""}"
      aria-label=${Yc(R,b,l)} @click=${K=>x(R.id,K.currentTarget)}>
      <span class="part-dot" style=${`background:${qf(R,p)}`}
        title=${E==="bands"?"By value, with its own bands":E==="pick"?"Its own colour":"The layer colour"}></span>
      ${v.kind==="text"?h`<span class="part-txt">${v.label===""?h`<span class="part-empty">empty</span>`:Kf(v.label).map(K=>K.space?h`<span class="part-sp">${"\xB7".repeat(K.text.length)}</span>`:K.text)}</span>`:h`<span class="part-txt">${v.label}</span>`}
    ...
    </button>`}),z=r.rules.some(R=>R.partId===c.id),B=c.value.kind.kind==="literal",N=qo(c),J=c.fontSize!==void 0,T=An.find(([R])=>R===r.fontWeight)?.[1]??r.fontWeight,U=R=>{R>=Bo&&R<=Uo&&y(b=>{b.fontSize=R},"size")},X=N==="bands"?Qe(e.resolve(c.value)??""):[],G={layer:"Use the layer colour",...B&&N!=="bands"?{bands:"By value needs a live value"}:{}},pe=(R,b)=>y(v=>{let M={bands:v.bands??[],bandAboveColorHex:v.bandAboveColorHex??ie};R(M),M.bands.length>0?v.bands=M.bands:delete v.bands,M.bandAboveColorHex!==ie?v.bandAboveColorHex=M.bandAboveColorHex:delete v.bandAboveColorHex},b);return h`<div class="rich-parts">
    <div class="field parts-field"><span>Parts</span>
      ...
      <div class="part-adds">
        <button type="button" class="small" title="Add a part of typed words"
          @click=${R=>$(A(""),R.currentTarget)}>${D("text")}<span>Add text</span></button>
    ...
    <div class="part-editor">
      ...
      ${se(e,c.value,R=>y(b=>{b.value=R},"value"),{showResolved:!0,label:B?"Text":"Shows",key:`${a}-part-${c.id}`})}
      ...
      ${Z("Colour",N,Vf,R=>y(b=>{if(R==="layer"){delete b.colorHex,delete b.coloring;return}if(R==="pick"){delete b.coloring,b.colorHex=Zo(p,"#FFFFFF")?"#64D2FF":p;return}delete b.colorHex,b.coloring="bands",(b.bands?.length??0)===0&&(b.bands=Da(Qe(e.resolve(b.value)??"")))}),{def:"layer",titles:G,...B&&N!=="bands"?{disabled:{bands:!0}}:{}})}
      ${N==="pick"?de("Part colour",c.colorHex,R=>y(b=>{b.colorHex=R??p},"color")):f}
      ${N==="bands"?h`
      ...
      <div class="field seg-field">${_e("Weight",c.fontWeight===void 0?void 0:{atDefault:!1,title:`Back to the layer weight (${T})`,reset:()=>y(R=>{delete R.fontWeight})})}
        ${Oa("Weight",c.fontWeight,An,R=>y(b=>{b.fontWeight=R}),{inherited:r.fontWeight})}
      </div>
      <label class="field num part-size">${_e("Font size",J?{atDefault:!1,title:`Back to the layer size (${m} pt)`,reset:()=>y(R=>{delete R.fontSize})}:void 0,ja(c.fontSize??m,U,{step:1,min:Bo,max:Uo}))}
        ${qa(c.fontSize,R=>{R===void 0?y(b=>{delete b.fontSize},"size"):U(R)},{step:1,min:Bo,max:Uo,optional:!0,unit:"pt",placeholder:String(m),ariaLabel:J?"Part font size":`Part font size, ${m} pt from the layer`,...J?{}:{lead:D("link")}})}
      </label>
    </div>
  </div>`}function Xc(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(b=>b.payload.id===a),o=`el-${a}`,s=(b,v)=>e.update(M=>b(M.elements[r]),v?`${o}-${v}`:void 0),l=Ee(e.config,t,n),d=l.frame,c=(b,v)=>e.update(M=>Te(M,t,a,{frame:Fo(d,b)}),`${o}-${v}-${t}`),u=De(n.kind).payload,p=u.colorSlot?.baseColorHex??"#FFFFFF",m=b=>u[b],g=!1,y=b=>n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?f:de(b,n.payload.colorSlot.baseColorHex,v=>s(M=>{M.kind!=="image"&&M.kind!=="tap"&&M.kind!=="timeline"&&(M.payload.colorSlot.baseColorHex=v??"#FFFFFF")},"color"),!1,p),x,$;switch(n.kind){case"text":{let b=(v,M)=>s(E=>v(E.payload),M);x=Jf(e,n,t,b,o),g=!n.payload.countdown&&!lt(n.payload),$=h`
        ...
        ${Em({label:"Align",value:n.payload.alignment??"center",options:xf,def:"center",set:v=>s(M=>{let E=M.payload;v==="center"?delete E.alignment:E.alignment=v})},{label:"Lines",value:n.payload.lineLimit===2?"2":"1",options:wf,def:"1",set:v=>s(M=>{let E=M.payload;v==="2"?E.lineLimit=2:delete E.lineLimit})})}
        ...
        ${g?Df(e,n.payload,b,y("Main colour")):f}`;break}case"icon":x=h`
        ...
        ${M?h`
            ${se(e,b.total??fc(b),E=>v(L=>{L.total=E},"total"),{showResolved:!0,label:"Total",key:`${o}-total`})}
            <div class="hint">How many dots to draw. Left as it is, a count of the same
              ...
              total over one scope. At most ${Ki} dots are drawn.</div>`:Of(e,b,{min:u.minValue,max:u.maxValue},o,v)}`,g=!0,$=h`
        <div class="grid2">
          ${Z("Style",b.style,Xm,E=>v(L=>{E==="dots"&&L.total===void 0&&(L.total=fc(L)),E!=="dots"&&delete L.total,L.style=E}),{titles:Jm,def:u.style})}
        ...
        ${M?f:h`
          ...
          <div class="hint">A short tick on the scale at that value, so the fill reads
            ...
            nothing. Leave it empty for no mark.</div>`}`;break}case"chart":{let b=n.payload,v=(H,O)=>s(ln=>H(ln.payload),O),M=qe(b),E=kr(u.marker),L=u.historyMinutes,V=u.historyPoints,K=b.historyMinutes>0,fe=K&&b.source==="statistics",at=K&&!fe,Ln=K?fe?"statistics":"history":"value",_n=fe?ii:Gt,we=Kt(b)??Wt(b),he=b.value.kind.kind==="entityState",rt=we===void 0?void 0:e.historySeries(we),Pu=K&&he?rt??"":e.resolve(b.value)??"",ot=b.historyPoints<1,gs=jo(a,b.historyMinutes,_n),We=Qe(Pu),Nt=b.limit>0&&We.length>b.limit?b.takeFromEnd?We.slice(We.length-b.limit):We.slice(0,b.limit):We,Nu=!K&&he&&We.length===1,tr=e.config.elements.filter(H=>H.kind==="chart"&&H.payload.id!==a),zu=ce(e),nr=b.scaleFrom!==void 0&&tr.some(H=>H.payload.id===b.scaleFrom);x=h`
        ${se(e,b.value,H=>v(O=>{O.value=H},"value"),{label:"Readings",noShare:!0,key:`${o}-value`})}
        ${Z("Draw",Ln,[["history","Recorded history"],["statistics","Long-term statistics"],["value","The value itself"]],H=>v(O=>{if(H==="value"){O.historyMinutes=0;return}O.source=H==="statistics"?"statistics":"history";let ln=O.historyMinutes||ji;O.historyMinutes=H==="statistics"?Math.min(ln,Sr):Math.min(ln,qi)}),{titles:{history:"Read the entity's recorded states from the recorder and plot them",statistics:"Plot the recorder's pre-aggregated rows, which reach back a year",value:"Plot the numbers the value holds right now, such as a forecast list"},def:u.historyMinutes>0?"history":"value"})}
        ${fe?h`
            ...
            <div class="grid2">
              ${Do(a,b.historyMinutes,L,H=>v(O=>{O.historyMinutes=H}),ii)}
              ${Z("Per",b.statPeriod,Ui,H=>v(O=>{O.statPeriod=H}),{def:Qn})}
            </div>
            ${gs?Vo(b.historyMinutes,H=>v(O=>{O.historyMinutes=H},"span"),!0):f}
            ${Z("Read",b.statType,vr,H=>v(O=>{O.statType=H}),{def:ei})}
        ...
        ${at?h`
            ${he?f:h`<div class="hint warn">History needs an entity.
              ...
              draws the value itself until Readings names an entity.</div>`}
            <div class="grid2">
              ${Do(a,b.historyMinutes,L,H=>v(O=>{O.historyMinutes=H}))}
                ...
                <div class="readings-row">
                  ...
                  ${ot?f:h`<span class="readings-into">into</span>
                    <input type="number" class="short" aria-label="How many time slots" .value=${String(b.historyPoints)}
                      ...
                      @input=${ge(H=>{let O=Number(H);H.trim()!==""&&Number.isFinite(O)&&O>=1&&v(ln=>{ln.historyPoints=Math.round(O)},"hpoints")})} />
                    <span class="readings-unit">slots</span>`}
                </div>
              </div>
            </div>
            ${gs?Vo(b.historyMinutes,H=>v(O=>{O.historyMinutes=H},"span")):f}
        ...
        ${We.length>0?h`<div class="field readout"><span>Reads</span>
              <span class="readout-v"><span class="nums">${Tf(Nt)}</span>${We.length===Nt.length?h` · ${Nt.length} ${Nt.length===1?"value":"values"}`:h` · ${Nt.length} of ${We.length}`}</span></div>`:f}
        ${Nu?h`<div class="hint warn">This entity holds one number, so the chart draws one bar.
              Switch Draw to <b>Recorded history</b> to plot how it has moved.</div>`:f}
        <div class="grid2">
          ${ae("Use",b.limit,H=>v(O=>{O.limit=Math.max(0,Math.round(H??0))},"limit"),{step:1,min:0,def:u.limit})}
          ${Z("From",b.takeFromEnd?"end":"start",[["start","The first"],["end","The last"]],H=>v(O=>{O.takeFromEnd=H==="end"}),{def:u.takeFromEnd===!0?"end":"start"})}
        </div>
        ...
        <div class="grid2">
          ${Z("Style",b.style,Vm,H=>v(O=>{O.style=H}),{def:u.style})}
          ${b.style==="bars"?ae("Bar gap",b.barGap,H=>v(O=>{O.barGap=Math.max(0,H??0)},"gap"),{step:.5,min:0,def:u.barGap,unit:"pt"}):Ha(e,n,t,"Line width",{step:.5,min:.5,def:m("lineWidth")})}
        </div>
        <div class="grid2">
          ${Z("Scale",b.scale,Bm,H=>v(O=>{O.scale=H}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:u.scale})}
          ${Z("Baseline",b.baseline,Um,H=>v(O=>{O.baseline=H}),{def:u.baseline})}
        </div>
        ${tr.length===0?f:Le("Same scale as",nr?b.scaleFrom:"",[["","Its own"],...tr.map(H=>[H.payload.id,Me(H,zu)])],H=>v(O=>{H?O.scaleFrom=H:delete O.scaleFrom}),{def:""})}
        ...
        ${!nr&&b.scale==="fixed"?h`<div class="grid2">
              ${ae("Min",b.minValue,H=>v(O=>{O.minValue=H??0},"cmin"),{def:u.minValue})}
              ${ae("Max",b.maxValue,H=>v(O=>{O.maxValue=H??100},"cmax"),{def:u.maxValue})}
            </div>`:f}
        ...
        <div class="field"><span>Series</span>
          <div class="row-acts">
            <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
              @click=${()=>{let H;e.update(O=>{H=zl(O,a)}),H&&e.selectLayer(H)}}>${D("plus")}<span>Add a second series</span></button>
          </div>
        </div>
        ${Z("Colour",b.coloring,Wo,H=>v(O=>{O.coloring=H,H==="bands"&&O.bands.length===0&&(O.bands=Da(Nt))}),{def:u.coloring})}
        ${y("Main colour")}
        ${b.coloring==="bands"?h`
          ...
          ${b.style==="area"?h`${Be("Band fill",b.fillBands,H=>v(O=>{O.fillBands=H}),u.fillBands)}
        ...
        ${Z("Highlight",b.highlight,es,H=>v(O=>{O.highlight=H}),{def:u.highlight})}
        ${b.highlight==="none"?f:h`
          <div class="grid2">
            ${b.highlight==="lowest"?f:de("Highest colour",b.highColorHex,H=>v(O=>{O.highColorHex=H??Re},"hicol"),!1,Re)}
            ${b.highlight==="highest"?f:de("Lowest colour",b.lowColorHex,H=>v(O=>{O.lowColorHex=H??Fe},"locol"),!1,Fe)}
          </div>
        ...
        ${ag(e,n,M,E,v)}
        ${Be("Threshold",b.thresholdValue!==void 0,H=>v(O=>{H?O.thresholdValue=Gm(Nt):delete O.thresholdValue}))}
        ${b.thresholdValue===void 0?f:h`
          <div class="grid2">
            ${ae("At",b.thresholdValue,H=>v(O=>{O.thresholdValue=H??0},"thval"))}
            ${b.drawsThreshold===!1?f:de("Line colour",b.thresholdColorHex,H=>v(O=>{O.thresholdColorHex=H??gn},"thcol"),!1,gn)}
          </div>
          ...
          ${$c(e,n,"threshold")}`}
        ${Be("Now marker",b.nowIndex!==void 0,H=>v(O=>{H?O.nowIndex={kind:{kind:"time",timeField:"hour"}}:delete O.nowIndex}))}
        ${b.nowIndex===void 0?f:h`
          ${se(e,b.nowIndex,H=>v(O=>{O.nowIndex=H},"nowidx"),{showResolved:!0,label:"Reading number",key:`${o}-nowindex`})}
          ${b.drawsNowLine===!1?f:de("Marker colour",b.nowColorHex,H=>v(O=>{O.nowColorHex=H??yn},"nowcol"),!1,yn)}
        ...
        ${Yi(b)?wc(b,v,u,"cl",h`
            <div class="hint">Clock times from the start of the span to now, evenly spaced, in a row of
              ...
              Recorded history.</div>`}`;break}case"timeline":{let b=n.payload,v=(we,he)=>s(rt=>we(rt.payload),he),M=u.historyMinutes,E=b.value.kind.kind==="entityState",L=Rt(b),V=L===void 0?void 0:e.historySeries(L),K=Ye(b)*60,fe=gi(V??"",Mt),at=jo(a,b.historyMinutes),Ln=b.value.kind.kind==="entityState"?b.value.kind.entityId:void 0,_n=qm(fe,K,Ln===void 0?void 0:e.hass.states[Ln]?.state,Ln?.split(".")[0]);x=h`
        ...
        ${fe.length>0?h`<div class="field readout"><span>Reads</span><span class="readout-v"><span class="nums">${Af(fe,K)}</span></span></div>`:f}
        ${Ff(fe)?h`<div class="hint warn">This entity reports numbers, so every reading is its own
        ...
        ${Ym(b,v,_n,`wa-tl-states-${o.replace(/[^a-z0-9]/gi,"")}`)}
        ...
        <div class="grid2">
          ${ae("Gap",b.gap,we=>v(he=>{he.gap=Math.min(Xi,Math.max(0,we??0))},"tgap"),{step:.5,min:0,max:Xi,def:u.gap,unit:"pt"})}
        ...
        ${n.payload.kind==="line"?Rf(t,d,c):f}`,$=n.payload.kind==="line"?ae("Thickness",n.payload.thickness,b=>s(v=>{v.payload.thickness=b??1},"thick"),{step:.5,min:.5,def:u.thickness,unit:"pt"}):h`
        ...
        ${Ti("Zoom",b.zoom,V=>v(K=>{K.zoom=V},"zoom"),{min:yo,max:4,step:.05,def:1,format:V=>`${V.toFixed(2)}x`,unit:"x"})}
        ${Ti("Pan left/right",b.panX,V=>v(K=>{K.panX=V},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${Ti("Pan up/down",b.panY,V=>v(K=>{K.panY=V},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class=${b.contentMode==="fit"&&b.zoom===1?"hint keep":"hint"}>${Cf(b)}</div>
        ...
        ${Jc(e,n.payload,(b,v)=>s(M=>b(M.payload),v),o)}
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let S=g||n.kind==="image"||n.kind==="tap"||n.kind==="timeline"?void 0:y(n.kind==="shape"?"Fill colour":n.kind==="text"&&lt(n.payload)?"Layer colour":"Colour"),k=Wr(e.config,n),C=k?{kind:{kind:"entityState",...k}}:void 0,z=n.kind==="image"?n.payload.timestamp===!0:!1,B=n.kind==="text"&&(n.payload.parts?.length??0)>0?n.payload.parts:void 0,N=eg[n.kind],J=tg[n.kind],T=xc(n.payload,u,N),U=n.kind==="text"?"fontSize":n.kind==="icon"?"size":n.kind==="gauge"||n.kind==="chart"?"lineWidth":void 0,X=e.config.perFamily[t]?.placements[a]?.size!==void 0,G=xc(n.payload,u,J)||U!==void 0&&l.size!==void 0&&l.size!==u[U],pe=jt(e.config,a),R=(b,v)=>()=>s(M=>Oo(M.payload,u,b),v);return h`
    ${xe(e,"content","Content",h`${n.kind==="tap"||n.kind==="text"?f:qc(e,n,o)}${x}`,{color:Q.content,icon:"content",summary:ts(e,n),...T?{reset:()=>s(b=>{Oo(b.payload,u,N),b.kind==="text"&&wi(b.payload.rules)},"reset-content")}:{}})}
    ...
    ${n.kind==="chart"?xe(e,"numbers","Extras",og(e,n),{color:Q.numbers,icon:"text",summary:rg(e,n),...pe.length>0||qt(e.config,a).length>0?{reset:()=>e.update(b=>{for(let v of jt(b,a))Xe(b,v.payload.id);for(let v of qt(b,a))Xe(b,v.payload.id)})}:{}}):f}
    ${n.kind==="image"?xe(e,"timestamp","Timestamp",Sf(n.payload,(b,v)=>s(M=>b(M.payload),v)),{color:Q.numbers,icon:"clock",summary:z?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden",...z?{reset:R(Qf,"reset-stamp")}:{}}):f}
    ${xe(e,"states","States",ru(e,n.payload.rules,n.kind,b=>b.elements.find(v=>v.payload.id===a)?.payload.rules,`rules-${a}`,C,B),{color:Q.states,icon:"states",summary:bi(n.payload.rules).replace(/\.$/,""),...n.payload.rules.length>0?{reset:()=>s(b=>{b.payload.rules=[]})}:{}})}
    ${i.placement===!1?f:Hf(e,n,t)}
    ${i.tap===!1?f:_f(e,n)}`}var Qf=["timestamp","timestampCorner","timestampSize"],eg={text:["value","countdown","parts"],icon:["symbol","path"],gauge:["value","minValue","maxValue","total","minSource","maxSource"],chart:["value","historyMinutes","historyPoints","source","statPeriod","statType","limit","takeFromEnd"],timeline:["value","historyMinutes"],shape:["kind","cornerRadius"],image:["entity","source"],tap:["action","openPageName"]},tg={text:["fontSize","fontWeight","colorSlot","alignment","lineLimit","monospacedDigits","coloring","bands","bandAboveColorHex","highlight","highColorHex","lowColorHex"],icon:["size","colorSlot"],gauge:["style","lineWidth","trackColorHex","colorSlot","coloring","bands","bandAboveColorHex","thresholdValue","thresholdColorHex"],chart:["style","scale","minValue","maxValue","baseline","barGap","lineWidth","highlight","highColorHex","lowColorHex","marker","highMarker","lowMarker","coloring","bands","bandAboveColorHex","fillBands","thresholdValue","thresholdColorHex","nowIndex","nowColorHex","scaleFrom","colorSlot","timeLabelCount","labelSize","labelColorHex","labelsAbove","hourCycle","minutes"],timeline:["bands","otherColorHex","gap","cornerRadius","labelSize","labelColorHex","labelsAbove","timeLabelCount","hourCycle","minutes"],shape:["colorSlot","borderColorHex","borderWidth","thickness"],image:["contentMode","zoom","panX","panY","cornerRadius"],tap:[]};function Jc(e,n,t,i){let a=n.action;return h`
    ${Le("Tap action",a.type,pf,r=>t(o=>{o.action=Dc(r,o.action),r!=="openPage"&&(delete o.openPageId,delete o.openPageName)}))}
    ...
    ${a.type==="openPage"?Uc(e,n.openPageId,n.openPageName,(r,o)=>t(s=>{if(r===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=r,o?s.openPageName=o:delete s.openPageName},"tap-page")):f}`}var ng=24;function ig(e,n){let t=[],i=1/0;for(let r of ne){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=Pl(e.config,n,r);o&&(t.push(`${te(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return f;let a=i<ng;return h`<div class="field readout"><span>Tap size</span><span class="readout-v">${t.join(" \xB7 ")}</span></div>
    ${a?h`<div class="hint warn">That is small for a wrist. Show the tap area and drag its corners out.</div>`:f}`}function ag(e,n,t,i,a){if(!Ml(n))return f;let r=n.payload;return h`
    <div class="grid2">
      ${r.highlight==="lowest"?f:Z("Highest marker",t.high,mc,o=>a(s=>{Gi(s,{...qe(s),high:o})}),{def:i.high})}
      ${r.highlight==="highest"?f:Z("Lowest marker",t.low,mc,o=>a(s=>{Gi(s,{...qe(s),low:o})}),{def:i.low})}
    </div>
    <div class="field list-field"><span>Markers</span>
      <div class="chips">
        <button class="small" title="Turn these two marks into layers you can restyle"
          @click=${()=>e.update(o=>{Rl(o,r.id)})}>${D("plus")}<span>Move to layers</span></button>
      </div>
    </div>
    <div class="hint">These marks are drawn by the chart itself, which is why they are one of three
      ...
      emoji, any size, any colour, sitting over its own bar instead of in a band along the top.</div>`}function $c(e,n,t){let i=n.payload,a=t==="now"?i.drawsNowLine!==!1:i.drawsThreshold!==!1,r=t==="now"?"now line":"threshold line";if(a)return h`
      <div class="field list-field"><span>Line</span>
        <div class="chips">
          <button class="small" title=${`Turn the ${r} into a layer you can restyle`}
            @click=${()=>e.update(s=>{Vr(s,i.id,t)})}>${D("plus")}<span>Move to layers</span></button>
        </div>
      </div>`;let o=qt(e.config,i.id).some(s=>s.payload.chartAnchor?.at===t);return h`
    ${o?f:h`
      <div class="field list-field"><span>Line</span>
        <div class="chips">
    ...
    <div class="hint">${o?`The ${r} is a layer in Extras, so its colour, thickness and style are set there. The number here still decides where it sits.`:`The ${r} was moved to a layer that has since been deleted, so nothing draws it.`}</div>`}function rg(e,n){let t=jt(e.config,n.payload.id),i=qt(e.config,n.payload.id);if(t.length===0&&i.length===0)return"None yet";let a=t.map(r=>{let o=r.payload.value.kind;return o.kind==="chartStat"?(pn.find(([s])=>s===o.stat)?.[1]??"number").toLowerCase():"number"});for(let r of i){let{at:o,place:s}=r.payload.chartAnchor,l=(hn.find(([d])=>d===o)?.[1]??"reading").toLowerCase();a.push(s==="through"?`${l} line`:`${l} marker`)}return a.join(" \xB7 ")}function og(e,n){let t=ce(e),i=jt(e.config,n.payload.id),a=qt(e.config,n.payload.id),r=c=>e.update(u=>{El(u,n.payload.id,c)}),o=c=>e.update(u=>{Dr(u,n.payload.id,c)}),s=new Set(i.map(c=>c.payload.value.kind.kind==="chartStat"?c.payload.value.kind.stat:"")),l=new Set(a.map(c=>c.payload.chartAnchor.at)),d=(c,u,p,m)=>h`
    <div class="num-row">
    ...
    ${i.length===0&&a.length===0?h`<div class="hint keep">A chart on its own shows that a reading moved, not what it moved to and not
        ...
        <div class="field list-field"><span>Shown</span>
          <div class="chart-numbers">
            ...
            ${a.map(c=>{let{at:u,place:p}=c.payload.chartAnchor,m=(hn.find(([y])=>y===u)?.[1]??"reading").toLowerCase();if(p==="through")return d(c.payload.id,u==="threshold"?"\u2500":"\u2502",`line through the ${m}`,"line");let g=c.kind==="text"?e.resolve(c.payload.value)??"\u25CF":"\u25C6";return d(c.payload.id,g,`over the ${m}`,"marker")})}
          </div>
        </div>
    ...
    <div class="field list-field"><span>Line</span>
      <div class="adders">
        ${Fl.map(([c,u])=>{let p=c==="threshold"&&n.payload.thresholdValue===void 0;return h`
            <button class="small" ?disabled=${p}
              ...
              @click=${()=>e.update(m=>{let g=m.elements.find(y=>y.payload.id===n.payload.id);g?.kind==="chart"&&(c==="now"&&g.payload.nowIndex===void 0&&(g.payload.nowIndex={kind:{kind:"time",timeField:"hour"}}),Vr(m,n.payload.id,c))})}>${D("plus")}<span>${u}</span></button>`})}
      </div>
    </div>
    <div class="hint">A marker starts as a character over the reading it names, so type any glyph or emoji into it:
      ...
      sits on.</div>`}function sg(e,n,t){if(n.kind==="tap")return f;let i=n.payload.id,a=Pe(e.config,i)[0],r=(s,l)=>e.update(d=>{let c=d.elements.find(u=>u.kind==="tap"&&u.payload.attachedTo===i);c&&s(c.payload)},l?`${t}-${l}`:void 0),o=jr(e.config,n);return h`
    ${Be("Tappable",a!==void 0,s=>e.update(l=>{s?ta(l,i):na(l,i)}))}
    ${a?h`<div class="value-editor">
          ...
          <div class="field"><span>Tap area</span>
            <div class="chips">
              ...
              ${Ji(a.payload.outset)?f:h`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
                    @click=${()=>r(s=>{s.outset={...Nr}})}>${D("reset")}</button>`}
            </div>
          </div>
        </div>
        ${ig(e,a.payload.id)}
        <div class="hint">The tap area follows this layer in every shape, so there is nothing to line up. Show it to drag its corners past the layer, so a small layer is still an easy target. Where two tap areas overlap, the one higher in Layers wins.</div>`:h`<div class="hint">Tapping this layer runs an action of its own, instead of the complication's tap action. It starts as <b>${ct(o)}</b>.</div>`}`}function Cc(e){return e.length>=2&&e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1):e}function Me(e,n){switch(e.kind){case"text":return Cc($e(e.payload.value,n));case"icon":return Cc($e(e.payload.symbol,n));case"gauge":return $e(e.payload.value,n);case"chart":return $e(e.payload.value,n);case"timeline":return $e(e.payload.value,n);case"shape":return e.payload.kind==="roundedRectangle"?"Rounded rectangle":e.payload.kind;case"image":{let t=e.payload.entity;return t.displayName||t.entityId||(e.payload.source==="camera"?"camera":"picture")}case"tap":{let t=e.payload.action,i="entityId"in t?t.displayName||t.entityId:t.type==="callService"?[t.serviceDomain,t.serviceName].filter(a=>a!=="").join("."):t.type==="openPage"&&e.payload.openPageName||"";return i?`${t.type} \xB7 ${i}`:t.type}}}function Zc(e,n){let t=pt(e.config,n.id),i=ce(e),a=(r,o)=>e.update(s=>{let l=s.groups?.find(d=>d.id===n.id);l&&r(l)},o?`group-${n.id}-${o}`:void 0);return xe(e,"content","Group",h`
    ...
    <div class="hint">Click a layer in the list to edit it.</div>`,{color:Q.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Qc(e,n){if(n==="inline")return lg(e);let t=e.config.perFamily[n];if(!t)return h`<div class="hint">No settings stored for ${te(n)} yet.</div>
    ...
    ${xe(e,"symbol","Symbol",h`
      ...
      <div class="field readout"><span>On the face</span><span class="readout-v">${n.symbol?`${n.symbol} `:""}${n.label?`${n.label}: `:""}${e.resolve(n.value)??"--"}</span></div>`,{color:Q.look,icon:"icon",summary:n.symbol||"None"})}`}function dg(e,n,t){let i=n.curvedText?"curved":"canvas",a=n.bezelGauge?"gauge":n.bezelText?"text":"none";return h`
    ${Z("Main content",i,[["canvas","Layer canvas"],["curved","Big curved text"]],r=>t(o=>{r==="curved"?o.curvedText||(o.curvedText=A("Text")):(delete o.curvedText,delete o.curvedColorHex)}))}
    ...
    `:f}
    ${Z("Bezel",a,[["none","None"],["text","Text label"],["gauge","Gauge arc"]],r=>t(o=>{r==="text"?(delete o.bezelGauge,o.bezelText||(o.bezelText=A("Label"))):r==="gauge"?(delete o.bezelText,o.bezelGauge||(o.bezelGauge={value:A("50"),minValue:0,maxValue:100,colorHexes:["#34C759","#FFCC00","#FF3B30"]})):(delete o.bezelText,delete o.bezelGauge)}))}
    ...
    ${a==="gauge"&&n.bezelGauge?cg(e,n.bezelGauge,t):f}`}function cg(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(s=>{let l=[...i];l[r]=o??l[r],s.bezelGauge.colorHexes=l},`gstop${r}`);return h`
    ...
    ${Be("End labels",!!(n.minLabel||n.maxLabel),r=>t(o=>{let s=o.bezelGauge;r?(s.minLabel=A(String(s.minValue)),s.maxLabel=A(String(s.maxValue))):(delete s.minLabel,delete s.maxLabel)}))}
    ${n.minLabel?se(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):f}
    ${n.maxLabel?se(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):f}`}var Fv=ne.map(e=>[e,te(e)]),is={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},ug=Object.keys(is),Ga=["color","text","fontSize","fontWeight","visibility"];function pg(e,n=!1){let t=oa[e].filter(i=>!n||Ga.includes(i));return ug.filter(i=>t.includes(Ae[i]))}function eu(e,n,t,i){let a=n!==void 0&&!e.some(r=>r.id===n);return h`<label class="field"><span>Changes</span>
      <select @change=${r=>i(r.target.value,r.target)}>
        ${jf(e,n,t).map(([r,o])=>h`<option value=${r} ?selected=${r===(n??"")}>${o}</option>`)}
      </select></label>
    ${a?h`<div class="hint warn">The part this changed has been removed, so it changes nothing. Pick another part or Whole text.</div>`:f}`}var hg={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function _a(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function Ve(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function tu(e){if(!e||Ce(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.duration&&n.push("as a duration"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function $e(e,n){return`${Ri(e,n)}${tu(e.format)}`}function Ri(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${Ve(t.value,40)}"`:"(empty)";case"entityState":return _a(t,n);case"entityAttribute":return t.attribute?`${_a(t,n)} \xB7 ${t.attribute}`:_a(t,n);case"entityAge":return`age of ${_a(t,n)}`;case"aggregate":return mg(t.aggregate);case"time":return hg[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${Ve(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(pn.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Ri(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function mg(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function Mi(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function fg(e,n,t,i,a,r){let o=(s,l)=>e.update(d=>{let c=i(d);c&&s(c)},l?`${a}-${l}`:void 0);return h`
    ...
    ${n.cases.map((m,g)=>yg(e,m,g,n,a,u,`${o}-${m.id}`,p))}
    ...
    ${n.otherwise?h`<div class="case-box otherwise">
          ...
          ${nu(e,n.otherwise,a,m=>u(g=>{g.otherwise&&m(g.otherwise)}),`${o}-otherwise`,p)}
        </div>`:f}
  </div>`}function yg(e,n,t,i,a,r,o,s=!1){let l=(c,u)=>r(p=>{let m=p.cases.find(g=>g.id===n.id);m&&c(m)},u),d=e.liveBranch(i)===n.id;return h`<div class="case-box ${d?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${d?h` <span class="ok">· active now</span>`:f}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>Mi(c.cases,t,t-1))}>${D("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(c=>Mi(c.cases,t,t+1))}>${D("down")}</button>
    ...
    ${n.when.tests.map((c,u)=>bg(e,c,u,p=>l(m=>{let g=m.when.tests.find(y=>y.id===c.id);g&&p(g)}),()=>l(p=>{p.when.tests=p.when.tests.filter(m=>m.id!==c.id)}),`${o}-${c.id}`))}
    <div class="adders">
      <button class="small" @click=${()=>l(c=>{c.when.tests.push(no())})}>+ test</button>
      <select class="adder" @change=${c=>{let u=c.target,p=u.value;if(u.value="",!p)return;let m=oc(p,tc(e.hass?.states));l(g=>{g.when.tests.push(...m)})}}>
        <option value="">+ preset…</option>
        ${ac.map(c=>h`<option value=${c.kind} title=${c.hint}>${c.label}</option>`)}
      </select>
    </div>
    <div class="hint keep" style="margin-top:8px">Then:</div>
    ${nu(e,n.then,a,c=>l(u=>c(u.then)),`${o}-then`,s)}
  </div>`}function bg(e,n,t,i,a,r){let o=(u,p)=>i(u,p?`${r}-${p}`:void 0),s=n.comparison,l=Jt(s.kind),d=e.evaluateTest(n),c=f;switch(l){case"value":c=se(e,s.value??A(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":c=h`${se(e,s.value??A(""),u=>o(p=>{p.comparison.value=u},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ${se(e,s.upper??A(""),u=>o(p=>{p.comparison.upper=u},"upper"),{showResolved:!0,label:"Upper bound",key:`${r}-upper`})}`;break;case"pattern":c=h`${be("Pattern",s.pattern??"",u=>o(p=>{p.comparison.pattern=u},"pattern"),{mono:!0,placeholder:"^on$"})}
        ${s.pattern&&!vg(s.pattern)?h`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:f}`;break;case"times":c=h`<div class="row-inline">
          ${Sc(e,"From",s.value??A("22:00"),u=>o(p=>{p.comparison.value=u},"rhs"),`${r}-rhs`)}
          ${Sc(e,"To",s.upper??A("06:00"),u=>o(p=>{p.comparison.upper=u},"upper"),`${r}-upper`)}
        </div>
        <div class="hint">The start is included and the end is not. An end earlier than the start wraps midnight, so 22:00 to 06:00 is the night. Equal times match nothing.</div>`;break;case"options":c=xg(n.value)?wg(s.options??[],u=>o(p=>{p.comparison.options=Ho(u)},"options")):be("Options (comma separated)",(s.options??[]).join(", "),u=>o(p=>{p.comparison.options=u.split(",").map(m=>m.trim()).filter(Boolean)},"options"));break;case"none":break}return h`<div class="test-box">
    <div class="rule-head">
    ...
    ${Le("Comparison",s.kind,Gl.map(u=>[u,Rn[u]]),u=>o(p=>{p.comparison=ao(p.comparison,u)}))}
    ${c}
  </div>`}function vg(e){try{return new RegExp(e),!0}catch{return!1}}function Sc(e,n,t,i,a){if(t.kind.kind!=="literal")return se(e,t,i,{showResolved:!0,label:n,key:a});let r=t.kind.value,o=Xt(r)??"";return h`<label class="field"><span>${n}</span>
    <input type="time" .value=${o}
      @input=${ge(s=>i({...t,kind:{kind:"literal",value:s}}))} />
    ${r!==""&&o===""?h`<div class="hint warn">"${r}" is not a 24-hour HH:MM time. The test stays false until it is.</div>`:f}</label>`}function xg(e){return e.kind.kind==="time"&&e.kind.timeField==="weekday"}function wg(e,n){let t=ic(e),i=a=>n(t.includes(a)?t.filter(r=>r!==a):[...t,a]);return h`<div class="field seg-field"><span>Days</span>
    <div class="seg wide" role="group" aria-label="Days">
      ${nc.map((a,r)=>h`<button type="button" role="checkbox" aria-checked=${t.includes(r)?"true":"false"}
        class=${t.includes(r)?"on":""} @click=${()=>i(r)}>${a}</button>`)}
    </div></div>`}function nu(e,n,t,i,a,r=!1){let o=pg(t,r);return h`
    ${n.length===0?h`<div class="hint keep">No changes.</div>`:f}
    ${n.map((s,l)=>kg(e,s,l,t,(d,c)=>i(u=>{u[l]&&d(u[l])},c?`${a}-${l}-${c}`:void 0),()=>i(d=>{d.splice(l,1)}),`${a}-${l}`,r))}
    <select class="adder" @change=${s=>{let l=s.target,d=l.value;l.value="",d&&i(c=>{c.push(Zt(d))})}}>
      <option value="">+ change…</option>
      ${o.map(s=>h`<option value=${s}>${is[s]}</option>`)}
    </select>`}var iu=["setColor","setBorderColor","setBackgroundColor"];function kg(e,n,t,i,a,r,o,s=!1){let l=!oa[i].includes(Ae[n.kind]),d=s&&!l&&!Ga.includes(Ae[n.kind]);return h`<div class="change-box">
    <div class="rule-head">
    ...
    ${au(e,n,a,o)}
      ...
      ${fg(e,n,t,i,a,o)}`:$g(e,s.table,n[0],t,i,a,r,o)}function $g(e,n,t,i,a,r,o,s){let l=(v,M)=>e.update(E=>{let L=a(E);L&&v(L)},M?`${r}-${M}`:void 0),d=n.value??Tc.get(r)??o,c=n.rows.length===0,u=n.numberMode||c&&d!==void 0&&!jd(d)&&Cg(e.resolve(d)),p=oa[i],m=Pa.get(r)??new Set,g=n.columns.length===0&&m.size===0?[Wd[i]]:[],y=Nd(n.columns,[...m,...g.filter(v=>v!==void 0)],p),x=La.get(r),$=t?t.partId:s?.some(v=>v.id===x)?x:void 0,S=s!==void 0&&$!==void 0,k=S?p.filter(v=>Ga.includes(v)):p,C=S?y.filter(v=>!Ga.includes(v)):[],z=(v,M)=>{if(!t){v?La.set(r,v):La.delete(r),ke(M);return}l(E=>{let L=E[0];L&&(v?L.partId=v:delete L.partId)})},B=t?e.liveBranch(t):"none",N=t?e.forced.get(t.id)??"live":"live",J=v=>N!=="live"&&(N==="otherwise"?v==="otherwise":N.caseId===v),T=v=>{t&&e.setForced(t.id,J(v)?"live":v==="otherwise"?"otherwise":{caseId:v})},U=v=>{Tc.set(r,v),n.rows.length!==0&&l(M=>Ud(M,v),"lhs")},X=()=>{La.delete(r),l(v=>{Vd(v,d??A(""),u),$!==void 0&&v[0]&&v[0].partId===void 0&&(v[0].partId=$)})},G=n.rows.map((v,M)=>Mc(e,{key:`${r}-${v.caseId}`,label:Kd(v.comparison,E=>$e(E,ce(e))),columns:y,changes:v.changes,live:B===v.caseId,forced:J(v.caseId),onForce:()=>T(v.caseId),when:Rg(e,v.comparison,`${r}-${v.caseId}`,(E,L)=>l(V=>{let K=V[0]?.cases.find(fe=>fe.id===v.caseId)?.when.tests[0];K&&E(K.comparison)},L&&`${v.caseId}-${L}`)),updChanges:(E,L)=>l(V=>{let K=V[0]?.cases.find(fe=>fe.id===v.caseId);K&&E(K.then)},L&&`${v.caseId}-${L}`),acts:h`
      <button class="icon" title="Move up" ?disabled=${M===0} @click=${()=>l(E=>Eo(E,M,M-1))}>${D("up")}</button>
      <button class="icon" title="Move down" ?disabled=${M===n.rows.length-1} @click=${()=>l(E=>Eo(E,M,M+1))}>${D("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(E=>Bd(E,v.caseId))}>${D("delete")}</button>`})),pe=n.otherwise===void 0?f:Mc(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:B==="otherwise",forced:J("otherwise"),onForce:()=>T("otherwise"),when:h`<span class="when-otherwise">Otherwise</span>`,updChanges:(v,M)=>l(E=>{let L=E[0]?.otherwise;L&&v(L)},M),acts:h`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(v=>Mo(v,!1))}>${D("close")}</button>`}),R=Na.get(r),b=Sg.filter(v=>k.includes(v)&&!y.includes(v));return h`
    <div class="states">
      ${se(e,d??A(""),U,{label:"Testing",showResolved:!0,key:`${r}-lhs`})}
      ${d===void 0?h`<div class="hint keep">Choose what these states look at.</div>`:f}
      ${s===void 0?f:eu(s,$,ce(e),z)}
          ...
          <tr>
            ...
            ${y.map(v=>h`<th>
              ...
              <button class="icon" title=${`Remove the ${tt[v]} column`}
                @click=${M=>{Na.set(r,v),ke(M.target)}}>${D("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
      ...
      ${R===void 0?f:h`<div class="hint warn confirm-row">
        Remove the ${tt[R]} column? Its ${Ec(n,R)} value${Ec(n,R)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${v=>{Na.delete(r),Pa.get(r)?.delete(R),ke(v.target),l(M=>Gd(M,R))}}>Remove</button>
    ...
    </div>`}function Cg(e){let n=(e??"").trim();return n!==""&&Number.isFinite(Number(n))}var Sg=["icon","text","color","visibility","opacity","fontSize","fontWeight","rotation","gaugeValue","gaugeMin","gaugeMax","backgroundColor","borderColor","borderWidth"];function Ec(e,n){let t=0;for(let i of e.rows)Ea(i.changes,n)&&(t+=1);return e.otherwise&&Ea(e.otherwise,n)&&(t+=1),t}function Tg(e){return!!e.target?.closest?.("input, select, textarea, button, label, [popover]")}function Mc(e,n){return h`<tr class="state-row ${n.live?"live":""} ${n.forced?"forced":""}"
    ...
    ${n.columns.map(t=>h`<td>${Eg(e,t,n.changes,n.updChanges,`${n.key}-${t}`)}</td>`)}
    <td class="acts">${n.acts}</td>
  </tr>`}function Eg(e,n,t,i,a){let r=Ea(t,n),o=Xa(a);if(!r)return h`<button type="button" class="cell empty" title=${`Set ${tt[n]} for this state`}
      @click=${d=>{i(c=>{c.push(Zt(Pd[n]))}),_c(d.target,o)}}>unchanged</button>`;let s=(d,c)=>i(u=>{let p=u.find(m=>Ae[m.kind]===n);p&&d(p)},c&&`${n}-${c}`),l=tt[n];return h`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${l}. Click to change it.`}>${Mg(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${l} @toggle=${Pc}>
      ...
      ${Ei.has(o)?h`${n==="visibility"?Z("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>s(c=>{c.kind=d})):au(e,r,s,a)}
    ...
    <select class="when-op" title="How this state is decided" @change=${ge(s=>i(l=>{let d=ao(l,s);l.kind=d.kind,d.value!==void 0?l.value=d.value:delete l.value,d.upper!==void 0?l.upper=d.upper:delete l.upper}))}>
      ${Co.map(s=>h`<option value=${s} ?selected=${s===n.kind}>${Fg(s)}</option>`)}
    </select>
    ${a==="value"||a==="between"?o(n.value??A(""),s=>i(l=>{l.value=s},"rhs"),"rhs",r?"0":"value"):f}
    ${a==="between"?h`<span class="when-and">to</span>${o(n.upper??A(""),s=>i(l=>{l.upper=s},"upper"),"upper","100")}`:f}
  </span>`}function Fg(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return Rn[e]}}function Ag(e,n,t,i,a,r,o){let s=Xa(i),l={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return h`<span class="rhs">
    ...
    ${Lc(e,s,o,n,t,l)}
  </span>`}var Fi=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:Kr,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"doorHistory",title:"Door history",blurb:"A strip of when the entity was open over the last hour, with its name above. For a door, a window or anything else with two states.",domains:["binary_sensor","cover"],layerCount:2},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function du(e){return Fi.find(n=>n.kind===e)??Fi[0]}var ou="#FF9F0A",Qa="#8E8E93",Ig=["#FF453A","#FFD60A","#34C759"],cu=["#0A84FF","#34C759","#FF9F0A"];function Hg(e){return e?.attributes?.device_class==="battery"?Ig:cu}var Lg={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function _g(e){let n=e.iconName?.trim();return n?{off:n,on:n}:Lg[as(e)]??{off:"circle",on:"circle.fill"}}function Pg(e){switch(as(e)){case"lock":return{kind:"equals",value:A("locked")};case"cover":case"valve":return{kind:"equals",value:A("open")};case"media_player":return{kind:"equals",value:A("playing")};default:return{kind:"isOn"}}}function as(e){return e.domain||e.entityId.split(".")[0]||""}function _t(e){return{...e,domain:as(e)}}function Ng(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Hn(e){return Math.round(e*1e4)/1e4}function on(e,n,t){return Math.min(t,Math.max(n,e))}function rs(e,n,t){let i=Se[e],a=on(Hn(n/i.width),0,1),r=on(Hn(t/i.height),0,1);return{x:Hn((1-a)/2),y:Hn((1-r)/2),width:a,height:r,rotationDegrees:0}}function zg(e){let n=Se[e],t=on(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:rs(e,t*1.3,t*1.3),size:t}}function Og(e){let n=Se[e],t=on(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:rs(e,n.width*.88,t*1.7),size:t}}function Dg(e){let n=Se[e],t=Math.min(n.width,n.height)*.9;return{frame:rs(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function uu(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Vg(e){let n=Se[e],t=on(Math.round(n.height*.2),6,14);return{frame:{x:.06,y:.56,width:.88,height:Hn(t/n.height),rotationDegrees:0}}}function Bg(e){let n=Se[e],t=on(Math.round(Math.min(n.width,n.height)*.26),8,15);return{frame:{x:.06,y:.2,width:.88,height:Hn(on(t*1.5/n.height,0,1)),rotationDegrees:0},size:t}}function Ug(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Gg(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function Ht(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Gg(n,a.size);let r=e.perFamily[t]??(e.perFamily[t]=ht());r.placements[n.payload.id]={frame:a.frame,isHidden:!1,...a.size!==void 0?{size:a.size}:{}}}function Lt(e){return De(e)}function os(e,n){let t={kind:{kind:"entityState",..._t(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function su(e){let n=Zt("setIcon");return n.value=A(e),n}function rn(e){let n=Zt("setColor");return n.value=A(e),n}function Kg(e,n){let t=pi(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",..._t(e)}},a.comparison=Pg(e);let r=n.on!==n.off;return i.then=r?[su(n.on),rn(ou)]:[rn(ou)],t.otherwise=r?[su(n.off),rn(Qa)]:[rn(Qa)],t}function Wg(e){let n=pi(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",..._t(e)}},i.comparison={kind:"isUnavailable"};let a=Zt("setOpacity");return a.number=.35,t.then=[a],n}function lu(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function jg(e,n,t=cu){let i=n.max-n.min,a=lu(n.min+i/3),r=lu(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:A(a)},changes:[rn(t[0])]},{comparison:{kind:"between",value:A(a),upper:A(r)},changes:[rn(t[1])]},{comparison:{kind:"greaterThan",value:A(r)},changes:[rn(t[2])]}];return zd(os(e),o)}function qg(e,n,t){let i=Lt("icon"),a=_g(n);return i.payload.symbol=A(a.off),i.payload.colorSlot.baseColorHex=Qa,i.payload.rules=[Kg(n,a)],Ht(e,i,t.family,zg),e.elements.push(i),ta(e,i.payload.id,{type:"toggleEntity",..._t(n)}),i.payload.id}function Yg(e,n,t){let i=Lt("text");return i.payload.value=os(n,t.state),i.payload.rules=[Wg(n)],Ht(e,i,t.family,Og),e.elements.push(i),i.payload.id}function Xg(e,n,t){let i=Lt("gauge");i.payload.value=os(n);let a=Ng(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[jg(n,a,Hg(t.state))],Ht(e,i,t.family,Dg),e.elements.push(i),i.payload.id}function Jg(e,n,t){let i=Lt("chart");return i.payload.value={kind:{kind:"entityState",..._t(n)}},i.payload.historyMinutes=0,i.payload.highlight="both",i.payload.marker="pointer",Ht(e,i,t.family,uu),e.elements.push(i),i.payload.id}function Zg(e,n,t){let i=Lt("chart");return i.payload.value={kind:{kind:"entityState",..._t(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",Ht(e,i,t.family,uu),e.elements.push(i),i.payload.id}function Qg(e,n,t){let i=_t(n),a=Lt("text");a.payload.value=A(i.displayName||i.entityId),a.payload.colorSlot.baseColorHex=Qa,Ht(e,a,t.family,Bg),e.elements.push(a);let r=t.state?.attributes?.device_class,o=Lt("timeline");return o.payload.value={kind:{kind:"entityState",...i}},o.payload.bands=_r(i.domain,typeof r=="string"?r:void 0),Ht(e,o,t.family,Vg),e.elements.push(o),o.payload.id}function ey(e,n,t){let i=Lt("image");return i.payload.entity=_t(n),Ht(e,i,t.family,Ug),e.elements.push(i),i.payload.id}function pu(e,n,t,i){switch(n){case"toggle":return qg(e,t,i);case"status":return Yg(e,t,i);case"gauge":return Xg(e,t,i);case"chart":return Jg(e,t,i);case"history":return Zg(e,t,i);case"doorHistory":return Qg(e,t,i);case"camera":return ey(e,t,i)}}var ty=/^[a-z0-9_]+\.shared_(\d+)$/;function hu(e){return ty.test(e)}function ny(e){return e.length===0?e:e[0].toUpperCase()+e.slice(1)}function fu(e,n){let i=(e.domain||n.split(".")[0]||"").toLowerCase().replace(/[^a-z0-9_]/g,"");return i===""?"entity":i}function gu(e,n){let t=new Map;for(let i of to(e,(a,r)=>n.has(r))){if(i.entityId==="")continue;let a=t.get(i.entityId);if(!a){let r=fu(i.ref,i.entityId),o=t.size+1;a={placeholderId:`${r}.shared_${o}`,domain:r,label:`${ny(r.replace(/_/g," "))} ${o}`,originalId:i.entityId,where:[]},t.set(i.entityId,a)}a.where.includes(i.where)||a.where.push(i.where)}return[...t.values()]}function iy(e,n){let t=structuredClone(e),i=new Map,a=new Map;for(let r of n)i.set(r.originalId,{entityId:r.placeholderId,displayName:r.label,domain:r.domain}),a.set(r.originalId,r.placeholderId);Qr(t,r=>{let o=i.get(r.entityId);return o?{...o}:void 0}),eo(t,r=>Yr(r,a)),delete t.openPageId,delete t.openPageName,t.tapAction.type==="openPage"&&(t.tapAction={type:"none"});for(let r of t.elements)r.kind==="tap"&&(delete r.payload.openPageId,delete r.payload.openPageName,r.payload.action.type==="openPage"&&(r.payload.action={type:"none"}));return t.dataSources=[],t}function yu(e){let n=!1;return ra(e,t=>{let i=t.kind;if(i.kind!=="aggregate")return;let a=i.aggregate.scope;a.kind==="filter"&&a.areaIds.length+a.labelIds.length+a.floorIds.length>0&&(n=!0)}),n}function ay(e,n="  "){let t=(i,a)=>{if(i===null||typeof i!="object")return JSON.stringify(i)??"null";let r=a+n;if(Array.isArray(i))return i.length===0?"[]":`[
...
`)}
${a}}`};return t(e,"")}function bu(e,n,t=[]){let i=n==="share"?iy(e,t):e,a=wn(i);return delete a.id,delete a.slotIndex,a.dataSources=[],`${ay(a)}
`}function vu(e){let t=(e.name===""?"Complication":e.name).split(/[^\p{L}\p{N}]+/u).filter(i=>i!=="").join("-");return`${t===""?"Complication":t}.json`}var ry="There is nothing to read here. Paste a complication first.",oy="This is not valid JSON. Check for a missing brace or a stray comma.",sy="This is valid JSON but not a complication. A complication starts with { and ends with }.",ly="This does not look like a complication.",mu="It was made by a newer panel, so update the Wrist Assistant integration before importing it.",dy="00000000-0000-4000-8000-000000000000";function cy(e){let n=/^([A-Za-z]+) is required$/.exec(e);return n?`It is missing "${n[1]}".`:e}function xu(e,n){let t=e.trim();if(t==="")return{ok:!1,error:ry};let i;try{i=JSON.parse(t)}catch{return{ok:!1,error:oy}}if(typeof i!="object"||i===null||Array.isArray(i))return{ok:!1,error:sy};let a=i,r=a.schemaVersion;if(typeof r=="number"&&r>n)return{ok:!1,error:`This complication is schema v${r}; this panel understands up to v${n}. ${mu}`};let o={...a,id:dy,slotIndex:0},s;try{s=xn(o)}catch(d){let c=d instanceof Oe||d instanceof Error?d.message:String(d);return{ok:!1,error:`${ly}

${cy(c)}`}}let l=Qi(a);if(l.length>0){let d=l.slice(0,3).join(", "),c=l.length>3?`, and ${l.length-3} more`:"";return{ok:!1,error:`This complication uses keys this panel does not know: ${d}${c}. ${mu}`}}return{ok:!0,config:s,raw:i}}function ss(e,n){let t=new Set;for(let o of Object.keys(n)){let s=o.split(".")[0]??"";s!==""&&t.add(s)}let i=o=>Object.prototype.hasOwnProperty.call(n,o),a=new Map,r=to(e,(o,s)=>hu(o)||t.has(s));for(let o of r){if(o.entityId==="")continue;let s=hu(o.entityId);if(!s&&i(o.entityId))continue;let l=a.get(o.entityId);l||(l={entityId:o.entityId,domain:fu(o.ref,o.entityId),label:o.ref.displayName||o.entityId,where:[],required:s},a.set(o.entityId,l)),l.label===o.entityId&&o.ref.displayName!==""&&(l.label=o.ref.displayName),l.where.includes(o.where)||l.where.push(o.where)}return[...a.values()]}function wu(e,n){let t=structuredClone(e);Qr(t,a=>{let r=n.get(a.entityId);if(r)return{entityId:r.entityId,displayName:r.displayName,domain:r.domain||r.entityId.split(".")[0]||""}});let i=new Map;for(let[a,r]of n)i.set(a,r.entityId);return eo(t,a=>Yr(a,i)),t}function ku(e,n){let t=e.trim();if(t==="")return"";let i=a=>n.has(a.toLowerCase());if(!i(t))return t;for(let a=2;a<=99;a+=1){let r=`${t} ${a}`;if(!i(r))return r}return t}function uy(e){return e.length<=1?e[0]??"":`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function $u(e){let n=e.elements.length,t=n===1?"1 layer":`${n} layers`,i=va(e);return i.length===0?t:`${t}, ${uy(i)}`}function ls(e){if(!e.parsed)return"Paste a complication first.";let n=e.name.trim();if(n==="")return"Give it a name first.";if(e.taken.has(n.toLowerCase()))return"A complication on this watch already has that name.";if(e.unchosen===1)return"One entity still needs choosing.";if(e.unchosen>1)return`${e.unchosen} entities still need choosing.`}var hy=3e4,my=500,fy=3e4,Cu="preset-entity";function Su(e){return`import-entity-${e}`}var gy={entityId:"",displayName:"",domain:""},yy=new Map,by={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function ds(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function vy(e){return e.kind==="family"?"look":"content"}function cs(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}function Tu(){return h`<span class="hstep" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
...
`)}var Fu="wrist-assistant-panel.layers.v1",gt=34,sn=200,$y=720,er=320,Cy=80,Sy=56,Au="wrist-assistant-panel.columns.v3",us=e=>Math.max(sn,Math.min($y,Math.round(e))),Iu=e=>e.metaKey||e.ctrlKey||e.shiftKey,Ty=/^(range|checkbox|radio|color|button|submit|reset|file|image)$/,Ai=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",Pt=Ai==="Cmd"?"\u2318":"Ctrl+",ps=Ai==="Cmd"?"\u21E7":"Shift+";function Hu(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Cy;if(i>=sn*2+er){let r=i-er,o=n,s=t;if(o+s>r){let l=r/(o+s);o=Math.max(sn,Math.floor(o*l)),s=Math.max(sn,Math.floor(s*l));let d=o+s-r;d>0&&(o>=s?o=Math.max(sn,o-d):s=Math.max(sn,s-d))}return{columns:3,left:o,right:s}}let a=e-Sy;return a>=sn+er?{columns:2,left:Math.min(n,a-er),right:t}:{columns:1,left:n,right:t}}var I=class I extends vt{constructor(){super(...arguments);this.narrow=!1;this.colLeft=Eu;this.colRight=Mu;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.sendStatusKnown=!1;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.helpSections=new Set;this.scrubStart=()=>this.draft?.beginGesture();this.scrubEnd=()=>this.draft?.endGesture();this.pickerOpen=!1;this.pickerFilter="all";this.sharedHelp=!1;this.thumbStep=0;this.layerDetail="compact";this.addOpen=!0;this.addDetail="expanded";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newOpen=!1;this.newName="";this.shareOpen=!1;this.shareMode="share";this.shareLabels=new Map;this.shareNote="";this.importOpen=!1;this.importText="";this.importName="";this.importMap=new Map;this.recordPreviews=new Map;this.previewCase=Tn.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Ad(()=>this.requestUpdate());this.imageSizes=Id(()=>this.requestUpdate());this.symbols=new $a(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.fades=new Ta;this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.newKeys=t=>{t.key==="Enter"&&(this.newName.trim()===""||this.newFamily===void 0||this.newNameProblem()!==void 0||(t.preventDefault(),this.createNew()))};this.importKeys={handleEvent:t=>{if(t.key!=="Enter"||t.target instanceof HTMLTextAreaElement)return;let i=this.importParse,a=i?.ok?i.config:void 0;if(!a)return;let r=ss(a,this.hass.states);r.some(s=>Qo(Su(s.entityId)))||ls({parsed:!0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(r)})!==void 0||(t.preventDefault(),t.stopPropagation(),this.doImport())},capture:!0};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||Qo(Cu)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0};this.pressing=!1;this.pressStart=()=>{this.pressing=!0};this.pressEnd=()=>{window.setTimeout(()=>{this.pressing=!1})};this.sharedValueFocus=t=>{this.pressing||this.sharedValueOutside(t)};this.sharedValueOutside=t=>{if(this.openValue===void 0)return;let i=t.composedPath(),a=i[0];if(a instanceof HTMLElement&&a.classList.contains("values-list"))return;i.some(o=>o instanceof HTMLElement&&o.classList.contains("vitem")&&o.classList.contains("open"))||this.setOpenValue(void 0)}}get testValues(){return this.draft?.testValues??yy}static{this.styles=ar`
    :host {
      ...
      --wa-text: ${ve(ze.text)};
      --wa-icon: ${ve(ze.icon)};
      --wa-gauge: ${ve(ze.gauge)};
      --wa-shape: ${ve(ze.shape)};
      --wa-image: ${ve(ze.image)};
      --wa-tap: ${ve(ze.tap)};
    ...
    * { box-sizing: border-box; }
    ...
    .layer.drop-before { border-top: ${gt}px solid transparent; }
    .layer.drop-after { border-bottom: ${gt}px solid transparent; }
    .layer.drop-before::after, .layer.drop-after::after {
      content: ""; position: absolute; left: 0; right: 0; height: ${gt}px; box-sizing: border-box;
    ...
    .layer.drop-before::after { top: -${gt}px; }
    .layer.drop-after::after { bottom: -${gt}px; }
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),window.addEventListener("pointerdown",this.pressStart,{capture:!0}),window.addEventListener("pointerup",this.pressEnd,{capture:!0}),window.addEventListener("pointercancel",this.pressEnd,{capture:!0}),window.addEventListener("click",this.sharedValueOutside,{capture:!0}),window.addEventListener("focusin",this.sharedValueFocus),this.addEventListener(Ka,this.scrubStart),this.addEventListener(Wa,this.scrubEnd),this.loadOwners(),this.watchStatusTimer=window.setInterval(()=>{this.refreshWatchStatus()},fy)}loadColumnWidths(){try{let t=window.localStorage.getItem(Au);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=us(i.left)),typeof i.right=="number"&&(this.colRight=us(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(Au,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(Fu);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail),typeof i.addOpen=="boolean"&&(this.addOpen=i.addOpen),(i.addDetail==="compact"||i.addDetail==="expanded")&&(this.addDetail=i.addDetail)}catch{}}saveListView(){try{window.localStorage.setItem(Fu,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail,addOpen:this.addOpen,addDetail:this.addDetail}))}catch{}}renderGutter(t){return h`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      ${a&&r.length>0?h`<div class="adders">
            ${r.map(o=>h`<button class="small primary"
              ...
              @click=${()=>this.mutate(s=>Wc(s,o,i))}>Copy the ${te(o)} layout</button>`)}
          </div>
    ...
    </div>`}addShape(t){this.mutate(i=>$d(i,t)),this.activeFamily=t,this.inspect={kind:"family"}}removeShape(t){let i=this.draft?.config;if(!i||!xa(i,t))return;let a=Sd(i,t);a.length>0&&!window.confirm(`Remove the ${te(t)} shape? This deletes ${a.join(", ")}. They are on this shape only, so nothing else in the complication loses anything.`)||(this.mutate(r=>Cd(r,t)),this.ensureActiveFamily())}createNew(){let t=this.newFamily,i=this.newName.trim();!t||i===""||this.newNameProblem()!==void 0||(this.closeNewDialog(),this.startNew(Il(i,this.freeSlot(),[t])))}setForced(t,i){let a=new Map(this.forced);i==="live"?a.delete(t):a.set(t,i),this.forced=a}async save(t=!1){if(!(!this.draft||!this.ownerId||!this.canEdit||this.saving)&&!(!t&&!this.draft.dirty)){if(!t&&!this.slotChosen){this.saveError="The watch is full. Delete a complication first.";return}this.saving=!0,this.saveError=void 0;try{let i=this.draft;if(t){let s=this.freeSlot();if(s<0){this.saveError="The watch is full (iPhone presets count too), so there is nowhere to put a copy. Delete a complication first.";return}let l=structuredClone(i.config);l.id=Y(),l.slotIndex=s,i=new tn(l,null)}let a=i.encoded(),r=await Ns(this.hass,this.ownerId,a,i.baseRevision);if(!r.ok||!r.record){r.error==="conflict"?this.conflict={current:r.current??null,message:r.message??"Someone else saved this complication first."}:this.saveError=r.message??r.error??"Save failed";return}this.conflict=void 0,this.remoteRevision=void 0,this.selectedId=r.record.id;let o=this.draft.testValues;this.draft=tn.fromDocument(r.record.document,r.record.revision),this.draft.testValues=o,this.savedName=String(r.record.document?.name??""),this.recompile(),this.beginSendWait(),await this.loadRecords()}catch(i){this.saveError=yt(i)}finally{this.saving=!1}}}async deleteCurrent(){if(!(!this.draft||!this.ownerId||!this.selectedId||!this.canEdit)){if(this.draft.baseRevision===null){this.clearDraft(),this.selectedId=void 0,this.selectFirst();return}this.saving=!0;try{let t=await zs(this.hass,this.ownerId,this.selectedId,this.draft.baseRevision);if(!t.ok){t.error==="conflict"?this.conflict={current:t.current??null,message:t.message??"This complication changed on the server."}:this.saveError=t.message??t.error??"Delete failed";return}this.clearDraft(),this.selectedId=void 0,await this.loadRecords()}catch(t){this.saveError=yt(t)}finally{this.saving=!1,this.confirmDelete=!1}}}duplicate(){if(!this.draft)return;let t=structuredClone(this.draft.config);t.id=Y(),t.name=`${t.name} copy`,t.slotIndex=this.freeSlot(),this.startNew(t)}reloadFromServer(){let t=this.conflict?.current??this.records.find(i=>i.id===this.selectedId);this.conflict=void 0,t&&!t.deleted?this.openRecord(t):(this.clearDraft(),this.selectedId=void 0,this.loadRecords())}get selectedOwner(){return this.owners.find(t=>t.owner_watch_id===this.ownerId)}async moveAll(){let t=this.ownerId,i=this.moveTarget;if(!(!t||!i||this.moving)){this.moving=!0,this.moveError=void 0;try{await Os(this.hass,t,i),this.moveTarget=void 0,await this.loadOwners(),await this.selectOwner(i)}catch(a){this.moveError=yt(a)}finally{this.moving=!1}}}scheduleTemplates(t){this.debounceTimer&&window.clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout(()=>{this.refreshTemplates()},t),this.templateTimer&&window.clearInterval(this.templateTimer),this.templateTimer=window.setInterval(()=>{this.refreshTemplates()},hy)}async refreshHistorySeries(){let t=this.draft?.config,i=t?Ar(t):[],a=t?Ir(t):[];if(i.length===0&&a.length===0){this.historySeries.size>0&&(this.historySeries=new Map);return}let r={};for(let s of i)r[s.key]={entity_id:s.entityId,minutes:s.minutes,points:s.points,...s.mode==="states"?{mode:"states"}:{}};let o={};for(let s of a)o[s.key]={entity_id:s.entityId,minutes:s.minutes,period:s.period,type:s.type};try{let[s,l]=await Promise.all([Bs(this.hass,r),Us(this.hass,o).catch(()=>({}))]),d=new Map;for(let[c,u]of Object.entries({...s,...l}))u.ok&&d.set(c,u.series);this.historySeries=d}catch{}}async refreshTemplates(){this.refreshHistorySeries();let t=this.compiled?.document;if(!t){this.templateResults=new Map,this.templateError=void 0,this.templateFetchedAt=Date.now();return}try{let a=(await Vs(this.hass,{doc:t})).doc;if(!a)return;if(!a.ok){this.templateError=a.error;return}let r=ed(a.value);if(!r){this.templateError="Template did not render to a JSON object";return}this.templateResults=r.values,this.templateError=void 0,this.templateFetchedAt=Date.now()}catch(i){this.templateError=yt(i)}}entityStateFor(t,i,a){let r=this.hass.states[t];if(!r)return;let o=r.attributes,s=t.split(".")[0]??"",l={entityId:t,state:(a?this.testValues.get(t):void 0)??r.state,unitOfMeasurement:typeof o.unit_of_measurement=="string"?o.unit_of_measurement:void 0,iconName:i,domain:s};if(s==="timer"){l.timerState=r.state,typeof o.finishes_at=="string"&&(l.finishesAt=o.finishes_at);let d=Ey(o.remaining);d!==void 0&&(l.remaining=d)}return typeof o.entity_picture=="string"&&(l.entityPicture=o.entity_picture),l}buildContext(t=!0){let i=new Map;for(let[r,o]of this.compiled?.entities??[]){let s=this.entityStateFor(r,o.iconName??"",t);s&&i.set(r,s)}let a=this.draft?.config.values??[];return{entityStates:i,templateResults:this.templateResults,historySeries:this.historySeries,namedValues:t?jl(a,this.testValues):a,dataAgeSeconds:this.templateFetchedAt===void 0?void 0:(Date.now()-this.templateFetchedAt)/1e3,testedEntities:t?new Set(this.testValues.keys()):new Set}}renderPickButton(){let t=this.picking,i=!this.draft||this.parseError!==void 0;return h`<button class="pick ${t?"on":""}" ?disabled=${i}
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?qr(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,s=a.closest("svg"),l=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=l!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let N=this.focusTapId();if(N!==void 0&&o===N&&s&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,s,N,r??void 0);return}let J=this.hitLayerId(i);J?this.inspect={kind:"layer",id:J}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let c=Iu(i);if(!c&&this.multi.size>0&&(this.multi=new Set),!o||!s)return;let u=qr(this.draft.config,o),p=this.draft.config.elements.find(N=>N.payload.id===u);if(!u||!p)return;if(c){i.preventDefault(),this.togglePick(u);return}let m=ut(this.draft.config,u),g=m!==void 0&&this.inspect.kind==="group"&&this.inspect.id===m.id;if(m&&(m.locked||g)&&!r&&!d){this.beginGroupGesture(t,i,s,m);return}if((this.inspect.kind!=="layer"||this.inspect.id!==u)&&(this.inspect={kind:"layer",id:u},r))return;i.preventDefault();let y=Ee(this.draft.config,t,p).frame,x=this.gestureCanvas(t);if(d&&p.kind==="image"&&p.payload.timestamp===!0){this.timestampActiveId=u;let N=p.payload,J=le[t],T=y.width*J.width,U=y.height*J.height,X={x:0,y:0,w:T,h:U,cx:T/2,cy:U/2},G=ga(N,X,fa(new Date));if(this.cancelGesture?.(),l){let v=x.width/J.width,M=N.timestampSize;this.cancelGesture=Qd(s,i,l,{w:G.w*v,h:G.h*v},(E,L)=>{let V=Math.min(40,Math.max(4,Math.round(M*E)));this.mutate(K=>{let fe=K.elements.find(at=>at.payload.id===u);fe?.kind==="image"&&(fe.payload.timestampSize=V)},`ts-size-${u}`),L&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let pe={x:0,y:0,w:y.width*x.width,h:y.height*x.height},R=dt(N)?{x:N.timestampX,y:N.timestampY}:{x:(G.x+G.w/2)/X.w,y:(G.y+G.h/2)/X.h},b=!1;this.cancelGesture=Zd(s,pe,i,R,(v,M,E)=>{E||(b=!0),b&&this.mutate(L=>{let V=L.elements.find(K=>K.payload.id===u);V?.kind==="image"&&(V.payload.timestampX=v,V.payload.timestampY=M)},`ts-${u}`),E&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let $=p.payload.chartAnchor,S=$!==void 0&&!St($.at)&&$.place!=="through",k=$!==void 0&&St($.at)&&$.place==="through",C=le[t],z={dx:$?.dx??0,dy:$?.dy??0},B=N=>Math.round(N*10)/10;this.cancelGesture?.(),this.cancelGesture=Ra(s,x,i,{elementId:u,frame:y,handle:r??void 0},{onFrame:(N,J,T)=>{this.mutate(U=>{if($===void 0){Te(U,t,N,{frame:J});return}Te(U,t,N,{frame:{...J,x:S?J.x:y.x,y:y.y}});let X=U.elements.find(R=>R.payload.id===N)?.payload.chartAnchor;if(X===void 0)return;let G=S?z.dx:B(z.dx+(J.x-y.x)*C.width),pe=k?z.dy:B(z.dy+(J.y-y.y)*C.height);G?X.dx=G:delete X.dx,pe?X.dy=pe:delete X.dy},`drag-${N}-${t}`),T&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let s=pt(o,r.id);if(s.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let l=new Map(s.map(x=>[x.payload.id,Ee(o,t,x).frame])),d=[...l.values()],c=Math.min(...d.map(x=>x.x)),u=Math.min(...d.map(x=>x.y)),p=Math.max(...d.map(x=>x.x+x.width)),m=Math.max(...d.map(x=>x.y+x.height)),g={x:c,y:u,width:p-c,height:m-u,rotationDegrees:0},y=x=>Math.round(x*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=Ra(a,this.gestureCanvas(t),i,{elementId:r.id,frame:g},{onFrame:(x,$,S)=>{let k=$.x-g.x,C=$.y-g.y;this.mutate(z=>{for(let[B,N]of l)Te(z,t,B,{frame:{...N,x:y(N.x+k),y:y(N.y+C)}})},`drag-group-${r.id}-${t}`),S&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?Xd:1,s=t*o,l=i*o,d=this.canvasFamily,c=le[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,s,l))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,c,`nudge-multi-${d}`,s,l);if(this.inspect.kind==="group"){let x=this.inspect.id;return this.nudgeMany(pt(r,x).map($=>$.payload.id),d,c,`nudge-group-${x}-${d}`,s,l)}if(this.inspect.kind!=="layer")return!1;let u=this.inspect.id,p=r.elements.find(x=>x.payload.id===u);if(!p)return!1;let m=ut(r,u);if(m?.locked)return this.nudgeMany(pt(r,m.id).map(x=>x.payload.id),d,c,`nudge-group-${m.id}-${d}`,s,l);let g=Ee(r,d,p).frame,y=Io(g,s,l,c);return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>Te(x,d,u,{frame:y}),`nudge-${u}-${d}`),!0}nudgeMany(t,i,a,r,o,s){let l=this.draft?.config;if(!l)return!1;let d=C=>Math.round(C*1e3)/1e3,c=new Map;for(let C of t){let z=l.elements.find(B=>B.payload.id===C);z&&c.set(C,Ee(l,i,z).frame)}if(c.size===0)return!1;let u=[...c.values()],p=Math.min(...u.map(C=>C.x)),m=Math.min(...u.map(C=>C.y)),g=Math.max(...u.map(C=>C.x+C.width)),y=Math.max(...u.map(C=>C.y+C.height)),x={x:p,y:m,width:g-p,height:y-m,rotationDegrees:0},$=Io(x,o,s,a),S=$.x-x.x,k=$.y-x.y;return(S!==0||k!==0)&&this.mutate(C=>{for(let[z,B]of c)Te(C,i,z,{frame:{...B,x:d(B.x+S),y:d(B.y+k)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,s=o?.elements.find(x=>x.payload.id===t);if(!o||s?.kind!=="image"||s.payload.timestamp!==!0)return!1;let l=s.payload,d=le[i],c=Ee(o,i,s).frame,u=c.width*d.width,p=c.height*d.height,m=ga(l,{x:0,y:0,w:u,h:p,cx:u/2,cy:p/2},fa(new Date)),g=dt(l)?{x:l.timestampX,y:l.timestampY}:{x:u>0?(m.x+m.w/2)/u:.5,y:p>0?(m.y+m.h/2)/p:.5},y=Jd(g,a,r,{w:u,h:p});return(y.x!==g.x||y.y!==g.y)&&this.mutate(x=>{let $=x.elements.find(S=>S.payload.id===t);$?.kind==="image"&&($.payload.timestampX=y.x,$.payload.timestampY=y.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=ma(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=bo(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:Pe(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let s=this.draft?.config,l=s?.elements.find(u=>u.payload.id===r);if(!s||!l)return;let d=me(s,l),c=Ee(s,t,l).frame;this.cancelGesture?.(),this.cancelGesture=Ra(a,this.gestureCanvas(t),i,{elementId:r,frame:c,handle:o},{onFrame:(u,p,m)=>{this.mutate(g=>{d?_l(g,u,t,p):Te(g,t,u,{frame:p})},`tap-box-${u}-${t}`),m&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:Hu(this.panelWidth,this.colLeft,this.colRight),r=this.records.find(o=>o.id===this.selectedId);return h`
      <header>
        <label>Choose watch
        ...
        ${this.renderPicker()}
        ${this.hass.user?.is_admin?h`<span class="hor" aria-hidden="true">or</span>${Tu()}`:f}
      ...
      <div class="gate-card">
        ...
        <p class="gate-lead">${Md(t?.app_version)}</p>
        <ol class="gate-steps">
          <li>
      ...
      ${a("all","All",t.length)}
      ${en.map(r=>a(r,te(r),t.filter(o=>i(o).includes(r)).length))}
      ...
      <div class="new-body">
        ...
        <div class="field new-shapes">
          ...
          <div class="shape-cards" role="radiogroup" aria-label="Shape">
            ${en.map(r=>h`<button type="button" role="radio" class="shape-card ${this.newFamily===r?"on":""}"
    ...
    </div>`}setShareLabel(t,i){let a=new Map(this.shareLabels);a.set(t,i),this.shareLabels=a}openShareDialog(){this.draft&&(this.shareOpen=!0,this.shareMode="share",this.shareLabels=new Map,this.shareNote="",this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.share-dialog");t&&!t.open&&t.showModal()}))}closeShareDialog(){let t=this.renderRoot.querySelector("dialog.share-dialog");t?.open?t.close():this.shareOpen=!1}async copyShareText(t){try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),this.shareNote="Copied.";return}}catch{}let i=this.renderRoot.querySelector("dialog.share-dialog textarea");i?.focus(),i?.select();let a=!1;try{a=document.execCommand("copy")}catch{a=!1}this.shareNote=a?"Copied.":"Press Cmd+C or Ctrl+C to copy."}downloadShareText(t){let i=this.draft?.config;if(!i)return;let a=vu(i),r=URL.createObjectURL(new Blob([t],{type:"application/json"})),o=document.createElement("a");o.href=r,o.download=a,o.click(),window.setTimeout(()=>URL.revokeObjectURL(r),0),this.shareNote=`Saved as ${a}.`}renderImportDialog(){let t=this.importParse,i=t?.ok?t.config:void 0,a=i?ss(i,this.hass.states):[],r=ls({parsed:i!==void 0,name:this.importName,taken:this.takenNames(),unchosen:this.unchosenCount(a)});return h`<dialog class="import-dialog" @keydown=${this.importKeys} @close=${()=>{this.importOpen=!1}}>
      <div class="new-head">
      ...
      ${r?h`<div class="hint err">A complication on this watch already has that name.</div>`:h`<div class="hint">${$u(t)}. It opens in the editor and reaches the watch at the first Save.</div>`}
      ...
      ${yu(t)?h`<div class="hint warn">This design filters by areas, labels or floors from the sender's home. Check its aggregate layers after import.</div>`:f}`}renderImportRow(t){let i=this.importMap.get(t.entityId);return h`<div class="xfer-ent">
      ${it({hass:this.hass},t.label,i??gy,a=>this.setImportEntity(t.entityId,a),Su(t.entityId),{compact:!0,domain:t.domain,needed:t.required&&i===void 0})}
    ...
    </div>`}setImportEntity(t,i){let a=new Map(this.importMap);i.entityId===""?a.delete(t):a.set(t,Ya(this.hass.states,i.entityId)),this.importMap=a}setImportText(t){this.importText=t;let i=this.importParse?.ok?JSON.stringify(this.importParse.config):void 0,a=t.trim()===""?void 0:xu(t,this.maxSchemaVersion);if(this.importParse=a,!a?.ok){this.importMap=new Map,this.importName="";return}JSON.stringify(a.config)!==i&&(this.importMap=new Map,this.importName=ku(a.config.name,this.takenNames()))}async readImportFile(t){let i=t.target,a=i.files?.[0];if(a){try{this.setImportText(await a.text())}catch(r){this.importParse={ok:!1,error:`That file could not be read: ${yt(r)}`}}i.value=""}}doImport(){let t=this.importParse;if(!t?.ok)return;let i=wu(t.config,this.importMap);i.id=Y(),i.name=this.importName.trim(),i.slotIndex=this.freeSlot(),i.dataSources=[],i.schemaVersion=Ut(i),this.startNew(i)&&(this.draft?.markDirty(),this.closeImportDialog())}openImportDialog(){!this.hass.user?.is_admin||this.freeSlot()<0||(this.importOpen=!0,this.importText="",this.importParse=void 0,this.importName="",this.importMap=new Map,this.updateComplete.then(()=>{let t=this.renderRoot.querySelector("dialog.import-dialog");t&&(t.open||t.showModal(),t.querySelector("textarea")?.focus())}))}closeImportDialog(){let t=this.renderRoot.querySelector("dialog.import-dialog");t?.open?t.close():this.importOpen=!1}renderBanners(){let t=[],i=this.renderOrphanBanner();if(i&&t.push(i),this.readOnlyReason?t.push(h`<div class="banner warn"><b>Read only.</b> ${this.readOnlyReason}</div>`):this.draft&&!this.hass.user?.is_admin&&t.push(h`<div class="banner warn"><b>Read only.</b> Only a Home Assistant administrator can save complications.</div>`),this.conflict){let a=this.conflict;t.push(h`<div class="banner err"><b>Save rejected.</b> ${a.message}
      ...
      <h2 class="panel-title tools fold-h" role="button" tabindex="0" aria-expanded=${a?"true":"false"}
        ...
        ${a?f:h`<span class="mini">${xo.length} kinds · ${Fi.length} presets</span>`}
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          <b>${Me(T,d)}</b>
          <small><span class="kind">${Mn[T.kind]}</span> · ${Fy(T,c,this.historySeries,R.size)}</small>
          ${C?h`<span class="facts">${My(this.host(),a,T,R).map(V=>h`<span class="fact"><b>${V.label}</b> ${V.value}</span>`)}</span>`:f}
        </span>
        <span class="right">
          <span class="badges">
          ...
          ${i?h`<span class="acts">
            <button class="icon" title=${`Bring forward (${Pt}])`} aria-label="Bring forward" @click=${V=>{V.stopPropagation(),r(G,1)}}>${D("up")}</button>
            <button class="icon" title=${`Send back (${Pt}[)`} aria-label="Send back" @click=${V=>{V.stopPropagation(),r(G,-1)}}>${D("down")}</button>
            <button class="icon" title=${`${R.isHidden?"Show":"Hide"} (${ps}${Pt}H)`} aria-label=${R.isHidden?"Show this layer":"Hide this layer"} @click=${V=>{V.stopPropagation(),this.mutate(K=>Te(K,a,G,{isHidden:!R.isHidden}))}}>${D(R.isHidden?"hide":"show")}</button>
            <button class="icon" title=${`Duplicate (${Pt}D)`} aria-label="Duplicate" @click=${V=>{V.stopPropagation(),o(G)}}>${D("duplicate")}</button>
            <button class="icon danger" title="Delete (Delete)" aria-label="Delete" @click=${V=>{V.stopPropagation(),s(G)}}>${D("delete")}</button>
          </span>`:f}
        </span>
      </div>`},B=(T,U)=>{let X=this.inspect.kind==="group"&&this.inspect.id===T.id,G=!this.collapsed.has(T.id),pe=this.rowDrag(T.id,i),R=U[0],b=U[U.length-1],v=E=>{let L=E.currentTarget,V=L.getBoundingClientRect(),K=V.top+(L.classList.contains("drop-before")?gt:0),fe=V.bottom-(L.classList.contains("drop-after")?gt:0),at=(E.clientY-K)/Math.max(1,fe-K);return at<.25?"drop-before":!G&&at>.75?"drop-after":"drop-into"},M=U.map(E=>E.payload.id);return h`<div class="layer group ${X?"hl":""} ${C?"rich":""}" style=${`--k:${Q.group}`} tabindex="0" draggable=${pe.draggable}
        ...
        @drop=${E=>{E.preventDefault();let L=v(E);this.clearDragMarks();let V=this.dragId;if(this.dragId=void 0,!(!V||!R||!b)){if(L==="drop-before"){this.reorderLayer(V,R.payload.id,!0,!0);return}if(L==="drop-after"){this.reorderLayer(V,b.payload.id,!1,!0);return}this.isGroupId(V)||(this.reorderLayer(V,R.payload.id,!0),this.mutate(K=>Ur(K,V,T.id)))}}}>
        ...
        <span class="name">
          ...
          ${C?h`<span class="facts"><span class="fact"><b>Holds</b> ${U.map(E=>Me(E,d)).join(", ")}</span></span>`:f}
        </span>
        <span class="right">
          ${i?h`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${ps}${Pt}G)`} aria-label="Ungroup" @click=${E=>{E.stopPropagation(),this.mutate(L=>ci(L,T.id)),X&&(this.inspect={kind:"general"})}}>${D("ungroup")}</button>
          </span>`:f}
          <button class="icon lockbtn ${T.locked?"on":""}" ?disabled=${!i}
            ...
            @click=${E=>{E.stopPropagation(),this.mutate(L=>{let V=L.groups?.find(K=>K.id===T.id);V&&(V.locked=!V.locked)})}}>${D(T.locked?"lock":"unlock")}</button>
          <button class="chev" aria-expanded=${G?"true":"false"} title=${G?"Fold the group":"Unfold the group"}
            @click=${E=>{E.stopPropagation();let L=new Set(this.collapsed);G?L.add(T.id):L.delete(T.id),this.collapsed=L}}>${D("chevron")}</button>
        </span>
      </div>`},N=[],J=new Set;for(let T=0;T<l.length;T++){let U=l[T],X=U.payload.groupId,G=X===void 0?void 0:t.groups?.find(b=>b.id===X);if(!G){N.push(z(U,!1));continue}if(J.has(G.id))continue;J.add(G.id);let pe=l.filter(b=>b.payload.groupId===G.id);N.push(B(G,pe));let R=this.inspect.kind==="group"&&this.inspect.id===G.id;this.collapsed.has(G.id)||N.push(h`<div class="group-kids">${pe.map(b=>z(b,!0,R))}</div>`)}return h`<div class="card layers-card s${this.thumbStep}" style=${`--thumb-w:${$}px;--thumb-h:${S}px`}>
      <h2 class="panel-title tools" style=${`--c:${Q.place}`}><span class="swatch">${D("layers")}</span>Layers
        ...
        <span class="tool-set">
          ...
          <span class="seg" role="group" aria-label="Preview size">
            ${wy.map((T,U)=>h`
              <button class=${this.thumbStep===U?"on":""} title=${`${Ru[U]} row pictures`}
                aria-label=${`${Ru[U]} row pictures`} aria-pressed=${this.thumbStep===U?"true":"false"}
      ...
      ${g>=2&&i?h`<div class="group-cta"><span>${g} layers picked</span><span class="spacer"></span>
            ...
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?h`<div class="hint">${Ai}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:f}
      ...
      ${t===void 0?f:h`
        ...
        ${it(this.host(),"Entity",i??{entityId:"",displayName:"",domain:""},a=>{this.presetEntity=a.entityId===""?void 0:a},Cu,{compact:!0,...t.domains?{domain:t.domains}:{},...t.preferNumeric?{preferNumeric:!0}:{}})}
        <div class="adders">
    ...
    </dialog>`}openPreset(t){this.canEdit&&(this.presetKind=t,this.presetEntity=void 0,this.updateComplete.then(()=>{let i=this.renderRoot.querySelector("dialog.preset-dialog");i&&(i.open||i.showModal(),i.querySelector(".entity-field input")?.focus())}))}closePresetDialog(){let t=this.renderRoot.querySelector("dialog.preset-dialog");t?.open?t.close():(this.presetKind=void 0,this.presetEntity=void 0)}createFromPreset(){let t=this.presetKind,i=this.presetEntity;if(!t||!i)return;let a={family:this.canvasFamily},r=this.hass.states[i.entityId];r&&(a.state=r);let o;this.addHere(s=>{o=pu(s,t,i,a)}),this.closePresetDialog(),o&&(this.inspect={kind:"layer",id:o})}renderCanvas(){if(this.parseError)return h`<div class="card error">This document cannot be read: ${this.parseError}</div>`;let t=this.draft?.config;if(!t)return h`<div class="card"><div class="empty">Choose a complication in the picker above, or make a new one.</div></div>`;let i=ca(t,this.buildContext(),this.forced);this.syncCountdownTicker(i);let a=this.currentCase(),r=this.activeFamily;return h`
      ...
      ${ba(r,m)}
    </div>`}renderUnder(t,i){let a=ce(this.host()),r=this.inspect,o=r.kind==="layer"?t.elements.find(u=>u.payload.id===r.id):void 0,s;if(this.showTaps)s=h`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${ct(t.tapAction)}</b>.`;else if(this.picking)s="Point at a layer and click it. Escape stops.";else if(i==="inline")s="One line of text. Edit it on the right.";else if(r.kind==="group"){let u=t.groups?.find(m=>m.id===r.id),p=u?pt(t,u.id).length:0;s=u?h`editing group <b>${u.name}</b>. Drag to move all ${p} layers.${u.locked?"":" Click one layer to move it alone."}`:""}else if(o){let u=ut(t,o.payload.id);s=u?.locked?h`editing <b>${Me(o,a)}</b> in <b>${u.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:h`editing <b>${Me(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else s="click a layer to edit it";if(i==="inline")return h`<div class="under"><b>Inline</b><span class="dot">·</span><span class="tail">${s}</span></div>`;let l=this.currentCase().slots[i],d=ma(l,i),c=Math.round(d.scale*100);return h`<div class="under">
      <b>${te(i)}</b>
      <span class="size">${l.width} × ${l.height} pt${c!==100?` \xB7 ${c}%`:""}</span>
      <span class="dot">·</span>
      <span class="tail">${s}</span>
    </div>`}renderInlinePreview(t,i){let a;if(!t)a=h`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?Sn((t.countdownEnd-r)/1e3):t.text,s=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=h`<div class="inline-line">${s??f}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:h`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSharedValues(){let t=this.draft?.config;if(!t)return f;let i=t.values,a=this.canEdit?h`<button class="small" @click=${()=>{let c=Kc();this.mutate(u=>{u.values.push(c)}),this.openSharedValue(c.id)}}>Add</button>`:f,r="Like a variable: set it once, and every layer that reads it follows.",o=h`<h2 class="panel-title"><span class="swatch">${D("content")}</span>Shared values
      ...
      </span>`})}renderValuesRow(){let t=this.draft?.config;if(!t)return f;let i=[...this.compiled?.entities.keys()??[]],a=Wl(t),r=this.testValues.size>0;return h`<div class="card tint-states" style=${`--c:${Q.states}`}>
      ...
      ${i.length===0&&a.length===0?h`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:h`<div class="chips values">
        ${i.map(o=>{let s=this.hass.states[o],l=typeof s?.attributes.friendly_name=="string"?s.attributes.friendly_name:o,d=typeof s?.attributes.unit_of_measurement=="string"?` ${s.attributes.unit_of_measurement}`:"",c=s?`${s.state}${d}`:"not in Home Assistant",u=this.testValues.get(o),m=t.elements.find(g=>ia(t,g.payload.id).some(y=>y.ref.entityId===o))?.kind??"text";return h`<div class="vchip vrow ctl ${u!==void 0?"testing":""}" style=${`--k:${ze[m]}`}
    ...
    </div>`}renderTestControl(t,i,a,r,o,s){let l=r??a?.state??"",d=ql(t,a,r);if(d.kind==="choice")return h`<span class="test-ctl"><select aria-label=${`Test value for ${i}`} @change=${m=>this.setTestValue(t,m.target.value)}>
      ...
      <span class="comp-acts">
        ...
        <div class="insp-body" style=${o} @change=${()=>this.draft?.endGesture()}>
          ${xe(a,"complication","Complication",Bc(a),{color:Q.complication,icon:"watch",alwaysOpen:!0})}
        ...
        </div>`;let s=f,l=!0;if(r.kind==="layer"){let c=t.elements.find(u=>u.payload.id===r.id);if(!c)return this.inspect={kind:"general"},f;s=Xc(a,c,this.canvasFamily,{placement:!0,tap:!0})}else if(r.kind==="group"){let c=t.groups?.find(u=>u.id===r.id);if(!c)return this.inspect={kind:"general"},f;l=!1,s=Zc(a,c)}else s=Qc(a,this.activeFamily);let d=this.openSections.size>1;return h`
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?h`<button class="expand" @click=${()=>{this.openSections=d?new Set([vy(r)]):new Set(Xo)}}>${d?"One at a time":"Open all"}</button>`:f}
      </div>
      ...
      ${xe(r,"picked",`${d} layers picked`,h`
            ...
            <div class="picked">
              ${c.map(m=>h`<div class="row" style=${`--k:${ze[m.kind]}`}>
                ...
                <span class="name">
                  ...
                  <b>${Me(m,o)}</b><span class="kind">${Mn[m.kind]}</span>
                </span>
              </div>`)}
            </div>
            <div class="row-acts">
          ...
          <div class="hint">${Ai}-click a layer to add it or take it out. Click one on its own to edit it alone.</div>`,{color:"var(--wa-accent)",icon:"layers",summary:`Edits here land on all ${d}`,alwaysOpen:!0})}
