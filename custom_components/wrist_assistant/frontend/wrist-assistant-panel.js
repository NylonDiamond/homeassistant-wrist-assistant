    ...
    <div class="hint">On the ${Q(t)} shape only. Arrow keys nudge 1 pt, shift for 10.</div>`,{color:te.place,icon:"place",summary:`${Math.round(s.width*100)}% wide \xB7 ${Q(t)}`,...i.inline?{alwaysOpen:!0,cardClass:"place-bar",bodyClass:"place-row"}:{},...d?{resetTitle:`Put this layer back to the middle of the ${Q(t)} face at half size, unrotated and shown`,reset:()=>e.update(u=>xe(u,t,a,{frame:{...Ke},isHidden:!1}))}:{}})}function cr(e,n,t={}){let i=t.placeholder;if(i===void 0&&(n===void 0||n.kind==="tap"))return f;let a=n!==void 0&&n.kind!=="tap"?n:void 0,r=a?Te(e.config,a.payload.id)[0]:void 0,o=r===void 0,s=i===void 0&&a!==void 0?op(e,a,`el-${a.payload.id}`):p`
      ...
      <div class="hint">${i}</div>`;return Ce(e,"tappable","Tap",s,{color:te.tap,icon:"tap",summary:r?je(r.payload.action):"Not tappable",...t.inline?{alwaysOpen:!0,cardClass:`tap-bar${o?" muted-bar":""}`,bodyClass:"tap-row"}:{},...r&&a?{reset:()=>e.update(l=>ni(l,a.payload.id))}:{}})}function $l(e,n,t,i={}){let a=n.payload.id,r=e.config.elements.findIndex(y=>y.payload.id===a),o=`el-${a}`,s=(y,x)=>e.update(O=>y(O.elements[r]),x?`${o}-${x}`:void 0),l=Se(e.config,t,n),d=l.frame,u=(y,x)=>e.update(O=>xe(O,t,a,{frame:Ja(d,y)}),`${o}-${x}-${t}`),c=Pe(n.kind).payload,h=c.colorSlot?.baseColorHex??"#FFFFFF",m=y=>c[y],g,v;switch(n.kind){case"text":{let y=ya(e.config,n.payload.value);g=p`
        ...
        ${P?p`
            ...
            <div class="grid2">
              ${Js(a,y.historyMinutes,G,M=>x(H=>{H.historyMinutes=M}))}
            ...
            ${at?Zs(y.historyMinutes,M=>x(H=>{H.historyMinutes=M},"span")):f}
        ...
        <div class="grid2">
          ${ae("Style",y.style,fu,M=>x(H=>{H.style=M}),{def:c.style})}
        ...
        <div class="grid2">
          ${ae("Scale",y.scale,gu,M=>x(H=>{H.scale=M}),{titles:{auto:"The plot stretches to fit the readings it has",fixed:"The plot always runs from Min to Max"},def:c.scale})}
          ${ae("Baseline",y.baseline,yu,M=>x(H=>{H.baseline=M}),{def:c.baseline})}
        </div>
        ${Pi.length===0?f:Fe("Same scale as",Oi?y.scaleFrom:"",[["","Its own"],...Pi.map(M=>[M.payload.id,Re(M,Jl)])],M=>x(H=>{M?H.scaleFrom=M:delete H.scaleFrom}),{def:""})}
        ...
        <button class="small" title="Add a second chart layer on this frame, drawn against this chart's range"
          @click=${()=>{let M;e.update(H=>{M=Ao(H,a)}),M&&e.selectLayer(M)}}>
          ${_("plus")}<span>Second series</span></button>
        ${ae("Colour",y.coloring,Ds,M=>x(H=>{H.coloring=M,M==="bands"&&H.bands.length===0&&(H.bands=Vs(ee))}),{def:c.coloring})}
        ${y.coloring==="bands"?p`
        ...
        <div class="grid2">
          ${ae("Highlight",y.highlight,cl,M=>x(H=>{H.highlight=M}),{def:c.highlight})}
          ${y.highlight==="none"?f:ae("Marker",y.marker,bu,M=>x(H=>{H.marker=M}),{def:c.marker})}
        </div>
        ...
        ${Me("Threshold line",y.thresholdValue!==void 0,M=>x(H=>{M?H.thresholdValue=vu(ee):delete H.thresholdValue}))}
