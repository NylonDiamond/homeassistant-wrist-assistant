...
`)}function kr(e){let n;try{n=JSON.parse(e)}catch{return}if(typeof n!="object"||n===null||Array.isArray(n))return;let t=new Map,i=new Set;for(let[a,r]of Object.entries(n))r===null?i.add(a):t.set(a,rl(r));return{values:t,nullKeys:i}}function rl(e){return typeof e=="string"?e:typeof e=="boolean"?e?"true":"false":typeof e=="number"?(Number.isInteger(e)&&Math.abs(e)<1e15,String(e)):JSON.stringify(e)}function Ti(e){let n=Ei(e),t=[...n.entities.entries()].sort(([i],[a])=>i<a?-1:i>a?1:0).map(([,i])=>({kind:"entity",entityId:i.entityId,displayName:i.displayName,domain:i.domain,...i.iconName!==void 0?{iconName:i.iconName}:{}}));return n.document&&t.push({kind:"template",value:n.document}),t}function ol(e,n){if(e.values.length!==0)switch(n){case"latest":return e.values[e.values.length-1];case"highest":return Math.max(...e.values);case"lowest":return Math.min(...e.values);case"average":return e.values.reduce((t,i)=>t+i,0)/e.values.length;case"top":return e.domainMax;case"bottom":return e.domainMin}}function bn(e){let n=e;if(/^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?$/.test(n))return Number(n);let t=n.toLowerCase();if(t==="inf"||t==="+inf"||t==="infinity"||t==="+infinity")return 1/0;if(t==="-inf"||t==="-infinity")return-1/0;if(t==="nan"||t==="+nan"||t==="-nan")return NaN}function bt(e){let n=e.trim(),t=bn(n);if(t!==void 0)return t;let i="";for(let r of n)if(/\p{N}/u.test(r)||r==="."||r==="-"||r==="+")i+=r;else if(i.length>0)break;return i.length===0?void 0:bn(i)}function sl(e){return Number.isInteger(e)&&Math.abs(e)<1e16?e.toFixed(1):String(e)}function ll(e){let n=Math.max(0,e);return n<60?`${Math.trunc(n)}s`:n<3600?`${Math.trunc(n/60)}m`:n<86400?`${Math.trunc(n/3600)}h`:`${Math.trunc(n/86400)}d`}function dl(e){return e.replace(/\S+/g,n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase())}function cl(e,n,t){if(Fe(n))return e;let i=n,a=e,r=bn(e.trim());if(i.relativeTime&&r!==void 0)a=ll(r);else{let o=bt(e);if(o!==void 0){let l=o*(i.multiply??1)+(i.offset??0);i.decimals!==void 0?a=l.toFixed(Math.max(0,i.decimals)):l!==o&&(a=Number.isInteger(l)?String(l):sl(l))}}switch(i.useEntityUnit&&t&&(a+=t.startsWith("\xB0")||t.startsWith("%")?t:` ${t}`),i.prefix&&(a=i.prefix+a),i.suffix&&(a=a+i.suffix),i.textCase){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"capitalized":a=dl(a);break}return a}function vt(e){let n=Math.trunc(Math.max(0,e)),t=Math.trunc(n/3600),i=Math.trunc(n%3600/60),a=n%60,r=o=>String(o).padStart(2,"0");return t>0?`${t}:${r(i)}:${r(a)}`:`${i}:${r(a)}`}function Bt(e,n=240){let t=[],i="",a=!1,r=()=>{if(i!==""){let o=Number(i);Number.isFinite(o)&&t.push(o)}i=""};for(let o of e){if(t.length>=n)break;if(o>="0"&&o<="9")i+=o,a=!0;else if(o===".")i.includes(".")&&r(),i+=".",a=!0;else if(o==="-"||o==="+"){let l=!a;r(),l&&(i+=o),a=!1}else r(),a=!1}return t.length<n&&r(),t}function pl(e,n){let t,i;return n.scale==="fixed"?(t=Math.min(n.minValue,n.maxValue),i=Math.max(n.minValue,n.maxValue)):(t=e.length>0?Math.min(...e):0,i=e.length>0?Math.max(...e):1),n.baseline==="zero"&&(t=Math.min(t,0),i=Math.max(i,0)),i>t||(i=t+1),{min:t,max:i}}function ul(e,n,t){if(e===void 0)return 0;let i=bt(e);if(i===void 0||Number.isNaN(i))return 0;let a=t-n;return a===0?0:Math.min(1,Math.max(0,(i-n)/a))}var Pe=class{constructor(n,t){this.ctx=n;this.charts=new Map;this.named=new Map(n.namedValues.map(i=>[i.id.toUpperCase(),i.value])),t&&this.settleCharts(t)}chartReadings(n){let t=tt(n),i=t!==void 0?this.ctx.historySeries?.get(t)??"":this.resolve(n.value)??"",a=Bt(i);n.limit>0&&a.length>n.limit&&(a=n.takeFromEnd?a.slice(a.length-n.limit):a.slice(0,n.limit));let r=pl(a,n),o={values:a,domainMin:r.min,domainMax:r.max},l=this.dereference(n.value);return l&&"entityId"in l.kind&&(o.entity={entityId:l.kind.entityId,displayName:l.kind.displayName,domain:l.kind.domain}),o}settleCharts(n){for(let t of n.elements)t.kind==="chart"&&this.charts.set(t.payload.id,this.chartReadings(t.payload))}dereference(n){let t=n,i=new Set,a=n.format;for(;t.kind.kind==="named";){let o=t.kind.id.toUpperCase();if(i.has(o))return;i.add(o);let l=this.named.get(o);if(!l)return;a=a&&!Fe(a)?a:l.format,t=l}let r={kind:t.kind};return a&&(r.format=a),r}directEntityUnit(n){let t=n.kind;if(t.kind==="entityState"||t.kind==="entityAttribute"||t.kind==="entityAge")return this.ctx.entityStates.get(t.entityId)?.unitOfMeasurement;if(t.kind==="chartStat"){let i=this.charts.get(t.layer.toUpperCase())?.entity;return i?this.ctx.entityStates.get(i.entityId)?.unitOfMeasurement:void 0}}resolve(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i;switch(t.kind.kind){case"literal":i=t.kind.value;break;case"entityState":i=this.ctx.entityStates.get(t.kind.entityId)?.state;break;case"dataAge":i=this.ctx.dataAgeSeconds===void 0?void 0:String(Math.trunc(this.ctx.dataAgeSeconds));break;case"chartStat":{let a=this.charts.get(t.kind.layer.toUpperCase()),r=a?ol(a,t.kind.stat):void 0;i=a&&r!==void 0?Ya(r,a.domainMax-a.domainMin):void 0;break}default:{let a=Si(n,this.named);i=a===void 0?void 0:this.ctx.templateResults.get(a)}}if(i!==void 0)return cl(i,t.format,this.directEntityUnit(t))}nowMs(){return this.ctx.nowMs??Date.now()}countdownEnd(n){if(!n)return;let t=this.dereference(n);if(!t)return;let i=t.kind;if(i.kind==="entityState"){let o=this.ctx.entityStates.get(i.entityId);if(o?.timerState!==void 0){if(o.timerState!=="active"||!o.finishesAt)return;let l=Date.parse(o.finishesAt);return Number.isFinite(l)&&l>this.nowMs()?l:void 0}}let a=this.resolve(n)?.trim();if(!a)return;let r=Date.parse(a);if(!Number.isFinite(r)){let o=bn(a);r=o===void 0?NaN:o*1e3}return Number.isFinite(r)&&r>this.nowMs()?r:void 0}countdownFallbackText(n){if(!n)return;let t=this.dereference(n);if(!t||t.kind.kind!=="entityState")return;let i=this.ctx.entityStates.get(t.kind.entityId);if(i?.timerState!==void 0)return i.timerState==="paused"?i.remaining!==void 0&&i.remaining>0?vt(i.remaining):"Paused":"Idle"}entityIcon(n){let t=this.dereference(n);return!t||t.kind.kind!=="entityState"?void 0:this.ctx.entityStates.get(t.kind.entityId)?.iconName??t.kind.iconName}isStale(){return(this.ctx.dataAgeSeconds??1/0)>(this.ctx.stalenessThresholdSeconds??1200)}evaluateTest(n){let t=n.comparison;if(t.kind==="isStale")return this.isStale();let i=this.resolve(n.value);if(i===void 0)return t.kind==="isUnavailable";let a=bt(i),r=()=>this.resolve(t.value),o=()=>{let s=r();return s===void 0?void 0:bt(s)},l=s=>{let d=o();return a===void 0||d===void 0?!1:s(a,d)};switch(t.kind){case"equals":{let s=r();return s!==void 0&&i===s}case"notEquals":{let s=r();return s!==void 0&&i!==s}case"isOn":return i.toLowerCase()==="on";case"isOff":return i.toLowerCase()==="off";case"isUnavailable":{let s=i.toLowerCase();return s==="unavailable"||s==="unknown"}case"isEmpty":return i.trim().length===0;case"greaterThan":return l((s,d)=>s>d);case"greaterOrEqual":return l((s,d)=>s>=d);case"lessThan":return l((s,d)=>s<d);case"lessOrEqual":return l((s,d)=>s<=d);case"between":{let s=o(),d=this.resolve(t.upper),p=d===void 0?void 0:bt(d);if(a===void 0||s===void 0||p===void 0)return!1;let[c,h]=s<=p?[s,p]:[p,s];return a>=c&&a<=h}case"contains":{let s=r();return!!s&&i.toLowerCase().includes(s.toLowerCase())}case"startsWith":{let s=r();return!!s&&i.toLowerCase().startsWith(s.toLowerCase())}case"endsWith":{let s=r();return!!s&&i.toLowerCase().endsWith(s.toLowerCase())}case"matchesRegex":{if(!t.pattern)return!1;try{return new RegExp(t.pattern).test(i)}catch{return!1}}case"isOneOf":return(t.options??[]).some(s=>s.toLowerCase()===i.toLowerCase());default:return!1}}evaluateCondition(n){return n.tests.length===0?!0:n.join==="any"?n.tests.some(t=>this.evaluateTest(t)):n.tests.every(t=>this.evaluateTest(t))}applyRules(n,t){let i=new Map;for(let a of n){let r=t?.get(a.id),o=[];if(r&&r!=="live")r==="otherwise"?o=a.otherwise??[]:o=a.cases.find(l=>l.id===r.caseId)?.then??[];else{let l=a.cases.find(s=>this.evaluateCondition(s.when));o=l?l.then:a.otherwise??[]}for(let l of o)i.set(fe[l.kind],l)}return i}liveBranches(n){let t=new Map;for(let i of n){let a=i.cases.find(r=>this.evaluateCondition(r.when));t.set(i.id,a?a.id:i.otherwise?"otherwise":"none")}return t}styleColor(n,t){let i=n.get(t);if(!i)return;let a=this.resolve(i.value);return a||void 0}styleText(n,t){let i=n.get(t);return i?this.resolve(i.value):void 0}styleNumber(n,t){return n.get(t)?.number}resolveElement(n,t){let i=n.payload,a=this.applyRules(i.rules,t),r=a.get("visibility"),o=r?r.kind==="hide":i.isHidden,l=this.styleNumber(a,"rotation"),s=l===void 0?i.frame:{...i.frame,rotationDegrees:l},d=this.styleNumber(a,"opacity")??1,p={id:i.id,isHidden:o,frame:s,opacity:d};switch(n.kind){case"text":{let c=n.payload.countdown?this.countdownEnd(n.payload.value):void 0,h=n.payload.countdown?this.countdownFallbackText(n.payload.value):void 0,f={kind:"text",...p,text:this.styleText(a,"text")??h??this.resolve(n.payload.value)??"--",fontSize:this.styleNumber(a,"fontSize")??n.payload.fontSize,fontWeight:a.get("fontWeight")?.weight??n.payload.fontWeight,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex};return c!==void 0&&(f.countdownEnd=c),f}case"icon":{let c=this.entityIcon(n.payload.symbol)??this.resolve(n.payload.symbol)??"questionmark.circle";return{kind:"icon",...p,symbol:this.styleText(a,"icon")??c,size:this.styleNumber(a,"fontSize")??n.payload.size,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex}}case"gauge":{let c=this.styleText(a,"gaugeValue")??this.resolve(n.payload.value),h=this.styleNumber(a,"gaugeMin")??n.payload.minValue,f=this.styleNumber(a,"gaugeMax")??n.payload.maxValue;return{kind:"gauge",...p,fraction:ul(c,h,f),style:n.payload.style,lineWidth:n.payload.lineWidth,colorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,trackColorHex:n.payload.trackColorHex}}case"chart":{let c=n.payload,h=this.charts.get(c.id)??this.chartReadings(c),f=h.values,y={min:h.domainMin,max:h.domainMax},k=this.styleColor(a,"color")??c.colorSlot.baseColorHex,w=gt(c),E=ja(c)?f.map(m=>qa(m,w,c.bandAboveColorHex)):[],R={kind:"chart",...p,values:f,style:c.style,domainMin:y.min,domainMax:y.max,baseline:c.baseline,barGap:c.barGap,lineWidth:c.lineWidth,colorHex:k,highColorHex:c.highColorHex,lowColorHex:c.lowColorHex,marker:c.marker,pointColorHexes:E,fillBands:c.fillBands};if(f.length>0){let m=c.highlight==="highest"||c.highlight==="both",b=c.highlight==="lowest"||c.highlight==="both",$=m?f.indexOf(Math.max(...f)):-1,L=b?f.indexOf(Math.min(...f)):-1;$>=0&&(R.highIndex=$),L>=0&&L!==$&&(R.lowIndex=L)}return R}case"shape":{let c={kind:"shape",...p,shapeKind:n.payload.kind,cornerRadius:n.payload.cornerRadius,fillColorHex:this.styleColor(a,"color")??n.payload.colorSlot.baseColorHex,borderWidth:this.styleNumber(a,"borderWidth")??n.payload.borderWidth},h=this.styleColor(a,"borderColor")??n.payload.borderColorHex;return h!==void 0&&(c.borderColorHex=h),c}case"image":{let c={kind:"image",...p,entityId:n.payload.entity.entityId,showTimestamp:n.payload.timestamp===!0,contentMode:n.payload.contentMode,zoom:n.payload.zoom,panX:n.payload.panX,panY:n.payload.panY,cornerRadius:n.payload.cornerRadius,timestampCorner:n.payload.timestampCorner,timestampSize:n.payload.timestampSize};Ae(n.payload)&&(c.timestampX=n.payload.timestampX,c.timestampY=n.payload.timestampY);let h=this.ctx.entityStates.get(n.payload.entity.entityId)?.entityPicture;return h!==void 0&&(c.url=h),c}case"tap":{let c={kind:"tap",...p,frame:n.payload.frame,opacity:1,action:n.payload.action};return n.payload.openPageId!==void 0&&(c.openPageId=n.payload.openPageId),n.payload.attachedTo!==void 0&&(c.attachedTo=n.payload.attachedTo),c}}}resolveLayout(n,t,i){let a=n.perFamily[t];this.settleCharts(n);let r=cr(n,t).map(k=>this.resolveElement(k,i)),o=a?this.applyRules(a.rules,i):new Map,l={family:t,elements:r,cornerBodyShape:a?.cornerBodyShape??"wedge",borderWidth:this.styleNumber(o,"borderWidth")??a?.borderWidth??2},s=this.styleText(o,"text"),d=a?.bezelCountdown&&s===void 0?this.countdownEnd(a.bezelText):void 0,p=a?.bezelCountdown?this.countdownFallbackText(a.bezelText):void 0,c=s??p??this.resolve(a?.bezelText);c!==void 0&&(l.bezelText=c),d!==void 0&&(l.bezelCountdownEnd=d);let h=this.resolve(a?.curvedText);if(h!==void 0&&(l.curvedText=h),a?.curvedColorHex!==void 0&&(l.curvedColorHex=a.curvedColorHex),a?.bezelGauge){let k=a.bezelGauge,w=this.resolve(k.value),E=w===void 0?void 0:bt(w);if(E!==void 0){let R=Math.min(k.minValue,k.maxValue),m=Math.max(k.minValue,k.maxValue),b={value:Math.min(m,Math.max(R,E)),minValue:R,maxValue:m===R?R+1:m,colorHexes:k.colorHexes},$=this.resolve(k.minLabel);$!==void 0&&(b.minLabel=$);let L=this.resolve(k.maxLabel);L!==void 0&&(b.maxLabel=L),l.bezelGauge=b}}let f=this.styleColor(o,"backgroundColor")??a?.backgroundColorHex;f!==void 0&&(l.backgroundColorHex=f);let y=this.styleColor(o,"borderColor")??a?.borderColorHex;return y!==void 0&&(l.borderColorHex=y),l}};function hl(e,n,t){let i=new Pe(n,t),a=e.countdown?i.countdownEnd(e.value):void 0,o={text:(e.countdown?i.countdownFallbackText(e.value):void 0)??i.resolve(e.value)??"--"};return e.label&&(o.label=e.label),e.symbol&&(o.symbol=e.symbol),a!==void 0&&(o.countdownEnd=a),o}function Fi(e,n,t){let i=new Pe(n),a={};for(let r of["rectangular","circular","corner"])e.supportedFamilies.includes(r)&&(a[r]=i.resolveLayout(e,r,t));return e.supportedFamilies.includes("inline")&&e.inline&&(a.inline=hl(e.inline,n,e)),a}var pe=me,Gt=[{label:"40 mm",screen:{width:162,height:197},slots:{rectangular:{width:141,height:51},circular:{width:40,height:40},corner:{width:26,height:26}},measured:!1},{label:"41 mm",screen:{width:176,height:215},slots:{rectangular:{width:153,height:55.5},circular:{width:43,height:43},corner:{width:29,height:29}},measured:!1},{label:"42 mm",screen:{width:187,height:223},slots:{rectangular:{width:163,height:59},circular:{width:46,height:46},corner:{width:31,height:31}},measured:!1},{label:"44 mm",screen:{width:184,height:224},slots:{rectangular:{width:160,height:58},circular:{width:45,height:45},corner:{width:30,height:30}},measured:!1},{label:"45 mm",screen:{width:198,height:242},slots:{rectangular:{width:172,height:62.5},circular:{width:48.5,height:48.5},corner:{width:32,height:32}},measured:!1},{label:"46 mm",screen:{width:208,height:248},slots:pe,measured:!0},{label:"49 mm",screen:{width:205,height:251},slots:{rectangular:{width:178.5,height:64.5},circular:{width:50,height:50},corner:{width:33.5,height:33.5}},measured:!1}],Ut=Gt.find(e=>e.measured);function Mr(e){if(!e)return;let n=/^(\d+)x(\d+)$/.exec(e.trim());if(!n)return;let t=Number(n[1]),i=Number(n[2]);return Gt.find(a=>a.screen.width===t&&a.screen.height===i)}function xn(e,n){let t=pe[n];if(e.width<=0||e.height<=0)return{scale:0,x:0,y:0,width:0,height:0};let i=Math.min(e.width/t.width,e.height/t.height),a=t.width*i,r=t.height*i;return{scale:i,x:(e.width-a)/2,y:(e.height-r)/2,width:a,height:r}}var ml={regular:400,medium:500,semibold:600,bold:700};function Re(e){if(!e)return;let n=e.startsWith("#")?e.slice(1):e;if(!/^[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/.test(n))return;let t=n.length===8?parseInt(n.slice(6,8),16)/255:1;return{color:`#${n.slice(0,6)}`,opacity:t}}function Ne(e,n,t="#FFFFFF"){let i=Re(e)??{color:t,opacity:1};return{[n]:i.color,[`${n}-opacity`]:i.opacity}}function Ar(e,n){let t=Math.max(0,e.frame.width*n.width),i=Math.max(0,e.frame.height*n.height),a=(e.frame.x+e.frame.width/2)*n.width,r=(e.frame.y+e.frame.height/2)*n.height;return{x:a-t/2,y:r-i/2,w:t,h:i,cx:a,cy:r}}function fl(e,n){let t=Ne(e.colorHex,"fill");e.countdownEnd!==void 0&&e.countdownEnd>Date.now()&&(e={...e,text:vt((e.countdownEnd-Date.now())/1e3)});let i=s=>s*.55,a=e.text.length*i(e.fontSize),r=a>n.w&&n.w>0?Math.max(.5,n.w/a):1,o=e.fontSize*r,l=e.text;if(n.w>0&&l.length*i(o)>n.w){let s=n.w-.8*o,d=Math.max(1,Math.floor(s/i(o)));l=`${l.slice(0,d).replace(/\s+$/,"")}\u2026`}return v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
    ...
    <g transform="rotate(${d} ${n.cx} ${n.cy})">
      ...
      ${e.fraction>0?v`<circle cx=${n.cx} cy=${n.cy} r=${o} fill="none" stroke-width=${a} stroke-linecap="round"
    ...
    </g>`}var yl=5;function bl(e,n){let t=e.values,i=Math.max(t.length,1),a=e.highIndex!==void 0||e.lowIndex!==void 0,r=e.marker==="none"||!a?0:yl,o=e.style==="bars"?0:e.lineWidth/2,l=n.x,s=Math.max(n.w,0),d=n.y+r+o,p=Math.max(n.h-r-o*2,1),c=d+p,h=Math.max(e.domainMax-e.domainMin,Number.EPSILON),f=e.baseline==="lowest",y=f?p*.12:0,k=Math.min(Math.max(e.barGap,0),s/(i*2)),w=Math.max((s-k*(i-1))/i,.5),E=m=>Math.min(1,Math.max(0,(m-e.domainMin)/h)),R=m=>c-E(m)*p;return{count:t.length,barWidth:w,plotTop:d,plotBottom:c,baselineY:f?c:R(0),barRect(m){let b=l+m*(w+k),$=t[m],L,O;if(f){let X=y+E($)*(p-y);L=c-X,O=c}else L=R($),O=f?c:R(0),L>O&&([L,O]=[O,L]);return{x:b,y:L,w,h:Math.max(O-L,.5)}},point(m){let b=Math.max(s-o*2,0);return{x:t.length>1?l+o+b*m/(t.length-1):l+s/2,y:R(t[m])}},markerCenter(m,b){let $=b?this.barRect(m):void 0;return{x:$?$.x+$.w/2:this.point(m).x,y:n.y+r/2}}}}function vl(e,n){if(e.values.length===0)return g;let t=bl(e,n),i=Ne(e.colorHex,"fill"),a=Ne(e.highColorHex,"fill",e.colorHex),r=Ne(e.lowColorHex,"fill",e.colorHex),o=(p,c)=>v`<circle cx=${p.x} cy=${p.y} r="1.7" fill=${c.fill} fill-opacity=${c["fill-opacity"]} />`,l=[],s=e.pointColorHexes.length===t.count,d=p=>s?Ne(e.pointColorHexes[p],"fill",e.colorHex):i;if(e.style==="bars")for(let p=0;p<t.count;p++){let c=t.barRect(p),h=p===e.highIndex?a:p===e.lowIndex?r:d(p),f=Math.min(1.2,c.w/2,c.h/2);l.push(v`<rect x=${c.x} y=${c.y} width=${c.w} height=${c.h} rx=${f}
        fill=${h.fill} fill-opacity=${h["fill-opacity"]} />`)}else{let p=Array.from({length:t.count},(h,f)=>t.point(f)),c=p.map((h,f)=>`${f===0?"M":"L"}${h.x} ${h.y}`).join(" ");if(e.style==="area")if(e.fillBands&&s&&t.count>1)for(let h=0;h<t.count-1;h++){let f=p[h],y=p[h+1],k=d(h+1),w=`M${f.x} ${f.y} L${y.x} ${y.y} L${y.x} ${t.baselineY} L${f.x} ${t.baselineY} Z`;l.push(v`<path d=${w} fill=${k.fill}
          ...
          fill-opacity=${i["fill-opacity"]*.28} stroke="none" />`)}if(s&&t.count>1)for(let h=0;h<t.count-1;h++){let f=p[h],y=p[h+1],k=d(h+1);l.push(v`<path d=${`M${f.x} ${f.y} L${y.x} ${y.y}`} fill="none"
        ...
        fill=${t.fill} fill-opacity=${t["fill-opacity"]}
        stroke=${o} stroke-opacity=${l} stroke-width=${a} />`}}function wl(e,n,t){let i=t.render(e.symbol,e.size,e.colorHex);if(i)return v`<g transform="translate(${n.cx-e.size/2} ${n.cy-e.size/2})">${i}</g>`;let a=Ne(e.colorHex,"stroke"),r=e.size;return v`
    ...
    <text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central" font-size=${r*.5}
      fill=${a.stroke} fill-opacity=${a["stroke-opacity"]} font-family="sans-serif">?</text>`}var Li=.25,kl=8;function $l(e,n,t,i,a,r,o,l){let s={x:0,y:0,width:e,height:n};if(!(e>0)||!(n>0)||!(t>0)||!(i>0))return s;let d=Math.min(Math.max(Number.isFinite(r)?r:1,Li),kl),p=Math.max(e/t,n/i),c=Math.min(e/t,n/i),h=(a==="fit"?c:p)*d,f=t*h,y=i*h,k=Math.min(Math.max(Number.isFinite(o)?o:0,-1),1),w=Math.min(Math.max(Number.isFinite(l)?l:0,-1),1);return{x:-(f-e)/2*(1+k)+0,y:-(y-n)/2*(1+w)+0,width:f,height:y}}function wn(e){let n=e.getHours()%12||12,t=i=>String(i).padStart(2,"0");return`${n}:${t(e.getMinutes())}:${t(e.getSeconds())}`}var vn=4;function kn(e,n,t){let i=Math.min(Math.max(e.timestampSize,4),40),a=t.length*i*.578+i*.89,r=i*1.25;if(!(Number.isFinite(e.timestampX)&&Number.isFinite(e.timestampY))){let s=e.timestampCorner.endsWith("Leading")?n.x+vn:n.x+n.w-vn-a,d=e.timestampCorner.startsWith("top")?n.y+vn:n.y+n.h-vn-r;return{x:s,y:d,w:a,h:r,size:i,label:t}}let l=(s,d,p,c)=>c>=p?d+(p-c)/2:Math.min(d+p-c,Math.max(d,s-c/2));return{x:l(n.x+e.timestampX*n.w,n.x,n.w,a),y:l(n.y+e.timestampY*n.h,n.y,n.h,r),w:a,h:r,size:i,label:t}}function Cl(e,n,t){let i=t.icons,a=`imgclip-${e.id}`,r=Math.max(0,e.cornerRadius),o=e.showTimestamp&&e.url?kn(e,n,wn(new Date)):void 0,l=o?v`
        ...
        <text data-ts-handle="1" x=${o.x+o.w/2} y=${o.y+o.h/2} text-anchor="middle" dominant-baseline="central"
          ...
          font-family="-apple-system, 'SF Pro Rounded', Helvetica, Arial, sans-serif">${o.label}</text>`:g,s=3,d=o&&t.timestampActiveId===e.id?v`
        ...
        ${[["nw",o.x,o.y],["ne",o.x+o.w,o.y],["sw",o.x,o.y+o.h],["se",o.x+o.w,o.y+o.h]].map(([h,f,y])=>v`<rect data-ts-corner=${h} x=${f-s/2} y=${y-s/2} width=${s} height=${s}
            fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${h}-resize" />`)}`:g,p=e.url?t.imageSizes?.size(e.url):void 0,c;if(e.url&&p){let h=$l(n.w,n.h,p.width,p.height,e.contentMode,e.zoom,e.panX,e.panY);c=v`<image href=${e.url} x=${n.x+h.x} y=${n.y+h.y} width=${h.width} height=${h.height}
      ...
      <g transform="translate(${n.cx-7} ${n.cy-7})">${i.render("camera.fill",14,"#FFFFFF99")??g}</g>`;return v`
    <defs><clipPath id=${a}><rect x=${n.x} y=${n.y} width=${n.w} height=${n.h} rx=${r} /></clipPath></defs>
    <g clip-path=${`url(#${a})`}>${c}${l}</g>${d}`}function Sl(e,n,t,i,a){if(!i)return g;let r=Math.min(10,n.w*.5,n.h*.5),o=a!==void 0?El(a,n):void 0;return v`
    ...
    ${o!==void 0?v`<text x=${n.cx} y=${n.cy} text-anchor="middle" dominant-baseline="central"
          font-family="-apple-system, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif"
          font-size=${Ii} font-weight="600" fill="#FFD60A" fill-opacity="0.95">${o}</text>`:r>=5?v`<g transform="translate(${n.cx-r/2} ${n.cy-r/2})" opacity="0.8">${t.render("hand.tap.fill",r,"#FFD60A")??g}</g>`:g}`}var Ii=5;function El(e,n){let t=Ii*.55,i=n.w-2;if(n.h<Ii*1.6||i<t*4)return;if(e.length*t<=i)return e;let a=Math.max(1,Math.floor(i/t)-1);return`${e.slice(0,a).replace(/\s+$/,"")}\u2026`}function Mi(e,n,t){if(e.isHidden&&!t.showHidden)return g;let i=t.tapReview===!0,a=t.tapAreas===!0||i,r=i?t.tapFocusId:void 0,o=r!==void 0&&e.id===r,l=r!==void 0;if(e.kind==="tap"&&!a)return g;if(e.kind==="tap"&&e.attachedTo!==void 0&&(!i||l&&!o))return g;let s=Ar(e,n),d=i&&(!l||o),p;switch(e.kind){case"text":p=fl(e,s);break;case"icon":p=wl(e,s,t.icons);break;case"gauge":p=gl(e,s);break;case"chart":p=vl(e,s);break;case"shape":p=xl(e,s);break;case"image":p=Cl(e,s,t);break;case"tap":p=Sl(e,s,t.icons,a,d?He(e.action):void 0);break}let c=i&&(e.kind!=="tap"||l&&!o)?.35:1,h=Math.min(1,Math.max(0,e.opacity))*(e.isHidden?.35:1)*c,f=t.highlightId===e.id,y=f||t.highlightIds?.includes(e.id)===!0,k=t.handles===!0&&(!l||o),w=y?v`<rect x=${s.x} y=${s.y} width=${s.w} height=${s.h} fill="none" stroke="#0A84FF" stroke-width="0.75" stroke-dasharray="2 1" vector-effect="non-scaling-stroke" />`:g,E=t.hoverId===e.id||t.hoverIds?.includes(e.id)===!0?v`<rect x=${s.x} y=${s.y} width=${s.w} height=${s.h} fill="#0A84FF" fill-opacity="0.22"
        stroke="#0A84FF" stroke-width="1" vector-effect="non-scaling-stroke" pointer-events="none" />`:g,R=v`<rect x=${s.x} y=${s.y} width=${s.w} height=${s.h} fill="transparent" stroke="none" />`,m=3,b=f&&k?[["nw",s.x,s.y],["ne",s.x+s.w,s.y],["sw",s.x,s.y+s.h],["se",s.x+s.w,s.y+s.h]].map(([$,L,O])=>v`<rect data-handle=${$} x=${L-m/2} y=${O-m/2} width=${m} height=${m}
          fill="#FFFFFF" stroke="#0A84FF" stroke-width="0.5" style="cursor:${$}-resize" />`):g;return v`<g data-element-id=${e.id} opacity=${h} style=${k?"cursor:move":g}
    transform="rotate(${e.frame.rotationDegrees} ${s.cx} ${s.cy})">${R}${p}${E}${w}${b}</g>`}function $n(e,n){return{quad:{width:104*e,height:124*e},cornerRadius:52*e,tile:n?{cx:(104-29.75)*e,cy:24*e}:{cx:70*e,cy:29.5*e},dial:{cx:0,cy:124*e,r:100.5*e},labelArc:{start:-90,end:-24}}}function _i(e,n){return(n?23.5:34)*e}var $r=10.5;function Hr(e,n){return(e===" "?.35:/[ILJ1.,:;'!|]/.test(e)?.34:/[MW]/.test(e)?.92:.66)*n}function Cr(e,n){let t=0;for(let i of e)t+=Hr(i,n);return t}function Sr(e,n,t){let i=e.toUpperCase(),a=d=>Hr(d,t),r=.9*t,o=0;for(let d of i)o+=a(d);if(o<=n)return i;let l=0,s="";for(let d of i){if(l+a(d)+r>n)break;s+=d,l+=a(d)}return`${s.replace(/\s+$/,"")}\u2026`}function Ai(e,n,t){let i=t*Math.PI/180;return{x:e.cx+n*Math.cos(i),y:e.cy+n*Math.sin(i)}}function Hi(e,n,t,i){let a=Ai(e,n,t),r=Ai(e,n,i);return`M ${a.x} ${a.y} A ${n} ${n} 0 0 1 ${r.x} ${r.y}`}function Lr(e,n,t,i){let{dial:a}=$n(e,!0),r=(i.end-i.start)*Math.PI/180;return{id:n,d:Hi(a,t,i.start,i.end),length:t*r}}function Tl(e,n){let t=$n(e,!0);return Lr(e,n,t.dial.r,t.labelArc)}var Er=18.5,Fl=113,Rl={start:-71,end:-36},Tr=104,Il=6.2,Fr={start:-77,end:-30.5};function Rr(e){let n=e.replace("#",""),t=i=>parseInt(n.slice(i,i+2),16)||0;return[t(0),t(2),t(4)]}function Ir(e,n){if(e.length===0)return"#34C759";if(e.length===1)return e[0];let t=Math.min(1,Math.max(0,n))*(e.length-1),i=Math.min(e.length-2,Math.floor(t)),a=t-i,r=Rr(e[i]),o=Rr(e[i+1]),l=(s,d)=>Math.round(s+(d-s)*a);return`rgb(${l(r[0],o[0])}, ${l(r[1],o[1])}, ${l(r[2],o[2])})`}var Ri=11;function Ml(e,n,t){let{dial:i}=$n(n,!0),a=Tr*n,r=180/(Math.PI*Tr),o=e.minLabel!==void 0?Cr(e.minLabel,Ri)*r:0,l=e.maxLabel!==void 0?Cr(e.maxLabel,Ri)*r:0,s=Fr.start+(o>0?Math.max(0,o-1.8):0),d=Fr.end-(l>0?Math.max(0,l-1.8):0),p=d-s,c=24,h=[];for(let E=0;E<c;E++){let R=s+p*E/c,m=Math.min(d,s+p*(E+1)/c+.4);h.push(v`<path d=${Hi(i,a,R,m)} fill="none"
      stroke=${Ir(e.colorHexes,(E+.5)/c)} stroke-width=${Il*n}
      stroke-linecap=${E===0||E===c-1?"round":"butt"} />`)}let f=(e.value-e.minValue)/(e.maxValue-e.minValue),y=Ai(i,a,s+p*f),k=1.5,w=(E,R,m,b)=>v`
    ...
    <circle cx=${y.x} cy=${y.y} r=${3.2*n} fill=${Ir(e.colorHexes,f)}
      stroke="#000000" stroke-width=${1.2*n} />
    ${e.minLabel!==void 0?w(`${t}-gmin`,s-k-Math.max(o,3),s-k,e.minLabel):g}
    ${e.maxLabel!==void 0?w(`${t}-gmax`,d+k,d+k+Math.max(l,3),e.maxLabel):g}`}function zi(e,n){let t=e.family in pe?e.family:"rectangular",i=n.slot??pe[t],a=pe[t],r=xn(i,t),o=`clip-${t}-${Math.random().toString(36).slice(2,8)}`,l=Re(e.backgroundColorHex),s=Re(e.borderColorHex),d=e.borderWidth*r.scale;if(t==="corner"){let y=r.scale,k=!!e.bezelText||!!e.bezelGauge,w=e.curvedText??"",E=w!=="",R=$n(y,k),m=_i(y,k),b=m/(a.width*y),$=R.tile.cx-m/2,L=R.tile.cy-m/2,O=`M 0 0 H ${R.quad.width-R.cornerRadius} A ${R.cornerRadius} ${R.cornerRadius} 0 0 1 ${R.quad.width} ${R.cornerRadius} V ${R.quad.height} H 0 Z`,X=g;if(e.bezelGauge)X=Ml(e.bezelGauge,y,o);else if(e.bezelText){let C=Tl(y,`${o}-bezel`),I=e.bezelCountdownEnd!==void 0&&e.bezelCountdownEnd>Date.now()?vt((e.bezelCountdownEnd-Date.now())/1e3):e.bezelText;X=v`<defs><path id=${C.id} d=${C.d} /></defs>
        <text font-size=${$r*y} font-weight="600" fill="#FFFFFF" font-family="-apple-system, 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${C.id}" startOffset="50%" text-anchor="middle">${Sr(I,C.length,$r*y)}</textPath></text>`}let x=g;if(E){let C=Re(e.curvedColorHex??"#FFFFFF")??{color:"#FFFFFF",opacity:1},I=Lr(y,`${o}-curved`,Fl*y,Rl);x=v`<defs><path id=${I.id} d=${I.d} /></defs>
        <text font-size=${Er*y} font-weight="600" fill=${C.color} fill-opacity=${C.opacity}
          font-family="-apple-system, 'SF Pro Rounded', 'SF Pro Text', Helvetica, Arial, sans-serif">
          <textPath href="#${I.id}" startOffset="50%" text-anchor="middle">${Sr(w,I.length,Er*y*.88)}</textPath></text>`}else{let C=e.borderWidth*r.scale*b,I=s?v`<circle cx=${m/2} cy=${m/2} r=${m/2-C/2} fill="none" stroke=${s.color} stroke-opacity=${s.opacity} stroke-width=${C} />`:g;x=v`<g transform="translate(${$} ${L})">
        <g clip-path=${`url(#${o})`}>
          ${l?v`<rect width=${m} height=${m} fill=${l.color} fill-opacity=${l.opacity} />`:g}
      ...
      ${X}
      ${x}
    </svg>`}let p=v`<rect width=${i.width} height=${i.height} />`,c=s?v`<rect x=${d/2} y=${d/2} width=${i.width-d} height=${i.height-d} fill="none" stroke=${s.color} stroke-opacity=${s.opacity} stroke-width=${d} />`:g,h=v`<rect width=${i.width} height=${i.height} fill="#000000" />`,f=`0 0 ${i.width} ${i.height}`;return v`<svg viewBox=${f} xmlns="http://www.w3.org/2000/svg" class="complication ${t}"
      width=${i.width} height=${i.height}>
    <defs><clipPath id=${o}>${p}</clipPath></defs>
    <g clip-path=${`url(#${o})`}>
      ${h}
      ${l?v`<rect width=${i.width} height=${i.height} fill=${l.color} fill-opacity=${l.opacity} />`:g}
      <g data-design-box transform="translate(${r.x} ${r.y}) scale(${r.scale})">
        ${e.elements.map(y=>Mi(y,a,n))}
      </g>
    </g>
    ${c}
  </svg>`}var Al=.14;function Hl(e,n){let t=Ar(e,n);if(e.kind!=="text"||e.text==="")return t;let i=Math.min(t.w,Math.max(e.fontSize,e.text.length*e.fontSize*.55)),a=Math.min(t.h,e.fontSize*1.3);return{x:t.cx-i/2,y:t.cy-a/2,w:i,h:a,cx:t.cx,cy:t.cy}}function Ll(e,n,t){let i=e.family in pe?e.family:"rectangular",a=pe[i],r=e.elements.filter(h=>n.includes(h.id)),o=1/0,l=1/0,s=-1/0,d=-1/0;for(let h of r){let f=Hl(h,a),y=h.frame.rotationDegrees%180===0?0:Math.hypot(f.w,f.h)/2;o=Math.min(o,y?f.cx-y:f.x),l=Math.min(l,y?f.cy-y:f.y),s=Math.max(s,y?f.cx+y:f.x+f.w),d=Math.max(d,y?f.cy+y:f.y+f.h)}let p=s-o,c=d-l;if(r.length===0||!(p>0)||!(c>0))o=0,l=0,p=a.width,c=a.height;else{let h=Math.max(2,Math.max(p,c)*Al);o-=h,l-=h,p+=2*h,c+=2*h}if(p/c<t){let h=c*t;o-=(h-p)/2,p=h}else{let h=p/t;l-=(h-c)/2,c=h}return{x:o,y:l,w:p,h:c}}function _r(e,n,t){let i=e.family in pe?e.family:"rectangular",a=pe[i],r=Ll(e,n,t.width/t.height),o=Re(e.backgroundColorHex),l=Re(e.borderColorHex),s=e.borderWidth,d={icons:t.icons,showHidden:!0,tapAreas:!0,...t.imageSizes?{imageSizes:t.imageSizes}:{}},p=e.elements.filter(f=>n.includes(f.id)),c=l&&s>0?i==="rectangular"?v`<rect x=${s/2} y=${s/2} width=${a.width-s} height=${a.height-s} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${s} />`:v`<circle cx=${a.width/2} cy=${a.height/2} r=${a.width/2-s/2} fill="none" stroke=${l.color} stroke-opacity=${l.opacity} stroke-width=${s} />`:g,h=i==="rectangular"?v`<rect width=${a.width} height=${a.height} fill=${o?o.color:"#000000"} fill-opacity=${o?o.opacity:1} />`:v`<circle cx=${a.width/2} cy=${a.height/2} r=${a.width/2} fill=${o?o.color:"#000000"} fill-opacity=${o?o.opacity:1} />`;return v`<svg viewBox=${`${r.x} ${r.y} ${r.w} ${r.h}`} xmlns="http://www.w3.org/2000/svg" class="thumb ${i}"
    ...
    ${p.map(f=>Mi(f,a,d))}
    ${c}
  </svg>`}function B(e){switch(e){case"rectangular":return"Rectangular";case"circular":return"Circular";case"corner":return"Corner";case"inline":return"Inline"}}var xt=["rectangular","circular","corner","inline"];function Kt(e){return Z.includes(e)}function zr(e){return xt.filter(n=>e.supportedFamilies.includes(n))}function Pr(e){return Z.find(n=>e.supportedFamilies.includes(n))}function wt(e,n){return e.supportedFamilies.includes(n)&&e.supportedFamilies.length>1}function _l(e){let n=e.elements.find(i=>i.kind==="text");return{value:n&&n.kind==="text"?structuredClone(n.payload.value):M("Text")}}function Nr(e,n){e.supportedFamilies.includes(n)||(e.supportedFamilies=xt.filter(t=>t===n||e.supportedFamilies.includes(t))),Kt(n)?e.perFamily[n]||(e.perFamily[n]=ui()):e.inline||(e.inline=_l(e)),e.schemaVersion=_t(e)}function Or(e,n){wt(e,n)&&(e.supportedFamilies=e.supportedFamilies.filter(t=>t!==n),Kt(n)?delete e.perFamily[n]:delete e.inline,e.schemaVersion=_t(e))}function Dr(e,n){let t=[];if(!Kt(n)){let r=e.inline;return r&&(r.value.kind.kind==="literal"&&(r.value.kind.value===""||r.value.kind.value==="Text")&&!r.label&&!r.symbol||t.push("the Inline text")),t}let i=e.perFamily[n];if(!i)return t;let a=Object.keys(i.placements).length;return a>0&&t.push(`${a} placement${a===1?"":"s"}`),i.rules.length>0&&t.push(`${i.rules.length} rule${i.rules.length===1?"":"s"}`),(i.bezelText||i.bezelGauge)&&t.push("the bezel"),i.curvedText&&t.push("the curved text"),(i.backgroundColorHex||i.borderColorHex)&&t.push("the background or border"),t}var te={text:"#42a5f5",icon:"#ab47bc",gauge:"#fb8c00",chart:"#3949ab",shape:"#43a047",image:"#00acc1",tap:"#ec407a"},kt={text:"Text",icon:"Icon",gauge:"Gauge",chart:"Chart",shape:"Shape",image:"Picture",tap:"Tap area"},Vr=["text","icon","gauge","chart","shape","image","tap"],Y={states:"#f9a825",tap:te.tap,place:"#78909c",complication:"#5c6bc0",group:"#90a4ae",locked:"#e53935"};var Br="2.8.0";function Pi(e){if(typeof e!="string")return;let n=/^\s*v?(\d+)\.(\d+)(?:\.(\d+))?/.exec(e);if(n)return[Number(n[1]),Number(n[2]),Number(n[3]??0)]}function zl(e,n){for(let t=0;t<3;t++)if(e[t]!==n[t])return e[t]<n[t]?-1:1;return 0}function Gr(e,n=Br){let t=Pi(e),i=Pi(n);return!t||!i?!1:zl(t,i)>=0}function Ur(e,n=Br){return`${Pi(e)?`This watch runs Wrist Assistant ${e}.`:"This watch has not reported its Wrist Assistant version yet."} The complication editor needs ${n} or newer. Update Wrist Assistant on the watch, open it once so it reports its version, then reload this page.`}var Kr="52a9d81d0fd7";function Pl(e){return e.trim().replace(/\./g,"-")}function Nl(e){return e.trim().replace(/-/g,".")}var Cn=class e{constructor(n){this.onReady=n;this.cache=new Map;this.pending=new Set;this.nameList=[];this.nameState="idle"}static available(){return typeof window<"u"&&!!window.customIcons?.ios}available(){return e.available()}names(){return this.nameState==="idle"&&this.fetchNames(),this.nameState==="loaded"?this.nameList:void 0}fetchNames(){this.nameState="loading";let n=window.customIcons?.ios;if(!n||typeof n.getIconList!="function"){this.nameState="loaded";return}Promise.resolve().then(()=>n.getIconList()).then(t=>{this.nameList=(t??[]).map(i=>Nl(i.name)).sort()}).catch(()=>{this.nameList=[]}).finally(()=>{this.nameState="loaded",this.onReady()})}render(n,t,i){let a=Pl(n),r=this.cache.get(a);if(r===void 0){this.fetch(a);return}if(r===null||!r.path)return;let o=Re(i)??{color:"#FFFFFF",opacity:1},l=r.viewBox??"0 0 24 24";return v`<svg x="0" y="0" width=${t} height=${t} viewBox=${l}>
    ...
    </select></label>`}function qi(e,n,t,i){let a=i.format??(r=>String(Math.round(r*100)/100));return u`<div class="field slider"><span>${e}</span>
    ...
    <div class="color-row">
      ${i?u`<input type="checkbox" title="Enabled" .checked=${n!==void 0} @change=${d=>t(d.target.checked?s(o,l):void 0)} />`:g}
    ...
    <div class="ent-box ${l?"open":""}">
      ...
      <input type="text" class="mono" role="combobox" aria-autocomplete="list" aria-expanded=${l?"true":"false"} autocomplete="off" spellcheck="false"
        ...
        @keydown=${w}
        @blur=${m=>{let b=m.target;l&&f(b.value),h(b)}} />
      ${(l?l.query:t.entityId)===""?g:u`<button type="button" class="ent-clear" title="Clear" aria-label="Clear"
    ...
    ${l?u`<div class="entity-results" role="listbox">
          ${s.length===0?u`<div class="hint" style="padding:6px 8px">${Lo(l.query)?"Nothing here has that id. Press Enter to use it anyway.":"Nothing matches that search."}</div>`:s.map((m,b)=>u`<button type="button" role="option" aria-selected=${b===d?"true":"false"} class="ent ${b===d?"hl":""}"
                ...
                <span class="ent-ico ${ji(m.state)?"on":""}">${Wi(m.domain)}</span>
                <span class="ent-main">
                  <span class="ent-name">${m.name}</span>
                  <span class="ent-sub">
                    ${m.area?u`<span class="ent-area">${m.area}</span>`:g}
  ...
  </div>`}function rd(e){requestAnimationFrame(()=>{e.closest(".entity-field")?.querySelector("button.ent.hl")?.scrollIntoView({block:"nearest"})})}var od=120;function sd(e,n,t,i){let a=r=>i.size===0?[...r]:r.filter(o=>i.has(o));return e!==""?{names:a(En.find(r=>r.name===e)?.symbols??[]),fromPack:!1}:n.trim()!==""&&t.length>0?{names:[...t],fromPack:!0}:{names:a(Tn),fromPack:!1}}function wo(e,n){return n.size===0?e.length:e.filter(t=>n.has(t)).length}function ld(e){return[{value:"",label:`Starter set (${wo(Tn,e)})`},...En.map(n=>({value:n.name,label:`${n.name} (${wo(n.symbols,e)})`}))]}function dd(e){return e.length>0?e.length:Tn.length}function cd(e,n,t,i){return t?n>e?`Showing ${e} of ${n}. Type more to narrow it down.`:n===1?"1 symbol matches.":`${n} symbols match.`:i===1?"1 symbol available.":`${i} symbols available.`}function ko(e,n,t,i){let a=e.icons.render(n,22,"#FFFFFF");return u`<button type="button" class="sym ${t?"on":""}" title=${n} @click=${()=>i(n)}>
    <span class="sym-glyph">${a??u`<span class="sym-none">?</span>`}</span>
    <span class="sym-name">${n}</span>
  </button>`}function zo(e,n,t,i){let a=e.symbols,r=a.isOpen(i),o=a.query(i),l=e.icons.names(),s=l??[],d=new Set(s),p=n.trim(),c=p!==""&&d.size>0&&!d.has(p),h=y=>{t(y),a.noteUsed(y)},f=g;if(r){let y=a.category(i),k=sd(y,o,s,d),w=qr(k.names,o),E=k.fromPack?w.slice(0,od):w,R=d.size===0?a.recent:a.recent.filter(m=>d.has(m));f=u`<div class="sym-browse">
      ...
      ${R.length===0?g:u`<div class="hint">Recent</div>
    ...
    ${No(e,a,r,n,t,i)}
  </div>`}function No(e,n,t,i,a,r){return u`<div class="value-pop" id=${n} popover role="dialog" aria-label=${t} @toggle=${Oo}>
    <div class="pop-head">
      <b>${t}</b>
      <span class="spacer"></span>
      <button type="button" class="small" popovertarget=${n} popovertargetaction="hide">Done</button>
    </div>
    ${Yt.has(n)?Do(e,i,a,r):g}
  </div>`}function re(e){return{values:e.config.values,hass:e.hass,elements:e.config.elements}}function Qi(e){return`wa-pop-${e.replace(/[^a-zA-Z0-9_-]/g,"")}`}function wd(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype.showPopover=="function"}var Yt=new Set,qt=new WeakMap;function kd(e){let n=e.getRootNode();return(n instanceof ShadowRoot||n instanceof Document?n:e.ownerDocument).querySelector(`[popovertarget="${e.id}"]`)}function $d(e,n){let t=e instanceof Node?e:null;if(!t)return;let i=t.getRootNode();!(i instanceof ShadowRoot)&&!(i instanceof Document)||requestAnimationFrame(()=>requestAnimationFrame(()=>{let a=i.querySelector(`#${CSS.escape(n)}`);a&&typeof a.showPopover=="function"&&!a.matches(":popover-open")&&a.showPopover()}))}function Oo(e){let n=e.currentTarget,t=e.newState==="open",i=qt.get(n);if(i&&(i(),qt.delete(n)),!t){Yt.delete(n.id)&&Ce(n);return}let a=kd(n);if(!a)return;let r=()=>{if(!n.isConnected||!n.matches(":popover-open")){qt.get(n)?.(),qt.delete(n);return}let o=a.getBoundingClientRect();if(o.bottom<0||o.top>window.innerHeight){n.hidePopover();return}Yi(n,o)};window.addEventListener("scroll",r,!0),window.addEventListener("resize",r),qt.set(n,()=>{window.removeEventListener("scroll",r,!0),window.removeEventListener("resize",r)}),Yi(n,a.getBoundingClientRect()),Yt.has(n.id)||(Yt.add(n.id),Ce(n),requestAnimationFrame(()=>{n.isConnected&&Yi(n,a.getBoundingClientRect())}))}function Yi(e,n){e.style.maxHeight="";let t=e.getBoundingClientRect(),i=Cd({left:n.left,top:n.top,bottom:n.bottom,width:n.width},{width:t.width,height:t.height},{width:window.innerWidth,height:window.innerHeight});e.style.left=`${i.left}px`,e.style.top=`${i.top}px`,e.style.maxHeight=`${i.maxHeight}px`}var rt=8,Mn=6,$o=140;function Cd(e,n,t){let i=t.height-e.bottom-Mn-rt,a=e.top-Mn-rt,r=n.height>i&&a>i&&i<$o,o=Math.max($o,r?a:i),l=Math.min(n.height,o),s=Math.max(rt,Math.min(e.left,t.width-n.width-rt)),d=r?Math.max(rt,e.top-Mn-l):Math.max(rt,Math.min(e.bottom+Mn,t.height-l-rt));return{left:s,top:d,maxHeight:o,above:r}}function Do(e,n,t,i){let a=n.kind,r=p=>t({...n,kind:p}),o=i.key,l=pd.filter(([p])=>i.allowNamed!==!1||p!=="named"),s=g;switch(a.kind){case"literal":s=i.symbol?zo(e,a.value,p=>r({...a,value:p}),o):ne("Text",a.value,p=>r({...a,value:p}));break;case"entityState":case"entityAge":s=Ke(e,"Entity",a,p=>r({...a,...p}),`${o}-entity`);break;case"entityAttribute":{let p=Object.keys(e.hass.states[a.entityId]?.attributes??{}).sort(),c=`wa-attrs-${o.replace(/[^a-z0-9]/gi,"")}`;s=u`${Ke(e,"Entity",a,h=>r({...a,...h}),`${o}-entity`)}
    ...
    ${s}
    ${i.noFormat?g:Sd(n.format,p=>t(Fe(p)?{kind:n.kind}:{...n,format:p}))}
    ${i.showResolved?u`<div class="hint">Now: ${d===void 0?u`<span class="warn">unresolved</span>`:u`<code>${d}</code>`}</div>`:g}`}function Sd(e,n){let t=e??{},i=a=>{let r={...t,...a};for(let o of Object.keys(r))(r[o]===void 0||r[o]===!1||r[o]==="")&&delete r[o];n(r)};return u`<details class="sub" ?open=${!Fe(e)}>
    ...
    ${n.stateFilter&&"value"in n.stateFilter?ne("State",n.stateFilter.value,l=>t({...n,stateFilter:{kind:n.stateFilter.kind,value:l}})):g}
    ${n.function==="count"?g:ne("Attribute (blank = state)",n.attribute??"",l=>{let s={...n};l?s.attribute=l:delete s.attribute,t(s)})}`}var Vo=li,Td=Vo.filter(([e])=>e!=="none");function Fd(e,n){return e!==void 0&&n.trim()!==""&&n.trim()!==e.trim()}function Bo(e){let n=e.config,t=n.tapAction,i=s=>["toggleEntity","runScene","runScript","addTodo","runHTTPAction"].includes(s),a=Fd(e.savedName,n.name),r=n.refreshMinutes??0,o=Co.map(s=>[String(s),So(s)]);Co.includes(r)||o.push([String(r),So(r)]);let l=n.showSuccessFlash??!0;return u`
    <div class="gen-row">
  ...
  ${a?g:u`<div class="hint">Without a page the tap falls back to the complication list.</div>`}`}function Uo(e,n){let t=e.config.values.findIndex(a=>a.id===n.id),i=`nv-${n.id}`;return u`
    ...
    ${t?u`
      ...
      ${i?g:V("Corner",e.timestampCorner,[["topLeading","Top left"],["topTrailing","Top right"],["bottomLeading","Bottom left"],["bottomTrailing","Bottom right"]],r=>n(o=>{o.timestampCorner=r}))}
      ...
      <div class="hint">The time the snapshot was fetched, not the time now. A frame that stops updating keeps its old time.</div>`:g}`}function le(e,n,t,i,a={}){let r=e.openSections.has(n),o=()=>e.toggleSection(n);return u`<section class="sec" data-open=${r?"true":"false"} style=${a.color?`--c:${a.color}`:""}>
    <div class="sec-h" role="button" tabindex="0" aria-expanded=${r?"true":"false"} @click=${o}
      ...
      <span class="tt"><h4>${t}</h4>${a.summary?u`<span class="sum">${a.summary}</span>`:g}</span>
      <span class="chev">${z("chevron")}</span>
    </div>
    ${r?u`<div class="sec-b">${i}</div>`:g}
  </section>`}function Od(e){if(e.length===0)return"nothing";let n=t=>Number.isInteger(t)?String(t):String(Math.round(t*100)/100);return e.length<=12?e.map(n).join(" "):`${e.slice(0,6).map(n).join(" ")} \u2026 ${e.slice(-3).map(n).join(" ")}`}function Dd(e){return ni.find(n=>n.minutes===e)?.label??`Last ${e} min`}function ta(e,n){let t=re(e);switch(n.kind){case"text":return st(ce(n.payload.value,t),48);case"icon":return st(ce(n.payload.symbol,t),48);case"gauge":return st(ce(n.payload.value,t),48);case"chart":return st(`${ce(n.payload.value,t)}${n.payload.historyMinutes>0?` \xB7 ${Dd(n.payload.historyMinutes)}`:""}`,48);case"shape":return n.payload.kind==="roundedRectangle"?"Rounded rectangle":n.payload.kind;case"image":return n.payload.entity.displayName||n.payload.entity.entityId||"No camera yet";case"tap":return He(n.payload.action)}}function _n(e){switch(e.kind){case"text":return`${e.payload.fontSize} pt ${e.payload.fontWeight.toLowerCase()} \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"icon":return`${e.payload.size} pt \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"gauge":return`${e.payload.style} \xB7 ${e.payload.lineWidth} pt line \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"chart":return`${e.payload.style} \xB7 ${e.payload.scale==="auto"?"auto scale":`${e.payload.minValue} to ${e.payload.maxValue}`}${e.payload.highlight==="none"?"":` \xB7 ${Po.find(([n])=>n===e.payload.highlight)?.[1].toLowerCase()??""} marked`}`;case"shape":return`${Se(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?` \xB7 ${e.payload.borderWidth} pt border`:""}`;case"image":return`${e.payload.contentMode==="fill"?"Fill the frame":"Fit inside"} \xB7 ${e.payload.zoom.toFixed(2)}x \xB7 corners ${e.payload.cornerRadius} pt`;case"tap":return}}function jo(e,n,t){let i=n.payload.id,a=e.config.elements.findIndex(m=>m.payload.id===i),r=`el-${i}`,o=(m,b)=>e.update($=>m($.elements[a]),b?`${r}-${b}`:void 0),l=be(e.config,t,n),s=l.frame,d=(m,b)=>e.update($=>ye($,t,i,{frame:{...s,...m}}),`${r}-${b}-${t}`),p=n.kind==="text"?"Font size":n.kind==="icon"?"Icon size":"Line width",c,h;switch(n.kind){case"text":{let m=di(e.config,n.payload.value);c=u`
        ${ee(e,n.payload.value,b=>o($=>{$.payload.value=b},"value"),{showResolved:!0,label:"Text",key:`${r}-value`})}
        ${m?u`<div class="hint">Prints a number from the chart <button type="button" class="link" @click=${()=>e.selectLayer(m.payload.id)}>${ke(m,re(e))}</button>. It stays in the chart's group and moves with it.</div>`:g}
        ${ge("Live countdown",n.payload.countdown===!0,b=>o($=>{let L=$.payload;b?L.countdown=!0:delete L.countdown}))}
        ${n.payload.countdown?u`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:g}`,h=u`<div class="grid2">
          ${j("Font size (pt)",n.payload.fontSize,b=>o($=>{$.payload.fontSize=b??14},"size"),{step:1,min:4})}
          ${V("Weight",n.payload.fontWeight,ea,b=>o($=>{$.payload.fontWeight=b}))}
        ...
        ${ae("Track colour",n.payload.trackColorHex,m=>o(b=>{b.payload.trackColorHex=m??"#FFFFFF40"},"track"))}`;break;case"chart":{let m=n.payload,b=(S,T)=>o(J=>S(J.payload),T),$=tt(m),L=m.historyMinutes>0,O=m.value.kind.kind==="entityState",X=$===void 0?void 0:e.historySeries($),x=L?X??"":e.resolve(m.value)??"",C=Bt(x),I=m.limit>0&&C.length>m.limit?m.takeFromEnd?C.slice(C.length-m.limit):C.slice(0,m.limit):C,P=!L&&O&&C.length===1;c=u`
        ${ee(e,m.value,S=>b(T=>{T.value=S},"value"),{label:"Readings",key:`${r}-value`})}
        ${V("Draw",L?"history":"value",[["value","The value itself"],["history","Its recorded history"]],S=>b(T=>{T.historyMinutes=S==="history"?T.historyMinutes||360:0}))}
        ${L?u`
            ${O?g:u`<div class="hint warn">History needs an entity.
            ...
            ${O&&X===void 0?u`<div class="hint">Reading the history…</div>`:g}
        ...
        ${C.length===0&&!(L&&(!O||X===void 0||X===""))?u`<div class="hint warn">No numbers in this value yet, so the chart draws nothing.</div>`:g}
        ${C.length>0?u`<div class="hint">Reads ${Od(I)}${C.length===I.length?u` · ${I.length} ${I.length===1?"value":"values"}`:u` · ${I.length} of ${C.length}`}</div>`:g}
        ...
        <div class="hint">${L?"Trims the series after it arrives, so 0 draws every reading fetched above.":"A forecast sensor often carries 24 or 48 entries. 0 draws all of them."}</div>`,h=u`
        ...
        ${m.coloring==="bands"?u`
          ...
          ${ae("And the rest",m.bandAboveColorHex,S=>b(T=>{T.bandAboveColorHex=S??cn},"babove"))}
        ...
        ${m.highlight==="none"?g:u`
          <div class="grid2">
            ${m.highlight==="lowest"?g:ae("Highest colour",m.highColorHex,S=>b(T=>{T.highColorHex=S??ln},"hicol"))}
            ${m.highlight==="highest"?g:ae("Lowest colour",m.lowColorHex,S=>b(T=>{T.lowColorHex=S??dn},"locol"))}
          </div>
          ...
          ${n.payload.kind==="roundedRectangle"?j("Corner radius (pt)",n.payload.cornerRadius,m=>o(b=>{b.payload.cornerRadius=m??6},"radius"),{step:.5,min:0}):g}
        </div>`,h=u`
        ...
        ${n.payload.borderColorHex!==void 0?j("Border width (pt)",n.payload.borderWidth,m=>o(b=>{b.payload.borderWidth=m??1},"bw"),{step:.5,min:0}):g}`;break;case"image":{let m=n.payload,b=($,L)=>o(O=>$(O.payload),L);c=u`
        ...
        ${V("Picture",m.contentMode,[["fill","Fill the frame (crop)"],["fit","Fit the whole picture"]],$=>b(L=>{L.contentMode=$}))}
        ${qi("Zoom",m.zoom,$=>b(L=>{L.zoom=$},"zoom"),{min:Li,max:4,step:.05,def:1,format:$=>`${$.toFixed(2)}x`})}
        ${qi("Pan left/right",m.panX,$=>b(L=>{L.panX=$},"panx"),{min:-1,max:1,step:.02,def:0})}
        ${qi("Pan up/down",m.panY,$=>b(L=>{L.panY=$},"pany"),{min:-1,max:1,step:.02,def:0})}
        <div class="hint">${Pd(m)}</div>
        ${j("Corner radius (pt)",m.cornerRadius,$=>b(L=>{L.cornerRadius=Math.max(0,$??zt)},"imgradius"),{step:1,min:0})}`;break}case"tap":{c=u`
        ...
        <div class="hint">To make one layer tappable, tick Tappable on that layer instead.</div>`;break}}let f=n.kind==="image"||n.kind==="tap"?void 0:ae(n.kind==="shape"?"Fill colour":"Colour",n.payload.colorSlot.baseColorHex,m=>o(b=>{b.kind!=="image"&&b.kind!=="tap"&&(b.payload.colorSlot.baseColorHex=m??"#FFFFFF")},"color")),y=fi(e.config,n),k=y?{kind:{kind:"entityState",...y}}:void 0,w=te[n.kind],E=n.kind==="tap"?void 0:we(e.config,i)[0],R=n.kind==="image"?n.payload.timestamp===!0:!1;return u`
    ${le(e,"content","Content",u`${n.kind==="tap"?g:Hd(e,n,r)}${c}`,{color:w,icon:"content",summary:ta(e,n)})}
    ${h===void 0&&f===void 0?g:le(e,"look",n.kind==="image"?"Picture":"Look",u`${h??g}${f??g}`,{color:w,icon:n.kind==="image"?"image":"look",..._n(n)?{summary:_n(n)}:{}})}
    ${n.kind==="chart"?le(e,"numbers","Numbers",Ud(e,n),{color:te.text,icon:"text",summary:Gd(e,n)}):g}
    ${n.kind==="image"?le(e,"timestamp","Timestamp",Nd(n.payload,(m,b)=>o($=>m($.payload),b)),{color:w,icon:"clock",summary:R?`Shown \xB7 ${n.payload.timestampSize} pt`:"Hidden"}):g}
    ${n.kind==="tap"?g:le(e,"tappable","Tap",Kd(e,n,r),{color:Y.tap,icon:"tap",summary:E?He(E.payload.action):"Not tappable"})}
    ...
    ${le(e,"placement","Place",u`
      ...
      ${n.kind==="shape"||n.kind==="image"||n.kind==="tap"?g:j(`${p} in ${B(t)} (blank = shared ${Md(n)})`,l.size,m=>e.update(b=>m===void 0?ye(b,t,i,{},!0):ye(b,t,i,{size:m}),`${r}-psize-${t}`),{step:1,min:1,optional:!0})}
    ...
    ${"entityId"in a?Ke(e,"Target",a,o=>t(l=>{l.action={type:a.type,...o}},"tap-entity"),`${i}-tap`):g}
    ${a.type==="openPage"?Go(e,n.openPageId,n.openPageName,(o,l)=>t(s=>{if(o===void 0){delete s.openPageId,delete s.openPageName;return}s.openPageId=o,l?s.openPageName=l:delete s.openPageName},"tap-page")):g}`}var Vd=24;function Bd(e,n){let t=[],i=1/0;for(let r of Z){if(r==="inline"||!e.config.supportedFamilies.includes(r))continue;let o=hr(e.config,n,r);o&&(t.push(`${B(r)} ${Math.round(o.width)} x ${Math.round(o.height)} pt`),i=Math.min(i,o.width,o.height))}if(t.length===0)return g;let a=i<Vd;return u`<div class=${a?"hint warn":"hint"}>${t.join(" \xB7 ")}${a?u`<br />That is small for a wrist. Show the tap area and drag its corners out.`:g}</div>`}function Gd(e,n){let t=Nt(e.config,n.payload.id);return t.length===0?"None yet":t.map(i=>{let a=i.payload.value.kind;return a.kind==="chartStat"?(ft.find(([r])=>r===a.stat)?.[1]??"number").toLowerCase():"number"}).join(" \xB7 ")}function Ud(e,n){let t=re(e),i=Nt(e.config,n.payload.id),a=o=>{let l;e.update(s=>{l=or(s,n.payload.id,o)}),l&&e.selectLayer(l)},r=new Set(i.map(o=>o.payload.value.kind.kind==="chartStat"?o.payload.value.kind.stat:""));return u`
        ...
        <div class="chart-numbers">
          ${i.map(o=>u`
            <button class="small" title="Edit this number" @click=${()=>e.selectLayer(o.payload.id)}>
              <b>${e.resolve(o.payload.value)??"--"}</b> · ${ke(o,t)}
            </button>`)}
        </div>
    ...
    ${a?u`<div class="value-editor">
          ...
          <div class="chips">
            ...
            ${pn(a.payload.outset)?g:u`<button class="icon" title="Fit the tap area to the layer again" aria-label="Fit the tap area to the layer again"
    ...
    <div class="adders">
    ...
    </div>`,{color:Y.group,icon:"folder",summary:`${t.length} layers \xB7 ${n.locked?"moves as one":"unlocked"}`})}function Jo(e,n){if(n==="inline")return u`${Wd(e)}${Ji(e,n)}`;let t=e.config.perFamily[n];if(!t)return u`<div class="hint">No settings stored for ${B(n)} yet.</div>
      ...
      ${Ji(e,n)}`;let i=(l,s)=>e.update(d=>l(d.perFamily[n]),s?`fam-${n}-${s}`:void 0),a=Object.keys(t.placements).length,r=t.backgroundColorHex?Se(t.backgroundColorHex):"transparent",o=t.borderColorHex?`${t.borderWidth} pt ${Se(t.borderColorHex)} border`:"no border";return u`
    ...
    ${n==="corner"?le(e,"corner","Corner content",jd(e,t,i),{color:Y.place,icon:"content",summary:t.curvedText?"Big curved text":"Layer canvas"}):g}
    ...
    ${Ji(e,n)}`}function Ji(e,n){let t=!wt(e.config,n),i=t?"A complication keeps at least one shape.":`Drop the ${B(n)} shape. The watch stops listing this complication for ${B(n)} slots.`;return le(e,"shape","Remove this shape",u`
    <div class="adders">
    ...
    ${le(e,"content","Inline text",u`
      ...
      ${n.countdown?u`<div class="hint">Ticks down to the value's target: an active timer's finish, or any future timestamp. A paused timer shows its remaining time.</div>`:g}`,{color:te.text,icon:"text",summary:st(`${n.label?`${n.label}: `:""}${ce(n.value,i)}`,48)})}
    ...
    ${a==="text"&&n.bezelText?u`
      ...
      ${ge("Live countdown",n.bezelCountdown===!0,r=>t(o=>{r?o.bezelCountdown=!0:delete o.bezelCountdown}))}`:g}
    ${a==="gauge"&&n.bezelGauge?qd(e,n.bezelGauge,t):g}`}function qd(e,n,t){let i=[n.colorHexes[0]??"#34C759",n.colorHexes[1]??n.colorHexes[n.colorHexes.length-1]??"#FFCC00",n.colorHexes[n.colorHexes.length-1]??"#FF3B30"],a=r=>o=>t(l=>{let s=[...i];s[r]=o??s[r],l.bezelGauge.colorHexes=s},`gstop${r}`);return u`
    ...
    ${n.minLabel?ee(e,n.minLabel,r=>t(o=>{o.bezelGauge.minLabel=r},"gminlab"),{label:"Min label",key:"fam-corner-gminlab"}):g}
    ${n.maxLabel?ee(e,n.maxLabel,r=>t(o=>{o.bezelGauge.maxLabel=r},"gmaxlab"),{label:"Max label",key:"fam-corner-gmaxlab"}):g}`}var Au=Z.map(e=>[e,B(e)]),na={setColor:"Set colour",setOpacity:"Set opacity",setText:"Set text",setIcon:"Set icon",setFontSize:"Set size",setFontWeight:"Set weight",setRotation:"Set rotation",hide:"Hide",show:"Show",setGaugeValue:"Set gauge value",setGaugeMin:"Set gauge min",setGaugeMax:"Set gauge max",setBorderColor:"Set border colour",setBorderWidth:"Set border width",setBackgroundColor:"Set background colour"},Yd=Object.keys(na);function Jd(e){let n=gn[e];return Yd.filter(t=>n.includes(fe[t]))}var Xd={now:"the time",hour:"the hour",minute:"the minute",weekday:"the weekday",day:"the day",month:"the month",timestamp:"the timestamp"};function An(e,n){if(e.entityId==="")return"(no entity)";let t=e.displayName.trim();if(t!==""&&t!==e.entityId)return t;let i=n?.hass?.states[e.entityId]?.attributes.friendly_name;return typeof i=="string"&&i.trim()!==""?i.trim():e.entityId}function st(e,n){let t=e.replace(/\s+/g," ").trim();return t.length>n?`${t.slice(0,n-1)}\u2026`:t}function Zd(e){if(!e||Fe(e))return"";let n=[];return e.decimals!==void 0&&n.push(`${e.decimals} dp`),e.multiply!==void 0&&n.push(`\xD7${e.multiply}`),e.offset!==void 0&&n.push(`${e.offset<0?"":"+"}${e.offset}`),e.prefix&&n.push(`"${e.prefix}" first`),e.suffix&&n.push(`"${e.suffix}" after`),e.useEntityUnit&&n.push("with unit"),e.relativeTime&&n.push("as relative time"),e.textCase&&n.push(e.textCase==="capitalized"?"Capitalized":e.textCase==="upper"?"UPPER":"lower"),n.length===0?"":` (${n.join(", ")})`}function ce(e,n){return`${Xo(e,n)}${Zd(e.format)}`}function Xo(e,n){let t=e.kind;switch(t.kind){case"literal":return t.value?`"${st(t.value,40)}"`:"(empty)";case"entityState":return An(t,n);case"entityAttribute":return t.attribute?`${An(t,n)} \xB7 ${t.attribute}`:An(t,n);case"entityAge":return`age of ${An(t,n)}`;case"aggregate":return Qd(t.aggregate);case"time":return Xd[t.timeField];case"dataAge":return"data age";case"jinja":return t.value?`template ${st(t.value,32)}`:"template (empty)";case"named":return t.id===""?"(no value chosen)":n?.values?.find(a=>a.id===t.id)?.name?.trim()||`named ${t.id.slice(0,8)}`;case"chartStat":{let i=(ft.find(([o])=>o===t.stat)?.[1]??t.stat).toLowerCase();if(t.layer==="")return`${i} (no chart chosen)`;let a=n?.elements?.find(o=>o.kind==="chart"&&o.payload.id===t.layer),r=a?.kind==="chart"&&a.payload.value.kind.kind!=="chartStat"?Xo(a.payload.value,n):"a missing chart";return`${i} of ${r}`}}}function Qd(e){let n=e.scope.kind==="entities"?`${e.scope.entities.length} entit${e.scope.entities.length===1?"y":"ies"}`:e.scope.domains.length>0?e.scope.domains.join(" + "):"matching entities";return`${e.function} of ${n}`}function zn(e,n,t){if(t<0||t>=e.length)return;let[i]=e.splice(n,1);e.splice(t,0,i)}function ec(e,n,t,i,a){let r=(o,l)=>e.update(s=>{let d=i(s);d&&o(d)},l?`${a}-${l}`:void 0);return u`
    ${n.length===0?u`<div class="hint">No rules yet. A rule checks values and changes how this ${t==="layout"?"family":"layer"} looks.</div>`:g}
    ${n.map((o,l)=>tc(e,o,l,n.length,t,r,`${a}-${o.id}`))}
    <div class="adders"><button class="small" @click=${()=>r(o=>{o.push(Vt())})}>+ rule</button></div>
    <div class="hint">Inside a rule the first matching case wins. Across rules the later rule wins for the same property. Different properties add up.</div>`}function tc(e,n,t,i,a,r,o){let l=e.liveBranch(n),s=e.forced.get(n.id)??"live",d=c=>s==="live"?c==="live":s==="otherwise"?c==="otherwise":s.caseId===c,p=(c,h)=>r(f=>{let y=f.find(k=>k.id===n.id);y&&c(y)},h);return u`<div class="rule-box">
    <div class="rule-head">
      <b>Rule ${t+1}</b>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(c=>zn(c,t,t-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i-1} @click=${()=>r(c=>zn(c,t,t+1))}>${z("down")}</button>
      <button class="icon danger" title="Delete rule" @click=${()=>r(c=>{let h=c.findIndex(f=>f.id===n.id);h>=0&&c.splice(h,1)})}>${z("delete")}</button>
    </div>
    <div class="branches">
      ...
      ${n.otherwise?u`<button class="${d("otherwise")?"active":""} ${l==="otherwise"?"live-match":""}" @click=${()=>e.setForced(n.id,"otherwise")}>Otherwise</button>`:g}
    </div>
  ...
  </div>`}function nc(e,n,t,i,a,r,o){let l=(d,p)=>r(c=>{let h=c.cases.find(f=>f.id===n.id);h&&d(h)},p),s=e.liveBranch(i)===n.id;return u`<div class="case-box ${s?"match":""}">
    <div class="rule-head">
      <span>Case ${t+1}${s?u` <span class="ok">· active now</span>`:g}</span>
      <span class="spacer"></span>
      <button class="icon" title="Move up" ?disabled=${t===0} @click=${()=>r(d=>zn(d.cases,t,t-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${t===i.cases.length-1} @click=${()=>r(d=>zn(d.cases,t,t+1))}>${z("down")}</button>
    ...
    ${n.when.tests.length===0?u`<div class="hint">No tests: this case always matches.</div>`:g}
    ${n.when.tests.map((d,p)=>ic(e,d,p,c=>l(h=>{let f=h.when.tests.find(y=>y.id===d.id);f&&c(f)}),()=>l(c=>{c.when.tests=c.when.tests.filter(h=>h.id!==d.id)}),`${o}-${d.id}`))}
    ...
    ${Zo(e,n.then,a,d=>l(p=>d(p.then)),`${o}-then`)}
  </div>`}function ic(e,n,t,i,a,r){let o=(c,h)=>i(c,h?`${r}-${h}`:void 0),l=n.comparison,s=nt(l.kind),d=e.evaluateTest(n),p=g;switch(s){case"value":p=ee(e,l.value??M(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Compare with",key:`${r}-rhs`});break;case"between":p=u`${ee(e,l.value??M(""),c=>o(h=>{h.comparison.value=c},"rhs"),{showResolved:!0,label:"Lower bound",key:`${r}-rhs`})}
        ...
        ${l.pattern&&!ac(l.pattern)?u`<div class="hint warn">This pattern does not compile. The test fails until it does.</div>`:g}`;break;case"options":p=ne("Options (comma separated)",(l.options??[]).join(", "),c=>o(h=>{h.comparison.options=c.split(",").map(f=>f.trim()).filter(Boolean)},"options"));break;case"none":break}return u`<div class="test-box">
    <div class="rule-head">
    ...
    ${V("Comparison",l.kind,gr.map(c=>[c,$t[c]]),c=>o(h=>{h.comparison=$i(h.comparison,c)}))}
    ${p}
  </div>`}function ac(e){try{return new RegExp(e),!0}catch{return!1}}function Zo(e,n,t,i,a){let r=Jd(t);return u`
    ${n.length===0?u`<div class="hint">No changes.</div>`:g}
    ...
    <select class="adder" @change=${o=>{let l=o.target,s=l.value;l.value="",s&&i(d=>{d.push(it(s))})}}>
      ...
      ${r.map(o=>u`<option value=${o}>${na[o]}</option>`)}
    </select>`}var Qo=["setColor","setBorderColor","setBackgroundColor"];function rc(e,n,t,i,a,r,o){let l=!gn[i].includes(fe[n.kind]);return u`<div class="change-box">
    <div class="rule-head">
      <span>${na[n.kind]}${l?u` <span class="no">(ignored by ${i==="layout"?"layouts":`${i} layers`})</span>`:g}</span>
      <span class="spacer"></span>
      <button class="icon danger" title="Delete change" @click=${r}>${z("delete")}</button>
    </div>
    ${es(e,n,a,o)}
  </div>`}function es(e,n,t,i){let a=yn(n.kind),r=g;if(a==="value"){let o=n.value??M("");if(Qo.includes(n.kind)){let l=o.kind.kind==="literal";r=u`${l?ae("Colour",o.kind.kind==="literal"?o.kind.value:"",s=>t(d=>{d.value=M(s??"#FFFFFF")},"color")):ee(e,o,s=>t(d=>{d.value=s},"value"),{noFormat:!0,showResolved:!0,label:"Colour from",key:`${i}-value`})}
      ...
      <div class="states-switch">
        <button class="link" ?disabled=${!o.ok} title=${o.ok?"Go back to the table":"These rules cannot be shown as a table"}
          @click=${s=>{Xi.delete(a),Ce(s.target)}}>Show as table</button>
        ${o.ok?g:u`<span class="hint">${o.reason}</span>`}
      </div>
      ${ec(e,n,t,i,a)}`:oc(e,o.table,n[0],t,i,a,r)}function oc(e,n,t,i,a,r,o){let l=(x,C)=>e.update(I=>{let P=a(I);P&&x(P)},C?`${r}-${C}`:void 0),s=n.value??Ro.get(r)??o,d=n.rows.length===0,p=n.numberMode||d&&s!==void 0&&!co(s)&&sc(e.resolve(s)),c=gn[i],h=Hn.get(r)??new Set,f=n.columns.length===0&&h.size===0?[lo[i]]:[],y=Qr(n.columns,[...h,...f.filter(x=>x!==void 0)],c),k=t?e.liveBranch(t):"none",w=t?e.forced.get(t.id)??"live":"live",E=x=>w!=="live"&&(w==="otherwise"?x==="otherwise":w.caseId===x),R=x=>{t&&e.setForced(t.id,E(x)?"live":x==="otherwise"?"otherwise":{caseId:x})},m=x=>{Ro.set(r,x),n.rows.length!==0&&l(C=>ro(C,x),"lhs")},b=()=>l(x=>io(x,s??M(""),p)),$=n.rows.map((x,C)=>Mo(e,{key:`${r}-${x.caseId}`,label:so(x.comparison,I=>ce(I,re(e))),columns:y,changes:x.changes,live:k===x.caseId,forced:E(x.caseId),onForce:()=>R(x.caseId),when:uc(e,x.comparison,`${r}-${x.caseId}`,(I,P)=>l(S=>{let T=S[0]?.cases.find(J=>J.id===x.caseId)?.when.tests[0];T&&I(T.comparison)},P&&`${x.caseId}-${P}`)),updChanges:(I,P)=>l(S=>{let T=S[0]?.cases.find(J=>J.id===x.caseId);T&&I(T.then)},P&&`${x.caseId}-${P}`),acts:u`
      <button class="icon" title="Move up" ?disabled=${C===0} @click=${()=>l(I=>Bi(I,C,C-1))}>${z("up")}</button>
      <button class="icon" title="Move down" ?disabled=${C===n.rows.length-1} @click=${()=>l(I=>Bi(I,C,C+1))}>${z("down")}</button>
      <button class="icon danger" title="Delete this state" @click=${()=>l(I=>ao(I,x.caseId))}>${z("delete")}</button>`})),L=n.otherwise===void 0?g:Mo(e,{key:`${r}-otherwise`,label:"Otherwise",columns:y,changes:n.otherwise,live:k==="otherwise",forced:E("otherwise"),onForce:()=>R("otherwise"),when:u`<span class="when-otherwise">Otherwise</span>`,updChanges:(x,C)=>l(I=>{let P=I[0]?.otherwise;P&&x(P)},C),acts:u`<button class="icon" title="Remove the Otherwise row" @click=${()=>l(x=>Gi(x,!1))}>${z("close")}</button>`}),O=Ln.get(r),X=lc.filter(x=>c.includes(x)&&!y.includes(x));return u`
    <div class="states">
      ...
      <table class="states-table">
        <thead>
          <tr>
            ...
            ${y.map(x=>u`<th>
              <span>${Oe[x]}</span>
              <button class="icon" title=${`Remove the ${Oe[x]} column`}
                @click=${C=>{Ln.set(r,x),Ce(C.target)}}>${z("close")}</button>
            </th>`)}
            <th class="acts"></th>
          </tr>
        </thead>
        <tbody>
          ${$}
          ${L}
          ${n.rows.length===0&&n.otherwise===void 0?u`<tr><td class="empty-row" colspan=${y.length+2}>No states yet. Add one to change how this ${i==="layout"?"shape":"layer"} looks when a value changes.</td></tr>`:g}
        </tbody>
      </table>
      ${O===void 0?g:u`<div class="hint warn confirm-row">
        Remove the ${Oe[O]} column? Its ${Io(n,O)} value${Io(n,O)===1?"":"s"} are deleted from every state.
        <button class="danger small" @click=${x=>{Ln.delete(r),Hn.get(r)?.delete(O),Ce(x.target),l(C=>oo(C,O))}}>Remove</button>
        <button class="small" @click=${x=>{Ln.delete(r),Ce(x.target)}}>Cancel</button>
      </div>`}
      <div class="states-foot">
        <button class="small" @click=${b}>+ state</button>
        ${n.otherwise===void 0?u`<button class="small" title="What this layer looks like when no state above matches" @click=${()=>l(x=>Gi(x,!0))}>+ otherwise</button>`:g}
        <span class="spacer"></span>
        ${w==="live"?g:u`<button class="small" @click=${()=>t&&e.setForced(t.id,"live")}>Back to live</button>`}
        ${X.length===0?g:u`<select class="chip-add" title="Add a column" @change=${x=>{let C=x.target,I=C.value;if(C.value="",!I)return;let P=Hn.get(r)??new Set;P.add(I),Hn.set(r,P),Ce(C)}}>
          <option value="" selected>+ column…</option>
          ${X.map(x=>u`<option value=${x}>${Oe[x]}</option>`)}
        </select>`}
      </div>
  ...
  </tr>`}function cc(e,n,t,i,a){let r=Fn(t,n),o=Qi(a);if(!r)return u`<button type="button" class="cell empty" title=${`Set ${Oe[n]} for this state`}
      @click=${d=>{i(p=>{p.push(it(Zr[n]))}),$d(d.target,o)}}>unchanged</button>`;let l=(d,p)=>i(c=>{let h=c.find(f=>fe[f.kind]===n);h&&d(h)},p&&`${n}-${p}`),s=Oe[n];return u`
    <button type="button" class="cell filled" popovertarget=${o} aria-haspopup="dialog" title=${`${s}. Click to change it.`}>${pc(e,r)}</button>
    <div class="value-pop" id=${o} popover role="dialog" aria-label=${s} @toggle=${Oo}>
      <div class="pop-head">
        <b>${s}</b>
        <span class="spacer"></span>
      ...
      ${Yt.has(o)?u`${n==="visibility"?V("This state",r.kind==="hide"?"hide":"show",[["show","Shown"],["hide","Hidden"]],d=>l(p=>{p.kind=d})):es(e,r,l,a)}
          <button class="link" @click=${d=>{d.target.closest("[popover]")?.hidePopover(),i(p=>{let c=p.findIndex(h=>fe[h.kind]===n);c>=0&&p.splice(c,1)})}}>Leave ${s.toLowerCase()} unchanged</button>`:g}
    </div>`}function pc(e,n){if(n.kind==="hide")return u`<span class="cell-word">Hidden</span>`;if(n.kind==="show")return u`<span class="cell-word">Shown</span>`;let t=yn(n.kind);if(t==="number")return u`<span class="cell-word mono">${n.number??0}</span>`;if(t==="weight")return u`<span class="cell-word">${ea.find(([r])=>r===(n.weight??"regular"))?.[1]}</span>`;let i=n.value??M(""),a=i.kind.kind==="literal"?i.kind.value:void 0;if(Qo.includes(n.kind))return u`<span class="swatch" style=${`background:${a&&/^#[0-9a-fA-F]{6,8}$/.test(a)?a:"transparent"}`}></span>
      <span class="cell-word">${a?Se(a):ce(i,re(e))}</span>`;if(n.kind==="setIcon"&&a){let r=e.icons.render(a,16,"#FFFFFF");return u`${r??g}<span class="cell-word">${a}</span>`}return u`<span class="cell-word">${ce(i,re(e))}</span>`}function Se(e){return{"#FF453A":"red","#FF9F0A":"orange","#FFD60A":"amber","#34C759":"green","#30D158":"green","#0A84FF":"blue","#64D2FF":"cyan","#BF5AF2":"purple","#FFFFFF":"white","#8E8E93":"grey","#000000":"black","#FFCC00":"amber","#FF3B30":"red"}[e.toUpperCase()]??e}function uc(e,n,t,i){let a=nt(n.kind),r=Di(n.kind),o=(l,s,d,p)=>mc(e,l,s,`${t}-${d}`,r,p,d==="rhs"?"Compare with":"Upper bound");return u`<span class="when-cell">
    <select class="when-op" title="How this state is decided" @change=${de(l=>i(s=>{let d=$i(s,l);s.kind=d.kind,d.value!==void 0?s.value=d.value:delete s.value,d.upper!==void 0?s.upper=d.upper:delete s.upper}))}>
      ${Oi.map(l=>u`<option value=${l} ?selected=${l===n.kind}>${hc(l)}</option>`)}
    </select>
    ${a==="value"||a==="between"?o(n.value??M(""),l=>i(s=>{s.value=l},"rhs"),"rhs",r?"0":"value"):g}
    ${a==="between"?u`<span class="when-and">to</span>${o(n.upper??M(""),l=>i(s=>{s.upper=l},"upper"),"upper","100")}`:g}
  </span>`}function hc(e){switch(e){case"lessThan":return"below\u2026";case"lessOrEqual":return"\u2026or below";case"between":return"between\u2026";case"greaterOrEqual":return"\u2026or above";case"greaterThan":return"above\u2026";default:return $t[e]}}function mc(e,n,t,i,a,r,o){let l=Qi(i),s={showResolved:!0,label:o,key:i};if(n.kind.kind!=="literal")return u`<span class="rhs">
    ...
    ${No(e,l,o,n,t,s)}
  </span>`}var Nn=[{kind:"toggle",title:"Toggle button",blurb:"An icon that toggles the entity when tapped and looks different while it is on.",domains:mi,layerCount:2},{kind:"status",title:"Status text",blurb:"The entity's state as one line of text, dimmed while it is unavailable.",layerCount:1},{kind:"gauge",title:"Sensor gauge",blurb:"An arc that fills with the entity's reading and changes colour across three bands.",preferNumeric:!0,layerCount:1},{kind:"chart",title:"Forecast chart",blurb:"A bar chart of the readings already in the entity, with the highest and lowest marked. For a forecast sensor that holds a list.",layerCount:1},{kind:"history",title:"History chart",blurb:"A line of how the entity has moved over the last six hours, read from Home Assistant's recorder.",preferNumeric:!0,layerCount:1},{kind:"camera",title:"Camera",blurb:"The camera's latest snapshot, filling the face.",domains:["camera"],layerCount:1}];function rs(e){return Nn.find(n=>n.kind===e)??Nn[0]}var ns="#FF9F0A",ia="#8E8E93",fc=["#FF453A","#FFD60A","#34C759"],os=["#0A84FF","#34C759","#FF9F0A"];function gc(e){return e?.attributes?.device_class==="battery"?fc:os}var yc={light:{off:"lightbulb",on:"lightbulb.fill"},switch:{off:"power",on:"power"},fan:{off:"fan.fill",on:"fan.fill"},input_boolean:{off:"circle",on:"circle.fill"},cover:{off:"curtains.closed",on:"window.casement"},lock:{off:"lock.open.fill",on:"lock.fill"},media_player:{off:"speaker.slash.fill",on:"speaker.wave.2.fill"},siren:{off:"bell.slash.fill",on:"bell.fill"},humidifier:{off:"humidifier.fill",on:"humidifier.fill"},valve:{off:"spigot.fill",on:"spigot.fill"},automation:{off:"gearshape.fill",on:"gearshape.fill"},script:{off:"play.fill",on:"play.fill"},scene:{off:"sparkles",on:"sparkles"},climate:{off:"thermometer.medium",on:"flame.fill"},binary_sensor:{off:"circle",on:"circle.fill"},group:{off:"circle",on:"circle.fill"}};function bc(e){let n=e.iconName?.trim();return n?{off:n,on:n}:yc[aa(e)]??{off:"circle",on:"circle.fill"}}function vc(e){switch(aa(e)){case"lock":return{kind:"equals",value:M("locked")};case"cover":case"valve":return{kind:"equals",value:M("open")};case"media_player":return{kind:"equals",value:M("playing")};default:return{kind:"isOn"}}}function aa(e){return e.domain||e.entityId.split(".")[0]||""}function dt(e){return{...e,domain:aa(e)}}function xc(e){let n=e?.attributes??{},t=n.min,i=n.max;if(typeof t=="number"&&typeof i=="number"&&i>t)return{min:t,max:i};let a=typeof n.device_class=="string"?n.device_class:"",r=typeof n.unit_of_measurement=="string"?n.unit_of_measurement:"";switch(a){case"battery":case"humidity":case"moisture":return{min:0,max:100};case"temperature":return r.includes("F")?{min:0,max:100}:{min:-10,max:40};default:return r==="%"?{min:0,max:100}:{min:0,max:100}}}function Pn(e){return Math.round(e*1e4)/1e4}function On(e,n,t){return Math.min(t,Math.max(n,e))}function ra(e,n,t){let i=pe[e],a=On(Pn(n/i.width),0,1),r=On(Pn(t/i.height),0,1);return{x:Pn((1-a)/2),y:Pn((1-r)/2),width:a,height:r,rotationDegrees:0}}function wc(e){let n=pe[e],t=On(Math.round(Math.min(n.width,n.height)*.55),12,30);return{frame:ra(e,t*1.3,t*1.3),size:t}}function kc(e){let n=pe[e],t=On(Math.round(Math.min(n.width,n.height)*.3),9,20);return{frame:ra(e,n.width*.88,t*1.7),size:t}}function $c(e){let n=pe[e],t=Math.min(n.width,n.height)*.9;return{frame:ra(e,t,t),size:Math.max(2.5,Math.round(t*.2)/2)}}function ss(e){let n=e==="rectangular";return{frame:{x:.05,y:n?.34:.3,width:.9,height:n?.42:.4,rotationDegrees:0},size:2}}function Cc(){return{frame:{x:0,y:0,width:1,height:1,rotationDegrees:0}}}function Sc(e,n){n!==void 0&&(e.kind==="text"?e.payload.fontSize=n:e.kind==="icon"?e.payload.size=n:(e.kind==="gauge"||e.kind==="chart")&&(e.payload.lineWidth=n))}function St(e,n,t,i){let a=i(t);n.payload.frame=a.frame,Sc(n,a.size);for(let r of Z){if(r===t||r==="inline")continue;let o=e.perFamily[r];if(!o)continue;let l=i(r);JSON.stringify(l)!==JSON.stringify(a)&&(o.placements[n.payload.id]={frame:l.frame,isHidden:!1,...l.size!==void 0?{size:l.size}:{}})}}function Et(e){return Ge(e)}function oa(e,n){let t={kind:{kind:"entityState",...dt(e)}},i=n?.attributes?.unit_of_measurement;return typeof i=="string"&&i.trim()!==""&&(t.format={useEntityUnit:!0}),t}function is(e){let n=it("setIcon");return n.value=M(e),n}function lt(e){let n=it("setColor");return n.value=M(e),n}function Ec(e,n){let t=Vt(),i=t.cases[0],a=i.when.tests[0];a.value={kind:{kind:"entityState",...dt(e)}},a.comparison=vc(e);let r=n.on!==n.off;return i.then=r?[is(n.on),lt(ns)]:[lt(ns)],t.otherwise=r?[is(n.off),lt(ia)]:[lt(ia)],t}function Tc(e){let n=Vt(),t=n.cases[0],i=t.when.tests[0];i.value={kind:{kind:"entityState",...dt(e)}},i.comparison={kind:"isUnavailable"};let a=it("setOpacity");return a.number=.35,t.then=[a],n}function as(e){let n=Math.abs(e)>=10?Math.round(e):Math.round(e*10)/10;return String(n)}function Fc(e,n,t=os){let i=n.max-n.min,a=as(n.min+i/3),r=as(n.min+i*2/3),o=[{comparison:{kind:"lessThan",value:M(a)},changes:[lt(t[0])]},{comparison:{kind:"between",value:M(a),upper:M(r)},changes:[lt(t[1])]},{comparison:{kind:"greaterThan",value:M(r)},changes:[lt(t[2])]}];return eo(oa(e),o)}function Rc(e,n,t){let i=Et("icon"),a=bc(n);return i.payload.symbol=M(a.off),i.payload.colorSlot.baseColorHex=ia,i.payload.rules=[Ec(n,a)],St(e,i,t.family,wc),e.elements.push(i),hn(e,i.payload.id,{type:"toggleEntity",...dt(n)}),i.payload.id}function Ic(e,n,t){let i=Et("text");return i.payload.value=oa(n,t.state),i.payload.rules=[Tc(n)],St(e,i,t.family,kc),e.elements.push(i),i.payload.id}function Mc(e,n,t){let i=Et("gauge");i.payload.value=oa(n);let a=xc(t.state);return i.payload.minValue=a.min,i.payload.maxValue=a.max,i.payload.rules=[Fc(n,a,gc(t.state))],St(e,i,t.family,$c),e.elements.push(i),i.payload.id}function Ac(e,n,t){let i=Et("chart");return i.payload.value={kind:{kind:"entityState",...dt(n)}},i.payload.highlight="both",i.payload.marker="pointer",St(e,i,t.family,ss),e.elements.push(i),i.payload.id}function Hc(e,n,t){let i=Et("chart");return i.payload.value={kind:{kind:"entityState",...dt(n)}},i.payload.historyMinutes=360,i.payload.historyPoints=24,i.payload.style="line",i.payload.highlight="both",i.payload.marker="pointer",St(e,i,t.family,ss),e.elements.push(i),i.payload.id}function Lc(e,n,t){let i=Et("image");return i.payload.entity=dt(n),St(e,i,t.family,Cc),e.elements.push(i),i.payload.id}function ls(e,n,t,i){switch(n){case"toggle":return Rc(e,t,i);case"status":return Ic(e,t,i);case"gauge":return Mc(e,t,i);case"chart":return Ac(e,t,i);case"history":return Hc(e,t,i);case"camera":return Lc(e,t,i)}}var zc=3e4,Pc=500,ds="preset-entity",Nc={ArrowLeft:{dx:-1,dy:0},ArrowRight:{dx:1,dy:0},ArrowUp:{dx:0,dy:-1},ArrowDown:{dx:0,dy:1}};function sa(e){return"id"in e?`${e.kind}:${e.id}`:e.kind}function Oc(e){return e.kind==="family"?"look":"content"}function Dc(e){let n=e.document?.supportedFamilies;return Array.isArray(n)?n.filter(t=>typeof t=="string"):[]}var cs=300,ps=400,us=52,hs=36,Vc=[1,1.7,2.6],Bc=["S","M","L"],ms=["Small","Medium","Large"],fs="wrist-assistant-panel.layers.v1",De=34,ct=200,Gc=720,Dn=320,Uc=80,Kc=56,gs="wrist-assistant-panel.columns.v2",la=e=>Math.max(ct,Math.min(Gc,Math.round(e))),ys=e=>e.metaKey||e.ctrlKey||e.shiftKey,Jt=typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"Cmd":"Ctrl",We=Jt==="Cmd"?"\u2318":"Ctrl+",da=Jt==="Cmd"?"\u21E7":"Shift+";function bs(e,n,t){if(e<=0)return{columns:3,left:n,right:t};let i=e-Uc;if(i>=ct*2+Dn){let r=i-Dn,o=n,l=t;if(o+l>r){let s=r/(o+l);o=Math.max(ct,Math.floor(o*s)),l=Math.max(ct,Math.floor(l*s));let d=o+l-r;d>0&&(o>=l?o=Math.max(ct,o-d):l=Math.max(ct,l-d))}return{columns:3,left:o,right:l}}let a=e-Kc;return a>=ct+Dn?{columns:2,left:Math.min(n,a-Dn),right:t}:{columns:1,left:n,right:t}}var A=class extends Be{constructor(){super(...arguments);this.narrow=!1;this.colLeft=cs;this.colRight=ps;this.panelWidth=0;this.owners=[];this.records=[];this.maxSchemaVersion=6;this.presets=[];this.occupied=[];this.serverToken=0;this.polling=!1;this.sendPending=!1;this.pages=[];this.templateResults=new Map;this.historySeries=new Map;this.forced=new Map;this.showRaw=!1;this.inspect={kind:"general"};this.openSections=new Set(["content"]);this.pickerOpen=!1;this.testValues=new Map;this.thumbStep=0;this.layerDetail="compact";this.multi=new Set;this.collapsed=new Set;this.activeFamily="rectangular";this.picking=!1;this.listHoverIds=[];this.zoomed=!1;this.helpOpen=!1;this.showTaps=!1;this.newShapeChooser=!1;this.previewCase=Ut.label;this.saving=!1;this.confirmDelete=!1;this.moving=!1;this.version=0;this.historySignature="";this.icons=Wr(()=>this.requestUpdate());this.imageSizes=jr(()=>this.requestUpdate());this.symbols=new Sn(()=>this.requestUpdate());this.keyHandler=t=>this.onKey(t);this.heldArrows=new Set;this.keyUpHandler=t=>{this.heldArrows.delete(t.key)&&this.heldArrows.size===0&&this.draft?.endGesture()};this.sizeObserver=new ResizeObserver(t=>{let i=t[0]?.contentRect.width??0;Math.abs(i-this.panelWidth)>=1&&(this.panelWidth=i)});this.beforeUnload=t=>{this.draft?.dirty&&t.preventDefault()};this.pickerOutside=t=>{t.composedPath().some(a=>a instanceof HTMLElement&&a.classList.contains("picker"))||this.togglePicker(!1)};this.presetKeys={handleEvent:t=>{t.key==="Enter"&&(this.presetEntity===void 0||_o(ds)||(t.preventDefault(),t.stopPropagation(),this.createFromPreset()))},capture:!0}}static{this.styles=Bn`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),this.loadColumnWidths(),this.loadListView(),this.sizeObserver.observe(this),window.addEventListener("keydown",this.keyHandler),window.addEventListener("keyup",this.keyUpHandler),window.addEventListener("beforeunload",this.beforeUnload),this.loadOwners()}loadColumnWidths(){try{let t=window.localStorage.getItem(gs);if(!t)return;let i=JSON.parse(t);typeof i.left=="number"&&(this.colLeft=la(i.left)),typeof i.right=="number"&&(this.colRight=la(i.right))}catch{}}saveColumnWidths(){try{window.localStorage.setItem(gs,JSON.stringify({left:this.colLeft,right:this.colRight}))}catch{}}loadListView(){try{let t=window.localStorage.getItem(fs);if(!t)return;let i=JSON.parse(t);(i.thumbStep===0||i.thumbStep===1||i.thumbStep===2)&&(this.thumbStep=i.thumbStep),(i.detail==="compact"||i.detail==="expanded")&&(this.layerDetail=i.detail)}catch{}}saveListView(){try{window.localStorage.setItem(fs,JSON.stringify({thumbStep:this.thumbStep,detail:this.layerDetail}))}catch{}}renderGutter(t){return u`<div class="gutter ${t}" role="separator" aria-orientation="vertical"
      ...
      @click=${()=>{this.zoomed=!0}}><span class="glyph">⤢</span>Expand</button>`}renderZoomDialog(t,i,a){let r=this.draft?.config;if(!r)return g;let o=a.slots[t],l=t==="corner"?104/124:o.width/o.height;return u`<dialog class="zoom-dialog" @close=${()=>{this.zoomed=!1}}>
      <div class="zoom-bar">
    ...
    </dialog>`}setShowTaps(t){this.showTaps=t,t&&this.togglePicking(!1)}togglePicking(t=!this.picking){this.picking=t,this.pickHoverId=void 0,t&&(this.showTaps=!1,this.cancelGesture?.())}hitLayerId(t){let i=this.draft?.config;if(!i)return;let r=t.target?.closest?.("[data-element-id]")?.getAttribute("data-element-id");return r?yi(i,r):void 0}leaveRow(t){this.listHoverIds.length===t.length&&this.listHoverIds.every((a,r)=>t[r]===a)&&(this.listHoverIds=[])}onPickMove(t){this.picking&&(this.pickHoverId=this.hitLayerId(t))}pickAt(t,i){let a=this.hitLayerId(i);this.togglePicking(!1),a&&(t!==this.activeFamily&&(this.activeFamily=t),this.inspect={kind:"layer",id:a})}onPreviewPointerDown(t,i){if(this.picking){i.preventDefault(),this.pickAt(t,i);return}let a=i.target,r=a.closest("[data-handle]")?.getAttribute("data-handle"),o=a.closest("[data-element-id]")?.getAttribute("data-element-id")??void 0,l=a.closest("svg"),s=a.closest("[data-ts-corner]")?.getAttribute("data-ts-corner")??null,d=s!==null||a.closest("[data-ts-handle]")!==null;if(d||(this.timestampActiveId=void 0),this.showTaps){let w=this.focusTapId();if(w!==void 0&&o===w&&l&&this.draft&&this.canEdit){if(t!==this.activeFamily){this.activeFamily=t;return}i.preventDefault(),this.beginTapBoxGesture(t,i,l,w,r??void 0);return}let E=this.hitLayerId(i);E?this.inspect={kind:"layer",id:E}:o===void 0&&(this.inspect={kind:"general"});return}if(!this.draft||!this.canEdit)return;if(t!==this.activeFamily){this.activeFamily=t;return}let p=ys(i);if(!p&&this.multi.size>0&&(this.multi=new Set),!o||!l)return;let c=yi(this.draft.config,o),h=this.draft.config.elements.find(w=>w.payload.id===c);if(!c||!h)return;if(p){i.preventDefault(),this.togglePick(c);return}let f=Le(this.draft.config,c);if(f?.locked&&!r&&!d){this.beginGroupGesture(t,i,l,f);return}if((this.inspect.kind!=="layer"||this.inspect.id!==c)&&(this.inspect={kind:"layer",id:c},r))return;i.preventDefault();let y=be(this.draft.config,t,h).frame,k=this.gestureCanvas(t);if(d&&h.kind==="image"&&h.payload.timestamp===!0){this.timestampActiveId=c;let w=h.payload,E=me[t],R=y.width*E.width,m=y.height*E.height,b={x:0,y:0,w:R,h:m,cx:R/2,cy:m/2},$=kn(w,b,wn(new Date));if(this.cancelGesture?.(),s){let x=k.width/E.width,C=w.timestampSize;this.cancelGesture=bo(l,i,s,{w:$.w*x,h:$.h*x},(I,P)=>{let S=Math.min(40,Math.max(4,Math.round(C*I)));this.mutate(T=>{let J=T.elements.find(ve=>ve.payload.id===c);J?.kind==="image"&&(J.payload.timestampSize=S)},`ts-size-${c}`),P&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}let L={x:0,y:0,w:y.width*k.width,h:y.height*k.height},O=Ae(w)?{x:w.timestampX,y:w.timestampY}:{x:($.x+$.w/2)/b.w,y:($.y+$.h/2)/b.h},X=!1;this.cancelGesture=yo(l,L,i,O,(x,C,I)=>{I||(X=!0),X&&this.mutate(P=>{let S=P.elements.find(T=>T.payload.id===c);S?.kind==="image"&&(S.payload.timestampX=x,S.payload.timestampY=C)},`ts-${c}`),I&&(this.draft?.endGesture(),this.cancelGesture=void 0)});return}this.cancelGesture?.(),this.cancelGesture=In(l,k,i,{elementId:c,frame:y,handle:r??void 0},{onFrame:(w,E,R)=>{this.mutate(m=>ye(m,t,w,{frame:E}),`drag-${w}-${t}`),R&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}beginGroupGesture(t,i,a,r){let o=this.draft?.config;if(!o)return;let l=_e(o,r.id);if(l.length===0)return;(this.inspect.kind!=="group"||this.inspect.id!==r.id)&&(this.inspect={kind:"group",id:r.id}),i.preventDefault();let s=new Map(l.map(w=>[w.payload.id,be(o,t,w).frame])),d=[...s.values()],p=Math.min(...d.map(w=>w.x)),c=Math.min(...d.map(w=>w.y)),h=Math.max(...d.map(w=>w.x+w.width)),f=Math.max(...d.map(w=>w.y+w.height)),y={x:p,y:c,width:h-p,height:f-c,rotationDegrees:0},k=w=>Math.round(w*1e3)/1e3;this.cancelGesture?.(),this.cancelGesture=In(a,this.gestureCanvas(t),i,{elementId:r.id,frame:y},{onFrame:(w,E,R)=>{let m=E.x-y.x,b=E.y-y.y;this.mutate($=>{for(let[L,O]of s)ye($,t,L,{frame:{...O,x:k(O.x+m),y:k(O.y+b)}})},`drag-group-${r.id}-${t}`),R&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}nudge(t,i,a){let r=this.draft?.config;if(!r||!this.canEdit||this.showTaps||this.picking)return!1;let o=a?fo:1,l=t*o,s=i*o,d=this.canvasFamily,p=me[d];if(this.timestampActiveId!==void 0&&this.nudgeTimestamp(this.timestampActiveId,d,l,s))return!0;if(this.multi.size>=2)return this.nudgeMany([...this.multi],d,p,`nudge-multi-${d}`,l,s);if(this.inspect.kind==="group"){let w=this.inspect.id;return this.nudgeMany(_e(r,w).map(E=>E.payload.id),d,p,`nudge-group-${w}-${d}`,l,s)}if(this.inspect.kind!=="layer")return!1;let c=this.inspect.id,h=r.elements.find(w=>w.payload.id===c);if(!h)return!1;let f=Le(r,c);if(f?.locked)return this.nudgeMany(_e(r,f.id).map(w=>w.payload.id),d,p,`nudge-group-${f.id}-${d}`,l,s);let y=be(r,d,h).frame,k=Ki(y,l,s,p);return(k.x!==y.x||k.y!==y.y)&&this.mutate(w=>ye(w,d,c,{frame:k}),`nudge-${c}-${d}`),!0}nudgeMany(t,i,a,r,o,l){let s=this.draft?.config;if(!s)return!1;let d=b=>Math.round(b*1e3)/1e3,p=new Map;for(let b of t){let $=s.elements.find(L=>L.payload.id===b);$&&p.set(b,be(s,i,$).frame)}if(p.size===0)return!1;let c=[...p.values()],h=Math.min(...c.map(b=>b.x)),f=Math.min(...c.map(b=>b.y)),y=Math.max(...c.map(b=>b.x+b.width)),k=Math.max(...c.map(b=>b.y+b.height)),w={x:h,y:f,width:y-h,height:k-f,rotationDegrees:0},E=Ki(w,o,l,a),R=E.x-w.x,m=E.y-w.y;return(R!==0||m!==0)&&this.mutate(b=>{for(let[$,L]of p)ye(b,i,$,{frame:{...L,x:d(L.x+R),y:d(L.y+m)}})},r),!0}nudgeTimestamp(t,i,a,r){let o=this.draft?.config,l=o?.elements.find(w=>w.payload.id===t);if(!o||l?.kind!=="image"||l.payload.timestamp!==!0)return!1;let s=l.payload,d=me[i],p=be(o,i,l).frame,c=p.width*d.width,h=p.height*d.height,f=kn(s,{x:0,y:0,w:c,h,cx:c/2,cy:h/2},wn(new Date)),y=Ae(s)?{x:s.timestampX,y:s.timestampY}:{x:c>0?(f.x+f.w/2)/c:.5,y:h>0?(f.y+f.h/2)/h:.5},k=go(y,a,r,{w:c,h});return(k.x!==y.x||k.y!==y.y)&&this.mutate(w=>{let E=w.elements.find(R=>R.payload.id===t);E?.kind==="image"&&(E.payload.timestampX=k.x,E.payload.timestampY=k.y)},`nudge-ts-${t}`),!0}gestureCanvas(t){let i=xn(this.previewSlot(t),t);if(t!=="corner")return{width:i.width,height:i.height};let a=this.draft?.config.perFamily.corner,r=!!a?.bezelText||!!a?.bezelGauge,o=_i(i.scale,r);return{width:o,height:o}}focusTapId(){let t=this.draft?.config;if(!t||!this.showTaps||this.inspect.kind!=="layer")return;let i=this.inspect.id,a=t.elements.find(r=>r.payload.id===i);if(a)return a.kind==="tap"?a.payload.id:we(t,i)[0]?.payload.id}beginTapBoxGesture(t,i,a,r,o){let l=this.draft?.config,s=l?.elements.find(c=>c.payload.id===r);if(!l||!s)return;let d=se(l,s),p=be(l,t,s).frame;this.cancelGesture?.(),this.cancelGesture=In(a,this.gestureCanvas(t),i,{elementId:r,frame:p,handle:o},{onFrame:(c,h,f)=>{this.mutate(y=>{d?ur(y,c,t,h):ye(y,t,c,{frame:h})},`tap-box-${c}-${t}`),f&&(this.draft?.endGesture(),this.cancelGesture=void 0)}})}render(){let t=this.draft,i=!!t?.dirty,a=this.narrow?{columns:1,left:this.colLeft,right:this.colRight}:bs(this.panelWidth,this.colLeft,this.colRight);return u`
      <header>
        ...
        <label>Watch
          <select @change=${r=>{this.selectOwner(r.target.value)}}>
            ${this.owners.map(r=>u`<option value=${r.owner_watch_id} ?selected=${r.owner_watch_id===this.ownerId}>
              ${ca(r)} (${r.complication_count})</option>`)}
          </select>
        </label>
      ...
      <button aria-haspopup="listbox" aria-expanded=${this.pickerOpen?"true":"false"} title="Choose a complication"
        ...
        ${i?u`<span class="pk-rev">r${i.revision}</span>`:t&&t.baseRevision===null?u`<span class="pk-rev">unsaved</span>`:g}
        ${z("chevron")}
      </button>
      ${this.pickerOpen?u`<div class="menu" role="listbox">
        ${o.length===0&&!(t&&t.baseRevision===null)?u`<div class="empty">No complications for this watch yet.</div>`:g}
        ...
        ${t&&t.baseRevision===null?u`<div class="row" aria-current="true">${this.shapeDots(r)}<span class="pk-name">${a}</span><span class="pk-badge">unsaved</span></div>`:g}
        ${this.hass.user?.is_admin?u`
          <button class="row new" ?disabled=${l<0} @click=${()=>{this.newShapeChooser=!this.newShapeChooser}}>
            ${z("plus")}<span class="pk-name">New complication</span>${l<0?u`<span class="pk-badge">watch is full</span>`:g}
          </button>
      ...
      ${this.hass.user?.is_admin?i.length===0?u`<div class="hint">No registered watch to move them to. Open Wrist Assistant on the watch first.</div>`:u`<div class="acts">
              <select @change=${a=>{this.moveTarget=a.target.value||void 0}}>
                ...
                ${i.map(a=>u`<option value=${a.owner_watch_id} ?selected=${a.owner_watch_id===this.moveTarget}>${ca(a)}</option>`)}
              </select>
      ...
      ${this.renderPresetDialog()}
        ...
        <span class="name">
          ...
          ${b?u`<span class="facts">${jc(this.host(),a,x,S).map(K=>u`<span class="fact"><b>${K.label}</b> ${K.value}</span>`)}</span>`:g}
        </span>
        <span class="right">
          <span class="badges">
            ${J?u`<span class="badge tap" title=${`Tappable \xB7 ${ke(J,d)}`}>tap</span>`:g}
            ${x.payload.rules.length===0?g:u`<span class="badge states" title=${ve}>${ve.replace(/\.$/,"").toLowerCase()}</span>`}
            ${T?u`<span class="badge">hidden</span>`:g}
          </span>
          ${i?u`<span class="acts">
            ...
            <button class="icon" title=${`${S.isHidden?"Show in":"Hide in"} ${B(a)} (${da}${We}H)`} aria-label=${S.isHidden?"Show this layer":"Hide this layer"} @click=${K=>{K.stopPropagation(),this.mutate(oe=>ye(oe,a,I,{isHidden:!S.isHidden}))}}>${z(S.isHidden?"hide":"show")}</button>
      ...
      </div>`},L=(x,C)=>{let I=this.inspect.kind==="group"&&this.inspect.id===x.id,P=!this.collapsed.has(x.id),S=this.rowDrag(x.id,i),T=C[0],J=C[C.length-1],ve=W=>{let K=W.currentTarget,oe=K.getBoundingClientRect(),pt=oe.top+(K.classList.contains("drop-before")?De:0),vs=oe.bottom-(K.classList.contains("drop-after")?De:0),pa=(W.clientY-pt)/Math.max(1,vs-pt);return pa<.25?"drop-before":!P&&pa>.75?"drop-after":"drop-into"},xe=C.map(W=>W.payload.id);return u`<div class="layer group ${I?"hl":""} ${b?"rich":""}" style=${`--k:${Y.group}`} tabindex="0" draggable=${S.draggable}
        ...
        <span class="name">
          ...
          ${b?u`<span class="facts"><span class="fact"><b>Holds</b> ${C.map(W=>ke(W,d)).join(", ")}</span></span>`:g}
        </span>
        <span class="right">
          ${i?u`<span class="acts">
            <button class="icon" title=${`Ungroup: keep the layers, drop the folder (${da}${We}G)`} aria-label="Ungroup" @click=${W=>{W.stopPropagation(),this.mutate(K=>Ot(K,x.id)),I&&(this.inspect={kind:"general"})}}>${z("ungroup")}</button>
          </span>`:g}
      ...
      </div>`},O=[],X=new Set;for(let x=0;x<s.length;x++){let C=s[x],I=C.payload.groupId,P=I===void 0?void 0:t.groups?.find(T=>T.id===I);if(!P){O.push($(C,!1));continue}if(X.has(P.id))continue;X.add(P.id);let S=s.filter(T=>T.payload.groupId===P.id);O.push(L(P,S)),this.collapsed.has(P.id)||O.push(u`<div class="group-kids">${S.map(T=>$(T,!0))}</div>`)}return u`<div class="card">
      ...
      ${this.activeFamily==="inline"?u`<div class="hint">Inline is one line of text and draws no layers. The rows here belong to the ${B(a)} shape.</div>`:g}
      ${y>=2&&i?u`<div class="group-cta"><span>${y} layers picked</span><span class="spacer"></span>
            ...
            <button class="small" @click=${()=>{this.multi=new Set}}>Clear</button></div>`:t.elements.length>=2&&i&&!t.groups?.length?u`<div class="hint">${Jt}-click layers here or on the preview, or shift-click a range of rows, then group them so a finished part moves as one. The <b>?</b> button in the header lists every key and mouse trick.</div>`:g}
      ${t.elements.length===0?u`<div class="empty">No layers yet. Add one above.</div>`:g}
    ...
    </div>`}renderBigPreview(t,i,a){let r=i[t];if(!r)return g;let o=this.inspect.kind==="layer"?this.inspect.id:void 0,l=this.draft?.config,s=this.inspect.kind==="group"?this.inspect.id:o!==void 0&&l?Le(l,o)?.id:void 0,d=l&&s!==void 0&&(this.inspect.kind==="group"||Le(l,o)?.locked)?_e(l,s).map(y=>y.payload.id):[],p=[...new Set([...d,...this.multi])],c=a.slots[t],h=this.focusTapId(),f={icons:this.icons,imageSizes:this.imageSizes,showHidden:!0,tapAreas:!0,slot:c,highlightId:h??o,...p.length>0&&!this.showTaps?{highlightIds:p}:{},tapReview:this.showTaps,...h!==void 0?{tapFocusId:h}:{},handles:this.canEdit&&!this.picking&&(!this.showTaps||h!==void 0),...this.picking?this.pickHoverId!==void 0?{hoverId:this.pickHoverId}:{}:this.listHoverIds.length>0?{hoverIds:this.listHoverIds}:{},...this.timestampActiveId!==void 0&&this.timestampActiveId===o&&!this.showTaps&&!this.picking?{timestampActiveId:this.timestampActiveId}:{}};return u`<div class="preview ${t} active ${this.picking?"picking":""}"
      ...
      ${zi(r,f)}
    </div>`}renderUnder(t,i){let a=re(this.host()),r=this.inspect,o=r.kind==="layer"?t.elements.find(c=>c.payload.id===r.id):void 0,l;if(this.showTaps)l=u`Every tap area is outlined. Where two overlap, the one higher in Layers wins. Anywhere else does <b>${He(t.tapAction)}</b>.`;else if(this.picking)l="Point at a layer and click it. Escape stops.";else if(i==="inline")l="One line of text. Edit it on the right.";else if(r.kind==="group"){let c=t.groups?.find(f=>f.id===r.id),h=c?_e(t,c.id).length:0;l=c?u`editing group <b>${c.name}</b>. ${c.locked?`Drag to move all ${h} layers.`:"Unlocked: each layer drags alone."}`:""}else if(o){let c=Le(t,o.payload.id);l=c?.locked?u`editing <b>${ke(o,a)}</b> in <b>${c.name}</b>. A drag moves the whole group; pull a corner to resize this layer. Arrow keys nudge the group.`:u`editing <b>${ke(o,a)}</b>. Drag it, or pull a corner. Arrow keys nudge it.`}else l="click a layer to edit it";if(i==="inline")return u`<div class="under"><b>Inline</b> · ${l}</div>`;let s=this.currentCase().slots[i],d=xn(s,i),p=Math.round(d.scale*100);return u`<div class="under"><b>${B(i)}</b> · ${s.width} × ${s.height} pt${p!==100?` \xB7 ${p}%`:""} · ${l}</div>`}renderInlinePreview(t,i){let a;if(!t)a=u`<div class="inline-line missing">No inline text</div>`;else{let r=Date.now(),o=t.countdownEnd!==void 0&&t.countdownEnd>r?vt((t.countdownEnd-r)/1e3):t.text,l=t.symbol?this.icons.render(t.symbol,i?11:15,"#FFFFFF"):void 0;a=u`<div class="inline-line">${l??g}<span>${t.label?`${t.label}: `:""}${o}</span></div>`}return i?a:u`<div class="preview inline active" @click=${()=>{this.inspect={kind:"family"}}}>${a}</div>`}renderSettingsRow(t){let i=this.host(),a=this.records.find(p=>p.id===this.selectedId),r=this.selectedOwner,o=[a?`Revision ${a.revision}`:"Not saved yet",r?ca(r):void 0].filter(Boolean).join(" \xB7 "),l=t.values,s=new Pe(this.buildContext(),this.draft?.config),d=re(i);return u`<div class="strip-row" style=${`--c:${Y.complication}`} @change=${()=>this.draft?.endGesture()}>
      ...
      <div class="values-list">
        <div class="values-head"><span class="sub">Shared values</span>
          ${this.canEdit?u`<button class="small" @click=${()=>{let p=Ko();this.mutate(c=>{c.values.push(p)}),this.inspect={kind:"data",id:p.id}}}>Add</button>`:g}
        ...
        ${l.map(p=>{let c=s.resolve({kind:{kind:"named",id:p.id}}),h=this.inspect.kind==="data"&&this.inspect.id===p.id;return u`<div class="datum ${h?"hl":""}" @click=${()=>{this.inspect={kind:"data",id:p.id}}}>
            ...
            ${this.canEdit?u`<button class="icon danger" title="Delete value" aria-label="Delete value" @click=${f=>{f.stopPropagation(),this.mutate(y=>{y.values=y.values.filter(k=>k.id!==p.id)}),h&&(this.inspect={kind:"general"})}}>${z("delete")}</button>`:g}
          </div>`})}
        </div>`}
      </div>
      ...
      <div class="tiles">
        ${xt.map(r=>{if(!a.includes(r))return u`<button class="tile off ${r}" ?disabled=${!this.canEdit} title=${`Add the ${B(r)} shape`} @click=${()=>this.addShape(r)}>
            ...
            </button>`;let l=r===this.activeFamily,s;if(r==="inline")s=this.renderInlinePreview(i.inline,!0);else{let c=i[r];s=c?zi(c,{icons:this.icons,imageSizes:this.imageSizes,slot:Ut.slots[r]}):g}let d=r!=="inline"&&t.elements.every(c=>be(t,r,c).isHidden||c.payload.isHidden)&&t.elements.length>0,p=this.canEdit&&wt(t,r);return u`<div class="tile-wrap">
            <button class="tile ${r}" aria-pressed=${l?"true":"false"} title=${`Edit the ${B(r)} shape`}
              ...
              <span class="lbl">${B(r)}${d?u`<small>· nothing shown</small>`:g}${l?u`<small>· editing</small>`:g}</span>
            </button>
            ${this.canEdit?u`<button class="icon danger tile-x" ?disabled=${!p}
              ...
              @click=${c=>{c.stopPropagation(),this.removeShape(r)}}>${z("delete")}</button>`:g}
          </div>`})}
      </div>
    ...
    </div>`}renderValuesRow(){let t=this.draft?.config;if(!t)return g;let i=[...this.compiled?.entities.keys()??[]],a=this.testValues.size>0;return u`<div class="strip-row">
      ...
      ${i.length===0?u`<div class="hint">No entities yet. Give a layer an entity and its live value shows here.</div>`:u`<div class="chips values">
        ${i.map(r=>{let o=this.hass.states[r],l=typeof o?.attributes.friendly_name=="string"?o.attributes.friendly_name:r,s=typeof o?.attributes.unit_of_measurement=="string"?` ${o.attributes.unit_of_measurement}`:"",d=o?`${o.state}${s}`:"not in Home Assistant",p=this.testValues.get(r),h=t.elements.find(y=>fn(t,y.payload.id).some(k=>k.ref.entityId===r))?.kind??"text",f=this.editingValue===r;return u`<button class="vchip ${p!==void 0?"testing":""}" style=${`--k:${te[h]}`}
      ...
      <div class="insp-head">
        ${this.crumbs(t)}
        ${l?u`<button class="expand" @click=${()=>{this.openSections=s?new Set([Oc(r)]):new Set(Zi)}}>${s?"One at a time":"Open all"}</button>`:g}
      </div>
      ...
      <span>${t}${i==="mixed"?u` <span class="mixed">(mixed)</span>`:g}</span></label>`}multiEditor(t,i){let a=this.canvasFamily,r=re(this.host()),o=new Pe(this.buildContext(),this.draft?.config),l=Wo(t,a,i),s=i.length,d=[...i].reverse(),p=f=>this.mutate(y=>{for(let k of i)ye(y,a,k.payload.id,{isHidden:f})}),c=f=>this.mutate(y=>{for(let k of i){let w=y.elements.find(E=>E.payload.id===k.payload.id);w&&(w.payload.isHidden=f)}}),h=f=>this.mutate(y=>{for(let k of i){let w=y.elements.find(E=>E.payload.id===k.payload.id);w&&w.kind!=="image"&&w.kind!=="tap"&&(w.payload.colorSlot.baseColorHex=f)}},"multi-colour");return u`
          ...
          <div class="picked">
            ${d.map(f=>u`<div class="row" style=${`--k:${te[f.kind]}`}>
              ...
              <span class="name">
                ...
                <b>${ke(f,r)}</b><span class="kind">${kt[f.kind]}</span>
              </span>
            </div>`)}
          </div>
      ...
      </div>`}renderFooter(){let t=this.draft;if(!t)return g;let i=this.records.find(r=>r.id===this.selectedId),a=Yr({revision:i?.revision??null,dirty:t.dirty,...this.saveError!==void 0?{error:this.saveError}:{},...this.templateError!==void 0?{templateError:this.templateError}:{}});return u`<details class="foot">
      <summary>
      ...
      <div class="foot-body">
        ...
        ${this.showRaw?u`<pre>${JSON.stringify(t.encoded(),null,2)}</pre>`:g}
      </div>
    </details>`}};H([mt({attribute:!1})],A.prototype,"hass",2),H([mt({type:Boolean})],A.prototype,"narrow",2),H([mt({attribute:!1})],A.prototype,"panel",2),H([_()],A.prototype,"colLeft",2),H([_()],A.prototype,"colRight",2),H([_()],A.prototype,"panelWidth",2),H([_()],A.prototype,"owners",2),H([_()],A.prototype,"ownerId",2),H([_()],A.prototype,"records",2),H([_()],A.prototype,"selectedId",2),H([_()],A.prototype,"draft",2),H([_()],A.prototype,"readOnlyReason",2),H([_()],A.prototype,"parseError",2),H([_()],A.prototype,"maxSchemaVersion",2),H([_()],A.prototype,"presets",2),H([_()],A.prototype,"occupied",2),H([_()],A.prototype,"serverToken",2),H([_()],A.prototype,"appliedToken",2),H([_()],A.prototype,"polling",2),H([_()],A.prototype,"sendPending",2),H([_()],A.prototype,"pages",2),H([_()],A.prototype,"templateResults",2),H([_()],A.prototype,"historySeries",2),H([_()],A.prototype,"templateError",2),H([_()],A.prototype,"templateFetchedAt",2),H([_()],A.prototype,"forced",2),H([_()],A.prototype,"showRaw",2),H([_()],A.prototype,"inspect",2),H([_()],A.prototype,"openSections",2),H([_()],A.prototype,"pickerOpen",2),H([_()],A.prototype,"testValues",2),H([_()],A.prototype,"editingValue",2),H([_()],A.prototype,"thumbStep",2),H([_()],A.prototype,"layerDetail",2),H([_()],A.prototype,"multi",2),H([_()],A.prototype,"collapsed",2),H([_()],A.prototype,"activeFamily",2),H([_()],A.prototype,"picking",2),H([_()],A.prototype,"pickHoverId",2),H([_()],A.prototype,"listHoverIds",2),H([_()],A.prototype,"zoomed",2),H([_()],A.prototype,"helpOpen",2),H([_()],A.prototype,"showTaps",2),H([_()],A.prototype,"timestampActiveId",2),H([_()],A.prototype,"savedName",2),H([_()],A.prototype,"presetKind",2),H([_()],A.prototype,"presetEntity",2),H([_()],A.prototype,"newShapeChooser",2),H([_()],A.prototype,"previewCase",2),H([_()],A.prototype,"loadError",2),H([_()],A.prototype,"saveError",2),H([_()],A.prototype,"saving",2),H([_()],A.prototype,"conflict",2),H([_()],A.prototype,"remoteRevision",2),H([_()],A.prototype,"confirmDelete",2),H([_()],A.prototype,"moveTarget",2),H([_()],A.prototype,"moving",2),H([_()],A.prototype,"moveError",2),H([_()],A.prototype,"version",2);function je(e){return String(e?.message??e)}function Wc(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e!="string"||e==="")return;let n=e.split(":").map(t=>Number(t));if(!(n.length===0||n.length>3||n.some(t=>Number.isNaN(t))))return n.reduce((t,i)=>t*60+i,0)}function ca(e){let n=e.device_name??e.owner_watch_id;return e.paired_iphone_name?`${n} (${e.paired_iphone_name})`:n}function jc(e,n,t,i){let a=me[n],r=i.frame,o=d=>Math.round(d),l=[{label:"Shows",value:ta(e,t)}],s=_n(t);return s&&l.push({label:"Looks",value:s}),l.push({label:"At",value:`${o(r.x*a.width)}, ${o(r.y*a.height)} pt`}),l.push({label:"Size",value:`${o(r.width*a.width)} x ${o(r.height*a.height)} pt`}),r.rotationDegrees!==0&&l.push({label:"Turned",value:`${Math.round(r.rotationDegrees)}\xB0`}),i.fromPlacement&&l.push({label:"Frame",value:`${B(n)} only`}),l}function qc(e,n,t){switch(e.kind){case"text":return`${n.resolve(e.payload.value)??"--"} \xB7 ${e.payload.fontSize} pt`;case"icon":return`${e.payload.size} pt \xB7 ${Se(e.payload.colorSlot.baseColorHex)}`;case"gauge":return`${n.resolve(e.payload.value)??"--"} \xB7 ${e.payload.style}`;case"chart":{let i=tt(e.payload),a=i!==void 0?t.get(i)??"":n.resolve(e.payload.value)??"";return`${e.payload.style} \xB7 ${Bt(a).length} values`}case"shape":return`${Se(e.payload.colorSlot.baseColorHex)}${e.payload.borderColorHex?" \xB7 border":""}`;case"image":return`${e.payload.contentMode==="fill"?"fill":"fit"} \xB7 ${e.payload.timestamp?"time shown":"no time"}`;case"tap":return He(e.payload.action)}}customElements.get("wrist-assistant-panel")||customElements.define("wrist-assistant-panel",A);export{A as WristAssistantPanel,bs as columnFit,jc as layerFacts};
